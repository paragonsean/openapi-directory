...
import UpdateTopicRequestTopic from './UpdateTopicRequestTopic';
...
class UpdateTopicRequest {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('topic')) {
                obj['topic'] = UpdateTopicRequestTopic.constructFromObject(data['topic']);
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        if (data['topic']) { // data not null
          UpdateTopicRequestTopic.validateJSON(data['topic']);
        }
...
/**
 * @member {module:model/UpdateTopicRequestTopic} topic
 */
