...
export default class NotificationsApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the markNotificationsAsRead operation.
     * @callback module:api/NotificationsApi~markNotificationsAsReadCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:model/MarkNotificationsAsReadRequest} [markNotificationsAsReadRequest] 
     * @param {module:api/NotificationsApi~markNotificationsAsReadCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/UpdateGroup200Response}
     */
    markNotificationsAsRead(opts, callback) {
      opts = opts || {};
      let postBody = opts['markNotificationsAsReadRequest'];
