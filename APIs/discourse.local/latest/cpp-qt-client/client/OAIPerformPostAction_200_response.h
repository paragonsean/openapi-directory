...
/*
 * OAIPerformPostAction_200_response.h
 *
 * 
 */

#ifndef OAIPerformPostAction_200_response_H
#define OAIPerformPostAction_200_response_H
...
namespace OpenAPI {
class OAIPerformPostAction_200_response_actions_summary_inner;

class OAIPerformPostAction_200_response : public OAIObject {
public:
    OAIPerformPostAction_200_response();
    OAIPerformPostAction_200_response(QString json);
    ~OAIPerformPostAction_200_response() override;
    ...
    QList<OAIPerformPostAction_200_response_actions_summary_inner> getActionsSummary() const;
    void setActionsSummary(const QList<OAIPerformPostAction_200_response_actions_summary_inner> &actions_summary);
    ...
    OAIObject getNotice() const;
    void setNotice(const OAIObject &notice);
...
private:
    ...
    QList<OAIPerformPostAction_200_response_actions_summary_inner> m_actions_summary;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPerformPostAction_200_response)

#endif // OAIPerformPostAction_200_response_H
