...
/*
 * OAIGetUserSentPrivateMessages_200_response_topic_list_topics_inner.h
 *
 * 
 */

#ifndef OAIGetUserSentPrivateMessages_200_response_topic_list_topics_inner_H
#define OAIGetUserSentPrivateMessages_200_response_topic_list_topics_inner_H
...
class OAIGetUserSentPrivateMessages_200_response_topic_list_topics_inner : public OAIObject {
public:
    OAIGetUserSentPrivateMessages_200_response_topic_list_topics_inner();
    OAIGetUserSentPrivateMessages_200_response_topic_list_topics_inner(QString json);
    ~OAIGetUserSentPrivateMessages_200_response_topic_list_topics_inner() override;
    ...
    qint32 getAllowedUserCount() const;
    void setAllowedUserCount(const qint32 &allowed_user_count);
    bool is_allowed_user_count_Set() const;
    bool is_allowed_user_count_Valid() const;
    ...
    QList<QJsonValue> getParticipants() const;
    void setParticipants(const QList<QJsonValue> &participants);
...
private:
    ...
    qint32 m_allowed_user_count;
    bool m_allowed_user_count_isSet;
    bool m_allowed_user_count_isValid;
    ...
    QList<QJsonValue> m_participants;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetUserSentPrivateMessages_200_response_topic_list_topics_inner)

#endif // OAIGetUserSentPrivateMessages_200_response_topic_list_topics_inner_H
