...
/*
 * OAIGetPost_200_response.h
 *
 * 
 */

#ifndef OAIGetPost_200_response_H
#define OAIGetPost_200_response_H
...
class OAIGetPost_200_response : public OAIObject {
public:
    OAIGetPost_200_response();
    OAIGetPost_200_response(QString json);
    ~OAIGetPost_200_response() override;
    ...
    QList<OAIGetPost_200_response_actions_summary_inner> getActionsSummary() const;
    void setActionsSummary(const QList<OAIGetPost_200_response_actions_summary_inner> &actions_summary);
    ...
    QJsonValue getScore() const;
    void setScore(const QJsonValue &score);
...
private:
    ...
    QList<OAIGetPost_200_response_actions_summary_inner> m_actions_summary;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetPost_200_response)

#endif // OAIGetPost_200_response_H
