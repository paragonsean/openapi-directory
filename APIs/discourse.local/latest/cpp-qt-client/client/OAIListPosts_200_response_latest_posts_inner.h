...
/*
 * OAIListPosts_200_response_latest_posts_inner.h
 *
 * 
 */

#ifndef OAIListPosts_200_response_latest_posts_inner_H
#define OAIListPosts_200_response_latest_posts_inner_H
...
namespace OpenAPI {
class OAIListPosts_200_response_latest_posts_inner_actions_summary_inner;

class OAIListPosts_200_response_latest_posts_inner : public OAIObject {
public:
    OAIListPosts_200_response_latest_posts_inner();
    OAIListPosts_200_response_latest_posts_inner(QString json);
    ~OAIListPosts_200_response_latest_posts_inner() override;
    ...
    QList<OAIListPosts_200_response_latest_posts_inner_actions_summary_inner> getActionsSummary() const;
    void setActionsSummary(const QList<OAIListPosts_200_response_latest_posts_inner_actions_summary_inner> &actions_summary);
    ...
    QString getTopicHtmlTitle() const;
    void setTopicHtmlTitle(const QString &topic_html_title);
    bool is_topic_html_title_Set() const;
    bool is_topic_html_title_Valid() const;
    ...
    QString getTopicTitle() const;
    void setTopicTitle(const QString &topic_title);
    bool is_topic_title_Set() const;
    bool is_topic_title_Valid() const;
...
private:
    ...
    QList<OAIListPosts_200_response_latest_posts_inner_actions_summary_inner> m_actions_summary;
    ...
    QString m_topic_html_title;
    bool m_topic_html_title_isSet;
    bool m_topic_html_title_isValid;
    ...
    QString m_topic_title;
    bool m_topic_title_isSet;
    bool m_topic_title_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListPosts_200_response_latest_posts_inner)

#endif // OAIListPosts_200_response_latest_posts_inner_H
