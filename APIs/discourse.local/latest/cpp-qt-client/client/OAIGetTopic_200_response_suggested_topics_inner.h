...
/*
 * OAIGetTopic_200_response_suggested_topics_inner.h
 *
 * 
 */

#ifndef OAIGetTopic_200_response_suggested_topics_inner_H
#define OAIGetTopic_200_response_suggested_topics_inner_H
...
class OAIGetTopic_200_response_suggested_topics_inner : public OAIObject {
public:
    OAIGetTopic_200_response_suggested_topics_inner();
    OAIGetTopic_200_response_suggested_topics_inner(QString json);
    ~OAIGetTopic_200_response_suggested_topics_inner() override;
    ...
    QString getBookmarked() const;
    void setBookmarked(const QString &bookmarked);
    ...
    QList<OAIGetTopic_200_response_suggested_topics_inner_posters_inner> getPosters() const;
    void setPosters(const QList<OAIGetTopic_200_response_suggested_topics_inner_posters_inner> &posters);
...
private:
    ...
    QList<OAIGetTopic_200_response_suggested_topics_inner_posters_inner> m_posters;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetTopic_200_response_suggested_topics_inner)

#endif // OAIGetTopic_200_response_suggested_topics_inner_H
