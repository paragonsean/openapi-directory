...
QString OAIUpdateUser_200_response::getSuccess() const {
    return m_success;
}
void OAIUpdateUser_200_response::setSuccess(const QString &success) {
    m_success = success;
    m_success_isSet = true;
}

bool OAIUpdateUser_200_response::is_success_Set() const{
    return m_success_isSet;
}

bool OAIUpdateUser_200_response::is_success_Valid() const{
    return m_success_isValid;
}

OAIObject OAIUpdateUser_200_response::getUser() const {
    return m_user;
}
void OAIUpdateUser_200_response::setUser(const OAIObject &user) {
    m_user = user;
    m_user_isSet = true;
}

bool OAIUpdateUser_200_response::is_user_Set() const{
    return m_user_isSet;
}

bool OAIUpdateUser_200_response::is_user_Valid() const{
...
bool OAIUpdateUser_200_response::isValid() const {
    ...
    return m_success_isValid && m_user_isValid && true;
}
