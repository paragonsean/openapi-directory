...
/*
 * OAIListGroups_200_response_groups_inner.h
 *
 * 
 */

#ifndef OAIListGroups_200_response_groups_inner_H
#define OAIListGroups_200_response_groups_inner_H
...
class OAIListGroups_200_response_groups_inner : public OAIObject {
public:
    OAIListGroups_200_response_groups_inner();
    OAIListGroups_200_response_groups_inner(QString json);
    ~OAIListGroups_200_response_groups_inner() override;
    ...
    bool isIsGroupOwner() const;
    void setIsGroupOwner(const bool &is_group_owner);
    bool is_is_group_owner_Set() const;
    bool is_is_group_owner_Valid() const;
...
private:
    ...
    bool m_is_group_owner;
    bool m_is_group_owner_isSet;
    bool m_is_group_owner_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListGroups_200_response_groups_inner)

#endif // OAIListGroups_200_response_groups_inner_H
