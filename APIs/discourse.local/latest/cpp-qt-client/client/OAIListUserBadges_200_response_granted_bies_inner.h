...
/*
 * OAIListUserBadges_200_response_granted_bies_inner.h
 *
 * 
 */

#ifndef OAIListUserBadges_200_response_granted_bies_inner_H
#define OAIListUserBadges_200_response_granted_bies_inner_H
...
class OAIListUserBadges_200_response_granted_bies_inner : public OAIObject {
public:
    OAIListUserBadges_200_response_granted_bies_inner();
    OAIListUserBadges_200_response_granted_bies_inner(QString json);
    ~OAIListUserBadges_200_response_granted_bies_inner() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListUserBadges_200_response_granted_bies_inner)

#endif // OAIListUserBadges_200_response_granted_bies_inner_H
