...
#include "OAICreateGroup_request_group.h"
#include <QJsonValue>
#include <QMap>
...
public:
    ...
    OAICreateGroup_request_group getGroup() const;
    void setGroup(const OAICreateGroup_request_group &group);
...
private:
    ...
    OAICreateGroup_request_group m_group;
    bool m_group_isSet;
