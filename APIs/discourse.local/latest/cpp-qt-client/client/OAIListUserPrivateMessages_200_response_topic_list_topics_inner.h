...
/*
 * OAIListUserPrivateMessages_200_response_topic_list_topics_inner.h
 *
 * 
 */

#ifndef OAIListUserPrivateMessages_200_response_topic_list_topics_inner_H
#define OAIListUserPrivateMessages_200_response_topic_list_topics_inner_H
...
namespace OpenAPI {
class OAIListUserPrivateMessages_200_response_topic_list_topics_inner_participants_inner;
class OAIListLatestTopics_200_response_topic_list_topics_inner_posters_inner;

class OAIListUserPrivateMessages_200_response_topic_list_topics_inner : public OAIObject {
public:
    OAIListUserPrivateMessages_200_response_topic_list_topics_inner();
    OAIListUserPrivateMessages_200_response_topic_list_topics_inner(QString json);
    ~OAIListUserPrivateMessages_200_response_topic_list_topics_inner() override;
    ...
    QList<OAIListUserPrivateMessages_200_response_topic_list_topics_inner_participants_inner> getParticipants() const;
    void setParticipants(const QList<OAIListUserPrivateMessages_200_response_topic_list_topics_inner_participants_inner> &participants);
...
private:
    ...
    QList<OAIListUserPrivateMessages_200_response_topic_list_topics_inner_participants_inner> m_participants;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListUserPrivateMessages_200_response_topic_list_topics_inner)

#endif // OAIListUserPrivateMessages_200_response_topic_list_topics_inner_H
