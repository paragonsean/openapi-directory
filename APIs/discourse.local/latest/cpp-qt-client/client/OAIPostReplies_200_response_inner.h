...
/*
 * OAIPostReplies_200_response_inner.h
 *
 * 
 */

#ifndef OAIPostReplies_200_response_inner_H
#define OAIPostReplies_200_response_inner_H

#include <QJsonObject>

#include "OAICreateTopicPostPM_200_response_actions_summary_inner.h"
#include "OAIPostReplies_200_response_inner_reply_to_user.h"
#include <QList>
#include <QString>
...
class OAIPostReplies_200_response_inner : public OAIObject {
public:
    OAIPostReplies_200_response_inner();
    OAIPostReplies_200_response_inner(QString json);
    ~OAIPostReplies_200_response_inner() override;
    ...
    qint32 getReplyToPostNumber() const;
    void setReplyToPostNumber(const qint32 &reply_to_post_number);
    bool is_reply_to_post_number_Set() const;
    bool is_reply_to_post_number_Valid() const;

    OAIPostReplies_200_response_inner_reply_to_user getReplyToUser() const;
    void setReplyToUser(const OAIPostReplies_200_response_inner_reply_to_user &reply_to_user);
...
private:
    ...
    qint32 m_reply_to_post_number;
    bool m_reply_to_post_number_isSet;
    bool m_reply_to_post_number_isValid;

    OAIPostReplies_200_response_inner_reply_to_user m_reply_to_user;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPostReplies_200_response_inner)

#endif // OAIPostReplies_200_response_inner_H
