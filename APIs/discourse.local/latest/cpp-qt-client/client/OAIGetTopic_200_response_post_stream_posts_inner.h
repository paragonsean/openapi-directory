...
/*
 * OAIGetTopic_200_response_post_stream_posts_inner.h
 *
 * 
 */

#ifndef OAIGetTopic_200_response_post_stream_posts_inner_H
#define OAIGetTopic_200_response_post_stream_posts_inner_H
...
class OAIGetTopic_200_response_post_stream_posts_inner : public OAIObject {
public:
    OAIGetTopic_200_response_post_stream_posts_inner();
    OAIGetTopic_200_response_post_stream_posts_inner(QString json);
    ~OAIGetTopic_200_response_post_stream_posts_inner() override;
    ...
    QList<OAIGetTopic_200_response_post_stream_posts_inner_link_counts_inner> getLinkCounts() const;
    void setLinkCounts(const QList<OAIGetTopic_200_response_post_stream_posts_inner_link_counts_inner> &link_counts);
    bool is_link_counts_Set() const;
    bool is_link_counts_Valid() const;
...
private:
    ...
    QList<OAIGetTopic_200_response_post_stream_posts_inner_link_counts_inner> m_link_counts;
    bool m_link_counts_isSet;
    bool m_link_counts_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetTopic_200_response_post_stream_posts_inner)

#endif // OAIGetTopic_200_response_post_stream_posts_inner_H
