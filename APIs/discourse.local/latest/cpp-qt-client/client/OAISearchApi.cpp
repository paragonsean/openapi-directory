...
void OAISearchApi::search(const ::OpenAPI::OptionalParam<QString> &q, const ::OpenAPI::OptionalParam<qint32> &page) {
    QString fullPath = QString(_serverConfigs["search"][_serverIndices.value("search")].URL()+"/search.json");
