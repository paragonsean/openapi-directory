...
/*
 * OAIGetTag_200_response.h
 *
 * 
 */

#ifndef OAIGetTag_200_response_H
#define OAIGetTag_200_response_H
...
namespace OpenAPI {
class OAIGetTag_200_response_topic_list;
class OAIListLatestTopics_200_response_users_inner;

class OAIGetTag_200_response : public OAIObject {
public:
    OAIGetTag_200_response();
    OAIGetTag_200_response(QString json);
    ~OAIGetTag_200_response() override;
    ...
    OAIGetTag_200_response_topic_list getTopicList() const;
    void setTopicList(const OAIGetTag_200_response_topic_list &topic_list);
...
private:
    ...
    OAIGetTag_200_response_topic_list m_topic_list;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetTag_200_response)

#endif // OAIGetTag_200_response_H
