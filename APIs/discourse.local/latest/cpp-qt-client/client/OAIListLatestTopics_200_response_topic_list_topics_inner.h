...
/*
 * OAIListLatestTopics_200_response_topic_list_topics_inner.h
 *
 * 
 */

#ifndef OAIListLatestTopics_200_response_topic_list_topics_inner_H
#define OAIListLatestTopics_200_response_topic_list_topics_inner_H

#include <QJsonObject>

#include "OAIListLatestTopics_200_response_topic_list_topics_inner_posters_inner.h"
#include <QList>
#include <QString>
...
namespace OpenAPI {
class OAIListLatestTopics_200_response_topic_list_topics_inner_posters_inner;

class OAIListLatestTopics_200_response_topic_list_topics_inner : public OAIObject {
public:
    OAIListLatestTopics_200_response_topic_list_topics_inner();
    OAIListLatestTopics_200_response_topic_list_topics_inner(QString json);
    ~OAIListLatestTopics_200_response_topic_list_topics_inner() override;
    ...
    QList<OAIListLatestTopics_200_response_topic_list_topics_inner_posters_inner> getPosters() const;
    void setPosters(const QList<OAIListLatestTopics_200_response_topic_list_topics_inner_posters_inner> &posters);
...
private:
    ...
    QList<OAIListLatestTopics_200_response_topic_list_topics_inner_posters_inner> m_posters;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListLatestTopics_200_response_topic_list_topics_inner)

#endif // OAIListLatestTopics_200_response_topic_list_topics_inner_H
