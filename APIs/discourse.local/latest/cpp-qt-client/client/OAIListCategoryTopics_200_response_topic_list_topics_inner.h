...
/*
 * OAIListCategoryTopics_200_response_topic_list_topics_inner.h
 *
 * 
 */

#ifndef OAIListCategoryTopics_200_response_topic_list_topics_inner_H
#define OAIListCategoryTopics_200_response_topic_list_topics_inner_H
...
class OAIListCategoryTopics_200_response_topic_list_topics_inner : public OAIObject {
public:
    OAIListCategoryTopics_200_response_topic_list_topics_inner();
    OAIListCategoryTopics_200_response_topic_list_topics_inner(QString json);
    ~OAIListCategoryTopics_200_response_topic_list_topics_inner() override;
    ...
    QList<OAIListCategoryTopics_200_response_topic_list_topics_inner_posters_inner> getPosters() const;
    void setPosters(const QList<OAIListCategoryTopics_200_response_topic_list_topics_inner_posters_inner> &posters);
...
private:
    ...
    QList<OAIListCategoryTopics_200_response_topic_list_topics_inner_posters_inner> m_posters;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListCategoryTopics_200_response_topic_list_topics_inner)

#endif // OAIListCategoryTopics_200_response_topic_list_topics_inner_H
