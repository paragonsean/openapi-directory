...
OAIGetSite_200_response_categories_inner::OAIGetSite_200_response_categories_inner(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetSite_200_response_categories_inner::OAIGetSite_200_response_categories_inner() {
    this->initializeModel();
}

OAIGetSite_200_response_categories_inner::~OAIGetSite_200_response_categories_inner() {}

void OAIGetSite_200_response_categories_inner::initializeModel() {
...
void OAIGetSite_200_response_categories_inner::fromJson(QString jsonString) {
...
void OAIGetSite_200_response_categories_inner::fromJsonObject(QJsonObject json) {
...
QString OAIGetSite_200_response_categories_inner::asJson() const {
...
QJsonObject OAIGetSite_200_response_categories_inner::asJsonObject() const {
    QJsonObject obj;
...
bool OAIGetSite_200_response_categories_inner::isAllowGlobalTags() const {
    return m_allow_global_tags;
}
void OAIGetSite_200_response_categories_inner::setAllowGlobalTags(const bool &allow_global_tags) {
    m_allow_global_tags = allow_global_tags;
    m_allow_global_tags_isSet = true;
}

bool OAIGetSite_200_response_categories_inner::is_allow_global_tags_Set() const{
    return m_allow_global_tags_isSet;
}

bool OAIGetSite_200_response_categories_inner::is_allow_global_tags_Valid() const{
    return m_allow_global_tags_isValid;
}

QList<QJsonValue> OAIGetSite_200_response_categories_inner::getAllowedTagGroups() const {
    return m_allowed_tag_groups;
}
void OAIGetSite_200_response_categories_inner::setAllowedTagGroups(const QList<QJsonValue> &allowed_tag_groups) {
    m_allowed_tag_groups = allowed_tag_groups;
    m_allowed_tag_groups_isSet = true;
}

bool OAIGetSite_200_response_categories_inner::is_allowed_tag_groups_Set() const{
    return m_allowed_tag_groups_isSet;
}

bool OAIGetSite_200_response_categories_inner::is_allowed_tag_groups_Valid() const{
    return m_allowed_tag_groups_isValid;
}

QList<QJsonValue> OAIGetSite_200_response_categories_inner::getAllowedTags() const {
    return m_allowed_tags;
}
void OAIGetSite_200_response_categories_inner::setAllowedTags(const QList<QJsonValue> &allowed_tags) {
    m_allowed_tags = allowed_tags;
    m_allowed_tags_isSet = true;
}

bool OAIGetSite_200_response_categories_inner::is_allowed_tags_Set() const{
    return m_allowed_tags_isSet;
}

bool OAIGetSite_200_response_categories_inner::is_allowed_tags_Valid() const{
    return m_allowed_tags_isValid;
}

bool OAIGetSite_200_response_categories_inner::isCanEdit() const {
    return m_can_edit;
}
void OAIGetSite_200_response_categories_inner::setCanEdit(const bool &can_edit) {
    m_can_edit = can_edit;
    m_can_edit_isSet = true;
}

bool OAIGetSite_200_response_categories_inner::is_can_edit_Set() const{
    return m_can_edit_isSet;
}

bool OAIGetSite_200_response_categories_inner::is_can_edit_Valid() const{
    return m_can_edit_isValid;
}

QString OAIGetSite_200_response_categories_inner::getColor() const {
    return m_color;
}
void OAIGetSite_200_response_categories_inner::setColor(const QString &color) {
    m_color = color;
    m_color_isSet = true;
}

bool OAIGetSite_200_response_categories_inner::is_color_Set() const{
    return m_color_isSet;
}

bool OAIGetSite_200_response_categories_inner::is_color_Valid() const{
    return m_color_isValid;
}

QMap<QString, QJsonValue> OAIGetSite_200_response_categories_inner::getCustomFields() const {
    return m_custom_fields;
}
void OAIGetSite_200_response_categories_inner::setCustomFields(const QMap<QString, QJsonValue> &custom_fields) {
    m_custom_fields = custom_fields;
    m_custom_fields_isSet = true;
}

bool OAIGetSite_200_response_categories_inner::is_custom_fields_Set() const{
    return m_custom_fields_isSet;
}

bool OAIGetSite_200_response_categories_inner::is_custom_fields_Valid() const{
    return m_custom_fields_isValid;
}

QString OAIGetSite_200_response_categories_inner::getDefaultListFilter() const {
    return m_default_list_filter;
}
void OAIGetSite_200_response_categories_inner::setDefaultListFilter(const QString &default_list_filter) {
    m_default_list_filter = default_list_filter;
    m_default_list_filter_isSet = true;
}

bool OAIGetSite_200_response_categories_inner::is_default_list_filter_Set() const{
    return m_default_list_filter_isSet;
}

bool OAIGetSite_200_response_categories_inner::is_default_list_filter_Valid() const{
    return m_default_list_filter_isValid;
}

QString OAIGetSite_200_response_categories_inner::getDefaultTopPeriod() const {
    return m_default_top_period;
}
void OAIGetSite_200_response_categories_inner::setDefaultTopPeriod(const QString &default_top_period) {
    m_default_top_period = default_top_period;
    m_default_top_period_isSet = true;
}

bool OAIGetSite_200_response_categories_inner::is_default_top_period_Set() const{
    return m_default_top_period_isSet;
}

bool OAIGetSite_200_response_categories_inner::is_default_top_period_Valid() const{
    return m_default_top_period_isValid;
}

QString OAIGetSite_200_response_categories_inner::getDefaultView() const {
    return m_default_view;
}
void OAIGetSite_200_response_categories_inner::setDefaultView(const QString &default_view) {
    m_default_view = default_view;
    m_default_view_isSet = true;
}

bool OAIGetSite_200_response_categories_inner::is_default_view_Set() const{
    return m_default_view_isSet;
}

bool OAIGetSite_200_response_categories_inner::is_default_view_Valid() const{
    return m_default_view_isValid;
}

QString OAIGetSite_200_response_categories_inner::getDescription() const {
    return m_description;
}
void OAIGetSite_200_response_categories_inner::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAIGetSite_200_response_categories_inner::is_description_Set() const{
    return m_description_isSet;
}

bool OAIGetSite_200_response_categories_inner::is_description_Valid() const{
    return m_description_isValid;
}

QString OAIGetSite_200_response_categories_inner::getDescriptionExcerpt() const {
    return m_description_excerpt;
}
void OAIGetSite_200_response_categories_inner::setDescriptionExcerpt(const QString &description_excerpt) {
    m_description_excerpt = description_excerpt;
    m_description_excerpt_isSet = true;
}

bool OAIGetSite_200_response_categories_inner::is_description_excerpt_Set() const{
    return m_description_excerpt_isSet;
}

bool OAIGetSite_200_response_categories_inner::is_description_excerpt_Valid() const{
    return m_description_excerpt_isValid;
}

QString OAIGetSite_200_response_categories_inner::getDescriptionText() const {
    return m_description_text;
}
void OAIGetSite_200_response_categories_inner::setDescriptionText(const QString &description_text) {
    m_description_text = description_text;
    m_description_text_isSet = true;
}

bool OAIGetSite_200_response_categories_inner::is_description_text_Set() const{
    return m_description_text_isSet;
}

bool OAIGetSite_200_response_categories_inner::is_description_text_Valid() const{
    return m_description_text_isValid;
}

QList<QJsonValue> OAIGetSite_200_response_categories_inner::getFormTemplateIds() const {
    return m_form_template_ids;
}
void OAIGetSite_200_response_categories_inner::setFormTemplateIds(const QList<QJsonValue> &form_template_ids) {
    m_form_template_ids = form_template_ids;
    m_form_template_ids_isSet = true;
}

bool OAIGetSite_200_response_categories_inner::is_form_template_ids_Set() const{
    return m_form_template_ids_isSet;
}

bool OAIGetSite_200_response_categories_inner::is_form_template_ids_Valid() const{
    return m_form_template_ids_isValid;
}

bool OAIGetSite_200_response_categories_inner::isHasChildren() const {
    return m_has_children;
}
void OAIGetSite_200_response_categories_inner::setHasChildren(const bool &has_children) {
    m_has_children = has_children;
    m_has_children_isSet = true;
}

bool OAIGetSite_200_response_categories_inner::is_has_children_Set() const{
    return m_has_children_isSet;
}

bool OAIGetSite_200_response_categories_inner::is_has_children_Valid() const{
    return m_has_children_isValid;
}

qint32 OAIGetSite_200_response_categories_inner::getId() const {
    return m_id;
}
void OAIGetSite_200_response_categories_inner::setId(const qint32 &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIGetSite_200_response_categories_inner::is_id_Set() const{
    return m_id_isSet;
}

bool OAIGetSite_200_response_categories_inner::is_id_Valid() const{
    return m_id_isValid;
}

qint32 OAIGetSite_200_response_categories_inner::getMinimumRequiredTags() const {
    return m_minimum_required_tags;
}
void OAIGetSite_200_response_categories_inner::setMinimumRequiredTags(const qint32 &minimum_required_tags) {
    m_minimum_required_tags = minimum_required_tags;
    m_minimum_required_tags_isSet = true;
}

bool OAIGetSite_200_response_categories_inner::is_minimum_required_tags_Set() const{
    return m_minimum_required_tags_isSet;
}

bool OAIGetSite_200_response_categories_inner::is_minimum_required_tags_Valid() const{
    return m_minimum_required_tags_isValid;
}

QString OAIGetSite_200_response_categories_inner::getName() const {
    return m_name;
}
void OAIGetSite_200_response_categories_inner::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIGetSite_200_response_categories_inner::is_name_Set() const{
    return m_name_isSet;
}

bool OAIGetSite_200_response_categories_inner::is_name_Valid() const{
    return m_name_isValid;
}

bool OAIGetSite_200_response_categories_inner::isNavigateToFirstPostAfterRead() const {
    return m_navigate_to_first_post_after_read;
}
void OAIGetSite_200_response_categories_inner::setNavigateToFirstPostAfterRead(const bool &navigate_to_first_post_after_read) {
    m_navigate_to_first_post_after_read = navigate_to_first_post_after_read;
    m_navigate_to_first_post_after_read_isSet = true;
}

bool OAIGetSite_200_response_categories_inner::is_navigate_to_first_post_after_read_Set() const{
    return m_navigate_to_first_post_after_read_isSet;
}

bool OAIGetSite_200_response_categories_inner::is_navigate_to_first_post_after_read_Valid() const{
    return m_navigate_to_first_post_after_read_isValid;
}

qint32 OAIGetSite_200_response_categories_inner::getNotificationLevel() const {
    return m_notification_level;
}
void OAIGetSite_200_response_categories_inner::setNotificationLevel(const qint32 &notification_level) {
    m_notification_level = notification_level;
    m_notification_level_isSet = true;
}

bool OAIGetSite_200_response_categories_inner::is_notification_level_Set() const{
    return m_notification_level_isSet;
}

bool OAIGetSite_200_response_categories_inner::is_notification_level_Valid() const{
    return m_notification_level_isValid;
}

qint32 OAIGetSite_200_response_categories_inner::getNumFeaturedTopics() const {
    return m_num_featured_topics;
}
void OAIGetSite_200_response_categories_inner::setNumFeaturedTopics(const qint32 &num_featured_topics) {
    m_num_featured_topics = num_featured_topics;
    m_num_featured_topics_isSet = true;
}

bool OAIGetSite_200_response_categories_inner::is_num_featured_topics_Set() const{
    return m_num_featured_topics_isSet;
}

bool OAIGetSite_200_response_categories_inner::is_num_featured_topics_Valid() const{
    return m_num_featured_topics_isValid;
}

qint32 OAIGetSite_200_response_categories_inner::getParentCategoryId() const {
    return m_parent_category_id;
}
void OAIGetSite_200_response_categories_inner::setParentCategoryId(const qint32 &parent_category_id) {
    m_parent_category_id = parent_category_id;
    m_parent_category_id_isSet = true;
}

bool OAIGetSite_200_response_categories_inner::is_parent_category_id_Set() const{
    return m_parent_category_id_isSet;
}

bool OAIGetSite_200_response_categories_inner::is_parent_category_id_Valid() const{
    return m_parent_category_id_isValid;
}

qint32 OAIGetSite_200_response_categories_inner::getPermission() const {
    return m_permission;
}
void OAIGetSite_200_response_categories_inner::setPermission(const qint32 &permission) {
    m_permission = permission;
    m_permission_isSet = true;
}

bool OAIGetSite_200_response_categories_inner::is_permission_Set() const{
    return m_permission_isSet;
}

bool OAIGetSite_200_response_categories_inner::is_permission_Valid() const{
    return m_permission_isValid;
}

qint32 OAIGetSite_200_response_categories_inner::getPosition() const {
    return m_position;
}
void OAIGetSite_200_response_categories_inner::setPosition(const qint32 &position) {
    m_position = position;
    m_position_isSet = true;
}

bool OAIGetSite_200_response_categories_inner::is_position_Set() const{
    return m_position_isSet;
}

bool OAIGetSite_200_response_categories_inner::is_position_Valid() const{
    return m_position_isValid;
}

qint32 OAIGetSite_200_response_categories_inner::getPostCount() const {
    return m_post_count;
}
void OAIGetSite_200_response_categories_inner::setPostCount(const qint32 &post_count) {
    m_post_count = post_count;
    m_post_count_isSet = true;
}

bool OAIGetSite_200_response_categories_inner::is_post_count_Set() const{
    return m_post_count_isSet;
}

bool OAIGetSite_200_response_categories_inner::is_post_count_Valid() const{
    return m_post_count_isValid;
}

QString OAIGetSite_200_response_categories_inner::getReadOnlyBanner() const {
    return m_read_only_banner;
}
void OAIGetSite_200_response_categories_inner::setReadOnlyBanner(const QString &read_only_banner) {
    m_read_only_banner = read_only_banner;
    m_read_only_banner_isSet = true;
}

bool OAIGetSite_200_response_categories_inner::is_read_only_banner_Set() const{
    return m_read_only_banner_isSet;
}

bool OAIGetSite_200_response_categories_inner::is_read_only_banner_Valid() const{
    return m_read_only_banner_isValid;
}

bool OAIGetSite_200_response_categories_inner::isReadRestricted() const {
    return m_read_restricted;
}
void OAIGetSite_200_response_categories_inner::setReadRestricted(const bool &read_restricted) {
    m_read_restricted = read_restricted;
    m_read_restricted_isSet = true;
}

bool OAIGetSite_200_response_categories_inner::is_read_restricted_Set() const{
    return m_read_restricted_isSet;
}

bool OAIGetSite_200_response_categories_inner::is_read_restricted_Valid() const{
    return m_read_restricted_isValid;
}

QList<OAIGetCategory_200_response_category_required_tag_groups_inner> OAIGetSite_200_response_categories_inner::getRequiredTagGroups() const {
    return m_required_tag_groups;
}
void OAIGetSite_200_response_categories_inner::setRequiredTagGroups(const QList<OAIGetCategory_200_response_category_required_tag_groups_inner> &required_tag_groups) {
    m_required_tag_groups = required_tag_groups;
    m_required_tag_groups_isSet = true;
}

bool OAIGetSite_200_response_categories_inner::is_required_tag_groups_Set() const{
    return m_required_tag_groups_isSet;
}

bool OAIGetSite_200_response_categories_inner::is_required_tag_groups_Valid() const{
    return m_required_tag_groups_isValid;
}

bool OAIGetSite_200_response_categories_inner::isShowSubcategoryList() const {
    return m_show_subcategory_list;
}
void OAIGetSite_200_response_categories_inner::setShowSubcategoryList(const bool &show_subcategory_list) {
    m_show_subcategory_list = show_subcategory_list;
    m_show_subcategory_list_isSet = true;
}

bool OAIGetSite_200_response_categories_inner::is_show_subcategory_list_Set() const{
    return m_show_subcategory_list_isSet;
}

bool OAIGetSite_200_response_categories_inner::is_show_subcategory_list_Valid() const{
    return m_show_subcategory_list_isValid;
}

QString OAIGetSite_200_response_categories_inner::getSlug() const {
    return m_slug;
}
void OAIGetSite_200_response_categories_inner::setSlug(const QString &slug) {
    m_slug = slug;
    m_slug_isSet = true;
}

bool OAIGetSite_200_response_categories_inner::is_slug_Set() const{
    return m_slug_isSet;
}

bool OAIGetSite_200_response_categories_inner::is_slug_Valid() const{
    return m_slug_isValid;
}

QString OAIGetSite_200_response_categories_inner::getSortAscending() const {
    return m_sort_ascending;
}
void OAIGetSite_200_response_categories_inner::setSortAscending(const QString &sort_ascending) {
    m_sort_ascending = sort_ascending;
    m_sort_ascending_isSet = true;
}

bool OAIGetSite_200_response_categories_inner::is_sort_ascending_Set() const{
    return m_sort_ascending_isSet;
}

bool OAIGetSite_200_response_categories_inner::is_sort_ascending_Valid() const{
    return m_sort_ascending_isValid;
}

QString OAIGetSite_200_response_categories_inner::getSortOrder() const {
    return m_sort_order;
}
void OAIGetSite_200_response_categories_inner::setSortOrder(const QString &sort_order) {
    m_sort_order = sort_order;
    m_sort_order_isSet = true;
}

bool OAIGetSite_200_response_categories_inner::is_sort_order_Set() const{
    return m_sort_order_isSet;
}

bool OAIGetSite_200_response_categories_inner::is_sort_order_Valid() const{
    return m_sort_order_isValid;
}

QString OAIGetSite_200_response_categories_inner::getSubcategoryListStyle() const {
    return m_subcategory_list_style;
}
void OAIGetSite_200_response_categories_inner::setSubcategoryListStyle(const QString &subcategory_list_style) {
    m_subcategory_list_style = subcategory_list_style;
    m_subcategory_list_style_isSet = true;
}

bool OAIGetSite_200_response_categories_inner::is_subcategory_list_style_Set() const{
    return m_subcategory_list_style_isSet;
}

bool OAIGetSite_200_response_categories_inner::is_subcategory_list_style_Valid() const{
    return m_subcategory_list_style_isValid;
}

QString OAIGetSite_200_response_categories_inner::getTextColor() const {
    return m_text_color;
}
void OAIGetSite_200_response_categories_inner::setTextColor(const QString &text_color) {
    m_text_color = text_color;
    m_text_color_isSet = true;
}

bool OAIGetSite_200_response_categories_inner::is_text_color_Set() const{
    return m_text_color_isSet;
}

bool OAIGetSite_200_response_categories_inner::is_text_color_Valid() const{
    return m_text_color_isValid;
}

qint32 OAIGetSite_200_response_categories_inner::getTopicCount() const {
    return m_topic_count;
}
void OAIGetSite_200_response_categories_inner::setTopicCount(const qint32 &topic_count) {
    m_topic_count = topic_count;
    m_topic_count_isSet = true;
}

bool OAIGetSite_200_response_categories_inner::is_topic_count_Set() const{
    return m_topic_count_isSet;
}

bool OAIGetSite_200_response_categories_inner::is_topic_count_Valid() const{
    return m_topic_count_isValid;
}

QString OAIGetSite_200_response_categories_inner::getTopicTemplate() const {
    return m_topic_template;
}
void OAIGetSite_200_response_categories_inner::setTopicTemplate(const QString &topic_template) {
    m_topic_template = topic_template;
    m_topic_template_isSet = true;
}

bool OAIGetSite_200_response_categories_inner::is_topic_template_Set() const{
    return m_topic_template_isSet;
}

bool OAIGetSite_200_response_categories_inner::is_topic_template_Valid() const{
    return m_topic_template_isValid;
}

QString OAIGetSite_200_response_categories_inner::getTopicUrl() const {
    return m_topic_url;
}
void OAIGetSite_200_response_categories_inner::setTopicUrl(const QString &topic_url) {
    m_topic_url = topic_url;
    m_topic_url_isSet = true;
}

bool OAIGetSite_200_response_categories_inner::is_topic_url_Set() const{
    return m_topic_url_isSet;
}

bool OAIGetSite_200_response_categories_inner::is_topic_url_Valid() const{
    return m_topic_url_isValid;
}

QString OAIGetSite_200_response_categories_inner::getUploadedBackground() const {
    return m_uploaded_background;
}
void OAIGetSite_200_response_categories_inner::setUploadedBackground(const QString &uploaded_background) {
    m_uploaded_background = uploaded_background;
    m_uploaded_background_isSet = true;
}

bool OAIGetSite_200_response_categories_inner::is_uploaded_background_Set() const{
    return m_uploaded_background_isSet;
}

bool OAIGetSite_200_response_categories_inner::is_uploaded_background_Valid() const{
    return m_uploaded_background_isValid;
}

QString OAIGetSite_200_response_categories_inner::getUploadedLogo() const {
    return m_uploaded_logo;
}
void OAIGetSite_200_response_categories_inner::setUploadedLogo(const QString &uploaded_logo) {
    m_uploaded_logo = uploaded_logo;
    m_uploaded_logo_isSet = true;
}

bool OAIGetSite_200_response_categories_inner::is_uploaded_logo_Set() const{
    return m_uploaded_logo_isSet;
}

bool OAIGetSite_200_response_categories_inner::is_uploaded_logo_Valid() const{
    return m_uploaded_logo_isValid;
}

QString OAIGetSite_200_response_categories_inner::getUploadedLogoDark() const {
    return m_uploaded_logo_dark;
}
void OAIGetSite_200_response_categories_inner::setUploadedLogoDark(const QString &uploaded_logo_dark) {
    m_uploaded_logo_dark = uploaded_logo_dark;
    m_uploaded_logo_dark_isSet = true;
}

bool OAIGetSite_200_response_categories_inner::is_uploaded_logo_dark_Set() const{
    return m_uploaded_logo_dark_isSet;
}

bool OAIGetSite_200_response_categories_inner::is_uploaded_logo_dark_Valid() const{
    return m_uploaded_logo_dark_isValid;
}

bool OAIGetSite_200_response_categories_inner::isSet() const {
...
bool OAIGetSite_200_response_categories_inner::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_allow_global_tags_isValid && m_allowed_tag_groups_isValid && m_allowed_tags_isValid && m_can_edit_isValid && m_color_isValid && m_default_list_filter_isValid && m_default_top_period_isValid && m_default_view_isValid && m_has_children_isValid && m_id_isValid && m_minimum_required_tags_isValid && m_name_isValid && m_navigate_to_first_post_after_read_isValid && m_notification_level_isValid && m_num_featured_topics_isValid && m_permission_isValid && m_position_isValid && m_post_count_isValid && m_read_only_banner_isValid && m_read_restricted_isValid && m_required_tag_groups_isValid && m_show_subcategory_list_isValid && m_slug_isValid && m_sort_ascending_isValid && m_sort_order_isValid && m_subcategory_list_style_isValid && m_text_color_isValid && m_topic_count_isValid && m_topic_template_isValid && m_topic_url_isValid && m_uploaded_background_isValid && m_uploaded_logo_isValid && m_uploaded_logo_dark_isValid && true;
}
