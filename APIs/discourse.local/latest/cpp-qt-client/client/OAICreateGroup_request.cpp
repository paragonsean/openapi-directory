...
OAICreateGroup_request_group OAICreateGroup_request::getGroup() const {
    return m_group;
}
void OAICreateGroup_request::setGroup(const OAICreateGroup_request_group &group) {
    m_group = group;
    m_group_isSet = true;
}

bool OAICreateGroup_request::is_group_Set() const{
    return m_group_isSet;
}

bool OAICreateGroup_request::is_group_Valid() const{
