...
/*
 * OAIListLatestTopics_200_response.h
 *
 * 
 */

#ifndef OAIListLatestTopics_200_response_H
#define OAIListLatestTopics_200_response_H
...
namespace OpenAPI {
class OAIListLatestTopics_200_response_topic_list;
class OAIListLatestTopics_200_response_users_inner;

class OAIListLatestTopics_200_response : public OAIObject {
public:
    OAIListLatestTopics_200_response();
    OAIListLatestTopics_200_response(QString json);
    ~OAIListLatestTopics_200_response() override;
    ...
    OAIListLatestTopics_200_response_topic_list getTopicList() const;
    void setTopicList(const OAIListLatestTopics_200_response_topic_list &topic_list);
...
private:
    ...
    OAIListLatestTopics_200_response_topic_list m_topic_list;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListLatestTopics_200_response)

#endif // OAIListLatestTopics_200_response_H
