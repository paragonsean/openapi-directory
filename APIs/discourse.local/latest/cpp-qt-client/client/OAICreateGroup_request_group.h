...
/*
 * OAICreateGroup_request_group.h
 *
 * 
 */

#ifndef OAICreateGroup_request_group_H
#define OAICreateGroup_request_group_H
...
class OAICreateGroup_request_group : public OAIObject {
public:
    OAICreateGroup_request_group();
    OAICreateGroup_request_group(QString json);
    ~OAICreateGroup_request_group() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateGroup_request_group)

#endif // OAICreateGroup_request_group_H
