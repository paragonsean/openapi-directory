...
/*
 * OAIListUserPrivateMessages_200_response_topic_list.h
 *
 * 
 */

#ifndef OAIListUserPrivateMessages_200_response_topic_list_H
#define OAIListUserPrivateMessages_200_response_topic_list_H

#include <QJsonObject>

#include "OAIListUserPrivateMessages_200_response_topic_list_topics_inner.h"
#include <QList>
#include <QString>
...
namespace OpenAPI {
class OAIListUserPrivateMessages_200_response_topic_list_topics_inner;

class OAIListUserPrivateMessages_200_response_topic_list : public OAIObject {
public:
    OAIListUserPrivateMessages_200_response_topic_list();
    OAIListUserPrivateMessages_200_response_topic_list(QString json);
    ~OAIListUserPrivateMessages_200_response_topic_list() override;
    ...
    QList<OAIListUserPrivateMessages_200_response_topic_list_topics_inner> getTopics() const;
    void setTopics(const QList<OAIListUserPrivateMessages_200_response_topic_list_topics_inner> &topics);
...
private:
    ...
    QList<OAIListUserPrivateMessages_200_response_topic_list_topics_inner> m_topics;
    bool m_topics_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListUserPrivateMessages_200_response_topic_list)

#endif // OAIListUserPrivateMessages_200_response_topic_list_H
