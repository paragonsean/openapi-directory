...
/*
 * OAIListLatestTopics_200_response_topic_list.h
 *
 * 
 */

#ifndef OAIListLatestTopics_200_response_topic_list_H
#define OAIListLatestTopics_200_response_topic_list_H
...
namespace OpenAPI {
class OAIListLatestTopics_200_response_topic_list_topics_inner;

class OAIListLatestTopics_200_response_topic_list : public OAIObject {
public:
    OAIListLatestTopics_200_response_topic_list();
    OAIListLatestTopics_200_response_topic_list(QString json);
    ~OAIListLatestTopics_200_response_topic_list() override;
    ...
    QList<OAIListLatestTopics_200_response_topic_list_topics_inner> getTopics() const;
    void setTopics(const QList<OAIListLatestTopics_200_response_topic_list_topics_inner> &topics);
...
private:
    ...
    QList<OAIListLatestTopics_200_response_topic_list_topics_inner> m_topics;
    bool m_topics_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListLatestTopics_200_response_topic_list)

#endif // OAIListLatestTopics_200_response_topic_list_H
