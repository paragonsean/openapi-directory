...
public class PostReplies200ResponseInner {
  ...
  private PostReplies200ResponseInnerReplyToUser replyToUser;
  ...
  public PostReplies200ResponseInner() {
  }

  public PostReplies200ResponseInner actionsSummary(List<CreateTopicPostPM200ResponseActionsSummaryInner> actionsSummary) {
    this.actionsSummary = actionsSummary;
    return this;
  }

  public PostReplies200ResponseInner addActionsSummaryItem(CreateTopicPostPM200ResponseActionsSummaryInner actionsSummaryItem) {
  ...
  public PostReplies200ResponseInner admin(Boolean admin) {
    this.admin = admin;
    return this;
  }
  ...
  public PostReplies200ResponseInner avatarTemplate(String avatarTemplate) {
  ...
  public PostReplies200ResponseInner bookmarked(Boolean bookmarked) {
  ...
  public PostReplies200ResponseInner canDelete(Boolean canDelete) {
  ...
  public PostReplies200ResponseInner canEdit(Boolean canEdit) {
  ...
  public PostReplies200ResponseInner canRecover(Boolean canRecover) {
  ...
  public PostReplies200ResponseInner canViewEditHistory(Boolean canViewEditHistory) {
  ...
  public PostReplies200ResponseInner canWiki(Boolean canWiki) {
  ...
  public PostReplies200ResponseInner cooked(String cooked) {
    this.cooked = cooked;
    return this;
  }
  ...
  public PostReplies200ResponseInner createdAt(String createdAt) {
  ...
  public PostReplies200ResponseInner deletedAt(String deletedAt) {
  ...
  public PostReplies200ResponseInner displayUsername(String displayUsername) {
  ...
  public PostReplies200ResponseInner editReason(String editReason) {
  ...
  public PostReplies200ResponseInner flairBgColor(String flairBgColor) {
  ...
  public PostReplies200ResponseInner flairColor(String flairColor) {
  ...
  public PostReplies200ResponseInner flairName(String flairName) {
  ...
  public PostReplies200ResponseInner flairUrl(String flairUrl) {
  ...
  public PostReplies200ResponseInner hidden(Boolean hidden) {
    this.hidden = hidden;
    return this;
  }
  ...
  public PostReplies200ResponseInner id(Integer id) {
    this.id = id;
    return this;
  }
  ...
  public PostReplies200ResponseInner incomingLinkCount(Integer incomingLinkCount) {
  ...
  public PostReplies200ResponseInner moderator(Boolean moderator) {
  ...
  public PostReplies200ResponseInner name(String name) {
    this.name = name;
    return this;
  }
  ...
  public PostReplies200ResponseInner postNumber(Integer postNumber) {
  ...
  public PostReplies200ResponseInner postType(Integer postType) {
  ...
  public PostReplies200ResponseInner primaryGroupName(String primaryGroupName) {
  ...
  public PostReplies200ResponseInner quoteCount(Integer quoteCount) {
  ...
  public PostReplies200ResponseInner readersCount(Integer readersCount) {
  ...
  public PostReplies200ResponseInner reads(Integer reads) {
    this.reads = reads;
    return this;
  }
  ...
  public PostReplies200ResponseInner replyCount(Integer replyCount) {
  ...
  public PostReplies200ResponseInner replyToPostNumber(Integer replyToPostNumber) {
  ...
  public PostReplies200ResponseInner replyToUser(PostReplies200ResponseInnerReplyToUser replyToUser) {
   ...
   */
  @javax.annotation.Nonnull
  public PostReplies200ResponseInnerReplyToUser getReplyToUser() {
    return replyToUser;
  }

  public void setReplyToUser(PostReplies200ResponseInnerReplyToUser replyToUser) {
    this.replyToUser = replyToUser;
  }


  public PostReplies200ResponseInner reviewableId(String reviewableId) {
  ...
  public PostReplies200ResponseInner reviewableScoreCount(Integer reviewableScoreCount) {
  ...
  public PostReplies200ResponseInner reviewableScorePendingCount(Integer reviewableScorePendingCount) {
  ...
  public PostReplies200ResponseInner score(Integer score) {
    this.score = score;
    return this;
  }
  ...
  public PostReplies200ResponseInner staff(Boolean staff) {
    this.staff = staff;
    return this;
  }
  ...
  public PostReplies200ResponseInner topicId(Integer topicId) {
  ...
  public PostReplies200ResponseInner topicSlug(String topicSlug) {
  ...
  public PostReplies200ResponseInner trustLevel(Integer trustLevel) {
  ...
  public PostReplies200ResponseInner updatedAt(String updatedAt) {
  ...
  public PostReplies200ResponseInner userDeleted(Boolean userDeleted) {
  ...
  public PostReplies200ResponseInner userId(Integer userId) {
    this.userId = userId;
    return this;
  }
  ...
  public PostReplies200ResponseInner userTitle(String userTitle) {
  ...
  public PostReplies200ResponseInner username(String username) {
  ...
  public PostReplies200ResponseInner version(Integer version) {
  ...
  public PostReplies200ResponseInner wiki(Boolean wiki) {
    this.wiki = wiki;
    return this;
  }
  ...
  public PostReplies200ResponseInner yours(Boolean yours) {
    this.yours = yours;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    PostReplies200ResponseInner postReplies200ResponseInner = (PostReplies200ResponseInner) o;
    return Objects.equals(this.actionsSummary, postReplies200ResponseInner.actionsSummary) &&
        Objects.equals(this.admin, postReplies200ResponseInner.admin) &&
        Objects.equals(this.avatarTemplate, postReplies200ResponseInner.avatarTemplate) &&
        Objects.equals(this.bookmarked, postReplies200ResponseInner.bookmarked) &&
        Objects.equals(this.canDelete, postReplies200ResponseInner.canDelete) &&
        Objects.equals(this.canEdit, postReplies200ResponseInner.canEdit) &&
        Objects.equals(this.canRecover, postReplies200ResponseInner.canRecover) &&
        Objects.equals(this.canViewEditHistory, postReplies200ResponseInner.canViewEditHistory) &&
        Objects.equals(this.canWiki, postReplies200ResponseInner.canWiki) &&
        Objects.equals(this.cooked, postReplies200ResponseInner.cooked) &&
        Objects.equals(this.createdAt, postReplies200ResponseInner.createdAt) &&
        Objects.equals(this.deletedAt, postReplies200ResponseInner.deletedAt) &&
        Objects.equals(this.displayUsername, postReplies200ResponseInner.displayUsername) &&
        Objects.equals(this.editReason, postReplies200ResponseInner.editReason) &&
        Objects.equals(this.flairBgColor, postReplies200ResponseInner.flairBgColor) &&
        Objects.equals(this.flairColor, postReplies200ResponseInner.flairColor) &&
        Objects.equals(this.flairName, postReplies200ResponseInner.flairName) &&
        Objects.equals(this.flairUrl, postReplies200ResponseInner.flairUrl) &&
        Objects.equals(this.hidden, postReplies200ResponseInner.hidden) &&
        Objects.equals(this.id, postReplies200ResponseInner.id) &&
        Objects.equals(this.incomingLinkCount, postReplies200ResponseInner.incomingLinkCount) &&
        Objects.equals(this.moderator, postReplies200ResponseInner.moderator) &&
        Objects.equals(this.name, postReplies200ResponseInner.name) &&
        Objects.equals(this.postNumber, postReplies200ResponseInner.postNumber) &&
        Objects.equals(this.postType, postReplies200ResponseInner.postType) &&
        Objects.equals(this.primaryGroupName, postReplies200ResponseInner.primaryGroupName) &&
        Objects.equals(this.quoteCount, postReplies200ResponseInner.quoteCount) &&
        Objects.equals(this.readersCount, postReplies200ResponseInner.readersCount) &&
        Objects.equals(this.reads, postReplies200ResponseInner.reads) &&
        Objects.equals(this.replyCount, postReplies200ResponseInner.replyCount) &&
        Objects.equals(this.replyToPostNumber, postReplies200ResponseInner.replyToPostNumber) &&
        Objects.equals(this.replyToUser, postReplies200ResponseInner.replyToUser) &&
        Objects.equals(this.reviewableId, postReplies200ResponseInner.reviewableId) &&
        Objects.equals(this.reviewableScoreCount, postReplies200ResponseInner.reviewableScoreCount) &&
        Objects.equals(this.reviewableScorePendingCount, postReplies200ResponseInner.reviewableScorePendingCount) &&
        Objects.equals(this.score, postReplies200ResponseInner.score) &&
        Objects.equals(this.staff, postReplies200ResponseInner.staff) &&
        Objects.equals(this.topicId, postReplies200ResponseInner.topicId) &&
        Objects.equals(this.topicSlug, postReplies200ResponseInner.topicSlug) &&
        Objects.equals(this.trustLevel, postReplies200ResponseInner.trustLevel) &&
        Objects.equals(this.updatedAt, postReplies200ResponseInner.updatedAt) &&
        Objects.equals(this.userDeleted, postReplies200ResponseInner.userDeleted) &&
        Objects.equals(this.userId, postReplies200ResponseInner.userId) &&
        Objects.equals(this.userTitle, postReplies200ResponseInner.userTitle) &&
        Objects.equals(this.username, postReplies200ResponseInner.username) &&
        Objects.equals(this.version, postReplies200ResponseInner.version) &&
        Objects.equals(this.wiki, postReplies200ResponseInner.wiki) &&
        Objects.equals(this.yours, postReplies200ResponseInner.yours);
  }
  ...
  public String toString() {
    ...
    sb.append("class PostReplies200ResponseInner {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PostReplies200ResponseInner
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PostReplies200ResponseInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PostReplies200ResponseInner is not found in the empty JSON string", PostReplies200ResponseInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PostReplies200ResponseInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PostReplies200ResponseInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PostReplies200ResponseInner.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PostReplies200ResponseInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PostReplies200ResponseInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PostReplies200ResponseInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PostReplies200ResponseInner.class));

       return (TypeAdapter<T>) new TypeAdapter<PostReplies200ResponseInner>() {
           @Override
           public void write(JsonWriter out, PostReplies200ResponseInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PostReplies200ResponseInner read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PostReplies200ResponseInner given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PostReplies200ResponseInner
   * @throws IOException if the JSON string is invalid with respect to PostReplies200ResponseInner
   */
  public static PostReplies200ResponseInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PostReplies200ResponseInner.class);
  }

  /**
   * Convert an instance of PostReplies200ResponseInner to an JSON string
   *
   * @return JSON string
   */
