...
public class AdminGetUser200ResponseGroupsInner {
  ...
  public AdminGetUser200ResponseGroupsInner() {
  }

  public AdminGetUser200ResponseGroupsInner allowMembershipRequests(Boolean allowMembershipRequests) {
  ...
  public AdminGetUser200ResponseGroupsInner automatic(Boolean automatic) {
  ...
  public AdminGetUser200ResponseGroupsInner bioCooked(String bioCooked) {
  ...
  public AdminGetUser200ResponseGroupsInner bioExcerpt(String bioExcerpt) {
  ...
  public AdminGetUser200ResponseGroupsInner bioRaw(String bioRaw) {
    this.bioRaw = bioRaw;
    return this;
  }
  ...
  public AdminGetUser200ResponseGroupsInner canAdminGroup(Boolean canAdminGroup) {
  ...
  public AdminGetUser200ResponseGroupsInner canSeeMembers(Boolean canSeeMembers) {
  ...
  public AdminGetUser200ResponseGroupsInner defaultNotificationLevel(Integer defaultNotificationLevel) {
  ...
  public AdminGetUser200ResponseGroupsInner displayName(String displayName) {
  ...
  public AdminGetUser200ResponseGroupsInner flairBgColor(String flairBgColor) {
  ...
  public AdminGetUser200ResponseGroupsInner flairColor(String flairColor) {
  ...
  public AdminGetUser200ResponseGroupsInner flairUrl(String flairUrl) {
  ...
  public AdminGetUser200ResponseGroupsInner fullName(String fullName) {
  ...
  public AdminGetUser200ResponseGroupsInner grantTrustLevel(String grantTrustLevel) {
  ...
  public AdminGetUser200ResponseGroupsInner hasMessages(Boolean hasMessages) {
  ...
  public AdminGetUser200ResponseGroupsInner id(Integer id) {
    this.id = id;
    return this;
  }
  ...
  public AdminGetUser200ResponseGroupsInner incomingEmail(String incomingEmail) {
  ...
  public AdminGetUser200ResponseGroupsInner membersVisibilityLevel(Integer membersVisibilityLevel) {
  ...
  public AdminGetUser200ResponseGroupsInner membershipRequestTemplate(String membershipRequestTemplate) {
  ...
  public AdminGetUser200ResponseGroupsInner mentionableLevel(Integer mentionableLevel) {
  ...
  public AdminGetUser200ResponseGroupsInner messageableLevel(Integer messageableLevel) {
  ...
  public AdminGetUser200ResponseGroupsInner name(String name) {
    this.name = name;
    return this;
  }
  ...
  public AdminGetUser200ResponseGroupsInner primaryGroup(Boolean primaryGroup) {
  ...
  public AdminGetUser200ResponseGroupsInner publicAdmission(Boolean publicAdmission) {
  ...
  public AdminGetUser200ResponseGroupsInner publicExit(Boolean publicExit) {
  ...
  public AdminGetUser200ResponseGroupsInner publishReadState(Boolean publishReadState) {
  ...
  public AdminGetUser200ResponseGroupsInner title(String title) {
    this.title = title;
    return this;
  }
  ...
  public AdminGetUser200ResponseGroupsInner userCount(Integer userCount) {
  ...
  public AdminGetUser200ResponseGroupsInner visibilityLevel(Integer visibilityLevel) {
   ...
   * @return the AdminGetUser200ResponseGroupsInner instance itself
   */
  public AdminGetUser200ResponseGroupsInner putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    AdminGetUser200ResponseGroupsInner adminGetUser200ResponseGroupsInner = (AdminGetUser200ResponseGroupsInner) o;
    return Objects.equals(this.allowMembershipRequests, adminGetUser200ResponseGroupsInner.allowMembershipRequests) &&
        Objects.equals(this.automatic, adminGetUser200ResponseGroupsInner.automatic) &&
        Objects.equals(this.bioCooked, adminGetUser200ResponseGroupsInner.bioCooked) &&
        Objects.equals(this.bioExcerpt, adminGetUser200ResponseGroupsInner.bioExcerpt) &&
        Objects.equals(this.bioRaw, adminGetUser200ResponseGroupsInner.bioRaw) &&
        Objects.equals(this.canAdminGroup, adminGetUser200ResponseGroupsInner.canAdminGroup) &&
        Objects.equals(this.canSeeMembers, adminGetUser200ResponseGroupsInner.canSeeMembers) &&
        Objects.equals(this.defaultNotificationLevel, adminGetUser200ResponseGroupsInner.defaultNotificationLevel) &&
        Objects.equals(this.displayName, adminGetUser200ResponseGroupsInner.displayName) &&
        Objects.equals(this.flairBgColor, adminGetUser200ResponseGroupsInner.flairBgColor) &&
        Objects.equals(this.flairColor, adminGetUser200ResponseGroupsInner.flairColor) &&
        Objects.equals(this.flairUrl, adminGetUser200ResponseGroupsInner.flairUrl) &&
        Objects.equals(this.fullName, adminGetUser200ResponseGroupsInner.fullName) &&
        Objects.equals(this.grantTrustLevel, adminGetUser200ResponseGroupsInner.grantTrustLevel) &&
        Objects.equals(this.hasMessages, adminGetUser200ResponseGroupsInner.hasMessages) &&
        Objects.equals(this.id, adminGetUser200ResponseGroupsInner.id) &&
        Objects.equals(this.incomingEmail, adminGetUser200ResponseGroupsInner.incomingEmail) &&
        Objects.equals(this.membersVisibilityLevel, adminGetUser200ResponseGroupsInner.membersVisibilityLevel) &&
        Objects.equals(this.membershipRequestTemplate, adminGetUser200ResponseGroupsInner.membershipRequestTemplate) &&
        Objects.equals(this.mentionableLevel, adminGetUser200ResponseGroupsInner.mentionableLevel) &&
        Objects.equals(this.messageableLevel, adminGetUser200ResponseGroupsInner.messageableLevel) &&
        Objects.equals(this.name, adminGetUser200ResponseGroupsInner.name) &&
        Objects.equals(this.primaryGroup, adminGetUser200ResponseGroupsInner.primaryGroup) &&
        Objects.equals(this.publicAdmission, adminGetUser200ResponseGroupsInner.publicAdmission) &&
        Objects.equals(this.publicExit, adminGetUser200ResponseGroupsInner.publicExit) &&
        Objects.equals(this.publishReadState, adminGetUser200ResponseGroupsInner.publishReadState) &&
        Objects.equals(this.title, adminGetUser200ResponseGroupsInner.title) &&
        Objects.equals(this.userCount, adminGetUser200ResponseGroupsInner.userCount) &&
        Objects.equals(this.visibilityLevel, adminGetUser200ResponseGroupsInner.visibilityLevel)&&
        Objects.equals(this.additionalProperties, adminGetUser200ResponseGroupsInner.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(allowMembershipRequests, automatic, bioCooked, bioExcerpt, bioRaw, canAdminGroup, canSeeMembers, defaultNotificationLevel, displayName, flairBgColor, flairColor, flairUrl, fullName, grantTrustLevel, hasMessages, id, incomingEmail, membersVisibilityLevel, membershipRequestTemplate, mentionableLevel, messageableLevel, name, primaryGroup, publicAdmission, publicExit, publishReadState, title, userCount, visibilityLevel, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AdminGetUser200ResponseGroupsInner {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AdminGetUser200ResponseGroupsInner
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AdminGetUser200ResponseGroupsInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AdminGetUser200ResponseGroupsInner is not found in the empty JSON string", AdminGetUser200ResponseGroupsInner.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AdminGetUser200ResponseGroupsInner.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AdminGetUser200ResponseGroupsInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AdminGetUser200ResponseGroupsInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AdminGetUser200ResponseGroupsInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AdminGetUser200ResponseGroupsInner.class));

       return (TypeAdapter<T>) new TypeAdapter<AdminGetUser200ResponseGroupsInner>() {
           @Override
           public void write(JsonWriter out, AdminGetUser200ResponseGroupsInner value) throws IOException {
           ...
           @Override
           public AdminGetUser200ResponseGroupsInner read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             AdminGetUser200ResponseGroupsInner instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of AdminGetUser200ResponseGroupsInner given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AdminGetUser200ResponseGroupsInner
   * @throws IOException if the JSON string is invalid with respect to AdminGetUser200ResponseGroupsInner
   */
  public static AdminGetUser200ResponseGroupsInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AdminGetUser200ResponseGroupsInner.class);
  }

  /**
   * Convert an instance of AdminGetUser200ResponseGroupsInner to an JSON string
   *
   * @return JSON string
   */
