...
public class CreateGroupRequestGroup {
  ...
  public CreateGroupRequestGroup automaticMembershipEmailDomains(String automaticMembershipEmailDomains) {
  ...
  public CreateGroupRequestGroup bioRaw(String bioRaw) {
    this.bioRaw = bioRaw;
    return this;
  }
  ...
  public CreateGroupRequestGroup defaultNotificationLevel(Integer defaultNotificationLevel) {
  ...
  public CreateGroupRequestGroup flairBgColor(String flairBgColor) {
  ...
  public CreateGroupRequestGroup flairIcon(String flairIcon) {
  ...
  public CreateGroupRequestGroup flairUploadId(Integer flairUploadId) {
  ...
  public CreateGroupRequestGroup fullName(String fullName) {
  ...
  public CreateGroupRequestGroup mutedCategoryIds(List<Integer> mutedCategoryIds) {
    this.mutedCategoryIds = mutedCategoryIds;
    return this;
  }

  public CreateGroupRequestGroup addMutedCategoryIdsItem(Integer mutedCategoryIdsItem) {
  ...
  public CreateGroupRequestGroup ownerUsernames(String ownerUsernames) {
  ...
  public CreateGroupRequestGroup primaryGroup(Boolean primaryGroup) {
  ...
  public CreateGroupRequestGroup publicAdmission(Boolean publicAdmission) {
  ...
  public CreateGroupRequestGroup publicExit(Boolean publicExit) {
  ...
  public CreateGroupRequestGroup regularCategoryIds(List<Integer> regularCategoryIds) {
    this.regularCategoryIds = regularCategoryIds;
    return this;
  }

  public CreateGroupRequestGroup addRegularCategoryIdsItem(Integer regularCategoryIdsItem) {
  ...
  public CreateGroupRequestGroup trackingCategoryIds(List<Integer> trackingCategoryIds) {
    this.trackingCategoryIds = trackingCategoryIds;
    return this;
  }

  public CreateGroupRequestGroup addTrackingCategoryIdsItem(Integer trackingCategoryIdsItem) {
  ...
  public CreateGroupRequestGroup usernames(String usernames) {
  ...
  public CreateGroupRequestGroup visibilityLevel(Integer visibilityLevel) {
  ...
  public CreateGroupRequestGroup watchingCategoryIds(List<Integer> watchingCategoryIds) {
    this.watchingCategoryIds = watchingCategoryIds;
    return this;
  }

  public CreateGroupRequestGroup addWatchingCategoryIdsItem(Integer watchingCategoryIdsItem) {
  ...
  public CreateGroupRequestGroup watchingFirstPostCategoryIds(List<Integer> watchingFirstPostCategoryIds) {
    this.watchingFirstPostCategoryIds = watchingFirstPostCategoryIds;
    return this;
  }

  public CreateGroupRequestGroup addWatchingFirstPostCategoryIdsItem(Integer watchingFirstPostCategoryIdsItem) {
   ...
   * @return the CreateGroupRequestGroup instance itself
   */
  public CreateGroupRequestGroup putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.automaticMembershipEmailDomains, createGroupRequestGroup.automaticMembershipEmailDomains) &&
        Objects.equals(this.bioRaw, createGroupRequestGroup.bioRaw) &&
        Objects.equals(this.defaultNotificationLevel, createGroupRequestGroup.defaultNotificationLevel) &&
        Objects.equals(this.flairBgColor, createGroupRequestGroup.flairBgColor) &&
        Objects.equals(this.flairIcon, createGroupRequestGroup.flairIcon) &&
        Objects.equals(this.flairUploadId, createGroupRequestGroup.flairUploadId) &&
        Objects.equals(this.fullName, createGroupRequestGroup.fullName) &&
        Objects.equals(this.mutedCategoryIds, createGroupRequestGroup.mutedCategoryIds) &&
        Objects.equals(this.name, createGroupRequestGroup.name) &&
        Objects.equals(this.ownerUsernames, createGroupRequestGroup.ownerUsernames) &&
        Objects.equals(this.primaryGroup, createGroupRequestGroup.primaryGroup) &&
        Objects.equals(this.publicAdmission, createGroupRequestGroup.publicAdmission) &&
        Objects.equals(this.publicExit, createGroupRequestGroup.publicExit) &&
        Objects.equals(this.regularCategoryIds, createGroupRequestGroup.regularCategoryIds) &&
        Objects.equals(this.trackingCategoryIds, createGroupRequestGroup.trackingCategoryIds) &&
        Objects.equals(this.usernames, createGroupRequestGroup.usernames) &&
        Objects.equals(this.visibilityLevel, createGroupRequestGroup.visibilityLevel) &&
        Objects.equals(this.watchingCategoryIds, createGroupRequestGroup.watchingCategoryIds) &&
        Objects.equals(this.watchingFirstPostCategoryIds, createGroupRequestGroup.watchingFirstPostCategoryIds)&&
        Objects.equals(this.additionalProperties, createGroupRequestGroup.additionalProperties);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateGroupRequestGroup
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateGroupRequestGroup.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateGroupRequestGroup is not found in the empty JSON string", CreateGroupRequestGroup.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CreateGroupRequestGroup.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateGroupRequestGroup.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateGroupRequestGroup' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateGroupRequestGroup> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateGroupRequestGroup.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateGroupRequestGroup>() {
           @Override
           public void write(JsonWriter out, CreateGroupRequestGroup value) throws IOException {
           ...
           @Override
           public CreateGroupRequestGroup read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             CreateGroupRequestGroup instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of CreateGroupRequestGroup given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateGroupRequestGroup
   * @throws IOException if the JSON string is invalid with respect to CreateGroupRequestGroup
   */
  public static CreateGroupRequestGroup fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateGroupRequestGroup.class);
  }

  /**
   * Convert an instance of CreateGroupRequestGroup to an JSON string
   *
   * @return JSON string
   */
