...
public class CreateGroup200ResponseBasicGroup {
  ...
  public CreateGroup200ResponseBasicGroup() {
  }

  public CreateGroup200ResponseBasicGroup allowMembershipRequests(Boolean allowMembershipRequests) {
  ...
  public CreateGroup200ResponseBasicGroup automatic(Boolean automatic) {
  ...
  public CreateGroup200ResponseBasicGroup bioCooked(String bioCooked) {
  ...
  public CreateGroup200ResponseBasicGroup bioExcerpt(String bioExcerpt) {
  ...
  public CreateGroup200ResponseBasicGroup bioRaw(String bioRaw) {
    this.bioRaw = bioRaw;
    return this;
  }
  ...
  public CreateGroup200ResponseBasicGroup canAdminGroup(Boolean canAdminGroup) {
  ...
  public CreateGroup200ResponseBasicGroup canEditGroup(Boolean canEditGroup) {
  ...
  public CreateGroup200ResponseBasicGroup canSeeMembers(Boolean canSeeMembers) {
  ...
  public CreateGroup200ResponseBasicGroup defaultNotificationLevel(Integer defaultNotificationLevel) {
  ...
  public CreateGroup200ResponseBasicGroup flairBgColor(String flairBgColor) {
  ...
  public CreateGroup200ResponseBasicGroup flairColor(String flairColor) {
  ...
  public CreateGroup200ResponseBasicGroup flairUrl(String flairUrl) {
  ...
  public CreateGroup200ResponseBasicGroup fullName(String fullName) {
  ...
  public CreateGroup200ResponseBasicGroup grantTrustLevel(String grantTrustLevel) {
  ...
  public CreateGroup200ResponseBasicGroup hasMessages(Boolean hasMessages) {
  ...
  public CreateGroup200ResponseBasicGroup id(Integer id) {
    this.id = id;
    return this;
  }
  ...
  public CreateGroup200ResponseBasicGroup incomingEmail(String incomingEmail) {
  ...
  public CreateGroup200ResponseBasicGroup membersVisibilityLevel(Integer membersVisibilityLevel) {
  ...
  public CreateGroup200ResponseBasicGroup membershipRequestTemplate(String membershipRequestTemplate) {
  ...
  public CreateGroup200ResponseBasicGroup mentionableLevel(Integer mentionableLevel) {
  ...
  public CreateGroup200ResponseBasicGroup messageableLevel(Integer messageableLevel) {
  ...
  public CreateGroup200ResponseBasicGroup name(String name) {
    this.name = name;
    return this;
  }
  ...
  public CreateGroup200ResponseBasicGroup primaryGroup(Boolean primaryGroup) {
  ...
  public CreateGroup200ResponseBasicGroup publicAdmission(Boolean publicAdmission) {
  ...
  public CreateGroup200ResponseBasicGroup publicExit(Boolean publicExit) {
  ...
  public CreateGroup200ResponseBasicGroup publishReadState(Boolean publishReadState) {
  ...
  public CreateGroup200ResponseBasicGroup title(String title) {
    this.title = title;
    return this;
  }
  ...
  public CreateGroup200ResponseBasicGroup userCount(Integer userCount) {
  ...
  public CreateGroup200ResponseBasicGroup visibilityLevel(Integer visibilityLevel) {
   ...
   * @return the CreateGroup200ResponseBasicGroup instance itself
   */
  public CreateGroup200ResponseBasicGroup putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    CreateGroup200ResponseBasicGroup createGroup200ResponseBasicGroup = (CreateGroup200ResponseBasicGroup) o;
    return Objects.equals(this.allowMembershipRequests, createGroup200ResponseBasicGroup.allowMembershipRequests) &&
        Objects.equals(this.automatic, createGroup200ResponseBasicGroup.automatic) &&
        Objects.equals(this.bioCooked, createGroup200ResponseBasicGroup.bioCooked) &&
        Objects.equals(this.bioExcerpt, createGroup200ResponseBasicGroup.bioExcerpt) &&
        Objects.equals(this.bioRaw, createGroup200ResponseBasicGroup.bioRaw) &&
        Objects.equals(this.canAdminGroup, createGroup200ResponseBasicGroup.canAdminGroup) &&
        Objects.equals(this.canEditGroup, createGroup200ResponseBasicGroup.canEditGroup) &&
        Objects.equals(this.canSeeMembers, createGroup200ResponseBasicGroup.canSeeMembers) &&
        Objects.equals(this.defaultNotificationLevel, createGroup200ResponseBasicGroup.defaultNotificationLevel) &&
        Objects.equals(this.flairBgColor, createGroup200ResponseBasicGroup.flairBgColor) &&
        Objects.equals(this.flairColor, createGroup200ResponseBasicGroup.flairColor) &&
        Objects.equals(this.flairUrl, createGroup200ResponseBasicGroup.flairUrl) &&
        Objects.equals(this.fullName, createGroup200ResponseBasicGroup.fullName) &&
        Objects.equals(this.grantTrustLevel, createGroup200ResponseBasicGroup.grantTrustLevel) &&
        Objects.equals(this.hasMessages, createGroup200ResponseBasicGroup.hasMessages) &&
        Objects.equals(this.id, createGroup200ResponseBasicGroup.id) &&
        Objects.equals(this.incomingEmail, createGroup200ResponseBasicGroup.incomingEmail) &&
        Objects.equals(this.membersVisibilityLevel, createGroup200ResponseBasicGroup.membersVisibilityLevel) &&
        Objects.equals(this.membershipRequestTemplate, createGroup200ResponseBasicGroup.membershipRequestTemplate) &&
        Objects.equals(this.mentionableLevel, createGroup200ResponseBasicGroup.mentionableLevel) &&
        Objects.equals(this.messageableLevel, createGroup200ResponseBasicGroup.messageableLevel) &&
        Objects.equals(this.name, createGroup200ResponseBasicGroup.name) &&
        Objects.equals(this.primaryGroup, createGroup200ResponseBasicGroup.primaryGroup) &&
        Objects.equals(this.publicAdmission, createGroup200ResponseBasicGroup.publicAdmission) &&
        Objects.equals(this.publicExit, createGroup200ResponseBasicGroup.publicExit) &&
        Objects.equals(this.publishReadState, createGroup200ResponseBasicGroup.publishReadState) &&
        Objects.equals(this.title, createGroup200ResponseBasicGroup.title) &&
        Objects.equals(this.userCount, createGroup200ResponseBasicGroup.userCount) &&
        Objects.equals(this.visibilityLevel, createGroup200ResponseBasicGroup.visibilityLevel)&&
        Objects.equals(this.additionalProperties, createGroup200ResponseBasicGroup.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(allowMembershipRequests, automatic, bioCooked, bioExcerpt, bioRaw, canAdminGroup, canEditGroup, canSeeMembers, defaultNotificationLevel, flairBgColor, flairColor, flairUrl, fullName, grantTrustLevel, hasMessages, id, incomingEmail, membersVisibilityLevel, membershipRequestTemplate, mentionableLevel, messageableLevel, name, primaryGroup, publicAdmission, publicExit, publishReadState, title, userCount, visibilityLevel, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CreateGroup200ResponseBasicGroup {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateGroup200ResponseBasicGroup
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateGroup200ResponseBasicGroup.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateGroup200ResponseBasicGroup is not found in the empty JSON string", CreateGroup200ResponseBasicGroup.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CreateGroup200ResponseBasicGroup.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateGroup200ResponseBasicGroup.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateGroup200ResponseBasicGroup' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateGroup200ResponseBasicGroup> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateGroup200ResponseBasicGroup.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateGroup200ResponseBasicGroup>() {
           @Override
           public void write(JsonWriter out, CreateGroup200ResponseBasicGroup value) throws IOException {
           ...
           @Override
           public CreateGroup200ResponseBasicGroup read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             CreateGroup200ResponseBasicGroup instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of CreateGroup200ResponseBasicGroup given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateGroup200ResponseBasicGroup
   * @throws IOException if the JSON string is invalid with respect to CreateGroup200ResponseBasicGroup
   */
  public static CreateGroup200ResponseBasicGroup fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateGroup200ResponseBasicGroup.class);
  }

  /**
   * Convert an instance of CreateGroup200ResponseBasicGroup to an JSON string
   *
   * @return JSON string
   */
