...
public class UpdateCategory200ResponseCategory {
  ...
  public UpdateCategory200ResponseCategory() {
  }

  public UpdateCategory200ResponseCategory allTopicsWiki(Boolean allTopicsWiki) {
  ...
  public UpdateCategory200ResponseCategory allowBadges(Boolean allowBadges) {
  ...
  public UpdateCategory200ResponseCategory allowGlobalTags(Boolean allowGlobalTags) {
  ...
  public UpdateCategory200ResponseCategory allowUnlimitedOwnerEditsOnFirstPost(Boolean allowUnlimitedOwnerEditsOnFirstPost) {
  ...
  public UpdateCategory200ResponseCategory allowedTagGroups(List<Object> allowedTagGroups) {
    this.allowedTagGroups = allowedTagGroups;
    return this;
  }

  public UpdateCategory200ResponseCategory addAllowedTagGroupsItem(Object allowedTagGroupsItem) {
  ...
  public UpdateCategory200ResponseCategory allowedTags(List<Object> allowedTags) {
    this.allowedTags = allowedTags;
    return this;
  }

  public UpdateCategory200ResponseCategory addAllowedTagsItem(Object allowedTagsItem) {
  ...
  public UpdateCategory200ResponseCategory autoCloseBasedOnLastPost(Boolean autoCloseBasedOnLastPost) {
  ...
  public UpdateCategory200ResponseCategory autoCloseHours(String autoCloseHours) {
  ...
  public UpdateCategory200ResponseCategory availableGroups(List<Object> availableGroups) {
    this.availableGroups = availableGroups;
    return this;
  }

  public UpdateCategory200ResponseCategory addAvailableGroupsItem(Object availableGroupsItem) {
  ...
  public UpdateCategory200ResponseCategory canDelete(Boolean canDelete) {
  ...
  public UpdateCategory200ResponseCategory canEdit(Boolean canEdit) {
  ...
  public UpdateCategory200ResponseCategory categorySetting(Object categorySetting) {
  ...
  public UpdateCategory200ResponseCategory color(String color) {
    this.color = color;
    return this;
  }
  ...
  public UpdateCategory200ResponseCategory customFields(Map<String, Object> customFields) {
    this.customFields = customFields;
    return this;
  }

  public UpdateCategory200ResponseCategory putCustomFieldsItem(String key, Object customFieldsItem) {
  ...
  public UpdateCategory200ResponseCategory defaultListFilter(String defaultListFilter) {
  ...
  public UpdateCategory200ResponseCategory defaultSlowModeSeconds(String defaultSlowModeSeconds) {
  ...
  public UpdateCategory200ResponseCategory defaultTopPeriod(String defaultTopPeriod) {
  ...
  public UpdateCategory200ResponseCategory defaultView(String defaultView) {
  ...
  public UpdateCategory200ResponseCategory description(String description) {
  ...
  public UpdateCategory200ResponseCategory descriptionExcerpt(String descriptionExcerpt) {
  ...
  public UpdateCategory200ResponseCategory descriptionText(String descriptionText) {
  ...
  public UpdateCategory200ResponseCategory emailIn(String emailIn) {
  ...
  public UpdateCategory200ResponseCategory emailInAllowStrangers(Boolean emailInAllowStrangers) {
  ...
  public UpdateCategory200ResponseCategory formTemplateIds(List<Object> formTemplateIds) {
    this.formTemplateIds = formTemplateIds;
    return this;
  }

  public UpdateCategory200ResponseCategory addFormTemplateIdsItem(Object formTemplateIdsItem) {
  ...
  public UpdateCategory200ResponseCategory groupPermissions(List<GetCategory200ResponseCategoryGroupPermissionsInner> groupPermissions) {
    this.groupPermissions = groupPermissions;
    return this;
  }

  public UpdateCategory200ResponseCategory addGroupPermissionsItem(GetCategory200ResponseCategoryGroupPermissionsInner groupPermissionsItem) {
  ...
  public UpdateCategory200ResponseCategory hasChildren(String hasChildren) {
  ...
  public UpdateCategory200ResponseCategory id(Integer id) {
    this.id = id;
    return this;
  }
  ...
  public UpdateCategory200ResponseCategory mailinglistMirror(Boolean mailinglistMirror) {
  ...
  public UpdateCategory200ResponseCategory minimumRequiredTags(Integer minimumRequiredTags) {
  ...
  public UpdateCategory200ResponseCategory name(String name) {
    this.name = name;
    return this;
  }
  ...
  public UpdateCategory200ResponseCategory navigateToFirstPostAfterRead(Boolean navigateToFirstPostAfterRead) {
  ...
  public UpdateCategory200ResponseCategory notificationLevel(Integer notificationLevel) {
  ...
  public UpdateCategory200ResponseCategory numFeaturedTopics(Integer numFeaturedTopics) {
  ...
  public UpdateCategory200ResponseCategory permission(String permission) {
  ...
  public UpdateCategory200ResponseCategory position(Integer position) {
  ...
  public UpdateCategory200ResponseCategory postCount(Integer postCount) {
  ...
  public UpdateCategory200ResponseCategory readOnlyBanner(String readOnlyBanner) {
  ...
  public UpdateCategory200ResponseCategory readRestricted(Boolean readRestricted) {
  ...
  public UpdateCategory200ResponseCategory requiredTagGroups(List<GetCategory200ResponseCategoryRequiredTagGroupsInner> requiredTagGroups) {
    this.requiredTagGroups = requiredTagGroups;
    return this;
  }

  public UpdateCategory200ResponseCategory addRequiredTagGroupsItem(GetCategory200ResponseCategoryRequiredTagGroupsInner requiredTagGroupsItem) {
  ...
  public UpdateCategory200ResponseCategory searchPriority(Integer searchPriority) {
  ...
  public UpdateCategory200ResponseCategory showSubcategoryList(Boolean showSubcategoryList) {
  ...
  public UpdateCategory200ResponseCategory slug(String slug) {
    this.slug = slug;
    return this;
  }
  ...
  public UpdateCategory200ResponseCategory sortAscending(String sortAscending) {
  ...
  public UpdateCategory200ResponseCategory sortOrder(String sortOrder) {
  ...
  public UpdateCategory200ResponseCategory subcategoryListStyle(String subcategoryListStyle) {
  ...
  public UpdateCategory200ResponseCategory textColor(String textColor) {
  ...
  public UpdateCategory200ResponseCategory topicCount(Integer topicCount) {
  ...
  public UpdateCategory200ResponseCategory topicFeaturedLinkAllowed(Boolean topicFeaturedLinkAllowed) {
  ...
  public UpdateCategory200ResponseCategory topicTemplate(String topicTemplate) {
  ...
  public UpdateCategory200ResponseCategory topicUrl(String topicUrl) {
  ...
  public UpdateCategory200ResponseCategory uploadedBackground(String uploadedBackground) {
  ...
  public UpdateCategory200ResponseCategory uploadedLogo(String uploadedLogo) {
  ...
  public UpdateCategory200ResponseCategory uploadedLogoDark(String uploadedLogoDark) {
   ...
   * @return the UpdateCategory200ResponseCategory instance itself
   */
  public UpdateCategory200ResponseCategory putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    UpdateCategory200ResponseCategory updateCategory200ResponseCategory = (UpdateCategory200ResponseCategory) o;
    return Objects.equals(this.allTopicsWiki, updateCategory200ResponseCategory.allTopicsWiki) &&
        Objects.equals(this.allowBadges, updateCategory200ResponseCategory.allowBadges) &&
        Objects.equals(this.allowGlobalTags, updateCategory200ResponseCategory.allowGlobalTags) &&
        Objects.equals(this.allowUnlimitedOwnerEditsOnFirstPost, updateCategory200ResponseCategory.allowUnlimitedOwnerEditsOnFirstPost) &&
        Objects.equals(this.allowedTagGroups, updateCategory200ResponseCategory.allowedTagGroups) &&
        Objects.equals(this.allowedTags, updateCategory200ResponseCategory.allowedTags) &&
        Objects.equals(this.autoCloseBasedOnLastPost, updateCategory200ResponseCategory.autoCloseBasedOnLastPost) &&
        Objects.equals(this.autoCloseHours, updateCategory200ResponseCategory.autoCloseHours) &&
        Objects.equals(this.availableGroups, updateCategory200ResponseCategory.availableGroups) &&
        Objects.equals(this.canDelete, updateCategory200ResponseCategory.canDelete) &&
        Objects.equals(this.canEdit, updateCategory200ResponseCategory.canEdit) &&
        Objects.equals(this.categorySetting, updateCategory200ResponseCategory.categorySetting) &&
        Objects.equals(this.color, updateCategory200ResponseCategory.color) &&
        Objects.equals(this.customFields, updateCategory200ResponseCategory.customFields) &&
        Objects.equals(this.defaultListFilter, updateCategory200ResponseCategory.defaultListFilter) &&
        Objects.equals(this.defaultSlowModeSeconds, updateCategory200ResponseCategory.defaultSlowModeSeconds) &&
        Objects.equals(this.defaultTopPeriod, updateCategory200ResponseCategory.defaultTopPeriod) &&
        Objects.equals(this.defaultView, updateCategory200ResponseCategory.defaultView) &&
        Objects.equals(this.description, updateCategory200ResponseCategory.description) &&
        Objects.equals(this.descriptionExcerpt, updateCategory200ResponseCategory.descriptionExcerpt) &&
        Objects.equals(this.descriptionText, updateCategory200ResponseCategory.descriptionText) &&
        Objects.equals(this.emailIn, updateCategory200ResponseCategory.emailIn) &&
        Objects.equals(this.emailInAllowStrangers, updateCategory200ResponseCategory.emailInAllowStrangers) &&
        Objects.equals(this.formTemplateIds, updateCategory200ResponseCategory.formTemplateIds) &&
        Objects.equals(this.groupPermissions, updateCategory200ResponseCategory.groupPermissions) &&
        Objects.equals(this.hasChildren, updateCategory200ResponseCategory.hasChildren) &&
        Objects.equals(this.id, updateCategory200ResponseCategory.id) &&
        Objects.equals(this.mailinglistMirror, updateCategory200ResponseCategory.mailinglistMirror) &&
        Objects.equals(this.minimumRequiredTags, updateCategory200ResponseCategory.minimumRequiredTags) &&
        Objects.equals(this.name, updateCategory200ResponseCategory.name) &&
        Objects.equals(this.navigateToFirstPostAfterRead, updateCategory200ResponseCategory.navigateToFirstPostAfterRead) &&
        Objects.equals(this.notificationLevel, updateCategory200ResponseCategory.notificationLevel) &&
        Objects.equals(this.numFeaturedTopics, updateCategory200ResponseCategory.numFeaturedTopics) &&
        Objects.equals(this.permission, updateCategory200ResponseCategory.permission) &&
        Objects.equals(this.position, updateCategory200ResponseCategory.position) &&
        Objects.equals(this.postCount, updateCategory200ResponseCategory.postCount) &&
        Objects.equals(this.readOnlyBanner, updateCategory200ResponseCategory.readOnlyBanner) &&
        Objects.equals(this.readRestricted, updateCategory200ResponseCategory.readRestricted) &&
        Objects.equals(this.requiredTagGroups, updateCategory200ResponseCategory.requiredTagGroups) &&
        Objects.equals(this.searchPriority, updateCategory200ResponseCategory.searchPriority) &&
        Objects.equals(this.showSubcategoryList, updateCategory200ResponseCategory.showSubcategoryList) &&
        Objects.equals(this.slug, updateCategory200ResponseCategory.slug) &&
        Objects.equals(this.sortAscending, updateCategory200ResponseCategory.sortAscending) &&
        Objects.equals(this.sortOrder, updateCategory200ResponseCategory.sortOrder) &&
        Objects.equals(this.subcategoryListStyle, updateCategory200ResponseCategory.subcategoryListStyle) &&
        Objects.equals(this.textColor, updateCategory200ResponseCategory.textColor) &&
        Objects.equals(this.topicCount, updateCategory200ResponseCategory.topicCount) &&
        Objects.equals(this.topicFeaturedLinkAllowed, updateCategory200ResponseCategory.topicFeaturedLinkAllowed) &&
        Objects.equals(this.topicTemplate, updateCategory200ResponseCategory.topicTemplate) &&
        Objects.equals(this.topicUrl, updateCategory200ResponseCategory.topicUrl) &&
        Objects.equals(this.uploadedBackground, updateCategory200ResponseCategory.uploadedBackground) &&
        Objects.equals(this.uploadedLogo, updateCategory200ResponseCategory.uploadedLogo) &&
        Objects.equals(this.uploadedLogoDark, updateCategory200ResponseCategory.uploadedLogoDark)&&
        Objects.equals(this.additionalProperties, updateCategory200ResponseCategory.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdateCategory200ResponseCategory {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateCategory200ResponseCategory
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateCategory200ResponseCategory.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateCategory200ResponseCategory is not found in the empty JSON string", UpdateCategory200ResponseCategory.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UpdateCategory200ResponseCategory.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateCategory200ResponseCategory.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateCategory200ResponseCategory' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateCategory200ResponseCategory> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateCategory200ResponseCategory.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateCategory200ResponseCategory>() {
           @Override
           public void write(JsonWriter out, UpdateCategory200ResponseCategory value) throws IOException {
           ...
           @Override
           public UpdateCategory200ResponseCategory read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             UpdateCategory200ResponseCategory instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of UpdateCategory200ResponseCategory given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateCategory200ResponseCategory
   * @throws IOException if the JSON string is invalid with respect to UpdateCategory200ResponseCategory
   */
  public static UpdateCategory200ResponseCategory fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateCategory200ResponseCategory.class);
  }

  /**
   * Convert an instance of UpdateCategory200ResponseCategory to an JSON string
   *
   * @return JSON string
   */
