...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SedraIvApi.APIApi();
  });
  ...
  describe('APIApi', function() {
    describe('lexemeIdGet', function() {
      it('should call lexemeIdGet successfully', function(done) {
        //uncomment below and update the code to test lexemeIdGet
        //instance.lexemeIdGet(function(error) {
    ...
    describe('wordIdGet', function() {
      it('should call wordIdGet successfully', function(done) {
        //uncomment below and update the code to test wordIdGet
        //instance.wordIdGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
