...
public class ApiApiTest {
     ...
     */
    @Test
    public void lexemeIdGetTest() throws ApiException {
        String id = null;
        LexemeIdGet200Response response = api.lexemeIdGet(id);
     ...
     */
    @Test
    public void wordIdGetTest() throws ApiException {
        String id = null;
        List<WordIdGet200ResponseInner> response = api.wordIdGet(id);
        // TODO: test validations
    }
