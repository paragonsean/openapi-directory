...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WordAssociationsApi.DefaultApi();
  });
  ...
  describe('DefaultApi', function() {
    describe('jsonSearchGet', function() {
      it('should call jsonSearchGet successfully', function(done) {
        //uncomment below and update the code to test jsonSearchGet
        //instance.jsonSearchGet(function(error) {
    ...
    describe('jsonSearchPost', function() {
      it('should call jsonSearchPost successfully', function(done) {
        //uncomment below and update the code to test jsonSearchPost
        //instance.jsonSearchPost(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
