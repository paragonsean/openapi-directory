...
class ApiClient {
     ...
     */
    constructor(basePath = 'https://api.wordassociations.net/associations/v1.0') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default https://api.wordassociations.net/associations/v1.0
         */
        ...
        this.authentications = {
            'internalApiKey': {type: 'apiKey', 'in': 'query', name: 'apikey'}
        }
