...
* <pre>
* var WordAssociationsApi = require('index'); // See note below*.
* var xxxSvc = new WordAssociationsApi.XxxApi(); // Allocate the API class we're going to use.
* var yyyModel = new WordAssociationsApi.Yyy(); // Construct a model instance.
...
* <pre>
* var xxxSvc = new WordAssociationsApi.XxxApi(); // Allocate the API class we're going to use.
* var yyy = new WordAssociationsApi.Yyy(); // Construct a model instance.
* yyyModel.someProperty = 'someValue';
* ...
* var zzz = xxxSvc.doSomething(yyyModel); // Invoke the service.
* ...
