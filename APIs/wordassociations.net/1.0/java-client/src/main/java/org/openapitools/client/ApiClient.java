...
public class ApiClient {
    ...
    private String basePath = "https://api.wordassociations.net/associations/v1.0";
    ...
    public ApiClient() {
        ...
        authentications.put("internalApiKey", new ApiKeyAuth("query", "apikey"));
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://api.wordassociations.net/associations/v1.0
