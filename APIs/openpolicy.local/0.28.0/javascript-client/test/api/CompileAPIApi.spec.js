...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenPolicyAgentOpaRestApi.CompileAPIApi();
  });
  ...
  describe('CompileAPIApi', function() {
    describe('postCompile', function() {
      it('should call postCompile successfully', function(done) {
        //uncomment below and update the code to test postCompile
        //instance.postCompile(function(error) {
