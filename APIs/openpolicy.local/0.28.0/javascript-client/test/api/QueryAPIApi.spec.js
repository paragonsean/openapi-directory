...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenPolicyAgentOpaRestApi.QueryAPIApi();
  });
  ...
  describe('QueryAPIApi', function() {
    ...
    describe('postSimpleQuery', function() {
      it('should call postSimpleQuery successfully', function(done) {
        //uncomment below and update the code to test postSimpleQuery
        //instance.postSimpleQuery(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
