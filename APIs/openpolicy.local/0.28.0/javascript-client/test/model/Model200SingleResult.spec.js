...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenPolicyAgentOpaRestApi.Model200SingleResult();
  });
  ...
  describe('Model200SingleResult', function() {
    it('should create an instance of Model200SingleResult', function() {
      // uncomment below and update the code to test Model200SingleResult
      //var instance = new OpenPolicyAgentOpaRestApi.Model200SingleResult();
      //expect(instance).to.be.a(OpenPolicyAgentOpaRestApi.Model200SingleResult);
    });
