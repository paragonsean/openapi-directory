...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenPolicyAgentOpaRestApi.Model200ExplanationsExplanationInnerNode();
  });
  ...
  describe('Model200ExplanationsExplanationInnerNode', function() {
    it('should create an instance of Model200ExplanationsExplanationInnerNode', function() {
      // uncomment below and update the code to test Model200ExplanationsExplanationInnerNode
      //var instance = new OpenPolicyAgentOpaRestApi.Model200ExplanationsExplanationInnerNode();
      //expect(instance).to.be.a(OpenPolicyAgentOpaRestApi.Model200ExplanationsExplanationInnerNode);
    });
