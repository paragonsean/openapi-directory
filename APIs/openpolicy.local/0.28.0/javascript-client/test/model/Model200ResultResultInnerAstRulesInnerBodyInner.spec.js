...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenPolicyAgentOpaRestApi.Model200ResultResultInnerAstRulesInnerBodyInner();
  });
  ...
  describe('Model200ResultResultInnerAstRulesInnerBodyInner', function() {
    it('should create an instance of Model200ResultResultInnerAstRulesInnerBodyInner', function() {
      // uncomment below and update the code to test Model200ResultResultInnerAstRulesInnerBodyInner
      //var instance = new OpenPolicyAgentOpaRestApi.Model200ResultResultInnerAstRulesInnerBodyInner();
      //expect(instance).to.be.a(OpenPolicyAgentOpaRestApi.Model200ResultResultInnerAstRulesInnerBodyInner);
    });
