...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenPolicyAgentOpaRestApi.Model200ResultResultInnerAst();
  });
  ...
  describe('Model200ResultResultInnerAst', function() {
    it('should create an instance of Model200ResultResultInnerAst', function() {
      // uncomment below and update the code to test Model200ResultResultInnerAst
      //var instance = new OpenPolicyAgentOpaRestApi.Model200ResultResultInnerAst();
      //expect(instance).to.be.a(OpenPolicyAgentOpaRestApi.Model200ResultResultInnerAst);
    });
