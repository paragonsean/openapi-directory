...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenPolicyAgentOpaRestApi.Model200Explanations();
  });
  ...
  describe('Model200Explanations', function() {
    it('should create an instance of Model200Explanations', function() {
      // uncomment below and update the code to test Model200Explanations
      //var instance = new OpenPolicyAgentOpaRestApi.Model200Explanations();
      //expect(instance).to.be.a(OpenPolicyAgentOpaRestApi.Model200Explanations);
    });
