...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenPolicyAgentOpaRestApi.PatchesSchemaInner();
  });
  ...
  describe('PatchesSchemaInner', function() {
    it('should create an instance of PatchesSchemaInner', function() {
      // uncomment below and update the code to test PatchesSchemaInner
      //var instance = new OpenPolicyAgentOpaRestApi.PatchesSchemaInner();
      //expect(instance).to.be.a(OpenPolicyAgentOpaRestApi.PatchesSchemaInner);
    });
