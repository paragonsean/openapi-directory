...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenPolicyAgentOpaRestApi.Model400ErrorsInner();
  });
  ...
  describe('Model400ErrorsInner', function() {
    it('should create an instance of Model400ErrorsInner', function() {
      // uncomment below and update the code to test Model400ErrorsInner
      //var instance = new OpenPolicyAgentOpaRestApi.Model400ErrorsInner();
      //expect(instance).to.be.a(OpenPolicyAgentOpaRestApi.Model400ErrorsInner);
    });
