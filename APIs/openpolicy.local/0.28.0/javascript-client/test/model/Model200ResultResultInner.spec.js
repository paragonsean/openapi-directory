...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenPolicyAgentOpaRestApi.Model200ResultResultInner();
  });
  ...
  describe('Model200ResultResultInner', function() {
    it('should create an instance of Model200ResultResultInner', function() {
      // uncomment below and update the code to test Model200ResultResultInner
      //var instance = new OpenPolicyAgentOpaRestApi.Model200ResultResultInner();
      //expect(instance).to.be.a(OpenPolicyAgentOpaRestApi.Model200ResultResultInner);
    });
