...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenPolicyAgentOpaRestApi.Model400ErrorsInnerLocation();
  });
  ...
  describe('Model400ErrorsInnerLocation', function() {
    it('should create an instance of Model400ErrorsInnerLocation', function() {
      // uncomment below and update the code to test Model400ErrorsInnerLocation
      //var instance = new OpenPolicyAgentOpaRestApi.Model400ErrorsInnerLocation();
      //expect(instance).to.be.a(OpenPolicyAgentOpaRestApi.Model400ErrorsInnerLocation);
    });
