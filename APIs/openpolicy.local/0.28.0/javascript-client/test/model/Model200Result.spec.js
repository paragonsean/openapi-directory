...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenPolicyAgentOpaRestApi.Model200Result();
  });
  ...
  describe('Model200Result', function() {
    it('should create an instance of Model200Result', function() {
      // uncomment below and update the code to test Model200Result
      //var instance = new OpenPolicyAgentOpaRestApi.Model200Result();
      //expect(instance).to.be.a(OpenPolicyAgentOpaRestApi.Model200Result);
    });
