...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenPolicyAgentOpaRestApi.Model200Metrics();
  });
  ...
  describe('Model200Metrics', function() {
    it('should create an instance of Model200Metrics', function() {
      // uncomment below and update the code to test Model200Metrics
      //var instance = new OpenPolicyAgentOpaRestApi.Model200Metrics();
      //expect(instance).to.be.a(OpenPolicyAgentOpaRestApi.Model200Metrics);
    });
