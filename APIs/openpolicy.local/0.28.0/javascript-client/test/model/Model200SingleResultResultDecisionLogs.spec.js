...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenPolicyAgentOpaRestApi.Model200SingleResultResultDecisionLogs();
  });
  ...
  describe('Model200SingleResultResultDecisionLogs', function() {
    it('should create an instance of Model200SingleResultResultDecisionLogs', function() {
      // uncomment below and update the code to test Model200SingleResultResultDecisionLogs
      //var instance = new OpenPolicyAgentOpaRestApi.Model200SingleResultResultDecisionLogs();
      //expect(instance).to.be.a(OpenPolicyAgentOpaRestApi.Model200SingleResultResultDecisionLogs);
    });
