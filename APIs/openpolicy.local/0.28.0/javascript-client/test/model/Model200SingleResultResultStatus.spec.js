...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenPolicyAgentOpaRestApi.Model200SingleResultResultStatus();
  });
  ...
  describe('Model200SingleResultResultStatus', function() {
    it('should create an instance of Model200SingleResultResultStatus', function() {
      // uncomment below and update the code to test Model200SingleResultResultStatus
      //var instance = new OpenPolicyAgentOpaRestApi.Model200SingleResultResultStatus();
      //expect(instance).to.be.a(OpenPolicyAgentOpaRestApi.Model200SingleResultResultStatus);
    });
