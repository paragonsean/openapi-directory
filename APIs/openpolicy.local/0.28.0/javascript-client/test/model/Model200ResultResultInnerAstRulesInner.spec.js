...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenPolicyAgentOpaRestApi.Model200ResultResultInnerAstRulesInner();
  });
  ...
  describe('Model200ResultResultInnerAstRulesInner', function() {
    it('should create an instance of Model200ResultResultInnerAstRulesInner', function() {
      // uncomment below and update the code to test Model200ResultResultInnerAstRulesInner
      //var instance = new OpenPolicyAgentOpaRestApi.Model200ResultResultInnerAstRulesInner();
      //expect(instance).to.be.a(OpenPolicyAgentOpaRestApi.Model200ResultResultInnerAstRulesInner);
    });
