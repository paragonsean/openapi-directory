...
#ifndef OAI_OAIConfigAPIApi_H
#define OAI_OAIConfigAPIApi_H
...
class OAIConfigAPIApi : public QObject {
    Q_OBJECT

public:
    OAIConfigAPIApi(const int timeOut = 0);
    ~OAIConfigAPIApi();
    ...
    */
    virtual void getConfig(const ::OpenAPI::OptionalParam<bool> &pretty = ::OpenAPI::OptionalParam<bool>());
...
Q_SIGNALS:
    ...
    void getConfigSignal(OAI200SingleResult summary);


    void getConfigSignalFull(OAIHttpRequestWorker *worker, OAI200SingleResult summary);

    Q_DECL_DEPRECATED_X("Use getConfigSignalError() instead")
    void getConfigSignalE(OAI200SingleResult summary, QNetworkReply::NetworkError error_type, QString error_str);
    void getConfigSignalError(OAI200SingleResult summary, QNetworkReply::NetworkError error_type, const QString &error_str);
