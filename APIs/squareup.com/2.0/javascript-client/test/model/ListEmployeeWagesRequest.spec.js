...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SquareConnectApi.ListEmployeeWagesRequest();
  });
  ...
  describe('ListEmployeeWagesRequest', function() {
    it('should create an instance of ListEmployeeWagesRequest', function() {
      ...
      //var instance = new SquareConnectApi.ListEmployeeWagesRequest();
      //expect(instance).to.be.a(SquareConnectApi.ListEmployeeWagesRequest);
    });
