...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SquareConnectApi.SearchLoyaltyRewardsRequest();
  });
  ...
  describe('SearchLoyaltyRewardsRequest', function() {
    it('should create an instance of SearchLoyaltyRewardsRequest', function() {
      ...
      //var instance = new SquareConnectApi.SearchLoyaltyRewardsRequest();
      //expect(instance).to.be.a(SquareConnectApi.SearchLoyaltyRewardsRequest);
    });
