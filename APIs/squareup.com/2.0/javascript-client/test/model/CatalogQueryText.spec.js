...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SquareConnectApi.CatalogQueryText();
  });
  ...
  describe('CatalogQueryText', function() {
    it('should create an instance of CatalogQueryText', function() {
      ...
      //var instance = new SquareConnectApi.CatalogQueryText();
      //expect(instance).to.be.a(SquareConnectApi.CatalogQueryText);
    });
