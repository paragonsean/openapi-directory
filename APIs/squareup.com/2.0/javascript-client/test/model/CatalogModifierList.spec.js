...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SquareConnectApi.CatalogModifierList();
  });
  ...
  describe('CatalogModifierList', function() {
    it('should create an instance of CatalogModifierList', function() {
      ...
      //var instance = new SquareConnectApi.CatalogModifierList();
      //expect(instance).to.be.a(SquareConnectApi.CatalogModifierList);
    });
