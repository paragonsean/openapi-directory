...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SquareConnectApi.SearchOrdersRequest();
  });
  ...
  describe('SearchOrdersRequest', function() {
    it('should create an instance of SearchOrdersRequest', function() {
      ...
      //var instance = new SquareConnectApi.SearchOrdersRequest();
      //expect(instance).to.be.a(SquareConnectApi.SearchOrdersRequest);
    });
