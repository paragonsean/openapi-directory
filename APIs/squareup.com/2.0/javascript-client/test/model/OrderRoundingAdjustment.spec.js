...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SquareConnectApi.OrderRoundingAdjustment();
  });
  ...
  describe('OrderRoundingAdjustment', function() {
    it('should create an instance of OrderRoundingAdjustment', function() {
      ...
      //var instance = new SquareConnectApi.OrderRoundingAdjustment();
      //expect(instance).to.be.a(SquareConnectApi.OrderRoundingAdjustment);
    });
