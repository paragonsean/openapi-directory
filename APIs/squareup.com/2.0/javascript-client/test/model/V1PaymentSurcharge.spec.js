...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SquareConnectApi.V1PaymentSurcharge();
  });
  ...
  describe('V1PaymentSurcharge', function() {
    it('should create an instance of V1PaymentSurcharge', function() {
      ...
      //var instance = new SquareConnectApi.V1PaymentSurcharge();
      //expect(instance).to.be.a(SquareConnectApi.V1PaymentSurcharge);
    });
