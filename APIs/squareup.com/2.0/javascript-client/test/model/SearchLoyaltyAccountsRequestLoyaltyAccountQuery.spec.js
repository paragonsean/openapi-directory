...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SquareConnectApi.SearchLoyaltyAccountsRequestLoyaltyAccountQuery();
  });
  ...
  describe('SearchLoyaltyAccountsRequestLoyaltyAccountQuery', function() {
    it('should create an instance of SearchLoyaltyAccountsRequestLoyaltyAccountQuery', function() {
      ...
      //var instance = new SquareConnectApi.SearchLoyaltyAccountsRequestLoyaltyAccountQuery();
      //expect(instance).to.be.a(SquareConnectApi.SearchLoyaltyAccountsRequestLoyaltyAccountQuery);
    });
