...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SquareConnectApi.ListBreakTypesRequest();
  });
  ...
  describe('ListBreakTypesRequest', function() {
    it('should create an instance of ListBreakTypesRequest', function() {
      ...
      //var instance = new SquareConnectApi.ListBreakTypesRequest();
      //expect(instance).to.be.a(SquareConnectApi.ListBreakTypesRequest);
    });
