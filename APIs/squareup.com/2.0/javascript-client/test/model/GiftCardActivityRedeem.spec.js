...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SquareConnectApi.GiftCardActivityRedeem();
  });
  ...
  describe('GiftCardActivityRedeem', function() {
    it('should create an instance of GiftCardActivityRedeem', function() {
      // uncomment below and update the code to test GiftCardActivityRedeem
      //var instance = new SquareConnectApi.GiftCardActivityRedeem();
      //expect(instance).to.be.a(SquareConnectApi.GiftCardActivityRedeem);
    });
