...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SquareConnectApi.CreateDisputeEvidenceTextRequest();
  });
  ...
  describe('CreateDisputeEvidenceTextRequest', function() {
    it('should create an instance of CreateDisputeEvidenceTextRequest', function() {
      ...
      //var instance = new SquareConnectApi.CreateDisputeEvidenceTextRequest();
      //expect(instance).to.be.a(SquareConnectApi.CreateDisputeEvidenceTextRequest);
    });
