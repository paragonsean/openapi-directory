...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SquareConnectApi.ListWorkweekConfigsResponse();
  });
  ...
  describe('ListWorkweekConfigsResponse', function() {
    it('should create an instance of ListWorkweekConfigsResponse', function() {
      ...
      //var instance = new SquareConnectApi.ListWorkweekConfigsResponse();
      //expect(instance).to.be.a(SquareConnectApi.ListWorkweekConfigsResponse);
    });
