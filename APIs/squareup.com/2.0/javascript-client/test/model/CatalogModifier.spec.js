...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SquareConnectApi.CatalogModifier();
  });
  ...
  describe('CatalogModifier', function() {
    it('should create an instance of CatalogModifier', function() {
      ...
      //var instance = new SquareConnectApi.CatalogModifier();
      //expect(instance).to.be.a(SquareConnectApi.CatalogModifier);
    });
