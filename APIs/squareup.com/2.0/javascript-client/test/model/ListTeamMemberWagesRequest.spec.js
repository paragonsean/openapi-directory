...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SquareConnectApi.ListTeamMemberWagesRequest();
  });
  ...
  describe('ListTeamMemberWagesRequest', function() {
    it('should create an instance of ListTeamMemberWagesRequest', function() {
      ...
      //var instance = new SquareConnectApi.ListTeamMemberWagesRequest();
      //expect(instance).to.be.a(SquareConnectApi.ListTeamMemberWagesRequest);
    });
