...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SquareConnectApi.SearchLoyaltyEventsResponse();
  });
  ...
  describe('SearchLoyaltyEventsResponse', function() {
    it('should create an instance of SearchLoyaltyEventsResponse', function() {
      ...
      //var instance = new SquareConnectApi.SearchLoyaltyEventsResponse();
      //expect(instance).to.be.a(SquareConnectApi.SearchLoyaltyEventsResponse);
    });
