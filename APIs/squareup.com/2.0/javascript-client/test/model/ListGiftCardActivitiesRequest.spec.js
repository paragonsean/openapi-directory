...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SquareConnectApi.ListGiftCardActivitiesRequest();
  });
  ...
  describe('ListGiftCardActivitiesRequest', function() {
    it('should create an instance of ListGiftCardActivitiesRequest', function() {
      // uncomment below and update the code to test ListGiftCardActivitiesRequest
      //var instance = new SquareConnectApi.ListGiftCardActivitiesRequest();
      //expect(instance).to.be.a(SquareConnectApi.ListGiftCardActivitiesRequest);
    });
