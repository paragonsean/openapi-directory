...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SquareConnectApi.BatchRetrieveOrdersResponse();
  });
  ...
  describe('BatchRetrieveOrdersResponse', function() {
    it('should create an instance of BatchRetrieveOrdersResponse', function() {
      ...
      //var instance = new SquareConnectApi.BatchRetrieveOrdersResponse();
      //expect(instance).to.be.a(SquareConnectApi.BatchRetrieveOrdersResponse);
    });
