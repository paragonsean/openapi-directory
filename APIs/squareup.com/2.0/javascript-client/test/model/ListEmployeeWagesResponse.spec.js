...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SquareConnectApi.ListEmployeeWagesResponse();
  });
  ...
  describe('ListEmployeeWagesResponse', function() {
    it('should create an instance of ListEmployeeWagesResponse', function() {
      ...
      //var instance = new SquareConnectApi.ListEmployeeWagesResponse();
      //expect(instance).to.be.a(SquareConnectApi.ListEmployeeWagesResponse);
    });
