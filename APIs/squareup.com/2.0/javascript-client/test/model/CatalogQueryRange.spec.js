...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SquareConnectApi.CatalogQueryRange();
  });
  ...
  describe('CatalogQueryRange', function() {
    it('should create an instance of CatalogQueryRange', function() {
      ...
      //var instance = new SquareConnectApi.CatalogQueryRange();
      //expect(instance).to.be.a(SquareConnectApi.CatalogQueryRange);
    });
