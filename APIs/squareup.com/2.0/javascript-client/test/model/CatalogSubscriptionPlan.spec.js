...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SquareConnectApi.CatalogSubscriptionPlan();
  });
  ...
  describe('CatalogSubscriptionPlan', function() {
    it('should create an instance of CatalogSubscriptionPlan', function() {
      ...
      //var instance = new SquareConnectApi.CatalogSubscriptionPlan();
      //expect(instance).to.be.a(SquareConnectApi.CatalogSubscriptionPlan);
    });
