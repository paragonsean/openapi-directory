...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SquareConnectApi.OrderCreatedObject();
  });
  ...
  describe('OrderCreatedObject', function() {
    it('should create an instance of OrderCreatedObject', function() {
      ...
      //var instance = new SquareConnectApi.OrderCreatedObject();
      //expect(instance).to.be.a(SquareConnectApi.OrderCreatedObject);
    });
