...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SquareConnectApi.ListDisputeEvidenceResponse();
  });
  ...
  describe('ListDisputeEvidenceResponse', function() {
    it('should create an instance of ListDisputeEvidenceResponse', function() {
      ...
      //var instance = new SquareConnectApi.ListDisputeEvidenceResponse();
      //expect(instance).to.be.a(SquareConnectApi.ListDisputeEvidenceResponse);
    });
