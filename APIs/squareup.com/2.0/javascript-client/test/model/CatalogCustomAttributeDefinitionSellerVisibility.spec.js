...
(function(root, factory) {
  ...
  describe('CatalogCustomAttributeDefinitionSellerVisibility', function() {
    it('should create an instance of CatalogCustomAttributeDefinitionSellerVisibility', function() {
      ...
      //var instance = new SquareConnectApi.CatalogCustomAttributeDefinitionSellerVisibility();
      //expect(instance).to.be.a(SquareConnectApi.CatalogCustomAttributeDefinitionSellerVisibility);
    });
