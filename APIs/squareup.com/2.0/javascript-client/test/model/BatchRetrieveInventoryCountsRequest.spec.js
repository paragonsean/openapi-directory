...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SquareConnectApi.BatchRetrieveInventoryCountsRequest();
  });
  ...
  describe('BatchRetrieveInventoryCountsRequest', function() {
    it('should create an instance of BatchRetrieveInventoryCountsRequest', function() {
      ...
      //var instance = new SquareConnectApi.BatchRetrieveInventoryCountsRequest();
      //expect(instance).to.be.a(SquareConnectApi.BatchRetrieveInventoryCountsRequest);
    });
