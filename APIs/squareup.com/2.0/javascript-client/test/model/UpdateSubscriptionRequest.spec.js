...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SquareConnectApi.UpdateSubscriptionRequest();
  });
  ...
  describe('UpdateSubscriptionRequest', function() {
    it('should create an instance of UpdateSubscriptionRequest', function() {
      ...
      //var instance = new SquareConnectApi.UpdateSubscriptionRequest();
      //expect(instance).to.be.a(SquareConnectApi.UpdateSubscriptionRequest);
    });
