...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SquareConnectApi.ListCustomerSegmentsResponse();
  });
  ...
  describe('ListCustomerSegmentsResponse', function() {
    it('should create an instance of ListCustomerSegmentsResponse', function() {
      ...
      //var instance = new SquareConnectApi.ListCustomerSegmentsResponse();
      //expect(instance).to.be.a(SquareConnectApi.ListCustomerSegmentsResponse);
    });
