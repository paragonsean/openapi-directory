...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SquareConnectApi.GetDeviceCodeResponse();
  });
  ...
  describe('GetDeviceCodeResponse', function() {
    it('should create an instance of GetDeviceCodeResponse', function() {
      ...
      //var instance = new SquareConnectApi.GetDeviceCodeResponse();
      //expect(instance).to.be.a(SquareConnectApi.GetDeviceCodeResponse);
    });
