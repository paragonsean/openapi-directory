...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SquareConnectApi.UpdateBookingRequest();
  });
  ...
  describe('UpdateBookingRequest', function() {
    it('should create an instance of UpdateBookingRequest', function() {
      ...
      //var instance = new SquareConnectApi.UpdateBookingRequest();
      //expect(instance).to.be.a(SquareConnectApi.UpdateBookingRequest);
    });
