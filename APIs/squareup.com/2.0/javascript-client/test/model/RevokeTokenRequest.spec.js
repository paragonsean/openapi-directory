...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SquareConnectApi.RevokeTokenRequest();
  });
  ...
  describe('RevokeTokenRequest', function() {
    it('should create an instance of RevokeTokenRequest', function() {
      ...
      //var instance = new SquareConnectApi.RevokeTokenRequest();
      //expect(instance).to.be.a(SquareConnectApi.RevokeTokenRequest);
    });
    ...
    it('should have the property revokeOnlyAccessToken (base name: "revoke_only_access_token")', function() {
      // uncomment below and update the code to test the property revokeOnlyAccessToken
      //var instance = new SquareConnectApi.RevokeTokenRequest();
      //expect(instance).to.be();
    });
