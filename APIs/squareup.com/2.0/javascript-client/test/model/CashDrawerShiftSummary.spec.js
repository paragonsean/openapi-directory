...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SquareConnectApi.CashDrawerShiftSummary();
  });
  ...
  describe('CashDrawerShiftSummary', function() {
    it('should create an instance of CashDrawerShiftSummary', function() {
      ...
      //var instance = new SquareConnectApi.CashDrawerShiftSummary();
      //expect(instance).to.be.a(SquareConnectApi.CashDrawerShiftSummary);
    });
