...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SquareConnectApi.CreateCustomerGroupRequest();
  });
  ...
  describe('CreateCustomerGroupRequest', function() {
    it('should create an instance of CreateCustomerGroupRequest', function() {
      ...
      //var instance = new SquareConnectApi.CreateCustomerGroupRequest();
      //expect(instance).to.be.a(SquareConnectApi.CreateCustomerGroupRequest);
    });
