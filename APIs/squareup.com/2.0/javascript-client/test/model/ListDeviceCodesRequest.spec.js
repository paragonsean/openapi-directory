...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SquareConnectApi.ListDeviceCodesRequest();
  });
  ...
  describe('ListDeviceCodesRequest', function() {
    it('should create an instance of ListDeviceCodesRequest', function() {
      ...
      //var instance = new SquareConnectApi.ListDeviceCodesRequest();
      //expect(instance).to.be.a(SquareConnectApi.ListDeviceCodesRequest);
    });
