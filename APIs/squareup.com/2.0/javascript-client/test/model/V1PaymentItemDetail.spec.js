...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SquareConnectApi.V1PaymentItemDetail();
  });
  ...
  describe('V1PaymentItemDetail', function() {
    it('should create an instance of V1PaymentItemDetail', function() {
      ...
      //var instance = new SquareConnectApi.V1PaymentItemDetail();
      //expect(instance).to.be.a(SquareConnectApi.V1PaymentItemDetail);
    });
