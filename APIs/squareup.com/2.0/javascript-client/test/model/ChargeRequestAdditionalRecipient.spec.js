...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SquareConnectApi.ChargeRequestAdditionalRecipient();
  });
  ...
  describe('ChargeRequestAdditionalRecipient', function() {
    it('should create an instance of ChargeRequestAdditionalRecipient', function() {
      ...
      //var instance = new SquareConnectApi.ChargeRequestAdditionalRecipient();
      //expect(instance).to.be.a(SquareConnectApi.ChargeRequestAdditionalRecipient);
    });
