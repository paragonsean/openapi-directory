...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SquareConnectApi.ListCardsResponse();
  });
  ...
  describe('ListCardsResponse', function() {
    it('should create an instance of ListCardsResponse', function() {
      // uncomment below and update the code to test ListCardsResponse
      //var instance = new SquareConnectApi.ListCardsResponse();
      //expect(instance).to.be.a(SquareConnectApi.ListCardsResponse);
    });
