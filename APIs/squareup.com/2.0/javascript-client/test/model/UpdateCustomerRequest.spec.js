...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SquareConnectApi.UpdateCustomerRequest();
  });
  ...
  describe('UpdateCustomerRequest', function() {
    it('should create an instance of UpdateCustomerRequest', function() {
      ...
      //var instance = new SquareConnectApi.UpdateCustomerRequest();
      //expect(instance).to.be.a(SquareConnectApi.UpdateCustomerRequest);
    });
