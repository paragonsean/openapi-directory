...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SquareConnectApi.OrderQuantityUnit();
  });
  ...
  describe('OrderQuantityUnit', function() {
    it('should create an instance of OrderQuantityUnit', function() {
      ...
      //var instance = new SquareConnectApi.OrderQuantityUnit();
      //expect(instance).to.be.a(SquareConnectApi.OrderQuantityUnit);
    });
