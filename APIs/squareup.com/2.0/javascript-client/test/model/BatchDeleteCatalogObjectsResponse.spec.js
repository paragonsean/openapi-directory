...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SquareConnectApi.BatchDeleteCatalogObjectsResponse();
  });
  ...
  describe('BatchDeleteCatalogObjectsResponse', function() {
    it('should create an instance of BatchDeleteCatalogObjectsResponse', function() {
      ...
      //var instance = new SquareConnectApi.BatchDeleteCatalogObjectsResponse();
      //expect(instance).to.be.a(SquareConnectApi.BatchDeleteCatalogObjectsResponse);
    });
