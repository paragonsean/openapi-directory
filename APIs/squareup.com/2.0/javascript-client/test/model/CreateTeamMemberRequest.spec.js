...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SquareConnectApi.CreateTeamMemberRequest();
  });
  ...
  describe('CreateTeamMemberRequest', function() {
    it('should create an instance of CreateTeamMemberRequest', function() {
      ...
      //var instance = new SquareConnectApi.CreateTeamMemberRequest();
      //expect(instance).to.be.a(SquareConnectApi.CreateTeamMemberRequest);
    });
