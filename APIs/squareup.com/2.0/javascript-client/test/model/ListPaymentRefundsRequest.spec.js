...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SquareConnectApi.ListPaymentRefundsRequest();
  });
  ...
  describe('ListPaymentRefundsRequest', function() {
    it('should create an instance of ListPaymentRefundsRequest', function() {
      ...
      //var instance = new SquareConnectApi.ListPaymentRefundsRequest();
      //expect(instance).to.be.a(SquareConnectApi.ListPaymentRefundsRequest);
    });
