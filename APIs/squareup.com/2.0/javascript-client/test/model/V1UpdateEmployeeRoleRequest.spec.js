...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SquareConnectApi.V1UpdateEmployeeRoleRequest();
  });
  ...
  describe('V1UpdateEmployeeRoleRequest', function() {
    it('should create an instance of V1UpdateEmployeeRoleRequest', function() {
      ...
      //var instance = new SquareConnectApi.V1UpdateEmployeeRoleRequest();
      //expect(instance).to.be.a(SquareConnectApi.V1UpdateEmployeeRoleRequest);
    });
