...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SquareConnectApi.LoyaltyEventOrderFilter();
  });
  ...
  describe('LoyaltyEventOrderFilter', function() {
    it('should create an instance of LoyaltyEventOrderFilter', function() {
      ...
      //var instance = new SquareConnectApi.LoyaltyEventOrderFilter();
      //expect(instance).to.be.a(SquareConnectApi.LoyaltyEventOrderFilter);
    });
