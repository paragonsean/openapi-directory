...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SquareConnectApi.BusinessHoursPeriod();
  });
  ...
  describe('BusinessHoursPeriod', function() {
    it('should create an instance of BusinessHoursPeriod', function() {
      ...
      //var instance = new SquareConnectApi.BusinessHoursPeriod();
      //expect(instance).to.be.a(SquareConnectApi.BusinessHoursPeriod);
    });
