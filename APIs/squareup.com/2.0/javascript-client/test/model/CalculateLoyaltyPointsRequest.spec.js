...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SquareConnectApi.CalculateLoyaltyPointsRequest();
  });
  ...
  describe('CalculateLoyaltyPointsRequest', function() {
    it('should create an instance of CalculateLoyaltyPointsRequest', function() {
      ...
      //var instance = new SquareConnectApi.CalculateLoyaltyPointsRequest();
      //expect(instance).to.be.a(SquareConnectApi.CalculateLoyaltyPointsRequest);
    });
