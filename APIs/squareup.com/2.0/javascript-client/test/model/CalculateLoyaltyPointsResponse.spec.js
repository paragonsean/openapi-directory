...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SquareConnectApi.CalculateLoyaltyPointsResponse();
  });
  ...
  describe('CalculateLoyaltyPointsResponse', function() {
    it('should create an instance of CalculateLoyaltyPointsResponse', function() {
      ...
      //var instance = new SquareConnectApi.CalculateLoyaltyPointsResponse();
      //expect(instance).to.be.a(SquareConnectApi.CalculateLoyaltyPointsResponse);
    });
