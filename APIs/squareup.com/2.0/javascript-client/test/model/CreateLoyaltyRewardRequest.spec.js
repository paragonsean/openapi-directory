...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SquareConnectApi.CreateLoyaltyRewardRequest();
  });
  ...
  describe('CreateLoyaltyRewardRequest', function() {
    it('should create an instance of CreateLoyaltyRewardRequest', function() {
      ...
      //var instance = new SquareConnectApi.CreateLoyaltyRewardRequest();
      //expect(instance).to.be.a(SquareConnectApi.CreateLoyaltyRewardRequest);
    });
