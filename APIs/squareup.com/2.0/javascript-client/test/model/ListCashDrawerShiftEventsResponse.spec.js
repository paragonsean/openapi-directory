...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SquareConnectApi.ListCashDrawerShiftEventsResponse();
  });
  ...
  describe('ListCashDrawerShiftEventsResponse', function() {
    it('should create an instance of ListCashDrawerShiftEventsResponse', function() {
      ...
      //var instance = new SquareConnectApi.ListCashDrawerShiftEventsResponse();
      //expect(instance).to.be.a(SquareConnectApi.ListCashDrawerShiftEventsResponse);
    });
