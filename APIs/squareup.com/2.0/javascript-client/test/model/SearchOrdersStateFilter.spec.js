...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SquareConnectApi.SearchOrdersStateFilter();
  });
  ...
  describe('SearchOrdersStateFilter', function() {
    it('should create an instance of SearchOrdersStateFilter', function() {
      ...
      //var instance = new SquareConnectApi.SearchOrdersStateFilter();
      //expect(instance).to.be.a(SquareConnectApi.SearchOrdersStateFilter);
    });
