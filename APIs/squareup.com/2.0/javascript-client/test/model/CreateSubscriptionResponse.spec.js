...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SquareConnectApi.CreateSubscriptionResponse();
  });
  ...
  describe('CreateSubscriptionResponse', function() {
    it('should create an instance of CreateSubscriptionResponse', function() {
      ...
      //var instance = new SquareConnectApi.CreateSubscriptionResponse();
      //expect(instance).to.be.a(SquareConnectApi.CreateSubscriptionResponse);
    });
