...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SquareConnectApi.CreateLoyaltyAccountRequest();
  });
  ...
  describe('CreateLoyaltyAccountRequest', function() {
    it('should create an instance of CreateLoyaltyAccountRequest', function() {
      ...
      //var instance = new SquareConnectApi.CreateLoyaltyAccountRequest();
      //expect(instance).to.be.a(SquareConnectApi.CreateLoyaltyAccountRequest);
    });
