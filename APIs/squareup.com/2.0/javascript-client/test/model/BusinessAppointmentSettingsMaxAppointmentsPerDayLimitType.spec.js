...
(function(root, factory) {
  ...
  describe('BusinessAppointmentSettingsMaxAppointmentsPerDayLimitType', function() {
    it('should create an instance of BusinessAppointmentSettingsMaxAppointmentsPerDayLimitType', function() {
      ...
      //var instance = new SquareConnectApi.BusinessAppointmentSettingsMaxAppointmentsPerDayLimitType();
      //expect(instance).to.be.a(SquareConnectApi.BusinessAppointmentSettingsMaxAppointmentsPerDayLimitType);
    });
