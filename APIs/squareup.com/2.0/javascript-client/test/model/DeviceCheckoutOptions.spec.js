...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SquareConnectApi.DeviceCheckoutOptions();
  });
  ...
  describe('DeviceCheckoutOptions', function() {
    it('should create an instance of DeviceCheckoutOptions', function() {
      ...
      //var instance = new SquareConnectApi.DeviceCheckoutOptions();
      //expect(instance).to.be.a(SquareConnectApi.DeviceCheckoutOptions);
    });
