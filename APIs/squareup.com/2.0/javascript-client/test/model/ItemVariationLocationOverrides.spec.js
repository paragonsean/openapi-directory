...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SquareConnectApi.ItemVariationLocationOverrides();
  });
  ...
  describe('ItemVariationLocationOverrides', function() {
    it('should create an instance of ItemVariationLocationOverrides', function() {
      ...
      //var instance = new SquareConnectApi.ItemVariationLocationOverrides();
      //expect(instance).to.be.a(SquareConnectApi.ItemVariationLocationOverrides);
    });
