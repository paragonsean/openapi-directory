...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SquareConnectApi.UpsertCatalogObjectRequest();
  });
  ...
  describe('UpsertCatalogObjectRequest', function() {
    it('should create an instance of UpsertCatalogObjectRequest', function() {
      ...
      //var instance = new SquareConnectApi.UpsertCatalogObjectRequest();
      //expect(instance).to.be.a(SquareConnectApi.UpsertCatalogObjectRequest);
    });
