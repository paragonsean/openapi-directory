...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SquareConnectApi.SearchOrdersSort();
  });
  ...
  describe('SearchOrdersSort', function() {
    it('should create an instance of SearchOrdersSort', function() {
      ...
      //var instance = new SquareConnectApi.SearchOrdersSort();
      //expect(instance).to.be.a(SquareConnectApi.SearchOrdersSort);
    });
