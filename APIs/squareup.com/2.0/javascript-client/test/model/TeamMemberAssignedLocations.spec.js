...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SquareConnectApi.TeamMemberAssignedLocations();
  });
  ...
  describe('TeamMemberAssignedLocations', function() {
    it('should create an instance of TeamMemberAssignedLocations', function() {
      ...
      //var instance = new SquareConnectApi.TeamMemberAssignedLocations();
      //expect(instance).to.be.a(SquareConnectApi.TeamMemberAssignedLocations);
    });
