...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SquareConnectApi.LoyaltyEventAdjustPoints();
  });
  ...
  describe('LoyaltyEventAdjustPoints', function() {
    it('should create an instance of LoyaltyEventAdjustPoints', function() {
      ...
      //var instance = new SquareConnectApi.LoyaltyEventAdjustPoints();
      //expect(instance).to.be.a(SquareConnectApi.LoyaltyEventAdjustPoints);
    });
