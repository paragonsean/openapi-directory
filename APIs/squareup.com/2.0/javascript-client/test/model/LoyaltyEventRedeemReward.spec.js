...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SquareConnectApi.LoyaltyEventRedeemReward();
  });
  ...
  describe('LoyaltyEventRedeemReward', function() {
    it('should create an instance of LoyaltyEventRedeemReward', function() {
      ...
      //var instance = new SquareConnectApi.LoyaltyEventRedeemReward();
      //expect(instance).to.be.a(SquareConnectApi.LoyaltyEventRedeemReward);
    });
