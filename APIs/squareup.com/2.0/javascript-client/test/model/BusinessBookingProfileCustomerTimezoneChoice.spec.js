...
(function(root, factory) {
  ...
  describe('BusinessBookingProfileCustomerTimezoneChoice', function() {
    it('should create an instance of BusinessBookingProfileCustomerTimezoneChoice', function() {
      ...
      //var instance = new SquareConnectApi.BusinessBookingProfileCustomerTimezoneChoice();
      //expect(instance).to.be.a(SquareConnectApi.BusinessBookingProfileCustomerTimezoneChoice);
    });
