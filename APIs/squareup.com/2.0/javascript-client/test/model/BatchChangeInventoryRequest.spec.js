...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SquareConnectApi.BatchChangeInventoryRequest();
  });
  ...
  describe('BatchChangeInventoryRequest', function() {
    it('should create an instance of BatchChangeInventoryRequest', function() {
      ...
      //var instance = new SquareConnectApi.BatchChangeInventoryRequest();
      //expect(instance).to.be.a(SquareConnectApi.BatchChangeInventoryRequest);
    });
