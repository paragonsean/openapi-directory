...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SquareConnectApi.GiftCardActivityUnlinkedActivityRefund();
  });
  ...
  describe('GiftCardActivityUnlinkedActivityRefund', function() {
    it('should create an instance of GiftCardActivityUnlinkedActivityRefund', function() {
      // uncomment below and update the code to test GiftCardActivityUnlinkedActivityRefund
      //var instance = new SquareConnectApi.GiftCardActivityUnlinkedActivityRefund();
      //expect(instance).to.be.a(SquareConnectApi.GiftCardActivityUnlinkedActivityRefund);
    });
