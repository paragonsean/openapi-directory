...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SquareConnectApi.ListTeamMemberWagesResponse();
  });
  ...
  describe('ListTeamMemberWagesResponse', function() {
    it('should create an instance of ListTeamMemberWagesResponse', function() {
      ...
      //var instance = new SquareConnectApi.ListTeamMemberWagesResponse();
      //expect(instance).to.be.a(SquareConnectApi.ListTeamMemberWagesResponse);
    });
