...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SquareConnectApi.RegisterDomainRequest();
  });
  ...
  describe('RegisterDomainRequest', function() {
    it('should create an instance of RegisterDomainRequest', function() {
      ...
      //var instance = new SquareConnectApi.RegisterDomainRequest();
      //expect(instance).to.be.a(SquareConnectApi.RegisterDomainRequest);
    });
