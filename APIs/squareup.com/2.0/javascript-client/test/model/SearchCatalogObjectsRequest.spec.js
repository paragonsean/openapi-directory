...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SquareConnectApi.SearchCatalogObjectsRequest();
  });
  ...
  describe('SearchCatalogObjectsRequest', function() {
    it('should create an instance of SearchCatalogObjectsRequest', function() {
      ...
      //var instance = new SquareConnectApi.SearchCatalogObjectsRequest();
      //expect(instance).to.be.a(SquareConnectApi.SearchCatalogObjectsRequest);
    });
