...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SquareConnectApi.ListDisputesRequest();
  });
  ...
  describe('ListDisputesRequest', function() {
    it('should create an instance of ListDisputesRequest', function() {
      ...
      //var instance = new SquareConnectApi.ListDisputesRequest();
      //expect(instance).to.be.a(SquareConnectApi.ListDisputesRequest);
    });
