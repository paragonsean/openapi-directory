...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SquareConnectApi.ListSubscriptionEventsRequest();
  });
  ...
  describe('ListSubscriptionEventsRequest', function() {
    it('should create an instance of ListSubscriptionEventsRequest', function() {
      ...
      //var instance = new SquareConnectApi.ListSubscriptionEventsRequest();
      //expect(instance).to.be.a(SquareConnectApi.ListSubscriptionEventsRequest);
    });
