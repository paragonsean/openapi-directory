...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SquareConnectApi.BatchRetrieveInventoryChangesRequest();
  });
  ...
  describe('BatchRetrieveInventoryChangesRequest', function() {
    it('should create an instance of BatchRetrieveInventoryChangesRequest', function() {
      ...
      //var instance = new SquareConnectApi.BatchRetrieveInventoryChangesRequest();
      //expect(instance).to.be.a(SquareConnectApi.BatchRetrieveInventoryChangesRequest);
    });
