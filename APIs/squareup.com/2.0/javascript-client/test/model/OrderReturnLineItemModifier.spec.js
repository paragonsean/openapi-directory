...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SquareConnectApi.OrderReturnLineItemModifier();
  });
  ...
  describe('OrderReturnLineItemModifier', function() {
    it('should create an instance of OrderReturnLineItemModifier', function() {
      ...
      //var instance = new SquareConnectApi.OrderReturnLineItemModifier();
      //expect(instance).to.be.a(SquareConnectApi.OrderReturnLineItemModifier);
    });
