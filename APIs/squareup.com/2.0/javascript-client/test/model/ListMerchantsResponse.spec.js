...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SquareConnectApi.ListMerchantsResponse();
  });
  ...
  describe('ListMerchantsResponse', function() {
    it('should create an instance of ListMerchantsResponse', function() {
      ...
      //var instance = new SquareConnectApi.ListMerchantsResponse();
      //expect(instance).to.be.a(SquareConnectApi.ListMerchantsResponse);
    });
