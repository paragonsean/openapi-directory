...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SquareConnectApi.ObtainTokenResponse();
  });
  ...
  describe('ObtainTokenResponse', function() {
    it('should create an instance of ObtainTokenResponse', function() {
      ...
      //var instance = new SquareConnectApi.ObtainTokenResponse();
      //expect(instance).to.be.a(SquareConnectApi.ObtainTokenResponse);
    });
