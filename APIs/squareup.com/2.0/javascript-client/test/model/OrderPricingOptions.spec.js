...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SquareConnectApi.OrderPricingOptions();
  });
  ...
  describe('OrderPricingOptions', function() {
    it('should create an instance of OrderPricingOptions', function() {
      ...
      //var instance = new SquareConnectApi.OrderPricingOptions();
      //expect(instance).to.be.a(SquareConnectApi.OrderPricingOptions);
    });
    ...
    it('should have the property autoApplyTaxes (base name: "auto_apply_taxes")', function() {
      // uncomment below and update the code to test the property autoApplyTaxes
      //var instance = new SquareConnectApi.OrderPricingOptions();
      //expect(instance).to.be();
    });
