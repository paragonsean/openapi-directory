...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SquareConnectApi.DeleteCatalogObjectResponse();
  });
  ...
  describe('DeleteCatalogObjectResponse', function() {
    it('should create an instance of DeleteCatalogObjectResponse', function() {
      ...
      //var instance = new SquareConnectApi.DeleteCatalogObjectResponse();
      //expect(instance).to.be.a(SquareConnectApi.DeleteCatalogObjectResponse);
    });
