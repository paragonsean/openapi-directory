...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SquareConnectApi.SearchLoyaltyRewardsResponse();
  });
  ...
  describe('SearchLoyaltyRewardsResponse', function() {
    it('should create an instance of SearchLoyaltyRewardsResponse', function() {
      ...
      //var instance = new SquareConnectApi.SearchLoyaltyRewardsResponse();
      //expect(instance).to.be.a(SquareConnectApi.SearchLoyaltyRewardsResponse);
    });
