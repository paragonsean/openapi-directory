...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SquareConnectApi.RedeemLoyaltyRewardRequest();
  });
  ...
  describe('RedeemLoyaltyRewardRequest', function() {
    it('should create an instance of RedeemLoyaltyRewardRequest', function() {
      ...
      //var instance = new SquareConnectApi.RedeemLoyaltyRewardRequest();
      //expect(instance).to.be.a(SquareConnectApi.RedeemLoyaltyRewardRequest);
    });
