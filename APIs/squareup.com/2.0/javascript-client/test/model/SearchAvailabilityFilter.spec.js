...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SquareConnectApi.SearchAvailabilityFilter();
  });
  ...
  describe('SearchAvailabilityFilter', function() {
    it('should create an instance of SearchAvailabilityFilter', function() {
      ...
      //var instance = new SquareConnectApi.SearchAvailabilityFilter();
      //expect(instance).to.be.a(SquareConnectApi.SearchAvailabilityFilter);
    });
