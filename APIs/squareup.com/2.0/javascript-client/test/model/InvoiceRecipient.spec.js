...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SquareConnectApi.InvoiceRecipient();
  });
  ...
  describe('InvoiceRecipient', function() {
    it('should create an instance of InvoiceRecipient', function() {
      ...
      //var instance = new SquareConnectApi.InvoiceRecipient();
      //expect(instance).to.be.a(SquareConnectApi.InvoiceRecipient);
    });
