...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SquareConnectApi.CancelTerminalCheckoutResponse();
  });
  ...
  describe('CancelTerminalCheckoutResponse', function() {
    it('should create an instance of CancelTerminalCheckoutResponse', function() {
      ...
      //var instance = new SquareConnectApi.CancelTerminalCheckoutResponse();
      //expect(instance).to.be.a(SquareConnectApi.CancelTerminalCheckoutResponse);
    });
