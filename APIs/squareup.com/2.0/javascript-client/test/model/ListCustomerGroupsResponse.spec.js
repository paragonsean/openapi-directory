...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SquareConnectApi.ListCustomerGroupsResponse();
  });
  ...
  describe('ListCustomerGroupsResponse', function() {
    it('should create an instance of ListCustomerGroupsResponse', function() {
      ...
      //var instance = new SquareConnectApi.ListCustomerGroupsResponse();
      //expect(instance).to.be.a(SquareConnectApi.ListCustomerGroupsResponse);
    });
