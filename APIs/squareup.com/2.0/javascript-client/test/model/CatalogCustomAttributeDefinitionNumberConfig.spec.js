...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SquareConnectApi.CatalogCustomAttributeDefinitionNumberConfig();
  });
  ...
  describe('CatalogCustomAttributeDefinitionNumberConfig', function() {
    it('should create an instance of CatalogCustomAttributeDefinitionNumberConfig', function() {
      ...
      //var instance = new SquareConnectApi.CatalogCustomAttributeDefinitionNumberConfig();
      //expect(instance).to.be.a(SquareConnectApi.CatalogCustomAttributeDefinitionNumberConfig);
    });
