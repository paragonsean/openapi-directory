...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SquareConnectApi.ListSubscriptionEventsResponse();
  });
  ...
  describe('ListSubscriptionEventsResponse', function() {
    it('should create an instance of ListSubscriptionEventsResponse', function() {
      ...
      //var instance = new SquareConnectApi.ListSubscriptionEventsResponse();
      //expect(instance).to.be.a(SquareConnectApi.ListSubscriptionEventsResponse);
    });
