...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SquareConnectApi.TerminalCheckoutQueryFilter();
  });
  ...
  describe('TerminalCheckoutQueryFilter', function() {
    it('should create an instance of TerminalCheckoutQueryFilter', function() {
      ...
      //var instance = new SquareConnectApi.TerminalCheckoutQueryFilter();
      //expect(instance).to.be.a(SquareConnectApi.TerminalCheckoutQueryFilter);
    });
