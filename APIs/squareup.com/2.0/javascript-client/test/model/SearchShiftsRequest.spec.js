...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SquareConnectApi.SearchShiftsRequest();
  });
  ...
  describe('SearchShiftsRequest', function() {
    it('should create an instance of SearchShiftsRequest', function() {
      ...
      //var instance = new SquareConnectApi.SearchShiftsRequest();
      //expect(instance).to.be.a(SquareConnectApi.SearchShiftsRequest);
    });
