...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SquareConnectApi.OrderLineItemDiscount();
  });
  ...
  describe('OrderLineItemDiscount', function() {
    it('should create an instance of OrderLineItemDiscount', function() {
      ...
      //var instance = new SquareConnectApi.OrderLineItemDiscount();
      //expect(instance).to.be.a(SquareConnectApi.OrderLineItemDiscount);
    });
    ...
    it('should have the property pricingRuleId (base name: "pricing_rule_id")', function() {
      // uncomment below and update the code to test the property pricingRuleId
      //var instance = new SquareConnectApi.OrderLineItemDiscount();
      //expect(instance).to.be();
    });

    it('should have the property rewardIds (base name: "reward_ids")', function() {
      // uncomment below and update the code to test the property rewardIds
      //var instance = new SquareConnectApi.OrderLineItemDiscount();
      //expect(instance).to.be();
    });
