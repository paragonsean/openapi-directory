...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SquareConnectApi.PublishInvoiceRequest();
  });
  ...
  describe('PublishInvoiceRequest', function() {
    it('should create an instance of PublishInvoiceRequest', function() {
      ...
      //var instance = new SquareConnectApi.PublishInvoiceRequest();
      //expect(instance).to.be.a(SquareConnectApi.PublishInvoiceRequest);
    });
