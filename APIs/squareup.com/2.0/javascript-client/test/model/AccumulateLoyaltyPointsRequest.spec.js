...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SquareConnectApi.AccumulateLoyaltyPointsRequest();
  });
  ...
  describe('AccumulateLoyaltyPointsRequest', function() {
    it('should create an instance of AccumulateLoyaltyPointsRequest', function() {
      ...
      //var instance = new SquareConnectApi.AccumulateLoyaltyPointsRequest();
      //expect(instance).to.be.a(SquareConnectApi.AccumulateLoyaltyPointsRequest);
    });
