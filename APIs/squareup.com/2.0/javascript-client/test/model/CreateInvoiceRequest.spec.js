...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SquareConnectApi.CreateInvoiceRequest();
  });
  ...
  describe('CreateInvoiceRequest', function() {
    it('should create an instance of CreateInvoiceRequest', function() {
      ...
      //var instance = new SquareConnectApi.CreateInvoiceRequest();
      //expect(instance).to.be.a(SquareConnectApi.CreateInvoiceRequest);
    });
