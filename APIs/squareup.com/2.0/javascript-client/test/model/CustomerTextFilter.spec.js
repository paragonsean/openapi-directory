...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SquareConnectApi.CustomerTextFilter();
  });
  ...
  describe('CustomerTextFilter', function() {
    it('should create an instance of CustomerTextFilter', function() {
      ...
      //var instance = new SquareConnectApi.CustomerTextFilter();
      //expect(instance).to.be.a(SquareConnectApi.CustomerTextFilter);
    });
