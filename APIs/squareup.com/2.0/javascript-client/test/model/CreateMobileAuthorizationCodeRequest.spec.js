...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SquareConnectApi.CreateMobileAuthorizationCodeRequest();
  });
  ...
  describe('CreateMobileAuthorizationCodeRequest', function() {
    it('should create an instance of CreateMobileAuthorizationCodeRequest', function() {
      ...
      //var instance = new SquareConnectApi.CreateMobileAuthorizationCodeRequest();
      //expect(instance).to.be.a(SquareConnectApi.CreateMobileAuthorizationCodeRequest);
    });
