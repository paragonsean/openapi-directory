...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SquareConnectApi.CatalogItemOptionValue();
  });
  ...
  describe('CatalogItemOptionValue', function() {
    it('should create an instance of CatalogItemOptionValue', function() {
      ...
      //var instance = new SquareConnectApi.CatalogItemOptionValue();
      //expect(instance).to.be.a(SquareConnectApi.CatalogItemOptionValue);
    });
