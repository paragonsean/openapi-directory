...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SquareConnectApi.ListEmployeesRequest();
  });
  ...
  describe('ListEmployeesRequest', function() {
    it('should create an instance of ListEmployeesRequest', function() {
      ...
      //var instance = new SquareConnectApi.ListEmployeesRequest();
      //expect(instance).to.be.a(SquareConnectApi.ListEmployeesRequest);
    });
