...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SquareConnectApi.V1PaymentModifier();
  });
  ...
  describe('V1PaymentModifier', function() {
    it('should create an instance of V1PaymentModifier', function() {
      ...
      //var instance = new SquareConnectApi.V1PaymentModifier();
      //expect(instance).to.be.a(SquareConnectApi.V1PaymentModifier);
    });
