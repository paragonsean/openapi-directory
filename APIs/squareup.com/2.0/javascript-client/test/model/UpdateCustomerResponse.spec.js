...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SquareConnectApi.UpdateCustomerResponse();
  });
  ...
  describe('UpdateCustomerResponse', function() {
    it('should create an instance of UpdateCustomerResponse', function() {
      ...
      //var instance = new SquareConnectApi.UpdateCustomerResponse();
      //expect(instance).to.be.a(SquareConnectApi.UpdateCustomerResponse);
    });
