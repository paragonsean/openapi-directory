...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SquareConnectApi.RetrieveCashDrawerShiftRequest();
  });
  ...
  describe('RetrieveCashDrawerShiftRequest', function() {
    it('should create an instance of RetrieveCashDrawerShiftRequest', function() {
      ...
      //var instance = new SquareConnectApi.RetrieveCashDrawerShiftRequest();
      //expect(instance).to.be.a(SquareConnectApi.RetrieveCashDrawerShiftRequest);
    });
