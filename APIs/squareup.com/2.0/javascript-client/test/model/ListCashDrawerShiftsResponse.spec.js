...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SquareConnectApi.ListCashDrawerShiftsResponse();
  });
  ...
  describe('ListCashDrawerShiftsResponse', function() {
    it('should create an instance of ListCashDrawerShiftsResponse', function() {
      ...
      //var instance = new SquareConnectApi.ListCashDrawerShiftsResponse();
      //expect(instance).to.be.a(SquareConnectApi.ListCashDrawerShiftsResponse);
    });
