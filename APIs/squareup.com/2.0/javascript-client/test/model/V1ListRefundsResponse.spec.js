...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SquareConnectApi.V1ListRefundsResponse();
  });
  ...
  describe('V1ListRefundsResponse', function() {
    it('should create an instance of V1ListRefundsResponse', function() {
      ...
      //var instance = new SquareConnectApi.V1ListRefundsResponse();
      //expect(instance).to.be.a(SquareConnectApi.V1ListRefundsResponse);
    });
