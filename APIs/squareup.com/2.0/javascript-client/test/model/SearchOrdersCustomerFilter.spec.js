...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SquareConnectApi.SearchOrdersCustomerFilter();
  });
  ...
  describe('SearchOrdersCustomerFilter', function() {
    it('should create an instance of SearchOrdersCustomerFilter', function() {
      ...
      //var instance = new SquareConnectApi.SearchOrdersCustomerFilter();
      //expect(instance).to.be.a(SquareConnectApi.SearchOrdersCustomerFilter);
    });
