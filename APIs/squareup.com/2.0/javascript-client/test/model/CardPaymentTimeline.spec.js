...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SquareConnectApi.CardPaymentTimeline();
  });
  ...
  describe('CardPaymentTimeline', function() {
    it('should create an instance of CardPaymentTimeline', function() {
      // uncomment below and update the code to test CardPaymentTimeline
      //var instance = new SquareConnectApi.CardPaymentTimeline();
      //expect(instance).to.be.a(SquareConnectApi.CardPaymentTimeline);
    });

    it('should have the property authorizedAt (base name: "authorized_at")', function() {
