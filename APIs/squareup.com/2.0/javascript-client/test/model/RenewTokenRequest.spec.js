...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SquareConnectApi.RenewTokenRequest();
  });
  ...
  describe('RenewTokenRequest', function() {
    it('should create an instance of RenewTokenRequest', function() {
      ...
      //var instance = new SquareConnectApi.RenewTokenRequest();
      //expect(instance).to.be.a(SquareConnectApi.RenewTokenRequest);
    });
