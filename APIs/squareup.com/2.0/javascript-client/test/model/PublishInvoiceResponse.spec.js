...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SquareConnectApi.PublishInvoiceResponse();
  });
  ...
  describe('PublishInvoiceResponse', function() {
    it('should create an instance of PublishInvoiceResponse', function() {
      ...
      //var instance = new SquareConnectApi.PublishInvoiceResponse();
      //expect(instance).to.be.a(SquareConnectApi.PublishInvoiceResponse);
    });
