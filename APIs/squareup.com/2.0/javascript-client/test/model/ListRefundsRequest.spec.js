...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SquareConnectApi.ListRefundsRequest();
  });
  ...
  describe('ListRefundsRequest', function() {
    it('should create an instance of ListRefundsRequest', function() {
      ...
      //var instance = new SquareConnectApi.ListRefundsRequest();
      //expect(instance).to.be.a(SquareConnectApi.ListRefundsRequest);
    });
