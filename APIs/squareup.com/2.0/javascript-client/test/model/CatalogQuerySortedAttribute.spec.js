...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SquareConnectApi.CatalogQuerySortedAttribute();
  });
  ...
  describe('CatalogQuerySortedAttribute', function() {
    it('should create an instance of CatalogQuerySortedAttribute', function() {
      ...
      //var instance = new SquareConnectApi.CatalogQuerySortedAttribute();
      //expect(instance).to.be.a(SquareConnectApi.CatalogQuerySortedAttribute);
    });
