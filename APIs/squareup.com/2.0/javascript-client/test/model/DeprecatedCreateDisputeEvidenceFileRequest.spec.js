...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SquareConnectApi.DeprecatedCreateDisputeEvidenceFileRequest();
  });
  ...
  describe('DeprecatedCreateDisputeEvidenceFileRequest', function() {
    it('should create an instance of DeprecatedCreateDisputeEvidenceFileRequest', function() {
      // uncomment below and update the code to test DeprecatedCreateDisputeEvidenceFileRequest
      //var instance = new SquareConnectApi.DeprecatedCreateDisputeEvidenceFileRequest();
      //expect(instance).to.be.a(SquareConnectApi.DeprecatedCreateDisputeEvidenceFileRequest);
    });
