...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SquareConnectApi.SourceApplication();
  });
  ...
  describe('SourceApplication', function() {
    it('should create an instance of SourceApplication', function() {
      ...
      //var instance = new SquareConnectApi.SourceApplication();
      //expect(instance).to.be.a(SquareConnectApi.SourceApplication);
    });
