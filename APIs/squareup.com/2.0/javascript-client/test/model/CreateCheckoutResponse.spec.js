...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SquareConnectApi.CreateCheckoutResponse();
  });
  ...
  describe('CreateCheckoutResponse', function() {
    it('should create an instance of CreateCheckoutResponse', function() {
      ...
      //var instance = new SquareConnectApi.CreateCheckoutResponse();
      //expect(instance).to.be.a(SquareConnectApi.CreateCheckoutResponse);
    });
