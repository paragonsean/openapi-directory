...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SquareConnectApi.LoyaltyEventAccumulatePoints();
  });
  ...
  describe('LoyaltyEventAccumulatePoints', function() {
    it('should create an instance of LoyaltyEventAccumulatePoints', function() {
      ...
      //var instance = new SquareConnectApi.LoyaltyEventAccumulatePoints();
      //expect(instance).to.be.a(SquareConnectApi.LoyaltyEventAccumulatePoints);
    });
