...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SquareConnectApi.RetrieveLoyaltyRewardResponse();
  });
  ...
  describe('RetrieveLoyaltyRewardResponse', function() {
    it('should create an instance of RetrieveLoyaltyRewardResponse', function() {
      ...
      //var instance = new SquareConnectApi.RetrieveLoyaltyRewardResponse();
      //expect(instance).to.be.a(SquareConnectApi.RetrieveLoyaltyRewardResponse);
    });
