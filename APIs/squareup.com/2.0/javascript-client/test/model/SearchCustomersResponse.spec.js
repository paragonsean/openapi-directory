...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SquareConnectApi.SearchCustomersResponse();
  });
  ...
  describe('SearchCustomersResponse', function() {
    it('should create an instance of SearchCustomersResponse', function() {
      ...
      //var instance = new SquareConnectApi.SearchCustomersResponse();
      //expect(instance).to.be.a(SquareConnectApi.SearchCustomersResponse);
    });
