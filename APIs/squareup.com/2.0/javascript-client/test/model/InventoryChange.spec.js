...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SquareConnectApi.InventoryChange();
  });
  ...
  describe('InventoryChange', function() {
    it('should create an instance of InventoryChange', function() {
      ...
      //var instance = new SquareConnectApi.InventoryChange();
      //expect(instance).to.be.a(SquareConnectApi.InventoryChange);
    });
