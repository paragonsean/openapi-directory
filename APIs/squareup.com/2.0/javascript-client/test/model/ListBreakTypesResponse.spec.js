...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SquareConnectApi.ListBreakTypesResponse();
  });
  ...
  describe('ListBreakTypesResponse', function() {
    it('should create an instance of ListBreakTypesResponse', function() {
      ...
      //var instance = new SquareConnectApi.ListBreakTypesResponse();
      //expect(instance).to.be.a(SquareConnectApi.ListBreakTypesResponse);
    });
