...
(function(root, factory) {
  ...
  describe('BusinessAppointmentSettingsCancellationPolicy', function() {
    it('should create an instance of BusinessAppointmentSettingsCancellationPolicy', function() {
      ...
      //var instance = new SquareConnectApi.BusinessAppointmentSettingsCancellationPolicy();
      //expect(instance).to.be.a(SquareConnectApi.BusinessAppointmentSettingsCancellationPolicy);
    });
