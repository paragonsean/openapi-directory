...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SquareConnectApi.V1ListPaymentsRequest();
  });
  ...
  describe('V1ListPaymentsRequest', function() {
    it('should create an instance of V1ListPaymentsRequest', function() {
      ...
      //var instance = new SquareConnectApi.V1ListPaymentsRequest();
      //expect(instance).to.be.a(SquareConnectApi.V1ListPaymentsRequest);
    });
