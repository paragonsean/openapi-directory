...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SquareConnectApi.CreateBookingRequest();
  });
  ...
  describe('CreateBookingRequest', function() {
    it('should create an instance of CreateBookingRequest', function() {
      ...
      //var instance = new SquareConnectApi.CreateBookingRequest();
      //expect(instance).to.be.a(SquareConnectApi.CreateBookingRequest);
    });
