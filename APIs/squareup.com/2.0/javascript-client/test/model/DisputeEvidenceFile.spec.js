...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SquareConnectApi.DisputeEvidenceFile();
  });
  ...
  describe('DisputeEvidenceFile', function() {
    it('should create an instance of DisputeEvidenceFile', function() {
      ...
      //var instance = new SquareConnectApi.DisputeEvidenceFile();
      //expect(instance).to.be.a(SquareConnectApi.DisputeEvidenceFile);
    });
