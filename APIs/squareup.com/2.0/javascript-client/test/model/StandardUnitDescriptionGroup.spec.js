...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SquareConnectApi.StandardUnitDescriptionGroup();
  });
  ...
  describe('StandardUnitDescriptionGroup', function() {
    it('should create an instance of StandardUnitDescriptionGroup', function() {
      ...
      //var instance = new SquareConnectApi.StandardUnitDescriptionGroup();
      //expect(instance).to.be.a(SquareConnectApi.StandardUnitDescriptionGroup);
    });
