...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SquareConnectApi.CatalogObjectBatch();
  });
  ...
  describe('CatalogObjectBatch', function() {
    it('should create an instance of CatalogObjectBatch', function() {
      ...
      //var instance = new SquareConnectApi.CatalogObjectBatch();
      //expect(instance).to.be.a(SquareConnectApi.CatalogObjectBatch);
    });
