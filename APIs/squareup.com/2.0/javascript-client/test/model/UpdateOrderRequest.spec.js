...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SquareConnectApi.UpdateOrderRequest();
  });
  ...
  describe('UpdateOrderRequest', function() {
    it('should create an instance of UpdateOrderRequest', function() {
      ...
      //var instance = new SquareConnectApi.UpdateOrderRequest();
      //expect(instance).to.be.a(SquareConnectApi.UpdateOrderRequest);
    });
