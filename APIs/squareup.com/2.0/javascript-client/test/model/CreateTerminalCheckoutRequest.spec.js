...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SquareConnectApi.CreateTerminalCheckoutRequest();
  });
  ...
  describe('CreateTerminalCheckoutRequest', function() {
    it('should create an instance of CreateTerminalCheckoutRequest', function() {
      ...
      //var instance = new SquareConnectApi.CreateTerminalCheckoutRequest();
      //expect(instance).to.be.a(SquareConnectApi.CreateTerminalCheckoutRequest);
    });
