...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SquareConnectApi.ListInvoicesRequest();
  });
  ...
  describe('ListInvoicesRequest', function() {
    it('should create an instance of ListInvoicesRequest', function() {
      ...
      //var instance = new SquareConnectApi.ListInvoicesRequest();
      //expect(instance).to.be.a(SquareConnectApi.ListInvoicesRequest);
    });
