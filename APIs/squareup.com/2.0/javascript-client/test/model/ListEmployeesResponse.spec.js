...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SquareConnectApi.ListEmployeesResponse();
  });
  ...
  describe('ListEmployeesResponse', function() {
    it('should create an instance of ListEmployeesResponse', function() {
      ...
      //var instance = new SquareConnectApi.ListEmployeesResponse();
      //expect(instance).to.be.a(SquareConnectApi.ListEmployeesResponse);
    });
