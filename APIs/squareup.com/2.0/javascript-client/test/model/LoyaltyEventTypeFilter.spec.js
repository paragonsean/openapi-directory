...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SquareConnectApi.LoyaltyEventTypeFilter();
  });
  ...
  describe('LoyaltyEventTypeFilter', function() {
    it('should create an instance of LoyaltyEventTypeFilter', function() {
      ...
      //var instance = new SquareConnectApi.LoyaltyEventTypeFilter();
      //expect(instance).to.be.a(SquareConnectApi.LoyaltyEventTypeFilter);
    });
