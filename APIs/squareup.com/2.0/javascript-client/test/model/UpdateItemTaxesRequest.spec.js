...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SquareConnectApi.UpdateItemTaxesRequest();
  });
  ...
  describe('UpdateItemTaxesRequest', function() {
    it('should create an instance of UpdateItemTaxesRequest', function() {
      ...
      //var instance = new SquareConnectApi.UpdateItemTaxesRequest();
      //expect(instance).to.be.a(SquareConnectApi.UpdateItemTaxesRequest);
    });
