...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SquareConnectApi.CreateDisputeEvidenceTextResponse();
  });
  ...
  describe('CreateDisputeEvidenceTextResponse', function() {
    it('should create an instance of CreateDisputeEvidenceTextResponse', function() {
      ...
      //var instance = new SquareConnectApi.CreateDisputeEvidenceTextResponse();
      //expect(instance).to.be.a(SquareConnectApi.CreateDisputeEvidenceTextResponse);
    });
