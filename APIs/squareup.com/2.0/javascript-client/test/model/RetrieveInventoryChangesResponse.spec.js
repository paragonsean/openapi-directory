...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SquareConnectApi.RetrieveInventoryChangesResponse();
  });
  ...
  describe('RetrieveInventoryChangesResponse', function() {
    it('should create an instance of RetrieveInventoryChangesResponse', function() {
      ...
      //var instance = new SquareConnectApi.RetrieveInventoryChangesResponse();
      //expect(instance).to.be.a(SquareConnectApi.RetrieveInventoryChangesResponse);
    });
