...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SquareConnectApi.CatalogCustomAttributeDefinitionStringConfig();
  });
  ...
  describe('CatalogCustomAttributeDefinitionStringConfig', function() {
    it('should create an instance of CatalogCustomAttributeDefinitionStringConfig', function() {
      ...
      //var instance = new SquareConnectApi.CatalogCustomAttributeDefinitionStringConfig();
      //expect(instance).to.be.a(SquareConnectApi.CatalogCustomAttributeDefinitionStringConfig);
    });
