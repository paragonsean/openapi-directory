...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SquareConnectApi.ListInvoicesResponse();
  });
  ...
  describe('ListInvoicesResponse', function() {
    it('should create an instance of ListInvoicesResponse', function() {
      // uncomment below and update the code to test ListInvoicesResponse
      //var instance = new SquareConnectApi.ListInvoicesResponse();
      //expect(instance).to.be.a(SquareConnectApi.ListInvoicesResponse);
    });
