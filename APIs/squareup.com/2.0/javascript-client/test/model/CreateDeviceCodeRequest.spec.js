...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SquareConnectApi.CreateDeviceCodeRequest();
  });
  ...
  describe('CreateDeviceCodeRequest', function() {
    it('should create an instance of CreateDeviceCodeRequest', function() {
      ...
      //var instance = new SquareConnectApi.CreateDeviceCodeRequest();
      //expect(instance).to.be.a(SquareConnectApi.CreateDeviceCodeRequest);
    });
