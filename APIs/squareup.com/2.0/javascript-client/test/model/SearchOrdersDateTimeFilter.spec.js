...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SquareConnectApi.SearchOrdersDateTimeFilter();
  });
  ...
  describe('SearchOrdersDateTimeFilter', function() {
    it('should create an instance of SearchOrdersDateTimeFilter', function() {
      ...
      //var instance = new SquareConnectApi.SearchOrdersDateTimeFilter();
      //expect(instance).to.be.a(SquareConnectApi.SearchOrdersDateTimeFilter);
    });
