...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SquareConnectApi.SubscriptionPhase();
  });
  ...
  describe('SubscriptionPhase', function() {
    it('should create an instance of SubscriptionPhase', function() {
      ...
      //var instance = new SquareConnectApi.SubscriptionPhase();
      //expect(instance).to.be.a(SquareConnectApi.SubscriptionPhase);
    });
