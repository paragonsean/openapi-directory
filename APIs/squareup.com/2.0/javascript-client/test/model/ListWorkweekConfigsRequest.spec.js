...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SquareConnectApi.ListWorkweekConfigsRequest();
  });
  ...
  describe('ListWorkweekConfigsRequest', function() {
    it('should create an instance of ListWorkweekConfigsRequest', function() {
      ...
      //var instance = new SquareConnectApi.ListWorkweekConfigsRequest();
      //expect(instance).to.be.a(SquareConnectApi.ListWorkweekConfigsRequest);
    });
