...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SquareConnectApi.RetrieveCustomerSegmentResponse();
  });
  ...
  describe('RetrieveCustomerSegmentResponse', function() {
    it('should create an instance of RetrieveCustomerSegmentResponse', function() {
      ...
      //var instance = new SquareConnectApi.RetrieveCustomerSegmentResponse();
      //expect(instance).to.be.a(SquareConnectApi.RetrieveCustomerSegmentResponse);
    });
