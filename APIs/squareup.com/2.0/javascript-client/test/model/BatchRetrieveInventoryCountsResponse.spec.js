...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SquareConnectApi.BatchRetrieveInventoryCountsResponse();
  });
  ...
  describe('BatchRetrieveInventoryCountsResponse', function() {
    it('should create an instance of BatchRetrieveInventoryCountsResponse', function() {
      ...
      //var instance = new SquareConnectApi.BatchRetrieveInventoryCountsResponse();
      //expect(instance).to.be.a(SquareConnectApi.BatchRetrieveInventoryCountsResponse);
    });
