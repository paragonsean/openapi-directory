...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SquareConnectApi.SearchLoyaltyAccountsResponse();
  });
  ...
  describe('SearchLoyaltyAccountsResponse', function() {
    it('should create an instance of SearchLoyaltyAccountsResponse', function() {
      ...
      //var instance = new SquareConnectApi.SearchLoyaltyAccountsResponse();
      //expect(instance).to.be.a(SquareConnectApi.SearchLoyaltyAccountsResponse);
    });
