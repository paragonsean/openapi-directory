...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SquareConnectApi.SearchLoyaltyAccountsRequest();
  });
  ...
  describe('SearchLoyaltyAccountsRequest', function() {
    it('should create an instance of SearchLoyaltyAccountsRequest', function() {
      ...
      //var instance = new SquareConnectApi.SearchLoyaltyAccountsRequest();
      //expect(instance).to.be.a(SquareConnectApi.SearchLoyaltyAccountsRequest);
    });
