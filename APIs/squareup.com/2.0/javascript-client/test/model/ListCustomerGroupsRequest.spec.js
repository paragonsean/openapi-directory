...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SquareConnectApi.ListCustomerGroupsRequest();
  });
  ...
  describe('ListCustomerGroupsRequest', function() {
    it('should create an instance of ListCustomerGroupsRequest', function() {
      ...
      //var instance = new SquareConnectApi.ListCustomerGroupsRequest();
      //expect(instance).to.be.a(SquareConnectApi.ListCustomerGroupsRequest);
    });
