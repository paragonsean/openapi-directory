...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SquareConnectApi.OrderReturnServiceCharge();
  });
  ...
  describe('OrderReturnServiceCharge', function() {
    it('should create an instance of OrderReturnServiceCharge', function() {
      ...
      //var instance = new SquareConnectApi.OrderReturnServiceCharge();
      //expect(instance).to.be.a(SquareConnectApi.OrderReturnServiceCharge);
    });
