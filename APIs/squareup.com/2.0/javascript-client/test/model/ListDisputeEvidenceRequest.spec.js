...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SquareConnectApi.ListDisputeEvidenceRequest();
  });
  ...
  describe('ListDisputeEvidenceRequest', function() {
    it('should create an instance of ListDisputeEvidenceRequest', function() {
      ...
      //var instance = new SquareConnectApi.ListDisputeEvidenceRequest();
      //expect(instance).to.be.a(SquareConnectApi.ListDisputeEvidenceRequest);
    });
