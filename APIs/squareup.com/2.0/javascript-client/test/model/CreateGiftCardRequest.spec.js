...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SquareConnectApi.CreateGiftCardRequest();
  });
  ...
  describe('CreateGiftCardRequest', function() {
    it('should create an instance of CreateGiftCardRequest', function() {
      ...
      //var instance = new SquareConnectApi.CreateGiftCardRequest();
      //expect(instance).to.be.a(SquareConnectApi.CreateGiftCardRequest);
    });
