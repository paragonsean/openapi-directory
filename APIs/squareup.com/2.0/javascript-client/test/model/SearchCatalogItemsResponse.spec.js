...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SquareConnectApi.SearchCatalogItemsResponse();
  });
  ...
  describe('SearchCatalogItemsResponse', function() {
    it('should create an instance of SearchCatalogItemsResponse', function() {
      ...
      //var instance = new SquareConnectApi.SearchCatalogItemsResponse();
      //expect(instance).to.be.a(SquareConnectApi.SearchCatalogItemsResponse);
    });
