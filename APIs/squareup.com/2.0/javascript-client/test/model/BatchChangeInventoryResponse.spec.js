...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SquareConnectApi.BatchChangeInventoryResponse();
  });
  ...
  describe('BatchChangeInventoryResponse', function() {
    it('should create an instance of BatchChangeInventoryResponse', function() {
      ...
      //var instance = new SquareConnectApi.BatchChangeInventoryResponse();
      //expect(instance).to.be.a(SquareConnectApi.BatchChangeInventoryResponse);
    });
