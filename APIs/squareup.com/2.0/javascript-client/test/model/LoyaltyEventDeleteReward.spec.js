...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SquareConnectApi.LoyaltyEventDeleteReward();
  });
  ...
  describe('LoyaltyEventDeleteReward', function() {
    it('should create an instance of LoyaltyEventDeleteReward', function() {
      ...
      //var instance = new SquareConnectApi.LoyaltyEventDeleteReward();
      //expect(instance).to.be.a(SquareConnectApi.LoyaltyEventDeleteReward);
    });
