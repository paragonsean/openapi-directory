...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SquareConnectApi.RetrieveInventoryCountRequest();
  });
  ...
  describe('RetrieveInventoryCountRequest', function() {
    it('should create an instance of RetrieveInventoryCountRequest', function() {
      ...
      //var instance = new SquareConnectApi.RetrieveInventoryCountRequest();
      //expect(instance).to.be.a(SquareConnectApi.RetrieveInventoryCountRequest);
    });
