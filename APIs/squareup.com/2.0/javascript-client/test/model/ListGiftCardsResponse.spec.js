...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SquareConnectApi.ListGiftCardsResponse();
  });
  ...
  describe('ListGiftCardsResponse', function() {
    it('should create an instance of ListGiftCardsResponse', function() {
      // uncomment below and update the code to test ListGiftCardsResponse
      //var instance = new SquareConnectApi.ListGiftCardsResponse();
      //expect(instance).to.be.a(SquareConnectApi.ListGiftCardsResponse);
    });
