...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SquareConnectApi.CashPaymentDetails();
  });
  ...
  describe('CashPaymentDetails', function() {
    it('should create an instance of CashPaymentDetails', function() {
      ...
      //var instance = new SquareConnectApi.CashPaymentDetails();
      //expect(instance).to.be.a(SquareConnectApi.CashPaymentDetails);
    });
