...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SquareConnectApi.ListMerchantsRequest();
  });
  ...
  describe('ListMerchantsRequest', function() {
    it('should create an instance of ListMerchantsRequest', function() {
      ...
      //var instance = new SquareConnectApi.ListMerchantsRequest();
      //expect(instance).to.be.a(SquareConnectApi.ListMerchantsRequest);
    });
