...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SquareConnectApi.CreateLoyaltyRewardResponse();
  });
  ...
  describe('CreateLoyaltyRewardResponse', function() {
    it('should create an instance of CreateLoyaltyRewardResponse', function() {
      ...
      //var instance = new SquareConnectApi.CreateLoyaltyRewardResponse();
      //expect(instance).to.be.a(SquareConnectApi.CreateLoyaltyRewardResponse);
    });
