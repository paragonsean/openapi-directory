...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SquareConnectApi.LoyaltyEventLocationFilter();
  });
  ...
  describe('LoyaltyEventLocationFilter', function() {
    it('should create an instance of LoyaltyEventLocationFilter', function() {
      ...
      //var instance = new SquareConnectApi.LoyaltyEventLocationFilter();
      //expect(instance).to.be.a(SquareConnectApi.LoyaltyEventLocationFilter);
    });
