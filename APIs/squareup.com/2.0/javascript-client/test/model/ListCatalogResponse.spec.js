...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SquareConnectApi.ListCatalogResponse();
  });
  ...
  describe('ListCatalogResponse', function() {
    it('should create an instance of ListCatalogResponse', function() {
      ...
      //var instance = new SquareConnectApi.ListCatalogResponse();
      //expect(instance).to.be.a(SquareConnectApi.ListCatalogResponse);
    });
