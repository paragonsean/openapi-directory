...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SquareConnectApi.CreateMobileAuthorizationCodeResponse();
  });
  ...
  describe('CreateMobileAuthorizationCodeResponse', function() {
    it('should create an instance of CreateMobileAuthorizationCodeResponse', function() {
      ...
      //var instance = new SquareConnectApi.CreateMobileAuthorizationCodeResponse();
      //expect(instance).to.be.a(SquareConnectApi.CreateMobileAuthorizationCodeResponse);
    });
