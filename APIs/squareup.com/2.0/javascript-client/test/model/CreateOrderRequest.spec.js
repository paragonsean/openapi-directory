...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SquareConnectApi.CreateOrderRequest();
  });
  ...
  describe('CreateOrderRequest', function() {
    it('should create an instance of CreateOrderRequest', function() {
      ...
      //var instance = new SquareConnectApi.CreateOrderRequest();
      //expect(instance).to.be.a(SquareConnectApi.CreateOrderRequest);
    });
