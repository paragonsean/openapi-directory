...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SquareConnectApi.BatchDeleteCatalogObjectsRequest();
  });
  ...
  describe('BatchDeleteCatalogObjectsRequest', function() {
    it('should create an instance of BatchDeleteCatalogObjectsRequest', function() {
      ...
      //var instance = new SquareConnectApi.BatchDeleteCatalogObjectsRequest();
      //expect(instance).to.be.a(SquareConnectApi.BatchDeleteCatalogObjectsRequest);
    });
