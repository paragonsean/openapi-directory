...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SquareConnectApi.SearchTeamMembersRequest();
  });
  ...
  describe('SearchTeamMembersRequest', function() {
    it('should create an instance of SearchTeamMembersRequest', function() {
      ...
      //var instance = new SquareConnectApi.SearchTeamMembersRequest();
      //expect(instance).to.be.a(SquareConnectApi.SearchTeamMembersRequest);
    });
