...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SquareConnectApi.RenewTokenResponse();
  });
  ...
  describe('RenewTokenResponse', function() {
    it('should create an instance of RenewTokenResponse', function() {
      ...
      //var instance = new SquareConnectApi.RenewTokenResponse();
      //expect(instance).to.be.a(SquareConnectApi.RenewTokenResponse);
    });
