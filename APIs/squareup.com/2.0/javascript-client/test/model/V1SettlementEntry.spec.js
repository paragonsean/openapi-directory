...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SquareConnectApi.V1SettlementEntry();
  });
  ...
  describe('V1SettlementEntry', function() {
    it('should create an instance of V1SettlementEntry', function() {
      ...
      //var instance = new SquareConnectApi.V1SettlementEntry();
      //expect(instance).to.be.a(SquareConnectApi.V1SettlementEntry);
    });
