...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SquareConnectApi.SearchSubscriptionsRequest();
  });
  ...
  describe('SearchSubscriptionsRequest', function() {
    it('should create an instance of SearchSubscriptionsRequest', function() {
      ...
      //var instance = new SquareConnectApi.SearchSubscriptionsRequest();
      //expect(instance).to.be.a(SquareConnectApi.SearchSubscriptionsRequest);
    });
