...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SquareConnectApi.BulkUpdateTeamMembersRequest();
  });
  ...
  describe('BulkUpdateTeamMembersRequest', function() {
    it('should create an instance of BulkUpdateTeamMembersRequest', function() {
      ...
      //var instance = new SquareConnectApi.BulkUpdateTeamMembersRequest();
      //expect(instance).to.be.a(SquareConnectApi.BulkUpdateTeamMembersRequest);
    });
