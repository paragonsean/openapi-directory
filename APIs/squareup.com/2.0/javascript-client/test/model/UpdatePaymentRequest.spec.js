...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SquareConnectApi.UpdatePaymentRequest();
  });
  ...
  describe('UpdatePaymentRequest', function() {
    it('should create an instance of UpdatePaymentRequest', function() {
      ...
      //var instance = new SquareConnectApi.UpdatePaymentRequest();
      //expect(instance).to.be.a(SquareConnectApi.UpdatePaymentRequest);
    });
