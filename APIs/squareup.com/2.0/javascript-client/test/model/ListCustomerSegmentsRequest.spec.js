...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SquareConnectApi.ListCustomerSegmentsRequest();
  });
  ...
  describe('ListCustomerSegmentsRequest', function() {
    it('should create an instance of ListCustomerSegmentsRequest', function() {
      ...
      //var instance = new SquareConnectApi.ListCustomerSegmentsRequest();
      //expect(instance).to.be.a(SquareConnectApi.ListCustomerSegmentsRequest);
    });
