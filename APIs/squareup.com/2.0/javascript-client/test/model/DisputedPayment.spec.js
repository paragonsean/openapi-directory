...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SquareConnectApi.DisputedPayment();
  });
  ...
  describe('DisputedPayment', function() {
    it('should create an instance of DisputedPayment', function() {
      ...
      //var instance = new SquareConnectApi.DisputedPayment();
      //expect(instance).to.be.a(SquareConnectApi.DisputedPayment);
    });
