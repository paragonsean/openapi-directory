...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SquareConnectApi.RetrieveTeamMemberBookingProfileResponse();
  });
  ...
  describe('RetrieveTeamMemberBookingProfileResponse', function() {
    it('should create an instance of RetrieveTeamMemberBookingProfileResponse', function() {
      ...
      //var instance = new SquareConnectApi.RetrieveTeamMemberBookingProfileResponse();
      //expect(instance).to.be.a(SquareConnectApi.RetrieveTeamMemberBookingProfileResponse);
    });
