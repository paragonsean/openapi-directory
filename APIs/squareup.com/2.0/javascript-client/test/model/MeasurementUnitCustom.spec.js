...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SquareConnectApi.MeasurementUnitCustom();
  });
  ...
  describe('MeasurementUnitCustom', function() {
    it('should create an instance of MeasurementUnitCustom', function() {
      ...
      //var instance = new SquareConnectApi.MeasurementUnitCustom();
      //expect(instance).to.be.a(SquareConnectApi.MeasurementUnitCustom);
    });
