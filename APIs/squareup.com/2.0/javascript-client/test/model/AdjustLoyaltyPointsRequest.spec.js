...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SquareConnectApi.AdjustLoyaltyPointsRequest();
  });
  ...
  describe('AdjustLoyaltyPointsRequest', function() {
    it('should create an instance of AdjustLoyaltyPointsRequest', function() {
      ...
      //var instance = new SquareConnectApi.AdjustLoyaltyPointsRequest();
      //expect(instance).to.be.a(SquareConnectApi.AdjustLoyaltyPointsRequest);
    });
