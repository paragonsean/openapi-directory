...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SquareConnectApi.SearchLoyaltyEventsRequest();
  });
  ...
  describe('SearchLoyaltyEventsRequest', function() {
    it('should create an instance of SearchLoyaltyEventsRequest', function() {
      ...
      //var instance = new SquareConnectApi.SearchLoyaltyEventsRequest();
      //expect(instance).to.be.a(SquareConnectApi.SearchLoyaltyEventsRequest);
    });
