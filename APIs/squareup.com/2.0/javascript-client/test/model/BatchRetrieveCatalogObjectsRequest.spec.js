...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SquareConnectApi.BatchRetrieveCatalogObjectsRequest();
  });
  ...
  describe('BatchRetrieveCatalogObjectsRequest', function() {
    it('should create an instance of BatchRetrieveCatalogObjectsRequest', function() {
      ...
      //var instance = new SquareConnectApi.BatchRetrieveCatalogObjectsRequest();
      //expect(instance).to.be.a(SquareConnectApi.BatchRetrieveCatalogObjectsRequest);
    });
