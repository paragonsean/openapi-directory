...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SquareConnectApi.SearchCustomersRequest();
  });
  ...
  describe('SearchCustomersRequest', function() {
    it('should create an instance of SearchCustomersRequest', function() {
      ...
      //var instance = new SquareConnectApi.SearchCustomersRequest();
      //expect(instance).to.be.a(SquareConnectApi.SearchCustomersRequest);
    });
