...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SquareConnectApi.StandardUnitDescription();
  });
  ...
  describe('StandardUnitDescription', function() {
    it('should create an instance of StandardUnitDescription', function() {
      ...
      //var instance = new SquareConnectApi.StandardUnitDescription();
      //expect(instance).to.be.a(SquareConnectApi.StandardUnitDescription);
    });
