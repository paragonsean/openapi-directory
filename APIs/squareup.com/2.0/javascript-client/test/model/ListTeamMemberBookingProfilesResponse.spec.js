...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SquareConnectApi.ListTeamMemberBookingProfilesResponse();
  });
  ...
  describe('ListTeamMemberBookingProfilesResponse', function() {
    it('should create an instance of ListTeamMemberBookingProfilesResponse', function() {
      ...
      //var instance = new SquareConnectApi.ListTeamMemberBookingProfilesResponse();
      //expect(instance).to.be.a(SquareConnectApi.ListTeamMemberBookingProfilesResponse);
    });
