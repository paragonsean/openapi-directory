...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SquareConnectApi.TerminalCheckoutQuerySort();
  });
  ...
  describe('TerminalCheckoutQuerySort', function() {
    it('should create an instance of TerminalCheckoutQuerySort', function() {
      ...
      //var instance = new SquareConnectApi.TerminalCheckoutQuerySort();
      //expect(instance).to.be.a(SquareConnectApi.TerminalCheckoutQuerySort);
    });
