...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SquareConnectApi.LoyaltyEventExpirePoints();
  });
  ...
  describe('LoyaltyEventExpirePoints', function() {
    it('should create an instance of LoyaltyEventExpirePoints', function() {
      ...
      //var instance = new SquareConnectApi.LoyaltyEventExpirePoints();
      //expect(instance).to.be.a(SquareConnectApi.LoyaltyEventExpirePoints);
    });
