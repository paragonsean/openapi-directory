...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SquareConnectApi.CancelInvoiceResponse();
  });
  ...
  describe('CancelInvoiceResponse', function() {
    it('should create an instance of CancelInvoiceResponse', function() {
      ...
      //var instance = new SquareConnectApi.CancelInvoiceResponse();
      //expect(instance).to.be.a(SquareConnectApi.CancelInvoiceResponse);
    });
