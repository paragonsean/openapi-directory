...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SquareConnectApi.SearchShiftsResponse();
  });
  ...
  describe('SearchShiftsResponse', function() {
    it('should create an instance of SearchShiftsResponse', function() {
      ...
      //var instance = new SquareConnectApi.SearchShiftsResponse();
      //expect(instance).to.be.a(SquareConnectApi.SearchShiftsResponse);
    });
