...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SquareConnectApi.BatchUpsertCatalogObjectsResponse();
  });
  ...
  describe('BatchUpsertCatalogObjectsResponse', function() {
    it('should create an instance of BatchUpsertCatalogObjectsResponse', function() {
      ...
      //var instance = new SquareConnectApi.BatchUpsertCatalogObjectsResponse();
      //expect(instance).to.be.a(SquareConnectApi.BatchUpsertCatalogObjectsResponse);
    });
