...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SquareConnectApi.RetrieveTransactionResponse();
  });
  ...
  describe('RetrieveTransactionResponse', function() {
    it('should create an instance of RetrieveTransactionResponse', function() {
      ...
      //var instance = new SquareConnectApi.RetrieveTransactionResponse();
      //expect(instance).to.be.a(SquareConnectApi.RetrieveTransactionResponse);
    });
