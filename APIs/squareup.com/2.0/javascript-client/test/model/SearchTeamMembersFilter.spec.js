...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SquareConnectApi.SearchTeamMembersFilter();
  });
  ...
  describe('SearchTeamMembersFilter', function() {
    it('should create an instance of SearchTeamMembersFilter', function() {
      ...
      //var instance = new SquareConnectApi.SearchTeamMembersFilter();
      //expect(instance).to.be.a(SquareConnectApi.SearchTeamMembersFilter);
    });
