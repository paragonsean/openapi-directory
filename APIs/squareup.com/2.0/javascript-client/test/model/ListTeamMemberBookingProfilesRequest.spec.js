...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SquareConnectApi.ListTeamMemberBookingProfilesRequest();
  });
  ...
  describe('ListTeamMemberBookingProfilesRequest', function() {
    it('should create an instance of ListTeamMemberBookingProfilesRequest', function() {
      ...
      //var instance = new SquareConnectApi.ListTeamMemberBookingProfilesRequest();
      //expect(instance).to.be.a(SquareConnectApi.ListTeamMemberBookingProfilesRequest);
    });
