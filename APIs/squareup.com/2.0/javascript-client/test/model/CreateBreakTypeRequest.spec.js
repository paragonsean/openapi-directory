...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SquareConnectApi.CreateBreakTypeRequest();
  });
  ...
  describe('CreateBreakTypeRequest', function() {
    it('should create an instance of CreateBreakTypeRequest', function() {
      ...
      //var instance = new SquareConnectApi.CreateBreakTypeRequest();
      //expect(instance).to.be.a(SquareConnectApi.CreateBreakTypeRequest);
    });
