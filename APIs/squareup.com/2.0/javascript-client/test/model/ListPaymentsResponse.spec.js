...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SquareConnectApi.ListPaymentsResponse();
  });
  ...
  describe('ListPaymentsResponse', function() {
    it('should create an instance of ListPaymentsResponse', function() {
      ...
      //var instance = new SquareConnectApi.ListPaymentsResponse();
      //expect(instance).to.be.a(SquareConnectApi.ListPaymentsResponse);
    });
