...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SquareConnectApi.BatchRetrieveCatalogObjectsResponse();
  });
  ...
  describe('BatchRetrieveCatalogObjectsResponse', function() {
    it('should create an instance of BatchRetrieveCatalogObjectsResponse', function() {
      ...
      //var instance = new SquareConnectApi.BatchRetrieveCatalogObjectsResponse();
      //expect(instance).to.be.a(SquareConnectApi.BatchRetrieveCatalogObjectsResponse);
    });
