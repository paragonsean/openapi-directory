...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SquareConnectApi.CustomerCreationSourceFilter();
  });
  ...
  describe('CustomerCreationSourceFilter', function() {
    it('should create an instance of CustomerCreationSourceFilter', function() {
      ...
      //var instance = new SquareConnectApi.CustomerCreationSourceFilter();
      //expect(instance).to.be.a(SquareConnectApi.CustomerCreationSourceFilter);
    });
