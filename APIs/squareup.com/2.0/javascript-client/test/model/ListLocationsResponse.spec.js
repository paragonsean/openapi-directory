...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SquareConnectApi.ListLocationsResponse();
  });
  ...
  describe('ListLocationsResponse', function() {
    it('should create an instance of ListLocationsResponse', function() {
      ...
      //var instance = new SquareConnectApi.ListLocationsResponse();
      //expect(instance).to.be.a(SquareConnectApi.ListLocationsResponse);
    });
