...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SquareConnectApi.CreateCardRequest();
  });
  ...
  describe('CreateCardRequest', function() {
    it('should create an instance of CreateCardRequest', function() {
      // uncomment below and update the code to test CreateCardRequest
      //var instance = new SquareConnectApi.CreateCardRequest();
      //expect(instance).to.be.a(SquareConnectApi.CreateCardRequest);
    });
