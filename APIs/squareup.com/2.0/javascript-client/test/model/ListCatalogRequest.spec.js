...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SquareConnectApi.ListCatalogRequest();
  });
  ...
  describe('ListCatalogRequest', function() {
    it('should create an instance of ListCatalogRequest', function() {
      ...
      //var instance = new SquareConnectApi.ListCatalogRequest();
      //expect(instance).to.be.a(SquareConnectApi.ListCatalogRequest);
    });
