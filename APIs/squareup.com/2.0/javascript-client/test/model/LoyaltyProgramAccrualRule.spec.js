...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SquareConnectApi.LoyaltyProgramAccrualRule();
  });
  ...
  describe('LoyaltyProgramAccrualRule', function() {
    it('should create an instance of LoyaltyProgramAccrualRule', function() {
      ...
      //var instance = new SquareConnectApi.LoyaltyProgramAccrualRule();
      //expect(instance).to.be.a(SquareConnectApi.LoyaltyProgramAccrualRule);
    });
    ...
    it('should have the property excludedCategoryIds (base name: "excluded_category_ids")', function() {
      // uncomment below and update the code to test the property excludedCategoryIds
      //var instance = new SquareConnectApi.LoyaltyProgramAccrualRule();
      //expect(instance).to.be();
    });

    it('should have the property excludedItemVariationIds (base name: "excluded_item_variation_ids")', function() {
      // uncomment below and update the code to test the property excludedItemVariationIds
      //var instance = new SquareConnectApi.LoyaltyProgramAccrualRule();
      //expect(instance).to.be();
    });
