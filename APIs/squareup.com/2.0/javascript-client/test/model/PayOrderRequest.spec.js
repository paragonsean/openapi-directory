...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SquareConnectApi.PayOrderRequest();
  });
  ...
  describe('PayOrderRequest', function() {
    it('should create an instance of PayOrderRequest', function() {
      ...
      //var instance = new SquareConnectApi.PayOrderRequest();
      //expect(instance).to.be.a(SquareConnectApi.PayOrderRequest);
    });
