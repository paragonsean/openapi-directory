...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SquareConnectApi.RetrieveEmployeeResponse();
  });
  ...
  describe('RetrieveEmployeeResponse', function() {
    it('should create an instance of RetrieveEmployeeResponse', function() {
      ...
      //var instance = new SquareConnectApi.RetrieveEmployeeResponse();
      //expect(instance).to.be.a(SquareConnectApi.RetrieveEmployeeResponse);
    });
