...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SquareConnectApi.UpdateItemModifierListsRequest();
  });
  ...
  describe('UpdateItemModifierListsRequest', function() {
    it('should create an instance of UpdateItemModifierListsRequest', function() {
      ...
      //var instance = new SquareConnectApi.UpdateItemModifierListsRequest();
      //expect(instance).to.be.a(SquareConnectApi.UpdateItemModifierListsRequest);
    });
