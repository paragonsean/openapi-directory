...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SquareConnectApi.V1ListSettlementsRequest();
  });
  ...
  describe('V1ListSettlementsRequest', function() {
    it('should create an instance of V1ListSettlementsRequest', function() {
      ...
      //var instance = new SquareConnectApi.V1ListSettlementsRequest();
      //expect(instance).to.be.a(SquareConnectApi.V1ListSettlementsRequest);
    });
