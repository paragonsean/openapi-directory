...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SquareConnectApi.ListTransactionsRequest();
  });
  ...
  describe('ListTransactionsRequest', function() {
    it('should create an instance of ListTransactionsRequest', function() {
      ...
      //var instance = new SquareConnectApi.ListTransactionsRequest();
      //expect(instance).to.be.a(SquareConnectApi.ListTransactionsRequest);
    });
