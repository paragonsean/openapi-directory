...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SquareConnectApi.LoyaltyEventOther();
  });
  ...
  describe('LoyaltyEventOther', function() {
    it('should create an instance of LoyaltyEventOther', function() {
      ...
      //var instance = new SquareConnectApi.LoyaltyEventOther();
      //expect(instance).to.be.a(SquareConnectApi.LoyaltyEventOther);
    });
