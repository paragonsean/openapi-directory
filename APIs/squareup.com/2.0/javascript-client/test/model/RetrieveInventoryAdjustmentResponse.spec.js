...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SquareConnectApi.RetrieveInventoryAdjustmentResponse();
  });
  ...
  describe('RetrieveInventoryAdjustmentResponse', function() {
    it('should create an instance of RetrieveInventoryAdjustmentResponse', function() {
      ...
      //var instance = new SquareConnectApi.RetrieveInventoryAdjustmentResponse();
      //expect(instance).to.be.a(SquareConnectApi.RetrieveInventoryAdjustmentResponse);
    });
