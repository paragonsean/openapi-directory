...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SquareConnectApi.LoyaltyProgramTerminology();
  });
  ...
  describe('LoyaltyProgramTerminology', function() {
    it('should create an instance of LoyaltyProgramTerminology', function() {
      ...
      //var instance = new SquareConnectApi.LoyaltyProgramTerminology();
      //expect(instance).to.be.a(SquareConnectApi.LoyaltyProgramTerminology);
    });
