...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SquareConnectApi.CatalogQueryPrefix();
  });
  ...
  describe('CatalogQueryPrefix', function() {
    it('should create an instance of CatalogQueryPrefix', function() {
      ...
      //var instance = new SquareConnectApi.CatalogQueryPrefix();
      //expect(instance).to.be.a(SquareConnectApi.CatalogQueryPrefix);
    });
