...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SquareConnectApi.CatalogObjectReference();
  });
  ...
  describe('CatalogObjectReference', function() {
    it('should create an instance of CatalogObjectReference', function() {
      ...
      //var instance = new SquareConnectApi.CatalogObjectReference();
      //expect(instance).to.be.a(SquareConnectApi.CatalogObjectReference);
    });
