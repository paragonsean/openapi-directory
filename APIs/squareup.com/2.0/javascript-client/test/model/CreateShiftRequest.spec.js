...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SquareConnectApi.CreateShiftRequest();
  });
  ...
  describe('CreateShiftRequest', function() {
    it('should create an instance of CreateShiftRequest', function() {
      ...
      //var instance = new SquareConnectApi.CreateShiftRequest();
      //expect(instance).to.be.a(SquareConnectApi.CreateShiftRequest);
    });
