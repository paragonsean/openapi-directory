...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SquareConnectApi.V1OrderHistoryEntry();
  });
  ...
  describe('V1OrderHistoryEntry', function() {
    it('should create an instance of V1OrderHistoryEntry', function() {
      ...
      //var instance = new SquareConnectApi.V1OrderHistoryEntry();
      //expect(instance).to.be.a(SquareConnectApi.V1OrderHistoryEntry);
    });
