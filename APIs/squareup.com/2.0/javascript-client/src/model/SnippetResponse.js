...
class SnippetResponse {
    ...
    /**
     * Validates the JSON data with respect to <code>SnippetResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SnippetResponse</code>.
     */
 ...
 */
SnippetResponse.prototype['errors'] = undefined;

/**
 * @member {module:model/Snippet} snippet
 */
SnippetResponse.prototype['snippet'] = undefined;
