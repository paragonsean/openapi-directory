...
class RetrieveDisputeResponse {
    ...
    constructor() { 
        ...
        RetrieveDisputeResponse.initialize(this);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RetrieveDisputeResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>RetrieveDisputeResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RetrieveDisputeResponse</code>.
     */
 ...
 */
RetrieveDisputeResponse.prototype['dispute'] = undefined;

/**
 * Information about errors encountered during the request.
 * @member {Array.<module:model/Error>} errors
 */
RetrieveDisputeResponse.prototype['errors'] = undefined;
...
export default RetrieveDisputeResponse;
