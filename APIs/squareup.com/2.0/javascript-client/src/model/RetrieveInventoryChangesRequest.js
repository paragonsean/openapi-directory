...
class RetrieveInventoryChangesRequest {
    ...
    constructor() { 
        ...
        RetrieveInventoryChangesRequest.initialize(this);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RetrieveInventoryChangesRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>RetrieveInventoryChangesRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RetrieveInventoryChangesRequest</code>.
     */
 ...
 */
RetrieveInventoryChangesRequest.prototype['cursor'] = undefined;
 ...
 */
RetrieveInventoryChangesRequest.prototype['location_ids'] = undefined;
...
export default RetrieveInventoryChangesRequest;
