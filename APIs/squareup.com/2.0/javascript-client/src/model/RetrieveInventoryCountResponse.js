...
class RetrieveInventoryCountResponse {
    ...
    constructor() { 
        ...
        RetrieveInventoryCountResponse.initialize(this);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RetrieveInventoryCountResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>RetrieveInventoryCountResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RetrieveInventoryCountResponse</code>.
     */
 ...
 */
RetrieveInventoryCountResponse.prototype['counts'] = undefined;
 ...
 */
RetrieveInventoryCountResponse.prototype['cursor'] = undefined;

/**
 * Any errors that occurred during the request.
 * @member {Array.<module:model/Error>} errors
 */
RetrieveInventoryCountResponse.prototype['errors'] = undefined;
...
export default RetrieveInventoryCountResponse;
