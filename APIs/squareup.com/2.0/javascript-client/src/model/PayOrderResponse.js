...
class PayOrderResponse {
    ...
    constructor() { 
        ...
        PayOrderResponse.initialize(this);
    }
    ...
    /**
     * Validates the JSON data with respect to <code>PayOrderResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PayOrderResponse</code>.
     */
 ...
 */
PayOrderResponse.prototype['errors'] = undefined;

/**
 * @member {module:model/Order} order
 */
PayOrderResponse.prototype['order'] = undefined;
