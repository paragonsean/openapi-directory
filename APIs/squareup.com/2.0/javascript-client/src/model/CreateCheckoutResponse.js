...
class CreateCheckoutResponse {
    ...
    constructor() { 
        ...
        CreateCheckoutResponse.initialize(this);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateCheckoutResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>CreateCheckoutResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateCheckoutResponse</code>.
     */
    static validateJSON(data) {
        // validate the optional field `checkout`
        if (data['checkout']) { // data not null
          Checkout.validateJSON(data['checkout']);
        }
 ...
 */
CreateCheckoutResponse.prototype['checkout'] = undefined;

/**
 * Any errors that occurred during the request.
 * @member {Array.<module:model/Error>} errors
 */
CreateCheckoutResponse.prototype['errors'] = undefined;
