...
class PublishInvoiceResponse {
    ...
    constructor() { 
        ...
        PublishInvoiceResponse.initialize(this);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PublishInvoiceResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>PublishInvoiceResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PublishInvoiceResponse</code>.
     */
 ...
 */
PublishInvoiceResponse.prototype['errors'] = undefined;

/**
 * @member {module:model/Invoice} invoice
 */
PublishInvoiceResponse.prototype['invoice'] = undefined;
...
export default PublishInvoiceResponse;
