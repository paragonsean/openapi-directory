...
class DeleteInvoiceResponse {
    ...
    constructor() { 
        ...
        DeleteInvoiceResponse.initialize(this);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DeleteInvoiceResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>DeleteInvoiceResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DeleteInvoiceResponse</code>.
     */
 ...
 */
DeleteInvoiceResponse.prototype['errors'] = undefined;
...
export default DeleteInvoiceResponse;
