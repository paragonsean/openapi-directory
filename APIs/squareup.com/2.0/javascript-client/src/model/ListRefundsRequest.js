...
class ListRefundsRequest {
    ...
    constructor() { 
        ...
        ListRefundsRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ListRefundsRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListRefundsRequest} obj Optional instance to populate.
     * @return {module:model/ListRefundsRequest} The populated <code>ListRefundsRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListRefundsRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>ListRefundsRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListRefundsRequest</code>.
     */
 ...
 */
ListRefundsRequest.prototype['begin_time'] = undefined;
 ...
 */
ListRefundsRequest.prototype['cursor'] = undefined;
 ...
 */
ListRefundsRequest.prototype['end_time'] = undefined;
 ...
 */
ListRefundsRequest.prototype['sort_order'] = undefined;
...
export default ListRefundsRequest;
