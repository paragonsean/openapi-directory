...
class BatchRetrieveInventoryChangesResponse {
    ...
    constructor() { 
        ...
        BatchRetrieveInventoryChangesResponse.initialize(this);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new BatchRetrieveInventoryChangesResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>BatchRetrieveInventoryChangesResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>BatchRetrieveInventoryChangesResponse</code>.
     */
 ...
 */
BatchRetrieveInventoryChangesResponse.prototype['changes'] = undefined;
 ...
 */
BatchRetrieveInventoryChangesResponse.prototype['cursor'] = undefined;

/**
 * Any errors that occurred during the request.
 * @member {Array.<module:model/Error>} errors
 */
BatchRetrieveInventoryChangesResponse.prototype['errors'] = undefined;
...
export default BatchRetrieveInventoryChangesResponse;
