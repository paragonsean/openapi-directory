...
class AccumulateLoyaltyPointsResponse {
    ...
    constructor() { 
        ...
        AccumulateLoyaltyPointsResponse.initialize(this);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AccumulateLoyaltyPointsResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>AccumulateLoyaltyPointsResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AccumulateLoyaltyPointsResponse</code>.
     */
 ...
 */
AccumulateLoyaltyPointsResponse.prototype['errors'] = undefined;

/**
 * @member {module:model/LoyaltyEvent} event
 */
AccumulateLoyaltyPointsResponse.prototype['event'] = undefined;
...
export default AccumulateLoyaltyPointsResponse;
