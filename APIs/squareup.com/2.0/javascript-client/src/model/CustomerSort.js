...
class CustomerSort {
    ...
    /**
     * Validates the JSON data with respect to <code>CustomerSort</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CustomerSort</code>.
     */
 ...
 * @member {String} field
 */
CustomerSort.prototype['field'] = undefined;
 ...
 * @member {String} order
 */
CustomerSort.prototype['order'] = undefined;
