...
* `MERCHANT_SUBSCRIPTION_NOT_FOUND` (value: `"MERCHANT_SUBSCRIPTION_NOT_FOUND"`)
...
* `MISSING_PIN` (value: `"MISSING_PIN"`)

* `MISSING_ACCOUNT_TYPE` (value: `"MISSING_ACCOUNT_TYPE"`)
...
* `ACCOUNT_UNUSABLE` (value: `"ACCOUNT_UNUSABLE"`)

* `BUYER_REFUSED_PAYMENT` (value: `"BUYER_REFUSED_PAYMENT"`)
...
* `REFUND_DECLINED` (value: `"REFUND_DECLINED"`)

* `INVALID_CARD_DATA` (value: `"INVALID_CARD_DATA"`)

* `SOURCE_USED` (value: `"SOURCE_USED"`)

* `SOURCE_EXPIRED` (value: `"SOURCE_EXPIRED"`)
