...
**jobAssignments** | [**[JobAssignment]**](JobAssignment.md) | Required. The ordered list of jobs that the team member is assigned to. The first job assignment is considered the team member&#39;s primary job.  The minimum length is 1 and the maximum length is 12. | [optional] 
