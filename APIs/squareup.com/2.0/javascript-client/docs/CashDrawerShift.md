# SquareConnectApi.CashDrawerShift
...
**employeeIds** | **[String]** | The IDs of all employees that were logged into Square Point of Sale at any point while the cash drawer shift was open. | [optional] 
