# SquareConnectApi.GiftCardActivityLoad
...
**buyerPaymentInstrumentIds** | **[String]** | If you are not using the Orders API, this field is required because it is used to identify a buyer  to perform compliance checks. | [optional] 
