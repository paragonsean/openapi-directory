# SquareConnectApi.CatalogPricingRule
...
**timePeriodIds** | **[String]** | A list of unique IDs for the catalog time periods when this pricing rule is in effect. If left unset, the pricing rule is always in effect. | [optional] 
