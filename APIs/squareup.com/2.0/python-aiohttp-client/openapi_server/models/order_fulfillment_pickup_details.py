...
class OrderFulfillmentPickupDetails(Model):
    """NOTE: This class is auto generated by OpenAPI Generator (https://openapi-generator.tech).

    Do not edit the class manually.
    """

    def __init__(self, accepted_at: str=None, auto_complete_duration: str=None, cancel_reason: str=None, canceled_at: str=None, curbside_pickup_details: OrderFulfillmentPickupDetailsCurbsidePickupDetails=None, expired_at: str=None, expires_at: str=None, is_curbside_pickup: bool=None, note: str=None, picked_up_at: str=None, pickup_at: str=None, pickup_window_duration: str=None, placed_at: str=None, prep_time_duration: str=None, ready_at: str=None, recipient: OrderFulfillmentRecipient=None, rejected_at: str=None, schedule_type: str=None):
        """OrderFulfillmentPickupDetails - a model defined in OpenAPI
        ...
        :param curbside_pickup_details: The curbside_pickup_details of this OrderFulfillmentPickupDetails.
        ...
        :param is_curbside_pickup: The is_curbside_pickup of this OrderFulfillmentPickupDetails.
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'OrderFulfillmentPickupDetails':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The OrderFulfillmentPickupDetails of this OrderFulfillmentPickupDetails.
        """
    ...
    def curbside_pickup_details(self):
        """Gets the curbside_pickup_details of this OrderFulfillmentPickupDetails.


        :return: The curbside_pickup_details of this OrderFulfillmentPickupDetails.
        :rtype: OrderFulfillmentPickupDetailsCurbsidePickupDetails
        """
    ...
    def curbside_pickup_details(self, curbside_pickup_details):
        """Sets the curbside_pickup_details of this OrderFulfillmentPickupDetails.


        :param curbside_pickup_details: The curbside_pickup_details of this OrderFulfillmentPickupDetails.
        :type curbside_pickup_details: OrderFulfillmentPickupDetailsCurbsidePickupDetails
        """
    ...
    def is_curbside_pickup(self):
        """Gets the is_curbside_pickup of this OrderFulfillmentPickupDetails.

        If set to `true`, indicates that this pickup order is for curbside pickup, not in-store pickup.

        :return: The is_curbside_pickup of this OrderFulfillmentPickupDetails.
        :rtype: bool
        """
    ...
    def is_curbside_pickup(self, is_curbside_pickup):
        """Sets the is_curbside_pickup of this OrderFulfillmentPickupDetails.
