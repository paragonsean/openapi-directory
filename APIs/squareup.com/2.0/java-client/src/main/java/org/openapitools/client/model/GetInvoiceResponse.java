...
public class GetInvoiceResponse {
  ...
  public GetInvoiceResponse errors(List<Error> errors) {
    this.errors = errors;
    return this;
  }

  public GetInvoiceResponse addErrorsItem(Error errorsItem) {
    if (this.errors == null) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.errors, getInvoiceResponse.errors) &&
        Objects.equals(this.invoice, getInvoiceResponse.invoice);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetInvoiceResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetInvoiceResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
