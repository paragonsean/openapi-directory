...
public class AdditionalRecipient {
  ...
  public static final String SERIALIZED_NAME_RECEIVABLE_ID = "receivable_id";
  @SerializedName(SERIALIZED_NAME_RECEIVABLE_ID)
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.amountMoney, additionalRecipient.amountMoney) &&
        Objects.equals(this.description, additionalRecipient.description) &&
        Objects.equals(this.locationId, additionalRecipient.locationId) &&
        Objects.equals(this.receivableId, additionalRecipient.receivableId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(amountMoney, description, locationId, receivableId);
  }
  ...
  static {
    ...
    openapiFields.add("receivable_id");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if ((jsonObj.get("receivable_id") != null && !jsonObj.get("receivable_id").isJsonNull()) && !jsonObj.get("receivable_id").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `receivable_id` to be a primitive type in the JSON string but got `%s`", jsonObj.get("receivable_id").toString()));
      }
  }
