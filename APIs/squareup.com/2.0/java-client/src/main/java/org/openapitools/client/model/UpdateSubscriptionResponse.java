...
public class UpdateSubscriptionResponse {
  ...
  public UpdateSubscriptionResponse errors(List<Error> errors) {
    this.errors = errors;
    return this;
  }

  public UpdateSubscriptionResponse addErrorsItem(Error errorsItem) {
    if (this.errors == null) {
  ...
  public UpdateSubscriptionResponse subscription(Subscription subscription) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.errors, updateSubscriptionResponse.errors) &&
        Objects.equals(this.subscription, updateSubscriptionResponse.subscription);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateSubscriptionResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateSubscriptionResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       final TypeAdapter<UpdateSubscriptionResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateSubscriptionResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateSubscriptionResponse>() {
           @Override
