...
public class GiftCardActivityLoad {
  ...
  public GiftCardActivityLoad amountMoney(Money amountMoney) {
  ...
  public GiftCardActivityLoad buyerPaymentInstrumentIds(List<String> buyerPaymentInstrumentIds) {
    this.buyerPaymentInstrumentIds = buyerPaymentInstrumentIds;
    return this;
  }

  public GiftCardActivityLoad addBuyerPaymentInstrumentIdsItem(String buyerPaymentInstrumentIdsItem) {
  ...
  public GiftCardActivityLoad lineItemUid(String lineItemUid) {
  ...
  public GiftCardActivityLoad orderId(String orderId) {
  ...
  public GiftCardActivityLoad referenceId(String referenceId) {
  ...
  public boolean equals(Object o) {
    ...
    GiftCardActivityLoad giftCardActivityLoad = (GiftCardActivityLoad) o;
    return Objects.equals(this.amountMoney, giftCardActivityLoad.amountMoney) &&
        Objects.equals(this.buyerPaymentInstrumentIds, giftCardActivityLoad.buyerPaymentInstrumentIds) &&
        Objects.equals(this.lineItemUid, giftCardActivityLoad.lineItemUid) &&
        Objects.equals(this.orderId, giftCardActivityLoad.orderId) &&
        Objects.equals(this.referenceId, giftCardActivityLoad.referenceId);
  }
  ...
  public String toString() {
    ...
    sb.append("class GiftCardActivityLoad {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GiftCardActivityLoad
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GiftCardActivityLoad.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GiftCardActivityLoad is not found in the empty JSON string", GiftCardActivityLoad.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GiftCardActivityLoad.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GiftCardActivityLoad` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GiftCardActivityLoad.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GiftCardActivityLoad' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GiftCardActivityLoad> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GiftCardActivityLoad.class));

       return (TypeAdapter<T>) new TypeAdapter<GiftCardActivityLoad>() {
           @Override
           public void write(JsonWriter out, GiftCardActivityLoad value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GiftCardActivityLoad read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GiftCardActivityLoad given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GiftCardActivityLoad
   * @throws IOException if the JSON string is invalid with respect to GiftCardActivityLoad
   */
  public static GiftCardActivityLoad fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GiftCardActivityLoad.class);
  }

  /**
   * Convert an instance of GiftCardActivityLoad to an JSON string
   *
   * @return JSON string
   */
