...
public class CancelSubscriptionResponse {
  ...
  public CancelSubscriptionResponse errors(List<Error> errors) {
    this.errors = errors;
    return this;
  }

  public CancelSubscriptionResponse addErrorsItem(Error errorsItem) {
    if (this.errors == null) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.errors, cancelSubscriptionResponse.errors) &&
        Objects.equals(this.subscription, cancelSubscriptionResponse.subscription);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CancelSubscriptionResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CancelSubscriptionResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
