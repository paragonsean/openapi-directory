...
public class InventoryTransfer {
  ...
  public static final String SERIALIZED_NAME_FROM_LOCATION_ID = "from_location_id";
  @SerializedName(SERIALIZED_NAME_FROM_LOCATION_ID)
  ...
  public static final String SERIALIZED_NAME_TO_LOCATION_ID = "to_location_id";
  @SerializedName(SERIALIZED_NAME_TO_LOCATION_ID)
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.catalogObjectId, inventoryTransfer.catalogObjectId) &&
        ...
        Objects.equals(this.id, inventoryTransfer.id) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(catalogObjectId, catalogObjectType, createdAt, employeeId, fromLocationId, id, occurredAt, quantity, referenceId, source, state, toLocationId);
  }
  ...
  static {
    ...
    openapiFields.add("from_location_id");
    ...
    openapiFields.add("to_location_id");
   ...
   * @throws IOException if the JSON Element is invalid with respect to InventoryTransfer
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!InventoryTransfer.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in InventoryTransfer is not found in the empty JSON string", InventoryTransfer.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!InventoryTransfer.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `InventoryTransfer` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if ((jsonObj.get("from_location_id") != null && !jsonObj.get("from_location_id").isJsonNull()) && !jsonObj.get("from_location_id").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `from_location_id` to be a primitive type in the JSON string but got `%s`", jsonObj.get("from_location_id").toString()));
      }
      ...
      if ((jsonObj.get("to_location_id") != null && !jsonObj.get("to_location_id").isJsonNull()) && !jsonObj.get("to_location_id").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `to_location_id` to be a primitive type in the JSON string but got `%s`", jsonObj.get("to_location_id").toString()));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!InventoryTransfer.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'InventoryTransfer' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<InventoryTransfer> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(InventoryTransfer.class));

       return (TypeAdapter<T>) new TypeAdapter<InventoryTransfer>() {
           @Override
           public void write(JsonWriter out, InventoryTransfer value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public InventoryTransfer read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of InventoryTransfer given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of InventoryTransfer
   * @throws IOException if the JSON string is invalid with respect to InventoryTransfer
   */
  public static InventoryTransfer fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, InventoryTransfer.class);
  }

  /**
   * Convert an instance of InventoryTransfer to an JSON string
   *
   * @return JSON string
   */
