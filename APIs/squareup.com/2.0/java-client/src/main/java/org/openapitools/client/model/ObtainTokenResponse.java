...
public class ObtainTokenResponse {
  ...
  public ObtainTokenResponse shortLived(Boolean shortLived) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.accessToken, obtainTokenResponse.accessToken) &&
        ...
        Objects.equals(this.shortLived, obtainTokenResponse.shortLived) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(accessToken, expiresAt, idToken, merchantId, planId, refreshToken, shortLived, subscriptionId, tokenType);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ObtainTokenResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ObtainTokenResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ObtainTokenResponse is not found in the empty JSON string", ObtainTokenResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ObtainTokenResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ObtainTokenResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ObtainTokenResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ObtainTokenResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ObtainTokenResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ObtainTokenResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<ObtainTokenResponse>() {
           @Override
           public void write(JsonWriter out, ObtainTokenResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ObtainTokenResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ObtainTokenResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ObtainTokenResponse
   * @throws IOException if the JSON string is invalid with respect to ObtainTokenResponse
   */
  public static ObtainTokenResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ObtainTokenResponse.class);
  }

  /**
   * Convert an instance of ObtainTokenResponse to an JSON string
   *
   * @return JSON string
   */
