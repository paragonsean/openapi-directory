...
public class ListCatalogResponse {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.cursor, listCatalogResponse.cursor) &&
        Objects.equals(this.errors, listCatalogResponse.errors) &&
        Objects.equals(this.objects, listCatalogResponse.objects);
  }

  @Override
  public int hashCode() {
    return Objects.hash(cursor, errors, objects);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ListCatalogResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListCatalogResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListCatalogResponse is not found in the empty JSON string", ListCatalogResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListCatalogResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListCatalogResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListCatalogResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListCatalogResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListCatalogResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListCatalogResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<ListCatalogResponse>() {
           @Override
           public void write(JsonWriter out, ListCatalogResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListCatalogResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListCatalogResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListCatalogResponse
   * @throws IOException if the JSON string is invalid with respect to ListCatalogResponse
   */
  public static ListCatalogResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListCatalogResponse.class);
  }

  /**
   * Convert an instance of ListCatalogResponse to an JSON string
   *
   * @return JSON string
   */
