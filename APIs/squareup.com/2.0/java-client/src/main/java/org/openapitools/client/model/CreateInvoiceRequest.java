...
public class CreateInvoiceRequest {
  ...
  public CreateInvoiceRequest idempotencyKey(String idempotencyKey) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.idempotencyKey, createInvoiceRequest.idempotencyKey) &&
        Objects.equals(this.invoice, createInvoiceRequest.invoice);
  }

  @Override
  public int hashCode() {
    return Objects.hash(idempotencyKey, invoice);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateInvoiceRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateInvoiceRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
