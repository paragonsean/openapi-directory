...
|**groupIds** | **List&lt;String&gt;** | The IDs of customer groups the customer belongs to. |  [optional] |
...
|**segmentIds** | **List&lt;String&gt;** | The IDs of segments the customer belongs to. |  [optional] |
|**updatedAt** | **String** | The timestamp when the customer profile was last updated, in RFC 3339 format. |  [optional] |
|**version** | **Long** | The Square-assigned version number of the customer profile. The version number is incremented each time an update is committed to the customer profile, except for changes to customer segment membership and cards on file. |  [optional] |
