...
|------------ | ------------- | ------------- | -------------|
|**appointmentSegments** | [**List&lt;AppointmentSegment&gt;**](AppointmentSegment.md) | A list of appointment segments for this booking. |  [optional] |
...
|**version** | **Integer** | The revision number for the booking used for optimistic concurrency. |  [optional] |
