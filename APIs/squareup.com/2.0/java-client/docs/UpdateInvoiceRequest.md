...
|------------ | ------------- | ------------- | -------------|
|**fieldsToClear** | **List&lt;String&gt;** | The list of fields to clear. For examples, see [Update an invoice](https://developer.squareup.com/docs/invoices-api/overview#update-an-invoice). |  [optional] |
