...
|------------ | ------------- | ------------- | -------------|
|**allowedObjectTypes** | **List&lt;String&gt;** | The set of Catalog Object Types that this Custom Attribute may be applied to. Currently, only &#x60;ITEM&#x60; and &#x60;ITEM_VARIATION&#x60; are allowed. At least one type must be included. |  |
