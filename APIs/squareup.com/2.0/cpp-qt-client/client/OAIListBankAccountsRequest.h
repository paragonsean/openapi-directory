...
/*
 * OAIListBankAccountsRequest.h
 *
 * Request object for fetching all &#x60;BankAccount&#x60; objects linked to a account.
 */

#ifndef OAIListBankAccountsRequest_H
#define OAIListBankAccountsRequest_H
...
class OAIListBankAccountsRequest : public OAIObject {
public:
    OAIListBankAccountsRequest();
    OAIListBankAccountsRequest(QString json);
    ~OAIListBankAccountsRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListBankAccountsRequest)

#endif // OAIListBankAccountsRequest_H
