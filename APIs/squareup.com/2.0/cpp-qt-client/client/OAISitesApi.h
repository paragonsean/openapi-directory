...
Q_SIGNALS:
    ...
    void listSitesSignal(OAIListSitesResponse summary);


    void listSitesSignalFull(OAIHttpRequestWorker *worker, OAIListSitesResponse summary);

    Q_DECL_DEPRECATED_X("Use listSitesSignalError() instead")
    void listSitesSignalE(OAIListSitesResponse summary, QNetworkReply::NetworkError error_type, QString error_str);
    void listSitesSignalError(OAIListSitesResponse summary, QNetworkReply::NetworkError error_type, const QString &error_str);
