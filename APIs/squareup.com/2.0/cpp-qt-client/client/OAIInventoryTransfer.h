...
/*
 * OAIInventoryTransfer.h
 *
 * Represents the transfer of a quantity of product inventory at a particular time from one location to another.
 */

#ifndef OAIInventoryTransfer_H
#define OAIInventoryTransfer_H
...
class OAIInventoryTransfer : public OAIObject {
public:
    OAIInventoryTransfer();
    OAIInventoryTransfer(QString json);
    ~OAIInventoryTransfer() override;
    ...
    QString getFromLocationId() const;
    void setFromLocationId(const QString &from_location_id);
    bool is_from_location_id_Set() const;
    bool is_from_location_id_Valid() const;
    ...
    QString getToLocationId() const;
    void setToLocationId(const QString &to_location_id);
...
private:
    ...
    QString m_from_location_id;
    bool m_from_location_id_isSet;
    bool m_from_location_id_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIInventoryTransfer)

#endif // OAIInventoryTransfer_H
