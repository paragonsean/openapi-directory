...
#ifndef OAI_OAIApplePayApi_H
#define OAI_OAIApplePayApi_H
...
class OAIApplePayApi : public QObject {
    Q_OBJECT

public:
    OAIApplePayApi(const int timeOut = 0);
    ~OAIApplePayApi();
    ...
    */
    virtual void registerDomain(const OAIRegisterDomainRequest &oai_register_domain_request);
