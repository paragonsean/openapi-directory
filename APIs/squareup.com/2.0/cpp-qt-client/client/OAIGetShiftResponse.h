...
#ifndef OAIGetShiftResponse_H
#define OAIGetShiftResponse_H
...
class OAIGetShiftResponse : public OAIObject {
public:
    OAIGetShiftResponse();
    OAIGetShiftResponse(QString json);
    ~OAIGetShiftResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetShiftResponse)

#endif // OAIGetShiftResponse_H
