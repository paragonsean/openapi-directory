...
/*
 * OAIListCashDrawerShiftsRequest.h
 *
 * 
 */

#ifndef OAIListCashDrawerShiftsRequest_H
#define OAIListCashDrawerShiftsRequest_H
...
class OAIListCashDrawerShiftsRequest : public OAIObject {
public:
    OAIListCashDrawerShiftsRequest();
    OAIListCashDrawerShiftsRequest(QString json);
    ~OAIListCashDrawerShiftsRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListCashDrawerShiftsRequest)

#endif // OAIListCashDrawerShiftsRequest_H
