...
#ifndef OAICreateCardResponse_H
#define OAICreateCardResponse_H
...
class OAICreateCardResponse : public OAIObject {
public:
    OAICreateCardResponse();
    OAICreateCardResponse(QString json);
    ~OAICreateCardResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateCardResponse)

#endif // OAICreateCardResponse_H
