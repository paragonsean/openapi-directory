...
/*
 * OAIListEmployeesRequest.h
 *
 * 
 */

#ifndef OAIListEmployeesRequest_H
#define OAIListEmployeesRequest_H
...
class OAIListEmployeesRequest : public OAIObject {
public:
    OAIListEmployeesRequest();
    OAIListEmployeesRequest(QString json);
    ~OAIListEmployeesRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListEmployeesRequest)

#endif // OAIListEmployeesRequest_H
