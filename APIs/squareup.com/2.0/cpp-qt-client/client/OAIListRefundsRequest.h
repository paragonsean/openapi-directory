...
#ifndef OAIListRefundsRequest_H
#define OAIListRefundsRequest_H
...
class OAIListRefundsRequest : public OAIObject {
public:
    OAIListRefundsRequest();
    OAIListRefundsRequest(QString json);
    ~OAIListRefundsRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListRefundsRequest)

#endif // OAIListRefundsRequest_H
