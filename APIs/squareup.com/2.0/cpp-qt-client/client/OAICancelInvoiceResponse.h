...
/*
 * OAICancelInvoiceResponse.h
 *
 * The response returned by the &#x60;CancelInvoice&#x60; request.
 */

#ifndef OAICancelInvoiceResponse_H
#define OAICancelInvoiceResponse_H
...
class OAICancelInvoiceResponse : public OAIObject {
public:
    OAICancelInvoiceResponse();
    OAICancelInvoiceResponse(QString json);
    ~OAICancelInvoiceResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICancelInvoiceResponse)

#endif // OAICancelInvoiceResponse_H
