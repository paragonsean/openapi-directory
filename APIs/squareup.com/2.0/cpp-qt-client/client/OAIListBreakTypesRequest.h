...
/*
 * OAIListBreakTypesRequest.h
 *
 * A request for a filtered set of &#x60;BreakType&#x60; objects.
 */

#ifndef OAIListBreakTypesRequest_H
#define OAIListBreakTypesRequest_H
...
class OAIListBreakTypesRequest : public OAIObject {
public:
    OAIListBreakTypesRequest();
    OAIListBreakTypesRequest(QString json);
    ~OAIListBreakTypesRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListBreakTypesRequest)

#endif // OAIListBreakTypesRequest_H
