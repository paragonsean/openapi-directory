...
/*
 * OAIOrderServiceCharge.h
 *
 * Represents a service charge applied to an order.
 */

#ifndef OAIOrderServiceCharge_H
#define OAIOrderServiceCharge_H
...
class OAIOrderServiceCharge : public OAIObject {
public:
    OAIOrderServiceCharge();
    OAIOrderServiceCharge(QString json);
    ~OAIOrderServiceCharge() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIOrderServiceCharge)

#endif // OAIOrderServiceCharge_H
