...
#ifndef OAIChargeResponse_H
#define OAIChargeResponse_H
...
class OAIChargeResponse : public OAIObject {
public:
    OAIChargeResponse();
    OAIChargeResponse(QString json);
    ~OAIChargeResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIChargeResponse)

#endif // OAIChargeResponse_H
