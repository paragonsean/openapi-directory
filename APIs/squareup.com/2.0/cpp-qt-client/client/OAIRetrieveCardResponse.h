...
#ifndef OAIRetrieveCardResponse_H
#define OAIRetrieveCardResponse_H
...
class OAIRetrieveCardResponse : public OAIObject {
public:
    OAIRetrieveCardResponse();
    OAIRetrieveCardResponse(QString json);
    ~OAIRetrieveCardResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRetrieveCardResponse)

#endif // OAIRetrieveCardResponse_H
