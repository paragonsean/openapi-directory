...
#ifndef OAIListGiftCardsResponse_H
#define OAIListGiftCardsResponse_H
...
class OAIListGiftCardsResponse : public OAIObject {
public:
    OAIListGiftCardsResponse();
    OAIListGiftCardsResponse(QString json);
    ~OAIListGiftCardsResponse() override;
    ...
    QList<OAIGiftCard> getGiftCards() const;
    void setGiftCards(const QList<OAIGiftCard> &gift_cards);
...
private:
    ...
    QList<OAIGiftCard> m_gift_cards;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListGiftCardsResponse)

#endif // OAIListGiftCardsResponse_H
