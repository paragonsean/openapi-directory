...
#ifndef OAIV1EmployeeRole_H
#define OAIV1EmployeeRole_H
...
class OAIV1EmployeeRole : public OAIObject {
public:
    OAIV1EmployeeRole();
    OAIV1EmployeeRole(QString json);
    ~OAIV1EmployeeRole() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIV1EmployeeRole)

#endif // OAIV1EmployeeRole_H
