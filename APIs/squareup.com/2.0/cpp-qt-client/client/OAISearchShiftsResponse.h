...
#ifndef OAISearchShiftsResponse_H
#define OAISearchShiftsResponse_H
...
class OAISearchShiftsResponse : public OAIObject {
public:
    OAISearchShiftsResponse();
    OAISearchShiftsResponse(QString json);
    ~OAISearchShiftsResponse() override;
    ...
    QList<OAIShift> getShifts() const;
    void setShifts(const QList<OAIShift> &shifts);
...
Q_DECLARE_METATYPE(OpenAPI::OAISearchShiftsResponse)

#endif // OAISearchShiftsResponse_H
