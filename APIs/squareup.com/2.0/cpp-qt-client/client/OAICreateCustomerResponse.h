...
#ifndef OAICreateCustomerResponse_H
#define OAICreateCustomerResponse_H
...
class OAICreateCustomerResponse : public OAIObject {
public:
    OAICreateCustomerResponse();
    OAICreateCustomerResponse(QString json);
    ~OAICreateCustomerResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateCustomerResponse)

#endif // OAICreateCustomerResponse_H
