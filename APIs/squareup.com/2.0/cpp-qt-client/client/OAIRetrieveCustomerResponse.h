...
#ifndef OAIRetrieveCustomerResponse_H
#define OAIRetrieveCustomerResponse_H
...
class OAIRetrieveCustomerResponse : public OAIObject {
public:
    OAIRetrieveCustomerResponse();
    OAIRetrieveCustomerResponse(QString json);
    ~OAIRetrieveCustomerResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRetrieveCustomerResponse)

#endif // OAIRetrieveCustomerResponse_H
