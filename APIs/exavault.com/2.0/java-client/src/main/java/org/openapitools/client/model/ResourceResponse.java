...
public class ResourceResponse {
  ...
  public ResourceResponse included(List<ResourceCollectionResponseIncludedInner> included) {
    this.included = included;
    return this;
  }

  public ResourceResponse addIncludedItem(ResourceCollectionResponseIncludedInner includedItem) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.data, resourceResponse.data) &&
        Objects.equals(this.included, resourceResponse.included) &&
        Objects.equals(this.responseStatus, resourceResponse.responseStatus);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ResourceResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ResourceResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ResourceResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ResourceResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
