...
import org.openapitools.client.model.MasterUser;
...
public class Account {
  ...
  private MasterUser relationships;
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.attributes, account.attributes) &&
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("attributes") != null && !jsonObj.get("attributes").isJsonNull()) {
        AccountAttributes.validateJsonElement(jsonObj.get("attributes"));
      }
      // validate the optional field `relationships`
      if (jsonObj.get("relationships") != null && !jsonObj.get("relationships").isJsonNull()) {
        MasterUser.validateJsonElement(jsonObj.get("relationships"));
      }
