...
public class WebhookActivityAttributesV1 {
  ...
  private WebhookV1Details details;
  ...
  public WebhookActivityAttributesV1() {
  }
  ...
  public WebhookActivityAttributesV1 endpointUrl(URI endpointUrl) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.accountId, webhookActivityAttributesV1.accountId) &&
        ...
        Objects.equals(this.webhookId, webhookActivityAttributesV1.webhookId) &&
   ...
   * @throws IOException if the JSON Element is invalid with respect to WebhookActivityAttributesV1
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!WebhookActivityAttributesV1.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in WebhookActivityAttributesV1 is not found in the empty JSON string", WebhookActivityAttributesV1.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!WebhookActivityAttributesV1.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `WebhookActivityAttributesV1` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("details") != null && !jsonObj.get("details").isJsonNull()) {
        WebhookV1Details.validateJsonElement(jsonObj.get("details"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!WebhookActivityAttributesV1.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'WebhookActivityAttributesV1' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<WebhookActivityAttributesV1> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(WebhookActivityAttributesV1.class));

       return (TypeAdapter<T>) new TypeAdapter<WebhookActivityAttributesV1>() {
           @Override
           public void write(JsonWriter out, WebhookActivityAttributesV1 value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public WebhookActivityAttributesV1 read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of WebhookActivityAttributesV1 given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of WebhookActivityAttributesV1
   * @throws IOException if the JSON string is invalid with respect to WebhookActivityAttributesV1
   */
  public static WebhookActivityAttributesV1 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, WebhookActivityAttributesV1.class);
  }

  /**
   * Convert an instance of WebhookActivityAttributesV1 to an JSON string
   *
   * @return JSON string
   */
