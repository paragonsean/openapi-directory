...
public class SSHKeyCollectionResponse {
  ...
  private List<SSHKey> data = new ArrayList<>();
  ...
  public SSHKeyCollectionResponse() {
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.data, ssHKeyCollectionResponse.data) &&
        Objects.equals(this.included, ssHKeyCollectionResponse.included) &&
        Objects.equals(this.responseStatus, ssHKeyCollectionResponse.responseStatus) &&
   ...
   * @throws IOException if the JSON Element is invalid with respect to SSHKeyCollectionResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SSHKeyCollectionResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SSHKeyCollectionResponse is not found in the empty JSON string", SSHKeyCollectionResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SSHKeyCollectionResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SSHKeyCollectionResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        ...
        if (jsonArraydata != null) {
          ...
          for (int i = 0; i < jsonArraydata.size(); i++) {
            SSHKey.validateJsonElement(jsonArraydata.get(i));
          };
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SSHKeyCollectionResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SSHKeyCollectionResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SSHKeyCollectionResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SSHKeyCollectionResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<SSHKeyCollectionResponse>() {
           @Override
           public void write(JsonWriter out, SSHKeyCollectionResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SSHKeyCollectionResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SSHKeyCollectionResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SSHKeyCollectionResponse
   * @throws IOException if the JSON string is invalid with respect to SSHKeyCollectionResponse
   */
  public static SSHKeyCollectionResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SSHKeyCollectionResponse.class);
  }

  /**
   * Convert an instance of SSHKeyCollectionResponse to an JSON string
   *
   * @return JSON string
   */
