...
public class FormResponse {
  ...
  private List<Share> included = new ArrayList<>();
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.data, formResponse.data) &&
        ...
        Objects.equals(this.responseStatus, formResponse.responseStatus);
  }
      ...
      if (jsonObj.get("included") != null && !jsonObj.get("included").isJsonNull()) {
        ...
        if (jsonArrayincluded != null) {
          ...
          for (int i = 0; i < jsonArrayincluded.size(); i++) {
            Share.validateJsonElement(jsonArrayincluded.get(i));
          };
        }
      }
  }
