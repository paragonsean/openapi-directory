...
public class UpdateNotificationByIdRequestBody {
  ...
  public UpdateNotificationByIdRequestBody() {
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(action, message, recipients, sendEmail, usernames);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateNotificationByIdRequestBody
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateNotificationByIdRequestBody.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateNotificationByIdRequestBody is not found in the empty JSON string", UpdateNotificationByIdRequestBody.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateNotificationByIdRequestBody.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateNotificationByIdRequestBody` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateNotificationByIdRequestBody.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateNotificationByIdRequestBody' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateNotificationByIdRequestBody> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateNotificationByIdRequestBody.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateNotificationByIdRequestBody>() {
           @Override
           public void write(JsonWriter out, UpdateNotificationByIdRequestBody value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateNotificationByIdRequestBody read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateNotificationByIdRequestBody given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateNotificationByIdRequestBody
   * @throws IOException if the JSON string is invalid with respect to UpdateNotificationByIdRequestBody
   */
  public static UpdateNotificationByIdRequestBody fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateNotificationByIdRequestBody.class);
  }

  /**
   * Convert an instance of UpdateNotificationByIdRequestBody to an JSON string
   *
   * @return JSON string
   */
