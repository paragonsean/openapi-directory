...
public class Form {
  ...
  private FormRelationships relationships;
  ...
  public boolean equals(Object o) {
    ...
    Form form = (Form) o;
    return Objects.equals(this.attributes, form.attributes) &&
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("attributes") != null && !jsonObj.get("attributes").isJsonNull()) {
        FormAttributes.validateJsonElement(jsonObj.get("attributes"));
      }
      // validate the optional field `relationships`
      if (jsonObj.get("relationships") != null && !jsonObj.get("relationships").isJsonNull()) {
        FormRelationships.validateJsonElement(jsonObj.get("relationships"));
      }
