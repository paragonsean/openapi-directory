...
import org.openapitools.client.model.WebhookAttributes;
import org.openapitools.client.model.WebhookRelationships;
...
public class Webhook {
  ...
  private WebhookRelationships relationships;
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.attributes, webhook.attributes) &&
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("attributes") != null && !jsonObj.get("attributes").isJsonNull()) {
        WebhookAttributes.validateJsonElement(jsonObj.get("attributes"));
      }
      // validate the optional field `relationships`
      if (jsonObj.get("relationships") != null && !jsonObj.get("relationships").isJsonNull()) {
        WebhookRelationships.validateJsonElement(jsonObj.get("relationships"));
      }
