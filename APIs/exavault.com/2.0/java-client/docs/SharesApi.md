...
<a id="addShare"></a>
# **addShare**
> ShareResponse addShare(evApiKey, evAccessToken, addShareRequestBody)
...
public class Example {
  public static void main(String[] args) {
    ...
    AddShareRequestBody addShareRequestBody = new AddShareRequestBody(); // AddShareRequestBody | 
    try {
      ShareResponse result = apiInstance.addShare(evApiKey, evAccessToken, addShareRequestBody);
...
public class Example {
  public static void main(String[] args) {
    ...
    Integer id = 56; // Integer | ID of the share to trigger invitations for.
    try {
      ShareResponse result = apiInstance.completeDirectSend(evApiKey, evAccessToken, id);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling SharesApi#completeDirectSend");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
| **id** | **Integer**| ID of the share to trigger invitations for. | |
...
public class Example {
  public static void main(String[] args) {
    ...
    SharesApi apiInstance = new SharesApi(defaultClient);
    Integer id = 23241; // Integer | ID of the share entry
    String evApiKey = "exampleaccount-zwSuWUZ8S38h33qPS8v0s"; // String | API Key required to make the API call.
    String evAccessToken = "5dc97cc607985eb8da033220e7447647e7915fbf73808"; // String | Access token required to make the API call.
    try {
      ...
      System.err.println("Exception when calling SharesApi#deleteShareById");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
| Name | Type | Description  | Notes |
|------------- | ------------- | ------------- | -------------|
| **id** | **Integer**| ID of the share entry | |
| **evApiKey** | **String**| API Key required to make the API call. | |
| **evAccessToken** | **String**| Access token required to make the API call. | |
...
<a id="getShareById"></a>
# **getShareById**
> ShareResponse getShareById(id, evApiKey, evAccessToken, include)
...
public class Example {
  public static void main(String[] args) {
    ...
    String evApiKey = "exampleaccount-zwSuWUZ8S38h33qPS8v0s"; // String | API Key
    String evAccessToken = "19853ef63a0bc348024a9e4cfd4a92520d2dfd04e88d8679fb1ed6bc551593d1"; // String | Access Token
    String include = "owner,notifications"; // String | Comma separated list of relationships to include in response. Possible values are **owner**, **resources**, **notifications**, **activity**.
    try {
      ShareResponse result = apiInstance.getShareById(id, evApiKey, evAccessToken, include);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling SharesApi#getShareById");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="listShares"></a>
# **listShares**
> ShareCollectionResponse listShares(evApiKey, evAccessToken, offset, limit, scope, sort, type, include, name, recipient, message, username, search)
...
public class Example {
  public static void main(String[] args) {
    ...
    Integer limit = 100; // Integer | Limit of records to be returned (for pagination)
    String scope = "all"; // String | Set of shares to return. (**all**=all of them, **active**=shares that are currently active, **curentUser**=shares created by you)
    String sort = "created"; // String | What order the list of matches should be in.
    String type = "receive"; // String | Limit the list of matches to only certain types of shares.
    String include = "owner,notifications"; // String | Comma separated list of relationships to include in response. Possible values are **owner**, **resources**, **notifications**, **activity**.
    String name = "Customer*"; // String | When provided, only shares whose names include this value will be in the list. Supports wildcards, such as **send\\*** to return everything starting with \"send\".  Use this parameter if you are searching for shares or receives for a specific folder name. For example **_/Clients/ACME/To Be Processed**.
    String recipient = "test@example.com"; // String | Filter the results to include only shares that invited a certain email address. Supports wildcard matching so that **\\*@example.com** will give back entries shared with addresses ending in \"@example.com\". 
    String message = "submitted"; // String | When provided, only shares with a message that contains the text will be included in the list of matches. Both the subject and the body of all messages will be checked for matches. This will always be a wildcard match, so that searching for **taxes** will return any shares with a message that contains the word \"taxes\".
    String username = "example"; // String | When provided, only shares created by the user with that `username` will be included in the list. Does not support wildcard searching.
    String search = "search_example"; // String | Searches the share name, username, recipients, share messages fields for the provided value. Supports wildcard searches.
    try {
      ...
      System.err.println("Exception when calling SharesApi#listShares");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
| **limit** | **Integer**| Limit of records to be returned (for pagination) | [optional] [default to 100] |
| **scope** | **String**| Set of shares to return. (**all**&#x3D;all of them, **active**&#x3D;shares that are currently active, **curentUser**&#x3D;shares created by you) | [optional] [enum: all, active, currentUser] |
| **sort** | **String**| What order the list of matches should be in. | [optional] [enum: created, -created] |
| **type** | **String**| Limit the list of matches to only certain types of shares. | [optional] [enum: receive, shared_folder, send] |
| **include** | **String**| Comma separated list of relationships to include in response. Possible values are **owner**, **resources**, **notifications**, **activity**. | [optional] |
...
public class Example {
  public static void main(String[] args) {
    ...
    String evApiKey = "exampleaccount-zwSuWUZ8S38h33qPS8v0s"; // String | API Key
    String evAccessToken = "19853ef63a0bc348024a9e4cfd4a92520d2dfd04e88d8679fb1ed6bc551593d1"; // String | Access Token
    UpdateShareRequestBody updateShareRequestBody = new UpdateShareRequestBody(); // UpdateShareRequestBody | 
    try {
      ShareResponse result = apiInstance.updateShareById(id, evApiKey, evAccessToken, updateShareRequestBody);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling SharesApi#updateShareById");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
