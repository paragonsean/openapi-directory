...
|**expiration** | **OffsetDateTime** | New expiration date and time for the share |  [optional] |
...
|**status** | **Integer** | New status for the share. You can set an active share to inactive by setting the status to **0** |  [optional] |
