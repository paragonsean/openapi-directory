...
|**allowedIp** | [**List&lt;AccountAttributesAllowedIpInner&gt;**](AccountAttributesAllowedIpInner.md) | Range of IP addresses allowed to access this account. |  [optional] |
...
|**created** | **OffsetDateTime** | Timestamp of account creation. |  [optional] |
...
|**modified** | **OffsetDateTime** | Timestamp of account modification. |  [optional] |
