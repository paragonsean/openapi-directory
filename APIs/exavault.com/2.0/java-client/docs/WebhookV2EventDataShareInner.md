...
|**assets** | **List&lt;String&gt;** | List of items included in the share |  [optional] |
|**created** | **OffsetDateTime** | Date and ti |  [optional] |
...
|**formId** | **Integer** | ID of the associated form |  [optional] |
...
|**id** | **Integer** | Unique ID of associated receive folder |  [optional] |
...
|**modified** | **OffsetDateTime** | Date and time when the share was last changed |  [optional] |
|**name** | **String** | Name of receiv |  [optional] |
|**ownerHash** | **String** | Hash value of the user who \&quot;owns\&quot; the receive fo |  [optional] |
|**paths** | **List&lt;String&gt;** | List |  [optional] |
...
|**status** | **Integer** | 1 if share is active. 0 if not. |  [optional] |
