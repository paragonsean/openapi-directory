...
import SSHKeyRelationshipsOwnerUserData from './SSHKeyRelationshipsOwnerUserData';
...
class SSHKeyRelationshipsOwnerUser {
    ...
    constructor() { 
        ...
        SSHKeyRelationshipsOwnerUser.initialize(this);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('data')) {
                obj['data'] = SSHKeyRelationshipsOwnerUserData.constructFromObject(data['data']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>SSHKeyRelationshipsOwnerUser</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SSHKeyRelationshipsOwnerUser</code>.
     */
    static validateJSON(data) {
        // validate the optional field `data`
        if (data['data']) { // data not null
          SSHKeyRelationshipsOwnerUserData.validateJSON(data['data']);
        }
 ...
 */
SSHKeyRelationshipsOwnerUser.prototype['data'] = undefined;
...
export default SSHKeyRelationshipsOwnerUser;
