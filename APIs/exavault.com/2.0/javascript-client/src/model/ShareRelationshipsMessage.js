...
import ShareMessageData from './ShareMessageData';
 ...
 * @version 2.0
 */
class ShareRelationshipsMessage {
    /**
    ...
    constructor() { 
        ...
        ShareRelationshipsMessage.initialize(this);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('data')) {
                obj['data'] = ShareMessageData.constructFromObject(data['data']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ShareRelationshipsMessage</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ShareRelationshipsMessage</code>.
     */
    static validateJSON(data) {
        // validate the optional field `data`
        if (data['data']) { // data not null
          ShareMessageData.validateJSON(data['data']);
        }
 ...
 */
ShareRelationshipsMessage.prototype['data'] = undefined;
...
export default ShareRelationshipsMessage;
