...
class WebhookV1Details {
    ...
    constructor() { 
        ...
        WebhookV1Details.initialize(this);
    }
    ...
    /**
     * Validates the JSON data with respect to <code>WebhookV1Details</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>WebhookV1Details</code>.
     */
 ...
 */
WebhookV1Details.prototype['accountName'] = undefined;

/**
 * Number of times the system has attempted to send
 * @member {Number} attempt
 */
WebhookV1Details.prototype['attempt'] = undefined;

/**
 * Entry - retry identifier
 * @member {String} attemptId
 */
WebhookV1Details.prototype['attemptId'] = undefined;

/**
 * Type of related activity
 * @member {String} event
 */
WebhookV1Details.prototype['event'] = undefined;

/**
 * Type of connection used for related activity
 * @member {String} protocol
 */
WebhookV1Details.prototype['protocol'] = undefined;
 ...
 */
WebhookV1Details.prototype['username'] = undefined;
...
export default WebhookV1Details;
