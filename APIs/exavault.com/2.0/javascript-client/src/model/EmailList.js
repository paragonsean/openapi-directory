...
class EmailList {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('attributes')) {
                obj['attributes'] = EmailListAttributes.constructFromObject(data['attributes']);
            }
            if (data.hasOwnProperty('id')) {
                obj['id'] = ApiClient.convertToType(data['id'], 'Number');
            }
            if (data.hasOwnProperty('relationships')) {
                obj['relationships'] = EmailListRelationships.constructFromObject(data['relationships']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>EmailList</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EmailList</code>.
     */
    static validateJSON(data) {
        // validate the optional field `attributes`
        if (data['attributes']) { // data not null
          EmailListAttributes.validateJSON(data['attributes']);
        }
        // validate the optional field `relationships`
        if (data['relationships']) { // data not null
          EmailListRelationships.validateJSON(data['relationships']);
        }
 ...
 */
EmailList.prototype['attributes'] = undefined;

/**
 * ID of the email list
 * @member {Number} id
 */
EmailList.prototype['id'] = undefined;

/**
 * @member {module:model/EmailListRelationships} relationships
 */
EmailList.prototype['relationships'] = undefined;

/**
 * Type of record. \"emailList\"
 * @member {String} type
 */
EmailList.prototype['type'] = undefined;
