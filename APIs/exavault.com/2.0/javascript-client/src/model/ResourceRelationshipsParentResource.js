...
import ResourceRelationshipsParentResourceData from './ResourceRelationshipsParentResourceData';
...
class ResourceRelationshipsParentResource {
    ...
    constructor() { 
        ...
        ResourceRelationshipsParentResource.initialize(this);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('data')) {
                obj['data'] = ResourceRelationshipsParentResourceData.constructFromObject(data['data']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ResourceRelationshipsParentResource</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ResourceRelationshipsParentResource</code>.
     */
    static validateJSON(data) {
        // validate the optional field `data`
        if (data['data']) { // data not null
          ResourceRelationshipsParentResourceData.validateJSON(data['data']);
        }
 ...
 */
ResourceRelationshipsParentResource.prototype['data'] = undefined;
...
export default ResourceRelationshipsParentResource;
