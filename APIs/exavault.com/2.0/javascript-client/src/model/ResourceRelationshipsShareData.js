...
class ResourceRelationshipsShareData {
    ...
    constructor() { 
        ...
        ResourceRelationshipsShareData.initialize(this);
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ResourceRelationshipsShareData</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ResourceRelationshipsShareData</code>.
     */
 ...
 * @member {Number} id
 */
ResourceRelationshipsShareData.prototype['id'] = undefined;

/**
 * @member {String} type
 */
ResourceRelationshipsShareData.prototype['type'] = undefined;
...
export default ResourceRelationshipsShareData;
