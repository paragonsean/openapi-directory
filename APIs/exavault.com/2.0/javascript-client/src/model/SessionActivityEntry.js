...
import SessionActivityEntryAttributes from './SessionActivityEntryAttributes';
...
class SessionActivityEntry {
    ...
    constructor() { 
        ...
        SessionActivityEntry.initialize(this);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('attributes')) {
                obj['attributes'] = SessionActivityEntryAttributes.constructFromObject(data['attributes']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>SessionActivityEntry</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SessionActivityEntry</code>.
     */
    static validateJSON(data) {
        // validate the optional field `attributes`
        if (data['attributes']) { // data not null
          SessionActivityEntryAttributes.validateJSON(data['attributes']);
        }
 ...
 */
SessionActivityEntry.prototype['attributes'] = undefined;

/**
 * @member {Number} id
 */
SessionActivityEntry.prototype['id'] = undefined;

/**
 * @member {module:model/SessionActivityEntry.TypeEnum} type
 */
SessionActivityEntry.prototype['type'] = undefined;
...
export default SessionActivityEntry;
