...
class ShareMessageData {
    ...
    constructor() { 
        ...
        ShareMessageData.initialize(this);
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ShareMessageData</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ShareMessageData</code>.
     */
 ...
 * @member {Number} id
 */
ShareMessageData.prototype['id'] = undefined;

/**
 * Type is message. 
 * @member {module:model/ShareMessageData.TypeEnum} type
 */
ShareMessageData.prototype['type'] = undefined;
...
export default ShareMessageData;
