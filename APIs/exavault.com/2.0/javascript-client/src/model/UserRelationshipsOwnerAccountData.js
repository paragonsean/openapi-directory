...
class UserRelationshipsOwnerAccountData {
    ...
    constructor() { 
        ...
        UserRelationshipsOwnerAccountData.initialize(this);
    }
    ...
    /**
     * Validates the JSON data with respect to <code>UserRelationshipsOwnerAccountData</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UserRelationshipsOwnerAccountData</code>.
     */
 ...
 * @member {Number} id
 */
UserRelationshipsOwnerAccountData.prototype['id'] = undefined;

/**
 * Type is account.
 * @member {module:model/UserRelationshipsOwnerAccountData.TypeEnum} type
 */
UserRelationshipsOwnerAccountData.prototype['type'] = undefined;
...
export default UserRelationshipsOwnerAccountData;
