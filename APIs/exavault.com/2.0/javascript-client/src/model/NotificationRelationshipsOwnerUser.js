...
import NotificationRelationshipsOwnerUserData from './NotificationRelationshipsOwnerUserData';
...
class NotificationRelationshipsOwnerUser {
    ...
    constructor() { 
        ...
        NotificationRelationshipsOwnerUser.initialize(this);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('data')) {
                obj['data'] = NotificationRelationshipsOwnerUserData.constructFromObject(data['data']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>NotificationRelationshipsOwnerUser</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>NotificationRelationshipsOwnerUser</code>.
     */
    static validateJSON(data) {
        // validate the optional field `data`
        if (data['data']) { // data not null
          NotificationRelationshipsOwnerUserData.validateJSON(data['data']);
        }
 ...
 */
NotificationRelationshipsOwnerUser.prototype['data'] = undefined;
...
export default NotificationRelationshipsOwnerUser;
