 ...
 * @version 2.0
 */
class ResendInvitationsRequestBody {
    /**
    ...
    constructor() { 
        ...
        ResendInvitationsRequestBody.initialize(this);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('recipientId')) {
                obj['recipientId'] = ApiClient.convertToType(data['recipientId'], 'Number');
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ResendInvitationsRequestBody</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ResendInvitationsRequestBody</code>.
     */
 ...
 */
ResendInvitationsRequestBody.prototype['recipientId'] = undefined;
...
export default ResendInvitationsRequestBody;
