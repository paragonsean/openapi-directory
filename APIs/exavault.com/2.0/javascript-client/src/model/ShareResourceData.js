...
class ShareResourceData {
    ...
    constructor() { 
        ...
        ShareResourceData.initialize(this);
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ShareResourceData</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ShareResourceData</code>.
     */
 ...
 * @member {Number} id
 */
ShareResourceData.prototype['id'] = undefined;

/**
 * Type is resource. 
 * @member {module:model/ShareResourceData.TypeEnum} type
 */
ShareResourceData.prototype['type'] = undefined;
...
export default ShareResourceData;
