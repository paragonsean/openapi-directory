...
import ShareRelationshipsOwnerData from './ShareRelationshipsOwnerData';
...
class ShareRelationshipsOwner {
    ...
    constructor() { 
        ...
        ShareRelationshipsOwner.initialize(this);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('data')) {
                obj['data'] = ShareRelationshipsOwnerData.constructFromObject(data['data']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ShareRelationshipsOwner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ShareRelationshipsOwner</code>.
     */
    static validateJSON(data) {
        // validate the optional field `data`
        if (data['data']) { // data not null
          ShareRelationshipsOwnerData.validateJSON(data['data']);
        }
 ...
 */
ShareRelationshipsOwner.prototype['data'] = undefined;
...
export default ShareRelationshipsOwner;
