...
class NotificationRelationshipsResourceData {
    ...
    constructor() { 
        ...
        NotificationRelationshipsResourceData.initialize(this);
    }
    ...
    /**
     * Validates the JSON data with respect to <code>NotificationRelationshipsResourceData</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>NotificationRelationshipsResourceData</code>.
     */
 ...
 * @member {Number} id
 */
NotificationRelationshipsResourceData.prototype['id'] = undefined;

/**
 * @member {String} type
 */
NotificationRelationshipsResourceData.prototype['type'] = undefined;
...
export default NotificationRelationshipsResourceData;
