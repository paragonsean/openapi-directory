...
**noticeThreshold** | **Number** | Percent of account storage that would trigger a notice email. Must be a whole number between 70 and 100 (inclusive). | [optional] 
...
**transactionsNoticeThreshold** | **Number** | Percent of daily transaction usage that would trigger a notice email. Must be a whole number between 70 and 100 (inclusive). | [optional] 
