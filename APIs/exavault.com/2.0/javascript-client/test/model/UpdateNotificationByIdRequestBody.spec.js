...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ExaVault.UpdateNotificationByIdRequestBody();
  });
  ...
  describe('UpdateNotificationByIdRequestBody', function() {
    it('should create an instance of UpdateNotificationByIdRequestBody', function() {
      // uncomment below and update the code to test UpdateNotificationByIdRequestBody
      //var instance = new ExaVault.UpdateNotificationByIdRequestBody();
      //expect(instance).to.be.a(ExaVault.UpdateNotificationByIdRequestBody);
    });
