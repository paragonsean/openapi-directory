...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ExaVault.AccessMode();
  });
  ...
  describe('AccessMode', function() {
    it('should create an instance of AccessMode', function() {
      // uncomment below and update the code to test AccessMode
      //var instance = new ExaVault.AccessMode();
      //expect(instance).to.be.a(ExaVault.AccessMode);
    });
