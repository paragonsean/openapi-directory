...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ExaVault.NotificationCollectionResponse();
  });
  ...
  describe('NotificationCollectionResponse', function() {
    it('should create an instance of NotificationCollectionResponse', function() {
      ...
      //var instance = new ExaVault.NotificationCollectionResponse();
      //expect(instance).to.be.a(ExaVault.NotificationCollectionResponse);
    });
