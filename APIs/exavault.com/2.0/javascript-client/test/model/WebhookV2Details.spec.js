...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ExaVault.WebhookV2Details();
  });
  ...
  describe('WebhookV2Details', function() {
    it('should create an instance of WebhookV2Details', function() {
      // uncomment below and update the code to test WebhookV2Details
      //var instance = new ExaVault.WebhookV2Details();
      //expect(instance).to.be.a(ExaVault.WebhookV2Details);
    });
