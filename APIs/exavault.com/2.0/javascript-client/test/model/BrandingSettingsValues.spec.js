...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ExaVault.BrandingSettingsValues();
  });
  ...
  describe('BrandingSettingsValues', function() {
    it('should create an instance of BrandingSettingsValues', function() {
      // uncomment below and update the code to test BrandingSettingsValues
      //var instance = new ExaVault.BrandingSettingsValues();
      //expect(instance).to.be.a(ExaVault.BrandingSettingsValues);
    });
