...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ExaVault.NotificationRelationshipsResourceData();
  });
  ...
  describe('NotificationRelationshipsResourceData', function() {
    it('should create an instance of NotificationRelationshipsResourceData', function() {
      ...
      //var instance = new ExaVault.NotificationRelationshipsResourceData();
      //expect(instance).to.be.a(ExaVault.NotificationRelationshipsResourceData);
    });
