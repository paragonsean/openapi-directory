...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ExaVault.WebhookV2EventDataShareInner();
  });
  ...
  describe('WebhookV2EventDataShareInner', function() {
    it('should create an instance of WebhookV2EventDataShareInner', function() {
      // uncomment below and update the code to test WebhookV2EventDataShareInner
      //var instance = new ExaVault.WebhookV2EventDataShareInner();
      //expect(instance).to.be.a(ExaVault.WebhookV2EventDataShareInner);
    });
