...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ExaVault.WebhookCollectionResponse();
  });
  ...
  describe('WebhookCollectionResponse', function() {
    it('should create an instance of WebhookCollectionResponse', function() {
      // uncomment below and update the code to test WebhookCollectionResponse
      //var instance = new ExaVault.WebhookCollectionResponse();
      //expect(instance).to.be.a(ExaVault.WebhookCollectionResponse);
    });
