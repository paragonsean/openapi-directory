...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ExaVault.UpdateFormByIdRequestBody();
  });
  ...
  describe('UpdateFormByIdRequestBody', function() {
    it('should create an instance of UpdateFormByIdRequestBody', function() {
      // uncomment below and update the code to test UpdateFormByIdRequestBody
      //var instance = new ExaVault.UpdateFormByIdRequestBody();
      //expect(instance).to.be.a(ExaVault.UpdateFormByIdRequestBody);
    });
