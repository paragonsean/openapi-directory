...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ExaVault.SSHKeyAttributes();
  });
  ...
  describe('SSHKeyAttributes', function() {
    it('should create an instance of SSHKeyAttributes', function() {
      // uncomment below and update the code to test SSHKeyAttributes
      //var instance = new ExaVault.SSHKeyAttributes();
      //expect(instance).to.be.a(ExaVault.SSHKeyAttributes);
    });
