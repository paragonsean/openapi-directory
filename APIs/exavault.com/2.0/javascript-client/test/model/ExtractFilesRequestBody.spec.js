...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ExaVault.ExtractFilesRequestBody();
  });
  ...
  describe('ExtractFilesRequestBody', function() {
    it('should create an instance of ExtractFilesRequestBody', function() {
      // uncomment below and update the code to test ExtractFilesRequestBody
      //var instance = new ExaVault.ExtractFilesRequestBody();
      //expect(instance).to.be.a(ExaVault.ExtractFilesRequestBody);
    });
