...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ExaVault.WebhookRelationships();
  });
  ...
  describe('WebhookRelationships', function() {
    it('should create an instance of WebhookRelationships', function() {
      // uncomment below and update the code to test WebhookRelationships
      //var instance = new ExaVault.WebhookRelationships();
      //expect(instance).to.be.a(ExaVault.WebhookRelationships);
    });
