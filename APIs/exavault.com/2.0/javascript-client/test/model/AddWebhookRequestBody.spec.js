...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ExaVault.AddWebhookRequestBody();
  });
  ...
  describe('AddWebhookRequestBody', function() {
    it('should create an instance of AddWebhookRequestBody', function() {
      // uncomment below and update the code to test AddWebhookRequestBody
      //var instance = new ExaVault.AddWebhookRequestBody();
      //expect(instance).to.be.a(ExaVault.AddWebhookRequestBody);
    });
