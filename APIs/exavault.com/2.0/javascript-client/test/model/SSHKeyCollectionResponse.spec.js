...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ExaVault.SSHKeyCollectionResponse();
  });
  ...
  describe('SSHKeyCollectionResponse', function() {
    it('should create an instance of SSHKeyCollectionResponse', function() {
      // uncomment below and update the code to test SSHKeyCollectionResponse
      //var instance = new ExaVault.SSHKeyCollectionResponse();
      //expect(instance).to.be.a(ExaVault.SSHKeyCollectionResponse);
    });
