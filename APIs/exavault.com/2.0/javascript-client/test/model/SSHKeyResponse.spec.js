...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ExaVault.SSHKeyResponse();
  });
  ...
  describe('SSHKeyResponse', function() {
    it('should create an instance of SSHKeyResponse', function() {
      // uncomment below and update the code to test SSHKeyResponse
      //var instance = new ExaVault.SSHKeyResponse();
      //expect(instance).to.be.a(ExaVault.SSHKeyResponse);
    });
