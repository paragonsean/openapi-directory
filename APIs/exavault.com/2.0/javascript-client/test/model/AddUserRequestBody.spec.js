...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ExaVault.AddUserRequestBody();
  });
  ...
  describe('AddUserRequestBody', function() {
    it('should create an instance of AddUserRequestBody', function() {
      // uncomment below and update the code to test AddUserRequestBody
      //var instance = new ExaVault.AddUserRequestBody();
      //expect(instance).to.be.a(ExaVault.AddUserRequestBody);
    });
