...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ExaVault.WebhookActivityAttributesV2();
  });
  ...
  describe('WebhookActivityAttributesV2', function() {
    it('should create an instance of WebhookActivityAttributesV2', function() {
      // uncomment below and update the code to test WebhookActivityAttributesV2
      //var instance = new ExaVault.WebhookActivityAttributesV2();
      //expect(instance).to.be.a(ExaVault.WebhookActivityAttributesV2);
    });
