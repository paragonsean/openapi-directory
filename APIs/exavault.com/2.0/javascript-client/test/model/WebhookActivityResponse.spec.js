...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ExaVault.WebhookActivityResponse();
  });
  ...
  describe('WebhookActivityResponse', function() {
    it('should create an instance of WebhookActivityResponse', function() {
      // uncomment below and update the code to test WebhookActivityResponse
      //var instance = new ExaVault.WebhookActivityResponse();
      //expect(instance).to.be.a(ExaVault.WebhookActivityResponse);
    });
