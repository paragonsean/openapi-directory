...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ExaVault.AccountQuotaValues();
  });
  ...
  describe('AccountQuotaValues', function() {
    it('should create an instance of AccountQuotaValues', function() {
      // uncomment below and update the code to test AccountQuotaValues
      //var instance = new ExaVault.AccountQuotaValues();
      //expect(instance).to.be.a(ExaVault.AccountQuotaValues);
    });
