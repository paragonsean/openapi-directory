...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ExaVault.UpdateShareRequestBody();
  });
  ...
  describe('UpdateShareRequestBody', function() {
    it('should create an instance of UpdateShareRequestBody', function() {
      // uncomment below and update the code to test UpdateShareRequestBody
      //var instance = new ExaVault.UpdateShareRequestBody();
      //expect(instance).to.be.a(ExaVault.UpdateShareRequestBody);
    });
