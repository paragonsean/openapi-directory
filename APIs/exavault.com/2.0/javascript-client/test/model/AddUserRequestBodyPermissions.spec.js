...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ExaVault.AddUserRequestBodyPermissions();
  });
  ...
  describe('AddUserRequestBodyPermissions', function() {
    it('should create an instance of AddUserRequestBodyPermissions', function() {
      // uncomment below and update the code to test AddUserRequestBodyPermissions
      //var instance = new ExaVault.AddUserRequestBodyPermissions();
      //expect(instance).to.be.a(ExaVault.AddUserRequestBodyPermissions);
    });
