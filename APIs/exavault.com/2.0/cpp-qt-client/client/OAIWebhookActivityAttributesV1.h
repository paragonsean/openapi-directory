...
/*
 * OAIWebhookActivityAttributesV1.h
 *
 * 
 */

#ifndef OAIWebhookActivityAttributesV1_H
#define OAIWebhookActivityAttributesV1_H
...
namespace OpenAPI {
class OAIWebhookV1Details;

class OAIWebhookActivityAttributesV1 : public OAIObject {
public:
    OAIWebhookActivityAttributesV1();
    OAIWebhookActivityAttributesV1(QString json);
    ~OAIWebhookActivityAttributesV1() override;
    ...
    OAIWebhookV1Details getDetails() const;
    void setDetails(const OAIWebhookV1Details &details);
...
Q_DECLARE_METATYPE(OpenAPI::OAIWebhookActivityAttributesV1)

#endif // OAIWebhookActivityAttributesV1_H
