...
OAIAccount OAIAccountResponse::getData() const {
    return m_data;
}
void OAIAccountResponse::setData(const OAIAccount &data) {
    m_data = data;
    m_data_isSet = true;
}
...
QList<OAIUser> OAIAccountResponse::getIncluded() const {
    return m_included;
}
void OAIAccountResponse::setIncluded(const QList<OAIUser> &included) {
    m_included = included;
    m_included_isSet = true;
}

bool OAIAccountResponse::is_included_Set() const{
    return m_included_isSet;
}

bool OAIAccountResponse::is_included_Valid() const{
    return m_included_isValid;
}

qint32 OAIAccountResponse::getResponseStatus() const {
    return m_response_status;
}
void OAIAccountResponse::setResponseStatus(const qint32 &response_status) {
    m_response_status = response_status;
    m_response_status_isSet = true;
}

bool OAIAccountResponse::is_response_status_Set() const{
    return m_response_status_isSet;
}

bool OAIAccountResponse::is_response_status_Valid() const{
