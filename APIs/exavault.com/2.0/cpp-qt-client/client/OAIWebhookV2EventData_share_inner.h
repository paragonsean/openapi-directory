...
/*
 * OAIWebhookV2EventData_share_inner.h
 *
 * 
 */

#ifndef OAIWebhookV2EventData_share_inner_H
#define OAIWebhookV2EventData_share_inner_H
...
class OAIWebhookV2EventData_share_inner : public OAIObject {
public:
    OAIWebhookV2EventData_share_inner();
    OAIWebhookV2EventData_share_inner(QString json);
    ~OAIWebhookV2EventData_share_inner() override;
    ...
    bool isResent() const;
    void setResent(const bool &resent);
...
Q_DECLARE_METATYPE(OpenAPI::OAIWebhookV2EventData_share_inner)

#endif // OAIWebhookV2EventData_share_inner_H
