...
OAIResourceAttributes OAIResource::getAttributes() const {
    return m_attributes;
}
void OAIResource::setAttributes(const OAIResourceAttributes &attributes) {
...
qint64 OAIResource::getId() const {
    return m_id;
}
void OAIResource::setId(const qint64 &id) {
    m_id = id;
    m_id_isSet = true;
}
...
OAIResource_relationships OAIResource::getRelationships() const {
    return m_relationships;
}
void OAIResource::setRelationships(const OAIResource_relationships &relationships) {
    m_relationships = relationships;
    m_relationships_isSet = true;
}

bool OAIResource::is_relationships_Set() const{
    return m_relationships_isSet;
}

bool OAIResource::is_relationships_Valid() const{
