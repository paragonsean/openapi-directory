...
OAIUser OAIUserResponse::getData() const {
    return m_data;
}
void OAIUserResponse::setData(const OAIUser &data) {
    m_data = data;
    m_data_isSet = true;
}
...
QList<OAIUserCollectionResponse_included_inner> OAIUserResponse::getIncluded() const {
    return m_included;
}
void OAIUserResponse::setIncluded(const QList<OAIUserCollectionResponse_included_inner> &included) {
    m_included = included;
    m_included_isSet = true;
}

bool OAIUserResponse::is_included_Set() const{
    return m_included_isSet;
}

bool OAIUserResponse::is_included_Valid() const{
    return m_included_isValid;
}

qint32 OAIUserResponse::getResponseStatus() const {
    return m_response_status;
}
void OAIUserResponse::setResponseStatus(const qint32 &response_status) {
    m_response_status = response_status;
    m_response_status_isSet = true;
}

bool OAIUserResponse::is_response_status_Set() const{
    return m_response_status_isSet;
}

bool OAIUserResponse::is_response_status_Valid() const{
