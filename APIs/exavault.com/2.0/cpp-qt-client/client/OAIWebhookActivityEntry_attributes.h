...
/*
 * OAIWebhookActivityEntry_attributes.h
 *
 * 
 */

#ifndef OAIWebhookActivityEntry_attributes_H
#define OAIWebhookActivityEntry_attributes_H
...
class OAIWebhookActivityEntry_attributes : public OAIObject {
public:
    OAIWebhookActivityEntry_attributes();
    OAIWebhookActivityEntry_attributes(QString json);
    ~OAIWebhookActivityEntry_attributes() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIWebhookActivityEntry_attributes)

#endif // OAIWebhookActivityEntry_attributes_H
