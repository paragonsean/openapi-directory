...
OAIForm OAIFormResponse::getData() const {
    return m_data;
}
void OAIFormResponse::setData(const OAIForm &data) {
    m_data = data;
    m_data_isSet = true;
}

bool OAIFormResponse::is_data_Set() const{
    return m_data_isSet;
}

bool OAIFormResponse::is_data_Valid() const{
    return m_data_isValid;
}

QList<OAIShare> OAIFormResponse::getIncluded() const {
    return m_included;
}
void OAIFormResponse::setIncluded(const QList<OAIShare> &included) {
    m_included = included;
    m_included_isSet = true;
}

bool OAIFormResponse::is_included_Set() const{
    return m_included_isSet;
}

bool OAIFormResponse::is_included_Valid() const{
    return m_included_isValid;
}

qint32 OAIFormResponse::getResponseStatus() const {
    return m_response_status;
}
void OAIFormResponse::setResponseStatus(const qint32 &response_status) {
    m_response_status = response_status;
    m_response_status_isSet = true;
}

bool OAIFormResponse::is_response_status_Set() const{
    return m_response_status_isSet;
}

bool OAIFormResponse::is_response_status_Valid() const{
