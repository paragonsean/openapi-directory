...
OAIFormAttributes OAIForm::getAttributes() const {
    return m_attributes;
}
void OAIForm::setAttributes(const OAIFormAttributes &attributes) {
    m_attributes = attributes;
    m_attributes_isSet = true;
}

bool OAIForm::is_attributes_Set() const{
    return m_attributes_isSet;
}

bool OAIForm::is_attributes_Valid() const{
    return m_attributes_isValid;
}

qint32 OAIForm::getId() const {
    return m_id;
}
void OAIForm::setId(const qint32 &id) {
    m_id = id;
    m_id_isSet = true;
}
...
OAIForm_relationships OAIForm::getRelationships() const {
    return m_relationships;
}
void OAIForm::setRelationships(const OAIForm_relationships &relationships) {
    m_relationships = relationships;
    m_relationships_isSet = true;
}

bool OAIForm::is_relationships_Set() const{
    return m_relationships_isSet;
}

bool OAIForm::is_relationships_Valid() const{
    return m_relationships_isValid;
}

QString OAIForm::getType() const {
    return m_type;
}
void OAIForm::setType(const QString &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAIForm::is_type_Set() const{
    return m_type_isSet;
}

bool OAIForm::is_type_Valid() const{
