...
/*
 * OAIFormEntryResponse.h
 *
 * Response object of the form data.
 */

#ifndef OAIFormEntryResponse_H
#define OAIFormEntryResponse_H

#include <QJsonObject>

#include "OAIFormEntry.h"
#include <QList>
...
class OAIFormEntryResponse : public OAIObject {
public:
    OAIFormEntryResponse();
    OAIFormEntryResponse(QString json);
    ~OAIFormEntryResponse() override;
    ...
    QList<OAIFormEntry> getData() const;
    void setData(const QList<OAIFormEntry> &data);
...
Q_DECLARE_METATYPE(OpenAPI::OAIFormEntryResponse)

#endif // OAIFormEntryResponse_H
