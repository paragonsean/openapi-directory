...
/*
 * OAIUserCollectionResponse.h
 *
 * 
 */

#ifndef OAIUserCollectionResponse_H
#define OAIUserCollectionResponse_H
...
class OAIUserCollectionResponse : public OAIObject {
public:
    OAIUserCollectionResponse();
    OAIUserCollectionResponse(QString json);
    ~OAIUserCollectionResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUserCollectionResponse)

#endif // OAIUserCollectionResponse_H
