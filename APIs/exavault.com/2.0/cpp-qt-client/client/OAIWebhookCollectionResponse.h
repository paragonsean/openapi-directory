...
/*
 * OAIWebhookCollectionResponse.h
 *
 * 
 */

#ifndef OAIWebhookCollectionResponse_H
#define OAIWebhookCollectionResponse_H

#include <QJsonObject>

#include "OAIUserCollectionResponse_included_inner.h"
...
namespace OpenAPI {
class OAIWebhook;
class OAIUserCollectionResponse_included_inner;

class OAIWebhookCollectionResponse : public OAIObject {
public:
    OAIWebhookCollectionResponse();
    OAIWebhookCollectionResponse(QString json);
    ~OAIWebhookCollectionResponse() override;
    ...
    QList<OAIUserCollectionResponse_included_inner> getIncluded() const;
    void setIncluded(const QList<OAIUserCollectionResponse_included_inner> &included);
...
private:
    ...
    QList<OAIUserCollectionResponse_included_inner> m_included;
...
Q_DECLARE_METATYPE(OpenAPI::OAIWebhookCollectionResponse)

#endif // OAIWebhookCollectionResponse_H
