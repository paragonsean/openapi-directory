...
OAIFormAttributes::OAIFormAttributes(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIFormAttributes::OAIFormAttributes() {
    this->initializeModel();
}

OAIFormAttributes::~OAIFormAttributes() {}

void OAIFormAttributes::initializeModel() {
...
void OAIFormAttributes::fromJson(QString jsonString) {
...
void OAIFormAttributes::fromJsonObject(QJsonObject json) {
...
QString OAIFormAttributes::asJson() const {
...
QJsonObject OAIFormAttributes::asJsonObject() const {
    QJsonObject obj;
...
QString OAIFormAttributes::getCssStyles() const {
    return m_css_styles;
}
void OAIFormAttributes::setCssStyles(const QString &css_styles) {
    m_css_styles = css_styles;
    m_css_styles_isSet = true;
}

bool OAIFormAttributes::is_css_styles_Set() const{
    return m_css_styles_isSet;
}

bool OAIFormAttributes::is_css_styles_Valid() const{
    return m_css_styles_isValid;
}

QList<OAIFormField> OAIFormAttributes::getElements() const {
    return m_elements;
}
void OAIFormAttributes::setElements(const QList<OAIFormField> &elements) {
    m_elements = elements;
    m_elements_isSet = true;
}

bool OAIFormAttributes::is_elements_Set() const{
    return m_elements_isSet;
}

bool OAIFormAttributes::is_elements_Valid() const{
    return m_elements_isValid;
}

QString OAIFormAttributes::getFormDescription() const {
    return m_form_description;
}
void OAIFormAttributes::setFormDescription(const QString &form_description) {
    m_form_description = form_description;
    m_form_description_isSet = true;
}

bool OAIFormAttributes::is_form_description_Set() const{
    return m_form_description_isSet;
}

bool OAIFormAttributes::is_form_description_Valid() const{
    return m_form_description_isValid;
}

QString OAIFormAttributes::getSubmitButtonText() const {
    return m_submit_button_text;
}
void OAIFormAttributes::setSubmitButtonText(const QString &submit_button_text) {
    m_submit_button_text = submit_button_text;
    m_submit_button_text_isSet = true;
}

bool OAIFormAttributes::is_submit_button_text_Set() const{
    return m_submit_button_text_isSet;
}

bool OAIFormAttributes::is_submit_button_text_Valid() const{
    return m_submit_button_text_isValid;
}

QString OAIFormAttributes::getSuccessMessage() const {
    return m_success_message;
}
void OAIFormAttributes::setSuccessMessage(const QString &success_message) {
    m_success_message = success_message;
    m_success_message_isSet = true;
}

bool OAIFormAttributes::is_success_message_Set() const{
    return m_success_message_isSet;
}

bool OAIFormAttributes::is_success_message_Valid() const{
    return m_success_message_isValid;
}

bool OAIFormAttributes::isSet() const {
...
bool OAIFormAttributes::isValid() const {
