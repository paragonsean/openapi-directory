...
/*
 * OAIResourceCollectionResponse.h
 *
 * Response object for collection of resources.
 */

#ifndef OAIResourceCollectionResponse_H
#define OAIResourceCollectionResponse_H
...
class OAIResourceCollectionResponse : public OAIObject {
public:
    OAIResourceCollectionResponse();
    OAIResourceCollectionResponse(QString json);
    ~OAIResourceCollectionResponse() override;
    ...
    QList<OAIResource> getData() const;
    void setData(const QList<OAIResource> &data);
...
Q_DECLARE_METATYPE(OpenAPI::OAIResourceCollectionResponse)

#endif // OAIResourceCollectionResponse_H
