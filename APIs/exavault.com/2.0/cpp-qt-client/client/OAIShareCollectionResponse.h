...
/*
 * OAIShareCollectionResponse.h
 *
 * 
 */

#ifndef OAIShareCollectionResponse_H
#define OAIShareCollectionResponse_H
...
class OAIShareCollectionResponse : public OAIObject {
public:
    OAIShareCollectionResponse();
    OAIShareCollectionResponse(QString json);
    ~OAIShareCollectionResponse() override;
    ...
    QList<OAIShare> getData() const;
    void setData(const QList<OAIShare> &data);
...
Q_DECLARE_METATYPE(OpenAPI::OAIShareCollectionResponse)

#endif // OAIShareCollectionResponse_H
