...
/*
 * OAIUpdateWebhookRequestBody.h
 *
 * 
 */

#ifndef OAIUpdateWebhookRequestBody_H
#define OAIUpdateWebhookRequestBody_H
...
class OAIUpdateWebhookRequestBody : public OAIObject {
public:
    OAIUpdateWebhookRequestBody();
    OAIUpdateWebhookRequestBody(QString json);
    ~OAIUpdateWebhookRequestBody() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateWebhookRequestBody)

#endif // OAIUpdateWebhookRequestBody_H
