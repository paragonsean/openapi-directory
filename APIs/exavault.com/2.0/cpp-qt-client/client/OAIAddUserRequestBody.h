...
/*
 * OAIAddUserRequestBody.h
 *
 * 
 */

#ifndef OAIAddUserRequestBody_H
#define OAIAddUserRequestBody_H
...
namespace OpenAPI {
class OAIAddUserRequestBody_permissions;

class OAIAddUserRequestBody : public OAIObject {
public:
    OAIAddUserRequestBody();
    OAIAddUserRequestBody(QString json);
    ~OAIAddUserRequestBody() override;
    ...
    OAIAddUserRequestBody_permissions getPermissions() const;
    void setPermissions(const OAIAddUserRequestBody_permissions &permissions);
    ...
    bool isWelcomeEmail() const;
    void setWelcomeEmail(const bool &welcome_email);
    bool is_welcome_email_Set() const;
    bool is_welcome_email_Valid() const;
...
private:
    ...
    OAIAddUserRequestBody_permissions m_permissions;
    ...
    bool m_welcome_email;
    bool m_welcome_email_isSet;
    bool m_welcome_email_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIAddUserRequestBody)

#endif // OAIAddUserRequestBody_H
