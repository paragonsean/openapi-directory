...
/*
 * OAIWebhookActivityResponse.h
 *
 * Session activity list response
 */

#ifndef OAIWebhookActivityResponse_H
#define OAIWebhookActivityResponse_H
...
namespace OpenAPI {
class OAIWebhookActivityEntry;

class OAIWebhookActivityResponse : public OAIObject {
public:
    OAIWebhookActivityResponse();
    OAIWebhookActivityResponse(QString json);
    ~OAIWebhookActivityResponse() override;
    ...
    QList<OAIWebhookActivityEntry> getData() const;
    void setData(const QList<OAIWebhookActivityEntry> &data);
...
private:
    ...
    QList<OAIWebhookActivityEntry> m_data;
    bool m_data_isSet;
    bool m_data_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIWebhookActivityResponse)

#endif // OAIWebhookActivityResponse_H
