...
async def test_get_plus_card_details(client):
    """Test case for get_plus_card_details
...
async def test_set_lost_stolen(client):
    """Test case for set_lost_stolen
...
async def test_set_phone_number(client):
    """Test case for set_phone_number
...
async def test_update_pin(client):
