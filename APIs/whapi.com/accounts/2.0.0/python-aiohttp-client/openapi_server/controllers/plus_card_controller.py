...
async def get_plus_card_details(request: web.Request, api_key, api_secret, api_ticket, fields=None, include=None, exclude=None) -> web.Response:
...
async def set_lost_stolen(request: web.Request, api_key, api_secret, api_ticket) -> web.Response:
...
async def set_phone_number(request: web.Request, api_key, api_secret, api_ticket, old_phone_number, phone_number) -> web.Response:
...
async def set_pin(request: web.Request, api_key, api_secret, api_ticket, pin) -> web.Response:
...
async def update_pin(request: web.Request, api_key, api_secret, api_ticket, pin) -> web.Response:
