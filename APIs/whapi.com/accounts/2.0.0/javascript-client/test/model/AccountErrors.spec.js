...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AccountsApi.AccountErrors();
  });
  ...
  describe('AccountErrors', function() {
    it('should create an instance of AccountErrors', function() {
      // uncomment below and update the code to test AccountErrors
      //var instance = new AccountsApi.AccountErrors();
      //expect(instance).to.be.a(AccountsApi.AccountErrors);
    });
