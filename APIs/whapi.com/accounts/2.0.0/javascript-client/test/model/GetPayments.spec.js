...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AccountsApi.GetPayments();
  });
  ...
  describe('GetPayments', function() {
    it('should create an instance of GetPayments', function() {
      // uncomment below and update the code to test GetPayments
      //var instance = new AccountsApi.GetPayments();
      //expect(instance).to.be.a(AccountsApi.GetPayments);
    });
