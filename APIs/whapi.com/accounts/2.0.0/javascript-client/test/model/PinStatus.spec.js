...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AccountsApi.PinStatus();
  });
  ...
  describe('PinStatus', function() {
    it('should create an instance of PinStatus', function() {
      ...
      //var instance = new AccountsApi.PinStatus();
      //expect(instance).to.be.a(AccountsApi.PinStatus);
    });

    it('should have the property attemptsRemaining (base name: "attemptsRemaining")', function() {
      // uncomment below and update the code to test the property attemptsRemaining
      //var instance = new AccountsApi.PinStatus();
