...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AccountsApi.PlusCard();
  });
  ...
  describe('PlusCard', function() {
    it('should create an instance of PlusCard', function() {
      // uncomment below and update the code to test PlusCard
      //var instance = new AccountsApi.PlusCard();
      //expect(instance).to.be.a(AccountsApi.PlusCard);
    });
