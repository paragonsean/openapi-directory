...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AccountsApi.AccountFlagsSet();
  });
  ...
  describe('AccountFlagsSet', function() {
    it('should create an instance of AccountFlagsSet', function() {
      // uncomment below and update the code to test AccountFlagsSet
      //var instance = new AccountsApi.AccountFlagsSet();
      //expect(instance).to.be.a(AccountsApi.AccountFlagsSet);
    });
