...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AccountsApi.StolenApi();
  });
  ...
  describe('StolenApi', function() {
    describe('setLostStolen_4', function() {
      it('should call setLostStolen_4 successfully', function(done) {
        //uncomment below and update the code to test setLostStolen_4
        //instance.setLostStolen_4(function(error) {
