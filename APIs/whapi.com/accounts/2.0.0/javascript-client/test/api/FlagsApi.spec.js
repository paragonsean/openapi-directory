...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AccountsApi.FlagsApi();
  });
  ...
  describe('FlagsApi', function() {
    describe('setAccountFlags', function() {
      it('should call setAccountFlags successfully', function(done) {
        //uncomment below and update the code to test setAccountFlags
        //instance.setAccountFlags(function(error) {
