...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AccountsApi.LostApi();
  });
  ...
  describe('LostApi', function() {
    describe('setLostStolen_3', function() {
      it('should call setLostStolen_3 successfully', function(done) {
        //uncomment below and update the code to test setLostStolen_3
        //instance.setLostStolen_3(function(error) {
