...
void Example::exampleFunction1(){
     OAIAccountsApi apiInstance;
      ...
      QEventLoop loop;
      connect(&apiInstance, &OAIAccountsApi::getBalanceSignal, [&]() {
          loop.quit();
      });
      connect(&apiInstance, &OAIAccountsApi::getBalanceSignalE, [&](QNetworkReply::NetworkError, QString error_str) {
      ...
      QString api_ticket = create(); // QString | Ticket Granting Ticket obtained from a previous request
      ...
      apiInstance.getBalance(api_keyapi_secretapi_ticketfieldsincludeexcludeterritorylanguage_as_per_territory);
