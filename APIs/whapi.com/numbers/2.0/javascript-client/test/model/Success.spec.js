...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NumbersApi.Success();
  });
  ...
  describe('Success', function() {
    it('should create an instance of Success', function() {
      ...
      //var instance = new NumbersApi.Success();
      //expect(instance).to.be.a(NumbersApi.Success);
    });

    it('should have the property randomNumbers (base name: "randomNumbers")', function() {
      // uncomment below and update the code to test the property randomNumbers
      //var instance = new NumbersApi.Success();
