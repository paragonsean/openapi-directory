...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NumbersApi.NumbersErrors();
  });
  ...
  describe('NumbersErrors', function() {
    it('should create an instance of NumbersErrors', function() {
      // uncomment below and update the code to test NumbersErrors
      //var instance = new NumbersApi.NumbersErrors();
      //expect(instance).to.be.a(NumbersApi.NumbersErrors);
    });
