...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NumbersApi.NumbersApi();
  });
  ...
  describe('NumbersApi', function() {
    describe('getRandomNumbers', function() {
      it('should call getRandomNumbers successfully', function(done) {
        //uncomment below and update the code to test getRandomNumbers
        //instance.getRandomNumbers(function(error) {
