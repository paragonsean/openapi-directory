...
/**
 * The Ticketvalidityresponse model module.
 * @module model/Ticketvalidityresponse
 * @version 2.0.0
 */
class Ticketvalidityresponse {
    /**
     * Constructs a new <code>Ticketvalidityresponse</code>.
     * @alias module:model/Ticketvalidityresponse
     */
    constructor() { 
        
        Ticketvalidityresponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>Ticketvalidityresponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Ticketvalidityresponse} obj Optional instance to populate.
     * @return {module:model/Ticketvalidityresponse} The populated <code>Ticketvalidityresponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new Ticketvalidityresponse();
    ...
    /**
     * Validates the JSON data with respect to <code>Ticketvalidityresponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Ticketvalidityresponse</code>.
     */
 ...
 */
Ticketvalidityresponse.prototype['valid'] = undefined;
...
export default Ticketvalidityresponse;
