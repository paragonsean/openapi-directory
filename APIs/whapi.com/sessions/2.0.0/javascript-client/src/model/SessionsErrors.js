...
/**
 * The SessionsErrors model module.
 * @module model/SessionsErrors
 * @version 2.0.0
 */
class SessionsErrors {
    /**
     * Constructs a new <code>SessionsErrors</code>.
     * @alias module:model/SessionsErrors
     */
    constructor() { 
        
        SessionsErrors.initialize(this);
    }
    ...
    /**
     * Constructs a <code>SessionsErrors</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SessionsErrors} obj Optional instance to populate.
     * @return {module:model/SessionsErrors} The populated <code>SessionsErrors</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SessionsErrors();
    ...
    /**
     * Validates the JSON data with respect to <code>SessionsErrors</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SessionsErrors</code>.
     */
 ...
 */
SessionsErrors.prototype['errors'] = undefined;
