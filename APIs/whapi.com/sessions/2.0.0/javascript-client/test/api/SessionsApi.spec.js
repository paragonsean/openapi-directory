...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SessionsApi.SessionsApi();
  });
  ...
  describe('SessionsApi', function() {
    describe('getServiceTicket', function() {
      it('should call getServiceTicket successfully', function(done) {
        //uncomment below and update the code to test getServiceTicket
        //instance.getServiceTicket(function(error) {
    ...
    describe('validateSession', function() {
      it('should call validateSession successfully', function(done) {
        //uncomment below and update the code to test validateSession
        //instance.validateSession(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
