...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SessionsApi.Ticketvalidityresponse();
  });
  ...
  describe('Ticketvalidityresponse', function() {
    it('should create an instance of Ticketvalidityresponse', function() {
      // uncomment below and update the code to test Ticketvalidityresponse
      //var instance = new SessionsApi.Ticketvalidityresponse();
      //expect(instance).to.be.a(SessionsApi.Ticketvalidityresponse);
    });
