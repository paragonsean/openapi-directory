...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SessionsApi.SessionsErrors();
  });
  ...
  describe('SessionsErrors', function() {
    it('should create an instance of SessionsErrors', function() {
      // uncomment below and update the code to test SessionsErrors
      //var instance = new SessionsApi.SessionsErrors();
      //expect(instance).to.be.a(SessionsApi.SessionsErrors);
    });
