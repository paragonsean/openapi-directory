...
#ifndef OAISessionsErrors_H
#define OAISessionsErrors_H
...
class OAISessionsErrors : public OAIObject {
public:
    OAISessionsErrors();
    OAISessionsErrors(QString json);
    ~OAISessionsErrors() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISessionsErrors)

#endif // OAISessionsErrors_H
