...
public:
    ...
    bool isTemporaryPassword() const;
    void setTemporaryPassword(const bool &temporary_password);
    bool is_temporary_password_Set() const;
    bool is_temporary_password_Valid() const;

    QString getTemporaryPasswordUrl() const;
    void setTemporaryPasswordUrl(const QString &temporary_password_url);
    bool is_temporary_password_url_Set() const;
    bool is_temporary_password_url_Valid() const;
...
private:
    ...
    bool m_temporary_password;
    bool m_temporary_password_isSet;
    bool m_temporary_password_isValid;

    QString m_temporary_password_url;
    bool m_temporary_password_url_isSet;
    bool m_temporary_password_url_isValid;
