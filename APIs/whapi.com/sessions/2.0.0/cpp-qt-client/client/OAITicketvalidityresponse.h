...
/*
 * OAITicketvalidityresponse.h
 *
 * 
 */

#ifndef OAITicketvalidityresponse_H
#define OAITicketvalidityresponse_H
...
class OAITicketvalidityresponse : public OAIObject {
public:
    OAITicketvalidityresponse();
    OAITicketvalidityresponse(QString json);
    ~OAITicketvalidityresponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITicketvalidityresponse)

#endif // OAITicketvalidityresponse_H
