...
#ifndef OAIServiceTicket_H
#define OAIServiceTicket_H
...
class OAIServiceTicket : public OAIObject {
public:
    OAIServiceTicket();
    OAIServiceTicket(QString json);
    ~OAIServiceTicket() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIServiceTicket)

#endif // OAIServiceTicket_H
