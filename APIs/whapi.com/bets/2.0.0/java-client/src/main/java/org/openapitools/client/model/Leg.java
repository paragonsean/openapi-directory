...
import org.openapitools.client.model.Part;
...
public class Leg {
  ...
  public Leg parts(List<Part> parts) {
    this.parts = parts;
    return this;
  }

  public Leg addPartsItem(Part partsItem) {
    if (this.parts == null) {
  ...
  public boolean equals(Object o) {
    ...
    Leg leg = (Leg) o;
    return Objects.equals(this.parts, leg.parts) &&
        Objects.equals(this.sort, leg.sort) &&
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (int i = 0; i < jsonArrayparts.size(); i++) {
        Part.validateJsonElement(jsonArrayparts.get(i));
      };
