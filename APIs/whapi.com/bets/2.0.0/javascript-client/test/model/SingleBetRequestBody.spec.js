...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BetsApi.SingleBetRequestBody();
  });
  ...
  describe('SingleBetRequestBody', function() {
    it('should create an instance of SingleBetRequestBody', function() {
      // uncomment below and update the code to test SingleBetRequestBody
      //var instance = new BetsApi.SingleBetRequestBody();
      //expect(instance).to.be.a(BetsApi.SingleBetRequestBody);
    });

    it('should have the property delayedBetId (base name: "delayedBetId")', function() {
      // uncomment below and update the code to test the property delayedBetId
      //var instance = new BetsApi.SingleBetRequestBody();
      //expect(instance).to.be();
    });

    it('should have the property freeBetId (base name: "freeBetId")', function() {
      // uncomment below and update the code to test the property freeBetId
      //var instance = new BetsApi.SingleBetRequestBody();
      //expect(instance).to.be();
    });
