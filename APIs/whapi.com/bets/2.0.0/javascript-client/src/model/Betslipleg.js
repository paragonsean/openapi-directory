...
class Betslipleg {
     ...
     */
    static initialize(obj, parts, type) { 
        obj['parts'] = parts;
        obj['type'] = type;
    }

    /**
     * Constructs a <code>Betslipleg</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Betslipleg} obj Optional instance to populate.
     * @return {module:model/Betslipleg} The populated <code>Betslipleg</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new Betslipleg();

            if (data.hasOwnProperty('parts')) {
                obj['parts'] = ApiClient.convertToType(data['parts'], [Betslippart]);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>Betslipleg</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Betslipleg</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of Betslipleg.RequiredProperties) {
...
Betslipleg.RequiredProperties = ["parts", "type"];

/**
 * @member {Array.<module:model/Betslippart>} parts
 */
Betslipleg.prototype['parts'] = undefined;

/**
 * The leg sort. This element is present for complex bets but not for single bets.
 * @member {String} sort
 */
Betslipleg.prototype['sort'] = undefined;

/**
 * Type of leg that was placed on the bet, such as Win or Each-way. Even though the priceNum and priceDen are required for the bets with type value W (win), it is just optional from the endpoint point of view. There are requests / bets like outcomes with starting price but do not have a specific price. Generally prices can change, so if the type is win you have to resubmit and thus verify the price that the customer saw on the screen initially. The API will check if it matches the current price of William Hill. Note that if you send a wrong / outdated price you will receive the error message - Price changed.
 * @member {String} type
 */
Betslipleg.prototype['type'] = undefined;
