...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SportsDataApi.Marketgroup();
  });
  ...
  describe('Marketgroup', function() {
    it('should create an instance of Marketgroup', function() {
      // uncomment below and update the code to test Marketgroup
      //var instance = new SportsDataApi.Marketgroup();
      //expect(instance).to.be.a(SportsDataApi.Marketgroup);
    });
