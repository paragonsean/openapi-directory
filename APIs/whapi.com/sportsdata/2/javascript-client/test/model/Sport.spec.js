...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SportsDataApi.Sport();
  });
  ...
  describe('Sport', function() {
    it('should create an instance of Sport', function() {
      // uncomment below and update the code to test Sport
      //var instance = new SportsDataApi.Sport();
      //expect(instance).to.be.a(SportsDataApi.Sport);
    });
