...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SportsDataApi.MarketsWrapper();
  });
  ...
  describe('MarketsWrapper', function() {
    it('should create an instance of MarketsWrapper', function() {
      // uncomment below and update the code to test MarketsWrapper
      //var instance = new SportsDataApi.MarketsWrapper();
      //expect(instance).to.be.a(SportsDataApi.MarketsWrapper);
    });
