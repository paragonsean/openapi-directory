...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SportsDataApi.SelectionsWrapper();
  });
  ...
  describe('SelectionsWrapper', function() {
    it('should create an instance of SelectionsWrapper', function() {
      // uncomment below and update the code to test SelectionsWrapper
      //var instance = new SportsDataApi.SelectionsWrapper();
      //expect(instance).to.be.a(SportsDataApi.SelectionsWrapper);
    });
