...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SportsDataApi.ClassesWrapper();
  });
  ...
  describe('ClassesWrapper', function() {
    it('should create an instance of ClassesWrapper', function() {
      // uncomment below and update the code to test ClassesWrapper
      //var instance = new SportsDataApi.ClassesWrapper();
      //expect(instance).to.be.a(SportsDataApi.ClassesWrapper);
    });
