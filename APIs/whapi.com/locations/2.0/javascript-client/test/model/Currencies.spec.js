...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Locations.Currencies();
  });
  ...
  describe('Currencies', function() {
    it('should create an instance of Currencies', function() {
      // uncomment below and update the code to test Currencies
      //var instance = new Locations.Currencies();
      //expect(instance).to.be.a(Locations.Currencies);
    });
