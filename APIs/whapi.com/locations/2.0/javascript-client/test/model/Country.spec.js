...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Locations.Country();
  });
  ...
  describe('Country', function() {
    it('should create an instance of Country', function() {
      ...
      //var instance = new Locations.Country();
      //expect(instance).to.be.a(Locations.Country);
    });
    ...
    it('should have the property dialCode (base name: "dialCode")', function() {
