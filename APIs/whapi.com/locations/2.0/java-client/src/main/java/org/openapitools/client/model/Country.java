...
public class Country {
  ...
  public static final String SERIALIZED_NAME_DIAL_CODE = "dialCode";
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.code, country.code) &&
        ...
        Objects.equals(this.dialCode, country.dialCode) &&
        Objects.equals(this.name, country.name);
  }

  @Override
  public int hashCode() {
    return Objects.hash(code, currencyCode, dialCode, name);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if ((jsonObj.get("dialCode") != null && !jsonObj.get("dialCode").isJsonNull()) && !jsonObj.get("dialCode").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `dialCode` to be a primitive type in the JSON string but got `%s`", jsonObj.get("dialCode").toString()));
      }
