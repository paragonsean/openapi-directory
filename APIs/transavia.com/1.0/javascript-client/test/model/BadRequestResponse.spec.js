...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AirportsApiV2.BadRequestResponse();
  });
  ...
  describe('BadRequestResponse', function() {
    it('should create an instance of BadRequestResponse', function() {
      ...
      //var instance = new AirportsApiV2.BadRequestResponse();
      //expect(instance).to.be.a(AirportsApiV2.BadRequestResponse);
    });
