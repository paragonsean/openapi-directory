...
void Example::exampleFunction1(){
     OAIDefaultApi apiInstance;
      ...
      QEventLoop loop;
      connect(&apiInstance, &OAIDefaultApi::v1OrderFeedbackPostSignal, [&]() {
          loop.quit();
      });
      connect(&apiInstance, &OAIDefaultApi::v1OrderFeedbackPostSignalE, [&](QNetworkReply::NetworkError, QString error_str) {
          qDebug() << "Error happened while issuing request : " << error_str;
          loop.quit();
      });

      QString id = create(); // QString | 
      ...
      QString notes = create(); // QString | 
      apiInstance.v1OrderFeedbackPost(idkeyactionformatnotes);
