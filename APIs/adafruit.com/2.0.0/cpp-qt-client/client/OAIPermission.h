...
public:
    ...
    void setObjectId(const double &object_id);
    ...
    QString getScopeValue() const;
    void setScopeValue(const QString &scope_value);
    bool is_scope_value_Set() const;
    bool is_scope_value_Valid() const;
...
private:
    ...
    QString m_scope_value;
    bool m_scope_value_isSet;
    bool m_scope_value_isValid;
