...
/*
 * OAICreateTrigger_request.h
 *
 * 
 */

#ifndef OAICreateTrigger_request_H
#define OAICreateTrigger_request_H
...
class OAICreateTrigger_request : public OAIObject {
public:
    OAICreateTrigger_request();
    OAICreateTrigger_request(QString json);
    ~OAICreateTrigger_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateTrigger_request)

#endif // OAICreateTrigger_request_H
