...
QString OAICreatePermission_request::getMode() const {
    return m_mode;
}
void OAICreatePermission_request::setMode(const QString &mode) {
    m_mode = mode;
    m_mode_isSet = true;
}

bool OAICreatePermission_request::is_mode_Set() const{
    return m_mode_isSet;
}

bool OAICreatePermission_request::is_mode_Valid() const{
    return m_mode_isValid;
}

QString OAICreatePermission_request::getScope() const {
    return m_scope;
}
void OAICreatePermission_request::setScope(const QString &scope) {
    m_scope = scope;
    m_scope_isSet = true;
}

bool OAICreatePermission_request::is_scope_Set() const{
    return m_scope_isSet;
}

bool OAICreatePermission_request::is_scope_Valid() const{
    return m_scope_isValid;
}

QString OAICreatePermission_request::getScopeValue() const {
    return m_scope_value;
}
void OAICreatePermission_request::setScopeValue(const QString &scope_value) {
    m_scope_value = scope_value;
    m_scope_value_isSet = true;
}

bool OAICreatePermission_request::is_scope_value_Set() const{
    return m_scope_value_isSet;
}

bool OAICreatePermission_request::is_scope_value_Valid() const{
