...
QList<OAIBlock> OAIDashboard::getBlocks() const {
    return m_blocks;
}
void OAIDashboard::setBlocks(const QList<OAIBlock> &blocks) {
    m_blocks = blocks;
    m_blocks_isSet = true;
}

bool OAIDashboard::is_blocks_Set() const{
    return m_blocks_isSet;
}

bool OAIDashboard::is_blocks_Valid() const{
...
QString OAIDashboard::getKey() const {
    return m_key;
}
void OAIDashboard::setKey(const QString &key) {
    m_key = key;
    m_key_isSet = true;
}

bool OAIDashboard::is_key_Set() const{
    return m_key_isSet;
}

bool OAIDashboard::is_key_Valid() const{
