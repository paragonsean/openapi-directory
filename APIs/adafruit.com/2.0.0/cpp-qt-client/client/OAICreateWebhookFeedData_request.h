...
/*
 * OAICreateWebhookFeedData_request.h
 *
 * 
 */

#ifndef OAICreateWebhookFeedData_request_H
#define OAICreateWebhookFeedData_request_H
...
class OAICreateWebhookFeedData_request : public OAIObject {
public:
    OAICreateWebhookFeedData_request();
    OAICreateWebhookFeedData_request(QString json);
    ~OAICreateWebhookFeedData_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateWebhookFeedData_request)

#endif // OAICreateWebhookFeedData_request_H
