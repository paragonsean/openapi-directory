...
/*
 * OAICreateData_request.h
 *
 * 
 */

#ifndef OAICreateData_request_H
#define OAICreateData_request_H
...
class OAICreateData_request : public OAIObject {
public:
    OAICreateData_request();
    OAICreateData_request(QString json);
    ~OAICreateData_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateData_request)

#endif // OAICreateData_request_H
