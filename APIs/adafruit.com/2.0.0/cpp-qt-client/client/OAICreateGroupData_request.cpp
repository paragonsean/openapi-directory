...
OAICreateGroupData_request::OAICreateGroupData_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateGroupData_request::OAICreateGroupData_request() {
    this->initializeModel();
}

OAICreateGroupData_request::~OAICreateGroupData_request() {}

void OAICreateGroupData_request::initializeModel() {
...
void OAICreateGroupData_request::fromJson(QString jsonString) {
...
void OAICreateGroupData_request::fromJsonObject(QJsonObject json) {
...
QString OAICreateGroupData_request::asJson() const {
...
QJsonObject OAICreateGroupData_request::asJsonObject() const {
    QJsonObject obj;
...
QString OAICreateGroupData_request::getCreatedAt() const {
    return m_created_at;
}
void OAICreateGroupData_request::setCreatedAt(const QString &created_at) {
    m_created_at = created_at;
    m_created_at_isSet = true;
}

bool OAICreateGroupData_request::is_created_at_Set() const{
    return m_created_at_isSet;
}

bool OAICreateGroupData_request::is_created_at_Valid() const{
    return m_created_at_isValid;
}

QList<OAICreateGroupData_request_feeds_inner> OAICreateGroupData_request::getFeeds() const {
    return m_feeds;
}
void OAICreateGroupData_request::setFeeds(const QList<OAICreateGroupData_request_feeds_inner> &feeds) {
    m_feeds = feeds;
    m_feeds_isSet = true;
}

bool OAICreateGroupData_request::is_feeds_Set() const{
    return m_feeds_isSet;
}

bool OAICreateGroupData_request::is_feeds_Valid() const{
    return m_feeds_isValid;
}

OAICreateGroupData_request_location OAICreateGroupData_request::getLocation() const {
    return m_location;
}
void OAICreateGroupData_request::setLocation(const OAICreateGroupData_request_location &location) {
    m_location = location;
    m_location_isSet = true;
}

bool OAICreateGroupData_request::is_location_Set() const{
    return m_location_isSet;
}

bool OAICreateGroupData_request::is_location_Valid() const{
    return m_location_isValid;
}

bool OAICreateGroupData_request::isSet() const {
...
bool OAICreateGroupData_request::isValid() const {
