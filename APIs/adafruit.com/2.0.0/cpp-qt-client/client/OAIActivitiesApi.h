...
public:
    ...
    */
    virtual void allActivities(const QString &username, const ::OpenAPI::OptionalParam<QDateTime> &start_time = ::OpenAPI::OptionalParam<QDateTime>(), const ::OpenAPI::OptionalParam<QDateTime> &end_time = ::OpenAPI::OptionalParam<QDateTime>(), const ::OpenAPI::OptionalParam<qint32> &limit = ::OpenAPI::OptionalParam<qint32>());

    /**
    * @param[in]  username QString [required]
    */
    virtual void destroyActivities(const QString &username);
    ...
    * @param[in]  limit qint32 [optional]
    */
    virtual void getActivity(const QString &username, const QString &type, const ::OpenAPI::OptionalParam<QDateTime> &start_time = ::OpenAPI::OptionalParam<QDateTime>(), const ::OpenAPI::OptionalParam<QDateTime> &end_time = ::OpenAPI::OptionalParam<QDateTime>(), const ::OpenAPI::OptionalParam<qint32> &limit = ::OpenAPI::OptionalParam<qint32>());
...
private:
    ...
    void allActivitiesCallback(OAIHttpRequestWorker *worker);
    void destroyActivitiesCallback(OAIHttpRequestWorker *worker);
    void getActivityCallback(OAIHttpRequestWorker *worker);

Q_SIGNALS:

    void allActivitiesSignal(QList<OAIActivity> summary);
    void destroyActivitiesSignal();
    void getActivitySignal(QList<OAIActivity> summary);


    void allActivitiesSignalFull(OAIHttpRequestWorker *worker, QList<OAIActivity> summary);
    void destroyActivitiesSignalFull(OAIHttpRequestWorker *worker);
    void getActivitySignalFull(OAIHttpRequestWorker *worker, QList<OAIActivity> summary);

    Q_DECL_DEPRECATED_X("Use allActivitiesSignalError() instead")
    void allActivitiesSignalE(QList<OAIActivity> summary, QNetworkReply::NetworkError error_type, QString error_str);
    void allActivitiesSignalError(QList<OAIActivity> summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use destroyActivitiesSignalError() instead")
    void destroyActivitiesSignalE(QNetworkReply::NetworkError error_type, QString error_str);
    void destroyActivitiesSignalError(QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use getActivitySignalError() instead")
    void getActivitySignalE(QList<OAIActivity> summary, QNetworkReply::NetworkError error_type, QString error_str);
    void getActivitySignalError(QList<OAIActivity> summary, QNetworkReply::NetworkError error_type, const QString &error_str);

    Q_DECL_DEPRECATED_X("Use allActivitiesSignalErrorFull() instead")
    void allActivitiesSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void allActivitiesSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use destroyActivitiesSignalErrorFull() instead")
    void destroyActivitiesSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void destroyActivitiesSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
