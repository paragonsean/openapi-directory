...
#ifndef OAIBlockFeed_H
#define OAIBlockFeed_H
...
class OAIBlockFeed : public OAIObject {
public:
    OAIBlockFeed();
    OAIBlockFeed(QString json);
    ~OAIBlockFeed() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBlockFeed)

#endif // OAIBlockFeed_H
