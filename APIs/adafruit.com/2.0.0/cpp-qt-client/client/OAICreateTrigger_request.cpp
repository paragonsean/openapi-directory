...
OAICreateTrigger_request::OAICreateTrigger_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateTrigger_request::OAICreateTrigger_request() {
    this->initializeModel();
}

OAICreateTrigger_request::~OAICreateTrigger_request() {}

void OAICreateTrigger_request::initializeModel() {

    m_name_isSet = false;
    m_name_isValid = false;
}

void OAICreateTrigger_request::fromJson(QString jsonString) {
...
void OAICreateTrigger_request::fromJsonObject(QJsonObject json) {

    m_name_isValid = ::OpenAPI::fromJsonValue(m_name, json[QString("name")]);
    m_name_isSet = !json[QString("name")].isNull() && m_name_isValid;
}

QString OAICreateTrigger_request::asJson() const {
...
QJsonObject OAICreateTrigger_request::asJsonObject() const {
    QJsonObject obj;
    if (m_name_isSet) {
...
QString OAICreateTrigger_request::getName() const {
    return m_name;
}
void OAICreateTrigger_request::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAICreateTrigger_request::is_name_Set() const{
    return m_name_isSet;
}

bool OAICreateTrigger_request::is_name_Valid() const{
    return m_name_isValid;
}

bool OAICreateTrigger_request::isSet() const {
...
bool OAICreateTrigger_request::isValid() const {
