...
public:
    ...
    */
    virtual void allDashboards(const QString &username);

    /**
    * @param[in]  username QString [required]
    * @param[in]  dashboard OAICreateDashboard_request [required]
    */
    virtual void createDashboard(const QString &username, const OAICreateDashboard_request &dashboard);

    /**
    * @param[in]  username QString [required]
    * @param[in]  id QString [required]
    */
    virtual void destroyDashboard(const QString &username, const QString &id);

    /**
    * @param[in]  username QString [required]
    * @param[in]  id QString [required]
    */
    virtual void getDashboard(const QString &username, const QString &id);
    ...
    * @param[in]  dashboard OAICreateDashboard_request [required]
    */
    virtual void replaceDashboard(const QString &username, const QString &id, const OAICreateDashboard_request &dashboard);
    ...
    * @param[in]  dashboard OAICreateDashboard_request [required]
    */
    virtual void updateDashboard(const QString &username, const QString &id, const OAICreateDashboard_request &dashboard);
...
private:
    ...
    void allDashboardsCallback(OAIHttpRequestWorker *worker);
    void createDashboardCallback(OAIHttpRequestWorker *worker);
    void destroyDashboardCallback(OAIHttpRequestWorker *worker);
    void getDashboardCallback(OAIHttpRequestWorker *worker);
    void replaceDashboardCallback(OAIHttpRequestWorker *worker);
    void updateDashboardCallback(OAIHttpRequestWorker *worker);

Q_SIGNALS:

    void allDashboardsSignal(QList<OAIDashboard> summary);
    void createDashboardSignal(OAIDashboard summary);
    void destroyDashboardSignal(QString summary);
    void getDashboardSignal(OAIDashboard summary);
    void replaceDashboardSignal(OAIDashboard summary);
    void updateDashboardSignal(OAIDashboard summary);


    void allDashboardsSignalFull(OAIHttpRequestWorker *worker, QList<OAIDashboard> summary);
    void createDashboardSignalFull(OAIHttpRequestWorker *worker, OAIDashboard summary);
    void destroyDashboardSignalFull(OAIHttpRequestWorker *worker, QString summary);
    void getDashboardSignalFull(OAIHttpRequestWorker *worker, OAIDashboard summary);
    void replaceDashboardSignalFull(OAIHttpRequestWorker *worker, OAIDashboard summary);
    void updateDashboardSignalFull(OAIHttpRequestWorker *worker, OAIDashboard summary);

    Q_DECL_DEPRECATED_X("Use allDashboardsSignalError() instead")
    void allDashboardsSignalE(QList<OAIDashboard> summary, QNetworkReply::NetworkError error_type, QString error_str);
    void allDashboardsSignalError(QList<OAIDashboard> summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use destroyDashboardSignalError() instead")
    void destroyDashboardSignalE(QString summary, QNetworkReply::NetworkError error_type, QString error_str);
    void destroyDashboardSignalError(QString summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use replaceDashboardSignalError() instead")
    void replaceDashboardSignalE(OAIDashboard summary, QNetworkReply::NetworkError error_type, QString error_str);
    void replaceDashboardSignalError(OAIDashboard summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use allDashboardsSignalErrorFull() instead")
    void allDashboardsSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void allDashboardsSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use destroyDashboardSignalErrorFull() instead")
    void destroyDashboardSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void destroyDashboardSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use replaceDashboardSignalErrorFull() instead")
    void replaceDashboardSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void replaceDashboardSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
