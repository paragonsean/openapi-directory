...
void OAIWebhooksApi::createRawWebhookFeedData() {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIWebhooksApi::createRawWebhookFeedDataCallback);
...
void OAIWebhooksApi::createRawWebhookFeedDataCallback(OAIHttpRequestWorker *worker) {
...
void OAIWebhooksApi::createWebhookFeedData(const OAICreateWebhookFeedData_request &payload) {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIWebhooksApi::createWebhookFeedDataCallback);
    connect(this, &OAIWebhooksApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIWebhooksApi::createWebhookFeedDataCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
