...
/*
 * OAICreateToken_request.h
 *
 * 
 */

#ifndef OAICreateToken_request_H
#define OAICreateToken_request_H
...
class OAICreateToken_request : public OAIObject {
public:
    OAICreateToken_request();
    OAICreateToken_request(QString json);
    ~OAICreateToken_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateToken_request)

#endif // OAICreateToken_request_H
