...
#include "OAIGetCurrentUserThrottle_200_response.h"
...
OAIGetCurrentUserThrottle_200_response::OAIGetCurrentUserThrottle_200_response(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetCurrentUserThrottle_200_response::OAIGetCurrentUserThrottle_200_response() {
    this->initializeModel();
}

OAIGetCurrentUserThrottle_200_response::~OAIGetCurrentUserThrottle_200_response() {}

void OAIGetCurrentUserThrottle_200_response::initializeModel() {

    m_active_data_rate_isSet = false;
    m_active_data_rate_isValid = false;

    m_data_rate_limit_isSet = false;
    m_data_rate_limit_isValid = false;
}

void OAIGetCurrentUserThrottle_200_response::fromJson(QString jsonString) {
...
void OAIGetCurrentUserThrottle_200_response::fromJsonObject(QJsonObject json) {

    m_active_data_rate_isValid = ::OpenAPI::fromJsonValue(m_active_data_rate, json[QString("active_data_rate")]);
    m_active_data_rate_isSet = !json[QString("active_data_rate")].isNull() && m_active_data_rate_isValid;

    m_data_rate_limit_isValid = ::OpenAPI::fromJsonValue(m_data_rate_limit, json[QString("data_rate_limit")]);
    m_data_rate_limit_isSet = !json[QString("data_rate_limit")].isNull() && m_data_rate_limit_isValid;
}

QString OAIGetCurrentUserThrottle_200_response::asJson() const {
...
QJsonObject OAIGetCurrentUserThrottle_200_response::asJsonObject() const {
    QJsonObject obj;
    if (m_active_data_rate_isSet) {
        obj.insert(QString("active_data_rate"), ::OpenAPI::toJsonValue(m_active_data_rate));
    }
    if (m_data_rate_limit_isSet) {
        obj.insert(QString("data_rate_limit"), ::OpenAPI::toJsonValue(m_data_rate_limit));
    }
    return obj;
}

qint32 OAIGetCurrentUserThrottle_200_response::getActiveDataRate() const {
    return m_active_data_rate;
}
void OAIGetCurrentUserThrottle_200_response::setActiveDataRate(const qint32 &active_data_rate) {
    m_active_data_rate = active_data_rate;
    m_active_data_rate_isSet = true;
}

bool OAIGetCurrentUserThrottle_200_response::is_active_data_rate_Set() const{
    return m_active_data_rate_isSet;
}

bool OAIGetCurrentUserThrottle_200_response::is_active_data_rate_Valid() const{
    return m_active_data_rate_isValid;
}

qint32 OAIGetCurrentUserThrottle_200_response::getDataRateLimit() const {
    return m_data_rate_limit;
}
void OAIGetCurrentUserThrottle_200_response::setDataRateLimit(const qint32 &data_rate_limit) {
    m_data_rate_limit = data_rate_limit;
    m_data_rate_limit_isSet = true;
}

bool OAIGetCurrentUserThrottle_200_response::is_data_rate_limit_Set() const{
    return m_data_rate_limit_isSet;
}

bool OAIGetCurrentUserThrottle_200_response::is_data_rate_limit_Valid() const{
    return m_data_rate_limit_isValid;
}

bool OAIGetCurrentUserThrottle_200_response::isSet() const {
...
bool OAIGetCurrentUserThrottle_200_response::isValid() const {
