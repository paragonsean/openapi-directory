...
QString OAICreateToken_request::getToken() const {
    return m_token;
}
void OAICreateToken_request::setToken(const QString &token) {
    m_token = token;
    m_token_isSet = true;
}

bool OAICreateToken_request::is_token_Set() const{
    return m_token_isSet;
}

bool OAICreateToken_request::is_token_Valid() const{
