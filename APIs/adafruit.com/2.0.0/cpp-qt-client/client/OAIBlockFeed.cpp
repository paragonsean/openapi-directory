...
OAIBlockFeed::OAIBlockFeed(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIBlockFeed::OAIBlockFeed() {
    this->initializeModel();
}

OAIBlockFeed::~OAIBlockFeed() {}

void OAIBlockFeed::initializeModel() {
...
void OAIBlockFeed::fromJson(QString jsonString) {
...
void OAIBlockFeed::fromJsonObject(QJsonObject json) {
...
QString OAIBlockFeed::asJson() const {
...
QJsonObject OAIBlockFeed::asJsonObject() const {
    QJsonObject obj;
    if (m_feed.isSet()) {
...
OAIFeed OAIBlockFeed::getFeed() const {
    return m_feed;
}
void OAIBlockFeed::setFeed(const OAIFeed &feed) {
    m_feed = feed;
    m_feed_isSet = true;
}

bool OAIBlockFeed::is_feed_Set() const{
    return m_feed_isSet;
}

bool OAIBlockFeed::is_feed_Valid() const{
    return m_feed_isValid;
}

OAIGroup OAIBlockFeed::getGroup() const {
    return m_group;
}
void OAIBlockFeed::setGroup(const OAIGroup &group) {
    m_group = group;
    m_group_isSet = true;
}

bool OAIBlockFeed::is_group_Set() const{
    return m_group_isSet;
}

bool OAIBlockFeed::is_group_Valid() const{
    return m_group_isValid;
}

QString OAIBlockFeed::getId() const {
    return m_id;
}
void OAIBlockFeed::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIBlockFeed::is_id_Set() const{
    return m_id_isSet;
}

bool OAIBlockFeed::is_id_Valid() const{
    return m_id_isValid;
}

bool OAIBlockFeed::isSet() const {
...
bool OAIBlockFeed::isValid() const {
