...
public:
    ...
    double getCreatedEpoch() const;
    void setCreatedEpoch(const double &created_epoch);
    bool is_created_epoch_Set() const;
    bool is_created_epoch_Valid() const;

    double getEle() const;
    void setEle(const double &ele);
    bool is_ele_Set() const;
    bool is_ele_Valid() const;
    ...
    double getFeedId() const;
    void setFeedId(const double &feed_id);
...
private:
    ...
    double m_created_epoch;
    bool m_created_epoch_isSet;
    bool m_created_epoch_isValid;
