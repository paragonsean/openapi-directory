...
/*
 * OAIFeed_details_data.h
 *
 * 
 */

#ifndef OAIFeed_details_data_H
#define OAIFeed_details_data_H
...
class OAIFeed_details_data : public OAIObject {
public:
    OAIFeed_details_data();
    OAIFeed_details_data(QString json);
    ~OAIFeed_details_data() override;
    ...
    QMap<QString, OAIData> getFirst() const;
    void setFirst(const QMap<QString, OAIData> &first);
    bool is_first_Set() const;
    bool is_first_Valid() const;

    QMap<QString, OAIData> getLast() const;
    void setLast(const QMap<QString, OAIData> &last);
...
private:
    ...
    QMap<QString, OAIData> m_first;
    bool m_first_isSet;
    bool m_first_isValid;

    QMap<QString, OAIData> m_last;
    bool m_last_isSet;
    bool m_last_isValid;
};
...
Q_DECLARE_METATYPE(OpenAPI::OAIFeed_details_data)

#endif // OAIFeed_details_data_H
