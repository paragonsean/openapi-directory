...
/*
 * OAICreateGroupData_request.h
 *
 * 
 */

#ifndef OAICreateGroupData_request_H
#define OAICreateGroupData_request_H
...
namespace OpenAPI {
class OAICreateGroupData_request_feeds_inner;
class OAICreateGroupData_request_location;

class OAICreateGroupData_request : public OAIObject {
public:
    OAICreateGroupData_request();
    OAICreateGroupData_request(QString json);
    ~OAICreateGroupData_request() override;
    ...
    QList<OAICreateGroupData_request_feeds_inner> getFeeds() const;
    void setFeeds(const QList<OAICreateGroupData_request_feeds_inner> &feeds);
    bool is_feeds_Set() const;
    bool is_feeds_Valid() const;

    OAICreateGroupData_request_location getLocation() const;
    void setLocation(const OAICreateGroupData_request_location &location);
...
private:
    ...
    QList<OAICreateGroupData_request_feeds_inner> m_feeds;
    bool m_feeds_isSet;
    bool m_feeds_isValid;

    OAICreateGroupData_request_location m_location;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateGroupData_request)

#endif // OAICreateGroupData_request_H
