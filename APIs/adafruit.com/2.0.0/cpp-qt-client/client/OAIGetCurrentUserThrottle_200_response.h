...
/*
 * OAIGetCurrentUserThrottle_200_response.h
 *
 * 
 */

#ifndef OAIGetCurrentUserThrottle_200_response_H
#define OAIGetCurrentUserThrottle_200_response_H
...
class OAIGetCurrentUserThrottle_200_response : public OAIObject {
public:
    OAIGetCurrentUserThrottle_200_response();
    OAIGetCurrentUserThrottle_200_response(QString json);
    ~OAIGetCurrentUserThrottle_200_response() override;
    ...
    qint32 getActiveDataRate() const;
    void setActiveDataRate(const qint32 &active_data_rate);
    bool is_active_data_rate_Set() const;
    bool is_active_data_rate_Valid() const;

    qint32 getDataRateLimit() const;
    void setDataRateLimit(const qint32 &data_rate_limit);
    bool is_data_rate_limit_Set() const;
    bool is_data_rate_limit_Valid() const;
...
private:
    ...
    qint32 m_active_data_rate;
    bool m_active_data_rate_isSet;
    bool m_active_data_rate_isValid;

    qint32 m_data_rate_limit;
    bool m_data_rate_limit_isSet;
    bool m_data_rate_limit_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIGetCurrentUserThrottle_200_response)

#endif // OAIGetCurrentUserThrottle_200_response_H
