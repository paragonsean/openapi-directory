...
QString OAICreateDashboard_request::getDescription() const {
    return m_description;
}
void OAICreateDashboard_request::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAICreateDashboard_request::is_description_Set() const{
    return m_description_isSet;
}

bool OAICreateDashboard_request::is_description_Valid() const{
    return m_description_isValid;
}

QString OAICreateDashboard_request::getKey() const {
    return m_key;
}
void OAICreateDashboard_request::setKey(const QString &key) {
    m_key = key;
    m_key_isSet = true;
}

bool OAICreateDashboard_request::is_key_Set() const{
    return m_key_isSet;
}

bool OAICreateDashboard_request::is_key_Valid() const{
    return m_key_isValid;
}

QString OAICreateDashboard_request::getName() const {
    return m_name;
}
void OAICreateDashboard_request::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAICreateDashboard_request::is_name_Set() const{
    return m_name_isSet;
}

bool OAICreateDashboard_request::is_name_Valid() const{
