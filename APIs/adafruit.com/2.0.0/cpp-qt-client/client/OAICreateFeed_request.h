...
/*
 * OAICreateFeed_request.h
 *
 * 
 */

#ifndef OAICreateFeed_request_H
#define OAICreateFeed_request_H
...
class OAICreateFeed_request : public OAIObject {
public:
    OAICreateFeed_request();
    OAICreateFeed_request(QString json);
    ~OAICreateFeed_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateFeed_request)

#endif // OAICreateFeed_request_H
