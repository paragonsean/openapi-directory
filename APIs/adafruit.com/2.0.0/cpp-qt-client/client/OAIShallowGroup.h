...
#ifndef OAIShallowGroup_H
#define OAIShallowGroup_H
...
class OAIShallowGroup : public OAIObject {
public:
    OAIShallowGroup();
    OAIShallowGroup(QString json);
    ~OAIShallowGroup() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIShallowGroup)

#endif // OAIShallowGroup_H
