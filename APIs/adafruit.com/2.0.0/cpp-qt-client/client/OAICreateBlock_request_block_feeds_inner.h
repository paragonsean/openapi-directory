...
/*
 * OAICreateBlock_request_block_feeds_inner.h
 *
 * 
 */

#ifndef OAICreateBlock_request_block_feeds_inner_H
#define OAICreateBlock_request_block_feeds_inner_H
...
class OAICreateBlock_request_block_feeds_inner : public OAIObject {
public:
    OAICreateBlock_request_block_feeds_inner();
    OAICreateBlock_request_block_feeds_inner(QString json);
    ~OAICreateBlock_request_block_feeds_inner() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateBlock_request_block_feeds_inner)

#endif // OAICreateBlock_request_block_feeds_inner_H
