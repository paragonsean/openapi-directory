...
#ifndef OAIFeed_details_H
#define OAIFeed_details_H
...
namespace OpenAPI {
class OAIFeed_details_data;

class OAIFeed_details : public OAIObject {
public:
    OAIFeed_details();
    OAIFeed_details(QString json);
    ~OAIFeed_details() override;
    ...
    OAIFeed_details_data getData() const;
    void setData(const OAIFeed_details_data &data);
    bool is_data_Set() const;
    bool is_data_Valid() const;

    QList<OAIObject> getSharedWith() const;
    void setSharedWith(const QList<OAIObject> &shared_with);
...
private:
    ...
    OAIFeed_details_data m_data;
    bool m_data_isSet;
    bool m_data_isValid;

    QList<OAIObject> m_shared_with;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFeed_details)

#endif // OAIFeed_details_H
