...
#include "OAICreateGroupData_request_feeds_inner.h"
...
OAICreateGroupData_request_feeds_inner::OAICreateGroupData_request_feeds_inner(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateGroupData_request_feeds_inner::OAICreateGroupData_request_feeds_inner() {
    this->initializeModel();
}

OAICreateGroupData_request_feeds_inner::~OAICreateGroupData_request_feeds_inner() {}

void OAICreateGroupData_request_feeds_inner::initializeModel() {
...
void OAICreateGroupData_request_feeds_inner::fromJson(QString jsonString) {
...
void OAICreateGroupData_request_feeds_inner::fromJsonObject(QJsonObject json) {
...
QString OAICreateGroupData_request_feeds_inner::asJson() const {
...
QJsonObject OAICreateGroupData_request_feeds_inner::asJsonObject() const {
    QJsonObject obj;
    if (m_key_isSet) {
...
QString OAICreateGroupData_request_feeds_inner::getKey() const {
    return m_key;
}
void OAICreateGroupData_request_feeds_inner::setKey(const QString &key) {
    m_key = key;
    m_key_isSet = true;
}

bool OAICreateGroupData_request_feeds_inner::is_key_Set() const{
    return m_key_isSet;
}

bool OAICreateGroupData_request_feeds_inner::is_key_Valid() const{
    return m_key_isValid;
}

QString OAICreateGroupData_request_feeds_inner::getValue() const {
    return m_value;
}
void OAICreateGroupData_request_feeds_inner::setValue(const QString &value) {
    m_value = value;
    m_value_isSet = true;
}

bool OAICreateGroupData_request_feeds_inner::is_value_Set() const{
    return m_value_isSet;
}

bool OAICreateGroupData_request_feeds_inner::is_value_Valid() const{
    return m_value_isValid;
}

bool OAICreateGroupData_request_feeds_inner::isSet() const {
...
bool OAICreateGroupData_request_feeds_inner::isValid() const {
