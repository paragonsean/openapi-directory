...
public:
    ...
    */
    virtual void getCurrentUserThrottle(const QString &username);
...
private:
    ...
    void getCurrentUserThrottleCallback(OAIHttpRequestWorker *worker);

Q_SIGNALS:

    void currentUserSignal(OAIUser summary);
    void getCurrentUserThrottleSignal(OAIGetCurrentUserThrottle_200_response summary);


    void currentUserSignalFull(OAIHttpRequestWorker *worker, OAIUser summary);
    void getCurrentUserThrottleSignalFull(OAIHttpRequestWorker *worker, OAIGetCurrentUserThrottle_200_response summary);

    Q_DECL_DEPRECATED_X("Use currentUserSignalError() instead")
    void currentUserSignalE(OAIUser summary, QNetworkReply::NetworkError error_type, QString error_str);
    void currentUserSignalError(OAIUser summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use getCurrentUserThrottleSignalError() instead")
    void getCurrentUserThrottleSignalE(OAIGetCurrentUserThrottle_200_response summary, QNetworkReply::NetworkError error_type, QString error_str);
    void getCurrentUserThrottleSignalError(OAIGetCurrentUserThrottle_200_response summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use getCurrentUserThrottleSignalErrorFull() instead")
    void getCurrentUserThrottleSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void getCurrentUserThrottleSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
