...
QString OAIData::getCompletedAt() const {
    return m_completed_at;
}
void OAIData::setCompletedAt(const QString &completed_at) {
    m_completed_at = completed_at;
    m_completed_at_isSet = true;
}

bool OAIData::is_completed_at_Set() const{
    return m_completed_at_isSet;
}

bool OAIData::is_completed_at_Valid() const{
    return m_completed_at_isValid;
}

QString OAIData::getCreatedAt() const {
    return m_created_at;
}
void OAIData::setCreatedAt(const QString &created_at) {
    m_created_at = created_at;
    m_created_at_isSet = true;
}

bool OAIData::is_created_at_Set() const{
    return m_created_at_isSet;
}

bool OAIData::is_created_at_Valid() const{
    return m_created_at_isValid;
}

double OAIData::getCreatedEpoch() const {
    return m_created_epoch;
}
void OAIData::setCreatedEpoch(const double &created_epoch) {
    m_created_epoch = created_epoch;
    m_created_epoch_isSet = true;
}

bool OAIData::is_created_epoch_Set() const{
    return m_created_epoch_isSet;
}

bool OAIData::is_created_epoch_Valid() const{
    return m_created_epoch_isValid;
}

double OAIData::getEle() const {
    return m_ele;
}
void OAIData::setEle(const double &ele) {
    m_ele = ele;
    m_ele_isSet = true;
}

bool OAIData::is_ele_Set() const{
    return m_ele_isSet;
}

bool OAIData::is_ele_Valid() const{
    return m_ele_isValid;
}

QString OAIData::getExpiration() const {
    return m_expiration;
}
void OAIData::setExpiration(const QString &expiration) {
    m_expiration = expiration;
    m_expiration_isSet = true;
}

bool OAIData::is_expiration_Set() const{
    return m_expiration_isSet;
}

bool OAIData::is_expiration_Valid() const{
    return m_expiration_isValid;
}

double OAIData::getFeedId() const {
    return m_feed_id;
}
void OAIData::setFeedId(const double &feed_id) {
    m_feed_id = feed_id;
    m_feed_id_isSet = true;
}

bool OAIData::is_feed_id_Set() const{
    return m_feed_id_isSet;
}

bool OAIData::is_feed_id_Valid() const{
    return m_feed_id_isValid;
}

double OAIData::getGroupId() const {
    return m_group_id;
}
void OAIData::setGroupId(const double &group_id) {
    m_group_id = group_id;
    m_group_id_isSet = true;
}

bool OAIData::is_group_id_Set() const{
    return m_group_id_isSet;
}

bool OAIData::is_group_id_Valid() const{
...
double OAIData::getLat() const {
    return m_lat;
}
void OAIData::setLat(const double &lat) {
    m_lat = lat;
    m_lat_isSet = true;
}

bool OAIData::is_lat_Set() const{
    return m_lat_isSet;
}

bool OAIData::is_lat_Valid() const{
    return m_lat_isValid;
}

double OAIData::getLon() const {
    return m_lon;
}
void OAIData::setLon(const double &lon) {
    m_lon = lon;
    m_lon_isSet = true;
}

bool OAIData::is_lon_Set() const{
    return m_lon_isSet;
}

bool OAIData::is_lon_Valid() const{
    return m_lon_isValid;
}

QString OAIData::getUpdatedAt() const {
    return m_updated_at;
}
void OAIData::setUpdatedAt(const QString &updated_at) {
    m_updated_at = updated_at;
    m_updated_at_isSet = true;
}

bool OAIData::is_updated_at_Set() const{
    return m_updated_at_isSet;
}

bool OAIData::is_updated_at_Valid() const{
    return m_updated_at_isValid;
}

QString OAIData::getValue() const {
    return m_value;
}
void OAIData::setValue(const QString &value) {
    m_value = value;
    m_value_isSet = true;
}

bool OAIData::is_value_Set() const{
    return m_value_isSet;
}

bool OAIData::is_value_Valid() const{
