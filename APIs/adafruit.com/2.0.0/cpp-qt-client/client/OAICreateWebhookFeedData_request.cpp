...
OAICreateWebhookFeedData_request::OAICreateWebhookFeedData_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateWebhookFeedData_request::OAICreateWebhookFeedData_request() {
    this->initializeModel();
}

OAICreateWebhookFeedData_request::~OAICreateWebhookFeedData_request() {}

void OAICreateWebhookFeedData_request::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
}

void OAICreateWebhookFeedData_request::fromJson(QString jsonString) {
...
void OAICreateWebhookFeedData_request::fromJsonObject(QJsonObject json) {

    m_value_isValid = ::OpenAPI::fromJsonValue(m_value, json[QString("value")]);
    m_value_isSet = !json[QString("value")].isNull() && m_value_isValid;
}

QString OAICreateWebhookFeedData_request::asJson() const {
...
QJsonObject OAICreateWebhookFeedData_request::asJsonObject() const {
    QJsonObject obj;
    if (m_value_isSet) {
...
QString OAICreateWebhookFeedData_request::getValue() const {
    return m_value;
}
void OAICreateWebhookFeedData_request::setValue(const QString &value) {
    m_value = value;
    m_value_isSet = true;
}

bool OAICreateWebhookFeedData_request::is_value_Set() const{
    return m_value_isSet;
}

bool OAICreateWebhookFeedData_request::is_value_Valid() const{
    return m_value_isValid;
}

bool OAICreateWebhookFeedData_request::isSet() const {
...
bool OAICreateWebhookFeedData_request::isValid() const {
