...
/*
 * OAICreateBlock_request.h
 *
 * 
 */

#ifndef OAICreateBlock_request_H
#define OAICreateBlock_request_H

#include <QJsonObject>

#include "OAICreateBlock_request_block_feeds_inner.h"
#include "OAIObject.h"
#include <QList>
#include <QString>
...
namespace OpenAPI {
class OAICreateBlock_request_block_feeds_inner;

class OAICreateBlock_request : public OAIObject {
public:
    OAICreateBlock_request();
    OAICreateBlock_request(QString json);
    ~OAICreateBlock_request() override;
    ...
    QList<OAICreateBlock_request_block_feeds_inner> getBlockFeeds() const;
    void setBlockFeeds(const QList<OAICreateBlock_request_block_feeds_inner> &block_feeds);
    bool is_block_feeds_Set() const;
    bool is_block_feeds_Valid() const;

    double getColumn() const;
    void setColumn(const double &column);
    bool is_column_Set() const;
    bool is_column_Valid() const;

    double getDashboardId() const;
    void setDashboardId(const double &dashboard_id);
    ...
    void setSizeX(const double &size_x);
    bool is_size_x_Set() const;
    bool is_size_x_Valid() const;

    double getSizeY() const;
    void setSizeY(const double &size_y);
    bool is_size_y_Set() const;
    bool is_size_y_Valid() const;

    QString getVisualType() const;
    void setVisualType(const QString &visual_type);
    bool is_visual_type_Set() const;
    bool is_visual_type_Valid() const;
...
private:
    ...
    QList<OAICreateBlock_request_block_feeds_inner> m_block_feeds;
    bool m_block_feeds_isSet;
    bool m_block_feeds_isValid;

    double m_column;
    bool m_column_isSet;
    bool m_column_isValid;

    double m_dashboard_id;
    ...
    double m_size_x;
    bool m_size_x_isSet;
    bool m_size_x_isValid;

    double m_size_y;
    bool m_size_y_isSet;
    bool m_size_y_isValid;

    QString m_visual_type;
    bool m_visual_type_isSet;
    bool m_visual_type_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAICreateBlock_request)

#endif // OAICreateBlock_request_H
