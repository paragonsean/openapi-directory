...
/*
 * OAIChartData_200_response.h
 *
 * 
 */

#ifndef OAIChartData_200_response_H
#define OAIChartData_200_response_H
...
namespace OpenAPI {
class OAIChartData_200_response_feed;

class OAIChartData_200_response : public OAIObject {
public:
    OAIChartData_200_response();
    OAIChartData_200_response(QString json);
    ~OAIChartData_200_response() override;
    ...
    OAIChartData_200_response_feed getFeed() const;
    void setFeed(const OAIChartData_200_response_feed &feed);
...
private:
    ...
    OAIChartData_200_response_feed m_feed;
    bool m_feed_isSet;
    bool m_feed_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIChartData_200_response)

#endif // OAIChartData_200_response_H
