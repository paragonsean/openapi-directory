...
OAICreateBlock_request_block_feeds_inner::OAICreateBlock_request_block_feeds_inner(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateBlock_request_block_feeds_inner::OAICreateBlock_request_block_feeds_inner() {
    this->initializeModel();
}

OAICreateBlock_request_block_feeds_inner::~OAICreateBlock_request_block_feeds_inner() {}

void OAICreateBlock_request_block_feeds_inner::initializeModel() {
...
void OAICreateBlock_request_block_feeds_inner::fromJson(QString jsonString) {
...
void OAICreateBlock_request_block_feeds_inner::fromJsonObject(QJsonObject json) {
...
QString OAICreateBlock_request_block_feeds_inner::asJson() const {
...
QJsonObject OAICreateBlock_request_block_feeds_inner::asJsonObject() const {
    QJsonObject obj;
    if (m_feed_id_isSet) {
...
QString OAICreateBlock_request_block_feeds_inner::getFeedId() const {
    return m_feed_id;
}
void OAICreateBlock_request_block_feeds_inner::setFeedId(const QString &feed_id) {
    m_feed_id = feed_id;
    m_feed_id_isSet = true;
}

bool OAICreateBlock_request_block_feeds_inner::is_feed_id_Set() const{
    return m_feed_id_isSet;
}

bool OAICreateBlock_request_block_feeds_inner::is_feed_id_Valid() const{
    return m_feed_id_isValid;
}

QString OAICreateBlock_request_block_feeds_inner::getGroupId() const {
    return m_group_id;
}
void OAICreateBlock_request_block_feeds_inner::setGroupId(const QString &group_id) {
    m_group_id = group_id;
    m_group_id_isSet = true;
}

bool OAICreateBlock_request_block_feeds_inner::is_group_id_Set() const{
    return m_group_id_isSet;
}

bool OAICreateBlock_request_block_feeds_inner::is_group_id_Valid() const{
    return m_group_id_isValid;
}

bool OAICreateBlock_request_block_feeds_inner::isSet() const {
...
bool OAICreateBlock_request_block_feeds_inner::isValid() const {
