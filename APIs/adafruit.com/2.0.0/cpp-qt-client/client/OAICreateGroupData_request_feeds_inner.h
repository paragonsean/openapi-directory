...
/*
 * OAICreateGroupData_request_feeds_inner.h
 *
 * 
 */

#ifndef OAICreateGroupData_request_feeds_inner_H
#define OAICreateGroupData_request_feeds_inner_H
...
class OAICreateGroupData_request_feeds_inner : public OAIObject {
public:
    OAICreateGroupData_request_feeds_inner();
    OAICreateGroupData_request_feeds_inner(QString json);
    ~OAICreateGroupData_request_feeds_inner() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateGroupData_request_feeds_inner)

#endif // OAICreateGroupData_request_feeds_inner_H
