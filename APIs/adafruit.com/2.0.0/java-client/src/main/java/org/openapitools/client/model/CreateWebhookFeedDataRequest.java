...
public class CreateWebhookFeedDataRequest {
  public static final String SERIALIZED_NAME_VALUE = "value";
  @SerializedName(SERIALIZED_NAME_VALUE)
  private String value;

  public CreateWebhookFeedDataRequest() {
  }

  public CreateWebhookFeedDataRequest value(String value) {
    this.value = value;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    CreateWebhookFeedDataRequest createWebhookFeedDataRequest = (CreateWebhookFeedDataRequest) o;
    return Objects.equals(this.value, createWebhookFeedDataRequest.value);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateWebhookFeedDataRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateWebhookFeedDataRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateWebhookFeedDataRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateWebhookFeedDataRequest is not found in the empty JSON string", CreateWebhookFeedDataRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateWebhookFeedDataRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateWebhookFeedDataRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateWebhookFeedDataRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateWebhookFeedDataRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateWebhookFeedDataRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateWebhookFeedDataRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateWebhookFeedDataRequest>() {
           @Override
           public void write(JsonWriter out, CreateWebhookFeedDataRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateWebhookFeedDataRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateWebhookFeedDataRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateWebhookFeedDataRequest
   * @throws IOException if the JSON string is invalid with respect to CreateWebhookFeedDataRequest
   */
  public static CreateWebhookFeedDataRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateWebhookFeedDataRequest.class);
  }

  /**
   * Convert an instance of CreateWebhookFeedDataRequest to an JSON string
   *
   * @return JSON string
   */
