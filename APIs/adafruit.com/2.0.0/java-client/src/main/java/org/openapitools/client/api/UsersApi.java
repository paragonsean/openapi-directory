...
import org.openapitools.client.model.GetCurrentUserThrottle200Response;
...
public class UsersApi {
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        ...
        <tr><td> 200 </td><td> A User record </td><td>  -  </td></tr>
    ...
    public User currentUser() throws ApiException {
        ApiResponse<User> localVarResp = currentUserWithHttpInfo();
     ...
     */
    public okhttp3.Call currentUserAsync(final ApiCallback<User> _callback) throws ApiException {
    ...
    /**
     * Build call for getCurrentUserThrottle
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> Data rate limit and current actions. </td><td>  -  </td></tr>
        <tr><td> 401 </td><td> Unauthorized </td><td>  -  </td></tr>
        <tr><td> 403 </td><td> Forbidden </td><td>  -  </td></tr>
        <tr><td> 404 </td><td> Not Found </td><td>  -  </td></tr>
        <tr><td> 500 </td><td> Server Error </td><td>  -  </td></tr>
     ...
     */
    public okhttp3.Call getCurrentUserThrottleCall(String username, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/{username}/throttle"
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getCurrentUserThrottleValidateBeforeCall(String username, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'username' is set
        if (username == null) {
            throw new ApiException("Missing the required parameter 'username' when calling getCurrentUserThrottle(Async)");
        }

        return getCurrentUserThrottleCall(username, _callback);
     ...
     * 
     * @param username a valid username string (required)
     * @return GetCurrentUserThrottle200Response
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public GetCurrentUserThrottle200Response getCurrentUserThrottle(String username) throws ApiException {
        ApiResponse<GetCurrentUserThrottle200Response> localVarResp = getCurrentUserThrottleWithHttpInfo(username);
        return localVarResp.getData();
    }
     ...
     * 
     * @param username a valid username string (required)
     * @return ApiResponse&lt;GetCurrentUserThrottle200Response&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<GetCurrentUserThrottle200Response> getCurrentUserThrottleWithHttpInfo(String username) throws ApiException {
        okhttp3.Call localVarCall = getCurrentUserThrottleValidateBeforeCall(username, null);
        Type localVarReturnType = new TypeToken<GetCurrentUserThrottle200Response>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Get the user&#39;s data rate limit and current activity level. (asynchronously)
     * 
     * @param username a valid username string (required)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
     ...
     */
    public okhttp3.Call getCurrentUserThrottleAsync(String username, final ApiCallback<GetCurrentUserThrottle200Response> _callback) throws ApiException {

        okhttp3.Call localVarCall = getCurrentUserThrottleValidateBeforeCall(username, _callback);
        Type localVarReturnType = new TypeToken<GetCurrentUserThrottle200Response>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
