...
public class CreateDataRequest {
  ...
  public CreateDataRequest createdAt(String createdAt) {
  ...
  public CreateDataRequest ele(String ele) {
    this.ele = ele;
    return this;
  }
  ...
  public CreateDataRequest epoch(BigDecimal epoch) {
    this.epoch = epoch;
    return this;
  }
  ...
  public CreateDataRequest lat(String lat) {
    this.lat = lat;
    return this;
  }
  ...
  public CreateDataRequest lon(String lon) {
    this.lon = lon;
    return this;
  }
  ...
  public CreateDataRequest value(String value) {
    this.value = value;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    CreateDataRequest createDataRequest = (CreateDataRequest) o;
    return Objects.equals(this.createdAt, createDataRequest.createdAt) &&
        Objects.equals(this.ele, createDataRequest.ele) &&
        Objects.equals(this.epoch, createDataRequest.epoch) &&
        Objects.equals(this.lat, createDataRequest.lat) &&
        Objects.equals(this.lon, createDataRequest.lon) &&
        Objects.equals(this.value, createDataRequest.value);
  }

  @Override
  public int hashCode() {
    return Objects.hash(createdAt, ele, epoch, lat, lon, value);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CreateDataRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateDataRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateDataRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateDataRequest is not found in the empty JSON string", CreateDataRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateDataRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateDataRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if ((jsonObj.get("ele") != null && !jsonObj.get("ele").isJsonNull()) && !jsonObj.get("ele").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `ele` to be a primitive type in the JSON string but got `%s`", jsonObj.get("ele").toString()));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateDataRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateDataRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateDataRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateDataRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateDataRequest>() {
           @Override
           public void write(JsonWriter out, CreateDataRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateDataRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateDataRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateDataRequest
   * @throws IOException if the JSON string is invalid with respect to CreateDataRequest
   */
  public static CreateDataRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateDataRequest.class);
  }

  /**
   * Convert an instance of CreateDataRequest to an JSON string
   *
   * @return JSON string
   */
