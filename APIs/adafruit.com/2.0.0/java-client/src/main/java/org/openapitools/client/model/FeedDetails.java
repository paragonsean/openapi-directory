...
public class FeedDetails {
  ...
  private FeedDetailsData data;

  public static final String SERIALIZED_NAME_SHARED_WITH = "shared_with";
  @SerializedName(SERIALIZED_NAME_SHARED_WITH)
  private List<Object> sharedWith = new ArrayList<>();

  public FeedDetails() {
  }

  public FeedDetails data(FeedDetailsData data) {
    this.data = data;
    return this;
  }
  ...
  public FeedDetailsData getData() {
    return data;
  }

  public void setData(FeedDetailsData data) {
    this.data = data;
  }


  public FeedDetails sharedWith(List<Object> sharedWith) {
    this.sharedWith = sharedWith;
    return this;
  }

  public FeedDetails addSharedWithItem(Object sharedWithItem) {
  ...
  public boolean equals(Object o) {
    ...
    FeedDetails feedDetails = (FeedDetails) o;
    return Objects.equals(this.data, feedDetails.data) &&
        Objects.equals(this.sharedWith, feedDetails.sharedWith);
  }

  @Override
  public int hashCode() {
    return Objects.hash(data, sharedWith);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class FeedDetails {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to FeedDetails
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!FeedDetails.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FeedDetails is not found in the empty JSON string", FeedDetails.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!FeedDetails.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `FeedDetails` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `data`
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        FeedDetailsData.validateJsonElement(jsonObj.get("data"));
      }
      // ensure the optional json data is an array if present
      if (jsonObj.get("shared_with") != null && !jsonObj.get("shared_with").isJsonNull() && !jsonObj.get("shared_with").isJsonArray()) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FeedDetails.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FeedDetails' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FeedDetails> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FeedDetails.class));

       return (TypeAdapter<T>) new TypeAdapter<FeedDetails>() {
           @Override
           public void write(JsonWriter out, FeedDetails value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public FeedDetails read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of FeedDetails given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of FeedDetails
   * @throws IOException if the JSON string is invalid with respect to FeedDetails
   */
  public static FeedDetails fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FeedDetails.class);
  }

  /**
   * Convert an instance of FeedDetails to an JSON string
   *
   * @return JSON string
   */
