...
public class ShallowGroup {
  ...
  public ShallowGroup description(String description) {
  ...
  public ShallowGroup name(String name) {
    this.name = name;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    ShallowGroup shallowGroup = (ShallowGroup) o;
    return Objects.equals(this.createdAt, shallowGroup.createdAt) &&
        Objects.equals(this.description, shallowGroup.description) &&
        Objects.equals(this.id, shallowGroup.id) &&
        Objects.equals(this.name, shallowGroup.name) &&
        Objects.equals(this.updatedAt, shallowGroup.updatedAt);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ShallowGroup
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ShallowGroup.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ShallowGroup is not found in the empty JSON string", ShallowGroup.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ShallowGroup.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ShallowGroup` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ShallowGroup.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ShallowGroup' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ShallowGroup> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ShallowGroup.class));

       return (TypeAdapter<T>) new TypeAdapter<ShallowGroup>() {
           @Override
           public void write(JsonWriter out, ShallowGroup value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ShallowGroup read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ShallowGroup given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ShallowGroup
   * @throws IOException if the JSON string is invalid with respect to ShallowGroup
   */
  public static ShallowGroup fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ShallowGroup.class);
  }

  /**
   * Convert an instance of ShallowGroup to an JSON string
   *
   * @return JSON string
   */
