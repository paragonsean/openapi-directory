...
public class ApiClient {
    ...
    private String basePath = "https://io.adafruit.com/api/v2";
    ...
    public ApiClient() {
        ...
        authentications.put("HeaderKey", new ApiKeyAuth("header", "X-AIO-Key"));
        authentications.put("HeaderSignature", new ApiKeyAuth("header", "X-AIO-Signature"));
        authentications.put("QueryKey", new ApiKeyAuth("query", "X-AIO-Key"));
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://io.adafruit.com/api/v2
