...
public class ChartData200ResponseFeed {
  ...
  public ChartData200ResponseFeed() {
  }

  public ChartData200ResponseFeed id(Integer id) {
    this.id = id;
    return this;
  }
  ...
  public ChartData200ResponseFeed key(String key) {
    this.key = key;
    return this;
  }
  ...
  public ChartData200ResponseFeed name(String name) {
    this.name = name;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    ChartData200ResponseFeed chartData200ResponseFeed = (ChartData200ResponseFeed) o;
    return Objects.equals(this.id, chartData200ResponseFeed.id) &&
        Objects.equals(this.key, chartData200ResponseFeed.key) &&
        Objects.equals(this.name, chartData200ResponseFeed.name);
  }
  ...
  public String toString() {
    ...
    sb.append("class ChartData200ResponseFeed {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ChartData200ResponseFeed
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ChartData200ResponseFeed.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ChartData200ResponseFeed is not found in the empty JSON string", ChartData200ResponseFeed.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ChartData200ResponseFeed.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ChartData200ResponseFeed` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ChartData200ResponseFeed.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ChartData200ResponseFeed' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ChartData200ResponseFeed> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ChartData200ResponseFeed.class));

       return (TypeAdapter<T>) new TypeAdapter<ChartData200ResponseFeed>() {
           @Override
           public void write(JsonWriter out, ChartData200ResponseFeed value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ChartData200ResponseFeed read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ChartData200ResponseFeed given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ChartData200ResponseFeed
   * @throws IOException if the JSON string is invalid with respect to ChartData200ResponseFeed
   */
  public static ChartData200ResponseFeed fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ChartData200ResponseFeed.class);
  }

  /**
   * Convert an instance of ChartData200ResponseFeed to an JSON string
   *
   * @return JSON string
   */
