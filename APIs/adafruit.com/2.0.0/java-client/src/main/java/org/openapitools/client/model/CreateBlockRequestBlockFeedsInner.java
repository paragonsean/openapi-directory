...
public class CreateBlockRequestBlockFeedsInner {
  ...
  public CreateBlockRequestBlockFeedsInner() {
  }

  public CreateBlockRequestBlockFeedsInner feedId(String feedId) {
    this.feedId = feedId;
    return this;
  }
  ...
  public CreateBlockRequestBlockFeedsInner groupId(String groupId) {
  ...
  public boolean equals(Object o) {
    ...
    CreateBlockRequestBlockFeedsInner createBlockRequestBlockFeedsInner = (CreateBlockRequestBlockFeedsInner) o;
    return Objects.equals(this.feedId, createBlockRequestBlockFeedsInner.feedId) &&
        Objects.equals(this.groupId, createBlockRequestBlockFeedsInner.groupId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(feedId, groupId);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CreateBlockRequestBlockFeedsInner {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateBlockRequestBlockFeedsInner
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateBlockRequestBlockFeedsInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateBlockRequestBlockFeedsInner is not found in the empty JSON string", CreateBlockRequestBlockFeedsInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateBlockRequestBlockFeedsInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateBlockRequestBlockFeedsInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateBlockRequestBlockFeedsInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateBlockRequestBlockFeedsInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateBlockRequestBlockFeedsInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateBlockRequestBlockFeedsInner.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateBlockRequestBlockFeedsInner>() {
           @Override
           public void write(JsonWriter out, CreateBlockRequestBlockFeedsInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateBlockRequestBlockFeedsInner read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateBlockRequestBlockFeedsInner given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateBlockRequestBlockFeedsInner
   * @throws IOException if the JSON string is invalid with respect to CreateBlockRequestBlockFeedsInner
   */
  public static CreateBlockRequestBlockFeedsInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateBlockRequestBlockFeedsInner.class);
  }

  /**
   * Convert an instance of CreateBlockRequestBlockFeedsInner to an JSON string
   *
   * @return JSON string
   */
