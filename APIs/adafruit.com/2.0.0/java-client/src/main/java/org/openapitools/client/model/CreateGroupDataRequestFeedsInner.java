...
public class CreateGroupDataRequestFeedsInner {
  ...
  public CreateGroupDataRequestFeedsInner() {
  }

  public CreateGroupDataRequestFeedsInner key(String key) {
    this.key = key;
    return this;
  }
  ...
  public CreateGroupDataRequestFeedsInner value(String value) {
    this.value = value;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    CreateGroupDataRequestFeedsInner createGroupDataRequestFeedsInner = (CreateGroupDataRequestFeedsInner) o;
    return Objects.equals(this.key, createGroupDataRequestFeedsInner.key) &&
        Objects.equals(this.value, createGroupDataRequestFeedsInner.value);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateGroupDataRequestFeedsInner {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateGroupDataRequestFeedsInner
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateGroupDataRequestFeedsInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateGroupDataRequestFeedsInner is not found in the empty JSON string", CreateGroupDataRequestFeedsInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateGroupDataRequestFeedsInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateGroupDataRequestFeedsInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CreateGroupDataRequestFeedsInner.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateGroupDataRequestFeedsInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateGroupDataRequestFeedsInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateGroupDataRequestFeedsInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateGroupDataRequestFeedsInner.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateGroupDataRequestFeedsInner>() {
           @Override
           public void write(JsonWriter out, CreateGroupDataRequestFeedsInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateGroupDataRequestFeedsInner read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateGroupDataRequestFeedsInner given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateGroupDataRequestFeedsInner
   * @throws IOException if the JSON string is invalid with respect to CreateGroupDataRequestFeedsInner
   */
  public static CreateGroupDataRequestFeedsInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateGroupDataRequestFeedsInner.class);
  }

  /**
   * Convert an instance of CreateGroupDataRequestFeedsInner to an JSON string
   *
   * @return JSON string
   */
