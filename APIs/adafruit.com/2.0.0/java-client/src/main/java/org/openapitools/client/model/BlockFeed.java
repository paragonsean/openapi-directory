...
public class BlockFeed {
  ...
  public BlockFeed feed(Feed feed) {
    this.feed = feed;
    return this;
  }
  ...
  public BlockFeed group(Group group) {
    this.group = group;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    BlockFeed blockFeed = (BlockFeed) o;
    return Objects.equals(this.feed, blockFeed.feed) &&
        Objects.equals(this.group, blockFeed.group) &&
        Objects.equals(this.id, blockFeed.id);
  }

  @Override
  public int hashCode() {
    return Objects.hash(feed, group, id);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class BlockFeed {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to BlockFeed
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!BlockFeed.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in BlockFeed is not found in the empty JSON string", BlockFeed.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!BlockFeed.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `BlockFeed` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!BlockFeed.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'BlockFeed' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<BlockFeed> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(BlockFeed.class));

       return (TypeAdapter<T>) new TypeAdapter<BlockFeed>() {
           @Override
           public void write(JsonWriter out, BlockFeed value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public BlockFeed read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of BlockFeed given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of BlockFeed
   * @throws IOException if the JSON string is invalid with respect to BlockFeed
   */
  public static BlockFeed fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, BlockFeed.class);
  }

  /**
   * Convert an instance of BlockFeed to an JSON string
   *
   * @return JSON string
   */
