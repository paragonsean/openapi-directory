...
/**
 * Model tests for CreateDataRequest
 */
public class CreateDataRequestTest {
    private final CreateDataRequest model = new CreateDataRequest();
