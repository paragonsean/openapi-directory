...
public class PermissionsApiTest {
    ...
    public void allPermissionsTest() throws ApiException {
        ...
        String type = null;
        String typeId = null;
        List<Permission> response = api.allPermissions(username, type, typeId);
    ...
    public void createPermissionTest() throws ApiException {
        ...
        String type = null;
        String typeId = null;
        CreatePermissionRequest permission = null;
        Permission response = api.createPermission(username, type, typeId, permission);
        // TODO: test validations
    }
     ...
     */
    @Test
    public void destroyPermissionTest() throws ApiException {
        String username = null;
        String type = null;
        String typeId = null;
        String id = null;
        String response = api.destroyPermission(username, type, typeId, id);
        // TODO: test validations
    }
    ...
    public void getPermissionTest() throws ApiException {
        ...
        String typeId = null;
        String id = null;
        Permission response = api.getPermission(username, type, typeId, id);
        // TODO: test validations
    }
     ...
     */
    @Test
    public void replacePermissionTest() throws ApiException {
        String username = null;
        String type = null;
        String typeId = null;
        String id = null;
        CreatePermissionRequest permission = null;
        Permission response = api.replacePermission(username, type, typeId, id, permission);
        // TODO: test validations
    }
    ...
    public void updatePermissionTest() throws ApiException {
        ...
        String id = null;
        CreatePermissionRequest permission = null;
        Permission response = api.updatePermission(username, type, typeId, id, permission);
        // TODO: test validations
    }
