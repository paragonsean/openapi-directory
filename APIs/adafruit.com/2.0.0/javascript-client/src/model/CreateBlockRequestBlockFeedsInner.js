...
/**
 * The CreateBlockRequestBlockFeedsInner model module.
 * @module model/CreateBlockRequestBlockFeedsInner
 * @version 2.0.0
 */
class CreateBlockRequestBlockFeedsInner {
    /**
     * Constructs a new <code>CreateBlockRequestBlockFeedsInner</code>.
     * @alias module:model/CreateBlockRequestBlockFeedsInner
     */
    constructor() { 
        
        CreateBlockRequestBlockFeedsInner.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CreateBlockRequestBlockFeedsInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateBlockRequestBlockFeedsInner} obj Optional instance to populate.
     * @return {module:model/CreateBlockRequestBlockFeedsInner} The populated <code>CreateBlockRequestBlockFeedsInner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateBlockRequestBlockFeedsInner();
    ...
    /**
     * Validates the JSON data with respect to <code>CreateBlockRequestBlockFeedsInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateBlockRequestBlockFeedsInner</code>.
     */
 ...
 */
CreateBlockRequestBlockFeedsInner.prototype['feed_id'] = undefined;

/**
 * @member {String} group_id
 */
CreateBlockRequestBlockFeedsInner.prototype['group_id'] = undefined;
...
export default CreateBlockRequestBlockFeedsInner;
