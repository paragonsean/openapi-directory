...
import CreateGroupDataRequestFeedsInner from './CreateGroupDataRequestFeedsInner';
import CreateGroupDataRequestLocation from './CreateGroupDataRequestLocation';

/**
 * The CreateGroupDataRequest model module.
 * @module model/CreateGroupDataRequest
 * @version 2.0.0
 */
class CreateGroupDataRequest {
    /**
     * Constructs a new <code>CreateGroupDataRequest</code>.
     * @alias module:model/CreateGroupDataRequest
     * @param feeds {Array.<module:model/CreateGroupDataRequestFeedsInner>} An array of feed data records with `key` and `value` properties.
     */
    constructor(feeds) { 
        
        CreateGroupDataRequest.initialize(this, feeds);
    }
    ...
    /**
     * Constructs a <code>CreateGroupDataRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateGroupDataRequest} obj Optional instance to populate.
     * @return {module:model/CreateGroupDataRequest} The populated <code>CreateGroupDataRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateGroupDataRequest();

            if (data.hasOwnProperty('created_at')) {
                obj['created_at'] = ApiClient.convertToType(data['created_at'], 'String');
            }
            if (data.hasOwnProperty('feeds')) {
                obj['feeds'] = ApiClient.convertToType(data['feeds'], [CreateGroupDataRequestFeedsInner]);
            }
            if (data.hasOwnProperty('location')) {
                obj['location'] = CreateGroupDataRequestLocation.constructFromObject(data['location']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>CreateGroupDataRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateGroupDataRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CreateGroupDataRequest.RequiredProperties) {
        ...
        if (data['feeds']) { // data not null
            ...
            for (const item of data['feeds']) {
                CreateGroupDataRequestFeedsInner.validateJSON(item);
            };
        }
        // validate the optional field `location`
        if (data['location']) { // data not null
          CreateGroupDataRequestLocation.validateJSON(data['location']);
        }
...
CreateGroupDataRequest.RequiredProperties = ["feeds"];

/**
 * Optional created_at timestamp which will be applied to all feed values created.
 * @member {String} created_at
 */
CreateGroupDataRequest.prototype['created_at'] = undefined;

/**
 * An array of feed data records with `key` and `value` properties.
 * @member {Array.<module:model/CreateGroupDataRequestFeedsInner>} feeds
 */
CreateGroupDataRequest.prototype['feeds'] = undefined;

/**
 * @member {module:model/CreateGroupDataRequestLocation} location
 */
CreateGroupDataRequest.prototype['location'] = undefined;
...
export default CreateGroupDataRequest;
