...
import ChartData200ResponseFeed from './ChartData200ResponseFeed';

/**
 * The ChartData200Response model module.
 * @module model/ChartData200Response
 * @version 2.0.0
 */
class ChartData200Response {
    /**
     * Constructs a new <code>ChartData200Response</code>.
     * @alias module:model/ChartData200Response
     */
    constructor() { 
        
        ChartData200Response.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ChartData200Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ChartData200Response} obj Optional instance to populate.
     * @return {module:model/ChartData200Response} The populated <code>ChartData200Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ChartData200Response();
            ...
            if (data.hasOwnProperty('feed')) {
                obj['feed'] = ChartData200ResponseFeed.constructFromObject(data['feed']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>ChartData200Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ChartData200Response</code>.
     */
    static validateJSON(data) {
        ...
        if (data['feed']) { // data not null
          ChartData200ResponseFeed.validateJSON(data['feed']);
        }
 ...
 */
ChartData200Response.prototype['columns'] = undefined;

/**
 * The actual chart data.
 * @member {Array.<Array.<String>>} data
 */
ChartData200Response.prototype['data'] = undefined;

/**
 * @member {module:model/ChartData200ResponseFeed} feed
 */
ChartData200Response.prototype['feed'] = undefined;

/**
 * @member {Object} parameters
 */
ChartData200Response.prototype['parameters'] = undefined;
...
export default ChartData200Response;
