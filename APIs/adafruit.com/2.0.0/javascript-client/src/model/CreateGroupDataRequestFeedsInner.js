...
/**
 * The CreateGroupDataRequestFeedsInner model module.
 * @module model/CreateGroupDataRequestFeedsInner
 * @version 2.0.0
 */
class CreateGroupDataRequestFeedsInner {
    /**
     * Constructs a new <code>CreateGroupDataRequestFeedsInner</code>.
     * @alias module:model/CreateGroupDataRequestFeedsInner
     * @param key {String} 
     * @param value {String} 
     */
    constructor(key, value) { 
        
        CreateGroupDataRequestFeedsInner.initialize(this, key, value);
    }
    ...
    /**
     * Constructs a <code>CreateGroupDataRequestFeedsInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateGroupDataRequestFeedsInner} obj Optional instance to populate.
     * @return {module:model/CreateGroupDataRequestFeedsInner} The populated <code>CreateGroupDataRequestFeedsInner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateGroupDataRequestFeedsInner();
    ...
    /**
     * Validates the JSON data with respect to <code>CreateGroupDataRequestFeedsInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateGroupDataRequestFeedsInner</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CreateGroupDataRequestFeedsInner.RequiredProperties) {
...
CreateGroupDataRequestFeedsInner.RequiredProperties = ["key", "value"];

/**
 * @member {String} key
 */
CreateGroupDataRequestFeedsInner.prototype['key'] = undefined;

/**
 * @member {String} value
 */
CreateGroupDataRequestFeedsInner.prototype['value'] = undefined;
...
export default CreateGroupDataRequestFeedsInner;
