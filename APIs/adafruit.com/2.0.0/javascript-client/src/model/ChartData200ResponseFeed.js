...
/**
 * The ChartData200ResponseFeed model module.
 * @module model/ChartData200ResponseFeed
 * @version 2.0.0
 */
class ChartData200ResponseFeed {
    /**
     * Constructs a new <code>ChartData200ResponseFeed</code>.
     * @alias module:model/ChartData200ResponseFeed
     */
    constructor() { 
        
        ChartData200ResponseFeed.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ChartData200ResponseFeed</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ChartData200ResponseFeed} obj Optional instance to populate.
     * @return {module:model/ChartData200ResponseFeed} The populated <code>ChartData200ResponseFeed</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ChartData200ResponseFeed();
    ...
    /**
     * Validates the JSON data with respect to <code>ChartData200ResponseFeed</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ChartData200ResponseFeed</code>.
     */
 ...
 * @member {Number} id
 */
ChartData200ResponseFeed.prototype['id'] = undefined;

/**
 * @member {String} key
 */
ChartData200ResponseFeed.prototype['key'] = undefined;

/**
 * @member {String} name
 */
ChartData200ResponseFeed.prototype['name'] = undefined;
...
export default ChartData200ResponseFeed;
