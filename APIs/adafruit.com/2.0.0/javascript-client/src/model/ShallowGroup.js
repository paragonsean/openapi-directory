...
/**
 * The ShallowGroup model module.
 * @module model/ShallowGroup
 * @version 2.0.0
 */
class ShallowGroup {
    /**
     * Constructs a new <code>ShallowGroup</code>.
     * @alias module:model/ShallowGroup
     */
    constructor() { 
        
        ShallowGroup.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ShallowGroup</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ShallowGroup} obj Optional instance to populate.
     * @return {module:model/ShallowGroup} The populated <code>ShallowGroup</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ShallowGroup();
    ...
    /**
     * Validates the JSON data with respect to <code>ShallowGroup</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ShallowGroup</code>.
     */
 ...
 */
ShallowGroup.prototype['created_at'] = undefined;

/**
 * @member {String} description
 */
ShallowGroup.prototype['description'] = undefined;

/**
 * @member {Number} id
 */
ShallowGroup.prototype['id'] = undefined;

/**
 * @member {String} name
 */
ShallowGroup.prototype['name'] = undefined;

/**
 * @member {String} updated_at
 */
ShallowGroup.prototype['updated_at'] = undefined;
