...
import FeedDetailsData from './FeedDetailsData';

/**
 * The FeedDetails model module.
 * @module model/FeedDetails
 * @version 2.0.0
 */
class FeedDetails {
    /**
     * Constructs a new <code>FeedDetails</code>.
     * Additional details about this feed.
     * @alias module:model/FeedDetails
     */
    constructor() { 
        
        FeedDetails.initialize(this);
    }
    ...
    /**
     * Constructs a <code>FeedDetails</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/FeedDetails} obj Optional instance to populate.
     * @return {module:model/FeedDetails} The populated <code>FeedDetails</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new FeedDetails();

            if (data.hasOwnProperty('data')) {
                obj['data'] = FeedDetailsData.constructFromObject(data['data']);
            }
            if (data.hasOwnProperty('shared_with')) {
                obj['shared_with'] = ApiClient.convertToType(data['shared_with'], [Object]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>FeedDetails</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>FeedDetails</code>.
     */
    static validateJSON(data) {
        // validate the optional field `data`
        if (data['data']) { // data not null
          FeedDetailsData.validateJSON(data['data']);
        }
...
/**
 * @member {module:model/FeedDetailsData} data
 */
FeedDetails.prototype['data'] = undefined;

/**
 * Access control list for this feed
 * @member {Array.<Object>} shared_with
 */
FeedDetails.prototype['shared_with'] = undefined;
