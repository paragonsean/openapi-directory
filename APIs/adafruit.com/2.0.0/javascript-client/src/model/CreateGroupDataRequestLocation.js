...
/**
 * The CreateGroupDataRequestLocation model module.
 * @module model/CreateGroupDataRequestLocation
 * @version 2.0.0
 */
class CreateGroupDataRequestLocation {
    /**
     * Constructs a new <code>CreateGroupDataRequestLocation</code>.
     * A location record with &#x60;lat&#x60;, &#x60;lon&#x60;, and [optional] &#x60;ele&#x60; properties.
     * @alias module:model/CreateGroupDataRequestLocation
     * @param lat {Number} 
     * @param lon {Number} 
     */
    constructor(lat, lon) { 
        
        CreateGroupDataRequestLocation.initialize(this, lat, lon);
    }
    ...
    /**
     * Constructs a <code>CreateGroupDataRequestLocation</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateGroupDataRequestLocation} obj Optional instance to populate.
     * @return {module:model/CreateGroupDataRequestLocation} The populated <code>CreateGroupDataRequestLocation</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateGroupDataRequestLocation();
    ...
    /**
     * Validates the JSON data with respect to <code>CreateGroupDataRequestLocation</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateGroupDataRequestLocation</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CreateGroupDataRequestLocation.RequiredProperties) {
...
CreateGroupDataRequestLocation.RequiredProperties = ["lat", "lon"];

/**
 * @member {Number} ele
 */
CreateGroupDataRequestLocation.prototype['ele'] = undefined;

/**
 * @member {Number} lat
 */
CreateGroupDataRequestLocation.prototype['lat'] = undefined;

/**
 * @member {Number} lon
 */
CreateGroupDataRequestLocation.prototype['lon'] = undefined;
...
export default CreateGroupDataRequestLocation;
