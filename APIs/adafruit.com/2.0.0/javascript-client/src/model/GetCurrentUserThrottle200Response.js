...
/**
 * The GetCurrentUserThrottle200Response model module.
 * @module model/GetCurrentUserThrottle200Response
 * @version 2.0.0
 */
class GetCurrentUserThrottle200Response {
    /**
     * Constructs a new <code>GetCurrentUserThrottle200Response</code>.
     * @alias module:model/GetCurrentUserThrottle200Response
     */
    constructor() { 
        
        GetCurrentUserThrottle200Response.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetCurrentUserThrottle200Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetCurrentUserThrottle200Response} obj Optional instance to populate.
     * @return {module:model/GetCurrentUserThrottle200Response} The populated <code>GetCurrentUserThrottle200Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetCurrentUserThrottle200Response();

            if (data.hasOwnProperty('active_data_rate')) {
                obj['active_data_rate'] = ApiClient.convertToType(data['active_data_rate'], 'Number');
            }
            if (data.hasOwnProperty('data_rate_limit')) {
                obj['data_rate_limit'] = ApiClient.convertToType(data['data_rate_limit'], 'Number');
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>GetCurrentUserThrottle200Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetCurrentUserThrottle200Response</code>.
     */
 ...
 * @member {Number} active_data_rate
 */
GetCurrentUserThrottle200Response.prototype['active_data_rate'] = undefined;

/**
 * Max possible actions inside the time window (usually 1 minute).
 * @member {Number} data_rate_limit
 */
GetCurrentUserThrottle200Response.prototype['data_rate_limit'] = undefined;
...
export default GetCurrentUserThrottle200Response;
