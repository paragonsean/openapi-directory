...
/**
 * The FeedDetailsData model module.
 * @module model/FeedDetailsData
 * @version 2.0.0
 */
class FeedDetailsData {
    /**
     * Constructs a new <code>FeedDetailsData</code>.
     * @alias module:model/FeedDetailsData
     */
    constructor() { 
        
        FeedDetailsData.initialize(this);
    }
    ...
    /**
     * Constructs a <code>FeedDetailsData</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/FeedDetailsData} obj Optional instance to populate.
     * @return {module:model/FeedDetailsData} The populated <code>FeedDetailsData</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new FeedDetailsData();

            if (data.hasOwnProperty('count')) {
                obj['count'] = ApiClient.convertToType(data['count'], 'Number');
            }
            if (data.hasOwnProperty('first')) {
                obj['first'] = ApiClient.convertToType(data['first'], {'String': Data});
            }
            if (data.hasOwnProperty('last')) {
                obj['last'] = ApiClient.convertToType(data['last'], {'String': Data});
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>FeedDetailsData</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>FeedDetailsData</code>.
     */
 ...
 * @member {Number} count
 */
FeedDetailsData.prototype['count'] = undefined;

/**
 * @member {Object.<String, module:model/Data>} first
 */
FeedDetailsData.prototype['first'] = undefined;

/**
 * @member {Object.<String, module:model/Data>} last
 */
FeedDetailsData.prototype['last'] = undefined;
...
export default FeedDetailsData;
