...
/**
 * The CreateDataRequest model module.
 * @module model/CreateDataRequest
 * @version 2.0.0
 */
class CreateDataRequest {
    /**
     * Constructs a new <code>CreateDataRequest</code>.
     * @alias module:model/CreateDataRequest
     */
    constructor() { 
        
        CreateDataRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CreateDataRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateDataRequest} obj Optional instance to populate.
     * @return {module:model/CreateDataRequest} The populated <code>CreateDataRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateDataRequest();

            if (data.hasOwnProperty('created_at')) {
                obj['created_at'] = ApiClient.convertToType(data['created_at'], 'String');
            }
            if (data.hasOwnProperty('ele')) {
                obj['ele'] = ApiClient.convertToType(data['ele'], 'String');
            }
    ...
    /**
     * Validates the JSON data with respect to <code>CreateDataRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateDataRequest</code>.
     */
    static validateJSON(data) {
        ...
        // ensure the json data is a string
        if (data['ele'] && !(typeof data['ele'] === 'string' || data['ele'] instanceof String)) {
            throw new Error("Expected the field `ele` to be a primitive type in the JSON string but got " + data['ele']);
        }
        // ensure the json data is a string
 ...
 */
CreateDataRequest.prototype['created_at'] = undefined;

/**
 * @member {String} ele
 */
CreateDataRequest.prototype['ele'] = undefined;

/**
 * @member {Number} epoch
 */
CreateDataRequest.prototype['epoch'] = undefined;

/**
 * @member {String} lat
 */
CreateDataRequest.prototype['lat'] = undefined;

/**
 * @member {String} lon
 */
CreateDataRequest.prototype['lon'] = undefined;

/**
 * @member {String} value
 */
CreateDataRequest.prototype['value'] = undefined;
