...
/**
 * The BlockFeed model module.
 * @module model/BlockFeed
 * @version 2.0.0
 */
class BlockFeed {
    /**
     * Constructs a new <code>BlockFeed</code>.
     * @alias module:model/BlockFeed
     */
    constructor() { 
        
        BlockFeed.initialize(this);
    }
    ...
    /**
     * Constructs a <code>BlockFeed</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/BlockFeed} obj Optional instance to populate.
     * @return {module:model/BlockFeed} The populated <code>BlockFeed</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new BlockFeed();
    ...
    /**
     * Validates the JSON data with respect to <code>BlockFeed</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>BlockFeed</code>.
     */
 ...
 */
BlockFeed.prototype['feed'] = undefined;

/**
 * @member {module:model/Group} group
 */
BlockFeed.prototype['group'] = undefined;

/**
 * @member {String} id
 */
BlockFeed.prototype['id'] = undefined;
