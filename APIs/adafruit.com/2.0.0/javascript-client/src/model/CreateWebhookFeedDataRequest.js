...
/**
 * The CreateWebhookFeedDataRequest model module.
 * @module model/CreateWebhookFeedDataRequest
 * @version 2.0.0
 */
class CreateWebhookFeedDataRequest {
    /**
     * Constructs a new <code>CreateWebhookFeedDataRequest</code>.
     * @alias module:model/CreateWebhookFeedDataRequest
     */
    constructor() { 
        
        CreateWebhookFeedDataRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CreateWebhookFeedDataRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateWebhookFeedDataRequest} obj Optional instance to populate.
     * @return {module:model/CreateWebhookFeedDataRequest} The populated <code>CreateWebhookFeedDataRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateWebhookFeedDataRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>CreateWebhookFeedDataRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateWebhookFeedDataRequest</code>.
     */
 ...
 * @member {String} value
 */
CreateWebhookFeedDataRequest.prototype['value'] = undefined;
...
export default CreateWebhookFeedDataRequest;
