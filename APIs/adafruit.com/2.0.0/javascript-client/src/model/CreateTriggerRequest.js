...
/**
 * The CreateTriggerRequest model module.
 * @module model/CreateTriggerRequest
 * @version 2.0.0
 */
class CreateTriggerRequest {
    /**
     * Constructs a new <code>CreateTriggerRequest</code>.
     * @alias module:model/CreateTriggerRequest
     */
    constructor() { 
        
        CreateTriggerRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CreateTriggerRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateTriggerRequest} obj Optional instance to populate.
     * @return {module:model/CreateTriggerRequest} The populated <code>CreateTriggerRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateTriggerRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>CreateTriggerRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateTriggerRequest</code>.
     */
 ...
 * @member {String} name
 */
CreateTriggerRequest.prototype['name'] = undefined;
...
export default CreateTriggerRequest;
