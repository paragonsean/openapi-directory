...
export default class UsersApi {
    ...
    */
     ...
     * @callback module:api/UsersApi~currentUserCallback
     ...
     * @param {module:api/UsersApi~currentUserCallback} callback The callback function, accepting three arguments: error, data, response
    ...
    /**
     * Callback function to receive the result of the getCurrentUserThrottle operation.
     * @callback module:api/UsersApi~getCurrentUserThrottleCallback
     * @param {String} error Error message, if any.
     * @param {module:model/GetCurrentUserThrottle200Response} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:api/UsersApi~getCurrentUserThrottleCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/GetCurrentUserThrottle200Response}
     */
    getCurrentUserThrottle(username, callback) {
      let postBody = null;
      // verify the required parameter 'username' is set
      if (username === undefined || username === null) {
        throw new Error("Missing the required parameter 'username' when calling getCurrentUserThrottle");
      }
      ...
      let contentTypes = [];
      let accepts = ['application/json', 'text/csv'];
      let returnType = GetCurrentUserThrottle200Response;
      return this.apiClient.callApi(
        '/{username}/throttle', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
