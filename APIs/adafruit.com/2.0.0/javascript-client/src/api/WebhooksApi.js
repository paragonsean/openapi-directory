...
export default class WebhooksApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the createRawWebhookFeedData operation.
     * @callback module:api/WebhooksApi~createRawWebhookFeedDataCallback
     ...
     * @param {module:api/WebhooksApi~createRawWebhookFeedDataCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/Data}
     */
    createRawWebhookFeedData(callback) {
      let postBody = null;
    ...
    /**
     * Callback function to receive the result of the createWebhookFeedData operation.
     * @callback module:api/WebhooksApi~createWebhookFeedDataCallback
     * @param {String} error Error message, if any.
     * @param {module:model/Data} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:api/WebhooksApi~createWebhookFeedDataCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/Data}
     */
    createWebhookFeedData(payload, callback) {
      let postBody = payload;
      // verify the required parameter 'payload' is set
      if (payload === undefined || payload === null) {
        throw new Error("Missing the required parameter 'payload' when calling createWebhookFeedData");
      }
