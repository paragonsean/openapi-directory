...
export default class TriggersApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the allTriggers operation.
     * @callback module:api/TriggersApi~allTriggersCallback
     * @param {String} error Error message, if any.
     * @param {Array.<module:model/Trigger>} data The data returned by the service call.
     ...
     * @param {module:api/TriggersApi~allTriggersCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Array.<module:model/Trigger>}
     */
    allTriggers(username, callback) {
      let postBody = null;
      // verify the required parameter 'username' is set
      if (username === undefined || username === null) {
        throw new Error("Missing the required parameter 'username' when calling allTriggers");
      }
     ...
     * @param {String} username a valid username string
     * @param {module:model/CreateTriggerRequest} trigger 
     ...
     */
    createTrigger(username, trigger, callback) {
      let postBody = trigger;
      // verify the required parameter 'username' is set
      if (username === undefined || username === null) {
        throw new Error("Missing the required parameter 'username' when calling createTrigger");
      }
    ...
    /**
     * Callback function to receive the result of the destroyTrigger operation.
     * @callback module:api/TriggersApi~destroyTriggerCallback
     * @param {String} error Error message, if any.
     ...
     * @param {String} username a valid username string
     * @param {String} id 
     * @param {module:api/TriggersApi~destroyTriggerCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link String}
     */
    destroyTrigger(username, id, callback) {
      let postBody = null;
      // verify the required parameter 'username' is set
      if (username === undefined || username === null) {
        throw new Error("Missing the required parameter 'username' when calling destroyTrigger");
      }
      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling destroyTrigger");
      }
     ...
     * data is of type: {@link module:model/Trigger}
     */
    getTrigger(username, id, callback) {
      let postBody = null;
      // verify the required parameter 'username' is set
      if (username === undefined || username === null) {
        throw new Error("Missing the required parameter 'username' when calling getTrigger");
      }
      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling getTrigger");
      }
    ...
    /**
     * Callback function to receive the result of the replaceTrigger operation.
     * @callback module:api/TriggersApi~replaceTriggerCallback
     * @param {String} error Error message, if any.
     * @param {module:model/Trigger} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} id 
     * @param {module:model/CreateTriggerRequest} trigger 
     * @param {module:api/TriggersApi~replaceTriggerCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/Trigger}
     */
    replaceTrigger(username, id, trigger, callback) {
      let postBody = trigger;
      // verify the required parameter 'username' is set
      if (username === undefined || username === null) {
        throw new Error("Missing the required parameter 'username' when calling replaceTrigger");
      }
      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling replaceTrigger");
      }
      // verify the required parameter 'trigger' is set
      if (trigger === undefined || trigger === null) {
        throw new Error("Missing the required parameter 'trigger' when calling replaceTrigger");
      }
     ...
     * data is of type: {@link module:model/Trigger}
     */
    updateTrigger(username, id, trigger, callback) {
      let postBody = trigger;
      // verify the required parameter 'username' is set
      if (username === undefined || username === null) {
        throw new Error("Missing the required parameter 'username' when calling updateTrigger");
      }
      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling updateTrigger");
      }
      // verify the required parameter 'trigger' is set
      if (trigger === undefined || trigger === null) {
