...
export default class DashboardsApi {
    ...
    */
     ...
     * @callback module:api/DashboardsApi~allDashboardsCallback
     ...
     * @param {module:api/DashboardsApi~allDashboardsCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Array.<module:model/Dashboard>}
     */
    allDashboards(username, callback) {
      let postBody = null;
      // verify the required parameter 'username' is set
      if (username === undefined || username === null) {
        throw new Error("Missing the required parameter 'username' when calling allDashboards");
      }
     ...
     * @param {String} username a valid username string
     * @param {module:model/CreateDashboardRequest} dashboard 
     ...
     */
    createDashboard(username, dashboard, callback) {
      let postBody = dashboard;
      // verify the required parameter 'username' is set
      if (username === undefined || username === null) {
        throw new Error("Missing the required parameter 'username' when calling createDashboard");
      }
      // verify the required parameter 'dashboard' is set
      if (dashboard === undefined || dashboard === null) {
        throw new Error("Missing the required parameter 'dashboard' when calling createDashboard");
      }
    ...
    /**
     * Callback function to receive the result of the destroyDashboard operation.
     * @callback module:api/DashboardsApi~destroyDashboardCallback
     * @param {String} error Error message, if any.
     ...
     * @param {String} username a valid username string
     * @param {String} id 
     * @param {module:api/DashboardsApi~destroyDashboardCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link String}
     */
    destroyDashboard(username, id, callback) {
      let postBody = null;
      // verify the required parameter 'username' is set
      if (username === undefined || username === null) {
        throw new Error("Missing the required parameter 'username' when calling destroyDashboard");
      }
      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling destroyDashboard");
      }
     ...
     * data is of type: {@link module:model/Dashboard}
     */
    getDashboard(username, id, callback) {
      let postBody = null;
      // verify the required parameter 'username' is set
      if (username === undefined || username === null) {
        throw new Error("Missing the required parameter 'username' when calling getDashboard");
      }
      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
    ...
    /**
     * Callback function to receive the result of the replaceDashboard operation.
     * @callback module:api/DashboardsApi~replaceDashboardCallback
     * @param {String} error Error message, if any.
     * @param {module:model/Dashboard} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} id 
     * @param {module:model/CreateDashboardRequest} dashboard 
     * @param {module:api/DashboardsApi~replaceDashboardCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/Dashboard}
     */
    replaceDashboard(username, id, dashboard, callback) {
      let postBody = dashboard;
      // verify the required parameter 'username' is set
      if (username === undefined || username === null) {
        throw new Error("Missing the required parameter 'username' when calling replaceDashboard");
      }
      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling replaceDashboard");
      }
      // verify the required parameter 'dashboard' is set
      if (dashboard === undefined || dashboard === null) {
        throw new Error("Missing the required parameter 'dashboard' when calling replaceDashboard");
      }
     ...
     * data is of type: {@link module:model/Dashboard}
     */
    updateDashboard(username, id, dashboard, callback) {
      let postBody = dashboard;
      // verify the required parameter 'username' is set
      if (username === undefined || username === null) {
        throw new Error("Missing the required parameter 'username' when calling updateDashboard");
      }
      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
      ...
      // verify the required parameter 'dashboard' is set
      if (dashboard === undefined || dashboard === null) {
        throw new Error("Missing the required parameter 'dashboard' when calling updateDashboard");
      }
