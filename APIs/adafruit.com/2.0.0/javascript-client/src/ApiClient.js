...
class ApiClient {
     ...
     */
    constructor(basePath = 'https://io.adafruit.com/api/v2') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default https://io.adafruit.com/api/v2
         */
        ...
        this.authentications = {
            'HeaderKey': {type: 'apiKey', 'in': 'header', name: 'X-AIO-Key'},
            'HeaderSignature': {type: 'apiKey', 'in': 'header', name: 'X-AIO-Signature'},
            'QueryKey': {type: 'apiKey', 'in': 'query', name: 'X-AIO-Key'}
        }
