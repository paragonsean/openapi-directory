...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AdafruitIoRestApi.CreateDataRequest();
  });
  ...
  describe('CreateDataRequest', function() {
    it('should create an instance of CreateDataRequest', function() {
      // uncomment below and update the code to test CreateDataRequest
      //var instance = new AdafruitIoRestApi.CreateDataRequest();
      //expect(instance).to.be.a(AdafruitIoRestApi.CreateDataRequest);
    });
