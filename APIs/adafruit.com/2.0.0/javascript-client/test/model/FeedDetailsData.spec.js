...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AdafruitIoRestApi.FeedDetailsData();
  });
  ...
  describe('FeedDetailsData', function() {
    it('should create an instance of FeedDetailsData', function() {
      // uncomment below and update the code to test FeedDetailsData
      //var instance = new AdafruitIoRestApi.FeedDetailsData();
      //expect(instance).to.be.a(AdafruitIoRestApi.FeedDetailsData);
    });
