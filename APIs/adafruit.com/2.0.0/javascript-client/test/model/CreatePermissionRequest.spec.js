...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AdafruitIoRestApi.CreatePermissionRequest();
  });
  ...
  describe('CreatePermissionRequest', function() {
    it('should create an instance of CreatePermissionRequest', function() {
      ...
      //var instance = new AdafruitIoRestApi.CreatePermissionRequest();
      //expect(instance).to.be.a(AdafruitIoRestApi.CreatePermissionRequest);
    });
