...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AdafruitIoRestApi.CreateTokenRequest();
  });
  ...
  describe('CreateTokenRequest', function() {
    it('should create an instance of CreateTokenRequest', function() {
      ...
      //var instance = new AdafruitIoRestApi.CreateTokenRequest();
      //expect(instance).to.be.a(AdafruitIoRestApi.CreateTokenRequest);
    });
