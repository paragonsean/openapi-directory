...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AdafruitIoRestApi.CreateGroupDataRequest();
  });
  ...
  describe('CreateGroupDataRequest', function() {
    it('should create an instance of CreateGroupDataRequest', function() {
      // uncomment below and update the code to test CreateGroupDataRequest
      //var instance = new AdafruitIoRestApi.CreateGroupDataRequest();
      //expect(instance).to.be.a(AdafruitIoRestApi.CreateGroupDataRequest);
    });
