...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AdafruitIoRestApi.CreateFeedRequest();
  });
  ...
  describe('CreateFeedRequest', function() {
    it('should create an instance of CreateFeedRequest', function() {
      ...
      //var instance = new AdafruitIoRestApi.CreateFeedRequest();
      //expect(instance).to.be.a(AdafruitIoRestApi.CreateFeedRequest);
    });
