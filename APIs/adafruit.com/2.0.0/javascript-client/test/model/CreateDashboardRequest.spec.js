...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AdafruitIoRestApi.CreateDashboardRequest();
  });
  ...
  describe('CreateDashboardRequest', function() {
    it('should create an instance of CreateDashboardRequest', function() {
      ...
      //var instance = new AdafruitIoRestApi.CreateDashboardRequest();
      //expect(instance).to.be.a(AdafruitIoRestApi.CreateDashboardRequest);
    });
