...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AdafruitIoRestApi.FeedDetails();
  });
  ...
  describe('FeedDetails', function() {
    it('should create an instance of FeedDetails', function() {
      // uncomment below and update the code to test FeedDetails
      //var instance = new AdafruitIoRestApi.FeedDetails();
      //expect(instance).to.be.a(AdafruitIoRestApi.FeedDetails);
    });
