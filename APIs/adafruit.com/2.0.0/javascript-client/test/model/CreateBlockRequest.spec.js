...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AdafruitIoRestApi.CreateBlockRequest();
  });
  ...
  describe('CreateBlockRequest', function() {
    it('should create an instance of CreateBlockRequest', function() {
      // uncomment below and update the code to test CreateBlockRequest
      //var instance = new AdafruitIoRestApi.CreateBlockRequest();
      //expect(instance).to.be.a(AdafruitIoRestApi.CreateBlockRequest);
    });

    it('should have the property blockFeeds (base name: "block_feeds")', function() {
      // uncomment below and update the code to test the property blockFeeds
      //var instance = new AdafruitIoRestApi.CreateBlockRequest();
    ...
    it('should have the property visualType (base name: "visual_type")', function() {
      // uncomment below and update the code to test the property visualType
      //var instance = new AdafruitIoRestApi.CreateBlockRequest();
      //expect(instance).to.be();
    });
