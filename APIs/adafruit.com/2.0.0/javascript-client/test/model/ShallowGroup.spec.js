...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AdafruitIoRestApi.ShallowGroup();
  });
  ...
  describe('ShallowGroup', function() {
    it('should create an instance of ShallowGroup', function() {
      // uncomment below and update the code to test ShallowGroup
      //var instance = new AdafruitIoRestApi.ShallowGroup();
      //expect(instance).to.be.a(AdafruitIoRestApi.ShallowGroup);
    });
