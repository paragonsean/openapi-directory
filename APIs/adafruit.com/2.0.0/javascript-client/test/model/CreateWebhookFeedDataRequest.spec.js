...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AdafruitIoRestApi.CreateWebhookFeedDataRequest();
  });
  ...
  describe('CreateWebhookFeedDataRequest', function() {
    it('should create an instance of CreateWebhookFeedDataRequest', function() {
      // uncomment below and update the code to test CreateWebhookFeedDataRequest
      //var instance = new AdafruitIoRestApi.CreateWebhookFeedDataRequest();
      //expect(instance).to.be.a(AdafruitIoRestApi.CreateWebhookFeedDataRequest);
    });
