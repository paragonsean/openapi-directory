...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AdafruitIoRestApi.CreateGroupDataRequestLocation();
  });
  ...
  describe('CreateGroupDataRequestLocation', function() {
    it('should create an instance of CreateGroupDataRequestLocation', function() {
      // uncomment below and update the code to test CreateGroupDataRequestLocation
      //var instance = new AdafruitIoRestApi.CreateGroupDataRequestLocation();
      //expect(instance).to.be.a(AdafruitIoRestApi.CreateGroupDataRequestLocation);
    });

    it('should have the property ele (base name: "ele")', function() {
      // uncomment below and update the code to test the property ele
      //var instance = new AdafruitIoRestApi.CreateGroupDataRequestLocation();
