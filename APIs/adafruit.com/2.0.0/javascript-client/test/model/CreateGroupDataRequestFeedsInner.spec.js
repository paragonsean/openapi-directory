...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AdafruitIoRestApi.CreateGroupDataRequestFeedsInner();
  });
  ...
  describe('CreateGroupDataRequestFeedsInner', function() {
    it('should create an instance of CreateGroupDataRequestFeedsInner', function() {
      // uncomment below and update the code to test CreateGroupDataRequestFeedsInner
      //var instance = new AdafruitIoRestApi.CreateGroupDataRequestFeedsInner();
      //expect(instance).to.be.a(AdafruitIoRestApi.CreateGroupDataRequestFeedsInner);
    });
