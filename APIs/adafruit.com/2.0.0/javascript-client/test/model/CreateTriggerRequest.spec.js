...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AdafruitIoRestApi.CreateTriggerRequest();
  });
  ...
  describe('CreateTriggerRequest', function() {
    it('should create an instance of CreateTriggerRequest', function() {
      // uncomment below and update the code to test CreateTriggerRequest
      //var instance = new AdafruitIoRestApi.CreateTriggerRequest();
      //expect(instance).to.be.a(AdafruitIoRestApi.CreateTriggerRequest);
    });
