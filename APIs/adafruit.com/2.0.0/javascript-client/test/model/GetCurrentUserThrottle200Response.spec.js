...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AdafruitIoRestApi.GetCurrentUserThrottle200Response();
  });
  ...
  describe('GetCurrentUserThrottle200Response', function() {
    it('should create an instance of GetCurrentUserThrottle200Response', function() {
      // uncomment below and update the code to test GetCurrentUserThrottle200Response
      //var instance = new AdafruitIoRestApi.GetCurrentUserThrottle200Response();
      //expect(instance).to.be.a(AdafruitIoRestApi.GetCurrentUserThrottle200Response);
    });

    it('should have the property activeDataRate (base name: "active_data_rate")', function() {
      // uncomment below and update the code to test the property activeDataRate
      //var instance = new AdafruitIoRestApi.GetCurrentUserThrottle200Response();
      //expect(instance).to.be();
    });

    it('should have the property dataRateLimit (base name: "data_rate_limit")', function() {
      // uncomment below and update the code to test the property dataRateLimit
      //var instance = new AdafruitIoRestApi.GetCurrentUserThrottle200Response();
      //expect(instance).to.be();
    });
