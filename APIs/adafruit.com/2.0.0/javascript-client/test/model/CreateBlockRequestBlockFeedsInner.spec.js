...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AdafruitIoRestApi.CreateBlockRequestBlockFeedsInner();
  });
  ...
  describe('CreateBlockRequestBlockFeedsInner', function() {
    it('should create an instance of CreateBlockRequestBlockFeedsInner', function() {
      // uncomment below and update the code to test CreateBlockRequestBlockFeedsInner
      //var instance = new AdafruitIoRestApi.CreateBlockRequestBlockFeedsInner();
      //expect(instance).to.be.a(AdafruitIoRestApi.CreateBlockRequestBlockFeedsInner);
    });
