...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AdafruitIoRestApi.BlockFeed();
  });
  ...
  describe('BlockFeed', function() {
    it('should create an instance of BlockFeed', function() {
      // uncomment below and update the code to test BlockFeed
      //var instance = new AdafruitIoRestApi.BlockFeed();
      //expect(instance).to.be.a(AdafruitIoRestApi.BlockFeed);
    });
