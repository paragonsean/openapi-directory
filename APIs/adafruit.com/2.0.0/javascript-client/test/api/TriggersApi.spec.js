...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AdafruitIoRestApi.TriggersApi();
  });
  ...
  describe('TriggersApi', function() {
    describe('allTriggers', function() {
      it('should call allTriggers successfully', function(done) {
        //uncomment below and update the code to test allTriggers
        //instance.allTriggers(function(error) {
    ...
    describe('destroyTrigger', function() {
      it('should call destroyTrigger successfully', function(done) {
        //uncomment below and update the code to test destroyTrigger
        //instance.destroyTrigger(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('replaceTrigger', function() {
      it('should call replaceTrigger successfully', function(done) {
        //uncomment below and update the code to test replaceTrigger
        //instance.replaceTrigger(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
