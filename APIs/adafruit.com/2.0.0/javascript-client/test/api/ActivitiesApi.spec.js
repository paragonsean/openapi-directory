...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AdafruitIoRestApi.ActivitiesApi();
  });
  ...
  describe('ActivitiesApi', function() {
    describe('allActivities', function() {
      it('should call allActivities successfully', function(done) {
        //uncomment below and update the code to test allActivities
        //instance.allActivities(function(error) {
    ...
    describe('destroyActivities', function() {
      it('should call destroyActivities successfully', function(done) {
        //uncomment below and update the code to test destroyActivities
        //instance.destroyActivities(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
