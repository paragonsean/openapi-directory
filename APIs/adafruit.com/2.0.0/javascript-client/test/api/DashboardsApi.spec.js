...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AdafruitIoRestApi.DashboardsApi();
  });
  ...
  describe('DashboardsApi', function() {
    describe('allDashboards', function() {
      it('should call allDashboards successfully', function(done) {
        //uncomment below and update the code to test allDashboards
        //instance.allDashboards(function(error) {
    ...
    describe('destroyDashboard', function() {
      it('should call destroyDashboard successfully', function(done) {
        //uncomment below and update the code to test destroyDashboard
        //instance.destroyDashboard(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('replaceDashboard', function() {
      it('should call replaceDashboard successfully', function(done) {
        //uncomment below and update the code to test replaceDashboard
        //instance.replaceDashboard(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
