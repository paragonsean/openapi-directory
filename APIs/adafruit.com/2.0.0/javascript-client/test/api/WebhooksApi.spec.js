...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AdafruitIoRestApi.WebhooksApi();
  });
  ...
  describe('WebhooksApi', function() {
    describe('createRawWebhookFeedData', function() {
      it('should call createRawWebhookFeedData successfully', function(done) {
        //uncomment below and update the code to test createRawWebhookFeedData
        //instance.createRawWebhookFeedData(function(error) {
    ...
    describe('createWebhookFeedData', function() {
      it('should call createWebhookFeedData successfully', function(done) {
        //uncomment below and update the code to test createWebhookFeedData
        //instance.createWebhookFeedData(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
