...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AdafruitIoRestApi.PermissionsApi();
  });
  ...
  describe('PermissionsApi', function() {
    ...
    describe('destroyPermission', function() {
      it('should call destroyPermission successfully', function(done) {
        //uncomment below and update the code to test destroyPermission
        //instance.destroyPermission(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('replacePermission', function() {
      it('should call replacePermission successfully', function(done) {
        //uncomment below and update the code to test replacePermission
        //instance.replacePermission(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
