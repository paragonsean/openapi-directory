...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AdafruitIoRestApi.TokensApi();
  });
  ...
  describe('TokensApi', function() {
    describe('allTokens', function() {
      it('should call allTokens successfully', function(done) {
        //uncomment below and update the code to test allTokens
        //instance.allTokens(function(error) {
    ...
    describe('destroyToken', function() {
      it('should call destroyToken successfully', function(done) {
        //uncomment below and update the code to test destroyToken
        //instance.destroyToken(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('replaceToken', function() {
      it('should call replaceToken successfully', function(done) {
        //uncomment below and update the code to test replaceToken
        //instance.replaceToken(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
