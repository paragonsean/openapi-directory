...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AdafruitIoRestApi.UsersApi();
  });
  ...
  describe('UsersApi', function() {
    ...
    describe('getCurrentUserThrottle', function() {
      it('should call getCurrentUserThrottle successfully', function(done) {
        //uncomment below and update the code to test getCurrentUserThrottle
        //instance.getCurrentUserThrottle(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
