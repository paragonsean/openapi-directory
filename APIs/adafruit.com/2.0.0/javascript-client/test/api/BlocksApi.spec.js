...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AdafruitIoRestApi.BlocksApi();
  });
  ...
  describe('BlocksApi', function() {
    describe('allBlocks', function() {
      it('should call allBlocks successfully', function(done) {
        //uncomment below and update the code to test allBlocks
        //instance.allBlocks(function(error) {
    ...
    describe('createBlock', function() {
      it('should call createBlock successfully', function(done) {
        //uncomment below and update the code to test createBlock
        //instance.createBlock(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('destroyBlock', function() {
      it('should call destroyBlock successfully', function(done) {
        //uncomment below and update the code to test destroyBlock
        //instance.destroyBlock(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('replaceBlock', function() {
      it('should call replaceBlock successfully', function(done) {
        //uncomment below and update the code to test replaceBlock
        //instance.replaceBlock(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('updateBlock', function() {
      it('should call updateBlock successfully', function(done) {
        //uncomment below and update the code to test updateBlock
        //instance.updateBlock(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
