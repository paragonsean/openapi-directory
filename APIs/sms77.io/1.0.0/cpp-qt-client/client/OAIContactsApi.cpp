...
void OAIContactsApi::contactsGet(const QString &action, const ::OpenAPI::OptionalParam<double> &json) {
...
void OAIContactsApi::contactsPOST(const QString &action, const ::OpenAPI::OptionalParam<double> &json, const ::OpenAPI::OptionalParam<QString> &id, const ::OpenAPI::OptionalParam<QString> &nick, const ::OpenAPI::OptionalParam<QString> &empfaenger, const ::OpenAPI::OptionalParam<QString> &email) {
    ...
    if (nick.hasValue())
    {
        ...
        queryPrefix = getParamStylePrefix(queryStyle);
        querySuffix = getParamStyleSuffix(queryStyle);
        queryDelimiter = getParamStyleDelimiter(queryStyle, "nick", true);
        if (fullPath.indexOf("?") > 0)
            fullPath.append(queryPrefix);
        else
            fullPath.append("?");

        fullPath.append(QUrl::toPercentEncoding("nick")).append(querySuffix).append(QUrl::toPercentEncoding(nick.stringValue()));
    }
    if (empfaenger.hasValue())
    {
        queryStyle = "form";
        if (queryStyle == "")
            queryStyle = "form";
        queryPrefix = getParamStylePrefix(queryStyle);
        querySuffix = getParamStyleSuffix(queryStyle);
        queryDelimiter = getParamStyleDelimiter(queryStyle, "empfaenger", true);
        if (fullPath.indexOf("?") > 0)
            fullPath.append(queryPrefix);
        else
            fullPath.append("?");

        fullPath.append(QUrl::toPercentEncoding("empfaenger")).append(querySuffix).append(QUrl::toPercentEncoding(empfaenger.stringValue()));
    }
    if (email.hasValue())
    {
        queryStyle = "form";
