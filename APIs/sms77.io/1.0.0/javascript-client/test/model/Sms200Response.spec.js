...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SevenIoApi.Sms200Response();
  });
  ...
  describe('Sms200Response', function() {
    it('should create an instance of Sms200Response', function() {
      // uncomment below and update the code to test Sms200Response
      //var instance = new SevenIoApi.Sms200Response();
      //expect(instance).to.be.a(SevenIoApi.Sms200Response);
    });
    ...
    it('should have the property smsType (base name: "sms_type")', function() {
      // uncomment below and update the code to test the property smsType
      //var instance = new SevenIoApi.Sms200Response();
      //expect(instance).to.be();
    });
