...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SevenIoApi.HooksApi();
  });
  ...
  describe('HooksApi', function() {
    describe('hooksGet', function() {
      it('should call hooksGet successfully', function(done) {
        //uncomment below and update the code to test hooksGet
        //instance.hooksGet(function(error) {
