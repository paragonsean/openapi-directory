...
async def cinema_shedule_showtime_search_read(request: web.Request, movie_title) -> web.Response:
...
async def cinema_shedule_showtime_searchall_read(request: web.Request, param) -> web.Response:
    """Return cinema schedule and showtime search result
