...
/**
 * API tests for GenreTypeApi
 */
@Disabled
public class GenreTypeApiTest {

    private final GenreTypeApi api = new GenreTypeApi();
     ...
     */
    @Test
    public void genreTypeSearchReadTest() throws ApiException {
        String genreDescription = null;
        api.genreTypeSearchRead(genreDescription);
