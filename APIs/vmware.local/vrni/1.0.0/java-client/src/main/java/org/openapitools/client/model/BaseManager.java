...
public class BaseManager extends BaseEntity {
   ...
   * @throws IOException if the JSON Element is invalid with respect to BaseManager
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!BaseManager.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in BaseManager is not found in the empty JSON string", BaseManager.openapiRequiredFields.toString()));
        }
      }
  ...
  /**
   * Create an instance of BaseManager given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of BaseManager
   * @throws IOException if the JSON string is invalid with respect to BaseManager
   */
  public static BaseManager fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, BaseManager.class);
  }

  /**
   * Convert an instance of BaseManager to an JSON string
   *
   * @return JSON string
   */
