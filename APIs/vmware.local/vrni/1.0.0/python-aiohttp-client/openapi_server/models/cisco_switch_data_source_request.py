...
class CiscoSwitchDataSourceRequest(Model):
    """NOTE: This class is auto generated by OpenAPI Generator (https://openapi-generator.tech).

    Do not edit the class manually.
    """

    def __init__(self, enabled: bool=True, fqdn: str=None, ip: str=None, nickname: str=None, notes: str=None, proxy_id: str=None, credentials: PasswordCredentials=None, switch_type: CiscoSwitchType=None):
        """CiscoSwitchDataSourceRequest - a model defined in OpenAPI
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'CiscoSwitchDataSourceRequest':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The CiscoSwitchDataSourceRequest of this CiscoSwitchDataSourceRequest.
        """
