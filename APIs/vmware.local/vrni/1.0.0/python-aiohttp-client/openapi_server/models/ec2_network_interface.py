...
class EC2NetworkInterface(Model):
    ...
    def __init__(self, entity_id: str=None, entity_type: EntityType=None, name: str=None, ip_addresses: List[IpV4Address]=None, layer2_network: Reference=None, vlan: Vlan=None, vm: Reference=None):
        """EC2NetworkInterface - a model defined in OpenAPI
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'EC2NetworkInterface':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The EC2NetworkInterface of this EC2NetworkInterface.
        """
