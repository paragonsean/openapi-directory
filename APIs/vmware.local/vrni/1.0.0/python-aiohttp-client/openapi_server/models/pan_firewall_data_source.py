...
class PanFirewallDataSource(Model):
    ...
    def __init__(self, enabled: bool=True, entity_id: str=None, entity_type: DataSourceType=None, fqdn: str=None, ip: str=None, nickname: str=None, notes: str=None, proxy_id: str=None, credentials: PasswordCredentials=None):
        """PanFirewallDataSource - a model defined in OpenAPI
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'PanFirewallDataSource':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The PanFirewallDataSource of this PanFirewallDataSource.
        """
