...
OAIEC2SecurityGroup::OAIEC2SecurityGroup(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIEC2SecurityGroup::OAIEC2SecurityGroup() {
    this->initializeModel();
}

OAIEC2SecurityGroup::~OAIEC2SecurityGroup() {}

void OAIEC2SecurityGroup::initializeModel() {
...
void OAIEC2SecurityGroup::fromJson(QString jsonString) {
...
void OAIEC2SecurityGroup::fromJsonObject(QJsonObject json) {
...
QString OAIEC2SecurityGroup::asJson() const {
...
QJsonObject OAIEC2SecurityGroup::asJsonObject() const {
    QJsonObject obj;
...
QString OAIEC2SecurityGroup::getEntityId() const {
    return m_entity_id;
}
void OAIEC2SecurityGroup::setEntityId(const QString &entity_id) {
    m_entity_id = entity_id;
    m_entity_id_isSet = true;
}

bool OAIEC2SecurityGroup::is_entity_id_Set() const{
    return m_entity_id_isSet;
}

bool OAIEC2SecurityGroup::is_entity_id_Valid() const{
    return m_entity_id_isValid;
}

OAIEntityType OAIEC2SecurityGroup::getEntityType() const {
    return m_entity_type;
}
void OAIEC2SecurityGroup::setEntityType(const OAIEntityType &entity_type) {
    m_entity_type = entity_type;
    m_entity_type_isSet = true;
}

bool OAIEC2SecurityGroup::is_entity_type_Set() const{
    return m_entity_type_isSet;
}

bool OAIEC2SecurityGroup::is_entity_type_Valid() const{
    return m_entity_type_isValid;
}

QString OAIEC2SecurityGroup::getName() const {
    return m_name;
}
void OAIEC2SecurityGroup::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIEC2SecurityGroup::is_name_Set() const{
    return m_name_isSet;
}

bool OAIEC2SecurityGroup::is_name_Valid() const{
    return m_name_isValid;
}

QList<OAIReference> OAIEC2SecurityGroup::getMembers() const {
    return m_members;
}
void OAIEC2SecurityGroup::setMembers(const QList<OAIReference> &members) {
    m_members = members;
    m_members_isSet = true;
}

bool OAIEC2SecurityGroup::is_members_Set() const{
    return m_members_isSet;
}

bool OAIEC2SecurityGroup::is_members_Valid() const{
    return m_members_isValid;
}

QList<OAIRuleSet> OAIEC2SecurityGroup::getDirectDestinationRules() const {
    return m_direct_destination_rules;
}
void OAIEC2SecurityGroup::setDirectDestinationRules(const QList<OAIRuleSet> &direct_destination_rules) {
    m_direct_destination_rules = direct_destination_rules;
    m_direct_destination_rules_isSet = true;
}

bool OAIEC2SecurityGroup::is_direct_destination_rules_Set() const{
    return m_direct_destination_rules_isSet;
}

bool OAIEC2SecurityGroup::is_direct_destination_rules_Valid() const{
    return m_direct_destination_rules_isValid;
}

QList<OAIReference> OAIEC2SecurityGroup::getDirectMembers() const {
    return m_direct_members;
}
void OAIEC2SecurityGroup::setDirectMembers(const QList<OAIReference> &direct_members) {
    m_direct_members = direct_members;
    m_direct_members_isSet = true;
}

bool OAIEC2SecurityGroup::is_direct_members_Set() const{
    return m_direct_members_isSet;
}

bool OAIEC2SecurityGroup::is_direct_members_Valid() const{
    return m_direct_members_isValid;
}

QList<OAIRuleSet> OAIEC2SecurityGroup::getDirectSourceRules() const {
    return m_direct_source_rules;
}
void OAIEC2SecurityGroup::setDirectSourceRules(const QList<OAIRuleSet> &direct_source_rules) {
    m_direct_source_rules = direct_source_rules;
    m_direct_source_rules_isSet = true;
}

bool OAIEC2SecurityGroup::is_direct_source_rules_Set() const{
    return m_direct_source_rules_isSet;
}

bool OAIEC2SecurityGroup::is_direct_source_rules_Valid() const{
    return m_direct_source_rules_isValid;
}

QList<OAIReference> OAIEC2SecurityGroup::getExcludedMembers() const {
    return m_excluded_members;
}
void OAIEC2SecurityGroup::setExcludedMembers(const QList<OAIReference> &excluded_members) {
    m_excluded_members = excluded_members;
    m_excluded_members_isSet = true;
}

bool OAIEC2SecurityGroup::is_excluded_members_Set() const{
    return m_excluded_members_isSet;
}

bool OAIEC2SecurityGroup::is_excluded_members_Valid() const{
    return m_excluded_members_isValid;
}

QList<OAIRuleSet> OAIEC2SecurityGroup::getIndirectDestinationRules() const {
    return m_indirect_destination_rules;
}
void OAIEC2SecurityGroup::setIndirectDestinationRules(const QList<OAIRuleSet> &indirect_destination_rules) {
    m_indirect_destination_rules = indirect_destination_rules;
    m_indirect_destination_rules_isSet = true;
}

bool OAIEC2SecurityGroup::is_indirect_destination_rules_Set() const{
    return m_indirect_destination_rules_isSet;
}

bool OAIEC2SecurityGroup::is_indirect_destination_rules_Valid() const{
    return m_indirect_destination_rules_isValid;
}

QList<OAIRuleSet> OAIEC2SecurityGroup::getIndirectSourceRules() const {
    return m_indirect_source_rules;
}
void OAIEC2SecurityGroup::setIndirectSourceRules(const QList<OAIRuleSet> &indirect_source_rules) {
    m_indirect_source_rules = indirect_source_rules;
    m_indirect_source_rules_isSet = true;
}

bool OAIEC2SecurityGroup::is_indirect_source_rules_Set() const{
    return m_indirect_source_rules_isSet;
}

bool OAIEC2SecurityGroup::is_indirect_source_rules_Valid() const{
    return m_indirect_source_rules_isValid;
}

QList<OAIReference> OAIEC2SecurityGroup::getParents() const {
    return m_parents;
}
void OAIEC2SecurityGroup::setParents(const QList<OAIReference> &parents) {
    m_parents = parents;
    m_parents_isSet = true;
}

bool OAIEC2SecurityGroup::is_parents_Set() const{
    return m_parents_isSet;
}

bool OAIEC2SecurityGroup::is_parents_Valid() const{
    return m_parents_isValid;
}

qint32 OAIEC2SecurityGroup::getTranslatedVmCount() const {
    return m_translated_vm_count;
}
void OAIEC2SecurityGroup::setTranslatedVmCount(const qint32 &translated_vm_count) {
    m_translated_vm_count = translated_vm_count;
    m_translated_vm_count_isSet = true;
}

bool OAIEC2SecurityGroup::is_translated_vm_count_Set() const{
    return m_translated_vm_count_isSet;
}

bool OAIEC2SecurityGroup::is_translated_vm_count_Valid() const{
    return m_translated_vm_count_isValid;
}

QString OAIEC2SecurityGroup::getVendorId() const {
    return m_vendor_id;
}
void OAIEC2SecurityGroup::setVendorId(const QString &vendor_id) {
    m_vendor_id = vendor_id;
    m_vendor_id_isSet = true;
}

bool OAIEC2SecurityGroup::is_vendor_id_Set() const{
    return m_vendor_id_isSet;
}

bool OAIEC2SecurityGroup::is_vendor_id_Valid() const{
    return m_vendor_id_isValid;
}

QString OAIEC2SecurityGroup::getRegion() const {
    return m_region;
}
void OAIEC2SecurityGroup::setRegion(const QString &region) {
    m_region = region;
    m_region_isSet = true;
}

bool OAIEC2SecurityGroup::is_region_Set() const{
    return m_region_isSet;
}

bool OAIEC2SecurityGroup::is_region_Valid() const{
    return m_region_isValid;
}

OAIReference OAIEC2SecurityGroup::getVpc() const {
    return m_vpc;
}
void OAIEC2SecurityGroup::setVpc(const OAIReference &vpc) {
    m_vpc = vpc;
    m_vpc_isSet = true;
}

bool OAIEC2SecurityGroup::is_vpc_Set() const{
    return m_vpc_isSet;
}

bool OAIEC2SecurityGroup::is_vpc_Valid() const{
    return m_vpc_isValid;
}

bool OAIEC2SecurityGroup::isSet() const {
...
bool OAIEC2SecurityGroup::isValid() const {
