...
/*
 * OAIBrocadeSwitchDataSource.h
 *
 * 
 */

#ifndef OAIBrocadeSwitchDataSource_H
#define OAIBrocadeSwitchDataSource_H
...
class OAIBrocadeSwitchDataSource : public OAIObject {
public:
    OAIBrocadeSwitchDataSource();
    OAIBrocadeSwitchDataSource(QString json);
    ~OAIBrocadeSwitchDataSource() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBrocadeSwitchDataSource)

#endif // OAIBrocadeSwitchDataSource_H
