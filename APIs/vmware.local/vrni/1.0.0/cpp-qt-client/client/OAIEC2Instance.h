...
#ifndef OAIEC2Instance_H
#define OAIEC2Instance_H
...
class OAIEC2Instance : public OAIObject {
public:
    OAIEC2Instance();
    OAIEC2Instance(QString json);
    ~OAIEC2Instance() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEC2Instance)

#endif // OAIEC2Instance_H
