...
/*
 * OAIEC2NetworkInterface.h
 *
 * 
 */

#ifndef OAIEC2NetworkInterface_H
#define OAIEC2NetworkInterface_H
...
class OAIEC2NetworkInterface : public OAIObject {
public:
    OAIEC2NetworkInterface();
    OAIEC2NetworkInterface(QString json);
    ~OAIEC2NetworkInterface() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEC2NetworkInterface)

#endif // OAIEC2NetworkInterface_H
