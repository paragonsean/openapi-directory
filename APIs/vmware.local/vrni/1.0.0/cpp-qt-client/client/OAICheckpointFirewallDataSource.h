...
/*
 * OAICheckpointFirewallDataSource.h
 *
 * 
 */

#ifndef OAICheckpointFirewallDataSource_H
#define OAICheckpointFirewallDataSource_H
...
class OAICheckpointFirewallDataSource : public OAIObject {
public:
    OAICheckpointFirewallDataSource();
    OAICheckpointFirewallDataSource(QString json);
    ~OAICheckpointFirewallDataSource() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICheckpointFirewallDataSource)

#endif // OAICheckpointFirewallDataSource_H
