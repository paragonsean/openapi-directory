...
/*
 * OAIBrocadeSwitchDataSourceRequest.h
 *
 * 
 */

#ifndef OAIBrocadeSwitchDataSourceRequest_H
#define OAIBrocadeSwitchDataSourceRequest_H
...
class OAIBrocadeSwitchDataSourceRequest : public OAIObject {
public:
    OAIBrocadeSwitchDataSourceRequest();
    OAIBrocadeSwitchDataSourceRequest(QString json);
    ~OAIBrocadeSwitchDataSourceRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBrocadeSwitchDataSourceRequest)

#endif // OAIBrocadeSwitchDataSourceRequest_H
