...
/*
 * OAIHPVCManagerDataSource.h
 *
 * 
 */

#ifndef OAIHPVCManagerDataSource_H
#define OAIHPVCManagerDataSource_H
...
class OAIHPVCManagerDataSource : public OAIObject {
public:
    OAIHPVCManagerDataSource();
    OAIHPVCManagerDataSource(QString json);
    ~OAIHPVCManagerDataSource() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIHPVCManagerDataSource)

#endif // OAIHPVCManagerDataSource_H
