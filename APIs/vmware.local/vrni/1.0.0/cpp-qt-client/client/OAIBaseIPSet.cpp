...
OAIBaseIPSet::OAIBaseIPSet(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIBaseIPSet::OAIBaseIPSet() {
    this->initializeModel();
}

OAIBaseIPSet::~OAIBaseIPSet() {}

void OAIBaseIPSet::initializeModel() {
...
void OAIBaseIPSet::fromJson(QString jsonString) {
...
void OAIBaseIPSet::fromJsonObject(QJsonObject json) {
...
QString OAIBaseIPSet::asJson() const {
...
QJsonObject OAIBaseIPSet::asJsonObject() const {
    QJsonObject obj;
...
QString OAIBaseIPSet::getEntityId() const {
    return m_entity_id;
}
void OAIBaseIPSet::setEntityId(const QString &entity_id) {
    m_entity_id = entity_id;
    m_entity_id_isSet = true;
}

bool OAIBaseIPSet::is_entity_id_Set() const{
    return m_entity_id_isSet;
}

bool OAIBaseIPSet::is_entity_id_Valid() const{
    return m_entity_id_isValid;
}

OAIEntityType OAIBaseIPSet::getEntityType() const {
    return m_entity_type;
}
void OAIBaseIPSet::setEntityType(const OAIEntityType &entity_type) {
    m_entity_type = entity_type;
    m_entity_type_isSet = true;
}

bool OAIBaseIPSet::is_entity_type_Set() const{
    return m_entity_type_isSet;
}

bool OAIBaseIPSet::is_entity_type_Valid() const{
    return m_entity_type_isValid;
}

QString OAIBaseIPSet::getName() const {
    return m_name;
}
void OAIBaseIPSet::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIBaseIPSet::is_name_Set() const{
    return m_name_isSet;
}

bool OAIBaseIPSet::is_name_Valid() const{
    return m_name_isValid;
}

QList<OAIRuleSet> OAIBaseIPSet::getDirectDestinationRules() const {
    return m_direct_destination_rules;
}
void OAIBaseIPSet::setDirectDestinationRules(const QList<OAIRuleSet> &direct_destination_rules) {
    m_direct_destination_rules = direct_destination_rules;
    m_direct_destination_rules_isSet = true;
}

bool OAIBaseIPSet::is_direct_destination_rules_Set() const{
    return m_direct_destination_rules_isSet;
}

bool OAIBaseIPSet::is_direct_destination_rules_Valid() const{
    return m_direct_destination_rules_isValid;
}

QList<OAIRuleSet> OAIBaseIPSet::getDirectSourceRules() const {
    return m_direct_source_rules;
}
void OAIBaseIPSet::setDirectSourceRules(const QList<OAIRuleSet> &direct_source_rules) {
    m_direct_source_rules = direct_source_rules;
    m_direct_source_rules_isSet = true;
}

bool OAIBaseIPSet::is_direct_source_rules_Set() const{
    return m_direct_source_rules_isSet;
}

bool OAIBaseIPSet::is_direct_source_rules_Valid() const{
    return m_direct_source_rules_isValid;
}

QList<OAIRuleSet> OAIBaseIPSet::getIndirectDestinationRules() const {
    return m_indirect_destination_rules;
}
void OAIBaseIPSet::setIndirectDestinationRules(const QList<OAIRuleSet> &indirect_destination_rules) {
    m_indirect_destination_rules = indirect_destination_rules;
    m_indirect_destination_rules_isSet = true;
}

bool OAIBaseIPSet::is_indirect_destination_rules_Set() const{
    return m_indirect_destination_rules_isSet;
}

bool OAIBaseIPSet::is_indirect_destination_rules_Valid() const{
    return m_indirect_destination_rules_isValid;
}

QList<OAIRuleSet> OAIBaseIPSet::getIndirectSourceRules() const {
    return m_indirect_source_rules;
}
void OAIBaseIPSet::setIndirectSourceRules(const QList<OAIRuleSet> &indirect_source_rules) {
    m_indirect_source_rules = indirect_source_rules;
    m_indirect_source_rules_isSet = true;
}

bool OAIBaseIPSet::is_indirect_source_rules_Set() const{
    return m_indirect_source_rules_isSet;
}

bool OAIBaseIPSet::is_indirect_source_rules_Valid() const{
    return m_indirect_source_rules_isValid;
}

QList<OAIIpV4Address> OAIBaseIPSet::getIpAddresses() const {
    return m_ip_addresses;
}
void OAIBaseIPSet::setIpAddresses(const QList<OAIIpV4Address> &ip_addresses) {
    m_ip_addresses = ip_addresses;
    m_ip_addresses_isSet = true;
}

bool OAIBaseIPSet::is_ip_addresses_Set() const{
    return m_ip_addresses_isSet;
}

bool OAIBaseIPSet::is_ip_addresses_Valid() const{
    return m_ip_addresses_isValid;
}

QList<OAIIpNumericRange> OAIBaseIPSet::getIpNumericRanges() const {
    return m_ip_numeric_ranges;
}
void OAIBaseIPSet::setIpNumericRanges(const QList<OAIIpNumericRange> &ip_numeric_ranges) {
    m_ip_numeric_ranges = ip_numeric_ranges;
    m_ip_numeric_ranges_isSet = true;
}

bool OAIBaseIPSet::is_ip_numeric_ranges_Set() const{
    return m_ip_numeric_ranges_isSet;
}

bool OAIBaseIPSet::is_ip_numeric_ranges_Valid() const{
    return m_ip_numeric_ranges_isValid;
}

QList<OAIIpAddressRange> OAIBaseIPSet::getIpRanges() const {
    return m_ip_ranges;
}
void OAIBaseIPSet::setIpRanges(const QList<OAIIpAddressRange> &ip_ranges) {
    m_ip_ranges = ip_ranges;
    m_ip_ranges_isSet = true;
}

bool OAIBaseIPSet::is_ip_ranges_Set() const{
    return m_ip_ranges_isSet;
}

bool OAIBaseIPSet::is_ip_ranges_Valid() const{
    return m_ip_ranges_isValid;
}

QList<OAIReference> OAIBaseIPSet::getParentSecurityGroups() const {
    return m_parent_security_groups;
}
void OAIBaseIPSet::setParentSecurityGroups(const QList<OAIReference> &parent_security_groups) {
    m_parent_security_groups = parent_security_groups;
    m_parent_security_groups_isSet = true;
}

bool OAIBaseIPSet::is_parent_security_groups_Set() const{
    return m_parent_security_groups_isSet;
}

bool OAIBaseIPSet::is_parent_security_groups_Valid() const{
    return m_parent_security_groups_isValid;
}

qint32 OAIBaseIPSet::getTranslatedVmCount() const {
    return m_translated_vm_count;
}
void OAIBaseIPSet::setTranslatedVmCount(const qint32 &translated_vm_count) {
    m_translated_vm_count = translated_vm_count;
    m_translated_vm_count_isSet = true;
}

bool OAIBaseIPSet::is_translated_vm_count_Set() const{
    return m_translated_vm_count_isSet;
}

bool OAIBaseIPSet::is_translated_vm_count_Valid() const{
    return m_translated_vm_count_isValid;
}

QString OAIBaseIPSet::getVendor() const {
    return m_vendor;
}
void OAIBaseIPSet::setVendor(const QString &vendor) {
    m_vendor = vendor;
    m_vendor_isSet = true;
}

bool OAIBaseIPSet::is_vendor_Set() const{
    return m_vendor_isSet;
}

bool OAIBaseIPSet::is_vendor_Valid() const{
    return m_vendor_isValid;
}

QString OAIBaseIPSet::getVendorId() const {
    return m_vendor_id;
}
void OAIBaseIPSet::setVendorId(const QString &vendor_id) {
    m_vendor_id = vendor_id;
    m_vendor_id_isSet = true;
}

bool OAIBaseIPSet::is_vendor_id_Set() const{
    return m_vendor_id_isSet;
}

bool OAIBaseIPSet::is_vendor_id_Valid() const{
    return m_vendor_id_isValid;
}

bool OAIBaseIPSet::isSet() const {
...
bool OAIBaseIPSet::isValid() const {
