...
void OAIAuthenticationApi::create(const OAIUserCredential &oai_user_credential) {
    QString fullPath = QString(_serverConfigs["create"][_serverIndices.value("create")].URL()+"/auth/token");
...

    {
        ...
        QByteArray output = oai_user_credential.asJson().toUtf8();
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIAuthenticationApi::createCallback);
...
void OAIAuthenticationApi::createCallback(OAIHttpRequestWorker *worker) {
...
void OAIAuthenticationApi::r_delete() {
    QString fullPath = QString(_serverConfigs["r_delete"][_serverIndices.value("r_delete")].URL()+"/auth/token");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIAuthenticationApi::r_deleteCallback);
    connect(this, &OAIAuthenticationApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIAuthenticationApi::r_deleteCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
