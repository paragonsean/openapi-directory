...
/*
 * OAIDellSwitchDataSource.h
 *
 * 
 */

#ifndef OAIDellSwitchDataSource_H
#define OAIDellSwitchDataSource_H
...
class OAIDellSwitchDataSource : public OAIObject {
public:
    OAIDellSwitchDataSource();
    OAIDellSwitchDataSource(QString json);
    ~OAIDellSwitchDataSource() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDellSwitchDataSource)

#endif // OAIDellSwitchDataSource_H
