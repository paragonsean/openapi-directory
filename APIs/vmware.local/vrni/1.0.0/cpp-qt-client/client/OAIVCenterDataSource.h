...
/*
 * OAIVCenterDataSource.h
 *
 * 
 */

#ifndef OAIVCenterDataSource_H
#define OAIVCenterDataSource_H
...
class OAIVCenterDataSource : public OAIObject {
public:
    OAIVCenterDataSource();
    OAIVCenterDataSource(QString json);
    ~OAIVCenterDataSource() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIVCenterDataSource)

#endif // OAIVCenterDataSource_H
