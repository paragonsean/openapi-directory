...
/*
 * OAIHPVCManagerDataSourceRequest.h
 *
 * 
 */

#ifndef OAIHPVCManagerDataSourceRequest_H
#define OAIHPVCManagerDataSourceRequest_H
...
class OAIHPVCManagerDataSourceRequest : public OAIObject {
public:
    OAIHPVCManagerDataSourceRequest();
    OAIHPVCManagerDataSourceRequest(QString json);
    ~OAIHPVCManagerDataSourceRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIHPVCManagerDataSourceRequest)

#endif // OAIHPVCManagerDataSourceRequest_H
