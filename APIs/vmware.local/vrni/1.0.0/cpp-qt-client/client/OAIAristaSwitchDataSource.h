...
/*
 * OAIAristaSwitchDataSource.h
 *
 * 
 */

#ifndef OAIAristaSwitchDataSource_H
#define OAIAristaSwitchDataSource_H
...
class OAIAristaSwitchDataSource : public OAIObject {
public:
    OAIAristaSwitchDataSource();
    OAIAristaSwitchDataSource(QString json);
    ~OAIAristaSwitchDataSource() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAristaSwitchDataSource)

#endif // OAIAristaSwitchDataSource_H
