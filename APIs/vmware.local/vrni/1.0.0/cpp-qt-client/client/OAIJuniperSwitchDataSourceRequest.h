...
/*
 * OAIJuniperSwitchDataSourceRequest.h
 *
 * 
 */

#ifndef OAIJuniperSwitchDataSourceRequest_H
#define OAIJuniperSwitchDataSourceRequest_H
...
class OAIJuniperSwitchDataSourceRequest : public OAIObject {
public:
    OAIJuniperSwitchDataSourceRequest();
    OAIJuniperSwitchDataSourceRequest(QString json);
    ~OAIJuniperSwitchDataSourceRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIJuniperSwitchDataSourceRequest)

#endif // OAIJuniperSwitchDataSourceRequest_H
