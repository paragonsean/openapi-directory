...
/*
 * OAISwitchDataSourceRequest.h
 *
 * 
 */

#ifndef OAISwitchDataSourceRequest_H
#define OAISwitchDataSourceRequest_H
...
class OAISwitchDataSourceRequest : public OAIObject {
public:
    OAISwitchDataSourceRequest();
    OAISwitchDataSourceRequest(QString json);
    ~OAISwitchDataSourceRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISwitchDataSourceRequest)

#endif // OAISwitchDataSourceRequest_H
