...
#ifndef OAIVCDatacenter_H
#define OAIVCDatacenter_H
...
class OAIVCDatacenter : public OAIObject {
public:
    OAIVCDatacenter();
    OAIVCDatacenter(QString json);
    ~OAIVCDatacenter() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIVCDatacenter)

#endif // OAIVCDatacenter_H
