...
/*
 * OAIPanFirewallDataSource.h
 *
 * 
 */

#ifndef OAIPanFirewallDataSource_H
#define OAIPanFirewallDataSource_H
...
class OAIPanFirewallDataSource : public OAIObject {
public:
    OAIPanFirewallDataSource();
    OAIPanFirewallDataSource(QString json);
    ~OAIPanFirewallDataSource() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPanFirewallDataSource)

#endif // OAIPanFirewallDataSource_H
