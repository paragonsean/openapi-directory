...
#ifndef OAIEC2IPSet_H
#define OAIEC2IPSet_H
...
class OAIEC2IPSet : public OAIObject {
public:
    OAIEC2IPSet();
    OAIEC2IPSet(QString json);
    ~OAIEC2IPSet() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEC2IPSet)
