...
public:
    ...
    */
    virtual void searchEntities(const ::OpenAPI::OptionalParam<OAISearchRequest> &oai_search_request = ::OpenAPI::OptionalParam<OAISearchRequest>());
...
Q_SIGNALS:
    ...
    void searchEntitiesSignal(OAIPagedListResponseWithTime summary);


    void searchEntitiesSignalFull(OAIHttpRequestWorker *worker, OAIPagedListResponseWithTime summary);

    Q_DECL_DEPRECATED_X("Use searchEntitiesSignalError() instead")
    void searchEntitiesSignalE(OAIPagedListResponseWithTime summary, QNetworkReply::NetworkError error_type, QString error_str);
    void searchEntitiesSignalError(OAIPagedListResponseWithTime summary, QNetworkReply::NetworkError error_type, const QString &error_str);
