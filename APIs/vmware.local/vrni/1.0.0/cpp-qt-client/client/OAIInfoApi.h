...
Q_SIGNALS:
    ...
    void getVersionSignal(OAIVersionResponse summary);


    void getVersionSignalFull(OAIHttpRequestWorker *worker, OAIVersionResponse summary);

    Q_DECL_DEPRECATED_X("Use getVersionSignalError() instead")
    void getVersionSignalE(OAIVersionResponse summary, QNetworkReply::NetworkError error_type, QString error_str);
    void getVersionSignalError(OAIVersionResponse summary, QNetworkReply::NetworkError error_type, const QString &error_str);
