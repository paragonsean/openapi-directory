...
/*
 * OAINSXServiceGroup.h
 *
 * 
 */

#ifndef OAINSXServiceGroup_H
#define OAINSXServiceGroup_H
...
class OAINSXServiceGroup : public OAIObject {
public:
    OAINSXServiceGroup();
    OAINSXServiceGroup(QString json);
    ~OAINSXServiceGroup() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAINSXServiceGroup)

#endif // OAINSXServiceGroup_H
