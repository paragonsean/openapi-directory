...
#ifndef OAIEntityName_H
#define OAIEntityName_H
...
class OAIEntityName : public OAIObject {
public:
    OAIEntityName();
    OAIEntityName(QString json);
    ~OAIEntityName() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEntityName)

#endif // OAIEntityName_H
