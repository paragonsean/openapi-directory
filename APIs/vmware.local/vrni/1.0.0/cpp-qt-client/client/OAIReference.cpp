...
QString OAIReference::getEntityId() const {
    return m_entity_id;
}
void OAIReference::setEntityId(const QString &entity_id) {
    m_entity_id = entity_id;
    m_entity_id_isSet = true;
}

bool OAIReference::is_entity_id_Set() const{
    return m_entity_id_isSet;
}

bool OAIReference::is_entity_id_Valid() const{
    return m_entity_id_isValid;
}

OAIEntityType OAIReference::getEntityType() const {
    return m_entity_type;
}
void OAIReference::setEntityType(const OAIEntityType &entity_type) {
    m_entity_type = entity_type;
    m_entity_type_isSet = true;
}

bool OAIReference::is_entity_type_Set() const{
    return m_entity_type_isSet;
}

bool OAIReference::is_entity_type_Valid() const{
