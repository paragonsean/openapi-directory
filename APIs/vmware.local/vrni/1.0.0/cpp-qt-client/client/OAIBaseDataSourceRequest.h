...
/*
 * OAIBaseDataSourceRequest.h
 *
 * 
 */

#ifndef OAIBaseDataSourceRequest_H
#define OAIBaseDataSourceRequest_H
...
class OAIBaseDataSourceRequest : public OAIObject {
public:
    OAIBaseDataSourceRequest();
    OAIBaseDataSourceRequest(QString json);
    ~OAIBaseDataSourceRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBaseDataSourceRequest)

#endif // OAIBaseDataSourceRequest_H
