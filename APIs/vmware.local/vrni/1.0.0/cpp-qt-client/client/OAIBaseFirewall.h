...
#ifndef OAIBaseFirewall_H
#define OAIBaseFirewall_H
...
class OAIBaseFirewall : public OAIObject {
public:
    OAIBaseFirewall();
    OAIBaseFirewall(QString json);
    ~OAIBaseFirewall() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBaseFirewall)

#endif // OAIBaseFirewall_H
