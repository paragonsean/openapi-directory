...
/*
 * OAIVCenterDataSourceRequest.h
 *
 * 
 */

#ifndef OAIVCenterDataSourceRequest_H
#define OAIVCenterDataSourceRequest_H
...
class OAIVCenterDataSourceRequest : public OAIObject {
public:
    OAIVCenterDataSourceRequest();
    OAIVCenterDataSourceRequest(QString json);
    ~OAIVCenterDataSourceRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIVCenterDataSourceRequest)

#endif // OAIVCenterDataSourceRequest_H
