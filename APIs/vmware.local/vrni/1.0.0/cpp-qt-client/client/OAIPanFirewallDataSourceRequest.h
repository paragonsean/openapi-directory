...
/*
 * OAIPanFirewallDataSourceRequest.h
 *
 * 
 */

#ifndef OAIPanFirewallDataSourceRequest_H
#define OAIPanFirewallDataSourceRequest_H
...
class OAIPanFirewallDataSourceRequest : public OAIObject {
public:
    OAIPanFirewallDataSourceRequest();
    OAIPanFirewallDataSourceRequest(QString json);
    ~OAIPanFirewallDataSourceRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPanFirewallDataSourceRequest)

#endif // OAIPanFirewallDataSourceRequest_H
