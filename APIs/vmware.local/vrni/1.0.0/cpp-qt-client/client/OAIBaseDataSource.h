...
#ifndef OAIBaseDataSource_H
#define OAIBaseDataSource_H
...
class OAIBaseDataSource : public OAIObject {
public:
    OAIBaseDataSource();
    OAIBaseDataSource(QString json);
    ~OAIBaseDataSource() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBaseDataSource)

#endif // OAIBaseDataSource_H
