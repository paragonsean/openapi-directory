...
#ifndef OAIBaseIPSet_H
#define OAIBaseIPSet_H
...
class OAIBaseIPSet : public OAIObject {
public:
    OAIBaseIPSet();
    OAIBaseIPSet(QString json);
    ~OAIBaseIPSet() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBaseIPSet)

#endif // OAIBaseIPSet_H
