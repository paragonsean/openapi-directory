...
/*
 * OAICheckpointFirewallDataSourceRequest.h
 *
 * 
 */

#ifndef OAICheckpointFirewallDataSourceRequest_H
#define OAICheckpointFirewallDataSourceRequest_H
...
class OAICheckpointFirewallDataSourceRequest : public OAIObject {
public:
    OAICheckpointFirewallDataSourceRequest();
    OAICheckpointFirewallDataSourceRequest(QString json);
    ~OAICheckpointFirewallDataSourceRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICheckpointFirewallDataSourceRequest)

#endif // OAICheckpointFirewallDataSourceRequest_H
