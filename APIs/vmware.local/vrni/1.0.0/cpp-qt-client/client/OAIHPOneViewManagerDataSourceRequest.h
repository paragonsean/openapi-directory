...
/*
 * OAIHPOneViewManagerDataSourceRequest.h
 *
 * 
 */

#ifndef OAIHPOneViewManagerDataSourceRequest_H
#define OAIHPOneViewManagerDataSourceRequest_H
...
class OAIHPOneViewManagerDataSourceRequest : public OAIObject {
public:
    OAIHPOneViewManagerDataSourceRequest();
    OAIHPOneViewManagerDataSourceRequest(QString json);
    ~OAIHPOneViewManagerDataSourceRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIHPOneViewManagerDataSourceRequest)

#endif // OAIHPOneViewManagerDataSourceRequest_H
