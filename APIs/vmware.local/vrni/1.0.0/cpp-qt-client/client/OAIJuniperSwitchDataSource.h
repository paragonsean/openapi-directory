...
/*
 * OAIJuniperSwitchDataSource.h
 *
 * 
 */

#ifndef OAIJuniperSwitchDataSource_H
#define OAIJuniperSwitchDataSource_H
...
class OAIJuniperSwitchDataSource : public OAIObject {
public:
    OAIJuniperSwitchDataSource();
    OAIJuniperSwitchDataSource(QString json);
    ~OAIJuniperSwitchDataSource() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIJuniperSwitchDataSource)

#endif // OAIJuniperSwitchDataSource_H
