...
/*
 * OAIUCSManagerDataSource.h
 *
 * 
 */

#ifndef OAIUCSManagerDataSource_H
#define OAIUCSManagerDataSource_H
...
class OAIUCSManagerDataSource : public OAIObject {
public:
    OAIUCSManagerDataSource();
    OAIUCSManagerDataSource(QString json);
    ~OAIUCSManagerDataSource() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUCSManagerDataSource)

#endif // OAIUCSManagerDataSource_H
