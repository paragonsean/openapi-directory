...
OAIVmknic::OAIVmknic(QString json) {
...
void OAIVmknic::initializeModel() {
...
void OAIVmknic::fromJson(QString jsonString) {
...
void OAIVmknic::fromJsonObject(QJsonObject json) {
...
QString OAIVmknic::asJson() const {
...
QJsonObject OAIVmknic::asJsonObject() const {
    QJsonObject obj;
...
QString OAIVmknic::getEntityId() const {
    return m_entity_id;
}
void OAIVmknic::setEntityId(const QString &entity_id) {
    m_entity_id = entity_id;
    m_entity_id_isSet = true;
}

bool OAIVmknic::is_entity_id_Set() const{
    return m_entity_id_isSet;
}

bool OAIVmknic::is_entity_id_Valid() const{
    return m_entity_id_isValid;
}

OAIEntityType OAIVmknic::getEntityType() const {
    return m_entity_type;
}
void OAIVmknic::setEntityType(const OAIEntityType &entity_type) {
    m_entity_type = entity_type;
    m_entity_type_isSet = true;
}

bool OAIVmknic::is_entity_type_Set() const{
    return m_entity_type_isSet;
}

bool OAIVmknic::is_entity_type_Valid() const{
    return m_entity_type_isValid;
}

QString OAIVmknic::getName() const {
    return m_name;
}
void OAIVmknic::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIVmknic::is_name_Set() const{
    return m_name_isSet;
}

bool OAIVmknic::is_name_Valid() const{
    return m_name_isValid;
}

OAIReference OAIVmknic::getHost() const {
    return m_host;
}
void OAIVmknic::setHost(const OAIReference &host) {
    m_host = host;
    m_host_isSet = true;
}

bool OAIVmknic::is_host_Set() const{
    return m_host_isSet;
}

bool OAIVmknic::is_host_Valid() const{
    return m_host_isValid;
}

QList<OAIIpV4Address> OAIVmknic::getIpAddresses() const {
    return m_ip_addresses;
}
void OAIVmknic::setIpAddresses(const QList<OAIIpV4Address> &ip_addresses) {
    m_ip_addresses = ip_addresses;
    m_ip_addresses_isSet = true;
}

bool OAIVmknic::is_ip_addresses_Set() const{
    return m_ip_addresses_isSet;
}

bool OAIVmknic::is_ip_addresses_Valid() const{
    return m_ip_addresses_isValid;
}

OAIReference OAIVmknic::getLayer2Network() const {
    return m_layer2_network;
}
void OAIVmknic::setLayer2Network(const OAIReference &layer2_network) {
    m_layer2_network = layer2_network;
    m_layer2_network_isSet = true;
}

bool OAIVmknic::is_layer2_network_Set() const{
    return m_layer2_network_isSet;
}

bool OAIVmknic::is_layer2_network_Valid() const{
    return m_layer2_network_isValid;
}

OAIVlan OAIVmknic::getVlan() const {
    return m_vlan;
}
void OAIVmknic::setVlan(const OAIVlan &vlan) {
    m_vlan = vlan;
    m_vlan_isSet = true;
}

bool OAIVmknic::is_vlan_Set() const{
    return m_vlan_isSet;
}

bool OAIVmknic::is_vlan_Valid() const{
    return m_vlan_isValid;
}

bool OAIVmknic::isSet() const {
