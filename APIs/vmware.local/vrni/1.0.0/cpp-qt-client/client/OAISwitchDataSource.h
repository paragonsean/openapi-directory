...
/*
 * OAISwitchDataSource.h
 *
 * 
 */

#ifndef OAISwitchDataSource_H
#define OAISwitchDataSource_H
...
class OAISwitchDataSource : public OAIObject {
public:
    OAISwitchDataSource();
    OAISwitchDataSource(QString json);
    ~OAISwitchDataSource() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISwitchDataSource)

#endif // OAISwitchDataSource_H
