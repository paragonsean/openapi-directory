...
OAIBaseVirtualMachine::OAIBaseVirtualMachine(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIBaseVirtualMachine::OAIBaseVirtualMachine() {
    this->initializeModel();
}

OAIBaseVirtualMachine::~OAIBaseVirtualMachine() {}

void OAIBaseVirtualMachine::initializeModel() {
...
void OAIBaseVirtualMachine::fromJson(QString jsonString) {
...
void OAIBaseVirtualMachine::fromJsonObject(QJsonObject json) {
...
QString OAIBaseVirtualMachine::asJson() const {
...
QJsonObject OAIBaseVirtualMachine::asJsonObject() const {
    QJsonObject obj;
...
QString OAIBaseVirtualMachine::getEntityId() const {
    return m_entity_id;
}
void OAIBaseVirtualMachine::setEntityId(const QString &entity_id) {
    m_entity_id = entity_id;
    m_entity_id_isSet = true;
}

bool OAIBaseVirtualMachine::is_entity_id_Set() const{
    return m_entity_id_isSet;
}

bool OAIBaseVirtualMachine::is_entity_id_Valid() const{
    return m_entity_id_isValid;
}

OAIEntityType OAIBaseVirtualMachine::getEntityType() const {
    return m_entity_type;
}
void OAIBaseVirtualMachine::setEntityType(const OAIEntityType &entity_type) {
    m_entity_type = entity_type;
    m_entity_type_isSet = true;
}

bool OAIBaseVirtualMachine::is_entity_type_Set() const{
    return m_entity_type_isSet;
}

bool OAIBaseVirtualMachine::is_entity_type_Valid() const{
    return m_entity_type_isValid;
}

QString OAIBaseVirtualMachine::getName() const {
    return m_name;
}
void OAIBaseVirtualMachine::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIBaseVirtualMachine::is_name_Set() const{
    return m_name_isSet;
}

bool OAIBaseVirtualMachine::is_name_Valid() const{
    return m_name_isValid;
}

QString OAIBaseVirtualMachine::getDefaultGateway() const {
    return m_default_gateway;
}
void OAIBaseVirtualMachine::setDefaultGateway(const QString &default_gateway) {
    m_default_gateway = default_gateway;
    m_default_gateway_isSet = true;
}

bool OAIBaseVirtualMachine::is_default_gateway_Set() const{
    return m_default_gateway_isSet;
}

bool OAIBaseVirtualMachine::is_default_gateway_Valid() const{
    return m_default_gateway_isValid;
}

QList<OAIRuleSet> OAIBaseVirtualMachine::getDestinationFirewallRules() const {
    return m_destination_firewall_rules;
}
void OAIBaseVirtualMachine::setDestinationFirewallRules(const QList<OAIRuleSet> &destination_firewall_rules) {
    m_destination_firewall_rules = destination_firewall_rules;
    m_destination_firewall_rules_isSet = true;
}

bool OAIBaseVirtualMachine::is_destination_firewall_rules_Set() const{
    return m_destination_firewall_rules_isSet;
}

bool OAIBaseVirtualMachine::is_destination_firewall_rules_Valid() const{
    return m_destination_firewall_rules_isValid;
}

QList<OAIIpV4Address> OAIBaseVirtualMachine::getIpAddresses() const {
    return m_ip_addresses;
}
void OAIBaseVirtualMachine::setIpAddresses(const QList<OAIIpV4Address> &ip_addresses) {
    m_ip_addresses = ip_addresses;
    m_ip_addresses_isSet = true;
}

bool OAIBaseVirtualMachine::is_ip_addresses_Set() const{
    return m_ip_addresses_isSet;
}

bool OAIBaseVirtualMachine::is_ip_addresses_Valid() const{
    return m_ip_addresses_isValid;
}

QList<OAIReference> OAIBaseVirtualMachine::getIpSets() const {
    return m_ip_sets;
}
void OAIBaseVirtualMachine::setIpSets(const QList<OAIReference> &ip_sets) {
    m_ip_sets = ip_sets;
    m_ip_sets_isSet = true;
}

bool OAIBaseVirtualMachine::is_ip_sets_Set() const{
    return m_ip_sets_isSet;
}

bool OAIBaseVirtualMachine::is_ip_sets_Valid() const{
    return m_ip_sets_isValid;
}

QList<OAIReference> OAIBaseVirtualMachine::getSecurityGroups() const {
    return m_security_groups;
}
void OAIBaseVirtualMachine::setSecurityGroups(const QList<OAIReference> &security_groups) {
    m_security_groups = security_groups;
    m_security_groups_isSet = true;
}

bool OAIBaseVirtualMachine::is_security_groups_Set() const{
    return m_security_groups_isSet;
}

bool OAIBaseVirtualMachine::is_security_groups_Valid() const{
    return m_security_groups_isValid;
}

QList<OAIRuleSet> OAIBaseVirtualMachine::getSourceFirewallRules() const {
    return m_source_firewall_rules;
}
void OAIBaseVirtualMachine::setSourceFirewallRules(const QList<OAIRuleSet> &source_firewall_rules) {
    m_source_firewall_rules = source_firewall_rules;
    m_source_firewall_rules_isSet = true;
}

bool OAIBaseVirtualMachine::is_source_firewall_rules_Set() const{
    return m_source_firewall_rules_isSet;
}

bool OAIBaseVirtualMachine::is_source_firewall_rules_Valid() const{
    return m_source_firewall_rules_isValid;
}

QList<OAIReference> OAIBaseVirtualMachine::getVnics() const {
    return m_vnics;
}
void OAIBaseVirtualMachine::setVnics(const QList<OAIReference> &vnics) {
    m_vnics = vnics;
    m_vnics_isSet = true;
}

bool OAIBaseVirtualMachine::is_vnics_Set() const{
    return m_vnics_isSet;
}

bool OAIBaseVirtualMachine::is_vnics_Valid() const{
    return m_vnics_isValid;
}

bool OAIBaseVirtualMachine::isSet() const {
...
bool OAIBaseVirtualMachine::isValid() const {
