...
/*
 * OAINSXVManagerDataSource.h
 *
 * 
 */

#ifndef OAINSXVManagerDataSource_H
#define OAINSXVManagerDataSource_H
...
class OAINSXVManagerDataSource : public OAIObject {
public:
    OAINSXVManagerDataSource();
    OAINSXVManagerDataSource(QString json);
    ~OAINSXVManagerDataSource() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAINSXVManagerDataSource)

#endif // OAINSXVManagerDataSource_H
