...
/*
 * OAIEC2SGFirewallRule.h
 *
 * 
 */

#ifndef OAIEC2SGFirewallRule_H
#define OAIEC2SGFirewallRule_H
...
class OAIEC2SGFirewallRule : public OAIObject {
public:
    OAIEC2SGFirewallRule();
    OAIEC2SGFirewallRule(QString json);
    ~OAIEC2SGFirewallRule() override;
    ...
    OAIEC2FirewallDirection getDirection() const;
    void setDirection(const OAIEC2FirewallDirection &direction);
    bool is_direction_Set() const;
    bool is_direction_Valid() const;

    OAIReference getOwnerSecurityGroup() const;
    void setOwnerSecurityGroup(const OAIReference &owner_security_group);
    bool is_owner_security_group_Set() const;
    bool is_owner_security_group_Valid() const;

    OAIReference getVpc() const;
    void setVpc(const OAIReference &vpc);
...
private:
    ...
    OAIEC2FirewallDirection m_direction;
    bool m_direction_isSet;
    bool m_direction_isValid;

    OAIReference m_owner_security_group;
    bool m_owner_security_group_isSet;
    bool m_owner_security_group_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEC2SGFirewallRule)

#endif // OAIEC2SGFirewallRule_H
