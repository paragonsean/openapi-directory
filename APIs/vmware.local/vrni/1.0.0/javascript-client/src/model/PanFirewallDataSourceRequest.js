...
/**
 * The PanFirewallDataSourceRequest model module.
 * @module model/PanFirewallDataSourceRequest
 * @version 1.0.0
 */
class PanFirewallDataSourceRequest {
    /**
     * Constructs a new <code>PanFirewallDataSourceRequest</code>.
     * @alias module:model/PanFirewallDataSourceRequest
    ...
    constructor(nickname, proxyId) { 
        ...
        PanFirewallDataSourceRequest.initialize(this, nickname, proxyId);
    }
    ...
    /**
     * Constructs a <code>PanFirewallDataSourceRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PanFirewallDataSourceRequest} obj Optional instance to populate.
     * @return {module:model/PanFirewallDataSourceRequest} The populated <code>PanFirewallDataSourceRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PanFirewallDataSourceRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>PanFirewallDataSourceRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PanFirewallDataSourceRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of PanFirewallDataSourceRequest.RequiredProperties) {
...
PanFirewallDataSourceRequest.RequiredProperties = ["nickname", "proxy_id"];

/**
 * @member {Boolean} enabled
 * @default true
 */
PanFirewallDataSourceRequest.prototype['enabled'] = true;

/**
 * @member {String} fqdn
 */
PanFirewallDataSourceRequest.prototype['fqdn'] = undefined;

/**
 * @member {String} ip
 */
PanFirewallDataSourceRequest.prototype['ip'] = undefined;

/**
 * @member {String} nickname
 */
PanFirewallDataSourceRequest.prototype['nickname'] = undefined;

/**
 * @member {String} notes
 */
PanFirewallDataSourceRequest.prototype['notes'] = undefined;

/**
 * proxy vm which should register this vcenter
 * @member {String} proxy_id
 */
PanFirewallDataSourceRequest.prototype['proxy_id'] = undefined;

/**
 * @member {module:model/PasswordCredentials} credentials
 */
PanFirewallDataSourceRequest.prototype['credentials'] = undefined;
...
export default PanFirewallDataSourceRequest;
