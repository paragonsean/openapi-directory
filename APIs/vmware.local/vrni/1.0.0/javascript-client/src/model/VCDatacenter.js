...
/**
 * The VCDatacenter model module.
 * @module model/VCDatacenter
 * @version 1.0.0
 */
class VCDatacenter {
    /**
     * Constructs a new <code>VCDatacenter</code>.
     * @alias module:model/VCDatacenter
     * @extends module:model/BaseEntity
     * @implements module:model/BaseEntity
     */
    constructor() { 
        BaseEntity.initialize(this);
        VCDatacenter.initialize(this);
    }
    ...
    /**
     * Constructs a <code>VCDatacenter</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/VCDatacenter} obj Optional instance to populate.
     * @return {module:model/VCDatacenter} The populated <code>VCDatacenter</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new VCDatacenter();
    ...
    /**
     * Validates the JSON data with respect to <code>VCDatacenter</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>VCDatacenter</code>.
     */
 ...
 */
VCDatacenter.prototype['vcenter_manager'] = undefined;

/**
 * @member {String} vendor_id
 */
VCDatacenter.prototype['vendor_id'] = undefined;
