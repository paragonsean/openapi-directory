...
/**
 * The AristaSwitchDataSource model module.
 * @module model/AristaSwitchDataSource
 * @version 1.0.0
 */
class AristaSwitchDataSource {
    /**
     * Constructs a new <code>AristaSwitchDataSource</code>.
     * @alias module:model/AristaSwitchDataSource
     * @extends module:model/SwitchDataSource
     * @implements module:model/SwitchDataSource
     */
    constructor() { 
        SwitchDataSource.initialize(this);
        AristaSwitchDataSource.initialize(this);
    }
    ...
    /**
     * Constructs a <code>AristaSwitchDataSource</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AristaSwitchDataSource} obj Optional instance to populate.
     * @return {module:model/AristaSwitchDataSource} The populated <code>AristaSwitchDataSource</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AristaSwitchDataSource();
    ...
    /**
     * Validates the JSON data with respect to <code>AristaSwitchDataSource</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AristaSwitchDataSource</code>.
     */
...
export default AristaSwitchDataSource;
