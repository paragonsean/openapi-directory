...
/**
 * The BrocadeSwitchDataSource model module.
 * @module model/BrocadeSwitchDataSource
 * @version 1.0.0
 */
class BrocadeSwitchDataSource {
    /**
     * Constructs a new <code>BrocadeSwitchDataSource</code>.
     * @alias module:model/BrocadeSwitchDataSource
     * @extends module:model/SwitchDataSource
     * @implements module:model/SwitchDataSource
     */
    constructor() { 
        SwitchDataSource.initialize(this);
        BrocadeSwitchDataSource.initialize(this);
    }
    ...
    /**
     * Constructs a <code>BrocadeSwitchDataSource</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/BrocadeSwitchDataSource} obj Optional instance to populate.
     * @return {module:model/BrocadeSwitchDataSource} The populated <code>BrocadeSwitchDataSource</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new BrocadeSwitchDataSource();
    ...
    /**
     * Validates the JSON data with respect to <code>BrocadeSwitchDataSource</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>BrocadeSwitchDataSource</code>.
     */
...
export default BrocadeSwitchDataSource;
