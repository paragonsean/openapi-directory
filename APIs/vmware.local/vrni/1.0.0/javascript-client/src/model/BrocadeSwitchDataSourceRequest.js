...
/**
 * The BrocadeSwitchDataSourceRequest model module.
 * @module model/BrocadeSwitchDataSourceRequest
 * @version 1.0.0
 */
class BrocadeSwitchDataSourceRequest {
    /**
     * Constructs a new <code>BrocadeSwitchDataSourceRequest</code>.
     * @alias module:model/BrocadeSwitchDataSourceRequest
    ...
    constructor(nickname, proxyId) { 
        ...
        BrocadeSwitchDataSourceRequest.initialize(this, nickname, proxyId);
    }
    ...
    /**
     * Constructs a <code>BrocadeSwitchDataSourceRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/BrocadeSwitchDataSourceRequest} obj Optional instance to populate.
     * @return {module:model/BrocadeSwitchDataSourceRequest} The populated <code>BrocadeSwitchDataSourceRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new BrocadeSwitchDataSourceRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>BrocadeSwitchDataSourceRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>BrocadeSwitchDataSourceRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of BrocadeSwitchDataSourceRequest.RequiredProperties) {
...
BrocadeSwitchDataSourceRequest.RequiredProperties = ["nickname", "proxy_id"];

/**
 * @member {Boolean} enabled
 * @default true
 */
BrocadeSwitchDataSourceRequest.prototype['enabled'] = true;

/**
 * @member {String} fqdn
 */
BrocadeSwitchDataSourceRequest.prototype['fqdn'] = undefined;

/**
 * @member {String} ip
 */
BrocadeSwitchDataSourceRequest.prototype['ip'] = undefined;

/**
 * @member {String} nickname
 */
BrocadeSwitchDataSourceRequest.prototype['nickname'] = undefined;

/**
 * @member {String} notes
 */
BrocadeSwitchDataSourceRequest.prototype['notes'] = undefined;

/**
 * proxy vm which should register this vcenter
 * @member {String} proxy_id
 */
BrocadeSwitchDataSourceRequest.prototype['proxy_id'] = undefined;

/**
 * @member {module:model/PasswordCredentials} credentials
 */
BrocadeSwitchDataSourceRequest.prototype['credentials'] = undefined;
...
export default BrocadeSwitchDataSourceRequest;
