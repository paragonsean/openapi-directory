...
/**
 * The CheckpointFirewallDataSourceRequest model module.
 * @module model/CheckpointFirewallDataSourceRequest
 * @version 1.0.0
 */
class CheckpointFirewallDataSourceRequest {
    /**
     * Constructs a new <code>CheckpointFirewallDataSourceRequest</code>.
     * @alias module:model/CheckpointFirewallDataSourceRequest
    ...
    constructor(nickname, proxyId) { 
        ...
        CheckpointFirewallDataSourceRequest.initialize(this, nickname, proxyId);
    }
    ...
    /**
     * Constructs a <code>CheckpointFirewallDataSourceRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CheckpointFirewallDataSourceRequest} obj Optional instance to populate.
     * @return {module:model/CheckpointFirewallDataSourceRequest} The populated <code>CheckpointFirewallDataSourceRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CheckpointFirewallDataSourceRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>CheckpointFirewallDataSourceRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CheckpointFirewallDataSourceRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CheckpointFirewallDataSourceRequest.RequiredProperties) {
...
CheckpointFirewallDataSourceRequest.RequiredProperties = ["nickname", "proxy_id"];

/**
 * @member {Boolean} enabled
 * @default true
 */
CheckpointFirewallDataSourceRequest.prototype['enabled'] = true;

/**
 * @member {String} fqdn
 */
CheckpointFirewallDataSourceRequest.prototype['fqdn'] = undefined;

/**
 * @member {String} ip
 */
CheckpointFirewallDataSourceRequest.prototype['ip'] = undefined;

/**
 * @member {String} nickname
 */
CheckpointFirewallDataSourceRequest.prototype['nickname'] = undefined;

/**
 * @member {String} notes
 */
CheckpointFirewallDataSourceRequest.prototype['notes'] = undefined;

/**
 * proxy vm which should register this vcenter
 * @member {String} proxy_id
 */
CheckpointFirewallDataSourceRequest.prototype['proxy_id'] = undefined;

/**
 * @member {module:model/PasswordCredentials} credentials
 */
CheckpointFirewallDataSourceRequest.prototype['credentials'] = undefined;
...
export default CheckpointFirewallDataSourceRequest;
