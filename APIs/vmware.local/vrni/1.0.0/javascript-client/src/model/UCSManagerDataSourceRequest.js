...
/**
 * The UCSManagerDataSourceRequest model module.
 * @module model/UCSManagerDataSourceRequest
 * @version 1.0.0
 */
class UCSManagerDataSourceRequest {
    /**
     * Constructs a new <code>UCSManagerDataSourceRequest</code>.
     * @alias module:model/UCSManagerDataSourceRequest
     * @extends module:model/SwitchDataSource
     * @implements module:model/SwitchDataSource
     */
    constructor() { 
        SwitchDataSource.initialize(this);
        UCSManagerDataSourceRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>UCSManagerDataSourceRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UCSManagerDataSourceRequest} obj Optional instance to populate.
     * @return {module:model/UCSManagerDataSourceRequest} The populated <code>UCSManagerDataSourceRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UCSManagerDataSourceRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>UCSManagerDataSourceRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UCSManagerDataSourceRequest</code>.
     */
...
export default UCSManagerDataSourceRequest;
