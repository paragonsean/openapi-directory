...
/**
 * The CiscoSwitchDataSourceRequest model module.
 * @module model/CiscoSwitchDataSourceRequest
 * @version 1.0.0
 */
class CiscoSwitchDataSourceRequest {
    /**
     * Constructs a new <code>CiscoSwitchDataSourceRequest</code>.
     * @alias module:model/CiscoSwitchDataSourceRequest
    ...
    constructor(nickname, proxyId) { 
        ...
        CiscoSwitchDataSourceRequest.initialize(this, nickname, proxyId);
    }
    ...
    /**
     * Constructs a <code>CiscoSwitchDataSourceRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CiscoSwitchDataSourceRequest} obj Optional instance to populate.
     * @return {module:model/CiscoSwitchDataSourceRequest} The populated <code>CiscoSwitchDataSourceRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CiscoSwitchDataSourceRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>CiscoSwitchDataSourceRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CiscoSwitchDataSourceRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CiscoSwitchDataSourceRequest.RequiredProperties) {
...
CiscoSwitchDataSourceRequest.RequiredProperties = ["nickname", "proxy_id"];

/**
 * @member {Boolean} enabled
 * @default true
 */
CiscoSwitchDataSourceRequest.prototype['enabled'] = true;

/**
 * @member {String} fqdn
 */
CiscoSwitchDataSourceRequest.prototype['fqdn'] = undefined;

/**
 * @member {String} ip
 */
CiscoSwitchDataSourceRequest.prototype['ip'] = undefined;

/**
 * @member {String} nickname
 */
CiscoSwitchDataSourceRequest.prototype['nickname'] = undefined;

/**
 * @member {String} notes
 */
CiscoSwitchDataSourceRequest.prototype['notes'] = undefined;

/**
 * proxy vm which should register this vcenter
 * @member {String} proxy_id
 */
CiscoSwitchDataSourceRequest.prototype['proxy_id'] = undefined;

/**
 * @member {module:model/PasswordCredentials} credentials
 */
CiscoSwitchDataSourceRequest.prototype['credentials'] = undefined;

/**
 * @member {module:model/CiscoSwitchType} switch_type
 */
CiscoSwitchDataSourceRequest.prototype['switch_type'] = undefined;
...
export default CiscoSwitchDataSourceRequest;
