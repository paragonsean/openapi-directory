...
class PasswordCredentials {
    ...
    constructor(password, username) { 
        ...
        PasswordCredentials.initialize(this, password, username);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PasswordCredentials();
    ...
    /**
     * Validates the JSON data with respect to <code>PasswordCredentials</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PasswordCredentials</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of PasswordCredentials.RequiredProperties) {
...
PasswordCredentials.RequiredProperties = ["password", "username"];

/**
 * @member {String} password
 */
PasswordCredentials.prototype['password'] = undefined;

/**
 * @member {String} username
 */
PasswordCredentials.prototype['username'] = undefined;
