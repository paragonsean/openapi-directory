...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VRealizeNetworkInsightApiReference.VersionResponse();
  });
  ...
  describe('VersionResponse', function() {
    it('should create an instance of VersionResponse', function() {
      ...
      //var instance = new VRealizeNetworkInsightApiReference.VersionResponse();
      //expect(instance).to.be.a(VRealizeNetworkInsightApiReference.VersionResponse);
    });
