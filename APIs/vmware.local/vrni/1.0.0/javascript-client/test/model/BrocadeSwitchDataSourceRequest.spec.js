...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VRealizeNetworkInsightApiReference.BrocadeSwitchDataSourceRequest();
  });
  ...
  describe('BrocadeSwitchDataSourceRequest', function() {
    it('should create an instance of BrocadeSwitchDataSourceRequest', function() {
      // uncomment below and update the code to test BrocadeSwitchDataSourceRequest
      //var instance = new VRealizeNetworkInsightApiReference.BrocadeSwitchDataSourceRequest();
      //expect(instance).to.be.a(VRealizeNetworkInsightApiReference.BrocadeSwitchDataSourceRequest);
    });
