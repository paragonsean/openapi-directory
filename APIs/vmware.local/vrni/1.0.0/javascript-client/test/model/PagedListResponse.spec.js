...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VRealizeNetworkInsightApiReference.PagedListResponse();
  });
  ...
  describe('PagedListResponse', function() {
    it('should create an instance of PagedListResponse', function() {
      // uncomment below and update the code to test PagedListResponse
      //var instance = new VRealizeNetworkInsightApiReference.PagedListResponse();
      //expect(instance).to.be.a(VRealizeNetworkInsightApiReference.PagedListResponse);
    });
