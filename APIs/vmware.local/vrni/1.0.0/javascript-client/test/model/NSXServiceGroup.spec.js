...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VRealizeNetworkInsightApiReference.NSXServiceGroup();
  });
  ...
  describe('NSXServiceGroup', function() {
    it('should create an instance of NSXServiceGroup', function() {
      // uncomment below and update the code to test NSXServiceGroup
      //var instance = new VRealizeNetworkInsightApiReference.NSXServiceGroup();
      //expect(instance).to.be.a(VRealizeNetworkInsightApiReference.NSXServiceGroup);
    });
