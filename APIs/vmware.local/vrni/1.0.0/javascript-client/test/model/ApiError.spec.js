...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VRealizeNetworkInsightApiReference.ApiError();
  });
  ...
  describe('ApiError', function() {
    it('should create an instance of ApiError', function() {
      ...
      //var instance = new VRealizeNetworkInsightApiReference.ApiError();
      //expect(instance).to.be.a(VRealizeNetworkInsightApiReference.ApiError);
    });
