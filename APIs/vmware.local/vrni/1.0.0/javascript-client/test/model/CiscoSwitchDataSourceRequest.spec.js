...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VRealizeNetworkInsightApiReference.CiscoSwitchDataSourceRequest();
  });
  ...
  describe('CiscoSwitchDataSourceRequest', function() {
    it('should create an instance of CiscoSwitchDataSourceRequest', function() {
      // uncomment below and update the code to test CiscoSwitchDataSourceRequest
      //var instance = new VRealizeNetworkInsightApiReference.CiscoSwitchDataSourceRequest();
      //expect(instance).to.be.a(VRealizeNetworkInsightApiReference.CiscoSwitchDataSourceRequest);
    });
    ...
    it('should have the property switchType (base name: "switch_type")', function() {
      // uncomment below and update the code to test the property switchType
      //var instance = new VRealizeNetworkInsightApiReference.CiscoSwitchDataSourceRequest();
      //expect(instance).to.be();
    });
