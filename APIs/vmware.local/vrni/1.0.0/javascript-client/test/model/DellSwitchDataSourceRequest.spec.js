...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VRealizeNetworkInsightApiReference.DellSwitchDataSourceRequest();
  });
  ...
  describe('DellSwitchDataSourceRequest', function() {
    it('should create an instance of DellSwitchDataSourceRequest', function() {
      // uncomment below and update the code to test DellSwitchDataSourceRequest
      //var instance = new VRealizeNetworkInsightApiReference.DellSwitchDataSourceRequest();
      //expect(instance).to.be.a(VRealizeNetworkInsightApiReference.DellSwitchDataSourceRequest);
    });
