...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VRealizeNetworkInsightApiReference.Folder();
  });
  ...
  describe('Folder', function() {
    it('should create an instance of Folder', function() {
      ...
      //var instance = new VRealizeNetworkInsightApiReference.Folder();
      //expect(instance).to.be.a(VRealizeNetworkInsightApiReference.Folder);
    });
