...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VRealizeNetworkInsightApiReference.JuniperSwitchDataSourceRequest();
  });
  ...
  describe('JuniperSwitchDataSourceRequest', function() {
    it('should create an instance of JuniperSwitchDataSourceRequest', function() {
      // uncomment below and update the code to test JuniperSwitchDataSourceRequest
      //var instance = new VRealizeNetworkInsightApiReference.JuniperSwitchDataSourceRequest();
      //expect(instance).to.be.a(VRealizeNetworkInsightApiReference.JuniperSwitchDataSourceRequest);
    });
