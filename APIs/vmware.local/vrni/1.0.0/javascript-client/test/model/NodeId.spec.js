...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VRealizeNetworkInsightApiReference.NodeId();
  });
  ...
  describe('NodeId', function() {
    it('should create an instance of NodeId', function() {
      ...
      //var instance = new VRealizeNetworkInsightApiReference.NodeId();
      //expect(instance).to.be.a(VRealizeNetworkInsightApiReference.NodeId);
    });
