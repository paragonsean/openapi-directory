...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VRealizeNetworkInsightApiReference.BaseDataSource();
  });
  ...
  describe('BaseDataSource', function() {
    it('should create an instance of BaseDataSource', function() {
      // uncomment below and update the code to test BaseDataSource
      //var instance = new VRealizeNetworkInsightApiReference.BaseDataSource();
      //expect(instance).to.be.a(VRealizeNetworkInsightApiReference.BaseDataSource);
    });
