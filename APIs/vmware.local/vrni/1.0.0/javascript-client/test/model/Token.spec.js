...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VRealizeNetworkInsightApiReference.Token();
  });
  ...
  describe('Token', function() {
    it('should create an instance of Token', function() {
      ...
      //var instance = new VRealizeNetworkInsightApiReference.Token();
      //expect(instance).to.be.a(VRealizeNetworkInsightApiReference.Token);
    });
