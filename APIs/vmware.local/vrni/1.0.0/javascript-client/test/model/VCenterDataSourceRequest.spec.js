...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VRealizeNetworkInsightApiReference.VCenterDataSourceRequest();
  });
  ...
  describe('VCenterDataSourceRequest', function() {
    it('should create an instance of VCenterDataSourceRequest', function() {
      // uncomment below and update the code to test VCenterDataSourceRequest
      //var instance = new VRealizeNetworkInsightApiReference.VCenterDataSourceRequest();
      //expect(instance).to.be.a(VRealizeNetworkInsightApiReference.VCenterDataSourceRequest);
    });
