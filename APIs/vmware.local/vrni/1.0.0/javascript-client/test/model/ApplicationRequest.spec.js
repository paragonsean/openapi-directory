...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VRealizeNetworkInsightApiReference.ApplicationRequest();
  });
  ...
  describe('ApplicationRequest', function() {
    it('should create an instance of ApplicationRequest', function() {
      ...
      //var instance = new VRealizeNetworkInsightApiReference.ApplicationRequest();
      //expect(instance).to.be.a(VRealizeNetworkInsightApiReference.ApplicationRequest);
    });
