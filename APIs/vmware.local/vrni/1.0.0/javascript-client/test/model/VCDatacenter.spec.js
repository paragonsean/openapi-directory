...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VRealizeNetworkInsightApiReference.VCDatacenter();
  });
  ...
  describe('VCDatacenter', function() {
    it('should create an instance of VCDatacenter', function() {
      // uncomment below and update the code to test VCDatacenter
      //var instance = new VRealizeNetworkInsightApiReference.VCDatacenter();
      //expect(instance).to.be.a(VRealizeNetworkInsightApiReference.VCDatacenter);
    });
