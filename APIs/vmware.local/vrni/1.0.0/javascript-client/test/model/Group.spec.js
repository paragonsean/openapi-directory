...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VRealizeNetworkInsightApiReference.Group();
  });
  ...
  describe('Group', function() {
    it('should create an instance of Group', function() {
      ...
      //var instance = new VRealizeNetworkInsightApiReference.Group();
      //expect(instance).to.be.a(VRealizeNetworkInsightApiReference.Group);
    });
