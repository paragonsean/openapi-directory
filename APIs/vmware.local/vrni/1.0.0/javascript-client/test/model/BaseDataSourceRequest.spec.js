...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VRealizeNetworkInsightApiReference.BaseDataSourceRequest();
  });
  ...
  describe('BaseDataSourceRequest', function() {
    it('should create an instance of BaseDataSourceRequest', function() {
      // uncomment below and update the code to test BaseDataSourceRequest
      //var instance = new VRealizeNetworkInsightApiReference.BaseDataSourceRequest();
      //expect(instance).to.be.a(VRealizeNetworkInsightApiReference.BaseDataSourceRequest);
    });
