...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VRealizeNetworkInsightApiReference.EntityName();
  });
  ...
  describe('EntityName', function() {
    it('should create an instance of EntityName', function() {
      // uncomment below and update the code to test EntityName
      //var instance = new VRealizeNetworkInsightApiReference.EntityName();
      //expect(instance).to.be.a(VRealizeNetworkInsightApiReference.EntityName);
    });
