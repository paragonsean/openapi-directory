...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VRealizeNetworkInsightApiReference.BaseEntity();
  });
  ...
  describe('BaseEntity', function() {
    it('should create an instance of BaseEntity', function() {
      // uncomment below and update the code to test BaseEntity
      //var instance = new VRealizeNetworkInsightApiReference.BaseEntity();
      //expect(instance).to.be.a(VRealizeNetworkInsightApiReference.BaseEntity);
    });
