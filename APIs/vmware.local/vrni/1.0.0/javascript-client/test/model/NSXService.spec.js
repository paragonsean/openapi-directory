...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VRealizeNetworkInsightApiReference.NSXService();
  });
  ...
  describe('NSXService', function() {
    it('should create an instance of NSXService', function() {
      // uncomment below and update the code to test NSXService
      //var instance = new VRealizeNetworkInsightApiReference.NSXService();
      //expect(instance).to.be.a(VRealizeNetworkInsightApiReference.NSXService);
    });
