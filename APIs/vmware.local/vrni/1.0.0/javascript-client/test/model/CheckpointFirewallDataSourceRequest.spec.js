...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VRealizeNetworkInsightApiReference.CheckpointFirewallDataSourceRequest();
  });
  ...
  describe('CheckpointFirewallDataSourceRequest', function() {
    it('should create an instance of CheckpointFirewallDataSourceRequest', function() {
      // uncomment below and update the code to test CheckpointFirewallDataSourceRequest
      //var instance = new VRealizeNetworkInsightApiReference.CheckpointFirewallDataSourceRequest();
      //expect(instance).to.be.a(VRealizeNetworkInsightApiReference.CheckpointFirewallDataSourceRequest);
    });
