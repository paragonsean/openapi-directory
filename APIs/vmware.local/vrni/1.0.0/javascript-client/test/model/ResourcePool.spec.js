...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VRealizeNetworkInsightApiReference.ResourcePool();
  });
  ...
  describe('ResourcePool', function() {
    it('should create an instance of ResourcePool', function() {
      // uncomment below and update the code to test ResourcePool
      //var instance = new VRealizeNetworkInsightApiReference.ResourcePool();
      //expect(instance).to.be.a(VRealizeNetworkInsightApiReference.ResourcePool);
    });
