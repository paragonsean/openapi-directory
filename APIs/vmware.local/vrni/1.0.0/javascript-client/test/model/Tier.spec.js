...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VRealizeNetworkInsightApiReference.Tier();
  });
  ...
  describe('Tier', function() {
    it('should create an instance of Tier', function() {
      ...
      //var instance = new VRealizeNetworkInsightApiReference.Tier();
      //expect(instance).to.be.a(VRealizeNetworkInsightApiReference.Tier);
    });
