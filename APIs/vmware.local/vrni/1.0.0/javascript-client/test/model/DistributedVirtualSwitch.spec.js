...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VRealizeNetworkInsightApiReference.DistributedVirtualSwitch();
  });
  ...
  describe('DistributedVirtualSwitch', function() {
    it('should create an instance of DistributedVirtualSwitch', function() {
      // uncomment below and update the code to test DistributedVirtualSwitch
      //var instance = new VRealizeNetworkInsightApiReference.DistributedVirtualSwitch();
      //expect(instance).to.be.a(VRealizeNetworkInsightApiReference.DistributedVirtualSwitch);
    });
