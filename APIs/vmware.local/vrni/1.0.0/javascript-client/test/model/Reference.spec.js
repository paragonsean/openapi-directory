...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VRealizeNetworkInsightApiReference.Reference();
  });
  ...
  describe('Reference', function() {
    it('should create an instance of Reference', function() {
      ...
      //var instance = new VRealizeNetworkInsightApiReference.Reference();
      //expect(instance).to.be.a(VRealizeNetworkInsightApiReference.Reference);
    });
