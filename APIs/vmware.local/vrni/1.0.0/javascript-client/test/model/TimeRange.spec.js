...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VRealizeNetworkInsightApiReference.TimeRange();
  });
  ...
  describe('TimeRange', function() {
    it('should create an instance of TimeRange', function() {
      ...
      //var instance = new VRealizeNetworkInsightApiReference.TimeRange();
      //expect(instance).to.be.a(VRealizeNetworkInsightApiReference.TimeRange);
    });
