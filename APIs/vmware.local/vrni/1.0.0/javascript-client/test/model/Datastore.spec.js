...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VRealizeNetworkInsightApiReference.Datastore();
  });
  ...
  describe('Datastore', function() {
    it('should create an instance of Datastore', function() {
      ...
      //var instance = new VRealizeNetworkInsightApiReference.Datastore();
      //expect(instance).to.be.a(VRealizeNetworkInsightApiReference.Datastore);
    });
