...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VRealizeNetworkInsightApiReference.AristaSwitchDataSourceRequest();
  });
  ...
  describe('AristaSwitchDataSourceRequest', function() {
    it('should create an instance of AristaSwitchDataSourceRequest', function() {
      // uncomment below and update the code to test AristaSwitchDataSourceRequest
      //var instance = new VRealizeNetworkInsightApiReference.AristaSwitchDataSourceRequest();
      //expect(instance).to.be.a(VRealizeNetworkInsightApiReference.AristaSwitchDataSourceRequest);
    });
