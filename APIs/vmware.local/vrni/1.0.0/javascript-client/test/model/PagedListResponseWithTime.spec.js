...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VRealizeNetworkInsightApiReference.PagedListResponseWithTime();
  });
  ...
  describe('PagedListResponseWithTime', function() {
    it('should create an instance of PagedListResponseWithTime', function() {
      // uncomment below and update the code to test PagedListResponseWithTime
      //var instance = new VRealizeNetworkInsightApiReference.PagedListResponseWithTime();
      //expect(instance).to.be.a(VRealizeNetworkInsightApiReference.PagedListResponseWithTime);
    });
