...
void OAIDefaultApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("pOSTVersionsPublishAnon", defaultConf);
    _serverIndices.insert("pOSTVersionsPublishAnon", 0);
}
...
void OAIDefaultApi::pOSTVersionsPublishAnon(const ::OpenAPI::OptionalParam<OAIPOST_versions_publish_anon_request> &oaipost_versions_publish_anon_request) {
    QString fullPath = QString(_serverConfigs["pOSTVersionsPublishAnon"][_serverIndices.value("pOSTVersionsPublishAnon")].URL()+"/versions/publish/anon");
    ...
    if (oaipost_versions_publish_anon_request.hasValue()){

        
        QByteArray output = oaipost_versions_publish_anon_request.value().asJson().toUtf8();
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIDefaultApi::pOSTVersionsPublishAnonCallback);
...
void OAIDefaultApi::pOSTVersionsPublishAnonCallback(OAIHttpRequestWorker *worker) {
    ...
    OAIPOST_versions_publish_anon_200_response output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT pOSTVersionsPublishAnonSignal(output);
        Q_EMIT pOSTVersionsPublishAnonSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT pOSTVersionsPublishAnonSignalE(output, error_type, error_str);
        Q_EMIT pOSTVersionsPublishAnonSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT pOSTVersionsPublishAnonSignalError(output, error_type, error_str);
        Q_EMIT pOSTVersionsPublishAnonSignalErrorFull(worker, error_type, error_str);
    }
}
