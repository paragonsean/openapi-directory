...
public class ApiClient {
    ...
    private String basePath = "https://api.stoplight.io/v1";
    protected List<ServerConfiguration> servers = new ArrayList<ServerConfiguration>(Arrays.asList(
    new ServerConfiguration(
      "https://api.stoplight.io/v1",
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/api-v1/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://api.stoplight.io/v1
