...
import org.openapitools.client.model.DocumentChunkWithScore;
...
public class QueryResult {
  ...
  private List<DocumentChunkWithScore> results = new ArrayList<>();
  ...
  public QueryResult results(List<DocumentChunkWithScore> results) {
    this.results = results;
    return this;
  }

  public QueryResult addResultsItem(DocumentChunkWithScore resultsItem) {
   ...
   */
  @javax.annotation.Nonnull
  public List<DocumentChunkWithScore> getResults() {
    return results;
  }

  public void setResults(List<DocumentChunkWithScore> results) {
    this.results = results;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.query, queryResult.query) &&
        Objects.equals(this.results, queryResult.results);
  }

  @Override
  public int hashCode() {
    return Objects.hash(query, results);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (int i = 0; i < jsonArrayresults.size(); i++) {
        DocumentChunkWithScore.validateJsonElement(jsonArrayresults.get(i));
      };
  }
