...
void OAIDefaultApi::initializeServerConfigs() {
    ...
    defaultConf.append(OAIServerConfiguration(
    QUrl("https://retriever.openindex.ai"),
    "No description provided",
    QMap<QString, OAIServerVariable>()));
    _serverConfigs.insert("queryQueryPost", defaultConf);
    _serverIndices.insert("queryQueryPost", 0);
}
...
void OAIDefaultApi::queryQueryPost(const OAIQueryRequest &oai_query_request) {
    QString fullPath = QString(_serverConfigs["queryQueryPost"][_serverIndices.value("queryQueryPost")].URL()+"/query");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIDefaultApi::queryQueryPostCallback);
...
void OAIDefaultApi::queryQueryPostCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT queryQueryPostSignal(output);
        Q_EMIT queryQueryPostSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT queryQueryPostSignalE(output, error_type, error_str);
        Q_EMIT queryQueryPostSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT queryQueryPostSignalError(output, error_type, error_str);
        Q_EMIT queryQueryPostSignalErrorFull(worker, error_type, error_str);
    }
}
