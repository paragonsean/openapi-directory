...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenIndexRetrievalPluginApi.ValidationError();
  });
  ...
  describe('ValidationError', function() {
    it('should create an instance of ValidationError', function() {
      ...
      //var instance = new OpenIndexRetrievalPluginApi.ValidationError();
      //expect(instance).to.be.a(OpenIndexRetrievalPluginApi.ValidationError);
    });
