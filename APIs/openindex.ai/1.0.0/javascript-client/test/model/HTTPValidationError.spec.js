...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenIndexRetrievalPluginApi.HTTPValidationError();
  });
  ...
  describe('HTTPValidationError', function() {
    it('should create an instance of HTTPValidationError', function() {
      ...
      //var instance = new OpenIndexRetrievalPluginApi.HTTPValidationError();
      //expect(instance).to.be.a(OpenIndexRetrievalPluginApi.HTTPValidationError);
    });
