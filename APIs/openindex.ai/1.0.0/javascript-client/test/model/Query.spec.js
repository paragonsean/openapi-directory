...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenIndexRetrievalPluginApi.Query();
  });
  ...
  describe('Query', function() {
    it('should create an instance of Query', function() {
      ...
      //var instance = new OpenIndexRetrievalPluginApi.Query();
      //expect(instance).to.be.a(OpenIndexRetrievalPluginApi.Query);
    });
