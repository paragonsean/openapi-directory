...
Q_SIGNALS:
    ...
    void healthSignal(OAIOtoroshiHealth summary);


    void healthSignalFull(OAIHttpRequestWorker *worker, OAIOtoroshiHealth summary);

    Q_DECL_DEPRECATED_X("Use healthSignalError() instead")
    void healthSignalE(OAIOtoroshiHealth summary, QNetworkReply::NetworkError error_type, QString error_str);
    void healthSignalError(OAIOtoroshiHealth summary, QNetworkReply::NetworkError error_type, const QString &error_str);
