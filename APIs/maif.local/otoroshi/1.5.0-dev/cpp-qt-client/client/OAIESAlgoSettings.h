...
#ifndef OAIESAlgoSettings_H
#define OAIESAlgoSettings_H
...
class OAIESAlgoSettings : public OAIObject {
public:
    OAIESAlgoSettings();
    OAIESAlgoSettings(QString json);
    ~OAIESAlgoSettings() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIESAlgoSettings)

#endif // OAIESAlgoSettings_H
