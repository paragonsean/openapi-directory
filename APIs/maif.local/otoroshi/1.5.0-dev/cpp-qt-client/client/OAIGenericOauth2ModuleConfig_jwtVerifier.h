...
/*
 * OAIGenericOauth2ModuleConfig_jwtVerifier.h
 *
 * Algo. settings to verify JWT token
 */

#ifndef OAIGenericOauth2ModuleConfig_jwtVerifier_H
#define OAIGenericOauth2ModuleConfig_jwtVerifier_H
...
class OAIGenericOauth2ModuleConfig_jwtVerifier : public OAIObject {
public:
    OAIGenericOauth2ModuleConfig_jwtVerifier();
    OAIGenericOauth2ModuleConfig_jwtVerifier(QString json);
    ~OAIGenericOauth2ModuleConfig_jwtVerifier() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGenericOauth2ModuleConfig_jwtVerifier)

#endif // OAIGenericOauth2ModuleConfig_jwtVerifier_H
