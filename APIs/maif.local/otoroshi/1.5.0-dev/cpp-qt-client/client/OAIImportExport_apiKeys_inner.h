...
/*
 * OAIImportExport_apiKeys_inner.h
 *
...
#ifndef OAIImportExport_apiKeys_inner_H
#define OAIImportExport_apiKeys_inner_H
...
class OAIImportExport_apiKeys_inner : public OAIObject {
public:
    OAIImportExport_apiKeys_inner();
    OAIImportExport_apiKeys_inner(QString json);
    ~OAIImportExport_apiKeys_inner() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIImportExport_apiKeys_inner)

#endif // OAIImportExport_apiKeys_inner_H
