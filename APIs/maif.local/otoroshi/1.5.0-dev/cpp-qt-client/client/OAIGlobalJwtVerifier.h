...
/*
 * OAIGlobalJwtVerifier.h
 *
 * A JWT verifier used by multiple service descriptor
 */

#ifndef OAIGlobalJwtVerifier_H
#define OAIGlobalJwtVerifier_H
...
class OAIGlobalJwtVerifier : public OAIObject {
public:
    OAIGlobalJwtVerifier();
    OAIGlobalJwtVerifier(QString json);
    ~OAIGlobalJwtVerifier() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGlobalJwtVerifier)

#endif // OAIGlobalJwtVerifier_H
