...
/*
 * OAIGenericOauth2ModuleConfig.h
 *
 * Settings to authenticate users using a generic OAuth2 provider
 */

#ifndef OAIGenericOauth2ModuleConfig_H
#define OAIGenericOauth2ModuleConfig_H
...
class OAIGenericOauth2ModuleConfig : public OAIObject {
public:
    OAIGenericOauth2ModuleConfig();
    OAIGenericOauth2ModuleConfig(QString json);
    ~OAIGenericOauth2ModuleConfig() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGenericOauth2ModuleConfig)

#endif // OAIGenericOauth2ModuleConfig_H
