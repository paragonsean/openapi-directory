...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OtoroshiAdminApi.GroupsApi();
  });
  ...
  describe('GroupsApi', function() {
    describe('allServiceGroups', function() {
      it('should call allServiceGroups successfully', function(done) {
        //uncomment below and update the code to test allServiceGroups
        //instance.allServiceGroups(function(error) {
    ...
    describe('serviceGroup', function() {
      it('should call serviceGroup successfully', function(done) {
        //uncomment below and update the code to test serviceGroup
        //instance.serviceGroup(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
