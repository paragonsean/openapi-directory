...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OtoroshiAdminApi.PulsarDataExporterConfig();
  });
  ...
  describe('PulsarDataExporterConfig', function() {
    it('should create an instance of PulsarDataExporterConfig', function() {
      // uncomment below and update the code to test PulsarDataExporterConfig
      //var instance = new OtoroshiAdminApi.PulsarDataExporterConfig();
      //expect(instance).to.be.a(OtoroshiAdminApi.PulsarDataExporterConfig);
    });
