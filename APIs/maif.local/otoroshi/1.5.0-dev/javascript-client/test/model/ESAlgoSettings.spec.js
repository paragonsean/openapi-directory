...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OtoroshiAdminApi.ESAlgoSettings();
  });
  ...
  describe('ESAlgoSettings', function() {
    it('should create an instance of ESAlgoSettings', function() {
      // uncomment below and update the code to test ESAlgoSettings
      //var instance = new OtoroshiAdminApi.ESAlgoSettings();
      //expect(instance).to.be.a(OtoroshiAdminApi.ESAlgoSettings);
    });
