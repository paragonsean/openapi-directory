...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OtoroshiAdminApi.Auth0Config();
  });
  ...
  describe('Auth0Config', function() {
    it('should create an instance of Auth0Config', function() {
      // uncomment below and update the code to test Auth0Config
      //var instance = new OtoroshiAdminApi.Auth0Config();
      //expect(instance).to.be.a(OtoroshiAdminApi.Auth0Config);
    });
