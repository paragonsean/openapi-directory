...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OtoroshiAdminApi.Outage();
  });
  ...
  describe('Outage', function() {
    it('should create an instance of Outage', function() {
      // uncomment below and update the code to test Outage
      //var instance = new OtoroshiAdminApi.Outage();
      //expect(instance).to.be.a(OtoroshiAdminApi.Outage);
    });
