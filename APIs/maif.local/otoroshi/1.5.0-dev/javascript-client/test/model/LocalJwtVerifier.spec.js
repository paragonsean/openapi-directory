...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OtoroshiAdminApi.LocalJwtVerifier();
  });
  ...
  describe('LocalJwtVerifier', function() {
    it('should create an instance of LocalJwtVerifier', function() {
      // uncomment below and update the code to test LocalJwtVerifier
      //var instance = new OtoroshiAdminApi.LocalJwtVerifier();
      //expect(instance).to.be.a(OtoroshiAdminApi.LocalJwtVerifier);
    });
