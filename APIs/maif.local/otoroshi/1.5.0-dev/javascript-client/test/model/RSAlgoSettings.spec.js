...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OtoroshiAdminApi.RSAlgoSettings();
  });
  ...
  describe('RSAlgoSettings', function() {
    it('should create an instance of RSAlgoSettings', function() {
      // uncomment below and update the code to test RSAlgoSettings
      //var instance = new OtoroshiAdminApi.RSAlgoSettings();
      //expect(instance).to.be.a(OtoroshiAdminApi.RSAlgoSettings);
    });
