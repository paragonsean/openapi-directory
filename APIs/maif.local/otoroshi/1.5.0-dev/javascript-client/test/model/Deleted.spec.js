...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OtoroshiAdminApi.Deleted();
  });
  ...
  describe('Deleted', function() {
    it('should create an instance of Deleted', function() {
      // uncomment below and update the code to test Deleted
      //var instance = new OtoroshiAdminApi.Deleted();
      //expect(instance).to.be.a(OtoroshiAdminApi.Deleted);
    });
