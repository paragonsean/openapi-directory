...
/**
 * The ImportExportErrorTemplatesInner model module.
 * @module model/ImportExportErrorTemplatesInner
 * @version 1.5.0-dev
 */
class ImportExportErrorTemplatesInner {
    /**
     * Constructs a new <code>ImportExportErrorTemplatesInner</code>.
     * Error templates for a service descriptor
     * @alias module:model/ImportExportErrorTemplatesInner
    ...
    constructor(messages, serviceId, template40x, template50x, templateBuild, templateMaintenance) { 
        ...
        ImportExportErrorTemplatesInner.initialize(this, messages, serviceId, template40x, template50x, templateBuild, templateMaintenance);
    }
    ...
    /**
     * Constructs a <code>ImportExportErrorTemplatesInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ImportExportErrorTemplatesInner} obj Optional instance to populate.
     * @return {module:model/ImportExportErrorTemplatesInner} The populated <code>ImportExportErrorTemplatesInner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ImportExportErrorTemplatesInner();
    ...
    /**
     * Validates the JSON data with respect to <code>ImportExportErrorTemplatesInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ImportExportErrorTemplatesInner</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ImportExportErrorTemplatesInner.RequiredProperties) {
...
ImportExportErrorTemplatesInner.RequiredProperties = ["messages", "serviceId", "template40x", "template50x", "templateBuild", "templateMaintenance"];

/**
 * Map for custom messages
 * @member {Object.<String, String>} messages
 */
ImportExportErrorTemplatesInner.prototype['messages'] = undefined;

/**
 * The Id of the service for which the error template is enabled
 * @member {String} serviceId
 */
ImportExportErrorTemplatesInner.prototype['serviceId'] = undefined;

/**
 * The html template for 40x errors
 * @member {String} template40x
 */
ImportExportErrorTemplatesInner.prototype['template40x'] = undefined;

/**
 * The html template for 50x errors
 * @member {String} template50x
 */
ImportExportErrorTemplatesInner.prototype['template50x'] = undefined;

/**
 * The html template for build page
 * @member {String} templateBuild
 */
ImportExportErrorTemplatesInner.prototype['templateBuild'] = undefined;

/**
 * The html template for maintenance page
 * @member {String} templateMaintenance
 */
ImportExportErrorTemplatesInner.prototype['templateMaintenance'] = undefined;
...
export default ImportExportErrorTemplatesInner;
