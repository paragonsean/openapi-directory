...
class ApiKey {
    ...
    constructor(authorizedEntities, clientId, clientName, clientSecret, enabled) { 
        ...
        ApiKey.initialize(this, authorizedEntities, clientId, clientName, clientSecret, enabled);
    }
...
ApiKey.RequiredProperties = ["authorizedEntities", "clientId", "clientName", "clientSecret", "enabled"];
