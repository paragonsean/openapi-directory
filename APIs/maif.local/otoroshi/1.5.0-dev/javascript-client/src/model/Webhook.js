...
class Webhook {
     ...
     * @param headers {Object.<String, String>} Headers to authorize the call or whatever
     * @param url {String} The URL where events are posted
     */
    constructor(headers, url) { 
        
        Webhook.initialize(this, headers, url);
    }
...
Webhook.RequiredProperties = ["headers", "url"];
