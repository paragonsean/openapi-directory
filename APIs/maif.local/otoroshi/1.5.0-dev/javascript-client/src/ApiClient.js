...
class ApiClient {
     ...
     */
    constructor(basePath = 'http://otoroshi-api.oto.tools') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default http://otoroshi-api.oto.tools
         */
         ...
         */
        this.defaultHeaders = {
            'User-Agent': 'OpenAPI-Generator/1.5.0-dev/Javascript'
        };
