...
**dailyQuota** | **Number** | Authorized number of calls per day | [optional] 
**enabled** | **Boolean** | Whether or not the key is enabled. If disabled, resources won&#39;t be available to calls using this key | 
**metadata** | **{String: String}** | Bunch of metadata for the key | [optional] 
**monthlyQuota** | **Number** | Authorized number of calls per month | [optional] 
**throttlingQuota** | **Number** | Authorized number of calls per second, measured on 10 seconds | [optional] 
