# OtoroshiAdminApi.ImportExportServiceDescriptorsInner
...
**additionalHeaders** | **{String: String}** | Specify headers that will be added to each client request. Useful to add authentication | [optional] 
...
**groups** | **[String]** | Each service descriptor is attached to groups. A group can have one or more services. Each API key is linked to a group and allow access to every service in the group | 
**gzip** | [**Gzip**](Gzip.md) |  | [optional] 
**headersVerification** | **{String: String}** | Specify headers that will be verified after routing. | [optional] 
...
**matchingHeaders** | **{String: String}** | Specify headers that MUST be present on client request to route it. Useful to implement versioning | [optional] 
**matchingRoot** | **String** | The root path on which the service is available | [optional] 
**metadata** | **{String: String}** | Just a bunch of random properties | [optional] 
...
**privatePatterns** | **[String]** | If you define a public pattern that is a little bit too much, you can make some of public URL private again | [optional] 
**publicPatterns** | **[String]** | By default, every services are private only and you&#39;ll need an API key to access it. However, if you want to expose a public UI, you can define one or more public patterns (regex) to allow access to anybody. For example if you want to allow anybody on any URL, just use &#39;/.*&#39; | [optional] 
...
**secComExcludedPatterns** | **[String]** | URI patterns excluded from secured communications | [optional] 
