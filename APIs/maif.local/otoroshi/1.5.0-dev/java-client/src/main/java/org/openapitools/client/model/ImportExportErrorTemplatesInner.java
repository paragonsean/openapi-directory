...
public class ImportExportErrorTemplatesInner {
  ...
  public ImportExportErrorTemplatesInner() {
  }

  public ImportExportErrorTemplatesInner messages(Map<String, String> messages) {
    this.messages = messages;
    return this;
  }

  public ImportExportErrorTemplatesInner putMessagesItem(String key, String messagesItem) {
  ...
  public ImportExportErrorTemplatesInner serviceId(String serviceId) {
  ...
  public ImportExportErrorTemplatesInner template40x(String template40x) {
  ...
  public ImportExportErrorTemplatesInner template50x(String template50x) {
  ...
  public ImportExportErrorTemplatesInner templateBuild(String templateBuild) {
  ...
  public ImportExportErrorTemplatesInner templateMaintenance(String templateMaintenance) {
  ...
  public boolean equals(Object o) {
    ...
    ImportExportErrorTemplatesInner importExportErrorTemplatesInner = (ImportExportErrorTemplatesInner) o;
    return Objects.equals(this.messages, importExportErrorTemplatesInner.messages) &&
        Objects.equals(this.serviceId, importExportErrorTemplatesInner.serviceId) &&
        Objects.equals(this.template40x, importExportErrorTemplatesInner.template40x) &&
        Objects.equals(this.template50x, importExportErrorTemplatesInner.template50x) &&
        Objects.equals(this.templateBuild, importExportErrorTemplatesInner.templateBuild) &&
        Objects.equals(this.templateMaintenance, importExportErrorTemplatesInner.templateMaintenance);
  }
  ...
  public String toString() {
    ...
    sb.append("class ImportExportErrorTemplatesInner {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ImportExportErrorTemplatesInner
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ImportExportErrorTemplatesInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ImportExportErrorTemplatesInner is not found in the empty JSON string", ImportExportErrorTemplatesInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ImportExportErrorTemplatesInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ImportExportErrorTemplatesInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ImportExportErrorTemplatesInner.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ImportExportErrorTemplatesInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ImportExportErrorTemplatesInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ImportExportErrorTemplatesInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ImportExportErrorTemplatesInner.class));

       return (TypeAdapter<T>) new TypeAdapter<ImportExportErrorTemplatesInner>() {
           @Override
           public void write(JsonWriter out, ImportExportErrorTemplatesInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ImportExportErrorTemplatesInner read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ImportExportErrorTemplatesInner given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ImportExportErrorTemplatesInner
   * @throws IOException if the JSON string is invalid with respect to ImportExportErrorTemplatesInner
   */
  public static ImportExportErrorTemplatesInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ImportExportErrorTemplatesInner.class);
  }

  /**
   * Convert an instance of ImportExportErrorTemplatesInner to an JSON string
   *
   * @return JSON string
   */
