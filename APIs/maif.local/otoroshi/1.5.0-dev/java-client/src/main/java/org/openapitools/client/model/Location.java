...
public class Location {
  ...
  public Location teams(List<Map<String, String>> teams) {
    this.teams = teams;
    return this;
  }

  public Location addTeamsItem(Map<String, String> teamsItem) {
    if (this.teams == null) {
  ...
  public Location tenant(String tenant) {
    this.tenant = tenant;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.teams, location.teams) &&
        Objects.equals(this.tenant, location.tenant);
  }

  @Override
  public int hashCode() {
    return Objects.hash(teams, tenant);
  }
