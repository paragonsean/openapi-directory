...
public class ImportExportApiKeysInner {
  ...
  public ImportExportApiKeysInner() {
  }

  public ImportExportApiKeysInner authorizedEntities(List<String> authorizedEntities) {
    this.authorizedEntities = authorizedEntities;
    return this;
  }

  public ImportExportApiKeysInner addAuthorizedEntitiesItem(String authorizedEntitiesItem) {
  ...
  public ImportExportApiKeysInner clientId(String clientId) {
  ...
  public ImportExportApiKeysInner clientName(String clientName) {
  ...
  public ImportExportApiKeysInner clientSecret(String clientSecret) {
  ...
  public ImportExportApiKeysInner dailyQuota(Long dailyQuota) {
  ...
  public ImportExportApiKeysInner enabled(Boolean enabled) {
  ...
  public ImportExportApiKeysInner metadata(Map<String, String> metadata) {
    this.metadata = metadata;
    return this;
  }

  public ImportExportApiKeysInner putMetadataItem(String key, String metadataItem) {
  ...
  public ImportExportApiKeysInner monthlyQuota(Long monthlyQuota) {
  ...
  public ImportExportApiKeysInner throttlingQuota(Long throttlingQuota) {
  ...
  public boolean equals(Object o) {
    ...
    ImportExportApiKeysInner importExportApiKeysInner = (ImportExportApiKeysInner) o;
    return Objects.equals(this.authorizedEntities, importExportApiKeysInner.authorizedEntities) &&
        Objects.equals(this.clientId, importExportApiKeysInner.clientId) &&
        Objects.equals(this.clientName, importExportApiKeysInner.clientName) &&
        Objects.equals(this.clientSecret, importExportApiKeysInner.clientSecret) &&
        Objects.equals(this.dailyQuota, importExportApiKeysInner.dailyQuota) &&
        Objects.equals(this.enabled, importExportApiKeysInner.enabled) &&
        Objects.equals(this.metadata, importExportApiKeysInner.metadata) &&
        Objects.equals(this.monthlyQuota, importExportApiKeysInner.monthlyQuota) &&
        Objects.equals(this.throttlingQuota, importExportApiKeysInner.throttlingQuota);
  }
  ...
  public String toString() {
    ...
    sb.append("class ImportExportApiKeysInner {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ImportExportApiKeysInner
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ImportExportApiKeysInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ImportExportApiKeysInner is not found in the empty JSON string", ImportExportApiKeysInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ImportExportApiKeysInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ImportExportApiKeysInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ImportExportApiKeysInner.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ImportExportApiKeysInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ImportExportApiKeysInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ImportExportApiKeysInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ImportExportApiKeysInner.class));

       return (TypeAdapter<T>) new TypeAdapter<ImportExportApiKeysInner>() {
           @Override
           public void write(JsonWriter out, ImportExportApiKeysInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ImportExportApiKeysInner read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ImportExportApiKeysInner given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ImportExportApiKeysInner
   * @throws IOException if the JSON string is invalid with respect to ImportExportApiKeysInner
   */
  public static ImportExportApiKeysInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ImportExportApiKeysInner.class);
  }

  /**
   * Convert an instance of ImportExportApiKeysInner to an JSON string
   *
   * @return JSON string
   */
