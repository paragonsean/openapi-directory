...
public class ApiClient {
    ...
    private String basePath = "http://otoroshi-api.oto.tools";
    ...
    public ApiClient() {
        ...
        authentications.put("otoroshi_auth", new HttpBasicAuth());
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/1.5.0-dev/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g http://otoroshi-api.oto.tools
