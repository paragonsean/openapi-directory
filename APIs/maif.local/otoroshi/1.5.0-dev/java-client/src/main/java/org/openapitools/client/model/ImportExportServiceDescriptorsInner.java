...
public class ImportExportServiceDescriptorsInner {
  ...
  public ImportExportServiceDescriptorsInner() {
  }

  public ImportExportServiceDescriptorsInner canary(Canary canary) {
    this.canary = canary;
    return this;
  }
  ...
  public ImportExportServiceDescriptorsInner additionalHeaders(Map<String, String> additionalHeaders) {
    this.additionalHeaders = additionalHeaders;
    return this;
  }

  public ImportExportServiceDescriptorsInner putAdditionalHeadersItem(String key, String additionalHeadersItem) {
  ...
  public ImportExportServiceDescriptorsInner api(ExposedApi api) {
    this.api = api;
    return this;
  }
  ...
  public ImportExportServiceDescriptorsInner authConfigRef(String authConfigRef) {
  ...
  public ImportExportServiceDescriptorsInner buildMode(Boolean buildMode) {
  ...
  public ImportExportServiceDescriptorsInner chaosConfig(ChaosConfig chaosConfig) {
  ...
  public ImportExportServiceDescriptorsInner clientConfig(ClientConfig clientConfig) {
  ...
  public ImportExportServiceDescriptorsInner clientValidatorRef(String clientValidatorRef) {
  ...
  public ImportExportServiceDescriptorsInner cors(CorsSettings cors) {
    this.cors = cors;
    return this;
  }
  ...
  public ImportExportServiceDescriptorsInner domain(String domain) {
    this.domain = domain;
    return this;
  }
  ...
  public ImportExportServiceDescriptorsInner enabled(Boolean enabled) {
  ...
  public ImportExportServiceDescriptorsInner enforceSecureCommunication(Boolean enforceSecureCommunication) {
  ...
  public ImportExportServiceDescriptorsInner env(String env) {
    this.env = env;
    return this;
  }
  ...
  public ImportExportServiceDescriptorsInner forceHttps(Boolean forceHttps) {
  ...
  public ImportExportServiceDescriptorsInner groups(List<String> groups) {
    this.groups = groups;
    return this;
  }

  public ImportExportServiceDescriptorsInner addGroupsItem(String groupsItem) {
    if (this.groups == null) {
  ...
  public ImportExportServiceDescriptorsInner gzip(Gzip gzip) {
    this.gzip = gzip;
    return this;
  }
  ...
  public ImportExportServiceDescriptorsInner headersVerification(Map<String, String> headersVerification) {
    this.headersVerification = headersVerification;
    return this;
  }

  public ImportExportServiceDescriptorsInner putHeadersVerificationItem(String key, String headersVerificationItem) {
  ...
  public ImportExportServiceDescriptorsInner healthCheck(HealthCheck healthCheck) {
  ...
  public ImportExportServiceDescriptorsInner id(UUID id) {
    this.id = id;
    return this;
  }
  ...
  public ImportExportServiceDescriptorsInner ipFiltering(IpFiltering ipFiltering) {
  ...
  public ImportExportServiceDescriptorsInner jwtVerifier(ImportExportServiceDescriptorsInnerJwtVerifier jwtVerifier) {
  ...
  public ImportExportServiceDescriptorsInner localHost(String localHost) {
  ...
  public ImportExportServiceDescriptorsInner localScheme(String localScheme) {
  ...
  public ImportExportServiceDescriptorsInner maintenanceMode(Boolean maintenanceMode) {
  ...
  public ImportExportServiceDescriptorsInner matchingHeaders(Map<String, String> matchingHeaders) {
    this.matchingHeaders = matchingHeaders;
    return this;
  }

  public ImportExportServiceDescriptorsInner putMatchingHeadersItem(String key, String matchingHeadersItem) {
  ...
  public ImportExportServiceDescriptorsInner matchingRoot(String matchingRoot) {
  ...
  public ImportExportServiceDescriptorsInner metadata(Map<String, String> metadata) {
    this.metadata = metadata;
    return this;
  }

  public ImportExportServiceDescriptorsInner putMetadataItem(String key, String metadataItem) {
  ...
  public ImportExportServiceDescriptorsInner name(String name) {
    this.name = name;
    return this;
  }
  ...
  public ImportExportServiceDescriptorsInner overrideHost(Boolean overrideHost) {
  ...
  public ImportExportServiceDescriptorsInner privateApp(Boolean privateApp) {
  ...
  public ImportExportServiceDescriptorsInner privatePatterns(List<String> privatePatterns) {
    this.privatePatterns = privatePatterns;
    return this;
  }

  public ImportExportServiceDescriptorsInner addPrivatePatternsItem(String privatePatternsItem) {
  ...
  public ImportExportServiceDescriptorsInner publicPatterns(List<String> publicPatterns) {
    this.publicPatterns = publicPatterns;
    return this;
  }

  public ImportExportServiceDescriptorsInner addPublicPatternsItem(String publicPatternsItem) {
  ...
  public ImportExportServiceDescriptorsInner redirectToLocal(Boolean redirectToLocal) {
  ...
  public ImportExportServiceDescriptorsInner redirection(RedirectionSettings redirection) {
  ...
  public ImportExportServiceDescriptorsInner root(String root) {
    this.root = root;
    return this;
  }
  ...
  public ImportExportServiceDescriptorsInner secComExcludedPatterns(List<String> secComExcludedPatterns) {
    this.secComExcludedPatterns = secComExcludedPatterns;
    return this;
  }

  public ImportExportServiceDescriptorsInner addSecComExcludedPatternsItem(String secComExcludedPatternsItem) {
  ...
  public ImportExportServiceDescriptorsInner secComSettings(GlobalJwtVerifierAlgoSettings secComSettings) {
  ...
  public ImportExportServiceDescriptorsInner sendOtoroshiHeadersBack(Boolean sendOtoroshiHeadersBack) {
  ...
  public ImportExportServiceDescriptorsInner statsdConfig(StatsdConfig statsdConfig) {
  ...
  public ImportExportServiceDescriptorsInner subdomain(String subdomain) {
  ...
  public ImportExportServiceDescriptorsInner targets(List<Target> targets) {
    this.targets = targets;
    return this;
  }

  public ImportExportServiceDescriptorsInner addTargetsItem(Target targetsItem) {
  ...
  public ImportExportServiceDescriptorsInner transformerRef(String transformerRef) {
  ...
  public ImportExportServiceDescriptorsInner userFacing(Boolean userFacing) {
  ...
  public ImportExportServiceDescriptorsInner xForwardedHeaders(Boolean xForwardedHeaders) {
  ...
  public boolean equals(Object o) {
    ...
    ImportExportServiceDescriptorsInner importExportServiceDescriptorsInner = (ImportExportServiceDescriptorsInner) o;
    return Objects.equals(this.canary, importExportServiceDescriptorsInner.canary) &&
        Objects.equals(this.additionalHeaders, importExportServiceDescriptorsInner.additionalHeaders) &&
        Objects.equals(this.api, importExportServiceDescriptorsInner.api) &&
        Objects.equals(this.authConfigRef, importExportServiceDescriptorsInner.authConfigRef) &&
        Objects.equals(this.buildMode, importExportServiceDescriptorsInner.buildMode) &&
        Objects.equals(this.chaosConfig, importExportServiceDescriptorsInner.chaosConfig) &&
        Objects.equals(this.clientConfig, importExportServiceDescriptorsInner.clientConfig) &&
        Objects.equals(this.clientValidatorRef, importExportServiceDescriptorsInner.clientValidatorRef) &&
        Objects.equals(this.cors, importExportServiceDescriptorsInner.cors) &&
        Objects.equals(this.domain, importExportServiceDescriptorsInner.domain) &&
        Objects.equals(this.enabled, importExportServiceDescriptorsInner.enabled) &&
        Objects.equals(this.enforceSecureCommunication, importExportServiceDescriptorsInner.enforceSecureCommunication) &&
        Objects.equals(this.env, importExportServiceDescriptorsInner.env) &&
        Objects.equals(this.forceHttps, importExportServiceDescriptorsInner.forceHttps) &&
        Objects.equals(this.groups, importExportServiceDescriptorsInner.groups) &&
        Objects.equals(this.gzip, importExportServiceDescriptorsInner.gzip) &&
        Objects.equals(this.headersVerification, importExportServiceDescriptorsInner.headersVerification) &&
        Objects.equals(this.healthCheck, importExportServiceDescriptorsInner.healthCheck) &&
        Objects.equals(this.id, importExportServiceDescriptorsInner.id) &&
        Objects.equals(this.ipFiltering, importExportServiceDescriptorsInner.ipFiltering) &&
        Objects.equals(this.jwtVerifier, importExportServiceDescriptorsInner.jwtVerifier) &&
        Objects.equals(this.localHost, importExportServiceDescriptorsInner.localHost) &&
        Objects.equals(this.localScheme, importExportServiceDescriptorsInner.localScheme) &&
        Objects.equals(this.maintenanceMode, importExportServiceDescriptorsInner.maintenanceMode) &&
        Objects.equals(this.matchingHeaders, importExportServiceDescriptorsInner.matchingHeaders) &&
        Objects.equals(this.matchingRoot, importExportServiceDescriptorsInner.matchingRoot) &&
        Objects.equals(this.metadata, importExportServiceDescriptorsInner.metadata) &&
        Objects.equals(this.name, importExportServiceDescriptorsInner.name) &&
        Objects.equals(this.overrideHost, importExportServiceDescriptorsInner.overrideHost) &&
        Objects.equals(this.privateApp, importExportServiceDescriptorsInner.privateApp) &&
        Objects.equals(this.privatePatterns, importExportServiceDescriptorsInner.privatePatterns) &&
        Objects.equals(this.publicPatterns, importExportServiceDescriptorsInner.publicPatterns) &&
        Objects.equals(this.redirectToLocal, importExportServiceDescriptorsInner.redirectToLocal) &&
        Objects.equals(this.redirection, importExportServiceDescriptorsInner.redirection) &&
        Objects.equals(this.root, importExportServiceDescriptorsInner.root) &&
        Objects.equals(this.secComExcludedPatterns, importExportServiceDescriptorsInner.secComExcludedPatterns) &&
        Objects.equals(this.secComSettings, importExportServiceDescriptorsInner.secComSettings) &&
        Objects.equals(this.sendOtoroshiHeadersBack, importExportServiceDescriptorsInner.sendOtoroshiHeadersBack) &&
        Objects.equals(this.statsdConfig, importExportServiceDescriptorsInner.statsdConfig) &&
        Objects.equals(this.subdomain, importExportServiceDescriptorsInner.subdomain) &&
        Objects.equals(this.targets, importExportServiceDescriptorsInner.targets) &&
        Objects.equals(this.transformerRef, importExportServiceDescriptorsInner.transformerRef) &&
        Objects.equals(this.userFacing, importExportServiceDescriptorsInner.userFacing) &&
        Objects.equals(this.xForwardedHeaders, importExportServiceDescriptorsInner.xForwardedHeaders);
  }
  ...
  public String toString() {
    ...
    sb.append("class ImportExportServiceDescriptorsInner {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ImportExportServiceDescriptorsInner
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ImportExportServiceDescriptorsInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ImportExportServiceDescriptorsInner is not found in the empty JSON string", ImportExportServiceDescriptorsInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ImportExportServiceDescriptorsInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ImportExportServiceDescriptorsInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ImportExportServiceDescriptorsInner.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ImportExportServiceDescriptorsInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ImportExportServiceDescriptorsInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ImportExportServiceDescriptorsInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ImportExportServiceDescriptorsInner.class));

       return (TypeAdapter<T>) new TypeAdapter<ImportExportServiceDescriptorsInner>() {
           @Override
           public void write(JsonWriter out, ImportExportServiceDescriptorsInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ImportExportServiceDescriptorsInner read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ImportExportServiceDescriptorsInner given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ImportExportServiceDescriptorsInner
   * @throws IOException if the JSON string is invalid with respect to ImportExportServiceDescriptorsInner
   */
  public static ImportExportServiceDescriptorsInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ImportExportServiceDescriptorsInner.class);
  }

  /**
   * Convert an instance of ImportExportServiceDescriptorsInner to an JSON string
   *
   * @return JSON string
   */
