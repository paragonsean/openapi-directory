...
class ErrorTemplate(Model):
    ...
    def __init__(self, messages: Dict[str, str]=None, service_id: str=None, template40x: str=None, template50x: str=None, template_build: str=None, template_maintenance: str=None):
        """ErrorTemplate - a model defined in OpenAPI

        :param messages: The messages of this ErrorTemplate.
        :param service_id: The service_id of this ErrorTemplate.
        :param template40x: The template40x of this ErrorTemplate.
        :param template50x: The template50x of this ErrorTemplate.
        :param template_build: The template_build of this ErrorTemplate.
        :param template_maintenance: The template_maintenance of this ErrorTemplate.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'ErrorTemplate':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The ErrorTemplate of this ErrorTemplate.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def messages(self):
        """Gets the messages of this ErrorTemplate.

        Map for custom messages

        :return: The messages of this ErrorTemplate.
        :rtype: Dict[str, str]
        """
    ...
    def messages(self, messages):
        """Sets the messages of this ErrorTemplate.
    ...
    @property
    def service_id(self):
        """Gets the service_id of this ErrorTemplate.

        The Id of the service for which the error template is enabled

        :return: The service_id of this ErrorTemplate.
        :rtype: str
        """
    ...
    def service_id(self, service_id):
        """Sets the service_id of this ErrorTemplate.
    ...
    def template40x(self):
        """Gets the template40x of this ErrorTemplate.

        The html template for 40x errors

        :return: The template40x of this ErrorTemplate.
        :rtype: str
        """
    ...
    def template40x(self, template40x):
        """Sets the template40x of this ErrorTemplate.
    ...
    def template50x(self):
        """Gets the template50x of this ErrorTemplate.

        The html template for 50x errors

        :return: The template50x of this ErrorTemplate.
        :rtype: str
        """
    ...
    def template50x(self, template50x):
        """Sets the template50x of this ErrorTemplate.
    ...
    def template_build(self):
        """Gets the template_build of this ErrorTemplate.

        The html template for build page

        :return: The template_build of this ErrorTemplate.
        :rtype: str
        """
    ...
    def template_build(self, template_build):
        """Sets the template_build of this ErrorTemplate.
    ...
    def template_maintenance(self):
        """Gets the template_maintenance of this ErrorTemplate.

        The html template for maintenance page

        :return: The template_maintenance of this ErrorTemplate.
        :rtype: str
        """
    ...
    def template_maintenance(self, template_maintenance):
        """Sets the template_maintenance of this ErrorTemplate.
