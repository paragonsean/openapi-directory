...
async def history_hourlycity_idcity_id_get(request: web.Request, city_id, start_date, end_date, key, units=None, lang=None, tz=None, param_callback=None) -> web.Response:
...
async def history_hourlycitycitycountrycountry_get(request: web.Request, city, country, start_date, end_date, key, state=None, units=None, lang=None, tz=None, param_callback=None) -> web.Response:
...
async def history_hourlylatlatlonlon_get(request: web.Request, lat, lon, start_date, end_date, key, units=None, lang=None, tz=None, param_callback=None) -> web.Response:
...
async def history_hourlypostal_codepostal_code_get(request: web.Request, postal_code, start_date, end_date, key, country=None, units=None, lang=None, tz=None, param_callback=None) -> web.Response:
...
async def history_hourlystationstation_get(request: web.Request, station, start_date, end_date, key, units=None, lang=None, tz=None, param_callback=None) -> web.Response:
