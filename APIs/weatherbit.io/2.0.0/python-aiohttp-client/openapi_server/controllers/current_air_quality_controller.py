...
async def current_airqualitycity_idcity_id_get(request: web.Request, city_id, key, param_callback=None) -> web.Response:
...
async def current_airqualitycitycitycountrycountry_get(request: web.Request, city, country, key, state=None, param_callback=None) -> web.Response:
...
async def current_airqualitylatlatlonlon_get(request: web.Request, lat, lon, key, param_callback=None) -> web.Response:
...
async def current_airqualitypostal_codepostal_code_get(request: web.Request, postal_code, key, country=None, param_callback=None) -> web.Response:
