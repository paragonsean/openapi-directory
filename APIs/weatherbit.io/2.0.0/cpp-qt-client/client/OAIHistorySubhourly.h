...
/*
 * OAIHistorySubhourly.h
 *
 * 
 */

#ifndef OAIHistorySubhourly_H
#define OAIHistorySubhourly_H
...
class OAIHistorySubhourly : public OAIObject {
public:
    OAIHistorySubhourly();
    OAIHistorySubhourly(QString json);
    ~OAIHistorySubhourly() override;
    ...
    QList<OAIHistoryObj> getData() const;
    void setData(const QList<OAIHistoryObj> &data);
...
Q_DECLARE_METATYPE(OpenAPI::OAIHistorySubhourly)

#endif // OAIHistorySubhourly_H
