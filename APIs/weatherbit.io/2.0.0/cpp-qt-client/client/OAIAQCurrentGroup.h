...
#ifndef OAIAQCurrentGroup_H
#define OAIAQCurrentGroup_H
...
class OAIAQCurrentGroup : public OAIObject {
public:
    OAIAQCurrentGroup();
    OAIAQCurrentGroup(QString json);
    ~OAIAQCurrentGroup() override;
    ...
    QList<OAIAQCurrent> getData() const;
    void setData(const QList<OAIAQCurrent> &data);
...
Q_DECLARE_METATYPE(OpenAPI::OAIAQCurrentGroup)

#endif // OAIAQCurrentGroup_H
