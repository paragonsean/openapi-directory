...
QString OAIHistory::getCityName() const {
    return m_city_name;
}
void OAIHistory::setCityName(const QString &city_name) {
    m_city_name = city_name;
    m_city_name_isSet = true;
}

bool OAIHistory::is_city_name_Set() const{
    return m_city_name_isSet;
}

bool OAIHistory::is_city_name_Valid() const{
    return m_city_name_isValid;
}

QString OAIHistory::getCountryCode() const {
    return m_country_code;
}
void OAIHistory::setCountryCode(const QString &country_code) {
    m_country_code = country_code;
    m_country_code_isSet = true;
}

bool OAIHistory::is_country_code_Set() const{
    return m_country_code_isSet;
}

bool OAIHistory::is_country_code_Valid() const{
    return m_country_code_isValid;
}

QList<OAIHistoryObj> OAIHistory::getData() const {
    return m_data;
}
void OAIHistory::setData(const QList<OAIHistoryObj> &data) {
    m_data = data;
    m_data_isSet = true;
}

bool OAIHistory::is_data_Set() const{
    return m_data_isSet;
}

bool OAIHistory::is_data_Valid() const{
    return m_data_isValid;
}

QString OAIHistory::getLat() const {
    return m_lat;
}
void OAIHistory::setLat(const QString &lat) {
    m_lat = lat;
    m_lat_isSet = true;
}

bool OAIHistory::is_lat_Set() const{
    return m_lat_isSet;
}

bool OAIHistory::is_lat_Valid() const{
    return m_lat_isValid;
}

QString OAIHistory::getLon() const {
    return m_lon;
}
void OAIHistory::setLon(const QString &lon) {
    m_lon = lon;
    m_lon_isSet = true;
}

bool OAIHistory::is_lon_Set() const{
    return m_lon_isSet;
}

bool OAIHistory::is_lon_Valid() const{
    return m_lon_isValid;
}

QList<QString> OAIHistory::getSources() const {
    return m_sources;
}
void OAIHistory::setSources(const QList<QString> &sources) {
    m_sources = sources;
    m_sources_isSet = true;
}

bool OAIHistory::is_sources_Set() const{
    return m_sources_isSet;
}

bool OAIHistory::is_sources_Valid() const{
    return m_sources_isValid;
}

QString OAIHistory::getStateCode() const {
    return m_state_code;
}
void OAIHistory::setStateCode(const QString &state_code) {
    m_state_code = state_code;
    m_state_code_isSet = true;
}

bool OAIHistory::is_state_code_Set() const{
    return m_state_code_isSet;
}

bool OAIHistory::is_state_code_Valid() const{
    return m_state_code_isValid;
}

QString OAIHistory::getTimezone() const {
    return m_timezone;
}
void OAIHistory::setTimezone(const QString &timezone) {
    m_timezone = timezone;
    m_timezone_isSet = true;
}

bool OAIHistory::is_timezone_Set() const{
    return m_timezone_isSet;
}

bool OAIHistory::is_timezone_Valid() const{
