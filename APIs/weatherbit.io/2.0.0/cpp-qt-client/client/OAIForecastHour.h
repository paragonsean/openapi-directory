...
#ifndef OAIForecastHour_H
#define OAIForecastHour_H
...
namespace OpenAPI {
class OAIForecastHour_weather;

class OAIForecastHour : public OAIObject {
public:
    OAIForecastHour();
    OAIForecastHour(QString json);
    ~OAIForecastHour() override;
    ...
    OAIForecastHour_weather getWeather() const;
    void setWeather(const OAIForecastHour_weather &weather);
...
private:
    ...
    OAIForecastHour_weather m_weather;
...
Q_DECLARE_METATYPE(OpenAPI::OAIForecastHour)

#endif // OAIForecastHour_H
