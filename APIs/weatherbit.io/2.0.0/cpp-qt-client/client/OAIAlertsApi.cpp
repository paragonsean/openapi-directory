...
void OAIAlertsApi::initializeServerConfigs() {
    ...
    "No description provided",
    QMap<QString, OAIServerVariable>()));
    _serverConfigs.insert("alertslatlatlonlonGet", defaultConf);
    _serverIndices.insert("alertslatlatlonlonGet", 0);
}
...
void OAIAlertsApi::alertslatlatlonlonGet(const double &lat, const double &lon, const QString &key, const ::OpenAPI::OptionalParam<QString> &callback) {
    QString fullPath = QString(_serverConfigs["alertslatlatlonlonGet"][_serverIndices.value("alertslatlatlonlonGet")].URL()+"/alerts?lat={lat}&lon={lon}");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIAlertsApi::alertslatlatlonlonGetCallback);
...
void OAIAlertsApi::alertslatlatlonlonGetCallback(OAIHttpRequestWorker *worker) {
    ...
    OAIWeatherAlert output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT alertslatlatlonlonGetSignal(output);
        Q_EMIT alertslatlatlonlonGetSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT alertslatlatlonlonGetSignalE(output, error_type, error_str);
        Q_EMIT alertslatlatlonlonGetSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT alertslatlatlonlonGetSignalError(output, error_type, error_str);
        Q_EMIT alertslatlatlonlonGetSignalErrorFull(worker, error_type, error_str);
    }
}
