...
#ifndef OAIForecastDay_H
#define OAIForecastDay_H
...
class OAIForecastDay : public OAIObject {
public:
    OAIForecastDay();
    OAIForecastDay(QString json);
    ~OAIForecastDay() override;
    ...
    QList<OAIForecast> getData() const;
    void setData(const QList<OAIForecast> &data);
...
Q_DECLARE_METATYPE(OpenAPI::OAIForecastDay)

#endif // OAIForecastDay_H
