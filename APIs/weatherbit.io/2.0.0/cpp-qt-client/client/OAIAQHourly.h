...
#ifndef OAIAQHourly_H
#define OAIAQHourly_H
...
class OAIAQHourly : public OAIObject {
public:
    OAIAQHourly();
    OAIAQHourly(QString json);
    ~OAIAQHourly() override;
    ...
    QList<OAIAQHour> getData() const;
    void setData(const QList<OAIAQHour> &data);
...
Q_DECLARE_METATYPE(OpenAPI::OAIAQHourly)
