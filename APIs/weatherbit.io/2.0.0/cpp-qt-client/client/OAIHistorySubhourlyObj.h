...
/*
 * OAIHistorySubhourlyObj.h
 *
 * 
 */

#ifndef OAIHistorySubhourlyObj_H
#define OAIHistorySubhourlyObj_H
...
class OAIHistorySubhourlyObj : public OAIObject {
public:
    OAIHistorySubhourlyObj();
    OAIHistorySubhourlyObj(QString json);
    ~OAIHistorySubhourlyObj() override;
    ...
    double getPrecipRate() const;
    void setPrecipRate(const double &precip_rate);
    bool is_precip_rate_Set() const;
    bool is_precip_rate_Valid() const;
    ...
    void setSnowRate(const double &snow_rate);
    bool is_snow_rate_Set() const;
    bool is_snow_rate_Valid() const;
...
private:
    ...
    double m_precip_rate;
    bool m_precip_rate_isSet;
    bool m_precip_rate_isValid;
    ...
    double m_snow_rate;
    bool m_snow_rate_isSet;
    bool m_snow_rate_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIHistorySubhourlyObj)

#endif // OAIHistorySubhourlyObj_H
