...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WeatherbitInteractiveSwaggerUiDocumentation.ForecastHour();
  });
  ...
  describe('ForecastHour', function() {
    it('should create an instance of ForecastHour', function() {
      // uncomment below and update the code to test ForecastHour
      //var instance = new WeatherbitInteractiveSwaggerUiDocumentation.ForecastHour();
      //expect(instance).to.be.a(WeatherbitInteractiveSwaggerUiDocumentation.ForecastHour);
    });
