...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WeatherbitInteractiveSwaggerUiDocumentation.History();
  });
  ...
  describe('History', function() {
    it('should create an instance of History', function() {
      ...
      //var instance = new WeatherbitInteractiveSwaggerUiDocumentation.History();
      //expect(instance).to.be.a(WeatherbitInteractiveSwaggerUiDocumentation.History);
    });
