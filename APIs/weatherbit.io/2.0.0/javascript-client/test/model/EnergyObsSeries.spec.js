...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WeatherbitInteractiveSwaggerUiDocumentation.EnergyObsSeries();
  });
  ...
  describe('EnergyObsSeries', function() {
    it('should create an instance of EnergyObsSeries', function() {
      // uncomment below and update the code to test EnergyObsSeries
      //var instance = new WeatherbitInteractiveSwaggerUiDocumentation.EnergyObsSeries();
      //expect(instance).to.be.a(WeatherbitInteractiveSwaggerUiDocumentation.EnergyObsSeries);
    });
