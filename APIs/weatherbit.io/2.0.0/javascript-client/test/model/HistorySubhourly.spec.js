...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WeatherbitInteractiveSwaggerUiDocumentation.HistorySubhourly();
  });
  ...
  describe('HistorySubhourly', function() {
    it('should create an instance of HistorySubhourly', function() {
      // uncomment below and update the code to test HistorySubhourly
      //var instance = new WeatherbitInteractiveSwaggerUiDocumentation.HistorySubhourly();
      //expect(instance).to.be.a(WeatherbitInteractiveSwaggerUiDocumentation.HistorySubhourly);
    });
