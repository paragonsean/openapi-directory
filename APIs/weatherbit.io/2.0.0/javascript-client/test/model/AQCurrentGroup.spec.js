...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WeatherbitInteractiveSwaggerUiDocumentation.AQCurrentGroup();
  });
  ...
  describe('AQCurrentGroup', function() {
    it('should create an instance of AQCurrentGroup', function() {
      // uncomment below and update the code to test AQCurrentGroup
      //var instance = new WeatherbitInteractiveSwaggerUiDocumentation.AQCurrentGroup();
      //expect(instance).to.be.a(WeatherbitInteractiveSwaggerUiDocumentation.AQCurrentGroup);
    });
