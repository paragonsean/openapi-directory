...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WeatherbitInteractiveSwaggerUiDocumentation.AQHourly();
  });
  ...
  describe('AQHourly', function() {
    it('should create an instance of AQHourly', function() {
      // uncomment below and update the code to test AQHourly
      //var instance = new WeatherbitInteractiveSwaggerUiDocumentation.AQHourly();
      //expect(instance).to.be.a(WeatherbitInteractiveSwaggerUiDocumentation.AQHourly);
    });
