...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WeatherbitInteractiveSwaggerUiDocumentation.HistoryDay();
  });
  ...
  describe('HistoryDay', function() {
    it('should create an instance of HistoryDay', function() {
      // uncomment below and update the code to test HistoryDay
      //var instance = new WeatherbitInteractiveSwaggerUiDocumentation.HistoryDay();
      //expect(instance).to.be.a(WeatherbitInteractiveSwaggerUiDocumentation.HistoryDay);
    });
