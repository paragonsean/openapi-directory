...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WeatherbitInteractiveSwaggerUiDocumentation.ForecastHourly();
  });
  ...
  describe('ForecastHourly', function() {
    it('should create an instance of ForecastHourly', function() {
      // uncomment below and update the code to test ForecastHourly
      //var instance = new WeatherbitInteractiveSwaggerUiDocumentation.ForecastHourly();
      //expect(instance).to.be.a(WeatherbitInteractiveSwaggerUiDocumentation.ForecastHourly);
    });
