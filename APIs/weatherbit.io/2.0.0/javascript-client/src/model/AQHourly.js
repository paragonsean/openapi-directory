...
/**
 * The AQHourly model module.
 * @module model/AQHourly
 * @version 2.0.0
 */
class AQHourly {
    /**
     * Constructs a new <code>AQHourly</code>.
     * @alias module:model/AQHourly
     */
    constructor() { 
        
        AQHourly.initialize(this);
    }
    ...
    /**
     * Constructs a <code>AQHourly</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AQHourly} obj Optional instance to populate.
     * @return {module:model/AQHourly} The populated <code>AQHourly</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AQHourly();
            ...
            if (data.hasOwnProperty('data')) {
                obj['data'] = ApiClient.convertToType(data['data'], [AQHour]);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>AQHourly</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AQHourly</code>.
     */
 ...
 */
AQHourly.prototype['city_name'] = undefined;

/**
 * Country Abbreviation
 * @member {String} country_code
 */
AQHourly.prototype['country_code'] = undefined;

/**
 * @member {Array.<module:model/AQHour>} data
 */
AQHourly.prototype['data'] = undefined;

/**
 * Latitude
 * @member {String} lat
 */
AQHourly.prototype['lat'] = undefined;

/**
 * Longitude
 * @member {String} lon
 */
AQHourly.prototype['lon'] = undefined;

/**
 * State Abbreviation
 * @member {String} state_code
 */
AQHourly.prototype['state_code'] = undefined;

/**
 * Local IANA time zone
 * @member {String} timezone
 */
AQHourly.prototype['timezone'] = undefined;
