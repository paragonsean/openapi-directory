...
/**
 * The HistoryDay model module.
 * @module model/HistoryDay
 * @version 2.0.0
 */
class HistoryDay {
    /**
     * Constructs a new <code>HistoryDay</code>.
     * @alias module:model/HistoryDay
     */
    constructor() { 
        
        HistoryDay.initialize(this);
    }
    ...
    /**
     * Constructs a <code>HistoryDay</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/HistoryDay} obj Optional instance to populate.
     * @return {module:model/HistoryDay} The populated <code>HistoryDay</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new HistoryDay();
            ...
            if (data.hasOwnProperty('data')) {
                obj['data'] = ApiClient.convertToType(data['data'], [HistoryDayObj]);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>HistoryDay</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>HistoryDay</code>.
     */
    static validateJSON(data) {
        ...
        if (data['data']) { // data not null
            ...
            for (const item of data['data']) {
                HistoryDayObj.validateJSON(item);
            };
        }
        // ensure the json data is a string
 ...
 */
HistoryDay.prototype['city_name'] = undefined;

/**
 * Country abbreviation
 * @member {String} country_code
 */
HistoryDay.prototype['country_code'] = undefined;

/**
 * @member {Array.<module:model/HistoryDayObj>} data
 */
HistoryDay.prototype['data'] = undefined;

/**
 * Latitude
 * @member {String} lat
 */
HistoryDay.prototype['lat'] = undefined;

/**
 * Longitude
 * @member {String} lon
 */
HistoryDay.prototype['lon'] = undefined;

/**
 * List of data sources used in response
 * @member {Array.<String>} sources
 */
HistoryDay.prototype['sources'] = undefined;

/**
 * State abbreviation
 * @member {String} state_code
 */
HistoryDay.prototype['state_code'] = undefined;

/**
 * Local IANA time zone
 * @member {String} timezone
 */
HistoryDay.prototype['timezone'] = undefined;
