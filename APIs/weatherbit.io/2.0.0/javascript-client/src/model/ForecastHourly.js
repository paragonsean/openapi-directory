...
/**
 * The ForecastHourly model module.
 * @module model/ForecastHourly
 * @version 2.0.0
 */
class ForecastHourly {
    /**
     * Constructs a new <code>ForecastHourly</code>.
     * @alias module:model/ForecastHourly
     */
    constructor() { 
        
        ForecastHourly.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ForecastHourly</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ForecastHourly} obj Optional instance to populate.
     * @return {module:model/ForecastHourly} The populated <code>ForecastHourly</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ForecastHourly();
            ...
            if (data.hasOwnProperty('data')) {
                obj['data'] = ApiClient.convertToType(data['data'], [ForecastHour]);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>ForecastHourly</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ForecastHourly</code>.
     */
    static validateJSON(data) {
        ...
        if (data['data']) { // data not null
            ...
            for (const item of data['data']) {
                ForecastHour.validateJSON(item);
            };
        }
        // ensure the json data is a string
 ...
 */
ForecastHourly.prototype['city_name'] = undefined;

/**
 * Country Abbreviation
 * @member {String} country_code
 */
ForecastHourly.prototype['country_code'] = undefined;

/**
 * @member {Array.<module:model/ForecastHour>} data
 */
ForecastHourly.prototype['data'] = undefined;

/**
 * Latitude
 * @member {String} lat
 */
ForecastHourly.prototype['lat'] = undefined;

/**
 * Longitude
 * @member {String} lon
 */
ForecastHourly.prototype['lon'] = undefined;

/**
 * State Abbreviation
 * @member {String} state_code
 */
ForecastHourly.prototype['state_code'] = undefined;

/**
 * Local IANA time zone
 * @member {String} timezone
 */
ForecastHourly.prototype['timezone'] = undefined;
