...
/**
 * The ForecastDay model module.
 * @module model/ForecastDay
 * @version 2.0.0
 */
class ForecastDay {
    /**
     * Constructs a new <code>ForecastDay</code>.
     * @alias module:model/ForecastDay
     */
    constructor() { 
        
        ForecastDay.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ForecastDay</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ForecastDay} obj Optional instance to populate.
     * @return {module:model/ForecastDay} The populated <code>ForecastDay</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ForecastDay();
            ...
            if (data.hasOwnProperty('data')) {
                obj['data'] = ApiClient.convertToType(data['data'], [Forecast]);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>ForecastDay</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ForecastDay</code>.
     */
 ...
 */
ForecastDay.prototype['city_name'] = undefined;

/**
 * Country Abbreviation
 * @member {String} country_code
 */
ForecastDay.prototype['country_code'] = undefined;

/**
 * @member {Array.<module:model/Forecast>} data
 */
ForecastDay.prototype['data'] = undefined;

/**
 * Latitude
 * @member {String} lat
 */
ForecastDay.prototype['lat'] = undefined;

/**
 * Longitude
 * @member {String} lon
 */
ForecastDay.prototype['lon'] = undefined;

/**
 * State Abbreviation
 * @member {String} state_code
 */
ForecastDay.prototype['state_code'] = undefined;

/**
 * Local IANA time zone
 * @member {String} timezone
 */
ForecastDay.prototype['timezone'] = undefined;
