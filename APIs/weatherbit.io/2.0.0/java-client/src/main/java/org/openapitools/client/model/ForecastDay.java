...
public class ForecastDay {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.cityName, forecastDay.cityName) &&
        Objects.equals(this.countryCode, forecastDay.countryCode) &&
        Objects.equals(this.data, forecastDay.data) &&
        Objects.equals(this.lat, forecastDay.lat) &&
        Objects.equals(this.lon, forecastDay.lon) &&
        Objects.equals(this.stateCode, forecastDay.stateCode) &&
        Objects.equals(this.timezone, forecastDay.timezone);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ForecastDay
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ForecastDay.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ForecastDay is not found in the empty JSON string", ForecastDay.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ForecastDay.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ForecastDay` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        ...
        if (jsonArraydata != null) {
          ...
          for (int i = 0; i < jsonArraydata.size(); i++) {
            Forecast.validateJsonElement(jsonArraydata.get(i));
          };
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ForecastDay.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ForecastDay' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ForecastDay> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ForecastDay.class));

       return (TypeAdapter<T>) new TypeAdapter<ForecastDay>() {
           @Override
  ...
  /**
   * Create an instance of ForecastDay given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ForecastDay
   * @throws IOException if the JSON string is invalid with respect to ForecastDay
   */
  public static ForecastDay fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ForecastDay.class);
  }

  /**
   * Convert an instance of ForecastDay to an JSON string
   *
   * @return JSON string
   */
