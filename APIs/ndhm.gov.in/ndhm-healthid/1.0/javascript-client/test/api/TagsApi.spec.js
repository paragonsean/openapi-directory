...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HealthIdService.TagsApi();
  });
  ...
  describe('TagsApi', function() {
    ...
    describe('deleteTagUsingDELETE', function() {
      it('should call deleteTagUsingDELETE successfully', function(done) {
        //uncomment below and update the code to test deleteTagUsingDELETE
        //instance.deleteTagUsingDELETE(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
