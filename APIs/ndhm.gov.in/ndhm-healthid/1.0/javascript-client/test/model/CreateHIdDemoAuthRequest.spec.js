...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HealthIdService.CreateHIdDemoAuthRequest();
  });
  ...
  describe('CreateHIdDemoAuthRequest', function() {
    it('should create an instance of CreateHIdDemoAuthRequest', function() {
      // uncomment below and update the code to test CreateHIdDemoAuthRequest
      //var instance = new HealthIdService.CreateHIdDemoAuthRequest();
      //expect(instance).to.be.a(HealthIdService.CreateHIdDemoAuthRequest);
    });

    it('should have the property aadharNumber (base name: "aadharNumber")', function() {
      // uncomment below and update the code to test the property aadharNumber
      //var instance = new HealthIdService.CreateHIdDemoAuthRequest();
