...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HealthIdService.HidBenefitLinkedRequestPayload();
  });
  ...
  describe('HidBenefitLinkedRequestPayload', function() {
    it('should create an instance of HidBenefitLinkedRequestPayload', function() {
      // uncomment below and update the code to test HidBenefitLinkedRequestPayload
      //var instance = new HealthIdService.HidBenefitLinkedRequestPayload();
      //expect(instance).to.be.a(HealthIdService.HidBenefitLinkedRequestPayload);
    });
