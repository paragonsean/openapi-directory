...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HealthIdService.AuthInitRequest();
  });
  ...
  describe('AuthInitRequest', function() {
    it('should create an instance of AuthInitRequest', function() {
      // uncomment below and update the code to test AuthInitRequest
      //var instance = new HealthIdService.AuthInitRequest();
      //expect(instance).to.be.a(HealthIdService.AuthInitRequest);
    });
