...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HealthIdService.HidBenefitRequestPayload();
  });
  ...
  describe('HidBenefitRequestPayload', function() {
    it('should create an instance of HidBenefitRequestPayload', function() {
      // uncomment below and update the code to test HidBenefitRequestPayload
      //var instance = new HealthIdService.HidBenefitRequestPayload();
      //expect(instance).to.be.a(HealthIdService.HidBenefitRequestPayload);
    });
