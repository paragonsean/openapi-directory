...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HealthIdService.RetriveHealthIdMobilePayLoad();
  });
  ...
  describe('RetriveHealthIdMobilePayLoad', function() {
    it('should create an instance of RetriveHealthIdMobilePayLoad', function() {
      // uncomment below and update the code to test RetriveHealthIdMobilePayLoad
      //var instance = new HealthIdService.RetriveHealthIdMobilePayLoad();
      //expect(instance).to.be.a(HealthIdService.RetriveHealthIdMobilePayLoad);
    });
