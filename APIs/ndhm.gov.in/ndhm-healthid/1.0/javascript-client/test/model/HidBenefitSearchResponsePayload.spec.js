...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HealthIdService.HidBenefitSearchResponsePayload();
  });
  ...
  describe('HidBenefitSearchResponsePayload', function() {
    it('should create an instance of HidBenefitSearchResponsePayload', function() {
      // uncomment below and update the code to test HidBenefitSearchResponsePayload
      //var instance = new HealthIdService.HidBenefitSearchResponsePayload();
      //expect(instance).to.be.a(HealthIdService.HidBenefitSearchResponsePayload);
    });
