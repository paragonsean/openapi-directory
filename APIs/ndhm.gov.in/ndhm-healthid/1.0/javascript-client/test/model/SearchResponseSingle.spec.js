...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HealthIdService.SearchResponseSingle();
  });
  ...
  describe('SearchResponseSingle', function() {
    it('should create an instance of SearchResponseSingle', function() {
      // uncomment below and update the code to test SearchResponseSingle
      //var instance = new HealthIdService.SearchResponseSingle();
      //expect(instance).to.be.a(HealthIdService.SearchResponseSingle);
    });
