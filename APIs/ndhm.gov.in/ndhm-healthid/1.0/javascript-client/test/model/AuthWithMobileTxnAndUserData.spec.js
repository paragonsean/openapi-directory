...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HealthIdService.AuthWithMobileTxnAndUserData();
  });
  ...
  describe('AuthWithMobileTxnAndUserData', function() {
    it('should create an instance of AuthWithMobileTxnAndUserData', function() {
      // uncomment below and update the code to test AuthWithMobileTxnAndUserData
      //var instance = new HealthIdService.AuthWithMobileTxnAndUserData();
      //expect(instance).to.be.a(HealthIdService.AuthWithMobileTxnAndUserData);
    });
