...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HealthIdService.HidOtpRequestPaylaod();
  });
  ...
  describe('HidOtpRequestPaylaod', function() {
    it('should create an instance of HidOtpRequestPaylaod', function() {
      // uncomment below and update the code to test HidOtpRequestPaylaod
      //var instance = new HealthIdService.HidOtpRequestPaylaod();
      //expect(instance).to.be.a(HealthIdService.HidOtpRequestPaylaod);
    });
