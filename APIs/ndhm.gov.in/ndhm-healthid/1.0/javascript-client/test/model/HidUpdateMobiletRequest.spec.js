...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HealthIdService.HidUpdateMobiletRequest();
  });
  ...
  describe('HidUpdateMobiletRequest', function() {
    it('should create an instance of HidUpdateMobiletRequest', function() {
      // uncomment below and update the code to test HidUpdateMobiletRequest
      //var instance = new HealthIdService.HidUpdateMobiletRequest();
      //expect(instance).to.be.a(HealthIdService.HidUpdateMobiletRequest);
    });
