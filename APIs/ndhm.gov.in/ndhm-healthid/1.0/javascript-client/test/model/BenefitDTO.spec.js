...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HealthIdService.BenefitDTO();
  });
  ...
  describe('BenefitDTO', function() {
    it('should create an instance of BenefitDTO', function() {
      // uncomment below and update the code to test BenefitDTO
      //var instance = new HealthIdService.BenefitDTO();
      //expect(instance).to.be.a(HealthIdService.BenefitDTO);
    });
    ...
    it('should have the property linkageDate (base name: "linkageDate")', function() {
      // uncomment below and update the code to test the property linkageDate
      //var instance = new HealthIdService.BenefitDTO();
      //expect(instance).to.be();
    });
