...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HealthIdService.CreateHidNotifyBenefitRequest();
  });
  ...
  describe('CreateHidNotifyBenefitRequest', function() {
    it('should create an instance of CreateHidNotifyBenefitRequest', function() {
      // uncomment below and update the code to test CreateHidNotifyBenefitRequest
      //var instance = new HealthIdService.CreateHidNotifyBenefitRequest();
      //expect(instance).to.be.a(HealthIdService.CreateHidNotifyBenefitRequest);
    });

    it('should have the property aadharNumberOrUidToken (base name: "aadharNumberOrUidToken")', function() {
      // uncomment below and update the code to test the property aadharNumberOrUidToken
      //var instance = new HealthIdService.CreateHidNotifyBenefitRequest();
