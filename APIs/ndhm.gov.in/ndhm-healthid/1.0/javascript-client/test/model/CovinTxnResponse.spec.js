...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HealthIdService.CovinTxnResponse();
  });
  ...
  describe('CovinTxnResponse', function() {
    it('should create an instance of CovinTxnResponse', function() {
      // uncomment below and update the code to test CovinTxnResponse
      //var instance = new HealthIdService.CovinTxnResponse();
      //expect(instance).to.be.a(HealthIdService.CovinTxnResponse);
    });
