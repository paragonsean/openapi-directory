...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HealthIdService.CreateAccountWithPreVerifiedAadhaar();
  });
  ...
  describe('CreateAccountWithPreVerifiedAadhaar', function() {
    it('should create an instance of CreateAccountWithPreVerifiedAadhaar', function() {
      // uncomment below and update the code to test CreateAccountWithPreVerifiedAadhaar
      //var instance = new HealthIdService.CreateAccountWithPreVerifiedAadhaar();
      //expect(instance).to.be.a(HealthIdService.CreateAccountWithPreVerifiedAadhaar);
    });
