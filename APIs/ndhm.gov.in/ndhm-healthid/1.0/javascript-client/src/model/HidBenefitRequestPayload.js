...
/**
 * The HidBenefitRequestPayload model module.
 * @module model/HidBenefitRequestPayload
 * @version 1.0
 */
class HidBenefitRequestPayload {
    /**
     * Constructs a new <code>HidBenefitRequestPayload</code>.
     * @alias module:model/HidBenefitRequestPayload
     */
    constructor() { 
        
        HidBenefitRequestPayload.initialize(this);
    }
    ...
    /**
     * Constructs a <code>HidBenefitRequestPayload</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/HidBenefitRequestPayload} obj Optional instance to populate.
     * @return {module:model/HidBenefitRequestPayload} The populated <code>HidBenefitRequestPayload</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new HidBenefitRequestPayload();
    ...
    /**
     * Validates the JSON data with respect to <code>HidBenefitRequestPayload</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>HidBenefitRequestPayload</code>.
     */
 ...
 */
HidBenefitRequestPayload.prototype['address'] = undefined;

/**
 * @member {Array.<module:model/HidBenefitRequestPayload.AuthMethodsEnum>} authMethods
 */
HidBenefitRequestPayload.prototype['authMethods'] = undefined;

/**
 * @member {String} benefitId
 */
HidBenefitRequestPayload.prototype['benefitId'] = undefined;

/**
 * @member {String} dayOfBirth
 */
HidBenefitRequestPayload.prototype['dayOfBirth'] = undefined;

/**
 * @member {String} districtCode
 */
HidBenefitRequestPayload.prototype['districtCode'] = undefined;

/**
 * @member {String} districtName
 */
HidBenefitRequestPayload.prototype['districtName'] = undefined;

/**
 * @member {String} email
 */
HidBenefitRequestPayload.prototype['email'] = undefined;

/**
 * @member {String} firstName
 */
HidBenefitRequestPayload.prototype['firstName'] = undefined;

/**
 * @member {String} gender
 */
HidBenefitRequestPayload.prototype['gender'] = undefined;

/**
 * @member {String} healthId
 */
HidBenefitRequestPayload.prototype['healthId'] = undefined;

/**
 * @member {String} healthIdNumber
 */
HidBenefitRequestPayload.prototype['healthIdNumber'] = undefined;

/**
 * @member {String} kycPhoto
 */
HidBenefitRequestPayload.prototype['kycPhoto'] = undefined;

/**
 * @member {Boolean} kycVerified
 */
HidBenefitRequestPayload.prototype['kycVerified'] = undefined;

/**
 * @member {String} lastName
 */
HidBenefitRequestPayload.prototype['lastName'] = undefined;

/**
 * @member {String} middleName
 */
HidBenefitRequestPayload.prototype['middleName'] = undefined;

/**
 * @member {String} mobile
 */
HidBenefitRequestPayload.prototype['mobile'] = undefined;

/**
 * @member {String} monthOfBirth
 */
HidBenefitRequestPayload.prototype['monthOfBirth'] = undefined;

/**
 * @member {String} name
 */
HidBenefitRequestPayload.prototype['name'] = undefined;

/**
 * @member {Boolean} new
 */
HidBenefitRequestPayload.prototype['new'] = undefined;

/**
 * @member {String} pincode
 */
HidBenefitRequestPayload.prototype['pincode'] = undefined;

/**
 * @member {String} profilePhoto
 */
HidBenefitRequestPayload.prototype['profilePhoto'] = undefined;

/**
 * @member {String} stateCode
 */
HidBenefitRequestPayload.prototype['stateCode'] = undefined;

/**
 * @member {String} stateName
 */
HidBenefitRequestPayload.prototype['stateName'] = undefined;

/**
 * @member {String} status
 */
HidBenefitRequestPayload.prototype['status'] = undefined;

/**
 * @member {String} subDistrictCode
 */
HidBenefitRequestPayload.prototype['subDistrictCode'] = undefined;

/**
 * @member {String} subdistrictName
 */
HidBenefitRequestPayload.prototype['subdistrictName'] = undefined;

/**
 * @member {Object.<String, String>} tags
 */
HidBenefitRequestPayload.prototype['tags'] = undefined;

/**
 * @member {String} token
 */
HidBenefitRequestPayload.prototype['token'] = undefined;

/**
 * @member {String} townCode
 */
HidBenefitRequestPayload.prototype['townCode'] = undefined;

/**
 * @member {String} townName
 */
HidBenefitRequestPayload.prototype['townName'] = undefined;

/**
 * @member {String} villageCode
 */
HidBenefitRequestPayload.prototype['villageCode'] = undefined;

/**
 * @member {String} villageName
 */
HidBenefitRequestPayload.prototype['villageName'] = undefined;

/**
 * @member {String} wardCode
 */
HidBenefitRequestPayload.prototype['wardCode'] = undefined;

/**
 * @member {String} wardName
 */
HidBenefitRequestPayload.prototype['wardName'] = undefined;

/**
 * @member {String} yearOfBirth
 */
HidBenefitRequestPayload.prototype['yearOfBirth'] = undefined;
 ...
 * @readonly
 */
HidBenefitRequestPayload['AuthMethodsEnum'] = {
...
export default HidBenefitRequestPayload;
