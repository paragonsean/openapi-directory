...
public class ApiClient {
    ...
    private String basePath = "https://healthidsbx.ndhm.gov.in/api";
    ...
    public ApiClient() {
        ...
        authentications.put("X-HIP-ID", new ApiKeyAuth("header", "X-HIP-ID"));
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://healthidsbx.ndhm.gov.in/api
