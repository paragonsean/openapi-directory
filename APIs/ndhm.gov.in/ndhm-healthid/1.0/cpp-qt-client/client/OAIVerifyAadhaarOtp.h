...
/*
 * OAIVerifyAadhaarOtp.h
 *
 * 
 */

#ifndef OAIVerifyAadhaarOtp_H
#define OAIVerifyAadhaarOtp_H
...
class OAIVerifyAadhaarOtp : public OAIObject {
public:
    OAIVerifyAadhaarOtp();
    OAIVerifyAadhaarOtp(QString json);
    ~OAIVerifyAadhaarOtp() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIVerifyAadhaarOtp)

#endif // OAIVerifyAadhaarOtp_H
