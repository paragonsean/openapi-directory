...
/*
 * OAICreateHIdDemoAuthRequest.h
 *
 * 
 */

#ifndef OAICreateHIdDemoAuthRequest_H
#define OAICreateHIdDemoAuthRequest_H
...
class OAICreateHIdDemoAuthRequest : public OAIObject {
public:
    OAICreateHIdDemoAuthRequest();
    OAICreateHIdDemoAuthRequest(QString json);
    ~OAICreateHIdDemoAuthRequest() override;
    ...
    QString getAadharNumber() const;
    void setAadharNumber(const QString &aadhar_number);
    bool is_aadhar_number_Set() const;
    bool is_aadhar_number_Valid() const;
...
private:
    ...
    QString m_aadhar_number;
    bool m_aadhar_number_isSet;
    bool m_aadhar_number_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateHIdDemoAuthRequest)

#endif // OAICreateHIdDemoAuthRequest_H
