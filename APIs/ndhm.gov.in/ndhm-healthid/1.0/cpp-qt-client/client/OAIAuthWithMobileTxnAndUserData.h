...
/*
 * OAIAuthWithMobileTxnAndUserData.h
 *
 * 
 */

#ifndef OAIAuthWithMobileTxnAndUserData_H
#define OAIAuthWithMobileTxnAndUserData_H
...
class OAIAuthWithMobileTxnAndUserData : public OAIObject {
public:
    OAIAuthWithMobileTxnAndUserData();
    OAIAuthWithMobileTxnAndUserData(QString json);
    ~OAIAuthWithMobileTxnAndUserData() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAuthWithMobileTxnAndUserData)

#endif // OAIAuthWithMobileTxnAndUserData_H
