...
class HIRequest(Model):
    ...
    def __init__(self, hi_request: HIRequestHiRequest=None, request_id: str=None, timestamp: datetime=None):
    ...
    def hi_request(self, hi_request):
        ...
        :param hi_request: The hi_request of this HIRequest.
        :type hi_request: HIRequestHiRequest
        """
