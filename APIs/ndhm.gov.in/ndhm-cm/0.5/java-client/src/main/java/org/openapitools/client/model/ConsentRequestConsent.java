...
public class ConsentRequestConsent {
  ...
  private List<CareContextDefinition> careContexts = new ArrayList<>();
  ...
  public ConsentRequestConsent hip(ConsentRequestConsentHip hip) {
    this.hip = hip;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public ConsentRequestConsentHip getHip() {
    return hip;
  }

  public void setHip(ConsentRequestConsentHip hip) {
    this.hip = hip;
  }


  public ConsentRequestConsent hiu(ConsentRequestConsentHiu hiu) {
    this.hiu = hiu;
    return this;
  }
   ...
   */
  @javax.annotation.Nonnull
  public ConsentRequestConsentHiu getHiu() {
    return hiu;
  }

  public void setHiu(ConsentRequestConsentHiu hiu) {
    this.hiu = hiu;
  }


  public ConsentRequestConsent patient(ConsentRequestConsentPatient patient) {
   ...
   */
  @javax.annotation.Nonnull
  public ConsentRequestConsentPatient getPatient() {
    return patient;
  }

  public void setPatient(ConsentRequestConsentPatient patient) {
    this.patient = patient;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.careContexts, consentRequestConsent.careContexts) &&
        ...
        Objects.equals(this.purpose, consentRequestConsent.purpose) &&
        Objects.equals(this.requester, consentRequestConsent.requester);
  }

  @Override
  public int hashCode() {
    return Objects.hash(careContexts, hiTypes, hip, hiu, patient, permission, purpose, requester);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ConsentRequestConsent
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ConsentRequestConsent.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ConsentRequestConsent is not found in the empty JSON string", ConsentRequestConsent.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ConsentRequestConsent.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ConsentRequestConsent` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ConsentRequestConsent.openapiRequiredFields) {
      ...
      if (jsonObj.get("careContexts") != null && !jsonObj.get("careContexts").isJsonNull()) {
        ...
        if (jsonArraycareContexts != null) {
          ...
          for (int i = 0; i < jsonArraycareContexts.size(); i++) {
            CareContextDefinition.validateJsonElement(jsonArraycareContexts.get(i));
          };
        }
      }
      ...
      if (jsonObj.get("hip") != null && !jsonObj.get("hip").isJsonNull()) {
        ConsentRequestConsentHip.validateJsonElement(jsonObj.get("hip"));
      }
      // validate the required field `hiu`
      ConsentRequestConsentHiu.validateJsonElement(jsonObj.get("hiu"));
      // validate the required field `patient`
      ConsentRequestConsentPatient.validateJsonElement(jsonObj.get("patient"));
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ConsentRequestConsent.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ConsentRequestConsent' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ConsentRequestConsent> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ConsentRequestConsent.class));

       return (TypeAdapter<T>) new TypeAdapter<ConsentRequestConsent>() {
           @Override
           public void write(JsonWriter out, ConsentRequestConsent value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ConsentRequestConsent read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ConsentRequestConsent given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ConsentRequestConsent
   * @throws IOException if the JSON string is invalid with respect to ConsentRequestConsent
   */
  public static ConsentRequestConsent fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ConsentRequestConsent.class);
  }

  /**
   * Convert an instance of ConsentRequestConsent to an JSON string
   *
   * @return JSON string
   */
