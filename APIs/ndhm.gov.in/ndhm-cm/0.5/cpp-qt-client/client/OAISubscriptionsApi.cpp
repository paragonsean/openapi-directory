...
void OAISubscriptionsApi::v05SubscriptionRequestsCmInitPost(const QString &authorization, const OAISubscriptionRequest &oai_subscription_request) {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAISubscriptionsApi::v05SubscriptionRequestsCmInitPostCallback);
...
void OAISubscriptionsApi::v05SubscriptionRequestsCmInitPostCallback(OAIHttpRequestWorker *worker) {
...
void OAISubscriptionsApi::v05SubscriptionRequestsHiuOnNotifyPost(const QString &authorization, const OAIHIUSubscriptionRequestNotificationAcknowledgement &oaihiu_subscription_request_notification_acknowledgement) {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAISubscriptionsApi::v05SubscriptionRequestsHiuOnNotifyPostCallback);
    connect(this, &OAISubscriptionsApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAISubscriptionsApi::v05SubscriptionRequestsHiuOnNotifyPostCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
...
void OAISubscriptionsApi::v05SubscriptionsHiuOnNotifyPost(const QString &authorization, const OAIHIUSubscriptionNotificationAcknowledgment &oaihiu_subscription_notification_acknowledgment) {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAISubscriptionsApi::v05SubscriptionsHiuOnNotifyPostCallback);
    connect(this, &OAISubscriptionsApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAISubscriptionsApi::v05SubscriptionsHiuOnNotifyPostCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
