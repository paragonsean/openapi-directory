...
public:
    ...
    */
    virtual void v05LinksLinkAddContextsPost(const QString &authorization, const OAIPatientCareContextLinkRequest &oai_patient_care_context_link_request);

    /**
    * @param[in]  authorization QString [required]
    * @param[in]  oai_patient_link_result OAIPatientLinkResult [required]
    */
    virtual void v05LinksLinkOnConfirmPost(const QString &authorization, const OAIPatientLinkResult &oai_patient_link_result);

    /**
    * @param[in]  authorization QString [required]
    * @param[in]  oai_patient_link_reference_result OAIPatientLinkReferenceResult [required]
    */
    virtual void v05LinksLinkOnInitPost(const QString &authorization, const OAIPatientLinkReferenceResult &oai_patient_link_reference_result);
