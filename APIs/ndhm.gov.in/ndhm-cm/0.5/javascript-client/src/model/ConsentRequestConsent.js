...
import ConsentRequestConsentHip from './ConsentRequestConsentHip';
import ConsentRequestConsentHiu from './ConsentRequestConsentHiu';
...
class ConsentRequestConsent {
     ...
     * @param hiu {module:model/ConsentRequestConsentHiu} 
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('hip')) {
                obj['hip'] = ConsentRequestConsentHip.constructFromObject(data['hip']);
            }
            if (data.hasOwnProperty('hiu')) {
                obj['hiu'] = ConsentRequestConsentHiu.constructFromObject(data['hiu']);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['hip']) { // data not null
          ConsentRequestConsentHip.validateJSON(data['hip']);
        }
        // validate the optional field `hiu`
        if (data['hiu']) { // data not null
          ConsentRequestConsentHiu.validateJSON(data['hiu']);
        }
...
/**
 * @member {module:model/ConsentRequestConsentHip} hip
 */
ConsentRequestConsent.prototype['hip'] = undefined;

/**
 * @member {module:model/ConsentRequestConsentHiu} hiu
 */
