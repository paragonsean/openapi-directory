...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HealthDataConsentManager.ConsentManagerPatientID();
  });
  ...
  describe('ConsentManagerPatientID', function() {
    it('should create an instance of ConsentManagerPatientID', function() {
      ...
      //var instance = new HealthDataConsentManager.ConsentManagerPatientID();
      //expect(instance).to.be.a(HealthDataConsentManager.ConsentManagerPatientID);
    });
