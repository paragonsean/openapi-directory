...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HealthDataConsentManager.PatientAuthInitRequestQuery();
  });
  ...
  describe('PatientAuthInitRequestQuery', function() {
    it('should create an instance of PatientAuthInitRequestQuery', function() {
      ...
      //var instance = new HealthDataConsentManager.PatientAuthInitRequestQuery();
      //expect(instance).to.be.a(HealthDataConsentManager.PatientAuthInitRequestQuery);
    });
