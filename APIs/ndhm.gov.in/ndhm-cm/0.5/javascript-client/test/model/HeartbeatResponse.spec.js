...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HealthDataConsentManager.HeartbeatResponse();
  });
  ...
  describe('HeartbeatResponse', function() {
    it('should create an instance of HeartbeatResponse', function() {
      ...
      //var instance = new HealthDataConsentManager.HeartbeatResponse();
      //expect(instance).to.be.a(HealthDataConsentManager.HeartbeatResponse);
    });
