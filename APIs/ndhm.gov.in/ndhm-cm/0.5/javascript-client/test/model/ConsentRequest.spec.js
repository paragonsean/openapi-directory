...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HealthDataConsentManager.ConsentRequest();
  });
  ...
  describe('ConsentRequest', function() {
    it('should create an instance of ConsentRequest', function() {
      ...
      //var instance = new HealthDataConsentManager.ConsentRequest();
      //expect(instance).to.be.a(HealthDataConsentManager.ConsentRequest);
    });
