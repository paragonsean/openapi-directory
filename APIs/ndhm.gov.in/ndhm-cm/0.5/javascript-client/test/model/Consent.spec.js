...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HealthDataConsentManager.Consent();
  });
  ...
  describe('Consent', function() {
    it('should create an instance of Consent', function() {
      ...
      //var instance = new HealthDataConsentManager.Consent();
      //expect(instance).to.be.a(HealthDataConsentManager.Consent);
    });
