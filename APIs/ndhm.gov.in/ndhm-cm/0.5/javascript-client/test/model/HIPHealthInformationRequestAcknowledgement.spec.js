...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HealthDataConsentManager.HIPHealthInformationRequestAcknowledgement();
  });
  ...
  describe('HIPHealthInformationRequestAcknowledgement', function() {
    it('should create an instance of HIPHealthInformationRequestAcknowledgement', function() {
      ...
      //var instance = new HealthDataConsentManager.HIPHealthInformationRequestAcknowledgement();
      //expect(instance).to.be.a(HealthDataConsentManager.HIPHealthInformationRequestAcknowledgement);
    });
