...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HealthDataConsentManager.ShareProfileAcknowledgement();
  });
  ...
  describe('ShareProfileAcknowledgement', function() {
    it('should create an instance of ShareProfileAcknowledgement', function() {
      ...
      //var instance = new HealthDataConsentManager.ShareProfileAcknowledgement();
      //expect(instance).to.be.a(HealthDataConsentManager.ShareProfileAcknowledgement);
    });
