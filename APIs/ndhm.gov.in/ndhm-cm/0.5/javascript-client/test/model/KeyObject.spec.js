...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HealthDataConsentManager.KeyObject();
  });
  ...
  describe('KeyObject', function() {
    it('should create an instance of KeyObject', function() {
      ...
      //var instance = new HealthDataConsentManager.KeyObject();
      //expect(instance).to.be.a(HealthDataConsentManager.KeyObject);
    });
