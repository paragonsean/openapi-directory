...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HealthDataConsentManager.PatientLinkResult();
  });
  ...
  describe('PatientLinkResult', function() {
    it('should create an instance of PatientLinkResult', function() {
      ...
      //var instance = new HealthDataConsentManager.PatientLinkResult();
      //expect(instance).to.be.a(HealthDataConsentManager.PatientLinkResult);
    });
