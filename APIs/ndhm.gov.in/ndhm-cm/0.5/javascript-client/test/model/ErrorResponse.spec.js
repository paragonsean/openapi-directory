...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HealthDataConsentManager.ErrorResponse();
  });
  ...
  describe('ErrorResponse', function() {
    it('should create an instance of ErrorResponse', function() {
      ...
      //var instance = new HealthDataConsentManager.ErrorResponse();
      //expect(instance).to.be.a(HealthDataConsentManager.ErrorResponse);
    });
