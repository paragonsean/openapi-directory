...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HealthDataConsentManager.PatientAuthRequester();
  });
  ...
  describe('PatientAuthRequester', function() {
    it('should create an instance of PatientAuthRequester', function() {
      ...
      //var instance = new HealthDataConsentManager.PatientAuthRequester();
      //expect(instance).to.be.a(HealthDataConsentManager.PatientAuthRequester);
    });
