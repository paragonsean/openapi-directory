...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HealthDataConsentManager.DateRange();
  });
  ...
  describe('DateRange', function() {
    it('should create an instance of DateRange', function() {
      ...
      //var instance = new HealthDataConsentManager.DateRange();
      //expect(instance).to.be.a(HealthDataConsentManager.DateRange);
    });
