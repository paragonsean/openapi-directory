...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HealthDataConsentManager.PatientLinkReferenceResultLink();
  });
  ...
  describe('PatientLinkReferenceResultLink', function() {
    it('should create an instance of PatientLinkReferenceResultLink', function() {
      ...
      //var instance = new HealthDataConsentManager.PatientLinkReferenceResultLink();
      //expect(instance).to.be.a(HealthDataConsentManager.PatientLinkReferenceResultLink);
    });
