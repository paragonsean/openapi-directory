...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HealthDataConsentManager.HIRequest();
  });
  ...
  describe('HIRequest', function() {
    it('should create an instance of HIRequest', function() {
      ...
      //var instance = new HealthDataConsentManager.HIRequest();
      //expect(instance).to.be.a(HealthDataConsentManager.HIRequest);
    });
