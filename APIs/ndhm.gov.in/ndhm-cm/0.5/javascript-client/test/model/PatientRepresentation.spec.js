...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HealthDataConsentManager.PatientRepresentation();
  });
  ...
  describe('PatientRepresentation', function() {
    it('should create an instance of PatientRepresentation', function() {
      ...
      //var instance = new HealthDataConsentManager.PatientRepresentation();
      //expect(instance).to.be.a(HealthDataConsentManager.PatientRepresentation);
    });
