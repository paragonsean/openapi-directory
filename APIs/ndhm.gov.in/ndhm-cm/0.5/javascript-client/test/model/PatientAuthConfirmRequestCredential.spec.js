...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HealthDataConsentManager.PatientAuthConfirmRequestCredential();
  });
  ...
  describe('PatientAuthConfirmRequestCredential', function() {
    it('should create an instance of PatientAuthConfirmRequestCredential', function() {
      ...
      //var instance = new HealthDataConsentManager.PatientAuthConfirmRequestCredential();
      //expect(instance).to.be.a(HealthDataConsentManager.PatientAuthConfirmRequestCredential);
    });
