...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HealthDataConsentManager.SubscriptionRequest();
  });
  ...
  describe('SubscriptionRequest', function() {
    it('should create an instance of SubscriptionRequest', function() {
      ...
      //var instance = new HealthDataConsentManager.SubscriptionRequest();
      //expect(instance).to.be.a(HealthDataConsentManager.SubscriptionRequest);
    });
