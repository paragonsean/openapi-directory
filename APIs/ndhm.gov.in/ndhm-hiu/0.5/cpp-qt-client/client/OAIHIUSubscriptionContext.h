...
/*
 * OAIHIUSubscriptionContext.h
 *
 * 
 */

#ifndef OAIHIUSubscriptionContext_H
#define OAIHIUSubscriptionContext_H
...
class OAIHIUSubscriptionContext : public OAIObject {
public:
    OAIHIUSubscriptionContext();
    OAIHIUSubscriptionContext(QString json);
    ~OAIHIUSubscriptionContext() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIHIUSubscriptionContext)

#endif // OAIHIUSubscriptionContext_H
