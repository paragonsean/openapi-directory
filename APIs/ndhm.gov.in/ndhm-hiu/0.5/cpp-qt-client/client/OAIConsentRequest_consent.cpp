...
OAIConsentArtefactResponse_consent_consentDetail_hip OAIConsentRequest_consent::getHip() const {
    return m_hip;
}
void OAIConsentRequest_consent::setHip(const OAIConsentArtefactResponse_consent_consentDetail_hip &hip) {
    m_hip = hip;
    m_hip_isSet = true;
}
...
OAIConsentArtefactResponse_consent_consentDetail_hiu OAIConsentRequest_consent::getHiu() const {
    return m_hiu;
}
void OAIConsentRequest_consent::setHiu(const OAIConsentArtefactResponse_consent_consentDetail_hiu &hiu) {
    m_hiu = hiu;
    m_hiu_isSet = true;
}
