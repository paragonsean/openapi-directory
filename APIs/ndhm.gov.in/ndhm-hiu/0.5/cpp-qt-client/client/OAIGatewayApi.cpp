...
OAIGatewayApi::OAIGatewayApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAIGatewayApi::~OAIGatewayApi() {
}

void OAIGatewayApi::initializeServerConfigs() {
    //Default server
    ...
    _serverConfigs.insert("v05CertsGet", defaultConf);
    _serverIndices.insert("v05CertsGet", 0);
    ...
    _serverConfigs.insert("v05SessionsPost", defaultConf);
    _serverIndices.insert("v05SessionsPost", 0);
    ...
    _serverConfigs.insert("v05WellKnownOpenidConfigurationGet", defaultConf);
    _serverIndices.insert("v05WellKnownOpenidConfigurationGet", 0);
}
...
*/
int OAIGatewayApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAIGatewayApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAIGatewayApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAIGatewayApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAIGatewayApi::setUsername(const QString &username) {
    _username = username;
}

void OAIGatewayApi::setPassword(const QString &password) {
    _password = password;
}


void OAIGatewayApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAIGatewayApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAIGatewayApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAIGatewayApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAIGatewayApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAIGatewayApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAIGatewayApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAIGatewayApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAIGatewayApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAIGatewayApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAIGatewayApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAIGatewayApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAIGatewayApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAIGatewayApi::v05CertsGet() {
    QString fullPath = QString(_serverConfigs["v05CertsGet"][_serverIndices.value("v05CertsGet")].URL()+"/v0.5/certs");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIGatewayApi::v05CertsGetCallback);
    connect(this, &OAIGatewayApi::abortRequestsSignal, worker, &QObject::deleteLater);
...
void OAIGatewayApi::v05CertsGetCallback(OAIHttpRequestWorker *worker) {
    ...
    OAICerts output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT v05CertsGetSignal(output);
        Q_EMIT v05CertsGetSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT v05CertsGetSignalE(output, error_type, error_str);
        Q_EMIT v05CertsGetSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT v05CertsGetSignalError(output, error_type, error_str);
        Q_EMIT v05CertsGetSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIGatewayApi::v05ConsentRequestsInitPost(const QString &authorization, const QString &x_cm_id, const OAIConsentRequest &oai_consent_request) {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIGatewayApi::v05ConsentRequestsInitPostCallback);
    connect(this, &OAIGatewayApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIGatewayApi::v05ConsentRequestsInitPostCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
...
void OAIGatewayApi::v05ConsentRequestsStatusPost(const QString &authorization, const QString &x_cm_id, const OAIConsentRequestStatusRequest &oai_consent_request_status_request) {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIGatewayApi::v05ConsentRequestsStatusPostCallback);
    connect(this, &OAIGatewayApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIGatewayApi::v05ConsentRequestsStatusPostCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
...
void OAIGatewayApi::v05ConsentsFetchPost(const QString &authorization, const QString &x_cm_id, const OAIConsentFetchRequest &oai_consent_fetch_request) {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIGatewayApi::v05ConsentsFetchPostCallback);
    connect(this, &OAIGatewayApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIGatewayApi::v05ConsentsFetchPostCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
...
void OAIGatewayApi::v05ConsentsHiuOnNotifyPost(const QString &authorization, const QString &x_cm_id, const OAIHIUConsentNotificationResponse &oaihiu_consent_notification_response) {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIGatewayApi::v05ConsentsHiuOnNotifyPostCallback);
    connect(this, &OAIGatewayApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIGatewayApi::v05ConsentsHiuOnNotifyPostCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
...
void OAIGatewayApi::v05HealthInformationCmRequestPost(const QString &authorization, const QString &x_cm_id, const OAIHIRequest &oaihi_request) {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIGatewayApi::v05HealthInformationCmRequestPostCallback);
    connect(this, &OAIGatewayApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIGatewayApi::v05HealthInformationCmRequestPostCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
...
void OAIGatewayApi::v05HealthInformationNotifyPost(const QString &authorization, const QString &x_cm_id, const OAIHealthInformationNotification &oai_health_information_notification) {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIGatewayApi::v05HealthInformationNotifyPostCallback);
    connect(this, &OAIGatewayApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIGatewayApi::v05HealthInformationNotifyPostCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
...
void OAIGatewayApi::v05PatientsFindPost(const QString &authorization, const QString &x_cm_id, const OAIPatientIdentificationRequest &oai_patient_identification_request) {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIGatewayApi::v05PatientsFindPostCallback);
    connect(this, &OAIGatewayApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIGatewayApi::v05PatientsFindPostCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
...
void OAIGatewayApi::v05SessionsPost(const OAISessionRequest &oai_session_request) {
    QString fullPath = QString(_serverConfigs["v05SessionsPost"][_serverIndices.value("v05SessionsPost")].URL()+"/v0.5/sessions");
...

    {
        ...
        QByteArray output = oai_session_request.asJson().toUtf8();
        input.request_body.append(output);
    }
    for (auto keyValueIt = _defaultHeaders.keyValueBegin(); keyValueIt != _defaultHeaders.keyValueEnd(); keyValueIt++) {
        input.headers.insert(keyValueIt->first, keyValueIt->second);
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIGatewayApi::v05SessionsPostCallback);
    connect(this, &OAIGatewayApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIGatewayApi::v05SessionsPostCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    OAISessionResponse output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT v05SessionsPostSignal(output);
        Q_EMIT v05SessionsPostSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT v05SessionsPostSignalE(output, error_type, error_str);
        Q_EMIT v05SessionsPostSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT v05SessionsPostSignalError(output, error_type, error_str);
        Q_EMIT v05SessionsPostSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIGatewayApi::v05SubscriptionRequestsCmInitPost(const QString &authorization, const QString &x_cm_id, const OAISubscriptionRequest &oai_subscription_request) {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIGatewayApi::v05SubscriptionRequestsCmInitPostCallback);
    connect(this, &OAIGatewayApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIGatewayApi::v05SubscriptionRequestsCmInitPostCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
...
void OAIGatewayApi::v05SubscriptionRequestsHiuOnNotifyPost(const QString &authorization, const QString &x_cm_id, const OAIHIUSubscriptionRequestNotificationAcknowledgement &oaihiu_subscription_request_notification_acknowledgement) {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIGatewayApi::v05SubscriptionRequestsHiuOnNotifyPostCallback);
    connect(this, &OAIGatewayApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIGatewayApi::v05SubscriptionRequestsHiuOnNotifyPostCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
...
void OAIGatewayApi::v05SubscriptionsHiuOnNotifyPost(const QString &authorization, const QString &x_cm_id, const OAIHIUSubscriptionNotificationAcknowledgment &oaihiu_subscription_notification_acknowledgment) {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIGatewayApi::v05SubscriptionsHiuOnNotifyPostCallback);
    connect(this, &OAIGatewayApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIGatewayApi::v05SubscriptionsHiuOnNotifyPostCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
...
void OAIGatewayApi::v05UsersAuthConfirmPost(const QString &authorization, const QString &x_cm_id, const OAIPatientAuthConfirmRequest &oai_patient_auth_confirm_request) {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIGatewayApi::v05UsersAuthConfirmPostCallback);
    connect(this, &OAIGatewayApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIGatewayApi::v05UsersAuthConfirmPostCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
...
void OAIGatewayApi::v05UsersAuthFetchModesPost(const QString &authorization, const QString &x_cm_id, const OAIPatientAuthModeQueryRequest &oai_patient_auth_mode_query_request) {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIGatewayApi::v05UsersAuthFetchModesPostCallback);
    connect(this, &OAIGatewayApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIGatewayApi::v05UsersAuthFetchModesPostCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
...
void OAIGatewayApi::v05UsersAuthInitPost(const QString &authorization, const QString &x_cm_id, const OAIPatientAuthInitRequest &oai_patient_auth_init_request) {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIGatewayApi::v05UsersAuthInitPostCallback);
    connect(this, &OAIGatewayApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIGatewayApi::v05UsersAuthInitPostCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
...
void OAIGatewayApi::v05UsersAuthOnNotifyPost(const QString &authorization, const QString &x_cm_id, const OAIPatientAuthNotificationAcknowledgement &oai_patient_auth_notification_acknowledgement) {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIGatewayApi::v05UsersAuthOnNotifyPostCallback);
    connect(this, &OAIGatewayApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIGatewayApi::v05UsersAuthOnNotifyPostCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
...
void OAIGatewayApi::v05WellKnownOpenidConfigurationGet() {
    QString fullPath = QString(_serverConfigs["v05WellKnownOpenidConfigurationGet"][_serverIndices.value("v05WellKnownOpenidConfigurationGet")].URL()+"/v0.5/.well-known/openid-configuration");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIGatewayApi::v05WellKnownOpenidConfigurationGetCallback);
    connect(this, &OAIGatewayApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIGatewayApi::v05WellKnownOpenidConfigurationGetCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    OAIOpenIdConfiguration output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT v05WellKnownOpenidConfigurationGetSignal(output);
        Q_EMIT v05WellKnownOpenidConfigurationGetSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT v05WellKnownOpenidConfigurationGetSignalE(output, error_type, error_str);
        Q_EMIT v05WellKnownOpenidConfigurationGetSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT v05WellKnownOpenidConfigurationGetSignalError(output, error_type, error_str);
        Q_EMIT v05WellKnownOpenidConfigurationGetSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIGatewayApi::tokenAvailable(){
