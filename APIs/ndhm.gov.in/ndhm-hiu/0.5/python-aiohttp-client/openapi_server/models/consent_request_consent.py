...
class ConsentRequestConsent(Model):
    ...
    def __init__(self, care_contexts: List[CareContextDefinition]=None, hi_types: List[HITypeEnum]=None, hip: ConsentArtefactResponseConsentConsentDetailHip=None, hiu: ConsentArtefactResponseConsentConsentDetailHiu=None, patient: ConsentRequestConsentPatient=None, permission: Permission=None, purpose: UsePurpose=None, requester: Requester=None):
