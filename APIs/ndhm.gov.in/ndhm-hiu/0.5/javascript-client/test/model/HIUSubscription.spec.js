...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HealthRepositoryProviderSpecificationsForHiu.HIUSubscription();
  });
  ...
  describe('HIUSubscription', function() {
    it('should create an instance of HIUSubscription', function() {
      ...
      //var instance = new HealthRepositoryProviderSpecificationsForHiu.HIUSubscription();
      //expect(instance).to.be.a(HealthRepositoryProviderSpecificationsForHiu.HIUSubscription);
    });
