...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HealthRepositoryProviderSpecificationsForHiu.SubscriptionRequestSubscription();
  });
  ...
  describe('SubscriptionRequestSubscription', function() {
    it('should create an instance of SubscriptionRequestSubscription', function() {
      ...
      //var instance = new HealthRepositoryProviderSpecificationsForHiu.SubscriptionRequestSubscription();
      //expect(instance).to.be.a(HealthRepositoryProviderSpecificationsForHiu.SubscriptionRequestSubscription);
    });
