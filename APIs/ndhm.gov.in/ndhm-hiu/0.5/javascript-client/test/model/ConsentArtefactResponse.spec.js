...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HealthRepositoryProviderSpecificationsForHiu.ConsentArtefactResponse();
  });
  ...
  describe('ConsentArtefactResponse', function() {
    it('should create an instance of ConsentArtefactResponse', function() {
      // uncomment below and update the code to test ConsentArtefactResponse
      //var instance = new HealthRepositoryProviderSpecificationsForHiu.ConsentArtefactResponse();
      //expect(instance).to.be.a(HealthRepositoryProviderSpecificationsForHiu.ConsentArtefactResponse);
    });
