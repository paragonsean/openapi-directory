...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HealthRepositoryProviderSpecificationsForHiu.SubscriptionRequest();
  });
  ...
  describe('SubscriptionRequest', function() {
    it('should create an instance of SubscriptionRequest', function() {
      ...
      //var instance = new HealthRepositoryProviderSpecificationsForHiu.SubscriptionRequest();
      //expect(instance).to.be.a(HealthRepositoryProviderSpecificationsForHiu.SubscriptionRequest);
    });
