...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HealthRepositoryProviderSpecificationsForHiu.ConsentRequestStatusRequest();
  });
  ...
  describe('ConsentRequestStatusRequest', function() {
    it('should create an instance of ConsentRequestStatusRequest', function() {
      ...
      //var instance = new HealthRepositoryProviderSpecificationsForHiu.ConsentRequestStatusRequest();
      //expect(instance).to.be.a(HealthRepositoryProviderSpecificationsForHiu.ConsentRequestStatusRequest);
    });
