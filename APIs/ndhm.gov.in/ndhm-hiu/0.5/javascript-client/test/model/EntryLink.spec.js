...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HealthRepositoryProviderSpecificationsForHiu.EntryLink();
  });
  ...
  describe('EntryLink', function() {
    it('should create an instance of EntryLink', function() {
      ...
      //var instance = new HealthRepositoryProviderSpecificationsForHiu.EntryLink();
      //expect(instance).to.be.a(HealthRepositoryProviderSpecificationsForHiu.EntryLink);
    });
