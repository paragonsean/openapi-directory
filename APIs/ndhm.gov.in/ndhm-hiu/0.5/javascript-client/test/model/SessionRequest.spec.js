...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HealthRepositoryProviderSpecificationsForHiu.SessionRequest();
  });
  ...
  describe('SessionRequest', function() {
    it('should create an instance of SessionRequest', function() {
      ...
      //var instance = new HealthRepositoryProviderSpecificationsForHiu.SessionRequest();
      //expect(instance).to.be.a(HealthRepositoryProviderSpecificationsForHiu.SessionRequest);
    });
