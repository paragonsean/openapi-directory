...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HealthRepositoryProviderSpecificationsForHiu.PatientAuthConfirmRequestCredential();
  });
  ...
  describe('PatientAuthConfirmRequestCredential', function() {
    it('should create an instance of PatientAuthConfirmRequestCredential', function() {
      ...
      //var instance = new HealthRepositoryProviderSpecificationsForHiu.PatientAuthConfirmRequestCredential();
      //expect(instance).to.be.a(HealthRepositoryProviderSpecificationsForHiu.PatientAuthConfirmRequestCredential);
    });
