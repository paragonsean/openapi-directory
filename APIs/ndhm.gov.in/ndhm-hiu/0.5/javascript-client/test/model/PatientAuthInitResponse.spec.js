...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HealthRepositoryProviderSpecificationsForHiu.PatientAuthInitResponse();
  });
  ...
  describe('PatientAuthInitResponse', function() {
    it('should create an instance of PatientAuthInitResponse', function() {
      ...
      //var instance = new HealthRepositoryProviderSpecificationsForHiu.PatientAuthInitResponse();
      //expect(instance).to.be.a(HealthRepositoryProviderSpecificationsForHiu.PatientAuthInitResponse);
    });
