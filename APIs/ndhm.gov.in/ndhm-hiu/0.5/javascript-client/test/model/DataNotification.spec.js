...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HealthRepositoryProviderSpecificationsForHiu.DataNotification();
  });
  ...
  describe('DataNotification', function() {
    it('should create an instance of DataNotification', function() {
      // uncomment below and update the code to test DataNotification
      //var instance = new HealthRepositoryProviderSpecificationsForHiu.DataNotification();
      //expect(instance).to.be.a(HealthRepositoryProviderSpecificationsForHiu.DataNotification);
    });
