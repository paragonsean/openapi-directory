...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HealthRepositoryProviderSpecificationsForHiu.ConsentRequestConsent();
  });
  ...
  describe('ConsentRequestConsent', function() {
    it('should create an instance of ConsentRequestConsent', function() {
      ...
      //var instance = new HealthRepositoryProviderSpecificationsForHiu.ConsentRequestConsent();
      //expect(instance).to.be.a(HealthRepositoryProviderSpecificationsForHiu.ConsentRequestConsent);
    });
