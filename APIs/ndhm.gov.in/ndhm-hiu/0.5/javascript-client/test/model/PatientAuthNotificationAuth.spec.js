...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HealthRepositoryProviderSpecificationsForHiu.PatientAuthNotificationAuth();
  });
  ...
  describe('PatientAuthNotificationAuth', function() {
    it('should create an instance of PatientAuthNotificationAuth', function() {
      // uncomment below and update the code to test PatientAuthNotificationAuth
      //var instance = new HealthRepositoryProviderSpecificationsForHiu.PatientAuthNotificationAuth();
      //expect(instance).to.be.a(HealthRepositoryProviderSpecificationsForHiu.PatientAuthNotificationAuth);
    });
