...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HealthRepositoryProviderSpecificationsForHiu.OpenIdConfiguration();
  });
  ...
  describe('OpenIdConfiguration', function() {
    it('should create an instance of OpenIdConfiguration', function() {
      ...
      //var instance = new HealthRepositoryProviderSpecificationsForHiu.OpenIdConfiguration();
      //expect(instance).to.be.a(HealthRepositoryProviderSpecificationsForHiu.OpenIdConfiguration);
    });
