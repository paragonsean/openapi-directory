...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HealthRepositoryProviderSpecificationsForHiu.ConsentManagerPatientID();
  });
  ...
  describe('ConsentManagerPatientID', function() {
    it('should create an instance of ConsentManagerPatientID', function() {
      ...
      //var instance = new HealthRepositoryProviderSpecificationsForHiu.ConsentManagerPatientID();
      //expect(instance).to.be.a(HealthRepositoryProviderSpecificationsForHiu.ConsentManagerPatientID);
    });
