...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HealthRepositoryProviderSpecificationsForHiu.HealthInformationNotificationNotificationStatusNotificationStatusResponsesInner();
  });
  ...
  describe('HealthInformationNotificationNotificationStatusNotificationStatusResponsesInner', function() {
    it('should create an instance of HealthInformationNotificationNotificationStatusNotificationStatusResponsesInner', function() {
      ...
      //var instance = new HealthRepositoryProviderSpecificationsForHiu.HealthInformationNotificationNotificationStatusNotificationStatusResponsesInner();
      //expect(instance).to.be.a(HealthRepositoryProviderSpecificationsForHiu.HealthInformationNotificationNotificationStatusNotificationStatusResponsesInner);
    });
