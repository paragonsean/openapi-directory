...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HealthRepositoryProviderSpecificationsForHiu.PatientAuthConfirmResponseAuth();
  });
  ...
  describe('PatientAuthConfirmResponseAuth', function() {
    it('should create an instance of PatientAuthConfirmResponseAuth', function() {
      ...
      //var instance = new HealthRepositoryProviderSpecificationsForHiu.PatientAuthConfirmResponseAuth();
      //expect(instance).to.be.a(HealthRepositoryProviderSpecificationsForHiu.PatientAuthConfirmResponseAuth);
    });
