...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HealthRepositoryProviderSpecificationsForHiu.AccessTokenValidity();
  });
  ...
  describe('AccessTokenValidity', function() {
    it('should create an instance of AccessTokenValidity', function() {
      ...
      //var instance = new HealthRepositoryProviderSpecificationsForHiu.AccessTokenValidity();
      //expect(instance).to.be.a(HealthRepositoryProviderSpecificationsForHiu.AccessTokenValidity);
    });
