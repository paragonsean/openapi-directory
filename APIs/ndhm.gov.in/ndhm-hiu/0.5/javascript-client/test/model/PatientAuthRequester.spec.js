...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HealthRepositoryProviderSpecificationsForHiu.PatientAuthRequester();
  });
  ...
  describe('PatientAuthRequester', function() {
    it('should create an instance of PatientAuthRequester', function() {
      ...
      //var instance = new HealthRepositoryProviderSpecificationsForHiu.PatientAuthRequester();
      //expect(instance).to.be.a(HealthRepositoryProviderSpecificationsForHiu.PatientAuthRequester);
    });
