...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HealthRepositoryProviderSpecificationsForHiu.DataNotificationEntriesInner();
  });
  ...
  describe('DataNotificationEntriesInner', function() {
    it('should create an instance of DataNotificationEntriesInner', function() {
      // uncomment below and update the code to test DataNotificationEntriesInner
      //var instance = new HealthRepositoryProviderSpecificationsForHiu.DataNotificationEntriesInner();
      //expect(instance).to.be.a(HealthRepositoryProviderSpecificationsForHiu.DataNotificationEntriesInner);
    });
