...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HealthRepositoryProviderSpecificationsForHiu.PatientAuthInitRequestQuery();
  });
  ...
  describe('PatientAuthInitRequestQuery', function() {
    it('should create an instance of PatientAuthInitRequestQuery', function() {
      ...
      //var instance = new HealthRepositoryProviderSpecificationsForHiu.PatientAuthInitRequestQuery();
      //expect(instance).to.be.a(HealthRepositoryProviderSpecificationsForHiu.PatientAuthInitRequestQuery);
    });
