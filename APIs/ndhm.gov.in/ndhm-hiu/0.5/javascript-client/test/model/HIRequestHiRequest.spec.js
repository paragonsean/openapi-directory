...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HealthRepositoryProviderSpecificationsForHiu.HIRequestHiRequest();
  });
  ...
  describe('HIRequestHiRequest', function() {
    it('should create an instance of HIRequestHiRequest', function() {
      ...
      //var instance = new HealthRepositoryProviderSpecificationsForHiu.HIRequestHiRequest();
      //expect(instance).to.be.a(HealthRepositoryProviderSpecificationsForHiu.HIRequestHiRequest);
    });
