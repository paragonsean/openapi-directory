...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HealthRepositoryProviderSpecificationsForHiu.KeyObject();
  });
  ...
  describe('KeyObject', function() {
    it('should create an instance of KeyObject', function() {
      ...
      //var instance = new HealthRepositoryProviderSpecificationsForHiu.KeyObject();
      //expect(instance).to.be.a(HealthRepositoryProviderSpecificationsForHiu.KeyObject);
    });
