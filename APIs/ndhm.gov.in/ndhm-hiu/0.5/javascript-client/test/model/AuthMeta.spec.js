...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HealthRepositoryProviderSpecificationsForHiu.AuthMeta();
  });
  ...
  describe('AuthMeta', function() {
    it('should create an instance of AuthMeta', function() {
      ...
      //var instance = new HealthRepositoryProviderSpecificationsForHiu.AuthMeta();
      //expect(instance).to.be.a(HealthRepositoryProviderSpecificationsForHiu.AuthMeta);
    });
