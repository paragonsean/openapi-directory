...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HealthRepositoryProviderSpecificationsForHiu.ConsentRequest();
  });
  ...
  describe('ConsentRequest', function() {
    it('should create an instance of ConsentRequest', function() {
      ...
      //var instance = new HealthRepositoryProviderSpecificationsForHiu.ConsentRequest();
      //expect(instance).to.be.a(HealthRepositoryProviderSpecificationsForHiu.ConsentRequest);
    });
