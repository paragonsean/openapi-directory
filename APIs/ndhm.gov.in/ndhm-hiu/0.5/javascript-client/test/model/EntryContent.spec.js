...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HealthRepositoryProviderSpecificationsForHiu.EntryContent();
  });
  ...
  describe('EntryContent', function() {
    it('should create an instance of EntryContent', function() {
      ...
      //var instance = new HealthRepositoryProviderSpecificationsForHiu.EntryContent();
      //expect(instance).to.be.a(HealthRepositoryProviderSpecificationsForHiu.EntryContent);
    });
