...
(function(root, factory) {
  ...
  describe('SubscriptionStatus', function() {
    it('should create an instance of SubscriptionStatus', function() {
      ...
      //var instance = new HealthRepositoryProviderSpecificationsForHiu.SubscriptionStatus();
      //expect(instance).to.be.a(HealthRepositoryProviderSpecificationsForHiu.SubscriptionStatus);
    });
