...
public class ApiClient {
    ...
    private String basePath = "https://dev.ndhm.gov.in/gateway";
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/0.5/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://dev.ndhm.gov.in/gateway
