...
export default class UserAuthApi {
    ...
    */
     ...
     */
    v05UsersAuthOnConfirmPost(authorization, X_HIP_ID, X_HIU_ID, patientAuthConfirmResponse, opts, callback) {
      opts = opts || {};
     ...
     */
    v05UsersAuthOnInitPost(authorization, X_HIP_ID, X_HIU_ID, patientAuthInitResponse, opts, callback) {
      opts = opts || {};
