...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HealthRepositoryProviderSpecificationsForHip.PatientAuthInitResponse();
  });
  ...
  describe('PatientAuthInitResponse', function() {
    it('should create an instance of PatientAuthInitResponse', function() {
      ...
      //var instance = new HealthRepositoryProviderSpecificationsForHip.PatientAuthInitResponse();
      //expect(instance).to.be.a(HealthRepositoryProviderSpecificationsForHip.PatientAuthInitResponse);
    });
