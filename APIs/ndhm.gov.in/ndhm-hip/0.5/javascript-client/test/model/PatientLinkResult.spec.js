...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HealthRepositoryProviderSpecificationsForHip.PatientLinkResult();
  });
  ...
  describe('PatientLinkResult', function() {
    it('should create an instance of PatientLinkResult', function() {
      ...
      //var instance = new HealthRepositoryProviderSpecificationsForHip.PatientLinkResult();
      //expect(instance).to.be.a(HealthRepositoryProviderSpecificationsForHip.PatientLinkResult);
    });
