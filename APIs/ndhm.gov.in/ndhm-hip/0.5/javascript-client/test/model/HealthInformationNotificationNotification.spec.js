...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HealthRepositoryProviderSpecificationsForHip.HealthInformationNotificationNotification();
  });
  ...
  describe('HealthInformationNotificationNotification', function() {
    it('should create an instance of HealthInformationNotificationNotification', function() {
      ...
      //var instance = new HealthRepositoryProviderSpecificationsForHip.HealthInformationNotificationNotification();
      //expect(instance).to.be.a(HealthRepositoryProviderSpecificationsForHip.HealthInformationNotificationNotification);
    });
