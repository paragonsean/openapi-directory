...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HealthRepositoryProviderSpecificationsForHip.DataNotification();
  });
  ...
  describe('DataNotification', function() {
    it('should create an instance of DataNotification', function() {
      ...
      //var instance = new HealthRepositoryProviderSpecificationsForHip.DataNotification();
      //expect(instance).to.be.a(HealthRepositoryProviderSpecificationsForHip.DataNotification);
    });
