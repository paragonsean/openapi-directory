...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HealthRepositoryProviderSpecificationsForHip.HIPHealthInformationRequestAcknowledgement();
  });
  ...
  describe('HIPHealthInformationRequestAcknowledgement', function() {
    it('should create an instance of HIPHealthInformationRequestAcknowledgement', function() {
      ...
      //var instance = new HealthRepositoryProviderSpecificationsForHip.HIPHealthInformationRequestAcknowledgement();
      //expect(instance).to.be.a(HealthRepositoryProviderSpecificationsForHip.HIPHealthInformationRequestAcknowledgement);
    });
