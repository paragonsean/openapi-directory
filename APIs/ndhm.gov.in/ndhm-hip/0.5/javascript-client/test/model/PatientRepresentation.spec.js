...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HealthRepositoryProviderSpecificationsForHip.PatientRepresentation();
  });
  ...
  describe('PatientRepresentation', function() {
    it('should create an instance of PatientRepresentation', function() {
      // uncomment below and update the code to test PatientRepresentation
      //var instance = new HealthRepositoryProviderSpecificationsForHip.PatientRepresentation();
      //expect(instance).to.be.a(HealthRepositoryProviderSpecificationsForHip.PatientRepresentation);
    });
    ...
    it('should have the property matchedBy (base name: "matchedBy")', function() {
      // uncomment below and update the code to test the property matchedBy
      //var instance = new HealthRepositoryProviderSpecificationsForHip.PatientRepresentation();
      //expect(instance).to.be();
    });
