...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HealthRepositoryProviderSpecificationsForHip.PatientCareContextLink();
  });
  ...
  describe('PatientCareContextLink', function() {
    it('should create an instance of PatientCareContextLink', function() {
      ...
      //var instance = new HealthRepositoryProviderSpecificationsForHip.PatientCareContextLink();
      //expect(instance).to.be.a(HealthRepositoryProviderSpecificationsForHip.PatientCareContextLink);
    });
