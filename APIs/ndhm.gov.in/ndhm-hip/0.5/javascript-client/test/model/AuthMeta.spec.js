...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HealthRepositoryProviderSpecificationsForHip.AuthMeta();
  });
  ...
  describe('AuthMeta', function() {
    it('should create an instance of AuthMeta', function() {
      ...
      //var instance = new HealthRepositoryProviderSpecificationsForHip.AuthMeta();
      //expect(instance).to.be.a(HealthRepositoryProviderSpecificationsForHip.AuthMeta);
    });
