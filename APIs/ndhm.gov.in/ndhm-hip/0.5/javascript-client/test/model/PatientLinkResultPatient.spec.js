...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HealthRepositoryProviderSpecificationsForHip.PatientLinkResultPatient();
  });
  ...
  describe('PatientLinkResultPatient', function() {
    it('should create an instance of PatientLinkResultPatient', function() {
      ...
      //var instance = new HealthRepositoryProviderSpecificationsForHip.PatientLinkResultPatient();
      //expect(instance).to.be.a(HealthRepositoryProviderSpecificationsForHip.PatientLinkResultPatient);
    });
