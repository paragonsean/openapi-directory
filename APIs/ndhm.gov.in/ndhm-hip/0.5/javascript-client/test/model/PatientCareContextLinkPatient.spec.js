...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HealthRepositoryProviderSpecificationsForHip.PatientCareContextLinkPatient();
  });
  ...
  describe('PatientCareContextLinkPatient', function() {
    it('should create an instance of PatientCareContextLinkPatient', function() {
      ...
      //var instance = new HealthRepositoryProviderSpecificationsForHip.PatientCareContextLinkPatient();
      //expect(instance).to.be.a(HealthRepositoryProviderSpecificationsForHip.PatientCareContextLinkPatient);
    });
