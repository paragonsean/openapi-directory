...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HealthRepositoryProviderSpecificationsForHip.ErrorResponse();
  });
  ...
  describe('ErrorResponse', function() {
    it('should create an instance of ErrorResponse', function() {
      ...
      //var instance = new HealthRepositoryProviderSpecificationsForHip.ErrorResponse();
      //expect(instance).to.be.a(HealthRepositoryProviderSpecificationsForHip.ErrorResponse);
    });
