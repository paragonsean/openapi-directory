...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HealthRepositoryProviderSpecificationsForHip.LinkConfirmationRequestConfirmation();
  });
  ...
  describe('LinkConfirmationRequestConfirmation', function() {
    it('should create an instance of LinkConfirmationRequestConfirmation', function() {
      ...
      //var instance = new HealthRepositoryProviderSpecificationsForHip.LinkConfirmationRequestConfirmation();
      //expect(instance).to.be.a(HealthRepositoryProviderSpecificationsForHip.LinkConfirmationRequestConfirmation);
    });
