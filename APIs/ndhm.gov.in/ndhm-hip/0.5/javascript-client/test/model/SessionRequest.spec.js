...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HealthRepositoryProviderSpecificationsForHip.SessionRequest();
  });
  ...
  describe('SessionRequest', function() {
    it('should create an instance of SessionRequest', function() {
      ...
      //var instance = new HealthRepositoryProviderSpecificationsForHip.SessionRequest();
      //expect(instance).to.be.a(HealthRepositoryProviderSpecificationsForHip.SessionRequest);
    });
