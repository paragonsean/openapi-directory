...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HealthRepositoryProviderSpecificationsForHip.PatientAuthConfirmResponseAuth();
  });
  ...
  describe('PatientAuthConfirmResponseAuth', function() {
    it('should create an instance of PatientAuthConfirmResponseAuth', function() {
      ...
      //var instance = new HealthRepositoryProviderSpecificationsForHip.PatientAuthConfirmResponseAuth();
      //expect(instance).to.be.a(HealthRepositoryProviderSpecificationsForHip.PatientAuthConfirmResponseAuth);
    });
