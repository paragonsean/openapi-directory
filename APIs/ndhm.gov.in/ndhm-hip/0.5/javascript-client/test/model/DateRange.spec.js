...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HealthRepositoryProviderSpecificationsForHip.DateRange();
  });
  ...
  describe('DateRange', function() {
    it('should create an instance of DateRange', function() {
      ...
      //var instance = new HealthRepositoryProviderSpecificationsForHip.DateRange();
      //expect(instance).to.be.a(HealthRepositoryProviderSpecificationsForHip.DateRange);
    });
