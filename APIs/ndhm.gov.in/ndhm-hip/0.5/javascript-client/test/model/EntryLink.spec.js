...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HealthRepositoryProviderSpecificationsForHip.EntryLink();
  });
  ...
  describe('EntryLink', function() {
    it('should create an instance of EntryLink', function() {
      ...
      //var instance = new HealthRepositoryProviderSpecificationsForHip.EntryLink();
      //expect(instance).to.be.a(HealthRepositoryProviderSpecificationsForHip.EntryLink);
    });
