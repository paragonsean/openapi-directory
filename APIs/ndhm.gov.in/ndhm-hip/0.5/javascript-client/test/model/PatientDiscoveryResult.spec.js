...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HealthRepositoryProviderSpecificationsForHip.PatientDiscoveryResult();
  });
  ...
  describe('PatientDiscoveryResult', function() {
    it('should create an instance of PatientDiscoveryResult', function() {
      ...
      //var instance = new HealthRepositoryProviderSpecificationsForHip.PatientDiscoveryResult();
      //expect(instance).to.be.a(HealthRepositoryProviderSpecificationsForHip.PatientDiscoveryResult);
    });
