...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HealthRepositoryProviderSpecificationsForHip.AccessTokenValidity();
  });
  ...
  describe('AccessTokenValidity', function() {
    it('should create an instance of AccessTokenValidity', function() {
      ...
      //var instance = new HealthRepositoryProviderSpecificationsForHip.AccessTokenValidity();
      //expect(instance).to.be.a(HealthRepositoryProviderSpecificationsForHip.AccessTokenValidity);
    });
