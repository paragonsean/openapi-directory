...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HealthRepositoryProviderSpecificationsForHip.ConsentManagerPatientID();
  });
  ...
  describe('ConsentManagerPatientID', function() {
    it('should create an instance of ConsentManagerPatientID', function() {
      ...
      //var instance = new HealthRepositoryProviderSpecificationsForHip.ConsentManagerPatientID();
      //expect(instance).to.be.a(HealthRepositoryProviderSpecificationsForHip.ConsentManagerPatientID);
    });
