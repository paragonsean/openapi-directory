...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HealthRepositoryProviderSpecificationsForHip.PatientAuthConfirmRequestCredential();
  });
  ...
  describe('PatientAuthConfirmRequestCredential', function() {
    it('should create an instance of PatientAuthConfirmRequestCredential', function() {
      ...
      //var instance = new HealthRepositoryProviderSpecificationsForHip.PatientAuthConfirmRequestCredential();
      //expect(instance).to.be.a(HealthRepositoryProviderSpecificationsForHip.PatientAuthConfirmRequestCredential);
    });
