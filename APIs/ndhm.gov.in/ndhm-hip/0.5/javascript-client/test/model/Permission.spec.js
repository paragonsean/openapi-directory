...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HealthRepositoryProviderSpecificationsForHip.Permission();
  });
  ...
  describe('Permission', function() {
    it('should create an instance of Permission', function() {
      ...
      //var instance = new HealthRepositoryProviderSpecificationsForHip.Permission();
      //expect(instance).to.be.a(HealthRepositoryProviderSpecificationsForHip.Permission);
    });
