...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HealthRepositoryProviderSpecificationsForHip.KeyObject();
  });
  ...
  describe('KeyObject', function() {
    it('should create an instance of KeyObject', function() {
      ...
      //var instance = new HealthRepositoryProviderSpecificationsForHip.KeyObject();
      //expect(instance).to.be.a(HealthRepositoryProviderSpecificationsForHip.KeyObject);
    });
