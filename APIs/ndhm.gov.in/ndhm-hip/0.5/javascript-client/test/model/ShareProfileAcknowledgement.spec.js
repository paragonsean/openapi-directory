...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HealthRepositoryProviderSpecificationsForHip.ShareProfileAcknowledgement();
  });
  ...
  describe('ShareProfileAcknowledgement', function() {
    it('should create an instance of ShareProfileAcknowledgement', function() {
      ...
      //var instance = new HealthRepositoryProviderSpecificationsForHip.ShareProfileAcknowledgement();
      //expect(instance).to.be.a(HealthRepositoryProviderSpecificationsForHip.ShareProfileAcknowledgement);
    });
