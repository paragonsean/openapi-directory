...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HealthRepositoryProviderSpecificationsForHip.DataNotificationEntriesInner();
  });
  ...
  describe('DataNotificationEntriesInner', function() {
    it('should create an instance of DataNotificationEntriesInner', function() {
      ...
      //var instance = new HealthRepositoryProviderSpecificationsForHip.DataNotificationEntriesInner();
      //expect(instance).to.be.a(HealthRepositoryProviderSpecificationsForHip.DataNotificationEntriesInner);
    });
