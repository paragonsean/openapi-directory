...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HealthRepositoryProviderSpecificationsForHip.Consent();
  });
  ...
  describe('Consent', function() {
    it('should create an instance of Consent', function() {
      ...
      //var instance = new HealthRepositoryProviderSpecificationsForHip.Consent();
      //expect(instance).to.be.a(HealthRepositoryProviderSpecificationsForHip.Consent);
    });
