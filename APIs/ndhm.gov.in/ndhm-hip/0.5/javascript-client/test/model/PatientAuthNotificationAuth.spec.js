...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HealthRepositoryProviderSpecificationsForHip.PatientAuthNotificationAuth();
  });
  ...
  describe('PatientAuthNotificationAuth', function() {
    it('should create an instance of PatientAuthNotificationAuth', function() {
      ...
      //var instance = new HealthRepositoryProviderSpecificationsForHip.PatientAuthNotificationAuth();
      //expect(instance).to.be.a(HealthRepositoryProviderSpecificationsForHip.PatientAuthNotificationAuth);
    });
