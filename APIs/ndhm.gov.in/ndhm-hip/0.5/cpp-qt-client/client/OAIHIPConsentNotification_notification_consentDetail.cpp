...
QList<OAIHIPConsentNotification_notification_consentDetail_careContexts_inner> OAIHIPConsentNotification_notification_consentDetail::getCareContexts() const {
    return m_care_contexts;
}
void OAIHIPConsentNotification_notification_consentDetail::setCareContexts(const QList<OAIHIPConsentNotification_notification_consentDetail_careContexts_inner> &care_contexts) {
...
OAIHIPConsentNotification_notification_consentDetail_hip OAIHIPConsentNotification_notification_consentDetail::getHip() const {
    return m_hip;
}
void OAIHIPConsentNotification_notification_consentDetail::setHip(const OAIHIPConsentNotification_notification_consentDetail_hip &hip) {
    m_hip = hip;
    m_hip_isSet = true;
}
