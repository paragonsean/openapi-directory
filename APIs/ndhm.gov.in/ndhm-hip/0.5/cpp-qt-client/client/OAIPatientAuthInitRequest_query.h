...
namespace OpenAPI {
class OAIPatientAuthInitRequest_query_requester;
...
public:
    ...
    OAIPatientAuthInitRequest_query_requester getRequester() const;
    void setRequester(const OAIPatientAuthInitRequest_query_requester &requester);
...
private:
    ...
    OAIPatientAuthInitRequest_query_requester m_requester;
