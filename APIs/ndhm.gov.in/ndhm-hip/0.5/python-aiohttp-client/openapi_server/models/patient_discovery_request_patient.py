...
class PatientDiscoveryRequestPatient(Model):
    ...
    def __init__(self, gender: str=None, id: str=None, name: str=None, unverified_identifiers: List[Identifier]=None, verified_identifiers: List[Identifier]=None, year_of_birth: int=None):
    ...
    def gender(self, gender):
        ...
        :type gender: str
        """
        allowed_values = ["M", "F", "O", "U"]  # noqa: E501
