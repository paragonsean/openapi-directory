...
public class PatientDiscoveryRequest {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.patient, patientDiscoveryRequest.patient) &&
        Objects.equals(this.requestId, patientDiscoveryRequest.requestId) &&
   ...
   * @throws IOException if the JSON Element is invalid with respect to PatientDiscoveryRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PatientDiscoveryRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PatientDiscoveryRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PatientDiscoveryRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      PatientDiscoveryRequestPatient.validateJsonElement(jsonObj.get("patient"));
