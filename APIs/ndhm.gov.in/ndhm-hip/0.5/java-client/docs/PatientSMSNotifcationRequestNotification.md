...
|**deeplinkUrl** | **URI** | A link pointing to digital health records of the patient. PHR App&#39;s deeplink will be sent in SMS if this field is not provided. |  [optional] |
