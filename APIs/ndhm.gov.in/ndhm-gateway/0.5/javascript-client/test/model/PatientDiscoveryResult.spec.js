...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Gateway.PatientDiscoveryResult();
  });
  ...
  describe('PatientDiscoveryResult', function() {
    it('should create an instance of PatientDiscoveryResult', function() {
      // uncomment below and update the code to test PatientDiscoveryResult
      //var instance = new Gateway.PatientDiscoveryResult();
      //expect(instance).to.be.a(Gateway.PatientDiscoveryResult);
    });
