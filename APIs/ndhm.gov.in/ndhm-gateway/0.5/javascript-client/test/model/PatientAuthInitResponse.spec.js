...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Gateway.PatientAuthInitResponse();
  });
  ...
  describe('PatientAuthInitResponse', function() {
    it('should create an instance of PatientAuthInitResponse', function() {
      // uncomment below and update the code to test PatientAuthInitResponse
      //var instance = new Gateway.PatientAuthInitResponse();
      //expect(instance).to.be.a(Gateway.PatientAuthInitResponse);
    });
