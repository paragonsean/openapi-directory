...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Gateway.ConsentRequestStatusRequest();
  });
  ...
  describe('ConsentRequestStatusRequest', function() {
    it('should create an instance of ConsentRequestStatusRequest', function() {
      ...
      //var instance = new Gateway.ConsentRequestStatusRequest();
      //expect(instance).to.be.a(Gateway.ConsentRequestStatusRequest);
    });
