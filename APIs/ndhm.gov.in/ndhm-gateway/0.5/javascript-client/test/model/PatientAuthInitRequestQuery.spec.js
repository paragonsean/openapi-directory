...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Gateway.PatientAuthInitRequestQuery();
  });
  ...
  describe('PatientAuthInitRequestQuery', function() {
    it('should create an instance of PatientAuthInitRequestQuery', function() {
      ...
      //var instance = new Gateway.PatientAuthInitRequestQuery();
      //expect(instance).to.be.a(Gateway.PatientAuthInitRequestQuery);
    });
