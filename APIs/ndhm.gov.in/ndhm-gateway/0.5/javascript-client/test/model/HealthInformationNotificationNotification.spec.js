...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Gateway.HealthInformationNotificationNotification();
  });
  ...
  describe('HealthInformationNotificationNotification', function() {
    it('should create an instance of HealthInformationNotificationNotification', function() {
      ...
      //var instance = new Gateway.HealthInformationNotificationNotification();
      //expect(instance).to.be.a(Gateway.HealthInformationNotificationNotification);
    });
