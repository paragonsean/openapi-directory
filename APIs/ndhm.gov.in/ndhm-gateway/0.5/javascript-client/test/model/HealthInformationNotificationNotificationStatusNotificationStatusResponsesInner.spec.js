...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Gateway.HealthInformationNotificationNotificationStatusNotificationStatusResponsesInner();
  });
  ...
  describe('HealthInformationNotificationNotificationStatusNotificationStatusResponsesInner', function() {
    it('should create an instance of HealthInformationNotificationNotificationStatusNotificationStatusResponsesInner', function() {
      ...
      //var instance = new Gateway.HealthInformationNotificationNotificationStatusNotificationStatusResponsesInner();
      //expect(instance).to.be.a(Gateway.HealthInformationNotificationNotificationStatusNotificationStatusResponsesInner);
    });
