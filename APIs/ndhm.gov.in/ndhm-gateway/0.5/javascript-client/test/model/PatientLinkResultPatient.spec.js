...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Gateway.PatientLinkResultPatient();
  });
  ...
  describe('PatientLinkResultPatient', function() {
    it('should create an instance of PatientLinkResultPatient', function() {
      ...
      //var instance = new Gateway.PatientLinkResultPatient();
      //expect(instance).to.be.a(Gateway.PatientLinkResultPatient);
    });
