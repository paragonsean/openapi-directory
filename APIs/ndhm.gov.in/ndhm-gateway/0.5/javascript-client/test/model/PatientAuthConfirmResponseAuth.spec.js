...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Gateway.PatientAuthConfirmResponseAuth();
  });
  ...
  describe('PatientAuthConfirmResponseAuth', function() {
    it('should create an instance of PatientAuthConfirmResponseAuth', function() {
      // uncomment below and update the code to test PatientAuthConfirmResponseAuth
      //var instance = new Gateway.PatientAuthConfirmResponseAuth();
      //expect(instance).to.be.a(Gateway.PatientAuthConfirmResponseAuth);
    });
