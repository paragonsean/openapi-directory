...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Gateway.HIPHIRequest();
  });
  ...
  describe('HIPHIRequest', function() {
    it('should create an instance of HIPHIRequest', function() {
      // uncomment below and update the code to test HIPHIRequest
      //var instance = new Gateway.HIPHIRequest();
      //expect(instance).to.be.a(Gateway.HIPHIRequest);
    });
