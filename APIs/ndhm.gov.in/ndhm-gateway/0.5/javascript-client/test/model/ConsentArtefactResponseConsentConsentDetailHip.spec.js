...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Gateway.ConsentArtefactResponseConsentConsentDetailHip();
  });
  ...
  describe('ConsentArtefactResponseConsentConsentDetailHip', function() {
    it('should create an instance of ConsentArtefactResponseConsentConsentDetailHip', function() {
      ...
      //var instance = new Gateway.ConsentArtefactResponseConsentConsentDetailHip();
      //expect(instance).to.be.a(Gateway.ConsentArtefactResponseConsentConsentDetailHip);
    });
