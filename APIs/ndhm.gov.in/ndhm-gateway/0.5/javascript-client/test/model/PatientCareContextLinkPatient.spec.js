...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Gateway.PatientCareContextLinkPatient();
  });
  ...
  describe('PatientCareContextLinkPatient', function() {
    it('should create an instance of PatientCareContextLinkPatient', function() {
      ...
      //var instance = new Gateway.PatientCareContextLinkPatient();
      //expect(instance).to.be.a(Gateway.PatientCareContextLinkPatient);
    });
