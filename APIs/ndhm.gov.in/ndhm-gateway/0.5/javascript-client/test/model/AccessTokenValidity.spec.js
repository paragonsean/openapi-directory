...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Gateway.AccessTokenValidity();
  });
  ...
  describe('AccessTokenValidity', function() {
    it('should create an instance of AccessTokenValidity', function() {
      // uncomment below and update the code to test AccessTokenValidity
      //var instance = new Gateway.AccessTokenValidity();
      //expect(instance).to.be.a(Gateway.AccessTokenValidity);
    });
