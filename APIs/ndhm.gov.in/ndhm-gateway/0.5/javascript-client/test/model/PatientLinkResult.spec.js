...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Gateway.PatientLinkResult();
  });
  ...
  describe('PatientLinkResult', function() {
    it('should create an instance of PatientLinkResult', function() {
      // uncomment below and update the code to test PatientLinkResult
      //var instance = new Gateway.PatientLinkResult();
      //expect(instance).to.be.a(Gateway.PatientLinkResult);
    });
