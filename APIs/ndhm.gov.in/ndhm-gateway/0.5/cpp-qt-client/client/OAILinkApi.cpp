...
void OAILinkApi::v05LinksLinkAddContextsPost(const QString &authorization, const QString &x_cm_id, const OAIPatientCareContextLinkRequest &oai_patient_care_context_link_request) {
...
void OAILinkApi::v05LinksLinkOnConfirmPost(const QString &authorization, const QString &x_cm_id, const OAIPatientLinkResult &oai_patient_link_result) {
...
void OAILinkApi::v05LinksLinkOnInitPost(const QString &authorization, const QString &x_cm_id, const OAIPatientLinkReferenceResult &oai_patient_link_reference_result) {
