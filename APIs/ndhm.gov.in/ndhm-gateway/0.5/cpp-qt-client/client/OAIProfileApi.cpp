...
void OAIProfileApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("v05PatientsProfileOnSharePost", defaultConf);
    _serverIndices.insert("v05PatientsProfileOnSharePost", 0);
...
void OAIProfileApi::v05PatientsProfileOnSharePost(const QString &authorization, const QString &x_cm_id, const OAIShareProfileResult &oai_share_profile_result) {
    QString fullPath = QString(_serverConfigs["v05PatientsProfileOnSharePost"][_serverIndices.value("v05PatientsProfileOnSharePost")].URL()+"/v0.5/patients/profile/on-share");
...

    {
        ...
        QByteArray output = oai_share_profile_result.asJson().toUtf8();
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIProfileApi::v05PatientsProfileOnSharePostCallback);
...
void OAIProfileApi::v05PatientsProfileOnSharePostCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT v05PatientsProfileOnSharePostSignal();
        Q_EMIT v05PatientsProfileOnSharePostSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT v05PatientsProfileOnSharePostSignalE(error_type, error_str);
        Q_EMIT v05PatientsProfileOnSharePostSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT v05PatientsProfileOnSharePostSignalError(error_type, error_str);
        Q_EMIT v05PatientsProfileOnSharePostSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIProfileApi::v05PatientsProfileSharePost(const QString &authorization, const QString &x_hip_id, const OAIShareProfileRequest &oai_share_profile_request) {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIProfileApi::v05PatientsProfileSharePostCallback);
    connect(this, &OAIProfileApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIProfileApi::v05PatientsProfileSharePostCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
