...
void OAISubscriptionsApi::v05SubscriptionRequestsCmInitPost(const QString &authorization, const QString &x_cm_id, const OAISubscriptionRequest &oai_subscription_request) {
...
void OAISubscriptionsApi::v05SubscriptionRequestsCmOnInitPost(const QString &authorization, const QString &x_hiu_id, const OAIHIUSubscriptionRequestReceipt &oaihiu_subscription_request_receipt) {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAISubscriptionsApi::v05SubscriptionRequestsCmOnInitPostCallback);
    connect(this, &OAISubscriptionsApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAISubscriptionsApi::v05SubscriptionRequestsCmOnInitPostCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
...
void OAISubscriptionsApi::v05SubscriptionRequestsHiuOnNotifyPost(const QString &authorization, const QString &x_cm_id, const OAIHIUSubscriptionRequestNotificationAcknowledgement &oaihiu_subscription_request_notification_acknowledgement) {
...
void OAISubscriptionsApi::v05SubscriptionsHiuOnNotifyPost(const QString &authorization, const QString &x_cm_id, const OAIHIUSubscriptionNotificationAcknowledgment &oaihiu_subscription_notification_acknowledgment) {
