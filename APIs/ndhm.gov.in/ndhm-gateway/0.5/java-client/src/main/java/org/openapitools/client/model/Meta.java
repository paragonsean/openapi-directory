...
public class Meta {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if ((jsonObj.get("communicationMedium") != null && !jsonObj.get("communicationMedium").isJsonNull()) && !jsonObj.get("communicationMedium").isJsonPrimitive()) {
      ...
      // validate the optional field `communicationMedium`
      if (jsonObj.get("communicationMedium") != null && !jsonObj.get("communicationMedium").isJsonNull()) {
