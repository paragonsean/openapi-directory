...
**hidden** | **Boolean** | Visibility of the page | [optional] [default to true]
...
**type** | **String** | Type of the page. The available types all show up under the /docs/ URL path of your docs project (also known as the \&quot;guides\&quot; section). Can be \&quot;basic\&quot; (most common), \&quot;error\&quot; (page desribing an API error), or \&quot;link\&quot; (page that redirects to an external link) | [optional] 
