...
async def create_campaign_entity(request: web.Request, x_api2_crm_user_key, x_api2_crm_application_key, body, x_api2_crm_native_enable=None, x_api2_crm_describe_lifetime=None) -> web.Response:
    """POST for campaign
    ...
    :param body: Add campaign into the system
    ...
    """
    body = CampaignEntity.from_dict(body)
    return web.Response(status=200)


async def create_campaign_entity_bulk(request: web.Request, x_api2_crm_user_key, x_api2_crm_application_key, body, x_api2_crm_native_enable=None, x_api2_crm_describe_lifetime=None) -> web.Response:
...
async def delete_campaign_collection_bulk(request: web.Request, x_api2_crm_user_key, x_api2_crm_application_key, body) -> web.Response:
...
async def delete_campaign_entity(request: web.Request, x_api2_crm_user_key, x_api2_crm_application_key, campaign_id) -> web.Response:
    """DELETE for campaign
...
async def update_campaign_entity(request: web.Request, x_api2_crm_user_key, x_api2_crm_application_key, campaign_id, body, x_api2_crm_native_enable=None, x_api2_crm_describe_lifetime=None) -> web.Response:
    """PUT for campaign
    ...
    :param campaign_id: Campaign Identifier
    :type campaign_id: str
    :param body: Update campaign information
    :type body: dict | bytes
    :param x_api2_crm_native_enable: Return native response
    :type x_api2_crm_native_enable: str
    :param x_api2_crm_describe_lifetime: Describe lifetime
...
async def update_campaign_entity_bulk(request: web.Request, x_api2_crm_user_key, x_api2_crm_application_key, body, x_api2_crm_native_enable=None, x_api2_crm_describe_lifetime=None) -> web.Response:
