...
async def create_ticket_entity(request: web.Request, x_api2_crm_user_key, x_api2_crm_application_key, body, x_api2_crm_native_enable=None, x_api2_crm_describe_lifetime=None) -> web.Response:
    """POST for ticket
    ...
    :param body: Add ticket into the system
    ...
    """
    body = TicketEntity.from_dict(body)
    return web.Response(status=200)


async def create_ticket_entity_bulk(request: web.Request, x_api2_crm_user_key, x_api2_crm_application_key, body, x_api2_crm_native_enable=None, x_api2_crm_describe_lifetime=None) -> web.Response:
...
async def delete_ticket_collection_bulk(request: web.Request, x_api2_crm_user_key, x_api2_crm_application_key, body) -> web.Response:
...
async def delete_ticket_entity(request: web.Request, x_api2_crm_user_key, x_api2_crm_application_key, ticket_id) -> web.Response:
    """DELETE for ticket
...
async def update_ticket_entity(request: web.Request, x_api2_crm_user_key, x_api2_crm_application_key, ticket_id, body, x_api2_crm_native_enable=None, x_api2_crm_describe_lifetime=None) -> web.Response:
    """PUT for ticket
    ...
    :param ticket_id: Ticket Identifier
    :type ticket_id: str
    :param body: Update ticket information
    :type body: dict | bytes
    :param x_api2_crm_native_enable: Return native response
    :type x_api2_crm_native_enable: str
    :param x_api2_crm_describe_lifetime: Describe lifetime
...
async def update_ticket_entity_bulk(request: web.Request, x_api2_crm_user_key, x_api2_crm_application_key, body, x_api2_crm_native_enable=None, x_api2_crm_describe_lifetime=None) -> web.Response:
    """PUT bulk  for ticket
