...
async def create_opportunity_entity(request: web.Request, x_api2_crm_user_key, x_api2_crm_application_key, body, x_api2_crm_native_enable=None, x_api2_crm_describe_lifetime=None) -> web.Response:
    ...
    :param body: Add opportunity into the system
    ...
    """
    body = OpportunityEntity.from_dict(body)
    return web.Response(status=200)


async def create_opportunity_entity_bulk(request: web.Request, x_api2_crm_user_key, x_api2_crm_application_key, body, x_api2_crm_native_enable=None, x_api2_crm_describe_lifetime=None) -> web.Response:
...
async def delete_opportunity_collection_bulk(request: web.Request, x_api2_crm_user_key, x_api2_crm_application_key, body) -> web.Response:
...
async def delete_opportunity_entity(request: web.Request, x_api2_crm_user_key, x_api2_crm_application_key, opportunity_id) -> web.Response:
    ...
    :param x_api2_crm_application_key: Application Key
    :type x_api2_crm_application_key: str
    :param opportunity_id: Opportunity Identifier
...
async def update_opportunity_entity(request: web.Request, x_api2_crm_user_key, x_api2_crm_application_key, opportunity_id, body, x_api2_crm_native_enable=None, x_api2_crm_describe_lifetime=None) -> web.Response:
    """PUT for opportunity
    ...
    :param opportunity_id: Opportunity Identifier
    :type opportunity_id: str
    :param body: Update opportunity information
    :type body: dict | bytes
    :param x_api2_crm_native_enable: Return native response
    :type x_api2_crm_native_enable: str
    :param x_api2_crm_describe_lifetime: Describe lifetime
...
async def update_opportunity_entity_bulk(request: web.Request, x_api2_crm_user_key, x_api2_crm_application_key, body, x_api2_crm_native_enable=None, x_api2_crm_describe_lifetime=None) -> web.Response:
