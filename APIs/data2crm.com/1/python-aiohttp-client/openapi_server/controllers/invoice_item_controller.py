...
async def create_invoice_item_entity(request: web.Request, x_api2_crm_user_key, x_api2_crm_application_key, body, x_api2_crm_native_enable=None, x_api2_crm_describe_lifetime=None) -> web.Response:
    ...
    :param body: Add invoiceItem into the system
    ...
    """
    body = InvoiceItemEntity.from_dict(body)
    return web.Response(status=200)


async def create_invoice_item_entity_bulk(request: web.Request, x_api2_crm_user_key, x_api2_crm_application_key, body, x_api2_crm_native_enable=None, x_api2_crm_describe_lifetime=None) -> web.Response:
...
async def delete_invoice_item_collection_bulk(request: web.Request, x_api2_crm_user_key, x_api2_crm_application_key, body) -> web.Response:
...
async def delete_invoice_item_entity(request: web.Request, x_api2_crm_user_key, x_api2_crm_application_key, invoice_item_id) -> web.Response:
    ...
    :param x_api2_crm_application_key: Application Key
    :type x_api2_crm_application_key: str
    :param invoice_item_id: Invoice Item Identifier
...
async def update_invoice_item_entity(request: web.Request, x_api2_crm_user_key, x_api2_crm_application_key, invoice_item_id, body, x_api2_crm_native_enable=None, x_api2_crm_describe_lifetime=None) -> web.Response:
    """PUT for invoiceItem
    ...
    :param invoice_item_id: Invoice Item Identifier
    :type invoice_item_id: str
    :param body: Update invoiceItem information
    :type body: dict | bytes
    :param x_api2_crm_native_enable: Return native response
    :type x_api2_crm_native_enable: str
    :param x_api2_crm_describe_lifetime: Describe lifetime
...
async def update_invoice_item_entity_bulk(request: web.Request, x_api2_crm_user_key, x_api2_crm_application_key, body, x_api2_crm_native_enable=None, x_api2_crm_describe_lifetime=None) -> web.Response:
