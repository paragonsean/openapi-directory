...
async def create_call_entity(request: web.Request, x_api2_crm_user_key, x_api2_crm_application_key, body, x_api2_crm_native_enable=None, x_api2_crm_describe_lifetime=None) -> web.Response:
    """POST for call
    ...
    :param body: Add call into the system
    ...
    """
    body = CallEntity.from_dict(body)
    return web.Response(status=200)


async def create_call_entity_bulk(request: web.Request, x_api2_crm_user_key, x_api2_crm_application_key, body, x_api2_crm_native_enable=None, x_api2_crm_describe_lifetime=None) -> web.Response:
    """POST bulk  for call
...
async def delete_call_collection_bulk(request: web.Request, x_api2_crm_user_key, x_api2_crm_application_key, body) -> web.Response:
...
async def delete_call_entity(request: web.Request, x_api2_crm_user_key, x_api2_crm_application_key, call_id) -> web.Response:
    """DELETE for call
...
async def update_call_entity(request: web.Request, x_api2_crm_user_key, x_api2_crm_application_key, call_id, body, x_api2_crm_native_enable=None, x_api2_crm_describe_lifetime=None) -> web.Response:
    """PUT for call
    ...
    :param call_id: Call Identifier
    :type call_id: str
    :param body: Update call information
    :type body: dict | bytes
    :param x_api2_crm_native_enable: Return native response
    :type x_api2_crm_native_enable: str
    :param x_api2_crm_describe_lifetime: Describe lifetime
...
async def update_call_entity_bulk(request: web.Request, x_api2_crm_user_key, x_api2_crm_application_key, body, x_api2_crm_native_enable=None, x_api2_crm_describe_lifetime=None) -> web.Response:
    """PUT bulk  for call
