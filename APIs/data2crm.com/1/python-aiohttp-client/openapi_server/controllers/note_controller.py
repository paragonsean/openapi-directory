...
async def create_note_entity(request: web.Request, x_api2_crm_user_key, x_api2_crm_application_key, body, x_api2_crm_native_enable=None, x_api2_crm_describe_lifetime=None) -> web.Response:
    """POST for note
    ...
    :param body: Add note into the system
    ...
    """
    body = NoteEntity.from_dict(body)
    return web.Response(status=200)


async def create_note_entity_bulk(request: web.Request, x_api2_crm_user_key, x_api2_crm_application_key, body, x_api2_crm_native_enable=None, x_api2_crm_describe_lifetime=None) -> web.Response:
    """POST bulk  for note
...
async def delete_note_collection_bulk(request: web.Request, x_api2_crm_user_key, x_api2_crm_application_key, body) -> web.Response:
...
async def delete_note_entity(request: web.Request, x_api2_crm_user_key, x_api2_crm_application_key, note_id) -> web.Response:
    """DELETE for note
...
async def update_note_entity(request: web.Request, x_api2_crm_user_key, x_api2_crm_application_key, note_id, body, x_api2_crm_native_enable=None, x_api2_crm_describe_lifetime=None) -> web.Response:
    """PUT for note
    ...
    :param note_id: Note Identifier
    :type note_id: str
    :param body: Update note information
    :type body: dict | bytes
    :param x_api2_crm_native_enable: Return native response
    :type x_api2_crm_native_enable: str
    :param x_api2_crm_describe_lifetime: Describe lifetime
...
async def update_note_entity_bulk(request: web.Request, x_api2_crm_user_key, x_api2_crm_application_key, body, x_api2_crm_native_enable=None, x_api2_crm_describe_lifetime=None) -> web.Response:
    """PUT bulk  for note
