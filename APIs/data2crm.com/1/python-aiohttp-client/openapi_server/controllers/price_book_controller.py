...
async def create_price_book_entity(request: web.Request, x_api2_crm_user_key, x_api2_crm_application_key, body, x_api2_crm_native_enable=None, x_api2_crm_describe_lifetime=None) -> web.Response:
    """POST for priceBook
    ...
    :param body: Add priceBook into the system
    ...
    """
    body = PriceBookEntity.from_dict(body)
    return web.Response(status=200)


async def create_price_book_entity_bulk(request: web.Request, x_api2_crm_user_key, x_api2_crm_application_key, body, x_api2_crm_native_enable=None, x_api2_crm_describe_lifetime=None) -> web.Response:
...
async def delete_price_book_collection_bulk(request: web.Request, x_api2_crm_user_key, x_api2_crm_application_key, body) -> web.Response:
...
async def delete_price_book_entity(request: web.Request, x_api2_crm_user_key, x_api2_crm_application_key, price_book_id) -> web.Response:
...
async def update_price_book_entity(request: web.Request, x_api2_crm_user_key, x_api2_crm_application_key, price_book_id, body, x_api2_crm_native_enable=None, x_api2_crm_describe_lifetime=None) -> web.Response:
    """PUT for priceBook
    ...
    :param price_book_id: PriceBook Identifier
    :type price_book_id: str
    :param body: Update priceBook information
    :type body: dict | bytes
    :param x_api2_crm_native_enable: Return native response
    :type x_api2_crm_native_enable: str
    :param x_api2_crm_describe_lifetime: Describe lifetime
...
async def update_price_book_entity_bulk(request: web.Request, x_api2_crm_user_key, x_api2_crm_application_key, body, x_api2_crm_native_enable=None, x_api2_crm_describe_lifetime=None) -> web.Response:
