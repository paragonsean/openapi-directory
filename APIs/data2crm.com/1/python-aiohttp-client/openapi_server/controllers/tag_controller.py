...
async def create_tag_entity(request: web.Request, x_api2_crm_user_key, x_api2_crm_application_key, body, x_api2_crm_native_enable=None, x_api2_crm_describe_lifetime=None) -> web.Response:
    """POST for tag
    ...
    :param body: Add tag into the system
    ...
    """
    body = TagEntity.from_dict(body)
    return web.Response(status=200)


async def create_tag_entity_bulk(request: web.Request, x_api2_crm_user_key, x_api2_crm_application_key, body, x_api2_crm_native_enable=None, x_api2_crm_describe_lifetime=None) -> web.Response:
    """POST bulk  for tag
...
async def delete_tag_collection_bulk(request: web.Request, x_api2_crm_user_key, x_api2_crm_application_key, body) -> web.Response:
    """DELETE bulk  for tag
...
async def delete_tag_entity(request: web.Request, x_api2_crm_user_key, x_api2_crm_application_key, tag_id) -> web.Response:
    """DELETE for tag
...
async def update_tag_entity(request: web.Request, x_api2_crm_user_key, x_api2_crm_application_key, tag_id, body, x_api2_crm_native_enable=None, x_api2_crm_describe_lifetime=None) -> web.Response:
    """PUT for tag
    ...
    :param tag_id: Tag Identifier
    :type tag_id: str
    :param body: Update tag information
    :type body: dict | bytes
    :param x_api2_crm_native_enable: Return native response
    :type x_api2_crm_native_enable: str
    :param x_api2_crm_describe_lifetime: Describe lifetime
...
async def update_tag_entity_bulk(request: web.Request, x_api2_crm_user_key, x_api2_crm_application_key, body, x_api2_crm_native_enable=None, x_api2_crm_describe_lifetime=None) -> web.Response:
    """PUT bulk  for tag
