...
async def create_quote_item_entity(request: web.Request, x_api2_crm_user_key, x_api2_crm_application_key, body, x_api2_crm_native_enable=None, x_api2_crm_describe_lifetime=None) -> web.Response:
    """POST for quoteItem
    ...
    :param body: Add quoteItem into the system
    ...
    """
    body = QuoteItemEntity.from_dict(body)
    return web.Response(status=200)


async def create_quote_item_entity_bulk(request: web.Request, x_api2_crm_user_key, x_api2_crm_application_key, body, x_api2_crm_native_enable=None, x_api2_crm_describe_lifetime=None) -> web.Response:
...
async def delete_quote_item_collection_bulk(request: web.Request, x_api2_crm_user_key, x_api2_crm_application_key, body) -> web.Response:
...
async def delete_quote_item_entity(request: web.Request, x_api2_crm_user_key, x_api2_crm_application_key, quote_item_id) -> web.Response:
...
async def update_quote_item_entity(request: web.Request, x_api2_crm_user_key, x_api2_crm_application_key, quote_item_id, body, x_api2_crm_native_enable=None, x_api2_crm_describe_lifetime=None) -> web.Response:
    """PUT for quoteItem
    ...
    :param quote_item_id: Quote Item Identifier
    :type quote_item_id: str
    :param body: Update quoteItem information
    :type body: dict | bytes
    :param x_api2_crm_native_enable: Return native response
    :type x_api2_crm_native_enable: str
    :param x_api2_crm_describe_lifetime: Describe lifetime
...
async def update_quote_item_entity_bulk(request: web.Request, x_api2_crm_user_key, x_api2_crm_application_key, body, x_api2_crm_native_enable=None, x_api2_crm_describe_lifetime=None) -> web.Response:
