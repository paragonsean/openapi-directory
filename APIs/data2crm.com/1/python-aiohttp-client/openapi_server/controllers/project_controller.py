...
async def create_project_entity(request: web.Request, x_api2_crm_user_key, x_api2_crm_application_key, body, x_api2_crm_native_enable=None, x_api2_crm_describe_lifetime=None) -> web.Response:
    """POST for project
    ...
    :param body: Add project into the system
    ...
    """
    body = ProjectEntity.from_dict(body)
    return web.Response(status=200)


async def create_project_entity_bulk(request: web.Request, x_api2_crm_user_key, x_api2_crm_application_key, body, x_api2_crm_native_enable=None, x_api2_crm_describe_lifetime=None) -> web.Response:
...
async def delete_project_collection_bulk(request: web.Request, x_api2_crm_user_key, x_api2_crm_application_key, body) -> web.Response:
...
async def delete_project_entity(request: web.Request, x_api2_crm_user_key, x_api2_crm_application_key, project_id) -> web.Response:
    """DELETE for project
...
async def update_project_entity(request: web.Request, x_api2_crm_user_key, x_api2_crm_application_key, project_id, body, x_api2_crm_native_enable=None, x_api2_crm_describe_lifetime=None) -> web.Response:
    """PUT for project
    ...
    :param project_id: Project Identifier
    :type project_id: str
    :param body: Update project information
    :type body: dict | bytes
    :param x_api2_crm_native_enable: Return native response
    :type x_api2_crm_native_enable: str
    :param x_api2_crm_describe_lifetime: Describe lifetime
...
async def update_project_entity_bulk(request: web.Request, x_api2_crm_user_key, x_api2_crm_application_key, body, x_api2_crm_native_enable=None, x_api2_crm_describe_lifetime=None) -> web.Response:
