...
async def get_field_collection(request: web.Request, x_api2_crm_user_key, x_api2_crm_application_key, x_api2_crm_describe_lifetime=None, page_size=None, page=None, filter=None, fields=None) -> web.Response:
    """GET for field
...
async def get_field_count_collection(request: web.Request, x_api2_crm_user_key, x_api2_crm_application_key) -> web.Response:
    """COUNT for field
...
async def get_field_entity(request: web.Request, x_api2_crm_user_key, x_api2_crm_application_key, field_id, x_api2_crm_describe_lifetime=None, fields=None) -> web.Response:
    """GET for field
