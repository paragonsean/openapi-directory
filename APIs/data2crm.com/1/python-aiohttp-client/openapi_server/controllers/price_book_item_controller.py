...
async def create_price_book_item_entity(request: web.Request, x_api2_crm_user_key, x_api2_crm_application_key, body, x_api2_crm_native_enable=None, x_api2_crm_describe_lifetime=None) -> web.Response:
    ...
    :param body: Add priceBookItem into the system
    ...
    """
    body = PriceBookItemEntity.from_dict(body)
    return web.Response(status=200)


async def create_price_book_item_entity_bulk(request: web.Request, x_api2_crm_user_key, x_api2_crm_application_key, body, x_api2_crm_native_enable=None, x_api2_crm_describe_lifetime=None) -> web.Response:
...
async def delete_price_book_item_collection_bulk(request: web.Request, x_api2_crm_user_key, x_api2_crm_application_key, body) -> web.Response:
...
async def delete_price_book_item_entity(request: web.Request, x_api2_crm_user_key, x_api2_crm_application_key, price_book_item_id) -> web.Response:
    ...
    :param x_api2_crm_application_key: Application Key
    :type x_api2_crm_application_key: str
    :param price_book_item_id: PriceBookItem Identifier
...
async def update_price_book_item_entity(request: web.Request, x_api2_crm_user_key, x_api2_crm_application_key, price_book_item_id, body, x_api2_crm_native_enable=None, x_api2_crm_describe_lifetime=None) -> web.Response:
    ...
    :param price_book_item_id: PriceBookItem Identifier
    :type price_book_item_id: str
    :param body: Update priceBookItem information
    :type body: dict | bytes
    :param x_api2_crm_native_enable: Return native response
    :type x_api2_crm_native_enable: str
    :param x_api2_crm_describe_lifetime: Describe lifetime
...
async def update_price_book_item_entity_bulk(request: web.Request, x_api2_crm_user_key, x_api2_crm_application_key, body, x_api2_crm_native_enable=None, x_api2_crm_describe_lifetime=None) -> web.Response:
