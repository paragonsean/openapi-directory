...
async def create_lead_entity(request: web.Request, x_api2_crm_user_key, x_api2_crm_application_key, body, x_api2_crm_native_enable=None, x_api2_crm_describe_lifetime=None) -> web.Response:
    """POST for lead
    ...
    :param body: Add lead into the system
    ...
    """
    body = LeadEntity.from_dict(body)
    return web.Response(status=200)


async def create_lead_entity_bulk(request: web.Request, x_api2_crm_user_key, x_api2_crm_application_key, body, x_api2_crm_native_enable=None, x_api2_crm_describe_lifetime=None) -> web.Response:
    """POST bulk  for lead
...
async def delete_lead_collection_bulk(request: web.Request, x_api2_crm_user_key, x_api2_crm_application_key, body) -> web.Response:
...
async def delete_lead_entity(request: web.Request, x_api2_crm_user_key, x_api2_crm_application_key, lead_id) -> web.Response:
    """DELETE for lead
...
async def update_lead_entity(request: web.Request, x_api2_crm_user_key, x_api2_crm_application_key, lead_id, body, x_api2_crm_native_enable=None, x_api2_crm_describe_lifetime=None) -> web.Response:
    """PUT for lead
    ...
    :param lead_id: Lead Identifier
    :type lead_id: str
    :param body: Update lead information
    :type body: dict | bytes
    :param x_api2_crm_native_enable: Return native response
    :type x_api2_crm_native_enable: str
    :param x_api2_crm_describe_lifetime: Describe lifetime
...
async def update_lead_entity_bulk(request: web.Request, x_api2_crm_user_key, x_api2_crm_application_key, body, x_api2_crm_native_enable=None, x_api2_crm_describe_lifetime=None) -> web.Response:
    """PUT bulk  for lead
