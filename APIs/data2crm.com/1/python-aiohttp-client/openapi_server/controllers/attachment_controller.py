...
async def create_attachment_entity(request: web.Request, x_api2_crm_user_key, x_api2_crm_application_key, body, x_api2_crm_native_enable=None, x_api2_crm_describe_lifetime=None) -> web.Response:
    """POST for attachment
    ...
    :param body: Add attachment into the system
    ...
    """
    body = AttachmentEntityWrite.from_dict(body)
    return web.Response(status=200)


async def create_attachment_entity_bulk(request: web.Request, x_api2_crm_user_key, x_api2_crm_application_key, body, x_api2_crm_native_enable=None, x_api2_crm_describe_lifetime=None) -> web.Response:
...
async def delete_attachment_collection_bulk(request: web.Request, x_api2_crm_user_key, x_api2_crm_application_key, body) -> web.Response:
...
async def delete_attachment_entity(request: web.Request, x_api2_crm_user_key, x_api2_crm_application_key, attachment_id) -> web.Response:
...
async def update_attachment_entity(request: web.Request, x_api2_crm_user_key, x_api2_crm_application_key, attachment_id, body, x_api2_crm_native_enable=None, x_api2_crm_describe_lifetime=None) -> web.Response:
    """PUT for attachment
    ...
    :param attachment_id: Attachment Identifier
    :type attachment_id: str
    :param body: Update attachment information
    :type body: dict | bytes
    :param x_api2_crm_native_enable: Return native response
    :type x_api2_crm_native_enable: str
    :param x_api2_crm_describe_lifetime: Describe lifetime
...
async def update_attachment_entity_bulk(request: web.Request, x_api2_crm_user_key, x_api2_crm_application_key, body, x_api2_crm_native_enable=None, x_api2_crm_describe_lifetime=None) -> web.Response:
