...
async def create_opportunity_product_entity(request: web.Request, x_api2_crm_user_key, x_api2_crm_application_key, body, x_api2_crm_native_enable=None, x_api2_crm_describe_lifetime=None) -> web.Response:
    ...
    :param body: Add opportunityProduct into the system
    ...
    """
    body = OpportunityProductEntity.from_dict(body)
    return web.Response(status=200)


async def create_opportunity_product_entity_bulk(request: web.Request, x_api2_crm_user_key, x_api2_crm_application_key, body, x_api2_crm_native_enable=None, x_api2_crm_describe_lifetime=None) -> web.Response:
...
async def delete_opportunity_product_collection_bulk(request: web.Request, x_api2_crm_user_key, x_api2_crm_application_key, body) -> web.Response:
...
async def delete_opportunity_product_entity(request: web.Request, x_api2_crm_user_key, x_api2_crm_application_key, opportunity_product_id) -> web.Response:
    ...
    :param x_api2_crm_application_key: Application Key
    :type x_api2_crm_application_key: str
    :param opportunity_product_id: Opportunity Product Identifier
...
async def update_opportunity_product_entity(request: web.Request, x_api2_crm_user_key, x_api2_crm_application_key, opportunity_product_id, body, x_api2_crm_native_enable=None, x_api2_crm_describe_lifetime=None) -> web.Response:
    ...
    :param opportunity_product_id: Opportunity Product Identifier
    :type opportunity_product_id: str
    :param body: Update opportunityProduct information
    :type body: dict | bytes
    :param x_api2_crm_native_enable: Return native response
    :type x_api2_crm_native_enable: str
    :param x_api2_crm_describe_lifetime: Describe lifetime
...
async def update_opportunity_product_entity_bulk(request: web.Request, x_api2_crm_user_key, x_api2_crm_application_key, body, x_api2_crm_native_enable=None, x_api2_crm_describe_lifetime=None) -> web.Response:
