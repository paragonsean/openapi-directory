...
async def create_quote_entity(request: web.Request, x_api2_crm_user_key, x_api2_crm_application_key, body, x_api2_crm_native_enable=None, x_api2_crm_describe_lifetime=None) -> web.Response:
    """POST for quote
    ...
    :param body: Add quote into the system
    ...
    """
    body = QuoteEntity.from_dict(body)
    return web.Response(status=200)


async def create_quote_entity_bulk(request: web.Request, x_api2_crm_user_key, x_api2_crm_application_key, body, x_api2_crm_native_enable=None, x_api2_crm_describe_lifetime=None) -> web.Response:
    """POST bulk  for quote
...
async def delete_quote_collection_bulk(request: web.Request, x_api2_crm_user_key, x_api2_crm_application_key, body) -> web.Response:
...
async def delete_quote_entity(request: web.Request, x_api2_crm_user_key, x_api2_crm_application_key, quote_id) -> web.Response:
    """DELETE for quote
...
async def update_quote_entity(request: web.Request, x_api2_crm_user_key, x_api2_crm_application_key, quote_id, body, x_api2_crm_native_enable=None, x_api2_crm_describe_lifetime=None) -> web.Response:
    """PUT for quote
    ...
    :param quote_id: Quote Identifier
    :type quote_id: str
    :param body: Update quote information
    :type body: dict | bytes
    :param x_api2_crm_native_enable: Return native response
    :type x_api2_crm_native_enable: str
    :param x_api2_crm_describe_lifetime: Describe lifetime
...
async def update_quote_entity_bulk(request: web.Request, x_api2_crm_user_key, x_api2_crm_application_key, body, x_api2_crm_native_enable=None, x_api2_crm_describe_lifetime=None) -> web.Response:
    """PUT bulk  for quote
