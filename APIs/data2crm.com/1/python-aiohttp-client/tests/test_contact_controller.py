...
async def test_create_contact_entity(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1/application/entity/contact',
        headers=headers,
        json=body,
        )
...
async def test_create_contact_entity_bulk(client):
    """Test case for create_contact_entity_bulk
    ...
    response = await client.request(
        method='POST',
        path='/v1/application/entity/contact/bulk',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_delete_contact_collection_bulk(client):
    """Test case for delete_contact_collection_bulk
...
async def test_delete_contact_entity(client):
    """Test case for delete_contact_entity
    ...
    response = await client.request(
        method='DELETE',
        path='/v1/application/entity/contact/{contact_id}'.format(contact_id='contact_id_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_get_contact_aggregate(client):
    """Test case for get_contact_aggregate
    ...
    response = await client.request(
        method='GET',
        path='/v1/application/entity/contact/aggregate',
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_get_contact_collection(client):
    """Test case for get_contact_collection
    ...
    response = await client.request(
        method='GET',
        path='/v1/application/entity/contact/list',
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_get_contact_count_collection(client):
    """Test case for get_contact_count_collection
    ...
    response = await client.request(
        method='GET',
        path='/v1/application/entity/contact/count',
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_get_contact_describe(client):
    """Test case for get_contact_describe
    ...
    response = await client.request(
        method='GET',
        path='/v1/application/entity/contact/describe',
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_get_contact_entity(client):
    """Test case for get_contact_entity
...
async def test_update_contact_entity(client):
    """Test case for update_contact_entity
...
async def test_update_contact_entity_bulk(client):
    """Test case for update_contact_entity_bulk
