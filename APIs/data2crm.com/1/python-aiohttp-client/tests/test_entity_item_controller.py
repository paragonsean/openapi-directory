...
async def test_create_entity_item_entity_bulk(client):
    """Test case for create_entity_item_entity_bulk
    ...
    response = await client.request(
        method='POST',
        path='/v1/application/entity/{entity_id}/bulk'.format(entity_id='entity_id_example'),
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_delete_entity_item_collection_bulk(client):
    """Test case for delete_entity_item_collection_bulk
...
async def test_delete_entity_item_entity(client):
    """Test case for delete_entity_item_entity
    ...
    response = await client.request(
        method='DELETE',
        path='/v1/application/entity/{entity_id}/{entity_item_id}'.format(entity_id='entity_id_example', entity_item_id='entity_item_id_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_get_entity_item_aggregate(client):
    """Test case for get_entity_item_aggregate
    ...
    response = await client.request(
        method='GET',
        path='/v1/application/entity/{entity_id}/aggregate'.format(entity_id='entity_id_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_get_entity_item_collection(client):
    """Test case for get_entity_item_collection
    ...
    response = await client.request(
        method='GET',
        path='/v1/application/entity/{entity_id}/list'.format(entity_id='entity_id_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_get_entity_item_count_collection(client):
    """Test case for get_entity_item_count_collection
    ...
    response = await client.request(
        method='GET',
        path='/v1/application/entity/{entity_id}/count'.format(entity_id='entity_id_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_get_entity_item_describe(client):
    """Test case for get_entity_item_describe
    ...
    response = await client.request(
        method='GET',
        path='/v1/application/entity/{entity_id}/describe'.format(entity_id='entity_id_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_get_entity_item_entity(client):
    """Test case for get_entity_item_entity
...
async def test_update_entity_item_entity(client):
    """Test case for update_entity_item_entity
...
async def test_update_entity_item_entity_bulk(client):
    """Test case for update_entity_item_entity_bulk
