...
async def test_create_opportunity_entity(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1/application/entity/opportunity',
        headers=headers,
        json=body,
        )
...
async def test_create_opportunity_entity_bulk(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1/application/entity/opportunity/bulk',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_delete_opportunity_collection_bulk(client):
...
async def test_delete_opportunity_entity(client):
    ...
    response = await client.request(
        method='DELETE',
        path='/v1/application/entity/opportunity/{opportunity_id}'.format(opportunity_id='opportunity_id_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_get_opportunity_aggregate(client):
    ...
    response = await client.request(
        method='GET',
        path='/v1/application/entity/opportunity/aggregate',
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_get_opportunity_collection(client):
    ...
    response = await client.request(
        method='GET',
        path='/v1/application/entity/opportunity/list',
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_get_opportunity_count_collection(client):
    ...
    response = await client.request(
        method='GET',
        path='/v1/application/entity/opportunity/count',
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_get_opportunity_describe(client):
    ...
    response = await client.request(
        method='GET',
        path='/v1/application/entity/opportunity/describe',
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_get_opportunity_entity(client):
...
async def test_update_opportunity_entity(client):
...
async def test_update_opportunity_entity_bulk(client):
