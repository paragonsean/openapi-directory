...
async def test_create_price_book_item_entity(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1/application/entity/priceBookItem',
        headers=headers,
        json=body,
        )
...
async def test_create_price_book_item_entity_bulk(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1/application/entity/priceBookItem/bulk',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_delete_price_book_item_collection_bulk(client):
...
async def test_delete_price_book_item_entity(client):
    ...
    response = await client.request(
        method='DELETE',
        path='/v1/application/entity/priceBookItem/{price_book_item_id}'.format(price_book_item_id='price_book_item_id_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_get_price_book_item_aggregate(client):
    ...
    response = await client.request(
        method='GET',
        path='/v1/application/entity/priceBookItem/aggregate',
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_get_price_book_item_collection(client):
    ...
    response = await client.request(
        method='GET',
        path='/v1/application/entity/priceBookItem/list',
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_get_price_book_item_count_collection(client):
    ...
    response = await client.request(
        method='GET',
        path='/v1/application/entity/priceBookItem/count',
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_get_price_book_item_describe(client):
    ...
    response = await client.request(
        method='GET',
        path='/v1/application/entity/priceBookItem/describe',
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_get_price_book_item_entity(client):
...
async def test_update_price_book_item_entity(client):
...
async def test_update_price_book_item_entity_bulk(client):
