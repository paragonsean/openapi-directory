...
async def test_create_task_entity(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1/application/entity/task',
        headers=headers,
        json=body,
        )
...
async def test_create_task_entity_bulk(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1/application/entity/task/bulk',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_delete_task_collection_bulk(client):
...
async def test_delete_task_entity(client):
    ...
    response = await client.request(
        method='DELETE',
        path='/v1/application/entity/task/{task_id}'.format(task_id='task_id_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_get_task_aggregate(client):
    ...
    response = await client.request(
        method='GET',
        path='/v1/application/entity/task/aggregate',
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_get_task_collection(client):
    ...
    response = await client.request(
        method='GET',
        path='/v1/application/entity/task/list',
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_get_task_count_collection(client):
    ...
    response = await client.request(
        method='GET',
        path='/v1/application/entity/task/count',
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_get_task_describe(client):
    ...
    response = await client.request(
        method='GET',
        path='/v1/application/entity/task/describe',
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_get_task_entity(client):
...
async def test_update_task_entity(client):
...
async def test_update_task_entity_bulk(client):
