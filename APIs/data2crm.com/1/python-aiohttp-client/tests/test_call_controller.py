...
async def test_create_call_entity(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1/application/entity/call',
        headers=headers,
        json=body,
        )
...
async def test_create_call_entity_bulk(client):
    """Test case for create_call_entity_bulk
    ...
    response = await client.request(
        method='POST',
        path='/v1/application/entity/call/bulk',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_delete_call_collection_bulk(client):
    """Test case for delete_call_collection_bulk
...
async def test_delete_call_entity(client):
    """Test case for delete_call_entity
    ...
    response = await client.request(
        method='DELETE',
        path='/v1/application/entity/call/{call_id}'.format(call_id='call_id_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_get_call_aggregate(client):
    """Test case for get_call_aggregate
    ...
    response = await client.request(
        method='GET',
        path='/v1/application/entity/call/aggregate',
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_get_call_collection(client):
    """Test case for get_call_collection
    ...
    response = await client.request(
        method='GET',
        path='/v1/application/entity/call/list',
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_get_call_count_collection(client):
    """Test case for get_call_count_collection
    ...
    response = await client.request(
        method='GET',
        path='/v1/application/entity/call/count',
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_get_call_describe(client):
    """Test case for get_call_describe
    ...
    response = await client.request(
        method='GET',
        path='/v1/application/entity/call/describe',
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_get_call_entity(client):
    """Test case for get_call_entity
...
async def test_update_call_entity(client):
    """Test case for update_call_entity
...
async def test_update_call_entity_bulk(client):
    """Test case for update_call_entity_bulk
