...
async def test_create_note_entity(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1/application/entity/note',
        headers=headers,
        json=body,
        )
...
async def test_create_note_entity_bulk(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1/application/entity/note/bulk',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_delete_note_collection_bulk(client):
...
async def test_delete_note_entity(client):
    ...
    response = await client.request(
        method='DELETE',
        path='/v1/application/entity/note/{note_id}'.format(note_id='note_id_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_get_note_aggregate(client):
    ...
    response = await client.request(
        method='GET',
        path='/v1/application/entity/note/aggregate',
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_get_note_collection(client):
    ...
    response = await client.request(
        method='GET',
        path='/v1/application/entity/note/list',
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_get_note_count_collection(client):
    ...
    response = await client.request(
        method='GET',
        path='/v1/application/entity/note/count',
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_get_note_describe(client):
    ...
    response = await client.request(
        method='GET',
        path='/v1/application/entity/note/describe',
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_get_note_entity(client):
...
async def test_update_note_entity(client):
...
async def test_update_note_entity_bulk(client):
