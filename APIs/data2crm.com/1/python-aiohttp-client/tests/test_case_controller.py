...
async def test_create_case_entity(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1/application/entity/case',
        headers=headers,
        json=body,
        )
...
async def test_create_case_entity_bulk(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1/application/entity/case/bulk',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_delete_case_collection_bulk(client):
...
async def test_delete_case_entity(client):
    ...
    response = await client.request(
        method='DELETE',
        path='/v1/application/entity/case/{case_id}'.format(case_id='case_id_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_get_case_aggregate(client):
    ...
    response = await client.request(
        method='GET',
        path='/v1/application/entity/case/aggregate',
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_get_case_collection(client):
    ...
    response = await client.request(
        method='GET',
        path='/v1/application/entity/case/list',
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_get_case_count_collection(client):
    ...
    response = await client.request(
        method='GET',
        path='/v1/application/entity/case/count',
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_get_case_describe(client):
    ...
    response = await client.request(
        method='GET',
        path='/v1/application/entity/case/describe',
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_get_case_entity(client):
...
async def test_update_case_entity(client):
...
async def test_update_case_entity_bulk(client):
