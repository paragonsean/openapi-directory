...
async def test_create_opportunity_product_entity(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1/application/entity/opportunityProduct',
        headers=headers,
        json=body,
        )
...
async def test_create_opportunity_product_entity_bulk(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1/application/entity/opportunityProduct/bulk',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_delete_opportunity_product_collection_bulk(client):
...
async def test_delete_opportunity_product_entity(client):
    ...
    response = await client.request(
        method='DELETE',
        path='/v1/application/entity/opportunityProduct/{opportunity_product_id}'.format(opportunity_product_id='opportunity_product_id_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_get_opportunity_product_aggregate(client):
    ...
    response = await client.request(
        method='GET',
        path='/v1/application/entity/opportunityProduct/aggregate',
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_get_opportunity_product_collection(client):
    ...
    response = await client.request(
        method='GET',
        path='/v1/application/entity/opportunityProduct/list',
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_get_opportunity_product_count_collection(client):
    ...
    response = await client.request(
        method='GET',
        path='/v1/application/entity/opportunityProduct/count',
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_get_opportunity_product_describe(client):
    ...
    response = await client.request(
        method='GET',
        path='/v1/application/entity/opportunityProduct/describe',
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_get_opportunity_product_entity(client):
...
async def test_update_opportunity_product_entity(client):
...
async def test_update_opportunity_product_entity_bulk(client):
