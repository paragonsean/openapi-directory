...
import RequestsLimit from './RequestsLimit';
...
class ApplicationEntity {
    ...
    constructor() { 
        ...
        ApplicationEntity.initialize(this);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('is_authorized')) {
                obj['is_authorized'] = ApiClient.convertToType(data['is_authorized'], 'Boolean');
            }
            ...
            if (data.hasOwnProperty('me')) {
                obj['me'] = UserEntity.constructFromObject(data['me']);
            }
            if (data.hasOwnProperty('plan')) {
                obj['plan'] = ApiClient.convertToType(data['plan'], 'String');
            }
            if (data.hasOwnProperty('requests_limit')) {
                obj['requests_limit'] = RequestsLimit.constructFromObject(data['requests_limit']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>ApplicationEntity</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ApplicationEntity</code>.
     */
    static validateJSON(data) {
        ...
        if (data['me']) { // data not null
          UserEntity.validateJSON(data['me']);
        }
        // ensure the json data is a string
        ...
        if (data['requests_limit']) { // data not null
          RequestsLimit.validateJSON(data['requests_limit']);
        }
        // ensure the json data is a string
 ...
 */
ApplicationEntity.prototype['authorization'] = undefined;

/**
 * @member {module:model/Company} company
 */
ApplicationEntity.prototype['company'] = undefined;

/**
 * Created At
 * @member {Date} created_at
 */
ApplicationEntity.prototype['created_at'] = undefined;

/**
 * Application description
 * @member {String} description
 */
ApplicationEntity.prototype['description'] = undefined;

/**
 * Is Authorized
 * @member {Boolean} is_authorized
 */
ApplicationEntity.prototype['is_authorized'] = undefined;

/**
 * Application key
 * @member {String} key
 */
ApplicationEntity.prototype['key'] = undefined;

/**
 * Last Used At
 * @member {Date} last_used_at
 */
ApplicationEntity.prototype['last_used_at'] = undefined;

/**
 * @member {module:model/UserEntity} me
 */
ApplicationEntity.prototype['me'] = undefined;

/**
 * Application Plan
 * @member {String} plan
 */
ApplicationEntity.prototype['plan'] = undefined;

/**
 * @member {module:model/RequestsLimit} requests_limit
 */
ApplicationEntity.prototype['requests_limit'] = undefined;

/**
 * Application platform type
 * @member {module:model/ApplicationEntity.TypeEnum} type
 */
ApplicationEntity.prototype['type'] = undefined;

/**
 * Updated At
 * @member {Date} updated_at
 */
ApplicationEntity.prototype['updated_at'] = undefined;

/**
 * Application URL
 * @member {String} url
 */
ApplicationEntity.prototype['url'] = undefined;

/**
 * User ID
 * @member {Number} user_id
 */
ApplicationEntity.prototype['user_id'] = undefined;

/**
 * User Key
 * @member {String} user_key
 */
ApplicationEntity.prototype['user_key'] = undefined;
