...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Data2CrmApi.AttachmentEntity();
  });
  ...
  describe('AttachmentEntity', function() {
    it('should create an instance of AttachmentEntity', function() {
      // uncomment below and update the code to test AttachmentEntity
      //var instance = new Data2CrmApi.AttachmentEntity();
      //expect(instance).to.be.a(Data2CrmApi.AttachmentEntity);
    });
