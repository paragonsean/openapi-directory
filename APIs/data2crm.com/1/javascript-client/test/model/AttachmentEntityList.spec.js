...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Data2CrmApi.AttachmentEntityList();
  });
  ...
  describe('AttachmentEntityList', function() {
    it('should create an instance of AttachmentEntityList', function() {
      // uncomment below and update the code to test AttachmentEntityList
      //var instance = new Data2CrmApi.AttachmentEntityList();
      //expect(instance).to.be.a(Data2CrmApi.AttachmentEntityList);
    });
