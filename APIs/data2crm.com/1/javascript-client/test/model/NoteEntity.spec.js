...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Data2CrmApi.NoteEntity();
  });
  ...
  describe('NoteEntity', function() {
    it('should create an instance of NoteEntity', function() {
      // uncomment below and update the code to test NoteEntity
      //var instance = new Data2CrmApi.NoteEntity();
      //expect(instance).to.be.a(Data2CrmApi.NoteEntity);
    });
