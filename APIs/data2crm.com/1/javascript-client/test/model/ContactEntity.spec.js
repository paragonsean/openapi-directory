...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Data2CrmApi.ContactEntity();
  });
  ...
  describe('ContactEntity', function() {
    it('should create an instance of ContactEntity', function() {
      // uncomment below and update the code to test ContactEntity
      //var instance = new Data2CrmApi.ContactEntity();
      //expect(instance).to.be.a(Data2CrmApi.ContactEntity);
    });
    ...
    it('should have the property syncToOutlook (base name: "sync_to_outlook")', function() {
      // uncomment below and update the code to test the property syncToOutlook
      //var instance = new Data2CrmApi.ContactEntity();
      //expect(instance).to.be();
    });
