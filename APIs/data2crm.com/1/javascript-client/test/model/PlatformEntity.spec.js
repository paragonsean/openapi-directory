...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Data2CrmApi.PlatformEntity();
  });
  ...
  describe('PlatformEntity', function() {
    it('should create an instance of PlatformEntity', function() {
      // uncomment below and update the code to test PlatformEntity
      //var instance = new Data2CrmApi.PlatformEntity();
      //expect(instance).to.be.a(Data2CrmApi.PlatformEntity);
    });
