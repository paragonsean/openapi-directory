...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Data2CrmApi.AccountEntity();
  });
  ...
  describe('AccountEntity', function() {
    it('should create an instance of AccountEntity', function() {
      // uncomment below and update the code to test AccountEntity
      //var instance = new Data2CrmApi.AccountEntity();
      //expect(instance).to.be.a(Data2CrmApi.AccountEntity);
    });
