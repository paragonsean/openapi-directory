...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Data2CrmApi.MeetingEntity();
  });
  ...
  describe('MeetingEntity', function() {
    it('should create an instance of MeetingEntity', function() {
      // uncomment below and update the code to test MeetingEntity
      //var instance = new Data2CrmApi.MeetingEntity();
      //expect(instance).to.be.a(Data2CrmApi.MeetingEntity);
    });
