...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Data2CrmApi.TagEntity();
  });
  ...
  describe('TagEntity', function() {
    it('should create an instance of TagEntity', function() {
      // uncomment below and update the code to test TagEntity
      //var instance = new Data2CrmApi.TagEntity();
      //expect(instance).to.be.a(Data2CrmApi.TagEntity);
    });
