...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Data2CrmApi.OpportunityProductEntity();
  });
  ...
  describe('OpportunityProductEntity', function() {
    it('should create an instance of OpportunityProductEntity', function() {
      // uncomment below and update the code to test OpportunityProductEntity
      //var instance = new Data2CrmApi.OpportunityProductEntity();
      //expect(instance).to.be.a(Data2CrmApi.OpportunityProductEntity);
    });
