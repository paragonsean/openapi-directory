...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Data2CrmApi.CaseDescribe();
  });
  ...
  describe('CaseDescribe', function() {
    it('should create an instance of CaseDescribe', function() {
      // uncomment below and update the code to test CaseDescribe
      //var instance = new Data2CrmApi.CaseDescribe();
      //expect(instance).to.be.a(Data2CrmApi.CaseDescribe);
    });
