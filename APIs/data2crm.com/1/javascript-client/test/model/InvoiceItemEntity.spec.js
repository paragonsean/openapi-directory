...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Data2CrmApi.InvoiceItemEntity();
  });
  ...
  describe('InvoiceItemEntity', function() {
    it('should create an instance of InvoiceItemEntity', function() {
      // uncomment below and update the code to test InvoiceItemEntity
      //var instance = new Data2CrmApi.InvoiceItemEntity();
      //expect(instance).to.be.a(Data2CrmApi.InvoiceItemEntity);
    });
