...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Data2CrmApi.FieldEntity();
  });
  ...
  describe('FieldEntity', function() {
    it('should create an instance of FieldEntity', function() {
      // uncomment below and update the code to test FieldEntity
      //var instance = new Data2CrmApi.FieldEntity();
      //expect(instance).to.be.a(Data2CrmApi.FieldEntity);
    });

    it('should have the property arrayItem (base name: "arrayItem")', function() {
