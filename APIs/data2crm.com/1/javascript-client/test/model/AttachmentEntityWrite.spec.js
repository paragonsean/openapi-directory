...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Data2CrmApi.AttachmentEntityWrite();
  });
  ...
  describe('AttachmentEntityWrite', function() {
    it('should create an instance of AttachmentEntityWrite', function() {
      // uncomment below and update the code to test AttachmentEntityWrite
      //var instance = new Data2CrmApi.AttachmentEntityWrite();
      //expect(instance).to.be.a(Data2CrmApi.AttachmentEntityWrite);
    });
