...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Data2CrmApi.TicketEntity();
  });
  ...
  describe('TicketEntity', function() {
    it('should create an instance of TicketEntity', function() {
      // uncomment below and update the code to test TicketEntity
      //var instance = new Data2CrmApi.TicketEntity();
      //expect(instance).to.be.a(Data2CrmApi.TicketEntity);
    });
