...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Data2CrmApi.ApplicationEntity();
  });
  ...
  describe('ApplicationEntity', function() {
    it('should create an instance of ApplicationEntity', function() {
      ...
      //var instance = new Data2CrmApi.ApplicationEntity();
      //expect(instance).to.be.a(Data2CrmApi.ApplicationEntity);
    });
    ...
    it('should have the property isAuthorized (base name: "is_authorized")', function() {
    ...
    it('should have the property requestsLimit (base name: "requests_limit")', function() {
      // uncomment below and update the code to test the property requestsLimit
      //var instance = new Data2CrmApi.ApplicationEntity();
      //expect(instance).to.be();
    });
