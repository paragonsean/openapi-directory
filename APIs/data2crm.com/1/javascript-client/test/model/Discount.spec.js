...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Data2CrmApi.Discount();
  });
  ...
  describe('Discount', function() {
    it('should create an instance of Discount', function() {
      ...
      //var instance = new Data2CrmApi.Discount();
      //expect(instance).to.be.a(Data2CrmApi.Discount);
    });

    it('should have the property percentValue (base name: "percent_value")', function() {
