...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Data2CrmApi.PriceBookEntity();
  });
  ...
  describe('PriceBookEntity', function() {
    it('should create an instance of PriceBookEntity', function() {
      // uncomment below and update the code to test PriceBookEntity
      //var instance = new Data2CrmApi.PriceBookEntity();
      //expect(instance).to.be.a(Data2CrmApi.PriceBookEntity);
    });
