...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Data2CrmApi.CallEntity();
  });
  ...
  describe('CallEntity', function() {
    it('should create an instance of CallEntity', function() {
      // uncomment below and update the code to test CallEntity
      //var instance = new Data2CrmApi.CallEntity();
      //expect(instance).to.be.a(Data2CrmApi.CallEntity);
    });
