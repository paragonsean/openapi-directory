...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Data2CrmApi.ApplicationEntityWrite();
  });
  ...
  describe('ApplicationEntityWrite', function() {
    it('should create an instance of ApplicationEntityWrite', function() {
      // uncomment below and update the code to test ApplicationEntityWrite
      //var instance = new Data2CrmApi.ApplicationEntityWrite();
      //expect(instance).to.be.a(Data2CrmApi.ApplicationEntityWrite);
    });
