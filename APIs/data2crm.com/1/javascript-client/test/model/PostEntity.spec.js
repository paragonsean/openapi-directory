...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Data2CrmApi.PostEntity();
  });
  ...
  describe('PostEntity', function() {
    it('should create an instance of PostEntity', function() {
      // uncomment below and update the code to test PostEntity
      //var instance = new Data2CrmApi.PostEntity();
      //expect(instance).to.be.a(Data2CrmApi.PostEntity);
    });
