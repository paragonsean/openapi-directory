...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Data2CrmApi.ApplicationEntityList();
  });
  ...
  describe('ApplicationEntityList', function() {
    it('should create an instance of ApplicationEntityList', function() {
      // uncomment below and update the code to test ApplicationEntityList
      //var instance = new Data2CrmApi.ApplicationEntityList();
      //expect(instance).to.be.a(Data2CrmApi.ApplicationEntityList);
    });
