...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Data2CrmApi.FieldItemEntity();
  });
  ...
  describe('FieldItemEntity', function() {
    it('should create an instance of FieldItemEntity', function() {
      // uncomment below and update the code to test FieldItemEntity
      //var instance = new Data2CrmApi.FieldItemEntity();
      //expect(instance).to.be.a(Data2CrmApi.FieldItemEntity);
    });
