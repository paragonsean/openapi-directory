...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Data2CrmApi.QuoteEntity();
  });
  ...
  describe('QuoteEntity', function() {
    it('should create an instance of QuoteEntity', function() {
      // uncomment below and update the code to test QuoteEntity
      //var instance = new Data2CrmApi.QuoteEntity();
      //expect(instance).to.be.a(Data2CrmApi.QuoteEntity);
    });
