...
> CampaignEntityRelation createCampaignEntity(xAPI2CRMUSERKEY, xAPI2CRMAPPLICATIONKEY, body, opts)
...
let apiInstance = new Data2CrmApi.CampaignApi();
...
let body = new Data2CrmApi.CampaignEntity(); // CampaignEntity | Add campaign into the system
let opts = {
...
apiInstance.createCampaignEntity(xAPI2CRMUSERKEY, xAPI2CRMAPPLICATIONKEY, body, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
> BulkEntityRelation createCampaignEntityBulk(xAPI2CRMUSERKEY, xAPI2CRMAPPLICATIONKEY, body, opts)
...
let xAPI2CRMUSERKEY = "'e2a6379ab878ae7e58119d4ec842bf9c'"; // String | User Key
let xAPI2CRMAPPLICATIONKEY = "'7ae5b17008fb414d84981191cf3b66a476ef8bef'"; // String | Application Key
let body = new Data2CrmApi.BulkEntity(); // BulkEntity | Add campaign into the system
let opts = {
  'xAPI2CRMNATIVEENABLE': "xAPI2CRMNATIVEENABLE_example", // String | Return native response
  'xAPI2CRMDESCRIBELIFETIME': "xAPI2CRMDESCRIBELIFETIME_example" // String | Describe lifetime
};
apiInstance.createCampaignEntityBulk(xAPI2CRMUSERKEY, xAPI2CRMAPPLICATIONKEY, body, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> BulkEntity deleteCampaignCollectionBulk(xAPI2CRMUSERKEY, xAPI2CRMAPPLICATIONKEY, body)
...
apiInstance.deleteCampaignCollectionBulk(xAPI2CRMUSERKEY, xAPI2CRMAPPLICATIONKEY, body, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> deleteCampaignEntity(xAPI2CRMUSERKEY, xAPI2CRMAPPLICATIONKEY, campaignId)
...
let xAPI2CRMUSERKEY = "'e2a6379ab878ae7e58119d4ec842bf9c'"; // String | User Key
let xAPI2CRMAPPLICATIONKEY = "'7ae5b17008fb414d84981191cf3b66a476ef8bef'"; // String | Application Key
let campaignId = "campaignId_example"; // String | Campaign Identifier
apiInstance.deleteCampaignEntity(xAPI2CRMUSERKEY, xAPI2CRMAPPLICATIONKEY, campaignId, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
> Aggregate getCampaignAggregate(xAPI2CRMUSERKEY, xAPI2CRMAPPLICATIONKEY, opts)
...
apiInstance.getCampaignAggregate(xAPI2CRMUSERKEY, xAPI2CRMAPPLICATIONKEY, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> [CampaignEntity] getCampaignCollection(xAPI2CRMUSERKEY, xAPI2CRMAPPLICATIONKEY, opts)
...
apiInstance.getCampaignCollection(xAPI2CRMUSERKEY, xAPI2CRMAPPLICATIONKEY, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> Count getCampaignCountCollection(xAPI2CRMUSERKEY, xAPI2CRMAPPLICATIONKEY, opts)
...
apiInstance.getCampaignCountCollection(xAPI2CRMUSERKEY, xAPI2CRMAPPLICATIONKEY, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> CampaignDescribe getCampaignDescribe(xAPI2CRMUSERKEY, xAPI2CRMAPPLICATIONKEY, opts)
...
apiInstance.getCampaignDescribe(xAPI2CRMUSERKEY, xAPI2CRMAPPLICATIONKEY, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> CampaignEntity getCampaignEntity(xAPI2CRMUSERKEY, xAPI2CRMAPPLICATIONKEY, campaignId, opts)
...
apiInstance.getCampaignEntity(xAPI2CRMUSERKEY, xAPI2CRMAPPLICATIONKEY, campaignId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> CampaignEntityRelation updateCampaignEntity(xAPI2CRMUSERKEY, xAPI2CRMAPPLICATIONKEY, campaignId, body, opts)
...
let xAPI2CRMAPPLICATIONKEY = "'7ae5b17008fb414d84981191cf3b66a476ef8bef'"; // String | Application Key
let campaignId = "campaignId_example"; // String | Campaign Identifier
let body = new Data2CrmApi.CampaignEntity(); // CampaignEntity | Update campaign information
let opts = {
  'xAPI2CRMNATIVEENABLE': "xAPI2CRMNATIVEENABLE_example", // String | Return native response
  'xAPI2CRMDESCRIBELIFETIME': "xAPI2CRMDESCRIBELIFETIME_example" // String | Describe lifetime
};
apiInstance.updateCampaignEntity(xAPI2CRMUSERKEY, xAPI2CRMAPPLICATIONKEY, campaignId, body, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> BulkEntityRelation updateCampaignEntityBulk(xAPI2CRMUSERKEY, xAPI2CRMAPPLICATIONKEY, body, opts)
...
apiInstance.updateCampaignEntityBulk(xAPI2CRMUSERKEY, xAPI2CRMAPPLICATIONKEY, body, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
