...
> PriceBookEntityRelation createPriceBookEntity(xAPI2CRMUSERKEY, xAPI2CRMAPPLICATIONKEY, body, opts)
...
let apiInstance = new Data2CrmApi.PriceBookApi();
...
let body = new Data2CrmApi.PriceBookEntity(); // PriceBookEntity | Add priceBook into the system
let opts = {
...
apiInstance.createPriceBookEntity(xAPI2CRMUSERKEY, xAPI2CRMAPPLICATIONKEY, body, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
> BulkEntityRelation createPriceBookEntityBulk(xAPI2CRMUSERKEY, xAPI2CRMAPPLICATIONKEY, body, opts)
...
let xAPI2CRMUSERKEY = "'e2a6379ab878ae7e58119d4ec842bf9c'"; // String | User Key
let xAPI2CRMAPPLICATIONKEY = "'7ae5b17008fb414d84981191cf3b66a476ef8bef'"; // String | Application Key
let body = new Data2CrmApi.BulkEntity(); // BulkEntity | Add priceBook into the system
let opts = {
  'xAPI2CRMNATIVEENABLE': "xAPI2CRMNATIVEENABLE_example", // String | Return native response
  'xAPI2CRMDESCRIBELIFETIME': "xAPI2CRMDESCRIBELIFETIME_example" // String | Describe lifetime
};
apiInstance.createPriceBookEntityBulk(xAPI2CRMUSERKEY, xAPI2CRMAPPLICATIONKEY, body, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> BulkEntity deletePriceBookCollectionBulk(xAPI2CRMUSERKEY, xAPI2CRMAPPLICATIONKEY, body)
...
apiInstance.deletePriceBookCollectionBulk(xAPI2CRMUSERKEY, xAPI2CRMAPPLICATIONKEY, body, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> deletePriceBookEntity(xAPI2CRMUSERKEY, xAPI2CRMAPPLICATIONKEY, priceBookId)
...
let xAPI2CRMUSERKEY = "'e2a6379ab878ae7e58119d4ec842bf9c'"; // String | User Key
let xAPI2CRMAPPLICATIONKEY = "'7ae5b17008fb414d84981191cf3b66a476ef8bef'"; // String | Application Key
let priceBookId = "priceBookId_example"; // String | PriceBook Identifier
apiInstance.deletePriceBookEntity(xAPI2CRMUSERKEY, xAPI2CRMAPPLICATIONKEY, priceBookId, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
> Aggregate getPriceBookAggregate(xAPI2CRMUSERKEY, xAPI2CRMAPPLICATIONKEY, opts)
...
apiInstance.getPriceBookAggregate(xAPI2CRMUSERKEY, xAPI2CRMAPPLICATIONKEY, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> [PriceBookEntity] getPriceBookCollection(xAPI2CRMUSERKEY, xAPI2CRMAPPLICATIONKEY, opts)
...
apiInstance.getPriceBookCollection(xAPI2CRMUSERKEY, xAPI2CRMAPPLICATIONKEY, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> Count getPriceBookCountCollection(xAPI2CRMUSERKEY, xAPI2CRMAPPLICATIONKEY, opts)
...
apiInstance.getPriceBookCountCollection(xAPI2CRMUSERKEY, xAPI2CRMAPPLICATIONKEY, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> PriceBookDescribe getPriceBookDescribe(xAPI2CRMUSERKEY, xAPI2CRMAPPLICATIONKEY, opts)
...
apiInstance.getPriceBookDescribe(xAPI2CRMUSERKEY, xAPI2CRMAPPLICATIONKEY, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> PriceBookEntity getPriceBookEntity(xAPI2CRMUSERKEY, xAPI2CRMAPPLICATIONKEY, priceBookId, opts)
...
apiInstance.getPriceBookEntity(xAPI2CRMUSERKEY, xAPI2CRMAPPLICATIONKEY, priceBookId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> PriceBookEntityRelation updatePriceBookEntity(xAPI2CRMUSERKEY, xAPI2CRMAPPLICATIONKEY, priceBookId, body, opts)
...
let xAPI2CRMAPPLICATIONKEY = "'7ae5b17008fb414d84981191cf3b66a476ef8bef'"; // String | Application Key
let priceBookId = "priceBookId_example"; // String | PriceBook Identifier
let body = new Data2CrmApi.PriceBookEntity(); // PriceBookEntity | Update priceBook information
let opts = {
  'xAPI2CRMNATIVEENABLE': "xAPI2CRMNATIVEENABLE_example", // String | Return native response
  'xAPI2CRMDESCRIBELIFETIME': "xAPI2CRMDESCRIBELIFETIME_example" // String | Describe lifetime
};
apiInstance.updatePriceBookEntity(xAPI2CRMUSERKEY, xAPI2CRMAPPLICATIONKEY, priceBookId, body, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> BulkEntityRelation updatePriceBookEntityBulk(xAPI2CRMUSERKEY, xAPI2CRMAPPLICATIONKEY, body, opts)
...
apiInstance.updatePriceBookEntityBulk(xAPI2CRMUSERKEY, xAPI2CRMAPPLICATIONKEY, body, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
