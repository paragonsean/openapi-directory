...
> PostEntityRelation createPostEntity(xAPI2CRMUSERKEY, xAPI2CRMAPPLICATIONKEY, body, opts)
...
let apiInstance = new Data2CrmApi.PostApi();
...
let body = new Data2CrmApi.PostEntity(); // PostEntity | Add post into the system
let opts = {
...
apiInstance.createPostEntity(xAPI2CRMUSERKEY, xAPI2CRMAPPLICATIONKEY, body, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
> BulkEntityRelation createPostEntityBulk(xAPI2CRMUSERKEY, xAPI2CRMAPPLICATIONKEY, body, opts)
...
let xAPI2CRMUSERKEY = "'e2a6379ab878ae7e58119d4ec842bf9c'"; // String | User Key
let xAPI2CRMAPPLICATIONKEY = "'7ae5b17008fb414d84981191cf3b66a476ef8bef'"; // String | Application Key
let body = new Data2CrmApi.BulkEntity(); // BulkEntity | Add post into the system
let opts = {
  'xAPI2CRMNATIVEENABLE': "xAPI2CRMNATIVEENABLE_example", // String | Return native response
  'xAPI2CRMDESCRIBELIFETIME': "xAPI2CRMDESCRIBELIFETIME_example" // String | Describe lifetime
};
apiInstance.createPostEntityBulk(xAPI2CRMUSERKEY, xAPI2CRMAPPLICATIONKEY, body, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> BulkEntity deletePostCollectionBulk(xAPI2CRMUSERKEY, xAPI2CRMAPPLICATIONKEY, body)
...
apiInstance.deletePostCollectionBulk(xAPI2CRMUSERKEY, xAPI2CRMAPPLICATIONKEY, body, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> deletePostEntity(xAPI2CRMUSERKEY, xAPI2CRMAPPLICATIONKEY, postId)
...
let xAPI2CRMUSERKEY = "'e2a6379ab878ae7e58119d4ec842bf9c'"; // String | User Key
let xAPI2CRMAPPLICATIONKEY = "'7ae5b17008fb414d84981191cf3b66a476ef8bef'"; // String | Application Key
let postId = "postId_example"; // String | Post Identifier
apiInstance.deletePostEntity(xAPI2CRMUSERKEY, xAPI2CRMAPPLICATIONKEY, postId, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
> Aggregate getPostAggregate(xAPI2CRMUSERKEY, xAPI2CRMAPPLICATIONKEY, opts)
...
apiInstance.getPostAggregate(xAPI2CRMUSERKEY, xAPI2CRMAPPLICATIONKEY, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> [PostEntity] getPostCollection(xAPI2CRMUSERKEY, xAPI2CRMAPPLICATIONKEY, opts)
...
apiInstance.getPostCollection(xAPI2CRMUSERKEY, xAPI2CRMAPPLICATIONKEY, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> Count getPostCountCollection(xAPI2CRMUSERKEY, xAPI2CRMAPPLICATIONKEY, opts)
...
apiInstance.getPostCountCollection(xAPI2CRMUSERKEY, xAPI2CRMAPPLICATIONKEY, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> PostDescribe getPostDescribe(xAPI2CRMUSERKEY, xAPI2CRMAPPLICATIONKEY, opts)
...
apiInstance.getPostDescribe(xAPI2CRMUSERKEY, xAPI2CRMAPPLICATIONKEY, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> PostEntity getPostEntity(xAPI2CRMUSERKEY, xAPI2CRMAPPLICATIONKEY, postId, opts)
...
apiInstance.getPostEntity(xAPI2CRMUSERKEY, xAPI2CRMAPPLICATIONKEY, postId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> PostEntityRelation updatePostEntity(xAPI2CRMUSERKEY, xAPI2CRMAPPLICATIONKEY, postId, body, opts)
...
let xAPI2CRMAPPLICATIONKEY = "'7ae5b17008fb414d84981191cf3b66a476ef8bef'"; // String | Application Key
let postId = "postId_example"; // String | Post Identifier
let body = new Data2CrmApi.PostEntity(); // PostEntity | Update post information
let opts = {
  'xAPI2CRMNATIVEENABLE': "xAPI2CRMNATIVEENABLE_example", // String | Return native response
  'xAPI2CRMDESCRIBELIFETIME': "xAPI2CRMDESCRIBELIFETIME_example" // String | Describe lifetime
};
apiInstance.updatePostEntity(xAPI2CRMUSERKEY, xAPI2CRMAPPLICATIONKEY, postId, body, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> BulkEntityRelation updatePostEntityBulk(xAPI2CRMUSERKEY, xAPI2CRMAPPLICATIONKEY, body, opts)
...
apiInstance.updatePostEntityBulk(xAPI2CRMUSERKEY, xAPI2CRMAPPLICATIONKEY, body, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
