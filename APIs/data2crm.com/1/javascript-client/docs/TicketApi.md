...
> TicketEntityRelation createTicketEntity(xAPI2CRMUSERKEY, xAPI2CRMAPPLICATIONKEY, body, opts)
...
let apiInstance = new Data2CrmApi.TicketApi();
...
let body = new Data2CrmApi.TicketEntity(); // TicketEntity | Add ticket into the system
let opts = {
...
apiInstance.createTicketEntity(xAPI2CRMUSERKEY, xAPI2CRMAPPLICATIONKEY, body, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
> BulkEntityRelation createTicketEntityBulk(xAPI2CRMUSERKEY, xAPI2CRMAPPLICATIONKEY, body, opts)
...
let xAPI2CRMUSERKEY = "'e2a6379ab878ae7e58119d4ec842bf9c'"; // String | User Key
let xAPI2CRMAPPLICATIONKEY = "'7ae5b17008fb414d84981191cf3b66a476ef8bef'"; // String | Application Key
let body = new Data2CrmApi.BulkEntity(); // BulkEntity | Add ticket into the system
let opts = {
  'xAPI2CRMNATIVEENABLE': "xAPI2CRMNATIVEENABLE_example", // String | Return native response
  'xAPI2CRMDESCRIBELIFETIME': "xAPI2CRMDESCRIBELIFETIME_example" // String | Describe lifetime
};
apiInstance.createTicketEntityBulk(xAPI2CRMUSERKEY, xAPI2CRMAPPLICATIONKEY, body, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> BulkEntity deleteTicketCollectionBulk(xAPI2CRMUSERKEY, xAPI2CRMAPPLICATIONKEY, body)
...
apiInstance.deleteTicketCollectionBulk(xAPI2CRMUSERKEY, xAPI2CRMAPPLICATIONKEY, body, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> deleteTicketEntity(xAPI2CRMUSERKEY, xAPI2CRMAPPLICATIONKEY, ticketId)
...
let xAPI2CRMUSERKEY = "'e2a6379ab878ae7e58119d4ec842bf9c'"; // String | User Key
let xAPI2CRMAPPLICATIONKEY = "'7ae5b17008fb414d84981191cf3b66a476ef8bef'"; // String | Application Key
let ticketId = "ticketId_example"; // String | Ticket Identifier
apiInstance.deleteTicketEntity(xAPI2CRMUSERKEY, xAPI2CRMAPPLICATIONKEY, ticketId, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
> Aggregate getTicketAggregate(xAPI2CRMUSERKEY, xAPI2CRMAPPLICATIONKEY, opts)
...
apiInstance.getTicketAggregate(xAPI2CRMUSERKEY, xAPI2CRMAPPLICATIONKEY, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> [TicketEntity] getTicketCollection(xAPI2CRMUSERKEY, xAPI2CRMAPPLICATIONKEY, opts)
...
apiInstance.getTicketCollection(xAPI2CRMUSERKEY, xAPI2CRMAPPLICATIONKEY, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> Count getTicketCountCollection(xAPI2CRMUSERKEY, xAPI2CRMAPPLICATIONKEY, opts)
...
apiInstance.getTicketCountCollection(xAPI2CRMUSERKEY, xAPI2CRMAPPLICATIONKEY, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> TicketDescribe getTicketDescribe(xAPI2CRMUSERKEY, xAPI2CRMAPPLICATIONKEY, opts)
...
apiInstance.getTicketDescribe(xAPI2CRMUSERKEY, xAPI2CRMAPPLICATIONKEY, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> TicketEntity getTicketEntity(xAPI2CRMUSERKEY, xAPI2CRMAPPLICATIONKEY, ticketId, opts)
...
apiInstance.getTicketEntity(xAPI2CRMUSERKEY, xAPI2CRMAPPLICATIONKEY, ticketId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> TicketEntityRelation updateTicketEntity(xAPI2CRMUSERKEY, xAPI2CRMAPPLICATIONKEY, ticketId, body, opts)
...
let xAPI2CRMAPPLICATIONKEY = "'7ae5b17008fb414d84981191cf3b66a476ef8bef'"; // String | Application Key
let ticketId = "ticketId_example"; // String | Ticket Identifier
let body = new Data2CrmApi.TicketEntity(); // TicketEntity | Update ticket information
let opts = {
  'xAPI2CRMNATIVEENABLE': "xAPI2CRMNATIVEENABLE_example", // String | Return native response
  'xAPI2CRMDESCRIBELIFETIME': "xAPI2CRMDESCRIBELIFETIME_example" // String | Describe lifetime
};
apiInstance.updateTicketEntity(xAPI2CRMUSERKEY, xAPI2CRMAPPLICATIONKEY, ticketId, body, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> BulkEntityRelation updateTicketEntityBulk(xAPI2CRMUSERKEY, xAPI2CRMAPPLICATIONKEY, body, opts)
...
apiInstance.updateTicketEntityBulk(xAPI2CRMUSERKEY, xAPI2CRMAPPLICATIONKEY, body, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
