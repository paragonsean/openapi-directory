...
> ProjectEntityRelation createProjectEntity(xAPI2CRMUSERKEY, xAPI2CRMAPPLICATIONKEY, body, opts)
...
let apiInstance = new Data2CrmApi.ProjectApi();
...
let body = new Data2CrmApi.ProjectEntity(); // ProjectEntity | Add project into the system
let opts = {
...
apiInstance.createProjectEntity(xAPI2CRMUSERKEY, xAPI2CRMAPPLICATIONKEY, body, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
> BulkEntityRelation createProjectEntityBulk(xAPI2CRMUSERKEY, xAPI2CRMAPPLICATIONKEY, body, opts)
...
let xAPI2CRMUSERKEY = "'e2a6379ab878ae7e58119d4ec842bf9c'"; // String | User Key
let xAPI2CRMAPPLICATIONKEY = "'7ae5b17008fb414d84981191cf3b66a476ef8bef'"; // String | Application Key
let body = new Data2CrmApi.BulkEntity(); // BulkEntity | Add project into the system
let opts = {
  'xAPI2CRMNATIVEENABLE': "xAPI2CRMNATIVEENABLE_example", // String | Return native response
  'xAPI2CRMDESCRIBELIFETIME': "xAPI2CRMDESCRIBELIFETIME_example" // String | Describe lifetime
};
apiInstance.createProjectEntityBulk(xAPI2CRMUSERKEY, xAPI2CRMAPPLICATIONKEY, body, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> BulkEntity deleteProjectCollectionBulk(xAPI2CRMUSERKEY, xAPI2CRMAPPLICATIONKEY, body)
...
apiInstance.deleteProjectCollectionBulk(xAPI2CRMUSERKEY, xAPI2CRMAPPLICATIONKEY, body, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> deleteProjectEntity(xAPI2CRMUSERKEY, xAPI2CRMAPPLICATIONKEY, projectId)
...
let xAPI2CRMUSERKEY = "'e2a6379ab878ae7e58119d4ec842bf9c'"; // String | User Key
let xAPI2CRMAPPLICATIONKEY = "'7ae5b17008fb414d84981191cf3b66a476ef8bef'"; // String | Application Key
let projectId = "projectId_example"; // String | Project Identifier
apiInstance.deleteProjectEntity(xAPI2CRMUSERKEY, xAPI2CRMAPPLICATIONKEY, projectId, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
> Aggregate getProjectAggregate(xAPI2CRMUSERKEY, xAPI2CRMAPPLICATIONKEY, opts)
...
apiInstance.getProjectAggregate(xAPI2CRMUSERKEY, xAPI2CRMAPPLICATIONKEY, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> [ProjectEntity] getProjectCollection(xAPI2CRMUSERKEY, xAPI2CRMAPPLICATIONKEY, opts)
...
apiInstance.getProjectCollection(xAPI2CRMUSERKEY, xAPI2CRMAPPLICATIONKEY, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> Count getProjectCountCollection(xAPI2CRMUSERKEY, xAPI2CRMAPPLICATIONKEY, opts)
...
apiInstance.getProjectCountCollection(xAPI2CRMUSERKEY, xAPI2CRMAPPLICATIONKEY, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> ProjectDescribe getProjectDescribe(xAPI2CRMUSERKEY, xAPI2CRMAPPLICATIONKEY, opts)
...
apiInstance.getProjectDescribe(xAPI2CRMUSERKEY, xAPI2CRMAPPLICATIONKEY, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> ProjectEntity getProjectEntity(xAPI2CRMUSERKEY, xAPI2CRMAPPLICATIONKEY, projectId, opts)
...
apiInstance.getProjectEntity(xAPI2CRMUSERKEY, xAPI2CRMAPPLICATIONKEY, projectId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> ProjectEntityRelation updateProjectEntity(xAPI2CRMUSERKEY, xAPI2CRMAPPLICATIONKEY, projectId, body, opts)
...
let xAPI2CRMAPPLICATIONKEY = "'7ae5b17008fb414d84981191cf3b66a476ef8bef'"; // String | Application Key
let projectId = "projectId_example"; // String | Project Identifier
let body = new Data2CrmApi.ProjectEntity(); // ProjectEntity | Update project information
let opts = {
  'xAPI2CRMNATIVEENABLE': "xAPI2CRMNATIVEENABLE_example", // String | Return native response
  'xAPI2CRMDESCRIBELIFETIME': "xAPI2CRMDESCRIBELIFETIME_example" // String | Describe lifetime
};
apiInstance.updateProjectEntity(xAPI2CRMUSERKEY, xAPI2CRMAPPLICATIONKEY, projectId, body, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> BulkEntityRelation updateProjectEntityBulk(xAPI2CRMUSERKEY, xAPI2CRMAPPLICATIONKEY, body, opts)
...
apiInstance.updateProjectEntityBulk(xAPI2CRMUSERKEY, xAPI2CRMAPPLICATIONKEY, body, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
