...
#ifndef OAICallEntity_H
#define OAICallEntity_H
...
class OAICallEntity : public OAIObject {
public:
    OAICallEntity();
    OAICallEntity(QString json);
    ~OAICallEntity() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICallEntity)

#endif // OAICallEntity_H
