...
/*
 * OAIPriceBookEntity.h
 *
 * 
 */

#ifndef OAIPriceBookEntity_H
#define OAIPriceBookEntity_H
...
class OAIPriceBookEntity : public OAIObject {
public:
    OAIPriceBookEntity();
    OAIPriceBookEntity(QString json);
    ~OAIPriceBookEntity() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPriceBookEntity)

#endif // OAIPriceBookEntity_H
