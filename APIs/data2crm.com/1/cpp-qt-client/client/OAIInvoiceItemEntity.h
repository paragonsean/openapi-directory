...
/*
 * OAIInvoiceItemEntity.h
 *
 * 
 */

#ifndef OAIInvoiceItemEntity_H
#define OAIInvoiceItemEntity_H
...
class OAIInvoiceItemEntity : public OAIObject {
public:
    OAIInvoiceItemEntity();
    OAIInvoiceItemEntity(QString json);
    ~OAIInvoiceItemEntity() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIInvoiceItemEntity)

#endif // OAIInvoiceItemEntity_H
