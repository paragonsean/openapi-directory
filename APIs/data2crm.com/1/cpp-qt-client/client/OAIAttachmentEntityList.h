...
/*
 * OAIAttachmentEntityList.h
 *
 * 
 */

#ifndef OAIAttachmentEntityList_H
#define OAIAttachmentEntityList_H
...
class OAIAttachmentEntityList : public OAIObject {
public:
    OAIAttachmentEntityList();
    OAIAttachmentEntityList(QString json);
    ~OAIAttachmentEntityList() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAttachmentEntityList)

#endif // OAIAttachmentEntityList_H
