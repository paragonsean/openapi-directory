...
#ifndef OAITaskEntity_H
#define OAITaskEntity_H
...
class OAITaskEntity : public OAIObject {
public:
    OAITaskEntity();
    OAITaskEntity(QString json);
    ~OAITaskEntity() override;
    ...
    QDateTime getReminderAt() const;
    void setReminderAt(const QDateTime &reminder_at);
    bool is_reminder_at_Set() const;
    bool is_reminder_at_Valid() const;
...
private:
    ...
    QDateTime m_reminder_at;
    bool m_reminder_at_isSet;
    bool m_reminder_at_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAITaskEntity)

#endif // OAITaskEntity_H
