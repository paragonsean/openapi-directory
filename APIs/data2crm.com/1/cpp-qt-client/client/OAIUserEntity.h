...
public:
    ...
    bool isIsAssociable() const;
    void setIsAssociable(const bool &is_associable);
    bool is_is_associable_Set() const;
    bool is_is_associable_Valid() const;
...
private:
    ...
    bool m_is_associable;
    bool m_is_associable_isSet;
    bool m_is_associable_isValid;
