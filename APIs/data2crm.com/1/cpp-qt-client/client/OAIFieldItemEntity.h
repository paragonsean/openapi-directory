...
/*
 * OAIFieldItemEntity.h
 *
 * 
 */

#ifndef OAIFieldItemEntity_H
#define OAIFieldItemEntity_H
...
class OAIFieldItemEntity : public OAIObject {
public:
    OAIFieldItemEntity();
    OAIFieldItemEntity(QString json);
    ~OAIFieldItemEntity() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFieldItemEntity)

#endif // OAIFieldItemEntity_H
