...
#ifndef OAIInvoiceEntity_H
#define OAIInvoiceEntity_H
...
class OAIInvoiceEntity : public OAIObject {
public:
    OAIInvoiceEntity();
    OAIInvoiceEntity(QString json);
    ~OAIInvoiceEntity() override;
    ...
    float getExciseDuty() const;
    void setExciseDuty(const float &excise_duty);
    bool is_excise_duty_Set() const;
    bool is_excise_duty_Valid() const;
    ...
    void setSalesCommission(const float &sales_commission);
    bool is_sales_commission_Set() const;
    bool is_sales_commission_Valid() const;
...
private:
    ...
    float m_excise_duty;
    bool m_excise_duty_isSet;
    bool m_excise_duty_isValid;
    ...
    float m_sales_commission;
    bool m_sales_commission_isSet;
    bool m_sales_commission_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIInvoiceEntity)

#endif // OAIInvoiceEntity_H
