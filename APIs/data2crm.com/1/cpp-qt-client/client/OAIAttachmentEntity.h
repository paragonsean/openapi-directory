...
/*
 * OAIAttachmentEntity.h
 *
 * 
 */

#ifndef OAIAttachmentEntity_H
#define OAIAttachmentEntity_H
...
class OAIAttachmentEntity : public OAIObject {
public:
    OAIAttachmentEntity();
    OAIAttachmentEntity(QString json);
    ~OAIAttachmentEntity() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAttachmentEntity)

#endif // OAIAttachmentEntity_H
