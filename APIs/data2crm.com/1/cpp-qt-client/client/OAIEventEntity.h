...
#ifndef OAIEventEntity_H
#define OAIEventEntity_H
...
class OAIEventEntity : public OAIObject {
public:
    OAIEventEntity();
    OAIEventEntity(QString json);
    ~OAIEventEntity() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEventEntity)

#endif // OAIEventEntity_H
