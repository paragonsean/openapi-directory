...
/*
 * OAIQuoteItemEntity.h
 *
 * 
 */

#ifndef OAIQuoteItemEntity_H
#define OAIQuoteItemEntity_H
...
class OAIQuoteItemEntity : public OAIObject {
public:
    OAIQuoteItemEntity();
    OAIQuoteItemEntity(QString json);
    ~OAIQuoteItemEntity() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIQuoteItemEntity)

#endif // OAIQuoteItemEntity_H
