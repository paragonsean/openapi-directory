...
#ifndef OAICommentEntity_H
#define OAICommentEntity_H
...
class OAICommentEntity : public OAIObject {
public:
    OAICommentEntity();
    OAICommentEntity(QString json);
    ~OAICommentEntity() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICommentEntity)

#endif // OAICommentEntity_H
