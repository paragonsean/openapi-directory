...
void OAIEntityApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("getEntityCollection", defaultConf);
    _serverIndices.insert("getEntityCollection", 0);
    _serverConfigs.insert("getEntityCountCollection", defaultConf);
    _serverIndices.insert("getEntityCountCollection", 0);
    _serverConfigs.insert("getEntityEntity", defaultConf);
    _serverIndices.insert("getEntityEntity", 0);
}
...
void OAIEntityApi::getEntityCollection(const QString &x_api2_crm_user_key, const QString &x_api2_crm_application_key, const ::OpenAPI::OptionalParam<QString> &x_api2_crm_native_enable, const ::OpenAPI::OptionalParam<QString> &x_api2_crm_describe_lifetime, const ::OpenAPI::OptionalParam<qint32> &page_size, const ::OpenAPI::OptionalParam<qint32> &page, const ::OpenAPI::OptionalParam<QString> &filter, const ::OpenAPI::OptionalParam<QString> &fields) {
    QString fullPath = QString(_serverConfigs["getEntityCollection"][_serverIndices.value("getEntityCollection")].URL()+"/application/entity/list");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIEntityApi::getEntityCollectionCallback);
...
void OAIEntityApi::getEntityCollectionCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT getEntityCollectionSignal(output);
        Q_EMIT getEntityCollectionSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT getEntityCollectionSignalE(output, error_type, error_str);
        Q_EMIT getEntityCollectionSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT getEntityCollectionSignalError(output, error_type, error_str);
        Q_EMIT getEntityCollectionSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIEntityApi::getEntityCountCollection(const QString &x_api2_crm_user_key, const QString &x_api2_crm_application_key) {
    QString fullPath = QString(_serverConfigs["getEntityCountCollection"][_serverIndices.value("getEntityCountCollection")].URL()+"/application/entity/count");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIEntityApi::getEntityCountCollectionCallback);
    connect(this, &OAIEntityApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIEntityApi::getEntityCountCollectionCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT getEntityCountCollectionSignal(output);
        Q_EMIT getEntityCountCollectionSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT getEntityCountCollectionSignalE(output, error_type, error_str);
        Q_EMIT getEntityCountCollectionSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT getEntityCountCollectionSignalError(output, error_type, error_str);
        Q_EMIT getEntityCountCollectionSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIEntityApi::getEntityEntity(const QString &x_api2_crm_user_key, const QString &x_api2_crm_application_key, const QString &entity_id, const ::OpenAPI::OptionalParam<QString> &x_api2_crm_native_enable, const ::OpenAPI::OptionalParam<QString> &x_api2_crm_describe_lifetime, const ::OpenAPI::OptionalParam<QString> &fields) {
    QString fullPath = QString(_serverConfigs["getEntityEntity"][_serverIndices.value("getEntityEntity")].URL()+"/application/entity/{entity_id}");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIEntityApi::getEntityEntityCallback);
    connect(this, &OAIEntityApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIEntityApi::getEntityEntityCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    OAIEntityEntity output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT getEntityEntitySignal(output);
        Q_EMIT getEntityEntitySignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT getEntityEntitySignalE(output, error_type, error_str);
        Q_EMIT getEntityEntitySignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT getEntityEntitySignalError(output, error_type, error_str);
        Q_EMIT getEntityEntitySignalErrorFull(worker, error_type, error_str);
    }
}
