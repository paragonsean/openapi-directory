...
#ifndef OAINoteEntity_H
#define OAINoteEntity_H
...
class OAINoteEntity : public OAIObject {
public:
    OAINoteEntity();
    OAINoteEntity(QString json);
    ~OAINoteEntity() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAINoteEntity)

#endif // OAINoteEntity_H
