...
<a id="getEntityCollection"></a>
# **getEntityCollection**
> List&lt;EntityEntity&gt; getEntityCollection(X_API2CRM_USER_KEY, X_API2CRM_APPLICATION_KEY, X_API2CRM_NATIVE_ENABLE, X_API2CRM_DESCRIBE_LIFETIME, pageSize, page, filter, fields)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      List<EntityEntity> result = apiInstance.getEntityCollection(X_API2CRM_USER_KEY, X_API2CRM_APPLICATION_KEY, X_API2CRM_NATIVE_ENABLE, X_API2CRM_DESCRIBE_LIFETIME, pageSize, page, filter, fields);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling EntityApi#getEntityCollection");
...
<a id="getEntityCountCollection"></a>
# **getEntityCountCollection**
> Count getEntityCountCollection(X_API2CRM_USER_KEY, X_API2CRM_APPLICATION_KEY)
...
public class Example {
  public static void main(String[] args) {
    ...
    String X_API2CRM_APPLICATION_KEY = "7ae5b17008fb414d84981191cf3b66a476ef8bef"; // String | Application Key
    try {
      Count result = apiInstance.getEntityCountCollection(X_API2CRM_USER_KEY, X_API2CRM_APPLICATION_KEY);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling EntityApi#getEntityCountCollection");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="getEntityEntity"></a>
# **getEntityEntity**
> EntityEntity getEntityEntity(X_API2CRM_USER_KEY, X_API2CRM_APPLICATION_KEY, entityId, X_API2CRM_NATIVE_ENABLE, X_API2CRM_DESCRIBE_LIFETIME, fields)
...
public class Example {
  public static void main(String[] args) {
    ...
    String fields = "fields_example"; // String | Comma-separated list of fields to include in the response
    try {
      EntityEntity result = apiInstance.getEntityEntity(X_API2CRM_USER_KEY, X_API2CRM_APPLICATION_KEY, entityId, X_API2CRM_NATIVE_ENABLE, X_API2CRM_DESCRIBE_LIFETIME, fields);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling EntityApi#getEntityEntity");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
