...
public class AttachmentEntity {
  ...
  public AttachmentEntity description(String description) {
  ...
  public AttachmentEntity link(String link) {
    this.link = link;
    return this;
  }
  ...
  public AttachmentEntity mimeType(String mimeType) {
  ...
  public AttachmentEntity relation(Relation relation) {
  ...
  public AttachmentEntity size(Integer size) {
    this.size = size;
    return this;
  }
  ...
  public AttachmentEntity title(String title) {
    this.title = title;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.createdAt, attachmentEntity.createdAt) &&
        Objects.equals(this.description, attachmentEntity.description) &&
        Objects.equals(this.id, attachmentEntity.id) &&
        Objects.equals(this.link, attachmentEntity.link) &&
        Objects.equals(this.mimeType, attachmentEntity.mimeType) &&
        Objects.equals(this.name, attachmentEntity.name) &&
        Objects.equals(this.relation, attachmentEntity.relation) &&
        Objects.equals(this.size, attachmentEntity.size) &&
        Objects.equals(this.title, attachmentEntity.title) &&
        Objects.equals(this.updatedAt, attachmentEntity.updatedAt);
  }

  @Override
  public int hashCode() {
    return Objects.hash(createdAt, description, id, link, mimeType, name, relation, size, title, updatedAt);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to AttachmentEntity
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AttachmentEntity.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AttachmentEntity.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AttachmentEntity` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
