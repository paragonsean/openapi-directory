...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new UrlboxApi.DefaultApi();
  });
  ...
  describe('DefaultApi', function() {
    describe('renderSync', function() {
      it('should call renderSync successfully', function(done) {
        //uncomment below and update the code to test renderSync
        //instance.renderSync(function(error) {
