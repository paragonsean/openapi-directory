...
public class ApiClient {
    ...
    private String basePath = "https://api.urlbox.io";
    ...
    public ApiClient() {
        ...
        authentications.put("SecretKey", new HttpBearerAuth("bearer"));
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://api.urlbox.io
