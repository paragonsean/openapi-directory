...
Urlbox API
- API version: v1
  - Build date: 2024-10-12T11:54:36.943445-04:00[America/New_York]
...
------------ | ------------- | ------------- | -------------
*DefaultApi* | [**renderSync**](docs/DefaultApi.md#renderSync) | **POST** /v1/render/sync | Render a URL as an image or video
