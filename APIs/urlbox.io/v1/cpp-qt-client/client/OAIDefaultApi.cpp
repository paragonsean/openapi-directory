...
void OAIDefaultApi::initializeServerConfigs() {
    ...
    QUrl("https://api.urlbox.io"),
    "No description provided",
    QMap<QString, OAIServerVariable>()));
    _serverConfigs.insert("renderSync", defaultConf);
    _serverIndices.insert("renderSync", 0);
}
...
void OAIDefaultApi::renderSync(const OAIRenderRequest &oai_render_request) {
    QString fullPath = QString(_serverConfigs["renderSync"][_serverIndices.value("renderSync")].URL()+"/v1/render/sync");
...

    {
        ...
        QByteArray output = oai_render_request.asJson().toUtf8();
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIDefaultApi::renderSyncCallback);
...
void OAIDefaultApi::renderSyncCallback(OAIHttpRequestWorker *worker) {
    ...
    OAIRenderResponse output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT renderSyncSignal(output);
        Q_EMIT renderSyncSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT renderSyncSignalE(output, error_type, error_str);
        Q_EMIT renderSyncSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT renderSyncSignalError(output, error_type, error_str);
        Q_EMIT renderSyncSignalErrorFull(worker, error_type, error_str);
    }
}
