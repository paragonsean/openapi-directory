...
ImageSearchClient - JavaScript client for image_search_client
...
```shell
npm install image_search_client --save
```
...
To use the link you just defined in your project, switch to the directory you want to use your image_search_client from, and run:
...
```javascript
var ImageSearchClient = require('image_search_client');

var defaultClient = ImageSearchClient.ApiClient.instance;
...
var api = new ImageSearchClient.ImageDetailSearchApi()
...
api.imagesDetails(xBingApisSDK, q, opts, callback);
...
------------ | ------------- | ------------- | -------------
*ImageSearchClient.ImageDetailSearchApi* | [**imagesDetails**](docs/ImageDetailSearchApi.md#imagesDetails) | **GET** /images/details | The Image Detail Search API lets you search on Bing and get back insights about an image, such as webpages that include the image. This section provides technical details about the query parameters and headers that you use to request insights of images and the JSON response objects that contain them. For examples that show how to make requests, see [Searching the Web for Images](https://docs.microsoft.com/azure/cognitive-services/bing-image-search/search-the-web).
*ImageSearchClient.ImageSearchApi* | [**imagesSearch**](docs/ImageSearchApi.md#imagesSearch) | **GET** /images/search | The Image Search API lets you send a search query to Bing and get back a list of relevant images. This section provides technical details about the query parameters and headers that you use to request images and the JSON response objects that contain them. For examples that show how to make requests, see [Searching the Web for Images](https://docs.microsoft.com/azure/cognitive-services/bing-image-search/search-the-web).
*ImageSearchClient.ImageTrendingSearchApi* | [**imagesTrending**](docs/ImageTrendingSearchApi.md#imagesTrending) | **GET** /images/trending | The Image Trending Search API lets you search on Bing and get back a list of images that are trending based on search requests made by others. The images are broken out into different categories. For example, Popular People Searches. For a list of markets that support trending images, see [Trending Images](https://docs.microsoft.com/en-us/azure/cognitive-services/bing-image-search/trending-images).


## Documentation for Models

 - [ImageSearchClient.AggregateOffer](docs/AggregateOffer.md)
 - [ImageSearchClient.AggregateRating](docs/AggregateRating.md)
 - [ImageSearchClient.Answer](docs/Answer.md)
 - [ImageSearchClient.CollectionPage](docs/CollectionPage.md)
 - [ImageSearchClient.CreativeWork](docs/CreativeWork.md)
 - [ImageSearchClient.Error](docs/Error.md)
 - [ImageSearchClient.ErrorResponse](docs/ErrorResponse.md)
 - [ImageSearchClient.Identifiable](docs/Identifiable.md)
 - [ImageSearchClient.ImageGallery](docs/ImageGallery.md)
 - [ImageSearchClient.ImageInsights](docs/ImageInsights.md)
 - [ImageSearchClient.ImageInsightsImageCaption](docs/ImageInsightsImageCaption.md)
 - [ImageSearchClient.ImageObject](docs/ImageObject.md)
 - [ImageSearchClient.ImageTagsModule](docs/ImageTagsModule.md)
 - [ImageSearchClient.Images](docs/Images.md)
 - [ImageSearchClient.ImagesImageMetadata](docs/ImagesImageMetadata.md)
 - [ImageSearchClient.ImagesModule](docs/ImagesModule.md)
 - [ImageSearchClient.InsightsTag](docs/InsightsTag.md)
 - [ImageSearchClient.Intangible](docs/Intangible.md)
 - [ImageSearchClient.MediaObject](docs/MediaObject.md)
 - [ImageSearchClient.NormalizedRectangle](docs/NormalizedRectangle.md)
 - [ImageSearchClient.Offer](docs/Offer.md)
 - [ImageSearchClient.Organization](docs/Organization.md)
 - [ImageSearchClient.Person](docs/Person.md)
 - [ImageSearchClient.PivotSuggestions](docs/PivotSuggestions.md)
 - [ImageSearchClient.PropertiesItem](docs/PropertiesItem.md)
 - [ImageSearchClient.Query](docs/Query.md)
 - [ImageSearchClient.Rating](docs/Rating.md)
 - [ImageSearchClient.Recipe](docs/Recipe.md)
 - [ImageSearchClient.RecipesModule](docs/RecipesModule.md)
 - [ImageSearchClient.RecognizedEntitiesModule](docs/RecognizedEntitiesModule.md)
 - [ImageSearchClient.RecognizedEntity](docs/RecognizedEntity.md)
 - [ImageSearchClient.RecognizedEntityGroup](docs/RecognizedEntityGroup.md)
 - [ImageSearchClient.RecognizedEntityRegion](docs/RecognizedEntityRegion.md)
 - [ImageSearchClient.RelatedCollectionsModule](docs/RelatedCollectionsModule.md)
 - [ImageSearchClient.RelatedSearchesModule](docs/RelatedSearchesModule.md)
 - [ImageSearchClient.Response](docs/Response.md)
 - [ImageSearchClient.ResponseBase](docs/ResponseBase.md)
 - [ImageSearchClient.SearchResultsAnswer](docs/SearchResultsAnswer.md)
 - [ImageSearchClient.StructuredValue](docs/StructuredValue.md)
 - [ImageSearchClient.Thing](docs/Thing.md)
 - [ImageSearchClient.TrendingImages](docs/TrendingImages.md)
 - [ImageSearchClient.TrendingImagesCategory](docs/TrendingImagesCategory.md)
 - [ImageSearchClient.TrendingImagesTile](docs/TrendingImagesTile.md)
 - [ImageSearchClient.WebPage](docs/WebPage.md)
