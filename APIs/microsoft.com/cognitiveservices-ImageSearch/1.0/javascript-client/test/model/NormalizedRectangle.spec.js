...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ImageSearchClient.NormalizedRectangle();
  });
  ...
  describe('NormalizedRectangle', function() {
    it('should create an instance of NormalizedRectangle', function() {
      // uncomment below and update the code to test NormalizedRectangle
      //var instance = new ImageSearchClient.NormalizedRectangle();
      //expect(instance).to.be.a(ImageSearchClient.NormalizedRectangle);
    });
