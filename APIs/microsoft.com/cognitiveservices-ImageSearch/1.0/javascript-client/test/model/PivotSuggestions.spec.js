...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ImageSearchClient.PivotSuggestions();
  });
  ...
  describe('PivotSuggestions', function() {
    it('should create an instance of PivotSuggestions', function() {
      ...
      //var instance = new ImageSearchClient.PivotSuggestions();
      //expect(instance).to.be.a(ImageSearchClient.PivotSuggestions);
    });
