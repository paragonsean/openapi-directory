...
/**
* ImageTrendingSearch service.
* @module api/ImageTrendingSearchApi
* @version 1.0
*/
export default class ImageTrendingSearchApi {

    /**
    * Constructs a new ImageTrendingSearchApi. 
    * @alias module:api/ImageTrendingSearchApi
    * @class
    ...
    */
    ...
    /**
     * Callback function to receive the result of the imagesTrending operation.
     * @callback module:api/ImageTrendingSearchApi~imagesTrendingCallback
     * @param {String} error Error message, if any.
     * @param {module:model/TrendingImages} data The data returned by the service call.
     ...
     * @param {module:api/ImageTrendingSearchApi~imagesTrendingCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/TrendingImages}
     */
    imagesTrending(xBingApisSDK, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'xBingApisSDK' is set
      if (xBingApisSDK === undefined || xBingApisSDK === null) {
        throw new Error("Missing the required parameter 'xBingApisSDK' when calling imagesTrending");
      }
