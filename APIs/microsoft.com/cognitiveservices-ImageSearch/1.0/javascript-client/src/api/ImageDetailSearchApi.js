...
/**
* ImageDetailSearch service.
* @module api/ImageDetailSearchApi
* @version 1.0
*/
export default class ImageDetailSearchApi {

    /**
    * Constructs a new ImageDetailSearchApi. 
    * @alias module:api/ImageDetailSearchApi
    * @class
    ...
    */
    ...
    /**
     * Callback function to receive the result of the imagesDetails operation.
     * @callback module:api/ImageDetailSearchApi~imagesDetailsCallback
     * @param {String} error Error message, if any.
     * @param {module:model/ImageInsights} data The data returned by the service call.
     ...
     * @param {module:model/String} [ct] The crop type to use when cropping the image based on the coordinates specified in the cal, cat, car, and cab parameters. The following are the possible values. 0: Rectangular (default). Use this parameter only with the Insights API. Do not specify this parameter when calling the Images, Trending Images, or Web Search APIs.
     ...
     * @param {module:api/ImageDetailSearchApi~imagesDetailsCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/ImageInsights}
     */
    imagesDetails(xBingApisSDK, q, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'xBingApisSDK' is set
      if (xBingApisSDK === undefined || xBingApisSDK === null) {
        throw new Error("Missing the required parameter 'xBingApisSDK' when calling imagesDetails");
      }
      // verify the required parameter 'q' is set
      if (q === undefined || q === null) {
        throw new Error("Missing the required parameter 'q' when calling imagesDetails");
      }
      ...
      let queryParams = {
        ...
        'id': opts['id'],
        'imgUrl': opts['imgUrl'],
        'insightsToken': opts['insightsToken'],
        'modules': this.apiClient.buildCollectionParam(opts['modules'], 'csv'),
        'mkt': opts['mkt'],
        'q': q,
