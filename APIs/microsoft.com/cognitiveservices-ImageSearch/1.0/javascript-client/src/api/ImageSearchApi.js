...
/**
* ImageSearch service.
* @module api/ImageSearchApi
* @version 1.0
*/
export default class ImageSearchApi {

    /**
    * Constructs a new ImageSearchApi. 
    * @alias module:api/ImageSearchApi
    * @class
    ...
    */
    ...
    /**
     * Callback function to receive the result of the imagesSearch operation.
     * @callback module:api/ImageSearchApi~imagesSearchCallback
     * @param {String} error Error message, if any.
     * @param {module:model/Images} data The data returned by the service call.
     ...
     * @param {module:model/String} [aspect] Filter images by the following aspect ratios. All: Do not filter by aspect.Specifying this value is the same as not specifying the aspect parameter. Square: Return images with standard aspect ratio. Wide: Return images with wide screen aspect ratio. Tall: Return images with tall aspect ratio.
     * @param {module:model/String} [color] Filter images by the following color options. ColorOnly: Return color images. Monochrome: Return black and white images. Return images with one of the following dominant colors: Black, Blue, Brown, Gray, Green, Orange, Pink, Purple, Red, Teal, White, Yellow
     ...
     * @param {module:model/String} [freshness] Filter images by the following discovery options. Day: Return images discovered by Bing within the last 24 hours. Week: Return images discovered by Bing within the last 7 days. Month: Return images discovered by Bing within the last 30 days.
     ...
     * @param {module:api/ImageSearchApi~imagesSearchCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/Images}
     */
    imagesSearch(xBingApisSDK, q, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'xBingApisSDK' is set
      if (xBingApisSDK === undefined || xBingApisSDK === null) {
        throw new Error("Missing the required parameter 'xBingApisSDK' when calling imagesSearch");
      }
      // verify the required parameter 'q' is set
      if (q === undefined || q === null) {
        throw new Error("Missing the required parameter 'q' when calling imagesSearch");
      }
