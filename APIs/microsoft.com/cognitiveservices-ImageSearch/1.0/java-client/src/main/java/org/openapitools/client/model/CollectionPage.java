...
public class CollectionPage extends WebPage {
  ...
  public String toString() {
    ...
    sb.append("class CollectionPage {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CollectionPage
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CollectionPage.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CollectionPage is not found in the empty JSON string", CollectionPage.openapiRequiredFields.toString()));
        }
      }
  ...
  /**
   * Create an instance of CollectionPage given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CollectionPage
   * @throws IOException if the JSON string is invalid with respect to CollectionPage
   */
  public static CollectionPage fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CollectionPage.class);
  }

  /**
   * Convert an instance of CollectionPage to an JSON string
   *
   * @return JSON string
   */
