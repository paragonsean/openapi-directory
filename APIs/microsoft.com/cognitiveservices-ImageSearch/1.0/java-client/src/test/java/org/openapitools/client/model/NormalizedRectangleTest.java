...
/**
 * Model tests for NormalizedRectangle
 */
public class NormalizedRectangleTest {
    private final NormalizedRectangle model = new NormalizedRectangle();
