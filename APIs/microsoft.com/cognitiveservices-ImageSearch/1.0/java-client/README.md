...
Image Search Client
- API version: 1.0
  - Build date: 2024-10-12T10:10:59.700770-04:00[America/New_York]
...
import org.openapitools.client.api.ImageDetailSearchApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    ImageDetailSearchApi apiInstance = new ImageDetailSearchApi(defaultClient);
    ...
    try {
      ImageInsights result = apiInstance.imagesDetails(xBingApisSDK, q, accept, acceptLanguage, contentType, userAgent, xMSEdgeClientID, xMSEdgeClientIP, xSearchLocation, cab, cal, car, cat, ct, cc, id, imgUrl, insightsToken, modules, mkt, safeSearch, setLang);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling ImageDetailSearchApi#imagesDetails");
...
## Documentation for Models
 ...
 - [ImageInsightsImageCaption](docs/ImageInsightsImageCaption.md)
 - [ImageObject](docs/ImageObject.md)
 - [ImageTagsModule](docs/ImageTagsModule.md)
 - [Images](docs/Images.md)
 - [ImagesImageMetadata](docs/ImagesImageMetadata.md)
 - [ImagesModule](docs/ImagesModule.md)
 - [InsightsTag](docs/InsightsTag.md)
 - [Intangible](docs/Intangible.md)
 - [MediaObject](docs/MediaObject.md)
 - [NormalizedRectangle](docs/NormalizedRectangle.md)
 - [Offer](docs/Offer.md)
 - [Organization](docs/Organization.md)
 - [Person](docs/Person.md)
 - [PivotSuggestions](docs/PivotSuggestions.md)
 - [PropertiesItem](docs/PropertiesItem.md)
 - [Query](docs/Query.md)
 - [Rating](docs/Rating.md)
 - [Recipe](docs/Recipe.md)
 - [RecipesModule](docs/RecipesModule.md)
 - [RecognizedEntitiesModule](docs/RecognizedEntitiesModule.md)
 - [RecognizedEntity](docs/RecognizedEntity.md)
 - [RecognizedEntityGroup](docs/RecognizedEntityGroup.md)
 - [RecognizedEntityRegion](docs/RecognizedEntityRegion.md)
 - [RelatedCollectionsModule](docs/RelatedCollectionsModule.md)
 - [RelatedSearchesModule](docs/RelatedSearchesModule.md)
 ...
 - [Thing](docs/Thing.md)
 - [TrendingImages](docs/TrendingImages.md)
 - [TrendingImagesCategory](docs/TrendingImagesCategory.md)
 - [TrendingImagesTile](docs/TrendingImagesTile.md)
