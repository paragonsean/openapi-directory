...
#ifndef OAIImageGallery_H
#define OAIImageGallery_H

#include <QJsonObject>

#include "OAICollectionPage.h"
...
class OAIImageGallery : public OAIObject {
public:
    OAIImageGallery();
    OAIImageGallery(QString json);
    ~OAIImageGallery() override;
    ...
    qint64 getImagesCount() const;
    void setImagesCount(const qint64 &images_count);
    bool is_images_count_Set() const;
    bool is_images_count_Valid() const;
...
private:
    ...
    qint64 m_images_count;
    bool m_images_count_isSet;
    bool m_images_count_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIImageGallery)

#endif // OAIImageGallery_H
