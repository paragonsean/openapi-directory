...
QString OAIWebPage::getDatePublished() const {
    return m_date_published;
}
void OAIWebPage::setDatePublished(const QString &date_published) {
    m_date_published = date_published;
    m_date_published_isSet = true;
}

bool OAIWebPage::is_date_published_Set() const{
    return m_date_published_isSet;
}

bool OAIWebPage::is_date_published_Valid() const{
