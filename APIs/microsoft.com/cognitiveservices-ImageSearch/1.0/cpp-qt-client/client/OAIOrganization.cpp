...
QString OAIOrganization::getReadLink() const {
    return m_read_link;
}
void OAIOrganization::setReadLink(const QString &read_link) {
    m_read_link = read_link;
    m_read_link_isSet = true;
}

bool OAIOrganization::is_read_link_Set() const{
    return m_read_link_isSet;
}

bool OAIOrganization::is_read_link_Valid() const{
