...
#ifndef OAICollectionPage_H
#define OAICollectionPage_H
...
class OAICollectionPage : public OAIObject {
public:
    OAICollectionPage();
    OAICollectionPage(QString json);
    ~OAICollectionPage() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICollectionPage)

#endif // OAICollectionPage_H
