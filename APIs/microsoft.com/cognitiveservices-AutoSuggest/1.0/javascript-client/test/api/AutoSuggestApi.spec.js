...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AutoSuggestClient.AutoSuggestApi();
  });
  ...
  describe('AutoSuggestApi', function() {
    describe('autoSuggest', function() {
      it('should call autoSuggest successfully', function(done) {
        //uncomment below and update the code to test autoSuggest
        //instance.autoSuggest(function(error) {
