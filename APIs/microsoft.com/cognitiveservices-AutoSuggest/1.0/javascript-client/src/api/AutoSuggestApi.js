...
* @version 1.0
*/
export default class AutoSuggestApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the autoSuggest operation.
     * @callback module:api/AutoSuggestApi~autoSuggestCallback
     ...
     * @param {Array.<module:model/String>} [responseFormat] The media type to use for the response. The following are the possible case-insensitive values: JSON, JSONLD. The default is JSON. If you specify JSONLD, the response body includes JSON-LD objects that contain the search results.
     * @param {module:api/AutoSuggestApi~autoSuggestCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/Suggestions}
     */
    autoSuggest(xBingApisSDK, q, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'xBingApisSDK' is set
      if (xBingApisSDK === undefined || xBingApisSDK === null) {
        throw new Error("Missing the required parameter 'xBingApisSDK' when calling autoSuggest");
      }
      // verify the required parameter 'q' is set
      if (q === undefined || q === null) {
        throw new Error("Missing the required parameter 'q' when calling autoSuggest");
      }
      ...
      let queryParams = {
        ...
        'ResponseFormat': this.apiClient.buildCollectionParam(opts['responseFormat'], 'csv')
      };
      let headerParams = {
