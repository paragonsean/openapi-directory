...
namespace OpenAPI {
class OAISuggestionsSuggestionGroup;
...
public:
    ...
    QList<OAISuggestionsSuggestionGroup> getSuggestionGroups() const;
    void setSuggestionGroups(const QList<OAISuggestionsSuggestionGroup> &suggestion_groups);
    bool is_suggestion_groups_Set() const;
    bool is_suggestion_groups_Valid() const;
...
private:
    ...
    QList<OAISuggestionsSuggestionGroup> m_suggestion_groups;
    bool m_suggestion_groups_isSet;
    bool m_suggestion_groups_isValid;
