...
public:
    ...
    QString getSearchKind() const;
    void setSearchKind(const QString &search_kind);
    bool is_search_kind_Set() const;
    bool is_search_kind_Valid() const;
...
private:
    ...
    QString m_search_kind;
    bool m_search_kind_isSet;
    bool m_search_kind_isValid;
