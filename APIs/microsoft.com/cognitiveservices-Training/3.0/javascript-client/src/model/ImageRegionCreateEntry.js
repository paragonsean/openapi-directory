...
class ImageRegionCreateEntry {
     ...
     */
    constructor(height, imageId, left, tagId, top, width) { 
        
        ImageRegionCreateEntry.initialize(this, height, imageId, left, tagId, top, width);
    }
     ...
     */
    static initialize(obj, height, imageId, left, tagId, top, width) { 
        obj['height'] = height;
        obj['imageId'] = imageId;
        obj['left'] = left;
        obj['tagId'] = tagId;
    ...
    static validateJSON(data) {
        ...
        for (const property of ImageRegionCreateEntry.RequiredProperties) {
...
ImageRegionCreateEntry.RequiredProperties = ["height", "imageId", "left", "tagId", "top", "width"];
