...
void OAIExport::initializeModel() {
    ...
    m_newer_version_available_isSet = false;
    m_newer_version_available_isValid = false;
...
void OAIExport::fromJsonObject(QJsonObject json) {
    ...
    m_newer_version_available_isValid = ::OpenAPI::fromJsonValue(m_newer_version_available, json[QString("newerVersionAvailable")]);
    m_newer_version_available_isSet = !json[QString("newerVersionAvailable")].isNull() && m_newer_version_available_isValid;
...
QJsonObject OAIExport::asJsonObject() const {
    ...
    if (m_newer_version_available_isSet) {
        obj.insert(QString("newerVersionAvailable"), ::OpenAPI::toJsonValue(m_newer_version_available));
    }
    if (m_platform_isSet) {
...
bool OAIExport::isNewerVersionAvailable() const {
    return m_newer_version_available;
}
void OAIExport::setNewerVersionAvailable(const bool &newer_version_available) {
    m_newer_version_available = newer_version_available;
    m_newer_version_available_isSet = true;
}

bool OAIExport::is_newer_version_available_Set() const{
    return m_newer_version_available_isSet;
}

bool OAIExport::is_newer_version_available_Valid() const{
    return m_newer_version_available_isValid;
}
