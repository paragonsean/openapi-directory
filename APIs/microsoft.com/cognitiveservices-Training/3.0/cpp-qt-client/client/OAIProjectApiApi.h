...
public:
    ...
    * @param[in]  target_export_platforms QList<QString> [optional]
    */
    virtual void createProject(const QString &name, const QString &training_key, const ::OpenAPI::OptionalParam<QString> &description = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &domain_id = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &classification_type = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QList<QString>> &target_export_platforms = ::OpenAPI::OptionalParam<QList<QString>>());
    ...
    * @param[in]  project_id QString [required]
    * @param[in]  iteration_id QString [required]
    * @param[in]  publish_name QString [required]
    * @param[in]  prediction_id QString [required]
    * @param[in]  training_key QString [required]
    */
    virtual void publishIteration(const QString &project_id, const QString &iteration_id, const QString &publish_name, const QString &prediction_id, const QString &training_key);

    /**
    * @param[in]  project_id QString [required]
    * @param[in]  training_key QString [required]
    * @param[in]  training_type QString [optional]
    * @param[in]  reserved_budget_in_hours qint32 [optional]
    * @param[in]  force_train bool [optional]
    * @param[in]  notification_email_address QString [optional]
    */
    virtual void trainProject(const QString &project_id, const QString &training_key, const ::OpenAPI::OptionalParam<QString> &training_type = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<qint32> &reserved_budget_in_hours = ::OpenAPI::OptionalParam<qint32>(), const ::OpenAPI::OptionalParam<bool> &force_train = ::OpenAPI::OptionalParam<bool>(), const ::OpenAPI::OptionalParam<QString> &notification_email_address = ::OpenAPI::OptionalParam<QString>());
    ...
    * @param[in]  training_key QString [required]
    */
    virtual void unpublishIteration(const QString &project_id, const QString &iteration_id, const QString &training_key);
...
private:
    ...
    void publishIterationCallback(OAIHttpRequestWorker *worker);
    void trainProjectCallback(OAIHttpRequestWorker *worker);
    void unpublishIterationCallback(OAIHttpRequestWorker *worker);
...
Q_SIGNALS:
    ...
    void publishIterationSignal(bool summary);
    void trainProjectSignal(OAIIteration summary);
    void unpublishIterationSignal();
    ...
    void publishIterationSignalFull(OAIHttpRequestWorker *worker, bool summary);
    void trainProjectSignalFull(OAIHttpRequestWorker *worker, OAIIteration summary);
    void unpublishIterationSignalFull(OAIHttpRequestWorker *worker);
    ...
    Q_DECL_DEPRECATED_X("Use publishIterationSignalError() instead")
    void publishIterationSignalE(bool summary, QNetworkReply::NetworkError error_type, QString error_str);
    void publishIterationSignalError(bool summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use unpublishIterationSignalError() instead")
    void unpublishIterationSignalE(QNetworkReply::NetworkError error_type, QString error_str);
    void unpublishIterationSignalError(QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use publishIterationSignalErrorFull() instead")
    void publishIterationSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void publishIterationSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use unpublishIterationSignalErrorFull() instead")
    void unpublishIterationSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void unpublishIterationSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
