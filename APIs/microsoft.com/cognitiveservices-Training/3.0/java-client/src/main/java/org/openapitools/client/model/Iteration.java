...
public class Iteration {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(classificationType, created, domainId, exportable, exportableTo, id, lastModified, name, originalPublishResourceId, projectId, publishName, reservedBudgetInHours, status, trainedAt, trainingType);
  }
