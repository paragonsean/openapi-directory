...
public class ImageApiApi {
     ...
     */
    public okhttp3.Call deleteImagesCall(UUID projectId, List<UUID> imageIds, String trainingKey, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call deleteImagesValidateBeforeCall(UUID projectId, List<UUID> imageIds, String trainingKey, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'projectId' is set
        if (projectId == null) {
     ...
     */
    public void deleteImages(UUID projectId, List<UUID> imageIds, String trainingKey) throws ApiException {
     ...
     */
    public ApiResponse<Void> deleteImagesWithHttpInfo(UUID projectId, List<UUID> imageIds, String trainingKey) throws ApiException {
     ...
     */
    public okhttp3.Call deleteImagesAsync(UUID projectId, List<UUID> imageIds, String trainingKey, final ApiCallback<Void> _callback) throws ApiException {
