...
public class ApiClient {
    ...
    private String basePath = "https://southcentralus.api.cognitive.microsoft.com/customvision/v3.0/training";
    ...
    new ServerConfiguration(
      "{Endpoint}/customvision/v3.0/training",
      "No description provided",
      new HashMap<String, ServerVariable>() {{
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://southcentralus.api.cognitive.microsoft.com/customvision/v3.0/training
