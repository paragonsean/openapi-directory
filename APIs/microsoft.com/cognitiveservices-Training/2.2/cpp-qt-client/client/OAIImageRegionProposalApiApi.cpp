...
void OAIImageRegionProposalApiApi::getImageRegionProposals(const QString &project_id, const QString &image_id, const QString &training_key) {
    QString fullPath = QString(_serverConfigs["getImageRegionProposals"][_serverIndices.value("getImageRegionProposals")].URL()+"/{projectId}/images/{imageId}/regionproposals");
