...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CustomVisionTrainingClient.Prediction();
  });
  ...
  describe('Prediction', function() {
    it('should create an instance of Prediction', function() {
      ...
      //var instance = new CustomVisionTrainingClient.Prediction();
      //expect(instance).to.be.a(CustomVisionTrainingClient.Prediction);
    });
