...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CustomVisionTrainingClient.ImageUrlCreateBatch();
  });
  ...
  describe('ImageUrlCreateBatch', function() {
    it('should create an instance of ImageUrlCreateBatch', function() {
      ...
      //var instance = new CustomVisionTrainingClient.ImageUrlCreateBatch();
      //expect(instance).to.be.a(CustomVisionTrainingClient.ImageUrlCreateBatch);
    });
