...
public class Example {
  public static void main(String[] args) {
    ...
    defaultClient.setBasePath("https://southcentralus.api.cognitive.microsoft.com/customvision/v2.2/Training");
...
public class Example {
  public static void main(String[] args) {
    ...
    String trainingKey = "{API Key}"; // String | 
    File imageData = new File("/path/to/file"); // File | Binary image data.
