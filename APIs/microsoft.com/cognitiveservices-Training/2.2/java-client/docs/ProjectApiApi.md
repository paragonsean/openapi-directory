...
| **projectId** | **UUID**| The project id. | |
| **iterationId** | **UUID**| The iteration id. | |
| **platform** | **String**| The target platform. | [enum: CoreML, TensorFlow, DockerFile, ONNX] |
| **trainingKey** | **String**|  | |
| **flavor** | **String**| The flavor of the target platform. | [optional] [enum: Linux, Windows, ONNX10, ONNX12] |
