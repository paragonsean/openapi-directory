...
public class ApiClient {
    ...
    private String basePath = "https://southcentralus.api.cognitive.microsoft.com/customvision/v2.2/Training";
    ...
    new ServerConfiguration(
      "{Endpoint}/customvision/v2.2/Training",
      "No description provided",
      new HashMap<String, ServerVariable>() {{
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://southcentralus.api.cognitive.microsoft.com/customvision/v2.2/Training
