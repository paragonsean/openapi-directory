...
class Image(Model):
    ...
    def __init__(self, created: datetime=None, height: int=None, id: str=None, image_uri: str=None, regions: List[ImageRegion]=None, tags: List[ImageTag]=None, thumbnail_uri: str=None, width: int=None):
