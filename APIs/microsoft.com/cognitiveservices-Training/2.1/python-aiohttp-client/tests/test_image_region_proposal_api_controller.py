...
async def test_get_image_region_proposals(client):
    ...
    response = await client.request(
        method='POST',
        path='/customvision/v2.1/Training/{project_id}/images/{image_id}/regionproposals'.format(project_id='bc3f7dad-5544-468c-8573-3ef04d55463e', image_id='4d6eb844-42ee-42bc-bd6f-c32455ef07c9'),
        headers=headers,
        )
