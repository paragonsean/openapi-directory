...
export default class ProjectApiApi {
    ...
    */
     ...
     * @param {String} projectId The project id
     * @param {String} iterationId The iteration id
     * @param {module:model/String} platform The target platform (coreml or tensorflow)
     * @param {String} trainingKey 
     * @param {Object} opts Optional parameters
     * @param {module:model/String} [flavor] The flavor of the target platform (Windows, Linux, ARM, or GPU)
