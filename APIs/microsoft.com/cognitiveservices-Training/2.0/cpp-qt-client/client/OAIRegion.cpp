...
float OAIRegion::getHeight() const {
    return m_height;
}
void OAIRegion::setHeight(const float &height) {
    m_height = height;
    m_height_isSet = true;
}

bool OAIRegion::is_height_Set() const{
    return m_height_isSet;
}

bool OAIRegion::is_height_Valid() const{
    return m_height_isValid;
}

float OAIRegion::getLeft() const {
    return m_left;
}
void OAIRegion::setLeft(const float &left) {
    m_left = left;
    m_left_isSet = true;
}

bool OAIRegion::is_left_Set() const{
    return m_left_isSet;
}

bool OAIRegion::is_left_Valid() const{
    return m_left_isValid;
}

QString OAIRegion::getTagId() const {
    return m_tag_id;
}
void OAIRegion::setTagId(const QString &tag_id) {
    m_tag_id = tag_id;
    m_tag_id_isSet = true;
}

bool OAIRegion::is_tag_id_Set() const{
    return m_tag_id_isSet;
}

bool OAIRegion::is_tag_id_Valid() const{
    return m_tag_id_isValid;
}

float OAIRegion::getTop() const {
    return m_top;
}
void OAIRegion::setTop(const float &top) {
    m_top = top;
    m_top_isSet = true;
}

bool OAIRegion::is_top_Set() const{
    return m_top_isSet;
}

bool OAIRegion::is_top_Valid() const{
    return m_top_isValid;
}

float OAIRegion::getWidth() const {
    return m_width;
}
void OAIRegion::setWidth(const float &width) {
    m_width = width;
    m_width_isSet = true;
}

bool OAIRegion::is_width_Set() const{
    return m_width_isSet;
}

bool OAIRegion::is_width_Valid() const{
