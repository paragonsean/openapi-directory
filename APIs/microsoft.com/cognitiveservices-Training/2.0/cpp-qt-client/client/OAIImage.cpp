...
QString OAIImage::getImageUri() const {
    return m_image_uri;
}
void OAIImage::setImageUri(const QString &image_uri) {
    m_image_uri = image_uri;
    m_image_uri_isSet = true;
}

bool OAIImage::is_image_uri_Set() const{
    return m_image_uri_isSet;
}

bool OAIImage::is_image_uri_Valid() const{
