...
QString OAIStoredImagePrediction::getImageUri() const {
    return m_image_uri;
}
void OAIStoredImagePrediction::setImageUri(const QString &image_uri) {
    m_image_uri = image_uri;
    m_image_uri_isSet = true;
}

bool OAIStoredImagePrediction::is_image_uri_Set() const{
    return m_image_uri_isSet;
}

bool OAIStoredImagePrediction::is_image_uri_Valid() const{
