...
public class ProjectApiApi {
     ...
     */
    public okhttp3.Call createProjectCall(String name, String trainingKey, String description, UUID domainId, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call createProjectValidateBeforeCall(String name, String trainingKey, String description, UUID domainId, final ApiCallback _callback) throws ApiException {
        ...
        return createProjectCall(name, trainingKey, description, domainId, _callback);
     ...
     */
    public Project createProject(String name, String trainingKey, String description, UUID domainId) throws ApiException {
        ApiResponse<Project> localVarResp = createProjectWithHttpInfo(name, trainingKey, description, domainId);
     ...
     */
    public ApiResponse<Project> createProjectWithHttpInfo(String name, String trainingKey, String description, UUID domainId) throws ApiException {
        okhttp3.Call localVarCall = createProjectValidateBeforeCall(name, trainingKey, description, domainId, null);
     ...
     */
    public okhttp3.Call createProjectAsync(String name, String trainingKey, String description, UUID domainId, final ApiCallback<Project> _callback) throws ApiException {

        okhttp3.Call localVarCall = createProjectValidateBeforeCall(name, trainingKey, description, domainId, _callback);
        Type localVarReturnType = new TypeToken<Project>(){}.getType();
