...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TrainingApi.ImageRegionCreateEntry();
  });
  ...
  describe('ImageRegionCreateEntry', function() {
    it('should create an instance of ImageRegionCreateEntry', function() {
      ...
      //var instance = new TrainingApi.ImageRegionCreateEntry();
      //expect(instance).to.be.a(TrainingApi.ImageRegionCreateEntry);
    });
