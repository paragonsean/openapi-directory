...
class ImageCreateResult(Model):
    ...
    def status(self, status):
        ...
        :type status: str
        """
        allowed_values = ["OK", "OKDuplicate", "ErrorSource", "ErrorImageFormat", "ErrorImageSize", "ErrorStorage", "ErrorLimitExceed", "ErrorTagLimitExceed", "ErrorRegionLimitExceed", "ErrorUnknown"]  # noqa: E501
