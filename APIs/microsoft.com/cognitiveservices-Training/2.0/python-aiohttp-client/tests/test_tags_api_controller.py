...
async def test_create_tag(client):
    ...
    response = await client.request(
        method='POST',
        path='/customvision/v2.0/Training/projects/{project_id}/tags'.format(project_id='bc3f7dad-5544-468c-8573-3ef04d55463e'),
        headers=headers,
        params=params,
        )
...
async def test_delete_tag(client):
    ...
    response = await client.request(
        method='DELETE',
        path='/customvision/v2.0/Training/projects/{project_id}/tags/{tag_id}'.format(project_id='bc3f7dad-5544-468c-8573-3ef04d55463e', tag_id='9e27bc1b-7ae7-4e3b-a4e5-36153479dc01'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
