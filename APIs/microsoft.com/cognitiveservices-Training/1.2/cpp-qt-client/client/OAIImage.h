...
public:
    ...
    QList<OAIPredictionTag> getPredictions() const;
    void setPredictions(const QList<OAIPredictionTag> &predictions);
...
private:
    ...
    QList<OAIPredictionTag> m_predictions;
