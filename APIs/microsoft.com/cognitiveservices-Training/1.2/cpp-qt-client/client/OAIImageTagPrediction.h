...
/*
 * OAIImageTagPrediction.h
 *
 * 
 */

#ifndef OAIImageTagPrediction_H
#define OAIImageTagPrediction_H
...
class OAIImageTagPrediction : public OAIObject {
public:
    OAIImageTagPrediction();
    OAIImageTagPrediction(QString json);
    ~OAIImageTagPrediction() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIImageTagPrediction)

#endif // OAIImageTagPrediction_H
