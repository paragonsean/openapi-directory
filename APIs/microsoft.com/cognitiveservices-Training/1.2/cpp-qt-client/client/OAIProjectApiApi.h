...
public:
    ...
    */
    virtual void createProject(const QString &name, const QString &training_key, const ::OpenAPI::OptionalParam<QString> &description = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &domain_id = ::OpenAPI::OptionalParam<QString>());
    ...
    * @param[in]  training_key QString [required]
    */
    virtual void exportIteration(const QString &project_id, const QString &iteration_id, const QString &platform, const QString &training_key);
    ...
    * @param[in]  project_id QString [required]
    * @param[in]  iteration_id QString [required]
    * @param[in]  threshold float [required]
    * @param[in]  training_key QString [required]
    */
    virtual void getIterationPerformance(const QString &project_id, const QString &iteration_id, const float &threshold, const QString &training_key);
