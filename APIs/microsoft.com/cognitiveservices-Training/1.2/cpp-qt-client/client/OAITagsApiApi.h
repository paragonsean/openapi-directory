...
Q_SIGNALS:
    ...
    void getTagsSignal(OAITagList summary);
    ...
    void getTagsSignalFull(OAIHttpRequestWorker *worker, OAITagList summary);
    ...
    void getTagsSignalE(OAITagList summary, QNetworkReply::NetworkError error_type, QString error_str);
    void getTagsSignalError(OAITagList summary, QNetworkReply::NetworkError error_type, const QString &error_str);
