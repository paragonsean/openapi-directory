...
QList<OAIPredictionTag> OAIImage::getPredictions() const {
    return m_predictions;
}
void OAIImage::setPredictions(const QList<OAIPredictionTag> &predictions) {
    m_predictions = predictions;
    m_predictions_isSet = true;
}

bool OAIImage::is_predictions_Set() const{
    return m_predictions_isSet;
}

bool OAIImage::is_predictions_Valid() const{
