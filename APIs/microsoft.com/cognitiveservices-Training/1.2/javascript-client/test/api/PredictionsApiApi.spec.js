...
(function(root, factory) {
  ...
  describe('PredictionsApiApi', function() {
    ...
    describe('queryPredictionResults', function() {
      it('should call queryPredictionResults successfully', function(done) {
        //uncomment below and update the code to test queryPredictionResults
        //instance.queryPredictionResults(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
