...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TrainingApi.ImageTagPrediction();
  });
  ...
  describe('ImageTagPrediction', function() {
    it('should create an instance of ImageTagPrediction', function() {
      // uncomment below and update the code to test ImageTagPrediction
      //var instance = new TrainingApi.ImageTagPrediction();
      //expect(instance).to.be.a(TrainingApi.ImageTagPrediction);
    });
