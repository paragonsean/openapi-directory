...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TrainingApi.ImagePredictionResult();
  });
  ...
  describe('ImagePredictionResult', function() {
    it('should create an instance of ImagePredictionResult', function() {
      // uncomment below and update the code to test ImagePredictionResult
      //var instance = new TrainingApi.ImagePredictionResult();
      //expect(instance).to.be.a(TrainingApi.ImagePredictionResult);
    });
