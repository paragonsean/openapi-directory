...
export default class PredictionsApiApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the queryPredictionResults operation.
     * @callback module:api/PredictionsApiApi~queryPredictionResultsCallback
     * @param {String} error Error message, if any.
     * @param {module:model/PredictionQuery} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:api/PredictionsApiApi~queryPredictionResultsCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/PredictionQuery}
     */
    queryPredictionResults(projectId, trainingKey, predictionQueryToken, callback) {
      let postBody = predictionQueryToken;
      // verify the required parameter 'projectId' is set
      if (projectId === undefined || projectId === null) {
        throw new Error("Missing the required parameter 'projectId' when calling queryPredictionResults");
      }
      // verify the required parameter 'trainingKey' is set
      if (trainingKey === undefined || trainingKey === null) {
        throw new Error("Missing the required parameter 'trainingKey' when calling queryPredictionResults");
      }
      // verify the required parameter 'predictionQueryToken' is set
      if (predictionQueryToken === undefined || predictionQueryToken === null) {
        throw new Error("Missing the required parameter 'predictionQueryToken' when calling queryPredictionResults");
      }
      ...
      let returnType = PredictionQuery;
      return this.apiClient.callApi(
     ...
     * @param {String} error Error message, if any.
     * @param {module:model/ImagePredictionResult} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * data is of type: {@link module:model/ImagePredictionResult}
     */
    quickTestImage(projectId, trainingKey, imageData, opts, callback) {
      ...
      let accepts = ['application/json', 'application/xml', 'text/json', 'text/xml'];
      let returnType = ImagePredictionResult;
      return this.apiClient.callApi(
