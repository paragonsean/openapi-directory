...
export default class ImageApiApi {
    ...
    */
     ...
     * @param {Array.<String>} [tagIds] An list of tags ids to filter the images. Defaults to all tagged images when null. Limited to 20
    ...
    /**
     * Callback function to receive the result of the postImageTags operation.
     * @callback module:api/ImageApiApi~postImageTagsCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:api/ImageApiApi~postImageTagsCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/ImageTagCreateSummary}
     */
    postImageTags(projectId, trainingKey, imageTagCreateBatch, callback) {
      let postBody = imageTagCreateBatch;
      // verify the required parameter 'projectId' is set
      if (projectId === undefined || projectId === null) {
        throw new Error("Missing the required parameter 'projectId' when calling postImageTags");
      }
      // verify the required parameter 'trainingKey' is set
      if (trainingKey === undefined || trainingKey === null) {
        throw new Error("Missing the required parameter 'trainingKey' when calling postImageTags");
      }
      // verify the required parameter 'imageTagCreateBatch' is set
      if (imageTagCreateBatch === undefined || imageTagCreateBatch === null) {
        throw new Error("Missing the required parameter 'imageTagCreateBatch' when calling postImageTags");
      }
