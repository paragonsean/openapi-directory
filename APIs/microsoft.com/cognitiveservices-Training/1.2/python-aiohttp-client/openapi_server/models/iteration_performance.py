...
class IterationPerformance(Model):
    ...
    def __init__(self, per_tag_performance: List[TagPerformance]=None, precision: float=None, precision_std_deviation: float=None, recall: float=None, recall_std_deviation: float=None):
