...
| [**queryPredictionResults**](PredictionsApiApi.md#queryPredictionResults) | **POST** /projects/{projectId}/predictions/query | Get images that were sent to your prediction endpoint |
...
<a id="queryPredictionResults"></a>
# **queryPredictionResults**
> PredictionQuery queryPredictionResults(projectId, trainingKey, predictionQueryToken)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      PredictionQuery result = apiInstance.queryPredictionResults(projectId, trainingKey, predictionQueryToken);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling PredictionsApiApi#queryPredictionResults");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
[**PredictionQuery**](PredictionQuery.md)
...
# **quickTestImage**
> ImagePredictionResult quickTestImage(projectId, trainingKey, imageData, iterationId)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ImagePredictionResult result = apiInstance.quickTestImage(projectId, trainingKey, imageData, iterationId);
      System.out.println(result);
    } catch (ApiException e) {
...
[**ImagePredictionResult**](ImagePredictionResult.md)
...
# **quickTestImageUrl**
> ImagePredictionResult quickTestImageUrl(projectId, trainingKey, imageUrl, iterationId)
...
public class Example {
  public static void main(String[] args) {
    ...
    UUID iterationId = UUID.fromString("fe1e83c4-6f50-4899-9544-6bb08cf0e15a"); // UUID | Optional. Specifies the id of a particular iteration to evaluate against.              The default iteration for the project will be used when not specified.
    try {
      ImagePredictionResult result = apiInstance.quickTestImageUrl(projectId, trainingKey, imageUrl, iterationId);
      System.out.println(result);
    } catch (ApiException e) {
