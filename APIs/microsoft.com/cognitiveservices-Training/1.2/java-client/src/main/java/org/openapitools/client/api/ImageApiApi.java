...
public class ImageApiApi {
     ...
     * @param tagIds An list of tags ids to filter the images. Defaults to all tagged images when null. Limited to 20 (optional)
     ...
     */
    public okhttp3.Call postImageTagsCall(UUID projectId, String trainingKey, ImageTagCreateBatch imageTagCreateBatch, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call postImageTagsValidateBeforeCall(UUID projectId, String trainingKey, ImageTagCreateBatch imageTagCreateBatch, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'projectId' is set
        if (projectId == null) {
            throw new ApiException("Missing the required parameter 'projectId' when calling postImageTags(Async)");
        }

        // verify the required parameter 'trainingKey' is set
        if (trainingKey == null) {
            throw new ApiException("Missing the required parameter 'trainingKey' when calling postImageTags(Async)");
        }

        // verify the required parameter 'imageTagCreateBatch' is set
        if (imageTagCreateBatch == null) {
            throw new ApiException("Missing the required parameter 'imageTagCreateBatch' when calling postImageTags(Async)");
        }

        return postImageTagsCall(projectId, trainingKey, imageTagCreateBatch, _callback);
     ...
     */
    public ImageTagCreateSummary postImageTags(UUID projectId, String trainingKey, ImageTagCreateBatch imageTagCreateBatch) throws ApiException {
        ApiResponse<ImageTagCreateSummary> localVarResp = postImageTagsWithHttpInfo(projectId, trainingKey, imageTagCreateBatch);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<ImageTagCreateSummary> postImageTagsWithHttpInfo(UUID projectId, String trainingKey, ImageTagCreateBatch imageTagCreateBatch) throws ApiException {
        okhttp3.Call localVarCall = postImageTagsValidateBeforeCall(projectId, trainingKey, imageTagCreateBatch, null);
     ...
     */
    public okhttp3.Call postImageTagsAsync(UUID projectId, String trainingKey, ImageTagCreateBatch imageTagCreateBatch, final ApiCallback<ImageTagCreateSummary> _callback) throws ApiException {

        okhttp3.Call localVarCall = postImageTagsValidateBeforeCall(projectId, trainingKey, imageTagCreateBatch, _callback);
        Type localVarReturnType = new TypeToken<ImageTagCreateSummary>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
