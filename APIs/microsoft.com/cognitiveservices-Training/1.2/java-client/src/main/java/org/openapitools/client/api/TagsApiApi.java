...
public class TagsApiApi {
     ...
     */
    public TagList getTags(UUID projectId, String trainingKey, UUID iterationId) throws ApiException {
        ApiResponse<TagList> localVarResp = getTagsWithHttpInfo(projectId, trainingKey, iterationId);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<TagList> getTagsWithHttpInfo(UUID projectId, String trainingKey, UUID iterationId) throws ApiException {
     ...
     */
    public okhttp3.Call getTagsAsync(UUID projectId, String trainingKey, UUID iterationId, final ApiCallback<TagList> _callback) throws ApiException {
