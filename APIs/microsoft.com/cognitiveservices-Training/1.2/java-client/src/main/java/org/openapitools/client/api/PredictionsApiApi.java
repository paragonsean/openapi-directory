...
import java.io.File;
import org.openapitools.client.model.ImagePredictionResult;
import org.openapitools.client.model.ImageUrl;
import org.openapitools.client.model.PredictionQuery;
...
public class PredictionsApiApi {
    ...
    /**
     * Build call for queryPredictionResults
     * @param projectId The project id (required)
     * @param trainingKey  (required)
     ...
     */
    public okhttp3.Call queryPredictionResultsCall(UUID projectId, String trainingKey, PredictionQueryToken predictionQueryToken, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call queryPredictionResultsValidateBeforeCall(UUID projectId, String trainingKey, PredictionQueryToken predictionQueryToken, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'projectId' is set
        if (projectId == null) {
            throw new ApiException("Missing the required parameter 'projectId' when calling queryPredictionResults(Async)");
        }

        // verify the required parameter 'trainingKey' is set
        if (trainingKey == null) {
            throw new ApiException("Missing the required parameter 'trainingKey' when calling queryPredictionResults(Async)");
        }

        // verify the required parameter 'predictionQueryToken' is set
        if (predictionQueryToken == null) {
            throw new ApiException("Missing the required parameter 'predictionQueryToken' when calling queryPredictionResults(Async)");
        }

        return queryPredictionResultsCall(projectId, trainingKey, predictionQueryToken, _callback);
     ...
     */
    public PredictionQuery queryPredictionResults(UUID projectId, String trainingKey, PredictionQueryToken predictionQueryToken) throws ApiException {
        ApiResponse<PredictionQuery> localVarResp = queryPredictionResultsWithHttpInfo(projectId, trainingKey, predictionQueryToken);
     ...
     * @param trainingKey  (required)
     * @param predictionQueryToken Parameters used to query the predictions. Limited to combining 2 tags (required)
     * @return ApiResponse&lt;PredictionQuery&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<PredictionQuery> queryPredictionResultsWithHttpInfo(UUID projectId, String trainingKey, PredictionQueryToken predictionQueryToken) throws ApiException {
        okhttp3.Call localVarCall = queryPredictionResultsValidateBeforeCall(projectId, trainingKey, predictionQueryToken, null);
        Type localVarReturnType = new TypeToken<PredictionQuery>(){}.getType();
     ...
     */
    public okhttp3.Call queryPredictionResultsAsync(UUID projectId, String trainingKey, PredictionQueryToken predictionQueryToken, final ApiCallback<PredictionQuery> _callback) throws ApiException {

        okhttp3.Call localVarCall = queryPredictionResultsValidateBeforeCall(projectId, trainingKey, predictionQueryToken, _callback);
        Type localVarReturnType = new TypeToken<PredictionQuery>(){}.getType();
     ...
     */
    public ImagePredictionResult quickTestImage(UUID projectId, String trainingKey, File imageData, UUID iterationId) throws ApiException {
        ApiResponse<ImagePredictionResult> localVarResp = quickTestImageWithHttpInfo(projectId, trainingKey, imageData, iterationId);
        return localVarResp.getData();
    }
     ...
     * @param imageData  (required)
     * @param iterationId Optional. Specifies the id of a particular iteration to evaluate against.              The default iteration for the project will be used when not specified. (optional)
     * @return ApiResponse&lt;ImagePredictionResult&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<ImagePredictionResult> quickTestImageWithHttpInfo(UUID projectId, String trainingKey, File imageData, UUID iterationId) throws ApiException {
        okhttp3.Call localVarCall = quickTestImageValidateBeforeCall(projectId, trainingKey, imageData, iterationId, null);
        Type localVarReturnType = new TypeToken<ImagePredictionResult>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call quickTestImageAsync(UUID projectId, String trainingKey, File imageData, UUID iterationId, final ApiCallback<ImagePredictionResult> _callback) throws ApiException {
     ...
     */
    public ImagePredictionResult quickTestImageUrl(UUID projectId, String trainingKey, ImageUrl imageUrl, UUID iterationId) throws ApiException {
        ApiResponse<ImagePredictionResult> localVarResp = quickTestImageUrlWithHttpInfo(projectId, trainingKey, imageUrl, iterationId);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<ImagePredictionResult> quickTestImageUrlWithHttpInfo(UUID projectId, String trainingKey, ImageUrl imageUrl, UUID iterationId) throws ApiException {
     ...
     */
    public okhttp3.Call quickTestImageUrlAsync(UUID projectId, String trainingKey, ImageUrl imageUrl, UUID iterationId, final ApiCallback<ImagePredictionResult> _callback) throws ApiException {
