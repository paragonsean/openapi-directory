...
public class ProjectApiApi {
     ...
     */
    public okhttp3.Call exportIterationCall(UUID projectId, UUID iterationId, String platform, String trainingKey, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call exportIterationValidateBeforeCall(UUID projectId, UUID iterationId, String platform, String trainingKey, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'projectId' is set
        if (projectId == null) {
        ...
        return exportIterationCall(projectId, iterationId, platform, trainingKey, _callback);
     ...
     */
    public Export exportIteration(UUID projectId, UUID iterationId, String platform, String trainingKey) throws ApiException {
        ApiResponse<Export> localVarResp = exportIterationWithHttpInfo(projectId, iterationId, platform, trainingKey);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<Export> exportIterationWithHttpInfo(UUID projectId, UUID iterationId, String platform, String trainingKey) throws ApiException {
        okhttp3.Call localVarCall = exportIterationValidateBeforeCall(projectId, iterationId, platform, trainingKey, null);
     ...
     */
    public okhttp3.Call exportIterationAsync(UUID projectId, UUID iterationId, String platform, String trainingKey, final ApiCallback<Export> _callback) throws ApiException {

        okhttp3.Call localVarCall = exportIterationValidateBeforeCall(projectId, iterationId, platform, trainingKey, _callback);
        Type localVarReturnType = new TypeToken<Export>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     * @param projectId The project id (required)
     * @param iterationId The id of the trained iteration (required)
     * @param threshold The 0 to 1 threshold to determine positive prediction (required)
     * @param trainingKey  (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    public okhttp3.Call getIterationPerformanceCall(UUID projectId, UUID iterationId, Float threshold, String trainingKey, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getIterationPerformanceValidateBeforeCall(UUID projectId, UUID iterationId, Float threshold, String trainingKey, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'projectId' is set
        if (projectId == null) {
        ...
        if (threshold == null) {
            throw new ApiException("Missing the required parameter 'threshold' when calling getIterationPerformance(Async)");
        }
        ...
        return getIterationPerformanceCall(projectId, iterationId, threshold, trainingKey, _callback);
     ...
     */
    public IterationPerformance getIterationPerformance(UUID projectId, UUID iterationId, Float threshold, String trainingKey) throws ApiException {
        ApiResponse<IterationPerformance> localVarResp = getIterationPerformanceWithHttpInfo(projectId, iterationId, threshold, trainingKey);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<IterationPerformance> getIterationPerformanceWithHttpInfo(UUID projectId, UUID iterationId, Float threshold, String trainingKey) throws ApiException {
        okhttp3.Call localVarCall = getIterationPerformanceValidateBeforeCall(projectId, iterationId, threshold, trainingKey, null);
        Type localVarReturnType = new TypeToken<IterationPerformance>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Get detailed performance information about a trained iteration (asynchronously)
     * 
     * @param projectId The project id (required)
     * @param iterationId The id of the trained iteration (required)
     * @param threshold The 0 to 1 threshold to determine positive prediction (required)
     ...
     */
    public okhttp3.Call getIterationPerformanceAsync(UUID projectId, UUID iterationId, Float threshold, String trainingKey, final ApiCallback<IterationPerformance> _callback) throws ApiException {

        okhttp3.Call localVarCall = getIterationPerformanceValidateBeforeCall(projectId, iterationId, threshold, trainingKey, _callback);
        Type localVarReturnType = new TypeToken<IterationPerformance>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
