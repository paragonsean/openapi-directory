...
public:
    ...
    bool isDrModeEnabled() const;
    void setDrModeEnabled(const bool &dr_mode_enabled);
    bool is_dr_mode_enabled_Set() const;
    bool is_dr_mode_enabled_Valid() const;
...
private:
    ...
    bool m_dr_mode_enabled;
    bool m_dr_mode_enabled_isSet;
    bool m_dr_mode_enabled_isValid;
