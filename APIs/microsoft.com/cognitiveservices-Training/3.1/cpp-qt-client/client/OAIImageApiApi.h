...
public:
    ...
    * @param[in]  all_images bool [optional]
    * @param[in]  all_iterations bool [optional]
    */
    virtual void deleteImages(const QString &project_id, const QString &training_key, const ::OpenAPI::OptionalParam<QList<QString>> &image_ids = ::OpenAPI::OptionalParam<QList<QString>>(), const ::OpenAPI::OptionalParam<bool> &all_images = ::OpenAPI::OptionalParam<bool>(), const ::OpenAPI::OptionalParam<bool> &all_iterations = ::OpenAPI::OptionalParam<bool>());
    ...
    * @param[in]  training_key QString [required]
    * @param[in]  oai_tag_filter OAITagFilter [required]
    */
    virtual void querySuggestedImageCount(const QString &project_id, const QString &iteration_id, const QString &training_key, const OAITagFilter &oai_tag_filter);

    /**
    * @param[in]  project_id QString [required]
    * @param[in]  iteration_id QString [required]
    * @param[in]  training_key QString [required]
    * @param[in]  oai_suggested_tag_and_region_query_token OAISuggestedTagAndRegionQueryToken [required]
    */
    virtual void querySuggestedImages(const QString &project_id, const QString &iteration_id, const QString &training_key, const OAISuggestedTagAndRegionQueryToken &oai_suggested_tag_and_region_query_token);
...
private:
    ...
    void querySuggestedImageCountCallback(OAIHttpRequestWorker *worker);
    void querySuggestedImagesCallback(OAIHttpRequestWorker *worker);
...
Q_SIGNALS:
    ...
    void querySuggestedImageCountSignal(QMap<QString, qint32> summary);
    void querySuggestedImagesSignal(OAISuggestedTagAndRegionQuery summary);
    ...
    void querySuggestedImageCountSignalFull(OAIHttpRequestWorker *worker, QMap<QString, qint32> summary);
    void querySuggestedImagesSignalFull(OAIHttpRequestWorker *worker, OAISuggestedTagAndRegionQuery summary);
    ...
    Q_DECL_DEPRECATED_X("Use querySuggestedImageCountSignalError() instead")
    void querySuggestedImageCountSignalE(QMap<QString, qint32> summary, QNetworkReply::NetworkError error_type, QString error_str);
    void querySuggestedImageCountSignalError(QMap<QString, qint32> summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use querySuggestedImagesSignalError() instead")
    void querySuggestedImagesSignalE(OAISuggestedTagAndRegionQuery summary, QNetworkReply::NetworkError error_type, QString error_str);
    void querySuggestedImagesSignalError(OAISuggestedTagAndRegionQuery summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use querySuggestedImageCountSignalErrorFull() instead")
    void querySuggestedImageCountSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void querySuggestedImageCountSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use querySuggestedImagesSignalErrorFull() instead")
    void querySuggestedImagesSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void querySuggestedImagesSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
