...
# **createProject**
> Project createProject(name, trainingKey, description, domainId, classificationType, targetExportPlatforms)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      Project result = apiInstance.createProject(name, trainingKey, description, domainId, classificationType, targetExportPlatforms);
...
public class Example {
  public static void main(String[] args) {
    ...
    String trainingKey = "{API Key}"; // String | API key.
    try {
      Boolean result = apiInstance.publishIteration(projectId, iterationId, publishName, predictionId, trainingKey);
      System.out.println(result);
    } catch (ApiException e) {
...
<a id="trainProject"></a>
# **trainProject**
> Iteration trainProject(projectId, trainingKey, trainingType, reservedBudgetInHours, forceTrain, notificationEmailAddress)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      Iteration result = apiInstance.trainProject(projectId, trainingKey, trainingType, reservedBudgetInHours, forceTrain, notificationEmailAddress);
      System.out.println(result);
    } catch (ApiException e) {
...
public class Example {
  public static void main(String[] args) {
    ...
    String trainingKey = "{API Key}"; // String | API key.
    try {
      apiInstance.unpublishIteration(projectId, iterationId, trainingKey);
    } catch (ApiException e) {
