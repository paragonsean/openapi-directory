...
# **quickTestImage**
> ImagePrediction quickTestImage(projectId, trainingKey, imageData, iterationId, store)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ImagePrediction result = apiInstance.quickTestImage(projectId, trainingKey, imageData, iterationId, store);
      System.out.println(result);
    } catch (ApiException e) {
...
# **quickTestImageUrl**
> ImagePrediction quickTestImageUrl(projectId, trainingKey, imageUrl, iterationId, store)
...
public class Example {
  public static void main(String[] args) {
    ...
    Boolean store = true; // Boolean | Optional. Specifies whether or not to store the result of this prediction. The default is true, to store.
    try {
      ImagePrediction result = apiInstance.quickTestImageUrl(projectId, trainingKey, imageUrl, iterationId, store);
      System.out.println(result);
    } catch (ApiException e) {
