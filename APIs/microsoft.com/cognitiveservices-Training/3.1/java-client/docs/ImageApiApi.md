...
<a id="deleteImages"></a>
# **deleteImages**
> deleteImages(projectId, trainingKey, imageIds, allImages, allIterations)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      apiInstance.deleteImages(projectId, trainingKey, imageIds, allImages, allIterations);
    } catch (ApiException e) {
...
> Map&lt;String, Integer&gt; querySuggestedImageCount(projectId, iterationId, trainingKey, tagFilter)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      Map<String, Integer> result = apiInstance.querySuggestedImageCount(projectId, iterationId, trainingKey, tagFilter);
      System.out.println(result);
    } catch (ApiException e) {
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      SuggestedTagAndRegionQuery result = apiInstance.querySuggestedImages(projectId, iterationId, trainingKey, suggestedTagAndRegionQueryToken);
      System.out.println(result);
    } catch (ApiException e) {
