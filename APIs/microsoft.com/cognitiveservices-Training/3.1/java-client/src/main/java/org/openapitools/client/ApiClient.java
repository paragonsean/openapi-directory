...
public class ApiClient {
    ...
    private String basePath = "https://southcentralus.api.cognitive.microsoft.com/customvision/v3.1/training";
    ...
    new ServerConfiguration(
      "{Endpoint}/customvision/v3.1/training",
      "No description provided",
      new HashMap<String, ServerVariable>() {{
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/3.1/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://southcentralus.api.cognitive.microsoft.com/customvision/v3.1/training
