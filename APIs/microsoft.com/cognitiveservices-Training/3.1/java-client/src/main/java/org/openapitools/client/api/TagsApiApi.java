...
public class TagsApiApi {
     ...
     * @param type Optional type for the tag. (optional)
     ...
     */
    public okhttp3.Call createTagCall(UUID projectId, String name, String trainingKey, String description, String type, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call createTagValidateBeforeCall(UUID projectId, String name, String trainingKey, String description, String type, final ApiCallback _callback) throws ApiException {
        ...
        return createTagCall(projectId, name, trainingKey, description, type, _callback);
     ...
     */
    public Tag createTag(UUID projectId, String name, String trainingKey, String description, String type) throws ApiException {
        ApiResponse<Tag> localVarResp = createTagWithHttpInfo(projectId, name, trainingKey, description, type);
     ...
     */
    public ApiResponse<Tag> createTagWithHttpInfo(UUID projectId, String name, String trainingKey, String description, String type) throws ApiException {
        okhttp3.Call localVarCall = createTagValidateBeforeCall(projectId, name, trainingKey, description, type, null);
     ...
     */
    public okhttp3.Call createTagAsync(UUID projectId, String name, String trainingKey, String description, String type, final ApiCallback<Tag> _callback) throws ApiException {

        okhttp3.Call localVarCall = createTagValidateBeforeCall(projectId, name, trainingKey, description, type, _callback);
        Type localVarReturnType = new TypeToken<Tag>(){}.getType();
