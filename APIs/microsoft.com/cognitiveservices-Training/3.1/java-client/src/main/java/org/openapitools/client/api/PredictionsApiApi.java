...
public class PredictionsApiApi {
     ...
     */
    public okhttp3.Call deletePredictionCall(UUID projectId, List<UUID> ids, String trainingKey, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call deletePredictionValidateBeforeCall(UUID projectId, List<UUID> ids, String trainingKey, final ApiCallback _callback) throws ApiException {
     ...
     */
    public void deletePrediction(UUID projectId, List<UUID> ids, String trainingKey) throws ApiException {
     ...
     */
    public ApiResponse<Void> deletePredictionWithHttpInfo(UUID projectId, List<UUID> ids, String trainingKey) throws ApiException {
     ...
     */
    public okhttp3.Call deletePredictionAsync(UUID projectId, List<UUID> ids, String trainingKey, final ApiCallback<Void> _callback) throws ApiException {
     ...
     */
    public okhttp3.Call quickTestImageCall(UUID projectId, String trainingKey, File imageData, UUID iterationId, Boolean store, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call quickTestImageValidateBeforeCall(UUID projectId, String trainingKey, File imageData, UUID iterationId, Boolean store, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'projectId' is set
        if (projectId == null) {
        ...
        return quickTestImageCall(projectId, trainingKey, imageData, iterationId, store, _callback);
     ...
     */
    public ImagePrediction quickTestImage(UUID projectId, String trainingKey, File imageData, UUID iterationId, Boolean store) throws ApiException {
        ApiResponse<ImagePrediction> localVarResp = quickTestImageWithHttpInfo(projectId, trainingKey, imageData, iterationId, store);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<ImagePrediction> quickTestImageWithHttpInfo(UUID projectId, String trainingKey, File imageData, UUID iterationId, Boolean store) throws ApiException {
        okhttp3.Call localVarCall = quickTestImageValidateBeforeCall(projectId, trainingKey, imageData, iterationId, store, null);
     ...
     */
    public okhttp3.Call quickTestImageAsync(UUID projectId, String trainingKey, File imageData, UUID iterationId, Boolean store, final ApiCallback<ImagePrediction> _callback) throws ApiException {

        okhttp3.Call localVarCall = quickTestImageValidateBeforeCall(projectId, trainingKey, imageData, iterationId, store, _callback);
        Type localVarReturnType = new TypeToken<ImagePrediction>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     */
    public okhttp3.Call quickTestImageUrlCall(UUID projectId, String trainingKey, ImageUrl imageUrl, UUID iterationId, Boolean store, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call quickTestImageUrlValidateBeforeCall(UUID projectId, String trainingKey, ImageUrl imageUrl, UUID iterationId, Boolean store, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'projectId' is set
        if (projectId == null) {
        ...
        return quickTestImageUrlCall(projectId, trainingKey, imageUrl, iterationId, store, _callback);
     ...
     */
    public ImagePrediction quickTestImageUrl(UUID projectId, String trainingKey, ImageUrl imageUrl, UUID iterationId, Boolean store) throws ApiException {
        ApiResponse<ImagePrediction> localVarResp = quickTestImageUrlWithHttpInfo(projectId, trainingKey, imageUrl, iterationId, store);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<ImagePrediction> quickTestImageUrlWithHttpInfo(UUID projectId, String trainingKey, ImageUrl imageUrl, UUID iterationId, Boolean store) throws ApiException {
        okhttp3.Call localVarCall = quickTestImageUrlValidateBeforeCall(projectId, trainingKey, imageUrl, iterationId, store, null);
        Type localVarReturnType = new TypeToken<ImagePrediction>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call quickTestImageUrlAsync(UUID projectId, String trainingKey, ImageUrl imageUrl, UUID iterationId, Boolean store, final ApiCallback<ImagePrediction> _callback) throws ApiException {

        okhttp3.Call localVarCall = quickTestImageUrlValidateBeforeCall(projectId, trainingKey, imageUrl, iterationId, store, _callback);
        Type localVarReturnType = new TypeToken<ImagePrediction>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
