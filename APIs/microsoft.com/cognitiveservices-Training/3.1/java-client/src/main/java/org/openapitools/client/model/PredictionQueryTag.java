...
public class PredictionQueryTag {
  ...
  public PredictionQueryTag id(UUID id) {
    this.id = id;
    return this;
  }
  ...
  public PredictionQueryTag maxThreshold(Float maxThreshold) {
  ...
  public PredictionQueryTag minThreshold(Float minThreshold) {
