...
> deleteImages(projectId, trainingKey, opts)
...
apiInstance.deleteImages(projectId, trainingKey, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully.');
...
> {String: Number} querySuggestedImageCount(projectId, iterationId, trainingKey, tagFilter)
...
apiInstance.querySuggestedImageCount(projectId, iterationId, trainingKey, tagFilter, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> SuggestedTagAndRegionQuery querySuggestedImages(projectId, iterationId, trainingKey, suggestedTagAndRegionQueryToken)
...
apiInstance.querySuggestedImages(projectId, iterationId, trainingKey, suggestedTagAndRegionQueryToken, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
