...
class ImageRegion {
    ...
    constructor(height, left, tagId, top, width) { 
        ...
        ImageRegion.initialize(this, height, left, tagId, top, width);
    }
    ...
    static validateJSON(data) {
        ...
        for (const property of ImageRegion.RequiredProperties) {
...
ImageRegion.RequiredProperties = ["height", "left", "tagId", "top", "width"];
