...
export default class ImageApiApi {
    ...
    */
     ...
     */
    deleteImages(projectId, trainingKey, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'projectId' is set
      if (projectId === undefined || projectId === null) {
     ...
     */
    querySuggestedImageCount(projectId, iterationId, trainingKey, tagFilter, callback) {
      ...
      // verify the required parameter 'trainingKey' is set
      if (trainingKey === undefined || trainingKey === null) {
        throw new Error("Missing the required parameter 'trainingKey' when calling querySuggestedImageCount");
      }
     ...
     */
    querySuggestedImages(projectId, iterationId, trainingKey, suggestedTagAndRegionQueryToken, callback) {
      ...
      // verify the required parameter 'trainingKey' is set
      if (trainingKey === undefined || trainingKey === null) {
        throw new Error("Missing the required parameter 'trainingKey' when calling querySuggestedImages");
      }
