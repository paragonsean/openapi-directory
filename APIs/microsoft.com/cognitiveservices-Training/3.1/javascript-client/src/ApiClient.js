...
class ApiClient {
     ...
     */
    constructor(basePath = 'https://southcentralus.api.cognitive.microsoft.com/customvision/v3.1/training') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default https://southcentralus.api.cognitive.microsoft.com/customvision/v3.1/training
         */
         ...
         */
        this.defaultHeaders = {
            'User-Agent': 'OpenAPI-Generator/3.1/Javascript'
        };
