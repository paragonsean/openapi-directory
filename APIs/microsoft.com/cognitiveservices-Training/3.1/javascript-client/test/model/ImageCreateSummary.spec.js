...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CustomVisionTrainingClient.ImageCreateSummary();
  });
  ...
  describe('ImageCreateSummary', function() {
    it('should create an instance of ImageCreateSummary', function() {
      ...
      //var instance = new CustomVisionTrainingClient.ImageCreateSummary();
      //expect(instance).to.be.a(CustomVisionTrainingClient.ImageCreateSummary);
    });
