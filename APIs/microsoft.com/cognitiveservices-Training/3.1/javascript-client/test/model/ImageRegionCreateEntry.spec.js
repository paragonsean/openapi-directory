...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CustomVisionTrainingClient.ImageRegionCreateEntry();
  });
  ...
  describe('ImageRegionCreateEntry', function() {
    it('should create an instance of ImageRegionCreateEntry', function() {
      // uncomment below and update the code to test ImageRegionCreateEntry
      //var instance = new CustomVisionTrainingClient.ImageRegionCreateEntry();
      //expect(instance).to.be.a(CustomVisionTrainingClient.ImageRegionCreateEntry);
    });
