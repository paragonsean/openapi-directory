...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CustomVisionTrainingClient.PredictionQueryTag();
  });
  ...
  describe('PredictionQueryTag', function() {
    it('should create an instance of PredictionQueryTag', function() {
      ...
      //var instance = new CustomVisionTrainingClient.PredictionQueryTag();
      //expect(instance).to.be.a(CustomVisionTrainingClient.PredictionQueryTag);
    });
