...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CustomVisionTrainingClient.ImageFileCreateEntry();
  });
  ...
  describe('ImageFileCreateEntry', function() {
    it('should create an instance of ImageFileCreateEntry', function() {
      ...
      //var instance = new CustomVisionTrainingClient.ImageFileCreateEntry();
      //expect(instance).to.be.a(CustomVisionTrainingClient.ImageFileCreateEntry);
    });
