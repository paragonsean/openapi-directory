...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CustomVisionTrainingClient.Project();
  });
  ...
  describe('Project', function() {
    it('should create an instance of Project', function() {
      ...
      //var instance = new CustomVisionTrainingClient.Project();
      //expect(instance).to.be.a(CustomVisionTrainingClient.Project);
    });
    ...
    it('should have the property drModeEnabled (base name: "drModeEnabled")', function() {
      // uncomment below and update the code to test the property drModeEnabled
      //var instance = new CustomVisionTrainingClient.Project();
      //expect(instance).to.be();
    });
