...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CustomVisionTrainingClient.BoundingBox();
  });
  ...
  describe('BoundingBox', function() {
    it('should create an instance of BoundingBox', function() {
      ...
      //var instance = new CustomVisionTrainingClient.BoundingBox();
      //expect(instance).to.be.a(CustomVisionTrainingClient.BoundingBox);
    });
