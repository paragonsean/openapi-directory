...
async def test_create_image_regions(client):
    ...
    response = await client.request(
        method='POST',
        path='/customvision/v3.1/training/projects/{project_id}/images/regions'.format(project_id='bc3f7dad-5544-468c-8573-3ef04d55463e'),
        headers=headers,
        json=body,
        )
...
async def test_create_image_tags(client):
    ...
    response = await client.request(
        method='POST',
        path='/customvision/v3.1/training/projects/{project_id}/images/tags'.format(project_id='bc3f7dad-5544-468c-8573-3ef04d55463e'),
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_create_images_from_data(client):
    ...
    response = await client.request(
        method='POST',
        path='/customvision/v3.1/training/projects/{project_id}/images'.format(project_id='64b822c5-8082-4b36-a426-27225f4aa18c'),
        headers=headers,
        data=data,
        params=params,
        )
...
async def test_create_images_from_files(client):
    ...
    response = await client.request(
        method='POST',
        path='/customvision/v3.1/training/projects/{project_id}/images/files'.format(project_id='64b822c5-8082-4b36-a426-27225f4aa18c'),
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_create_images_from_predictions(client):
    ...
    response = await client.request(
        method='POST',
        path='/customvision/v3.1/training/projects/{project_id}/images/predictions'.format(project_id='64b822c5-8082-4b36-a426-27225f4aa18c'),
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_create_images_from_urls(client):
    ...
    response = await client.request(
        method='POST',
        path='/customvision/v3.1/training/projects/{project_id}/images/urls'.format(project_id='64b822c5-8082-4b36-a426-27225f4aa18c'),
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_delete_image_tags(client):
    ...
    response = await client.request(
        method='DELETE',
        path='/customvision/v3.1/training/projects/{project_id}/images/tags'.format(project_id='64b822c5-8082-4b36-a426-27225f4aa18c'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_get_images_by_ids(client):
    ...
    response = await client.request(
        method='GET',
        path='/customvision/v3.1/training/projects/{project_id}/images/id'.format(project_id='bc3f7dad-5544-468c-8573-3ef04d55463e'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_get_tagged_image_count(client):
    ...
    response = await client.request(
        method='GET',
        path='/customvision/v3.1/training/projects/{project_id}/images/tagged/count'.format(project_id='bc3f7dad-5544-468c-8573-3ef04d55463e'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_get_tagged_images(client):
    ...
    response = await client.request(
        method='GET',
        path='/customvision/v3.1/training/projects/{project_id}/images/tagged'.format(project_id='bc3f7dad-5544-468c-8573-3ef04d55463e'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_get_untagged_image_count(client):
    ...
    response = await client.request(
        method='GET',
        path='/customvision/v3.1/training/projects/{project_id}/images/untagged/count'.format(project_id='bc3f7dad-5544-468c-8573-3ef04d55463e'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_get_untagged_images(client):
    ...
    response = await client.request(
        method='GET',
        path='/customvision/v3.1/training/projects/{project_id}/images/untagged'.format(project_id='bc3f7dad-5544-468c-8573-3ef04d55463e'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_query_suggested_image_count(client):
    ...
    response = await client.request(
        method='POST',
        path='/customvision/v3.1/training/projects/{project_id}/images/suggested/count'.format(project_id='bc3f7dad-5544-468c-8573-3ef04d55463e'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_query_suggested_images(client):
    ...
    response = await client.request(
        method='POST',
        path='/customvision/v3.1/training/projects/{project_id}/images/suggested'.format(project_id='bc3f7dad-5544-468c-8573-3ef04d55463e'),
        headers=headers,
        json=body,
        params=params,
        )
