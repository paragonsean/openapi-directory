...
public:
    ...
    */
    virtual void createTag(const QString &project_id, const QString &name, const ::OpenAPI::OptionalParam<QString> &description = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &type = ::OpenAPI::OptionalParam<QString>());

    /**
    * @param[in]  project_id QString [required]
    * @param[in]  tag_id QString [required]
    */
    virtual void deleteTag(const QString &project_id, const QString &tag_id);
    ...
    */
    virtual void getTag(const QString &project_id, const QString &tag_id, const ::OpenAPI::OptionalParam<QString> &iteration_id = ::OpenAPI::OptionalParam<QString>());

    /**
    * @param[in]  project_id QString [required]
    * @param[in]  iteration_id QString [optional]
    */
    virtual void getTags(const QString &project_id, const ::OpenAPI::OptionalParam<QString> &iteration_id = ::OpenAPI::OptionalParam<QString>());
    ...
    */
    virtual void updateTag(const QString &project_id, const QString &tag_id, const OAITag &oai_tag);
