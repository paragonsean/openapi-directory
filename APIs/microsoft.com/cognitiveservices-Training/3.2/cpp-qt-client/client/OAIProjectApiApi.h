...
public:
    ...
    */
    virtual void createProject(const QString &name, const ::OpenAPI::OptionalParam<QString> &description = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &domain_id = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &classification_type = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QList<QString>> &target_export_platforms = ::OpenAPI::OptionalParam<QList<QString>>());

    /**
    * @param[in]  project_id QString [required]
    * @param[in]  iteration_id QString [required]
    */
    virtual void deleteIteration(const QString &project_id, const QString &iteration_id);

    /**
    * @param[in]  project_id QString [required]
    */
    virtual void deleteProject(const QString &project_id);
    ...
    */
    virtual void exportIteration(const QString &project_id, const QString &iteration_id, const QString &platform, const ::OpenAPI::OptionalParam<QString> &flavor = ::OpenAPI::OptionalParam<QString>());

    /**
    * @param[in]  project_id QString [required]
    */
    virtual void exportProject(const QString &project_id);

    /**
    * @param[in]  project_id QString [required]
    * @param[in]  iteration_id QString [required]
    */
    virtual void getExports(const QString &project_id, const QString &iteration_id);
    ...
    */
    virtual void getImagePerformanceCount(const QString &project_id, const QString &iteration_id, const ::OpenAPI::OptionalParam<QList<QString>> &tag_ids = ::OpenAPI::OptionalParam<QList<QString>>());
    ...
    */
    virtual void getImagePerformances(const QString &project_id, const QString &iteration_id, const ::OpenAPI::OptionalParam<QList<QString>> &tag_ids = ::OpenAPI::OptionalParam<QList<QString>>(), const ::OpenAPI::OptionalParam<QString> &order_by = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<qint32> &take = ::OpenAPI::OptionalParam<qint32>(), const ::OpenAPI::OptionalParam<qint32> &skip = ::OpenAPI::OptionalParam<qint32>());

    /**
    * @param[in]  project_id QString [required]
    * @param[in]  iteration_id QString [required]
    */
    virtual void getIteration(const QString &project_id, const QString &iteration_id);
    ...
    */
    virtual void getIterationPerformance(const QString &project_id, const QString &iteration_id, const ::OpenAPI::OptionalParam<float> &threshold = ::OpenAPI::OptionalParam<float>(), const ::OpenAPI::OptionalParam<float> &overlap_threshold = ::OpenAPI::OptionalParam<float>());

    /**
    * @param[in]  project_id QString [required]
    */
    virtual void getIterations(const QString &project_id);

    /**
    * @param[in]  project_id QString [required]
    */
    virtual void getProject(const QString &project_id);
    ...
    */
    virtual void importProject(const QString &token);
    ...
    */
    virtual void publishIteration(const QString &project_id, const QString &iteration_id, const QString &publish_name, const QString &prediction_id);
    ...
    * @param[in]  oai_training_parameters OAITrainingParameters [optional]
    */
    virtual void trainProject(const QString &project_id, const ::OpenAPI::OptionalParam<QString> &training_type = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<qint32> &reserved_budget_in_hours = ::OpenAPI::OptionalParam<qint32>(), const ::OpenAPI::OptionalParam<bool> &force_train = ::OpenAPI::OptionalParam<bool>(), const ::OpenAPI::OptionalParam<QString> &notification_email_address = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<OAITrainingParameters> &oai_training_parameters = ::OpenAPI::OptionalParam<OAITrainingParameters>());

    /**
    * @param[in]  project_id QString [required]
    * @param[in]  iteration_id QString [required]
    */
    virtual void unpublishIteration(const QString &project_id, const QString &iteration_id);
    ...
    */
    virtual void updateIteration(const QString &project_id, const QString &iteration_id, const OAIIteration &oai_iteration);

    /**
    * @param[in]  project_id QString [required]
    * @param[in]  oai_project OAIProject [required]
    */
    virtual void updateProject(const QString &project_id, const OAIProject &oai_project);
...
private:
    ...
    void importProjectCallback(OAIHttpRequestWorker *worker);
...
Q_SIGNALS:
    ...
    void exportProjectSignal(OAIProjectExport summary);
    ...
    void importProjectSignal(OAIProject summary);
    ...
    void exportProjectSignalFull(OAIHttpRequestWorker *worker, OAIProjectExport summary);
    ...
    void importProjectSignalFull(OAIHttpRequestWorker *worker, OAIProject summary);
    ...
    void exportProjectSignalE(OAIProjectExport summary, QNetworkReply::NetworkError error_type, QString error_str);
    void exportProjectSignalError(OAIProjectExport summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use importProjectSignalError() instead")
    void importProjectSignalE(OAIProject summary, QNetworkReply::NetworkError error_type, QString error_str);
    void importProjectSignalError(OAIProject summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use importProjectSignalErrorFull() instead")
    void importProjectSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void importProjectSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
