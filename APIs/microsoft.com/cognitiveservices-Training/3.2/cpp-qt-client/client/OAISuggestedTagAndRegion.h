...
/*
 * OAISuggestedTagAndRegion.h
 *
 * Result of a suggested tags and regions request.
 */

#ifndef OAISuggestedTagAndRegion_H
#define OAISuggestedTagAndRegion_H
...
class OAISuggestedTagAndRegion : public OAIObject {
public:
    OAISuggestedTagAndRegion();
    OAISuggestedTagAndRegion(QString json);
    ~OAISuggestedTagAndRegion() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISuggestedTagAndRegion)

#endif // OAISuggestedTagAndRegion_H
