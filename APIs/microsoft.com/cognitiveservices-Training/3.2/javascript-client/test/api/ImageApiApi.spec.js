...
(function(root, factory) {
  ...
  describe('ImageApiApi', function() {
    ...
    describe('querySuggestedImageCount', function() {
      it('should call querySuggestedImageCount successfully', function(done) {
        //uncomment below and update the code to test querySuggestedImageCount
        //instance.querySuggestedImageCount(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('querySuggestedImages', function() {
      it('should call querySuggestedImages successfully', function(done) {
        //uncomment below and update the code to test querySuggestedImages
        //instance.querySuggestedImages(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
