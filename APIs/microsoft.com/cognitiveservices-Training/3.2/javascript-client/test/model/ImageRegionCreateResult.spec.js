...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CustomVisionTrainingClient.ImageRegionCreateResult();
  });
  ...
  describe('ImageRegionCreateResult', function() {
    it('should create an instance of ImageRegionCreateResult', function() {
      // uncomment below and update the code to test ImageRegionCreateResult
      //var instance = new CustomVisionTrainingClient.ImageRegionCreateResult();
      //expect(instance).to.be.a(CustomVisionTrainingClient.ImageRegionCreateResult);
    });
