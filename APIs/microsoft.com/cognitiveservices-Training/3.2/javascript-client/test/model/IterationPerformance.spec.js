...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CustomVisionTrainingClient.IterationPerformance();
  });
  ...
  describe('IterationPerformance', function() {
    it('should create an instance of IterationPerformance', function() {
      ...
      //var instance = new CustomVisionTrainingClient.IterationPerformance();
      //expect(instance).to.be.a(CustomVisionTrainingClient.IterationPerformance);
    });
