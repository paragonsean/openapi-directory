...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CustomVisionTrainingClient.ImageRegionProposal();
  });
  ...
  describe('ImageRegionProposal', function() {
    it('should create an instance of ImageRegionProposal', function() {
      // uncomment below and update the code to test ImageRegionProposal
      //var instance = new CustomVisionTrainingClient.ImageRegionProposal();
      //expect(instance).to.be.a(CustomVisionTrainingClient.ImageRegionProposal);
    });
