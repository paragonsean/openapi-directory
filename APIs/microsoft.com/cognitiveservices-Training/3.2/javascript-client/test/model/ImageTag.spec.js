...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CustomVisionTrainingClient.ImageTag();
  });
  ...
  describe('ImageTag', function() {
    it('should create an instance of ImageTag', function() {
      ...
      //var instance = new CustomVisionTrainingClient.ImageTag();
      //expect(instance).to.be.a(CustomVisionTrainingClient.ImageTag);
    });
