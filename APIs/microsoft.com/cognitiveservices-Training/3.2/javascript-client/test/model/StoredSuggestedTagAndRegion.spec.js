...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CustomVisionTrainingClient.StoredSuggestedTagAndRegion();
  });
  ...
  describe('StoredSuggestedTagAndRegion', function() {
    it('should create an instance of StoredSuggestedTagAndRegion', function() {
      // uncomment below and update the code to test StoredSuggestedTagAndRegion
      //var instance = new CustomVisionTrainingClient.StoredSuggestedTagAndRegion();
      //expect(instance).to.be.a(CustomVisionTrainingClient.StoredSuggestedTagAndRegion);
    });
    ...
    it('should have the property predictionUncertainty (base name: "predictionUncertainty")', function() {
      // uncomment below and update the code to test the property predictionUncertainty
      //var instance = new CustomVisionTrainingClient.StoredSuggestedTagAndRegion();
      //expect(instance).to.be();
    });
