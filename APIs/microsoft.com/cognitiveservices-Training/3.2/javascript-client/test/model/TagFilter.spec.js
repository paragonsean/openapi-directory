...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CustomVisionTrainingClient.TagFilter();
  });
  ...
  describe('TagFilter', function() {
    it('should create an instance of TagFilter', function() {
      // uncomment below and update the code to test TagFilter
      //var instance = new CustomVisionTrainingClient.TagFilter();
      //expect(instance).to.be.a(CustomVisionTrainingClient.TagFilter);
    });
