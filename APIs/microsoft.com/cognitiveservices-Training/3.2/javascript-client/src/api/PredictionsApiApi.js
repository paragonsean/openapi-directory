...
export default class PredictionsApiApi {
    ...
    */
     ...
     */
    deletePrediction(projectId, ids, callback) {
      let postBody = null;
     ...
     */
    queryPredictions(projectId, predictionQueryToken, callback) {
     ...
     */
    quickTestImage(projectId, imageData, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'projectId' is set
      if (projectId === undefined || projectId === null) {
     ...
     * data is of type: {@link module:model/ImagePrediction}
     */
    quickTestImageUrl(projectId, imageUrl, opts, callback) {
      opts = opts || {};
