...
export default class TagsApiApi {
    ...
    */
     ...
     */
    createTag(projectId, name, opts, callback) {
      opts = opts || {};
      let postBody = null;
     ...
     */
    deleteTag(projectId, tagId, callback) {
      let postBody = null;
      // verify the required parameter 'projectId' is set
      if (projectId === undefined || projectId === null) {
     ...
     * data is of type: {@link module:model/Tag}
     */
    getTag(projectId, tagId, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'projectId' is set
      if (projectId === undefined || projectId === null) {
     ...
     */
    getTags(projectId, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'projectId' is set
      if (projectId === undefined || projectId === null) {
     ...
     * data is of type: {@link module:model/Tag}
     */
    updateTag(projectId, tagId, tag, callback) {
      let postBody = tag;
      // verify the required parameter 'projectId' is set
      if (projectId === undefined || projectId === null) {
