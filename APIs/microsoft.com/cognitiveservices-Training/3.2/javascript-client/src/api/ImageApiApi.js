...
import SuggestedTagAndRegionQuery from '../model/SuggestedTagAndRegionQuery';
import SuggestedTagAndRegionQueryToken from '../model/SuggestedTagAndRegionQueryToken';
...
export default class ImageApiApi {
    ...
    */
     ...
     */
    createImageRegions(projectId, imageRegionCreateBatch, callback) {
     ...
     */
    createImageTags(projectId, imageTagCreateBatch, callback) {
     ...
     */
    createImagesFromData(projectId, imageData, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'projectId' is set
      if (projectId === undefined || projectId === null) {
     ...
     * data is of type: {@link module:model/ImageCreateSummary}
     */
    createImagesFromFiles(projectId, imageFileCreateBatch, callback) {
     ...
     * data is of type: {@link module:model/ImageCreateSummary}
     */
    createImagesFromPredictions(projectId, imageIdCreateBatch, callback) {
     ...
     * data is of type: {@link module:model/ImageCreateSummary}
     */
    createImagesFromUrls(projectId, imageUrlCreateBatch, callback) {
     ...
     */
    deleteImageRegions(projectId, regionIds, callback) {
      let postBody = null;
      // verify the required parameter 'projectId' is set
      if (projectId === undefined || projectId === null) {
     ...
     */
    deleteImageTags(projectId, imageIds, tagIds, callback) {
      let postBody = null;
      // verify the required parameter 'projectId' is set
      if (projectId === undefined || projectId === null) {
     ...
     */
    deleteImages(projectId, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'projectId' is set
      if (projectId === undefined || projectId === null) {
     ...
     */
    getImagesByIds(projectId, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'projectId' is set
      if (projectId === undefined || projectId === null) {
     ...
     */
    getTaggedImageCount(projectId, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'projectId' is set
      if (projectId === undefined || projectId === null) {
     ...
     * data is of type: {@link Array.<module:model/Image>}
     */
    getTaggedImages(projectId, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'projectId' is set
      if (projectId === undefined || projectId === null) {
     ...
     * data is of type: {@link Number}
     */
    getUntaggedImageCount(projectId, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'projectId' is set
      if (projectId === undefined || projectId === null) {
     ...
     * data is of type: {@link Array.<module:model/Image>}
     */
    getUntaggedImages(projectId, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'projectId' is set
      if (projectId === undefined || projectId === null) {
    ...
    /**
     * Callback function to receive the result of the querySuggestedImageCount operation.
     * @callback module:api/ImageApiApi~querySuggestedImageCountCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:model/TagFilter} tagFilter Model that contains tagIds, threshold and projectType to query by.
     * @param {module:api/ImageApiApi~querySuggestedImageCountCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Object.<String, {String: Number}>}
     */
    querySuggestedImageCount(projectId, iterationId, tagFilter, callback) {
      let postBody = tagFilter;
      // verify the required parameter 'projectId' is set
      if (projectId === undefined || projectId === null) {
        throw new Error("Missing the required parameter 'projectId' when calling querySuggestedImageCount");
      }
      // verify the required parameter 'iterationId' is set
      if (iterationId === undefined || iterationId === null) {
        throw new Error("Missing the required parameter 'iterationId' when calling querySuggestedImageCount");
      }
      // verify the required parameter 'tagFilter' is set
      if (tagFilter === undefined || tagFilter === null) {
        throw new Error("Missing the required parameter 'tagFilter' when calling querySuggestedImageCount");
      }
      ...
      return this.apiClient.callApi(
        '/projects/{projectId}/images/suggested/count', 'POST',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
    ...
    /**
     * Callback function to receive the result of the querySuggestedImages operation.
     * @callback module:api/ImageApiApi~querySuggestedImagesCallback
     * @param {String} error Error message, if any.
     * @param {module:model/SuggestedTagAndRegionQuery} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} projectId The project id.
     * @param {String} iterationId IterationId to use for the suggested tags and regions.
     * @param {module:model/SuggestedTagAndRegionQueryToken} suggestedTagAndRegionQueryToken Contains properties we need to query suggested images.
     * @param {module:api/ImageApiApi~querySuggestedImagesCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/SuggestedTagAndRegionQuery}
     */
    querySuggestedImages(projectId, iterationId, suggestedTagAndRegionQueryToken, callback) {
      let postBody = suggestedTagAndRegionQueryToken;
      // verify the required parameter 'projectId' is set
      if (projectId === undefined || projectId === null) {
        throw new Error("Missing the required parameter 'projectId' when calling querySuggestedImages");
      }
      // verify the required parameter 'iterationId' is set
      if (iterationId === undefined || iterationId === null) {
        throw new Error("Missing the required parameter 'iterationId' when calling querySuggestedImages");
      }
      // verify the required parameter 'suggestedTagAndRegionQueryToken' is set
      if (suggestedTagAndRegionQueryToken === undefined || suggestedTagAndRegionQueryToken === null) {
        throw new Error("Missing the required parameter 'suggestedTagAndRegionQueryToken' when calling querySuggestedImages");
      }
      ...
      let contentTypes = ['application/json', 'application/x-www-form-urlencoded', 'application/xml', 'text/xml'];
      let accepts = ['application/json', 'application/xml', 'text/xml'];
      let returnType = SuggestedTagAndRegionQuery;
      return this.apiClient.callApi(
        '/projects/{projectId}/images/suggested', 'POST',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
