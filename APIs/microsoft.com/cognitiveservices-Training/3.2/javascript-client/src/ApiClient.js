...
class ApiClient {
     ...
     */
    constructor(basePath = 'https://southcentralus.api.cognitive.microsoft.com/customvision/v3.2/training') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default https://southcentralus.api.cognitive.microsoft.com/customvision/v3.2/training
         */
        ...
        this.authentications = {
            'apim_key': {type: 'apiKey', 'in': 'header', name: 'Training-Key'}
        }
         ...
         */
        this.defaultHeaders = {
            'User-Agent': 'OpenAPI-Generator/3.2/Javascript'
        };
