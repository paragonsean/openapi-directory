...
async def create_project(request: web.Request, name, description=None, domain_id=None, classification_type=None, target_export_platforms=None) -> web.Response:
    """Create a project.
...
async def delete_iteration(request: web.Request, project_id, iteration_id) -> web.Response:
...
async def export_iteration(request: web.Request, project_id, iteration_id, platform, flavor=None) -> web.Response:
...
async def export_project(request: web.Request, project_id) -> web.Response:
    """Exports a project.
...
async def get_exports(request: web.Request, project_id, iteration_id) -> web.Response:
...
async def get_image_performance_count(request: web.Request, project_id, iteration_id, tag_ids=None) -> web.Response:
...
async def get_image_performances(request: web.Request, project_id, iteration_id, tag_ids=None, order_by=None, take=None, skip=None) -> web.Response:
...
async def get_iteration(request: web.Request, project_id, iteration_id) -> web.Response:
...
async def get_iteration_performance(request: web.Request, project_id, iteration_id, threshold=None, overlap_threshold=None) -> web.Response:
...
async def get_iterations(request: web.Request, project_id) -> web.Response:
...
async def import_project(request: web.Request, token) -> web.Response:
    """Imports a project.
...
async def publish_iteration(request: web.Request, project_id, iteration_id, publish_name, prediction_id) -> web.Response:
...
async def train_project(request: web.Request, project_id, training_type=None, reserved_budget_in_hours=None, force_train=None, notification_email_address=None, body=None) -> web.Response:
    ...
    :param body: Additional training parameters passed in to control how the project is trained.
    :type body: dict | bytes

    """
    body = TrainingParameters.from_dict(body)
    return web.Response(status=200)


async def unpublish_iteration(request: web.Request, project_id, iteration_id) -> web.Response:
...
async def update_iteration(request: web.Request, project_id, iteration_id, body) -> web.Response:
...
async def update_project(request: web.Request, project_id, body) -> web.Response:
