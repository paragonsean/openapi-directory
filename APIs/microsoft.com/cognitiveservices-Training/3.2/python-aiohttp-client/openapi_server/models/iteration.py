...
class Iteration(Model):
    ...
    def __init__(self, classification_type: str=None, created: datetime=None, domain_id: str=None, exportable: bool=None, exportable_to: List[str]=None, id: str=None, last_modified: datetime=None, name: str=None, original_publish_resource_id: str=None, project_id: str=None, publish_name: str=None, reserved_budget_in_hours: int=None, status: str=None, trained_at: datetime=None, training_time_in_minutes: int=None, training_type: str=None):
        ...
        :param training_time_in_minutes: The training_time_in_minutes of this Iteration.
        ...
        self.attribute_map = {
            ...
            'training_time_in_minutes': 'trainingTimeInMinutes',
        ...
        self._training_time_in_minutes = training_time_in_minutes
    ...
    @property
    def training_time_in_minutes(self):
        """Gets the training_time_in_minutes of this Iteration.

        Gets the training time for the iteration.

        :return: The training_time_in_minutes of this Iteration.
        :rtype: int
        """
        return self._training_time_in_minutes

    @training_time_in_minutes.setter
    def training_time_in_minutes(self, training_time_in_minutes):
        """Sets the training_time_in_minutes of this Iteration.

        Gets the training time for the iteration.

        :param training_time_in_minutes: The training_time_in_minutes of this Iteration.
        :type training_time_in_minutes: int
        """
