...
class Project(Model):
    ...
    def __init__(self, created: datetime=None, description: str=None, dr_mode_enabled: bool=None, id: str=None, last_modified: datetime=None, name: str=None, settings: ProjectSettings=None, status: str=None, thumbnail_uri: str=None):
    ...
    def status(self, status):
        ...
        :type status: str
        """
        allowed_values = ["Succeeded", "Importing", "Failed"]  # noqa: E501
