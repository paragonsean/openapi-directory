...
public class ApiClient {
    ...
    private String basePath = "https://southcentralus.api.cognitive.microsoft.com/customvision/v3.2/training";
    ...
    new ServerConfiguration(
      "{Endpoint}/customvision/v3.2/training",
      "No description provided",
      new HashMap<String, ServerVariable>() {{
        put("Endpoint", new ServerVariable(
    ...
    public ApiClient() {
        ...
        authentications.put("apim_key", new ApiKeyAuth("header", "Training-Key"));
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/3.2/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://southcentralus.api.cognitive.microsoft.com/customvision/v3.2/training
