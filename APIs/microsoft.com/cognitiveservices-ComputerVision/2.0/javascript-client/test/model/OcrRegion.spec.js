...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ComputerVisionClient.OcrRegion();
  });
  ...
  describe('OcrRegion', function() {
    it('should create an instance of OcrRegion', function() {
      // uncomment below and update the code to test OcrRegion
      //var instance = new ComputerVisionClient.OcrRegion();
      //expect(instance).to.be.a(ComputerVisionClient.OcrRegion);
    });
