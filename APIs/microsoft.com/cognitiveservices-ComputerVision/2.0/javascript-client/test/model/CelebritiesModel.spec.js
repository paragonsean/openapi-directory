...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ComputerVisionClient.CelebritiesModel();
  });
  ...
  describe('CelebritiesModel', function() {
    it('should create an instance of CelebritiesModel', function() {
      // uncomment below and update the code to test CelebritiesModel
      //var instance = new ComputerVisionClient.CelebritiesModel();
      //expect(instance).to.be.a(ComputerVisionClient.CelebritiesModel);
    });
