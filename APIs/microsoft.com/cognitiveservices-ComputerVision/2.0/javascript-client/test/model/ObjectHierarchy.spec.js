...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ComputerVisionClient.ObjectHierarchy();
  });
  ...
  describe('ObjectHierarchy', function() {
    it('should create an instance of ObjectHierarchy', function() {
      // uncomment below and update the code to test ObjectHierarchy
      //var instance = new ComputerVisionClient.ObjectHierarchy();
      //expect(instance).to.be.a(ComputerVisionClient.ObjectHierarchy);
    });
