...
public:
    ...
    qint32 getClipArtType() const;
    void setClipArtType(const qint32 &clip_art_type);
    bool is_clip_art_type_Set() const;
    bool is_clip_art_type_Valid() const;

    qint32 getLineDrawingType() const;
    void setLineDrawingType(const qint32 &line_drawing_type);
