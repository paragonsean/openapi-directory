...
qint32 OAIImageType::getClipArtType() const {
    return m_clip_art_type;
}
void OAIImageType::setClipArtType(const qint32 &clip_art_type) {
...
qint32 OAIImageType::getLineDrawingType() const {
    return m_line_drawing_type;
}
void OAIImageType::setLineDrawingType(const qint32 &line_drawing_type) {
