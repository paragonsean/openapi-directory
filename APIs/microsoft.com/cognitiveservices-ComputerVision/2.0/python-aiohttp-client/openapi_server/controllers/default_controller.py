...
async def analyze_image(request: web.Request, body, visual_features=None, details=None, language=None) -> web.Response:
    """analyze_image
...
async def describe_image(request: web.Request, body, max_candidates=None, language=None) -> web.Response:
    """describe_image
