...
#ifndef OAIDetectedBrand_H
#define OAIDetectedBrand_H
...
class OAIDetectedBrand : public OAIObject {
public:
    OAIDetectedBrand();
    OAIDetectedBrand(QString json);
    ~OAIDetectedBrand() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDetectedBrand)

#endif // OAIDetectedBrand_H
