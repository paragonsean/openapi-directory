...
void OAIAdultInfo::initializeModel() {
    ...
    m_gore_score_isSet = false;
    m_gore_score_isValid = false;

    m_is_adult_content_isSet = false;
    m_is_adult_content_isValid = false;

    m_is_gory_content_isSet = false;
    m_is_gory_content_isValid = false;
...
void OAIAdultInfo::fromJsonObject(QJsonObject json) {
    ...
    m_gore_score_isValid = ::OpenAPI::fromJsonValue(m_gore_score, json[QString("goreScore")]);
    m_gore_score_isSet = !json[QString("goreScore")].isNull() && m_gore_score_isValid;
    ...
    m_is_gory_content_isValid = ::OpenAPI::fromJsonValue(m_is_gory_content, json[QString("isGoryContent")]);
    m_is_gory_content_isSet = !json[QString("isGoryContent")].isNull() && m_is_gory_content_isValid;
...
QJsonObject OAIAdultInfo::asJsonObject() const {
    ...
    if (m_gore_score_isSet) {
        obj.insert(QString("goreScore"), ::OpenAPI::toJsonValue(m_gore_score));
    }
    if (m_is_adult_content_isSet) {
        obj.insert(QString("isAdultContent"), ::OpenAPI::toJsonValue(m_is_adult_content));
    }
    if (m_is_gory_content_isSet) {
        obj.insert(QString("isGoryContent"), ::OpenAPI::toJsonValue(m_is_gory_content));
    }
...
double OAIAdultInfo::getGoreScore() const {
    return m_gore_score;
}
void OAIAdultInfo::setGoreScore(const double &gore_score) {
    m_gore_score = gore_score;
    m_gore_score_isSet = true;
}

bool OAIAdultInfo::is_gore_score_Set() const{
    return m_gore_score_isSet;
}

bool OAIAdultInfo::is_gore_score_Valid() const{
    return m_gore_score_isValid;
}
...
bool OAIAdultInfo::isIsGoryContent() const {
    return m_is_gory_content;
}
void OAIAdultInfo::setIsGoryContent(const bool &is_gory_content) {
    m_is_gory_content = is_gory_content;
    m_is_gory_content_isSet = true;
}

bool OAIAdultInfo::is_is_gory_content_Set() const{
    return m_is_gory_content_isSet;
}

bool OAIAdultInfo::is_is_gory_content_Valid() const{
    return m_is_gory_content_isValid;
}
