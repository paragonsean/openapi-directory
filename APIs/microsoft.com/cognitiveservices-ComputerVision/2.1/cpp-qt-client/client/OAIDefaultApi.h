...
public:
    ...
    * @param[in]  description_exclude QList<QString> [optional]
    */
    virtual void analyzeImage(const OAIImageUrl &oai_image_url, const ::OpenAPI::OptionalParam<QList<QString>> &visual_features = ::OpenAPI::OptionalParam<QList<QString>>(), const ::OpenAPI::OptionalParam<QList<QString>> &details = ::OpenAPI::OptionalParam<QList<QString>>(), const ::OpenAPI::OptionalParam<QString> &language = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QList<QString>> &description_exclude = ::OpenAPI::OptionalParam<QList<QString>>());
    ...
    * @param[in]  description_exclude QList<QString> [optional]
    */
    virtual void describeImage(const OAIImageUrl &oai_image_url, const ::OpenAPI::OptionalParam<qint32> &max_candidates = ::OpenAPI::OptionalParam<qint32>(), const ::OpenAPI::OptionalParam<QString> &language = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QList<QString>> &description_exclude = ::OpenAPI::OptionalParam<QList<QString>>());
