...
public class DefaultApi {
     ...
     * @param descriptionExclude Turn off specified domain models when generating the description. (optional)
     ...
     */
    public okhttp3.Call analyzeImageCall(ImageUrl imageUrl, List<String> visualFeatures, List<String> details, String language, List<String> descriptionExclude, final ApiCallback _callback) throws ApiException {
        ...
        if (descriptionExclude != null) {
            localVarCollectionQueryParams.addAll(localVarApiClient.parameterToPairs("csv", "descriptionExclude", descriptionExclude));
        }
    ...
    private okhttp3.Call analyzeImageValidateBeforeCall(ImageUrl imageUrl, List<String> visualFeatures, List<String> details, String language, List<String> descriptionExclude, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'imageUrl' is set
        if (imageUrl == null) {
            throw new ApiException("Missing the required parameter 'imageUrl' when calling analyzeImage(Async)");
        }

        return analyzeImageCall(imageUrl, visualFeatures, details, language, descriptionExclude, _callback);
     ...
     */
    public ImageAnalysis analyzeImage(ImageUrl imageUrl, List<String> visualFeatures, List<String> details, String language, List<String> descriptionExclude) throws ApiException {
        ApiResponse<ImageAnalysis> localVarResp = analyzeImageWithHttpInfo(imageUrl, visualFeatures, details, language, descriptionExclude);
     ...
     */
    public ApiResponse<ImageAnalysis> analyzeImageWithHttpInfo(ImageUrl imageUrl, List<String> visualFeatures, List<String> details, String language, List<String> descriptionExclude) throws ApiException {
        okhttp3.Call localVarCall = analyzeImageValidateBeforeCall(imageUrl, visualFeatures, details, language, descriptionExclude, null);
     ...
     */
    public okhttp3.Call analyzeImageAsync(ImageUrl imageUrl, List<String> visualFeatures, List<String> details, String language, List<String> descriptionExclude, final ApiCallback<ImageAnalysis> _callback) throws ApiException {

        okhttp3.Call localVarCall = analyzeImageValidateBeforeCall(imageUrl, visualFeatures, details, language, descriptionExclude, _callback);
        Type localVarReturnType = new TypeToken<ImageAnalysis>(){}.getType();
     ...
     */
    public okhttp3.Call describeImageCall(ImageUrl imageUrl, Integer maxCandidates, String language, List<String> descriptionExclude, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call describeImageValidateBeforeCall(ImageUrl imageUrl, Integer maxCandidates, String language, List<String> descriptionExclude, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'imageUrl' is set
        if (imageUrl == null) {
            throw new ApiException("Missing the required parameter 'imageUrl' when calling describeImage(Async)");
        }

        return describeImageCall(imageUrl, maxCandidates, language, descriptionExclude, _callback);
     ...
     */
    public ImageDescription describeImage(ImageUrl imageUrl, Integer maxCandidates, String language, List<String> descriptionExclude) throws ApiException {
        ApiResponse<ImageDescription> localVarResp = describeImageWithHttpInfo(imageUrl, maxCandidates, language, descriptionExclude);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<ImageDescription> describeImageWithHttpInfo(ImageUrl imageUrl, Integer maxCandidates, String language, List<String> descriptionExclude) throws ApiException {
        okhttp3.Call localVarCall = describeImageValidateBeforeCall(imageUrl, maxCandidates, language, descriptionExclude, null);
     ...
     */
    public okhttp3.Call describeImageAsync(ImageUrl imageUrl, Integer maxCandidates, String language, List<String> descriptionExclude, final ApiCallback<ImageDescription> _callback) throws ApiException {

        okhttp3.Call localVarCall = describeImageValidateBeforeCall(imageUrl, maxCandidates, language, descriptionExclude, _callback);
        Type localVarReturnType = new TypeToken<ImageDescription>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> The OCR results in the hierarchy of region/line/word. The results include text, bounding box for regions, lines and words. The angle, in radians, of the detected text with respect to the closest horizontal or vertical direction. After rotating the input image clockwise by this angle, the recognized text lines become horizontal or vertical. In combination with the orientation property it can be used to overlay recognition results correctly on the original image, by rotating either the original image or recognition results by a suitable angle around the center of the original image. If the angle cannot be confidently detected, this property is not present. If the image contains text at different angles, only part of the text will be recognized correctly. </td><td>  -  </td></tr>
        <tr><td> 0 </td><td> Error response. </td><td>  -  </td></tr>
     </table>
     */
