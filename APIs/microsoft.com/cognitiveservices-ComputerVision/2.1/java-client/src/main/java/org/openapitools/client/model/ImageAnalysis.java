...
import org.openapitools.client.model.DetectedBrand;
...
public class ImageAnalysis {
  ...
  public ImageAnalysis brands(List<DetectedBrand> brands) {
    this.brands = brands;
    return this;
  }

  public ImageAnalysis addBrandsItem(DetectedBrand brandsItem) {
    if (this.brands == null) {
  ...
  public void setBrands(List<DetectedBrand> brands) {
    this.brands = brands;
  }
  ...
  public ImageAnalysis objects(List<DetectedObject> objects) {
    this.objects = objects;
    return this;
  }

  public ImageAnalysis addObjectsItem(DetectedObject objectsItem) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.adult, imageAnalysis.adult) &&
        Objects.equals(this.brands, imageAnalysis.brands) &&
        ...
        Objects.equals(this.objects, imageAnalysis.objects) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(adult, brands, categories, color, description, faces, imageType, metadata, objects, requestId, tags);
  }
      ...
      if (jsonObj.get("brands") != null && !jsonObj.get("brands").isJsonNull()) {
        ...
        if (jsonArraybrands != null) {
          ...
          for (int i = 0; i < jsonArraybrands.size(); i++) {
            DetectedBrand.validateJsonElement(jsonArraybrands.get(i));
          };
        }
      }
