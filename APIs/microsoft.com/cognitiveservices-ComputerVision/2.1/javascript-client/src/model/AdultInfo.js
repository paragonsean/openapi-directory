...
class AdultInfo {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('goreScore')) {
                obj['goreScore'] = ApiClient.convertToType(data['goreScore'], 'Number');
            }
            if (data.hasOwnProperty('isAdultContent')) {
                obj['isAdultContent'] = ApiClient.convertToType(data['isAdultContent'], 'Boolean');
            }
            if (data.hasOwnProperty('isGoryContent')) {
                obj['isGoryContent'] = ApiClient.convertToType(data['isGoryContent'], 'Boolean');
            }
 ...
 * @member {Number} goreScore
 */
AdultInfo.prototype['goreScore'] = undefined;
 ...
 * @member {Boolean} isGoryContent
 */
AdultInfo.prototype['isGoryContent'] = undefined;
