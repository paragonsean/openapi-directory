...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ComputerVisionClient.FaceRectangle();
  });
  ...
  describe('FaceRectangle', function() {
    it('should create an instance of FaceRectangle', function() {
      // uncomment below and update the code to test FaceRectangle
      //var instance = new ComputerVisionClient.FaceRectangle();
      //expect(instance).to.be.a(ComputerVisionClient.FaceRectangle);
    });
