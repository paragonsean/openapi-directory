...
* @version 1.0
*/
export default class SpellCheckApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the spellChecker operation.
     * @callback module:api/SpellCheckApi~spellCheckerCallback
     * @param {String} error Error message, if any.
     * @param {module:model/SpellCheck} data The data returned by the service call.
     ...
     * @param {module:model/String} [actionType] A string that's used by logging to determine whether the request is coming from an interactive session or a page load. The following are the possible values. 1) Edit—The request is from an interactive session 2) Load—The request is from a page load
     ...
     * @param {module:api/SpellCheckApi~spellCheckerCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/SpellCheck}
     */
    spellChecker(xBingApisSDK, text, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'xBingApisSDK' is set
      if (xBingApisSDK === undefined || xBingApisSDK === null) {
        throw new Error("Missing the required parameter 'xBingApisSDK' when calling spellChecker");
      }
      // verify the required parameter 'text' is set
      if (text === undefined || text === null) {
        throw new Error("Missing the required parameter 'text' when calling spellChecker");
      }
      ...
      let queryParams = {
        ...
        'cc': opts['cc'],
        'ClientMachineName': opts['clientMachineName'],
        'DocId': opts['docId'],
        'mkt': opts['mkt'],
        ...
        'UserId': opts['userId'],
        'Mode': opts['mode'],
        'PreContextText': opts['preContextText'],
        'PostContextText': opts['postContextText'],
        'Text': text
      };
      let headerParams = {
