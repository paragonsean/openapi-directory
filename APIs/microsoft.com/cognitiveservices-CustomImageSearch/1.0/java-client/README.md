...
- API version: 1.0
  - Build date: 2024-10-12T10:10:40.621386-04:00[America/New_York]
...
import org.openapitools.client.api.CustomImageSearchApi;

public class Example {
  public static void main(String[] args) {
    ApiClient defaultClient = Configuration.getDefaultApiClient();
    defaultClient.setBasePath("https://api.cognitive.microsoft.com/bingcustomsearch/v7.0");
    ...
    CustomImageSearchApi apiInstance = new CustomImageSearchApi(defaultClient);
    String xBingApisSDK = "true"; // String | Activate swagger compliance
    String customConfig = "customConfig_example"; // String | The identifier for the custom search configuration
    String q = "q_example"; // String | The user's search query term. The term cannot be empty. The term may contain [Bing Advanced Operators](http://msdn.microsoft.com/library/ff795620.aspx). For example, to limit images to a specific domain, use the [site:](http://msdn.microsoft.com/library/ff795613.aspx) operator. To help improve relevance of an insights query (see [insightsToken](https://docs.microsoft.com/en-us/rest/api/cognitiveservices/bing-images-api-v7-reference#insightstoken)), you should always include the user's query term. Use this parameter only with the Image Search API.Do not specify this parameter when calling the Trending Images API.
    ...
    Integer width = 56; // Integer | Filter images that have the specified width, in pixels. You may use this filter with the size filter to return small images that have a width of 150 pixels.
    try {
      Images result = apiInstance.customInstanceImageSearch(xBingApisSDK, customConfig, q, accept, acceptLanguage, userAgent, xMSEdgeClientID, xMSEdgeClientIP, xSearchLocation, aspect, color, cc, count, freshness, height, id, imageContent, imageType, license, mkt, maxFileSize, maxHeight, maxWidth, minFileSize, minHeight, minWidth, offset, safeSearch, size, setLang, width);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling CustomImageSearchApi#customInstanceImageSearch");
...
------------ | ------------- | ------------- | -------------
*CustomImageSearchApi* | [**customInstanceImageSearch**](docs/CustomImageSearchApi.md#customInstanceImageSearch) | **GET** /images/search | The Custom Image Search API lets you send an image search query to Bing and get image results found in your custom view of the web.
