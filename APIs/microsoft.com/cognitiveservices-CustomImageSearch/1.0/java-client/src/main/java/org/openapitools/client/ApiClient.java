...
public class ApiClient {
    ...
    private String basePath = "https://api.cognitive.microsoft.com/bingcustomsearch/v7.0";
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://api.cognitive.microsoft.com/bingcustomsearch/v7.0
