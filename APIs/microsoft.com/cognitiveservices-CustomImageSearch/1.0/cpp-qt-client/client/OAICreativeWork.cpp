...
QString OAICreativeWork::getAlternateName() const {
    return m_alternate_name;
}
void OAICreativeWork::setAlternateName(const QString &alternate_name) {
    m_alternate_name = alternate_name;
    m_alternate_name_isSet = true;
}

bool OAICreativeWork::is_alternate_name_Set() const{
    return m_alternate_name_isSet;
}

bool OAICreativeWork::is_alternate_name_Valid() const{
