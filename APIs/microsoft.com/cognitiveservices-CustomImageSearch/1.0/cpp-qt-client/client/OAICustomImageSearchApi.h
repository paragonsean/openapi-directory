...
#ifndef OAI_OAICustomImageSearchApi_H
#define OAI_OAICustomImageSearchApi_H
...
class OAICustomImageSearchApi : public QObject {
    Q_OBJECT

public:
    OAICustomImageSearchApi(const int timeOut = 0);
    ~OAICustomImageSearchApi();
...
private:
    ...
    void customInstanceImageSearchCallback(OAIHttpRequestWorker *worker);

Q_SIGNALS:

    void customInstanceImageSearchSignal(OAIImages summary);


    void customInstanceImageSearchSignalFull(OAIHttpRequestWorker *worker, OAIImages summary);

    Q_DECL_DEPRECATED_X("Use customInstanceImageSearchSignalError() instead")
    void customInstanceImageSearchSignalE(OAIImages summary, QNetworkReply::NetworkError error_type, QString error_str);
    void customInstanceImageSearchSignalError(OAIImages summary, QNetworkReply::NetworkError error_type, const QString &error_str);

    Q_DECL_DEPRECATED_X("Use customInstanceImageSearchSignalErrorFull() instead")
    void customInstanceImageSearchSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void customInstanceImageSearchSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
