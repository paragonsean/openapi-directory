...
class ImageObject(Model):
    ...
    def __init__(self, accent_color: str=None, image_id: str=None, image_insights_token: str=None, thumbnail: ImageObject=None, visual_words: str=None, content_size: str=None, content_url: str=None, encoding_format: str=None, height: int=None, host_page_display_url: str=None, host_page_url: str=None, width: int=None, provider: List[Thing]=None, text: str=None, thumbnail_url: str=None, alternate_name: str=None, bing_id: str=None, description: str=None, image: ImageObject=None, name: str=None, url: str=None, read_link: str=None, web_search_url: str=None, id: str=None, type: str=None):
