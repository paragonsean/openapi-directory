...
class ApiClient {
     ...
     */
    constructor(basePath = 'https://api.cognitive.microsoft.com/bingcustomsearch/v7.0') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default https://api.cognitive.microsoft.com/bingcustomsearch/v7.0
         */
  ...
  /**
    ...
    */
    hostSettings() {
        return [
            {
              'url': "https://api.cognitive.microsoft.com/bingcustomsearch/v7.0",
