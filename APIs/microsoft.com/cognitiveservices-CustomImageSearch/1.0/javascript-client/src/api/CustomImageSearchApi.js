...
/**
* CustomImageSearch service.
* @module api/CustomImageSearchApi
* @version 1.0
*/
export default class CustomImageSearchApi {

    /**
    * Constructs a new CustomImageSearchApi. 
    * @alias module:api/CustomImageSearchApi
    * @class
    ...
    */
    ...
    /**
     * Callback function to receive the result of the customInstanceImageSearch operation.
     * @callback module:api/CustomImageSearchApi~customInstanceImageSearchCallback
     ...
     * @param {module:api/CustomImageSearchApi~customInstanceImageSearchCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/Images}
     */
    customInstanceImageSearch(xBingApisSDK, customConfig, q, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'xBingApisSDK' is set
      if (xBingApisSDK === undefined || xBingApisSDK === null) {
        throw new Error("Missing the required parameter 'xBingApisSDK' when calling customInstanceImageSearch");
      }
      // verify the required parameter 'customConfig' is set
      if (customConfig === undefined || customConfig === null) {
        throw new Error("Missing the required parameter 'customConfig' when calling customInstanceImageSearch");
      }
      // verify the required parameter 'q' is set
      if (q === undefined || q === null) {
        throw new Error("Missing the required parameter 'q' when calling customInstanceImageSearch");
      }
