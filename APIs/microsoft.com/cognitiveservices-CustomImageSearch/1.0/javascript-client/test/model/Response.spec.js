...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CustomImageSearchClient.Response();
  });
  ...
  describe('Response', function() {
    it('should create an instance of Response', function() {
      ...
      //var instance = new CustomImageSearchClient.Response();
      //expect(instance).to.be.a(CustomImageSearchClient.Response);
    });
