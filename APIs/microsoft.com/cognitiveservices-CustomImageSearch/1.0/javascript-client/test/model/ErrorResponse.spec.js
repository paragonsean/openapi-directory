...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CustomImageSearchClient.ErrorResponse();
  });
  ...
  describe('ErrorResponse', function() {
    it('should create an instance of ErrorResponse', function() {
      ...
      //var instance = new CustomImageSearchClient.ErrorResponse();
      //expect(instance).to.be.a(CustomImageSearchClient.ErrorResponse);
    });
