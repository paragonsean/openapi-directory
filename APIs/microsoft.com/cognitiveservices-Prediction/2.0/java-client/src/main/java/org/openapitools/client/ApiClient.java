...
public class ApiClient {
    ...
    private String basePath = "https://southcentralus.api.cognitive.microsoft.com/customvision/v2.0/Prediction";
    ...
    new ServerConfiguration(
      "{Endpoint}/customvision/v2.0/Prediction",
      "No description provided",
      new HashMap<String, ServerVariable>() {{
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://southcentralus.api.cognitive.microsoft.com/customvision/v2.0/Prediction
