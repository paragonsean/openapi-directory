...
<a id="predictImage"></a>
# **predictImage**
> ImagePrediction predictImage(projectId, predictionKey, imageData, iterationId, application)
...
public class Example {
  public static void main(String[] args) {
    ...
    defaultClient.setBasePath("https://southcentralus.api.cognitive.microsoft.com/customvision/v2.0/Prediction");
    ...
    try {
      ImagePrediction result = apiInstance.predictImage(projectId, predictionKey, imageData, iterationId, application);
...
# **predictImageUrl**
> ImagePrediction predictImageUrl(projectId, predictionKey, imageUrl, iterationId, application)
...
public class Example {
  public static void main(String[] args) {
    ...
    String application = "application_example"; // String | Optional. Specifies the name of application using the endpoint
    try {
      ImagePrediction result = apiInstance.predictImageUrl(projectId, predictionKey, imageUrl, iterationId, application);
      System.out.println(result);
    } catch (ApiException e) {
...
> ImagePrediction predictImageUrlWithNoStore(projectId, predictionKey, imageUrl, iterationId, application)
...
public class Example {
  public static void main(String[] args) {
    ...
    String application = "application_example"; // String | Optional. Specifies the name of application using the endpoint
    try {
      ImagePrediction result = apiInstance.predictImageUrlWithNoStore(projectId, predictionKey, imageUrl, iterationId, application);
      System.out.println(result);
    } catch (ApiException e) {
...
> ImagePrediction predictImageWithNoStore(projectId, predictionKey, imageData, iterationId, application)
...
public class Example {
  public static void main(String[] args) {
    ...
    String application = "application_example"; // String | Optional. Specifies the name of application using the endpoint
    try {
      ImagePrediction result = apiInstance.predictImageWithNoStore(projectId, predictionKey, imageData, iterationId, application);
      System.out.println(result);
    } catch (ApiException e) {
