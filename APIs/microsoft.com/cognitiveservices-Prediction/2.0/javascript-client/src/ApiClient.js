...
class ApiClient {
     ...
     */
    constructor(basePath = 'https://southcentralus.api.cognitive.microsoft.com/customvision/v2.0/Prediction') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default https://southcentralus.api.cognitive.microsoft.com/customvision/v2.0/Prediction
         */
