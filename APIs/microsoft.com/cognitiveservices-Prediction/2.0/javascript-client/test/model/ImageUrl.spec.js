...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CustomVisionPredictionClient.ImageUrl();
  });
  ...
  describe('ImageUrl', function() {
    it('should create an instance of ImageUrl', function() {
      ...
      //var instance = new CustomVisionPredictionClient.ImageUrl();
      //expect(instance).to.be.a(CustomVisionPredictionClient.ImageUrl);
    });
