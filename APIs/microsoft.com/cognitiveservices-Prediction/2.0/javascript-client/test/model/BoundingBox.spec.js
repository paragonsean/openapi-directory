...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CustomVisionPredictionClient.BoundingBox();
  });
  ...
  describe('BoundingBox', function() {
    it('should create an instance of BoundingBox', function() {
      ...
      //var instance = new CustomVisionPredictionClient.BoundingBox();
      //expect(instance).to.be.a(CustomVisionPredictionClient.BoundingBox);
    });
