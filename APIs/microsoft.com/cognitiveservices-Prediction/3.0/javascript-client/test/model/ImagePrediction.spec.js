...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CustomVisionPredictionClient.ImagePrediction();
  });
  ...
  describe('ImagePrediction', function() {
    it('should create an instance of ImagePrediction', function() {
      ...
      //var instance = new CustomVisionPredictionClient.ImagePrediction();
      //expect(instance).to.be.a(CustomVisionPredictionClient.ImagePrediction);
    });
