...
class ApiClient {
     ...
     */
    constructor(basePath = 'https://southcentralus.api.cognitive.microsoft.com/customvision/v3.0/prediction') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default https://southcentralus.api.cognitive.microsoft.com/customvision/v3.0/prediction
         */
        ...
        this.authentications = {
            'apim_key': {type: 'apiKey', 'in': 'header', name: 'Prediction-Key'}
        }
