...
public class ApiClient {
    ...
    private String basePath = "https://southcentralus.api.cognitive.microsoft.com/customvision/v3.0/prediction";
    ...
    new ServerConfiguration(
      "{Endpoint}/customvision/v3.0/prediction",
      "No description provided",
      new HashMap<String, ServerVariable>() {{
    ...
    public ApiClient() {
        ...
        authentications.put("apim_key", new ApiKeyAuth("header", "Prediction-Key"));
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://southcentralus.api.cognitive.microsoft.com/customvision/v3.0/prediction
