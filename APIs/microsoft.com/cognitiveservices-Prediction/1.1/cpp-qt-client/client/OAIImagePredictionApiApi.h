...
#include "OAIImagePredictionResultModel.h"
...
Q_SIGNALS:
    ...
    void predictImageSignal(OAIImagePredictionResultModel summary);
    void predictImageUrlSignal(OAIImagePredictionResultModel summary);
    void predictImageUrlWithNoStoreSignal(OAIImagePredictionResultModel summary);
    void predictImageWithNoStoreSignal(OAIImagePredictionResultModel summary);


    void predictImageSignalFull(OAIHttpRequestWorker *worker, OAIImagePredictionResultModel summary);
    void predictImageUrlSignalFull(OAIHttpRequestWorker *worker, OAIImagePredictionResultModel summary);
    void predictImageUrlWithNoStoreSignalFull(OAIHttpRequestWorker *worker, OAIImagePredictionResultModel summary);
    void predictImageWithNoStoreSignalFull(OAIHttpRequestWorker *worker, OAIImagePredictionResultModel summary);

    Q_DECL_DEPRECATED_X("Use predictImageSignalError() instead")
    void predictImageSignalE(OAIImagePredictionResultModel summary, QNetworkReply::NetworkError error_type, QString error_str);
    void predictImageSignalError(OAIImagePredictionResultModel summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use predictImageUrlSignalError() instead")
    void predictImageUrlSignalE(OAIImagePredictionResultModel summary, QNetworkReply::NetworkError error_type, QString error_str);
    void predictImageUrlSignalError(OAIImagePredictionResultModel summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use predictImageUrlWithNoStoreSignalError() instead")
    void predictImageUrlWithNoStoreSignalE(OAIImagePredictionResultModel summary, QNetworkReply::NetworkError error_type, QString error_str);
    void predictImageUrlWithNoStoreSignalError(OAIImagePredictionResultModel summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use predictImageWithNoStoreSignalError() instead")
    void predictImageWithNoStoreSignalE(OAIImagePredictionResultModel summary, QNetworkReply::NetworkError error_type, QString error_str);
    void predictImageWithNoStoreSignalError(OAIImagePredictionResultModel summary, QNetworkReply::NetworkError error_type, const QString &error_str);
