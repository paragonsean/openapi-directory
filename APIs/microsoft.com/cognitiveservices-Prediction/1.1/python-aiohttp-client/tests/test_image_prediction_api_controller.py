...
from openapi_server.models.image_prediction_result_model import ImagePredictionResultModel
...
async def test_predict_image(client):
    ...
    response = await client.request(
        method='POST',
        path='/customvision/v1.1/Prediction/{project_id}/image'.format(project_id='64b822c5-8082-4b36-a426-27225f4aa18c'),
        headers=headers,
        data=data,
        params=params,
        )
...
async def test_predict_image_url(client):
    ...
    response = await client.request(
        method='POST',
        path='/customvision/v1.1/Prediction/{project_id}/url'.format(project_id='64b822c5-8082-4b36-a426-27225f4aa18c'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_predict_image_url_with_no_store(client):
    ...
    response = await client.request(
        method='POST',
        path='/customvision/v1.1/Prediction/{project_id}/url/nostore'.format(project_id='project_id_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_predict_image_with_no_store(client):
    ...
    response = await client.request(
        method='POST',
        path='/customvision/v1.1/Prediction/{project_id}/image/nostore'.format(project_id='project_id_example'),
        headers=headers,
        data=data,
        params=params,
        )
