...
QString OAIAction::getDatePublished() const {
    return m_date_published;
}
void OAIAction::setDatePublished(const QString &date_published) {
    m_date_published = date_published;
    m_date_published_isSet = true;
}

bool OAIAction::is_date_published_Set() const{
    return m_date_published_isSet;
}

bool OAIAction::is_date_published_Valid() const{
...
QString OAIAction::getAlternateName() const {
    return m_alternate_name;
}
void OAIAction::setAlternateName(const QString &alternate_name) {
    m_alternate_name = alternate_name;
    m_alternate_name_isSet = true;
}

bool OAIAction::is_alternate_name_Set() const{
    return m_alternate_name_isSet;
}

bool OAIAction::is_alternate_name_Valid() const{
    return m_alternate_name_isValid;
}

QString OAIAction::getBingId() const {
    return m_bing_id;
}
void OAIAction::setBingId(const QString &bing_id) {
    m_bing_id = bing_id;
    m_bing_id_isSet = true;
}

bool OAIAction::is_bing_id_Set() const{
    return m_bing_id_isSet;
}

bool OAIAction::is_bing_id_Valid() const{
...
OAIImageObject OAIAction::getImage() const {
    return m_image;
}
void OAIAction::setImage(const OAIImageObject &image) {
    m_image = image;
    m_image_isSet = true;
}

bool OAIAction::is_image_Set() const{
    return m_image_isSet;
}

bool OAIAction::is_image_Valid() const{
