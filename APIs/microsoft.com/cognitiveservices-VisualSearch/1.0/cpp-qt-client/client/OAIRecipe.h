...
public:
    ...
    QString getCookTime() const;
    void setCookTime(const QString &cook_time);
    bool is_cook_time_Set() const;
    bool is_cook_time_Valid() const;

    QString getPrepTime() const;
    void setPrepTime(const QString &prep_time);
    bool is_prep_time_Set() const;
    bool is_prep_time_Valid() const;
...
private:
    ...
    QString m_cook_time;
    bool m_cook_time_isSet;
    bool m_cook_time_isValid;

    QString m_prep_time;
    bool m_prep_time_isSet;
    bool m_prep_time_isValid;
