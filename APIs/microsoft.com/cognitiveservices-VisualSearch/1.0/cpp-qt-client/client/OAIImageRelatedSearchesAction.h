...
/*
 * OAIImageRelatedSearchesAction.h
 *
 * Defines an related search action.
 */

#ifndef OAIImageRelatedSearchesAction_H
#define OAIImageRelatedSearchesAction_H
...
class OAIImageRelatedSearchesAction : public OAIObject {
public:
    OAIImageRelatedSearchesAction();
    OAIImageRelatedSearchesAction(QString json);
    ~OAIImageRelatedSearchesAction() override;
    ...
    OAIRelatedSearchesModule getData() const;
    void setData(const OAIRelatedSearchesModule &data);
...
private:
    ...
    OAIRelatedSearchesModule m_data;
    bool m_data_isSet;
    bool m_data_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIImageRelatedSearchesAction)

#endif // OAIImageRelatedSearchesAction_H
