...
public:
    ...
    OAIImagesImageMetadata getInsightsMetadata() const;
    void setInsightsMetadata(const OAIImagesImageMetadata &insights_metadata);
    bool is_insights_metadata_Set() const;
    bool is_insights_metadata_Valid() const;
...
private:
    ...
    OAIImagesImageMetadata m_insights_metadata;
    bool m_insights_metadata_isSet;
    bool m_insights_metadata_isValid;
