...
/*
 * OAIImageModuleAction.h
 *
 * Defines an image list action.
 */

#ifndef OAIImageModuleAction_H
#define OAIImageModuleAction_H
...
class OAIImageModuleAction : public OAIObject {
public:
    OAIImageModuleAction();
    OAIImageModuleAction(QString json);
    ~OAIImageModuleAction() override;
    ...
    OAIImagesModule getData() const;
    void setData(const OAIImagesModule &data);
...
Q_DECLARE_METATYPE(OpenAPI::OAIImageModuleAction)

#endif // OAIImageModuleAction_H
