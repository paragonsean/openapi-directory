...
/*
 * OAIImageShoppingSourcesAction.h
 *
 * Defines a shopping sources action.
 */

#ifndef OAIImageShoppingSourcesAction_H
#define OAIImageShoppingSourcesAction_H
...
class OAIImageShoppingSourcesAction : public OAIObject {
public:
    OAIImageShoppingSourcesAction();
    OAIImageShoppingSourcesAction(QString json);
    ~OAIImageShoppingSourcesAction() override;
    ...
    OAIAggregateOffer getData() const;
    void setData(const OAIAggregateOffer &data);
...
Q_DECLARE_METATYPE(OpenAPI::OAIImageShoppingSourcesAction)

#endif // OAIImageShoppingSourcesAction_H
