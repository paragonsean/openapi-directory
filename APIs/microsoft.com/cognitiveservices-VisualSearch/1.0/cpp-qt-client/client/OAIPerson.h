...
public:
    ...
    QString getTwitterProfile() const;
    void setTwitterProfile(const QString &twitter_profile);
    bool is_twitter_profile_Set() const;
    bool is_twitter_profile_Valid() const;
...
private:
    ...
    QString m_twitter_profile;
    bool m_twitter_profile_isSet;
    bool m_twitter_profile_isValid;
