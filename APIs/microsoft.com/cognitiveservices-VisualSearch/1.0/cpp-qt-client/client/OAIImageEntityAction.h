...
/*
 * OAIImageEntityAction.h
 *
 * Defines an entity action.
 */

#ifndef OAIImageEntityAction_H
#define OAIImageEntityAction_H
...
class OAIImageEntityAction : public OAIObject {
public:
    OAIImageEntityAction();
    OAIImageEntityAction(QString json);
    ~OAIImageEntityAction() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIImageEntityAction)

#endif // OAIImageEntityAction_H
