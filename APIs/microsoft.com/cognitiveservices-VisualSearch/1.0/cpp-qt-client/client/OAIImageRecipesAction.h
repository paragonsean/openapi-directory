...
/*
 * OAIImageRecipesAction.h
 *
 * Defines an recipe action.
 */

#ifndef OAIImageRecipesAction_H
#define OAIImageRecipesAction_H
...
class OAIImageRecipesAction : public OAIObject {
public:
    OAIImageRecipesAction();
    OAIImageRecipesAction(QString json);
    ~OAIImageRecipesAction() override;
    ...
    OAIRecipesModule getData() const;
    void setData(const OAIRecipesModule &data);
...
Q_DECLARE_METATYPE(OpenAPI::OAIImageRecipesAction)

#endif // OAIImageRecipesAction_H
