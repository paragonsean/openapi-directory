...
OAIAggregateOffer::OAIAggregateOffer(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAggregateOffer::OAIAggregateOffer() {
    this->initializeModel();
}

OAIAggregateOffer::~OAIAggregateOffer() {}

void OAIAggregateOffer::initializeModel() {
...
void OAIAggregateOffer::fromJson(QString jsonString) {
...
void OAIAggregateOffer::fromJsonObject(QJsonObject json) {
...
QString OAIAggregateOffer::asJson() const {
...
QJsonObject OAIAggregateOffer::asJsonObject() const {
    QJsonObject obj;
    if (m_offers.size() > 0) {
...
QList<OAIOffer> OAIAggregateOffer::getOffers() const {
    return m_offers;
}
void OAIAggregateOffer::setOffers(const QList<OAIOffer> &offers) {
    m_offers = offers;
    m_offers_isSet = true;
}

bool OAIAggregateOffer::is_offers_Set() const{
    return m_offers_isSet;
}

bool OAIAggregateOffer::is_offers_Valid() const{
    return m_offers_isValid;
}

OAIAggregateRating OAIAggregateOffer::getAggregateRating() const {
    return m_aggregate_rating;
}
void OAIAggregateOffer::setAggregateRating(const OAIAggregateRating &aggregate_rating) {
    m_aggregate_rating = aggregate_rating;
    m_aggregate_rating_isSet = true;
}

bool OAIAggregateOffer::is_aggregate_rating_Set() const{
    return m_aggregate_rating_isSet;
}

bool OAIAggregateOffer::is_aggregate_rating_Valid() const{
    return m_aggregate_rating_isValid;
}

QString OAIAggregateOffer::getAvailability() const {
    return m_availability;
}
void OAIAggregateOffer::setAvailability(const QString &availability) {
    m_availability = availability;
    m_availability_isSet = true;
}

bool OAIAggregateOffer::is_availability_Set() const{
    return m_availability_isSet;
}

bool OAIAggregateOffer::is_availability_Valid() const{
    return m_availability_isValid;
}

QString OAIAggregateOffer::getLastUpdated() const {
    return m_last_updated;
}
void OAIAggregateOffer::setLastUpdated(const QString &last_updated) {
    m_last_updated = last_updated;
    m_last_updated_isSet = true;
}

bool OAIAggregateOffer::is_last_updated_Set() const{
    return m_last_updated_isSet;
}

bool OAIAggregateOffer::is_last_updated_Valid() const{
    return m_last_updated_isValid;
}

float OAIAggregateOffer::getPrice() const {
    return m_price;
}
void OAIAggregateOffer::setPrice(const float &price) {
    m_price = price;
    m_price_isSet = true;
}

bool OAIAggregateOffer::is_price_Set() const{
    return m_price_isSet;
}

bool OAIAggregateOffer::is_price_Valid() const{
    return m_price_isValid;
}

QString OAIAggregateOffer::getPriceCurrency() const {
    return m_price_currency;
}
void OAIAggregateOffer::setPriceCurrency(const QString &price_currency) {
    m_price_currency = price_currency;
    m_price_currency_isSet = true;
}

bool OAIAggregateOffer::is_price_currency_Set() const{
    return m_price_currency_isSet;
}

bool OAIAggregateOffer::is_price_currency_Valid() const{
    return m_price_currency_isValid;
}

OAIOrganization OAIAggregateOffer::getSeller() const {
    return m_seller;
}
void OAIAggregateOffer::setSeller(const OAIOrganization &seller) {
    m_seller = seller;
    m_seller_isSet = true;
}

bool OAIAggregateOffer::is_seller_Set() const{
    return m_seller_isSet;
}

bool OAIAggregateOffer::is_seller_Valid() const{
    return m_seller_isValid;
}

QString OAIAggregateOffer::getAlternateName() const {
    return m_alternate_name;
}
void OAIAggregateOffer::setAlternateName(const QString &alternate_name) {
    m_alternate_name = alternate_name;
    m_alternate_name_isSet = true;
}

bool OAIAggregateOffer::is_alternate_name_Set() const{
    return m_alternate_name_isSet;
}

bool OAIAggregateOffer::is_alternate_name_Valid() const{
    return m_alternate_name_isValid;
}

QString OAIAggregateOffer::getBingId() const {
    return m_bing_id;
}
void OAIAggregateOffer::setBingId(const QString &bing_id) {
    m_bing_id = bing_id;
    m_bing_id_isSet = true;
}

bool OAIAggregateOffer::is_bing_id_Set() const{
    return m_bing_id_isSet;
}

bool OAIAggregateOffer::is_bing_id_Valid() const{
    return m_bing_id_isValid;
}

QString OAIAggregateOffer::getDescription() const {
    return m_description;
}
void OAIAggregateOffer::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAIAggregateOffer::is_description_Set() const{
    return m_description_isSet;
}

bool OAIAggregateOffer::is_description_Valid() const{
    return m_description_isValid;
}

OAIImageObject OAIAggregateOffer::getImage() const {
    return m_image;
}
void OAIAggregateOffer::setImage(const OAIImageObject &image) {
    m_image = image;
    m_image_isSet = true;
}

bool OAIAggregateOffer::is_image_Set() const{
    return m_image_isSet;
}

bool OAIAggregateOffer::is_image_Valid() const{
    return m_image_isValid;
}

QString OAIAggregateOffer::getName() const {
    return m_name;
}
void OAIAggregateOffer::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIAggregateOffer::is_name_Set() const{
    return m_name_isSet;
}

bool OAIAggregateOffer::is_name_Valid() const{
    return m_name_isValid;
}

QString OAIAggregateOffer::getUrl() const {
    return m_url;
}
void OAIAggregateOffer::setUrl(const QString &url) {
    m_url = url;
    m_url_isSet = true;
}

bool OAIAggregateOffer::is_url_Set() const{
    return m_url_isSet;
}

bool OAIAggregateOffer::is_url_Valid() const{
    return m_url_isValid;
}

QString OAIAggregateOffer::getReadLink() const {
    return m_read_link;
}
void OAIAggregateOffer::setReadLink(const QString &read_link) {
    m_read_link = read_link;
    m_read_link_isSet = true;
}

bool OAIAggregateOffer::is_read_link_Set() const{
    return m_read_link_isSet;
}

bool OAIAggregateOffer::is_read_link_Valid() const{
    return m_read_link_isValid;
}

QString OAIAggregateOffer::getWebSearchUrl() const {
    return m_web_search_url;
}
void OAIAggregateOffer::setWebSearchUrl(const QString &web_search_url) {
    m_web_search_url = web_search_url;
    m_web_search_url_isSet = true;
}

bool OAIAggregateOffer::is_web_search_url_Set() const{
    return m_web_search_url_isSet;
}

bool OAIAggregateOffer::is_web_search_url_Valid() const{
    return m_web_search_url_isValid;
}

QString OAIAggregateOffer::getId() const {
    return m_id;
}
void OAIAggregateOffer::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIAggregateOffer::is_id_Set() const{
    return m_id_isSet;
}

bool OAIAggregateOffer::is_id_Valid() const{
    return m_id_isValid;
}

QString OAIAggregateOffer::getType() const {
    return m__type;
}
void OAIAggregateOffer::setType(const QString &_type) {
    m__type = _type;
    m__type_isSet = true;
}

bool OAIAggregateOffer::is__type_Set() const{
    return m__type_isSet;
}

bool OAIAggregateOffer::is__type_Valid() const{
    return m__type_isValid;
}

bool OAIAggregateOffer::isSet() const {
...
bool OAIAggregateOffer::isValid() const {
