...
#ifndef OAIImageAction_H
#define OAIImageAction_H
...
class OAIImageAction : public OAIObject {
public:
    OAIImageAction();
    OAIImageAction(QString json);
    ~OAIImageAction() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIImageAction)

#endif // OAIImageAction_H
