...
OAIImageAction::OAIImageAction(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIImageAction::OAIImageAction() {
    this->initializeModel();
}

OAIImageAction::~OAIImageAction() {}

void OAIImageAction::initializeModel() {
...
void OAIImageAction::fromJson(QString jsonString) {
...
void OAIImageAction::fromJsonObject(QJsonObject json) {
...
QString OAIImageAction::asJson() const {
...
QJsonObject OAIImageAction::asJsonObject() const {
    QJsonObject obj;
    if (m__type_isSet) {
...
QString OAIImageAction::getType() const {
    return m__type;
}
void OAIImageAction::setType(const QString &_type) {
    m__type = _type;
    m__type_isSet = true;
}

bool OAIImageAction::is__type_Set() const{
    return m__type_isSet;
}

bool OAIImageAction::is__type_Valid() const{
    return m__type_isValid;
}

QString OAIImageAction::getActionType() const {
    return m_action_type;
}
void OAIImageAction::setActionType(const QString &action_type) {
    m_action_type = action_type;
    m_action_type_isSet = true;
}

bool OAIImageAction::is_action_type_Set() const{
    return m_action_type_isSet;
}

bool OAIImageAction::is_action_type_Valid() const{
    return m_action_type_isValid;
}

QString OAIImageAction::getDisplayName() const {
    return m_display_name;
}
void OAIImageAction::setDisplayName(const QString &display_name) {
    m_display_name = display_name;
    m_display_name_isSet = true;
}

bool OAIImageAction::is_display_name_Set() const{
    return m_display_name_isSet;
}

bool OAIImageAction::is_display_name_Valid() const{
    return m_display_name_isValid;
}

bool OAIImageAction::isIsTopAction() const {
    return m_is_top_action;
}
void OAIImageAction::setIsTopAction(const bool &is_top_action) {
    m_is_top_action = is_top_action;
    m_is_top_action_isSet = true;
}

bool OAIImageAction::is_is_top_action_Set() const{
    return m_is_top_action_isSet;
}

bool OAIImageAction::is_is_top_action_Valid() const{
    return m_is_top_action_isValid;
}

QList<OAIThing> OAIImageAction::getResult() const {
    return m_result;
}
void OAIImageAction::setResult(const QList<OAIThing> &result) {
    m_result = result;
    m_result_isSet = true;
}

bool OAIImageAction::is_result_Set() const{
    return m_result_isSet;
}

bool OAIImageAction::is_result_Valid() const{
    return m_result_isValid;
}

QString OAIImageAction::getServiceUrl() const {
    return m_service_url;
}
void OAIImageAction::setServiceUrl(const QString &service_url) {
    m_service_url = service_url;
    m_service_url_isSet = true;
}

bool OAIImageAction::is_service_url_Set() const{
    return m_service_url_isSet;
}

bool OAIImageAction::is_service_url_Valid() const{
    return m_service_url_isValid;
}

QString OAIImageAction::getDatePublished() const {
    return m_date_published;
}
void OAIImageAction::setDatePublished(const QString &date_published) {
    m_date_published = date_published;
    m_date_published_isSet = true;
}

bool OAIImageAction::is_date_published_Set() const{
    return m_date_published_isSet;
}

bool OAIImageAction::is_date_published_Valid() const{
    return m_date_published_isValid;
}

QList<OAIThing> OAIImageAction::getProvider() const {
    return m_provider;
}
void OAIImageAction::setProvider(const QList<OAIThing> &provider) {
    m_provider = provider;
    m_provider_isSet = true;
}

bool OAIImageAction::is_provider_Set() const{
    return m_provider_isSet;
}

bool OAIImageAction::is_provider_Valid() const{
    return m_provider_isValid;
}

QString OAIImageAction::getText() const {
    return m_text;
}
void OAIImageAction::setText(const QString &text) {
    m_text = text;
    m_text_isSet = true;
}

bool OAIImageAction::is_text_Set() const{
    return m_text_isSet;
}

bool OAIImageAction::is_text_Valid() const{
    return m_text_isValid;
}

QString OAIImageAction::getThumbnailUrl() const {
    return m_thumbnail_url;
}
void OAIImageAction::setThumbnailUrl(const QString &thumbnail_url) {
    m_thumbnail_url = thumbnail_url;
    m_thumbnail_url_isSet = true;
}

bool OAIImageAction::is_thumbnail_url_Set() const{
    return m_thumbnail_url_isSet;
}

bool OAIImageAction::is_thumbnail_url_Valid() const{
    return m_thumbnail_url_isValid;
}

QString OAIImageAction::getAlternateName() const {
    return m_alternate_name;
}
void OAIImageAction::setAlternateName(const QString &alternate_name) {
    m_alternate_name = alternate_name;
    m_alternate_name_isSet = true;
}

bool OAIImageAction::is_alternate_name_Set() const{
    return m_alternate_name_isSet;
}

bool OAIImageAction::is_alternate_name_Valid() const{
    return m_alternate_name_isValid;
}

QString OAIImageAction::getBingId() const {
    return m_bing_id;
}
void OAIImageAction::setBingId(const QString &bing_id) {
    m_bing_id = bing_id;
    m_bing_id_isSet = true;
}

bool OAIImageAction::is_bing_id_Set() const{
    return m_bing_id_isSet;
}

bool OAIImageAction::is_bing_id_Valid() const{
    return m_bing_id_isValid;
}

QString OAIImageAction::getDescription() const {
    return m_description;
}
void OAIImageAction::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAIImageAction::is_description_Set() const{
    return m_description_isSet;
}

bool OAIImageAction::is_description_Valid() const{
    return m_description_isValid;
}

OAIImageObject OAIImageAction::getImage() const {
    return m_image;
}
void OAIImageAction::setImage(const OAIImageObject &image) {
    m_image = image;
    m_image_isSet = true;
}

bool OAIImageAction::is_image_Set() const{
    return m_image_isSet;
}

bool OAIImageAction::is_image_Valid() const{
    return m_image_isValid;
}

QString OAIImageAction::getName() const {
    return m_name;
}
void OAIImageAction::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIImageAction::is_name_Set() const{
    return m_name_isSet;
}

bool OAIImageAction::is_name_Valid() const{
    return m_name_isValid;
}

QString OAIImageAction::getUrl() const {
    return m_url;
}
void OAIImageAction::setUrl(const QString &url) {
    m_url = url;
    m_url_isSet = true;
}

bool OAIImageAction::is_url_Set() const{
    return m_url_isSet;
}

bool OAIImageAction::is_url_Valid() const{
    return m_url_isValid;
}

QString OAIImageAction::getReadLink() const {
    return m_read_link;
}
void OAIImageAction::setReadLink(const QString &read_link) {
    m_read_link = read_link;
    m_read_link_isSet = true;
}

bool OAIImageAction::is_read_link_Set() const{
    return m_read_link_isSet;
}

bool OAIImageAction::is_read_link_Valid() const{
    return m_read_link_isValid;
}

QString OAIImageAction::getWebSearchUrl() const {
    return m_web_search_url;
}
void OAIImageAction::setWebSearchUrl(const QString &web_search_url) {
    m_web_search_url = web_search_url;
    m_web_search_url_isSet = true;
}

bool OAIImageAction::is_web_search_url_Set() const{
    return m_web_search_url_isSet;
}

bool OAIImageAction::is_web_search_url_Valid() const{
    return m_web_search_url_isValid;
}

QString OAIImageAction::getId() const {
    return m_id;
}
void OAIImageAction::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIImageAction::is_id_Set() const{
    return m_id_isSet;
}

bool OAIImageAction::is_id_Valid() const{
    return m_id_isValid;
}

bool OAIImageAction::isSet() const {
...
bool OAIImageAction::isValid() const {
