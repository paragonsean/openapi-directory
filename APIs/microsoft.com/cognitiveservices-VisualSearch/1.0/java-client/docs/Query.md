...
|------------ | ------------- | ------------- | -------------|
|**displayText** | **String** | The display version of the query term. |  [optional] [readonly] |
...
|**webSearchUrl** | **String** | The URL that takes the user to the Bing search results page for the query. |  [optional] [readonly] |
