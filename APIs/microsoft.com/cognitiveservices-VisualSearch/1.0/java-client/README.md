...
- API version: 1.0
  - Build date: 2024-10-12T10:10:56.690028-04:00[America/New_York]
...
import org.openapitools.client.api.ImageVisualSearchApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    ImageVisualSearchApi apiInstance = new ImageVisualSearchApi(defaultClient);
    ...
    String contentType = "contentType_example"; // String | Must be set to multipart/form-data and include a boundary parameter (for example, multipart/form-data; boundary=<boundary string>). For more details, see [Content form types]( https://docs.microsoft.com/en-us/azure/cognitive-services/bing-visual-search/overview#content-form-types).
...
## Documentation for Models
 ...
 - [CropArea](docs/CropArea.md)
 - [Error](docs/Error.md)
 - [ErrorResponse](docs/ErrorResponse.md)
 - [Filters](docs/Filters.md)
 - [Identifiable](docs/Identifiable.md)
 - [ImageAction](docs/ImageAction.md)
 - [ImageEntityAction](docs/ImageEntityAction.md)
 - [ImageInfo](docs/ImageInfo.md)
 - [ImageKnowledge](docs/ImageKnowledge.md)
 - [ImageModuleAction](docs/ImageModuleAction.md)
 - [ImageObject](docs/ImageObject.md)
 - [ImageRecipesAction](docs/ImageRecipesAction.md)
 - [ImageRelatedSearchesAction](docs/ImageRelatedSearchesAction.md)
 - [ImageShoppingSourcesAction](docs/ImageShoppingSourcesAction.md)
 - [ImageTag](docs/ImageTag.md)
 - [ImageTagRegion](docs/ImageTagRegion.md)
 - [ImagesImageMetadata](docs/ImagesImageMetadata.md)
 - [ImagesModule](docs/ImagesModule.md)
 - [ImagesVisualSearchRequest](docs/ImagesVisualSearchRequest.md)
 - [Intangible](docs/Intangible.md)
 - [KnowledgeRequest](docs/KnowledgeRequest.md)
 - [MediaObject](docs/MediaObject.md)
 - [NormalizedQuadrilateral](docs/NormalizedQuadrilateral.md)
 - [Offer](docs/Offer.md)
 ...
 - [Thing](docs/Thing.md)
 - [VisualSearchRequest](docs/VisualSearchRequest.md)
