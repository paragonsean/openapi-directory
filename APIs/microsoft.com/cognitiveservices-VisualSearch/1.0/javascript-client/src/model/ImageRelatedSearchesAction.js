...
/**
 * The ImageRelatedSearchesAction model module.
 * @module model/ImageRelatedSearchesAction
 * @version 1.0
 */
class ImageRelatedSearchesAction {
    /**
     * Constructs a new <code>ImageRelatedSearchesAction</code>.
     * Defines an related search action.
     * @alias module:model/ImageRelatedSearchesAction
     * @extends module:model/ImageAction
     * @implements module:model/ImageAction
     */
    constructor() { 
        ImageAction.initialize(this);
        ImageRelatedSearchesAction.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ImageRelatedSearchesAction</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ImageRelatedSearchesAction} obj Optional instance to populate.
     * @return {module:model/ImageRelatedSearchesAction} The populated <code>ImageRelatedSearchesAction</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ImageRelatedSearchesAction();
            ImageAction.constructFromObject(data, obj);
            ImageAction.constructFromObject(data, obj);

            if (data.hasOwnProperty('data')) {
                obj['data'] = RelatedSearchesModule.constructFromObject(data['data']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ImageRelatedSearchesAction</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ImageRelatedSearchesAction</code>.
     */
    static validateJSON(data) {
        // validate the optional field `data`
        if (data['data']) { // data not null
          RelatedSearchesModule.validateJSON(data['data']);
        }
...
/**
 * @member {module:model/RelatedSearchesModule} data
 */
ImageRelatedSearchesAction.prototype['data'] = undefined;
...
export default ImageRelatedSearchesAction;
