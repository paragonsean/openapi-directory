...
/**
 * The ImageRecipesAction model module.
 * @module model/ImageRecipesAction
 * @version 1.0
 */
class ImageRecipesAction {
    /**
     * Constructs a new <code>ImageRecipesAction</code>.
     * Defines an recipe action.
     * @alias module:model/ImageRecipesAction
     * @extends module:model/ImageAction
     * @implements module:model/ImageAction
     */
    constructor() { 
        ImageAction.initialize(this);
        ImageRecipesAction.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ImageRecipesAction</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ImageRecipesAction} obj Optional instance to populate.
     * @return {module:model/ImageRecipesAction} The populated <code>ImageRecipesAction</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ImageRecipesAction();
            ImageAction.constructFromObject(data, obj);
            ImageAction.constructFromObject(data, obj);

            if (data.hasOwnProperty('data')) {
                obj['data'] = RecipesModule.constructFromObject(data['data']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ImageRecipesAction</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ImageRecipesAction</code>.
     */
    static validateJSON(data) {
        // validate the optional field `data`
        if (data['data']) { // data not null
          RecipesModule.validateJSON(data['data']);
        }
...
/**
 * @member {module:model/RecipesModule} data
 */
ImageRecipesAction.prototype['data'] = undefined;
...
export default ImageRecipesAction;
