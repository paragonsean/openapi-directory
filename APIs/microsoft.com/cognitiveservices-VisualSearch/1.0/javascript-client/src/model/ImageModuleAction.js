...
/**
 * The ImageModuleAction model module.
 * @module model/ImageModuleAction
 * @version 1.0
 */
class ImageModuleAction {
    /**
     * Constructs a new <code>ImageModuleAction</code>.
     * Defines an image list action.
     * @alias module:model/ImageModuleAction
     * @extends module:model/ImageAction
     * @implements module:model/ImageAction
     */
    constructor() { 
        ImageAction.initialize(this);
        ImageModuleAction.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ImageModuleAction</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ImageModuleAction} obj Optional instance to populate.
     * @return {module:model/ImageModuleAction} The populated <code>ImageModuleAction</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ImageModuleAction();
            ImageAction.constructFromObject(data, obj);
            ImageAction.constructFromObject(data, obj);

            if (data.hasOwnProperty('data')) {
                obj['data'] = ImagesModule.constructFromObject(data['data']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ImageModuleAction</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ImageModuleAction</code>.
     */
    static validateJSON(data) {
        // validate the optional field `data`
        if (data['data']) { // data not null
          ImagesModule.validateJSON(data['data']);
        }
...
/**
 * @member {module:model/ImagesModule} data
 */
ImageModuleAction.prototype['data'] = undefined;
...
export default ImageModuleAction;
