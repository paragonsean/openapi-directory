...
/**
 * The ImageEntityAction model module.
 * @module model/ImageEntityAction
 * @version 1.0
 */
class ImageEntityAction {
    /**
     * Constructs a new <code>ImageEntityAction</code>.
     * Defines an entity action.
     * @alias module:model/ImageEntityAction
     * @extends module:model/ImageAction
     * @implements module:model/ImageAction
     */
    constructor() { 
        ImageAction.initialize(this);
        ImageEntityAction.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ImageEntityAction</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ImageEntityAction} obj Optional instance to populate.
     * @return {module:model/ImageEntityAction} The populated <code>ImageEntityAction</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ImageEntityAction();
    ...
    /**
     * Validates the JSON data with respect to <code>ImageEntityAction</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ImageEntityAction</code>.
     */
...
export default ImageEntityAction;
