...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VisualSearchClient.ImageRecipesAction();
  });
  ...
  describe('ImageRecipesAction', function() {
    it('should create an instance of ImageRecipesAction', function() {
      // uncomment below and update the code to test ImageRecipesAction
      //var instance = new VisualSearchClient.ImageRecipesAction();
      //expect(instance).to.be.a(VisualSearchClient.ImageRecipesAction);
    });
