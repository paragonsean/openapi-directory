...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VisualSearchClient.ImageAction();
  });
  ...
  describe('ImageAction', function() {
    it('should create an instance of ImageAction', function() {
      // uncomment below and update the code to test ImageAction
      //var instance = new VisualSearchClient.ImageAction();
      //expect(instance).to.be.a(VisualSearchClient.ImageAction);
    });
