...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VisualSearchClient.RecipesModule();
  });
  ...
  describe('RecipesModule', function() {
    it('should create an instance of RecipesModule', function() {
      ...
      //var instance = new VisualSearchClient.RecipesModule();
      //expect(instance).to.be.a(VisualSearchClient.RecipesModule);
    });
