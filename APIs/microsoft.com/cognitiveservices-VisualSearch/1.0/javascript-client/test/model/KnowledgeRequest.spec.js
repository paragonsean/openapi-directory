...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VisualSearchClient.KnowledgeRequest();
  });
  ...
  describe('KnowledgeRequest', function() {
    it('should create an instance of KnowledgeRequest', function() {
      // uncomment below and update the code to test KnowledgeRequest
      //var instance = new VisualSearchClient.KnowledgeRequest();
      //expect(instance).to.be.a(VisualSearchClient.KnowledgeRequest);
    });
