...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VisualSearchClient.Recipe();
  });
  ...
  describe('Recipe', function() {
    it('should create an instance of Recipe', function() {
      ...
      //var instance = new VisualSearchClient.Recipe();
      //expect(instance).to.be.a(VisualSearchClient.Recipe);
    });

    it('should have the property cookTime (base name: "cookTime")', function() {
      // uncomment below and update the code to test the property cookTime
      //var instance = new VisualSearchClient.Recipe();
      //expect(instance).to.be();
    });

    it('should have the property prepTime (base name: "prepTime")', function() {
