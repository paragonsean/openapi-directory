...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VisualSearchClient.StructuredValue();
  });
  ...
  describe('StructuredValue', function() {
    it('should create an instance of StructuredValue', function() {
      ...
      //var instance = new VisualSearchClient.StructuredValue();
      //expect(instance).to.be.a(VisualSearchClient.StructuredValue);
    });
