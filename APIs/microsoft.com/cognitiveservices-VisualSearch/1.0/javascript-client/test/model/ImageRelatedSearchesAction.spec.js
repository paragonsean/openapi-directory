...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VisualSearchClient.ImageRelatedSearchesAction();
  });
  ...
  describe('ImageRelatedSearchesAction', function() {
    it('should create an instance of ImageRelatedSearchesAction', function() {
      // uncomment below and update the code to test ImageRelatedSearchesAction
      //var instance = new VisualSearchClient.ImageRelatedSearchesAction();
      //expect(instance).to.be.a(VisualSearchClient.ImageRelatedSearchesAction);
    });
