...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VisualSearchClient.ImageEntityAction();
  });
  ...
  describe('ImageEntityAction', function() {
    it('should create an instance of ImageEntityAction', function() {
      // uncomment below and update the code to test ImageEntityAction
      //var instance = new VisualSearchClient.ImageEntityAction();
      //expect(instance).to.be.a(VisualSearchClient.ImageEntityAction);
    });
