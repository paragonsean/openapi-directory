...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VisualSearchClient.ImageShoppingSourcesAction();
  });
  ...
  describe('ImageShoppingSourcesAction', function() {
    it('should create an instance of ImageShoppingSourcesAction', function() {
      // uncomment below and update the code to test ImageShoppingSourcesAction
      //var instance = new VisualSearchClient.ImageShoppingSourcesAction();
      //expect(instance).to.be.a(VisualSearchClient.ImageShoppingSourcesAction);
    });
