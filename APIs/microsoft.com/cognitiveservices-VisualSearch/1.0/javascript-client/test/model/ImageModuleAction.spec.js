...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VisualSearchClient.ImageModuleAction();
  });
  ...
  describe('ImageModuleAction', function() {
    it('should create an instance of ImageModuleAction', function() {
      // uncomment below and update the code to test ImageModuleAction
      //var instance = new VisualSearchClient.ImageModuleAction();
      //expect(instance).to.be.a(VisualSearchClient.ImageModuleAction);
    });
