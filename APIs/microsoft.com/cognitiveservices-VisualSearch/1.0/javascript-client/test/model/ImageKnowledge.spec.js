...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VisualSearchClient.ImageKnowledge();
  });
  ...
  describe('ImageKnowledge', function() {
    it('should create an instance of ImageKnowledge', function() {
      // uncomment below and update the code to test ImageKnowledge
      //var instance = new VisualSearchClient.ImageKnowledge();
      //expect(instance).to.be.a(VisualSearchClient.ImageKnowledge);
    });
