...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VisualSearchClient.CropArea();
  });
  ...
  describe('CropArea', function() {
    it('should create an instance of CropArea', function() {
      // uncomment below and update the code to test CropArea
      //var instance = new VisualSearchClient.CropArea();
      //expect(instance).to.be.a(VisualSearchClient.CropArea);
    });
