...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VisualSearchClient.Action();
  });
  ...
  describe('Action', function() {
    it('should create an instance of Action', function() {
      ...
      //var instance = new VisualSearchClient.Action();
      //expect(instance).to.be.a(VisualSearchClient.Action);
    });
    ...
    it('should have the property isTopAction (base name: "isTopAction")', function() {
      // uncomment below and update the code to test the property isTopAction
      //var instance = new VisualSearchClient.Action();
      //expect(instance).to.be();
    });
