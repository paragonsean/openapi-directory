...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VisualSearchClient.AggregateOffer();
  });
  ...
  describe('AggregateOffer', function() {
    it('should create an instance of AggregateOffer', function() {
      // uncomment below and update the code to test AggregateOffer
      //var instance = new VisualSearchClient.AggregateOffer();
      //expect(instance).to.be.a(VisualSearchClient.AggregateOffer);
    });
