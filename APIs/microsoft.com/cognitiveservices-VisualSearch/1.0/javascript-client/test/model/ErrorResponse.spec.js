...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VisualSearchClient.ErrorResponse();
  });
  ...
  describe('ErrorResponse', function() {
    it('should create an instance of ErrorResponse', function() {
      ...
      //var instance = new VisualSearchClient.ErrorResponse();
      //expect(instance).to.be.a(VisualSearchClient.ErrorResponse);
    });
