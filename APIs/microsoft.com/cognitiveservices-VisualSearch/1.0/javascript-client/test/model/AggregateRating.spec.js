...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VisualSearchClient.AggregateRating();
  });
  ...
  describe('AggregateRating', function() {
    it('should create an instance of AggregateRating', function() {
      // uncomment below and update the code to test AggregateRating
      //var instance = new VisualSearchClient.AggregateRating();
      //expect(instance).to.be.a(VisualSearchClient.AggregateRating);
    });
