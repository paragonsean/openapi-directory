...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VisualSearchClient.RelatedSearchesModule();
  });
  ...
  describe('RelatedSearchesModule', function() {
    it('should create an instance of RelatedSearchesModule', function() {
      // uncomment below and update the code to test RelatedSearchesModule
      //var instance = new VisualSearchClient.RelatedSearchesModule();
      //expect(instance).to.be.a(VisualSearchClient.RelatedSearchesModule);
    });
