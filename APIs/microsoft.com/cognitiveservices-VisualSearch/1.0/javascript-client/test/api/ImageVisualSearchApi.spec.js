...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VisualSearchClient.ImageVisualSearchApi();
  });
  ...
  describe('ImageVisualSearchApi', function() {
    describe('imagesVisualSearch', function() {
      it('should call imagesVisualSearch successfully', function(done) {
        //uncomment below and update the code to test imagesVisualSearch
        //instance.imagesVisualSearch(function(error) {
