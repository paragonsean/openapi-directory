...
class ImageObject(Model):
    ...
    def __init__(self, thumbnail: ImageObject=None, content_url: str=None, height: int=None, host_page_url: str=None, width: int=None, provider: List[Thing]=None, text: str=None, thumbnail_url: str=None, alternate_name: str=None, bing_id: str=None, description: str=None, image: ImageObject=None, name: str=None, url: str=None, web_search_url: str=None, id: str=None, type: str=None):
