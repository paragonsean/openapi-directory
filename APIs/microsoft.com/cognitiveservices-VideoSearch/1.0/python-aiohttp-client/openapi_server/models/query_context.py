...
class QueryContext(Model):
    ...
    def __init__(self, adult_intent: bool=None, alteration_override_query: str=None, altered_query: str=None, ask_user_for_location: bool=None, is_transactional: bool=None, original_query: str=None):
