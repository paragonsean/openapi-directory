...
VideoSearchClient - JavaScript client for video_search_client
...
```shell
npm install video_search_client --save
```
...
To use the link you just defined in your project, switch to the directory you want to use your video_search_client from, and run:
...
```javascript
var VideoSearchClient = require('video_search_client');

var defaultClient = VideoSearchClient.ApiClient.instance;
...
var api = new VideoSearchClient.VideoDetailSearchApi()
var xBingApisSDK = "xBingApisSDK_example"; // {String} Activate swagger compliance
var q = "q_example"; // {String} The user's search query string. The query string cannot be empty. The query string may contain [Bing Advanced Operators](http://msdn.microsoft.com/library/ff795620.aspx). For example, to limit videos to a specific domain, use the [site:](http://msdn.microsoft.com/library/ff795613.aspx) operator. Use this parameter only with the Video Search API. Do not specify this parameter when calling the Trending Videos API.
var opts = {
...
api.videosDetails(xBingApisSDK, q, opts, callback);
...
------------ | ------------- | ------------- | -------------
*VideoSearchClient.VideoDetailSearchApi* | [**videosDetails**](docs/VideoDetailSearchApi.md#videosDetails) | **GET** /videos/details | The Video Detail Search API lets you search on Bing and get back insights about a video, such as related videos. This section provides technical details about the query parameters and headers that you use to request insights of videos and the JSON response objects that contain them. For examples that show how to make requests, see [Searching the Web for Videos](https://docs.microsoft.com/azure/cognitive-services/bing-video-search/search-the-web).
*VideoSearchClient.VideoSearchApi* | [**videosSearch**](docs/VideoSearchApi.md#videosSearch) | **GET** /videos/search | The Video Search API lets you send a search query to Bing and get back a list of videos that are relevant to the search query. This section provides technical details about the query parameters and headers that you use to request videos and the JSON response objects that contain them. For examples that show how to make requests, see [Searching the Web for Videos](https://docs.microsoft.com/azure/cognitive-services/bing-video-search/search-the-web).
*VideoSearchClient.VideoTrendingSearchApi* | [**videosTrending**](docs/VideoTrendingSearchApi.md#videosTrending) | **GET** /videos/trending | The Video Trending Search API lets you search on Bing and get back a list of videos that are trending based on search requests made by others. The videos are broken out into different categories. For example, Top Music Videos. For a list of markets that support trending videos, see [Trending Videos](https://docs.microsoft.com/azure/cognitive-services/bing-video-search/trending-videos).


## Documentation for Models

 - [VideoSearchClient.Answer](docs/Answer.md)
 - [VideoSearchClient.CreativeWork](docs/CreativeWork.md)
 - [VideoSearchClient.Error](docs/Error.md)
 - [VideoSearchClient.ErrorResponse](docs/ErrorResponse.md)
 - [VideoSearchClient.Identifiable](docs/Identifiable.md)
 - [VideoSearchClient.ImageObject](docs/ImageObject.md)
 - [VideoSearchClient.MediaObject](docs/MediaObject.md)
 - [VideoSearchClient.PivotSuggestions](docs/PivotSuggestions.md)
 - [VideoSearchClient.Query](docs/Query.md)
 - [VideoSearchClient.QueryContext](docs/QueryContext.md)
 - [VideoSearchClient.Response](docs/Response.md)
 - [VideoSearchClient.ResponseBase](docs/ResponseBase.md)
 - [VideoSearchClient.SearchResultsAnswer](docs/SearchResultsAnswer.md)
 - [VideoSearchClient.Thing](docs/Thing.md)
 - [VideoSearchClient.TrendingVideos](docs/TrendingVideos.md)
 - [VideoSearchClient.TrendingVideosCategory](docs/TrendingVideosCategory.md)
 - [VideoSearchClient.TrendingVideosSubcategory](docs/TrendingVideosSubcategory.md)
 - [VideoSearchClient.TrendingVideosTile](docs/TrendingVideosTile.md)
 - [VideoSearchClient.VideoDetails](docs/VideoDetails.md)
 - [VideoSearchClient.VideoObject](docs/VideoObject.md)
 - [VideoSearchClient.Videos](docs/Videos.md)
 - [VideoSearchClient.VideosModule](docs/VideosModule.md)
