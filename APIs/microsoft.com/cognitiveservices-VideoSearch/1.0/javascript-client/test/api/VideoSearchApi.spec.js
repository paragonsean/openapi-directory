...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VideoSearchClient.VideoSearchApi();
  });
  ...
  describe('VideoSearchApi', function() {
    describe('videosSearch', function() {
      it('should call videosSearch successfully', function(done) {
        //uncomment below and update the code to test videosSearch
        //instance.videosSearch(function(error) {
