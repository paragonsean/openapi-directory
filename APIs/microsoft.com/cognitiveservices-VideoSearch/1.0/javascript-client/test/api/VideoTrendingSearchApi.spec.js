...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VideoSearchClient.VideoTrendingSearchApi();
  });
  ...
  describe('VideoTrendingSearchApi', function() {
    describe('videosTrending', function() {
      it('should call videosTrending successfully', function(done) {
        //uncomment below and update the code to test videosTrending
        //instance.videosTrending(function(error) {
