...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VideoSearchClient.VideoDetailSearchApi();
  });
  ...
  describe('VideoDetailSearchApi', function() {
    describe('videosDetails', function() {
      it('should call videosDetails successfully', function(done) {
        //uncomment below and update the code to test videosDetails
        //instance.videosDetails(function(error) {
