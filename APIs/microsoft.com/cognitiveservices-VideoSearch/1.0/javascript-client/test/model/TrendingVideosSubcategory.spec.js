...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VideoSearchClient.TrendingVideosSubcategory();
  });
  ...
  describe('TrendingVideosSubcategory', function() {
    it('should create an instance of TrendingVideosSubcategory', function() {
      // uncomment below and update the code to test TrendingVideosSubcategory
      //var instance = new VideoSearchClient.TrendingVideosSubcategory();
      //expect(instance).to.be.a(VideoSearchClient.TrendingVideosSubcategory);
    });
