...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VideoSearchClient.PivotSuggestions();
  });
  ...
  describe('PivotSuggestions', function() {
    it('should create an instance of PivotSuggestions', function() {
      // uncomment below and update the code to test PivotSuggestions
      //var instance = new VideoSearchClient.PivotSuggestions();
      //expect(instance).to.be.a(VideoSearchClient.PivotSuggestions);
    });
