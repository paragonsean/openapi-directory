...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VideoSearchClient.TrendingVideosTile();
  });
  ...
  describe('TrendingVideosTile', function() {
    it('should create an instance of TrendingVideosTile', function() {
      // uncomment below and update the code to test TrendingVideosTile
      //var instance = new VideoSearchClient.TrendingVideosTile();
      //expect(instance).to.be.a(VideoSearchClient.TrendingVideosTile);
    });
