...
/**
* VideoDetailSearch service.
* @module api/VideoDetailSearchApi
* @version 1.0
*/
export default class VideoDetailSearchApi {

    /**
    * Constructs a new VideoDetailSearchApi. 
    * @alias module:api/VideoDetailSearchApi
    * @class
    ...
    */
    ...
    /**
     * Callback function to receive the result of the videosDetails operation.
     * @callback module:api/VideoDetailSearchApi~videosDetailsCallback
     ...
     * @param {module:api/VideoDetailSearchApi~videosDetailsCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/VideoDetails}
     */
    videosDetails(xBingApisSDK, q, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'xBingApisSDK' is set
      if (xBingApisSDK === undefined || xBingApisSDK === null) {
        throw new Error("Missing the required parameter 'xBingApisSDK' when calling videosDetails");
      }
      // verify the required parameter 'q' is set
      if (q === undefined || q === null) {
        throw new Error("Missing the required parameter 'q' when calling videosDetails");
      }
