...
/**
* VideoSearch service.
* @module api/VideoSearchApi
* @version 1.0
*/
export default class VideoSearchApi {

    /**
    * Constructs a new VideoSearchApi. 
    * @alias module:api/VideoSearchApi
    * @class
    ...
    */
    ...
    /**
     * Callback function to receive the result of the videosSearch operation.
     * @callback module:api/VideoSearchApi~videosSearchCallback
     * @param {String} error Error message, if any.
     * @param {module:model/Videos} data The data returned by the service call.
     ...
     * @param {module:api/VideoSearchApi~videosSearchCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/Videos}
     */
    videosSearch(xBingApisSDK, q, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'xBingApisSDK' is set
      if (xBingApisSDK === undefined || xBingApisSDK === null) {
        throw new Error("Missing the required parameter 'xBingApisSDK' when calling videosSearch");
      }
      // verify the required parameter 'q' is set
      if (q === undefined || q === null) {
        throw new Error("Missing the required parameter 'q' when calling videosSearch");
      }
