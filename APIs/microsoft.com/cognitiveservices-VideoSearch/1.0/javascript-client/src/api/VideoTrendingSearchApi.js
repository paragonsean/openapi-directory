...
/**
* VideoTrendingSearch service.
* @module api/VideoTrendingSearchApi
* @version 1.0
*/
export default class VideoTrendingSearchApi {

    /**
    * Constructs a new VideoTrendingSearchApi. 
    * @alias module:api/VideoTrendingSearchApi
    * @class
    ...
    */
    ...
    /**
     * Callback function to receive the result of the videosTrending operation.
     * @callback module:api/VideoTrendingSearchApi~videosTrendingCallback
     * @param {String} error Error message, if any.
     * @param {module:model/TrendingVideos} data The data returned by the service call.
     ...
     * @param {module:api/VideoTrendingSearchApi~videosTrendingCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/TrendingVideos}
     */
    videosTrending(xBingApisSDK, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'xBingApisSDK' is set
      if (xBingApisSDK === undefined || xBingApisSDK === null) {
        throw new Error("Missing the required parameter 'xBingApisSDK' when calling videosTrending");
      }
