...
Video Search Client
- API version: 1.0
  - Build date: 2024-10-12T10:10:48.256609-04:00[America/New_York]
...
import org.openapitools.client.api.VideoDetailSearchApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    VideoDetailSearchApi apiInstance = new VideoDetailSearchApi(defaultClient);
    String xBingApisSDK = "true"; // String | Activate swagger compliance
    String q = "q_example"; // String | The user's search query string. The query string cannot be empty. The query string may contain [Bing Advanced Operators](http://msdn.microsoft.com/library/ff795620.aspx). For example, to limit videos to a specific domain, use the [site:](http://msdn.microsoft.com/library/ff795613.aspx) operator. Use this parameter only with the Video Search API. Do not specify this parameter when calling the Trending Videos API.
    ...
    String id = "id_example"; // String | An ID that uniquely identifies a video. The [Video](https://docs.microsoft.com/en-us/rest/api/cognitiveservices/bing-video-api-v7-reference#video) object's videoId field contains the ID that you set this parameter to. You use this parameter to identify the video to get insights of.
    ...
    try {
      VideoDetails result = apiInstance.videosDetails(xBingApisSDK, q, accept, acceptLanguage, userAgent, xMSEdgeClientID, xMSEdgeClientIP, xSearchLocation, cc, id, modules, mkt, resolution, safeSearch, setLang, textDecorations, textFormat);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling VideoDetailSearchApi#videosDetails");
...
------------ | ------------- | ------------- | -------------
*VideoDetailSearchApi* | [**videosDetails**](docs/VideoDetailSearchApi.md#videosDetails) | **GET** /videos/details | The Video Detail Search API lets you search on Bing and get back insights about a video, such as related videos. This section provides technical details about the query parameters and headers that you use to request insights of videos and the JSON response objects that contain them. For examples that show how to make requests, see [Searching the Web for Videos](https://docs.microsoft.com/azure/cognitive-services/bing-video-search/search-the-web).
*VideoSearchApi* | [**videosSearch**](docs/VideoSearchApi.md#videosSearch) | **GET** /videos/search | The Video Search API lets you send a search query to Bing and get back a list of videos that are relevant to the search query. This section provides technical details about the query parameters and headers that you use to request videos and the JSON response objects that contain them. For examples that show how to make requests, see [Searching the Web for Videos](https://docs.microsoft.com/azure/cognitive-services/bing-video-search/search-the-web).
*VideoTrendingSearchApi* | [**videosTrending**](docs/VideoTrendingSearchApi.md#videosTrending) | **GET** /videos/trending | The Video Trending Search API lets you search on Bing and get back a list of videos that are trending based on search requests made by others. The videos are broken out into different categories. For example, Top Music Videos. For a list of markets that support trending videos, see [Trending Videos](https://docs.microsoft.com/azure/cognitive-services/bing-video-search/trending-videos).
...
## Documentation for Models
 ...
 - [Thing](docs/Thing.md)
 - [TrendingVideos](docs/TrendingVideos.md)
 - [TrendingVideosCategory](docs/TrendingVideosCategory.md)
 - [TrendingVideosSubcategory](docs/TrendingVideosSubcategory.md)
 - [TrendingVideosTile](docs/TrendingVideosTile.md)
 - [VideoDetails](docs/VideoDetails.md)
 - [VideoObject](docs/VideoObject.md)
 - [Videos](docs/Videos.md)
 - [VideosModule](docs/VideosModule.md)
