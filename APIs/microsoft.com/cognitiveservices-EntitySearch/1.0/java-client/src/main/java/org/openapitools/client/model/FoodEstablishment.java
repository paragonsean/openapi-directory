...
public class FoodEstablishment extends LocalBusiness {
  ...
  public String toString() {
    ...
    sb.append("class FoodEstablishment {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to FoodEstablishment
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!FoodEstablishment.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FoodEstablishment is not found in the empty JSON string", FoodEstablishment.openapiRequiredFields.toString()));
        }
      }
  ...
  /**
   * Create an instance of FoodEstablishment given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of FoodEstablishment
   * @throws IOException if the JSON string is invalid with respect to FoodEstablishment
   */
  public static FoodEstablishment fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FoodEstablishment.class);
  }

  /**
   * Convert an instance of FoodEstablishment to an JSON string
   *
   * @return JSON string
   */
