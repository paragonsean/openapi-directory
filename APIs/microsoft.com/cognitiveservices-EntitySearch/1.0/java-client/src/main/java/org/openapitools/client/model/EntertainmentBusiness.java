...
public class EntertainmentBusiness extends LocalBusiness {
  ...
  public String toString() {
    ...
    sb.append("class EntertainmentBusiness {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to EntertainmentBusiness
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EntertainmentBusiness.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EntertainmentBusiness is not found in the empty JSON string", EntertainmentBusiness.openapiRequiredFields.toString()));
        }
      }
  ...
  /**
   * Create an instance of EntertainmentBusiness given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of EntertainmentBusiness
   * @throws IOException if the JSON string is invalid with respect to EntertainmentBusiness
   */
  public static EntertainmentBusiness fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EntertainmentBusiness.class);
  }

  /**
   * Convert an instance of EntertainmentBusiness to an JSON string
   *
   * @return JSON string
   */
