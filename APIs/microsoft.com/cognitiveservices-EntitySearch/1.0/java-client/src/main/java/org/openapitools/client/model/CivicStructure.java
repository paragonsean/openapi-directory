...
public class CivicStructure extends Place {
  ...
  public String toString() {
    ...
    sb.append("class CivicStructure {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CivicStructure
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CivicStructure.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CivicStructure is not found in the empty JSON string", CivicStructure.openapiRequiredFields.toString()));
        }
      }
  ...
  /**
   * Create an instance of CivicStructure given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CivicStructure
   * @throws IOException if the JSON string is invalid with respect to CivicStructure
   */
  public static CivicStructure fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CivicStructure.class);
  }

  /**
   * Convert an instance of CivicStructure to an JSON string
   *
   * @return JSON string
   */
