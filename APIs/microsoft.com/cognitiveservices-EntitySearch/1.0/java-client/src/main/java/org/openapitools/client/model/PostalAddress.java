...
public class PostalAddress extends StructuredValue {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(addressCountry, addressLocality, addressRegion, addressRegionAbbreviation, addressSubregion, countryIso, neighborhood, postOfficeBoxNumber, postalCode, streetAddress, text, super.hashCode());
  }
