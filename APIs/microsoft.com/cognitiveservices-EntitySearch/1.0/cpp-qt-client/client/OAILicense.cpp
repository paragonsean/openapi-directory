...
QList<OAIThing> OAILicense::getProvider() const {
    return m_provider;
}
void OAILicense::setProvider(const QList<OAIThing> &provider) {
    m_provider = provider;
    m_provider_isSet = true;
}

bool OAILicense::is_provider_Set() const{
    return m_provider_isSet;
}

bool OAILicense::is_provider_Valid() const{
    return m_provider_isValid;
}

QString OAILicense::getText() const {
    return m_text;
}
void OAILicense::setText(const QString &text) {
    m_text = text;
    m_text_isSet = true;
}

bool OAILicense::is_text_Set() const{
    return m_text_isSet;
}

bool OAILicense::is_text_Valid() const{
    return m_text_isValid;
}

QString OAILicense::getThumbnailUrl() const {
    return m_thumbnail_url;
}
void OAILicense::setThumbnailUrl(const QString &thumbnail_url) {
    m_thumbnail_url = thumbnail_url;
    m_thumbnail_url_isSet = true;
}

bool OAILicense::is_thumbnail_url_Set() const{
    return m_thumbnail_url_isSet;
}

bool OAILicense::is_thumbnail_url_Valid() const{
    return m_thumbnail_url_isValid;
}

QString OAILicense::getBingId() const {
    return m_bing_id;
}
void OAILicense::setBingId(const QString &bing_id) {
    m_bing_id = bing_id;
    m_bing_id_isSet = true;
}

bool OAILicense::is_bing_id_Set() const{
    return m_bing_id_isSet;
}

bool OAILicense::is_bing_id_Valid() const{
...
OAIEntitiesEntityPresentationInfo OAILicense::getEntityPresentationInfo() const {
    return m_entity_presentation_info;
}
void OAILicense::setEntityPresentationInfo(const OAIEntitiesEntityPresentationInfo &entity_presentation_info) {
    m_entity_presentation_info = entity_presentation_info;
    m_entity_presentation_info_isSet = true;
}

bool OAILicense::is_entity_presentation_info_Set() const{
    return m_entity_presentation_info_isSet;
}

bool OAILicense::is_entity_presentation_info_Valid() const{
    return m_entity_presentation_info_isValid;
}

OAIImageObject OAILicense::getImage() const {
    return m_image;
}
void OAILicense::setImage(const OAIImageObject &image) {
    m_image = image;
    m_image_isSet = true;
}

bool OAILicense::is_image_Set() const{
    return m_image_isSet;
}

bool OAILicense::is_image_Valid() const{
...
QList<OAIContractualRulesContractualRule> OAILicense::getContractualRules() const {
    return m_contractual_rules;
}
void OAILicense::setContractualRules(const QList<OAIContractualRulesContractualRule> &contractual_rules) {
    m_contractual_rules = contractual_rules;
    m_contractual_rules_isSet = true;
}

bool OAILicense::is_contractual_rules_Set() const{
    return m_contractual_rules_isSet;
}

bool OAILicense::is_contractual_rules_Valid() const{
    return m_contractual_rules_isValid;
}

QString OAILicense::getWebSearchUrl() const {
    return m_web_search_url;
}
void OAILicense::setWebSearchUrl(const QString &web_search_url) {
    m_web_search_url = web_search_url;
    m_web_search_url_isSet = true;
}

bool OAILicense::is_web_search_url_Set() const{
    return m_web_search_url_isSet;
}

bool OAILicense::is_web_search_url_Valid() const{
...
void OAILicense::setType(const QString &_type) {
    m__type = _type;
    m__type_isSet = true;
}

bool OAILicense::is__type_Set() const{
    return m__type_isSet;
}

bool OAILicense::is__type_Valid() const{
