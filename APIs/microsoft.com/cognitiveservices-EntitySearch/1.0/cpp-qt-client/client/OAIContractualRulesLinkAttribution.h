...
/*
 * OAIContractualRulesLinkAttribution.h
 *
 * Defines a contractual rule for link attribution.
 */

#ifndef OAIContractualRulesLinkAttribution_H
#define OAIContractualRulesLinkAttribution_H
...
class OAIContractualRulesLinkAttribution : public OAIObject {
public:
    OAIContractualRulesLinkAttribution();
    OAIContractualRulesLinkAttribution(QString json);
    ~OAIContractualRulesLinkAttribution() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIContractualRulesLinkAttribution)

#endif // OAIContractualRulesLinkAttribution_H
