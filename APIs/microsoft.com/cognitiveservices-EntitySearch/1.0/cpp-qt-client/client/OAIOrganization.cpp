...
OAIEntitiesEntityPresentationInfo OAIOrganization::getEntityPresentationInfo() const {
    return m_entity_presentation_info;
}
void OAIOrganization::setEntityPresentationInfo(const OAIEntitiesEntityPresentationInfo &entity_presentation_info) {
    m_entity_presentation_info = entity_presentation_info;
    m_entity_presentation_info_isSet = true;
}

bool OAIOrganization::is_entity_presentation_info_Set() const{
    return m_entity_presentation_info_isSet;
}

bool OAIOrganization::is_entity_presentation_info_Valid() const{
...
QList<OAIContractualRulesContractualRule> OAIOrganization::getContractualRules() const {
    return m_contractual_rules;
}
void OAIOrganization::setContractualRules(const QList<OAIContractualRulesContractualRule> &contractual_rules) {
    m_contractual_rules = contractual_rules;
    m_contractual_rules_isSet = true;
}

bool OAIOrganization::is_contractual_rules_Set() const{
    return m_contractual_rules_isSet;
}

bool OAIOrganization::is_contractual_rules_Valid() const{
