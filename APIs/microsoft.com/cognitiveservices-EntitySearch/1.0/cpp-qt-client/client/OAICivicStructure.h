...
#ifndef OAICivicStructure_H
#define OAICivicStructure_H
...
class OAICivicStructure : public OAIObject {
public:
    OAICivicStructure();
    OAICivicStructure(QString json);
    ~OAICivicStructure() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICivicStructure)

#endif // OAICivicStructure_H
