...
/*
 * OAIContractualRulesAttribution.h
 *
 * 
 */

#ifndef OAIContractualRulesAttribution_H
#define OAIContractualRulesAttribution_H
...
class OAIContractualRulesAttribution : public OAIObject {
public:
    OAIContractualRulesAttribution();
    OAIContractualRulesAttribution(QString json);
    ~OAIContractualRulesAttribution() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIContractualRulesAttribution)

#endif // OAIContractualRulesAttribution_H
