...
QList<OAIContractualRulesContractualRule> OAIErrorResponse::getContractualRules() const {
    return m_contractual_rules;
}
void OAIErrorResponse::setContractualRules(const QList<OAIContractualRulesContractualRule> &contractual_rules) {
    m_contractual_rules = contractual_rules;
    m_contractual_rules_isSet = true;
}

bool OAIErrorResponse::is_contractual_rules_Set() const{
    return m_contractual_rules_isSet;
}

bool OAIErrorResponse::is_contractual_rules_Valid() const{
