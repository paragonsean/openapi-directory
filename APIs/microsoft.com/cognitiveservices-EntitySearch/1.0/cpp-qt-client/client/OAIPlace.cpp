...
QString OAIPlace::getBingId() const {
    return m_bing_id;
}
void OAIPlace::setBingId(const QString &bing_id) {
    m_bing_id = bing_id;
    m_bing_id_isSet = true;
}

bool OAIPlace::is_bing_id_Set() const{
    return m_bing_id_isSet;
}

bool OAIPlace::is_bing_id_Valid() const{
    return m_bing_id_isValid;
}

QString OAIPlace::getDescription() const {
    return m_description;
}
void OAIPlace::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAIPlace::is_description_Set() const{
    return m_description_isSet;
}

bool OAIPlace::is_description_Valid() const{
...
OAIImageObject OAIPlace::getImage() const {
    return m_image;
}
void OAIPlace::setImage(const OAIImageObject &image) {
    m_image = image;
    m_image_isSet = true;
}

bool OAIPlace::is_image_Set() const{
    return m_image_isSet;
}

bool OAIPlace::is_image_Valid() const{
...
QList<OAIContractualRulesContractualRule> OAIPlace::getContractualRules() const {
    return m_contractual_rules;
}
void OAIPlace::setContractualRules(const QList<OAIContractualRulesContractualRule> &contractual_rules) {
    m_contractual_rules = contractual_rules;
    m_contractual_rules_isSet = true;
}

bool OAIPlace::is_contractual_rules_Set() const{
    return m_contractual_rules_isSet;
}

bool OAIPlace::is_contractual_rules_Valid() const{
