...
QList<OAIContractualRulesContractualRule> OAIResponse::getContractualRules() const {
    return m_contractual_rules;
}
void OAIResponse::setContractualRules(const QList<OAIContractualRulesContractualRule> &contractual_rules) {
    m_contractual_rules = contractual_rules;
    m_contractual_rules_isSet = true;
}

bool OAIResponse::is_contractual_rules_Set() const{
    return m_contractual_rules_isSet;
}

bool OAIResponse::is_contractual_rules_Valid() const{
