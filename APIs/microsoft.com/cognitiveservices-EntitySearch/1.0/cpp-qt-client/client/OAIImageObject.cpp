...
OAIEntitiesEntityPresentationInfo OAIImageObject::getEntityPresentationInfo() const {
    return m_entity_presentation_info;
}
void OAIImageObject::setEntityPresentationInfo(const OAIEntitiesEntityPresentationInfo &entity_presentation_info) {
    m_entity_presentation_info = entity_presentation_info;
    m_entity_presentation_info_isSet = true;
}

bool OAIImageObject::is_entity_presentation_info_Set() const{
    return m_entity_presentation_info_isSet;
}

bool OAIImageObject::is_entity_presentation_info_Valid() const{
...
QList<OAIContractualRulesContractualRule> OAIImageObject::getContractualRules() const {
    return m_contractual_rules;
}
void OAIImageObject::setContractualRules(const QList<OAIContractualRulesContractualRule> &contractual_rules) {
    m_contractual_rules = contractual_rules;
    m_contractual_rules_isSet = true;
}

bool OAIImageObject::is_contractual_rules_Set() const{
    return m_contractual_rules_isSet;
}

bool OAIImageObject::is_contractual_rules_Valid() const{
