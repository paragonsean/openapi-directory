...
QList<OAIContractualRulesContractualRule> OAIAnswer::getContractualRules() const {
    return m_contractual_rules;
}
void OAIAnswer::setContractualRules(const QList<OAIContractualRulesContractualRule> &contractual_rules) {
    m_contractual_rules = contractual_rules;
    m_contractual_rules_isSet = true;
}

bool OAIAnswer::is_contractual_rules_Set() const{
    return m_contractual_rules_isSet;
}

bool OAIAnswer::is_contractual_rules_Valid() const{
