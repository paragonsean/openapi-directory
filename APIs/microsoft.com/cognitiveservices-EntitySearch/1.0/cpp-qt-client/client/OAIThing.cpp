...
QList<OAIContractualRulesContractualRule> OAIThing::getContractualRules() const {
    return m_contractual_rules;
}
void OAIThing::setContractualRules(const QList<OAIContractualRulesContractualRule> &contractual_rules) {
    m_contractual_rules = contractual_rules;
    m_contractual_rules_isSet = true;
}

bool OAIThing::is_contractual_rules_Set() const{
    return m_contractual_rules_isSet;
}

bool OAIThing::is_contractual_rules_Valid() const{
