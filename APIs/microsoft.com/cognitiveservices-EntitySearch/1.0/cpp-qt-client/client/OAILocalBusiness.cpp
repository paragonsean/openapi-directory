...
OAILocalBusiness::OAILocalBusiness(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAILocalBusiness::OAILocalBusiness() {
    this->initializeModel();
}

OAILocalBusiness::~OAILocalBusiness() {}

void OAILocalBusiness::initializeModel() {
...
void OAILocalBusiness::fromJson(QString jsonString) {
...
void OAILocalBusiness::fromJsonObject(QJsonObject json) {
...
QString OAILocalBusiness::asJson() const {
...
QJsonObject OAILocalBusiness::asJsonObject() const {
    QJsonObject obj;
...
bool OAILocalBusiness::isIsPermanentlyClosed() const {
    return m_is_permanently_closed;
}
void OAILocalBusiness::setIsPermanentlyClosed(const bool &is_permanently_closed) {
    m_is_permanently_closed = is_permanently_closed;
    m_is_permanently_closed_isSet = true;
}

bool OAILocalBusiness::is_is_permanently_closed_Set() const{
    return m_is_permanently_closed_isSet;
}

bool OAILocalBusiness::is_is_permanently_closed_Valid() const{
    return m_is_permanently_closed_isValid;
}

QList<OAIImageObject> OAILocalBusiness::getPanoramas() const {
    return m_panoramas;
}
void OAILocalBusiness::setPanoramas(const QList<OAIImageObject> &panoramas) {
    m_panoramas = panoramas;
    m_panoramas_isSet = true;
}

bool OAILocalBusiness::is_panoramas_Set() const{
    return m_panoramas_isSet;
}

bool OAILocalBusiness::is_panoramas_Valid() const{
    return m_panoramas_isValid;
}

QString OAILocalBusiness::getPriceRange() const {
    return m_price_range;
}
void OAILocalBusiness::setPriceRange(const QString &price_range) {
    m_price_range = price_range;
    m_price_range_isSet = true;
}

bool OAILocalBusiness::is_price_range_Set() const{
    return m_price_range_isSet;
}

bool OAILocalBusiness::is_price_range_Valid() const{
    return m_price_range_isValid;
}

QString OAILocalBusiness::getTagLine() const {
    return m_tag_line;
}
void OAILocalBusiness::setTagLine(const QString &tag_line) {
    m_tag_line = tag_line;
    m_tag_line_isSet = true;
}

bool OAILocalBusiness::is_tag_line_Set() const{
    return m_tag_line_isSet;
}

bool OAILocalBusiness::is_tag_line_Valid() const{
    return m_tag_line_isValid;
}

OAIPostalAddress OAILocalBusiness::getAddress() const {
    return m_address;
}
void OAILocalBusiness::setAddress(const OAIPostalAddress &address) {
    m_address = address;
    m_address_isSet = true;
}

bool OAILocalBusiness::is_address_Set() const{
    return m_address_isSet;
}

bool OAILocalBusiness::is_address_Valid() const{
    return m_address_isValid;
}

QString OAILocalBusiness::getTelephone() const {
    return m_telephone;
}
void OAILocalBusiness::setTelephone(const QString &telephone) {
    m_telephone = telephone;
    m_telephone_isSet = true;
}

bool OAILocalBusiness::is_telephone_Set() const{
    return m_telephone_isSet;
}

bool OAILocalBusiness::is_telephone_Valid() const{
    return m_telephone_isValid;
}

QString OAILocalBusiness::getBingId() const {
    return m_bing_id;
}
void OAILocalBusiness::setBingId(const QString &bing_id) {
    m_bing_id = bing_id;
    m_bing_id_isSet = true;
}

bool OAILocalBusiness::is_bing_id_Set() const{
    return m_bing_id_isSet;
}

bool OAILocalBusiness::is_bing_id_Valid() const{
    return m_bing_id_isValid;
}

QString OAILocalBusiness::getDescription() const {
    return m_description;
}
void OAILocalBusiness::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAILocalBusiness::is_description_Set() const{
    return m_description_isSet;
}

bool OAILocalBusiness::is_description_Valid() const{
    return m_description_isValid;
}

OAIEntitiesEntityPresentationInfo OAILocalBusiness::getEntityPresentationInfo() const {
    return m_entity_presentation_info;
}
void OAILocalBusiness::setEntityPresentationInfo(const OAIEntitiesEntityPresentationInfo &entity_presentation_info) {
    m_entity_presentation_info = entity_presentation_info;
    m_entity_presentation_info_isSet = true;
}

bool OAILocalBusiness::is_entity_presentation_info_Set() const{
    return m_entity_presentation_info_isSet;
}

bool OAILocalBusiness::is_entity_presentation_info_Valid() const{
    return m_entity_presentation_info_isValid;
}

OAIImageObject OAILocalBusiness::getImage() const {
    return m_image;
}
void OAILocalBusiness::setImage(const OAIImageObject &image) {
    m_image = image;
    m_image_isSet = true;
}

bool OAILocalBusiness::is_image_Set() const{
    return m_image_isSet;
}

bool OAILocalBusiness::is_image_Valid() const{
    return m_image_isValid;
}

QString OAILocalBusiness::getName() const {
    return m_name;
}
void OAILocalBusiness::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAILocalBusiness::is_name_Set() const{
    return m_name_isSet;
}

bool OAILocalBusiness::is_name_Valid() const{
    return m_name_isValid;
}

QString OAILocalBusiness::getUrl() const {
    return m_url;
}
void OAILocalBusiness::setUrl(const QString &url) {
    m_url = url;
    m_url_isSet = true;
}

bool OAILocalBusiness::is_url_Set() const{
    return m_url_isSet;
}

bool OAILocalBusiness::is_url_Valid() const{
    return m_url_isValid;
}

QList<OAIContractualRulesContractualRule> OAILocalBusiness::getContractualRules() const {
    return m_contractual_rules;
}
void OAILocalBusiness::setContractualRules(const QList<OAIContractualRulesContractualRule> &contractual_rules) {
    m_contractual_rules = contractual_rules;
    m_contractual_rules_isSet = true;
}

bool OAILocalBusiness::is_contractual_rules_Set() const{
    return m_contractual_rules_isSet;
}

bool OAILocalBusiness::is_contractual_rules_Valid() const{
    return m_contractual_rules_isValid;
}

QString OAILocalBusiness::getWebSearchUrl() const {
    return m_web_search_url;
}
void OAILocalBusiness::setWebSearchUrl(const QString &web_search_url) {
    m_web_search_url = web_search_url;
    m_web_search_url_isSet = true;
}

bool OAILocalBusiness::is_web_search_url_Set() const{
    return m_web_search_url_isSet;
}

bool OAILocalBusiness::is_web_search_url_Valid() const{
    return m_web_search_url_isValid;
}

QString OAILocalBusiness::getId() const {
    return m_id;
}
void OAILocalBusiness::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAILocalBusiness::is_id_Set() const{
    return m_id_isSet;
}

bool OAILocalBusiness::is_id_Valid() const{
    return m_id_isValid;
}

QString OAILocalBusiness::getType() const {
    return m__type;
}
void OAILocalBusiness::setType(const QString &_type) {
    m__type = _type;
    m__type_isSet = true;
}

bool OAILocalBusiness::is__type_Set() const{
    return m__type_isSet;
}

bool OAILocalBusiness::is__type_Valid() const{
    return m__type_isValid;
}

bool OAILocalBusiness::isSet() const {
...
bool OAILocalBusiness::isValid() const {
