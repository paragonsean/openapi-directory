...
public:
    ...
    QString getHotelClass() const;
    void setHotelClass(const QString &hotel_class);
    bool is_hotel_class_Set() const;
    bool is_hotel_class_Valid() const;
...
private:
    ...
    QString m_hotel_class;
    bool m_hotel_class_isSet;
    bool m_hotel_class_isValid;
