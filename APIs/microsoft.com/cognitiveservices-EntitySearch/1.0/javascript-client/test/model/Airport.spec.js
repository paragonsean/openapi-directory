...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EntitySearchClient.Airport();
  });
  ...
  describe('Airport', function() {
    it('should create an instance of Airport', function() {
      ...
      //var instance = new EntitySearchClient.Airport();
      //expect(instance).to.be.a(EntitySearchClient.Airport);
    });
    ...
    it('should have the property icaoCode (base name: "icaoCode")', function() {
