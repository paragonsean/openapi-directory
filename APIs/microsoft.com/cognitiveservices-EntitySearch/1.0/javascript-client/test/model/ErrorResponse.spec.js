...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EntitySearchClient.ErrorResponse();
  });
  ...
  describe('ErrorResponse', function() {
    it('should create an instance of ErrorResponse', function() {
      ...
      //var instance = new EntitySearchClient.ErrorResponse();
      //expect(instance).to.be.a(EntitySearchClient.ErrorResponse);
    });
