...
* @module api/EntitySearchApi
* @version 1.0
*/
export default class EntitySearchApi {

    /**
    * Constructs a new EntitySearchApi. 
    * @alias module:api/EntitySearchApi
    * @class
    ...
    */
    ...
    /**
     * Callback function to receive the result of the entitiesSearch operation.
     * @callback module:api/EntitySearchApi~entitiesSearchCallback
     ...
     * @param {Array.<module:model/String>} [responseFilter] A comma-delimited list of answers to include in the response. If you do not specify this parameter, the response includes all search answers for which there's relevant data.
     ...
     * @param {module:api/EntitySearchApi~entitiesSearchCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/SearchResponse}
     */
    entitiesSearch(xBingApisSDK, q, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'xBingApisSDK' is set
      if (xBingApisSDK === undefined || xBingApisSDK === null) {
        throw new Error("Missing the required parameter 'xBingApisSDK' when calling entitiesSearch");
      }
      // verify the required parameter 'q' is set
      if (q === undefined || q === null) {
        throw new Error("Missing the required parameter 'q' when calling entitiesSearch");
      }
