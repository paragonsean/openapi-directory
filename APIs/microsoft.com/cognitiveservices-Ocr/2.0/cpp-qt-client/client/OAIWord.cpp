...
QList<double> OAIWord::getBoundingBox() const {
    return m_bounding_box;
}
void OAIWord::setBoundingBox(const QList<double> &bounding_box) {
...
QString OAIWord::getConfidence() const {
    return m_confidence;
}
void OAIWord::setConfidence(const QString &confidence) {
