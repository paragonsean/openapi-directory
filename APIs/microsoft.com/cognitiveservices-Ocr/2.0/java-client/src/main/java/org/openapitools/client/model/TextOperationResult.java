...
public class TextOperationResult {
  ...
  public TextOperationResult recognitionResult(TextRecognitionResult recognitionResult) {
  ...
  public TextOperationResult status(OperationStatus status) {
    this.status = status;
    return this;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("recognitionResult") != null && !jsonObj.get("recognitionResult").isJsonNull()) {
        TextRecognitionResult.validateJsonElement(jsonObj.get("recognitionResult"));
      }
