...
OAITextRecognitionResult OAITextOperationResult::getRecognitionResult() const {
    return m_recognition_result;
}
void OAITextOperationResult::setRecognitionResult(const OAITextRecognitionResult &recognition_result) {
...
OAIOperationStatus OAITextOperationResult::getStatus() const {
    return m_status;
}
void OAITextOperationResult::setStatus(const OAIOperationStatus &status) {
    m_status = status;
    m_status_isSet = true;
}
