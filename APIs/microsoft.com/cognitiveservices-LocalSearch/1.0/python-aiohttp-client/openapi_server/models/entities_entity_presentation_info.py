...
class EntitiesEntityPresentationInfo(Model):
    ...
    def __init__(self, type: str=None, entity_scenario: str='DominantEntity', entity_sub_type_hints: List[str]=None, entity_type_display_hint: str=None, entity_type_hints: List[str]=None, query: str=None):
        """EntitiesEntityPresentationInfo - a model defined in OpenAPI

        :param type: The type of this EntitiesEntityPresentationInfo.
        :param entity_scenario: The entity_scenario of this EntitiesEntityPresentationInfo.
        :param entity_sub_type_hints: The entity_sub_type_hints of this EntitiesEntityPresentationInfo.
        ...
        :param query: The query of this EntitiesEntityPresentationInfo.
        """
        self.openapi_types = {
            'type': str,
            'entity_scenario': str,
            'entity_sub_type_hints': List[str],
        ...
        self.attribute_map = {
            ...
            'entity_sub_type_hints': 'entitySubTypeHints',
        ...
        self._entity_sub_type_hints = entity_sub_type_hints
    ...
    @property
    def type(self):
        """Gets the type of this EntitiesEntityPresentationInfo.


        :return: The type of this EntitiesEntityPresentationInfo.
        :rtype: str
        """
        return self._type
    ...
    @type.setter
    def type(self, type):
        """Sets the type of this EntitiesEntityPresentationInfo.
    ...
    @property
    def entity_sub_type_hints(self):
        """Gets the entity_sub_type_hints of this EntitiesEntityPresentationInfo.


        :return: The entity_sub_type_hints of this EntitiesEntityPresentationInfo.
        :rtype: List[str]
        """
        return self._entity_sub_type_hints

    @entity_sub_type_hints.setter
    def entity_sub_type_hints(self, entity_sub_type_hints):
        """Sets the entity_sub_type_hints of this EntitiesEntityPresentationInfo.


        :param entity_sub_type_hints: The entity_sub_type_hints of this EntitiesEntityPresentationInfo.
        :type entity_sub_type_hints: List[str]
        """
    ...
    def entity_type_hints(self, entity_type_hints):
        ...
        """
        allowed_values = ["Place", "LocalBusiness", "Restaurant", "Hotel"]  # noqa: E501
    ...
    @property
    def query(self):
        """Gets the query of this EntitiesEntityPresentationInfo.


        :return: The query of this EntitiesEntityPresentationInfo.
        :rtype: str
        """
        return self._query
    ...
    def query(self, query):
        """Sets the query of this EntitiesEntityPresentationInfo.
