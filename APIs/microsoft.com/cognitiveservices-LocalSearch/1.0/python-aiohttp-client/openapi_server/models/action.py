...
class Action(Model):
    ...
    def __init__(self, display_name: str=None, is_top_action: bool=None, location: List[Place]=None, result: List[Thing]=None, service_url: str=None, about: List[Thing]=None, comment_count: int=None, copyright_holder: Thing=None, copyright_year: int=None, creator: Thing=None, disclaimer: str=None, discussion_url: str=None, genre: List[str]=None, head_line: str=None, is_accessible_for_free: bool=None, is_family_friendly: bool=None, main_entity: Thing=None, mentions: List[Thing]=None, provider: List[Thing]=None, text: str=None, thumbnail_url: str=None, entity_presentation_info: EntitiesEntityPresentationInfo=None, name: str=None, url: str=None, adaptive_card: str=None, immediate_action: List[Action]=None, potential_action: List[Action]=None, preferred_clickthrough_url: str=None, read_link: str=None, web_search_url: str=None, id: str=None, type: str=None):
        ...
        :param location: The location of this Action.
        ...
        :param entity_presentation_info: The entity_presentation_info of this Action.
    ...
    @property
    def location(self):
        """Gets the location of this Action.
    ...
    def entity_presentation_info(self):
        """Gets the entity_presentation_info of this Action.


        :return: The entity_presentation_info of this Action.
    ...
    def entity_presentation_info(self, entity_presentation_info):
        """Sets the entity_presentation_info of this Action.
