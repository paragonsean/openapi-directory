...
class Error(Model):
    ...
    def __init__(self, type: str=None, code: str='None', message: str=None, more_details: str=None, parameter: str=None, sub_code: str=None, value: str=None):
        ...
        :param sub_code: The sub_code of this Error.
    ...
    @property
    def sub_code(self):
        """Gets the sub_code of this Error.

        The error code that further helps to identify the error.

        :return: The sub_code of this Error.
        :rtype: str
        """
    ...
    def sub_code(self, sub_code):
        """Sets the sub_code of this Error.
        ...
        :type sub_code: str
        """
        allowed_values = ["UnexpectedError", "ResourceError", "NotImplemented", "ParameterMissing", "ParameterInvalidValue", "HttpNotAllowed", "Blocked", "AuthorizationMissing", "AuthorizationRedundancy", "AuthorizationDisabled", "AuthorizationExpired"]  # noqa: E501
        if sub_code not in allowed_values:
            raise ValueError(
                "Invalid value for `sub_code` ({0}), must be one of {1}"
