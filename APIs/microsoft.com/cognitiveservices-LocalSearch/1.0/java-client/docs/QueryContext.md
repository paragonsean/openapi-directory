...
|**alterationDisplayQuery** | **String** | AlteredQuery that is formatted for display purpose. The query string in the AlterationDisplayQuery can be html-escaped and can contain hit-highlighting characters |  [optional] [readonly] |
