...
/**
* LocalSearch service.
* @module api/LocalSearchApi
* @version 1.0
*/
export default class LocalSearchApi {

    /**
    * Constructs a new LocalSearchApi. 
    * @alias module:api/LocalSearchApi
    * @class
    ...
    */
    ...
    /**
     * Callback function to receive the result of the localSearch operation.
     * @callback module:api/LocalSearchApi~localSearchCallback
     ...
     * @param {module:api/LocalSearchApi~localSearchCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/SearchResponse}
     */
    localSearch(xBingApisSDK, q, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'xBingApisSDK' is set
      if (xBingApisSDK === undefined || xBingApisSDK === null) {
        throw new Error("Missing the required parameter 'xBingApisSDK' when calling localSearch");
      }
      // verify the required parameter 'q' is set
      if (q === undefined || q === null) {
        throw new Error("Missing the required parameter 'q' when calling localSearch");
      }
      ...
      let queryParams = {
        ...
        'mkt': opts['mkt'],
        'q': q,
        'localcategories': opts['localcategories'],
        'localcircularview': opts['localcircularview'],
        'localmapview': opts['localmapview'],
        'count': opts['count'],
        'first': opts['first'],
      ...
      return this.apiClient.callApi(
        '/v7.0/localbusinesses/search', 'GET',
