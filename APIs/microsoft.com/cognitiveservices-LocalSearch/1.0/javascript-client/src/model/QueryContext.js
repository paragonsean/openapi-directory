...
class QueryContext {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('alterationDisplayQuery')) {
                obj['alterationDisplayQuery'] = ApiClient.convertToType(data['alterationDisplayQuery'], 'String');
            }
    ...
    static validateJSON(data) {
        ...
        // ensure the json data is a string
        if (data['alterationDisplayQuery'] && !(typeof data['alterationDisplayQuery'] === 'string' || data['alterationDisplayQuery'] instanceof String)) {
            throw new Error("Expected the field `alterationDisplayQuery` to be a primitive type in the JSON string but got " + data['alterationDisplayQuery']);
        }
        // ensure the json data is a string
 ...
 * @member {String} alterationDisplayQuery
 */
QueryContext.prototype['alterationDisplayQuery'] = undefined;
