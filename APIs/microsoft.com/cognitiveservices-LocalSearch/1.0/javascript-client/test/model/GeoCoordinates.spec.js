...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LocalSearchClient.GeoCoordinates();
  });
  ...
  describe('GeoCoordinates', function() {
    it('should create an instance of GeoCoordinates', function() {
      ...
      //var instance = new LocalSearchClient.GeoCoordinates();
      //expect(instance).to.be.a(LocalSearchClient.GeoCoordinates);
    });
