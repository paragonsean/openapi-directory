...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LocalSearchClient.LocalSearchApi();
  });
  ...
  describe('LocalSearchApi', function() {
    describe('localSearch', function() {
      it('should call localSearch successfully', function(done) {
        //uncomment below and update the code to test localSearch
        //instance.localSearch(function(error) {
