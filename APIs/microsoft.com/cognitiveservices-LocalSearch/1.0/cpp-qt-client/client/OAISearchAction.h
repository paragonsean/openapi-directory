...
#ifndef OAISearchAction_H
#define OAISearchAction_H
...
class OAISearchAction : public OAIObject {
public:
    OAISearchAction();
    OAISearchAction(QString json);
    ~OAISearchAction() override;
    ...
    QList<OAIAnswer> getRichContent() const;
    void setRichContent(const QList<OAIAnswer> &rich_content);
    bool is_rich_content_Set() const;
    bool is_rich_content_Valid() const;
...
private:
    ...
    QList<OAIAnswer> m_rich_content;
    bool m_rich_content_isSet;
    bool m_rich_content_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAISearchAction)

#endif // OAISearchAction_H
