...
QString OAISearchResultsAnswer::getAdaptiveCard() const {
    return m_adaptive_card;
}
void OAISearchResultsAnswer::setAdaptiveCard(const QString &adaptive_card) {
    m_adaptive_card = adaptive_card;
    m_adaptive_card_isSet = true;
}

bool OAISearchResultsAnswer::is_adaptive_card_Set() const{
    return m_adaptive_card_isSet;
}

bool OAISearchResultsAnswer::is_adaptive_card_Valid() const{
    return m_adaptive_card_isValid;
}

QList<OAIAction> OAISearchResultsAnswer::getImmediateAction() const {
    return m_immediate_action;
}
void OAISearchResultsAnswer::setImmediateAction(const QList<OAIAction> &immediate_action) {
    m_immediate_action = immediate_action;
    m_immediate_action_isSet = true;
}

bool OAISearchResultsAnswer::is_immediate_action_Set() const{
    return m_immediate_action_isSet;
}

bool OAISearchResultsAnswer::is_immediate_action_Valid() const{
    return m_immediate_action_isValid;
}

QList<OAIAction> OAISearchResultsAnswer::getPotentialAction() const {
    return m_potential_action;
}
void OAISearchResultsAnswer::setPotentialAction(const QList<OAIAction> &potential_action) {
    m_potential_action = potential_action;
    m_potential_action_isSet = true;
}

bool OAISearchResultsAnswer::is_potential_action_Set() const{
    return m_potential_action_isSet;
}

bool OAISearchResultsAnswer::is_potential_action_Valid() const{
    return m_potential_action_isValid;
}

QString OAISearchResultsAnswer::getPreferredClickthroughUrl() const {
    return m_preferred_clickthrough_url;
}
void OAISearchResultsAnswer::setPreferredClickthroughUrl(const QString &preferred_clickthrough_url) {
    m_preferred_clickthrough_url = preferred_clickthrough_url;
    m_preferred_clickthrough_url_isSet = true;
}

bool OAISearchResultsAnswer::is_preferred_clickthrough_url_Set() const{
    return m_preferred_clickthrough_url_isSet;
}

bool OAISearchResultsAnswer::is_preferred_clickthrough_url_Valid() const{
