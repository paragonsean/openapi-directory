...
OAIEntitiesEntityPresentationInfo OAIStructuredValue::getEntityPresentationInfo() const {
    return m_entity_presentation_info;
}
void OAIStructuredValue::setEntityPresentationInfo(const OAIEntitiesEntityPresentationInfo &entity_presentation_info) {
    m_entity_presentation_info = entity_presentation_info;
    m_entity_presentation_info_isSet = true;
}

bool OAIStructuredValue::is_entity_presentation_info_Set() const{
    return m_entity_presentation_info_isSet;
}

bool OAIStructuredValue::is_entity_presentation_info_Valid() const{
...
QString OAIStructuredValue::getAdaptiveCard() const {
    return m_adaptive_card;
}
void OAIStructuredValue::setAdaptiveCard(const QString &adaptive_card) {
    m_adaptive_card = adaptive_card;
    m_adaptive_card_isSet = true;
}

bool OAIStructuredValue::is_adaptive_card_Set() const{
    return m_adaptive_card_isSet;
}

bool OAIStructuredValue::is_adaptive_card_Valid() const{
    return m_adaptive_card_isValid;
}

QList<OAIAction> OAIStructuredValue::getImmediateAction() const {
    return m_immediate_action;
}
void OAIStructuredValue::setImmediateAction(const QList<OAIAction> &immediate_action) {
    m_immediate_action = immediate_action;
    m_immediate_action_isSet = true;
}

bool OAIStructuredValue::is_immediate_action_Set() const{
    return m_immediate_action_isSet;
}

bool OAIStructuredValue::is_immediate_action_Valid() const{
    return m_immediate_action_isValid;
}

QList<OAIAction> OAIStructuredValue::getPotentialAction() const {
    return m_potential_action;
}
void OAIStructuredValue::setPotentialAction(const QList<OAIAction> &potential_action) {
    m_potential_action = potential_action;
    m_potential_action_isSet = true;
}

bool OAIStructuredValue::is_potential_action_Set() const{
    return m_potential_action_isSet;
}

bool OAIStructuredValue::is_potential_action_Valid() const{
    return m_potential_action_isValid;
}

QString OAIStructuredValue::getPreferredClickthroughUrl() const {
    return m_preferred_clickthrough_url;
}
void OAIStructuredValue::setPreferredClickthroughUrl(const QString &preferred_clickthrough_url) {
    m_preferred_clickthrough_url = preferred_clickthrough_url;
    m_preferred_clickthrough_url_isSet = true;
}

bool OAIStructuredValue::is_preferred_clickthrough_url_Set() const{
    return m_preferred_clickthrough_url_isSet;
}

bool OAIStructuredValue::is_preferred_clickthrough_url_Valid() const{
    return m_preferred_clickthrough_url_isValid;
}

QString OAIStructuredValue::getReadLink() const {
    return m_read_link;
}
void OAIStructuredValue::setReadLink(const QString &read_link) {
    m_read_link = read_link;
    m_read_link_isSet = true;
}

bool OAIStructuredValue::is_read_link_Set() const{
    return m_read_link_isSet;
}

bool OAIStructuredValue::is_read_link_Valid() const{
