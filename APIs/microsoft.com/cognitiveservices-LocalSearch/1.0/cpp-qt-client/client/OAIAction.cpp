...
bool OAIAction::isIsTopAction() const {
    return m_is_top_action;
}
void OAIAction::setIsTopAction(const bool &is_top_action) {
    m_is_top_action = is_top_action;
    m_is_top_action_isSet = true;
}

bool OAIAction::is_is_top_action_Set() const{
    return m_is_top_action_isSet;
}

bool OAIAction::is_is_top_action_Valid() const{
    return m_is_top_action_isValid;
}

QList<OAIPlace> OAIAction::getLocation() const {
    return m_location;
}
void OAIAction::setLocation(const QList<OAIPlace> &location) {
    m_location = location;
    m_location_isSet = true;
}

bool OAIAction::is_location_Set() const{
    return m_location_isSet;
}

bool OAIAction::is_location_Valid() const{
    return m_location_isValid;
}

QList<OAIThing> OAIAction::getResult() const {
    return m_result;
}
void OAIAction::setResult(const QList<OAIThing> &result) {
    m_result = result;
    m_result_isSet = true;
}

bool OAIAction::is_result_Set() const{
    return m_result_isSet;
}

bool OAIAction::is_result_Valid() const{
    return m_result_isValid;
}

QString OAIAction::getServiceUrl() const {
    return m_service_url;
}
void OAIAction::setServiceUrl(const QString &service_url) {
    m_service_url = service_url;
    m_service_url_isSet = true;
}

bool OAIAction::is_service_url_Set() const{
    return m_service_url_isSet;
}

bool OAIAction::is_service_url_Valid() const{
    return m_service_url_isValid;
}

QList<OAIThing> OAIAction::getAbout() const {
    return m_about;
}
void OAIAction::setAbout(const QList<OAIThing> &about) {
    m_about = about;
    m_about_isSet = true;
}

bool OAIAction::is_about_Set() const{
    return m_about_isSet;
}

bool OAIAction::is_about_Valid() const{
    return m_about_isValid;
}

qint32 OAIAction::getCommentCount() const {
    return m_comment_count;
}
void OAIAction::setCommentCount(const qint32 &comment_count) {
    m_comment_count = comment_count;
    m_comment_count_isSet = true;
}

bool OAIAction::is_comment_count_Set() const{
    return m_comment_count_isSet;
}

bool OAIAction::is_comment_count_Valid() const{
    return m_comment_count_isValid;
}

OAIThing OAIAction::getCopyrightHolder() const {
    return m_copyright_holder;
}
void OAIAction::setCopyrightHolder(const OAIThing &copyright_holder) {
    m_copyright_holder = copyright_holder;
    m_copyright_holder_isSet = true;
}

bool OAIAction::is_copyright_holder_Set() const{
    return m_copyright_holder_isSet;
}

bool OAIAction::is_copyright_holder_Valid() const{
    return m_copyright_holder_isValid;
}

qint32 OAIAction::getCopyrightYear() const {
    return m_copyright_year;
}
void OAIAction::setCopyrightYear(const qint32 &copyright_year) {
    m_copyright_year = copyright_year;
    m_copyright_year_isSet = true;
}

bool OAIAction::is_copyright_year_Set() const{
    return m_copyright_year_isSet;
}

bool OAIAction::is_copyright_year_Valid() const{
    return m_copyright_year_isValid;
}

OAIThing OAIAction::getCreator() const {
    return m_creator;
}
void OAIAction::setCreator(const OAIThing &creator) {
    m_creator = creator;
    m_creator_isSet = true;
}

bool OAIAction::is_creator_Set() const{
    return m_creator_isSet;
}

bool OAIAction::is_creator_Valid() const{
    return m_creator_isValid;
}

QString OAIAction::getDisclaimer() const {
    return m_disclaimer;
}
void OAIAction::setDisclaimer(const QString &disclaimer) {
    m_disclaimer = disclaimer;
    m_disclaimer_isSet = true;
}

bool OAIAction::is_disclaimer_Set() const{
    return m_disclaimer_isSet;
}

bool OAIAction::is_disclaimer_Valid() const{
    return m_disclaimer_isValid;
}

QString OAIAction::getDiscussionUrl() const {
    return m_discussion_url;
}
void OAIAction::setDiscussionUrl(const QString &discussion_url) {
    m_discussion_url = discussion_url;
    m_discussion_url_isSet = true;
}

bool OAIAction::is_discussion_url_Set() const{
    return m_discussion_url_isSet;
}

bool OAIAction::is_discussion_url_Valid() const{
    return m_discussion_url_isValid;
}

QList<QString> OAIAction::getGenre() const {
    return m_genre;
}
void OAIAction::setGenre(const QList<QString> &genre) {
    m_genre = genre;
    m_genre_isSet = true;
}

bool OAIAction::is_genre_Set() const{
    return m_genre_isSet;
}

bool OAIAction::is_genre_Valid() const{
    return m_genre_isValid;
}

QString OAIAction::getHeadLine() const {
    return m_head_line;
}
void OAIAction::setHeadLine(const QString &head_line) {
    m_head_line = head_line;
    m_head_line_isSet = true;
}

bool OAIAction::is_head_line_Set() const{
    return m_head_line_isSet;
}

bool OAIAction::is_head_line_Valid() const{
    return m_head_line_isValid;
}

bool OAIAction::isIsAccessibleForFree() const {
    return m_is_accessible_for_free;
}
void OAIAction::setIsAccessibleForFree(const bool &is_accessible_for_free) {
    m_is_accessible_for_free = is_accessible_for_free;
    m_is_accessible_for_free_isSet = true;
}

bool OAIAction::is_is_accessible_for_free_Set() const{
    return m_is_accessible_for_free_isSet;
}

bool OAIAction::is_is_accessible_for_free_Valid() const{
    return m_is_accessible_for_free_isValid;
}

bool OAIAction::isIsFamilyFriendly() const {
    return m_is_family_friendly;
}
void OAIAction::setIsFamilyFriendly(const bool &is_family_friendly) {
    m_is_family_friendly = is_family_friendly;
    m_is_family_friendly_isSet = true;
}

bool OAIAction::is_is_family_friendly_Set() const{
    return m_is_family_friendly_isSet;
}

bool OAIAction::is_is_family_friendly_Valid() const{
    return m_is_family_friendly_isValid;
}

OAIThing OAIAction::getMainEntity() const {
    return m_main_entity;
}
void OAIAction::setMainEntity(const OAIThing &main_entity) {
    m_main_entity = main_entity;
    m_main_entity_isSet = true;
}

bool OAIAction::is_main_entity_Set() const{
    return m_main_entity_isSet;
}

bool OAIAction::is_main_entity_Valid() const{
    return m_main_entity_isValid;
}

QList<OAIThing> OAIAction::getMentions() const {
    return m_mentions;
}
void OAIAction::setMentions(const QList<OAIThing> &mentions) {
    m_mentions = mentions;
    m_mentions_isSet = true;
}

bool OAIAction::is_mentions_Set() const{
    return m_mentions_isSet;
}

bool OAIAction::is_mentions_Valid() const{
    return m_mentions_isValid;
}

QList<OAIThing> OAIAction::getProvider() const {
    return m_provider;
}
void OAIAction::setProvider(const QList<OAIThing> &provider) {
    m_provider = provider;
    m_provider_isSet = true;
}

bool OAIAction::is_provider_Set() const{
    return m_provider_isSet;
}

bool OAIAction::is_provider_Valid() const{
...
QString OAIAction::getThumbnailUrl() const {
    return m_thumbnail_url;
}
void OAIAction::setThumbnailUrl(const QString &thumbnail_url) {
    m_thumbnail_url = thumbnail_url;
    m_thumbnail_url_isSet = true;
}

bool OAIAction::is_thumbnail_url_Set() const{
    return m_thumbnail_url_isSet;
}

bool OAIAction::is_thumbnail_url_Valid() const{
    return m_thumbnail_url_isValid;
}

OAIEntitiesEntityPresentationInfo OAIAction::getEntityPresentationInfo() const {
    return m_entity_presentation_info;
}
void OAIAction::setEntityPresentationInfo(const OAIEntitiesEntityPresentationInfo &entity_presentation_info) {
    m_entity_presentation_info = entity_presentation_info;
    m_entity_presentation_info_isSet = true;
}

bool OAIAction::is_entity_presentation_info_Set() const{
    return m_entity_presentation_info_isSet;
}

bool OAIAction::is_entity_presentation_info_Valid() const{
...
QString OAIAction::getAdaptiveCard() const {
    return m_adaptive_card;
}
void OAIAction::setAdaptiveCard(const QString &adaptive_card) {
    m_adaptive_card = adaptive_card;
    m_adaptive_card_isSet = true;
}

bool OAIAction::is_adaptive_card_Set() const{
    return m_adaptive_card_isSet;
}

bool OAIAction::is_adaptive_card_Valid() const{
    return m_adaptive_card_isValid;
}

QList<OAIAction> OAIAction::getImmediateAction() const {
    return m_immediate_action;
}
void OAIAction::setImmediateAction(const QList<OAIAction> &immediate_action) {
    m_immediate_action = immediate_action;
    m_immediate_action_isSet = true;
}

bool OAIAction::is_immediate_action_Set() const{
    return m_immediate_action_isSet;
}

bool OAIAction::is_immediate_action_Valid() const{
    return m_immediate_action_isValid;
}

QList<OAIAction> OAIAction::getPotentialAction() const {
    return m_potential_action;
}
void OAIAction::setPotentialAction(const QList<OAIAction> &potential_action) {
    m_potential_action = potential_action;
    m_potential_action_isSet = true;
}

bool OAIAction::is_potential_action_Set() const{
    return m_potential_action_isSet;
}

bool OAIAction::is_potential_action_Valid() const{
    return m_potential_action_isValid;
}

QString OAIAction::getPreferredClickthroughUrl() const {
    return m_preferred_clickthrough_url;
}
void OAIAction::setPreferredClickthroughUrl(const QString &preferred_clickthrough_url) {
    m_preferred_clickthrough_url = preferred_clickthrough_url;
    m_preferred_clickthrough_url_isSet = true;
}

bool OAIAction::is_preferred_clickthrough_url_Set() const{
    return m_preferred_clickthrough_url_isSet;
}

bool OAIAction::is_preferred_clickthrough_url_Valid() const{
    return m_preferred_clickthrough_url_isValid;
}

QString OAIAction::getReadLink() const {
    return m_read_link;
}
void OAIAction::setReadLink(const QString &read_link) {
    m_read_link = read_link;
    m_read_link_isSet = true;
}

bool OAIAction::is_read_link_Set() const{
    return m_read_link_isSet;
}

bool OAIAction::is_read_link_Valid() const{
    return m_read_link_isValid;
}

QString OAIAction::getWebSearchUrl() const {
    return m_web_search_url;
}
void OAIAction::setWebSearchUrl(const QString &web_search_url) {
    m_web_search_url = web_search_url;
    m_web_search_url_isSet = true;
}

bool OAIAction::is_web_search_url_Set() const{
    return m_web_search_url_isSet;
}

bool OAIAction::is_web_search_url_Valid() const{
...
void OAIAction::setType(const QString &_type) {
    m__type = _type;
    m__type_isSet = true;
}

bool OAIAction::is__type_Set() const{
    return m__type_isSet;
}

bool OAIAction::is__type_Valid() const{
