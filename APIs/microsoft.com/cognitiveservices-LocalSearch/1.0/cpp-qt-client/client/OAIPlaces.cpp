...
QString OAIPlaces::getAdaptiveCard() const {
    return m_adaptive_card;
}
void OAIPlaces::setAdaptiveCard(const QString &adaptive_card) {
    m_adaptive_card = adaptive_card;
    m_adaptive_card_isSet = true;
}

bool OAIPlaces::is_adaptive_card_Set() const{
    return m_adaptive_card_isSet;
}

bool OAIPlaces::is_adaptive_card_Valid() const{
    return m_adaptive_card_isValid;
}

QList<OAIAction> OAIPlaces::getImmediateAction() const {
    return m_immediate_action;
}
void OAIPlaces::setImmediateAction(const QList<OAIAction> &immediate_action) {
    m_immediate_action = immediate_action;
    m_immediate_action_isSet = true;
}

bool OAIPlaces::is_immediate_action_Set() const{
    return m_immediate_action_isSet;
}

bool OAIPlaces::is_immediate_action_Valid() const{
    return m_immediate_action_isValid;
}

QList<OAIAction> OAIPlaces::getPotentialAction() const {
    return m_potential_action;
}
void OAIPlaces::setPotentialAction(const QList<OAIAction> &potential_action) {
    m_potential_action = potential_action;
    m_potential_action_isSet = true;
}

bool OAIPlaces::is_potential_action_Set() const{
    return m_potential_action_isSet;
}

bool OAIPlaces::is_potential_action_Valid() const{
    return m_potential_action_isValid;
}

QString OAIPlaces::getPreferredClickthroughUrl() const {
    return m_preferred_clickthrough_url;
}
void OAIPlaces::setPreferredClickthroughUrl(const QString &preferred_clickthrough_url) {
    m_preferred_clickthrough_url = preferred_clickthrough_url;
    m_preferred_clickthrough_url_isSet = true;
}

bool OAIPlaces::is_preferred_clickthrough_url_Set() const{
    return m_preferred_clickthrough_url_isSet;
}

bool OAIPlaces::is_preferred_clickthrough_url_Valid() const{
    return m_preferred_clickthrough_url_isValid;
}

QString OAIPlaces::getReadLink() const {
    return m_read_link;
}
void OAIPlaces::setReadLink(const QString &read_link) {
    m_read_link = read_link;
    m_read_link_isSet = true;
}

bool OAIPlaces::is_read_link_Set() const{
    return m_read_link_isSet;
}

bool OAIPlaces::is_read_link_Valid() const{
