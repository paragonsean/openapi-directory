...
public:
    ...
    QString getAlterationDisplayQuery() const;
    void setAlterationDisplayQuery(const QString &alteration_display_query);
    bool is_alteration_display_query_Set() const;
    bool is_alteration_display_query_Valid() const;
...
private:
    ...
    QString m_alteration_display_query;
    bool m_alteration_display_query_isSet;
    bool m_alteration_display_query_isValid;
