...
void OAISearchAction::initializeModel() {
    ...
    m_rich_content_isSet = false;
    m_rich_content_isValid = false;
...
void OAISearchAction::fromJsonObject(QJsonObject json) {
    ...
    m_rich_content_isValid = ::OpenAPI::fromJsonValue(m_rich_content, json[QString("richContent")]);
    m_rich_content_isSet = !json[QString("richContent")].isNull() && m_rich_content_isValid;
...
QJsonObject OAISearchAction::asJsonObject() const {
    ...
    if (m_rich_content.size() > 0) {
        obj.insert(QString("richContent"), ::OpenAPI::toJsonValue(m_rich_content));
    }
...
QString OAISearchAction::getFormattingRuleId() const {
    return m_formatting_rule_id;
}
void OAISearchAction::setFormattingRuleId(const QString &formatting_rule_id) {
    m_formatting_rule_id = formatting_rule_id;
    m_formatting_rule_id_isSet = true;
}

bool OAISearchAction::is_formatting_rule_id_Set() const{
    return m_formatting_rule_id_isSet;
}

bool OAISearchAction::is_formatting_rule_id_Valid() const{
...
QList<OAIAnswer> OAISearchAction::getRichContent() const {
    return m_rich_content;
}
void OAISearchAction::setRichContent(const QList<OAIAnswer> &rich_content) {
    m_rich_content = rich_content;
    m_rich_content_isSet = true;
}

bool OAISearchAction::is_rich_content_Set() const{
    return m_rich_content_isSet;
}

bool OAISearchAction::is_rich_content_Valid() const{
    return m_rich_content_isValid;
}
...
QList<OAIPlace> OAISearchAction::getLocation() const {
    return m_location;
}
void OAISearchAction::setLocation(const QList<OAIPlace> &location) {
    m_location = location;
    m_location_isSet = true;
}

bool OAISearchAction::is_location_Set() const{
    return m_location_isSet;
}

bool OAISearchAction::is_location_Valid() const{
...
OAIEntitiesEntityPresentationInfo OAISearchAction::getEntityPresentationInfo() const {
    return m_entity_presentation_info;
}
void OAISearchAction::setEntityPresentationInfo(const OAIEntitiesEntityPresentationInfo &entity_presentation_info) {
    m_entity_presentation_info = entity_presentation_info;
    m_entity_presentation_info_isSet = true;
}

bool OAISearchAction::is_entity_presentation_info_Set() const{
    return m_entity_presentation_info_isSet;
}

bool OAISearchAction::is_entity_presentation_info_Valid() const{
    return m_entity_presentation_info_isValid;
}

QString OAISearchAction::getName() const {
    return m_name;
}
void OAISearchAction::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAISearchAction::is_name_Set() const{
    return m_name_isSet;
}

bool OAISearchAction::is_name_Valid() const{
