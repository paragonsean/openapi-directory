...
class ImageObject(Model):
    ...
    def __init__(self, thumbnail: ImageObject=None, content_url: str=None, height: int=None, width: int=None, date_published: str=None, provider: List[Thing]=None, thumbnail_url: str=None, video: VideoObject=None, alternate_name: str=None, bing_id: str=None, description: str=None, image: ImageObject=None, name: str=None, url: str=None, web_search_url: str=None, id: str=None, type: str=None):
        ...
        :param video: The video of this ImageObject.
    ...
    @property
    def video(self):
        """Gets the video of this ImageObject.


        :return: The video of this ImageObject.
        :rtype: VideoObject
        """
        return self._video
    ...
    def video(self, video):
        """Sets the video of this ImageObject.
