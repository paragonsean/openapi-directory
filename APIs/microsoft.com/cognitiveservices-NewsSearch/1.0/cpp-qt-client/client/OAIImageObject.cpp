...
OAIVideoObject OAIImageObject::getVideo() const {
    return m_video;
}
void OAIImageObject::setVideo(const OAIVideoObject &video) {
    m_video = video;
    m_video_isSet = true;
}

bool OAIImageObject::is_video_Set() const{
    return m_video_isSet;
}

bool OAIImageObject::is_video_Valid() const{
