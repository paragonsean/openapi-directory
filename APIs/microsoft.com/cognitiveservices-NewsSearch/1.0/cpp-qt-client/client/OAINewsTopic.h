...
#ifndef OAINewsTopic_H
#define OAINewsTopic_H
...
class OAINewsTopic : public OAIObject {
public:
    OAINewsTopic();
    OAINewsTopic(QString json);
    ~OAINewsTopic() override;
    ...
    bool isIsBreakingNews() const;
    void setIsBreakingNews(const bool &is_breaking_news);
    bool is_is_breaking_news_Set() const;
    bool is_is_breaking_news_Valid() const;

    QString getNewsSearchUrl() const;
    void setNewsSearchUrl(const QString &news_search_url);
    bool is_news_search_url_Set() const;
    bool is_news_search_url_Valid() const;
...
private:
    ...
    bool m_is_breaking_news;
    bool m_is_breaking_news_isSet;
    bool m_is_breaking_news_isValid;

    QString m_news_search_url;
    bool m_news_search_url_isSet;
    bool m_news_search_url_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAINewsTopic)

#endif // OAINewsTopic_H
