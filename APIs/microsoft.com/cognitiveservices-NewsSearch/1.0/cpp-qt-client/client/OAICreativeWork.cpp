...
QString OAICreativeWork::getDatePublished() const {
    return m_date_published;
}
void OAICreativeWork::setDatePublished(const QString &date_published) {
    m_date_published = date_published;
    m_date_published_isSet = true;
}

bool OAICreativeWork::is_date_published_Set() const{
    return m_date_published_isSet;
}

bool OAICreativeWork::is_date_published_Valid() const{
...
OAIVideoObject OAICreativeWork::getVideo() const {
    return m_video;
}
void OAICreativeWork::setVideo(const OAIVideoObject &video) {
    m_video = video;
    m_video_isSet = true;
}

bool OAICreativeWork::is_video_Set() const{
    return m_video_isSet;
}

bool OAICreativeWork::is_video_Valid() const{
