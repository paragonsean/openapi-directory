...
QString OAIVideoObject::getDatePublished() const {
    return m_date_published;
}
void OAIVideoObject::setDatePublished(const QString &date_published) {
    m_date_published = date_published;
    m_date_published_isSet = true;
}

bool OAIVideoObject::is_date_published_Set() const{
    return m_date_published_isSet;
}

bool OAIVideoObject::is_date_published_Valid() const{
...
OAIVideoObject OAIVideoObject::getVideo() const {
    return m_video;
}
void OAIVideoObject::setVideo(const OAIVideoObject &video) {
    m_video = video;
    m_video_isSet = true;
}

bool OAIVideoObject::is_video_Set() const{
    return m_video_isSet;
}

bool OAIVideoObject::is_video_Valid() const{
