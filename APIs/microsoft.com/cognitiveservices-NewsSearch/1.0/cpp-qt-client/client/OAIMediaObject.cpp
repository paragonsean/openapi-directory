...
OAIVideoObject OAIMediaObject::getVideo() const {
    return m_video;
}
void OAIMediaObject::setVideo(const OAIVideoObject &video) {
    m_video = video;
    m_video_isSet = true;
}

bool OAIMediaObject::is_video_Set() const{
    return m_video_isSet;
}

bool OAIMediaObject::is_video_Valid() const{
