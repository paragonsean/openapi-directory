...
#ifndef OAINewsArticle_H
#define OAINewsArticle_H
...
class OAINewsArticle : public OAIObject {
public:
    OAINewsArticle();
    OAINewsArticle(QString json);
    ~OAINewsArticle() override;
    ...
    QList<OAINewsArticle> getClusteredArticles() const;
    void setClusteredArticles(const QList<OAINewsArticle> &clustered_articles);
    bool is_clustered_articles_Set() const;
    bool is_clustered_articles_Valid() const;

    bool isHeadline() const;
    void setHeadline(const bool &headline);
...
private:
    ...
    QList<OAINewsArticle> m_clustered_articles;
    bool m_clustered_articles_isSet;
    bool m_clustered_articles_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAINewsArticle)

#endif // OAINewsArticle_H
