...
News Search Client
- API version: 1.0
  - Build date: 2024-10-12T10:10:53.501943-04:00[America/New_York]
...
import org.openapitools.client.api.NewsCategoryApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    NewsCategoryApi apiInstance = new NewsCategoryApi(defaultClient);
    ...
    try {
      News result = apiInstance.newsCategory(xBingApisSDK, accept, acceptLanguage, userAgent, xMSEdgeClientID, xMSEdgeClientIP, xSearchLocation, cc, category, count, headlineCount, mkt, offset, originalImg, safeSearch, setLang, textDecorations, textFormat);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling NewsCategoryApi#newsCategory");
...
------------ | ------------- | ------------- | -------------
*NewsCategoryApi* | [**newsCategory**](docs/NewsCategoryApi.md#newsCategory) | **GET** /news | The News Category API lets you search on Bing and get back a list of top news articles by category. This section provides technical details about the query parameters and headers that you use to request news and the JSON response objects that contain them.  For examples that show how to make requests, see [Searching the web for news](https://docs.microsoft.com/en-us/azure/cognitive-services/bing-news-search/search-the-web).
*NewsSearchApi* | [**newsSearch**](docs/NewsSearchApi.md#newsSearch) | **GET** /news/search | The News Search API lets you send a search query to Bing and get back a list of news that are relevant to the search query. This section provides technical details about the query parameters and headers that you use to request news and the JSON response objects that contain them.  For examples that show how to make requests, see [Searching the web for news](https://docs.microsoft.com/en-us/azure/cognitive-services/bing-news-search/search-the-web).
*NewsTrendingTopicsApi* | [**newsTrending**](docs/NewsTrendingTopicsApi.md#newsTrending) | **GET** /news/trendingtopics | The News Trending Topics API lets you search on Bing and get back a list of trending news topics that are currently trending on Bing. This section provides technical details about the query parameters and headers that you use to request news and the JSON response objects that contain them.  For examples that show how to make requests, see [Searching the web for news](https://docs.microsoft.com/en-us/azure/cognitive-services/bing-news-search/search-the-web).
...
## Documentation for Models
 ...
 - [Thing](docs/Thing.md)
 - [TrendingTopics](docs/TrendingTopics.md)
