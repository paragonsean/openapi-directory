...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NewsSearchClient.NewsSearchApi();
  });
  ...
  describe('NewsSearchApi', function() {
    describe('newsSearch', function() {
      it('should call newsSearch successfully', function(done) {
        //uncomment below and update the code to test newsSearch
        //instance.newsSearch(function(error) {
