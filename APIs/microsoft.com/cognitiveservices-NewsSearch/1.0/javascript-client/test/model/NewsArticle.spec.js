...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NewsSearchClient.NewsArticle();
  });
  ...
  describe('NewsArticle', function() {
    it('should create an instance of NewsArticle', function() {
      // uncomment below and update the code to test NewsArticle
      //var instance = new NewsSearchClient.NewsArticle();
      //expect(instance).to.be.a(NewsSearchClient.NewsArticle);
    });
    ...
    it('should have the property clusteredArticles (base name: "clusteredArticles")', function() {
      // uncomment below and update the code to test the property clusteredArticles
      //var instance = new NewsSearchClient.NewsArticle();
      //expect(instance).to.be();
    });
