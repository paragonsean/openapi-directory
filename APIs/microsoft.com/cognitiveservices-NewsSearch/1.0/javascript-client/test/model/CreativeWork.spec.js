...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NewsSearchClient.CreativeWork();
  });
  ...
  describe('CreativeWork', function() {
    it('should create an instance of CreativeWork', function() {
      ...
      //var instance = new NewsSearchClient.CreativeWork();
      //expect(instance).to.be.a(NewsSearchClient.CreativeWork);
    });

    it('should have the property datePublished (base name: "datePublished")', function() {
