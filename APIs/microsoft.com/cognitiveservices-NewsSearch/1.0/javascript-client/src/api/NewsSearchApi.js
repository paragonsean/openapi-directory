...
/**
* NewsSearch service.
* @module api/NewsSearchApi
* @version 1.0
*/
export default class NewsSearchApi {

    /**
    * Constructs a new NewsSearchApi. 
    * @alias module:api/NewsSearchApi
    * @class
    ...
    */
    ...
    /**
     * Callback function to receive the result of the newsSearch operation.
     * @callback module:api/NewsSearchApi~newsSearchCallback
     ...
     * @param {module:api/NewsSearchApi~newsSearchCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/News}
     */
    newsSearch(xBingApisSDK, q, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'xBingApisSDK' is set
      if (xBingApisSDK === undefined || xBingApisSDK === null) {
        throw new Error("Missing the required parameter 'xBingApisSDK' when calling newsSearch");
      }
      // verify the required parameter 'q' is set
      if (q === undefined || q === null) {
        throw new Error("Missing the required parameter 'q' when calling newsSearch");
      }
