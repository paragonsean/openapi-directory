...
/**
* NewsTrendingTopics service.
* @module api/NewsTrendingTopicsApi
* @version 1.0
*/
export default class NewsTrendingTopicsApi {

    /**
    * Constructs a new NewsTrendingTopicsApi. 
    * @alias module:api/NewsTrendingTopicsApi
    * @class
    ...
    */
    ...
    /**
     * Callback function to receive the result of the newsTrending operation.
     * @callback module:api/NewsTrendingTopicsApi~newsTrendingCallback
     * @param {String} error Error message, if any.
     * @param {module:model/TrendingTopics} data The data returned by the service call.
     ...
     * @param {module:api/NewsTrendingTopicsApi~newsTrendingCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/TrendingTopics}
     */
    newsTrending(xBingApisSDK, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'xBingApisSDK' is set
      if (xBingApisSDK === undefined || xBingApisSDK === null) {
        throw new Error("Missing the required parameter 'xBingApisSDK' when calling newsTrending");
      }
      ...
      let returnType = TrendingTopics;
      return this.apiClient.callApi(
        '/news/trendingtopics', 'GET',
