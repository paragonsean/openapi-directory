...
* @module api/NewsCategoryApi
* @version 1.0
*/
export default class NewsCategoryApi {

    /**
    * Constructs a new NewsCategoryApi. 
    * @alias module:api/NewsCategoryApi
    * @class
    ...
    */
    ...
    /**
     * Callback function to receive the result of the newsCategory operation.
     * @callback module:api/NewsCategoryApi~newsCategoryCallback
     ...
     * @param {module:api/NewsCategoryApi~newsCategoryCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/News}
     */
    newsCategory(xBingApisSDK, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'xBingApisSDK' is set
      if (xBingApisSDK === undefined || xBingApisSDK === null) {
        throw new Error("Missing the required parameter 'xBingApisSDK' when calling newsCategory");
      }
      ...
      let queryParams = {
        ...
        'count': opts['count'],
        'headlineCount': opts['headlineCount'],
        'mkt': opts['mkt'],
        'offset': opts['offset'],
