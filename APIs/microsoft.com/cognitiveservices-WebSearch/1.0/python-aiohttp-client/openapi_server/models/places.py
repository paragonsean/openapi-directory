...
class Places(Model):
    ...
    def __init__(self, value: List[Thing]=None, is_family_friendly: bool=None, query_context: QueryContext=None, total_estimated_matches: int=None, follow_up_queries: List[Query]=None, web_search_url: str=None, id: str=None, type: str=None):
        ...
        :param follow_up_queries: The follow_up_queries of this Places.
    ...
    def follow_up_queries(self):
        """Gets the follow_up_queries of this Places.


        :return: The follow_up_queries of this Places.
        :rtype: List[Query]
        """
    ...
    def follow_up_queries(self, follow_up_queries):
        """Sets the follow_up_queries of this Places.
