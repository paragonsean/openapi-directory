...
class News(Model):
    ...
    def __init__(self, location: str=None, value: List[NewsArticle]=None, is_family_friendly: bool=None, query_context: QueryContext=None, total_estimated_matches: int=None, follow_up_queries: List[Query]=None, web_search_url: str=None, id: str=None, type: str=None):
        """News - a model defined in OpenAPI

        :param location: The location of this News.
        :param value: The value of this News.
        :param is_family_friendly: The is_family_friendly of this News.
        :param query_context: The query_context of this News.
    ...
    def is_family_friendly(self):
        """Gets the is_family_friendly of this News.


        :return: The is_family_friendly of this News.
        :rtype: bool
        """
    ...
    def is_family_friendly(self, is_family_friendly):
        """Sets the is_family_friendly of this News.
    ...
    def query_context(self):
        """Gets the query_context of this News.


        :return: The query_context of this News.
        :rtype: QueryContext
        """
    ...
    def query_context(self, query_context):
        """Sets the query_context of this News.
