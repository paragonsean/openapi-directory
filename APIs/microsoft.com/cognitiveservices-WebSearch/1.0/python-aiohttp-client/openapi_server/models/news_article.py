...
class NewsArticle(Model):
    ...
    def __init__(self, word_count: int=None, provider: List[Thing]=None, text: str=None, thumbnail_url: str=None, bing_id: str=None, description: str=None, image: ImageObject=None, name: str=None, url: str=None, web_search_url: str=None, id: str=None, type: str=None):
        ...
        :param text: The text of this NewsArticle.
    ...
    @property
    def text(self):
        """Gets the text of this NewsArticle.


        :return: The text of this NewsArticle.
        :rtype: str
        """
        return self._text
    ...
    @text.setter
    def text(self, text):
        """Sets the text of this NewsArticle.
