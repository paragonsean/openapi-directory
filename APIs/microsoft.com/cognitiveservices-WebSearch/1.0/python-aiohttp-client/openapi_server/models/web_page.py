...
class WebPage(Model):
    ...
    def __init__(self, date_last_crawled: str=None, deep_links: List[WebPage]=None, display_url: str=None, primary_image_of_page: ImageObject=None, search_tags: List[WebMetaTag]=None, snippet: str=None, provider: List[Thing]=None, text: str=None, thumbnail_url: str=None, bing_id: str=None, description: str=None, image: ImageObject=None, name: str=None, url: str=None, web_search_url: str=None, id: str=None, type: str=None):
        ...
        :param primary_image_of_page: The primary_image_of_page of this WebPage.
        ...
        self._primary_image_of_page = primary_image_of_page
    ...
    @property
    def primary_image_of_page(self):
        """Gets the primary_image_of_page of this WebPage.


        :return: The primary_image_of_page of this WebPage.
        :rtype: ImageObject
        """
        return self._primary_image_of_page

    @primary_image_of_page.setter
    def primary_image_of_page(self, primary_image_of_page):
        """Sets the primary_image_of_page of this WebPage.


        :param primary_image_of_page: The primary_image_of_page of this WebPage.
        :type primary_image_of_page: ImageObject
        """
