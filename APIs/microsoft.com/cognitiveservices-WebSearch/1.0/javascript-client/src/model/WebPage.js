...
class WebPage {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('primaryImageOfPage')) {
                obj['primaryImageOfPage'] = ImageObject.constructFromObject(data['primaryImageOfPage']);
            }
    ...
    static validateJSON(data) {
        ...
        // validate the optional field `primaryImageOfPage`
        if (data['primaryImageOfPage']) { // data not null
          ImageObject.validateJSON(data['primaryImageOfPage']);
        }
...
/**
 * @member {module:model/ImageObject} primaryImageOfPage
 */
WebPage.prototype['primaryImageOfPage'] = undefined;
