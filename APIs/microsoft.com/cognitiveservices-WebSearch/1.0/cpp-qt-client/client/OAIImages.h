...
public:
    ...
    QList<OAIQuery> getSimilarTerms() const;
    void setSimilarTerms(const QList<OAIQuery> &similar_terms);
    bool is_similar_terms_Set() const;
    bool is_similar_terms_Valid() const;
...
private:
    ...
    QList<OAIQuery> m_similar_terms;
    bool m_similar_terms_isSet;
    bool m_similar_terms_isValid;
