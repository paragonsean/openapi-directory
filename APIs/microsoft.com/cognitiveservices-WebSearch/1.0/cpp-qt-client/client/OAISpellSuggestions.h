...
#ifndef OAISpellSuggestions_H
#define OAISpellSuggestions_H
...
class OAISpellSuggestions : public OAIObject {
public:
    OAISpellSuggestions();
    OAISpellSuggestions(QString json);
    ~OAISpellSuggestions() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISpellSuggestions)

#endif // OAISpellSuggestions_H
