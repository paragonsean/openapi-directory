...
bool OAINews::isIsFamilyFriendly() const {
    return m_is_family_friendly;
}
void OAINews::setIsFamilyFriendly(const bool &is_family_friendly) {
    m_is_family_friendly = is_family_friendly;
    m_is_family_friendly_isSet = true;
}

bool OAINews::is_is_family_friendly_Set() const{
    return m_is_family_friendly_isSet;
}

bool OAINews::is_is_family_friendly_Valid() const{
    return m_is_family_friendly_isValid;
}

OAIQueryContext OAINews::getQueryContext() const {
    return m_query_context;
}
void OAINews::setQueryContext(const OAIQueryContext &query_context) {
    m_query_context = query_context;
    m_query_context_isSet = true;
}

bool OAINews::is_query_context_Set() const{
    return m_query_context_isSet;
}

bool OAINews::is_query_context_Valid() const{
