...
#ifndef OAIIntangible_H
#define OAIIntangible_H
...
class OAIIntangible : public OAIObject {
public:
    OAIIntangible();
    OAIIntangible(QString json);
    ~OAIIntangible() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIIntangible)

#endif // OAIIntangible_H
