...
#ifndef OAIWebWebAnswer_H
#define OAIWebWebAnswer_H
...
class OAIWebWebAnswer : public OAIObject {
public:
    OAIWebWebAnswer();
    OAIWebWebAnswer(QString json);
    ~OAIWebWebAnswer() override;
    ...
    bool isSomeResultsRemoved() const;
    void setSomeResultsRemoved(const bool &some_results_removed);
    bool is_some_results_removed_Set() const;
    bool is_some_results_removed_Valid() const;

    QList<OAIWebPage> getValue() const;
    void setValue(const QList<OAIWebPage> &value);
...
private:
    ...
    bool m_some_results_removed;
    bool m_some_results_removed_isSet;
    bool m_some_results_removed_isValid;

    QList<OAIWebPage> m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIWebWebAnswer)

#endif // OAIWebWebAnswer_H
