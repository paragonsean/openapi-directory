...
/*
 * OAIRelatedSearchesRelatedSearchAnswer.h
 *
 * Defines a list of related queries made by others.
 */

#ifndef OAIRelatedSearchesRelatedSearchAnswer_H
#define OAIRelatedSearchesRelatedSearchAnswer_H
...
class OAIRelatedSearchesRelatedSearchAnswer : public OAIObject {
public:
    OAIRelatedSearchesRelatedSearchAnswer();
    OAIRelatedSearchesRelatedSearchAnswer(QString json);
    ~OAIRelatedSearchesRelatedSearchAnswer() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRelatedSearchesRelatedSearchAnswer)

#endif // OAIRelatedSearchesRelatedSearchAnswer_H
