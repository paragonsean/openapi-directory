...
* @module api/CustomSearchApi
* @version 1.0
*/
export default class CustomSearchApi {

    /**
    * Constructs a new CustomSearchApi. 
    * @alias module:api/CustomSearchApi
    * @class
    ...
    */
    ...
    /**
     * Callback function to receive the result of the customInstanceSearch operation.
     * @callback module:api/CustomSearchApi~customInstanceSearchCallback
     ...
     * @param {module:api/CustomSearchApi~customInstanceSearchCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/SearchResponse}
     */
    customInstanceSearch(xBingApisSDK, customConfig, q, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'xBingApisSDK' is set
      if (xBingApisSDK === undefined || xBingApisSDK === null) {
        throw new Error("Missing the required parameter 'xBingApisSDK' when calling customInstanceSearch");
      }
      // verify the required parameter 'customConfig' is set
      if (customConfig === undefined || customConfig === null) {
        throw new Error("Missing the required parameter 'customConfig' when calling customInstanceSearch");
      }
      // verify the required parameter 'q' is set
      if (q === undefined || q === null) {
        throw new Error("Missing the required parameter 'q' when calling customInstanceSearch");
      }
