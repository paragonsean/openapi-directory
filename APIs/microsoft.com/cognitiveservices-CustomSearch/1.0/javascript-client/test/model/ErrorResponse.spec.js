...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CustomSearchClient.ErrorResponse();
  });
  ...
  describe('ErrorResponse', function() {
    it('should create an instance of ErrorResponse', function() {
      ...
      //var instance = new CustomSearchClient.ErrorResponse();
      //expect(instance).to.be.a(CustomSearchClient.ErrorResponse);
    });
