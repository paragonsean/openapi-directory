...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CustomSearchClient.SearchResponse();
  });
  ...
  describe('SearchResponse', function() {
    it('should create an instance of SearchResponse', function() {
      ...
      //var instance = new CustomSearchClient.SearchResponse();
      //expect(instance).to.be.a(CustomSearchClient.SearchResponse);
    });
