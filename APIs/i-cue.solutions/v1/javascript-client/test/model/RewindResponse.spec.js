...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GrowthServices.RewindResponse();
  });
  ...
  describe('RewindResponse', function() {
    it('should create an instance of RewindResponse', function() {
      // uncomment below and update the code to test RewindResponse
      //var instance = new GrowthServices.RewindResponse();
      //expect(instance).to.be.a(GrowthServices.RewindResponse);
    });
