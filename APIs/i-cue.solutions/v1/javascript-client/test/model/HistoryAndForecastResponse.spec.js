...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GrowthServices.HistoryAndForecastResponse();
  });
  ...
  describe('HistoryAndForecastResponse', function() {
    it('should create an instance of HistoryAndForecastResponse', function() {
      // uncomment below and update the code to test HistoryAndForecastResponse
      //var instance = new GrowthServices.HistoryAndForecastResponse();
      //expect(instance).to.be.a(GrowthServices.HistoryAndForecastResponse);
    });
