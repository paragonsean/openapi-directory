...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GrowthServices.OptimalParameterResponse();
  });
  ...
  describe('OptimalParameterResponse', function() {
    it('should create an instance of OptimalParameterResponse', function() {
      // uncomment below and update the code to test OptimalParameterResponse
      //var instance = new GrowthServices.OptimalParameterResponse();
      //expect(instance).to.be.a(GrowthServices.OptimalParameterResponse);
    });
