...
/*
 * OAIForecastHyperparameterResponse.h
 *
 * 
 */

#ifndef OAIForecastHyperparameterResponse_H
#define OAIForecastHyperparameterResponse_H
...
class OAIForecastHyperparameterResponse : public OAIObject {
public:
    OAIForecastHyperparameterResponse();
    OAIForecastHyperparameterResponse(QString json);
    ~OAIForecastHyperparameterResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIForecastHyperparameterResponse)

#endif // OAIForecastHyperparameterResponse_H
