...
/*
 * OAIPlanningLevelInfoRequest.h
 *
 * 
 */

#ifndef OAIPlanningLevelInfoRequest_H
#define OAIPlanningLevelInfoRequest_H
...
class OAIPlanningLevelInfoRequest : public OAIObject {
public:
    OAIPlanningLevelInfoRequest();
    OAIPlanningLevelInfoRequest(QString json);
    ~OAIPlanningLevelInfoRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPlanningLevelInfoRequest)

#endif // OAIPlanningLevelInfoRequest_H
