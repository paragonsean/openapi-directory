...
/*
 * OAITimeSeriesHistoryAndForecastResponse.h
 *
 * 
 */

#ifndef OAITimeSeriesHistoryAndForecastResponse_H
#define OAITimeSeriesHistoryAndForecastResponse_H
...
class OAITimeSeriesHistoryAndForecastResponse : public OAIObject {
public:
    OAITimeSeriesHistoryAndForecastResponse();
    OAITimeSeriesHistoryAndForecastResponse(QString json);
    ~OAITimeSeriesHistoryAndForecastResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITimeSeriesHistoryAndForecastResponse)

#endif // OAITimeSeriesHistoryAndForecastResponse_H
