...
/*
 * OAIActivity_and_identity_activity.h
 *
 * 
 */

#ifndef OAIActivity_and_identity_activity_H
#define OAIActivity_and_identity_activity_H
...
class OAIActivity_and_identity_activity : public OAIObject {
public:
    OAIActivity_and_identity_activity();
    OAIActivity_and_identity_activity(QString json);
    ~OAIActivity_and_identity_activity() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIActivity_and_identity_activity)

#endif // OAIActivity_and_identity_activity_H
