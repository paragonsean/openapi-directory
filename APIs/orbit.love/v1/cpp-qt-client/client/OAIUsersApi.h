...
Q_SIGNALS:
    ...
    void userGetSignalFull(OAIHttpRequestWorker *worker);

    Q_DECL_DEPRECATED_X("Use userGetSignalError() instead")
    void userGetSignalE(QNetworkReply::NetworkError error_type, QString error_str);
    void userGetSignalError(QNetworkReply::NetworkError error_type, const QString &error_str);
