...
public class PostActivity {
  ...
  public PostActivity activityType(ActivityTypeEnum activityType) {
  ...
  public PostActivity occurredAt(String occurredAt) {
  ...
  public PostActivity url(String url) {
    this.url = url;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.activityType, postActivity.activityType) &&
        Objects.equals(this.occurredAt, postActivity.occurredAt) &&
        Objects.equals(this.url, postActivity.url);
  }

  @Override
  public int hashCode() {
    return Objects.hash(activityType, occurredAt, url);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to PostActivity
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PostActivity.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PostActivity is not found in the empty JSON string", PostActivity.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PostActivity.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PostActivity` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PostActivity.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PostActivity.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PostActivity' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PostActivity> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PostActivity.class));

       return (TypeAdapter<T>) new TypeAdapter<PostActivity>() {
           @Override
           public void write(JsonWriter out, PostActivity value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PostActivity read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PostActivity given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PostActivity
   * @throws IOException if the JSON string is invalid with respect to PostActivity
   */
  public static PostActivity fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PostActivity.class);
  }

  /**
   * Convert an instance of PostActivity to an JSON string
   *
   * @return JSON string
   */
