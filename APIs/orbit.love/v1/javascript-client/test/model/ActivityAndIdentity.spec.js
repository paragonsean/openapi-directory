...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OrbitApi.ActivityAndIdentity();
  });
  ...
  describe('ActivityAndIdentity', function() {
    it('should create an instance of ActivityAndIdentity', function() {
      // uncomment below and update the code to test ActivityAndIdentity
      //var instance = new OrbitApi.ActivityAndIdentity();
      //expect(instance).to.be.a(OrbitApi.ActivityAndIdentity);
    });
