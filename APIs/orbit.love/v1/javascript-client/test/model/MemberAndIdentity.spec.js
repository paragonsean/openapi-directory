...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OrbitApi.MemberAndIdentity();
  });
  ...
  describe('MemberAndIdentity', function() {
    it('should create an instance of MemberAndIdentity', function() {
      // uncomment below and update the code to test MemberAndIdentity
      //var instance = new OrbitApi.MemberAndIdentity();
      //expect(instance).to.be.a(OrbitApi.MemberAndIdentity);
    });
