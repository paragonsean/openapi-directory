...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OrbitApi.PostActivityWithMember();
  });
  ...
  describe('PostActivityWithMember', function() {
    it('should create an instance of PostActivityWithMember', function() {
      // uncomment below and update the code to test PostActivityWithMember
      //var instance = new OrbitApi.PostActivityWithMember();
      //expect(instance).to.be.a(OrbitApi.PostActivityWithMember);
    });
