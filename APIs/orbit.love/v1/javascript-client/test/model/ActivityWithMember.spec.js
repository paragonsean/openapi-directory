...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OrbitApi.ActivityWithMember();
  });
  ...
  describe('ActivityWithMember', function() {
    it('should create an instance of ActivityWithMember', function() {
      // uncomment below and update the code to test ActivityWithMember
      //var instance = new OrbitApi.ActivityWithMember();
      //expect(instance).to.be.a(OrbitApi.ActivityWithMember);
    });
