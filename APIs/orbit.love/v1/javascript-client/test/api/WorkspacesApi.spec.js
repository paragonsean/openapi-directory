...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OrbitApi.WorkspacesApi();
  });
  ...
  describe('WorkspacesApi', function() {
    ...
    describe('workspacesWorkspaceSlugGet', function() {
      it('should call workspacesWorkspaceSlugGet successfully', function(done) {
        //uncomment below and update the code to test workspacesWorkspaceSlugGet
        //instance.workspacesWorkspaceSlugGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
