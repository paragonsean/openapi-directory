...
public class ReferenceLine {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.lineNumber, referenceLine.lineNumber) &&
        Objects.equals(this.lineText, referenceLine.lineText);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(lineNumber, lineText);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ReferenceLine.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ReferenceLine` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
