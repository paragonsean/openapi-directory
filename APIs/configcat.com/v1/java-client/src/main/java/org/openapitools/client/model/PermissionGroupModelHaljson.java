...
public class PermissionGroupModelHaljson {
  ...
  public PermissionGroupModelHaljson embedded(ConfigModelHaljsonEmbedded embedded) {
  ...
  public PermissionGroupModelHaljson links(EnvironmentModelHaljsonLinks links) {
    this.links = links;
    return this;
  }
  ...
  public PermissionGroupModelHaljson accessType(AccessType accessType) {
  ...
  public PermissionGroupModelHaljson canCreateOrUpdateConfig(Boolean canCreateOrUpdateConfig) {
  ...
  public PermissionGroupModelHaljson canCreateOrUpdateEnvironment(Boolean canCreateOrUpdateEnvironment) {
  ...
  public PermissionGroupModelHaljson canCreateOrUpdateSegments(Boolean canCreateOrUpdateSegments) {
  ...
  public PermissionGroupModelHaljson canCreateOrUpdateSetting(Boolean canCreateOrUpdateSetting) {
  ...
  public PermissionGroupModelHaljson canCreateOrUpdateTag(Boolean canCreateOrUpdateTag) {
  ...
  public PermissionGroupModelHaljson canDeleteConfig(Boolean canDeleteConfig) {
  ...
  public PermissionGroupModelHaljson canDeleteEnvironment(Boolean canDeleteEnvironment) {
  ...
  public PermissionGroupModelHaljson canDeleteSegments(Boolean canDeleteSegments) {
  ...
  public PermissionGroupModelHaljson canDeleteSetting(Boolean canDeleteSetting) {
  ...
  public PermissionGroupModelHaljson canDeleteTag(Boolean canDeleteTag) {
  ...
  public PermissionGroupModelHaljson canManageIntegrations(Boolean canManageIntegrations) {
  ...
  public PermissionGroupModelHaljson canManageMembers(Boolean canManageMembers) {
  ...
  public PermissionGroupModelHaljson canManageProductPreferences(Boolean canManageProductPreferences) {
  ...
  public PermissionGroupModelHaljson canManageWebhook(Boolean canManageWebhook) {
  ...
  public PermissionGroupModelHaljson canRotateSdkKey(Boolean canRotateSdkKey) {
  ...
  public PermissionGroupModelHaljson canTagSetting(Boolean canTagSetting) {
  ...
  public PermissionGroupModelHaljson canUseExportImport(Boolean canUseExportImport) {
  ...
  public PermissionGroupModelHaljson canViewProductAuditLog(Boolean canViewProductAuditLog) {
  ...
  public PermissionGroupModelHaljson canViewProductStatistics(Boolean canViewProductStatistics) {
  ...
  public PermissionGroupModelHaljson canViewSdkKey(Boolean canViewSdkKey) {
  ...
  public PermissionGroupModelHaljson environmentAccesses(List<EnvironmentAccessModel> environmentAccesses) {
    this.environmentAccesses = environmentAccesses;
    return this;
  }

  public PermissionGroupModelHaljson addEnvironmentAccessesItem(EnvironmentAccessModel environmentAccessesItem) {
  ...
  public PermissionGroupModelHaljson name(String name) {
    this.name = name;
    return this;
  }
  ...
  public PermissionGroupModelHaljson newEnvironmentAccessType(EnvironmentAccessType newEnvironmentAccessType) {
  ...
  public PermissionGroupModelHaljson permissionGroupId(Long permissionGroupId) {
  ...
  public boolean equals(Object o) {
    ...
    PermissionGroupModelHaljson permissionGroupModelHaljson = (PermissionGroupModelHaljson) o;
    return Objects.equals(this.embedded, permissionGroupModelHaljson.embedded) &&
        Objects.equals(this.links, permissionGroupModelHaljson.links) &&
        Objects.equals(this.accessType, permissionGroupModelHaljson.accessType) &&
        Objects.equals(this.canCreateOrUpdateConfig, permissionGroupModelHaljson.canCreateOrUpdateConfig) &&
        Objects.equals(this.canCreateOrUpdateEnvironment, permissionGroupModelHaljson.canCreateOrUpdateEnvironment) &&
        Objects.equals(this.canCreateOrUpdateSegments, permissionGroupModelHaljson.canCreateOrUpdateSegments) &&
        Objects.equals(this.canCreateOrUpdateSetting, permissionGroupModelHaljson.canCreateOrUpdateSetting) &&
        Objects.equals(this.canCreateOrUpdateTag, permissionGroupModelHaljson.canCreateOrUpdateTag) &&
        Objects.equals(this.canDeleteConfig, permissionGroupModelHaljson.canDeleteConfig) &&
        Objects.equals(this.canDeleteEnvironment, permissionGroupModelHaljson.canDeleteEnvironment) &&
        Objects.equals(this.canDeleteSegments, permissionGroupModelHaljson.canDeleteSegments) &&
        Objects.equals(this.canDeleteSetting, permissionGroupModelHaljson.canDeleteSetting) &&
        Objects.equals(this.canDeleteTag, permissionGroupModelHaljson.canDeleteTag) &&
        Objects.equals(this.canManageIntegrations, permissionGroupModelHaljson.canManageIntegrations) &&
        Objects.equals(this.canManageMembers, permissionGroupModelHaljson.canManageMembers) &&
        Objects.equals(this.canManageProductPreferences, permissionGroupModelHaljson.canManageProductPreferences) &&
        Objects.equals(this.canManageWebhook, permissionGroupModelHaljson.canManageWebhook) &&
        Objects.equals(this.canRotateSdkKey, permissionGroupModelHaljson.canRotateSdkKey) &&
        Objects.equals(this.canTagSetting, permissionGroupModelHaljson.canTagSetting) &&
        Objects.equals(this.canUseExportImport, permissionGroupModelHaljson.canUseExportImport) &&
        Objects.equals(this.canViewProductAuditLog, permissionGroupModelHaljson.canViewProductAuditLog) &&
        Objects.equals(this.canViewProductStatistics, permissionGroupModelHaljson.canViewProductStatistics) &&
        Objects.equals(this.canViewSdkKey, permissionGroupModelHaljson.canViewSdkKey) &&
        Objects.equals(this.environmentAccesses, permissionGroupModelHaljson.environmentAccesses) &&
        Objects.equals(this.name, permissionGroupModelHaljson.name) &&
        Objects.equals(this.newEnvironmentAccessType, permissionGroupModelHaljson.newEnvironmentAccessType) &&
        Objects.equals(this.permissionGroupId, permissionGroupModelHaljson.permissionGroupId);
  }
  ...
  public String toString() {
    ...
    sb.append("class PermissionGroupModelHaljson {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PermissionGroupModelHaljson
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PermissionGroupModelHaljson.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PermissionGroupModelHaljson is not found in the empty JSON string", PermissionGroupModelHaljson.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PermissionGroupModelHaljson.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PermissionGroupModelHaljson` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PermissionGroupModelHaljson.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PermissionGroupModelHaljson' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PermissionGroupModelHaljson> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PermissionGroupModelHaljson.class));

       return (TypeAdapter<T>) new TypeAdapter<PermissionGroupModelHaljson>() {
           @Override
           public void write(JsonWriter out, PermissionGroupModelHaljson value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PermissionGroupModelHaljson read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PermissionGroupModelHaljson given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PermissionGroupModelHaljson
   * @throws IOException if the JSON string is invalid with respect to PermissionGroupModelHaljson
   */
  public static PermissionGroupModelHaljson fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PermissionGroupModelHaljson.class);
  }

  /**
   * Convert an instance of PermissionGroupModelHaljson to an JSON string
   *
   * @return JSON string
   */
