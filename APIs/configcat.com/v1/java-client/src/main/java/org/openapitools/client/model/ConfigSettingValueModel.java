...
public class ConfigSettingValueModel {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.integrationLinks, configSettingValueModel.integrationLinks) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(integrationLinks, lastUpdaterUserEmail, lastUpdaterUserFullName, rolloutPercentageItems, rolloutRules, setting, settingTags, updatedAt, value);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ConfigSettingValueModel.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ConfigSettingValueModel` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
