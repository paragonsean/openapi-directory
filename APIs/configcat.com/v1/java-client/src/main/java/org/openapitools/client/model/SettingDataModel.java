...
public class SettingDataModel {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.createdAt, settingDataModel.createdAt) &&
        ...
        Objects.equals(this.settingId, settingDataModel.settingId) &&
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SettingDataModel.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SettingDataModel` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
