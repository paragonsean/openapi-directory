...
public class OrganizationModel {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, organizationModel.name) &&
        Objects.equals(this.organizationId, organizationModel.organizationId);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!OrganizationModel.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `OrganizationModel` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
