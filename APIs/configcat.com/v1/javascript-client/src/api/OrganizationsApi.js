...
export default class OrganizationsApi {
    ...
    */
     ...
     * @param {Array.<module:model/OrganizationModelHaljson>} data The data returned by the service call.
     ...
     * data is of type: {@link Array.<module:model/OrganizationModelHaljson>}
     */
    getOrganizations(callback) {
      ...
      let returnType = [OrganizationModelHaljson];
