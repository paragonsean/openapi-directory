...
/**
 * The UpdateSettingValueWithSettingIdModel model module.
 * @module model/UpdateSettingValueWithSettingIdModel
 * @version v1
 */
class UpdateSettingValueWithSettingIdModel {
    /**
     * Constructs a new <code>UpdateSettingValueWithSettingIdModel</code>.
     * @alias module:model/UpdateSettingValueWithSettingIdModel
     */
    constructor() { 
        
        UpdateSettingValueWithSettingIdModel.initialize(this);
    }
    ...
    /**
     * Constructs a <code>UpdateSettingValueWithSettingIdModel</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateSettingValueWithSettingIdModel} obj Optional instance to populate.
     * @return {module:model/UpdateSettingValueWithSettingIdModel} The populated <code>UpdateSettingValueWithSettingIdModel</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateSettingValueWithSettingIdModel();
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateSettingValueWithSettingIdModel</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateSettingValueWithSettingIdModel</code>.
     */
 ...
 */
UpdateSettingValueWithSettingIdModel.prototype['rolloutPercentageItems'] = undefined;

/**
 * The targeting rule collection.
 * @member {Array.<module:model/RolloutRuleModel>} rolloutRules
 */
UpdateSettingValueWithSettingIdModel.prototype['rolloutRules'] = undefined;

/**
 * The id of the Setting.
 * @member {Number} settingId
 */
UpdateSettingValueWithSettingIdModel.prototype['settingId'] = undefined;

/**
 * The value to serve. It must respect the setting type.
 * @member {Object} value
 */
UpdateSettingValueWithSettingIdModel.prototype['value'] = undefined;
...
export default UpdateSettingValueWithSettingIdModel;
