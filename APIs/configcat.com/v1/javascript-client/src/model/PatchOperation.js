...
class PatchOperation {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('from')) {
                obj['from'] = JsonPointer.constructFromObject(data['from']);
            }
            if (data.hasOwnProperty('op')) {
                obj['op'] = OperationType.constructFromObject(data['op']);
            }
            if (data.hasOwnProperty('path')) {
                obj['path'] = JsonPointer.constructFromObject(data['path']);
            }
            if (data.hasOwnProperty('value')) {
                obj['value'] = JsonNode.constructFromObject(data['value']);
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        if (data['from']) { // data not null
          JsonPointer.validateJSON(data['from']);
        }
        // validate the optional field `path`
        if (data['path']) { // data not null
          JsonPointer.validateJSON(data['path']);
        }
        // validate the optional field `value`
        if (data['value']) { // data not null
          JsonNode.validateJSON(data['value']);
        }
...
/**
 * @member {module:model/JsonPointer} from
 */
...
/**
 * @member {module:model/JsonPointer} path
 */
PatchOperation.prototype['path'] = undefined;

/**
 * @member {module:model/JsonNode} value
 */
