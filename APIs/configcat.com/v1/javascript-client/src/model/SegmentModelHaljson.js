...
/**
 * The SegmentModelHaljson model module.
 * @module model/SegmentModelHaljson
 * @version v1
 */
class SegmentModelHaljson {
    /**
     * Constructs a new <code>SegmentModelHaljson</code>.
     * @alias module:model/SegmentModelHaljson
     */
    constructor() { 
        
        SegmentModelHaljson.initialize(this);
    }
    ...
    /**
     * Constructs a <code>SegmentModelHaljson</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SegmentModelHaljson} obj Optional instance to populate.
     * @return {module:model/SegmentModelHaljson} The populated <code>SegmentModelHaljson</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SegmentModelHaljson();
    ...
    /**
     * Validates the JSON data with respect to <code>SegmentModelHaljson</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SegmentModelHaljson</code>.
     */
 ...
 */
SegmentModelHaljson.prototype['_embedded'] = undefined;

/**
 * @member {module:model/EnvironmentModelHaljsonLinks} _links
 */
SegmentModelHaljson.prototype['_links'] = undefined;

/**
 * @member {module:model/RolloutRuleComparator} comparator
 */
SegmentModelHaljson.prototype['comparator'] = undefined;

/**
 * @member {String} comparisonAttribute
 */
SegmentModelHaljson.prototype['comparisonAttribute'] = undefined;

/**
 * @member {String} comparisonValue
 */
SegmentModelHaljson.prototype['comparisonValue'] = undefined;

/**
 * @member {Date} createdAt
 */
SegmentModelHaljson.prototype['createdAt'] = undefined;

/**
 * @member {String} creatorEmail
 */
SegmentModelHaljson.prototype['creatorEmail'] = undefined;

/**
 * @member {String} creatorFullName
 */
SegmentModelHaljson.prototype['creatorFullName'] = undefined;

/**
 * @member {String} description
 */
SegmentModelHaljson.prototype['description'] = undefined;

/**
 * @member {String} lastUpdaterEmail
 */
SegmentModelHaljson.prototype['lastUpdaterEmail'] = undefined;

/**
 * @member {String} lastUpdaterFullName
 */
SegmentModelHaljson.prototype['lastUpdaterFullName'] = undefined;

/**
 * @member {String} name
 */
SegmentModelHaljson.prototype['name'] = undefined;

/**
 * @member {String} segmentId
 */
SegmentModelHaljson.prototype['segmentId'] = undefined;

/**
 * @member {Date} updatedAt
 */
SegmentModelHaljson.prototype['updatedAt'] = undefined;
...
export default SegmentModelHaljson;
