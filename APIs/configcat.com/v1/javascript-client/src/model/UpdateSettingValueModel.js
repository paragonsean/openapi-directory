...
/**
 * The UpdateSettingValueModel model module.
 * @module model/UpdateSettingValueModel
 * @version v1
 */
class UpdateSettingValueModel {
    /**
     * Constructs a new <code>UpdateSettingValueModel</code>.
     * @alias module:model/UpdateSettingValueModel
     */
    constructor() { 
        
        UpdateSettingValueModel.initialize(this);
    }
    ...
    /**
     * Constructs a <code>UpdateSettingValueModel</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateSettingValueModel} obj Optional instance to populate.
     * @return {module:model/UpdateSettingValueModel} The populated <code>UpdateSettingValueModel</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateSettingValueModel();
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateSettingValueModel</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateSettingValueModel</code>.
     */
 ...
 */
UpdateSettingValueModel.prototype['rolloutPercentageItems'] = undefined;

/**
 * The targeting rule collection.
 * @member {Array.<module:model/RolloutRuleModel>} rolloutRules
 */
UpdateSettingValueModel.prototype['rolloutRules'] = undefined;

/**
 * The value to serve. It must respect the setting type.
 * @member {Object} value
 */
UpdateSettingValueModel.prototype['value'] = undefined;
...
export default UpdateSettingValueModel;
