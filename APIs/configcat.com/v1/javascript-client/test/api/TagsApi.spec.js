...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ConfigCatPublicManagementApi.TagsApi();
  });
  ...
  describe('TagsApi', function() {
    ...
    describe('getSettingsByTag', function() {
      it('should call getSettingsByTag successfully', function(done) {
        //uncomment below and update the code to test getSettingsByTag
        //instance.getSettingsByTag(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
