...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ConfigCatPublicManagementApi.ConfigModelHaljsonEmbeddedProductLinks();
  });
  ...
  describe('ConfigModelHaljsonEmbeddedProductLinks', function() {
    it('should create an instance of ConfigModelHaljsonEmbeddedProductLinks', function() {
      // uncomment below and update the code to test ConfigModelHaljsonEmbeddedProductLinks
      //var instance = new ConfigCatPublicManagementApi.ConfigModelHaljsonEmbeddedProductLinks();
      //expect(instance).to.be.a(ConfigCatPublicManagementApi.ConfigModelHaljsonEmbeddedProductLinks);
    });
    ...
    it('should have the property permissionGroups (base name: "permission-groups")', function() {
