...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ConfigCatPublicManagementApi.CreatePermissionGroupRequest();
  });
  ...
  describe('CreatePermissionGroupRequest', function() {
    it('should create an instance of CreatePermissionGroupRequest', function() {
      // uncomment below and update the code to test CreatePermissionGroupRequest
      //var instance = new ConfigCatPublicManagementApi.CreatePermissionGroupRequest();
      //expect(instance).to.be.a(ConfigCatPublicManagementApi.CreatePermissionGroupRequest);
    });
