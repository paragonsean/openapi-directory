...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ConfigCatPublicManagementApi.JsonNode();
  });
  ...
  describe('JsonNode', function() {
    it('should create an instance of JsonNode', function() {
      ...
      //var instance = new ConfigCatPublicManagementApi.JsonNode();
      //expect(instance).to.be.a(ConfigCatPublicManagementApi.JsonNode);
    });
