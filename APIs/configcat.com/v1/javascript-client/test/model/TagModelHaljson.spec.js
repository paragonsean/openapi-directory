...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ConfigCatPublicManagementApi.TagModelHaljson();
  });
  ...
  describe('TagModelHaljson', function() {
    it('should create an instance of TagModelHaljson', function() {
      // uncomment below and update the code to test TagModelHaljson
      //var instance = new ConfigCatPublicManagementApi.TagModelHaljson();
      //expect(instance).to.be.a(ConfigCatPublicManagementApi.TagModelHaljson);
    });
