...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ConfigCatPublicManagementApi.DeleteRepositoryReportsRequest();
  });
  ...
  describe('DeleteRepositoryReportsRequest', function() {
    it('should create an instance of DeleteRepositoryReportsRequest', function() {
      // uncomment below and update the code to test DeleteRepositoryReportsRequest
      //var instance = new ConfigCatPublicManagementApi.DeleteRepositoryReportsRequest();
      //expect(instance).to.be.a(ConfigCatPublicManagementApi.DeleteRepositoryReportsRequest);
    });
