...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ConfigCatPublicManagementApi.CodeReferenceRequest();
  });
  ...
  describe('CodeReferenceRequest', function() {
    it('should create an instance of CodeReferenceRequest', function() {
      // uncomment below and update the code to test CodeReferenceRequest
      //var instance = new ConfigCatPublicManagementApi.CodeReferenceRequest();
      //expect(instance).to.be.a(ConfigCatPublicManagementApi.CodeReferenceRequest);
    });

    it('should have the property activeBranches (base name: "activeBranches")', function() {
      // uncomment below and update the code to test the property activeBranches
      //var instance = new ConfigCatPublicManagementApi.CodeReferenceRequest();
    ...
    it('should have the property flagReferences (base name: "flagReferences")', function() {
      // uncomment below and update the code to test the property flagReferences
      //var instance = new ConfigCatPublicManagementApi.CodeReferenceRequest();
      //expect(instance).to.be();
    });
