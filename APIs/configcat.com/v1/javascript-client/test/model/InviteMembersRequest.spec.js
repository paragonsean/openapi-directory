...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ConfigCatPublicManagementApi.InviteMembersRequest();
  });
  ...
  describe('InviteMembersRequest', function() {
    it('should create an instance of InviteMembersRequest', function() {
      // uncomment below and update the code to test InviteMembersRequest
      //var instance = new ConfigCatPublicManagementApi.InviteMembersRequest();
      //expect(instance).to.be.a(ConfigCatPublicManagementApi.InviteMembersRequest);
    });
