...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ConfigCatPublicManagementApi.SettingModel();
  });
  ...
  describe('SettingModel', function() {
    it('should create an instance of SettingModel', function() {
      // uncomment below and update the code to test SettingModel
      //var instance = new ConfigCatPublicManagementApi.SettingModel();
      //expect(instance).to.be.a(ConfigCatPublicManagementApi.SettingModel);
    });
