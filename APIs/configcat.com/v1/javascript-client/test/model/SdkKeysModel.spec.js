...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ConfigCatPublicManagementApi.SdkKeysModel();
  });
  ...
  describe('SdkKeysModel', function() {
    it('should create an instance of SdkKeysModel', function() {
      // uncomment below and update the code to test SdkKeysModel
      //var instance = new ConfigCatPublicManagementApi.SdkKeysModel();
      //expect(instance).to.be.a(ConfigCatPublicManagementApi.SdkKeysModel);
    });
