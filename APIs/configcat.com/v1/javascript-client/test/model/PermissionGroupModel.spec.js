...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ConfigCatPublicManagementApi.PermissionGroupModel();
  });
  ...
  describe('PermissionGroupModel', function() {
    it('should create an instance of PermissionGroupModel', function() {
      // uncomment below and update the code to test PermissionGroupModel
      //var instance = new ConfigCatPublicManagementApi.PermissionGroupModel();
      //expect(instance).to.be.a(ConfigCatPublicManagementApi.PermissionGroupModel);
    });
