...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ConfigCatPublicManagementApi.TagModel();
  });
  ...
  describe('TagModel', function() {
    it('should create an instance of TagModel', function() {
      // uncomment below and update the code to test TagModel
      //var instance = new ConfigCatPublicManagementApi.TagModel();
      //expect(instance).to.be.a(ConfigCatPublicManagementApi.TagModel);
    });
