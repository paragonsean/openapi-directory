...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ConfigCatPublicManagementApi.ConfigModel();
  });
  ...
  describe('ConfigModel', function() {
    it('should create an instance of ConfigModel', function() {
      // uncomment below and update the code to test ConfigModel
      //var instance = new ConfigCatPublicManagementApi.ConfigModel();
      //expect(instance).to.be.a(ConfigCatPublicManagementApi.ConfigModel);
    });
