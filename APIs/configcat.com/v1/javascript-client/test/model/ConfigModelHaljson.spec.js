...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ConfigCatPublicManagementApi.ConfigModelHaljson();
  });
  ...
  describe('ConfigModelHaljson', function() {
    it('should create an instance of ConfigModelHaljson', function() {
      // uncomment below and update the code to test ConfigModelHaljson
      //var instance = new ConfigCatPublicManagementApi.ConfigModelHaljson();
      //expect(instance).to.be.a(ConfigCatPublicManagementApi.ConfigModelHaljson);
    });
