...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ConfigCatPublicManagementApi.UpdatePermissionGroupRequest();
  });
  ...
  describe('UpdatePermissionGroupRequest', function() {
    it('should create an instance of UpdatePermissionGroupRequest', function() {
      ...
      //var instance = new ConfigCatPublicManagementApi.UpdatePermissionGroupRequest();
      //expect(instance).to.be.a(ConfigCatPublicManagementApi.UpdatePermissionGroupRequest);
    });
