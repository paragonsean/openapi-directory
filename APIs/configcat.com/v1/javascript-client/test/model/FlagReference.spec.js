...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ConfigCatPublicManagementApi.FlagReference();
  });
  ...
  describe('FlagReference', function() {
    it('should create an instance of FlagReference', function() {
      // uncomment below and update the code to test FlagReference
      //var instance = new ConfigCatPublicManagementApi.FlagReference();
      //expect(instance).to.be.a(ConfigCatPublicManagementApi.FlagReference);
    });
