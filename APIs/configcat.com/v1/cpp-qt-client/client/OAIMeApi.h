...
Q_SIGNALS:
    ...
    void getMeSignal(OAIMeModel summary);


    void getMeSignalFull(OAIHttpRequestWorker *worker, OAIMeModel summary);

    Q_DECL_DEPRECATED_X("Use getMeSignalError() instead")
    void getMeSignalE(OAIMeModel summary, QNetworkReply::NetworkError error_type, QString error_str);
    void getMeSignalError(OAIMeModel summary, QNetworkReply::NetworkError error_type, const QString &error_str);
