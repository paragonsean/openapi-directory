...
public:
    ...
    OAIJsonNodeOptions getOptions() const;
    void setOptions(const OAIJsonNodeOptions &options);
    bool is_options_Set() const;
    bool is_options_Valid() const;

    OAIJsonNode getParent() const;
    void setParent(const OAIJsonNode &parent);
    bool is_parent_Set() const;
    bool is_parent_Valid() const;

    OAIJsonNode getRoot() const;
    void setRoot(const OAIJsonNode &root);
...
private:
    ...
    OAIJsonNodeOptions m_options;
    bool m_options_isSet;
    bool m_options_isValid;

    OAIJsonNode m_parent;
    bool m_parent_isSet;
