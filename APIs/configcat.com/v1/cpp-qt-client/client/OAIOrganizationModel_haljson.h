...
/*
 * OAIOrganizationModel_haljson.h
 *
 * 
 */

#ifndef OAIOrganizationModel_haljson_H
#define OAIOrganizationModel_haljson_H
...
class OAIOrganizationModel_haljson : public OAIObject {
public:
    OAIOrganizationModel_haljson();
    OAIOrganizationModel_haljson(QString json);
    ~OAIOrganizationModel_haljson() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIOrganizationModel_haljson)

#endif // OAIOrganizationModel_haljson_H
