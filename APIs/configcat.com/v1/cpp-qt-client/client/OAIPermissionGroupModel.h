...
/*
 * OAIPermissionGroupModel.h
 *
 * 
 */

#ifndef OAIPermissionGroupModel_H
#define OAIPermissionGroupModel_H

#include <QJsonObject>

#include "OAIAccessType.h"
#include "OAIEnvironmentAccessModel.h"
...
namespace OpenAPI {
class OAIEnvironmentAccessModel;
class OAIProductModel;

class OAIPermissionGroupModel : public OAIObject {
public:
    OAIPermissionGroupModel();
    OAIPermissionGroupModel(QString json);
    ~OAIPermissionGroupModel() override;
    ...
    QList<OAIEnvironmentAccessModel> getEnvironmentAccesses() const;
    void setEnvironmentAccesses(const QList<OAIEnvironmentAccessModel> &environment_accesses);
...
private:
    ...
    QList<OAIEnvironmentAccessModel> m_environment_accesses;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPermissionGroupModel)

#endif // OAIPermissionGroupModel_H
