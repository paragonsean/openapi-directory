...
void OAIOperationType::fromJson(QString jsonString) {
    ...
    if ( jsonString.compare("unknown", Qt::CaseInsensitive) == 0) {
        m_value = eOAIOperationType::UNKNOWN;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("add", Qt::CaseInsensitive) == 0) {
        m_value = eOAIOperationType::ADD;
        m_value_isSet = m_value_isValid = true;
    }
...
QString OAIOperationType::asJson() const {
    ...
    QString val;
    switch (m_value){
        case eOAIOperationType::UNKNOWN:
            val = "unknown";
            break;
        case eOAIOperationType::ADD:
            val = "add";
            break;
        case eOAIOperationType::REMOVE:
            val = "remove";
            break;
        case eOAIOperationType::REPLACE:
            val = "replace";
            break;
        case eOAIOperationType::MOVE:
            val = "move";
            break;
        case eOAIOperationType::COPY:
            val = "copy";
            break;
        case eOAIOperationType::TEST:
            val = "test";
            break;
        default:
            break;
