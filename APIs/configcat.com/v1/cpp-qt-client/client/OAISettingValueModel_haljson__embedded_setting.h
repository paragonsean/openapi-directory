...
/*
 * OAISettingValueModel_haljson__embedded_setting.h
 *
 * 
 */

#ifndef OAISettingValueModel_haljson__embedded_setting_H
#define OAISettingValueModel_haljson__embedded_setting_H
...
class OAISettingValueModel_haljson__embedded_setting : public OAIObject {
public:
    OAISettingValueModel_haljson__embedded_setting();
    OAISettingValueModel_haljson__embedded_setting(QString json);
    ~OAISettingValueModel_haljson__embedded_setting() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISettingValueModel_haljson__embedded_setting)

#endif // OAISettingValueModel_haljson__embedded_setting_H
