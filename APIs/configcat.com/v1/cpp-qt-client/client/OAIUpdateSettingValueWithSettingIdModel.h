...
/*
 * OAIUpdateSettingValueWithSettingIdModel.h
 *
 * 
 */

#ifndef OAIUpdateSettingValueWithSettingIdModel_H
#define OAIUpdateSettingValueWithSettingIdModel_H
...
class OAIUpdateSettingValueWithSettingIdModel : public OAIObject {
public:
    OAIUpdateSettingValueWithSettingIdModel();
    OAIUpdateSettingValueWithSettingIdModel(QString json);
    ~OAIUpdateSettingValueWithSettingIdModel() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateSettingValueWithSettingIdModel)

#endif // OAIUpdateSettingValueWithSettingIdModel_H
