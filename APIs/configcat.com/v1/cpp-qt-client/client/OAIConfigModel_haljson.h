...
/*
 * OAIConfigModel_haljson.h
 *
 * 
 */

#ifndef OAIConfigModel_haljson_H
#define OAIConfigModel_haljson_H
...
class OAIConfigModel_haljson : public OAIObject {
public:
    OAIConfigModel_haljson();
    OAIConfigModel_haljson(QString json);
    ~OAIConfigModel_haljson() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIConfigModel_haljson)

#endif // OAIConfigModel_haljson_H
