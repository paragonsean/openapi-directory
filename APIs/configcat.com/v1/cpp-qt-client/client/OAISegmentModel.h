...
#ifndef OAISegmentModel_H
#define OAISegmentModel_H
...
class OAISegmentModel : public OAIObject {
public:
    OAISegmentModel();
    OAISegmentModel(QString json);
    ~OAISegmentModel() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISegmentModel)

#endif // OAISegmentModel_H
