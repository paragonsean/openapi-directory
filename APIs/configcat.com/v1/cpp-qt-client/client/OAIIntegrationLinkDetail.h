...
/*
 * OAIIntegrationLinkDetail.h
 *
 * 
 */

#ifndef OAIIntegrationLinkDetail_H
#define OAIIntegrationLinkDetail_H
...
class OAIIntegrationLinkDetail : public OAIObject {
public:
    OAIIntegrationLinkDetail();
    OAIIntegrationLinkDetail(QString json);
    ~OAIIntegrationLinkDetail() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIIntegrationLinkDetail)

#endif // OAIIntegrationLinkDetail_H
