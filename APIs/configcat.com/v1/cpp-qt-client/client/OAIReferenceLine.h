...
public:
    ...
    QString getLineText() const;
    void setLineText(const QString &line_text);
    bool is_line_text_Set() const;
    bool is_line_text_Valid() const;
...
private:
    ...
    QString m_line_text;
    bool m_line_text_isSet;
    bool m_line_text_isValid;
};
