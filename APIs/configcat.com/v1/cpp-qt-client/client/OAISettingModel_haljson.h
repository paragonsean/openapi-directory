...
/*
 * OAISettingModel_haljson.h
 *
 * 
 */

#ifndef OAISettingModel_haljson_H
#define OAISettingModel_haljson_H
...
namespace OpenAPI {
class OAISettingModel_haljson__embedded;
class OAIEnvironmentModel_haljson__links;

class OAISettingModel_haljson : public OAIObject {
public:
    OAISettingModel_haljson();
    OAISettingModel_haljson(QString json);
    ~OAISettingModel_haljson() override;
    ...
    OAISettingModel_haljson__embedded getEmbedded() const;
    void setEmbedded(const OAISettingModel_haljson__embedded &_embedded);
...
private:
    ...
    OAISettingModel_haljson__embedded m__embedded;
...
Q_DECLARE_METATYPE(OpenAPI::OAISettingModel_haljson)

#endif // OAISettingModel_haljson_H
