...
#ifndef OAIConfigModel_H
#define OAIConfigModel_H
...
class OAIConfigModel : public OAIObject {
public:
    OAIConfigModel();
    OAIConfigModel(QString json);
    ~OAIConfigModel() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIConfigModel)

#endif // OAIConfigModel_H
