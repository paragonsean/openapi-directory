...
/*
 * OAIPermissionGroupModel_haljson.h
 *
 * 
 */

#ifndef OAIPermissionGroupModel_haljson_H
#define OAIPermissionGroupModel_haljson_H
...
class OAIPermissionGroupModel_haljson : public OAIObject {
public:
    OAIPermissionGroupModel_haljson();
    OAIPermissionGroupModel_haljson(QString json);
    ~OAIPermissionGroupModel_haljson() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPermissionGroupModel_haljson)

#endif // OAIPermissionGroupModel_haljson_H
