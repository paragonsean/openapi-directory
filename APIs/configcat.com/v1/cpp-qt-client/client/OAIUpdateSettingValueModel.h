...
/*
 * OAIUpdateSettingValueModel.h
 *
 * 
 */

#ifndef OAIUpdateSettingValueModel_H
#define OAIUpdateSettingValueModel_H
...
class OAIUpdateSettingValueModel : public OAIObject {
public:
    OAIUpdateSettingValueModel();
    OAIUpdateSettingValueModel(QString json);
    ~OAIUpdateSettingValueModel() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateSettingValueModel)

#endif // OAIUpdateSettingValueModel_H
