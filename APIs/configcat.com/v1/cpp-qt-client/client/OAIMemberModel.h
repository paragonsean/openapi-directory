...
#ifndef OAIMemberModel_H
#define OAIMemberModel_H
...
class OAIMemberModel : public OAIObject {
public:
    OAIMemberModel();
    OAIMemberModel(QString json);
    ~OAIMemberModel() override;
    ...
    qint64 getPermissionGroupId() const;
    void setPermissionGroupId(const qint64 &permission_group_id);
...
Q_DECLARE_METATYPE(OpenAPI::OAIMemberModel)

#endif // OAIMemberModel_H
