...
/*
 * OAISegmentListModel_haljson.h
 *
 * 
 */

#ifndef OAISegmentListModel_haljson_H
#define OAISegmentListModel_haljson_H
...
class OAISegmentListModel_haljson : public OAIObject {
public:
    OAISegmentListModel_haljson();
    OAISegmentListModel_haljson(QString json);
    ~OAISegmentListModel_haljson() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISegmentListModel_haljson)

#endif // OAISegmentListModel_haljson_H
