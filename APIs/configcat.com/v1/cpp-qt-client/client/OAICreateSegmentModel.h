...
/*
 * OAICreateSegmentModel.h
 *
 * 
 */

#ifndef OAICreateSegmentModel_H
#define OAICreateSegmentModel_H
...
class OAICreateSegmentModel : public OAIObject {
public:
    OAICreateSegmentModel();
    OAICreateSegmentModel(QString json);
    ~OAICreateSegmentModel() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateSegmentModel)

#endif // OAICreateSegmentModel_H
