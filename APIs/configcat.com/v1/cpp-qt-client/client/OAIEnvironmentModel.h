...
/*
 * OAIEnvironmentModel.h
 *
 * 
 */

#ifndef OAIEnvironmentModel_H
#define OAIEnvironmentModel_H
...
class OAIEnvironmentModel : public OAIObject {
public:
    OAIEnvironmentModel();
    OAIEnvironmentModel(QString json);
    ~OAIEnvironmentModel() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEnvironmentModel)

#endif // OAIEnvironmentModel_H
