...
/*
 * OAIRolloutRuleModel.h
 *
 * 
 */

#ifndef OAIRolloutRuleModel_H
#define OAIRolloutRuleModel_H
...
class OAIRolloutRuleModel : public OAIObject {
public:
    OAIRolloutRuleModel();
    OAIRolloutRuleModel(QString json);
    ~OAIRolloutRuleModel() override;
    ...
    OAISegmentComparator getSegmentComparator() const;
    void setSegmentComparator(const OAISegmentComparator &segment_comparator);
    bool is_segment_comparator_Set() const;
    bool is_segment_comparator_Valid() const;
...
private:
    ...
    OAISegmentComparator m_segment_comparator;
    bool m_segment_comparator_isSet;
    bool m_segment_comparator_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRolloutRuleModel)

#endif // OAIRolloutRuleModel_H
