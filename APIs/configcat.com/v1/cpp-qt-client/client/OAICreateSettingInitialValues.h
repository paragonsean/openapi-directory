...
/*
 * OAICreateSettingInitialValues.h
 *
 * 
 */

#ifndef OAICreateSettingInitialValues_H
#define OAICreateSettingInitialValues_H
...
class OAICreateSettingInitialValues : public OAIObject {
public:
    OAICreateSettingInitialValues();
    OAICreateSettingInitialValues(QString json);
    ~OAICreateSettingInitialValues() override;
    ...
    QList<qint64> getTags() const;
    void setTags(const QList<qint64> &tags);
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateSettingInitialValues)

#endif // OAICreateSettingInitialValues_H
