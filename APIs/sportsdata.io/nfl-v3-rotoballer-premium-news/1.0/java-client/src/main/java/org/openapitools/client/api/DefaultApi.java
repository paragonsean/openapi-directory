...
public class DefaultApi {
    ...
    /**
     * Build call for premiumNewsByTeam
     * @param format Desired response format. Valid entries are &lt;code&gt;XML&lt;/code&gt; or &lt;code&gt;JSON&lt;/code&gt;. (required)
     ...
     */
    public okhttp3.Call premiumNewsByTeamCall(String format, String team, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/{format}/RotoBallerPremiumNewsByTeam/{team}"
            .replace("{" + "format" + "}", localVarApiClient.escapeString(format.toString()))
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call premiumNewsByTeamValidateBeforeCall(String format, String team, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'format' is set
        if (format == null) {
            throw new ApiException("Missing the required parameter 'format' when calling premiumNewsByTeam(Async)");
        }

        // verify the required parameter 'team' is set
        if (team == null) {
            throw new ApiException("Missing the required parameter 'team' when calling premiumNewsByTeam(Async)");
        }

        return premiumNewsByTeamCall(format, team, _callback);
     ...
     */
    public List<News> premiumNewsByTeam(String format, String team) throws ApiException {
        ApiResponse<List<News>> localVarResp = premiumNewsByTeamWithHttpInfo(format, team);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<List<News>> premiumNewsByTeamWithHttpInfo(String format, String team) throws ApiException {
        okhttp3.Call localVarCall = premiumNewsByTeamValidateBeforeCall(format, team, null);
        Type localVarReturnType = new TypeToken<List<News>>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Premium News by Team (asynchronously)
     * 
     * @param format Desired response format. Valid entries are &lt;code&gt;XML&lt;/code&gt; or &lt;code&gt;JSON&lt;/code&gt;. (required)
     * @param team Abbreviation of the team. Example: &lt;code&gt;WAS&lt;/code&gt;. (required)
     * @param _callback The callback to be executed when the API call finishes
     ...
     */
    public okhttp3.Call premiumNewsByTeamAsync(String format, String team, final ApiCallback<List<News>> _callback) throws ApiException {

        okhttp3.Call localVarCall = premiumNewsByTeamValidateBeforeCall(format, team, _callback);
        Type localVarReturnType = new TypeToken<List<News>>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
