...
* <pre>
* var CbbV3Scores = require('index'); // See note below*.
* var xxxSvc = new CbbV3Scores.XxxApi(); // Allocate the API class we're going to use.
* var yyyModel = new CbbV3Scores.Yyy(); // Construct a model instance.
...
* <pre>
* var xxxSvc = new CbbV3Scores.XxxApi(); // Allocate the API class we're going to use.
* var yyy = new CbbV3Scores.Yyy(); // Construct a model instance.
* yyyModel.someProperty = 'someValue';
* ...
* var zzz = xxxSvc.doSomething(yyyModel); // Invoke the service.
* ...
