...
qint32 OAITeamSeason::getAssists() const {
    return m_assists;
}
void OAITeamSeason::setAssists(const qint32 &assists) {
    m_assists = assists;
...
qint32 OAITeamSeason::getBlockedShots() const {
    return m_blocked_shots;
}
void OAITeamSeason::setBlockedShots(const qint32 &blocked_shots) {
...
qint32 OAITeamSeason::getDefensiveRebounds() const {
    return m_defensive_rebounds;
}
void OAITeamSeason::setDefensiveRebounds(const qint32 &defensive_rebounds) {
...
qint32 OAITeamSeason::getFieldGoalsAttempted() const {
    return m_field_goals_attempted;
}
void OAITeamSeason::setFieldGoalsAttempted(const qint32 &field_goals_attempted) {
...
qint32 OAITeamSeason::getFreeThrowsAttempted() const {
    return m_free_throws_attempted;
}
void OAITeamSeason::setFreeThrowsAttempted(const qint32 &free_throws_attempted) {
...
qint32 OAITeamSeason::getFreeThrowsMade() const {
    return m_free_throws_made;
}
void OAITeamSeason::setFreeThrowsMade(const qint32 &free_throws_made) {
...
qint32 OAITeamSeason::getOffensiveRebounds() const {
    return m_offensive_rebounds;
}
void OAITeamSeason::setOffensiveRebounds(const qint32 &offensive_rebounds) {
...
qint32 OAITeamSeason::getPersonalFouls() const {
    return m_personal_fouls;
}
void OAITeamSeason::setPersonalFouls(const qint32 &personal_fouls) {
...
qint32 OAITeamSeason::getPoints() const {
    return m_points;
}
void OAITeamSeason::setPoints(const qint32 &points) {
    m_points = points;
    m_points_isSet = true;
}
...
qint32 OAITeamSeason::getRebounds() const {
    return m_rebounds;
}
void OAITeamSeason::setRebounds(const qint32 &rebounds) {
    m_rebounds = rebounds;
...
qint32 OAITeamSeason::getSteals() const {
    return m_steals;
}
void OAITeamSeason::setSteals(const qint32 &steals) {
    m_steals = steals;
    m_steals_isSet = true;
}
...
qint32 OAITeamSeason::getThreePointersAttempted() const {
    return m_three_pointers_attempted;
}
void OAITeamSeason::setThreePointersAttempted(const qint32 &three_pointers_attempted) {
...
qint32 OAITeamSeason::getThreePointersMade() const {
    return m_three_pointers_made;
}
void OAITeamSeason::setThreePointersMade(const qint32 &three_pointers_made) {
...
qint32 OAITeamSeason::getTurnovers() const {
    return m_turnovers;
}
void OAITeamSeason::setTurnovers(const qint32 &turnovers) {
...
qint32 OAITeamSeason::getTwoPointersAttempted() const {
    return m_two_pointers_attempted;
}
void OAITeamSeason::setTwoPointersAttempted(const qint32 &two_pointers_attempted) {
...
qint32 OAITeamSeason::getTwoPointersMade() const {
    return m_two_pointers_made;
}
void OAITeamSeason::setTwoPointersMade(const qint32 &two_pointers_made) {
