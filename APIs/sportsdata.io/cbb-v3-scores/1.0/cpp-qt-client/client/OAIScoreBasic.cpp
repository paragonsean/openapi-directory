...
qint32 OAIScoreBasic::getAwayTeamSeed() const {
    return m_away_team_seed;
}
void OAIScoreBasic::setAwayTeamSeed(const qint32 &away_team_seed) {
    m_away_team_seed = away_team_seed;
    m_away_team_seed_isSet = true;
}

bool OAIScoreBasic::is_away_team_seed_Set() const{
    return m_away_team_seed_isSet;
}

bool OAIScoreBasic::is_away_team_seed_Valid() const{
    return m_away_team_seed_isValid;
}

QString OAIScoreBasic::getBracket() const {
    return m_bracket;
}
void OAIScoreBasic::setBracket(const QString &bracket) {
    m_bracket = bracket;
    m_bracket_isSet = true;
}

bool OAIScoreBasic::is_bracket_Set() const{
    return m_bracket_isSet;
}

bool OAIScoreBasic::is_bracket_Valid() const{
...
qint32 OAIScoreBasic::getHomeTeamSeed() const {
    return m_home_team_seed;
}
void OAIScoreBasic::setHomeTeamSeed(const qint32 &home_team_seed) {
    m_home_team_seed = home_team_seed;
    m_home_team_seed_isSet = true;
}

bool OAIScoreBasic::is_home_team_seed_Set() const{
    return m_home_team_seed_isSet;
}

bool OAIScoreBasic::is_home_team_seed_Valid() const{
...
qint32 OAIScoreBasic::getRound() const {
    return m_round;
}
void OAIScoreBasic::setRound(const qint32 &round) {
    m_round = round;
    m_round_isSet = true;
}

bool OAIScoreBasic::is_round_Set() const{
    return m_round_isSet;
}

bool OAIScoreBasic::is_round_Valid() const{
...
qint32 OAIScoreBasic::getTournamentId() const {
    return m_tournament_id;
}
void OAIScoreBasic::setTournamentId(const qint32 &tournament_id) {
    m_tournament_id = tournament_id;
    m_tournament_id_isSet = true;
}

bool OAIScoreBasic::is_tournament_id_Set() const{
    return m_tournament_id_isSet;
}

bool OAIScoreBasic::is_tournament_id_Valid() const{
