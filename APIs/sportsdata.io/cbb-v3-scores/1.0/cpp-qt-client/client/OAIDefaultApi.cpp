...
void OAIDefaultApi::initializeServerConfigs() {
    ...
    QUrl("http://azure-api.sportsdata.io/v3/cbb/scores"),
    "No description provided",
    QMap<QString, OAIServerVariable>()));
    defaultConf.append(OAIServerConfiguration(
    QUrl("https://azure-api.sportsdata.io/v3/cbb/scores"),
    "No description provided",
    QMap<QString, OAIServerVariable>()));
    ...
    _serverConfigs.insert("leagueHierarchy", defaultConf);
    _serverIndices.insert("leagueHierarchy", 0);
    ...
    _serverConfigs.insert("teamSchedule", defaultConf);
    _serverIndices.insert("teamSchedule", 0);
    ...
    _serverConfigs.insert("tournamentHierarchy", defaultConf);
    _serverIndices.insert("tournamentHierarchy", 0);
}
...
void OAIDefaultApi::leagueHierarchy(const QString &format) {
    QString fullPath = QString(_serverConfigs["leagueHierarchy"][_serverIndices.value("leagueHierarchy")].URL()+"/{format}/LeagueHierarchy");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIDefaultApi::leagueHierarchyCallback);
    connect(this, &OAIDefaultApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIDefaultApi::leagueHierarchyCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT leagueHierarchySignal(output);
        Q_EMIT leagueHierarchySignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT leagueHierarchySignalE(output, error_type, error_str);
        Q_EMIT leagueHierarchySignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT leagueHierarchySignalError(output, error_type, error_str);
        Q_EMIT leagueHierarchySignalErrorFull(worker, error_type, error_str);
    }
}
...
void OAIDefaultApi::teamSchedule(const QString &format, const QString &season, const QString &team) {
    QString fullPath = QString(_serverConfigs["teamSchedule"][_serverIndices.value("teamSchedule")].URL()+"/{format}/TeamSchedule/{season}/{team}");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIDefaultApi::teamScheduleCallback);
    connect(this, &OAIDefaultApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIDefaultApi::teamScheduleCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT teamScheduleSignal(output);
        Q_EMIT teamScheduleSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT teamScheduleSignalE(output, error_type, error_str);
        Q_EMIT teamScheduleSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT teamScheduleSignalError(output, error_type, error_str);
        Q_EMIT teamScheduleSignalErrorFull(worker, error_type, error_str);
    }
}
...
void OAIDefaultApi::tournamentHierarchy(const QString &format, const QString &season) {
    QString fullPath = QString(_serverConfigs["tournamentHierarchy"][_serverIndices.value("tournamentHierarchy")].URL()+"/{format}/Tournament/{season}");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIDefaultApi::tournamentHierarchyCallback);
    connect(this, &OAIDefaultApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIDefaultApi::tournamentHierarchyCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT tournamentHierarchySignal(output);
        Q_EMIT tournamentHierarchySignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT tournamentHierarchySignalE(output, error_type, error_str);
        Q_EMIT tournamentHierarchySignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT tournamentHierarchySignalError(output, error_type, error_str);
        Q_EMIT tournamentHierarchySignalErrorFull(worker, error_type, error_str);
    }
}
