...
qint32 OAIScheduleBasic::getAwayTeamSeed() const {
    return m_away_team_seed;
}
void OAIScheduleBasic::setAwayTeamSeed(const qint32 &away_team_seed) {
    m_away_team_seed = away_team_seed;
    m_away_team_seed_isSet = true;
}

bool OAIScheduleBasic::is_away_team_seed_Set() const{
    return m_away_team_seed_isSet;
}

bool OAIScheduleBasic::is_away_team_seed_Valid() const{
    return m_away_team_seed_isValid;
}

QString OAIScheduleBasic::getBracket() const {
    return m_bracket;
}
void OAIScheduleBasic::setBracket(const QString &bracket) {
    m_bracket = bracket;
    m_bracket_isSet = true;
}

bool OAIScheduleBasic::is_bracket_Set() const{
    return m_bracket_isSet;
}

bool OAIScheduleBasic::is_bracket_Valid() const{
...
qint32 OAIScheduleBasic::getHomeTeamSeed() const {
    return m_home_team_seed;
}
void OAIScheduleBasic::setHomeTeamSeed(const qint32 &home_team_seed) {
    m_home_team_seed = home_team_seed;
    m_home_team_seed_isSet = true;
}

bool OAIScheduleBasic::is_home_team_seed_Set() const{
    return m_home_team_seed_isSet;
}

bool OAIScheduleBasic::is_home_team_seed_Valid() const{
...
qint32 OAIScheduleBasic::getRound() const {
    return m_round;
}
void OAIScheduleBasic::setRound(const qint32 &round) {
    m_round = round;
    m_round_isSet = true;
}

bool OAIScheduleBasic::is_round_Set() const{
    return m_round_isSet;
}

bool OAIScheduleBasic::is_round_Valid() const{
...
qint32 OAIScheduleBasic::getTournamentId() const {
    return m_tournament_id;
}
void OAIScheduleBasic::setTournamentId(const qint32 &tournament_id) {
    m_tournament_id = tournament_id;
    m_tournament_id_isSet = true;
}

bool OAIScheduleBasic::is_tournament_id_Set() const{
    return m_tournament_id_isSet;
}

bool OAIScheduleBasic::is_tournament_id_Valid() const{
