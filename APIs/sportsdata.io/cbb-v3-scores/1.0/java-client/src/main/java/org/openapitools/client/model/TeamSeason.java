...
public class TeamSeason {
  ...
  public TeamSeason assists(Integer assists) {
  ...
  public TeamSeason blockedShots(Integer blockedShots) {
  ...
  public TeamSeason defensiveRebounds(Integer defensiveRebounds) {
  ...
  public TeamSeason fieldGoalsAttempted(Integer fieldGoalsAttempted) {
  ...
  public TeamSeason freeThrowsAttempted(Integer freeThrowsAttempted) {
  ...
  public TeamSeason freeThrowsMade(Integer freeThrowsMade) {
  ...
  public TeamSeason offensiveRebounds(Integer offensiveRebounds) {
  ...
  public TeamSeason personalFouls(Integer personalFouls) {
  ...
  public TeamSeason points(Integer points) {
    this.points = points;
    return this;
  }
  ...
  public TeamSeason rebounds(Integer rebounds) {
  ...
  public TeamSeason steals(Integer steals) {
    this.steals = steals;
    return this;
  }
  ...
  public TeamSeason threePointersAttempted(Integer threePointersAttempted) {
  ...
  public TeamSeason threePointersMade(Integer threePointersMade) {
  ...
  public TeamSeason turnovers(Integer turnovers) {
  ...
  public TeamSeason twoPointersAttempted(Integer twoPointersAttempted) {
  ...
  public TeamSeason twoPointersMade(Integer twoPointersMade) {
