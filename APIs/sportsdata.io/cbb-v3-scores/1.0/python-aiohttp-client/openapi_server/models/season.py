...
class Season(Model):
    ...
    def __init__(self, api_season: str=None, description: str=None, end_year: int=None, post_season_start_date: str=None, regular_season_start_date: str=None, season: int=None, start_year: int=None):
