...
class PlayerBasic(Model):
    ...
    def __init__(self, birth_city: str=None, birth_state: str=None, _class: str=None, first_name: str=None, global_team_id: int=None, height: int=None, jersey: int=None, last_name: str=None, player_id: int=None, position: str=None, team: str=None, team_id: int=None, weight: int=None):
