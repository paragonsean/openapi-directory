...
bool OAIScheduleBasic::isCanceled() const {
    return m_canceled;
}
void OAIScheduleBasic::setCanceled(const bool &canceled) {
    m_canceled = canceled;
    m_canceled_isSet = true;
}

bool OAIScheduleBasic::is_canceled_Set() const{
    return m_canceled_isSet;
}

bool OAIScheduleBasic::is_canceled_Valid() const{
    return m_canceled_isValid;
}

bool OAIScheduleBasic::isClosed() const {
    return m_closed;
}
void OAIScheduleBasic::setClosed(const bool &closed) {
    m_closed = closed;
    m_closed_isSet = true;
}

bool OAIScheduleBasic::is_closed_Set() const{
    return m_closed_isSet;
}

bool OAIScheduleBasic::is_closed_Valid() const{
    return m_closed_isValid;
}

QString OAIScheduleBasic::getDate() const {
    return m_date;
}
void OAIScheduleBasic::setDate(const QString &date) {
    m_date = date;
    m_date_isSet = true;
}

bool OAIScheduleBasic::is_date_Set() const{
    return m_date_isSet;
}

bool OAIScheduleBasic::is_date_Valid() const{
...
QString OAIScheduleBasic::getGameKey() const {
    return m_game_key;
}
void OAIScheduleBasic::setGameKey(const QString &game_key) {
    m_game_key = game_key;
    m_game_key_isSet = true;
}

bool OAIScheduleBasic::is_game_key_Set() const{
    return m_game_key_isSet;
}

bool OAIScheduleBasic::is_game_key_Valid() const{
...
QString OAIScheduleBasic::getLastUpdated() const {
    return m_last_updated;
}
void OAIScheduleBasic::setLastUpdated(const QString &last_updated) {
    m_last_updated = last_updated;
    m_last_updated_isSet = true;
}

bool OAIScheduleBasic::is_last_updated_Set() const{
    return m_last_updated_isSet;
}

bool OAIScheduleBasic::is_last_updated_Valid() const{
    return m_last_updated_isValid;
}

qint32 OAIScheduleBasic::getScoreId() const {
    return m_score_id;
}
void OAIScheduleBasic::setScoreId(const qint32 &score_id) {
    m_score_id = score_id;
    m_score_id_isSet = true;
}

bool OAIScheduleBasic::is_score_id_Set() const{
    return m_score_id_isSet;
}

bool OAIScheduleBasic::is_score_id_Valid() const{
