...
class Game(Model):
    ...
    def __init__(self, attendance: int=None, away_point_spread_payout: int=None, away_rotation_number: int=None, away_team: str=None, away_team_id: int=None, away_team_money_line: int=None, away_team_name: str=None, away_team_score: int=None, channel: str=None, created: str=None, date_time: str=None, date_time_utc: str=None, day: str=None, distance: int=None, down: int=None, game_end_date_time: str=None, game_id: int=None, global_away_team_id: int=None, global_game_id: int=None, global_home_team_id: int=None, home_point_spread_payout: int=None, home_rotation_number: int=None, home_team: str=None, home_team_id: int=None, home_team_money_line: int=None, home_team_name: str=None, home_team_score: int=None, is_closed: bool=None, neutral_venue: bool=None, over_payout: int=None, over_under: float=None, period: str=None, periods: List[Period]=None, point_spread: float=None, possession: str=None, season: int=None, season_type: int=None, stadium: Stadium=None, stadium_id: int=None, status: str=None, time_remaining_minutes: int=None, time_remaining_seconds: int=None, title: str=None, under_payout: int=None, updated: str=None, week: int=None, yard_line: int=None, yard_line_territory: str=None):
        ...
        :param created: The created of this Game.
        ...
        :param distance: The distance of this Game.
        :param down: The down of this Game.
        ...
        :param possession: The possession of this Game.
        ...
        :param yard_line: The yard_line of this Game.
        :param yard_line_territory: The yard_line_territory of this Game.
        """
        self.openapi_types = {
            'attendance': int,
    ...
    @property
    def created(self):
        """Gets the created of this Game.


        :return: The created of this Game.
        :rtype: str
        """
    ...
    @property
    def distance(self):
        """Gets the distance of this Game.


        :return: The distance of this Game.
        :rtype: int
        """
    ...
    def distance(self, distance):
        """Sets the distance of this Game.
    ...
    @property
    def down(self):
        """Gets the down of this Game.


        :return: The down of this Game.
        :rtype: int
        """
        return self._down
    ...
    @property
    def possession(self):
        """Gets the possession of this Game.


        :return: The possession of this Game.
        :rtype: str
        """
    ...
    def possession(self, possession):
        """Sets the possession of this Game.
    ...
    @property
    def yard_line(self):
        """Gets the yard_line of this Game.


        :return: The yard_line of this Game.
        :rtype: int
        """
    ...
    def yard_line(self, yard_line):
        """Sets the yard_line of this Game.
    ...
    def yard_line_territory(self):
        """Gets the yard_line_territory of this Game.


        :return: The yard_line_territory of this Game.
        :rtype: str
        """
    ...
    def yard_line_territory(self, yard_line_territory):
        """Sets the yard_line_territory of this Game.
