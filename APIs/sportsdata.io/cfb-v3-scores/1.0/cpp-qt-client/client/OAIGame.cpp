...
QString OAIGame::getCreated() const {
    return m_created;
}
void OAIGame::setCreated(const QString &created) {
    m_created = created;
    m_created_isSet = true;
}

bool OAIGame::is_created_Set() const{
    return m_created_isSet;
}

bool OAIGame::is_created_Valid() const{
...
qint32 OAIGame::getDistance() const {
    return m_distance;
}
void OAIGame::setDistance(const qint32 &distance) {
    m_distance = distance;
    m_distance_isSet = true;
}

bool OAIGame::is_distance_Set() const{
    return m_distance_isSet;
}

bool OAIGame::is_distance_Valid() const{
    return m_distance_isValid;
}

qint32 OAIGame::getDown() const {
    return m_down;
}
void OAIGame::setDown(const qint32 &down) {
    m_down = down;
    m_down_isSet = true;
}

bool OAIGame::is_down_Set() const{
    return m_down_isSet;
}

bool OAIGame::is_down_Valid() const{
...
QString OAIGame::getPossession() const {
    return m_possession;
}
void OAIGame::setPossession(const QString &possession) {
    m_possession = possession;
    m_possession_isSet = true;
}

bool OAIGame::is_possession_Set() const{
    return m_possession_isSet;
}

bool OAIGame::is_possession_Valid() const{
...
qint32 OAIGame::getYardLine() const {
    return m_yard_line;
}
void OAIGame::setYardLine(const qint32 &yard_line) {
    m_yard_line = yard_line;
    m_yard_line_isSet = true;
}

bool OAIGame::is_yard_line_Set() const{
    return m_yard_line_isSet;
}

bool OAIGame::is_yard_line_Valid() const{
    return m_yard_line_isValid;
}

QString OAIGame::getYardLineTerritory() const {
    return m_yard_line_territory;
}
void OAIGame::setYardLineTerritory(const QString &yard_line_territory) {
    m_yard_line_territory = yard_line_territory;
    m_yard_line_territory_isSet = true;
}

bool OAIGame::is_yard_line_territory_Set() const{
    return m_yard_line_territory_isSet;
}

bool OAIGame::is_yard_line_territory_Valid() const{
