...
QString OAIScheduleBasic::getAwayTeamName() const {
    return m_away_team_name;
}
void OAIScheduleBasic::setAwayTeamName(const QString &away_team_name) {
    m_away_team_name = away_team_name;
    m_away_team_name_isSet = true;
}

bool OAIScheduleBasic::is_away_team_name_Set() const{
    return m_away_team_name_isSet;
}

bool OAIScheduleBasic::is_away_team_name_Valid() const{
...
QString OAIScheduleBasic::getCreated() const {
    return m_created;
}
void OAIScheduleBasic::setCreated(const QString &created) {
    m_created = created;
    m_created_isSet = true;
}

bool OAIScheduleBasic::is_created_Set() const{
    return m_created_isSet;
}

bool OAIScheduleBasic::is_created_Valid() const{
...
QString OAIScheduleBasic::getHomeTeamName() const {
    return m_home_team_name;
}
void OAIScheduleBasic::setHomeTeamName(const QString &home_team_name) {
    m_home_team_name = home_team_name;
    m_home_team_name_isSet = true;
}

bool OAIScheduleBasic::is_home_team_name_Set() const{
    return m_home_team_name_isSet;
}

bool OAIScheduleBasic::is_home_team_name_Valid() const{
...
QString OAIScheduleBasic::getTitle() const {
    return m_title;
}
void OAIScheduleBasic::setTitle(const QString &title) {
    m_title = title;
    m_title_isSet = true;
}

bool OAIScheduleBasic::is_title_Set() const{
    return m_title_isSet;
}

bool OAIScheduleBasic::is_title_Valid() const{
...
qint32 OAIScheduleBasic::getWeek() const {
    return m_week;
}
void OAIScheduleBasic::setWeek(const qint32 &week) {
    m_week = week;
    m_week_isSet = true;
}

bool OAIScheduleBasic::is_week_Set() const{
    return m_week_isSet;
}

bool OAIScheduleBasic::is_week_Valid() const{
