...
class DfsSlateGame(Model):
    ...
    def __init__(self, game: Schedule=None, game_id: int=None, operator_game_id: int=None, removed_by_operator: bool=None, score_id: int=None, slate_game_id: int=None, slate_id: int=None):
        ...
        :param score_id: The score_id of this DfsSlateGame.
    ...
    @property
    def score_id(self):
        """Gets the score_id of this DfsSlateGame.


        :return: The score_id of this DfsSlateGame.
        :rtype: int
        """
