...
void OAIDfsSlatePlayer::initializeModel() {
    ...
    m_fantasy_defense_projection_stat_id_isSet = false;
    m_fantasy_defense_projection_stat_id_isValid = false;
...
void OAIDfsSlatePlayer::fromJsonObject(QJsonObject json) {
    ...
    m_fantasy_defense_projection_stat_id_isValid = ::OpenAPI::fromJsonValue(m_fantasy_defense_projection_stat_id, json[QString("FantasyDefenseProjectionStatID")]);
    m_fantasy_defense_projection_stat_id_isSet = !json[QString("FantasyDefenseProjectionStatID")].isNull() && m_fantasy_defense_projection_stat_id_isValid;
...
QJsonObject OAIDfsSlatePlayer::asJsonObject() const {
    QJsonObject obj;
    if (m_fantasy_defense_projection_stat_id_isSet) {
        obj.insert(QString("FantasyDefenseProjectionStatID"), ::OpenAPI::toJsonValue(m_fantasy_defense_projection_stat_id));
    }
...
qint32 OAIDfsSlatePlayer::getFantasyDefenseProjectionStatId() const {
    return m_fantasy_defense_projection_stat_id;
}
void OAIDfsSlatePlayer::setFantasyDefenseProjectionStatId(const qint32 &fantasy_defense_projection_stat_id) {
    m_fantasy_defense_projection_stat_id = fantasy_defense_projection_stat_id;
    m_fantasy_defense_projection_stat_id_isSet = true;
}

bool OAIDfsSlatePlayer::is_fantasy_defense_projection_stat_id_Set() const{
    return m_fantasy_defense_projection_stat_id_isSet;
}

bool OAIDfsSlatePlayer::is_fantasy_defense_projection_stat_id_Valid() const{
    return m_fantasy_defense_projection_stat_id_isValid;
}
