...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NflV3Stats.PlayerSeasonRedZone();
  });
  ...
  describe('PlayerSeasonRedZone', function() {
    it('should create an instance of PlayerSeasonRedZone', function() {
      // uncomment below and update the code to test PlayerSeasonRedZone
      //var instance = new NflV3Stats.PlayerSeasonRedZone();
      //expect(instance).to.be.a(NflV3Stats.PlayerSeasonRedZone);
    });
