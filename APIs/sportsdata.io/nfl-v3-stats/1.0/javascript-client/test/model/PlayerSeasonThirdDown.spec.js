...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NflV3Stats.PlayerSeasonThirdDown();
  });
  ...
  describe('PlayerSeasonThirdDown', function() {
    it('should create an instance of PlayerSeasonThirdDown', function() {
      // uncomment below and update the code to test PlayerSeasonThirdDown
      //var instance = new NflV3Stats.PlayerSeasonThirdDown();
      //expect(instance).to.be.a(NflV3Stats.PlayerSeasonThirdDown);
    });
