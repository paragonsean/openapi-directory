...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NflV3Stats.PlayerDetail();
  });
  ...
  describe('PlayerDetail', function() {
    it('should create an instance of PlayerDetail', function() {
      // uncomment below and update the code to test PlayerDetail
      //var instance = new NflV3Stats.PlayerDetail();
      //expect(instance).to.be.a(NflV3Stats.PlayerDetail);
    });
    ...
    it('should have the property latestNews (base name: "LatestNews")', function() {
      // uncomment below and update the code to test the property latestNews
      //var instance = new NflV3Stats.PlayerDetail();
      //expect(instance).to.be();
    });
    ...
    it('should have the property playerSeason (base name: "PlayerSeason")', function() {
      // uncomment below and update the code to test the property playerSeason
      //var instance = new NflV3Stats.PlayerDetail();
      //expect(instance).to.be();
    });
