...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NflV3Stats.PlayerGameRedZone();
  });
  ...
  describe('PlayerGameRedZone', function() {
    it('should create an instance of PlayerGameRedZone', function() {
      // uncomment below and update the code to test PlayerGameRedZone
      //var instance = new NflV3Stats.PlayerGameRedZone();
      //expect(instance).to.be.a(NflV3Stats.PlayerGameRedZone);
    });
