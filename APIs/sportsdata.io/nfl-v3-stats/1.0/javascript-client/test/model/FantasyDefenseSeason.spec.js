...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NflV3Stats.FantasyDefenseSeason();
  });
  ...
  describe('FantasyDefenseSeason', function() {
    it('should create an instance of FantasyDefenseSeason', function() {
      // uncomment below and update the code to test FantasyDefenseSeason
      //var instance = new NflV3Stats.FantasyDefenseSeason();
      //expect(instance).to.be.a(NflV3Stats.FantasyDefenseSeason);
    });
