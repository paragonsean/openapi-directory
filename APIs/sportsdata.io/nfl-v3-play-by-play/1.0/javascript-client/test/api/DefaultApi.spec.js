...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NflV3PlayByPlay.DefaultApi();
  });
  ...
  describe('DefaultApi', function() {
    ...
    describe('playByPlaySimulation', function() {
      it('should call playByPlaySimulation successfully', function(done) {
        //uncomment below and update the code to test playByPlaySimulation
        //instance.playByPlaySimulation(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
