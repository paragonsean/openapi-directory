...
void OAIDefaultApi::initializeServerConfigs() {
    ...
    QUrl("http://azure-api.sportsdata.io/v3/nfl/pbp"),
    "No description provided",
    QMap<QString, OAIServerVariable>()));
    defaultConf.append(OAIServerConfiguration(
    QUrl("https://azure-api.sportsdata.io/v3/nfl/pbp"),
    "No description provided",
    QMap<QString, OAIServerVariable>()));
    _serverConfigs.insert("playByPlay", defaultConf);
    _serverIndices.insert("playByPlay", 0);
    _serverConfigs.insert("playByPlayDelta", defaultConf);
    _serverIndices.insert("playByPlayDelta", 0);
    _serverConfigs.insert("playByPlaySimulation", defaultConf);
    _serverIndices.insert("playByPlaySimulation", 0);
}
...
void OAIDefaultApi::playByPlay(const QString &format, const QString &season, const QString &week, const QString &hometeam) {
    QString fullPath = QString(_serverConfigs["playByPlay"][_serverIndices.value("playByPlay")].URL()+"/{format}/PlayByPlay/{season}/{week}/{hometeam}");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIDefaultApi::playByPlayCallback);
...
void OAIDefaultApi::playByPlayCallback(OAIHttpRequestWorker *worker) {
    ...
    OAIPlayByPlay output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT playByPlaySignal(output);
        Q_EMIT playByPlaySignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT playByPlaySignalE(output, error_type, error_str);
        Q_EMIT playByPlaySignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT playByPlaySignalError(output, error_type, error_str);
        Q_EMIT playByPlaySignalErrorFull(worker, error_type, error_str);
    }
}

void OAIDefaultApi::playByPlayDelta(const QString &format, const QString &season, const QString &week, const QString &minutes) {
    QString fullPath = QString(_serverConfigs["playByPlayDelta"][_serverIndices.value("playByPlayDelta")].URL()+"/{format}/PlayByPlayDelta/{season}/{week}/{minutes}");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIDefaultApi::playByPlayDeltaCallback);
    connect(this, &OAIDefaultApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIDefaultApi::playByPlayDeltaCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT playByPlayDeltaSignal(output);
        Q_EMIT playByPlayDeltaSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT playByPlayDeltaSignalE(output, error_type, error_str);
        Q_EMIT playByPlayDeltaSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT playByPlayDeltaSignalError(output, error_type, error_str);
        Q_EMIT playByPlayDeltaSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIDefaultApi::playByPlaySimulation(const QString &format, const QString &numberofplays) {
    QString fullPath = QString(_serverConfigs["playByPlaySimulation"][_serverIndices.value("playByPlaySimulation")].URL()+"/{format}/SimulatedPlayByPlay/{numberofplays}");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIDefaultApi::playByPlaySimulationCallback);
    connect(this, &OAIDefaultApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIDefaultApi::playByPlaySimulationCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT playByPlaySimulationSignal(output);
        Q_EMIT playByPlaySimulationSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT playByPlaySimulationSignalE(output, error_type, error_str);
        Q_EMIT playByPlaySimulationSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT playByPlaySimulationSignalError(output, error_type, error_str);
        Q_EMIT playByPlaySimulationSignalErrorFull(worker, error_type, error_str);
    }
}
