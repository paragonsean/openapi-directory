...
class BoxScore {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('ShootoutPlays')) {
                obj['ShootoutPlays'] = ApiClient.convertToType(data['ShootoutPlays'], [Play]);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['ShootoutPlays']) { // data not null
            // ensure the json data is an array
            if (!Array.isArray(data['ShootoutPlays'])) {
                throw new Error("Expected the field `ShootoutPlays` to be an array in the JSON data but got " + data['ShootoutPlays']);
            }
            // validate the optional field `ShootoutPlays` (array)
            for (const item of data['ShootoutPlays']) {
 ...
 */
BoxScore.prototype['Periods'] = undefined;
...
/**
 * @member {Array.<module:model/Play>} ShootoutPlays
 */
BoxScore.prototype['ShootoutPlays'] = undefined;
