...
public:
    ...
    OAIOpponentSeason getOpponentStat() const;
    void setOpponentStat(const OAIOpponentSeason &opponent_stat);
    bool is_opponent_stat_Set() const;
    bool is_opponent_stat_Valid() const;
...
private:
    ...
    OAIOpponentSeason m_opponent_stat;
    bool m_opponent_stat_isSet;
    bool m_opponent_stat_isValid;
