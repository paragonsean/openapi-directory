...
void OAIDefaultApi::initializeServerConfigs() {
    ...
    QUrl("http://azure-api.sportsdata.io/v3/nhl/stats"),
    "No description provided",
    QMap<QString, OAIServerVariable>()));
    defaultConf.append(OAIServerConfiguration(
    QUrl("https://azure-api.sportsdata.io/v3/nhl/stats"),
    "No description provided",
    QMap<QString, OAIServerVariable>()));
    ...
    _serverConfigs.insert("lineCombinationsBySeason", defaultConf);
    _serverIndices.insert("lineCombinationsBySeason", 0);
    ...
    _serverConfigs.insert("playerDetailsByFreeAgent", defaultConf);
    _serverIndices.insert("playerDetailsByFreeAgent", 0);
    ...
    _serverConfigs.insert("teamStatsAllowedByPosition", defaultConf);
    _serverIndices.insert("teamStatsAllowedByPosition", 0);
...
void OAIDefaultApi::lineCombinationsBySeason(const QString &format, const QString &season) {
    QString fullPath = QString(_serverConfigs["lineCombinationsBySeason"][_serverIndices.value("lineCombinationsBySeason")].URL()+"/{format}/LinesBySeason/{season}");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIDefaultApi::lineCombinationsBySeasonCallback);
    connect(this, &OAIDefaultApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIDefaultApi::lineCombinationsBySeasonCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT lineCombinationsBySeasonSignal(output);
        Q_EMIT lineCombinationsBySeasonSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT lineCombinationsBySeasonSignalE(output, error_type, error_str);
        Q_EMIT lineCombinationsBySeasonSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT lineCombinationsBySeasonSignalError(output, error_type, error_str);
        Q_EMIT lineCombinationsBySeasonSignalErrorFull(worker, error_type, error_str);
    }
}
...
void OAIDefaultApi::playerDetailsByFreeAgent(const QString &format) {
    QString fullPath = QString(_serverConfigs["playerDetailsByFreeAgent"][_serverIndices.value("playerDetailsByFreeAgent")].URL()+"/{format}/FreeAgents");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIDefaultApi::playerDetailsByFreeAgentCallback);
    connect(this, &OAIDefaultApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIDefaultApi::playerDetailsByFreeAgentCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT playerDetailsByFreeAgentSignal(output);
        Q_EMIT playerDetailsByFreeAgentSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT playerDetailsByFreeAgentSignalE(output, error_type, error_str);
        Q_EMIT playerDetailsByFreeAgentSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT playerDetailsByFreeAgentSignalError(output, error_type, error_str);
        Q_EMIT playerDetailsByFreeAgentSignalErrorFull(worker, error_type, error_str);
    }
}
...
void OAIDefaultApi::teamStatsAllowedByPosition(const QString &format, const QString &season) {
    QString fullPath = QString(_serverConfigs["teamStatsAllowedByPosition"][_serverIndices.value("teamStatsAllowedByPosition")].URL()+"/{format}/TeamStatsAllowedByPosition/{season}");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIDefaultApi::teamStatsAllowedByPositionCallback);
    connect(this, &OAIDefaultApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIDefaultApi::teamStatsAllowedByPositionCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT teamStatsAllowedByPositionSignal(output);
        Q_EMIT teamStatsAllowedByPositionSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT teamStatsAllowedByPositionSignalE(output, error_type, error_str);
        Q_EMIT teamStatsAllowedByPositionSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT teamStatsAllowedByPositionSignalError(output, error_type, error_str);
        Q_EMIT teamStatsAllowedByPositionSignalErrorFull(worker, error_type, error_str);
    }
}
