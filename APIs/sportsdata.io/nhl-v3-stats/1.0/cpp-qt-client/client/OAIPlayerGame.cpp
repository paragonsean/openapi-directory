...
double OAIPlayerGame::getBenchPenaltyMinutes() const {
    return m_bench_penalty_minutes;
}
void OAIPlayerGame::setBenchPenaltyMinutes(const double &bench_penalty_minutes) {
    m_bench_penalty_minutes = bench_penalty_minutes;
    m_bench_penalty_minutes_isSet = true;
}

bool OAIPlayerGame::is_bench_penalty_minutes_Set() const{
    return m_bench_penalty_minutes_isSet;
}

bool OAIPlayerGame::is_bench_penalty_minutes_Valid() const{
    return m_bench_penalty_minutes_isValid;
}

double OAIPlayerGame::getBlocks() const {
    return m_blocks;
}
void OAIPlayerGame::setBlocks(const double &blocks) {
    m_blocks = blocks;
    m_blocks_isSet = true;
}

bool OAIPlayerGame::is_blocks_Set() const{
    return m_blocks_isSet;
}

bool OAIPlayerGame::is_blocks_Valid() const{
...
double OAIPlayerGame::getEmptyNetGoals() const {
    return m_empty_net_goals;
}
void OAIPlayerGame::setEmptyNetGoals(const double &empty_net_goals) {
    m_empty_net_goals = empty_net_goals;
    m_empty_net_goals_isSet = true;
}

bool OAIPlayerGame::is_empty_net_goals_Set() const{
    return m_empty_net_goals_isSet;
}

bool OAIPlayerGame::is_empty_net_goals_Valid() const{
    return m_empty_net_goals_isValid;
}

double OAIPlayerGame::getFaceoffsLost() const {
    return m_faceoffs_lost;
}
void OAIPlayerGame::setFaceoffsLost(const double &faceoffs_lost) {
    m_faceoffs_lost = faceoffs_lost;
    m_faceoffs_lost_isSet = true;
}

bool OAIPlayerGame::is_faceoffs_lost_Set() const{
    return m_faceoffs_lost_isSet;
}

bool OAIPlayerGame::is_faceoffs_lost_Valid() const{
    return m_faceoffs_lost_isValid;
}

double OAIPlayerGame::getFaceoffsWon() const {
    return m_faceoffs_won;
}
void OAIPlayerGame::setFaceoffsWon(const double &faceoffs_won) {
    m_faceoffs_won = faceoffs_won;
    m_faceoffs_won_isSet = true;
}

bool OAIPlayerGame::is_faceoffs_won_Set() const{
    return m_faceoffs_won_isSet;
}

bool OAIPlayerGame::is_faceoffs_won_Valid() const{
...
double OAIPlayerGame::getGiveaways() const {
    return m_giveaways;
}
void OAIPlayerGame::setGiveaways(const double &giveaways) {
    m_giveaways = giveaways;
    m_giveaways_isSet = true;
}

bool OAIPlayerGame::is_giveaways_Set() const{
    return m_giveaways_isSet;
}

bool OAIPlayerGame::is_giveaways_Valid() const{
...
double OAIPlayerGame::getGoaltendingGoalsAgainst() const {
    return m_goaltending_goals_against;
}
void OAIPlayerGame::setGoaltendingGoalsAgainst(const double &goaltending_goals_against) {
    m_goaltending_goals_against = goaltending_goals_against;
    m_goaltending_goals_against_isSet = true;
}

bool OAIPlayerGame::is_goaltending_goals_against_Set() const{
    return m_goaltending_goals_against_isSet;
}

bool OAIPlayerGame::is_goaltending_goals_against_Valid() const{
    return m_goaltending_goals_against_isValid;
}

double OAIPlayerGame::getGoaltendingLosses() const {
    return m_goaltending_losses;
}
void OAIPlayerGame::setGoaltendingLosses(const double &goaltending_losses) {
    m_goaltending_losses = goaltending_losses;
    m_goaltending_losses_isSet = true;
}

bool OAIPlayerGame::is_goaltending_losses_Set() const{
    return m_goaltending_losses_isSet;
}

bool OAIPlayerGame::is_goaltending_losses_Valid() const{
    return m_goaltending_losses_isValid;
}

qint32 OAIPlayerGame::getGoaltendingMinutes() const {
    return m_goaltending_minutes;
}
void OAIPlayerGame::setGoaltendingMinutes(const qint32 &goaltending_minutes) {
    m_goaltending_minutes = goaltending_minutes;
    m_goaltending_minutes_isSet = true;
}

bool OAIPlayerGame::is_goaltending_minutes_Set() const{
    return m_goaltending_minutes_isSet;
}

bool OAIPlayerGame::is_goaltending_minutes_Valid() const{
    return m_goaltending_minutes_isValid;
}

double OAIPlayerGame::getGoaltendingOvertimeLosses() const {
    return m_goaltending_overtime_losses;
}
void OAIPlayerGame::setGoaltendingOvertimeLosses(const double &goaltending_overtime_losses) {
    m_goaltending_overtime_losses = goaltending_overtime_losses;
    m_goaltending_overtime_losses_isSet = true;
}

bool OAIPlayerGame::is_goaltending_overtime_losses_Set() const{
    return m_goaltending_overtime_losses_isSet;
}

bool OAIPlayerGame::is_goaltending_overtime_losses_Valid() const{
    return m_goaltending_overtime_losses_isValid;
}

double OAIPlayerGame::getGoaltendingSaves() const {
    return m_goaltending_saves;
}
void OAIPlayerGame::setGoaltendingSaves(const double &goaltending_saves) {
    m_goaltending_saves = goaltending_saves;
    m_goaltending_saves_isSet = true;
}

bool OAIPlayerGame::is_goaltending_saves_Set() const{
    return m_goaltending_saves_isSet;
}

bool OAIPlayerGame::is_goaltending_saves_Valid() const{
    return m_goaltending_saves_isValid;
}

qint32 OAIPlayerGame::getGoaltendingSeconds() const {
    return m_goaltending_seconds;
}
void OAIPlayerGame::setGoaltendingSeconds(const qint32 &goaltending_seconds) {
    m_goaltending_seconds = goaltending_seconds;
    m_goaltending_seconds_isSet = true;
}

bool OAIPlayerGame::is_goaltending_seconds_Set() const{
    return m_goaltending_seconds_isSet;
}

bool OAIPlayerGame::is_goaltending_seconds_Valid() const{
    return m_goaltending_seconds_isValid;
}

double OAIPlayerGame::getGoaltendingShotsAgainst() const {
    return m_goaltending_shots_against;
}
void OAIPlayerGame::setGoaltendingShotsAgainst(const double &goaltending_shots_against) {
    m_goaltending_shots_against = goaltending_shots_against;
    m_goaltending_shots_against_isSet = true;
}

bool OAIPlayerGame::is_goaltending_shots_against_Set() const{
    return m_goaltending_shots_against_isSet;
}

bool OAIPlayerGame::is_goaltending_shots_against_Valid() const{
    return m_goaltending_shots_against_isValid;
}

double OAIPlayerGame::getGoaltendingShutouts() const {
    return m_goaltending_shutouts;
}
void OAIPlayerGame::setGoaltendingShutouts(const double &goaltending_shutouts) {
    m_goaltending_shutouts = goaltending_shutouts;
    m_goaltending_shutouts_isSet = true;
}

bool OAIPlayerGame::is_goaltending_shutouts_Set() const{
    return m_goaltending_shutouts_isSet;
}

bool OAIPlayerGame::is_goaltending_shutouts_Valid() const{
    return m_goaltending_shutouts_isValid;
}

double OAIPlayerGame::getGoaltendingWins() const {
    return m_goaltending_wins;
}
void OAIPlayerGame::setGoaltendingWins(const double &goaltending_wins) {
    m_goaltending_wins = goaltending_wins;
    m_goaltending_wins_isSet = true;
}

bool OAIPlayerGame::is_goaltending_wins_Set() const{
    return m_goaltending_wins_isSet;
}

bool OAIPlayerGame::is_goaltending_wins_Valid() const{
    return m_goaltending_wins_isValid;
}

double OAIPlayerGame::getHatTricks() const {
    return m_hat_tricks;
}
void OAIPlayerGame::setHatTricks(const double &hat_tricks) {
    m_hat_tricks = hat_tricks;
    m_hat_tricks_isSet = true;
}

bool OAIPlayerGame::is_hat_tricks_Set() const{
    return m_hat_tricks_isSet;
}

bool OAIPlayerGame::is_hat_tricks_Valid() const{
...
double OAIPlayerGame::getPenaltyMinutes() const {
    return m_penalty_minutes;
}
void OAIPlayerGame::setPenaltyMinutes(const double &penalty_minutes) {
    m_penalty_minutes = penalty_minutes;
    m_penalty_minutes_isSet = true;
}

bool OAIPlayerGame::is_penalty_minutes_Set() const{
    return m_penalty_minutes_isSet;
}

bool OAIPlayerGame::is_penalty_minutes_Valid() const{
...
double OAIPlayerGame::getPowerPlayAssists() const {
    return m_power_play_assists;
}
void OAIPlayerGame::setPowerPlayAssists(const double &power_play_assists) {
    m_power_play_assists = power_play_assists;
    m_power_play_assists_isSet = true;
}

bool OAIPlayerGame::is_power_play_assists_Set() const{
    return m_power_play_assists_isSet;
}

bool OAIPlayerGame::is_power_play_assists_Valid() const{
    return m_power_play_assists_isValid;
}

double OAIPlayerGame::getPowerPlayGoals() const {
    return m_power_play_goals;
}
void OAIPlayerGame::setPowerPlayGoals(const double &power_play_goals) {
    m_power_play_goals = power_play_goals;
    m_power_play_goals_isSet = true;
}

bool OAIPlayerGame::is_power_play_goals_Set() const{
    return m_power_play_goals_isSet;
}

bool OAIPlayerGame::is_power_play_goals_Valid() const{
...
double OAIPlayerGame::getShifts() const {
    return m_shifts;
}
void OAIPlayerGame::setShifts(const double &shifts) {
    m_shifts = shifts;
    m_shifts_isSet = true;
}

bool OAIPlayerGame::is_shifts_Set() const{
    return m_shifts_isSet;
}

bool OAIPlayerGame::is_shifts_Valid() const{
    return m_shifts_isValid;
}

double OAIPlayerGame::getShootoutGoals() const {
    return m_shootout_goals;
}
void OAIPlayerGame::setShootoutGoals(const double &shootout_goals) {
    m_shootout_goals = shootout_goals;
    m_shootout_goals_isSet = true;
}

bool OAIPlayerGame::is_shootout_goals_Set() const{
    return m_shootout_goals_isSet;
}

bool OAIPlayerGame::is_shootout_goals_Valid() const{
    return m_shootout_goals_isValid;
}

double OAIPlayerGame::getShortHandedAssists() const {
    return m_short_handed_assists;
}
void OAIPlayerGame::setShortHandedAssists(const double &short_handed_assists) {
    m_short_handed_assists = short_handed_assists;
    m_short_handed_assists_isSet = true;
}

bool OAIPlayerGame::is_short_handed_assists_Set() const{
    return m_short_handed_assists_isSet;
}

bool OAIPlayerGame::is_short_handed_assists_Valid() const{
    return m_short_handed_assists_isValid;
}

double OAIPlayerGame::getShortHandedGoals() const {
    return m_short_handed_goals;
}
void OAIPlayerGame::setShortHandedGoals(const double &short_handed_goals) {
    m_short_handed_goals = short_handed_goals;
    m_short_handed_goals_isSet = true;
}

bool OAIPlayerGame::is_short_handed_goals_Set() const{
    return m_short_handed_goals_isSet;
}

bool OAIPlayerGame::is_short_handed_goals_Valid() const{
...
double OAIPlayerGame::getTakeaways() const {
    return m_takeaways;
}
void OAIPlayerGame::setTakeaways(const double &takeaways) {
    m_takeaways = takeaways;
    m_takeaways_isSet = true;
}

bool OAIPlayerGame::is_takeaways_Set() const{
    return m_takeaways_isSet;
}

bool OAIPlayerGame::is_takeaways_Valid() const{
