...
public:
    ...
    */
    virtual void lineCombinationsBySeason(const QString &format, const QString &season);
...
private:
    ...
    void lineCombinationsBySeasonCallback(OAIHttpRequestWorker *worker);
...
Q_SIGNALS:
    ...
    void lineCombinationsBySeasonSignal(QList<OAITeamLine> summary);
    ...
    void lineCombinationsBySeasonSignalFull(OAIHttpRequestWorker *worker, QList<OAITeamLine> summary);
    ...
    Q_DECL_DEPRECATED_X("Use lineCombinationsBySeasonSignalError() instead")
    void lineCombinationsBySeasonSignalE(QList<OAITeamLine> summary, QNetworkReply::NetworkError error_type, QString error_str);
    void lineCombinationsBySeasonSignalError(QList<OAITeamLine> summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use lineCombinationsBySeasonSignalErrorFull() instead")
    void lineCombinationsBySeasonSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void lineCombinationsBySeasonSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
