...
public:
    ...
    QString getCatches() const;
    void setCatches(const QString &catches);
    bool is_catches_Set() const;
    bool is_catches_Valid() const;
...
private:
    ...
    QString m_catches;
    bool m_catches_isSet;
    bool m_catches_isValid;
