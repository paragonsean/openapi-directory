...
public class DefaultApi {
     ...
     * @param format Desired response format. Valid entries are &lt;code&gt;XML&lt;/code&gt; or &lt;code&gt;JSON&lt;/code&gt;. (required)
     * @param date The date of the game(s).  &lt;br&gt;Examples: &lt;code&gt;2017-OCT-31&lt;/code&gt;, &lt;code&gt;2018-FEB-15&lt;/code&gt;.   (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
    ...
    /**
     * Build call for lineCombinationsBySeason
     * @param format Desired response format. Valid entries are &lt;code&gt;XML&lt;/code&gt; or &lt;code&gt;JSON&lt;/code&gt;. (required)
     ...
     */
    public okhttp3.Call lineCombinationsBySeasonCall(String format, String season, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/{format}/LinesBySeason/{season}"
            .replace("{" + "format" + "}", localVarApiClient.escapeString(format.toString()))
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call lineCombinationsBySeasonValidateBeforeCall(String format, String season, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'format' is set
        if (format == null) {
            throw new ApiException("Missing the required parameter 'format' when calling lineCombinationsBySeason(Async)");
        }

        // verify the required parameter 'season' is set
        if (season == null) {
            throw new ApiException("Missing the required parameter 'season' when calling lineCombinationsBySeason(Async)");
        }

        return lineCombinationsBySeasonCall(format, season, _callback);
     ...
     */
    public List<TeamLine> lineCombinationsBySeason(String format, String season) throws ApiException {
        ApiResponse<List<TeamLine>> localVarResp = lineCombinationsBySeasonWithHttpInfo(format, season);
        return localVarResp.getData();
    }
     ...
     * @param format Desired response format. Valid entries are &lt;code&gt;XML&lt;/code&gt; or &lt;code&gt;JSON&lt;/code&gt;. (required)
     * @param season Year of the season.  &lt;br&gt;Examples: &lt;code&gt;2016&lt;/code&gt;, &lt;code&gt;2017&lt;/code&gt;.   (required)
     * @return ApiResponse&lt;List&lt;TeamLine&gt;&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<List<TeamLine>> lineCombinationsBySeasonWithHttpInfo(String format, String season) throws ApiException {
        okhttp3.Call localVarCall = lineCombinationsBySeasonValidateBeforeCall(format, season, null);
        Type localVarReturnType = new TypeToken<List<TeamLine>>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Line Combinations by Season (asynchronously)
     * 
     * @param format Desired response format. Valid entries are &lt;code&gt;XML&lt;/code&gt; or &lt;code&gt;JSON&lt;/code&gt;. (required)
     * @param season Year of the season.  &lt;br&gt;Examples: &lt;code&gt;2016&lt;/code&gt;, &lt;code&gt;2017&lt;/code&gt;.   (required)
     * @param _callback The callback to be executed when the API call finishes
     ...
     */
    public okhttp3.Call lineCombinationsBySeasonAsync(String format, String season, final ApiCallback<List<TeamLine>> _callback) throws ApiException {

        okhttp3.Call localVarCall = lineCombinationsBySeasonValidateBeforeCall(format, season, _callback);
        Type localVarReturnType = new TypeToken<List<TeamLine>>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     * @param format Desired response format. Valid entries are &lt;code&gt;XML&lt;/code&gt; or &lt;code&gt;JSON&lt;/code&gt;. (required)
     * @param date The date of the news.  &lt;br&gt;Examples: &lt;code&gt;2017-OCT-31&lt;/code&gt;, &lt;code&gt;2018-FEB-15&lt;/code&gt;.   (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
