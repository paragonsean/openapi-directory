...
public class BoxScore {
  ...
  public static final String SERIALIZED_NAME_SHOOTOUT_PLAYS = "ShootoutPlays";
  @SerializedName(SERIALIZED_NAME_SHOOTOUT_PLAYS)
  private List<Play> shootoutPlays = new ArrayList<>();
  ...
  public BoxScore shootoutPlays(List<Play> shootoutPlays) {
    this.shootoutPlays = shootoutPlays;
    return this;
  }

  public BoxScore addShootoutPlaysItem(Play shootoutPlaysItem) {
    if (this.shootoutPlays == null) {
      this.shootoutPlays = new ArrayList<>();
    }
    this.shootoutPlays.add(shootoutPlaysItem);
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public List<Play> getShootoutPlays() {
    return shootoutPlays;
  }

  public void setShootoutPlays(List<Play> shootoutPlays) {
    this.shootoutPlays = shootoutPlays;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.game, boxScore.game) &&
        ...
        Objects.equals(this.shootoutPlays, boxScore.shootoutPlays) &&
        Objects.equals(this.teamGames, boxScore.teamGames);
  }

  @Override
  public int hashCode() {
    return Objects.hash(game, periods, playerGames, shootoutPlays, teamGames);
  }
  ...
  public String toString() {
    ...
    sb.append("    shootoutPlays: ").append(toIndentedString(shootoutPlays)).append("\n");
  ...
  static {
    ...
    openapiFields.add("ShootoutPlays");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("ShootoutPlays") != null && !jsonObj.get("ShootoutPlays").isJsonNull()) {
        JsonArray jsonArrayshootoutPlays = jsonObj.getAsJsonArray("ShootoutPlays");
        if (jsonArrayshootoutPlays != null) {
          // ensure the json data is an array
          if (!jsonObj.get("ShootoutPlays").isJsonArray()) {
            throw new IllegalArgumentException(String.format("Expected the field `ShootoutPlays` to be an array in the JSON string but got `%s`", jsonObj.get("ShootoutPlays").toString()));
          }

          // validate the optional field `ShootoutPlays` (array)
          for (int i = 0; i < jsonArrayshootoutPlays.size(); i++) {
            Play.validateJsonElement(jsonArrayshootoutPlays.get(i));
          };
        }
      }
