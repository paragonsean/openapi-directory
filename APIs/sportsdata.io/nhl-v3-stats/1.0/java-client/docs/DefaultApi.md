...
public class Example {
  public static void main(String[] args) {
    ...
    DefaultApi apiInstance = new DefaultApi(defaultClient);
    String format = "XML"; // String | Desired response format. Valid entries are <code>XML</code> or <code>JSON</code>.
    String gameid = "gameid_example"; // String | The GameID of an NHL game.  GameIDs can be found in the Games API.  Valid entries are <code>14620</code> or <code>16905</code>
    try {
...
public class Example {
  public static void main(String[] args) {
    ...
    DefaultApi apiInstance = new DefaultApi(defaultClient);
    String format = "XML"; // String | Desired response format. Valid entries are <code>XML</code> or <code>JSON</code>.
    String date = "date_example"; // String | The date of the game(s).  <br>Examples: <code>2017-OCT-31</code>, <code>2018-FEB-15</code>.  
    try {
...
<a id="lineCombinationsBySeason"></a>
# **lineCombinationsBySeason**
> List&lt;TeamLine&gt; lineCombinationsBySeason(format, season)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      List<TeamLine> result = apiInstance.lineCombinationsBySeason(format, season);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling DefaultApi#lineCombinationsBySeason");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
public class Example {
  public static void main(String[] args) {
    ...
    DefaultApi apiInstance = new DefaultApi(defaultClient);
    String format = "XML"; // String | Desired response format. Valid entries are <code>XML</code> or <code>JSON</code>.
    String date = "date_example"; // String | The date of the news.  <br>Examples: <code>2017-OCT-31</code>, <code>2018-FEB-15</code>.  
    try {
...
<a id="playerDetailsByFreeAgent"></a>
# **playerDetailsByFreeAgent**
> List&lt;Player&gt; playerDetailsByFreeAgent(format)
...
public class Example {
  public static void main(String[] args) {
    ...
    String format = "XML"; // String | Desired response format. Valid entries are <code>XML</code> or <code>JSON</code>.
    try {
      List<Player> result = apiInstance.playerDetailsByFreeAgent(format);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling DefaultApi#playerDetailsByFreeAgent");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
public class Example {
  public static void main(String[] args) {
    ...
    DefaultApi apiInstance = new DefaultApi(defaultClient);
    String format = "XML"; // String | Desired response format. Valid entries are <code>XML</code> or <code>JSON</code>.
    String playerid = "playerid_example"; // String | Unique FantasyData Player ID. Example:<code>30000007</code>.
    try {
...
public class Example {
  public static void main(String[] args) {
    ...
    String playerid = "playerid_example"; // String | Unique FantasyData Player ID. Example:<code>30000651</code>.
...
<a id="teamStatsAllowedByPosition"></a>
# **teamStatsAllowedByPosition**
> List&lt;TeamSeason&gt; teamStatsAllowedByPosition(format, season)
...
public class Example {
  public static void main(String[] args) {
    ...
    String season = "season_example"; // String | Year of the season.  <br>Examples: <code>2016</code>, <code>2017</code>.  
    try {
      List<TeamSeason> result = apiInstance.teamStatsAllowedByPosition(format, season);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling DefaultApi#teamStatsAllowedByPosition");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
