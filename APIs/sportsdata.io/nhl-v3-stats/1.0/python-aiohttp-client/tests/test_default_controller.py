...
from openapi_server.models.team_line import TeamLine
...
async def test_are_games_in_progress(client):
    ...
    response = await client.request(
        method='GET',
        path='/v3/nhl/stats/{format}/AreAnyGamesInProgress'.format(format=XML),
        headers=headers,
        )
...
async def test_box_score(client):
    ...
    response = await client.request(
        method='GET',
        path='/v3/nhl/stats/{format}/BoxScore/{gameid}'.format(format=XML, gameid='gameid_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_box_scores_by_date(client):
    ...
    response = await client.request(
        method='GET',
        path='/v3/nhl/stats/{format}/BoxScores/{_date}'.format(format=XML, _date='_date_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_box_scores_by_date_delta(client):
    ...
    response = await client.request(
        method='GET',
        path='/v3/nhl/stats/{format}/BoxScoresDelta/{_date}/{minutes}'.format(format=XML, _date='_date_example', minutes='minutes_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_current_season(client):
    ...
    response = await client.request(
        method='GET',
        path='/v3/nhl/stats/{format}/CurrentSeason'.format(format=XML),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_dfs_slates_by_date(client):
    ...
    response = await client.request(
        method='GET',
        path='/v3/nhl/stats/{format}/DfsSlatesByDate/{_date}'.format(format=XML, _date='_date_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_games_by_date(client):
    ...
    response = await client.request(
        method='GET',
        path='/v3/nhl/stats/{format}/GamesByDate/{_date}'.format(format=XML, _date='_date_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_line_combinations_by_season(client):
    ...
    response = await client.request(
        method='GET',
        path='/v3/nhl/stats/{format}/LinesBySeason/{season}'.format(format=XML, season='season_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_news(client):
    ...
    response = await client.request(
        method='GET',
        path='/v3/nhl/stats/{format}/News'.format(format=XML),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_news_by_date(client):
    ...
    response = await client.request(
        method='GET',
        path='/v3/nhl/stats/{format}/NewsByDate/{_date}'.format(format=XML, _date='_date_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_news_by_player(client):
    ...
    response = await client.request(
        method='GET',
        path='/v3/nhl/stats/{format}/NewsByPlayerID/{playerid}'.format(format=XML, playerid='playerid_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_player_details_by_active(client):
    ...
    response = await client.request(
        method='GET',
        path='/v3/nhl/stats/{format}/Players'.format(format=XML),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_player_details_by_free_agent(client):
    ...
    response = await client.request(
        method='GET',
        path='/v3/nhl/stats/{format}/FreeAgents'.format(format=XML),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_player_details_by_player(client):
    ...
    response = await client.request(
        method='GET',
        path='/v3/nhl/stats/{format}/Player/{playerid}'.format(format=XML, playerid='playerid_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_player_game_logs_by_season(client):
    ...
    response = await client.request(
        method='GET',
        path='/v3/nhl/stats/{format}/PlayerGameStatsBySeason/{season}/{playerid}/{numberofgames}'.format(format='format_example', season='season_example', playerid='playerid_example', numberofgames='numberofgames_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_player_game_stats_by_date(client):
    ...
    response = await client.request(
        method='GET',
        path='/v3/nhl/stats/{format}/PlayerGameStatsByDate/{_date}'.format(format=XML, _date='_date_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_player_game_stats_by_player(client):
    ...
    response = await client.request(
        method='GET',
        path='/v3/nhl/stats/{format}/PlayerGameStatsByPlayer/{_date}/{playerid}'.format(format=XML, _date='_date_example', playerid='playerid_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_player_season_stats(client):
    ...
    response = await client.request(
        method='GET',
        path='/v3/nhl/stats/{format}/PlayerSeasonStats/{season}'.format(format=XML, season='season_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_player_season_stats_by_player(client):
    ...
    response = await client.request(
        method='GET',
        path='/v3/nhl/stats/{format}/PlayerSeasonStatsByPlayer/{season}/{playerid}'.format(format=XML, season='season_example', playerid='playerid_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_player_season_stats_by_team(client):
    ...
    response = await client.request(
        method='GET',
        path='/v3/nhl/stats/{format}/PlayerSeasonStatsByTeam/{season}/{team}'.format(format=XML, season='season_example', team='team_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_players_by_team(client):
    ...
    response = await client.request(
        method='GET',
        path='/v3/nhl/stats/{format}/Players/{team}'.format(format=XML, team='team_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_schedules(client):
    ...
    response = await client.request(
        method='GET',
        path='/v3/nhl/stats/{format}/Games/{season}'.format(format=XML, season='season_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_stadiums(client):
    ...
    response = await client.request(
        method='GET',
        path='/v3/nhl/stats/{format}/Stadiums'.format(format=xml),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_standings(client):
    ...
    response = await client.request(
        method='GET',
        path='/v3/nhl/stats/{format}/Standings/{season}'.format(format=XML, season='season_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_team_game_logs_by_season(client):
    ...
    response = await client.request(
        method='GET',
        path='/v3/nhl/stats/{format}/TeamGameStatsBySeason/{season}/{teamid}/{numberofgames}'.format(format='format_example', season='season_example', teamid='teamid_example', numberofgames='numberofgames_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_team_game_stats_by_date(client):
    ...
    response = await client.request(
        method='GET',
        path='/v3/nhl/stats/{format}/TeamGameStatsByDate/{_date}'.format(format=XML, _date='_date_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_team_season_stats(client):
    ...
    response = await client.request(
        method='GET',
        path='/v3/nhl/stats/{format}/TeamSeasonStats/{season}'.format(format=XML, season='season_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_team_stats_allowed_by_position(client):
    ...
    response = await client.request(
        method='GET',
        path='/v3/nhl/stats/{format}/TeamStatsAllowedByPosition/{season}'.format(format=XML, season='season_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_teams_active(client):
    ...
    response = await client.request(
        method='GET',
        path='/v3/nhl/stats/{format}/teams'.format(format=XML),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_teams_all(client):
    ...
    response = await client.request(
        method='GET',
        path='/v3/nhl/stats/{format}/AllTeams'.format(format=XML),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
