...
class Player(Model):
    ...
    def __init__(self, birth_city: str=None, birth_date: str=None, birth_state: str=None, catches: str=None, depth_chart_order: int=None, depth_chart_position: str=None, draft_kings_name: str=None, draft_kings_player_id: int=None, fan_duel_name: str=None, fan_duel_player_id: int=None, fantasy_alarm_player_id: int=None, fantasy_draft_name: str=None, fantasy_draft_player_id: int=None, first_name: str=None, global_team_id: int=None, height: int=None, injury_body_part: str=None, injury_notes: str=None, injury_start_date: str=None, injury_status: str=None, jersey: int=None, last_name: str=None, photo_url: str=None, player_id: int=None, position: str=None, roto_wire_player_id: int=None, rotoworld_player_id: int=None, shoots: str=None, sport_radar_player_id: str=None, sports_direct_player_id: int=None, stats_player_id: int=None, status: str=None, team: str=None, team_id: int=None, usa_today_headshot_no_background_updated: str=None, usa_today_headshot_no_background_url: str=None, usa_today_headshot_updated: str=None, usa_today_headshot_url: str=None, usa_today_player_id: int=None, weight: int=None, xml_team_player_id: int=None, yahoo_name: str=None, yahoo_player_id: int=None):
        ...
        :param catches: The catches of this Player.
        ...
        :param shoots: The shoots of this Player.
    ...
    @property
    def catches(self):
        """Gets the catches of this Player.


        :return: The catches of this Player.
        :rtype: str
        """
    ...
    def catches(self, catches):
        """Sets the catches of this Player.
    ...
    @property
    def shoots(self):
        """Gets the shoots of this Player.


        :return: The shoots of this Player.
        :rtype: str
        """
        return self._shoots
    ...
    def shoots(self, shoots):
        """Sets the shoots of this Player.
