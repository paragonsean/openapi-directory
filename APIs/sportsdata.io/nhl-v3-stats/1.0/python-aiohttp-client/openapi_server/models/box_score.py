...
class BoxScore(Model):
    ...
    def __init__(self, game: Game=None, periods: List[Period]=None, player_games: List[PlayerGame]=None, shootout_plays: List[Play]=None, team_games: List[TeamGame]=None):
        ...
        :param shootout_plays: The shootout_plays of this BoxScore.
    ...
    def shootout_plays(self):
        """Gets the shootout_plays of this BoxScore.


        :return: The shootout_plays of this BoxScore.
        :rtype: List[Play]
        """
    ...
    def shootout_plays(self, shootout_plays):
        """Sets the shootout_plays of this BoxScore.


        :param shootout_plays: The shootout_plays of this BoxScore.
        :type shootout_plays: List[Play]
        """
