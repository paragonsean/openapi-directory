...
async def box_scores_by_date(request: web.Request, format, _date) -> web.Response:
    ...
    :param format: Desired response format. Valid entries are &lt;code&gt;XML&lt;/code&gt; or &lt;code&gt;JSON&lt;/code&gt;.
    :type format: str
    :param _date: The date of the game(s).  &lt;br&gt;Examples: &lt;code&gt;2017-OCT-31&lt;/code&gt;, &lt;code&gt;2018-FEB-15&lt;/code&gt;.  
    :type _date: str
...
async def line_combinations_by_season(request: web.Request, format, season) -> web.Response:
...
async def news_by_date(request: web.Request, format, _date) -> web.Response:
    ...
    :param format: Desired response format. Valid entries are &lt;code&gt;XML&lt;/code&gt; or &lt;code&gt;JSON&lt;/code&gt;.
    :type format: str
    :param _date: The date of the news.  &lt;br&gt;Examples: &lt;code&gt;2017-OCT-31&lt;/code&gt;, &lt;code&gt;2018-FEB-15&lt;/code&gt;.  
    :type _date: str
...
async def player_game_logs_by_season(request: web.Request, format, season, playerid, numberofgames) -> web.Response:
    ...
    :type season: str
    :param playerid: Unique FantasyData Player ID. Example:&lt;code&gt;30000651&lt;/code&gt;.
    :type playerid: str
