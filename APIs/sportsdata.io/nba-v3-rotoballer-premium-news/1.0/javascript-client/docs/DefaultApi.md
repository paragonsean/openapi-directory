# NbaV3RotoBallerPremiumNews.DefaultApi
...
```javascript
import NbaV3RotoBallerPremiumNews from 'nba_v3_roto_baller_premium_news';
let defaultClient = NbaV3RotoBallerPremiumNews.ApiClient.instance;
...
let apiInstance = new NbaV3RotoBallerPremiumNews.DefaultApi();
