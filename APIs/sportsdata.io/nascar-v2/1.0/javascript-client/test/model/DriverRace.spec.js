...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NascarV2.DriverRace();
  });
  ...
  describe('DriverRace', function() {
    it('should create an instance of DriverRace', function() {
      // uncomment below and update the code to test DriverRace
      //var instance = new NascarV2.DriverRace();
      //expect(instance).to.be.a(NascarV2.DriverRace);
    });
