...
public class DriverRace {
  ...
  public DriverRace bonus(BigDecimal bonus) {
    this.bonus = bonus;
    return this;
  }
  ...
  public DriverRace created(String created) {
  ...
  public DriverRace currentPosition(BigDecimal currentPosition) {
  ...
  public DriverRace dateTime(String dateTime) {
  ...
  public DriverRace day(String day) {
    this.day = day;
    return this;
  }
  ...
  public DriverRace draftKingsSalary(Integer draftKingsSalary) {
  ...
  public DriverRace driverID(Integer driverID) {
  ...
  public DriverRace fantasyPoints(BigDecimal fantasyPoints) {
  ...
  public DriverRace fantasyPointsDraftKings(BigDecimal fantasyPointsDraftKings) {
  ...
  public DriverRace fastestLaps(BigDecimal fastestLaps) {
  ...
  public DriverRace finalPosition(BigDecimal finalPosition) {
  ...
  public DriverRace laps(BigDecimal laps) {
    this.laps = laps;
    return this;
  }
  ...
  public DriverRace lapsLed(BigDecimal lapsLed) {
  ...
  public DriverRace manufacturer(String manufacturer) {
  ...
  public DriverRace name(String name) {
    this.name = name;
    return this;
  }
  ...
  public DriverRace number(Integer number) {
    this.number = number;
    return this;
  }
  ...
  public DriverRace numberDisplay(String numberDisplay) {
  ...
  public DriverRace penalty(BigDecimal penalty) {
  ...
  public DriverRace points(BigDecimal points) {
    this.points = points;
    return this;
  }
  ...
  public DriverRace poleFinalPosition(BigDecimal poleFinalPosition) {
  ...
  public DriverRace poles(BigDecimal poles) {
    this.poles = poles;
    return this;
  }
  ...
  public DriverRace positionDifferential(BigDecimal positionDifferential) {
  ...
  public DriverRace qualifyingSpeed(BigDecimal qualifyingSpeed) {
  ...
  public DriverRace raceID(Integer raceID) {
    this.raceID = raceID;
    return this;
  }
  ...
  public DriverRace season(Integer season) {
    this.season = season;
    return this;
  }
  ...
  public DriverRace startPosition(BigDecimal startPosition) {
  ...
  public DriverRace statID(Integer statID) {
    this.statID = statID;
    return this;
  }
  ...
  public DriverRace updated(String updated) {
  ...
  public DriverRace wins(BigDecimal wins) {
    this.wins = wins;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    DriverRace driverRace = (DriverRace) o;
    return Objects.equals(this.bonus, driverRace.bonus) &&
        Objects.equals(this.created, driverRace.created) &&
        Objects.equals(this.currentPosition, driverRace.currentPosition) &&
        Objects.equals(this.dateTime, driverRace.dateTime) &&
        Objects.equals(this.day, driverRace.day) &&
        Objects.equals(this.draftKingsSalary, driverRace.draftKingsSalary) &&
        Objects.equals(this.driverID, driverRace.driverID) &&
        Objects.equals(this.fantasyPoints, driverRace.fantasyPoints) &&
        Objects.equals(this.fantasyPointsDraftKings, driverRace.fantasyPointsDraftKings) &&
        Objects.equals(this.fastestLaps, driverRace.fastestLaps) &&
        Objects.equals(this.finalPosition, driverRace.finalPosition) &&
        Objects.equals(this.laps, driverRace.laps) &&
        Objects.equals(this.lapsLed, driverRace.lapsLed) &&
        Objects.equals(this.manufacturer, driverRace.manufacturer) &&
        Objects.equals(this.name, driverRace.name) &&
        Objects.equals(this.number, driverRace.number) &&
        Objects.equals(this.numberDisplay, driverRace.numberDisplay) &&
        Objects.equals(this.penalty, driverRace.penalty) &&
        Objects.equals(this.points, driverRace.points) &&
        Objects.equals(this.poleFinalPosition, driverRace.poleFinalPosition) &&
        Objects.equals(this.poles, driverRace.poles) &&
        Objects.equals(this.positionDifferential, driverRace.positionDifferential) &&
        Objects.equals(this.qualifyingSpeed, driverRace.qualifyingSpeed) &&
        Objects.equals(this.raceID, driverRace.raceID) &&
        Objects.equals(this.season, driverRace.season) &&
        Objects.equals(this.startPosition, driverRace.startPosition) &&
        Objects.equals(this.statID, driverRace.statID) &&
        Objects.equals(this.updated, driverRace.updated) &&
        Objects.equals(this.wins, driverRace.wins);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to DriverRace
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DriverRace.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DriverRace is not found in the empty JSON string", DriverRace.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DriverRace.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DriverRace` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DriverRace.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DriverRace' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DriverRace> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DriverRace.class));

       return (TypeAdapter<T>) new TypeAdapter<DriverRace>() {
           @Override
           public void write(JsonWriter out, DriverRace value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DriverRace read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DriverRace given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DriverRace
   * @throws IOException if the JSON string is invalid with respect to DriverRace
   */
  public static DriverRace fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DriverRace.class);
  }

  /**
   * Convert an instance of DriverRace to an JSON string
   *
   * @return JSON string
   */
