...
#ifndef OAIDriverRace_H
#define OAIDriverRace_H
...
class OAIDriverRace : public OAIObject {
public:
    OAIDriverRace();
    OAIDriverRace(QString json);
    ~OAIDriverRace() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDriverRace)

#endif // OAIDriverRace_H
