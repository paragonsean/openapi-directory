...
async def play_by_play(request: web.Request, format, gameid) -> web.Response:
    ...
    :type format: str
    :param gameid: The GameID of an NBA game.  GameIDs can be found in the Games API.  Valid entries are &lt;code&gt;14620&lt;/code&gt;, &lt;code&gt;16905&lt;/code&gt;, etc.
    :type gameid: str
...
async def play_by_play_delta(request: web.Request, format, _date, minutes) -> web.Response:
    ...
    :param format: Desired response format. Valid entries are &lt;code&gt;XML&lt;/code&gt; or &lt;code&gt;JSON&lt;/code&gt;.
    :type format: str
    :param _date: The date of the game(s). &lt;br&gt;Examples: &lt;code&gt;2016-OCT-31&lt;/code&gt;, &lt;code&gt;2017-JAN-15&lt;/code&gt;.
    :type _date: str
