...
public:
    ...
    qint32 getAlternateId() const;
    void setAlternateId(const qint32 &alternate_id);
    ...
    qint32 getCrewChiefId() const;
    void setCrewChiefId(const qint32 &crew_chief_id);
    bool is_crew_chief_id_Set() const;
    bool is_crew_chief_id_Valid() const;
    ...
    qint32 getUmpireId() const;
    void setUmpireId(const qint32 &umpire_id);
    bool is_umpire_id_Set() const;
    bool is_umpire_id_Valid() const;
...
private:
    ...
    qint32 m_crew_chief_id;
    bool m_crew_chief_id_isSet;
    bool m_crew_chief_id_isValid;
    ...
    qint32 m_umpire_id;
    bool m_umpire_id_isSet;
    bool m_umpire_id_isValid;
