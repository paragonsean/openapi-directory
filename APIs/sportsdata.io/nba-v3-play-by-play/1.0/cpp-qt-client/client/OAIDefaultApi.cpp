...
void OAIDefaultApi::initializeServerConfigs() {
    ...
    QUrl("http://azure-api.sportsdata.io/v3/nba/pbp"),
    "No description provided",
    QMap<QString, OAIServerVariable>()));
    defaultConf.append(OAIServerConfiguration(
    QUrl("https://azure-api.sportsdata.io/v3/nba/pbp"),
    "No description provided",
    QMap<QString, OAIServerVariable>()));
...
void OAIDefaultApi::playByPlay(const QString &format, const QString &gameid) {
    QString fullPath = QString(_serverConfigs["playByPlay"][_serverIndices.value("playByPlay")].URL()+"/{format}/PlayByPlay/{gameid}");
...
void OAIDefaultApi::playByPlayDelta(const QString &format, const QString &date, const QString &minutes) {
    QString fullPath = QString(_serverConfigs["playByPlayDelta"][_serverIndices.value("playByPlayDelta")].URL()+"/{format}/PlayByPlayDelta/{date}/{minutes}");
