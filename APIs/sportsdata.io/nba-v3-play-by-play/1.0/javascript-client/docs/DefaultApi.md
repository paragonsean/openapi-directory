...
```javascript
import NbaV3PlayByPlay from 'nba_v3_play_by_play';
let defaultClient = NbaV3PlayByPlay.ApiClient.instance;
...
let apiInstance = new NbaV3PlayByPlay.DefaultApi();
let format = "'XML'"; // String | Desired response format. Valid entries are <code>XML</code> or <code>JSON</code>.
let gameid = "gameid_example"; // String | The GameID of an NBA game.  GameIDs can be found in the Games API.  Valid entries are <code>14620</code>, <code>16905</code>, etc.
 ...
 **gameid** | **String**| The GameID of an NBA game.  GameIDs can be found in the Games API.  Valid entries are &lt;code&gt;14620&lt;/code&gt;, &lt;code&gt;16905&lt;/code&gt;, etc. | 
...
let apiInstance = new NbaV3PlayByPlay.DefaultApi();
let format = "'XML'"; // String | Desired response format. Valid entries are <code>XML</code> or <code>JSON</code>.
let date = "date_example"; // String | The date of the game(s). <br>Examples: <code>2016-OCT-31</code>, <code>2017-JAN-15</code>.
...
------------- | ------------- | ------------- | -------------
 **format** | **String**| Desired response format. Valid entries are &lt;code&gt;XML&lt;/code&gt; or &lt;code&gt;JSON&lt;/code&gt;. | [default to &#39;XML&#39;]
 **date** | **String**| The date of the game(s). &lt;br&gt;Examples: &lt;code&gt;2016-OCT-31&lt;/code&gt;, &lt;code&gt;2017-JAN-15&lt;/code&gt;. | 
