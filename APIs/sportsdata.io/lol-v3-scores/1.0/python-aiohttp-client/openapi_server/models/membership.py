...
class Membership(Model):
    ...
    def __init__(self, active: bool=None, end_date: str=None, membership_id: int=None, player_id: int=None, player_name: str=None, start_date: str=None, team_area: str=None, team_id: int=None, team_name: str=None, updated: str=None):
