...
```javascript
import LoLV3Scores from 'lo_l_v3_scores';
let defaultClient = LoLV3Scores.ApiClient.instance;
...
let apiInstance = new LoLV3Scores.DefaultApi();
...
let apiInstance = new LoLV3Scores.DefaultApi();
let format = "'xml'"; // String | Desired response format. Valid entries are <code>XML</code> or <code>JSON</code>.
let competitionid = "competitionid_example"; // String | A LoL competition/league unique CompetitionId. Possible values include: <code>100000009</code>, etc.
