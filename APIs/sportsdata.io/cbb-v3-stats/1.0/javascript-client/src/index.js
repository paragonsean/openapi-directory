...
* <pre>
* var CbbV3Stats = require('index'); // See note below*.
* var xxxSvc = new CbbV3Stats.XxxApi(); // Allocate the API class we're going to use.
* var yyyModel = new CbbV3Stats.Yyy(); // Construct a model instance.
...
* <pre>
* var xxxSvc = new CbbV3Stats.XxxApi(); // Allocate the API class we're going to use.
* var yyy = new CbbV3Stats.Yyy(); // Construct a model instance.
* yyyModel.someProperty = 'someValue';
* ...
* var zzz = xxxSvc.doSomething(yyyModel); // Invoke the service.
* ...
