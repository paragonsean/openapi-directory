...
public class PlayerGameProjection {
  ...
  public PlayerGameProjection assists(Integer assists) {
  ...
  public PlayerGameProjection blockedShots(Integer blockedShots) {
  ...
  public PlayerGameProjection defensiveRebounds(Integer defensiveRebounds) {
  ...
  public PlayerGameProjection fieldGoalsAttempted(Integer fieldGoalsAttempted) {
  ...
  public PlayerGameProjection fieldGoalsMade(Integer fieldGoalsMade) {
  ...
  public PlayerGameProjection freeThrowsAttempted(Integer freeThrowsAttempted) {
  ...
  public PlayerGameProjection freeThrowsMade(Integer freeThrowsMade) {
  ...
  public PlayerGameProjection offensiveRebounds(Integer offensiveRebounds) {
  ...
  public PlayerGameProjection personalFouls(Integer personalFouls) {
  ...
  public PlayerGameProjection points(Integer points) {
    this.points = points;
    return this;
  }
  ...
  public PlayerGameProjection rebounds(Integer rebounds) {
  ...
  public PlayerGameProjection steals(Integer steals) {
    this.steals = steals;
    return this;
  }
  ...
  public PlayerGameProjection threePointersAttempted(Integer threePointersAttempted) {
  ...
  public PlayerGameProjection threePointersMade(Integer threePointersMade) {
  ...
  public PlayerGameProjection turnovers(Integer turnovers) {
  ...
  public PlayerGameProjection twoPointersAttempted(Integer twoPointersAttempted) {
  ...
  public PlayerGameProjection twoPointersMade(Integer twoPointersMade) {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(assists, assistsPercentage, blockedShots, blocksPercentage, dateTime, day, defensiveRebounds, defensiveReboundsPercentage, draftKingsPosition, draftKingsSalary, effectiveFieldGoalsPercentage, fanDuelPosition, fanDuelSalary, fantasyDataSalary, fantasyPoints, fantasyPointsDraftKings, fantasyPointsFanDuel, fantasyPointsYahoo, fieldGoalsAttempted, fieldGoalsMade, fieldGoalsPercentage, freeThrowsAttempted, freeThrowsMade, freeThrowsPercentage, gameID, games, globalGameID, globalOpponentID, globalTeamID, homeOrAway, injuryBodyPart, injuryNotes, injuryStartDate, injuryStatus, isGameOver, minutes, name, offensiveRebounds, offensiveReboundsPercentage, opponent, opponentID, opponentPositionRank, opponentRank, personalFouls, playerEfficiencyRating, playerID, points, position, rebounds, season, seasonType, statID, steals, stealsPercentage, team, teamID, threePointersAttempted, threePointersMade, threePointersPercentage, totalReboundsPercentage, trueShootingAttempts, trueShootingPercentage, turnOversPercentage, turnovers, twoPointersAttempted, twoPointersMade, twoPointersPercentage, updated, usageRatePercentage, yahooPosition, yahooSalary);
  }
