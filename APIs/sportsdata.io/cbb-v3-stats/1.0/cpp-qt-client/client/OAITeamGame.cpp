...
qint32 OAITeamGame::getAssists() const {
    return m_assists;
}
void OAITeamGame::setAssists(const qint32 &assists) {
    m_assists = assists;
...
qint32 OAITeamGame::getBlockedShots() const {
    return m_blocked_shots;
}
void OAITeamGame::setBlockedShots(const qint32 &blocked_shots) {
...
qint32 OAITeamGame::getConferenceLosses() const {
    return m_conference_losses;
}
void OAITeamGame::setConferenceLosses(const qint32 &conference_losses) {
    m_conference_losses = conference_losses;
    m_conference_losses_isSet = true;
}

bool OAITeamGame::is_conference_losses_Set() const{
    return m_conference_losses_isSet;
}

bool OAITeamGame::is_conference_losses_Valid() const{
    return m_conference_losses_isValid;
}

qint32 OAITeamGame::getConferenceWins() const {
    return m_conference_wins;
}
void OAITeamGame::setConferenceWins(const qint32 &conference_wins) {
    m_conference_wins = conference_wins;
    m_conference_wins_isSet = true;
}

bool OAITeamGame::is_conference_wins_Set() const{
    return m_conference_wins_isSet;
}

bool OAITeamGame::is_conference_wins_Valid() const{
...
qint32 OAITeamGame::getDefensiveRebounds() const {
    return m_defensive_rebounds;
}
void OAITeamGame::setDefensiveRebounds(const qint32 &defensive_rebounds) {
...
qint32 OAITeamGame::getFieldGoalsAttempted() const {
    return m_field_goals_attempted;
}
void OAITeamGame::setFieldGoalsAttempted(const qint32 &field_goals_attempted) {
...
qint32 OAITeamGame::getFreeThrowsAttempted() const {
    return m_free_throws_attempted;
}
void OAITeamGame::setFreeThrowsAttempted(const qint32 &free_throws_attempted) {
...
qint32 OAITeamGame::getFreeThrowsMade() const {
    return m_free_throws_made;
}
void OAITeamGame::setFreeThrowsMade(const qint32 &free_throws_made) {
...
qint32 OAITeamGame::getOffensiveRebounds() const {
    return m_offensive_rebounds;
}
void OAITeamGame::setOffensiveRebounds(const qint32 &offensive_rebounds) {
...
qint32 OAITeamGame::getPersonalFouls() const {
    return m_personal_fouls;
}
void OAITeamGame::setPersonalFouls(const qint32 &personal_fouls) {
...
qint32 OAITeamGame::getPoints() const {
    return m_points;
}
void OAITeamGame::setPoints(const qint32 &points) {
    m_points = points;
    m_points_isSet = true;
}
...
qint32 OAITeamGame::getRebounds() const {
    return m_rebounds;
}
void OAITeamGame::setRebounds(const qint32 &rebounds) {
    m_rebounds = rebounds;
...
qint32 OAITeamGame::getSteals() const {
    return m_steals;
}
void OAITeamGame::setSteals(const qint32 &steals) {
    m_steals = steals;
    m_steals_isSet = true;
}
...
qint32 OAITeamGame::getThreePointersAttempted() const {
    return m_three_pointers_attempted;
}
void OAITeamGame::setThreePointersAttempted(const qint32 &three_pointers_attempted) {
...
qint32 OAITeamGame::getThreePointersMade() const {
    return m_three_pointers_made;
}
void OAITeamGame::setThreePointersMade(const qint32 &three_pointers_made) {
...
qint32 OAITeamGame::getTurnovers() const {
    return m_turnovers;
}
void OAITeamGame::setTurnovers(const qint32 &turnovers) {
...
qint32 OAITeamGame::getTwoPointersAttempted() const {
    return m_two_pointers_attempted;
}
void OAITeamGame::setTwoPointersAttempted(const qint32 &two_pointers_attempted) {
...
qint32 OAITeamGame::getTwoPointersMade() const {
    return m_two_pointers_made;
}
void OAITeamGame::setTwoPointersMade(const qint32 &two_pointers_made) {
