...
qint32 OAIPlayerGame::getAssists() const {
    return m_assists;
}
void OAIPlayerGame::setAssists(const qint32 &assists) {
    m_assists = assists;
...
qint32 OAIPlayerGame::getBlockedShots() const {
    return m_blocked_shots;
}
void OAIPlayerGame::setBlockedShots(const qint32 &blocked_shots) {
...
qint32 OAIPlayerGame::getDefensiveRebounds() const {
    return m_defensive_rebounds;
}
void OAIPlayerGame::setDefensiveRebounds(const qint32 &defensive_rebounds) {
...
qint32 OAIPlayerGame::getFieldGoalsAttempted() const {
    return m_field_goals_attempted;
}
void OAIPlayerGame::setFieldGoalsAttempted(const qint32 &field_goals_attempted) {
...
qint32 OAIPlayerGame::getFieldGoalsMade() const {
    return m_field_goals_made;
}
void OAIPlayerGame::setFieldGoalsMade(const qint32 &field_goals_made) {
...
qint32 OAIPlayerGame::getFreeThrowsAttempted() const {
    return m_free_throws_attempted;
}
void OAIPlayerGame::setFreeThrowsAttempted(const qint32 &free_throws_attempted) {
...
qint32 OAIPlayerGame::getFreeThrowsMade() const {
    return m_free_throws_made;
}
void OAIPlayerGame::setFreeThrowsMade(const qint32 &free_throws_made) {
...
qint32 OAIPlayerGame::getOffensiveRebounds() const {
    return m_offensive_rebounds;
}
void OAIPlayerGame::setOffensiveRebounds(const qint32 &offensive_rebounds) {
...
qint32 OAIPlayerGame::getPersonalFouls() const {
    return m_personal_fouls;
}
void OAIPlayerGame::setPersonalFouls(const qint32 &personal_fouls) {
...
qint32 OAIPlayerGame::getPoints() const {
    return m_points;
}
void OAIPlayerGame::setPoints(const qint32 &points) {
    m_points = points;
    m_points_isSet = true;
}
...
qint32 OAIPlayerGame::getRebounds() const {
    return m_rebounds;
}
void OAIPlayerGame::setRebounds(const qint32 &rebounds) {
    m_rebounds = rebounds;
...
qint32 OAIPlayerGame::getSteals() const {
    return m_steals;
}
void OAIPlayerGame::setSteals(const qint32 &steals) {
    m_steals = steals;
    m_steals_isSet = true;
}
...
qint32 OAIPlayerGame::getThreePointersAttempted() const {
    return m_three_pointers_attempted;
}
void OAIPlayerGame::setThreePointersAttempted(const qint32 &three_pointers_attempted) {
...
qint32 OAIPlayerGame::getThreePointersMade() const {
    return m_three_pointers_made;
}
void OAIPlayerGame::setThreePointersMade(const qint32 &three_pointers_made) {
...
qint32 OAIPlayerGame::getTurnovers() const {
    return m_turnovers;
}
void OAIPlayerGame::setTurnovers(const qint32 &turnovers) {
...
qint32 OAIPlayerGame::getTwoPointersAttempted() const {
    return m_two_pointers_attempted;
}
void OAIPlayerGame::setTwoPointersAttempted(const qint32 &two_pointers_attempted) {
...
qint32 OAIPlayerGame::getTwoPointersMade() const {
    return m_two_pointers_made;
}
void OAIPlayerGame::setTwoPointersMade(const qint32 &two_pointers_made) {
