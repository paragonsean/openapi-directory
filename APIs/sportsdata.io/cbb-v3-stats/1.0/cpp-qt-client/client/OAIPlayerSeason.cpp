...
qint32 OAIPlayerSeason::getAssists() const {
    return m_assists;
}
void OAIPlayerSeason::setAssists(const qint32 &assists) {
    m_assists = assists;
...
qint32 OAIPlayerSeason::getBlockedShots() const {
    return m_blocked_shots;
}
void OAIPlayerSeason::setBlockedShots(const qint32 &blocked_shots) {
...
qint32 OAIPlayerSeason::getDefensiveRebounds() const {
    return m_defensive_rebounds;
}
void OAIPlayerSeason::setDefensiveRebounds(const qint32 &defensive_rebounds) {
...
qint32 OAIPlayerSeason::getFieldGoalsAttempted() const {
    return m_field_goals_attempted;
}
void OAIPlayerSeason::setFieldGoalsAttempted(const qint32 &field_goals_attempted) {
...
qint32 OAIPlayerSeason::getFieldGoalsMade() const {
    return m_field_goals_made;
}
void OAIPlayerSeason::setFieldGoalsMade(const qint32 &field_goals_made) {
...
qint32 OAIPlayerSeason::getFreeThrowsAttempted() const {
    return m_free_throws_attempted;
}
void OAIPlayerSeason::setFreeThrowsAttempted(const qint32 &free_throws_attempted) {
...
qint32 OAIPlayerSeason::getFreeThrowsMade() const {
    return m_free_throws_made;
}
void OAIPlayerSeason::setFreeThrowsMade(const qint32 &free_throws_made) {
...
qint32 OAIPlayerSeason::getOffensiveRebounds() const {
    return m_offensive_rebounds;
}
void OAIPlayerSeason::setOffensiveRebounds(const qint32 &offensive_rebounds) {
...
qint32 OAIPlayerSeason::getPersonalFouls() const {
    return m_personal_fouls;
}
void OAIPlayerSeason::setPersonalFouls(const qint32 &personal_fouls) {
...
qint32 OAIPlayerSeason::getPoints() const {
    return m_points;
}
void OAIPlayerSeason::setPoints(const qint32 &points) {
    m_points = points;
    m_points_isSet = true;
}
...
qint32 OAIPlayerSeason::getRebounds() const {
    return m_rebounds;
}
void OAIPlayerSeason::setRebounds(const qint32 &rebounds) {
    m_rebounds = rebounds;
...
qint32 OAIPlayerSeason::getSteals() const {
    return m_steals;
}
void OAIPlayerSeason::setSteals(const qint32 &steals) {
    m_steals = steals;
    m_steals_isSet = true;
}
...
qint32 OAIPlayerSeason::getThreePointersAttempted() const {
    return m_three_pointers_attempted;
}
void OAIPlayerSeason::setThreePointersAttempted(const qint32 &three_pointers_attempted) {
...
qint32 OAIPlayerSeason::getThreePointersMade() const {
    return m_three_pointers_made;
}
void OAIPlayerSeason::setThreePointersMade(const qint32 &three_pointers_made) {
...
qint32 OAIPlayerSeason::getTurnovers() const {
    return m_turnovers;
}
void OAIPlayerSeason::setTurnovers(const qint32 &turnovers) {
...
qint32 OAIPlayerSeason::getTwoPointersAttempted() const {
    return m_two_pointers_attempted;
}
void OAIPlayerSeason::setTwoPointersAttempted(const qint32 &two_pointers_attempted) {
...
qint32 OAIPlayerSeason::getTwoPointersMade() const {
    return m_two_pointers_made;
}
void OAIPlayerSeason::setTwoPointersMade(const qint32 &two_pointers_made) {
