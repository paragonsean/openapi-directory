...
class BoxScore(Model):
    ...
    def __init__(self, game: Game=None, periods: List[Period]=None, player_games: List[PlayerGame]=None, team_games: List[TeamGame]=None):
        """BoxScore - a model defined in OpenAPI

        :param game: The game of this BoxScore.
        :param periods: The periods of this BoxScore.
    ...
    @property
    def periods(self):
        """Gets the periods of this BoxScore.


        :return: The periods of this BoxScore.
        :rtype: List[Period]
        """
    ...
    def periods(self, periods):
        """Sets the periods of this BoxScore.
