...
async def test_are_games_in_progress(client):
    ...
    response = await client.request(
        method='GET',
        path='/v3/cbb/stats/{format}/AreAnyGamesInProgress'.format(format=XML),
        headers=headers,
        )
...
async def test_box_score(client):
    ...
    response = await client.request(
        method='GET',
        path='/v3/cbb/stats/{format}/BoxScore/{gameid}'.format(format=XML, gameid='gameid_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_box_scores_by_date(client):
    ...
    response = await client.request(
        method='GET',
        path='/v3/cbb/stats/{format}/BoxScores/{_date}'.format(format=XML, _date='_date_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_box_scores_by_date_delta(client):
    ...
    response = await client.request(
        method='GET',
        path='/v3/cbb/stats/{format}/BoxScoresDelta/{_date}/{minutes}'.format(format=XML, _date='_date_example', minutes='minutes_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_current_season(client):
    ...
    response = await client.request(
        method='GET',
        path='/v3/cbb/stats/{format}/CurrentSeason'.format(format=XML),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_games_by_date(client):
    ...
    response = await client.request(
        method='GET',
        path='/v3/cbb/stats/{format}/GamesByDate/{_date}'.format(format=XML, _date='_date_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_injured_players(client):
    ...
    response = await client.request(
        method='GET',
        path='/v3/cbb/stats/{format}/InjuredPlayers'.format(format=XML),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_league_hierarchy(client):
    ...
    response = await client.request(
        method='GET',
        path='/v3/cbb/stats/{format}/LeagueHierarchy'.format(format=XML),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_player_details_by_active(client):
    ...
    response = await client.request(
        method='GET',
        path='/v3/cbb/stats/{format}/Players'.format(format=XML),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_player_details_by_player(client):
    ...
    response = await client.request(
        method='GET',
        path='/v3/cbb/stats/{format}/Player/{playerid}'.format(format=XML, playerid='playerid_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_player_details_by_team(client):
    ...
    response = await client.request(
        method='GET',
        path='/v3/cbb/stats/{format}/Players/{team}'.format(format=XML, team='team_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_player_game_logs_by_season(client):
    ...
    response = await client.request(
        method='GET',
        path='/v3/cbb/stats/{format}/PlayerGameStatsBySeason/{season}/{playerid}/{numberofgames}'.format(format='format_example', season='season_example', playerid='playerid_example', numberofgames='numberofgames_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_player_game_stats_by_date(client):
    ...
    response = await client.request(
        method='GET',
        path='/v3/cbb/stats/{format}/PlayerGameStatsByDate/{_date}'.format(format=XML, _date='_date_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_player_game_stats_by_player(client):
    ...
    response = await client.request(
        method='GET',
        path='/v3/cbb/stats/{format}/PlayerGameStatsByPlayer/{_date}/{playerid}'.format(format=XML, _date='_date_example', playerid='playerid_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_player_season_stats(client):
    ...
    response = await client.request(
        method='GET',
        path='/v3/cbb/stats/{format}/PlayerSeasonStats/{season}'.format(format=XML, season='season_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_player_season_stats_by_player(client):
    ...
    response = await client.request(
        method='GET',
        path='/v3/cbb/stats/{format}/PlayerSeasonStatsByPlayer/{season}/{playerid}'.format(format=XML, season='season_example', playerid='playerid_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_player_season_stats_by_team(client):
    ...
    response = await client.request(
        method='GET',
        path='/v3/cbb/stats/{format}/PlayerSeasonStatsByTeam/{season}/{team}'.format(format=XML, season='season_example', team='team_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_projected_player_game_stats_by_date(client):
    ...
    response = await client.request(
        method='GET',
        path='/v3/cbb/stats/{format}/PlayerGameProjectionStatsByDate/{_date}'.format(format=XML, _date='_date_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_projected_player_game_stats_by_player(client):
    ...
    response = await client.request(
        method='GET',
        path='/v3/cbb/stats/{format}/PlayerGameProjectionStatsByPlayer/{_date}/{playerid}'.format(format=XML, _date='_date_example', playerid='playerid_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_schedules(client):
    ...
    response = await client.request(
        method='GET',
        path='/v3/cbb/stats/{format}/Games/{season}'.format(format=XML, season='season_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_stadiums(client):
    ...
    response = await client.request(
        method='GET',
        path='/v3/cbb/stats/{format}/Stadiums'.format(format=XML),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_team_game_logs_by_season(client):
    ...
    response = await client.request(
        method='GET',
        path='/v3/cbb/stats/{format}/TeamGameStatsBySeason/{season}/{teamid}/{numberofgames}'.format(format='format_example', season='season_example', teamid='teamid_example', numberofgames='numberofgames_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_team_game_stats_by_date(client):
    ...
    response = await client.request(
        method='GET',
        path='/v3/cbb/stats/{format}/TeamGameStatsByDate/{_date}'.format(format=XML, _date='_date_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_team_season_stats(client):
    ...
    response = await client.request(
        method='GET',
        path='/v3/cbb/stats/{format}/TeamSeasonStats/{season}'.format(format=XML, season='season_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_teams(client):
    ...
    response = await client.request(
        method='GET',
        path='/v3/cbb/stats/{format}/teams'.format(format=XML),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_tournament_hierarchy(client):
    ...
    response = await client.request(
        method='GET',
        path='/v3/cbb/stats/{format}/Tournament/{season}'.format(format=XML, season='season_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
