...
class DfsSlate {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('DfsSlateGames')) {
                obj['DfsSlateGames'] = ApiClient.convertToType(data['DfsSlateGames'], [DfsSlateGame]);
            }
            ...
            if (data.hasOwnProperty('NumberOfGames')) {
                obj['NumberOfGames'] = ApiClient.convertToType(data['NumberOfGames'], 'Number');
            }
            ...
            if (data.hasOwnProperty('SalaryCap')) {
                obj['SalaryCap'] = ApiClient.convertToType(data['SalaryCap'], 'Number');
            }
            ...
            if (data.hasOwnProperty('VideoGameId')) {
                obj['VideoGameId'] = ApiClient.convertToType(data['VideoGameId'], 'Number');
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        if (data['DfsSlateGames']) { // data not null
            // ensure the json data is an array
            if (!Array.isArray(data['DfsSlateGames'])) {
                throw new Error("Expected the field `DfsSlateGames` to be an array in the JSON data but got " + data['DfsSlateGames']);
            }
            // validate the optional field `DfsSlateGames` (array)
            for (const item of data['DfsSlateGames']) {
                DfsSlateGame.validateJSON(item);
            };
        }
...
/**
 * @member {Array.<module:model/DfsSlateGame>} DfsSlateGames
 */
DfsSlate.prototype['DfsSlateGames'] = undefined;
...
/**
 * @member {Number} NumberOfGames
 */
DfsSlate.prototype['NumberOfGames'] = undefined;
...
/**
 * @member {Number} SalaryCap
 */
DfsSlate.prototype['SalaryCap'] = undefined;
...
/**
 * @member {Number} VideoGameId
 */
DfsSlate.prototype['VideoGameId'] = undefined;
