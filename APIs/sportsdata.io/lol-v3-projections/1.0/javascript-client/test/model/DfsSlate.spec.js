...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LoLV3Projections.DfsSlate();
  });
  ...
  describe('DfsSlate', function() {
    it('should create an instance of DfsSlate', function() {
      ...
      //var instance = new LoLV3Projections.DfsSlate();
      //expect(instance).to.be.a(LoLV3Projections.DfsSlate);
    });
    ...
    it('should have the property videoGameId (base name: "VideoGameId")', function() {
