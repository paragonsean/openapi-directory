...
void OAIDfsSlate::initializeModel() {
    ...
    m_video_game_id_isSet = false;
    m_video_game_id_isValid = false;
}
...
void OAIDfsSlate::fromJsonObject(QJsonObject json) {
    ...
    m_video_game_id_isValid = ::OpenAPI::fromJsonValue(m_video_game_id, json[QString("VideoGameId")]);
    m_video_game_id_isSet = !json[QString("VideoGameId")].isNull() && m_video_game_id_isValid;
}
...
QJsonObject OAIDfsSlate::asJsonObject() const {
    ...
    if (m_video_game_id_isSet) {
        obj.insert(QString("VideoGameId"), ::OpenAPI::toJsonValue(m_video_game_id));
    }
    return obj;
}
...
qint32 OAIDfsSlate::getVideoGameId() const {
    return m_video_game_id;
}
void OAIDfsSlate::setVideoGameId(const qint32 &video_game_id) {
    m_video_game_id = video_game_id;
    m_video_game_id_isSet = true;
}

bool OAIDfsSlate::is_video_game_id_Set() const{
    return m_video_game_id_isSet;
}

bool OAIDfsSlate::is_video_game_id_Valid() const{
    return m_video_game_id_isValid;
}
