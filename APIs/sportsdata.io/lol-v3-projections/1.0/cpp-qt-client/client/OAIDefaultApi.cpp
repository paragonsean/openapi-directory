...
void OAIDefaultApi::initializeServerConfigs() {
    ...
    QUrl("http://azure-api.sportsdata.io/v3/lol/projections"),
    "No description provided",
    QMap<QString, OAIServerVariable>()));
    defaultConf.append(OAIServerConfiguration(
    QUrl("https://azure-api.sportsdata.io/v3/lol/projections"),
    "No description provided",
    QMap<QString, OAIServerVariable>()));
    _serverConfigs.insert("dfsSlatesByDate", defaultConf);
    _serverIndices.insert("dfsSlatesByDate", 0);
    _serverConfigs.insert("projectedPlayerGameStatsByDate", defaultConf);
    _serverIndices.insert("projectedPlayerGameStatsByDate", 0);
    _serverConfigs.insert("projectedPlayerGameStatsByPlayer", defaultConf);
    _serverIndices.insert("projectedPlayerGameStatsByPlayer", 0);
}
...
void OAIDefaultApi::projectedPlayerGameStatsByDate(const QString &format, const QString &date) {
    QString fullPath = QString(_serverConfigs["projectedPlayerGameStatsByDate"][_serverIndices.value("projectedPlayerGameStatsByDate")].URL()+"/{format}/PlayerGameProjectionStatsByDate/{date}");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIDefaultApi::projectedPlayerGameStatsByDateCallback);
    connect(this, &OAIDefaultApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIDefaultApi::projectedPlayerGameStatsByDateCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT projectedPlayerGameStatsByDateSignal(output);
        Q_EMIT projectedPlayerGameStatsByDateSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT projectedPlayerGameStatsByDateSignalE(output, error_type, error_str);
        Q_EMIT projectedPlayerGameStatsByDateSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT projectedPlayerGameStatsByDateSignalError(output, error_type, error_str);
        Q_EMIT projectedPlayerGameStatsByDateSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIDefaultApi::projectedPlayerGameStatsByPlayer(const QString &format, const QString &date, const QString &playerid) {
    QString fullPath = QString(_serverConfigs["projectedPlayerGameStatsByPlayer"][_serverIndices.value("projectedPlayerGameStatsByPlayer")].URL()+"/{format}/PlayerGameProjectionStatsByPlayer/{date}/{playerid}");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIDefaultApi::projectedPlayerGameStatsByPlayerCallback);
    connect(this, &OAIDefaultApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIDefaultApi::projectedPlayerGameStatsByPlayerCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT projectedPlayerGameStatsByPlayerSignal(output);
        Q_EMIT projectedPlayerGameStatsByPlayerSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT projectedPlayerGameStatsByPlayerSignalE(output, error_type, error_str);
        Q_EMIT projectedPlayerGameStatsByPlayerSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT projectedPlayerGameStatsByPlayerSignalError(output, error_type, error_str);
        Q_EMIT projectedPlayerGameStatsByPlayerSignalErrorFull(worker, error_type, error_str);
    }
}
