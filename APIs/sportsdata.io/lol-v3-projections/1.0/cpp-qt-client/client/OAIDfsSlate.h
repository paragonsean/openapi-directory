...
public:
    ...
    qint32 getVideoGameId() const;
    void setVideoGameId(const qint32 &video_game_id);
    bool is_video_game_id_Set() const;
    bool is_video_game_id_Valid() const;
...
private:
    ...
    qint32 m_video_game_id;
    bool m_video_game_id_isSet;
    bool m_video_game_id_isValid;
};
