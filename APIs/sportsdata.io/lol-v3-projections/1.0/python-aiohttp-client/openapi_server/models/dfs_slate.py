...
class DfsSlate(Model):
    ...
    def __init__(self, dfs_slate_games: List[DfsSlateGame]=None, dfs_slate_players: List[DfsSlatePlayer]=None, is_multi_day_slate: bool=None, number_of_games: int=None, operator: str=None, operator_day: str=None, operator_game_type: str=None, operator_name: str=None, operator_slate_id: int=None, operator_start_time: str=None, removed_by_operator: bool=None, salary_cap: int=None, slate_id: int=None, slate_roster_slots: List[str]=None, video_game_id: int=None):
        """DfsSlate - a model defined in OpenAPI

        :param dfs_slate_games: The dfs_slate_games of this DfsSlate.
        ...
        :param number_of_games: The number_of_games of this DfsSlate.
        ...
        :param salary_cap: The salary_cap of this DfsSlate.
        :param slate_id: The slate_id of this DfsSlate.
        :param slate_roster_slots: The slate_roster_slots of this DfsSlate.
        :param video_game_id: The video_game_id of this DfsSlate.
        """
        self.openapi_types = {
            'dfs_slate_games': List[DfsSlateGame],
        ...
        self._video_game_id = video_game_id
    ...
    def dfs_slate_games(self):
        """Gets the dfs_slate_games of this DfsSlate.


        :return: The dfs_slate_games of this DfsSlate.
        :rtype: List[DfsSlateGame]
        """
        return self._dfs_slate_games

    @dfs_slate_games.setter
    def dfs_slate_games(self, dfs_slate_games):
        """Sets the dfs_slate_games of this DfsSlate.


        :param dfs_slate_games: The dfs_slate_games of this DfsSlate.
        :type dfs_slate_games: List[DfsSlateGame]
        """
    ...
    def number_of_games(self):
        """Gets the number_of_games of this DfsSlate.


        :return: The number_of_games of this DfsSlate.
        :rtype: int
        """
    ...
    def number_of_games(self, number_of_games):
        """Sets the number_of_games of this DfsSlate.
    ...
    @property
    def salary_cap(self):
        """Gets the salary_cap of this DfsSlate.


        :return: The salary_cap of this DfsSlate.
        :rtype: int
        """
    ...
    def salary_cap(self, salary_cap):
        """Sets the salary_cap of this DfsSlate.
    ...
    @property
    def video_game_id(self):
        """Gets the video_game_id of this DfsSlate.


        :return: The video_game_id of this DfsSlate.
        :rtype: int
        """
        return self._video_game_id

    @video_game_id.setter
    def video_game_id(self, video_game_id):
        """Sets the video_game_id of this DfsSlate.


        :param video_game_id: The video_game_id of this DfsSlate.
        :type video_game_id: int
        """
