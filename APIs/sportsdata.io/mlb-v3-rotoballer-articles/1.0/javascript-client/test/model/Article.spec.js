...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    factory(root.expect, root.MlbV3RotoBallerArticles);
  }
}(this, function(expect, MlbV3RotoBallerArticles) {
  'use strict';

  var instance;

  beforeEach(function() {
    instance = new MlbV3RotoBallerArticles.Article();
  });
  ...
  describe('Article', function() {
    it('should create an instance of Article', function() {
      ...
      //var instance = new MlbV3RotoBallerArticles.Article();
      //expect(instance).to.be.a(MlbV3RotoBallerArticles.Article);
    });
