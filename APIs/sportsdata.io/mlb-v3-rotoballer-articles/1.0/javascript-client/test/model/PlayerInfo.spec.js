...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MlbV3RotoBallerArticles.PlayerInfo();
  });
  ...
  describe('PlayerInfo', function() {
    it('should create an instance of PlayerInfo', function() {
      ...
      //var instance = new MlbV3RotoBallerArticles.PlayerInfo();
      //expect(instance).to.be.a(MlbV3RotoBallerArticles.PlayerInfo);
    });
