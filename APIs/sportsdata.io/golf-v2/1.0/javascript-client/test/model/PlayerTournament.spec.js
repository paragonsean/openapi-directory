...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GolfV2.PlayerTournament();
  });
  ...
  describe('PlayerTournament', function() {
    it('should create an instance of PlayerTournament', function() {
      // uncomment below and update the code to test PlayerTournament
      //var instance = new GolfV2.PlayerTournament();
      //expect(instance).to.be.a(GolfV2.PlayerTournament);
    });
