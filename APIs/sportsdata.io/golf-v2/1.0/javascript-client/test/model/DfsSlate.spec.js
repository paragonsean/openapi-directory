...
(function(root, factory) {
  ...
  describe('DfsSlate', function() {
    it('should create an instance of DfsSlate', function() {
      ...
      //var instance = new GolfV2.DfsSlate();
      //expect(instance).to.be.a(GolfV2.DfsSlate);
    });
    ...
    it('should have the property dfsSlateTournaments (base name: "DfsSlateTournaments")', function() {
      // uncomment below and update the code to test the property dfsSlateTournaments
      //var instance = new GolfV2.DfsSlate();
      //expect(instance).to.be();
    });
    ...
    it('should have the property numberOfTournaments (base name: "NumberOfTournaments")', function() {
      // uncomment below and update the code to test the property numberOfTournaments
      //var instance = new GolfV2.DfsSlate();
      //expect(instance).to.be();
    });
