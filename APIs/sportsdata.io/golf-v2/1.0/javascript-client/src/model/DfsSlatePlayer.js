...
class DfsSlatePlayer {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('PlayerTournamentProjectionID')) {
                obj['PlayerTournamentProjectionID'] = ApiClient.convertToType(data['PlayerTournamentProjectionID'], 'Number');
            }
...
/**
 * @member {Number} PlayerTournamentProjectionID
 */
DfsSlatePlayer.prototype['PlayerTournamentProjectionID'] = undefined;
 ...
 */
DfsSlatePlayer.prototype['SlateTournamentID'] = undefined;
