...
public:
    ...
    qint32 getPlayerTournamentProjectionId() const;
    void setPlayerTournamentProjectionId(const qint32 &player_tournament_projection_id);
    bool is_player_tournament_projection_id_Set() const;
    bool is_player_tournament_projection_id_Valid() const;
...
private:
    ...
    qint32 m_player_tournament_projection_id;
    bool m_player_tournament_projection_id_isSet;
    bool m_player_tournament_projection_id_isValid;
