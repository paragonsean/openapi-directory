...
```javascript
import MlbV3PlayByPlay from 'mlb_v3_play_by_play';
let defaultClient = MlbV3PlayByPlay.ApiClient.instance;
...
let apiInstance = new MlbV3PlayByPlay.DefaultApi();
