...
async def test_are_games_in_progress(client):
    ...
    response = await client.request(
        method='GET',
        path='/v3/nhl/scores/{format}/AreAnyGamesInProgress'.format(format=XML),
        headers=headers,
        )
...
async def test_current_season(client):
    ...
    response = await client.request(
        method='GET',
        path='/v3/nhl/scores/{format}/CurrentSeason'.format(format=XML),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_games_by_date(client):
    ...
    response = await client.request(
        method='GET',
        path='/v3/nhl/scores/{format}/GamesByDate/{_date}'.format(format=XML, _date='_date_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_games_by_date_basic(client):
    ...
    response = await client.request(
        method='GET',
        path='/v3/nhl/scores/{format}/ScoresBasic/{_date}'.format(format=XML, _date='_date_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_news(client):
    ...
    response = await client.request(
        method='GET',
        path='/v3/nhl/scores/{format}/News'.format(format=XML),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_news_by_date(client):
    ...
    response = await client.request(
        method='GET',
        path='/v3/nhl/scores/{format}/NewsByDate/{_date}'.format(format=XML, _date='_date_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_news_by_player(client):
    ...
    response = await client.request(
        method='GET',
        path='/v3/nhl/scores/{format}/NewsByPlayerID/{playerid}'.format(format=XML, playerid='playerid_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_player_details_by_active(client):
    ...
    response = await client.request(
        method='GET',
        path='/v3/nhl/scores/{format}/Players'.format(format=XML),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_player_details_by_free_agent(client):
    ...
    response = await client.request(
        method='GET',
        path='/v3/nhl/scores/{format}/FreeAgents'.format(format=XML),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_player_details_by_player(client):
    ...
    response = await client.request(
        method='GET',
        path='/v3/nhl/scores/{format}/Player/{playerid}'.format(format=XML, playerid='playerid_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_players_by_team(client):
    ...
    response = await client.request(
        method='GET',
        path='/v3/nhl/scores/{format}/Players/{team}'.format(format=XML, team='team_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_players_by_team_basic(client):
    ...
    response = await client.request(
        method='GET',
        path='/v3/nhl/scores/{format}/PlayersBasic/{team}'.format(format=XML, team='team_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_schedules(client):
    ...
    response = await client.request(
        method='GET',
        path='/v3/nhl/scores/{format}/Games/{season}'.format(format=XML, season='season_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_schedules_basic(client):
    ...
    response = await client.request(
        method='GET',
        path='/v3/nhl/scores/{format}/SchedulesBasic/{season}'.format(format=XML, season='season_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_stadiums(client):
    ...
    response = await client.request(
        method='GET',
        path='/v3/nhl/scores/{format}/Stadiums'.format(format=xml),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_standings(client):
    ...
    response = await client.request(
        method='GET',
        path='/v3/nhl/scores/{format}/Standings/{season}'.format(format=XML, season='season_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_team_game_logs_by_season(client):
    ...
    response = await client.request(
        method='GET',
        path='/v3/nhl/scores/{format}/TeamGameStatsBySeason/{season}/{teamid}/{numberofgames}'.format(format=XML, season='season_example', teamid='teamid_example', numberofgames='numberofgames_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_team_game_stats_by_date(client):
    ...
    response = await client.request(
        method='GET',
        path='/v3/nhl/scores/{format}/TeamGameStatsByDate/{_date}'.format(format=XML, _date='_date_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_team_season_stats(client):
    ...
    response = await client.request(
        method='GET',
        path='/v3/nhl/scores/{format}/TeamSeasonStats/{season}'.format(format=XML, season='season_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_teams_active(client):
    ...
    response = await client.request(
        method='GET',
        path='/v3/nhl/scores/{format}/teams'.format(format=XML),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_teams_all(client):
    ...
    response = await client.request(
        method='GET',
        path='/v3/nhl/scores/{format}/AllTeams'.format(format=XML),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
