...
class Stadium(Model):
    ...
    def __init__(self, active: bool=None, address: str=None, capacity: int=None, city: str=None, country: str=None, geo_lat: float=None, geo_long: float=None, name: str=None, stadium_id: int=None, state: str=None, zip: str=None):
        """Stadium - a model defined in OpenAPI

        :param active: The active of this Stadium.
        :param address: The address of this Stadium.
        ...
        :param zip: The zip of this Stadium.
        """
        self.openapi_types = {
            'active': bool,
            'address': str,
    ...
    @property
    def address(self):
        """Gets the address of this Stadium.


        :return: The address of this Stadium.
        :rtype: str
        """
    ...
    @property
    def zip(self):
        """Gets the zip of this Stadium.


        :return: The zip of this Stadium.
        :rtype: str
        """
        return self._zip
