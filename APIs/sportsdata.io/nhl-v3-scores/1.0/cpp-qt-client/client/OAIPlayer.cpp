...
void OAIPlayer::initializeModel() {
    ...
    m_catches_isSet = false;
    m_catches_isValid = false;
...
void OAIPlayer::fromJsonObject(QJsonObject json) {
    ...
    m_catches_isValid = ::OpenAPI::fromJsonValue(m_catches, json[QString("Catches")]);
    m_catches_isSet = !json[QString("Catches")].isNull() && m_catches_isValid;
...
QJsonObject OAIPlayer::asJsonObject() const {
    ...
    if (m_catches_isSet) {
        obj.insert(QString("Catches"), ::OpenAPI::toJsonValue(m_catches));
    }
...
QString OAIPlayer::getCatches() const {
    return m_catches;
}
void OAIPlayer::setCatches(const QString &catches) {
    m_catches = catches;
    m_catches_isSet = true;
}

bool OAIPlayer::is_catches_Set() const{
    return m_catches_isSet;
}

bool OAIPlayer::is_catches_Valid() const{
    return m_catches_isValid;
}
...
QString OAIPlayer::getShoots() const {
    return m_shoots;
}
void OAIPlayer::setShoots(const QString &shoots) {
    m_shoots = shoots;
    m_shoots_isSet = true;
}

bool OAIPlayer::is_shoots_Set() const{
    return m_shoots_isSet;
}

bool OAIPlayer::is_shoots_Valid() const{
