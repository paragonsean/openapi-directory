...
public class Team {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(active, city, conference, division, globalTeamID, key, name, primaryColor, quaternaryColor, secondaryColor, stadiumID, teamID, tertiaryColor, wikipediaLogoUrl, wikipediaWordMarkUrl);
  }
