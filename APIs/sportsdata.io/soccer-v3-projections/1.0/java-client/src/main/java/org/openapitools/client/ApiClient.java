...
public class ApiClient {
    ...
    private String basePath = "http://azure-api.sportsdata.io/v3/soccer/projections";
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g http://azure-api.sportsdata.io/v3/soccer/projections
