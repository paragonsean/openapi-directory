...
public:
    ...
    void setCaptain(const bool &captain);
    bool is_captain_Set() const;
    bool is_captain_Valid() const;
    ...
    QString getMondogoalPosition() const;
    void setMondogoalPosition(const QString &mondogoal_position);
    bool is_mondogoal_position_Set() const;
    bool is_mondogoal_position_Valid() const;

    qint32 getMondogoalSalary() const;
    void setMondogoalSalary(const qint32 &mondogoal_salary);
    bool is_mondogoal_salary_Set() const;
    bool is_mondogoal_salary_Valid() const;
    ...
    bool isSuspension() const;
    void setSuspension(const bool &suspension);
    bool is_suspension_Set() const;
    bool is_suspension_Valid() const;
...
private:
    ...
    bool m_captain;
    bool m_captain_isSet;
    bool m_captain_isValid;
    ...
    QString m_mondogoal_position;
    bool m_mondogoal_position_isSet;
    bool m_mondogoal_position_isValid;

    qint32 m_mondogoal_salary;
    bool m_mondogoal_salary_isSet;
    bool m_mondogoal_salary_isValid;
    ...
    bool m_suspension;
    bool m_suspension_isSet;
    bool m_suspension_isValid;
