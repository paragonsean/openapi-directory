...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SoccerV3Projections.DfsSlatePlayer();
  });
  ...
  describe('DfsSlatePlayer', function() {
    it('should create an instance of DfsSlatePlayer', function() {
      ...
      //var instance = new SoccerV3Projections.DfsSlatePlayer();
      //expect(instance).to.be.a(SoccerV3Projections.DfsSlatePlayer);
    });
