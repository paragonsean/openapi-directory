...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SoccerV3Projections.PlayerGameProjection();
  });
  ...
  describe('PlayerGameProjection', function() {
    it('should create an instance of PlayerGameProjection', function() {
      ...
      //var instance = new SoccerV3Projections.PlayerGameProjection();
      //expect(instance).to.be.a(SoccerV3Projections.PlayerGameProjection);
    });
