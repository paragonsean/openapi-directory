...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SoccerV3Projections.DfsSlateGame();
  });
  ...
  describe('DfsSlateGame', function() {
    it('should create an instance of DfsSlateGame', function() {
      ...
      //var instance = new SoccerV3Projections.DfsSlateGame();
      //expect(instance).to.be.a(SoccerV3Projections.DfsSlateGame);
    });
