...
* <pre>
* var SoccerV3Projections = require('index'); // See note below*.
* var xxxSvc = new SoccerV3Projections.XxxApi(); // Allocate the API class we're going to use.
* var yyyModel = new SoccerV3Projections.Yyy(); // Construct a model instance.
...
* <pre>
* var xxxSvc = new SoccerV3Projections.XxxApi(); // Allocate the API class we're going to use.
* var yyy = new SoccerV3Projections.Yyy(); // Construct a model instance.
* yyyModel.someProperty = 'someValue';
* ...
* var zzz = xxxSvc.doSomething(yyyModel); // Invoke the service.
* ...
