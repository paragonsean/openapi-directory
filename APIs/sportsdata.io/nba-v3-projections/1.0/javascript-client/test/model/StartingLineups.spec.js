...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NbaV3Projections.StartingLineups();
  });
  ...
  describe('StartingLineups', function() {
    it('should create an instance of StartingLineups', function() {
      ...
      //var instance = new NbaV3Projections.StartingLineups();
      //expect(instance).to.be.a(NbaV3Projections.StartingLineups);
    });

    it('should have the property awayLineup (base name: "AwayLineup")', function() {
      // uncomment below and update the code to test the property awayLineup
      //var instance = new NbaV3Projections.StartingLineups();
    ...
    it('should have the property homeLineup (base name: "HomeLineup")', function() {
      // uncomment below and update the code to test the property homeLineup
      //var instance = new NbaV3Projections.StartingLineups();
      //expect(instance).to.be();
    });
