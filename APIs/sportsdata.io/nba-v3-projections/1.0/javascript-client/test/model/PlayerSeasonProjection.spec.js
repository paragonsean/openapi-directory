...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NbaV3Projections.PlayerSeasonProjection();
  });
  ...
  describe('PlayerSeasonProjection', function() {
    it('should create an instance of PlayerSeasonProjection', function() {
      ...
      //var instance = new NbaV3Projections.PlayerSeasonProjection();
      //expect(instance).to.be.a(NbaV3Projections.PlayerSeasonProjection);
    });
