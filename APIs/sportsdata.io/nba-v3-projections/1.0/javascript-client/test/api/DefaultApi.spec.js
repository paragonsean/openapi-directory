...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NbaV3Projections.DefaultApi();
  });
  ...
  describe('DefaultApi', function() {
    ...
    describe('projectedPlayerSeasonStats', function() {
      it('should call projectedPlayerSeasonStats successfully', function(done) {
        //uncomment below and update the code to test projectedPlayerSeasonStats
        //instance.projectedPlayerSeasonStats(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('projectedPlayerSeasonStatsByPlayer', function() {
      it('should call projectedPlayerSeasonStatsByPlayer successfully', function(done) {
        //uncomment below and update the code to test projectedPlayerSeasonStatsByPlayer
        //instance.projectedPlayerSeasonStatsByPlayer(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('projectedPlayerSeasonStatsByTeam', function() {
      it('should call projectedPlayerSeasonStatsByTeam successfully', function(done) {
        //uncomment below and update the code to test projectedPlayerSeasonStatsByTeam
        //instance.projectedPlayerSeasonStatsByTeam(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
