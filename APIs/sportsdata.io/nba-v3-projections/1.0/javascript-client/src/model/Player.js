...
class Player {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('NbaDotComPlayerID')) {
                obj['NbaDotComPlayerID'] = ApiClient.convertToType(data['NbaDotComPlayerID'], 'Number');
            }
...
/**
 * @member {Number} NbaDotComPlayerID
 */
Player.prototype['NbaDotComPlayerID'] = undefined;
