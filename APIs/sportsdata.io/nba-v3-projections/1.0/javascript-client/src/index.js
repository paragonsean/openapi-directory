...
* <pre>
* var NbaV3Projections = require('index'); // See note below*.
* var xxxSvc = new NbaV3Projections.XxxApi(); // Allocate the API class we're going to use.
* var yyyModel = new NbaV3Projections.Yyy(); // Construct a model instance.
...
* <pre>
* var xxxSvc = new NbaV3Projections.XxxApi(); // Allocate the API class we're going to use.
* var yyy = new NbaV3Projections.Yyy(); // Construct a model instance.
* yyyModel.someProperty = 'someValue';
* ...
* var zzz = xxxSvc.doSomething(yyyModel); // Invoke the service.
* ...
...
export {
    ...
    /**
     * The StartingLineups model constructor.
     * @property {module:model/StartingLineups}
     */
    StartingLineups,
