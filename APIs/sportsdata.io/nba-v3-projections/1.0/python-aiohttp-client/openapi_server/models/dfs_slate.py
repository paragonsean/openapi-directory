...
class DfsSlate(Model):
    ...
    def __init__(self, dfs_slate_games: List[DfsSlateGame]=None, dfs_slate_players: List[DfsSlatePlayer]=None, is_multi_day_slate: bool=None, number_of_games: int=None, operator: str=None, operator_day: str=None, operator_game_type: str=None, operator_name: str=None, operator_slate_id: int=None, operator_start_time: str=None, removed_by_operator: bool=None, salary_cap: int=None, slate_id: int=None, slate_roster_slots: List[str]=None):
