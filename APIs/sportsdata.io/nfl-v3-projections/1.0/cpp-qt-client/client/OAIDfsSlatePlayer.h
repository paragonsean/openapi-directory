...
public:
    ...
    qint32 getFantasyDefenseProjectionStatId() const;
    void setFantasyDefenseProjectionStatId(const qint32 &fantasy_defense_projection_stat_id);
    bool is_fantasy_defense_projection_stat_id_Set() const;
    bool is_fantasy_defense_projection_stat_id_Valid() const;
...
private:
    ...
    qint32 m_fantasy_defense_projection_stat_id;
    bool m_fantasy_defense_projection_stat_id_isSet;
    bool m_fantasy_defense_projection_stat_id_isValid;
