...
OAISchedule OAIDfsSlateGame::getGame() const {
    return m_game;
}
void OAIDfsSlateGame::setGame(const OAISchedule &game) {
    m_game = game;
    m_game_isSet = true;
}
...
qint32 OAIDfsSlateGame::getScoreId() const {
    return m_score_id;
}
void OAIDfsSlateGame::setScoreId(const qint32 &score_id) {
    m_score_id = score_id;
    m_score_id_isSet = true;
}

bool OAIDfsSlateGame::is_score_id_Set() const{
    return m_score_id_isSet;
}

bool OAIDfsSlateGame::is_score_id_Valid() const{
