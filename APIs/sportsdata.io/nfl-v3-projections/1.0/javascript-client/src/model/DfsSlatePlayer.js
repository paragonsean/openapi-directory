...
class DfsSlatePlayer {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('FantasyDefenseProjectionStatID')) {
                obj['FantasyDefenseProjectionStatID'] = ApiClient.convertToType(data['FantasyDefenseProjectionStatID'], 'Number');
            }
...
/**
 * @member {Number} FantasyDefenseProjectionStatID
 */
DfsSlatePlayer.prototype['FantasyDefenseProjectionStatID'] = undefined;
