...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NflV3Projections.FantasyDefenseSeasonProjection();
  });
  ...
  describe('FantasyDefenseSeasonProjection', function() {
    it('should create an instance of FantasyDefenseSeasonProjection', function() {
      // uncomment below and update the code to test FantasyDefenseSeasonProjection
      //var instance = new NflV3Projections.FantasyDefenseSeasonProjection();
      //expect(instance).to.be.a(NflV3Projections.FantasyDefenseSeasonProjection);
    });
