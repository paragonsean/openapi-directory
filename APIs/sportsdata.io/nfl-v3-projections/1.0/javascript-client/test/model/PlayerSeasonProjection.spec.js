...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NflV3Projections.PlayerSeasonProjection();
  });
  ...
  describe('PlayerSeasonProjection', function() {
    it('should create an instance of PlayerSeasonProjection', function() {
      // uncomment below and update the code to test PlayerSeasonProjection
      //var instance = new NflV3Projections.PlayerSeasonProjection();
      //expect(instance).to.be.a(NflV3Projections.PlayerSeasonProjection);
    });
