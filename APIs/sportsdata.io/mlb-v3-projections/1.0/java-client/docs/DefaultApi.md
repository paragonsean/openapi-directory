...
> List&lt;PlayerGameProjection&gt; projectedPlayerGameStatsByPlayerWInjuriesDfsSalaries(format, date, playerid)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      List<PlayerGameProjection> result = apiInstance.projectedPlayerGameStatsByPlayerWInjuriesDfsSalaries(format, date, playerid);
      System.out.println(result);
    } catch (ApiException e) {
...
<a id="projectedPlayerSeasonStatsWithAdp"></a>
# **projectedPlayerSeasonStatsWithAdp**
> List&lt;PlayerSeasonProjection&gt; projectedPlayerSeasonStatsWithAdp(format, season)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      List<PlayerSeasonProjection> result = apiInstance.projectedPlayerSeasonStatsWithAdp(format, season);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling DefaultApi#projectedPlayerSeasonStatsWithAdp");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
