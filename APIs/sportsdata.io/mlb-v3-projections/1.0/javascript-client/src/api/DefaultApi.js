...
export default class DefaultApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the projectedPlayerSeasonStatsWithAdp operation.
     * @callback module:api/DefaultApi~projectedPlayerSeasonStatsWithAdpCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:api/DefaultApi~projectedPlayerSeasonStatsWithAdpCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Array.<module:model/PlayerSeasonProjection>}
     */
    projectedPlayerSeasonStatsWithAdp(format, season, callback) {
      let postBody = null;
      // verify the required parameter 'format' is set
      if (format === undefined || format === null) {
        throw new Error("Missing the required parameter 'format' when calling projectedPlayerSeasonStatsWithAdp");
      }
      // verify the required parameter 'season' is set
      if (season === undefined || season === null) {
        throw new Error("Missing the required parameter 'season' when calling projectedPlayerSeasonStatsWithAdp");
      }
