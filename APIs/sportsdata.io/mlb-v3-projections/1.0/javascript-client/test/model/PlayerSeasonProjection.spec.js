...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MlbV3Projections.PlayerSeasonProjection();
  });
  ...
  describe('PlayerSeasonProjection', function() {
    it('should create an instance of PlayerSeasonProjection', function() {
      ...
      //var instance = new MlbV3Projections.PlayerSeasonProjection();
      //expect(instance).to.be.a(MlbV3Projections.PlayerSeasonProjection);
    });
