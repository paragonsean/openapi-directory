# NflV3RotoBallerArticles.DefaultApi

All URIs are relative to *http://azure-api.sportsdata.io/v3/nfl/articles-rotoballer*
...
```javascript
import NflV3RotoBallerArticles from 'nfl_v3_roto_baller_articles';
let defaultClient = NflV3RotoBallerArticles.ApiClient.instance;
...
let apiInstance = new NflV3RotoBallerArticles.DefaultApi();
