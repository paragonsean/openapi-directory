...
class Player(Model):
    ...
    def __init__(self, bat_hand: str=None, birth_city: str=None, birth_country: str=None, birth_date: str=None, birth_state: str=None, college: str=None, draft_kings_name: str=None, draft_kings_player_id: int=None, experience: str=None, fan_duel_name: str=None, fan_duel_player_id: int=None, fantasy_alarm_player_id: int=None, fantasy_draft_name: str=None, fantasy_draft_player_id: int=None, first_name: str=None, global_team_id: int=None, height: int=None, high_school: str=None, injury_body_part: str=None, injury_notes: str=None, injury_start_date: str=None, injury_status: str=None, jersey: int=None, last_name: str=None, mlbamid: int=None, photo_url: str=None, player_id: int=None, position: str=None, position_category: str=None, pro_debut: str=None, roto_wire_player_id: int=None, rotoworld_player_id: int=None, salary: int=None, sport_radar_player_id: str=None, sports_data_id: str=None, sports_direct_player_id: int=None, stats_player_id: int=None, status: str=None, team: str=None, team_id: int=None, throw_hand: str=None, upcoming_game_id: int=None, usa_today_headshot_no_background_updated: str=None, usa_today_headshot_no_background_url: str=None, usa_today_headshot_updated: str=None, usa_today_headshot_url: str=None, usa_today_player_id: int=None, weight: int=None, xml_team_player_id: int=None, yahoo_name: str=None, yahoo_player_id: int=None):
        """Player - a model defined in OpenAPI

        :param bat_hand: The bat_hand of this Player.
        ...
        :param mlbamid: The mlbamid of this Player.
        ...
        :param pro_debut: The pro_debut of this Player.
        ...
        :param throw_hand: The throw_hand of this Player.
        :param upcoming_game_id: The upcoming_game_id of this Player.
        ...
        self._upcoming_game_id = upcoming_game_id
    ...
    @property
    def bat_hand(self):
        """Gets the bat_hand of this Player.


        :return: The bat_hand of this Player.
        :rtype: str
        """
    ...
    def bat_hand(self, bat_hand):
        """Sets the bat_hand of this Player.
    ...
    @property
    def mlbamid(self):
        """Gets the mlbamid of this Player.


        :return: The mlbamid of this Player.
        :rtype: int
        """
        return self._mlbamid

    @mlbamid.setter
    def mlbamid(self, mlbamid):
        """Sets the mlbamid of this Player.
    ...
    @property
    def pro_debut(self):
        """Gets the pro_debut of this Player.


        :return: The pro_debut of this Player.
        :rtype: str
        """
        return self._pro_debut

    @pro_debut.setter
    def pro_debut(self, pro_debut):
        """Sets the pro_debut of this Player.
    ...
    @property
    def throw_hand(self):
        """Gets the throw_hand of this Player.


        :return: The throw_hand of this Player.
        :rtype: str
        """
    ...
    def throw_hand(self, throw_hand):
        """Sets the throw_hand of this Player.
    ...
    @property
    def upcoming_game_id(self):
        """Gets the upcoming_game_id of this Player.


        :return: The upcoming_game_id of this Player.
        :rtype: int
        """
        return self._upcoming_game_id

    @upcoming_game_id.setter
    def upcoming_game_id(self, upcoming_game_id):
        """Sets the upcoming_game_id of this Player.


        :param upcoming_game_id: The upcoming_game_id of this Player.
        :type upcoming_game_id: int
        """
