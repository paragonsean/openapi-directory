...
QString OAIPlayerBasic::getBatHand() const {
    return m_bat_hand;
}
void OAIPlayerBasic::setBatHand(const QString &bat_hand) {
    m_bat_hand = bat_hand;
    m_bat_hand_isSet = true;
}

bool OAIPlayerBasic::is_bat_hand_Set() const{
    return m_bat_hand_isSet;
}

bool OAIPlayerBasic::is_bat_hand_Valid() const{
...
QString OAIPlayerBasic::getThrowHand() const {
    return m_throw_hand;
}
void OAIPlayerBasic::setThrowHand(const QString &throw_hand) {
    m_throw_hand = throw_hand;
    m_throw_hand_isSet = true;
}

bool OAIPlayerBasic::is_throw_hand_Set() const{
    return m_throw_hand_isSet;
}

bool OAIPlayerBasic::is_throw_hand_Valid() const{
