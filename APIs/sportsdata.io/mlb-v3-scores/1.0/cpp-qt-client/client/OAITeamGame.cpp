...
double OAITeamGame::getAtBats() const {
    return m_at_bats;
}
void OAITeamGame::setAtBats(const double &at_bats) {
    m_at_bats = at_bats;
    m_at_bats_isSet = true;
}

bool OAITeamGame::is_at_bats_Set() const{
    return m_at_bats_isSet;
}

bool OAITeamGame::is_at_bats_Valid() const{
    return m_at_bats_isValid;
}

double OAITeamGame::getBallsInPlay() const {
    return m_balls_in_play;
}
void OAITeamGame::setBallsInPlay(const double &balls_in_play) {
    m_balls_in_play = balls_in_play;
    m_balls_in_play_isSet = true;
}

bool OAITeamGame::is_balls_in_play_Set() const{
    return m_balls_in_play_isSet;
}

bool OAITeamGame::is_balls_in_play_Valid() const{
    return m_balls_in_play_isValid;
}

double OAITeamGame::getBattingAverage() const {
    return m_batting_average;
}
void OAITeamGame::setBattingAverage(const double &batting_average) {
    m_batting_average = batting_average;
    m_batting_average_isSet = true;
}

bool OAITeamGame::is_batting_average_Set() const{
    return m_batting_average_isSet;
}

bool OAITeamGame::is_batting_average_Valid() const{
    return m_batting_average_isValid;
}

double OAITeamGame::getBattingAverageOnBallsInPlay() const {
    return m_batting_average_on_balls_in_play;
}
void OAITeamGame::setBattingAverageOnBallsInPlay(const double &batting_average_on_balls_in_play) {
    m_batting_average_on_balls_in_play = batting_average_on_balls_in_play;
    m_batting_average_on_balls_in_play_isSet = true;
}

bool OAITeamGame::is_batting_average_on_balls_in_play_Set() const{
    return m_batting_average_on_balls_in_play_isSet;
}

bool OAITeamGame::is_batting_average_on_balls_in_play_Valid() const{
    return m_batting_average_on_balls_in_play_isValid;
}

bool OAITeamGame::isBattingOrderConfirmed() const {
    return m_batting_order_confirmed;
}
void OAITeamGame::setBattingOrderConfirmed(const bool &batting_order_confirmed) {
    m_batting_order_confirmed = batting_order_confirmed;
    m_batting_order_confirmed_isSet = true;
}

bool OAITeamGame::is_batting_order_confirmed_Set() const{
    return m_batting_order_confirmed_isSet;
}

bool OAITeamGame::is_batting_order_confirmed_Valid() const{
    return m_batting_order_confirmed_isValid;
}

double OAITeamGame::getCaughtStealing() const {
    return m_caught_stealing;
}
void OAITeamGame::setCaughtStealing(const double &caught_stealing) {
    m_caught_stealing = caught_stealing;
    m_caught_stealing_isSet = true;
}

bool OAITeamGame::is_caught_stealing_Set() const{
    return m_caught_stealing_isSet;
}

bool OAITeamGame::is_caught_stealing_Valid() const{
...
double OAITeamGame::getDoublePlays() const {
    return m_double_plays;
}
void OAITeamGame::setDoublePlays(const double &double_plays) {
    m_double_plays = double_plays;
    m_double_plays_isSet = true;
}

bool OAITeamGame::is_double_plays_Set() const{
    return m_double_plays_isSet;
}

bool OAITeamGame::is_double_plays_Valid() const{
    return m_double_plays_isValid;
}

double OAITeamGame::getDoubles() const {
    return m_doubles;
}
void OAITeamGame::setDoubles(const double &doubles) {
    m_doubles = doubles;
    m_doubles_isSet = true;
}

bool OAITeamGame::is_doubles_Set() const{
    return m_doubles_isSet;
}

bool OAITeamGame::is_doubles_Valid() const{
    return m_doubles_isValid;
}

double OAITeamGame::getEarnedRunAverage() const {
    return m_earned_run_average;
}
void OAITeamGame::setEarnedRunAverage(const double &earned_run_average) {
    m_earned_run_average = earned_run_average;
    m_earned_run_average_isSet = true;
}

bool OAITeamGame::is_earned_run_average_Set() const{
    return m_earned_run_average_isSet;
}

bool OAITeamGame::is_earned_run_average_Valid() const{
    return m_earned_run_average_isValid;
}

double OAITeamGame::getErrors() const {
    return m_errors;
}
void OAITeamGame::setErrors(const double &errors) {
    m_errors = errors;
    m_errors_isSet = true;
}

bool OAITeamGame::is_errors_Set() const{
    return m_errors_isSet;
}

bool OAITeamGame::is_errors_Valid() const{
...
double OAITeamGame::getFantasyPointsBatting() const {
    return m_fantasy_points_batting;
}
void OAITeamGame::setFantasyPointsBatting(const double &fantasy_points_batting) {
    m_fantasy_points_batting = fantasy_points_batting;
    m_fantasy_points_batting_isSet = true;
}

bool OAITeamGame::is_fantasy_points_batting_Set() const{
    return m_fantasy_points_batting_isSet;
}

bool OAITeamGame::is_fantasy_points_batting_Valid() const{
...
double OAITeamGame::getFantasyPointsPitching() const {
    return m_fantasy_points_pitching;
}
void OAITeamGame::setFantasyPointsPitching(const double &fantasy_points_pitching) {
    m_fantasy_points_pitching = fantasy_points_pitching;
    m_fantasy_points_pitching_isSet = true;
}

bool OAITeamGame::is_fantasy_points_pitching_Set() const{
    return m_fantasy_points_pitching_isSet;
}

bool OAITeamGame::is_fantasy_points_pitching_Valid() const{
...
double OAITeamGame::getFieldingIndependentPitching() const {
    return m_fielding_independent_pitching;
}
void OAITeamGame::setFieldingIndependentPitching(const double &fielding_independent_pitching) {
    m_fielding_independent_pitching = fielding_independent_pitching;
    m_fielding_independent_pitching_isSet = true;
}

bool OAITeamGame::is_fielding_independent_pitching_Set() const{
    return m_fielding_independent_pitching_isSet;
}

bool OAITeamGame::is_fielding_independent_pitching_Valid() const{
    return m_fielding_independent_pitching_isValid;
}

double OAITeamGame::getFlyOuts() const {
    return m_fly_outs;
}
void OAITeamGame::setFlyOuts(const double &fly_outs) {
    m_fly_outs = fly_outs;
    m_fly_outs_isSet = true;
}

bool OAITeamGame::is_fly_outs_Set() const{
    return m_fly_outs_isSet;
}

bool OAITeamGame::is_fly_outs_Valid() const{
...
double OAITeamGame::getGrandSlams() const {
    return m_grand_slams;
}
void OAITeamGame::setGrandSlams(const double &grand_slams) {
    m_grand_slams = grand_slams;
    m_grand_slams_isSet = true;
}

bool OAITeamGame::is_grand_slams_Set() const{
    return m_grand_slams_isSet;
}

bool OAITeamGame::is_grand_slams_Valid() const{
    return m_grand_slams_isValid;
}

double OAITeamGame::getGroundIntoDoublePlay() const {
    return m_ground_into_double_play;
}
void OAITeamGame::setGroundIntoDoublePlay(const double &ground_into_double_play) {
    m_ground_into_double_play = ground_into_double_play;
    m_ground_into_double_play_isSet = true;
}

bool OAITeamGame::is_ground_into_double_play_Set() const{
    return m_ground_into_double_play_isSet;
}

bool OAITeamGame::is_ground_into_double_play_Valid() const{
    return m_ground_into_double_play_isValid;
}

double OAITeamGame::getGroundOuts() const {
    return m_ground_outs;
}
void OAITeamGame::setGroundOuts(const double &ground_outs) {
    m_ground_outs = ground_outs;
    m_ground_outs_isSet = true;
}

bool OAITeamGame::is_ground_outs_Set() const{
    return m_ground_outs_isSet;
}

bool OAITeamGame::is_ground_outs_Valid() const{
    return m_ground_outs_isValid;
}

double OAITeamGame::getHitByPitch() const {
    return m_hit_by_pitch;
}
void OAITeamGame::setHitByPitch(const double &hit_by_pitch) {
    m_hit_by_pitch = hit_by_pitch;
    m_hit_by_pitch_isSet = true;
}

bool OAITeamGame::is_hit_by_pitch_Set() const{
    return m_hit_by_pitch_isSet;
}

bool OAITeamGame::is_hit_by_pitch_Valid() const{
...
double OAITeamGame::getHomeRuns() const {
    return m_home_runs;
}
void OAITeamGame::setHomeRuns(const double &home_runs) {
    m_home_runs = home_runs;
    m_home_runs_isSet = true;
}

bool OAITeamGame::is_home_runs_Set() const{
    return m_home_runs_isSet;
}

bool OAITeamGame::is_home_runs_Valid() const{
    return m_home_runs_isValid;
}

double OAITeamGame::getInningsPitchedDecimal() const {
    return m_innings_pitched_decimal;
}
void OAITeamGame::setInningsPitchedDecimal(const double &innings_pitched_decimal) {
    m_innings_pitched_decimal = innings_pitched_decimal;
    m_innings_pitched_decimal_isSet = true;
}

bool OAITeamGame::is_innings_pitched_decimal_Set() const{
    return m_innings_pitched_decimal_isSet;
}

bool OAITeamGame::is_innings_pitched_decimal_Valid() const{
    return m_innings_pitched_decimal_isValid;
}

double OAITeamGame::getInningsPitchedFull() const {
    return m_innings_pitched_full;
}
void OAITeamGame::setInningsPitchedFull(const double &innings_pitched_full) {
    m_innings_pitched_full = innings_pitched_full;
    m_innings_pitched_full_isSet = true;
}

bool OAITeamGame::is_innings_pitched_full_Set() const{
    return m_innings_pitched_full_isSet;
}

bool OAITeamGame::is_innings_pitched_full_Valid() const{
    return m_innings_pitched_full_isValid;
}

double OAITeamGame::getInningsPitchedOuts() const {
    return m_innings_pitched_outs;
}
void OAITeamGame::setInningsPitchedOuts(const double &innings_pitched_outs) {
    m_innings_pitched_outs = innings_pitched_outs;
    m_innings_pitched_outs_isSet = true;
}

bool OAITeamGame::is_innings_pitched_outs_Set() const{
    return m_innings_pitched_outs_isSet;
}

bool OAITeamGame::is_innings_pitched_outs_Valid() const{
    return m_innings_pitched_outs_isValid;
}

double OAITeamGame::getIntentionalWalks() const {
    return m_intentional_walks;
}
void OAITeamGame::setIntentionalWalks(const double &intentional_walks) {
    m_intentional_walks = intentional_walks;
    m_intentional_walks_isSet = true;
}

bool OAITeamGame::is_intentional_walks_Set() const{
    return m_intentional_walks_isSet;
}

bool OAITeamGame::is_intentional_walks_Valid() const{
...
double OAITeamGame::getIsolatedPower() const {
    return m_isolated_power;
}
void OAITeamGame::setIsolatedPower(const double &isolated_power) {
    m_isolated_power = isolated_power;
    m_isolated_power_isSet = true;
}

bool OAITeamGame::is_isolated_power_Set() const{
    return m_isolated_power_isSet;
}

bool OAITeamGame::is_isolated_power_Valid() const{
    return m_isolated_power_isValid;
}

double OAITeamGame::getLeftOnBase() const {
    return m_left_on_base;
}
void OAITeamGame::setLeftOnBase(const double &left_on_base) {
    m_left_on_base = left_on_base;
    m_left_on_base_isSet = true;
}

bool OAITeamGame::is_left_on_base_Set() const{
    return m_left_on_base_isSet;
}

bool OAITeamGame::is_left_on_base_Valid() const{
    return m_left_on_base_isValid;
}

double OAITeamGame::getLineOuts() const {
    return m_line_outs;
}
void OAITeamGame::setLineOuts(const double &line_outs) {
    m_line_outs = line_outs;
    m_line_outs_isSet = true;
}

bool OAITeamGame::is_line_outs_Set() const{
    return m_line_outs_isSet;
}

bool OAITeamGame::is_line_outs_Valid() const{
    return m_line_outs_isValid;
}

double OAITeamGame::getLosses() const {
    return m_losses;
}
void OAITeamGame::setLosses(const double &losses) {
    m_losses = losses;
    m_losses_isSet = true;
}
...
double OAITeamGame::getOnBasePercentage() const {
    return m_on_base_percentage;
}
void OAITeamGame::setOnBasePercentage(const double &on_base_percentage) {
    m_on_base_percentage = on_base_percentage;
    m_on_base_percentage_isSet = true;
}

bool OAITeamGame::is_on_base_percentage_Set() const{
    return m_on_base_percentage_isSet;
}

bool OAITeamGame::is_on_base_percentage_Valid() const{
    return m_on_base_percentage_isValid;
}

double OAITeamGame::getOnBasePlusSlugging() const {
    return m_on_base_plus_slugging;
}
void OAITeamGame::setOnBasePlusSlugging(const double &on_base_plus_slugging) {
    m_on_base_plus_slugging = on_base_plus_slugging;
    m_on_base_plus_slugging_isSet = true;
}

bool OAITeamGame::is_on_base_plus_slugging_Set() const{
    return m_on_base_plus_slugging_isSet;
}

bool OAITeamGame::is_on_base_plus_slugging_Valid() const{
...
double OAITeamGame::getOuts() const {
    return m_outs;
}
void OAITeamGame::setOuts(const double &outs) {
    m_outs = outs;
    m_outs_isSet = true;
}

bool OAITeamGame::is_outs_Set() const{
    return m_outs_isSet;
}

bool OAITeamGame::is_outs_Valid() const{
    return m_outs_isValid;
}

double OAITeamGame::getPitchesSeen() const {
    return m_pitches_seen;
}
void OAITeamGame::setPitchesSeen(const double &pitches_seen) {
    m_pitches_seen = pitches_seen;
    m_pitches_seen_isSet = true;
}

bool OAITeamGame::is_pitches_seen_Set() const{
    return m_pitches_seen_isSet;
}

bool OAITeamGame::is_pitches_seen_Valid() const{
    return m_pitches_seen_isValid;
}

double OAITeamGame::getPitchesThrown() const {
    return m_pitches_thrown;
}
void OAITeamGame::setPitchesThrown(const double &pitches_thrown) {
    m_pitches_thrown = pitches_thrown;
    m_pitches_thrown_isSet = true;
}

bool OAITeamGame::is_pitches_thrown_Set() const{
    return m_pitches_thrown_isSet;
}

bool OAITeamGame::is_pitches_thrown_Valid() const{
    return m_pitches_thrown_isValid;
}

double OAITeamGame::getPitchesThrownStrikes() const {
    return m_pitches_thrown_strikes;
}
void OAITeamGame::setPitchesThrownStrikes(const double &pitches_thrown_strikes) {
    m_pitches_thrown_strikes = pitches_thrown_strikes;
    m_pitches_thrown_strikes_isSet = true;
}

bool OAITeamGame::is_pitches_thrown_strikes_Set() const{
    return m_pitches_thrown_strikes_isSet;
}

bool OAITeamGame::is_pitches_thrown_strikes_Valid() const{
    return m_pitches_thrown_strikes_isValid;
}

double OAITeamGame::getPitchingBallsInPlay() const {
    return m_pitching_balls_in_play;
}
void OAITeamGame::setPitchingBallsInPlay(const double &pitching_balls_in_play) {
    m_pitching_balls_in_play = pitching_balls_in_play;
    m_pitching_balls_in_play_isSet = true;
}

bool OAITeamGame::is_pitching_balls_in_play_Set() const{
    return m_pitching_balls_in_play_isSet;
}

bool OAITeamGame::is_pitching_balls_in_play_Valid() const{
    return m_pitching_balls_in_play_isValid;
}

double OAITeamGame::getPitchingBattingAverageAgainst() const {
    return m_pitching_batting_average_against;
}
void OAITeamGame::setPitchingBattingAverageAgainst(const double &pitching_batting_average_against) {
    m_pitching_batting_average_against = pitching_batting_average_against;
    m_pitching_batting_average_against_isSet = true;
}

bool OAITeamGame::is_pitching_batting_average_against_Set() const{
    return m_pitching_batting_average_against_isSet;
}

bool OAITeamGame::is_pitching_batting_average_against_Valid() const{
    return m_pitching_batting_average_against_isValid;
}

double OAITeamGame::getPitchingBattingAverageOnBallsInPlay() const {
    return m_pitching_batting_average_on_balls_in_play;
}
void OAITeamGame::setPitchingBattingAverageOnBallsInPlay(const double &pitching_batting_average_on_balls_in_play) {
...
bool OAITeamGame::is_pitching_batting_average_on_balls_in_play_Set() const{
    return m_pitching_batting_average_on_balls_in_play_isSet;
}

bool OAITeamGame::is_pitching_batting_average_on_balls_in_play_Valid() const{
    return m_pitching_batting_average_on_balls_in_play_isValid;
}

double OAITeamGame::getPitchingBlownSaves() const {
    return m_pitching_blown_saves;
}
void OAITeamGame::setPitchingBlownSaves(const double &pitching_blown_saves) {
    m_pitching_blown_saves = pitching_blown_saves;
    m_pitching_blown_saves_isSet = true;
}

bool OAITeamGame::is_pitching_blown_saves_Set() const{
    return m_pitching_blown_saves_isSet;
}

bool OAITeamGame::is_pitching_blown_saves_Valid() const{
    return m_pitching_blown_saves_isValid;
}

double OAITeamGame::getPitchingCatchersInterference() const {
    return m_pitching_catchers_interference;
}
void OAITeamGame::setPitchingCatchersInterference(const double &pitching_catchers_interference) {
    m_pitching_catchers_interference = pitching_catchers_interference;
    m_pitching_catchers_interference_isSet = true;
}

bool OAITeamGame::is_pitching_catchers_interference_Set() const{
    return m_pitching_catchers_interference_isSet;
}

bool OAITeamGame::is_pitching_catchers_interference_Valid() const{
    return m_pitching_catchers_interference_isValid;
}

double OAITeamGame::getPitchingCompleteGames() const {
    return m_pitching_complete_games;
}
void OAITeamGame::setPitchingCompleteGames(const double &pitching_complete_games) {
    m_pitching_complete_games = pitching_complete_games;
    m_pitching_complete_games_isSet = true;
}

bool OAITeamGame::is_pitching_complete_games_Set() const{
    return m_pitching_complete_games_isSet;
}

bool OAITeamGame::is_pitching_complete_games_Valid() const{
    return m_pitching_complete_games_isValid;
}

double OAITeamGame::getPitchingDoublePlays() const {
    return m_pitching_double_plays;
}
void OAITeamGame::setPitchingDoublePlays(const double &pitching_double_plays) {
    m_pitching_double_plays = pitching_double_plays;
    m_pitching_double_plays_isSet = true;
}

bool OAITeamGame::is_pitching_double_plays_Set() const{
    return m_pitching_double_plays_isSet;
}

bool OAITeamGame::is_pitching_double_plays_Valid() const{
    return m_pitching_double_plays_isValid;
}

double OAITeamGame::getPitchingDoubles() const {
    return m_pitching_doubles;
}
void OAITeamGame::setPitchingDoubles(const double &pitching_doubles) {
    m_pitching_doubles = pitching_doubles;
    m_pitching_doubles_isSet = true;
}

bool OAITeamGame::is_pitching_doubles_Set() const{
    return m_pitching_doubles_isSet;
}

bool OAITeamGame::is_pitching_doubles_Valid() const{
    return m_pitching_doubles_isValid;
}

double OAITeamGame::getPitchingEarnedRuns() const {
    return m_pitching_earned_runs;
}
void OAITeamGame::setPitchingEarnedRuns(const double &pitching_earned_runs) {
    m_pitching_earned_runs = pitching_earned_runs;
    m_pitching_earned_runs_isSet = true;
}

bool OAITeamGame::is_pitching_earned_runs_Set() const{
    return m_pitching_earned_runs_isSet;
}

bool OAITeamGame::is_pitching_earned_runs_Valid() const{
    return m_pitching_earned_runs_isValid;
}

double OAITeamGame::getPitchingFlyOuts() const {
    return m_pitching_fly_outs;
}
void OAITeamGame::setPitchingFlyOuts(const double &pitching_fly_outs) {
    m_pitching_fly_outs = pitching_fly_outs;
    m_pitching_fly_outs_isSet = true;
}

bool OAITeamGame::is_pitching_fly_outs_Set() const{
    return m_pitching_fly_outs_isSet;
}

bool OAITeamGame::is_pitching_fly_outs_Valid() const{
    return m_pitching_fly_outs_isValid;
}

double OAITeamGame::getPitchingGrandSlams() const {
    return m_pitching_grand_slams;
}
void OAITeamGame::setPitchingGrandSlams(const double &pitching_grand_slams) {
    m_pitching_grand_slams = pitching_grand_slams;
    m_pitching_grand_slams_isSet = true;
}

bool OAITeamGame::is_pitching_grand_slams_Set() const{
    return m_pitching_grand_slams_isSet;
}

bool OAITeamGame::is_pitching_grand_slams_Valid() const{
    return m_pitching_grand_slams_isValid;
}

double OAITeamGame::getPitchingGroundIntoDoublePlay() const {
    return m_pitching_ground_into_double_play;
}
void OAITeamGame::setPitchingGroundIntoDoublePlay(const double &pitching_ground_into_double_play) {
    m_pitching_ground_into_double_play = pitching_ground_into_double_play;
    m_pitching_ground_into_double_play_isSet = true;
}

bool OAITeamGame::is_pitching_ground_into_double_play_Set() const{
    return m_pitching_ground_into_double_play_isSet;
}

bool OAITeamGame::is_pitching_ground_into_double_play_Valid() const{
    return m_pitching_ground_into_double_play_isValid;
}

double OAITeamGame::getPitchingGroundOuts() const {
    return m_pitching_ground_outs;
}
void OAITeamGame::setPitchingGroundOuts(const double &pitching_ground_outs) {
    m_pitching_ground_outs = pitching_ground_outs;
    m_pitching_ground_outs_isSet = true;
}

bool OAITeamGame::is_pitching_ground_outs_Set() const{
    return m_pitching_ground_outs_isSet;
}

bool OAITeamGame::is_pitching_ground_outs_Valid() const{
    return m_pitching_ground_outs_isValid;
}

double OAITeamGame::getPitchingHitByPitch() const {
    return m_pitching_hit_by_pitch;
}
void OAITeamGame::setPitchingHitByPitch(const double &pitching_hit_by_pitch) {
    m_pitching_hit_by_pitch = pitching_hit_by_pitch;
    m_pitching_hit_by_pitch_isSet = true;
}

bool OAITeamGame::is_pitching_hit_by_pitch_Set() const{
    return m_pitching_hit_by_pitch_isSet;
}

bool OAITeamGame::is_pitching_hit_by_pitch_Valid() const{
    return m_pitching_hit_by_pitch_isValid;
}

double OAITeamGame::getPitchingHits() const {
    return m_pitching_hits;
}
void OAITeamGame::setPitchingHits(const double &pitching_hits) {
    m_pitching_hits = pitching_hits;
    m_pitching_hits_isSet = true;
}

bool OAITeamGame::is_pitching_hits_Set() const{
    return m_pitching_hits_isSet;
}

bool OAITeamGame::is_pitching_hits_Valid() const{
    return m_pitching_hits_isValid;
}

double OAITeamGame::getPitchingHolds() const {
    return m_pitching_holds;
}
void OAITeamGame::setPitchingHolds(const double &pitching_holds) {
    m_pitching_holds = pitching_holds;
    m_pitching_holds_isSet = true;
}

bool OAITeamGame::is_pitching_holds_Set() const{
    return m_pitching_holds_isSet;
}

bool OAITeamGame::is_pitching_holds_Valid() const{
    return m_pitching_holds_isValid;
}

double OAITeamGame::getPitchingHomeRuns() const {
    return m_pitching_home_runs;
}
void OAITeamGame::setPitchingHomeRuns(const double &pitching_home_runs) {
    m_pitching_home_runs = pitching_home_runs;
    m_pitching_home_runs_isSet = true;
}

bool OAITeamGame::is_pitching_home_runs_Set() const{
    return m_pitching_home_runs_isSet;
}

bool OAITeamGame::is_pitching_home_runs_Valid() const{
    return m_pitching_home_runs_isValid;
}

qint32 OAITeamGame::getPitchingInningStarted() const {
    return m_pitching_inning_started;
}
void OAITeamGame::setPitchingInningStarted(const qint32 &pitching_inning_started) {
    m_pitching_inning_started = pitching_inning_started;
    m_pitching_inning_started_isSet = true;
}

bool OAITeamGame::is_pitching_inning_started_Set() const{
    return m_pitching_inning_started_isSet;
}

bool OAITeamGame::is_pitching_inning_started_Valid() const{
    return m_pitching_inning_started_isValid;
}

double OAITeamGame::getPitchingIntentionalWalks() const {
    return m_pitching_intentional_walks;
}
void OAITeamGame::setPitchingIntentionalWalks(const double &pitching_intentional_walks) {
    m_pitching_intentional_walks = pitching_intentional_walks;
    m_pitching_intentional_walks_isSet = true;
}

bool OAITeamGame::is_pitching_intentional_walks_Set() const{
    return m_pitching_intentional_walks_isSet;
}

bool OAITeamGame::is_pitching_intentional_walks_Valid() const{
    return m_pitching_intentional_walks_isValid;
}

double OAITeamGame::getPitchingLineOuts() const {
    return m_pitching_line_outs;
}
void OAITeamGame::setPitchingLineOuts(const double &pitching_line_outs) {
    m_pitching_line_outs = pitching_line_outs;
    m_pitching_line_outs_isSet = true;
}

bool OAITeamGame::is_pitching_line_outs_Set() const{
    return m_pitching_line_outs_isSet;
}

bool OAITeamGame::is_pitching_line_outs_Valid() const{
    return m_pitching_line_outs_isValid;
}

double OAITeamGame::getPitchingNoHitters() const {
    return m_pitching_no_hitters;
}
void OAITeamGame::setPitchingNoHitters(const double &pitching_no_hitters) {
    m_pitching_no_hitters = pitching_no_hitters;
    m_pitching_no_hitters_isSet = true;
}

bool OAITeamGame::is_pitching_no_hitters_Set() const{
    return m_pitching_no_hitters_isSet;
}

bool OAITeamGame::is_pitching_no_hitters_Valid() const{
    return m_pitching_no_hitters_isValid;
}

double OAITeamGame::getPitchingOnBasePercentage() const {
    return m_pitching_on_base_percentage;
}
void OAITeamGame::setPitchingOnBasePercentage(const double &pitching_on_base_percentage) {
    m_pitching_on_base_percentage = pitching_on_base_percentage;
    m_pitching_on_base_percentage_isSet = true;
}

bool OAITeamGame::is_pitching_on_base_percentage_Set() const{
    return m_pitching_on_base_percentage_isSet;
}

bool OAITeamGame::is_pitching_on_base_percentage_Valid() const{
    return m_pitching_on_base_percentage_isValid;
}

double OAITeamGame::getPitchingOnBasePlusSlugging() const {
    return m_pitching_on_base_plus_slugging;
}
void OAITeamGame::setPitchingOnBasePlusSlugging(const double &pitching_on_base_plus_slugging) {
    m_pitching_on_base_plus_slugging = pitching_on_base_plus_slugging;
    m_pitching_on_base_plus_slugging_isSet = true;
}

bool OAITeamGame::is_pitching_on_base_plus_slugging_Set() const{
    return m_pitching_on_base_plus_slugging_isSet;
}

bool OAITeamGame::is_pitching_on_base_plus_slugging_Valid() const{
    return m_pitching_on_base_plus_slugging_isValid;
}

double OAITeamGame::getPitchingPerfectGames() const {
    return m_pitching_perfect_games;
}
void OAITeamGame::setPitchingPerfectGames(const double &pitching_perfect_games) {
    m_pitching_perfect_games = pitching_perfect_games;
    m_pitching_perfect_games_isSet = true;
}

bool OAITeamGame::is_pitching_perfect_games_Set() const{
    return m_pitching_perfect_games_isSet;
}

bool OAITeamGame::is_pitching_perfect_games_Valid() const{
    return m_pitching_perfect_games_isValid;
}

double OAITeamGame::getPitchingPlateAppearances() const {
    return m_pitching_plate_appearances;
}
void OAITeamGame::setPitchingPlateAppearances(const double &pitching_plate_appearances) {
    m_pitching_plate_appearances = pitching_plate_appearances;
    m_pitching_plate_appearances_isSet = true;
}

bool OAITeamGame::is_pitching_plate_appearances_Set() const{
    return m_pitching_plate_appearances_isSet;
}

bool OAITeamGame::is_pitching_plate_appearances_Valid() const{
    return m_pitching_plate_appearances_isValid;
}

double OAITeamGame::getPitchingPopOuts() const {
    return m_pitching_pop_outs;
}
void OAITeamGame::setPitchingPopOuts(const double &pitching_pop_outs) {
    m_pitching_pop_outs = pitching_pop_outs;
    m_pitching_pop_outs_isSet = true;
}

bool OAITeamGame::is_pitching_pop_outs_Set() const{
    return m_pitching_pop_outs_isSet;
}

bool OAITeamGame::is_pitching_pop_outs_Valid() const{
    return m_pitching_pop_outs_isValid;
}

double OAITeamGame::getPitchingQualityStarts() const {
    return m_pitching_quality_starts;
}
void OAITeamGame::setPitchingQualityStarts(const double &pitching_quality_starts) {
    m_pitching_quality_starts = pitching_quality_starts;
    m_pitching_quality_starts_isSet = true;
}

bool OAITeamGame::is_pitching_quality_starts_Set() const{
    return m_pitching_quality_starts_isSet;
}

bool OAITeamGame::is_pitching_quality_starts_Valid() const{
    return m_pitching_quality_starts_isValid;
}

double OAITeamGame::getPitchingReachedOnError() const {
    return m_pitching_reached_on_error;
}
void OAITeamGame::setPitchingReachedOnError(const double &pitching_reached_on_error) {
    m_pitching_reached_on_error = pitching_reached_on_error;
    m_pitching_reached_on_error_isSet = true;
}

bool OAITeamGame::is_pitching_reached_on_error_Set() const{
    return m_pitching_reached_on_error_isSet;
}

bool OAITeamGame::is_pitching_reached_on_error_Valid() const{
    return m_pitching_reached_on_error_isValid;
}

double OAITeamGame::getPitchingRuns() const {
    return m_pitching_runs;
}
void OAITeamGame::setPitchingRuns(const double &pitching_runs) {
    m_pitching_runs = pitching_runs;
    m_pitching_runs_isSet = true;
}

bool OAITeamGame::is_pitching_runs_Set() const{
    return m_pitching_runs_isSet;
}

bool OAITeamGame::is_pitching_runs_Valid() const{
    return m_pitching_runs_isValid;
}

double OAITeamGame::getPitchingSacrificeFlies() const {
    return m_pitching_sacrifice_flies;
}
void OAITeamGame::setPitchingSacrificeFlies(const double &pitching_sacrifice_flies) {
    m_pitching_sacrifice_flies = pitching_sacrifice_flies;
    m_pitching_sacrifice_flies_isSet = true;
}

bool OAITeamGame::is_pitching_sacrifice_flies_Set() const{
    return m_pitching_sacrifice_flies_isSet;
}

bool OAITeamGame::is_pitching_sacrifice_flies_Valid() const{
    return m_pitching_sacrifice_flies_isValid;
}

double OAITeamGame::getPitchingSacrifices() const {
    return m_pitching_sacrifices;
}
void OAITeamGame::setPitchingSacrifices(const double &pitching_sacrifices) {
    m_pitching_sacrifices = pitching_sacrifices;
    m_pitching_sacrifices_isSet = true;
}

bool OAITeamGame::is_pitching_sacrifices_Set() const{
    return m_pitching_sacrifices_isSet;
}

bool OAITeamGame::is_pitching_sacrifices_Valid() const{
    return m_pitching_sacrifices_isValid;
}

double OAITeamGame::getPitchingShutOuts() const {
    return m_pitching_shut_outs;
}
void OAITeamGame::setPitchingShutOuts(const double &pitching_shut_outs) {
    m_pitching_shut_outs = pitching_shut_outs;
    m_pitching_shut_outs_isSet = true;
}

bool OAITeamGame::is_pitching_shut_outs_Set() const{
    return m_pitching_shut_outs_isSet;
}

bool OAITeamGame::is_pitching_shut_outs_Valid() const{
    return m_pitching_shut_outs_isValid;
}

double OAITeamGame::getPitchingSingles() const {
    return m_pitching_singles;
}
void OAITeamGame::setPitchingSingles(const double &pitching_singles) {
    m_pitching_singles = pitching_singles;
    m_pitching_singles_isSet = true;
}

bool OAITeamGame::is_pitching_singles_Set() const{
    return m_pitching_singles_isSet;
}

bool OAITeamGame::is_pitching_singles_Valid() const{
    return m_pitching_singles_isValid;
}

double OAITeamGame::getPitchingSluggingPercentage() const {
    return m_pitching_slugging_percentage;
}
void OAITeamGame::setPitchingSluggingPercentage(const double &pitching_slugging_percentage) {
    m_pitching_slugging_percentage = pitching_slugging_percentage;
    m_pitching_slugging_percentage_isSet = true;
}

bool OAITeamGame::is_pitching_slugging_percentage_Set() const{
    return m_pitching_slugging_percentage_isSet;
}

bool OAITeamGame::is_pitching_slugging_percentage_Valid() const{
    return m_pitching_slugging_percentage_isValid;
}

double OAITeamGame::getPitchingStrikeouts() const {
    return m_pitching_strikeouts;
}
void OAITeamGame::setPitchingStrikeouts(const double &pitching_strikeouts) {
    m_pitching_strikeouts = pitching_strikeouts;
    m_pitching_strikeouts_isSet = true;
}

bool OAITeamGame::is_pitching_strikeouts_Set() const{
    return m_pitching_strikeouts_isSet;
}

bool OAITeamGame::is_pitching_strikeouts_Valid() const{
    return m_pitching_strikeouts_isValid;
}

double OAITeamGame::getPitchingStrikeoutsPerNineInnings() const {
    return m_pitching_strikeouts_per_nine_innings;
}
void OAITeamGame::setPitchingStrikeoutsPerNineInnings(const double &pitching_strikeouts_per_nine_innings) {
...
bool OAITeamGame::is_pitching_strikeouts_per_nine_innings_Set() const{
    return m_pitching_strikeouts_per_nine_innings_isSet;
}

bool OAITeamGame::is_pitching_strikeouts_per_nine_innings_Valid() const{
    return m_pitching_strikeouts_per_nine_innings_isValid;
}

double OAITeamGame::getPitchingTotalBases() const {
    return m_pitching_total_bases;
}
void OAITeamGame::setPitchingTotalBases(const double &pitching_total_bases) {
    m_pitching_total_bases = pitching_total_bases;
    m_pitching_total_bases_isSet = true;
}

bool OAITeamGame::is_pitching_total_bases_Set() const{
    return m_pitching_total_bases_isSet;
}

bool OAITeamGame::is_pitching_total_bases_Valid() const{
    return m_pitching_total_bases_isValid;
}

double OAITeamGame::getPitchingTriples() const {
    return m_pitching_triples;
}
void OAITeamGame::setPitchingTriples(const double &pitching_triples) {
    m_pitching_triples = pitching_triples;
    m_pitching_triples_isSet = true;
}

bool OAITeamGame::is_pitching_triples_Set() const{
    return m_pitching_triples_isSet;
}

bool OAITeamGame::is_pitching_triples_Valid() const{
    return m_pitching_triples_isValid;
}

double OAITeamGame::getPitchingWalks() const {
    return m_pitching_walks;
}
void OAITeamGame::setPitchingWalks(const double &pitching_walks) {
    m_pitching_walks = pitching_walks;
    m_pitching_walks_isSet = true;
}

bool OAITeamGame::is_pitching_walks_Set() const{
    return m_pitching_walks_isSet;
}

bool OAITeamGame::is_pitching_walks_Valid() const{
    return m_pitching_walks_isValid;
}

double OAITeamGame::getPitchingWalksPerNineInnings() const {
    return m_pitching_walks_per_nine_innings;
}
void OAITeamGame::setPitchingWalksPerNineInnings(const double &pitching_walks_per_nine_innings) {
    m_pitching_walks_per_nine_innings = pitching_walks_per_nine_innings;
    m_pitching_walks_per_nine_innings_isSet = true;
}

bool OAITeamGame::is_pitching_walks_per_nine_innings_Set() const{
    return m_pitching_walks_per_nine_innings_isSet;
}

bool OAITeamGame::is_pitching_walks_per_nine_innings_Valid() const{
    return m_pitching_walks_per_nine_innings_isValid;
}

double OAITeamGame::getPitchingWeightedOnBasePercentage() const {
    return m_pitching_weighted_on_base_percentage;
}
void OAITeamGame::setPitchingWeightedOnBasePercentage(const double &pitching_weighted_on_base_percentage) {
...
bool OAITeamGame::is_pitching_weighted_on_base_percentage_Set() const{
    return m_pitching_weighted_on_base_percentage_isSet;
}

bool OAITeamGame::is_pitching_weighted_on_base_percentage_Valid() const{
    return m_pitching_weighted_on_base_percentage_isValid;
}

double OAITeamGame::getPlateAppearances() const {
    return m_plate_appearances;
}
void OAITeamGame::setPlateAppearances(const double &plate_appearances) {
    m_plate_appearances = plate_appearances;
    m_plate_appearances_isSet = true;
}

bool OAITeamGame::is_plate_appearances_Set() const{
    return m_plate_appearances_isSet;
}

bool OAITeamGame::is_plate_appearances_Valid() const{
    return m_plate_appearances_isValid;
}

double OAITeamGame::getPopOuts() const {
    return m_pop_outs;
}
void OAITeamGame::setPopOuts(const double &pop_outs) {
    m_pop_outs = pop_outs;
    m_pop_outs_isSet = true;
}

bool OAITeamGame::is_pop_outs_Set() const{
    return m_pop_outs_isSet;
}

bool OAITeamGame::is_pop_outs_Valid() const{
    return m_pop_outs_isValid;
}

double OAITeamGame::getReachedOnError() const {
    return m_reached_on_error;
}
void OAITeamGame::setReachedOnError(const double &reached_on_error) {
    m_reached_on_error = reached_on_error;
    m_reached_on_error_isSet = true;
}

bool OAITeamGame::is_reached_on_error_Set() const{
    return m_reached_on_error_isSet;
}

bool OAITeamGame::is_reached_on_error_Valid() const{
    return m_reached_on_error_isValid;
}

double OAITeamGame::getRuns() const {
    return m_runs;
}
void OAITeamGame::setRuns(const double &runs) {
    m_runs = runs;
    m_runs_isSet = true;
}

bool OAITeamGame::is_runs_Set() const{
    return m_runs_isSet;
}

bool OAITeamGame::is_runs_Valid() const{
    return m_runs_isValid;
}

double OAITeamGame::getRunsBattedIn() const {
    return m_runs_batted_in;
}
void OAITeamGame::setRunsBattedIn(const double &runs_batted_in) {
    m_runs_batted_in = runs_batted_in;
    m_runs_batted_in_isSet = true;
}

bool OAITeamGame::is_runs_batted_in_Set() const{
    return m_runs_batted_in_isSet;
}

bool OAITeamGame::is_runs_batted_in_Valid() const{
    return m_runs_batted_in_isValid;
}

double OAITeamGame::getSacrificeFlies() const {
    return m_sacrifice_flies;
}
void OAITeamGame::setSacrificeFlies(const double &sacrifice_flies) {
    m_sacrifice_flies = sacrifice_flies;
    m_sacrifice_flies_isSet = true;
}

bool OAITeamGame::is_sacrifice_flies_Set() const{
    return m_sacrifice_flies_isSet;
}

bool OAITeamGame::is_sacrifice_flies_Valid() const{
    return m_sacrifice_flies_isValid;
}

double OAITeamGame::getSacrifices() const {
    return m_sacrifices;
}
void OAITeamGame::setSacrifices(const double &sacrifices) {
    m_sacrifices = sacrifices;
    m_sacrifices_isSet = true;
}

bool OAITeamGame::is_sacrifices_Set() const{
    return m_sacrifices_isSet;
}

bool OAITeamGame::is_sacrifices_Valid() const{
    return m_sacrifices_isValid;
}

double OAITeamGame::getSaves() const {
    return m_saves;
}
void OAITeamGame::setSaves(const double &saves) {
    m_saves = saves;
    m_saves_isSet = true;
}

bool OAITeamGame::is_saves_Set() const{
    return m_saves_isSet;
}

bool OAITeamGame::is_saves_Valid() const{
...
double OAITeamGame::getSingles() const {
    return m_singles;
}
void OAITeamGame::setSingles(const double &singles) {
    m_singles = singles;
    m_singles_isSet = true;
}

bool OAITeamGame::is_singles_Set() const{
    return m_singles_isSet;
}

bool OAITeamGame::is_singles_Valid() const{
    return m_singles_isValid;
}

double OAITeamGame::getSluggingPercentage() const {
    return m_slugging_percentage;
}
void OAITeamGame::setSluggingPercentage(const double &slugging_percentage) {
    m_slugging_percentage = slugging_percentage;
    m_slugging_percentage_isSet = true;
}

bool OAITeamGame::is_slugging_percentage_Set() const{
    return m_slugging_percentage_isSet;
}

bool OAITeamGame::is_slugging_percentage_Valid() const{
...
double OAITeamGame::getStolenBases() const {
    return m_stolen_bases;
}
void OAITeamGame::setStolenBases(const double &stolen_bases) {
    m_stolen_bases = stolen_bases;
    m_stolen_bases_isSet = true;
}

bool OAITeamGame::is_stolen_bases_Set() const{
    return m_stolen_bases_isSet;
}

bool OAITeamGame::is_stolen_bases_Valid() const{
    return m_stolen_bases_isValid;
}

double OAITeamGame::getStrikeouts() const {
    return m_strikeouts;
}
void OAITeamGame::setStrikeouts(const double &strikeouts) {
    m_strikeouts = strikeouts;
    m_strikeouts_isSet = true;
}

bool OAITeamGame::is_strikeouts_Set() const{
    return m_strikeouts_isSet;
}

bool OAITeamGame::is_strikeouts_Valid() const{
    return m_strikeouts_isValid;
}

qint32 OAITeamGame::getSubstituteBattingOrder() const {
    return m_substitute_batting_order;
}
void OAITeamGame::setSubstituteBattingOrder(const qint32 &substitute_batting_order) {
    m_substitute_batting_order = substitute_batting_order;
    m_substitute_batting_order_isSet = true;
}

bool OAITeamGame::is_substitute_batting_order_Set() const{
    return m_substitute_batting_order_isSet;
}

bool OAITeamGame::is_substitute_batting_order_Valid() const{
    return m_substitute_batting_order_isValid;
}

qint32 OAITeamGame::getSubstituteBattingOrderSequence() const {
    return m_substitute_batting_order_sequence;
}
void OAITeamGame::setSubstituteBattingOrderSequence(const qint32 &substitute_batting_order_sequence) {
    m_substitute_batting_order_sequence = substitute_batting_order_sequence;
    m_substitute_batting_order_sequence_isSet = true;
}

bool OAITeamGame::is_substitute_batting_order_sequence_Set() const{
    return m_substitute_batting_order_sequence_isSet;
}

bool OAITeamGame::is_substitute_batting_order_sequence_Valid() const{
...
double OAITeamGame::getTotalBases() const {
    return m_total_bases;
}
void OAITeamGame::setTotalBases(const double &total_bases) {
    m_total_bases = total_bases;
    m_total_bases_isSet = true;
}

bool OAITeamGame::is_total_bases_Set() const{
    return m_total_bases_isSet;
}

bool OAITeamGame::is_total_bases_Valid() const{
    return m_total_bases_isValid;
}

double OAITeamGame::getTotalOutsPitched() const {
    return m_total_outs_pitched;
}
void OAITeamGame::setTotalOutsPitched(const double &total_outs_pitched) {
    m_total_outs_pitched = total_outs_pitched;
    m_total_outs_pitched_isSet = true;
}

bool OAITeamGame::is_total_outs_pitched_Set() const{
    return m_total_outs_pitched_isSet;
}

bool OAITeamGame::is_total_outs_pitched_Valid() const{
    return m_total_outs_pitched_isValid;
}

double OAITeamGame::getTriples() const {
    return m_triples;
}
void OAITeamGame::setTriples(const double &triples) {
    m_triples = triples;
    m_triples_isSet = true;
}

bool OAITeamGame::is_triples_Set() const{
    return m_triples_isSet;
}

bool OAITeamGame::is_triples_Valid() const{
...
double OAITeamGame::getWalks() const {
    return m_walks;
}
void OAITeamGame::setWalks(const double &walks) {
    m_walks = walks;
    m_walks_isSet = true;
}

bool OAITeamGame::is_walks_Set() const{
    return m_walks_isSet;
}

bool OAITeamGame::is_walks_Valid() const{
    return m_walks_isValid;
}

double OAITeamGame::getWalksHitsPerInningsPitched() const {
    return m_walks_hits_per_innings_pitched;
}
void OAITeamGame::setWalksHitsPerInningsPitched(const double &walks_hits_per_innings_pitched) {
    m_walks_hits_per_innings_pitched = walks_hits_per_innings_pitched;
    m_walks_hits_per_innings_pitched_isSet = true;
}

bool OAITeamGame::is_walks_hits_per_innings_pitched_Set() const{
    return m_walks_hits_per_innings_pitched_isSet;
}

bool OAITeamGame::is_walks_hits_per_innings_pitched_Valid() const{
    return m_walks_hits_per_innings_pitched_isValid;
}

double OAITeamGame::getWeightedOnBasePercentage() const {
    return m_weighted_on_base_percentage;
}
void OAITeamGame::setWeightedOnBasePercentage(const double &weighted_on_base_percentage) {
    m_weighted_on_base_percentage = weighted_on_base_percentage;
    m_weighted_on_base_percentage_isSet = true;
}

bool OAITeamGame::is_weighted_on_base_percentage_Set() const{
    return m_weighted_on_base_percentage_isSet;
}

bool OAITeamGame::is_weighted_on_base_percentage_Valid() const{
    return m_weighted_on_base_percentage_isValid;
}

double OAITeamGame::getWins() const {
    return m_wins;
}
void OAITeamGame::setWins(const double &wins) {
    m_wins = wins;
    m_wins_isSet = true;
}
