# NbaV3Stats.DefaultApi

All URIs are relative to *http://azure-api.sportsdata.io/v3/nba/stats*

Method | HTTP request | Description
------------- | ------------- | -------------
[**allStars**](DefaultApi.md#allStars) | **GET** /{format}/AllStars/{season} | All-Stars
...
> [PlayerInfo] allStars(format, season)
...
```javascript
import NbaV3Stats from 'nba_v3_stats';
let defaultClient = NbaV3Stats.ApiClient.instance;
...
let apiInstance = new NbaV3Stats.DefaultApi();
...
apiInstance.allStars(format, season, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
