...
class ApiClient {
     ...
     */
    constructor(basePath = 'http://azure-api.sportsdata.io/v3/nba/stats') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default http://azure-api.sportsdata.io/v3/nba/stats
         */
  ...
  /**
    ...
    */
    hostSettings() {
        return [
            {
              'url': "http://azure-api.sportsdata.io/v3/nba/stats",
              'description': "No description provided",
            },
            {
              'url': "https://azure-api.sportsdata.io/v3/nba/stats",
              'description': "No description provided",
            }
      ];
    }
