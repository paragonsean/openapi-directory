...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NbaV3Stats.DefaultApi();
  });
  ...
  describe('DefaultApi', function() {
    describe('allStars', function() {
      it('should call allStars successfully', function(done) {
        //uncomment below and update the code to test allStars
        //instance.allStars(function(error) {
