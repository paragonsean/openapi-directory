...
async def all_stars(request: web.Request, format, season) -> web.Response:
    """All-Stars
...
async def team_stats_allowed_by_position(request: web.Request, format, season) -> web.Response:
