...
void OAIDefaultApi::initializeServerConfigs() {
    ...
    QUrl("http://azure-api.sportsdata.io/v3/nba/stats"),
    "No description provided",
    QMap<QString, OAIServerVariable>()));
    defaultConf.append(OAIServerConfiguration(
    QUrl("https://azure-api.sportsdata.io/v3/nba/stats"),
    "No description provided",
    QMap<QString, OAIServerVariable>()));
    _serverConfigs.insert("allStars", defaultConf);
    _serverIndices.insert("allStars", 0);
...
void OAIDefaultApi::allStars(const QString &format, const QString &season) {
    QString fullPath = QString(_serverConfigs["allStars"][_serverIndices.value("allStars")].URL()+"/{format}/AllStars/{season}");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIDefaultApi::allStarsCallback);
...
void OAIDefaultApi::allStarsCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT allStarsSignal(output);
        Q_EMIT allStarsSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT allStarsSignalE(output, error_type, error_str);
        Q_EMIT allStarsSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT allStarsSignalError(output, error_type, error_str);
        Q_EMIT allStarsSignalErrorFull(worker, error_type, error_str);
    }
}
