...
double OAIOpponentSeason::getAssistsPercentage() const {
    return m_assists_percentage;
}
void OAIOpponentSeason::setAssistsPercentage(const double &assists_percentage) {
    m_assists_percentage = assists_percentage;
    m_assists_percentage_isSet = true;
}

bool OAIOpponentSeason::is_assists_percentage_Set() const{
    return m_assists_percentage_isSet;
}

bool OAIOpponentSeason::is_assists_percentage_Valid() const{
    return m_assists_percentage_isValid;
}

double OAIOpponentSeason::getBlockedShots() const {
    return m_blocked_shots;
}
void OAIOpponentSeason::setBlockedShots(const double &blocked_shots) {
    m_blocked_shots = blocked_shots;
    m_blocked_shots_isSet = true;
}

bool OAIOpponentSeason::is_blocked_shots_Set() const{
    return m_blocked_shots_isSet;
}

bool OAIOpponentSeason::is_blocked_shots_Valid() const{
    return m_blocked_shots_isValid;
}

double OAIOpponentSeason::getBlocksPercentage() const {
    return m_blocks_percentage;
}
void OAIOpponentSeason::setBlocksPercentage(const double &blocks_percentage) {
    m_blocks_percentage = blocks_percentage;
    m_blocks_percentage_isSet = true;
}

bool OAIOpponentSeason::is_blocks_percentage_Set() const{
    return m_blocks_percentage_isSet;
}

bool OAIOpponentSeason::is_blocks_percentage_Valid() const{
    return m_blocks_percentage_isValid;
}

double OAIOpponentSeason::getDefensiveRebounds() const {
    return m_defensive_rebounds;
}
void OAIOpponentSeason::setDefensiveRebounds(const double &defensive_rebounds) {
    m_defensive_rebounds = defensive_rebounds;
    m_defensive_rebounds_isSet = true;
}

bool OAIOpponentSeason::is_defensive_rebounds_Set() const{
    return m_defensive_rebounds_isSet;
}

bool OAIOpponentSeason::is_defensive_rebounds_Valid() const{
    return m_defensive_rebounds_isValid;
}

double OAIOpponentSeason::getDefensiveReboundsPercentage() const {
    return m_defensive_rebounds_percentage;
}
void OAIOpponentSeason::setDefensiveReboundsPercentage(const double &defensive_rebounds_percentage) {
    m_defensive_rebounds_percentage = defensive_rebounds_percentage;
    m_defensive_rebounds_percentage_isSet = true;
}

bool OAIOpponentSeason::is_defensive_rebounds_percentage_Set() const{
    return m_defensive_rebounds_percentage_isSet;
}

bool OAIOpponentSeason::is_defensive_rebounds_percentage_Valid() const{
    return m_defensive_rebounds_percentage_isValid;
}

double OAIOpponentSeason::getDoubleDoubles() const {
    return m_double_doubles;
}
void OAIOpponentSeason::setDoubleDoubles(const double &double_doubles) {
    m_double_doubles = double_doubles;
    m_double_doubles_isSet = true;
}

bool OAIOpponentSeason::is_double_doubles_Set() const{
    return m_double_doubles_isSet;
}

bool OAIOpponentSeason::is_double_doubles_Valid() const{
    return m_double_doubles_isValid;
}

double OAIOpponentSeason::getEffectiveFieldGoalsPercentage() const {
    return m_effective_field_goals_percentage;
}
void OAIOpponentSeason::setEffectiveFieldGoalsPercentage(const double &effective_field_goals_percentage) {
    m_effective_field_goals_percentage = effective_field_goals_percentage;
    m_effective_field_goals_percentage_isSet = true;
}

bool OAIOpponentSeason::is_effective_field_goals_percentage_Set() const{
    return m_effective_field_goals_percentage_isSet;
}

bool OAIOpponentSeason::is_effective_field_goals_percentage_Valid() const{
...
double OAIOpponentSeason::getFieldGoalsAttempted() const {
    return m_field_goals_attempted;
}
void OAIOpponentSeason::setFieldGoalsAttempted(const double &field_goals_attempted) {
    m_field_goals_attempted = field_goals_attempted;
    m_field_goals_attempted_isSet = true;
}

bool OAIOpponentSeason::is_field_goals_attempted_Set() const{
    return m_field_goals_attempted_isSet;
}

bool OAIOpponentSeason::is_field_goals_attempted_Valid() const{
    return m_field_goals_attempted_isValid;
}

double OAIOpponentSeason::getFieldGoalsMade() const {
    return m_field_goals_made;
}
void OAIOpponentSeason::setFieldGoalsMade(const double &field_goals_made) {
    m_field_goals_made = field_goals_made;
    m_field_goals_made_isSet = true;
}

bool OAIOpponentSeason::is_field_goals_made_Set() const{
    return m_field_goals_made_isSet;
}

bool OAIOpponentSeason::is_field_goals_made_Valid() const{
    return m_field_goals_made_isValid;
}

double OAIOpponentSeason::getFieldGoalsPercentage() const {
    return m_field_goals_percentage;
}
void OAIOpponentSeason::setFieldGoalsPercentage(const double &field_goals_percentage) {
    m_field_goals_percentage = field_goals_percentage;
    m_field_goals_percentage_isSet = true;
}

bool OAIOpponentSeason::is_field_goals_percentage_Set() const{
    return m_field_goals_percentage_isSet;
}

bool OAIOpponentSeason::is_field_goals_percentage_Valid() const{
    return m_field_goals_percentage_isValid;
}

double OAIOpponentSeason::getFreeThrowsAttempted() const {
    return m_free_throws_attempted;
}
void OAIOpponentSeason::setFreeThrowsAttempted(const double &free_throws_attempted) {
    m_free_throws_attempted = free_throws_attempted;
    m_free_throws_attempted_isSet = true;
}

bool OAIOpponentSeason::is_free_throws_attempted_Set() const{
    return m_free_throws_attempted_isSet;
}

bool OAIOpponentSeason::is_free_throws_attempted_Valid() const{
    return m_free_throws_attempted_isValid;
}

double OAIOpponentSeason::getFreeThrowsMade() const {
    return m_free_throws_made;
}
void OAIOpponentSeason::setFreeThrowsMade(const double &free_throws_made) {
    m_free_throws_made = free_throws_made;
    m_free_throws_made_isSet = true;
}

bool OAIOpponentSeason::is_free_throws_made_Set() const{
    return m_free_throws_made_isSet;
}

bool OAIOpponentSeason::is_free_throws_made_Valid() const{
    return m_free_throws_made_isValid;
}

double OAIOpponentSeason::getFreeThrowsPercentage() const {
    return m_free_throws_percentage;
}
void OAIOpponentSeason::setFreeThrowsPercentage(const double &free_throws_percentage) {
    m_free_throws_percentage = free_throws_percentage;
    m_free_throws_percentage_isSet = true;
}

bool OAIOpponentSeason::is_free_throws_percentage_Set() const{
    return m_free_throws_percentage_isSet;
}

bool OAIOpponentSeason::is_free_throws_percentage_Valid() const{
...
bool OAIOpponentSeason::isIsClosed() const {
    return m_is_closed;
}
void OAIOpponentSeason::setIsClosed(const bool &is_closed) {
    m_is_closed = is_closed;
    m_is_closed_isSet = true;
}

bool OAIOpponentSeason::is_is_closed_Set() const{
    return m_is_closed_isSet;
}

bool OAIOpponentSeason::is_is_closed_Valid() const{
    return m_is_closed_isValid;
}

bool OAIOpponentSeason::isLineupConfirmed() const {
    return m_lineup_confirmed;
}
void OAIOpponentSeason::setLineupConfirmed(const bool &lineup_confirmed) {
    m_lineup_confirmed = lineup_confirmed;
    m_lineup_confirmed_isSet = true;
}

bool OAIOpponentSeason::is_lineup_confirmed_Set() const{
    return m_lineup_confirmed_isSet;
}

bool OAIOpponentSeason::is_lineup_confirmed_Valid() const{
    return m_lineup_confirmed_isValid;
}

QString OAIOpponentSeason::getLineupStatus() const {
    return m_lineup_status;
}
void OAIOpponentSeason::setLineupStatus(const QString &lineup_status) {
    m_lineup_status = lineup_status;
    m_lineup_status_isSet = true;
}

bool OAIOpponentSeason::is_lineup_status_Set() const{
    return m_lineup_status_isSet;
}

bool OAIOpponentSeason::is_lineup_status_Valid() const{
...
double OAIOpponentSeason::getOffensiveRebounds() const {
    return m_offensive_rebounds;
}
void OAIOpponentSeason::setOffensiveRebounds(const double &offensive_rebounds) {
    m_offensive_rebounds = offensive_rebounds;
    m_offensive_rebounds_isSet = true;
}

bool OAIOpponentSeason::is_offensive_rebounds_Set() const{
    return m_offensive_rebounds_isSet;
}

bool OAIOpponentSeason::is_offensive_rebounds_Valid() const{
    return m_offensive_rebounds_isValid;
}

double OAIOpponentSeason::getOffensiveReboundsPercentage() const {
    return m_offensive_rebounds_percentage;
}
void OAIOpponentSeason::setOffensiveReboundsPercentage(const double &offensive_rebounds_percentage) {
    m_offensive_rebounds_percentage = offensive_rebounds_percentage;
    m_offensive_rebounds_percentage_isSet = true;
}

bool OAIOpponentSeason::is_offensive_rebounds_percentage_Set() const{
    return m_offensive_rebounds_percentage_isSet;
}

bool OAIOpponentSeason::is_offensive_rebounds_percentage_Valid() const{
...
double OAIOpponentSeason::getPersonalFouls() const {
    return m_personal_fouls;
}
void OAIOpponentSeason::setPersonalFouls(const double &personal_fouls) {
    m_personal_fouls = personal_fouls;
    m_personal_fouls_isSet = true;
}

bool OAIOpponentSeason::is_personal_fouls_Set() const{
    return m_personal_fouls_isSet;
}

bool OAIOpponentSeason::is_personal_fouls_Valid() const{
    return m_personal_fouls_isValid;
}

double OAIOpponentSeason::getPlayerEfficiencyRating() const {
    return m_player_efficiency_rating;
}
void OAIOpponentSeason::setPlayerEfficiencyRating(const double &player_efficiency_rating) {
    m_player_efficiency_rating = player_efficiency_rating;
    m_player_efficiency_rating_isSet = true;
}

bool OAIOpponentSeason::is_player_efficiency_rating_Set() const{
    return m_player_efficiency_rating_isSet;
}

bool OAIOpponentSeason::is_player_efficiency_rating_Valid() const{
...
double OAIOpponentSeason::getPoints() const {
    return m_points;
}
void OAIOpponentSeason::setPoints(const double &points) {
    m_points = points;
    m_points_isSet = true;
}

bool OAIOpponentSeason::is_points_Set() const{
    return m_points_isSet;
}

bool OAIOpponentSeason::is_points_Valid() const{
    return m_points_isValid;
}

double OAIOpponentSeason::getPossessions() const {
    return m_possessions;
}
void OAIOpponentSeason::setPossessions(const double &possessions) {
    m_possessions = possessions;
    m_possessions_isSet = true;
}

bool OAIOpponentSeason::is_possessions_Set() const{
    return m_possessions_isSet;
}

bool OAIOpponentSeason::is_possessions_Valid() const{
    return m_possessions_isValid;
}

double OAIOpponentSeason::getRebounds() const {
    return m_rebounds;
}
void OAIOpponentSeason::setRebounds(const double &rebounds) {
    m_rebounds = rebounds;
    m_rebounds_isSet = true;
}

bool OAIOpponentSeason::is_rebounds_Set() const{
    return m_rebounds_isSet;
}

bool OAIOpponentSeason::is_rebounds_Valid() const{
...
double OAIOpponentSeason::getSteals() const {
    return m_steals;
}
void OAIOpponentSeason::setSteals(const double &steals) {
    m_steals = steals;
    m_steals_isSet = true;
}

bool OAIOpponentSeason::is_steals_Set() const{
    return m_steals_isSet;
}

bool OAIOpponentSeason::is_steals_Valid() const{
    return m_steals_isValid;
}

double OAIOpponentSeason::getStealsPercentage() const {
    return m_steals_percentage;
}
void OAIOpponentSeason::setStealsPercentage(const double &steals_percentage) {
    m_steals_percentage = steals_percentage;
    m_steals_percentage_isSet = true;
}

bool OAIOpponentSeason::is_steals_percentage_Set() const{
    return m_steals_percentage_isSet;
}

bool OAIOpponentSeason::is_steals_percentage_Valid() const{
...
double OAIOpponentSeason::getThreePointersAttempted() const {
    return m_three_pointers_attempted;
}
void OAIOpponentSeason::setThreePointersAttempted(const double &three_pointers_attempted) {
    m_three_pointers_attempted = three_pointers_attempted;
    m_three_pointers_attempted_isSet = true;
}

bool OAIOpponentSeason::is_three_pointers_attempted_Set() const{
    return m_three_pointers_attempted_isSet;
}

bool OAIOpponentSeason::is_three_pointers_attempted_Valid() const{
    return m_three_pointers_attempted_isValid;
}

double OAIOpponentSeason::getThreePointersMade() const {
    return m_three_pointers_made;
}
void OAIOpponentSeason::setThreePointersMade(const double &three_pointers_made) {
    m_three_pointers_made = three_pointers_made;
    m_three_pointers_made_isSet = true;
}

bool OAIOpponentSeason::is_three_pointers_made_Set() const{
    return m_three_pointers_made_isSet;
}

bool OAIOpponentSeason::is_three_pointers_made_Valid() const{
    return m_three_pointers_made_isValid;
}

double OAIOpponentSeason::getThreePointersPercentage() const {
    return m_three_pointers_percentage;
}
void OAIOpponentSeason::setThreePointersPercentage(const double &three_pointers_percentage) {
    m_three_pointers_percentage = three_pointers_percentage;
    m_three_pointers_percentage_isSet = true;
}

bool OAIOpponentSeason::is_three_pointers_percentage_Set() const{
    return m_three_pointers_percentage_isSet;
}

bool OAIOpponentSeason::is_three_pointers_percentage_Valid() const{
    return m_three_pointers_percentage_isValid;
}

double OAIOpponentSeason::getTotalReboundsPercentage() const {
    return m_total_rebounds_percentage;
}
void OAIOpponentSeason::setTotalReboundsPercentage(const double &total_rebounds_percentage) {
    m_total_rebounds_percentage = total_rebounds_percentage;
    m_total_rebounds_percentage_isSet = true;
}

bool OAIOpponentSeason::is_total_rebounds_percentage_Set() const{
    return m_total_rebounds_percentage_isSet;
}

bool OAIOpponentSeason::is_total_rebounds_percentage_Valid() const{
    return m_total_rebounds_percentage_isValid;
}

double OAIOpponentSeason::getTripleDoubles() const {
    return m_triple_doubles;
}
void OAIOpponentSeason::setTripleDoubles(const double &triple_doubles) {
    m_triple_doubles = triple_doubles;
    m_triple_doubles_isSet = true;
}

bool OAIOpponentSeason::is_triple_doubles_Set() const{
    return m_triple_doubles_isSet;
}

bool OAIOpponentSeason::is_triple_doubles_Valid() const{
    return m_triple_doubles_isValid;
}

double OAIOpponentSeason::getTrueShootingAttempts() const {
    return m_true_shooting_attempts;
}
void OAIOpponentSeason::setTrueShootingAttempts(const double &true_shooting_attempts) {
    m_true_shooting_attempts = true_shooting_attempts;
    m_true_shooting_attempts_isSet = true;
}

bool OAIOpponentSeason::is_true_shooting_attempts_Set() const{
    return m_true_shooting_attempts_isSet;
}

bool OAIOpponentSeason::is_true_shooting_attempts_Valid() const{
    return m_true_shooting_attempts_isValid;
}

double OAIOpponentSeason::getTrueShootingPercentage() const {
    return m_true_shooting_percentage;
}
void OAIOpponentSeason::setTrueShootingPercentage(const double &true_shooting_percentage) {
    m_true_shooting_percentage = true_shooting_percentage;
    m_true_shooting_percentage_isSet = true;
}

bool OAIOpponentSeason::is_true_shooting_percentage_Set() const{
    return m_true_shooting_percentage_isSet;
}

bool OAIOpponentSeason::is_true_shooting_percentage_Valid() const{
    return m_true_shooting_percentage_isValid;
}

double OAIOpponentSeason::getTurnOversPercentage() const {
    return m_turn_overs_percentage;
}
void OAIOpponentSeason::setTurnOversPercentage(const double &turn_overs_percentage) {
    m_turn_overs_percentage = turn_overs_percentage;
    m_turn_overs_percentage_isSet = true;
}

bool OAIOpponentSeason::is_turn_overs_percentage_Set() const{
    return m_turn_overs_percentage_isSet;
}

bool OAIOpponentSeason::is_turn_overs_percentage_Valid() const{
    return m_turn_overs_percentage_isValid;
}

double OAIOpponentSeason::getTurnovers() const {
    return m_turnovers;
}
void OAIOpponentSeason::setTurnovers(const double &turnovers) {
    m_turnovers = turnovers;
    m_turnovers_isSet = true;
}

bool OAIOpponentSeason::is_turnovers_Set() const{
    return m_turnovers_isSet;
}

bool OAIOpponentSeason::is_turnovers_Valid() const{
    return m_turnovers_isValid;
}

double OAIOpponentSeason::getTwoPointersAttempted() const {
    return m_two_pointers_attempted;
}
void OAIOpponentSeason::setTwoPointersAttempted(const double &two_pointers_attempted) {
    m_two_pointers_attempted = two_pointers_attempted;
    m_two_pointers_attempted_isSet = true;
}

bool OAIOpponentSeason::is_two_pointers_attempted_Set() const{
    return m_two_pointers_attempted_isSet;
}

bool OAIOpponentSeason::is_two_pointers_attempted_Valid() const{
    return m_two_pointers_attempted_isValid;
}

double OAIOpponentSeason::getTwoPointersMade() const {
    return m_two_pointers_made;
}
void OAIOpponentSeason::setTwoPointersMade(const double &two_pointers_made) {
    m_two_pointers_made = two_pointers_made;
    m_two_pointers_made_isSet = true;
}

bool OAIOpponentSeason::is_two_pointers_made_Set() const{
    return m_two_pointers_made_isSet;
}

bool OAIOpponentSeason::is_two_pointers_made_Valid() const{
    return m_two_pointers_made_isValid;
}

double OAIOpponentSeason::getTwoPointersPercentage() const {
    return m_two_pointers_percentage;
}
void OAIOpponentSeason::setTwoPointersPercentage(const double &two_pointers_percentage) {
    m_two_pointers_percentage = two_pointers_percentage;
    m_two_pointers_percentage_isSet = true;
}

bool OAIOpponentSeason::is_two_pointers_percentage_Set() const{
    return m_two_pointers_percentage_isSet;
}

bool OAIOpponentSeason::is_two_pointers_percentage_Valid() const{
...
double OAIOpponentSeason::getUsageRatePercentage() const {
    return m_usage_rate_percentage;
}
void OAIOpponentSeason::setUsageRatePercentage(const double &usage_rate_percentage) {
    m_usage_rate_percentage = usage_rate_percentage;
    m_usage_rate_percentage_isSet = true;
}

bool OAIOpponentSeason::is_usage_rate_percentage_Set() const{
    return m_usage_rate_percentage_isSet;
}

bool OAIOpponentSeason::is_usage_rate_percentage_Valid() const{
