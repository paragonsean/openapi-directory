...
#ifndef OAIPlayerGame_H
#define OAIPlayerGame_H
...
class OAIPlayerGame : public OAIObject {
public:
    OAIPlayerGame();
    OAIPlayerGame(QString json);
    ~OAIPlayerGame() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPlayerGame)

#endif // OAIPlayerGame_H
