...
class Team(Model):
    ...
    def __init__(self, active: bool=None, city: str=None, division: str=None, global_team_id: int=None, key: str=None, league: str=None, name: str=None, primary_color: str=None, quaternary_color: str=None, secondary_color: str=None, stadium_id: int=None, team_id: int=None, tertiary_color: str=None, wikipedia_logo_url: str=None, wikipedia_word_mark_url: str=None):
