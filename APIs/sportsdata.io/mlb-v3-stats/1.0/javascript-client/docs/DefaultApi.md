...
```javascript
import MlbV3Stats from 'mlb_v3_stats';
let defaultClient = MlbV3Stats.ApiClient.instance;
...
let apiInstance = new MlbV3Stats.DefaultApi();
...
> [PlayerSeason] batterVsPitcherStats(format, hitterid, pitcherid)
...
let apiInstance = new MlbV3Stats.DefaultApi();
let format = "'XML'"; // String | Desired response format. Valid entries are <code>XML</code> or <code>JSON</code>.
let hitterid = "hitterid_example"; // String | Unique FantasyData Player ID. Example:<code>10000031</code>.
let pitcherid = "pitcherid_example"; // String | Unique FantasyData Player ID. Example:<code>10000618</code>.
apiInstance.batterVsPitcherStats(format, hitterid, pitcherid, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
let apiInstance = new MlbV3Stats.DefaultApi();
let format = "'XML'"; // String | Desired response format. Valid entries are <code>XML</code> or <code>JSON</code>.
let gameid = "gameid_example"; // String | The GameID of an MLB game.  GameIDs can be found in the Games API.  Valid entries are <code>14620</code> or <code>16905</code>
...
let playerid = "playerid_example"; // String | Unique FantasyData Player ID. Example:<code>10001365</code>.
...
> [PlayerSeason] playerSeasonAwayStats(format, season)
...
apiInstance.playerSeasonAwayStats(format, season, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> [PlayerSeason] playerSeasonHomeStats(format, season)
...
let format = "'XML'"; // String | Desired response format. Valid entries are <code>XML</code> or <code>JSON</code>.
let season = "season_example"; // String | Year of the season. <br>Examples: <code>2017</code>, <code>2018</code>.
apiInstance.playerSeasonHomeStats(format, season, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> [PlayerSeason] playerSeasonSplitStats(format, season, split)
...
let format = "'XML'"; // String | Desired response format. Valid entries are <code>XML</code> or <code>JSON</code>.
let season = "season_example"; // String | Year of the season. <br>Examples: <code>2017</code>, <code>2018</code>.
let split = "'L'"; // String | The desired split of stats. Currently, we support vs. Left/Right/Switch handed pitchers/hitters. Possible values are: <code>L</code>, <code>R</code> and <code>S</code>
apiInstance.playerSeasonSplitStats(format, season, split, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
 ...
 **format** | **String**| Desired response format. Valid entries are &lt;code&gt;XML&lt;/code&gt; or &lt;code&gt;JSON&lt;/code&gt;. | [default to &#39;XML&#39;]
 **season** | **String**| Year of the season. &lt;br&gt;Examples: &lt;code&gt;2017&lt;/code&gt;, &lt;code&gt;2018&lt;/code&gt;. | 
 **split** | **String**| The desired split of stats. Currently, we support vs. Left/Right/Switch handed pitchers/hitters. Possible values are: &lt;code&gt;L&lt;/code&gt;, &lt;code&gt;R&lt;/code&gt; and &lt;code&gt;S&lt;/code&gt; | [default to &#39;L&#39;]
...
> [PlayerSeason] playerSeasonStatsSplitByTeam(format, season)
...
let format = "'XML'"; // String | Desired response format. Valid entries are <code>XML</code> or <code>JSON</code>.
let season = "season_example"; // String | Year of the season. <br>Examples: <code>2017</code>, <code>2018</code>.
apiInstance.playerSeasonStatsSplitByTeam(format, season, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
let format = "format_example"; // String | Desired response format. Valid entries are <code>XML</code> or <code>JSON</code>.
let season = "season_example"; // String | Season to get games from. Example <code>2019POST</code>, <code>2020</code>
let teamid = "teamid_example"; // String | Unique ID of team.  Example <code> 12 </code>
let numberofgames = "numberofgames_example"; // String | How many games to return. Example <code>all</code>, <code>10</code>, <code>25</code>
...
> [PlayerSeason] teamHittingVsStartingPitcher(format, gameid, team)
...
let gameid = "gameid_example"; // String | The GameID of an MLB game.  GameIDs can be found in the Games API.  Valid entries are <code>14620</code> or <code>16905</code>
let team = "team_example"; // String | The abbreviation of the requested team. <br>Examples: <code>SF</code>, <code>NYY</code>.
apiInstance.teamHittingVsStartingPitcher(format, gameid, team, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
