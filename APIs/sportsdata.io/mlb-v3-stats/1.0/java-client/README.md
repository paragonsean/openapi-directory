...
MLB v3 Stats
- API version: 1.0
  - Build date: 2024-10-12T10:04:52.246450-04:00[America/New_York]
...
*DefaultApi* | [**batterVsPitcherStats**](docs/DefaultApi.md#batterVsPitcherStats) | **GET** /{format}/HitterVsPitcher/{hitterid}/{pitcherid} | Batter vs. Pitcher Stats
...
*DefaultApi* | [**playerSeasonAwayStats**](docs/DefaultApi.md#playerSeasonAwayStats) | **GET** /{format}/PlayerSeasonAwayStats/{season} | Player Season Away Stats
*DefaultApi* | [**playerSeasonHomeStats**](docs/DefaultApi.md#playerSeasonHomeStats) | **GET** /{format}/PlayerSeasonHomeStats/{season} | Player Season Home Stats
*DefaultApi* | [**playerSeasonSplitStats**](docs/DefaultApi.md#playerSeasonSplitStats) | **GET** /{format}/PlayerSeasonSplitStats/{season}/{split} | Player Season Split Stats
...
*DefaultApi* | [**playerSeasonStatsSplitByTeam**](docs/DefaultApi.md#playerSeasonStatsSplitByTeam) | **GET** /{format}/PlayerSeasonStatsSplitByTeam/{season} | Player Season Stats Split By Team
...
*DefaultApi* | [**teamHittingVsStartingPitcher**](docs/DefaultApi.md#teamHittingVsStartingPitcher) | **GET** /{format}/TeamHittersVsPitcher/{gameid}/{team} | Team Hitting vs. Starting Pitcher
