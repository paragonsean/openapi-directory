...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SoccerV3Scores.Round();
  });
  ...
  describe('Round', function() {
    it('should create an instance of Round', function() {
      ...
      //var instance = new SoccerV3Scores.Round();
      //expect(instance).to.be.a(SoccerV3Scores.Round);
    });
    ...
    it('should have the property playerSeasons (base name: "PlayerSeasons")', function() {
      // uncomment below and update the code to test the property playerSeasons
      //var instance = new SoccerV3Scores.Round();
      //expect(instance).to.be();
    });
    ...
    it('should have the property standings (base name: "Standings")', function() {
      // uncomment below and update the code to test the property standings
      //var instance = new SoccerV3Scores.Round();
      //expect(instance).to.be();
    });
    ...
    it('should have the property teamSeasons (base name: "TeamSeasons")', function() {
      // uncomment below and update the code to test the property teamSeasons
      //var instance = new SoccerV3Scores.Round();
      //expect(instance).to.be();
    });
