...
async def test_areas_countries(client):
    ...
    response = await client.request(
        method='GET',
        path='/v3/soccer/scores/{format}/Areas'.format(format=xml),
        headers=headers,
        )
...
async def test_canceled_memberships(client):
    """Test case for canceled_memberships
    ...
    response = await client.request(
        method='GET',
        path='/v3/soccer/scores/{format}/CanceledMemberships'.format(format='format_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_competition_fixtures_league_details(client):
    ...
    response = await client.request(
        method='GET',
        path='/v3/soccer/scores/{format}/CompetitionDetails/{competition}'.format(format=xml, competition='competition_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_competition_hierarchy_league_hierarchy(client):
    ...
    response = await client.request(
        method='GET',
        path='/v3/soccer/scores/{format}/CompetitionHierarchy'.format(format=xml),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_competitions_leagues(client):
    ...
    response = await client.request(
        method='GET',
        path='/v3/soccer/scores/{format}/Competitions'.format(format=xml),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_games_by_date(client):
    ...
    response = await client.request(
        method='GET',
        path='/v3/soccer/scores/{format}/GamesByDate/{_date}'.format(format=xml, _date='_date_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_memberships_active(client):
    ...
    response = await client.request(
        method='GET',
        path='/v3/soccer/scores/{format}/ActiveMemberships'.format(format=xml),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_memberships_by_competition_active(client):
    ...
    response = await client.request(
        method='GET',
        path='/v3/soccer/scores/{format}/MembershipsByCompetition/{competition}'.format(format=xml, competition='competition_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_memberships_by_competition_historical(client):
    ...
    response = await client.request(
        method='GET',
        path='/v3/soccer/scores/{format}/HistoricalMembershipsByCompetition/{competition}'.format(format=xml, competition='competition_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_memberships_by_team_active(client):
    ...
    response = await client.request(
        method='GET',
        path='/v3/soccer/scores/{format}/MembershipsByTeam/{teamid}'.format(format=xml, teamid='teamid_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_memberships_by_team_historical(client):
    ...
    response = await client.request(
        method='GET',
        path='/v3/soccer/scores/{format}/HistoricalMembershipsByTeam/{teamid}'.format(format=xml, teamid='teamid_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_memberships_historical(client):
    ...
    response = await client.request(
        method='GET',
        path='/v3/soccer/scores/{format}/HistoricalMemberships'.format(format=xml),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_memberships_recently_changed(client):
    ...
    response = await client.request(
        method='GET',
        path='/v3/soccer/scores/{format}/RecentlyChangedMemberships/{days}'.format(format=xml, days='days_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_player(client):
    ...
    response = await client.request(
        method='GET',
        path='/v3/soccer/scores/{format}/Player/{playerid}'.format(format=xml, playerid='playerid_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_players(client):
    ...
    response = await client.request(
        method='GET',
        path='/v3/soccer/scores/{format}/Players'.format(format=xml),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_players_by_team(client):
    ...
    response = await client.request(
        method='GET',
        path='/v3/soccer/scores/{format}/PlayersByTeam/{teamid}'.format(format=xml, teamid='teamid_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_schedule(client):
    ...
    response = await client.request(
        method='GET',
        path='/v3/soccer/scores/{format}/Schedule/{roundid}'.format(format=xml, roundid='roundid_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_season_teams(client):
    ...
    response = await client.request(
        method='GET',
        path='/v3/soccer/scores/{format}/SeasonTeams/{seasonid}'.format(format=xml, seasonid='seasonid_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_standings(client):
    ...
    response = await client.request(
        method='GET',
        path='/v3/soccer/scores/{format}/Standings/{roundid}'.format(format=xml, roundid='roundid_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_team_game_stats_by_date(client):
    ...
    response = await client.request(
        method='GET',
        path='/v3/soccer/scores/{format}/TeamGameStatsByDate/{_date}'.format(format=xml, _date='_date_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_team_season_stats(client):
    ...
    response = await client.request(
        method='GET',
        path='/v3/soccer/scores/{format}/TeamSeasonStats/{roundid}'.format(format=xml, roundid='roundid_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_teams(client):
    ...
    response = await client.request(
        method='GET',
        path='/v3/soccer/scores/{format}/Teams'.format(format=xml),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_upcoming_schedule_by_player(client):
    ...
    response = await client.request(
        method='GET',
        path='/v3/soccer/scores/{format}/UpcomingScheduleByPlayer/{playerid}'.format(format=xml, playerid='playerid_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_venues(client):
    ...
    response = await client.request(
        method='GET',
        path='/v3/soccer/scores/{format}/Venues'.format(format=xml),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
