...
class CompetitionDetail(Model):
    ...
    def __init__(self, area_id: int=None, area_name: str=None, competition_id: int=None, current_season: Season=None, format: str=None, games: List[Game]=None, gender: str=None, key: str=None, name: str=None, seasons: List[Season]=None, teams: List[TeamDetail]=None, type: str=None):
        ...
        :param key: The key of this CompetitionDetail.
    ...
    @property
    def key(self):
        """Gets the key of this CompetitionDetail.


        :return: The key of this CompetitionDetail.
        :rtype: str
        """
        return self._key
    ...
    @key.setter
    def key(self, key):
        """Sets the key of this CompetitionDetail.
