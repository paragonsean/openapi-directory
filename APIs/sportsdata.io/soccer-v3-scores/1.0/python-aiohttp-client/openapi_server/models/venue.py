...
class Venue(Model):
    ...
    def __init__(self, address: str=None, capacity: int=None, city: str=None, country: str=None, geo_lat: float=None, geo_long: float=None, name: str=None, nickname1: str=None, nickname2: str=None, open: bool=None, opened: int=None, surface: str=None, venue_id: int=None, zip: str=None):
        ...
        :param surface: The surface of this Venue.
    ...
    @property
    def surface(self):
        """Gets the surface of this Venue.


        :return: The surface of this Venue.
        :rtype: str
        """
    ...
    def surface(self, surface):
        """Sets the surface of this Venue.
