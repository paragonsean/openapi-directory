...
Soccer v3 Scores
- API version: 1.0
  - Build date: 2024-10-12T10:05:19.207252-04:00[America/New_York]
...
public class Example {
  public static void main(String[] args) {
    ...
    defaultClient.setBasePath("http://azure-api.sportsdata.io/v3/soccer/scores");
...
*DefaultApi* | [**canceledMemberships**](docs/DefaultApi.md#canceledMemberships) | **GET** /{format}/CanceledMemberships | Canceled Memberships
*DefaultApi* | [**competitionFixturesLeagueDetails**](docs/DefaultApi.md#competitionFixturesLeagueDetails) | **GET** /{format}/CompetitionDetails/{competition} | Competition Fixtures (League Details)
*DefaultApi* | [**competitionHierarchyLeagueHierarchy**](docs/DefaultApi.md#competitionHierarchyLeagueHierarchy) | **GET** /{format}/CompetitionHierarchy | Competition Hierarchy (League Hierarchy)
...
*DefaultApi* | [**membershipsByCompetitionActive**](docs/DefaultApi.md#membershipsByCompetitionActive) | **GET** /{format}/MembershipsByCompetition/{competition} | Memberships by Competition (Active)
*DefaultApi* | [**membershipsByCompetitionHistorical**](docs/DefaultApi.md#membershipsByCompetitionHistorical) | **GET** /{format}/HistoricalMembershipsByCompetition/{competition} | Memberships by Competition (Historical)
...
*DefaultApi* | [**membershipsRecentlyChanged**](docs/DefaultApi.md#membershipsRecentlyChanged) | **GET** /{format}/RecentlyChangedMemberships/{days} | Memberships (Recently Changed)
...
*DefaultApi* | [**teamSeasonStats**](docs/DefaultApi.md#teamSeasonStats) | **GET** /{format}/TeamSeasonStats/{roundid} | Team Season Stats
*DefaultApi* | [**teams**](docs/DefaultApi.md#teams) | **GET** /{format}/Teams | Teams
*DefaultApi* | [**upcomingScheduleByPlayer**](docs/DefaultApi.md#upcomingScheduleByPlayer) | **GET** /{format}/UpcomingScheduleByPlayer/{playerid} | Upcoming Schedule By Player
...
## Documentation for Models
 ...
 - [Area](docs/Area.md)
 - [CanceledMembership](docs/CanceledMembership.md)
