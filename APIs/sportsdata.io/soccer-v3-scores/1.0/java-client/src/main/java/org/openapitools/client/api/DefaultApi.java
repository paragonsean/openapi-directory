...
public class DefaultApi {
    ...
    /**
     * Build call for canceledMemberships
     * @param format Desired response format. Valid entries are &lt;code&gt;XML&lt;/code&gt; or &lt;code&gt;JSON&lt;/code&gt;. (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    public okhttp3.Call canceledMembershipsCall(String format, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/{format}/CanceledMemberships"
            .replace("{" + "format" + "}", localVarApiClient.escapeString(format.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call canceledMembershipsValidateBeforeCall(String format, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'format' is set
        if (format == null) {
            throw new ApiException("Missing the required parameter 'format' when calling canceledMemberships(Async)");
        }

        return canceledMembershipsCall(format, _callback);
     ...
     */
    public CanceledMembership canceledMemberships(String format) throws ApiException {
        ApiResponse<CanceledMembership> localVarResp = canceledMembershipsWithHttpInfo(format);
        return localVarResp.getData();
    }
     ...
     * 
     * @param format Desired response format. Valid entries are &lt;code&gt;XML&lt;/code&gt; or &lt;code&gt;JSON&lt;/code&gt;. (required)
     * @return ApiResponse&lt;CanceledMembership&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<CanceledMembership> canceledMembershipsWithHttpInfo(String format) throws ApiException {
        okhttp3.Call localVarCall = canceledMembershipsValidateBeforeCall(format, null);
        Type localVarReturnType = new TypeToken<CanceledMembership>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Canceled Memberships (asynchronously)
     * 
     * @param format Desired response format. Valid entries are &lt;code&gt;XML&lt;/code&gt; or &lt;code&gt;JSON&lt;/code&gt;. (required)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
     ...
     */
    public okhttp3.Call canceledMembershipsAsync(String format, final ApiCallback<CanceledMembership> _callback) throws ApiException {

        okhttp3.Call localVarCall = canceledMembershipsValidateBeforeCall(format, _callback);
        Type localVarReturnType = new TypeToken<CanceledMembership>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
