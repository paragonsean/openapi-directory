...
public class TeamDetail {
  ...
  public TeamDetail active(Boolean active) {
    this.active = active;
    return this;
  }
  ...
  public TeamDetail address(String address) {
  ...
  public TeamDetail areaId(Integer areaId) {
    this.areaId = areaId;
    return this;
  }
  ...
  public TeamDetail areaName(String areaName) {
  ...
  public TeamDetail city(String city) {
    this.city = city;
    return this;
  }
  ...
  public TeamDetail clubColor1(String clubColor1) {
  ...
  public TeamDetail clubColor2(String clubColor2) {
  ...
  public TeamDetail clubColor3(String clubColor3) {
  ...
  public TeamDetail email(String email) {
    this.email = email;
    return this;
  }
  ...
  public TeamDetail fax(String fax) {
    this.fax = fax;
    return this;
  }
  ...
  public TeamDetail founded(Integer founded) {
  ...
  public TeamDetail fullName(String fullName) {
  ...
  public TeamDetail gender(String gender) {
    this.gender = gender;
    return this;
  }
  ...
  public TeamDetail globalTeamId(Integer globalTeamId) {
  ...
  public TeamDetail key(String key) {
    this.key = key;
    return this;
  }
  ...
  public TeamDetail nickname1(String nickname1) {
  ...
  public TeamDetail nickname2(String nickname2) {
  ...
  public TeamDetail nickname3(String nickname3) {
  ...
  public TeamDetail phone(String phone) {
    this.phone = phone;
    return this;
  }
  ...
  public TeamDetail players(List<Player> players) {
    this.players = players;
    return this;
  }

  public TeamDetail addPlayersItem(Player playersItem) {
  ...
  public TeamDetail teamId(Integer teamId) {
    this.teamId = teamId;
    return this;
  }
  ...
  public TeamDetail type(String type) {
    this.type = type;
    return this;
  }
  ...
  public TeamDetail venueId(Integer venueId) {
  ...
  public TeamDetail venueName(String venueName) {
  ...
  public TeamDetail website(String website) {
  ...
  public TeamDetail wikipediaLogoUrl(String wikipediaLogoUrl) {
  ...
  public TeamDetail wikipediaWordMarkUrl(String wikipediaWordMarkUrl) {
  ...
  public TeamDetail zip(String zip) {
    this.zip = zip;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.active, teamDetail.active) &&
        Objects.equals(this.address, teamDetail.address) &&
        Objects.equals(this.areaId, teamDetail.areaId) &&
        Objects.equals(this.areaName, teamDetail.areaName) &&
        Objects.equals(this.city, teamDetail.city) &&
        Objects.equals(this.clubColor1, teamDetail.clubColor1) &&
        Objects.equals(this.clubColor2, teamDetail.clubColor2) &&
        Objects.equals(this.clubColor3, teamDetail.clubColor3) &&
        Objects.equals(this.email, teamDetail.email) &&
        Objects.equals(this.fax, teamDetail.fax) &&
        Objects.equals(this.founded, teamDetail.founded) &&
        Objects.equals(this.fullName, teamDetail.fullName) &&
        Objects.equals(this.gender, teamDetail.gender) &&
        Objects.equals(this.globalTeamId, teamDetail.globalTeamId) &&
        Objects.equals(this.key, teamDetail.key) &&
        Objects.equals(this.name, teamDetail.name) &&
        Objects.equals(this.nickname1, teamDetail.nickname1) &&
        Objects.equals(this.nickname2, teamDetail.nickname2) &&
        Objects.equals(this.nickname3, teamDetail.nickname3) &&
        Objects.equals(this.phone, teamDetail.phone) &&
        Objects.equals(this.players, teamDetail.players) &&
        Objects.equals(this.teamId, teamDetail.teamId) &&
        Objects.equals(this.type, teamDetail.type) &&
        Objects.equals(this.venueId, teamDetail.venueId) &&
        Objects.equals(this.venueName, teamDetail.venueName) &&
        Objects.equals(this.website, teamDetail.website) &&
        Objects.equals(this.wikipediaLogoUrl, teamDetail.wikipediaLogoUrl) &&
        Objects.equals(this.wikipediaWordMarkUrl, teamDetail.wikipediaWordMarkUrl) &&
        Objects.equals(this.zip, teamDetail.zip);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(active, address, areaId, areaName, city, clubColor1, clubColor2, clubColor3, email, fax, founded, fullName, gender, globalTeamId, key, name, nickname1, nickname2, nickname3, phone, players, teamId, type, venueId, venueName, website, wikipediaLogoUrl, wikipediaWordMarkUrl, zip);
  }
