...
qint32 OAIMembership::getJersey() const {
    return m_jersey;
}
void OAIMembership::setJersey(const qint32 &jersey) {
    m_jersey = jersey;
    m_jersey_isSet = true;
}

bool OAIMembership::is_jersey_Set() const{
    return m_jersey_isSet;
}

bool OAIMembership::is_jersey_Valid() const{
