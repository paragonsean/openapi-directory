...
QString OAICompetition::getKey() const {
    return m_key;
}
void OAICompetition::setKey(const QString &key) {
    m_key = key;
    m_key_isSet = true;
}

bool OAICompetition::is_key_Set() const{
    return m_key_isSet;
}

bool OAICompetition::is_key_Valid() const{
