...
QString OAICompetitionDetail::getKey() const {
    return m_key;
}
void OAICompetitionDetail::setKey(const QString &key) {
    m_key = key;
    m_key_isSet = true;
}

bool OAICompetitionDetail::is_key_Set() const{
    return m_key_isSet;
}

bool OAICompetitionDetail::is_key_Valid() const{
