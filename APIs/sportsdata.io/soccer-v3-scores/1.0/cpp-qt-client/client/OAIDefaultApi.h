...
public:
    ...
    * @param[in]  format QString [required]
    */
    virtual void canceledMemberships(const QString &format);

    /**
    * @param[in]  format QString [required]
    * @param[in]  competition QString [required]
    */
    virtual void competitionFixturesLeagueDetails(const QString &format, const QString &competition);

    /**
    * @param[in]  format QString [required]
    */
    virtual void competitionHierarchyLeagueHierarchy(const QString &format);
    ...
    * @param[in]  competition QString [required]
    */
    virtual void membershipsByCompetitionActive(const QString &format, const QString &competition);

    /**
    * @param[in]  format QString [required]
    * @param[in]  competition QString [required]
    */
    virtual void membershipsByCompetitionHistorical(const QString &format, const QString &competition);
    ...
    */
    ...
    /**
    * @param[in]  format QString [required]
    * @param[in]  days QString [required]
    */
    virtual void membershipsRecentlyChanged(const QString &format, const QString &days);
    ...
    * @param[in]  roundid QString [required]
    */
    virtual void teamSeasonStats(const QString &format, const QString &roundid);
    ...
    * @param[in]  playerid QString [required]
    */
    virtual void upcomingScheduleByPlayer(const QString &format, const QString &playerid);
...
private:
    ...
    void canceledMembershipsCallback(OAIHttpRequestWorker *worker);
    void competitionFixturesLeagueDetailsCallback(OAIHttpRequestWorker *worker);
    void competitionHierarchyLeagueHierarchyCallback(OAIHttpRequestWorker *worker);
    ...
    void membershipsByCompetitionActiveCallback(OAIHttpRequestWorker *worker);
    void membershipsByCompetitionHistoricalCallback(OAIHttpRequestWorker *worker);
    ...
    void membershipsRecentlyChangedCallback(OAIHttpRequestWorker *worker);
    ...
    void upcomingScheduleByPlayerCallback(OAIHttpRequestWorker *worker);
    void venuesCallback(OAIHttpRequestWorker *worker);

Q_SIGNALS:

    void areasCountriesSignal(QList<OAIArea> summary);
    void canceledMembershipsSignal(OAICanceledMembership summary);
    void competitionFixturesLeagueDetailsSignal(OAICompetitionDetail summary);
    void competitionHierarchyLeagueHierarchySignal(QList<OAIArea> summary);
    ...
    void membershipsByCompetitionActiveSignal(QList<OAIMembership> summary);
    void membershipsByCompetitionHistoricalSignal(QList<OAIMembership> summary);
    ...
    void membershipsRecentlyChangedSignal(QList<OAIMembership> summary);
    ...
    void upcomingScheduleByPlayerSignal(QList<OAIGame> summary);
    void venuesSignal(QList<OAIVenue> summary);


    void areasCountriesSignalFull(OAIHttpRequestWorker *worker, QList<OAIArea> summary);
    void canceledMembershipsSignalFull(OAIHttpRequestWorker *worker, OAICanceledMembership summary);
    void competitionFixturesLeagueDetailsSignalFull(OAIHttpRequestWorker *worker, OAICompetitionDetail summary);
    void competitionHierarchyLeagueHierarchySignalFull(OAIHttpRequestWorker *worker, QList<OAIArea> summary);
    ...
    void membershipsByCompetitionActiveSignalFull(OAIHttpRequestWorker *worker, QList<OAIMembership> summary);
    void membershipsByCompetitionHistoricalSignalFull(OAIHttpRequestWorker *worker, QList<OAIMembership> summary);
    ...
    void membershipsRecentlyChangedSignalFull(OAIHttpRequestWorker *worker, QList<OAIMembership> summary);
    ...
    void upcomingScheduleByPlayerSignalFull(OAIHttpRequestWorker *worker, QList<OAIGame> summary);
    ...
    Q_DECL_DEPRECATED_X("Use canceledMembershipsSignalError() instead")
    void canceledMembershipsSignalE(OAICanceledMembership summary, QNetworkReply::NetworkError error_type, QString error_str);
    void canceledMembershipsSignalError(OAICanceledMembership summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use competitionHierarchyLeagueHierarchySignalError() instead")
    void competitionHierarchyLeagueHierarchySignalE(QList<OAIArea> summary, QNetworkReply::NetworkError error_type, QString error_str);
    void competitionHierarchyLeagueHierarchySignalError(QList<OAIArea> summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use membershipsByCompetitionActiveSignalError() instead")
    void membershipsByCompetitionActiveSignalE(QList<OAIMembership> summary, QNetworkReply::NetworkError error_type, QString error_str);
    void membershipsByCompetitionActiveSignalError(QList<OAIMembership> summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use membershipsByCompetitionHistoricalSignalError() instead")
    void membershipsByCompetitionHistoricalSignalE(QList<OAIMembership> summary, QNetworkReply::NetworkError error_type, QString error_str);
    void membershipsByCompetitionHistoricalSignalError(QList<OAIMembership> summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use membershipsRecentlyChangedSignalError() instead")
    void membershipsRecentlyChangedSignalE(QList<OAIMembership> summary, QNetworkReply::NetworkError error_type, QString error_str);
    void membershipsRecentlyChangedSignalError(QList<OAIMembership> summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use upcomingScheduleByPlayerSignalError() instead")
    void upcomingScheduleByPlayerSignalE(QList<OAIGame> summary, QNetworkReply::NetworkError error_type, QString error_str);
    void upcomingScheduleByPlayerSignalError(QList<OAIGame> summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use canceledMembershipsSignalErrorFull() instead")
    void canceledMembershipsSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void canceledMembershipsSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use competitionHierarchyLeagueHierarchySignalErrorFull() instead")
    void competitionHierarchyLeagueHierarchySignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void competitionHierarchyLeagueHierarchySignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use membershipsByCompetitionActiveSignalErrorFull() instead")
    void membershipsByCompetitionActiveSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void membershipsByCompetitionActiveSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use membershipsByCompetitionHistoricalSignalErrorFull() instead")
    void membershipsByCompetitionHistoricalSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void membershipsByCompetitionHistoricalSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use membershipsRecentlyChangedSignalErrorFull() instead")
    void membershipsRecentlyChangedSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void membershipsRecentlyChangedSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use upcomingScheduleByPlayerSignalErrorFull() instead")
    void upcomingScheduleByPlayerSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void upcomingScheduleByPlayerSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
