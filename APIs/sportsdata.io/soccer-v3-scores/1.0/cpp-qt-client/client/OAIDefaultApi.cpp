...
void OAIDefaultApi::initializeServerConfigs() {
    ...
    QUrl("http://azure-api.sportsdata.io/v3/soccer/scores"),
    "No description provided",
    QMap<QString, OAIServerVariable>()));
    defaultConf.append(OAIServerConfiguration(
    QUrl("https://azure-api.sportsdata.io/v3/soccer/scores"),
    "No description provided",
    QMap<QString, OAIServerVariable>()));
    _serverConfigs.insert("areasCountries", defaultConf);
    _serverIndices.insert("areasCountries", 0);
    _serverConfigs.insert("canceledMemberships", defaultConf);
    _serverIndices.insert("canceledMemberships", 0);
...
void OAIDefaultApi::canceledMemberships(const QString &format) {
    QString fullPath = QString(_serverConfigs["canceledMemberships"][_serverIndices.value("canceledMemberships")].URL()+"/{format}/CanceledMemberships");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIDefaultApi::canceledMembershipsCallback);
    connect(this, &OAIDefaultApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIDefaultApi::canceledMembershipsCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    OAICanceledMembership output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT canceledMembershipsSignal(output);
        Q_EMIT canceledMembershipsSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT canceledMembershipsSignalE(output, error_type, error_str);
        Q_EMIT canceledMembershipsSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT canceledMembershipsSignalError(output, error_type, error_str);
        Q_EMIT canceledMembershipsSignalErrorFull(worker, error_type, error_str);
    }
}
