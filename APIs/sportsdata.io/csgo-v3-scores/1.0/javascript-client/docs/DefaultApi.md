...
```javascript
import CsgoV3Scores from 'csgo_v3_scores';
let defaultClient = CsgoV3Scores.ApiClient.instance;
...
let apiInstance = new CsgoV3Scores.DefaultApi();
