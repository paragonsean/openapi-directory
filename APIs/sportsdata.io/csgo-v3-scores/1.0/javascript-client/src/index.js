...
* <pre>
* var CsgoV3Scores = require('index'); // See note below*.
* var xxxSvc = new CsgoV3Scores.XxxApi(); // Allocate the API class we're going to use.
* var yyyModel = new CsgoV3Scores.Yyy(); // Construct a model instance.
...
* <pre>
* var xxxSvc = new CsgoV3Scores.XxxApi(); // Allocate the API class we're going to use.
* var yyy = new CsgoV3Scores.Yyy(); // Construct a model instance.
* yyyModel.someProperty = 'someValue';
* ...
* var zzz = xxxSvc.doSomething(yyyModel); // Invoke the service.
* ...
