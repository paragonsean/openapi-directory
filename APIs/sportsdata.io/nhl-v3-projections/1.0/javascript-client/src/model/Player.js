...
class Player {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('Catches')) {
                obj['Catches'] = ApiClient.convertToType(data['Catches'], 'String');
            }
            if (data.hasOwnProperty('DepthChartOrder')) {
                obj['DepthChartOrder'] = ApiClient.convertToType(data['DepthChartOrder'], 'Number');
            }
            if (data.hasOwnProperty('DepthChartPosition')) {
                obj['DepthChartPosition'] = ApiClient.convertToType(data['DepthChartPosition'], 'String');
            }
    ...
    static validateJSON(data) {
        ...
        // ensure the json data is a string
        if (data['Catches'] && !(typeof data['Catches'] === 'string' || data['Catches'] instanceof String)) {
            throw new Error("Expected the field `Catches` to be a primitive type in the JSON string but got " + data['Catches']);
        }
        // ensure the json data is a string
        if (data['DepthChartPosition'] && !(typeof data['DepthChartPosition'] === 'string' || data['DepthChartPosition'] instanceof String)) {
            throw new Error("Expected the field `DepthChartPosition` to be a primitive type in the JSON string but got " + data['DepthChartPosition']);
        }
        // ensure the json data is a string
...
/**
 * @member {String} Catches
 */
Player.prototype['Catches'] = undefined;

/**
 * @member {Number} DepthChartOrder
 */
Player.prototype['DepthChartOrder'] = undefined;

/**
 * @member {String} DepthChartPosition
 */
Player.prototype['DepthChartPosition'] = undefined;
 ...
 */
Player.prototype['Shoots'] = undefined;
