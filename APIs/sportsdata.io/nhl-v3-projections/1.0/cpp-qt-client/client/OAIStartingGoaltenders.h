...
/*
 * OAIStartingGoaltenders.h
 *
 * 
 */

#ifndef OAIStartingGoaltenders_H
#define OAIStartingGoaltenders_H
...
class OAIStartingGoaltenders : public OAIObject {
public:
    OAIStartingGoaltenders();
    OAIStartingGoaltenders(QString json);
    ~OAIStartingGoaltenders() override;
    ...
    OAIGoaltender getAwayGoaltender() const;
    void setAwayGoaltender(const OAIGoaltender &away_goaltender);
    bool is_away_goaltender_Set() const;
    bool is_away_goaltender_Valid() const;
    ...
    OAIGoaltender getHomeGoaltender() const;
    void setHomeGoaltender(const OAIGoaltender &home_goaltender);
    bool is_home_goaltender_Set() const;
    bool is_home_goaltender_Valid() const;
...
private:
    ...
    OAIGoaltender m_away_goaltender;
    bool m_away_goaltender_isSet;
    bool m_away_goaltender_isValid;
    ...
    OAIGoaltender m_home_goaltender;
    bool m_home_goaltender_isSet;
    bool m_home_goaltender_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStartingGoaltenders)

#endif // OAIStartingGoaltenders_H
