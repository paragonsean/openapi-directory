...
void OAITeam::initializeModel() {
    ...
    m_nba_dot_com_team_id_isSet = false;
    m_nba_dot_com_team_id_isValid = false;
...
void OAITeam::fromJsonObject(QJsonObject json) {
    ...
    m_league_id_isValid = ::OpenAPI::fromJsonValue(m_league_id, json[QString("LeagueID")]);
    m_league_id_isSet = !json[QString("LeagueID")].isNull() && m_league_id_isValid;

    m_name_isValid = ::OpenAPI::fromJsonValue(m_name, json[QString("Name")]);
    m_name_isSet = !json[QString("Name")].isNull() && m_name_isValid;

    m_nba_dot_com_team_id_isValid = ::OpenAPI::fromJsonValue(m_nba_dot_com_team_id, json[QString("NbaDotComTeamID")]);
    m_nba_dot_com_team_id_isSet = !json[QString("NbaDotComTeamID")].isNull() && m_nba_dot_com_team_id_isValid;
...
QJsonObject OAITeam::asJsonObject() const {
    ...
    if (m_league_id_isSet) {
        obj.insert(QString("LeagueID"), ::OpenAPI::toJsonValue(m_league_id));
    }
    if (m_name_isSet) {
        obj.insert(QString("Name"), ::OpenAPI::toJsonValue(m_name));
    }
    if (m_nba_dot_com_team_id_isSet) {
        obj.insert(QString("NbaDotComTeamID"), ::OpenAPI::toJsonValue(m_nba_dot_com_team_id));
    }
...
qint32 OAITeam::getLeagueId() const {
    return m_league_id;
}
void OAITeam::setLeagueId(const qint32 &league_id) {
    m_league_id = league_id;
    m_league_id_isSet = true;
}

bool OAITeam::is_league_id_Set() const{
    return m_league_id_isSet;
}

bool OAITeam::is_league_id_Valid() const{
...
qint32 OAITeam::getNbaDotComTeamId() const {
    return m_nba_dot_com_team_id;
}
void OAITeam::setNbaDotComTeamId(const qint32 &nba_dot_com_team_id) {
    m_nba_dot_com_team_id = nba_dot_com_team_id;
    m_nba_dot_com_team_id_isSet = true;
}

bool OAITeam::is_nba_dot_com_team_id_Set() const{
    return m_nba_dot_com_team_id_isSet;
}

bool OAITeam::is_nba_dot_com_team_id_Valid() const{
    return m_nba_dot_com_team_id_isValid;
}
