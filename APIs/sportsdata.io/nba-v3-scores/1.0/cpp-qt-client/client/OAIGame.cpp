...
void OAIGame::initializeModel() {
    ...
    m_crew_chief_id_isSet = false;
    m_crew_chief_id_isValid = false;
    ...
    m_umpire_id_isSet = false;
    m_umpire_id_isValid = false;
...
void OAIGame::fromJsonObject(QJsonObject json) {
    ...
    m_crew_chief_id_isValid = ::OpenAPI::fromJsonValue(m_crew_chief_id, json[QString("CrewChiefID")]);
    m_crew_chief_id_isSet = !json[QString("CrewChiefID")].isNull() && m_crew_chief_id_isValid;
    ...
    m_umpire_id_isValid = ::OpenAPI::fromJsonValue(m_umpire_id, json[QString("UmpireID")]);
    m_umpire_id_isSet = !json[QString("UmpireID")].isNull() && m_umpire_id_isValid;
...
QJsonObject OAIGame::asJsonObject() const {
    ...
    if (m_crew_chief_id_isSet) {
        obj.insert(QString("CrewChiefID"), ::OpenAPI::toJsonValue(m_crew_chief_id));
    }
    ...
    if (m_umpire_id_isSet) {
        obj.insert(QString("UmpireID"), ::OpenAPI::toJsonValue(m_umpire_id));
    }
...
qint32 OAIGame::getAlternateId() const {
    return m_alternate_id;
}
void OAIGame::setAlternateId(const qint32 &alternate_id) {
    m_alternate_id = alternate_id;
    m_alternate_id_isSet = true;
}

bool OAIGame::is_alternate_id_Set() const{
    return m_alternate_id_isSet;
}

bool OAIGame::is_alternate_id_Valid() const{
...
qint32 OAIGame::getCrewChiefId() const {
    return m_crew_chief_id;
}
void OAIGame::setCrewChiefId(const qint32 &crew_chief_id) {
    m_crew_chief_id = crew_chief_id;
    m_crew_chief_id_isSet = true;
}

bool OAIGame::is_crew_chief_id_Set() const{
    return m_crew_chief_id_isSet;
}

bool OAIGame::is_crew_chief_id_Valid() const{
    return m_crew_chief_id_isValid;
}
...
QString OAIGame::getQuarter() const {
    return m_quarter;
}
void OAIGame::setQuarter(const QString &quarter) {
    m_quarter = quarter;
    m_quarter_isSet = true;
}

bool OAIGame::is_quarter_Set() const{
    return m_quarter_isSet;
}

bool OAIGame::is_quarter_Valid() const{
    return m_quarter_isValid;
}

QList<OAIQuarter> OAIGame::getQuarters() const {
    return m_quarters;
}
void OAIGame::setQuarters(const QList<OAIQuarter> &quarters) {
    m_quarters = quarters;
    m_quarters_isSet = true;
}

bool OAIGame::is_quarters_Set() const{
    return m_quarters_isSet;
}

bool OAIGame::is_quarters_Valid() const{
    return m_quarters_isValid;
}

qint32 OAIGame::getRefereeId() const {
    return m_referee_id;
}
void OAIGame::setRefereeId(const qint32 &referee_id) {
    m_referee_id = referee_id;
    m_referee_id_isSet = true;
}

bool OAIGame::is_referee_id_Set() const{
    return m_referee_id_isSet;
}

bool OAIGame::is_referee_id_Valid() const{
...
qint32 OAIGame::getUmpireId() const {
    return m_umpire_id;
}
void OAIGame::setUmpireId(const qint32 &umpire_id) {
    m_umpire_id = umpire_id;
    m_umpire_id_isSet = true;
}

bool OAIGame::is_umpire_id_Set() const{
    return m_umpire_id_isSet;
}

bool OAIGame::is_umpire_id_Valid() const{
    return m_umpire_id_isValid;
}
