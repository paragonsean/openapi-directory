...
public:
    ...
    qint32 getAwayTeamScore2() const;
    void setAwayTeamScore2(const qint32 &away_team_score2);
    bool is_away_team_score2_Set() const;
    bool is_away_team_score2_Valid() const;
    ...
    qint32 getHomeTeamScore2() const;
    void setHomeTeamScore2(const qint32 &home_team_score2);
    bool is_home_team_score2_Set() const;
    bool is_home_team_score2_Valid() const;
...
private:
    ...
    qint32 m_away_team_score2;
    bool m_away_team_score2_isSet;
    bool m_away_team_score2_isValid;
    ...
    qint32 m_home_team_score2;
    bool m_home_team_score2_isSet;
    bool m_home_team_score2_isValid;
