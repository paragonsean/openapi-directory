...
class ScheduleBasic(Model):
    ...
    def __init__(self, away_team: str=None, away_team_id: int=None, away_team_score: int=None, date_time: str=None, date_time_utc: str=None, day: str=None, game_id: int=None, global_away_team_id: int=None, global_game_id: int=None, global_home_team_id: int=None, home_team: str=None, home_team_id: int=None, home_team_score: int=None, is_closed: bool=None, neutral_venue: bool=None, season: int=None, season_type: int=None, stadium_id: int=None, status: str=None, updated: str=None):
