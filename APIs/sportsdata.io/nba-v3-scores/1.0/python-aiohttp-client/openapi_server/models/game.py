...
class Game(Model):
    ...
    def __init__(self, alternate_id: int=None, attendance: int=None, away_rotation_number: int=None, away_team: str=None, away_team_id: int=None, away_team_money_line: int=None, away_team_score: int=None, channel: str=None, crew_chief_id: int=None, date_time: str=None, date_time_utc: str=None, day: str=None, game_end_date_time: str=None, game_id: int=None, global_away_team_id: int=None, global_game_id: int=None, global_home_team_id: int=None, home_rotation_number: int=None, home_team: str=None, home_team_id: int=None, home_team_money_line: int=None, home_team_score: int=None, is_closed: bool=None, last_play: str=None, neutral_venue: bool=None, over_payout: int=None, over_under: float=None, point_spread: float=None, point_spread_away_team_money_line: int=None, point_spread_home_team_money_line: int=None, quarter: str=None, quarters: List[Quarter]=None, referee_id: int=None, season: int=None, season_type: int=None, series_info: Series=None, stadium_id: int=None, status: str=None, time_remaining_minutes: int=None, time_remaining_seconds: int=None, umpire_id: int=None, under_payout: int=None, updated: str=None):
        """Game - a model defined in OpenAPI

        :param alternate_id: The alternate_id of this Game.
        ...
        :param crew_chief_id: The crew_chief_id of this Game.
        ...
        :param quarter: The quarter of this Game.
        :param quarters: The quarters of this Game.
        :param referee_id: The referee_id of this Game.
        ...
        :param umpire_id: The umpire_id of this Game.
        ...
        self._crew_chief_id = crew_chief_id
    ...
    def alternate_id(self):
        """Gets the alternate_id of this Game.


        :return: The alternate_id of this Game.
        :rtype: int
        """
    ...
    def alternate_id(self, alternate_id):
        """Sets the alternate_id of this Game.
    ...
    @property
    def crew_chief_id(self):
        """Gets the crew_chief_id of this Game.


        :return: The crew_chief_id of this Game.
        :rtype: int
        """
        return self._crew_chief_id

    @crew_chief_id.setter
    def crew_chief_id(self, crew_chief_id):
        """Sets the crew_chief_id of this Game.


        :param crew_chief_id: The crew_chief_id of this Game.
        :type crew_chief_id: int
        """
    ...
    @property
    def quarter(self):
        """Gets the quarter of this Game.


        :return: The quarter of this Game.
        :rtype: str
        """
    ...
    @property
    def quarters(self):
        """Gets the quarters of this Game.


        :return: The quarters of this Game.
        :rtype: List[Quarter]
        """
    ...
    def quarters(self, quarters):
        """Sets the quarters of this Game.
    ...
    @property
    def referee_id(self):
        """Gets the referee_id of this Game.


        :return: The referee_id of this Game.
        :rtype: int
        """
    ...
    def referee_id(self, referee_id):
        """Sets the referee_id of this Game.
    ...
    @property
    def umpire_id(self):
        """Gets the umpire_id of this Game.


        :return: The umpire_id of this Game.
        :rtype: int
        """
        return self._umpire_id

    @umpire_id.setter
    def umpire_id(self, umpire_id):
        """Sets the umpire_id of this Game.
