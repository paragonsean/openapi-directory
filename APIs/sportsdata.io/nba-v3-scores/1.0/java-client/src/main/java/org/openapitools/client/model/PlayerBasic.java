...
public class PlayerBasic {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(birthCity, birthCountry, birthDate, birthState, firstName, globalTeamID, height, jersey, lastName, playerID, position, positionCategory, sportsDataID, status, team, teamID, weight);
  }
