...
public class ScheduleBasic {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(awayTeam, awayTeamID, awayTeamScore, dateTime, dateTimeUTC, day, gameID, globalAwayTeamID, globalGameID, globalHomeTeamID, homeTeam, homeTeamID, homeTeamScore, isClosed, neutralVenue, season, seasonType, stadiumID, status, updated);
  }
