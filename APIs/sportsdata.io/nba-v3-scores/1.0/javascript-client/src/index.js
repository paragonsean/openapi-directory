...
* <pre>
* var NbaV3Scores = require('index'); // See note below*.
* var xxxSvc = new NbaV3Scores.XxxApi(); // Allocate the API class we're going to use.
* var yyyModel = new NbaV3Scores.Yyy(); // Construct a model instance.
...
* <pre>
* var xxxSvc = new NbaV3Scores.XxxApi(); // Allocate the API class we're going to use.
* var yyy = new NbaV3Scores.Yyy(); // Construct a model instance.
* yyyModel.someProperty = 'someValue';
* ...
* var zzz = xxxSvc.doSomething(yyyModel); // Invoke the service.
* ...
