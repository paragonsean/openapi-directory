    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('LeagueID')) {
                obj['LeagueID'] = ApiClient.convertToType(data['LeagueID'], 'Number');
            }
            if (data.hasOwnProperty('Name')) {
                obj['Name'] = ApiClient.convertToType(data['Name'], 'String');
            }
            if (data.hasOwnProperty('NbaDotComTeamID')) {
                obj['NbaDotComTeamID'] = ApiClient.convertToType(data['NbaDotComTeamID'], 'Number');
            }
 ...
 */
Team.prototype['LeagueID'] = undefined;
...
/**
 * @member {Number} NbaDotComTeamID
 */
Team.prototype['NbaDotComTeamID'] = undefined;
