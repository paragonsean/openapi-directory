...
(function(root, factory) {
  ...
  describe('Team', function() {
    it('should create an instance of Team', function() {
      ...
      //var instance = new NbaV3Scores.Team();
      //expect(instance).to.be.a(NbaV3Scores.Team);
    });
    ...
    it('should have the property nbaDotComTeamID (base name: "NbaDotComTeamID")', function() {
      // uncomment below and update the code to test the property nbaDotComTeamID
      //var instance = new NbaV3Scores.Team();
      //expect(instance).to.be();
    });
