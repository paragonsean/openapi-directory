...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    factory(root.expect, root.NbaV3RotoBallerArticles);
  }
}(this, function(expect, NbaV3RotoBallerArticles) {
  'use strict';

  var instance;

  beforeEach(function() {
    instance = new NbaV3RotoBallerArticles.Article();
  });
  ...
  describe('Article', function() {
    it('should create an instance of Article', function() {
      ...
      //var instance = new NbaV3RotoBallerArticles.Article();
      //expect(instance).to.be.a(NbaV3RotoBallerArticles.Article);
    });
