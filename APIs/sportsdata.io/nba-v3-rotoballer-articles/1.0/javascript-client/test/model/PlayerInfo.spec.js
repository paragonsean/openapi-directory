...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NbaV3RotoBallerArticles.PlayerInfo();
  });
  ...
  describe('PlayerInfo', function() {
    it('should create an instance of PlayerInfo', function() {
      ...
      //var instance = new NbaV3RotoBallerArticles.PlayerInfo();
      //expect(instance).to.be.a(NbaV3RotoBallerArticles.PlayerInfo);
    });
