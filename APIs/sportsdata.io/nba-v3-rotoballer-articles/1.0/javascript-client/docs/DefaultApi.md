# NbaV3RotoBallerArticles.DefaultApi
...
```javascript
import NbaV3RotoBallerArticles from 'nba_v3_roto_baller_articles';
let defaultClient = NbaV3RotoBallerArticles.ApiClient.instance;
...
let apiInstance = new NbaV3RotoBallerArticles.DefaultApi();
