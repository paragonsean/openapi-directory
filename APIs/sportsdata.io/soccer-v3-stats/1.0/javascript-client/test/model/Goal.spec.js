...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SoccerV3Stats.Goal();
  });
  ...
  describe('Goal', function() {
    it('should create an instance of Goal', function() {
      ...
      //var instance = new SoccerV3Stats.Goal();
      //expect(instance).to.be.a(SoccerV3Stats.Goal);
    });
    ...
    it('should have the property assistedByPlayerName1 (base name: "AssistedByPlayerName1")', function() {
      // uncomment below and update the code to test the property assistedByPlayerName1
      //var instance = new SoccerV3Stats.Goal();
      //expect(instance).to.be();
    });

    it('should have the property assistedByPlayerName2 (base name: "AssistedByPlayerName2")', function() {
      // uncomment below and update the code to test the property assistedByPlayerName2
      //var instance = new SoccerV3Stats.Goal();
      //expect(instance).to.be();
    });
