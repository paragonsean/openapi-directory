...
public class Area {
  ...
  public static final String SERIALIZED_NAME_COMPETITIONS = "Competitions";
  @SerializedName(SERIALIZED_NAME_COMPETITIONS)
  ...
  public Area competitions(List<Competition> competitions) {
    this.competitions = competitions;
    return this;
  }

  public Area addCompetitionsItem(Competition competitionsItem) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.areaId, area.areaId) &&
        Objects.equals(this.competitions, area.competitions) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(areaId, competitions, countryCode, name);
  }
  ...
  static {
    ...
    openapiFields.add("Competitions");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("Competitions") != null && !jsonObj.get("Competitions").isJsonNull()) {
        JsonArray jsonArraycompetitions = jsonObj.getAsJsonArray("Competitions");
        if (jsonArraycompetitions != null) {
          // ensure the json data is an array
          if (!jsonObj.get("Competitions").isJsonArray()) {
            throw new IllegalArgumentException(String.format("Expected the field `Competitions` to be an array in the JSON string but got `%s`", jsonObj.get("Competitions").toString()));
          }

          // validate the optional field `Competitions` (array)
          for (int i = 0; i < jsonArraycompetitions.size(); i++) {
            Competition.validateJsonElement(jsonArraycompetitions.get(i));
          };
        }
      }
