...
public class Lineup {
  ...
  public static final String SERIALIZED_NAME_LINEUP_ID = "LineupId";
  @SerializedName(SERIALIZED_NAME_LINEUP_ID)
  ...
  public static final String SERIALIZED_NAME_PITCH_POSITION_HORIZONTAL = "PitchPositionHorizontal";
  @SerializedName(SERIALIZED_NAME_PITCH_POSITION_HORIZONTAL)
  private Integer pitchPositionHorizontal;

  public static final String SERIALIZED_NAME_PITCH_POSITION_VERTICAL = "PitchPositionVertical";
  @SerializedName(SERIALIZED_NAME_PITCH_POSITION_VERTICAL)
  ...
  public static final String SERIALIZED_NAME_REPLACED_PLAYER_ID = "ReplacedPlayerId";
  @SerializedName(SERIALIZED_NAME_REPLACED_PLAYER_ID)
  private Integer replacedPlayerId;

  public static final String SERIALIZED_NAME_REPLACED_PLAYER_NAME = "ReplacedPlayerName";
  @SerializedName(SERIALIZED_NAME_REPLACED_PLAYER_NAME)
  ...
  public Lineup gameId(Integer gameId) {
    this.gameId = gameId;
    return this;
  }
  ...
  public Lineup gameMinute(Integer gameMinute) {
  ...
  public Lineup gameMinuteExtra(Integer gameMinuteExtra) {
  ...
  public Lineup lineupId(Integer lineupId) {
  ...
  public Lineup name(String name) {
    this.name = name;
    return this;
  }
  ...
  public Lineup pitchPositionHorizontal(Integer pitchPositionHorizontal) {
    this.pitchPositionHorizontal = pitchPositionHorizontal;
    return this;
  }

  /**
   * Get pitchPositionHorizontal
  ...
  public Lineup pitchPositionVertical(Integer pitchPositionVertical) {
    this.pitchPositionVertical = pitchPositionVertical;
    return this;
  }

  /**
   * Get pitchPositionVertical
  ...
  public Lineup replacedPlayerId(Integer replacedPlayerId) {
    this.replacedPlayerId = replacedPlayerId;
    return this;
  }

  /**
   * Get replacedPlayerId
  ...
  public Lineup replacedPlayerName(String replacedPlayerName) {
    this.replacedPlayerName = replacedPlayerName;
    return this;
  }

  /**
   * Get replacedPlayerName
  ...
  public Lineup type(String type) {
    this.type = type;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.gameId, lineup.gameId) &&
        Objects.equals(this.gameMinute, lineup.gameMinute) &&
        Objects.equals(this.gameMinuteExtra, lineup.gameMinuteExtra) &&
        Objects.equals(this.lineupId, lineup.lineupId) &&
        Objects.equals(this.name, lineup.name) &&
        Objects.equals(this.pitchPositionHorizontal, lineup.pitchPositionHorizontal) &&
        Objects.equals(this.pitchPositionVertical, lineup.pitchPositionVertical) &&
        Objects.equals(this.playerId, lineup.playerId) &&
        Objects.equals(this.position, lineup.position) &&
        Objects.equals(this.replacedPlayerId, lineup.replacedPlayerId) &&
        Objects.equals(this.replacedPlayerName, lineup.replacedPlayerName) &&
        Objects.equals(this.teamId, lineup.teamId) &&
        Objects.equals(this.type, lineup.type);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(gameId, gameMinute, gameMinuteExtra, lineupId, name, pitchPositionHorizontal, pitchPositionVertical, playerId, position, replacedPlayerId, replacedPlayerName, teamId, type);
  }
  ...
  public String toString() {
    ...
    sb.append("    lineupId: ").append(toIndentedString(lineupId)).append("\n");
    sb.append("    name: ").append(toIndentedString(name)).append("\n");
    sb.append("    pitchPositionHorizontal: ").append(toIndentedString(pitchPositionHorizontal)).append("\n");
    sb.append("    pitchPositionVertical: ").append(toIndentedString(pitchPositionVertical)).append("\n");
    sb.append("    playerId: ").append(toIndentedString(playerId)).append("\n");
    sb.append("    position: ").append(toIndentedString(position)).append("\n");
    sb.append("    replacedPlayerId: ").append(toIndentedString(replacedPlayerId)).append("\n");
    sb.append("    replacedPlayerName: ").append(toIndentedString(replacedPlayerName)).append("\n");
  ...
  static {
    ...
    openapiFields.add("LineupId");
    openapiFields.add("Name");
    openapiFields.add("PitchPositionHorizontal");
    openapiFields.add("PitchPositionVertical");
    openapiFields.add("PlayerId");
    openapiFields.add("Position");
    openapiFields.add("ReplacedPlayerId");
    openapiFields.add("ReplacedPlayerName");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if ((jsonObj.get("ReplacedPlayerName") != null && !jsonObj.get("ReplacedPlayerName").isJsonNull()) && !jsonObj.get("ReplacedPlayerName").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `ReplacedPlayerName` to be a primitive type in the JSON string but got `%s`", jsonObj.get("ReplacedPlayerName").toString()));
      }
