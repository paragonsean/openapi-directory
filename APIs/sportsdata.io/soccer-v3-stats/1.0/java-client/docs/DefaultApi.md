...
public class Example {
  public static void main(String[] args) {
    ...
    defaultClient.setBasePath("http://azure-api.sportsdata.io/v3/soccer/stats");
...
public class Example {
  public static void main(String[] args) {
    ...
    DefaultApi apiInstance = new DefaultApi(defaultClient);
    String format = "xml"; // String | Desired response format. Valid entries are <code>XML</code> or <code>JSON</code>.
    String gameid = "gameid_example"; // String | The GameID of a Soccer game.  GameIDs can be found in the Games API.  Valid entries are <code>702</code>, <code>1274</code>, etc.
    try {
...
<a id="boxScoresByDateByCompetition"></a>
# **boxScoresByDateByCompetition**
> List&lt;BoxScore&gt; boxScoresByDateByCompetition(format, competition, date)
...
public class Example {
  public static void main(String[] args) {
    ...
    String date = "date_example"; // String | The date of the game(s). <br>Examples: <code>2017-02-27</code>, <code>2017-09-01</code>.
    try {
      List<BoxScore> result = apiInstance.boxScoresByDateByCompetition(format, competition, date);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling DefaultApi#boxScoresByDateByCompetition");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="boxScoresDeltaByDateByCompetition"></a>
# **boxScoresDeltaByDateByCompetition**
> List&lt;BoxScore&gt; boxScoresDeltaByDateByCompetition(format, competition, date, minutes)
...
public class Example {
  public static void main(String[] args) {
    ...
    String minutes = "minutes_example"; // String | Only returns player statistics that have changed in the last X minutes.  You specify how many minutes in time to go back. Valid entries are: <code>1</code>, <code>2</code> ... <code>all</code>.
    try {
      List<BoxScore> result = apiInstance.boxScoresDeltaByDateByCompetition(format, competition, date, minutes);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling DefaultApi#boxScoresDeltaByDateByCompetition");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
public class Example {
  public static void main(String[] args) {
    ...
    String competition = "competition_example"; // String | An indication of a soccer competition/league. This value can be the CompetitionId or the Competition Key. Possible values include: <code>EPL</code>, <code>1</code>, <code>MLS</code>, <code>8</code>, etc.
    try {
      CompetitionDetail result = apiInstance.competitionFixturesLeagueDetails(format, competition);
      System.out.println(result);
    } catch (ApiException e) {
...
<a id="competitionHierarchyLeagueHierarchy"></a>
# **competitionHierarchyLeagueHierarchy**
> List&lt;Area&gt; competitionHierarchyLeagueHierarchy(format)
...
public class Example {
  public static void main(String[] args) {
    ...
    String format = "xml"; // String | Desired response format. Valid entries are <code>XML</code> or <code>JSON</code>.
    try {
      List<Area> result = apiInstance.competitionHierarchyLeagueHierarchy(format);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling DefaultApi#competitionHierarchyLeagueHierarchy");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="membershipsByCompetitionActive"></a>
# **membershipsByCompetitionActive**
> List&lt;Membership&gt; membershipsByCompetitionActive(format, competition)
...
public class Example {
  public static void main(String[] args) {
    ...
    String competition = "competition_example"; // String | An indication of a soccer competition/league. This value can be the CompetitionId or the Competition Key. Possible values include: <code>EPL</code>, <code>1</code>, <code>MLS</code>, <code>8</code>, etc.
    try {
      List<Membership> result = apiInstance.membershipsByCompetitionActive(format, competition);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling DefaultApi#membershipsByCompetitionActive");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="membershipsByCompetitionHistorical"></a>
# **membershipsByCompetitionHistorical**
> List&lt;Membership&gt; membershipsByCompetitionHistorical(format, competition)
...
public class Example {
  public static void main(String[] args) {
    ...
    String competition = "competition_example"; // String | An indication of a soccer competition/league. This value can be the CompetitionId or the Competition Key. Possible values include: <code>EPL</code>, <code>1</code>, <code>MLS</code>, <code>8</code>, etc.
    try {
      List<Membership> result = apiInstance.membershipsByCompetitionHistorical(format, competition);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling DefaultApi#membershipsByCompetitionHistorical");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
public class Example {
  public static void main(String[] args) {
    ...
    DefaultApi apiInstance = new DefaultApi(defaultClient);
    String format = "xml"; // String | Desired response format. Valid entries are <code>XML</code> or <code>JSON</code>.
    String teamid = "teamid_example"; // String | Unique FantasyData Team ID.  Example:<code>516</code>.
    try {
...
<a id="membershipsRecentlyChanged"></a>
# **membershipsRecentlyChanged**
> List&lt;Membership&gt; membershipsRecentlyChanged(format, days)
...
public class Example {
  public static void main(String[] args) {
    ...
    DefaultApi apiInstance = new DefaultApi(defaultClient);
    String format = "xml"; // String | Desired response format. Valid entries are <code>XML</code> or <code>JSON</code>.
    String days = "days_example"; // String | The number of days since memberships were updated. For example, if you pass <code>3</code>, you'll receive all memberships that have been updated in the past 3 days. Valid entries are: <code>1</code>, <code>2</code> ... <code>30</code>
    try {
      List<Membership> result = apiInstance.membershipsRecentlyChanged(format, days);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling DefaultApi#membershipsRecentlyChanged");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
> List&lt;PlayerGame&gt; playerGameStatsByPlayer(format, date, playerid)
...
public class Example {
  public static void main(String[] args) {
    ...
    String playerid = "playerid_example"; // String | Unique FantasyData Player ID. Example:<code>90026231</code>.
    try {
      List<PlayerGame> result = apiInstance.playerGameStatsByPlayer(format, date, playerid);
      System.out.println(result);
    } catch (ApiException e) {
...
# **playerSeasonStats**
> List&lt;PlayerSeason&gt; playerSeasonStats(format, roundid)
...
public class Example {
  public static void main(String[] args) {
    ...
    DefaultApi apiInstance = new DefaultApi(defaultClient);
    String format = "xml"; // String | Desired response format. Valid entries are <code>XML</code> or <code>JSON</code>.
    String roundid = "roundid_example"; // String | Unique FantasyData Round ID. RoundIDs can be found in the Competition Hierarchy (League Hierarchy).  Examples: <code>1</code>, <code>2</code>, <code>3</code>, etc
    try {
      List<PlayerSeason> result = apiInstance.playerSeasonStats(format, roundid);
      System.out.println(result);
    } catch (ApiException e) {
...
> List&lt;PlayerSeason&gt; playerSeasonStatsByPlayer(format, roundid, playerid)
...
public class Example {
  public static void main(String[] args) {
    ...
    String playerid = "playerid_example"; // String | Unique FantasyData Player ID. Example:<code>90026231</code>.
    try {
      List<PlayerSeason> result = apiInstance.playerSeasonStatsByPlayer(format, roundid, playerid);
      System.out.println(result);
    } catch (ApiException e) {
...
> List&lt;PlayerSeason&gt; playerSeasonStatsByTeam(format, roundid, team)
...
public class Example {
  public static void main(String[] args) {
    ...
    String format = "xml"; // String | Desired response format. Valid entries are <code>XML</code> or <code>JSON</code>.
    String roundid = "roundid_example"; // String | Unique FantasyData Round ID. RoundIDs can be found in the Competition Hierarchy (League Hierarchy).  Examples: <code>1</code>, <code>2</code>, <code>3</code>, etc
    String team = "team_example"; // String | Unique FantasyData Team ID.  Example:<code>516</code>.
    try {
      List<PlayerSeason> result = apiInstance.playerSeasonStatsByTeam(format, roundid, team);
      System.out.println(result);
    } catch (ApiException e) {
...
public class Example {
  public static void main(String[] args) {
    ...
    DefaultApi apiInstance = new DefaultApi(defaultClient);
    String format = "xml"; // String | Desired response format. Valid entries are <code>XML</code> or <code>JSON</code>.
    String seasonid = "seasonid_example"; // String | Unique FantasyData Season ID. SeasonIDs can be found in the Competition Hierarchy (League Hierarchy).  Examples: <code>1</code>, <code>2</code>, <code>3</code>, etc
    try {
...
# **teamSeasonStats**
> List&lt;TeamSeason&gt; teamSeasonStats(format, roundid)
...
public class Example {
  public static void main(String[] args) {
    ...
    String roundid = "roundid_example"; // String | Unique FantasyData Round ID. RoundIDs can be found in the Competition Hierarchy (League Hierarchy).  Examples: <code>1</code>, <code>2</code>, <code>3</code>, etc
    try {
      List<TeamSeason> result = apiInstance.teamSeasonStats(format, roundid);
      System.out.println(result);
    } catch (ApiException e) {
...
public class Example {
  public static void main(String[] args) {
    ...
    DefaultApi apiInstance = new DefaultApi(defaultClient);
    String format = "json"; // String | Desired response format. Valid entries are <code>XML</code> or <code>JSON</code>.
    String competitionId = "competitionId_example"; // String | The id of the competition. <br>Examples: <code>3</code>
    try {
...
<a id="upcomingScheduleByPlayer"></a>
# **upcomingScheduleByPlayer**
> List&lt;Game&gt; upcomingScheduleByPlayer(format, playerid)
...
public class Example {
  public static void main(String[] args) {
    ...
    String playerid = "playerid_example"; // String | Unique FantasyData Player ID. Example:<code>90026231</code>.
    try {
      List<Game> result = apiInstance.upcomingScheduleByPlayer(format, playerid);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling DefaultApi#upcomingScheduleByPlayer");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
