...
void OAIDefaultApi::initializeServerConfigs() {
    ...
    QUrl("http://azure-api.sportsdata.io/v3/soccer/stats"),
    "No description provided",
    QMap<QString, OAIServerVariable>()));
    defaultConf.append(OAIServerConfiguration(
    QUrl("https://azure-api.sportsdata.io/v3/soccer/stats"),
    "No description provided",
    QMap<QString, OAIServerVariable>()));
    ...
    _serverConfigs.insert("boxScoresByDateByCompetition", defaultConf);
    _serverIndices.insert("boxScoresByDateByCompetition", 0);
    _serverConfigs.insert("boxScoresByDateDelta", defaultConf);
    _serverIndices.insert("boxScoresByDateDelta", 0);
    _serverConfigs.insert("boxScoresDeltaByDateByCompetition", defaultConf);
    _serverIndices.insert("boxScoresDeltaByDateByCompetition", 0);
    ...
    _serverConfigs.insert("competitionHierarchyLeagueHierarchy", defaultConf);
    _serverIndices.insert("competitionHierarchyLeagueHierarchy", 0);
    ...
    _serverConfigs.insert("membershipsByCompetitionActive", defaultConf);
    _serverIndices.insert("membershipsByCompetitionActive", 0);
    _serverConfigs.insert("membershipsByCompetitionHistorical", defaultConf);
    _serverIndices.insert("membershipsByCompetitionHistorical", 0);
    ...
    _serverConfigs.insert("membershipsRecentlyChanged", defaultConf);
    _serverIndices.insert("membershipsRecentlyChanged", 0);
    ...
    _serverConfigs.insert("upcomingDfsSlatesByCompetition", defaultConf);
    _serverIndices.insert("upcomingDfsSlatesByCompetition", 0);
    _serverConfigs.insert("upcomingScheduleByPlayer", defaultConf);
    _serverIndices.insert("upcomingScheduleByPlayer", 0);
...
void OAIDefaultApi::boxScoresByDateByCompetition(const QString &format, const QString &competition, const QString &date) {
    QString fullPath = QString(_serverConfigs["boxScoresByDateByCompetition"][_serverIndices.value("boxScoresByDateByCompetition")].URL()+"/{format}/BoxScoresByCompetition/{competition}/{date}");
    ...
    {
        QString competitionPathParam("{");
        competitionPathParam.append("competition").append("}");
        QString pathPrefix, pathSuffix, pathDelimiter;
        QString pathStyle = "simple";
        if (pathStyle == "")
            pathStyle = "simple";
        pathPrefix = getParamStylePrefix(pathStyle);
        pathSuffix = getParamStyleSuffix(pathStyle);
        pathDelimiter = getParamStyleDelimiter(pathStyle, "competition", false);
        QString paramString = (pathStyle == "matrix") ? pathPrefix+"competition"+pathSuffix : pathPrefix;
        fullPath.replace(competitionPathParam, paramString+QUrl::toPercentEncoding(::OpenAPI::toStringValue(competition)));
    }
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIDefaultApi::boxScoresByDateByCompetitionCallback);
    connect(this, &OAIDefaultApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIDefaultApi::boxScoresByDateByCompetitionCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT boxScoresByDateByCompetitionSignal(output);
        Q_EMIT boxScoresByDateByCompetitionSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT boxScoresByDateByCompetitionSignalE(output, error_type, error_str);
        Q_EMIT boxScoresByDateByCompetitionSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT boxScoresByDateByCompetitionSignalError(output, error_type, error_str);
        Q_EMIT boxScoresByDateByCompetitionSignalErrorFull(worker, error_type, error_str);
    }
}
...
void OAIDefaultApi::boxScoresDeltaByDateByCompetition(const QString &format, const QString &competition, const QString &date, const QString &minutes) {
    QString fullPath = QString(_serverConfigs["boxScoresDeltaByDateByCompetition"][_serverIndices.value("boxScoresDeltaByDateByCompetition")].URL()+"/{format}/BoxScoresDeltaByCompetition/{competition}/{date}/{minutes}");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIDefaultApi::boxScoresDeltaByDateByCompetitionCallback);
    connect(this, &OAIDefaultApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIDefaultApi::boxScoresDeltaByDateByCompetitionCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT boxScoresDeltaByDateByCompetitionSignal(output);
        Q_EMIT boxScoresDeltaByDateByCompetitionSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT boxScoresDeltaByDateByCompetitionSignalE(output, error_type, error_str);
        Q_EMIT boxScoresDeltaByDateByCompetitionSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT boxScoresDeltaByDateByCompetitionSignalError(output, error_type, error_str);
        Q_EMIT boxScoresDeltaByDateByCompetitionSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIDefaultApi::competitionFixturesLeagueDetails(const QString &format, const QString &competition) {
    QString fullPath = QString(_serverConfigs["competitionFixturesLeagueDetails"][_serverIndices.value("competitionFixturesLeagueDetails")].URL()+"/{format}/CompetitionDetails/{competition}");
...
void OAIDefaultApi::competitionHierarchyLeagueHierarchy(const QString &format) {
    QString fullPath = QString(_serverConfigs["competitionHierarchyLeagueHierarchy"][_serverIndices.value("competitionHierarchyLeagueHierarchy")].URL()+"/{format}/CompetitionHierarchy");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIDefaultApi::competitionHierarchyLeagueHierarchyCallback);
    connect(this, &OAIDefaultApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIDefaultApi::competitionHierarchyLeagueHierarchyCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT competitionHierarchyLeagueHierarchySignal(output);
        Q_EMIT competitionHierarchyLeagueHierarchySignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT competitionHierarchyLeagueHierarchySignalE(output, error_type, error_str);
        Q_EMIT competitionHierarchyLeagueHierarchySignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT competitionHierarchyLeagueHierarchySignalError(output, error_type, error_str);
        Q_EMIT competitionHierarchyLeagueHierarchySignalErrorFull(worker, error_type, error_str);
    }
}
...
void OAIDefaultApi::membershipsByCompetitionActive(const QString &format, const QString &competition) {
    QString fullPath = QString(_serverConfigs["membershipsByCompetitionActive"][_serverIndices.value("membershipsByCompetitionActive")].URL()+"/{format}/MembershipsByCompetition/{competition}");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIDefaultApi::membershipsByCompetitionActiveCallback);
    connect(this, &OAIDefaultApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIDefaultApi::membershipsByCompetitionActiveCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT membershipsByCompetitionActiveSignal(output);
        Q_EMIT membershipsByCompetitionActiveSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT membershipsByCompetitionActiveSignalE(output, error_type, error_str);
        Q_EMIT membershipsByCompetitionActiveSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT membershipsByCompetitionActiveSignalError(output, error_type, error_str);
        Q_EMIT membershipsByCompetitionActiveSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIDefaultApi::membershipsByCompetitionHistorical(const QString &format, const QString &competition) {
    QString fullPath = QString(_serverConfigs["membershipsByCompetitionHistorical"][_serverIndices.value("membershipsByCompetitionHistorical")].URL()+"/{format}/HistoricalMembershipsByCompetition/{competition}");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIDefaultApi::membershipsByCompetitionHistoricalCallback);
    connect(this, &OAIDefaultApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIDefaultApi::membershipsByCompetitionHistoricalCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT membershipsByCompetitionHistoricalSignal(output);
        Q_EMIT membershipsByCompetitionHistoricalSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT membershipsByCompetitionHistoricalSignalE(output, error_type, error_str);
        Q_EMIT membershipsByCompetitionHistoricalSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT membershipsByCompetitionHistoricalSignalError(output, error_type, error_str);
        Q_EMIT membershipsByCompetitionHistoricalSignalErrorFull(worker, error_type, error_str);
    }
}
...
void OAIDefaultApi::membershipsRecentlyChanged(const QString &format, const QString &days) {
    QString fullPath = QString(_serverConfigs["membershipsRecentlyChanged"][_serverIndices.value("membershipsRecentlyChanged")].URL()+"/{format}/RecentlyChangedMemberships/{days}");
    ...
    {
        QString daysPathParam("{");
        daysPathParam.append("days").append("}");
        QString pathPrefix, pathSuffix, pathDelimiter;
        QString pathStyle = "simple";
        if (pathStyle == "")
            pathStyle = "simple";
        pathPrefix = getParamStylePrefix(pathStyle);
        pathSuffix = getParamStyleSuffix(pathStyle);
        pathDelimiter = getParamStyleDelimiter(pathStyle, "days", false);
        QString paramString = (pathStyle == "matrix") ? pathPrefix+"days"+pathSuffix : pathPrefix;
        fullPath.replace(daysPathParam, paramString+QUrl::toPercentEncoding(::OpenAPI::toStringValue(days)));
    }
    OAIHttpRequestWorker *worker = new OAIHttpRequestWorker(this, _manager);
    worker->setTimeOut(_timeOut);
    worker->setWorkingDirectory(_workingDirectory);
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIDefaultApi::membershipsRecentlyChangedCallback);
    connect(this, &OAIDefaultApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIDefaultApi::membershipsRecentlyChangedCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT membershipsRecentlyChangedSignal(output);
        Q_EMIT membershipsRecentlyChangedSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT membershipsRecentlyChangedSignalE(output, error_type, error_str);
        Q_EMIT membershipsRecentlyChangedSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT membershipsRecentlyChangedSignalError(output, error_type, error_str);
        Q_EMIT membershipsRecentlyChangedSignalErrorFull(worker, error_type, error_str);
    }
}
...
void OAIDefaultApi::playerSeasonStats(const QString &format, const QString &roundid) {
    QString fullPath = QString(_serverConfigs["playerSeasonStats"][_serverIndices.value("playerSeasonStats")].URL()+"/{format}/PlayerSeasonStats/{roundid}");
...
void OAIDefaultApi::playerSeasonStatsByPlayer(const QString &format, const QString &roundid, const QString &playerid) {
    QString fullPath = QString(_serverConfigs["playerSeasonStatsByPlayer"][_serverIndices.value("playerSeasonStatsByPlayer")].URL()+"/{format}/PlayerSeasonStatsByPlayer/{roundid}/{playerid}");
...
void OAIDefaultApi::playerSeasonStatsByTeam(const QString &format, const QString &roundid, const QString &team) {
    QString fullPath = QString(_serverConfigs["playerSeasonStatsByTeam"][_serverIndices.value("playerSeasonStatsByTeam")].URL()+"/{format}/PlayerSeasonStatsByTeam/{roundid}/{team}");
...
void OAIDefaultApi::teamSeasonStats(const QString &format, const QString &roundid) {
    QString fullPath = QString(_serverConfigs["teamSeasonStats"][_serverIndices.value("teamSeasonStats")].URL()+"/{format}/TeamSeasonStats/{roundid}");
...
void OAIDefaultApi::upcomingDfsSlatesByCompetition(const QString &format, const QString &competition_id) {
    QString fullPath = QString(_serverConfigs["upcomingDfsSlatesByCompetition"][_serverIndices.value("upcomingDfsSlatesByCompetition")].URL()+"/{format}/UpcomingDfsSlatesByCompetition/{competitionId}");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIDefaultApi::upcomingDfsSlatesByCompetitionCallback);
    connect(this, &OAIDefaultApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIDefaultApi::upcomingDfsSlatesByCompetitionCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT upcomingDfsSlatesByCompetitionSignal(output);
        Q_EMIT upcomingDfsSlatesByCompetitionSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT upcomingDfsSlatesByCompetitionSignalE(output, error_type, error_str);
        Q_EMIT upcomingDfsSlatesByCompetitionSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT upcomingDfsSlatesByCompetitionSignalError(output, error_type, error_str);
        Q_EMIT upcomingDfsSlatesByCompetitionSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIDefaultApi::upcomingScheduleByPlayer(const QString &format, const QString &playerid) {
    QString fullPath = QString(_serverConfigs["upcomingScheduleByPlayer"][_serverIndices.value("upcomingScheduleByPlayer")].URL()+"/{format}/UpcomingScheduleByPlayer/{playerid}");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIDefaultApi::upcomingScheduleByPlayerCallback);
    connect(this, &OAIDefaultApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIDefaultApi::upcomingScheduleByPlayerCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT upcomingScheduleByPlayerSignal(output);
        Q_EMIT upcomingScheduleByPlayerSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT upcomingScheduleByPlayerSignalE(output, error_type, error_str);
        Q_EMIT upcomingScheduleByPlayerSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT upcomingScheduleByPlayerSignalError(output, error_type, error_str);
        Q_EMIT upcomingScheduleByPlayerSignalErrorFull(worker, error_type, error_str);
    }
}
