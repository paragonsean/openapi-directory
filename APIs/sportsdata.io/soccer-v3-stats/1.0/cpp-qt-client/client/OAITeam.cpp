...
QString OAITeam::getClubColor1() const {
    return m_club_color1;
}
void OAITeam::setClubColor1(const QString &club_color1) {
    m_club_color1 = club_color1;
    m_club_color1_isSet = true;
}

bool OAITeam::is_club_color1_Set() const{
    return m_club_color1_isSet;
}

bool OAITeam::is_club_color1_Valid() const{
    return m_club_color1_isValid;
}

QString OAITeam::getClubColor2() const {
    return m_club_color2;
}
void OAITeam::setClubColor2(const QString &club_color2) {
    m_club_color2 = club_color2;
    m_club_color2_isSet = true;
}

bool OAITeam::is_club_color2_Set() const{
    return m_club_color2_isSet;
}

bool OAITeam::is_club_color2_Valid() const{
    return m_club_color2_isValid;
}

QString OAITeam::getClubColor3() const {
    return m_club_color3;
}
void OAITeam::setClubColor3(const QString &club_color3) {
    m_club_color3 = club_color3;
    m_club_color3_isSet = true;
}

bool OAITeam::is_club_color3_Set() const{
    return m_club_color3_isSet;
}

bool OAITeam::is_club_color3_Valid() const{
...
QString OAITeam::getFax() const {
    return m_fax;
}
void OAITeam::setFax(const QString &fax) {
    m_fax = fax;
    m_fax_isSet = true;
}

bool OAITeam::is_fax_Set() const{
    return m_fax_isSet;
}

bool OAITeam::is_fax_Valid() const{
...
QString OAITeam::getNickname1() const {
    return m_nickname1;
}
void OAITeam::setNickname1(const QString &nickname1) {
    m_nickname1 = nickname1;
    m_nickname1_isSet = true;
}

bool OAITeam::is_nickname1_Set() const{
    return m_nickname1_isSet;
}

bool OAITeam::is_nickname1_Valid() const{
    return m_nickname1_isValid;
}

QString OAITeam::getNickname2() const {
    return m_nickname2;
}
void OAITeam::setNickname2(const QString &nickname2) {
    m_nickname2 = nickname2;
    m_nickname2_isSet = true;
}

bool OAITeam::is_nickname2_Set() const{
    return m_nickname2_isSet;
}

bool OAITeam::is_nickname2_Valid() const{
    return m_nickname2_isValid;
}

QString OAITeam::getNickname3() const {
    return m_nickname3;
}
void OAITeam::setNickname3(const QString &nickname3) {
    m_nickname3 = nickname3;
    m_nickname3_isSet = true;
}

bool OAITeam::is_nickname3_Set() const{
    return m_nickname3_isSet;
}

bool OAITeam::is_nickname3_Valid() const{
    return m_nickname3_isValid;
}

QString OAITeam::getPhone() const {
    return m_phone;
}
void OAITeam::setPhone(const QString &phone) {
    m_phone = phone;
    m_phone_isSet = true;
}

bool OAITeam::is_phone_Set() const{
    return m_phone_isSet;
}

bool OAITeam::is_phone_Valid() const{
...
qint32 OAITeam::getVenueId() const {
    return m_venue_id;
}
void OAITeam::setVenueId(const qint32 &venue_id) {
    m_venue_id = venue_id;
    m_venue_id_isSet = true;
}

bool OAITeam::is_venue_id_Set() const{
    return m_venue_id_isSet;
}

bool OAITeam::is_venue_id_Valid() const{
    return m_venue_id_isValid;
}

QString OAITeam::getVenueName() const {
    return m_venue_name;
}
void OAITeam::setVenueName(const QString &venue_name) {
    m_venue_name = venue_name;
    m_venue_name_isSet = true;
}

bool OAITeam::is_venue_name_Set() const{
    return m_venue_name_isSet;
}

bool OAITeam::is_venue_name_Valid() const{
...
QString OAITeam::getZip() const {
    return m_zip;
}
void OAITeam::setZip(const QString &zip) {
    m_zip = zip;
    m_zip_isSet = true;
}

bool OAITeam::is_zip_Set() const{
    return m_zip_isSet;
}

bool OAITeam::is_zip_Valid() const{
