...
double OAIPlayerSeason::getCornersWon() const {
    return m_corners_won;
}
void OAIPlayerSeason::setCornersWon(const double &corners_won) {
    m_corners_won = corners_won;
    m_corners_won_isSet = true;
}

bool OAIPlayerSeason::is_corners_won_Set() const{
    return m_corners_won_isSet;
}

bool OAIPlayerSeason::is_corners_won_Valid() const{
    return m_corners_won_isValid;
}

double OAIPlayerSeason::getCrosses() const {
    return m_crosses;
}
void OAIPlayerSeason::setCrosses(const double &crosses) {
    m_crosses = crosses;
    m_crosses_isSet = true;
}

bool OAIPlayerSeason::is_crosses_Set() const{
    return m_crosses_isSet;
}

bool OAIPlayerSeason::is_crosses_Valid() const{
    return m_crosses_isValid;
}

double OAIPlayerSeason::getDefenderCleanSheets() const {
    return m_defender_clean_sheets;
}
void OAIPlayerSeason::setDefenderCleanSheets(const double &defender_clean_sheets) {
    m_defender_clean_sheets = defender_clean_sheets;
    m_defender_clean_sheets_isSet = true;
}

bool OAIPlayerSeason::is_defender_clean_sheets_Set() const{
    return m_defender_clean_sheets_isSet;
}

bool OAIPlayerSeason::is_defender_clean_sheets_Valid() const{
...
double OAIPlayerSeason::getFantasyPointsMondogoal() const {
    return m_fantasy_points_mondogoal;
}
void OAIPlayerSeason::setFantasyPointsMondogoal(const double &fantasy_points_mondogoal) {
    m_fantasy_points_mondogoal = fantasy_points_mondogoal;
    m_fantasy_points_mondogoal_isSet = true;
}

bool OAIPlayerSeason::is_fantasy_points_mondogoal_Set() const{
    return m_fantasy_points_mondogoal_isSet;
}

bool OAIPlayerSeason::is_fantasy_points_mondogoal_Valid() const{
...
double OAIPlayerSeason::getFouled() const {
    return m_fouled;
}
void OAIPlayerSeason::setFouled(const double &fouled) {
    m_fouled = fouled;
    m_fouled_isSet = true;
}

bool OAIPlayerSeason::is_fouled_Set() const{
    return m_fouled_isSet;
}

bool OAIPlayerSeason::is_fouled_Valid() const{
    return m_fouled_isValid;
}

double OAIPlayerSeason::getFouls() const {
    return m_fouls;
}
void OAIPlayerSeason::setFouls(const double &fouls) {
    m_fouls = fouls;
    m_fouls_isSet = true;
}

bool OAIPlayerSeason::is_fouls_Set() const{
    return m_fouls_isSet;
}

bool OAIPlayerSeason::is_fouls_Valid() const{
...
double OAIPlayerSeason::getGoalkeeperCleanSheets() const {
    return m_goalkeeper_clean_sheets;
}
void OAIPlayerSeason::setGoalkeeperCleanSheets(const double &goalkeeper_clean_sheets) {
    m_goalkeeper_clean_sheets = goalkeeper_clean_sheets;
    m_goalkeeper_clean_sheets_isSet = true;
}

bool OAIPlayerSeason::is_goalkeeper_clean_sheets_Set() const{
    return m_goalkeeper_clean_sheets_isSet;
}

bool OAIPlayerSeason::is_goalkeeper_clean_sheets_Valid() const{
    return m_goalkeeper_clean_sheets_isValid;
}

double OAIPlayerSeason::getGoalkeeperGoalsAgainst() const {
    return m_goalkeeper_goals_against;
}
void OAIPlayerSeason::setGoalkeeperGoalsAgainst(const double &goalkeeper_goals_against) {
    m_goalkeeper_goals_against = goalkeeper_goals_against;
    m_goalkeeper_goals_against_isSet = true;
}

bool OAIPlayerSeason::is_goalkeeper_goals_against_Set() const{
    return m_goalkeeper_goals_against_isSet;
}

bool OAIPlayerSeason::is_goalkeeper_goals_against_Valid() const{
    return m_goalkeeper_goals_against_isValid;
}

double OAIPlayerSeason::getGoalkeeperSaves() const {
    return m_goalkeeper_saves;
}
void OAIPlayerSeason::setGoalkeeperSaves(const double &goalkeeper_saves) {
    m_goalkeeper_saves = goalkeeper_saves;
    m_goalkeeper_saves_isSet = true;
}

bool OAIPlayerSeason::is_goalkeeper_saves_Set() const{
    return m_goalkeeper_saves_isSet;
}

bool OAIPlayerSeason::is_goalkeeper_saves_Valid() const{
    return m_goalkeeper_saves_isValid;
}

double OAIPlayerSeason::getGoalkeeperSingleGoalAgainst() const {
    return m_goalkeeper_single_goal_against;
}
void OAIPlayerSeason::setGoalkeeperSingleGoalAgainst(const double &goalkeeper_single_goal_against) {
    m_goalkeeper_single_goal_against = goalkeeper_single_goal_against;
    m_goalkeeper_single_goal_against_isSet = true;
}

bool OAIPlayerSeason::is_goalkeeper_single_goal_against_Set() const{
    return m_goalkeeper_single_goal_against_isSet;
}

bool OAIPlayerSeason::is_goalkeeper_single_goal_against_Valid() const{
    return m_goalkeeper_single_goal_against_isValid;
}

double OAIPlayerSeason::getGoalkeeperWins() const {
    return m_goalkeeper_wins;
}
void OAIPlayerSeason::setGoalkeeperWins(const double &goalkeeper_wins) {
    m_goalkeeper_wins = goalkeeper_wins;
    m_goalkeeper_wins_isSet = true;
}

bool OAIPlayerSeason::is_goalkeeper_wins_Set() const{
    return m_goalkeeper_wins_isSet;
}

bool OAIPlayerSeason::is_goalkeeper_wins_Valid() const{
...
double OAIPlayerSeason::getInterceptions() const {
    return m_interceptions;
}
void OAIPlayerSeason::setInterceptions(const double &interceptions) {
    m_interceptions = interceptions;
    m_interceptions_isSet = true;
}

bool OAIPlayerSeason::is_interceptions_Set() const{
    return m_interceptions_isSet;
}

bool OAIPlayerSeason::is_interceptions_Valid() const{
    return m_interceptions_isValid;
}

double OAIPlayerSeason::getLastManTackle() const {
    return m_last_man_tackle;
}
void OAIPlayerSeason::setLastManTackle(const double &last_man_tackle) {
    m_last_man_tackle = last_man_tackle;
    m_last_man_tackle_isSet = true;
}

bool OAIPlayerSeason::is_last_man_tackle_Set() const{
    return m_last_man_tackle_isSet;
}

bool OAIPlayerSeason::is_last_man_tackle_Valid() const{
    return m_last_man_tackle_isValid;
}

double OAIPlayerSeason::getMinutes() const {
    return m_minutes;
}
void OAIPlayerSeason::setMinutes(const double &minutes) {
    m_minutes = minutes;
...
double OAIPlayerSeason::getOffsides() const {
    return m_offsides;
}
void OAIPlayerSeason::setOffsides(const double &offsides) {
    m_offsides = offsides;
    m_offsides_isSet = true;
}

bool OAIPlayerSeason::is_offsides_Set() const{
    return m_offsides_isSet;
}

bool OAIPlayerSeason::is_offsides_Valid() const{
    return m_offsides_isValid;
}

double OAIPlayerSeason::getOpponentScore() const {
    return m_opponent_score;
}
void OAIPlayerSeason::setOpponentScore(const double &opponent_score) {
    m_opponent_score = opponent_score;
    m_opponent_score_isSet = true;
}

bool OAIPlayerSeason::is_opponent_score_Set() const{
    return m_opponent_score_isSet;
}

bool OAIPlayerSeason::is_opponent_score_Valid() const{
    return m_opponent_score_isValid;
}

double OAIPlayerSeason::getOwnGoals() const {
    return m_own_goals;
}
void OAIPlayerSeason::setOwnGoals(const double &own_goals) {
    m_own_goals = own_goals;
    m_own_goals_isSet = true;
}

bool OAIPlayerSeason::is_own_goals_Set() const{
    return m_own_goals_isSet;
}

bool OAIPlayerSeason::is_own_goals_Valid() const{
    return m_own_goals_isValid;
}

double OAIPlayerSeason::getPasses() const {
    return m_passes;
}
void OAIPlayerSeason::setPasses(const double &passes) {
    m_passes = passes;
    m_passes_isSet = true;
}

bool OAIPlayerSeason::is_passes_Set() const{
    return m_passes_isSet;
}

bool OAIPlayerSeason::is_passes_Valid() const{
    return m_passes_isValid;
}

double OAIPlayerSeason::getPassesCompleted() const {
    return m_passes_completed;
}
void OAIPlayerSeason::setPassesCompleted(const double &passes_completed) {
    m_passes_completed = passes_completed;
    m_passes_completed_isSet = true;
}

bool OAIPlayerSeason::is_passes_completed_Set() const{
    return m_passes_completed_isSet;
}

bool OAIPlayerSeason::is_passes_completed_Valid() const{
    return m_passes_completed_isValid;
}

double OAIPlayerSeason::getPenaltiesConceded() const {
    return m_penalties_conceded;
}
void OAIPlayerSeason::setPenaltiesConceded(const double &penalties_conceded) {
    m_penalties_conceded = penalties_conceded;
    m_penalties_conceded_isSet = true;
}

bool OAIPlayerSeason::is_penalties_conceded_Set() const{
    return m_penalties_conceded_isSet;
}

bool OAIPlayerSeason::is_penalties_conceded_Valid() const{
    return m_penalties_conceded_isValid;
}

double OAIPlayerSeason::getPenaltiesWon() const {
    return m_penalties_won;
}
void OAIPlayerSeason::setPenaltiesWon(const double &penalties_won) {
    m_penalties_won = penalties_won;
    m_penalties_won_isSet = true;
}

bool OAIPlayerSeason::is_penalties_won_Set() const{
    return m_penalties_won_isSet;
}

bool OAIPlayerSeason::is_penalties_won_Valid() const{
    return m_penalties_won_isValid;
}

double OAIPlayerSeason::getPenaltyKickGoals() const {
    return m_penalty_kick_goals;
}
void OAIPlayerSeason::setPenaltyKickGoals(const double &penalty_kick_goals) {
    m_penalty_kick_goals = penalty_kick_goals;
    m_penalty_kick_goals_isSet = true;
}

bool OAIPlayerSeason::is_penalty_kick_goals_Set() const{
    return m_penalty_kick_goals_isSet;
}

bool OAIPlayerSeason::is_penalty_kick_goals_Valid() const{
    return m_penalty_kick_goals_isValid;
}

double OAIPlayerSeason::getPenaltyKickMisses() const {
    return m_penalty_kick_misses;
}
void OAIPlayerSeason::setPenaltyKickMisses(const double &penalty_kick_misses) {
    m_penalty_kick_misses = penalty_kick_misses;
    m_penalty_kick_misses_isSet = true;
}

bool OAIPlayerSeason::is_penalty_kick_misses_Set() const{
    return m_penalty_kick_misses_isSet;
}

bool OAIPlayerSeason::is_penalty_kick_misses_Valid() const{
    return m_penalty_kick_misses_isValid;
}

double OAIPlayerSeason::getPenaltyKickSaves() const {
    return m_penalty_kick_saves;
}
void OAIPlayerSeason::setPenaltyKickSaves(const double &penalty_kick_saves) {
    m_penalty_kick_saves = penalty_kick_saves;
    m_penalty_kick_saves_isSet = true;
}

bool OAIPlayerSeason::is_penalty_kick_saves_Set() const{
    return m_penalty_kick_saves_isSet;
}

bool OAIPlayerSeason::is_penalty_kick_saves_Valid() const{
...
double OAIPlayerSeason::getRedCards() const {
    return m_red_cards;
}
void OAIPlayerSeason::setRedCards(const double &red_cards) {
    m_red_cards = red_cards;
    m_red_cards_isSet = true;
}

bool OAIPlayerSeason::is_red_cards_Set() const{
    return m_red_cards_isSet;
}

bool OAIPlayerSeason::is_red_cards_Valid() const{
    return m_red_cards_isValid;
}

qint32 OAIPlayerSeason::getRoundId() const {
    return m_round_id;
}
void OAIPlayerSeason::setRoundId(const qint32 &round_id) {
    m_round_id = round_id;
    m_round_id_isSet = true;
}

bool OAIPlayerSeason::is_round_id_Set() const{
    return m_round_id_isSet;
}

bool OAIPlayerSeason::is_round_id_Valid() const{
    return m_round_id_isValid;
}

double OAIPlayerSeason::getScore() const {
    return m_score;
}
void OAIPlayerSeason::setScore(const double &score) {
    m_score = score;
    m_score_isSet = true;
}

bool OAIPlayerSeason::is_score_Set() const{
    return m_score_isSet;
}

bool OAIPlayerSeason::is_score_Valid() const{
...
QString OAIPlayerSeason::getShortName() const {
    return m_short_name;
}
void OAIPlayerSeason::setShortName(const QString &short_name) {
    m_short_name = short_name;
    m_short_name_isSet = true;
}

bool OAIPlayerSeason::is_short_name_Set() const{
    return m_short_name_isSet;
}

bool OAIPlayerSeason::is_short_name_Valid() const{
    return m_short_name_isValid;
}

double OAIPlayerSeason::getShots() const {
    return m_shots;
}
void OAIPlayerSeason::setShots(const double &shots) {
    m_shots = shots;
    m_shots_isSet = true;
}

bool OAIPlayerSeason::is_shots_Set() const{
    return m_shots_isSet;
}

bool OAIPlayerSeason::is_shots_Valid() const{
...
double OAIPlayerSeason::getTackles() const {
    return m_tackles;
}
void OAIPlayerSeason::setTackles(const double &tackles) {
    m_tackles = tackles;
    m_tackles_isSet = true;
}

bool OAIPlayerSeason::is_tackles_Set() const{
    return m_tackles_isSet;
}

bool OAIPlayerSeason::is_tackles_Valid() const{
    return m_tackles_isValid;
}

double OAIPlayerSeason::getTacklesWon() const {
    return m_tackles_won;
}
void OAIPlayerSeason::setTacklesWon(const double &tackles_won) {
    m_tackles_won = tackles_won;
    m_tackles_won_isSet = true;
}

bool OAIPlayerSeason::is_tackles_won_Set() const{
    return m_tackles_won_isSet;
}

bool OAIPlayerSeason::is_tackles_won_Valid() const{
...
double OAIPlayerSeason::getTouches() const {
    return m_touches;
}
void OAIPlayerSeason::setTouches(const double &touches) {
    m_touches = touches;
    m_touches_isSet = true;
}

bool OAIPlayerSeason::is_touches_Set() const{
    return m_touches_isSet;
}

bool OAIPlayerSeason::is_touches_Valid() const{
...
QString OAIPlayerSeason::getUpdatedUtc() const {
    return m_updated_utc;
}
void OAIPlayerSeason::setUpdatedUtc(const QString &updated_utc) {
    m_updated_utc = updated_utc;
    m_updated_utc_isSet = true;
}

bool OAIPlayerSeason::is_updated_utc_Set() const{
    return m_updated_utc_isSet;
}

bool OAIPlayerSeason::is_updated_utc_Valid() const{
    return m_updated_utc_isValid;
}

double OAIPlayerSeason::getYellowCards() const {
    return m_yellow_cards;
}
void OAIPlayerSeason::setYellowCards(const double &yellow_cards) {
    m_yellow_cards = yellow_cards;
    m_yellow_cards_isSet = true;
}

bool OAIPlayerSeason::is_yellow_cards_Set() const{
    return m_yellow_cards_isSet;
}

bool OAIPlayerSeason::is_yellow_cards_Valid() const{
    return m_yellow_cards_isValid;
}

double OAIPlayerSeason::getYellowRedCards() const {
    return m_yellow_red_cards;
}
void OAIPlayerSeason::setYellowRedCards(const double &yellow_red_cards) {
    m_yellow_red_cards = yellow_red_cards;
    m_yellow_red_cards_isSet = true;
}

bool OAIPlayerSeason::is_yellow_red_cards_Set() const{
    return m_yellow_red_cards_isSet;
}

bool OAIPlayerSeason::is_yellow_red_cards_Valid() const{
