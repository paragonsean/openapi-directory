...
QList<OAICompetition> OAIArea::getCompetitions() const {
    return m_competitions;
}
void OAIArea::setCompetitions(const QList<OAICompetition> &competitions) {
    m_competitions = competitions;
    m_competitions_isSet = true;
}

bool OAIArea::is_competitions_Set() const{
    return m_competitions_isSet;
}

bool OAIArea::is_competitions_Valid() const{
