...
public:
    ...
    * @param[in]  date QString [required]
    */
    virtual void boxScoresByDateByCompetition(const QString &format, const QString &competition, const QString &date);
    ...
    * @param[in]  minutes QString [required]
    */
    virtual void boxScoresDeltaByDateByCompetition(const QString &format, const QString &competition, const QString &date, const QString &minutes);
    ...
    */
    virtual void playerSeasonStats(const QString &format, const QString &roundid);
    ...
    * @param[in]  playerid QString [required]
    */
    virtual void playerSeasonStatsByPlayer(const QString &format, const QString &roundid, const QString &playerid);
    ...
    */
    virtual void playerSeasonStatsByTeam(const QString &format, const QString &roundid, const QString &team);
...
private:
    ...
    void boxScoresByDateByCompetitionCallback(OAIHttpRequestWorker *worker);
    void boxScoresByDateDeltaCallback(OAIHttpRequestWorker *worker);
    void boxScoresDeltaByDateByCompetitionCallback(OAIHttpRequestWorker *worker);
...
Q_SIGNALS:
    ...
    void boxScoresByDateByCompetitionSignal(QList<OAIBoxScore> summary);
    void boxScoresByDateDeltaSignal(QList<OAIBoxScore> summary);
    void boxScoresDeltaByDateByCompetitionSignal(QList<OAIBoxScore> summary);
    ...
    void playerGameStatsByPlayerSignal(QList<OAIPlayerGame> summary);
    ...
    void boxScoresByDateByCompetitionSignalFull(OAIHttpRequestWorker *worker, QList<OAIBoxScore> summary);
    void boxScoresByDateDeltaSignalFull(OAIHttpRequestWorker *worker, QList<OAIBoxScore> summary);
    void boxScoresDeltaByDateByCompetitionSignalFull(OAIHttpRequestWorker *worker, QList<OAIBoxScore> summary);
    ...
    void playerGameStatsByPlayerSignalFull(OAIHttpRequestWorker *worker, QList<OAIPlayerGame> summary);
    ...
    Q_DECL_DEPRECATED_X("Use boxScoresByDateByCompetitionSignalError() instead")
    void boxScoresByDateByCompetitionSignalE(QList<OAIBoxScore> summary, QNetworkReply::NetworkError error_type, QString error_str);
    void boxScoresByDateByCompetitionSignalError(QList<OAIBoxScore> summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use boxScoresDeltaByDateByCompetitionSignalError() instead")
    void boxScoresDeltaByDateByCompetitionSignalE(QList<OAIBoxScore> summary, QNetworkReply::NetworkError error_type, QString error_str);
    void boxScoresDeltaByDateByCompetitionSignalError(QList<OAIBoxScore> summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    void playerGameStatsByPlayerSignalE(QList<OAIPlayerGame> summary, QNetworkReply::NetworkError error_type, QString error_str);
    void playerGameStatsByPlayerSignalError(QList<OAIPlayerGame> summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use boxScoresByDateByCompetitionSignalErrorFull() instead")
    void boxScoresByDateByCompetitionSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void boxScoresByDateByCompetitionSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use boxScoresDeltaByDateByCompetitionSignalErrorFull() instead")
    void boxScoresDeltaByDateByCompetitionSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void boxScoresDeltaByDateByCompetitionSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
