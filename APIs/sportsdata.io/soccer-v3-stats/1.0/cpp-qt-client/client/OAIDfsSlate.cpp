...
qint32 OAIDfsSlate::getCompetitionId() const {
    return m_competition_id;
}
void OAIDfsSlate::setCompetitionId(const qint32 &competition_id) {
    m_competition_id = competition_id;
    m_competition_id_isSet = true;
}

bool OAIDfsSlate::is_competition_id_Set() const{
    return m_competition_id_isSet;
}

bool OAIDfsSlate::is_competition_id_Valid() const{
