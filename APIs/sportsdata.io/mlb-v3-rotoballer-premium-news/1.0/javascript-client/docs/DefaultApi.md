# MlbV3RotoBallerPremiumNews.DefaultApi

All URIs are relative to *http://azure-api.sportsdata.io/v3/mlb/news-rotoballer*
...
```javascript
import MlbV3RotoBallerPremiumNews from 'mlb_v3_roto_baller_premium_news';
let defaultClient = MlbV3RotoBallerPremiumNews.ApiClient.instance;
...
let apiInstance = new MlbV3RotoBallerPremiumNews.DefaultApi();
