...
import org.openapitools.client.model.Champion;
...
import org.openapitools.client.model.Spell;
...
public class DefaultApi {
     ...
     * @param format Desired response format. Valid entries are &lt;code&gt;XML&lt;/code&gt; or &lt;code&gt;JSON&lt;/code&gt;. (required)
     * @param gameid Unique FantasyData Game ID.  Example:&lt;code&gt;100002649&lt;/code&gt;. (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     */
    public List<BoxScore> boxScore(String format, String gameid) throws ApiException {
        ApiResponse<List<BoxScore>> localVarResp = boxScoreWithHttpInfo(format, gameid);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<List<BoxScore>> boxScoreWithHttpInfo(String format, String gameid) throws ApiException {
     ...
     */
    public okhttp3.Call boxScoreAsync(String format, String gameid, final ApiCallback<List<BoxScore>> _callback) throws ApiException {
     ...
     * @param format Desired response format. Valid entries are &lt;code&gt;XML&lt;/code&gt; or &lt;code&gt;JSON&lt;/code&gt;. (required)
     * @param date The date of the game(s). &lt;br&gt;Examples: &lt;code&gt;2019-01-20&lt;/code&gt; (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     */
    public okhttp3.Call championsCall(String format, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/{format}/Champions"
            .replace("{" + "format" + "}", localVarApiClient.escapeString(format.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call championsValidateBeforeCall(String format, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'format' is set
        if (format == null) {
            throw new ApiException("Missing the required parameter 'format' when calling champions(Async)");
        }

        return championsCall(format, _callback);
     ...
     */
    public List<Champion> champions(String format) throws ApiException {
        ApiResponse<List<Champion>> localVarResp = championsWithHttpInfo(format);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<List<Champion>> championsWithHttpInfo(String format) throws ApiException {
        okhttp3.Call localVarCall = championsValidateBeforeCall(format, null);
        Type localVarReturnType = new TypeToken<List<Champion>>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Champions (asynchronously)
     * Areas (Countries)
     * @param format Desired response format. Valid entries are &lt;code&gt;XML&lt;/code&gt; or &lt;code&gt;JSON&lt;/code&gt;. (required)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
     ...
     */
    public okhttp3.Call championsAsync(String format, final ApiCallback<List<Champion>> _callback) throws ApiException {

        okhttp3.Call localVarCall = championsValidateBeforeCall(format, _callback);
        Type localVarReturnType = new TypeToken<List<Champion>>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     * @param format Desired response format. Valid entries are &lt;code&gt;XML&lt;/code&gt; or &lt;code&gt;JSON&lt;/code&gt;. (required)
     * @param competitionid A LoL competition/league unique CompetitionId. Possible values include: &lt;code&gt;100000019&lt;/code&gt;, etc. (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     */
    public okhttp3.Call itemsCall(String format, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/{format}/Items"
            .replace("{" + "format" + "}", localVarApiClient.escapeString(format.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call itemsValidateBeforeCall(String format, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'format' is set
        if (format == null) {
            throw new ApiException("Missing the required parameter 'format' when calling items(Async)");
        }

        return itemsCall(format, _callback);
     ...
     */
    public List<Item> items(String format) throws ApiException {
        ApiResponse<List<Item>> localVarResp = itemsWithHttpInfo(format);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<List<Item>> itemsWithHttpInfo(String format) throws ApiException {
        okhttp3.Call localVarCall = itemsValidateBeforeCall(format, null);
     ...
     */
    public okhttp3.Call itemsAsync(String format, final ApiCallback<List<Item>> _callback) throws ApiException {

        okhttp3.Call localVarCall = itemsValidateBeforeCall(format, _callback);
        Type localVarReturnType = new TypeToken<List<Item>>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     * @param format Desired response format. Valid entries are &lt;code&gt;XML&lt;/code&gt; or &lt;code&gt;JSON&lt;/code&gt;. (required)
     * @param teamid Unique FantasyData Team ID.  Example:&lt;code&gt;100000165&lt;/code&gt;. (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     * @param format Desired response format. Valid entries are &lt;code&gt;XML&lt;/code&gt; or &lt;code&gt;JSON&lt;/code&gt;. (required)
     * @param roundid Unique FantasyData Round ID. RoundIDs can be found in the Competitions and Competition Details endpoints.  Example: &lt;code&gt;100000278&lt;/code&gt;, etc (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     * @param format Desired response format. Valid entries are &lt;code&gt;XML&lt;/code&gt; or &lt;code&gt;JSON&lt;/code&gt;. (required)
     * @param seasonid Unique FantasyData Season ID. SeasonIDs can be found in the Competitions and Competition Details endpoints.  Examples: &lt;code&gt;100000057&lt;/code&gt;, etc (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     */
    public okhttp3.Call spellsCall(String format, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/{format}/Spells"
            .replace("{" + "format" + "}", localVarApiClient.escapeString(format.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call spellsValidateBeforeCall(String format, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'format' is set
        if (format == null) {
            throw new ApiException("Missing the required parameter 'format' when calling spells(Async)");
        }

        return spellsCall(format, _callback);
     ...
     */
    public List<Spell> spells(String format) throws ApiException {
        ApiResponse<List<Spell>> localVarResp = spellsWithHttpInfo(format);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<List<Spell>> spellsWithHttpInfo(String format) throws ApiException {
        okhttp3.Call localVarCall = spellsValidateBeforeCall(format, null);
        Type localVarReturnType = new TypeToken<List<Spell>>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Spells (asynchronously)
     * Areas (Countries)
     * @param format Desired response format. Valid entries are &lt;code&gt;XML&lt;/code&gt; or &lt;code&gt;JSON&lt;/code&gt;. (required)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
     ...
     */
    public okhttp3.Call spellsAsync(String format, final ApiCallback<List<Spell>> _callback) throws ApiException {

        okhttp3.Call localVarCall = spellsValidateBeforeCall(format, _callback);
        Type localVarReturnType = new TypeToken<List<Spell>>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
