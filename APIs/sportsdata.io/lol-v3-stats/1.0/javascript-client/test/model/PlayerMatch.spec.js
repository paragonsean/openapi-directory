...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LoLV3Stats.PlayerMatch();
  });
  ...
  describe('PlayerMatch', function() {
    it('should create an instance of PlayerMatch', function() {
      // uncomment below and update the code to test PlayerMatch
      //var instance = new LoLV3Stats.PlayerMatch();
      //expect(instance).to.be.a(LoLV3Stats.PlayerMatch);
    });
    ...
    it('should have the property championLevel (base name: "ChampionLevel")', function() {
      // uncomment below and update the code to test the property championLevel
      //var instance = new LoLV3Stats.PlayerMatch();
      //expect(instance).to.be();
    });
    ...
    it('should have the property spells (base name: "Spells")', function() {
      // uncomment below and update the code to test the property spells
      //var instance = new LoLV3Stats.PlayerMatch();
      //expect(instance).to.be();
    });
