...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LoLV3Stats.TeamMatch();
  });
  ...
  describe('TeamMatch', function() {
    it('should create an instance of TeamMatch', function() {
      // uncomment below and update the code to test TeamMatch
      //var instance = new LoLV3Stats.TeamMatch();
      //expect(instance).to.be.a(LoLV3Stats.TeamMatch);
    });
