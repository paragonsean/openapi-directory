...
class BoxScore(Model):
    ...
    def __init__(self, game: Game=None, matches: List[Match]=None, player_games: List[PlayerGame]=None, team_games: List[TeamGame]=None):
        """BoxScore - a model defined in OpenAPI

        :param game: The game of this BoxScore.
        :param matches: The matches of this BoxScore.
    ...
    @property
    def matches(self):
        """Gets the matches of this BoxScore.


        :return: The matches of this BoxScore.
        :rtype: List[Match]
        """
    ...
    def matches(self, matches):
        """Sets the matches of this BoxScore.
