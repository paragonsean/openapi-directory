...
from openapi_server.models.champion import Champion
...
async def box_score(request: web.Request, format, gameid) -> web.Response:
    ...
    :param format: Desired response format. Valid entries are &lt;code&gt;XML&lt;/code&gt; or &lt;code&gt;JSON&lt;/code&gt;.
    :type format: str
    :param gameid: Unique FantasyData Game ID.  Example:&lt;code&gt;100002649&lt;/code&gt;.
    :type gameid: str
...
async def box_scores_by_date(request: web.Request, format, _date) -> web.Response:
    ...
    :param format: Desired response format. Valid entries are &lt;code&gt;XML&lt;/code&gt; or &lt;code&gt;JSON&lt;/code&gt;.
    :type format: str
    :param _date: The date of the game(s). &lt;br&gt;Examples: &lt;code&gt;2019-01-20&lt;/code&gt;
    :type _date: str
...
async def champions(request: web.Request, format) -> web.Response:
    """Champions
...
async def competition_fixtures_league_details(request: web.Request, format, competitionid) -> web.Response:
    ...
    :param format: Desired response format. Valid entries are &lt;code&gt;XML&lt;/code&gt; or &lt;code&gt;JSON&lt;/code&gt;.
    :type format: str
    :param competitionid: A LoL competition/league unique CompetitionId. Possible values include: &lt;code&gt;100000019&lt;/code&gt;, etc.
...
async def items(request: web.Request, format) -> web.Response:
    """Items
...
async def memberships_by_team_active(request: web.Request, format, teamid) -> web.Response:
    ...
    :param format: Desired response format. Valid entries are &lt;code&gt;XML&lt;/code&gt; or &lt;code&gt;JSON&lt;/code&gt;.
    :type format: str
    :param teamid: Unique FantasyData Team ID.  Example:&lt;code&gt;100000165&lt;/code&gt;.
    :type teamid: str
...
async def schedule(request: web.Request, format, roundid) -> web.Response:
    ...
    :param format: Desired response format. Valid entries are &lt;code&gt;XML&lt;/code&gt; or &lt;code&gt;JSON&lt;/code&gt;.
    :type format: str
    :param roundid: Unique FantasyData Round ID. RoundIDs can be found in the Competitions and Competition Details endpoints.  Example: &lt;code&gt;100000278&lt;/code&gt;, etc
    :type roundid: str
...
async def season_teams(request: web.Request, format, seasonid) -> web.Response:
    ...
    :param format: Desired response format. Valid entries are &lt;code&gt;XML&lt;/code&gt; or &lt;code&gt;JSON&lt;/code&gt;.
    :type format: str
    :param seasonid: Unique FantasyData Season ID. SeasonIDs can be found in the Competitions and Competition Details endpoints.  Examples: &lt;code&gt;100000057&lt;/code&gt;, etc
    :type seasonid: str
...
async def spells(request: web.Request, format) -> web.Response:
    """Spells
