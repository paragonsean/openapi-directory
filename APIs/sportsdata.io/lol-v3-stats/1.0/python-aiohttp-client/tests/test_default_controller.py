...
async def test_areas_countries(client):
    ...
    response = await client.request(
        method='GET',
        path='/v3/lol/stats/{format}/Areas'.format(format=xml),
        headers=headers,
        )
...
async def test_box_score(client):
    ...
    response = await client.request(
        method='GET',
        path='/v3/lol/stats/{format}/BoxScore/{gameid}'.format(format=xml, gameid='gameid_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_box_scores_by_date(client):
    ...
    response = await client.request(
        method='GET',
        path='/v3/lol/stats/{format}/BoxScores/{_date}'.format(format=xml, _date='_date_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_champions(client):
    """Test case for champions
    ...
    response = await client.request(
        method='GET',
        path='/v3/lol/stats/{format}/Champions'.format(format=xml),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_competition_fixtures_league_details(client):
    ...
    response = await client.request(
        method='GET',
        path='/v3/lol/stats/{format}/CompetitionDetails/{competitionid}'.format(format=xml, competitionid='competitionid_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_competitions_leagues(client):
    ...
    response = await client.request(
        method='GET',
        path='/v3/lol/stats/{format}/Competitions'.format(format=xml),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_games_by_date(client):
    ...
    response = await client.request(
        method='GET',
        path='/v3/lol/stats/{format}/GamesByDate/{_date}'.format(format=xml, _date='_date_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_items(client):
    ...
    response = await client.request(
        method='GET',
        path='/v3/lol/stats/{format}/Items'.format(format=xml),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_memberships_active(client):
    ...
    response = await client.request(
        method='GET',
        path='/v3/lol/stats/{format}/ActiveMemberships'.format(format=xml),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_memberships_by_team_active(client):
    ...
    response = await client.request(
        method='GET',
        path='/v3/lol/stats/{format}/MembershipsByTeam/{teamid}'.format(format=xml, teamid='teamid_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_memberships_by_team_historical(client):
    ...
    response = await client.request(
        method='GET',
        path='/v3/lol/stats/{format}/HistoricalMembershipsByTeam/{teamid}'.format(format=xml, teamid='teamid_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_memberships_historical(client):
    ...
    response = await client.request(
        method='GET',
        path='/v3/lol/stats/{format}/HistoricalMemberships'.format(format=xml),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_player(client):
    ...
    response = await client.request(
        method='GET',
        path='/v3/lol/stats/{format}/Player/{playerid}'.format(format=xml, playerid='playerid_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_players(client):
    ...
    response = await client.request(
        method='GET',
        path='/v3/lol/stats/{format}/Players'.format(format=xml),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_players_by_team(client):
    ...
    response = await client.request(
        method='GET',
        path='/v3/lol/stats/{format}/PlayersByTeam/{teamid}'.format(format=xml, teamid='teamid_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_schedule(client):
    ...
    response = await client.request(
        method='GET',
        path='/v3/lol/stats/{format}/Schedule/{roundid}'.format(format=xml, roundid='roundid_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_season_teams(client):
    ...
    response = await client.request(
        method='GET',
        path='/v3/lol/stats/{format}/SeasonTeams/{seasonid}'.format(format=xml, seasonid='seasonid_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_spells(client):
    """Test case for spells
    ...
    response = await client.request(
        method='GET',
        path='/v3/lol/stats/{format}/Spells'.format(format=xml),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_standings(client):
    ...
    response = await client.request(
        method='GET',
        path='/v3/lol/stats/{format}/Standings/{roundid}'.format(format=xml, roundid='roundid_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_teams(client):
    ...
    response = await client.request(
        method='GET',
        path='/v3/lol/stats/{format}/Teams'.format(format=xml),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_venues(client):
    ...
    response = await client.request(
        method='GET',
        path='/v3/lol/stats/{format}/Venues'.format(format=xml),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
