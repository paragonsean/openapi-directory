...
void OAIStanding::initializeModel() {
    ...
    m_score_against_isSet = false;
    m_score_against_isValid = false;

    m_score_difference_isSet = false;
    m_score_difference_isValid = false;

    m_score_for_isSet = false;
    m_score_for_isValid = false;
...
void OAIStanding::fromJsonObject(QJsonObject json) {
    ...
    m_score_against_isValid = ::OpenAPI::fromJsonValue(m_score_against, json[QString("ScoreAgainst")]);
    m_score_against_isSet = !json[QString("ScoreAgainst")].isNull() && m_score_against_isValid;

    m_score_difference_isValid = ::OpenAPI::fromJsonValue(m_score_difference, json[QString("ScoreDifference")]);
    m_score_difference_isSet = !json[QString("ScoreDifference")].isNull() && m_score_difference_isValid;

    m_score_for_isValid = ::OpenAPI::fromJsonValue(m_score_for, json[QString("ScoreFor")]);
    m_score_for_isSet = !json[QString("ScoreFor")].isNull() && m_score_for_isValid;
...
QJsonObject OAIStanding::asJsonObject() const {
    ...
    if (m_score_against_isSet) {
        obj.insert(QString("ScoreAgainst"), ::OpenAPI::toJsonValue(m_score_against));
    }
    if (m_score_difference_isSet) {
        obj.insert(QString("ScoreDifference"), ::OpenAPI::toJsonValue(m_score_difference));
    }
    if (m_score_for_isSet) {
        obj.insert(QString("ScoreFor"), ::OpenAPI::toJsonValue(m_score_for));
    }
...
qint32 OAIStanding::getScoreAgainst() const {
    return m_score_against;
}
void OAIStanding::setScoreAgainst(const qint32 &score_against) {
    m_score_against = score_against;
    m_score_against_isSet = true;
}

bool OAIStanding::is_score_against_Set() const{
    return m_score_against_isSet;
}

bool OAIStanding::is_score_against_Valid() const{
    return m_score_against_isValid;
}

qint32 OAIStanding::getScoreDifference() const {
    return m_score_difference;
}
void OAIStanding::setScoreDifference(const qint32 &score_difference) {
    m_score_difference = score_difference;
    m_score_difference_isSet = true;
}

bool OAIStanding::is_score_difference_Set() const{
    return m_score_difference_isSet;
}

bool OAIStanding::is_score_difference_Valid() const{
    return m_score_difference_isValid;
}

qint32 OAIStanding::getScoreFor() const {
    return m_score_for;
}
void OAIStanding::setScoreFor(const qint32 &score_for) {
    m_score_for = score_for;
    m_score_for_isSet = true;
}

bool OAIStanding::is_score_for_Set() const{
    return m_score_for_isSet;
}

bool OAIStanding::is_score_for_Valid() const{
    return m_score_for_isValid;
}
