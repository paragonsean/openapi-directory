...
QList<OAIMatch> OAIBoxScore::getMatches() const {
    return m_matches;
}
void OAIBoxScore::setMatches(const QList<OAIMatch> &matches) {
    m_matches = matches;
    m_matches_isSet = true;
}

bool OAIBoxScore::is_matches_Set() const{
    return m_matches_isSet;
}

bool OAIBoxScore::is_matches_Valid() const{
