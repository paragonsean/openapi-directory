...
public:
    ...
    * @param[in]  format QString [required]
    */
    virtual void champions(const QString &format);
    ...
    * @param[in]  format QString [required]
    */
    virtual void items(const QString &format);
    ...
    * @param[in]  format QString [required]
    */
    virtual void spells(const QString &format);
...
private:
    ...
    void championsCallback(OAIHttpRequestWorker *worker);
    ...
    void spellsCallback(OAIHttpRequestWorker *worker);
...
Q_SIGNALS:
    ...
    void boxScoreSignal(QList<OAIBoxScore> summary);
    void boxScoresByDateSignal(QList<OAIBoxScore> summary);
    void championsSignal(QList<OAIChampion> summary);
    ...
    void itemsSignal(QList<OAIItem> summary);
    ...
    void spellsSignal(QList<OAISpell> summary);
    ...
    void boxScoreSignalFull(OAIHttpRequestWorker *worker, QList<OAIBoxScore> summary);
    void boxScoresByDateSignalFull(OAIHttpRequestWorker *worker, QList<OAIBoxScore> summary);
    void championsSignalFull(OAIHttpRequestWorker *worker, QList<OAIChampion> summary);
    ...
    void itemsSignalFull(OAIHttpRequestWorker *worker, QList<OAIItem> summary);
    ...
    void spellsSignalFull(OAIHttpRequestWorker *worker, QList<OAISpell> summary);
    ...
    void boxScoreSignalE(QList<OAIBoxScore> summary, QNetworkReply::NetworkError error_type, QString error_str);
    void boxScoreSignalError(QList<OAIBoxScore> summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use championsSignalError() instead")
    void championsSignalE(QList<OAIChampion> summary, QNetworkReply::NetworkError error_type, QString error_str);
    void championsSignalError(QList<OAIChampion> summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    void itemsSignalE(QList<OAIItem> summary, QNetworkReply::NetworkError error_type, QString error_str);
    void itemsSignalError(QList<OAIItem> summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use spellsSignalError() instead")
    void spellsSignalE(QList<OAISpell> summary, QNetworkReply::NetworkError error_type, QString error_str);
    void spellsSignalError(QList<OAISpell> summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use championsSignalErrorFull() instead")
    void championsSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void championsSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use spellsSignalErrorFull() instead")
    void spellsSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void spellsSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
