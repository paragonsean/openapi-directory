...
void OAIDefaultApi::initializeServerConfigs() {
    ...
    QUrl("http://azure-api.sportsdata.io/v3/lol/stats"),
    "No description provided",
    QMap<QString, OAIServerVariable>()));
    defaultConf.append(OAIServerConfiguration(
    QUrl("https://azure-api.sportsdata.io/v3/lol/stats"),
    "No description provided",
    QMap<QString, OAIServerVariable>()));
    ...
    _serverConfigs.insert("champions", defaultConf);
    _serverIndices.insert("champions", 0);
    ...
    _serverConfigs.insert("spells", defaultConf);
    _serverIndices.insert("spells", 0);
...
void OAIDefaultApi::champions(const QString &format) {
    QString fullPath = QString(_serverConfigs["champions"][_serverIndices.value("champions")].URL()+"/{format}/Champions");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIDefaultApi::championsCallback);
    connect(this, &OAIDefaultApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIDefaultApi::championsCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT championsSignal(output);
        Q_EMIT championsSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT championsSignalE(output, error_type, error_str);
        Q_EMIT championsSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT championsSignalError(output, error_type, error_str);
        Q_EMIT championsSignalErrorFull(worker, error_type, error_str);
    }
}
...
void OAIDefaultApi::items(const QString &format) {
    QString fullPath = QString(_serverConfigs["items"][_serverIndices.value("items")].URL()+"/{format}/Items");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIDefaultApi::itemsCallback);
    connect(this, &OAIDefaultApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIDefaultApi::itemsCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
...
void OAIDefaultApi::spells(const QString &format) {
    QString fullPath = QString(_serverConfigs["spells"][_serverIndices.value("spells")].URL()+"/{format}/Spells");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIDefaultApi::spellsCallback);
    connect(this, &OAIDefaultApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIDefaultApi::spellsCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT spellsSignal(output);
        Q_EMIT spellsSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT spellsSignalE(output, error_type, error_str);
        Q_EMIT spellsSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT spellsSignalError(output, error_type, error_str);
        Q_EMIT spellsSignalErrorFull(worker, error_type, error_str);
    }
}
