...
#ifndef OAIPlayerMatch_H
#define OAIPlayerMatch_H
...
class OAIPlayerMatch : public OAIObject {
public:
    OAIPlayerMatch();
    OAIPlayerMatch(QString json);
    ~OAIPlayerMatch() override;
    ...
    qint32 getChampionLevel() const;
    void setChampionLevel(const qint32 &champion_level);
    bool is_champion_level_Set() const;
    bool is_champion_level_Valid() const;
    ...
    QString getLane() const;
    void setLane(const QString &lane);
    bool is_lane_Set() const;
    bool is_lane_Valid() const;
    ...
    QList<OAISpell> getSpells() const;
    void setSpells(const QList<OAISpell> &spells);
    bool is_spells_Set() const;
    bool is_spells_Valid() const;
...
private:
    ...
    qint32 m_champion_level;
    bool m_champion_level_isSet;
    bool m_champion_level_isValid;
    ...
    QList<OAISpell> m_spells;
    bool m_spells_isSet;
    bool m_spells_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPlayerMatch)

#endif // OAIPlayerMatch_H
