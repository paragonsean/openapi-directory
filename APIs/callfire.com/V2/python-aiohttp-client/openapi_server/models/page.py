...
class Page(Model):
    ...
    def __init__(self, items: List[object]=None, limit: int=None, offset: int=None, total_count: int=None):
        ...
        :param total_count: The total_count of this Page.
        """
        self.openapi_types = {
            'items': List[object],
            'limit': int,
    ...
    def total_count(self):
        """Gets the total_count of this Page.

        Total count of available results. -1 if unknown

        :return: The total_count of this Page.
        :rtype: int
        """
    ...
    def total_count(self, total_count):
        """Sets the total_count of this Page.
