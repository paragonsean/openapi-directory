# CallFireApiDocumentation.DoNotContact
...
**campaignId** | **Number** | An Id of a campaign which was used to send a message to DNC number | [optional] [readonly] 
**created** | **Number** | A time when a given resource was created, formatted in unix time milliseconds (read only). Example: 1473781817000 for Sat, 05 Jan 1985 14:03:37 GMT | [optional] [readonly] 
