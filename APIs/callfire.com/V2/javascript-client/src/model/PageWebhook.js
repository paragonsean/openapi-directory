...
class PageWebhook {
    ...
    /**
     * Validates the JSON data with respect to <code>PageWebhook</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PageWebhook</code>.
     */
 ...
 */
PageWebhook.prototype['items'] = undefined;

/**
 * ~
 * @member {Number} limit
 */
PageWebhook.prototype['limit'] = undefined;

/**
 * ~
 * @member {Number} offset
 */
PageWebhook.prototype['offset'] = undefined;

/**
 * ~
 * @member {Number} totalCount
 */
PageWebhook.prototype['totalCount'] = undefined;
