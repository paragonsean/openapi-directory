...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CallFireApiDocumentation.ResourceId();
  });
  ...
  describe('ResourceId', function() {
    it('should create an instance of ResourceId', function() {
      ...
      //var instance = new CallFireApiDocumentation.ResourceId();
      //expect(instance).to.be.a(CallFireApiDocumentation.ResourceId);
    });
