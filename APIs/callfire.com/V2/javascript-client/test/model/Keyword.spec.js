...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CallFireApiDocumentation.Keyword();
  });
  ...
  describe('Keyword', function() {
    it('should create an instance of Keyword', function() {
      ...
      //var instance = new CallFireApiDocumentation.Keyword();
      //expect(instance).to.be.a(CallFireApiDocumentation.Keyword);
    });
