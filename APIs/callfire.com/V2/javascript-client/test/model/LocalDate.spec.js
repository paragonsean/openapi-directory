...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CallFireApiDocumentation.LocalDate();
  });
  ...
  describe('LocalDate', function() {
    it('should create an instance of LocalDate', function() {
      ...
      //var instance = new CallFireApiDocumentation.LocalDate();
      //expect(instance).to.be.a(CallFireApiDocumentation.LocalDate);
    });
