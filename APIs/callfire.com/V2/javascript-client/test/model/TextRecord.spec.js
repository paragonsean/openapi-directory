...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CallFireApiDocumentation.TextRecord();
  });
  ...
  describe('TextRecord', function() {
    it('should create an instance of TextRecord', function() {
      // uncomment below and update the code to test TextRecord
      //var instance = new CallFireApiDocumentation.TextRecord();
      //expect(instance).to.be.a(CallFireApiDocumentation.TextRecord);
    });
