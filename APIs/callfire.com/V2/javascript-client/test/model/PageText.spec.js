...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CallFireApiDocumentation.PageText();
  });
  ...
  describe('PageText', function() {
    it('should create an instance of PageText', function() {
      // uncomment below and update the code to test PageText
      //var instance = new CallFireApiDocumentation.PageText();
      //expect(instance).to.be.a(CallFireApiDocumentation.PageText);
    });
