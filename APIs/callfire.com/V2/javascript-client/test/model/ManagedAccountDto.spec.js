...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CallFireApiDocumentation.ManagedAccountDto();
  });
  ...
  describe('ManagedAccountDto', function() {
    it('should create an instance of ManagedAccountDto', function() {
      // uncomment below and update the code to test ManagedAccountDto
      //var instance = new CallFireApiDocumentation.ManagedAccountDto();
      //expect(instance).to.be.a(CallFireApiDocumentation.ManagedAccountDto);
    });
