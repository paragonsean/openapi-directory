...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CallFireApiDocumentation.CallPage();
  });
  ...
  describe('CallPage', function() {
    it('should create an instance of CallPage', function() {
      // uncomment below and update the code to test CallPage
      //var instance = new CallFireApiDocumentation.CallPage();
      //expect(instance).to.be.a(CallFireApiDocumentation.CallPage);
    });
