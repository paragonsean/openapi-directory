...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CallFireApiDocumentation.TextRecipient();
  });
  ...
  describe('TextRecipient', function() {
    it('should create an instance of TextRecipient', function() {
      ...
      //var instance = new CallFireApiDocumentation.TextRecipient();
      //expect(instance).to.be.a(CallFireApiDocumentation.TextRecipient);
    });
