...
#ifndef OAIMediaPage_H
#define OAIMediaPage_H
...
class OAIMediaPage : public OAIObject {
public:
    OAIMediaPage();
    OAIMediaPage(QString json);
    ~OAIMediaPage() override;
    ...
    QList<OAIMedia> getItems() const;
    void setItems(const QList<OAIMedia> &items);
...
Q_DECLARE_METATYPE(OpenAPI::OAIMediaPage)

#endif // OAIMediaPage_H
