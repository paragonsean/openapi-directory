...
#ifndef OAITextPage_H
#define OAITextPage_H
...
class OAITextPage : public OAIObject {
public:
    OAITextPage();
    OAITextPage(QString json);
    ~OAITextPage() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITextPage)
