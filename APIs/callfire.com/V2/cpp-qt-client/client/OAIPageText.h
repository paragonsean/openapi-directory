...
#ifndef OAIPageText_H
#define OAIPageText_H
...
class OAIPageText : public OAIObject {
public:
    OAIPageText();
    OAIPageText(QString json);
    ~OAIPageText() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPageText)
