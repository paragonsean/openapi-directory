...
#ifndef OAIWebhookPage_H
#define OAIWebhookPage_H
...
class OAIWebhookPage : public OAIObject {
public:
    OAIWebhookPage();
    OAIWebhookPage(QString json);
    ~OAIWebhookPage() override;
    ...
    QList<OAIWebhook> getItems() const;
    void setItems(const QList<OAIWebhook> &items);
...
Q_DECLARE_METATYPE(OpenAPI::OAIWebhookPage)

#endif // OAIWebhookPage_H
