...
#ifndef OAIPageWebhook_H
#define OAIPageWebhook_H
...
class OAIPageWebhook : public OAIObject {
public:
    OAIPageWebhook();
    OAIPageWebhook(QString json);
    ~OAIPageWebhook() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPageWebhook)

#endif // OAIPageWebhook_H
