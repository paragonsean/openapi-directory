...
#ifndef OAICallPage_H
#define OAICallPage_H
...
class OAICallPage : public OAIObject {
public:
    OAICallPage();
    OAICallPage(QString json);
    ~OAICallPage() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICallPage)
