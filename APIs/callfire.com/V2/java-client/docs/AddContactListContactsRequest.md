...
|**contactNumbers** | **List&lt;String&gt;** | A phone number in E.164 format (11-digit). Examples: 12132000384 |  [optional] |
...
|**contacts** | [**List&lt;Contact&gt;**](Contact.md) | A list of new contact objects which need to be added |  [optional] |
