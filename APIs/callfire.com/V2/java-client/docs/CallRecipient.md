...
|------------ | ------------- | ------------- | -------------|
|**attributes** | **Map&lt;String, String&gt;** | Map of user-defined string attributes associated with recipient |  [optional] |
|**contactId** | **Long** | An id of existing contact used as recipient |  [optional] |
...
|**liveMessageSoundId** | **Long** | An id of a sound file to play if phone is answered |  [optional] |
...
|**machineMessageSoundId** | **Long** | An id of a sound file to play if answering machine is detected |  [optional] |
...
|**transferMessageSoundId** | **Long** | An id of a sound file to play if call is transferred |  [optional] |
|**transferNumber** | **String** | Phone number in E.164 format (11-digit) to transfer the call to. Example: 12132000384 |  [optional] |
|**voice** | [**VoiceEnum**](#VoiceEnum) | The voice to be used (MALE1, FEMALE1, FEMALE2, SPANISH1, FRENCHCANADIAN1) |  [optional] |
