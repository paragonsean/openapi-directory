...
<a id="findKeywordLeaseConfigs"></a>
# **findKeywordLeaseConfigs**
> Page findKeywordLeaseConfigs(limit, offset, filter, labelName, fields)
...
public class Example {
  public static void main(String[] args) {
    ...
    String filter = "filter_example"; // String | Filter by part of Keyword name or Label name of Keyword
    String labelName = "labelName_example"; // String | An exact label name to search by
    ...
    try {
      Page result = apiInstance.findKeywordLeaseConfigs(limit, offset, filter, labelName, fields);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling KeywordsApi#findKeywordLeaseConfigs");
...
<a id="findKeywordLeases"></a>
# **findKeywordLeases**
> KeywordLeasePage findKeywordLeases(limit, offset, filter, labelName, fields)
...
public class Example {
  public static void main(String[] args) {
    ...
    String fields = "fields_example"; // String | Limit fields received in response. E.g. fields: id, name or fields items (id, name), see more at [partial response](https://developers.callfire.com/docs.html#partial-response) page.
    try {
      KeywordLeasePage result = apiInstance.findKeywordLeases(limit, offset, filter, labelName, fields);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling KeywordsApi#findKeywordLeases");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="findKeywords"></a>
# **findKeywords**
> KeywordList findKeywords(keywords)
...
public class Example {
  public static void main(String[] args) {
    ...
    KeywordsApi apiInstance = new KeywordsApi(defaultClient);
    List<String> keywords = Arrays.asList(); // List<String> | A keyword to search for
    try {
      KeywordList result = apiInstance.findKeywords(keywords);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling KeywordsApi#findKeywords");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
| Name | Type | Description  | Notes |
|------------- | ------------- | ------------- | -------------|
| **keywords** | [**List&lt;String&gt;**](String.md)| A keyword to search for | [optional] |
...
<a id="getKeywordLease"></a>
# **getKeywordLease**
> KeywordLease getKeywordLease(keyword, fields)
...
public class Example {
  public static void main(String[] args) {
    ...
    KeywordsApi apiInstance = new KeywordsApi(defaultClient);
    String keyword = "keyword_example"; // String | Keyword text that a lease is desired for
    String fields = "fields_example"; // String | Limit fields received in response. E.g. fields: id, name or fields items (id, name), see more at [partial response](https://developers.callfire.com/docs.html#partial-response) page.
    try {
      KeywordLease result = apiInstance.getKeywordLease(keyword, fields);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling KeywordsApi#getKeywordLease");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="getKeywordLeaseById"></a>
# **getKeywordLeaseById**
> KeywordLease getKeywordLeaseById(id, fields)
...
public class Example {
  public static void main(String[] args) {
    ...
    String fields = "fields_example"; // String | Limit fields received in response. E.g. fields: id, name or fields items (id, name), see more at [partial response](https://developers.callfire.com/docs.html#partial-response) page.
    try {
      KeywordLease result = apiInstance.getKeywordLeaseById(id, fields);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling KeywordsApi#getKeywordLeaseById");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="getKeywordLeaseConfig"></a>
# **getKeywordLeaseConfig**
> KeywordConfig getKeywordLeaseConfig(keyword, fields)
...
public class Example {
  public static void main(String[] args) {
    ...
    KeywordsApi apiInstance = new KeywordsApi(defaultClient);
    String keyword = "keyword_example"; // String | A Keyword to get KeywordConfig by
    String fields = "fields_example"; // String | Limit fields received in response. E.g. fields: id, name or fields items (id, name), see more at [partial response](https://developers.callfire.com/docs.html#partial-response) page.
    try {
      KeywordConfig result = apiInstance.getKeywordLeaseConfig(keyword, fields);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling KeywordsApi#getKeywordLeaseConfig");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
public class Example {
  public static void main(String[] args) {
    ...
    KeywordsApi apiInstance = new KeywordsApi(defaultClient);
    String keyword = "keyword_example"; // String | To specify a keyword to search for. Example: SUN, MOON
    try {
      Boolean result = apiInstance.isKeywordAvailable(keyword);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling KeywordsApi#isKeywordAvailable");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="updateKeywordLease"></a>
# **updateKeywordLease**
> updateKeywordLease(keyword, keywordLease)
...
public class Example {
  public static void main(String[] args) {
    ...
    KeywordsApi apiInstance = new KeywordsApi(defaultClient);
    String keyword = "keyword_example"; // String | To update a keyword lease
    KeywordLease keywordLease = new KeywordLease(); // KeywordLease | A keyword lease object
    try {
      apiInstance.updateKeywordLease(keyword, keywordLease);
    } catch (ApiException e) {
      System.err.println("Exception when calling KeywordsApi#updateKeywordLease");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="updateKeywordLeaseConfig"></a>
# **updateKeywordLeaseConfig**
> updateKeywordLeaseConfig(keyword, keywordConfig)
...
public class Example {
  public static void main(String[] args) {
    ...
    KeywordsApi apiInstance = new KeywordsApi(defaultClient);
    String keyword = "keyword_example"; // String | To update a keyword lease config
    KeywordConfig keywordConfig = new KeywordConfig(); // KeywordConfig | The configuration of a keyword lease object.
    try {
      apiInstance.updateKeywordLeaseConfig(keyword, keywordConfig);
    } catch (ApiException e) {
      System.err.println("Exception when calling KeywordsApi#updateKeywordLeaseConfig");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
