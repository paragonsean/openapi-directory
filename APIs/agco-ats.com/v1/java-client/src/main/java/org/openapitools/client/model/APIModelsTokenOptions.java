...
public class APIModelsTokenOptions {
  ...
  public APIModelsTokenOptions() {
  }

  public APIModelsTokenOptions bearerAction(BearerActionEnum bearerAction) {
  ...
  public APIModelsTokenOptions maCAction(MaCActionEnum maCAction) {
  ...
  public boolean equals(Object o) {
    ...
    APIModelsTokenOptions apIModelsTokenOptions = (APIModelsTokenOptions) o;
    return Objects.equals(this.bearerAction, apIModelsTokenOptions.bearerAction) &&
        Objects.equals(this.maCAction, apIModelsTokenOptions.maCAction);
  }

  @Override
  public int hashCode() {
    return Objects.hash(bearerAction, maCAction);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class APIModelsTokenOptions {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to APIModelsTokenOptions
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!APIModelsTokenOptions.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in APIModelsTokenOptions is not found in the empty JSON string", APIModelsTokenOptions.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!APIModelsTokenOptions.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `APIModelsTokenOptions` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!APIModelsTokenOptions.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'APIModelsTokenOptions' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<APIModelsTokenOptions> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(APIModelsTokenOptions.class));

       return (TypeAdapter<T>) new TypeAdapter<APIModelsTokenOptions>() {
           @Override
           public void write(JsonWriter out, APIModelsTokenOptions value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public APIModelsTokenOptions read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of APIModelsTokenOptions given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of APIModelsTokenOptions
   * @throws IOException if the JSON string is invalid with respect to APIModelsTokenOptions
   */
  public static APIModelsTokenOptions fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, APIModelsTokenOptions.class);
  }

  /**
   * Convert an instance of APIModelsTokenOptions to an JSON string
   *
   * @return JSON string
   */
