...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AgcoApi.BuildSystemSharedDTOActivity();
  });
  ...
  describe('BuildSystemSharedDTOActivity', function() {
    it('should create an instance of BuildSystemSharedDTOActivity', function() {
      // uncomment below and update the code to test BuildSystemSharedDTOActivity
      //var instance = new AgcoApi.BuildSystemSharedDTOActivity();
      //expect(instance).to.be.a(AgcoApi.BuildSystemSharedDTOActivity);
    });
