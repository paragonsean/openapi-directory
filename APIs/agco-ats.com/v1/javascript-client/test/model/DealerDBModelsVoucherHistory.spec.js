...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AgcoApi.DealerDBModelsVoucherHistory();
  });
  ...
  describe('DealerDBModelsVoucherHistory', function() {
    it('should create an instance of DealerDBModelsVoucherHistory', function() {
      // uncomment below and update the code to test DealerDBModelsVoucherHistory
      //var instance = new AgcoApi.DealerDBModelsVoucherHistory();
      //expect(instance).to.be.a(AgcoApi.DealerDBModelsVoucherHistory);
    });
