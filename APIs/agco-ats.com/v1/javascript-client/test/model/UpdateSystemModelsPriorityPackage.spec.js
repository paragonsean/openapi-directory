...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AgcoApi.UpdateSystemModelsPriorityPackage();
  });
  ...
  describe('UpdateSystemModelsPriorityPackage', function() {
    it('should create an instance of UpdateSystemModelsPriorityPackage', function() {
      // uncomment below and update the code to test UpdateSystemModelsPriorityPackage
      //var instance = new AgcoApi.UpdateSystemModelsPriorityPackage();
      //expect(instance).to.be.a(AgcoApi.UpdateSystemModelsPriorityPackage);
    });
    ...
    it('should have the property priorityPackageID (base name: "PriorityPackageID")', function() {
      // uncomment below and update the code to test the property priorityPackageID
      //var instance = new AgcoApi.UpdateSystemModelsPriorityPackage();
      //expect(instance).to.be();
    });
