...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AgcoApi.DealerDBModelsEDTLiteRegistration();
  });
  ...
  describe('DealerDBModelsEDTLiteRegistration', function() {
    it('should create an instance of DealerDBModelsEDTLiteRegistration', function() {
      // uncomment below and update the code to test DealerDBModelsEDTLiteRegistration
      //var instance = new AgcoApi.DealerDBModelsEDTLiteRegistration();
      //expect(instance).to.be.a(AgcoApi.DealerDBModelsEDTLiteRegistration);
    });
