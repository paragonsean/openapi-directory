...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AgcoApi.BuildSystemSharedDTOJob();
  });
  ...
  describe('BuildSystemSharedDTOJob', function() {
    it('should create an instance of BuildSystemSharedDTOJob', function() {
      // uncomment below and update the code to test BuildSystemSharedDTOJob
      //var instance = new AgcoApi.BuildSystemSharedDTOJob();
      //expect(instance).to.be.a(AgcoApi.BuildSystemSharedDTOJob);
    });
