...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AgcoApi.BuildSystemSharedInterfacesIActivityStep();
  });
  ...
  describe('BuildSystemSharedInterfacesIActivityStep', function() {
    it('should create an instance of BuildSystemSharedInterfacesIActivityStep', function() {
      // uncomment below and update the code to test BuildSystemSharedInterfacesIActivityStep
      //var instance = new AgcoApi.BuildSystemSharedInterfacesIActivityStep();
      //expect(instance).to.be.a(AgcoApi.BuildSystemSharedInterfacesIActivityStep);
    });
