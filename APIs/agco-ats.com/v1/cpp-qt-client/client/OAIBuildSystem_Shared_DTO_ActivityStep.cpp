...
OAIBuildSystem_Shared_DTO_ActivityStep::OAIBuildSystem_Shared_DTO_ActivityStep(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIBuildSystem_Shared_DTO_ActivityStep::OAIBuildSystem_Shared_DTO_ActivityStep() {
    this->initializeModel();
}

OAIBuildSystem_Shared_DTO_ActivityStep::~OAIBuildSystem_Shared_DTO_ActivityStep() {}

void OAIBuildSystem_Shared_DTO_ActivityStep::initializeModel() {
...
void OAIBuildSystem_Shared_DTO_ActivityStep::fromJson(QString jsonString) {
...
void OAIBuildSystem_Shared_DTO_ActivityStep::fromJsonObject(QJsonObject json) {
...
QString OAIBuildSystem_Shared_DTO_ActivityStep::asJson() const {
...
QJsonObject OAIBuildSystem_Shared_DTO_ActivityStep::asJsonObject() const {
    QJsonObject obj;
...
qint32 OAIBuildSystem_Shared_DTO_ActivityStep::getActivityId() const {
    return m_activity_id;
}
void OAIBuildSystem_Shared_DTO_ActivityStep::setActivityId(const qint32 &activity_id) {
    m_activity_id = activity_id;
    m_activity_id_isSet = true;
}

bool OAIBuildSystem_Shared_DTO_ActivityStep::is_activity_id_Set() const{
    return m_activity_id_isSet;
}

bool OAIBuildSystem_Shared_DTO_ActivityStep::is_activity_id_Valid() const{
    return m_activity_id_isValid;
}

qint32 OAIBuildSystem_Shared_DTO_ActivityStep::getActivityStepId() const {
    return m_activity_step_id;
}
void OAIBuildSystem_Shared_DTO_ActivityStep::setActivityStepId(const qint32 &activity_step_id) {
    m_activity_step_id = activity_step_id;
    m_activity_step_id_isSet = true;
}

bool OAIBuildSystem_Shared_DTO_ActivityStep::is_activity_step_id_Set() const{
    return m_activity_step_id_isSet;
}

bool OAIBuildSystem_Shared_DTO_ActivityStep::is_activity_step_id_Valid() const{
    return m_activity_step_id_isValid;
}

QString OAIBuildSystem_Shared_DTO_ActivityStep::getImplementationId() const {
    return m_implementation_id;
}
void OAIBuildSystem_Shared_DTO_ActivityStep::setImplementationId(const QString &implementation_id) {
    m_implementation_id = implementation_id;
    m_implementation_id_isSet = true;
}

bool OAIBuildSystem_Shared_DTO_ActivityStep::is_implementation_id_Set() const{
    return m_implementation_id_isSet;
}

bool OAIBuildSystem_Shared_DTO_ActivityStep::is_implementation_id_Valid() const{
    return m_implementation_id_isValid;
}

QList<OAIBuildSystem_Shared_DTO_ParameterMapping> OAIBuildSystem_Shared_DTO_ActivityStep::getParameterMappings() const {
    return m_parameter_mappings;
}
void OAIBuildSystem_Shared_DTO_ActivityStep::setParameterMappings(const QList<OAIBuildSystem_Shared_DTO_ParameterMapping> &parameter_mappings) {
    m_parameter_mappings = parameter_mappings;
    m_parameter_mappings_isSet = true;
}

bool OAIBuildSystem_Shared_DTO_ActivityStep::is_parameter_mappings_Set() const{
    return m_parameter_mappings_isSet;
}

bool OAIBuildSystem_Shared_DTO_ActivityStep::is_parameter_mappings_Valid() const{
    return m_parameter_mappings_isValid;
}

qint32 OAIBuildSystem_Shared_DTO_ActivityStep::getRunOrder() const {
    return m_run_order;
}
void OAIBuildSystem_Shared_DTO_ActivityStep::setRunOrder(const qint32 &run_order) {
    m_run_order = run_order;
    m_run_order_isSet = true;
}

bool OAIBuildSystem_Shared_DTO_ActivityStep::is_run_order_Set() const{
    return m_run_order_isSet;
}

bool OAIBuildSystem_Shared_DTO_ActivityStep::is_run_order_Valid() const{
    return m_run_order_isValid;
}

qint32 OAIBuildSystem_Shared_DTO_ActivityStep::getStepId() const {
    return m_step_id;
}
void OAIBuildSystem_Shared_DTO_ActivityStep::setStepId(const qint32 &step_id) {
    m_step_id = step_id;
    m_step_id_isSet = true;
}

bool OAIBuildSystem_Shared_DTO_ActivityStep::is_step_id_Set() const{
    return m_step_id_isSet;
}

bool OAIBuildSystem_Shared_DTO_ActivityStep::is_step_id_Valid() const{
    return m_step_id_isValid;
}

QString OAIBuildSystem_Shared_DTO_ActivityStep::getStepName() const {
    return m_step_name;
}
void OAIBuildSystem_Shared_DTO_ActivityStep::setStepName(const QString &step_name) {
    m_step_name = step_name;
    m_step_name_isSet = true;
}

bool OAIBuildSystem_Shared_DTO_ActivityStep::is_step_name_Set() const{
    return m_step_name_isSet;
}

bool OAIBuildSystem_Shared_DTO_ActivityStep::is_step_name_Valid() const{
    return m_step_name_isValid;
}

QString OAIBuildSystem_Shared_DTO_ActivityStep::getUseConfig() const {
    return m_use_config;
}
void OAIBuildSystem_Shared_DTO_ActivityStep::setUseConfig(const QString &use_config) {
    m_use_config = use_config;
    m_use_config_isSet = true;
}

bool OAIBuildSystem_Shared_DTO_ActivityStep::is_use_config_Set() const{
    return m_use_config_isSet;
}

bool OAIBuildSystem_Shared_DTO_ActivityStep::is_use_config_Valid() const{
    return m_use_config_isValid;
}

bool OAIBuildSystem_Shared_DTO_ActivityStep::isSet() const {
...
bool OAIBuildSystem_Shared_DTO_ActivityStep::isValid() const {
