...
public class Curation {
  ...
  public Curation reviewDate(String reviewDate) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.accountId, curation.accountId) &&
        ...
        Objects.equals(this.id, curation.id) &&
        Objects.equals(this.modifiedDate, curation.modifiedDate) &&
        Objects.equals(this.reviewDate, curation.reviewDate) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(accountId, articleId, assignedTo, commentsCount, createdDate, groupId, id, modifiedDate, reviewDate, status, version);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to Curation
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Curation.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Curation is not found in the empty JSON string", Curation.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Curation.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Curation` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Curation.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Curation.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Curation' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Curation> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Curation.class));

       return (TypeAdapter<T>) new TypeAdapter<Curation>() {
           @Override
           public void write(JsonWriter out, Curation value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Curation read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Curation given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Curation
   * @throws IOException if the JSON string is invalid with respect to Curation
   */
  public static Curation fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Curation.class);
  }

  /**
   * Convert an instance of Curation to an JSON string
   *
   * @return JSON string
   */
