...
public class Group {
  public static final String SERIALIZED_NAME_ASSOCIATION_CRITERIA = "association_criteria";
  @SerializedName(SERIALIZED_NAME_ASSOCIATION_CRITERIA)
  private String associationCriteria;
  ...
  public boolean equals(Object o) {
    ...
    Group group = (Group) o;
    return Objects.equals(this.associationCriteria, group.associationCriteria) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(associationCriteria, id, name, parentId, resourceId);
  }
  ...
  static {
    ...
    openapiFields.add("association_criteria");
    ...
    openapiRequiredFields.add("association_criteria");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (!jsonObj.get("association_criteria").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `association_criteria` to be a primitive type in the JSON string but got `%s`", jsonObj.get("association_criteria").toString()));
      }
