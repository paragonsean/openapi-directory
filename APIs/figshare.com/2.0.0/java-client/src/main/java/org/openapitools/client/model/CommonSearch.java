...
public class CommonSearch {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.group, commonSearch.group) &&
        ...
        Objects.equals(this.searchFor, commonSearch.searchFor);
  }

  @Override
  public int hashCode() {
    return Objects.hash(group, institution, limit, modifiedSince, offset, orderDirection, page, pageSize, publishedSince, searchFor);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to CommonSearch
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CommonSearch.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CommonSearch is not found in the empty JSON string", CommonSearch.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CommonSearch.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CommonSearch` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CommonSearch.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CommonSearch' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CommonSearch> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CommonSearch.class));

       return (TypeAdapter<T>) new TypeAdapter<CommonSearch>() {
           @Override
           public void write(JsonWriter out, CommonSearch value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CommonSearch read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CommonSearch given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CommonSearch
   * @throws IOException if the JSON string is invalid with respect to CommonSearch
   */
  public static CommonSearch fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CommonSearch.class);
  }

  /**
   * Convert an instance of CommonSearch to an JSON string
   *
   * @return JSON string
   */
