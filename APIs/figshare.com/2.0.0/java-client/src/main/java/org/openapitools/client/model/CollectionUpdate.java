...
public class CollectionUpdate {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.articles, collectionUpdate.articles) &&
        ...
        Objects.equals(this.funding, collectionUpdate.funding) &&
   ...
   * @throws IOException if the JSON Element is invalid with respect to CollectionUpdate
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CollectionUpdate.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CollectionUpdate is not found in the empty JSON string", CollectionUpdate.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CollectionUpdate.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CollectionUpdate` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CollectionUpdate.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CollectionUpdate' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CollectionUpdate> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CollectionUpdate.class));

       return (TypeAdapter<T>) new TypeAdapter<CollectionUpdate>() {
           @Override
           public void write(JsonWriter out, CollectionUpdate value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CollectionUpdate read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CollectionUpdate given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CollectionUpdate
   * @throws IOException if the JSON string is invalid with respect to CollectionUpdate
   */
  public static CollectionUpdate fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CollectionUpdate.class);
  }

  /**
   * Convert an instance of CollectionUpdate to an JSON string
   *
   * @return JSON string
   */
