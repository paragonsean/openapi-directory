...
|------------ | ------------- | ------------- | -------------|
|**accountId** | **Long** | ID of the account owning the collection |  |
...
|**groupResourceId** | **String** | Collection group resource id |  |
...
|**publishedDate** | **String** | Date when collection was published  |  |
