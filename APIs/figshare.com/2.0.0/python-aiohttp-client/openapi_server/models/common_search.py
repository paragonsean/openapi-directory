...
class CommonSearch(Model):
    """NOTE: This class is auto generated by OpenAPI Generator (https://openapi-generator.tech).

    Do not edit the class manually.
    """

    def __init__(self, group: int=None, institution: int=None, limit: int=None, modified_since: str=None, offset: int=None, order_direction: str='desc', page: int=None, page_size: int=10, published_since: str=None, search_for: str=None):
        """CommonSearch - a model defined in OpenAPI
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'CommonSearch':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The CommonSearch of this CommonSearch.
        """
