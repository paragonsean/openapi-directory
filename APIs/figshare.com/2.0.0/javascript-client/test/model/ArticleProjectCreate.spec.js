...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FigshareApi.ArticleProjectCreate();
  });
  ...
  describe('ArticleProjectCreate', function() {
    it('should create an instance of ArticleProjectCreate', function() {
      // uncomment below and update the code to test ArticleProjectCreate
      //var instance = new FigshareApi.ArticleProjectCreate();
      //expect(instance).to.be.a(FigshareApi.ArticleProjectCreate);
    });
