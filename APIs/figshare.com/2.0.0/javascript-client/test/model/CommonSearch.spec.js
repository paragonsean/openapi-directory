...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FigshareApi.CommonSearch();
  });
  ...
  describe('CommonSearch', function() {
    it('should create an instance of CommonSearch', function() {
      // uncomment below and update the code to test CommonSearch
      //var instance = new FigshareApi.CommonSearch();
      //expect(instance).to.be.a(FigshareApi.CommonSearch);
    });
