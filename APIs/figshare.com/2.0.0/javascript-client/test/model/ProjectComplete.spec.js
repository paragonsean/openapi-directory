...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FigshareApi.ProjectComplete();
  });
  ...
  describe('ProjectComplete', function() {
    it('should create an instance of ProjectComplete', function() {
      // uncomment below and update the code to test ProjectComplete
      //var instance = new FigshareApi.ProjectComplete();
      //expect(instance).to.be.a(FigshareApi.ProjectComplete);
    });
