...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FigshareApi.ArticleEmbargoUpdater();
  });
  ...
  describe('ArticleEmbargoUpdater', function() {
    it('should create an instance of ArticleEmbargoUpdater', function() {
      // uncomment below and update the code to test ArticleEmbargoUpdater
      //var instance = new FigshareApi.ArticleEmbargoUpdater();
      //expect(instance).to.be.a(FigshareApi.ArticleEmbargoUpdater);
    });
