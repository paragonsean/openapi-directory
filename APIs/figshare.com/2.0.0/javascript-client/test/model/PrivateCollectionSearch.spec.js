...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FigshareApi.PrivateCollectionSearch();
  });
  ...
  describe('PrivateCollectionSearch', function() {
    it('should create an instance of PrivateCollectionSearch', function() {
      // uncomment below and update the code to test PrivateCollectionSearch
      //var instance = new FigshareApi.PrivateCollectionSearch();
      //expect(instance).to.be.a(FigshareApi.PrivateCollectionSearch);
    });
