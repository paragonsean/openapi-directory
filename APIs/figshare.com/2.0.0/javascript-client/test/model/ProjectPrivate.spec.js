...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FigshareApi.ProjectPrivate();
  });
  ...
  describe('ProjectPrivate', function() {
    it('should create an instance of ProjectPrivate', function() {
      // uncomment below and update the code to test ProjectPrivate
      //var instance = new FigshareApi.ProjectPrivate();
      //expect(instance).to.be.a(FigshareApi.ProjectPrivate);
    });
