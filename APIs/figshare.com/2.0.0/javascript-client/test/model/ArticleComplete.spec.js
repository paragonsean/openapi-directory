...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FigshareApi.ArticleComplete();
  });
  ...
  describe('ArticleComplete', function() {
    it('should create an instance of ArticleComplete', function() {
      // uncomment below and update the code to test ArticleComplete
      //var instance = new FigshareApi.ArticleComplete();
      //expect(instance).to.be.a(FigshareApi.ArticleComplete);
    });
