...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FigshareApi.PrivateArticleSearch();
  });
  ...
  describe('PrivateArticleSearch', function() {
    it('should create an instance of PrivateArticleSearch', function() {
      // uncomment below and update the code to test PrivateArticleSearch
      //var instance = new FigshareApi.PrivateArticleSearch();
      //expect(instance).to.be.a(FigshareApi.PrivateArticleSearch);
    });
