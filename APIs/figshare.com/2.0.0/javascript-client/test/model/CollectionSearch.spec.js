...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FigshareApi.CollectionSearch();
  });
  ...
  describe('CollectionSearch', function() {
    it('should create an instance of CollectionSearch', function() {
      // uncomment below and update the code to test CollectionSearch
      //var instance = new FigshareApi.CollectionSearch();
      //expect(instance).to.be.a(FigshareApi.CollectionSearch);
    });
