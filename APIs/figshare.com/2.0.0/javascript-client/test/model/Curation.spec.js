...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FigshareApi.Curation();
  });
  ...
  describe('Curation', function() {
    it('should create an instance of Curation', function() {
      // uncomment below and update the code to test Curation
      //var instance = new FigshareApi.Curation();
      //expect(instance).to.be.a(FigshareApi.Curation);
    });
