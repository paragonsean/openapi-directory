...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FigshareApi.ArticleCompletePrivate();
  });
  ...
  describe('ArticleCompletePrivate', function() {
    it('should create an instance of ArticleCompletePrivate', function() {
      // uncomment below and update the code to test ArticleCompletePrivate
      //var instance = new FigshareApi.ArticleCompletePrivate();
      //expect(instance).to.be.a(FigshareApi.ArticleCompletePrivate);
    });
    ...
    it('should have the property figshareUrl (base name: "figshare_url")', function() {
      // uncomment below and update the code to test the property figshareUrl
      //var instance = new FigshareApi.ArticleCompletePrivate();
      //expect(instance).to.be();
    });
