...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FigshareApi.CollectionCompletePrivate();
  });
  ...
  describe('CollectionCompletePrivate', function() {
    it('should create an instance of CollectionCompletePrivate', function() {
      // uncomment below and update the code to test CollectionCompletePrivate
      //var instance = new FigshareApi.CollectionCompletePrivate();
      //expect(instance).to.be.a(FigshareApi.CollectionCompletePrivate);
    });
