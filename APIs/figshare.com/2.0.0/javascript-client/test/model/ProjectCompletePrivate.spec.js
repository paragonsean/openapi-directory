...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FigshareApi.ProjectCompletePrivate();
  });
  ...
  describe('ProjectCompletePrivate', function() {
    it('should create an instance of ProjectCompletePrivate', function() {
      // uncomment below and update the code to test ProjectCompletePrivate
      //var instance = new FigshareApi.ProjectCompletePrivate();
      //expect(instance).to.be.a(FigshareApi.ProjectCompletePrivate);
    });
