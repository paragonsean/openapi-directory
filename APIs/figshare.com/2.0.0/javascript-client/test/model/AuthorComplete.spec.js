...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FigshareApi.AuthorComplete();
  });
  ...
  describe('AuthorComplete', function() {
    it('should create an instance of AuthorComplete', function() {
      // uncomment below and update the code to test AuthorComplete
      //var instance = new FigshareApi.AuthorComplete();
      //expect(instance).to.be.a(FigshareApi.AuthorComplete);
    });
