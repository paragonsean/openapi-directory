...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FigshareApi.PublicFile();
  });
  ...
  describe('PublicFile', function() {
    it('should create an instance of PublicFile', function() {
      // uncomment below and update the code to test PublicFile
      //var instance = new FigshareApi.PublicFile();
      //expect(instance).to.be.a(FigshareApi.PublicFile);
    });
