...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FigshareApi.FileId();
  });
  ...
  describe('FileId', function() {
    it('should create an instance of FileId', function() {
      // uncomment below and update the code to test FileId
      //var instance = new FigshareApi.FileId();
      //expect(instance).to.be.a(FigshareApi.FileId);
    });
