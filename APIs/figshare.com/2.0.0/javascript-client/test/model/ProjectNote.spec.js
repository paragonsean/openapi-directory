...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FigshareApi.ProjectNote();
  });
  ...
  describe('ProjectNote', function() {
    it('should create an instance of ProjectNote', function() {
      // uncomment below and update the code to test ProjectNote
      //var instance = new FigshareApi.ProjectNote();
      //expect(instance).to.be.a(FigshareApi.ProjectNote);
    });
