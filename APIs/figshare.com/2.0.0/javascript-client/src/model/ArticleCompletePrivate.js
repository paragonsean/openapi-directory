...
/**
 * The ArticleCompletePrivate model module.
 * @module model/ArticleCompletePrivate
 * @version 2.0.0
 */
class ArticleCompletePrivate {
    /**
     * Constructs a new <code>ArticleCompletePrivate</code>.
     * @alias module:model/ArticleCompletePrivate
     * @implements module:model/ArticleComplete
     * @param authors {Array.<module:model/Author>} List of article authors
     * @param customFields {Array.<module:model/CustomArticleField>} List of custom fields values
     * @param embargoOptions {Array.<module:model/GroupEmbargoOptions>} List of embargo options
     * @param figshareUrl {String} Article public url
     * @param files {Array.<module:model/PublicFile>} List of article files
     * @param resourceDoi {String} Article DOI
     * @param resourceTitle {String} Article resource title
    ...
    constructor(authors, customFields, embargoOptions, figshareUrl, files, resourceDoi, resourceTitle, categories, citation, confidentialReason, createdDate, description, embargoDate, embargoReason, embargoTitle, embargoType, funding, fundingList, hasLinkedFile, isActive, isConfidential, isEmbargoed, isMetadataRecord, isPublic, license, metadataReason, modifiedDate, references, size, status, tags, version, definedType, definedTypeName, doi, groupId, handle, id, publishedDate, thumb, timeline, title, url, urlPrivateApi, urlPrivateHtml, urlPublicApi, urlPublicHtml) { 
        ...
        ArticleCompletePrivate.initialize(this, authors, customFields, embargoOptions, figshareUrl, files, resourceDoi, resourceTitle, categories, citation, confidentialReason, createdDate, description, embargoDate, embargoReason, embargoTitle, embargoType, funding, fundingList, hasLinkedFile, isActive, isConfidential, isEmbargoed, isMetadataRecord, isPublic, license, metadataReason, modifiedDate, references, size, status, tags, version, definedType, definedTypeName, doi, groupId, handle, id, publishedDate, thumb, timeline, title, url, urlPrivateApi, urlPrivateHtml, urlPublicApi, urlPublicHtml);
    }
     ...
     */
    static initialize(obj, authors, customFields, embargoOptions, figshareUrl, files, resourceDoi, resourceTitle, categories, citation, confidentialReason, createdDate, description, embargoDate, embargoReason, embargoTitle, embargoType, funding, fundingList, hasLinkedFile, isActive, isConfidential, isEmbargoed, isMetadataRecord, isPublic, license, metadataReason, modifiedDate, references, size, status, tags, version, definedType, definedTypeName, doi, groupId, handle, id, publishedDate, thumb, timeline, title, url, urlPrivateApi, urlPrivateHtml, urlPublicApi, urlPublicHtml) { 
    ...
    /**
     * Constructs a <code>ArticleCompletePrivate</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ArticleCompletePrivate} obj Optional instance to populate.
     * @return {module:model/ArticleCompletePrivate} The populated <code>ArticleCompletePrivate</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ArticleCompletePrivate();
            ArticleComplete.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>ArticleCompletePrivate</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ArticleCompletePrivate</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ArticleCompletePrivate.RequiredProperties) {
...
ArticleCompletePrivate.RequiredProperties = ["account_id", "group_resource_id", "authors", "custom_fields", "embargo_options", "figshare_url", "files", "resource_doi", "resource_title", "categories", "citation", "confidential_reason", "created_date", "description", "embargo_date", "embargo_reason", "embargo_title", "embargo_type", "funding", "funding_list", "has_linked_file", "is_active", "is_confidential", "is_embargoed", "is_metadata_record", "is_public", "license", "metadata_reason", "modified_date", "references", "size", "status", "tags", "version", "defined_type", "defined_type_name", "doi", "group_id", "handle", "id", "published_date", "thumb", "timeline", "title", "url", "url_private_api", "url_private_html", "url_public_api", "url_public_html"];

/**
 * ID of the account owning the article
 * @member {Number} account_id
 */
ArticleCompletePrivate.prototype['account_id'] = undefined;

/**
 * Group resource id
 * @member {String} group_resource_id
 */
ArticleCompletePrivate.prototype['group_resource_id'] = undefined;

/**
 * List of article authors
 * @member {Array.<module:model/Author>} authors
 */
ArticleCompletePrivate.prototype['authors'] = undefined;

/**
 * List of custom fields values
 * @member {Array.<module:model/CustomArticleField>} custom_fields
 */
ArticleCompletePrivate.prototype['custom_fields'] = undefined;

/**
 * List of embargo options
 * @member {Array.<module:model/GroupEmbargoOptions>} embargo_options
 */
ArticleCompletePrivate.prototype['embargo_options'] = undefined;

/**
 * Article public url
 * @member {String} figshare_url
 */
ArticleCompletePrivate.prototype['figshare_url'] = undefined;

/**
 * List of article files
 * @member {Array.<module:model/PublicFile>} files
 */
ArticleCompletePrivate.prototype['files'] = undefined;

/**
 * Article DOI
 * @member {String} resource_doi
 */
ArticleCompletePrivate.prototype['resource_doi'] = undefined;

/**
 * Article resource title
 * @member {String} resource_title
 */
ArticleCompletePrivate.prototype['resource_title'] = undefined;

/**
 * List of categories selected for the article
 * @member {Array.<module:model/Category>} categories
 */
ArticleCompletePrivate.prototype['categories'] = undefined;

/**
 * Article citation
 * @member {String} citation
 */
ArticleCompletePrivate.prototype['citation'] = undefined;

/**
 * Confidentiality reason
 * @member {String} confidential_reason
 */
ArticleCompletePrivate.prototype['confidential_reason'] = undefined;

/**
 * Date when article was created
 * @member {String} created_date
 */
ArticleCompletePrivate.prototype['created_date'] = undefined;

/**
 * Article description
 * @member {String} description
 */
ArticleCompletePrivate.prototype['description'] = undefined;

/**
 * Date when embargo lifts
 * @member {String} embargo_date
 */
ArticleCompletePrivate.prototype['embargo_date'] = undefined;

/**
 * Reason for embargo
 * @member {String} embargo_reason
 */
ArticleCompletePrivate.prototype['embargo_reason'] = undefined;

/**
 * Title for embargo
 * @member {String} embargo_title
 */
ArticleCompletePrivate.prototype['embargo_title'] = undefined;

/**
 * Article embargo
 * @member {String} embargo_type
 */
ArticleCompletePrivate.prototype['embargo_type'] = undefined;

/**
 * Article funding
 * @member {String} funding
 */
ArticleCompletePrivate.prototype['funding'] = undefined;

/**
 * @member {Array.<Number>} funding_list
 */
ArticleCompletePrivate.prototype['funding_list'] = undefined;

/**
 * True if any files are linked to the article
 * @member {Boolean} has_linked_file
 */
ArticleCompletePrivate.prototype['has_linked_file'] = undefined;

/**
 * True if article is active
 * @member {Boolean} is_active
 */
ArticleCompletePrivate.prototype['is_active'] = undefined;

/**
 * Article Confidentiality
 * @member {Boolean} is_confidential
 */
ArticleCompletePrivate.prototype['is_confidential'] = undefined;

/**
 * True if article is embargoed
 * @member {Boolean} is_embargoed
 */
ArticleCompletePrivate.prototype['is_embargoed'] = undefined;

/**
 * True if article has no files
 * @member {Boolean} is_metadata_record
 */
ArticleCompletePrivate.prototype['is_metadata_record'] = undefined;

/**
 * True if article is published
 * @member {Boolean} is_public
 */
ArticleCompletePrivate.prototype['is_public'] = undefined;

/**
 * @member {module:model/License} license
 */
ArticleCompletePrivate.prototype['license'] = undefined;

/**
 * Article metadata reason
 * @member {String} metadata_reason
 */
ArticleCompletePrivate.prototype['metadata_reason'] = undefined;

/**
 * Date when article was last modified
 * @member {String} modified_date
 */
ArticleCompletePrivate.prototype['modified_date'] = undefined;

/**
 * List of references
 * @member {Array.<String>} references
 */
ArticleCompletePrivate.prototype['references'] = undefined;

/**
 * Article size
 * @member {Number} size
 */
ArticleCompletePrivate.prototype['size'] = undefined;

/**
 * Article status
 * @member {String} status
 */
ArticleCompletePrivate.prototype['status'] = undefined;

/**
 * List of article tags
 * @member {Array.<String>} tags
 */
ArticleCompletePrivate.prototype['tags'] = undefined;

/**
 * Article version
 * @member {Number} version
 */
ArticleCompletePrivate.prototype['version'] = undefined;

/**
 * Type of article identifier
 * @member {Number} defined_type
 */
ArticleCompletePrivate.prototype['defined_type'] = undefined;

/**
 * Name of the article type identifier
 * @member {String} defined_type_name
 */
ArticleCompletePrivate.prototype['defined_type_name'] = undefined;

/**
 * DOI
 * @member {String} doi
 */
ArticleCompletePrivate.prototype['doi'] = undefined;

/**
 * Group ID
 * @member {Number} group_id
 */
ArticleCompletePrivate.prototype['group_id'] = undefined;

/**
 * Handle
 * @member {String} handle
 */
ArticleCompletePrivate.prototype['handle'] = undefined;

/**
 * Unique identifier for article
 * @member {Number} id
 */
ArticleCompletePrivate.prototype['id'] = undefined;

/**
 * Posted date
 * @member {String} published_date
 */
ArticleCompletePrivate.prototype['published_date'] = undefined;

/**
 * Thumbnail image
 * @member {String} thumb
 */
ArticleCompletePrivate.prototype['thumb'] = undefined;

/**
 * @member {module:model/Timeline} timeline
 */
ArticleCompletePrivate.prototype['timeline'] = undefined;

/**
 * Title of article
 * @member {String} title
 */
ArticleCompletePrivate.prototype['title'] = undefined;

/**
 * Api endpoint for article
 * @member {String} url
 */
ArticleCompletePrivate.prototype['url'] = undefined;

/**
 * Private Api endpoint for article
 * @member {String} url_private_api
 */
ArticleCompletePrivate.prototype['url_private_api'] = undefined;

/**
 * Private site endpoint for article
 * @member {String} url_private_html
 */
ArticleCompletePrivate.prototype['url_private_html'] = undefined;

/**
 * Public Api endpoint for article
 * @member {String} url_public_api
 */
ArticleCompletePrivate.prototype['url_public_api'] = undefined;

/**
 * Public site endpoint for article
 * @member {String} url_public_html
 */
ArticleCompletePrivate.prototype['url_public_html'] = undefined;


// Implement ArticleComplete interface:
/**
 * List of categories selected for the article
 * @member {Array.<module:model/Category>} categories
 */
...
export default ArticleCompletePrivate;
