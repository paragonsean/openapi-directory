...
/**
 * The ProjectsSearch model module.
 * @module model/ProjectsSearch
 * @version 2.0.0
 */
class ProjectsSearch {
    /**
     * Constructs a new <code>ProjectsSearch</code>.
     * @alias module:model/ProjectsSearch
     * @implements module:model/CommonSearch
     */
    constructor() { 
        CommonSearch.initialize(this);
        ProjectsSearch.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ProjectsSearch</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ProjectsSearch} obj Optional instance to populate.
     * @return {module:model/ProjectsSearch} The populated <code>ProjectsSearch</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ProjectsSearch();
    ...
    /**
     * Validates the JSON data with respect to <code>ProjectsSearch</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ProjectsSearch</code>.
     */
 ...
 * @member {module:model/ProjectsSearch.OrderEnum} order
 * @default 'published_date'
 */
ProjectsSearch.prototype['order'] = 'published_date';

/**
 * only return collections from this group
 * @member {Number} group
 */
ProjectsSearch.prototype['group'] = undefined;

/**
 * only return collections from this institution
 * @member {Number} institution
 */
ProjectsSearch.prototype['institution'] = undefined;

/**
 * Number of results included on a page. Used for pagination with query
 * @member {Number} limit
 */
ProjectsSearch.prototype['limit'] = undefined;
 ...
 */
ProjectsSearch.prototype['modified_since'] = undefined;

/**
 * Where to start the listing(the offset of the first result). Used for pagination with limit
 * @member {Number} offset
 */
ProjectsSearch.prototype['offset'] = undefined;

/**
 * Direction of ordering
 * @member {module:model/ProjectsSearch.OrderDirectionEnum} order_direction
 * @default 'desc'
 */
ProjectsSearch.prototype['order_direction'] = 'desc';

/**
 * Page number. Used for pagination with page_size
 * @member {Number} page
 */
ProjectsSearch.prototype['page'] = undefined;
 ...
 * @default 10
 */
ProjectsSearch.prototype['page_size'] = 10;
 ...
 */
ProjectsSearch.prototype['published_since'] = undefined;

/**
 * Search term
 * @member {String} search_for
 */
ProjectsSearch.prototype['search_for'] = undefined;
 ...
 * @readonly
 */
ProjectsSearch['OrderDirectionEnum'] = {
