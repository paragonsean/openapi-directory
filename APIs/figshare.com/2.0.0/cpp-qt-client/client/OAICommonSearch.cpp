...
OAICommonSearch::OAICommonSearch(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICommonSearch::OAICommonSearch() {
    this->initializeModel();
}

OAICommonSearch::~OAICommonSearch() {}

void OAICommonSearch::initializeModel() {
...
void OAICommonSearch::fromJson(QString jsonString) {
...
void OAICommonSearch::fromJsonObject(QJsonObject json) {
...
QString OAICommonSearch::asJson() const {
...
QJsonObject OAICommonSearch::asJsonObject() const {
    QJsonObject obj;
    if (m_group_isSet) {
...
qint32 OAICommonSearch::getGroup() const {
    return m_group;
}
void OAICommonSearch::setGroup(const qint32 &group) {
    m_group = group;
    m_group_isSet = true;
}

bool OAICommonSearch::is_group_Set() const{
    return m_group_isSet;
}

bool OAICommonSearch::is_group_Valid() const{
    return m_group_isValid;
}

qint32 OAICommonSearch::getInstitution() const {
    return m_institution;
}
void OAICommonSearch::setInstitution(const qint32 &institution) {
    m_institution = institution;
    m_institution_isSet = true;
}

bool OAICommonSearch::is_institution_Set() const{
    return m_institution_isSet;
}

bool OAICommonSearch::is_institution_Valid() const{
    return m_institution_isValid;
}

qint64 OAICommonSearch::getLimit() const {
    return m_limit;
}
void OAICommonSearch::setLimit(const qint64 &limit) {
    m_limit = limit;
    m_limit_isSet = true;
}

bool OAICommonSearch::is_limit_Set() const{
    return m_limit_isSet;
}

bool OAICommonSearch::is_limit_Valid() const{
    return m_limit_isValid;
}

QString OAICommonSearch::getModifiedSince() const {
    return m_modified_since;
}
void OAICommonSearch::setModifiedSince(const QString &modified_since) {
    m_modified_since = modified_since;
    m_modified_since_isSet = true;
}

bool OAICommonSearch::is_modified_since_Set() const{
    return m_modified_since_isSet;
}

bool OAICommonSearch::is_modified_since_Valid() const{
    return m_modified_since_isValid;
}

qint64 OAICommonSearch::getOffset() const {
    return m_offset;
}
void OAICommonSearch::setOffset(const qint64 &offset) {
    m_offset = offset;
    m_offset_isSet = true;
}

bool OAICommonSearch::is_offset_Set() const{
    return m_offset_isSet;
}

bool OAICommonSearch::is_offset_Valid() const{
    return m_offset_isValid;
}

QString OAICommonSearch::getOrderDirection() const {
    return m_order_direction;
}
void OAICommonSearch::setOrderDirection(const QString &order_direction) {
    m_order_direction = order_direction;
    m_order_direction_isSet = true;
}

bool OAICommonSearch::is_order_direction_Set() const{
    return m_order_direction_isSet;
}

bool OAICommonSearch::is_order_direction_Valid() const{
    return m_order_direction_isValid;
}

qint64 OAICommonSearch::getPage() const {
    return m_page;
}
void OAICommonSearch::setPage(const qint64 &page) {
    m_page = page;
    m_page_isSet = true;
}

bool OAICommonSearch::is_page_Set() const{
    return m_page_isSet;
}

bool OAICommonSearch::is_page_Valid() const{
    return m_page_isValid;
}

qint64 OAICommonSearch::getPageSize() const {
    return m_page_size;
}
void OAICommonSearch::setPageSize(const qint64 &page_size) {
    m_page_size = page_size;
    m_page_size_isSet = true;
}

bool OAICommonSearch::is_page_size_Set() const{
    return m_page_size_isSet;
}

bool OAICommonSearch::is_page_size_Valid() const{
    return m_page_size_isValid;
}

QString OAICommonSearch::getPublishedSince() const {
    return m_published_since;
}
void OAICommonSearch::setPublishedSince(const QString &published_since) {
    m_published_since = published_since;
    m_published_since_isSet = true;
}

bool OAICommonSearch::is_published_since_Set() const{
    return m_published_since_isSet;
}

bool OAICommonSearch::is_published_since_Valid() const{
    return m_published_since_isValid;
}

QString OAICommonSearch::getSearchFor() const {
    return m_search_for;
}
void OAICommonSearch::setSearchFor(const QString &search_for) {
    m_search_for = search_for;
    m_search_for_isSet = true;
}

bool OAICommonSearch::is_search_for_Set() const{
    return m_search_for_isSet;
}

bool OAICommonSearch::is_search_for_Valid() const{
    return m_search_for_isValid;
}

bool OAICommonSearch::isSet() const {
...
bool OAICommonSearch::isValid() const {
