...
/*
 * OAIArticleCompletePrivate.h
 *
 * 
 */

#ifndef OAIArticleCompletePrivate_H
#define OAIArticleCompletePrivate_H
...
class OAIArticleCompletePrivate : public OAIObject {
public:
    OAIArticleCompletePrivate();
    OAIArticleCompletePrivate(QString json);
    ~OAIArticleCompletePrivate() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIArticleCompletePrivate)

#endif // OAIArticleCompletePrivate_H
