...
/*
 * OAICollectionCreate.h
 *
 * 
 */

#ifndef OAICollectionCreate_H
#define OAICollectionCreate_H
...
class OAICollectionCreate : public OAIObject {
public:
    OAICollectionCreate();
    OAICollectionCreate(QString json);
    ~OAICollectionCreate() override;
    ...
    QList<qint32> getArticles() const;
    void setArticles(const QList<qint32> &articles);
    ...
    qint32 getResourceVersion() const;
    void setResourceVersion(const qint32 &resource_version);
...
Q_DECLARE_METATYPE(OpenAPI::OAICollectionCreate)

#endif // OAICollectionCreate_H
