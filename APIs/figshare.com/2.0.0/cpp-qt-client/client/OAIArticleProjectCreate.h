...
/*
 * OAIArticleProjectCreate.h
 *
 * 
 */

#ifndef OAIArticleProjectCreate_H
#define OAIArticleProjectCreate_H
...
class OAIArticleProjectCreate : public OAIObject {
public:
    OAIArticleProjectCreate();
    OAIArticleProjectCreate(QString json);
    ~OAIArticleProjectCreate() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIArticleProjectCreate)

#endif // OAIArticleProjectCreate_H
