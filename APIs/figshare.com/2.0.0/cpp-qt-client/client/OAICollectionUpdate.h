...
/*
 * OAICollectionUpdate.h
 *
 * 
 */

#ifndef OAICollectionUpdate_H
#define OAICollectionUpdate_H
...
class OAICollectionUpdate : public OAIObject {
public:
    OAICollectionUpdate();
    OAICollectionUpdate(QString json);
    ~OAICollectionUpdate() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICollectionUpdate)

#endif // OAICollectionUpdate_H
