...
/*
 * OAIPrivateArticleSearch.h
 *
 * 
 */

#ifndef OAIPrivateArticleSearch_H
#define OAIPrivateArticleSearch_H
...
class OAIPrivateArticleSearch : public OAIObject {
public:
    OAIPrivateArticleSearch();
    OAIPrivateArticleSearch(QString json);
    ~OAIPrivateArticleSearch() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPrivateArticleSearch)

#endif // OAIPrivateArticleSearch_H
