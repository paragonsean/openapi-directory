...
/*
 * OAIPrivateCollectionSearch.h
 *
 * 
 */

#ifndef OAIPrivateCollectionSearch_H
#define OAIPrivateCollectionSearch_H
...
class OAIPrivateCollectionSearch : public OAIObject {
public:
    OAIPrivateCollectionSearch();
    OAIPrivateCollectionSearch(QString json);
    ~OAIPrivateCollectionSearch() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPrivateCollectionSearch)

#endif // OAIPrivateCollectionSearch_H
