...
#ifndef OAIPublicFile_H
#define OAIPublicFile_H
...
class OAIPublicFile : public OAIObject {
public:
    OAIPublicFile();
    OAIPublicFile(QString json);
    ~OAIPublicFile() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPublicFile)

#endif // OAIPublicFile_H
