...
#ifndef OAIProjectsSearch_H
#define OAIProjectsSearch_H
...
class OAIProjectsSearch : public OAIObject {
public:
    OAIProjectsSearch();
    OAIProjectsSearch(QString json);
    ~OAIProjectsSearch() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIProjectsSearch)

#endif // OAIProjectsSearch_H
