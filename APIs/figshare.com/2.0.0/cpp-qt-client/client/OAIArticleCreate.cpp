...
OAIArticleCreate::OAIArticleCreate(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIArticleCreate::OAIArticleCreate() {
    this->initializeModel();
}

OAIArticleCreate::~OAIArticleCreate() {}

void OAIArticleCreate::initializeModel() {
...
void OAIArticleCreate::fromJson(QString jsonString) {
...
void OAIArticleCreate::fromJsonObject(QJsonObject json) {
...
QString OAIArticleCreate::asJson() const {
...
QJsonObject OAIArticleCreate::asJsonObject() const {
    QJsonObject obj;
    if (m_authors.size() > 0) {
...
QList<OAIObject> OAIArticleCreate::getAuthors() const {
    return m_authors;
}
void OAIArticleCreate::setAuthors(const QList<OAIObject> &authors) {
    m_authors = authors;
    m_authors_isSet = true;
}

bool OAIArticleCreate::is_authors_Set() const{
    return m_authors_isSet;
}

bool OAIArticleCreate::is_authors_Valid() const{
    return m_authors_isValid;
}

QList<qint64> OAIArticleCreate::getCategories() const {
    return m_categories;
}
void OAIArticleCreate::setCategories(const QList<qint64> &categories) {
    m_categories = categories;
    m_categories_isSet = true;
}

bool OAIArticleCreate::is_categories_Set() const{
    return m_categories_isSet;
}

bool OAIArticleCreate::is_categories_Valid() const{
    return m_categories_isValid;
}

QList<QString> OAIArticleCreate::getCategoriesBySourceId() const {
    return m_categories_by_source_id;
}
void OAIArticleCreate::setCategoriesBySourceId(const QList<QString> &categories_by_source_id) {
    m_categories_by_source_id = categories_by_source_id;
    m_categories_by_source_id_isSet = true;
}

bool OAIArticleCreate::is_categories_by_source_id_Set() const{
    return m_categories_by_source_id_isSet;
}

bool OAIArticleCreate::is_categories_by_source_id_Valid() const{
    return m_categories_by_source_id_isValid;
}

OAIObject OAIArticleCreate::getCustomFields() const {
    return m_custom_fields;
}
void OAIArticleCreate::setCustomFields(const OAIObject &custom_fields) {
    m_custom_fields = custom_fields;
    m_custom_fields_isSet = true;
}

bool OAIArticleCreate::is_custom_fields_Set() const{
    return m_custom_fields_isSet;
}

bool OAIArticleCreate::is_custom_fields_Valid() const{
    return m_custom_fields_isValid;
}

QList<OAICustomArticleFieldAdd> OAIArticleCreate::getCustomFieldsList() const {
    return m_custom_fields_list;
}
void OAIArticleCreate::setCustomFieldsList(const QList<OAICustomArticleFieldAdd> &custom_fields_list) {
    m_custom_fields_list = custom_fields_list;
    m_custom_fields_list_isSet = true;
}

bool OAIArticleCreate::is_custom_fields_list_Set() const{
    return m_custom_fields_list_isSet;
}

bool OAIArticleCreate::is_custom_fields_list_Valid() const{
    return m_custom_fields_list_isValid;
}

QString OAIArticleCreate::getDefinedType() const {
    return m_defined_type;
}
void OAIArticleCreate::setDefinedType(const QString &defined_type) {
    m_defined_type = defined_type;
    m_defined_type_isSet = true;
}

bool OAIArticleCreate::is_defined_type_Set() const{
    return m_defined_type_isSet;
}

bool OAIArticleCreate::is_defined_type_Valid() const{
    return m_defined_type_isValid;
}

QString OAIArticleCreate::getDescription() const {
    return m_description;
}
void OAIArticleCreate::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAIArticleCreate::is_description_Set() const{
    return m_description_isSet;
}

bool OAIArticleCreate::is_description_Valid() const{
    return m_description_isValid;
}

QString OAIArticleCreate::getDoi() const {
    return m_doi;
}
void OAIArticleCreate::setDoi(const QString &doi) {
    m_doi = doi;
    m_doi_isSet = true;
}

bool OAIArticleCreate::is_doi_Set() const{
    return m_doi_isSet;
}

bool OAIArticleCreate::is_doi_Valid() const{
    return m_doi_isValid;
}

QString OAIArticleCreate::getFunding() const {
    return m_funding;
}
void OAIArticleCreate::setFunding(const QString &funding) {
    m_funding = funding;
    m_funding_isSet = true;
}

bool OAIArticleCreate::is_funding_Set() const{
    return m_funding_isSet;
}

bool OAIArticleCreate::is_funding_Valid() const{
    return m_funding_isValid;
}

QList<OAIFundingCreate> OAIArticleCreate::getFundingList() const {
    return m_funding_list;
}
void OAIArticleCreate::setFundingList(const QList<OAIFundingCreate> &funding_list) {
    m_funding_list = funding_list;
    m_funding_list_isSet = true;
}

bool OAIArticleCreate::is_funding_list_Set() const{
    return m_funding_list_isSet;
}

bool OAIArticleCreate::is_funding_list_Valid() const{
    return m_funding_list_isValid;
}

qint64 OAIArticleCreate::getGroupId() const {
    return m_group_id;
}
void OAIArticleCreate::setGroupId(const qint64 &group_id) {
    m_group_id = group_id;
    m_group_id_isSet = true;
}

bool OAIArticleCreate::is_group_id_Set() const{
    return m_group_id_isSet;
}

bool OAIArticleCreate::is_group_id_Valid() const{
    return m_group_id_isValid;
}

QString OAIArticleCreate::getHandle() const {
    return m_handle;
}
void OAIArticleCreate::setHandle(const QString &handle) {
    m_handle = handle;
    m_handle_isSet = true;
}

bool OAIArticleCreate::is_handle_Set() const{
    return m_handle_isSet;
}

bool OAIArticleCreate::is_handle_Valid() const{
    return m_handle_isValid;
}

bool OAIArticleCreate::isIsMetadataRecord() const {
    return m_is_metadata_record;
}
void OAIArticleCreate::setIsMetadataRecord(const bool &is_metadata_record) {
    m_is_metadata_record = is_metadata_record;
    m_is_metadata_record_isSet = true;
}

bool OAIArticleCreate::is_is_metadata_record_Set() const{
    return m_is_metadata_record_isSet;
}

bool OAIArticleCreate::is_is_metadata_record_Valid() const{
    return m_is_metadata_record_isValid;
}

QList<QString> OAIArticleCreate::getKeywords() const {
    return m_keywords;
}
void OAIArticleCreate::setKeywords(const QList<QString> &keywords) {
    m_keywords = keywords;
    m_keywords_isSet = true;
}

bool OAIArticleCreate::is_keywords_Set() const{
    return m_keywords_isSet;
}

bool OAIArticleCreate::is_keywords_Valid() const{
    return m_keywords_isValid;
}

qint64 OAIArticleCreate::getLicense() const {
    return m_license;
}
void OAIArticleCreate::setLicense(const qint64 &license) {
    m_license = license;
    m_license_isSet = true;
}

bool OAIArticleCreate::is_license_Set() const{
    return m_license_isSet;
}

bool OAIArticleCreate::is_license_Valid() const{
    return m_license_isValid;
}

QString OAIArticleCreate::getMetadataReason() const {
    return m_metadata_reason;
}
void OAIArticleCreate::setMetadataReason(const QString &metadata_reason) {
    m_metadata_reason = metadata_reason;
    m_metadata_reason_isSet = true;
}

bool OAIArticleCreate::is_metadata_reason_Set() const{
    return m_metadata_reason_isSet;
}

bool OAIArticleCreate::is_metadata_reason_Valid() const{
    return m_metadata_reason_isValid;
}

QList<QString> OAIArticleCreate::getReferences() const {
    return m_references;
}
void OAIArticleCreate::setReferences(const QList<QString> &references) {
    m_references = references;
    m_references_isSet = true;
}

bool OAIArticleCreate::is_references_Set() const{
    return m_references_isSet;
}

bool OAIArticleCreate::is_references_Valid() const{
    return m_references_isValid;
}

QString OAIArticleCreate::getResourceDoi() const {
    return m_resource_doi;
}
void OAIArticleCreate::setResourceDoi(const QString &resource_doi) {
    m_resource_doi = resource_doi;
    m_resource_doi_isSet = true;
}

bool OAIArticleCreate::is_resource_doi_Set() const{
    return m_resource_doi_isSet;
}

bool OAIArticleCreate::is_resource_doi_Valid() const{
    return m_resource_doi_isValid;
}

QString OAIArticleCreate::getResourceTitle() const {
    return m_resource_title;
}
void OAIArticleCreate::setResourceTitle(const QString &resource_title) {
    m_resource_title = resource_title;
    m_resource_title_isSet = true;
}

bool OAIArticleCreate::is_resource_title_Set() const{
    return m_resource_title_isSet;
}

bool OAIArticleCreate::is_resource_title_Valid() const{
    return m_resource_title_isValid;
}

QList<QString> OAIArticleCreate::getTags() const {
    return m_tags;
}
void OAIArticleCreate::setTags(const QList<QString> &tags) {
    m_tags = tags;
    m_tags_isSet = true;
}

bool OAIArticleCreate::is_tags_Set() const{
    return m_tags_isSet;
}

bool OAIArticleCreate::is_tags_Valid() const{
    return m_tags_isValid;
}

OAITimelineUpdate OAIArticleCreate::getTimeline() const {
    return m_timeline;
}
void OAIArticleCreate::setTimeline(const OAITimelineUpdate &timeline) {
    m_timeline = timeline;
    m_timeline_isSet = true;
}

bool OAIArticleCreate::is_timeline_Set() const{
    return m_timeline_isSet;
}

bool OAIArticleCreate::is_timeline_Valid() const{
    return m_timeline_isValid;
}

QString OAIArticleCreate::getTitle() const {
    return m_title;
}
void OAIArticleCreate::setTitle(const QString &title) {
    m_title = title;
    m_title_isSet = true;
}

bool OAIArticleCreate::is_title_Set() const{
    return m_title_isSet;
}

bool OAIArticleCreate::is_title_Valid() const{
    return m_title_isValid;
}

bool OAIArticleCreate::isSet() const {
...
bool OAIArticleCreate::isValid() const {
