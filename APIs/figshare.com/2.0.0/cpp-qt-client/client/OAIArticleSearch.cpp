...
OAIArticleSearch::OAIArticleSearch(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIArticleSearch::OAIArticleSearch() {
    this->initializeModel();
}

OAIArticleSearch::~OAIArticleSearch() {}

void OAIArticleSearch::initializeModel() {
...
void OAIArticleSearch::fromJson(QString jsonString) {
...
void OAIArticleSearch::fromJsonObject(QJsonObject json) {
...
QString OAIArticleSearch::asJson() const {
...
QJsonObject OAIArticleSearch::asJsonObject() const {
    QJsonObject obj;
    if (m_doi_isSet) {
...
QString OAIArticleSearch::getDoi() const {
    return m_doi;
}
void OAIArticleSearch::setDoi(const QString &doi) {
    m_doi = doi;
    m_doi_isSet = true;
}

bool OAIArticleSearch::is_doi_Set() const{
    return m_doi_isSet;
}

bool OAIArticleSearch::is_doi_Valid() const{
    return m_doi_isValid;
}

QString OAIArticleSearch::getHandle() const {
    return m_handle;
}
void OAIArticleSearch::setHandle(const QString &handle) {
    m_handle = handle;
    m_handle_isSet = true;
}

bool OAIArticleSearch::is_handle_Set() const{
    return m_handle_isSet;
}

bool OAIArticleSearch::is_handle_Valid() const{
    return m_handle_isValid;
}

qint64 OAIArticleSearch::getItemType() const {
    return m_item_type;
}
void OAIArticleSearch::setItemType(const qint64 &item_type) {
    m_item_type = item_type;
    m_item_type_isSet = true;
}

bool OAIArticleSearch::is_item_type_Set() const{
    return m_item_type_isSet;
}

bool OAIArticleSearch::is_item_type_Valid() const{
    return m_item_type_isValid;
}

QString OAIArticleSearch::getOrder() const {
    return m_order;
}
void OAIArticleSearch::setOrder(const QString &order) {
    m_order = order;
    m_order_isSet = true;
}

bool OAIArticleSearch::is_order_Set() const{
    return m_order_isSet;
}

bool OAIArticleSearch::is_order_Valid() const{
    return m_order_isValid;
}

qint64 OAIArticleSearch::getProjectId() const {
    return m_project_id;
}
void OAIArticleSearch::setProjectId(const qint64 &project_id) {
    m_project_id = project_id;
    m_project_id_isSet = true;
}

bool OAIArticleSearch::is_project_id_Set() const{
    return m_project_id_isSet;
}

bool OAIArticleSearch::is_project_id_Valid() const{
    return m_project_id_isValid;
}

QString OAIArticleSearch::getResourceDoi() const {
    return m_resource_doi;
}
void OAIArticleSearch::setResourceDoi(const QString &resource_doi) {
    m_resource_doi = resource_doi;
    m_resource_doi_isSet = true;
}

bool OAIArticleSearch::is_resource_doi_Set() const{
    return m_resource_doi_isSet;
}

bool OAIArticleSearch::is_resource_doi_Valid() const{
    return m_resource_doi_isValid;
}

qint32 OAIArticleSearch::getGroup() const {
    return m_group;
}
void OAIArticleSearch::setGroup(const qint32 &group) {
    m_group = group;
    m_group_isSet = true;
}

bool OAIArticleSearch::is_group_Set() const{
    return m_group_isSet;
}

bool OAIArticleSearch::is_group_Valid() const{
    return m_group_isValid;
}

qint32 OAIArticleSearch::getInstitution() const {
    return m_institution;
}
void OAIArticleSearch::setInstitution(const qint32 &institution) {
    m_institution = institution;
    m_institution_isSet = true;
}

bool OAIArticleSearch::is_institution_Set() const{
    return m_institution_isSet;
}

bool OAIArticleSearch::is_institution_Valid() const{
    return m_institution_isValid;
}

qint64 OAIArticleSearch::getLimit() const {
    return m_limit;
}
void OAIArticleSearch::setLimit(const qint64 &limit) {
    m_limit = limit;
    m_limit_isSet = true;
}

bool OAIArticleSearch::is_limit_Set() const{
    return m_limit_isSet;
}

bool OAIArticleSearch::is_limit_Valid() const{
    return m_limit_isValid;
}

QString OAIArticleSearch::getModifiedSince() const {
    return m_modified_since;
}
void OAIArticleSearch::setModifiedSince(const QString &modified_since) {
    m_modified_since = modified_since;
    m_modified_since_isSet = true;
}

bool OAIArticleSearch::is_modified_since_Set() const{
    return m_modified_since_isSet;
}

bool OAIArticleSearch::is_modified_since_Valid() const{
    return m_modified_since_isValid;
}

qint64 OAIArticleSearch::getOffset() const {
    return m_offset;
}
void OAIArticleSearch::setOffset(const qint64 &offset) {
    m_offset = offset;
    m_offset_isSet = true;
}

bool OAIArticleSearch::is_offset_Set() const{
    return m_offset_isSet;
}

bool OAIArticleSearch::is_offset_Valid() const{
    return m_offset_isValid;
}

QString OAIArticleSearch::getOrderDirection() const {
    return m_order_direction;
}
void OAIArticleSearch::setOrderDirection(const QString &order_direction) {
    m_order_direction = order_direction;
    m_order_direction_isSet = true;
}

bool OAIArticleSearch::is_order_direction_Set() const{
    return m_order_direction_isSet;
}

bool OAIArticleSearch::is_order_direction_Valid() const{
    return m_order_direction_isValid;
}

qint64 OAIArticleSearch::getPage() const {
    return m_page;
}
void OAIArticleSearch::setPage(const qint64 &page) {
    m_page = page;
    m_page_isSet = true;
}

bool OAIArticleSearch::is_page_Set() const{
    return m_page_isSet;
}

bool OAIArticleSearch::is_page_Valid() const{
    return m_page_isValid;
}

qint64 OAIArticleSearch::getPageSize() const {
    return m_page_size;
}
void OAIArticleSearch::setPageSize(const qint64 &page_size) {
    m_page_size = page_size;
    m_page_size_isSet = true;
}

bool OAIArticleSearch::is_page_size_Set() const{
    return m_page_size_isSet;
}

bool OAIArticleSearch::is_page_size_Valid() const{
    return m_page_size_isValid;
}

QString OAIArticleSearch::getPublishedSince() const {
    return m_published_since;
}
void OAIArticleSearch::setPublishedSince(const QString &published_since) {
    m_published_since = published_since;
    m_published_since_isSet = true;
}

bool OAIArticleSearch::is_published_since_Set() const{
    return m_published_since_isSet;
}

bool OAIArticleSearch::is_published_since_Valid() const{
    return m_published_since_isValid;
}

QString OAIArticleSearch::getSearchFor() const {
    return m_search_for;
}
void OAIArticleSearch::setSearchFor(const QString &search_for) {
    m_search_for = search_for;
    m_search_for_isSet = true;
}

bool OAIArticleSearch::is_search_for_Set() const{
    return m_search_for_isSet;
}

bool OAIArticleSearch::is_search_for_Valid() const{
    return m_search_for_isValid;
}

bool OAIArticleSearch::isSet() const {
...
bool OAIArticleSearch::isValid() const {
