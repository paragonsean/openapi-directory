...
#ifndef OAIArticleUpdate_H
#define OAIArticleUpdate_H
...
class OAIArticleUpdate : public OAIObject {
public:
    OAIArticleUpdate();
    OAIArticleUpdate(QString json);
    ~OAIArticleUpdate() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIArticleUpdate)

#endif // OAIArticleUpdate_H
