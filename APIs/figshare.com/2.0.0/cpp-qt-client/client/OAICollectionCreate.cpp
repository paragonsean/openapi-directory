...
OAICollectionCreate::OAICollectionCreate(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICollectionCreate::OAICollectionCreate() {
    this->initializeModel();
}

OAICollectionCreate::~OAICollectionCreate() {}

void OAICollectionCreate::initializeModel() {
...
void OAICollectionCreate::fromJson(QString jsonString) {
...
void OAICollectionCreate::fromJsonObject(QJsonObject json) {
...
QString OAICollectionCreate::asJson() const {
...
QJsonObject OAICollectionCreate::asJsonObject() const {
    QJsonObject obj;
...
QList<qint32> OAICollectionCreate::getArticles() const {
    return m_articles;
}
void OAICollectionCreate::setArticles(const QList<qint32> &articles) {
    m_articles = articles;
    m_articles_isSet = true;
}

bool OAICollectionCreate::is_articles_Set() const{
    return m_articles_isSet;
}

bool OAICollectionCreate::is_articles_Valid() const{
    return m_articles_isValid;
}

QList<OAIObject> OAICollectionCreate::getAuthors() const {
    return m_authors;
}
void OAICollectionCreate::setAuthors(const QList<OAIObject> &authors) {
    m_authors = authors;
    m_authors_isSet = true;
}

bool OAICollectionCreate::is_authors_Set() const{
    return m_authors_isSet;
}

bool OAICollectionCreate::is_authors_Valid() const{
    return m_authors_isValid;
}

QList<qint64> OAICollectionCreate::getCategories() const {
    return m_categories;
}
void OAICollectionCreate::setCategories(const QList<qint64> &categories) {
    m_categories = categories;
    m_categories_isSet = true;
}

bool OAICollectionCreate::is_categories_Set() const{
    return m_categories_isSet;
}

bool OAICollectionCreate::is_categories_Valid() const{
    return m_categories_isValid;
}

QList<QString> OAICollectionCreate::getCategoriesBySourceId() const {
    return m_categories_by_source_id;
}
void OAICollectionCreate::setCategoriesBySourceId(const QList<QString> &categories_by_source_id) {
    m_categories_by_source_id = categories_by_source_id;
    m_categories_by_source_id_isSet = true;
}

bool OAICollectionCreate::is_categories_by_source_id_Set() const{
    return m_categories_by_source_id_isSet;
}

bool OAICollectionCreate::is_categories_by_source_id_Valid() const{
    return m_categories_by_source_id_isValid;
}

OAIObject OAICollectionCreate::getCustomFields() const {
    return m_custom_fields;
}
void OAICollectionCreate::setCustomFields(const OAIObject &custom_fields) {
    m_custom_fields = custom_fields;
    m_custom_fields_isSet = true;
}

bool OAICollectionCreate::is_custom_fields_Set() const{
    return m_custom_fields_isSet;
}

bool OAICollectionCreate::is_custom_fields_Valid() const{
    return m_custom_fields_isValid;
}

QList<OAICustomArticleFieldAdd> OAICollectionCreate::getCustomFieldsList() const {
    return m_custom_fields_list;
}
void OAICollectionCreate::setCustomFieldsList(const QList<OAICustomArticleFieldAdd> &custom_fields_list) {
    m_custom_fields_list = custom_fields_list;
    m_custom_fields_list_isSet = true;
}

bool OAICollectionCreate::is_custom_fields_list_Set() const{
    return m_custom_fields_list_isSet;
}

bool OAICollectionCreate::is_custom_fields_list_Valid() const{
    return m_custom_fields_list_isValid;
}

QString OAICollectionCreate::getDescription() const {
    return m_description;
}
void OAICollectionCreate::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAICollectionCreate::is_description_Set() const{
    return m_description_isSet;
}

bool OAICollectionCreate::is_description_Valid() const{
    return m_description_isValid;
}

QString OAICollectionCreate::getDoi() const {
    return m_doi;
}
void OAICollectionCreate::setDoi(const QString &doi) {
    m_doi = doi;
    m_doi_isSet = true;
}

bool OAICollectionCreate::is_doi_Set() const{
    return m_doi_isSet;
}

bool OAICollectionCreate::is_doi_Valid() const{
    return m_doi_isValid;
}

QString OAICollectionCreate::getFunding() const {
    return m_funding;
}
void OAICollectionCreate::setFunding(const QString &funding) {
    m_funding = funding;
    m_funding_isSet = true;
}

bool OAICollectionCreate::is_funding_Set() const{
    return m_funding_isSet;
}

bool OAICollectionCreate::is_funding_Valid() const{
    return m_funding_isValid;
}

QList<OAIFundingCreate> OAICollectionCreate::getFundingList() const {
    return m_funding_list;
}
void OAICollectionCreate::setFundingList(const QList<OAIFundingCreate> &funding_list) {
    m_funding_list = funding_list;
    m_funding_list_isSet = true;
}

bool OAICollectionCreate::is_funding_list_Set() const{
    return m_funding_list_isSet;
}

bool OAICollectionCreate::is_funding_list_Valid() const{
    return m_funding_list_isValid;
}

qint64 OAICollectionCreate::getGroupId() const {
    return m_group_id;
}
void OAICollectionCreate::setGroupId(const qint64 &group_id) {
    m_group_id = group_id;
    m_group_id_isSet = true;
}

bool OAICollectionCreate::is_group_id_Set() const{
    return m_group_id_isSet;
}

bool OAICollectionCreate::is_group_id_Valid() const{
    return m_group_id_isValid;
}

QString OAICollectionCreate::getHandle() const {
    return m_handle;
}
void OAICollectionCreate::setHandle(const QString &handle) {
    m_handle = handle;
    m_handle_isSet = true;
}

bool OAICollectionCreate::is_handle_Set() const{
    return m_handle_isSet;
}

bool OAICollectionCreate::is_handle_Valid() const{
    return m_handle_isValid;
}

QList<QString> OAICollectionCreate::getKeywords() const {
    return m_keywords;
}
void OAICollectionCreate::setKeywords(const QList<QString> &keywords) {
    m_keywords = keywords;
    m_keywords_isSet = true;
}

bool OAICollectionCreate::is_keywords_Set() const{
    return m_keywords_isSet;
}

bool OAICollectionCreate::is_keywords_Valid() const{
    return m_keywords_isValid;
}

QList<QString> OAICollectionCreate::getReferences() const {
    return m_references;
}
void OAICollectionCreate::setReferences(const QList<QString> &references) {
    m_references = references;
    m_references_isSet = true;
}

bool OAICollectionCreate::is_references_Set() const{
    return m_references_isSet;
}

bool OAICollectionCreate::is_references_Valid() const{
    return m_references_isValid;
}

QString OAICollectionCreate::getResourceDoi() const {
    return m_resource_doi;
}
void OAICollectionCreate::setResourceDoi(const QString &resource_doi) {
    m_resource_doi = resource_doi;
    m_resource_doi_isSet = true;
}

bool OAICollectionCreate::is_resource_doi_Set() const{
    return m_resource_doi_isSet;
}

bool OAICollectionCreate::is_resource_doi_Valid() const{
    return m_resource_doi_isValid;
}

QString OAICollectionCreate::getResourceId() const {
    return m_resource_id;
}
void OAICollectionCreate::setResourceId(const QString &resource_id) {
    m_resource_id = resource_id;
    m_resource_id_isSet = true;
}

bool OAICollectionCreate::is_resource_id_Set() const{
    return m_resource_id_isSet;
}

bool OAICollectionCreate::is_resource_id_Valid() const{
    return m_resource_id_isValid;
}

QString OAICollectionCreate::getResourceLink() const {
    return m_resource_link;
}
void OAICollectionCreate::setResourceLink(const QString &resource_link) {
    m_resource_link = resource_link;
    m_resource_link_isSet = true;
}

bool OAICollectionCreate::is_resource_link_Set() const{
    return m_resource_link_isSet;
}

bool OAICollectionCreate::is_resource_link_Valid() const{
    return m_resource_link_isValid;
}

QString OAICollectionCreate::getResourceTitle() const {
    return m_resource_title;
}
void OAICollectionCreate::setResourceTitle(const QString &resource_title) {
    m_resource_title = resource_title;
    m_resource_title_isSet = true;
}

bool OAICollectionCreate::is_resource_title_Set() const{
    return m_resource_title_isSet;
}

bool OAICollectionCreate::is_resource_title_Valid() const{
    return m_resource_title_isValid;
}

qint32 OAICollectionCreate::getResourceVersion() const {
    return m_resource_version;
}
void OAICollectionCreate::setResourceVersion(const qint32 &resource_version) {
    m_resource_version = resource_version;
    m_resource_version_isSet = true;
}

bool OAICollectionCreate::is_resource_version_Set() const{
    return m_resource_version_isSet;
}

bool OAICollectionCreate::is_resource_version_Valid() const{
    return m_resource_version_isValid;
}

QList<QString> OAICollectionCreate::getTags() const {
    return m_tags;
}
void OAICollectionCreate::setTags(const QList<QString> &tags) {
    m_tags = tags;
    m_tags_isSet = true;
}

bool OAICollectionCreate::is_tags_Set() const{
    return m_tags_isSet;
}

bool OAICollectionCreate::is_tags_Valid() const{
    return m_tags_isValid;
}

OAITimelineUpdate OAICollectionCreate::getTimeline() const {
    return m_timeline;
}
void OAICollectionCreate::setTimeline(const OAITimelineUpdate &timeline) {
    m_timeline = timeline;
    m_timeline_isSet = true;
}

bool OAICollectionCreate::is_timeline_Set() const{
    return m_timeline_isSet;
}

bool OAICollectionCreate::is_timeline_Valid() const{
    return m_timeline_isValid;
}

QString OAICollectionCreate::getTitle() const {
    return m_title;
}
void OAICollectionCreate::setTitle(const QString &title) {
    m_title = title;
    m_title_isSet = true;
}

bool OAICollectionCreate::is_title_Set() const{
    return m_title_isSet;
}

bool OAICollectionCreate::is_title_Valid() const{
    return m_title_isValid;
}

bool OAICollectionCreate::isSet() const {
...
bool OAICollectionCreate::isValid() const {
