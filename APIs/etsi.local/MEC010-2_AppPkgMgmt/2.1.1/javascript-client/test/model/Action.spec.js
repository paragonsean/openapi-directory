...
(function(root, factory) {
  ...
  describe('Action', function() {
    it('should create an instance of Action', function() {
      ...
      //var instance = new EtsiGsMec0102Part2ApplicationLifecycleRulesAndRequirementsManagement.Action();
      //expect(instance).to.be.a(EtsiGsMec0102Part2ApplicationLifecycleRulesAndRequirementsManagement.Action);
    });
