...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EtsiGsMec0102Part2ApplicationLifecycleRulesAndRequirementsManagement.TimeStamp();
  });
  ...
  describe('TimeStamp', function() {
    it('should create an instance of TimeStamp', function() {
      ...
      //var instance = new EtsiGsMec0102Part2ApplicationLifecycleRulesAndRequirementsManagement.TimeStamp();
      //expect(instance).to.be.a(EtsiGsMec0102Part2ApplicationLifecycleRulesAndRequirementsManagement.TimeStamp);
    });
