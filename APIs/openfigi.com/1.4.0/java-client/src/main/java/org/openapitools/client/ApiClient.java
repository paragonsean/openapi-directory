...
public class ApiClient {
    ...
    private String basePath = "https://api.openfigi.com/v1";
    ...
    public ApiClient() {
        ...
        authentications.put("ApiKeyAuth", new ApiKeyAuth("header", "X-OPENFIGI-APIKEY"));
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://api.openfigi.com/v1
