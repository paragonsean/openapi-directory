...
void OAIDefaultApi::initializeServerConfigs() {
    ...
    QUrl("https://api.openfigi.com/{basePath}"),
    "Production Tier",
    QMap<QString, OAIServerVariable>{ 
    {"basePath", OAIServerVariable("No description provided","v1",
    QSet<QString>{ {"v1"},{"v2"},{"v3"} })}, }));
    
    _serverConfigs.insert("mappingPost", defaultConf);
    _serverIndices.insert("mappingPost", 0);
    _serverConfigs.insert("mappingValuesKeyGet", defaultConf);
    _serverIndices.insert("mappingValuesKeyGet", 0);
}
...
void OAIDefaultApi::mappingPost(const ::OpenAPI::OptionalParam<QList<OAIMappingJob>> &oai_mapping_job) {
    QString fullPath = QString(_serverConfigs["mappingPost"][_serverIndices.value("mappingPost")].URL()+"/mapping");
    ...
    if (oai_mapping_job.hasValue()){
        QJsonDocument doc(::OpenAPI::toJsonValue(oai_mapping_job.value()).toArray());
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIDefaultApi::mappingPostCallback);
...
void OAIDefaultApi::mappingPostCallback(OAIHttpRequestWorker *worker) {
    ...
    QList<OAIMappingJobResult> output;
    QString json(worker->response);
    QByteArray array(json.toStdString().c_str());
    QJsonDocument doc = QJsonDocument::fromJson(array);
    QJsonArray jsonArray = doc.array();
    for (QJsonValue obj : jsonArray) {
        OAIMappingJobResult val;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT mappingPostSignal(output);
        Q_EMIT mappingPostSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT mappingPostSignalE(output, error_type, error_str);
        Q_EMIT mappingPostSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT mappingPostSignalError(output, error_type, error_str);
        Q_EMIT mappingPostSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIDefaultApi::mappingValuesKeyGet(const QString &key) {
    QString fullPath = QString(_serverConfigs["mappingValuesKeyGet"][_serverIndices.value("mappingValuesKeyGet")].URL()+"/mapping/values/{key}");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIDefaultApi::mappingValuesKeyGetCallback);
    connect(this, &OAIDefaultApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIDefaultApi::mappingValuesKeyGetCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    OAI_mapping_values__key__get_200_response output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT mappingValuesKeyGetSignal(output);
        Q_EMIT mappingValuesKeyGetSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT mappingValuesKeyGetSignalE(output, error_type, error_str);
        Q_EMIT mappingValuesKeyGetSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT mappingValuesKeyGetSignalError(output, error_type, error_str);
        Q_EMIT mappingValuesKeyGetSignalErrorFull(worker, error_type, error_str);
    }
}
