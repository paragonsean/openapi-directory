...
#include <iostream>
#include "../client/OAIPersonaApi.h"
...
void Example::exampleFunction1(){
     OAIPersonaApi apiInstance;
      ...
      QEventLoop loop;
      connect(&apiInstance, &OAIPersonaApi::personasGetSignal, [&]() {
          loop.quit();
      });
      connect(&apiInstance, &OAIPersonaApi::personasGetSignalE, [&](QNetworkReply::NetworkError, QString error_str) {
          qDebug() << "Error happened while issuing request : " << error_str;
          loop.quit();
      });

      QString name = create(); // QString | Filter by Persona name
      ...
      qint32 count = create(); // qint32 | Amount of items to return
      ...
      qint32 page = create(); // qint32 | Offset, used together with count
      ...
      QList<QString> fields = create(); // QList<QString> | Allows to select only needed fields
      ...
      QList<QString> expand = create(); // QList<QString> | Allows to select extra fields
      apiInstance.personasGet(namecountpagefieldsexpand);
