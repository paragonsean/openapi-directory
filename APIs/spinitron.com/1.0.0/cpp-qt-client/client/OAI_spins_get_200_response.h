...
/*
 * OAI_spins_get_200_response.h
 *
 * 
 */

#ifndef OAI_spins_get_200_response_H
#define OAI_spins_get_200_response_H
...
class OAI_spins_get_200_response : public OAIObject {
public:
    OAI_spins_get_200_response();
    OAI_spins_get_200_response(QString json);
    ~OAI_spins_get_200_response() override;
    ...
    QList<OAISpin> getItems() const;
    void setItems(const QList<OAISpin> &items);
...
Q_DECLARE_METATYPE(OpenAPI::OAI_spins_get_200_response)

#endif // OAI_spins_get_200_response_H
