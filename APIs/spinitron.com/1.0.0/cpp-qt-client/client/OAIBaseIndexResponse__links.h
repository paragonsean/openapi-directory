...
/*
 * OAIBaseIndexResponse__links.h
 *
 * 
 */

#ifndef OAIBaseIndexResponse__links_H
#define OAIBaseIndexResponse__links_H
...
class OAIBaseIndexResponse__links : public OAIObject {
public:
    OAIBaseIndexResponse__links();
    OAIBaseIndexResponse__links(QString json);
    ~OAIBaseIndexResponse__links() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBaseIndexResponse__links)

#endif // OAIBaseIndexResponse__links_H
