...
OAI_personas_get_200_response::OAI_personas_get_200_response(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAI_personas_get_200_response::OAI_personas_get_200_response() {
    this->initializeModel();
}

OAI_personas_get_200_response::~OAI_personas_get_200_response() {}

void OAI_personas_get_200_response::initializeModel() {
...
void OAI_personas_get_200_response::fromJson(QString jsonString) {
...
void OAI_personas_get_200_response::fromJsonObject(QJsonObject json) {
...
QString OAI_personas_get_200_response::asJson() const {
...
QJsonObject OAI_personas_get_200_response::asJsonObject() const {
    QJsonObject obj;
    if (m__links.isSet()) {
...
OAIBaseIndexResponse__links OAI_personas_get_200_response::getLinks() const {
    return m__links;
}
void OAI_personas_get_200_response::setLinks(const OAIBaseIndexResponse__links &_links) {
    m__links = _links;
    m__links_isSet = true;
}

bool OAI_personas_get_200_response::is__links_Set() const{
    return m__links_isSet;
}

bool OAI_personas_get_200_response::is__links_Valid() const{
    return m__links_isValid;
}

OAIPagination OAI_personas_get_200_response::getMeta() const {
    return m__meta;
}
void OAI_personas_get_200_response::setMeta(const OAIPagination &_meta) {
    m__meta = _meta;
    m__meta_isSet = true;
}

bool OAI_personas_get_200_response::is__meta_Set() const{
    return m__meta_isSet;
}

bool OAI_personas_get_200_response::is__meta_Valid() const{
    return m__meta_isValid;
}

QList<OAIPersona> OAI_personas_get_200_response::getItems() const {
    return m_items;
}
void OAI_personas_get_200_response::setItems(const QList<OAIPersona> &items) {
    m_items = items;
    m_items_isSet = true;
}

bool OAI_personas_get_200_response::is_items_Set() const{
    return m_items_isSet;
}

bool OAI_personas_get_200_response::is_items_Valid() const{
    return m_items_isValid;
}

bool OAI_personas_get_200_response::isSet() const {
...
bool OAI_personas_get_200_response::isValid() const {
