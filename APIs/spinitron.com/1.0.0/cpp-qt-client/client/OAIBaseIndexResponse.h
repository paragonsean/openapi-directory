...
/*
 * OAIBaseIndexResponse.h
 *
 * 
 */

#ifndef OAIBaseIndexResponse_H
#define OAIBaseIndexResponse_H
...
class OAIBaseIndexResponse : public OAIObject {
public:
    OAIBaseIndexResponse();
    OAIBaseIndexResponse(QString json);
    ~OAIBaseIndexResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBaseIndexResponse)

#endif // OAIBaseIndexResponse_H
