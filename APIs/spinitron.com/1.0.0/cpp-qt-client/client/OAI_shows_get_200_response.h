...
/*
 * OAI_shows_get_200_response.h
 *
 * 
 */

#ifndef OAI_shows_get_200_response_H
#define OAI_shows_get_200_response_H
...
class OAI_shows_get_200_response : public OAIObject {
public:
    OAI_shows_get_200_response();
    OAI_shows_get_200_response(QString json);
    ~OAI_shows_get_200_response() override;
    ...
    QList<OAIShow> getItems() const;
    void setItems(const QList<OAIShow> &items);
...
Q_DECLARE_METATYPE(OpenAPI::OAI_shows_get_200_response)

#endif // OAI_shows_get_200_response_H
