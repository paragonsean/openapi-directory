...
/*
 * OAI_playlists_get_200_response.h
 *
 * 
 */

#ifndef OAI_playlists_get_200_response_H
#define OAI_playlists_get_200_response_H
...
class OAI_playlists_get_200_response : public OAIObject {
public:
    OAI_playlists_get_200_response();
    OAI_playlists_get_200_response(QString json);
    ~OAI_playlists_get_200_response() override;
    ...
    QList<OAIPlaylist> getItems() const;
    void setItems(const QList<OAIPlaylist> &items);
...
Q_DECLARE_METATYPE(OpenAPI::OAI_playlists_get_200_response)

#endif // OAI_playlists_get_200_response_H
