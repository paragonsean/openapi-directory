...
OAI_spins_get_200_response::OAI_spins_get_200_response(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAI_spins_get_200_response::OAI_spins_get_200_response() {
    this->initializeModel();
}

OAI_spins_get_200_response::~OAI_spins_get_200_response() {}

void OAI_spins_get_200_response::initializeModel() {
...
void OAI_spins_get_200_response::fromJson(QString jsonString) {
...
void OAI_spins_get_200_response::fromJsonObject(QJsonObject json) {
...
QString OAI_spins_get_200_response::asJson() const {
...
QJsonObject OAI_spins_get_200_response::asJsonObject() const {
    QJsonObject obj;
    if (m__links.isSet()) {
...
OAIBaseIndexResponse__links OAI_spins_get_200_response::getLinks() const {
    return m__links;
}
void OAI_spins_get_200_response::setLinks(const OAIBaseIndexResponse__links &_links) {
    m__links = _links;
    m__links_isSet = true;
}

bool OAI_spins_get_200_response::is__links_Set() const{
    return m__links_isSet;
}

bool OAI_spins_get_200_response::is__links_Valid() const{
    return m__links_isValid;
}

OAIPagination OAI_spins_get_200_response::getMeta() const {
    return m__meta;
}
void OAI_spins_get_200_response::setMeta(const OAIPagination &_meta) {
    m__meta = _meta;
    m__meta_isSet = true;
}

bool OAI_spins_get_200_response::is__meta_Set() const{
    return m__meta_isSet;
}

bool OAI_spins_get_200_response::is__meta_Valid() const{
    return m__meta_isValid;
}

QList<OAISpin> OAI_spins_get_200_response::getItems() const {
    return m_items;
}
void OAI_spins_get_200_response::setItems(const QList<OAISpin> &items) {
    m_items = items;
    m_items_isSet = true;
}

bool OAI_spins_get_200_response::is_items_Set() const{
    return m_items_isSet;
}

bool OAI_spins_get_200_response::is_items_Valid() const{
    return m_items_isValid;
}

bool OAI_spins_get_200_response::isSet() const {
...
bool OAI_spins_get_200_response::isValid() const {
