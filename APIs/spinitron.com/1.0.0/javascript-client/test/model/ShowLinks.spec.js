...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SpinitronV2Api.ShowLinks();
  });
  ...
  describe('ShowLinks', function() {
    it('should create an instance of ShowLinks', function() {
      // uncomment below and update the code to test ShowLinks
      //var instance = new SpinitronV2Api.ShowLinks();
      //expect(instance).to.be.a(SpinitronV2Api.ShowLinks);
    });
