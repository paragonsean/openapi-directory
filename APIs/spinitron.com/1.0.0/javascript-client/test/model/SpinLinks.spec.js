...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SpinitronV2Api.SpinLinks();
  });
  ...
  describe('SpinLinks', function() {
    it('should create an instance of SpinLinks', function() {
      // uncomment below and update the code to test SpinLinks
      //var instance = new SpinitronV2Api.SpinLinks();
      //expect(instance).to.be.a(SpinitronV2Api.SpinLinks);
    });
