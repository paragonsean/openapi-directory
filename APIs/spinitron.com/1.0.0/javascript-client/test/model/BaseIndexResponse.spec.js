...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SpinitronV2Api.BaseIndexResponse();
  });
  ...
  describe('BaseIndexResponse', function() {
    it('should create an instance of BaseIndexResponse', function() {
      // uncomment below and update the code to test BaseIndexResponse
      //var instance = new SpinitronV2Api.BaseIndexResponse();
      //expect(instance).to.be.a(SpinitronV2Api.BaseIndexResponse);
    });
