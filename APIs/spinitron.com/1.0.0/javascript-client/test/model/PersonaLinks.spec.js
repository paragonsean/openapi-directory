...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SpinitronV2Api.PersonaLinks();
  });
  ...
  describe('PersonaLinks', function() {
    it('should create an instance of PersonaLinks', function() {
      // uncomment below and update the code to test PersonaLinks
      //var instance = new SpinitronV2Api.PersonaLinks();
      //expect(instance).to.be.a(SpinitronV2Api.PersonaLinks);
    });
