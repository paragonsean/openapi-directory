...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SpinitronV2Api.BaseIndexResponseLinks();
  });
  ...
  describe('BaseIndexResponseLinks', function() {
    it('should create an instance of BaseIndexResponseLinks', function() {
      // uncomment below and update the code to test BaseIndexResponseLinks
      //var instance = new SpinitronV2Api.BaseIndexResponseLinks();
      //expect(instance).to.be.a(SpinitronV2Api.BaseIndexResponseLinks);
    });
