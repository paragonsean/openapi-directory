...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SpinitronV2Api.PlaylistLinks();
  });
  ...
  describe('PlaylistLinks', function() {
    it('should create an instance of PlaylistLinks', function() {
      // uncomment below and update the code to test PlaylistLinks
      //var instance = new SpinitronV2Api.PlaylistLinks();
      //expect(instance).to.be.a(SpinitronV2Api.PlaylistLinks);
    });
    ...
    it('should have the property spins (base name: "spins")', function() {
      // uncomment below and update the code to test the property spins
      //var instance = new SpinitronV2Api.PlaylistLinks();
      //expect(instance).to.be();
    });
