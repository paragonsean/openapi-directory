...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SpinitronV2Api.Playlist();
  });
  ...
  describe('Playlist', function() {
    it('should create an instance of Playlist', function() {
      ...
      //var instance = new SpinitronV2Api.Playlist();
      //expect(instance).to.be.a(SpinitronV2Api.Playlist);
    });
    ...
    it('should have the property episodeName (base name: "episode_name")', function() {
