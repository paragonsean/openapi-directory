...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SpinitronV2Api.ShowApi();
  });
  ...
  describe('ShowApi', function() {
    describe('showsGet', function() {
      it('should call showsGet successfully', function(done) {
        //uncomment below and update the code to test showsGet
        //instance.showsGet(function(error) {
    ...
    describe('showsIdGet', function() {
      it('should call showsIdGet successfully', function(done) {
        //uncomment below and update the code to test showsIdGet
        //instance.showsIdGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
