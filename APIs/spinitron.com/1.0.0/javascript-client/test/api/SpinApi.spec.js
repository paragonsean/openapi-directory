...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SpinitronV2Api.SpinApi();
  });
  ...
  describe('SpinApi', function() {
    describe('spinsGet', function() {
      it('should call spinsGet successfully', function(done) {
        //uncomment below and update the code to test spinsGet
        //instance.spinsGet(function(error) {
    ...
    describe('spinsIdGet', function() {
      it('should call spinsIdGet successfully', function(done) {
        //uncomment below and update the code to test spinsIdGet
        //instance.spinsIdGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('spinsPost', function() {
      it('should call spinsPost successfully', function(done) {
        //uncomment below and update the code to test spinsPost
        //instance.spinsPost(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
