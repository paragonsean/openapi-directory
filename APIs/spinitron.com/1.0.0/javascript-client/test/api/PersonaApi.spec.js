...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SpinitronV2Api.PersonaApi();
  });
  ...
  describe('PersonaApi', function() {
    describe('personasGet', function() {
      it('should call personasGet successfully', function(done) {
        //uncomment below and update the code to test personasGet
        //instance.personasGet(function(error) {
    ...
    describe('personasIdGet', function() {
      it('should call personasIdGet successfully', function(done) {
        //uncomment below and update the code to test personasIdGet
        //instance.personasIdGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
