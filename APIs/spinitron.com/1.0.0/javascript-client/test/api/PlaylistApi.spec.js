...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SpinitronV2Api.PlaylistApi();
  });
  ...
  describe('PlaylistApi', function() {
    describe('playlistsGet', function() {
      it('should call playlistsGet successfully', function(done) {
        //uncomment below and update the code to test playlistsGet
        //instance.playlistsGet(function(error) {
    ...
    describe('playlistsIdGet', function() {
      it('should call playlistsIdGet successfully', function(done) {
        //uncomment below and update the code to test playlistsIdGet
        //instance.playlistsIdGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
