...
/**
 * The BaseIndexResponseLinks model module.
 * @module model/BaseIndexResponseLinks
 * @version 1.0.0
 */
class BaseIndexResponseLinks {
    /**
     * Constructs a new <code>BaseIndexResponseLinks</code>.
     * @alias module:model/BaseIndexResponseLinks
     */
    constructor() { 
        
        BaseIndexResponseLinks.initialize(this);
    }
    ...
    /**
     * Constructs a <code>BaseIndexResponseLinks</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/BaseIndexResponseLinks} obj Optional instance to populate.
     * @return {module:model/BaseIndexResponseLinks} The populated <code>BaseIndexResponseLinks</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new BaseIndexResponseLinks();
    ...
    /**
     * Validates the JSON data with respect to <code>BaseIndexResponseLinks</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>BaseIndexResponseLinks</code>.
     */
 ...
 */
BaseIndexResponseLinks.prototype['self'] = undefined;
...
export default BaseIndexResponseLinks;
