...
class ApiClient {
     ...
     */
    constructor(basePath = 'https://spinitron.com/api') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default https://spinitron.com/api
         */
        ...
        this.authentications = {
            'accessToken': {type: 'apiKey', 'in': 'query', name: 'access-token'},
            'httpBearer': {type: 'bearer'} // JWT
        }
