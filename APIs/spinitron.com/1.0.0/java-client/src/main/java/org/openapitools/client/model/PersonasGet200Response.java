...
public class PersonasGet200Response {
  ...
  public PersonasGet200Response() {
  }

  public PersonasGet200Response links(BaseIndexResponseLinks links) {
    this.links = links;
    return this;
  }
  ...
  public PersonasGet200Response meta(Pagination meta) {
    this.meta = meta;
    return this;
  }
  ...
  public PersonasGet200Response items(List<Persona> items) {
    this.items = items;
    return this;
  }

  public PersonasGet200Response addItemsItem(Persona itemsItem) {
    if (this.items == null) {
  ...
  public boolean equals(Object o) {
    ...
    PersonasGet200Response personasGet200Response = (PersonasGet200Response) o;
    return Objects.equals(this.links, personasGet200Response.links) &&
        Objects.equals(this.meta, personasGet200Response.meta) &&
        Objects.equals(this.items, personasGet200Response.items);
  }
  ...
  public String toString() {
    ...
    sb.append("class PersonasGet200Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PersonasGet200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PersonasGet200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PersonasGet200Response is not found in the empty JSON string", PersonasGet200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PersonasGet200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PersonasGet200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("items") != null && !jsonObj.get("items").isJsonNull()) {
        ...
        if (jsonArrayitems != null) {
          ...
          for (int i = 0; i < jsonArrayitems.size(); i++) {
            Persona.validateJsonElement(jsonArrayitems.get(i));
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PersonasGet200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PersonasGet200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PersonasGet200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PersonasGet200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<PersonasGet200Response>() {
           @Override
           public void write(JsonWriter out, PersonasGet200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PersonasGet200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PersonasGet200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PersonasGet200Response
   * @throws IOException if the JSON string is invalid with respect to PersonasGet200Response
   */
  public static PersonasGet200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PersonasGet200Response.class);
  }

  /**
   * Convert an instance of PersonasGet200Response to an JSON string
   *
   * @return JSON string
   */
