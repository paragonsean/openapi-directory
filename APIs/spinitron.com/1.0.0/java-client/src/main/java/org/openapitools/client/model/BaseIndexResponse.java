...
public class BaseIndexResponse {
  ...
  public BaseIndexResponse() {
  }

  public BaseIndexResponse links(BaseIndexResponseLinks links) {
    this.links = links;
    return this;
  }
  ...
  public BaseIndexResponse meta(Pagination meta) {
    this.meta = meta;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    BaseIndexResponse baseIndexResponse = (BaseIndexResponse) o;
    return Objects.equals(this.links, baseIndexResponse.links) &&
        Objects.equals(this.meta, baseIndexResponse.meta);
  }
  ...
  public String toString() {
    ...
    sb.append("class BaseIndexResponse {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to BaseIndexResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!BaseIndexResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in BaseIndexResponse is not found in the empty JSON string", BaseIndexResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!BaseIndexResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `BaseIndexResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!BaseIndexResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'BaseIndexResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<BaseIndexResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(BaseIndexResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<BaseIndexResponse>() {
           @Override
           public void write(JsonWriter out, BaseIndexResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public BaseIndexResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of BaseIndexResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of BaseIndexResponse
   * @throws IOException if the JSON string is invalid with respect to BaseIndexResponse
   */
  public static BaseIndexResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, BaseIndexResponse.class);
  }

  /**
   * Convert an instance of BaseIndexResponse to an JSON string
   *
   * @return JSON string
   */
