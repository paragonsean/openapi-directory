...
public class ApiClient {
    ...
    private String basePath = "https://spinitron.com/api";
    ...
    public ApiClient() {
        ...
        authentications.put("accessToken", new ApiKeyAuth("query", "access-token"));
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://spinitron.com/api
