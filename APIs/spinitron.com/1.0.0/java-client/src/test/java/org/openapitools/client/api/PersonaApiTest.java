...
public class PersonaApiTest {
     ...
     */
    @Test
    public void personasGetTest() throws ApiException {
        String name = null;
        Integer count = null;
        Integer page = null;
        List<String> fields = null;
        List<String> expand = null;
        PersonasGet200Response response = api.personasGet(name, count, page, fields, expand);
     ...
     */
    @Test
    public void personasIdGetTest() throws ApiException {
        Integer id = null;
        List<String> fields = null;
        List<String> expand = null;
        Persona response = api.personasIdGet(id, fields, expand);
        // TODO: test validations
    }
