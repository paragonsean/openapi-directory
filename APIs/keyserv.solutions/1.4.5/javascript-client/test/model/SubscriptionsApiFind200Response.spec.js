...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KeyServ.SubscriptionsApiFind200Response();
  });
  ...
  describe('SubscriptionsApiFind200Response', function() {
    it('should create an instance of SubscriptionsApiFind200Response', function() {
      // uncomment below and update the code to test SubscriptionsApiFind200Response
      //var instance = new KeyServ.SubscriptionsApiFind200Response();
      //expect(instance).to.be.a(KeyServ.SubscriptionsApiFind200Response);
    });
