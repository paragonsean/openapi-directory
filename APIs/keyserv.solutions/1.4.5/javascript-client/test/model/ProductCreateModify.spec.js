...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KeyServ.ProductCreateModify();
  });
  ...
  describe('ProductCreateModify', function() {
    it('should create an instance of ProductCreateModify', function() {
      // uncomment below and update the code to test ProductCreateModify
      //var instance = new KeyServ.ProductCreateModify();
      //expect(instance).to.be.a(KeyServ.ProductCreateModify);
    });
