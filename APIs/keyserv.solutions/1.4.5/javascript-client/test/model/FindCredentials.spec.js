...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KeyServ.FindCredentials();
  });
  ...
  describe('FindCredentials', function() {
    it('should create an instance of FindCredentials', function() {
      // uncomment below and update the code to test FindCredentials
      //var instance = new KeyServ.FindCredentials();
      //expect(instance).to.be.a(KeyServ.FindCredentials);
    });
