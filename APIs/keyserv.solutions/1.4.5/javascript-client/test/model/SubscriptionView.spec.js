...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KeyServ.SubscriptionView();
  });
  ...
  describe('SubscriptionView', function() {
    it('should create an instance of SubscriptionView', function() {
      // uncomment below and update the code to test SubscriptionView
      //var instance = new KeyServ.SubscriptionView();
      //expect(instance).to.be.a(KeyServ.SubscriptionView);
    });
