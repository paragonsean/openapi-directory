...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KeyServ.CurrentKey();
  });
  ...
  describe('CurrentKey', function() {
    it('should create an instance of CurrentKey', function() {
      // uncomment below and update the code to test CurrentKey
      //var instance = new KeyServ.CurrentKey();
      //expect(instance).to.be.a(KeyServ.CurrentKey);
    });
