...
public class ApiClient {
    ...
    private String basePath = "https://keyserv.solutions";
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/1.4.5/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://keyserv.solutions
