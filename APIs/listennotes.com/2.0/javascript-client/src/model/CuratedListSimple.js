...
/**
 * The CuratedListSimple model module.
 * @module model/CuratedListSimple
 * @version 2.0
 */
class CuratedListSimple {
    /**
     * Constructs a new <code>CuratedListSimple</code>.
     * @alias module:model/CuratedListSimple
     */
    constructor() { 
        
        CuratedListSimple.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CuratedListSimple</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CuratedListSimple} obj Optional instance to populate.
     * @return {module:model/CuratedListSimple} The populated <code>CuratedListSimple</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CuratedListSimple();
    ...
    /**
     * Validates the JSON data with respect to <code>CuratedListSimple</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CuratedListSimple</code>.
     */
...
export default CuratedListSimple;
