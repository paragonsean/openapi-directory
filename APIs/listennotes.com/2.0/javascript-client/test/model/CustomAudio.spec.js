...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ListenApiPodcastSearchDirectoryAndInsightsApi.CustomAudio();
  });
  ...
  describe('CustomAudio', function() {
    it('should create an instance of CustomAudio', function() {
      // uncomment below and update the code to test CustomAudio
      //var instance = new ListenApiPodcastSearchDirectoryAndInsightsApi.CustomAudio();
      //expect(instance).to.be.a(ListenApiPodcastSearchDirectoryAndInsightsApi.CustomAudio);
    });
