...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ListenApiPodcastSearchDirectoryAndInsightsApi.PodcastMinimum();
  });
  ...
  describe('PodcastMinimum', function() {
    it('should create an instance of PodcastMinimum', function() {
      // uncomment below and update the code to test PodcastMinimum
      //var instance = new ListenApiPodcastSearchDirectoryAndInsightsApi.PodcastMinimum();
      //expect(instance).to.be.a(ListenApiPodcastSearchDirectoryAndInsightsApi.PodcastMinimum);
    });
