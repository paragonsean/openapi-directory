...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ListenApiPodcastSearchDirectoryAndInsightsApi.EpisodeFull();
  });
  ...
  describe('EpisodeFull', function() {
    it('should create an instance of EpisodeFull', function() {
      // uncomment below and update the code to test EpisodeFull
      //var instance = new ListenApiPodcastSearchDirectoryAndInsightsApi.EpisodeFull();
      //expect(instance).to.be.a(ListenApiPodcastSearchDirectoryAndInsightsApi.EpisodeFull);
    });
