...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ListenApiPodcastSearchDirectoryAndInsightsApi.EpisodeSearchResultPodcast();
  });
  ...
  describe('EpisodeSearchResultPodcast', function() {
    it('should create an instance of EpisodeSearchResultPodcast', function() {
      // uncomment below and update the code to test EpisodeSearchResultPodcast
      //var instance = new ListenApiPodcastSearchDirectoryAndInsightsApi.EpisodeSearchResultPodcast();
      //expect(instance).to.be.a(ListenApiPodcastSearchDirectoryAndInsightsApi.EpisodeSearchResultPodcast);
    });
