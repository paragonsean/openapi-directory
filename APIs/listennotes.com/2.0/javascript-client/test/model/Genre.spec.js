...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ListenApiPodcastSearchDirectoryAndInsightsApi.Genre();
  });
  ...
  describe('Genre', function() {
    it('should create an instance of Genre', function() {
      ...
      //var instance = new ListenApiPodcastSearchDirectoryAndInsightsApi.Genre();
      //expect(instance).to.be.a(ListenApiPodcastSearchDirectoryAndInsightsApi.Genre);
    });
