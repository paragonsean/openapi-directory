...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ListenApiPodcastSearchDirectoryAndInsightsApi.EpisodeSearchResult();
  });
  ...
  describe('EpisodeSearchResult', function() {
    it('should create an instance of EpisodeSearchResult', function() {
      // uncomment below and update the code to test EpisodeSearchResult
      //var instance = new ListenApiPodcastSearchDirectoryAndInsightsApi.EpisodeSearchResult();
      //expect(instance).to.be.a(ListenApiPodcastSearchDirectoryAndInsightsApi.EpisodeSearchResult);
    });
