...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ListenApiPodcastSearchDirectoryAndInsightsApi.EpisodeSimple();
  });
  ...
  describe('EpisodeSimple', function() {
    it('should create an instance of EpisodeSimple', function() {
      // uncomment below and update the code to test EpisodeSimple
      //var instance = new ListenApiPodcastSearchDirectoryAndInsightsApi.EpisodeSimple();
      //expect(instance).to.be.a(ListenApiPodcastSearchDirectoryAndInsightsApi.EpisodeSimple);
    });
