...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ListenApiPodcastSearchDirectoryAndInsightsApi.PodcastFull();
  });
  ...
  describe('PodcastFull', function() {
    it('should create an instance of PodcastFull', function() {
      // uncomment below and update the code to test PodcastFull
      //var instance = new ListenApiPodcastSearchDirectoryAndInsightsApi.PodcastFull();
      //expect(instance).to.be.a(ListenApiPodcastSearchDirectoryAndInsightsApi.PodcastFull);
    });
    ...
    it('should have the property nextEpisodePubDate (base name: "next_episode_pub_date")', function() {
      // uncomment below and update the code to test the property nextEpisodePubDate
      //var instance = new ListenApiPodcastSearchDirectoryAndInsightsApi.PodcastFull();
      //expect(instance).to.be();
    });
