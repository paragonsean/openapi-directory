...
#ifndef OAIEpisodeMinimum_H
#define OAIEpisodeMinimum_H
...
class OAIEpisodeMinimum : public OAIObject {
public:
    OAIEpisodeMinimum();
    OAIEpisodeMinimum(QString json);
    ~OAIEpisodeMinimum() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEpisodeMinimum)

#endif // OAIEpisodeMinimum_H
