...
#ifndef OAIEpisodeSimple_H
#define OAIEpisodeSimple_H
...
class OAIEpisodeSimple : public OAIObject {
public:
    OAIEpisodeSimple();
    OAIEpisodeSimple(QString json);
    ~OAIEpisodeSimple() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEpisodeSimple)

#endif // OAIEpisodeSimple_H
