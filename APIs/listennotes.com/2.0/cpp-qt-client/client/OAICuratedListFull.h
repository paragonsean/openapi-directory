...
/*
 * OAICuratedListFull.h
 *
 * 
 */

#ifndef OAICuratedListFull_H
#define OAICuratedListFull_H
...
class OAICuratedListFull : public OAIObject {
public:
    OAICuratedListFull();
    OAICuratedListFull(QString json);
    ~OAICuratedListFull() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICuratedListFull)

#endif // OAICuratedListFull_H
