...
#ifndef OAIPodcastSimple_H
#define OAIPodcastSimple_H
...
class OAIPodcastSimple : public OAIObject {
public:
    OAIPodcastSimple();
    OAIPodcastSimple(QString json);
    ~OAIPodcastSimple() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPodcastSimple)

#endif // OAIPodcastSimple_H
