...
/*
 * OAICuratedListSimple.h
 *
 * 
 */

#ifndef OAICuratedListSimple_H
#define OAICuratedListSimple_H
...
class OAICuratedListSimple : public OAIObject {
public:
    OAICuratedListSimple();
    OAICuratedListSimple(QString json);
    ~OAICuratedListSimple() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICuratedListSimple)

#endif // OAICuratedListSimple_H
