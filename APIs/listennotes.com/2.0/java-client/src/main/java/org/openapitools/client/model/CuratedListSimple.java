...
public class CuratedListSimple {
  ...
  public CuratedListSimple description(String description) {
  ...
  public CuratedListSimple id(String id) {
    this.id = id;
    return this;
  }
  ...
  public CuratedListSimple listennotesUrl(String listennotesUrl) {
  ...
  public CuratedListSimple podcasts(List<PodcastMinimum> podcasts) {
    this.podcasts = podcasts;
    return this;
  }

  public CuratedListSimple addPodcastsItem(PodcastMinimum podcastsItem) {
  ...
  public CuratedListSimple pubDateMs(Integer pubDateMs) {
  ...
  public CuratedListSimple sourceDomain(String sourceDomain) {
  ...
  public CuratedListSimple sourceUrl(String sourceUrl) {
  ...
  public CuratedListSimple title(String title) {
    this.title = title;
    return this;
  }
  ...
  public CuratedListSimple total(Integer total) {
    this.total = total;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    CuratedListSimple curatedListSimple = (CuratedListSimple) o;
    return Objects.equals(this.description, curatedListSimple.description) &&
        Objects.equals(this.id, curatedListSimple.id) &&
        Objects.equals(this.listennotesUrl, curatedListSimple.listennotesUrl) &&
        Objects.equals(this.podcasts, curatedListSimple.podcasts) &&
        Objects.equals(this.pubDateMs, curatedListSimple.pubDateMs) &&
        Objects.equals(this.sourceDomain, curatedListSimple.sourceDomain) &&
        Objects.equals(this.sourceUrl, curatedListSimple.sourceUrl) &&
        Objects.equals(this.title, curatedListSimple.title) &&
        Objects.equals(this.total, curatedListSimple.total);
  }
  ...
  public String toString() {
    ...
    sb.append("class CuratedListSimple {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CuratedListSimple
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CuratedListSimple.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CuratedListSimple is not found in the empty JSON string", CuratedListSimple.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CuratedListSimple.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CuratedListSimple` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CuratedListSimple.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CuratedListSimple' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CuratedListSimple> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CuratedListSimple.class));

       return (TypeAdapter<T>) new TypeAdapter<CuratedListSimple>() {
           @Override
           public void write(JsonWriter out, CuratedListSimple value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CuratedListSimple read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CuratedListSimple given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CuratedListSimple
   * @throws IOException if the JSON string is invalid with respect to CuratedListSimple
   */
  public static CuratedListSimple fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CuratedListSimple.class);
  }

  /**
   * Convert an instance of CuratedListSimple to an JSON string
   *
   * @return JSON string
   */
