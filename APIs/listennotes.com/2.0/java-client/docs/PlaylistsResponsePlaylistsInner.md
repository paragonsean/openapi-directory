...
|**episodeCount** | **Integer** | The number of episodes (including custom audio) in this playlist. |  [optional] |
...
|**podcastCount** | **Integer** | The number of podcasts in this playlist. |  [optional] |
|**thumbnail** | **String** | Low resolution image url of the playlist. |  [optional] |
|**totalAudioLengthSec** | **Integer** | Total audio length of all episodes in this playlist, in seconds. |  [optional] |
