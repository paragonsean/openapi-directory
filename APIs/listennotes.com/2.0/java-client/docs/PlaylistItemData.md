...
|**audioLengthSec** | **Integer** | Audio length in seconds. |  [optional] |
...
|**pubDateMs** | **Integer** | Published date (in milliseconds) of this custom audio. For now, it&#39;s the same as **added_at_ms** of this playlist item.  |  [optional] |
...
|**type** | **PodcastTypeField** |  |  [optional] |
