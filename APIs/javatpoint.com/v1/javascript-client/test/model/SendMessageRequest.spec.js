...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FirebaseCloudMessagingApi.SendMessageRequest();
  });
  ...
  describe('SendMessageRequest', function() {
    it('should create an instance of SendMessageRequest', function() {
      ...
      //var instance = new FirebaseCloudMessagingApi.SendMessageRequest();
      //expect(instance).to.be.a(FirebaseCloudMessagingApi.SendMessageRequest);
    });
