...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FirebaseCloudMessagingApi.Notification();
  });
  ...
  describe('Notification', function() {
    it('should create an instance of Notification', function() {
      ...
      //var instance = new FirebaseCloudMessagingApi.Notification();
      //expect(instance).to.be.a(FirebaseCloudMessagingApi.Notification);
    });
