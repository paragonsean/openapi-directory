...
void OAIProjectsApi::initializeServerConfigs() {
    ...
    QUrl("https://fcm.googleapis.com/"),
    "No description provided",
    QMap<QString, OAIServerVariable>()));
    _serverConfigs.insert("fcm_projects_messages_send", defaultConf);
    _serverIndices.insert("fcm_projects_messages_send", 0);
}
...
void OAIProjectsApi::fcm_projects_messages_send(const QString &parent, const ::OpenAPI::OptionalParam<QString> &_xgafv, const ::OpenAPI::OptionalParam<QString> &access_token, const ::OpenAPI::OptionalParam<QString> &alt, const ::OpenAPI::OptionalParam<QString> &callback, const ::OpenAPI::OptionalParam<QString> &fields, const ::OpenAPI::OptionalParam<QString> &key, const ::OpenAPI::OptionalParam<QString> &oauth_token, const ::OpenAPI::OptionalParam<bool> &pretty_print, const ::OpenAPI::OptionalParam<QString> &quota_user, const ::OpenAPI::OptionalParam<QString> &upload_protocol, const ::OpenAPI::OptionalParam<QString> &upload_type, const ::OpenAPI::OptionalParam<OAISendMessageRequest> &oai_send_message_request) {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIProjectsApi::fcm_projects_messages_sendCallback);
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIProjectsApi::fcm_projects_messages_sendCallback);
...
void OAIProjectsApi::fcm_projects_messages_sendCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT fcm_projects_messages_sendSignal(output);
        Q_EMIT fcm_projects_messages_sendSignalFull(worker, output);
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT fcm_projects_messages_sendSignalE(output, error_type, error_str);
        Q_EMIT fcm_projects_messages_sendSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT fcm_projects_messages_sendSignalError(output, error_type, error_str);
        Q_EMIT fcm_projects_messages_sendSignalErrorFull(worker, error_type, error_str);
    }
}
