...
async def v3do_post_multi_part(request: web.Request, wm_consumer_channel_type, wm_consumer_id, wm_sec_timestamp, wm_sec_auth_signature, wm_svc_name, wm_qos_correlation_id, file, feed_type=None) -> web.Response:
    """Upload an item feed
...
async def v3get_all_items_status(request: web.Request, feed_id, wm_consumer_channel_type, wm_consumer_id, wm_sec_timestamp, wm_sec_auth_signature, wm_svc_name, wm_qos_correlation_id, include_details=None, offset=None, limit=None) -> web.Response:
...
async def v3get_feed_item_status(request: web.Request, wm_consumer_channel_type, wm_consumer_id, wm_sec_timestamp, wm_sec_auth_signature, wm_svc_name, wm_qos_correlation_id, feed_id=None, include_details=None, offset=None, limit=None) -> web.Response:
