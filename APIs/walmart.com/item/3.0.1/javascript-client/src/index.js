...
import Version2Api from './api/Version2Api';
...
* <pre>
* var ItemApi = require('index'); // See note below*.
* var xxxSvc = new ItemApi.XxxApi(); // Allocate the API class we're going to use.
* var yyyModel = new ItemApi.Yyy(); // Construct a model instance.
...
* <pre>
* var xxxSvc = new ItemApi.XxxApi(); // Allocate the API class we're going to use.
* var yyy = new ItemApi.Yyy(); // Construct a model instance.
* yyyModel.someProperty = 'someValue';
* ...
* var zzz = xxxSvc.doSomething(yyyModel); // Invoke the service.
* ...
...
export {
    ...
    /**
    * The Version2Api service constructor.
    * @property {module:api/Version2Api}
    */
    Version2Api,
