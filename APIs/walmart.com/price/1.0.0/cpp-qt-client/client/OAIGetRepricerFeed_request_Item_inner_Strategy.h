...
/*
 * OAIGetRepricerFeed_request_Item_inner_Strategy.h
 *
 * 
 */

#ifndef OAIGetRepricerFeed_request_Item_inner_Strategy_H
#define OAIGetRepricerFeed_request_Item_inner_Strategy_H
...
class OAIGetRepricerFeed_request_Item_inner_Strategy : public OAIObject {
public:
    OAIGetRepricerFeed_request_Item_inner_Strategy();
    OAIGetRepricerFeed_request_Item_inner_Strategy(QString json);
    ~OAIGetRepricerFeed_request_Item_inner_Strategy() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetRepricerFeed_request_Item_inner_Strategy)

#endif // OAIGetRepricerFeed_request_Item_inner_Strategy_H
