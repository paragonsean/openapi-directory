...
OAIUpdatePrice_request_pricing_inner_comparisonPrice OAIPricing::getComparisonPrice() const {
    return m_comparison_price;
}
void OAIPricing::setComparisonPrice(const OAIUpdatePrice_request_pricing_inner_comparisonPrice &comparison_price) {
    m_comparison_price = comparison_price;
    m_comparison_price_isSet = true;
}

bool OAIPricing::is_comparison_price_Set() const{
    return m_comparison_price_isSet;
}

bool OAIPricing::is_comparison_price_Valid() const{
    return m_comparison_price_isValid;
}

QString OAIPricing::getComparisonPriceType() const {
    return m_comparison_price_type;
}
void OAIPricing::setComparisonPriceType(const QString &comparison_price_type) {
    m_comparison_price_type = comparison_price_type;
    m_comparison_price_type_isSet = true;
}

bool OAIPricing::is_comparison_price_type_Set() const{
    return m_comparison_price_type_isSet;
}

bool OAIPricing::is_comparison_price_type_Valid() const{
    return m_comparison_price_type_isValid;
}

OAIUpdatePrice_request_pricing_inner_currentPrice OAIPricing::getCurrentPrice() const {
    return m_current_price;
}
void OAIPricing::setCurrentPrice(const OAIUpdatePrice_request_pricing_inner_currentPrice &current_price) {
    m_current_price = current_price;
    m_current_price_isSet = true;
}

bool OAIPricing::is_current_price_Set() const{
    return m_current_price_isSet;
}

bool OAIPricing::is_current_price_Valid() const{
    return m_current_price_isValid;
}

QString OAIPricing::getCurrentPriceType() const {
    return m_current_price_type;
}
void OAIPricing::setCurrentPriceType(const QString &current_price_type) {
    m_current_price_type = current_price_type;
    m_current_price_type_isSet = true;
}

bool OAIPricing::is_current_price_type_Set() const{
    return m_current_price_type_isSet;
}

bool OAIPricing::is_current_price_type_Valid() const{
    return m_current_price_type_isValid;
}

QDateTime OAIPricing::getEffectiveDate() const {
    return m_effective_date;
}
void OAIPricing::setEffectiveDate(const QDateTime &effective_date) {
    m_effective_date = effective_date;
    m_effective_date_isSet = true;
}

bool OAIPricing::is_effective_date_Set() const{
    return m_effective_date_isSet;
}

bool OAIPricing::is_effective_date_Valid() const{
    return m_effective_date_isValid;
}

QDateTime OAIPricing::getExpirationDate() const {
    return m_expiration_date;
}
void OAIPricing::setExpirationDate(const QDateTime &expiration_date) {
    m_expiration_date = expiration_date;
    m_expiration_date_isSet = true;
}

bool OAIPricing::is_expiration_date_Set() const{
    return m_expiration_date_isSet;
}

bool OAIPricing::is_expiration_date_Valid() const{
    return m_expiration_date_isValid;
}

QString OAIPricing::getPriceDisplayCodes() const {
    return m_price_display_codes;
}
void OAIPricing::setPriceDisplayCodes(const QString &price_display_codes) {
    m_price_display_codes = price_display_codes;
    m_price_display_codes_isSet = true;
}

bool OAIPricing::is_price_display_codes_Set() const{
    return m_price_display_codes_isSet;
}

bool OAIPricing::is_price_display_codes_Valid() const{
    return m_price_display_codes_isValid;
}

QString OAIPricing::getProcessMode() const {
    return m_process_mode;
}
void OAIPricing::setProcessMode(const QString &process_mode) {
    m_process_mode = process_mode;
    m_process_mode_isSet = true;
}

bool OAIPricing::is_process_mode_Set() const{
    return m_process_mode_isSet;
}

bool OAIPricing::is_process_mode_Valid() const{
    return m_process_mode_isValid;
}

QString OAIPricing::getPromoId() const {
    return m_promo_id;
}
void OAIPricing::setPromoId(const QString &promo_id) {
    m_promo_id = promo_id;
    m_promo_id_isSet = true;
}

bool OAIPricing::is_promo_id_Set() const{
    return m_promo_id_isSet;
}

bool OAIPricing::is_promo_id_Valid() const{
