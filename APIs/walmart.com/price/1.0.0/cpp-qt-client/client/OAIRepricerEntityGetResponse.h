...
/*
 * OAIRepricerEntityGetResponse.h
 *
 * 
 */

#ifndef OAIRepricerEntityGetResponse_H
#define OAIRepricerEntityGetResponse_H
...
class OAIRepricerEntityGetResponse : public OAIObject {
public:
    OAIRepricerEntityGetResponse();
    OAIRepricerEntityGetResponse(QString json);
    ~OAIRepricerEntityGetResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRepricerEntityGetResponse)

#endif // OAIRepricerEntityGetResponse_H
