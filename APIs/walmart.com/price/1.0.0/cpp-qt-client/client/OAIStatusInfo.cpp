...
bool OAIStatusInfo::isSubsidyEnrolled() const {
    return m_subsidy_enrolled;
}
void OAIStatusInfo::setSubsidyEnrolled(const bool &subsidy_enrolled) {
    m_subsidy_enrolled = subsidy_enrolled;
    m_subsidy_enrolled_isSet = true;
}

bool OAIStatusInfo::is_subsidy_enrolled_Set() const{
    return m_subsidy_enrolled_isSet;
}

bool OAIStatusInfo::is_subsidy_enrolled_Valid() const{
    return m_subsidy_enrolled_isValid;
}

bool OAIStatusInfo::isSubsidyPreference() const {
    return m_subsidy_preference;
}
void OAIStatusInfo::setSubsidyPreference(const bool &subsidy_preference) {
    m_subsidy_preference = subsidy_preference;
    m_subsidy_preference_isSet = true;
}

bool OAIStatusInfo::is_subsidy_preference_Set() const{
    return m_subsidy_preference_isSet;
}

bool OAIStatusInfo::is_subsidy_preference_Valid() const{
