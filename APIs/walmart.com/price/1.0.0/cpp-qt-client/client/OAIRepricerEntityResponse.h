...
/*
 * OAIRepricerEntityResponse.h
 *
 * 
 */

#ifndef OAIRepricerEntityResponse_H
#define OAIRepricerEntityResponse_H
...
class OAIRepricerEntityResponse : public OAIObject {
public:
    OAIRepricerEntityResponse();
    OAIRepricerEntityResponse(QString json);
    ~OAIRepricerEntityResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRepricerEntityResponse)

#endif // OAIRepricerEntityResponse_H
