...
/*
 * OAIFeedItemsHeaderRequestDTO.h
 *
 * 
 */

#ifndef OAIFeedItemsHeaderRequestDTO_H
#define OAIFeedItemsHeaderRequestDTO_H
...
class OAIFeedItemsHeaderRequestDTO : public OAIObject {
public:
    OAIFeedItemsHeaderRequestDTO();
    OAIFeedItemsHeaderRequestDTO(QString json);
    ~OAIFeedItemsHeaderRequestDTO() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFeedItemsHeaderRequestDTO)

#endif // OAIFeedItemsHeaderRequestDTO_H
