...
/*
 * OAICreateStrategy_request.h
 *
 * 
 */

#ifndef OAICreateStrategy_request_H
#define OAICreateStrategy_request_H
...
class OAICreateStrategy_request : public OAIObject {
public:
    OAICreateStrategy_request();
    OAICreateStrategy_request(QString json);
    ~OAICreateStrategy_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateStrategy_request)

#endif // OAICreateStrategy_request_H
