...
/*
 * OAIUpdatePrice_request_pricing_inner.h
 *
 * 
 */

#ifndef OAIUpdatePrice_request_pricing_inner_H
#define OAIUpdatePrice_request_pricing_inner_H
...
class OAIUpdatePrice_request_pricing_inner : public OAIObject {
public:
    OAIUpdatePrice_request_pricing_inner();
    OAIUpdatePrice_request_pricing_inner(QString json);
    ~OAIUpdatePrice_request_pricing_inner() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdatePrice_request_pricing_inner)

#endif // OAIUpdatePrice_request_pricing_inner_H
