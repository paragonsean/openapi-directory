...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PriceManagement.UpdatePrice200ResponseErrorsInner();
  });
  ...
  describe('UpdatePrice200ResponseErrorsInner', function() {
    it('should create an instance of UpdatePrice200ResponseErrorsInner', function() {
      // uncomment below and update the code to test UpdatePrice200ResponseErrorsInner
      //var instance = new PriceManagement.UpdatePrice200ResponseErrorsInner();
      //expect(instance).to.be.a(PriceManagement.UpdatePrice200ResponseErrorsInner);
    });
