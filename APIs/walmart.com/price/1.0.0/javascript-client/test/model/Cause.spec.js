...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PriceManagement.Cause();
  });
  ...
  describe('Cause', function() {
    it('should create an instance of Cause', function() {
      // uncomment below and update the code to test Cause
      //var instance = new PriceManagement.Cause();
      //expect(instance).to.be.a(PriceManagement.Cause);
    });
