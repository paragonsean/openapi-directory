...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PriceManagement.PriceBulkUploads200Response();
  });
  ...
  describe('PriceBulkUploads200Response', function() {
    it('should create an instance of PriceBulkUploads200Response', function() {
      // uncomment below and update the code to test PriceBulkUploads200Response
      //var instance = new PriceManagement.PriceBulkUploads200Response();
      //expect(instance).to.be.a(PriceManagement.PriceBulkUploads200Response);
    });
