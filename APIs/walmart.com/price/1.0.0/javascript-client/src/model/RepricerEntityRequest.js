...
/**
 * The RepricerEntityRequest model module.
 * @module model/RepricerEntityRequest
 * @version 1.0.0
 */
class RepricerEntityRequest {
    /**
     * Constructs a new <code>RepricerEntityRequest</code>.
     * @alias module:model/RepricerEntityRequest
     */
    constructor() { 
        
        RepricerEntityRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>RepricerEntityRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/RepricerEntityRequest} obj Optional instance to populate.
     * @return {module:model/RepricerEntityRequest} The populated <code>RepricerEntityRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RepricerEntityRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>RepricerEntityRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RepricerEntityRequest</code>.
     */
 ...
 */
RepricerEntityRequest.prototype['enableRepricerForPromotion'] = undefined;

/**
 * Status of the Strategy Collection
 * @member {Boolean} enabled
 */
RepricerEntityRequest.prototype['enabled'] = undefined;

/**
 * Name of the Strategy Collection
 * @member {String} repricerStrategy
 */
RepricerEntityRequest.prototype['repricerStrategy'] = undefined;

/**
 * Strategies
 * @member {Array.<module:model/GetStrategies200ResponseStrategyCollectionsInnerStrategiesInner>} strategies
 */
RepricerEntityRequest.prototype['strategies'] = undefined;
...
export default RepricerEntityRequest;
