...
/**
 * The UpdatePriceRequestPricingInner model module.
 * @module model/UpdatePriceRequestPricingInner
 * @version 1.0.0
 */
class UpdatePriceRequestPricingInner {
    /**
     * Constructs a new <code>UpdatePriceRequestPricingInner</code>.
     * @alias module:model/UpdatePriceRequestPricingInner
     * @param currentPrice {module:model/UpdatePriceRequestPricingInnerCurrentPrice} 
     * @param currentPriceType {module:model/UpdatePriceRequestPricingInner.CurrentPriceTypeEnum} This is applicable only for both promotions and price
     */
    constructor(currentPrice, currentPriceType) { 
        
        UpdatePriceRequestPricingInner.initialize(this, currentPrice, currentPriceType);
    }
    ...
    /**
     * Constructs a <code>UpdatePriceRequestPricingInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdatePriceRequestPricingInner} obj Optional instance to populate.
     * @return {module:model/UpdatePriceRequestPricingInner} The populated <code>UpdatePriceRequestPricingInner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdatePriceRequestPricingInner();
    ...
    /**
     * Validates the JSON data with respect to <code>UpdatePriceRequestPricingInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdatePriceRequestPricingInner</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of UpdatePriceRequestPricingInner.RequiredProperties) {
...
UpdatePriceRequestPricingInner.RequiredProperties = ["currentPrice", "currentPriceType"];

/**
 * @member {module:model/UpdatePriceRequestPricingInnerComparisonPrice} comparisonPrice
 */
UpdatePriceRequestPricingInner.prototype['comparisonPrice'] = undefined;

/**
 * This is applicable only for promotions
 * @member {module:model/UpdatePriceRequestPricingInner.ComparisonPriceTypeEnum} comparisonPriceType
 */
UpdatePriceRequestPricingInner.prototype['comparisonPriceType'] = undefined;

/**
 * @member {module:model/UpdatePriceRequestPricingInnerCurrentPrice} currentPrice
 */
UpdatePriceRequestPricingInner.prototype['currentPrice'] = undefined;

/**
 * This is applicable only for both promotions and price
 * @member {module:model/UpdatePriceRequestPricingInner.CurrentPriceTypeEnum} currentPriceType
 */
UpdatePriceRequestPricingInner.prototype['currentPriceType'] = undefined;

/**
 * This is applicable only for promotions
 * @member {Date} effectiveDate
 */
UpdatePriceRequestPricingInner.prototype['effectiveDate'] = undefined;

/**
 * This is applicable only for promotions
 * @member {Date} expirationDate
 */
UpdatePriceRequestPricingInner.prototype['expirationDate'] = undefined;

/**
 * Represent promo placement. This is applicable only for promotions
 * @member {module:model/UpdatePriceRequestPricingInner.PriceDisplayCodesEnum} priceDisplayCodes
 */
UpdatePriceRequestPricingInner.prototype['priceDisplayCodes'] = undefined;

/**
 * This is applicable only for promotions
 * @member {module:model/UpdatePriceRequestPricingInner.ProcessModeEnum} processMode
 */
UpdatePriceRequestPricingInner.prototype['processMode'] = undefined;

/**
 * This is applicable only for promotions
 * @member {String} promoId
 */
UpdatePriceRequestPricingInner.prototype['promoId'] = undefined;
 ...
 * @readonly
 */
UpdatePriceRequestPricingInner['ComparisonPriceTypeEnum'] = {
 ...
 * @readonly
 */
UpdatePriceRequestPricingInner['CurrentPriceTypeEnum'] = {
 ...
 * @readonly
 */
UpdatePriceRequestPricingInner['PriceDisplayCodesEnum'] = {
 ...
 * @readonly
 */
UpdatePriceRequestPricingInner['ProcessModeEnum'] = {
...
export default UpdatePriceRequestPricingInner;
