...
/**
 * The CreateStrategy200Response model module.
 * @module model/CreateStrategy200Response
 * @version 1.0.0
 */
class CreateStrategy200Response {
    /**
     * Constructs a new <code>CreateStrategy200Response</code>.
     * @alias module:model/CreateStrategy200Response
     */
    constructor() { 
        
        CreateStrategy200Response.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CreateStrategy200Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateStrategy200Response} obj Optional instance to populate.
     * @return {module:model/CreateStrategy200Response} The populated <code>CreateStrategy200Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateStrategy200Response();
    ...
    /**
     * Validates the JSON data with respect to <code>CreateStrategy200Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateStrategy200Response</code>.
     */
 ...
 */
CreateStrategy200Response.prototype['enableRepricerForPromotion'] = undefined;

/**
 * @member {Boolean} enabled
 */
CreateStrategy200Response.prototype['enabled'] = undefined;

/**
 * @member {String} repricerStrategy
 */
CreateStrategy200Response.prototype['repricerStrategy'] = undefined;

/**
 * @member {Array.<module:model/GetStrategies200ResponseStrategyCollectionsInnerStrategiesInner>} strategies
 */
CreateStrategy200Response.prototype['strategies'] = undefined;

/**
 * @member {String} strategyCollectionId
 */
CreateStrategy200Response.prototype['strategyCollectionId'] = undefined;
...
export default CreateStrategy200Response;
