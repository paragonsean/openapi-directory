...
class Price {
    ...
    constructor(pricing, sku) { 
        ...
        Price.initialize(this, pricing, sku);
    }
...
Price.RequiredProperties = ["pricing", "sku"];

/**
 * @member {Object} definitions
 */
Price.prototype['definitions'] = undefined;

/**
 * This is applicable only for promotions
 * @member {String} offerId
 */
Price.prototype['offerId'] = undefined;

/**
 * @member {Array.<module:model/UpdatePriceRequestPricingInner>} pricing
 */
Price.prototype['pricing'] = undefined;

/**
 * This is applicable only for promotions
 * @member {module:model/Price.ReplaceAllEnum} replaceAll
 */
Price.prototype['replaceAll'] = undefined;

/**
 * @member {String} sku
 */
Price.prototype['sku'] = undefined;
