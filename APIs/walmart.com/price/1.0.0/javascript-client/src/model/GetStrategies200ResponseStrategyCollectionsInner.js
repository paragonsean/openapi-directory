...
/**
 * The GetStrategies200ResponseStrategyCollectionsInner model module.
 * @module model/GetStrategies200ResponseStrategyCollectionsInner
 * @version 1.0.0
 */
class GetStrategies200ResponseStrategyCollectionsInner {
    /**
     * Constructs a new <code>GetStrategies200ResponseStrategyCollectionsInner</code>.
     * @alias module:model/GetStrategies200ResponseStrategyCollectionsInner
     */
    constructor() { 
        
        GetStrategies200ResponseStrategyCollectionsInner.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetStrategies200ResponseStrategyCollectionsInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetStrategies200ResponseStrategyCollectionsInner} obj Optional instance to populate.
     * @return {module:model/GetStrategies200ResponseStrategyCollectionsInner} The populated <code>GetStrategies200ResponseStrategyCollectionsInner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetStrategies200ResponseStrategyCollectionsInner();
    ...
    /**
     * Validates the JSON data with respect to <code>GetStrategies200ResponseStrategyCollectionsInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetStrategies200ResponseStrategyCollectionsInner</code>.
     */
 ...
 */
GetStrategies200ResponseStrategyCollectionsInner.prototype['assignedCount'] = undefined;

/**
 * @member {Boolean} enableRepricerForPromotion
 */
GetStrategies200ResponseStrategyCollectionsInner.prototype['enableRepricerForPromotion'] = undefined;

/**
 * @member {Boolean} enabled
 */
GetStrategies200ResponseStrategyCollectionsInner.prototype['enabled'] = undefined;

/**
 * @member {String} repricerStrategy
 */
GetStrategies200ResponseStrategyCollectionsInner.prototype['repricerStrategy'] = undefined;

/**
 * @member {Array.<module:model/GetStrategies200ResponseStrategyCollectionsInnerStrategiesInner>} strategies
 */
GetStrategies200ResponseStrategyCollectionsInner.prototype['strategies'] = undefined;

/**
 * @member {String} strategyCollectionId
 */
GetStrategies200ResponseStrategyCollectionsInner.prototype['strategyCollectionId'] = undefined;
...
export default GetStrategies200ResponseStrategyCollectionsInner;
