...
class Pricing(Model):
    ...
    def __init__(self, comparison_price: UpdatePriceRequestPricingInnerComparisonPrice=None, comparison_price_type: str=None, current_price: UpdatePriceRequestPricingInnerCurrentPrice=None, current_price_type: str=None, effective_date: datetime=None, expiration_date: datetime=None, price_display_codes: str=None, process_mode: str=None, promo_id: str=None):
        ...
        :param comparison_price: The comparison_price of this Pricing.
        :param comparison_price_type: The comparison_price_type of this Pricing.
        :param current_price: The current_price of this Pricing.
        :param current_price_type: The current_price_type of this Pricing.
        :param effective_date: The effective_date of this Pricing.
        :param expiration_date: The expiration_date of this Pricing.
        :param price_display_codes: The price_display_codes of this Pricing.
        :param process_mode: The process_mode of this Pricing.
        :param promo_id: The promo_id of this Pricing.
        """
        self.openapi_types = {
    ...
    def comparison_price(self):
        """Gets the comparison_price of this Pricing.


        :return: The comparison_price of this Pricing.
    ...
    def comparison_price(self, comparison_price):
        """Sets the comparison_price of this Pricing.
    ...
    def comparison_price_type(self):
        """Gets the comparison_price_type of this Pricing.

        This is applicable only for promotions

        :return: The comparison_price_type of this Pricing.
        :rtype: str
        """
    ...
    def comparison_price_type(self, comparison_price_type):
        """Sets the comparison_price_type of this Pricing.
    ...
    def current_price(self):
        """Gets the current_price of this Pricing.


        :return: The current_price of this Pricing.
    ...
    def current_price(self, current_price):
        """Sets the current_price of this Pricing.
    ...
    def current_price_type(self):
        """Gets the current_price_type of this Pricing.

        This is applicable only for both promotions and price

        :return: The current_price_type of this Pricing.
        :rtype: str
        """
    ...
    def current_price_type(self, current_price_type):
        """Sets the current_price_type of this Pricing.
    ...
    def price_display_codes(self):
        """Gets the price_display_codes of this Pricing.

        Represent promo placement. This is applicable only for promotions

        :return: The price_display_codes of this Pricing.
        :rtype: str
        """
    ...
    def price_display_codes(self, price_display_codes):
        """Sets the price_display_codes of this Pricing.
    ...
    def process_mode(self):
        """Gets the process_mode of this Pricing.

        This is applicable only for promotions

        :return: The process_mode of this Pricing.
        :rtype: str
        """
    ...
    def process_mode(self, process_mode):
        """Sets the process_mode of this Pricing.
    ...
    @property
    def promo_id(self):
        """Gets the promo_id of this Pricing.

        This is applicable only for promotions

        :return: The promo_id of this Pricing.
        :rtype: str
        """
    ...
    def promo_id(self, promo_id):
        """Sets the promo_id of this Pricing.
