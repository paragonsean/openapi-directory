...
public class RepricerEntityResponse {
  ...
  public RepricerEntityResponse() {
  }

  public RepricerEntityResponse enableRepricerForPromotion(Boolean enableRepricerForPromotion) {
  ...
  public RepricerEntityResponse enabled(Boolean enabled) {
  ...
  public RepricerEntityResponse repricerStrategy(String repricerStrategy) {
  ...
  public RepricerEntityResponse strategies(List<GetStrategies200ResponseStrategyCollectionsInnerStrategiesInner> strategies) {
    this.strategies = strategies;
    return this;
  }

  public RepricerEntityResponse addStrategiesItem(GetStrategies200ResponseStrategyCollectionsInnerStrategiesInner strategiesItem) {
  ...
  public RepricerEntityResponse strategyCollectionId(String strategyCollectionId) {
  ...
  public boolean equals(Object o) {
    ...
    RepricerEntityResponse repricerEntityResponse = (RepricerEntityResponse) o;
    return Objects.equals(this.enableRepricerForPromotion, repricerEntityResponse.enableRepricerForPromotion) &&
        Objects.equals(this.enabled, repricerEntityResponse.enabled) &&
        Objects.equals(this.repricerStrategy, repricerEntityResponse.repricerStrategy) &&
        Objects.equals(this.strategies, repricerEntityResponse.strategies) &&
        Objects.equals(this.strategyCollectionId, repricerEntityResponse.strategyCollectionId);
  }
  ...
  public String toString() {
    ...
    sb.append("class RepricerEntityResponse {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to RepricerEntityResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RepricerEntityResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in RepricerEntityResponse is not found in the empty JSON string", RepricerEntityResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RepricerEntityResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `RepricerEntityResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RepricerEntityResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RepricerEntityResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RepricerEntityResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RepricerEntityResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<RepricerEntityResponse>() {
           @Override
           public void write(JsonWriter out, RepricerEntityResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public RepricerEntityResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of RepricerEntityResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of RepricerEntityResponse
   * @throws IOException if the JSON string is invalid with respect to RepricerEntityResponse
   */
  public static RepricerEntityResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RepricerEntityResponse.class);
  }

  /**
   * Convert an instance of RepricerEntityResponse to an JSON string
   *
   * @return JSON string
   */
