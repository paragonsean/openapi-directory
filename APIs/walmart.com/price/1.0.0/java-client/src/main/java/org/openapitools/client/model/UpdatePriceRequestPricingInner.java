...
public class UpdatePriceRequestPricingInner {
  ...
  public UpdatePriceRequestPricingInner() {
  }

  public UpdatePriceRequestPricingInner comparisonPrice(UpdatePriceRequestPricingInnerComparisonPrice comparisonPrice) {
  ...
  public UpdatePriceRequestPricingInner comparisonPriceType(ComparisonPriceTypeEnum comparisonPriceType) {
  ...
  public UpdatePriceRequestPricingInner currentPrice(UpdatePriceRequestPricingInnerCurrentPrice currentPrice) {
  ...
  public UpdatePriceRequestPricingInner currentPriceType(CurrentPriceTypeEnum currentPriceType) {
  ...
  public UpdatePriceRequestPricingInner effectiveDate(OffsetDateTime effectiveDate) {
  ...
  public UpdatePriceRequestPricingInner expirationDate(OffsetDateTime expirationDate) {
  ...
  public UpdatePriceRequestPricingInner priceDisplayCodes(PriceDisplayCodesEnum priceDisplayCodes) {
  ...
  public UpdatePriceRequestPricingInner processMode(ProcessModeEnum processMode) {
  ...
  public UpdatePriceRequestPricingInner promoId(String promoId) {
  ...
  public boolean equals(Object o) {
    ...
    UpdatePriceRequestPricingInner updatePriceRequestPricingInner = (UpdatePriceRequestPricingInner) o;
    return Objects.equals(this.comparisonPrice, updatePriceRequestPricingInner.comparisonPrice) &&
        Objects.equals(this.comparisonPriceType, updatePriceRequestPricingInner.comparisonPriceType) &&
        Objects.equals(this.currentPrice, updatePriceRequestPricingInner.currentPrice) &&
        Objects.equals(this.currentPriceType, updatePriceRequestPricingInner.currentPriceType) &&
        Objects.equals(this.effectiveDate, updatePriceRequestPricingInner.effectiveDate) &&
        Objects.equals(this.expirationDate, updatePriceRequestPricingInner.expirationDate) &&
        Objects.equals(this.priceDisplayCodes, updatePriceRequestPricingInner.priceDisplayCodes) &&
        Objects.equals(this.processMode, updatePriceRequestPricingInner.processMode) &&
        Objects.equals(this.promoId, updatePriceRequestPricingInner.promoId);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdatePriceRequestPricingInner {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdatePriceRequestPricingInner
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdatePriceRequestPricingInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdatePriceRequestPricingInner is not found in the empty JSON string", UpdatePriceRequestPricingInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdatePriceRequestPricingInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdatePriceRequestPricingInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UpdatePriceRequestPricingInner.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdatePriceRequestPricingInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdatePriceRequestPricingInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdatePriceRequestPricingInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdatePriceRequestPricingInner.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdatePriceRequestPricingInner>() {
           @Override
           public void write(JsonWriter out, UpdatePriceRequestPricingInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdatePriceRequestPricingInner read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdatePriceRequestPricingInner given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdatePriceRequestPricingInner
   * @throws IOException if the JSON string is invalid with respect to UpdatePriceRequestPricingInner
   */
  public static UpdatePriceRequestPricingInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdatePriceRequestPricingInner.class);
  }

  /**
   * Convert an instance of UpdatePriceRequestPricingInner to an JSON string
   *
   * @return JSON string
   */
