...
public class RepricerEntityGetResponse {
  ...
  public RepricerEntityGetResponse() {
  }

  public RepricerEntityGetResponse assignedCount(Integer assignedCount) {
  ...
  public RepricerEntityGetResponse enableRepricerForPromotion(Boolean enableRepricerForPromotion) {
  ...
  public RepricerEntityGetResponse enabled(Boolean enabled) {
  ...
  public RepricerEntityGetResponse repricerStrategy(String repricerStrategy) {
  ...
  public RepricerEntityGetResponse strategies(List<GetStrategies200ResponseStrategyCollectionsInnerStrategiesInner> strategies) {
    this.strategies = strategies;
    return this;
  }

  public RepricerEntityGetResponse addStrategiesItem(GetStrategies200ResponseStrategyCollectionsInnerStrategiesInner strategiesItem) {
  ...
  public RepricerEntityGetResponse strategyCollectionId(String strategyCollectionId) {
  ...
  public boolean equals(Object o) {
    ...
    RepricerEntityGetResponse repricerEntityGetResponse = (RepricerEntityGetResponse) o;
    return Objects.equals(this.assignedCount, repricerEntityGetResponse.assignedCount) &&
        Objects.equals(this.enableRepricerForPromotion, repricerEntityGetResponse.enableRepricerForPromotion) &&
        Objects.equals(this.enabled, repricerEntityGetResponse.enabled) &&
        Objects.equals(this.repricerStrategy, repricerEntityGetResponse.repricerStrategy) &&
        Objects.equals(this.strategies, repricerEntityGetResponse.strategies) &&
        Objects.equals(this.strategyCollectionId, repricerEntityGetResponse.strategyCollectionId);
  }
  ...
  public String toString() {
    ...
    sb.append("class RepricerEntityGetResponse {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to RepricerEntityGetResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RepricerEntityGetResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in RepricerEntityGetResponse is not found in the empty JSON string", RepricerEntityGetResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RepricerEntityGetResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `RepricerEntityGetResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RepricerEntityGetResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RepricerEntityGetResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RepricerEntityGetResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RepricerEntityGetResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<RepricerEntityGetResponse>() {
           @Override
           public void write(JsonWriter out, RepricerEntityGetResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public RepricerEntityGetResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of RepricerEntityGetResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of RepricerEntityGetResponse
   * @throws IOException if the JSON string is invalid with respect to RepricerEntityGetResponse
   */
  public static RepricerEntityGetResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RepricerEntityGetResponse.class);
  }

  /**
   * Convert an instance of RepricerEntityGetResponse to an JSON string
   *
   * @return JSON string
   */
