...
class ApiClient {
     ...
     */
    constructor(basePath = 'https://developer.walmart.com/orderProxy/order-api-doc-app/rest') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default https://developer.walmart.com/orderProxy/order-api-doc-app/rest
         */
         ...
         */
        this.defaultHeaders = {
            'User-Agent': 'OpenAPI-Generator/3.0.1/Javascript'
        };
