...
public class Elements {
  ...
  public Elements inventories(List<GetMultiNodeInventoryForAllSkuAndAllShipNodes200ResponseElementsInventoriesInner> inventories) {
    this.inventories = inventories;
    return this;
  }

  public Elements addInventoriesItem(GetMultiNodeInventoryForAllSkuAndAllShipNodes200ResponseElementsInventoriesInner inventoriesItem) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.inventories, elements.inventories);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to Elements
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Elements.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Elements.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Elements` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
