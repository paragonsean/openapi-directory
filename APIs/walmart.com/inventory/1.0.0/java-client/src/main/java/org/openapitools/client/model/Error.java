...
public class Error {
  ...
  public Error causes(List<GetMultiNodeInventoryForSkuAndAllShipnodes200ResponseNodesInnerErrorsInnerCausesInner> causes) {
    this.causes = causes;
    return this;
  }

  public Error addCausesItem(GetMultiNodeInventoryForSkuAndAllShipnodes200ResponseNodesInnerErrorsInnerCausesInner causesItem) {
    if (this.causes == null) {
  ...
  public Error errorIdentifiers(Map<String, Object> errorIdentifiers) {
    this.errorIdentifiers = errorIdentifiers;
    return this;
  }

  public Error putErrorIdentifiersItem(String key, Object errorIdentifiersItem) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.category, error.category) &&
        ...
        Objects.equals(this.errorIdentifiers, error.errorIdentifiers) &&
