...
#ifndef OAIInputQty_H
#define OAIInputQty_H
...
class OAIInputQty : public OAIObject {
public:
    OAIInputQty();
    OAIInputQty(QString json);
    ~OAIInputQty() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIInputQty)
