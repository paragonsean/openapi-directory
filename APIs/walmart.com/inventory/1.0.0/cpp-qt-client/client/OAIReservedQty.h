...
#ifndef OAIReservedQty_H
#define OAIReservedQty_H
...
class OAIReservedQty : public OAIObject {
public:
    OAIReservedQty();
    OAIReservedQty(QString json);
    ~OAIReservedQty() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIReservedQty)

#endif // OAIReservedQty_H
