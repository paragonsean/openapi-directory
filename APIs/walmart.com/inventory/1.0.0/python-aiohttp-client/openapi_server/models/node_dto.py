...
class NodeDTO(Model):
    ...
    def __init__(self, avail_to_sell_qty: GetMultiNodeInventoryForAllSkuAndAllShipNodes200ResponseElementsInventoriesInnerNodesInnerAvailToSellQty=None, errors: List[GetMultiNodeInventoryForSkuAndAllShipnodes200ResponseNodesInnerErrorsInner]=None, input_qty: GetMultiNodeInventoryForAllSkuAndAllShipNodes200ResponseElementsInventoriesInnerNodesInnerInputQty=None, reserved_qty: GetMultiNodeInventoryForAllSkuAndAllShipNodes200ResponseElementsInventoriesInnerNodesInnerReservedQty=None, ship_node: str=None):
        """NodeDTO - a model defined in OpenAPI

        :param avail_to_sell_qty: The avail_to_sell_qty of this NodeDTO.
        :param errors: The errors of this NodeDTO.
        :param input_qty: The input_qty of this NodeDTO.
        :param reserved_qty: The reserved_qty of this NodeDTO.
        :param ship_node: The ship_node of this NodeDTO.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'NodeDTO':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The NodeDTO of this NodeDTO.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def avail_to_sell_qty(self):
        """Gets the avail_to_sell_qty of this NodeDTO.


        :return: The avail_to_sell_qty of this NodeDTO.
    ...
    def avail_to_sell_qty(self, avail_to_sell_qty):
        """Sets the avail_to_sell_qty of this NodeDTO.
    ...
    @property
    def errors(self):
        """Gets the errors of this NodeDTO.


        :return: The errors of this NodeDTO.
    ...
    def errors(self, errors):
        """Sets the errors of this NodeDTO.
    ...
    @property
    def input_qty(self):
        """Gets the input_qty of this NodeDTO.


        :return: The input_qty of this NodeDTO.
    ...
    def input_qty(self, input_qty):
        """Sets the input_qty of this NodeDTO.
    ...
    def reserved_qty(self):
        """Gets the reserved_qty of this NodeDTO.


        :return: The reserved_qty of this NodeDTO.
    ...
    def reserved_qty(self, reserved_qty):
        """Sets the reserved_qty of this NodeDTO.
    ...
    @property
    def ship_node(self):
        """Gets the ship_node of this NodeDTO.

        ShipNode Id of the ship node for which the inventory is requested

        :return: The ship_node of this NodeDTO.
        :rtype: str
        """
    ...
    def ship_node(self, ship_node):
        """Sets the ship_node of this NodeDTO.
