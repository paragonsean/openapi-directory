...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new InventoryManagement.FeedId();
  });
  ...
  describe('FeedId', function() {
    it('should create an instance of FeedId', function() {
      // uncomment below and update the code to test FeedId
      //var instance = new InventoryManagement.FeedId();
      //expect(instance).to.be.a(InventoryManagement.FeedId);
    });
