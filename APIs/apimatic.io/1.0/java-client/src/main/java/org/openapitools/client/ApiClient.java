...
public class ApiClient {
    ...
    private String basePath = "https://apimatic.io/api/transform";
    ...
    public ApiClient() {
        ...
        authentications.put("api-key", new ApiKeyAuth("query", "apikey"));
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://apimatic.io/api/transform
