...
void OAIDefaultApi::initializeServerConfigs() {
    ...
    QUrl("https://apimatic.io/api/transform"),
    "No description provided",
    QMap<QString, OAIServerVariable>()));
    _serverConfigs.insert("convertAPI", defaultConf);
    _serverIndices.insert("convertAPI", 0);
}
...
void OAIDefaultApi::convertAPI(const QString &format, const ::OpenAPI::OptionalParam<QString> &url) {
    QString fullPath = QString(_serverConfigs["convertAPI"][_serverIndices.value("convertAPI")].URL()+"/transform");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIDefaultApi::convertAPICallback);
...
void OAIDefaultApi::convertAPICallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT convertAPISignal(output);
        Q_EMIT convertAPISignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT convertAPISignalE(output, error_type, error_str);
        Q_EMIT convertAPISignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT convertAPISignalError(output, error_type, error_str);
        Q_EMIT convertAPISignalErrorFull(worker, error_type, error_str);
    }
}
