...
Vehicle Enquiry API
- API version: 1.1.0
  - Build date: 2024-10-12T10:11:47.677139-04:00[America/New_York]
...
------------ | ------------- | ------------- | -------------
*VehicleApi* | [**getVehicleDetailsByRegistrationNumber**](docs/VehicleApi.md#getVehicleDetailsByRegistrationNumber) | **POST** /v1/vehicles | Get vehicle details by registration number
