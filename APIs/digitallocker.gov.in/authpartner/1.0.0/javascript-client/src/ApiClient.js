...
class ApiClient {
     ...
     */
    constructor(basePath = 'https://betaapi.digitallocker.gov.in/public') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default https://betaapi.digitallocker.gov.in/public
         */
        ...
        this.authentications = {
            'Customkey2': {type: 'apiKey', 'in': 'header', name: 'X-2'},
            'Customkeys1': {type: 'apiKey', 'in': 'header', name: 'X1123'},
            'bearerAuth': {type: 'bearer'},
            'oauthAuthorizeCode': {type: 'oauth2'},
