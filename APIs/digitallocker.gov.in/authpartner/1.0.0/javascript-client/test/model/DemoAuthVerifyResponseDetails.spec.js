...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AuthorizedPartnerApiSpecification.DemoAuthVerifyResponseDetails();
  });
  ...
  describe('DemoAuthVerifyResponseDetails', function() {
    it('should create an instance of DemoAuthVerifyResponseDetails', function() {
      // uncomment below and update the code to test DemoAuthVerifyResponseDetails
      //var instance = new AuthorizedPartnerApiSpecification.DemoAuthVerifyResponseDetails();
      //expect(instance).to.be.a(AuthorizedPartnerApiSpecification.DemoAuthVerifyResponseDetails);
    });
