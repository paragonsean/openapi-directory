...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AuthorizedPartnerApiSpecification.SampleDetails();
  });
  ...
  describe('SampleDetails', function() {
    it('should create an instance of SampleDetails', function() {
      // uncomment below and update the code to test SampleDetails
      //var instance = new AuthorizedPartnerApiSpecification.SampleDetails();
      //expect(instance).to.be.a(AuthorizedPartnerApiSpecification.SampleDetails);
    });
