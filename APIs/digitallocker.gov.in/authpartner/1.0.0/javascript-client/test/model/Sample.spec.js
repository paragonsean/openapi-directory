...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AuthorizedPartnerApiSpecification.Sample();
  });
  ...
  describe('Sample', function() {
    it('should create an instance of Sample', function() {
      ...
      //var instance = new AuthorizedPartnerApiSpecification.Sample();
      //expect(instance).to.be.a(AuthorizedPartnerApiSpecification.Sample);
    });
