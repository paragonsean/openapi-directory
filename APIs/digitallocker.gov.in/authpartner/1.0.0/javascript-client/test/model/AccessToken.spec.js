...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AuthorizedPartnerApiSpecification.AccessToken();
  });
  ...
  describe('AccessToken', function() {
    it('should create an instance of AccessToken', function() {
      ...
      //var instance = new AuthorizedPartnerApiSpecification.AccessToken();
      //expect(instance).to.be.a(AuthorizedPartnerApiSpecification.AccessToken);
    });
    ...
    it('should have the property codeVerifier (base name: "code_verifier")', function() {
      // uncomment below and update the code to test the property codeVerifier
      //var instance = new AuthorizedPartnerApiSpecification.AccessToken();
      //expect(instance).to.be();
    });
