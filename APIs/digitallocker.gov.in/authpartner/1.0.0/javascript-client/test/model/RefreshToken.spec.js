...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AuthorizedPartnerApiSpecification.RefreshToken();
  });
  ...
  describe('RefreshToken', function() {
    it('should create an instance of RefreshToken', function() {
      ...
      //var instance = new AuthorizedPartnerApiSpecification.RefreshToken();
      //expect(instance).to.be.a(AuthorizedPartnerApiSpecification.RefreshToken);
    });
