...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AuthorizedPartnerApiSpecification.Response2();
  });
  ...
  describe('Response2', function() {
    it('should create an instance of Response2', function() {
      ...
      //var instance = new AuthorizedPartnerApiSpecification.Response2();
      //expect(instance).to.be.a(AuthorizedPartnerApiSpecification.Response2);
    });
