...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AuthorizedPartnerApiSpecification.AuthTokenResponse();
  });
  ...
  describe('AuthTokenResponse', function() {
    it('should create an instance of AuthTokenResponse', function() {
      // uncomment below and update the code to test AuthTokenResponse
      //var instance = new AuthorizedPartnerApiSpecification.AuthTokenResponse();
      //expect(instance).to.be.a(AuthorizedPartnerApiSpecification.AuthTokenResponse);
    });
