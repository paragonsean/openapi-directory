...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AuthorizedPartnerApiSpecification.RefreshAccessToken();
  });
  ...
  describe('RefreshAccessToken', function() {
    it('should create an instance of RefreshAccessToken', function() {
      // uncomment below and update the code to test RefreshAccessToken
      //var instance = new AuthorizedPartnerApiSpecification.RefreshAccessToken();
      //expect(instance).to.be.a(AuthorizedPartnerApiSpecification.RefreshAccessToken);
    });
