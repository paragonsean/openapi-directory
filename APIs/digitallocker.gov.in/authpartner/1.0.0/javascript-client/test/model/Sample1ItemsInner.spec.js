...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AuthorizedPartnerApiSpecification.Sample1ItemsInner();
  });
  ...
  describe('Sample1ItemsInner', function() {
    it('should create an instance of Sample1ItemsInner', function() {
      // uncomment below and update the code to test Sample1ItemsInner
      //var instance = new AuthorizedPartnerApiSpecification.Sample1ItemsInner();
      //expect(instance).to.be.a(AuthorizedPartnerApiSpecification.Sample1ItemsInner);
    });
