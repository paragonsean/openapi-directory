...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AuthorizedPartnerApiSpecification.DemoAuthResponseDetails();
  });
  ...
  describe('DemoAuthResponseDetails', function() {
    it('should create an instance of DemoAuthResponseDetails', function() {
      // uncomment below and update the code to test DemoAuthResponseDetails
      //var instance = new AuthorizedPartnerApiSpecification.DemoAuthResponseDetails();
      //expect(instance).to.be.a(AuthorizedPartnerApiSpecification.DemoAuthResponseDetails);
    });
