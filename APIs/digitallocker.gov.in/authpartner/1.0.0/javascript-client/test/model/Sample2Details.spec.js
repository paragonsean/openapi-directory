...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AuthorizedPartnerApiSpecification.Sample2Details();
  });
  ...
  describe('Sample2Details', function() {
    it('should create an instance of Sample2Details', function() {
      // uncomment below and update the code to test Sample2Details
      //var instance = new AuthorizedPartnerApiSpecification.Sample2Details();
      //expect(instance).to.be.a(AuthorizedPartnerApiSpecification.Sample2Details);
    });
