...
#ifndef OAIResponse8_H
#define OAIResponse8_H
...
class OAIResponse8 : public OAIObject {
public:
    OAIResponse8();
    OAIResponse8(QString json);
    ~OAIResponse8() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIResponse8)

#endif // OAIResponse8_H
