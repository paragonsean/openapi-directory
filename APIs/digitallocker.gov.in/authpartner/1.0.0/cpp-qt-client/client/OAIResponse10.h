...
#ifndef OAIResponse10_H
#define OAIResponse10_H
...
class OAIResponse10 : public OAIObject {
public:
    OAIResponse10();
    OAIResponse10(QString json);
    ~OAIResponse10() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIResponse10)

#endif // OAIResponse10_H
