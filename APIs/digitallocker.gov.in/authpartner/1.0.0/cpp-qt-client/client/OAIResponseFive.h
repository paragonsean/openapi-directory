...
#ifndef OAIResponseFive_H
#define OAIResponseFive_H
...
class OAIResponseFive : public OAIObject {
public:
    OAIResponseFive();
    OAIResponseFive(QString json);
    ~OAIResponseFive() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIResponseFive)

#endif // OAIResponseFive_H
