...
#ifndef OAIResponseSix_H
#define OAIResponseSix_H
...
class OAIResponseSix : public OAIObject {
public:
    OAIResponseSix();
    OAIResponseSix(QString json);
    ~OAIResponseSix() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIResponseSix)

#endif // OAIResponseSix_H
