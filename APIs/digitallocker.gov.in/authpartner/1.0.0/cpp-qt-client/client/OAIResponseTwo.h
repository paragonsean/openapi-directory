...
#ifndef OAIResponseTwo_H
#define OAIResponseTwo_H
...
class OAIResponseTwo : public OAIObject {
public:
    OAIResponseTwo();
    OAIResponseTwo(QString json);
    ~OAIResponseTwo() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIResponseTwo)

#endif // OAIResponseTwo_H
