...
#ifndef OAIResponseThree_H
#define OAIResponseThree_H
...
class OAIResponseThree : public OAIObject {
public:
    OAIResponseThree();
    OAIResponseThree(QString json);
    ~OAIResponseThree() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIResponseThree)

#endif // OAIResponseThree_H
