...
#ifndef OAIResponseOne_H
#define OAIResponseOne_H
...
class OAIResponseOne : public OAIObject {
public:
    OAIResponseOne();
    OAIResponseOne(QString json);
    ~OAIResponseOne() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIResponseOne)

#endif // OAIResponseOne_H
