...
/*
 * OAISample_3_details.h
 *
 * 
 */

#ifndef OAISample_3_details_H
#define OAISample_3_details_H
...
class OAISample_3_details : public OAIObject {
public:
    OAISample_3_details();
    OAISample_3_details(QString json);
    ~OAISample_3_details() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISample_3_details)

#endif // OAISample_3_details_H
