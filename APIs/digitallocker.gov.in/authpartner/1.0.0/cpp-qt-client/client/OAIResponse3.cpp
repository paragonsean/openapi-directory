...
QString OAIResponse3::getError() const {
    return m_error;
}
void OAIResponse3::setError(const QString &error) {
    m_error = error;
    m_error_isSet = true;
}

bool OAIResponse3::is_error_Set() const{
    return m_error_isSet;
}

bool OAIResponse3::is_error_Valid() const{
    return m_error_isValid;
}

QString OAIResponse3::getErrorDescription() const {
    return m_error_description;
}
void OAIResponse3::setErrorDescription(const QString &error_description) {
    m_error_description = error_description;
    m_error_description_isSet = true;
}

bool OAIResponse3::is_error_description_Set() const{
    return m_error_description_isSet;
}

bool OAIResponse3::is_error_description_Valid() const{
