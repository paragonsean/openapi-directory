...
#ifndef OAIResponse6_H
#define OAIResponse6_H
...
class OAIResponse6 : public OAIObject {
public:
    OAIResponse6();
    OAIResponse6(QString json);
    ~OAIResponse6() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIResponse6)

#endif // OAIResponse6_H
