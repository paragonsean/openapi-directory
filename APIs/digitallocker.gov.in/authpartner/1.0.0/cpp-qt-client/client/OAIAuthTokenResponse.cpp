...
#include "OAIAuthTokenResponse.h"
...
OAIAuthTokenResponse::OAIAuthTokenResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAuthTokenResponse::OAIAuthTokenResponse() {
    this->initializeModel();
}

OAIAuthTokenResponse::~OAIAuthTokenResponse() {}

void OAIAuthTokenResponse::initializeModel() {
...
void OAIAuthTokenResponse::fromJson(QString jsonString) {
...
void OAIAuthTokenResponse::fromJsonObject(QJsonObject json) {
...
QString OAIAuthTokenResponse::asJson() const {
...
QJsonObject OAIAuthTokenResponse::asJsonObject() const {
    QJsonObject obj;
...
QString OAIAuthTokenResponse::getAccessToken() const {
    return m_access_token;
}
void OAIAuthTokenResponse::setAccessToken(const QString &access_token) {
    m_access_token = access_token;
    m_access_token_isSet = true;
}

bool OAIAuthTokenResponse::is_access_token_Set() const{
    return m_access_token_isSet;
}

bool OAIAuthTokenResponse::is_access_token_Valid() const{
    return m_access_token_isValid;
}

qint64 OAIAuthTokenResponse::getExpiresIn() const {
    return m_expires_in;
}
void OAIAuthTokenResponse::setExpiresIn(const qint64 &expires_in) {
    m_expires_in = expires_in;
    m_expires_in_isSet = true;
}

bool OAIAuthTokenResponse::is_expires_in_Set() const{
    return m_expires_in_isSet;
}

bool OAIAuthTokenResponse::is_expires_in_Valid() const{
    return m_expires_in_isValid;
}

QString OAIAuthTokenResponse::getRefreshToken() const {
    return m_refresh_token;
}
void OAIAuthTokenResponse::setRefreshToken(const QString &refresh_token) {
    m_refresh_token = refresh_token;
    m_refresh_token_isSet = true;
}

bool OAIAuthTokenResponse::is_refresh_token_Set() const{
    return m_refresh_token_isSet;
}

bool OAIAuthTokenResponse::is_refresh_token_Valid() const{
    return m_refresh_token_isValid;
}

QString OAIAuthTokenResponse::getScope() const {
    return m_scope;
}
void OAIAuthTokenResponse::setScope(const QString &scope) {
    m_scope = scope;
    m_scope_isSet = true;
}

bool OAIAuthTokenResponse::is_scope_Set() const{
    return m_scope_isSet;
}

bool OAIAuthTokenResponse::is_scope_Valid() const{
    return m_scope_isValid;
}

QString OAIAuthTokenResponse::getTokenType() const {
    return m_token_type;
}
void OAIAuthTokenResponse::setTokenType(const QString &token_type) {
    m_token_type = token_type;
    m_token_type_isSet = true;
}

bool OAIAuthTokenResponse::is_token_type_Set() const{
    return m_token_type_isSet;
}

bool OAIAuthTokenResponse::is_token_type_Valid() const{
    return m_token_type_isValid;
}

bool OAIAuthTokenResponse::isSet() const {
...
bool OAIAuthTokenResponse::isValid() const {
