...
#ifndef OAIResponse4_H
#define OAIResponse4_H
...
class OAIResponse4 : public OAIObject {
public:
    OAIResponse4();
    OAIResponse4(QString json);
    ~OAIResponse4() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIResponse4)

#endif // OAIResponse4_H
