...
/*
 * OAIAuthTokenResponse.h
 *
 * 
 */

#ifndef OAIAuthTokenResponse_H
#define OAIAuthTokenResponse_H
...
class OAIAuthTokenResponse : public OAIObject {
public:
    OAIAuthTokenResponse();
    OAIAuthTokenResponse(QString json);
    ~OAIAuthTokenResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAuthTokenResponse)

#endif // OAIAuthTokenResponse_H
