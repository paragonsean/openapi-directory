...
#ifndef OAIResponse9_H
#define OAIResponse9_H
...
class OAIResponse9 : public OAIObject {
public:
    OAIResponse9();
    OAIResponse9(QString json);
    ~OAIResponse9() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIResponse9)

#endif // OAIResponse9_H
