...
#ifndef OAIResponseFour_H
#define OAIResponseFour_H
...
class OAIResponseFour : public OAIObject {
public:
    OAIResponseFour();
    OAIResponseFour(QString json);
    ~OAIResponseFour() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIResponseFour)

#endif // OAIResponseFour_H
