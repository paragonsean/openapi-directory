...
#ifndef OAIResponse1_H
#define OAIResponse1_H
...
class OAIResponse1 : public OAIObject {
public:
    OAIResponse1();
    OAIResponse1(QString json);
    ~OAIResponse1() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIResponse1)

#endif // OAIResponse1_H
