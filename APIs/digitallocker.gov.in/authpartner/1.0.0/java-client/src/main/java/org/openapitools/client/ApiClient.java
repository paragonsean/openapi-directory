...
public class ApiClient {
    ...
    private String basePath = "https://betaapi.digitallocker.gov.in/public";
    ...
    public ApiClient() {
        ...
        authentications.put("Customkey2", new ApiKeyAuth("header", "X-2"));
        authentications.put("Customkeys1", new ApiKeyAuth("header", "X1123"));
        authentications.put("bearerAuth", new HttpBearerAuth("bearer"));
        authentications.put("oauthAuthorizeCode", new OAuth());
    ...
    public ApiClient(String basePath, String clientId, String clientSecret, Map<String, String> parameters) {
        ...
        String tokenUrl = "https://betaapi.digitallocker.gov.in/public/oauth2/1/token";
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://betaapi.digitallocker.gov.in/public
