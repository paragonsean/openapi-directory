...
#ifndef OAIOrderShippment_H
#define OAIOrderShippment_H
...
class OAIOrderShippment : public OAIObject {
public:
    OAIOrderShippment();
    OAIOrderShippment(QString json);
    ~OAIOrderShippment() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIOrderShippment)

#endif // OAIOrderShippment_H
