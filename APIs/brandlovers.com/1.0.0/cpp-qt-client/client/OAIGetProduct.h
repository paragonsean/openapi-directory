...
#ifndef OAIGetProduct_H
#define OAIGetProduct_H
...
class OAIGetProduct : public OAIObject {
public:
    OAIGetProduct();
    OAIGetProduct(QString json);
    ~OAIGetProduct() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetProduct)

#endif // OAIGetProduct_H
