...
public class Error {
  ...
  public Error skuSellerId(String skuSellerId) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.message, error.message) &&
        Objects.equals(this.skuSellerId, error.skuSellerId) &&
        Objects.equals(this.type, error.type);
  }

  @Override
  public int hashCode() {
    return Objects.hash(message, skuSellerId, type);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if ((jsonObj.get("skuSellerId") != null && !jsonObj.get("skuSellerId").isJsonNull()) && !jsonObj.get("skuSellerId").isJsonPrimitive()) {
