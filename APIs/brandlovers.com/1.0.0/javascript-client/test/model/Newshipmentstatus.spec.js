...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BrandLoversMarketplaceApiV1.Newshipmentstatus();
  });
  ...
  describe('Newshipmentstatus', function() {
    it('should create an instance of Newshipmentstatus', function() {
      // uncomment below and update the code to test Newshipmentstatus
      //var instance = new BrandLoversMarketplaceApiV1.Newshipmentstatus();
      //expect(instance).to.be.a(BrandLoversMarketplaceApiV1.Newshipmentstatus);
    });
