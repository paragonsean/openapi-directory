...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BrandLoversMarketplaceApiV1.ProductPrice();
  });
  ...
  describe('ProductPrice', function() {
    it('should create an instance of ProductPrice', function() {
      ...
      //var instance = new BrandLoversMarketplaceApiV1.ProductPrice();
      //expect(instance).to.be.a(BrandLoversMarketplaceApiV1.ProductPrice);
    });
