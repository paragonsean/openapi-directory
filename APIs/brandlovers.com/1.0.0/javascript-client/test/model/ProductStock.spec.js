...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BrandLoversMarketplaceApiV1.ProductStock();
  });
  ...
  describe('ProductStock', function() {
    it('should create an instance of ProductStock', function() {
      ...
      //var instance = new BrandLoversMarketplaceApiV1.ProductStock();
      //expect(instance).to.be.a(BrandLoversMarketplaceApiV1.ProductStock);
    });
