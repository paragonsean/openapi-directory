...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BrandLoversMarketplaceApiV1.ProductAttribute();
  });
  ...
  describe('ProductAttribute', function() {
    it('should create an instance of ProductAttribute', function() {
      ...
      //var instance = new BrandLoversMarketplaceApiV1.ProductAttribute();
      //expect(instance).to.be.a(BrandLoversMarketplaceApiV1.ProductAttribute);
    });
