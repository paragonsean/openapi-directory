...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BrandLoversMarketplaceApiV1.GetOrders();
  });
  ...
  describe('GetOrders', function() {
    it('should create an instance of GetOrders', function() {
      // uncomment below and update the code to test GetOrders
      //var instance = new BrandLoversMarketplaceApiV1.GetOrders();
      //expect(instance).to.be.a(BrandLoversMarketplaceApiV1.GetOrders);
    });
