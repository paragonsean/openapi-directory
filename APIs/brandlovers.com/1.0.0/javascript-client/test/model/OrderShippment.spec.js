...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BrandLoversMarketplaceApiV1.OrderShippment();
  });
  ...
  describe('OrderShippment', function() {
    it('should create an instance of OrderShippment', function() {
      // uncomment below and update the code to test OrderShippment
      //var instance = new BrandLoversMarketplaceApiV1.OrderShippment();
      //expect(instance).to.be.a(BrandLoversMarketplaceApiV1.OrderShippment);
    });
