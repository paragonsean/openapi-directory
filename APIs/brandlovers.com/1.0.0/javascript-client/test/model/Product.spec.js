...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BrandLoversMarketplaceApiV1.Product();
  });
  ...
  describe('Product', function() {
    it('should create an instance of Product', function() {
      ...
      //var instance = new BrandLoversMarketplaceApiV1.Product();
      //expect(instance).to.be.a(BrandLoversMarketplaceApiV1.Product);
    });
