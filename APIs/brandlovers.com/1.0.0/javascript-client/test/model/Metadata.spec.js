...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BrandLoversMarketplaceApiV1.Metadata();
  });
  ...
  describe('Metadata', function() {
    it('should create an instance of Metadata', function() {
      ...
      //var instance = new BrandLoversMarketplaceApiV1.Metadata();
      //expect(instance).to.be.a(BrandLoversMarketplaceApiV1.Metadata);
    });
