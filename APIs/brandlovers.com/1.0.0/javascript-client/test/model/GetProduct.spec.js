...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BrandLoversMarketplaceApiV1.GetProduct();
  });
  ...
  describe('GetProduct', function() {
    it('should create an instance of GetProduct', function() {
      // uncomment below and update the code to test GetProduct
      //var instance = new BrandLoversMarketplaceApiV1.GetProduct();
      //expect(instance).to.be.a(BrandLoversMarketplaceApiV1.GetProduct);
    });
