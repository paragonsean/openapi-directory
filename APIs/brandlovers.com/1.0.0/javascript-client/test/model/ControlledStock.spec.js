...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BrandLoversMarketplaceApiV1.ControlledStock();
  });
  ...
  describe('ControlledStock', function() {
    it('should create an instance of ControlledStock', function() {
      // uncomment below and update the code to test ControlledStock
      //var instance = new BrandLoversMarketplaceApiV1.ControlledStock();
      //expect(instance).to.be.a(BrandLoversMarketplaceApiV1.ControlledStock);
    });
