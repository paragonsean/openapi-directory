...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BrandLoversMarketplaceApiV1.Order();
  });
  ...
  describe('Order', function() {
    it('should create an instance of Order', function() {
      ...
      //var instance = new BrandLoversMarketplaceApiV1.Order();
      //expect(instance).to.be.a(BrandLoversMarketplaceApiV1.Order);
    });
    ...
    it('should have the property orderMarketplaceId (base name: "orderMarketplaceId")', function() {
      // uncomment below and update the code to test the property orderMarketplaceId
      //var instance = new BrandLoversMarketplaceApiV1.Order();
      //expect(instance).to.be();
    });
    ...
    it('should have the property totalDiscountAmount (base name: "totalDiscountAmount")', function() {
      // uncomment below and update the code to test the property totalDiscountAmount
      //var instance = new BrandLoversMarketplaceApiV1.Order();
      //expect(instance).to.be();
    });

    it('should have the property totalItemsAmount (base name: "totalItemsAmount")', function() {
      // uncomment below and update the code to test the property totalItemsAmount
      //var instance = new BrandLoversMarketplaceApiV1.Order();
      //expect(instance).to.be();
    });

    it('should have the property totalShippingAmount (base name: "totalShippingAmount")', function() {
      // uncomment below and update the code to test the property totalShippingAmount
      //var instance = new BrandLoversMarketplaceApiV1.Order();
      //expect(instance).to.be();
    });
