# BrandLoversMarketplaceApiV1.NewTrackingRefund
...
**items** | [**[OrderItemReference]**](OrderItemReference.md) |  | 
**number** | **String** | Tracking Id in the courier | [optional] 
**occurredAt** | **Date** | Date time that this was created | [optional] 
**sellerShipmentId** | **String** | Unique Seller shipment Id. This must be unique across all orders and shipments | [optional] 
**tranckingUrl** | **String** | Courier tracking URL | [optional] 
