# BrandLoversMarketplaceApiV1.Shippment
...
**items** | [**[OrderItemReference]**](OrderItemReference.md) | List of items of this shippment | 
**number** | **String** | Courier unique trackign Id associated with this shipment | [optional] 
**occurredAt** | **Date** | Date time when this shippment happened | 
