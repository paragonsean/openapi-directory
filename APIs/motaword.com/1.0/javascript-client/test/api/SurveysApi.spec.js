...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MotaWordApi.SurveysApi();
  });
  ...
  describe('SurveysApi', function() {
    ...
    describe('submitAnswers', function() {
      it('should call submitAnswers successfully', function(done) {
        //uncomment below and update the code to test submitAnswers
        //instance.submitAnswers(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
