...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MotaWordApi.PaymentInfo();
  });
  ...
  describe('PaymentInfo', function() {
    it('should create an instance of PaymentInfo', function() {
      ...
      //var instance = new MotaWordApi.PaymentInfo();
      //expect(instance).to.be.a(MotaWordApi.PaymentInfo);
    });
    ...
    it('should have the property sharedCard (base name: "shared_card")', function() {
      // uncomment below and update the code to test the property sharedCard
      //var instance = new MotaWordApi.PaymentInfo();
      //expect(instance).to.be();
    });
