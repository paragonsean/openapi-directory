...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MotaWordApi.ClientProfileNps();
  });
  ...
  describe('ClientProfileNps', function() {
    it('should create an instance of ClientProfileNps', function() {
      // uncomment below and update the code to test ClientProfileNps
      //var instance = new MotaWordApi.ClientProfileNps();
      //expect(instance).to.be.a(MotaWordApi.ClientProfileNps);
    });
