...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MotaWordApi.ReportContent();
  });
  ...
  describe('ReportContent', function() {
    it('should create an instance of ReportContent', function() {
      // uncomment below and update the code to test ReportContent
      //var instance = new MotaWordApi.ReportContent();
      //expect(instance).to.be.a(MotaWordApi.ReportContent);
    });
