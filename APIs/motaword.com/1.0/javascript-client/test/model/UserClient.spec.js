...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MotaWordApi.UserClient();
  });
  ...
  describe('UserClient', function() {
    it('should create an instance of UserClient', function() {
      // uncomment below and update the code to test UserClient
      //var instance = new MotaWordApi.UserClient();
      //expect(instance).to.be.a(MotaWordApi.UserClient);
    });
