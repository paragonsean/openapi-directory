...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MotaWordApi.TokenError();
  });
  ...
  describe('TokenError', function() {
    it('should create an instance of TokenError', function() {
      // uncomment below and update the code to test TokenError
      //var instance = new MotaWordApi.TokenError();
      //expect(instance).to.be.a(MotaWordApi.TokenError);
    });
