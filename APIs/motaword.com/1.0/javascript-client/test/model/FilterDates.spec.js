...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MotaWordApi.FilterDates();
  });
  ...
  describe('FilterDates', function() {
    it('should create an instance of FilterDates', function() {
      // uncomment below and update the code to test FilterDates
      //var instance = new MotaWordApi.FilterDates();
      //expect(instance).to.be.a(MotaWordApi.FilterDates);
    });
