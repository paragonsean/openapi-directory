...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MotaWordApi.PagingMetaPaging();
  });
  ...
  describe('PagingMetaPaging', function() {
    it('should create an instance of PagingMetaPaging', function() {
      // uncomment below and update the code to test PagingMetaPaging
      //var instance = new MotaWordApi.PagingMetaPaging();
      //expect(instance).to.be.a(MotaWordApi.PagingMetaPaging);
    });
