...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MotaWordApi.StyleGuide();
  });
  ...
  describe('StyleGuide', function() {
    it('should create an instance of StyleGuide', function() {
      // uncomment below and update the code to test StyleGuide
      //var instance = new MotaWordApi.StyleGuide();
      //expect(instance).to.be.a(MotaWordApi.StyleGuide);
    });
