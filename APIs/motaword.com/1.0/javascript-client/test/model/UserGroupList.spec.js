...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MotaWordApi.UserGroupList();
  });
  ...
  describe('UserGroupList', function() {
    it('should create an instance of UserGroupList', function() {
      // uncomment below and update the code to test UserGroupList
      //var instance = new MotaWordApi.UserGroupList();
      //expect(instance).to.be.a(MotaWordApi.UserGroupList);
    });
