...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MotaWordApi.InstantTranslationRequest();
  });
  ...
  describe('InstantTranslationRequest', function() {
    it('should create an instance of InstantTranslationRequest', function() {
      // uncomment below and update the code to test InstantTranslationRequest
      //var instance = new MotaWordApi.InstantTranslationRequest();
      //expect(instance).to.be.a(MotaWordApi.InstantTranslationRequest);
    });
