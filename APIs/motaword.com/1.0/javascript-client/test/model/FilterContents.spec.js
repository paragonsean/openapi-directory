...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MotaWordApi.FilterContents();
  });
  ...
  describe('FilterContents', function() {
    it('should create an instance of FilterContents', function() {
      // uncomment below and update the code to test FilterContents
      //var instance = new MotaWordApi.FilterContents();
      //expect(instance).to.be.a(MotaWordApi.FilterContents);
    });
