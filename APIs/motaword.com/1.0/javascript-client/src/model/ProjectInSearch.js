...
/**
 * The ProjectInSearch model module.
 * @module model/ProjectInSearch
 * @version 1.0
 */
class ProjectInSearch {
    /**
     * Constructs a new <code>ProjectInSearch</code>.
     * @alias module:model/ProjectInSearch
     * @implements module:model/Project
     */
    constructor() { 
        Project.initialize(this);
        ProjectInSearch.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ProjectInSearch</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ProjectInSearch} obj Optional instance to populate.
     * @return {module:model/ProjectInSearch} The populated <code>ProjectInSearch</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ProjectInSearch();
    ...
    /**
     * Validates the JSON data with respect to <code>ProjectInSearch</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ProjectInSearch</code>.
     */
 ...
 */
ProjectInSearch.prototype['average_scores'] = undefined;

/**
 * @member {String} budget_code
 */
ProjectInSearch.prototype['budget_code'] = undefined;

/**
 * Callback URL to notify when project status changed.
 * @member {String} callback_url
 */
ProjectInSearch.prototype['callback_url'] = undefined;

/**
 * @member {Boolean} can_pam_manage
 */
ProjectInSearch.prototype['can_pam_manage'] = undefined;

/**
 * @member {module:model/User} client
 */
ProjectInSearch.prototype['client'] = undefined;

/**
 * Assigned admin's id
 * @member {Number} cm_id
 */
ProjectInSearch.prototype['cm_id'] = undefined;

/**
 * the date-time notation as defined by RFC 3339, section 5.6, for example, 2017-07-21T17:32:28Z
 * @member {Date} completed_on
 */
ProjectInSearch.prototype['completed_on'] = undefined;

/**
 * @member {String} continuous_project_type
 */
ProjectInSearch.prototype['continuous_project_type'] = undefined;

/**
 * Unix epoch time
 * @member {Number} created_at
 */
ProjectInSearch.prototype['created_at'] = undefined;

/**
 * Custom data provided while creating a new project.
 * @member {Object} custom
 */
ProjectInSearch.prototype['custom'] = undefined;

/**
 * Unix epoch time
 * @member {Number} delivery_at
 */
ProjectInSearch.prototype['delivery_at'] = undefined;
 ...
 */
ProjectInSearch.prototype['errors'] = undefined;

/**
 * @member {Number} id
 */
ProjectInSearch.prototype['id'] = undefined;

/**
 * @member {Boolean} is_api_project
 */
ProjectInSearch.prototype['is_api_project'] = undefined;

/**
 * @member {Boolean} is_certified
 */
ProjectInSearch.prototype['is_certified'] = undefined;

/**
 * @member {Boolean} is_continuous
 */
ProjectInSearch.prototype['is_continuous'] = undefined;

/**
 * @member {Boolean} is_manual
 */
ProjectInSearch.prototype['is_manual'] = undefined;

/**
 * @member {module:model/ProjectLinks} links
 */
ProjectInSearch.prototype['links'] = undefined;
 ...
 */
ProjectInSearch.prototype['pairs'] = undefined;

/**
 * Quote IDs of pivots
 * @member {Array.<Number>} pivoted_projects
 */
ProjectInSearch.prototype['pivoted_projects'] = undefined;

/**
 * @member {module:model/ProjectPrice} price
 */
ProjectInSearch.prototype['price'] = undefined;

/**
 * @member {module:model/ProjectPrice} price_without_discount
 */
ProjectInSearch.prototype['price_without_discount'] = undefined;

/**
 * @member {module:model/VendorProjectRole} role
 */
ProjectInSearch.prototype['role'] = undefined;

/**
 * @member {Boolean} should_send_client_survey
 */
ProjectInSearch.prototype['should_send_client_survey'] = undefined;

/**
 * @member {module:model/ProjectSource} source
 */
ProjectInSearch.prototype['source'] = undefined;

/**
 * @member {String} source_language
 */
ProjectInSearch.prototype['source_language'] = undefined;

/**
 * @member {module:model/ProjectStatus} status
 */
ProjectInSearch.prototype['status'] = undefined;

/**
 * @member {Array.<String>} subjects
 */
ProjectInSearch.prototype['subjects'] = undefined;

/**
 * @member {Array.<String>} target_languages
 */
ProjectInSearch.prototype['target_languages'] = undefined;

/**
 * TMS project name for this MW project. Requires privileged scope.
 * @member {String} tms_name
 */
ProjectInSearch.prototype['tms_name'] = undefined;

/**
 * Unix epoch time. Available only if status is `pending`.
 * @member {Number} valid_until
 */
ProjectInSearch.prototype['valid_until'] = undefined;

/**
 * @member {Number} vendor_word_count
 */
ProjectInSearch.prototype['vendor_word_count'] = undefined;

/**
 * @member {Number} word_count
 */
ProjectInSearch.prototype['word_count'] = undefined;

/**
 * @member {module:model/ProjectWordCountAnalysis} word_count_analysis
 */
ProjectInSearch.prototype['word_count_analysis'] = undefined;

/**
 * @member {String} search_result_reason
 */
ProjectInSearch.prototype['search_result_reason'] = undefined;
...
export default ProjectInSearch;
