# MotaWordApi.DocumentUploadRequest

## Properties

Name | Type | Description | Notes
------------ | ------------- | ------------- | -------------
**documents** | **File** | Single file data. The name is plural to provide a consistent naming convention. | [optional] 
...
**sourceLink** | [**LinkedSourceDocument**](LinkedSourceDocument.md) |  | [optional] 
