...
public class AuthApi {
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        ...
        <tr><td> 0 </td><td> Authentication error - for vendor auth, it will also fail if their account is not approved yet. In that case, the error response will include \&quot;account_status\&quot; key. </td><td>  -  </td></tr>
     </table>
     */
     ...
     */
    public Token getAccessToken(TokenRequest tokenRequest) throws ApiException {
        ApiResponse<Token> localVarResp = getAccessTokenWithHttpInfo(tokenRequest);
     ...
     */
    public ApiResponse<Token> getAccessTokenWithHttpInfo(TokenRequest tokenRequest) throws ApiException {
     ...
     */
    public okhttp3.Call getAccessTokenAsync(TokenRequest tokenRequest, final ApiCallback<Token> _callback) throws ApiException {
