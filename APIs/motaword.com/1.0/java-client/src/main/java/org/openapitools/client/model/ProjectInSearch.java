...
public class ProjectInSearch {
  ...
  public ProjectInSearch averageScores(Map<String, Float> averageScores) {
    this.averageScores = averageScores;
    return this;
  }

  public ProjectInSearch putAverageScoresItem(String key, Float averageScoresItem) {
  ...
  public ProjectInSearch budgetCode(String budgetCode) {
  ...
  public ProjectInSearch callbackUrl(String callbackUrl) {
  ...
  public ProjectInSearch canPamManage(Boolean canPamManage) {
  ...
  public ProjectInSearch client(User client) {
    this.client = client;
    return this;
  }
  ...
  public ProjectInSearch cmId(Long cmId) {
    this.cmId = cmId;
    return this;
  }
  ...
  public ProjectInSearch completedOn(OffsetDateTime completedOn) {
  ...
  public ProjectInSearch continuousProjectType(String continuousProjectType) {
  ...
  public ProjectInSearch createdAt(Long createdAt) {
  ...
  public ProjectInSearch custom(Object custom) {
    this.custom = custom;
    return this;
  }
  ...
  public ProjectInSearch deliveryAt(Long deliveryAt) {
  ...
  public ProjectInSearch errors(List<Error> errors) {
    this.errors = errors;
    return this;
  }

  public ProjectInSearch addErrorsItem(Error errorsItem) {
    if (this.errors == null) {
  ...
  public ProjectInSearch id(Long id) {
    this.id = id;
    return this;
  }
  ...
  public ProjectInSearch isApiProject(Boolean isApiProject) {
  ...
  public ProjectInSearch isCertified(Boolean isCertified) {
  ...
  public ProjectInSearch isContinuous(Boolean isContinuous) {
  ...
  public ProjectInSearch isManual(Boolean isManual) {
  ...
  public ProjectInSearch links(ProjectLinks links) {
    this.links = links;
    return this;
  }
  ...
  public ProjectInSearch pairs(List<VendorProjectPair> pairs) {
    this.pairs = pairs;
    return this;
  }

  public ProjectInSearch addPairsItem(VendorProjectPair pairsItem) {
    if (this.pairs == null) {
  ...
  public ProjectInSearch pivotedProjects(List<Long> pivotedProjects) {
    this.pivotedProjects = pivotedProjects;
    return this;
  }

  public ProjectInSearch addPivotedProjectsItem(Long pivotedProjectsItem) {
  ...
  public ProjectInSearch price(ProjectPrice price) {
    this.price = price;
    return this;
  }
  ...
  public ProjectInSearch priceWithoutDiscount(ProjectPrice priceWithoutDiscount) {
  ...
  public ProjectInSearch role(VendorProjectRole role) {
    this.role = role;
    return this;
  }
  ...
  public ProjectInSearch shouldSendClientSurvey(Boolean shouldSendClientSurvey) {
  ...
  public ProjectInSearch source(ProjectSource source) {
    this.source = source;
    return this;
  }
  ...
  public ProjectInSearch sourceLanguage(String sourceLanguage) {
  ...
  public ProjectInSearch status(ProjectStatus status) {
    this.status = status;
    return this;
  }
  ...
  public ProjectInSearch subjects(List<String> subjects) {
    this.subjects = subjects;
    return this;
  }

  public ProjectInSearch addSubjectsItem(String subjectsItem) {
  ...
  public ProjectInSearch targetLanguages(List<String> targetLanguages) {
    this.targetLanguages = targetLanguages;
    return this;
  }

  public ProjectInSearch addTargetLanguagesItem(String targetLanguagesItem) {
  ...
  public ProjectInSearch tmsName(String tmsName) {
  ...
  public ProjectInSearch validUntil(Long validUntil) {
  ...
  public ProjectInSearch vendorWordCount(Long vendorWordCount) {
  ...
  public ProjectInSearch wordCount(Long wordCount) {
  ...
  public ProjectInSearch wordCountAnalysis(ProjectWordCountAnalysis wordCountAnalysis) {
  ...
  public ProjectInSearch searchResultReason(String searchResultReason) {
  ...
  public boolean equals(Object o) {
    ...
    ProjectInSearch projectInSearch = (ProjectInSearch) o;
    return Objects.equals(this.averageScores, projectInSearch.averageScores) &&
        Objects.equals(this.budgetCode, projectInSearch.budgetCode) &&
        Objects.equals(this.callbackUrl, projectInSearch.callbackUrl) &&
        Objects.equals(this.canPamManage, projectInSearch.canPamManage) &&
        Objects.equals(this.client, projectInSearch.client) &&
        Objects.equals(this.cmId, projectInSearch.cmId) &&
        Objects.equals(this.completedOn, projectInSearch.completedOn) &&
        Objects.equals(this.continuousProjectType, projectInSearch.continuousProjectType) &&
        Objects.equals(this.createdAt, projectInSearch.createdAt) &&
        Objects.equals(this.custom, projectInSearch.custom) &&
        Objects.equals(this.deliveryAt, projectInSearch.deliveryAt) &&
        Objects.equals(this.errors, projectInSearch.errors) &&
        Objects.equals(this.id, projectInSearch.id) &&
        Objects.equals(this.isApiProject, projectInSearch.isApiProject) &&
        Objects.equals(this.isCertified, projectInSearch.isCertified) &&
        Objects.equals(this.isContinuous, projectInSearch.isContinuous) &&
        Objects.equals(this.isManual, projectInSearch.isManual) &&
        Objects.equals(this.links, projectInSearch.links) &&
        Objects.equals(this.pairs, projectInSearch.pairs) &&
        Objects.equals(this.pivotedProjects, projectInSearch.pivotedProjects) &&
        Objects.equals(this.price, projectInSearch.price) &&
        Objects.equals(this.priceWithoutDiscount, projectInSearch.priceWithoutDiscount) &&
        Objects.equals(this.role, projectInSearch.role) &&
        Objects.equals(this.shouldSendClientSurvey, projectInSearch.shouldSendClientSurvey) &&
        Objects.equals(this.source, projectInSearch.source) &&
        Objects.equals(this.sourceLanguage, projectInSearch.sourceLanguage) &&
        Objects.equals(this.status, projectInSearch.status) &&
        Objects.equals(this.subjects, projectInSearch.subjects) &&
        Objects.equals(this.targetLanguages, projectInSearch.targetLanguages) &&
        Objects.equals(this.tmsName, projectInSearch.tmsName) &&
        Objects.equals(this.validUntil, projectInSearch.validUntil) &&
        Objects.equals(this.vendorWordCount, projectInSearch.vendorWordCount) &&
        Objects.equals(this.wordCount, projectInSearch.wordCount) &&
        Objects.equals(this.wordCountAnalysis, projectInSearch.wordCountAnalysis) &&
        Objects.equals(this.searchResultReason, projectInSearch.searchResultReason);
  }

  @Override
  public int hashCode() {
    return Objects.hash(averageScores, budgetCode, callbackUrl, canPamManage, client, cmId, completedOn, continuousProjectType, createdAt, custom, deliveryAt, errors, id, isApiProject, isCertified, isContinuous, isManual, links, pairs, pivotedProjects, price, priceWithoutDiscount, role, shouldSendClientSurvey, source, sourceLanguage, status, subjects, targetLanguages, tmsName, validUntil, vendorWordCount, wordCount, wordCountAnalysis, searchResultReason);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ProjectInSearch {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ProjectInSearch
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ProjectInSearch.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ProjectInSearch is not found in the empty JSON string", ProjectInSearch.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ProjectInSearch.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ProjectInSearch` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ProjectInSearch.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ProjectInSearch' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ProjectInSearch> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ProjectInSearch.class));

       return (TypeAdapter<T>) new TypeAdapter<ProjectInSearch>() {
           @Override
           public void write(JsonWriter out, ProjectInSearch value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ProjectInSearch read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ProjectInSearch given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ProjectInSearch
   * @throws IOException if the JSON string is invalid with respect to ProjectInSearch
   */
  public static ProjectInSearch fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ProjectInSearch.class);
  }

  /**
   * Convert an instance of ProjectInSearch to an JSON string
   *
   * @return JSON string
   */
