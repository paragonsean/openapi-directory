...
import org.openapitools.client.model.OperationStatusEnum;
...
public class OperationStatus {
  ...
  private OperationStatusEnum status = OperationStatusEnum.SUCCESS;

  public OperationStatus() {
  }

  public OperationStatus status(OperationStatusEnum status) {
    this.status = status;
    return this;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("status") != null && !jsonObj.get("status").isJsonNull()) {
        OperationStatusEnum.validateJsonElement(jsonObj.get("status"));
      }
  }
