...
OAIProjectInSearch::OAIProjectInSearch(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIProjectInSearch::OAIProjectInSearch() {
    this->initializeModel();
}

OAIProjectInSearch::~OAIProjectInSearch() {}

void OAIProjectInSearch::initializeModel() {
...
void OAIProjectInSearch::fromJson(QString jsonString) {
...
void OAIProjectInSearch::fromJsonObject(QJsonObject json) {
...
QString OAIProjectInSearch::asJson() const {
...
QJsonObject OAIProjectInSearch::asJsonObject() const {
    QJsonObject obj;
...
QMap<QString, float> OAIProjectInSearch::getAverageScores() const {
    return m_average_scores;
}
void OAIProjectInSearch::setAverageScores(const QMap<QString, float> &average_scores) {
    m_average_scores = average_scores;
    m_average_scores_isSet = true;
}

bool OAIProjectInSearch::is_average_scores_Set() const{
    return m_average_scores_isSet;
}

bool OAIProjectInSearch::is_average_scores_Valid() const{
    return m_average_scores_isValid;
}

QString OAIProjectInSearch::getBudgetCode() const {
    return m_budget_code;
}
void OAIProjectInSearch::setBudgetCode(const QString &budget_code) {
    m_budget_code = budget_code;
    m_budget_code_isSet = true;
}

bool OAIProjectInSearch::is_budget_code_Set() const{
    return m_budget_code_isSet;
}

bool OAIProjectInSearch::is_budget_code_Valid() const{
    return m_budget_code_isValid;
}

QString OAIProjectInSearch::getCallbackUrl() const {
    return m_callback_url;
}
void OAIProjectInSearch::setCallbackUrl(const QString &callback_url) {
    m_callback_url = callback_url;
    m_callback_url_isSet = true;
}

bool OAIProjectInSearch::is_callback_url_Set() const{
    return m_callback_url_isSet;
}

bool OAIProjectInSearch::is_callback_url_Valid() const{
    return m_callback_url_isValid;
}

bool OAIProjectInSearch::isCanPamManage() const {
    return m_can_pam_manage;
}
void OAIProjectInSearch::setCanPamManage(const bool &can_pam_manage) {
    m_can_pam_manage = can_pam_manage;
    m_can_pam_manage_isSet = true;
}

bool OAIProjectInSearch::is_can_pam_manage_Set() const{
    return m_can_pam_manage_isSet;
}

bool OAIProjectInSearch::is_can_pam_manage_Valid() const{
    return m_can_pam_manage_isValid;
}

OAIUser OAIProjectInSearch::getClient() const {
    return m_client;
}
void OAIProjectInSearch::setClient(const OAIUser &client) {
    m_client = client;
    m_client_isSet = true;
}

bool OAIProjectInSearch::is_client_Set() const{
    return m_client_isSet;
}

bool OAIProjectInSearch::is_client_Valid() const{
    return m_client_isValid;
}

qint64 OAIProjectInSearch::getCmId() const {
    return m_cm_id;
}
void OAIProjectInSearch::setCmId(const qint64 &cm_id) {
    m_cm_id = cm_id;
    m_cm_id_isSet = true;
}

bool OAIProjectInSearch::is_cm_id_Set() const{
    return m_cm_id_isSet;
}

bool OAIProjectInSearch::is_cm_id_Valid() const{
    return m_cm_id_isValid;
}

QDateTime OAIProjectInSearch::getCompletedOn() const {
    return m_completed_on;
}
void OAIProjectInSearch::setCompletedOn(const QDateTime &completed_on) {
    m_completed_on = completed_on;
    m_completed_on_isSet = true;
}

bool OAIProjectInSearch::is_completed_on_Set() const{
    return m_completed_on_isSet;
}

bool OAIProjectInSearch::is_completed_on_Valid() const{
    return m_completed_on_isValid;
}

QString OAIProjectInSearch::getContinuousProjectType() const {
    return m_continuous_project_type;
}
void OAIProjectInSearch::setContinuousProjectType(const QString &continuous_project_type) {
    m_continuous_project_type = continuous_project_type;
    m_continuous_project_type_isSet = true;
}

bool OAIProjectInSearch::is_continuous_project_type_Set() const{
    return m_continuous_project_type_isSet;
}

bool OAIProjectInSearch::is_continuous_project_type_Valid() const{
    return m_continuous_project_type_isValid;
}

qint64 OAIProjectInSearch::getCreatedAt() const {
    return m_created_at;
}
void OAIProjectInSearch::setCreatedAt(const qint64 &created_at) {
    m_created_at = created_at;
    m_created_at_isSet = true;
}

bool OAIProjectInSearch::is_created_at_Set() const{
    return m_created_at_isSet;
}

bool OAIProjectInSearch::is_created_at_Valid() const{
    return m_created_at_isValid;
}

OAIObject OAIProjectInSearch::getCustom() const {
    return m_custom;
}
void OAIProjectInSearch::setCustom(const OAIObject &custom) {
    m_custom = custom;
    m_custom_isSet = true;
}

bool OAIProjectInSearch::is_custom_Set() const{
    return m_custom_isSet;
}

bool OAIProjectInSearch::is_custom_Valid() const{
    return m_custom_isValid;
}

qint64 OAIProjectInSearch::getDeliveryAt() const {
    return m_delivery_at;
}
void OAIProjectInSearch::setDeliveryAt(const qint64 &delivery_at) {
    m_delivery_at = delivery_at;
    m_delivery_at_isSet = true;
}

bool OAIProjectInSearch::is_delivery_at_Set() const{
    return m_delivery_at_isSet;
}

bool OAIProjectInSearch::is_delivery_at_Valid() const{
    return m_delivery_at_isValid;
}

QList<OAIError> OAIProjectInSearch::getErrors() const {
    return m_errors;
}
void OAIProjectInSearch::setErrors(const QList<OAIError> &errors) {
    m_errors = errors;
    m_errors_isSet = true;
}

bool OAIProjectInSearch::is_errors_Set() const{
    return m_errors_isSet;
}

bool OAIProjectInSearch::is_errors_Valid() const{
    return m_errors_isValid;
}

qint64 OAIProjectInSearch::getId() const {
    return m_id;
}
void OAIProjectInSearch::setId(const qint64 &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIProjectInSearch::is_id_Set() const{
    return m_id_isSet;
}

bool OAIProjectInSearch::is_id_Valid() const{
    return m_id_isValid;
}

bool OAIProjectInSearch::isIsApiProject() const {
    return m_is_api_project;
}
void OAIProjectInSearch::setIsApiProject(const bool &is_api_project) {
    m_is_api_project = is_api_project;
    m_is_api_project_isSet = true;
}

bool OAIProjectInSearch::is_is_api_project_Set() const{
    return m_is_api_project_isSet;
}

bool OAIProjectInSearch::is_is_api_project_Valid() const{
    return m_is_api_project_isValid;
}

bool OAIProjectInSearch::isIsCertified() const {
    return m_is_certified;
}
void OAIProjectInSearch::setIsCertified(const bool &is_certified) {
    m_is_certified = is_certified;
    m_is_certified_isSet = true;
}

bool OAIProjectInSearch::is_is_certified_Set() const{
    return m_is_certified_isSet;
}

bool OAIProjectInSearch::is_is_certified_Valid() const{
    return m_is_certified_isValid;
}

bool OAIProjectInSearch::isIsContinuous() const {
    return m_is_continuous;
}
void OAIProjectInSearch::setIsContinuous(const bool &is_continuous) {
    m_is_continuous = is_continuous;
    m_is_continuous_isSet = true;
}

bool OAIProjectInSearch::is_is_continuous_Set() const{
    return m_is_continuous_isSet;
}

bool OAIProjectInSearch::is_is_continuous_Valid() const{
    return m_is_continuous_isValid;
}

bool OAIProjectInSearch::isIsManual() const {
    return m_is_manual;
}
void OAIProjectInSearch::setIsManual(const bool &is_manual) {
    m_is_manual = is_manual;
    m_is_manual_isSet = true;
}

bool OAIProjectInSearch::is_is_manual_Set() const{
    return m_is_manual_isSet;
}

bool OAIProjectInSearch::is_is_manual_Valid() const{
    return m_is_manual_isValid;
}

OAIProjectLinks OAIProjectInSearch::getLinks() const {
    return m_links;
}
void OAIProjectInSearch::setLinks(const OAIProjectLinks &links) {
    m_links = links;
    m_links_isSet = true;
}

bool OAIProjectInSearch::is_links_Set() const{
    return m_links_isSet;
}

bool OAIProjectInSearch::is_links_Valid() const{
    return m_links_isValid;
}

QList<OAIVendorProjectPair> OAIProjectInSearch::getPairs() const {
    return m_pairs;
}
void OAIProjectInSearch::setPairs(const QList<OAIVendorProjectPair> &pairs) {
    m_pairs = pairs;
    m_pairs_isSet = true;
}

bool OAIProjectInSearch::is_pairs_Set() const{
    return m_pairs_isSet;
}

bool OAIProjectInSearch::is_pairs_Valid() const{
    return m_pairs_isValid;
}

QList<qint64> OAIProjectInSearch::getPivotedProjects() const {
    return m_pivoted_projects;
}
void OAIProjectInSearch::setPivotedProjects(const QList<qint64> &pivoted_projects) {
    m_pivoted_projects = pivoted_projects;
    m_pivoted_projects_isSet = true;
}

bool OAIProjectInSearch::is_pivoted_projects_Set() const{
    return m_pivoted_projects_isSet;
}

bool OAIProjectInSearch::is_pivoted_projects_Valid() const{
    return m_pivoted_projects_isValid;
}

OAIProject_price OAIProjectInSearch::getPrice() const {
    return m_price;
}
void OAIProjectInSearch::setPrice(const OAIProject_price &price) {
    m_price = price;
    m_price_isSet = true;
}

bool OAIProjectInSearch::is_price_Set() const{
    return m_price_isSet;
}

bool OAIProjectInSearch::is_price_Valid() const{
    return m_price_isValid;
}

OAIProject_price OAIProjectInSearch::getPriceWithoutDiscount() const {
    return m_price_without_discount;
}
void OAIProjectInSearch::setPriceWithoutDiscount(const OAIProject_price &price_without_discount) {
    m_price_without_discount = price_without_discount;
    m_price_without_discount_isSet = true;
}

bool OAIProjectInSearch::is_price_without_discount_Set() const{
    return m_price_without_discount_isSet;
}

bool OAIProjectInSearch::is_price_without_discount_Valid() const{
    return m_price_without_discount_isValid;
}

OAIVendorProjectRole OAIProjectInSearch::getRole() const {
    return m_role;
}
void OAIProjectInSearch::setRole(const OAIVendorProjectRole &role) {
    m_role = role;
    m_role_isSet = true;
}

bool OAIProjectInSearch::is_role_Set() const{
    return m_role_isSet;
}

bool OAIProjectInSearch::is_role_Valid() const{
    return m_role_isValid;
}

bool OAIProjectInSearch::isShouldSendClientSurvey() const {
    return m_should_send_client_survey;
}
void OAIProjectInSearch::setShouldSendClientSurvey(const bool &should_send_client_survey) {
    m_should_send_client_survey = should_send_client_survey;
    m_should_send_client_survey_isSet = true;
}

bool OAIProjectInSearch::is_should_send_client_survey_Set() const{
    return m_should_send_client_survey_isSet;
}

bool OAIProjectInSearch::is_should_send_client_survey_Valid() const{
    return m_should_send_client_survey_isValid;
}

OAIProjectSource OAIProjectInSearch::getSource() const {
    return m_source;
}
void OAIProjectInSearch::setSource(const OAIProjectSource &source) {
    m_source = source;
    m_source_isSet = true;
}

bool OAIProjectInSearch::is_source_Set() const{
    return m_source_isSet;
}

bool OAIProjectInSearch::is_source_Valid() const{
    return m_source_isValid;
}

QString OAIProjectInSearch::getSourceLanguage() const {
    return m_source_language;
}
void OAIProjectInSearch::setSourceLanguage(const QString &source_language) {
    m_source_language = source_language;
    m_source_language_isSet = true;
}

bool OAIProjectInSearch::is_source_language_Set() const{
    return m_source_language_isSet;
}

bool OAIProjectInSearch::is_source_language_Valid() const{
    return m_source_language_isValid;
}

OAIProjectStatus OAIProjectInSearch::getStatus() const {
    return m_status;
}
void OAIProjectInSearch::setStatus(const OAIProjectStatus &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIProjectInSearch::is_status_Set() const{
    return m_status_isSet;
}

bool OAIProjectInSearch::is_status_Valid() const{
    return m_status_isValid;
}

QList<QString> OAIProjectInSearch::getSubjects() const {
    return m_subjects;
}
void OAIProjectInSearch::setSubjects(const QList<QString> &subjects) {
    m_subjects = subjects;
    m_subjects_isSet = true;
}

bool OAIProjectInSearch::is_subjects_Set() const{
    return m_subjects_isSet;
}

bool OAIProjectInSearch::is_subjects_Valid() const{
    return m_subjects_isValid;
}

QList<QString> OAIProjectInSearch::getTargetLanguages() const {
    return m_target_languages;
}
void OAIProjectInSearch::setTargetLanguages(const QList<QString> &target_languages) {
    m_target_languages = target_languages;
    m_target_languages_isSet = true;
}

bool OAIProjectInSearch::is_target_languages_Set() const{
    return m_target_languages_isSet;
}

bool OAIProjectInSearch::is_target_languages_Valid() const{
    return m_target_languages_isValid;
}

QString OAIProjectInSearch::getTmsName() const {
    return m_tms_name;
}
void OAIProjectInSearch::setTmsName(const QString &tms_name) {
    m_tms_name = tms_name;
    m_tms_name_isSet = true;
}

bool OAIProjectInSearch::is_tms_name_Set() const{
    return m_tms_name_isSet;
}

bool OAIProjectInSearch::is_tms_name_Valid() const{
    return m_tms_name_isValid;
}

qint64 OAIProjectInSearch::getValidUntil() const {
    return m_valid_until;
}
void OAIProjectInSearch::setValidUntil(const qint64 &valid_until) {
    m_valid_until = valid_until;
    m_valid_until_isSet = true;
}

bool OAIProjectInSearch::is_valid_until_Set() const{
    return m_valid_until_isSet;
}

bool OAIProjectInSearch::is_valid_until_Valid() const{
    return m_valid_until_isValid;
}

qint64 OAIProjectInSearch::getVendorWordCount() const {
    return m_vendor_word_count;
}
void OAIProjectInSearch::setVendorWordCount(const qint64 &vendor_word_count) {
    m_vendor_word_count = vendor_word_count;
    m_vendor_word_count_isSet = true;
}

bool OAIProjectInSearch::is_vendor_word_count_Set() const{
    return m_vendor_word_count_isSet;
}

bool OAIProjectInSearch::is_vendor_word_count_Valid() const{
    return m_vendor_word_count_isValid;
}

qint64 OAIProjectInSearch::getWordCount() const {
    return m_word_count;
}
void OAIProjectInSearch::setWordCount(const qint64 &word_count) {
    m_word_count = word_count;
    m_word_count_isSet = true;
}

bool OAIProjectInSearch::is_word_count_Set() const{
    return m_word_count_isSet;
}

bool OAIProjectInSearch::is_word_count_Valid() const{
    return m_word_count_isValid;
}

OAIProject_word_count_analysis OAIProjectInSearch::getWordCountAnalysis() const {
    return m_word_count_analysis;
}
void OAIProjectInSearch::setWordCountAnalysis(const OAIProject_word_count_analysis &word_count_analysis) {
    m_word_count_analysis = word_count_analysis;
    m_word_count_analysis_isSet = true;
}

bool OAIProjectInSearch::is_word_count_analysis_Set() const{
    return m_word_count_analysis_isSet;
}

bool OAIProjectInSearch::is_word_count_analysis_Valid() const{
    return m_word_count_analysis_isValid;
}

QString OAIProjectInSearch::getSearchResultReason() const {
    return m_search_result_reason;
}
void OAIProjectInSearch::setSearchResultReason(const QString &search_result_reason) {
    m_search_result_reason = search_result_reason;
    m_search_result_reason_isSet = true;
}

bool OAIProjectInSearch::is_search_result_reason_Set() const{
    return m_search_result_reason_isSet;
}

bool OAIProjectInSearch::is_search_result_reason_Valid() const{
    return m_search_result_reason_isValid;
}

bool OAIProjectInSearch::isSet() const {
...
bool OAIProjectInSearch::isValid() const {
