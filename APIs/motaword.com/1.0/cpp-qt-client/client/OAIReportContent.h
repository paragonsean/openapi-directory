...
#ifndef OAIReportContent_H
#define OAIReportContent_H
...
class OAIReportContent : public OAIObject {
public:
    OAIReportContent();
    OAIReportContent(QString json);
    ~OAIReportContent() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIReportContent)

#endif // OAIReportContent_H
