...
void OAISearchApi::initializeServerConfigs() {
    ...
    "No description provided",
    QMap<QString, OAIServerVariable>()));
    _serverConfigs.insert("checkDocumentsReindex", defaultConf);
    _serverIndices.insert("checkDocumentsReindex", 0);
    _serverConfigs.insert("reindexDocuments", defaultConf);
    _serverIndices.insert("reindexDocuments", 0);
    _serverConfigs.insert("searchEverywhere", defaultConf);
    _serverIndices.insert("searchEverywhere", 0);
}
...
void OAISearchApi::checkDocumentsReindex(const QString &async_request_key) {
    QString fullPath = QString(_serverConfigs["checkDocumentsReindex"][_serverIndices.value("checkDocumentsReindex")].URL()+"/search/documents/reindex/status");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAISearchApi::checkDocumentsReindexCallback);
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAISearchApi::checkDocumentsReindexCallback);
...
void OAISearchApi::checkDocumentsReindexCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT checkDocumentsReindexSignal(output);
        Q_EMIT checkDocumentsReindexSignalFull(worker, output);
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT checkDocumentsReindexSignalE(output, error_type, error_str);
        Q_EMIT checkDocumentsReindexSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT checkDocumentsReindexSignalError(output, error_type, error_str);
        Q_EMIT checkDocumentsReindexSignalErrorFull(worker, error_type, error_str);
    }
}

void OAISearchApi::reindexDocuments() {
    QString fullPath = QString(_serverConfigs["reindexDocuments"][_serverIndices.value("reindexDocuments")].URL()+"/search/documents/reindex");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAISearchApi::reindexDocumentsCallback);
    connect(this, &OAISearchApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAISearchApi::reindexDocumentsCallback);
    connect(this, &OAISearchApi::abortRequestsSignal, _latestWorker, &QObject::deleteLater);
    connect(_latestWorker, &QObject::destroyed, [this](){
        if(findChildren<OAIHttpRequestWorker*>().count() == 0){
            Q_EMIT allPendingRequestsCompleted();
...
void OAISearchApi::reindexDocumentsCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT reindexDocumentsSignal(output);
        Q_EMIT reindexDocumentsSignalFull(worker, output);
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT reindexDocumentsSignalE(output, error_type, error_str);
        Q_EMIT reindexDocumentsSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT reindexDocumentsSignalError(output, error_type, error_str);
        Q_EMIT reindexDocumentsSignalErrorFull(worker, error_type, error_str);
    }
}

void OAISearchApi::searchEverywhere(const QString &query, const ::OpenAPI::OptionalParam<QList<QString>> &include, const ::OpenAPI::OptionalParam<qint64> &page, const ::OpenAPI::OptionalParam<qint64> &per_page) {
    QString fullPath = QString(_serverConfigs["searchEverywhere"][_serverIndices.value("searchEverywhere")].URL()+"/search");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAISearchApi::searchEverywhereCallback);
    connect(this, &OAISearchApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAISearchApi::searchEverywhereCallback);
    connect(this, &OAISearchApi::abortRequestsSignal, _latestWorker, &QObject::deleteLater);
    connect(_latestWorker, &QObject::destroyed, [this](){
        if(findChildren<OAIHttpRequestWorker*>().count() == 0){
            Q_EMIT allPendingRequestsCompleted();
...
void OAISearchApi::searchEverywhereCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    OAISearchEverywhereResult output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT searchEverywhereSignal(output);
        Q_EMIT searchEverywhereSignalFull(worker, output);
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT searchEverywhereSignalE(output, error_type, error_str);
        Q_EMIT searchEverywhereSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT searchEverywhereSignalError(output, error_type, error_str);
        Q_EMIT searchEverywhereSignalErrorFull(worker, error_type, error_str);
    }
}
