...
void OAIDefaultApi::initializeServerConfigs() {
    ...
    "No description provided",
    QMap<QString, OAIServerVariable>()));
    _serverConfigs.insert("deleteCache", defaultConf);
    _serverIndices.insert("deleteCache", 0);
}
...
void OAIDefaultApi::deleteCache(const QString &key) {
    QString fullPath = QString(_serverConfigs["deleteCache"][_serverIndices.value("deleteCache")].URL()+"/cache/{key}");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIDefaultApi::deleteCacheCallback);
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIDefaultApi::deleteCacheCallback);
...
void OAIDefaultApi::deleteCacheCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT deleteCacheSignal(output);
        Q_EMIT deleteCacheSignalFull(worker, output);
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT deleteCacheSignalE(output, error_type, error_str);
        Q_EMIT deleteCacheSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT deleteCacheSignalError(output, error_type, error_str);
        Q_EMIT deleteCacheSignalErrorFull(worker, error_type, error_str);
    }
}
