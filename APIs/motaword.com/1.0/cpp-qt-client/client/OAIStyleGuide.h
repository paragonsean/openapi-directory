...
#ifndef OAIStyleGuide_H
#define OAIStyleGuide_H
...
class OAIStyleGuide : public OAIObject {
public:
    OAIStyleGuide();
    OAIStyleGuide(QString json);
    ~OAIStyleGuide() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStyleGuide)

#endif // OAIStyleGuide_H
