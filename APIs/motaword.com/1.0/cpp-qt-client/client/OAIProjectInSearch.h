...
/*
 * OAIProjectInSearch.h
 *
 * 
 */

#ifndef OAIProjectInSearch_H
#define OAIProjectInSearch_H
...
class OAIProjectInSearch : public OAIObject {
public:
    OAIProjectInSearch();
    OAIProjectInSearch(QString json);
    ~OAIProjectInSearch() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIProjectInSearch)

#endif // OAIProjectInSearch_H
