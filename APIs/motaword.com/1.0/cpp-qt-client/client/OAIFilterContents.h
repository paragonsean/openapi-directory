...
#ifndef OAIFilterContents_H
#define OAIFilterContents_H
...
class OAIFilterContents : public OAIObject {
public:
    OAIFilterContents();
    OAIFilterContents(QString json);
    ~OAIFilterContents() override;
    ...
    QList<OAISimpleModel> getClients() const;
    void setClients(const QList<OAISimpleModel> &clients);
    bool is_clients_Set() const;
    bool is_clients_Valid() const;

    QList<OAISimpleModel> getDocuments() const;
    void setDocuments(const QList<OAISimpleModel> &documents);
    bool is_documents_Set() const;
    bool is_documents_Valid() const;

    QList<OAISimpleModel> getProjects() const;
    void setProjects(const QList<OAISimpleModel> &projects);
    ...
    QList<OAISimpleModel> getVendors() const;
    void setVendors(const QList<OAISimpleModel> &vendors);
...
private:
    ...
    QList<OAISimpleModel> m_clients;
    bool m_clients_isSet;
    bool m_clients_isValid;

    QList<OAISimpleModel> m_documents;
    bool m_documents_isSet;
    bool m_documents_isValid;

    QList<OAISimpleModel> m_projects;
    ...
    QList<OAISimpleModel> m_vendors;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFilterContents)

#endif // OAIFilterContents_H
