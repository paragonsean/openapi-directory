...
public:
    ...
    */
    virtual void getAccessToken(const ::OpenAPI::OptionalParam<OAITokenRequest> &oai_token_request = ::OpenAPI::OptionalParam<OAITokenRequest>());
...
Q_SIGNALS:
    ...
    void getAccessTokenSignal(OAIToken summary);


    void getAccessTokenSignalFull(OAIHttpRequestWorker *worker, OAIToken summary);

    Q_DECL_DEPRECATED_X("Use getAccessTokenSignalError() instead")
    void getAccessTokenSignalE(OAIToken summary, QNetworkReply::NetworkError error_type, QString error_str);
    void getAccessTokenSignalError(OAIToken summary, QNetworkReply::NetworkError error_type, const QString &error_str);
