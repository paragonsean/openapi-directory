...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AdobeExperienceManagerAemApi.SlingApi();
  });
  ...
  describe('SlingApi', function() {
    ...
    describe('getTruststoreInfo', function() {
      it('should call getTruststoreInfo successfully', function(done) {
        //uncomment below and update the code to test getTruststoreInfo
        //instance.getTruststoreInfo(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('postConfigApacheHttpComponentsProxyConfiguration', function() {
      it('should call postConfigApacheHttpComponentsProxyConfiguration successfully', function(done) {
        //uncomment below and update the code to test postConfigApacheHttpComponentsProxyConfiguration
        //instance.postConfigApacheHttpComponentsProxyConfiguration(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('postConfigProperty', function() {
      it('should call postConfigProperty successfully', function(done) {
        //uncomment below and update the code to test postConfigProperty
        //instance.postConfigProperty(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
