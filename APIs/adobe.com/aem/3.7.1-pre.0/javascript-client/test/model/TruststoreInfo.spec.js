...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AdobeExperienceManagerAemApi.TruststoreInfo();
  });
  ...
  describe('TruststoreInfo', function() {
    it('should create an instance of TruststoreInfo', function() {
      ...
      //var instance = new AdobeExperienceManagerAemApi.TruststoreInfo();
      //expect(instance).to.be.a(AdobeExperienceManagerAemApi.TruststoreInfo);
    });
