...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AdobeExperienceManagerAemApi.SamlConfigurationPropertyItemsString();
  });
  ...
  describe('SamlConfigurationPropertyItemsString', function() {
    it('should create an instance of SamlConfigurationPropertyItemsString', function() {
      ...
      //var instance = new AdobeExperienceManagerAemApi.SamlConfigurationPropertyItemsString();
      //expect(instance).to.be.a(AdobeExperienceManagerAemApi.SamlConfigurationPropertyItemsString);
    });
