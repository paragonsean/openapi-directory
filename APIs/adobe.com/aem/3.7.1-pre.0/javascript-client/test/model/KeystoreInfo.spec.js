...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AdobeExperienceManagerAemApi.KeystoreInfo();
  });
  ...
  describe('KeystoreInfo', function() {
    it('should create an instance of KeystoreInfo', function() {
      ...
      //var instance = new AdobeExperienceManagerAemApi.KeystoreInfo();
      //expect(instance).to.be.a(AdobeExperienceManagerAemApi.KeystoreInfo);
    });
