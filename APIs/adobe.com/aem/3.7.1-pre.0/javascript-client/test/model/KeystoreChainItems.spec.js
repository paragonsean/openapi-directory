...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AdobeExperienceManagerAemApi.KeystoreChainItems();
  });
  ...
  describe('KeystoreChainItems', function() {
    it('should create an instance of KeystoreChainItems', function() {
      ...
      //var instance = new AdobeExperienceManagerAemApi.KeystoreChainItems();
      //expect(instance).to.be.a(AdobeExperienceManagerAemApi.KeystoreChainItems);
    });
