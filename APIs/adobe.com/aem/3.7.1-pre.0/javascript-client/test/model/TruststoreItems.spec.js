...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AdobeExperienceManagerAemApi.TruststoreItems();
  });
  ...
  describe('TruststoreItems', function() {
    it('should create an instance of TruststoreItems', function() {
      ...
      //var instance = new AdobeExperienceManagerAemApi.TruststoreItems();
      //expect(instance).to.be.a(AdobeExperienceManagerAemApi.TruststoreItems);
    });
