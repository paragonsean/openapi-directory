...
* <pre>
* var AdobeExperienceManagerAemApi = require('index'); // See note below*.
* var xxxSvc = new AdobeExperienceManagerAemApi.XxxApi(); // Allocate the API class we're going to use.
* var yyyModel = new AdobeExperienceManagerAemApi.Yyy(); // Construct a model instance.
...
* <pre>
* var xxxSvc = new AdobeExperienceManagerAemApi.XxxApi(); // Allocate the API class we're going to use.
* var yyy = new AdobeExperienceManagerAemApi.Yyy(); // Construct a model instance.
* yyyModel.someProperty = 'someValue';
* ...
* var zzz = xxxSvc.doSomething(yyyModel); // Invoke the service.
* ...
