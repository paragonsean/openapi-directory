...
class SamlConfigurationProperties(Model):
    ...
    def __init__(self, add_group_memberships: SamlConfigurationPropertyItemsBoolean=None, assertion_consumer_service_url: SamlConfigurationPropertyItemsString=None, clock_tolerance: SamlConfigurationPropertyItemsLong=None, create_user: SamlConfigurationPropertyItemsBoolean=None, default_groups: SamlConfigurationPropertyItemsArray=None, default_redirect_url: SamlConfigurationPropertyItemsString=None, digest_method: SamlConfigurationPropertyItemsString=None, group_membership_attribute: SamlConfigurationPropertyItemsString=None, handle_logout: SamlConfigurationPropertyItemsBoolean=None, idp_cert_alias: SamlConfigurationPropertyItemsString=None, idp_http_redirect: SamlConfigurationPropertyItemsBoolean=None, idp_url: SamlConfigurationPropertyItemsString=None, key_store_password: SamlConfigurationPropertyItemsString=None, logout_url: SamlConfigurationPropertyItemsString=None, name_id_format: SamlConfigurationPropertyItemsString=None, path: SamlConfigurationPropertyItemsArray=None, service_ranking: SamlConfigurationPropertyItemsLong=None, service_provider_entity_id: SamlConfigurationPropertyItemsString=None, signature_method: SamlConfigurationPropertyItemsString=None, sp_private_key_alias: SamlConfigurationPropertyItemsString=None, synchronize_attributes: SamlConfigurationPropertyItemsArray=None, use_encryption: SamlConfigurationPropertyItemsBoolean=None, user_id_attribute: SamlConfigurationPropertyItemsString=None, user_intermediate_path: SamlConfigurationPropertyItemsString=None):
