...
public class SlingApi {
    ...
    private okhttp3.Call postAuthorizableKeystoreValidateBeforeCall(String intermediatePath, String authorizableId, String colonOperation, String currentPassword, String newPassword, String rePassword, String keyPassword, String keyStorePass, String alias, String newAlias, String removeAlias, File certChain, File keyStore, File pk, final ApiCallback _callback) throws ApiException {
        ...
        return postAuthorizableKeystoreCall(intermediatePath, authorizableId, colonOperation, currentPassword, newPassword, rePassword, keyPassword, keyStorePass, alias, newAlias, removeAlias, certChain, keyStore, pk, _callback);
     ...
     */
    public KeystoreInfo postAuthorizableKeystore(String intermediatePath, String authorizableId, String colonOperation, String currentPassword, String newPassword, String rePassword, String keyPassword, String keyStorePass, String alias, String newAlias, String removeAlias, File certChain, File keyStore, File pk) throws ApiException {
        ApiResponse<KeystoreInfo> localVarResp = postAuthorizableKeystoreWithHttpInfo(intermediatePath, authorizableId, colonOperation, currentPassword, newPassword, rePassword, keyPassword, keyStorePass, alias, newAlias, removeAlias, certChain, keyStore, pk);
        return localVarResp.getData();
    }
    ...
    public ApiResponse<KeystoreInfo> postAuthorizableKeystoreWithHttpInfo(String intermediatePath, String authorizableId, String colonOperation, String currentPassword, String newPassword, String rePassword, String keyPassword, String keyStorePass, String alias, String newAlias, String removeAlias, File certChain, File keyStore, File pk) throws ApiException {
        okhttp3.Call localVarCall = postAuthorizableKeystoreValidateBeforeCall(intermediatePath, authorizableId, colonOperation, currentPassword, newPassword, rePassword, keyPassword, keyStorePass, alias, newAlias, removeAlias, certChain, keyStore, pk, null);
        Type localVarReturnType = new TypeToken<KeystoreInfo>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call postAuthorizableKeystoreAsync(String intermediatePath, String authorizableId, String colonOperation, String currentPassword, String newPassword, String rePassword, String keyPassword, String keyStorePass, String alias, String newAlias, String removeAlias, File certChain, File keyStore, File pk, final ApiCallback<KeystoreInfo> _callback) throws ApiException {

        okhttp3.Call localVarCall = postAuthorizableKeystoreValidateBeforeCall(intermediatePath, authorizableId, colonOperation, currentPassword, newPassword, rePassword, keyPassword, keyStorePass, alias, newAlias, removeAlias, certChain, keyStore, pk, _callback);
        Type localVarReturnType = new TypeToken<KeystoreInfo>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    ...
    private okhttp3.Call postAuthorizablesValidateBeforeCall(String authorizableId, String intermediatePath, String createUser, String createGroup, String repColonPassword, String profileGivenName, final ApiCallback _callback) throws ApiException {
        ...
        return postAuthorizablesCall(authorizableId, intermediatePath, createUser, createGroup, repColonPassword, profileGivenName, _callback);
     ...
     */
    public okhttp3.Call postNodeCall(String path, String name, String colonOperation, String deleteAuthorizable, File _file, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call postNodeValidateBeforeCall(String path, String name, String colonOperation, String deleteAuthorizable, File _file, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'path' is set
        if (path == null) {
        ...
        return postNodeCall(path, name, colonOperation, deleteAuthorizable, _file, _callback);
     ...
     */
    public void postNode(String path, String name, String colonOperation, String deleteAuthorizable, File _file) throws ApiException {
        postNodeWithHttpInfo(path, name, colonOperation, deleteAuthorizable, _file);
    }
     ...
     */
    public ApiResponse<Void> postNodeWithHttpInfo(String path, String name, String colonOperation, String deleteAuthorizable, File _file) throws ApiException {
        okhttp3.Call localVarCall = postNodeValidateBeforeCall(path, name, colonOperation, deleteAuthorizable, _file, null);
        return localVarApiClient.execute(localVarCall);
    }
     ...
     */
    public okhttp3.Call postNodeAsync(String path, String name, String colonOperation, String deleteAuthorizable, File _file, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = postNodeValidateBeforeCall(path, name, colonOperation, deleteAuthorizable, _file, _callback);
        localVarApiClient.executeAsync(localVarCall, _callback);
        return localVarCall;
    }
    /**
    ...
    private okhttp3.Call postPathValidateBeforeCall(String path, String jcrColonPrimaryType, String colonName, final ApiCallback _callback) throws ApiException {
        ...
        return postPathCall(path, jcrColonPrimaryType, colonName, _callback);
     ...
     */
    public okhttp3.Call postTreeActivationCall(Boolean ignoredeactivated, Boolean onlymodified, String path, String cmd, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call postTreeActivationValidateBeforeCall(Boolean ignoredeactivated, Boolean onlymodified, String path, String cmd, final ApiCallback _callback) throws ApiException {
     ...
     */
    public void postTreeActivation(Boolean ignoredeactivated, Boolean onlymodified, String path, String cmd) throws ApiException {
     ...
     */
    public ApiResponse<Void> postTreeActivationWithHttpInfo(Boolean ignoredeactivated, Boolean onlymodified, String path, String cmd) throws ApiException {
     ...
     */
    public okhttp3.Call postTreeActivationAsync(Boolean ignoredeactivated, Boolean onlymodified, String path, String cmd, final ApiCallback<Void> _callback) throws ApiException {
    ...
    private okhttp3.Call postTruststoreValidateBeforeCall(String colonOperation, String newPassword, String rePassword, String keyStoreType, String removeAlias, File certificate, final ApiCallback _callback) throws ApiException {
        return postTruststoreCall(colonOperation, newPassword, rePassword, keyStoreType, removeAlias, certificate, _callback);
