...
> KeystoreInfo postAuthorizableKeystore(intermediatePath, authorizableId, colonOperation, currentPassword, newPassword, rePassword, keyPassword, keyStorePass, alias, newAlias, removeAlias, certChain, keyStore, pk)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      KeystoreInfo result = apiInstance.postAuthorizableKeystore(intermediatePath, authorizableId, colonOperation, currentPassword, newPassword, rePassword, keyPassword, keyStorePass, alias, newAlias, removeAlias, certChain, keyStore, pk);
      System.out.println(result);
    } catch (ApiException e) {
...
<a id="postNode"></a>
# **postNode**
> postNode(path, name, colonOperation, deleteAuthorizable, _file)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      apiInstance.postNode(path, name, colonOperation, deleteAuthorizable, _file);
    } catch (ApiException e) {
