...
/**
 * The MetaTagModel model module.
 * @module model/MetaTagModel
 * @version 1.0.0
 */
class MetaTagModel {
    /**
     * Constructs a new <code>MetaTagModel</code>.
     * @alias module:model/MetaTagModel
     * @param content {String} 
     * @param name {String} 
     */
    constructor(content, name) { 
        
        MetaTagModel.initialize(this, content, name);
    }
    ...
    /**
     * Constructs a <code>MetaTagModel</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/MetaTagModel} obj Optional instance to populate.
     * @return {module:model/MetaTagModel} The populated <code>MetaTagModel</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new MetaTagModel();
    ...
    /**
     * Validates the JSON data with respect to <code>MetaTagModel</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>MetaTagModel</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of MetaTagModel.RequiredProperties) {
...
MetaTagModel.RequiredProperties = ["content", "name"];

/**
 * @member {String} content
 */
MetaTagModel.prototype['content'] = undefined;

/**
 * @member {String} name
 */
MetaTagModel.prototype['name'] = undefined;
