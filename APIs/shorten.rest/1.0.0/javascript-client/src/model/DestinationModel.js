...
/**
 * The DestinationModel model module.
 * @module model/DestinationModel
 * @version 1.0.0
 */
class DestinationModel {
    /**
     * Constructs a new <code>DestinationModel</code>.
     * @alias module:model/DestinationModel
     * @param url {String} 
     */
    constructor(url) { 
        
        DestinationModel.initialize(this, url);
    }
    ...
    /**
     * Constructs a <code>DestinationModel</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DestinationModel} obj Optional instance to populate.
     * @return {module:model/DestinationModel} The populated <code>DestinationModel</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DestinationModel();
    ...
    /**
     * Validates the JSON data with respect to <code>DestinationModel</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DestinationModel</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DestinationModel.RequiredProperties) {
...
DestinationModel.RequiredProperties = ["url"];

/**
 * ISO alpha-2 [country code](//en.wikipedia.org/wiki/ISO_3166-1_alpha-2#Officially_assigned_code_elements)
 * @member {String} country
 */
DestinationModel.prototype['country'] = undefined;

/**
 * Please check the [supported OS list](#tag/OperatingSystems)
 * @member {String} os
 */
DestinationModel.prototype['os'] = undefined;

/**
 * @member {String} url
 */
DestinationModel.prototype['url'] = undefined;
