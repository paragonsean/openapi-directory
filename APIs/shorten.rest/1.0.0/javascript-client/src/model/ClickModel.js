...
/**
 * The ClickModel model module.
 * @module model/ClickModel
 * @version 1.0.0
 */
class ClickModel {
    /**
     * Constructs a new <code>ClickModel</code>.
     * @alias module:model/ClickModel
     */
    constructor() { 
        
        ClickModel.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ClickModel</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ClickModel} obj Optional instance to populate.
     * @return {module:model/ClickModel} The populated <code>ClickModel</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ClickModel();
    ...
    /**
     * Validates the JSON data with respect to <code>ClickModel</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ClickModel</code>.
     */
 ...
 * @member {String} alias
 */
ClickModel.prototype['alias'] = undefined;

/**
 * @member {String} aliasId
 */
ClickModel.prototype['aliasId'] = undefined;

/**
 * @member {String} browser
 */
ClickModel.prototype['browser'] = undefined;

/**
 * @member {String} country
 */
ClickModel.prototype['country'] = undefined;

/**
 * @member {Number} createdAt
 */
ClickModel.prototype['createdAt'] = undefined;

/**
 * @member {String} destination
 */
ClickModel.prototype['destination'] = undefined;

/**
 * @member {String} domain
 */
ClickModel.prototype['domain'] = undefined;

/**
 * @member {String} os
 */
ClickModel.prototype['os'] = undefined;

/**
 * @member {String} referrer
 */
ClickModel.prototype['referrer'] = undefined;

/**
 * @member {String} userAgent
 */
ClickModel.prototype['userAgent'] = undefined;
