...
/**
 * The CreateAliasResponseModel model module.
 * @module model/CreateAliasResponseModel
 * @version 1.0.0
 */
class CreateAliasResponseModel {
    /**
     * Constructs a new <code>CreateAliasResponseModel</code>.
     * @alias module:model/CreateAliasResponseModel
     */
    constructor() { 
        
        CreateAliasResponseModel.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CreateAliasResponseModel</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateAliasResponseModel} obj Optional instance to populate.
     * @return {module:model/CreateAliasResponseModel} The populated <code>CreateAliasResponseModel</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateAliasResponseModel();
    ...
    /**
     * Validates the JSON data with respect to <code>CreateAliasResponseModel</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateAliasResponseModel</code>.
     */
 ...
 */
CreateAliasResponseModel.prototype['aliasName'] = undefined;

/**
 * @member {String} domainName
 */
CreateAliasResponseModel.prototype['domainName'] = undefined;

/**
 * @member {String} shortUrl
 */
CreateAliasResponseModel.prototype['shortUrl'] = undefined;
...
export default CreateAliasResponseModel;
