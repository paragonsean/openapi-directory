...
/**
 * The GetAliasesModel model module.
 * @module model/GetAliasesModel
 * @version 1.0.0
 */
class GetAliasesModel {
    /**
     * Constructs a new <code>GetAliasesModel</code>.
     * @alias module:model/GetAliasesModel
     */
    constructor() { 
        
        GetAliasesModel.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetAliasesModel</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetAliasesModel} obj Optional instance to populate.
     * @return {module:model/GetAliasesModel} The populated <code>GetAliasesModel</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetAliasesModel();
    ...
    /**
     * Validates the JSON data with respect to <code>GetAliasesModel</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetAliasesModel</code>.
     */
    static validateJSON(data) {
        ...
        if (data['lastId'] && !(typeof data['lastId'] === 'string' || data['lastId'] instanceof String)) {
            throw new Error("Expected the field `lastId` to be a primitive type in the JSON string but got " + data['lastId']);
        }
 ...
 */
GetAliasesModel.prototype['aliases'] = undefined;

/**
 * @member {String} lastId
 */
GetAliasesModel.prototype['lastId'] = undefined;
...
export default GetAliasesModel;
