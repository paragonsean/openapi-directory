...
/**
 * The SnippetModel model module.
 * @module model/SnippetModel
 * @version 1.0.0
 */
class SnippetModel {
    /**
     * Constructs a new <code>SnippetModel</code>.
     * @alias module:model/SnippetModel
     * @param id {String} Please check the [supported snippets list](#tag/Snippets)
     */
    constructor(id) { 
        
        SnippetModel.initialize(this, id);
    }
    ...
    /**
     * Constructs a <code>SnippetModel</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SnippetModel} obj Optional instance to populate.
     * @return {module:model/SnippetModel} The populated <code>SnippetModel</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SnippetModel();
    ...
    /**
     * Validates the JSON data with respect to <code>SnippetModel</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SnippetModel</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of SnippetModel.RequiredProperties) {
...
SnippetModel.RequiredProperties = ["id"];

/**
 * Please check the [supported snippets list](#tag/Snippets)
 * @member {String} id
 */
SnippetModel.prototype['id'] = undefined;

/**
 * @member {Object.<String, String>} parameters
 */
SnippetModel.prototype['parameters'] = undefined;
