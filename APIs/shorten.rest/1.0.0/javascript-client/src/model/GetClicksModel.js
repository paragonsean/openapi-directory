...
/**
 * The GetClicksModel model module.
 * @module model/GetClicksModel
 * @version 1.0.0
 */
class GetClicksModel {
    /**
     * Constructs a new <code>GetClicksModel</code>.
     * @alias module:model/GetClicksModel
     */
    constructor() { 
        
        GetClicksModel.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetClicksModel</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetClicksModel} obj Optional instance to populate.
     * @return {module:model/GetClicksModel} The populated <code>GetClicksModel</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetClicksModel();

            if (data.hasOwnProperty('clicks')) {
                obj['clicks'] = ApiClient.convertToType(data['clicks'], [ClickModel]);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>GetClicksModel</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetClicksModel</code>.
     */
    static validateJSON(data) {
        if (data['clicks']) { // data not null
            // ensure the json data is an array
            if (!Array.isArray(data['clicks'])) {
                throw new Error("Expected the field `clicks` to be an array in the JSON data but got " + data['clicks']);
            }
            // validate the optional field `clicks` (array)
            for (const item of data['clicks']) {
                ClickModel.validateJSON(item);
            };
        }
...
/**
 * @member {Array.<module:model/ClickModel>} clicks
 */
GetClicksModel.prototype['clicks'] = undefined;

/**
 * @member {String} lastId
 */
GetClicksModel.prototype['lastId'] = undefined;
