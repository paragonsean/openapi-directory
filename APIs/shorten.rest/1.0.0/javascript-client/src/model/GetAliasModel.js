...
import CreateAliasModel from './CreateAliasModel';

/**
 * The GetAliasModel model module.
 * @module model/GetAliasModel
 * @version 1.0.0
 */
class GetAliasModel {
    /**
     * Constructs a new <code>GetAliasModel</code>.
     * @alias module:model/GetAliasModel
     * @extends Object
     */
    constructor() { 
        
        GetAliasModel.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetAliasModel</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetAliasModel} obj Optional instance to populate.
     * @return {module:model/GetAliasModel} The populated <code>GetAliasModel</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetAliasModel();

            ApiClient.constructFromObject(data, obj, 'CreateAliasModel');
    ...
    /**
     * Validates the JSON data with respect to <code>GetAliasModel</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetAliasModel</code>.
     */
 ...
 */
GetAliasModel.prototype['createdAt'] = undefined;

/**
 * @member {String} domainName
 */
GetAliasModel.prototype['domainName'] = undefined;

/**
 * @member {String} name
 */
GetAliasModel.prototype['name'] = undefined;

/**
 * @member {Number} updatedAt
 */
GetAliasModel.prototype['updatedAt'] = undefined;
