...
/**
 * The ClicksFilterModel model module.
 * @module model/ClicksFilterModel
 * @version 1.0.0
 */
class ClicksFilterModel {
    /**
     * Constructs a new <code>ClicksFilterModel</code>.
     * @alias module:model/ClicksFilterModel
     */
    constructor() { 
        
        ClicksFilterModel.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ClicksFilterModel</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ClicksFilterModel} obj Optional instance to populate.
     * @return {module:model/ClicksFilterModel} The populated <code>ClicksFilterModel</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ClicksFilterModel();
    ...
    /**
     * Validates the JSON data with respect to <code>ClicksFilterModel</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ClicksFilterModel</code>.
     */
 ...
 */
ClicksFilterModel.prototype['aliasId'] = undefined;

/**
 * date From
 * @member {String} dateFrom
 */
ClicksFilterModel.prototype['dateFrom'] = undefined;

/**
 * date To
 * @member {String} dateTo
 */
ClicksFilterModel.prototype['dateTo'] = undefined;

/**
 * Domain name
 * @member {String} domain
 */
ClicksFilterModel.prototype['domain'] = undefined;

/**
 * last Id
 * @member {Number} lastId
 */
ClicksFilterModel.prototype['lastId'] = undefined;
...
export default ClicksFilterModel;
