...
/**
 * The CreateAliasModel model module.
 * @module model/CreateAliasModel
 * @version 1.0.0
 */
class CreateAliasModel {
    /**
     * Constructs a new <code>CreateAliasModel</code>.
     * @alias module:model/CreateAliasModel
     */
    constructor() { 
        
        CreateAliasModel.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CreateAliasModel</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateAliasModel} obj Optional instance to populate.
     * @return {module:model/CreateAliasModel} The populated <code>CreateAliasModel</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateAliasModel();
    ...
    /**
     * Validates the JSON data with respect to <code>CreateAliasModel</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateAliasModel</code>.
     */
 ...
 */
CreateAliasModel.prototype['destinations'] = undefined;

/**
 * @member {Array.<module:model/MetaTagModel>} metatags
 */
CreateAliasModel.prototype['metatags'] = undefined;

/**
 * @member {Array.<module:model/SnippetModel>} snippets
 */
CreateAliasModel.prototype['snippets'] = undefined;
...
export default CreateAliasModel;
