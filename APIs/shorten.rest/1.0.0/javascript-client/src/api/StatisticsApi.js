...
export default class StatisticsApi {
    ...
    */
     ...
     * @param {module:model/ClickModelPg} data The data returned by the service call.
     ...
     * @param {module:model/ClicksFilterModel} clicksFilterModel Filter
     ...
     * data is of type: {@link module:model/ClickModelPg}
     */
    getStatistics(clicksFilterModel, callback) {
      let postBody = clicksFilterModel;
      // verify the required parameter 'clicksFilterModel' is set
      if (clicksFilterModel === undefined || clicksFilterModel === null) {
        throw new Error("Missing the required parameter 'clicksFilterModel' when calling getStatistics");
      }
