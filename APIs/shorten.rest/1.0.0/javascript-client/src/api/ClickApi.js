...
* @version 1.0.0
*/
export default class ClickApi {

    /**
    * Constructs a new ClickApi. 
    * @alias module:api/ClickApi
    * @class
    ...
    */
    ...
    /**
     * Callback function to receive the result of the getClicks operation.
     * @callback module:api/ClickApi~getClicksCallback
     * @param {String} error Error message, if any.
     * @param {module:model/GetClicksModel} data The data returned by the service call.
     ...
     * @param {Number} [limit = 1000)] Number of results to return per request
     * @param {module:api/ClickApi~getClicksCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/GetClicksModel}
     */
    getClicks(opts, callback) {
      opts = opts || {};
      let postBody = null;
