...
export default class AliasApi {
    ...
    */
     ...
     * @callback module:api/AliasApi~createAliasCallback
     * @param {String} error Error message, if any.
     * @param {module:model/CreateAliasResponseModel} data The data returned by the service call.
     ...
     * @param {module:model/CreateAliasModel} createAliasModel alias properties
     * @param {Object} opts Optional parameters
     * @param {String} [domainName = 'short.fyi')] domain which alias will belong to (string without `http/https` or `/`)
     * @param {String} [aliasName = '@rnd')] alias (without `/` at the beginning)
     * @param {module:api/AliasApi~createAliasCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/CreateAliasResponseModel}
     */
    createAlias(createAliasModel, opts, callback) {
      opts = opts || {};
      let postBody = createAliasModel;
      // verify the required parameter 'createAliasModel' is set
      if (createAliasModel === undefined || createAliasModel === null) {
        throw new Error("Missing the required parameter 'createAliasModel' when calling createAlias");
      }
      ...
      let returnType = CreateAliasResponseModel;
     ...
     * @callback module:api/AliasApi~deleteAliasCallback
     * @param {String} error Error message, if any.
     ...
     * @param {Object} opts Optional parameters
     * @param {String} [domainName = 'short.fyi')] domain which alias belongs to (string without `http/https` or `/`)
     * @param {module:api/AliasApi~deleteAliasCallback} callback The callback function, accepting three arguments: error, data, response
     */
    deleteAlias(aliasName, opts, callback) {
      opts = opts || {};
      let postBody = null;
    ...
    /**
     * Callback function to receive the result of the getAlias operation.
     * @callback module:api/AliasApi~getAliasCallback
     * @param {String} error Error message, if any.
     * @param {module:model/AliasModel} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Object} opts Optional parameters
     * @param {String} [domainName = 'short.fyi')] domain which alias belongs to (string without `http/https` or `/`)
     * @param {module:api/AliasApi~getAliasCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/AliasModel}
     */
    getAlias(aliasName, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'aliasName' is set
      if (aliasName === undefined || aliasName === null) {
        throw new Error("Missing the required parameter 'aliasName' when calling getAlias");
      }
     ...
     * @callback module:api/AliasApi~getAliasesCallback
     * @param {String} error Error message, if any.
     * @param {module:model/GetAliasesModel} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Object} opts Optional parameters
     * @param {String} [domainName = 'short.fyi')] The domain name to get the aliases for (string without `http/https` or `/`)
     ...
     * @param {module:api/AliasApi~getAliasesCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/GetAliasesModel}
     */
    getAliases(opts, callback) {
      opts = opts || {};
      let postBody = null;
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = GetAliasesModel;
      return this.apiClient.callApi(
        '/aliases/all', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
     ...
     * @param {String} aliasName alias (without `/` at the beginning)
     * @param {module:model/CreateAliasModel} createAliasModel alias properties you wish to be updated
     * @param {Object} opts Optional parameters
     * @param {String} [domainName = 'short.fyi')] domain which alias belongs to (string without `http/https` or `/`)
     ...
     */
    updateAlias(aliasName, createAliasModel, opts, callback) {
      opts = opts || {};
      let postBody = createAliasModel;
      // verify the required parameter 'aliasName' is set
      if (aliasName === undefined || aliasName === null) {
        throw new Error("Missing the required parameter 'aliasName' when calling updateAlias");
      }
      // verify the required parameter 'createAliasModel' is set
      if (createAliasModel === undefined || createAliasModel === null) {
        throw new Error("Missing the required parameter 'createAliasModel' when calling updateAlias");
      }
