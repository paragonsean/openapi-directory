...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ShortenRestApiDocumentation.ClickModelPg();
  });
  ...
  describe('ClickModelPg', function() {
    it('should create an instance of ClickModelPg', function() {
      // uncomment below and update the code to test ClickModelPg
      //var instance = new ShortenRestApiDocumentation.ClickModelPg();
      //expect(instance).to.be.a(ShortenRestApiDocumentation.ClickModelPg);
    });
