...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ShortenRestApiDocumentation.AliasModel();
  });
  ...
  describe('AliasModel', function() {
    it('should create an instance of AliasModel', function() {
      // uncomment below and update the code to test AliasModel
      //var instance = new ShortenRestApiDocumentation.AliasModel();
      //expect(instance).to.be.a(ShortenRestApiDocumentation.AliasModel);
    });
