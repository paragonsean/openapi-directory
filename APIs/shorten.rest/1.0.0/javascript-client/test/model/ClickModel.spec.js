...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ShortenRestApiDocumentation.ClickModel();
  });
  ...
  describe('ClickModel', function() {
    it('should create an instance of ClickModel', function() {
      // uncomment below and update the code to test ClickModel
      //var instance = new ShortenRestApiDocumentation.ClickModel();
      //expect(instance).to.be.a(ShortenRestApiDocumentation.ClickModel);
    });
