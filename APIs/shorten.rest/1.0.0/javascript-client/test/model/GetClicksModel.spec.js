...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    factory(root.expect, root.ShortenRestApiDocumentation);
  }
}(this, function(expect, ShortenRestApiDocumentation) {
  'use strict';

  var instance;

  beforeEach(function() {
    instance = new ShortenRestApiDocumentation.GetClicksModel();
  });
  ...
  describe('GetClicksModel', function() {
    it('should create an instance of GetClicksModel', function() {
      // uncomment below and update the code to test GetClicksModel
      //var instance = new ShortenRestApiDocumentation.GetClicksModel();
      //expect(instance).to.be.a(ShortenRestApiDocumentation.GetClicksModel);
    });
