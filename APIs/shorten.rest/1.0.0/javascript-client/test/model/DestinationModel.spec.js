...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ShortenRestApiDocumentation.DestinationModel();
  });
  ...
  describe('DestinationModel', function() {
    it('should create an instance of DestinationModel', function() {
      // uncomment below and update the code to test DestinationModel
      //var instance = new ShortenRestApiDocumentation.DestinationModel();
      //expect(instance).to.be.a(ShortenRestApiDocumentation.DestinationModel);
    });
