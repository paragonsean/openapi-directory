...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ShortenRestApiDocumentation.CreateAliasResponseModel();
  });
  ...
  describe('CreateAliasResponseModel', function() {
    it('should create an instance of CreateAliasResponseModel', function() {
      // uncomment below and update the code to test CreateAliasResponseModel
      //var instance = new ShortenRestApiDocumentation.CreateAliasResponseModel();
      //expect(instance).to.be.a(ShortenRestApiDocumentation.CreateAliasResponseModel);
    });
