...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ShortenRestApiDocumentation.ClicksFilterModel();
  });
  ...
  describe('ClicksFilterModel', function() {
    it('should create an instance of ClicksFilterModel', function() {
      // uncomment below and update the code to test ClicksFilterModel
      //var instance = new ShortenRestApiDocumentation.ClicksFilterModel();
      //expect(instance).to.be.a(ShortenRestApiDocumentation.ClicksFilterModel);
    });
