...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ShortenRestApiDocumentation.CreateAliasModel();
  });
  ...
  describe('CreateAliasModel', function() {
    it('should create an instance of CreateAliasModel', function() {
      // uncomment below and update the code to test CreateAliasModel
      //var instance = new ShortenRestApiDocumentation.CreateAliasModel();
      //expect(instance).to.be.a(ShortenRestApiDocumentation.CreateAliasModel);
    });
