...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ShortenRestApiDocumentation.MetaTagModel();
  });
  ...
  describe('MetaTagModel', function() {
    it('should create an instance of MetaTagModel', function() {
      // uncomment below and update the code to test MetaTagModel
      //var instance = new ShortenRestApiDocumentation.MetaTagModel();
      //expect(instance).to.be.a(ShortenRestApiDocumentation.MetaTagModel);
    });
