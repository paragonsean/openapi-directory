...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ShortenRestApiDocumentation.SnippetModel();
  });
  ...
  describe('SnippetModel', function() {
    it('should create an instance of SnippetModel', function() {
      // uncomment below and update the code to test SnippetModel
      //var instance = new ShortenRestApiDocumentation.SnippetModel();
      //expect(instance).to.be.a(ShortenRestApiDocumentation.SnippetModel);
    });
