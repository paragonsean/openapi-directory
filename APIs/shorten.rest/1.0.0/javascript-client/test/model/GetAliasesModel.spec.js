...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ShortenRestApiDocumentation.GetAliasesModel();
  });
  ...
  describe('GetAliasesModel', function() {
    it('should create an instance of GetAliasesModel', function() {
      // uncomment below and update the code to test GetAliasesModel
      //var instance = new ShortenRestApiDocumentation.GetAliasesModel();
      //expect(instance).to.be.a(ShortenRestApiDocumentation.GetAliasesModel);
    });
