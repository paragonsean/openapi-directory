...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ShortenRestApiDocumentation.GetAliasModel();
  });
  ...
  describe('GetAliasModel', function() {
    it('should create an instance of GetAliasModel', function() {
      // uncomment below and update the code to test GetAliasModel
      //var instance = new ShortenRestApiDocumentation.GetAliasModel();
      //expect(instance).to.be.a(ShortenRestApiDocumentation.GetAliasModel);
    });
