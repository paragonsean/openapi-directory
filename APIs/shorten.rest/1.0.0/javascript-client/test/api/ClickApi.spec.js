...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ShortenRestApiDocumentation.ClickApi();
  });
  ...
  describe('ClickApi', function() {
    describe('getClicks', function() {
      it('should call getClicks successfully', function(done) {
        //uncomment below and update the code to test getClicks
        //instance.getClicks(function(error) {
