...
public class ClickModel {
  ...
  public ClickModel alias(String alias) {
    this.alias = alias;
    return this;
  }
  ...
  public ClickModel aliasId(String aliasId) {
  ...
  public ClickModel browser(String browser) {
  ...
  public ClickModel country(String country) {
  ...
  public ClickModel createdAt(Long createdAt) {
  ...
  public ClickModel destination(String destination) {
  ...
  public ClickModel domain(String domain) {
    this.domain = domain;
    return this;
  }
  ...
  public ClickModel os(String os) {
    this.os = os;
    return this;
  }
  ...
  public ClickModel referrer(String referrer) {
  ...
  public ClickModel userAgent(String userAgent) {
  ...
  public boolean equals(Object o) {
    ...
    ClickModel clickModel = (ClickModel) o;
    return Objects.equals(this.alias, clickModel.alias) &&
        Objects.equals(this.aliasId, clickModel.aliasId) &&
        Objects.equals(this.browser, clickModel.browser) &&
        Objects.equals(this.country, clickModel.country) &&
        Objects.equals(this.createdAt, clickModel.createdAt) &&
        Objects.equals(this.destination, clickModel.destination) &&
        Objects.equals(this.domain, clickModel.domain) &&
        Objects.equals(this.os, clickModel.os) &&
        Objects.equals(this.referrer, clickModel.referrer) &&
        Objects.equals(this.userAgent, clickModel.userAgent);
  }

  @Override
  public int hashCode() {
    return Objects.hash(alias, aliasId, browser, country, createdAt, destination, domain, os, referrer, userAgent);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ClickModel {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ClickModel
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ClickModel.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ClickModel is not found in the empty JSON string", ClickModel.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ClickModel.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ClickModel` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ClickModel.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ClickModel' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ClickModel> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ClickModel.class));

       return (TypeAdapter<T>) new TypeAdapter<ClickModel>() {
           @Override
           public void write(JsonWriter out, ClickModel value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ClickModel read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ClickModel given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ClickModel
   * @throws IOException if the JSON string is invalid with respect to ClickModel
   */
  public static ClickModel fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ClickModel.class);
  }

  /**
   * Convert an instance of ClickModel to an JSON string
   *
   * @return JSON string
   */
