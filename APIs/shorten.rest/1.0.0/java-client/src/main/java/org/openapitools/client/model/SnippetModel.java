...
public class SnippetModel {
  ...
  public SnippetModel id(String id) {
    this.id = id;
    return this;
  }
  ...
  public SnippetModel parameters(Map<String, String> parameters) {
    this.parameters = parameters;
    return this;
  }

  public SnippetModel putParametersItem(String key, String parametersItem) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, snippetModel.id) &&
        Objects.equals(this.parameters, snippetModel.parameters);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to SnippetModel
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SnippetModel.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SnippetModel is not found in the empty JSON string", SnippetModel.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SnippetModel.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SnippetModel` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : SnippetModel.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SnippetModel.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SnippetModel' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SnippetModel> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SnippetModel.class));

       return (TypeAdapter<T>) new TypeAdapter<SnippetModel>() {
           @Override
           public void write(JsonWriter out, SnippetModel value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SnippetModel read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SnippetModel given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SnippetModel
   * @throws IOException if the JSON string is invalid with respect to SnippetModel
   */
  public static SnippetModel fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SnippetModel.class);
  }

  /**
   * Convert an instance of SnippetModel to an JSON string
   *
   * @return JSON string
   */
