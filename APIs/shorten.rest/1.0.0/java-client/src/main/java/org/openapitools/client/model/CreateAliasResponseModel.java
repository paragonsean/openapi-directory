...
public class CreateAliasResponseModel {
  ...
  public CreateAliasResponseModel aliasName(String aliasName) {
  ...
  public CreateAliasResponseModel domainName(String domainName) {
  ...
  public CreateAliasResponseModel shortUrl(String shortUrl) {
  ...
  public boolean equals(Object o) {
    ...
    CreateAliasResponseModel createAliasResponseModel = (CreateAliasResponseModel) o;
    return Objects.equals(this.aliasName, createAliasResponseModel.aliasName) &&
        Objects.equals(this.domainName, createAliasResponseModel.domainName) &&
        Objects.equals(this.shortUrl, createAliasResponseModel.shortUrl);
  }

  @Override
  public int hashCode() {
    return Objects.hash(aliasName, domainName, shortUrl);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CreateAliasResponseModel {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateAliasResponseModel
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateAliasResponseModel.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateAliasResponseModel is not found in the empty JSON string", CreateAliasResponseModel.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateAliasResponseModel.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateAliasResponseModel` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateAliasResponseModel.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateAliasResponseModel' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateAliasResponseModel> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateAliasResponseModel.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateAliasResponseModel>() {
           @Override
           public void write(JsonWriter out, CreateAliasResponseModel value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateAliasResponseModel read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateAliasResponseModel given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateAliasResponseModel
   * @throws IOException if the JSON string is invalid with respect to CreateAliasResponseModel
   */
  public static CreateAliasResponseModel fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateAliasResponseModel.class);
  }

  /**
   * Convert an instance of CreateAliasResponseModel to an JSON string
   *
   * @return JSON string
   */
