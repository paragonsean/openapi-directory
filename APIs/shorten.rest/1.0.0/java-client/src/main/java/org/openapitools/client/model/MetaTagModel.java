...
public class MetaTagModel {
  ...
  public MetaTagModel content(String content) {
  ...
  public MetaTagModel name(String name) {
    this.name = name;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    MetaTagModel metaTagModel = (MetaTagModel) o;
    return Objects.equals(this.content, metaTagModel.content) &&
        Objects.equals(this.name, metaTagModel.name);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to MetaTagModel
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MetaTagModel.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MetaTagModel is not found in the empty JSON string", MetaTagModel.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MetaTagModel.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `MetaTagModel` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : MetaTagModel.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MetaTagModel.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MetaTagModel' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MetaTagModel> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MetaTagModel.class));

       return (TypeAdapter<T>) new TypeAdapter<MetaTagModel>() {
           @Override
           public void write(JsonWriter out, MetaTagModel value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public MetaTagModel read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of MetaTagModel given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of MetaTagModel
   * @throws IOException if the JSON string is invalid with respect to MetaTagModel
   */
  public static MetaTagModel fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MetaTagModel.class);
  }

  /**
   * Convert an instance of MetaTagModel to an JSON string
   *
   * @return JSON string
   */
