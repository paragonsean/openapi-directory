...
public class ClickApi {
    ...
    public ClickApi(ApiClient apiClient) {
    ...
    /**
     * Build call for getClicks
     * @param continueFrom An ID returned by a previous query to continue clicks retrieval (see lastId in response) (optional)
     ...
     */
    public okhttp3.Call getClicksCall(String continueFrom, Integer limit, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call getClicksValidateBeforeCall(String continueFrom, Integer limit, final ApiCallback _callback) throws ApiException {
        return getClicksCall(continueFrom, limit, _callback);
     ...
     */
    public GetClicksModel getClicks(String continueFrom, Integer limit) throws ApiException {
        ApiResponse<GetClicksModel> localVarResp = getClicksWithHttpInfo(continueFrom, limit);
     ...
     * @param continueFrom An ID returned by a previous query to continue clicks retrieval (see lastId in response) (optional)
     * @param limit Number of results to return per request (optional, default to 1000)
     * @return ApiResponse&lt;GetClicksModel&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<GetClicksModel> getClicksWithHttpInfo(String continueFrom, Integer limit) throws ApiException {
        okhttp3.Call localVarCall = getClicksValidateBeforeCall(continueFrom, limit, null);
        Type localVarReturnType = new TypeToken<GetClicksModel>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Get clicks (asynchronously)
     * Retrieve the raw click data for your account. Clicks are retrieved by creation date in descending order.    If there are more results than the limit for the request the response will return you a value in lastId property you can specify it in the continueFrom query parameter to get the next batch of records.
     * @param continueFrom An ID returned by a previous query to continue clicks retrieval (see lastId in response) (optional)
     * @param limit Number of results to return per request (optional, default to 1000)
     ...
     */
    public okhttp3.Call getClicksAsync(String continueFrom, Integer limit, final ApiCallback<GetClicksModel> _callback) throws ApiException {

        okhttp3.Call localVarCall = getClicksValidateBeforeCall(continueFrom, limit, _callback);
        Type localVarReturnType = new TypeToken<GetClicksModel>(){}.getType();
