...
public class GetAliasesModel {
  ...
  public GetAliasesModel aliases(List<String> aliases) {
    this.aliases = aliases;
    return this;
  }

  public GetAliasesModel addAliasesItem(String aliasesItem) {
  ...
  public GetAliasesModel lastId(String lastId) {
    this.lastId = lastId;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    GetAliasesModel getAliasesModel = (GetAliasesModel) o;
    return Objects.equals(this.aliases, getAliasesModel.aliases) &&
        Objects.equals(this.lastId, getAliasesModel.lastId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(aliases, lastId);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class GetAliasesModel {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetAliasesModel
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetAliasesModel.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetAliasesModel is not found in the empty JSON string", GetAliasesModel.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetAliasesModel.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetAliasesModel` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetAliasesModel.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetAliasesModel' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetAliasesModel> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetAliasesModel.class));

       return (TypeAdapter<T>) new TypeAdapter<GetAliasesModel>() {
           @Override
           public void write(JsonWriter out, GetAliasesModel value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetAliasesModel read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetAliasesModel given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetAliasesModel
   * @throws IOException if the JSON string is invalid with respect to GetAliasesModel
   */
  public static GetAliasesModel fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetAliasesModel.class);
  }

  /**
   * Convert an instance of GetAliasesModel to an JSON string
   *
   * @return JSON string
   */
