...
import org.openapitools.client.model.GetClicksModel;
...
/**
 * API tests for ClickApi
 */
@Disabled
public class ClickApiTest {

    private final ClickApi api = new ClickApi();
     ...
     */
    @Test
    public void getClicksTest() throws ApiException {
        String continueFrom = null;
        Integer limit = null;
        GetClicksModel response = api.getClicks(continueFrom, limit);
