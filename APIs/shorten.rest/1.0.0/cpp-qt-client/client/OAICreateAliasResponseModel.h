...
/*
 * OAICreateAliasResponseModel.h
 *
 * 
 */

#ifndef OAICreateAliasResponseModel_H
#define OAICreateAliasResponseModel_H
...
class OAICreateAliasResponseModel : public OAIObject {
public:
    OAICreateAliasResponseModel();
    OAICreateAliasResponseModel(QString json);
    ~OAICreateAliasResponseModel() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateAliasResponseModel)

#endif // OAICreateAliasResponseModel_H
