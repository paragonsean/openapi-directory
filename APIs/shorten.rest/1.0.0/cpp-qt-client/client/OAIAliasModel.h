...
#ifndef OAIAliasModel_H
#define OAIAliasModel_H
...
class OAIAliasModel : public OAIObject {
public:
    OAIAliasModel();
    OAIAliasModel(QString json);
    ~OAIAliasModel() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAliasModel)

#endif // OAIAliasModel_H
