...
OAIDestinationModel::OAIDestinationModel(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDestinationModel::OAIDestinationModel() {
    this->initializeModel();
}

OAIDestinationModel::~OAIDestinationModel() {}

void OAIDestinationModel::initializeModel() {
...
void OAIDestinationModel::fromJson(QString jsonString) {
...
void OAIDestinationModel::fromJsonObject(QJsonObject json) {
...
QString OAIDestinationModel::asJson() const {
...
QJsonObject OAIDestinationModel::asJsonObject() const {
    QJsonObject obj;
    if (m_country_isSet) {
...
QString OAIDestinationModel::getCountry() const {
    return m_country;
}
void OAIDestinationModel::setCountry(const QString &country) {
    m_country = country;
    m_country_isSet = true;
}

bool OAIDestinationModel::is_country_Set() const{
    return m_country_isSet;
}

bool OAIDestinationModel::is_country_Valid() const{
    return m_country_isValid;
}

QString OAIDestinationModel::getOs() const {
    return m_os;
}
void OAIDestinationModel::setOs(const QString &os) {
    m_os = os;
    m_os_isSet = true;
}

bool OAIDestinationModel::is_os_Set() const{
    return m_os_isSet;
}

bool OAIDestinationModel::is_os_Valid() const{
    return m_os_isValid;
}

QString OAIDestinationModel::getUrl() const {
    return m_url;
}
void OAIDestinationModel::setUrl(const QString &url) {
    m_url = url;
    m_url_isSet = true;
}

bool OAIDestinationModel::is_url_Set() const{
    return m_url_isSet;
}

bool OAIDestinationModel::is_url_Valid() const{
    return m_url_isValid;
}

bool OAIDestinationModel::isSet() const {
...
bool OAIDestinationModel::isValid() const {
