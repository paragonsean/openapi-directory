...
OAIGetAliasModel::OAIGetAliasModel(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetAliasModel::OAIGetAliasModel() {
    this->initializeModel();
}

OAIGetAliasModel::~OAIGetAliasModel() {}

void OAIGetAliasModel::initializeModel() {
...
void OAIGetAliasModel::fromJson(QString jsonString) {
...
void OAIGetAliasModel::fromJsonObject(QJsonObject json) {
...
QString OAIGetAliasModel::asJson() const {
...
QJsonObject OAIGetAliasModel::asJsonObject() const {
    QJsonObject obj;
...
qint64 OAIGetAliasModel::getCreatedAt() const {
    return m_created_at;
}
void OAIGetAliasModel::setCreatedAt(const qint64 &created_at) {
    m_created_at = created_at;
    m_created_at_isSet = true;
}

bool OAIGetAliasModel::is_created_at_Set() const{
    return m_created_at_isSet;
}

bool OAIGetAliasModel::is_created_at_Valid() const{
    return m_created_at_isValid;
}

QString OAIGetAliasModel::getDomainName() const {
    return m_domain_name;
}
void OAIGetAliasModel::setDomainName(const QString &domain_name) {
    m_domain_name = domain_name;
    m_domain_name_isSet = true;
}

bool OAIGetAliasModel::is_domain_name_Set() const{
    return m_domain_name_isSet;
}

bool OAIGetAliasModel::is_domain_name_Valid() const{
    return m_domain_name_isValid;
}

QString OAIGetAliasModel::getName() const {
    return m_name;
}
void OAIGetAliasModel::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIGetAliasModel::is_name_Set() const{
    return m_name_isSet;
}

bool OAIGetAliasModel::is_name_Valid() const{
    return m_name_isValid;
}

qint64 OAIGetAliasModel::getUpdatedAt() const {
    return m_updated_at;
}
void OAIGetAliasModel::setUpdatedAt(const qint64 &updated_at) {
    m_updated_at = updated_at;
    m_updated_at_isSet = true;
}

bool OAIGetAliasModel::is_updated_at_Set() const{
    return m_updated_at_isSet;
}

bool OAIGetAliasModel::is_updated_at_Valid() const{
    return m_updated_at_isValid;
}

bool OAIGetAliasModel::isSet() const {
...
bool OAIGetAliasModel::isValid() const {
