...
public:
    ...
    /**
    * @param[in]  oai_create_alias_model OAICreateAliasModel [required]
    * @param[in]  domain_name QString [optional]
    * @param[in]  alias_name QString [optional]
    */
    virtual void createAlias(const OAICreateAliasModel &oai_create_alias_model, const ::OpenAPI::OptionalParam<QString> &domain_name = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &alias_name = ::OpenAPI::OptionalParam<QString>());

    /**
    * @param[in]  alias_name QString [required]
    * @param[in]  domain_name QString [optional]
    */
    virtual void deleteAlias(const QString &alias_name, const ::OpenAPI::OptionalParam<QString> &domain_name = ::OpenAPI::OptionalParam<QString>());

    /**
    * @param[in]  alias_name QString [required]
    * @param[in]  domain_name QString [optional]
    */
    virtual void getAlias(const QString &alias_name, const ::OpenAPI::OptionalParam<QString> &domain_name = ::OpenAPI::OptionalParam<QString>());
    ...
    */
    virtual void getAliases(const ::OpenAPI::OptionalParam<QString> &domain_name = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &continue_from = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<qint32> &limit = ::OpenAPI::OptionalParam<qint32>());
    ...
    * @param[in]  domain_name QString [optional]
    */
    virtual void updateAlias(const QString &alias_name, const OAICreateAliasModel &oai_create_alias_model, const ::OpenAPI::OptionalParam<QString> &domain_name = ::OpenAPI::OptionalParam<QString>());
...
private:
    ...
    void getAliasCallback(OAIHttpRequestWorker *worker);
    void getAliasesCallback(OAIHttpRequestWorker *worker);
    void updateAliasCallback(OAIHttpRequestWorker *worker);

Q_SIGNALS:

    void createAliasSignal(OAICreateAliasResponseModel summary);
    void deleteAliasSignal();
    void getAliasSignal(OAIAliasModel summary);
    void getAliasesSignal(OAIGetAliasesModel summary);
    void updateAliasSignal();


    void createAliasSignalFull(OAIHttpRequestWorker *worker, OAICreateAliasResponseModel summary);
    void deleteAliasSignalFull(OAIHttpRequestWorker *worker);
    void getAliasSignalFull(OAIHttpRequestWorker *worker, OAIAliasModel summary);
    void getAliasesSignalFull(OAIHttpRequestWorker *worker, OAIGetAliasesModel summary);
    void updateAliasSignalFull(OAIHttpRequestWorker *worker);

    Q_DECL_DEPRECATED_X("Use createAliasSignalError() instead")
    void createAliasSignalE(OAICreateAliasResponseModel summary, QNetworkReply::NetworkError error_type, QString error_str);
    void createAliasSignalError(OAICreateAliasResponseModel summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use getAliasSignalError() instead")
    void getAliasSignalE(OAIAliasModel summary, QNetworkReply::NetworkError error_type, QString error_str);
    void getAliasSignalError(OAIAliasModel summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use getAliasesSignalError() instead")
    void getAliasesSignalE(OAIGetAliasesModel summary, QNetworkReply::NetworkError error_type, QString error_str);
    void getAliasesSignalError(OAIGetAliasesModel summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use getAliasSignalErrorFull() instead")
    void getAliasSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void getAliasSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use getAliasesSignalErrorFull() instead")
    void getAliasesSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void getAliasesSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
