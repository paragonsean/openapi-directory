...
#ifndef OAIGetClicksModel_H
#define OAIGetClicksModel_H
...
class OAIGetClicksModel : public OAIObject {
public:
    OAIGetClicksModel();
    OAIGetClicksModel(QString json);
    ~OAIGetClicksModel() override;
    ...
    QList<OAIClickModel> getClicks() const;
    void setClicks(const QList<OAIClickModel> &clicks);
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetClicksModel)

#endif // OAIGetClicksModel_H
