...
/*
 * OAIGetAliasesModel.h
 *
 * 
 */

#ifndef OAIGetAliasesModel_H
#define OAIGetAliasesModel_H
...
class OAIGetAliasesModel : public OAIObject {
public:
    OAIGetAliasesModel();
    OAIGetAliasesModel(QString json);
    ~OAIGetAliasesModel() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetAliasesModel)

#endif // OAIGetAliasesModel_H
