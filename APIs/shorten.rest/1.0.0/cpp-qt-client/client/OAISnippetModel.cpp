...
OAISnippetModel::OAISnippetModel(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISnippetModel::OAISnippetModel() {
    this->initializeModel();
}

OAISnippetModel::~OAISnippetModel() {}

void OAISnippetModel::initializeModel() {
...
void OAISnippetModel::fromJson(QString jsonString) {
...
void OAISnippetModel::fromJsonObject(QJsonObject json) {
...
QString OAISnippetModel::asJson() const {
...
QJsonObject OAISnippetModel::asJsonObject() const {
    QJsonObject obj;
    if (m_id_isSet) {
...
QString OAISnippetModel::getId() const {
    return m_id;
}
void OAISnippetModel::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAISnippetModel::is_id_Set() const{
    return m_id_isSet;
}

bool OAISnippetModel::is_id_Valid() const{
    return m_id_isValid;
}

QMap<QString, QString> OAISnippetModel::getParameters() const {
    return m_parameters;
}
void OAISnippetModel::setParameters(const QMap<QString, QString> &parameters) {
    m_parameters = parameters;
    m_parameters_isSet = true;
}

bool OAISnippetModel::is_parameters_Set() const{
    return m_parameters_isSet;
}

bool OAISnippetModel::is_parameters_Valid() const{
    return m_parameters_isValid;
}

bool OAISnippetModel::isSet() const {
...
bool OAISnippetModel::isValid() const {
