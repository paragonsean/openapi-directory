...
public:
    ...
    /**
    * @param[in]  oai_clicks_filter_model OAIClicksFilterModel [required]
    */
    virtual void getStatistics(const OAIClicksFilterModel &oai_clicks_filter_model);
...
Q_SIGNALS:
    ...
    void getStatisticsSignal(OAIClickModelPg summary);


    void getStatisticsSignalFull(OAIHttpRequestWorker *worker, OAIClickModelPg summary);

    Q_DECL_DEPRECATED_X("Use getStatisticsSignalError() instead")
    void getStatisticsSignalE(OAIClickModelPg summary, QNetworkReply::NetworkError error_type, QString error_str);
    void getStatisticsSignalError(OAIClickModelPg summary, QNetworkReply::NetworkError error_type, const QString &error_str);
