...
OAIClickApi::OAIClickApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAIClickApi::~OAIClickApi() {
}

void OAIClickApi::initializeServerConfigs() {
    //Default server
    ...
    _serverConfigs.insert("getClicks", defaultConf);
    _serverIndices.insert("getClicks", 0);
}
...
*/
int OAIClickApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAIClickApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAIClickApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAIClickApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAIClickApi::setUsername(const QString &username) {
    _username = username;
}

void OAIClickApi::setPassword(const QString &password) {
    _password = password;
}


void OAIClickApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAIClickApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAIClickApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAIClickApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAIClickApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAIClickApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAIClickApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAIClickApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAIClickApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAIClickApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAIClickApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAIClickApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAIClickApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAIClickApi::getClicks(const ::OpenAPI::OptionalParam<QString> &continue_from, const ::OpenAPI::OptionalParam<qint32> &limit) {
    QString fullPath = QString(_serverConfigs["getClicks"][_serverIndices.value("getClicks")].URL()+"/clicks");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIClickApi::getClicksCallback);
    connect(this, &OAIClickApi::abortRequestsSignal, worker, &QObject::deleteLater);
...
void OAIClickApi::getClicksCallback(OAIHttpRequestWorker *worker) {
    ...
    OAIGetClicksModel output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT getClicksSignal(output);
        Q_EMIT getClicksSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT getClicksSignalE(output, error_type, error_str);
        Q_EMIT getClicksSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT getClicksSignalError(output, error_type, error_str);
        Q_EMIT getClicksSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIClickApi::tokenAvailable(){
