...
#ifndef OAIClickModelPg_H
#define OAIClickModelPg_H
...
class OAIClickModelPg : public OAIObject {
public:
    OAIClickModelPg();
    OAIClickModelPg(QString json);
    ~OAIClickModelPg() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIClickModelPg)

#endif // OAIClickModelPg_H
