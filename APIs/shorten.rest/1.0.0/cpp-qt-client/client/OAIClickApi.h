...
#ifndef OAI_OAIClickApi_H
#define OAI_OAIClickApi_H
...
class OAIClickApi : public QObject {
    Q_OBJECT

public:
    OAIClickApi(const int timeOut = 0);
    ~OAIClickApi();
    ...
    /**
    * @param[in]  continue_from QString [optional]
    * @param[in]  limit qint32 [optional]
    */
    virtual void getClicks(const ::OpenAPI::OptionalParam<QString> &continue_from = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<qint32> &limit = ::OpenAPI::OptionalParam<qint32>());
...
private:
    ...
    void getClicksCallback(OAIHttpRequestWorker *worker);

Q_SIGNALS:

    void getClicksSignal(OAIGetClicksModel summary);


    void getClicksSignalFull(OAIHttpRequestWorker *worker, OAIGetClicksModel summary);

    Q_DECL_DEPRECATED_X("Use getClicksSignalError() instead")
    void getClicksSignalE(OAIGetClicksModel summary, QNetworkReply::NetworkError error_type, QString error_str);
    void getClicksSignalError(OAIGetClicksModel summary, QNetworkReply::NetworkError error_type, const QString &error_str);

    Q_DECL_DEPRECATED_X("Use getClicksSignalErrorFull() instead")
    void getClicksSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void getClicksSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
