...
#ifndef OAIMetaTagModel_H
#define OAIMetaTagModel_H
...
class OAIMetaTagModel : public OAIObject {
public:
    OAIMetaTagModel();
    OAIMetaTagModel(QString json);
    ~OAIMetaTagModel() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMetaTagModel)

#endif // OAIMetaTagModel_H
