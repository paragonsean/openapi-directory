...
OAIClickModelPg::OAIClickModelPg(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIClickModelPg::OAIClickModelPg() {
    this->initializeModel();
}

OAIClickModelPg::~OAIClickModelPg() {}

void OAIClickModelPg::initializeModel() {
...
void OAIClickModelPg::fromJson(QString jsonString) {
...
void OAIClickModelPg::fromJsonObject(QJsonObject json) {
...
QString OAIClickModelPg::asJson() const {
...
QJsonObject OAIClickModelPg::asJsonObject() const {
    QJsonObject obj;
...
QString OAIClickModelPg::getAccountId() const {
    return m_account_id;
}
void OAIClickModelPg::setAccountId(const QString &account_id) {
    m_account_id = account_id;
    m_account_id_isSet = true;
}

bool OAIClickModelPg::is_account_id_Set() const{
    return m_account_id_isSet;
}

bool OAIClickModelPg::is_account_id_Valid() const{
    return m_account_id_isValid;
}

QString OAIClickModelPg::getAlias() const {
    return m_alias;
}
void OAIClickModelPg::setAlias(const QString &alias) {
    m_alias = alias;
    m_alias_isSet = true;
}

bool OAIClickModelPg::is_alias_Set() const{
    return m_alias_isSet;
}

bool OAIClickModelPg::is_alias_Valid() const{
    return m_alias_isValid;
}

QString OAIClickModelPg::getAliasId() const {
    return m_alias_id;
}
void OAIClickModelPg::setAliasId(const QString &alias_id) {
    m_alias_id = alias_id;
    m_alias_id_isSet = true;
}

bool OAIClickModelPg::is_alias_id_Set() const{
    return m_alias_id_isSet;
}

bool OAIClickModelPg::is_alias_id_Valid() const{
    return m_alias_id_isValid;
}

QString OAIClickModelPg::getBrowser() const {
    return m_browser;
}
void OAIClickModelPg::setBrowser(const QString &browser) {
    m_browser = browser;
    m_browser_isSet = true;
}

bool OAIClickModelPg::is_browser_Set() const{
    return m_browser_isSet;
}

bool OAIClickModelPg::is_browser_Valid() const{
    return m_browser_isValid;
}

QString OAIClickModelPg::getCountry() const {
    return m_country;
}
void OAIClickModelPg::setCountry(const QString &country) {
    m_country = country;
    m_country_isSet = true;
}

bool OAIClickModelPg::is_country_Set() const{
    return m_country_isSet;
}

bool OAIClickModelPg::is_country_Valid() const{
    return m_country_isValid;
}

qint64 OAIClickModelPg::getCreatedAt() const {
    return m_created_at;
}
void OAIClickModelPg::setCreatedAt(const qint64 &created_at) {
    m_created_at = created_at;
    m_created_at_isSet = true;
}

bool OAIClickModelPg::is_created_at_Set() const{
    return m_created_at_isSet;
}

bool OAIClickModelPg::is_created_at_Valid() const{
    return m_created_at_isValid;
}

QString OAIClickModelPg::getDestination() const {
    return m_destination;
}
void OAIClickModelPg::setDestination(const QString &destination) {
    m_destination = destination;
    m_destination_isSet = true;
}

bool OAIClickModelPg::is_destination_Set() const{
    return m_destination_isSet;
}

bool OAIClickModelPg::is_destination_Valid() const{
    return m_destination_isValid;
}

QString OAIClickModelPg::getDomain() const {
    return m_domain;
}
void OAIClickModelPg::setDomain(const QString &domain) {
    m_domain = domain;
    m_domain_isSet = true;
}

bool OAIClickModelPg::is_domain_Set() const{
    return m_domain_isSet;
}

bool OAIClickModelPg::is_domain_Valid() const{
    return m_domain_isValid;
}

qint32 OAIClickModelPg::getId() const {
    return m_id;
}
void OAIClickModelPg::setId(const qint32 &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIClickModelPg::is_id_Set() const{
    return m_id_isSet;
}

bool OAIClickModelPg::is_id_Valid() const{
    return m_id_isValid;
}

QString OAIClickModelPg::getOs() const {
    return m_os;
}
void OAIClickModelPg::setOs(const QString &os) {
    m_os = os;
    m_os_isSet = true;
}

bool OAIClickModelPg::is_os_Set() const{
    return m_os_isSet;
}

bool OAIClickModelPg::is_os_Valid() const{
    return m_os_isValid;
}

QString OAIClickModelPg::getReferrer() const {
    return m_referrer;
}
void OAIClickModelPg::setReferrer(const QString &referrer) {
    m_referrer = referrer;
    m_referrer_isSet = true;
}

bool OAIClickModelPg::is_referrer_Set() const{
    return m_referrer_isSet;
}

bool OAIClickModelPg::is_referrer_Valid() const{
    return m_referrer_isValid;
}

QString OAIClickModelPg::getUserAgent() const {
    return m_user_agent;
}
void OAIClickModelPg::setUserAgent(const QString &user_agent) {
    m_user_agent = user_agent;
    m_user_agent_isSet = true;
}

bool OAIClickModelPg::is_user_agent_Set() const{
    return m_user_agent_isSet;
}

bool OAIClickModelPg::is_user_agent_Valid() const{
    return m_user_agent_isValid;
}

bool OAIClickModelPg::isSet() const {
...
bool OAIClickModelPg::isValid() const {
