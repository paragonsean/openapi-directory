...
#ifndef OAIGetAliasModel_H
#define OAIGetAliasModel_H
...
class OAIGetAliasModel : public OAIObject {
public:
    OAIGetAliasModel();
    OAIGetAliasModel(QString json);
    ~OAIGetAliasModel() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetAliasModel)

#endif // OAIGetAliasModel_H
