...
/*
 * OAIClicksFilterModel.h
 *
 * 
 */

#ifndef OAIClicksFilterModel_H
#define OAIClicksFilterModel_H
...
class OAIClicksFilterModel : public OAIObject {
public:
    OAIClicksFilterModel();
    OAIClicksFilterModel(QString json);
    ~OAIClicksFilterModel() override;
    ...
    qint32 getLastId() const;
    void setLastId(const qint32 &last_id);
...
Q_DECLARE_METATYPE(OpenAPI::OAIClicksFilterModel)

#endif // OAIClicksFilterModel_H
