...
#ifndef OAISnippetModel_H
#define OAISnippetModel_H
...
class OAISnippetModel : public OAIObject {
public:
    OAISnippetModel();
    OAISnippetModel(QString json);
    ~OAISnippetModel() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISnippetModel)

#endif // OAISnippetModel_H
