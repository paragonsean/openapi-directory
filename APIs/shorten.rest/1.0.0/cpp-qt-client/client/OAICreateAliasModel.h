...
/*
 * OAICreateAliasModel.h
 *
 * 
 */

#ifndef OAICreateAliasModel_H
#define OAICreateAliasModel_H

#include <QJsonObject>

#include "OAIDestinationModel.h"
#include "OAIMetaTagModel.h"
#include "OAISnippetModel.h"
#include <QList>
...
namespace OpenAPI {
class OAIDestinationModel;
class OAIMetaTagModel;
class OAISnippetModel;

class OAICreateAliasModel : public OAIObject {
public:
    OAICreateAliasModel();
    OAICreateAliasModel(QString json);
    ~OAICreateAliasModel() override;
    ...
    QList<OAIDestinationModel> getDestinations() const;
    void setDestinations(const QList<OAIDestinationModel> &destinations);
    bool is_destinations_Set() const;
    bool is_destinations_Valid() const;

    QList<OAIMetaTagModel> getMetatags() const;
    void setMetatags(const QList<OAIMetaTagModel> &metatags);
    bool is_metatags_Set() const;
    bool is_metatags_Valid() const;

    QList<OAISnippetModel> getSnippets() const;
    void setSnippets(const QList<OAISnippetModel> &snippets);
...
private:
    ...
    QList<OAIDestinationModel> m_destinations;
    bool m_destinations_isSet;
    bool m_destinations_isValid;

    QList<OAIMetaTagModel> m_metatags;
    bool m_metatags_isSet;
    bool m_metatags_isValid;

    QList<OAISnippetModel> m_snippets;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateAliasModel)

#endif // OAICreateAliasModel_H
