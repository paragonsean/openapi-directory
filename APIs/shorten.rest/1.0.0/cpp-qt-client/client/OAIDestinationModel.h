...
/*
 * OAIDestinationModel.h
 *
 * 
 */

#ifndef OAIDestinationModel_H
#define OAIDestinationModel_H
...
class OAIDestinationModel : public OAIObject {
public:
    OAIDestinationModel();
    OAIDestinationModel(QString json);
    ~OAIDestinationModel() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDestinationModel)

#endif // OAIDestinationModel_H
