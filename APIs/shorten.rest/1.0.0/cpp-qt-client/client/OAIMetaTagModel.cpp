...
OAIMetaTagModel::OAIMetaTagModel(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIMetaTagModel::OAIMetaTagModel() {
    this->initializeModel();
}

OAIMetaTagModel::~OAIMetaTagModel() {}

void OAIMetaTagModel::initializeModel() {
...
void OAIMetaTagModel::fromJson(QString jsonString) {
...
void OAIMetaTagModel::fromJsonObject(QJsonObject json) {
...
QString OAIMetaTagModel::asJson() const {
...
QJsonObject OAIMetaTagModel::asJsonObject() const {
    QJsonObject obj;
    if (m_content_isSet) {
...
QString OAIMetaTagModel::getContent() const {
    return m_content;
}
void OAIMetaTagModel::setContent(const QString &content) {
    m_content = content;
    m_content_isSet = true;
}

bool OAIMetaTagModel::is_content_Set() const{
    return m_content_isSet;
}

bool OAIMetaTagModel::is_content_Valid() const{
    return m_content_isValid;
}

QString OAIMetaTagModel::getName() const {
    return m_name;
}
void OAIMetaTagModel::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIMetaTagModel::is_name_Set() const{
    return m_name_isSet;
}

bool OAIMetaTagModel::is_name_Valid() const{
    return m_name_isValid;
}

bool OAIMetaTagModel::isSet() const {
...
bool OAIMetaTagModel::isValid() const {
