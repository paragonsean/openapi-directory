...
OAIGetAliasesModel::OAIGetAliasesModel(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetAliasesModel::OAIGetAliasesModel() {
    this->initializeModel();
}

OAIGetAliasesModel::~OAIGetAliasesModel() {}

void OAIGetAliasesModel::initializeModel() {
...
void OAIGetAliasesModel::fromJson(QString jsonString) {
...
void OAIGetAliasesModel::fromJsonObject(QJsonObject json) {
...
QString OAIGetAliasesModel::asJson() const {
...
QJsonObject OAIGetAliasesModel::asJsonObject() const {
    QJsonObject obj;
    if (m_aliases.size() > 0) {
...
QList<QString> OAIGetAliasesModel::getAliases() const {
    return m_aliases;
}
void OAIGetAliasesModel::setAliases(const QList<QString> &aliases) {
    m_aliases = aliases;
    m_aliases_isSet = true;
}

bool OAIGetAliasesModel::is_aliases_Set() const{
    return m_aliases_isSet;
}

bool OAIGetAliasesModel::is_aliases_Valid() const{
    return m_aliases_isValid;
}

QString OAIGetAliasesModel::getLastId() const {
    return m_last_id;
}
void OAIGetAliasesModel::setLastId(const QString &last_id) {
    m_last_id = last_id;
    m_last_id_isSet = true;
}

bool OAIGetAliasesModel::is_last_id_Set() const{
    return m_last_id_isSet;
}

bool OAIGetAliasesModel::is_last_id_Valid() const{
    return m_last_id_isValid;
}

bool OAIGetAliasesModel::isSet() const {
...
bool OAIGetAliasesModel::isValid() const {
