...
OAIGetClicksModel::OAIGetClicksModel(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetClicksModel::OAIGetClicksModel() {
    this->initializeModel();
}

OAIGetClicksModel::~OAIGetClicksModel() {}

void OAIGetClicksModel::initializeModel() {
...
void OAIGetClicksModel::fromJson(QString jsonString) {
...
void OAIGetClicksModel::fromJsonObject(QJsonObject json) {
...
QString OAIGetClicksModel::asJson() const {
...
QJsonObject OAIGetClicksModel::asJsonObject() const {
    QJsonObject obj;
    if (m_clicks.size() > 0) {
...
QList<OAIClickModel> OAIGetClicksModel::getClicks() const {
    return m_clicks;
}
void OAIGetClicksModel::setClicks(const QList<OAIClickModel> &clicks) {
    m_clicks = clicks;
    m_clicks_isSet = true;
}

bool OAIGetClicksModel::is_clicks_Set() const{
    return m_clicks_isSet;
}

bool OAIGetClicksModel::is_clicks_Valid() const{
    return m_clicks_isValid;
}

QString OAIGetClicksModel::getLastId() const {
    return m_last_id;
}
void OAIGetClicksModel::setLastId(const QString &last_id) {
    m_last_id = last_id;
    m_last_id_isSet = true;
}

bool OAIGetClicksModel::is_last_id_Set() const{
    return m_last_id_isSet;
}

bool OAIGetClicksModel::is_last_id_Valid() const{
    return m_last_id_isValid;
}

bool OAIGetClicksModel::isSet() const {
...
bool OAIGetClicksModel::isValid() const {
