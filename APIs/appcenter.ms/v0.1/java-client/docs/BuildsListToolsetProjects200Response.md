...
|**buildscripts** | [**Map&lt;String, BuildsListToolsetProjects200ResponseBuildscriptsValue&gt;**](BuildsListToolsetProjects200ResponseBuildscriptsValue.md) | A collection of detected pre/post buildscripts for current platform toolset |  [optional] |
