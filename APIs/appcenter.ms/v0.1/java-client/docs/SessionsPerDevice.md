...
|**sessionsPerUser** | [**List&lt;AnalyticsPerDeviceCounts200ResponseSessionsPerUserInner&gt;**](AnalyticsPerDeviceCounts200ResponseSessionsPerUserInner.md) | The session count for each interval per device. |  [optional] |
