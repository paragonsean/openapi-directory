...
|------------ | ------------- | ------------- | -------------|
|**appexProvisioningProfiles** | [**List&lt;ReleaseCreateRequestAppexProvisioningProfilesInner&gt;**](ReleaseCreateRequestAppexProvisioningProfilesInner.md) | iOS app extension provisioning profiles included in the release. |  [optional] |
...
|**ipaUuids** | [**List&lt;ReleaseCreateRequestIpaUuidsInner&gt;**](ReleaseCreateRequestIpaUuidsInner.md) | A list of UUIDs for architectures for an iOS app. |  [optional] |
