...
|------------ | ------------- | ------------- | -------------|
|**isBillable** | **Boolean** | If the subscription can be used for billing |  [optional] |
|**isBilling** | **Boolean** | If the subscription is used for billing |  [optional] |
|**isMicrosoftInternal** | **Boolean** | If the subscription is internal Microsoft subscription |  [optional] |
