...
|**portalSubdomain** | [**PortalSubdomainEnum**](#PortalSubdomainEnum) | The sub-domain of the portal from which this request was made. Will be used to build the invitation link. |  [optional] |
