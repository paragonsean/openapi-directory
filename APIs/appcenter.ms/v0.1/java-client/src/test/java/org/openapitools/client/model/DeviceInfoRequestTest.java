...
/**
 * Model tests for DeviceInfoRequest
 */
public class DeviceInfoRequestTest {
    private final DeviceInfoRequest model = new DeviceInfoRequest();
