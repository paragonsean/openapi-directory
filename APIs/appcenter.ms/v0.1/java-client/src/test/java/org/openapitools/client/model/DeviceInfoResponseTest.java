...
/**
 * Model tests for DeviceInfoResponse
 */
public class DeviceInfoResponseTest {
    private final DeviceInfoResponse model = new DeviceInfoResponse();
