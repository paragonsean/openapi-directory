...
public class ErrorDeleteCounter {
  ...
  public ErrorDeleteCounter() {
  }

  public ErrorDeleteCounter appId(String appId) {
    this.appId = appId;
    return this;
  }
  ...
  public ErrorDeleteCounter attachmentsDeleted(Integer attachmentsDeleted) {
  ...
  public ErrorDeleteCounter blobsFailed(Integer blobsFailed) {
  ...
  public ErrorDeleteCounter blobsSucceeded(Integer blobsSucceeded) {
  ...
  public ErrorDeleteCounter errorGroupId(String errorGroupId) {
  ...
  public ErrorDeleteCounter errorId(String errorId) {
  ...
  public ErrorDeleteCounter errorsDeleted(Integer errorsDeleted) {
  ...
  public boolean equals(Object o) {
    ...
    ErrorDeleteCounter errorDeleteCounter = (ErrorDeleteCounter) o;
    return Objects.equals(this.appId, errorDeleteCounter.appId) &&
        Objects.equals(this.attachmentsDeleted, errorDeleteCounter.attachmentsDeleted) &&
        Objects.equals(this.blobsFailed, errorDeleteCounter.blobsFailed) &&
        Objects.equals(this.blobsSucceeded, errorDeleteCounter.blobsSucceeded) &&
        Objects.equals(this.errorGroupId, errorDeleteCounter.errorGroupId) &&
        Objects.equals(this.errorId, errorDeleteCounter.errorId) &&
        Objects.equals(this.errorsDeleted, errorDeleteCounter.errorsDeleted);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ErrorDeleteCounter
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ErrorDeleteCounter.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ErrorDeleteCounter is not found in the empty JSON string", ErrorDeleteCounter.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ErrorDeleteCounter.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ErrorDeleteCounter` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ErrorDeleteCounter.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ErrorDeleteCounter' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ErrorDeleteCounter> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ErrorDeleteCounter.class));

       return (TypeAdapter<T>) new TypeAdapter<ErrorDeleteCounter>() {
           @Override
           public void write(JsonWriter out, ErrorDeleteCounter value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ErrorDeleteCounter read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ErrorDeleteCounter given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ErrorDeleteCounter
   * @throws IOException if the JSON string is invalid with respect to ErrorDeleteCounter
   */
  public static ErrorDeleteCounter fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ErrorDeleteCounter.class);
  }

  /**
   * Convert an instance of ErrorDeleteCounter to an JSON string
   *
   * @return JSON string
   */
