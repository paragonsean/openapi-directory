...
public class SymbolUploadsCreateRequest {
  ...
  public SymbolUploadsCreateRequest() {
  }

  public SymbolUploadsCreateRequest build(String build) {
    this.build = build;
    return this;
  }
  ...
  public SymbolUploadsCreateRequest clientCallback(String clientCallback) {
  ...
  public SymbolUploadsCreateRequest fileName(String fileName) {
  ...
  public SymbolUploadsCreateRequest symbolType(SymbolTypeEnum symbolType) {
  ...
  public SymbolUploadsCreateRequest version(String version) {
  ...
  public boolean equals(Object o) {
    ...
    SymbolUploadsCreateRequest symbolUploadsCreateRequest = (SymbolUploadsCreateRequest) o;
    return Objects.equals(this.build, symbolUploadsCreateRequest.build) &&
        Objects.equals(this.clientCallback, symbolUploadsCreateRequest.clientCallback) &&
        Objects.equals(this.fileName, symbolUploadsCreateRequest.fileName) &&
        Objects.equals(this.symbolType, symbolUploadsCreateRequest.symbolType) &&
        Objects.equals(this.version, symbolUploadsCreateRequest.version);
  }
  ...
  public String toString() {
    ...
    sb.append("class SymbolUploadsCreateRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to SymbolUploadsCreateRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SymbolUploadsCreateRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SymbolUploadsCreateRequest is not found in the empty JSON string", SymbolUploadsCreateRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SymbolUploadsCreateRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SymbolUploadsCreateRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : SymbolUploadsCreateRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SymbolUploadsCreateRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SymbolUploadsCreateRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SymbolUploadsCreateRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SymbolUploadsCreateRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<SymbolUploadsCreateRequest>() {
           @Override
           public void write(JsonWriter out, SymbolUploadsCreateRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SymbolUploadsCreateRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SymbolUploadsCreateRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SymbolUploadsCreateRequest
   * @throws IOException if the JSON string is invalid with respect to SymbolUploadsCreateRequest
   */
  public static SymbolUploadsCreateRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SymbolUploadsCreateRequest.class);
  }

  /**
   * Convert an instance of SymbolUploadsCreateRequest to an JSON string
   *
   * @return JSON string
   */
