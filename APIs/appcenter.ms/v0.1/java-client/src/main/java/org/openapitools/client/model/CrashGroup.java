...
public class CrashGroup {
  ...
  public CrashGroup annotation(String annotation) {
  ...
  public CrashGroup appVersion(String appVersion) {
  ...
  public CrashGroup build(String build) {
    this.build = build;
    return this;
  }
  ...
  public CrashGroup count(Integer count) {
    this.count = count;
    return this;
  }
  ...
  public CrashGroup crashGroupId(String crashGroupId) {
  ...
  public CrashGroup crashReason(String crashReason) {
  ...
  public CrashGroup displayId(String displayId) {
  ...
  public CrashGroup exception(String exception) {
  ...
  public CrashGroup fatal(Boolean fatal) {
    this.fatal = fatal;
    return this;
  }
  ...
  public CrashGroup firstOccurrence(OffsetDateTime firstOccurrence) {
  ...
  public CrashGroup impactedUsers(Integer impactedUsers) {
  ...
  public CrashGroup lastOccurrence(OffsetDateTime lastOccurrence) {
  ...
  public CrashGroup newCrashGroupId(String newCrashGroupId) {
  ...
  public CrashGroup reasonFrame(CrashGroupsList200ResponseCrashGroupsInnerReasonFrame reasonFrame) {
  ...
  public CrashGroup status(StatusEnum status) {
    this.status = status;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    CrashGroup crashGroup = (CrashGroup) o;
    return Objects.equals(this.annotation, crashGroup.annotation) &&
        Objects.equals(this.appVersion, crashGroup.appVersion) &&
        Objects.equals(this.build, crashGroup.build) &&
        Objects.equals(this.count, crashGroup.count) &&
        Objects.equals(this.crashGroupId, crashGroup.crashGroupId) &&
        Objects.equals(this.crashReason, crashGroup.crashReason) &&
        Objects.equals(this.displayId, crashGroup.displayId) &&
        Objects.equals(this.exception, crashGroup.exception) &&
        Objects.equals(this.fatal, crashGroup.fatal) &&
        Objects.equals(this.firstOccurrence, crashGroup.firstOccurrence) &&
        Objects.equals(this.impactedUsers, crashGroup.impactedUsers) &&
        Objects.equals(this.lastOccurrence, crashGroup.lastOccurrence) &&
        Objects.equals(this.newCrashGroupId, crashGroup.newCrashGroupId) &&
        Objects.equals(this.reasonFrame, crashGroup.reasonFrame) &&
        Objects.equals(this.status, crashGroup.status);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to CrashGroup
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CrashGroup.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CrashGroup is not found in the empty JSON string", CrashGroup.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CrashGroup.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CrashGroup` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CrashGroup.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CrashGroup.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CrashGroup' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CrashGroup> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CrashGroup.class));

       return (TypeAdapter<T>) new TypeAdapter<CrashGroup>() {
           @Override
           public void write(JsonWriter out, CrashGroup value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CrashGroup read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CrashGroup given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CrashGroup
   * @throws IOException if the JSON string is invalid with respect to CrashGroup
   */
  public static CrashGroup fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CrashGroup.class);
  }

  /**
   * Convert an instance of CrashGroup to an JSON string
   *
   * @return JSON string
   */
