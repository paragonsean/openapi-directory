...
public class ExportConfigurationsList200ResponseValuesInner {
  ...
  public ExportConfigurationsList200ResponseValuesInner() {
  }

  public ExportConfigurationsList200ResponseValuesInner creationTime(String creationTime) {
  ...
  public ExportConfigurationsList200ResponseValuesInner exportConfiguration(ExportConfigurationsList200ResponseValuesInnerExportConfiguration exportConfiguration) {
  ...
  public ExportConfigurationsList200ResponseValuesInner exportEntities(List<ExportEntitiesEnum> exportEntities) {
    this.exportEntities = exportEntities;
    return this;
  }

  public ExportConfigurationsList200ResponseValuesInner addExportEntitiesItem(ExportEntitiesEnum exportEntitiesItem) {
  ...
  public ExportConfigurationsList200ResponseValuesInner exportType(ExportTypeEnum exportType) {
  ...
  public ExportConfigurationsList200ResponseValuesInner id(String id) {
    this.id = id;
    return this;
  }
  ...
  public ExportConfigurationsList200ResponseValuesInner lastRunTime(String lastRunTime) {
  ...
  public ExportConfigurationsList200ResponseValuesInner resourceGroup(String resourceGroup) {
  ...
  public ExportConfigurationsList200ResponseValuesInner resourceName(String resourceName) {
  ...
  public ExportConfigurationsList200ResponseValuesInner state(StateEnum state) {
    this.state = state;
    return this;
  }
  ...
  public ExportConfigurationsList200ResponseValuesInner stateInfo(String stateInfo) {
  ...
  public boolean equals(Object o) {
    ...
    ExportConfigurationsList200ResponseValuesInner exportConfigurationsList200ResponseValuesInner = (ExportConfigurationsList200ResponseValuesInner) o;
    return Objects.equals(this.creationTime, exportConfigurationsList200ResponseValuesInner.creationTime) &&
        Objects.equals(this.exportConfiguration, exportConfigurationsList200ResponseValuesInner.exportConfiguration) &&
        Objects.equals(this.exportEntities, exportConfigurationsList200ResponseValuesInner.exportEntities) &&
        Objects.equals(this.exportType, exportConfigurationsList200ResponseValuesInner.exportType) &&
        Objects.equals(this.id, exportConfigurationsList200ResponseValuesInner.id) &&
        Objects.equals(this.lastRunTime, exportConfigurationsList200ResponseValuesInner.lastRunTime) &&
        Objects.equals(this.resourceGroup, exportConfigurationsList200ResponseValuesInner.resourceGroup) &&
        Objects.equals(this.resourceName, exportConfigurationsList200ResponseValuesInner.resourceName) &&
        Objects.equals(this.state, exportConfigurationsList200ResponseValuesInner.state) &&
        Objects.equals(this.stateInfo, exportConfigurationsList200ResponseValuesInner.stateInfo);
  }
  ...
  public String toString() {
    ...
    sb.append("class ExportConfigurationsList200ResponseValuesInner {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ExportConfigurationsList200ResponseValuesInner
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ExportConfigurationsList200ResponseValuesInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ExportConfigurationsList200ResponseValuesInner is not found in the empty JSON string", ExportConfigurationsList200ResponseValuesInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ExportConfigurationsList200ResponseValuesInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ExportConfigurationsList200ResponseValuesInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ExportConfigurationsList200ResponseValuesInner.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ExportConfigurationsList200ResponseValuesInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ExportConfigurationsList200ResponseValuesInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ExportConfigurationsList200ResponseValuesInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ExportConfigurationsList200ResponseValuesInner.class));

       return (TypeAdapter<T>) new TypeAdapter<ExportConfigurationsList200ResponseValuesInner>() {
           @Override
           public void write(JsonWriter out, ExportConfigurationsList200ResponseValuesInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ExportConfigurationsList200ResponseValuesInner read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ExportConfigurationsList200ResponseValuesInner given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ExportConfigurationsList200ResponseValuesInner
   * @throws IOException if the JSON string is invalid with respect to ExportConfigurationsList200ResponseValuesInner
   */
  public static ExportConfigurationsList200ResponseValuesInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ExportConfigurationsList200ResponseValuesInner.class);
  }

  /**
   * Convert an instance of ExportConfigurationsList200ResponseValuesInner to an JSON string
   *
   * @return JSON string
   */
