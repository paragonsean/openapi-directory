...
public class TeamUpdateRequest {
  ...
  public TeamUpdateRequest displayName(String displayName) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.displayName, teamUpdateRequest.displayName);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TeamUpdateRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TeamUpdateRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
