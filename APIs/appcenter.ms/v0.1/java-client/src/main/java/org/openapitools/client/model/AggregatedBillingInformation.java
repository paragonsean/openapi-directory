...
public class AggregatedBillingInformation {
  ...
  public AggregatedBillingInformation azureSubscriptionId(String azureSubscriptionId) {
  ...
  public AggregatedBillingInformation azureSubscriptionState(AzureSubscriptionStateEnum azureSubscriptionState) {
  ...
  public AggregatedBillingInformation billingPlans(BillingAggregatedInformationGetByApp200ResponseBillingPlans billingPlans) {
  ...
  public AggregatedBillingInformation id(String id) {
    this.id = id;
    return this;
  }
  ...
  public AggregatedBillingInformation timestamp(String timestamp) {
  ...
  public AggregatedBillingInformation usage(BillingAggregatedInformationGetByApp200ResponseUsage usage) {
    this.usage = usage;
    return this;
  }
  ...
  public AggregatedBillingInformation version(String version) {
  ...
  public boolean equals(Object o) {
    ...
    AggregatedBillingInformation aggregatedBillingInformation = (AggregatedBillingInformation) o;
    return Objects.equals(this.azureSubscriptionId, aggregatedBillingInformation.azureSubscriptionId) &&
        Objects.equals(this.azureSubscriptionState, aggregatedBillingInformation.azureSubscriptionState) &&
        Objects.equals(this.billingPlans, aggregatedBillingInformation.billingPlans) &&
        Objects.equals(this.id, aggregatedBillingInformation.id) &&
        Objects.equals(this.timestamp, aggregatedBillingInformation.timestamp) &&
        Objects.equals(this.usage, aggregatedBillingInformation.usage) &&
        Objects.equals(this.version, aggregatedBillingInformation.version);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to AggregatedBillingInformation
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AggregatedBillingInformation.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AggregatedBillingInformation is not found in the empty JSON string", AggregatedBillingInformation.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AggregatedBillingInformation.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AggregatedBillingInformation` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AggregatedBillingInformation.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AggregatedBillingInformation' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AggregatedBillingInformation> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AggregatedBillingInformation.class));

       return (TypeAdapter<T>) new TypeAdapter<AggregatedBillingInformation>() {
           @Override
           public void write(JsonWriter out, AggregatedBillingInformation value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AggregatedBillingInformation read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AggregatedBillingInformation given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AggregatedBillingInformation
   * @throws IOException if the JSON string is invalid with respect to AggregatedBillingInformation
   */
  public static AggregatedBillingInformation fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AggregatedBillingInformation.class);
  }

  /**
   * Convert an instance of AggregatedBillingInformation to an JSON string
   *
   * @return JSON string
   */
