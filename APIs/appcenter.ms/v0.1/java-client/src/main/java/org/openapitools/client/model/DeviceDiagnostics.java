...
public class DeviceDiagnostics {
  ...
  public DeviceDiagnostics appBuild(String appBuild) {
  ...
  public DeviceDiagnostics appNamespace(String appNamespace) {
  ...
  public DeviceDiagnostics appVersion(String appVersion) {
  ...
  public DeviceDiagnostics carrierCode(String carrierCode) {
  ...
  public DeviceDiagnostics carrierCountry(String carrierCountry) {
  ...
  public DeviceDiagnostics carrierName(String carrierName) {
  ...
  public DeviceDiagnostics liveUpdateDeploymentKey(String liveUpdateDeploymentKey) {
  ...
  public DeviceDiagnostics liveUpdatePackageHash(String liveUpdatePackageHash) {
  ...
  public DeviceDiagnostics liveUpdateReleaseLabel(String liveUpdateReleaseLabel) {
  ...
  public DeviceDiagnostics locale(String locale) {
    this.locale = locale;
    return this;
  }
  ...
  public DeviceDiagnostics model(String model) {
    this.model = model;
    return this;
  }
  ...
  public DeviceDiagnostics oemName(String oemName) {
  ...
  public DeviceDiagnostics osApiLevel(Integer osApiLevel) {
  ...
  public DeviceDiagnostics osBuild(String osBuild) {
  ...
  public DeviceDiagnostics osName(String osName) {
    this.osName = osName;
    return this;
  }
  ...
  public DeviceDiagnostics osVersion(String osVersion) {
  ...
  public DeviceDiagnostics screenSize(String screenSize) {
  ...
  public DeviceDiagnostics sdkName(String sdkName) {
  ...
  public DeviceDiagnostics sdkVersion(String sdkVersion) {
  ...
  public DeviceDiagnostics timeZoneOffset(Integer timeZoneOffset) {
  ...
  public DeviceDiagnostics wrapperRuntimeVersion(String wrapperRuntimeVersion) {
  ...
  public DeviceDiagnostics wrapperSdkName(String wrapperSdkName) {
  ...
  public DeviceDiagnostics wrapperSdkVersion(String wrapperSdkVersion) {
  ...
  public boolean equals(Object o) {
    ...
    DeviceDiagnostics deviceDiagnostics = (DeviceDiagnostics) o;
    return Objects.equals(this.appBuild, deviceDiagnostics.appBuild) &&
        Objects.equals(this.appNamespace, deviceDiagnostics.appNamespace) &&
        Objects.equals(this.appVersion, deviceDiagnostics.appVersion) &&
        Objects.equals(this.carrierCode, deviceDiagnostics.carrierCode) &&
        Objects.equals(this.carrierCountry, deviceDiagnostics.carrierCountry) &&
        Objects.equals(this.carrierName, deviceDiagnostics.carrierName) &&
        Objects.equals(this.liveUpdateDeploymentKey, deviceDiagnostics.liveUpdateDeploymentKey) &&
        Objects.equals(this.liveUpdatePackageHash, deviceDiagnostics.liveUpdatePackageHash) &&
        Objects.equals(this.liveUpdateReleaseLabel, deviceDiagnostics.liveUpdateReleaseLabel) &&
        Objects.equals(this.locale, deviceDiagnostics.locale) &&
        Objects.equals(this.model, deviceDiagnostics.model) &&
        Objects.equals(this.oemName, deviceDiagnostics.oemName) &&
        Objects.equals(this.osApiLevel, deviceDiagnostics.osApiLevel) &&
        Objects.equals(this.osBuild, deviceDiagnostics.osBuild) &&
        Objects.equals(this.osName, deviceDiagnostics.osName) &&
        Objects.equals(this.osVersion, deviceDiagnostics.osVersion) &&
        Objects.equals(this.screenSize, deviceDiagnostics.screenSize) &&
        Objects.equals(this.sdkName, deviceDiagnostics.sdkName) &&
        Objects.equals(this.sdkVersion, deviceDiagnostics.sdkVersion) &&
        Objects.equals(this.timeZoneOffset, deviceDiagnostics.timeZoneOffset) &&
        Objects.equals(this.wrapperRuntimeVersion, deviceDiagnostics.wrapperRuntimeVersion) &&
        Objects.equals(this.wrapperSdkName, deviceDiagnostics.wrapperSdkName) &&
        Objects.equals(this.wrapperSdkVersion, deviceDiagnostics.wrapperSdkVersion);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to DeviceDiagnostics
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DeviceDiagnostics.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DeviceDiagnostics is not found in the empty JSON string", DeviceDiagnostics.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DeviceDiagnostics.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DeviceDiagnostics` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DeviceDiagnostics.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DeviceDiagnostics.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DeviceDiagnostics' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DeviceDiagnostics> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DeviceDiagnostics.class));

       return (TypeAdapter<T>) new TypeAdapter<DeviceDiagnostics>() {
           @Override
           public void write(JsonWriter out, DeviceDiagnostics value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DeviceDiagnostics read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DeviceDiagnostics given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DeviceDiagnostics
   * @throws IOException if the JSON string is invalid with respect to DeviceDiagnostics
   */
  public static DeviceDiagnostics fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DeviceDiagnostics.class);
  }

  /**
   * Convert an instance of DeviceDiagnostics to an JSON string
   *
   * @return JSON string
   */
