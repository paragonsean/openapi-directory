...
public class RepoConfig {
  ...
  public RepoConfig id(String id) {
    this.id = id;
    return this;
  }
  ...
  public RepoConfig state(StateEnum state) {
    this.state = state;
    return this;
  }
  ...
  public RepoConfig type(String type) {
    this.type = type;
    return this;
  }
  ...
  public RepoConfig userEmail(String userEmail) {
  ...
  public RepoConfig installationId(String installationId) {
  ...
  public RepoConfig externalUserId(String externalUserId) {
  ...
  public RepoConfig repoId(String repoId) {
    this.repoId = repoId;
    return this;
  }
  ...
  public RepoConfig repoUrl(String repoUrl) {
  ...
  public RepoConfig serviceConnectionId(String serviceConnectionId) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, repoConfig.id) &&
        Objects.equals(this.state, repoConfig.state) &&
        Objects.equals(this.type, repoConfig.type) &&
        Objects.equals(this.userEmail, repoConfig.userEmail) &&
        Objects.equals(this.installationId, repoConfig.installationId) &&
        Objects.equals(this.externalUserId, repoConfig.externalUserId) &&
        Objects.equals(this.repoId, repoConfig.repoId) &&
        Objects.equals(this.repoUrl, repoConfig.repoUrl) &&
        Objects.equals(this.serviceConnectionId, repoConfig.serviceConnectionId);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to RepoConfig
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RepoConfig.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in RepoConfig is not found in the empty JSON string", RepoConfig.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RepoConfig.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `RepoConfig` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : RepoConfig.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RepoConfig.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RepoConfig' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RepoConfig> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RepoConfig.class));

       return (TypeAdapter<T>) new TypeAdapter<RepoConfig>() {
           @Override
           public void write(JsonWriter out, RepoConfig value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public RepoConfig read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of RepoConfig given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of RepoConfig
   * @throws IOException if the JSON string is invalid with respect to RepoConfig
   */
  public static RepoConfig fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RepoConfig.class);
  }

  /**
   * Convert an instance of RepoConfig to an JSON string
   *
   * @return JSON string
   */
