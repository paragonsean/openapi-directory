...
public class BranchConfiguration {
  ...
  public BranchConfiguration artifactVersioning(BranchConfigurationsGet200ResponseAllOfArtifactVersioning artifactVersioning) {
  ...
  public BranchConfiguration badgeIsEnabled(Boolean badgeIsEnabled) {
  ...
  public BranchConfiguration cloneFromBranch(String cloneFromBranch) {
  ...
  public BranchConfiguration signed(Boolean signed) {
    this.signed = signed;
    return this;
  }
  ...
  public BranchConfiguration testsEnabled(Boolean testsEnabled) {
  ...
  public BranchConfiguration toolsets(BranchConfigurationsGet200ResponseAllOfToolsets toolsets) {
  ...
  public BranchConfiguration trigger(TriggerEnum trigger) {
   ...
   * @return the BranchConfiguration instance itself
   */
  public BranchConfiguration putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    BranchConfiguration branchConfiguration = (BranchConfiguration) o;
    return Objects.equals(this.artifactVersioning, branchConfiguration.artifactVersioning) &&
        Objects.equals(this.badgeIsEnabled, branchConfiguration.badgeIsEnabled) &&
        Objects.equals(this.cloneFromBranch, branchConfiguration.cloneFromBranch) &&
        Objects.equals(this.signed, branchConfiguration.signed) &&
        Objects.equals(this.testsEnabled, branchConfiguration.testsEnabled) &&
        Objects.equals(this.toolsets, branchConfiguration.toolsets) &&
        Objects.equals(this.trigger, branchConfiguration.trigger)&&
        Objects.equals(this.additionalProperties, branchConfiguration.additionalProperties);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to BranchConfiguration
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!BranchConfiguration.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in BranchConfiguration is not found in the empty JSON string", BranchConfiguration.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!BranchConfiguration.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'BranchConfiguration' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<BranchConfiguration> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(BranchConfiguration.class));

       return (TypeAdapter<T>) new TypeAdapter<BranchConfiguration>() {
           @Override
           public void write(JsonWriter out, BranchConfiguration value) throws IOException {
           ...
           @Override
           public BranchConfiguration read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             BranchConfiguration instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of BranchConfiguration given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of BranchConfiguration
   * @throws IOException if the JSON string is invalid with respect to BranchConfiguration
   */
  public static BranchConfiguration fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, BranchConfiguration.class);
  }

  /**
   * Convert an instance of BranchConfiguration to an JSON string
   *
   * @return JSON string
   */
