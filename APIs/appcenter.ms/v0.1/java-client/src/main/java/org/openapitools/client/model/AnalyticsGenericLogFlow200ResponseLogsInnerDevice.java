...
public class AnalyticsGenericLogFlow200ResponseLogsInnerDevice {
  ...
  public AnalyticsGenericLogFlow200ResponseLogsInnerDevice() {
  }

  public AnalyticsGenericLogFlow200ResponseLogsInnerDevice appBuild(String appBuild) {
  ...
  public AnalyticsGenericLogFlow200ResponseLogsInnerDevice appNamespace(String appNamespace) {
  ...
  public AnalyticsGenericLogFlow200ResponseLogsInnerDevice appVersion(String appVersion) {
  ...
  public AnalyticsGenericLogFlow200ResponseLogsInnerDevice carrierCode(String carrierCode) {
  ...
  public AnalyticsGenericLogFlow200ResponseLogsInnerDevice carrierCountry(String carrierCountry) {
  ...
  public AnalyticsGenericLogFlow200ResponseLogsInnerDevice carrierName(String carrierName) {
  ...
  public AnalyticsGenericLogFlow200ResponseLogsInnerDevice liveUpdateDeploymentKey(String liveUpdateDeploymentKey) {
  ...
  public AnalyticsGenericLogFlow200ResponseLogsInnerDevice liveUpdatePackageHash(String liveUpdatePackageHash) {
  ...
  public AnalyticsGenericLogFlow200ResponseLogsInnerDevice liveUpdateReleaseLabel(String liveUpdateReleaseLabel) {
  ...
  public AnalyticsGenericLogFlow200ResponseLogsInnerDevice locale(String locale) {
    this.locale = locale;
    return this;
  }
  ...
  public AnalyticsGenericLogFlow200ResponseLogsInnerDevice model(String model) {
    this.model = model;
    return this;
  }
  ...
  public AnalyticsGenericLogFlow200ResponseLogsInnerDevice oemName(String oemName) {
  ...
  public AnalyticsGenericLogFlow200ResponseLogsInnerDevice osApiLevel(Integer osApiLevel) {
  ...
  public AnalyticsGenericLogFlow200ResponseLogsInnerDevice osBuild(String osBuild) {
  ...
  public AnalyticsGenericLogFlow200ResponseLogsInnerDevice osName(String osName) {
    this.osName = osName;
    return this;
  }
  ...
  public AnalyticsGenericLogFlow200ResponseLogsInnerDevice osVersion(String osVersion) {
  ...
  public AnalyticsGenericLogFlow200ResponseLogsInnerDevice screenSize(String screenSize) {
  ...
  public AnalyticsGenericLogFlow200ResponseLogsInnerDevice sdkName(String sdkName) {
  ...
  public AnalyticsGenericLogFlow200ResponseLogsInnerDevice sdkVersion(String sdkVersion) {
  ...
  public AnalyticsGenericLogFlow200ResponseLogsInnerDevice timeZoneOffset(Integer timeZoneOffset) {
  ...
  public AnalyticsGenericLogFlow200ResponseLogsInnerDevice wrapperRuntimeVersion(String wrapperRuntimeVersion) {
  ...
  public AnalyticsGenericLogFlow200ResponseLogsInnerDevice wrapperSdkName(String wrapperSdkName) {
  ...
  public AnalyticsGenericLogFlow200ResponseLogsInnerDevice wrapperSdkVersion(String wrapperSdkVersion) {
  ...
  public boolean equals(Object o) {
    ...
    AnalyticsGenericLogFlow200ResponseLogsInnerDevice analyticsGenericLogFlow200ResponseLogsInnerDevice = (AnalyticsGenericLogFlow200ResponseLogsInnerDevice) o;
    return Objects.equals(this.appBuild, analyticsGenericLogFlow200ResponseLogsInnerDevice.appBuild) &&
        Objects.equals(this.appNamespace, analyticsGenericLogFlow200ResponseLogsInnerDevice.appNamespace) &&
        Objects.equals(this.appVersion, analyticsGenericLogFlow200ResponseLogsInnerDevice.appVersion) &&
        Objects.equals(this.carrierCode, analyticsGenericLogFlow200ResponseLogsInnerDevice.carrierCode) &&
        Objects.equals(this.carrierCountry, analyticsGenericLogFlow200ResponseLogsInnerDevice.carrierCountry) &&
        Objects.equals(this.carrierName, analyticsGenericLogFlow200ResponseLogsInnerDevice.carrierName) &&
        Objects.equals(this.liveUpdateDeploymentKey, analyticsGenericLogFlow200ResponseLogsInnerDevice.liveUpdateDeploymentKey) &&
        Objects.equals(this.liveUpdatePackageHash, analyticsGenericLogFlow200ResponseLogsInnerDevice.liveUpdatePackageHash) &&
        Objects.equals(this.liveUpdateReleaseLabel, analyticsGenericLogFlow200ResponseLogsInnerDevice.liveUpdateReleaseLabel) &&
        Objects.equals(this.locale, analyticsGenericLogFlow200ResponseLogsInnerDevice.locale) &&
        Objects.equals(this.model, analyticsGenericLogFlow200ResponseLogsInnerDevice.model) &&
        Objects.equals(this.oemName, analyticsGenericLogFlow200ResponseLogsInnerDevice.oemName) &&
        Objects.equals(this.osApiLevel, analyticsGenericLogFlow200ResponseLogsInnerDevice.osApiLevel) &&
        Objects.equals(this.osBuild, analyticsGenericLogFlow200ResponseLogsInnerDevice.osBuild) &&
        Objects.equals(this.osName, analyticsGenericLogFlow200ResponseLogsInnerDevice.osName) &&
        Objects.equals(this.osVersion, analyticsGenericLogFlow200ResponseLogsInnerDevice.osVersion) &&
        Objects.equals(this.screenSize, analyticsGenericLogFlow200ResponseLogsInnerDevice.screenSize) &&
        Objects.equals(this.sdkName, analyticsGenericLogFlow200ResponseLogsInnerDevice.sdkName) &&
        Objects.equals(this.sdkVersion, analyticsGenericLogFlow200ResponseLogsInnerDevice.sdkVersion) &&
        Objects.equals(this.timeZoneOffset, analyticsGenericLogFlow200ResponseLogsInnerDevice.timeZoneOffset) &&
        Objects.equals(this.wrapperRuntimeVersion, analyticsGenericLogFlow200ResponseLogsInnerDevice.wrapperRuntimeVersion) &&
        Objects.equals(this.wrapperSdkName, analyticsGenericLogFlow200ResponseLogsInnerDevice.wrapperSdkName) &&
        Objects.equals(this.wrapperSdkVersion, analyticsGenericLogFlow200ResponseLogsInnerDevice.wrapperSdkVersion);
  }
  ...
  public String toString() {
    ...
    sb.append("class AnalyticsGenericLogFlow200ResponseLogsInnerDevice {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AnalyticsGenericLogFlow200ResponseLogsInnerDevice
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AnalyticsGenericLogFlow200ResponseLogsInnerDevice.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AnalyticsGenericLogFlow200ResponseLogsInnerDevice is not found in the empty JSON string", AnalyticsGenericLogFlow200ResponseLogsInnerDevice.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AnalyticsGenericLogFlow200ResponseLogsInnerDevice.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AnalyticsGenericLogFlow200ResponseLogsInnerDevice` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AnalyticsGenericLogFlow200ResponseLogsInnerDevice.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AnalyticsGenericLogFlow200ResponseLogsInnerDevice.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AnalyticsGenericLogFlow200ResponseLogsInnerDevice' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AnalyticsGenericLogFlow200ResponseLogsInnerDevice> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AnalyticsGenericLogFlow200ResponseLogsInnerDevice.class));

       return (TypeAdapter<T>) new TypeAdapter<AnalyticsGenericLogFlow200ResponseLogsInnerDevice>() {
           @Override
           public void write(JsonWriter out, AnalyticsGenericLogFlow200ResponseLogsInnerDevice value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AnalyticsGenericLogFlow200ResponseLogsInnerDevice read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AnalyticsGenericLogFlow200ResponseLogsInnerDevice given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AnalyticsGenericLogFlow200ResponseLogsInnerDevice
   * @throws IOException if the JSON string is invalid with respect to AnalyticsGenericLogFlow200ResponseLogsInnerDevice
   */
  public static AnalyticsGenericLogFlow200ResponseLogsInnerDevice fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AnalyticsGenericLogFlow200ResponseLogsInnerDevice.class);
  }

  /**
   * Convert an instance of AnalyticsGenericLogFlow200ResponseLogsInnerDevice to an JSON string
   *
   * @return JSON string
   */
