...
public class TestGetDeviceConfigurations200ResponseInnerModel {
  ...
  public TestGetDeviceConfigurations200ResponseInnerModel() {
  }

  public TestGetDeviceConfigurations200ResponseInnerModel availabilityCount(BigDecimal availabilityCount) {
  ...
  public TestGetDeviceConfigurations200ResponseInnerModel cpu(TestGetDeviceConfigurations200ResponseInnerModelCpu cpu) {
    this.cpu = cpu;
    return this;
  }
  ...
  public TestGetDeviceConfigurations200ResponseInnerModel deviceFrame(TestGetDeviceConfigurations200ResponseInnerModelDeviceFrame deviceFrame) {
  ...
  public TestGetDeviceConfigurations200ResponseInnerModel dimensions(TestGetDeviceConfigurations200ResponseInnerModelDimensions dimensions) {
  ...
  public TestGetDeviceConfigurations200ResponseInnerModel formFactor(String formFactor) {
  ...
  public TestGetDeviceConfigurations200ResponseInnerModel manufacturer(String manufacturer) {
  ...
  public TestGetDeviceConfigurations200ResponseInnerModel memory(TestGetDeviceConfigurations200ResponseInnerModelMemory memory) {
    this.memory = memory;
    return this;
  }
  ...
  public TestGetDeviceConfigurations200ResponseInnerModel model(String model) {
    this.model = model;
    return this;
  }
  ...
  public TestGetDeviceConfigurations200ResponseInnerModel name(String name) {
    this.name = name;
    return this;
  }
  ...
  public TestGetDeviceConfigurations200ResponseInnerModel platform(String platform) {
  ...
  public TestGetDeviceConfigurations200ResponseInnerModel releaseDate(String releaseDate) {
  ...
  public TestGetDeviceConfigurations200ResponseInnerModel resolution(TestGetDeviceConfigurations200ResponseInnerModelResolution resolution) {
  ...
  public TestGetDeviceConfigurations200ResponseInnerModel screenRotation(BigDecimal screenRotation) {
  ...
  public TestGetDeviceConfigurations200ResponseInnerModel screenSize(TestGetDeviceConfigurations200ResponseInnerModelScreenSize screenSize) {
  ...
  public boolean equals(Object o) {
    ...
    TestGetDeviceConfigurations200ResponseInnerModel testGetDeviceConfigurations200ResponseInnerModel = (TestGetDeviceConfigurations200ResponseInnerModel) o;
    return Objects.equals(this.availabilityCount, testGetDeviceConfigurations200ResponseInnerModel.availabilityCount) &&
        Objects.equals(this.cpu, testGetDeviceConfigurations200ResponseInnerModel.cpu) &&
        Objects.equals(this.deviceFrame, testGetDeviceConfigurations200ResponseInnerModel.deviceFrame) &&
        Objects.equals(this.dimensions, testGetDeviceConfigurations200ResponseInnerModel.dimensions) &&
        Objects.equals(this.formFactor, testGetDeviceConfigurations200ResponseInnerModel.formFactor) &&
        Objects.equals(this.manufacturer, testGetDeviceConfigurations200ResponseInnerModel.manufacturer) &&
        Objects.equals(this.memory, testGetDeviceConfigurations200ResponseInnerModel.memory) &&
        Objects.equals(this.model, testGetDeviceConfigurations200ResponseInnerModel.model) &&
        Objects.equals(this.name, testGetDeviceConfigurations200ResponseInnerModel.name) &&
        Objects.equals(this.platform, testGetDeviceConfigurations200ResponseInnerModel.platform) &&
        Objects.equals(this.releaseDate, testGetDeviceConfigurations200ResponseInnerModel.releaseDate) &&
        Objects.equals(this.resolution, testGetDeviceConfigurations200ResponseInnerModel.resolution) &&
        Objects.equals(this.screenRotation, testGetDeviceConfigurations200ResponseInnerModel.screenRotation) &&
        Objects.equals(this.screenSize, testGetDeviceConfigurations200ResponseInnerModel.screenSize);
  }
  ...
  public String toString() {
    ...
    sb.append("class TestGetDeviceConfigurations200ResponseInnerModel {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to TestGetDeviceConfigurations200ResponseInnerModel
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TestGetDeviceConfigurations200ResponseInnerModel.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TestGetDeviceConfigurations200ResponseInnerModel is not found in the empty JSON string", TestGetDeviceConfigurations200ResponseInnerModel.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TestGetDeviceConfigurations200ResponseInnerModel.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TestGetDeviceConfigurations200ResponseInnerModel` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TestGetDeviceConfigurations200ResponseInnerModel.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TestGetDeviceConfigurations200ResponseInnerModel' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TestGetDeviceConfigurations200ResponseInnerModel> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TestGetDeviceConfigurations200ResponseInnerModel.class));

       return (TypeAdapter<T>) new TypeAdapter<TestGetDeviceConfigurations200ResponseInnerModel>() {
           @Override
           public void write(JsonWriter out, TestGetDeviceConfigurations200ResponseInnerModel value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TestGetDeviceConfigurations200ResponseInnerModel read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of TestGetDeviceConfigurations200ResponseInnerModel given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of TestGetDeviceConfigurations200ResponseInnerModel
   * @throws IOException if the JSON string is invalid with respect to TestGetDeviceConfigurations200ResponseInnerModel
   */
  public static TestGetDeviceConfigurations200ResponseInnerModel fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TestGetDeviceConfigurations200ResponseInnerModel.class);
  }

  /**
   * Convert an instance of TestGetDeviceConfigurations200ResponseInnerModel to an JSON string
   *
   * @return JSON string
   */
