...
public class GenericLog {
  ...
  public GenericLog accountId(String accountId) {
  ...
  public GenericLog authProvider(String authProvider) {
  ...
  public GenericLog device(AnalyticsGenericLogFlow200ResponseLogsInnerDevice device) {
    this.device = device;
    return this;
  }
  ...
  public GenericLog eventId(String eventId) {
  ...
  public GenericLog eventName(String eventName) {
  ...
  public GenericLog installId(UUID installId) {
  ...
  public GenericLog messageId(String messageId) {
  ...
  public GenericLog properties(Map<String, String> properties) {
    this.properties = properties;
    return this;
  }

  public GenericLog putPropertiesItem(String key, String propertiesItem) {
  ...
  public GenericLog sessionId(UUID sessionId) {
  ...
  public GenericLog timestamp(OffsetDateTime timestamp) {
  ...
  public GenericLog type(TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.accountId, genericLog.accountId) &&
        Objects.equals(this.authProvider, genericLog.authProvider) &&
        Objects.equals(this.device, genericLog.device) &&
        Objects.equals(this.eventId, genericLog.eventId) &&
        Objects.equals(this.eventName, genericLog.eventName) &&
        Objects.equals(this.installId, genericLog.installId) &&
        Objects.equals(this.messageId, genericLog.messageId) &&
        Objects.equals(this.properties, genericLog.properties) &&
        Objects.equals(this.sessionId, genericLog.sessionId) &&
        Objects.equals(this.timestamp, genericLog.timestamp) &&
        Objects.equals(this.type, genericLog.type);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to GenericLog
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GenericLog.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GenericLog is not found in the empty JSON string", GenericLog.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GenericLog.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GenericLog` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GenericLog.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GenericLog.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GenericLog' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GenericLog> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GenericLog.class));

       return (TypeAdapter<T>) new TypeAdapter<GenericLog>() {
           @Override
           public void write(JsonWriter out, GenericLog value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GenericLog read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GenericLog given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GenericLog
   * @throws IOException if the JSON string is invalid with respect to GenericLog
   */
  public static GenericLog fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GenericLog.class);
  }

  /**
   * Convert an instance of GenericLog to an JSON string
   *
   * @return JSON string
   */
