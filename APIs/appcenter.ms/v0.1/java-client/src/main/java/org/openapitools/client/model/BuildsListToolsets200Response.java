...
public class BuildsListToolsets200Response {
  ...
  public BuildsListToolsets200Response() {
  }

  public BuildsListToolsets200Response node(List<BuildsListToolsets200ResponseNodeInner> node) {
    this.node = node;
    return this;
  }

  public BuildsListToolsets200Response addNodeItem(BuildsListToolsets200ResponseNodeInner nodeItem) {
    if (this.node == null) {
  ...
  public BuildsListToolsets200Response xamarin(List<BuildsListToolsets200ResponseXamarinInner> xamarin) {
    this.xamarin = xamarin;
    return this;
  }

  public BuildsListToolsets200Response addXamarinItem(BuildsListToolsets200ResponseXamarinInner xamarinItem) {
  ...
  public BuildsListToolsets200Response xcode(List<BuildsListToolsets200ResponseXcodeInner> xcode) {
    this.xcode = xcode;
    return this;
  }

  public BuildsListToolsets200Response addXcodeItem(BuildsListToolsets200ResponseXcodeInner xcodeItem) {
    if (this.xcode == null) {
  ...
  public boolean equals(Object o) {
    ...
    BuildsListToolsets200Response buildsListToolsets200Response = (BuildsListToolsets200Response) o;
    return Objects.equals(this.node, buildsListToolsets200Response.node) &&
        Objects.equals(this.xamarin, buildsListToolsets200Response.xamarin) &&
        Objects.equals(this.xcode, buildsListToolsets200Response.xcode);
  }
  ...
  public String toString() {
    ...
    sb.append("class BuildsListToolsets200Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to BuildsListToolsets200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!BuildsListToolsets200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in BuildsListToolsets200Response is not found in the empty JSON string", BuildsListToolsets200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!BuildsListToolsets200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `BuildsListToolsets200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!BuildsListToolsets200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'BuildsListToolsets200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<BuildsListToolsets200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(BuildsListToolsets200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<BuildsListToolsets200Response>() {
           @Override
           public void write(JsonWriter out, BuildsListToolsets200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public BuildsListToolsets200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of BuildsListToolsets200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of BuildsListToolsets200Response
   * @throws IOException if the JSON string is invalid with respect to BuildsListToolsets200Response
   */
  public static BuildsListToolsets200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, BuildsListToolsets200Response.class);
  }

  /**
   * Convert an instance of BuildsListToolsets200Response to an JSON string
   *
   * @return JSON string
   */
