...
public class AppRepoPostRequest {
  ...
  public AppRepoPostRequest externalUserId(String externalUserId) {
  ...
  public AppRepoPostRequest installationId(String installationId) {
  ...
  public AppRepoPostRequest repoId(String repoId) {
    this.repoId = repoId;
    return this;
  }
  ...
  public AppRepoPostRequest repoProvider(RepoProviderEnum repoProvider) {
  ...
  public AppRepoPostRequest repoUrl(String repoUrl) {
  ...
  public AppRepoPostRequest serviceConnectionId(UUID serviceConnectionId) {
  ...
  public AppRepoPostRequest userId(UUID userId) {
    this.userId = userId;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    AppRepoPostRequest appRepoPostRequest = (AppRepoPostRequest) o;
    return Objects.equals(this.externalUserId, appRepoPostRequest.externalUserId) &&
        Objects.equals(this.installationId, appRepoPostRequest.installationId) &&
        Objects.equals(this.repoId, appRepoPostRequest.repoId) &&
        Objects.equals(this.repoProvider, appRepoPostRequest.repoProvider) &&
        Objects.equals(this.repoUrl, appRepoPostRequest.repoUrl) &&
        Objects.equals(this.serviceConnectionId, appRepoPostRequest.serviceConnectionId) &&
        Objects.equals(this.userId, appRepoPostRequest.userId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(externalUserId, installationId, repoId, repoProvider, repoUrl, serviceConnectionId, userId);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to AppRepoPostRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AppRepoPostRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AppRepoPostRequest is not found in the empty JSON string", AppRepoPostRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AppRepoPostRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AppRepoPostRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AppRepoPostRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AppRepoPostRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AppRepoPostRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AppRepoPostRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AppRepoPostRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<AppRepoPostRequest>() {
           @Override
           public void write(JsonWriter out, AppRepoPostRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AppRepoPostRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AppRepoPostRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AppRepoPostRequest
   * @throws IOException if the JSON string is invalid with respect to AppRepoPostRequest
   */
  public static AppRepoPostRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AppRepoPostRequest.class);
  }

  /**
   * Convert an instance of AppRepoPostRequest to an JSON string
   *
   * @return JSON string
   */
