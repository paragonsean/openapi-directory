...
public class OrgDistributionGroupDetailsResponseAllOfApps {
  ...
  public OrgDistributionGroupDetailsResponseAllOfApps() {
  }

  public OrgDistributionGroupDetailsResponseAllOfApps description(String description) {
  ...
  public OrgDistributionGroupDetailsResponseAllOfApps displayName(String displayName) {
  ...
  public OrgDistributionGroupDetailsResponseAllOfApps iconSource(String iconSource) {
  ...
  public OrgDistributionGroupDetailsResponseAllOfApps iconUrl(String iconUrl) {
  ...
  public OrgDistributionGroupDetailsResponseAllOfApps id(UUID id) {
    this.id = id;
    return this;
  }
  ...
  public OrgDistributionGroupDetailsResponseAllOfApps name(String name) {
    this.name = name;
    return this;
  }
  ...
  public OrgDistributionGroupDetailsResponseAllOfApps os(OsEnum os) {
    this.os = os;
    return this;
  }
  ...
  public OrgDistributionGroupDetailsResponseAllOfApps owner(AppsList200ResponseInnerAllOfOwner owner) {
    this.owner = owner;
    return this;
  }
  ...
  public OrgDistributionGroupDetailsResponseAllOfApps releaseType(String releaseType) {
  ...
  public OrgDistributionGroupDetailsResponseAllOfApps appSecret(String appSecret) {
  ...
  public OrgDistributionGroupDetailsResponseAllOfApps azureSubscription(AppsList200ResponseInnerAllOfAzureSubscription azureSubscription) {
  ...
  public OrgDistributionGroupDetailsResponseAllOfApps createdAt(String createdAt) {
  ...
  public OrgDistributionGroupDetailsResponseAllOfApps memberPermissions(List<MemberPermissionsEnum> memberPermissions) {
    this.memberPermissions = memberPermissions;
    return this;
  }

  public OrgDistributionGroupDetailsResponseAllOfApps addMemberPermissionsItem(MemberPermissionsEnum memberPermissionsItem) {
  ...
  public OrgDistributionGroupDetailsResponseAllOfApps origin(OriginEnum origin) {
    this.origin = origin;
    return this;
  }
  ...
  public OrgDistributionGroupDetailsResponseAllOfApps platform(PlatformEnum platform) {
  ...
  public OrgDistributionGroupDetailsResponseAllOfApps updatedAt(String updatedAt) {
  ...
  public boolean equals(Object o) {
    ...
    OrgDistributionGroupDetailsResponseAllOfApps orgDistributionGroupDetailsResponseAllOfApps = (OrgDistributionGroupDetailsResponseAllOfApps) o;
    return Objects.equals(this.description, orgDistributionGroupDetailsResponseAllOfApps.description) &&
        Objects.equals(this.displayName, orgDistributionGroupDetailsResponseAllOfApps.displayName) &&
        Objects.equals(this.iconSource, orgDistributionGroupDetailsResponseAllOfApps.iconSource) &&
        Objects.equals(this.iconUrl, orgDistributionGroupDetailsResponseAllOfApps.iconUrl) &&
        Objects.equals(this.id, orgDistributionGroupDetailsResponseAllOfApps.id) &&
        Objects.equals(this.name, orgDistributionGroupDetailsResponseAllOfApps.name) &&
        Objects.equals(this.os, orgDistributionGroupDetailsResponseAllOfApps.os) &&
        Objects.equals(this.owner, orgDistributionGroupDetailsResponseAllOfApps.owner) &&
        Objects.equals(this.releaseType, orgDistributionGroupDetailsResponseAllOfApps.releaseType) &&
        Objects.equals(this.appSecret, orgDistributionGroupDetailsResponseAllOfApps.appSecret) &&
        Objects.equals(this.azureSubscription, orgDistributionGroupDetailsResponseAllOfApps.azureSubscription) &&
        Objects.equals(this.createdAt, orgDistributionGroupDetailsResponseAllOfApps.createdAt) &&
        Objects.equals(this.memberPermissions, orgDistributionGroupDetailsResponseAllOfApps.memberPermissions) &&
        Objects.equals(this.origin, orgDistributionGroupDetailsResponseAllOfApps.origin) &&
        Objects.equals(this.platform, orgDistributionGroupDetailsResponseAllOfApps.platform) &&
        Objects.equals(this.updatedAt, orgDistributionGroupDetailsResponseAllOfApps.updatedAt);
  }
  ...
  public String toString() {
    ...
    sb.append("class OrgDistributionGroupDetailsResponseAllOfApps {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to OrgDistributionGroupDetailsResponseAllOfApps
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!OrgDistributionGroupDetailsResponseAllOfApps.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in OrgDistributionGroupDetailsResponseAllOfApps is not found in the empty JSON string", OrgDistributionGroupDetailsResponseAllOfApps.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!OrgDistributionGroupDetailsResponseAllOfApps.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `OrgDistributionGroupDetailsResponseAllOfApps` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : OrgDistributionGroupDetailsResponseAllOfApps.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!OrgDistributionGroupDetailsResponseAllOfApps.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'OrgDistributionGroupDetailsResponseAllOfApps' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<OrgDistributionGroupDetailsResponseAllOfApps> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(OrgDistributionGroupDetailsResponseAllOfApps.class));

       return (TypeAdapter<T>) new TypeAdapter<OrgDistributionGroupDetailsResponseAllOfApps>() {
           @Override
           public void write(JsonWriter out, OrgDistributionGroupDetailsResponseAllOfApps value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public OrgDistributionGroupDetailsResponseAllOfApps read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of OrgDistributionGroupDetailsResponseAllOfApps given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of OrgDistributionGroupDetailsResponseAllOfApps
   * @throws IOException if the JSON string is invalid with respect to OrgDistributionGroupDetailsResponseAllOfApps
   */
  public static OrgDistributionGroupDetailsResponseAllOfApps fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, OrgDistributionGroupDetailsResponseAllOfApps.class);
  }

  /**
   * Convert an instance of OrgDistributionGroupDetailsResponseAllOfApps to an JSON string
   *
   * @return JSON string
   */
