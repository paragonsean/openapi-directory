...
public class RepoConfigPostRequest {
  ...
  public RepoConfigPostRequest installationId(String installationId) {
  ...
  public RepoConfigPostRequest externalUserId(String externalUserId) {
  ...
  public RepoConfigPostRequest repoId(String repoId) {
    this.repoId = repoId;
    return this;
  }
  ...
  public RepoConfigPostRequest repoUrl(String repoUrl) {
  ...
  public RepoConfigPostRequest serviceConnectionId(String serviceConnectionId) {
  ...
  public boolean equals(Object o) {
    ...
    RepoConfigPostRequest repoConfigPostRequest = (RepoConfigPostRequest) o;
    return Objects.equals(this.installationId, repoConfigPostRequest.installationId) &&
        Objects.equals(this.externalUserId, repoConfigPostRequest.externalUserId) &&
        Objects.equals(this.repoId, repoConfigPostRequest.repoId) &&
        Objects.equals(this.repoUrl, repoConfigPostRequest.repoUrl) &&
        Objects.equals(this.serviceConnectionId, repoConfigPostRequest.serviceConnectionId);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to RepoConfigPostRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RepoConfigPostRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in RepoConfigPostRequest is not found in the empty JSON string", RepoConfigPostRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RepoConfigPostRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `RepoConfigPostRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : RepoConfigPostRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RepoConfigPostRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RepoConfigPostRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RepoConfigPostRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RepoConfigPostRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<RepoConfigPostRequest>() {
           @Override
           public void write(JsonWriter out, RepoConfigPostRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public RepoConfigPostRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of RepoConfigPostRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of RepoConfigPostRequest
   * @throws IOException if the JSON string is invalid with respect to RepoConfigPostRequest
   */
  public static RepoConfigPostRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RepoConfigPostRequest.class);
  }

  /**
   * Convert an instance of RepoConfigPostRequest to an JSON string
   *
   * @return JSON string
   */
