...
public class ReleaseUpdateRequest {
  ...
  public ReleaseUpdateRequest build(ReleasesGetLatestByDistributionGroup200ResponseBuild build) {
    this.build = build;
    return this;
  }
  ...
  public ReleaseUpdateRequest destinationId(String destinationId) {
  ...
  public ReleaseUpdateRequest destinationName(String destinationName) {
  ...
  public ReleaseUpdateRequest destinationType(String destinationType) {
  ...
  public ReleaseUpdateRequest destinations(List<ReleasesUpdateRequestDestinationsInner> destinations) {
    this.destinations = destinations;
    return this;
  }

  public ReleaseUpdateRequest addDestinationsItem(ReleasesUpdateRequestDestinationsInner destinationsItem) {
  ...
  public ReleaseUpdateRequest distributionGroupId(String distributionGroupId) {
  ...
  public ReleaseUpdateRequest distributionGroupName(String distributionGroupName) {
  ...
  public ReleaseUpdateRequest mandatoryUpdate(Boolean mandatoryUpdate) {
  ...
  public ReleaseUpdateRequest metadata(ReleasesUpdateRequestMetadata metadata) {
  ...
  public ReleaseUpdateRequest notifyTesters(Boolean notifyTesters) {
  ...
  public ReleaseUpdateRequest releaseNotes(String releaseNotes) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.build, releaseUpdateRequest.build) &&
        Objects.equals(this.destinationId, releaseUpdateRequest.destinationId) &&
        Objects.equals(this.destinationName, releaseUpdateRequest.destinationName) &&
        Objects.equals(this.destinationType, releaseUpdateRequest.destinationType) &&
        Objects.equals(this.destinations, releaseUpdateRequest.destinations) &&
        Objects.equals(this.distributionGroupId, releaseUpdateRequest.distributionGroupId) &&
        Objects.equals(this.distributionGroupName, releaseUpdateRequest.distributionGroupName) &&
        Objects.equals(this.mandatoryUpdate, releaseUpdateRequest.mandatoryUpdate) &&
        Objects.equals(this.metadata, releaseUpdateRequest.metadata) &&
        Objects.equals(this.notifyTesters, releaseUpdateRequest.notifyTesters) &&
        Objects.equals(this.releaseNotes, releaseUpdateRequest.releaseNotes);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ReleaseUpdateRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ReleaseUpdateRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ReleaseUpdateRequest is not found in the empty JSON string", ReleaseUpdateRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ReleaseUpdateRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ReleaseUpdateRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ReleaseUpdateRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ReleaseUpdateRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ReleaseUpdateRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ReleaseUpdateRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<ReleaseUpdateRequest>() {
           @Override
           public void write(JsonWriter out, ReleaseUpdateRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ReleaseUpdateRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ReleaseUpdateRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ReleaseUpdateRequest
   * @throws IOException if the JSON string is invalid with respect to ReleaseUpdateRequest
   */
  public static ReleaseUpdateRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ReleaseUpdateRequest.class);
  }

  /**
   * Convert an instance of ReleaseUpdateRequest to an JSON string
   *
   * @return JSON string
   */
