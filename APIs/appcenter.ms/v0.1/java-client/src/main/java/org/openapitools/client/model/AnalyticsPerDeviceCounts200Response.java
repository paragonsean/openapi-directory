...
public class AnalyticsPerDeviceCounts200Response {
  ...
  public AnalyticsPerDeviceCounts200Response() {
  }

  public AnalyticsPerDeviceCounts200Response averageSessionsPerUser(Double averageSessionsPerUser) {
  ...
  public AnalyticsPerDeviceCounts200Response previousAverageSessionsPerUser(Double previousAverageSessionsPerUser) {
  ...
  public AnalyticsPerDeviceCounts200Response previousTotalCount(Long previousTotalCount) {
  ...
  public AnalyticsPerDeviceCounts200Response sessionsPerUser(List<AnalyticsPerDeviceCounts200ResponseSessionsPerUserInner> sessionsPerUser) {
    this.sessionsPerUser = sessionsPerUser;
    return this;
  }

  public AnalyticsPerDeviceCounts200Response addSessionsPerUserItem(AnalyticsPerDeviceCounts200ResponseSessionsPerUserInner sessionsPerUserItem) {
  ...
  public AnalyticsPerDeviceCounts200Response totalCount(Long totalCount) {
  ...
  public boolean equals(Object o) {
    ...
    AnalyticsPerDeviceCounts200Response analyticsPerDeviceCounts200Response = (AnalyticsPerDeviceCounts200Response) o;
    return Objects.equals(this.averageSessionsPerUser, analyticsPerDeviceCounts200Response.averageSessionsPerUser) &&
        Objects.equals(this.previousAverageSessionsPerUser, analyticsPerDeviceCounts200Response.previousAverageSessionsPerUser) &&
        Objects.equals(this.previousTotalCount, analyticsPerDeviceCounts200Response.previousTotalCount) &&
        Objects.equals(this.sessionsPerUser, analyticsPerDeviceCounts200Response.sessionsPerUser) &&
        Objects.equals(this.totalCount, analyticsPerDeviceCounts200Response.totalCount);
  }
  ...
  public String toString() {
    ...
    sb.append("class AnalyticsPerDeviceCounts200Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AnalyticsPerDeviceCounts200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AnalyticsPerDeviceCounts200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AnalyticsPerDeviceCounts200Response is not found in the empty JSON string", AnalyticsPerDeviceCounts200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AnalyticsPerDeviceCounts200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AnalyticsPerDeviceCounts200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AnalyticsPerDeviceCounts200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AnalyticsPerDeviceCounts200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AnalyticsPerDeviceCounts200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AnalyticsPerDeviceCounts200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<AnalyticsPerDeviceCounts200Response>() {
           @Override
           public void write(JsonWriter out, AnalyticsPerDeviceCounts200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AnalyticsPerDeviceCounts200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AnalyticsPerDeviceCounts200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AnalyticsPerDeviceCounts200Response
   * @throws IOException if the JSON string is invalid with respect to AnalyticsPerDeviceCounts200Response
   */
  public static AnalyticsPerDeviceCounts200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AnalyticsPerDeviceCounts200Response.class);
  }

  /**
   * Convert an instance of AnalyticsPerDeviceCounts200Response to an JSON string
   *
   * @return JSON string
   */
