...
public class HandledErrorReasonFrame {
  ...
  public HandledErrorReasonFrame appCode(Boolean appCode) {
  ...
  public HandledErrorReasonFrame classMethod(Boolean classMethod) {
  ...
  public HandledErrorReasonFrame className(String className) {
  ...
  public HandledErrorReasonFrame codeFormatted(String codeFormatted) {
  ...
  public HandledErrorReasonFrame codeRaw(String codeRaw) {
  ...
  public HandledErrorReasonFrame exceptionType(String exceptionType) {
  ...
  public HandledErrorReasonFrame _file(String _file) {
    this._file = _file;
    return this;
  }
  ...
  public HandledErrorReasonFrame frameworkName(String frameworkName) {
  ...
  public HandledErrorReasonFrame language(LanguageEnum language) {
  ...
  public HandledErrorReasonFrame line(Integer line) {
    this.line = line;
    return this;
  }
  ...
  public HandledErrorReasonFrame method(String method) {
    this.method = method;
    return this;
  }
  ...
  public HandledErrorReasonFrame methodParams(String methodParams) {
  ...
  public HandledErrorReasonFrame osExceptionType(String osExceptionType) {
  ...
  public boolean equals(Object o) {
    ...
    HandledErrorReasonFrame handledErrorReasonFrame = (HandledErrorReasonFrame) o;
    return Objects.equals(this.appCode, handledErrorReasonFrame.appCode) &&
        Objects.equals(this.classMethod, handledErrorReasonFrame.classMethod) &&
        Objects.equals(this.className, handledErrorReasonFrame.className) &&
        Objects.equals(this.codeFormatted, handledErrorReasonFrame.codeFormatted) &&
        Objects.equals(this.codeRaw, handledErrorReasonFrame.codeRaw) &&
        Objects.equals(this.exceptionType, handledErrorReasonFrame.exceptionType) &&
        Objects.equals(this._file, handledErrorReasonFrame._file) &&
        Objects.equals(this.frameworkName, handledErrorReasonFrame.frameworkName) &&
        Objects.equals(this.language, handledErrorReasonFrame.language) &&
        Objects.equals(this.line, handledErrorReasonFrame.line) &&
        Objects.equals(this.method, handledErrorReasonFrame.method) &&
        Objects.equals(this.methodParams, handledErrorReasonFrame.methodParams) &&
        Objects.equals(this.osExceptionType, handledErrorReasonFrame.osExceptionType);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to HandledErrorReasonFrame
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!HandledErrorReasonFrame.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in HandledErrorReasonFrame is not found in the empty JSON string", HandledErrorReasonFrame.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!HandledErrorReasonFrame.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `HandledErrorReasonFrame` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!HandledErrorReasonFrame.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'HandledErrorReasonFrame' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<HandledErrorReasonFrame> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(HandledErrorReasonFrame.class));

       return (TypeAdapter<T>) new TypeAdapter<HandledErrorReasonFrame>() {
           @Override
           public void write(JsonWriter out, HandledErrorReasonFrame value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public HandledErrorReasonFrame read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of HandledErrorReasonFrame given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of HandledErrorReasonFrame
   * @throws IOException if the JSON string is invalid with respect to HandledErrorReasonFrame
   */
  public static HandledErrorReasonFrame fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, HandledErrorReasonFrame.class);
  }

  /**
   * Convert an instance of HandledErrorReasonFrame to an JSON string
   *
   * @return JSON string
   */
