...
public class ErrorsGroupDetails200Response {
  ...
  public ErrorsGroupDetails200Response() {
  }

  public ErrorsGroupDetails200Response appBuild(String appBuild) {
  ...
  public ErrorsGroupDetails200Response appVersion(String appVersion) {
  ...
  public ErrorsGroupDetails200Response codeRaw(String codeRaw) {
  ...
  public ErrorsGroupDetails200Response count(Long count) {
    this.count = count;
    return this;
  }
  ...
  public ErrorsGroupDetails200Response deviceCount(Long deviceCount) {
  ...
  public ErrorsGroupDetails200Response errorGroupId(String errorGroupId) {
  ...
  public ErrorsGroupDetails200Response exceptionAppCode(Boolean exceptionAppCode) {
  ...
  public ErrorsGroupDetails200Response exceptionClassMethod(Boolean exceptionClassMethod) {
  ...
  public ErrorsGroupDetails200Response exceptionClassName(String exceptionClassName) {
  ...
  public ErrorsGroupDetails200Response exceptionFile(String exceptionFile) {
  ...
  public ErrorsGroupDetails200Response exceptionLine(String exceptionLine) {
  ...
  public ErrorsGroupDetails200Response exceptionMessage(String exceptionMessage) {
  ...
  public ErrorsGroupDetails200Response exceptionMethod(String exceptionMethod) {
  ...
  public ErrorsGroupDetails200Response exceptionType(String exceptionType) {
  ...
  public ErrorsGroupDetails200Response firstOccurrence(OffsetDateTime firstOccurrence) {
  ...
  public ErrorsGroupDetails200Response hidden(Boolean hidden) {
    this.hidden = hidden;
    return this;
  }
  ...
  public ErrorsGroupDetails200Response lastOccurrence(OffsetDateTime lastOccurrence) {
  ...
  public ErrorsGroupDetails200Response reasonFrames(List<ErrorsGroupList200ResponseErrorGroupsInnerAllOfReasonFramesInner> reasonFrames) {
    this.reasonFrames = reasonFrames;
    return this;
  }

  public ErrorsGroupDetails200Response addReasonFramesItem(ErrorsGroupList200ResponseErrorGroupsInnerAllOfReasonFramesInner reasonFramesItem) {
  ...
  public ErrorsGroupDetails200Response annotation(String annotation) {
  ...
  public ErrorsGroupDetails200Response state(StateEnum state) {
    this.state = state;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    ErrorsGroupDetails200Response errorsGroupDetails200Response = (ErrorsGroupDetails200Response) o;
    return Objects.equals(this.appBuild, errorsGroupDetails200Response.appBuild) &&
        Objects.equals(this.appVersion, errorsGroupDetails200Response.appVersion) &&
        Objects.equals(this.codeRaw, errorsGroupDetails200Response.codeRaw) &&
        Objects.equals(this.count, errorsGroupDetails200Response.count) &&
        Objects.equals(this.deviceCount, errorsGroupDetails200Response.deviceCount) &&
        Objects.equals(this.errorGroupId, errorsGroupDetails200Response.errorGroupId) &&
        Objects.equals(this.exceptionAppCode, errorsGroupDetails200Response.exceptionAppCode) &&
        Objects.equals(this.exceptionClassMethod, errorsGroupDetails200Response.exceptionClassMethod) &&
        Objects.equals(this.exceptionClassName, errorsGroupDetails200Response.exceptionClassName) &&
        Objects.equals(this.exceptionFile, errorsGroupDetails200Response.exceptionFile) &&
        Objects.equals(this.exceptionLine, errorsGroupDetails200Response.exceptionLine) &&
        Objects.equals(this.exceptionMessage, errorsGroupDetails200Response.exceptionMessage) &&
        Objects.equals(this.exceptionMethod, errorsGroupDetails200Response.exceptionMethod) &&
        Objects.equals(this.exceptionType, errorsGroupDetails200Response.exceptionType) &&
        Objects.equals(this.firstOccurrence, errorsGroupDetails200Response.firstOccurrence) &&
        Objects.equals(this.hidden, errorsGroupDetails200Response.hidden) &&
        Objects.equals(this.lastOccurrence, errorsGroupDetails200Response.lastOccurrence) &&
        Objects.equals(this.reasonFrames, errorsGroupDetails200Response.reasonFrames) &&
        Objects.equals(this.annotation, errorsGroupDetails200Response.annotation) &&
        Objects.equals(this.state, errorsGroupDetails200Response.state);
  }
  ...
  public String toString() {
    ...
    sb.append("class ErrorsGroupDetails200Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ErrorsGroupDetails200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ErrorsGroupDetails200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ErrorsGroupDetails200Response is not found in the empty JSON string", ErrorsGroupDetails200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ErrorsGroupDetails200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ErrorsGroupDetails200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ErrorsGroupDetails200Response.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ErrorsGroupDetails200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ErrorsGroupDetails200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ErrorsGroupDetails200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ErrorsGroupDetails200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<ErrorsGroupDetails200Response>() {
           @Override
           public void write(JsonWriter out, ErrorsGroupDetails200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ErrorsGroupDetails200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ErrorsGroupDetails200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ErrorsGroupDetails200Response
   * @throws IOException if the JSON string is invalid with respect to ErrorsGroupDetails200Response
   */
  public static ErrorsGroupDetails200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ErrorsGroupDetails200Response.class);
  }

  /**
   * Convert an instance of ErrorsGroupDetails200Response to an JSON string
   *
   * @return JSON string
   */
