...
public class AndroidModule {
  ...
  public AndroidModule buildConfigurations(List<BuildsListToolsetProjects200ResponseAndroidAndroidModulesInnerBuildConfigurationsInner> buildConfigurations) {
    this.buildConfigurations = buildConfigurations;
    return this;
  }

  public AndroidModule addBuildConfigurationsItem(BuildsListToolsetProjects200ResponseAndroidAndroidModulesInnerBuildConfigurationsInner buildConfigurationsItem) {
  ...
  public AndroidModule buildTypes(List<String> buildTypes) {
    this.buildTypes = buildTypes;
    return this;
  }

  public AndroidModule addBuildTypesItem(String buildTypesItem) {
  ...
  public AndroidModule buildVariants(List<String> buildVariants) {
    this.buildVariants = buildVariants;
    return this;
  }

  public AndroidModule addBuildVariantsItem(String buildVariantsItem) {
  ...
  public AndroidModule hasBundle(Boolean hasBundle) {
  ...
  public AndroidModule isRoot(Boolean isRoot) {
    this.isRoot = isRoot;
    return this;
  }
  ...
  public AndroidModule name(String name) {
    this.name = name;
    return this;
  }
  ...
  public AndroidModule productFlavors(List<String> productFlavors) {
    this.productFlavors = productFlavors;
    return this;
  }

  public AndroidModule addProductFlavorsItem(String productFlavorsItem) {
  ...
  public boolean equals(Object o) {
    ...
    AndroidModule androidModule = (AndroidModule) o;
    return Objects.equals(this.buildConfigurations, androidModule.buildConfigurations) &&
        Objects.equals(this.buildTypes, androidModule.buildTypes) &&
        Objects.equals(this.buildVariants, androidModule.buildVariants) &&
        Objects.equals(this.hasBundle, androidModule.hasBundle) &&
        Objects.equals(this.isRoot, androidModule.isRoot) &&
        Objects.equals(this.name, androidModule.name) &&
        Objects.equals(this.productFlavors, androidModule.productFlavors);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to AndroidModule
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AndroidModule.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AndroidModule is not found in the empty JSON string", AndroidModule.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AndroidModule.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AndroidModule` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AndroidModule.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AndroidModule.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AndroidModule' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AndroidModule> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AndroidModule.class));

       return (TypeAdapter<T>) new TypeAdapter<AndroidModule>() {
           @Override
           public void write(JsonWriter out, AndroidModule value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AndroidModule read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AndroidModule given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AndroidModule
   * @throws IOException if the JSON string is invalid with respect to AndroidModule
   */
  public static AndroidModule fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AndroidModule.class);
  }

  /**
   * Convert an instance of AndroidModule to an JSON string
   *
   * @return JSON string
   */
