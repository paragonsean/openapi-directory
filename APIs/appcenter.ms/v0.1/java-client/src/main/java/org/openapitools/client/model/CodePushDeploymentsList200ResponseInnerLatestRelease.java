...
public class CodePushDeploymentsList200ResponseInnerLatestRelease {
  ...
  public CodePushDeploymentsList200ResponseInnerLatestRelease() {
  }

  public CodePushDeploymentsList200ResponseInnerLatestRelease description(String description) {
  ...
  public CodePushDeploymentsList200ResponseInnerLatestRelease isDisabled(Boolean isDisabled) {
  ...
  public CodePushDeploymentsList200ResponseInnerLatestRelease isMandatory(Boolean isMandatory) {
  ...
  public CodePushDeploymentsList200ResponseInnerLatestRelease rollout(Integer rollout) {
  ...
  public CodePushDeploymentsList200ResponseInnerLatestRelease targetBinaryRange(String targetBinaryRange) {
  ...
  public CodePushDeploymentsList200ResponseInnerLatestRelease blobUrl(String blobUrl) {
  ...
  public CodePushDeploymentsList200ResponseInnerLatestRelease diffPackageMap(Map<String, CodePushDeploymentsList200ResponseInnerLatestReleaseAllOfDiffPackageMapValue> diffPackageMap) {
    this.diffPackageMap = diffPackageMap;
    return this;
  }

  public CodePushDeploymentsList200ResponseInnerLatestRelease putDiffPackageMapItem(String key, CodePushDeploymentsList200ResponseInnerLatestReleaseAllOfDiffPackageMapValue diffPackageMapItem) {
  ...
  public CodePushDeploymentsList200ResponseInnerLatestRelease label(String label) {
    this.label = label;
    return this;
  }
  ...
  public CodePushDeploymentsList200ResponseInnerLatestRelease originalDeployment(String originalDeployment) {
  ...
  public CodePushDeploymentsList200ResponseInnerLatestRelease originalLabel(String originalLabel) {
  ...
  public CodePushDeploymentsList200ResponseInnerLatestRelease packageHash(String packageHash) {
  ...
  public CodePushDeploymentsList200ResponseInnerLatestRelease releaseMethod(ReleaseMethodEnum releaseMethod) {
  ...
  public CodePushDeploymentsList200ResponseInnerLatestRelease releasedBy(String releasedBy) {
  ...
  public CodePushDeploymentsList200ResponseInnerLatestRelease size(BigDecimal size) {
    this.size = size;
    return this;
  }
  ...
  public CodePushDeploymentsList200ResponseInnerLatestRelease uploadTime(Integer uploadTime) {
  ...
  public boolean equals(Object o) {
    ...
    CodePushDeploymentsList200ResponseInnerLatestRelease codePushDeploymentsList200ResponseInnerLatestRelease = (CodePushDeploymentsList200ResponseInnerLatestRelease) o;
    return Objects.equals(this.description, codePushDeploymentsList200ResponseInnerLatestRelease.description) &&
        Objects.equals(this.isDisabled, codePushDeploymentsList200ResponseInnerLatestRelease.isDisabled) &&
        Objects.equals(this.isMandatory, codePushDeploymentsList200ResponseInnerLatestRelease.isMandatory) &&
        Objects.equals(this.rollout, codePushDeploymentsList200ResponseInnerLatestRelease.rollout) &&
        Objects.equals(this.targetBinaryRange, codePushDeploymentsList200ResponseInnerLatestRelease.targetBinaryRange) &&
        Objects.equals(this.blobUrl, codePushDeploymentsList200ResponseInnerLatestRelease.blobUrl) &&
        Objects.equals(this.diffPackageMap, codePushDeploymentsList200ResponseInnerLatestRelease.diffPackageMap) &&
        Objects.equals(this.label, codePushDeploymentsList200ResponseInnerLatestRelease.label) &&
        Objects.equals(this.originalDeployment, codePushDeploymentsList200ResponseInnerLatestRelease.originalDeployment) &&
        Objects.equals(this.originalLabel, codePushDeploymentsList200ResponseInnerLatestRelease.originalLabel) &&
        Objects.equals(this.packageHash, codePushDeploymentsList200ResponseInnerLatestRelease.packageHash) &&
        Objects.equals(this.releaseMethod, codePushDeploymentsList200ResponseInnerLatestRelease.releaseMethod) &&
        Objects.equals(this.releasedBy, codePushDeploymentsList200ResponseInnerLatestRelease.releasedBy) &&
        Objects.equals(this.size, codePushDeploymentsList200ResponseInnerLatestRelease.size) &&
        Objects.equals(this.uploadTime, codePushDeploymentsList200ResponseInnerLatestRelease.uploadTime);
  }
  ...
  public String toString() {
    ...
    sb.append("class CodePushDeploymentsList200ResponseInnerLatestRelease {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CodePushDeploymentsList200ResponseInnerLatestRelease
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CodePushDeploymentsList200ResponseInnerLatestRelease.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CodePushDeploymentsList200ResponseInnerLatestRelease is not found in the empty JSON string", CodePushDeploymentsList200ResponseInnerLatestRelease.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CodePushDeploymentsList200ResponseInnerLatestRelease.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CodePushDeploymentsList200ResponseInnerLatestRelease` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CodePushDeploymentsList200ResponseInnerLatestRelease.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CodePushDeploymentsList200ResponseInnerLatestRelease' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CodePushDeploymentsList200ResponseInnerLatestRelease> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CodePushDeploymentsList200ResponseInnerLatestRelease.class));

       return (TypeAdapter<T>) new TypeAdapter<CodePushDeploymentsList200ResponseInnerLatestRelease>() {
           @Override
           public void write(JsonWriter out, CodePushDeploymentsList200ResponseInnerLatestRelease value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CodePushDeploymentsList200ResponseInnerLatestRelease read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CodePushDeploymentsList200ResponseInnerLatestRelease given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CodePushDeploymentsList200ResponseInnerLatestRelease
   * @throws IOException if the JSON string is invalid with respect to CodePushDeploymentsList200ResponseInnerLatestRelease
   */
  public static CodePushDeploymentsList200ResponseInnerLatestRelease fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CodePushDeploymentsList200ResponseInnerLatestRelease.class);
  }

  /**
   * Convert an instance of CodePushDeploymentsList200ResponseInnerLatestRelease to an JSON string
   *
   * @return JSON string
   */
