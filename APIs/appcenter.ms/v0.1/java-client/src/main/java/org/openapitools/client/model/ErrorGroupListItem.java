...
public class ErrorGroupListItem {
  ...
  public ErrorGroupListItem appBuild(String appBuild) {
  ...
  public ErrorGroupListItem appVersion(String appVersion) {
  ...
  public ErrorGroupListItem codeRaw(String codeRaw) {
  ...
  public ErrorGroupListItem count(Long count) {
    this.count = count;
    return this;
  }
  ...
  public ErrorGroupListItem deviceCount(Long deviceCount) {
  ...
  public ErrorGroupListItem errorGroupId(String errorGroupId) {
  ...
  public ErrorGroupListItem exceptionAppCode(Boolean exceptionAppCode) {
  ...
  public ErrorGroupListItem exceptionClassMethod(Boolean exceptionClassMethod) {
  ...
  public ErrorGroupListItem exceptionClassName(String exceptionClassName) {
  ...
  public ErrorGroupListItem exceptionFile(String exceptionFile) {
  ...
  public ErrorGroupListItem exceptionLine(String exceptionLine) {
  ...
  public ErrorGroupListItem exceptionMessage(String exceptionMessage) {
  ...
  public ErrorGroupListItem exceptionMethod(String exceptionMethod) {
  ...
  public ErrorGroupListItem exceptionType(String exceptionType) {
  ...
  public ErrorGroupListItem firstOccurrence(OffsetDateTime firstOccurrence) {
  ...
  public ErrorGroupListItem hidden(Boolean hidden) {
    this.hidden = hidden;
    return this;
  }
  ...
  public ErrorGroupListItem lastOccurrence(OffsetDateTime lastOccurrence) {
  ...
  public ErrorGroupListItem reasonFrames(List<ErrorsGroupList200ResponseErrorGroupsInnerAllOfReasonFramesInner> reasonFrames) {
    this.reasonFrames = reasonFrames;
    return this;
  }

  public ErrorGroupListItem addReasonFramesItem(ErrorsGroupList200ResponseErrorGroupsInnerAllOfReasonFramesInner reasonFramesItem) {
  ...
  public ErrorGroupListItem annotation(String annotation) {
  ...
  public ErrorGroupListItem state(StateEnum state) {
    this.state = state;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    ErrorGroupListItem errorGroupListItem = (ErrorGroupListItem) o;
    return Objects.equals(this.appBuild, errorGroupListItem.appBuild) &&
        Objects.equals(this.appVersion, errorGroupListItem.appVersion) &&
        Objects.equals(this.codeRaw, errorGroupListItem.codeRaw) &&
        Objects.equals(this.count, errorGroupListItem.count) &&
        Objects.equals(this.deviceCount, errorGroupListItem.deviceCount) &&
        Objects.equals(this.errorGroupId, errorGroupListItem.errorGroupId) &&
        Objects.equals(this.exceptionAppCode, errorGroupListItem.exceptionAppCode) &&
        Objects.equals(this.exceptionClassMethod, errorGroupListItem.exceptionClassMethod) &&
        Objects.equals(this.exceptionClassName, errorGroupListItem.exceptionClassName) &&
        Objects.equals(this.exceptionFile, errorGroupListItem.exceptionFile) &&
        Objects.equals(this.exceptionLine, errorGroupListItem.exceptionLine) &&
        Objects.equals(this.exceptionMessage, errorGroupListItem.exceptionMessage) &&
        Objects.equals(this.exceptionMethod, errorGroupListItem.exceptionMethod) &&
        Objects.equals(this.exceptionType, errorGroupListItem.exceptionType) &&
        Objects.equals(this.firstOccurrence, errorGroupListItem.firstOccurrence) &&
        Objects.equals(this.hidden, errorGroupListItem.hidden) &&
        Objects.equals(this.lastOccurrence, errorGroupListItem.lastOccurrence) &&
        Objects.equals(this.reasonFrames, errorGroupListItem.reasonFrames) &&
        Objects.equals(this.annotation, errorGroupListItem.annotation) &&
        Objects.equals(this.state, errorGroupListItem.state);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ErrorGroupListItem
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ErrorGroupListItem.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ErrorGroupListItem is not found in the empty JSON string", ErrorGroupListItem.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ErrorGroupListItem.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ErrorGroupListItem` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ErrorGroupListItem.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ErrorGroupListItem.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ErrorGroupListItem' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ErrorGroupListItem> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ErrorGroupListItem.class));

       return (TypeAdapter<T>) new TypeAdapter<ErrorGroupListItem>() {
           @Override
           public void write(JsonWriter out, ErrorGroupListItem value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ErrorGroupListItem read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ErrorGroupListItem given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ErrorGroupListItem
   * @throws IOException if the JSON string is invalid with respect to ErrorGroupListItem
   */
  public static ErrorGroupListItem fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ErrorGroupListItem.class);
  }

  /**
   * Convert an instance of ErrorGroupListItem to an JSON string
   *
   * @return JSON string
   */
