...
public class BranchConfigurationsGet200ResponseAllOfToolsetsXcode {
  ...
  public BranchConfigurationsGet200ResponseAllOfToolsetsXcode() {
  }

  public BranchConfigurationsGet200ResponseAllOfToolsetsXcode appExtensionProvisioningProfileFiles(List<BranchConfigurationsGet200ResponseAllOfToolsetsXcodeAppExtensionProvisioningProfileFilesInner> appExtensionProvisioningProfileFiles) {
    this.appExtensionProvisioningProfileFiles = appExtensionProvisioningProfileFiles;
    return this;
  }

  public BranchConfigurationsGet200ResponseAllOfToolsetsXcode addAppExtensionProvisioningProfileFilesItem(BranchConfigurationsGet200ResponseAllOfToolsetsXcodeAppExtensionProvisioningProfileFilesInner appExtensionProvisioningProfileFilesItem) {
  ...
  public BranchConfigurationsGet200ResponseAllOfToolsetsXcode archiveConfiguration(String archiveConfiguration) {
  ...
  public BranchConfigurationsGet200ResponseAllOfToolsetsXcode automaticSigning(Boolean automaticSigning) {
  ...
  public BranchConfigurationsGet200ResponseAllOfToolsetsXcode cartfilePath(String cartfilePath) {
  ...
  public BranchConfigurationsGet200ResponseAllOfToolsetsXcode certificateEncoded(String certificateEncoded) {
  ...
  public BranchConfigurationsGet200ResponseAllOfToolsetsXcode certificateFileId(String certificateFileId) {
  ...
  public BranchConfigurationsGet200ResponseAllOfToolsetsXcode certificateFilename(String certificateFilename) {
  ...
  public BranchConfigurationsGet200ResponseAllOfToolsetsXcode certificatePassword(String certificatePassword) {
  ...
  public BranchConfigurationsGet200ResponseAllOfToolsetsXcode certificateUploadId(String certificateUploadId) {
  ...
  public BranchConfigurationsGet200ResponseAllOfToolsetsXcode forceLegacyBuildSystem(Boolean forceLegacyBuildSystem) {
  ...
  public BranchConfigurationsGet200ResponseAllOfToolsetsXcode podfilePath(String podfilePath) {
  ...
  public BranchConfigurationsGet200ResponseAllOfToolsetsXcode projectOrWorkspacePath(String projectOrWorkspacePath) {
  ...
  public BranchConfigurationsGet200ResponseAllOfToolsetsXcode provisioningProfileEncoded(String provisioningProfileEncoded) {
  ...
  public BranchConfigurationsGet200ResponseAllOfToolsetsXcode provisioningProfileFileId(String provisioningProfileFileId) {
  ...
  public BranchConfigurationsGet200ResponseAllOfToolsetsXcode provisioningProfileFilename(String provisioningProfileFilename) {
  ...
  public BranchConfigurationsGet200ResponseAllOfToolsetsXcode provisioningProfileUploadId(String provisioningProfileUploadId) {
  ...
  public BranchConfigurationsGet200ResponseAllOfToolsetsXcode scheme(String scheme) {
    this.scheme = scheme;
    return this;
  }
  ...
  public BranchConfigurationsGet200ResponseAllOfToolsetsXcode targetToArchive(String targetToArchive) {
  ...
  public BranchConfigurationsGet200ResponseAllOfToolsetsXcode teamId(String teamId) {
    this.teamId = teamId;
    return this;
  }
  ...
  public BranchConfigurationsGet200ResponseAllOfToolsetsXcode xcodeProjectSha(String xcodeProjectSha) {
  ...
  public BranchConfigurationsGet200ResponseAllOfToolsetsXcode xcodeVersion(String xcodeVersion) {
  ...
  public boolean equals(Object o) {
    ...
    BranchConfigurationsGet200ResponseAllOfToolsetsXcode branchConfigurationsGet200ResponseAllOfToolsetsXcode = (BranchConfigurationsGet200ResponseAllOfToolsetsXcode) o;
    return Objects.equals(this.appExtensionProvisioningProfileFiles, branchConfigurationsGet200ResponseAllOfToolsetsXcode.appExtensionProvisioningProfileFiles) &&
        Objects.equals(this.archiveConfiguration, branchConfigurationsGet200ResponseAllOfToolsetsXcode.archiveConfiguration) &&
        Objects.equals(this.automaticSigning, branchConfigurationsGet200ResponseAllOfToolsetsXcode.automaticSigning) &&
        Objects.equals(this.cartfilePath, branchConfigurationsGet200ResponseAllOfToolsetsXcode.cartfilePath) &&
        Objects.equals(this.certificateEncoded, branchConfigurationsGet200ResponseAllOfToolsetsXcode.certificateEncoded) &&
        Objects.equals(this.certificateFileId, branchConfigurationsGet200ResponseAllOfToolsetsXcode.certificateFileId) &&
        Objects.equals(this.certificateFilename, branchConfigurationsGet200ResponseAllOfToolsetsXcode.certificateFilename) &&
        Objects.equals(this.certificatePassword, branchConfigurationsGet200ResponseAllOfToolsetsXcode.certificatePassword) &&
        Objects.equals(this.certificateUploadId, branchConfigurationsGet200ResponseAllOfToolsetsXcode.certificateUploadId) &&
        Objects.equals(this.forceLegacyBuildSystem, branchConfigurationsGet200ResponseAllOfToolsetsXcode.forceLegacyBuildSystem) &&
        Objects.equals(this.podfilePath, branchConfigurationsGet200ResponseAllOfToolsetsXcode.podfilePath) &&
        Objects.equals(this.projectOrWorkspacePath, branchConfigurationsGet200ResponseAllOfToolsetsXcode.projectOrWorkspacePath) &&
        Objects.equals(this.provisioningProfileEncoded, branchConfigurationsGet200ResponseAllOfToolsetsXcode.provisioningProfileEncoded) &&
        Objects.equals(this.provisioningProfileFileId, branchConfigurationsGet200ResponseAllOfToolsetsXcode.provisioningProfileFileId) &&
        Objects.equals(this.provisioningProfileFilename, branchConfigurationsGet200ResponseAllOfToolsetsXcode.provisioningProfileFilename) &&
        Objects.equals(this.provisioningProfileUploadId, branchConfigurationsGet200ResponseAllOfToolsetsXcode.provisioningProfileUploadId) &&
        Objects.equals(this.scheme, branchConfigurationsGet200ResponseAllOfToolsetsXcode.scheme) &&
        Objects.equals(this.targetToArchive, branchConfigurationsGet200ResponseAllOfToolsetsXcode.targetToArchive) &&
        Objects.equals(this.teamId, branchConfigurationsGet200ResponseAllOfToolsetsXcode.teamId) &&
        Objects.equals(this.xcodeProjectSha, branchConfigurationsGet200ResponseAllOfToolsetsXcode.xcodeProjectSha) &&
        Objects.equals(this.xcodeVersion, branchConfigurationsGet200ResponseAllOfToolsetsXcode.xcodeVersion);
  }
  ...
  public String toString() {
    ...
    sb.append("class BranchConfigurationsGet200ResponseAllOfToolsetsXcode {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to BranchConfigurationsGet200ResponseAllOfToolsetsXcode
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!BranchConfigurationsGet200ResponseAllOfToolsetsXcode.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in BranchConfigurationsGet200ResponseAllOfToolsetsXcode is not found in the empty JSON string", BranchConfigurationsGet200ResponseAllOfToolsetsXcode.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!BranchConfigurationsGet200ResponseAllOfToolsetsXcode.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `BranchConfigurationsGet200ResponseAllOfToolsetsXcode` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!BranchConfigurationsGet200ResponseAllOfToolsetsXcode.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'BranchConfigurationsGet200ResponseAllOfToolsetsXcode' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<BranchConfigurationsGet200ResponseAllOfToolsetsXcode> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(BranchConfigurationsGet200ResponseAllOfToolsetsXcode.class));

       return (TypeAdapter<T>) new TypeAdapter<BranchConfigurationsGet200ResponseAllOfToolsetsXcode>() {
           @Override
           public void write(JsonWriter out, BranchConfigurationsGet200ResponseAllOfToolsetsXcode value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public BranchConfigurationsGet200ResponseAllOfToolsetsXcode read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of BranchConfigurationsGet200ResponseAllOfToolsetsXcode given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of BranchConfigurationsGet200ResponseAllOfToolsetsXcode
   * @throws IOException if the JSON string is invalid with respect to BranchConfigurationsGet200ResponseAllOfToolsetsXcode
   */
  public static BranchConfigurationsGet200ResponseAllOfToolsetsXcode fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, BranchConfigurationsGet200ResponseAllOfToolsetsXcode.class);
  }

  /**
   * Convert an instance of BranchConfigurationsGet200ResponseAllOfToolsetsXcode to an JSON string
   *
   * @return JSON string
   */
