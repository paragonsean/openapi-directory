...
public class StoresCreateRequest {
  ...
  public StoresCreateRequest() {
  }

  public StoresCreateRequest intuneDetails(StoresCreateRequestIntuneDetails intuneDetails) {
  ...
  public StoresCreateRequest name(String name) {
    this.name = name;
    return this;
  }
  ...
  public StoresCreateRequest serviceConnectionId(String serviceConnectionId) {
  ...
  public StoresCreateRequest track(TrackEnum track) {
    this.track = track;
    return this;
  }
  ...
  public StoresCreateRequest type(TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    StoresCreateRequest storesCreateRequest = (StoresCreateRequest) o;
    return Objects.equals(this.intuneDetails, storesCreateRequest.intuneDetails) &&
        Objects.equals(this.name, storesCreateRequest.name) &&
        Objects.equals(this.serviceConnectionId, storesCreateRequest.serviceConnectionId) &&
        Objects.equals(this.track, storesCreateRequest.track) &&
        Objects.equals(this.type, storesCreateRequest.type);
  }
  ...
  public String toString() {
    ...
    sb.append("class StoresCreateRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to StoresCreateRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StoresCreateRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in StoresCreateRequest is not found in the empty JSON string", StoresCreateRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!StoresCreateRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `StoresCreateRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!StoresCreateRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'StoresCreateRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<StoresCreateRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(StoresCreateRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<StoresCreateRequest>() {
           @Override
           public void write(JsonWriter out, StoresCreateRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public StoresCreateRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of StoresCreateRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of StoresCreateRequest
   * @throws IOException if the JSON string is invalid with respect to StoresCreateRequest
   */
  public static StoresCreateRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, StoresCreateRequest.class);
  }

  /**
   * Convert an instance of StoresCreateRequest to an JSON string
   *
   * @return JSON string
   */
