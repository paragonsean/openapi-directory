...
public class LegacyCodePushRelease {
  ...
  public LegacyCodePushRelease() {
  }

  public LegacyCodePushRelease appVersion(String appVersion) {
  ...
  public LegacyCodePushRelease blobUrl(String blobUrl) {
  ...
  public LegacyCodePushRelease diffPackageMap(Object diffPackageMap) {
  ...
  public LegacyCodePushRelease isDisabled(Boolean isDisabled) {
  ...
  public LegacyCodePushRelease isMandatory(Boolean isMandatory) {
  ...
  public LegacyCodePushRelease label(String label) {
    this.label = label;
    return this;
  }
  ...
  public LegacyCodePushRelease manifestBlobUrl(String manifestBlobUrl) {
  ...
  public LegacyCodePushRelease releaseMethod(String releaseMethod) {
  ...
  public LegacyCodePushRelease releasedByUserId(String releasedByUserId) {
  ...
  public LegacyCodePushRelease rollout(Integer rollout) {
  ...
  public LegacyCodePushRelease size(Integer size) {
    this.size = size;
    return this;
  }
  ...
  public LegacyCodePushRelease uploadTime(Integer uploadTime) {
  ...
  public boolean equals(Object o) {
    ...
    LegacyCodePushRelease legacyCodePushRelease = (LegacyCodePushRelease) o;
    return Objects.equals(this.appVersion, legacyCodePushRelease.appVersion) &&
        Objects.equals(this.blobUrl, legacyCodePushRelease.blobUrl) &&
        Objects.equals(this.diffPackageMap, legacyCodePushRelease.diffPackageMap) &&
        Objects.equals(this.isDisabled, legacyCodePushRelease.isDisabled) &&
        Objects.equals(this.isMandatory, legacyCodePushRelease.isMandatory) &&
        Objects.equals(this.label, legacyCodePushRelease.label) &&
        Objects.equals(this.manifestBlobUrl, legacyCodePushRelease.manifestBlobUrl) &&
        Objects.equals(this.releaseMethod, legacyCodePushRelease.releaseMethod) &&
        Objects.equals(this.releasedByUserId, legacyCodePushRelease.releasedByUserId) &&
        Objects.equals(this.rollout, legacyCodePushRelease.rollout) &&
        Objects.equals(this.size, legacyCodePushRelease.size) &&
        Objects.equals(this.uploadTime, legacyCodePushRelease.uploadTime);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to LegacyCodePushRelease
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LegacyCodePushRelease.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LegacyCodePushRelease is not found in the empty JSON string", LegacyCodePushRelease.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LegacyCodePushRelease.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LegacyCodePushRelease` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LegacyCodePushRelease.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LegacyCodePushRelease' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LegacyCodePushRelease> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LegacyCodePushRelease.class));

       return (TypeAdapter<T>) new TypeAdapter<LegacyCodePushRelease>() {
           @Override
           public void write(JsonWriter out, LegacyCodePushRelease value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LegacyCodePushRelease read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LegacyCodePushRelease given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LegacyCodePushRelease
   * @throws IOException if the JSON string is invalid with respect to LegacyCodePushRelease
   */
  public static LegacyCodePushRelease fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LegacyCodePushRelease.class);
  }

  /**
   * Convert an instance of LegacyCodePushRelease to an JSON string
   *
   * @return JSON string
   */
