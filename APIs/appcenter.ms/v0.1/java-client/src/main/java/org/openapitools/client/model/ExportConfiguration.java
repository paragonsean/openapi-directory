...
public class ExportConfiguration {
  ...
  public ExportConfiguration backfill(Boolean backfill) {
  ...
  public ExportConfiguration exportEntities(List<ExportEntitiesEnum> exportEntities) {
    this.exportEntities = exportEntities;
    return this;
  }

  public ExportConfiguration addExportEntitiesItem(ExportEntitiesEnum exportEntitiesItem) {
  ...
  public ExportConfiguration resourceGroup(String resourceGroup) {
  ...
  public ExportConfiguration resourceName(String resourceName) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.backfill, exportConfiguration.backfill) &&
        Objects.equals(this.exportEntities, exportConfiguration.exportEntities) &&
        Objects.equals(this.resourceGroup, exportConfiguration.resourceGroup) &&
        Objects.equals(this.resourceName, exportConfiguration.resourceName) &&
   ...
   * @throws IOException if the JSON Element is invalid with respect to ExportConfiguration
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ExportConfiguration.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ExportConfiguration is not found in the empty JSON string", ExportConfiguration.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ExportConfiguration.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ExportConfiguration` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ExportConfiguration.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ExportConfiguration.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ExportConfiguration' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ExportConfiguration> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ExportConfiguration.class));

       return (TypeAdapter<T>) new TypeAdapter<ExportConfiguration>() {
           @Override
           public void write(JsonWriter out, ExportConfiguration value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ExportConfiguration read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ExportConfiguration given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ExportConfiguration
   * @throws IOException if the JSON string is invalid with respect to ExportConfiguration
   */
  public static ExportConfiguration fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ExportConfiguration.class);
  }

  /**
   * Convert an instance of ExportConfiguration to an JSON string
   *
   * @return JSON string
   */
