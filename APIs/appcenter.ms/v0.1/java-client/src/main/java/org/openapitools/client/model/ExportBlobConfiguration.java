...
public class ExportBlobConfiguration {
  /**
  ...
  public ExportBlobConfiguration blobPathFormatKind(BlobPathFormatKindEnum blobPathFormatKind) {
  ...
  public ExportBlobConfiguration backfill(Boolean backfill) {
  ...
  public ExportBlobConfiguration exportEntities(List<ExportEntitiesEnum> exportEntities) {
    this.exportEntities = exportEntities;
    return this;
  }

  public ExportBlobConfiguration addExportEntitiesItem(ExportEntitiesEnum exportEntitiesItem) {
  ...
  public ExportBlobConfiguration resourceGroup(String resourceGroup) {
  ...
  public ExportBlobConfiguration resourceName(String resourceName) {
  ...
  public ExportBlobConfiguration type(TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    ExportBlobConfiguration exportBlobConfiguration = (ExportBlobConfiguration) o;
    return Objects.equals(this.blobPathFormatKind, exportBlobConfiguration.blobPathFormatKind) &&
        Objects.equals(this.backfill, exportBlobConfiguration.backfill) &&
        Objects.equals(this.exportEntities, exportBlobConfiguration.exportEntities) &&
        Objects.equals(this.resourceGroup, exportBlobConfiguration.resourceGroup) &&
        Objects.equals(this.resourceName, exportBlobConfiguration.resourceName) &&
        Objects.equals(this.type, exportBlobConfiguration.type);
  }

  @Override
  public int hashCode() {
    return Objects.hash(blobPathFormatKind, backfill, exportEntities, resourceGroup, resourceName, type);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ExportBlobConfiguration
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ExportBlobConfiguration.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ExportBlobConfiguration is not found in the empty JSON string", ExportBlobConfiguration.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ExportBlobConfiguration.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ExportBlobConfiguration` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ExportBlobConfiguration.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ExportBlobConfiguration.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ExportBlobConfiguration' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ExportBlobConfiguration> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ExportBlobConfiguration.class));

       return (TypeAdapter<T>) new TypeAdapter<ExportBlobConfiguration>() {
           @Override
           public void write(JsonWriter out, ExportBlobConfiguration value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ExportBlobConfiguration read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ExportBlobConfiguration given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ExportBlobConfiguration
   * @throws IOException if the JSON string is invalid with respect to ExportBlobConfiguration
   */
  public static ExportBlobConfiguration fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ExportBlobConfiguration.class);
  }

  /**
   * Convert an instance of ExportBlobConfiguration to an JSON string
   *
   * @return JSON string
   */
