...
public class LegacyDeploymentHistory {
  ...
  public LegacyDeploymentHistory() {
  }

  public LegacyDeploymentHistory allOf(LegacyCodePushReleaseResponsePackage allOf) {
    this.allOf = allOf;
    return this;
  }
  ...
  public LegacyDeploymentHistory description(String description) {
  ...
  public LegacyDeploymentHistory originalDeployment(String originalDeployment) {
  ...
  public LegacyDeploymentHistory originalLabel(String originalLabel) {
  ...
  public LegacyDeploymentHistory packageHash(String packageHash) {
  ...
  public boolean equals(Object o) {
    ...
    LegacyDeploymentHistory legacyDeploymentHistory = (LegacyDeploymentHistory) o;
    return Objects.equals(this.allOf, legacyDeploymentHistory.allOf) &&
        Objects.equals(this.description, legacyDeploymentHistory.description) &&
        Objects.equals(this.originalDeployment, legacyDeploymentHistory.originalDeployment) &&
        Objects.equals(this.originalLabel, legacyDeploymentHistory.originalLabel) &&
        Objects.equals(this.packageHash, legacyDeploymentHistory.packageHash);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to LegacyDeploymentHistory
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LegacyDeploymentHistory.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LegacyDeploymentHistory is not found in the empty JSON string", LegacyDeploymentHistory.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LegacyDeploymentHistory.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LegacyDeploymentHistory` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LegacyDeploymentHistory.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LegacyDeploymentHistory' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LegacyDeploymentHistory> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LegacyDeploymentHistory.class));

       return (TypeAdapter<T>) new TypeAdapter<LegacyDeploymentHistory>() {
           @Override
           public void write(JsonWriter out, LegacyDeploymentHistory value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LegacyDeploymentHistory read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LegacyDeploymentHistory given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LegacyDeploymentHistory
   * @throws IOException if the JSON string is invalid with respect to LegacyDeploymentHistory
   */
  public static LegacyDeploymentHistory fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LegacyDeploymentHistory.class);
  }

  /**
   * Convert an instance of LegacyDeploymentHistory to an JSON string
   *
   * @return JSON string
   */
