...
public class AppResponseInternal {
  ...
  public static final String SERIALIZED_NAME_CUTOVER_FROM_HOCKEYAPP_AT = "cutover_from_hockeyapp_at";
  @SerializedName(SERIALIZED_NAME_CUTOVER_FROM_HOCKEYAPP_AT)
  private String cutoverFromHockeyappAt;
  ...
  private List<AppResponseInternalAllOfRepositories> repositories = new ArrayList<>();
  ...
  private AppResponseInternalAllOfUserPermissions userPermissions;

  public AppResponseInternal() {
  }

  public AppResponseInternal description(String description) {
  ...
  public AppResponseInternal displayName(String displayName) {
  ...
  public AppResponseInternal iconSource(String iconSource) {
  ...
  public AppResponseInternal iconUrl(String iconUrl) {
  ...
  public AppResponseInternal id(UUID id) {
    this.id = id;
    return this;
  }
  ...
  public AppResponseInternal name(String name) {
    this.name = name;
    return this;
  }
  ...
  public AppResponseInternal os(OsEnum os) {
    this.os = os;
    return this;
  }
  ...
  public AppResponseInternal owner(Object owner) {
    this.owner = owner;
    return this;
  }
  ...
  public AppResponseInternal releaseType(String releaseType) {
  ...
  public AppResponseInternal appSecret(String appSecret) {
  ...
  public AppResponseInternal azureSubscription(Object azureSubscription) {
  ...
  public AppResponseInternal createdAt(String createdAt) {
  ...
  public AppResponseInternal memberPermissions(List<MemberPermissionsEnum> memberPermissions) {
    this.memberPermissions = memberPermissions;
    return this;
  }

  public AppResponseInternal addMemberPermissionsItem(MemberPermissionsEnum memberPermissionsItem) {
  ...
  public AppResponseInternal origin(OriginEnum origin) {
    this.origin = origin;
    return this;
  }
  ...
  public AppResponseInternal platform(PlatformEnum platform) {
  ...
  public AppResponseInternal updatedAt(String updatedAt) {
  ...
  public AppResponseInternal cutoverFromHockeyappAt(String cutoverFromHockeyappAt) {
   ...
   * @return cutoverFromHockeyappAt
   */
  @javax.annotation.Nullable
  public String getCutoverFromHockeyappAt() {
    return cutoverFromHockeyappAt;
  }

  public void setCutoverFromHockeyappAt(String cutoverFromHockeyappAt) {
    this.cutoverFromHockeyappAt = cutoverFromHockeyappAt;
  }


  public AppResponseInternal featureFlags(List<String> featureFlags) {
    this.featureFlags = featureFlags;
    return this;
  }

  public AppResponseInternal addFeatureFlagsItem(String featureFlagsItem) {
  ...
  public AppResponseInternal repositories(List<AppResponseInternalAllOfRepositories> repositories) {
    this.repositories = repositories;
    return this;
  }

  public AppResponseInternal addRepositoriesItem(AppResponseInternalAllOfRepositories repositoriesItem) {
   ...
   */
  @javax.annotation.Nullable
  public List<AppResponseInternalAllOfRepositories> getRepositories() {
    return repositories;
  }

  public void setRepositories(List<AppResponseInternalAllOfRepositories> repositories) {
    this.repositories = repositories;
  }


  public AppResponseInternal userPermissions(AppResponseInternalAllOfUserPermissions userPermissions) {
   ...
   */
  @javax.annotation.Nullable
  public AppResponseInternalAllOfUserPermissions getUserPermissions() {
    return userPermissions;
  }

  public void setUserPermissions(AppResponseInternalAllOfUserPermissions userPermissions) {
    this.userPermissions = userPermissions;
  }
  ...
  public boolean equals(Object o) {
    ...
    AppResponseInternal appResponseInternal = (AppResponseInternal) o;
    return Objects.equals(this.description, appResponseInternal.description) &&
        Objects.equals(this.displayName, appResponseInternal.displayName) &&
        Objects.equals(this.iconSource, appResponseInternal.iconSource) &&
        Objects.equals(this.iconUrl, appResponseInternal.iconUrl) &&
        Objects.equals(this.id, appResponseInternal.id) &&
        Objects.equals(this.name, appResponseInternal.name) &&
        Objects.equals(this.os, appResponseInternal.os) &&
        Objects.equals(this.owner, appResponseInternal.owner) &&
        Objects.equals(this.releaseType, appResponseInternal.releaseType) &&
        Objects.equals(this.appSecret, appResponseInternal.appSecret) &&
        Objects.equals(this.azureSubscription, appResponseInternal.azureSubscription) &&
        Objects.equals(this.createdAt, appResponseInternal.createdAt) &&
        Objects.equals(this.memberPermissions, appResponseInternal.memberPermissions) &&
        Objects.equals(this.origin, appResponseInternal.origin) &&
        Objects.equals(this.platform, appResponseInternal.platform) &&
        Objects.equals(this.updatedAt, appResponseInternal.updatedAt) &&
        Objects.equals(this.cutoverFromHockeyappAt, appResponseInternal.cutoverFromHockeyappAt) &&
        Objects.equals(this.featureFlags, appResponseInternal.featureFlags) &&
        Objects.equals(this.repositories, appResponseInternal.repositories) &&
        Objects.equals(this.userPermissions, appResponseInternal.userPermissions);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(description, displayName, iconSource, iconUrl, id, name, os, owner, releaseType, appSecret, azureSubscription, createdAt, memberPermissions, origin, platform, updatedAt, cutoverFromHockeyappAt, featureFlags, repositories, userPermissions);
  }
  ...
  public String toString() {
    ...
    sb.append("    cutoverFromHockeyappAt: ").append(toIndentedString(cutoverFromHockeyappAt)).append("\n");
  ...
  static {
    ...
    openapiFields.add("cutover_from_hockeyapp_at");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AppResponseInternal
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AppResponseInternal.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AppResponseInternal is not found in the empty JSON string", AppResponseInternal.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AppResponseInternal.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AppResponseInternal` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AppResponseInternal.openapiRequiredFields) {
      ...
      if ((jsonObj.get("cutover_from_hockeyapp_at") != null && !jsonObj.get("cutover_from_hockeyapp_at").isJsonNull()) && !jsonObj.get("cutover_from_hockeyapp_at").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `cutover_from_hockeyapp_at` to be a primitive type in the JSON string but got `%s`", jsonObj.get("cutover_from_hockeyapp_at").toString()));
      }
      // ensure the optional json data is an array if present
      ...
      if (jsonObj.get("repositories") != null && !jsonObj.get("repositories").isJsonNull()) {
        ...
        if (jsonArrayrepositories != null) {
          ...
          for (int i = 0; i < jsonArrayrepositories.size(); i++) {
            AppResponseInternalAllOfRepositories.validateJsonElement(jsonArrayrepositories.get(i));
          };
        }
      }
      // validate the optional field `user_permissions`
      if (jsonObj.get("user_permissions") != null && !jsonObj.get("user_permissions").isJsonNull()) {
        AppResponseInternalAllOfUserPermissions.validateJsonElement(jsonObj.get("user_permissions"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AppResponseInternal.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AppResponseInternal' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AppResponseInternal> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AppResponseInternal.class));

       return (TypeAdapter<T>) new TypeAdapter<AppResponseInternal>() {
           @Override
           public void write(JsonWriter out, AppResponseInternal value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AppResponseInternal read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AppResponseInternal given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AppResponseInternal
   * @throws IOException if the JSON string is invalid with respect to AppResponseInternal
   */
  public static AppResponseInternal fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AppResponseInternal.class);
  }

  /**
   * Convert an instance of AppResponseInternal to an JSON string
   *
   * @return JSON string
   */
