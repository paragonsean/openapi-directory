...
public class XcodeSchemeContainer {
  ...
  public XcodeSchemeContainer appExtensionTargets(List<BuildsListToolsetProjects200ResponseXcodeXcodeSchemeContainersInnerAppExtensionTargetsInner> appExtensionTargets) {
    this.appExtensionTargets = appExtensionTargets;
    return this;
  }

  public XcodeSchemeContainer addAppExtensionTargetsItem(BuildsListToolsetProjects200ResponseXcodeXcodeSchemeContainersInnerAppExtensionTargetsInner appExtensionTargetsItem) {
  ...
  public XcodeSchemeContainer cartfilePath(String cartfilePath) {
  ...
  public XcodeSchemeContainer path(String path) {
    this.path = path;
    return this;
  }
  ...
  public XcodeSchemeContainer podfilePath(String podfilePath) {
  ...
  public XcodeSchemeContainer sharedSchemes(List<BuildsListToolsetProjects200ResponseXcodeXcodeSchemeContainersInnerSharedSchemesInner> sharedSchemes) {
    this.sharedSchemes = sharedSchemes;
    return this;
  }

  public XcodeSchemeContainer addSharedSchemesItem(BuildsListToolsetProjects200ResponseXcodeXcodeSchemeContainersInnerSharedSchemesInner sharedSchemesItem) {
  ...
  public XcodeSchemeContainer workspaceProjectPaths(String workspaceProjectPaths) {
  ...
  public XcodeSchemeContainer xcodeProjectSha(String xcodeProjectSha) {
  ...
  public boolean equals(Object o) {
    ...
    XcodeSchemeContainer xcodeSchemeContainer = (XcodeSchemeContainer) o;
    return Objects.equals(this.appExtensionTargets, xcodeSchemeContainer.appExtensionTargets) &&
        Objects.equals(this.cartfilePath, xcodeSchemeContainer.cartfilePath) &&
        Objects.equals(this.path, xcodeSchemeContainer.path) &&
        Objects.equals(this.podfilePath, xcodeSchemeContainer.podfilePath) &&
        Objects.equals(this.sharedSchemes, xcodeSchemeContainer.sharedSchemes) &&
        Objects.equals(this.workspaceProjectPaths, xcodeSchemeContainer.workspaceProjectPaths) &&
        Objects.equals(this.xcodeProjectSha, xcodeSchemeContainer.xcodeProjectSha);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to XcodeSchemeContainer
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!XcodeSchemeContainer.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in XcodeSchemeContainer is not found in the empty JSON string", XcodeSchemeContainer.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!XcodeSchemeContainer.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `XcodeSchemeContainer` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : XcodeSchemeContainer.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!XcodeSchemeContainer.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'XcodeSchemeContainer' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<XcodeSchemeContainer> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(XcodeSchemeContainer.class));

       return (TypeAdapter<T>) new TypeAdapter<XcodeSchemeContainer>() {
           @Override
           public void write(JsonWriter out, XcodeSchemeContainer value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public XcodeSchemeContainer read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of XcodeSchemeContainer given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of XcodeSchemeContainer
   * @throws IOException if the JSON string is invalid with respect to XcodeSchemeContainer
   */
  public static XcodeSchemeContainer fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, XcodeSchemeContainer.class);
  }

  /**
   * Convert an instance of XcodeSchemeContainer to an JSON string
   *
   * @return JSON string
   */
