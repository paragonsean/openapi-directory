...
public class SymbolUpload {
  ...
  public SymbolUpload appId(String appId) {
    this.appId = appId;
    return this;
  }
  ...
  public SymbolUpload fileName(String fileName) {
  ...
  public SymbolUpload fileSize(BigDecimal fileSize) {
  ...
  public SymbolUpload origin(OriginEnum origin) {
    this.origin = origin;
    return this;
  }
  ...
  public SymbolUpload status(StatusEnum status) {
    this.status = status;
    return this;
  }
  ...
  public SymbolUpload symbolType(SymbolTypeEnum symbolType) {
  ...
  public SymbolUpload symbolUploadId(String symbolUploadId) {
  ...
  public SymbolUpload symbolsUploaded(List<SymbolUploadsList200ResponseInnerSymbolsUploadedInner> symbolsUploaded) {
    this.symbolsUploaded = symbolsUploaded;
    return this;
  }

  public SymbolUpload addSymbolsUploadedItem(SymbolUploadsList200ResponseInnerSymbolsUploadedInner symbolsUploadedItem) {
  ...
  public SymbolUpload timestamp(OffsetDateTime timestamp) {
  ...
  public SymbolUpload user(SymbolUploadsList200ResponseInnerUser user) {
    this.user = user;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    SymbolUpload symbolUpload = (SymbolUpload) o;
    return Objects.equals(this.appId, symbolUpload.appId) &&
        Objects.equals(this.fileName, symbolUpload.fileName) &&
        Objects.equals(this.fileSize, symbolUpload.fileSize) &&
        Objects.equals(this.origin, symbolUpload.origin) &&
        Objects.equals(this.status, symbolUpload.status) &&
        Objects.equals(this.symbolType, symbolUpload.symbolType) &&
        Objects.equals(this.symbolUploadId, symbolUpload.symbolUploadId) &&
        Objects.equals(this.symbolsUploaded, symbolUpload.symbolsUploaded) &&
        Objects.equals(this.timestamp, symbolUpload.timestamp) &&
        Objects.equals(this.user, symbolUpload.user);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to SymbolUpload
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SymbolUpload.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SymbolUpload is not found in the empty JSON string", SymbolUpload.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SymbolUpload.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SymbolUpload` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : SymbolUpload.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SymbolUpload.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SymbolUpload' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SymbolUpload> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SymbolUpload.class));

       return (TypeAdapter<T>) new TypeAdapter<SymbolUpload>() {
           @Override
           public void write(JsonWriter out, SymbolUpload value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SymbolUpload read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SymbolUpload given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SymbolUpload
   * @throws IOException if the JSON string is invalid with respect to SymbolUpload
   */
  public static SymbolUpload fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SymbolUpload.class);
  }

  /**
   * Convert an instance of SymbolUpload to an JSON string
   *
   * @return JSON string
   */
