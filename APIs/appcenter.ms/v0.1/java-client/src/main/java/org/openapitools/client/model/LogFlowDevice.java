...
public class LogFlowDevice {
  ...
  public LogFlowDevice appBuild(String appBuild) {
  ...
  public LogFlowDevice appNamespace(String appNamespace) {
  ...
  public LogFlowDevice appVersion(String appVersion) {
  ...
  public LogFlowDevice carrierCode(String carrierCode) {
  ...
  public LogFlowDevice carrierCountry(String carrierCountry) {
  ...
  public LogFlowDevice carrierName(String carrierName) {
  ...
  public LogFlowDevice liveUpdateDeploymentKey(String liveUpdateDeploymentKey) {
  ...
  public LogFlowDevice liveUpdatePackageHash(String liveUpdatePackageHash) {
  ...
  public LogFlowDevice liveUpdateReleaseLabel(String liveUpdateReleaseLabel) {
  ...
  public LogFlowDevice locale(String locale) {
    this.locale = locale;
    return this;
  }
  ...
  public LogFlowDevice model(String model) {
    this.model = model;
    return this;
  }
  ...
  public LogFlowDevice oemName(String oemName) {
  ...
  public LogFlowDevice osApiLevel(Integer osApiLevel) {
  ...
  public LogFlowDevice osBuild(String osBuild) {
  ...
  public LogFlowDevice osName(String osName) {
    this.osName = osName;
    return this;
  }
  ...
  public LogFlowDevice osVersion(String osVersion) {
  ...
  public LogFlowDevice screenSize(String screenSize) {
  ...
  public LogFlowDevice sdkName(String sdkName) {
  ...
  public LogFlowDevice sdkVersion(String sdkVersion) {
  ...
  public LogFlowDevice timeZoneOffset(Integer timeZoneOffset) {
  ...
  public LogFlowDevice wrapperRuntimeVersion(String wrapperRuntimeVersion) {
  ...
  public LogFlowDevice wrapperSdkName(String wrapperSdkName) {
  ...
  public LogFlowDevice wrapperSdkVersion(String wrapperSdkVersion) {
  ...
  public boolean equals(Object o) {
    ...
    LogFlowDevice logFlowDevice = (LogFlowDevice) o;
    return Objects.equals(this.appBuild, logFlowDevice.appBuild) &&
        Objects.equals(this.appNamespace, logFlowDevice.appNamespace) &&
        Objects.equals(this.appVersion, logFlowDevice.appVersion) &&
        Objects.equals(this.carrierCode, logFlowDevice.carrierCode) &&
        Objects.equals(this.carrierCountry, logFlowDevice.carrierCountry) &&
        Objects.equals(this.carrierName, logFlowDevice.carrierName) &&
        Objects.equals(this.liveUpdateDeploymentKey, logFlowDevice.liveUpdateDeploymentKey) &&
        Objects.equals(this.liveUpdatePackageHash, logFlowDevice.liveUpdatePackageHash) &&
        Objects.equals(this.liveUpdateReleaseLabel, logFlowDevice.liveUpdateReleaseLabel) &&
        Objects.equals(this.locale, logFlowDevice.locale) &&
        Objects.equals(this.model, logFlowDevice.model) &&
        Objects.equals(this.oemName, logFlowDevice.oemName) &&
        Objects.equals(this.osApiLevel, logFlowDevice.osApiLevel) &&
        Objects.equals(this.osBuild, logFlowDevice.osBuild) &&
        Objects.equals(this.osName, logFlowDevice.osName) &&
        Objects.equals(this.osVersion, logFlowDevice.osVersion) &&
        Objects.equals(this.screenSize, logFlowDevice.screenSize) &&
        Objects.equals(this.sdkName, logFlowDevice.sdkName) &&
        Objects.equals(this.sdkVersion, logFlowDevice.sdkVersion) &&
        Objects.equals(this.timeZoneOffset, logFlowDevice.timeZoneOffset) &&
        Objects.equals(this.wrapperRuntimeVersion, logFlowDevice.wrapperRuntimeVersion) &&
        Objects.equals(this.wrapperSdkName, logFlowDevice.wrapperSdkName) &&
        Objects.equals(this.wrapperSdkVersion, logFlowDevice.wrapperSdkVersion);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to LogFlowDevice
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LogFlowDevice.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LogFlowDevice is not found in the empty JSON string", LogFlowDevice.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LogFlowDevice.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LogFlowDevice` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LogFlowDevice.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LogFlowDevice.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LogFlowDevice' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LogFlowDevice> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LogFlowDevice.class));

       return (TypeAdapter<T>) new TypeAdapter<LogFlowDevice>() {
           @Override
           public void write(JsonWriter out, LogFlowDevice value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LogFlowDevice read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LogFlowDevice given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LogFlowDevice
   * @throws IOException if the JSON string is invalid with respect to LogFlowDevice
   */
  public static LogFlowDevice fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LogFlowDevice.class);
  }

  /**
   * Convert an instance of LogFlowDevice to an JSON string
   *
   * @return JSON string
   */
