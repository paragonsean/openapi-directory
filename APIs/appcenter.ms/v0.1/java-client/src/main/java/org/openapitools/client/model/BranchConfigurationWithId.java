...
public class BranchConfigurationWithId {
  ...
  public BranchConfigurationWithId() {
  }

  public BranchConfigurationWithId artifactVersioning(BranchConfigurationsGet200ResponseAllOfArtifactVersioning artifactVersioning) {
  ...
  public BranchConfigurationWithId badgeIsEnabled(Boolean badgeIsEnabled) {
  ...
  public BranchConfigurationWithId cloneFromBranch(String cloneFromBranch) {
  ...
  public BranchConfigurationWithId signed(Boolean signed) {
    this.signed = signed;
    return this;
  }
  ...
  public BranchConfigurationWithId testsEnabled(Boolean testsEnabled) {
  ...
  public BranchConfigurationWithId toolsets(BranchConfigurationsGet200ResponseAllOfToolsets toolsets) {
  ...
  public BranchConfigurationWithId trigger(TriggerEnum trigger) {
  ...
  public BranchConfigurationWithId id(Integer id) {
    this.id = id;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    BranchConfigurationWithId branchConfigurationWithId = (BranchConfigurationWithId) o;
    return Objects.equals(this.artifactVersioning, branchConfigurationWithId.artifactVersioning) &&
        Objects.equals(this.badgeIsEnabled, branchConfigurationWithId.badgeIsEnabled) &&
        Objects.equals(this.cloneFromBranch, branchConfigurationWithId.cloneFromBranch) &&
        Objects.equals(this.signed, branchConfigurationWithId.signed) &&
        Objects.equals(this.testsEnabled, branchConfigurationWithId.testsEnabled) &&
        Objects.equals(this.toolsets, branchConfigurationWithId.toolsets) &&
        Objects.equals(this.trigger, branchConfigurationWithId.trigger) &&
        Objects.equals(this.id, branchConfigurationWithId.id);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to BranchConfigurationWithId
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!BranchConfigurationWithId.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in BranchConfigurationWithId is not found in the empty JSON string", BranchConfigurationWithId.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!BranchConfigurationWithId.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `BranchConfigurationWithId` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : BranchConfigurationWithId.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!BranchConfigurationWithId.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'BranchConfigurationWithId' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<BranchConfigurationWithId> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(BranchConfigurationWithId.class));

       return (TypeAdapter<T>) new TypeAdapter<BranchConfigurationWithId>() {
           @Override
           public void write(JsonWriter out, BranchConfigurationWithId value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public BranchConfigurationWithId read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of BranchConfigurationWithId given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of BranchConfigurationWithId
   * @throws IOException if the JSON string is invalid with respect to BranchConfigurationWithId
   */
  public static BranchConfigurationWithId fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, BranchConfigurationWithId.class);
  }

  /**
   * Convert an instance of BranchConfigurationWithId to an JSON string
   *
   * @return JSON string
   */
