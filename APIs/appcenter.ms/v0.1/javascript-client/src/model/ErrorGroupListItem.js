...
/**
 * The ErrorGroupListItem model module.
 * @module model/ErrorGroupListItem
 * @version v0.1
 */
class ErrorGroupListItem {
    /**
     * Constructs a new <code>ErrorGroupListItem</code>.
     * @alias module:model/ErrorGroupListItem
     ...
     * @param state {module:model/ErrorGroupListItem.StateEnum} 
     */
    constructor(appVersion, count, deviceCount, errorGroupId, firstOccurrence, lastOccurrence, state) { 
        
        ErrorGroupListItem.initialize(this, appVersion, count, deviceCount, errorGroupId, firstOccurrence, lastOccurrence, state);
    }
    ...
    /**
     * Constructs a <code>ErrorGroupListItem</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ErrorGroupListItem} obj Optional instance to populate.
     * @return {module:model/ErrorGroupListItem} The populated <code>ErrorGroupListItem</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ErrorGroupListItem();
    ...
    /**
     * Validates the JSON data with respect to <code>ErrorGroupListItem</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ErrorGroupListItem</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ErrorGroupListItem.RequiredProperties) {
...
ErrorGroupListItem.RequiredProperties = ["appVersion", "count", "deviceCount", "errorGroupId", "firstOccurrence", "lastOccurrence", "state"];

/**
 * @member {String} appBuild
 */
ErrorGroupListItem.prototype['appBuild'] = undefined;

/**
 * @member {String} appVersion
 */
ErrorGroupListItem.prototype['appVersion'] = undefined;

/**
 * @member {String} codeRaw
 */
ErrorGroupListItem.prototype['codeRaw'] = undefined;

/**
 * @member {Number} count
 */
ErrorGroupListItem.prototype['count'] = undefined;

/**
 * @member {Number} deviceCount
 */
ErrorGroupListItem.prototype['deviceCount'] = undefined;

/**
 * @member {String} errorGroupId
 */
ErrorGroupListItem.prototype['errorGroupId'] = undefined;

/**
 * @member {Boolean} exceptionAppCode
 */
ErrorGroupListItem.prototype['exceptionAppCode'] = undefined;

/**
 * @member {Boolean} exceptionClassMethod
 */
ErrorGroupListItem.prototype['exceptionClassMethod'] = undefined;

/**
 * @member {String} exceptionClassName
 */
ErrorGroupListItem.prototype['exceptionClassName'] = undefined;

/**
 * @member {String} exceptionFile
 */
ErrorGroupListItem.prototype['exceptionFile'] = undefined;

/**
 * @member {String} exceptionLine
 */
ErrorGroupListItem.prototype['exceptionLine'] = undefined;

/**
 * @member {String} exceptionMessage
 */
ErrorGroupListItem.prototype['exceptionMessage'] = undefined;

/**
 * @member {String} exceptionMethod
 */
ErrorGroupListItem.prototype['exceptionMethod'] = undefined;

/**
 * @member {String} exceptionType
 */
ErrorGroupListItem.prototype['exceptionType'] = undefined;

/**
 * @member {Date} firstOccurrence
 */
ErrorGroupListItem.prototype['firstOccurrence'] = undefined;

/**
 * @member {Boolean} hidden
 */
ErrorGroupListItem.prototype['hidden'] = undefined;

/**
 * @member {Date} lastOccurrence
 */
ErrorGroupListItem.prototype['lastOccurrence'] = undefined;

/**
 * @member {Array.<module:model/ErrorsGroupList200ResponseErrorGroupsInnerAllOfReasonFramesInner>} reasonFrames
 */
ErrorGroupListItem.prototype['reasonFrames'] = undefined;

/**
 * @member {String} annotation
 */
ErrorGroupListItem.prototype['annotation'] = undefined;

/**
 * @member {module:model/ErrorGroupListItem.StateEnum} state
 */
ErrorGroupListItem.prototype['state'] = undefined;
