...
/**
 * The ExportConfigurationsList200ResponseValuesInner model module.
 * @module model/ExportConfigurationsList200ResponseValuesInner
 * @version v0.1
 */
class ExportConfigurationsList200ResponseValuesInner {
    /**
     * Constructs a new <code>ExportConfigurationsList200ResponseValuesInner</code>.
     * Export configuration result
     * @alias module:model/ExportConfigurationsList200ResponseValuesInner
     * @param creationTime {String} Creation time in ISO 8601 format
     * @param exportType {module:model/ExportConfigurationsList200ResponseValuesInner.ExportTypeEnum} Target resource type of export configuration
     * @param id {String} Export configuration id
     * @param state {module:model/ExportConfigurationsList200ResponseValuesInner.StateEnum} State of the export job
     */
    constructor(creationTime, exportType, id, state) { 
        
        ExportConfigurationsList200ResponseValuesInner.initialize(this, creationTime, exportType, id, state);
    }
    ...
    /**
     * Constructs a <code>ExportConfigurationsList200ResponseValuesInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ExportConfigurationsList200ResponseValuesInner} obj Optional instance to populate.
     * @return {module:model/ExportConfigurationsList200ResponseValuesInner} The populated <code>ExportConfigurationsList200ResponseValuesInner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ExportConfigurationsList200ResponseValuesInner();
    ...
    /**
     * Validates the JSON data with respect to <code>ExportConfigurationsList200ResponseValuesInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ExportConfigurationsList200ResponseValuesInner</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ExportConfigurationsList200ResponseValuesInner.RequiredProperties) {
...
ExportConfigurationsList200ResponseValuesInner.RequiredProperties = ["creation_time", "export_type", "id", "state"];

/**
 * Creation time in ISO 8601 format
 * @member {String} creation_time
 */
ExportConfigurationsList200ResponseValuesInner.prototype['creation_time'] = undefined;

/**
 * @member {module:model/ExportConfigurationsList200ResponseValuesInnerExportConfiguration} export_configuration
 */
ExportConfigurationsList200ResponseValuesInner.prototype['export_configuration'] = undefined;

/**
 * @member {Array.<module:model/ExportConfigurationsList200ResponseValuesInner.ExportEntitiesEnum>} export_entities
 */
ExportConfigurationsList200ResponseValuesInner.prototype['export_entities'] = undefined;

/**
 * Target resource type of export configuration
 * @member {module:model/ExportConfigurationsList200ResponseValuesInner.ExportTypeEnum} export_type
 */
ExportConfigurationsList200ResponseValuesInner.prototype['export_type'] = undefined;

/**
 * Export configuration id
 * @member {String} id
 */
ExportConfigurationsList200ResponseValuesInner.prototype['id'] = undefined;

/**
 * Latest time in ISO 8601 format when export completed successfully
 * @member {String} last_run_time
 */
ExportConfigurationsList200ResponseValuesInner.prototype['last_run_time'] = undefined;

/**
 * resource group for the storage account/App Insights resource
 * @member {String} resource_group
 */
ExportConfigurationsList200ResponseValuesInner.prototype['resource_group'] = undefined;

/**
 * Storage accout or Appinsights resource name
 * @member {String} resource_name
 */
ExportConfigurationsList200ResponseValuesInner.prototype['resource_name'] = undefined;

/**
 * State of the export job
 * @member {module:model/ExportConfigurationsList200ResponseValuesInner.StateEnum} state
 */
ExportConfigurationsList200ResponseValuesInner.prototype['state'] = undefined;

/**
 * Additional information about export configuration state
 * @member {String} state_info
 */
ExportConfigurationsList200ResponseValuesInner.prototype['state_info'] = undefined;
 ...
 * @readonly
 */
ExportConfigurationsList200ResponseValuesInner['ExportEntitiesEnum'] = {
 ...
 * @readonly
 */
ExportConfigurationsList200ResponseValuesInner['ExportTypeEnum'] = {
 ...
 * @readonly
 */
ExportConfigurationsList200ResponseValuesInner['StateEnum'] = {
...
export default ExportConfigurationsList200ResponseValuesInner;
