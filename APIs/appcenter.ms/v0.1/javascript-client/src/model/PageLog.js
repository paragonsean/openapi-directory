...
/**
 * The PageLog model module.
 * @module model/PageLog
 * @version v0.1
 */
class PageLog {
    /**
     * Constructs a new <code>PageLog</code>.
     * Page view log (as in screens or activities).
     * @alias module:model/PageLog
     * @param device {Object} Device characteristics.
     * @param installId {String} Install ID. 
     * @param timestamp {Date} Log creation timestamp. 
     * @param type {module:model/PageLog.TypeEnum} Log type. 
     */
    constructor(device, installId, timestamp, type) { 
        
        PageLog.initialize(this, device, installId, timestamp, type);
    }
    ...
    /**
     * Constructs a <code>PageLog</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PageLog} obj Optional instance to populate.
     * @return {module:model/PageLog} The populated <code>PageLog</code> instance.
     */
    ...
    /**
     * Validates the JSON data with respect to <code>PageLog</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PageLog</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of PageLog.RequiredProperties) {
...
PageLog.RequiredProperties = ["name", "session_id", "device", "install_id", "timestamp", "type"];

/**
 * Name of the page. 
 * @member {String} name
 */
PageLog.prototype['name'] = undefined;

/**
 * Session ID. 
 * @member {String} session_id
 */
PageLog.prototype['session_id'] = undefined;

/**
 * Additional key/value pair parameters. 
 * @member {Object.<String, String>} properties
 */
PageLog.prototype['properties'] = undefined;

/**
 * Device characteristics.
 * @member {Object} device
 */
PageLog.prototype['device'] = undefined;

/**
 * Install ID. 
 * @member {String} install_id
 */
PageLog.prototype['install_id'] = undefined;

/**
 * Log creation timestamp. 
 * @member {Date} timestamp
 */
PageLog.prototype['timestamp'] = undefined;

/**
 * Log type. 
 * @member {module:model/PageLog.TypeEnum} type
 */
PageLog.prototype['type'] = undefined;
