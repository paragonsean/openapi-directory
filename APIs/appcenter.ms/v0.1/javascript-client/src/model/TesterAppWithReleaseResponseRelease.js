...
/**
 * The TesterAppWithReleaseResponseRelease model module.
 * @module model/TesterAppWithReleaseResponseRelease
 * @version v0.1
 */
class TesterAppWithReleaseResponseRelease {
    /**
     * Constructs a new <code>TesterAppWithReleaseResponseRelease</code>.
     * @alias module:model/TesterAppWithReleaseResponseRelease
    ...
    constructor(enabled, id, mandatoryUpdate, shortVersion, uploadedAt, version, size) { 
        ...
        TesterAppWithReleaseResponseRelease.initialize(this, enabled, id, mandatoryUpdate, shortVersion, uploadedAt, version, size);
    }
    ...
    /**
     * Constructs a <code>TesterAppWithReleaseResponseRelease</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/TesterAppWithReleaseResponseRelease} obj Optional instance to populate.
     * @return {module:model/TesterAppWithReleaseResponseRelease} The populated <code>TesterAppWithReleaseResponseRelease</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new TesterAppWithReleaseResponseRelease();
    ...
    /**
     * Validates the JSON data with respect to <code>TesterAppWithReleaseResponseRelease</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TesterAppWithReleaseResponseRelease</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of TesterAppWithReleaseResponseRelease.RequiredProperties) {
...
TesterAppWithReleaseResponseRelease.RequiredProperties = ["enabled", "id", "mandatory_update", "short_version", "uploaded_at", "version", "size"];

/**
 * This value determines the whether a release currently is enabled or disabled.
 * @member {Boolean} enabled
 */
TesterAppWithReleaseResponseRelease.prototype['enabled'] = undefined;

/**
 * ID identifying this unique release.
 * @member {Number} id
 */
TesterAppWithReleaseResponseRelease.prototype['id'] = undefined;

/**
 * This value determines if a release is external or not.
 * @member {Boolean} is_external_build
 */
TesterAppWithReleaseResponseRelease.prototype['is_external_build'] = undefined;

/**
 * A boolean which determines whether the release is a mandatory update or not.
 * @member {Boolean} mandatory_update
 */
TesterAppWithReleaseResponseRelease.prototype['mandatory_update'] = undefined;

/**
 * The release's origin
 * @member {module:model/TesterAppWithReleaseResponseRelease.OriginEnum} origin
 */
TesterAppWithReleaseResponseRelease.prototype['origin'] = undefined;
 ...
 */
TesterAppWithReleaseResponseRelease.prototype['short_version'] = undefined;

/**
 * UTC time in ISO 8601 format of the uploaded time.
 * @member {String} uploaded_at
 */
TesterAppWithReleaseResponseRelease.prototype['uploaded_at'] = undefined;
 ...
 */
TesterAppWithReleaseResponseRelease.prototype['version'] = undefined;
 ...
 */
TesterAppWithReleaseResponseRelease.prototype['install_url'] = undefined;

/**
 * The release's release notes.
 * @member {String} release_notes
 */
TesterAppWithReleaseResponseRelease.prototype['release_notes'] = undefined;

/**
 * The release's size in bytes.
 * @member {Number} size
 */
TesterAppWithReleaseResponseRelease.prototype['size'] = undefined;
 ...
 * @readonly
 */
TesterAppWithReleaseResponseRelease['OriginEnum'] = {
...
export default TesterAppWithReleaseResponseRelease;
