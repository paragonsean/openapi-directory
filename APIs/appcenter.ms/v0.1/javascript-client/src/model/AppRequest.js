...
class AppRequest {
     ...
     * @param os {module:model/AppRequest.OsEnum} The OS the app will be running on
     * @param platform {module:model/AppRequest.PlatformEnum} The platform of the app
     */
    constructor(displayName, os, platform) { 
        
        AppRequest.initialize(this, displayName, os, platform);
    }
    ...
    /**
     * Validates the JSON data with respect to <code>AppRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AppRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of AppRequest.RequiredProperties) {
...
AppRequest.RequiredProperties = ["display_name", "os", "platform"];

/**
 * A short text describing the app
 * @member {String} description
 */
AppRequest.prototype['description'] = undefined;

/**
 * The descriptive name of the app. This can contain any characters
 * @member {String} display_name
 */
AppRequest.prototype['display_name'] = undefined;

/**
 * The name of the app used in URLs
 * @member {String} name
 */
AppRequest.prototype['name'] = undefined;

/**
 * The OS the app will be running on
 * @member {module:model/AppRequest.OsEnum} os
 */
AppRequest.prototype['os'] = undefined;

/**
 * The platform of the app
 * @member {module:model/AppRequest.PlatformEnum} platform
 */
AppRequest.prototype['platform'] = undefined;

/**
 * A one-word descriptive release-type value that starts with a capital letter but is otherwise lowercase
 * @member {String} release_type
 */
AppRequest.prototype['release_type'] = undefined;
