...
/**
 * The DeviceDiagnostics model module.
 * @module model/DeviceDiagnostics
 * @version v0.1
 */
class DeviceDiagnostics {
    /**
     * Constructs a new <code>DeviceDiagnostics</code>.
     * Device characteristics.
     * @alias module:model/DeviceDiagnostics
    ...
    constructor(appBuild, appVersion, locale, osName, osVersion, sdkName, sdkVersion, timeZoneOffset) { 
        ...
        DeviceDiagnostics.initialize(this, appBuild, appVersion, locale, osName, osVersion, sdkName, sdkVersion, timeZoneOffset);
    }
    ...
    /**
     * Constructs a <code>DeviceDiagnostics</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DeviceDiagnostics} obj Optional instance to populate.
     * @return {module:model/DeviceDiagnostics} The populated <code>DeviceDiagnostics</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DeviceDiagnostics();
    ...
    /**
     * Validates the JSON data with respect to <code>DeviceDiagnostics</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DeviceDiagnostics</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DeviceDiagnostics.RequiredProperties) {
...
DeviceDiagnostics.RequiredProperties = ["app_build", "app_version", "locale", "os_name", "os_version", "sdk_name", "sdk_version", "time_zone_offset"];

/**
 * The app's build number, e.g. 42. 
 * @member {String} app_build
 */
DeviceDiagnostics.prototype['app_build'] = undefined;
 ...
 */
DeviceDiagnostics.prototype['app_namespace'] = undefined;

/**
 * Application version name, e.g. 1.1.0 
 * @member {String} app_version
 */
DeviceDiagnostics.prototype['app_version'] = undefined;

/**
 * Carrier country code (for mobile devices). 
 * @member {String} carrier_code
 */
DeviceDiagnostics.prototype['carrier_code'] = undefined;

/**
 * Carrier country. 
 * @member {String} carrier_country
 */
DeviceDiagnostics.prototype['carrier_country'] = undefined;

/**
 * Carrier name (for mobile devices). 
 * @member {String} carrier_name
 */
DeviceDiagnostics.prototype['carrier_name'] = undefined;

/**
 * Identifier of environment that current application release belongs to, deployment key then maps to environment like Production, Staging. 
 * @member {String} live_update_deployment_key
 */
DeviceDiagnostics.prototype['live_update_deployment_key'] = undefined;
 ...
 */
DeviceDiagnostics.prototype['live_update_package_hash'] = undefined;

/**
 * Label that is used to identify application code 'version' released via Live Update beacon running on device 
 * @member {String} live_update_release_label
 */
DeviceDiagnostics.prototype['live_update_release_label'] = undefined;

/**
 * Language code (example: en_US). 
 * @member {String} locale
 */
DeviceDiagnostics.prototype['locale'] = undefined;

/**
 * Device model (example: iPad2,3). 
 * @member {String} model
 */
DeviceDiagnostics.prototype['model'] = undefined;

/**
 * Device manufacturer (example: HTC). 
 * @member {String} oem_name
 */
DeviceDiagnostics.prototype['oem_name'] = undefined;

/**
 * API level when applicable like in Android (example: 15). 
 * @member {Number} os_api_level
 */
DeviceDiagnostics.prototype['os_api_level'] = undefined;

/**
 * OS build code (example: LMY47X). 
 * @member {String} os_build
 */
DeviceDiagnostics.prototype['os_build'] = undefined;
 ...
 */
DeviceDiagnostics.prototype['os_name'] = undefined;

/**
 * OS version (example: 9.3.0). 
 * @member {String} os_version
 */
DeviceDiagnostics.prototype['os_version'] = undefined;

/**
 * Screen size of the device in pixels (example: 640x480). 
 * @member {String} screen_size
 */
DeviceDiagnostics.prototype['screen_size'] = undefined;
 ...
 */
DeviceDiagnostics.prototype['sdk_name'] = undefined;

/**
 * Version of the SDK in semver format, e.g. \"1.2.0\" or \"0.12.3-alpha.1\". 
 * @member {String} sdk_version
 */
DeviceDiagnostics.prototype['sdk_version'] = undefined;

/**
 * The offset in minutes from UTC for the device time zone, including daylight savings time. 
 * @member {Number} time_zone_offset
 */
DeviceDiagnostics.prototype['time_zone_offset'] = undefined;
 ...
 */
DeviceDiagnostics.prototype['wrapper_runtime_version'] = undefined;
 ...
 */
DeviceDiagnostics.prototype['wrapper_sdk_name'] = undefined;
 ...
 */
DeviceDiagnostics.prototype['wrapper_sdk_version'] = undefined;
