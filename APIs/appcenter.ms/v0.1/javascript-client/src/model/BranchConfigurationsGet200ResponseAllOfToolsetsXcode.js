...
/**
 * The BranchConfigurationsGet200ResponseAllOfToolsetsXcode model module.
 * @module model/BranchConfigurationsGet200ResponseAllOfToolsetsXcode
 * @version v0.1
 */
class BranchConfigurationsGet200ResponseAllOfToolsetsXcode {
    /**
     * Constructs a new <code>BranchConfigurationsGet200ResponseAllOfToolsetsXcode</code>.
     * Build configuration when Xcode is part of the build steps
     * @alias module:model/BranchConfigurationsGet200ResponseAllOfToolsetsXcode
     */
    constructor() { 
        
        BranchConfigurationsGet200ResponseAllOfToolsetsXcode.initialize(this);
    }
    ...
    /**
     * Constructs a <code>BranchConfigurationsGet200ResponseAllOfToolsetsXcode</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/BranchConfigurationsGet200ResponseAllOfToolsetsXcode} obj Optional instance to populate.
     * @return {module:model/BranchConfigurationsGet200ResponseAllOfToolsetsXcode} The populated <code>BranchConfigurationsGet200ResponseAllOfToolsetsXcode</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new BranchConfigurationsGet200ResponseAllOfToolsetsXcode();
    ...
    /**
     * Validates the JSON data with respect to <code>BranchConfigurationsGet200ResponseAllOfToolsetsXcode</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>BranchConfigurationsGet200ResponseAllOfToolsetsXcode</code>.
     */
 ...
 */
BranchConfigurationsGet200ResponseAllOfToolsetsXcode.prototype['appExtensionProvisioningProfileFiles'] = undefined;

/**
 * The build configuration of the target to archive
 * @member {String} archiveConfiguration
 */
BranchConfigurationsGet200ResponseAllOfToolsetsXcode.prototype['archiveConfiguration'] = undefined;

/**
 * @member {Boolean} automaticSigning
 */
BranchConfigurationsGet200ResponseAllOfToolsetsXcode.prototype['automaticSigning'] = undefined;

/**
 * Path to Carthage file, if present
 * @member {String} cartfilePath
 */
BranchConfigurationsGet200ResponseAllOfToolsetsXcode.prototype['cartfilePath'] = undefined;

/**
 * @member {String} certificateEncoded
 */
BranchConfigurationsGet200ResponseAllOfToolsetsXcode.prototype['certificateEncoded'] = undefined;

/**
 * @member {String} certificateFileId
 */
BranchConfigurationsGet200ResponseAllOfToolsetsXcode.prototype['certificateFileId'] = undefined;

/**
 * @member {String} certificateFilename
 */
BranchConfigurationsGet200ResponseAllOfToolsetsXcode.prototype['certificateFilename'] = undefined;

/**
 * @member {String} certificatePassword
 */
BranchConfigurationsGet200ResponseAllOfToolsetsXcode.prototype['certificatePassword'] = undefined;

/**
 * @member {String} certificateUploadId
 */
BranchConfigurationsGet200ResponseAllOfToolsetsXcode.prototype['certificateUploadId'] = undefined;
 ...
 */
BranchConfigurationsGet200ResponseAllOfToolsetsXcode.prototype['forceLegacyBuildSystem'] = undefined;

/**
 * Path to CococaPods file, if present
 * @member {String} podfilePath
 */
BranchConfigurationsGet200ResponseAllOfToolsetsXcode.prototype['podfilePath'] = undefined;

/**
 * Xcode project/workspace path
 * @member {String} projectOrWorkspacePath
 */
BranchConfigurationsGet200ResponseAllOfToolsetsXcode.prototype['projectOrWorkspacePath'] = undefined;

/**
 * @member {String} provisioningProfileEncoded
 */
BranchConfigurationsGet200ResponseAllOfToolsetsXcode.prototype['provisioningProfileEncoded'] = undefined;

/**
 * @member {String} provisioningProfileFileId
 */
BranchConfigurationsGet200ResponseAllOfToolsetsXcode.prototype['provisioningProfileFileId'] = undefined;

/**
 * @member {String} provisioningProfileFilename
 */
BranchConfigurationsGet200ResponseAllOfToolsetsXcode.prototype['provisioningProfileFilename'] = undefined;

/**
 * @member {String} provisioningProfileUploadId
 */
BranchConfigurationsGet200ResponseAllOfToolsetsXcode.prototype['provisioningProfileUploadId'] = undefined;

/**
 * @member {String} scheme
 */
BranchConfigurationsGet200ResponseAllOfToolsetsXcode.prototype['scheme'] = undefined;

/**
 * The target id of the selected scheme to archive
 * @member {String} targetToArchive
 */
BranchConfigurationsGet200ResponseAllOfToolsetsXcode.prototype['targetToArchive'] = undefined;

/**
 * @member {String} teamId
 */
BranchConfigurationsGet200ResponseAllOfToolsetsXcode.prototype['teamId'] = undefined;

/**
 * The selected pbxproject hash to the repositroy
 * @member {String} xcodeProjectSha
 */
BranchConfigurationsGet200ResponseAllOfToolsetsXcode.prototype['xcodeProjectSha'] = undefined;
 ...
 */
BranchConfigurationsGet200ResponseAllOfToolsetsXcode.prototype['xcodeVersion'] = undefined;
...
export default BranchConfigurationsGet200ResponseAllOfToolsetsXcode;
