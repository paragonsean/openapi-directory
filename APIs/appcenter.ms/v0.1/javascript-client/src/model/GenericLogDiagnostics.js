...
/**
 * The GenericLogDiagnostics model module.
 * @module model/GenericLogDiagnostics
 * @version v0.1
 */
class GenericLogDiagnostics {
    /**
     * Constructs a new <code>GenericLogDiagnostics</code>.
     * Generic log.
     * @alias module:model/GenericLogDiagnostics
     ...
     * @param type {module:model/GenericLogDiagnostics.TypeEnum} Log type. 
     */
    constructor(device, installId, timestamp, type) { 
        
        GenericLogDiagnostics.initialize(this, device, installId, timestamp, type);
    }
    ...
    /**
     * Constructs a <code>GenericLogDiagnostics</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GenericLogDiagnostics} obj Optional instance to populate.
     * @return {module:model/GenericLogDiagnostics} The populated <code>GenericLogDiagnostics</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GenericLogDiagnostics();
    ...
    /**
     * Validates the JSON data with respect to <code>GenericLogDiagnostics</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GenericLogDiagnostics</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of GenericLogDiagnostics.RequiredProperties) {
...
GenericLogDiagnostics.RequiredProperties = ["device", "install_id", "timestamp", "type"];

/**
 * @member {module:model/AnalyticsGenericLogFlow200ResponseLogsInnerDevice} device
 */
GenericLogDiagnostics.prototype['device'] = undefined;

/**
 * Event ID. 
 * @member {String} event_id
 */
GenericLogDiagnostics.prototype['event_id'] = undefined;

/**
 * Event name. 
 * @member {String} event_name
 */
GenericLogDiagnostics.prototype['event_name'] = undefined;

/**
 * Install ID. 
 * @member {String} install_id
 */
GenericLogDiagnostics.prototype['install_id'] = undefined;

/**
 * Message ID. 
 * @member {String} message_id
 */
GenericLogDiagnostics.prototype['message_id'] = undefined;

/**
 * event specific properties. 
 * @member {Object.<String, String>} properties
 */
GenericLogDiagnostics.prototype['properties'] = undefined;

/**
 * Session ID. 
 * @member {String} session_id
 */
GenericLogDiagnostics.prototype['session_id'] = undefined;

/**
 * Log creation timestamp. 
 * @member {Date} timestamp
 */
GenericLogDiagnostics.prototype['timestamp'] = undefined;

/**
 * Log type. 
 * @member {module:model/GenericLogDiagnostics.TypeEnum} type
 */
GenericLogDiagnostics.prototype['type'] = undefined;
 ...
 * @readonly
 */
GenericLogDiagnostics['TypeEnum'] = {
...
export default GenericLogDiagnostics;
