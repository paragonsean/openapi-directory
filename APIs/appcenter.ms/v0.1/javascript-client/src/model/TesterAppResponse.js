...
/**
 * The TesterAppResponse model module.
 * @module model/TesterAppResponse
 * @version v0.1
 */
class TesterAppResponse {
    /**
     * Constructs a new <code>TesterAppResponse</code>.
     * @alias module:model/TesterAppResponse
     ...
     * @param os {module:model/TesterAppResponse.OsEnum} The OS the app will be running on
     * @param owner {module:model/AppsList200ResponseInnerAllOfOwner} 
     */
    constructor(displayName, id, name, os, owner) { 
        
        TesterAppResponse.initialize(this, displayName, id, name, os, owner);
    }
    ...
    /**
     * Constructs a <code>TesterAppResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/TesterAppResponse} obj Optional instance to populate.
     * @return {module:model/TesterAppResponse} The populated <code>TesterAppResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new TesterAppResponse();
            ...
            if (data.hasOwnProperty('microsoft_internal')) {
                obj['microsoft_internal'] = ApiClient.convertToType(data['microsoft_internal'], 'Boolean');
            }
    ...
    /**
     * Validates the JSON data with respect to <code>TesterAppResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TesterAppResponse</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of TesterAppResponse.RequiredProperties) {
...
TesterAppResponse.RequiredProperties = ["display_name", "id", "name", "os", "owner"];

/**
 * The description of the app
 * @member {String} description
 */
TesterAppResponse.prototype['description'] = undefined;

/**
 * The display name of the app
 * @member {String} display_name
 */
TesterAppResponse.prototype['display_name'] = undefined;

/**
 * The string representation of the source of the app's icon
 * @member {String} icon_source
 */
TesterAppResponse.prototype['icon_source'] = undefined;

/**
 * The string representation of the URL pointing to the app's icon
 * @member {String} icon_url
 */
TesterAppResponse.prototype['icon_url'] = undefined;

/**
 * The unique ID (UUID) of the app
 * @member {String} id
 */
TesterAppResponse.prototype['id'] = undefined;

/**
 * The name of the app used in URLs
 * @member {String} name
 */
TesterAppResponse.prototype['name'] = undefined;

/**
 * The OS the app will be running on
 * @member {module:model/TesterAppResponse.OsEnum} os
 */
TesterAppResponse.prototype['os'] = undefined;

/**
 * @member {module:model/AppsList200ResponseInnerAllOfOwner} owner
 */
TesterAppResponse.prototype['owner'] = undefined;

/**
 * A one-word descriptive release-type value that starts with a capital letter but is otherwise lowercase
 * @member {String} release_type
 */
TesterAppResponse.prototype['release_type'] = undefined;

/**
 * it indicates if the app is microsoft internal
 * @member {Boolean} microsoft_internal
 */
TesterAppResponse.prototype['microsoft_internal'] = undefined;

/**
 * The permissions associated with the app
 * @member {Array.<module:model/TesterAppResponse.PermissionsEnum>} permissions
 */
TesterAppResponse.prototype['permissions'] = undefined;
 ...
 * @readonly
 */
TesterAppResponse['PermissionsEnum'] = {

    /**
     * value: "can_remove_from_app"
     * @const
     */
...
export default TesterAppResponse;
