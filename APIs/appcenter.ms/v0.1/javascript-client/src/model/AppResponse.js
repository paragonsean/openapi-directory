...
class AppResponse {
     ...
     * @param os {module:model/AppResponse.OsEnum} The OS the app will be running on
     ...
     * @param origin {module:model/AppResponse.OriginEnum} The creation origin of this app
     * @param platform {module:model/AppResponse.PlatformEnum} The platform of the app
     */
    constructor(displayName, id, name, os, owner, appSecret, origin, platform) { 
        
        AppResponse.initialize(this, displayName, id, name, os, owner, appSecret, origin, platform);
    }
...
AppResponse.RequiredProperties = ["display_name", "id", "name", "os", "owner", "app_secret", "origin", "platform"];
 ...
 */
AppResponse.prototype['display_name'] = undefined;

/**
 * The string representation of the source of the app's icon
 * @member {String} icon_source
 */
AppResponse.prototype['icon_source'] = undefined;

/**
 * The string representation of the URL pointing to the app's icon
 * @member {String} icon_url
 */
AppResponse.prototype['icon_url'] = undefined;
 ...
 * @member {module:model/AppResponse.OsEnum} os
 */
AppResponse.prototype['os'] = undefined;

/**
 * @member {module:model/AppsList200ResponseInnerAllOfOwner} owner
 */
AppResponse.prototype['owner'] = undefined;

/**
 * A one-word descriptive release-type value that starts with a capital letter but is otherwise lowercase
 * @member {String} release_type
 */
AppResponse.prototype['release_type'] = undefined;
 ...
 */
AppResponse.prototype['app_secret'] = undefined;

/**
 * @member {module:model/AppsList200ResponseInnerAllOfAzureSubscription} azure_subscription
 */
AppResponse.prototype['azure_subscription'] = undefined;

/**
 * The created date of this app
 * @member {String} created_at
 */
AppResponse.prototype['created_at'] = undefined;

/**
 * The permissions of the calling user
 * @member {Array.<module:model/AppResponse.MemberPermissionsEnum>} member_permissions
 */
AppResponse.prototype['member_permissions'] = undefined;

/**
 * The creation origin of this app
 * @member {module:model/AppResponse.OriginEnum} origin
 */
AppResponse.prototype['origin'] = undefined;

/**
 * The platform of the app
 * @member {module:model/AppResponse.PlatformEnum} platform
 */
AppResponse.prototype['platform'] = undefined;

/**
 * The last updated date of this app
 * @member {String} updated_at
 */
AppResponse.prototype['updated_at'] = undefined;
 ...
 * @readonly
 */
AppResponse['MemberPermissionsEnum'] = {
