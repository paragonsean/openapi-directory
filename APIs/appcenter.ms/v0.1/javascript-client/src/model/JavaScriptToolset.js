...
/**
 * The JavaScriptToolset model module.
 * @module model/JavaScriptToolset
 * @version v0.1
 */
class JavaScriptToolset {
    /**
     * Constructs a new <code>JavaScriptToolset</code>.
     * @alias module:model/JavaScriptToolset
     * @param packageJsonPaths {Array.<String>} Paths for detected package.json files
     */
    constructor(packageJsonPaths) { 
        
        JavaScriptToolset.initialize(this, packageJsonPaths);
    }
    ...
    /**
     * Constructs a <code>JavaScriptToolset</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/JavaScriptToolset} obj Optional instance to populate.
     * @return {module:model/JavaScriptToolset} The populated <code>JavaScriptToolset</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new JavaScriptToolset();
    ...
    /**
     * Validates the JSON data with respect to <code>JavaScriptToolset</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>JavaScriptToolset</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of JavaScriptToolset.RequiredProperties) {
...
JavaScriptToolset.RequiredProperties = ["packageJsonPaths"];
 ...
 */
JavaScriptToolset.prototype['javascriptSolutions'] = undefined;

/**
 * Paths for detected package.json files
 * @member {Array.<String>} packageJsonPaths
 */
JavaScriptToolset.prototype['packageJsonPaths'] = undefined;
...
export default JavaScriptToolset;
