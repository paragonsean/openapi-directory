...
/**
 * The BasicAppResponse model module.
 * @module model/BasicAppResponse
 * @version v0.1
 */
class BasicAppResponse {
    /**
     * Constructs a new <code>BasicAppResponse</code>.
     * @alias module:model/BasicAppResponse
     ...
     * @param os {module:model/BasicAppResponse.OsEnum} The OS the app will be running on
     * @param owner {module:model/AppsList200ResponseInnerAllOfOwner} 
     */
    constructor(displayName, id, name, os, owner) { 
        
        BasicAppResponse.initialize(this, displayName, id, name, os, owner);
    }
    ...
    /**
     * Constructs a <code>BasicAppResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/BasicAppResponse} obj Optional instance to populate.
     * @return {module:model/BasicAppResponse} The populated <code>BasicAppResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new BasicAppResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>BasicAppResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>BasicAppResponse</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of BasicAppResponse.RequiredProperties) {
...
BasicAppResponse.RequiredProperties = ["display_name", "id", "name", "os", "owner"];

/**
 * The description of the app
 * @member {String} description
 */
BasicAppResponse.prototype['description'] = undefined;

/**
 * The display name of the app
 * @member {String} display_name
 */
BasicAppResponse.prototype['display_name'] = undefined;

/**
 * The string representation of the source of the app's icon
 * @member {String} icon_source
 */
BasicAppResponse.prototype['icon_source'] = undefined;

/**
 * The string representation of the URL pointing to the app's icon
 * @member {String} icon_url
 */
BasicAppResponse.prototype['icon_url'] = undefined;

/**
 * The unique ID (UUID) of the app
 * @member {String} id
 */
BasicAppResponse.prototype['id'] = undefined;

/**
 * The name of the app used in URLs
 * @member {String} name
 */
BasicAppResponse.prototype['name'] = undefined;

/**
 * The OS the app will be running on
 * @member {module:model/BasicAppResponse.OsEnum} os
 */
BasicAppResponse.prototype['os'] = undefined;

/**
 * @member {module:model/AppsList200ResponseInnerAllOfOwner} owner
 */
BasicAppResponse.prototype['owner'] = undefined;

/**
 * A one-word descriptive release-type value that starts with a capital letter but is otherwise lowercase
 * @member {String} release_type
 */
BasicAppResponse.prototype['release_type'] = undefined;
...
export default BasicAppResponse;
