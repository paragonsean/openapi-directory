...
/**
 * The StoreReleasesList200ResponseInner model module.
 * @module model/StoreReleasesList200ResponseInner
 * @version v0.1
 */
class StoreReleasesList200ResponseInner {
    /**
     * Constructs a new <code>StoreReleasesList200ResponseInner</code>.
     * Basic information on a release
     * @alias module:model/StoreReleasesList200ResponseInner
     */
    constructor() { 
        
        StoreReleasesList200ResponseInner.initialize(this);
    }
    ...
    /**
     * Constructs a <code>StoreReleasesList200ResponseInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/StoreReleasesList200ResponseInner} obj Optional instance to populate.
     * @return {module:model/StoreReleasesList200ResponseInner} The populated <code>StoreReleasesList200ResponseInner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new StoreReleasesList200ResponseInner();
    ...
    /**
     * Validates the JSON data with respect to <code>StoreReleasesList200ResponseInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>StoreReleasesList200ResponseInner</code>.
     */
 ...
 * @member {module:model/StoreReleasesList200ResponseInner.DestinationTypeEnum} destination_type
 */
StoreReleasesList200ResponseInner.prototype['destination_type'] = undefined;
 ...
 */
StoreReleasesList200ResponseInner.prototype['distribution_stores'] = undefined;

/**
 * ID identifying this unique release.
 * @member {Number} id
 */
StoreReleasesList200ResponseInner.prototype['id'] = undefined;
 ...
 */
StoreReleasesList200ResponseInner.prototype['short_version'] = undefined;

/**
 * UTC time in ISO 8601 format of the uploaded time.
 * @member {String} uploaded_at
 */
StoreReleasesList200ResponseInner.prototype['uploaded_at'] = undefined;

/**
 * The release's version. For iOS: CFBundleVersion from info.plist. For Android: android:versionCode from AppManifest.xml. 
 * @member {String} version
 */
StoreReleasesList200ResponseInner.prototype['version'] = undefined;
 ...
 * @readonly
 */
StoreReleasesList200ResponseInner['DestinationTypeEnum'] = {
...
export default StoreReleasesList200ResponseInner;
