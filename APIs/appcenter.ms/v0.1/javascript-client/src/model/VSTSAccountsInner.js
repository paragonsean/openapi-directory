...
/**
 * The VSTSAccountsInner model module.
 * @module model/VSTSAccountsInner
 * @version v0.1
 */
class VSTSAccountsInner {
    /**
     * Constructs a new <code>VSTSAccountsInner</code>.
     * VSTS account with projects list and user info
     * @alias module:model/VSTSAccountsInner
     */
    constructor() { 
        
        VSTSAccountsInner.initialize(this);
    }
    ...
    /**
     * Constructs a <code>VSTSAccountsInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/VSTSAccountsInner} obj Optional instance to populate.
     * @return {module:model/VSTSAccountsInner} The populated <code>VSTSAccountsInner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new VSTSAccountsInner();
    ...
    /**
     * Validates the JSON data with respect to <code>VSTSAccountsInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>VSTSAccountsInner</code>.
     */
 ...
 */
VSTSAccountsInner.prototype['accountId'] = undefined;

/**
 * Account name
 * @member {String} accountName
 */
VSTSAccountsInner.prototype['accountName'] = undefined;

/**
 * Account status
 * @member {String} accountStatus
 */
VSTSAccountsInner.prototype['accountStatus'] = undefined;

/**
 * Account type
 * @member {String} accountType
 */
VSTSAccountsInner.prototype['accountType'] = undefined;

/**
 * Account uri
 * @member {String} accountUri
 */
VSTSAccountsInner.prototype['accountUri'] = undefined;

/**
 * Account projects
 * @member {Array.<module:model/VSTSAccountProjectsInner>} projects
 */
VSTSAccountsInner.prototype['projects'] = undefined;

/**
 * @member {module:model/VSTSAccountUser} user
 */
VSTSAccountsInner.prototype['user'] = undefined;
...
export default VSTSAccountsInner;
