...
/**
 * The ReleaseCreateRequestAppexProvisioningProfilesInner model module.
 * @module model/ReleaseCreateRequestAppexProvisioningProfilesInner
 * @version v0.1
 */
class ReleaseCreateRequestAppexProvisioningProfilesInner {
    /**
     * Constructs a new <code>ReleaseCreateRequestAppexProvisioningProfilesInner</code>.
     * An object containing information about an iOS provisioning profile.
     * @alias module:model/ReleaseCreateRequestAppexProvisioningProfilesInner
     ...
     * @param profileType {module:model/ReleaseCreateRequestAppexProvisioningProfilesInner.ProfileTypeEnum} 
    ...
    constructor(applicationIdentifier, expiredAt, name, profileType, teamIdentifier) { 
        ...
        ReleaseCreateRequestAppexProvisioningProfilesInner.initialize(this, applicationIdentifier, expiredAt, name, profileType, teamIdentifier);
    }
    ...
    /**
     * Constructs a <code>ReleaseCreateRequestAppexProvisioningProfilesInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ReleaseCreateRequestAppexProvisioningProfilesInner} obj Optional instance to populate.
     * @return {module:model/ReleaseCreateRequestAppexProvisioningProfilesInner} The populated <code>ReleaseCreateRequestAppexProvisioningProfilesInner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ReleaseCreateRequestAppexProvisioningProfilesInner();
    ...
    /**
     * Validates the JSON data with respect to <code>ReleaseCreateRequestAppexProvisioningProfilesInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ReleaseCreateRequestAppexProvisioningProfilesInner</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ReleaseCreateRequestAppexProvisioningProfilesInner.RequiredProperties) {
...
ReleaseCreateRequestAppexProvisioningProfilesInner.RequiredProperties = ["application_identifier", "expired_at", "name", "profile_type", "team_identifier"];

/**
 * The application identifier.
 * @member {String} application_identifier
 */
ReleaseCreateRequestAppexProvisioningProfilesInner.prototype['application_identifier'] = undefined;

/**
 * The profile's expiration date in RFC 3339 format, i.e. 2017-07-21T17:32:28Z
 * @member {String} expired_at
 */
ReleaseCreateRequestAppexProvisioningProfilesInner.prototype['expired_at'] = undefined;

/**
 * The name of the provisioning profile.
 * @member {String} name
 */
ReleaseCreateRequestAppexProvisioningProfilesInner.prototype['name'] = undefined;

/**
 * @member {module:model/ReleaseCreateRequestAppexProvisioningProfilesInner.ProfileTypeEnum} profile_type
 */
ReleaseCreateRequestAppexProvisioningProfilesInner.prototype['profile_type'] = undefined;

/**
 * The team identifier.
 * @member {String} team_identifier
 */
ReleaseCreateRequestAppexProvisioningProfilesInner.prototype['team_identifier'] = undefined;

/**
 * @member {Array.<String>} udids
 */
ReleaseCreateRequestAppexProvisioningProfilesInner.prototype['udids'] = undefined;
 ...
 * @readonly
 */
ReleaseCreateRequestAppexProvisioningProfilesInner['ProfileTypeEnum'] = {
...
export default ReleaseCreateRequestAppexProvisioningProfilesInner;
