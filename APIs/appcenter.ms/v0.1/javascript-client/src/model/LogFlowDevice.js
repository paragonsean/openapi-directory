...
/**
 * The LogFlowDevice model module.
 * @module model/LogFlowDevice
 * @version v0.1
 */
class LogFlowDevice {
    /**
     * Constructs a new <code>LogFlowDevice</code>.
     * Device characteristics.
     * @alias module:model/LogFlowDevice
    ...
    constructor(appBuild, appVersion, locale, osName, osVersion, sdkName, sdkVersion, timeZoneOffset) { 
        ...
        LogFlowDevice.initialize(this, appBuild, appVersion, locale, osName, osVersion, sdkName, sdkVersion, timeZoneOffset);
    }
    ...
    /**
     * Constructs a <code>LogFlowDevice</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/LogFlowDevice} obj Optional instance to populate.
     * @return {module:model/LogFlowDevice} The populated <code>LogFlowDevice</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new LogFlowDevice();
    ...
    /**
     * Validates the JSON data with respect to <code>LogFlowDevice</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>LogFlowDevice</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of LogFlowDevice.RequiredProperties) {
...
LogFlowDevice.RequiredProperties = ["app_build", "app_version", "locale", "os_name", "os_version", "sdk_name", "sdk_version", "time_zone_offset"];

/**
 * The app's build number, e.g. 42. 
 * @member {String} app_build
 */
LogFlowDevice.prototype['app_build'] = undefined;
 ...
 */
LogFlowDevice.prototype['app_namespace'] = undefined;

/**
 * Application version name, e.g. 1.1.0 
 * @member {String} app_version
 */
LogFlowDevice.prototype['app_version'] = undefined;

/**
 * Carrier country code (for mobile devices). 
 * @member {String} carrier_code
 */
LogFlowDevice.prototype['carrier_code'] = undefined;

/**
 * Carrier country. 
 * @member {String} carrier_country
 */
LogFlowDevice.prototype['carrier_country'] = undefined;

/**
 * Carrier name (for mobile devices). 
 * @member {String} carrier_name
 */
LogFlowDevice.prototype['carrier_name'] = undefined;

/**
 * Identifier of environment that current application release belongs to, deployment key then maps to environment like Production, Staging. 
 * @member {String} live_update_deployment_key
 */
LogFlowDevice.prototype['live_update_deployment_key'] = undefined;
 ...
 */
LogFlowDevice.prototype['live_update_package_hash'] = undefined;

/**
 * Label that is used to identify application code 'version' released via Live Update beacon running on device 
 * @member {String} live_update_release_label
 */
LogFlowDevice.prototype['live_update_release_label'] = undefined;

/**
 * Language code (example: en_US). 
 * @member {String} locale
 */
LogFlowDevice.prototype['locale'] = undefined;

/**
 * Device model (example: iPad2,3). 
 * @member {String} model
 */
LogFlowDevice.prototype['model'] = undefined;

/**
 * Device manufacturer (example: HTC). 
 * @member {String} oem_name
 */
LogFlowDevice.prototype['oem_name'] = undefined;

/**
 * API level when applicable like in Android (example: 15). 
 * @member {Number} os_api_level
 */
LogFlowDevice.prototype['os_api_level'] = undefined;

/**
 * OS build code (example: LMY47X). 
 * @member {String} os_build
 */
LogFlowDevice.prototype['os_build'] = undefined;
 ...
 */
LogFlowDevice.prototype['os_name'] = undefined;

/**
 * OS version (example: 9.3.0). 
 * @member {String} os_version
 */
LogFlowDevice.prototype['os_version'] = undefined;

/**
 * Screen size of the device in pixels (example: 640x480). 
 * @member {String} screen_size
 */
LogFlowDevice.prototype['screen_size'] = undefined;
 ...
 */
LogFlowDevice.prototype['sdk_name'] = undefined;

/**
 * Version of the SDK in semver format, e.g. \"1.2.0\" or \"0.12.3-alpha.1\". 
 * @member {String} sdk_version
 */
LogFlowDevice.prototype['sdk_version'] = undefined;

/**
 * The offset in minutes from UTC for the device time zone, including daylight savings time. 
 * @member {Number} time_zone_offset
 */
LogFlowDevice.prototype['time_zone_offset'] = undefined;
 ...
 */
LogFlowDevice.prototype['wrapper_runtime_version'] = undefined;
 ...
 */
LogFlowDevice.prototype['wrapper_sdk_name'] = undefined;
 ...
 */
LogFlowDevice.prototype['wrapper_sdk_version'] = undefined;
