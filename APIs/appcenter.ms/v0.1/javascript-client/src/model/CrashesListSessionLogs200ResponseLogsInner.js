...
/**
 * The CrashesListSessionLogs200ResponseLogsInner model module.
 * @module model/CrashesListSessionLogs200ResponseLogsInner
 * @version v0.1
 */
class CrashesListSessionLogs200ResponseLogsInner {
    /**
     * Constructs a new <code>CrashesListSessionLogs200ResponseLogsInner</code>.
     * Generic log.
     * @alias module:model/CrashesListSessionLogs200ResponseLogsInner
     ...
     * @param type {module:model/CrashesListSessionLogs200ResponseLogsInner.TypeEnum} Log type. 
     */
    constructor(device, installId, timestamp, type) { 
        
        CrashesListSessionLogs200ResponseLogsInner.initialize(this, device, installId, timestamp, type);
    }
    ...
    /**
     * Constructs a <code>CrashesListSessionLogs200ResponseLogsInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CrashesListSessionLogs200ResponseLogsInner} obj Optional instance to populate.
     * @return {module:model/CrashesListSessionLogs200ResponseLogsInner} The populated <code>CrashesListSessionLogs200ResponseLogsInner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CrashesListSessionLogs200ResponseLogsInner();
    ...
    /**
     * Validates the JSON data with respect to <code>CrashesListSessionLogs200ResponseLogsInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CrashesListSessionLogs200ResponseLogsInner</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CrashesListSessionLogs200ResponseLogsInner.RequiredProperties) {
...
CrashesListSessionLogs200ResponseLogsInner.RequiredProperties = ["device", "install_id", "timestamp", "type"];

/**
 * Account ID of the authenticated user. 
 * @member {String} account_id
 */
CrashesListSessionLogs200ResponseLogsInner.prototype['account_id'] = undefined;

/**
 * Auth service provider. 
 * @member {String} auth_provider
 */
CrashesListSessionLogs200ResponseLogsInner.prototype['auth_provider'] = undefined;

/**
 * @member {module:model/AnalyticsGenericLogFlow200ResponseLogsInnerDevice} device
 */
CrashesListSessionLogs200ResponseLogsInner.prototype['device'] = undefined;

/**
 * Event ID. 
 * @member {String} event_id
 */
CrashesListSessionLogs200ResponseLogsInner.prototype['event_id'] = undefined;

/**
 * Event name. 
 * @member {String} event_name
 */
CrashesListSessionLogs200ResponseLogsInner.prototype['event_name'] = undefined;

/**
 * Install ID. 
 * @member {String} install_id
 */
CrashesListSessionLogs200ResponseLogsInner.prototype['install_id'] = undefined;

/**
 * Message ID. 
 * @member {String} message_id
 */
CrashesListSessionLogs200ResponseLogsInner.prototype['message_id'] = undefined;

/**
 * event specific properties. 
 * @member {Object.<String, String>} properties
 */
CrashesListSessionLogs200ResponseLogsInner.prototype['properties'] = undefined;

/**
 * Session ID. 
 * @member {String} session_id
 */
CrashesListSessionLogs200ResponseLogsInner.prototype['session_id'] = undefined;

/**
 * Log creation timestamp. 
 * @member {Date} timestamp
 */
CrashesListSessionLogs200ResponseLogsInner.prototype['timestamp'] = undefined;

/**
 * Log type. 
 * @member {module:model/CrashesListSessionLogs200ResponseLogsInner.TypeEnum} type
 */
CrashesListSessionLogs200ResponseLogsInner.prototype['type'] = undefined;
 ...
 * @readonly
 */
CrashesListSessionLogs200ResponseLogsInner['TypeEnum'] = {
...
export default CrashesListSessionLogs200ResponseLogsInner;
