...
/**
 * The LogDiagnostics model module.
 * @module model/LogDiagnostics
 * @version v0.1
 */
class LogDiagnostics {
    /**
     * Constructs a new <code>LogDiagnostics</code>.
     * @alias module:model/LogDiagnostics
     ...
     * @param type {module:model/LogDiagnostics.TypeEnum} Log type. 
     */
    constructor(device, installId, timestamp, type) { 
        
        LogDiagnostics.initialize(this, device, installId, timestamp, type);
    }
    ...
    /**
     * Constructs a <code>LogDiagnostics</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/LogDiagnostics} obj Optional instance to populate.
     * @return {module:model/LogDiagnostics} The populated <code>LogDiagnostics</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new LogDiagnostics();
    ...
    /**
     * Validates the JSON data with respect to <code>LogDiagnostics</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>LogDiagnostics</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of LogDiagnostics.RequiredProperties) {
...
LogDiagnostics.RequiredProperties = ["device", "install_id", "timestamp", "type"];

/**
 * @member {module:model/AnalyticsGenericLogFlow200ResponseLogsInnerDevice} device
 */
LogDiagnostics.prototype['device'] = undefined;

/**
 * Install ID. 
 * @member {String} install_id
 */
LogDiagnostics.prototype['install_id'] = undefined;

/**
 * Log creation timestamp. 
 * @member {Date} timestamp
 */
LogDiagnostics.prototype['timestamp'] = undefined;

/**
 * Log type. 
 * @member {module:model/LogDiagnostics.TypeEnum} type
 */
LogDiagnostics.prototype['type'] = undefined;
