...
/**
 * The ErrorLog model module.
 * @module model/ErrorLog
 * @version v0.1
 */
class ErrorLog {
    /**
     * Constructs a new <code>ErrorLog</code>.
     * Error log.
     * @alias module:model/ErrorLog
     ...
     * @param type {module:model/ErrorLog.TypeEnum} Log type. 
     */
    constructor(device, installId, timestamp, type) { 
        
        ErrorLog.initialize(this, device, installId, timestamp, type);
    }
    ...
    /**
     * Constructs a <code>ErrorLog</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ErrorLog} obj Optional instance to populate.
     * @return {module:model/ErrorLog} The populated <code>ErrorLog</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ErrorLog();
    ...
    /**
     * Validates the JSON data with respect to <code>ErrorLog</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ErrorLog</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ErrorLog.RequiredProperties) {
...
ErrorLog.RequiredProperties = ["id", "session_id", "device", "install_id", "timestamp", "type"];
 ...
 */
ErrorLog.prototype['app_launch_toffset'] = undefined;

/**
 * Error identifier.
 * @member {String} id
 */
ErrorLog.prototype['id'] = undefined;

/**
 * Session ID. 
 * @member {String} session_id
 */
ErrorLog.prototype['session_id'] = undefined;

/**
 * @member {module:model/AnalyticsGenericLogFlow200ResponseLogsInnerDevice} device
 */
ErrorLog.prototype['device'] = undefined;

/**
 * Install ID. 
 * @member {String} install_id
 */
ErrorLog.prototype['install_id'] = undefined;

/**
 * Log creation timestamp. 
 * @member {Date} timestamp
 */
ErrorLog.prototype['timestamp'] = undefined;

/**
 * Log type. 
 * @member {module:model/ErrorLog.TypeEnum} type
 */
ErrorLog.prototype['type'] = undefined;
