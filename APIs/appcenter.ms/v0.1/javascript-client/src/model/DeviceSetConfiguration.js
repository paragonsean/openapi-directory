...
/**
 * The DeviceSetConfiguration model module.
 * @module model/DeviceSetConfiguration
 * @version v0.1
 */
class DeviceSetConfiguration {
    /**
     * Constructs a new <code>DeviceSetConfiguration</code>.
     * @alias module:model/DeviceSetConfiguration
     */
    constructor() { 
        
        DeviceSetConfiguration.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DeviceSetConfiguration</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DeviceSetConfiguration} obj Optional instance to populate.
     * @return {module:model/DeviceSetConfiguration} The populated <code>DeviceSetConfiguration</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DeviceSetConfiguration();
    ...
    /**
     * Validates the JSON data with respect to <code>DeviceSetConfiguration</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DeviceSetConfiguration</code>.
     */
 ...
 * @member {String} id
 */
DeviceSetConfiguration.prototype['id'] = undefined;

/**
 * @member {module:model/DeviceSetDeviceConfigurationsInnerImage} image
 */
DeviceSetConfiguration.prototype['image'] = undefined;

/**
 * @member {module:model/DeviceSetDeviceConfigurationsInnerModel} model
 */
DeviceSetConfiguration.prototype['model'] = undefined;

/**
 * @member {String} os
 */
DeviceSetConfiguration.prototype['os'] = undefined;

/**
 * @member {String} osName
 */
DeviceSetConfiguration.prototype['osName'] = undefined;
