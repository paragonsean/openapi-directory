...
/**
 * The DiagnosticsStackFrame model module.
 * @module model/DiagnosticsStackFrame
 * @version v0.1
 */
class DiagnosticsStackFrame {
    /**
     * Constructs a new <code>DiagnosticsStackFrame</code>.
     * a single frame of a stack trace
     * @alias module:model/DiagnosticsStackFrame
    ...
    constructor(appCode, codeFormatted, codeRaw) { 
        ...
        DiagnosticsStackFrame.initialize(this, appCode, codeFormatted, codeRaw);
    }
    ...
    /**
     * Constructs a <code>DiagnosticsStackFrame</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DiagnosticsStackFrame} obj Optional instance to populate.
     * @return {module:model/DiagnosticsStackFrame} The populated <code>DiagnosticsStackFrame</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DiagnosticsStackFrame();
    ...
    /**
     * Validates the JSON data with respect to <code>DiagnosticsStackFrame</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DiagnosticsStackFrame</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DiagnosticsStackFrame.RequiredProperties) {
...
DiagnosticsStackFrame.RequiredProperties = ["app_code", "code_formatted", "code_raw"];

/**
 * address of the frame
 * @member {String} address
 */
DiagnosticsStackFrame.prototype['address'] = undefined;

/**
 * this line isn't from any framework
 * @member {Boolean} app_code
 */
DiagnosticsStackFrame.prototype['app_code'] = undefined;

/**
 * is a class method
 * @member {Boolean} class_method
 */
DiagnosticsStackFrame.prototype['class_method'] = undefined;

/**
 * name of the class
 * @member {String} class_name
 */
DiagnosticsStackFrame.prototype['class_name'] = undefined;

/**
 * Formatted frame string
 * @member {String} code_formatted
 */
DiagnosticsStackFrame.prototype['code_formatted'] = undefined;

/**
 * Raw frame string
 * @member {String} code_raw
 */
DiagnosticsStackFrame.prototype['code_raw'] = undefined;

/**
 * name of the file
 * @member {String} file
 */
DiagnosticsStackFrame.prototype['file'] = undefined;

/**
 * Name of the framework
 * @member {String} framework_name
 */
DiagnosticsStackFrame.prototype['framework_name'] = undefined;

/**
 * programming language of the frame
 * @member {module:model/DiagnosticsStackFrame.LanguageEnum} language
 */
DiagnosticsStackFrame.prototype['language'] = undefined;

/**
 * line number
 * @member {Number} line
 */
DiagnosticsStackFrame.prototype['line'] = undefined;

/**
 * name of the method
 * @member {String} method
 */
DiagnosticsStackFrame.prototype['method'] = undefined;

/**
 * parameters of the frames method
 * @member {String} method_params
 */
DiagnosticsStackFrame.prototype['method_params'] = undefined;

/**
 * frame should be shown always
 * @member {Boolean} relevant
 */
DiagnosticsStackFrame.prototype['relevant'] = undefined;
 ...
 * @readonly
 */
DiagnosticsStackFrame['LanguageEnum'] = {
...
export default DiagnosticsStackFrame;
