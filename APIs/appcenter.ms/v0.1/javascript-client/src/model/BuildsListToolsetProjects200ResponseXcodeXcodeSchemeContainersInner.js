...
/**
 * The BuildsListToolsetProjects200ResponseXcodeXcodeSchemeContainersInner model module.
 * @module model/BuildsListToolsetProjects200ResponseXcodeXcodeSchemeContainersInner
 * @version v0.1
 */
class BuildsListToolsetProjects200ResponseXcodeXcodeSchemeContainersInner {
    /**
     * Constructs a new <code>BuildsListToolsetProjects200ResponseXcodeXcodeSchemeContainersInner</code>.
     * @alias module:model/BuildsListToolsetProjects200ResponseXcodeXcodeSchemeContainersInner
    ...
    constructor(path, sharedSchemes) { 
        ...
        BuildsListToolsetProjects200ResponseXcodeXcodeSchemeContainersInner.initialize(this, path, sharedSchemes);
    }
    ...
    /**
     * Constructs a <code>BuildsListToolsetProjects200ResponseXcodeXcodeSchemeContainersInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/BuildsListToolsetProjects200ResponseXcodeXcodeSchemeContainersInner} obj Optional instance to populate.
     * @return {module:model/BuildsListToolsetProjects200ResponseXcodeXcodeSchemeContainersInner} The populated <code>BuildsListToolsetProjects200ResponseXcodeXcodeSchemeContainersInner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new BuildsListToolsetProjects200ResponseXcodeXcodeSchemeContainersInner();
    ...
    /**
     * Validates the JSON data with respect to <code>BuildsListToolsetProjects200ResponseXcodeXcodeSchemeContainersInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>BuildsListToolsetProjects200ResponseXcodeXcodeSchemeContainersInner</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of BuildsListToolsetProjects200ResponseXcodeXcodeSchemeContainersInner.RequiredProperties) {
...
BuildsListToolsetProjects200ResponseXcodeXcodeSchemeContainersInner.RequiredProperties = ["path", "sharedSchemes"];
 ...
 */
BuildsListToolsetProjects200ResponseXcodeXcodeSchemeContainersInner.prototype['appExtensionTargets'] = undefined;

/**
 * Path to Carthage file, if present
 * @member {String} cartfilePath
 */
BuildsListToolsetProjects200ResponseXcodeXcodeSchemeContainersInner.prototype['cartfilePath'] = undefined;

/**
 * Path to project
 * @member {String} path
 */
BuildsListToolsetProjects200ResponseXcodeXcodeSchemeContainersInner.prototype['path'] = undefined;

/**
 * Path to CocoaPods file, if present
 * @member {String} podfilePath
 */
BuildsListToolsetProjects200ResponseXcodeXcodeSchemeContainersInner.prototype['podfilePath'] = undefined;
 ...
 */
BuildsListToolsetProjects200ResponseXcodeXcodeSchemeContainersInner.prototype['sharedSchemes'] = undefined;

/**
 * Related projects paths for xcworkspace
 * @member {String} workspaceProjectPaths
 */
BuildsListToolsetProjects200ResponseXcodeXcodeSchemeContainersInner.prototype['workspaceProjectPaths'] = undefined;

/**
 * repo object Id of the pbxproject
 * @member {String} xcodeProjectSha
 */
BuildsListToolsetProjects200ResponseXcodeXcodeSchemeContainersInner.prototype['xcodeProjectSha'] = undefined;
...
export default BuildsListToolsetProjects200ResponseXcodeXcodeSchemeContainersInner;
