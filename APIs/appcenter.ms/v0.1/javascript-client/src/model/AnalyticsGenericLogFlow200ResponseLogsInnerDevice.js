...
/**
 * The AnalyticsGenericLogFlow200ResponseLogsInnerDevice model module.
 * @module model/AnalyticsGenericLogFlow200ResponseLogsInnerDevice
 * @version v0.1
 */
class AnalyticsGenericLogFlow200ResponseLogsInnerDevice {
    /**
     * Constructs a new <code>AnalyticsGenericLogFlow200ResponseLogsInnerDevice</code>.
     * Device characteristics.
     * @alias module:model/AnalyticsGenericLogFlow200ResponseLogsInnerDevice
    ...
    constructor(appBuild, appVersion, locale, osName, osVersion, sdkName, sdkVersion, timeZoneOffset) { 
        ...
        AnalyticsGenericLogFlow200ResponseLogsInnerDevice.initialize(this, appBuild, appVersion, locale, osName, osVersion, sdkName, sdkVersion, timeZoneOffset);
    }
    ...
    /**
     * Constructs a <code>AnalyticsGenericLogFlow200ResponseLogsInnerDevice</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AnalyticsGenericLogFlow200ResponseLogsInnerDevice} obj Optional instance to populate.
     * @return {module:model/AnalyticsGenericLogFlow200ResponseLogsInnerDevice} The populated <code>AnalyticsGenericLogFlow200ResponseLogsInnerDevice</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AnalyticsGenericLogFlow200ResponseLogsInnerDevice();
    ...
    /**
     * Validates the JSON data with respect to <code>AnalyticsGenericLogFlow200ResponseLogsInnerDevice</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AnalyticsGenericLogFlow200ResponseLogsInnerDevice</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of AnalyticsGenericLogFlow200ResponseLogsInnerDevice.RequiredProperties) {
...
AnalyticsGenericLogFlow200ResponseLogsInnerDevice.RequiredProperties = ["app_build", "app_version", "locale", "os_name", "os_version", "sdk_name", "sdk_version", "time_zone_offset"];

/**
 * The app's build number, e.g. 42. 
 * @member {String} app_build
 */
AnalyticsGenericLogFlow200ResponseLogsInnerDevice.prototype['app_build'] = undefined;
 ...
 */
AnalyticsGenericLogFlow200ResponseLogsInnerDevice.prototype['app_namespace'] = undefined;

/**
 * Application version name, e.g. 1.1.0 
 * @member {String} app_version
 */
AnalyticsGenericLogFlow200ResponseLogsInnerDevice.prototype['app_version'] = undefined;

/**
 * Carrier country code (for mobile devices). 
 * @member {String} carrier_code
 */
AnalyticsGenericLogFlow200ResponseLogsInnerDevice.prototype['carrier_code'] = undefined;

/**
 * Carrier country. 
 * @member {String} carrier_country
 */
AnalyticsGenericLogFlow200ResponseLogsInnerDevice.prototype['carrier_country'] = undefined;

/**
 * Carrier name (for mobile devices). 
 * @member {String} carrier_name
 */
AnalyticsGenericLogFlow200ResponseLogsInnerDevice.prototype['carrier_name'] = undefined;

/**
 * Identifier of environment that current application release belongs to, deployment key then maps to environment like Production, Staging. 
 * @member {String} live_update_deployment_key
 */
AnalyticsGenericLogFlow200ResponseLogsInnerDevice.prototype['live_update_deployment_key'] = undefined;
 ...
 */
AnalyticsGenericLogFlow200ResponseLogsInnerDevice.prototype['live_update_package_hash'] = undefined;

/**
 * Label that is used to identify application code 'version' released via Live Update beacon running on device 
 * @member {String} live_update_release_label
 */
AnalyticsGenericLogFlow200ResponseLogsInnerDevice.prototype['live_update_release_label'] = undefined;

/**
 * Language code (example: en_US). 
 * @member {String} locale
 */
AnalyticsGenericLogFlow200ResponseLogsInnerDevice.prototype['locale'] = undefined;

/**
 * Device model (example: iPad2,3). 
 * @member {String} model
 */
AnalyticsGenericLogFlow200ResponseLogsInnerDevice.prototype['model'] = undefined;

/**
 * Device manufacturer (example: HTC). 
 * @member {String} oem_name
 */
AnalyticsGenericLogFlow200ResponseLogsInnerDevice.prototype['oem_name'] = undefined;

/**
 * API level when applicable like in Android (example: 15). 
 * @member {Number} os_api_level
 */
AnalyticsGenericLogFlow200ResponseLogsInnerDevice.prototype['os_api_level'] = undefined;

/**
 * OS build code (example: LMY47X). 
 * @member {String} os_build
 */
AnalyticsGenericLogFlow200ResponseLogsInnerDevice.prototype['os_build'] = undefined;
 ...
 */
AnalyticsGenericLogFlow200ResponseLogsInnerDevice.prototype['os_name'] = undefined;

/**
 * OS version (example: 9.3.0). 
 * @member {String} os_version
 */
AnalyticsGenericLogFlow200ResponseLogsInnerDevice.prototype['os_version'] = undefined;

/**
 * Screen size of the device in pixels (example: 640x480). 
 * @member {String} screen_size
 */
AnalyticsGenericLogFlow200ResponseLogsInnerDevice.prototype['screen_size'] = undefined;
 ...
 */
AnalyticsGenericLogFlow200ResponseLogsInnerDevice.prototype['sdk_name'] = undefined;

/**
 * Version of the SDK in semver format, e.g. \"1.2.0\" or \"0.12.3-alpha.1\". 
 * @member {String} sdk_version
 */
AnalyticsGenericLogFlow200ResponseLogsInnerDevice.prototype['sdk_version'] = undefined;

/**
 * The offset in minutes from UTC for the device time zone, including daylight savings time. 
 * @member {Number} time_zone_offset
 */
AnalyticsGenericLogFlow200ResponseLogsInnerDevice.prototype['time_zone_offset'] = undefined;
 ...
 */
AnalyticsGenericLogFlow200ResponseLogsInnerDevice.prototype['wrapper_runtime_version'] = undefined;
 ...
 */
AnalyticsGenericLogFlow200ResponseLogsInnerDevice.prototype['wrapper_sdk_name'] = undefined;
 ...
 */
AnalyticsGenericLogFlow200ResponseLogsInnerDevice.prototype['wrapper_sdk_version'] = undefined;
...
export default AnalyticsGenericLogFlow200ResponseLogsInnerDevice;
