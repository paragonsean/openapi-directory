...
class CustomProperty {
    ...
    constructor(name, type) { 
        ...
        CustomProperty.initialize(this, name, type);
    }
    ...
    /**
     * Validates the JSON data with respect to <code>CustomProperty</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CustomProperty</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CustomProperty.RequiredProperties) {
...
CustomProperty.RequiredProperties = ["name", "type"];

/**
 * @member {String} name
 */
CustomProperty.prototype['name'] = undefined;

/**
 * @member {String} type
 */
CustomProperty.prototype['type'] = undefined;
