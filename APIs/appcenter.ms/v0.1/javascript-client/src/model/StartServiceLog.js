...
/**
 * The StartServiceLog model module.
 * @module model/StartServiceLog
 * @version v0.1
 */
class StartServiceLog {
    /**
     * Constructs a new <code>StartServiceLog</code>.
     * Describe a AppCenter.Start API call from the SDK.
     * @alias module:model/StartServiceLog
     ...
     * @param type {module:model/StartServiceLog.TypeEnum} Log type. 
     */
    constructor(device, installId, timestamp, type) { 
        
        StartServiceLog.initialize(this, device, installId, timestamp, type);
    }
    ...
    /**
     * Constructs a <code>StartServiceLog</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/StartServiceLog} obj Optional instance to populate.
     * @return {module:model/StartServiceLog} The populated <code>StartServiceLog</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new StartServiceLog();
    ...
    /**
     * Validates the JSON data with respect to <code>StartServiceLog</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>StartServiceLog</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of StartServiceLog.RequiredProperties) {
...
StartServiceLog.RequiredProperties = ["device", "install_id", "timestamp", "type"];

/**
 * The list of services of the AppCenter Start API call.
 * @member {Array.<String>} services
 */
StartServiceLog.prototype['services'] = undefined;

/**
 * @member {module:model/AnalyticsGenericLogFlow200ResponseLogsInnerDevice} device
 */
StartServiceLog.prototype['device'] = undefined;

/**
 * Install ID. 
 * @member {String} install_id
 */
StartServiceLog.prototype['install_id'] = undefined;

/**
 * Log creation timestamp. 
 * @member {Date} timestamp
 */
StartServiceLog.prototype['timestamp'] = undefined;

/**
 * Log type. 
 * @member {module:model/StartServiceLog.TypeEnum} type
 */
StartServiceLog.prototype['type'] = undefined;
...
export default StartServiceLog;
