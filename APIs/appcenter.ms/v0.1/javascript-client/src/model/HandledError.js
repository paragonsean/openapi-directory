...
/**
 * The HandledError model module.
 * @module model/HandledError
 * @version v0.1
 */
class HandledError {
    /**
     * Constructs a new <code>HandledError</code>.
     * @alias module:model/HandledError
     */
    constructor() { 
        
        HandledError.initialize(this);
    }
    ...
    /**
     * Constructs a <code>HandledError</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/HandledError} obj Optional instance to populate.
     * @return {module:model/HandledError} The populated <code>HandledError</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new HandledError();
    ...
    /**
     * Validates the JSON data with respect to <code>HandledError</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>HandledError</code>.
     */
 ...
 */
HandledError.prototype['country'] = undefined;

/**
 * @member {String} deviceName
 */
HandledError.prototype['deviceName'] = undefined;

/**
 * @member {String} errorId
 */
HandledError.prototype['errorId'] = undefined;

/**
 * @member {Boolean} hasAttachments
 */
HandledError.prototype['hasAttachments'] = undefined;

/**
 * @member {Boolean} hasBreadcrumbs
 */
HandledError.prototype['hasBreadcrumbs'] = undefined;

/**
 * @member {String} language
 */
HandledError.prototype['language'] = undefined;

/**
 * @member {String} osType
 */
HandledError.prototype['osType'] = undefined;

/**
 * @member {String} osVersion
 */
HandledError.prototype['osVersion'] = undefined;

/**
 * @member {Date} timestamp
 */
HandledError.prototype['timestamp'] = undefined;

/**
 * @member {String} userId
 */
HandledError.prototype['userId'] = undefined;
