...
class Log {
     ...
     * @param type {module:model/Log.TypeEnum} Log type. 
     */
    constructor(device, installId, timestamp, type) { 
        
        Log.initialize(this, device, installId, timestamp, type);
    }
...
Log.RequiredProperties = ["device", "install_id", "timestamp", "type"];

/**
 * @member {module:model/AnalyticsGenericLogFlow200ResponseLogsInnerDevice} device
 */
Log.prototype['device'] = undefined;

/**
 * Install ID. 
 * @member {String} install_id
 */
Log.prototype['install_id'] = undefined;
...
/**
 * Log type. 
 * @member {module:model/Log.TypeEnum} type
 */
