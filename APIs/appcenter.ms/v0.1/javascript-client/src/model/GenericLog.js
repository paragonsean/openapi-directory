...
/**
 * The GenericLog model module.
 * @module model/GenericLog
 * @version v0.1
 */
class GenericLog {
    /**
     * Constructs a new <code>GenericLog</code>.
     * Generic log.
     * @alias module:model/GenericLog
     ...
     * @param type {module:model/GenericLog.TypeEnum} Log type. 
     */
    constructor(device, installId, timestamp, type) { 
        
        GenericLog.initialize(this, device, installId, timestamp, type);
    }
    ...
    /**
     * Constructs a <code>GenericLog</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GenericLog} obj Optional instance to populate.
     * @return {module:model/GenericLog} The populated <code>GenericLog</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GenericLog();
    ...
    /**
     * Validates the JSON data with respect to <code>GenericLog</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GenericLog</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of GenericLog.RequiredProperties) {
...
GenericLog.RequiredProperties = ["device", "install_id", "timestamp", "type"];

/**
 * Account ID of the authenticated user. 
 * @member {String} account_id
 */
GenericLog.prototype['account_id'] = undefined;

/**
 * Auth service provider. 
 * @member {String} auth_provider
 */
GenericLog.prototype['auth_provider'] = undefined;

/**
 * @member {module:model/AnalyticsGenericLogFlow200ResponseLogsInnerDevice} device
 */
GenericLog.prototype['device'] = undefined;

/**
 * Event ID. 
 * @member {String} event_id
 */
GenericLog.prototype['event_id'] = undefined;

/**
 * Event name. 
 * @member {String} event_name
 */
GenericLog.prototype['event_name'] = undefined;

/**
 * Install ID. 
 * @member {String} install_id
 */
GenericLog.prototype['install_id'] = undefined;

/**
 * Message ID. 
 * @member {String} message_id
 */
GenericLog.prototype['message_id'] = undefined;

/**
 * event specific properties. 
 * @member {Object.<String, String>} properties
 */
GenericLog.prototype['properties'] = undefined;

/**
 * Session ID. 
 * @member {String} session_id
 */
GenericLog.prototype['session_id'] = undefined;

/**
 * Log creation timestamp. 
 * @member {Date} timestamp
 */
GenericLog.prototype['timestamp'] = undefined;

/**
 * Log type. 
 * @member {module:model/GenericLog.TypeEnum} type
 */
GenericLog.prototype['type'] = undefined;
