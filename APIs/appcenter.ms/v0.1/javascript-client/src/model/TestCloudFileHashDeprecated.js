...
/**
 * The TestCloudFileHashDeprecated model module.
 * @module model/TestCloudFileHashDeprecated
 * @version v0.1
 */
class TestCloudFileHashDeprecated {
    /**
     * Constructs a new <code>TestCloudFileHashDeprecated</code>.
     * Hash, type, path and byte range of a file that is required in test run
     * @alias module:model/TestCloudFileHashDeprecated
     * @param checksum {String} SHA256 hash of the file
     * @param fileType {module:model/TestCloudFileHashDeprecated.FileTypeEnum} Type of the file
     * @param relativePath {String} Relative path of the file
     */
    constructor(checksum, fileType, relativePath) { 
        
        TestCloudFileHashDeprecated.initialize(this, checksum, fileType, relativePath);
    }
    ...
    /**
     * Constructs a <code>TestCloudFileHashDeprecated</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/TestCloudFileHashDeprecated} obj Optional instance to populate.
     * @return {module:model/TestCloudFileHashDeprecated} The populated <code>TestCloudFileHashDeprecated</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new TestCloudFileHashDeprecated();
    ...
    /**
     * Validates the JSON data with respect to <code>TestCloudFileHashDeprecated</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TestCloudFileHashDeprecated</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of TestCloudFileHashDeprecated.RequiredProperties) {
...
TestCloudFileHashDeprecated.RequiredProperties = ["checksum", "file_type", "relative_path"];

/**
 * Range of bytes required to verify ownership of the file
 * @member {String} byte_range
 */
TestCloudFileHashDeprecated.prototype['byte_range'] = undefined;

/**
 * SHA256 hash of the file
 * @member {String} checksum
 */
TestCloudFileHashDeprecated.prototype['checksum'] = undefined;

/**
 * Type of the file
 * @member {module:model/TestCloudFileHashDeprecated.FileTypeEnum} file_type
 */
TestCloudFileHashDeprecated.prototype['file_type'] = undefined;

/**
 * Relative path of the file
 * @member {String} relative_path
 */
TestCloudFileHashDeprecated.prototype['relative_path'] = undefined;
 ...
 * @readonly
 */
TestCloudFileHashDeprecated['FileTypeEnum'] = {
...
export default TestCloudFileHashDeprecated;
