...
/**
 * The StoresReleaseDetails model module.
 * @module model/StoresReleaseDetails
 * @version v0.1
 */
class StoresReleaseDetails {
    /**
     * Constructs a new <code>StoresReleaseDetails</code>.
     * Details of an uploaded release
     * @alias module:model/StoresReleaseDetails
     */
    constructor() { 
        
        StoresReleaseDetails.initialize(this);
    }
    ...
    /**
     * Constructs a <code>StoresReleaseDetails</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/StoresReleaseDetails} obj Optional instance to populate.
     * @return {module:model/StoresReleaseDetails} The populated <code>StoresReleaseDetails</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new StoresReleaseDetails();
    ...
    /**
     * Validates the JSON data with respect to <code>StoresReleaseDetails</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>StoresReleaseDetails</code>.
     */
 ...
 */
StoresReleaseDetails.prototype['android_min_api_level'] = undefined;

/**
 * The app's display name.
 * @member {String} app_display_name
 */
StoresReleaseDetails.prototype['app_display_name'] = undefined;

/**
 * The app's name (extracted from the uploaded release).
 * @member {String} app_name
 */
StoresReleaseDetails.prototype['app_name'] = undefined;

/**
 * The identifier of the apps bundle.
 * @member {String} bundle_identifier
 */
StoresReleaseDetails.prototype['bundle_identifier'] = undefined;
 ...
 */
StoresReleaseDetails.prototype['distribution_stores'] = undefined;

/**
 * The URL that hosts the binary for this release.
 * @member {String} download_url
 */
StoresReleaseDetails.prototype['download_url'] = undefined;

/**
 * MD5 checksum of the release binary.
 * @member {String} fingerprint
 */
StoresReleaseDetails.prototype['fingerprint'] = undefined;

/**
 * ID identifying this unique release.
 * @member {Number} id
 */
StoresReleaseDetails.prototype['id'] = undefined;
 ...
 * @member {module:model/StoresReleaseDetails.InstallUrlEnum} install_url
 */
StoresReleaseDetails.prototype['install_url'] = undefined;

/**
 * The release's minimum required operating system.
 * @member {String} min_os
 */
StoresReleaseDetails.prototype['min_os'] = undefined;

/**
 * The release's release notes.
 * @member {String} release_notes
 */
StoresReleaseDetails.prototype['release_notes'] = undefined;
 ...
 */
StoresReleaseDetails.prototype['short_version'] = undefined;

/**
 * The release's size in bytes.
 * @member {Number} size
 */
StoresReleaseDetails.prototype['size'] = undefined;
 ...
 * @member {module:model/StoresReleaseDetails.StatusEnum} status
 */
StoresReleaseDetails.prototype['status'] = undefined;

/**
 * UTC time in ISO 8601 format of the uploaded time.
 * @member {String} uploaded_at
 */
StoresReleaseDetails.prototype['uploaded_at'] = undefined;
 ...
 */
StoresReleaseDetails.prototype['version'] = undefined;
 ...
 * @readonly
 */
StoresReleaseDetails['InstallUrlEnum'] = {
 ...
 * @readonly
 */
StoresReleaseDetails['StatusEnum'] = {
...
export default StoresReleaseDetails;
