...
/**
 * The CrashGroupsList200ResponseCrashGroupsInnerReasonFrame model module.
 * @module model/CrashGroupsList200ResponseCrashGroupsInnerReasonFrame
 * @version v0.1
 */
class CrashGroupsList200ResponseCrashGroupsInnerReasonFrame {
    /**
     * Constructs a new <code>CrashGroupsList200ResponseCrashGroupsInnerReasonFrame</code>.
     * frame belonging to the reason of the crash
     * @alias module:model/CrashGroupsList200ResponseCrashGroupsInnerReasonFrame
     */
    constructor() { 
        
        CrashGroupsList200ResponseCrashGroupsInnerReasonFrame.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CrashGroupsList200ResponseCrashGroupsInnerReasonFrame</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CrashGroupsList200ResponseCrashGroupsInnerReasonFrame} obj Optional instance to populate.
     * @return {module:model/CrashGroupsList200ResponseCrashGroupsInnerReasonFrame} The populated <code>CrashGroupsList200ResponseCrashGroupsInnerReasonFrame</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CrashGroupsList200ResponseCrashGroupsInnerReasonFrame();
    ...
    /**
     * Validates the JSON data with respect to <code>CrashGroupsList200ResponseCrashGroupsInnerReasonFrame</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CrashGroupsList200ResponseCrashGroupsInnerReasonFrame</code>.
     */
 ...
 */
CrashGroupsList200ResponseCrashGroupsInnerReasonFrame.prototype['app_code'] = undefined;

/**
 * is a class method
 * @member {Boolean} class_method
 */
CrashGroupsList200ResponseCrashGroupsInnerReasonFrame.prototype['class_method'] = undefined;

/**
 * name of the class
 * @member {String} class_name
 */
CrashGroupsList200ResponseCrashGroupsInnerReasonFrame.prototype['class_name'] = undefined;

/**
 * Formatted frame string
 * @member {String} code_formatted
 */
CrashGroupsList200ResponseCrashGroupsInnerReasonFrame.prototype['code_formatted'] = undefined;

/**
 * Unformatted Frame string
 * @member {String} code_raw
 */
CrashGroupsList200ResponseCrashGroupsInnerReasonFrame.prototype['code_raw'] = undefined;

/**
 * Exception type.
 * @member {String} exception_type
 */
CrashGroupsList200ResponseCrashGroupsInnerReasonFrame.prototype['exception_type'] = undefined;

/**
 * name of the file
 * @member {String} file
 */
CrashGroupsList200ResponseCrashGroupsInnerReasonFrame.prototype['file'] = undefined;

/**
 * Name of the framework
 * @member {String} framework_name
 */
CrashGroupsList200ResponseCrashGroupsInnerReasonFrame.prototype['framework_name'] = undefined;

/**
 * programming language of the frame
 * @member {module:model/CrashGroupsList200ResponseCrashGroupsInnerReasonFrame.LanguageEnum} language
 */
CrashGroupsList200ResponseCrashGroupsInnerReasonFrame.prototype['language'] = undefined;

/**
 * line number
 * @member {Number} line
 */
CrashGroupsList200ResponseCrashGroupsInnerReasonFrame.prototype['line'] = undefined;

/**
 * name of the method
 * @member {String} method
 */
CrashGroupsList200ResponseCrashGroupsInnerReasonFrame.prototype['method'] = undefined;

/**
 * parameters of the frames method
 * @member {String} method_params
 */
CrashGroupsList200ResponseCrashGroupsInnerReasonFrame.prototype['method_params'] = undefined;

/**
 * OS exception type. (aka. SIGNAL)
 * @member {String} os_exception_type
 */
CrashGroupsList200ResponseCrashGroupsInnerReasonFrame.prototype['os_exception_type'] = undefined;
 ...
 * @readonly
 */
CrashGroupsList200ResponseCrashGroupsInnerReasonFrame['LanguageEnum'] = {
...
export default CrashGroupsList200ResponseCrashGroupsInnerReasonFrame;
