...
/**
 * The AppsUpdateRequest model module.
 * @module model/AppsUpdateRequest
 * @version v0.1
 */
class AppsUpdateRequest {
    /**
     * Constructs a new <code>AppsUpdateRequest</code>.
     * @alias module:model/AppsUpdateRequest
     */
    constructor() { 
        
        AppsUpdateRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>AppsUpdateRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AppsUpdateRequest} obj Optional instance to populate.
     * @return {module:model/AppsUpdateRequest} The populated <code>AppsUpdateRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AppsUpdateRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>AppsUpdateRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AppsUpdateRequest</code>.
     */
 ...
 */
AppsUpdateRequest.prototype['description'] = undefined;

/**
 * The display name of the app
 * @member {String} display_name
 */
AppsUpdateRequest.prototype['display_name'] = undefined;

/**
 * The uuid for the icon's asset id from ACFUS
 * @member {String} icon_asset_id
 */
AppsUpdateRequest.prototype['icon_asset_id'] = undefined;

/**
 * The string representation of the URL pointing to the app's icon
 * @member {String} icon_url
 */
AppsUpdateRequest.prototype['icon_url'] = undefined;

/**
 * The name of the app used in URLs
 * @member {String} name
 */
AppsUpdateRequest.prototype['name'] = undefined;

/**
 * A one-word descriptive release type value that starts with a capital letter but is otherwise lowercase
 * @member {String} release_type
 */
AppsUpdateRequest.prototype['release_type'] = undefined;
...
export default AppsUpdateRequest;
