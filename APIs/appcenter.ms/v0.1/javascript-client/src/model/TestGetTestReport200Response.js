...
/**
 * The TestGetTestReport200Response model module.
 * @module model/TestGetTestReport200Response
 * @version v0.1
 */
class TestGetTestReport200Response {
    /**
     * Constructs a new <code>TestGetTestReport200Response</code>.
     * @alias module:model/TestGetTestReport200Response
    ...
    constructor(appUploadId, date, dateFinished, deviceLogs, features, finishedDeviceSnapshots, id, platform, revision, schemaVersion, stats, testType) { 
        ...
        TestGetTestReport200Response.initialize(this, appUploadId, date, dateFinished, deviceLogs, features, finishedDeviceSnapshots, id, platform, revision, schemaVersion, stats, testType);
    }
    ...
    /**
     * Constructs a <code>TestGetTestReport200Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/TestGetTestReport200Response} obj Optional instance to populate.
     * @return {module:model/TestGetTestReport200Response} The populated <code>TestGetTestReport200Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new TestGetTestReport200Response();
    ...
    /**
     * Validates the JSON data with respect to <code>TestGetTestReport200Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TestGetTestReport200Response</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of TestGetTestReport200Response.RequiredProperties) {
...
TestGetTestReport200Response.RequiredProperties = ["app_upload_id", "date", "date_finished", "device_logs", "features", "finished_device_snapshots", "id", "platform", "revision", "schema_version", "stats", "testType"];

/**
 * @member {String} app_upload_id
 */
TestGetTestReport200Response.prototype['app_upload_id'] = undefined;

/**
 * @member {String} date
 */
TestGetTestReport200Response.prototype['date'] = undefined;

/**
 * @member {String} date_finished
 */
TestGetTestReport200Response.prototype['date_finished'] = undefined;

/**
 * @member {Array.<module:model/TestGetTestReport200ResponseDeviceLogsInner>} device_logs
 */
TestGetTestReport200Response.prototype['device_logs'] = undefined;

/**
 * @member {String} errorMessage
 */
TestGetTestReport200Response.prototype['errorMessage'] = undefined;

/**
 * @member {Array.<module:model/TestGetTestReport200ResponseFeaturesInner>} features
 */
TestGetTestReport200Response.prototype['features'] = undefined;

/**
 * @member {Array.<String>} finished_device_snapshots
 */
TestGetTestReport200Response.prototype['finished_device_snapshots'] = undefined;

/**
 * @member {String} id
 */
TestGetTestReport200Response.prototype['id'] = undefined;

/**
 * @member {String} platform
 */
TestGetTestReport200Response.prototype['platform'] = undefined;

/**
 * @member {Number} revision
 */
TestGetTestReport200Response.prototype['revision'] = undefined;

/**
 * @member {Number} schema_version
 */
TestGetTestReport200Response.prototype['schema_version'] = undefined;

/**
 * @member {Array.<module:model/TestGetTestReport200ResponseSnapshotFatalErrorsInner>} snapshot_fatal_errors
 */
TestGetTestReport200Response.prototype['snapshot_fatal_errors'] = undefined;

/**
 * @member {module:model/TestGetTestReport200ResponseStats} stats
 */
TestGetTestReport200Response.prototype['stats'] = undefined;

/**
 * @member {String} testType
 */
TestGetTestReport200Response.prototype['testType'] = undefined;
...
export default TestGetTestReport200Response;
