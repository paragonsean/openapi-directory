...
/**
 * The CrashGroupsList200ResponseCrashGroupsInner model module.
 * @module model/CrashGroupsList200ResponseCrashGroupsInner
 * @version v0.1
 */
class CrashGroupsList200ResponseCrashGroupsInner {
    /**
     * Constructs a new <code>CrashGroupsList200ResponseCrashGroupsInner</code>.
     * @alias module:model/CrashGroupsList200ResponseCrashGroupsInner
     ...
     * @param status {module:model/CrashGroupsList200ResponseCrashGroupsInner.StatusEnum} 
     */
    constructor(annotation, appVersion, build, count, crashGroupId, crashReason, displayId, fatal, firstOccurrence, lastOccurrence, newCrashGroupId, status) { 
        ...
        CrashGroupsList200ResponseCrashGroupsInner.initialize(this, annotation, appVersion, build, count, crashGroupId, crashReason, displayId, fatal, firstOccurrence, lastOccurrence, newCrashGroupId, status);
    }
    ...
    /**
     * Constructs a <code>CrashGroupsList200ResponseCrashGroupsInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CrashGroupsList200ResponseCrashGroupsInner} obj Optional instance to populate.
     * @return {module:model/CrashGroupsList200ResponseCrashGroupsInner} The populated <code>CrashGroupsList200ResponseCrashGroupsInner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CrashGroupsList200ResponseCrashGroupsInner();
    ...
    /**
     * Validates the JSON data with respect to <code>CrashGroupsList200ResponseCrashGroupsInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CrashGroupsList200ResponseCrashGroupsInner</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CrashGroupsList200ResponseCrashGroupsInner.RequiredProperties) {
...
CrashGroupsList200ResponseCrashGroupsInner.RequiredProperties = ["annotation", "app_version", "build", "count", "crash_group_id", "crash_reason", "display_id", "fatal", "first_occurrence", "last_occurrence", "new_crash_group_id", "status"];

/**
 * @member {String} annotation
 */
CrashGroupsList200ResponseCrashGroupsInner.prototype['annotation'] = undefined;

/**
 * @member {String} app_version
 */
CrashGroupsList200ResponseCrashGroupsInner.prototype['app_version'] = undefined;

/**
 * @member {String} build
 */
CrashGroupsList200ResponseCrashGroupsInner.prototype['build'] = undefined;

/**
 * @member {Number} count
 */
CrashGroupsList200ResponseCrashGroupsInner.prototype['count'] = undefined;

/**
 * @member {String} crash_group_id
 */
CrashGroupsList200ResponseCrashGroupsInner.prototype['crash_group_id'] = undefined;

/**
 * @member {String} crash_reason
 */
CrashGroupsList200ResponseCrashGroupsInner.prototype['crash_reason'] = undefined;

/**
 * @member {String} display_id
 */
CrashGroupsList200ResponseCrashGroupsInner.prototype['display_id'] = undefined;

/**
 * @member {String} exception
 */
CrashGroupsList200ResponseCrashGroupsInner.prototype['exception'] = undefined;

/**
 * Crash or handled exception
 * @member {Boolean} fatal
 */
CrashGroupsList200ResponseCrashGroupsInner.prototype['fatal'] = undefined;

/**
 * @member {Date} first_occurrence
 */
CrashGroupsList200ResponseCrashGroupsInner.prototype['first_occurrence'] = undefined;

/**
 * @member {Number} impacted_users
 */
CrashGroupsList200ResponseCrashGroupsInner.prototype['impacted_users'] = undefined;

/**
 * @member {Date} last_occurrence
 */
CrashGroupsList200ResponseCrashGroupsInner.prototype['last_occurrence'] = undefined;

/**
 * @member {String} new_crash_group_id
 */
CrashGroupsList200ResponseCrashGroupsInner.prototype['new_crash_group_id'] = undefined;

/**
 * @member {module:model/CrashGroupsList200ResponseCrashGroupsInnerReasonFrame} reason_frame
 */
CrashGroupsList200ResponseCrashGroupsInner.prototype['reason_frame'] = undefined;

/**
 * @member {module:model/CrashGroupsList200ResponseCrashGroupsInner.StatusEnum} status
 */
CrashGroupsList200ResponseCrashGroupsInner.prototype['status'] = undefined;
 ...
 * @readonly
 */
CrashGroupsList200ResponseCrashGroupsInner['StatusEnum'] = {
...
export default CrashGroupsList200ResponseCrashGroupsInner;
