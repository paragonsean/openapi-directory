...
/**
 * The AnalyticsGenericLogFlow200ResponseLogsInner model module.
 * @module model/AnalyticsGenericLogFlow200ResponseLogsInner
 * @version v0.1
 */
class AnalyticsGenericLogFlow200ResponseLogsInner {
    /**
     * Constructs a new <code>AnalyticsGenericLogFlow200ResponseLogsInner</code>.
     * Generic log.
     * @alias module:model/AnalyticsGenericLogFlow200ResponseLogsInner
     ...
     * @param type {module:model/AnalyticsGenericLogFlow200ResponseLogsInner.TypeEnum} Log type. 
     */
    constructor(device, installId, timestamp, type) { 
        
        AnalyticsGenericLogFlow200ResponseLogsInner.initialize(this, device, installId, timestamp, type);
    }
    ...
    /**
     * Constructs a <code>AnalyticsGenericLogFlow200ResponseLogsInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AnalyticsGenericLogFlow200ResponseLogsInner} obj Optional instance to populate.
     * @return {module:model/AnalyticsGenericLogFlow200ResponseLogsInner} The populated <code>AnalyticsGenericLogFlow200ResponseLogsInner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AnalyticsGenericLogFlow200ResponseLogsInner();
    ...
    /**
     * Validates the JSON data with respect to <code>AnalyticsGenericLogFlow200ResponseLogsInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AnalyticsGenericLogFlow200ResponseLogsInner</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of AnalyticsGenericLogFlow200ResponseLogsInner.RequiredProperties) {
...
AnalyticsGenericLogFlow200ResponseLogsInner.RequiredProperties = ["device", "install_id", "timestamp", "type"];

/**
 * Account ID of the authenticated user. 
 * @member {String} account_id
 */
AnalyticsGenericLogFlow200ResponseLogsInner.prototype['account_id'] = undefined;

/**
 * Auth service provider. 
 * @member {String} auth_provider
 */
AnalyticsGenericLogFlow200ResponseLogsInner.prototype['auth_provider'] = undefined;

/**
 * @member {module:model/AnalyticsGenericLogFlow200ResponseLogsInnerDevice} device
 */
AnalyticsGenericLogFlow200ResponseLogsInner.prototype['device'] = undefined;

/**
 * Event ID. 
 * @member {String} event_id
 */
AnalyticsGenericLogFlow200ResponseLogsInner.prototype['event_id'] = undefined;

/**
 * Event name. 
 * @member {String} event_name
 */
AnalyticsGenericLogFlow200ResponseLogsInner.prototype['event_name'] = undefined;

/**
 * Install ID. 
 * @member {String} install_id
 */
AnalyticsGenericLogFlow200ResponseLogsInner.prototype['install_id'] = undefined;

/**
 * Message ID. 
 * @member {String} message_id
 */
AnalyticsGenericLogFlow200ResponseLogsInner.prototype['message_id'] = undefined;

/**
 * event specific properties. 
 * @member {Object.<String, String>} properties
 */
AnalyticsGenericLogFlow200ResponseLogsInner.prototype['properties'] = undefined;

/**
 * Session ID. 
 * @member {String} session_id
 */
AnalyticsGenericLogFlow200ResponseLogsInner.prototype['session_id'] = undefined;

/**
 * Log creation timestamp. 
 * @member {Date} timestamp
 */
AnalyticsGenericLogFlow200ResponseLogsInner.prototype['timestamp'] = undefined;

/**
 * Log type. 
 * @member {module:model/AnalyticsGenericLogFlow200ResponseLogsInner.TypeEnum} type
 */
AnalyticsGenericLogFlow200ResponseLogsInner.prototype['type'] = undefined;
 ...
 * @readonly
 */
AnalyticsGenericLogFlow200ResponseLogsInner['TypeEnum'] = {
...
export default AnalyticsGenericLogFlow200ResponseLogsInner;
