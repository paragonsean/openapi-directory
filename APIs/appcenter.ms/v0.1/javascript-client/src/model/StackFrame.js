...
class StackFrame {
    ...
    constructor(appCode, codeFormatted, codeRaw) { 
        ...
        StackFrame.initialize(this, appCode, codeFormatted, codeRaw);
    }
    ...
    static validateJSON(data) {
        ...
        for (const property of StackFrame.RequiredProperties) {
...
StackFrame.RequiredProperties = ["app_code", "code_formatted", "code_raw"];

/**
 * address of the frame
 * @member {String} address
 */
StackFrame.prototype['address'] = undefined;

/**
 * this line isn't from any framework
 * @member {Boolean} app_code
 */
StackFrame.prototype['app_code'] = undefined;

/**
 * is a class method
 * @member {Boolean} class_method
 */
StackFrame.prototype['class_method'] = undefined;

/**
 * name of the class
 * @member {String} class_name
 */
StackFrame.prototype['class_name'] = undefined;

/**
 * Formatted frame string
 * @member {String} code_formatted
 */
StackFrame.prototype['code_formatted'] = undefined;

/**
 * Raw frame string
 * @member {String} code_raw
 */
StackFrame.prototype['code_raw'] = undefined;

/**
 * name of the file
 * @member {String} file
 */
StackFrame.prototype['file'] = undefined;

/**
 * Name of the framework
 * @member {String} framework_name
 */
StackFrame.prototype['framework_name'] = undefined;

/**
 * programming language of the frame
 * @member {module:model/StackFrame.LanguageEnum} language
 */
StackFrame.prototype['language'] = undefined;

/**
 * line number
 * @member {Number} line
 */
StackFrame.prototype['line'] = undefined;

/**
 * name of the method
 * @member {String} method
 */
StackFrame.prototype['method'] = undefined;

/**
 * parameters of the frames method
 * @member {String} method_params
 */
StackFrame.prototype['method_params'] = undefined;

/**
 * frame should be shown always
 * @member {Boolean} relevant
 */
StackFrame.prototype['relevant'] = undefined;
