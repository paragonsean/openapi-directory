...
/**
 * The ExportConfiguration model module.
 * @module model/ExportConfiguration
 * @version v0.1
 */
class ExportConfiguration {
    /**
     * Constructs a new <code>ExportConfiguration</code>.
     * Export configuration
     * @alias module:model/ExportConfiguration
     * @param type {module:model/ExportConfiguration.TypeEnum} Type of export configuration
     */
    constructor(type) { 
        
        ExportConfiguration.initialize(this, type);
    }
    ...
    /**
     * Constructs a <code>ExportConfiguration</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ExportConfiguration} obj Optional instance to populate.
     * @return {module:model/ExportConfiguration} The populated <code>ExportConfiguration</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ExportConfiguration();
    ...
    /**
     * Validates the JSON data with respect to <code>ExportConfiguration</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ExportConfiguration</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ExportConfiguration.RequiredProperties) {
...
ExportConfiguration.RequiredProperties = ["type"];
 ...
 */
ExportConfiguration.prototype['backfill'] = undefined;

/**
 * @member {Array.<module:model/ExportConfiguration.ExportEntitiesEnum>} export_entities
 */
ExportConfiguration.prototype['export_entities'] = undefined;

/**
 * The resource group name on azure
 * @member {String} resource_group
 */
ExportConfiguration.prototype['resource_group'] = undefined;

/**
 * The resource name on azure
 * @member {String} resource_name
 */
ExportConfiguration.prototype['resource_name'] = undefined;

/**
 * Type of export configuration
 * @member {module:model/ExportConfiguration.TypeEnum} type
 */
ExportConfiguration.prototype['type'] = undefined;
 ...
 * @readonly
 */
ExportConfiguration['ExportEntitiesEnum'] = {
