...
/**
 * The SymbolUploadBeginRequest model module.
 * @module model/SymbolUploadBeginRequest
 * @version v0.1
 */
class SymbolUploadBeginRequest {
    /**
     * Constructs a new <code>SymbolUploadBeginRequest</code>.
     * A request containing information pertaining to starting a symbol upload process
     * @alias module:model/SymbolUploadBeginRequest
     * @param symbolType {module:model/SymbolUploadBeginRequest.SymbolTypeEnum} The type of the symbol for the current symbol upload
     */
    constructor(symbolType) { 
        
        SymbolUploadBeginRequest.initialize(this, symbolType);
    }
    ...
    /**
     * Constructs a <code>SymbolUploadBeginRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SymbolUploadBeginRequest} obj Optional instance to populate.
     * @return {module:model/SymbolUploadBeginRequest} The populated <code>SymbolUploadBeginRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SymbolUploadBeginRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>SymbolUploadBeginRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SymbolUploadBeginRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of SymbolUploadBeginRequest.RequiredProperties) {
...
SymbolUploadBeginRequest.RequiredProperties = ["symbol_type"];

/**
 * The build number. Optional for Apple. Required for Android.
 * @member {String} build
 */
SymbolUploadBeginRequest.prototype['build'] = undefined;
 ...
 */
SymbolUploadBeginRequest.prototype['client_callback'] = undefined;

/**
 * The file name for the symbol upload
 * @member {String} file_name
 */
SymbolUploadBeginRequest.prototype['file_name'] = undefined;

/**
 * The type of the symbol for the current symbol upload
 * @member {module:model/SymbolUploadBeginRequest.SymbolTypeEnum} symbol_type
 */
SymbolUploadBeginRequest.prototype['symbol_type'] = undefined;

/**
 * The version number. Optional for Apple. Required for Android.
 * @member {String} version
 */
SymbolUploadBeginRequest.prototype['version'] = undefined;
 ...
 * @readonly
 */
SymbolUploadBeginRequest['SymbolTypeEnum'] = {
...
export default SymbolUploadBeginRequest;
