...
/**
 * The UnhandledErrorLog model module.
 * @module model/UnhandledErrorLog
 * @version v0.1
 */
class UnhandledErrorLog {
    /**
     * Constructs a new <code>UnhandledErrorLog</code>.
     * Required explicit begin session log (a marker event for analytics service).
     * @alias module:model/UnhandledErrorLog
     ...
     * @param type {module:model/UnhandledErrorLog.TypeEnum} Log type. 
     */
    constructor(device, installId, timestamp, type) { 
        
        UnhandledErrorLog.initialize(this, device, installId, timestamp, type);
    }
    ...
    /**
     * Constructs a <code>UnhandledErrorLog</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UnhandledErrorLog} obj Optional instance to populate.
     * @return {module:model/UnhandledErrorLog} The populated <code>UnhandledErrorLog</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UnhandledErrorLog();
    ...
    /**
     * Validates the JSON data with respect to <code>UnhandledErrorLog</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UnhandledErrorLog</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of UnhandledErrorLog.RequiredProperties) {
...
UnhandledErrorLog.RequiredProperties = ["error_id", "device", "install_id", "timestamp", "type"];

/**
 * Error ID. 
 * @member {String} error_id
 */
UnhandledErrorLog.prototype['error_id'] = undefined;

/**
 * @member {module:model/AnalyticsGenericLogFlow200ResponseLogsInnerDevice} device
 */
UnhandledErrorLog.prototype['device'] = undefined;

/**
 * Install ID. 
 * @member {String} install_id
 */
UnhandledErrorLog.prototype['install_id'] = undefined;

/**
 * Log creation timestamp. 
 * @member {Date} timestamp
 */
UnhandledErrorLog.prototype['timestamp'] = undefined;

/**
 * Log type. 
 * @member {module:model/UnhandledErrorLog.TypeEnum} type
 */
UnhandledErrorLog.prototype['type'] = undefined;
...
export default UnhandledErrorLog;
