...
/**
 * The BuildTimelineRecord model module.
 * @module model/BuildTimelineRecord
 * @version v0.1
 */
class BuildTimelineRecord {
    /**
     * Constructs a new <code>BuildTimelineRecord</code>.
     * @alias module:model/BuildTimelineRecord
     */
    constructor() { 
        
        BuildTimelineRecord.initialize(this);
    }
    ...
    /**
     * Constructs a <code>BuildTimelineRecord</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/BuildTimelineRecord} obj Optional instance to populate.
     * @return {module:model/BuildTimelineRecord} The populated <code>BuildTimelineRecord</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new BuildTimelineRecord();
    ...
    /**
     * Validates the JSON data with respect to <code>BuildTimelineRecord</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>BuildTimelineRecord</code>.
     */
 ...
 */
BuildTimelineRecord.prototype['currentOperation'] = undefined;

/**
 * @member {Number} errorCount
 */
BuildTimelineRecord.prototype['errorCount'] = undefined;

/**
 * @member {String} finishTime
 */
BuildTimelineRecord.prototype['finishTime'] = undefined;

/**
 * @member {String} id
 */
BuildTimelineRecord.prototype['id'] = undefined;

/**
 * @member {Array.<module:model/BuildTimelineRecordsInnerIssuesInner>} issues
 */
BuildTimelineRecord.prototype['issues'] = undefined;

/**
 * @member {String} name
 */
BuildTimelineRecord.prototype['name'] = undefined;

/**
 * @member {Number} order
 */
BuildTimelineRecord.prototype['order'] = undefined;

/**
 * @member {Number} percentComplete
 */
BuildTimelineRecord.prototype['percentComplete'] = undefined;

/**
 * @member {String} result
 */
BuildTimelineRecord.prototype['result'] = undefined;

/**
 * @member {String} startTime
 */
BuildTimelineRecord.prototype['startTime'] = undefined;

/**
 * @member {String} state
 */
BuildTimelineRecord.prototype['state'] = undefined;

/**
 * @member {String} type
 */
BuildTimelineRecord.prototype['type'] = undefined;

/**
 * @member {Number} warningCount
 */
BuildTimelineRecord.prototype['warningCount'] = undefined;
...
export default BuildTimelineRecord;
