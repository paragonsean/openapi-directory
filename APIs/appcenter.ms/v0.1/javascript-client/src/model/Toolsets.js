...
/**
 * The Toolsets model module.
 * @module model/Toolsets
 * @version v0.1
 */
class Toolsets {
    /**
     * Constructs a new <code>Toolsets</code>.
     * Set of toolsets available for app
     * @alias module:model/Toolsets
     */
    constructor() { 
        
        Toolsets.initialize(this);
    }
    ...
    /**
     * Constructs a <code>Toolsets</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Toolsets} obj Optional instance to populate.
     * @return {module:model/Toolsets} The populated <code>Toolsets</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new Toolsets();
    ...
    /**
     * Validates the JSON data with respect to <code>Toolsets</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Toolsets</code>.
     */
