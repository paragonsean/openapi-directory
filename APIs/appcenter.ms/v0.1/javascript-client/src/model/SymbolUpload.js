...
/**
 * The SymbolUpload model module.
 * @module model/SymbolUpload
 * @version v0.1
 */
class SymbolUpload {
    /**
     * Constructs a new <code>SymbolUpload</code>.
     * A single symbol upload entity
     * @alias module:model/SymbolUpload
     * @param appId {String} The application that this symbol upload belongs to
     * @param status {module:model/SymbolUpload.StatusEnum} The current status for the symbol upload
     * @param symbolType {module:model/SymbolUpload.SymbolTypeEnum} The type of the symbol for the current symbol upload
     * @param symbolUploadId {String} The id for the current symbol upload
     */
    constructor(appId, status, symbolType, symbolUploadId) { 
        
        SymbolUpload.initialize(this, appId, status, symbolType, symbolUploadId);
    }
    ...
    /**
     * Constructs a <code>SymbolUpload</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SymbolUpload} obj Optional instance to populate.
     * @return {module:model/SymbolUpload} The populated <code>SymbolUpload</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SymbolUpload();
    ...
    /**
     * Validates the JSON data with respect to <code>SymbolUpload</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SymbolUpload</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of SymbolUpload.RequiredProperties) {
...
SymbolUpload.RequiredProperties = ["app_id", "status", "symbol_type", "symbol_upload_id"];

/**
 * The application that this symbol upload belongs to
 * @member {String} app_id
 */
SymbolUpload.prototype['app_id'] = undefined;

/**
 * The file name for the symbol upload
 * @member {String} file_name
 */
SymbolUpload.prototype['file_name'] = undefined;

/**
 * The size of the file in Mebibytes. This may be 0 until the status is indexed
 * @member {Number} file_size
 */
SymbolUpload.prototype['file_size'] = undefined;

/**
 * The origin of the symbol upload
 * @member {module:model/SymbolUpload.OriginEnum} origin
 */
SymbolUpload.prototype['origin'] = undefined;

/**
 * The current status for the symbol upload
 * @member {module:model/SymbolUpload.StatusEnum} status
 */
SymbolUpload.prototype['status'] = undefined;

/**
 * The type of the symbol for the current symbol upload
 * @member {module:model/SymbolUpload.SymbolTypeEnum} symbol_type
 */
SymbolUpload.prototype['symbol_type'] = undefined;

/**
 * The id for the current symbol upload
 * @member {String} symbol_upload_id
 */
SymbolUpload.prototype['symbol_upload_id'] = undefined;
