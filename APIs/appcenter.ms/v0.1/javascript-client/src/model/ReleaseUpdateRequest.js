...
/**
 * The ReleaseUpdateRequest model module.
 * @module model/ReleaseUpdateRequest
 * @version v0.1
 */
class ReleaseUpdateRequest {
    /**
     * Constructs a new <code>ReleaseUpdateRequest</code>.
     * A request containing information for updating a release.
     * @alias module:model/ReleaseUpdateRequest
     */
    constructor() { 
        
        ReleaseUpdateRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ReleaseUpdateRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ReleaseUpdateRequest} obj Optional instance to populate.
     * @return {module:model/ReleaseUpdateRequest} The populated <code>ReleaseUpdateRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ReleaseUpdateRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>ReleaseUpdateRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ReleaseUpdateRequest</code>.
     */
 ...
 */
ReleaseUpdateRequest.prototype['build'] = undefined;
 ...
 */
ReleaseUpdateRequest.prototype['destination_id'] = undefined;
 ...
 */
ReleaseUpdateRequest.prototype['destination_name'] = undefined;

/**
 * Not used anymore.
 * @member {String} destination_type
 */
ReleaseUpdateRequest.prototype['destination_type'] = undefined;
 ...
 */
ReleaseUpdateRequest.prototype['destinations'] = undefined;
 ...
 */
ReleaseUpdateRequest.prototype['distribution_group_id'] = undefined;
 ...
 * @default true
 */
ReleaseUpdateRequest.prototype['notify_testers'] = true;

/**
 * Release notes for this release.
 * @member {String} release_notes
 */
ReleaseUpdateRequest.prototype['release_notes'] = undefined;
...
export default ReleaseUpdateRequest;
