...
/**
 * The StartSessionLog model module.
 * @module model/StartSessionLog
 * @version v0.1
 */
class StartSessionLog {
    /**
     * Constructs a new <code>StartSessionLog</code>.
     * Required explicit begin session log (a marker event for analytics service).
     * @alias module:model/StartSessionLog
     ...
     * @param type {module:model/StartSessionLog.TypeEnum} Log type. 
     */
    constructor(device, installId, timestamp, type) { 
        
        StartSessionLog.initialize(this, device, installId, timestamp, type);
    }
    ...
    /**
     * Constructs a <code>StartSessionLog</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/StartSessionLog} obj Optional instance to populate.
     * @return {module:model/StartSessionLog} The populated <code>StartSessionLog</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new StartSessionLog();
    ...
    /**
     * Validates the JSON data with respect to <code>StartSessionLog</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>StartSessionLog</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of StartSessionLog.RequiredProperties) {
...
StartSessionLog.RequiredProperties = ["session_id", "device", "install_id", "timestamp", "type"];

/**
 * Session ID. 
 * @member {String} session_id
 */
StartSessionLog.prototype['session_id'] = undefined;

/**
 * @member {module:model/AnalyticsGenericLogFlow200ResponseLogsInnerDevice} device
 */
StartSessionLog.prototype['device'] = undefined;

/**
 * Install ID. 
 * @member {String} install_id
 */
StartSessionLog.prototype['install_id'] = undefined;

/**
 * Log creation timestamp. 
 * @member {Date} timestamp
 */
StartSessionLog.prototype['timestamp'] = undefined;

/**
 * Log type. 
 * @member {module:model/StartSessionLog.TypeEnum} type
 */
StartSessionLog.prototype['type'] = undefined;
...
export default StartSessionLog;
