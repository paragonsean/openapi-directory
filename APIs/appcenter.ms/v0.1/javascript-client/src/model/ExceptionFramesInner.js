...
/**
 * The ExceptionFramesInner model module.
 * @module model/ExceptionFramesInner
 * @version v0.1
 */
class ExceptionFramesInner {
    /**
     * Constructs a new <code>ExceptionFramesInner</code>.
     * a single frame of a stack trace
     * @alias module:model/ExceptionFramesInner
     * @param appCode {Boolean} this line isn't from any framework
     * @param codeFormatted {String} Formatted frame string
     * @param codeRaw {String} Raw frame string
     */
    constructor(appCode, codeFormatted, codeRaw) { 
        
        ExceptionFramesInner.initialize(this, appCode, codeFormatted, codeRaw);
    }
     ...
     */
    static initialize(obj, appCode, codeFormatted, codeRaw) { 
        obj['app_code'] = appCode;
        obj['code_formatted'] = codeFormatted;
        obj['code_raw'] = codeRaw;
    }

    /**
     * Constructs a <code>ExceptionFramesInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ExceptionFramesInner} obj Optional instance to populate.
     * @return {module:model/ExceptionFramesInner} The populated <code>ExceptionFramesInner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ExceptionFramesInner();
    ...
    /**
     * Validates the JSON data with respect to <code>ExceptionFramesInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ExceptionFramesInner</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ExceptionFramesInner.RequiredProperties) {
...
ExceptionFramesInner.RequiredProperties = ["app_code", "code_formatted", "code_raw"];

/**
 * address of the frame
 * @member {String} address
 */
ExceptionFramesInner.prototype['address'] = undefined;

/**
 * this line isn't from any framework
 * @member {Boolean} app_code
 */
ExceptionFramesInner.prototype['app_code'] = undefined;

/**
 * is a class method
 * @member {Boolean} class_method
 */
ExceptionFramesInner.prototype['class_method'] = undefined;

/**
 * name of the class
 * @member {String} class_name
 */
ExceptionFramesInner.prototype['class_name'] = undefined;

/**
 * Formatted frame string
 * @member {String} code_formatted
 */
ExceptionFramesInner.prototype['code_formatted'] = undefined;

/**
 * Raw frame string
 * @member {String} code_raw
 */
ExceptionFramesInner.prototype['code_raw'] = undefined;

/**
 * name of the file
 * @member {String} file
 */
ExceptionFramesInner.prototype['file'] = undefined;

/**
 * Name of the framework
 * @member {String} framework_name
 */
ExceptionFramesInner.prototype['framework_name'] = undefined;

/**
 * programming language of the frame
 * @member {module:model/ExceptionFramesInner.LanguageEnum} language
 */
ExceptionFramesInner.prototype['language'] = undefined;

/**
 * line number
 * @member {Number} line
 */
ExceptionFramesInner.prototype['line'] = undefined;

/**
 * name of the method
 * @member {String} method
 */
ExceptionFramesInner.prototype['method'] = undefined;

/**
 * parameters of the frames method
 * @member {String} method_params
 */
ExceptionFramesInner.prototype['method_params'] = undefined;

/**
 * frame should be shown always
 * @member {Boolean} relevant
 */
ExceptionFramesInner.prototype['relevant'] = undefined;
 ...
 * @readonly
 */
ExceptionFramesInner['LanguageEnum'] = {
...
export default ExceptionFramesInner;
