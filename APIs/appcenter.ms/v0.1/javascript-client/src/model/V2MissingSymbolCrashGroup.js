...
/**
 * The V2MissingSymbolCrashGroup model module.
 * @module model/V2MissingSymbolCrashGroup
 * @version v0.1
 */
class V2MissingSymbolCrashGroup {
    /**
     * Constructs a new <code>V2MissingSymbolCrashGroup</code>.
     * missing symbol crash group object
     * @alias module:model/V2MissingSymbolCrashGroup
     ...
     * @param status {module:model/V2MissingSymbolCrashGroup.StatusEnum} group status
    ...
    constructor(appBuild, appId, appVer, lastModified, missingSymbols, status, symbolGroupId) { 
        ...
        V2MissingSymbolCrashGroup.initialize(this, appBuild, appId, appVer, lastModified, missingSymbols, status, symbolGroupId);
    }
    ...
    /**
     * Constructs a <code>V2MissingSymbolCrashGroup</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/V2MissingSymbolCrashGroup} obj Optional instance to populate.
     * @return {module:model/V2MissingSymbolCrashGroup} The populated <code>V2MissingSymbolCrashGroup</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new V2MissingSymbolCrashGroup();
    ...
    /**
     * Validates the JSON data with respect to <code>V2MissingSymbolCrashGroup</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>V2MissingSymbolCrashGroup</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of V2MissingSymbolCrashGroup.RequiredProperties) {
...
V2MissingSymbolCrashGroup.RequiredProperties = ["app_build", "app_id", "app_ver", "last_modified", "missing_symbols", "status", "symbol_group_id"];

/**
 * application build
 * @member {String} app_build
 */
V2MissingSymbolCrashGroup.prototype['app_build'] = undefined;

/**
 * application id
 * @member {String} app_id
 */
V2MissingSymbolCrashGroup.prototype['app_id'] = undefined;

/**
 * application version
 * @member {String} app_ver
 */
V2MissingSymbolCrashGroup.prototype['app_ver'] = undefined;

/**
 * number of crashes that belong to this group
 * @member {Number} crash_count
 */
V2MissingSymbolCrashGroup.prototype['crash_count'] = undefined;

/**
 * number of errors that belong to this group
 * @member {Number} error_count
 */
V2MissingSymbolCrashGroup.prototype['error_count'] = undefined;

/**
 * last update date for the group
 * @member {Date} last_modified
 */
V2MissingSymbolCrashGroup.prototype['last_modified'] = undefined;
 ...
 */
V2MissingSymbolCrashGroup.prototype['missing_symbols'] = undefined;

/**
 * group status
 * @member {module:model/V2MissingSymbolCrashGroup.StatusEnum} status
 */
V2MissingSymbolCrashGroup.prototype['status'] = undefined;

/**
 * id of the symbol group
 * @member {String} symbol_group_id
 */
V2MissingSymbolCrashGroup.prototype['symbol_group_id'] = undefined;
 ...
 * @readonly
 */
V2MissingSymbolCrashGroup['StatusEnum'] = {
...
export default V2MissingSymbolCrashGroup;
