...
/**
 * The CreateReleaseUploadResponse model module.
 * @module model/CreateReleaseUploadResponse
 * @version v0.1
 */
class CreateReleaseUploadResponse {
    /**
     * Constructs a new <code>CreateReleaseUploadResponse</code>.
     * @alias module:model/CreateReleaseUploadResponse
    ...
    constructor(id, packageAssetId, token, uploadDomain, urlEncodedToken) { 
        ...
        CreateReleaseUploadResponse.initialize(this, id, packageAssetId, token, uploadDomain, urlEncodedToken);
    }
    ...
    /**
     * Constructs a <code>CreateReleaseUploadResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateReleaseUploadResponse} obj Optional instance to populate.
     * @return {module:model/CreateReleaseUploadResponse} The populated <code>CreateReleaseUploadResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateReleaseUploadResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>CreateReleaseUploadResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateReleaseUploadResponse</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CreateReleaseUploadResponse.RequiredProperties) {
...
CreateReleaseUploadResponse.RequiredProperties = ["id", "package_asset_id", "token", "upload_domain", "url_encoded_token"];

/**
 * The ID for the newly created upload. It is going to be required later in the process.
 * @member {String} id
 */
CreateReleaseUploadResponse.prototype['id'] = undefined;

/**
 * The associated asset ID in the file management service associated with this uploaded.
 * @member {String} package_asset_id
 */
CreateReleaseUploadResponse.prototype['package_asset_id'] = undefined;

/**
 * The access token used for upload permissions.
 * @member {String} token
 */
CreateReleaseUploadResponse.prototype['token'] = undefined;

/**
 * The URL domain used to upload the release.
 * @member {String} upload_domain
 */
CreateReleaseUploadResponse.prototype['upload_domain'] = undefined;
 ...
 */
CreateReleaseUploadResponse.prototype['url_encoded_token'] = undefined;
...
export default CreateReleaseUploadResponse;
