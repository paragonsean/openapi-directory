...
/**
 * The BranchConfigurationsUpdateRequest model module.
 * @module model/BranchConfigurationsUpdateRequest
 * @version v0.1
 */
class BranchConfigurationsUpdateRequest {
    /**
     * Constructs a new <code>BranchConfigurationsUpdateRequest</code>.
     * The branch build configuration
     * @alias module:model/BranchConfigurationsUpdateRequest
     * @extends Object
     */
    constructor() { 
        
        BranchConfigurationsUpdateRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>BranchConfigurationsUpdateRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/BranchConfigurationsUpdateRequest} obj Optional instance to populate.
     * @return {module:model/BranchConfigurationsUpdateRequest} The populated <code>BranchConfigurationsUpdateRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new BranchConfigurationsUpdateRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>BranchConfigurationsUpdateRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>BranchConfigurationsUpdateRequest</code>.
     */
 ...
 */
BranchConfigurationsUpdateRequest.prototype['artifactVersioning'] = undefined;

/**
 * @member {Boolean} badgeIsEnabled
 */
BranchConfigurationsUpdateRequest.prototype['badgeIsEnabled'] = undefined;
 ...
 */
BranchConfigurationsUpdateRequest.prototype['cloneFromBranch'] = undefined;

/**
 * @member {Boolean} signed
 */
BranchConfigurationsUpdateRequest.prototype['signed'] = undefined;

/**
 * @member {Boolean} testsEnabled
 */
BranchConfigurationsUpdateRequest.prototype['testsEnabled'] = undefined;

/**
 * @member {module:model/BranchConfigurationsGet200ResponseAllOfToolsets} toolsets
 */
BranchConfigurationsUpdateRequest.prototype['toolsets'] = undefined;

/**
 * @member {module:model/BranchConfigurationsUpdateRequest.TriggerEnum} trigger
 */
BranchConfigurationsUpdateRequest.prototype['trigger'] = undefined;
 ...
 * @readonly
 */
BranchConfigurationsUpdateRequest['TriggerEnum'] = {
...
export default BranchConfigurationsUpdateRequest;
