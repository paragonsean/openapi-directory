...
/**
 * The AppMembership model module.
 * @module model/AppMembership
 * @version v0.1
 */
class AppMembership {
    /**
     * Constructs a new <code>AppMembership</code>.
     * @alias module:model/AppMembership
     */
    constructor() { 
        
        AppMembership.initialize(this);
    }
    ...
    /**
     * Constructs a <code>AppMembership</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AppMembership} obj Optional instance to populate.
     * @return {module:model/AppMembership} The populated <code>AppMembership</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AppMembership();
    ...
    /**
     * Validates the JSON data with respect to <code>AppMembership</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AppMembership</code>.
     */
 ...
 */
AppMembership.prototype['app_id'] = undefined;

/**
 * @member {module:model/AppMembership.OriginEnum} origin
 */
AppMembership.prototype['origin'] = undefined;

/**
 * @member {Array.<String>} permissions
 */
AppMembership.prototype['permissions'] = undefined;

/**
 * @member {String} source_id
 */
AppMembership.prototype['source_id'] = undefined;

/**
 * @member {module:model/AppMembership.SourceTypeEnum} source_type
 */
AppMembership.prototype['source_type'] = undefined;

/**
 * @member {String} user_id
 */
AppMembership.prototype['user_id'] = undefined;
