...
/**
 * The DiagnosticsExceptionFramesInner model module.
 * @module model/DiagnosticsExceptionFramesInner
 * @version v0.1
 */
class DiagnosticsExceptionFramesInner {
    /**
     * Constructs a new <code>DiagnosticsExceptionFramesInner</code>.
     * a single frame of a stack trace
     * @alias module:model/DiagnosticsExceptionFramesInner
    ...
    constructor(appCode, codeFormatted, codeRaw) { 
        ...
        DiagnosticsExceptionFramesInner.initialize(this, appCode, codeFormatted, codeRaw);
    }
    ...
    /**
     * Constructs a <code>DiagnosticsExceptionFramesInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DiagnosticsExceptionFramesInner} obj Optional instance to populate.
     * @return {module:model/DiagnosticsExceptionFramesInner} The populated <code>DiagnosticsExceptionFramesInner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DiagnosticsExceptionFramesInner();
    ...
    /**
     * Validates the JSON data with respect to <code>DiagnosticsExceptionFramesInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DiagnosticsExceptionFramesInner</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DiagnosticsExceptionFramesInner.RequiredProperties) {
...
DiagnosticsExceptionFramesInner.RequiredProperties = ["app_code", "code_formatted", "code_raw"];

/**
 * address of the frame
 * @member {String} address
 */
DiagnosticsExceptionFramesInner.prototype['address'] = undefined;

/**
 * this line isn't from any framework
 * @member {Boolean} app_code
 */
DiagnosticsExceptionFramesInner.prototype['app_code'] = undefined;

/**
 * is a class method
 * @member {Boolean} class_method
 */
DiagnosticsExceptionFramesInner.prototype['class_method'] = undefined;

/**
 * name of the class
 * @member {String} class_name
 */
DiagnosticsExceptionFramesInner.prototype['class_name'] = undefined;

/**
 * Formatted frame string
 * @member {String} code_formatted
 */
DiagnosticsExceptionFramesInner.prototype['code_formatted'] = undefined;

/**
 * Raw frame string
 * @member {String} code_raw
 */
DiagnosticsExceptionFramesInner.prototype['code_raw'] = undefined;

/**
 * name of the file
 * @member {String} file
 */
DiagnosticsExceptionFramesInner.prototype['file'] = undefined;

/**
 * Name of the framework
 * @member {String} framework_name
 */
DiagnosticsExceptionFramesInner.prototype['framework_name'] = undefined;

/**
 * programming language of the frame
 * @member {module:model/DiagnosticsExceptionFramesInner.LanguageEnum} language
 */
DiagnosticsExceptionFramesInner.prototype['language'] = undefined;

/**
 * line number
 * @member {Number} line
 */
DiagnosticsExceptionFramesInner.prototype['line'] = undefined;

/**
 * name of the method
 * @member {String} method
 */
DiagnosticsExceptionFramesInner.prototype['method'] = undefined;

/**
 * parameters of the frames method
 * @member {String} method_params
 */
DiagnosticsExceptionFramesInner.prototype['method_params'] = undefined;

/**
 * frame should be shown always
 * @member {Boolean} relevant
 */
DiagnosticsExceptionFramesInner.prototype['relevant'] = undefined;
 ...
 * @readonly
 */
DiagnosticsExceptionFramesInner['LanguageEnum'] = {
...
export default DiagnosticsExceptionFramesInner;
