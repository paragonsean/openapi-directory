...
/**
 * The BuildsListBranches200ResponseInnerLastBuild model module.
 * @module model/BuildsListBranches200ResponseInnerLastBuild
 * @version v0.1
 */
class BuildsListBranches200ResponseInnerLastBuild {
    /**
     * Constructs a new <code>BuildsListBranches200ResponseInnerLastBuild</code>.
     * @alias module:model/BuildsListBranches200ResponseInnerLastBuild
    ...
    constructor(buildNumber, id, queueTime, result, sourceBranch, sourceVersion, status) { 
        ...
        BuildsListBranches200ResponseInnerLastBuild.initialize(this, buildNumber, id, queueTime, result, sourceBranch, sourceVersion, status);
    }
    ...
    /**
     * Constructs a <code>BuildsListBranches200ResponseInnerLastBuild</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/BuildsListBranches200ResponseInnerLastBuild} obj Optional instance to populate.
     * @return {module:model/BuildsListBranches200ResponseInnerLastBuild} The populated <code>BuildsListBranches200ResponseInnerLastBuild</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new BuildsListBranches200ResponseInnerLastBuild();
    ...
    /**
     * Validates the JSON data with respect to <code>BuildsListBranches200ResponseInnerLastBuild</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>BuildsListBranches200ResponseInnerLastBuild</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of BuildsListBranches200ResponseInnerLastBuild.RequiredProperties) {
...
BuildsListBranches200ResponseInnerLastBuild.RequiredProperties = ["buildNumber", "id", "queueTime", "result", "sourceBranch", "sourceVersion", "status"];

/**
 * The build number
 * @member {String} buildNumber
 */
BuildsListBranches200ResponseInnerLastBuild.prototype['buildNumber'] = undefined;

/**
 * The time the build was finished
 * @member {String} finishTime
 */
BuildsListBranches200ResponseInnerLastBuild.prototype['finishTime'] = undefined;

/**
 * The build ID
 * @member {Number} id
 */
BuildsListBranches200ResponseInnerLastBuild.prototype['id'] = undefined;

/**
 * The time the build status was last changed
 * @member {String} lastChangedDate
 */
BuildsListBranches200ResponseInnerLastBuild.prototype['lastChangedDate'] = undefined;

/**
 * The time the build was queued
 * @member {String} queueTime
 */
BuildsListBranches200ResponseInnerLastBuild.prototype['queueTime'] = undefined;

/**
 * The build result
 * @member {String} result
 */
BuildsListBranches200ResponseInnerLastBuild.prototype['result'] = undefined;

/**
 * The source branch name
 * @member {String} sourceBranch
 */
BuildsListBranches200ResponseInnerLastBuild.prototype['sourceBranch'] = undefined;

/**
 * The source SHA
 * @member {String} sourceVersion
 */
BuildsListBranches200ResponseInnerLastBuild.prototype['sourceVersion'] = undefined;

/**
 * The time the build was started
 * @member {String} startTime
 */
BuildsListBranches200ResponseInnerLastBuild.prototype['startTime'] = undefined;

/**
 * The build status
 * @member {String} status
 */
BuildsListBranches200ResponseInnerLastBuild.prototype['status'] = undefined;
...
export default BuildsListBranches200ResponseInnerLastBuild;
