# AppCenterClient.OrgDistributionGroupDetailsResponse
...
**apps** | [**[OrgDistributionGroupDetailsResponseAllOfApps]**](OrgDistributionGroupDetailsResponseAllOfApps.md) | The apps associated with the distribution group | 
