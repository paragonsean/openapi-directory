# AppCenterClient.BranchConfigurationsGet200ResponseAllOfToolsetsAndroid

## Properties

Name | Type | Description | Notes
------------ | ------------- | ------------- | -------------
**automaticSigning** | **Boolean** | Whether to apply automatic signing or not | [optional] 
...
**isRoot** | **Boolean** | Whether it is the root module or not | [optional] 
...
**runLint** | **Boolean** | Whether to run lint checks during the build (default) | [optional] 
**runTests** | **Boolean** | Whether to run unit tests during the build (default) | [optional] [default to true]
