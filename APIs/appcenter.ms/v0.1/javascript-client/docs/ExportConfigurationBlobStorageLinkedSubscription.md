# AppCenterClient.ExportConfigurationBlobStorageLinkedSubscription

## Properties

Name | Type | Description | Notes
------------ | ------------- | ------------- | -------------
**subscriptionId** | **String** | Id of customer subscription linked in App Center | 
...
* `WithoutAppId` (value: `"WithoutAppId"`)

* `WithAppId` (value: `"WithAppId"`)
