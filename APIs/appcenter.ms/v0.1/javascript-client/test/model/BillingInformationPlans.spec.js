...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AppCenterClient.BillingInformationPlans();
  });
  ...
  describe('BillingInformationPlans', function() {
    it('should create an instance of BillingInformationPlans', function() {
      // uncomment below and update the code to test BillingInformationPlans
      //var instance = new AppCenterClient.BillingInformationPlans();
      //expect(instance).to.be.a(AppCenterClient.BillingInformationPlans);
    });
