...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AppCenterClient.BranchStatus();
  });
  ...
  describe('BranchStatus', function() {
    it('should create an instance of BranchStatus', function() {
      // uncomment below and update the code to test BranchStatus
      //var instance = new AppCenterClient.BranchStatus();
      //expect(instance).to.be.a(AppCenterClient.BranchStatus);
    });
