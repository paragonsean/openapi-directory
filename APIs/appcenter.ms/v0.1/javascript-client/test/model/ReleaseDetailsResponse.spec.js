...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AppCenterClient.ReleaseDetailsResponse();
  });
  ...
  describe('ReleaseDetailsResponse', function() {
    it('should create an instance of ReleaseDetailsResponse', function() {
      // uncomment below and update the code to test ReleaseDetailsResponse
      //var instance = new AppCenterClient.ReleaseDetailsResponse();
      //expect(instance).to.be.a(AppCenterClient.ReleaseDetailsResponse);
    });
