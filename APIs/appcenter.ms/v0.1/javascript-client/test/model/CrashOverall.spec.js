...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AppCenterClient.CrashOverall();
  });
  ...
  describe('CrashOverall', function() {
    it('should create an instance of CrashOverall', function() {
      // uncomment below and update the code to test CrashOverall
      //var instance = new AppCenterClient.CrashOverall();
      //expect(instance).to.be.a(AppCenterClient.CrashOverall);
    });
