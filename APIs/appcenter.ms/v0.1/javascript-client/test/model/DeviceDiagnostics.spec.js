...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AppCenterClient.DeviceDiagnostics();
  });
  ...
  describe('DeviceDiagnostics', function() {
    it('should create an instance of DeviceDiagnostics', function() {
      // uncomment below and update the code to test DeviceDiagnostics
      //var instance = new AppCenterClient.DeviceDiagnostics();
      //expect(instance).to.be.a(AppCenterClient.DeviceDiagnostics);
    });
