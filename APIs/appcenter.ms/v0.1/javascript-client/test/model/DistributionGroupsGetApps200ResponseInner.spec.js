...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AppCenterClient.DistributionGroupsGetApps200ResponseInner();
  });
  ...
  describe('DistributionGroupsGetApps200ResponseInner', function() {
    it('should create an instance of DistributionGroupsGetApps200ResponseInner', function() {
      // uncomment below and update the code to test DistributionGroupsGetApps200ResponseInner
      //var instance = new AppCenterClient.DistributionGroupsGetApps200ResponseInner();
      //expect(instance).to.be.a(AppCenterClient.DistributionGroupsGetApps200ResponseInner);
    });
