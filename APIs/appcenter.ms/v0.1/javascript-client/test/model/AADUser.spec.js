...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AppCenterClient.AADUser();
  });
  ...
  describe('AADUser', function() {
    it('should create an instance of AADUser', function() {
      // uncomment below and update the code to test AADUser
      //var instance = new AppCenterClient.AADUser();
      //expect(instance).to.be.a(AppCenterClient.AADUser);
    });
