...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AppCenterClient.GitHubPullRequestLiteBase();
  });
  ...
  describe('GitHubPullRequestLiteBase', function() {
    it('should create an instance of GitHubPullRequestLiteBase', function() {
      // uncomment below and update the code to test GitHubPullRequestLiteBase
      //var instance = new AppCenterClient.GitHubPullRequestLiteBase();
      //expect(instance).to.be.a(AppCenterClient.GitHubPullRequestLiteBase);
    });
