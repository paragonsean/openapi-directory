...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AppCenterClient.UserProfileResponseManagement();
  });
  ...
  describe('UserProfileResponseManagement', function() {
    it('should create an instance of UserProfileResponseManagement', function() {
      // uncomment below and update the code to test UserProfileResponseManagement
      //var instance = new AppCenterClient.UserProfileResponseManagement();
      //expect(instance).to.be.a(AppCenterClient.UserProfileResponseManagement);
    });
    ...
    it('should have the property adminRole (base name: "admin_role")', function() {
      // uncomment below and update the code to test the property adminRole
      //var instance = new AppCenterClient.UserProfileResponseManagement();
      //expect(instance).to.be();
    });
