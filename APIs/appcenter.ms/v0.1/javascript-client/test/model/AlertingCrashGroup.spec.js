...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AppCenterClient.AlertingCrashGroup();
  });
  ...
  describe('AlertingCrashGroup', function() {
    it('should create an instance of AlertingCrashGroup', function() {
      // uncomment below and update the code to test AlertingCrashGroup
      //var instance = new AppCenterClient.AlertingCrashGroup();
      //expect(instance).to.be.a(AppCenterClient.AlertingCrashGroup);
    });
