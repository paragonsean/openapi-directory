...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AppCenterClient.DistributionGroupRelease();
  });
  ...
  describe('DistributionGroupRelease', function() {
    it('should create an instance of DistributionGroupRelease', function() {
      // uncomment below and update the code to test DistributionGroupRelease
      //var instance = new AppCenterClient.DistributionGroupRelease();
      //expect(instance).to.be.a(AppCenterClient.DistributionGroupRelease);
    });
