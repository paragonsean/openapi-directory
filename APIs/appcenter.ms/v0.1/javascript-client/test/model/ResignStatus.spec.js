...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AppCenterClient.ResignStatus();
  });
  ...
  describe('ResignStatus', function() {
    it('should create an instance of ResignStatus', function() {
      // uncomment below and update the code to test ResignStatus
      //var instance = new AppCenterClient.ResignStatus();
      //expect(instance).to.be.a(AppCenterClient.ResignStatus);
    });
