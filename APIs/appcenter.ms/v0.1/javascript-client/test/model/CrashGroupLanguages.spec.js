...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AppCenterClient.CrashGroupLanguages();
  });
  ...
  describe('CrashGroupLanguages', function() {
    it('should create an instance of CrashGroupLanguages', function() {
      // uncomment below and update the code to test CrashGroupLanguages
      //var instance = new AppCenterClient.CrashGroupLanguages();
      //expect(instance).to.be.a(AppCenterClient.CrashGroupLanguages);
    });
