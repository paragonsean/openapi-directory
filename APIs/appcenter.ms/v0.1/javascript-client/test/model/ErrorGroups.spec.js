...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AppCenterClient.ErrorGroups();
  });
  ...
  describe('ErrorGroups', function() {
    it('should create an instance of ErrorGroups', function() {
      // uncomment below and update the code to test ErrorGroups
      //var instance = new AppCenterClient.ErrorGroups();
      //expect(instance).to.be.a(AppCenterClient.ErrorGroups);
    });
