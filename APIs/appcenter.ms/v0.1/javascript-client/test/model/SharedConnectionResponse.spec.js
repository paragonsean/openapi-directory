...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AppCenterClient.SharedConnectionResponse();
  });
  ...
  describe('SharedConnectionResponse', function() {
    it('should create an instance of SharedConnectionResponse', function() {
      // uncomment below and update the code to test SharedConnectionResponse
      //var instance = new AppCenterClient.SharedConnectionResponse();
      //expect(instance).to.be.a(AppCenterClient.SharedConnectionResponse);
    });
