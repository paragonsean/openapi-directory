...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AppCenterClient.StoresBasicReleaseDetails();
  });
  ...
  describe('StoresBasicReleaseDetails', function() {
    it('should create an instance of StoresBasicReleaseDetails', function() {
      // uncomment below and update the code to test StoresBasicReleaseDetails
      //var instance = new AppCenterClient.StoresBasicReleaseDetails();
      //expect(instance).to.be.a(AppCenterClient.StoresBasicReleaseDetails);
    });
