...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AppCenterClient.BugtrackerGetSettings200Response();
  });
  ...
  describe('BugtrackerGetSettings200Response', function() {
    it('should create an instance of BugtrackerGetSettings200Response', function() {
      // uncomment below and update the code to test BugtrackerGetSettings200Response
      //var instance = new AppCenterClient.BugtrackerGetSettings200Response();
      //expect(instance).to.be.a(AppCenterClient.BugtrackerGetSettings200Response);
    });
