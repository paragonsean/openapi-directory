...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AppCenterClient.LogFlowGenericLog();
  });
  ...
  describe('LogFlowGenericLog', function() {
    it('should create an instance of LogFlowGenericLog', function() {
      // uncomment below and update the code to test LogFlowGenericLog
      //var instance = new AppCenterClient.LogFlowGenericLog();
      //expect(instance).to.be.a(AppCenterClient.LogFlowGenericLog);
    });
