...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AppCenterClient.LegacyUpdateInfoData();
  });
  ...
  describe('LegacyUpdateInfoData', function() {
    it('should create an instance of LegacyUpdateInfoData', function() {
      // uncomment below and update the code to test LegacyUpdateInfoData
      //var instance = new AppCenterClient.LegacyUpdateInfoData();
      //expect(instance).to.be.a(AppCenterClient.LegacyUpdateInfoData);
    });
