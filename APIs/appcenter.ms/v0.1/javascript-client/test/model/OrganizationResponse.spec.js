...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AppCenterClient.OrganizationResponse();
  });
  ...
  describe('OrganizationResponse', function() {
    it('should create an instance of OrganizationResponse', function() {
      ...
      //var instance = new AppCenterClient.OrganizationResponse();
      //expect(instance).to.be.a(AppCenterClient.OrganizationResponse);
    });
