...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AppCenterClient.BasicAppResponse();
  });
  ...
  describe('BasicAppResponse', function() {
    it('should create an instance of BasicAppResponse', function() {
      // uncomment below and update the code to test BasicAppResponse
      //var instance = new AppCenterClient.BasicAppResponse();
      //expect(instance).to.be.a(AppCenterClient.BasicAppResponse);
    });
