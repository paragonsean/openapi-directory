...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AppCenterClient.HandledError();
  });
  ...
  describe('HandledError', function() {
    it('should create an instance of HandledError', function() {
      // uncomment below and update the code to test HandledError
      //var instance = new AppCenterClient.HandledError();
      //expect(instance).to.be.a(AppCenterClient.HandledError);
    });
