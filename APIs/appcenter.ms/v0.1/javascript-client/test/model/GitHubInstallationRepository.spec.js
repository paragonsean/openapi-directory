...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AppCenterClient.GitHubInstallationRepository();
  });
  ...
  describe('GitHubInstallationRepository', function() {
    it('should create an instance of GitHubInstallationRepository', function() {
      // uncomment below and update the code to test GitHubInstallationRepository
      //var instance = new AppCenterClient.GitHubInstallationRepository();
      //expect(instance).to.be.a(AppCenterClient.GitHubInstallationRepository);
    });
