...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AppCenterClient.ItunesTeamsResponse();
  });
  ...
  describe('ItunesTeamsResponse', function() {
    it('should create an instance of ItunesTeamsResponse', function() {
      // uncomment below and update the code to test ItunesTeamsResponse
      //var instance = new AppCenterClient.ItunesTeamsResponse();
      //expect(instance).to.be.a(AppCenterClient.ItunesTeamsResponse);
    });
