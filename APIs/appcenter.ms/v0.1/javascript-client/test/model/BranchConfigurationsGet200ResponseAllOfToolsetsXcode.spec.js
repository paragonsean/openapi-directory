...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AppCenterClient.BranchConfigurationsGet200ResponseAllOfToolsetsXcode();
  });
  ...
  describe('BranchConfigurationsGet200ResponseAllOfToolsetsXcode', function() {
    it('should create an instance of BranchConfigurationsGet200ResponseAllOfToolsetsXcode', function() {
      // uncomment below and update the code to test BranchConfigurationsGet200ResponseAllOfToolsetsXcode
      //var instance = new AppCenterClient.BranchConfigurationsGet200ResponseAllOfToolsetsXcode();
      //expect(instance).to.be.a(AppCenterClient.BranchConfigurationsGet200ResponseAllOfToolsetsXcode);
    });
