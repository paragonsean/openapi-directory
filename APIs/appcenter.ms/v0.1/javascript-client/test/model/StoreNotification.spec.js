...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AppCenterClient.StoreNotification();
  });
  ...
  describe('StoreNotification', function() {
    it('should create an instance of StoreNotification', function() {
      // uncomment below and update the code to test StoreNotification
      //var instance = new AppCenterClient.StoreNotification();
      //expect(instance).to.be.a(AppCenterClient.StoreNotification);
    });
