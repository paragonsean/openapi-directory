...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AppCenterClient.ErrorsListForGroup200ResponseErrorsInner();
  });
  ...
  describe('ErrorsListForGroup200ResponseErrorsInner', function() {
    it('should create an instance of ErrorsListForGroup200ResponseErrorsInner', function() {
      // uncomment below and update the code to test ErrorsListForGroup200ResponseErrorsInner
      //var instance = new AppCenterClient.ErrorsListForGroup200ResponseErrorsInner();
      //expect(instance).to.be.a(AppCenterClient.ErrorsListForGroup200ResponseErrorsInner);
    });
