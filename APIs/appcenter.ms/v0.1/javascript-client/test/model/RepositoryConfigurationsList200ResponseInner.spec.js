...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AppCenterClient.RepositoryConfigurationsList200ResponseInner();
  });
  ...
  describe('RepositoryConfigurationsList200ResponseInner', function() {
    it('should create an instance of RepositoryConfigurationsList200ResponseInner', function() {
      // uncomment below and update the code to test RepositoryConfigurationsList200ResponseInner
      //var instance = new AppCenterClient.RepositoryConfigurationsList200ResponseInner();
      //expect(instance).to.be.a(AppCenterClient.RepositoryConfigurationsList200ResponseInner);
    });
