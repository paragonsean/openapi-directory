...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AppCenterClient.DeviceModel();
  });
  ...
  describe('DeviceModel', function() {
    it('should create an instance of DeviceModel', function() {
      // uncomment below and update the code to test DeviceModel
      //var instance = new AppCenterClient.DeviceModel();
      //expect(instance).to.be.a(AppCenterClient.DeviceModel);
    });
