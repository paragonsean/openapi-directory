...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AppCenterClient.GitHubInstallationRepositoriesInner();
  });
  ...
  describe('GitHubInstallationRepositoriesInner', function() {
    it('should create an instance of GitHubInstallationRepositoriesInner', function() {
      // uncomment below and update the code to test GitHubInstallationRepositoriesInner
      //var instance = new AppCenterClient.GitHubInstallationRepositoriesInner();
      //expect(instance).to.be.a(AppCenterClient.GitHubInstallationRepositoriesInner);
    });
