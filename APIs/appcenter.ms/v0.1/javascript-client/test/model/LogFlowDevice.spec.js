...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AppCenterClient.LogFlowDevice();
  });
  ...
  describe('LogFlowDevice', function() {
    it('should create an instance of LogFlowDevice', function() {
      // uncomment below and update the code to test LogFlowDevice
      //var instance = new AppCenterClient.LogFlowDevice();
      //expect(instance).to.be.a(AppCenterClient.LogFlowDevice);
    });
