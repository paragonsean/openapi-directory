...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AppCenterClient.BillingResourceUsage();
  });
  ...
  describe('BillingResourceUsage', function() {
    it('should create an instance of BillingResourceUsage', function() {
      // uncomment below and update the code to test BillingResourceUsage
      //var instance = new AppCenterClient.BillingResourceUsage();
      //expect(instance).to.be.a(AppCenterClient.BillingResourceUsage);
    });
