...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AppCenterClient.OS();
  });
  ...
  describe('OS', function() {
    it('should create an instance of OS', function() {
      // uncomment below and update the code to test OS
      //var instance = new AppCenterClient.OS();
      //expect(instance).to.be.a(AppCenterClient.OS);
    });
