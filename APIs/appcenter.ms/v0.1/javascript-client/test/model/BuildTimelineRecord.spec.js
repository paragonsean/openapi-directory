...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AppCenterClient.BuildTimelineRecord();
  });
  ...
  describe('BuildTimelineRecord', function() {
    it('should create an instance of BuildTimelineRecord', function() {
      // uncomment below and update the code to test BuildTimelineRecord
      //var instance = new AppCenterClient.BuildTimelineRecord();
      //expect(instance).to.be.a(AppCenterClient.BuildTimelineRecord);
    });
