...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AppCenterClient.DistributionGroupPrivateResponse();
  });
  ...
  describe('DistributionGroupPrivateResponse', function() {
    it('should create an instance of DistributionGroupPrivateResponse', function() {
      // uncomment below and update the code to test DistributionGroupPrivateResponse
      //var instance = new AppCenterClient.DistributionGroupPrivateResponse();
      //expect(instance).to.be.a(AppCenterClient.DistributionGroupPrivateResponse);
    });
