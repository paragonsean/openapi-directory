...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AppCenterClient.CodePushDeploymentsPromoteRequest();
  });
  ...
  describe('CodePushDeploymentsPromoteRequest', function() {
    it('should create an instance of CodePushDeploymentsPromoteRequest', function() {
      // uncomment below and update the code to test CodePushDeploymentsPromoteRequest
      //var instance = new AppCenterClient.CodePushDeploymentsPromoteRequest();
      //expect(instance).to.be.a(AppCenterClient.CodePushDeploymentsPromoteRequest);
    });
