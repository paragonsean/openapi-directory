...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AppCenterClient.CrashAttachment();
  });
  ...
  describe('CrashAttachment', function() {
    it('should create an instance of CrashAttachment', function() {
      // uncomment below and update the code to test CrashAttachment
      //var instance = new AppCenterClient.CrashAttachment();
      //expect(instance).to.be.a(AppCenterClient.CrashAttachment);
    });
