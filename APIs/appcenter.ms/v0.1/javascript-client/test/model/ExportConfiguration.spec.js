...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AppCenterClient.ExportConfiguration();
  });
  ...
  describe('ExportConfiguration', function() {
    it('should create an instance of ExportConfiguration', function() {
      // uncomment below and update the code to test ExportConfiguration
      //var instance = new AppCenterClient.ExportConfiguration();
      //expect(instance).to.be.a(AppCenterClient.ExportConfiguration);
    });
