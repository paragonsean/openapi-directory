...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AppCenterClient.ActiveDeviceCounts();
  });
  ...
  describe('ActiveDeviceCounts', function() {
    it('should create an instance of ActiveDeviceCounts', function() {
      // uncomment below and update the code to test ActiveDeviceCounts
      //var instance = new AppCenterClient.ActiveDeviceCounts();
      //expect(instance).to.be.a(AppCenterClient.ActiveDeviceCounts);
    });
