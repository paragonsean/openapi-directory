...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AppCenterClient.DiagnosticsThread();
  });
  ...
  describe('DiagnosticsThread', function() {
    it('should create an instance of DiagnosticsThread', function() {
      // uncomment below and update the code to test DiagnosticsThread
      //var instance = new AppCenterClient.DiagnosticsThread();
      //expect(instance).to.be.a(AppCenterClient.DiagnosticsThread);
    });
