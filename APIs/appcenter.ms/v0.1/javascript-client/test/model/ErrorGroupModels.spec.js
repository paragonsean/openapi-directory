...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AppCenterClient.ErrorGroupModels();
  });
  ...
  describe('ErrorGroupModels', function() {
    it('should create an instance of ErrorGroupModels', function() {
      // uncomment below and update the code to test ErrorGroupModels
      //var instance = new AppCenterClient.ErrorGroupModels();
      //expect(instance).to.be.a(AppCenterClient.ErrorGroupModels);
    });
