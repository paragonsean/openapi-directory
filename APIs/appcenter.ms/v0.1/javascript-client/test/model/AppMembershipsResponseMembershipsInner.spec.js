...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AppCenterClient.AppMembershipsResponseMembershipsInner();
  });
  ...
  describe('AppMembershipsResponseMembershipsInner', function() {
    it('should create an instance of AppMembershipsResponseMembershipsInner', function() {
      // uncomment below and update the code to test AppMembershipsResponseMembershipsInner
      //var instance = new AppCenterClient.AppMembershipsResponseMembershipsInner();
      //expect(instance).to.be.a(AppCenterClient.AppMembershipsResponseMembershipsInner);
    });
