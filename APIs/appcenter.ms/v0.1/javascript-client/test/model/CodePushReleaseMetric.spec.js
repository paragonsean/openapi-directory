...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AppCenterClient.CodePushReleaseMetric();
  });
  ...
  describe('CodePushReleaseMetric', function() {
    it('should create an instance of CodePushReleaseMetric', function() {
      // uncomment below and update the code to test CodePushReleaseMetric
      //var instance = new AppCenterClient.CodePushReleaseMetric();
      //expect(instance).to.be.a(AppCenterClient.CodePushReleaseMetric);
    });
