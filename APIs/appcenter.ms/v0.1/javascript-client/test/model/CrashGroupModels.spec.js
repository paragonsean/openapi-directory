...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AppCenterClient.CrashGroupModels();
  });
  ...
  describe('CrashGroupModels', function() {
    it('should create an instance of CrashGroupModels', function() {
      // uncomment below and update the code to test CrashGroupModels
      //var instance = new AppCenterClient.CrashGroupModels();
      //expect(instance).to.be.a(AppCenterClient.CrashGroupModels);
    });
