...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AppCenterClient.V2SymbolUpdateInfo();
  });
  ...
  describe('V2SymbolUpdateInfo', function() {
    it('should create an instance of V2SymbolUpdateInfo', function() {
      // uncomment below and update the code to test V2SymbolUpdateInfo
      //var instance = new AppCenterClient.V2SymbolUpdateInfo();
      //expect(instance).to.be.a(AppCenterClient.V2SymbolUpdateInfo);
    });
