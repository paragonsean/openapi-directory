...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AppCenterClient.GenericLogDiagnostics();
  });
  ...
  describe('GenericLogDiagnostics', function() {
    it('should create an instance of GenericLogDiagnostics', function() {
      // uncomment below and update the code to test GenericLogDiagnostics
      //var instance = new AppCenterClient.GenericLogDiagnostics();
      //expect(instance).to.be.a(AppCenterClient.GenericLogDiagnostics);
    });
