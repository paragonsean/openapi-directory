...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AppCenterClient.SymbolStatusResponse();
  });
  ...
  describe('SymbolStatusResponse', function() {
    it('should create an instance of SymbolStatusResponse', function() {
      // uncomment below and update the code to test SymbolStatusResponse
      //var instance = new AppCenterClient.SymbolStatusResponse();
      //expect(instance).to.be.a(AppCenterClient.SymbolStatusResponse);
    });
