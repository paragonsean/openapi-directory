...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AppCenterClient.DeploymentReleasesUpdateRequest();
  });
  ...
  describe('DeploymentReleasesUpdateRequest', function() {
    it('should create an instance of DeploymentReleasesUpdateRequest', function() {
      // uncomment below and update the code to test DeploymentReleasesUpdateRequest
      //var instance = new AppCenterClient.DeploymentReleasesUpdateRequest();
      //expect(instance).to.be.a(AppCenterClient.DeploymentReleasesUpdateRequest);
    });
