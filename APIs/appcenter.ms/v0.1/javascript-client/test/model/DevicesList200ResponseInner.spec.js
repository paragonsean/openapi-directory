...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AppCenterClient.DevicesList200ResponseInner();
  });
  ...
  describe('DevicesList200ResponseInner', function() {
    it('should create an instance of DevicesList200ResponseInner', function() {
      // uncomment below and update the code to test DevicesList200ResponseInner
      //var instance = new AppCenterClient.DevicesList200ResponseInner();
      //expect(instance).to.be.a(AppCenterClient.DevicesList200ResponseInner);
    });
