...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AppCenterClient.BuildParams();
  });
  ...
  describe('BuildParams', function() {
    it('should create an instance of BuildParams', function() {
      // uncomment below and update the code to test BuildParams
      //var instance = new AppCenterClient.BuildParams();
      //expect(instance).to.be.a(AppCenterClient.BuildParams);
    });
