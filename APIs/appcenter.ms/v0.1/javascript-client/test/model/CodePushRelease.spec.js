...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AppCenterClient.CodePushRelease();
  });
  ...
  describe('CodePushRelease', function() {
    it('should create an instance of CodePushRelease', function() {
      // uncomment below and update the code to test CodePushRelease
      //var instance = new AppCenterClient.CodePushRelease();
      //expect(instance).to.be.a(AppCenterClient.CodePushRelease);
    });
