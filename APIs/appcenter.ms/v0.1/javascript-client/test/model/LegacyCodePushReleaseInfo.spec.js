...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AppCenterClient.LegacyCodePushReleaseInfo();
  });
  ...
  describe('LegacyCodePushReleaseInfo', function() {
    it('should create an instance of LegacyCodePushReleaseInfo', function() {
      // uncomment below and update the code to test LegacyCodePushReleaseInfo
      //var instance = new AppCenterClient.LegacyCodePushReleaseInfo();
      //expect(instance).to.be.a(AppCenterClient.LegacyCodePushReleaseInfo);
    });
