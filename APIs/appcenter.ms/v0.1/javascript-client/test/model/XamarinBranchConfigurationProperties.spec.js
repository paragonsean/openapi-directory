...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AppCenterClient.XamarinBranchConfigurationProperties();
  });
  ...
  describe('XamarinBranchConfigurationProperties', function() {
    it('should create an instance of XamarinBranchConfigurationProperties', function() {
      // uncomment below and update the code to test XamarinBranchConfigurationProperties
      //var instance = new AppCenterClient.XamarinBranchConfigurationProperties();
      //expect(instance).to.be.a(AppCenterClient.XamarinBranchConfigurationProperties);
    });
