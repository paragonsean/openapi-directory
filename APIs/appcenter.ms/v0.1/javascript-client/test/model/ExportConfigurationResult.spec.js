...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AppCenterClient.ExportConfigurationResult();
  });
  ...
  describe('ExportConfigurationResult', function() {
    it('should create an instance of ExportConfigurationResult', function() {
      // uncomment below and update the code to test ExportConfigurationResult
      //var instance = new AppCenterClient.ExportConfigurationResult();
      //expect(instance).to.be.a(AppCenterClient.ExportConfigurationResult);
    });
