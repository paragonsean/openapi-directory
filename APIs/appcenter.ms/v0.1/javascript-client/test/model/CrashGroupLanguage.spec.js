...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AppCenterClient.CrashGroupLanguage();
  });
  ...
  describe('CrashGroupLanguage', function() {
    it('should create an instance of CrashGroupLanguage', function() {
      // uncomment below and update the code to test CrashGroupLanguage
      //var instance = new AppCenterClient.CrashGroupLanguage();
      //expect(instance).to.be.a(AppCenterClient.CrashGroupLanguage);
    });
