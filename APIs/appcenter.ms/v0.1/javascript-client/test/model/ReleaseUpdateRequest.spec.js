...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AppCenterClient.ReleaseUpdateRequest();
  });
  ...
  describe('ReleaseUpdateRequest', function() {
    it('should create an instance of ReleaseUpdateRequest', function() {
      // uncomment below and update the code to test ReleaseUpdateRequest
      //var instance = new AppCenterClient.ReleaseUpdateRequest();
      //expect(instance).to.be.a(AppCenterClient.ReleaseUpdateRequest);
    });
