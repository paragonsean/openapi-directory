...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AppCenterClient.AppMembership();
  });
  ...
  describe('AppMembership', function() {
    it('should create an instance of AppMembership', function() {
      // uncomment below and update the code to test AppMembership
      //var instance = new AppCenterClient.AppMembership();
      //expect(instance).to.be.a(AppCenterClient.AppMembership);
    });
