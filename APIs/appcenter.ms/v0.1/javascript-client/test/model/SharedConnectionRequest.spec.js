...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AppCenterClient.SharedConnectionRequest();
  });
  ...
  describe('SharedConnectionRequest', function() {
    it('should create an instance of SharedConnectionRequest', function() {
      // uncomment below and update the code to test SharedConnectionRequest
      //var instance = new AppCenterClient.SharedConnectionRequest();
      //expect(instance).to.be.a(AppCenterClient.SharedConnectionRequest);
    });
