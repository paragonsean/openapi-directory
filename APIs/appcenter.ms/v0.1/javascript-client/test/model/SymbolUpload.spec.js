...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AppCenterClient.SymbolUpload();
  });
  ...
  describe('SymbolUpload', function() {
    it('should create an instance of SymbolUpload', function() {
      // uncomment below and update the code to test SymbolUpload
      //var instance = new AppCenterClient.SymbolUpload();
      //expect(instance).to.be.a(AppCenterClient.SymbolUpload);
    });
