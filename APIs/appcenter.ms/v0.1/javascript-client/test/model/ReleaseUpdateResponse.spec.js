...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AppCenterClient.ReleaseUpdateResponse();
  });
  ...
  describe('ReleaseUpdateResponse', function() {
    it('should create an instance of ReleaseUpdateResponse', function() {
      // uncomment below and update the code to test ReleaseUpdateResponse
      //var instance = new AppCenterClient.ReleaseUpdateResponse();
      //expect(instance).to.be.a(AppCenterClient.ReleaseUpdateResponse);
    });
