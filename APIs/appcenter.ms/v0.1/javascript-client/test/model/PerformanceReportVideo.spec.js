...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AppCenterClient.PerformanceReportVideo();
  });
  ...
  describe('PerformanceReportVideo', function() {
    it('should create an instance of PerformanceReportVideo', function() {
      // uncomment below and update the code to test PerformanceReportVideo
      //var instance = new AppCenterClient.PerformanceReportVideo();
      //expect(instance).to.be.a(AppCenterClient.PerformanceReportVideo);
    });
