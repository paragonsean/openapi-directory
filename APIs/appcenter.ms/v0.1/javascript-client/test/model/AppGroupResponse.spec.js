...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AppCenterClient.AppGroupResponse();
  });
  ...
  describe('AppGroupResponse', function() {
    it('should create an instance of AppGroupResponse', function() {
      // uncomment below and update the code to test AppGroupResponse
      //var instance = new AppCenterClient.AppGroupResponse();
      //expect(instance).to.be.a(AppCenterClient.AppGroupResponse);
    });
