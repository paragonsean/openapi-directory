...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AppCenterClient.OrganizationResponseManagement();
  });
  ...
  describe('OrganizationResponseManagement', function() {
    it('should create an instance of OrganizationResponseManagement', function() {
      // uncomment below and update the code to test OrganizationResponseManagement
      //var instance = new AppCenterClient.OrganizationResponseManagement();
      //expect(instance).to.be.a(AppCenterClient.OrganizationResponseManagement);
    });
