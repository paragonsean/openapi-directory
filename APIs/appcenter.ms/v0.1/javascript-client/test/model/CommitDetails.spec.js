...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AppCenterClient.CommitDetails();
  });
  ...
  describe('CommitDetails', function() {
    it('should create an instance of CommitDetails', function() {
      // uncomment below and update the code to test CommitDetails
      //var instance = new AppCenterClient.CommitDetails();
      //expect(instance).to.be.a(AppCenterClient.CommitDetails);
    });
