...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AppCenterClient.LegacyCodePushRelease();
  });
  ...
  describe('LegacyCodePushRelease', function() {
    it('should create an instance of LegacyCodePushRelease', function() {
      // uncomment below and update the code to test LegacyCodePushRelease
      //var instance = new AppCenterClient.LegacyCodePushRelease();
      //expect(instance).to.be.a(AppCenterClient.LegacyCodePushRelease);
    });
