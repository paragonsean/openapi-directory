...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AppCenterClient.DiagnosticsStackTrace();
  });
  ...
  describe('DiagnosticsStackTrace', function() {
    it('should create an instance of DiagnosticsStackTrace', function() {
      // uncomment below and update the code to test DiagnosticsStackTrace
      //var instance = new AppCenterClient.DiagnosticsStackTrace();
      //expect(instance).to.be.a(AppCenterClient.DiagnosticsStackTrace);
    });
