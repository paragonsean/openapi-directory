...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AppCenterClient.PrivateBasicReleaseDetailsResponse();
  });
  ...
  describe('PrivateBasicReleaseDetailsResponse', function() {
    it('should create an instance of PrivateBasicReleaseDetailsResponse', function() {
      // uncomment below and update the code to test PrivateBasicReleaseDetailsResponse
      //var instance = new AppCenterClient.PrivateBasicReleaseDetailsResponse();
      //expect(instance).to.be.a(AppCenterClient.PrivateBasicReleaseDetailsResponse);
    });
