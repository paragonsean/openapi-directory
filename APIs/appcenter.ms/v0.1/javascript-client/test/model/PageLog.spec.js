...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AppCenterClient.PageLog();
  });
  ...
  describe('PageLog', function() {
    it('should create an instance of PageLog', function() {
      // uncomment below and update the code to test PageLog
      //var instance = new AppCenterClient.PageLog();
      //expect(instance).to.be.a(AppCenterClient.PageLog);
    });
