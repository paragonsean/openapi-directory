...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AppCenterClient.CodePushReleaseModification();
  });
  ...
  describe('CodePushReleaseModification', function() {
    it('should create an instance of CodePushReleaseModification', function() {
      // uncomment below and update the code to test CodePushReleaseModification
      //var instance = new AppCenterClient.CodePushReleaseModification();
      //expect(instance).to.be.a(AppCenterClient.CodePushReleaseModification);
    });
