...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AppCenterClient.BillingAggregatedInformationGetByApp200Response();
  });
  ...
  describe('BillingAggregatedInformationGetByApp200Response', function() {
    it('should create an instance of BillingAggregatedInformationGetByApp200Response', function() {
      // uncomment below and update the code to test BillingAggregatedInformationGetByApp200Response
      //var instance = new AppCenterClient.BillingAggregatedInformationGetByApp200Response();
      //expect(instance).to.be.a(AppCenterClient.BillingAggregatedInformationGetByApp200Response);
    });
