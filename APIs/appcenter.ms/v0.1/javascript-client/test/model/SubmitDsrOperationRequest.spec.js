...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AppCenterClient.SubmitDsrOperationRequest();
  });
  ...
  describe('SubmitDsrOperationRequest', function() {
    it('should create an instance of SubmitDsrOperationRequest', function() {
      // uncomment below and update the code to test SubmitDsrOperationRequest
      //var instance = new AppCenterClient.SubmitDsrOperationRequest();
      //expect(instance).to.be.a(AppCenterClient.SubmitDsrOperationRequest);
    });
