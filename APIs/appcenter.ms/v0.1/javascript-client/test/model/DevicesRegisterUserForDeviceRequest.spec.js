...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AppCenterClient.DevicesRegisterUserForDeviceRequest();
  });
  ...
  describe('DevicesRegisterUserForDeviceRequest', function() {
    it('should create an instance of DevicesRegisterUserForDeviceRequest', function() {
      // uncomment below and update the code to test DevicesRegisterUserForDeviceRequest
      //var instance = new AppCenterClient.DevicesRegisterUserForDeviceRequest();
      //expect(instance).to.be.a(AppCenterClient.DevicesRegisterUserForDeviceRequest);
    });
