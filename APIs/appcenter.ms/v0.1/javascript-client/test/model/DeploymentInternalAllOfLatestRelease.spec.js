...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AppCenterClient.DeploymentInternalAllOfLatestRelease();
  });
  ...
  describe('DeploymentInternalAllOfLatestRelease', function() {
    it('should create an instance of DeploymentInternalAllOfLatestRelease', function() {
      // uncomment below and update the code to test DeploymentInternalAllOfLatestRelease
      //var instance = new AppCenterClient.DeploymentInternalAllOfLatestRelease();
      //expect(instance).to.be.a(AppCenterClient.DeploymentInternalAllOfLatestRelease);
    });
