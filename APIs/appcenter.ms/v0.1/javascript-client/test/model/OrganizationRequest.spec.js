...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AppCenterClient.OrganizationRequest();
  });
  ...
  describe('OrganizationRequest', function() {
    it('should create an instance of OrganizationRequest', function() {
      ...
      //var instance = new AppCenterClient.OrganizationRequest();
      //expect(instance).to.be.a(AppCenterClient.OrganizationRequest);
    });
