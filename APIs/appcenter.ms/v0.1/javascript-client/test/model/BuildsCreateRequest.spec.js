...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AppCenterClient.BuildsCreateRequest();
  });
  ...
  describe('BuildsCreateRequest', function() {
    it('should create an instance of BuildsCreateRequest', function() {
      // uncomment below and update the code to test BuildsCreateRequest
      //var instance = new AppCenterClient.BuildsCreateRequest();
      //expect(instance).to.be.a(AppCenterClient.BuildsCreateRequest);
    });
