...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AppCenterClient.CodePushAcquisitionUpdateCheck200ResponseUpdateInfo();
  });
  ...
  describe('CodePushAcquisitionUpdateCheck200ResponseUpdateInfo', function() {
    it('should create an instance of CodePushAcquisitionUpdateCheck200ResponseUpdateInfo', function() {
      // uncomment below and update the code to test CodePushAcquisitionUpdateCheck200ResponseUpdateInfo
      //var instance = new AppCenterClient.CodePushAcquisitionUpdateCheck200ResponseUpdateInfo();
      //expect(instance).to.be.a(AppCenterClient.CodePushAcquisitionUpdateCheck200ResponseUpdateInfo);
    });
