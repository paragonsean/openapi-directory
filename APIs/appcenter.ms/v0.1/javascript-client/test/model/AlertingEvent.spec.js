...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AppCenterClient.AlertingEvent();
  });
  ...
  describe('AlertingEvent', function() {
    it('should create an instance of AlertingEvent', function() {
      // uncomment below and update the code to test AlertingEvent
      //var instance = new AppCenterClient.AlertingEvent();
      //expect(instance).to.be.a(AppCenterClient.AlertingEvent);
    });
