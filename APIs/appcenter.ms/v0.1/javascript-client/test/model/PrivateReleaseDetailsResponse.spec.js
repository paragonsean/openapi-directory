...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AppCenterClient.PrivateReleaseDetailsResponse();
  });
  ...
  describe('PrivateReleaseDetailsResponse', function() {
    it('should create an instance of PrivateReleaseDetailsResponse', function() {
      // uncomment below and update the code to test PrivateReleaseDetailsResponse
      //var instance = new AppCenterClient.PrivateReleaseDetailsResponse();
      //expect(instance).to.be.a(AppCenterClient.PrivateReleaseDetailsResponse);
    });
