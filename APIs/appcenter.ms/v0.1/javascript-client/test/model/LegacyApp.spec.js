...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AppCenterClient.LegacyApp();
  });
  ...
  describe('LegacyApp', function() {
    it('should create an instance of LegacyApp', function() {
      // uncomment below and update the code to test LegacyApp
      //var instance = new AppCenterClient.LegacyApp();
      //expect(instance).to.be.a(AppCenterClient.LegacyApp);
    });
