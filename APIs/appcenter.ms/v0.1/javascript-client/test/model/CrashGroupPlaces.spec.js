...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AppCenterClient.CrashGroupPlaces();
  });
  ...
  describe('CrashGroupPlaces', function() {
    it('should create an instance of CrashGroupPlaces', function() {
      // uncomment below and update the code to test CrashGroupPlaces
      //var instance = new AppCenterClient.CrashGroupPlaces();
      //expect(instance).to.be.a(AppCenterClient.CrashGroupPlaces);
    });
