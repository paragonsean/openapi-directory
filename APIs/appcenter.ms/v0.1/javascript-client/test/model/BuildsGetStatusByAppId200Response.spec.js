...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AppCenterClient.BuildsGetStatusByAppId200Response();
  });
  ...
  describe('BuildsGetStatusByAppId200Response', function() {
    it('should create an instance of BuildsGetStatusByAppId200Response', function() {
      // uncomment below and update the code to test BuildsGetStatusByAppId200Response
      //var instance = new AppCenterClient.BuildsGetStatusByAppId200Response();
      //expect(instance).to.be.a(AppCenterClient.BuildsGetStatusByAppId200Response);
    });
