...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AppCenterClient.DeviceFrame();
  });
  ...
  describe('DeviceFrame', function() {
    it('should create an instance of DeviceFrame', function() {
      // uncomment below and update the code to test DeviceFrame
      //var instance = new AppCenterClient.DeviceFrame();
      //expect(instance).to.be.a(AppCenterClient.DeviceFrame);
    });
