...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AppCenterClient.CrashesListSessionLogs200ResponseLogsInner();
  });
  ...
  describe('CrashesListSessionLogs200ResponseLogsInner', function() {
    it('should create an instance of CrashesListSessionLogs200ResponseLogsInner', function() {
      // uncomment below and update the code to test CrashesListSessionLogs200ResponseLogsInner
      //var instance = new AppCenterClient.CrashesListSessionLogs200ResponseLogsInner();
      //expect(instance).to.be.a(AppCenterClient.CrashesListSessionLogs200ResponseLogsInner);
    });
