...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AppCenterClient.DeviceSetDeviceConfigurationsInnerModel();
  });
  ...
  describe('DeviceSetDeviceConfigurationsInnerModel', function() {
    it('should create an instance of DeviceSetDeviceConfigurationsInnerModel', function() {
      // uncomment below and update the code to test DeviceSetDeviceConfigurationsInnerModel
      //var instance = new AppCenterClient.DeviceSetDeviceConfigurationsInnerModel();
      //expect(instance).to.be.a(AppCenterClient.DeviceSetDeviceConfigurationsInnerModel);
    });
