...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AppCenterClient.CrashGroupModel();
  });
  ...
  describe('CrashGroupModel', function() {
    it('should create an instance of CrashGroupModel', function() {
      // uncomment below and update the code to test CrashGroupModel
      //var instance = new AppCenterClient.CrashGroupModel();
      //expect(instance).to.be.a(AppCenterClient.CrashGroupModel);
    });
