...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AppCenterClient.DeviceAvailability();
  });
  ...
  describe('DeviceAvailability', function() {
    it('should create an instance of DeviceAvailability', function() {
      // uncomment below and update the code to test DeviceAvailability
      //var instance = new AppCenterClient.DeviceAvailability();
      //expect(instance).to.be.a(AppCenterClient.DeviceAvailability);
    });
