...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AppCenterClient.TesterAppWithReleaseResponse();
  });
  ...
  describe('TesterAppWithReleaseResponse', function() {
    it('should create an instance of TesterAppWithReleaseResponse', function() {
      // uncomment below and update the code to test TesterAppWithReleaseResponse
      //var instance = new AppCenterClient.TesterAppWithReleaseResponse();
      //expect(instance).to.be.a(AppCenterClient.TesterAppWithReleaseResponse);
    });
