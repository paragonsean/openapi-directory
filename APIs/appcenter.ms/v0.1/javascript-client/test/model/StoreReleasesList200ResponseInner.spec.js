...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AppCenterClient.StoreReleasesList200ResponseInner();
  });
  ...
  describe('StoreReleasesList200ResponseInner', function() {
    it('should create an instance of StoreReleasesList200ResponseInner', function() {
      // uncomment below and update the code to test StoreReleasesList200ResponseInner
      //var instance = new AppCenterClient.StoreReleasesList200ResponseInner();
      //expect(instance).to.be.a(AppCenterClient.StoreReleasesList200ResponseInner);
    });
