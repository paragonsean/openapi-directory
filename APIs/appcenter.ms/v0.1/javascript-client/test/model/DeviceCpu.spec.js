...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AppCenterClient.DeviceCpu();
  });
  ...
  describe('DeviceCpu', function() {
    it('should create an instance of DeviceCpu', function() {
      // uncomment below and update the code to test DeviceCpu
      //var instance = new AppCenterClient.DeviceCpu();
      //expect(instance).to.be.a(AppCenterClient.DeviceCpu);
    });
