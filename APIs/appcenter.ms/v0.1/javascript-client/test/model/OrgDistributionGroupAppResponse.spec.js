...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AppCenterClient.OrgDistributionGroupAppResponse();
  });
  ...
  describe('OrgDistributionGroupAppResponse', function() {
    it('should create an instance of OrgDistributionGroupAppResponse', function() {
      // uncomment below and update the code to test OrgDistributionGroupAppResponse
      //var instance = new AppCenterClient.OrgDistributionGroupAppResponse();
      //expect(instance).to.be.a(AppCenterClient.OrgDistributionGroupAppResponse);
    });
