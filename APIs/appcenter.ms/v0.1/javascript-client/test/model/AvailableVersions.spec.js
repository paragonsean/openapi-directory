...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AppCenterClient.AvailableVersions();
  });
  ...
  describe('AvailableVersions', function() {
    it('should create an instance of AvailableVersions', function() {
      ...
      //var instance = new AppCenterClient.AvailableVersions();
      //expect(instance).to.be.a(AppCenterClient.AvailableVersions);
    });
