...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AppCenterClient.AnalyticsGenericLogFlow200ResponseLogsInner();
  });
  ...
  describe('AnalyticsGenericLogFlow200ResponseLogsInner', function() {
    it('should create an instance of AnalyticsGenericLogFlow200ResponseLogsInner', function() {
      // uncomment below and update the code to test AnalyticsGenericLogFlow200ResponseLogsInner
      //var instance = new AppCenterClient.AnalyticsGenericLogFlow200ResponseLogsInner();
      //expect(instance).to.be.a(AppCenterClient.AnalyticsGenericLogFlow200ResponseLogsInner);
    });
