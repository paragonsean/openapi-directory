...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AppCenterClient.CodePushReleaseInfo();
  });
  ...
  describe('CodePushReleaseInfo', function() {
    it('should create an instance of CodePushReleaseInfo', function() {
      // uncomment below and update the code to test CodePushReleaseInfo
      //var instance = new AppCenterClient.CodePushReleaseInfo();
      //expect(instance).to.be.a(AppCenterClient.CodePushReleaseInfo);
    });
