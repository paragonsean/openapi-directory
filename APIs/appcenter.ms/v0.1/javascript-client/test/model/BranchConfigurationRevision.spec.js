...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AppCenterClient.BranchConfigurationRevision();
  });
  ...
  describe('BranchConfigurationRevision', function() {
    it('should create an instance of BranchConfigurationRevision', function() {
      // uncomment below and update the code to test BranchConfigurationRevision
      //var instance = new AppCenterClient.BranchConfigurationRevision();
      //expect(instance).to.be.a(AppCenterClient.BranchConfigurationRevision);
    });
