...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AppCenterClient.TestCloudFileHash1();
  });
  ...
  describe('TestCloudFileHash1', function() {
    it('should create an instance of TestCloudFileHash1', function() {
      // uncomment below and update the code to test TestCloudFileHash1
      //var instance = new AppCenterClient.TestCloudFileHash1();
      //expect(instance).to.be.a(AppCenterClient.TestCloudFileHash1);
    });
