...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AppCenterClient.DeviceSetModel();
  });
  ...
  describe('DeviceSetModel', function() {
    it('should create an instance of DeviceSetModel', function() {
      // uncomment below and update the code to test DeviceSetModel
      //var instance = new AppCenterClient.DeviceSetModel();
      //expect(instance).to.be.a(AppCenterClient.DeviceSetModel);
    });
