...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AppCenterClient.UploadedSymbolInfo();
  });
  ...
  describe('UploadedSymbolInfo', function() {
    it('should create an instance of UploadedSymbolInfo', function() {
      // uncomment below and update the code to test UploadedSymbolInfo
      //var instance = new AppCenterClient.UploadedSymbolInfo();
      //expect(instance).to.be.a(AppCenterClient.UploadedSymbolInfo);
    });
