...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AppCenterClient.ErrorsListSessionLogs200ResponseLogsInner();
  });
  ...
  describe('ErrorsListSessionLogs200ResponseLogsInner', function() {
    it('should create an instance of ErrorsListSessionLogs200ResponseLogsInner', function() {
      // uncomment below and update the code to test ErrorsListSessionLogs200ResponseLogsInner
      //var instance = new AppCenterClient.ErrorsListSessionLogs200ResponseLogsInner();
      //expect(instance).to.be.a(AppCenterClient.ErrorsListSessionLogs200ResponseLogsInner);
    });
