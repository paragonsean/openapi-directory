...
/*
 * OAIDiagnosticsException_frames_inner.h
 *
 * a single frame of a stack trace
 */

#ifndef OAIDiagnosticsException_frames_inner_H
#define OAIDiagnosticsException_frames_inner_H
...
class OAIDiagnosticsException_frames_inner : public OAIObject {
public:
    OAIDiagnosticsException_frames_inner();
    OAIDiagnosticsException_frames_inner(QString json);
    ~OAIDiagnosticsException_frames_inner() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDiagnosticsException_frames_inner)

#endif // OAIDiagnosticsException_frames_inner_H
