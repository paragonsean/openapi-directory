...
/*
 * OAIAzureSubscriptionResponse.h
 *
 * 
 */

#ifndef OAIAzureSubscriptionResponse_H
#define OAIAzureSubscriptionResponse_H
...
class OAIAzureSubscriptionResponse : public OAIObject {
public:
    OAIAzureSubscriptionResponse();
    OAIAzureSubscriptionResponse(QString json);
    ~OAIAzureSubscriptionResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAzureSubscriptionResponse)

#endif // OAIAzureSubscriptionResponse_H
