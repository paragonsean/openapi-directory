...
/*
 * OAIAppleCertificateSecretDetailsResponse.h
 *
 * Apple connection secrets
 */

#ifndef OAIAppleCertificateSecretDetailsResponse_H
#define OAIAppleCertificateSecretDetailsResponse_H
...
class OAIAppleCertificateSecretDetailsResponse : public OAIObject {
public:
    OAIAppleCertificateSecretDetailsResponse();
    OAIAppleCertificateSecretDetailsResponse(QString json);
    ~OAIAppleCertificateSecretDetailsResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAppleCertificateSecretDetailsResponse)

#endif // OAIAppleCertificateSecretDetailsResponse_H
