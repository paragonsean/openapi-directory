...
#ifndef OAIAppMembership_H
#define OAIAppMembership_H
...
class OAIAppMembership : public OAIObject {
public:
    OAIAppMembership();
    OAIAppMembership(QString json);
    ~OAIAppMembership() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAppMembership)

#endif // OAIAppMembership_H
