...
#ifndef OAIGenericLog_H
#define OAIGenericLog_H
...
class OAIGenericLog : public OAIObject {
public:
    OAIGenericLog();
    OAIGenericLog(QString json);
    ~OAIGenericLog() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGenericLog)

#endif // OAIGenericLog_H
