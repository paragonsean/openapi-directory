...
/*
 * OAIGenericLog_Diagnostics.h
 *
 * Generic log.
 */

#ifndef OAIGenericLog_Diagnostics_H
#define OAIGenericLog_Diagnostics_H
...
class OAIGenericLog_Diagnostics : public OAIObject {
public:
    OAIGenericLog_Diagnostics();
    OAIGenericLog_Diagnostics(QString json);
    ~OAIGenericLog_Diagnostics() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGenericLog_Diagnostics)

#endif // OAIGenericLog_Diagnostics_H
