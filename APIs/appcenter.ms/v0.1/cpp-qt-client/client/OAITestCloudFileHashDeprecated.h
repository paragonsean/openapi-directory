...
/*
 * OAITestCloudFileHashDeprecated.h
 *
 * Hash, type, path and byte range of a file that is required in test run
 */

#ifndef OAITestCloudFileHashDeprecated_H
#define OAITestCloudFileHashDeprecated_H
...
class OAITestCloudFileHashDeprecated : public OAIObject {
public:
    OAITestCloudFileHashDeprecated();
    OAITestCloudFileHashDeprecated(QString json);
    ~OAITestCloudFileHashDeprecated() override;
    ...
    void setByteRange(const QString &byte_range);
...
Q_DECLARE_METATYPE(OpenAPI::OAITestCloudFileHashDeprecated)

#endif // OAITestCloudFileHashDeprecated_H
