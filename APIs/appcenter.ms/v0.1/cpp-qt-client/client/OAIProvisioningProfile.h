...
/*
 * OAIProvisioningProfile.h
 *
 * An object containing information about an iOS provisioning profile.
 */

#ifndef OAIProvisioningProfile_H
#define OAIProvisioningProfile_H
...
class OAIProvisioningProfile : public OAIObject {
public:
    OAIProvisioningProfile();
    OAIProvisioningProfile(QString json);
    ~OAIProvisioningProfile() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIProvisioningProfile)

#endif // OAIProvisioningProfile_H
