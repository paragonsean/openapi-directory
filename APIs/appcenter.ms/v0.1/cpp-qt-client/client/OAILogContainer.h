...
#ifndef OAILogContainer_H
#define OAILogContainer_H
...
namespace OpenAPI {
class OAILogContainer_logs_inner;

class OAILogContainer : public OAIObject {
public:
    OAILogContainer();
    OAILogContainer(QString json);
    ~OAILogContainer() override;
    ...
    QList<OAILogContainer_logs_inner> getLogs() const;
    void setLogs(const QList<OAILogContainer_logs_inner> &logs);
...
private:
    ...
    QList<OAILogContainer_logs_inner> m_logs;
    bool m_logs_isSet;
    bool m_logs_isValid;
};
...
Q_DECLARE_METATYPE(OpenAPI::OAILogContainer)

#endif // OAILogContainer_H
