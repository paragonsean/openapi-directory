...
/*
 * OAIPageLog_Diagnostics.h
 *
 * Page view log (as in screens or activities).
 */

#ifndef OAIPageLog_Diagnostics_H
#define OAIPageLog_Diagnostics_H
...
class OAIPageLog_Diagnostics : public OAIObject {
public:
    OAIPageLog_Diagnostics();
    OAIPageLog_Diagnostics(QString json);
    ~OAIPageLog_Diagnostics() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPageLog_Diagnostics)

#endif // OAIPageLog_Diagnostics_H
