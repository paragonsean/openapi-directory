...
OAIAnalytics_DeviceCounts_default_response_error OAIError::getError() const {
    return m_error;
}
void OAIError::setError(const OAIAnalytics_DeviceCounts_default_response_error &error) {
    m_error = error;
    m_error_isSet = true;
}
