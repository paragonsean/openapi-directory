...
/*
 * OAILegacyUpdateInfoData.h
 *
 * 
 */

#ifndef OAILegacyUpdateInfoData_H
#define OAILegacyUpdateInfoData_H
...
class OAILegacyUpdateInfoData : public OAIObject {
public:
    OAILegacyUpdateInfoData();
    OAILegacyUpdateInfoData(QString json);
    ~OAILegacyUpdateInfoData() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILegacyUpdateInfoData)

#endif // OAILegacyUpdateInfoData_H
