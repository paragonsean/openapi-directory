...
/*
 * OAITesterAppResponse.h
 *
 * 
 */

#ifndef OAITesterAppResponse_H
#define OAITesterAppResponse_H
...
class OAITesterAppResponse : public OAIObject {
public:
    OAITesterAppResponse();
    OAITesterAppResponse(QString json);
    ~OAITesterAppResponse() override;
    ...
    bool isMicrosoftInternal() const;
    void setMicrosoftInternal(const bool &microsoft_internal);
    bool is_microsoft_internal_Set() const;
    bool is_microsoft_internal_Valid() const;
...
private:
    ...
    bool m_microsoft_internal;
    bool m_microsoft_internal_isSet;
    bool m_microsoft_internal_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAITesterAppResponse)

#endif // OAITesterAppResponse_H
