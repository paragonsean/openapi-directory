...
#ifndef OAIResignStatus_H
#define OAIResignStatus_H
...
class OAIResignStatus : public OAIObject {
public:
    OAIResignStatus();
    OAIResignStatus(QString json);
    ~OAIResignStatus() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIResignStatus)

#endif // OAIResignStatus_H
