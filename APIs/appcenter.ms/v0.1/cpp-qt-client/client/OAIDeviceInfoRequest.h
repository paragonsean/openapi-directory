...
/*
 * OAIDeviceInfoRequest.h
 *
 * The information for a single iOS device
 */

#ifndef OAIDeviceInfoRequest_H
#define OAIDeviceInfoRequest_H
...
class OAIDeviceInfoRequest : public OAIObject {
public:
    OAIDeviceInfoRequest();
    OAIDeviceInfoRequest(QString json);
    ~OAIDeviceInfoRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeviceInfoRequest)

#endif // OAIDeviceInfoRequest_H
