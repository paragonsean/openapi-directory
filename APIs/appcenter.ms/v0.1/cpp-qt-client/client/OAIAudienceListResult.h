...
/*
 * OAIAudienceListResult.h
 *
 * List of audiences.
 */

#ifndef OAIAudienceListResult_H
#define OAIAudienceListResult_H
...
class OAIAudienceListResult : public OAIObject {
public:
    OAIAudienceListResult();
    OAIAudienceListResult(QString json);
    ~OAIAudienceListResult() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAudienceListResult)

#endif // OAIAudienceListResult_H
