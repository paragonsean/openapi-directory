...
#ifndef OAIGitHubAccount_H
#define OAIGitHubAccount_H
...
class OAIGitHubAccount : public OAIObject {
public:
    OAIGitHubAccount();
    OAIGitHubAccount(QString json);
    ~OAIGitHubAccount() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGitHubAccount)

#endif // OAIGitHubAccount_H
