...
#ifndef OAILogFlowDevice_H
#define OAILogFlowDevice_H
...
class OAILogFlowDevice : public OAIObject {
public:
    OAILogFlowDevice();
    OAILogFlowDevice(QString json);
    ~OAILogFlowDevice() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILogFlowDevice)

#endif // OAILogFlowDevice_H
