...
/*
 * OAIReleases_listByDistributionGroup_200_response_inner.h
 *
 * Response for getting a list of releases in a distribution group
 */

#ifndef OAIReleases_listByDistributionGroup_200_response_inner_H
#define OAIReleases_listByDistributionGroup_200_response_inner_H
...
class OAIReleases_listByDistributionGroup_200_response_inner : public OAIObject {
public:
    OAIReleases_listByDistributionGroup_200_response_inner();
    OAIReleases_listByDistributionGroup_200_response_inner(QString json);
    ~OAIReleases_listByDistributionGroup_200_response_inner() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIReleases_listByDistributionGroup_200_response_inner)

#endif // OAIReleases_listByDistributionGroup_200_response_inner_H
