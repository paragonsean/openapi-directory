...
/*
 * OAIJiraConnectionSecretRequest.h
 *
 * Jira connection secrets
 */

#ifndef OAIJiraConnectionSecretRequest_H
#define OAIJiraConnectionSecretRequest_H
...
class OAIJiraConnectionSecretRequest : public OAIObject {
public:
    OAIJiraConnectionSecretRequest();
    OAIJiraConnectionSecretRequest(QString json);
    ~OAIJiraConnectionSecretRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIJiraConnectionSecretRequest)

#endif // OAIJiraConnectionSecretRequest_H
