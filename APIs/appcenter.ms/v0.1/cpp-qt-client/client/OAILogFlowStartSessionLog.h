...
/*
 * OAILogFlowStartSessionLog.h
 *
 * Required explicit begin session log (a marker event for analytics service).
 */

#ifndef OAILogFlowStartSessionLog_H
#define OAILogFlowStartSessionLog_H
...
class OAILogFlowStartSessionLog : public OAIObject {
public:
    OAILogFlowStartSessionLog();
    OAILogFlowStartSessionLog(QString json);
    ~OAILogFlowStartSessionLog() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILogFlowStartSessionLog)

#endif // OAILogFlowStartSessionLog_H
