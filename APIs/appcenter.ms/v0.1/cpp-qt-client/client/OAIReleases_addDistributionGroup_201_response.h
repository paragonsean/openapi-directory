...
/*
 * OAIReleases_addDistributionGroup_201_response.h
 *
 * 
 */

#ifndef OAIReleases_addDistributionGroup_201_response_H
#define OAIReleases_addDistributionGroup_201_response_H
...
class OAIReleases_addDistributionGroup_201_response : public OAIObject {
public:
    OAIReleases_addDistributionGroup_201_response();
    OAIReleases_addDistributionGroup_201_response(QString json);
    ~OAIReleases_addDistributionGroup_201_response() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIReleases_addDistributionGroup_201_response)

#endif // OAIReleases_addDistributionGroup_201_response_H
