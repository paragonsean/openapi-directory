...
/*
 * OAICrashGroups_list_200_response_crash_groups_inner_reason_frame.h
 *
 * frame belonging to the reason of the crash
 */

#ifndef OAICrashGroups_list_200_response_crash_groups_inner_reason_frame_H
#define OAICrashGroups_list_200_response_crash_groups_inner_reason_frame_H
...
class OAICrashGroups_list_200_response_crash_groups_inner_reason_frame : public OAIObject {
public:
    OAICrashGroups_list_200_response_crash_groups_inner_reason_frame();
    OAICrashGroups_list_200_response_crash_groups_inner_reason_frame(QString json);
    ~OAICrashGroups_list_200_response_crash_groups_inner_reason_frame() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICrashGroups_list_200_response_crash_groups_inner_reason_frame)

#endif // OAICrashGroups_list_200_response_crash_groups_inner_reason_frame_H
