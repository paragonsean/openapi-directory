...
/*
 * OAIDistributionStartSessionLog.h
 *
 * Log is used to update distribution group identifier for session (a marker event for analytics service).
 */

#ifndef OAIDistributionStartSessionLog_H
#define OAIDistributionStartSessionLog_H
...
class OAIDistributionStartSessionLog : public OAIObject {
public:
    OAIDistributionStartSessionLog();
    OAIDistributionStartSessionLog(QString json);
    ~OAIDistributionStartSessionLog() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDistributionStartSessionLog)

#endif // OAIDistributionStartSessionLog_H
