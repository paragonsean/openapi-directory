...
#ifndef OAIDeviceSetModel_H
#define OAIDeviceSetModel_H
...
class OAIDeviceSetModel : public OAIObject {
public:
    OAIDeviceSetModel();
    OAIDeviceSetModel(QString json);
    ~OAIDeviceSetModel() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeviceSetModel)

#endif // OAIDeviceSetModel_H
