...
/*
 * OAISymbolStatusResponse.h
 *
 * A response containing information pertaining to a symbol status
 */

#ifndef OAISymbolStatusResponse_H
#define OAISymbolStatusResponse_H
...
class OAISymbolStatusResponse : public OAIObject {
public:
    OAISymbolStatusResponse();
    OAISymbolStatusResponse(QString json);
    ~OAISymbolStatusResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISymbolStatusResponse)

#endif // OAISymbolStatusResponse_H
