...
/*
 * OAIBranchConfiguration.h
 *
 * The branch build configuration
 */

#ifndef OAIBranchConfiguration_H
#define OAIBranchConfiguration_H
...
class OAIBranchConfiguration : public OAIObject {
public:
    OAIBranchConfiguration();
    OAIBranchConfiguration(QString json);
    ~OAIBranchConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBranchConfiguration)

#endif // OAIBranchConfiguration_H
