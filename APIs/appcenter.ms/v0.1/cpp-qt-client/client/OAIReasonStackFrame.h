...
/*
 * OAIReasonStackFrame.h
 *
 * frame belonging to the reason of the crash
 */

#ifndef OAIReasonStackFrame_H
#define OAIReasonStackFrame_H
...
class OAIReasonStackFrame : public OAIObject {
public:
    OAIReasonStackFrame();
    OAIReasonStackFrame(QString json);
    ~OAIReasonStackFrame() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIReasonStackFrame)

#endif // OAIReasonStackFrame_H
