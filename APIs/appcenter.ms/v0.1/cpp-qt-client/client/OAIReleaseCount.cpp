...
OAIReleaseCount::OAIReleaseCount(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIReleaseCount::OAIReleaseCount() {
    this->initializeModel();
}

OAIReleaseCount::~OAIReleaseCount() {}

void OAIReleaseCount::initializeModel() {
...
void OAIReleaseCount::fromJson(QString jsonString) {
...
void OAIReleaseCount::fromJsonObject(QJsonObject json) {
...
QString OAIReleaseCount::asJson() const {
...
QJsonObject OAIReleaseCount::asJsonObject() const {
    QJsonObject obj;
...
QString OAIReleaseCount::getDistributionGroup() const {
    return m_distribution_group;
}
void OAIReleaseCount::setDistributionGroup(const QString &distribution_group) {
    m_distribution_group = distribution_group;
    m_distribution_group_isSet = true;
}

bool OAIReleaseCount::is_distribution_group_Set() const{
    return m_distribution_group_isSet;
}

bool OAIReleaseCount::is_distribution_group_Valid() const{
    return m_distribution_group_isValid;
}

QString OAIReleaseCount::getReleaseId() const {
    return m_release_id;
}
void OAIReleaseCount::setReleaseId(const QString &release_id) {
    m_release_id = release_id;
    m_release_id_isSet = true;
}

bool OAIReleaseCount::is_release_id_Set() const{
    return m_release_id_isSet;
}

bool OAIReleaseCount::is_release_id_Valid() const{
    return m_release_id_isValid;
}

qint64 OAIReleaseCount::getTotalCount() const {
    return m_total_count;
}
void OAIReleaseCount::setTotalCount(const qint64 &total_count) {
    m_total_count = total_count;
    m_total_count_isSet = true;
}

bool OAIReleaseCount::is_total_count_Set() const{
    return m_total_count_isSet;
}

bool OAIReleaseCount::is_total_count_Valid() const{
    return m_total_count_isValid;
}

qint64 OAIReleaseCount::getUniqueCount() const {
    return m_unique_count;
}
void OAIReleaseCount::setUniqueCount(const qint64 &unique_count) {
    m_unique_count = unique_count;
    m_unique_count_isSet = true;
}

bool OAIReleaseCount::is_unique_count_Set() const{
    return m_unique_count_isSet;
}

bool OAIReleaseCount::is_unique_count_Valid() const{
    return m_unique_count_isValid;
}

bool OAIReleaseCount::isSet() const {
...
bool OAIReleaseCount::isValid() const {
