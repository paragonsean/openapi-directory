...
/*
 * OAIHanledErrorLog_Diagnostics.h
 *
 * Required explicit begin session log (a marker event for analytics service).
 */

#ifndef OAIHanledErrorLog_Diagnostics_H
#define OAIHanledErrorLog_Diagnostics_H
...
class OAIHanledErrorLog_Diagnostics : public OAIObject {
public:
    OAIHanledErrorLog_Diagnostics();
    OAIHanledErrorLog_Diagnostics(QString json);
    ~OAIHanledErrorLog_Diagnostics() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIHanledErrorLog_Diagnostics)

#endif // OAIHanledErrorLog_Diagnostics_H
