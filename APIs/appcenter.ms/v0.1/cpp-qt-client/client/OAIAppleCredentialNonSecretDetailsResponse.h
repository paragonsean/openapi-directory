...
/*
 * OAIAppleCredentialNonSecretDetailsResponse.h
 *
 * Apple credentials non-secret details
 */

#ifndef OAIAppleCredentialNonSecretDetailsResponse_H
#define OAIAppleCredentialNonSecretDetailsResponse_H
...
class OAIAppleCredentialNonSecretDetailsResponse : public OAIObject {
public:
    OAIAppleCredentialNonSecretDetailsResponse();
    OAIAppleCredentialNonSecretDetailsResponse(QString json);
    ~OAIAppleCredentialNonSecretDetailsResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAppleCredentialNonSecretDetailsResponse)

#endif // OAIAppleCredentialNonSecretDetailsResponse_H
