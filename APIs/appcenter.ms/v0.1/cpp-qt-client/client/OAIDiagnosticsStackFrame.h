...
/*
 * OAIDiagnosticsStackFrame.h
 *
 * a single frame of a stack trace
 */

#ifndef OAIDiagnosticsStackFrame_H
#define OAIDiagnosticsStackFrame_H
...
class OAIDiagnosticsStackFrame : public OAIObject {
public:
    OAIDiagnosticsStackFrame();
    OAIDiagnosticsStackFrame(QString json);
    ~OAIDiagnosticsStackFrame() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDiagnosticsStackFrame)

#endif // OAIDiagnosticsStackFrame_H
