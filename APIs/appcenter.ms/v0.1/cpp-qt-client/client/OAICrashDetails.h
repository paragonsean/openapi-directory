...
#ifndef OAICrashDetails_H
#define OAICrashDetails_H
...
class OAICrashDetails : public OAIObject {
public:
    OAICrashDetails();
    OAICrashDetails(QString json);
    ~OAICrashDetails() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICrashDetails)

#endif // OAICrashDetails_H
