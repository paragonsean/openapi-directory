...
/*
 * OAIErrors_GroupList_200_response_errorGroups_inner.h
 *
 * 
 */

#ifndef OAIErrors_GroupList_200_response_errorGroups_inner_H
#define OAIErrors_GroupList_200_response_errorGroups_inner_H
...
class OAIErrors_GroupList_200_response_errorGroups_inner : public OAIObject {
public:
    OAIErrors_GroupList_200_response_errorGroups_inner();
    OAIErrors_GroupList_200_response_errorGroups_inner(QString json);
    ~OAIErrors_GroupList_200_response_errorGroups_inner() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIErrors_GroupList_200_response_errorGroups_inner)

#endif // OAIErrors_GroupList_200_response_errorGroups_inner_H
