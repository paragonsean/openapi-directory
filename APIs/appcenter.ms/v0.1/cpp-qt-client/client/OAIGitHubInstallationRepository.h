...
/*
 * OAIGitHubInstallationRepository.h
 *
 * The repository which is accessiable by GitHub App Installation
 */

#ifndef OAIGitHubInstallationRepository_H
#define OAIGitHubInstallationRepository_H
...
class OAIGitHubInstallationRepository : public OAIObject {
public:
    OAIGitHubInstallationRepository();
    OAIGitHubInstallationRepository(QString json);
    ~OAIGitHubInstallationRepository() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGitHubInstallationRepository)

#endif // OAIGitHubInstallationRepository_H
