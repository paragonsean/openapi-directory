...
/*
 * OAIAppleConnectionSecretResponse.h
 *
 * Apple connection secrets
 */

#ifndef OAIAppleConnectionSecretResponse_H
#define OAIAppleConnectionSecretResponse_H
...
class OAIAppleConnectionSecretResponse : public OAIObject {
public:
    OAIAppleConnectionSecretResponse();
    OAIAppleConnectionSecretResponse(QString json);
    ~OAIAppleConnectionSecretResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAppleConnectionSecretResponse)

#endif // OAIAppleConnectionSecretResponse_H
