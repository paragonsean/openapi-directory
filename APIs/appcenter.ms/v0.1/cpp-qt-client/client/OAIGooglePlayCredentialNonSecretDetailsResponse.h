...
/*
 * OAIGooglePlayCredentialNonSecretDetailsResponse.h
 *
 * Google Play credentials non-secret details
 */

#ifndef OAIGooglePlayCredentialNonSecretDetailsResponse_H
#define OAIGooglePlayCredentialNonSecretDetailsResponse_H
...
class OAIGooglePlayCredentialNonSecretDetailsResponse : public OAIObject {
public:
    OAIGooglePlayCredentialNonSecretDetailsResponse();
    OAIGooglePlayCredentialNonSecretDetailsResponse(QString json);
    ~OAIGooglePlayCredentialNonSecretDetailsResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGooglePlayCredentialNonSecretDetailsResponse)

#endif // OAIGooglePlayCredentialNonSecretDetailsResponse_H
