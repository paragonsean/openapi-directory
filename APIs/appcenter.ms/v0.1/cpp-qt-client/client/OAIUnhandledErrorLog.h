...
/*
 * OAIUnhandledErrorLog.h
 *
 * Required explicit begin session log (a marker event for analytics service).
 */

#ifndef OAIUnhandledErrorLog_H
#define OAIUnhandledErrorLog_H
...
class OAIUnhandledErrorLog : public OAIObject {
public:
    OAIUnhandledErrorLog();
    OAIUnhandledErrorLog(QString json);
    ~OAIUnhandledErrorLog() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUnhandledErrorLog)

#endif // OAIUnhandledErrorLog_H
