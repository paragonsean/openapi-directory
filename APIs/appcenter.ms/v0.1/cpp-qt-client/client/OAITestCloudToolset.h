...
/*
 * OAITestCloudToolset.h
 *
 * 
 */

#ifndef OAITestCloudToolset_H
#define OAITestCloudToolset_H
...
class OAITestCloudToolset : public OAIObject {
public:
    OAITestCloudToolset();
    OAITestCloudToolset(QString json);
    ~OAITestCloudToolset() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITestCloudToolset)

#endif // OAITestCloudToolset_H
