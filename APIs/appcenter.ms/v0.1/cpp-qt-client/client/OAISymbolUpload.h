...
#ifndef OAISymbolUpload_H
#define OAISymbolUpload_H
...
class OAISymbolUpload : public OAIObject {
public:
    OAISymbolUpload();
    OAISymbolUpload(QString json);
    ~OAISymbolUpload() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISymbolUpload)

#endif // OAISymbolUpload_H
