...
/*
 * OAIAppleTestFlightGroupRequest.h
 *
...
#ifndef OAIAppleTestFlightGroupRequest_H
#define OAIAppleTestFlightGroupRequest_H
...
class OAIAppleTestFlightGroupRequest : public OAIObject {
public:
    OAIAppleTestFlightGroupRequest();
    OAIAppleTestFlightGroupRequest(QString json);
    ~OAIAppleTestFlightGroupRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAppleTestFlightGroupRequest)

#endif // OAIAppleTestFlightGroupRequest_H
