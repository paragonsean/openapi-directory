...
/*
 * OAIErrors_ListSessionLogs_200_response_logs_inner.h
 *
 * Generic log.
 */

#ifndef OAIErrors_ListSessionLogs_200_response_logs_inner_H
#define OAIErrors_ListSessionLogs_200_response_logs_inner_H
...
class OAIErrors_ListSessionLogs_200_response_logs_inner : public OAIObject {
public:
    OAIErrors_ListSessionLogs_200_response_logs_inner();
    OAIErrors_ListSessionLogs_200_response_logs_inner(QString json);
    ~OAIErrors_ListSessionLogs_200_response_logs_inner() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIErrors_ListSessionLogs_200_response_logs_inner)

#endif // OAIErrors_ListSessionLogs_200_response_logs_inner_H
