...
/*
 * OAIAppInvitations_list_200_response_invited_by.h
 *
 * 
 */

#ifndef OAIAppInvitations_list_200_response_invited_by_H
#define OAIAppInvitations_list_200_response_invited_by_H
...
class OAIAppInvitations_list_200_response_invited_by : public OAIObject {
public:
    OAIAppInvitations_list_200_response_invited_by();
    OAIAppInvitations_list_200_response_invited_by(QString json);
    ~OAIAppInvitations_list_200_response_invited_by() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAppInvitations_list_200_response_invited_by)

#endif // OAIAppInvitations_list_200_response_invited_by_H
