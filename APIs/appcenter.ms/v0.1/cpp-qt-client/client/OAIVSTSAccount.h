...
#ifndef OAIVSTSAccount_H
#define OAIVSTSAccount_H
...
class OAIVSTSAccount : public OAIObject {
public:
    OAIVSTSAccount();
    OAIVSTSAccount(QString json);
    ~OAIVSTSAccount() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIVSTSAccount)

#endif // OAIVSTSAccount_H
