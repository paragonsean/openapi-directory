...
#include "OAIBranchConfiguration.h"
...
OAIBranchConfiguration::OAIBranchConfiguration(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIBranchConfiguration::OAIBranchConfiguration() {
    this->initializeModel();
}

OAIBranchConfiguration::~OAIBranchConfiguration() {}

void OAIBranchConfiguration::initializeModel() {
...
void OAIBranchConfiguration::fromJson(QString jsonString) {
...
void OAIBranchConfiguration::fromJsonObject(QJsonObject json) {
...
QString OAIBranchConfiguration::asJson() const {
...
QJsonObject OAIBranchConfiguration::asJsonObject() const {
    QJsonObject obj;
...
OAIBranchConfigurations_get_200_response_allOf_artifactVersioning OAIBranchConfiguration::getArtifactVersioning() const {
    return m_artifact_versioning;
}
void OAIBranchConfiguration::setArtifactVersioning(const OAIBranchConfigurations_get_200_response_allOf_artifactVersioning &artifact_versioning) {
    m_artifact_versioning = artifact_versioning;
    m_artifact_versioning_isSet = true;
}

bool OAIBranchConfiguration::is_artifact_versioning_Set() const{
    return m_artifact_versioning_isSet;
}

bool OAIBranchConfiguration::is_artifact_versioning_Valid() const{
    return m_artifact_versioning_isValid;
}

bool OAIBranchConfiguration::isBadgeIsEnabled() const {
    return m_badge_is_enabled;
}
void OAIBranchConfiguration::setBadgeIsEnabled(const bool &badge_is_enabled) {
    m_badge_is_enabled = badge_is_enabled;
    m_badge_is_enabled_isSet = true;
}

bool OAIBranchConfiguration::is_badge_is_enabled_Set() const{
    return m_badge_is_enabled_isSet;
}

bool OAIBranchConfiguration::is_badge_is_enabled_Valid() const{
    return m_badge_is_enabled_isValid;
}

QString OAIBranchConfiguration::getCloneFromBranch() const {
    return m_clone_from_branch;
}
void OAIBranchConfiguration::setCloneFromBranch(const QString &clone_from_branch) {
    m_clone_from_branch = clone_from_branch;
    m_clone_from_branch_isSet = true;
}

bool OAIBranchConfiguration::is_clone_from_branch_Set() const{
    return m_clone_from_branch_isSet;
}

bool OAIBranchConfiguration::is_clone_from_branch_Valid() const{
    return m_clone_from_branch_isValid;
}

bool OAIBranchConfiguration::isRSigned() const {
    return m_r_signed;
}
void OAIBranchConfiguration::setRSigned(const bool &r_signed) {
    m_r_signed = r_signed;
    m_r_signed_isSet = true;
}

bool OAIBranchConfiguration::is_r_signed_Set() const{
    return m_r_signed_isSet;
}

bool OAIBranchConfiguration::is_r_signed_Valid() const{
    return m_r_signed_isValid;
}

bool OAIBranchConfiguration::isTestsEnabled() const {
    return m_tests_enabled;
}
void OAIBranchConfiguration::setTestsEnabled(const bool &tests_enabled) {
    m_tests_enabled = tests_enabled;
    m_tests_enabled_isSet = true;
}

bool OAIBranchConfiguration::is_tests_enabled_Set() const{
    return m_tests_enabled_isSet;
}

bool OAIBranchConfiguration::is_tests_enabled_Valid() const{
    return m_tests_enabled_isValid;
}

OAIBranchConfigurations_get_200_response_allOf_toolsets OAIBranchConfiguration::getToolsets() const {
    return m_toolsets;
}
void OAIBranchConfiguration::setToolsets(const OAIBranchConfigurations_get_200_response_allOf_toolsets &toolsets) {
    m_toolsets = toolsets;
    m_toolsets_isSet = true;
}

bool OAIBranchConfiguration::is_toolsets_Set() const{
    return m_toolsets_isSet;
}

bool OAIBranchConfiguration::is_toolsets_Valid() const{
    return m_toolsets_isValid;
}

QString OAIBranchConfiguration::getTrigger() const {
    return m_trigger;
}
void OAIBranchConfiguration::setTrigger(const QString &trigger) {
    m_trigger = trigger;
    m_trigger_isSet = true;
}

bool OAIBranchConfiguration::is_trigger_Set() const{
    return m_trigger_isSet;
}

bool OAIBranchConfiguration::is_trigger_Valid() const{
    return m_trigger_isValid;
}

bool OAIBranchConfiguration::isSet() const {
...
bool OAIBranchConfiguration::isValid() const {
