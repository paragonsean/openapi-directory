...
/*
 * OAICrashGroupModel.h
 *
 * 
 */

#ifndef OAICrashGroupModel_H
#define OAICrashGroupModel_H
...
class OAICrashGroupModel : public OAIObject {
public:
    OAICrashGroupModel();
    OAICrashGroupModel(QString json);
    ~OAICrashGroupModel() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICrashGroupModel)

#endif // OAICrashGroupModel_H
