...
OAISubscription_1::OAISubscription_1(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISubscription_1::OAISubscription_1() {
    this->initializeModel();
}

OAISubscription_1::~OAISubscription_1() {}

void OAISubscription_1::initializeModel() {
...
void OAISubscription_1::fromJson(QString jsonString) {
...
void OAISubscription_1::fromJsonObject(QJsonObject json) {
...
QString OAISubscription_1::asJson() const {
...
QJsonObject OAISubscription_1::asJsonObject() const {
    QJsonObject obj;
    if (m_active_isSet) {
...
bool OAISubscription_1::isActive() const {
    return m_active;
}
void OAISubscription_1::setActive(const bool &active) {
    m_active = active;
    m_active_isSet = true;
}

bool OAISubscription_1::is_active_Set() const{
    return m_active_isSet;
}

bool OAISubscription_1::is_active_Valid() const{
    return m_active_isValid;
}

qint32 OAISubscription_1::getConcurrentDevicesLimit() const {
    return m_concurrent_devices_limit;
}
void OAISubscription_1::setConcurrentDevicesLimit(const qint32 &concurrent_devices_limit) {
    m_concurrent_devices_limit = concurrent_devices_limit;
    m_concurrent_devices_limit_isSet = true;
}

bool OAISubscription_1::is_concurrent_devices_limit_Set() const{
    return m_concurrent_devices_limit_isSet;
}

bool OAISubscription_1::is_concurrent_devices_limit_Valid() const{
    return m_concurrent_devices_limit_isValid;
}

double OAISubscription_1::getDaysLeft() const {
    return m_days_left;
}
void OAISubscription_1::setDaysLeft(const double &days_left) {
    m_days_left = days_left;
    m_days_left_isSet = true;
}

bool OAISubscription_1::is_days_left_Set() const{
    return m_days_left_isSet;
}

bool OAISubscription_1::is_days_left_Valid() const{
    return m_days_left_isValid;
}

QString OAISubscription_1::getEndsAt() const {
    return m_ends_at;
}
void OAISubscription_1::setEndsAt(const QString &ends_at) {
    m_ends_at = ends_at;
    m_ends_at_isSet = true;
}

bool OAISubscription_1::is_ends_at_Set() const{
    return m_ends_at_isSet;
}

bool OAISubscription_1::is_ends_at_Valid() const{
    return m_ends_at_isValid;
}

QString OAISubscription_1::getId() const {
    return m_id;
}
void OAISubscription_1::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAISubscription_1::is_id_Set() const{
    return m_id_isSet;
}

bool OAISubscription_1::is_id_Valid() const{
    return m_id_isValid;
}

qint32 OAISubscription_1::getRunningDevices() const {
    return m_running_devices;
}
void OAISubscription_1::setRunningDevices(const qint32 &running_devices) {
    m_running_devices = running_devices;
    m_running_devices_isSet = true;
}

bool OAISubscription_1::is_running_devices_Set() const{
    return m_running_devices_isSet;
}

bool OAISubscription_1::is_running_devices_Valid() const{
    return m_running_devices_isValid;
}

QString OAISubscription_1::getStartsAt() const {
    return m_starts_at;
}
void OAISubscription_1::setStartsAt(const QString &starts_at) {
    m_starts_at = starts_at;
    m_starts_at_isSet = true;
}

bool OAISubscription_1::is_starts_at_Set() const{
    return m_starts_at_isSet;
}

bool OAISubscription_1::is_starts_at_Valid() const{
    return m_starts_at_isValid;
}

OAISubscription_Tier OAISubscription_1::getTier() const {
    return m_tier;
}
void OAISubscription_1::setTier(const OAISubscription_Tier &tier) {
    m_tier = tier;
    m_tier_isSet = true;
}

bool OAISubscription_1::is_tier_Set() const{
    return m_tier_isSet;
}

bool OAISubscription_1::is_tier_Valid() const{
    return m_tier_isValid;
}

bool OAISubscription_1::isSet() const {
...
bool OAISubscription_1::isValid() const {
