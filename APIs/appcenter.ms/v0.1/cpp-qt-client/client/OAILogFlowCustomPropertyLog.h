...
/*
 * OAILogFlowCustomPropertyLog.h
 *
 * Set or remove custom properties.
 */

#ifndef OAILogFlowCustomPropertyLog_H
#define OAILogFlowCustomPropertyLog_H
...
class OAILogFlowCustomPropertyLog : public OAIObject {
public:
    OAILogFlowCustomPropertyLog();
    OAILogFlowCustomPropertyLog(QString json);
    ~OAILogFlowCustomPropertyLog() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILogFlowCustomPropertyLog)

#endif // OAILogFlowCustomPropertyLog_H
