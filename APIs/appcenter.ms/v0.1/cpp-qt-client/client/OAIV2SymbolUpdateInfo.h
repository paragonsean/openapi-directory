...
/*
 * OAIV2SymbolUpdateInfo.h
 *
 * symbol update message
 */

#ifndef OAIV2SymbolUpdateInfo_H
#define OAIV2SymbolUpdateInfo_H
...
class OAIV2SymbolUpdateInfo : public OAIObject {
public:
    OAIV2SymbolUpdateInfo();
    OAIV2SymbolUpdateInfo(QString json);
    ~OAIV2SymbolUpdateInfo() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIV2SymbolUpdateInfo)

#endif // OAIV2SymbolUpdateInfo_H
