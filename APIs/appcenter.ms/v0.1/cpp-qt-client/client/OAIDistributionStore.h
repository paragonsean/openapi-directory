...
/*
 * OAIDistributionStore.h
 *
 * 
 */

#ifndef OAIDistributionStore_H
#define OAIDistributionStore_H
...
class OAIDistributionStore : public OAIObject {
public:
    OAIDistributionStore();
    OAIDistributionStore(QString json);
    ~OAIDistributionStore() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDistributionStore)

#endif // OAIDistributionStore_H
