...
/*
 * OAILogWithProperties.h
 *
 * 
 */

#ifndef OAILogWithProperties_H
#define OAILogWithProperties_H
...
class OAILogWithProperties : public OAIObject {
public:
    OAILogWithProperties();
    OAILogWithProperties(QString json);
    ~OAILogWithProperties() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILogWithProperties)

#endif // OAILogWithProperties_H
