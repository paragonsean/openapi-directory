...
/*
 * OAICrashes_ListSessionLogs_200_response_logs_inner.h
 *
 * Generic log.
 */

#ifndef OAICrashes_ListSessionLogs_200_response_logs_inner_H
#define OAICrashes_ListSessionLogs_200_response_logs_inner_H
...
class OAICrashes_ListSessionLogs_200_response_logs_inner : public OAIObject {
public:
    OAICrashes_ListSessionLogs_200_response_logs_inner();
    OAICrashes_ListSessionLogs_200_response_logs_inner(QString json);
    ~OAICrashes_ListSessionLogs_200_response_logs_inner() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICrashes_ListSessionLogs_200_response_logs_inner)

#endif // OAICrashes_ListSessionLogs_200_response_logs_inner_H
