...
/*
 * OAIStartServiceLog.h
 *
 * Describe a AppCenter.Start API call from the SDK.
 */

#ifndef OAIStartServiceLog_H
#define OAIStartServiceLog_H
...
class OAIStartServiceLog : public OAIObject {
public:
    OAIStartServiceLog();
    OAIStartServiceLog(QString json);
    ~OAIStartServiceLog() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStartServiceLog)

#endif // OAIStartServiceLog_H
