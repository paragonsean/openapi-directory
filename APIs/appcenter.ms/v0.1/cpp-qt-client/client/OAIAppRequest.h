...
#ifndef OAIAppRequest_H
#define OAIAppRequest_H
...
class OAIAppRequest : public OAIObject {
public:
    OAIAppRequest();
    OAIAppRequest(QString json);
    ~OAIAppRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAppRequest)

#endif // OAIAppRequest_H
