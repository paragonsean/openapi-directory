...
/*
 * OAITest_Cloud_File_Hash.h
 *
 * Hash, type, path and byte range of a file that is required in test run
 */

#ifndef OAITest_Cloud_File_Hash_H
#define OAITest_Cloud_File_Hash_H
...
class OAITest_Cloud_File_Hash : public OAIObject {
public:
    OAITest_Cloud_File_Hash();
    OAITest_Cloud_File_Hash(QString json);
    ~OAITest_Cloud_File_Hash() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITest_Cloud_File_Hash)

#endif // OAITest_Cloud_File_Hash_H
