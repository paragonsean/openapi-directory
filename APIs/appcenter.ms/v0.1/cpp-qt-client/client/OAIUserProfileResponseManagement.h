...
/*
 * OAIUserProfileResponseManagement.h
 *
 * 
 */

#ifndef OAIUserProfileResponseManagement_H
#define OAIUserProfileResponseManagement_H
...
namespace OpenAPI {
class OAIUserProfileResponseManagement_allOf_identity_providers;

class OAIUserProfileResponseManagement : public OAIObject {
public:
    OAIUserProfileResponseManagement();
    OAIUserProfileResponseManagement(QString json);
    ~OAIUserProfileResponseManagement() override;
    ...
    QList<OAIUserProfileResponseManagement_allOf_identity_providers> getIdentityProviders() const;
    void setIdentityProviders(const QList<OAIUserProfileResponseManagement_allOf_identity_providers> &identity_providers);
...
private:
    ...
    QList<OAIUserProfileResponseManagement_allOf_identity_providers> m_identity_providers;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUserProfileResponseManagement)

#endif // OAIUserProfileResponseManagement_H
