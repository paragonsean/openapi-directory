...
/*
 * OAIGooglePlayConnectionSecretResponse.h
 *
 * Google Play connection secrets
 */

#ifndef OAIGooglePlayConnectionSecretResponse_H
#define OAIGooglePlayConnectionSecretResponse_H
...
class OAIGooglePlayConnectionSecretResponse : public OAIObject {
public:
    OAIGooglePlayConnectionSecretResponse();
    OAIGooglePlayConnectionSecretResponse(QString json);
    ~OAIGooglePlayConnectionSecretResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGooglePlayConnectionSecretResponse)

#endif // OAIGooglePlayConnectionSecretResponse_H
