...
/*
 * OAILogFlowGenericLog.h
 *
 * Generic log.
 */

#ifndef OAILogFlowGenericLog_H
#define OAILogFlowGenericLog_H
...
class OAILogFlowGenericLog : public OAIObject {
public:
    OAILogFlowGenericLog();
    OAILogFlowGenericLog(QString json);
    ~OAILogFlowGenericLog() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILogFlowGenericLog)

#endif // OAILogFlowGenericLog_H
