...
/*
 * OAICodePushRelease.h
 *
 * 
 */

#ifndef OAICodePushRelease_H
#define OAICodePushRelease_H
...
class OAICodePushRelease : public OAIObject {
public:
    OAICodePushRelease();
    OAICodePushRelease(QString json);
    ~OAICodePushRelease() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICodePushRelease)

#endif // OAICodePushRelease_H
