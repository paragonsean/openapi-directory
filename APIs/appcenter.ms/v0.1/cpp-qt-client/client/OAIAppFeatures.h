...
#ifndef OAIAppFeatures_H
#define OAIAppFeatures_H
...
class OAIAppFeatures : public OAIObject {
public:
    OAIAppFeatures();
    OAIAppFeatures(QString json);
    ~OAIAppFeatures() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAppFeatures)

#endif // OAIAppFeatures_H
