...
/*
 * OAIAppleCredentialsMultifactorSecretRequest.h
 *
 * Apple connection secrets
 */

#ifndef OAIAppleCredentialsMultifactorSecretRequest_H
#define OAIAppleCredentialsMultifactorSecretRequest_H
...
class OAIAppleCredentialsMultifactorSecretRequest : public OAIObject {
public:
    OAIAppleCredentialsMultifactorSecretRequest();
    OAIAppleCredentialsMultifactorSecretRequest(QString json);
    ~OAIAppleCredentialsMultifactorSecretRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAppleCredentialsMultifactorSecretRequest)

#endif // OAIAppleCredentialsMultifactorSecretRequest_H
