...
/*
 * OAILegacyAppListResponse_apps_inner.h
 *
 * 
 */

#ifndef OAILegacyAppListResponse_apps_inner_H
#define OAILegacyAppListResponse_apps_inner_H
...
class OAILegacyAppListResponse_apps_inner : public OAIObject {
public:
    OAILegacyAppListResponse_apps_inner();
    OAILegacyAppListResponse_apps_inner(QString json);
    ~OAILegacyAppListResponse_apps_inner() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILegacyAppListResponse_apps_inner)

#endif // OAILegacyAppListResponse_apps_inner_H
