...
#ifndef OAILogFlowLog_H
#define OAILogFlowLog_H
...
class OAILogFlowLog : public OAIObject {
public:
    OAILogFlowLog();
    OAILogFlowLog(QString json);
    ~OAILogFlowLog() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILogFlowLog)

#endif // OAILogFlowLog_H
