...
/*
 * OAILogWithProperties_Diagnostics.h
 *
 * 
 */

#ifndef OAILogWithProperties_Diagnostics_H
#define OAILogWithProperties_Diagnostics_H
...
class OAILogWithProperties_Diagnostics : public OAIObject {
public:
    OAILogWithProperties_Diagnostics();
    OAILogWithProperties_Diagnostics(QString json);
    ~OAILogWithProperties_Diagnostics() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILogWithProperties_Diagnostics)

#endif // OAILogWithProperties_Diagnostics_H
