...
/*
 * OAIAppleCertificateNonSecretDetailsResponse.h
 *
 * Apple certificate non-secret details
 */

#ifndef OAIAppleCertificateNonSecretDetailsResponse_H
#define OAIAppleCertificateNonSecretDetailsResponse_H
...
class OAIAppleCertificateNonSecretDetailsResponse : public OAIObject {
public:
    OAIAppleCertificateNonSecretDetailsResponse();
    OAIAppleCertificateNonSecretDetailsResponse(QString json);
    ~OAIAppleCertificateNonSecretDetailsResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAppleCertificateNonSecretDetailsResponse)

#endif // OAIAppleCertificateNonSecretDetailsResponse_H
