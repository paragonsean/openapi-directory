...
/*
 * OAIProvisioningProfileFile.h
 *
 * Provisioning profile fetch and store information
 */

#ifndef OAIProvisioningProfileFile_H
#define OAIProvisioningProfileFile_H
...
class OAIProvisioningProfileFile : public OAIObject {
public:
    OAIProvisioningProfileFile();
    OAIProvisioningProfileFile(QString json);
    ~OAIProvisioningProfileFile() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIProvisioningProfileFile)

#endif // OAIProvisioningProfileFile_H
