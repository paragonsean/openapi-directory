...
/*
 * OAISessionsPerDevice.h
 *
 * 
 */

#ifndef OAISessionsPerDevice_H
#define OAISessionsPerDevice_H
...
class OAISessionsPerDevice : public OAIObject {
public:
    OAISessionsPerDevice();
    OAISessionsPerDevice(QString json);
    ~OAISessionsPerDevice() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISessionsPerDevice)

#endif // OAISessionsPerDevice_H
