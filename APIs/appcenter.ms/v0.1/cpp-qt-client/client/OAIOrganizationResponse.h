...
/*
 * OAIOrganizationResponse.h
 *
 * 
 */

#ifndef OAIOrganizationResponse_H
#define OAIOrganizationResponse_H
...
class OAIOrganizationResponse : public OAIObject {
public:
    OAIOrganizationResponse();
    OAIOrganizationResponse(QString json);
    ~OAIOrganizationResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIOrganizationResponse)

#endif // OAIOrganizationResponse_H
