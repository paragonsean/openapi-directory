...
#ifndef OAITest_Run_H
#define OAITest_Run_H
...
class OAITest_Run : public OAIObject {
public:
    OAITest_Run();
    OAITest_Run(QString json);
    ~OAITest_Run() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITest_Run)
