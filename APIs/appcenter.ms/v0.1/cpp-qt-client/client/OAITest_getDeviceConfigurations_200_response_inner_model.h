...
/*
 * OAITest_getDeviceConfigurations_200_response_inner_model.h
 *
 * 
 */

#ifndef OAITest_getDeviceConfigurations_200_response_inner_model_H
#define OAITest_getDeviceConfigurations_200_response_inner_model_H
...
class OAITest_getDeviceConfigurations_200_response_inner_model : public OAIObject {
public:
    OAITest_getDeviceConfigurations_200_response_inner_model();
    OAITest_getDeviceConfigurations_200_response_inner_model(QString json);
    ~OAITest_getDeviceConfigurations_200_response_inner_model() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITest_getDeviceConfigurations_200_response_inner_model)

#endif // OAITest_getDeviceConfigurations_200_response_inner_model_H
