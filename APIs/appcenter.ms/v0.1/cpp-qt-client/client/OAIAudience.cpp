...
QMap<QString, QString> OAIAudience::getCustomProperties() const {
    return m_custom_properties;
}
void OAIAudience::setCustomProperties(const QMap<QString, QString> &custom_properties) {
    m_custom_properties = custom_properties;
    m_custom_properties_isSet = true;
}

bool OAIAudience::is_custom_properties_Set() const{
    return m_custom_properties_isSet;
}

bool OAIAudience::is_custom_properties_Valid() const{
    return m_custom_properties_isValid;
}

bool OAIAudience::isEnabled() const {
    return m_enabled;
}
void OAIAudience::setEnabled(const bool &enabled) {
    m_enabled = enabled;
    m_enabled_isSet = true;
}

bool OAIAudience::is_enabled_Set() const{
    return m_enabled_isSet;
}

bool OAIAudience::is_enabled_Valid() const{
    return m_enabled_isValid;
}

qint64 OAIAudience::getEstimatedTotalCount() const {
    return m_estimated_total_count;
}
void OAIAudience::setEstimatedTotalCount(const qint64 &estimated_total_count) {
    m_estimated_total_count = estimated_total_count;
    m_estimated_total_count_isSet = true;
}

bool OAIAudience::is_estimated_total_count_Set() const{
    return m_estimated_total_count_isSet;
}

bool OAIAudience::is_estimated_total_count_Valid() const{
    return m_estimated_total_count_isValid;
}

QDateTime OAIAudience::getTimestamp() const {
    return m_timestamp;
}
void OAIAudience::setTimestamp(const QDateTime &timestamp) {
    m_timestamp = timestamp;
    m_timestamp_isSet = true;
}

bool OAIAudience::is_timestamp_Set() const{
    return m_timestamp_isSet;
}

bool OAIAudience::is_timestamp_Valid() const{
    return m_timestamp_isValid;
}

QString OAIAudience::getDefinition() const {
    return m_definition;
}
void OAIAudience::setDefinition(const QString &definition) {
    m_definition = definition;
    m_definition_isSet = true;
}

bool OAIAudience::is_definition_Set() const{
    return m_definition_isSet;
}

bool OAIAudience::is_definition_Valid() const{
...
qint64 OAIAudience::getEstimatedCount() const {
    return m_estimated_count;
}
void OAIAudience::setEstimatedCount(const qint64 &estimated_count) {
    m_estimated_count = estimated_count;
    m_estimated_count_isSet = true;
}

bool OAIAudience::is_estimated_count_Set() const{
    return m_estimated_count_isSet;
}

bool OAIAudience::is_estimated_count_Valid() const{
...
QString OAIAudience::getState() const {
    return m_state;
}
void OAIAudience::setState(const QString &state) {
    m_state = state;
    m_state_isSet = true;
}

bool OAIAudience::is_state_Set() const{
    return m_state_isSet;
}

bool OAIAudience::is_state_Valid() const{
