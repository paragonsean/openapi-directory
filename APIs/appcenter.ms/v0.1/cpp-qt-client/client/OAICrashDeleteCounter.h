...
/*
 * OAICrashDeleteCounter.h
 *
 * 
 */

#ifndef OAICrashDeleteCounter_H
#define OAICrashDeleteCounter_H
...
class OAICrashDeleteCounter : public OAIObject {
public:
    OAICrashDeleteCounter();
    OAICrashDeleteCounter(QString json);
    ~OAICrashDeleteCounter() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICrashDeleteCounter)

#endif // OAICrashDeleteCounter_H
