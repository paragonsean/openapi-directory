...
/*
 * OAIStartServiceLog_Diagnostics.h
 *
 * Describe a AppCenter.Start API call from the SDK.
 */

#ifndef OAIStartServiceLog_Diagnostics_H
#define OAIStartServiceLog_Diagnostics_H
...
class OAIStartServiceLog_Diagnostics : public OAIObject {
public:
    OAIStartServiceLog_Diagnostics();
    OAIStartServiceLog_Diagnostics(QString json);
    ~OAIStartServiceLog_Diagnostics() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStartServiceLog_Diagnostics)

#endif // OAIStartServiceLog_Diagnostics_H
