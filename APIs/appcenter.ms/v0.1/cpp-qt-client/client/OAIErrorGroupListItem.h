...
/*
 * OAIErrorGroupListItem.h
 *
 * 
 */

#ifndef OAIErrorGroupListItem_H
#define OAIErrorGroupListItem_H
...
class OAIErrorGroupListItem : public OAIObject {
public:
    OAIErrorGroupListItem();
    OAIErrorGroupListItem(QString json);
    ~OAIErrorGroupListItem() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIErrorGroupListItem)

#endif // OAIErrorGroupListItem_H
