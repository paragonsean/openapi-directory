...
/*
 * OAILegacyCodePushReleaseResponse_package.h
 *
 * 
 */

#ifndef OAILegacyCodePushReleaseResponse_package_H
#define OAILegacyCodePushReleaseResponse_package_H
...
class OAILegacyCodePushReleaseResponse_package : public OAIObject {
public:
    OAILegacyCodePushReleaseResponse_package();
    OAILegacyCodePushReleaseResponse_package(QString json);
    ~OAILegacyCodePushReleaseResponse_package() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILegacyCodePushReleaseResponse_package)

#endif // OAILegacyCodePushReleaseResponse_package_H
