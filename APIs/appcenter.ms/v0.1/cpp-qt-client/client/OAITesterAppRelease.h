...
/*
 * OAITesterAppRelease.h
 *
 * 
 */

#ifndef OAITesterAppRelease_H
#define OAITesterAppRelease_H
...
class OAITesterAppRelease : public OAIObject {
public:
    OAITesterAppRelease();
    OAITesterAppRelease(QString json);
    ~OAITesterAppRelease() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITesterAppRelease)

#endif // OAITesterAppRelease_H
