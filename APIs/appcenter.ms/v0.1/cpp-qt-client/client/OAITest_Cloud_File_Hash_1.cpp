...
OAITest_Cloud_File_Hash_1::OAITest_Cloud_File_Hash_1(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAITest_Cloud_File_Hash_1::OAITest_Cloud_File_Hash_1() {
    this->initializeModel();
}

OAITest_Cloud_File_Hash_1::~OAITest_Cloud_File_Hash_1() {}

void OAITest_Cloud_File_Hash_1::initializeModel() {
...
void OAITest_Cloud_File_Hash_1::fromJson(QString jsonString) {
...
void OAITest_Cloud_File_Hash_1::fromJsonObject(QJsonObject json) {
...
QString OAITest_Cloud_File_Hash_1::asJson() const {
...
QJsonObject OAITest_Cloud_File_Hash_1::asJsonObject() const {
    QJsonObject obj;
    if (m_checksum_isSet) {
...
QString OAITest_Cloud_File_Hash_1::getChecksum() const {
    return m_checksum;
}
void OAITest_Cloud_File_Hash_1::setChecksum(const QString &checksum) {
    m_checksum = checksum;
    m_checksum_isSet = true;
}

bool OAITest_Cloud_File_Hash_1::is_checksum_Set() const{
    return m_checksum_isSet;
}

bool OAITest_Cloud_File_Hash_1::is_checksum_Valid() const{
    return m_checksum_isValid;
}

QString OAITest_Cloud_File_Hash_1::getFileType() const {
    return m_file_type;
}
void OAITest_Cloud_File_Hash_1::setFileType(const QString &file_type) {
    m_file_type = file_type;
    m_file_type_isSet = true;
}

bool OAITest_Cloud_File_Hash_1::is_file_type_Set() const{
    return m_file_type_isSet;
}

bool OAITest_Cloud_File_Hash_1::is_file_type_Valid() const{
    return m_file_type_isValid;
}

QString OAITest_Cloud_File_Hash_1::getRelativePath() const {
    return m_relative_path;
}
void OAITest_Cloud_File_Hash_1::setRelativePath(const QString &relative_path) {
    m_relative_path = relative_path;
    m_relative_path_isSet = true;
}

bool OAITest_Cloud_File_Hash_1::is_relative_path_Set() const{
    return m_relative_path_isSet;
}

bool OAITest_Cloud_File_Hash_1::is_relative_path_Valid() const{
    return m_relative_path_isValid;
}

bool OAITest_Cloud_File_Hash_1::isSet() const {
...
bool OAITest_Cloud_File_Hash_1::isValid() const {
