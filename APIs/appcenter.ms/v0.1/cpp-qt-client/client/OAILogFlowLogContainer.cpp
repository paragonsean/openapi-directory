...
#include "OAILogFlowLogContainer.h"
...
OAILogFlowLogContainer::OAILogFlowLogContainer(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAILogFlowLogContainer::OAILogFlowLogContainer() {
    this->initializeModel();
}

OAILogFlowLogContainer::~OAILogFlowLogContainer() {}

void OAILogFlowLogContainer::initializeModel() {
...
void OAILogFlowLogContainer::fromJson(QString jsonString) {
...
void OAILogFlowLogContainer::fromJsonObject(QJsonObject json) {
...
QString OAILogFlowLogContainer::asJson() const {
...
QJsonObject OAILogFlowLogContainer::asJsonObject() const {
    QJsonObject obj;
...
bool OAILogFlowLogContainer::isExceededMaxLimit() const {
    return m_exceeded_max_limit;
}
void OAILogFlowLogContainer::setExceededMaxLimit(const bool &exceeded_max_limit) {
    m_exceeded_max_limit = exceeded_max_limit;
    m_exceeded_max_limit_isSet = true;
}

bool OAILogFlowLogContainer::is_exceeded_max_limit_Set() const{
    return m_exceeded_max_limit_isSet;
}

bool OAILogFlowLogContainer::is_exceeded_max_limit_Valid() const{
    return m_exceeded_max_limit_isValid;
}

QDateTime OAILogFlowLogContainer::getLastReceivedLogTimestamp() const {
    return m_last_received_log_timestamp;
}
void OAILogFlowLogContainer::setLastReceivedLogTimestamp(const QDateTime &last_received_log_timestamp) {
    m_last_received_log_timestamp = last_received_log_timestamp;
    m_last_received_log_timestamp_isSet = true;
}

bool OAILogFlowLogContainer::is_last_received_log_timestamp_Set() const{
    return m_last_received_log_timestamp_isSet;
}

bool OAILogFlowLogContainer::is_last_received_log_timestamp_Valid() const{
    return m_last_received_log_timestamp_isValid;
}

QList<OAIAnalytics_LogFlow_200_response_logs_inner> OAILogFlowLogContainer::getLogs() const {
    return m_logs;
}
void OAILogFlowLogContainer::setLogs(const QList<OAIAnalytics_LogFlow_200_response_logs_inner> &logs) {
    m_logs = logs;
    m_logs_isSet = true;
}

bool OAILogFlowLogContainer::is_logs_Set() const{
    return m_logs_isSet;
}

bool OAILogFlowLogContainer::is_logs_Valid() const{
    return m_logs_isValid;
}

bool OAILogFlowLogContainer::isSet() const {
...
bool OAILogFlowLogContainer::isValid() const {
