...
/*
 * OAIErrorAttachment.h
 *
 * 
 */

#ifndef OAIErrorAttachment_H
#define OAIErrorAttachment_H
...
class OAIErrorAttachment : public OAIObject {
public:
    OAIErrorAttachment();
    OAIErrorAttachment(QString json);
    ~OAIErrorAttachment() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIErrorAttachment)

#endif // OAIErrorAttachment_H
