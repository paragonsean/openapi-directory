...
/*
 * OAIHandledErrorDetails.h
 *
 * 
 */

#ifndef OAIHandledErrorDetails_H
#define OAIHandledErrorDetails_H
...
class OAIHandledErrorDetails : public OAIObject {
public:
    OAIHandledErrorDetails();
    OAIHandledErrorDetails(QString json);
    ~OAIHandledErrorDetails() override;
    ...
    QList<OAIObject> getReasonFrames() const;
    void setReasonFrames(const QList<OAIObject> &reason_frames);
...
private:
    ...
    QList<OAIObject> m_reason_frames;
...
Q_DECLARE_METATYPE(OpenAPI::OAIHandledErrorDetails)

#endif // OAIHandledErrorDetails_H
