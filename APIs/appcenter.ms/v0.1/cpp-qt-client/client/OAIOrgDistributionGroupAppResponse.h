...
/*
 * OAIOrgDistributionGroupAppResponse.h
 *
 * 
 */

#ifndef OAIOrgDistributionGroupAppResponse_H
#define OAIOrgDistributionGroupAppResponse_H
...
class OAIOrgDistributionGroupAppResponse : public OAIObject {
public:
    OAIOrgDistributionGroupAppResponse();
    OAIOrgDistributionGroupAppResponse(QString json);
    ~OAIOrgDistributionGroupAppResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIOrgDistributionGroupAppResponse)

#endif // OAIOrgDistributionGroupAppResponse_H
