...
/*
 * OAIJiraConnectionNonSecretResponse.h
 *
 * Jira non-secret data
 */

#ifndef OAIJiraConnectionNonSecretResponse_H
#define OAIJiraConnectionNonSecretResponse_H
...
class OAIJiraConnectionNonSecretResponse : public OAIObject {
public:
    OAIJiraConnectionNonSecretResponse();
    OAIJiraConnectionNonSecretResponse(QString json);
    ~OAIJiraConnectionNonSecretResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIJiraConnectionNonSecretResponse)

#endif // OAIJiraConnectionNonSecretResponse_H
