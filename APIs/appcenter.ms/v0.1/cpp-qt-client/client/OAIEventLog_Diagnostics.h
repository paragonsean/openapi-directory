...
/*
 * OAIEventLog_Diagnostics.h
 *
 * Event log.
 */

#ifndef OAIEventLog_Diagnostics_H
#define OAIEventLog_Diagnostics_H
...
class OAIEventLog_Diagnostics : public OAIObject {
public:
    OAIEventLog_Diagnostics();
    OAIEventLog_Diagnostics(QString json);
    ~OAIEventLog_Diagnostics() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEventLog_Diagnostics)

#endif // OAIEventLog_Diagnostics_H
