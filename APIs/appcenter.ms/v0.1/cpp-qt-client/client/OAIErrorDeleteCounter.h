...
/*
 * OAIErrorDeleteCounter.h
 *
 * 
 */

#ifndef OAIErrorDeleteCounter_H
#define OAIErrorDeleteCounter_H
...
class OAIErrorDeleteCounter : public OAIObject {
public:
    OAIErrorDeleteCounter();
    OAIErrorDeleteCounter(QString json);
    ~OAIErrorDeleteCounter() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIErrorDeleteCounter)

#endif // OAIErrorDeleteCounter_H
