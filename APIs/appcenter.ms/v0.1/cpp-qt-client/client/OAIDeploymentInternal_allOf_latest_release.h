...
/*
 * OAIDeploymentInternal_allOf_latest_release.h
 *
 * 
 */

#ifndef OAIDeploymentInternal_allOf_latest_release_H
#define OAIDeploymentInternal_allOf_latest_release_H
...
class OAIDeploymentInternal_allOf_latest_release : public OAIObject {
public:
    OAIDeploymentInternal_allOf_latest_release();
    OAIDeploymentInternal_allOf_latest_release(QString json);
    ~OAIDeploymentInternal_allOf_latest_release() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeploymentInternal_allOf_latest_release)

#endif // OAIDeploymentInternal_allOf_latest_release_H
