...
#include "OAIErrorGroupListItem.h"
...
OAIErrorGroupListItem::OAIErrorGroupListItem(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIErrorGroupListItem::OAIErrorGroupListItem() {
    this->initializeModel();
}

OAIErrorGroupListItem::~OAIErrorGroupListItem() {}

void OAIErrorGroupListItem::initializeModel() {
...
void OAIErrorGroupListItem::fromJson(QString jsonString) {
...
void OAIErrorGroupListItem::fromJsonObject(QJsonObject json) {
...
QString OAIErrorGroupListItem::asJson() const {
...
QJsonObject OAIErrorGroupListItem::asJsonObject() const {
    QJsonObject obj;
...
QString OAIErrorGroupListItem::getAppBuild() const {
    return m_app_build;
}
void OAIErrorGroupListItem::setAppBuild(const QString &app_build) {
    m_app_build = app_build;
    m_app_build_isSet = true;
}

bool OAIErrorGroupListItem::is_app_build_Set() const{
    return m_app_build_isSet;
}

bool OAIErrorGroupListItem::is_app_build_Valid() const{
    return m_app_build_isValid;
}

QString OAIErrorGroupListItem::getAppVersion() const {
    return m_app_version;
}
void OAIErrorGroupListItem::setAppVersion(const QString &app_version) {
    m_app_version = app_version;
    m_app_version_isSet = true;
}

bool OAIErrorGroupListItem::is_app_version_Set() const{
    return m_app_version_isSet;
}

bool OAIErrorGroupListItem::is_app_version_Valid() const{
    return m_app_version_isValid;
}

QString OAIErrorGroupListItem::getCodeRaw() const {
    return m_code_raw;
}
void OAIErrorGroupListItem::setCodeRaw(const QString &code_raw) {
    m_code_raw = code_raw;
    m_code_raw_isSet = true;
}

bool OAIErrorGroupListItem::is_code_raw_Set() const{
    return m_code_raw_isSet;
}

bool OAIErrorGroupListItem::is_code_raw_Valid() const{
    return m_code_raw_isValid;
}

qint64 OAIErrorGroupListItem::getCount() const {
    return m_count;
}
void OAIErrorGroupListItem::setCount(const qint64 &count) {
    m_count = count;
    m_count_isSet = true;
}

bool OAIErrorGroupListItem::is_count_Set() const{
    return m_count_isSet;
}

bool OAIErrorGroupListItem::is_count_Valid() const{
    return m_count_isValid;
}

qint64 OAIErrorGroupListItem::getDeviceCount() const {
    return m_device_count;
}
void OAIErrorGroupListItem::setDeviceCount(const qint64 &device_count) {
    m_device_count = device_count;
    m_device_count_isSet = true;
}

bool OAIErrorGroupListItem::is_device_count_Set() const{
    return m_device_count_isSet;
}

bool OAIErrorGroupListItem::is_device_count_Valid() const{
    return m_device_count_isValid;
}

QString OAIErrorGroupListItem::getErrorGroupId() const {
    return m_error_group_id;
}
void OAIErrorGroupListItem::setErrorGroupId(const QString &error_group_id) {
    m_error_group_id = error_group_id;
    m_error_group_id_isSet = true;
}

bool OAIErrorGroupListItem::is_error_group_id_Set() const{
    return m_error_group_id_isSet;
}

bool OAIErrorGroupListItem::is_error_group_id_Valid() const{
    return m_error_group_id_isValid;
}

bool OAIErrorGroupListItem::isExceptionAppCode() const {
    return m_exception_app_code;
}
void OAIErrorGroupListItem::setExceptionAppCode(const bool &exception_app_code) {
    m_exception_app_code = exception_app_code;
    m_exception_app_code_isSet = true;
}

bool OAIErrorGroupListItem::is_exception_app_code_Set() const{
    return m_exception_app_code_isSet;
}

bool OAIErrorGroupListItem::is_exception_app_code_Valid() const{
    return m_exception_app_code_isValid;
}

bool OAIErrorGroupListItem::isExceptionClassMethod() const {
    return m_exception_class_method;
}
void OAIErrorGroupListItem::setExceptionClassMethod(const bool &exception_class_method) {
    m_exception_class_method = exception_class_method;
    m_exception_class_method_isSet = true;
}

bool OAIErrorGroupListItem::is_exception_class_method_Set() const{
    return m_exception_class_method_isSet;
}

bool OAIErrorGroupListItem::is_exception_class_method_Valid() const{
    return m_exception_class_method_isValid;
}

QString OAIErrorGroupListItem::getExceptionClassName() const {
    return m_exception_class_name;
}
void OAIErrorGroupListItem::setExceptionClassName(const QString &exception_class_name) {
    m_exception_class_name = exception_class_name;
    m_exception_class_name_isSet = true;
}

bool OAIErrorGroupListItem::is_exception_class_name_Set() const{
    return m_exception_class_name_isSet;
}

bool OAIErrorGroupListItem::is_exception_class_name_Valid() const{
    return m_exception_class_name_isValid;
}

QString OAIErrorGroupListItem::getExceptionFile() const {
    return m_exception_file;
}
void OAIErrorGroupListItem::setExceptionFile(const QString &exception_file) {
    m_exception_file = exception_file;
    m_exception_file_isSet = true;
}

bool OAIErrorGroupListItem::is_exception_file_Set() const{
    return m_exception_file_isSet;
}

bool OAIErrorGroupListItem::is_exception_file_Valid() const{
    return m_exception_file_isValid;
}

QString OAIErrorGroupListItem::getExceptionLine() const {
    return m_exception_line;
}
void OAIErrorGroupListItem::setExceptionLine(const QString &exception_line) {
    m_exception_line = exception_line;
    m_exception_line_isSet = true;
}

bool OAIErrorGroupListItem::is_exception_line_Set() const{
    return m_exception_line_isSet;
}

bool OAIErrorGroupListItem::is_exception_line_Valid() const{
    return m_exception_line_isValid;
}

QString OAIErrorGroupListItem::getExceptionMessage() const {
    return m_exception_message;
}
void OAIErrorGroupListItem::setExceptionMessage(const QString &exception_message) {
    m_exception_message = exception_message;
    m_exception_message_isSet = true;
}

bool OAIErrorGroupListItem::is_exception_message_Set() const{
    return m_exception_message_isSet;
}

bool OAIErrorGroupListItem::is_exception_message_Valid() const{
    return m_exception_message_isValid;
}

QString OAIErrorGroupListItem::getExceptionMethod() const {
    return m_exception_method;
}
void OAIErrorGroupListItem::setExceptionMethod(const QString &exception_method) {
    m_exception_method = exception_method;
    m_exception_method_isSet = true;
}

bool OAIErrorGroupListItem::is_exception_method_Set() const{
    return m_exception_method_isSet;
}

bool OAIErrorGroupListItem::is_exception_method_Valid() const{
    return m_exception_method_isValid;
}

QString OAIErrorGroupListItem::getExceptionType() const {
    return m_exception_type;
}
void OAIErrorGroupListItem::setExceptionType(const QString &exception_type) {
    m_exception_type = exception_type;
    m_exception_type_isSet = true;
}

bool OAIErrorGroupListItem::is_exception_type_Set() const{
    return m_exception_type_isSet;
}

bool OAIErrorGroupListItem::is_exception_type_Valid() const{
    return m_exception_type_isValid;
}

QDateTime OAIErrorGroupListItem::getFirstOccurrence() const {
    return m_first_occurrence;
}
void OAIErrorGroupListItem::setFirstOccurrence(const QDateTime &first_occurrence) {
    m_first_occurrence = first_occurrence;
    m_first_occurrence_isSet = true;
}

bool OAIErrorGroupListItem::is_first_occurrence_Set() const{
    return m_first_occurrence_isSet;
}

bool OAIErrorGroupListItem::is_first_occurrence_Valid() const{
    return m_first_occurrence_isValid;
}

bool OAIErrorGroupListItem::isHidden() const {
    return m_hidden;
}
void OAIErrorGroupListItem::setHidden(const bool &hidden) {
    m_hidden = hidden;
    m_hidden_isSet = true;
}

bool OAIErrorGroupListItem::is_hidden_Set() const{
    return m_hidden_isSet;
}

bool OAIErrorGroupListItem::is_hidden_Valid() const{
    return m_hidden_isValid;
}

QDateTime OAIErrorGroupListItem::getLastOccurrence() const {
    return m_last_occurrence;
}
void OAIErrorGroupListItem::setLastOccurrence(const QDateTime &last_occurrence) {
    m_last_occurrence = last_occurrence;
    m_last_occurrence_isSet = true;
}

bool OAIErrorGroupListItem::is_last_occurrence_Set() const{
    return m_last_occurrence_isSet;
}

bool OAIErrorGroupListItem::is_last_occurrence_Valid() const{
    return m_last_occurrence_isValid;
}

QList<OAIErrors_GroupList_200_response_errorGroups_inner_allOf_reasonFrames_inner> OAIErrorGroupListItem::getReasonFrames() const {
    return m_reason_frames;
}
void OAIErrorGroupListItem::setReasonFrames(const QList<OAIErrors_GroupList_200_response_errorGroups_inner_allOf_reasonFrames_inner> &reason_frames) {
    m_reason_frames = reason_frames;
    m_reason_frames_isSet = true;
}

bool OAIErrorGroupListItem::is_reason_frames_Set() const{
    return m_reason_frames_isSet;
}

bool OAIErrorGroupListItem::is_reason_frames_Valid() const{
    return m_reason_frames_isValid;
}

QString OAIErrorGroupListItem::getAnnotation() const {
    return m_annotation;
}
void OAIErrorGroupListItem::setAnnotation(const QString &annotation) {
    m_annotation = annotation;
    m_annotation_isSet = true;
}

bool OAIErrorGroupListItem::is_annotation_Set() const{
    return m_annotation_isSet;
}

bool OAIErrorGroupListItem::is_annotation_Valid() const{
    return m_annotation_isValid;
}

QString OAIErrorGroupListItem::getState() const {
    return m_state;
}
void OAIErrorGroupListItem::setState(const QString &state) {
    m_state = state;
    m_state_isSet = true;
}

bool OAIErrorGroupListItem::is_state_Set() const{
    return m_state_isSet;
}

bool OAIErrorGroupListItem::is_state_Valid() const{
    return m_state_isValid;
}

bool OAIErrorGroupListItem::isSet() const {
...
bool OAIErrorGroupListItem::isValid() const {
