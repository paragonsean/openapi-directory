...
#ifndef OAITestRunSummary_H
#define OAITestRunSummary_H
...
class OAITestRunSummary : public OAIObject {
public:
    OAITestRunSummary();
    OAITestRunSummary(QString json);
    ~OAITestRunSummary() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITestRunSummary)

#endif // OAITestRunSummary_H
