...
#ifndef OAIRepoConfig_H
#define OAIRepoConfig_H
...
class OAIRepoConfig : public OAIObject {
public:
    OAIRepoConfig();
    OAIRepoConfig(QString json);
    ~OAIRepoConfig() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRepoConfig)

#endif // OAIRepoConfig_H
