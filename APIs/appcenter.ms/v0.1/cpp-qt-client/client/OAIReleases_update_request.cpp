...
OAIReleases_update_request::OAIReleases_update_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIReleases_update_request::OAIReleases_update_request() {
    this->initializeModel();
}

OAIReleases_update_request::~OAIReleases_update_request() {}

void OAIReleases_update_request::initializeModel() {
...
void OAIReleases_update_request::fromJson(QString jsonString) {
...
void OAIReleases_update_request::fromJsonObject(QJsonObject json) {
...
QString OAIReleases_update_request::asJson() const {
...
QJsonObject OAIReleases_update_request::asJsonObject() const {
    QJsonObject obj;
    if (m_build.isSet()) {
...
OAIReleases_getLatestByDistributionGroup_200_response_build OAIReleases_update_request::getBuild() const {
    return m_build;
}
void OAIReleases_update_request::setBuild(const OAIReleases_getLatestByDistributionGroup_200_response_build &build) {
    m_build = build;
    m_build_isSet = true;
}

bool OAIReleases_update_request::is_build_Set() const{
    return m_build_isSet;
}

bool OAIReleases_update_request::is_build_Valid() const{
    return m_build_isValid;
}

QString OAIReleases_update_request::getDestinationId() const {
    return m_destination_id;
}
void OAIReleases_update_request::setDestinationId(const QString &destination_id) {
    m_destination_id = destination_id;
    m_destination_id_isSet = true;
}

bool OAIReleases_update_request::is_destination_id_Set() const{
    return m_destination_id_isSet;
}

bool OAIReleases_update_request::is_destination_id_Valid() const{
    return m_destination_id_isValid;
}

QString OAIReleases_update_request::getDestinationName() const {
    return m_destination_name;
}
void OAIReleases_update_request::setDestinationName(const QString &destination_name) {
    m_destination_name = destination_name;
    m_destination_name_isSet = true;
}

bool OAIReleases_update_request::is_destination_name_Set() const{
    return m_destination_name_isSet;
}

bool OAIReleases_update_request::is_destination_name_Valid() const{
    return m_destination_name_isValid;
}

QString OAIReleases_update_request::getDestinationType() const {
    return m_destination_type;
}
void OAIReleases_update_request::setDestinationType(const QString &destination_type) {
    m_destination_type = destination_type;
    m_destination_type_isSet = true;
}

bool OAIReleases_update_request::is_destination_type_Set() const{
    return m_destination_type_isSet;
}

bool OAIReleases_update_request::is_destination_type_Valid() const{
    return m_destination_type_isValid;
}

QList<OAIReleases_update_request_destinations_inner> OAIReleases_update_request::getDestinations() const {
    return m_destinations;
}
void OAIReleases_update_request::setDestinations(const QList<OAIReleases_update_request_destinations_inner> &destinations) {
    m_destinations = destinations;
    m_destinations_isSet = true;
}

bool OAIReleases_update_request::is_destinations_Set() const{
    return m_destinations_isSet;
}

bool OAIReleases_update_request::is_destinations_Valid() const{
    return m_destinations_isValid;
}

QString OAIReleases_update_request::getDistributionGroupId() const {
    return m_distribution_group_id;
}
void OAIReleases_update_request::setDistributionGroupId(const QString &distribution_group_id) {
    m_distribution_group_id = distribution_group_id;
    m_distribution_group_id_isSet = true;
}

bool OAIReleases_update_request::is_distribution_group_id_Set() const{
    return m_distribution_group_id_isSet;
}

bool OAIReleases_update_request::is_distribution_group_id_Valid() const{
    return m_distribution_group_id_isValid;
}

QString OAIReleases_update_request::getDistributionGroupName() const {
    return m_distribution_group_name;
}
void OAIReleases_update_request::setDistributionGroupName(const QString &distribution_group_name) {
    m_distribution_group_name = distribution_group_name;
    m_distribution_group_name_isSet = true;
}

bool OAIReleases_update_request::is_distribution_group_name_Set() const{
    return m_distribution_group_name_isSet;
}

bool OAIReleases_update_request::is_distribution_group_name_Valid() const{
    return m_distribution_group_name_isValid;
}

bool OAIReleases_update_request::isMandatoryUpdate() const {
    return m_mandatory_update;
}
void OAIReleases_update_request::setMandatoryUpdate(const bool &mandatory_update) {
    m_mandatory_update = mandatory_update;
    m_mandatory_update_isSet = true;
}

bool OAIReleases_update_request::is_mandatory_update_Set() const{
    return m_mandatory_update_isSet;
}

bool OAIReleases_update_request::is_mandatory_update_Valid() const{
    return m_mandatory_update_isValid;
}

OAIReleases_update_request_metadata OAIReleases_update_request::getMetadata() const {
    return m_metadata;
}
void OAIReleases_update_request::setMetadata(const OAIReleases_update_request_metadata &metadata) {
    m_metadata = metadata;
    m_metadata_isSet = true;
}

bool OAIReleases_update_request::is_metadata_Set() const{
    return m_metadata_isSet;
}

bool OAIReleases_update_request::is_metadata_Valid() const{
    return m_metadata_isValid;
}

bool OAIReleases_update_request::isNotifyTesters() const {
    return m_notify_testers;
}
void OAIReleases_update_request::setNotifyTesters(const bool &notify_testers) {
    m_notify_testers = notify_testers;
    m_notify_testers_isSet = true;
}

bool OAIReleases_update_request::is_notify_testers_Set() const{
    return m_notify_testers_isSet;
}

bool OAIReleases_update_request::is_notify_testers_Valid() const{
    return m_notify_testers_isValid;
}

QString OAIReleases_update_request::getReleaseNotes() const {
    return m_release_notes;
}
void OAIReleases_update_request::setReleaseNotes(const QString &release_notes) {
    m_release_notes = release_notes;
    m_release_notes_isSet = true;
}

bool OAIReleases_update_request::is_release_notes_Set() const{
    return m_release_notes_isSet;
}

bool OAIReleases_update_request::is_release_notes_Valid() const{
    return m_release_notes_isValid;
}

bool OAIReleases_update_request::isSet() const {
...
bool OAIReleases_update_request::isValid() const {
