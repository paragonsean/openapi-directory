...
/*
 * OAIAppleConnectionNonSecretResponse.h
 *
 * Apple connection secrets
 */

#ifndef OAIAppleConnectionNonSecretResponse_H
#define OAIAppleConnectionNonSecretResponse_H
...
class OAIAppleConnectionNonSecretResponse : public OAIObject {
public:
    OAIAppleConnectionNonSecretResponse();
    OAIAppleConnectionNonSecretResponse(QString json);
    ~OAIAppleConnectionNonSecretResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAppleConnectionNonSecretResponse)

#endif // OAIAppleConnectionNonSecretResponse_H
