...
#include "OAIStoresReleaseDetails.h"
...
OAIStoresReleaseDetails::OAIStoresReleaseDetails(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIStoresReleaseDetails::OAIStoresReleaseDetails() {
    this->initializeModel();
}

OAIStoresReleaseDetails::~OAIStoresReleaseDetails() {}

void OAIStoresReleaseDetails::initializeModel() {
...
void OAIStoresReleaseDetails::fromJson(QString jsonString) {
...
void OAIStoresReleaseDetails::fromJsonObject(QJsonObject json) {
...
QString OAIStoresReleaseDetails::asJson() const {
...
QJsonObject OAIStoresReleaseDetails::asJsonObject() const {
    QJsonObject obj;
...
QString OAIStoresReleaseDetails::getAndroidMinApiLevel() const {
    return m_android_min_api_level;
}
void OAIStoresReleaseDetails::setAndroidMinApiLevel(const QString &android_min_api_level) {
    m_android_min_api_level = android_min_api_level;
    m_android_min_api_level_isSet = true;
}

bool OAIStoresReleaseDetails::is_android_min_api_level_Set() const{
    return m_android_min_api_level_isSet;
}

bool OAIStoresReleaseDetails::is_android_min_api_level_Valid() const{
    return m_android_min_api_level_isValid;
}

QString OAIStoresReleaseDetails::getAppDisplayName() const {
    return m_app_display_name;
}
void OAIStoresReleaseDetails::setAppDisplayName(const QString &app_display_name) {
    m_app_display_name = app_display_name;
    m_app_display_name_isSet = true;
}

bool OAIStoresReleaseDetails::is_app_display_name_Set() const{
    return m_app_display_name_isSet;
}

bool OAIStoresReleaseDetails::is_app_display_name_Valid() const{
    return m_app_display_name_isValid;
}

QString OAIStoresReleaseDetails::getAppName() const {
    return m_app_name;
}
void OAIStoresReleaseDetails::setAppName(const QString &app_name) {
    m_app_name = app_name;
    m_app_name_isSet = true;
}

bool OAIStoresReleaseDetails::is_app_name_Set() const{
    return m_app_name_isSet;
}

bool OAIStoresReleaseDetails::is_app_name_Valid() const{
    return m_app_name_isValid;
}

QString OAIStoresReleaseDetails::getBundleIdentifier() const {
    return m_bundle_identifier;
}
void OAIStoresReleaseDetails::setBundleIdentifier(const QString &bundle_identifier) {
    m_bundle_identifier = bundle_identifier;
    m_bundle_identifier_isSet = true;
}

bool OAIStoresReleaseDetails::is_bundle_identifier_Set() const{
    return m_bundle_identifier_isSet;
}

bool OAIStoresReleaseDetails::is_bundle_identifier_Valid() const{
    return m_bundle_identifier_isValid;
}

QList<OAIStoreReleases_getLatest_200_response_inner_distribution_stores_inner> OAIStoresReleaseDetails::getDistributionStores() const {
    return m_distribution_stores;
}
void OAIStoresReleaseDetails::setDistributionStores(const QList<OAIStoreReleases_getLatest_200_response_inner_distribution_stores_inner> &distribution_stores) {
    m_distribution_stores = distribution_stores;
    m_distribution_stores_isSet = true;
}

bool OAIStoresReleaseDetails::is_distribution_stores_Set() const{
    return m_distribution_stores_isSet;
}

bool OAIStoresReleaseDetails::is_distribution_stores_Valid() const{
    return m_distribution_stores_isValid;
}

QString OAIStoresReleaseDetails::getDownloadUrl() const {
    return m_download_url;
}
void OAIStoresReleaseDetails::setDownloadUrl(const QString &download_url) {
    m_download_url = download_url;
    m_download_url_isSet = true;
}

bool OAIStoresReleaseDetails::is_download_url_Set() const{
    return m_download_url_isSet;
}

bool OAIStoresReleaseDetails::is_download_url_Valid() const{
    return m_download_url_isValid;
}

QString OAIStoresReleaseDetails::getFingerprint() const {
    return m_fingerprint;
}
void OAIStoresReleaseDetails::setFingerprint(const QString &fingerprint) {
    m_fingerprint = fingerprint;
    m_fingerprint_isSet = true;
}

bool OAIStoresReleaseDetails::is_fingerprint_Set() const{
    return m_fingerprint_isSet;
}

bool OAIStoresReleaseDetails::is_fingerprint_Valid() const{
    return m_fingerprint_isValid;
}

double OAIStoresReleaseDetails::getId() const {
    return m_id;
}
void OAIStoresReleaseDetails::setId(const double &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIStoresReleaseDetails::is_id_Set() const{
    return m_id_isSet;
}

bool OAIStoresReleaseDetails::is_id_Valid() const{
    return m_id_isValid;
}

QString OAIStoresReleaseDetails::getInstallUrl() const {
    return m_install_url;
}
void OAIStoresReleaseDetails::setInstallUrl(const QString &install_url) {
    m_install_url = install_url;
    m_install_url_isSet = true;
}

bool OAIStoresReleaseDetails::is_install_url_Set() const{
    return m_install_url_isSet;
}

bool OAIStoresReleaseDetails::is_install_url_Valid() const{
    return m_install_url_isValid;
}

QString OAIStoresReleaseDetails::getMinOs() const {
    return m_min_os;
}
void OAIStoresReleaseDetails::setMinOs(const QString &min_os) {
    m_min_os = min_os;
    m_min_os_isSet = true;
}

bool OAIStoresReleaseDetails::is_min_os_Set() const{
    return m_min_os_isSet;
}

bool OAIStoresReleaseDetails::is_min_os_Valid() const{
    return m_min_os_isValid;
}

QString OAIStoresReleaseDetails::getReleaseNotes() const {
    return m_release_notes;
}
void OAIStoresReleaseDetails::setReleaseNotes(const QString &release_notes) {
    m_release_notes = release_notes;
    m_release_notes_isSet = true;
}

bool OAIStoresReleaseDetails::is_release_notes_Set() const{
    return m_release_notes_isSet;
}

bool OAIStoresReleaseDetails::is_release_notes_Valid() const{
    return m_release_notes_isValid;
}

QString OAIStoresReleaseDetails::getShortVersion() const {
    return m_short_version;
}
void OAIStoresReleaseDetails::setShortVersion(const QString &short_version) {
    m_short_version = short_version;
    m_short_version_isSet = true;
}

bool OAIStoresReleaseDetails::is_short_version_Set() const{
    return m_short_version_isSet;
}

bool OAIStoresReleaseDetails::is_short_version_Valid() const{
    return m_short_version_isValid;
}

double OAIStoresReleaseDetails::getSize() const {
    return m_size;
}
void OAIStoresReleaseDetails::setSize(const double &size) {
    m_size = size;
    m_size_isSet = true;
}

bool OAIStoresReleaseDetails::is_size_Set() const{
    return m_size_isSet;
}

bool OAIStoresReleaseDetails::is_size_Valid() const{
    return m_size_isValid;
}

QString OAIStoresReleaseDetails::getStatus() const {
    return m_status;
}
void OAIStoresReleaseDetails::setStatus(const QString &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIStoresReleaseDetails::is_status_Set() const{
    return m_status_isSet;
}

bool OAIStoresReleaseDetails::is_status_Valid() const{
    return m_status_isValid;
}

QString OAIStoresReleaseDetails::getUploadedAt() const {
    return m_uploaded_at;
}
void OAIStoresReleaseDetails::setUploadedAt(const QString &uploaded_at) {
    m_uploaded_at = uploaded_at;
    m_uploaded_at_isSet = true;
}

bool OAIStoresReleaseDetails::is_uploaded_at_Set() const{
    return m_uploaded_at_isSet;
}

bool OAIStoresReleaseDetails::is_uploaded_at_Valid() const{
    return m_uploaded_at_isValid;
}

QString OAIStoresReleaseDetails::getVersion() const {
    return m_version;
}
void OAIStoresReleaseDetails::setVersion(const QString &version) {
    m_version = version;
    m_version_isSet = true;
}

bool OAIStoresReleaseDetails::is_version_Set() const{
    return m_version_isSet;
}

bool OAIStoresReleaseDetails::is_version_Valid() const{
    return m_version_isValid;
}

bool OAIStoresReleaseDetails::isSet() const {
...
bool OAIStoresReleaseDetails::isValid() const {
