...
/*
 * OAIJiraCredentialNonSecretDetailsResponse.h
 *
 * Jira credentials non-secret details
 */

#ifndef OAIJiraCredentialNonSecretDetailsResponse_H
#define OAIJiraCredentialNonSecretDetailsResponse_H
...
class OAIJiraCredentialNonSecretDetailsResponse : public OAIObject {
public:
    OAIJiraCredentialNonSecretDetailsResponse();
    OAIJiraCredentialNonSecretDetailsResponse(QString json);
    ~OAIJiraCredentialNonSecretDetailsResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIJiraCredentialNonSecretDetailsResponse)

#endif // OAIJiraCredentialNonSecretDetailsResponse_H
