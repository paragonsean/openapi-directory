...
#include "OAITestCloudFileHashResponse.h"
...
OAITestCloudFileHashResponse::OAITestCloudFileHashResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAITestCloudFileHashResponse::OAITestCloudFileHashResponse() {
    this->initializeModel();
}

OAITestCloudFileHashResponse::~OAITestCloudFileHashResponse() {}

void OAITestCloudFileHashResponse::initializeModel() {
...
void OAITestCloudFileHashResponse::fromJson(QString jsonString) {
...
void OAITestCloudFileHashResponse::fromJsonObject(QJsonObject json) {
...
QString OAITestCloudFileHashResponse::asJson() const {
...
QJsonObject OAITestCloudFileHashResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_checksum_isSet) {
...
QString OAITestCloudFileHashResponse::getChecksum() const {
    return m_checksum;
}
void OAITestCloudFileHashResponse::setChecksum(const QString &checksum) {
    m_checksum = checksum;
    m_checksum_isSet = true;
}

bool OAITestCloudFileHashResponse::is_checksum_Set() const{
    return m_checksum_isSet;
}

bool OAITestCloudFileHashResponse::is_checksum_Valid() const{
    return m_checksum_isValid;
}

QString OAITestCloudFileHashResponse::getFileType() const {
    return m_file_type;
}
void OAITestCloudFileHashResponse::setFileType(const QString &file_type) {
    m_file_type = file_type;
    m_file_type_isSet = true;
}

bool OAITestCloudFileHashResponse::is_file_type_Set() const{
    return m_file_type_isSet;
}

bool OAITestCloudFileHashResponse::is_file_type_Valid() const{
    return m_file_type_isValid;
}

QString OAITestCloudFileHashResponse::getRelativePath() const {
    return m_relative_path;
}
void OAITestCloudFileHashResponse::setRelativePath(const QString &relative_path) {
    m_relative_path = relative_path;
    m_relative_path_isSet = true;
}

bool OAITestCloudFileHashResponse::is_relative_path_Set() const{
    return m_relative_path_isSet;
}

bool OAITestCloudFileHashResponse::is_relative_path_Valid() const{
    return m_relative_path_isValid;
}

OAITest_Cloud_Hash_Upload_Status OAITestCloudFileHashResponse::getUploadStatus() const {
    return m_upload_status;
}
void OAITestCloudFileHashResponse::setUploadStatus(const OAITest_Cloud_Hash_Upload_Status &upload_status) {
    m_upload_status = upload_status;
    m_upload_status_isSet = true;
}

bool OAITestCloudFileHashResponse::is_upload_status_Set() const{
    return m_upload_status_isSet;
}

bool OAITestCloudFileHashResponse::is_upload_status_Valid() const{
    return m_upload_status_isValid;
}

bool OAITestCloudFileHashResponse::isSet() const {
...
bool OAITestCloudFileHashResponse::isValid() const {
