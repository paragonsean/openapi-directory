...
/*
 * OAICrashAttachment.h
 *
 * 
 */

#ifndef OAICrashAttachment_H
#define OAICrashAttachment_H
...
class OAICrashAttachment : public OAIObject {
public:
    OAICrashAttachment();
    OAICrashAttachment(QString json);
    ~OAICrashAttachment() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICrashAttachment)

#endif // OAICrashAttachment_H
