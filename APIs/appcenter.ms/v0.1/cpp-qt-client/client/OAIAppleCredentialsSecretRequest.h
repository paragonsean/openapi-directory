...
/*
 * OAIAppleCredentialsSecretRequest.h
 *
 * Apple connection secrets
 */

#ifndef OAIAppleCredentialsSecretRequest_H
#define OAIAppleCredentialsSecretRequest_H
...
class OAIAppleCredentialsSecretRequest : public OAIObject {
public:
    OAIAppleCredentialsSecretRequest();
    OAIAppleCredentialsSecretRequest(QString json);
    ~OAIAppleCredentialsSecretRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAppleCredentialsSecretRequest)

#endif // OAIAppleCredentialsSecretRequest_H
