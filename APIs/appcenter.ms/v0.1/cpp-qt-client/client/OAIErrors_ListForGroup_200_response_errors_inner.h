...
/*
 * OAIErrors_ListForGroup_200_response_errors_inner.h
 *
 * 
 */

#ifndef OAIErrors_ListForGroup_200_response_errors_inner_H
#define OAIErrors_ListForGroup_200_response_errors_inner_H
...
class OAIErrors_ListForGroup_200_response_errors_inner : public OAIObject {
public:
    OAIErrors_ListForGroup_200_response_errors_inner();
    OAIErrors_ListForGroup_200_response_errors_inner(QString json);
    ~OAIErrors_ListForGroup_200_response_errors_inner() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIErrors_ListForGroup_200_response_errors_inner)

#endif // OAIErrors_ListForGroup_200_response_errors_inner_H
