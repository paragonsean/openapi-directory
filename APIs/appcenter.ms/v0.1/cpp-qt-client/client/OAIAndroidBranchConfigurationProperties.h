...
/*
 * OAIAndroidBranchConfigurationProperties.h
 *
 * Build configuration for Android projects
 */

#ifndef OAIAndroidBranchConfigurationProperties_H
#define OAIAndroidBranchConfigurationProperties_H
...
class OAIAndroidBranchConfigurationProperties : public OAIObject {
public:
    OAIAndroidBranchConfigurationProperties();
    OAIAndroidBranchConfigurationProperties(QString json);
    ~OAIAndroidBranchConfigurationProperties() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAndroidBranchConfigurationProperties)

#endif // OAIAndroidBranchConfigurationProperties_H
