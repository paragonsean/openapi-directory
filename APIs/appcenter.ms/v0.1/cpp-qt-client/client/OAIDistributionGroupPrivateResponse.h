...
/*
 * OAIDistributionGroupPrivateResponse.h
 *
 * 
 */

#ifndef OAIDistributionGroupPrivateResponse_H
#define OAIDistributionGroupPrivateResponse_H
...
class OAIDistributionGroupPrivateResponse : public OAIObject {
public:
    OAIDistributionGroupPrivateResponse();
    OAIDistributionGroupPrivateResponse(QString json);
    ~OAIDistributionGroupPrivateResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDistributionGroupPrivateResponse)

#endif // OAIDistributionGroupPrivateResponse_H
