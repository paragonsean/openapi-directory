...
/*
 * OAIAppleCertificateSecretRequest.h
 *
 * Apple certificate secrets
 */

#ifndef OAIAppleCertificateSecretRequest_H
#define OAIAppleCertificateSecretRequest_H
...
class OAIAppleCertificateSecretRequest : public OAIObject {
public:
    OAIAppleCertificateSecretRequest();
    OAIAppleCertificateSecretRequest(QString json);
    ~OAIAppleCertificateSecretRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAppleCertificateSecretRequest)

#endif // OAIAppleCertificateSecretRequest_H
