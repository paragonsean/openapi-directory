...
QString OAIDevice::getAppBuild() const {
    return m_app_build;
}
void OAIDevice::setAppBuild(const QString &app_build) {
    m_app_build = app_build;
    m_app_build_isSet = true;
}

bool OAIDevice::is_app_build_Set() const{
    return m_app_build_isSet;
}

bool OAIDevice::is_app_build_Valid() const{
    return m_app_build_isValid;
}

QString OAIDevice::getAppNamespace() const {
    return m_app_namespace;
}
void OAIDevice::setAppNamespace(const QString &app_namespace) {
    m_app_namespace = app_namespace;
    m_app_namespace_isSet = true;
}

bool OAIDevice::is_app_namespace_Set() const{
    return m_app_namespace_isSet;
}

bool OAIDevice::is_app_namespace_Valid() const{
...
QString OAIDevice::getCarrierCode() const {
    return m_carrier_code;
}
void OAIDevice::setCarrierCode(const QString &carrier_code) {
    m_carrier_code = carrier_code;
    m_carrier_code_isSet = true;
}

bool OAIDevice::is_carrier_code_Set() const{
    return m_carrier_code_isSet;
}

bool OAIDevice::is_carrier_code_Valid() const{
    return m_carrier_code_isValid;
}

QString OAIDevice::getCarrierCountry() const {
    return m_carrier_country;
}
void OAIDevice::setCarrierCountry(const QString &carrier_country) {
    m_carrier_country = carrier_country;
    m_carrier_country_isSet = true;
}

bool OAIDevice::is_carrier_country_Set() const{
    return m_carrier_country_isSet;
}

bool OAIDevice::is_carrier_country_Valid() const{
    return m_carrier_country_isValid;
}

QString OAIDevice::getCarrierName() const {
    return m_carrier_name;
}
void OAIDevice::setCarrierName(const QString &carrier_name) {
    m_carrier_name = carrier_name;
    m_carrier_name_isSet = true;
}

bool OAIDevice::is_carrier_name_Set() const{
    return m_carrier_name_isSet;
}

bool OAIDevice::is_carrier_name_Valid() const{
    return m_carrier_name_isValid;
}

QString OAIDevice::getLiveUpdateDeploymentKey() const {
    return m_live_update_deployment_key;
}
void OAIDevice::setLiveUpdateDeploymentKey(const QString &live_update_deployment_key) {
    m_live_update_deployment_key = live_update_deployment_key;
    m_live_update_deployment_key_isSet = true;
}

bool OAIDevice::is_live_update_deployment_key_Set() const{
    return m_live_update_deployment_key_isSet;
}

bool OAIDevice::is_live_update_deployment_key_Valid() const{
    return m_live_update_deployment_key_isValid;
}

QString OAIDevice::getLiveUpdatePackageHash() const {
    return m_live_update_package_hash;
}
void OAIDevice::setLiveUpdatePackageHash(const QString &live_update_package_hash) {
    m_live_update_package_hash = live_update_package_hash;
    m_live_update_package_hash_isSet = true;
}

bool OAIDevice::is_live_update_package_hash_Set() const{
    return m_live_update_package_hash_isSet;
}

bool OAIDevice::is_live_update_package_hash_Valid() const{
    return m_live_update_package_hash_isValid;
}

QString OAIDevice::getLiveUpdateReleaseLabel() const {
    return m_live_update_release_label;
}
void OAIDevice::setLiveUpdateReleaseLabel(const QString &live_update_release_label) {
    m_live_update_release_label = live_update_release_label;
    m_live_update_release_label_isSet = true;
}

bool OAIDevice::is_live_update_release_label_Set() const{
    return m_live_update_release_label_isSet;
}

bool OAIDevice::is_live_update_release_label_Valid() const{
    return m_live_update_release_label_isValid;
}

QString OAIDevice::getLocale() const {
    return m_locale;
}
void OAIDevice::setLocale(const QString &locale) {
    m_locale = locale;
    m_locale_isSet = true;
}

bool OAIDevice::is_locale_Set() const{
    return m_locale_isSet;
}

bool OAIDevice::is_locale_Valid() const{
...
QString OAIDevice::getOemName() const {
    return m_oem_name;
}
void OAIDevice::setOemName(const QString &oem_name) {
    m_oem_name = oem_name;
    m_oem_name_isSet = true;
}

bool OAIDevice::is_oem_name_Set() const{
    return m_oem_name_isSet;
}

bool OAIDevice::is_oem_name_Valid() const{
    return m_oem_name_isValid;
}

qint32 OAIDevice::getOsApiLevel() const {
    return m_os_api_level;
}
void OAIDevice::setOsApiLevel(const qint32 &os_api_level) {
    m_os_api_level = os_api_level;
    m_os_api_level_isSet = true;
}

bool OAIDevice::is_os_api_level_Set() const{
    return m_os_api_level_isSet;
}

bool OAIDevice::is_os_api_level_Valid() const{
    return m_os_api_level_isValid;
}

QString OAIDevice::getOsBuild() const {
    return m_os_build;
}
void OAIDevice::setOsBuild(const QString &os_build) {
    m_os_build = os_build;
    m_os_build_isSet = true;
}

bool OAIDevice::is_os_build_Set() const{
    return m_os_build_isSet;
}

bool OAIDevice::is_os_build_Valid() const{
    return m_os_build_isValid;
}

QString OAIDevice::getOsName() const {
    return m_os_name;
}
void OAIDevice::setOsName(const QString &os_name) {
    m_os_name = os_name;
    m_os_name_isSet = true;
}

bool OAIDevice::is_os_name_Set() const{
    return m_os_name_isSet;
}

bool OAIDevice::is_os_name_Valid() const{
...
QString OAIDevice::getScreenSize() const {
    return m_screen_size;
}
void OAIDevice::setScreenSize(const QString &screen_size) {
    m_screen_size = screen_size;
    m_screen_size_isSet = true;
}

bool OAIDevice::is_screen_size_Set() const{
    return m_screen_size_isSet;
}

bool OAIDevice::is_screen_size_Valid() const{
    return m_screen_size_isValid;
}

QString OAIDevice::getSdkName() const {
    return m_sdk_name;
}
void OAIDevice::setSdkName(const QString &sdk_name) {
    m_sdk_name = sdk_name;
    m_sdk_name_isSet = true;
}

bool OAIDevice::is_sdk_name_Set() const{
    return m_sdk_name_isSet;
}

bool OAIDevice::is_sdk_name_Valid() const{
    return m_sdk_name_isValid;
}

QString OAIDevice::getSdkVersion() const {
    return m_sdk_version;
}
void OAIDevice::setSdkVersion(const QString &sdk_version) {
...
qint32 OAIDevice::getTimeZoneOffset() const {
    return m_time_zone_offset;
}
void OAIDevice::setTimeZoneOffset(const qint32 &time_zone_offset) {
    m_time_zone_offset = time_zone_offset;
    m_time_zone_offset_isSet = true;
}

bool OAIDevice::is_time_zone_offset_Set() const{
    return m_time_zone_offset_isSet;
}

bool OAIDevice::is_time_zone_offset_Valid() const{
    return m_time_zone_offset_isValid;
}

QString OAIDevice::getWrapperRuntimeVersion() const {
    return m_wrapper_runtime_version;
}
void OAIDevice::setWrapperRuntimeVersion(const QString &wrapper_runtime_version) {
    m_wrapper_runtime_version = wrapper_runtime_version;
    m_wrapper_runtime_version_isSet = true;
}

bool OAIDevice::is_wrapper_runtime_version_Set() const{
    return m_wrapper_runtime_version_isSet;
}

bool OAIDevice::is_wrapper_runtime_version_Valid() const{
    return m_wrapper_runtime_version_isValid;
}

QString OAIDevice::getWrapperSdkName() const {
    return m_wrapper_sdk_name;
}
void OAIDevice::setWrapperSdkName(const QString &wrapper_sdk_name) {
    m_wrapper_sdk_name = wrapper_sdk_name;
    m_wrapper_sdk_name_isSet = true;
}

bool OAIDevice::is_wrapper_sdk_name_Set() const{
    return m_wrapper_sdk_name_isSet;
}

bool OAIDevice::is_wrapper_sdk_name_Valid() const{
    return m_wrapper_sdk_name_isValid;
}

QString OAIDevice::getWrapperSdkVersion() const {
    return m_wrapper_sdk_version;
}
void OAIDevice::setWrapperSdkVersion(const QString &wrapper_sdk_version) {
    m_wrapper_sdk_version = wrapper_sdk_version;
    m_wrapper_sdk_version_isSet = true;
}

bool OAIDevice::is_wrapper_sdk_version_Set() const{
    return m_wrapper_sdk_version_isSet;
}

bool OAIDevice::is_wrapper_sdk_version_Valid() const{
