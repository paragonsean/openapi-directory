...
/*
 * OAIReleases_update_request.h
 *
 * A request containing information for updating a release.
 */

#ifndef OAIReleases_update_request_H
#define OAIReleases_update_request_H
...
class OAIReleases_update_request : public OAIObject {
public:
    OAIReleases_update_request();
    OAIReleases_update_request(QString json);
    ~OAIReleases_update_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIReleases_update_request)

#endif // OAIReleases_update_request_H
