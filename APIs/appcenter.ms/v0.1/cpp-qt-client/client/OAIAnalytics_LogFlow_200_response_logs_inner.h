...
/*
 * OAIAnalytics_LogFlow_200_response_logs_inner.h
 *
 * 
 */

#ifndef OAIAnalytics_LogFlow_200_response_logs_inner_H
#define OAIAnalytics_LogFlow_200_response_logs_inner_H
...
class OAIAnalytics_LogFlow_200_response_logs_inner : public OAIObject {
public:
    OAIAnalytics_LogFlow_200_response_logs_inner();
    OAIAnalytics_LogFlow_200_response_logs_inner(QString json);
    ~OAIAnalytics_LogFlow_200_response_logs_inner() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAnalytics_LogFlow_200_response_logs_inner)

#endif // OAIAnalytics_LogFlow_200_response_logs_inner_H
