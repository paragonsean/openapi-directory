...
/*
 * OAIPasswordUpdateRequest.h
 *
 * 
 */

#ifndef OAIPasswordUpdateRequest_H
#define OAIPasswordUpdateRequest_H
...
class OAIPasswordUpdateRequest : public OAIObject {
public:
    OAIPasswordUpdateRequest();
    OAIPasswordUpdateRequest(QString json);
    ~OAIPasswordUpdateRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPasswordUpdateRequest)

#endif // OAIPasswordUpdateRequest_H
