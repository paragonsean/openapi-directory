...
/*
 * OAIAvailableVersions_Diagnostics.h
 *
 * 
 */

#ifndef OAIAvailableVersions_Diagnostics_H
#define OAIAvailableVersions_Diagnostics_H
...
class OAIAvailableVersions_Diagnostics : public OAIObject {
public:
    OAIAvailableVersions_Diagnostics();
    OAIAvailableVersions_Diagnostics(QString json);
    ~OAIAvailableVersions_Diagnostics() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAvailableVersions_Diagnostics)

#endif // OAIAvailableVersions_Diagnostics_H
