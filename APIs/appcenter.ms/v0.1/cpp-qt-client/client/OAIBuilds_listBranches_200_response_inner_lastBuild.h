...
/*
 * OAIBuilds_listBranches_200_response_inner_lastBuild.h
 *
 * 
 */

#ifndef OAIBuilds_listBranches_200_response_inner_lastBuild_H
#define OAIBuilds_listBranches_200_response_inner_lastBuild_H
...
class OAIBuilds_listBranches_200_response_inner_lastBuild : public OAIObject {
public:
    OAIBuilds_listBranches_200_response_inner_lastBuild();
    OAIBuilds_listBranches_200_response_inner_lastBuild(QString json);
    ~OAIBuilds_listBranches_200_response_inner_lastBuild() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBuilds_listBranches_200_response_inner_lastBuild)

#endif // OAIBuilds_listBranches_200_response_inner_lastBuild_H
