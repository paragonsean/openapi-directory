...
/*
 * OAIAnalytics_TestAudience_200_response.h
 *
 * Audience test result.
 */

#ifndef OAIAnalytics_TestAudience_200_response_H
#define OAIAnalytics_TestAudience_200_response_H
...
class OAIAnalytics_TestAudience_200_response : public OAIObject {
public:
    OAIAnalytics_TestAudience_200_response();
    OAIAnalytics_TestAudience_200_response(QString json);
    ~OAIAnalytics_TestAudience_200_response() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAnalytics_TestAudience_200_response)

#endif // OAIAnalytics_TestAudience_200_response_H
