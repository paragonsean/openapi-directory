...
#ifndef OAIErrorGroup_H
#define OAIErrorGroup_H
...
class OAIErrorGroup : public OAIObject {
public:
    OAIErrorGroup();
    OAIErrorGroup(QString json);
    ~OAIErrorGroup() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIErrorGroup)

#endif // OAIErrorGroup_H
