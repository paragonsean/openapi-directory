...
/*
 * OAIStartSessionLog.h
 *
 * Required explicit begin session log (a marker event for analytics service).
 */

#ifndef OAIStartSessionLog_H
#define OAIStartSessionLog_H
...
class OAIStartSessionLog : public OAIObject {
public:
    OAIStartSessionLog();
    OAIStartSessionLog(QString json);
    ~OAIStartSessionLog() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStartSessionLog)

#endif // OAIStartSessionLog_H
