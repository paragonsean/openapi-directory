...
/*
 * OAILogFlowEventLog.h
 *
 * Event log.
 */

#ifndef OAILogFlowEventLog_H
#define OAILogFlowEventLog_H
...
class OAILogFlowEventLog : public OAIObject {
public:
    OAILogFlowEventLog();
    OAILogFlowEventLog(QString json);
    ~OAILogFlowEventLog() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILogFlowEventLog)

#endif // OAILogFlowEventLog_H
