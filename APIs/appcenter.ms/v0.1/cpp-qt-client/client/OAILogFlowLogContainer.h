...
/*
 * OAILogFlowLogContainer.h
 *
 * 
 */

#ifndef OAILogFlowLogContainer_H
#define OAILogFlowLogContainer_H
...
class OAILogFlowLogContainer : public OAIObject {
public:
    OAILogFlowLogContainer();
    OAILogFlowLogContainer(QString json);
    ~OAILogFlowLogContainer() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILogFlowLogContainer)

#endif // OAILogFlowLogContainer_H
