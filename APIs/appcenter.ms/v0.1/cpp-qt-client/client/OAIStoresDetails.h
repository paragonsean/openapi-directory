...
#ifndef OAIStoresDetails_H
#define OAIStoresDetails_H
...
class OAIStoresDetails : public OAIObject {
public:
    OAIStoresDetails();
    OAIStoresDetails(QString json);
    ~OAIStoresDetails() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStoresDetails)

#endif // OAIStoresDetails_H
