...
/*
 * OAILogFlowErrorLog.h
 *
 * Error log.
 */

#ifndef OAILogFlowErrorLog_H
#define OAILogFlowErrorLog_H
...
class OAILogFlowErrorLog : public OAIObject {
public:
    OAILogFlowErrorLog();
    OAILogFlowErrorLog(QString json);
    ~OAILogFlowErrorLog() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILogFlowErrorLog)

#endif // OAILogFlowErrorLog_H
