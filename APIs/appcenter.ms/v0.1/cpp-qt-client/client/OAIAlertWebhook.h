...
#ifndef OAIAlertWebhook_H
#define OAIAlertWebhook_H
...
class OAIAlertWebhook : public OAIObject {
public:
    OAIAlertWebhook();
    OAIAlertWebhook(QString json);
    ~OAIAlertWebhook() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAlertWebhook)

#endif // OAIAlertWebhook_H
