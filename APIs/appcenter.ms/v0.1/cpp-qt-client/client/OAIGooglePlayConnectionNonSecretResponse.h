...
/*
 * OAIGooglePlayConnectionNonSecretResponse.h
 *
 * Google Play non-secret data
 */

#ifndef OAIGooglePlayConnectionNonSecretResponse_H
#define OAIGooglePlayConnectionNonSecretResponse_H
...
class OAIGooglePlayConnectionNonSecretResponse : public OAIObject {
public:
    OAIGooglePlayConnectionNonSecretResponse();
    OAIGooglePlayConnectionNonSecretResponse(QString json);
    ~OAIGooglePlayConnectionNonSecretResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGooglePlayConnectionNonSecretResponse)

#endif // OAIGooglePlayConnectionNonSecretResponse_H
