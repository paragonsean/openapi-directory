...
/*
 * OAIFilterReleasesContainer.h
 *
 * 
 */

#ifndef OAIFilterReleasesContainer_H
#define OAIFilterReleasesContainer_H
...
class OAIFilterReleasesContainer : public OAIObject {
public:
    OAIFilterReleasesContainer();
    OAIFilterReleasesContainer(QString json);
    ~OAIFilterReleasesContainer() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFilterReleasesContainer)

#endif // OAIFilterReleasesContainer_H
