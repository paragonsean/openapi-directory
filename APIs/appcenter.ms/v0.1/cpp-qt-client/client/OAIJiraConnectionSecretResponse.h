...
/*
 * OAIJiraConnectionSecretResponse.h
 *
 * Jira connection secrets
 */

#ifndef OAIJiraConnectionSecretResponse_H
#define OAIJiraConnectionSecretResponse_H
...
class OAIJiraConnectionSecretResponse : public OAIObject {
public:
    OAIJiraConnectionSecretResponse();
    OAIJiraConnectionSecretResponse(QString json);
    ~OAIJiraConnectionSecretResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIJiraConnectionSecretResponse)

#endif // OAIJiraConnectionSecretResponse_H
