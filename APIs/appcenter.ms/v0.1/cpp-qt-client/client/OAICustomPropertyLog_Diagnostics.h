...
/*
 * OAICustomPropertyLog_Diagnostics.h
 *
 * Set or remove custom properties.
 */

#ifndef OAICustomPropertyLog_Diagnostics_H
#define OAICustomPropertyLog_Diagnostics_H
...
class OAICustomPropertyLog_Diagnostics : public OAIObject {
public:
    OAICustomPropertyLog_Diagnostics();
    OAICustomPropertyLog_Diagnostics(QString json);
    ~OAICustomPropertyLog_Diagnostics() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICustomPropertyLog_Diagnostics)

#endif // OAICustomPropertyLog_Diagnostics_H
