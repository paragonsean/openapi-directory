...
/*
 * OAIDevices_list_200_response_inner.h
 *
 * The information for a single iOS device
 */

#ifndef OAIDevices_list_200_response_inner_H
#define OAIDevices_list_200_response_inner_H
...
class OAIDevices_list_200_response_inner : public OAIObject {
public:
    OAIDevices_list_200_response_inner();
    OAIDevices_list_200_response_inner(QString json);
    ~OAIDevices_list_200_response_inner() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDevices_list_200_response_inner)

#endif // OAIDevices_list_200_response_inner_H
