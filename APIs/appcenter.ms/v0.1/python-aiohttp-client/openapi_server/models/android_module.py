...
class AndroidModule(Model):
    ...
    def __init__(self, build_configurations: List[BuildsListToolsetProjects200ResponseAndroidAndroidModulesInnerBuildConfigurationsInner]=None, build_types: List[str]=None, build_variants: List[str]=None, has_bundle: bool=None, is_root: bool=None, name: str=None, product_flavors: List[str]=None):
        """AndroidModule - a model defined in OpenAPI

        :param build_configurations: The build_configurations of this AndroidModule.
        :param build_types: The build_types of this AndroidModule.
        :param build_variants: The build_variants of this AndroidModule.
        :param has_bundle: The has_bundle of this AndroidModule.
        :param is_root: The is_root of this AndroidModule.
        :param name: The name of this AndroidModule.
        :param product_flavors: The product_flavors of this AndroidModule.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'AndroidModule':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The AndroidModule of this AndroidModule.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def build_configurations(self):
        """Gets the build_configurations of this AndroidModule.

        The detected build configurations of the Android module

        :return: The build_configurations of this AndroidModule.
    ...
    def build_configurations(self, build_configurations):
        """Sets the build_configurations of this AndroidModule.
    ...
    def build_types(self):
        """Gets the build_types of this AndroidModule.

        The detected build types of the Android module

        :return: The build_types of this AndroidModule.
        :rtype: List[str]
        """
    ...
    @property
    def has_bundle(self):
        """Gets the has_bundle of this AndroidModule.

        Module contains bundle settings

        :return: The has_bundle of this AndroidModule.
        :rtype: bool
        """
    ...
    @property
    def is_root(self):
        """Gets the is_root of this AndroidModule.

        Whether the module is at the root level of the project

        :return: The is_root of this AndroidModule.
        :rtype: bool
        """
    ...
    @property
    def name(self):
        """Gets the name of this AndroidModule.

        Name of the Android module

        :return: The name of this AndroidModule.
        :rtype: str
        """
        return self._name
    ...
    def product_flavors(self):
        """Gets the product_flavors of this AndroidModule.

        The product flavors of the Android module

        :return: The product_flavors of this AndroidModule.
        :rtype: List[str]
        """
