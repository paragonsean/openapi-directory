...
class V2MissingSymbolCrashGroup(Model):
    ...
    def __init__(self, app_build: str=None, app_id: str=None, app_ver: str=None, crash_count: int=None, error_count: int=None, last_modified: datetime=None, missing_symbols: List[MissingSymbolGroupsList200ResponseGroupsInnerMissingSymbolsInner]=None, status: str=None, symbol_group_id: str=None):
        """V2MissingSymbolCrashGroup - a model defined in OpenAPI

        :param app_build: The app_build of this V2MissingSymbolCrashGroup.
        :param app_id: The app_id of this V2MissingSymbolCrashGroup.
        :param app_ver: The app_ver of this V2MissingSymbolCrashGroup.
        :param crash_count: The crash_count of this V2MissingSymbolCrashGroup.
        :param error_count: The error_count of this V2MissingSymbolCrashGroup.
        :param last_modified: The last_modified of this V2MissingSymbolCrashGroup.
        :param missing_symbols: The missing_symbols of this V2MissingSymbolCrashGroup.
        :param status: The status of this V2MissingSymbolCrashGroup.
        :param symbol_group_id: The symbol_group_id of this V2MissingSymbolCrashGroup.
        """
        self.openapi_types = {
            'app_build': str,
            'app_id': str,
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'V2MissingSymbolCrashGroup':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The v2MissingSymbolCrashGroup of this V2MissingSymbolCrashGroup.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def app_build(self):
        """Gets the app_build of this V2MissingSymbolCrashGroup.

        application build

        :return: The app_build of this V2MissingSymbolCrashGroup.
        :rtype: str
        """
    ...
    @property
    def app_id(self):
        """Gets the app_id of this V2MissingSymbolCrashGroup.

        application id

        :return: The app_id of this V2MissingSymbolCrashGroup.
        :rtype: str
        """
        return self._app_id
    ...
    @property
    def app_ver(self):
        """Gets the app_ver of this V2MissingSymbolCrashGroup.

        application version

        :return: The app_ver of this V2MissingSymbolCrashGroup.
        :rtype: str
        """
    ...
    def crash_count(self):
        """Gets the crash_count of this V2MissingSymbolCrashGroup.

        number of crashes that belong to this group

        :return: The crash_count of this V2MissingSymbolCrashGroup.
        :rtype: int
        """
    ...
    def error_count(self):
        """Gets the error_count of this V2MissingSymbolCrashGroup.

        number of errors that belong to this group

        :return: The error_count of this V2MissingSymbolCrashGroup.
        :rtype: int
        """
    ...
    def error_count(self, error_count):
        """Sets the error_count of this V2MissingSymbolCrashGroup.
    ...
    def last_modified(self):
        """Gets the last_modified of this V2MissingSymbolCrashGroup.

        last update date for the group

        :return: The last_modified of this V2MissingSymbolCrashGroup.
        :rtype: datetime
        """
    ...
    def missing_symbols(self):
        """Gets the missing_symbols of this V2MissingSymbolCrashGroup.

        list of missing symbols

        :return: The missing_symbols of this V2MissingSymbolCrashGroup.
    ...
    @property
    def status(self):
        """Gets the status of this V2MissingSymbolCrashGroup.

        group status

        :return: The status of this V2MissingSymbolCrashGroup.
        :rtype: str
        """
        return self._status
    ...
    def symbol_group_id(self):
        """Gets the symbol_group_id of this V2MissingSymbolCrashGroup.

        id of the symbol group

        :return: The symbol_group_id of this V2MissingSymbolCrashGroup.
        :rtype: str
        """
