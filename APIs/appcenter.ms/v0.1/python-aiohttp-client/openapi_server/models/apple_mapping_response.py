...
class AppleMappingResponse(Model):
    ...
    def __init__(self, app_id: str=None, apple_id: str=None, service_connection_id: str=None, team_identifier: str=None):
        """AppleMappingResponse - a model defined in OpenAPI

        :param app_id: The app_id of this AppleMappingResponse.
        :param apple_id: The apple_id of this AppleMappingResponse.
        :param service_connection_id: The service_connection_id of this AppleMappingResponse.
        :param team_identifier: The team_identifier of this AppleMappingResponse.
        """
        self.openapi_types = {
            'app_id': str,
            'apple_id': str,
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'AppleMappingResponse':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The AppleMappingResponse of this AppleMappingResponse.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def app_id(self):
        """Gets the app_id of this AppleMappingResponse.

        ID of the apple application in Mobile Center

        :return: The app_id of this AppleMappingResponse.
        :rtype: str
        """
        return self._app_id
    ...
    @property
    def apple_id(self):
        """Gets the apple_id of this AppleMappingResponse.

        ID of the apple application in apple store

        :return: The apple_id of this AppleMappingResponse.
        :rtype: str
        """
    ...
    def service_connection_id(self):
        """Gets the service_connection_id of this AppleMappingResponse.
        ...
        :return: The service_connection_id of this AppleMappingResponse.
        :rtype: str
        """
    ...
    def team_identifier(self):
        """Gets the team_identifier of this AppleMappingResponse.

        ID of the Team associated with the app in apple store

        :return: The team_identifier of this AppleMappingResponse.
        :rtype: str
        """
