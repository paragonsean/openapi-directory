...
class BuildsListToolsetProjects200ResponseXcode(Model):
    ...
    def __init__(self, xcode_scheme_containers: List[BuildsListToolsetProjects200ResponseXcodeXcodeSchemeContainersInner]=None):
        """BuildsListToolsetProjects200ResponseXcode - a model defined in OpenAPI

        :param xcode_scheme_containers: The xcode_scheme_containers of this BuildsListToolsetProjects200ResponseXcode.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'BuildsListToolsetProjects200ResponseXcode':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The builds_listToolsetProjects_200_response_xcode of this BuildsListToolsetProjects200ResponseXcode.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def xcode_scheme_containers(self):
        """Gets the xcode_scheme_containers of this BuildsListToolsetProjects200ResponseXcode.

        The Xcode scheme containers

        :return: The xcode_scheme_containers of this BuildsListToolsetProjects200ResponseXcode.
    ...
    def xcode_scheme_containers(self, xcode_scheme_containers):
        """Sets the xcode_scheme_containers of this BuildsListToolsetProjects200ResponseXcode.
