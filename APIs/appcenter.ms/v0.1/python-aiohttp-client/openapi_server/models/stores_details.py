...
class StoresDetails(Model):
    ...
    def __init__(self, id: str=None, is_latest: bool=None, name: str=None, publishing_status: str=None, type: str=None):
        """StoresDetails - a model defined in OpenAPI

        :param id: The id of this StoresDetails.
        :param is_latest: The is_latest of this StoresDetails.
        :param name: The name of this StoresDetails.
        :param publishing_status: The publishing_status of this StoresDetails.
        :param type: The type of this StoresDetails.
        """
        self.openapi_types = {
            'id': str,
            'is_latest': bool,
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'StoresDetails':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The StoresDetails of this StoresDetails.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def id(self):
        """Gets the id of this StoresDetails.

        ID identifying a unique distribution store.

        :return: The id of this StoresDetails.
        :rtype: str
        """
        return self._id
    ...
    @property
    def is_latest(self):
        """Gets the is_latest of this StoresDetails.

        Is the containing release the latest one in this distribution store.

        :return: The is_latest of this StoresDetails.
        :rtype: bool
        """
    ...
    @property
    def name(self):
        """Gets the name of this StoresDetails.

        A name identifying a unique distribution store.

        :return: The name of this StoresDetails.
        :rtype: str
        """
        return self._name
    ...
    def publishing_status(self):
        """Gets the publishing_status of this StoresDetails.

        A status identifying the status of release in the distribution store.

        :return: The publishing_status of this StoresDetails.
        :rtype: str
        """
    ...
    @property
    def type(self):
        """Gets the type of this StoresDetails.

        A type identifying the type of distribution store.

        :return: The type of this StoresDetails.
        :rtype: str
        """
        return self._type
