...
class AnalyticsGenericLogFlow200Response(Model):
    ...
    def __init__(self, exceeded_max_limit: bool=None, last_received_log_timestamp: datetime=None, logs: List[AnalyticsGenericLogFlow200ResponseLogsInner]=None):
        """AnalyticsGenericLogFlow200Response - a model defined in OpenAPI

        :param exceeded_max_limit: The exceeded_max_limit of this AnalyticsGenericLogFlow200Response.
        :param last_received_log_timestamp: The last_received_log_timestamp of this AnalyticsGenericLogFlow200Response.
        :param logs: The logs of this AnalyticsGenericLogFlow200Response.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'AnalyticsGenericLogFlow200Response':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The Analytics_GenericLogFlow_200_response of this AnalyticsGenericLogFlow200Response.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def exceeded_max_limit(self):
        """Gets the exceeded_max_limit of this AnalyticsGenericLogFlow200Response.

        indicates if the number of available logs are more than the max allowed return limit(100).

        :return: The exceeded_max_limit of this AnalyticsGenericLogFlow200Response.
        :rtype: bool
        """
    ...
    def exceeded_max_limit(self, exceeded_max_limit):
        """Sets the exceeded_max_limit of this AnalyticsGenericLogFlow200Response.
    ...
    def last_received_log_timestamp(self):
        """Gets the last_received_log_timestamp of this AnalyticsGenericLogFlow200Response.

        the timestamp of the last log received. This value can be used as the start time parameter in the consecutive API call.

        :return: The last_received_log_timestamp of this AnalyticsGenericLogFlow200Response.
        :rtype: datetime
        """
    ...
    def last_received_log_timestamp(self, last_received_log_timestamp):
        """Sets the last_received_log_timestamp of this AnalyticsGenericLogFlow200Response.
    ...
    @property
    def logs(self):
        """Gets the logs of this AnalyticsGenericLogFlow200Response.

        the list of logs

        :return: The logs of this AnalyticsGenericLogFlow200Response.
    ...
    @logs.setter
    def logs(self, logs):
        """Sets the logs of this AnalyticsGenericLogFlow200Response.
