...
class CustomProperty(Model):
    ...
    def __init__(self, name: str=None, type: str=None):
        ...
        :param type: The type of this CustomProperty.
        """
        self.openapi_types = {
            'name': str,
            'type': str
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'CustomProperty':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The CustomProperty of this CustomProperty.
        """
    ...
    @property
    def type(self):
        """Gets the type of this CustomProperty.


        :return: The type of this CustomProperty.
        :rtype: str
        """
        return self._type
