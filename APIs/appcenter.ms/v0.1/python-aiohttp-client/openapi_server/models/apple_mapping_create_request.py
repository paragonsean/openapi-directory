...
class AppleMappingCreateRequest(Model):
    ...
    def __init__(self, apple_id: str=None, bundle_identifier: str=None, service_connection_id: str=None, team_identifier: str=None):
        """AppleMappingCreateRequest - a model defined in OpenAPI

        :param apple_id: The apple_id of this AppleMappingCreateRequest.
        :param bundle_identifier: The bundle_identifier of this AppleMappingCreateRequest.
        :param service_connection_id: The service_connection_id of this AppleMappingCreateRequest.
        :param team_identifier: The team_identifier of this AppleMappingCreateRequest.
        """
        self.openapi_types = {
            'apple_id': str,
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'AppleMappingCreateRequest':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The appleMapping_create_request of this AppleMappingCreateRequest.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def apple_id(self):
        """Gets the apple_id of this AppleMappingCreateRequest.

        ID of the apple application in apple store, takes precedence over bundle_identifier when both are provided

        :return: The apple_id of this AppleMappingCreateRequest.
        :rtype: str
        """
    ...
    def apple_id(self, apple_id):
        """Sets the apple_id of this AppleMappingCreateRequest.
    ...
    def bundle_identifier(self):
        """Gets the bundle_identifier of this AppleMappingCreateRequest.

        Bundle Identifier of the apple package

        :return: The bundle_identifier of this AppleMappingCreateRequest.
        :rtype: str
        """
    ...
    def bundle_identifier(self, bundle_identifier):
        """Sets the bundle_identifier of this AppleMappingCreateRequest.
    ...
    def service_connection_id(self):
        """Gets the service_connection_id of this AppleMappingCreateRequest.
        ...
        :return: The service_connection_id of this AppleMappingCreateRequest.
        :rtype: str
        """
    ...
    def service_connection_id(self, service_connection_id):
        """Sets the service_connection_id of this AppleMappingCreateRequest.
    ...
    def team_identifier(self):
        """Gets the team_identifier of this AppleMappingCreateRequest.

        ID of the Team associated with the app in apple store

        :return: The team_identifier of this AppleMappingCreateRequest.
        :rtype: str
        """
    ...
    def team_identifier(self, team_identifier):
        """Sets the team_identifier of this AppleMappingCreateRequest.
