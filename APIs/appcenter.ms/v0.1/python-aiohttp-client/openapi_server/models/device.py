...
class Device(Model):
    ...
    def __init__(self, app_build: str=None, app_namespace: str=None, app_version: str=None, carrier_code: str=None, carrier_country: str=None, carrier_name: str=None, live_update_deployment_key: str=None, live_update_package_hash: str=None, live_update_release_label: str=None, locale: str=None, model: str=None, oem_name: str=None, os_api_level: int=None, os_build: str=None, os_name: str=None, os_version: str=None, screen_size: str=None, sdk_name: str=None, sdk_version: str=None, time_zone_offset: int=None, wrapper_runtime_version: str=None, wrapper_sdk_name: str=None, wrapper_sdk_version: str=None):
        ...
        :param app_build: The app_build of this Device.
        :param app_namespace: The app_namespace of this Device.
        :param app_version: The app_version of this Device.
        :param carrier_code: The carrier_code of this Device.
        :param carrier_country: The carrier_country of this Device.
        :param carrier_name: The carrier_name of this Device.
        :param live_update_deployment_key: The live_update_deployment_key of this Device.
        :param live_update_package_hash: The live_update_package_hash of this Device.
        :param live_update_release_label: The live_update_release_label of this Device.
        :param locale: The locale of this Device.
        :param model: The model of this Device.
        :param oem_name: The oem_name of this Device.
        :param os_api_level: The os_api_level of this Device.
        :param os_build: The os_build of this Device.
        :param os_name: The os_name of this Device.
        :param os_version: The os_version of this Device.
        :param screen_size: The screen_size of this Device.
        :param sdk_name: The sdk_name of this Device.
        :param sdk_version: The sdk_version of this Device.
        :param time_zone_offset: The time_zone_offset of this Device.
        :param wrapper_runtime_version: The wrapper_runtime_version of this Device.
        :param wrapper_sdk_name: The wrapper_sdk_name of this Device.
        :param wrapper_sdk_version: The wrapper_sdk_version of this Device.
        """
        self.openapi_types = {
            'app_build': str,
            'app_namespace': str,
    ...
    @property
    def app_build(self):
        """Gets the app_build of this Device.

        The app's build number, e.g. 42. 

        :return: The app_build of this Device.
        :rtype: str
        """
    ...
    def app_namespace(self):
        """Gets the app_namespace of this Device.
        ...
        :return: The app_namespace of this Device.
        :rtype: str
        """
    ...
    def carrier_code(self):
        """Gets the carrier_code of this Device.

        Carrier country code (for mobile devices). 

        :return: The carrier_code of this Device.
        :rtype: str
        """
    ...
    def carrier_country(self):
        """Gets the carrier_country of this Device.

        Carrier country. 

        :return: The carrier_country of this Device.
        :rtype: str
        """
    ...
    def carrier_name(self):
        """Gets the carrier_name of this Device.

        Carrier name (for mobile devices). 

        :return: The carrier_name of this Device.
        :rtype: str
        """
    ...
    def live_update_deployment_key(self):
        """Gets the live_update_deployment_key of this Device.

        Identifier of environment that current application release belongs to, deployment key then maps to environment like Production, Staging. 

        :return: The live_update_deployment_key of this Device.
        :rtype: str
        """
    ...
    def live_update_package_hash(self):
        """Gets the live_update_package_hash of this Device.
        ...
        :return: The live_update_package_hash of this Device.
        :rtype: str
        """
    ...
    def live_update_release_label(self):
        """Gets the live_update_release_label of this Device.

        Label that is used to identify application code 'version' released via Live Update beacon running on device 

        :return: The live_update_release_label of this Device.
        :rtype: str
        """
    ...
    @property
    def locale(self):
        """Gets the locale of this Device.

        Language code (example: en_US). 

        :return: The locale of this Device.
        :rtype: str
        """
        return self._locale
    ...
    @property
    def oem_name(self):
        """Gets the oem_name of this Device.

        Device manufacturer (example: HTC). 

        :return: The oem_name of this Device.
        :rtype: str
        """
    ...
    def os_api_level(self):
        """Gets the os_api_level of this Device.

        API level when applicable like in Android (example: 15). 

        :return: The os_api_level of this Device.
        :rtype: int
        """
    ...
    @property
    def os_build(self):
        """Gets the os_build of this Device.

        OS build code (example: LMY47X). 

        :return: The os_build of this Device.
        :rtype: str
        """
    ...
    def screen_size(self):
        """Gets the screen_size of this Device.

        Screen size of the device in pixels (example: 640x480). 

        :return: The screen_size of this Device.
        :rtype: str
        """
    ...
    def time_zone_offset(self):
        """Gets the time_zone_offset of this Device.

        The offset in minutes from UTC for the device time zone, including daylight savings time. 

        :return: The time_zone_offset of this Device.
        :rtype: int
        """
    ...
    def wrapper_runtime_version(self):
        """Gets the wrapper_runtime_version of this Device.
        ...
        :return: The wrapper_runtime_version of this Device.
        :rtype: str
        """
    ...
    def wrapper_sdk_version(self):
        """Gets the wrapper_sdk_version of this Device.
        ...
        :return: The wrapper_sdk_version of this Device.
        :rtype: str
        """
