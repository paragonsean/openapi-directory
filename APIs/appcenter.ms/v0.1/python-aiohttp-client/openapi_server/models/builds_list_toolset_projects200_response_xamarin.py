...
class BuildsListToolsetProjects200ResponseXamarin(Model):
    ...
    def __init__(self, xamarin_solutions: List[BuildsListToolsetProjects200ResponseXamarinXamarinSolutionsInner]=None):
        """BuildsListToolsetProjects200ResponseXamarin - a model defined in OpenAPI

        :param xamarin_solutions: The xamarin_solutions of this BuildsListToolsetProjects200ResponseXamarin.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'BuildsListToolsetProjects200ResponseXamarin':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The builds_listToolsetProjects_200_response_xamarin of this BuildsListToolsetProjects200ResponseXamarin.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def xamarin_solutions(self):
        """Gets the xamarin_solutions of this BuildsListToolsetProjects200ResponseXamarin.

        Xamarin solutions for the toolset

        :return: The xamarin_solutions of this BuildsListToolsetProjects200ResponseXamarin.
    ...
    def xamarin_solutions(self, xamarin_solutions):
        """Sets the xamarin_solutions of this BuildsListToolsetProjects200ResponseXamarin.
