...
class Destination(Model):
    ...
    def __init__(self, id: str=None, name: str=None, is_latest: bool=None, publishing_status: str=None, type: str=None, destination_type: str=None, display_name: str=None):
        ...
        :param is_latest: The is_latest of this Destination.
        :param publishing_status: The publishing_status of this Destination.
        :param type: The type of this Destination.
        :param destination_type: The destination_type of this Destination.
        :param display_name: The display_name of this Destination.
        """
        self.openapi_types = {
            'id': str,
            'name': str,
    ...
    @property
    def is_latest(self):
        """Gets the is_latest of this Destination.

        Is the containing release the latest one in this distribution store.

        :return: The is_latest of this Destination.
        :rtype: bool
        """
    ...
    def publishing_status(self):
        """Gets the publishing_status of this Destination.

        publishing status of the release in the store.

        :return: The publishing_status of this Destination.
        :rtype: str
        """
    ...
    def publishing_status(self, publishing_status):
        """Sets the publishing_status of this Destination.
    ...
    def display_name(self):
        """Gets the display_name of this Destination.

        Display name for the group or tester

        :return: The display_name of this Destination.
        :rtype: str
        """
