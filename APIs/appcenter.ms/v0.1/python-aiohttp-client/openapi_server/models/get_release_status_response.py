...
class GetReleaseStatusResponse(Model):
    ...
    def __init__(self, error_details: str=None, id: str=None, release_distinct_id: float=None, release_url: object=None, upload_status: str=None):
        """GetReleaseStatusResponse - a model defined in OpenAPI

        :param error_details: The error_details of this GetReleaseStatusResponse.
        :param id: The id of this GetReleaseStatusResponse.
        :param release_distinct_id: The release_distinct_id of this GetReleaseStatusResponse.
        :param release_url: The release_url of this GetReleaseStatusResponse.
        :param upload_status: The upload_status of this GetReleaseStatusResponse.
        """
        self.openapi_types = {
            'error_details': str,
            'id': str,
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'GetReleaseStatusResponse':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The GetReleaseStatusResponse of this GetReleaseStatusResponse.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def error_details(self):
        """Gets the error_details of this GetReleaseStatusResponse.

        Details describing what went wrong processing the upload. Will only be set if status = 'error'.

        :return: The error_details of this GetReleaseStatusResponse.
        :rtype: str
        """
    ...
    @property
    def id(self):
        """Gets the id of this GetReleaseStatusResponse.

        The ID for the upload.

        :return: The id of this GetReleaseStatusResponse.
        :rtype: str
        """
        return self._id
    ...
    def release_distinct_id(self):
        """Gets the release_distinct_id of this GetReleaseStatusResponse.

        The distinct ID of the release. Will only be set when the status = 'readyToBePublished'.

        :return: The release_distinct_id of this GetReleaseStatusResponse.
        :rtype: float
        """
    ...
    def release_url(self):
        """Gets the release_url of this GetReleaseStatusResponse.

        The URL of the release. Will only be set when the status = 'readyToBePublished'.

        :return: The release_url of this GetReleaseStatusResponse.
        :rtype: object
        """
    ...
    def upload_status(self):
        """Gets the upload_status of this GetReleaseStatusResponse.

        The current upload status.

        :return: The upload_status of this GetReleaseStatusResponse.
        :rtype: str
        """
