...
class AlertWebhook(Model):
    ...
    def __init__(self, enabled: bool=None, event_types: List[str]=None, id: str=None, name: str=None, url: str=None):
        """AlertWebhook - a model defined in OpenAPI

        :param enabled: The enabled of this AlertWebhook.
        :param event_types: The event_types of this AlertWebhook.
        :param id: The id of this AlertWebhook.
        :param name: The name of this AlertWebhook.
        :param url: The url of this AlertWebhook.
        """
        self.openapi_types = {
            'enabled': bool,
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'AlertWebhook':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The AlertWebhook of this AlertWebhook.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def enabled(self):
        """Gets the enabled of this AlertWebhook.

        Allows eanble/disable webhook

        :return: The enabled of this AlertWebhook.
        :rtype: bool
        """
    ...
    def event_types(self):
        """Gets the event_types of this AlertWebhook.

        Event types enabled for webhook

        :return: The event_types of this AlertWebhook.
        :rtype: List[str]
        """
    ...
    @property
    def id(self):
        """Gets the id of this AlertWebhook.

        The unique id (UUID) of the webhook

        :return: The id of this AlertWebhook.
        :rtype: str
        """
        return self._id
    ...
    @property
    def name(self):
        """Gets the name of this AlertWebhook.

        display name of the webhook

        :return: The name of this AlertWebhook.
        :rtype: str
        """
        return self._name
    ...
    @property
    def url(self):
        """Gets the url of this AlertWebhook.

        target url of the webhook

        :return: The url of this AlertWebhook.
        :rtype: str
        """
        return self._url
