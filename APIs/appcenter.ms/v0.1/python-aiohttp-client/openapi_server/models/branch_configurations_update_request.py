...
class BranchConfigurationsUpdateRequest(Model):
    ...
    def __init__(self, artifact_versioning: BranchConfigurationsGet200ResponseAllOfArtifactVersioning=None, badge_is_enabled: bool=None, clone_from_branch: str=None, signed: bool=None, tests_enabled: bool=None, toolsets: BranchConfigurationsGet200ResponseAllOfToolsets=None, trigger: str=None):
        """BranchConfigurationsUpdateRequest - a model defined in OpenAPI

        :param artifact_versioning: The artifact_versioning of this BranchConfigurationsUpdateRequest.
        :param badge_is_enabled: The badge_is_enabled of this BranchConfigurationsUpdateRequest.
        :param clone_from_branch: The clone_from_branch of this BranchConfigurationsUpdateRequest.
        :param signed: The signed of this BranchConfigurationsUpdateRequest.
        :param tests_enabled: The tests_enabled of this BranchConfigurationsUpdateRequest.
        :param toolsets: The toolsets of this BranchConfigurationsUpdateRequest.
        :param trigger: The trigger of this BranchConfigurationsUpdateRequest.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'BranchConfigurationsUpdateRequest':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The branchConfigurations_update_request of this BranchConfigurationsUpdateRequest.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def artifact_versioning(self):
        """Gets the artifact_versioning of this BranchConfigurationsUpdateRequest.


        :return: The artifact_versioning of this BranchConfigurationsUpdateRequest.
    ...
    def artifact_versioning(self, artifact_versioning):
        """Sets the artifact_versioning of this BranchConfigurationsUpdateRequest.
    ...
    def badge_is_enabled(self):
        """Gets the badge_is_enabled of this BranchConfigurationsUpdateRequest.


        :return: The badge_is_enabled of this BranchConfigurationsUpdateRequest.
        :rtype: bool
        """
    ...
    def badge_is_enabled(self, badge_is_enabled):
        """Sets the badge_is_enabled of this BranchConfigurationsUpdateRequest.
    ...
    def clone_from_branch(self):
        """Gets the clone_from_branch of this BranchConfigurationsUpdateRequest.

        A configured branch name to clone from. If provided, all other parameters will be ignored. Only supported in POST requests.

        :return: The clone_from_branch of this BranchConfigurationsUpdateRequest.
        :rtype: str
        """
    ...
    def clone_from_branch(self, clone_from_branch):
        """Sets the clone_from_branch of this BranchConfigurationsUpdateRequest.
    ...
    @property
    def signed(self):
        """Gets the signed of this BranchConfigurationsUpdateRequest.


        :return: The signed of this BranchConfigurationsUpdateRequest.
        :rtype: bool
        """
        return self._signed
    ...
    def signed(self, signed):
        """Sets the signed of this BranchConfigurationsUpdateRequest.
    ...
    def tests_enabled(self):
        """Gets the tests_enabled of this BranchConfigurationsUpdateRequest.


        :return: The tests_enabled of this BranchConfigurationsUpdateRequest.
        :rtype: bool
        """
    ...
    def tests_enabled(self, tests_enabled):
        """Sets the tests_enabled of this BranchConfigurationsUpdateRequest.
    ...
    @property
    def toolsets(self):
        """Gets the toolsets of this BranchConfigurationsUpdateRequest.


        :return: The toolsets of this BranchConfigurationsUpdateRequest.
    ...
    def toolsets(self, toolsets):
        """Sets the toolsets of this BranchConfigurationsUpdateRequest.
    ...
    @property
    def trigger(self):
        """Gets the trigger of this BranchConfigurationsUpdateRequest.


        :return: The trigger of this BranchConfigurationsUpdateRequest.
        :rtype: str
        """
    ...
    def trigger(self, trigger):
        """Sets the trigger of this BranchConfigurationsUpdateRequest.
