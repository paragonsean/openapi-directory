...
class XcodeSchemeContainer(Model):
    ...
    def __init__(self, app_extension_targets: List[BuildsListToolsetProjects200ResponseXcodeXcodeSchemeContainersInnerAppExtensionTargetsInner]=None, cartfile_path: str=None, path: str=None, podfile_path: str=None, shared_schemes: List[BuildsListToolsetProjects200ResponseXcodeXcodeSchemeContainersInnerSharedSchemesInner]=None, workspace_project_paths: str=None, xcode_project_sha: str=None):
        """XcodeSchemeContainer - a model defined in OpenAPI

        :param app_extension_targets: The app_extension_targets of this XcodeSchemeContainer.
        :param cartfile_path: The cartfile_path of this XcodeSchemeContainer.
        :param path: The path of this XcodeSchemeContainer.
        :param podfile_path: The podfile_path of this XcodeSchemeContainer.
        :param shared_schemes: The shared_schemes of this XcodeSchemeContainer.
        :param workspace_project_paths: The workspace_project_paths of this XcodeSchemeContainer.
        :param xcode_project_sha: The xcode_project_sha of this XcodeSchemeContainer.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'XcodeSchemeContainer':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The XcodeSchemeContainer of this XcodeSchemeContainer.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def app_extension_targets(self):
        """Gets the app_extension_targets of this XcodeSchemeContainer.

        Information regarding project app extensions, if present

        :return: The app_extension_targets of this XcodeSchemeContainer.
    ...
    def cartfile_path(self):
        """Gets the cartfile_path of this XcodeSchemeContainer.

        Path to Carthage file, if present

        :return: The cartfile_path of this XcodeSchemeContainer.
        :rtype: str
        """
    ...
    @property
    def path(self):
        """Gets the path of this XcodeSchemeContainer.

        Path to project

        :return: The path of this XcodeSchemeContainer.
        :rtype: str
        """
        return self._path
    ...
    def podfile_path(self):
        """Gets the podfile_path of this XcodeSchemeContainer.

        Path to CocoaPods file, if present

        :return: The podfile_path of this XcodeSchemeContainer.
        :rtype: str
        """
    ...
    def shared_schemes(self):
        """Gets the shared_schemes of this XcodeSchemeContainer.

        Project schemes

        :return: The shared_schemes of this XcodeSchemeContainer.
    ...
    def workspace_project_paths(self):
        """Gets the workspace_project_paths of this XcodeSchemeContainer.

        Related projects paths for xcworkspace

        :return: The workspace_project_paths of this XcodeSchemeContainer.
        :rtype: str
        """
    ...
    def xcode_project_sha(self):
        """Gets the xcode_project_sha of this XcodeSchemeContainer.

        repo object Id of the pbxproject

        :return: The xcode_project_sha of this XcodeSchemeContainer.
        :rtype: str
        """
