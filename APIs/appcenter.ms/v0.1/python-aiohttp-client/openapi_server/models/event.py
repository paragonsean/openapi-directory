...
class Event(Model):
    ...
    def __init__(self, count: int=None, count_per_device: float=None, count_per_session: float=None, device_count: int=None, id: str=None, name: str=None, previous_count: int=None, previous_device_count: int=None):
        ...
        :param count_per_device: The count_per_device of this Event.
        :param count_per_session: The count_per_session of this Event.
        :param device_count: The device_count of this Event.
        :param id: The id of this Event.
        :param name: The name of this Event.
        :param previous_count: The previous_count of this Event.
        :param previous_device_count: The previous_device_count of this Event.
        """
        self.openapi_types = {
            'count': int,
    ...
    def count_per_device(self):
        """Gets the count_per_device of this Event.


        :return: The count_per_device of this Event.
        :rtype: float
        """
    ...
    def count_per_session(self):
        """Gets the count_per_session of this Event.


        :return: The count_per_session of this Event.
        :rtype: float
        """
    ...
    def device_count(self):
        """Gets the device_count of this Event.


        :return: The device_count of this Event.
        :rtype: int
        """
    ...
    def previous_count(self):
        """Gets the previous_count of this Event.

        The event count of previous time range of the event.

        :return: The previous_count of this Event.
        :rtype: int
        """
    ...
    def previous_device_count(self):
        """Gets the previous_device_count of this Event.

        The device count of previous time range of the event.

        :return: The previous_device_count of this Event.
        :rtype: int
        """
