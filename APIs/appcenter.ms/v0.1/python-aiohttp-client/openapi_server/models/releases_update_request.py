...
class ReleasesUpdateRequest(Model):
    ...
    def __init__(self, build: ReleasesGetLatestByDistributionGroup200ResponseBuild=None, destination_id: str=None, destination_name: str=None, destination_type: str=None, destinations: List[ReleasesUpdateRequestDestinationsInner]=None, distribution_group_id: str=None, distribution_group_name: str=None, mandatory_update: bool=None, metadata: ReleasesUpdateRequestMetadata=None, notify_testers: bool=True, release_notes: str=None):
        """ReleasesUpdateRequest - a model defined in OpenAPI

        :param build: The build of this ReleasesUpdateRequest.
        :param destination_id: The destination_id of this ReleasesUpdateRequest.
        :param destination_name: The destination_name of this ReleasesUpdateRequest.
        :param destination_type: The destination_type of this ReleasesUpdateRequest.
        :param destinations: The destinations of this ReleasesUpdateRequest.
        :param distribution_group_id: The distribution_group_id of this ReleasesUpdateRequest.
        :param distribution_group_name: The distribution_group_name of this ReleasesUpdateRequest.
        :param mandatory_update: The mandatory_update of this ReleasesUpdateRequest.
        :param metadata: The metadata of this ReleasesUpdateRequest.
        :param notify_testers: The notify_testers of this ReleasesUpdateRequest.
        :param release_notes: The release_notes of this ReleasesUpdateRequest.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'ReleasesUpdateRequest':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The releases_update_request of this ReleasesUpdateRequest.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def build(self):
        """Gets the build of this ReleasesUpdateRequest.


        :return: The build of this ReleasesUpdateRequest.
    ...
    def build(self, build):
        """Sets the build of this ReleasesUpdateRequest.
    ...
    def destination_id(self):
        """Gets the destination_id of this ReleasesUpdateRequest.
        ...
        :return: The destination_id of this ReleasesUpdateRequest.
        :rtype: str
        """
    ...
    def destination_id(self, destination_id):
        """Sets the destination_id of this ReleasesUpdateRequest.
    ...
    def destination_name(self):
        """Gets the destination_name of this ReleasesUpdateRequest.
        ...
        :return: The destination_name of this ReleasesUpdateRequest.
        :rtype: str
        """
    ...
    def destination_name(self, destination_name):
        """Sets the destination_name of this ReleasesUpdateRequest.
    ...
    def destination_type(self):
        """Gets the destination_type of this ReleasesUpdateRequest.

        Not used anymore.

        :return: The destination_type of this ReleasesUpdateRequest.
        :rtype: str
        """
    ...
    def destination_type(self, destination_type):
        """Sets the destination_type of this ReleasesUpdateRequest.
    ...
    def destinations(self):
        """Gets the destinations of this ReleasesUpdateRequest.

        Distribute this release under the following list of destinations (store groups or distribution groups).

        :return: The destinations of this ReleasesUpdateRequest.
    ...
    def destinations(self, destinations):
        """Sets the destinations of this ReleasesUpdateRequest.
    ...
    def distribution_group_id(self):
        """Gets the distribution_group_id of this ReleasesUpdateRequest.
        ...
        :return: The distribution_group_id of this ReleasesUpdateRequest.
        :rtype: str
        """
    ...
    def distribution_group_id(self, distribution_group_id):
        """Sets the distribution_group_id of this ReleasesUpdateRequest.
    ...
    def distribution_group_name(self):
        """Gets the distribution_group_name of this ReleasesUpdateRequest.
        ...
        :return: The distribution_group_name of this ReleasesUpdateRequest.
        :rtype: str
        """
    ...
    def distribution_group_name(self, distribution_group_name):
        """Sets the distribution_group_name of this ReleasesUpdateRequest.
    ...
    def mandatory_update(self):
        """Gets the mandatory_update of this ReleasesUpdateRequest.

        A boolean which determines whether this version should be a mandatory update or not.

        :return: The mandatory_update of this ReleasesUpdateRequest.
        :rtype: bool
        """
    ...
    def mandatory_update(self, mandatory_update):
        """Sets the mandatory_update of this ReleasesUpdateRequest.
    ...
    @property
    def metadata(self):
        """Gets the metadata of this ReleasesUpdateRequest.


        :return: The metadata of this ReleasesUpdateRequest.
    ...
    def metadata(self, metadata):
        """Sets the metadata of this ReleasesUpdateRequest.
    ...
    def notify_testers(self):
        """Gets the notify_testers of this ReleasesUpdateRequest.

        A boolean which determines whether to notify testers of a new release, default to true.

        :return: The notify_testers of this ReleasesUpdateRequest.
        :rtype: bool
        """
    ...
    def notify_testers(self, notify_testers):
        """Sets the notify_testers of this ReleasesUpdateRequest.
    ...
    def release_notes(self):
        """Gets the release_notes of this ReleasesUpdateRequest.

        Release notes for this release.

        :return: The release_notes of this ReleasesUpdateRequest.
        :rtype: str
        """
    ...
    def release_notes(self, release_notes):
        """Sets the release_notes of this ReleasesUpdateRequest.
