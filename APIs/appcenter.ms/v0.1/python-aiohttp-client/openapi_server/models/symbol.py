...
class Symbol(Model):
    ...
    def __init__(self, alternate_symbol_ids: List[str]=None, app_id: str=None, build: str=None, origin: str=None, platform: str=None, status: str=None, symbol_id: str=None, symbol_upload_id: str=None, type: str=None, url: str=None, version: str=None):
        ...
        :param alternate_symbol_ids: The alternate_symbol_ids of this Symbol.
        :param app_id: The app_id of this Symbol.
        :param build: The build of this Symbol.
        :param origin: The origin of this Symbol.
        :param platform: The platform of this Symbol.
        :param status: The status of this Symbol.
        :param symbol_id: The symbol_id of this Symbol.
        :param symbol_upload_id: The symbol_upload_id of this Symbol.
        :param type: The type of this Symbol.
        :param url: The url of this Symbol.
        :param version: The version of this Symbol.
        """
        self.openapi_types = {
    ...
    def alternate_symbol_ids(self):
        """Gets the alternate_symbol_ids of this Symbol.

        The other symbols in the same file

        :return: The alternate_symbol_ids of this Symbol.
        :rtype: List[str]
        """
    ...
    @property
    def app_id(self):
        """Gets the app_id of this Symbol.

        The application that this symbol belongs to

        :return: The app_id of this Symbol.
        :rtype: str
        """
        return self._app_id
    ...
    @property
    def build(self):
        """Gets the build of this Symbol.

        The build number. Optional for Apple. Required for Android.

        :return: The build of this Symbol.
        :rtype: str
        """
        return self._build
    ...
    @property
    def origin(self):
        """Gets the origin of this Symbol.
    ...
    @property
    def platform(self):
        """Gets the platform of this Symbol.

        The platform that this symbol is associated with

        :return: The platform of this Symbol.
        :rtype: str
        """
    ...
    @property
    def status(self):
        """Gets the status of this Symbol.
    ...
    @property
    def symbol_id(self):
        """Gets the symbol_id of this Symbol.

        The unique id for this symbol (uuid)

        :return: The symbol_id of this Symbol.
        :rtype: str
        """
    ...
    def symbol_upload_id(self):
        """Gets the symbol_upload_id of this Symbol.

        The id of the symbol upload this symbol belongs to.

        :return: The symbol_upload_id of this Symbol.
        :rtype: str
        """
    ...
    @property
    def url(self):
        """Gets the url of this Symbol.

        The path name of the symbol file in blob storage

        :return: The url of this Symbol.
        :rtype: str
        """
        return self._url
    ...
    def version(self):
        ...
        :return: The version of this Symbol.
        :rtype: str
        """
