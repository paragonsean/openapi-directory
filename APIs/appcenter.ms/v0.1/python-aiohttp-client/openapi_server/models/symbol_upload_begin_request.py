...
class SymbolUploadBeginRequest(Model):
    ...
    def __init__(self, build: str=None, client_callback: str=None, file_name: str=None, symbol_type: str=None, version: str=None):
        """SymbolUploadBeginRequest - a model defined in OpenAPI

        :param build: The build of this SymbolUploadBeginRequest.
        :param client_callback: The client_callback of this SymbolUploadBeginRequest.
        :param file_name: The file_name of this SymbolUploadBeginRequest.
        :param symbol_type: The symbol_type of this SymbolUploadBeginRequest.
        :param version: The version of this SymbolUploadBeginRequest.
        """
        self.openapi_types = {
            'build': str,
            'client_callback': str,
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'SymbolUploadBeginRequest':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The SymbolUploadBeginRequest of this SymbolUploadBeginRequest.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def build(self):
        """Gets the build of this SymbolUploadBeginRequest.

        The build number. Optional for Apple. Required for Android.

        :return: The build of this SymbolUploadBeginRequest.
        :rtype: str
        """
        return self._build
    ...
    def client_callback(self):
        """Gets the client_callback of this SymbolUploadBeginRequest.

        The callback URL that the client can optionally provide to get status updates for the current symbol upload

        :return: The client_callback of this SymbolUploadBeginRequest.
        :rtype: str
        """
    ...
    @property
    def file_name(self):
        """Gets the file_name of this SymbolUploadBeginRequest.

        The file name for the symbol upload

        :return: The file_name of this SymbolUploadBeginRequest.
        :rtype: str
        """
    ...
    def symbol_type(self):
        """Gets the symbol_type of this SymbolUploadBeginRequest.

        The type of the symbol for the current symbol upload

        :return: The symbol_type of this SymbolUploadBeginRequest.
        :rtype: str
        """
    ...
    @property
    def version(self):
        """Gets the version of this SymbolUploadBeginRequest.

        The version number. Optional for Apple. Required for Android.

        :return: The version of this SymbolUploadBeginRequest.
        :rtype: str
        """
