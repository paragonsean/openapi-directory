...
bng2latlong
- API version: 1.0
  - Build date: 2024-10-12T11:25:14.326781-04:00[America/New_York]
...
------------ | ------------- | ------------- | -------------
*DefaultApi* | [**bng2latlongEastingNorthingGet**](docs/DefaultApi.md#bng2latlongEastingNorthingGet) | **GET** /bng2latlong/{easting}/{northing} | Returns latitude and longitude for the given easting and northing.


## Documentation for Models

 - [Bng2latlongEastingNorthingGet200Response](docs/Bng2latlongEastingNorthingGet200Response.md)
