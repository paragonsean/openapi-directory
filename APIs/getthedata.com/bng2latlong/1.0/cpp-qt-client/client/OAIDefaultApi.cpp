...
void OAIDefaultApi::initializeServerConfigs() {
    ...
    QUrl("https://api.getthedata.com"),
    "No description provided",
    QMap<QString, OAIServerVariable>()));
    _serverConfigs.insert("bng2latlongEastingNorthingGet", defaultConf);
    _serverIndices.insert("bng2latlongEastingNorthingGet", 0);
}
...
void OAIDefaultApi::bng2latlongEastingNorthingGet(const qint32 &easting, const qint32 &northing) {
    QString fullPath = QString(_serverConfigs["bng2latlongEastingNorthingGet"][_serverIndices.value("bng2latlongEastingNorthingGet")].URL()+"/bng2latlong/{easting}/{northing}");
    
    
    {
        QString eastingPathParam("{");
        eastingPathParam.append("easting").append("}");
        ...
        pathDelimiter = getParamStyleDelimiter(pathStyle, "easting", false);
        QString paramString = (pathStyle == "matrix") ? pathPrefix+"easting"+pathSuffix : pathPrefix;
        fullPath.replace(eastingPathParam, paramString+QUrl::toPercentEncoding(::OpenAPI::toStringValue(easting)));
    }
    
    {
        QString northingPathParam("{");
        northingPathParam.append("northing").append("}");
        QString pathPrefix, pathSuffix, pathDelimiter;
        QString pathStyle = "simple";
        if (pathStyle == "")
            pathStyle = "simple";
        pathPrefix = getParamStylePrefix(pathStyle);
        pathSuffix = getParamStyleSuffix(pathStyle);
        pathDelimiter = getParamStyleDelimiter(pathStyle, "northing", false);
        QString paramString = (pathStyle == "matrix") ? pathPrefix+"northing"+pathSuffix : pathPrefix;
        fullPath.replace(northingPathParam, paramString+QUrl::toPercentEncoding(::OpenAPI::toStringValue(northing)));
    }
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIDefaultApi::bng2latlongEastingNorthingGetCallback);
...
void OAIDefaultApi::bng2latlongEastingNorthingGetCallback(OAIHttpRequestWorker *worker) {
    ...
    OAI_bng2latlong__easting___northing__get_200_response output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT bng2latlongEastingNorthingGetSignal(output);
        Q_EMIT bng2latlongEastingNorthingGetSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT bng2latlongEastingNorthingGetSignalE(output, error_type, error_str);
        Q_EMIT bng2latlongEastingNorthingGetSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT bng2latlongEastingNorthingGetSignalError(output, error_type, error_str);
        Q_EMIT bng2latlongEastingNorthingGetSignalErrorFull(worker, error_type, error_str);
    }
}
