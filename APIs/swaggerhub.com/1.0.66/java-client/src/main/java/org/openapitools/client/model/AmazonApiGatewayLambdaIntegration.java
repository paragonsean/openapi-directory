...
public class AmazonApiGatewayLambdaIntegration {
   ...
   */
  @JsonAdapter(RuntimeLanguageEnum.Adapter.class)
  public enum RuntimeLanguageEnum {
    PYTHON3_8("python3.8"),
    ...
    RuntimeLanguageEnum(String value) {
      this.value = value;
    }
    ...
    public static RuntimeLanguageEnum fromValue(String value) {
      for (RuntimeLanguageEnum b : RuntimeLanguageEnum.values()) {
        if (b.value.equals(value)) {
          return b;
        }
      }
    ...
    public static class Adapter extends TypeAdapter<RuntimeLanguageEnum> {
      @Override
      public void write(final JsonWriter jsonWriter, final RuntimeLanguageEnum enumeration) throws IOException {
        jsonWriter.value(enumeration.getValue());
      }

      @Override
      public RuntimeLanguageEnum read(final JsonReader jsonReader) throws IOException {
        String value =  jsonReader.nextString();
        return RuntimeLanguageEnum.fromValue(value);
      }
    }

    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      String value = jsonElement.getAsString();
      RuntimeLanguageEnum.fromValue(value);
    }
  }

  public static final String SERIALIZED_NAME_RUNTIME_LANGUAGE = "runtimeLanguage";
  @SerializedName(SERIALIZED_NAME_RUNTIME_LANGUAGE)
  private RuntimeLanguageEnum runtimeLanguage = RuntimeLanguageEnum.NODEJS12_X;

  public AmazonApiGatewayLambdaIntegration() {
  }
  ...
  public AmazonApiGatewayLambdaIntegration enabled(Boolean enabled) {
  ...
  public AmazonApiGatewayLambdaIntegration name(String name) {
    this.name = name;
    return this;
  }
  ...
  public AmazonApiGatewayLambdaIntegration accessKey(String accessKey) {
  ...
  public AmazonApiGatewayLambdaIntegration apiId(String apiId) {
    this.apiId = apiId;
    return this;
  }
  ...
  public AmazonApiGatewayLambdaIntegration basePathMode(BasePathModeEnum basePathMode) {
  ...
  public AmazonApiGatewayLambdaIntegration deploymentMode(DeploymentModeEnum deploymentMode) {
  ...
  public AmazonApiGatewayLambdaIntegration publishMode(PublishModeEnum publishMode) {
  ...
  public AmazonApiGatewayLambdaIntegration region(RegionEnum region) {
    this.region = region;
    return this;
  }
  ...
  public AmazonApiGatewayLambdaIntegration secretKey(String secretKey) {
  ...
  public AmazonApiGatewayLambdaIntegration updateDefinition(Boolean updateDefinition) {
  ...
  public AmazonApiGatewayLambdaIntegration configType(ConfigTypeEnum configType) {
  ...
  public AmazonApiGatewayLambdaIntegration lambdaRole(String lambdaRole) {
  ...
  public AmazonApiGatewayLambdaIntegration runtimeLanguage(RuntimeLanguageEnum runtimeLanguage) {
   ...
   */
  @javax.annotation.Nullable
  public RuntimeLanguageEnum getRuntimeLanguage() {
    return runtimeLanguage;
  }

  public void setRuntimeLanguage(RuntimeLanguageEnum runtimeLanguage) {
    this.runtimeLanguage = runtimeLanguage;
  }
  ...
  public boolean equals(Object o) {
    ...
    AmazonApiGatewayLambdaIntegration amazonApiGatewayLambdaIntegration = (AmazonApiGatewayLambdaIntegration) o;
    return Objects.equals(this.enabled, amazonApiGatewayLambdaIntegration.enabled) &&
        Objects.equals(this.id, amazonApiGatewayLambdaIntegration.id) &&
        Objects.equals(this.name, amazonApiGatewayLambdaIntegration.name) &&
        Objects.equals(this.accessKey, amazonApiGatewayLambdaIntegration.accessKey) &&
        Objects.equals(this.apiId, amazonApiGatewayLambdaIntegration.apiId) &&
        Objects.equals(this.basePathMode, amazonApiGatewayLambdaIntegration.basePathMode) &&
        Objects.equals(this.deploymentMode, amazonApiGatewayLambdaIntegration.deploymentMode) &&
        Objects.equals(this.publishMode, amazonApiGatewayLambdaIntegration.publishMode) &&
        Objects.equals(this.region, amazonApiGatewayLambdaIntegration.region) &&
        Objects.equals(this.secretKey, amazonApiGatewayLambdaIntegration.secretKey) &&
        Objects.equals(this.updateDefinition, amazonApiGatewayLambdaIntegration.updateDefinition) &&
        Objects.equals(this.configType, amazonApiGatewayLambdaIntegration.configType) &&
        Objects.equals(this.lambdaRole, amazonApiGatewayLambdaIntegration.lambdaRole) &&
        Objects.equals(this.runtimeLanguage, amazonApiGatewayLambdaIntegration.runtimeLanguage);
  }

  @Override
  public int hashCode() {
    return Objects.hash(enabled, id, name, accessKey, apiId, basePathMode, deploymentMode, publishMode, region, secretKey, updateDefinition, configType, lambdaRole, runtimeLanguage);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AmazonApiGatewayLambdaIntegration {\n");
    ...
    sb.append("    runtimeLanguage: ").append(toIndentedString(runtimeLanguage)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("runtimeLanguage");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AmazonApiGatewayLambdaIntegration
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AmazonApiGatewayLambdaIntegration.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AmazonApiGatewayLambdaIntegration is not found in the empty JSON string", AmazonApiGatewayLambdaIntegration.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AmazonApiGatewayLambdaIntegration.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AmazonApiGatewayLambdaIntegration` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AmazonApiGatewayLambdaIntegration.openapiRequiredFields) {
      ...
      if ((jsonObj.get("lambdaRole") != null && !jsonObj.get("lambdaRole").isJsonNull()) && !jsonObj.get("lambdaRole").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `lambdaRole` to be a primitive type in the JSON string but got `%s`", jsonObj.get("lambdaRole").toString()));
      }
      if ((jsonObj.get("runtimeLanguage") != null && !jsonObj.get("runtimeLanguage").isJsonNull()) && !jsonObj.get("runtimeLanguage").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `runtimeLanguage` to be a primitive type in the JSON string but got `%s`", jsonObj.get("runtimeLanguage").toString()));
      }
      // validate the optional field `runtimeLanguage`
      if (jsonObj.get("runtimeLanguage") != null && !jsonObj.get("runtimeLanguage").isJsonNull()) {
        RuntimeLanguageEnum.validateJsonElement(jsonObj.get("runtimeLanguage"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AmazonApiGatewayLambdaIntegration.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AmazonApiGatewayLambdaIntegration' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AmazonApiGatewayLambdaIntegration> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AmazonApiGatewayLambdaIntegration.class));

       return (TypeAdapter<T>) new TypeAdapter<AmazonApiGatewayLambdaIntegration>() {
           @Override
           public void write(JsonWriter out, AmazonApiGatewayLambdaIntegration value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AmazonApiGatewayLambdaIntegration read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AmazonApiGatewayLambdaIntegration given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AmazonApiGatewayLambdaIntegration
   * @throws IOException if the JSON string is invalid with respect to AmazonApiGatewayLambdaIntegration
   */
  public static AmazonApiGatewayLambdaIntegration fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AmazonApiGatewayLambdaIntegration.class);
  }

  /**
   * Convert an instance of AmazonApiGatewayLambdaIntegration to an JSON string
   *
   * @return JSON string
   */
