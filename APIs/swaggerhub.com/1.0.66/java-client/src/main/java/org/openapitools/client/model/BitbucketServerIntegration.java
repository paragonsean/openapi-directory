...
public class BitbucketServerIntegration {
  ...
  public BitbucketServerIntegration() {
  }
  ...
  public BitbucketServerIntegration enabled(Boolean enabled) {
  ...
  public BitbucketServerIntegration name(String name) {
    this.name = name;
    return this;
  }
  ...
  public BitbucketServerIntegration branch(String branch) {
    this.branch = branch;
    return this;
  }
  ...
  public BitbucketServerIntegration ignoredPaths(List<String> ignoredPaths) {
    this.ignoredPaths = ignoredPaths;
    return this;
  }

  public BitbucketServerIntegration addIgnoredPathsItem(String ignoredPathsItem) {
  ...
  public BitbucketServerIntegration managedPaths(List<String> managedPaths) {
    this.managedPaths = managedPaths;
    return this;
  }

  public BitbucketServerIntegration addManagedPathsItem(String managedPathsItem) {
  ...
  public BitbucketServerIntegration outputFile(String outputFile) {
  ...
  public BitbucketServerIntegration outputFolder(String outputFolder) {
  ...
  public BitbucketServerIntegration providedPaths(List<String> providedPaths) {
    this.providedPaths = providedPaths;
    return this;
  }

  public BitbucketServerIntegration addProvidedPathsItem(String providedPathsItem) {
  ...
  public BitbucketServerIntegration repository(String repository) {
  ...
  public BitbucketServerIntegration syncMethod(SyncMethodEnum syncMethod) {
  ...
  public BitbucketServerIntegration target(String target) {
    this.target = target;
    return this;
  }
  ...
  public BitbucketServerIntegration configType(ConfigTypeEnum configType) {
  ...
  public BitbucketServerIntegration host(String host) {
    this.host = host;
    return this;
  }
  ...
  public BitbucketServerIntegration owner(String owner) {
    this.owner = owner;
    return this;
  }
  ...
  public BitbucketServerIntegration password(String password) {
  ...
  public BitbucketServerIntegration username(String username) {
  ...
  public boolean equals(Object o) {
    ...
    BitbucketServerIntegration bitbucketServerIntegration = (BitbucketServerIntegration) o;
    return Objects.equals(this.enabled, bitbucketServerIntegration.enabled) &&
        Objects.equals(this.id, bitbucketServerIntegration.id) &&
        Objects.equals(this.name, bitbucketServerIntegration.name) &&
        Objects.equals(this.branch, bitbucketServerIntegration.branch) &&
        Objects.equals(this.ignoredPaths, bitbucketServerIntegration.ignoredPaths) &&
        Objects.equals(this.managedPaths, bitbucketServerIntegration.managedPaths) &&
        Objects.equals(this.outputFile, bitbucketServerIntegration.outputFile) &&
        Objects.equals(this.outputFolder, bitbucketServerIntegration.outputFolder) &&
        Objects.equals(this.providedPaths, bitbucketServerIntegration.providedPaths) &&
        Objects.equals(this.repository, bitbucketServerIntegration.repository) &&
        Objects.equals(this.syncMethod, bitbucketServerIntegration.syncMethod) &&
        Objects.equals(this.target, bitbucketServerIntegration.target) &&
        Objects.equals(this.configType, bitbucketServerIntegration.configType) &&
        Objects.equals(this.host, bitbucketServerIntegration.host) &&
        Objects.equals(this.owner, bitbucketServerIntegration.owner) &&
        Objects.equals(this.password, bitbucketServerIntegration.password) &&
        Objects.equals(this.username, bitbucketServerIntegration.username);
  }

  @Override
  public int hashCode() {
    return Objects.hash(enabled, id, name, branch, ignoredPaths, managedPaths, outputFile, outputFolder, providedPaths, repository, syncMethod, target, configType, host, owner, password, username);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class BitbucketServerIntegration {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to BitbucketServerIntegration
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!BitbucketServerIntegration.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in BitbucketServerIntegration is not found in the empty JSON string", BitbucketServerIntegration.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!BitbucketServerIntegration.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `BitbucketServerIntegration` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : BitbucketServerIntegration.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!BitbucketServerIntegration.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'BitbucketServerIntegration' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<BitbucketServerIntegration> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(BitbucketServerIntegration.class));

       return (TypeAdapter<T>) new TypeAdapter<BitbucketServerIntegration>() {
           @Override
           public void write(JsonWriter out, BitbucketServerIntegration value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public BitbucketServerIntegration read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of BitbucketServerIntegration given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of BitbucketServerIntegration
   * @throws IOException if the JSON string is invalid with respect to BitbucketServerIntegration
   */
  public static BitbucketServerIntegration fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, BitbucketServerIntegration.class);
  }

  /**
   * Convert an instance of BitbucketServerIntegration to an JSON string
   *
   * @return JSON string
   */
