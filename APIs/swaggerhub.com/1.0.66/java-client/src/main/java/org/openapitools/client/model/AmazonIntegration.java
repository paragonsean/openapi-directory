...
public class AmazonIntegration {
  ...
  public AmazonIntegration enabled(Boolean enabled) {
  ...
  public AmazonIntegration name(String name) {
    this.name = name;
    return this;
  }
  ...
  public AmazonIntegration accessKey(String accessKey) {
  ...
  public AmazonIntegration apiId(String apiId) {
    this.apiId = apiId;
    return this;
  }
  ...
  public AmazonIntegration basePathMode(BasePathModeEnum basePathMode) {
  ...
  public AmazonIntegration deploymentMode(DeploymentModeEnum deploymentMode) {
  ...
  public AmazonIntegration publishMode(PublishModeEnum publishMode) {
  ...
  public AmazonIntegration region(RegionEnum region) {
    this.region = region;
    return this;
  }
  ...
  public AmazonIntegration secretKey(String secretKey) {
  ...
  public AmazonIntegration updateDefinition(Boolean updateDefinition) {
  ...
  public boolean equals(Object o) {
    ...
    AmazonIntegration amazonIntegration = (AmazonIntegration) o;
    return Objects.equals(this.enabled, amazonIntegration.enabled) &&
        Objects.equals(this.id, amazonIntegration.id) &&
        Objects.equals(this.name, amazonIntegration.name) &&
        Objects.equals(this.accessKey, amazonIntegration.accessKey) &&
        Objects.equals(this.apiId, amazonIntegration.apiId) &&
        Objects.equals(this.basePathMode, amazonIntegration.basePathMode) &&
        Objects.equals(this.deploymentMode, amazonIntegration.deploymentMode) &&
        Objects.equals(this.publishMode, amazonIntegration.publishMode) &&
        Objects.equals(this.region, amazonIntegration.region) &&
        Objects.equals(this.secretKey, amazonIntegration.secretKey) &&
        Objects.equals(this.updateDefinition, amazonIntegration.updateDefinition);
  }

  @Override
  public int hashCode() {
    return Objects.hash(enabled, id, name, accessKey, apiId, basePathMode, deploymentMode, publishMode, region, secretKey, updateDefinition);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AmazonIntegration {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AmazonIntegration
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AmazonIntegration.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AmazonIntegration is not found in the empty JSON string", AmazonIntegration.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AmazonIntegration.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AmazonIntegration` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AmazonIntegration.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AmazonIntegration.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AmazonIntegration' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AmazonIntegration> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AmazonIntegration.class));

       return (TypeAdapter<T>) new TypeAdapter<AmazonIntegration>() {
           @Override
           public void write(JsonWriter out, AmazonIntegration value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AmazonIntegration read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AmazonIntegration given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AmazonIntegration
   * @throws IOException if the JSON string is invalid with respect to AmazonIntegration
   */
  public static AmazonIntegration fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AmazonIntegration.class);
  }

  /**
   * Convert an instance of AmazonIntegration to an JSON string
   *
   * @return JSON string
   */
