...
public class GitHubEnterpriseIntegration {
  ...
  public GitHubEnterpriseIntegration() {
  }
  ...
  public GitHubEnterpriseIntegration enabled(Boolean enabled) {
  ...
  public GitHubEnterpriseIntegration name(String name) {
    this.name = name;
    return this;
  }
  ...
  public GitHubEnterpriseIntegration branch(String branch) {
    this.branch = branch;
    return this;
  }
  ...
  public GitHubEnterpriseIntegration ignoredPaths(List<String> ignoredPaths) {
    this.ignoredPaths = ignoredPaths;
    return this;
  }

  public GitHubEnterpriseIntegration addIgnoredPathsItem(String ignoredPathsItem) {
  ...
  public GitHubEnterpriseIntegration managedPaths(List<String> managedPaths) {
    this.managedPaths = managedPaths;
    return this;
  }

  public GitHubEnterpriseIntegration addManagedPathsItem(String managedPathsItem) {
  ...
  public GitHubEnterpriseIntegration outputFile(String outputFile) {
  ...
  public GitHubEnterpriseIntegration outputFolder(String outputFolder) {
  ...
  public GitHubEnterpriseIntegration providedPaths(List<String> providedPaths) {
    this.providedPaths = providedPaths;
    return this;
  }

  public GitHubEnterpriseIntegration addProvidedPathsItem(String providedPathsItem) {
  ...
  public GitHubEnterpriseIntegration repository(String repository) {
  ...
  public GitHubEnterpriseIntegration syncMethod(SyncMethodEnum syncMethod) {
  ...
  public GitHubEnterpriseIntegration target(String target) {
    this.target = target;
    return this;
  }
  ...
  public GitHubEnterpriseIntegration configType(ConfigTypeEnum configType) {
  ...
  public GitHubEnterpriseIntegration host(String host) {
    this.host = host;
    return this;
  }
  ...
  public GitHubEnterpriseIntegration owner(String owner) {
    this.owner = owner;
    return this;
  }
  ...
  public GitHubEnterpriseIntegration token(String token) {
    this.token = token;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    GitHubEnterpriseIntegration gitHubEnterpriseIntegration = (GitHubEnterpriseIntegration) o;
    return Objects.equals(this.enabled, gitHubEnterpriseIntegration.enabled) &&
        Objects.equals(this.id, gitHubEnterpriseIntegration.id) &&
        Objects.equals(this.name, gitHubEnterpriseIntegration.name) &&
        Objects.equals(this.branch, gitHubEnterpriseIntegration.branch) &&
        Objects.equals(this.ignoredPaths, gitHubEnterpriseIntegration.ignoredPaths) &&
        Objects.equals(this.managedPaths, gitHubEnterpriseIntegration.managedPaths) &&
        Objects.equals(this.outputFile, gitHubEnterpriseIntegration.outputFile) &&
        Objects.equals(this.outputFolder, gitHubEnterpriseIntegration.outputFolder) &&
        Objects.equals(this.providedPaths, gitHubEnterpriseIntegration.providedPaths) &&
        Objects.equals(this.repository, gitHubEnterpriseIntegration.repository) &&
        Objects.equals(this.syncMethod, gitHubEnterpriseIntegration.syncMethod) &&
        Objects.equals(this.target, gitHubEnterpriseIntegration.target) &&
        Objects.equals(this.configType, gitHubEnterpriseIntegration.configType) &&
        Objects.equals(this.host, gitHubEnterpriseIntegration.host) &&
        Objects.equals(this.owner, gitHubEnterpriseIntegration.owner) &&
        Objects.equals(this.token, gitHubEnterpriseIntegration.token);
  }

  @Override
  public int hashCode() {
    return Objects.hash(enabled, id, name, branch, ignoredPaths, managedPaths, outputFile, outputFolder, providedPaths, repository, syncMethod, target, configType, host, owner, token);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class GitHubEnterpriseIntegration {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GitHubEnterpriseIntegration
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GitHubEnterpriseIntegration.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GitHubEnterpriseIntegration is not found in the empty JSON string", GitHubEnterpriseIntegration.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GitHubEnterpriseIntegration.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GitHubEnterpriseIntegration` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GitHubEnterpriseIntegration.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GitHubEnterpriseIntegration.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GitHubEnterpriseIntegration' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GitHubEnterpriseIntegration> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GitHubEnterpriseIntegration.class));

       return (TypeAdapter<T>) new TypeAdapter<GitHubEnterpriseIntegration>() {
           @Override
           public void write(JsonWriter out, GitHubEnterpriseIntegration value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GitHubEnterpriseIntegration read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GitHubEnterpriseIntegration given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GitHubEnterpriseIntegration
   * @throws IOException if the JSON string is invalid with respect to GitHubEnterpriseIntegration
   */
  public static GitHubEnterpriseIntegration fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GitHubEnterpriseIntegration.class);
  }

  /**
   * Convert an instance of GitHubEnterpriseIntegration to an JSON string
   *
   * @return JSON string
   */
