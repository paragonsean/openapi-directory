...
public class GitHubIntegration {
  ...
  public GitHubIntegration enabled(Boolean enabled) {
  ...
  public GitHubIntegration name(String name) {
    this.name = name;
    return this;
  }
  ...
  public GitHubIntegration branch(String branch) {
    this.branch = branch;
    return this;
  }
  ...
  public GitHubIntegration ignoredPaths(List<String> ignoredPaths) {
    this.ignoredPaths = ignoredPaths;
    return this;
  }

  public GitHubIntegration addIgnoredPathsItem(String ignoredPathsItem) {
  ...
  public GitHubIntegration managedPaths(List<String> managedPaths) {
    this.managedPaths = managedPaths;
    return this;
  }

  public GitHubIntegration addManagedPathsItem(String managedPathsItem) {
  ...
  public GitHubIntegration outputFile(String outputFile) {
  ...
  public GitHubIntegration outputFolder(String outputFolder) {
  ...
  public GitHubIntegration providedPaths(List<String> providedPaths) {
    this.providedPaths = providedPaths;
    return this;
  }

  public GitHubIntegration addProvidedPathsItem(String providedPathsItem) {
  ...
  public GitHubIntegration repository(String repository) {
  ...
  public GitHubIntegration syncMethod(SyncMethodEnum syncMethod) {
  ...
  public GitHubIntegration target(String target) {
    this.target = target;
    return this;
  }
  ...
  public GitHubIntegration configType(ConfigTypeEnum configType) {
  ...
  public GitHubIntegration owner(String owner) {
    this.owner = owner;
    return this;
  }
  ...
  public GitHubIntegration token(String token) {
    this.token = token;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    GitHubIntegration gitHubIntegration = (GitHubIntegration) o;
    return Objects.equals(this.enabled, gitHubIntegration.enabled) &&
        Objects.equals(this.id, gitHubIntegration.id) &&
        Objects.equals(this.name, gitHubIntegration.name) &&
        Objects.equals(this.branch, gitHubIntegration.branch) &&
        Objects.equals(this.ignoredPaths, gitHubIntegration.ignoredPaths) &&
        Objects.equals(this.managedPaths, gitHubIntegration.managedPaths) &&
        Objects.equals(this.outputFile, gitHubIntegration.outputFile) &&
        Objects.equals(this.outputFolder, gitHubIntegration.outputFolder) &&
        Objects.equals(this.providedPaths, gitHubIntegration.providedPaths) &&
        Objects.equals(this.repository, gitHubIntegration.repository) &&
        Objects.equals(this.syncMethod, gitHubIntegration.syncMethod) &&
        Objects.equals(this.target, gitHubIntegration.target) &&
        Objects.equals(this.configType, gitHubIntegration.configType) &&
        Objects.equals(this.owner, gitHubIntegration.owner) &&
        Objects.equals(this.token, gitHubIntegration.token);
  }

  @Override
  public int hashCode() {
    return Objects.hash(enabled, id, name, branch, ignoredPaths, managedPaths, outputFile, outputFolder, providedPaths, repository, syncMethod, target, configType, owner, token);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class GitHubIntegration {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GitHubIntegration
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GitHubIntegration.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GitHubIntegration is not found in the empty JSON string", GitHubIntegration.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GitHubIntegration.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GitHubIntegration` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GitHubIntegration.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GitHubIntegration.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GitHubIntegration' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GitHubIntegration> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GitHubIntegration.class));

       return (TypeAdapter<T>) new TypeAdapter<GitHubIntegration>() {
           @Override
           public void write(JsonWriter out, GitHubIntegration value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GitHubIntegration read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GitHubIntegration given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GitHubIntegration
   * @throws IOException if the JSON string is invalid with respect to GitHubIntegration
   */
  public static GitHubIntegration fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GitHubIntegration.class);
  }

  /**
   * Convert an instance of GitHubIntegration to an JSON string
   *
   * @return JSON string
   */
