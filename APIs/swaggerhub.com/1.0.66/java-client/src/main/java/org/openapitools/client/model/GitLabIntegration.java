...
/**
 * Configuration details for the GitLab integration
 */
...
public class GitLabIntegration {
  ...
  public GitLabIntegration enabled(Boolean enabled) {
  ...
  public GitLabIntegration name(String name) {
    this.name = name;
    return this;
  }
  ...
  public GitLabIntegration branch(String branch) {
    this.branch = branch;
    return this;
  }
  ...
  public GitLabIntegration ignoredPaths(List<String> ignoredPaths) {
    this.ignoredPaths = ignoredPaths;
    return this;
  }

  public GitLabIntegration addIgnoredPathsItem(String ignoredPathsItem) {
  ...
  public GitLabIntegration managedPaths(List<String> managedPaths) {
    this.managedPaths = managedPaths;
    return this;
  }

  public GitLabIntegration addManagedPathsItem(String managedPathsItem) {
  ...
  public GitLabIntegration outputFile(String outputFile) {
  ...
  public GitLabIntegration outputFolder(String outputFolder) {
  ...
  public GitLabIntegration providedPaths(List<String> providedPaths) {
    this.providedPaths = providedPaths;
    return this;
  }

  public GitLabIntegration addProvidedPathsItem(String providedPathsItem) {
  ...
  public GitLabIntegration repository(String repository) {
  ...
  public GitLabIntegration syncMethod(SyncMethodEnum syncMethod) {
  ...
  public GitLabIntegration target(String target) {
    this.target = target;
    return this;
  }
  ...
  public GitLabIntegration configType(ConfigTypeEnum configType) {
  ...
  public GitLabIntegration host(String host) {
    this.host = host;
    return this;
  }

  /**
   * The GitLab host to connect to. Make sure to include &#x60;https://&#x60; or &#x60;http://&#x60; at the beginning.
   * @return host
   */
  @javax.annotation.Nullable
  ...
  public GitLabIntegration owner(String owner) {
    this.owner = owner;
    return this;
  }
  ...
  public GitLabIntegration personalAccessToken(String personalAccessToken) {
    this.personalAccessToken = personalAccessToken;
    return this;
  }

  /**
   * A personal access token for accessing the target repository. The token must have the _api_ scope. Write-only property. Required to create and update the integration. 
  ...
  public boolean equals(Object o) {
    ...
    GitLabIntegration gitLabIntegration = (GitLabIntegration) o;
    return Objects.equals(this.enabled, gitLabIntegration.enabled) &&
        Objects.equals(this.id, gitLabIntegration.id) &&
        Objects.equals(this.name, gitLabIntegration.name) &&
        Objects.equals(this.branch, gitLabIntegration.branch) &&
        Objects.equals(this.ignoredPaths, gitLabIntegration.ignoredPaths) &&
        Objects.equals(this.managedPaths, gitLabIntegration.managedPaths) &&
        Objects.equals(this.outputFile, gitLabIntegration.outputFile) &&
        Objects.equals(this.outputFolder, gitLabIntegration.outputFolder) &&
        Objects.equals(this.providedPaths, gitLabIntegration.providedPaths) &&
        Objects.equals(this.repository, gitLabIntegration.repository) &&
        Objects.equals(this.syncMethod, gitLabIntegration.syncMethod) &&
        Objects.equals(this.target, gitLabIntegration.target) &&
        Objects.equals(this.configType, gitLabIntegration.configType) &&
        Objects.equals(this.host, gitLabIntegration.host) &&
        Objects.equals(this.owner, gitLabIntegration.owner) &&
        Objects.equals(this.personalAccessToken, gitLabIntegration.personalAccessToken);
  }

  @Override
  public int hashCode() {
    return Objects.hash(enabled, id, name, branch, ignoredPaths, managedPaths, outputFile, outputFolder, providedPaths, repository, syncMethod, target, configType, host, owner, personalAccessToken);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class GitLabIntegration {\n");
    ...
    sb.append("    personalAccessToken: ").append("*").append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("personalAccessToken");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GitLabIntegration
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GitLabIntegration.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GitLabIntegration is not found in the empty JSON string", GitLabIntegration.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GitLabIntegration.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GitLabIntegration` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GitLabIntegration.openapiRequiredFields) {
      ...
      if ((jsonObj.get("personalAccessToken") != null && !jsonObj.get("personalAccessToken").isJsonNull()) && !jsonObj.get("personalAccessToken").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `personalAccessToken` to be a primitive type in the JSON string but got `%s`", jsonObj.get("personalAccessToken").toString()));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GitLabIntegration.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GitLabIntegration' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GitLabIntegration> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GitLabIntegration.class));

       return (TypeAdapter<T>) new TypeAdapter<GitLabIntegration>() {
           @Override
           public void write(JsonWriter out, GitLabIntegration value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GitLabIntegration read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GitLabIntegration given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GitLabIntegration
   * @throws IOException if the JSON string is invalid with respect to GitLabIntegration
   */
  public static GitLabIntegration fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GitLabIntegration.class);
  }

  /**
   * Convert an instance of GitLabIntegration to an JSON string
   *
   * @return JSON string
   */
