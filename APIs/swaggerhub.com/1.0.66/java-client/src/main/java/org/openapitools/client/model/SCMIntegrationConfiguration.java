...
public class SCMIntegrationConfiguration {
  ...
  public SCMIntegrationConfiguration() {
  }
  ...
  public SCMIntegrationConfiguration enabled(Boolean enabled) {
  ...
  public SCMIntegrationConfiguration name(String name) {
    this.name = name;
    return this;
  }
  ...
  public SCMIntegrationConfiguration branch(String branch) {
    this.branch = branch;
    return this;
  }
  ...
  public SCMIntegrationConfiguration ignoredPaths(List<String> ignoredPaths) {
    this.ignoredPaths = ignoredPaths;
    return this;
  }

  public SCMIntegrationConfiguration addIgnoredPathsItem(String ignoredPathsItem) {
  ...
  public SCMIntegrationConfiguration managedPaths(List<String> managedPaths) {
    this.managedPaths = managedPaths;
    return this;
  }

  public SCMIntegrationConfiguration addManagedPathsItem(String managedPathsItem) {
  ...
  public SCMIntegrationConfiguration outputFile(String outputFile) {
  ...
  public SCMIntegrationConfiguration outputFolder(String outputFolder) {
  ...
  public SCMIntegrationConfiguration providedPaths(List<String> providedPaths) {
    this.providedPaths = providedPaths;
    return this;
  }

  public SCMIntegrationConfiguration addProvidedPathsItem(String providedPathsItem) {
  ...
  public SCMIntegrationConfiguration repository(String repository) {
  ...
  public SCMIntegrationConfiguration syncMethod(SyncMethodEnum syncMethod) {
  ...
  public SCMIntegrationConfiguration target(String target) {
    this.target = target;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    SCMIntegrationConfiguration scMIntegrationConfiguration = (SCMIntegrationConfiguration) o;
    return Objects.equals(this.enabled, scMIntegrationConfiguration.enabled) &&
        Objects.equals(this.id, scMIntegrationConfiguration.id) &&
        Objects.equals(this.name, scMIntegrationConfiguration.name) &&
        Objects.equals(this.branch, scMIntegrationConfiguration.branch) &&
        Objects.equals(this.ignoredPaths, scMIntegrationConfiguration.ignoredPaths) &&
        Objects.equals(this.managedPaths, scMIntegrationConfiguration.managedPaths) &&
        Objects.equals(this.outputFile, scMIntegrationConfiguration.outputFile) &&
        Objects.equals(this.outputFolder, scMIntegrationConfiguration.outputFolder) &&
        Objects.equals(this.providedPaths, scMIntegrationConfiguration.providedPaths) &&
        Objects.equals(this.repository, scMIntegrationConfiguration.repository) &&
        Objects.equals(this.syncMethod, scMIntegrationConfiguration.syncMethod) &&
        Objects.equals(this.target, scMIntegrationConfiguration.target);
  }

  @Override
  public int hashCode() {
    return Objects.hash(enabled, id, name, branch, ignoredPaths, managedPaths, outputFile, outputFolder, providedPaths, repository, syncMethod, target);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class SCMIntegrationConfiguration {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to SCMIntegrationConfiguration
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SCMIntegrationConfiguration.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SCMIntegrationConfiguration is not found in the empty JSON string", SCMIntegrationConfiguration.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SCMIntegrationConfiguration.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SCMIntegrationConfiguration` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : SCMIntegrationConfiguration.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SCMIntegrationConfiguration.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SCMIntegrationConfiguration' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SCMIntegrationConfiguration> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SCMIntegrationConfiguration.class));

       return (TypeAdapter<T>) new TypeAdapter<SCMIntegrationConfiguration>() {
           @Override
           public void write(JsonWriter out, SCMIntegrationConfiguration value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SCMIntegrationConfiguration read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SCMIntegrationConfiguration given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SCMIntegrationConfiguration
   * @throws IOException if the JSON string is invalid with respect to SCMIntegrationConfiguration
   */
  public static SCMIntegrationConfiguration fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SCMIntegrationConfiguration.class);
  }

  /**
   * Convert an instance of SCMIntegrationConfiguration to an JSON string
   *
   * @return JSON string
   */
