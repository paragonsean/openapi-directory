...
public class AzureDevopsServicesIntegration {
  ...
  public AzureDevopsServicesIntegration() {
  }
  ...
  public AzureDevopsServicesIntegration enabled(Boolean enabled) {
  ...
  public AzureDevopsServicesIntegration name(String name) {
    this.name = name;
    return this;
  }
  ...
  public AzureDevopsServicesIntegration branch(String branch) {
    this.branch = branch;
    return this;
  }
  ...
  public AzureDevopsServicesIntegration ignoredPaths(List<String> ignoredPaths) {
    this.ignoredPaths = ignoredPaths;
    return this;
  }

  public AzureDevopsServicesIntegration addIgnoredPathsItem(String ignoredPathsItem) {
  ...
  public AzureDevopsServicesIntegration managedPaths(List<String> managedPaths) {
    this.managedPaths = managedPaths;
    return this;
  }

  public AzureDevopsServicesIntegration addManagedPathsItem(String managedPathsItem) {
  ...
  public AzureDevopsServicesIntegration outputFile(String outputFile) {
  ...
  public AzureDevopsServicesIntegration outputFolder(String outputFolder) {
  ...
  public AzureDevopsServicesIntegration providedPaths(List<String> providedPaths) {
    this.providedPaths = providedPaths;
    return this;
  }

  public AzureDevopsServicesIntegration addProvidedPathsItem(String providedPathsItem) {
  ...
  public AzureDevopsServicesIntegration repository(String repository) {
  ...
  public AzureDevopsServicesIntegration syncMethod(SyncMethodEnum syncMethod) {
  ...
  public AzureDevopsServicesIntegration target(String target) {
    this.target = target;
    return this;
  }
  ...
  public AzureDevopsServicesIntegration configType(ConfigTypeEnum configType) {
  ...
  public AzureDevopsServicesIntegration organization(String organization) {
  ...
  public AzureDevopsServicesIntegration personalAccessToken(String personalAccessToken) {
  ...
  public AzureDevopsServicesIntegration project(String project) {
  ...
  public boolean equals(Object o) {
    ...
    AzureDevopsServicesIntegration azureDevopsServicesIntegration = (AzureDevopsServicesIntegration) o;
    return Objects.equals(this.enabled, azureDevopsServicesIntegration.enabled) &&
        Objects.equals(this.id, azureDevopsServicesIntegration.id) &&
        Objects.equals(this.name, azureDevopsServicesIntegration.name) &&
        Objects.equals(this.branch, azureDevopsServicesIntegration.branch) &&
        Objects.equals(this.ignoredPaths, azureDevopsServicesIntegration.ignoredPaths) &&
        Objects.equals(this.managedPaths, azureDevopsServicesIntegration.managedPaths) &&
        Objects.equals(this.outputFile, azureDevopsServicesIntegration.outputFile) &&
        Objects.equals(this.outputFolder, azureDevopsServicesIntegration.outputFolder) &&
        Objects.equals(this.providedPaths, azureDevopsServicesIntegration.providedPaths) &&
        Objects.equals(this.repository, azureDevopsServicesIntegration.repository) &&
        Objects.equals(this.syncMethod, azureDevopsServicesIntegration.syncMethod) &&
        Objects.equals(this.target, azureDevopsServicesIntegration.target) &&
        Objects.equals(this.configType, azureDevopsServicesIntegration.configType) &&
        Objects.equals(this.organization, azureDevopsServicesIntegration.organization) &&
        Objects.equals(this.personalAccessToken, azureDevopsServicesIntegration.personalAccessToken) &&
        Objects.equals(this.project, azureDevopsServicesIntegration.project);
  }

  @Override
  public int hashCode() {
    return Objects.hash(enabled, id, name, branch, ignoredPaths, managedPaths, outputFile, outputFolder, providedPaths, repository, syncMethod, target, configType, organization, personalAccessToken, project);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AzureDevopsServicesIntegration {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AzureDevopsServicesIntegration
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AzureDevopsServicesIntegration.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AzureDevopsServicesIntegration is not found in the empty JSON string", AzureDevopsServicesIntegration.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AzureDevopsServicesIntegration.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AzureDevopsServicesIntegration` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AzureDevopsServicesIntegration.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AzureDevopsServicesIntegration.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AzureDevopsServicesIntegration' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AzureDevopsServicesIntegration> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AzureDevopsServicesIntegration.class));

       return (TypeAdapter<T>) new TypeAdapter<AzureDevopsServicesIntegration>() {
           @Override
           public void write(JsonWriter out, AzureDevopsServicesIntegration value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AzureDevopsServicesIntegration read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AzureDevopsServicesIntegration given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AzureDevopsServicesIntegration
   * @throws IOException if the JSON string is invalid with respect to AzureDevopsServicesIntegration
   */
  public static AzureDevopsServicesIntegration fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AzureDevopsServicesIntegration.class);
  }

  /**
   * Convert an instance of AzureDevopsServicesIntegration to an JSON string
   *
   * @return JSON string
   */
