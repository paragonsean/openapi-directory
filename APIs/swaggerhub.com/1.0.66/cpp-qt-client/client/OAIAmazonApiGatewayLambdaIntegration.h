...
/*
 * OAIAmazonApiGatewayLambdaIntegration.h
 *
...
#ifndef OAIAmazonApiGatewayLambdaIntegration_H
#define OAIAmazonApiGatewayLambdaIntegration_H
...
class OAIAmazonApiGatewayLambdaIntegration : public OAIObject {
public:
    OAIAmazonApiGatewayLambdaIntegration();
    OAIAmazonApiGatewayLambdaIntegration(QString json);
    ~OAIAmazonApiGatewayLambdaIntegration() override;
    ...
    QString getRuntimeLanguage() const;
    void setRuntimeLanguage(const QString &runtime_language);
    bool is_runtime_language_Set() const;
    bool is_runtime_language_Valid() const;
...
private:
    ...
    QString m_runtime_language;
    bool m_runtime_language_isSet;
    bool m_runtime_language_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIAmazonApiGatewayLambdaIntegration)

#endif // OAIAmazonApiGatewayLambdaIntegration_H
