...
QJsonObject OAIValidationResult::asJsonObject() const {
    QJsonObject obj;
    if (m_validation.size() > 0) {
        obj.insert(QString("validation"), ::OpenAPI::toJsonValue(m_validation));
    }
    return obj;
}

QList<OAIValidationErrors> OAIValidationResult::getValidation() const {
    return m_validation;
}
void OAIValidationResult::setValidation(const QList<OAIValidationErrors> &validation) {
    m_validation = validation;
    m_validation_isSet = true;
}

bool OAIValidationResult::is_validation_Set() const{
    return m_validation_isSet;
}

bool OAIValidationResult::is_validation_Valid() const{
