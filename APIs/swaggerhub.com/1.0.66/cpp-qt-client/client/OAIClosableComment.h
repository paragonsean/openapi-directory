...
/*
 * OAIClosableComment.h
 *
 * 
 */

#ifndef OAIClosableComment_H
#define OAIClosableComment_H
...
class OAIClosableComment : public OAIObject {
public:
    OAIClosableComment();
    OAIClosableComment(QString json);
    ~OAIClosableComment() override;
    ...
    QList<OAIComment> getReplies() const;
    void setReplies(const QList<OAIComment> &replies);
...
Q_DECLARE_METATYPE(OpenAPI::OAIClosableComment)

#endif // OAIClosableComment_H
