...
#ifndef OAIProjectsJson_H
#define OAIProjectsJson_H
...
class OAIProjectsJson : public OAIObject {
public:
    OAIProjectsJson();
    OAIProjectsJson(QString json);
    ~OAIProjectsJson() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIProjectsJson)

#endif // OAIProjectsJson_H
