...
/*
 * OAIGitLabIntegration.h
 *
 * Configuration details for the GitLab integration
 */

#ifndef OAIGitLabIntegration_H
#define OAIGitLabIntegration_H
...
class OAIGitLabIntegration : public OAIObject {
public:
    OAIGitLabIntegration();
    OAIGitLabIntegration(QString json);
    ~OAIGitLabIntegration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGitLabIntegration)

#endif // OAIGitLabIntegration_H
