...
QString OAIValidationErrors::getDescription() const {
    return m_description;
}
void OAIValidationErrors::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAIValidationErrors::is_description_Set() const{
    return m_description_isSet;
}

bool OAIValidationErrors::is_description_Valid() const{
    return m_description_isValid;
}

qint32 OAIValidationErrors::getLine() const {
    return m_line;
}
void OAIValidationErrors::setLine(const qint32 &line) {
    m_line = line;
    m_line_isSet = true;
}

bool OAIValidationErrors::is_line_Set() const{
    return m_line_isSet;
}

bool OAIValidationErrors::is_line_Valid() const{
    return m_line_isValid;
}

QString OAIValidationErrors::getSeverity() const {
    return m_severity;
}
void OAIValidationErrors::setSeverity(const QString &severity) {
    m_severity = severity;
    m_severity_isSet = true;
}

bool OAIValidationErrors::is_severity_Set() const{
    return m_severity_isSet;
}

bool OAIValidationErrors::is_severity_Valid() const{
