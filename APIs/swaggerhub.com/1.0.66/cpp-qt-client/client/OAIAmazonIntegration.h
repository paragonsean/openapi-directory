...
/*
 * OAIAmazonIntegration.h
 *
 * Common configuration details for Amazon integrations
 */

#ifndef OAIAmazonIntegration_H
#define OAIAmazonIntegration_H
...
class OAIAmazonIntegration : public OAIObject {
public:
    OAIAmazonIntegration();
    OAIAmazonIntegration(QString json);
    ~OAIAmazonIntegration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAmazonIntegration)

#endif // OAIAmazonIntegration_H
