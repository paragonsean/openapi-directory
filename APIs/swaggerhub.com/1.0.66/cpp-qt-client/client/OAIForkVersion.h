...
#ifndef OAIForkVersion_H
#define OAIForkVersion_H
...
class OAIForkVersion : public OAIObject {
public:
    OAIForkVersion();
    OAIForkVersion(QString json);
    ~OAIForkVersion() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIForkVersion)

#endif // OAIForkVersion_H
