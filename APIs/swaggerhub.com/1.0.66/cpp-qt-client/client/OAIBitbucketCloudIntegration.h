...
/*
 * OAIBitbucketCloudIntegration.h
 *
 * Configuration details for the Bitbucket Cloud integration
 */

#ifndef OAIBitbucketCloudIntegration_H
#define OAIBitbucketCloudIntegration_H
...
class OAIBitbucketCloudIntegration : public OAIObject {
public:
    OAIBitbucketCloudIntegration();
    OAIBitbucketCloudIntegration(QString json);
    ~OAIBitbucketCloudIntegration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBitbucketCloudIntegration)

#endif // OAIBitbucketCloudIntegration_H
