...
/*
 * OAIBitbucketServerIntegration.h
 *
 * Configuration details for the Bitbucket Server integration
 */

#ifndef OAIBitbucketServerIntegration_H
#define OAIBitbucketServerIntegration_H
...
class OAIBitbucketServerIntegration : public OAIObject {
public:
    OAIBitbucketServerIntegration();
    OAIBitbucketServerIntegration(QString json);
    ~OAIBitbucketServerIntegration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBitbucketServerIntegration)

#endif // OAIBitbucketServerIntegration_H
