...
/*
 * OAIGitHubIntegration.h
 *
 * Configuration details for the GitHub.com integration
 */

#ifndef OAIGitHubIntegration_H
#define OAIGitHubIntegration_H
...
class OAIGitHubIntegration : public OAIObject {
public:
    OAIGitHubIntegration();
    OAIGitHubIntegration(QString json);
    ~OAIGitHubIntegration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGitHubIntegration)

#endif // OAIGitHubIntegration_H
