...
#ifndef OAIIBMApiConnectIntegration_H
#define OAIIBMApiConnectIntegration_H
...
class OAIIBMApiConnectIntegration : public OAIObject {
public:
    OAIIBMApiConnectIntegration();
    OAIIBMApiConnectIntegration(QString json);
    ~OAIIBMApiConnectIntegration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIIBMApiConnectIntegration)

#endif // OAIIBMApiConnectIntegration_H
