...
/*
 * OAISCMIntegrationConfiguration.h
 *
 * Common configuration details for source control integrations
 */

#ifndef OAISCMIntegrationConfiguration_H
#define OAISCMIntegrationConfiguration_H
...
class OAISCMIntegrationConfiguration : public OAIObject {
public:
    OAISCMIntegrationConfiguration();
    OAISCMIntegrationConfiguration(QString json);
    ~OAISCMIntegrationConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISCMIntegrationConfiguration)

#endif // OAISCMIntegrationConfiguration_H
