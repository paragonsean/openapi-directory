...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SwaggerHubRegistryApi.ProjectsJson();
  });
  ...
  describe('ProjectsJson', function() {
    it('should create an instance of ProjectsJson', function() {
      // uncomment below and update the code to test ProjectsJson
      //var instance = new SwaggerHubRegistryApi.ProjectsJson();
      //expect(instance).to.be.a(SwaggerHubRegistryApi.ProjectsJson);
    });
