...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SwaggerHubRegistryApi.ApisJson();
  });
  ...
  describe('ApisJson', function() {
    it('should create an instance of ApisJson', function() {
      // uncomment below and update the code to test ApisJson
      //var instance = new SwaggerHubRegistryApi.ApisJson();
      //expect(instance).to.be.a(SwaggerHubRegistryApi.ApisJson);
    });
