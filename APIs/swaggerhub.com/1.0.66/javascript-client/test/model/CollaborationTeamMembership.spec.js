...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SwaggerHubRegistryApi.CollaborationTeamMembership();
  });
  ...
  describe('CollaborationTeamMembership', function() {
    it('should create an instance of CollaborationTeamMembership', function() {
      // uncomment below and update the code to test CollaborationTeamMembership
      //var instance = new SwaggerHubRegistryApi.CollaborationTeamMembership();
      //expect(instance).to.be.a(SwaggerHubRegistryApi.CollaborationTeamMembership);
    });
