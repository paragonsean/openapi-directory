...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SwaggerHubRegistryApi.ProjectMember();
  });
  ...
  describe('ProjectMember', function() {
    it('should create an instance of ProjectMember', function() {
      ...
      //var instance = new SwaggerHubRegistryApi.ProjectMember();
      //expect(instance).to.be.a(SwaggerHubRegistryApi.ProjectMember);
    });
