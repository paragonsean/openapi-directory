...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SwaggerHubRegistryApi.AmazonApiGatewayLambdaIntegration();
  });
  ...
  describe('AmazonApiGatewayLambdaIntegration', function() {
    it('should create an instance of AmazonApiGatewayLambdaIntegration', function() {
      // uncomment below and update the code to test AmazonApiGatewayLambdaIntegration
      //var instance = new SwaggerHubRegistryApi.AmazonApiGatewayLambdaIntegration();
      //expect(instance).to.be.a(SwaggerHubRegistryApi.AmazonApiGatewayLambdaIntegration);
    });
    ...
    it('should have the property runtimeLanguage (base name: "runtimeLanguage")', function() {
      // uncomment below and update the code to test the property runtimeLanguage
      //var instance = new SwaggerHubRegistryApi.AmazonApiGatewayLambdaIntegration();
      //expect(instance).to.be();
    });
