...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SwaggerHubRegistryApi.IBMApiConnectIntegration();
  });
  ...
  describe('IBMApiConnectIntegration', function() {
    it('should create an instance of IBMApiConnectIntegration', function() {
      // uncomment below and update the code to test IBMApiConnectIntegration
      //var instance = new SwaggerHubRegistryApi.IBMApiConnectIntegration();
      //expect(instance).to.be.a(SwaggerHubRegistryApi.IBMApiConnectIntegration);
    });
