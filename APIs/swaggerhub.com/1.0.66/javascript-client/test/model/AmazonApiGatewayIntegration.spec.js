...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SwaggerHubRegistryApi.AmazonApiGatewayIntegration();
  });
  ...
  describe('AmazonApiGatewayIntegration', function() {
    it('should create an instance of AmazonApiGatewayIntegration', function() {
      // uncomment below and update the code to test AmazonApiGatewayIntegration
      //var instance = new SwaggerHubRegistryApi.AmazonApiGatewayIntegration();
      //expect(instance).to.be.a(SwaggerHubRegistryApi.AmazonApiGatewayIntegration);
    });
    ...
    it('should have the property proxyToAddress (base name: "proxyToAddress")', function() {
      // uncomment below and update the code to test the property proxyToAddress
      //var instance = new SwaggerHubRegistryApi.AmazonApiGatewayIntegration();
      //expect(instance).to.be();
    });
