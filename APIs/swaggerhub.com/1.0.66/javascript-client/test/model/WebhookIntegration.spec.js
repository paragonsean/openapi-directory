...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SwaggerHubRegistryApi.WebhookIntegration();
  });
  ...
  describe('WebhookIntegration', function() {
    it('should create an instance of WebhookIntegration', function() {
      // uncomment below and update the code to test WebhookIntegration
      //var instance = new SwaggerHubRegistryApi.WebhookIntegration();
      //expect(instance).to.be.a(SwaggerHubRegistryApi.WebhookIntegration);
    });
    ...
    it('should have the property lifeCycleEvents (base name: "lifeCycleEvents")', function() {
      // uncomment below and update the code to test the property lifeCycleEvents
      //var instance = new SwaggerHubRegistryApi.WebhookIntegration();
      //expect(instance).to.be();
    });
