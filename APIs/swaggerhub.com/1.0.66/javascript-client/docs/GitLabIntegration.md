# SwaggerHubRegistryApi.GitLabIntegration
...
**host** | **String** | The GitLab host to connect to. Make sure to include &#x60;https://&#x60; or &#x60;http://&#x60; at the beginning. | [optional] [default to &#39;https://gitlab.com&#39;]
**owner** | **String** | The owner of the repository to synchronize with | 
**personalAccessToken** | **String** | A personal access token for accessing the target repository. The token must have the _api_ scope. Write-only property. Required to create and update the integration.  | [optional] 
