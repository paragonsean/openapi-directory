...
/**
 * The GitLabIntegration model module.
 * @module model/GitLabIntegration
 * @version 1.0.66
 */
class GitLabIntegration {
    /**
     * Constructs a new <code>GitLabIntegration</code>.
     * Configuration details for the GitLab integration
     * @alias module:model/GitLabIntegration
     ...
     * @param configType {module:model/GitLabIntegration.ConfigTypeEnum} Integration type
     * @param owner {String} The owner of the repository to synchronize with
     */
    constructor(name, branch, outputFolder, repository, syncMethod, target, configType, owner) { 
        SCMIntegrationConfiguration.initialize(this, name, branch, outputFolder, repository, syncMethod, target);
        GitLabIntegration.initialize(this, name, branch, outputFolder, repository, syncMethod, target, configType, owner);
    }
     ...
     */
    static initialize(obj, name, branch, outputFolder, repository, syncMethod, target, configType, owner) { 
        obj['enabled'] = true;
        obj['name'] = name;
        obj['branch'] = branch;
        ...
        obj['host'] = 'https://gitlab.com';
        obj['owner'] = owner;
    }

    /**
     * Constructs a <code>GitLabIntegration</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GitLabIntegration} obj Optional instance to populate.
     * @return {module:model/GitLabIntegration} The populated <code>GitLabIntegration</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GitLabIntegration();
    ...
    /**
     * Validates the JSON data with respect to <code>GitLabIntegration</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GitLabIntegration</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of GitLabIntegration.RequiredProperties) {
...
GitLabIntegration.RequiredProperties = ["name", "branch", "outputFolder", "repository", "syncMethod", "target", "configType", "owner"];
 ...
 * @default true
 */
GitLabIntegration.prototype['enabled'] = true;

/**
 * ID of the integration
 * @member {String} id
 */
GitLabIntegration.prototype['id'] = undefined;

/**
 * The display name of the integration. Must be unique among all integrations configured for the given API version.
 * @member {String} name
 */
GitLabIntegration.prototype['name'] = undefined;
 ...
 */
GitLabIntegration.prototype['branch'] = undefined;
 ...
 */
GitLabIntegration.prototype['ignoredPaths'] = undefined;
 ...
 */
GitLabIntegration.prototype['managedPaths'] = undefined;
 ...
 */
GitLabIntegration.prototype['outputFile'] = undefined;

/**
 * The output folder for the generated code or definition, relative to the repository root. If this folder does not exist, it will be created. If the output folder is not specified, SwaggerHub will create files and folders in the repository root. Use forward slashes `/` as path separators, but do not add `/` at the beginning. 
 * @member {String} outputFolder
 */
GitLabIntegration.prototype['outputFolder'] = undefined;
 ...
 */
GitLabIntegration.prototype['providedPaths'] = undefined;

/**
 * The repository to synchronize with
 * @member {String} repository
 */
GitLabIntegration.prototype['repository'] = undefined;
 ...
 * @member {module:model/GitLabIntegration.SyncMethodEnum} syncMethod
 */
GitLabIntegration.prototype['syncMethod'] = undefined;
 ...
 */
GitLabIntegration.prototype['target'] = undefined;

/**
 * Integration type
 * @member {module:model/GitLabIntegration.ConfigTypeEnum} configType
 */
GitLabIntegration.prototype['configType'] = undefined;
 ...
 */
GitLabIntegration.prototype['host'] = 'https://gitlab.com';

/**
 * The owner of the repository to synchronize with
 * @member {String} owner
 */
GitLabIntegration.prototype['owner'] = undefined;
 ...
 */
GitLabIntegration.prototype['personalAccessToken'] = undefined;
 ...
 * @readonly
 */
GitLabIntegration['SyncMethodEnum'] = {
 ...
 * @readonly
 */
GitLabIntegration['ConfigTypeEnum'] = {
