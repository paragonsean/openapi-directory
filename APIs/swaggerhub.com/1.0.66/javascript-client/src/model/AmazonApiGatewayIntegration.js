...
/**
 * The AmazonApiGatewayIntegration model module.
 * @module model/AmazonApiGatewayIntegration
 * @version 1.0.66
 */
class AmazonApiGatewayIntegration {
    /**
     * Constructs a new <code>AmazonApiGatewayIntegration</code>.
     ...
     * @alias module:model/AmazonApiGatewayIntegration
     ...
     * @param region {module:model/AmazonApiGatewayIntegration.RegionEnum} AWS region where the API will be published
     * @param configType {module:model/AmazonApiGatewayIntegration.ConfigTypeEnum} Integration type
     * @param proxyToAddress {String} The URL of the backend endpoint to which API Gateway will proxy the requests
     */
    constructor(name, region, configType, proxyToAddress) { 
        AmazonIntegration.initialize(this, name, region);
        AmazonApiGatewayIntegration.initialize(this, name, region, configType, proxyToAddress);
    }
     ...
     */
    static initialize(obj, name, region, configType, proxyToAddress) { 
        obj['enabled'] = true;
        obj['name'] = name;
        ...
        obj['proxyToAddress'] = proxyToAddress;
    }

    /**
     * Constructs a <code>AmazonApiGatewayIntegration</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AmazonApiGatewayIntegration} obj Optional instance to populate.
     * @return {module:model/AmazonApiGatewayIntegration} The populated <code>AmazonApiGatewayIntegration</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AmazonApiGatewayIntegration();
            ...
            if (data.hasOwnProperty('proxyToAddress')) {
                obj['proxyToAddress'] = ApiClient.convertToType(data['proxyToAddress'], 'String');
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>AmazonApiGatewayIntegration</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AmazonApiGatewayIntegration</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of AmazonApiGatewayIntegration.RequiredProperties) {
        ...
        // ensure the json data is a string
        if (data['proxyToAddress'] && !(typeof data['proxyToAddress'] === 'string' || data['proxyToAddress'] instanceof String)) {
            throw new Error("Expected the field `proxyToAddress` to be a primitive type in the JSON string but got " + data['proxyToAddress']);
        }
...
AmazonApiGatewayIntegration.RequiredProperties = ["name", "region", "configType", "proxyToAddress"];
 ...
 * @member {module:model/AmazonApiGatewayIntegration.BasePathModeEnum} basePathMode
 * @default 'ignore'
 */
AmazonApiGatewayIntegration.prototype['basePathMode'] = 'ignore';

/**
 * Should be \"on save\". The value \"never\" means the integration is disabled.
 * @member {module:model/AmazonApiGatewayIntegration.DeploymentModeEnum} deploymentMode
 * @default 'on save'
 */
AmazonApiGatewayIntegration.prototype['deploymentMode'] = 'on save';

/**
 * How to update an existing API in AWS
 * @member {module:model/AmazonApiGatewayIntegration.PublishModeEnum} publishMode
 * @default 'merge'
 */
AmazonApiGatewayIntegration.prototype['publishMode'] = 'merge';

/**
 * AWS region where the API will be published
 * @member {module:model/AmazonApiGatewayIntegration.RegionEnum} region
 */
AmazonApiGatewayIntegration.prototype['region'] = undefined;

/**
 * AWS secret key. Write-only property. Required to create and update the integration.
 * @member {String} secretKey
 */
AmazonApiGatewayIntegration.prototype['secretKey'] = undefined;
 ...
 * @default false
 */
AmazonApiGatewayIntegration.prototype['updateDefinition'] = false;

/**
 * Integration type
 * @member {module:model/AmazonApiGatewayIntegration.ConfigTypeEnum} configType
 */
AmazonApiGatewayIntegration.prototype['configType'] = undefined;

/**
 * The URL of the backend endpoint to which API Gateway will proxy the requests
 * @member {String} proxyToAddress
 */
AmazonApiGatewayIntegration.prototype['proxyToAddress'] = undefined;
 ...
 * @readonly
 */
AmazonApiGatewayIntegration['BasePathModeEnum'] = {
 ...
 * @readonly
 */
AmazonApiGatewayIntegration['DeploymentModeEnum'] = {
 ...
 * @readonly
 */
AmazonApiGatewayIntegration['PublishModeEnum'] = {
 ...
 * @readonly
 */
AmazonApiGatewayIntegration['RegionEnum'] = {
 ...
 * @readonly
 */
AmazonApiGatewayIntegration['ConfigTypeEnum'] = {
...
export default AmazonApiGatewayIntegration;
