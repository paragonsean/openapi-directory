...
/**
 * The AzureDevopsServicesIntegration model module.
 * @module model/AzureDevopsServicesIntegration
 * @version 1.0.66
 */
class AzureDevopsServicesIntegration {
    /**
     * Constructs a new <code>AzureDevopsServicesIntegration</code>.
     * Configuration details for the Azure DevOps Services integration
     * @alias module:model/AzureDevopsServicesIntegration
     ...
     * @param configType {module:model/AzureDevopsServicesIntegration.ConfigTypeEnum} Integration type
     * @param organization {String} The Azure DevOps organization that contains the target repository
     * @param project {String} Team Project which contains the target repository
     */
    constructor(name, branch, outputFolder, repository, syncMethod, target, configType, organization, project) { 
        SCMIntegrationConfiguration.initialize(this, name, branch, outputFolder, repository, syncMethod, target);
        AzureDevopsServicesIntegration.initialize(this, name, branch, outputFolder, repository, syncMethod, target, configType, organization, project);
    }
     ...
     */
    static initialize(obj, name, branch, outputFolder, repository, syncMethod, target, configType, organization, project) { 
        obj['enabled'] = true;
        obj['name'] = name;
        obj['branch'] = branch;
    ...
    /**
     * Constructs a <code>AzureDevopsServicesIntegration</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AzureDevopsServicesIntegration} obj Optional instance to populate.
     * @return {module:model/AzureDevopsServicesIntegration} The populated <code>AzureDevopsServicesIntegration</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AzureDevopsServicesIntegration();
            ...
            if (data.hasOwnProperty('personalAccessToken')) {
                obj['personalAccessToken'] = ApiClient.convertToType(data['personalAccessToken'], 'String');
            }
    ...
    /**
     * Validates the JSON data with respect to <code>AzureDevopsServicesIntegration</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AzureDevopsServicesIntegration</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of AzureDevopsServicesIntegration.RequiredProperties) {
        ...
        // ensure the json data is a string
        if (data['personalAccessToken'] && !(typeof data['personalAccessToken'] === 'string' || data['personalAccessToken'] instanceof String)) {
            throw new Error("Expected the field `personalAccessToken` to be a primitive type in the JSON string but got " + data['personalAccessToken']);
        }
        // ensure the json data is a string
...
AzureDevopsServicesIntegration.RequiredProperties = ["name", "branch", "outputFolder", "repository", "syncMethod", "target", "configType", "organization", "project"];
 ...
 * @default true
 */
AzureDevopsServicesIntegration.prototype['enabled'] = true;

/**
 * ID of the integration
 * @member {String} id
 */
AzureDevopsServicesIntegration.prototype['id'] = undefined;

/**
 * The display name of the integration. Must be unique among all integrations configured for the given API version.
 * @member {String} name
 */
AzureDevopsServicesIntegration.prototype['name'] = undefined;
 ...
 */
AzureDevopsServicesIntegration.prototype['branch'] = undefined;
 ...
 */
AzureDevopsServicesIntegration.prototype['ignoredPaths'] = undefined;
 ...
 */
AzureDevopsServicesIntegration.prototype['managedPaths'] = undefined;
 ...
 */
AzureDevopsServicesIntegration.prototype['outputFile'] = undefined;

/**
 * The output folder for the generated code or definition, relative to the repository root. If this folder does not exist, it will be created. If the output folder is not specified, SwaggerHub will create files and folders in the repository root. Use forward slashes `/` as path separators, but do not add `/` at the beginning. 
 * @member {String} outputFolder
 */
AzureDevopsServicesIntegration.prototype['outputFolder'] = undefined;
 ...
 */
AzureDevopsServicesIntegration.prototype['providedPaths'] = undefined;

/**
 * The repository to synchronize with
 * @member {String} repository
 */
AzureDevopsServicesIntegration.prototype['repository'] = undefined;
 ...
 * @member {module:model/AzureDevopsServicesIntegration.SyncMethodEnum} syncMethod
 */
AzureDevopsServicesIntegration.prototype['syncMethod'] = undefined;
 ...
 */
AzureDevopsServicesIntegration.prototype['target'] = undefined;

/**
 * Integration type
 * @member {module:model/AzureDevopsServicesIntegration.ConfigTypeEnum} configType
 */
AzureDevopsServicesIntegration.prototype['configType'] = undefined;

/**
 * The Azure DevOps organization that contains the target repository
 * @member {String} organization
 */
AzureDevopsServicesIntegration.prototype['organization'] = undefined;
 ...
 * @member {String} personalAccessToken
 */
AzureDevopsServicesIntegration.prototype['personalAccessToken'] = undefined;

/**
 * Team Project which contains the target repository
 * @member {String} project
 */
AzureDevopsServicesIntegration.prototype['project'] = undefined;
 ...
 * @readonly
 */
AzureDevopsServicesIntegration['SyncMethodEnum'] = {
 ...
 * @readonly
 */
AzureDevopsServicesIntegration['ConfigTypeEnum'] = {
...
export default AzureDevopsServicesIntegration;
