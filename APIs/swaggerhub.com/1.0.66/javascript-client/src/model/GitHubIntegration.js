...
/**
 * The GitHubIntegration model module.
 * @module model/GitHubIntegration
 * @version 1.0.66
 */
class GitHubIntegration {
    /**
     * Constructs a new <code>GitHubIntegration</code>.
     * Configuration details for the GitHub.com integration
     * @alias module:model/GitHubIntegration
     ...
     * @param configType {module:model/GitHubIntegration.ConfigTypeEnum} Integration type
     * @param owner {String} The owner of the GitHub repository to synchronize with
     */
    constructor(name, branch, outputFolder, repository, syncMethod, target, configType, owner) { 
        ...
        GitHubIntegration.initialize(this, name, branch, outputFolder, repository, syncMethod, target, configType, owner);
    }
    ...
    /**
     * Constructs a <code>GitHubIntegration</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GitHubIntegration} obj Optional instance to populate.
     * @return {module:model/GitHubIntegration} The populated <code>GitHubIntegration</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GitHubIntegration();
    ...
    /**
     * Validates the JSON data with respect to <code>GitHubIntegration</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GitHubIntegration</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of GitHubIntegration.RequiredProperties) {
...
GitHubIntegration.RequiredProperties = ["name", "branch", "outputFolder", "repository", "syncMethod", "target", "configType", "owner"];
 ...
 * @default true
 */
GitHubIntegration.prototype['enabled'] = true;

/**
 * ID of the integration
 * @member {String} id
 */
GitHubIntegration.prototype['id'] = undefined;

/**
 * The display name of the integration. Must be unique among all integrations configured for the given API version.
 * @member {String} name
 */
GitHubIntegration.prototype['name'] = undefined;
 ...
 */
GitHubIntegration.prototype['branch'] = undefined;
 ...
 */
GitHubIntegration.prototype['ignoredPaths'] = undefined;
 ...
 */
GitHubIntegration.prototype['managedPaths'] = undefined;
 ...
 */
GitHubIntegration.prototype['outputFile'] = undefined;

/**
 * The output folder for the generated code or definition, relative to the repository root. If this folder does not exist, it will be created. If the output folder is not specified, SwaggerHub will create files and folders in the repository root. Use forward slashes `/` as path separators, but do not add `/` at the beginning. 
 * @member {String} outputFolder
 */
GitHubIntegration.prototype['outputFolder'] = undefined;
 ...
 */
GitHubIntegration.prototype['providedPaths'] = undefined;

/**
 * The repository to synchronize with
 * @member {String} repository
 */
GitHubIntegration.prototype['repository'] = undefined;
 ...
 * @member {module:model/GitHubIntegration.SyncMethodEnum} syncMethod
 */
GitHubIntegration.prototype['syncMethod'] = undefined;
 ...
 */
GitHubIntegration.prototype['target'] = undefined;

/**
 * Integration type
 * @member {module:model/GitHubIntegration.ConfigTypeEnum} configType
 */
GitHubIntegration.prototype['configType'] = undefined;

/**
 * The owner of the GitHub repository to synchronize with
 * @member {String} owner
 */
GitHubIntegration.prototype['owner'] = undefined;
 ...
 * @member {String} token
 */
GitHubIntegration.prototype['token'] = undefined;
 ...
 * @readonly
 */
GitHubIntegration['SyncMethodEnum'] = {
 ...
 * @readonly
 */
GitHubIntegration['ConfigTypeEnum'] = {
