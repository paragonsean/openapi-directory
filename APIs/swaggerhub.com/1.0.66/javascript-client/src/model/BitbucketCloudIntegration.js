...
/**
 * The BitbucketCloudIntegration model module.
 * @module model/BitbucketCloudIntegration
 * @version 1.0.66
 */
class BitbucketCloudIntegration {
    /**
     * Constructs a new <code>BitbucketCloudIntegration</code>.
     * Configuration details for the Bitbucket Cloud integration
     * @alias module:model/BitbucketCloudIntegration
     ...
     * @param configType {module:model/BitbucketCloudIntegration.ConfigTypeEnum} Integration type
     * @param owner {String} The owner of the Bitbucket repository to synchronize with
     * @param username {String} Bitbucket username to authenticate with
     */
    constructor(name, branch, outputFolder, repository, syncMethod, target, configType, owner, username) { 
        SCMIntegrationConfiguration.initialize(this, name, branch, outputFolder, repository, syncMethod, target);
        BitbucketCloudIntegration.initialize(this, name, branch, outputFolder, repository, syncMethod, target, configType, owner, username);
    }
     ...
     */
    static initialize(obj, name, branch, outputFolder, repository, syncMethod, target, configType, owner, username) { 
        obj['enabled'] = true;
        obj['name'] = name;
        obj['branch'] = branch;
    ...
    /**
     * Constructs a <code>BitbucketCloudIntegration</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/BitbucketCloudIntegration} obj Optional instance to populate.
     * @return {module:model/BitbucketCloudIntegration} The populated <code>BitbucketCloudIntegration</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new BitbucketCloudIntegration();
    ...
    /**
     * Validates the JSON data with respect to <code>BitbucketCloudIntegration</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>BitbucketCloudIntegration</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of BitbucketCloudIntegration.RequiredProperties) {
...
BitbucketCloudIntegration.RequiredProperties = ["name", "branch", "outputFolder", "repository", "syncMethod", "target", "configType", "owner", "username"];
 ...
 * @default true
 */
BitbucketCloudIntegration.prototype['enabled'] = true;

/**
 * ID of the integration
 * @member {String} id
 */
BitbucketCloudIntegration.prototype['id'] = undefined;

/**
 * The display name of the integration. Must be unique among all integrations configured for the given API version.
 * @member {String} name
 */
BitbucketCloudIntegration.prototype['name'] = undefined;
 ...
 */
BitbucketCloudIntegration.prototype['branch'] = undefined;
 ...
 */
BitbucketCloudIntegration.prototype['ignoredPaths'] = undefined;
 ...
 */
BitbucketCloudIntegration.prototype['managedPaths'] = undefined;
 ...
 */
BitbucketCloudIntegration.prototype['outputFile'] = undefined;

/**
 * The output folder for the generated code or definition, relative to the repository root. If this folder does not exist, it will be created. If the output folder is not specified, SwaggerHub will create files and folders in the repository root. Use forward slashes `/` as path separators, but do not add `/` at the beginning. 
 * @member {String} outputFolder
 */
BitbucketCloudIntegration.prototype['outputFolder'] = undefined;
 ...
 */
BitbucketCloudIntegration.prototype['providedPaths'] = undefined;

/**
 * The repository to synchronize with
 * @member {String} repository
 */
BitbucketCloudIntegration.prototype['repository'] = undefined;
 ...
 * @member {module:model/BitbucketCloudIntegration.SyncMethodEnum} syncMethod
 */
BitbucketCloudIntegration.prototype['syncMethod'] = undefined;
 ...
 */
BitbucketCloudIntegration.prototype['target'] = undefined;

/**
 * Integration type
 * @member {module:model/BitbucketCloudIntegration.ConfigTypeEnum} configType
 */
BitbucketCloudIntegration.prototype['configType'] = undefined;

/**
 * The owner of the Bitbucket repository to synchronize with
 * @member {String} owner
 */
BitbucketCloudIntegration.prototype['owner'] = undefined;
 ...
 */
BitbucketCloudIntegration.prototype['password'] = undefined;

/**
 * Bitbucket username to authenticate with
 * @member {String} username
 */
BitbucketCloudIntegration.prototype['username'] = undefined;
 ...
 * @readonly
 */
BitbucketCloudIntegration['SyncMethodEnum'] = {
 ...
 * @readonly
 */
BitbucketCloudIntegration['ConfigTypeEnum'] = {
...
export default BitbucketCloudIntegration;
