...
/**
 * The GitHubEnterpriseIntegration model module.
 * @module model/GitHubEnterpriseIntegration
 * @version 1.0.66
 */
class GitHubEnterpriseIntegration {
    /**
     * Constructs a new <code>GitHubEnterpriseIntegration</code>.
     * Configuration details for the GitHub Enterprise integration
     * @alias module:model/GitHubEnterpriseIntegration
     ...
     * @param configType {module:model/GitHubEnterpriseIntegration.ConfigTypeEnum} Integration type
     * @param host {String} The GitHub Enterprise host to connect to. Make sure to include `http://` or `https://` at the beginning.
     * @param owner {String} The owner of the repository to synchronize with
     */
    constructor(name, branch, outputFolder, repository, syncMethod, target, configType, host, owner) { 
        SCMIntegrationConfiguration.initialize(this, name, branch, outputFolder, repository, syncMethod, target);
        GitHubEnterpriseIntegration.initialize(this, name, branch, outputFolder, repository, syncMethod, target, configType, host, owner);
    }
     ...
     */
    static initialize(obj, name, branch, outputFolder, repository, syncMethod, target, configType, host, owner) { 
        obj['enabled'] = true;
        obj['name'] = name;
        obj['branch'] = branch;
    ...
    /**
     * Constructs a <code>GitHubEnterpriseIntegration</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GitHubEnterpriseIntegration} obj Optional instance to populate.
     * @return {module:model/GitHubEnterpriseIntegration} The populated <code>GitHubEnterpriseIntegration</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GitHubEnterpriseIntegration();
    ...
    /**
     * Validates the JSON data with respect to <code>GitHubEnterpriseIntegration</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GitHubEnterpriseIntegration</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of GitHubEnterpriseIntegration.RequiredProperties) {
...
GitHubEnterpriseIntegration.RequiredProperties = ["name", "branch", "outputFolder", "repository", "syncMethod", "target", "configType", "host", "owner"];
 ...
 * @default true
 */
GitHubEnterpriseIntegration.prototype['enabled'] = true;

/**
 * ID of the integration
 * @member {String} id
 */
GitHubEnterpriseIntegration.prototype['id'] = undefined;

/**
 * The display name of the integration. Must be unique among all integrations configured for the given API version.
 * @member {String} name
 */
GitHubEnterpriseIntegration.prototype['name'] = undefined;
 ...
 */
GitHubEnterpriseIntegration.prototype['branch'] = undefined;
 ...
 */
GitHubEnterpriseIntegration.prototype['ignoredPaths'] = undefined;
 ...
 */
GitHubEnterpriseIntegration.prototype['managedPaths'] = undefined;
 ...
 */
GitHubEnterpriseIntegration.prototype['outputFile'] = undefined;

/**
 * The output folder for the generated code or definition, relative to the repository root. If this folder does not exist, it will be created. If the output folder is not specified, SwaggerHub will create files and folders in the repository root. Use forward slashes `/` as path separators, but do not add `/` at the beginning. 
 * @member {String} outputFolder
 */
GitHubEnterpriseIntegration.prototype['outputFolder'] = undefined;
 ...
 */
GitHubEnterpriseIntegration.prototype['providedPaths'] = undefined;

/**
 * The repository to synchronize with
 * @member {String} repository
 */
GitHubEnterpriseIntegration.prototype['repository'] = undefined;
 ...
 * @member {module:model/GitHubEnterpriseIntegration.SyncMethodEnum} syncMethod
 */
GitHubEnterpriseIntegration.prototype['syncMethod'] = undefined;
 ...
 */
GitHubEnterpriseIntegration.prototype['target'] = undefined;

/**
 * Integration type
 * @member {module:model/GitHubEnterpriseIntegration.ConfigTypeEnum} configType
 */
GitHubEnterpriseIntegration.prototype['configType'] = undefined;

/**
 * The GitHub Enterprise host to connect to. Make sure to include `http://` or `https://` at the beginning.
 * @member {String} host
 */
GitHubEnterpriseIntegration.prototype['host'] = undefined;

/**
 * The owner of the repository to synchronize with
 * @member {String} owner
 */
GitHubEnterpriseIntegration.prototype['owner'] = undefined;
 ...
 * @member {String} token
 */
GitHubEnterpriseIntegration.prototype['token'] = undefined;
 ...
 * @readonly
 */
GitHubEnterpriseIntegration['SyncMethodEnum'] = {
 ...
 * @readonly
 */
GitHubEnterpriseIntegration['ConfigTypeEnum'] = {
