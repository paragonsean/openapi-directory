...
class GitHubIntegration(Model):
    ...
    def __init__(self, enabled: bool=True, id: str=None, name: str=None, branch: str=None, ignored_paths: List[str]=None, managed_paths: List[str]=None, output_file: str=None, output_folder: str=None, provided_paths: List[str]=None, repository: str=None, sync_method: str=None, target: str=None, config_type: str=None, owner: str=None, token: str=None):
        """GitHubIntegration - a model defined in OpenAPI

        :param enabled: The enabled of this GitHubIntegration.
        :param id: The id of this GitHubIntegration.
        :param name: The name of this GitHubIntegration.
        :param branch: The branch of this GitHubIntegration.
        :param ignored_paths: The ignored_paths of this GitHubIntegration.
        :param managed_paths: The managed_paths of this GitHubIntegration.
        :param output_file: The output_file of this GitHubIntegration.
        :param output_folder: The output_folder of this GitHubIntegration.
        :param provided_paths: The provided_paths of this GitHubIntegration.
        :param repository: The repository of this GitHubIntegration.
        :param sync_method: The sync_method of this GitHubIntegration.
        :param target: The target of this GitHubIntegration.
        :param config_type: The config_type of this GitHubIntegration.
        :param owner: The owner of this GitHubIntegration.
        :param token: The token of this GitHubIntegration.
        """
        self.openapi_types = {
            'enabled': bool,
            'id': str,
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'GitHubIntegration':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The GitHubIntegration of this GitHubIntegration.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def enabled(self):
        """Gets the enabled of this GitHubIntegration.

        Whether the integration is enabled or disabled

        :return: The enabled of this GitHubIntegration.
        :rtype: bool
        """
    ...
    def enabled(self, enabled):
        """Sets the enabled of this GitHubIntegration.
    ...
    @property
    def id(self):
        """Gets the id of this GitHubIntegration.

        ID of the integration

        :return: The id of this GitHubIntegration.
        :rtype: str
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        """Sets the id of this GitHubIntegration.
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this GitHubIntegration.
    ...
    @property
    def branch(self):
        """Gets the branch of this GitHubIntegration.
        ...
        :return: The branch of this GitHubIntegration.
        :rtype: str
        """
        return self._branch
    ...
    def branch(self, branch):
        """Sets the branch of this GitHubIntegration.
    ...
    def ignored_paths(self):
        """Gets the ignored_paths of this GitHubIntegration.
        ...
        :return: The ignored_paths of this GitHubIntegration.
        :rtype: List[str]
        """
    ...
    def ignored_paths(self, ignored_paths):
        """Sets the ignored_paths of this GitHubIntegration.
    ...
    def managed_paths(self):
        """Gets the managed_paths of this GitHubIntegration.
        ...
        :return: The managed_paths of this GitHubIntegration.
        :rtype: List[str]
        """
    ...
    def managed_paths(self, managed_paths):
        """Sets the managed_paths of this GitHubIntegration.
    ...
    def output_file(self):
        """Gets the output_file of this GitHubIntegration.
        ...
        :return: The output_file of this GitHubIntegration.
        :rtype: str
        """
    ...
    def output_file(self, output_file):
        """Sets the output_file of this GitHubIntegration.
    ...
    def output_folder(self):
        """Gets the output_folder of this GitHubIntegration.
        ...
        :return: The output_folder of this GitHubIntegration.
        :rtype: str
        """
    ...
    def output_folder(self, output_folder):
        """Sets the output_folder of this GitHubIntegration.
    ...
    def provided_paths(self):
        """Gets the provided_paths of this GitHubIntegration.
        ...
        :return: The provided_paths of this GitHubIntegration.
        :rtype: List[str]
        """
    ...
    def provided_paths(self, provided_paths):
        """Sets the provided_paths of this GitHubIntegration.
    ...
    @property
    def repository(self):
        """Gets the repository of this GitHubIntegration.

        The repository to synchronize with

        :return: The repository of this GitHubIntegration.
        :rtype: str
        """
    ...
    def repository(self, repository):
        """Sets the repository of this GitHubIntegration.
    ...
    def sync_method(self):
        """Gets the sync_method of this GitHubIntegration.
        ...
        :return: The sync_method of this GitHubIntegration.
        :rtype: str
        """
    ...
    def sync_method(self, sync_method):
        """Sets the sync_method of this GitHubIntegration.
    ...
    @property
    def target(self):
        """Gets the target of this GitHubIntegration.
        ...
        :return: The target of this GitHubIntegration.
        :rtype: str
        """
        return self._target
    ...
    def target(self, target):
        """Sets the target of this GitHubIntegration.
    ...
    def config_type(self):
        """Gets the config_type of this GitHubIntegration.

        Integration type

        :return: The config_type of this GitHubIntegration.
        :rtype: str
        """
    ...
    def config_type(self, config_type):
        """Sets the config_type of this GitHubIntegration.
    ...
    @property
    def owner(self):
        """Gets the owner of this GitHubIntegration.

        The owner of the GitHub repository to synchronize with

        :return: The owner of this GitHubIntegration.
        :rtype: str
        """
        return self._owner
    ...
    def owner(self, owner):
        """Sets the owner of this GitHubIntegration.
    ...
    @property
    def token(self):
        """Gets the token of this GitHubIntegration.

        A personal access token for accessing the target GitHub repository. You can generate tokens here: https://github.com/settings/tokens. Write-only property. Required to create and update the integration. The token must have the _public_repo_ scope if the target repository is public, or the _repo_ scope if it is private. 

        :return: The token of this GitHubIntegration.
        :rtype: str
        """
        return self._token
    ...
    def token(self, token):
        """Sets the token of this GitHubIntegration.
