...
public class ApiClient {
    ...
    private String basePath = "https://api.collegefootballdata.com";
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/4.4.12/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://api.collegefootballdata.com
