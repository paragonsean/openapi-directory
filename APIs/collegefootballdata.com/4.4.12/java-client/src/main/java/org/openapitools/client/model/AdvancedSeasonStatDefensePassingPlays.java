...
public class AdvancedSeasonStatDefensePassingPlays {
   ...
   * @throws IOException if the JSON Element is invalid with respect to AdvancedSeasonStatDefensePassingPlays
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AdvancedSeasonStatDefensePassingPlays.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AdvancedSeasonStatDefensePassingPlays is not found in the empty JSON string", AdvancedSeasonStatDefensePassingPlays.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AdvancedSeasonStatDefensePassingPlays.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AdvancedSeasonStatDefensePassingPlays` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AdvancedSeasonStatDefensePassingPlays.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AdvancedSeasonStatDefensePassingPlays' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AdvancedSeasonStatDefensePassingPlays> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AdvancedSeasonStatDefensePassingPlays.class));

       return (TypeAdapter<T>) new TypeAdapter<AdvancedSeasonStatDefensePassingPlays>() {
           @Override
           public void write(JsonWriter out, AdvancedSeasonStatDefensePassingPlays value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AdvancedSeasonStatDefensePassingPlays read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AdvancedSeasonStatDefensePassingPlays given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AdvancedSeasonStatDefensePassingPlays
   * @throws IOException if the JSON string is invalid with respect to AdvancedSeasonStatDefensePassingPlays
   */
  public static AdvancedSeasonStatDefensePassingPlays fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AdvancedSeasonStatDefensePassingPlays.class);
  }

  /**
   * Convert an instance of AdvancedSeasonStatDefensePassingPlays to an JSON string
   *
   * @return JSON string
   */
