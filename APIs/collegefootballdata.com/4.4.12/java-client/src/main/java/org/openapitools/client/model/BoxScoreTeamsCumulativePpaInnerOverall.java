...
public class BoxScoreTeamsCumulativePpaInnerOverall {
  ...
  public BoxScoreTeamsCumulativePpaInnerOverall() {
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to BoxScoreTeamsCumulativePpaInnerOverall
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!BoxScoreTeamsCumulativePpaInnerOverall.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in BoxScoreTeamsCumulativePpaInnerOverall is not found in the empty JSON string", BoxScoreTeamsCumulativePpaInnerOverall.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!BoxScoreTeamsCumulativePpaInnerOverall.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `BoxScoreTeamsCumulativePpaInnerOverall` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!BoxScoreTeamsCumulativePpaInnerOverall.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'BoxScoreTeamsCumulativePpaInnerOverall' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<BoxScoreTeamsCumulativePpaInnerOverall> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(BoxScoreTeamsCumulativePpaInnerOverall.class));

       return (TypeAdapter<T>) new TypeAdapter<BoxScoreTeamsCumulativePpaInnerOverall>() {
           @Override
           public void write(JsonWriter out, BoxScoreTeamsCumulativePpaInnerOverall value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public BoxScoreTeamsCumulativePpaInnerOverall read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of BoxScoreTeamsCumulativePpaInnerOverall given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of BoxScoreTeamsCumulativePpaInnerOverall
   * @throws IOException if the JSON string is invalid with respect to BoxScoreTeamsCumulativePpaInnerOverall
   */
  public static BoxScoreTeamsCumulativePpaInnerOverall fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, BoxScoreTeamsCumulativePpaInnerOverall.class);
  }

  /**
   * Convert an instance of BoxScoreTeamsCumulativePpaInnerOverall to an JSON string
   *
   * @return JSON string
   */
