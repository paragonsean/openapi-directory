...
/*
 * OAITeamPPA_defense.h
 *
 * 
 */

#ifndef OAITeamPPA_defense_H
#define OAITeamPPA_defense_H
...
namespace OpenAPI {
class OAITeamPPA_defense_cumulative;

class OAITeamPPA_defense : public OAIObject {
public:
    OAITeamPPA_defense();
    OAITeamPPA_defense(QString json);
    ~OAITeamPPA_defense() override;
    ...
    OAITeamPPA_defense_cumulative getCumulative() const;
    void setCumulative(const OAITeamPPA_defense_cumulative &cumulative);
...
private:
    ...
    OAITeamPPA_defense_cumulative m_cumulative;
...
Q_DECLARE_METATYPE(OpenAPI::OAITeamPPA_defense)

#endif // OAITeamPPA_defense_H
