...
/*
 * OAIConferenceSPRating_offense.h
 *
 * 
 */

#ifndef OAIConferenceSPRating_offense_H
#define OAIConferenceSPRating_offense_H
...
class OAIConferenceSPRating_offense : public OAIObject {
public:
    OAIConferenceSPRating_offense();
    OAIConferenceSPRating_offense(QString json);
    ~OAIConferenceSPRating_offense() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIConferenceSPRating_offense)

#endif // OAIConferenceSPRating_offense_H
