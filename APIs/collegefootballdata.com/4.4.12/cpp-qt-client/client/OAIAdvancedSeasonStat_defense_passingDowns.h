...
/*
 * OAIAdvancedSeasonStat_defense_passingDowns.h
 *
 * 
 */

#ifndef OAIAdvancedSeasonStat_defense_passingDowns_H
#define OAIAdvancedSeasonStat_defense_passingDowns_H
...
class OAIAdvancedSeasonStat_defense_passingDowns : public OAIObject {
public:
    OAIAdvancedSeasonStat_defense_passingDowns();
    OAIAdvancedSeasonStat_defense_passingDowns(QString json);
    ~OAIAdvancedSeasonStat_defense_passingDowns() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAdvancedSeasonStat_defense_passingDowns)

#endif // OAIAdvancedSeasonStat_defense_passingDowns_H
