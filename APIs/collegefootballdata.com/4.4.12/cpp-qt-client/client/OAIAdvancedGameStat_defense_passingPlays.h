...
/*
 * OAIAdvancedGameStat_defense_passingPlays.h
 *
 * 
 */

#ifndef OAIAdvancedGameStat_defense_passingPlays_H
#define OAIAdvancedGameStat_defense_passingPlays_H
...
class OAIAdvancedGameStat_defense_passingPlays : public OAIObject {
public:
    OAIAdvancedGameStat_defense_passingPlays();
    OAIAdvancedGameStat_defense_passingPlays(QString json);
    ~OAIAdvancedGameStat_defense_passingPlays() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAdvancedGameStat_defense_passingPlays)

#endif // OAIAdvancedGameStat_defense_passingPlays_H
