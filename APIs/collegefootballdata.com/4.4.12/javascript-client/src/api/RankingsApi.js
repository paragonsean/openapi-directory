...
export default class RankingsApi {
    ...
    */
     ...
     * @callback module:api/RankingsApi~getRankingsCallback
     * @param {String} error Error message, if any.
     * @param {Array.<module:model/RankingWeek>} data The data returned by the service call.
     ...
     * @param {module:api/RankingsApi~getRankingsCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Array.<module:model/RankingWeek>}
     */
    getRankings(year, opts, callback) {
      opts = opts || {};
      let postBody = null;
