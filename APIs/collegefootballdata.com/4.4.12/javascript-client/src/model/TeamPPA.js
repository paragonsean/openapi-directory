...
import TeamPPADefense from './TeamPPADefense';
...
class TeamPPA {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('defense')) {
                obj['defense'] = TeamPPADefense.constructFromObject(data['defense']);
            }
            if (data.hasOwnProperty('offense')) {
                obj['offense'] = TeamPPADefense.constructFromObject(data['offense']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>TeamPPA</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TeamPPA</code>.
     */
    static validateJSON(data) {
        ...
        if (data['defense']) { // data not null
          TeamPPADefense.validateJSON(data['defense']);
        }
        // validate the optional field `offense`
        if (data['offense']) { // data not null
          TeamPPADefense.validateJSON(data['offense']);
        }
        // ensure the json data is a string
...
/**
 * @member {module:model/TeamPPADefense} defense
 */
TeamPPA.prototype['defense'] = undefined;

/**
 * @member {module:model/TeamPPADefense} offense
 */
