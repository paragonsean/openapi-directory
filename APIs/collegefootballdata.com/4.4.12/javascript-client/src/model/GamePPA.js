...
import GamePPADefense from './GamePPADefense';
...
class GamePPA {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('defense')) {
                obj['defense'] = GamePPADefense.constructFromObject(data['defense']);
            }
            if (data.hasOwnProperty('gameId')) {
                obj['gameId'] = ApiClient.convertToType(data['gameId'], 'Number');
            }
            if (data.hasOwnProperty('offense')) {
                obj['offense'] = GamePPADefense.constructFromObject(data['offense']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>GamePPA</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GamePPA</code>.
     */
    static validateJSON(data) {
        ...
        if (data['defense']) { // data not null
          GamePPADefense.validateJSON(data['defense']);
        }
        // validate the optional field `offense`
        if (data['offense']) { // data not null
          GamePPADefense.validateJSON(data['offense']);
        }
        // ensure the json data is a string
...
/**
 * @member {module:model/GamePPADefense} defense
 */
 ...
 */
GamePPA.prototype['gameId'] = undefined;

/**
 * @member {module:model/GamePPADefense} offense
 */
 ...
 */
GamePPA.prototype['opponent'] = undefined;
