...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CollegeFootballDataApi.BoxScorePlayers();
  });
  ...
  describe('BoxScorePlayers', function() {
    it('should create an instance of BoxScorePlayers', function() {
      // uncomment below and update the code to test BoxScorePlayers
      //var instance = new CollegeFootballDataApi.BoxScorePlayers();
      //expect(instance).to.be.a(CollegeFootballDataApi.BoxScorePlayers);
    });
