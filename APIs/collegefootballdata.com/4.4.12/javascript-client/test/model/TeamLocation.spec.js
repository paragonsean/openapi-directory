...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CollegeFootballDataApi.TeamLocation();
  });
  ...
  describe('TeamLocation', function() {
    it('should create an instance of TeamLocation', function() {
      // uncomment below and update the code to test TeamLocation
      //var instance = new CollegeFootballDataApi.TeamLocation();
      //expect(instance).to.be.a(CollegeFootballDataApi.TeamLocation);
    });
