...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CollegeFootballDataApi.DriveEndTime();
  });
  ...
  describe('DriveEndTime', function() {
    it('should create an instance of DriveEndTime', function() {
      // uncomment below and update the code to test DriveEndTime
      //var instance = new CollegeFootballDataApi.DriveEndTime();
      //expect(instance).to.be.a(CollegeFootballDataApi.DriveEndTime);
    });
