...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CollegeFootballDataApi.GameLinesLinesInner();
  });
  ...
  describe('GameLinesLinesInner', function() {
    it('should create an instance of GameLinesLinesInner', function() {
      // uncomment below and update the code to test GameLinesLinesInner
      //var instance = new CollegeFootballDataApi.GameLinesLinesInner();
      //expect(instance).to.be.a(CollegeFootballDataApi.GameLinesLinesInner);
    });

    it('should have the property awayMoneyline (base name: "awayMoneyline")', function() {
      // uncomment below and update the code to test the property awayMoneyline
      //var instance = new CollegeFootballDataApi.GameLinesLinesInner();
      //expect(instance).to.be();
    });

    it('should have the property formattedSpread (base name: "formattedSpread")', function() {
      // uncomment below and update the code to test the property formattedSpread
      //var instance = new CollegeFootballDataApi.GameLinesLinesInner();
      //expect(instance).to.be();
    });

    it('should have the property homeMoneyline (base name: "homeMoneyline")', function() {
      // uncomment below and update the code to test the property homeMoneyline
      //var instance = new CollegeFootballDataApi.GameLinesLinesInner();
      //expect(instance).to.be();
    });
    ...
    it('should have the property overUnderOpen (base name: "overUnderOpen")', function() {
      // uncomment below and update the code to test the property overUnderOpen
      //var instance = new CollegeFootballDataApi.GameLinesLinesInner();
      //expect(instance).to.be();
    });
    ...
    it('should have the property spreadOpen (base name: "spreadOpen")', function() {
      // uncomment below and update the code to test the property spreadOpen
      //var instance = new CollegeFootballDataApi.GameLinesLinesInner();
      //expect(instance).to.be();
    });
