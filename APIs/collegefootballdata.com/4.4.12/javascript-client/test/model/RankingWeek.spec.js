...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CollegeFootballDataApi.RankingWeek();
  });
  ...
  describe('RankingWeek', function() {
    it('should create an instance of RankingWeek', function() {
      // uncomment below and update the code to test RankingWeek
      //var instance = new CollegeFootballDataApi.RankingWeek();
      //expect(instance).to.be.a(CollegeFootballDataApi.RankingWeek);
    });
