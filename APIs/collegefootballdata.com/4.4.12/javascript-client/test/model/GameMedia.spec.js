...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CollegeFootballDataApi.GameMedia();
  });
  ...
  describe('GameMedia', function() {
    it('should create an instance of GameMedia', function() {
      // uncomment below and update the code to test GameMedia
      //var instance = new CollegeFootballDataApi.GameMedia();
      //expect(instance).to.be.a(CollegeFootballDataApi.GameMedia);
    });
    ...
    it('should have the property isStartTimeTBD (base name: "isStartTimeTBD")', function() {
      // uncomment below and update the code to test the property isStartTimeTBD
      //var instance = new CollegeFootballDataApi.GameMedia();
      //expect(instance).to.be();
    });
