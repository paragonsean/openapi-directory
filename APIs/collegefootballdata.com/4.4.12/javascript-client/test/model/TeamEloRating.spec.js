...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CollegeFootballDataApi.TeamEloRating();
  });
  ...
  describe('TeamEloRating', function() {
    it('should create an instance of TeamEloRating', function() {
      // uncomment below and update the code to test TeamEloRating
      //var instance = new CollegeFootballDataApi.TeamEloRating();
      //expect(instance).to.be.a(CollegeFootballDataApi.TeamEloRating);
    });
