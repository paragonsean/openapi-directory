...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CollegeFootballDataApi.ConferenceSPRating();
  });
  ...
  describe('ConferenceSPRating', function() {
    it('should create an instance of ConferenceSPRating', function() {
      // uncomment below and update the code to test ConferenceSPRating
      //var instance = new CollegeFootballDataApi.ConferenceSPRating();
      //expect(instance).to.be.a(CollegeFootballDataApi.ConferenceSPRating);
    });
