...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CollegeFootballDataApi.TeamRecruitingRank();
  });
  ...
  describe('TeamRecruitingRank', function() {
    it('should create an instance of TeamRecruitingRank', function() {
      // uncomment below and update the code to test TeamRecruitingRank
      //var instance = new CollegeFootballDataApi.TeamRecruitingRank();
      //expect(instance).to.be.a(CollegeFootballDataApi.TeamRecruitingRank);
    });
