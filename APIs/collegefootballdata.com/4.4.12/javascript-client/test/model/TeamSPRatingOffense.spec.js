...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CollegeFootballDataApi.TeamSPRatingOffense();
  });
  ...
  describe('TeamSPRatingOffense', function() {
    it('should create an instance of TeamSPRatingOffense', function() {
      // uncomment below and update the code to test TeamSPRatingOffense
      //var instance = new CollegeFootballDataApi.TeamSPRatingOffense();
      //expect(instance).to.be.a(CollegeFootballDataApi.TeamSPRatingOffense);
    });
