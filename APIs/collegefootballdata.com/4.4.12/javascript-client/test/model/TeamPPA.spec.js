...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CollegeFootballDataApi.TeamPPA();
  });
  ...
  describe('TeamPPA', function() {
    it('should create an instance of TeamPPA', function() {
      // uncomment below and update the code to test TeamPPA
      //var instance = new CollegeFootballDataApi.TeamPPA();
      //expect(instance).to.be.a(CollegeFootballDataApi.TeamPPA);
    });
