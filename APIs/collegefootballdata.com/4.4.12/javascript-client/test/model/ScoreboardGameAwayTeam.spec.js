...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CollegeFootballDataApi.ScoreboardGameAwayTeam();
  });
  ...
  describe('ScoreboardGameAwayTeam', function() {
    it('should create an instance of ScoreboardGameAwayTeam', function() {
      // uncomment below and update the code to test ScoreboardGameAwayTeam
      //var instance = new CollegeFootballDataApi.ScoreboardGameAwayTeam();
      //expect(instance).to.be.a(CollegeFootballDataApi.ScoreboardGameAwayTeam);
    });
