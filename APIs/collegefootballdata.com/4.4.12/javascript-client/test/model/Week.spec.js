...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CollegeFootballDataApi.Week();
  });
  ...
  describe('Week', function() {
    it('should create an instance of Week', function() {
      ...
      //var instance = new CollegeFootballDataApi.Week();
      //expect(instance).to.be.a(CollegeFootballDataApi.Week);
    });
    ...
    it('should have the property lastGameStart (base name: "lastGameStart")', function() {
      // uncomment below and update the code to test the property lastGameStart
      //var instance = new CollegeFootballDataApi.Week();
      //expect(instance).to.be();
    });
