...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CollegeFootballDataApi.VenueLocation();
  });
  ...
  describe('VenueLocation', function() {
    it('should create an instance of VenueLocation', function() {
      // uncomment below and update the code to test VenueLocation
      //var instance = new CollegeFootballDataApi.VenueLocation();
      //expect(instance).to.be.a(CollegeFootballDataApi.VenueLocation);
    });
