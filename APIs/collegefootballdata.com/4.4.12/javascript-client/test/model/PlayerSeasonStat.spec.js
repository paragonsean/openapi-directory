...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CollegeFootballDataApi.PlayerSeasonStat();
  });
  ...
  describe('PlayerSeasonStat', function() {
    it('should create an instance of PlayerSeasonStat', function() {
      // uncomment below and update the code to test PlayerSeasonStat
      //var instance = new CollegeFootballDataApi.PlayerSeasonStat();
      //expect(instance).to.be.a(CollegeFootballDataApi.PlayerSeasonStat);
    });
