...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CollegeFootballDataApi.PlayerSeasonPPA();
  });
  ...
  describe('PlayerSeasonPPA', function() {
    it('should create an instance of PlayerSeasonPPA', function() {
      // uncomment below and update the code to test PlayerSeasonPPA
      //var instance = new CollegeFootballDataApi.PlayerSeasonPPA();
      //expect(instance).to.be.a(CollegeFootballDataApi.PlayerSeasonPPA);
    });
