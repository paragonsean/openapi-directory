...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CollegeFootballDataApi.BoxScoreTeamsCumulativePpaInner();
  });
  ...
  describe('BoxScoreTeamsCumulativePpaInner', function() {
    it('should create an instance of BoxScoreTeamsCumulativePpaInner', function() {
      // uncomment below and update the code to test BoxScoreTeamsCumulativePpaInner
      //var instance = new CollegeFootballDataApi.BoxScoreTeamsCumulativePpaInner();
      //expect(instance).to.be.a(CollegeFootballDataApi.BoxScoreTeamsCumulativePpaInner);
    });
