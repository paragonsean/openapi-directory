...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CollegeFootballDataApi.PredictedPoints();
  });
  ...
  describe('PredictedPoints', function() {
    it('should create an instance of PredictedPoints', function() {
      // uncomment below and update the code to test PredictedPoints
      //var instance = new CollegeFootballDataApi.PredictedPoints();
      //expect(instance).to.be.a(CollegeFootballDataApi.PredictedPoints);
    });

    it('should have the property predictedPoints (base name: "predictedPoints")', function() {
      // uncomment below and update the code to test the property predictedPoints
      //var instance = new CollegeFootballDataApi.PredictedPoints();
