...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CollegeFootballDataApi.BoxScorePlayersUsageInner();
  });
  ...
  describe('BoxScorePlayersUsageInner', function() {
    it('should create an instance of BoxScorePlayersUsageInner', function() {
      // uncomment below and update the code to test BoxScorePlayersUsageInner
      //var instance = new CollegeFootballDataApi.BoxScorePlayersUsageInner();
      //expect(instance).to.be.a(CollegeFootballDataApi.BoxScorePlayersUsageInner);
    });
