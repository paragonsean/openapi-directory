...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CollegeFootballDataApi.PlayerUsageUsage();
  });
  ...
  describe('PlayerUsageUsage', function() {
    it('should create an instance of PlayerUsageUsage', function() {
      // uncomment below and update the code to test PlayerUsageUsage
      //var instance = new CollegeFootballDataApi.PlayerUsageUsage();
      //expect(instance).to.be.a(CollegeFootballDataApi.PlayerUsageUsage);
    });
