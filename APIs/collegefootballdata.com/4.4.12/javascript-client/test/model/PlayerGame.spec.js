...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CollegeFootballDataApi.PlayerGame();
  });
  ...
  describe('PlayerGame', function() {
    it('should create an instance of PlayerGame', function() {
      ...
      //var instance = new CollegeFootballDataApi.PlayerGame();
      //expect(instance).to.be.a(CollegeFootballDataApi.PlayerGame);
    });
