...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CollegeFootballDataApi.Conference();
  });
  ...
  describe('Conference', function() {
    it('should create an instance of Conference', function() {
      ...
      //var instance = new CollegeFootballDataApi.Conference();
      //expect(instance).to.be.a(CollegeFootballDataApi.Conference);
    });
