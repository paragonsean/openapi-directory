...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CollegeFootballDataApi.TeamSeason();
  });
  ...
  describe('TeamSeason', function() {
    it('should create an instance of TeamSeason', function() {
      ...
      //var instance = new CollegeFootballDataApi.TeamSeason();
      //expect(instance).to.be.a(CollegeFootballDataApi.TeamSeason);
    });
