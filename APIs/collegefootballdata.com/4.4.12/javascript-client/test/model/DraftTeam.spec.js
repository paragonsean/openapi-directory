...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CollegeFootballDataApi.DraftTeam();
  });
  ...
  describe('DraftTeam', function() {
    it('should create an instance of DraftTeam', function() {
      // uncomment below and update the code to test DraftTeam
      //var instance = new CollegeFootballDataApi.DraftTeam();
      //expect(instance).to.be.a(CollegeFootballDataApi.DraftTeam);
    });
