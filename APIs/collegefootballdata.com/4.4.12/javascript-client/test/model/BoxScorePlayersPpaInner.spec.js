...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CollegeFootballDataApi.BoxScorePlayersPpaInner();
  });
  ...
  describe('BoxScorePlayersPpaInner', function() {
    it('should create an instance of BoxScorePlayersPpaInner', function() {
      // uncomment below and update the code to test BoxScorePlayersPpaInner
      //var instance = new CollegeFootballDataApi.BoxScorePlayersPpaInner();
      //expect(instance).to.be.a(CollegeFootballDataApi.BoxScorePlayersPpaInner);
    });
