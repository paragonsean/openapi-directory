...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CollegeFootballDataApi.GamePPA();
  });
  ...
  describe('GamePPA', function() {
    it('should create an instance of GamePPA', function() {
      // uncomment below and update the code to test GamePPA
      //var instance = new CollegeFootballDataApi.GamePPA();
      //expect(instance).to.be.a(CollegeFootballDataApi.GamePPA);
    });
