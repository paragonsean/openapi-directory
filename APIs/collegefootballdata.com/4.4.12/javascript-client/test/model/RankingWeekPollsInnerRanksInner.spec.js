...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CollegeFootballDataApi.RankingWeekPollsInnerRanksInner();
  });
  ...
  describe('RankingWeekPollsInnerRanksInner', function() {
    it('should create an instance of RankingWeekPollsInnerRanksInner', function() {
      // uncomment below and update the code to test RankingWeekPollsInnerRanksInner
      //var instance = new CollegeFootballDataApi.RankingWeekPollsInnerRanksInner();
      //expect(instance).to.be.a(CollegeFootballDataApi.RankingWeekPollsInnerRanksInner);
    });
    ...
    it('should have the property firstPlaceVotes (base name: "firstPlaceVotes")', function() {
      // uncomment below and update the code to test the property firstPlaceVotes
      //var instance = new CollegeFootballDataApi.RankingWeekPollsInnerRanksInner();
      //expect(instance).to.be();
    });
