...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CollegeFootballDataApi.TeamPPADefense();
  });
  ...
  describe('TeamPPADefense', function() {
    it('should create an instance of TeamPPADefense', function() {
      // uncomment below and update the code to test TeamPPADefense
      //var instance = new CollegeFootballDataApi.TeamPPADefense();
      //expect(instance).to.be.a(CollegeFootballDataApi.TeamPPADefense);
    });
