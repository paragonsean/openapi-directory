...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CollegeFootballDataApi.PlayerUsage();
  });
  ...
  describe('PlayerUsage', function() {
    it('should create an instance of PlayerUsage', function() {
      // uncomment below and update the code to test PlayerUsage
      //var instance = new CollegeFootballDataApi.PlayerUsage();
      //expect(instance).to.be.a(CollegeFootballDataApi.PlayerUsage);
    });
