...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CollegeFootballDataApi.RecruitingApi();
  });
  ...
  describe('RecruitingApi', function() {
    describe('getRecruitingGroups', function() {
      it('should call getRecruitingGroups successfully', function(done) {
        //uncomment below and update the code to test getRecruitingGroups
        //instance.getRecruitingGroups(function(error) {
    ...
    describe('getRecruitingPlayers', function() {
      it('should call getRecruitingPlayers successfully', function(done) {
        //uncomment below and update the code to test getRecruitingPlayers
        //instance.getRecruitingPlayers(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('getRecruitingTeams', function() {
      it('should call getRecruitingTeams successfully', function(done) {
        //uncomment below and update the code to test getRecruitingTeams
        //instance.getRecruitingTeams(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
