...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CollegeFootballDataApi.DraftApi();
  });
  ...
  describe('DraftApi', function() {
    describe('getDraftPicks', function() {
      it('should call getDraftPicks successfully', function(done) {
        //uncomment below and update the code to test getDraftPicks
        //instance.getDraftPicks(function(error) {
    ...
    describe('getNFLPositions', function() {
      it('should call getNFLPositions successfully', function(done) {
        //uncomment below and update the code to test getNFLPositions
        //instance.getNFLPositions(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('getNFLTeams', function() {
      it('should call getNFLTeams successfully', function(done) {
        //uncomment below and update the code to test getNFLTeams
        //instance.getNFLTeams(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
