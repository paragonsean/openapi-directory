...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CollegeFootballDataApi.StatsApi();
  });
  ...
  describe('StatsApi', function() {
    describe('getAdvancedTeamGameStats', function() {
      it('should call getAdvancedTeamGameStats successfully', function(done) {
        //uncomment below and update the code to test getAdvancedTeamGameStats
        //instance.getAdvancedTeamGameStats(function(error) {
    ...
    describe('getAdvancedTeamSeasonStats', function() {
      it('should call getAdvancedTeamSeasonStats successfully', function(done) {
        //uncomment below and update the code to test getAdvancedTeamSeasonStats
        //instance.getAdvancedTeamSeasonStats(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('getStatCategories', function() {
      it('should call getStatCategories successfully', function(done) {
        //uncomment below and update the code to test getStatCategories
        //instance.getStatCategories(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('getTeamSeasonStats', function() {
      it('should call getTeamSeasonStats successfully', function(done) {
        //uncomment below and update the code to test getTeamSeasonStats
        //instance.getTeamSeasonStats(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
