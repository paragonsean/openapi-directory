...
/**
 * The FireteamFireteamUserInfoCard model module.
 * @module model/FireteamFireteamUserInfoCard
 * @version 2.18.0
 */
class FireteamFireteamUserInfoCard {
    /**
     * Constructs a new <code>FireteamFireteamUserInfoCard</code>.
     * @alias module:model/FireteamFireteamUserInfoCard
     */
    constructor() { 
        
        FireteamFireteamUserInfoCard.initialize(this);
    }
    ...
    /**
     * Constructs a <code>FireteamFireteamUserInfoCard</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/FireteamFireteamUserInfoCard} obj Optional instance to populate.
     * @return {module:model/FireteamFireteamUserInfoCard} The populated <code>FireteamFireteamUserInfoCard</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new FireteamFireteamUserInfoCard();

            if (data.hasOwnProperty('FireteamDisplayName')) {
                obj['FireteamDisplayName'] = ApiClient.convertToType(data['FireteamDisplayName'], 'String');
            }
            if (data.hasOwnProperty('FireteamMembershipType')) {
                obj['FireteamMembershipType'] = ApiClient.convertToType(data['FireteamMembershipType'], 'Number');
            }
    ...
    /**
     * Validates the JSON data with respect to <code>FireteamFireteamUserInfoCard</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>FireteamFireteamUserInfoCard</code>.
     */
    static validateJSON(data) {
        // ensure the json data is a string
        if (data['FireteamDisplayName'] && !(typeof data['FireteamDisplayName'] === 'string' || data['FireteamDisplayName'] instanceof String)) {
            throw new Error("Expected the field `FireteamDisplayName` to be a primitive type in the JSON string but got " + data['FireteamDisplayName']);
        }
...
/**
 * @member {String} FireteamDisplayName
 */
FireteamFireteamUserInfoCard.prototype['FireteamDisplayName'] = undefined;

/**
 * @member {Number} FireteamMembershipType
 */
FireteamFireteamUserInfoCard.prototype['FireteamMembershipType'] = undefined;
 ...
 */
FireteamFireteamUserInfoCard.prototype['applicableMembershipTypes'] = undefined;

/**
 * The bungie global display name, if set.
 * @member {String} bungieGlobalDisplayName
 */
FireteamFireteamUserInfoCard.prototype['bungieGlobalDisplayName'] = undefined;

/**
 * The bungie global display name code, if set.
 * @member {Number} bungieGlobalDisplayNameCode
 */
FireteamFireteamUserInfoCard.prototype['bungieGlobalDisplayNameCode'] = undefined;

/**
 * If there is a cross save override in effect, this value will tell you the type that is overridding this one.
 * @member {Number} crossSaveOverride
 */
FireteamFireteamUserInfoCard.prototype['crossSaveOverride'] = undefined;

/**
 * Display Name the player has chosen for themselves. The display name is optional when the data type is used as input to a platform API.
 * @member {String} displayName
 */
FireteamFireteamUserInfoCard.prototype['displayName'] = undefined;

/**
 * URL the Icon if available.
 * @member {String} iconPath
 */
FireteamFireteamUserInfoCard.prototype['iconPath'] = undefined;

/**
 * If True, this is a public user membership.
 * @member {Boolean} isPublic
 */
FireteamFireteamUserInfoCard.prototype['isPublic'] = undefined;

/**
 * Membership ID as they user is known in the Accounts service
 * @member {Number} membershipId
 */
FireteamFireteamUserInfoCard.prototype['membershipId'] = undefined;

/**
 * Type of the membership. Not necessarily the native type.
 * @member {Number} membershipType
 */
FireteamFireteamUserInfoCard.prototype['membershipType'] = undefined;

/**
 * A platform specific additional display name - ex: psn Real Name, bnet Unique Name, etc.
 * @member {String} supplementalDisplayName
 */
FireteamFireteamUserInfoCard.prototype['supplementalDisplayName'] = undefined;
...
export default FireteamFireteamUserInfoCard;
