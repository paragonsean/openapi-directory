...
/**
 * The DestinyComponentsItemsDestinyItemPlugComponent model module.
 * @module model/DestinyComponentsItemsDestinyItemPlugComponent
 * @version 2.18.0
 */
class DestinyComponentsItemsDestinyItemPlugComponent {
    /**
     * Constructs a new <code>DestinyComponentsItemsDestinyItemPlugComponent</code>.
     ...
     * @alias module:model/DestinyComponentsItemsDestinyItemPlugComponent
     */
    constructor() { 
        
        DestinyComponentsItemsDestinyItemPlugComponent.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DestinyComponentsItemsDestinyItemPlugComponent</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DestinyComponentsItemsDestinyItemPlugComponent} obj Optional instance to populate.
     * @return {module:model/DestinyComponentsItemsDestinyItemPlugComponent} The populated <code>DestinyComponentsItemsDestinyItemPlugComponent</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DestinyComponentsItemsDestinyItemPlugComponent();
    ...
    /**
     * Validates the JSON data with respect to <code>DestinyComponentsItemsDestinyItemPlugComponent</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DestinyComponentsItemsDestinyItemPlugComponent</code>.
     */
 ...
 */
DestinyComponentsItemsDestinyItemPlugComponent.prototype['canInsert'] = undefined;
 ...
 */
DestinyComponentsItemsDestinyItemPlugComponent.prototype['enableFailIndexes'] = undefined;

/**
 * If true, this plug will provide its benefits while inserted.
 * @member {Boolean} enabled
 */
DestinyComponentsItemsDestinyItemPlugComponent.prototype['enabled'] = undefined;
 ...
 */
DestinyComponentsItemsDestinyItemPlugComponent.prototype['insertFailIndexes'] = undefined;

/**
 * The hash identifier of the DestinyInventoryItemDefinition that represents this plug.
 * @member {Number} plugItemHash
 */
DestinyComponentsItemsDestinyItemPlugComponent.prototype['plugItemHash'] = undefined;
 ...
 */
DestinyComponentsItemsDestinyItemPlugComponent.prototype['plugObjectives'] = undefined;
...
export default DestinyComponentsItemsDestinyItemPlugComponent;
