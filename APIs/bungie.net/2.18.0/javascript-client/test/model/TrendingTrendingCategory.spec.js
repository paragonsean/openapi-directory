...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BungieNetApi.TrendingTrendingCategory();
  });
  ...
  describe('TrendingTrendingCategory', function() {
    it('should create an instance of TrendingTrendingCategory', function() {
      // uncomment below and update the code to test TrendingTrendingCategory
      //var instance = new BungieNetApi.TrendingTrendingCategory();
      //expect(instance).to.be.a(BungieNetApi.TrendingTrendingCategory);
    });
