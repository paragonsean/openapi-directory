...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BungieNetApi.ForumPollResponse();
  });
  ...
  describe('ForumPollResponse', function() {
    it('should create an instance of ForumPollResponse', function() {
      // uncomment below and update the code to test ForumPollResponse
      //var instance = new BungieNetApi.ForumPollResponse();
      //expect(instance).to.be.a(BungieNetApi.ForumPollResponse);
    });
