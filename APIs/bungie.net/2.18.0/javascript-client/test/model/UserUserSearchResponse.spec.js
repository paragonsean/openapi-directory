...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BungieNetApi.UserUserSearchResponse();
  });
  ...
  describe('UserUserSearchResponse', function() {
    it('should create an instance of UserUserSearchResponse', function() {
      // uncomment below and update the code to test UserUserSearchResponse
      //var instance = new BungieNetApi.UserUserSearchResponse();
      //expect(instance).to.be.a(BungieNetApi.UserUserSearchResponse);
    });
