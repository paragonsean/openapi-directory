...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BungieNetApi.DestinyMiscDestinyColor();
  });
  ...
  describe('DestinyMiscDestinyColor', function() {
    it('should create an instance of DestinyMiscDestinyColor', function() {
      // uncomment below and update the code to test DestinyMiscDestinyColor
      //var instance = new BungieNetApi.DestinyMiscDestinyColor();
      //expect(instance).to.be.a(BungieNetApi.DestinyMiscDestinyColor);
    });
