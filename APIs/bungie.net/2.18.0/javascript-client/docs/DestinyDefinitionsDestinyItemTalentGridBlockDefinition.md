# BungieNetApi.DestinyDefinitionsDestinyItemTalentGridBlockDefinition
...
**hudDamageType** | **Number** | If the talent grid implies a damage type, this is the enum value for that damage type. | [optional] 
...
**talentGridHash** | **Number** | The hash identifier of the DestinyTalentGridDefinition attached to this item. | [optional] 
