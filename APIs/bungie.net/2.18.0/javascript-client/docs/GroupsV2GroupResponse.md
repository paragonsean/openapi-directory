# BungieNetApi.GroupsV2GroupResponse

## Properties

Name | Type | Description | Notes
------------ | ------------- | ------------- | -------------
**allianceStatus** | **Number** |  | [optional] 
**alliedIds** | **[Number]** |  | [optional] 
**currentUserMemberMap** | [**{String: GroupsV2GroupMember}**](GroupsV2GroupMember.md) | This property will be populated if the authenticated user is a member of the group. Note that because of account linking, a user can sometimes be part of a clan more than once. As such, this returns the highest member type available. | [optional] 
...
**groupJoinInviteCount** | **Number** |  | [optional] 
