# BungieNetApi.DestinyDestinyActivity

## Properties

Name | Type | Description | Notes
------------ | ------------- | ------------- | -------------
**activityHash** | **Number** | The hash identifier of the Activity. Use this to look up the DestinyActivityDefinition of the activity. | [optional] 
...
**challenges** | [**[DestinyChallengesDestinyChallengeStatus]**](DestinyChallengesDestinyChallengeStatus.md) |  | [optional] 
**difficultyTier** | **Number** | A DestinyActivityDifficultyTier enum value indicating the difficulty of the activity. | [optional] 
**displayLevel** | **Number** | The difficulty level of the activity, if applicable. | [optional] 
...
**recommendedLight** | **Number** | The recommended light level for the activity, if applicable. | [optional] 
