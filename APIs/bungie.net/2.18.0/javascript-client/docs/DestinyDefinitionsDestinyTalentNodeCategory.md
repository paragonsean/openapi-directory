# BungieNetApi.DestinyDefinitionsDestinyTalentNodeCategory
...
**nodeHashes** | **[Number]** | The set of all hash identifiers for Talent Nodes (DestinyTalentNodeDefinition) in this Talent Grid that are part of this Category. | [optional] 
