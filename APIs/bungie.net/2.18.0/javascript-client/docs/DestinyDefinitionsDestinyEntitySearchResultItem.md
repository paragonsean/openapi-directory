# BungieNetApi.DestinyDefinitionsDestinyEntitySearchResultItem
...
**hash** | **Number** | The hash identifier of the entity. You will use this to look up the DestinyDefinition relevant for the entity found. | [optional] 
**weight** | **Number** | The ranking value for sorting that we calculated using our relevance formula. This will hopefully get better with time and iteration. | [optional] 
