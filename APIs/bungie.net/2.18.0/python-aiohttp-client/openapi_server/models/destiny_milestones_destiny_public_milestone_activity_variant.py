...
class DestinyMilestonesDestinyPublicMilestoneActivityVariant(Model):
    """NOTE: This class is auto generated by OpenAPI Generator (https://openapi-generator.tech).

    Do not edit the class manually.
    """

    def __init__(self, activity_hash: int=None, activity_mode_hash: int=None, activity_mode_type: int=None):
        """DestinyMilestonesDestinyPublicMilestoneActivityVariant - a model defined in OpenAPI

        :param activity_hash: The activity_hash of this DestinyMilestonesDestinyPublicMilestoneActivityVariant.
        :param activity_mode_hash: The activity_mode_hash of this DestinyMilestonesDestinyPublicMilestoneActivityVariant.
        :param activity_mode_type: The activity_mode_type of this DestinyMilestonesDestinyPublicMilestoneActivityVariant.
        """
        self.openapi_types = {
            'activity_hash': int,
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'DestinyMilestonesDestinyPublicMilestoneActivityVariant':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The Destiny.Milestones.DestinyPublicMilestoneActivityVariant of this DestinyMilestonesDestinyPublicMilestoneActivityVariant.
        """
    ...
    def activity_mode_hash(self):
        """Gets the activity_mode_hash of this DestinyMilestonesDestinyPublicMilestoneActivityVariant.

        The hash identifier of the most specific Activity Mode under which this activity is played. This is useful for situations where the activity in question is - for instance - a PVP map, but it's not clear what mode the PVP map is being played under. If it's a playlist, this will be less specific: but hopefully useful in some way.

        :return: The activity_mode_hash of this DestinyMilestonesDestinyPublicMilestoneActivityVariant.
        :rtype: int
        """
    ...
    def activity_mode_hash(self, activity_mode_hash):
        """Sets the activity_mode_hash of this DestinyMilestonesDestinyPublicMilestoneActivityVariant.
    ...
    def activity_mode_type(self):
        """Gets the activity_mode_type of this DestinyMilestonesDestinyPublicMilestoneActivityVariant.

        The enumeration equivalent of the most specific Activity Mode under which this activity is played.

        :return: The activity_mode_type of this DestinyMilestonesDestinyPublicMilestoneActivityVariant.
        :rtype: int
        """
    ...
    def activity_mode_type(self, activity_mode_type):
        """Sets the activity_mode_type of this DestinyMilestonesDestinyPublicMilestoneActivityVariant.
