...
public class DestinyComponentsItemsDestinyItemPlugComponent {
  ...
  public DestinyComponentsItemsDestinyItemPlugComponent canInsert(Boolean canInsert) {
  ...
  public DestinyComponentsItemsDestinyItemPlugComponent enableFailIndexes(List<Integer> enableFailIndexes) {
    this.enableFailIndexes = enableFailIndexes;
    return this;
  }

  public DestinyComponentsItemsDestinyItemPlugComponent addEnableFailIndexesItem(Integer enableFailIndexesItem) {
  ...
  public DestinyComponentsItemsDestinyItemPlugComponent enabled(Boolean enabled) {
  ...
  public DestinyComponentsItemsDestinyItemPlugComponent insertFailIndexes(List<Integer> insertFailIndexes) {
    this.insertFailIndexes = insertFailIndexes;
    return this;
  }

  public DestinyComponentsItemsDestinyItemPlugComponent addInsertFailIndexesItem(Integer insertFailIndexesItem) {
  ...
  public DestinyComponentsItemsDestinyItemPlugComponent plugObjectives(List<DestinyQuestsDestinyObjectiveProgress> plugObjectives) {
    this.plugObjectives = plugObjectives;
    return this;
  }

  public DestinyComponentsItemsDestinyItemPlugComponent addPlugObjectivesItem(DestinyQuestsDestinyObjectiveProgress plugObjectivesItem) {
  ...
  public boolean equals(Object o) {
    ...
    DestinyComponentsItemsDestinyItemPlugComponent destinyComponentsItemsDestinyItemPlugComponent = (DestinyComponentsItemsDestinyItemPlugComponent) o;
    return Objects.equals(this.canInsert, destinyComponentsItemsDestinyItemPlugComponent.canInsert) &&
        Objects.equals(this.enableFailIndexes, destinyComponentsItemsDestinyItemPlugComponent.enableFailIndexes) &&
        Objects.equals(this.enabled, destinyComponentsItemsDestinyItemPlugComponent.enabled) &&
        Objects.equals(this.insertFailIndexes, destinyComponentsItemsDestinyItemPlugComponent.insertFailIndexes) &&
        Objects.equals(this.plugItemHash, destinyComponentsItemsDestinyItemPlugComponent.plugItemHash) &&
        Objects.equals(this.plugObjectives, destinyComponentsItemsDestinyItemPlugComponent.plugObjectives);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to DestinyComponentsItemsDestinyItemPlugComponent
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DestinyComponentsItemsDestinyItemPlugComponent.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DestinyComponentsItemsDestinyItemPlugComponent is not found in the empty JSON string", DestinyComponentsItemsDestinyItemPlugComponent.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DestinyComponentsItemsDestinyItemPlugComponent.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DestinyComponentsItemsDestinyItemPlugComponent` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DestinyComponentsItemsDestinyItemPlugComponent.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DestinyComponentsItemsDestinyItemPlugComponent' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DestinyComponentsItemsDestinyItemPlugComponent> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DestinyComponentsItemsDestinyItemPlugComponent.class));

       return (TypeAdapter<T>) new TypeAdapter<DestinyComponentsItemsDestinyItemPlugComponent>() {
           @Override
           public void write(JsonWriter out, DestinyComponentsItemsDestinyItemPlugComponent value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DestinyComponentsItemsDestinyItemPlugComponent read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DestinyComponentsItemsDestinyItemPlugComponent given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DestinyComponentsItemsDestinyItemPlugComponent
   * @throws IOException if the JSON string is invalid with respect to DestinyComponentsItemsDestinyItemPlugComponent
   */
  public static DestinyComponentsItemsDestinyItemPlugComponent fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DestinyComponentsItemsDestinyItemPlugComponent.class);
  }

  /**
   * Convert an instance of DestinyComponentsItemsDestinyItemPlugComponent to an JSON string
   *
   * @return JSON string
   */
