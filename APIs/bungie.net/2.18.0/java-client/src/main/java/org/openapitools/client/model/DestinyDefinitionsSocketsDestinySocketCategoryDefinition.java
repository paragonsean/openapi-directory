...
public class DestinyDefinitionsSocketsDestinySocketCategoryDefinition {
  public static final String SERIALIZED_NAME_CATEGORY_STYLE = "categoryStyle";
  @SerializedName(SERIALIZED_NAME_CATEGORY_STYLE)
  ...
  public static final String SERIALIZED_NAME_UI_CATEGORY_STYLE = "uiCategoryStyle";
  @SerializedName(SERIALIZED_NAME_UI_CATEGORY_STYLE)
  private Integer uiCategoryStyle;

  public DestinyDefinitionsSocketsDestinySocketCategoryDefinition() {
  }

  public DestinyDefinitionsSocketsDestinySocketCategoryDefinition categoryStyle(Integer categoryStyle) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.categoryStyle, destinyDefinitionsSocketsDestinySocketCategoryDefinition.categoryStyle) &&
        Objects.equals(this.displayProperties, destinyDefinitionsSocketsDestinySocketCategoryDefinition.displayProperties) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(categoryStyle, displayProperties, hash, index, redacted, uiCategoryStyle);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to DestinyDefinitionsSocketsDestinySocketCategoryDefinition
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DestinyDefinitionsSocketsDestinySocketCategoryDefinition.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DestinyDefinitionsSocketsDestinySocketCategoryDefinition is not found in the empty JSON string", DestinyDefinitionsSocketsDestinySocketCategoryDefinition.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DestinyDefinitionsSocketsDestinySocketCategoryDefinition.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DestinyDefinitionsSocketsDestinySocketCategoryDefinition` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DestinyDefinitionsSocketsDestinySocketCategoryDefinition.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DestinyDefinitionsSocketsDestinySocketCategoryDefinition' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DestinyDefinitionsSocketsDestinySocketCategoryDefinition> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DestinyDefinitionsSocketsDestinySocketCategoryDefinition.class));

       return (TypeAdapter<T>) new TypeAdapter<DestinyDefinitionsSocketsDestinySocketCategoryDefinition>() {
           @Override
           public void write(JsonWriter out, DestinyDefinitionsSocketsDestinySocketCategoryDefinition value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DestinyDefinitionsSocketsDestinySocketCategoryDefinition read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DestinyDefinitionsSocketsDestinySocketCategoryDefinition given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DestinyDefinitionsSocketsDestinySocketCategoryDefinition
   * @throws IOException if the JSON string is invalid with respect to DestinyDefinitionsSocketsDestinySocketCategoryDefinition
   */
  public static DestinyDefinitionsSocketsDestinySocketCategoryDefinition fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DestinyDefinitionsSocketsDestinySocketCategoryDefinition.class);
  }

  /**
   * Convert an instance of DestinyDefinitionsSocketsDestinySocketCategoryDefinition to an JSON string
   *
   * @return JSON string
   */
