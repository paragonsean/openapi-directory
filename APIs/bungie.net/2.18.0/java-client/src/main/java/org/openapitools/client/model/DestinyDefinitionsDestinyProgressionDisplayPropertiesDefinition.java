...
public class DestinyDefinitionsDestinyProgressionDisplayPropertiesDefinition {
  ...
  public static final String SERIALIZED_NAME_DISPLAY_UNITS_NAME = "displayUnitsName";
  @SerializedName(SERIALIZED_NAME_DISPLAY_UNITS_NAME)
  private String displayUnitsName;
  ...
  public DestinyDefinitionsDestinyProgressionDisplayPropertiesDefinition highResIcon(String highResIcon) {
  ...
  public DestinyDefinitionsDestinyProgressionDisplayPropertiesDefinition iconSequences(List<DestinyDefinitionsCommonDestinyIconSequenceDefinition> iconSequences) {
    this.iconSequences = iconSequences;
    return this;
  }

  public DestinyDefinitionsDestinyProgressionDisplayPropertiesDefinition addIconSequencesItem(DestinyDefinitionsCommonDestinyIconSequenceDefinition iconSequencesItem) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.description, destinyDefinitionsDestinyProgressionDisplayPropertiesDefinition.description) &&
        Objects.equals(this.displayUnitsName, destinyDefinitionsDestinyProgressionDisplayPropertiesDefinition.displayUnitsName) &&
        Objects.equals(this.hasIcon, destinyDefinitionsDestinyProgressionDisplayPropertiesDefinition.hasIcon) &&
        Objects.equals(this.highResIcon, destinyDefinitionsDestinyProgressionDisplayPropertiesDefinition.highResIcon) &&
        Objects.equals(this.icon, destinyDefinitionsDestinyProgressionDisplayPropertiesDefinition.icon) &&
        Objects.equals(this.iconSequences, destinyDefinitionsDestinyProgressionDisplayPropertiesDefinition.iconSequences) &&
        Objects.equals(this.name, destinyDefinitionsDestinyProgressionDisplayPropertiesDefinition.name);
  }

  @Override
  public int hashCode() {
    return Objects.hash(description, displayUnitsName, hasIcon, highResIcon, icon, iconSequences, name);
  }
  ...
  static {
    ...
    openapiFields.add("displayUnitsName");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DestinyDefinitionsDestinyProgressionDisplayPropertiesDefinition
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DestinyDefinitionsDestinyProgressionDisplayPropertiesDefinition.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DestinyDefinitionsDestinyProgressionDisplayPropertiesDefinition is not found in the empty JSON string", DestinyDefinitionsDestinyProgressionDisplayPropertiesDefinition.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DestinyDefinitionsDestinyProgressionDisplayPropertiesDefinition.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DestinyDefinitionsDestinyProgressionDisplayPropertiesDefinition` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if ((jsonObj.get("displayUnitsName") != null && !jsonObj.get("displayUnitsName").isJsonNull()) && !jsonObj.get("displayUnitsName").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `displayUnitsName` to be a primitive type in the JSON string but got `%s`", jsonObj.get("displayUnitsName").toString()));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DestinyDefinitionsDestinyProgressionDisplayPropertiesDefinition.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DestinyDefinitionsDestinyProgressionDisplayPropertiesDefinition' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DestinyDefinitionsDestinyProgressionDisplayPropertiesDefinition> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DestinyDefinitionsDestinyProgressionDisplayPropertiesDefinition.class));

       return (TypeAdapter<T>) new TypeAdapter<DestinyDefinitionsDestinyProgressionDisplayPropertiesDefinition>() {
           @Override
           public void write(JsonWriter out, DestinyDefinitionsDestinyProgressionDisplayPropertiesDefinition value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DestinyDefinitionsDestinyProgressionDisplayPropertiesDefinition read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DestinyDefinitionsDestinyProgressionDisplayPropertiesDefinition given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DestinyDefinitionsDestinyProgressionDisplayPropertiesDefinition
   * @throws IOException if the JSON string is invalid with respect to DestinyDefinitionsDestinyProgressionDisplayPropertiesDefinition
   */
  public static DestinyDefinitionsDestinyProgressionDisplayPropertiesDefinition fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DestinyDefinitionsDestinyProgressionDisplayPropertiesDefinition.class);
  }

  /**
   * Convert an instance of DestinyDefinitionsDestinyProgressionDisplayPropertiesDefinition to an JSON string
   *
   * @return JSON string
   */
