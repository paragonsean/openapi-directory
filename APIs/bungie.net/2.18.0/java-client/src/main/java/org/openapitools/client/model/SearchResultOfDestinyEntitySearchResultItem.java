...
public class SearchResultOfDestinyEntitySearchResultItem {
  ...
  private List<DestinyDefinitionsDestinyEntitySearchResultItem> results = new ArrayList<>();
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.hasMore, searchResultOfDestinyEntitySearchResultItem.hasMore) &&
        ...
        Objects.equals(this.results, searchResultOfDestinyEntitySearchResultItem.results) &&
   ...
   * @throws IOException if the JSON Element is invalid with respect to SearchResultOfDestinyEntitySearchResultItem
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SearchResultOfDestinyEntitySearchResultItem.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SearchResultOfDestinyEntitySearchResultItem is not found in the empty JSON string", SearchResultOfDestinyEntitySearchResultItem.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SearchResultOfDestinyEntitySearchResultItem.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SearchResultOfDestinyEntitySearchResultItem` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("results") != null && !jsonObj.get("results").isJsonNull()) {
        ...
        if (jsonArrayresults != null) {
          ...
          for (int i = 0; i < jsonArrayresults.size(); i++) {
            DestinyDefinitionsDestinyEntitySearchResultItem.validateJsonElement(jsonArrayresults.get(i));
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SearchResultOfDestinyEntitySearchResultItem.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SearchResultOfDestinyEntitySearchResultItem' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SearchResultOfDestinyEntitySearchResultItem> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SearchResultOfDestinyEntitySearchResultItem.class));

       return (TypeAdapter<T>) new TypeAdapter<SearchResultOfDestinyEntitySearchResultItem>() {
           @Override
           public void write(JsonWriter out, SearchResultOfDestinyEntitySearchResultItem value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SearchResultOfDestinyEntitySearchResultItem read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SearchResultOfDestinyEntitySearchResultItem given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SearchResultOfDestinyEntitySearchResultItem
   * @throws IOException if the JSON string is invalid with respect to SearchResultOfDestinyEntitySearchResultItem
   */
  public static SearchResultOfDestinyEntitySearchResultItem fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SearchResultOfDestinyEntitySearchResultItem.class);
  }

  /**
   * Convert an instance of SearchResultOfDestinyEntitySearchResultItem to an JSON string
   *
   * @return JSON string
   */
