...
public class DestinyProgressionDestinyFactionProgression {
  ...
  public static final String SERIALIZED_NAME_FACTION_VENDOR_INDEX = "factionVendorIndex";
  @SerializedName(SERIALIZED_NAME_FACTION_VENDOR_INDEX)
  private Integer factionVendorIndex;
  ...
  public DestinyProgressionDestinyFactionProgression currentResetCount(Integer currentResetCount) {
  ...
  public DestinyProgressionDestinyFactionProgression rewardItemStates(List<Integer> rewardItemStates) {
    this.rewardItemStates = rewardItemStates;
    return this;
  }

  public DestinyProgressionDestinyFactionProgression addRewardItemStatesItem(Integer rewardItemStatesItem) {
  ...
  public DestinyProgressionDestinyFactionProgression seasonResets(List<DestinyDestinyProgressionResetEntry> seasonResets) {
    this.seasonResets = seasonResets;
    return this;
  }

  public DestinyProgressionDestinyFactionProgression addSeasonResetsItem(DestinyDestinyProgressionResetEntry seasonResetsItem) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.currentProgress, destinyProgressionDestinyFactionProgression.currentProgress) &&
        Objects.equals(this.currentResetCount, destinyProgressionDestinyFactionProgression.currentResetCount) &&
        ...
        Objects.equals(this.factionHash, destinyProgressionDestinyFactionProgression.factionHash) &&
        ...
        Objects.equals(this.rewardItemStates, destinyProgressionDestinyFactionProgression.rewardItemStates) &&
        Objects.equals(this.seasonResets, destinyProgressionDestinyFactionProgression.seasonResets) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(currentProgress, currentResetCount, dailyLimit, dailyProgress, factionHash, factionVendorIndex, level, levelCap, nextLevelAt, progressToNextLevel, progressionHash, rewardItemStates, seasonResets, stepIndex, weeklyLimit, weeklyProgress);
  }
  ...
  static {
    ...
    openapiFields.add("factionVendorIndex");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DestinyProgressionDestinyFactionProgression
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DestinyProgressionDestinyFactionProgression.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DestinyProgressionDestinyFactionProgression is not found in the empty JSON string", DestinyProgressionDestinyFactionProgression.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DestinyProgressionDestinyFactionProgression.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DestinyProgressionDestinyFactionProgression` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DestinyProgressionDestinyFactionProgression.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DestinyProgressionDestinyFactionProgression' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DestinyProgressionDestinyFactionProgression> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DestinyProgressionDestinyFactionProgression.class));

       return (TypeAdapter<T>) new TypeAdapter<DestinyProgressionDestinyFactionProgression>() {
           @Override
           public void write(JsonWriter out, DestinyProgressionDestinyFactionProgression value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DestinyProgressionDestinyFactionProgression read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DestinyProgressionDestinyFactionProgression given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DestinyProgressionDestinyFactionProgression
   * @throws IOException if the JSON string is invalid with respect to DestinyProgressionDestinyFactionProgression
   */
  public static DestinyProgressionDestinyFactionProgression fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DestinyProgressionDestinyFactionProgression.class);
  }

  /**
   * Convert an instance of DestinyProgressionDestinyFactionProgression to an JSON string
   *
   * @return JSON string
   */
