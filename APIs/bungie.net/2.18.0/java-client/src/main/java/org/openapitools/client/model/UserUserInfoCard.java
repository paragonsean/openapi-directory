...
public class UserUserInfoCard {
  ...
  public UserUserInfoCard applicableMembershipTypes(List<Integer> applicableMembershipTypes) {
    this.applicableMembershipTypes = applicableMembershipTypes;
    return this;
  }

  public UserUserInfoCard addApplicableMembershipTypesItem(Integer applicableMembershipTypesItem) {
  ...
  public UserUserInfoCard bungieGlobalDisplayName(String bungieGlobalDisplayName) {
  ...
  public UserUserInfoCard bungieGlobalDisplayNameCode(Integer bungieGlobalDisplayNameCode) {
  ...
  public UserUserInfoCard crossSaveOverride(Integer crossSaveOverride) {
  ...
  public UserUserInfoCard isPublic(Boolean isPublic) {
  ...
  public UserUserInfoCard membershipType(Integer membershipType) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.applicableMembershipTypes, userUserInfoCard.applicableMembershipTypes) &&
        Objects.equals(this.bungieGlobalDisplayName, userUserInfoCard.bungieGlobalDisplayName) &&
        Objects.equals(this.bungieGlobalDisplayNameCode, userUserInfoCard.bungieGlobalDisplayNameCode) &&
        Objects.equals(this.crossSaveOverride, userUserInfoCard.crossSaveOverride) &&
        Objects.equals(this.displayName, userUserInfoCard.displayName) &&
        Objects.equals(this.iconPath, userUserInfoCard.iconPath) &&
        Objects.equals(this.isPublic, userUserInfoCard.isPublic) &&
        ...
        Objects.equals(this.supplementalDisplayName, userUserInfoCard.supplementalDisplayName);
  }

  @Override
  public int hashCode() {
    return Objects.hash(applicableMembershipTypes, bungieGlobalDisplayName, bungieGlobalDisplayNameCode, crossSaveOverride, displayName, iconPath, isPublic, membershipId, membershipType, supplementalDisplayName);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to UserUserInfoCard
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UserUserInfoCard.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UserUserInfoCard is not found in the empty JSON string", UserUserInfoCard.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UserUserInfoCard.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UserUserInfoCard` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UserUserInfoCard.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UserUserInfoCard' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UserUserInfoCard> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UserUserInfoCard.class));

       return (TypeAdapter<T>) new TypeAdapter<UserUserInfoCard>() {
           @Override
           public void write(JsonWriter out, UserUserInfoCard value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UserUserInfoCard read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UserUserInfoCard given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UserUserInfoCard
   * @throws IOException if the JSON string is invalid with respect to UserUserInfoCard
   */
  public static UserUserInfoCard fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UserUserInfoCard.class);
  }

  /**
   * Convert an instance of UserUserInfoCard to an JSON string
   *
   * @return JSON string
   */
