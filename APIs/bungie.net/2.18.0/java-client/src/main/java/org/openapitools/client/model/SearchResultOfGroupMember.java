...
public class SearchResultOfGroupMember {
  ...
  private List<GroupsV2GroupMember> results = new ArrayList<>();
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.hasMore, searchResultOfGroupMember.hasMore) &&
        ...
        Objects.equals(this.results, searchResultOfGroupMember.results) &&
   ...
   * @throws IOException if the JSON Element is invalid with respect to SearchResultOfGroupMember
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SearchResultOfGroupMember.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SearchResultOfGroupMember is not found in the empty JSON string", SearchResultOfGroupMember.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SearchResultOfGroupMember.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SearchResultOfGroupMember` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("results") != null && !jsonObj.get("results").isJsonNull()) {
        ...
        if (jsonArrayresults != null) {
          ...
          for (int i = 0; i < jsonArrayresults.size(); i++) {
            GroupsV2GroupMember.validateJsonElement(jsonArrayresults.get(i));
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SearchResultOfGroupMember.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SearchResultOfGroupMember' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SearchResultOfGroupMember> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SearchResultOfGroupMember.class));

       return (TypeAdapter<T>) new TypeAdapter<SearchResultOfGroupMember>() {
           @Override
           public void write(JsonWriter out, SearchResultOfGroupMember value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SearchResultOfGroupMember read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SearchResultOfGroupMember given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SearchResultOfGroupMember
   * @throws IOException if the JSON string is invalid with respect to SearchResultOfGroupMember
   */
  public static SearchResultOfGroupMember fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SearchResultOfGroupMember.class);
  }

  /**
   * Convert an instance of SearchResultOfGroupMember to an JSON string
   *
   * @return JSON string
   */
