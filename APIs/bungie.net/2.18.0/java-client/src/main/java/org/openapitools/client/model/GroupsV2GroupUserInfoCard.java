...
public class GroupsV2GroupUserInfoCard {
  public static final String SERIALIZED_NAME_LAST_SEEN_DISPLAY_NAME = "LastSeenDisplayName";
  @SerializedName(SERIALIZED_NAME_LAST_SEEN_DISPLAY_NAME)
  private String lastSeenDisplayName;

  public static final String SERIALIZED_NAME_LAST_SEEN_DISPLAY_NAME_TYPE = "LastSeenDisplayNameType";
  @SerializedName(SERIALIZED_NAME_LAST_SEEN_DISPLAY_NAME_TYPE)
  private Integer lastSeenDisplayNameType;
  ...
  public GroupsV2GroupUserInfoCard lastSeenDisplayName(String lastSeenDisplayName) {
  ...
  public void setLastSeenDisplayName(String lastSeenDisplayName) {
    this.lastSeenDisplayName = lastSeenDisplayName;
  }


  public GroupsV2GroupUserInfoCard lastSeenDisplayNameType(Integer lastSeenDisplayNameType) {
   ...
   */
  @javax.annotation.Nullable
  public Integer getLastSeenDisplayNameType() {
    return lastSeenDisplayNameType;
  }

  public void setLastSeenDisplayNameType(Integer lastSeenDisplayNameType) {
    this.lastSeenDisplayNameType = lastSeenDisplayNameType;
  }


  public GroupsV2GroupUserInfoCard applicableMembershipTypes(List<Integer> applicableMembershipTypes) {
    this.applicableMembershipTypes = applicableMembershipTypes;
    return this;
  }

  public GroupsV2GroupUserInfoCard addApplicableMembershipTypesItem(Integer applicableMembershipTypesItem) {
  ...
  public GroupsV2GroupUserInfoCard bungieGlobalDisplayName(String bungieGlobalDisplayName) {
  ...
  public GroupsV2GroupUserInfoCard bungieGlobalDisplayNameCode(Integer bungieGlobalDisplayNameCode) {
  ...
  public GroupsV2GroupUserInfoCard crossSaveOverride(Integer crossSaveOverride) {
  ...
  public GroupsV2GroupUserInfoCard displayName(String displayName) {
  ...
  public GroupsV2GroupUserInfoCard iconPath(String iconPath) {
  ...
  public GroupsV2GroupUserInfoCard isPublic(Boolean isPublic) {
  ...
  public GroupsV2GroupUserInfoCard membershipId(Long membershipId) {
  ...
  public GroupsV2GroupUserInfoCard membershipType(Integer membershipType) {
  ...
  public GroupsV2GroupUserInfoCard supplementalDisplayName(String supplementalDisplayName) {
  ...
  public boolean equals(Object o) {
    ...
    GroupsV2GroupUserInfoCard groupsV2GroupUserInfoCard = (GroupsV2GroupUserInfoCard) o;
    return Objects.equals(this.lastSeenDisplayName, groupsV2GroupUserInfoCard.lastSeenDisplayName) &&
        Objects.equals(this.lastSeenDisplayNameType, groupsV2GroupUserInfoCard.lastSeenDisplayNameType) &&
        Objects.equals(this.applicableMembershipTypes, groupsV2GroupUserInfoCard.applicableMembershipTypes) &&
        Objects.equals(this.bungieGlobalDisplayName, groupsV2GroupUserInfoCard.bungieGlobalDisplayName) &&
        Objects.equals(this.bungieGlobalDisplayNameCode, groupsV2GroupUserInfoCard.bungieGlobalDisplayNameCode) &&
        Objects.equals(this.crossSaveOverride, groupsV2GroupUserInfoCard.crossSaveOverride) &&
        Objects.equals(this.displayName, groupsV2GroupUserInfoCard.displayName) &&
        Objects.equals(this.iconPath, groupsV2GroupUserInfoCard.iconPath) &&
        Objects.equals(this.isPublic, groupsV2GroupUserInfoCard.isPublic) &&
        Objects.equals(this.membershipId, groupsV2GroupUserInfoCard.membershipId) &&
        Objects.equals(this.membershipType, groupsV2GroupUserInfoCard.membershipType) &&
        Objects.equals(this.supplementalDisplayName, groupsV2GroupUserInfoCard.supplementalDisplayName);
  }

  @Override
  public int hashCode() {
    return Objects.hash(lastSeenDisplayName, lastSeenDisplayNameType, applicableMembershipTypes, bungieGlobalDisplayName, bungieGlobalDisplayNameCode, crossSaveOverride, displayName, iconPath, isPublic, membershipId, membershipType, supplementalDisplayName);
  }
  ...
  public String toString() {
    ...
    sb.append("    lastSeenDisplayName: ").append(toIndentedString(lastSeenDisplayName)).append("\n");
    sb.append("    lastSeenDisplayNameType: ").append(toIndentedString(lastSeenDisplayNameType)).append("\n");
  ...
  static {
    ...
    openapiFields.add("LastSeenDisplayName");
    openapiFields.add("LastSeenDisplayNameType");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GroupsV2GroupUserInfoCard
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GroupsV2GroupUserInfoCard.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GroupsV2GroupUserInfoCard is not found in the empty JSON string", GroupsV2GroupUserInfoCard.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GroupsV2GroupUserInfoCard.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GroupsV2GroupUserInfoCard` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      if ((jsonObj.get("LastSeenDisplayName") != null && !jsonObj.get("LastSeenDisplayName").isJsonNull()) && !jsonObj.get("LastSeenDisplayName").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `LastSeenDisplayName` to be a primitive type in the JSON string but got `%s`", jsonObj.get("LastSeenDisplayName").toString()));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GroupsV2GroupUserInfoCard.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GroupsV2GroupUserInfoCard' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GroupsV2GroupUserInfoCard> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GroupsV2GroupUserInfoCard.class));

       return (TypeAdapter<T>) new TypeAdapter<GroupsV2GroupUserInfoCard>() {
           @Override
           public void write(JsonWriter out, GroupsV2GroupUserInfoCard value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GroupsV2GroupUserInfoCard read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GroupsV2GroupUserInfoCard given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GroupsV2GroupUserInfoCard
   * @throws IOException if the JSON string is invalid with respect to GroupsV2GroupUserInfoCard
   */
  public static GroupsV2GroupUserInfoCard fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GroupsV2GroupUserInfoCard.class);
  }

  /**
   * Convert an instance of GroupsV2GroupUserInfoCard to an JSON string
   *
   * @return JSON string
   */
