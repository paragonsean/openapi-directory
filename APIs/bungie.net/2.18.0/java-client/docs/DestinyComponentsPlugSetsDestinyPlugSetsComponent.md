...
|------------ | ------------- | ------------- | -------------|
|**plugs** | **Map&lt;String, List&lt;DestinySocketsDestinyItemPlug&gt;&gt;** | The shared list of plugs for each relevant PlugSet, keyed by the hash identifier of the PlugSet (DestinyPlugSetDefinition). |  [optional] |
