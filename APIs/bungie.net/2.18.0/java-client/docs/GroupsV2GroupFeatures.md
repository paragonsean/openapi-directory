...
|**hostGuidedGamePermissionOverride** | **Integer** | Minimum Member Level allowed to host guided games  Always Allowed: Founder, Acting Founder, Admin  Allowed Overrides: None, Member, Beginner  Default is Member for clans, None for groups, although this means nothing for groups. |  [optional] |
...
|**joinLevel** | **Integer** | Level to join a member at when accepting an invite, application, or joining an open clan  Default is Beginner. |  [optional] |
...
|**membershipTypes** | **List&lt;Integer&gt;** |  |  [optional] |
