...
|------------ | ------------- | ------------- | -------------|
|**creationDate** | **OffsetDateTime** | If the entry has a date at which it was created, this is that date. |  [optional] |
|**displayName** | **String** | The localized \&quot;display name/article title/&#39;primary localized identifier&#39;\&quot; of the entity. |  [optional] |
|**endDate** | **OffsetDateTime** |  |  [optional] |
|**entityType** | **Integer** | An enum - unfortunately - dictating all of the possible kinds of trending items that you might get in your result set, in case you want to do custom rendering or call to get the details of the item. |  [optional] |
