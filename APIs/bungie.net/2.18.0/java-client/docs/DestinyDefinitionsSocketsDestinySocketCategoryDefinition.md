...
|------------ | ------------- | ------------- | -------------|
|**categoryStyle** | **Integer** | Same as uiCategoryStyle, but in a more usable enumeration form. |  [optional] |
...
|**uiCategoryStyle** | **Integer** | A string hinting to the game&#39;s UI system about how the sockets in this category should be displayed.  BNet doesn&#39;t use it: it&#39;s up to you to find valid values and make your own special UI if you want to honor this category style. |  [optional] |
