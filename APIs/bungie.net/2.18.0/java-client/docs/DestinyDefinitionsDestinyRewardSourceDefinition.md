...
|------------ | ------------- | ------------- | -------------|
|**category** | **Integer** | Sources are grouped into categories: common ways that items are provided. I hope to see this expand in Destiny 2 once we have time to generate accurate reward source data. |  [optional] |
