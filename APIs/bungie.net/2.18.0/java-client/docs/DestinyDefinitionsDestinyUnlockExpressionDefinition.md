...
|------------ | ------------- | ------------- | -------------|
|**scope** | **Integer** | A shortcut for determining the most restrictive gating that this expression performs. See the DestinyGatingScope enum&#39;s documentation for more details. |  [optional] |
