...
/*
 * OAIDestiny2_SearchDestinyEntities_200_response.h
 *
 * 
 */

#ifndef OAIDestiny2_SearchDestinyEntities_200_response_H
#define OAIDestiny2_SearchDestinyEntities_200_response_H
...
namespace OpenAPI {
class OAIDestiny_Definitions_DestinyEntitySearchResult;

class OAIDestiny2_SearchDestinyEntities_200_response : public OAIObject {
public:
    OAIDestiny2_SearchDestinyEntities_200_response();
    OAIDestiny2_SearchDestinyEntities_200_response(QString json);
    ~OAIDestiny2_SearchDestinyEntities_200_response() override;
    ...
    OAIDestiny_Definitions_DestinyEntitySearchResult getResponse() const;
    void setResponse(const OAIDestiny_Definitions_DestinyEntitySearchResult &response);
...
private:
    ...
    OAIDestiny_Definitions_DestinyEntitySearchResult m_response;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDestiny2_SearchDestinyEntities_200_response)

#endif // OAIDestiny2_SearchDestinyEntities_200_response_H
