...
/*
 * OAITrending_GetTrendingEntryDetail_200_response.h
 *
 * 
 */

#ifndef OAITrending_GetTrendingEntryDetail_200_response_H
#define OAITrending_GetTrendingEntryDetail_200_response_H
...
namespace OpenAPI {
class OAITrending_TrendingDetail;

class OAITrending_GetTrendingEntryDetail_200_response : public OAIObject {
public:
    OAITrending_GetTrendingEntryDetail_200_response();
    OAITrending_GetTrendingEntryDetail_200_response(QString json);
    ~OAITrending_GetTrendingEntryDetail_200_response() override;
    ...
    OAITrending_TrendingDetail getResponse() const;
    void setResponse(const OAITrending_TrendingDetail &response);
...
private:
    ...
    OAITrending_TrendingDetail m_response;
...
Q_DECLARE_METATYPE(OpenAPI::OAITrending_GetTrendingEntryDetail_200_response)

#endif // OAITrending_GetTrendingEntryDetail_200_response_H
