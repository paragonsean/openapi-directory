...
/*
 * OAI_GetCommonSettings_200_response.h
 *
 * 
 */

#ifndef OAI_GetCommonSettings_200_response_H
#define OAI_GetCommonSettings_200_response_H
...
namespace OpenAPI {
class OAICommon_Models_CoreSettingsConfiguration;

class OAI_GetCommonSettings_200_response : public OAIObject {
public:
    OAI_GetCommonSettings_200_response();
    OAI_GetCommonSettings_200_response(QString json);
    ~OAI_GetCommonSettings_200_response() override;
    ...
    OAICommon_Models_CoreSettingsConfiguration getResponse() const;
    void setResponse(const OAICommon_Models_CoreSettingsConfiguration &response);
...
private:
    ...
    OAICommon_Models_CoreSettingsConfiguration m_response;
...
Q_DECLARE_METATYPE(OpenAPI::OAI_GetCommonSettings_200_response)

#endif // OAI_GetCommonSettings_200_response_H
