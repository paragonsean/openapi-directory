...
/*
 * OAIGroupV2_IndividualGroupInvite_200_response.h
 *
 * 
 */

#ifndef OAIGroupV2_IndividualGroupInvite_200_response_H
#define OAIGroupV2_IndividualGroupInvite_200_response_H
...
namespace OpenAPI {
class OAIGroupsV2_GroupApplicationResponse;

class OAIGroupV2_IndividualGroupInvite_200_response : public OAIObject {
public:
    OAIGroupV2_IndividualGroupInvite_200_response();
    OAIGroupV2_IndividualGroupInvite_200_response(QString json);
    ~OAIGroupV2_IndividualGroupInvite_200_response() override;
    ...
    OAIGroupsV2_GroupApplicationResponse getResponse() const;
    void setResponse(const OAIGroupsV2_GroupApplicationResponse &response);
...
private:
    ...
    OAIGroupsV2_GroupApplicationResponse m_response;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGroupV2_IndividualGroupInvite_200_response)

#endif // OAIGroupV2_IndividualGroupInvite_200_response_H
