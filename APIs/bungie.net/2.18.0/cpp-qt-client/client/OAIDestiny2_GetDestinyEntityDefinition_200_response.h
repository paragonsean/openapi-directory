...
/*
 * OAIDestiny2_GetDestinyEntityDefinition_200_response.h
 *
 * 
 */

#ifndef OAIDestiny2_GetDestinyEntityDefinition_200_response_H
#define OAIDestiny2_GetDestinyEntityDefinition_200_response_H
...
namespace OpenAPI {
class OAIDestiny_Definitions_DestinyDefinition;

class OAIDestiny2_GetDestinyEntityDefinition_200_response : public OAIObject {
public:
    OAIDestiny2_GetDestinyEntityDefinition_200_response();
    OAIDestiny2_GetDestinyEntityDefinition_200_response(QString json);
    ~OAIDestiny2_GetDestinyEntityDefinition_200_response() override;
    ...
    OAIDestiny_Definitions_DestinyDefinition getResponse() const;
    void setResponse(const OAIDestiny_Definitions_DestinyDefinition &response);
...
private:
    ...
    OAIDestiny_Definitions_DestinyDefinition m_response;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDestiny2_GetDestinyEntityDefinition_200_response)

#endif // OAIDestiny2_GetDestinyEntityDefinition_200_response_H
