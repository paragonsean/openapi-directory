...
/*
 * OAIGroupV2_GroupSearch_200_response.h
 *
 * 
 */

#ifndef OAIGroupV2_GroupSearch_200_response_H
#define OAIGroupV2_GroupSearch_200_response_H
...
namespace OpenAPI {
class OAIGroupsV2_GroupSearchResponse;

class OAIGroupV2_GroupSearch_200_response : public OAIObject {
public:
    OAIGroupV2_GroupSearch_200_response();
    OAIGroupV2_GroupSearch_200_response(QString json);
    ~OAIGroupV2_GroupSearch_200_response() override;
    ...
    OAIGroupsV2_GroupSearchResponse getResponse() const;
    void setResponse(const OAIGroupsV2_GroupSearchResponse &response);
...
private:
    ...
    OAIGroupsV2_GroupSearchResponse m_response;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGroupV2_GroupSearch_200_response)

#endif // OAIGroupV2_GroupSearch_200_response_H
