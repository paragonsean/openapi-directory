...
/*
 * OAIDestiny2_GetLinkedProfiles_200_response.h
 *
 * 
 */

#ifndef OAIDestiny2_GetLinkedProfiles_200_response_H
#define OAIDestiny2_GetLinkedProfiles_200_response_H
...
namespace OpenAPI {
class OAIDestiny_Responses_DestinyLinkedProfilesResponse;

class OAIDestiny2_GetLinkedProfiles_200_response : public OAIObject {
public:
    OAIDestiny2_GetLinkedProfiles_200_response();
    OAIDestiny2_GetLinkedProfiles_200_response(QString json);
    ~OAIDestiny2_GetLinkedProfiles_200_response() override;
    ...
    OAIDestiny_Responses_DestinyLinkedProfilesResponse getResponse() const;
    void setResponse(const OAIDestiny_Responses_DestinyLinkedProfilesResponse &response);
...
private:
    ...
    OAIDestiny_Responses_DestinyLinkedProfilesResponse m_response;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDestiny2_GetLinkedProfiles_200_response)

#endif // OAIDestiny2_GetLinkedProfiles_200_response_H
