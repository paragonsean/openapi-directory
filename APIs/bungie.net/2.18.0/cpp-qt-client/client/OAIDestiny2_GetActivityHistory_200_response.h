...
/*
 * OAIDestiny2_GetActivityHistory_200_response.h
 *
 * 
 */

#ifndef OAIDestiny2_GetActivityHistory_200_response_H
#define OAIDestiny2_GetActivityHistory_200_response_H
...
namespace OpenAPI {
class OAIDestiny_HistoricalStats_DestinyActivityHistoryResults;

class OAIDestiny2_GetActivityHistory_200_response : public OAIObject {
public:
    OAIDestiny2_GetActivityHistory_200_response();
    OAIDestiny2_GetActivityHistory_200_response(QString json);
    ~OAIDestiny2_GetActivityHistory_200_response() override;
    ...
    OAIDestiny_HistoricalStats_DestinyActivityHistoryResults getResponse() const;
    void setResponse(const OAIDestiny_HistoricalStats_DestinyActivityHistoryResults &response);
...
private:
    ...
    OAIDestiny_HistoricalStats_DestinyActivityHistoryResults m_response;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDestiny2_GetActivityHistory_200_response)

#endif // OAIDestiny2_GetActivityHistory_200_response_H
