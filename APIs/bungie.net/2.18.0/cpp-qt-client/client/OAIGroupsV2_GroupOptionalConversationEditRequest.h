...
/*
 * OAIGroupsV2_GroupOptionalConversationEditRequest.h
 *
 * 
 */

#ifndef OAIGroupsV2_GroupOptionalConversationEditRequest_H
#define OAIGroupsV2_GroupOptionalConversationEditRequest_H
...
class OAIGroupsV2_GroupOptionalConversationEditRequest : public OAIObject {
public:
    OAIGroupsV2_GroupOptionalConversationEditRequest();
    OAIGroupsV2_GroupOptionalConversationEditRequest(QString json);
    ~OAIGroupsV2_GroupOptionalConversationEditRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGroupsV2_GroupOptionalConversationEditRequest)

#endif // OAIGroupsV2_GroupOptionalConversationEditRequest_H
