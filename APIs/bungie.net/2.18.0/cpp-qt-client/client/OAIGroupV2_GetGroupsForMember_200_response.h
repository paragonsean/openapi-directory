...
/*
 * OAIGroupV2_GetGroupsForMember_200_response.h
 *
 * 
 */

#ifndef OAIGroupV2_GetGroupsForMember_200_response_H
#define OAIGroupV2_GetGroupsForMember_200_response_H
...
namespace OpenAPI {
class OAIGroupsV2_GetGroupsForMemberResponse;

class OAIGroupV2_GetGroupsForMember_200_response : public OAIObject {
public:
    OAIGroupV2_GetGroupsForMember_200_response();
    OAIGroupV2_GetGroupsForMember_200_response(QString json);
    ~OAIGroupV2_GetGroupsForMember_200_response() override;
    ...
    OAIGroupsV2_GetGroupsForMemberResponse getResponse() const;
    void setResponse(const OAIGroupsV2_GetGroupsForMemberResponse &response);
...
private:
    ...
    OAIGroupsV2_GetGroupsForMemberResponse m_response;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGroupV2_GetGroupsForMember_200_response)

#endif // OAIGroupV2_GetGroupsForMember_200_response_H
