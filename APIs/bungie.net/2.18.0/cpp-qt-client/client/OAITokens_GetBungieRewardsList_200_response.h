...
/*
 * OAITokens_GetBungieRewardsList_200_response.h
 *
 * 
 */

#ifndef OAITokens_GetBungieRewardsList_200_response_H
#define OAITokens_GetBungieRewardsList_200_response_H
...
namespace OpenAPI {
class OAITokens_BungieRewardDisplay;

class OAITokens_GetBungieRewardsList_200_response : public OAIObject {
public:
    OAITokens_GetBungieRewardsList_200_response();
    OAITokens_GetBungieRewardsList_200_response(QString json);
    ~OAITokens_GetBungieRewardsList_200_response() override;
    ...
    QMap<QString, OAITokens_BungieRewardDisplay> getResponse() const;
    void setResponse(const QMap<QString, OAITokens_BungieRewardDisplay> &response);
...
private:
    ...
    QMap<QString, OAITokens_BungieRewardDisplay> m_response;
...
Q_DECLARE_METATYPE(OpenAPI::OAITokens_GetBungieRewardsList_200_response)

#endif // OAITokens_GetBungieRewardsList_200_response_H
