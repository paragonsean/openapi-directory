...
/*
 * OAIGroupV2_GetAvailableThemes_200_response.h
 *
 * 
 */

#ifndef OAIGroupV2_GetAvailableThemes_200_response_H
#define OAIGroupV2_GetAvailableThemes_200_response_H
...
namespace OpenAPI {
class OAIConfig_GroupTheme;

class OAIGroupV2_GetAvailableThemes_200_response : public OAIObject {
public:
    OAIGroupV2_GetAvailableThemes_200_response();
    OAIGroupV2_GetAvailableThemes_200_response(QString json);
    ~OAIGroupV2_GetAvailableThemes_200_response() override;
    ...
    QList<OAIConfig_GroupTheme> getResponse() const;
    void setResponse(const QList<OAIConfig_GroupTheme> &response);
...
private:
    ...
    QList<OAIConfig_GroupTheme> m_response;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGroupV2_GetAvailableThemes_200_response)

#endif // OAIGroupV2_GetAvailableThemes_200_response_H
