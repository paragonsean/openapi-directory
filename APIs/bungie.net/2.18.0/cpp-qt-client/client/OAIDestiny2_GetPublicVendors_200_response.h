...
/*
 * OAIDestiny2_GetPublicVendors_200_response.h
 *
 * 
 */

#ifndef OAIDestiny2_GetPublicVendors_200_response_H
#define OAIDestiny2_GetPublicVendors_200_response_H
...
namespace OpenAPI {
class OAIDestiny_Responses_DestinyPublicVendorsResponse;

class OAIDestiny2_GetPublicVendors_200_response : public OAIObject {
public:
    OAIDestiny2_GetPublicVendors_200_response();
    OAIDestiny2_GetPublicVendors_200_response(QString json);
    ~OAIDestiny2_GetPublicVendors_200_response() override;
    ...
    OAIDestiny_Responses_DestinyPublicVendorsResponse getResponse() const;
    void setResponse(const OAIDestiny_Responses_DestinyPublicVendorsResponse &response);
...
private:
    ...
    OAIDestiny_Responses_DestinyPublicVendorsResponse m_response;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDestiny2_GetPublicVendors_200_response)

#endif // OAIDestiny2_GetPublicVendors_200_response_H
