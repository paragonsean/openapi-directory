...
/*
 * OAIDestiny2_GetClanLeaderboards_200_response.h
 *
 * 
 */

#ifndef OAIDestiny2_GetClanLeaderboards_200_response_H
#define OAIDestiny2_GetClanLeaderboards_200_response_H
...
namespace OpenAPI {
class OAIDestiny_HistoricalStats_DestinyLeaderboard;

class OAIDestiny2_GetClanLeaderboards_200_response : public OAIObject {
public:
    OAIDestiny2_GetClanLeaderboards_200_response();
    OAIDestiny2_GetClanLeaderboards_200_response(QString json);
    ~OAIDestiny2_GetClanLeaderboards_200_response() override;
    ...
    QMap<QString, QMap<QString, OAIDestiny_HistoricalStats_DestinyLeaderboard>> getResponse() const;
    void setResponse(const QMap<QString, QMap<QString, OAIDestiny_HistoricalStats_DestinyLeaderboard>> &response);
...
private:
    ...
    QMap<QString, QMap<QString, OAIDestiny_HistoricalStats_DestinyLeaderboard>> m_response;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDestiny2_GetClanLeaderboards_200_response)

#endif // OAIDestiny2_GetClanLeaderboards_200_response_H
