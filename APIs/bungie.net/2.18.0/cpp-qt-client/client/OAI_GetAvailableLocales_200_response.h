...
/*
 * OAI_GetAvailableLocales_200_response.h
 *
 * 
 */

#ifndef OAI_GetAvailableLocales_200_response_H
#define OAI_GetAvailableLocales_200_response_H
...
class OAI_GetAvailableLocales_200_response : public OAIObject {
public:
    OAI_GetAvailableLocales_200_response();
    OAI_GetAvailableLocales_200_response(QString json);
    ~OAI_GetAvailableLocales_200_response() override;
    ...
    QMap<QString, QString> getResponse() const;
    void setResponse(const QMap<QString, QString> &response);
...
Q_DECLARE_METATYPE(OpenAPI::OAI_GetAvailableLocales_200_response)

#endif // OAI_GetAvailableLocales_200_response_H
