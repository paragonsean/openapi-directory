...
/*
 * OAIUser_SearchByGlobalNamePost_200_response.h
 *
 * 
 */

#ifndef OAIUser_SearchByGlobalNamePost_200_response_H
#define OAIUser_SearchByGlobalNamePost_200_response_H
...
namespace OpenAPI {
class OAIUser_UserSearchResponse;

class OAIUser_SearchByGlobalNamePost_200_response : public OAIObject {
public:
    OAIUser_SearchByGlobalNamePost_200_response();
    OAIUser_SearchByGlobalNamePost_200_response(QString json);
    ~OAIUser_SearchByGlobalNamePost_200_response() override;
    ...
    OAIUser_UserSearchResponse getResponse() const;
    void setResponse(const OAIUser_UserSearchResponse &response);
...
private:
    ...
    OAIUser_UserSearchResponse m_response;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUser_SearchByGlobalNamePost_200_response)

#endif // OAIUser_SearchByGlobalNamePost_200_response_H
