...
/*
 * OAIForum_GetForumTagSuggestions_200_response.h
 *
 * 
 */

#ifndef OAIForum_GetForumTagSuggestions_200_response_H
#define OAIForum_GetForumTagSuggestions_200_response_H
...
class OAIForum_GetForumTagSuggestions_200_response : public OAIObject {
public:
    OAIForum_GetForumTagSuggestions_200_response();
    OAIForum_GetForumTagSuggestions_200_response(QString json);
    ~OAIForum_GetForumTagSuggestions_200_response() override;
    ...
    QList<OAITags_Models_Contracts_TagResponse> getResponse() const;
    void setResponse(const QList<OAITags_Models_Contracts_TagResponse> &response);
...
private:
    ...
    QList<OAITags_Models_Contracts_TagResponse> m_response;
...
Q_DECLARE_METATYPE(OpenAPI::OAIForum_GetForumTagSuggestions_200_response)

#endif // OAIForum_GetForumTagSuggestions_200_response_H
