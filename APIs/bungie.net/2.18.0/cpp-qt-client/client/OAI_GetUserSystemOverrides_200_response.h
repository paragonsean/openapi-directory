...
/*
 * OAI_GetUserSystemOverrides_200_response.h
 *
 * 
 */

#ifndef OAI_GetUserSystemOverrides_200_response_H
#define OAI_GetUserSystemOverrides_200_response_H
...
class OAI_GetUserSystemOverrides_200_response : public OAIObject {
public:
    OAI_GetUserSystemOverrides_200_response();
    OAI_GetUserSystemOverrides_200_response(QString json);
    ~OAI_GetUserSystemOverrides_200_response() override;
    ...
    QMap<QString, OAICommon_Models_CoreSystem> getResponse() const;
    void setResponse(const QMap<QString, OAICommon_Models_CoreSystem> &response);
...
private:
    ...
    QMap<QString, OAICommon_Models_CoreSystem> m_response;
...
Q_DECLARE_METATYPE(OpenAPI::OAI_GetUserSystemOverrides_200_response)

#endif // OAI_GetUserSystemOverrides_200_response_H
