...
/*
 * OAIDestiny_Definitions_Presentation_DestinyPresentationNodeBaseDefinition.h
 *
 * This is the base class for all presentation system children. Presentation Nodes, Records, Collectibles, and Metrics.
 */

#ifndef OAIDestiny_Definitions_Presentation_DestinyPresentationNodeBaseDefinition_H
#define OAIDestiny_Definitions_Presentation_DestinyPresentationNodeBaseDefinition_H
...
class OAIDestiny_Definitions_Presentation_DestinyPresentationNodeBaseDefinition : public OAIObject {
public:
    OAIDestiny_Definitions_Presentation_DestinyPresentationNodeBaseDefinition();
    OAIDestiny_Definitions_Presentation_DestinyPresentationNodeBaseDefinition(QString json);
    ~OAIDestiny_Definitions_Presentation_DestinyPresentationNodeBaseDefinition() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDestiny_Definitions_Presentation_DestinyPresentationNodeBaseDefinition)

#endif // OAIDestiny_Definitions_Presentation_DestinyPresentationNodeBaseDefinition_H
