...
/*
 * OAIFireteam_FireteamUserInfoCard.h
 *
 * 
 */

#ifndef OAIFireteam_FireteamUserInfoCard_H
#define OAIFireteam_FireteamUserInfoCard_H
...
class OAIFireteam_FireteamUserInfoCard : public OAIObject {
public:
    OAIFireteam_FireteamUserInfoCard();
    OAIFireteam_FireteamUserInfoCard(QString json);
    ~OAIFireteam_FireteamUserInfoCard() override;
    ...
    QString getFireteamDisplayName() const;
    void setFireteamDisplayName(const QString &fireteam_display_name);
    bool is_fireteam_display_name_Set() const;
    bool is_fireteam_display_name_Valid() const;

    qint32 getFireteamMembershipType() const;
    void setFireteamMembershipType(const qint32 &fireteam_membership_type);
    bool is_fireteam_membership_type_Set() const;
    bool is_fireteam_membership_type_Valid() const;
...
private:
    ...
    QString m_fireteam_display_name;
    bool m_fireteam_display_name_isSet;
    bool m_fireteam_display_name_isValid;

    qint32 m_fireteam_membership_type;
    bool m_fireteam_membership_type_isSet;
    bool m_fireteam_membership_type_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFireteam_FireteamUserInfoCard)

#endif // OAIFireteam_FireteamUserInfoCard_H
