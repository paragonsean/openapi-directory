...
/*
 * OAIGroupV2_GetGroupOptionalConversations_200_response.h
 *
 * 
 */

#ifndef OAIGroupV2_GetGroupOptionalConversations_200_response_H
#define OAIGroupV2_GetGroupOptionalConversations_200_response_H
...
namespace OpenAPI {
class OAIGroupsV2_GroupOptionalConversation;

class OAIGroupV2_GetGroupOptionalConversations_200_response : public OAIObject {
public:
    OAIGroupV2_GetGroupOptionalConversations_200_response();
    OAIGroupV2_GetGroupOptionalConversations_200_response(QString json);
    ~OAIGroupV2_GetGroupOptionalConversations_200_response() override;
    ...
    QList<OAIGroupsV2_GroupOptionalConversation> getResponse() const;
    void setResponse(const QList<OAIGroupsV2_GroupOptionalConversation> &response);
...
private:
    ...
    QList<OAIGroupsV2_GroupOptionalConversation> m_response;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGroupV2_GetGroupOptionalConversations_200_response)

#endif // OAIGroupV2_GetGroupOptionalConversations_200_response_H
