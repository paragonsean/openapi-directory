...
/*
 * OAI_GetGlobalAlerts_200_response.h
 *
 * 
 */

#ifndef OAI_GetGlobalAlerts_200_response_H
#define OAI_GetGlobalAlerts_200_response_H
...
namespace OpenAPI {
class OAIGlobalAlert;

class OAI_GetGlobalAlerts_200_response : public OAIObject {
public:
    OAI_GetGlobalAlerts_200_response();
    OAI_GetGlobalAlerts_200_response(QString json);
    ~OAI_GetGlobalAlerts_200_response() override;
    ...
    QList<OAIGlobalAlert> getResponse() const;
    void setResponse(const QList<OAIGlobalAlert> &response);
...
private:
    ...
    QList<OAIGlobalAlert> m_response;
...
Q_DECLARE_METATYPE(OpenAPI::OAI_GetGlobalAlerts_200_response)

#endif // OAI_GetGlobalAlerts_200_response_H
