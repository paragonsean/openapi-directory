...
/*
 * OAIDestiny2_GetHistoricalStats_200_response.h
 *
 * 
 */

#ifndef OAIDestiny2_GetHistoricalStats_200_response_H
#define OAIDestiny2_GetHistoricalStats_200_response_H
...
class OAIDestiny2_GetHistoricalStats_200_response : public OAIObject {
public:
    OAIDestiny2_GetHistoricalStats_200_response();
    OAIDestiny2_GetHistoricalStats_200_response(QString json);
    ~OAIDestiny2_GetHistoricalStats_200_response() override;
    ...
    QMap<QString, OAIDestiny_HistoricalStats_DestinyHistoricalStatsByPeriod> getResponse() const;
    void setResponse(const QMap<QString, OAIDestiny_HistoricalStats_DestinyHistoricalStatsByPeriod> &response);
...
private:
    ...
    QMap<QString, OAIDestiny_HistoricalStats_DestinyHistoricalStatsByPeriod> m_response;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDestiny2_GetHistoricalStats_200_response)

#endif // OAIDestiny2_GetHistoricalStats_200_response_H
