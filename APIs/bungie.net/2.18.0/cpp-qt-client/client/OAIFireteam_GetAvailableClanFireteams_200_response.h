...
/*
 * OAIFireteam_GetAvailableClanFireteams_200_response.h
 *
 * 
 */

#ifndef OAIFireteam_GetAvailableClanFireteams_200_response_H
#define OAIFireteam_GetAvailableClanFireteams_200_response_H
...
namespace OpenAPI {
class OAISearchResultOfFireteamSummary;

class OAIFireteam_GetAvailableClanFireteams_200_response : public OAIObject {
public:
    OAIFireteam_GetAvailableClanFireteams_200_response();
    OAIFireteam_GetAvailableClanFireteams_200_response(QString json);
    ~OAIFireteam_GetAvailableClanFireteams_200_response() override;
    ...
    OAISearchResultOfFireteamSummary getResponse() const;
    void setResponse(const OAISearchResultOfFireteamSummary &response);
...
private:
    ...
    OAISearchResultOfFireteamSummary m_response;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFireteam_GetAvailableClanFireteams_200_response)

#endif // OAIFireteam_GetAvailableClanFireteams_200_response_H
