...
/*
 * OAIDestiny2_GetPublicMilestoneContent_200_response.h
 *
 * 
 */

#ifndef OAIDestiny2_GetPublicMilestoneContent_200_response_H
#define OAIDestiny2_GetPublicMilestoneContent_200_response_H
...
class OAIDestiny2_GetPublicMilestoneContent_200_response : public OAIObject {
public:
    OAIDestiny2_GetPublicMilestoneContent_200_response();
    OAIDestiny2_GetPublicMilestoneContent_200_response(QString json);
    ~OAIDestiny2_GetPublicMilestoneContent_200_response() override;
    ...
    OAIDestiny_Milestones_DestinyMilestoneContent getResponse() const;
    void setResponse(const OAIDestiny_Milestones_DestinyMilestoneContent &response);
...
private:
    ...
    OAIDestiny_Milestones_DestinyMilestoneContent m_response;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDestiny2_GetPublicMilestoneContent_200_response)

#endif // OAIDestiny2_GetPublicMilestoneContent_200_response_H
