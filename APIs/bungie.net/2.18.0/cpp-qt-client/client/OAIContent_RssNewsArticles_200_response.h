...
/*
 * OAIContent_RssNewsArticles_200_response.h
 *
 * 
 */

#ifndef OAIContent_RssNewsArticles_200_response_H
#define OAIContent_RssNewsArticles_200_response_H
...
namespace OpenAPI {
class OAIContent_NewsArticleRssResponse;

class OAIContent_RssNewsArticles_200_response : public OAIObject {
public:
    OAIContent_RssNewsArticles_200_response();
    OAIContent_RssNewsArticles_200_response(QString json);
    ~OAIContent_RssNewsArticles_200_response() override;
    ...
    OAIContent_NewsArticleRssResponse getResponse() const;
    void setResponse(const OAIContent_NewsArticleRssResponse &response);
...
private:
    ...
    OAIContent_NewsArticleRssResponse m_response;
...
Q_DECLARE_METATYPE(OpenAPI::OAIContent_RssNewsArticles_200_response)

#endif // OAIContent_RssNewsArticles_200_response_H
