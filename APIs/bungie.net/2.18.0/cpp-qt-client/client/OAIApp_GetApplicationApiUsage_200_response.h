...
/*
 * OAIApp_GetApplicationApiUsage_200_response.h
 *
 * 
 */

#ifndef OAIApp_GetApplicationApiUsage_200_response_H
#define OAIApp_GetApplicationApiUsage_200_response_H
...
namespace OpenAPI {
class OAIApplications_ApiUsage;

class OAIApp_GetApplicationApiUsage_200_response : public OAIObject {
public:
    OAIApp_GetApplicationApiUsage_200_response();
    OAIApp_GetApplicationApiUsage_200_response(QString json);
    ~OAIApp_GetApplicationApiUsage_200_response() override;
    ...
    OAIApplications_ApiUsage getResponse() const;
    void setResponse(const OAIApplications_ApiUsage &response);
...
private:
    ...
    OAIApplications_ApiUsage m_response;
...
Q_DECLARE_METATYPE(OpenAPI::OAIApp_GetApplicationApiUsage_200_response)

#endif // OAIApp_GetApplicationApiUsage_200_response_H
