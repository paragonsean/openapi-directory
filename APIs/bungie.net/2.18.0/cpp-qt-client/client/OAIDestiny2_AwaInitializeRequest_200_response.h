...
/*
 * OAIDestiny2_AwaInitializeRequest_200_response.h
 *
 * 
 */

#ifndef OAIDestiny2_AwaInitializeRequest_200_response_H
#define OAIDestiny2_AwaInitializeRequest_200_response_H
...
namespace OpenAPI {
class OAIDestiny_Advanced_AwaInitializeResponse;

class OAIDestiny2_AwaInitializeRequest_200_response : public OAIObject {
public:
    OAIDestiny2_AwaInitializeRequest_200_response();
    OAIDestiny2_AwaInitializeRequest_200_response(QString json);
    ~OAIDestiny2_AwaInitializeRequest_200_response() override;
    ...
    OAIDestiny_Advanced_AwaInitializeResponse getResponse() const;
    void setResponse(const OAIDestiny_Advanced_AwaInitializeResponse &response);
...
private:
    ...
    OAIDestiny_Advanced_AwaInitializeResponse m_response;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDestiny2_AwaInitializeRequest_200_response)

#endif // OAIDestiny2_AwaInitializeRequest_200_response_H
