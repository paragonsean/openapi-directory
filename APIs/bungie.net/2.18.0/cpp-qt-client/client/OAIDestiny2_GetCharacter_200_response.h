...
/*
 * OAIDestiny2_GetCharacter_200_response.h
 *
 * 
 */

#ifndef OAIDestiny2_GetCharacter_200_response_H
#define OAIDestiny2_GetCharacter_200_response_H
...
namespace OpenAPI {
class OAIDestiny_Responses_DestinyCharacterResponse;

class OAIDestiny2_GetCharacter_200_response : public OAIObject {
public:
    OAIDestiny2_GetCharacter_200_response();
    OAIDestiny2_GetCharacter_200_response(QString json);
    ~OAIDestiny2_GetCharacter_200_response() override;
    ...
    OAIDestiny_Responses_DestinyCharacterResponse getResponse() const;
    void setResponse(const OAIDestiny_Responses_DestinyCharacterResponse &response);
...
private:
    ...
    OAIDestiny_Responses_DestinyCharacterResponse m_response;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDestiny2_GetCharacter_200_response)

#endif // OAIDestiny2_GetCharacter_200_response_H
