...
#include "OAIQueries_SearchResult.h"
...
OAIQueries_SearchResult::OAIQueries_SearchResult(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIQueries_SearchResult::OAIQueries_SearchResult() {
    this->initializeModel();
}

OAIQueries_SearchResult::~OAIQueries_SearchResult() {}

void OAIQueries_SearchResult::initializeModel() {
...
void OAIQueries_SearchResult::fromJson(QString jsonString) {
...
void OAIQueries_SearchResult::fromJsonObject(QJsonObject json) {
...
QString OAIQueries_SearchResult::asJson() const {
...
QJsonObject OAIQueries_SearchResult::asJsonObject() const {
    QJsonObject obj;
    if (m_has_more_isSet) {
...
bool OAIQueries_SearchResult::isHasMore() const {
    return m_has_more;
}
void OAIQueries_SearchResult::setHasMore(const bool &has_more) {
    m_has_more = has_more;
    m_has_more_isSet = true;
}

bool OAIQueries_SearchResult::is_has_more_Set() const{
    return m_has_more_isSet;
}

bool OAIQueries_SearchResult::is_has_more_Valid() const{
    return m_has_more_isValid;
}

OAIQueries_PagedQuery OAIQueries_SearchResult::getQuery() const {
    return m_query;
}
void OAIQueries_SearchResult::setQuery(const OAIQueries_PagedQuery &query) {
    m_query = query;
    m_query_isSet = true;
}

bool OAIQueries_SearchResult::is_query_Set() const{
    return m_query_isSet;
}

bool OAIQueries_SearchResult::is_query_Valid() const{
    return m_query_isValid;
}

QString OAIQueries_SearchResult::getReplacementContinuationToken() const {
    return m_replacement_continuation_token;
}
void OAIQueries_SearchResult::setReplacementContinuationToken(const QString &replacement_continuation_token) {
    m_replacement_continuation_token = replacement_continuation_token;
    m_replacement_continuation_token_isSet = true;
}

bool OAIQueries_SearchResult::is_replacement_continuation_token_Set() const{
    return m_replacement_continuation_token_isSet;
}

bool OAIQueries_SearchResult::is_replacement_continuation_token_Valid() const{
    return m_replacement_continuation_token_isValid;
}

qint32 OAIQueries_SearchResult::getTotalResults() const {
    return m_total_results;
}
void OAIQueries_SearchResult::setTotalResults(const qint32 &total_results) {
    m_total_results = total_results;
    m_total_results_isSet = true;
}

bool OAIQueries_SearchResult::is_total_results_Set() const{
    return m_total_results_isSet;
}

bool OAIQueries_SearchResult::is_total_results_Valid() const{
    return m_total_results_isValid;
}

bool OAIQueries_SearchResult::isUseTotalResults() const {
    return m_use_total_results;
}
void OAIQueries_SearchResult::setUseTotalResults(const bool &use_total_results) {
    m_use_total_results = use_total_results;
    m_use_total_results_isSet = true;
}

bool OAIQueries_SearchResult::is_use_total_results_Set() const{
    return m_use_total_results_isSet;
}

bool OAIQueries_SearchResult::is_use_total_results_Valid() const{
    return m_use_total_results_isValid;
}

bool OAIQueries_SearchResult::isSet() const {
...
bool OAIQueries_SearchResult::isValid() const {
