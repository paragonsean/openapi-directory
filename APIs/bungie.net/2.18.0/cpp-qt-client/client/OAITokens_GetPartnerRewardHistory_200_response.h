...
/*
 * OAITokens_GetPartnerRewardHistory_200_response.h
 *
 * 
 */

#ifndef OAITokens_GetPartnerRewardHistory_200_response_H
#define OAITokens_GetPartnerRewardHistory_200_response_H
...
namespace OpenAPI {
class OAITokens_PartnerRewardHistoryResponse;

class OAITokens_GetPartnerRewardHistory_200_response : public OAIObject {
public:
    OAITokens_GetPartnerRewardHistory_200_response();
    OAITokens_GetPartnerRewardHistory_200_response(QString json);
    ~OAITokens_GetPartnerRewardHistory_200_response() override;
    ...
    OAITokens_PartnerRewardHistoryResponse getResponse() const;
    void setResponse(const OAITokens_PartnerRewardHistoryResponse &response);
...
private:
    ...
    OAITokens_PartnerRewardHistoryResponse m_response;
...
Q_DECLARE_METATYPE(OpenAPI::OAITokens_GetPartnerRewardHistory_200_response)

#endif // OAITokens_GetPartnerRewardHistory_200_response_H
