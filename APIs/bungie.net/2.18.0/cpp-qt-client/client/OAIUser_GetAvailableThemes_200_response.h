...
/*
 * OAIUser_GetAvailableThemes_200_response.h
 *
 * 
 */

#ifndef OAIUser_GetAvailableThemes_200_response_H
#define OAIUser_GetAvailableThemes_200_response_H
...
namespace OpenAPI {
class OAIConfig_UserTheme;

class OAIUser_GetAvailableThemes_200_response : public OAIObject {
public:
    OAIUser_GetAvailableThemes_200_response();
    OAIUser_GetAvailableThemes_200_response(QString json);
    ~OAIUser_GetAvailableThemes_200_response() override;
    ...
    QList<OAIConfig_UserTheme> getResponse() const;
    void setResponse(const QList<OAIConfig_UserTheme> &response);
...
private:
    ...
    QList<OAIConfig_UserTheme> m_response;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUser_GetAvailableThemes_200_response)

#endif // OAIUser_GetAvailableThemes_200_response_H
