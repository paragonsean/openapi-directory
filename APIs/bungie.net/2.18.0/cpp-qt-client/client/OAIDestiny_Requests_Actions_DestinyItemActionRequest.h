...
/*
 * OAIDestiny_Requests_Actions_DestinyItemActionRequest.h
 *
 * 
 */

#ifndef OAIDestiny_Requests_Actions_DestinyItemActionRequest_H
#define OAIDestiny_Requests_Actions_DestinyItemActionRequest_H
...
class OAIDestiny_Requests_Actions_DestinyItemActionRequest : public OAIObject {
public:
    OAIDestiny_Requests_Actions_DestinyItemActionRequest();
    OAIDestiny_Requests_Actions_DestinyItemActionRequest(QString json);
    ~OAIDestiny_Requests_Actions_DestinyItemActionRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDestiny_Requests_Actions_DestinyItemActionRequest)

#endif // OAIDestiny_Requests_Actions_DestinyItemActionRequest_H
