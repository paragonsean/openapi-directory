...
/*
 * OAIDestiny2_GetDestinyAggregateActivityStats_200_response.h
 *
 * 
 */

#ifndef OAIDestiny2_GetDestinyAggregateActivityStats_200_response_H
#define OAIDestiny2_GetDestinyAggregateActivityStats_200_response_H
...
namespace OpenAPI {
class OAIDestiny_HistoricalStats_DestinyAggregateActivityResults;

class OAIDestiny2_GetDestinyAggregateActivityStats_200_response : public OAIObject {
public:
    OAIDestiny2_GetDestinyAggregateActivityStats_200_response();
    OAIDestiny2_GetDestinyAggregateActivityStats_200_response(QString json);
    ~OAIDestiny2_GetDestinyAggregateActivityStats_200_response() override;
    ...
    OAIDestiny_HistoricalStats_DestinyAggregateActivityResults getResponse() const;
    void setResponse(const OAIDestiny_HistoricalStats_DestinyAggregateActivityResults &response);
...
private:
    ...
    OAIDestiny_HistoricalStats_DestinyAggregateActivityResults m_response;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDestiny2_GetDestinyAggregateActivityStats_200_response)

#endif // OAIDestiny2_GetDestinyAggregateActivityStats_200_response_H
