...
/*
 * OAISocial_GetFriendRequestList_200_response.h
 *
 * 
 */

#ifndef OAISocial_GetFriendRequestList_200_response_H
#define OAISocial_GetFriendRequestList_200_response_H
...
namespace OpenAPI {
class OAISocial_Friends_BungieFriendRequestListResponse;

class OAISocial_GetFriendRequestList_200_response : public OAIObject {
public:
    OAISocial_GetFriendRequestList_200_response();
    OAISocial_GetFriendRequestList_200_response(QString json);
    ~OAISocial_GetFriendRequestList_200_response() override;
    ...
    OAISocial_Friends_BungieFriendRequestListResponse getResponse() const;
    void setResponse(const OAISocial_Friends_BungieFriendRequestListResponse &response);
...
private:
    ...
    OAISocial_Friends_BungieFriendRequestListResponse m_response;
...
Q_DECLARE_METATYPE(OpenAPI::OAISocial_GetFriendRequestList_200_response)

#endif // OAISocial_GetFriendRequestList_200_response_H
