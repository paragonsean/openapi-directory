...
/*
 * OAIGroupV2_GetGroupByName_200_response.h
 *
 * 
 */

#ifndef OAIGroupV2_GetGroupByName_200_response_H
#define OAIGroupV2_GetGroupByName_200_response_H
...
class OAIGroupV2_GetGroupByName_200_response : public OAIObject {
public:
    OAIGroupV2_GetGroupByName_200_response();
    OAIGroupV2_GetGroupByName_200_response(QString json);
    ~OAIGroupV2_GetGroupByName_200_response() override;
    ...
    OAIGroupsV2_GroupResponse getResponse() const;
    void setResponse(const OAIGroupsV2_GroupResponse &response);
...
private:
    ...
    OAIGroupsV2_GroupResponse m_response;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGroupV2_GetGroupByName_200_response)

#endif // OAIGroupV2_GetGroupByName_200_response_H
