...
/*
 * OAIGroupV2_RecoverGroupForFounder_200_response.h
 *
 * 
 */

#ifndef OAIGroupV2_RecoverGroupForFounder_200_response_H
#define OAIGroupV2_RecoverGroupForFounder_200_response_H
...
namespace OpenAPI {
class OAIGroupsV2_GroupMembershipSearchResponse;

class OAIGroupV2_RecoverGroupForFounder_200_response : public OAIObject {
public:
    OAIGroupV2_RecoverGroupForFounder_200_response();
    OAIGroupV2_RecoverGroupForFounder_200_response(QString json);
    ~OAIGroupV2_RecoverGroupForFounder_200_response() override;
    ...
    OAIGroupsV2_GroupMembershipSearchResponse getResponse() const;
    void setResponse(const OAIGroupsV2_GroupMembershipSearchResponse &response);
...
private:
    ...
    OAIGroupsV2_GroupMembershipSearchResponse m_response;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGroupV2_RecoverGroupForFounder_200_response)

#endif // OAIGroupV2_RecoverGroupForFounder_200_response_H
