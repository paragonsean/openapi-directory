...
/*
 * OAIDestiny2_GetPublicMilestones_200_response.h
 *
 * 
 */

#ifndef OAIDestiny2_GetPublicMilestones_200_response_H
#define OAIDestiny2_GetPublicMilestones_200_response_H
...
class OAIDestiny2_GetPublicMilestones_200_response : public OAIObject {
public:
    OAIDestiny2_GetPublicMilestones_200_response();
    OAIDestiny2_GetPublicMilestones_200_response(QString json);
    ~OAIDestiny2_GetPublicMilestones_200_response() override;
    ...
    QMap<QString, OAIDestiny_Milestones_DestinyPublicMilestone> getResponse() const;
    void setResponse(const QMap<QString, OAIDestiny_Milestones_DestinyPublicMilestone> &response);
...
private:
    ...
    QMap<QString, OAIDestiny_Milestones_DestinyPublicMilestone> m_response;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDestiny2_GetPublicMilestones_200_response)

#endif // OAIDestiny2_GetPublicMilestones_200_response_H
