...
/*
 * OAIContent_GetContentById_200_response.h
 *
 * 
 */

#ifndef OAIContent_GetContentById_200_response_H
#define OAIContent_GetContentById_200_response_H
...
class OAIContent_GetContentById_200_response : public OAIObject {
public:
    OAIContent_GetContentById_200_response();
    OAIContent_GetContentById_200_response(QString json);
    ~OAIContent_GetContentById_200_response() override;
    ...
    OAIContent_ContentItemPublicContract getResponse() const;
    void setResponse(const OAIContent_ContentItemPublicContract &response);
...
private:
    ...
    OAIContent_ContentItemPublicContract m_response;
...
Q_DECLARE_METATYPE(OpenAPI::OAIContent_GetContentById_200_response)

#endif // OAIContent_GetContentById_200_response_H
