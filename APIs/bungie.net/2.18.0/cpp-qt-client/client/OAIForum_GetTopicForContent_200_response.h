...
/*
 * OAIForum_GetTopicForContent_200_response.h
 *
 * 
 */

#ifndef OAIForum_GetTopicForContent_200_response_H
#define OAIForum_GetTopicForContent_200_response_H
...
class OAIForum_GetTopicForContent_200_response : public OAIObject {
public:
    OAIForum_GetTopicForContent_200_response();
    OAIForum_GetTopicForContent_200_response(QString json);
    ~OAIForum_GetTopicForContent_200_response() override;
    ...
    qint64 getResponse() const;
    void setResponse(const qint64 &response);
...
Q_DECLARE_METATYPE(OpenAPI::OAIForum_GetTopicForContent_200_response)

#endif // OAIForum_GetTopicForContent_200_response_H
