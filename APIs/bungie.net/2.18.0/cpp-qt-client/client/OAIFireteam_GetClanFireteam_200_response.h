...
/*
 * OAIFireteam_GetClanFireteam_200_response.h
 *
 * 
 */

#ifndef OAIFireteam_GetClanFireteam_200_response_H
#define OAIFireteam_GetClanFireteam_200_response_H
...
class OAIFireteam_GetClanFireteam_200_response : public OAIObject {
public:
    OAIFireteam_GetClanFireteam_200_response();
    OAIFireteam_GetClanFireteam_200_response(QString json);
    ~OAIFireteam_GetClanFireteam_200_response() override;
    ...
    OAIFireteam_FireteamResponse getResponse() const;
    void setResponse(const OAIFireteam_FireteamResponse &response);
...
private:
    ...
    OAIFireteam_FireteamResponse m_response;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFireteam_GetClanFireteam_200_response)

#endif // OAIFireteam_GetClanFireteam_200_response_H
