...
/*
 * OAIFireteam_GetMyClanFireteams_200_response.h
 *
 * 
 */

#ifndef OAIFireteam_GetMyClanFireteams_200_response_H
#define OAIFireteam_GetMyClanFireteams_200_response_H

#include <QJsonObject>

#include "OAISearchResultOfFireteamResponse.h"
#include <QMap>
#include <QString>
...
namespace OpenAPI {
class OAISearchResultOfFireteamResponse;

class OAIFireteam_GetMyClanFireteams_200_response : public OAIObject {
public:
    OAIFireteam_GetMyClanFireteams_200_response();
    OAIFireteam_GetMyClanFireteams_200_response(QString json);
    ~OAIFireteam_GetMyClanFireteams_200_response() override;
    ...
    OAISearchResultOfFireteamResponse getResponse() const;
    void setResponse(const OAISearchResultOfFireteamResponse &response);
...
private:
    ...
    OAISearchResultOfFireteamResponse m_response;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFireteam_GetMyClanFireteams_200_response)

#endif // OAIFireteam_GetMyClanFireteams_200_response_H
