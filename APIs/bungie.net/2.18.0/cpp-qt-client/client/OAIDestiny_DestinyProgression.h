...
/*
 * OAIDestiny_DestinyProgression.h
 *
 * Information about a current character&#39;s status with a Progression. A progression is a value that can increase with activity and has levels. Think Character Level and Reputation Levels. Combine this \&quot;live\&quot; data with the related DestinyProgressionDefinition for a full picture of the Progression.
 */

#ifndef OAIDestiny_DestinyProgression_H
#define OAIDestiny_DestinyProgression_H
...
class OAIDestiny_DestinyProgression : public OAIObject {
public:
    OAIDestiny_DestinyProgression();
    OAIDestiny_DestinyProgression(QString json);
    ~OAIDestiny_DestinyProgression() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDestiny_DestinyProgression)

#endif // OAIDestiny_DestinyProgression_H
