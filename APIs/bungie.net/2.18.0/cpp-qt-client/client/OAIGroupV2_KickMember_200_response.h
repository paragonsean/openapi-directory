...
/*
 * OAIGroupV2_KickMember_200_response.h
 *
 * 
 */

#ifndef OAIGroupV2_KickMember_200_response_H
#define OAIGroupV2_KickMember_200_response_H
...
namespace OpenAPI {
class OAIGroupsV2_GroupMemberLeaveResult;

class OAIGroupV2_KickMember_200_response : public OAIObject {
public:
    OAIGroupV2_KickMember_200_response();
    OAIGroupV2_KickMember_200_response(QString json);
    ~OAIGroupV2_KickMember_200_response() override;
    ...
    OAIGroupsV2_GroupMemberLeaveResult getResponse() const;
    void setResponse(const OAIGroupsV2_GroupMemberLeaveResult &response);
...
private:
    ...
    OAIGroupsV2_GroupMemberLeaveResult m_response;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGroupV2_KickMember_200_response)

#endif // OAIGroupV2_KickMember_200_response_H
