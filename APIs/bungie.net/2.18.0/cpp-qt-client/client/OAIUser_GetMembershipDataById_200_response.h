...
/*
 * OAIUser_GetMembershipDataById_200_response.h
 *
 * 
 */

#ifndef OAIUser_GetMembershipDataById_200_response_H
#define OAIUser_GetMembershipDataById_200_response_H
...
namespace OpenAPI {
class OAIUser_UserMembershipData;

class OAIUser_GetMembershipDataById_200_response : public OAIObject {
public:
    OAIUser_GetMembershipDataById_200_response();
    OAIUser_GetMembershipDataById_200_response(QString json);
    ~OAIUser_GetMembershipDataById_200_response() override;
    ...
    OAIUser_UserMembershipData getResponse() const;
    void setResponse(const OAIUser_UserMembershipData &response);
...
private:
    ...
    OAIUser_UserMembershipData m_response;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUser_GetMembershipDataById_200_response)

#endif // OAIUser_GetMembershipDataById_200_response_H
