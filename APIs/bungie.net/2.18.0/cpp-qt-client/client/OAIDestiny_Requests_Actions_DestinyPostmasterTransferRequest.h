...
/*
 * OAIDestiny_Requests_Actions_DestinyPostmasterTransferRequest.h
 *
 * 
 */

#ifndef OAIDestiny_Requests_Actions_DestinyPostmasterTransferRequest_H
#define OAIDestiny_Requests_Actions_DestinyPostmasterTransferRequest_H
...
class OAIDestiny_Requests_Actions_DestinyPostmasterTransferRequest : public OAIObject {
public:
    OAIDestiny_Requests_Actions_DestinyPostmasterTransferRequest();
    OAIDestiny_Requests_Actions_DestinyPostmasterTransferRequest(QString json);
    ~OAIDestiny_Requests_Actions_DestinyPostmasterTransferRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDestiny_Requests_Actions_DestinyPostmasterTransferRequest)

#endif // OAIDestiny_Requests_Actions_DestinyPostmasterTransferRequest_H
