...
/*
 * OAIDestiny2_GetVendor_200_response.h
 *
 * 
 */

#ifndef OAIDestiny2_GetVendor_200_response_H
#define OAIDestiny2_GetVendor_200_response_H
...
namespace OpenAPI {
class OAIDestiny_Responses_DestinyVendorResponse;

class OAIDestiny2_GetVendor_200_response : public OAIObject {
public:
    OAIDestiny2_GetVendor_200_response();
    OAIDestiny2_GetVendor_200_response(QString json);
    ~OAIDestiny2_GetVendor_200_response() override;
    ...
    OAIDestiny_Responses_DestinyVendorResponse getResponse() const;
    void setResponse(const OAIDestiny_Responses_DestinyVendorResponse &response);
...
private:
    ...
    OAIDestiny_Responses_DestinyVendorResponse m_response;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDestiny2_GetVendor_200_response)

#endif // OAIDestiny2_GetVendor_200_response_H
