...
/*
 * OAIDestiny2_InsertSocketPlug_200_response.h
 *
 * 
 */

#ifndef OAIDestiny2_InsertSocketPlug_200_response_H
#define OAIDestiny2_InsertSocketPlug_200_response_H
...
namespace OpenAPI {
class OAIDestiny_Responses_DestinyItemChangeResponse;

class OAIDestiny2_InsertSocketPlug_200_response : public OAIObject {
public:
    OAIDestiny2_InsertSocketPlug_200_response();
    OAIDestiny2_InsertSocketPlug_200_response(QString json);
    ~OAIDestiny2_InsertSocketPlug_200_response() override;
    ...
    OAIDestiny_Responses_DestinyItemChangeResponse getResponse() const;
    void setResponse(const OAIDestiny_Responses_DestinyItemChangeResponse &response);
...
private:
    ...
    OAIDestiny_Responses_DestinyItemChangeResponse m_response;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDestiny2_InsertSocketPlug_200_response)

#endif // OAIDestiny2_InsertSocketPlug_200_response_H
