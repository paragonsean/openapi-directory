...
/*
 * OAIGroupV2_GetRecommendedGroups_200_response.h
 *
 * 
 */

#ifndef OAIGroupV2_GetRecommendedGroups_200_response_H
#define OAIGroupV2_GetRecommendedGroups_200_response_H
...
class OAIGroupV2_GetRecommendedGroups_200_response : public OAIObject {
public:
    OAIGroupV2_GetRecommendedGroups_200_response();
    OAIGroupV2_GetRecommendedGroups_200_response(QString json);
    ~OAIGroupV2_GetRecommendedGroups_200_response() override;
    ...
    QList<OAIGroupsV2_GroupV2Card> getResponse() const;
    void setResponse(const QList<OAIGroupsV2_GroupV2Card> &response);
...
private:
    ...
    QList<OAIGroupsV2_GroupV2Card> m_response;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGroupV2_GetRecommendedGroups_200_response)

#endif // OAIGroupV2_GetRecommendedGroups_200_response_H
