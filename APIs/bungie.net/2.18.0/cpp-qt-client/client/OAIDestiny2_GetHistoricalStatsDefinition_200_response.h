...
/*
 * OAIDestiny2_GetHistoricalStatsDefinition_200_response.h
 *
 * 
 */

#ifndef OAIDestiny2_GetHistoricalStatsDefinition_200_response_H
#define OAIDestiny2_GetHistoricalStatsDefinition_200_response_H
...
namespace OpenAPI {
class OAIDestiny_HistoricalStats_Definitions_DestinyHistoricalStatsDefinition;

class OAIDestiny2_GetHistoricalStatsDefinition_200_response : public OAIObject {
public:
    OAIDestiny2_GetHistoricalStatsDefinition_200_response();
    OAIDestiny2_GetHistoricalStatsDefinition_200_response(QString json);
    ~OAIDestiny2_GetHistoricalStatsDefinition_200_response() override;
    ...
    QMap<QString, OAIDestiny_HistoricalStats_Definitions_DestinyHistoricalStatsDefinition> getResponse() const;
    void setResponse(const QMap<QString, OAIDestiny_HistoricalStats_Definitions_DestinyHistoricalStatsDefinition> &response);
...
private:
    ...
    QMap<QString, OAIDestiny_HistoricalStats_Definitions_DestinyHistoricalStatsDefinition> m_response;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDestiny2_GetHistoricalStatsDefinition_200_response)

#endif // OAIDestiny2_GetHistoricalStatsDefinition_200_response_H
