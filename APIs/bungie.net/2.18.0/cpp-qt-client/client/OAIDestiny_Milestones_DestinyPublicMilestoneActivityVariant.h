...
/*
 * OAIDestiny_Milestones_DestinyPublicMilestoneActivityVariant.h
 *
 * Represents a variant of an activity that&#39;s relevant to a milestone.
 */

#ifndef OAIDestiny_Milestones_DestinyPublicMilestoneActivityVariant_H
#define OAIDestiny_Milestones_DestinyPublicMilestoneActivityVariant_H
...
class OAIDestiny_Milestones_DestinyPublicMilestoneActivityVariant : public OAIObject {
public:
    OAIDestiny_Milestones_DestinyPublicMilestoneActivityVariant();
    OAIDestiny_Milestones_DestinyPublicMilestoneActivityVariant(QString json);
    ~OAIDestiny_Milestones_DestinyPublicMilestoneActivityVariant() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDestiny_Milestones_DestinyPublicMilestoneActivityVariant)

#endif // OAIDestiny_Milestones_DestinyPublicMilestoneActivityVariant_H
