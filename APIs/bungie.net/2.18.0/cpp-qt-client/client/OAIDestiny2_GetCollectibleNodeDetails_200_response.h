...
/*
 * OAIDestiny2_GetCollectibleNodeDetails_200_response.h
 *
 * 
 */

#ifndef OAIDestiny2_GetCollectibleNodeDetails_200_response_H
#define OAIDestiny2_GetCollectibleNodeDetails_200_response_H
...
namespace OpenAPI {
class OAIDestiny_Responses_DestinyCollectibleNodeDetailResponse;

class OAIDestiny2_GetCollectibleNodeDetails_200_response : public OAIObject {
public:
    OAIDestiny2_GetCollectibleNodeDetails_200_response();
    OAIDestiny2_GetCollectibleNodeDetails_200_response(QString json);
    ~OAIDestiny2_GetCollectibleNodeDetails_200_response() override;
    ...
    OAIDestiny_Responses_DestinyCollectibleNodeDetailResponse getResponse() const;
    void setResponse(const OAIDestiny_Responses_DestinyCollectibleNodeDetailResponse &response);
...
private:
    ...
    OAIDestiny_Responses_DestinyCollectibleNodeDetailResponse m_response;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDestiny2_GetCollectibleNodeDetails_200_response)

#endif // OAIDestiny2_GetCollectibleNodeDetails_200_response_H
