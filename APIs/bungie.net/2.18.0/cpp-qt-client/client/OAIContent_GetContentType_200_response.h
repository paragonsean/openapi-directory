...
/*
 * OAIContent_GetContentType_200_response.h
 *
 * 
 */

#ifndef OAIContent_GetContentType_200_response_H
#define OAIContent_GetContentType_200_response_H
...
namespace OpenAPI {
class OAIContent_Models_ContentTypeDescription;

class OAIContent_GetContentType_200_response : public OAIObject {
public:
    OAIContent_GetContentType_200_response();
    OAIContent_GetContentType_200_response(QString json);
    ~OAIContent_GetContentType_200_response() override;
    ...
    OAIContent_Models_ContentTypeDescription getResponse() const;
    void setResponse(const OAIContent_Models_ContentTypeDescription &response);
...
private:
    ...
    OAIContent_Models_ContentTypeDescription m_response;
...
Q_DECLARE_METATYPE(OpenAPI::OAIContent_GetContentType_200_response)

#endif // OAIContent_GetContentType_200_response_H
