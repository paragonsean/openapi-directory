...
/*
 * OAIDestiny2_AwaGetActionToken_200_response.h
 *
 * 
 */

#ifndef OAIDestiny2_AwaGetActionToken_200_response_H
#define OAIDestiny2_AwaGetActionToken_200_response_H
...
namespace OpenAPI {
class OAIDestiny_Advanced_AwaAuthorizationResult;

class OAIDestiny2_AwaGetActionToken_200_response : public OAIObject {
public:
    OAIDestiny2_AwaGetActionToken_200_response();
    OAIDestiny2_AwaGetActionToken_200_response(QString json);
    ~OAIDestiny2_AwaGetActionToken_200_response() override;
    ...
    OAIDestiny_Advanced_AwaAuthorizationResult getResponse() const;
    void setResponse(const OAIDestiny_Advanced_AwaAuthorizationResult &response);
...
private:
    ...
    OAIDestiny_Advanced_AwaAuthorizationResult m_response;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDestiny2_AwaGetActionToken_200_response)

#endif // OAIDestiny2_AwaGetActionToken_200_response_H
