...
/*
 * OAIDestiny2_GetItem_200_response.h
 *
 * 
 */

#ifndef OAIDestiny2_GetItem_200_response_H
#define OAIDestiny2_GetItem_200_response_H
...
class OAIDestiny2_GetItem_200_response : public OAIObject {
public:
    OAIDestiny2_GetItem_200_response();
    OAIDestiny2_GetItem_200_response(QString json);
    ~OAIDestiny2_GetItem_200_response() override;
    ...
    OAIDestiny_Responses_DestinyItemResponse getResponse() const;
    void setResponse(const OAIDestiny_Responses_DestinyItemResponse &response);
...
private:
    ...
    OAIDestiny_Responses_DestinyItemResponse m_response;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDestiny2_GetItem_200_response)

#endif // OAIDestiny2_GetItem_200_response_H
