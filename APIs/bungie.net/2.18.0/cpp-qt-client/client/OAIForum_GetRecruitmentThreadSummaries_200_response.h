...
/*
 * OAIForum_GetRecruitmentThreadSummaries_200_response.h
 *
 * 
 */

#ifndef OAIForum_GetRecruitmentThreadSummaries_200_response_H
#define OAIForum_GetRecruitmentThreadSummaries_200_response_H
...
class OAIForum_GetRecruitmentThreadSummaries_200_response : public OAIObject {
public:
    OAIForum_GetRecruitmentThreadSummaries_200_response();
    OAIForum_GetRecruitmentThreadSummaries_200_response(QString json);
    ~OAIForum_GetRecruitmentThreadSummaries_200_response() override;
    ...
    QList<OAIForum_ForumRecruitmentDetail> getResponse() const;
    void setResponse(const QList<OAIForum_ForumRecruitmentDetail> &response);
...
private:
    ...
    QList<OAIForum_ForumRecruitmentDetail> m_response;
...
Q_DECLARE_METATYPE(OpenAPI::OAIForum_GetRecruitmentThreadSummaries_200_response)

#endif // OAIForum_GetRecruitmentThreadSummaries_200_response_H
