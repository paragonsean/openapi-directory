...
/*
 * OAIGroupV2_GetInvitedIndividuals_200_response.h
 *
 * 
 */

#ifndef OAIGroupV2_GetInvitedIndividuals_200_response_H
#define OAIGroupV2_GetInvitedIndividuals_200_response_H
...
namespace OpenAPI {
class OAISearchResultOfGroupMemberApplication;

class OAIGroupV2_GetInvitedIndividuals_200_response : public OAIObject {
public:
    OAIGroupV2_GetInvitedIndividuals_200_response();
    OAIGroupV2_GetInvitedIndividuals_200_response(QString json);
    ~OAIGroupV2_GetInvitedIndividuals_200_response() override;
    ...
    OAISearchResultOfGroupMemberApplication getResponse() const;
    void setResponse(const OAISearchResultOfGroupMemberApplication &response);
...
private:
    ...
    OAISearchResultOfGroupMemberApplication m_response;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGroupV2_GetInvitedIndividuals_200_response)

#endif // OAIGroupV2_GetInvitedIndividuals_200_response_H
