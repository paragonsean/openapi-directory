...
/*
 * OAIUser_GetMembershipFromHardLinkedCredential_200_response.h
 *
 * 
 */

#ifndef OAIUser_GetMembershipFromHardLinkedCredential_200_response_H
#define OAIUser_GetMembershipFromHardLinkedCredential_200_response_H
...
namespace OpenAPI {
class OAIUser_HardLinkedUserMembership;

class OAIUser_GetMembershipFromHardLinkedCredential_200_response : public OAIObject {
public:
    OAIUser_GetMembershipFromHardLinkedCredential_200_response();
    OAIUser_GetMembershipFromHardLinkedCredential_200_response(QString json);
    ~OAIUser_GetMembershipFromHardLinkedCredential_200_response() override;
    ...
    OAIUser_HardLinkedUserMembership getResponse() const;
    void setResponse(const OAIUser_HardLinkedUserMembership &response);
...
private:
    ...
    OAIUser_HardLinkedUserMembership m_response;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUser_GetMembershipFromHardLinkedCredential_200_response)

#endif // OAIUser_GetMembershipFromHardLinkedCredential_200_response_H
