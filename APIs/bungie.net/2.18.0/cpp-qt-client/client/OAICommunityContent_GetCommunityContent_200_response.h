...
/*
 * OAICommunityContent_GetCommunityContent_200_response.h
 *
 * 
 */

#ifndef OAICommunityContent_GetCommunityContent_200_response_H
#define OAICommunityContent_GetCommunityContent_200_response_H
...
namespace OpenAPI {
class OAIForum_PostSearchResponse;

class OAICommunityContent_GetCommunityContent_200_response : public OAIObject {
public:
    OAICommunityContent_GetCommunityContent_200_response();
    OAICommunityContent_GetCommunityContent_200_response(QString json);
    ~OAICommunityContent_GetCommunityContent_200_response() override;
    ...
    OAIForum_PostSearchResponse getResponse() const;
    void setResponse(const OAIForum_PostSearchResponse &response);
...
private:
    ...
    OAIForum_PostSearchResponse m_response;
...
Q_DECLARE_METATYPE(OpenAPI::OAICommunityContent_GetCommunityContent_200_response)

#endif // OAICommunityContent_GetCommunityContent_200_response_H
