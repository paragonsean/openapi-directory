...
/*
 * OAIDestiny_Definitions_BreakerTypes_DestinyBreakerTypeDefinition.h
 *
 * 
 */

#ifndef OAIDestiny_Definitions_BreakerTypes_DestinyBreakerTypeDefinition_H
#define OAIDestiny_Definitions_BreakerTypes_DestinyBreakerTypeDefinition_H
...
class OAIDestiny_Definitions_BreakerTypes_DestinyBreakerTypeDefinition : public OAIObject {
public:
    OAIDestiny_Definitions_BreakerTypes_DestinyBreakerTypeDefinition();
    OAIDestiny_Definitions_BreakerTypes_DestinyBreakerTypeDefinition(QString json);
    ~OAIDestiny_Definitions_BreakerTypes_DestinyBreakerTypeDefinition() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDestiny_Definitions_BreakerTypes_DestinyBreakerTypeDefinition)

#endif // OAIDestiny_Definitions_BreakerTypes_DestinyBreakerTypeDefinition_H
