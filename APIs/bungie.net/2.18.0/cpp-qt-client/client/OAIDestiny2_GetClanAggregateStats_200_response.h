...
/*
 * OAIDestiny2_GetClanAggregateStats_200_response.h
 *
 * 
 */

#ifndef OAIDestiny2_GetClanAggregateStats_200_response_H
#define OAIDestiny2_GetClanAggregateStats_200_response_H
...
namespace OpenAPI {
class OAIDestiny_HistoricalStats_DestinyClanAggregateStat;

class OAIDestiny2_GetClanAggregateStats_200_response : public OAIObject {
public:
    OAIDestiny2_GetClanAggregateStats_200_response();
    OAIDestiny2_GetClanAggregateStats_200_response(QString json);
    ~OAIDestiny2_GetClanAggregateStats_200_response() override;
    ...
    QList<OAIDestiny_HistoricalStats_DestinyClanAggregateStat> getResponse() const;
    void setResponse(const QList<OAIDestiny_HistoricalStats_DestinyClanAggregateStat> &response);
...
private:
    ...
    QList<OAIDestiny_HistoricalStats_DestinyClanAggregateStat> m_response;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDestiny2_GetClanAggregateStats_200_response)

#endif // OAIDestiny2_GetClanAggregateStats_200_response_H
