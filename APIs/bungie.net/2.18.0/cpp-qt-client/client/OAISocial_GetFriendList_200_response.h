...
/*
 * OAISocial_GetFriendList_200_response.h
 *
 * 
 */

#ifndef OAISocial_GetFriendList_200_response_H
#define OAISocial_GetFriendList_200_response_H
...
namespace OpenAPI {
class OAISocial_Friends_BungieFriendListResponse;

class OAISocial_GetFriendList_200_response : public OAIObject {
public:
    OAISocial_GetFriendList_200_response();
    OAISocial_GetFriendList_200_response(QString json);
    ~OAISocial_GetFriendList_200_response() override;
    ...
    OAISocial_Friends_BungieFriendListResponse getResponse() const;
    void setResponse(const OAISocial_Friends_BungieFriendListResponse &response);
...
private:
    ...
    OAISocial_Friends_BungieFriendListResponse m_response;
...
Q_DECLARE_METATYPE(OpenAPI::OAISocial_GetFriendList_200_response)

#endif // OAISocial_GetFriendList_200_response_H
