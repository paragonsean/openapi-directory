...
/*
 * OAIGroupV2_GetBannedMembersOfGroup_200_response.h
 *
 * 
 */

#ifndef OAIGroupV2_GetBannedMembersOfGroup_200_response_H
#define OAIGroupV2_GetBannedMembersOfGroup_200_response_H
...
namespace OpenAPI {
class OAISearchResultOfGroupBan;

class OAIGroupV2_GetBannedMembersOfGroup_200_response : public OAIObject {
public:
    OAIGroupV2_GetBannedMembersOfGroup_200_response();
    OAIGroupV2_GetBannedMembersOfGroup_200_response(QString json);
    ~OAIGroupV2_GetBannedMembersOfGroup_200_response() override;
    ...
    OAISearchResultOfGroupBan getResponse() const;
    void setResponse(const OAISearchResultOfGroupBan &response);
...
private:
    ...
    OAISearchResultOfGroupBan m_response;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGroupV2_GetBannedMembersOfGroup_200_response)

#endif // OAIGroupV2_GetBannedMembersOfGroup_200_response_H
