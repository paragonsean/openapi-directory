...
/*
 * OAITrending_GetTrendingCategories_200_response.h
 *
 * 
 */

#ifndef OAITrending_GetTrendingCategories_200_response_H
#define OAITrending_GetTrendingCategories_200_response_H
...
namespace OpenAPI {
class OAITrending_TrendingCategories;

class OAITrending_GetTrendingCategories_200_response : public OAIObject {
public:
    OAITrending_GetTrendingCategories_200_response();
    OAITrending_GetTrendingCategories_200_response(QString json);
    ~OAITrending_GetTrendingCategories_200_response() override;
    ...
    OAITrending_TrendingCategories getResponse() const;
    void setResponse(const OAITrending_TrendingCategories &response);
...
private:
    ...
    OAITrending_TrendingCategories m_response;
...
Q_DECLARE_METATYPE(OpenAPI::OAITrending_GetTrendingCategories_200_response)

#endif // OAITrending_GetTrendingCategories_200_response_H
