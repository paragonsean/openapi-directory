...
/*
 * OAIDestiny2_GetVendors_200_response.h
 *
 * 
 */

#ifndef OAIDestiny2_GetVendors_200_response_H
#define OAIDestiny2_GetVendors_200_response_H
...
namespace OpenAPI {
class OAIDestiny_Responses_DestinyVendorsResponse;

class OAIDestiny2_GetVendors_200_response : public OAIObject {
public:
    OAIDestiny2_GetVendors_200_response();
    OAIDestiny2_GetVendors_200_response(QString json);
    ~OAIDestiny2_GetVendors_200_response() override;
    ...
    OAIDestiny_Responses_DestinyVendorsResponse getResponse() const;
    void setResponse(const OAIDestiny_Responses_DestinyVendorsResponse &response);
...
private:
    ...
    OAIDestiny_Responses_DestinyVendorsResponse m_response;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDestiny2_GetVendors_200_response)

#endif // OAIDestiny2_GetVendors_200_response_H
