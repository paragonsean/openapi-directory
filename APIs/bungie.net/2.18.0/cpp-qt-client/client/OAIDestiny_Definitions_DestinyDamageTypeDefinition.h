...
/*
 * OAIDestiny_Definitions_DestinyDamageTypeDefinition.h
 *
 * All damage types that are possible in the game are defined here, along with localized info and icons as needed.
 */

#ifndef OAIDestiny_Definitions_DestinyDamageTypeDefinition_H
#define OAIDestiny_Definitions_DestinyDamageTypeDefinition_H
...
class OAIDestiny_Definitions_DestinyDamageTypeDefinition : public OAIObject {
public:
    OAIDestiny_Definitions_DestinyDamageTypeDefinition();
    OAIDestiny_Definitions_DestinyDamageTypeDefinition(QString json);
    ~OAIDestiny_Definitions_DestinyDamageTypeDefinition() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDestiny_Definitions_DestinyDamageTypeDefinition)

#endif // OAIDestiny_Definitions_DestinyDamageTypeDefinition_H
