...
/*
 * OAIGroupV2_ApproveAllPending_200_response.h
 *
 * 
 */

#ifndef OAIGroupV2_ApproveAllPending_200_response_H
#define OAIGroupV2_ApproveAllPending_200_response_H
...
namespace OpenAPI {
class OAIEntities_EntityActionResult;

class OAIGroupV2_ApproveAllPending_200_response : public OAIObject {
public:
    OAIGroupV2_ApproveAllPending_200_response();
    OAIGroupV2_ApproveAllPending_200_response(QString json);
    ~OAIGroupV2_ApproveAllPending_200_response() override;
    ...
    QList<OAIEntities_EntityActionResult> getResponse() const;
    void setResponse(const QList<OAIEntities_EntityActionResult> &response);
...
private:
    ...
    QList<OAIEntities_EntityActionResult> m_response;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGroupV2_ApproveAllPending_200_response)

#endif // OAIGroupV2_ApproveAllPending_200_response_H
