...
/*
 * OAIDestiny2_SearchDestinyPlayerByBungieName_200_response.h
 *
 * 
 */

#ifndef OAIDestiny2_SearchDestinyPlayerByBungieName_200_response_H
#define OAIDestiny2_SearchDestinyPlayerByBungieName_200_response_H
...
class OAIDestiny2_SearchDestinyPlayerByBungieName_200_response : public OAIObject {
public:
    OAIDestiny2_SearchDestinyPlayerByBungieName_200_response();
    OAIDestiny2_SearchDestinyPlayerByBungieName_200_response(QString json);
    ~OAIDestiny2_SearchDestinyPlayerByBungieName_200_response() override;
    ...
    QList<OAIUser_UserInfoCard> getResponse() const;
    void setResponse(const QList<OAIUser_UserInfoCard> &response);
...
private:
    ...
    QList<OAIUser_UserInfoCard> m_response;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDestiny2_SearchDestinyPlayerByBungieName_200_response)

#endif // OAIDestiny2_SearchDestinyPlayerByBungieName_200_response_H
