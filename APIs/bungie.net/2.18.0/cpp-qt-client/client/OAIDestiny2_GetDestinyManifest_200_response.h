...
/*
 * OAIDestiny2_GetDestinyManifest_200_response.h
 *
 * 
 */

#ifndef OAIDestiny2_GetDestinyManifest_200_response_H
#define OAIDestiny2_GetDestinyManifest_200_response_H
...
namespace OpenAPI {
class OAIDestiny_Config_DestinyManifest;

class OAIDestiny2_GetDestinyManifest_200_response : public OAIObject {
public:
    OAIDestiny2_GetDestinyManifest_200_response();
    OAIDestiny2_GetDestinyManifest_200_response(QString json);
    ~OAIDestiny2_GetDestinyManifest_200_response() override;
    ...
    OAIDestiny_Config_DestinyManifest getResponse() const;
    void setResponse(const OAIDestiny_Config_DestinyManifest &response);
...
private:
    ...
    OAIDestiny_Config_DestinyManifest m_response;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDestiny2_GetDestinyManifest_200_response)

#endif // OAIDestiny2_GetDestinyManifest_200_response_H
