...
/*
 * OAIUser_GetBungieNetUserById_200_response.h
 *
 * 
 */

#ifndef OAIUser_GetBungieNetUserById_200_response_H
#define OAIUser_GetBungieNetUserById_200_response_H
...
class OAIUser_GetBungieNetUserById_200_response : public OAIObject {
public:
    OAIUser_GetBungieNetUserById_200_response();
    OAIUser_GetBungieNetUserById_200_response(QString json);
    ~OAIUser_GetBungieNetUserById_200_response() override;
    ...
    OAIUser_GeneralUser getResponse() const;
    void setResponse(const OAIUser_GeneralUser &response);
...
private:
    ...
    OAIUser_GeneralUser m_response;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUser_GetBungieNetUserById_200_response)

#endif // OAIUser_GetBungieNetUserById_200_response_H
