...
/*
 * OAISocial_GetPlatformFriendList_200_response.h
 *
 * 
 */

#ifndef OAISocial_GetPlatformFriendList_200_response_H
#define OAISocial_GetPlatformFriendList_200_response_H
...
namespace OpenAPI {
class OAISocial_Friends_PlatformFriendResponse;

class OAISocial_GetPlatformFriendList_200_response : public OAIObject {
public:
    OAISocial_GetPlatformFriendList_200_response();
    OAISocial_GetPlatformFriendList_200_response(QString json);
    ~OAISocial_GetPlatformFriendList_200_response() override;
    ...
    OAISocial_Friends_PlatformFriendResponse getResponse() const;
    void setResponse(const OAISocial_Friends_PlatformFriendResponse &response);
...
private:
    ...
    OAISocial_Friends_PlatformFriendResponse m_response;
...
Q_DECLARE_METATYPE(OpenAPI::OAISocial_GetPlatformFriendList_200_response)

#endif // OAISocial_GetPlatformFriendList_200_response_H
