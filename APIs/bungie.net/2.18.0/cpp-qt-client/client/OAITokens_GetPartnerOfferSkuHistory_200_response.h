...
/*
 * OAITokens_GetPartnerOfferSkuHistory_200_response.h
 *
 * 
 */

#ifndef OAITokens_GetPartnerOfferSkuHistory_200_response_H
#define OAITokens_GetPartnerOfferSkuHistory_200_response_H
...
class OAITokens_GetPartnerOfferSkuHistory_200_response : public OAIObject {
public:
    OAITokens_GetPartnerOfferSkuHistory_200_response();
    OAITokens_GetPartnerOfferSkuHistory_200_response(QString json);
    ~OAITokens_GetPartnerOfferSkuHistory_200_response() override;
    ...
    QList<OAITokens_PartnerOfferSkuHistoryResponse> getResponse() const;
    void setResponse(const QList<OAITokens_PartnerOfferSkuHistoryResponse> &response);
...
private:
    ...
    QList<OAITokens_PartnerOfferSkuHistoryResponse> m_response;
...
Q_DECLARE_METATYPE(OpenAPI::OAITokens_GetPartnerOfferSkuHistory_200_response)

#endif // OAITokens_GetPartnerOfferSkuHistory_200_response_H
