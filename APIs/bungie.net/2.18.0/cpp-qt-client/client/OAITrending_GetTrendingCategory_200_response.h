...
/*
 * OAITrending_GetTrendingCategory_200_response.h
 *
 * 
 */

#ifndef OAITrending_GetTrendingCategory_200_response_H
#define OAITrending_GetTrendingCategory_200_response_H
...
class OAITrending_GetTrendingCategory_200_response : public OAIObject {
public:
    OAITrending_GetTrendingCategory_200_response();
    OAITrending_GetTrendingCategory_200_response(QString json);
    ~OAITrending_GetTrendingCategory_200_response() override;
    ...
    OAISearchResultOfTrendingEntry getResponse() const;
    void setResponse(const OAISearchResultOfTrendingEntry &response);
...
private:
    ...
    OAISearchResultOfTrendingEntry m_response;
...
Q_DECLARE_METATYPE(OpenAPI::OAITrending_GetTrendingCategory_200_response)

#endif // OAITrending_GetTrendingCategory_200_response_H
