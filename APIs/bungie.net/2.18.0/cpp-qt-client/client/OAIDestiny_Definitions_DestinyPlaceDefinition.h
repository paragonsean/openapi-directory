...
/*
 * OAIDestiny_Definitions_DestinyPlaceDefinition.h
 *
...
#ifndef OAIDestiny_Definitions_DestinyPlaceDefinition_H
#define OAIDestiny_Definitions_DestinyPlaceDefinition_H
...
class OAIDestiny_Definitions_DestinyPlaceDefinition : public OAIObject {
public:
    OAIDestiny_Definitions_DestinyPlaceDefinition();
    OAIDestiny_Definitions_DestinyPlaceDefinition(QString json);
    ~OAIDestiny_Definitions_DestinyPlaceDefinition() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDestiny_Definitions_DestinyPlaceDefinition)

#endif // OAIDestiny_Definitions_DestinyPlaceDefinition_H
