...
/*
 * OAIDestiny2_GetPostGameCarnageReport_200_response.h
 *
 * 
 */

#ifndef OAIDestiny2_GetPostGameCarnageReport_200_response_H
#define OAIDestiny2_GetPostGameCarnageReport_200_response_H
...
namespace OpenAPI {
class OAIDestiny_HistoricalStats_DestinyPostGameCarnageReportData;

class OAIDestiny2_GetPostGameCarnageReport_200_response : public OAIObject {
public:
    OAIDestiny2_GetPostGameCarnageReport_200_response();
    OAIDestiny2_GetPostGameCarnageReport_200_response(QString json);
    ~OAIDestiny2_GetPostGameCarnageReport_200_response() override;
    ...
    OAIDestiny_HistoricalStats_DestinyPostGameCarnageReportData getResponse() const;
    void setResponse(const OAIDestiny_HistoricalStats_DestinyPostGameCarnageReportData &response);
...
private:
    ...
    OAIDestiny_HistoricalStats_DestinyPostGameCarnageReportData m_response;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDestiny2_GetPostGameCarnageReport_200_response)

#endif // OAIDestiny2_GetPostGameCarnageReport_200_response_H
