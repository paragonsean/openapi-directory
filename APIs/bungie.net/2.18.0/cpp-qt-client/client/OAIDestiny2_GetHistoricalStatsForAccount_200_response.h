...
/*
 * OAIDestiny2_GetHistoricalStatsForAccount_200_response.h
 *
 * 
 */

#ifndef OAIDestiny2_GetHistoricalStatsForAccount_200_response_H
#define OAIDestiny2_GetHistoricalStatsForAccount_200_response_H
...
namespace OpenAPI {
class OAIDestiny_HistoricalStats_DestinyHistoricalStatsAccountResult;

class OAIDestiny2_GetHistoricalStatsForAccount_200_response : public OAIObject {
public:
    OAIDestiny2_GetHistoricalStatsForAccount_200_response();
    OAIDestiny2_GetHistoricalStatsForAccount_200_response(QString json);
    ~OAIDestiny2_GetHistoricalStatsForAccount_200_response() override;
    ...
    OAIDestiny_HistoricalStats_DestinyHistoricalStatsAccountResult getResponse() const;
    void setResponse(const OAIDestiny_HistoricalStats_DestinyHistoricalStatsAccountResult &response);
...
private:
    ...
    OAIDestiny_HistoricalStats_DestinyHistoricalStatsAccountResult m_response;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDestiny2_GetHistoricalStatsForAccount_200_response)

#endif // OAIDestiny2_GetHistoricalStatsForAccount_200_response_H
