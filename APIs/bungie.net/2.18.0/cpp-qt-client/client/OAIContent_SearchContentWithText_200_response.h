...
/*
 * OAIContent_SearchContentWithText_200_response.h
 *
 * 
 */

#ifndef OAIContent_SearchContentWithText_200_response_H
#define OAIContent_SearchContentWithText_200_response_H
...
namespace OpenAPI {
class OAISearchResultOfContentItemPublicContract;

class OAIContent_SearchContentWithText_200_response : public OAIObject {
public:
    OAIContent_SearchContentWithText_200_response();
    OAIContent_SearchContentWithText_200_response(QString json);
    ~OAIContent_SearchContentWithText_200_response() override;
    ...
    OAISearchResultOfContentItemPublicContract getResponse() const;
    void setResponse(const OAISearchResultOfContentItemPublicContract &response);
...
private:
    ...
    OAISearchResultOfContentItemPublicContract m_response;
...
Q_DECLARE_METATYPE(OpenAPI::OAIContent_SearchContentWithText_200_response)

#endif // OAIContent_SearchContentWithText_200_response_H
