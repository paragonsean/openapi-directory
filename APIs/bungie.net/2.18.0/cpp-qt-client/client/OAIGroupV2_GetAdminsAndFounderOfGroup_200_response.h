...
/*
 * OAIGroupV2_GetAdminsAndFounderOfGroup_200_response.h
 *
 * 
 */

#ifndef OAIGroupV2_GetAdminsAndFounderOfGroup_200_response_H
#define OAIGroupV2_GetAdminsAndFounderOfGroup_200_response_H
...
namespace OpenAPI {
class OAISearchResultOfGroupMember;

class OAIGroupV2_GetAdminsAndFounderOfGroup_200_response : public OAIObject {
public:
    OAIGroupV2_GetAdminsAndFounderOfGroup_200_response();
    OAIGroupV2_GetAdminsAndFounderOfGroup_200_response(QString json);
    ~OAIGroupV2_GetAdminsAndFounderOfGroup_200_response() override;
    ...
    OAISearchResultOfGroupMember getResponse() const;
    void setResponse(const OAISearchResultOfGroupMember &response);
...
private:
    ...
    OAISearchResultOfGroupMember m_response;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGroupV2_GetAdminsAndFounderOfGroup_200_response)

#endif // OAIGroupV2_GetAdminsAndFounderOfGroup_200_response_H
