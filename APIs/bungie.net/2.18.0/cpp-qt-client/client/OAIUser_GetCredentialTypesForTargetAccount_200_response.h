...
/*
 * OAIUser_GetCredentialTypesForTargetAccount_200_response.h
 *
 * 
 */

#ifndef OAIUser_GetCredentialTypesForTargetAccount_200_response_H
#define OAIUser_GetCredentialTypesForTargetAccount_200_response_H
...
namespace OpenAPI {
class OAIUser_Models_GetCredentialTypesForAccountResponse;

class OAIUser_GetCredentialTypesForTargetAccount_200_response : public OAIObject {
public:
    OAIUser_GetCredentialTypesForTargetAccount_200_response();
    OAIUser_GetCredentialTypesForTargetAccount_200_response(QString json);
    ~OAIUser_GetCredentialTypesForTargetAccount_200_response() override;
    ...
    QList<OAIUser_Models_GetCredentialTypesForAccountResponse> getResponse() const;
    void setResponse(const QList<OAIUser_Models_GetCredentialTypesForAccountResponse> &response);
...
private:
    ...
    QList<OAIUser_Models_GetCredentialTypesForAccountResponse> m_response;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUser_GetCredentialTypesForTargetAccount_200_response)

#endif // OAIUser_GetCredentialTypesForTargetAccount_200_response_H
