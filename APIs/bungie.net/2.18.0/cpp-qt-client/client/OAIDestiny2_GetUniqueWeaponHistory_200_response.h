...
/*
 * OAIDestiny2_GetUniqueWeaponHistory_200_response.h
 *
 * 
 */

#ifndef OAIDestiny2_GetUniqueWeaponHistory_200_response_H
#define OAIDestiny2_GetUniqueWeaponHistory_200_response_H
...
namespace OpenAPI {
class OAIDestiny_HistoricalStats_DestinyHistoricalWeaponStatsData;

class OAIDestiny2_GetUniqueWeaponHistory_200_response : public OAIObject {
public:
    OAIDestiny2_GetUniqueWeaponHistory_200_response();
    OAIDestiny2_GetUniqueWeaponHistory_200_response(QString json);
    ~OAIDestiny2_GetUniqueWeaponHistory_200_response() override;
    ...
    OAIDestiny_HistoricalStats_DestinyHistoricalWeaponStatsData getResponse() const;
    void setResponse(const OAIDestiny_HistoricalStats_DestinyHistoricalWeaponStatsData &response);
...
private:
    ...
    OAIDestiny_HistoricalStats_DestinyHistoricalWeaponStatsData m_response;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDestiny2_GetUniqueWeaponHistory_200_response)

#endif // OAIDestiny2_GetUniqueWeaponHistory_200_response_H
