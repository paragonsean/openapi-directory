...
/*
 * OAIDestiny2_EquipItems_200_response.h
 *
 * 
 */

#ifndef OAIDestiny2_EquipItems_200_response_H
#define OAIDestiny2_EquipItems_200_response_H
...
namespace OpenAPI {
class OAIDestiny_DestinyEquipItemResults;

class OAIDestiny2_EquipItems_200_response : public OAIObject {
public:
    OAIDestiny2_EquipItems_200_response();
    OAIDestiny2_EquipItems_200_response(QString json);
    ~OAIDestiny2_EquipItems_200_response() override;
    ...
    OAIDestiny_DestinyEquipItemResults getResponse() const;
    void setResponse(const OAIDestiny_DestinyEquipItemResults &response);
...
private:
    ...
    OAIDestiny_DestinyEquipItemResults m_response;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDestiny2_EquipItems_200_response)

#endif // OAIDestiny2_EquipItems_200_response_H
