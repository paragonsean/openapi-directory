...
/*
 * OAIGroupV2_GetPotentialGroupsForMember_200_response.h
 *
 * 
 */

#ifndef OAIGroupV2_GetPotentialGroupsForMember_200_response_H
#define OAIGroupV2_GetPotentialGroupsForMember_200_response_H

#include <QJsonObject>

#include "OAIGroupsV2_GroupPotentialMembershipSearchResponse.h"
#include <QMap>
#include <QString>
...
namespace OpenAPI {
class OAIGroupsV2_GroupPotentialMembershipSearchResponse;

class OAIGroupV2_GetPotentialGroupsForMember_200_response : public OAIObject {
public:
    OAIGroupV2_GetPotentialGroupsForMember_200_response();
    OAIGroupV2_GetPotentialGroupsForMember_200_response(QString json);
    ~OAIGroupV2_GetPotentialGroupsForMember_200_response() override;
    ...
    OAIGroupsV2_GroupPotentialMembershipSearchResponse getResponse() const;
    void setResponse(const OAIGroupsV2_GroupPotentialMembershipSearchResponse &response);
...
private:
    ...
    OAIGroupsV2_GroupPotentialMembershipSearchResponse m_response;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGroupV2_GetPotentialGroupsForMember_200_response)

#endif // OAIGroupV2_GetPotentialGroupsForMember_200_response_H
