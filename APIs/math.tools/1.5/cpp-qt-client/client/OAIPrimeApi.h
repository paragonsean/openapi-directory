...
#ifndef OAI_OAIPrimeApi_H
#define OAI_OAIPrimeApi_H
...
class OAIPrimeApi : public QObject {
    Q_OBJECT

public:
    OAIPrimeApi(const int timeOut = 0);
    ~OAIPrimeApi();
    ...
    */
    virtual void numbersPrimeFactorsGet(const ::OpenAPI::OptionalParam<qint32> &number = ::OpenAPI::OptionalParam<qint32>());
...
private:
    ...
    void numbersPrimeFactorsGetCallback(OAIHttpRequestWorker *worker);
...
Q_SIGNALS:
    ...
    void numbersPrimeFactorsGetSignal();
    ...
    void numbersPrimeFactorsGetSignalFull(OAIHttpRequestWorker *worker);
    ...
    Q_DECL_DEPRECATED_X("Use numbersPrimeFactorsGetSignalError() instead")
    void numbersPrimeFactorsGetSignalE(QNetworkReply::NetworkError error_type, QString error_str);
    void numbersPrimeFactorsGetSignalError(QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use numbersPrimeFactorsGetSignalErrorFull() instead")
    void numbersPrimeFactorsGetSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void numbersPrimeFactorsGetSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
