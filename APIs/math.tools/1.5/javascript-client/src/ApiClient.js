...
class ApiClient {
     ...
     */
    constructor(basePath = 'https://api.math.tools') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default https://api.math.tools
         */
        ...
        this.authentications = {
            'X-Mathtools-Api-Secret': {type: 'apiKey', 'in': 'header', name: 'X-Mathtools-Api-Secret'}
        }
         ...
         */
        this.defaultHeaders = {
            'User-Agent': 'OpenAPI-Generator/1.5/Javascript'
        };
