...
public class ApiClient {
    ...
    private String basePath = "https://api.math.tools";
    ...
    public ApiClient() {
        ...
        authentications.put("X-Mathtools-Api-Secret", new ApiKeyAuth("header", "X-Mathtools-Api-Secret"));
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://api.math.tools
