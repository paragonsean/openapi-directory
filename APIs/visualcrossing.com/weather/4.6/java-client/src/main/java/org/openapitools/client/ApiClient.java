...
public class ApiClient {
    ...
    private String basePath = "https://weather.visualcrossing.com";
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/4.6/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://weather.visualcrossing.com
