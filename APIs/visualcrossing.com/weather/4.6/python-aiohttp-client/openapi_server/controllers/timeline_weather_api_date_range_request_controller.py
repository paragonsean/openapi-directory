...
async def visual_crossing_web_services_rest_services_timeline_location_startdate_enddate_get(request: web.Request, location, startdate, enddate, key, content_type=None, unit_group=None, include=None, lang=None) -> web.Response:
