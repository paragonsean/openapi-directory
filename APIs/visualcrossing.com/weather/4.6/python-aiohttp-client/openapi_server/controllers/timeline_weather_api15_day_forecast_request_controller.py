...
async def visual_crossing_web_services_rest_services_timeline_location_get(request: web.Request, location, key, content_type=None, unit_group=None, include=None, lang=None) -> web.Response:
