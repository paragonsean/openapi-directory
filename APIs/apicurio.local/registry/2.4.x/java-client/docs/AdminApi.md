...
public class Example {
  public static void main(String[] args) {
    ...
    AdminApi apiInstance = new AdminApi(defaultClient);
    try {
      apiInstance.deleteAllGlobalRules_0();
    } catch (ApiException e) {
      System.err.println("Exception when calling AdminApi#deleteAllGlobalRules_0");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      apiInstance.deleteGlobalRule_0(rule);
    } catch (ApiException e) {
      System.err.println("Exception when calling AdminApi#deleteGlobalRule_0");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="exportData"></a>
# **exportData**
> DownloadRef exportData(forBrowser)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      DownloadRef result = apiInstance.exportData(forBrowser);
...
public class Example {
  public static void main(String[] args) {
    ...
    RuleType rule = RuleType.fromValue("VALIDITY"); // RuleType | The unique name/type of a rule.
    try {
      Rule result = apiInstance.getGlobalRuleConfig_0(rule);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling AdminApi#getGlobalRuleConfig_0");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="listArtifactTypes_0"></a>
# **listArtifactTypes_0**
> List&lt;ArtifactTypeInfo&gt; listArtifactTypes_0()
...
public class Example {
  public static void main(String[] args) {
    ...
    AdminApi apiInstance = new AdminApi(defaultClient);
    try {
      List<ArtifactTypeInfo> result = apiInstance.listArtifactTypes_0();
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling AdminApi#listArtifactTypes_0");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="listGlobalRules_0"></a>
# **listGlobalRules_0**
> List&lt;RuleType&gt; listGlobalRules_0()
...
public class Example {
  public static void main(String[] args) {
    ...
    AdminApi apiInstance = new AdminApi(defaultClient);
    try {
      List<RuleType> result = apiInstance.listGlobalRules_0();
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling AdminApi#listGlobalRules_0");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="updateGlobalRuleConfig_0"></a>
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      Rule result = apiInstance.updateGlobalRuleConfig_0(rule, rule2);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling AdminApi#updateGlobalRuleConfig_0");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
