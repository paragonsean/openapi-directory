...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApicurioRegistryApiV2.SystemInfo();
  });
  ...
  describe('SystemInfo', function() {
    it('should create an instance of SystemInfo', function() {
      ...
      //var instance = new ApicurioRegistryApiV2.SystemInfo();
      //expect(instance).to.be.a(ApicurioRegistryApiV2.SystemInfo);
    });
