...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApicurioRegistryApiV2.SearchedVersion();
  });
  ...
  describe('SearchedVersion', function() {
    it('should create an instance of SearchedVersion', function() {
      // uncomment below and update the code to test SearchedVersion
      //var instance = new ApicurioRegistryApiV2.SearchedVersion();
      //expect(instance).to.be.a(ApicurioRegistryApiV2.SearchedVersion);
    });
