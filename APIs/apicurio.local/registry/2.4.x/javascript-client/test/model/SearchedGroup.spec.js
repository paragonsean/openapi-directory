...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApicurioRegistryApiV2.SearchedGroup();
  });
  ...
  describe('SearchedGroup', function() {
    it('should create an instance of SearchedGroup', function() {
      // uncomment below and update the code to test SearchedGroup
      //var instance = new ApicurioRegistryApiV2.SearchedGroup();
      //expect(instance).to.be.a(ApicurioRegistryApiV2.SearchedGroup);
    });
