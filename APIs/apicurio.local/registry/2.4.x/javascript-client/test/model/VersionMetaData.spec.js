...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApicurioRegistryApiV2.VersionMetaData();
  });
  ...
  describe('VersionMetaData', function() {
    it('should create an instance of VersionMetaData', function() {
      // uncomment below and update the code to test VersionMetaData
      //var instance = new ApicurioRegistryApiV2.VersionMetaData();
      //expect(instance).to.be.a(ApicurioRegistryApiV2.VersionMetaData);
    });
