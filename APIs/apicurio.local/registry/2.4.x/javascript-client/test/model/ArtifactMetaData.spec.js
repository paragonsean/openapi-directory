...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApicurioRegistryApiV2.ArtifactMetaData();
  });
  ...
  describe('ArtifactMetaData', function() {
    it('should create an instance of ArtifactMetaData', function() {
      // uncomment below and update the code to test ArtifactMetaData
      //var instance = new ApicurioRegistryApiV2.ArtifactMetaData();
      //expect(instance).to.be.a(ApicurioRegistryApiV2.ArtifactMetaData);
    });
