...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApicurioRegistryApiV2.RuleViolationError();
  });
  ...
  describe('RuleViolationError', function() {
    it('should create an instance of RuleViolationError', function() {
      // uncomment below and update the code to test RuleViolationError
      //var instance = new ApicurioRegistryApiV2.RuleViolationError();
      //expect(instance).to.be.a(ApicurioRegistryApiV2.RuleViolationError);
    });
