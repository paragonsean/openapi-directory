...
class VersionSearchResults {
     ...
     * @param count {Number} The total number of versions that matched the query (may be more than the number of versions returned in the result set).
     * @param versions {Array.<module:model/SearchedVersion>} The collection of artifact versions returned in the result set.
     */
