...
/*
 * OAIVersionMetaData.h
 *
 * 
 */

#ifndef OAIVersionMetaData_H
#define OAIVersionMetaData_H
...
class OAIVersionMetaData : public OAIObject {
public:
    OAIVersionMetaData();
    OAIVersionMetaData(QString json);
    ~OAIVersionMetaData() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIVersionMetaData)

#endif // OAIVersionMetaData_H
