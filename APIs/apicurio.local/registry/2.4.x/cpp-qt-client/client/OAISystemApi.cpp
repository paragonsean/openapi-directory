...
void OAISystemApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("getResourceLimits", defaultConf);
    _serverIndices.insert("getResourceLimits", 0);
...
void OAISystemApi::getResourceLimits() {
    QString fullPath = QString(_serverConfigs["getResourceLimits"][_serverIndices.value("getResourceLimits")].URL()+"/system/limits");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAISystemApi::getResourceLimitsCallback);
...
void OAISystemApi::getResourceLimitsCallback(OAIHttpRequestWorker *worker) {
    ...
    OAILimits output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT getResourceLimitsSignal(output);
        Q_EMIT getResourceLimitsSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT getResourceLimitsSignalE(output, error_type, error_str);
        Q_EMIT getResourceLimitsSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT getResourceLimitsSignalError(output, error_type, error_str);
        Q_EMIT getResourceLimitsSignalErrorFull(worker, error_type, error_str);
    }
}
