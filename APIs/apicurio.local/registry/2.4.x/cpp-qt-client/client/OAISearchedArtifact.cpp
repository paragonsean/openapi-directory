...
QString OAISearchedArtifact::getGroupId() const {
    return m_group_id;
}
void OAISearchedArtifact::setGroupId(const QString &group_id) {
    m_group_id = group_id;
    m_group_id_isSet = true;
}

bool OAISearchedArtifact::is_group_id_Set() const{
    return m_group_id_isSet;
}

bool OAISearchedArtifact::is_group_id_Valid() const{
...
QString OAISearchedArtifact::getType() const {
    return m_type;
}
void OAISearchedArtifact::setType(const QString &type) {
    m_type = type;
    m_type_isSet = true;
}
