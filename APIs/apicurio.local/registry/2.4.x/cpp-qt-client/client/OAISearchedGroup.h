...
#ifndef OAISearchedGroup_H
#define OAISearchedGroup_H
...
class OAISearchedGroup : public OAIObject {
public:
    OAISearchedGroup();
    OAISearchedGroup(QString json);
    ~OAISearchedGroup() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISearchedGroup)

#endif // OAISearchedGroup_H
