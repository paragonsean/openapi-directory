...
public:
    ...
    virtual void getResourceLimits();
...
private:
    ...
    void getResourceLimitsCallback(OAIHttpRequestWorker *worker);
    void getSystemInfoCallback(OAIHttpRequestWorker *worker);

Q_SIGNALS:

    void getResourceLimitsSignal(OAILimits summary);
    void getSystemInfoSignal(OAISystemInfo summary);


    void getResourceLimitsSignalFull(OAIHttpRequestWorker *worker, OAILimits summary);
    void getSystemInfoSignalFull(OAIHttpRequestWorker *worker, OAISystemInfo summary);

    Q_DECL_DEPRECATED_X("Use getResourceLimitsSignalError() instead")
    void getResourceLimitsSignalE(OAILimits summary, QNetworkReply::NetworkError error_type, QString error_str);
    void getResourceLimitsSignalError(OAILimits summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use getResourceLimitsSignalErrorFull() instead")
    void getResourceLimitsSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void getResourceLimitsSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
