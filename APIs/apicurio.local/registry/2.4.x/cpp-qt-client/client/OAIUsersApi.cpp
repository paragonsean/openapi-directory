...
void OAIUsersApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("getCurrentUserInfo", defaultConf);
    _serverIndices.insert("getCurrentUserInfo", 0);
}
...
void OAIUsersApi::getCurrentUserInfo() {
    QString fullPath = QString(_serverConfigs["getCurrentUserInfo"][_serverIndices.value("getCurrentUserInfo")].URL()+"/users/me");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIUsersApi::getCurrentUserInfoCallback);
...
void OAIUsersApi::getCurrentUserInfoCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT getCurrentUserInfoSignal(output);
        Q_EMIT getCurrentUserInfoSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT getCurrentUserInfoSignalE(output, error_type, error_str);
        Q_EMIT getCurrentUserInfoSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT getCurrentUserInfoSignalError(output, error_type, error_str);
        Q_EMIT getCurrentUserInfoSignalErrorFull(worker, error_type, error_str);
    }
}
