...
qint64 OAIArtifactMetaData::getContentId() const {
    return m_content_id;
}
void OAIArtifactMetaData::setContentId(const qint64 &content_id) {
    m_content_id = content_id;
    m_content_id_isSet = true;
}

bool OAIArtifactMetaData::is_content_id_Set() const{
    return m_content_id_isSet;
}

bool OAIArtifactMetaData::is_content_id_Valid() const{
...
QString OAIArtifactMetaData::getGroupId() const {
    return m_group_id;
}
void OAIArtifactMetaData::setGroupId(const QString &group_id) {
    m_group_id = group_id;
    m_group_id_isSet = true;
}

bool OAIArtifactMetaData::is_group_id_Set() const{
    return m_group_id_isSet;
}

bool OAIArtifactMetaData::is_group_id_Valid() const{
...
QList<OAIArtifactReference> OAIArtifactMetaData::getReferences() const {
    return m_references;
}
void OAIArtifactMetaData::setReferences(const QList<OAIArtifactReference> &references) {
    m_references = references;
    m_references_isSet = true;
}

bool OAIArtifactMetaData::is_references_Set() const{
    return m_references_isSet;
}

bool OAIArtifactMetaData::is_references_Valid() const{
...
QString OAIArtifactMetaData::getType() const {
    return m_type;
}
void OAIArtifactMetaData::setType(const QString &type) {
    m_type = type;
    m_type_isSet = true;
}
...
QString OAIArtifactMetaData::getVersion() const {
    return m_version;
}
void OAIArtifactMetaData::setVersion(const QString &version) {
    m_version = version;
...
bool OAIArtifactMetaData::isValid() const {
    ...
    return m_content_id_isValid && m_created_by_isValid && m_created_on_isValid && m_global_id_isValid && m_id_isValid && m_modified_by_isValid && m_modified_on_isValid && m_state_isValid && m_type_isValid && m_version_isValid && true;
}
