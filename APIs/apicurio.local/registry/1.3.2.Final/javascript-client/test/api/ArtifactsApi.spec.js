...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApicurioRegistryApi.ArtifactsApi();
  });
  ...
  describe('ArtifactsApi', function() {
    ...
    describe('getArtifactByGlobalId', function() {
      it('should call getArtifactByGlobalId successfully', function(done) {
        //uncomment below and update the code to test getArtifactByGlobalId
        //instance.getArtifactByGlobalId(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
