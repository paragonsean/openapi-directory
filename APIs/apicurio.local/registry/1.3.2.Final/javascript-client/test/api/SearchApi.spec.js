...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApicurioRegistryApi.SearchApi();
  });
  ...
  describe('SearchApi', function() {
    ...
    describe('searchVersions', function() {
      it('should call searchVersions successfully', function(done) {
        //uncomment below and update the code to test searchVersions
        //instance.searchVersions(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
