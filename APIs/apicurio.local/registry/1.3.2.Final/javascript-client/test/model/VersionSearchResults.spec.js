...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApicurioRegistryApi.VersionSearchResults();
  });
  ...
  describe('VersionSearchResults', function() {
    it('should create an instance of VersionSearchResults', function() {
      // uncomment below and update the code to test VersionSearchResults
      //var instance = new ApicurioRegistryApi.VersionSearchResults();
      //expect(instance).to.be.a(ApicurioRegistryApi.VersionSearchResults);
    });
