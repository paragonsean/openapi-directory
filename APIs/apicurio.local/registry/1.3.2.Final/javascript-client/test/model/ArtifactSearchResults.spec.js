...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApicurioRegistryApi.ArtifactSearchResults();
  });
  ...
  describe('ArtifactSearchResults', function() {
    it('should create an instance of ArtifactSearchResults', function() {
      ...
      //var instance = new ApicurioRegistryApi.ArtifactSearchResults();
      //expect(instance).to.be.a(ApicurioRegistryApi.ArtifactSearchResults);
    });
