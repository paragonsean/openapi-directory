...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApicurioRegistryApi.SearchedArtifact();
  });
  ...
  describe('SearchedArtifact', function() {
    it('should create an instance of SearchedArtifact', function() {
      ...
      //var instance = new ApicurioRegistryApi.SearchedArtifact();
      //expect(instance).to.be.a(ApicurioRegistryApi.SearchedArtifact);
    });
