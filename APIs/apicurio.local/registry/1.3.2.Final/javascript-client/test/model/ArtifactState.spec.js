...
(function(root, factory) {
  ...
  describe('ArtifactState', function() {
    it('should create an instance of ArtifactState', function() {
      // uncomment below and update the code to test ArtifactState
      //var instance = new ApicurioRegistryApi.ArtifactState();
      //expect(instance).to.be.a(ApicurioRegistryApi.ArtifactState);
    });
