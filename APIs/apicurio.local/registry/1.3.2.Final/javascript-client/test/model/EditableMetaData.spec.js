...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApicurioRegistryApi.EditableMetaData();
  });
  ...
  describe('EditableMetaData', function() {
    it('should create an instance of EditableMetaData', function() {
      ...
      //var instance = new ApicurioRegistryApi.EditableMetaData();
      //expect(instance).to.be.a(ApicurioRegistryApi.EditableMetaData);
    });
