...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApicurioRegistryApi.UpdateState();
  });
  ...
  describe('UpdateState', function() {
    it('should create an instance of UpdateState', function() {
      // uncomment below and update the code to test UpdateState
      //var instance = new ApicurioRegistryApi.UpdateState();
      //expect(instance).to.be.a(ApicurioRegistryApi.UpdateState);
    });
