...
(function(root, factory) {
  ...
  describe('SearchOver', function() {
    it('should create an instance of SearchOver', function() {
      // uncomment below and update the code to test SearchOver
      //var instance = new ApicurioRegistryApi.SearchOver();
      //expect(instance).to.be.a(ApicurioRegistryApi.SearchOver);
    });
