...
public class VersionMetaData {
  ...
  public VersionMetaData version(Long version) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.createdBy, versionMetaData.createdBy) &&
        ...
        Objects.equals(this.version, versionMetaData.version);
  }

  @Override
  public int hashCode() {
    return Objects.hash(createdBy, createdOn, description, globalId, id, labels, name, properties, state, type, version);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to VersionMetaData
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!VersionMetaData.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!VersionMetaData.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `VersionMetaData` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
