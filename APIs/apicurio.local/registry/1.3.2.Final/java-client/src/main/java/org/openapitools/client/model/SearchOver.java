 ...
 * 
 */
@JsonAdapter(SearchOver.Adapter.class)
public enum SearchOver {
  ...
  public static SearchOver fromValue(String value) {
    for (SearchOver b : SearchOver.values()) {
  ...
  public static class Adapter extends TypeAdapter<SearchOver> {
    @Override
    public void write(final JsonWriter jsonWriter, final SearchOver enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public SearchOver read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return SearchOver.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    SearchOver.fromValue(value);
  }
}
