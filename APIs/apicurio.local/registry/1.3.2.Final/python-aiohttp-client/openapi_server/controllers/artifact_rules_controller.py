...
async def create_artifact_rule(request: web.Request, artifact_id, body) -> web.Response:
...
async def delete_artifact_rule(request: web.Request, rule, artifact_id) -> web.Response:
...
async def delete_artifact_rules(request: web.Request, artifact_id) -> web.Response:
...
async def get_artifact_rule_config(request: web.Request, rule, artifact_id) -> web.Response:
...
async def list_artifact_rules(request: web.Request, artifact_id) -> web.Response:
    """List artifact rules
...
async def test_update_artifact(request: web.Request, artifact_id, x_registry_artifact_type=None) -> web.Response:
...
async def update_artifact_rule_config(request: web.Request, rule, artifact_id, body) -> web.Response:
