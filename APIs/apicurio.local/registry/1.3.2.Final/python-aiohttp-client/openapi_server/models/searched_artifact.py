...
class SearchedArtifact(Model):
    ...
    def __init__(self, created_by: str=None, created_on: datetime=None, description: str=None, id: str=None, labels: List[str]=None, modified_by: str=None, modified_on: datetime=None, name: str=None, state: ArtifactState=None, type: ArtifactType=None):
