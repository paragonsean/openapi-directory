...
void OAISearchApi::searchArtifacts(const qint32 &offset, const qint32 &limit, const ::OpenAPI::OptionalParam<QString> &search, const ::OpenAPI::OptionalParam<QString> &over, const ::OpenAPI::OptionalParam<QString> &order) {
...
void OAISearchApi::searchVersions(const QString &artifact_id, const qint32 &offset, const qint32 &limit) {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAISearchApi::searchVersionsCallback);
    connect(this, &OAISearchApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAISearchApi::searchVersionsCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
