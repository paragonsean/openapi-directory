...
#ifndef OAISearchOver_H
#define OAISearchOver_H
...
class OAISearchOver : public OAIEnum {
public:
    OAISearchOver();
    OAISearchOver(QString json);
    ~OAISearchOver() override;
    ...
    OAISearchOver::eOAISearchOver getValue() const;
    void setValue(const OAISearchOver::eOAISearchOver& value);
...
Q_DECLARE_METATYPE(OpenAPI::OAISearchOver)

#endif // OAISearchOver_H
