...
OAIArtifactType OAIVersionMetaData::getType() const {
    return m_type;
}
void OAIVersionMetaData::setType(const OAIArtifactType &type) {
    m_type = type;
    m_type_isSet = true;
}
...
qint64 OAIVersionMetaData::getVersion() const {
    return m_version;
}
void OAIVersionMetaData::setVersion(const qint64 &version) {
    m_version = version;
...
bool OAIVersionMetaData::isValid() const {
    ...
    return m_created_by_isValid && m_created_on_isValid && m_global_id_isValid && m_id_isValid && m_type_isValid && m_version_isValid && true;
}
