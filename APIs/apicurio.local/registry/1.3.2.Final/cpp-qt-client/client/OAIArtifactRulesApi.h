...
public:
    ...
    */
    virtual void createArtifactRule(const QString &artifact_id, const OAIRule &oai_rule);

    /**
    * @param[in]  rule QString [required]
    * @param[in]  artifact_id QString [required]
    */
    virtual void deleteArtifactRule(const QString &rule, const QString &artifact_id);

    /**
    * @param[in]  artifact_id QString [required]
    */
    virtual void deleteArtifactRules(const QString &artifact_id);

    /**
    * @param[in]  rule QString [required]
    * @param[in]  artifact_id QString [required]
    */
    virtual void getArtifactRuleConfig(const QString &rule, const QString &artifact_id);

    /**
    * @param[in]  artifact_id QString [required]
    */
    virtual void listArtifactRules(const QString &artifact_id);

    /**
    * @param[in]  artifact_id QString [required]
    * @param[in]  x_registry_artifact_type QString [optional]
    */
    virtual void testUpdateArtifact(const QString &artifact_id, const ::OpenAPI::OptionalParam<QString> &x_registry_artifact_type = ::OpenAPI::OptionalParam<QString>());
    ...
    * @param[in]  oai_rule OAIRule [required]
    */
    virtual void updateArtifactRuleConfig(const QString &rule, const QString &artifact_id, const OAIRule &oai_rule);
