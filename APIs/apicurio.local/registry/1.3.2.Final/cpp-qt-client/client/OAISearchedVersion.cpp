...
OAIArtifactType OAISearchedVersion::getType() const {
    return m_type;
}
void OAISearchedVersion::setType(const OAIArtifactType &type) {
    m_type = type;
    m_type_isSet = true;
}
...
qint32 OAISearchedVersion::getVersion() const {
    return m_version;
}
void OAISearchedVersion::setVersion(const qint32 &version) {
    m_version = version;
...
bool OAISearchedVersion::isValid() const {
    ...
    return m_created_by_isValid && m_created_on_isValid && m_global_id_isValid && m_state_isValid && m_type_isValid && m_version_isValid && true;
}
