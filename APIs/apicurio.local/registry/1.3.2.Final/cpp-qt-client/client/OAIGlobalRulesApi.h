...
public:
    ...
    */
    virtual void deleteGlobalRule(const QString &rule);

    /**
    * @param[in]  rule QString [required]
    */
    virtual void getGlobalRuleConfig(const QString &rule);
    ...
    * @param[in]  oai_rule OAIRule [required]
    */
    virtual void updateGlobalRuleConfig(const QString &rule, const OAIRule &oai_rule);
