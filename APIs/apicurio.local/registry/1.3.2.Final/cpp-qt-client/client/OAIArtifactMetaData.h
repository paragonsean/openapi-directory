...
/*
 * OAIArtifactMetaData.h
 *
 * 
 */

#ifndef OAIArtifactMetaData_H
#define OAIArtifactMetaData_H
...
class OAIArtifactMetaData : public OAIObject {
public:
    OAIArtifactMetaData();
    OAIArtifactMetaData(QString json);
    ~OAIArtifactMetaData() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIArtifactMetaData)

#endif // OAIArtifactMetaData_H
