...
#ifndef OAIArtifactState_H
#define OAIArtifactState_H
...
class OAIArtifactState : public OAIEnum {
public:
    OAIArtifactState();
    OAIArtifactState(QString json);
    ~OAIArtifactState() override;
    ...
    OAIArtifactState::eOAIArtifactState getValue() const;
    void setValue(const OAIArtifactState::eOAIArtifactState& value);
...
Q_DECLARE_METATYPE(OpenAPI::OAIArtifactState)

#endif // OAIArtifactState_H
