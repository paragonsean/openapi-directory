...
public class ModelList extends TimelineTable {
  ...
  public ModelList data(List<String> data) {
    this.data = data;
    return this;
  }

  public ModelList addDataItem(String dataItem) {
    if (this.data == null) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.data, _list.data) &&
        super.equals(o);
  }
