...
public class Product {
  ...
  public static final String SERIALIZED_NAME_REQUIRES_SHIPPING = "requiresShipping";
   ...
   */
  @JsonAdapter(TaxCategoryIdEnum.Adapter.class)
  public enum TaxCategoryIdEnum {
    _00000("00000"),
    ...
    TaxCategoryIdEnum(String value) {
      this.value = value;
    }
    ...
    public static TaxCategoryIdEnum fromValue(String value) {
      for (TaxCategoryIdEnum b : TaxCategoryIdEnum.values()) {
    ...
    public static class Adapter extends TypeAdapter<TaxCategoryIdEnum> {
      @Override
      public void write(final JsonWriter jsonWriter, final TaxCategoryIdEnum enumeration) throws IOException {
        jsonWriter.value(enumeration.getValue());
      }

      @Override
      public TaxCategoryIdEnum read(final JsonReader jsonReader) throws IOException {
        String value =  jsonReader.nextString();
        return TaxCategoryIdEnum.fromValue(value);
      }
    }

    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      String value = jsonElement.getAsString();
      TaxCategoryIdEnum.fromValue(value);
    }
  }

  public static final String SERIALIZED_NAME_TAX_CATEGORY_ID = "taxCategoryId";
  @SerializedName(SERIALIZED_NAME_TAX_CATEGORY_ID)
  private TaxCategoryIdEnum taxCategoryId;
  ...
  public Product options(List<String> options) {
    this.options = options;
    return this;
  }

  public Product addOptionsItem(String optionsItem) {
  ...
  public Product requiresShipping(Boolean requiresShipping) {
  ...
  public Product accountingCode(String accountingCode) {
  ...
  public Product taxCategoryId(TaxCategoryIdEnum taxCategoryId) {
   ...
   */
  @javax.annotation.Nullable
  public TaxCategoryIdEnum getTaxCategoryId() {
    return taxCategoryId;
  }

  public void setTaxCategoryId(TaxCategoryIdEnum taxCategoryId) {
    this.taxCategoryId = taxCategoryId;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.createdTime, product.createdTime) &&
        ...
        Objects.equals(this.requiresShipping, product.requiresShipping) &&
        Objects.equals(this.unitLabel, product.unitLabel) &&
        Objects.equals(this.updatedTime, product.updatedTime) &&
        Objects.equals(this.links, product.links) &&
        Objects.equals(this.accountingCode, product.accountingCode) &&
        Objects.equals(this.taxCategoryId, product.taxCategoryId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(createdTime, customFields, description, id, name, options, requiresShipping, unitLabel, updatedTime, links, accountingCode, taxCategoryId);
  }
  ...
  static {
    ...
    openapiFields.add("requiresShipping");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      // validate the optional field `taxCategoryId`
      if (jsonObj.get("taxCategoryId") != null && !jsonObj.get("taxCategoryId").isJsonNull()) {
        TaxCategoryIdEnum.validateJsonElement(jsonObj.get("taxCategoryId"));
      }
  }
