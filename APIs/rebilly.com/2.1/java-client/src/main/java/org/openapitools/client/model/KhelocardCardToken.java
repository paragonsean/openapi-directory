...
public class KhelocardCardToken {
  ...
  public KhelocardCardToken billingAddress(ContactObject billingAddress) {
  ...
  public KhelocardCardToken method(MethodEnum method) {
    this.method = method;
    return this;
  }
  ...
  public KhelocardCardToken paymentInstrument(Object paymentInstrument) {
  ...
  public KhelocardCardToken leadSource(LeadSource leadSource) {
  ...
  public KhelocardCardToken riskMetadata(RiskMetadata riskMetadata) {
  ...
  public boolean equals(Object o) {
    ...
    KhelocardCardToken khelocardCardToken = (KhelocardCardToken) o;
    return Objects.equals(this.billingAddress, khelocardCardToken.billingAddress) &&
        Objects.equals(this.method, khelocardCardToken.method) &&
        Objects.equals(this.paymentInstrument, khelocardCardToken.paymentInstrument) &&
        Objects.equals(this.links, khelocardCardToken.links) &&
        Objects.equals(this.createdTime, khelocardCardToken.createdTime) &&
        Objects.equals(this.expirationTime, khelocardCardToken.expirationTime) &&
        Objects.equals(this.id, khelocardCardToken.id) &&
        Objects.equals(this.isUsed, khelocardCardToken.isUsed) &&
        Objects.equals(this.leadSource, khelocardCardToken.leadSource) &&
        Objects.equals(this.riskMetadata, khelocardCardToken.riskMetadata) &&
        Objects.equals(this.updatedTime, khelocardCardToken.updatedTime) &&
        Objects.equals(this.usageTime, khelocardCardToken.usageTime);
  }
  ...
  public String toString() {
    ...
    sb.append("class KhelocardCardToken {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to KhelocardCardToken
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!KhelocardCardToken.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in KhelocardCardToken is not found in the empty JSON string", KhelocardCardToken.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!KhelocardCardToken.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `KhelocardCardToken` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : KhelocardCardToken.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!KhelocardCardToken.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'KhelocardCardToken' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<KhelocardCardToken> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(KhelocardCardToken.class));

       return (TypeAdapter<T>) new TypeAdapter<KhelocardCardToken>() {
           @Override
           public void write(JsonWriter out, KhelocardCardToken value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public KhelocardCardToken read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of KhelocardCardToken given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of KhelocardCardToken
   * @throws IOException if the JSON string is invalid with respect to KhelocardCardToken
   */
  public static KhelocardCardToken fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, KhelocardCardToken.class);
  }

  /**
   * Convert an instance of KhelocardCardToken to an JSON string
   *
   * @return JSON string
   */
