...
import org.openapitools.client.model.ProofOfIdentityAllOfDocumentMatches;
import org.openapitools.client.model.ProofOfIdentityAllOfLinks;
...
public class ProofOfIdentity {
  ...
  private List<ProofOfIdentityAllOfLinks> links = new ArrayList<>();
  ...
  private ProofOfIdentityAllOfDocumentMatches documentMatches;

  public static final String SERIALIZED_NAME_PARSED_DATA = "parsedData";
  @SerializedName(SERIALIZED_NAME_PARSED_DATA)
  private ProofOfIdentityAllOfDocumentMatches parsedData;

  public ProofOfIdentity() {
  }

  public ProofOfIdentity(
     List<ProofOfIdentityAllOfLinks> links, 
  ...
  public List<ProofOfIdentityAllOfLinks> getLinks() {
    return links;
  }
  ...
  public ProofOfIdentity documentSubtype(KycDocumentSubtypes documentSubtype) {
  ...
  public ProofOfIdentity documentType(KycDocumentTypes documentType) {
  ...
  @Deprecated
  public ProofOfIdentity fileId(String fileId) {
    this.fileId = fileId;
    return this;
  }
  ...
  public ProofOfIdentity fileIds(List<String> fileIds) {
    this.fileIds = fileIds;
    return this;
  }

  public ProofOfIdentity addFileIdsItem(String fileIdsItem) {
  ...
  public ProofOfIdentity rejectionReason(KycDocumentRejection rejectionReason) {
  ...
  public ProofOfIdentity customerId(String customerId) {
  ...
  public ProofOfIdentity matchLevel(Integer matchLevel) {
  ...
  public ProofOfIdentity notes(String notes) {
    this.notes = notes;
    return this;
  }
  ...
  public ProofOfIdentity reason(String reason) {
    this.reason = reason;
    return this;
  }
  ...
  public ProofOfIdentity documentMatches(ProofOfIdentityAllOfDocumentMatches documentMatches) {
   ...
   */
  @javax.annotation.Nullable
  public ProofOfIdentityAllOfDocumentMatches getDocumentMatches() {
    return documentMatches;
  }

  public void setDocumentMatches(ProofOfIdentityAllOfDocumentMatches documentMatches) {
    this.documentMatches = documentMatches;
  }


  public ProofOfIdentity parsedData(ProofOfIdentityAllOfDocumentMatches parsedData) {
   ...
   */
  @javax.annotation.Nullable
  public ProofOfIdentityAllOfDocumentMatches getParsedData() {
    return parsedData;
  }

  public void setParsedData(ProofOfIdentityAllOfDocumentMatches parsedData) {
    this.parsedData = parsedData;
  }
  ...
  public boolean equals(Object o) {
    ...
    ProofOfIdentity proofOfIdentity = (ProofOfIdentity) o;
    return Objects.equals(this.links, proofOfIdentity.links) &&
        Objects.equals(this.createdTime, proofOfIdentity.createdTime) &&
        Objects.equals(this.documentSubtype, proofOfIdentity.documentSubtype) &&
        Objects.equals(this.documentType, proofOfIdentity.documentType) &&
        Objects.equals(this.fileId, proofOfIdentity.fileId) &&
        Objects.equals(this.fileIds, proofOfIdentity.fileIds) &&
        Objects.equals(this.id, proofOfIdentity.id) &&
        Objects.equals(this.processedTime, proofOfIdentity.processedTime) &&
        Objects.equals(this.rejectionReason, proofOfIdentity.rejectionReason) &&
        Objects.equals(this.requestId, proofOfIdentity.requestId) &&
        Objects.equals(this.status, proofOfIdentity.status) &&
        Objects.equals(this.updatedTime, proofOfIdentity.updatedTime) &&
        Objects.equals(this.customerId, proofOfIdentity.customerId) &&
        Objects.equals(this.matchLevel, proofOfIdentity.matchLevel) &&
        Objects.equals(this.notes, proofOfIdentity.notes) &&
        Objects.equals(this.reason, proofOfIdentity.reason) &&
        Objects.equals(this.reviewTime, proofOfIdentity.reviewTime) &&
        Objects.equals(this.reviewerId, proofOfIdentity.reviewerId) &&
        Objects.equals(this.reviewerName, proofOfIdentity.reviewerName) &&
        Objects.equals(this.documentMatches, proofOfIdentity.documentMatches) &&
        Objects.equals(this.parsedData, proofOfIdentity.parsedData);
  }
  ...
  public String toString() {
    ...
    sb.append("class ProofOfIdentity {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ProofOfIdentity
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ProofOfIdentity.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ProofOfIdentity is not found in the empty JSON string", ProofOfIdentity.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ProofOfIdentity.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ProofOfIdentity` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ProofOfIdentity.openapiRequiredFields) {
      ...
      if (jsonObj.get("_links") != null && !jsonObj.get("_links").isJsonNull()) {
        ...
        if (jsonArraylinks != null) {
          ...
          for (int i = 0; i < jsonArraylinks.size(); i++) {
            ProofOfIdentityAllOfLinks.validateJsonElement(jsonArraylinks.get(i));
          };
        }
      }
      ...
      if (jsonObj.get("documentMatches") != null && !jsonObj.get("documentMatches").isJsonNull()) {
        ProofOfIdentityAllOfDocumentMatches.validateJsonElement(jsonObj.get("documentMatches"));
      }
      // validate the optional field `parsedData`
      if (jsonObj.get("parsedData") != null && !jsonObj.get("parsedData").isJsonNull()) {
        ProofOfIdentityAllOfDocumentMatches.validateJsonElement(jsonObj.get("parsedData"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ProofOfIdentity.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ProofOfIdentity' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ProofOfIdentity> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ProofOfIdentity.class));

       return (TypeAdapter<T>) new TypeAdapter<ProofOfIdentity>() {
           @Override
           public void write(JsonWriter out, ProofOfIdentity value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ProofOfIdentity read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ProofOfIdentity given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ProofOfIdentity
   * @throws IOException if the JSON string is invalid with respect to ProofOfIdentity
   */
  public static ProofOfIdentity fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ProofOfIdentity.class);
  }

  /**
   * Convert an instance of ProofOfIdentity to an JSON string
   *
   * @return JSON string
   */
