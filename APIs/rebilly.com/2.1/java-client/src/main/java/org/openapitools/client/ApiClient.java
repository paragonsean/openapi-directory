...
public class ApiClient {
    ...
    private String basePath = "https://api-sandbox.rebilly.com";
    ...
    public ApiClient() {
        ...
        authentications.put("PublishableApiKey", new ApiKeyAuth("header", "Authorization"));
        authentications.put("SecretApiKey", new ApiKeyAuth("header", "REB-APIKEY"));
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://api-sandbox.rebilly.com
