 ...
 */
@JsonAdapter(GlobalWebhookEventType.Adapter.class)
public enum GlobalWebhookEventType {
  ...
  GlobalWebhookEventType(String value) {
    this.value = value;
  }
  ...
  public static GlobalWebhookEventType fromValue(String value) {
    for (GlobalWebhookEventType b : GlobalWebhookEventType.values()) {
  ...
  public static class Adapter extends TypeAdapter<GlobalWebhookEventType> {
    @Override
    public void write(final JsonWriter jsonWriter, final GlobalWebhookEventType enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public GlobalWebhookEventType read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return GlobalWebhookEventType.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    GlobalWebhookEventType.fromValue(value);
  }
}
