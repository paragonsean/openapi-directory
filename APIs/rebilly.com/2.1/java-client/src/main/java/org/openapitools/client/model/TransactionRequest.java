...
public class TransactionRequest {
  ...
  public TransactionRequest billingAddress(ContactObject billingAddress) {
  ...
  public TransactionRequest customFields(Object customFields) {
  ...
  public TransactionRequest gatewayAccountId(String gatewayAccountId) {
  ...
  public TransactionRequest invoiceIds(List<String> invoiceIds) {
    this.invoiceIds = invoiceIds;
    return this;
  }

  public TransactionRequest addInvoiceIdsItem(String invoiceIdsItem) {
  ...
  public TransactionRequest isMerchantInitiated(Boolean isMerchantInitiated) {
  ...
  public TransactionRequest isProcessedOutside(Boolean isProcessedOutside) {
  ...
  public TransactionRequest notificationUrl(URI notificationUrl) {
  ...
  public TransactionRequest paymentInstruction(PaymentInstruction paymentInstruction) {
  ...
  @Deprecated
  public TransactionRequest paymentInstrument(PaymentInstrument paymentInstrument) {
  ...
  public TransactionRequest processedTime(OffsetDateTime processedTime) {
  ...
  public TransactionRequest redirectUrl(URI redirectUrl) {
  ...
  public TransactionRequest requestId(String requestId) {
  ...
  public TransactionRequest riskMetadata(RiskMetadata riskMetadata) {
  ...
  public TransactionRequest websiteId(String websiteId) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.amount, transactionRequest.amount) &&
        Objects.equals(this.billingAddress, transactionRequest.billingAddress) &&
        Objects.equals(this.currency, transactionRequest.currency) &&
        Objects.equals(this.customFields, transactionRequest.customFields) &&
        Objects.equals(this.customerId, transactionRequest.customerId) &&
        Objects.equals(this.description, transactionRequest.description) &&
        Objects.equals(this.gatewayAccountId, transactionRequest.gatewayAccountId) &&
        Objects.equals(this.invoiceIds, transactionRequest.invoiceIds) &&
        Objects.equals(this.isMerchantInitiated, transactionRequest.isMerchantInitiated) &&
        Objects.equals(this.isProcessedOutside, transactionRequest.isProcessedOutside) &&
        Objects.equals(this.notificationUrl, transactionRequest.notificationUrl) &&
        Objects.equals(this.paymentInstruction, transactionRequest.paymentInstruction) &&
        Objects.equals(this.paymentInstrument, transactionRequest.paymentInstrument) &&
        Objects.equals(this.processedTime, transactionRequest.processedTime) &&
        Objects.equals(this.redirectUrl, transactionRequest.redirectUrl) &&
        Objects.equals(this.requestId, transactionRequest.requestId) &&
        Objects.equals(this.riskMetadata, transactionRequest.riskMetadata) &&
        Objects.equals(this.websiteId, transactionRequest.websiteId) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(amount, billingAddress, currency, customFields, customerId, description, gatewayAccountId, invoiceIds, isMerchantInitiated, isProcessedOutside, notificationUrl, paymentInstruction, paymentInstrument, processedTime, redirectUrl, requestId, riskMetadata, websiteId, type);
  }
