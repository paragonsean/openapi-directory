...
public class KycDocument {
  ...
  public KycDocument documentSubtype(KycDocumentSubtypes documentSubtype) {
  ...
  public KycDocument documentType(KycDocumentTypes documentType) {
  ...
  @Deprecated
  public KycDocument fileId(String fileId) {
    this.fileId = fileId;
    return this;
  }
  ...
  public KycDocument fileIds(List<String> fileIds) {
    this.fileIds = fileIds;
    return this;
  }

  public KycDocument addFileIdsItem(String fileIdsItem) {
  ...
  public KycDocument rejectionReason(KycDocumentRejection rejectionReason) {
  ...
  public KycDocument customerId(String customerId) {
  ...
  public KycDocument matchLevel(Integer matchLevel) {
  ...
  public KycDocument notes(String notes) {
    this.notes = notes;
    return this;
  }
  ...
  public KycDocument reason(String reason) {
    this.reason = reason;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    KycDocument kycDocument = (KycDocument) o;
    return Objects.equals(this.links, kycDocument.links) &&
        Objects.equals(this.createdTime, kycDocument.createdTime) &&
        Objects.equals(this.documentSubtype, kycDocument.documentSubtype) &&
        Objects.equals(this.documentType, kycDocument.documentType) &&
        Objects.equals(this.fileId, kycDocument.fileId) &&
        Objects.equals(this.fileIds, kycDocument.fileIds) &&
        Objects.equals(this.id, kycDocument.id) &&
        Objects.equals(this.processedTime, kycDocument.processedTime) &&
        Objects.equals(this.rejectionReason, kycDocument.rejectionReason) &&
        Objects.equals(this.requestId, kycDocument.requestId) &&
        Objects.equals(this.status, kycDocument.status) &&
        Objects.equals(this.updatedTime, kycDocument.updatedTime) &&
        Objects.equals(this.customerId, kycDocument.customerId) &&
        Objects.equals(this.matchLevel, kycDocument.matchLevel) &&
        Objects.equals(this.notes, kycDocument.notes) &&
        Objects.equals(this.reason, kycDocument.reason) &&
        Objects.equals(this.reviewTime, kycDocument.reviewTime) &&
        Objects.equals(this.reviewerId, kycDocument.reviewerId) &&
        Objects.equals(this.reviewerName, kycDocument.reviewerName);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to KycDocument
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!KycDocument.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in KycDocument is not found in the empty JSON string", KycDocument.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!KycDocument.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `KycDocument` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : KycDocument.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!KycDocument.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'KycDocument' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<KycDocument> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(KycDocument.class));

       return (TypeAdapter<T>) new TypeAdapter<KycDocument>() {
           @Override
           public void write(JsonWriter out, KycDocument value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public KycDocument read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of KycDocument given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of KycDocument
   * @throws IOException if the JSON string is invalid with respect to KycDocument
   */
  public static KycDocument fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, KycDocument.class);
  }

  /**
   * Convert an instance of KycDocument to an JSON string
   *
   * @return JSON string
   */
