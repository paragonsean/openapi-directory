...
public class AuthenticationToken {
  ...
  protected ModeEnum mode = ModeEnum.PASSWORD;
  ...
  public AuthenticationToken mode(ModeEnum mode) {
    this.mode = mode;
    return this;
  }
  ...
  public AuthenticationToken otpRequired(Boolean otpRequired) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.credentialId, authenticationToken.credentialId) &&
        Objects.equals(this.mode, authenticationToken.mode) &&
        Objects.equals(this.otpRequired, authenticationToken.otpRequired) &&
        Objects.equals(this.token, authenticationToken.token);
  }

  @Override
  public int hashCode() {
    return Objects.hash(credentialId, mode, otpRequired, token);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      String discriminatorValue = jsonElement.getAsJsonObject().get("mode").getAsString();
      switch (discriminatorValue) {
        case "password":
          Password.validateJsonElement(jsonElement);
          break;
        case "passwordless":
          Passwordless.validateJsonElement(jsonElement);
          break;
        default:
          throw new IllegalArgumentException(String.format("The value of the `mode` field `%s` does not match any key defined in the discriminator's mapping.", discriminatorValue));
      }
  }
