...
public class OrderTimeline {
  ...
  public OrderTimeline extraData(TimelineExtraData extraData) {
  ...
  public OrderTimeline message(String message) {
  ...
  public boolean equals(Object o) {
    ...
    OrderTimeline orderTimeline = (OrderTimeline) o;
    return Objects.equals(this.links, orderTimeline.links) &&
        Objects.equals(this.extraData, orderTimeline.extraData) &&
        Objects.equals(this.id, orderTimeline.id) &&
        Objects.equals(this.message, orderTimeline.message) &&
        Objects.equals(this.occurredTime, orderTimeline.occurredTime) &&
        Objects.equals(this.triggeredBy, orderTimeline.triggeredBy) &&
        Objects.equals(this.type, orderTimeline.type);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to OrderTimeline
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!OrderTimeline.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in OrderTimeline is not found in the empty JSON string", OrderTimeline.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!OrderTimeline.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `OrderTimeline` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!OrderTimeline.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'OrderTimeline' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<OrderTimeline> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(OrderTimeline.class));

       return (TypeAdapter<T>) new TypeAdapter<OrderTimeline>() {
           @Override
           public void write(JsonWriter out, OrderTimeline value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public OrderTimeline read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of OrderTimeline given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of OrderTimeline
   * @throws IOException if the JSON string is invalid with respect to OrderTimeline
   */
  public static OrderTimeline fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, OrderTimeline.class);
  }

  /**
   * Convert an instance of OrderTimeline to an JSON string
   *
   * @return JSON string
   */
