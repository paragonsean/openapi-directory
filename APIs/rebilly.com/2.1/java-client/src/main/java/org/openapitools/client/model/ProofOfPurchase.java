...
public class ProofOfPurchase {
  ...
  public ProofOfPurchase documentSubtype(KycDocumentSubtypes documentSubtype) {
  ...
  public ProofOfPurchase documentType(KycDocumentTypes documentType) {
  ...
  @Deprecated
  public ProofOfPurchase fileId(String fileId) {
    this.fileId = fileId;
    return this;
  }
  ...
  public ProofOfPurchase fileIds(List<String> fileIds) {
    this.fileIds = fileIds;
    return this;
  }

  public ProofOfPurchase addFileIdsItem(String fileIdsItem) {
  ...
  public ProofOfPurchase rejectionReason(KycDocumentRejection rejectionReason) {
  ...
  public ProofOfPurchase customerId(String customerId) {
  ...
  public ProofOfPurchase matchLevel(Integer matchLevel) {
  ...
  public ProofOfPurchase notes(String notes) {
    this.notes = notes;
    return this;
  }
  ...
  public ProofOfPurchase reason(String reason) {
    this.reason = reason;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    ProofOfPurchase proofOfPurchase = (ProofOfPurchase) o;
    return Objects.equals(this.links, proofOfPurchase.links) &&
        Objects.equals(this.createdTime, proofOfPurchase.createdTime) &&
        Objects.equals(this.documentSubtype, proofOfPurchase.documentSubtype) &&
        Objects.equals(this.documentType, proofOfPurchase.documentType) &&
        Objects.equals(this.fileId, proofOfPurchase.fileId) &&
        Objects.equals(this.fileIds, proofOfPurchase.fileIds) &&
        Objects.equals(this.id, proofOfPurchase.id) &&
        Objects.equals(this.processedTime, proofOfPurchase.processedTime) &&
        Objects.equals(this.rejectionReason, proofOfPurchase.rejectionReason) &&
        Objects.equals(this.requestId, proofOfPurchase.requestId) &&
        Objects.equals(this.status, proofOfPurchase.status) &&
        Objects.equals(this.updatedTime, proofOfPurchase.updatedTime) &&
        Objects.equals(this.customerId, proofOfPurchase.customerId) &&
        Objects.equals(this.matchLevel, proofOfPurchase.matchLevel) &&
        Objects.equals(this.notes, proofOfPurchase.notes) &&
        Objects.equals(this.reason, proofOfPurchase.reason) &&
        Objects.equals(this.reviewTime, proofOfPurchase.reviewTime) &&
        Objects.equals(this.reviewerId, proofOfPurchase.reviewerId) &&
        Objects.equals(this.reviewerName, proofOfPurchase.reviewerName);
  }
  ...
  public String toString() {
    ...
    sb.append("class ProofOfPurchase {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ProofOfPurchase
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ProofOfPurchase.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ProofOfPurchase is not found in the empty JSON string", ProofOfPurchase.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ProofOfPurchase.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ProofOfPurchase` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ProofOfPurchase.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ProofOfPurchase.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ProofOfPurchase' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ProofOfPurchase> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ProofOfPurchase.class));

       return (TypeAdapter<T>) new TypeAdapter<ProofOfPurchase>() {
           @Override
           public void write(JsonWriter out, ProofOfPurchase value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ProofOfPurchase read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ProofOfPurchase given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ProofOfPurchase
   * @throws IOException if the JSON string is invalid with respect to ProofOfPurchase
   */
  public static ProofOfPurchase fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ProofOfPurchase.class);
  }

  /**
   * Convert an instance of ProofOfPurchase to an JSON string
   *
   * @return JSON string
   */
