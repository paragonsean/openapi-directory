...
public class CommonTransactionRequest {
  ...
  public CommonTransactionRequest amount(Double amount) {
    this.amount = amount;
    return this;
  }
  ...
  public CommonTransactionRequest billingAddress(ContactObject billingAddress) {
  ...
  public CommonTransactionRequest currency(String currency) {
  ...
  public CommonTransactionRequest customFields(Object customFields) {
  ...
  public CommonTransactionRequest customerId(String customerId) {
  ...
  public CommonTransactionRequest description(String description) {
  ...
  public CommonTransactionRequest gatewayAccountId(String gatewayAccountId) {
  ...
  public CommonTransactionRequest invoiceIds(List<String> invoiceIds) {
    this.invoiceIds = invoiceIds;
    return this;
  }

  public CommonTransactionRequest addInvoiceIdsItem(String invoiceIdsItem) {
  ...
  public CommonTransactionRequest isMerchantInitiated(Boolean isMerchantInitiated) {
  ...
  public CommonTransactionRequest isProcessedOutside(Boolean isProcessedOutside) {
  ...
  public CommonTransactionRequest notificationUrl(URI notificationUrl) {
  ...
  public CommonTransactionRequest paymentInstruction(PaymentInstruction paymentInstruction) {
  ...
  @Deprecated
  public CommonTransactionRequest paymentInstrument(PaymentInstrument paymentInstrument) {
  ...
  public CommonTransactionRequest processedTime(OffsetDateTime processedTime) {
  ...
  public CommonTransactionRequest redirectUrl(URI redirectUrl) {
  ...
  public CommonTransactionRequest requestId(String requestId) {
  ...
  public CommonTransactionRequest riskMetadata(RiskMetadata riskMetadata) {
  ...
  public CommonTransactionRequest websiteId(String websiteId) {
  ...
  public boolean equals(Object o) {
    ...
    CommonTransactionRequest commonTransactionRequest = (CommonTransactionRequest) o;
    return Objects.equals(this.amount, commonTransactionRequest.amount) &&
        Objects.equals(this.billingAddress, commonTransactionRequest.billingAddress) &&
        Objects.equals(this.currency, commonTransactionRequest.currency) &&
        Objects.equals(this.customFields, commonTransactionRequest.customFields) &&
        Objects.equals(this.customerId, commonTransactionRequest.customerId) &&
        Objects.equals(this.description, commonTransactionRequest.description) &&
        Objects.equals(this.gatewayAccountId, commonTransactionRequest.gatewayAccountId) &&
        Objects.equals(this.invoiceIds, commonTransactionRequest.invoiceIds) &&
        Objects.equals(this.isMerchantInitiated, commonTransactionRequest.isMerchantInitiated) &&
        Objects.equals(this.isProcessedOutside, commonTransactionRequest.isProcessedOutside) &&
        Objects.equals(this.notificationUrl, commonTransactionRequest.notificationUrl) &&
        Objects.equals(this.paymentInstruction, commonTransactionRequest.paymentInstruction) &&
        Objects.equals(this.paymentInstrument, commonTransactionRequest.paymentInstrument) &&
        Objects.equals(this.processedTime, commonTransactionRequest.processedTime) &&
        Objects.equals(this.redirectUrl, commonTransactionRequest.redirectUrl) &&
        Objects.equals(this.requestId, commonTransactionRequest.requestId) &&
        Objects.equals(this.riskMetadata, commonTransactionRequest.riskMetadata) &&
        Objects.equals(this.websiteId, commonTransactionRequest.websiteId);
  }
  ...
  public String toString() {
    ...
    sb.append("class CommonTransactionRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CommonTransactionRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CommonTransactionRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CommonTransactionRequest is not found in the empty JSON string", CommonTransactionRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CommonTransactionRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CommonTransactionRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CommonTransactionRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CommonTransactionRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CommonTransactionRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CommonTransactionRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CommonTransactionRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<CommonTransactionRequest>() {
           @Override
           public void write(JsonWriter out, CommonTransactionRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CommonTransactionRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CommonTransactionRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CommonTransactionRequest
   * @throws IOException if the JSON string is invalid with respect to CommonTransactionRequest
   */
  public static CommonTransactionRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CommonTransactionRequest.class);
  }

  /**
   * Convert an instance of CommonTransactionRequest to an JSON string
   *
   * @return JSON string
   */
