...
public class LeadSourceData {
  ...
  public LeadSourceData affiliate(String affiliate) {
  ...
  public LeadSourceData campaign(String campaign) {
  ...
  public LeadSourceData clickId(String clickId) {
  ...
  public LeadSourceData content(String content) {
  ...
  public LeadSourceData medium(String medium) {
    this.medium = medium;
    return this;
  }
  ...
  public LeadSourceData path(String path) {
    this.path = path;
    return this;
  }
  ...
  public LeadSourceData referrer(String referrer) {
  ...
  public LeadSourceData salesAgent(String salesAgent) {
  ...
  public LeadSourceData source(String source) {
    this.source = source;
    return this;
  }
  ...
  public LeadSourceData subAffiliate(String subAffiliate) {
  ...
  public LeadSourceData term(String term) {
    this.term = term;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    LeadSourceData leadSourceData = (LeadSourceData) o;
    return Objects.equals(this.links, leadSourceData.links) &&
        Objects.equals(this.affiliate, leadSourceData.affiliate) &&
        Objects.equals(this.campaign, leadSourceData.campaign) &&
        Objects.equals(this.clickId, leadSourceData.clickId) &&
        Objects.equals(this.content, leadSourceData.content) &&
        Objects.equals(this.createdTime, leadSourceData.createdTime) &&
        Objects.equals(this.medium, leadSourceData.medium) &&
        Objects.equals(this.path, leadSourceData.path) &&
        Objects.equals(this.referrer, leadSourceData.referrer) &&
        Objects.equals(this.salesAgent, leadSourceData.salesAgent) &&
        Objects.equals(this.source, leadSourceData.source) &&
        Objects.equals(this.subAffiliate, leadSourceData.subAffiliate) &&
        Objects.equals(this.term, leadSourceData.term);
  }

  @Override
  public int hashCode() {
    return Objects.hash(links, affiliate, campaign, clickId, content, createdTime, medium, path, referrer, salesAgent, source, subAffiliate, term);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class LeadSourceData {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to LeadSourceData
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LeadSourceData.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LeadSourceData is not found in the empty JSON string", LeadSourceData.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LeadSourceData.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LeadSourceData` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LeadSourceData.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LeadSourceData' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LeadSourceData> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LeadSourceData.class));

       return (TypeAdapter<T>) new TypeAdapter<LeadSourceData>() {
           @Override
           public void write(JsonWriter out, LeadSourceData value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LeadSourceData read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LeadSourceData given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LeadSourceData
   * @throws IOException if the JSON string is invalid with respect to LeadSourceData
   */
  public static LeadSourceData fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LeadSourceData.class);
  }

  /**
   * Convert an instance of LeadSourceData to an JSON string
   *
   * @return JSON string
   */
