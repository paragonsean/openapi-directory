...
public class InvoiceItem {
  ...
  private List<InvoiceItemEmbeddedInner> embedded = new ArrayList<>();

  public static final String SERIALIZED_NAME_LINKS = "_links";
  @SerializedName(SERIALIZED_NAME_LINKS)
  private List<InvoiceItemLinksInner> links = new ArrayList<>();
  ...
  public InvoiceItem(
     List<InvoiceItemEmbeddedInner> embedded, 
     List<InvoiceItemLinksInner> links, 
  ...
  public List<InvoiceItemEmbeddedInner> getEmbedded() {
    return embedded;
  }
   ...
   */
  @javax.annotation.Nullable
  public List<InvoiceItemLinksInner> getLinks() {
    return links;
  }
  ...
  public InvoiceItem periodEndTime(OffsetDateTime periodEndTime) {
  ...
  public InvoiceItem periodNumber(Integer periodNumber) {
  ...
  public InvoiceItem periodStartTime(OffsetDateTime periodStartTime) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.embedded, invoiceItem.embedded) &&
        Objects.equals(this.links, invoiceItem.links) &&
        Objects.equals(this.createdTime, invoiceItem.createdTime) &&
        Objects.equals(this.description, invoiceItem.description) &&
        Objects.equals(this.discountAmount, invoiceItem.discountAmount) &&
        Objects.equals(this.id, invoiceItem.id) &&
        Objects.equals(this.periodEndTime, invoiceItem.periodEndTime) &&
        Objects.equals(this.periodNumber, invoiceItem.periodNumber) &&
        Objects.equals(this.periodStartTime, invoiceItem.periodStartTime) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(embedded, links, createdTime, description, discountAmount, id, periodEndTime, periodNumber, periodStartTime, price, productId, quantity, type, unitPrice, updatedTime);
  }
      ...
      if (jsonObj.get("_embedded") != null && !jsonObj.get("_embedded").isJsonNull()) {
        ...
        if (jsonArrayembedded != null) {
          ...
          for (int i = 0; i < jsonArrayembedded.size(); i++) {
            InvoiceItemEmbeddedInner.validateJsonElement(jsonArrayembedded.get(i));
          };
        }
      }
      if (jsonObj.get("_links") != null && !jsonObj.get("_links").isJsonNull()) {
        ...
        if (jsonArraylinks != null) {
          ...
          for (int i = 0; i < jsonArraylinks.size(); i++) {
            InvoiceItemLinksInner.validateJsonElement(jsonArraylinks.get(i));
          };
        }
      }
