...
public class SubscriptionCancellationState {
  /**
   * Cancel category.
   */
  ...
  public SubscriptionCancellationState() {
  }
  ...
  public boolean equals(Object o) {
    ...
    SubscriptionCancellationState subscriptionCancellationState = (SubscriptionCancellationState) o;
    return Objects.equals(this.cancelCategory, subscriptionCancellationState.cancelCategory) &&
        Objects.equals(this.cancelDescription, subscriptionCancellationState.cancelDescription) &&
        Objects.equals(this.canceledBy, subscriptionCancellationState.canceledBy) &&
        Objects.equals(this.canceledTime, subscriptionCancellationState.canceledTime);
  }

  @Override
  public int hashCode() {
    return Objects.hash(cancelCategory, cancelDescription, canceledBy, canceledTime);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class SubscriptionCancellationState {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to SubscriptionCancellationState
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SubscriptionCancellationState.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SubscriptionCancellationState is not found in the empty JSON string", SubscriptionCancellationState.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SubscriptionCancellationState.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SubscriptionCancellationState` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SubscriptionCancellationState.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SubscriptionCancellationState' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SubscriptionCancellationState> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SubscriptionCancellationState.class));

       return (TypeAdapter<T>) new TypeAdapter<SubscriptionCancellationState>() {
           @Override
           public void write(JsonWriter out, SubscriptionCancellationState value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SubscriptionCancellationState read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SubscriptionCancellationState given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SubscriptionCancellationState
   * @throws IOException if the JSON string is invalid with respect to SubscriptionCancellationState
   */
  public static SubscriptionCancellationState fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SubscriptionCancellationState.class);
  }

  /**
   * Convert an instance of SubscriptionCancellationState to an JSON string
   *
   * @return JSON string
   */
