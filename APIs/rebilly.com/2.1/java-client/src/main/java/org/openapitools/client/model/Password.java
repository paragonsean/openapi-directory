...
public class Password extends AuthenticationToken {
  ...
  public Password expiredTime(OffsetDateTime expiredTime) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.links, password.links) &&
        Objects.equals(this.expiredTime, password.expiredTime) &&
        Objects.equals(this.customerId, password.customerId) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(links, expiredTime, customerId, password, username, super.hashCode());
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (String requiredField : Password.openapiRequiredFields) {
