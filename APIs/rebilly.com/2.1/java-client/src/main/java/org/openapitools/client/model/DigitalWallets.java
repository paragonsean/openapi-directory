...
import org.openapitools.client.model.DigitalWalletsApplePay;
import org.openapitools.client.model.DigitalWalletsGooglePay;
...
public class DigitalWallets {
  ...
  private DigitalWalletsApplePay applePay;

  public static final String SERIALIZED_NAME_GOOGLE_PAY = "googlePay";
  @SerializedName(SERIALIZED_NAME_GOOGLE_PAY)
  private DigitalWalletsGooglePay googlePay;

  public DigitalWallets() {
  }

  public DigitalWallets applePay(DigitalWalletsApplePay applePay) {
  ...
  public DigitalWalletsApplePay getApplePay() {
    return applePay;
  }

  public void setApplePay(DigitalWalletsApplePay applePay) {
    this.applePay = applePay;
  }


  public DigitalWallets googlePay(DigitalWalletsGooglePay googlePay) {
   ...
   */
  @javax.annotation.Nullable
  public DigitalWalletsGooglePay getGooglePay() {
    return googlePay;
  }

  public void setGooglePay(DigitalWalletsGooglePay googlePay) {
    this.googlePay = googlePay;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.applePay, digitalWallets.applePay) &&
        Objects.equals(this.googlePay, digitalWallets.googlePay);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("applePay") != null && !jsonObj.get("applePay").isJsonNull()) {
        DigitalWalletsApplePay.validateJsonElement(jsonObj.get("applePay"));
      }
      // validate the optional field `googlePay`
      if (jsonObj.get("googlePay") != null && !jsonObj.get("googlePay").isJsonNull()) {
        DigitalWalletsGooglePay.validateJsonElement(jsonObj.get("googlePay"));
      }
  }
