...
public class CommonOneTimeOrder {
  ...
  public CommonOneTimeOrder billingAddress(ContactObject billingAddress) {
  ...
  public CommonOneTimeOrder couponIds(List<String> couponIds) {
    this.couponIds = couponIds;
    return this;
  }

  public CommonOneTimeOrder addCouponIdsItem(String couponIdsItem) {
  ...
  public CommonOneTimeOrder deliveryAddress(ContactObject deliveryAddress) {
  ...
  public CommonOneTimeOrder items(List<CommonSubscriptionItemsInner> items) {
    this.items = items;
    return this;
  }

  public CommonOneTimeOrder addItemsItem(CommonSubscriptionItemsInner itemsItem) {
    if (this.items == null) {
  ...
  public CommonOneTimeOrder orderType(OrderTypeEnum orderType) {
  ...
  public CommonOneTimeOrder poNumber(String poNumber) {
  ...
  public CommonOneTimeOrder websiteId(String websiteId) {
  ...
  public boolean equals(Object o) {
    ...
    CommonOneTimeOrder commonOneTimeOrder = (CommonOneTimeOrder) o;
    return Objects.equals(this.activationTime, commonOneTimeOrder.activationTime) &&
        Objects.equals(this.billingAddress, commonOneTimeOrder.billingAddress) &&
        Objects.equals(this.billingStatus, commonOneTimeOrder.billingStatus) &&
        Objects.equals(this.couponIds, commonOneTimeOrder.couponIds) &&
        Objects.equals(this.deliveryAddress, commonOneTimeOrder.deliveryAddress) &&
        Objects.equals(this.id, commonOneTimeOrder.id) &&
        Objects.equals(this.initialInvoiceId, commonOneTimeOrder.initialInvoiceId) &&
        Objects.equals(this.items, commonOneTimeOrder.items) &&
        Objects.equals(this.orderType, commonOneTimeOrder.orderType) &&
        Objects.equals(this.poNumber, commonOneTimeOrder.poNumber) &&
        Objects.equals(this.recentInvoiceId, commonOneTimeOrder.recentInvoiceId) &&
        Objects.equals(this.voidTime, commonOneTimeOrder.voidTime) &&
        Objects.equals(this.websiteId, commonOneTimeOrder.websiteId) &&
        Objects.equals(this.status, commonOneTimeOrder.status);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(activationTime, billingAddress, billingStatus, couponIds, deliveryAddress, id, initialInvoiceId, items, orderType, poNumber, recentInvoiceId, voidTime, websiteId, status);
  }
  ...
  public String toString() {
    ...
    sb.append("class CommonOneTimeOrder {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CommonOneTimeOrder
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CommonOneTimeOrder.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CommonOneTimeOrder is not found in the empty JSON string", CommonOneTimeOrder.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CommonOneTimeOrder.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CommonOneTimeOrder` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CommonOneTimeOrder.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CommonOneTimeOrder' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CommonOneTimeOrder> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CommonOneTimeOrder.class));

       return (TypeAdapter<T>) new TypeAdapter<CommonOneTimeOrder>() {
           @Override
           public void write(JsonWriter out, CommonOneTimeOrder value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CommonOneTimeOrder read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CommonOneTimeOrder given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CommonOneTimeOrder
   * @throws IOException if the JSON string is invalid with respect to CommonOneTimeOrder
   */
  public static CommonOneTimeOrder fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CommonOneTimeOrder.class);
  }

  /**
   * Convert an instance of CommonOneTimeOrder to an JSON string
   *
   * @return JSON string
   */
