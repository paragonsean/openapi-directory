...
public class PaymentCard {
  ...
  private List<PaymentCardAllOfEmbedded> embedded = new ArrayList<>();

  public static final String SERIALIZED_NAME_LINKS = "_links";
  @SerializedName(SERIALIZED_NAME_LINKS)
  private List<PaymentCardAllOfLinks> links = new ArrayList<>();

  public static final String SERIALIZED_NAME_EXPIRATION_REMINDER_NUMBER = "expirationReminderNumber";
  @SerializedName(SERIALIZED_NAME_EXPIRATION_REMINDER_NUMBER)
  private Integer expirationReminderNumber;

  public static final String SERIALIZED_NAME_EXPIRATION_REMINDER_TIME = "expirationReminderTime";
  @SerializedName(SERIALIZED_NAME_EXPIRATION_REMINDER_TIME)
  private OffsetDateTime expirationReminderTime;

  public static final String SERIALIZED_NAME_STICKY_GATEWAY_ACCOUNT_ID = "stickyGatewayAccountId";
  @SerializedName(SERIALIZED_NAME_STICKY_GATEWAY_ACCOUNT_ID)
  private String stickyGatewayAccountId;
  ...
  public PaymentCard(
     ...
     List<PaymentCardAllOfEmbedded> embedded, 
     List<PaymentCardAllOfLinks> links, 
     Integer expirationReminderNumber, 
     OffsetDateTime expirationReminderTime, 
     String stickyGatewayAccountId
  ) {
    this();
    ...
    this.links = links;
    this.expirationReminderNumber = expirationReminderNumber;
    this.expirationReminderTime = expirationReminderTime;
    this.stickyGatewayAccountId = stickyGatewayAccountId;
  }
  ...
  public PaymentCard billingAddress(ContactObject billingAddress) {
  ...
  public PaymentCard customFields(Object customFields) {
  ...
  public PaymentCard pan(String pan) {
    this.pan = pan;
    return this;
  }
  ...
  public PaymentCard riskMetadata(RiskMetadata riskMetadata) {
  ...
  public PaymentCard status(StatusEnum status) {
    this.status = status;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public List<PaymentCardAllOfEmbedded> getEmbedded() {
    return embedded;
  }
   ...
   */
  @javax.annotation.Nullable
  public List<PaymentCardAllOfLinks> getLinks() {
    return links;
  }
   ...
   * @return expirationReminderNumber
   */
  @javax.annotation.Nullable
  public Integer getExpirationReminderNumber() {
    return expirationReminderNumber;
  }
   ...
   */
  @javax.annotation.Nullable
  public OffsetDateTime getExpirationReminderTime() {
    return expirationReminderTime;
  }
   ...
   * @return stickyGatewayAccountId
   */
  @javax.annotation.Nullable
  public String getStickyGatewayAccountId() {
    return stickyGatewayAccountId;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.bankCountry, paymentCard.bankCountry) &&
        Objects.equals(this.bankName, paymentCard.bankName) &&
        Objects.equals(this.billingAddress, paymentCard.billingAddress) &&
        Objects.equals(this.bin, paymentCard.bin) &&
        Objects.equals(this.brand, paymentCard.brand) &&
        Objects.equals(this.createdTime, paymentCard.createdTime) &&
        Objects.equals(this.customFields, paymentCard.customFields) &&
        ...
        Objects.equals(this.method, paymentCard.method) &&
        Objects.equals(this.pan, paymentCard.pan) &&
        Objects.equals(this.riskMetadata, paymentCard.riskMetadata) &&
        Objects.equals(this.status, paymentCard.status) &&
        Objects.equals(this.updatedTime, paymentCard.updatedTime) &&
        Objects.equals(this.embedded, paymentCard.embedded) &&
        Objects.equals(this.links, paymentCard.links) &&
        Objects.equals(this.expirationReminderNumber, paymentCard.expirationReminderNumber) &&
        Objects.equals(this.expirationReminderTime, paymentCard.expirationReminderTime) &&
        Objects.equals(this.stickyGatewayAccountId, paymentCard.stickyGatewayAccountId);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(bankCountry, bankName, billingAddress, bin, brand, createdTime, customFields, customerId, cvv, expMonth, expYear, fingerprint, id, last4, method, pan, riskMetadata, status, updatedTime, embedded, links, expirationReminderNumber, expirationReminderTime, stickyGatewayAccountId);
  }
  ...
  public String toString() {
    ...
    sb.append("    expirationReminderNumber: ").append(toIndentedString(expirationReminderNumber)).append("\n");
    sb.append("    expirationReminderTime: ").append(toIndentedString(expirationReminderTime)).append("\n");
    sb.append("    stickyGatewayAccountId: ").append(toIndentedString(stickyGatewayAccountId)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("expirationReminderNumber");
    openapiFields.add("expirationReminderTime");
    openapiFields.add("stickyGatewayAccountId");
      ...
      if (jsonObj.get("_embedded") != null && !jsonObj.get("_embedded").isJsonNull()) {
        ...
        if (jsonArrayembedded != null) {
          ...
          for (int i = 0; i < jsonArrayembedded.size(); i++) {
            PaymentCardAllOfEmbedded.validateJsonElement(jsonArrayembedded.get(i));
          };
        }
      }
      if (jsonObj.get("_links") != null && !jsonObj.get("_links").isJsonNull()) {
        ...
        if (jsonArraylinks != null) {
          ...
          for (int i = 0; i < jsonArraylinks.size(); i++) {
            PaymentCardAllOfLinks.validateJsonElement(jsonArraylinks.get(i));
          };
        }
      }
      if ((jsonObj.get("stickyGatewayAccountId") != null && !jsonObj.get("stickyGatewayAccountId").isJsonNull()) && !jsonObj.get("stickyGatewayAccountId").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `stickyGatewayAccountId` to be a primitive type in the JSON string but got `%s`", jsonObj.get("stickyGatewayAccountId").toString()));
      }
  }
