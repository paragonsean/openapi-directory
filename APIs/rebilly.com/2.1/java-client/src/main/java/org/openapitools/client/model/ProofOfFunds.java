...
public class ProofOfFunds {
  ...
  public ProofOfFunds documentSubtype(KycDocumentSubtypes documentSubtype) {
  ...
  public ProofOfFunds documentType(KycDocumentTypes documentType) {
  ...
  @Deprecated
  public ProofOfFunds fileId(String fileId) {
    this.fileId = fileId;
    return this;
  }
  ...
  public ProofOfFunds fileIds(List<String> fileIds) {
    this.fileIds = fileIds;
    return this;
  }

  public ProofOfFunds addFileIdsItem(String fileIdsItem) {
  ...
  public ProofOfFunds rejectionReason(KycDocumentRejection rejectionReason) {
  ...
  public ProofOfFunds customerId(String customerId) {
  ...
  public ProofOfFunds matchLevel(Integer matchLevel) {
  ...
  public ProofOfFunds notes(String notes) {
    this.notes = notes;
    return this;
  }
  ...
  public ProofOfFunds reason(String reason) {
    this.reason = reason;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    ProofOfFunds proofOfFunds = (ProofOfFunds) o;
    return Objects.equals(this.links, proofOfFunds.links) &&
        Objects.equals(this.createdTime, proofOfFunds.createdTime) &&
        Objects.equals(this.documentSubtype, proofOfFunds.documentSubtype) &&
        Objects.equals(this.documentType, proofOfFunds.documentType) &&
        Objects.equals(this.fileId, proofOfFunds.fileId) &&
        Objects.equals(this.fileIds, proofOfFunds.fileIds) &&
        Objects.equals(this.id, proofOfFunds.id) &&
        Objects.equals(this.processedTime, proofOfFunds.processedTime) &&
        Objects.equals(this.rejectionReason, proofOfFunds.rejectionReason) &&
        Objects.equals(this.requestId, proofOfFunds.requestId) &&
        Objects.equals(this.status, proofOfFunds.status) &&
        Objects.equals(this.updatedTime, proofOfFunds.updatedTime) &&
        Objects.equals(this.customerId, proofOfFunds.customerId) &&
        Objects.equals(this.matchLevel, proofOfFunds.matchLevel) &&
        Objects.equals(this.notes, proofOfFunds.notes) &&
        Objects.equals(this.reason, proofOfFunds.reason) &&
        Objects.equals(this.reviewTime, proofOfFunds.reviewTime) &&
        Objects.equals(this.reviewerId, proofOfFunds.reviewerId) &&
        Objects.equals(this.reviewerName, proofOfFunds.reviewerName);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(links, createdTime, documentSubtype, documentType, fileId, fileIds, id, processedTime, rejectionReason, requestId, status, updatedTime, customerId, matchLevel, notes, reason, reviewTime, reviewerId, reviewerName);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ProofOfFunds
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ProofOfFunds.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ProofOfFunds is not found in the empty JSON string", ProofOfFunds.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ProofOfFunds.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ProofOfFunds` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ProofOfFunds.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ProofOfFunds.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ProofOfFunds' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ProofOfFunds> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ProofOfFunds.class));

       return (TypeAdapter<T>) new TypeAdapter<ProofOfFunds>() {
           @Override
           public void write(JsonWriter out, ProofOfFunds value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ProofOfFunds read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ProofOfFunds given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ProofOfFunds
   * @throws IOException if the JSON string is invalid with respect to ProofOfFunds
   */
  public static ProofOfFunds fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ProofOfFunds.class);
  }

  /**
   * Convert an instance of ProofOfFunds to an JSON string
   *
   * @return JSON string
   */
