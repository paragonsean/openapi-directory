...
public class PaymentCardToken {
  ...
  public PaymentCardToken billingAddress(ContactObject billingAddress) {
  ...
  public PaymentCardToken method(MethodEnum method) {
    this.method = method;
    return this;
  }
  ...
  public PaymentCardToken paymentInstrument(Object paymentInstrument) {
  ...
  public PaymentCardToken leadSource(LeadSource leadSource) {
  ...
  public PaymentCardToken riskMetadata(RiskMetadata riskMetadata) {
  ...
  public boolean equals(Object o) {
    ...
    PaymentCardToken paymentCardToken = (PaymentCardToken) o;
    return Objects.equals(this.billingAddress, paymentCardToken.billingAddress) &&
        Objects.equals(this.method, paymentCardToken.method) &&
        Objects.equals(this.paymentInstrument, paymentCardToken.paymentInstrument) &&
        Objects.equals(this.links, paymentCardToken.links) &&
        Objects.equals(this.createdTime, paymentCardToken.createdTime) &&
        Objects.equals(this.expirationTime, paymentCardToken.expirationTime) &&
        Objects.equals(this.id, paymentCardToken.id) &&
        Objects.equals(this.isUsed, paymentCardToken.isUsed) &&
        Objects.equals(this.leadSource, paymentCardToken.leadSource) &&
        Objects.equals(this.riskMetadata, paymentCardToken.riskMetadata) &&
        Objects.equals(this.updatedTime, paymentCardToken.updatedTime) &&
        Objects.equals(this.usageTime, paymentCardToken.usageTime);
  }
  ...
  public String toString() {
    ...
    sb.append("class PaymentCardToken {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PaymentCardToken
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PaymentCardToken.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PaymentCardToken is not found in the empty JSON string", PaymentCardToken.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PaymentCardToken.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PaymentCardToken` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PaymentCardToken.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PaymentCardToken.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PaymentCardToken' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PaymentCardToken> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PaymentCardToken.class));

       return (TypeAdapter<T>) new TypeAdapter<PaymentCardToken>() {
           @Override
           public void write(JsonWriter out, PaymentCardToken value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PaymentCardToken read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PaymentCardToken given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PaymentCardToken
   * @throws IOException if the JSON string is invalid with respect to PaymentCardToken
   */
  public static PaymentCardToken fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PaymentCardToken.class);
  }

  /**
   * Convert an instance of PaymentCardToken to an JSON string
   *
   * @return JSON string
   */
