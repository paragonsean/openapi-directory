...
import org.openapitools.client.model.AttachmentEmbeddedInner;
import org.openapitools.client.model.AttachmentLinksInner;
...
public class Attachment {
  ...
  private List<AttachmentEmbeddedInner> embedded = new ArrayList<>();

  public static final String SERIALIZED_NAME_LINKS = "_links";
  @SerializedName(SERIALIZED_NAME_LINKS)
  private List<AttachmentLinksInner> links = new ArrayList<>();
   ...
   * Linked object type.
   */
  @JsonAdapter(RelatedTypeEnum.Adapter.class)
  public enum RelatedTypeEnum {
    ...
    public static class Adapter extends TypeAdapter<RelatedTypeEnum> {
      @Override
      public void write(final JsonWriter jsonWriter, final RelatedTypeEnum enumeration) throws IOException {
        jsonWriter.value(enumeration.getValue());
      }

      @Override
      public RelatedTypeEnum read(final JsonReader jsonReader) throws IOException {
        String value =  jsonReader.nextString();
        return RelatedTypeEnum.fromValue(value);
      }
    }

    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      String value = jsonElement.getAsString();
      RelatedTypeEnum.fromValue(value);
    }
  }

  public static final String SERIALIZED_NAME_RELATED_TYPE = "relatedType";
  @SerializedName(SERIALIZED_NAME_RELATED_TYPE)
  ...
  public Attachment(
     List<AttachmentEmbeddedInner> embedded, 
     List<AttachmentLinksInner> links, 
  ...
  public List<AttachmentEmbeddedInner> getEmbedded() {
    return embedded;
  }
   ...
   */
  @javax.annotation.Nullable
  public List<AttachmentLinksInner> getLinks() {
    return links;
  }
  ...
  public Attachment relatedId(String relatedId) {
  ...
  public Attachment relatedType(RelatedTypeEnum relatedType) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.embedded, attachment.embedded) &&
        Objects.equals(this.links, attachment.links) &&
        Objects.equals(this.createdTime, attachment.createdTime) &&
        ...
        Objects.equals(this.relatedId, attachment.relatedId) &&
        Objects.equals(this.relatedType, attachment.relatedType) &&
        Objects.equals(this.updatedTime, attachment.updatedTime);
  }

  @Override
  public int hashCode() {
    return Objects.hash(embedded, links, createdTime, description, fileId, id, name, relatedId, relatedType, updatedTime);
  }
  ...
  static {
    ...
    openapiFields.add("relatedType");
    openapiFields.add("updatedTime");

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>();
    openapiRequiredFields.add("fileId");
    openapiRequiredFields.add("relatedId");
    openapiRequiredFields.add("relatedType");
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("_embedded") != null && !jsonObj.get("_embedded").isJsonNull()) {
        ...
        if (jsonArrayembedded != null) {
          ...
          for (int i = 0; i < jsonArrayembedded.size(); i++) {
            AttachmentEmbeddedInner.validateJsonElement(jsonArrayembedded.get(i));
          };
        }
      }
      if (jsonObj.get("_links") != null && !jsonObj.get("_links").isJsonNull()) {
        ...
        if (jsonArraylinks != null) {
          ...
          for (int i = 0; i < jsonArraylinks.size(); i++) {
            AttachmentLinksInner.validateJsonElement(jsonArraylinks.get(i));
          };
        }
      }
      ...
      if (!jsonObj.get("relatedId").isJsonPrimitive()) {
      ...
      if (!jsonObj.get("relatedType").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `relatedType` to be a primitive type in the JSON string but got `%s`", jsonObj.get("relatedType").toString()));
      }
      // validate the required field `relatedType`
      RelatedTypeEnum.validateJsonElement(jsonObj.get("relatedType"));
  }
