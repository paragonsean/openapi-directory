...
public class FlexiblePlan {
  ...
  public FlexiblePlan id(String id) {
    this.id = id;
    return this;
  }
  ...
  public FlexiblePlan currency(String currency) {
  ...
  public FlexiblePlan customFields(Object customFields) {
  ...
  public FlexiblePlan name(String name) {
    this.name = name;
    return this;
  }
  ...
  public FlexiblePlan pricing(PlanPriceFormula pricing) {
  ...
  public FlexiblePlan productId(String productId) {
  ...
  public FlexiblePlan productOptions(Map<String, String> productOptions) {
    this.productOptions = productOptions;
    return this;
  }

  public FlexiblePlan putProductOptionsItem(String key, String productOptionsItem) {
  ...
  public FlexiblePlan recurringInterval(CommonPlanRecurringInterval recurringInterval) {
  ...
  public FlexiblePlan setup(CommonPlanSetup setup) {
    this.setup = setup;
    return this;
  }
  ...
  public FlexiblePlan trial(CommonPlanTrial trial) {
    this.trial = trial;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    FlexiblePlan flexiblePlan = (FlexiblePlan) o;
    return Objects.equals(this.id, flexiblePlan.id) &&
        Objects.equals(this.createdTime, flexiblePlan.createdTime) &&
        Objects.equals(this.currency, flexiblePlan.currency) &&
        Objects.equals(this.currencySign, flexiblePlan.currencySign) &&
        Objects.equals(this.customFields, flexiblePlan.customFields) &&
        Objects.equals(this.isTrialOnly, flexiblePlan.isTrialOnly) &&
        Objects.equals(this.name, flexiblePlan.name) &&
        Objects.equals(this.pricing, flexiblePlan.pricing) &&
        Objects.equals(this.productId, flexiblePlan.productId) &&
        Objects.equals(this.productOptions, flexiblePlan.productOptions) &&
        Objects.equals(this.recurringInterval, flexiblePlan.recurringInterval) &&
        Objects.equals(this.revision, flexiblePlan.revision) &&
        Objects.equals(this.setup, flexiblePlan.setup) &&
        Objects.equals(this.trial, flexiblePlan.trial) &&
        Objects.equals(this.updatedTime, flexiblePlan.updatedTime);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, createdTime, currency, currencySign, customFields, isTrialOnly, name, pricing, productId, productOptions, recurringInterval, revision, setup, trial, updatedTime);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class FlexiblePlan {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to FlexiblePlan
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!FlexiblePlan.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FlexiblePlan is not found in the empty JSON string", FlexiblePlan.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!FlexiblePlan.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `FlexiblePlan` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : FlexiblePlan.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FlexiblePlan.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FlexiblePlan' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FlexiblePlan> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FlexiblePlan.class));

       return (TypeAdapter<T>) new TypeAdapter<FlexiblePlan>() {
           @Override
           public void write(JsonWriter out, FlexiblePlan value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public FlexiblePlan read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of FlexiblePlan given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of FlexiblePlan
   * @throws IOException if the JSON string is invalid with respect to FlexiblePlan
   */
  public static FlexiblePlan fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FlexiblePlan.class);
  }

  /**
   * Convert an instance of FlexiblePlan to an JSON string
   *
   * @return JSON string
   */
