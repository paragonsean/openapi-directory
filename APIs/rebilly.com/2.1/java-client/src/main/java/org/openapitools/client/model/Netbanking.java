...
public class Netbanking extends GatewayAccount {
  public static final String SERIALIZED_NAME_CREDENTIALS = "credentials";
  @SerializedName(SERIALIZED_NAME_CREDENTIALS)
  private NetbankingAllOfCredentials credentials;
  ...
  public Netbanking credentials(NetbankingAllOfCredentials credentials) {
  ...
  public NetbankingAllOfCredentials getCredentials() {
    return credentials;
  }

  public void setCredentials(NetbankingAllOfCredentials credentials) {
    this.credentials = credentials;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.credentials, netbanking.credentials) &&
        super.equals(o);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Netbanking.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Netbanking is not found in the empty JSON string", Netbanking.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Netbanking.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Netbanking` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
