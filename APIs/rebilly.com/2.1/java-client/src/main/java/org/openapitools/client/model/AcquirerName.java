 ...
 * The acquirer name.
 */
@JsonAdapter(AcquirerName.Adapter.class)
public enum AcquirerName {
  ...
  public static AcquirerName fromValue(String value) {
    for (AcquirerName b : AcquirerName.values()) {
  ...
  public static class Adapter extends TypeAdapter<AcquirerName> {
    @Override
    public void write(final JsonWriter jsonWriter, final AcquirerName enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public AcquirerName read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return AcquirerName.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    AcquirerName.fromValue(value);
  }
}
