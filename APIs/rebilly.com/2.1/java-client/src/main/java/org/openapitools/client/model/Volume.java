...
import org.openapitools.client.model.StairstepAllOfBrackets;
...
public class Volume extends PlanPriceFormula {
  public static final String SERIALIZED_NAME_BRACKETS = "brackets";
  @SerializedName(SERIALIZED_NAME_BRACKETS)
  private List<StairstepAllOfBrackets> brackets = new ArrayList<>();

  public Volume() {
    this.formula = this.getClass().getSimpleName();
  }

  public Volume brackets(List<StairstepAllOfBrackets> brackets) {
    this.brackets = brackets;
    return this;
  }

  public Volume addBracketsItem(StairstepAllOfBrackets bracketsItem) {
  ...
  /**
   * The price brackets, along with the price formula, is used to calculate the amount to charge for the product on this plan on the invoice.  The \&quot;volume\&quot; example:  Price per apple | Max quantity | Description ----------------|--------------|------------ $5              | 1            | 1 $4              | 5            | 2 to 5 $3              | null         | 6 or more  If someone bought 1 apple, it would be $5.  If someone bought 2 apples, it would be $8. For 2 to 5 apples, the price is $4 per apple. 
   * @return brackets
   */
  @javax.annotation.Nonnull
  public List<StairstepAllOfBrackets> getBrackets() {
    return brackets;
  }

  public void setBrackets(List<StairstepAllOfBrackets> brackets) {
    this.brackets = brackets;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.brackets, volume.brackets) &&
        super.equals(o);
  }

  @Override
  public int hashCode() {
    return Objects.hash(brackets, super.hashCode());
  }
  ...
  static {
    ...
    openapiRequiredFields.add("brackets");
