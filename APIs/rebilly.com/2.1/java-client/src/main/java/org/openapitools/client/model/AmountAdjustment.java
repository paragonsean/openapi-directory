...
public class AmountAdjustment {
  ...
  public AmountAdjustment method(MethodEnum method) {
    this.method = method;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.method, amountAdjustment.method);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to AmountAdjustment
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AmountAdjustment.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
