...
public class Credential {
  ...
  public Credential customerId(String customerId) {
  ...
  public Credential expiredTime(OffsetDateTime expiredTime) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.links, credential.links) &&
        Objects.equals(this.customerId, credential.customerId) &&
        Objects.equals(this.expiredTime, credential.expiredTime) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(links, customerId, expiredTime, id, password, username);
  }
