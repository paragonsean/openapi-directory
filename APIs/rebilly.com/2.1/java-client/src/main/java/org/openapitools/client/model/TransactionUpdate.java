...
public class TransactionUpdate {
  ...
  public TransactionUpdate currency(String currency) {
  ...
  public TransactionUpdate result(ResultEnum result) {
    this.result = result;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.amount, transactionUpdate.amount) &&
        Objects.equals(this.currency, transactionUpdate.currency) &&
        Objects.equals(this.result, transactionUpdate.result);
  }

  @Override
  public int hashCode() {
    return Objects.hash(amount, currency, result);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (String requiredField : TransactionUpdate.openapiRequiredFields) {
