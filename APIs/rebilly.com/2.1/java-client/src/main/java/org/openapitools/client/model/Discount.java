...
import org.openapitools.client.model.AmountAdjustment;
...
public class Discount extends AmountAdjustment {
  /**
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      switch (discriminatorValue) {
        case "discount":
          Discount.validateJsonElement(jsonElement);
          break;
        case "partial":
          Partial.validateJsonElement(jsonElement);
          break;
        default:
