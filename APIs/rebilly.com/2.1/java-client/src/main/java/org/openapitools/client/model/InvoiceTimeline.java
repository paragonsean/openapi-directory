...
public class InvoiceTimeline {
  ...
  public InvoiceTimeline extraData(TimelineExtraData extraData) {
  ...
  public InvoiceTimeline message(String message) {
  ...
  public boolean equals(Object o) {
    ...
    InvoiceTimeline invoiceTimeline = (InvoiceTimeline) o;
    return Objects.equals(this.links, invoiceTimeline.links) &&
        Objects.equals(this.extraData, invoiceTimeline.extraData) &&
        Objects.equals(this.id, invoiceTimeline.id) &&
        Objects.equals(this.message, invoiceTimeline.message) &&
        Objects.equals(this.occurredTime, invoiceTimeline.occurredTime) &&
        Objects.equals(this.triggeredBy, invoiceTimeline.triggeredBy) &&
        Objects.equals(this.type, invoiceTimeline.type);
  }
  ...
  public String toString() {
    ...
    sb.append("class InvoiceTimeline {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to InvoiceTimeline
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!InvoiceTimeline.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in InvoiceTimeline is not found in the empty JSON string", InvoiceTimeline.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!InvoiceTimeline.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `InvoiceTimeline` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!InvoiceTimeline.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'InvoiceTimeline' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<InvoiceTimeline> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(InvoiceTimeline.class));

       return (TypeAdapter<T>) new TypeAdapter<InvoiceTimeline>() {
           @Override
           public void write(JsonWriter out, InvoiceTimeline value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public InvoiceTimeline read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of InvoiceTimeline given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of InvoiceTimeline
   * @throws IOException if the JSON string is invalid with respect to InvoiceTimeline
   */
  public static InvoiceTimeline fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, InvoiceTimeline.class);
  }

  /**
   * Convert an instance of InvoiceTimeline to an JSON string
   *
   * @return JSON string
   */
