...
public class IBANType {
  ...
  public IBANType accountNumber(String accountNumber) {
  ...
  public IBANType accountNumberType(AccountNumberTypeEnum accountNumberType) {
  ...
  public IBANType bankName(String bankName) {
  ...
  public IBANType bic(String bic) {
    this.bic = bic;
    return this;
  }
  ...
  public IBANType billingAddress(ContactObject billingAddress) {
  ...
  public IBANType customFields(Object customFields) {
  ...
  public IBANType customerId(String customerId) {
  ...
  public IBANType method(MethodEnum method) {
    this.method = method;
    return this;
  }
  ...
  public IBANType riskMetadata(RiskMetadata riskMetadata) {
  ...
  public boolean equals(Object o) {
    ...
    IBANType ibANType = (IBANType) o;
    return Objects.equals(this.accountNumber, ibANType.accountNumber) &&
        Objects.equals(this.accountNumberType, ibANType.accountNumberType) &&
        Objects.equals(this.bankName, ibANType.bankName) &&
        Objects.equals(this.bic, ibANType.bic) &&
        Objects.equals(this.billingAddress, ibANType.billingAddress) &&
        Objects.equals(this.customFields, ibANType.customFields) &&
        Objects.equals(this.customerId, ibANType.customerId) &&
        Objects.equals(this.method, ibANType.method) &&
        Objects.equals(this.riskMetadata, ibANType.riskMetadata);
  }

  @Override
  public int hashCode() {
    return Objects.hash(accountNumber, accountNumberType, bankName, bic, billingAddress, customFields, customerId, method, riskMetadata);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class IBANType {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to IBANType
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!IBANType.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in IBANType is not found in the empty JSON string", IBANType.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!IBANType.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `IBANType` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : IBANType.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!IBANType.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'IBANType' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<IBANType> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(IBANType.class));

       return (TypeAdapter<T>) new TypeAdapter<IBANType>() {
           @Override
           public void write(JsonWriter out, IBANType value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public IBANType read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of IBANType given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of IBANType
   * @throws IOException if the JSON string is invalid with respect to IBANType
   */
  public static IBANType fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, IBANType.class);
  }

  /**
   * Convert an instance of IBANType to an JSON string
   *
   * @return JSON string
   */
