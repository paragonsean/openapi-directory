...
public class BankAccountAllOfLinks extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(BankAccountAllOfLinks.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!BankAccountAllOfLinks.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'BankAccountAllOfLinks' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<BankAccountAllOfLinks>() {
                @Override
                public void write(JsonWriter out, BankAccountAllOfLinks value) throws IOException {
                ...
                @Override
                public BankAccountAllOfLinks read(JsonReader in) throws IOException {
                    ...
                    try {
                        ...
                        BankAccountAllOfLinks ret = new BankAccountAllOfLinks();
                    ...
                    throw new IOException(String.format("Failed deserialization for BankAccountAllOfLinks: no class matches result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public BankAccountAllOfLinks() {
        super("anyOf", Boolean.FALSE);
    }

    public BankAccountAllOfLinks(Object o) {
        super("anyOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, Class<?>> getSchemas() {
        return BankAccountAllOfLinks.schemas;
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to BankAccountAllOfLinks
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        throw new IOException(String.format("The JSON string is invalid for BankAccountAllOfLinks with anyOf schemas: CustomerLink, SelfLink. no class match the result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
    }

    /**
     * Create an instance of BankAccountAllOfLinks given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of BankAccountAllOfLinks
     * @throws IOException if the JSON string is invalid with respect to BankAccountAllOfLinks
     */
    public static BankAccountAllOfLinks fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, BankAccountAllOfLinks.class);
    }

    /**
     * Convert an instance of BankAccountAllOfLinks to an JSON string
     *
     * @return JSON string
     */
