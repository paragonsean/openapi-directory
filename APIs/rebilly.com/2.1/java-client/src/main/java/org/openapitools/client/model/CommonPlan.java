...
public class CommonPlan {
  ...
  public CommonPlan currency(String currency) {
  ...
  public CommonPlan customFields(Object customFields) {
  ...
  public CommonPlan name(String name) {
    this.name = name;
    return this;
  }
  ...
  public CommonPlan pricing(PlanPriceFormula pricing) {
  ...
  public CommonPlan productId(String productId) {
  ...
  public CommonPlan productOptions(Map<String, String> productOptions) {
    this.productOptions = productOptions;
    return this;
  }

  public CommonPlan putProductOptionsItem(String key, String productOptionsItem) {
  ...
  public CommonPlan recurringInterval(CommonPlanRecurringInterval recurringInterval) {
  ...
  public CommonPlan setup(CommonPlanSetup setup) {
    this.setup = setup;
    return this;
  }
  ...
  public CommonPlan trial(CommonPlanTrial trial) {
    this.trial = trial;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    CommonPlan commonPlan = (CommonPlan) o;
    return Objects.equals(this.createdTime, commonPlan.createdTime) &&
        Objects.equals(this.currency, commonPlan.currency) &&
        Objects.equals(this.currencySign, commonPlan.currencySign) &&
        Objects.equals(this.customFields, commonPlan.customFields) &&
        Objects.equals(this.id, commonPlan.id) &&
        Objects.equals(this.isTrialOnly, commonPlan.isTrialOnly) &&
        Objects.equals(this.name, commonPlan.name) &&
        Objects.equals(this.pricing, commonPlan.pricing) &&
        Objects.equals(this.productId, commonPlan.productId) &&
        Objects.equals(this.productOptions, commonPlan.productOptions) &&
        Objects.equals(this.recurringInterval, commonPlan.recurringInterval) &&
        Objects.equals(this.revision, commonPlan.revision) &&
        Objects.equals(this.setup, commonPlan.setup) &&
        Objects.equals(this.trial, commonPlan.trial) &&
        Objects.equals(this.updatedTime, commonPlan.updatedTime);
  }

  @Override
  public int hashCode() {
    return Objects.hash(createdTime, currency, currencySign, customFields, id, isTrialOnly, name, pricing, productId, productOptions, recurringInterval, revision, setup, trial, updatedTime);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CommonPlan {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CommonPlan
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CommonPlan.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CommonPlan is not found in the empty JSON string", CommonPlan.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CommonPlan.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CommonPlan` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CommonPlan.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CommonPlan.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CommonPlan' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CommonPlan> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CommonPlan.class));

       return (TypeAdapter<T>) new TypeAdapter<CommonPlan>() {
           @Override
           public void write(JsonWriter out, CommonPlan value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CommonPlan read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CommonPlan given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CommonPlan
   * @throws IOException if the JSON string is invalid with respect to CommonPlan
   */
  public static CommonPlan fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CommonPlan.class);
  }

  /**
   * Convert an instance of CommonPlan to an JSON string
   *
   * @return JSON string
   */
