...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      apiInstance.deletePlan(id, organizationId);
...
|-------------|-------------|------------------|
| **204** | Plan was deleted. |  * Rate-Limit-Limit -  <br>  * Rate-Limit-Remaining -  <br>  * Rate-Limit-Reset -  <br>  |
...
<a id="getPlan"></a>
# **getPlan**
> Plan getPlan(id, organizationId)
...
public class Example {
  public static void main(String[] args) {
    ...
    String organizationId = "organizationId_example"; // String | Organization identifier in scope of which need to perform request (if not specified, the default organization will be used).
    try {
      Plan result = apiInstance.getPlan(id, organizationId);
...
| Status code | Description | Response headers |
|-------------|-------------|------------------|
| **200** | Plan was retrieved successfully. |  * Rate-Limit-Limit -  <br>  * Rate-Limit-Remaining -  <br>  * Rate-Limit-Reset -  <br>  |
| **401** | Unauthorized access, invalid credentials was used. |  -  |
| **403** | Access forbidden. |  -  |
| **404** | Resource was not found. |  -  |

<a id="getPlanCollection"></a>
# **getPlanCollection**
> List&lt;Plan&gt; getPlanCollection(organizationId, filter, sort, limit, offset, q)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      List<Plan> result = apiInstance.getPlanCollection(organizationId, filter, sort, limit, offset, q);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling PlansApi#getPlanCollection");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
| Status code | Description | Response headers |
|-------------|-------------|------------------|
| **200** | A list of Plans was retrieved successfully. |  * Pagination-Limit -  <br>  * Pagination-Offset -  <br>  * Pagination-Total -  <br>  * Rate-Limit-Limit -  <br>  * Rate-Limit-Remaining -  <br>  * Rate-Limit-Reset -  <br>  |
| **401** | Unauthorized access, invalid credentials was used. |  -  |
| **403** | Access forbidden. |  -  |

<a id="postPlan"></a>
# **postPlan**
> Plan postPlan(plan, organizationId)
...
public class Example {
  public static void main(String[] args) {
    ...
    PlansApi apiInstance = new PlansApi(defaultClient);
    Plan plan = new Plan(); // Plan | Plan resource.
    String organizationId = "organizationId_example"; // String | Organization identifier in scope of which need to perform request (if not specified, the default organization will be used).
    try {
      Plan result = apiInstance.postPlan(plan, organizationId);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling PlansApi#postPlan");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="putPlan"></a>
# **putPlan**
> Plan putPlan(id, plan, organizationId)
...
public class Example {
  public static void main(String[] args) {
    ...
    String organizationId = "organizationId_example"; // String | Organization identifier in scope of which need to perform request (if not specified, the default organization will be used).
    try {
      Plan result = apiInstance.putPlan(id, plan, organizationId);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling PlansApi#putPlan");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
| Status code | Description | Response headers |
|-------------|-------------|------------------|
| **200** | Plan was updated. |  * Rate-Limit-Limit -  <br>  * Rate-Limit-Remaining -  <br>  * Rate-Limit-Reset -  <br>  |
| **201** | Plan was created. |  * Rate-Limit-Limit -  <br>  * Rate-Limit-Remaining -  <br>  * Rate-Limit-Reset -  <br>  |
| **401** | Unauthorized access, invalid credentials was used. |  -  |
| **403** | Access forbidden. |  -  |
| **404** | Resource was not found. |  -  |
| **422** | Invalid data was sent. |  -  |
