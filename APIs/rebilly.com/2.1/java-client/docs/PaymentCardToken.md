...
|------------ | ------------- | ------------- | -------------|
|**billingAddress** | [**ContactObject**](ContactObject.md) | The billing address object. |  [optional] |
|**method** | [**MethodEnum**](#MethodEnum) | The token payment method. |  |
|**paymentInstrument** | [**Object**](Object.md) | The payment card instrument details. |  |
