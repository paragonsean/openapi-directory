...
<a id="getDispute"></a>
# **getDispute**
> Dispute getDispute(id, organizationId)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      Dispute result = apiInstance.getDispute(id, organizationId);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling DisputesApi#getDispute");
...
|-------------|-------------|------------------|
| **200** | Dispute was retrieved successfully. |  * Rate-Limit-Limit -  <br>  * Rate-Limit-Remaining -  <br>  * Rate-Limit-Reset -  <br>  |
| **401** | Unauthorized access, invalid credentials was used. |  -  |
| **403** | Access forbidden. |  -  |
| **404** | Resource was not found. |  -  |

<a id="getDisputeCollection"></a>
# **getDisputeCollection**
> List&lt;Dispute&gt; getDisputeCollection(organizationId, filter, sort, limit, offset, q, expand)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      List<Dispute> result = apiInstance.getDisputeCollection(organizationId, filter, sort, limit, offset, q, expand);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling DisputesApi#getDisputeCollection");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
| Status code | Description | Response headers |
|-------------|-------------|------------------|
| **200** | A list of disputes was retrieved successfully. |  * Pagination-Limit -  <br>  * Pagination-Offset -  <br>  * Pagination-Total -  <br>  * Rate-Limit-Limit -  <br>  * Rate-Limit-Remaining -  <br>  * Rate-Limit-Reset -  <br>  |
| **401** | Unauthorized access, invalid credentials was used. |  -  |
| **403** | Access forbidden. |  -  |

<a id="postDispute"></a>
# **postDispute**
> Dispute postDispute(dispute, organizationId)
...
public class Example {
  public static void main(String[] args) {
    ...
    DisputesApi apiInstance = new DisputesApi(defaultClient);
    Dispute dispute = new Dispute(); // Dispute | Dispute resource.
    String organizationId = "organizationId_example"; // String | Organization identifier in scope of which need to perform request (if not specified, the default organization will be used).
    try {
      Dispute result = apiInstance.postDispute(dispute, organizationId);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling DisputesApi#postDispute");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
| Status code | Description | Response headers |
|-------------|-------------|------------------|
| **201** | Dispute was created. |  * Rate-Limit-Limit -  <br>  * Rate-Limit-Remaining -  <br>  * Rate-Limit-Reset -  <br>  |
| **401** | Unauthorized access, invalid credentials was used. |  -  |
| **403** | Access forbidden. |  -  |
...
<a id="putDispute"></a>
# **putDispute**
> Dispute putDispute(id, dispute, organizationId)
...
public class Example {
  public static void main(String[] args) {
    ...
    String organizationId = "organizationId_example"; // String | Organization identifier in scope of which need to perform request (if not specified, the default organization will be used).
    try {
      Dispute result = apiInstance.putDispute(id, dispute, organizationId);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling DisputesApi#putDispute");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
| Status code | Description | Response headers |
|-------------|-------------|------------------|
| **200** | Dispute was updated. |  * Rate-Limit-Limit -  <br>  * Rate-Limit-Remaining -  <br>  * Rate-Limit-Reset -  <br>  |
| **201** | Dispute was created. |  * Rate-Limit-Limit -  <br>  * Rate-Limit-Remaining -  <br>  * Rate-Limit-Reset -  <br>  |
| **401** | Unauthorized access, invalid credentials was used. |  -  |
| **403** | Access forbidden. |  -  |
| **422** | Invalid data was sent. |  -  |
