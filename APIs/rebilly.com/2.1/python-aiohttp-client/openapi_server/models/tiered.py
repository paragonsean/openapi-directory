...
class Tiered(Model):
    ...
    def __init__(self, formula: str=None, brackets: List[StairstepAllOfBrackets]=None):
        """Tiered - a model defined in OpenAPI

        :param formula: The formula of this Tiered.
        :param brackets: The brackets of this Tiered.
        """
        self.openapi_types = {
            'formula': str,
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'Tiered':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The tiered of this Tiered.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def formula(self):
        """Gets the formula of this Tiered.
        ...
        :return: The formula of this Tiered.
        :rtype: str
        """
    ...
    def formula(self, formula):
        """Sets the formula of this Tiered.
    ...
    @property
    def brackets(self):
        """Gets the brackets of this Tiered.

        The price brackets, along with the price formula, is used to calculate the amount to charge for the product on this plan on the invoice.  The \"tiered\" example:  Price per apple | Max quantity | Description ----------------|--------------|------------ $5              | 1            | 1 $4              | 5            | 2 to 5 $3              | null         | 6 or more  If someone bought 1 apple, it would be $5.  If someone bought 2 apples, it would be $9. $5 per apple for the first apple, then $4 per apple for the 2nd to 5th apple. 

        :return: The brackets of this Tiered.
    ...
    def brackets(self, brackets):
        """Sets the brackets of this Tiered.
