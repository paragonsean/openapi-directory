...
class CommonTransactionRequest(Model):
    ...
    def __init__(self, amount: float=None, billing_address: ContactObject=None, currency: str=None, custom_fields: object=None, customer_id: str=None, description: str=None, gateway_account_id: str=None, invoice_ids: List[str]=None, is_merchant_initiated: bool=False, is_processed_outside: bool=False, notification_url: str=None, payment_instruction: PaymentInstruction=None, payment_instrument: PaymentInstrument=None, processed_time: datetime=None, redirect_url: str=None, request_id: str=None, risk_metadata: RiskMetadata=None, website_id: str=None):
        """CommonTransactionRequest - a model defined in OpenAPI

        :param amount: The amount of this CommonTransactionRequest.
        :param billing_address: The billing_address of this CommonTransactionRequest.
        :param currency: The currency of this CommonTransactionRequest.
        :param custom_fields: The custom_fields of this CommonTransactionRequest.
        :param customer_id: The customer_id of this CommonTransactionRequest.
        :param description: The description of this CommonTransactionRequest.
        :param gateway_account_id: The gateway_account_id of this CommonTransactionRequest.
        :param invoice_ids: The invoice_ids of this CommonTransactionRequest.
        :param is_merchant_initiated: The is_merchant_initiated of this CommonTransactionRequest.
        :param is_processed_outside: The is_processed_outside of this CommonTransactionRequest.
        :param notification_url: The notification_url of this CommonTransactionRequest.
        :param payment_instruction: The payment_instruction of this CommonTransactionRequest.
        :param payment_instrument: The payment_instrument of this CommonTransactionRequest.
        :param processed_time: The processed_time of this CommonTransactionRequest.
        :param redirect_url: The redirect_url of this CommonTransactionRequest.
        :param request_id: The request_id of this CommonTransactionRequest.
        :param risk_metadata: The risk_metadata of this CommonTransactionRequest.
        :param website_id: The website_id of this CommonTransactionRequest.
        """
        self.openapi_types = {
            'amount': float,
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'CommonTransactionRequest':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The CommonTransactionRequest of this CommonTransactionRequest.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def amount(self):
        """Gets the amount of this CommonTransactionRequest.

        The transaction amount.

        :return: The amount of this CommonTransactionRequest.
        :rtype: float
        """
        return self._amount
    ...
    def amount(self, amount):
        """Sets the amount of this CommonTransactionRequest.
    ...
    def billing_address(self):
        """Gets the billing_address of this CommonTransactionRequest.

        Billing address. If not supplied, we use the billing address associated with the payment instrument, and then customer.

        :return: The billing_address of this CommonTransactionRequest.
        :rtype: ContactObject
        """
    ...
    def billing_address(self, billing_address):
        """Sets the billing_address of this CommonTransactionRequest.
    ...
    @property
    def currency(self):
        """Gets the currency of this CommonTransactionRequest.

        ISO 4217 alphabetic currency code.

        :return: The currency of this CommonTransactionRequest.
        :rtype: str
        """
    ...
    def currency(self, currency):
        """Sets the currency of this CommonTransactionRequest.
    ...
    def custom_fields(self):
        """Gets the custom_fields of this CommonTransactionRequest.

        Custom Fields list as a map `{\"custom field name\": \"custom field value\", ...}`. The format must follow the saved format (see Custom Fields section for the formats). 

        :return: The custom_fields of this CommonTransactionRequest.
        :rtype: object
        """
    ...
    def custom_fields(self, custom_fields):
        """Sets the custom_fields of this CommonTransactionRequest.
    ...
    def customer_id(self):
        """Gets the customer_id of this CommonTransactionRequest.

        The customer identifier string.

        :return: The customer_id of this CommonTransactionRequest.
        :rtype: str
        """
    ...
    def customer_id(self, customer_id):
        """Sets the customer_id of this CommonTransactionRequest.
    ...
    def description(self):
        """Gets the description of this CommonTransactionRequest.

        The payment description.

        :return: The description of this CommonTransactionRequest.
        :rtype: str
        """
    ...
    def description(self, description):
        """Sets the description of this CommonTransactionRequest.
    ...
    def gateway_account_id(self):
        """Gets the gateway_account_id of this CommonTransactionRequest.
        ...
        :return: The gateway_account_id of this CommonTransactionRequest.
        :rtype: str
        """
    ...
    def gateway_account_id(self, gateway_account_id):
        """Sets the gateway_account_id of this CommonTransactionRequest.
    ...
    def invoice_ids(self):
        """Gets the invoice_ids of this CommonTransactionRequest.

        The array of invoice identifiers.

        :return: The invoice_ids of this CommonTransactionRequest.
        :rtype: List[str]
        """
    ...
    def invoice_ids(self, invoice_ids):
        """Sets the invoice_ids of this CommonTransactionRequest.
    ...
    def is_merchant_initiated(self):
        """Gets the is_merchant_initiated of this CommonTransactionRequest.

        True if the transaction was initiated by the merchant.

        :return: The is_merchant_initiated of this CommonTransactionRequest.
        :rtype: bool
        """
    ...
    def is_merchant_initiated(self, is_merchant_initiated):
        """Sets the is_merchant_initiated of this CommonTransactionRequest.
    ...
    def is_processed_outside(self):
        """Gets the is_processed_outside of this CommonTransactionRequest.

        True if transaction was processed outside Rebilly.

        :return: The is_processed_outside of this CommonTransactionRequest.
        :rtype: bool
        """
    ...
    def is_processed_outside(self, is_processed_outside):
        """Sets the is_processed_outside of this CommonTransactionRequest.
    ...
    def notification_url(self):
        """Gets the notification_url of this CommonTransactionRequest.
        ...
        :return: The notification_url of this CommonTransactionRequest.
        :rtype: str
        """
    ...
    def notification_url(self, notification_url):
        """Sets the notification_url of this CommonTransactionRequest.
    ...
    def payment_instruction(self):
        """Gets the payment_instruction of this CommonTransactionRequest.

        Payment instruction. If not supplied, customer's default payment instrument will be used.

        :return: The payment_instruction of this CommonTransactionRequest.
    ...
    def payment_instruction(self, payment_instruction):
        """Sets the payment_instruction of this CommonTransactionRequest.
    ...
    def payment_instrument(self):
        """Gets the payment_instrument of this CommonTransactionRequest.


        :return: The payment_instrument of this CommonTransactionRequest.
    ...
    def payment_instrument(self, payment_instrument):
        """Sets the payment_instrument of this CommonTransactionRequest.
    ...
    def processed_time(self):
        """Gets the processed_time of this CommonTransactionRequest.

        The time the transaction was processed. Can be specified only if transaction was processed outside Rebilly.

        :return: The processed_time of this CommonTransactionRequest.
        :rtype: datetime
        """
    ...
    def processed_time(self, processed_time):
        """Sets the processed_time of this CommonTransactionRequest.
    ...
    def redirect_url(self):
        """Gets the redirect_url of this CommonTransactionRequest.
        ...
        :return: The redirect_url of this CommonTransactionRequest.
        :rtype: str
        """
    ...
    def redirect_url(self, redirect_url):
        """Sets the redirect_url of this CommonTransactionRequest.
    ...
    @property
    def request_id(self):
        """Gets the request_id of this CommonTransactionRequest.
        ...
        :return: The request_id of this CommonTransactionRequest.
        :rtype: str
        """
    ...
    def request_id(self, request_id):
        """Sets the request_id of this CommonTransactionRequest.
    ...
    def risk_metadata(self):
        """Gets the risk_metadata of this CommonTransactionRequest.


        :return: The risk_metadata of this CommonTransactionRequest.
        :rtype: RiskMetadata
        """
    ...
    def risk_metadata(self, risk_metadata):
        """Sets the risk_metadata of this CommonTransactionRequest.
    ...
    @property
    def website_id(self):
        """Gets the website_id of this CommonTransactionRequest.

        The website identifier string.

        :return: The website_id of this CommonTransactionRequest.
        :rtype: str
        """
    ...
    def website_id(self, website_id):
        """Sets the website_id of this CommonTransactionRequest.
