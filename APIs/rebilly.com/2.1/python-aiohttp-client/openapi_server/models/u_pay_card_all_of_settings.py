...
class UPayCardAllOfSettings(Model):
    ...
    def __init__(self, tolerance_percentage: int=None):
        """UPayCardAllOfSettings - a model defined in OpenAPI

        :param tolerance_percentage: The tolerance_percentage of this UPayCardAllOfSettings.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'UPayCardAllOfSettings':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The UPayCard_allOf_settings of this UPayCardAllOfSettings.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def tolerance_percentage(self):
        """Gets the tolerance_percentage of this UPayCardAllOfSettings.

        Tolerance percentage for settled amount.

        :return: The tolerance_percentage of this UPayCardAllOfSettings.
        :rtype: int
        """
    ...
    def tolerance_percentage(self, tolerance_percentage):
        """Sets the tolerance_percentage of this UPayCardAllOfSettings.
