...
class TransactionRequest(Model):
    ...
    def __init__(self, amount: float=None, billing_address: ContactObject=None, currency: str=None, custom_fields: object=None, customer_id: str=None, description: str=None, gateway_account_id: str=None, invoice_ids: List[str]=None, is_merchant_initiated: bool=False, is_processed_outside: bool=False, notification_url: str=None, payment_instruction: PaymentInstruction=None, payment_instrument: PaymentInstrument=None, processed_time: datetime=None, redirect_url: str=None, request_id: str=None, risk_metadata: RiskMetadata=None, website_id: str=None, type: str=None):
        """TransactionRequest - a model defined in OpenAPI

        :param amount: The amount of this TransactionRequest.
        :param billing_address: The billing_address of this TransactionRequest.
        :param currency: The currency of this TransactionRequest.
        :param custom_fields: The custom_fields of this TransactionRequest.
        :param customer_id: The customer_id of this TransactionRequest.
        :param description: The description of this TransactionRequest.
        :param gateway_account_id: The gateway_account_id of this TransactionRequest.
        :param invoice_ids: The invoice_ids of this TransactionRequest.
        :param is_merchant_initiated: The is_merchant_initiated of this TransactionRequest.
        :param is_processed_outside: The is_processed_outside of this TransactionRequest.
        :param notification_url: The notification_url of this TransactionRequest.
        :param payment_instruction: The payment_instruction of this TransactionRequest.
        :param payment_instrument: The payment_instrument of this TransactionRequest.
        :param processed_time: The processed_time of this TransactionRequest.
        :param redirect_url: The redirect_url of this TransactionRequest.
        :param request_id: The request_id of this TransactionRequest.
        :param risk_metadata: The risk_metadata of this TransactionRequest.
        :param website_id: The website_id of this TransactionRequest.
        :param type: The type of this TransactionRequest.
        """
        self.openapi_types = {
            'amount': float,
    ...
    def billing_address(self, billing_address):
        """Sets the billing_address of this TransactionRequest.
    ...
    @property
    def currency(self):
        """Gets the currency of this TransactionRequest.

        ISO 4217 alphabetic currency code.

        :return: The currency of this TransactionRequest.
        :rtype: str
        """
    ...
    def currency(self, currency):
        """Sets the currency of this TransactionRequest.
    ...
    def custom_fields(self):
        """Gets the custom_fields of this TransactionRequest.

        Custom Fields list as a map `{\"custom field name\": \"custom field value\", ...}`. The format must follow the saved format (see Custom Fields section for the formats). 

        :return: The custom_fields of this TransactionRequest.
        :rtype: object
        """
    ...
    def custom_fields(self, custom_fields):
        """Sets the custom_fields of this TransactionRequest.
    ...
    def customer_id(self):
        """Gets the customer_id of this TransactionRequest.

        The customer identifier string.

        :return: The customer_id of this TransactionRequest.
        :rtype: str
        """
    ...
    def customer_id(self, customer_id):
        """Sets the customer_id of this TransactionRequest.
    ...
    def description(self):
        """Gets the description of this TransactionRequest.

        The payment description.

        :return: The description of this TransactionRequest.
        :rtype: str
        """
    ...
    def description(self, description):
        """Sets the description of this TransactionRequest.
    ...
    def gateway_account_id(self):
        """Gets the gateway_account_id of this TransactionRequest.
        ...
        :return: The gateway_account_id of this TransactionRequest.
        :rtype: str
        """
    ...
    def gateway_account_id(self, gateway_account_id):
        """Sets the gateway_account_id of this TransactionRequest.
    ...
    def invoice_ids(self):
        """Gets the invoice_ids of this TransactionRequest.

        The array of invoice identifiers.

        :return: The invoice_ids of this TransactionRequest.
        :rtype: List[str]
        """
    ...
    def invoice_ids(self, invoice_ids):
        """Sets the invoice_ids of this TransactionRequest.
    ...
    def is_merchant_initiated(self):
        """Gets the is_merchant_initiated of this TransactionRequest.

        True if the transaction was initiated by the merchant.

        :return: The is_merchant_initiated of this TransactionRequest.
        :rtype: bool
        """
    ...
    def is_merchant_initiated(self, is_merchant_initiated):
        """Sets the is_merchant_initiated of this TransactionRequest.
    ...
    def is_processed_outside(self):
        """Gets the is_processed_outside of this TransactionRequest.

        True if transaction was processed outside Rebilly.

        :return: The is_processed_outside of this TransactionRequest.
        :rtype: bool
        """
    ...
    def is_processed_outside(self, is_processed_outside):
        """Sets the is_processed_outside of this TransactionRequest.
    ...
    def notification_url(self):
        """Gets the notification_url of this TransactionRequest.
        ...
        :return: The notification_url of this TransactionRequest.
        :rtype: str
        """
    ...
    def notification_url(self, notification_url):
        """Sets the notification_url of this TransactionRequest.
    ...
    def payment_instruction(self):
        """Gets the payment_instruction of this TransactionRequest.

        Payment instruction. If not supplied, customer's default payment instrument will be used.

        :return: The payment_instruction of this TransactionRequest.
    ...
    def payment_instruction(self, payment_instruction):
        """Sets the payment_instruction of this TransactionRequest.
    ...
    def payment_instrument(self):
        """Gets the payment_instrument of this TransactionRequest.


        :return: The payment_instrument of this TransactionRequest.
    ...
    def payment_instrument(self, payment_instrument):
        """Sets the payment_instrument of this TransactionRequest.
    ...
    def processed_time(self, processed_time):
        """Sets the processed_time of this TransactionRequest.
    ...
    def redirect_url(self):
        """Gets the redirect_url of this TransactionRequest.
        ...
        :return: The redirect_url of this TransactionRequest.
        :rtype: str
        """
    ...
    def redirect_url(self, redirect_url):
        """Sets the redirect_url of this TransactionRequest.
    ...
    @property
    def request_id(self):
        """Gets the request_id of this TransactionRequest.
        ...
        :return: The request_id of this TransactionRequest.
        :rtype: str
        """
    ...
    def request_id(self, request_id):
        """Sets the request_id of this TransactionRequest.
    ...
    def risk_metadata(self):
        """Gets the risk_metadata of this TransactionRequest.


        :return: The risk_metadata of this TransactionRequest.
        :rtype: RiskMetadata
        """
    ...
    def risk_metadata(self, risk_metadata):
        """Sets the risk_metadata of this TransactionRequest.
    ...
    @property
    def website_id(self):
        """Gets the website_id of this TransactionRequest.

        The website identifier string.

        :return: The website_id of this TransactionRequest.
        :rtype: str
        """
    ...
    def website_id(self, website_id):
        """Sets the website_id of this TransactionRequest.
    ...
    @property
    def type(self):
        """Gets the type of this TransactionRequest.
        ...
        :return: The type of this TransactionRequest.
        :rtype: str
        """
        return self._type
    ...
    def type(self, type):
        ...
        :type type: str
        """
        allowed_values = ["3ds-authentication", "sale", "authorize"]  # noqa: E501
