...
class LPG(Model):
    ...
    def __init__(self, links: List[GatewayAccountLinksInner]=None, accepted_currencies: List[str]=None, acquirer_name: AcquirerName=None, additional_filters: str=None, approval_window_ttl: int=3600, city_field: str=None, created_time: datetime=None, dcc_force_currency: str=None, dcc_markup: int=None, descriptor: str=None, digital_wallets: DigitalWallets=None, dynamic_descriptor: bool=False, excluded_dcc_quote_currencies: List[str]=None, gateway_name: GatewayName=None, id: str=None, is_down: bool=None, merchant_category_code: str='0000', method: PaymentMethod=None, monthly_limit: float=None, organization_id: str=None, payment_card_schemes: List[PaymentCardBrand]=None, reconciliation_window_enabled: bool=False, reconciliation_window_ttl: int=None, status: str=None, sticky: bool=True, three_d_secure: bool=False, timeout: int=None, token: str=None, updated_time: datetime=None, credentials: LPGAllOfCredentials=None):
        """LPG - a model defined in OpenAPI

        :param links: The links of this LPG.
        :param accepted_currencies: The accepted_currencies of this LPG.
        :param acquirer_name: The acquirer_name of this LPG.
        :param additional_filters: The additional_filters of this LPG.
        :param approval_window_ttl: The approval_window_ttl of this LPG.
        :param city_field: The city_field of this LPG.
        :param created_time: The created_time of this LPG.
        :param dcc_force_currency: The dcc_force_currency of this LPG.
        :param dcc_markup: The dcc_markup of this LPG.
        :param descriptor: The descriptor of this LPG.
        :param digital_wallets: The digital_wallets of this LPG.
        :param dynamic_descriptor: The dynamic_descriptor of this LPG.
        :param excluded_dcc_quote_currencies: The excluded_dcc_quote_currencies of this LPG.
        :param gateway_name: The gateway_name of this LPG.
        :param id: The id of this LPG.
        :param is_down: The is_down of this LPG.
        :param merchant_category_code: The merchant_category_code of this LPG.
        :param method: The method of this LPG.
        :param monthly_limit: The monthly_limit of this LPG.
        :param organization_id: The organization_id of this LPG.
        :param payment_card_schemes: The payment_card_schemes of this LPG.
        :param reconciliation_window_enabled: The reconciliation_window_enabled of this LPG.
        :param reconciliation_window_ttl: The reconciliation_window_ttl of this LPG.
        :param status: The status of this LPG.
        :param sticky: The sticky of this LPG.
        :param three_d_secure: The three_d_secure of this LPG.
        :param timeout: The timeout of this LPG.
        :param token: The token of this LPG.
        :param updated_time: The updated_time of this LPG.
        :param credentials: The credentials of this LPG.
        """
        self.openapi_types = {
            ...
            'credentials': LPGAllOfCredentials
        }
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'LPG':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The LPG of this LPG.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def links(self):
        """Gets the links of this LPG.

        The links related to resource.

        :return: The links of this LPG.
    ...
    def accepted_currencies(self):
        """Gets the accepted_currencies of this LPG.

        Accepted currencies (array of the currency three letter codes).

        :return: The accepted_currencies of this LPG.
        :rtype: List[str]
        """
    ...
    def accepted_currencies(self, accepted_currencies):
        """Sets the accepted_currencies of this LPG.
    ...
    def acquirer_name(self):
        """Gets the acquirer_name of this LPG.


        :return: The acquirer_name of this LPG.
        :rtype: AcquirerName
        """
    ...
    def acquirer_name(self, acquirer_name):
        """Sets the acquirer_name of this LPG.
    ...
    def additional_filters(self):
        """Gets the additional_filters of this LPG.
        ...
        :return: The additional_filters of this LPG.
        :rtype: str
        """
    ...
    def additional_filters(self, additional_filters):
        """Sets the additional_filters of this LPG.
    ...
    def approval_window_ttl(self, approval_window_ttl):
        """Sets the approval_window_ttl of this LPG.
    ...
    @property
    def city_field(self):
        """Gets the city_field of this LPG.

        The gateway account's city field (also known as line 2 descriptor).

        :return: The city_field of this LPG.
        :rtype: str
        """
    ...
    def city_field(self, city_field):
        """Sets the city_field of this LPG.
    ...
    def created_time(self):
        """Gets the created_time of this LPG.

        Gateway Account created time.

        :return: The created_time of this LPG.
        :rtype: datetime
        """
    ...
    def created_time(self, created_time):
        """Sets the created_time of this LPG.
    ...
    def dcc_force_currency(self, dcc_force_currency):
        """Sets the dcc_force_currency of this LPG.
    ...
    @property
    def dcc_markup(self):
        """Gets the dcc_markup of this LPG.

        Dynamic currency conversion markup in basis points.

        :return: The dcc_markup of this LPG.
        :rtype: int
        """
    ...
    def dcc_markup(self, dcc_markup):
        """Sets the dcc_markup of this LPG.
    ...
    @property
    def descriptor(self):
        """Gets the descriptor of this LPG.

        The gateway account's descriptor.

        :return: The descriptor of this LPG.
        :rtype: str
        """
    ...
    def descriptor(self, descriptor):
        """Sets the descriptor of this LPG.
    ...
    def digital_wallets(self):
        """Gets the digital_wallets of this LPG.


        :return: The digital_wallets of this LPG.
    ...
    def digital_wallets(self, digital_wallets):
        """Sets the digital_wallets of this LPG.
    ...
    def dynamic_descriptor(self):
        """Gets the dynamic_descriptor of this LPG.

        True, if Gateway Account allows dynamic descriptor.

        :return: The dynamic_descriptor of this LPG.
        :rtype: bool
        """
    ...
    def dynamic_descriptor(self, dynamic_descriptor):
        """Sets the dynamic_descriptor of this LPG.
    ...
    def excluded_dcc_quote_currencies(self):
        """Gets the excluded_dcc_quote_currencies of this LPG.

        Excluded Dynamic Currency Conversion Quote Currencies.

        :return: The excluded_dcc_quote_currencies of this LPG.
        :rtype: List[str]
        """
    ...
    def excluded_dcc_quote_currencies(self, excluded_dcc_quote_currencies):
        """Sets the excluded_dcc_quote_currencies of this LPG.
    ...
    def gateway_name(self):
        """Gets the gateway_name of this LPG.


        :return: The gateway_name of this LPG.
        :rtype: GatewayName
        """
    ...
    def gateway_name(self, gateway_name):
        """Sets the gateway_name of this LPG.
    ...
    @property
    def id(self):
        """Gets the id of this LPG.

        The gateway identifier string.

        :return: The id of this LPG.
        :rtype: str
        """
        return self._id
    ...
    @property
    def is_down(self):
        """Gets the is_down of this LPG.

        True if gateway is currently in downtime period.

        :return: The is_down of this LPG.
        :rtype: bool
        """
    ...
    def merchant_category_code(self):
        """Gets the merchant_category_code of this LPG.

        The gateway account's merchant category code.

        :return: The merchant_category_code of this LPG.
        :rtype: str
        """
    ...
    def merchant_category_code(self, merchant_category_code):
        """Sets the merchant_category_code of this LPG.
    ...
    @property
    def method(self):
        """Gets the method of this LPG.


        :return: The method of this LPG.
        :rtype: PaymentMethod
        """
        return self._method
    ...
    def monthly_limit(self):
        """Gets the monthly_limit of this LPG.

        Monthly Limit.

        :return: The monthly_limit of this LPG.
        :rtype: float
        """
    ...
    def monthly_limit(self, monthly_limit):
        """Sets the monthly_limit of this LPG.
    ...
    def organization_id(self):
        """Gets the organization_id of this LPG.

        Organization ID.

        :return: The organization_id of this LPG.
        :rtype: str
        """
    ...
    def organization_id(self, organization_id):
        """Sets the organization_id of this LPG.
    ...
    def payment_card_schemes(self):
        """Gets the payment_card_schemes of this LPG.

        Accepted payment card brands.

        :return: The payment_card_schemes of this LPG.
    ...
    def payment_card_schemes(self, payment_card_schemes):
        """Sets the payment_card_schemes of this LPG.
    ...
    def reconciliation_window_enabled(self, reconciliation_window_enabled):
        """Sets the reconciliation_window_enabled of this LPG.
    ...
    def reconciliation_window_ttl(self):
        """Gets the reconciliation_window_ttl of this LPG.
        ...
        :return: The reconciliation_window_ttl of this LPG.
        :rtype: int
        """
    ...
    def reconciliation_window_ttl(self, reconciliation_window_ttl):
        """Sets the reconciliation_window_ttl of this LPG.
    ...
    @property
    def status(self):
        """Gets the status of this LPG.

        The gateway account's status.

        :return: The status of this LPG.
        :rtype: str
        """
        return self._status
    ...
    def three_d_secure(self):
        """Gets the three_d_secure of this LPG.

        True, if Gateway Account allows 3DSecure.

        :return: The three_d_secure of this LPG.
        :rtype: bool
        """
    ...
    def three_d_secure(self, three_d_secure):
        """Sets the three_d_secure of this LPG.
    ...
    @property
    def timeout(self):
        """Gets the timeout of this LPG.

        Gateway Account request timeout in seconds.

        :return: The timeout of this LPG.
        :rtype: int
        """
    ...
    @property
    def token(self):
        """Gets the token of this LPG.

        Gateway Account token.

        :return: The token of this LPG.
        :rtype: str
        """
        return self._token
    ...
    def updated_time(self):
        """Gets the updated_time of this LPG.

        Gateway Account updated time.

        :return: The updated_time of this LPG.
        :rtype: datetime
        """
    ...
    def updated_time(self, updated_time):
        """Sets the updated_time of this LPG.
    ...
    def credentials(self):
        """Gets the credentials of this LPG.


        :return: The credentials of this LPG.
        :rtype: LPGAllOfCredentials
        """
        return self._credentials

    @credentials.setter
    def credentials(self, credentials):
        """Sets the credentials of this LPG.


        :param credentials: The credentials of this LPG.
        :type credentials: LPGAllOfCredentials
        """
