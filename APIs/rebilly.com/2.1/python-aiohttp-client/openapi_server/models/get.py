...
class GET(Model):
    ...
    def __init__(self, links: List[GatewayAccountLinksInner]=None, accepted_currencies: List[str]=None, acquirer_name: AcquirerName=None, additional_filters: str=None, approval_window_ttl: int=3600, city_field: str=None, created_time: datetime=None, dcc_force_currency: str=None, dcc_markup: int=None, descriptor: str=None, digital_wallets: DigitalWallets=None, dynamic_descriptor: bool=False, excluded_dcc_quote_currencies: List[str]=None, gateway_name: GatewayName=None, id: str=None, is_down: bool=None, merchant_category_code: str='0000', method: PaymentMethod=None, monthly_limit: float=None, organization_id: str=None, payment_card_schemes: List[PaymentCardBrand]=None, reconciliation_window_enabled: bool=False, reconciliation_window_ttl: int=None, status: str=None, sticky: bool=True, three_d_secure: bool=False, timeout: int=None, token: str=None, updated_time: datetime=None, credentials: GETAllOfCredentials=None, three_d_secure_server: GET3dsServers=None):
        """GET - a model defined in OpenAPI

        :param links: The links of this GET.
        :param accepted_currencies: The accepted_currencies of this GET.
        :param acquirer_name: The acquirer_name of this GET.
        :param additional_filters: The additional_filters of this GET.
        :param approval_window_ttl: The approval_window_ttl of this GET.
        :param city_field: The city_field of this GET.
        :param created_time: The created_time of this GET.
        :param dcc_force_currency: The dcc_force_currency of this GET.
        :param dcc_markup: The dcc_markup of this GET.
        :param descriptor: The descriptor of this GET.
        :param digital_wallets: The digital_wallets of this GET.
        :param dynamic_descriptor: The dynamic_descriptor of this GET.
        :param excluded_dcc_quote_currencies: The excluded_dcc_quote_currencies of this GET.
        :param gateway_name: The gateway_name of this GET.
        :param id: The id of this GET.
        :param is_down: The is_down of this GET.
        :param merchant_category_code: The merchant_category_code of this GET.
        :param method: The method of this GET.
        :param monthly_limit: The monthly_limit of this GET.
        :param organization_id: The organization_id of this GET.
        :param payment_card_schemes: The payment_card_schemes of this GET.
        :param reconciliation_window_enabled: The reconciliation_window_enabled of this GET.
        :param reconciliation_window_ttl: The reconciliation_window_ttl of this GET.
        :param status: The status of this GET.
        :param sticky: The sticky of this GET.
        :param three_d_secure: The three_d_secure of this GET.
        :param timeout: The timeout of this GET.
        :param token: The token of this GET.
        :param updated_time: The updated_time of this GET.
        :param credentials: The credentials of this GET.
        :param three_d_secure_server: The three_d_secure_server of this GET.
        """
        self.openapi_types = {
            ...
            'credentials': GETAllOfCredentials,
            'three_d_secure_server': GET3dsServers
        }
    ...
    @property
    def links(self):
        """Gets the links of this GET.

        The links related to resource.

        :return: The links of this GET.
    ...
    def accepted_currencies(self):
        """Gets the accepted_currencies of this GET.

        Accepted currencies (array of the currency three letter codes).

        :return: The accepted_currencies of this GET.
        :rtype: List[str]
        """
    ...
    def accepted_currencies(self, accepted_currencies):
        """Sets the accepted_currencies of this GET.
    ...
    def acquirer_name(self):
        """Gets the acquirer_name of this GET.


        :return: The acquirer_name of this GET.
        :rtype: AcquirerName
        """
    ...
    def acquirer_name(self, acquirer_name):
        """Sets the acquirer_name of this GET.
    ...
    def additional_filters(self):
        """Gets the additional_filters of this GET.
        ...
        :return: The additional_filters of this GET.
        :rtype: str
        """
    ...
    def additional_filters(self, additional_filters):
        """Sets the additional_filters of this GET.
    ...
    def approval_window_ttl(self, approval_window_ttl):
        """Sets the approval_window_ttl of this GET.
    ...
    @property
    def city_field(self):
        """Gets the city_field of this GET.

        The gateway account's city field (also known as line 2 descriptor).

        :return: The city_field of this GET.
        :rtype: str
        """
    ...
    def city_field(self, city_field):
        """Sets the city_field of this GET.
    ...
    def created_time(self):
        """Gets the created_time of this GET.

        Gateway Account created time.

        :return: The created_time of this GET.
        :rtype: datetime
        """
    ...
    def created_time(self, created_time):
        """Sets the created_time of this GET.
    ...
    def dcc_force_currency(self, dcc_force_currency):
        """Sets the dcc_force_currency of this GET.
    ...
    @property
    def dcc_markup(self):
        """Gets the dcc_markup of this GET.

        Dynamic currency conversion markup in basis points.

        :return: The dcc_markup of this GET.
        :rtype: int
        """
    ...
    def dcc_markup(self, dcc_markup):
        """Sets the dcc_markup of this GET.
    ...
    @property
    def descriptor(self):
        """Gets the descriptor of this GET.

        The gateway account's descriptor.

        :return: The descriptor of this GET.
        :rtype: str
        """
    ...
    def descriptor(self, descriptor):
        """Sets the descriptor of this GET.
    ...
    def digital_wallets(self):
        """Gets the digital_wallets of this GET.


        :return: The digital_wallets of this GET.
    ...
    def digital_wallets(self, digital_wallets):
        """Sets the digital_wallets of this GET.
    ...
    def dynamic_descriptor(self):
        """Gets the dynamic_descriptor of this GET.

        True, if Gateway Account allows dynamic descriptor.

        :return: The dynamic_descriptor of this GET.
        :rtype: bool
        """
    ...
    def dynamic_descriptor(self, dynamic_descriptor):
        """Sets the dynamic_descriptor of this GET.
    ...
    def excluded_dcc_quote_currencies(self):
        """Gets the excluded_dcc_quote_currencies of this GET.

        Excluded Dynamic Currency Conversion Quote Currencies.

        :return: The excluded_dcc_quote_currencies of this GET.
        :rtype: List[str]
        """
    ...
    def excluded_dcc_quote_currencies(self, excluded_dcc_quote_currencies):
        """Sets the excluded_dcc_quote_currencies of this GET.
    ...
    def gateway_name(self):
        """Gets the gateway_name of this GET.


        :return: The gateway_name of this GET.
        :rtype: GatewayName
        """
    ...
    def gateway_name(self, gateway_name):
        """Sets the gateway_name of this GET.
    ...
    @property
    def id(self):
        """Gets the id of this GET.

        The gateway identifier string.

        :return: The id of this GET.
        :rtype: str
        """
        return self._id
    ...
    @property
    def is_down(self):
        """Gets the is_down of this GET.

        True if gateway is currently in downtime period.

        :return: The is_down of this GET.
        :rtype: bool
        """
    ...
    def merchant_category_code(self):
        """Gets the merchant_category_code of this GET.

        The gateway account's merchant category code.

        :return: The merchant_category_code of this GET.
        :rtype: str
        """
    ...
    def merchant_category_code(self, merchant_category_code):
        """Sets the merchant_category_code of this GET.
    ...
    @property
    def method(self):
        """Gets the method of this GET.


        :return: The method of this GET.
        :rtype: PaymentMethod
        """
        return self._method
    ...
    def monthly_limit(self):
        """Gets the monthly_limit of this GET.

        Monthly Limit.

        :return: The monthly_limit of this GET.
        :rtype: float
        """
    ...
    def monthly_limit(self, monthly_limit):
        """Sets the monthly_limit of this GET.
    ...
    def organization_id(self):
        """Gets the organization_id of this GET.

        Organization ID.

        :return: The organization_id of this GET.
        :rtype: str
        """
    ...
    def organization_id(self, organization_id):
        """Sets the organization_id of this GET.
    ...
    def payment_card_schemes(self):
        """Gets the payment_card_schemes of this GET.

        Accepted payment card brands.

        :return: The payment_card_schemes of this GET.
    ...
    def payment_card_schemes(self, payment_card_schemes):
        """Sets the payment_card_schemes of this GET.
    ...
    def reconciliation_window_enabled(self, reconciliation_window_enabled):
        """Sets the reconciliation_window_enabled of this GET.
    ...
    def reconciliation_window_ttl(self):
        """Gets the reconciliation_window_ttl of this GET.
        ...
        :return: The reconciliation_window_ttl of this GET.
        :rtype: int
        """
    ...
    def reconciliation_window_ttl(self, reconciliation_window_ttl):
        """Sets the reconciliation_window_ttl of this GET.
    ...
    @property
    def status(self):
        """Gets the status of this GET.

        The gateway account's status.

        :return: The status of this GET.
        :rtype: str
        """
        return self._status
    ...
    def three_d_secure(self):
        """Gets the three_d_secure of this GET.

        True, if Gateway Account allows 3DSecure.

        :return: The three_d_secure of this GET.
        :rtype: bool
        """
    ...
    def three_d_secure(self, three_d_secure):
        """Sets the three_d_secure of this GET.
    ...
    @property
    def timeout(self):
        """Gets the timeout of this GET.

        Gateway Account request timeout in seconds.

        :return: The timeout of this GET.
        :rtype: int
        """
    ...
    @property
    def token(self):
        """Gets the token of this GET.

        Gateway Account token.

        :return: The token of this GET.
        :rtype: str
        """
        return self._token
    ...
    def updated_time(self):
        """Gets the updated_time of this GET.

        Gateway Account updated time.

        :return: The updated_time of this GET.
        :rtype: datetime
        """
    ...
    def updated_time(self, updated_time):
        """Sets the updated_time of this GET.
    ...
    def credentials(self):
        """Gets the credentials of this GET.


        :return: The credentials of this GET.
        :rtype: GETAllOfCredentials
        """
        return self._credentials

    @credentials.setter
    def credentials(self, credentials):
        """Sets the credentials of this GET.


        :param credentials: The credentials of this GET.
        :type credentials: GETAllOfCredentials
        """
    ...
    def three_d_secure_server(self):
        """Gets the three_d_secure_server of this GET.


        :return: The three_d_secure_server of this GET.
        :rtype: GET3dsServers
        """
    ...
    def three_d_secure_server(self, three_d_secure_server):
        """Sets the three_d_secure_server of this GET.


        :param three_d_secure_server: The three_d_secure_server of this GET.
        :type three_d_secure_server: GET3dsServers
        """
