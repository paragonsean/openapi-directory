...
class PayPal(Model):
    ...
    def __init__(self, links: List[GatewayAccountLinksInner]=None, accepted_currencies: List[str]=None, acquirer_name: AcquirerName=None, additional_filters: str=None, approval_window_ttl: int=3600, city_field: str=None, created_time: datetime=None, dcc_force_currency: str=None, dcc_markup: int=None, descriptor: str=None, digital_wallets: DigitalWallets=None, dynamic_descriptor: bool=False, excluded_dcc_quote_currencies: List[str]=None, gateway_name: GatewayName=None, id: str=None, is_down: bool=None, merchant_category_code: str='0000', method: PaymentMethod=None, monthly_limit: float=None, organization_id: str=None, payment_card_schemes: List[PaymentCardBrand]=None, reconciliation_window_enabled: bool=False, reconciliation_window_ttl: int=None, status: str=None, sticky: bool=True, three_d_secure: bool=False, timeout: int=None, token: str=None, updated_time: datetime=None, settings: PayPalAllOfSettings=None):
        """PayPal - a model defined in OpenAPI

        :param links: The links of this PayPal.
        :param accepted_currencies: The accepted_currencies of this PayPal.
        :param acquirer_name: The acquirer_name of this PayPal.
        :param additional_filters: The additional_filters of this PayPal.
        :param approval_window_ttl: The approval_window_ttl of this PayPal.
        :param city_field: The city_field of this PayPal.
        :param created_time: The created_time of this PayPal.
        :param dcc_force_currency: The dcc_force_currency of this PayPal.
        :param dcc_markup: The dcc_markup of this PayPal.
        :param descriptor: The descriptor of this PayPal.
        :param digital_wallets: The digital_wallets of this PayPal.
        :param dynamic_descriptor: The dynamic_descriptor of this PayPal.
        :param excluded_dcc_quote_currencies: The excluded_dcc_quote_currencies of this PayPal.
        :param gateway_name: The gateway_name of this PayPal.
        :param id: The id of this PayPal.
        :param is_down: The is_down of this PayPal.
        :param merchant_category_code: The merchant_category_code of this PayPal.
        :param method: The method of this PayPal.
        :param monthly_limit: The monthly_limit of this PayPal.
        :param organization_id: The organization_id of this PayPal.
        :param payment_card_schemes: The payment_card_schemes of this PayPal.
        :param reconciliation_window_enabled: The reconciliation_window_enabled of this PayPal.
        :param reconciliation_window_ttl: The reconciliation_window_ttl of this PayPal.
        :param status: The status of this PayPal.
        :param sticky: The sticky of this PayPal.
        :param three_d_secure: The three_d_secure of this PayPal.
        :param timeout: The timeout of this PayPal.
        :param token: The token of this PayPal.
        :param updated_time: The updated_time of this PayPal.
        :param settings: The settings of this PayPal.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'PayPal':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The PayPal of this PayPal.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def links(self):
        """Gets the links of this PayPal.

        The links related to resource.

        :return: The links of this PayPal.
    ...
    def accepted_currencies(self):
        """Gets the accepted_currencies of this PayPal.

        Accepted currencies (array of the currency three letter codes).

        :return: The accepted_currencies of this PayPal.
        :rtype: List[str]
        """
    ...
    def accepted_currencies(self, accepted_currencies):
        """Sets the accepted_currencies of this PayPal.
    ...
    def acquirer_name(self):
        """Gets the acquirer_name of this PayPal.


        :return: The acquirer_name of this PayPal.
        :rtype: AcquirerName
        """
    ...
    def acquirer_name(self, acquirer_name):
        """Sets the acquirer_name of this PayPal.
    ...
    def additional_filters(self):
        """Gets the additional_filters of this PayPal.
        ...
        :return: The additional_filters of this PayPal.
        :rtype: str
        """
    ...
    def additional_filters(self, additional_filters):
        """Sets the additional_filters of this PayPal.
    ...
    def approval_window_ttl(self, approval_window_ttl):
        """Sets the approval_window_ttl of this PayPal.
    ...
    @property
    def city_field(self):
        """Gets the city_field of this PayPal.

        The gateway account's city field (also known as line 2 descriptor).

        :return: The city_field of this PayPal.
        :rtype: str
        """
    ...
    def city_field(self, city_field):
        """Sets the city_field of this PayPal.
    ...
    def created_time(self):
        """Gets the created_time of this PayPal.

        Gateway Account created time.

        :return: The created_time of this PayPal.
        :rtype: datetime
        """
    ...
    def created_time(self, created_time):
        """Sets the created_time of this PayPal.
    ...
    def dcc_force_currency(self, dcc_force_currency):
        """Sets the dcc_force_currency of this PayPal.
    ...
    @property
    def dcc_markup(self):
        """Gets the dcc_markup of this PayPal.

        Dynamic currency conversion markup in basis points.

        :return: The dcc_markup of this PayPal.
        :rtype: int
        """
    ...
    def dcc_markup(self, dcc_markup):
        """Sets the dcc_markup of this PayPal.
    ...
    @property
    def descriptor(self):
        """Gets the descriptor of this PayPal.

        The gateway account's descriptor.

        :return: The descriptor of this PayPal.
        :rtype: str
        """
    ...
    def descriptor(self, descriptor):
        """Sets the descriptor of this PayPal.
    ...
    def digital_wallets(self):
        """Gets the digital_wallets of this PayPal.


        :return: The digital_wallets of this PayPal.
    ...
    def digital_wallets(self, digital_wallets):
        """Sets the digital_wallets of this PayPal.
    ...
    def dynamic_descriptor(self):
        """Gets the dynamic_descriptor of this PayPal.

        True, if Gateway Account allows dynamic descriptor.

        :return: The dynamic_descriptor of this PayPal.
        :rtype: bool
        """
    ...
    def dynamic_descriptor(self, dynamic_descriptor):
        """Sets the dynamic_descriptor of this PayPal.
    ...
    def excluded_dcc_quote_currencies(self):
        """Gets the excluded_dcc_quote_currencies of this PayPal.

        Excluded Dynamic Currency Conversion Quote Currencies.

        :return: The excluded_dcc_quote_currencies of this PayPal.
        :rtype: List[str]
        """
    ...
    def excluded_dcc_quote_currencies(self, excluded_dcc_quote_currencies):
        """Sets the excluded_dcc_quote_currencies of this PayPal.
    ...
    def gateway_name(self):
        """Gets the gateway_name of this PayPal.


        :return: The gateway_name of this PayPal.
        :rtype: GatewayName
        """
    ...
    def gateway_name(self, gateway_name):
        """Sets the gateway_name of this PayPal.
    ...
    @property
    def id(self):
        """Gets the id of this PayPal.

        The gateway identifier string.

        :return: The id of this PayPal.
        :rtype: str
        """
        return self._id
    ...
    @property
    def is_down(self):
        """Gets the is_down of this PayPal.

        True if gateway is currently in downtime period.

        :return: The is_down of this PayPal.
        :rtype: bool
        """
    ...
    def is_down(self, is_down):
        """Sets the is_down of this PayPal.
    ...
    def merchant_category_code(self):
        """Gets the merchant_category_code of this PayPal.

        The gateway account's merchant category code.

        :return: The merchant_category_code of this PayPal.
        :rtype: str
        """
    ...
    def merchant_category_code(self, merchant_category_code):
        """Sets the merchant_category_code of this PayPal.
    ...
    @property
    def method(self):
        """Gets the method of this PayPal.


        :return: The method of this PayPal.
        :rtype: PaymentMethod
        """
        return self._method
    ...
    def method(self, method):
        """Sets the method of this PayPal.
    ...
    def monthly_limit(self):
        """Gets the monthly_limit of this PayPal.

        Monthly Limit.

        :return: The monthly_limit of this PayPal.
        :rtype: float
        """
    ...
    def monthly_limit(self, monthly_limit):
        """Sets the monthly_limit of this PayPal.
    ...
    def organization_id(self):
        """Gets the organization_id of this PayPal.

        Organization ID.

        :return: The organization_id of this PayPal.
        :rtype: str
        """
    ...
    def organization_id(self, organization_id):
        """Sets the organization_id of this PayPal.
    ...
    def payment_card_schemes(self):
        """Gets the payment_card_schemes of this PayPal.

        Accepted payment card brands.

        :return: The payment_card_schemes of this PayPal.
    ...
    def payment_card_schemes(self, payment_card_schemes):
        """Sets the payment_card_schemes of this PayPal.
    ...
    def reconciliation_window_enabled(self, reconciliation_window_enabled):
        """Sets the reconciliation_window_enabled of this PayPal.
    ...
    def reconciliation_window_ttl(self):
        """Gets the reconciliation_window_ttl of this PayPal.
        ...
        :return: The reconciliation_window_ttl of this PayPal.
        :rtype: int
        """
    ...
    def reconciliation_window_ttl(self, reconciliation_window_ttl):
        """Sets the reconciliation_window_ttl of this PayPal.
    ...
    @property
    def status(self):
        """Gets the status of this PayPal.

        The gateway account's status.

        :return: The status of this PayPal.
        :rtype: str
        """
        return self._status
    ...
    def status(self, status):
        """Sets the status of this PayPal.
    ...
    def sticky(self, sticky):
        """Sets the sticky of this PayPal.
    ...
    def three_d_secure(self):
        """Gets the three_d_secure of this PayPal.

        True, if Gateway Account allows 3DSecure.

        :return: The three_d_secure of this PayPal.
        :rtype: bool
        """
    ...
    def three_d_secure(self, three_d_secure):
        """Sets the three_d_secure of this PayPal.
    ...
    @property
    def timeout(self):
        """Gets the timeout of this PayPal.

        Gateway Account request timeout in seconds.

        :return: The timeout of this PayPal.
        :rtype: int
        """
    ...
    def timeout(self, timeout):
        """Sets the timeout of this PayPal.
    ...
    @property
    def token(self):
        """Gets the token of this PayPal.

        Gateway Account token.

        :return: The token of this PayPal.
        :rtype: str
        """
        return self._token
    ...
    def updated_time(self):
        """Gets the updated_time of this PayPal.

        Gateway Account updated time.

        :return: The updated_time of this PayPal.
        :rtype: datetime
        """
    ...
    def updated_time(self, updated_time):
        """Sets the updated_time of this PayPal.
    ...
    @property
    def settings(self):
        """Gets the settings of this PayPal.


        :return: The settings of this PayPal.
        :rtype: PayPalAllOfSettings
        """
        return self._settings

    @settings.setter
    def settings(self, settings):
        """Sets the settings of this PayPal.


        :param settings: The settings of this PayPal.
        :type settings: PayPalAllOfSettings
        """
        if settings is None:
