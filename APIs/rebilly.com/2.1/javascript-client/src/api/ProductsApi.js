...
export default class ProductsApi {
    ...
    */
     ...
     */
    deleteProduct(id, opts, callback) {
      opts = opts || {};
      let postBody = null;
     ...
     * @callback module:api/ProductsApi~getProductCollectionCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:api/ProductsApi~getProductCollectionCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Array.<module:model/Product>}
     */
    getProductCollection(opts, callback) {
      opts = opts || {};
      let postBody = null;
     ...
     * @callback module:api/ProductsApi~postProductCallback
     * @param {String} error Error message, if any.
     * @param {module:model/Product} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * Create a Product
     * Create a Product. 
     * @param {module:model/Product} product Product resource.
     * @param {Object} opts Optional parameters
     * @param {String} [organizationId] Organization identifier in scope of which need to perform request (if not specified, the default organization will be used).
     ...
     * data is of type: {@link module:model/Product}
     */
    postProduct(product, opts, callback) {
      opts = opts || {};
      let postBody = product;
      // verify the required parameter 'product' is set
      if (product === undefined || product === null) {
        throw new Error("Missing the required parameter 'product' when calling postProduct");
      }
     ...
     * @callback module:api/ProductsApi~putProductCallback
     * @param {String} error Error message, if any.
     * @param {module:model/Product} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Object} opts Optional parameters
     * @param {String} [organizationId] Organization identifier in scope of which need to perform request (if not specified, the default organization will be used).
     * @param {module:api/ProductsApi~putProductCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/Product}
     */
    putProduct(id, product, opts, callback) {
      opts = opts || {};
      let postBody = product;
      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling putProduct");
      }
      // verify the required parameter 'product' is set
      if (product === undefined || product === null) {
        throw new Error("Missing the required parameter 'product' when calling putProduct");
      }
