...
export default class PlansApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the getPlanCollection operation.
     * @callback module:api/PlansApi~getPlanCollectionCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:api/PlansApi~getPlanCollectionCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Array.<module:model/Plan>}
     */
    getPlanCollection(opts, callback) {
      opts = opts || {};
      let postBody = null;
    ...
    /**
     * Callback function to receive the result of the postPlan operation.
     * @callback module:api/PlansApi~postPlanCallback
     * @param {String} error Error message, if any.
     * @param {module:model/Plan} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * Create a plan
     * Create a plan. 
     * @param {module:model/Plan} plan Plan resource.
     * @param {Object} opts Optional parameters
     * @param {String} [organizationId] Organization identifier in scope of which need to perform request (if not specified, the default organization will be used).
     * @param {module:api/PlansApi~postPlanCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/Plan}
     */
    postPlan(plan, opts, callback) {
      opts = opts || {};
      let postBody = plan;
      // verify the required parameter 'plan' is set
      if (plan === undefined || plan === null) {
        throw new Error("Missing the required parameter 'plan' when calling postPlan");
      }
    ...
    /**
     * Callback function to receive the result of the putPlan operation.
     * @callback module:api/PlansApi~putPlanCallback
     * @param {String} error Error message, if any.
     * @param {module:model/Plan} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Object} opts Optional parameters
     * @param {String} [organizationId] Organization identifier in scope of which need to perform request (if not specified, the default organization will be used).
     * @param {module:api/PlansApi~putPlanCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/Plan}
     */
    putPlan(id, plan, opts, callback) {
      opts = opts || {};
      let postBody = plan;
      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling putPlan");
      }
      // verify the required parameter 'plan' is set
      if (plan === undefined || plan === null) {
        throw new Error("Missing the required parameter 'plan' when calling putPlan");
      }
