...
import DragonphoenixAllOfCredentials from './DragonphoenixAllOfCredentials';
...
/**
 * The Dragonphoenix model module.
 * @module model/Dragonphoenix
 * @version 2.1
 */
class Dragonphoenix {
    /**
     * Constructs a new <code>Dragonphoenix</code>.
     * Dragonphoenix config.
     * @alias module:model/Dragonphoenix
     ...
     * @param credentials {module:model/DragonphoenixAllOfCredentials} 
     */
    constructor(acceptedCurrencies, gatewayName, method, credentials) { 
        ...
        Dragonphoenix.initialize(this, acceptedCurrencies, gatewayName, method, credentials);
    }
    ...
    /**
     * Constructs a <code>Dragonphoenix</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Dragonphoenix} obj Optional instance to populate.
     * @return {module:model/Dragonphoenix} The populated <code>Dragonphoenix</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new Dragonphoenix();
            GatewayAccount.constructFromObject(data, obj);
            GatewayAccount.constructFromObject(data, obj);

            if (data.hasOwnProperty('credentials')) {
                obj['credentials'] = DragonphoenixAllOfCredentials.constructFromObject(data['credentials']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>Dragonphoenix</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Dragonphoenix</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of Dragonphoenix.RequiredProperties) {
        ...
        if (data['credentials']) { // data not null
          DragonphoenixAllOfCredentials.validateJSON(data['credentials']);
        }
...
Dragonphoenix.RequiredProperties = ["credentials", "acceptedCurrencies", "gatewayName", "method"];

/**
 * @member {module:model/DragonphoenixAllOfCredentials} credentials
 */
Dragonphoenix.prototype['credentials'] = undefined;
