...
import CommonKycRequest from './CommonKycRequest';
...
/**
 * The KycRequest model module.
 * @module model/KycRequest
 * @version 2.1
 */
class KycRequest {
    /**
     * Constructs a new <code>KycRequest</code>.
     * @alias module:model/KycRequest
     * @implements module:model/CommonKycRequest
    ...
    constructor(documents, customerId) { 
        CommonKycRequest.initialize(this, documents);
    ...
    /**
     * Constructs a <code>KycRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/KycRequest} obj Optional instance to populate.
     * @return {module:model/KycRequest} The populated <code>KycRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new KycRequest();
            CommonKycRequest.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>KycRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>KycRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of KycRequest.RequiredProperties) {
...
KycRequest.RequiredProperties = ["documents", "customerId"];
...
// Implement CommonKycRequest interface:
/**
 * Creation date/time.
 * @member {Date} createdTime
 */
CommonKycRequest.prototype['createdTime'] = undefined;
/**
 * Documents to be requested from customer.
 * @member {Array.<module:model/CommonKycRequestDocumentsInner>} documents
 */
CommonKycRequest.prototype['documents'] = undefined;
/**
 * Expiration date/time.
 * @member {Date} expirationTime
 */
CommonKycRequest.prototype['expirationTime'] = undefined;
/**
 * The resource ID. Defaults to UUID v4.
 * @member {String} id
 */
CommonKycRequest.prototype['id'] = undefined;
/**
 * The URL to redirect the customer when an upload is completed.
 * @member {String} redirectUrl
 */
CommonKycRequest.prototype['redirectUrl'] = undefined;
/**
 * Latest update date/time.
 * @member {Date} updatedTime
 */
CommonKycRequest.prototype['updatedTime'] = undefined;
