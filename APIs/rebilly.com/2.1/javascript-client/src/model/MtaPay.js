...
import MtaPayAllOfCredentials from './MtaPayAllOfCredentials';
import MtaPayAllOfSettings from './MtaPayAllOfSettings';
import PaymentCardBrand from './PaymentCardBrand';
import PaymentMethod from './PaymentMethod';

/**
 * The MtaPay model module.
 * @module model/MtaPay
 * @version 2.1
 */
class MtaPay {
    /**
     * Constructs a new <code>MtaPay</code>.
     * MTA Pay Gateway config.
     * @alias module:model/MtaPay
     ...
     * @param credentials {module:model/MtaPayAllOfCredentials} 
     * @param settings {module:model/MtaPayAllOfSettings} 
     */
    constructor(acceptedCurrencies, gatewayName, method, credentials, settings) { 
        ...
        MtaPay.initialize(this, acceptedCurrencies, gatewayName, method, credentials, settings);
    }
    ...
    /**
     * Constructs a <code>MtaPay</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/MtaPay} obj Optional instance to populate.
     * @return {module:model/MtaPay} The populated <code>MtaPay</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('credentials')) {
                obj['credentials'] = MtaPayAllOfCredentials.constructFromObject(data['credentials']);
            }
            if (data.hasOwnProperty('settings')) {
                obj['settings'] = MtaPayAllOfSettings.constructFromObject(data['settings']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>MtaPay</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>MtaPay</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of MtaPay.RequiredProperties) {
        ...
        if (data['credentials']) { // data not null
          MtaPayAllOfCredentials.validateJSON(data['credentials']);
        }
        // validate the optional field `settings`
        if (data['settings']) { // data not null
          MtaPayAllOfSettings.validateJSON(data['settings']);
        }
...
MtaPay.RequiredProperties = ["credentials", "settings", "acceptedCurrencies", "gatewayName", "method"];

/**
 * @member {module:model/MtaPayAllOfCredentials} credentials
 */
MtaPay.prototype['credentials'] = undefined;

/**
 * @member {module:model/MtaPayAllOfSettings} settings
 */
MtaPay.prototype['settings'] = undefined;
