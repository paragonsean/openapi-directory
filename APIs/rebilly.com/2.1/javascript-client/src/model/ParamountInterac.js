...
import GigadatAllOfSettings from './GigadatAllOfSettings';
import ParamountInteracAllOfCredentials from './ParamountInteracAllOfCredentials';
import PaymentCardBrand from './PaymentCardBrand';
import PaymentMethod from './PaymentMethod';

/**
 * The ParamountInterac model module.
 * @module model/ParamountInterac
 * @version 2.1
 */
class ParamountInterac {
    /**
     * Constructs a new <code>ParamountInterac</code>.
     * ParamountInterac config.
     * @alias module:model/ParamountInterac
     ...
     * @param credentials {module:model/ParamountInteracAllOfCredentials} 
     */
    constructor(acceptedCurrencies, gatewayName, method, credentials) { 
        ...
        ParamountInterac.initialize(this, acceptedCurrencies, gatewayName, method, credentials);
    }
    ...
    /**
     * Constructs a <code>ParamountInterac</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ParamountInterac} obj Optional instance to populate.
     * @return {module:model/ParamountInterac} The populated <code>ParamountInterac</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ParamountInterac();
            GatewayAccount.constructFromObject(data, obj);
            GatewayAccount.constructFromObject(data, obj);

            if (data.hasOwnProperty('credentials')) {
                obj['credentials'] = ParamountInteracAllOfCredentials.constructFromObject(data['credentials']);
            }
            if (data.hasOwnProperty('settings')) {
                obj['settings'] = GigadatAllOfSettings.constructFromObject(data['settings']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ParamountInterac</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ParamountInterac</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ParamountInterac.RequiredProperties) {
        ...
        if (data['credentials']) { // data not null
          ParamountInteracAllOfCredentials.validateJSON(data['credentials']);
        }
        // validate the optional field `settings`
        if (data['settings']) { // data not null
          GigadatAllOfSettings.validateJSON(data['settings']);
        }
...
ParamountInterac.RequiredProperties = ["credentials", "acceptedCurrencies", "gatewayName", "method"];

/**
 * @member {module:model/ParamountInteracAllOfCredentials} credentials
 */
ParamountInterac.prototype['credentials'] = undefined;

/**
 * @member {module:model/GigadatAllOfSettings} settings
 */
ParamountInterac.prototype['settings'] = undefined;
...
export default ParamountInterac;
