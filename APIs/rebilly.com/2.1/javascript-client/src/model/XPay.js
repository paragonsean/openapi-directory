...
import XPayAllOfCredentials from './XPayAllOfCredentials';

/**
 * The XPay model module.
 * @module model/XPay
 * @version 2.1
 */
class XPay {
    /**
     * Constructs a new <code>XPay</code>.
     * XPay config.
     * @alias module:model/XPay
     ...
     * @param credentials {module:model/XPayAllOfCredentials} 
     */
    constructor(acceptedCurrencies, gatewayName, method, credentials) { 
        ...
        XPay.initialize(this, acceptedCurrencies, gatewayName, method, credentials);
    }
    ...
    /**
     * Constructs a <code>XPay</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/XPay} obj Optional instance to populate.
     * @return {module:model/XPay} The populated <code>XPay</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('credentials')) {
                obj['credentials'] = XPayAllOfCredentials.constructFromObject(data['credentials']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>XPay</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>XPay</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of XPay.RequiredProperties) {
        ...
        if (data['credentials']) { // data not null
          XPayAllOfCredentials.validateJSON(data['credentials']);
        }
...
XPay.RequiredProperties = ["credentials", "acceptedCurrencies", "gatewayName", "method"];

/**
 * @member {module:model/XPayAllOfCredentials} credentials
 */
XPay.prototype['credentials'] = undefined;
