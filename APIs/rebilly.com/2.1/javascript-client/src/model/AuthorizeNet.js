...
import AuthorizeNetAllOfCredentials from './AuthorizeNetAllOfCredentials';
...
/**
 * The AuthorizeNet model module.
 * @module model/AuthorizeNet
 * @version 2.1
 */
class AuthorizeNet {
    /**
     * Constructs a new <code>AuthorizeNet</code>.
     * AuthorizeNet Gateway config.
     * @alias module:model/AuthorizeNet
     ...
     * @param credentials {module:model/AuthorizeNetAllOfCredentials} 
     */
    constructor(acceptedCurrencies, gatewayName, method, credentials) { 
        ...
        AuthorizeNet.initialize(this, acceptedCurrencies, gatewayName, method, credentials);
    }
    ...
    /**
     * Constructs a <code>AuthorizeNet</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AuthorizeNet} obj Optional instance to populate.
     * @return {module:model/AuthorizeNet} The populated <code>AuthorizeNet</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AuthorizeNet();
            GatewayAccount.constructFromObject(data, obj);
            GatewayAccount.constructFromObject(data, obj);

            if (data.hasOwnProperty('credentials')) {
                obj['credentials'] = AuthorizeNetAllOfCredentials.constructFromObject(data['credentials']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>AuthorizeNet</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AuthorizeNet</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of AuthorizeNet.RequiredProperties) {
        ...
        if (data['credentials']) { // data not null
          AuthorizeNetAllOfCredentials.validateJSON(data['credentials']);
        }
...
AuthorizeNet.RequiredProperties = ["credentials", "acceptedCurrencies", "gatewayName", "method"];

/**
 * @member {module:model/AuthorizeNetAllOfCredentials} credentials
 */
AuthorizeNet.prototype['credentials'] = undefined;
