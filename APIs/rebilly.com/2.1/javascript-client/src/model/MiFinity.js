...
import MiFinityAllOfCredentials from './MiFinityAllOfCredentials';
import PaymentCardBrand from './PaymentCardBrand';
import PaymentMethod from './PaymentMethod';

/**
 * The MiFinity model module.
 * @module model/MiFinity
 * @version 2.1
 */
class MiFinity {
    /**
     * Constructs a new <code>MiFinity</code>.
     * MiFinity config.
     * @alias module:model/MiFinity
     ...
     * @param credentials {module:model/MiFinityAllOfCredentials} 
     */
    constructor(acceptedCurrencies, gatewayName, method, credentials) { 
        ...
        MiFinity.initialize(this, acceptedCurrencies, gatewayName, method, credentials);
    }
    ...
    /**
     * Constructs a <code>MiFinity</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/MiFinity} obj Optional instance to populate.
     * @return {module:model/MiFinity} The populated <code>MiFinity</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new MiFinity();
            GatewayAccount.constructFromObject(data, obj);
            GatewayAccount.constructFromObject(data, obj);

            if (data.hasOwnProperty('credentials')) {
                obj['credentials'] = MiFinityAllOfCredentials.constructFromObject(data['credentials']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>MiFinity</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>MiFinity</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of MiFinity.RequiredProperties) {
        ...
        if (data['credentials']) { // data not null
          MiFinityAllOfCredentials.validateJSON(data['credentials']);
        }
...
MiFinity.RequiredProperties = ["credentials", "acceptedCurrencies", "gatewayName", "method"];

/**
 * @member {module:model/MiFinityAllOfCredentials} credentials
 */
MiFinity.prototype['credentials'] = undefined;
