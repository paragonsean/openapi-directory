...
import CitadelAllOfCredentials from './CitadelAllOfCredentials';
...
/**
 * The Citadel model module.
 * @module model/Citadel
 * @version 2.1
 */
class Citadel {
    /**
     * Constructs a new <code>Citadel</code>.
     * Citadel config.
     * @alias module:model/Citadel
     ...
     * @param credentials {module:model/CitadelAllOfCredentials} 
     */
    constructor(acceptedCurrencies, gatewayName, method, credentials) { 
        ...
        Citadel.initialize(this, acceptedCurrencies, gatewayName, method, credentials);
    }
    ...
    /**
     * Constructs a <code>Citadel</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Citadel} obj Optional instance to populate.
     * @return {module:model/Citadel} The populated <code>Citadel</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('credentials')) {
                obj['credentials'] = CitadelAllOfCredentials.constructFromObject(data['credentials']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>Citadel</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Citadel</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of Citadel.RequiredProperties) {
        ...
        if (data['credentials']) { // data not null
          CitadelAllOfCredentials.validateJSON(data['credentials']);
        }
...
Citadel.RequiredProperties = ["credentials", "acceptedCurrencies", "gatewayName", "method"];

/**
 * @member {module:model/CitadelAllOfCredentials} credentials
 */
Citadel.prototype['credentials'] = undefined;
