...
/**
 * The Other model module.
 * @module model/Other
 * @version 2.1
 */
class Other {
    /**
     * Constructs a new <code>Other</code>.
     * Other.
     * @alias module:model/Other
    ...
    /**
     * Constructs a <code>Other</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Other} obj Optional instance to populate.
     * @return {module:model/Other} The populated <code>Other</code> instance.
     */
    ...
    /**
     * Validates the JSON data with respect to <code>Other</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Other</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of Other.RequiredProperties) {
...
Other.RequiredProperties = ["name"];

/**
 * @member {module:model/ThreeDSecureServerName} name
 */
Other.prototype['name'] = undefined;
