...
import ForteAllOfCredentials from './ForteAllOfCredentials';
...
/**
 * The Forte model module.
 * @module model/Forte
 * @version 2.1
 */
class Forte {
    /**
     * Constructs a new <code>Forte</code>.
     * Forte Gateway config.
     * @alias module:model/Forte
     ...
     * @param credentials {module:model/ForteAllOfCredentials} 
     */
    constructor(acceptedCurrencies, gatewayName, method, credentials) { 
        ...
        Forte.initialize(this, acceptedCurrencies, gatewayName, method, credentials);
    }
    ...
    /**
     * Constructs a <code>Forte</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Forte} obj Optional instance to populate.
     * @return {module:model/Forte} The populated <code>Forte</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('credentials')) {
                obj['credentials'] = ForteAllOfCredentials.constructFromObject(data['credentials']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>Forte</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Forte</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of Forte.RequiredProperties) {
        ...
        if (data['credentials']) { // data not null
          ForteAllOfCredentials.validateJSON(data['credentials']);
        }
...
Forte.RequiredProperties = ["credentials", "acceptedCurrencies", "gatewayName", "method"];

/**
 * @member {module:model/ForteAllOfCredentials} credentials
 */
Forte.prototype['credentials'] = undefined;
