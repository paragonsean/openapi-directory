...
import CommonPaymentCard from './CommonPaymentCard';
import ContactObject from './ContactObject';
import PaymentCardAllOfEmbedded from './PaymentCardAllOfEmbedded';
import PaymentCardAllOfLinks from './PaymentCardAllOfLinks';
...
class PaymentCard {
     ...
     * @implements module:model/CommonPaymentCard
     */
    constructor() { 
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            CommonPaymentCard.constructFromObject(data, obj);
            ...
            if (data.hasOwnProperty('_embedded')) {
                obj['_embedded'] = ApiClient.convertToType(data['_embedded'], [PaymentCardAllOfEmbedded]);
            }
            if (data.hasOwnProperty('_links')) {
                obj['_links'] = ApiClient.convertToType(data['_links'], [PaymentCardAllOfLinks]);
            }
            if (data.hasOwnProperty('expirationReminderNumber')) {
                obj['expirationReminderNumber'] = ApiClient.convertToType(data['expirationReminderNumber'], 'Number');
            }
            if (data.hasOwnProperty('expirationReminderTime')) {
                obj['expirationReminderTime'] = ApiClient.convertToType(data['expirationReminderTime'], 'Date');
            }
            if (data.hasOwnProperty('stickyGatewayAccountId')) {
                obj['stickyGatewayAccountId'] = ApiClient.convertToType(data['stickyGatewayAccountId'], 'String');
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        if (data['_embedded']) { // data not null
            ...
            for (const item of data['_embedded']) {
                PaymentCardAllOfEmbedded.validateJSON(item);
            };
        }
        if (data['_links']) { // data not null
            ...
            for (const item of data['_links']) {
                PaymentCardAllOfLinks.validateJSON(item);
            };
        }
        // ensure the json data is a string
        if (data['stickyGatewayAccountId'] && !(typeof data['stickyGatewayAccountId'] === 'string' || data['stickyGatewayAccountId'] instanceof String)) {
            throw new Error("Expected the field `stickyGatewayAccountId` to be a primitive type in the JSON string but got " + data['stickyGatewayAccountId']);
        }
 ...
 */
PaymentCard.prototype['bankCountry'] = undefined;

/**
 * Payment instrument bank name.
 * @member {String} bankName
 */
PaymentCard.prototype['bankName'] = undefined;

/**
 * The billing address.
 * @member {module:model/ContactObject} billingAddress
 */
PaymentCard.prototype['billingAddress'] = undefined;
 ...
 */
PaymentCard.prototype['brand'] = undefined;

/**
 * Payment instrument created time.
 * @member {Date} createdTime
 */
PaymentCard.prototype['createdTime'] = undefined;

/**
 * Custom Fields list as a map `{\"custom field name\": \"custom field value\", ...}`. The format must follow the saved format (see Custom Fields section for the formats). 
 * @member {Object} customFields
 */
PaymentCard.prototype['customFields'] = undefined;

/**
 * The сustomer's ID.
 * @member {String} customerId
 */
PaymentCard.prototype['customerId'] = undefined;

/**
 * Card's cvv (card verification value).
 * @member {String} cvv
 */
PaymentCard.prototype['cvv'] = undefined;

/**
 * Card's expiration month.
 * @member {Number} expMonth
 */
PaymentCard.prototype['expMonth'] = undefined;

/**
 * Card's expiration year.
 * @member {Number} expYear
 */
PaymentCard.prototype['expYear'] = undefined;
 ...
 * @member {String} last4
 */
PaymentCard.prototype['last4'] = undefined;

/**
 * The method of payment instrument.
 * @member {module:model/PaymentCard.MethodEnum} method
 */
PaymentCard.prototype['method'] = undefined;

/**
 * The card PAN (primary account number).
 * @member {String} pan
 */
PaymentCard.prototype['pan'] = undefined;

/**
 * @member {module:model/RiskMetadata} riskMetadata
 */
PaymentCard.prototype['riskMetadata'] = undefined;
 ...
 * @member {module:model/PaymentCard.StatusEnum} status
 */
PaymentCard.prototype['status'] = undefined;

/**
 * Payment instrument updated time.
 * @member {Date} updatedTime
 */
PaymentCard.prototype['updatedTime'] = undefined;

/**
 * Any embedded objects available that are requested by the `expand` querystring parameter.
 * @member {Array.<module:model/PaymentCardAllOfEmbedded>} _embedded
 */
PaymentCard.prototype['_embedded'] = undefined;

/**
 * The links related to resource.
 * @member {Array.<module:model/PaymentCardAllOfLinks>} _links
 */
PaymentCard.prototype['_links'] = undefined;

/**
 * Number of expiration reminder events triggered.
 * @member {Number} expirationReminderNumber
 */
PaymentCard.prototype['expirationReminderNumber'] = undefined;

/**
 * Time expiration reminder event will be triggered.
 * @member {Date} expirationReminderTime
 */
PaymentCard.prototype['expirationReminderTime'] = undefined;

/**
 * Default gateway account ID used for transactions.
 * @member {String} stickyGatewayAccountId
 */
PaymentCard.prototype['stickyGatewayAccountId'] = undefined;


// Implement CommonPaymentCard interface:
/**
 * Payment instrument bank country.
 * @member {String} bankCountry
 */
