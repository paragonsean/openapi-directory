...
import PaymeroAllOfCredentials from './PaymeroAllOfCredentials';
import PaymeroAllOfSettings from './PaymeroAllOfSettings';

/**
 * The Paymero model module.
 * @module model/Paymero
 * @version 2.1
 */
class Paymero {
    /**
     * Constructs a new <code>Paymero</code>.
     * Paymero config.
     * @alias module:model/Paymero
     ...
     * @param credentials {module:model/PaymeroAllOfCredentials} 
     */
    constructor(acceptedCurrencies, gatewayName, method, credentials) { 
        ...
        Paymero.initialize(this, acceptedCurrencies, gatewayName, method, credentials);
    }
    ...
    /**
     * Constructs a <code>Paymero</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Paymero} obj Optional instance to populate.
     * @return {module:model/Paymero} The populated <code>Paymero</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('credentials')) {
                obj['credentials'] = PaymeroAllOfCredentials.constructFromObject(data['credentials']);
            }
            if (data.hasOwnProperty('settings')) {
                obj['settings'] = PaymeroAllOfSettings.constructFromObject(data['settings']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>Paymero</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Paymero</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of Paymero.RequiredProperties) {
        ...
        if (data['credentials']) { // data not null
          PaymeroAllOfCredentials.validateJSON(data['credentials']);
        }
        // validate the optional field `settings`
        if (data['settings']) { // data not null
          PaymeroAllOfSettings.validateJSON(data['settings']);
        }
...
Paymero.RequiredProperties = ["credentials", "acceptedCurrencies", "gatewayName", "method"];

/**
 * @member {module:model/PaymeroAllOfCredentials} credentials
 */
Paymero.prototype['credentials'] = undefined;

/**
 * @member {module:model/PaymeroAllOfSettings} settings
 */
Paymero.prototype['settings'] = undefined;
