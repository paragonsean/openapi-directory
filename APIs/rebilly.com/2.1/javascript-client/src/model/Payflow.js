...
import PayflowAllOfCredentials from './PayflowAllOfCredentials';
import PaymentCardBrand from './PaymentCardBrand';
import PaymentMethod from './PaymentMethod';

/**
 * The Payflow model module.
 * @module model/Payflow
 * @version 2.1
 */
class Payflow {
    /**
     * Constructs a new <code>Payflow</code>.
     * Payflow config.
     * @alias module:model/Payflow
     ...
     * @param credentials {module:model/PayflowAllOfCredentials} 
     */
    constructor(acceptedCurrencies, gatewayName, method, credentials) { 
        ...
        Payflow.initialize(this, acceptedCurrencies, gatewayName, method, credentials);
    }
    ...
    /**
     * Constructs a <code>Payflow</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Payflow} obj Optional instance to populate.
     * @return {module:model/Payflow} The populated <code>Payflow</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('credentials')) {
                obj['credentials'] = PayflowAllOfCredentials.constructFromObject(data['credentials']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>Payflow</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Payflow</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of Payflow.RequiredProperties) {
        ...
        if (data['credentials']) { // data not null
          PayflowAllOfCredentials.validateJSON(data['credentials']);
        }
...
Payflow.RequiredProperties = ["credentials", "acceptedCurrencies", "gatewayName", "method"];

/**
 * @member {module:model/PayflowAllOfCredentials} credentials
 */
Payflow.prototype['credentials'] = undefined;
