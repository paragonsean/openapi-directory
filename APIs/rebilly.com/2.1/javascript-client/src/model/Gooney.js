...
import GooneyAllOfCredentials from './GooneyAllOfCredentials';
import PaymentCardBrand from './PaymentCardBrand';
import PaymentMethod from './PaymentMethod';

/**
 * The Gooney model module.
 * @module model/Gooney
 * @version 2.1
 */
class Gooney {
    /**
     * Constructs a new <code>Gooney</code>.
     * Gooney config.
     * @alias module:model/Gooney
     ...
     * @param credentials {module:model/GooneyAllOfCredentials} 
     */
    constructor(acceptedCurrencies, gatewayName, method, credentials) { 
        ...
        Gooney.initialize(this, acceptedCurrencies, gatewayName, method, credentials);
    }
    ...
    /**
     * Constructs a <code>Gooney</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Gooney} obj Optional instance to populate.
     * @return {module:model/Gooney} The populated <code>Gooney</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('credentials')) {
                obj['credentials'] = GooneyAllOfCredentials.constructFromObject(data['credentials']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>Gooney</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Gooney</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of Gooney.RequiredProperties) {
        ...
        if (data['credentials']) { // data not null
          GooneyAllOfCredentials.validateJSON(data['credentials']);
        }
...
Gooney.RequiredProperties = ["credentials", "acceptedCurrencies", "gatewayName", "method"];

/**
 * @member {module:model/GooneyAllOfCredentials} credentials
 */
Gooney.prototype['credentials'] = undefined;
