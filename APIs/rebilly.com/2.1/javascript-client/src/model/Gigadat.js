...
import GigadatAllOfCredentials from './GigadatAllOfCredentials';
import GigadatAllOfSettings from './GigadatAllOfSettings';
import PaymentCardBrand from './PaymentCardBrand';
import PaymentMethod from './PaymentMethod';

/**
 * The Gigadat model module.
 * @module model/Gigadat
 * @version 2.1
 */
class Gigadat {
    /**
     * Constructs a new <code>Gigadat</code>.
     * Gigadat config.
     * @alias module:model/Gigadat
     ...
     * @param credentials {module:model/GigadatAllOfCredentials} 
     */
    constructor(acceptedCurrencies, gatewayName, method, credentials) { 
        ...
        Gigadat.initialize(this, acceptedCurrencies, gatewayName, method, credentials);
    }
    ...
    /**
     * Constructs a <code>Gigadat</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Gigadat} obj Optional instance to populate.
     * @return {module:model/Gigadat} The populated <code>Gigadat</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('credentials')) {
                obj['credentials'] = GigadatAllOfCredentials.constructFromObject(data['credentials']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>Gigadat</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Gigadat</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of Gigadat.RequiredProperties) {
        ...
        if (data['credentials']) { // data not null
          GigadatAllOfCredentials.validateJSON(data['credentials']);
        }
...
Gigadat.RequiredProperties = ["credentials", "acceptedCurrencies", "gatewayName", "method"];

/**
 * @member {module:model/GigadatAllOfCredentials} credentials
 */
Gigadat.prototype['credentials'] = undefined;

/**
 * @member {module:model/GigadatAllOfSettings} settings
 */
Gigadat.prototype['settings'] = undefined;
