...
import NinjaWalletAllOfCredentials from './NinjaWalletAllOfCredentials';
import PaymentCardBrand from './PaymentCardBrand';
import PaymentMethod from './PaymentMethod';

/**
 * The NinjaWallet model module.
 * @module model/NinjaWallet
 * @version 2.1
 */
class NinjaWallet {
    /**
     * Constructs a new <code>NinjaWallet</code>.
     * NinjaWallet config.
     * @alias module:model/NinjaWallet
     ...
     * @param credentials {module:model/NinjaWalletAllOfCredentials} 
     */
    constructor(acceptedCurrencies, gatewayName, method, credentials) { 
        ...
        NinjaWallet.initialize(this, acceptedCurrencies, gatewayName, method, credentials);
    }
    ...
    /**
     * Constructs a <code>NinjaWallet</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/NinjaWallet} obj Optional instance to populate.
     * @return {module:model/NinjaWallet} The populated <code>NinjaWallet</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new NinjaWallet();
            GatewayAccount.constructFromObject(data, obj);
            GatewayAccount.constructFromObject(data, obj);

            if (data.hasOwnProperty('credentials')) {
                obj['credentials'] = NinjaWalletAllOfCredentials.constructFromObject(data['credentials']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>NinjaWallet</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>NinjaWallet</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of NinjaWallet.RequiredProperties) {
        ...
        if (data['credentials']) { // data not null
          NinjaWalletAllOfCredentials.validateJSON(data['credentials']);
        }
...
NinjaWallet.RequiredProperties = ["credentials", "acceptedCurrencies", "gatewayName", "method"];

/**
 * @member {module:model/NinjaWalletAllOfCredentials} credentials
 */
NinjaWallet.prototype['credentials'] = undefined;
