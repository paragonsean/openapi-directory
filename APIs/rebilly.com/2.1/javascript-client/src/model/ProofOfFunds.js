...
/**
 * The ProofOfFunds model module.
 * @module model/ProofOfFunds
 * @version 2.1
 */
class ProofOfFunds {
    /**
     * Constructs a new <code>ProofOfFunds</code>.
     * @alias module:model/ProofOfFunds
     ...
     * @param status {module:model/ProofOfFunds.StatusEnum} Status of the validation.
    ...
    constructor(documentType, status, customerId) { 
        ...
        ProofOfFunds.initialize(this, documentType, status, customerId);
    }
    ...
    /**
     * Constructs a <code>ProofOfFunds</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ProofOfFunds} obj Optional instance to populate.
     * @return {module:model/ProofOfFunds} The populated <code>ProofOfFunds</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ProofOfFunds();
    ...
    /**
     * Validates the JSON data with respect to <code>ProofOfFunds</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ProofOfFunds</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ProofOfFunds.RequiredProperties) {
...
ProofOfFunds.RequiredProperties = ["documentType", "status", "customerId"];

/**
 * The links related to resource.
 * @member {Array.<module:model/CommonKycDocumentLinksInner>} _links
 */
ProofOfFunds.prototype['_links'] = undefined;

/**
 * Creation date/time.
 * @member {Date} createdTime
 */
ProofOfFunds.prototype['createdTime'] = undefined;

/**
 * Document subtype submitted for validation.
 * @member {module:model/KycDocumentSubtypes} documentSubtype
 */
ProofOfFunds.prototype['documentSubtype'] = undefined;
 ...
 */
ProofOfFunds.prototype['documentType'] = undefined;

/**
 * Linked file object id.
 * @member {String} fileId
 */
ProofOfFunds.prototype['fileId'] = undefined;

/**
 * Linked file object id's.
 * @member {Array.<String>} fileIds
 */
ProofOfFunds.prototype['fileIds'] = undefined;

/**
 * The resource ID. Defaults to UUID v4.
 * @member {String} id
 */
ProofOfFunds.prototype['id'] = undefined;

/**
 * Processing date/time.
 * @member {Date} processedTime
 */
ProofOfFunds.prototype['processedTime'] = undefined;

/**
 * @member {module:model/KycDocumentRejection} rejectionReason
 */
ProofOfFunds.prototype['rejectionReason'] = undefined;

/**
 * KYC request identifier string.
 * @member {String} requestId
 */
ProofOfFunds.prototype['requestId'] = undefined;

/**
 * Status of the validation.
 * @member {module:model/ProofOfFunds.StatusEnum} status
 */
ProofOfFunds.prototype['status'] = undefined;

/**
 * Latest update date/time.
 * @member {Date} updatedTime
 */
ProofOfFunds.prototype['updatedTime'] = undefined;

/**
 * The сustomer's ID.
 * @member {String} customerId
 */
ProofOfFunds.prototype['customerId'] = undefined;

/**
 * The level of strictness for the document matches.
 * @member {Number} matchLevel
 */
ProofOfFunds.prototype['matchLevel'] = undefined;

/**
 * Reviewer notes.
 * @member {String} notes
 */
ProofOfFunds.prototype['notes'] = undefined;

/**
 * Reason for uploading.
 * @member {String} reason
 */
ProofOfFunds.prototype['reason'] = undefined;

/**
 * Date and time of manual review.
 * @member {Date} reviewTime
 */
ProofOfFunds.prototype['reviewTime'] = undefined;

/**
 * Reviewer's user ID.
 * @member {String} reviewerId
 */
ProofOfFunds.prototype['reviewerId'] = undefined;

/**
 * Reviewer's first and last name.
 * @member {String} reviewerName
 */
ProofOfFunds.prototype['reviewerName'] = undefined;
