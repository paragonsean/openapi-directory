...
import LPGAllOfCredentials from './LPGAllOfCredentials';
import PaymentCardBrand from './PaymentCardBrand';
import PaymentMethod from './PaymentMethod';

/**
 * The LPG model module.
 * @module model/LPG
 * @version 2.1
 */
class LPG {
    /**
     * Constructs a new <code>LPG</code>.
     * LPG config.
     * @alias module:model/LPG
     ...
     * @param credentials {module:model/LPGAllOfCredentials} 
     */
    constructor(acceptedCurrencies, gatewayName, method, credentials) { 
        ...
        LPG.initialize(this, acceptedCurrencies, gatewayName, method, credentials);
    }
    ...
    /**
     * Constructs a <code>LPG</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/LPG} obj Optional instance to populate.
     * @return {module:model/LPG} The populated <code>LPG</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('credentials')) {
                obj['credentials'] = LPGAllOfCredentials.constructFromObject(data['credentials']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>LPG</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>LPG</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of LPG.RequiredProperties) {
        ...
        if (data['credentials']) { // data not null
          LPGAllOfCredentials.validateJSON(data['credentials']);
        }
...
LPG.RequiredProperties = ["credentials", "acceptedCurrencies", "gatewayName", "method"];

/**
 * @member {module:model/LPGAllOfCredentials} credentials
 */
LPG.prototype['credentials'] = undefined;
