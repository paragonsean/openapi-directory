...
import AsiaPaymentGatewayAllOfCredentials from './AsiaPaymentGatewayAllOfCredentials';
...
/**
 * The AsiaPaymentGateway model module.
 * @module model/AsiaPaymentGateway
 * @version 2.1
 */
class AsiaPaymentGateway {
    /**
     * Constructs a new <code>AsiaPaymentGateway</code>.
     * AsiaPaymentGateway config.
     * @alias module:model/AsiaPaymentGateway
     ...
     * @param credentials {module:model/AsiaPaymentGatewayAllOfCredentials} 
     */
    constructor(acceptedCurrencies, gatewayName, method, credentials) { 
        ...
        AsiaPaymentGateway.initialize(this, acceptedCurrencies, gatewayName, method, credentials);
    }
    ...
    /**
     * Constructs a <code>AsiaPaymentGateway</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AsiaPaymentGateway} obj Optional instance to populate.
     * @return {module:model/AsiaPaymentGateway} The populated <code>AsiaPaymentGateway</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AsiaPaymentGateway();
            GatewayAccount.constructFromObject(data, obj);
            GatewayAccount.constructFromObject(data, obj);

            if (data.hasOwnProperty('credentials')) {
                obj['credentials'] = AsiaPaymentGatewayAllOfCredentials.constructFromObject(data['credentials']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>AsiaPaymentGateway</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AsiaPaymentGateway</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of AsiaPaymentGateway.RequiredProperties) {
        ...
        if (data['credentials']) { // data not null
          AsiaPaymentGatewayAllOfCredentials.validateJSON(data['credentials']);
        }
...
AsiaPaymentGateway.RequiredProperties = ["credentials", "acceptedCurrencies", "gatewayName", "method"];

/**
 * @member {module:model/AsiaPaymentGatewayAllOfCredentials} credentials
 */
AsiaPaymentGateway.prototype['credentials'] = undefined;
...
export default AsiaPaymentGateway;
