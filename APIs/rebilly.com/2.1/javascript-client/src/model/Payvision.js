...
import PayvisionAllOfCredentials from './PayvisionAllOfCredentials';
import PayvisionAllOfSettings from './PayvisionAllOfSettings';

/**
 * The Payvision model module.
 * @module model/Payvision
 * @version 2.1
 */
class Payvision {
    /**
     * Constructs a new <code>Payvision</code>.
     * Payvision Gateway config.
     * @alias module:model/Payvision
     ...
     * @param credentials {module:model/PayvisionAllOfCredentials} 
     */
    constructor(acceptedCurrencies, gatewayName, method, credentials) { 
        ...
        Payvision.initialize(this, acceptedCurrencies, gatewayName, method, credentials);
    }
    ...
    /**
     * Constructs a <code>Payvision</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Payvision} obj Optional instance to populate.
     * @return {module:model/Payvision} The populated <code>Payvision</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new Payvision();
            GatewayAccount.constructFromObject(data, obj);
            GatewayAccount.constructFromObject(data, obj);

            if (data.hasOwnProperty('credentials')) {
                obj['credentials'] = PayvisionAllOfCredentials.constructFromObject(data['credentials']);
            }
            if (data.hasOwnProperty('settings')) {
                obj['settings'] = PayvisionAllOfSettings.constructFromObject(data['settings']);
            }
            if (data.hasOwnProperty('threeDSecureServer')) {
                obj['threeDSecureServer'] = Payvision3dsServers.constructFromObject(data['threeDSecureServer']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>Payvision</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Payvision</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of Payvision.RequiredProperties) {
        ...
        if (data['credentials']) { // data not null
          PayvisionAllOfCredentials.validateJSON(data['credentials']);
        }
        // validate the optional field `settings`
        if (data['settings']) { // data not null
          PayvisionAllOfSettings.validateJSON(data['settings']);
        }
        // validate the optional field `threeDSecureServer`
        if (data['threeDSecureServer']) { // data not null
          Payvision3dsServers.validateJSON(data['threeDSecureServer']);
        }
...
Payvision.RequiredProperties = ["credentials", "acceptedCurrencies", "gatewayName", "method"];

/**
 * @member {module:model/PayvisionAllOfCredentials} credentials
 */
Payvision.prototype['credentials'] = undefined;

/**
 * @member {module:model/PayvisionAllOfSettings} settings
 */
Payvision.prototype['settings'] = undefined;

/**
 * @member {module:model/Payvision3dsServers} threeDSecureServer
 */
Payvision.prototype['threeDSecureServer'] = undefined;
