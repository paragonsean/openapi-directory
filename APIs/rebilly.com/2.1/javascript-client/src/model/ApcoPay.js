...
import ApcoPayAllOfCredentials from './ApcoPayAllOfCredentials';
import ApcoPayAllOfSettings from './ApcoPayAllOfSettings';
...
/**
 * The ApcoPay model module.
 * @module model/ApcoPay
 * @version 2.1
 */
class ApcoPay {
    /**
     * Constructs a new <code>ApcoPay</code>.
     * ApcoPay config.
     * @alias module:model/ApcoPay
     ...
     * @param credentials {module:model/ApcoPayAllOfCredentials} 
     */
    constructor(acceptedCurrencies, gatewayName, method, credentials) { 
        ...
        ApcoPay.initialize(this, acceptedCurrencies, gatewayName, method, credentials);
    }
    ...
    /**
     * Constructs a <code>ApcoPay</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ApcoPay} obj Optional instance to populate.
     * @return {module:model/ApcoPay} The populated <code>ApcoPay</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('credentials')) {
                obj['credentials'] = ApcoPayAllOfCredentials.constructFromObject(data['credentials']);
            }
            if (data.hasOwnProperty('settings')) {
                obj['settings'] = ApcoPayAllOfSettings.constructFromObject(data['settings']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ApcoPay</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ApcoPay</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ApcoPay.RequiredProperties) {
        ...
        if (data['credentials']) { // data not null
          ApcoPayAllOfCredentials.validateJSON(data['credentials']);
        }
        // validate the optional field `settings`
        if (data['settings']) { // data not null
          ApcoPayAllOfSettings.validateJSON(data['settings']);
        }
...
ApcoPay.RequiredProperties = ["credentials", "acceptedCurrencies", "gatewayName", "method"];

/**
 * @member {module:model/ApcoPayAllOfCredentials} credentials
 */
ApcoPay.prototype['credentials'] = undefined;

/**
 * @member {module:model/ApcoPayAllOfSettings} settings
 */
ApcoPay.prototype['settings'] = undefined;
