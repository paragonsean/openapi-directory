...
import WorldlineAtosFrankfurtAllOfCredentials from './WorldlineAtosFrankfurtAllOfCredentials';
import WorldlineAtosFrankfurtAllOfSettings from './WorldlineAtosFrankfurtAllOfSettings';

/**
 * The WorldlineAtosFrankfurt model module.
 * @module model/WorldlineAtosFrankfurt
 * @version 2.1
 */
class WorldlineAtosFrankfurt {
    /**
     * Constructs a new <code>WorldlineAtosFrankfurt</code>.
     * WorldlineAtosFrankfurt Gateway config.
     * @alias module:model/WorldlineAtosFrankfurt
     ...
     * @param credentials {module:model/WorldlineAtosFrankfurtAllOfCredentials} 
     * @param settings {module:model/WorldlineAtosFrankfurtAllOfSettings} 
     */
    constructor(acceptedCurrencies, gatewayName, method, credentials, settings) { 
        ...
        WorldlineAtosFrankfurt.initialize(this, acceptedCurrencies, gatewayName, method, credentials, settings);
    }
    ...
    /**
     * Constructs a <code>WorldlineAtosFrankfurt</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/WorldlineAtosFrankfurt} obj Optional instance to populate.
     * @return {module:model/WorldlineAtosFrankfurt} The populated <code>WorldlineAtosFrankfurt</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new WorldlineAtosFrankfurt();
            GatewayAccount.constructFromObject(data, obj);
            GatewayAccount.constructFromObject(data, obj);

            if (data.hasOwnProperty('credentials')) {
                obj['credentials'] = WorldlineAtosFrankfurtAllOfCredentials.constructFromObject(data['credentials']);
            }
            if (data.hasOwnProperty('settings')) {
                obj['settings'] = WorldlineAtosFrankfurtAllOfSettings.constructFromObject(data['settings']);
            }
            if (data.hasOwnProperty('threeDSecureServer')) {
                obj['threeDSecureServer'] = WorldlineAtosFrankfurt3dsServers.constructFromObject(data['threeDSecureServer']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>WorldlineAtosFrankfurt</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>WorldlineAtosFrankfurt</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of WorldlineAtosFrankfurt.RequiredProperties) {
        ...
        if (data['credentials']) { // data not null
          WorldlineAtosFrankfurtAllOfCredentials.validateJSON(data['credentials']);
        }
        // validate the optional field `settings`
        if (data['settings']) { // data not null
          WorldlineAtosFrankfurtAllOfSettings.validateJSON(data['settings']);
        }
        // validate the optional field `threeDSecureServer`
        if (data['threeDSecureServer']) { // data not null
          WorldlineAtosFrankfurt3dsServers.validateJSON(data['threeDSecureServer']);
        }
...
WorldlineAtosFrankfurt.RequiredProperties = ["credentials", "settings", "acceptedCurrencies", "gatewayName", "method"];

/**
 * @member {module:model/WorldlineAtosFrankfurtAllOfCredentials} credentials
 */
WorldlineAtosFrankfurt.prototype['credentials'] = undefined;

/**
 * @member {module:model/WorldlineAtosFrankfurtAllOfSettings} settings
 */
WorldlineAtosFrankfurt.prototype['settings'] = undefined;

/**
 * @member {module:model/WorldlineAtosFrankfurt3dsServers} threeDSecureServer
 */
WorldlineAtosFrankfurt.prototype['threeDSecureServer'] = undefined;
...
export default WorldlineAtosFrankfurt;
