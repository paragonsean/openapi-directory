...
import IpayOptionsAllOfCredentials from './IpayOptionsAllOfCredentials';
import IpayOptionsAllOfSettings from './IpayOptionsAllOfSettings';
import PaymentCardBrand from './PaymentCardBrand';
import PaymentMethod from './PaymentMethod';

/**
 * The IpayOptions model module.
 * @module model/IpayOptions
 * @version 2.1
 */
class IpayOptions {
    /**
     * Constructs a new <code>IpayOptions</code>.
     * Ipay Options config.
     * @alias module:model/IpayOptions
     ...
     * @param credentials {module:model/IpayOptionsAllOfCredentials} 
     * @param settings {module:model/IpayOptionsAllOfSettings} 
     */
    constructor(acceptedCurrencies, gatewayName, method, credentials, settings) { 
        ...
        IpayOptions.initialize(this, acceptedCurrencies, gatewayName, method, credentials, settings);
    }
    ...
    /**
     * Constructs a <code>IpayOptions</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/IpayOptions} obj Optional instance to populate.
     * @return {module:model/IpayOptions} The populated <code>IpayOptions</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new IpayOptions();
            GatewayAccount.constructFromObject(data, obj);
            GatewayAccount.constructFromObject(data, obj);

            if (data.hasOwnProperty('credentials')) {
                obj['credentials'] = IpayOptionsAllOfCredentials.constructFromObject(data['credentials']);
            }
            if (data.hasOwnProperty('settings')) {
                obj['settings'] = IpayOptionsAllOfSettings.constructFromObject(data['settings']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>IpayOptions</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>IpayOptions</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of IpayOptions.RequiredProperties) {
        ...
        if (data['credentials']) { // data not null
          IpayOptionsAllOfCredentials.validateJSON(data['credentials']);
        }
        // validate the optional field `settings`
        if (data['settings']) { // data not null
          IpayOptionsAllOfSettings.validateJSON(data['settings']);
        }
...
IpayOptions.RequiredProperties = ["credentials", "settings", "acceptedCurrencies", "gatewayName", "method"];

/**
 * @member {module:model/IpayOptionsAllOfCredentials} credentials
 */
IpayOptions.prototype['credentials'] = undefined;

/**
 * @member {module:model/IpayOptionsAllOfSettings} settings
 */
IpayOptions.prototype['settings'] = undefined;
