...
import ToditoCashAllOfCredentials from './ToditoCashAllOfCredentials';

/**
 * The ToditoCash model module.
 * @module model/ToditoCash
 * @version 2.1
 */
class ToditoCash {
    /**
     * Constructs a new <code>ToditoCash</code>.
     * ToditoCash config.
     * @alias module:model/ToditoCash
     ...
     * @param credentials {module:model/ToditoCashAllOfCredentials} 
     */
    constructor(acceptedCurrencies, gatewayName, method, credentials) { 
        ...
        ToditoCash.initialize(this, acceptedCurrencies, gatewayName, method, credentials);
    }
    ...
    /**
     * Constructs a <code>ToditoCash</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ToditoCash} obj Optional instance to populate.
     * @return {module:model/ToditoCash} The populated <code>ToditoCash</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ToditoCash();
            GatewayAccount.constructFromObject(data, obj);
            GatewayAccount.constructFromObject(data, obj);

            if (data.hasOwnProperty('credentials')) {
                obj['credentials'] = ToditoCashAllOfCredentials.constructFromObject(data['credentials']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ToditoCash</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ToditoCash</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ToditoCash.RequiredProperties) {
        ...
        if (data['credentials']) { // data not null
          ToditoCashAllOfCredentials.validateJSON(data['credentials']);
        }
...
ToditoCash.RequiredProperties = ["credentials", "acceptedCurrencies", "gatewayName", "method"];

/**
 * @member {module:model/ToditoCashAllOfCredentials} credentials
 */
ToditoCash.prototype['credentials'] = undefined;
