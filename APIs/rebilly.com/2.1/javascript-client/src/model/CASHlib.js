...
import CASHlibAllOfCredentials from './CASHlibAllOfCredentials';
...
/**
 * The CASHlib model module.
 * @module model/CASHlib
 * @version 2.1
 */
class CASHlib {
    /**
     * Constructs a new <code>CASHlib</code>.
     * CASHlib config.
     * @alias module:model/CASHlib
     ...
     * @param credentials {module:model/CASHlibAllOfCredentials} 
     */
    constructor(acceptedCurrencies, gatewayName, method, credentials) { 
        ...
        CASHlib.initialize(this, acceptedCurrencies, gatewayName, method, credentials);
    }
    ...
    /**
     * Constructs a <code>CASHlib</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CASHlib} obj Optional instance to populate.
     * @return {module:model/CASHlib} The populated <code>CASHlib</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('credentials')) {
                obj['credentials'] = CASHlibAllOfCredentials.constructFromObject(data['credentials']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>CASHlib</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CASHlib</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CASHlib.RequiredProperties) {
        ...
        if (data['credentials']) { // data not null
          CASHlibAllOfCredentials.validateJSON(data['credentials']);
        }
...
CASHlib.RequiredProperties = ["credentials", "acceptedCurrencies", "gatewayName", "method"];

/**
 * @member {module:model/CASHlibAllOfCredentials} credentials
 */
CASHlib.prototype['credentials'] = undefined;
