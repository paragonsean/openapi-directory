...
import AdyenAllOfCredentials from './AdyenAllOfCredentials';
import AdyenAllOfSettings from './AdyenAllOfSettings';
...
/**
 * The Adyen model module.
 * @module model/Adyen
 * @version 2.1
 */
class Adyen {
    /**
     * Constructs a new <code>Adyen</code>.
     * Adyen config.
     * @alias module:model/Adyen
     ...
     * @param credentials {module:model/AdyenAllOfCredentials} 
     * @param settings {module:model/AdyenAllOfSettings} 
     */
    constructor(acceptedCurrencies, gatewayName, method, credentials, settings) { 
        ...
        Adyen.initialize(this, acceptedCurrencies, gatewayName, method, credentials, settings);
    }
    ...
    /**
     * Constructs a <code>Adyen</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Adyen} obj Optional instance to populate.
     * @return {module:model/Adyen} The populated <code>Adyen</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('credentials')) {
                obj['credentials'] = AdyenAllOfCredentials.constructFromObject(data['credentials']);
            }
            if (data.hasOwnProperty('settings')) {
                obj['settings'] = AdyenAllOfSettings.constructFromObject(data['settings']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>Adyen</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Adyen</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of Adyen.RequiredProperties) {
        ...
        if (data['credentials']) { // data not null
          AdyenAllOfCredentials.validateJSON(data['credentials']);
        }
        // validate the optional field `settings`
        if (data['settings']) { // data not null
          AdyenAllOfSettings.validateJSON(data['settings']);
        }
...
Adyen.RequiredProperties = ["credentials", "settings", "acceptedCurrencies", "gatewayName", "method"];

/**
 * @member {module:model/AdyenAllOfCredentials} credentials
 */
Adyen.prototype['credentials'] = undefined;

/**
 * @member {module:model/AdyenAllOfSettings} settings
 */
Adyen.prototype['settings'] = undefined;
