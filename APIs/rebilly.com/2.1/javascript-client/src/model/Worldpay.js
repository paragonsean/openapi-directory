...
import WorldpayAllOfCredentials from './WorldpayAllOfCredentials';
import WorldpayAllOfSettings from './WorldpayAllOfSettings';

/**
 * The Worldpay model module.
 * @module model/Worldpay
 * @version 2.1
 */
class Worldpay {
    /**
     * Constructs a new <code>Worldpay</code>.
     * Worldpay Gateway config.
     * @alias module:model/Worldpay
     ...
     * @param credentials {module:model/WorldpayAllOfCredentials} 
     */
    constructor(acceptedCurrencies, gatewayName, method, credentials) { 
        ...
        Worldpay.initialize(this, acceptedCurrencies, gatewayName, method, credentials);
    }
    ...
    /**
     * Constructs a <code>Worldpay</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Worldpay} obj Optional instance to populate.
     * @return {module:model/Worldpay} The populated <code>Worldpay</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new Worldpay();
            GatewayAccount.constructFromObject(data, obj);
            GatewayAccount.constructFromObject(data, obj);

            if (data.hasOwnProperty('credentials')) {
                obj['credentials'] = WorldpayAllOfCredentials.constructFromObject(data['credentials']);
            }
            if (data.hasOwnProperty('settings')) {
                obj['settings'] = WorldpayAllOfSettings.constructFromObject(data['settings']);
            }
            if (data.hasOwnProperty('threeDSecureServer')) {
                obj['threeDSecureServer'] = Worldpay3dsServers.constructFromObject(data['threeDSecureServer']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>Worldpay</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Worldpay</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of Worldpay.RequiredProperties) {
        ...
        if (data['credentials']) { // data not null
          WorldpayAllOfCredentials.validateJSON(data['credentials']);
        }
        // validate the optional field `settings`
        if (data['settings']) { // data not null
          WorldpayAllOfSettings.validateJSON(data['settings']);
        }
        // validate the optional field `threeDSecureServer`
        if (data['threeDSecureServer']) { // data not null
          Worldpay3dsServers.validateJSON(data['threeDSecureServer']);
        }
...
Worldpay.RequiredProperties = ["credentials", "acceptedCurrencies", "gatewayName", "method"];

/**
 * @member {module:model/WorldpayAllOfCredentials} credentials
 */
Worldpay.prototype['credentials'] = undefined;

/**
 * @member {module:model/WorldpayAllOfSettings} settings
 */
Worldpay.prototype['settings'] = undefined;

/**
 * @member {module:model/Worldpay3dsServers} threeDSecureServer
 */
Worldpay.prototype['threeDSecureServer'] = undefined;
