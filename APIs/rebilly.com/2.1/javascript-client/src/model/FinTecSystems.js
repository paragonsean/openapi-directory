...
import FinTecSystemsAllOfCredentials from './FinTecSystemsAllOfCredentials';
import FinTecSystemsAllOfSettings from './FinTecSystemsAllOfSettings';
...
/**
 * The FinTecSystems model module.
 * @module model/FinTecSystems
 * @version 2.1
 */
class FinTecSystems {
    /**
     * Constructs a new <code>FinTecSystems</code>.
     * FinTecSystems config.
     * @alias module:model/FinTecSystems
     ...
     * @param credentials {module:model/FinTecSystemsAllOfCredentials} 
     * @param settings {module:model/FinTecSystemsAllOfSettings} 
     */
    constructor(acceptedCurrencies, gatewayName, method, credentials, settings) { 
        GatewayAccount.initialize(this, acceptedCurrencies, gatewayName, method);
        FinTecSystems.initialize(this, acceptedCurrencies, gatewayName, method, credentials, settings);
    }
     ...
     */
    static initialize(obj, acceptedCurrencies, gatewayName, method, credentials, settings) { 
        obj['credentials'] = credentials;
        obj['settings'] = settings;
    }

    /**
     * Constructs a <code>FinTecSystems</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/FinTecSystems} obj Optional instance to populate.
     * @return {module:model/FinTecSystems} The populated <code>FinTecSystems</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new FinTecSystems();
            GatewayAccount.constructFromObject(data, obj);
            GatewayAccount.constructFromObject(data, obj);

            if (data.hasOwnProperty('credentials')) {
                obj['credentials'] = FinTecSystemsAllOfCredentials.constructFromObject(data['credentials']);
            }
            if (data.hasOwnProperty('settings')) {
                obj['settings'] = FinTecSystemsAllOfSettings.constructFromObject(data['settings']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>FinTecSystems</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>FinTecSystems</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of FinTecSystems.RequiredProperties) {
        ...
        if (data['credentials']) { // data not null
          FinTecSystemsAllOfCredentials.validateJSON(data['credentials']);
        }
        // validate the optional field `settings`
        if (data['settings']) { // data not null
          FinTecSystemsAllOfSettings.validateJSON(data['settings']);
        }
...
FinTecSystems.RequiredProperties = ["credentials", "settings", "acceptedCurrencies", "gatewayName", "method"];

/**
 * @member {module:model/FinTecSystemsAllOfCredentials} credentials
 */
FinTecSystems.prototype['credentials'] = undefined;

/**
 * @member {module:model/FinTecSystemsAllOfSettings} settings
 */
FinTecSystems.prototype['settings'] = undefined;
