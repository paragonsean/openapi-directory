...
import ICEPAYAllOfCredentials from './ICEPAYAllOfCredentials';
import PaymentCardBrand from './PaymentCardBrand';
import PaymentMethod from './PaymentMethod';

/**
 * The ICEPAY model module.
 * @module model/ICEPAY
 * @version 2.1
 */
class ICEPAY {
    /**
     * Constructs a new <code>ICEPAY</code>.
     * ICEPAY config.
     * @alias module:model/ICEPAY
     ...
     * @param credentials {module:model/ICEPAYAllOfCredentials} 
     */
    constructor(acceptedCurrencies, gatewayName, method, credentials) { 
        ...
        ICEPAY.initialize(this, acceptedCurrencies, gatewayName, method, credentials);
    }
    ...
    /**
     * Constructs a <code>ICEPAY</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ICEPAY} obj Optional instance to populate.
     * @return {module:model/ICEPAY} The populated <code>ICEPAY</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('credentials')) {
                obj['credentials'] = ICEPAYAllOfCredentials.constructFromObject(data['credentials']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ICEPAY</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ICEPAY</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ICEPAY.RequiredProperties) {
        ...
        if (data['credentials']) { // data not null
          ICEPAYAllOfCredentials.validateJSON(data['credentials']);
        }
...
ICEPAY.RequiredProperties = ["credentials", "acceptedCurrencies", "gatewayName", "method"];

/**
 * @member {module:model/ICEPAYAllOfCredentials} credentials
 */
ICEPAY.prototype['credentials'] = undefined;
