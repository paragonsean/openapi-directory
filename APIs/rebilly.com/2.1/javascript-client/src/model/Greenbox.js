...
import GreenboxAllOfCredentials from './GreenboxAllOfCredentials';
import PaymentCardBrand from './PaymentCardBrand';
import PaymentMethod from './PaymentMethod';

/**
 * The Greenbox model module.
 * @module model/Greenbox
 * @version 2.1
 */
class Greenbox {
    /**
     * Constructs a new <code>Greenbox</code>.
     * Greenbox config.
     * @alias module:model/Greenbox
     ...
     * @param credentials {module:model/GreenboxAllOfCredentials} 
     */
    constructor(acceptedCurrencies, gatewayName, method, credentials) { 
        ...
        Greenbox.initialize(this, acceptedCurrencies, gatewayName, method, credentials);
    }
    ...
    /**
     * Constructs a <code>Greenbox</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Greenbox} obj Optional instance to populate.
     * @return {module:model/Greenbox} The populated <code>Greenbox</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new Greenbox();
            GatewayAccount.constructFromObject(data, obj);
            GatewayAccount.constructFromObject(data, obj);

            if (data.hasOwnProperty('credentials')) {
                obj['credentials'] = GreenboxAllOfCredentials.constructFromObject(data['credentials']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>Greenbox</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Greenbox</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of Greenbox.RequiredProperties) {
        ...
        if (data['credentials']) { // data not null
          GreenboxAllOfCredentials.validateJSON(data['credentials']);
        }
...
Greenbox.RequiredProperties = ["credentials", "acceptedCurrencies", "gatewayName", "method"];

/**
 * @member {module:model/GreenboxAllOfCredentials} credentials
 */
Greenbox.prototype['credentials'] = undefined;
