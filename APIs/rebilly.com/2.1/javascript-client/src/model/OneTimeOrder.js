...
import CommonOneTimeOrder from './CommonOneTimeOrder';
...
/**
 * The OneTimeOrder model module.
 * @module model/OneTimeOrder
 * @version 2.1
 */
class OneTimeOrder {
    /**
     * Constructs a new <code>OneTimeOrder</code>.
     * @alias module:model/OneTimeOrder
     * @implements module:model/CommonOneTimeOrder
     * @implements module:model/SubscriptionMetadata
     * @param items {Array.<module:model/CommonSubscriptionItemsInner>} 
     * @param orderType {module:model/OneTimeOrder.OrderTypeEnum} Specifies the type of order, a subscription or a one-time purchase. 
    ...
    constructor(items, orderType, websiteId, customerId) { 
        CommonOneTimeOrder.initialize(this);SubscriptionMetadata.initialize(this);
        OneTimeOrder.initialize(this, items, orderType, websiteId, customerId);
    }
    ...
    /**
     * Constructs a <code>OneTimeOrder</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/OneTimeOrder} obj Optional instance to populate.
     * @return {module:model/OneTimeOrder} The populated <code>OneTimeOrder</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new OneTimeOrder();
            CommonOneTimeOrder.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>OneTimeOrder</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>OneTimeOrder</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of OneTimeOrder.RequiredProperties) {
...
OneTimeOrder.RequiredProperties = ["items", "orderType", "websiteId", "customerId"];

/**
 * Order activation time.
 * @member {Date} activationTime
 */
OneTimeOrder.prototype['activationTime'] = undefined;

/**
 * Order billing address.
 * @member {module:model/ContactObject} billingAddress
 */
OneTimeOrder.prototype['billingAddress'] = undefined;
 ...
 * @member {module:model/OneTimeOrder.BillingStatusEnum} billingStatus
 */
OneTimeOrder.prototype['billingStatus'] = undefined;
 ...
 */
OneTimeOrder.prototype['revision'] = undefined;
 ...
 */
OneTimeOrder.prototype['riskMetadata'] = undefined;

/**
 * Order updated time.
 * @member {Date} updatedTime
 */
OneTimeOrder.prototype['updatedTime'] = undefined;

/**
 * The customer identifier string.
 * @member {String} customerId
 */
OneTimeOrder.prototype['customerId'] = undefined;


// Implement CommonOneTimeOrder interface:
/**
 * Order activation time.
 * @member {Date} activationTime
 */
 ...
 * @readonly
 */
OneTimeOrder['BillingStatusEnum'] = {
