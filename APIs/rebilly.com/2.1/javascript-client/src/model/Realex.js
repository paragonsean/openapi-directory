...
import RealexAllOfCredentials from './RealexAllOfCredentials';

/**
 * The Realex model module.
 * @module model/Realex
 * @version 2.1
 */
class Realex {
    /**
     * Constructs a new <code>Realex</code>.
     * Realex Gateway config.
     * @alias module:model/Realex
     ...
     * @param credentials {module:model/RealexAllOfCredentials} 
     */
    constructor(acceptedCurrencies, gatewayName, method, credentials) { 
        ...
        Realex.initialize(this, acceptedCurrencies, gatewayName, method, credentials);
    }
    ...
    /**
     * Constructs a <code>Realex</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Realex} obj Optional instance to populate.
     * @return {module:model/Realex} The populated <code>Realex</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('credentials')) {
                obj['credentials'] = RealexAllOfCredentials.constructFromObject(data['credentials']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>Realex</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Realex</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of Realex.RequiredProperties) {
        ...
        if (data['credentials']) { // data not null
          RealexAllOfCredentials.validateJSON(data['credentials']);
        }
...
Realex.RequiredProperties = ["credentials", "acceptedCurrencies", "gatewayName", "method"];

/**
 * @member {module:model/RealexAllOfCredentials} credentials
 */
Realex.prototype['credentials'] = undefined;
