...
import AstroPayCardAllOfCredentials from './AstroPayCardAllOfCredentials';
import AstroPayCardAllOfSettings from './AstroPayCardAllOfSettings';
...
/**
 * The AstroPayCard model module.
 * @module model/AstroPayCard
 * @version 2.1
 */
class AstroPayCard {
    /**
     * Constructs a new <code>AstroPayCard</code>.
     * AstroPay Card config.
     * @alias module:model/AstroPayCard
     ...
     * @param credentials {module:model/AstroPayCardAllOfCredentials} 
     */
    constructor(acceptedCurrencies, gatewayName, method, credentials) { 
        ...
        AstroPayCard.initialize(this, acceptedCurrencies, gatewayName, method, credentials);
    }
    ...
    /**
     * Constructs a <code>AstroPayCard</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AstroPayCard} obj Optional instance to populate.
     * @return {module:model/AstroPayCard} The populated <code>AstroPayCard</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AstroPayCard();
            GatewayAccount.constructFromObject(data, obj);
            GatewayAccount.constructFromObject(data, obj);

            if (data.hasOwnProperty('credentials')) {
                obj['credentials'] = AstroPayCardAllOfCredentials.constructFromObject(data['credentials']);
            }
            if (data.hasOwnProperty('settings')) {
                obj['settings'] = AstroPayCardAllOfSettings.constructFromObject(data['settings']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>AstroPayCard</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AstroPayCard</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of AstroPayCard.RequiredProperties) {
        ...
        if (data['credentials']) { // data not null
          AstroPayCardAllOfCredentials.validateJSON(data['credentials']);
        }
        // validate the optional field `settings`
        if (data['settings']) { // data not null
          AstroPayCardAllOfSettings.validateJSON(data['settings']);
        }
...
AstroPayCard.RequiredProperties = ["credentials", "acceptedCurrencies", "gatewayName", "method"];

/**
 * @member {module:model/AstroPayCardAllOfCredentials} credentials
 */
AstroPayCard.prototype['credentials'] = undefined;

/**
 * @member {module:model/AstroPayCardAllOfSettings} settings
 */
AstroPayCard.prototype['settings'] = undefined;
