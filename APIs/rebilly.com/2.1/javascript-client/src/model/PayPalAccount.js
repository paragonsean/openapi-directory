...
import CommonPayPalAccount from './CommonPayPalAccount';
import ContactObject from './ContactObject';
import PayPalAccountAllOfEmbedded from './PayPalAccountAllOfEmbedded';
import PayPalAccountAllOfLinks from './PayPalAccountAllOfLinks';
import RiskMetadata from './RiskMetadata';

/**
 * The PayPalAccount model module.
 * @module model/PayPalAccount
 * @version 2.1
 */
class PayPalAccount {
    /**
     * Constructs a new <code>PayPalAccount</code>.
     * @alias module:model/PayPalAccount
     * @implements module:model/CommonPayPalAccount
     * @param billingAddress {module:model/ContactObject} The billing address.
     * @param customerId {String} The customer's ID.
     * @param method {module:model/PayPalAccount.MethodEnum} The method of payment instrument.
     */
    constructor(billingAddress, customerId, method) { 
        CommonPayPalAccount.initialize(this, billingAddress, customerId, method);
        PayPalAccount.initialize(this, billingAddress, customerId, method);
    }
    ...
    /**
     * Constructs a <code>PayPalAccount</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PayPalAccount} obj Optional instance to populate.
     * @return {module:model/PayPalAccount} The populated <code>PayPalAccount</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PayPalAccount();
            CommonPayPalAccount.constructFromObject(data, obj);
            ...
            if (data.hasOwnProperty('_embedded')) {
                obj['_embedded'] = ApiClient.convertToType(data['_embedded'], [PayPalAccountAllOfEmbedded]);
            }
            if (data.hasOwnProperty('_links')) {
                obj['_links'] = ApiClient.convertToType(data['_links'], [PayPalAccountAllOfLinks]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>PayPalAccount</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PayPalAccount</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of PayPalAccount.RequiredProperties) {
        ...
        if (data['_embedded']) { // data not null
            ...
            for (const item of data['_embedded']) {
                PayPalAccountAllOfEmbedded.validateJSON(item);
            };
        }
        if (data['_links']) { // data not null
            ...
            for (const item of data['_links']) {
                PayPalAccountAllOfLinks.validateJSON(item);
            };
        }
...
PayPalAccount.RequiredProperties = ["billingAddress", "customerId", "method"];

/**
 * The billing address.
 * @member {module:model/ContactObject} billingAddress
 */
PayPalAccount.prototype['billingAddress'] = undefined;

/**
 * PayPal account created time.
 * @member {Date} createdTime
 */
PayPalAccount.prototype['createdTime'] = undefined;

/**
 * Custom Fields list as a map `{\"custom field name\": \"custom field value\", ...}`. The format must follow the saved format (see Custom Fields section for the formats). 
 * @member {Object} customFields
 */
PayPalAccount.prototype['customFields'] = undefined;

/**
 * The customer's ID.
 * @member {String} customerId
 */
PayPalAccount.prototype['customerId'] = undefined;

/**
 * The payment instrument ID.
 * @member {String} id
 */
PayPalAccount.prototype['id'] = undefined;

/**
 * The method of payment instrument.
 * @member {module:model/PayPalAccount.MethodEnum} method
 */
PayPalAccount.prototype['method'] = undefined;

/**
 * @member {module:model/RiskMetadata} riskMetadata
 */
PayPalAccount.prototype['riskMetadata'] = undefined;

/**
 * PayPal account status.
 * @member {module:model/PayPalAccount.StatusEnum} status
 */
PayPalAccount.prototype['status'] = undefined;

/**
 * PayPal account updated time.
 * @member {Date} updatedTime
 */
PayPalAccount.prototype['updatedTime'] = undefined;

/**
 * PayPal username.
 * @member {String} username
 */
PayPalAccount.prototype['username'] = undefined;

/**
 * Any embedded objects available that are requested by the `expand` querystring parameter.
 * @member {Array.<module:model/PayPalAccountAllOfEmbedded>} _embedded
 */
PayPalAccount.prototype['_embedded'] = undefined;

/**
 * The links related to resource.
 * @member {Array.<module:model/PayPalAccountAllOfLinks>} _links
 */
PayPalAccount.prototype['_links'] = undefined;


// Implement CommonPayPalAccount interface:
/**
 * The billing address.
 * @member {module:model/ContactObject} billingAddress
 */
