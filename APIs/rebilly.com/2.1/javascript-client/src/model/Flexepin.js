...
import FlexepinAllOfCredentials from './FlexepinAllOfCredentials';
...
/**
 * The Flexepin model module.
 * @module model/Flexepin
 * @version 2.1
 */
class Flexepin {
    /**
     * Constructs a new <code>Flexepin</code>.
     * Flexepin Gateway config.
     * @alias module:model/Flexepin
     ...
     * @param credentials {module:model/FlexepinAllOfCredentials} 
     */
    constructor(acceptedCurrencies, gatewayName, method, credentials) { 
        ...
        Flexepin.initialize(this, acceptedCurrencies, gatewayName, method, credentials);
    }
    ...
    /**
     * Constructs a <code>Flexepin</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Flexepin} obj Optional instance to populate.
     * @return {module:model/Flexepin} The populated <code>Flexepin</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new Flexepin();
            GatewayAccount.constructFromObject(data, obj);
            GatewayAccount.constructFromObject(data, obj);

            if (data.hasOwnProperty('credentials')) {
                obj['credentials'] = FlexepinAllOfCredentials.constructFromObject(data['credentials']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>Flexepin</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Flexepin</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of Flexepin.RequiredProperties) {
        ...
        if (data['credentials']) { // data not null
          FlexepinAllOfCredentials.validateJSON(data['credentials']);
        }
...
Flexepin.RequiredProperties = ["credentials", "acceptedCurrencies", "gatewayName", "method"];

/**
 * @member {module:model/FlexepinAllOfCredentials} credentials
 */
Flexepin.prototype['credentials'] = undefined;
