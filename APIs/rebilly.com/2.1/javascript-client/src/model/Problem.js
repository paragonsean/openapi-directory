...
import DetailedProblem from './DetailedProblem';
import DocumentedProblem from './DocumentedProblem';
...
class Problem {
     ...
     * @implements module:model/DocumentedProblem
     * @implements module:model/DetailedProblem
     */
    constructor() { 
        DocumentedProblem.initialize(this);DetailedProblem.initialize(this);
    ...
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new Problem();
            DocumentedProblem.constructFromObject(data, obj);
            DetailedProblem.constructFromObject(data, obj);
...
// Implement DocumentedProblem interface:
/**
 * The HTTP status code.
 * @member {Number} status
 */
DocumentedProblem.prototype['status'] = undefined;
/**
 * A short, human-readable summary of the problem type. It SHOULD NOT change from occurrence to occurrence of the problem, except for purposes of localization.
 * @member {String} title
 */
DocumentedProblem.prototype['title'] = undefined;
/**
 * A URI reference [[RFC3986](https://tools.ietf.org/html/rfc3986)] that identifies the problem type. It should provide human-readable documentation for the problem type. When this member is not present, its value is assumed to be \"about:blank\".
 * @member {String} type
 */
DocumentedProblem.prototype['type'] = undefined;
// Implement DetailedProblem interface:
/**
 * The HTTP status code.
 * @member {Number} status
 */
DetailedProblem.prototype['status'] = undefined;
/**
 * A short, human-readable summary of the problem type. It SHOULD NOT change from occurrence to occurrence of the problem, except for purposes of localization.
 * @member {String} title
 */
DetailedProblem.prototype['title'] = undefined;
/**
 * A human-readable explanation specific to this occurrence of the problem.
 * @member {String} detail
 */
DetailedProblem.prototype['detail'] = undefined;
