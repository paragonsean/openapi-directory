...
import RPNAllOfCredentials from './RPNAllOfCredentials';

/**
 * The RPN model module.
 * @module model/RPN
 * @version 2.1
 */
class RPN {
    /**
     * Constructs a new <code>RPN</code>.
     * RPN Gateway config.
     * @alias module:model/RPN
     ...
     * @param credentials {module:model/RPNAllOfCredentials} 
     */
    constructor(acceptedCurrencies, gatewayName, method, credentials) { 
        ...
        RPN.initialize(this, acceptedCurrencies, gatewayName, method, credentials);
    }
    ...
    /**
     * Constructs a <code>RPN</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/RPN} obj Optional instance to populate.
     * @return {module:model/RPN} The populated <code>RPN</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('credentials')) {
                obj['credentials'] = RPNAllOfCredentials.constructFromObject(data['credentials']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>RPN</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RPN</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of RPN.RequiredProperties) {
        ...
        if (data['credentials']) { // data not null
          RPNAllOfCredentials.validateJSON(data['credentials']);
        }
...
RPN.RequiredProperties = ["credentials", "acceptedCurrencies", "gatewayName", "method"];

/**
 * @member {module:model/RPNAllOfCredentials} credentials
 */
RPN.prototype['credentials'] = undefined;
