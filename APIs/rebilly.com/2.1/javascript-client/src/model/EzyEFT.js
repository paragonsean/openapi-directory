...
import EzyEFTAllOfCredentials from './EzyEFTAllOfCredentials';
...
/**
 * The EzyEFT model module.
 * @module model/EzyEFT
 * @version 2.1
 */
class EzyEFT {
    /**
     * Constructs a new <code>EzyEFT</code>.
     * ezyEFT config.
     * @alias module:model/EzyEFT
     ...
     * @param credentials {module:model/EzyEFTAllOfCredentials} 
     */
    constructor(acceptedCurrencies, gatewayName, method, credentials) { 
        ...
        EzyEFT.initialize(this, acceptedCurrencies, gatewayName, method, credentials);
    }
    ...
    /**
     * Constructs a <code>EzyEFT</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/EzyEFT} obj Optional instance to populate.
     * @return {module:model/EzyEFT} The populated <code>EzyEFT</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('credentials')) {
                obj['credentials'] = EzyEFTAllOfCredentials.constructFromObject(data['credentials']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>EzyEFT</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EzyEFT</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of EzyEFT.RequiredProperties) {
        ...
        if (data['credentials']) { // data not null
          EzyEFTAllOfCredentials.validateJSON(data['credentials']);
        }
...
EzyEFT.RequiredProperties = ["credentials", "acceptedCurrencies", "gatewayName", "method"];

/**
 * @member {module:model/EzyEFTAllOfCredentials} credentials
 */
EzyEFT.prototype['credentials'] = undefined;
