...
import PaymentAsiaAllOfCredentials from './PaymentAsiaAllOfCredentials';
import PaymentCardBrand from './PaymentCardBrand';
import PaymentMethod from './PaymentMethod';

/**
 * The PaymentAsia model module.
 * @module model/PaymentAsia
 * @version 2.1
 */
class PaymentAsia {
    /**
     * Constructs a new <code>PaymentAsia</code>.
     * PaymentAsia config.
     * @alias module:model/PaymentAsia
     ...
     * @param credentials {module:model/PaymentAsiaAllOfCredentials} 
     */
    constructor(acceptedCurrencies, gatewayName, method, credentials) { 
        ...
        PaymentAsia.initialize(this, acceptedCurrencies, gatewayName, method, credentials);
    }
    ...
    /**
     * Constructs a <code>PaymentAsia</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PaymentAsia} obj Optional instance to populate.
     * @return {module:model/PaymentAsia} The populated <code>PaymentAsia</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PaymentAsia();
            GatewayAccount.constructFromObject(data, obj);
            GatewayAccount.constructFromObject(data, obj);

            if (data.hasOwnProperty('credentials')) {
                obj['credentials'] = PaymentAsiaAllOfCredentials.constructFromObject(data['credentials']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>PaymentAsia</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PaymentAsia</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of PaymentAsia.RequiredProperties) {
        ...
        if (data['credentials']) { // data not null
          PaymentAsiaAllOfCredentials.validateJSON(data['credentials']);
        }
...
PaymentAsia.RequiredProperties = ["credentials", "acceptedCurrencies", "gatewayName", "method"];

/**
 * @member {module:model/PaymentAsiaAllOfCredentials} credentials
 */
PaymentAsia.prototype['credentials'] = undefined;
