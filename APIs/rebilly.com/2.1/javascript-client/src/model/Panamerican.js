...
import PanamericanAllOfCredentials from './PanamericanAllOfCredentials';
import PanamericanAllOfSettings from './PanamericanAllOfSettings';
import PaymentCardBrand from './PaymentCardBrand';
import PaymentMethod from './PaymentMethod';

/**
 * The Panamerican model module.
 * @module model/Panamerican
 * @version 2.1
 */
class Panamerican {
    /**
     * Constructs a new <code>Panamerican</code>.
     * Panamerican config.
     * @alias module:model/Panamerican
     ...
     * @param credentials {module:model/PanamericanAllOfCredentials} 
     * @param settings {module:model/PanamericanAllOfSettings} 
     */
    constructor(acceptedCurrencies, gatewayName, method, credentials, settings) { 
        ...
        Panamerican.initialize(this, acceptedCurrencies, gatewayName, method, credentials, settings);
    }
    ...
    /**
     * Constructs a <code>Panamerican</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Panamerican} obj Optional instance to populate.
     * @return {module:model/Panamerican} The populated <code>Panamerican</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new Panamerican();
            GatewayAccount.constructFromObject(data, obj);
            GatewayAccount.constructFromObject(data, obj);

            if (data.hasOwnProperty('credentials')) {
                obj['credentials'] = PanamericanAllOfCredentials.constructFromObject(data['credentials']);
            }
            if (data.hasOwnProperty('settings')) {
                obj['settings'] = PanamericanAllOfSettings.constructFromObject(data['settings']);
            }
            if (data.hasOwnProperty('threeDSecureServer')) {
                obj['threeDSecureServer'] = Panamerican3dsServers.constructFromObject(data['threeDSecureServer']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>Panamerican</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Panamerican</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of Panamerican.RequiredProperties) {
        ...
        if (data['credentials']) { // data not null
          PanamericanAllOfCredentials.validateJSON(data['credentials']);
        }
        // validate the optional field `settings`
        if (data['settings']) { // data not null
          PanamericanAllOfSettings.validateJSON(data['settings']);
        }
        // validate the optional field `threeDSecureServer`
        if (data['threeDSecureServer']) { // data not null
          Panamerican3dsServers.validateJSON(data['threeDSecureServer']);
        }
...
Panamerican.RequiredProperties = ["credentials", "settings", "acceptedCurrencies", "gatewayName", "method"];

/**
 * @member {module:model/PanamericanAllOfCredentials} credentials
 */
Panamerican.prototype['credentials'] = undefined;

/**
 * @member {module:model/PanamericanAllOfSettings} settings
 */
Panamerican.prototype['settings'] = undefined;

/**
 * @member {module:model/Panamerican3dsServers} threeDSecureServer
 */
Panamerican.prototype['threeDSecureServer'] = undefined;
