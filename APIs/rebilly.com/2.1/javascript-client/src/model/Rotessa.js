...
import RotessaAllOfCredentials from './RotessaAllOfCredentials';
import RotessaAllOfSettings from './RotessaAllOfSettings';

/**
 * The Rotessa model module.
 * @module model/Rotessa
 * @version 2.1
 */
class Rotessa {
    /**
     * Constructs a new <code>Rotessa</code>.
     * Rotessa config.
     * @alias module:model/Rotessa
     ...
     * @param credentials {module:model/RotessaAllOfCredentials} 
     * @param settings {module:model/RotessaAllOfSettings} 
     */
    constructor(acceptedCurrencies, gatewayName, method, credentials, settings) { 
        ...
        Rotessa.initialize(this, acceptedCurrencies, gatewayName, method, credentials, settings);
    }
    ...
    /**
     * Constructs a <code>Rotessa</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Rotessa} obj Optional instance to populate.
     * @return {module:model/Rotessa} The populated <code>Rotessa</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('credentials')) {
                obj['credentials'] = RotessaAllOfCredentials.constructFromObject(data['credentials']);
            }
            if (data.hasOwnProperty('settings')) {
                obj['settings'] = RotessaAllOfSettings.constructFromObject(data['settings']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>Rotessa</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Rotessa</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of Rotessa.RequiredProperties) {
        ...
        if (data['credentials']) { // data not null
          RotessaAllOfCredentials.validateJSON(data['credentials']);
        }
        // validate the optional field `settings`
        if (data['settings']) { // data not null
          RotessaAllOfSettings.validateJSON(data['settings']);
        }
...
Rotessa.RequiredProperties = ["credentials", "settings", "acceptedCurrencies", "gatewayName", "method"];

/**
 * @member {module:model/RotessaAllOfCredentials} credentials
 */
Rotessa.prototype['credentials'] = undefined;

/**
 * @member {module:model/RotessaAllOfSettings} settings
 */
Rotessa.prototype['settings'] = undefined;
