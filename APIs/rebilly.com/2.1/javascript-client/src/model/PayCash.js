...
import PayCashAllOfCredentials from './PayCashAllOfCredentials';
import PaymentCardBrand from './PaymentCardBrand';
import PaymentMethod from './PaymentMethod';

/**
 * The PayCash model module.
 * @module model/PayCash
 * @version 2.1
 */
class PayCash {
    /**
     * Constructs a new <code>PayCash</code>.
     * PayCash config.
     * @alias module:model/PayCash
     ...
     * @param credentials {module:model/PayCashAllOfCredentials} 
     */
    constructor(acceptedCurrencies, gatewayName, method, credentials) { 
        ...
        PayCash.initialize(this, acceptedCurrencies, gatewayName, method, credentials);
    }
    ...
    /**
     * Constructs a <code>PayCash</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PayCash} obj Optional instance to populate.
     * @return {module:model/PayCash} The populated <code>PayCash</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('credentials')) {
                obj['credentials'] = PayCashAllOfCredentials.constructFromObject(data['credentials']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>PayCash</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PayCash</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of PayCash.RequiredProperties) {
        ...
        if (data['credentials']) { // data not null
          PayCashAllOfCredentials.validateJSON(data['credentials']);
        }
...
PayCash.RequiredProperties = ["credentials", "acceptedCurrencies", "gatewayName", "method"];

/**
 * @member {module:model/PayCashAllOfCredentials} credentials
 */
PayCash.prototype['credentials'] = undefined;
