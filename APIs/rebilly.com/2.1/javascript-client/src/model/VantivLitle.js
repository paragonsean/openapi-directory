...
import VantivLitleAllOfCredentials from './VantivLitleAllOfCredentials';

/**
 * The VantivLitle model module.
 * @module model/VantivLitle
 * @version 2.1
 */
class VantivLitle {
    /**
     * Constructs a new <code>VantivLitle</code>.
     * VantivLitle Gateway config.
     * @alias module:model/VantivLitle
     ...
     * @param credentials {module:model/VantivLitleAllOfCredentials} 
     */
    constructor(acceptedCurrencies, gatewayName, method, credentials) { 
        ...
        VantivLitle.initialize(this, acceptedCurrencies, gatewayName, method, credentials);
    }
    ...
    /**
     * Constructs a <code>VantivLitle</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/VantivLitle} obj Optional instance to populate.
     * @return {module:model/VantivLitle} The populated <code>VantivLitle</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new VantivLitle();
            GatewayAccount.constructFromObject(data, obj);
            GatewayAccount.constructFromObject(data, obj);

            if (data.hasOwnProperty('credentials')) {
                obj['credentials'] = VantivLitleAllOfCredentials.constructFromObject(data['credentials']);
            }
            if (data.hasOwnProperty('threeDSecureServer')) {
                obj['threeDSecureServer'] = VantivLitle3dsServers.constructFromObject(data['threeDSecureServer']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>VantivLitle</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>VantivLitle</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of VantivLitle.RequiredProperties) {
        ...
        if (data['credentials']) { // data not null
          VantivLitleAllOfCredentials.validateJSON(data['credentials']);
        }
        // validate the optional field `threeDSecureServer`
        if (data['threeDSecureServer']) { // data not null
          VantivLitle3dsServers.validateJSON(data['threeDSecureServer']);
        }
...
VantivLitle.RequiredProperties = ["credentials", "acceptedCurrencies", "gatewayName", "method"];

/**
 * @member {module:model/VantivLitleAllOfCredentials} credentials
 */
VantivLitle.prototype['credentials'] = undefined;

/**
 * @member {module:model/VantivLitle3dsServers} threeDSecureServer
 */
VantivLitle.prototype['threeDSecureServer'] = undefined;
