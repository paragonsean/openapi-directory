...
import MonerisAllOfCredentials from './MonerisAllOfCredentials';
import PaymentCardBrand from './PaymentCardBrand';
import PaymentMethod from './PaymentMethod';

/**
 * The Moneris model module.
 * @module model/Moneris
 * @version 2.1
 */
class Moneris {
    /**
     * Constructs a new <code>Moneris</code>.
     * Moneris Gateway config.
     * @alias module:model/Moneris
     ...
     * @param credentials {module:model/MonerisAllOfCredentials} 
     */
    constructor(acceptedCurrencies, gatewayName, method, credentials) { 
        ...
        Moneris.initialize(this, acceptedCurrencies, gatewayName, method, credentials);
    }
    ...
    /**
     * Constructs a <code>Moneris</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Moneris} obj Optional instance to populate.
     * @return {module:model/Moneris} The populated <code>Moneris</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('credentials')) {
                obj['credentials'] = MonerisAllOfCredentials.constructFromObject(data['credentials']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>Moneris</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Moneris</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of Moneris.RequiredProperties) {
        ...
        if (data['credentials']) { // data not null
          MonerisAllOfCredentials.validateJSON(data['credentials']);
        }
...
Moneris.RequiredProperties = ["credentials", "acceptedCurrencies", "gatewayName", "method"];

/**
 * @member {module:model/MonerisAllOfCredentials} credentials
 */
Moneris.prototype['credentials'] = undefined;
