...
import ProofOfAddressAllOfLinks from './ProofOfAddressAllOfLinks';

/**
 * The ProofOfAddress model module.
 * @module model/ProofOfAddress
 * @version 2.1
 */
class ProofOfAddress {
    /**
     * Constructs a new <code>ProofOfAddress</code>.
     * @alias module:model/ProofOfAddress
     ...
     * @param status {module:model/ProofOfAddress.StatusEnum} Status of the validation.
    ...
    constructor(documentType, status, customerId) { 
        ...
        ProofOfAddress.initialize(this, documentType, status, customerId);
    }
    ...
    /**
     * Constructs a <code>ProofOfAddress</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ProofOfAddress} obj Optional instance to populate.
     * @return {module:model/ProofOfAddress} The populated <code>ProofOfAddress</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ProofOfAddress();
            KycDocument.constructFromObject(data, obj);

            if (data.hasOwnProperty('_links')) {
                obj['_links'] = ApiClient.convertToType(data['_links'], [ProofOfAddressAllOfLinks]);
            }
            ...
            if (data.hasOwnProperty('documentMatches')) {
                obj['documentMatches'] = ProofOfAddressAllOfDocumentMatches.constructFromObject(data['documentMatches']);
            }
            if (data.hasOwnProperty('parsedData')) {
                obj['parsedData'] = ProofOfAddressAllOfDocumentMatches.constructFromObject(data['parsedData']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ProofOfAddress</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ProofOfAddress</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ProofOfAddress.RequiredProperties) {
        ...
        if (data['_links']) { // data not null
            ...
            for (const item of data['_links']) {
                ProofOfAddressAllOfLinks.validateJSON(item);
            };
        }
        ...
        if (data['documentMatches']) { // data not null
          ProofOfAddressAllOfDocumentMatches.validateJSON(data['documentMatches']);
        }
        // validate the optional field `parsedData`
        if (data['parsedData']) { // data not null
          ProofOfAddressAllOfDocumentMatches.validateJSON(data['parsedData']);
        }
...
ProofOfAddress.RequiredProperties = ["documentType", "status", "customerId"];

/**
 * The links related to resource.
 * @member {Array.<module:model/ProofOfAddressAllOfLinks>} _links
 */
ProofOfAddress.prototype['_links'] = undefined;

/**
 * Creation date/time.
 * @member {Date} createdTime
 */
ProofOfAddress.prototype['createdTime'] = undefined;

/**
 * Document subtype submitted for validation.
 * @member {module:model/KycDocumentSubtypes} documentSubtype
 */
ProofOfAddress.prototype['documentSubtype'] = undefined;
 ...
 */
ProofOfAddress.prototype['documentType'] = undefined;

/**
 * Linked file object id.
 * @member {String} fileId
 */
ProofOfAddress.prototype['fileId'] = undefined;

/**
 * Linked file object id's.
 * @member {Array.<String>} fileIds
 */
ProofOfAddress.prototype['fileIds'] = undefined;

/**
 * The resource ID. Defaults to UUID v4.
 * @member {String} id
 */
ProofOfAddress.prototype['id'] = undefined;

/**
 * Processing date/time.
 * @member {Date} processedTime
 */
ProofOfAddress.prototype['processedTime'] = undefined;

/**
 * @member {module:model/KycDocumentRejection} rejectionReason
 */
ProofOfAddress.prototype['rejectionReason'] = undefined;

/**
 * KYC request identifier string.
 * @member {String} requestId
 */
ProofOfAddress.prototype['requestId'] = undefined;

/**
 * Status of the validation.
 * @member {module:model/ProofOfAddress.StatusEnum} status
 */
ProofOfAddress.prototype['status'] = undefined;

/**
 * Latest update date/time.
 * @member {Date} updatedTime
 */
ProofOfAddress.prototype['updatedTime'] = undefined;

/**
 * The сustomer's ID.
 * @member {String} customerId
 */
ProofOfAddress.prototype['customerId'] = undefined;

/**
 * The level of strictness for the document matches.
 * @member {Number} matchLevel
 */
ProofOfAddress.prototype['matchLevel'] = undefined;

/**
 * Reviewer notes.
 * @member {String} notes
 */
ProofOfAddress.prototype['notes'] = undefined;

/**
 * Reason for uploading.
 * @member {String} reason
 */
ProofOfAddress.prototype['reason'] = undefined;

/**
 * Date and time of manual review.
 * @member {Date} reviewTime
 */
ProofOfAddress.prototype['reviewTime'] = undefined;

/**
 * Reviewer's user ID.
 * @member {String} reviewerId
 */
ProofOfAddress.prototype['reviewerId'] = undefined;

/**
 * Reviewer's first and last name.
 * @member {String} reviewerName
 */
ProofOfAddress.prototype['reviewerName'] = undefined;

/**
 * @member {module:model/ProofOfAddressAllOfDocumentMatches} documentMatches
 */
ProofOfAddress.prototype['documentMatches'] = undefined;

/**
 * @member {module:model/ProofOfAddressAllOfDocumentMatches} parsedData
 */
ProofOfAddress.prototype['parsedData'] = undefined;
