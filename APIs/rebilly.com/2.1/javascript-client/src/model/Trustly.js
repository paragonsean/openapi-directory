...
import TrustlyAllOfCredentials from './TrustlyAllOfCredentials';

/**
 * The Trustly model module.
 * @module model/Trustly
 * @version 2.1
 */
class Trustly {
    /**
     * Constructs a new <code>Trustly</code>.
     * Trustly config.
     * @alias module:model/Trustly
     ...
     * @param credentials {module:model/TrustlyAllOfCredentials} 
     */
    constructor(acceptedCurrencies, gatewayName, method, credentials) { 
        ...
        Trustly.initialize(this, acceptedCurrencies, gatewayName, method, credentials);
    }
    ...
    /**
     * Constructs a <code>Trustly</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Trustly} obj Optional instance to populate.
     * @return {module:model/Trustly} The populated <code>Trustly</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('credentials')) {
                obj['credentials'] = TrustlyAllOfCredentials.constructFromObject(data['credentials']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>Trustly</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Trustly</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of Trustly.RequiredProperties) {
        ...
        if (data['credentials']) { // data not null
          TrustlyAllOfCredentials.validateJSON(data['credentials']);
        }
...
Trustly.RequiredProperties = ["credentials", "acceptedCurrencies", "gatewayName", "method"];

/**
 * @member {module:model/TrustlyAllOfCredentials} credentials
 */
Trustly.prototype['credentials'] = undefined;
