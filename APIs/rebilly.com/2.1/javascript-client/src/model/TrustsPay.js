...
import TrustsPayAllOfCredentials from './TrustsPayAllOfCredentials';

/**
 * The TrustsPay model module.
 * @module model/TrustsPay
 * @version 2.1
 */
class TrustsPay {
    /**
     * Constructs a new <code>TrustsPay</code>.
     * TrustsPay config.
     * @alias module:model/TrustsPay
     ...
     * @param credentials {module:model/TrustsPayAllOfCredentials} 
     */
    constructor(acceptedCurrencies, gatewayName, method, credentials) { 
        ...
        TrustsPay.initialize(this, acceptedCurrencies, gatewayName, method, credentials);
    }
    ...
    /**
     * Constructs a <code>TrustsPay</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/TrustsPay} obj Optional instance to populate.
     * @return {module:model/TrustsPay} The populated <code>TrustsPay</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new TrustsPay();
            GatewayAccount.constructFromObject(data, obj);
            GatewayAccount.constructFromObject(data, obj);

            if (data.hasOwnProperty('credentials')) {
                obj['credentials'] = TrustsPayAllOfCredentials.constructFromObject(data['credentials']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>TrustsPay</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TrustsPay</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of TrustsPay.RequiredProperties) {
        ...
        if (data['credentials']) { // data not null
          TrustsPayAllOfCredentials.validateJSON(data['credentials']);
        }
...
TrustsPay.RequiredProperties = ["credentials", "acceptedCurrencies", "gatewayName", "method"];

/**
 * @member {module:model/TrustsPayAllOfCredentials} credentials
 */
TrustsPay.prototype['credentials'] = undefined;
