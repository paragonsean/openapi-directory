...
import DLocalAllOfCredentials from './DLocalAllOfCredentials';
import DLocalAllOfSettings from './DLocalAllOfSettings';
...
/**
 * The DLocal model module.
 * @module model/DLocal
 * @version 2.1
 */
class DLocal {
    /**
     * Constructs a new <code>DLocal</code>.
     * dLocal config.
     * @alias module:model/DLocal
     ...
     * @param credentials {module:model/DLocalAllOfCredentials} 
     */
    constructor(acceptedCurrencies, gatewayName, method, credentials) { 
        ...
        DLocal.initialize(this, acceptedCurrencies, gatewayName, method, credentials);
    }
    ...
    /**
     * Constructs a <code>DLocal</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DLocal} obj Optional instance to populate.
     * @return {module:model/DLocal} The populated <code>DLocal</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('credentials')) {
                obj['credentials'] = DLocalAllOfCredentials.constructFromObject(data['credentials']);
            }
            if (data.hasOwnProperty('settings')) {
                obj['settings'] = DLocalAllOfSettings.constructFromObject(data['settings']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>DLocal</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DLocal</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DLocal.RequiredProperties) {
        ...
        if (data['credentials']) { // data not null
          DLocalAllOfCredentials.validateJSON(data['credentials']);
        }
        // validate the optional field `settings`
        if (data['settings']) { // data not null
          DLocalAllOfSettings.validateJSON(data['settings']);
        }
...
DLocal.RequiredProperties = ["credentials", "acceptedCurrencies", "gatewayName", "method"];

/**
 * @member {module:model/DLocalAllOfCredentials} credentials
 */
DLocal.prototype['credentials'] = undefined;

/**
 * @member {module:model/DLocalAllOfSettings} settings
 */
DLocal.prototype['settings'] = undefined;
