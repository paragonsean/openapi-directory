...
import ProsaAllOfCredentials from './ProsaAllOfCredentials';

/**
 * The Prosa model module.
 * @module model/Prosa
 * @version 2.1
 */
class Prosa {
    /**
     * Constructs a new <code>Prosa</code>.
     * Prosa config.
     * @alias module:model/Prosa
     ...
     * @param credentials {module:model/ProsaAllOfCredentials} 
     */
    constructor(acceptedCurrencies, gatewayName, method, credentials) { 
        ...
        Prosa.initialize(this, acceptedCurrencies, gatewayName, method, credentials);
    }
    ...
    /**
     * Constructs a <code>Prosa</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Prosa} obj Optional instance to populate.
     * @return {module:model/Prosa} The populated <code>Prosa</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('credentials')) {
                obj['credentials'] = ProsaAllOfCredentials.constructFromObject(data['credentials']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>Prosa</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Prosa</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of Prosa.RequiredProperties) {
        ...
        if (data['credentials']) { // data not null
          ProsaAllOfCredentials.validateJSON(data['credentials']);
        }
...
Prosa.RequiredProperties = ["credentials", "acceptedCurrencies", "gatewayName", "method"];

/**
 * @member {module:model/ProsaAllOfCredentials} credentials
 */
Prosa.prototype['credentials'] = undefined;
