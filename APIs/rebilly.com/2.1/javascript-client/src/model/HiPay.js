...
import HiPayAllOfCredentials from './HiPayAllOfCredentials';
import PaymentCardBrand from './PaymentCardBrand';
import PaymentMethod from './PaymentMethod';

/**
 * The HiPay model module.
 * @module model/HiPay
 * @version 2.1
 */
class HiPay {
    /**
     * Constructs a new <code>HiPay</code>.
     * HiPay config.
     * @alias module:model/HiPay
     ...
     * @param credentials {module:model/HiPayAllOfCredentials} 
     */
    constructor(acceptedCurrencies, gatewayName, method, credentials) { 
        ...
        HiPay.initialize(this, acceptedCurrencies, gatewayName, method, credentials);
    }
    ...
    /**
     * Constructs a <code>HiPay</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/HiPay} obj Optional instance to populate.
     * @return {module:model/HiPay} The populated <code>HiPay</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('credentials')) {
                obj['credentials'] = HiPayAllOfCredentials.constructFromObject(data['credentials']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>HiPay</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>HiPay</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of HiPay.RequiredProperties) {
        ...
        if (data['credentials']) { // data not null
          HiPayAllOfCredentials.validateJSON(data['credentials']);
        }
...
HiPay.RequiredProperties = ["credentials", "acceptedCurrencies", "gatewayName", "method"];

/**
 * @member {module:model/HiPayAllOfCredentials} credentials
 */
HiPay.prototype['credentials'] = undefined;
