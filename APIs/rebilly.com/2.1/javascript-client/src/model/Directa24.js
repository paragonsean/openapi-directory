...
import Directa24AllOfCredentials from './Directa24AllOfCredentials';
import Directa24AllOfSettings from './Directa24AllOfSettings';
...
/**
 * The Directa24 model module.
 * @module model/Directa24
 * @version 2.1
 */
class Directa24 {
    /**
     * Constructs a new <code>Directa24</code>.
     * Directa24 config.
     * @alias module:model/Directa24
     ...
     * @param credentials {module:model/Directa24AllOfCredentials} 
     */
    constructor(acceptedCurrencies, gatewayName, method, credentials) { 
        ...
        Directa24.initialize(this, acceptedCurrencies, gatewayName, method, credentials);
    }
    ...
    /**
     * Constructs a <code>Directa24</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Directa24} obj Optional instance to populate.
     * @return {module:model/Directa24} The populated <code>Directa24</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new Directa24();
            GatewayAccount.constructFromObject(data, obj);
            GatewayAccount.constructFromObject(data, obj);

            if (data.hasOwnProperty('credentials')) {
                obj['credentials'] = Directa24AllOfCredentials.constructFromObject(data['credentials']);
            }
            if (data.hasOwnProperty('settings')) {
                obj['settings'] = Directa24AllOfSettings.constructFromObject(data['settings']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>Directa24</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Directa24</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of Directa24.RequiredProperties) {
        ...
        if (data['credentials']) { // data not null
          Directa24AllOfCredentials.validateJSON(data['credentials']);
        }
        // validate the optional field `settings`
        if (data['settings']) { // data not null
          Directa24AllOfSettings.validateJSON(data['settings']);
        }
...
Directa24.RequiredProperties = ["credentials", "acceptedCurrencies", "gatewayName", "method"];

/**
 * @member {module:model/Directa24AllOfCredentials} credentials
 */
Directa24.prototype['credentials'] = undefined;

/**
 * @member {module:model/Directa24AllOfSettings} settings
 */
Directa24.prototype['settings'] = undefined;
