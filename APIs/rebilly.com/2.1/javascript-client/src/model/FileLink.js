...
class FileLink {
     ...
     * @param {module:model/FileLink} obj Optional instance to populate.
     * @return {module:model/FileLink} The populated <code>FileLink</code> instance.
     */
    ...
    static validateJSON(data) {
        ...
        for (const property of FileLink.RequiredProperties) {
...
FileLink.RequiredProperties = ["rel", "href"];

/**
 * The link type.
 * @member {module:model/FileLink.RelEnum} rel
 */
FileLink.prototype['rel'] = undefined;

/**
 * The link URL.
 * @member {String} href
 */
FileLink.prototype['href'] = undefined;
