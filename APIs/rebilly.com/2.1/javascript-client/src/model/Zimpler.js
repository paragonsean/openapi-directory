...
import ZimplerAllOfCredentials from './ZimplerAllOfCredentials';

/**
 * The Zimpler model module.
 * @module model/Zimpler
 * @version 2.1
 */
class Zimpler {
    /**
     * Constructs a new <code>Zimpler</code>.
     * Zimpler config.
     * @alias module:model/Zimpler
     ...
     * @param credentials {module:model/ZimplerAllOfCredentials} 
     */
    constructor(acceptedCurrencies, gatewayName, method, credentials) { 
        ...
        Zimpler.initialize(this, acceptedCurrencies, gatewayName, method, credentials);
    }
    ...
    /**
     * Constructs a <code>Zimpler</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Zimpler} obj Optional instance to populate.
     * @return {module:model/Zimpler} The populated <code>Zimpler</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('credentials')) {
                obj['credentials'] = ZimplerAllOfCredentials.constructFromObject(data['credentials']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>Zimpler</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Zimpler</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of Zimpler.RequiredProperties) {
        ...
        if (data['credentials']) { // data not null
          ZimplerAllOfCredentials.validateJSON(data['credentials']);
        }
...
Zimpler.RequiredProperties = ["credentials", "acceptedCurrencies", "gatewayName", "method"];

/**
 * @member {module:model/ZimplerAllOfCredentials} credentials
 */
Zimpler.prototype['credentials'] = undefined;
