...
/**
 * The CommonProduct model module.
 * @module model/CommonProduct
 * @version 2.1
 */
class CommonProduct {
    /**
     * Constructs a new <code>CommonProduct</code>.
     ...
     * @alias module:model/CommonProduct
    ...
    /**
     * Constructs a <code>CommonProduct</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CommonProduct} obj Optional instance to populate.
     * @return {module:model/CommonProduct} The populated <code>CommonProduct</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CommonProduct();
    ...
    /**
     * Validates the JSON data with respect to <code>CommonProduct</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CommonProduct</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CommonProduct.RequiredProperties) {
...
CommonProduct.RequiredProperties = ["name"];
