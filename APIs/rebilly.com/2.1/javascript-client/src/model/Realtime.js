...
import RealtimeAllOfCredentials from './RealtimeAllOfCredentials';
...
class Realtime {
     ...
     * @param credentials {module:model/RealtimeAllOfCredentials} 
     */
    constructor(acceptedCurrencies, gatewayName, method, credentials) { 
        ...
        Realtime.initialize(this, acceptedCurrencies, gatewayName, method, credentials);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('credentials')) {
                obj['credentials'] = RealtimeAllOfCredentials.constructFromObject(data['credentials']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>Realtime</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Realtime</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of Realtime.RequiredProperties) {
        ...
        if (data['credentials']) { // data not null
          RealtimeAllOfCredentials.validateJSON(data['credentials']);
        }
...
Realtime.RequiredProperties = ["credentials", "acceptedCurrencies", "gatewayName", "method"];

/**
 * @member {module:model/RealtimeAllOfCredentials} credentials
 */
Realtime.prototype['credentials'] = undefined;
