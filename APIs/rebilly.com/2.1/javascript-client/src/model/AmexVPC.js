...
import AmexVPCAllOfCredentials from './AmexVPCAllOfCredentials';
import AmexVPCAllOfSettings from './AmexVPCAllOfSettings';
...
/**
 * The AmexVPC model module.
 * @module model/AmexVPC
 * @version 2.1
 */
class AmexVPC {
    /**
     * Constructs a new <code>AmexVPC</code>.
     * AmexVPC config.
     * @alias module:model/AmexVPC
     ...
     * @param credentials {module:model/AmexVPCAllOfCredentials} 
     * @param settings {module:model/AmexVPCAllOfSettings} 
     */
    constructor(acceptedCurrencies, gatewayName, method, credentials, settings) { 
        ...
        AmexVPC.initialize(this, acceptedCurrencies, gatewayName, method, credentials, settings);
    }
    ...
    /**
     * Constructs a <code>AmexVPC</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AmexVPC} obj Optional instance to populate.
     * @return {module:model/AmexVPC} The populated <code>AmexVPC</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('credentials')) {
                obj['credentials'] = AmexVPCAllOfCredentials.constructFromObject(data['credentials']);
            }
            if (data.hasOwnProperty('settings')) {
                obj['settings'] = AmexVPCAllOfSettings.constructFromObject(data['settings']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>AmexVPC</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AmexVPC</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of AmexVPC.RequiredProperties) {
        ...
        if (data['credentials']) { // data not null
          AmexVPCAllOfCredentials.validateJSON(data['credentials']);
        }
        // validate the optional field `settings`
        if (data['settings']) { // data not null
          AmexVPCAllOfSettings.validateJSON(data['settings']);
        }
...
AmexVPC.RequiredProperties = ["credentials", "settings", "acceptedCurrencies", "gatewayName", "method"];

/**
 * @member {module:model/AmexVPCAllOfCredentials} credentials
 */
AmexVPC.prototype['credentials'] = undefined;

/**
 * @member {module:model/AmexVPCAllOfSettings} settings
 */
AmexVPC.prototype['settings'] = undefined;
