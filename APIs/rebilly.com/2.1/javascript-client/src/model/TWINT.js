...
import TWINTAllOfCredentials from './TWINTAllOfCredentials';
import TWINTAllOfSettings from './TWINTAllOfSettings';

/**
 * The TWINT model module.
 * @module model/TWINT
 * @version 2.1
 */
class TWINT {
    /**
     * Constructs a new <code>TWINT</code>.
     * TWINT config.
     * @alias module:model/TWINT
     ...
     * @param credentials {module:model/TWINTAllOfCredentials} 
     * @param settings {module:model/TWINTAllOfSettings} 
     */
    constructor(acceptedCurrencies, gatewayName, method, credentials, settings) { 
        ...
        TWINT.initialize(this, acceptedCurrencies, gatewayName, method, credentials, settings);
    }
    ...
    /**
     * Constructs a <code>TWINT</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/TWINT} obj Optional instance to populate.
     * @return {module:model/TWINT} The populated <code>TWINT</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('credentials')) {
                obj['credentials'] = TWINTAllOfCredentials.constructFromObject(data['credentials']);
            }
            if (data.hasOwnProperty('settings')) {
                obj['settings'] = TWINTAllOfSettings.constructFromObject(data['settings']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>TWINT</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TWINT</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of TWINT.RequiredProperties) {
        ...
        if (data['credentials']) { // data not null
          TWINTAllOfCredentials.validateJSON(data['credentials']);
        }
        // validate the optional field `settings`
        if (data['settings']) { // data not null
          TWINTAllOfSettings.validateJSON(data['settings']);
        }
...
TWINT.RequiredProperties = ["credentials", "settings", "acceptedCurrencies", "gatewayName", "method"];

/**
 * @member {module:model/TWINTAllOfCredentials} credentials
 */
TWINT.prototype['credentials'] = undefined;

/**
 * @member {module:model/TWINTAllOfSettings} settings
 */
TWINT.prototype['settings'] = undefined;
