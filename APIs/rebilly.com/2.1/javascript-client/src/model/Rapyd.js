...
import RapydAllOfCredentials from './RapydAllOfCredentials';

/**
 * The Rapyd model module.
 * @module model/Rapyd
 * @version 2.1
 */
class Rapyd {
    /**
     * Constructs a new <code>Rapyd</code>.
     * Rapyd config.
     * @alias module:model/Rapyd
     ...
     * @param credentials {module:model/RapydAllOfCredentials} 
     */
    constructor(acceptedCurrencies, gatewayName, method, credentials) { 
        ...
        Rapyd.initialize(this, acceptedCurrencies, gatewayName, method, credentials);
    }
    ...
    /**
     * Constructs a <code>Rapyd</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Rapyd} obj Optional instance to populate.
     * @return {module:model/Rapyd} The populated <code>Rapyd</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('credentials')) {
                obj['credentials'] = RapydAllOfCredentials.constructFromObject(data['credentials']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>Rapyd</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Rapyd</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of Rapyd.RequiredProperties) {
        ...
        if (data['credentials']) { // data not null
          RapydAllOfCredentials.validateJSON(data['credentials']);
        }
...
Rapyd.RequiredProperties = ["credentials", "acceptedCurrencies", "gatewayName", "method"];

/**
 * @member {module:model/RapydAllOfCredentials} credentials
 */
Rapyd.prototype['credentials'] = undefined;
