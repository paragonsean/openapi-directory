...
/**
 * The KhelocardCard model module.
 * @module model/KhelocardCard
 * @version 2.1
 */
class KhelocardCard {
    /**
     * Constructs a new <code>KhelocardCard</code>.
     * @alias module:model/KhelocardCard
     */
    constructor() { 
        
        KhelocardCard.initialize(this);
    }
    ...
    /**
     * Constructs a <code>KhelocardCard</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/KhelocardCard} obj Optional instance to populate.
     * @return {module:model/KhelocardCard} The populated <code>KhelocardCard</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new KhelocardCard();
    ...
    /**
     * Validates the JSON data with respect to <code>KhelocardCard</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>KhelocardCard</code>.
     */
 ...
 */
KhelocardCard.prototype['_embedded'] = undefined;

/**
 * Links related to the resource.
 * @member {Array.<module:model/BankAccountAllOfLinks>} _links
 */
KhelocardCard.prototype['_links'] = undefined;

/**
 * The billing address.
 * @member {module:model/ContactObject} billingAddress
 */
KhelocardCard.prototype['billingAddress'] = undefined;

/**
 * The payment instrument created time.
 * @member {Date} createdTime
 */
KhelocardCard.prototype['createdTime'] = undefined;

/**
 * Custom Fields list as a map `{\"custom field name\": \"custom field value\", ...}`. The format must follow the saved format (see Custom Fields section for the formats). 
 * @member {Object} customFields
 */
KhelocardCard.prototype['customFields'] = undefined;

/**
 * Customer's ID.
 * @member {String} customerId
 */
KhelocardCard.prototype['customerId'] = undefined;

/**
 * Khelocard card's expiration month.
 * @member {Number} expMonth
 */
KhelocardCard.prototype['expMonth'] = undefined;

/**
 * Khelocard card's expiration year.
 * @member {Number} expYear
 */
KhelocardCard.prototype['expYear'] = undefined;

/**
 * A unique value to identify the payment instrument regardless of variable values. It contains alphanumeric values.
 * @member {String} fingerprint
 */
KhelocardCard.prototype['fingerprint'] = undefined;

/**
 * The payment instrument ID.
 * @member {String} id
 */
KhelocardCard.prototype['id'] = undefined;

/**
 * The number's last 4 digits.
 * @member {String} last4
 */
KhelocardCard.prototype['last4'] = undefined;

/**
 * The method of payment instrument.
 * @member {module:model/KhelocardCard.MethodEnum} method
 */
KhelocardCard.prototype['method'] = undefined;

/**
 * Khelocard card's masked number.
 * @member {String} number
 */
KhelocardCard.prototype['number'] = undefined;

/**
 * @member {module:model/RiskMetadata} riskMetadata
 */
KhelocardCard.prototype['riskMetadata'] = undefined;

/**
 * The payment instrument status.
 * @member {module:model/KhelocardCard.StatusEnum} status
 */
KhelocardCard.prototype['status'] = undefined;

/**
 * The payment instrument updated time.
 * @member {Date} updatedTime
 */
KhelocardCard.prototype['updatedTime'] = undefined;
