...
import EcoPayzAllOfCredentials from './EcoPayzAllOfCredentials';
import EcoPayzAllOfSettings from './EcoPayzAllOfSettings';
...
/**
 * The EcoPayz model module.
 * @module model/EcoPayz
 * @version 2.1
 */
class EcoPayz {
    /**
     * Constructs a new <code>EcoPayz</code>.
     * ecoPayz config.
     * @alias module:model/EcoPayz
     ...
     * @param credentials {module:model/EcoPayzAllOfCredentials} 
     */
    constructor(acceptedCurrencies, gatewayName, method, credentials) { 
        ...
        EcoPayz.initialize(this, acceptedCurrencies, gatewayName, method, credentials);
    }
    ...
    /**
     * Constructs a <code>EcoPayz</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/EcoPayz} obj Optional instance to populate.
     * @return {module:model/EcoPayz} The populated <code>EcoPayz</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('credentials')) {
                obj['credentials'] = EcoPayzAllOfCredentials.constructFromObject(data['credentials']);
            }
            if (data.hasOwnProperty('settings')) {
                obj['settings'] = EcoPayzAllOfSettings.constructFromObject(data['settings']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>EcoPayz</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EcoPayz</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of EcoPayz.RequiredProperties) {
        ...
        if (data['credentials']) { // data not null
          EcoPayzAllOfCredentials.validateJSON(data['credentials']);
        }
        // validate the optional field `settings`
        if (data['settings']) { // data not null
          EcoPayzAllOfSettings.validateJSON(data['settings']);
        }
...
EcoPayz.RequiredProperties = ["credentials", "acceptedCurrencies", "gatewayName", "method"];

/**
 * @member {module:model/EcoPayzAllOfCredentials} credentials
 */
EcoPayz.prototype['credentials'] = undefined;

/**
 * @member {module:model/EcoPayzAllOfSettings} settings
 */
EcoPayz.prototype['settings'] = undefined;
