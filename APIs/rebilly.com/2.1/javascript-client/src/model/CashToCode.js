...
import CashToCodeAllOfCredentials from './CashToCodeAllOfCredentials';
import CashToCodeAllOfSettings from './CashToCodeAllOfSettings';
...
/**
 * The CashToCode model module.
 * @module model/CashToCode
 * @version 2.1
 */
class CashToCode {
    /**
     * Constructs a new <code>CashToCode</code>.
     * CashToCode config.
     * @alias module:model/CashToCode
     ...
     * @param credentials {module:model/CashToCodeAllOfCredentials} 
     */
    constructor(acceptedCurrencies, gatewayName, method, credentials) { 
        ...
        CashToCode.initialize(this, acceptedCurrencies, gatewayName, method, credentials);
    }
    ...
    /**
     * Constructs a <code>CashToCode</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CashToCode} obj Optional instance to populate.
     * @return {module:model/CashToCode} The populated <code>CashToCode</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CashToCode();
            GatewayAccount.constructFromObject(data, obj);
            GatewayAccount.constructFromObject(data, obj);

            if (data.hasOwnProperty('credentials')) {
                obj['credentials'] = CashToCodeAllOfCredentials.constructFromObject(data['credentials']);
            }
            if (data.hasOwnProperty('settings')) {
                obj['settings'] = CashToCodeAllOfSettings.constructFromObject(data['settings']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>CashToCode</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CashToCode</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CashToCode.RequiredProperties) {
        ...
        if (data['credentials']) { // data not null
          CashToCodeAllOfCredentials.validateJSON(data['credentials']);
        }
        // validate the optional field `settings`
        if (data['settings']) { // data not null
          CashToCodeAllOfSettings.validateJSON(data['settings']);
        }
...
CashToCode.RequiredProperties = ["credentials", "acceptedCurrencies", "gatewayName", "method"];

/**
 * @member {module:model/CashToCodeAllOfCredentials} credentials
 */
CashToCode.prototype['credentials'] = undefined;

/**
 * @member {module:model/CashToCodeAllOfSettings} settings
 */
CashToCode.prototype['settings'] = undefined;
