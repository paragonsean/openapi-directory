...
import BraintreePaymentsAllOfCredentials from './BraintreePaymentsAllOfCredentials';
...
/**
 * The BraintreePayments model module.
 * @module model/BraintreePayments
 * @version 2.1
 */
class BraintreePayments {
    /**
     * Constructs a new <code>BraintreePayments</code>.
     * BraintreePayments Gateway config.
     * @alias module:model/BraintreePayments
     ...
     * @param credentials {module:model/BraintreePaymentsAllOfCredentials} 
     */
    constructor(acceptedCurrencies, gatewayName, method, credentials) { 
        ...
        BraintreePayments.initialize(this, acceptedCurrencies, gatewayName, method, credentials);
    }
    ...
    /**
     * Constructs a <code>BraintreePayments</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/BraintreePayments} obj Optional instance to populate.
     * @return {module:model/BraintreePayments} The populated <code>BraintreePayments</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new BraintreePayments();
            GatewayAccount.constructFromObject(data, obj);
            GatewayAccount.constructFromObject(data, obj);

            if (data.hasOwnProperty('credentials')) {
                obj['credentials'] = BraintreePaymentsAllOfCredentials.constructFromObject(data['credentials']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>BraintreePayments</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>BraintreePayments</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of BraintreePayments.RequiredProperties) {
        ...
        if (data['credentials']) { // data not null
          BraintreePaymentsAllOfCredentials.validateJSON(data['credentials']);
        }
...
BraintreePayments.RequiredProperties = ["credentials", "acceptedCurrencies", "gatewayName", "method"];

/**
 * @member {module:model/BraintreePaymentsAllOfCredentials} credentials
 */
BraintreePayments.prototype['credentials'] = undefined;
