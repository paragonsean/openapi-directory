...
class Discount {
     ...
     * @param method {module:model/Discount.MethodEnum} 
     * @param type {module:model/Discount.TypeEnum} The payment amount discount type.
     * @param value {Number} The payment amount discount.
     */
...
Discount.RequiredProperties = ["type", "value", "method"];
