...
class ProductLink {
    ...
    constructor(href) { 
        ...
        ProductLink.initialize(this, href);
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ProductLink</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ProductLink</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ProductLink.RequiredProperties) {
...
ProductLink.RequiredProperties = ["rel", "href"];

/**
 * The link type.
 * @member {module:model/ProductLink.RelEnum} rel
 */
ProductLink.prototype['rel'] = undefined;

/**
 * The link URL.
 * @member {String} href
 */
ProductLink.prototype['href'] = undefined;
