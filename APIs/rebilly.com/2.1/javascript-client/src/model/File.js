...
import FileLinksInner from './FileLinksInner';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('_links')) {
                obj['_links'] = ApiClient.convertToType(data['_links'], [FileLinksInner]);
            }
    ...
    static validateJSON(data) {
        if (data['_links']) { // data not null
            ...
            for (const item of data['_links']) {
                FileLinksInner.validateJSON(item);
            };
        }
 ...
 * @member {Array.<module:model/FileLinksInner>} _links
 */
File.prototype['_links'] = undefined;
 ...
 */
File.prototype['isPublic'] = undefined;

/**
 * The mime type.
 * @member {module:model/File.MimeEnum} mime
 */
 ...
 */
File.prototype['updatedTime'] = undefined;
...
/**
 * Allowed values for the <code>mime</code> property.
 * @enum {String}
 * @readonly
 */
File['MimeEnum'] = {
