...
import PaymentsOSAllOfCredentials from './PaymentsOSAllOfCredentials';

/**
 * The PaymentsOS model module.
 * @module model/PaymentsOS
 * @version 2.1
 */
class PaymentsOS {
    /**
     * Constructs a new <code>PaymentsOS</code>.
     * PaymentsOS config.
     * @alias module:model/PaymentsOS
     ...
     * @param credentials {module:model/PaymentsOSAllOfCredentials} 
     */
    constructor(acceptedCurrencies, gatewayName, method, credentials) { 
        ...
        PaymentsOS.initialize(this, acceptedCurrencies, gatewayName, method, credentials);
    }
    ...
    /**
     * Constructs a <code>PaymentsOS</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PaymentsOS} obj Optional instance to populate.
     * @return {module:model/PaymentsOS} The populated <code>PaymentsOS</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PaymentsOS();
            GatewayAccount.constructFromObject(data, obj);
            GatewayAccount.constructFromObject(data, obj);

            if (data.hasOwnProperty('credentials')) {
                obj['credentials'] = PaymentsOSAllOfCredentials.constructFromObject(data['credentials']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>PaymentsOS</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PaymentsOS</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of PaymentsOS.RequiredProperties) {
        ...
        if (data['credentials']) { // data not null
          PaymentsOSAllOfCredentials.validateJSON(data['credentials']);
        }
...
PaymentsOS.RequiredProperties = ["credentials", "acceptedCurrencies", "gatewayName", "method"];

/**
 * @member {module:model/PaymentsOSAllOfCredentials} credentials
 */
PaymentsOS.prototype['credentials'] = undefined;
