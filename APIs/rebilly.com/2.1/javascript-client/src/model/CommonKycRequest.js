...
/**
 * The CommonKycRequest model module.
 * @module model/CommonKycRequest
 * @version 2.1
 */
class CommonKycRequest {
    /**
     * Constructs a new <code>CommonKycRequest</code>.
     * @alias module:model/CommonKycRequest
    ...
    /**
     * Constructs a <code>CommonKycRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CommonKycRequest} obj Optional instance to populate.
     * @return {module:model/CommonKycRequest} The populated <code>CommonKycRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CommonKycRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>CommonKycRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CommonKycRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CommonKycRequest.RequiredProperties) {
...
CommonKycRequest.RequiredProperties = ["documents"];
...
export default CommonKycRequest;
