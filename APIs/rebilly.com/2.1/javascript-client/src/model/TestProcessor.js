...
/**
 * The TestProcessor model module.
 * @module model/TestProcessor
 * @version 2.1
 */
class TestProcessor {
    /**
     ...
     * @alias module:model/TestProcessor
    ...
    constructor(acceptedCurrencies, gatewayName, method) { 
        ...
        TestProcessor.initialize(this, acceptedCurrencies, gatewayName, method);
    }
    ...
    /**
     * Constructs a <code>TestProcessor</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/TestProcessor} obj Optional instance to populate.
     * @return {module:model/TestProcessor} The populated <code>TestProcessor</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new TestProcessor();
            GatewayAccount.constructFromObject(data, obj);
            GatewayAccount.constructFromObject(data, obj);

            if (data.hasOwnProperty('threeDSecureServer')) {
                obj['threeDSecureServer'] = TestProcessor3dsServers.constructFromObject(data['threeDSecureServer']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>TestProcessor</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TestProcessor</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of TestProcessor.RequiredProperties) {
        ...
        if (data['threeDSecureServer']) { // data not null
          TestProcessor3dsServers.validateJSON(data['threeDSecureServer']);
        }
...
TestProcessor.RequiredProperties = ["acceptedCurrencies", "gatewayName", "method"];

/**
 * @member {module:model/TestProcessor3dsServers} threeDSecureServer
 */
TestProcessor.prototype['threeDSecureServer'] = undefined;
