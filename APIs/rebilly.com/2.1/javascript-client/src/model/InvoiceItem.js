...
import InvoiceItemEmbeddedInner from './InvoiceItemEmbeddedInner';
import InvoiceItemLinksInner from './InvoiceItemLinksInner';
...
class InvoiceItem {
     ...
     * @param type {module:model/InvoiceItem.TypeEnum} Invoice item's type.
     * @param unitPrice {Number} Invoice item's price.
     */
    constructor(type, unitPrice) { 
        
        InvoiceItem.initialize(this, type, unitPrice);
    }
     ...
     */
    static initialize(obj, type, unitPrice) { 
        obj['type'] = type;
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('_embedded')) {
                obj['_embedded'] = ApiClient.convertToType(data['_embedded'], [InvoiceItemEmbeddedInner]);
            }
            if (data.hasOwnProperty('_links')) {
                obj['_links'] = ApiClient.convertToType(data['_links'], [InvoiceItemLinksInner]);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['_embedded']) { // data not null
            ...
            for (const item of data['_embedded']) {
                InvoiceItemEmbeddedInner.validateJSON(item);
            };
        }
        if (data['_links']) { // data not null
            ...
            for (const item of data['_links']) {
                InvoiceItemLinksInner.validateJSON(item);
            };
        }
...
InvoiceItem.RequiredProperties = ["type", "unitPrice"];

/**
 * Any embedded objects available that are requested by the `expand` querystring parameter.
 * @member {Array.<module:model/InvoiceItemEmbeddedInner>} _embedded
 */
InvoiceItem.prototype['_embedded'] = undefined;

/**
 * The links related to resource.
 * @member {Array.<module:model/InvoiceItemLinksInner>} _links
 */
InvoiceItem.prototype['_links'] = undefined;

/**
 * Invoice item created time.
 * @member {Date} createdTime
 */
InvoiceItem.prototype['createdTime'] = undefined;
 ...
 */
InvoiceItem.prototype['discountAmount'] = undefined;
 ...
 */
InvoiceItem.prototype['periodEndTime'] = undefined;

/**
 * Invoice item subscription order period number.
 * @member {Number} periodNumber
 */
InvoiceItem.prototype['periodNumber'] = undefined;

/**
 * Start time.
 * @member {Date} periodStartTime
 */
InvoiceItem.prototype['periodStartTime'] = undefined;

/**
 * Invoice item's total price.
 * @member {Number} price
 */
InvoiceItem.prototype['price'] = undefined;
...
/**
 * Invoice item's type.
 * @member {module:model/InvoiceItem.TypeEnum} type
 */
InvoiceItem.prototype['type'] = undefined;
 ...
 */
InvoiceItem.prototype['updatedTime'] = undefined;
