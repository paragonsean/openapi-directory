...
class Credential {
     ...
     * @param customerId {String} The credential's customer ID.
     * @param password {String} The credential's password.
     * @param username {String} Credential's username.
     */
    constructor(customerId, password, username) { 
        
        Credential.initialize(this, customerId, password, username);
    }
     ...
     */
    static initialize(obj, customerId, password, username) { 
...
Credential.RequiredProperties = ["customerId", "password", "username"];

/**
 * The links related to resource.
 * @member {Array.<module:model/BankAccountAllOfLinks>} _links
 */
Credential.prototype['_links'] = undefined;

/**
 * The credential's customer ID.
 * @member {String} customerId
 */
Credential.prototype['customerId'] = undefined;

/**
 * The credential's expired time.
 * @member {Date} expiredTime
 */
Credential.prototype['expiredTime'] = undefined;
