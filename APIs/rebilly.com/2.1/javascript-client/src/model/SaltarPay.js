...
import SaltarPayAllOfCredentials from './SaltarPayAllOfCredentials';

/**
 * The SaltarPay model module.
 * @module model/SaltarPay
 * @version 2.1
 */
class SaltarPay {
    /**
     * Constructs a new <code>SaltarPay</code>.
     * SaltarPay config.
     * @alias module:model/SaltarPay
     ...
     * @param credentials {module:model/SaltarPayAllOfCredentials} 
     */
    constructor(acceptedCurrencies, gatewayName, method, credentials) { 
        ...
        SaltarPay.initialize(this, acceptedCurrencies, gatewayName, method, credentials);
    }
    ...
    /**
     * Constructs a <code>SaltarPay</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SaltarPay} obj Optional instance to populate.
     * @return {module:model/SaltarPay} The populated <code>SaltarPay</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SaltarPay();
            GatewayAccount.constructFromObject(data, obj);
            GatewayAccount.constructFromObject(data, obj);

            if (data.hasOwnProperty('credentials')) {
                obj['credentials'] = SaltarPayAllOfCredentials.constructFromObject(data['credentials']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>SaltarPay</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SaltarPay</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of SaltarPay.RequiredProperties) {
        ...
        if (data['credentials']) { // data not null
          SaltarPayAllOfCredentials.validateJSON(data['credentials']);
        }
...
SaltarPay.RequiredProperties = ["credentials", "acceptedCurrencies", "gatewayName", "method"];

/**
 * @member {module:model/SaltarPayAllOfCredentials} credentials
 */
SaltarPay.prototype['credentials'] = undefined;
