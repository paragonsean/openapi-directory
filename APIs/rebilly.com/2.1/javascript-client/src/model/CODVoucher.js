...
import CODVoucherAllOfCredentials from './CODVoucherAllOfCredentials';
...
/**
 * The CODVoucher model module.
 * @module model/CODVoucher
 * @version 2.1
 */
class CODVoucher {
    /**
     * Constructs a new <code>CODVoucher</code>.
     * COD Voucher config.
     * @alias module:model/CODVoucher
     ...
     * @param credentials {module:model/CODVoucherAllOfCredentials} 
     */
    constructor(acceptedCurrencies, gatewayName, method, credentials) { 
        ...
        CODVoucher.initialize(this, acceptedCurrencies, gatewayName, method, credentials);
    }
    ...
    /**
     * Constructs a <code>CODVoucher</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CODVoucher} obj Optional instance to populate.
     * @return {module:model/CODVoucher} The populated <code>CODVoucher</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CODVoucher();
            GatewayAccount.constructFromObject(data, obj);
            GatewayAccount.constructFromObject(data, obj);

            if (data.hasOwnProperty('credentials')) {
                obj['credentials'] = CODVoucherAllOfCredentials.constructFromObject(data['credentials']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>CODVoucher</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CODVoucher</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CODVoucher.RequiredProperties) {
        ...
        if (data['credentials']) { // data not null
          CODVoucherAllOfCredentials.validateJSON(data['credentials']);
        }
...
CODVoucher.RequiredProperties = ["credentials", "acceptedCurrencies", "gatewayName", "method"];

/**
 * @member {module:model/CODVoucherAllOfCredentials} credentials
 */
CODVoucher.prototype['credentials'] = undefined;
