...
/**
 * The InvoiceTimeline model module.
 * @module model/InvoiceTimeline
 * @version 2.1
 */
class InvoiceTimeline {
    /**
     * Constructs a new <code>InvoiceTimeline</code>.
     * @alias module:model/InvoiceTimeline
     */
    constructor() { 
        
        InvoiceTimeline.initialize(this);
    }
    ...
    /**
     * Constructs a <code>InvoiceTimeline</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/InvoiceTimeline} obj Optional instance to populate.
     * @return {module:model/InvoiceTimeline} The populated <code>InvoiceTimeline</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new InvoiceTimeline();
    ...
    /**
     * Validates the JSON data with respect to <code>InvoiceTimeline</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>InvoiceTimeline</code>.
     */
 ...
 */
InvoiceTimeline.prototype['_links'] = undefined;

/**
 * @member {module:model/TimelineExtraData} extraData
 */
InvoiceTimeline.prototype['extraData'] = undefined;

/**
 * The Timeline message identifier string.
 * @member {String} id
 */
InvoiceTimeline.prototype['id'] = undefined;

/**
 * The message that describes the message details.
 * @member {String} message
 */
InvoiceTimeline.prototype['message'] = undefined;

/**
 * Timeline message time.
 * @member {Date} occurredTime
 */
InvoiceTimeline.prototype['occurredTime'] = undefined;

/**
 * Shows who or what triggered the Timeline event.
 * @member {module:model/InvoiceTimeline.TriggeredByEnum} triggeredBy
 */
InvoiceTimeline.prototype['triggeredBy'] = undefined;

/**
 * Timeline message type.
 * @member {module:model/InvoiceTimeline.TypeEnum} type
 */
InvoiceTimeline.prototype['type'] = undefined;
 ...
 * @readonly
 */
InvoiceTimeline['TriggeredByEnum'] = {
