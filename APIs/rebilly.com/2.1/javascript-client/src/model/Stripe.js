...
import StripeAllOfSettings from './StripeAllOfSettings';

/**
 * The Stripe model module.
 * @module model/Stripe
 * @version 2.1
 */
class Stripe {
    /**
     * Constructs a new <code>Stripe</code>.
     * Stripe Gateway config.
     * @alias module:model/Stripe
     ...
     * @param settings {module:model/StripeAllOfSettings} 
     */
    constructor(acceptedCurrencies, gatewayName, method, settings) { 
        GatewayAccount.initialize(this, acceptedCurrencies, gatewayName, method);
        Stripe.initialize(this, acceptedCurrencies, gatewayName, method, settings);
    }
     ...
     */
    static initialize(obj, acceptedCurrencies, gatewayName, method, settings) { 
        obj['settings'] = settings;
    }

    /**
     * Constructs a <code>Stripe</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Stripe} obj Optional instance to populate.
     * @return {module:model/Stripe} The populated <code>Stripe</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('settings')) {
                obj['settings'] = StripeAllOfSettings.constructFromObject(data['settings']);
            }
            if (data.hasOwnProperty('threeDSecureServer')) {
                obj['threeDSecureServer'] = Stripe3dsServers.constructFromObject(data['threeDSecureServer']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>Stripe</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Stripe</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of Stripe.RequiredProperties) {
        ...
        if (data['settings']) { // data not null
          StripeAllOfSettings.validateJSON(data['settings']);
        }
        // validate the optional field `threeDSecureServer`
        if (data['threeDSecureServer']) { // data not null
          Stripe3dsServers.validateJSON(data['threeDSecureServer']);
        }
...
Stripe.RequiredProperties = ["settings", "acceptedCurrencies", "gatewayName", "method"];

/**
 * @member {module:model/StripeAllOfSettings} settings
 */
Stripe.prototype['settings'] = undefined;

/**
 * @member {module:model/Stripe3dsServers} threeDSecureServer
 */
Stripe.prototype['threeDSecureServer'] = undefined;
