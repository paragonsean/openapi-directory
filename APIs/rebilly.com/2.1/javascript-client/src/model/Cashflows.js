...
import CashflowsAllOfCredentials from './CashflowsAllOfCredentials';
...
/**
 * The Cashflows model module.
 * @module model/Cashflows
 * @version 2.1
 */
class Cashflows {
    /**
     * Constructs a new <code>Cashflows</code>.
     * Cashflows Gateway config.
     * @alias module:model/Cashflows
     ...
     * @param credentials {module:model/CashflowsAllOfCredentials} 
     */
    constructor(acceptedCurrencies, gatewayName, method, credentials) { 
        ...
        Cashflows.initialize(this, acceptedCurrencies, gatewayName, method, credentials);
    }
    ...
    /**
     * Constructs a <code>Cashflows</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Cashflows} obj Optional instance to populate.
     * @return {module:model/Cashflows} The populated <code>Cashflows</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new Cashflows();
            GatewayAccount.constructFromObject(data, obj);
            GatewayAccount.constructFromObject(data, obj);

            if (data.hasOwnProperty('credentials')) {
                obj['credentials'] = CashflowsAllOfCredentials.constructFromObject(data['credentials']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>Cashflows</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Cashflows</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of Cashflows.RequiredProperties) {
        ...
        if (data['credentials']) { // data not null
          CashflowsAllOfCredentials.validateJSON(data['credentials']);
        }
...
Cashflows.RequiredProperties = ["credentials", "acceptedCurrencies", "gatewayName", "method"];

/**
 * @member {module:model/CashflowsAllOfCredentials} credentials
 */
Cashflows.prototype['credentials'] = undefined;
