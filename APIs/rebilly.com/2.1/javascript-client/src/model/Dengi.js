...
import DengiAllOfCredentials from './DengiAllOfCredentials';
...
/**
 * The Dengi model module.
 * @module model/Dengi
 * @version 2.1
 */
class Dengi {
    /**
     * Constructs a new <code>Dengi</code>.
     * Dengi Gateway config.
     * @alias module:model/Dengi
     ...
     * @param credentials {module:model/DengiAllOfCredentials} 
     */
    constructor(acceptedCurrencies, gatewayName, method, credentials) { 
        ...
        Dengi.initialize(this, acceptedCurrencies, gatewayName, method, credentials);
    }
    ...
    /**
     * Constructs a <code>Dengi</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Dengi} obj Optional instance to populate.
     * @return {module:model/Dengi} The populated <code>Dengi</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('credentials')) {
                obj['credentials'] = DengiAllOfCredentials.constructFromObject(data['credentials']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>Dengi</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Dengi</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of Dengi.RequiredProperties) {
        ...
        if (data['credentials']) { // data not null
          DengiAllOfCredentials.validateJSON(data['credentials']);
        }
...
Dengi.RequiredProperties = ["credentials", "acceptedCurrencies", "gatewayName", "method"];

/**
 * @member {module:model/DengiAllOfCredentials} credentials
 */
Dengi.prototype['credentials'] = undefined;
