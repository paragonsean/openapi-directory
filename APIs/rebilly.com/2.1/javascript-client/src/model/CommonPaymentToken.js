...
/**
 * The CommonPaymentToken model module.
 * @module model/CommonPaymentToken
 * @version 2.1
 */
class CommonPaymentToken {
    /**
     * Constructs a new <code>CommonPaymentToken</code>.
     * @alias module:model/CommonPaymentToken
     * @param method {String} 
     */
    constructor(method) { 
    ...
    /**
     * Constructs a <code>CommonPaymentToken</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CommonPaymentToken} obj Optional instance to populate.
     * @return {module:model/CommonPaymentToken} The populated <code>CommonPaymentToken</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CommonPaymentToken();
    ...
    /**
     * Validates the JSON data with respect to <code>CommonPaymentToken</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CommonPaymentToken</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CommonPaymentToken.RequiredProperties) {
...
CommonPaymentToken.RequiredProperties = ["method"];
...
export default CommonPaymentToken;
