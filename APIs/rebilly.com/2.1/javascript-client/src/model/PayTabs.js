...
import PayTabsAllOfCredentials from './PayTabsAllOfCredentials';
import PaymentCardBrand from './PaymentCardBrand';
import PaymentMethod from './PaymentMethod';

/**
 * The PayTabs model module.
 * @module model/PayTabs
 * @version 2.1
 */
class PayTabs {
    /**
     * Constructs a new <code>PayTabs</code>.
     * PayTabs config.
     * @alias module:model/PayTabs
     ...
     * @param credentials {module:model/PayTabsAllOfCredentials} 
     */
    constructor(acceptedCurrencies, gatewayName, method, credentials) { 
        ...
        PayTabs.initialize(this, acceptedCurrencies, gatewayName, method, credentials);
    }
    ...
    /**
     * Constructs a <code>PayTabs</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PayTabs} obj Optional instance to populate.
     * @return {module:model/PayTabs} The populated <code>PayTabs</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('credentials')) {
                obj['credentials'] = PayTabsAllOfCredentials.constructFromObject(data['credentials']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>PayTabs</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PayTabs</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of PayTabs.RequiredProperties) {
        ...
        if (data['credentials']) { // data not null
          PayTabsAllOfCredentials.validateJSON(data['credentials']);
        }
...
PayTabs.RequiredProperties = ["credentials", "acceptedCurrencies", "gatewayName", "method"];

/**
 * @member {module:model/PayTabsAllOfCredentials} credentials
 */
PayTabs.prototype['credentials'] = undefined;
