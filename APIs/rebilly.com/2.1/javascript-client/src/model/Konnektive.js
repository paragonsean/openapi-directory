...
import KonnektiveAllOfCredentials from './KonnektiveAllOfCredentials';
import KonnektiveAllOfSettings from './KonnektiveAllOfSettings';
import PaymentCardBrand from './PaymentCardBrand';
import PaymentMethod from './PaymentMethod';

/**
 * The Konnektive model module.
 * @module model/Konnektive
 * @version 2.1
 */
class Konnektive {
    /**
     * Constructs a new <code>Konnektive</code>.
     * Konnektive config.
     * @alias module:model/Konnektive
     ...
     * @param credentials {module:model/KonnektiveAllOfCredentials} 
     * @param settings {module:model/KonnektiveAllOfSettings} 
     */
    constructor(acceptedCurrencies, gatewayName, method, credentials, settings) { 
        ...
        Konnektive.initialize(this, acceptedCurrencies, gatewayName, method, credentials, settings);
    }
    ...
    /**
     * Constructs a <code>Konnektive</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Konnektive} obj Optional instance to populate.
     * @return {module:model/Konnektive} The populated <code>Konnektive</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new Konnektive();
            GatewayAccount.constructFromObject(data, obj);
            GatewayAccount.constructFromObject(data, obj);

            if (data.hasOwnProperty('credentials')) {
                obj['credentials'] = KonnektiveAllOfCredentials.constructFromObject(data['credentials']);
            }
            if (data.hasOwnProperty('settings')) {
                obj['settings'] = KonnektiveAllOfSettings.constructFromObject(data['settings']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>Konnektive</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Konnektive</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of Konnektive.RequiredProperties) {
        ...
        if (data['credentials']) { // data not null
          KonnektiveAllOfCredentials.validateJSON(data['credentials']);
        }
        // validate the optional field `settings`
        if (data['settings']) { // data not null
          KonnektiveAllOfSettings.validateJSON(data['settings']);
        }
...
Konnektive.RequiredProperties = ["credentials", "settings", "acceptedCurrencies", "gatewayName", "method"];

/**
 * @member {module:model/KonnektiveAllOfCredentials} credentials
 */
Konnektive.prototype['credentials'] = undefined;

/**
 * @member {module:model/KonnektiveAllOfSettings} settings
 */
Konnektive.prototype['settings'] = undefined;
