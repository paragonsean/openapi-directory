...
import Pay4FunAllOfCredentials from './Pay4FunAllOfCredentials';
import PaymentCardBrand from './PaymentCardBrand';
import PaymentMethod from './PaymentMethod';

/**
 * The Pay4Fun model module.
 * @module model/Pay4Fun
 * @version 2.1
 */
class Pay4Fun {
    /**
     * Constructs a new <code>Pay4Fun</code>.
     * Pay4Fun config.
     * @alias module:model/Pay4Fun
     ...
     * @param credentials {module:model/Pay4FunAllOfCredentials} 
     */
    constructor(acceptedCurrencies, gatewayName, method, credentials) { 
        ...
        Pay4Fun.initialize(this, acceptedCurrencies, gatewayName, method, credentials);
    }
    ...
    /**
     * Constructs a <code>Pay4Fun</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Pay4Fun} obj Optional instance to populate.
     * @return {module:model/Pay4Fun} The populated <code>Pay4Fun</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('credentials')) {
                obj['credentials'] = Pay4FunAllOfCredentials.constructFromObject(data['credentials']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>Pay4Fun</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Pay4Fun</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of Pay4Fun.RequiredProperties) {
        ...
        if (data['credentials']) { // data not null
          Pay4FunAllOfCredentials.validateJSON(data['credentials']);
        }
...
Pay4Fun.RequiredProperties = ["credentials", "acceptedCurrencies", "gatewayName", "method"];

/**
 * @member {module:model/Pay4FunAllOfCredentials} credentials
 */
Pay4Fun.prototype['credentials'] = undefined;
