...
import FundSendAllOfCredentials from './FundSendAllOfCredentials';
...
/**
 * The FundSend model module.
 * @module model/FundSend
 * @version 2.1
 */
class FundSend {
    /**
     * Constructs a new <code>FundSend</code>.
     * FundSend Gateway config.
     * @alias module:model/FundSend
     ...
     * @param credentials {module:model/FundSendAllOfCredentials} 
     */
    constructor(acceptedCurrencies, gatewayName, method, credentials) { 
        ...
        FundSend.initialize(this, acceptedCurrencies, gatewayName, method, credentials);
    }
    ...
    /**
     * Constructs a <code>FundSend</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/FundSend} obj Optional instance to populate.
     * @return {module:model/FundSend} The populated <code>FundSend</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new FundSend();
            GatewayAccount.constructFromObject(data, obj);
            GatewayAccount.constructFromObject(data, obj);

            if (data.hasOwnProperty('credentials')) {
                obj['credentials'] = FundSendAllOfCredentials.constructFromObject(data['credentials']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>FundSend</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>FundSend</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of FundSend.RequiredProperties) {
        ...
        if (data['credentials']) { // data not null
          FundSendAllOfCredentials.validateJSON(data['credentials']);
        }
...
FundSend.RequiredProperties = ["credentials", "acceptedCurrencies", "gatewayName", "method"];

/**
 * @member {module:model/FundSendAllOfCredentials} credentials
 */
FundSend.prototype['credentials'] = undefined;
