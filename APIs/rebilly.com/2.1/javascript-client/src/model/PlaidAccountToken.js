...
/**
 * The PlaidAccountToken model module.
 * @module model/PlaidAccountToken
 * @version 2.1
 */
class PlaidAccountToken {
    /**
     * Constructs a new <code>PlaidAccountToken</code>.
     * @alias module:model/PlaidAccountToken
     * @implements module:model/CommonPaymentToken
     * @param method {String} 
     */
    constructor(method) { 
        CommonPaymentToken.initialize(this, method);
        PlaidAccountToken.initialize(this, method);
    }
    ...
    /**
     * Constructs a <code>PlaidAccountToken</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PlaidAccountToken} obj Optional instance to populate.
     * @return {module:model/PlaidAccountToken} The populated <code>PlaidAccountToken</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PlaidAccountToken();
    ...
    /**
     * Validates the JSON data with respect to <code>PlaidAccountToken</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PlaidAccountToken</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of PlaidAccountToken.RequiredProperties) {
...
PlaidAccountToken.RequiredProperties = ["billingAddress", "method", "paymentInstrument"];

/**
 * The billing address object.
 * @member {module:model/ContactObject} billingAddress
 */
PlaidAccountToken.prototype['billingAddress'] = undefined;

/**
 * The token method.
 * @member {module:model/PlaidAccountToken.MethodEnum} method
 */
PlaidAccountToken.prototype['method'] = undefined;

/**
 * The Plaid payment instrument details.
 * @member {Object} paymentInstrument
 */
PlaidAccountToken.prototype['paymentInstrument'] = undefined;

/**
 * The links related to resource.
 * @member {Array.<module:model/SelfLink>} _links
 */
PlaidAccountToken.prototype['_links'] = undefined;

/**
 * Token created time.
 * @member {Date} createdTime
 */
PlaidAccountToken.prototype['createdTime'] = undefined;

/**
 * Token expiration time.
 * @member {Date} expirationTime
 */
PlaidAccountToken.prototype['expirationTime'] = undefined;

/**
 * The token identifier string.
 * @member {String} id
 */
PlaidAccountToken.prototype['id'] = undefined;
 ...
 * @default false
 */
PlaidAccountToken.prototype['isUsed'] = false;

/**
 * @member {module:model/LeadSource} leadSource
 */
PlaidAccountToken.prototype['leadSource'] = undefined;

/**
 * @member {module:model/RiskMetadata} riskMetadata
 */
PlaidAccountToken.prototype['riskMetadata'] = undefined;

/**
 * Token updated time.
 * @member {Date} updatedTime
 */
PlaidAccountToken.prototype['updatedTime'] = undefined;

/**
 * Token usage time.
 * @member {Date} usageTime
 */
PlaidAccountToken.prototype['usageTime'] = undefined;
...
export default PlaidAccountToken;
