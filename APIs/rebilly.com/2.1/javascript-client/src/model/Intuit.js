...
import IntuitAllOfCredentials from './IntuitAllOfCredentials';
import PaymentCardBrand from './PaymentCardBrand';
import PaymentMethod from './PaymentMethod';

/**
 * The Intuit model module.
 * @module model/Intuit
 * @version 2.1
 */
class Intuit {
    /**
     * Constructs a new <code>Intuit</code>.
     * Intuit Gateway config.
     * @alias module:model/Intuit
     ...
     * @param credentials {module:model/IntuitAllOfCredentials} 
     */
    constructor(acceptedCurrencies, gatewayName, method, credentials) { 
        ...
        Intuit.initialize(this, acceptedCurrencies, gatewayName, method, credentials);
    }
    ...
    /**
     * Constructs a <code>Intuit</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Intuit} obj Optional instance to populate.
     * @return {module:model/Intuit} The populated <code>Intuit</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('credentials')) {
                obj['credentials'] = IntuitAllOfCredentials.constructFromObject(data['credentials']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>Intuit</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Intuit</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of Intuit.RequiredProperties) {
        ...
        if (data['credentials']) { // data not null
          IntuitAllOfCredentials.validateJSON(data['credentials']);
        }
...
Intuit.RequiredProperties = ["credentials", "acceptedCurrencies", "gatewayName", "method"];

/**
 * @member {module:model/IntuitAllOfCredentials} credentials
 */
Intuit.prototype['credentials'] = undefined;
