...
import PayPalAllOfSettings from './PayPalAllOfSettings';
...
class PayPal {
     ...
     * @param settings {module:model/PayPalAllOfSettings} 
     */
    constructor(acceptedCurrencies, gatewayName, method, settings) { 
        ...
        PayPal.initialize(this, acceptedCurrencies, gatewayName, method, settings);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('settings')) {
                obj['settings'] = PayPalAllOfSettings.constructFromObject(data['settings']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>PayPal</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PayPal</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of PayPal.RequiredProperties) {
        ...
        if (data['settings']) { // data not null
          PayPalAllOfSettings.validateJSON(data['settings']);
        }
...
PayPal.RequiredProperties = ["settings", "acceptedCurrencies", "gatewayName", "method"];

/**
 * @member {module:model/PayPalAllOfSettings} settings
 */
PayPal.prototype['settings'] = undefined;
