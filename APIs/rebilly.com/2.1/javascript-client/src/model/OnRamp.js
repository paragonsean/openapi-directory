...
import OnRampAllOfCredentials from './OnRampAllOfCredentials';
import PaymentCardBrand from './PaymentCardBrand';
import PaymentMethod from './PaymentMethod';

/**
 * The OnRamp model module.
 * @module model/OnRamp
 * @version 2.1
 */
class OnRamp {
    /**
     * Constructs a new <code>OnRamp</code>.
     * OnRamp config.
     * @alias module:model/OnRamp
     ...
     * @param credentials {module:model/OnRampAllOfCredentials} 
     */
    constructor(acceptedCurrencies, gatewayName, method, credentials) { 
        ...
        OnRamp.initialize(this, acceptedCurrencies, gatewayName, method, credentials);
    }
    ...
    /**
     * Constructs a <code>OnRamp</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/OnRamp} obj Optional instance to populate.
     * @return {module:model/OnRamp} The populated <code>OnRamp</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('credentials')) {
                obj['credentials'] = OnRampAllOfCredentials.constructFromObject(data['credentials']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>OnRamp</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>OnRamp</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of OnRamp.RequiredProperties) {
        ...
        if (data['credentials']) { // data not null
          OnRampAllOfCredentials.validateJSON(data['credentials']);
        }
...
OnRamp.RequiredProperties = ["credentials", "acceptedCurrencies", "gatewayName", "method"];

/**
 * @member {module:model/OnRampAllOfCredentials} credentials
 */
OnRamp.prototype['credentials'] = undefined;
