...
/**
 * The CommonKycDocument model module.
 * @module model/CommonKycDocument
 * @version 2.1
 */
class CommonKycDocument {
    /**
     * Constructs a new <code>CommonKycDocument</code>.
     * @alias module:model/CommonKycDocument
     ...
     * @param status {module:model/CommonKycDocument.StatusEnum} Status of the validation.
     */
    constructor(documentType, status) { 
     ...
     */
    static initialize(obj, documentType, status) { 
        obj['documentType'] = documentType;
        obj['status'] = status;
    }

    /**
     * Constructs a <code>CommonKycDocument</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CommonKycDocument} obj Optional instance to populate.
     * @return {module:model/CommonKycDocument} The populated <code>CommonKycDocument</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CommonKycDocument();
    ...
    /**
     * Validates the JSON data with respect to <code>CommonKycDocument</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CommonKycDocument</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CommonKycDocument.RequiredProperties) {
...
CommonKycDocument.RequiredProperties = ["documentType", "status"];
...
export default CommonKycDocument;
