...
import Clearhaus3dsServers from './Clearhaus3dsServers';
import ClearhausAllOfCredentials from './ClearhausAllOfCredentials';
...
/**
 * The Clearhaus model module.
 * @module model/Clearhaus
 * @version 2.1
 */
class Clearhaus {
    /**
     * Constructs a new <code>Clearhaus</code>.
     * Clearhaus Gateway config.
     * @alias module:model/Clearhaus
     ...
     * @param credentials {module:model/ClearhausAllOfCredentials} 
     */
    constructor(acceptedCurrencies, gatewayName, method, credentials) { 
        ...
        Clearhaus.initialize(this, acceptedCurrencies, gatewayName, method, credentials);
    }
    ...
    /**
     * Constructs a <code>Clearhaus</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Clearhaus} obj Optional instance to populate.
     * @return {module:model/Clearhaus} The populated <code>Clearhaus</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new Clearhaus();
            GatewayAccount.constructFromObject(data, obj);
            GatewayAccount.constructFromObject(data, obj);

            if (data.hasOwnProperty('credentials')) {
                obj['credentials'] = ClearhausAllOfCredentials.constructFromObject(data['credentials']);
            }
            if (data.hasOwnProperty('threeDSecureServer')) {
                obj['threeDSecureServer'] = Clearhaus3dsServers.constructFromObject(data['threeDSecureServer']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>Clearhaus</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Clearhaus</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of Clearhaus.RequiredProperties) {
        ...
        if (data['credentials']) { // data not null
          ClearhausAllOfCredentials.validateJSON(data['credentials']);
        }
        // validate the optional field `threeDSecureServer`
        if (data['threeDSecureServer']) { // data not null
          Clearhaus3dsServers.validateJSON(data['threeDSecureServer']);
        }
...
Clearhaus.RequiredProperties = ["credentials", "acceptedCurrencies", "gatewayName", "method"];

/**
 * @member {module:model/ClearhausAllOfCredentials} credentials
 */
Clearhaus.prototype['credentials'] = undefined;

/**
 * @member {module:model/Clearhaus3dsServers} threeDSecureServer
 */
Clearhaus.prototype['threeDSecureServer'] = undefined;
