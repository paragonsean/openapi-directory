...
import MyFatoorahAllOfCredentials from './MyFatoorahAllOfCredentials';
import PaymentCardBrand from './PaymentCardBrand';
import PaymentMethod from './PaymentMethod';

/**
 * The MyFatoorah model module.
 * @module model/MyFatoorah
 * @version 2.1
 */
class MyFatoorah {
    /**
     * Constructs a new <code>MyFatoorah</code>.
     * MyFatoorah config.
     * @alias module:model/MyFatoorah
     ...
     * @param credentials {module:model/MyFatoorahAllOfCredentials} 
     */
    constructor(acceptedCurrencies, gatewayName, method, credentials) { 
        ...
        MyFatoorah.initialize(this, acceptedCurrencies, gatewayName, method, credentials);
    }
    ...
    /**
     * Constructs a <code>MyFatoorah</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/MyFatoorah} obj Optional instance to populate.
     * @return {module:model/MyFatoorah} The populated <code>MyFatoorah</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new MyFatoorah();
            GatewayAccount.constructFromObject(data, obj);
            GatewayAccount.constructFromObject(data, obj);

            if (data.hasOwnProperty('credentials')) {
                obj['credentials'] = MyFatoorahAllOfCredentials.constructFromObject(data['credentials']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>MyFatoorah</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>MyFatoorah</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of MyFatoorah.RequiredProperties) {
        ...
        if (data['credentials']) { // data not null
          MyFatoorahAllOfCredentials.validateJSON(data['credentials']);
        }
...
MyFatoorah.RequiredProperties = ["credentials", "acceptedCurrencies", "gatewayName", "method"];

/**
 * @member {module:model/MyFatoorahAllOfCredentials} credentials
 */
MyFatoorah.prototype['credentials'] = undefined;
