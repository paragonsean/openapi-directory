...
import PlugnpayAllOfCredentials from './PlugnpayAllOfCredentials';

/**
 * The Plugnpay model module.
 * @module model/Plugnpay
 * @version 2.1
 */
class Plugnpay {
    /**
     * Constructs a new <code>Plugnpay</code>.
     * Plugnpay Gateway config.
     * @alias module:model/Plugnpay
     ...
     * @param credentials {module:model/PlugnpayAllOfCredentials} 
     */
    constructor(acceptedCurrencies, gatewayName, method, credentials) { 
        ...
        Plugnpay.initialize(this, acceptedCurrencies, gatewayName, method, credentials);
    }
    ...
    /**
     * Constructs a <code>Plugnpay</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Plugnpay} obj Optional instance to populate.
     * @return {module:model/Plugnpay} The populated <code>Plugnpay</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new Plugnpay();
            GatewayAccount.constructFromObject(data, obj);
            GatewayAccount.constructFromObject(data, obj);

            if (data.hasOwnProperty('credentials')) {
                obj['credentials'] = PlugnpayAllOfCredentials.constructFromObject(data['credentials']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>Plugnpay</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Plugnpay</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of Plugnpay.RequiredProperties) {
        ...
        if (data['credentials']) { // data not null
          PlugnpayAllOfCredentials.validateJSON(data['credentials']);
        }
...
Plugnpay.RequiredProperties = ["credentials", "acceptedCurrencies", "gatewayName", "method"];

/**
 * @member {module:model/PlugnpayAllOfCredentials} credentials
 */
Plugnpay.prototype['credentials'] = undefined;
