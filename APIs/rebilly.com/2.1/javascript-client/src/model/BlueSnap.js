...
import BlueSnapAllOfCredentials from './BlueSnapAllOfCredentials';
...
/**
 * The BlueSnap model module.
 * @module model/BlueSnap
 * @version 2.1
 */
class BlueSnap {
    /**
     * Constructs a new <code>BlueSnap</code>.
     * BlueSnap config.
     * @alias module:model/BlueSnap
     ...
     * @param credentials {module:model/BlueSnapAllOfCredentials} 
     */
    constructor(acceptedCurrencies, gatewayName, method, credentials) { 
        ...
        BlueSnap.initialize(this, acceptedCurrencies, gatewayName, method, credentials);
    }
    ...
    /**
     * Constructs a <code>BlueSnap</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/BlueSnap} obj Optional instance to populate.
     * @return {module:model/BlueSnap} The populated <code>BlueSnap</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new BlueSnap();
            GatewayAccount.constructFromObject(data, obj);
            GatewayAccount.constructFromObject(data, obj);

            if (data.hasOwnProperty('credentials')) {
                obj['credentials'] = BlueSnapAllOfCredentials.constructFromObject(data['credentials']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>BlueSnap</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>BlueSnap</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of BlueSnap.RequiredProperties) {
        ...
        if (data['credentials']) { // data not null
          BlueSnapAllOfCredentials.validateJSON(data['credentials']);
        }
...
BlueSnap.RequiredProperties = ["credentials", "acceptedCurrencies", "gatewayName", "method"];

/**
 * @member {module:model/BlueSnapAllOfCredentials} credentials
 */
BlueSnap.prototype['credentials'] = undefined;
