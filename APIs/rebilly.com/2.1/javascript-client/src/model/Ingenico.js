...
import IngenicoAllOfCredentials from './IngenicoAllOfCredentials';
import PaymentCardBrand from './PaymentCardBrand';
import PaymentMethod from './PaymentMethod';

/**
 * The Ingenico model module.
 * @module model/Ingenico
 * @version 2.1
 */
class Ingenico {
    /**
     * Constructs a new <code>Ingenico</code>.
     * Ingenico Gateway config.
     * @alias module:model/Ingenico
     ...
     * @param credentials {module:model/IngenicoAllOfCredentials} 
     */
    constructor(acceptedCurrencies, gatewayName, method, credentials) { 
        ...
        Ingenico.initialize(this, acceptedCurrencies, gatewayName, method, credentials);
    }
    ...
    /**
     * Constructs a <code>Ingenico</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Ingenico} obj Optional instance to populate.
     * @return {module:model/Ingenico} The populated <code>Ingenico</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new Ingenico();
            GatewayAccount.constructFromObject(data, obj);
            GatewayAccount.constructFromObject(data, obj);

            if (data.hasOwnProperty('credentials')) {
                obj['credentials'] = IngenicoAllOfCredentials.constructFromObject(data['credentials']);
            }
            if (data.hasOwnProperty('threeDSecureServer')) {
                obj['threeDSecureServer'] = Ingenico3dsServers.constructFromObject(data['threeDSecureServer']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>Ingenico</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Ingenico</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of Ingenico.RequiredProperties) {
        ...
        if (data['credentials']) { // data not null
          IngenicoAllOfCredentials.validateJSON(data['credentials']);
        }
        // validate the optional field `threeDSecureServer`
        if (data['threeDSecureServer']) { // data not null
          Ingenico3dsServers.validateJSON(data['threeDSecureServer']);
        }
...
Ingenico.RequiredProperties = ["credentials", "acceptedCurrencies", "gatewayName", "method"];

/**
 * @member {module:model/IngenicoAllOfCredentials} credentials
 */
Ingenico.prototype['credentials'] = undefined;

/**
 * @member {module:model/Ingenico3dsServers} threeDSecureServer
 */
Ingenico.prototype['threeDSecureServer'] = undefined;
