...
import NuaPayAllOfCredentials from './NuaPayAllOfCredentials';
import PaymentCardBrand from './PaymentCardBrand';
import PaymentMethod from './PaymentMethod';

/**
 * The NuaPay model module.
 * @module model/NuaPay
 * @version 2.1
 */
class NuaPay {
    /**
     * Constructs a new <code>NuaPay</code>.
     * NuaPay Gateway config.
     * @alias module:model/NuaPay
     ...
     * @param credentials {module:model/NuaPayAllOfCredentials} 
     */
    constructor(acceptedCurrencies, gatewayName, method, credentials) { 
        ...
        NuaPay.initialize(this, acceptedCurrencies, gatewayName, method, credentials);
    }
    ...
    /**
     * Constructs a <code>NuaPay</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/NuaPay} obj Optional instance to populate.
     * @return {module:model/NuaPay} The populated <code>NuaPay</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('credentials')) {
                obj['credentials'] = NuaPayAllOfCredentials.constructFromObject(data['credentials']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>NuaPay</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>NuaPay</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of NuaPay.RequiredProperties) {
        ...
        if (data['credentials']) { // data not null
          NuaPayAllOfCredentials.validateJSON(data['credentials']);
        }
...
NuaPay.RequiredProperties = ["credentials", "acceptedCurrencies", "gatewayName", "method"];

/**
 * @member {module:model/NuaPayAllOfCredentials} credentials
 */
NuaPay.prototype['credentials'] = undefined;
