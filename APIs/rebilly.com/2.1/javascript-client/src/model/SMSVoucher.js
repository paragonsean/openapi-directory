...
import SMSVoucherAllOfCredentials from './SMSVoucherAllOfCredentials';

/**
 * The SMSVoucher model module.
 * @module model/SMSVoucher
 * @version 2.1
 */
class SMSVoucher {
    /**
     * Constructs a new <code>SMSVoucher</code>.
     * SMSVoucher Gateway config.
     * @alias module:model/SMSVoucher
     ...
     * @param credentials {module:model/SMSVoucherAllOfCredentials} 
     */
    constructor(acceptedCurrencies, gatewayName, method, credentials) { 
        ...
        SMSVoucher.initialize(this, acceptedCurrencies, gatewayName, method, credentials);
    }
    ...
    /**
     * Constructs a <code>SMSVoucher</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SMSVoucher} obj Optional instance to populate.
     * @return {module:model/SMSVoucher} The populated <code>SMSVoucher</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SMSVoucher();
            GatewayAccount.constructFromObject(data, obj);
            GatewayAccount.constructFromObject(data, obj);

            if (data.hasOwnProperty('credentials')) {
                obj['credentials'] = SMSVoucherAllOfCredentials.constructFromObject(data['credentials']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>SMSVoucher</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SMSVoucher</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of SMSVoucher.RequiredProperties) {
        ...
        if (data['credentials']) { // data not null
          SMSVoucherAllOfCredentials.validateJSON(data['credentials']);
        }
...
SMSVoucher.RequiredProperties = ["credentials", "acceptedCurrencies", "gatewayName", "method"];

/**
 * @member {module:model/SMSVoucherAllOfCredentials} credentials
 */
SMSVoucher.prototype['credentials'] = undefined;
