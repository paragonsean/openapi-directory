...
import CayanAllOfCredentials from './CayanAllOfCredentials';
...
/**
 * The Cayan model module.
 * @module model/Cayan
 * @version 2.1
 */
class Cayan {
    /**
     * Constructs a new <code>Cayan</code>.
     * Cayan Gateway config.
     * @alias module:model/Cayan
     ...
     * @param credentials {module:model/CayanAllOfCredentials} 
     */
    constructor(acceptedCurrencies, gatewayName, method, credentials) { 
        ...
        Cayan.initialize(this, acceptedCurrencies, gatewayName, method, credentials);
    }
    ...
    /**
     * Constructs a <code>Cayan</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Cayan} obj Optional instance to populate.
     * @return {module:model/Cayan} The populated <code>Cayan</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('credentials')) {
                obj['credentials'] = CayanAllOfCredentials.constructFromObject(data['credentials']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>Cayan</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Cayan</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of Cayan.RequiredProperties) {
        ...
        if (data['credentials']) { // data not null
          CayanAllOfCredentials.validateJSON(data['credentials']);
        }
...
Cayan.RequiredProperties = ["credentials", "acceptedCurrencies", "gatewayName", "method"];

/**
 * @member {module:model/CayanAllOfCredentials} credentials
 */
Cayan.prototype['credentials'] = undefined;
