...
class SubscriptionMetadata {
    ...
    constructor() { 
        ...
        SubscriptionMetadata.initialize(this);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SubscriptionMetadata();
    ...
    /**
     * Validates the JSON data with respect to <code>SubscriptionMetadata</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SubscriptionMetadata</code>.
     */
