...
import PayrAllOfCredentials from './PayrAllOfCredentials';

/**
 * The Payr model module.
 * @module model/Payr
 * @version 2.1
 */
class Payr {
    /**
     * Constructs a new <code>Payr</code>.
     * Payr Gateway config.
     * @alias module:model/Payr
     ...
     * @param credentials {module:model/PayrAllOfCredentials} 
     */
    constructor(acceptedCurrencies, gatewayName, method, credentials) { 
        ...
        Payr.initialize(this, acceptedCurrencies, gatewayName, method, credentials);
    }
    ...
    /**
     * Constructs a <code>Payr</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Payr} obj Optional instance to populate.
     * @return {module:model/Payr} The populated <code>Payr</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('credentials')) {
                obj['credentials'] = PayrAllOfCredentials.constructFromObject(data['credentials']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>Payr</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Payr</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of Payr.RequiredProperties) {
        ...
        if (data['credentials']) { // data not null
          PayrAllOfCredentials.validateJSON(data['credentials']);
        }
...
Payr.RequiredProperties = ["credentials", "acceptedCurrencies", "gatewayName", "method"];

/**
 * @member {module:model/PayrAllOfCredentials} credentials
 */
Payr.prototype['credentials'] = undefined;
