...
/**
 * The CommonPlan model module.
 * @module model/CommonPlan
 * @version 2.1
 */
class CommonPlan {
    /**
     * Constructs a new <code>CommonPlan</code>.
     * @alias module:model/CommonPlan
     ...
     */
    constructor(currency, name, pricing, productId) { 
     ...
     */
    static initialize(obj, currency, name, pricing, productId) { 
    ...
    /**
     * Constructs a <code>CommonPlan</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CommonPlan} obj Optional instance to populate.
     * @return {module:model/CommonPlan} The populated <code>CommonPlan</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CommonPlan();
    ...
    /**
     * Validates the JSON data with respect to <code>CommonPlan</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CommonPlan</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CommonPlan.RequiredProperties) {
...
CommonPlan.RequiredProperties = ["currency", "name", "pricing", "productId"];
