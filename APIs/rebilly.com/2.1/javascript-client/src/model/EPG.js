...
import EPGAllOfCredentials from './EPGAllOfCredentials';
...
/**
 * The EPG model module.
 * @module model/EPG
 * @version 2.1
 */
class EPG {
    /**
     * Constructs a new <code>EPG</code>.
     * EPG config.
     * @alias module:model/EPG
     ...
     * @param credentials {module:model/EPGAllOfCredentials} 
     */
    constructor(acceptedCurrencies, gatewayName, method, credentials) { 
        ...
        EPG.initialize(this, acceptedCurrencies, gatewayName, method, credentials);
    }
    ...
    /**
     * Constructs a <code>EPG</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/EPG} obj Optional instance to populate.
     * @return {module:model/EPG} The populated <code>EPG</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('credentials')) {
                obj['credentials'] = EPGAllOfCredentials.constructFromObject(data['credentials']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>EPG</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EPG</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of EPG.RequiredProperties) {
        ...
        if (data['credentials']) { // data not null
          EPGAllOfCredentials.validateJSON(data['credentials']);
        }
...
EPG.RequiredProperties = ["credentials", "acceptedCurrencies", "gatewayName", "method"];

/**
 * @member {module:model/EPGAllOfCredentials} credentials
 */
EPG.prototype['credentials'] = undefined;
