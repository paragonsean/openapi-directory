...
import AirpayAllOfCredentials from './AirpayAllOfCredentials';
...
/**
 * The Airpay model module.
 * @module model/Airpay
 * @version 2.1
 */
class Airpay {
    /**
     * Constructs a new <code>Airpay</code>.
     * Airpay config.
     * @alias module:model/Airpay
     ...
     * @param credentials {module:model/AirpayAllOfCredentials} 
     */
    constructor(acceptedCurrencies, gatewayName, method, credentials) { 
        ...
        Airpay.initialize(this, acceptedCurrencies, gatewayName, method, credentials);
    }
    ...
    /**
     * Constructs a <code>Airpay</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Airpay} obj Optional instance to populate.
     * @return {module:model/Airpay} The populated <code>Airpay</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('credentials')) {
                obj['credentials'] = AirpayAllOfCredentials.constructFromObject(data['credentials']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>Airpay</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Airpay</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of Airpay.RequiredProperties) {
        ...
        if (data['credentials']) { // data not null
          AirpayAllOfCredentials.validateJSON(data['credentials']);
        }
...
Airpay.RequiredProperties = ["credentials", "acceptedCurrencies", "gatewayName", "method"];

/**
 * @member {module:model/AirpayAllOfCredentials} credentials
 */
Airpay.prototype['credentials'] = undefined;
