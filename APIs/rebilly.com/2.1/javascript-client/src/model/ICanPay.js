...
import ICanPayAllOfCredentials from './ICanPayAllOfCredentials';
...
/**
 * The ICanPay model module.
 * @module model/ICanPay
 * @version 2.1
 */
class ICanPay {
    /**
     * Constructs a new <code>ICanPay</code>.
     * iCanPay Gateway config.
     * @alias module:model/ICanPay
     ...
     * @param credentials {module:model/ICanPayAllOfCredentials} 
     */
    constructor(acceptedCurrencies, gatewayName, method, credentials) { 
        ...
        ICanPay.initialize(this, acceptedCurrencies, gatewayName, method, credentials);
    }
    ...
    /**
     * Constructs a <code>ICanPay</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ICanPay} obj Optional instance to populate.
     * @return {module:model/ICanPay} The populated <code>ICanPay</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('credentials')) {
                obj['credentials'] = ICanPayAllOfCredentials.constructFromObject(data['credentials']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>ICanPay</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ICanPay</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ICanPay.RequiredProperties) {
        ...
        if (data['credentials']) { // data not null
          ICanPayAllOfCredentials.validateJSON(data['credentials']);
        }
...
ICanPay.RequiredProperties = ["credentials", "acceptedCurrencies", "gatewayName", "method"];

/**
 * @member {module:model/ICanPayAllOfCredentials} credentials
 */
ICanPay.prototype['credentials'] = undefined;

/**
 * @member {module:model/PaymenTechnologiesAllOfSettings} settings
 */
ICanPay.prototype['settings'] = undefined;
