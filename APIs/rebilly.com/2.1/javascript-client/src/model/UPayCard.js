...
import UPayCardAllOfCredentials from './UPayCardAllOfCredentials';
import UPayCardAllOfSettings from './UPayCardAllOfSettings';

/**
 * The UPayCard model module.
 * @module model/UPayCard
 * @version 2.1
 */
class UPayCard {
    /**
     * Constructs a new <code>UPayCard</code>.
     * UPayCard Gateway config.
     * @alias module:model/UPayCard
     ...
     * @param credentials {module:model/UPayCardAllOfCredentials} 
     */
    constructor(acceptedCurrencies, gatewayName, method, credentials) { 
        ...
        UPayCard.initialize(this, acceptedCurrencies, gatewayName, method, credentials);
    }
    ...
    /**
     * Constructs a <code>UPayCard</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UPayCard} obj Optional instance to populate.
     * @return {module:model/UPayCard} The populated <code>UPayCard</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UPayCard();
            GatewayAccount.constructFromObject(data, obj);
            GatewayAccount.constructFromObject(data, obj);

            if (data.hasOwnProperty('credentials')) {
                obj['credentials'] = UPayCardAllOfCredentials.constructFromObject(data['credentials']);
            }
            if (data.hasOwnProperty('settings')) {
                obj['settings'] = UPayCardAllOfSettings.constructFromObject(data['settings']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>UPayCard</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UPayCard</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of UPayCard.RequiredProperties) {
        ...
        if (data['credentials']) { // data not null
          UPayCardAllOfCredentials.validateJSON(data['credentials']);
        }
        // validate the optional field `settings`
        if (data['settings']) { // data not null
          UPayCardAllOfSettings.validateJSON(data['settings']);
        }
...
UPayCard.RequiredProperties = ["credentials", "acceptedCurrencies", "gatewayName", "method"];

/**
 * @member {module:model/UPayCardAllOfCredentials} credentials
 */
UPayCard.prototype['credentials'] = undefined;

/**
 * @member {module:model/UPayCardAllOfSettings} settings
 */
UPayCard.prototype['settings'] = undefined;
