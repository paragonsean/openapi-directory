...
export default class PaymentMethod {
        ...
        /**
         * value: "Interac-express-connect"
         * @const
         */
        "Interac-express-connect" = "Interac-express-connect";
         ...
         * @const
         */
        "LPG-online" = "LPG-online";

    
        /**
         * value: "LPG-payment-card"
         * @const
         */
        "LPG-payment-card" = "LPG-payment-card";
