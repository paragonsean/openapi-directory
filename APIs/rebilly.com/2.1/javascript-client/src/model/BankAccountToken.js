...
/**
 * The BankAccountToken model module.
 * @module model/BankAccountToken
 * @version 2.1
 */
class BankAccountToken {
    /**
     * Constructs a new <code>BankAccountToken</code>.
     * @alias module:model/BankAccountToken
     * @implements module:model/CommonPaymentToken
     * @param method {String} 
     */
    constructor(method) { 
        CommonPaymentToken.initialize(this, method);
        BankAccountToken.initialize(this, method);
    }
    ...
    /**
     * Constructs a <code>BankAccountToken</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/BankAccountToken} obj Optional instance to populate.
     * @return {module:model/BankAccountToken} The populated <code>BankAccountToken</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new BankAccountToken();
            ...
            if (data.hasOwnProperty('paymentInstrument')) {
                obj['paymentInstrument'] = BankAccountInstrument.constructFromObject(data['paymentInstrument']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>BankAccountToken</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>BankAccountToken</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of BankAccountToken.RequiredProperties) {
        ...
        if (data['paymentInstrument']) { // data not null
          BankAccountInstrument.validateJSON(data['paymentInstrument']);
        }
...
BankAccountToken.RequiredProperties = ["billingAddress", "method", "paymentInstrument"];

/**
 * The billing address object.
 * @member {module:model/ContactObject} billingAddress
 */
BankAccountToken.prototype['billingAddress'] = undefined;

/**
 * The token payment method.
 * @member {module:model/BankAccountToken.MethodEnum} method
 */
BankAccountToken.prototype['method'] = undefined;

/**
 * @member {module:model/BankAccountInstrument} paymentInstrument
 */
BankAccountToken.prototype['paymentInstrument'] = undefined;

/**
 * The links related to resource.
 * @member {Array.<module:model/SelfLink>} _links
 */
BankAccountToken.prototype['_links'] = undefined;

/**
 * Token created time.
 * @member {Date} createdTime
 */
BankAccountToken.prototype['createdTime'] = undefined;

/**
 * Token expiration time.
 * @member {Date} expirationTime
 */
BankAccountToken.prototype['expirationTime'] = undefined;

/**
 * The token identifier string.
 * @member {String} id
 */
BankAccountToken.prototype['id'] = undefined;
 ...
 * @default false
 */
BankAccountToken.prototype['isUsed'] = false;

/**
 * @member {module:model/LeadSource} leadSource
 */
BankAccountToken.prototype['leadSource'] = undefined;

/**
 * @member {module:model/RiskMetadata} riskMetadata
 */
BankAccountToken.prototype['riskMetadata'] = undefined;

/**
 * Token updated time.
 * @member {Date} updatedTime
 */
BankAccountToken.prototype['updatedTime'] = undefined;

/**
 * Token usage time.
 * @member {Date} usageTime
 */
BankAccountToken.prototype['usageTime'] = undefined;
...
export default BankAccountToken;
