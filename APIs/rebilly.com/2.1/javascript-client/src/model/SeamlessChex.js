...
import SeamlessChexAllOfCredentials from './SeamlessChexAllOfCredentials';

/**
 * The SeamlessChex model module.
 * @module model/SeamlessChex
 * @version 2.1
 */
class SeamlessChex {
    /**
     * Constructs a new <code>SeamlessChex</code>.
     * SeamlessChex config.
     * @alias module:model/SeamlessChex
     ...
     * @param credentials {module:model/SeamlessChexAllOfCredentials} 
     */
    constructor(acceptedCurrencies, gatewayName, method, credentials) { 
        ...
        SeamlessChex.initialize(this, acceptedCurrencies, gatewayName, method, credentials);
    }
    ...
    /**
     * Constructs a <code>SeamlessChex</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SeamlessChex} obj Optional instance to populate.
     * @return {module:model/SeamlessChex} The populated <code>SeamlessChex</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SeamlessChex();
            GatewayAccount.constructFromObject(data, obj);
            GatewayAccount.constructFromObject(data, obj);

            if (data.hasOwnProperty('credentials')) {
                obj['credentials'] = SeamlessChexAllOfCredentials.constructFromObject(data['credentials']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>SeamlessChex</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SeamlessChex</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of SeamlessChex.RequiredProperties) {
        ...
        if (data['credentials']) { // data not null
          SeamlessChexAllOfCredentials.validateJSON(data['credentials']);
        }
...
SeamlessChex.RequiredProperties = ["credentials", "acceptedCurrencies", "gatewayName", "method"];

/**
 * @member {module:model/SeamlessChexAllOfCredentials} credentials
 */
SeamlessChex.prototype['credentials'] = undefined;
