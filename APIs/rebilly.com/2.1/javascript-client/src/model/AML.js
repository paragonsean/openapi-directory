...
import AMLAddressInner from './AMLAddressInner';
import AMLAliasesInner from './AMLAliasesInner';
import AMLPassportInner from './AMLPassportInner';
import SelfLink from './SelfLink';

/**
 * The AML model module.
 * @module model/AML
 * @version 2.1
 */
class AML {
    /**
     * Constructs a new <code>AML</code>.
     * @alias module:model/AML
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>AML</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AML} obj Optional instance to populate.
     * @return {module:model/AML} The populated <code>AML</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('address')) {
                obj['address'] = ApiClient.convertToType(data['address'], [AMLAddressInner]);
            }
            if (data.hasOwnProperty('aliases')) {
                obj['aliases'] = ApiClient.convertToType(data['aliases'], [AMLAliasesInner]);
            }
            ...
            if (data.hasOwnProperty('passport')) {
                obj['passport'] = ApiClient.convertToType(data['passport'], [AMLPassportInner]);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>AML</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AML</code>.
     */
    static validateJSON(data) {
        ...
        if (data['address']) { // data not null
            ...
            for (const item of data['address']) {
                AMLAddressInner.validateJSON(item);
            };
        }
        if (data['aliases']) { // data not null
            ...
            for (const item of data['aliases']) {
                AMLAliasesInner.validateJSON(item);
            };
        }
        ...
        // ensure the json data is an array
        if (!Array.isArray(data['legalBasis'])) {
            throw new Error("Expected the field `legalBasis` to be an array in the JSON data but got " + data['legalBasis']);
        }
        // ensure the json data is a string
        ...
        if (data['passport']) { // data not null
            ...
            if (!Array.isArray(data['passport'])) {
                throw new Error("Expected the field `passport` to be an array in the JSON data but got " + data['passport']);
            }
            // validate the optional field `passport` (array)
            for (const item of data['passport']) {
                AMLPassportInner.validateJSON(item);
            };
        }
        // ensure the json data is a string
 ...
 */
AML.prototype['_links'] = undefined;

/**
 * Addresses related to the identity.
 * @member {Array.<module:model/AMLAddressInner>} address
 */
AML.prototype['address'] = undefined;

/**
 * List of aliases, if any.
 * @member {Array.<module:model/AMLAliasesInner>} aliases
 */
AML.prototype['aliases'] = undefined;

/**
 * Extra information (the content varies per list).
 * @member {String} comments
 */
AML.prototype['comments'] = undefined;

/**
 * The source list's confidence in information.
 * @member {module:model/AML.ConfidenceEnum} confidence
 */
AML.prototype['confidence'] = undefined;

/**
 * One or more possible dates of birth.
 * @member {Array.<Date>} dob
 */
AML.prototype['dob'] = undefined;

/**
 * First Name.
 * @member {String} firstName
 */
AML.prototype['firstName'] = undefined;

/**
 * Gender of returned identity (if `type` is `individual`).
 * @member {String} gender
 */
AML.prototype['gender'] = undefined;

/**
 * Last Name. `null` if it is a single-name entity.
 * @member {String} lastName
 */
AML.prototype['lastName'] = undefined;

/**
 * List of references to legal documents if they exist.
 * @member {Array.<String>} legalBasis
 */
AML.prototype['legalBasis'] = undefined;

/**
 * The nationality of the identity.
 * @member {String} nationality
 */
AML.prototype['nationality'] = undefined;

/**
 * Passport information.
 * @member {Array.<module:model/AMLPassportInner>} passport
 */
AML.prototype['passport'] = undefined;

/**
 * Regime.
 * @member {String} regime
 */
AML.prototype['regime'] = undefined;

/**
 * Which list this came from.
 * @member {String} source
 */
AML.prototype['source'] = undefined;

/**
 * The list type.
 * @member {module:model/AML.SourceTypeEnum} sourceType
 */
AML.prototype['sourceType'] = undefined;

/**
 * The title of their position.
 * @member {Array.<String>} title
 */
AML.prototype['title'] = undefined;

/**
 * The record type.
 * @member {module:model/AML.TypeEnum} type
 */
AML.prototype['type'] = undefined;
