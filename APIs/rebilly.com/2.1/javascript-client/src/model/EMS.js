...
import EMSAllOfCredentials from './EMSAllOfCredentials';
import EMSAllOfSettings from './EMSAllOfSettings';
...
/**
 * The EMS model module.
 * @module model/EMS
 * @version 2.1
 */
class EMS {
    /**
     * Constructs a new <code>EMS</code>.
     * EMS e-Commerce (XML) API config.
     * @alias module:model/EMS
     ...
     * @param credentials {module:model/EMSAllOfCredentials} 
     */
    constructor(acceptedCurrencies, gatewayName, method, credentials) { 
        ...
        EMS.initialize(this, acceptedCurrencies, gatewayName, method, credentials);
    }
    ...
    /**
     * Constructs a <code>EMS</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/EMS} obj Optional instance to populate.
     * @return {module:model/EMS} The populated <code>EMS</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('credentials')) {
                obj['credentials'] = EMSAllOfCredentials.constructFromObject(data['credentials']);
            }
            if (data.hasOwnProperty('settings')) {
                obj['settings'] = EMSAllOfSettings.constructFromObject(data['settings']);
            }
            if (data.hasOwnProperty('threeDSecureServer')) {
                obj['threeDSecureServer'] = EMS3dsServers.constructFromObject(data['threeDSecureServer']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>EMS</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EMS</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of EMS.RequiredProperties) {
        ...
        if (data['credentials']) { // data not null
          EMSAllOfCredentials.validateJSON(data['credentials']);
        }
        // validate the optional field `settings`
        if (data['settings']) { // data not null
          EMSAllOfSettings.validateJSON(data['settings']);
        }
        // validate the optional field `threeDSecureServer`
        if (data['threeDSecureServer']) { // data not null
          EMS3dsServers.validateJSON(data['threeDSecureServer']);
        }
...
EMS.RequiredProperties = ["credentials", "acceptedCurrencies", "gatewayName", "method"];

/**
 * @member {module:model/EMSAllOfCredentials} credentials
 */
EMS.prototype['credentials'] = undefined;

/**
 * @member {module:model/EMSAllOfSettings} settings
 */
EMS.prototype['settings'] = undefined;

/**
 * @member {module:model/EMS3dsServers} threeDSecureServer
 */
EMS.prototype['threeDSecureServer'] = undefined;
