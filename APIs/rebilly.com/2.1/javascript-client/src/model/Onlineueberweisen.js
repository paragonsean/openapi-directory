...
import OnlineueberweisenAllOfCredentials from './OnlineueberweisenAllOfCredentials';
import OnlineueberweisenAllOfSettings from './OnlineueberweisenAllOfSettings';
import PaymentCardBrand from './PaymentCardBrand';
import PaymentMethod from './PaymentMethod';

/**
 * The Onlineueberweisen model module.
 * @module model/Onlineueberweisen
 * @version 2.1
 */
class Onlineueberweisen {
    /**
     * Constructs a new <code>Onlineueberweisen</code>.
     * Onlineueberweisen config.
     * @alias module:model/Onlineueberweisen
     ...
     * @param credentials {module:model/OnlineueberweisenAllOfCredentials} 
     * @param settings {module:model/OnlineueberweisenAllOfSettings} 
     */
    constructor(acceptedCurrencies, gatewayName, method, credentials, settings) { 
        ...
        Onlineueberweisen.initialize(this, acceptedCurrencies, gatewayName, method, credentials, settings);
    }
    ...
    /**
     * Constructs a <code>Onlineueberweisen</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Onlineueberweisen} obj Optional instance to populate.
     * @return {module:model/Onlineueberweisen} The populated <code>Onlineueberweisen</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new Onlineueberweisen();
            GatewayAccount.constructFromObject(data, obj);
            GatewayAccount.constructFromObject(data, obj);

            if (data.hasOwnProperty('credentials')) {
                obj['credentials'] = OnlineueberweisenAllOfCredentials.constructFromObject(data['credentials']);
            }
            if (data.hasOwnProperty('settings')) {
                obj['settings'] = OnlineueberweisenAllOfSettings.constructFromObject(data['settings']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>Onlineueberweisen</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Onlineueberweisen</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of Onlineueberweisen.RequiredProperties) {
        ...
        if (data['credentials']) { // data not null
          OnlineueberweisenAllOfCredentials.validateJSON(data['credentials']);
        }
        // validate the optional field `settings`
        if (data['settings']) { // data not null
          OnlineueberweisenAllOfSettings.validateJSON(data['settings']);
        }
...
Onlineueberweisen.RequiredProperties = ["credentials", "settings", "acceptedCurrencies", "gatewayName", "method"];

/**
 * @member {module:model/OnlineueberweisenAllOfCredentials} credentials
 */
Onlineueberweisen.prototype['credentials'] = undefined;

/**
 * @member {module:model/OnlineueberweisenAllOfSettings} settings
 */
Onlineueberweisen.prototype['settings'] = undefined;
...
export default Onlineueberweisen;
