...
/**
 * The AlternativePaymentToken model module.
 * @module model/AlternativePaymentToken
 * @version 2.1
 */
class AlternativePaymentToken {
    /**
     * Constructs a new <code>AlternativePaymentToken</code>.
     * @alias module:model/AlternativePaymentToken
     * @implements module:model/CommonPaymentToken
     * @param method {String} 
     */
    constructor(method) { 
        CommonPaymentToken.initialize(this, method);
        AlternativePaymentToken.initialize(this, method);
    }
    ...
    /**
     * Constructs a <code>AlternativePaymentToken</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AlternativePaymentToken} obj Optional instance to populate.
     * @return {module:model/AlternativePaymentToken} The populated <code>AlternativePaymentToken</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AlternativePaymentToken();
            ...
            if (data.hasOwnProperty('method')) {
                obj['method'] = ApiClient.convertToType(data['method'], AlternativePaymentMethods);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>AlternativePaymentToken</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AlternativePaymentToken</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of AlternativePaymentToken.RequiredProperties) {
...
AlternativePaymentToken.RequiredProperties = ["billingAddress", "method"];

/**
 * The billing address object.
 * @member {module:model/ContactObject} billingAddress
 */
AlternativePaymentToken.prototype['billingAddress'] = undefined;

/**
 * The token payment method.
 * @member {module:model/AlternativePaymentMethods} method
 */
AlternativePaymentToken.prototype['method'] = undefined;

/**
 * The links related to resource.
 * @member {Array.<module:model/SelfLink>} _links
 */
AlternativePaymentToken.prototype['_links'] = undefined;

/**
 * Token created time.
 * @member {Date} createdTime
 */
AlternativePaymentToken.prototype['createdTime'] = undefined;

/**
 * Token expiration time.
 * @member {Date} expirationTime
 */
AlternativePaymentToken.prototype['expirationTime'] = undefined;

/**
 * The token identifier string.
 * @member {String} id
 */
AlternativePaymentToken.prototype['id'] = undefined;
 ...
 * @default false
 */
AlternativePaymentToken.prototype['isUsed'] = false;

/**
 * @member {module:model/LeadSource} leadSource
 */
AlternativePaymentToken.prototype['leadSource'] = undefined;

/**
 * @member {module:model/RiskMetadata} riskMetadata
 */
AlternativePaymentToken.prototype['riskMetadata'] = undefined;

/**
 * Token updated time.
 * @member {Date} updatedTime
 */
AlternativePaymentToken.prototype['updatedTime'] = undefined;

/**
 * Token usage time.
 * @member {Date} usageTime
 */
AlternativePaymentToken.prototype['usageTime'] = undefined;
...
export default AlternativePaymentToken;
