...
import EcorePayAllOfCredentials from './EcorePayAllOfCredentials';
...
/**
 * The EcorePay model module.
 * @module model/EcorePay
 * @version 2.1
 */
class EcorePay {
    /**
     * Constructs a new <code>EcorePay</code>.
     * EcorePay Gateway config.
     * @alias module:model/EcorePay
     ...
     * @param credentials {module:model/EcorePayAllOfCredentials} 
     */
    constructor(acceptedCurrencies, gatewayName, method, credentials) { 
        ...
        EcorePay.initialize(this, acceptedCurrencies, gatewayName, method, credentials);
    }
    ...
    /**
     * Constructs a <code>EcorePay</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/EcorePay} obj Optional instance to populate.
     * @return {module:model/EcorePay} The populated <code>EcorePay</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new EcorePay();
            GatewayAccount.constructFromObject(data, obj);
            GatewayAccount.constructFromObject(data, obj);

            if (data.hasOwnProperty('credentials')) {
                obj['credentials'] = EcorePayAllOfCredentials.constructFromObject(data['credentials']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>EcorePay</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EcorePay</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of EcorePay.RequiredProperties) {
        ...
        if (data['credentials']) { // data not null
          EcorePayAllOfCredentials.validateJSON(data['credentials']);
        }
...
EcorePay.RequiredProperties = ["credentials", "acceptedCurrencies", "gatewayName", "method"];

/**
 * @member {module:model/EcorePayAllOfCredentials} credentials
 */
EcorePay.prototype['credentials'] = undefined;
