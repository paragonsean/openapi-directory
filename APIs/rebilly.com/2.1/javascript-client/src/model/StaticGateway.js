...
/**
 * The StaticGateway model module.
 * @module model/StaticGateway
 * @version 2.1
 */
class StaticGateway {
    /**
     * Constructs a new <code>StaticGateway</code>.
     * StaticGateway Gateway config.
     * @alias module:model/StaticGateway
    ...
    constructor(acceptedCurrencies, gatewayName, method) { 
        ...
        StaticGateway.initialize(this, acceptedCurrencies, gatewayName, method);
    }
    ...
    /**
     * Constructs a <code>StaticGateway</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/StaticGateway} obj Optional instance to populate.
     * @return {module:model/StaticGateway} The populated <code>StaticGateway</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new StaticGateway();
    ...
    /**
     * Validates the JSON data with respect to <code>StaticGateway</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>StaticGateway</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of StaticGateway.RequiredProperties) {
...
StaticGateway.RequiredProperties = ["acceptedCurrencies", "gatewayName", "method"];
