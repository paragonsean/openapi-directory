...
import CopprAllOfCredentials from './CopprAllOfCredentials';
import CopprAllOfSettings from './CopprAllOfSettings';
...
/**
 * The Coppr model module.
 * @module model/Coppr
 * @version 2.1
 */
class Coppr {
    /**
     * Constructs a new <code>Coppr</code>.
     * Coppr config.
     * @alias module:model/Coppr
     ...
     * @param credentials {module:model/CopprAllOfCredentials} 
     */
    constructor(acceptedCurrencies, gatewayName, method, credentials) { 
        ...
        Coppr.initialize(this, acceptedCurrencies, gatewayName, method, credentials);
    }
    ...
    /**
     * Constructs a <code>Coppr</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Coppr} obj Optional instance to populate.
     * @return {module:model/Coppr} The populated <code>Coppr</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('credentials')) {
                obj['credentials'] = CopprAllOfCredentials.constructFromObject(data['credentials']);
            }
            if (data.hasOwnProperty('settings')) {
                obj['settings'] = CopprAllOfSettings.constructFromObject(data['settings']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>Coppr</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Coppr</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of Coppr.RequiredProperties) {
        ...
        if (data['credentials']) { // data not null
          CopprAllOfCredentials.validateJSON(data['credentials']);
        }
        // validate the optional field `settings`
        if (data['settings']) { // data not null
          CopprAllOfSettings.validateJSON(data['settings']);
        }
...
Coppr.RequiredProperties = ["credentials", "acceptedCurrencies", "gatewayName", "method"];

/**
 * @member {module:model/CopprAllOfCredentials} credentials
 */
Coppr.prototype['credentials'] = undefined;

/**
 * @member {module:model/CopprAllOfSettings} settings
 */
Coppr.prototype['settings'] = undefined;
