...
import IChequeAllOfCredentials from './IChequeAllOfCredentials';
import PaymentCardBrand from './PaymentCardBrand';
import PaymentMethod from './PaymentMethod';

/**
 * The ICheque model module.
 * @module model/ICheque
 * @version 2.1
 */
class ICheque {
    /**
     * Constructs a new <code>ICheque</code>.
     * iCheque Gateway config.
     * @alias module:model/ICheque
     ...
     * @param credentials {module:model/IChequeAllOfCredentials} 
     */
    constructor(acceptedCurrencies, gatewayName, method, credentials) { 
        ...
        ICheque.initialize(this, acceptedCurrencies, gatewayName, method, credentials);
    }
    ...
    /**
     * Constructs a <code>ICheque</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ICheque} obj Optional instance to populate.
     * @return {module:model/ICheque} The populated <code>ICheque</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('credentials')) {
                obj['credentials'] = IChequeAllOfCredentials.constructFromObject(data['credentials']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ICheque</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ICheque</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ICheque.RequiredProperties) {
        ...
        if (data['credentials']) { // data not null
          IChequeAllOfCredentials.validateJSON(data['credentials']);
        }
...
ICheque.RequiredProperties = ["credentials", "acceptedCurrencies", "gatewayName", "method"];

/**
 * @member {module:model/IChequeAllOfCredentials} credentials
 */
ICheque.prototype['credentials'] = undefined;
