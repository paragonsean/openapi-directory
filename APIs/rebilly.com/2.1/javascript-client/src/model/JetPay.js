...
import JetPayAllOfCredentials from './JetPayAllOfCredentials';
import PaymentCardBrand from './PaymentCardBrand';
import PaymentMethod from './PaymentMethod';

/**
 * The JetPay model module.
 * @module model/JetPay
 * @version 2.1
 */
class JetPay {
    /**
     * Constructs a new <code>JetPay</code>.
     * JetPay Gateway config.
     * @alias module:model/JetPay
     ...
     * @param credentials {module:model/JetPayAllOfCredentials} 
     */
    constructor(acceptedCurrencies, gatewayName, method, credentials) { 
        ...
        JetPay.initialize(this, acceptedCurrencies, gatewayName, method, credentials);
    }
    ...
    /**
     * Constructs a <code>JetPay</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/JetPay} obj Optional instance to populate.
     * @return {module:model/JetPay} The populated <code>JetPay</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('credentials')) {
                obj['credentials'] = JetPayAllOfCredentials.constructFromObject(data['credentials']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>JetPay</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>JetPay</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of JetPay.RequiredProperties) {
        ...
        if (data['credentials']) { // data not null
          JetPayAllOfCredentials.validateJSON(data['credentials']);
        }
...
JetPay.RequiredProperties = ["credentials", "acceptedCurrencies", "gatewayName", "method"];

/**
 * @member {module:model/JetPayAllOfCredentials} credentials
 */
JetPay.prototype['credentials'] = undefined;
