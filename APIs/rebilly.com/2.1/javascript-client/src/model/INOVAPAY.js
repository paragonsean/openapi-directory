...
import INOVAPAYAllOfCredentials from './INOVAPAYAllOfCredentials';
import PaymentCardBrand from './PaymentCardBrand';
import PaymentMethod from './PaymentMethod';

/**
 * The INOVAPAY model module.
 * @module model/INOVAPAY
 * @version 2.1
 */
class INOVAPAY {
    /**
     * Constructs a new <code>INOVAPAY</code>.
     * INOVAPAY config.
     * @alias module:model/INOVAPAY
     ...
     * @param credentials {module:model/INOVAPAYAllOfCredentials} 
     */
    constructor(acceptedCurrencies, gatewayName, method, credentials) { 
        ...
        INOVAPAY.initialize(this, acceptedCurrencies, gatewayName, method, credentials);
    }
    ...
    /**
     * Constructs a <code>INOVAPAY</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/INOVAPAY} obj Optional instance to populate.
     * @return {module:model/INOVAPAY} The populated <code>INOVAPAY</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new INOVAPAY();
            GatewayAccount.constructFromObject(data, obj);
            GatewayAccount.constructFromObject(data, obj);

            if (data.hasOwnProperty('credentials')) {
                obj['credentials'] = INOVAPAYAllOfCredentials.constructFromObject(data['credentials']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>INOVAPAY</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>INOVAPAY</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of INOVAPAY.RequiredProperties) {
        ...
        if (data['credentials']) { // data not null
          INOVAPAYAllOfCredentials.validateJSON(data['credentials']);
        }
...
INOVAPAY.RequiredProperties = ["credentials", "acceptedCurrencies", "gatewayName", "method"];

/**
 * @member {module:model/INOVAPAYAllOfCredentials} credentials
 */
INOVAPAY.prototype['credentials'] = undefined;
