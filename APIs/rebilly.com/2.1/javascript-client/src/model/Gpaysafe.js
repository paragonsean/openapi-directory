...
import GpaysafeAllOfCredentials from './GpaysafeAllOfCredentials';
import PaymentCardBrand from './PaymentCardBrand';
import PaymentMethod from './PaymentMethod';

/**
 * The Gpaysafe model module.
 * @module model/Gpaysafe
 * @version 2.1
 */
class Gpaysafe {
    /**
     * Constructs a new <code>Gpaysafe</code>.
     * Gpaysafe Gateway config.
     * @alias module:model/Gpaysafe
     ...
     * @param credentials {module:model/GpaysafeAllOfCredentials} 
     */
    constructor(acceptedCurrencies, gatewayName, method, credentials) { 
        ...
        Gpaysafe.initialize(this, acceptedCurrencies, gatewayName, method, credentials);
    }
    ...
    /**
     * Constructs a <code>Gpaysafe</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Gpaysafe} obj Optional instance to populate.
     * @return {module:model/Gpaysafe} The populated <code>Gpaysafe</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new Gpaysafe();
            GatewayAccount.constructFromObject(data, obj);
            GatewayAccount.constructFromObject(data, obj);

            if (data.hasOwnProperty('credentials')) {
                obj['credentials'] = GpaysafeAllOfCredentials.constructFromObject(data['credentials']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>Gpaysafe</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Gpaysafe</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of Gpaysafe.RequiredProperties) {
        ...
        if (data['credentials']) { // data not null
          GpaysafeAllOfCredentials.validateJSON(data['credentials']);
        }
...
Gpaysafe.RequiredProperties = ["credentials", "acceptedCurrencies", "gatewayName", "method"];

/**
 * @member {module:model/GpaysafeAllOfCredentials} credentials
 */
Gpaysafe.prototype['credentials'] = undefined;
