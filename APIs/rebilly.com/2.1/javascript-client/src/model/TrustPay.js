...
import TrustPayAllOfCredentials from './TrustPayAllOfCredentials';

/**
 * The TrustPay model module.
 * @module model/TrustPay
 * @version 2.1
 */
class TrustPay {
    /**
     * Constructs a new <code>TrustPay</code>.
     * TrustPay config.
     * @alias module:model/TrustPay
     ...
     * @param credentials {module:model/TrustPayAllOfCredentials} 
     */
    constructor(acceptedCurrencies, gatewayName, method, credentials) { 
        ...
        TrustPay.initialize(this, acceptedCurrencies, gatewayName, method, credentials);
    }
    ...
    /**
     * Constructs a <code>TrustPay</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/TrustPay} obj Optional instance to populate.
     * @return {module:model/TrustPay} The populated <code>TrustPay</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new TrustPay();
            GatewayAccount.constructFromObject(data, obj);
            GatewayAccount.constructFromObject(data, obj);

            if (data.hasOwnProperty('credentials')) {
                obj['credentials'] = TrustPayAllOfCredentials.constructFromObject(data['credentials']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>TrustPay</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TrustPay</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of TrustPay.RequiredProperties) {
        ...
        if (data['credentials']) { // data not null
          TrustPayAllOfCredentials.validateJSON(data['credentials']);
        }
...
TrustPay.RequiredProperties = ["credentials", "acceptedCurrencies", "gatewayName", "method"];

/**
 * @member {module:model/TrustPayAllOfCredentials} credentials
 */
TrustPay.prototype['credentials'] = undefined;
