...
import NGeniusAllOfCredentials from './NGeniusAllOfCredentials';
import PaymentCardBrand from './PaymentCardBrand';
import PaymentMethod from './PaymentMethod';

/**
 * The NGenius model module.
 * @module model/NGenius
 * @version 2.1
 */
class NGenius {
    /**
     * Constructs a new <code>NGenius</code>.
     * NGenius config.
     * @alias module:model/NGenius
     ...
     * @param credentials {module:model/NGeniusAllOfCredentials} 
     */
    constructor(acceptedCurrencies, gatewayName, method, credentials) { 
        ...
        NGenius.initialize(this, acceptedCurrencies, gatewayName, method, credentials);
    }
    ...
    /**
     * Constructs a <code>NGenius</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/NGenius} obj Optional instance to populate.
     * @return {module:model/NGenius} The populated <code>NGenius</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('credentials')) {
                obj['credentials'] = NGeniusAllOfCredentials.constructFromObject(data['credentials']);
            }
            if (data.hasOwnProperty('threeDSecureServer')) {
                obj['threeDSecureServer'] = NGenius3dsServers.constructFromObject(data['threeDSecureServer']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>NGenius</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>NGenius</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of NGenius.RequiredProperties) {
        ...
        if (data['credentials']) { // data not null
          NGeniusAllOfCredentials.validateJSON(data['credentials']);
        }
        // validate the optional field `threeDSecureServer`
        if (data['threeDSecureServer']) { // data not null
          NGenius3dsServers.validateJSON(data['threeDSecureServer']);
        }
...
NGenius.RequiredProperties = ["credentials", "acceptedCurrencies", "gatewayName", "method"];

/**
 * @member {module:model/NGeniusAllOfCredentials} credentials
 */
NGenius.prototype['credentials'] = undefined;

/**
 * @member {module:model/NGenius3dsServers} threeDSecureServer
 */
NGenius.prototype['threeDSecureServer'] = undefined;
