...
import Ilixium3dsServers from './Ilixium3dsServers';
import IlixiumAllOfCredentials from './IlixiumAllOfCredentials';
import IlixiumAllOfSettings from './IlixiumAllOfSettings';
import PaymentCardBrand from './PaymentCardBrand';
import PaymentMethod from './PaymentMethod';

/**
 * The Ilixium model module.
 * @module model/Ilixium
 * @version 2.1
 */
class Ilixium {
    /**
     * Constructs a new <code>Ilixium</code>.
     * Ilixium Gateway config.
     * @alias module:model/Ilixium
     ...
     * @param credentials {module:model/IlixiumAllOfCredentials} 
     */
    constructor(acceptedCurrencies, gatewayName, method, credentials) { 
        ...
        Ilixium.initialize(this, acceptedCurrencies, gatewayName, method, credentials);
    }
    ...
    /**
     * Constructs a <code>Ilixium</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Ilixium} obj Optional instance to populate.
     * @return {module:model/Ilixium} The populated <code>Ilixium</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('credentials')) {
                obj['credentials'] = IlixiumAllOfCredentials.constructFromObject(data['credentials']);
            }
            if (data.hasOwnProperty('settings')) {
                obj['settings'] = IlixiumAllOfSettings.constructFromObject(data['settings']);
            }
            if (data.hasOwnProperty('threeDSecureServer')) {
                obj['threeDSecureServer'] = Ilixium3dsServers.constructFromObject(data['threeDSecureServer']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>Ilixium</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Ilixium</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of Ilixium.RequiredProperties) {
        ...
        if (data['credentials']) { // data not null
          IlixiumAllOfCredentials.validateJSON(data['credentials']);
        }
        // validate the optional field `settings`
        if (data['settings']) { // data not null
          IlixiumAllOfSettings.validateJSON(data['settings']);
        }
        // validate the optional field `threeDSecureServer`
        if (data['threeDSecureServer']) { // data not null
          Ilixium3dsServers.validateJSON(data['threeDSecureServer']);
        }
...
Ilixium.RequiredProperties = ["credentials", "acceptedCurrencies", "gatewayName", "method"];

/**
 * @member {module:model/IlixiumAllOfCredentials} credentials
 */
Ilixium.prototype['credentials'] = undefined;

/**
 * @member {module:model/IlixiumAllOfSettings} settings
 */
Ilixium.prototype['settings'] = undefined;

/**
 * @member {module:model/Ilixium3dsServers} threeDSecureServer
 */
Ilixium.prototype['threeDSecureServer'] = undefined;
