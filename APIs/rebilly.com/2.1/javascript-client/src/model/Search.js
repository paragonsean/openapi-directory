...
class Search {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('orders')) {
                obj['orders'] = ApiClient.convertToType(data['orders'], [Subscription]);
            }
            if (data.hasOwnProperty('searched')) {
                obj['searched'] = ApiClient.convertToType(data['searched'], ['String']);
            }
    ...
    static validateJSON(data) {
        ...
        // ensure the json data is an array
        if (!Array.isArray(data['searched'])) {
            throw new Error("Expected the field `searched` to be an array in the JSON data but got " + data['searched']);
        }
 ...
 */
Search.prototype['customers'] = undefined;

/**
 * List of returned invoices.
 * @member {Array.<module:model/Invoice>} invoices
 */
Search.prototype['invoices'] = undefined;

/**
 * List of returned orders.
 * @member {Array.<module:model/Subscription>} orders
 */
Search.prototype['orders'] = undefined;

/**
 * Names of searched resources, even if they returned nothing.
 * @member {Array.<String>} searched
 */
Search.prototype['searched'] = undefined;

/**
 * List of returned transactions.
 * @member {Array.<module:model/Transaction>} transactions
 */
Search.prototype['transactions'] = undefined;
