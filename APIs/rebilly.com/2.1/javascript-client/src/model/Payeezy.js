...
import PayeezyAllOfCredentials from './PayeezyAllOfCredentials';
import PaymentCardBrand from './PaymentCardBrand';
import PaymentMethod from './PaymentMethod';

/**
 * The Payeezy model module.
 * @module model/Payeezy
 * @version 2.1
 */
class Payeezy {
    /**
     * Constructs a new <code>Payeezy</code>.
     * Payeezy Gateway config.
     * @alias module:model/Payeezy
     ...
     * @param credentials {module:model/PayeezyAllOfCredentials} 
     */
    constructor(acceptedCurrencies, gatewayName, method, credentials) { 
        ...
        Payeezy.initialize(this, acceptedCurrencies, gatewayName, method, credentials);
    }
    ...
    /**
     * Constructs a <code>Payeezy</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Payeezy} obj Optional instance to populate.
     * @return {module:model/Payeezy} The populated <code>Payeezy</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('credentials')) {
                obj['credentials'] = PayeezyAllOfCredentials.constructFromObject(data['credentials']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>Payeezy</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Payeezy</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of Payeezy.RequiredProperties) {
        ...
        if (data['credentials']) { // data not null
          PayeezyAllOfCredentials.validateJSON(data['credentials']);
        }
...
Payeezy.RequiredProperties = ["credentials", "acceptedCurrencies", "gatewayName", "method"];

/**
 * @member {module:model/PayeezyAllOfCredentials} credentials
 */
Payeezy.prototype['credentials'] = undefined;
