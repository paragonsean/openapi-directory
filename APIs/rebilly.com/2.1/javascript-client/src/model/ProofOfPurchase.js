...
/**
 * The ProofOfPurchase model module.
 * @module model/ProofOfPurchase
 * @version 2.1
 */
class ProofOfPurchase {
    /**
     * Constructs a new <code>ProofOfPurchase</code>.
     * @alias module:model/ProofOfPurchase
     ...
     * @param status {module:model/ProofOfPurchase.StatusEnum} Status of the validation.
    ...
    constructor(documentType, status, customerId) { 
        ...
        ProofOfPurchase.initialize(this, documentType, status, customerId);
    }
    ...
    /**
     * Constructs a <code>ProofOfPurchase</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ProofOfPurchase} obj Optional instance to populate.
     * @return {module:model/ProofOfPurchase} The populated <code>ProofOfPurchase</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ProofOfPurchase();
            KycDocument.constructFromObject(data, obj);

            if (data.hasOwnProperty('_links')) {
                obj['_links'] = ApiClient.convertToType(data['_links'], [CommonKycDocumentLinksInner]);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>ProofOfPurchase</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ProofOfPurchase</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ProofOfPurchase.RequiredProperties) {
        ...
        if (data['_links']) { // data not null
            ...
            for (const item of data['_links']) {
                CommonKycDocumentLinksInner.validateJSON(item);
            };
        }
...
ProofOfPurchase.RequiredProperties = ["documentType", "status", "customerId"];

/**
 * The links related to resource.
 * @member {Array.<module:model/CommonKycDocumentLinksInner>} _links
 */
ProofOfPurchase.prototype['_links'] = undefined;

/**
 * Creation date/time.
 * @member {Date} createdTime
 */
ProofOfPurchase.prototype['createdTime'] = undefined;

/**
 * Document subtype submitted for validation.
 * @member {module:model/KycDocumentSubtypes} documentSubtype
 */
ProofOfPurchase.prototype['documentSubtype'] = undefined;
 ...
 */
ProofOfPurchase.prototype['documentType'] = undefined;

/**
 * Linked file object id.
 * @member {String} fileId
 */
ProofOfPurchase.prototype['fileId'] = undefined;

/**
 * Linked file object id's.
 * @member {Array.<String>} fileIds
 */
ProofOfPurchase.prototype['fileIds'] = undefined;

/**
 * The resource ID. Defaults to UUID v4.
 * @member {String} id
 */
ProofOfPurchase.prototype['id'] = undefined;

/**
 * Processing date/time.
 * @member {Date} processedTime
 */
ProofOfPurchase.prototype['processedTime'] = undefined;

/**
 * @member {module:model/KycDocumentRejection} rejectionReason
 */
ProofOfPurchase.prototype['rejectionReason'] = undefined;

/**
 * KYC request identifier string.
 * @member {String} requestId
 */
ProofOfPurchase.prototype['requestId'] = undefined;

/**
 * Status of the validation.
 * @member {module:model/ProofOfPurchase.StatusEnum} status
 */
ProofOfPurchase.prototype['status'] = undefined;

/**
 * Latest update date/time.
 * @member {Date} updatedTime
 */
ProofOfPurchase.prototype['updatedTime'] = undefined;

/**
 * The сustomer's ID.
 * @member {String} customerId
 */
ProofOfPurchase.prototype['customerId'] = undefined;

/**
 * The level of strictness for the document matches.
 * @member {Number} matchLevel
 */
ProofOfPurchase.prototype['matchLevel'] = undefined;

/**
 * Reviewer notes.
 * @member {String} notes
 */
ProofOfPurchase.prototype['notes'] = undefined;

/**
 * Reason for uploading.
 * @member {String} reason
 */
ProofOfPurchase.prototype['reason'] = undefined;

/**
 * Date and time of manual review.
 * @member {Date} reviewTime
 */
ProofOfPurchase.prototype['reviewTime'] = undefined;

/**
 * Reviewer's user ID.
 * @member {String} reviewerId
 */
ProofOfPurchase.prototype['reviewerId'] = undefined;

/**
 * Reviewer's first and last name.
 * @member {String} reviewerName
 */
ProofOfPurchase.prototype['reviewerName'] = undefined;
