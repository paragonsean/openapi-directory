...
class Organization {
     ...
     * @param country {String} The organization country ISO Alpha-2 code.
     * @param name {String} The organization name.
     */
    constructor(country, name) { 
        
        Organization.initialize(this, country, name);
    }
     ...
     */
    static initialize(obj, country, name) { 
        obj['country'] = country;
        obj['name'] = name;
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('invoiceTimeZone')) {
                obj['invoiceTimeZone'] = ApiClient.convertToType(data['invoiceTimeZone'], 'String');
            }
            ...
            if (data.hasOwnProperty('questionnaire')) {
                obj['questionnaire'] = OrganizationQuestionnaire.constructFromObject(data['questionnaire']);
            }
            if (data.hasOwnProperty('region')) {
                obj['region'] = ApiClient.convertToType(data['region'], 'String');
            }
            if (data.hasOwnProperty('taxDescriptor')) {
                obj['taxDescriptor'] = ApiClient.convertToType(data['taxDescriptor'], 'String');
            }
    ...
    static validateJSON(data) {
        ...
        // ensure the json data is a string
        if (data['invoiceTimeZone'] && !(typeof data['invoiceTimeZone'] === 'string' || data['invoiceTimeZone'] instanceof String)) {
            throw new Error("Expected the field `invoiceTimeZone` to be a primitive type in the JSON string but got " + data['invoiceTimeZone']);
        }
        // ensure the json data is a string
        ...
        if (data['questionnaire']) { // data not null
          OrganizationQuestionnaire.validateJSON(data['questionnaire']);
        }
        // ensure the json data is a string
        ...
        // ensure the json data is a string
        if (data['taxDescriptor'] && !(typeof data['taxDescriptor'] === 'string' || data['taxDescriptor'] instanceof String)) {
            throw new Error("Expected the field `taxDescriptor` to be a primitive type in the JSON string but got " + data['taxDescriptor']);
        }
...
Organization.RequiredProperties = ["country", "name"];
 ...
 */
Organization.prototype['address2'] = undefined;
 ...
 */
Organization.prototype['createdTime'] = undefined;
 ...
 * @member {String} invoiceTimeZone
 */
Organization.prototype['invoiceTimeZone'] = undefined;
 ...
 */
Organization.prototype['isPrimary'] = undefined;
 ...
 */
Organization.prototype['phoneNumbers'] = undefined;

/**
 * The organization postal code.
 * @member {String} postalCode
 */
Organization.prototype['postalCode'] = undefined;

/**
 * @member {module:model/OrganizationQuestionnaire} questionnaire
 */
Organization.prototype['questionnaire'] = undefined;

/**
 * The organization region (state).
 * @member {String} region
 */
Organization.prototype['region'] = undefined;

/**
 * The organization's tax label. This will be displayed on the invoice.
 * @member {String} taxDescriptor
 */
Organization.prototype['taxDescriptor'] = undefined;
