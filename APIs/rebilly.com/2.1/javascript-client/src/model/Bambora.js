...
import BamboraAllOfCredentials from './BamboraAllOfCredentials';
...
/**
 * The Bambora model module.
 * @module model/Bambora
 * @version 2.1
 */
class Bambora {
    /**
     * Constructs a new <code>Bambora</code>.
     * Bambora Gateway config.
     * @alias module:model/Bambora
     ...
     * @param credentials {module:model/BamboraAllOfCredentials} 
     */
    constructor(acceptedCurrencies, gatewayName, method, credentials) { 
        ...
        Bambora.initialize(this, acceptedCurrencies, gatewayName, method, credentials);
    }
    ...
    /**
     * Constructs a <code>Bambora</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Bambora} obj Optional instance to populate.
     * @return {module:model/Bambora} The populated <code>Bambora</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('credentials')) {
                obj['credentials'] = BamboraAllOfCredentials.constructFromObject(data['credentials']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>Bambora</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Bambora</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of Bambora.RequiredProperties) {
        ...
        if (data['credentials']) { // data not null
          BamboraAllOfCredentials.validateJSON(data['credentials']);
        }
...
Bambora.RequiredProperties = ["credentials", "acceptedCurrencies", "gatewayName", "method"];

/**
 * @member {module:model/BamboraAllOfCredentials} credentials
 */
Bambora.prototype['credentials'] = undefined;
