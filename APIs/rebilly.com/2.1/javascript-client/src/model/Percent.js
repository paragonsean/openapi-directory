...
class Percent {
     ...
     * @extends module:model/Discount
     * @implements module:model/Discount
     * @param value {Number} Discount percent.
     */
    constructor(value) { 
        Discount.initialize(this, method, type, value);
        Percent.initialize(this, value);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new Percent();
            Discount.constructFromObject(data, obj);
            Discount.constructFromObject(data, obj);
    ...
    static validateJSON(data) {
        ...
        for (const property of Percent.RequiredProperties) {
...
Percent.RequiredProperties = ["value"];

/**
 * Discount percent.
 * @member {Number} value
 */
Percent.prototype['value'] = undefined;


// Implement Discount interface:
/**
 * @member {module:model/Discount.MethodEnum} method
 */
Discount.prototype['method'] = undefined;
/**
