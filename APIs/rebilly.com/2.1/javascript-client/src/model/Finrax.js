...
import FinraxAllOfCredentials from './FinraxAllOfCredentials';
import FinraxAllOfSettings from './FinraxAllOfSettings';
...
/**
 * The Finrax model module.
 * @module model/Finrax
 * @version 2.1
 */
class Finrax {
    /**
     * Constructs a new <code>Finrax</code>.
     * Finrax config.
     * @alias module:model/Finrax
     ...
     * @param credentials {module:model/FinraxAllOfCredentials} 
     */
    constructor(acceptedCurrencies, gatewayName, method, credentials) { 
        ...
        Finrax.initialize(this, acceptedCurrencies, gatewayName, method, credentials);
    }
    ...
    /**
     * Constructs a <code>Finrax</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Finrax} obj Optional instance to populate.
     * @return {module:model/Finrax} The populated <code>Finrax</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('credentials')) {
                obj['credentials'] = FinraxAllOfCredentials.constructFromObject(data['credentials']);
            }
            if (data.hasOwnProperty('settings')) {
                obj['settings'] = FinraxAllOfSettings.constructFromObject(data['settings']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>Finrax</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Finrax</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of Finrax.RequiredProperties) {
        ...
        if (data['credentials']) { // data not null
          FinraxAllOfCredentials.validateJSON(data['credentials']);
        }
        // validate the optional field `settings`
        if (data['settings']) { // data not null
          FinraxAllOfSettings.validateJSON(data['settings']);
        }
...
Finrax.RequiredProperties = ["credentials", "acceptedCurrencies", "gatewayName", "method"];

/**
 * @member {module:model/FinraxAllOfCredentials} credentials
 */
Finrax.prototype['credentials'] = undefined;

/**
 * @member {module:model/FinraxAllOfSettings} settings
 */
Finrax.prototype['settings'] = undefined;
