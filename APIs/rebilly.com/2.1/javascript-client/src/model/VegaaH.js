...
import VegaaHAllOfCredentials from './VegaaHAllOfCredentials';

/**
 * The VegaaH model module.
 * @module model/VegaaH
 * @version 2.1
 */
class VegaaH {
    /**
     * Constructs a new <code>VegaaH</code>.
     * vegaaH Gateway config.
     * @alias module:model/VegaaH
     ...
     * @param credentials {module:model/VegaaHAllOfCredentials} 
     */
    constructor(acceptedCurrencies, gatewayName, method, credentials) { 
        ...
        VegaaH.initialize(this, acceptedCurrencies, gatewayName, method, credentials);
    }
    ...
    /**
     * Constructs a <code>VegaaH</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/VegaaH} obj Optional instance to populate.
     * @return {module:model/VegaaH} The populated <code>VegaaH</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('credentials')) {
                obj['credentials'] = VegaaHAllOfCredentials.constructFromObject(data['credentials']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>VegaaH</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>VegaaH</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of VegaaH.RequiredProperties) {
        ...
        if (data['credentials']) { // data not null
          VegaaHAllOfCredentials.validateJSON(data['credentials']);
        }
...
VegaaH.RequiredProperties = ["credentials", "acceptedCurrencies", "gatewayName", "method"];

/**
 * @member {module:model/VegaaHAllOfCredentials} credentials
 */
VegaaH.prototype['credentials'] = undefined;
