...
import CardknoxAllOfCredentials from './CardknoxAllOfCredentials';
...
/**
 * The Cardknox model module.
 * @module model/Cardknox
 * @version 2.1
 */
class Cardknox {
    /**
     * Constructs a new <code>Cardknox</code>.
     * Cardknox Gateway config.
     * @alias module:model/Cardknox
     ...
     * @param credentials {module:model/CardknoxAllOfCredentials} 
     */
    constructor(acceptedCurrencies, gatewayName, method, credentials) { 
        ...
        Cardknox.initialize(this, acceptedCurrencies, gatewayName, method, credentials);
    }
    ...
    /**
     * Constructs a <code>Cardknox</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Cardknox} obj Optional instance to populate.
     * @return {module:model/Cardknox} The populated <code>Cardknox</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new Cardknox();
            GatewayAccount.constructFromObject(data, obj);
            GatewayAccount.constructFromObject(data, obj);

            if (data.hasOwnProperty('credentials')) {
                obj['credentials'] = CardknoxAllOfCredentials.constructFromObject(data['credentials']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>Cardknox</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Cardknox</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of Cardknox.RequiredProperties) {
        ...
        if (data['credentials']) { // data not null
          CardknoxAllOfCredentials.validateJSON(data['credentials']);
        }
...
Cardknox.RequiredProperties = ["credentials", "acceptedCurrencies", "gatewayName", "method"];

/**
 * @member {module:model/CardknoxAllOfCredentials} credentials
 */
Cardknox.prototype['credentials'] = undefined;
