...
import DataCashAllOfCredentials from './DataCashAllOfCredentials';
import DataCashAllOfSettings from './DataCashAllOfSettings';
...
/**
 * The DataCash model module.
 * @module model/DataCash
 * @version 2.1
 */
class DataCash {
    /**
     * Constructs a new <code>DataCash</code>.
     * DataCash Gateway config.
     * @alias module:model/DataCash
     ...
     * @param credentials {module:model/DataCashAllOfCredentials} 
     */
    constructor(acceptedCurrencies, gatewayName, method, credentials) { 
        ...
        DataCash.initialize(this, acceptedCurrencies, gatewayName, method, credentials);
    }
    ...
    /**
     * Constructs a <code>DataCash</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DataCash} obj Optional instance to populate.
     * @return {module:model/DataCash} The populated <code>DataCash</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DataCash();
            GatewayAccount.constructFromObject(data, obj);
            GatewayAccount.constructFromObject(data, obj);

            if (data.hasOwnProperty('credentials')) {
                obj['credentials'] = DataCashAllOfCredentials.constructFromObject(data['credentials']);
            }
            if (data.hasOwnProperty('settings')) {
                obj['settings'] = DataCashAllOfSettings.constructFromObject(data['settings']);
            }
            if (data.hasOwnProperty('threeDSecureServer')) {
                obj['threeDSecureServer'] = DataCash3dsServers.constructFromObject(data['threeDSecureServer']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>DataCash</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DataCash</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DataCash.RequiredProperties) {
        ...
        if (data['credentials']) { // data not null
          DataCashAllOfCredentials.validateJSON(data['credentials']);
        }
        // validate the optional field `settings`
        if (data['settings']) { // data not null
          DataCashAllOfSettings.validateJSON(data['settings']);
        }
        // validate the optional field `threeDSecureServer`
        if (data['threeDSecureServer']) { // data not null
          DataCash3dsServers.validateJSON(data['threeDSecureServer']);
        }
...
DataCash.RequiredProperties = ["credentials", "acceptedCurrencies", "gatewayName", "method"];

/**
 * @member {module:model/DataCashAllOfCredentials} credentials
 */
DataCash.prototype['credentials'] = undefined;

/**
 * @member {module:model/DataCashAllOfSettings} settings
 */
DataCash.prototype['settings'] = undefined;

/**
 * @member {module:model/DataCash3dsServers} threeDSecureServer
 */
DataCash.prototype['threeDSecureServer'] = undefined;
