...
import CommonKycDocument from './CommonKycDocument';
...
/**
 * The KycDocument model module.
 * @module model/KycDocument
 * @version 2.1
 */
class KycDocument {
    /**
     * Constructs a new <code>KycDocument</code>.
     * @alias module:model/KycDocument
     * @implements module:model/CommonKycDocument
     ...
     * @param status {module:model/KycDocument.StatusEnum} Status of the validation.
     * @param customerId {String} The сustomer's ID.
     */
    constructor(documentType, status, customerId) { 
        CommonKycDocument.initialize(this, documentType, status);
    ...
    /**
     * Constructs a <code>KycDocument</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/KycDocument} obj Optional instance to populate.
     * @return {module:model/KycDocument} The populated <code>KycDocument</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new KycDocument();
            CommonKycDocument.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>KycDocument</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>KycDocument</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of KycDocument.RequiredProperties) {
...
KycDocument.RequiredProperties = ["documentType", "status", "customerId"];
...
// Implement CommonKycDocument interface:
/**
 * The links related to resource.
 * @member {Array.<module:model/CommonKycDocumentLinksInner>} _links
 */
CommonKycDocument.prototype['_links'] = undefined;
/**
 * Creation date/time.
 * @member {Date} createdTime
 */
CommonKycDocument.prototype['createdTime'] = undefined;
/**
 * Document subtype submitted for validation.
 * @member {module:model/KycDocumentSubtypes} documentSubtype
 */
CommonKycDocument.prototype['documentSubtype'] = undefined;
/**
 * Document type submitted for validation, only identity-proof type is analyzed in an automated manner.
 * @member {module:model/KycDocumentTypes} documentType
 */
CommonKycDocument.prototype['documentType'] = undefined;
/**
 * Linked file object id.
 * @member {String} fileId
 */
CommonKycDocument.prototype['fileId'] = undefined;
/**
 * Linked file object id's.
 * @member {Array.<String>} fileIds
 */
CommonKycDocument.prototype['fileIds'] = undefined;
/**
 * The resource ID. Defaults to UUID v4.
 * @member {String} id
 */
CommonKycDocument.prototype['id'] = undefined;
/**
 * Processing date/time.
 * @member {Date} processedTime
 */
CommonKycDocument.prototype['processedTime'] = undefined;
/**
 * @member {module:model/KycDocumentRejection} rejectionReason
 */
CommonKycDocument.prototype['rejectionReason'] = undefined;
/**
 * KYC request identifier string.
 * @member {String} requestId
 */
CommonKycDocument.prototype['requestId'] = undefined;
/**
 * Status of the validation.
 * @member {module:model/CommonKycDocument.StatusEnum} status
 */
CommonKycDocument.prototype['status'] = undefined;
/**
 * Latest update date/time.
 * @member {Date} updatedTime
 */
CommonKycDocument.prototype['updatedTime'] = undefined;
