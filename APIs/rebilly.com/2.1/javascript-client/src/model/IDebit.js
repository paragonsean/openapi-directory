...
import IDebitAllOfCredentials from './IDebitAllOfCredentials';
import PaymentCardBrand from './PaymentCardBrand';
import PaymentMethod from './PaymentMethod';

/**
 * The IDebit model module.
 * @module model/IDebit
 * @version 2.1
 */
class IDebit {
    /**
     * Constructs a new <code>IDebit</code>.
     * iDebit config.
     * @alias module:model/IDebit
     ...
     * @param credentials {module:model/IDebitAllOfCredentials} 
     */
    constructor(acceptedCurrencies, gatewayName, method, credentials) { 
        ...
        IDebit.initialize(this, acceptedCurrencies, gatewayName, method, credentials);
    }
    ...
    /**
     * Constructs a <code>IDebit</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/IDebit} obj Optional instance to populate.
     * @return {module:model/IDebit} The populated <code>IDebit</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('credentials')) {
                obj['credentials'] = IDebitAllOfCredentials.constructFromObject(data['credentials']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>IDebit</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>IDebit</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of IDebit.RequiredProperties) {
        ...
        if (data['credentials']) { // data not null
          IDebitAllOfCredentials.validateJSON(data['credentials']);
        }
...
IDebit.RequiredProperties = ["credentials", "acceptedCurrencies", "gatewayName", "method"];

/**
 * @member {module:model/IDebitAllOfCredentials} credentials
 */
IDebit.prototype['credentials'] = undefined;
