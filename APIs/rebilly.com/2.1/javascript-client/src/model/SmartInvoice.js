...
import SmartInvoiceAllOfCredentials from './SmartInvoiceAllOfCredentials';

/**
 * The SmartInvoice model module.
 * @module model/SmartInvoice
 * @version 2.1
 */
class SmartInvoice {
    /**
     * Constructs a new <code>SmartInvoice</code>.
     * SmartInvoice config.
     * @alias module:model/SmartInvoice
     ...
     * @param credentials {module:model/SmartInvoiceAllOfCredentials} 
     */
    constructor(acceptedCurrencies, gatewayName, method, credentials) { 
        ...
        SmartInvoice.initialize(this, acceptedCurrencies, gatewayName, method, credentials);
    }
    ...
    /**
     * Constructs a <code>SmartInvoice</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SmartInvoice} obj Optional instance to populate.
     * @return {module:model/SmartInvoice} The populated <code>SmartInvoice</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SmartInvoice();
            GatewayAccount.constructFromObject(data, obj);
            GatewayAccount.constructFromObject(data, obj);

            if (data.hasOwnProperty('credentials')) {
                obj['credentials'] = SmartInvoiceAllOfCredentials.constructFromObject(data['credentials']);
            }
            if (data.hasOwnProperty('threeDSecureServer')) {
                obj['threeDSecureServer'] = SmartInvoice3dsServers.constructFromObject(data['threeDSecureServer']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>SmartInvoice</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SmartInvoice</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of SmartInvoice.RequiredProperties) {
        ...
        if (data['credentials']) { // data not null
          SmartInvoiceAllOfCredentials.validateJSON(data['credentials']);
        }
        // validate the optional field `threeDSecureServer`
        if (data['threeDSecureServer']) { // data not null
          SmartInvoice3dsServers.validateJSON(data['threeDSecureServer']);
        }
...
SmartInvoice.RequiredProperties = ["credentials", "acceptedCurrencies", "gatewayName", "method"];

/**
 * @member {module:model/SmartInvoiceAllOfCredentials} credentials
 */
SmartInvoice.prototype['credentials'] = undefined;

/**
 * @member {module:model/SmartInvoice3dsServers} threeDSecureServer
 */
SmartInvoice.prototype['threeDSecureServer'] = undefined;
