...
import SparkPayAllOfCredentials from './SparkPayAllOfCredentials';

/**
 * The SparkPay model module.
 * @module model/SparkPay
 * @version 2.1
 */
class SparkPay {
    /**
     * Constructs a new <code>SparkPay</code>.
     * SparkPay config.
     * @alias module:model/SparkPay
     ...
     * @param credentials {module:model/SparkPayAllOfCredentials} 
     */
    constructor(acceptedCurrencies, gatewayName, method, credentials) { 
        ...
        SparkPay.initialize(this, acceptedCurrencies, gatewayName, method, credentials);
    }
    ...
    /**
     * Constructs a <code>SparkPay</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SparkPay} obj Optional instance to populate.
     * @return {module:model/SparkPay} The populated <code>SparkPay</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SparkPay();
            GatewayAccount.constructFromObject(data, obj);
            GatewayAccount.constructFromObject(data, obj);

            if (data.hasOwnProperty('credentials')) {
                obj['credentials'] = SparkPayAllOfCredentials.constructFromObject(data['credentials']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>SparkPay</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SparkPay</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of SparkPay.RequiredProperties) {
        ...
        if (data['credentials']) { // data not null
          SparkPayAllOfCredentials.validateJSON(data['credentials']);
        }
...
SparkPay.RequiredProperties = ["credentials", "acceptedCurrencies", "gatewayName", "method"];

/**
 * @member {module:model/SparkPayAllOfCredentials} credentials
 */
SparkPay.prototype['credentials'] = undefined;
