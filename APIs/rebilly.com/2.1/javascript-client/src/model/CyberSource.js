...
import CyberSourceAllOfCredentials from './CyberSourceAllOfCredentials';
...
/**
 * The CyberSource model module.
 * @module model/CyberSource
 * @version 2.1
 */
class CyberSource {
    /**
     * Constructs a new <code>CyberSource</code>.
     * CyberSource config.
     * @alias module:model/CyberSource
     ...
     * @param credentials {module:model/CyberSourceAllOfCredentials} 
     */
    constructor(acceptedCurrencies, gatewayName, method, credentials) { 
        ...
        CyberSource.initialize(this, acceptedCurrencies, gatewayName, method, credentials);
    }
    ...
    /**
     * Constructs a <code>CyberSource</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CyberSource} obj Optional instance to populate.
     * @return {module:model/CyberSource} The populated <code>CyberSource</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CyberSource();
            GatewayAccount.constructFromObject(data, obj);
            GatewayAccount.constructFromObject(data, obj);

            if (data.hasOwnProperty('credentials')) {
                obj['credentials'] = CyberSourceAllOfCredentials.constructFromObject(data['credentials']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>CyberSource</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CyberSource</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CyberSource.RequiredProperties) {
        ...
        if (data['credentials']) { // data not null
          CyberSourceAllOfCredentials.validateJSON(data['credentials']);
        }
...
CyberSource.RequiredProperties = ["credentials", "acceptedCurrencies", "gatewayName", "method"];

/**
 * @member {module:model/CyberSourceAllOfCredentials} credentials
 */
CyberSource.prototype['credentials'] = undefined;
