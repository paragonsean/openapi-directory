...
import CredoraxAllOfCredentials from './CredoraxAllOfCredentials';
...
/**
 * The Credorax model module.
 * @module model/Credorax
 * @version 2.1
 */
class Credorax {
    /**
     * Constructs a new <code>Credorax</code>.
     * Credorax Gateway config.
     * @alias module:model/Credorax
     ...
     * @param credentials {module:model/CredoraxAllOfCredentials} 
     */
    constructor(acceptedCurrencies, gatewayName, method, credentials) { 
        ...
        Credorax.initialize(this, acceptedCurrencies, gatewayName, method, credentials);
    }
    ...
    /**
     * Constructs a <code>Credorax</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Credorax} obj Optional instance to populate.
     * @return {module:model/Credorax} The populated <code>Credorax</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new Credorax();
            GatewayAccount.constructFromObject(data, obj);
            GatewayAccount.constructFromObject(data, obj);

            if (data.hasOwnProperty('credentials')) {
                obj['credentials'] = CredoraxAllOfCredentials.constructFromObject(data['credentials']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>Credorax</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Credorax</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of Credorax.RequiredProperties) {
        ...
        if (data['credentials']) { // data not null
          CredoraxAllOfCredentials.validateJSON(data['credentials']);
        }
...
Credorax.RequiredProperties = ["credentials", "acceptedCurrencies", "gatewayName", "method"];

/**
 * @member {module:model/CredoraxAllOfCredentials} credentials
 */
Credorax.prototype['credentials'] = undefined;
