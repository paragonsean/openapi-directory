...
/**
 * The CommonSubscription model module.
 * @module model/CommonSubscription
 * @version 2.1
 */
class CommonSubscription {
    /**
     * Constructs a new <code>CommonSubscription</code>.
     * @alias module:model/CommonSubscription
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>CommonSubscription</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CommonSubscription} obj Optional instance to populate.
     * @return {module:model/CommonSubscription} The populated <code>CommonSubscription</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CommonSubscription();
    ...
    /**
     * Validates the JSON data with respect to <code>CommonSubscription</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CommonSubscription</code>.
     */
 ...
 * @readonly
 */
CommonSubscription['BillingStatusEnum'] = {
 ...
 * @readonly
 */
CommonSubscription['OrderTypeEnum'] = {
