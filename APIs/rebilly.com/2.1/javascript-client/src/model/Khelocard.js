...
import KhelocardAllOfCredentials from './KhelocardAllOfCredentials';
import PaymentCardBrand from './PaymentCardBrand';
import PaymentMethod from './PaymentMethod';

/**
 * The Khelocard model module.
 * @module model/Khelocard
 * @version 2.1
 */
class Khelocard {
    /**
     * Constructs a new <code>Khelocard</code>.
     * Khelocard config.
     * @alias module:model/Khelocard
     ...
     * @param credentials {module:model/KhelocardAllOfCredentials} 
     */
    constructor(acceptedCurrencies, gatewayName, method, credentials) { 
        ...
        Khelocard.initialize(this, acceptedCurrencies, gatewayName, method, credentials);
    }
    ...
    /**
     * Constructs a <code>Khelocard</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Khelocard} obj Optional instance to populate.
     * @return {module:model/Khelocard} The populated <code>Khelocard</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new Khelocard();
            GatewayAccount.constructFromObject(data, obj);
            GatewayAccount.constructFromObject(data, obj);

            if (data.hasOwnProperty('credentials')) {
                obj['credentials'] = KhelocardAllOfCredentials.constructFromObject(data['credentials']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>Khelocard</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Khelocard</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of Khelocard.RequiredProperties) {
        ...
        if (data['credentials']) { // data not null
          KhelocardAllOfCredentials.validateJSON(data['credentials']);
        }
...
Khelocard.RequiredProperties = ["credentials", "acceptedCurrencies", "gatewayName", "method"];

/**
 * @member {module:model/KhelocardAllOfCredentials} credentials
 */
Khelocard.prototype['credentials'] = undefined;
