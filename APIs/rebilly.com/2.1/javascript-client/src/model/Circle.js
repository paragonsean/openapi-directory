...
import CircleAllOfCredentials from './CircleAllOfCredentials';
...
class Circle {
     ...
     * @param credentials {module:model/CircleAllOfCredentials} 
     */
    constructor(acceptedCurrencies, gatewayName, method, credentials) { 
        ...
        Circle.initialize(this, acceptedCurrencies, gatewayName, method, credentials);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('credentials')) {
                obj['credentials'] = CircleAllOfCredentials.constructFromObject(data['credentials']);
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        if (data['credentials']) { // data not null
          CircleAllOfCredentials.validateJSON(data['credentials']);
        }
...
Circle.RequiredProperties = ["credentials", "acceptedCurrencies", "gatewayName", "method"];

/**
 * @member {module:model/CircleAllOfCredentials} credentials
 */
Circle.prototype['credentials'] = undefined;
