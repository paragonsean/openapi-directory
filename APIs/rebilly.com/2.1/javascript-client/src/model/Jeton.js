...
import JetonAllOfCredentials from './JetonAllOfCredentials';
import JetonAllOfSettings from './JetonAllOfSettings';
import PaymentCardBrand from './PaymentCardBrand';
import PaymentMethod from './PaymentMethod';

/**
 * The Jeton model module.
 * @module model/Jeton
 * @version 2.1
 */
class Jeton {
    /**
     * Constructs a new <code>Jeton</code>.
     * Jeton Gateway config.
     * @alias module:model/Jeton
     ...
     * @param credentials {module:model/JetonAllOfCredentials} 
     */
    constructor(acceptedCurrencies, gatewayName, method, credentials) { 
        ...
        Jeton.initialize(this, acceptedCurrencies, gatewayName, method, credentials);
    }
    ...
    /**
     * Constructs a <code>Jeton</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Jeton} obj Optional instance to populate.
     * @return {module:model/Jeton} The populated <code>Jeton</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('credentials')) {
                obj['credentials'] = JetonAllOfCredentials.constructFromObject(data['credentials']);
            }
            if (data.hasOwnProperty('settings')) {
                obj['settings'] = JetonAllOfSettings.constructFromObject(data['settings']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>Jeton</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Jeton</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of Jeton.RequiredProperties) {
        ...
        if (data['credentials']) { // data not null
          JetonAllOfCredentials.validateJSON(data['credentials']);
        }
        // validate the optional field `settings`
        if (data['settings']) { // data not null
          JetonAllOfSettings.validateJSON(data['settings']);
        }
...
Jeton.RequiredProperties = ["credentials", "acceptedCurrencies", "gatewayName", "method"];

/**
 * @member {module:model/JetonAllOfCredentials} credentials
 */
Jeton.prototype['credentials'] = undefined;

/**
 * @member {module:model/JetonAllOfSettings} settings
 */
Jeton.prototype['settings'] = undefined;
