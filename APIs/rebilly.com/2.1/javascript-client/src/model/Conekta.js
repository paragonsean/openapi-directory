...
import ConektaAllOfCredentials from './ConektaAllOfCredentials';
...
/**
 * The Conekta model module.
 * @module model/Conekta
 * @version 2.1
 */
class Conekta {
    /**
     * Constructs a new <code>Conekta</code>.
     * Conekta config.
     * @alias module:model/Conekta
     ...
     * @param credentials {module:model/ConektaAllOfCredentials} 
     */
    constructor(acceptedCurrencies, gatewayName, method, credentials) { 
        ...
        Conekta.initialize(this, acceptedCurrencies, gatewayName, method, credentials);
    }
    ...
    /**
     * Constructs a <code>Conekta</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Conekta} obj Optional instance to populate.
     * @return {module:model/Conekta} The populated <code>Conekta</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('credentials')) {
                obj['credentials'] = ConektaAllOfCredentials.constructFromObject(data['credentials']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>Conekta</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Conekta</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of Conekta.RequiredProperties) {
        ...
        if (data['credentials']) { // data not null
          ConektaAllOfCredentials.validateJSON(data['credentials']);
        }
...
Conekta.RequiredProperties = ["credentials", "acceptedCurrencies", "gatewayName", "method"];

/**
 * @member {module:model/ConektaAllOfCredentials} credentials
 */
Conekta.prototype['credentials'] = undefined;
