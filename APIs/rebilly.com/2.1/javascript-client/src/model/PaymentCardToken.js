...
/**
 * The PaymentCardToken model module.
 * @module model/PaymentCardToken
 * @version 2.1
 */
class PaymentCardToken {
    /**
     * Constructs a new <code>PaymentCardToken</code>.
     * @alias module:model/PaymentCardToken
     * @implements module:model/CommonPaymentToken
     * @param method {String} 
     */
    constructor(method) { 
        CommonPaymentToken.initialize(this, method);
        PaymentCardToken.initialize(this, method);
    }
    ...
    /**
     * Constructs a <code>PaymentCardToken</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PaymentCardToken} obj Optional instance to populate.
     * @return {module:model/PaymentCardToken} The populated <code>PaymentCardToken</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PaymentCardToken();
    ...
    /**
     * Validates the JSON data with respect to <code>PaymentCardToken</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PaymentCardToken</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of PaymentCardToken.RequiredProperties) {
...
PaymentCardToken.RequiredProperties = ["method", "paymentInstrument"];

/**
 * The billing address object.
 * @member {module:model/ContactObject} billingAddress
 */
PaymentCardToken.prototype['billingAddress'] = undefined;

/**
 * The token payment method.
 * @member {module:model/PaymentCardToken.MethodEnum} method
 */
PaymentCardToken.prototype['method'] = undefined;

/**
 * The payment card instrument details.
 * @member {Object} paymentInstrument
 */
PaymentCardToken.prototype['paymentInstrument'] = undefined;

/**
 * The links related to resource.
 * @member {Array.<module:model/SelfLink>} _links
 */
PaymentCardToken.prototype['_links'] = undefined;

/**
 * Token created time.
 * @member {Date} createdTime
 */
PaymentCardToken.prototype['createdTime'] = undefined;

/**
 * Token expiration time.
 * @member {Date} expirationTime
 */
PaymentCardToken.prototype['expirationTime'] = undefined;

/**
 * The token identifier string.
 * @member {String} id
 */
PaymentCardToken.prototype['id'] = undefined;
 ...
 * @default false
 */
PaymentCardToken.prototype['isUsed'] = false;

/**
 * @member {module:model/LeadSource} leadSource
 */
PaymentCardToken.prototype['leadSource'] = undefined;

/**
 * @member {module:model/RiskMetadata} riskMetadata
 */
PaymentCardToken.prototype['riskMetadata'] = undefined;

/**
 * Token updated time.
 * @member {Date} updatedTime
 */
PaymentCardToken.prototype['updatedTime'] = undefined;

/**
 * Token usage time.
 * @member {Date} usageTime
 */
PaymentCardToken.prototype['usageTime'] = undefined;
...
export default PaymentCardToken;
