...
import SofortAllOfCredentials from './SofortAllOfCredentials';

/**
 * The Sofort model module.
 * @module model/Sofort
 * @version 2.1
 */
class Sofort {
    /**
     * Constructs a new <code>Sofort</code>.
     * Sofort config.
     * @alias module:model/Sofort
     ...
     * @param credentials {module:model/SofortAllOfCredentials} 
     */
    constructor(acceptedCurrencies, gatewayName, method, credentials) { 
        ...
        Sofort.initialize(this, acceptedCurrencies, gatewayName, method, credentials);
    }
    ...
    /**
     * Constructs a <code>Sofort</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Sofort} obj Optional instance to populate.
     * @return {module:model/Sofort} The populated <code>Sofort</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('credentials')) {
                obj['credentials'] = SofortAllOfCredentials.constructFromObject(data['credentials']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>Sofort</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Sofort</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of Sofort.RequiredProperties) {
        ...
        if (data['credentials']) { // data not null
          SofortAllOfCredentials.validateJSON(data['credentials']);
        }
...
Sofort.RequiredProperties = ["credentials", "acceptedCurrencies", "gatewayName", "method"];

/**
 * @member {module:model/SofortAllOfCredentials} credentials
 */
Sofort.prototype['credentials'] = undefined;
