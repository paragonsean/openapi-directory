...
import MuchBetterAllOfCredentials from './MuchBetterAllOfCredentials';
import MuchBetterAllOfSettings from './MuchBetterAllOfSettings';
import PaymentCardBrand from './PaymentCardBrand';
import PaymentMethod from './PaymentMethod';

/**
 * The MuchBetter model module.
 * @module model/MuchBetter
 * @version 2.1
 */
class MuchBetter {
    /**
     * Constructs a new <code>MuchBetter</code>.
     * MuchBetter config.
     * @alias module:model/MuchBetter
     ...
     * @param credentials {module:model/MuchBetterAllOfCredentials} 
     */
    constructor(acceptedCurrencies, gatewayName, method, credentials) { 
        ...
        MuchBetter.initialize(this, acceptedCurrencies, gatewayName, method, credentials);
    }
    ...
    /**
     * Constructs a <code>MuchBetter</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/MuchBetter} obj Optional instance to populate.
     * @return {module:model/MuchBetter} The populated <code>MuchBetter</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new MuchBetter();
            GatewayAccount.constructFromObject(data, obj);
            GatewayAccount.constructFromObject(data, obj);

            if (data.hasOwnProperty('credentials')) {
                obj['credentials'] = MuchBetterAllOfCredentials.constructFromObject(data['credentials']);
            }
            if (data.hasOwnProperty('settings')) {
                obj['settings'] = MuchBetterAllOfSettings.constructFromObject(data['settings']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>MuchBetter</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>MuchBetter</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of MuchBetter.RequiredProperties) {
        ...
        if (data['credentials']) { // data not null
          MuchBetterAllOfCredentials.validateJSON(data['credentials']);
        }
        // validate the optional field `settings`
        if (data['settings']) { // data not null
          MuchBetterAllOfSettings.validateJSON(data['settings']);
        }
...
MuchBetter.RequiredProperties = ["credentials", "acceptedCurrencies", "gatewayName", "method"];

/**
 * @member {module:model/MuchBetterAllOfCredentials} credentials
 */
MuchBetter.prototype['credentials'] = undefined;

/**
 * @member {module:model/MuchBetterAllOfSettings} settings
 */
MuchBetter.prototype['settings'] = undefined;
