...
import BitPayAllOfCredentials from './BitPayAllOfCredentials';
...
/**
 * The BitPay model module.
 * @module model/BitPay
 * @version 2.1
 */
class BitPay {
    /**
     * Constructs a new <code>BitPay</code>.
     * BitPay Gateway config.
     * @alias module:model/BitPay
     ...
     * @param credentials {module:model/BitPayAllOfCredentials} 
     */
    constructor(acceptedCurrencies, gatewayName, method, credentials) { 
        ...
        BitPay.initialize(this, acceptedCurrencies, gatewayName, method, credentials);
    }
    ...
    /**
     * Constructs a <code>BitPay</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/BitPay} obj Optional instance to populate.
     * @return {module:model/BitPay} The populated <code>BitPay</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('credentials')) {
                obj['credentials'] = BitPayAllOfCredentials.constructFromObject(data['credentials']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>BitPay</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>BitPay</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of BitPay.RequiredProperties) {
        ...
        if (data['credentials']) { // data not null
          BitPayAllOfCredentials.validateJSON(data['credentials']);
        }
...
BitPay.RequiredProperties = ["credentials", "acceptedCurrencies", "gatewayName", "method"];

/**
 * @member {module:model/BitPayAllOfCredentials} credentials
 */
BitPay.prototype['credentials'] = undefined;
