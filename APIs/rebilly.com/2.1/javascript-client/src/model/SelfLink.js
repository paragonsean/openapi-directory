...
class SelfLink {
    ...
    /**
     * Validates the JSON data with respect to <code>SelfLink</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SelfLink</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of SelfLink.RequiredProperties) {
...
SelfLink.RequiredProperties = ["rel", "href"];

/**
 * The link type.
 * @member {module:model/SelfLink.RelEnum} rel
 */
SelfLink.prototype['rel'] = undefined;

/**
 * The link URL.
 * @member {String} href
 */
SelfLink.prototype['href'] = undefined;
