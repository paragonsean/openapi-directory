...
import CoinPaymentsAllOfCredentials from './CoinPaymentsAllOfCredentials';
...
/**
 * The CoinPayments model module.
 * @module model/CoinPayments
 * @version 2.1
 */
class CoinPayments {
    /**
     * Constructs a new <code>CoinPayments</code>.
     * CoinPayments config.
     * @alias module:model/CoinPayments
     ...
     * @param credentials {module:model/CoinPaymentsAllOfCredentials} 
     */
    constructor(acceptedCurrencies, gatewayName, method, credentials) { 
        ...
        CoinPayments.initialize(this, acceptedCurrencies, gatewayName, method, credentials);
    }
    ...
    /**
     * Constructs a <code>CoinPayments</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CoinPayments} obj Optional instance to populate.
     * @return {module:model/CoinPayments} The populated <code>CoinPayments</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CoinPayments();
            GatewayAccount.constructFromObject(data, obj);
            GatewayAccount.constructFromObject(data, obj);

            if (data.hasOwnProperty('credentials')) {
                obj['credentials'] = CoinPaymentsAllOfCredentials.constructFromObject(data['credentials']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>CoinPayments</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CoinPayments</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CoinPayments.RequiredProperties) {
        ...
        if (data['credentials']) { // data not null
          CoinPaymentsAllOfCredentials.validateJSON(data['credentials']);
        }
...
CoinPayments.RequiredProperties = ["credentials", "acceptedCurrencies", "gatewayName", "method"];

/**
 * @member {module:model/CoinPaymentsAllOfCredentials} credentials
 */
CoinPayments.prototype['credentials'] = undefined;
