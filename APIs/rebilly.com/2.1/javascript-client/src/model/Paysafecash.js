...
import PaysafecashAllOfCredentials from './PaysafecashAllOfCredentials';

/**
 * The Paysafecash model module.
 * @module model/Paysafecash
 * @version 2.1
 */
class Paysafecash {
    /**
     * Constructs a new <code>Paysafecash</code>.
     * Paysafecash Gateway config.
     * @alias module:model/Paysafecash
     ...
     * @param credentials {module:model/PaysafecashAllOfCredentials} 
     */
    constructor(acceptedCurrencies, gatewayName, method, credentials) { 
        ...
        Paysafecash.initialize(this, acceptedCurrencies, gatewayName, method, credentials);
    }
    ...
    /**
     * Constructs a <code>Paysafecash</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Paysafecash} obj Optional instance to populate.
     * @return {module:model/Paysafecash} The populated <code>Paysafecash</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new Paysafecash();
            GatewayAccount.constructFromObject(data, obj);
            GatewayAccount.constructFromObject(data, obj);

            if (data.hasOwnProperty('credentials')) {
                obj['credentials'] = PaysafecashAllOfCredentials.constructFromObject(data['credentials']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>Paysafecash</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Paysafecash</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of Paysafecash.RequiredProperties) {
        ...
        if (data['credentials']) { // data not null
          PaysafecashAllOfCredentials.validateJSON(data['credentials']);
        }
...
Paysafecash.RequiredProperties = ["credentials", "acceptedCurrencies", "gatewayName", "method"];

/**
 * @member {module:model/PaysafecashAllOfCredentials} credentials
 */
Paysafecash.prototype['credentials'] = undefined;
