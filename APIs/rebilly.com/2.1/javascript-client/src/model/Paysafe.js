...
import PaysafeAllOfCredentials from './PaysafeAllOfCredentials';

/**
 * The Paysafe model module.
 * @module model/Paysafe
 * @version 2.1
 */
class Paysafe {
    /**
     * Constructs a new <code>Paysafe</code>.
     * Paysafe Gateway config.
     * @alias module:model/Paysafe
     ...
     * @param credentials {module:model/PaysafeAllOfCredentials} 
     */
    constructor(acceptedCurrencies, gatewayName, method, credentials) { 
        ...
        Paysafe.initialize(this, acceptedCurrencies, gatewayName, method, credentials);
    }
    ...
    /**
     * Constructs a <code>Paysafe</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Paysafe} obj Optional instance to populate.
     * @return {module:model/Paysafe} The populated <code>Paysafe</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('credentials')) {
                obj['credentials'] = PaysafeAllOfCredentials.constructFromObject(data['credentials']);
            }
            if (data.hasOwnProperty('threeDSecureServer')) {
                obj['threeDSecureServer'] = Paysafe3dsServers.constructFromObject(data['threeDSecureServer']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>Paysafe</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Paysafe</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of Paysafe.RequiredProperties) {
        ...
        if (data['credentials']) { // data not null
          PaysafeAllOfCredentials.validateJSON(data['credentials']);
        }
        // validate the optional field `threeDSecureServer`
        if (data['threeDSecureServer']) { // data not null
          Paysafe3dsServers.validateJSON(data['threeDSecureServer']);
        }
...
Paysafe.RequiredProperties = ["credentials", "acceptedCurrencies", "gatewayName", "method"];

/**
 * @member {module:model/PaysafeAllOfCredentials} credentials
 */
Paysafe.prototype['credentials'] = undefined;

/**
 * @member {module:model/Paysafe3dsServers} threeDSecureServer
 */
Paysafe.prototype['threeDSecureServer'] = undefined;
