...
import NetellerAllOfCredentials from './NetellerAllOfCredentials';
import NetellerAllOfSettings from './NetellerAllOfSettings';
import PaymentCardBrand from './PaymentCardBrand';
import PaymentMethod from './PaymentMethod';

/**
 * The Neteller model module.
 * @module model/Neteller
 * @version 2.1
 */
class Neteller {
    /**
     * Constructs a new <code>Neteller</code>.
     * Neteller Gateway config.
     * @alias module:model/Neteller
     ...
     * @param credentials {module:model/NetellerAllOfCredentials} 
     */
    constructor(acceptedCurrencies, gatewayName, method, credentials) { 
        ...
        Neteller.initialize(this, acceptedCurrencies, gatewayName, method, credentials);
    }
    ...
    /**
     * Constructs a <code>Neteller</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Neteller} obj Optional instance to populate.
     * @return {module:model/Neteller} The populated <code>Neteller</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new Neteller();
            GatewayAccount.constructFromObject(data, obj);
            GatewayAccount.constructFromObject(data, obj);

            if (data.hasOwnProperty('credentials')) {
                obj['credentials'] = NetellerAllOfCredentials.constructFromObject(data['credentials']);
            }
            if (data.hasOwnProperty('settings')) {
                obj['settings'] = NetellerAllOfSettings.constructFromObject(data['settings']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>Neteller</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Neteller</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of Neteller.RequiredProperties) {
        ...
        if (data['credentials']) { // data not null
          NetellerAllOfCredentials.validateJSON(data['credentials']);
        }
        // validate the optional field `settings`
        if (data['settings']) { // data not null
          NetellerAllOfSettings.validateJSON(data['settings']);
        }
...
Neteller.RequiredProperties = ["credentials", "acceptedCurrencies", "gatewayName", "method"];

/**
 * @member {module:model/NetellerAllOfCredentials} credentials
 */
Neteller.prototype['credentials'] = undefined;

/**
 * @member {module:model/NetellerAllOfSettings} settings
 */
Neteller.prototype['settings'] = undefined;
