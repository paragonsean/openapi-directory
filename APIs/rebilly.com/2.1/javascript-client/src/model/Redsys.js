...
import RedsysAllOfCredentials from './RedsysAllOfCredentials';

/**
 * The Redsys model module.
 * @module model/Redsys
 * @version 2.1
 */
class Redsys {
    /**
     * Constructs a new <code>Redsys</code>.
     * Redsys Gateway config.
     * @alias module:model/Redsys
     ...
     * @param credentials {module:model/RedsysAllOfCredentials} 
     */
    constructor(acceptedCurrencies, gatewayName, method, credentials) { 
        ...
        Redsys.initialize(this, acceptedCurrencies, gatewayName, method, credentials);
    }
    ...
    /**
     * Constructs a <code>Redsys</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Redsys} obj Optional instance to populate.
     * @return {module:model/Redsys} The populated <code>Redsys</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('credentials')) {
                obj['credentials'] = RedsysAllOfCredentials.constructFromObject(data['credentials']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>Redsys</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Redsys</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of Redsys.RequiredProperties) {
        ...
        if (data['credentials']) { // data not null
          RedsysAllOfCredentials.validateJSON(data['credentials']);
        }
...
Redsys.RequiredProperties = ["credentials", "acceptedCurrencies", "gatewayName", "method"];

/**
 * @member {module:model/RedsysAllOfCredentials} credentials
 */
Redsys.prototype['credentials'] = undefined;
