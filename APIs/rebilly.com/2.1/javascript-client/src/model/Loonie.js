...
import LoonieAllOfCredentials from './LoonieAllOfCredentials';
import PaymentCardBrand from './PaymentCardBrand';
import PaymentMethod from './PaymentMethod';

/**
 * The Loonie model module.
 * @module model/Loonie
 * @version 2.1
 */
class Loonie {
    /**
     * Constructs a new <code>Loonie</code>.
     * loonie config.
     * @alias module:model/Loonie
     ...
     * @param credentials {module:model/LoonieAllOfCredentials} 
     */
    constructor(acceptedCurrencies, gatewayName, method, credentials) { 
        ...
        Loonie.initialize(this, acceptedCurrencies, gatewayName, method, credentials);
    }
    ...
    /**
     * Constructs a <code>Loonie</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Loonie} obj Optional instance to populate.
     * @return {module:model/Loonie} The populated <code>Loonie</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('credentials')) {
                obj['credentials'] = LoonieAllOfCredentials.constructFromObject(data['credentials']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>Loonie</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Loonie</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of Loonie.RequiredProperties) {
        ...
        if (data['credentials']) { // data not null
          LoonieAllOfCredentials.validateJSON(data['credentials']);
        }
...
Loonie.RequiredProperties = ["credentials", "acceptedCurrencies", "gatewayName", "method"];

/**
 * @member {module:model/LoonieAllOfCredentials} credentials
 */
Loonie.prototype['credentials'] = undefined;
