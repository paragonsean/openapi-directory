...
import NetbankingAllOfCredentials from './NetbankingAllOfCredentials';
import PaymentCardBrand from './PaymentCardBrand';
import PaymentMethod from './PaymentMethod';

/**
 * The Netbanking model module.
 * @module model/Netbanking
 * @version 2.1
 */
class Netbanking {
    /**
     * Constructs a new <code>Netbanking</code>.
     * Netbanking config.
     * @alias module:model/Netbanking
     ...
     * @param credentials {module:model/NetbankingAllOfCredentials} 
     */
    constructor(acceptedCurrencies, gatewayName, method, credentials) { 
        ...
        Netbanking.initialize(this, acceptedCurrencies, gatewayName, method, credentials);
    }
    ...
    /**
     * Constructs a <code>Netbanking</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Netbanking} obj Optional instance to populate.
     * @return {module:model/Netbanking} The populated <code>Netbanking</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new Netbanking();
            GatewayAccount.constructFromObject(data, obj);
            GatewayAccount.constructFromObject(data, obj);

            if (data.hasOwnProperty('credentials')) {
                obj['credentials'] = NetbankingAllOfCredentials.constructFromObject(data['credentials']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>Netbanking</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Netbanking</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of Netbanking.RequiredProperties) {
        ...
        if (data['credentials']) { // data not null
          NetbankingAllOfCredentials.validateJSON(data['credentials']);
        }
...
Netbanking.RequiredProperties = ["credentials", "acceptedCurrencies", "gatewayName", "method"];

/**
 * @member {module:model/NetbankingAllOfCredentials} credentials
 */
Netbanking.prototype['credentials'] = undefined;
