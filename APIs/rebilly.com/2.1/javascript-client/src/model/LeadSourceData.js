...
/**
 * The LeadSourceData model module.
 * @module model/LeadSourceData
 * @version 2.1
 */
class LeadSourceData {
    /**
     * Constructs a new <code>LeadSourceData</code>.
     * @alias module:model/LeadSourceData
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>LeadSourceData</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/LeadSourceData} obj Optional instance to populate.
     * @return {module:model/LeadSourceData} The populated <code>LeadSourceData</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new LeadSourceData();
    ...
    /**
     * Validates the JSON data with respect to <code>LeadSourceData</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>LeadSourceData</code>.
     */
