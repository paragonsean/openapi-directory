...
import CauriPaymentAllOfCredentials from './CauriPaymentAllOfCredentials';
...
/**
 * The CauriPayment model module.
 * @module model/CauriPayment
 * @version 2.1
 */
class CauriPayment {
    /**
     * Constructs a new <code>CauriPayment</code>.
     * CauriPayment config.
     * @alias module:model/CauriPayment
     ...
     * @param credentials {module:model/CauriPaymentAllOfCredentials} 
     */
    constructor(acceptedCurrencies, gatewayName, method, credentials) { 
        ...
        CauriPayment.initialize(this, acceptedCurrencies, gatewayName, method, credentials);
    }
    ...
    /**
     * Constructs a <code>CauriPayment</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CauriPayment} obj Optional instance to populate.
     * @return {module:model/CauriPayment} The populated <code>CauriPayment</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CauriPayment();
            GatewayAccount.constructFromObject(data, obj);
            GatewayAccount.constructFromObject(data, obj);

            if (data.hasOwnProperty('credentials')) {
                obj['credentials'] = CauriPaymentAllOfCredentials.constructFromObject(data['credentials']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>CauriPayment</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CauriPayment</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CauriPayment.RequiredProperties) {
        ...
        if (data['credentials']) { // data not null
          CauriPaymentAllOfCredentials.validateJSON(data['credentials']);
        }
...
CauriPayment.RequiredProperties = ["credentials", "acceptedCurrencies", "gatewayName", "method"];

/**
 * @member {module:model/CauriPaymentAllOfCredentials} credentials
 */
CauriPayment.prototype['credentials'] = undefined;
