...
import Wallet88AllOfCredentials from './Wallet88AllOfCredentials';

/**
 * The Wallet88 model module.
 * @module model/Wallet88
 * @version 2.1
 */
class Wallet88 {
    /**
     * Constructs a new <code>Wallet88</code>.
     * Wallet88 config.
     * @alias module:model/Wallet88
     ...
     * @param credentials {module:model/Wallet88AllOfCredentials} 
     */
    constructor(acceptedCurrencies, gatewayName, method, credentials) { 
        ...
        Wallet88.initialize(this, acceptedCurrencies, gatewayName, method, credentials);
    }
    ...
    /**
     * Constructs a <code>Wallet88</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Wallet88} obj Optional instance to populate.
     * @return {module:model/Wallet88} The populated <code>Wallet88</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new Wallet88();
            GatewayAccount.constructFromObject(data, obj);
            GatewayAccount.constructFromObject(data, obj);

            if (data.hasOwnProperty('credentials')) {
                obj['credentials'] = Wallet88AllOfCredentials.constructFromObject(data['credentials']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>Wallet88</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Wallet88</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of Wallet88.RequiredProperties) {
        ...
        if (data['credentials']) { // data not null
          Wallet88AllOfCredentials.validateJSON(data['credentials']);
        }
...
Wallet88.RequiredProperties = ["credentials", "acceptedCurrencies", "gatewayName", "method"];

/**
 * @member {module:model/Wallet88AllOfCredentials} credentials
 */
Wallet88.prototype['credentials'] = undefined;
