...
/**
 * The CommonSubscriptionOrder model module.
 * @module model/CommonSubscriptionOrder
 * @version 2.1
 */
class CommonSubscriptionOrder {
    /**
     * Constructs a new <code>CommonSubscriptionOrder</code>.
     * @alias module:model/CommonSubscriptionOrder
     * @implements module:model/CommonSubscription
     */
    constructor() { 
        CommonSubscription.initialize(this);
        CommonSubscriptionOrder.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CommonSubscriptionOrder</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CommonSubscriptionOrder} obj Optional instance to populate.
     * @return {module:model/CommonSubscriptionOrder} The populated <code>CommonSubscriptionOrder</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CommonSubscriptionOrder();
    ...
    /**
     * Validates the JSON data with respect to <code>CommonSubscriptionOrder</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CommonSubscriptionOrder</code>.
     */
 ...
 * @readonly
 */
CommonSubscriptionOrder['BillingStatusEnum'] = {
 ...
 * @readonly
 */
CommonSubscriptionOrder['OrderTypeEnum'] = {
 ...
 * @readonly
 */
CommonSubscriptionOrder['StatusEnum'] = {
...
export default CommonSubscriptionOrder;
