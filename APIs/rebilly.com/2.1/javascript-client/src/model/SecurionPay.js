...
import SecurionPay3dsServers from './SecurionPay3dsServers';
import SecurionPayAllOfCredentials from './SecurionPayAllOfCredentials';

/**
 * The SecurionPay model module.
 * @module model/SecurionPay
 * @version 2.1
 */
class SecurionPay {
    /**
     * Constructs a new <code>SecurionPay</code>.
     * SecurionPay config.
     * @alias module:model/SecurionPay
     ...
     * @param credentials {module:model/SecurionPayAllOfCredentials} 
     */
    constructor(acceptedCurrencies, gatewayName, method, credentials) { 
        ...
        SecurionPay.initialize(this, acceptedCurrencies, gatewayName, method, credentials);
    }
    ...
    /**
     * Constructs a <code>SecurionPay</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SecurionPay} obj Optional instance to populate.
     * @return {module:model/SecurionPay} The populated <code>SecurionPay</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SecurionPay();
            GatewayAccount.constructFromObject(data, obj);
            GatewayAccount.constructFromObject(data, obj);

            if (data.hasOwnProperty('credentials')) {
                obj['credentials'] = SecurionPayAllOfCredentials.constructFromObject(data['credentials']);
            }
            if (data.hasOwnProperty('threeDSecureServer')) {
                obj['threeDSecureServer'] = SecurionPay3dsServers.constructFromObject(data['threeDSecureServer']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>SecurionPay</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SecurionPay</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of SecurionPay.RequiredProperties) {
        ...
        if (data['credentials']) { // data not null
          SecurionPayAllOfCredentials.validateJSON(data['credentials']);
        }
        // validate the optional field `threeDSecureServer`
        if (data['threeDSecureServer']) { // data not null
          SecurionPay3dsServers.validateJSON(data['threeDSecureServer']);
        }
...
SecurionPay.RequiredProperties = ["credentials", "acceptedCurrencies", "gatewayName", "method"];

/**
 * @member {module:model/SecurionPayAllOfCredentials} credentials
 */
SecurionPay.prototype['credentials'] = undefined;

/**
 * @member {module:model/SecurionPay3dsServers} threeDSecureServer
 */
SecurionPay.prototype['threeDSecureServer'] = undefined;
