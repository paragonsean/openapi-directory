...
import InstaDebitAllOfCredentials from './InstaDebitAllOfCredentials';
import PaymentCardBrand from './PaymentCardBrand';
import PaymentMethod from './PaymentMethod';

/**
 * The InstaDebit model module.
 * @module model/InstaDebit
 * @version 2.1
 */
class InstaDebit {
    /**
     * Constructs a new <code>InstaDebit</code>.
     * InstaDebit config.
     * @alias module:model/InstaDebit
     ...
     * @param credentials {module:model/InstaDebitAllOfCredentials} 
     */
    constructor(acceptedCurrencies, gatewayName, method, credentials) { 
        ...
        InstaDebit.initialize(this, acceptedCurrencies, gatewayName, method, credentials);
    }
    ...
    /**
     * Constructs a <code>InstaDebit</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/InstaDebit} obj Optional instance to populate.
     * @return {module:model/InstaDebit} The populated <code>InstaDebit</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new InstaDebit();
            GatewayAccount.constructFromObject(data, obj);
            GatewayAccount.constructFromObject(data, obj);

            if (data.hasOwnProperty('credentials')) {
                obj['credentials'] = InstaDebitAllOfCredentials.constructFromObject(data['credentials']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>InstaDebit</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>InstaDebit</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of InstaDebit.RequiredProperties) {
        ...
        if (data['credentials']) { // data not null
          InstaDebitAllOfCredentials.validateJSON(data['credentials']);
        }
...
InstaDebit.RequiredProperties = ["credentials", "acceptedCurrencies", "gatewayName", "method"];

/**
 * @member {module:model/InstaDebitAllOfCredentials} credentials
 */
InstaDebit.prototype['credentials'] = undefined;
