...
import ChaseAllOfCredentials from './ChaseAllOfCredentials';
...
/**
 * The Chase model module.
 * @module model/Chase
 * @version 2.1
 */
class Chase {
    /**
     * Constructs a new <code>Chase</code>.
     * Chase Gateway config.
     * @alias module:model/Chase
     ...
     * @param credentials {module:model/ChaseAllOfCredentials} 
     */
    constructor(acceptedCurrencies, gatewayName, method, credentials) { 
        ...
        Chase.initialize(this, acceptedCurrencies, gatewayName, method, credentials);
    }
    ...
    /**
     * Constructs a <code>Chase</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Chase} obj Optional instance to populate.
     * @return {module:model/Chase} The populated <code>Chase</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('credentials')) {
                obj['credentials'] = ChaseAllOfCredentials.constructFromObject(data['credentials']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>Chase</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Chase</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of Chase.RequiredProperties) {
        ...
        if (data['credentials']) { // data not null
          ChaseAllOfCredentials.validateJSON(data['credentials']);
        }
...
Chase.RequiredProperties = ["credentials", "acceptedCurrencies", "gatewayName", "method"];

/**
 * @member {module:model/ChaseAllOfCredentials} credentials
 */
Chase.prototype['credentials'] = undefined;
