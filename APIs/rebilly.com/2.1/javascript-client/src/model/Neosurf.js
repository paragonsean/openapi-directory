...
import NeosurfAllOfCredentials from './NeosurfAllOfCredentials';
import PaymentCardBrand from './PaymentCardBrand';
import PaymentMethod from './PaymentMethod';

/**
 * The Neosurf model module.
 * @module model/Neosurf
 * @version 2.1
 */
class Neosurf {
    /**
     * Constructs a new <code>Neosurf</code>.
     * Neosurf config.
     * @alias module:model/Neosurf
     ...
     * @param credentials {module:model/NeosurfAllOfCredentials} 
     */
    constructor(acceptedCurrencies, gatewayName, method, credentials) { 
        ...
        Neosurf.initialize(this, acceptedCurrencies, gatewayName, method, credentials);
    }
    ...
    /**
     * Constructs a <code>Neosurf</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Neosurf} obj Optional instance to populate.
     * @return {module:model/Neosurf} The populated <code>Neosurf</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('credentials')) {
                obj['credentials'] = NeosurfAllOfCredentials.constructFromObject(data['credentials']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>Neosurf</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Neosurf</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of Neosurf.RequiredProperties) {
        ...
        if (data['credentials']) { // data not null
          NeosurfAllOfCredentials.validateJSON(data['credentials']);
        }
...
Neosurf.RequiredProperties = ["credentials", "acceptedCurrencies", "gatewayName", "method"];

/**
 * @member {module:model/NeosurfAllOfCredentials} credentials
 */
Neosurf.prototype['credentials'] = undefined;
