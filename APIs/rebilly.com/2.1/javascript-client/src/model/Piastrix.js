...
import Piastrix3dsServers from './Piastrix3dsServers';
import PiastrixAllOfCredentials from './PiastrixAllOfCredentials';
import PiastrixAllOfSettings from './PiastrixAllOfSettings';

/**
 * The Piastrix model module.
 * @module model/Piastrix
 * @version 2.1
 */
class Piastrix {
    /**
     * Constructs a new <code>Piastrix</code>.
     * Piastrix config.
     * @alias module:model/Piastrix
     ...
     * @param credentials {module:model/PiastrixAllOfCredentials} 
     */
    constructor(acceptedCurrencies, gatewayName, method, credentials) { 
        ...
        Piastrix.initialize(this, acceptedCurrencies, gatewayName, method, credentials);
    }
    ...
    /**
     * Constructs a <code>Piastrix</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Piastrix} obj Optional instance to populate.
     * @return {module:model/Piastrix} The populated <code>Piastrix</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new Piastrix();
            GatewayAccount.constructFromObject(data, obj);
            GatewayAccount.constructFromObject(data, obj);

            if (data.hasOwnProperty('credentials')) {
                obj['credentials'] = PiastrixAllOfCredentials.constructFromObject(data['credentials']);
            }
            if (data.hasOwnProperty('settings')) {
                obj['settings'] = PiastrixAllOfSettings.constructFromObject(data['settings']);
            }
            if (data.hasOwnProperty('threeDSecureServer')) {
                obj['threeDSecureServer'] = Piastrix3dsServers.constructFromObject(data['threeDSecureServer']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>Piastrix</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Piastrix</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of Piastrix.RequiredProperties) {
        ...
        if (data['credentials']) { // data not null
          PiastrixAllOfCredentials.validateJSON(data['credentials']);
        }
        // validate the optional field `settings`
        if (data['settings']) { // data not null
          PiastrixAllOfSettings.validateJSON(data['settings']);
        }
        // validate the optional field `threeDSecureServer`
        if (data['threeDSecureServer']) { // data not null
          Piastrix3dsServers.validateJSON(data['threeDSecureServer']);
        }
...
Piastrix.RequiredProperties = ["credentials", "acceptedCurrencies", "gatewayName", "method"];

/**
 * @member {module:model/PiastrixAllOfCredentials} credentials
 */
Piastrix.prototype['credentials'] = undefined;

/**
 * @member {module:model/PiastrixAllOfSettings} settings
 */
Piastrix.prototype['settings'] = undefined;

/**
 * @member {module:model/Piastrix3dsServers} threeDSecureServer
 */
Piastrix.prototype['threeDSecureServer'] = undefined;
