...
import PostFinanceAllOfCredentials from './PostFinanceAllOfCredentials';

/**
 * The PostFinance model module.
 * @module model/PostFinance
 * @version 2.1
 */
class PostFinance {
    /**
     * Constructs a new <code>PostFinance</code>.
     * PostFinance config.
     * @alias module:model/PostFinance
     ...
     * @param credentials {module:model/PostFinanceAllOfCredentials} 
     */
    constructor(acceptedCurrencies, gatewayName, method, credentials) { 
        ...
        PostFinance.initialize(this, acceptedCurrencies, gatewayName, method, credentials);
    }
    ...
    /**
     * Constructs a <code>PostFinance</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PostFinance} obj Optional instance to populate.
     * @return {module:model/PostFinance} The populated <code>PostFinance</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PostFinance();
            GatewayAccount.constructFromObject(data, obj);
            GatewayAccount.constructFromObject(data, obj);

            if (data.hasOwnProperty('credentials')) {
                obj['credentials'] = PostFinanceAllOfCredentials.constructFromObject(data['credentials']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>PostFinance</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PostFinance</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of PostFinance.RequiredProperties) {
        ...
        if (data['credentials']) { // data not null
          PostFinanceAllOfCredentials.validateJSON(data['credentials']);
        }
...
PostFinance.RequiredProperties = ["credentials", "acceptedCurrencies", "gatewayName", "method"];

/**
 * @member {module:model/PostFinanceAllOfCredentials} credentials
 */
PostFinance.prototype['credentials'] = undefined;
