...
import EBANXAllOfCredentials from './EBANXAllOfCredentials';
...
/**
 * The EBANX model module.
 * @module model/EBANX
 * @version 2.1
 */
class EBANX {
    /**
     * Constructs a new <code>EBANX</code>.
     * EBANX config.
     * @alias module:model/EBANX
     ...
     * @param credentials {module:model/EBANXAllOfCredentials} 
     */
    constructor(acceptedCurrencies, gatewayName, method, credentials) { 
        ...
        EBANX.initialize(this, acceptedCurrencies, gatewayName, method, credentials);
    }
    ...
    /**
     * Constructs a <code>EBANX</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/EBANX} obj Optional instance to populate.
     * @return {module:model/EBANX} The populated <code>EBANX</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('credentials')) {
                obj['credentials'] = EBANXAllOfCredentials.constructFromObject(data['credentials']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>EBANX</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EBANX</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of EBANX.RequiredProperties) {
        ...
        if (data['credentials']) { // data not null
          EBANXAllOfCredentials.validateJSON(data['credentials']);
        }
...
EBANX.RequiredProperties = ["credentials", "acceptedCurrencies", "gatewayName", "method"];

/**
 * @member {module:model/EBANXAllOfCredentials} credentials
 */
EBANX.prototype['credentials'] = undefined;
