...
import EMerchantPayAllOfCredentials from './EMerchantPayAllOfCredentials';
import EMerchantPayAllOfSettings from './EMerchantPayAllOfSettings';
...
/**
 * The EMerchantPay model module.
 * @module model/EMerchantPay
 * @version 2.1
 */
class EMerchantPay {
    /**
     * Constructs a new <code>EMerchantPay</code>.
     * eMerchantPay Gateway config.
     * @alias module:model/EMerchantPay
     ...
     * @param credentials {module:model/EMerchantPayAllOfCredentials} 
     */
    constructor(acceptedCurrencies, gatewayName, method, credentials) { 
        ...
        EMerchantPay.initialize(this, acceptedCurrencies, gatewayName, method, credentials);
    }
    ...
    /**
     * Constructs a <code>EMerchantPay</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/EMerchantPay} obj Optional instance to populate.
     * @return {module:model/EMerchantPay} The populated <code>EMerchantPay</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new EMerchantPay();
            GatewayAccount.constructFromObject(data, obj);
            GatewayAccount.constructFromObject(data, obj);

            if (data.hasOwnProperty('credentials')) {
                obj['credentials'] = EMerchantPayAllOfCredentials.constructFromObject(data['credentials']);
            }
            if (data.hasOwnProperty('settings')) {
                obj['settings'] = EMerchantPayAllOfSettings.constructFromObject(data['settings']);
            }
            if (data.hasOwnProperty('threeDSecureServer')) {
                obj['threeDSecureServer'] = EMerchantPay3dsServers.constructFromObject(data['threeDSecureServer']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>EMerchantPay</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EMerchantPay</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of EMerchantPay.RequiredProperties) {
        ...
        if (data['credentials']) { // data not null
          EMerchantPayAllOfCredentials.validateJSON(data['credentials']);
        }
        // validate the optional field `settings`
        if (data['settings']) { // data not null
          EMerchantPayAllOfSettings.validateJSON(data['settings']);
        }
        // validate the optional field `threeDSecureServer`
        if (data['threeDSecureServer']) { // data not null
          EMerchantPay3dsServers.validateJSON(data['threeDSecureServer']);
        }
...
EMerchantPay.RequiredProperties = ["credentials", "acceptedCurrencies", "gatewayName", "method"];

/**
 * @member {module:model/EMerchantPayAllOfCredentials} credentials
 */
EMerchantPay.prototype['credentials'] = undefined;

/**
 * @member {module:model/EMerchantPayAllOfSettings} settings
 */
EMerchantPay.prototype['settings'] = undefined;

/**
 * @member {module:model/EMerchantPay3dsServers} threeDSecureServer
 */
EMerchantPay.prototype['threeDSecureServer'] = undefined;
