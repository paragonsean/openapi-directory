...
import GlobalOneAllOfCredentials from './GlobalOneAllOfCredentials';
import PaymentCardBrand from './PaymentCardBrand';
import PaymentMethod from './PaymentMethod';

/**
 * The GlobalOne model module.
 * @module model/GlobalOne
 * @version 2.1
 */
class GlobalOne {
    /**
     * Constructs a new <code>GlobalOne</code>.
     * GlobalOne Gateway config.
     * @alias module:model/GlobalOne
     ...
     * @param credentials {module:model/GlobalOneAllOfCredentials} 
     */
    constructor(acceptedCurrencies, gatewayName, method, credentials) { 
        ...
        GlobalOne.initialize(this, acceptedCurrencies, gatewayName, method, credentials);
    }
    ...
    /**
     * Constructs a <code>GlobalOne</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GlobalOne} obj Optional instance to populate.
     * @return {module:model/GlobalOne} The populated <code>GlobalOne</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GlobalOne();
            GatewayAccount.constructFromObject(data, obj);
            GatewayAccount.constructFromObject(data, obj);

            if (data.hasOwnProperty('credentials')) {
                obj['credentials'] = GlobalOneAllOfCredentials.constructFromObject(data['credentials']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>GlobalOne</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GlobalOne</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of GlobalOne.RequiredProperties) {
        ...
        if (data['credentials']) { // data not null
          GlobalOneAllOfCredentials.validateJSON(data['credentials']);
        }
...
GlobalOne.RequiredProperties = ["credentials", "acceptedCurrencies", "gatewayName", "method"];

/**
 * @member {module:model/GlobalOneAllOfCredentials} credentials
 */
GlobalOne.prototype['credentials'] = undefined;
