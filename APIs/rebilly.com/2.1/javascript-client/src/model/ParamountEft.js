...
import ParamountEftAllOfCredentials from './ParamountEftAllOfCredentials';
import PaymentCardBrand from './PaymentCardBrand';
import PaymentMethod from './PaymentMethod';

/**
 * The ParamountEft model module.
 * @module model/ParamountEft
 * @version 2.1
 */
class ParamountEft {
    /**
     * Constructs a new <code>ParamountEft</code>.
     * Paramount config.
     * @alias module:model/ParamountEft
     ...
     * @param credentials {module:model/ParamountEftAllOfCredentials} 
     */
    constructor(acceptedCurrencies, gatewayName, method, credentials) { 
        ...
        ParamountEft.initialize(this, acceptedCurrencies, gatewayName, method, credentials);
    }
    ...
    /**
     * Constructs a <code>ParamountEft</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ParamountEft} obj Optional instance to populate.
     * @return {module:model/ParamountEft} The populated <code>ParamountEft</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ParamountEft();
            GatewayAccount.constructFromObject(data, obj);
            GatewayAccount.constructFromObject(data, obj);

            if (data.hasOwnProperty('credentials')) {
                obj['credentials'] = ParamountEftAllOfCredentials.constructFromObject(data['credentials']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ParamountEft</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ParamountEft</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ParamountEft.RequiredProperties) {
        ...
        if (data['credentials']) { // data not null
          ParamountEftAllOfCredentials.validateJSON(data['credentials']);
        }
...
ParamountEft.RequiredProperties = ["credentials", "acceptedCurrencies", "gatewayName", "method"];

/**
 * @member {module:model/ParamountEftAllOfCredentials} credentials
 */
ParamountEft.prototype['credentials'] = undefined;
