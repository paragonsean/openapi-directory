...
import VCreditosAllOfCredentials from './VCreditosAllOfCredentials';

/**
 * The VCreditos model module.
 * @module model/VCreditos
 * @version 2.1
 */
class VCreditos {
    /**
     * Constructs a new <code>VCreditos</code>.
     * VCreditos config.
     * @alias module:model/VCreditos
     ...
     * @param credentials {module:model/VCreditosAllOfCredentials} 
     */
    constructor(acceptedCurrencies, gatewayName, method, credentials) { 
        ...
        VCreditos.initialize(this, acceptedCurrencies, gatewayName, method, credentials);
    }
    ...
    /**
     * Constructs a <code>VCreditos</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/VCreditos} obj Optional instance to populate.
     * @return {module:model/VCreditos} The populated <code>VCreditos</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new VCreditos();
            GatewayAccount.constructFromObject(data, obj);
            GatewayAccount.constructFromObject(data, obj);

            if (data.hasOwnProperty('credentials')) {
                obj['credentials'] = VCreditosAllOfCredentials.constructFromObject(data['credentials']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>VCreditos</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>VCreditos</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of VCreditos.RequiredProperties) {
        ...
        if (data['credentials']) { // data not null
          VCreditosAllOfCredentials.validateJSON(data['credentials']);
        }
...
VCreditos.RequiredProperties = ["credentials", "acceptedCurrencies", "gatewayName", "method"];

/**
 * @member {module:model/VCreditosAllOfCredentials} credentials
 */
VCreditos.prototype['credentials'] = undefined;
