...
import ZotapayAllOfCredentials from './ZotapayAllOfCredentials';

/**
 * The Zotapay model module.
 * @module model/Zotapay
 * @version 2.1
 */
class Zotapay {
    /**
     * Constructs a new <code>Zotapay</code>.
     * Zotapay Gateway config.
     * @alias module:model/Zotapay
     ...
     * @param credentials {module:model/ZotapayAllOfCredentials} 
     */
    constructor(acceptedCurrencies, gatewayName, method, credentials) { 
        ...
        Zotapay.initialize(this, acceptedCurrencies, gatewayName, method, credentials);
    }
    ...
    /**
     * Constructs a <code>Zotapay</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Zotapay} obj Optional instance to populate.
     * @return {module:model/Zotapay} The populated <code>Zotapay</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('credentials')) {
                obj['credentials'] = ZotapayAllOfCredentials.constructFromObject(data['credentials']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>Zotapay</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Zotapay</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of Zotapay.RequiredProperties) {
        ...
        if (data['credentials']) { // data not null
          ZotapayAllOfCredentials.validateJSON(data['credentials']);
        }
...
Zotapay.RequiredProperties = ["credentials", "acceptedCurrencies", "gatewayName", "method"];

/**
 * @member {module:model/ZotapayAllOfCredentials} credentials
 */
Zotapay.prototype['credentials'] = undefined;
