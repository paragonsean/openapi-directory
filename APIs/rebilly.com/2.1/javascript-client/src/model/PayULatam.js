...
import PayULatamAllOfCredentials from './PayULatamAllOfCredentials';
import PaymentCardBrand from './PaymentCardBrand';
import PaymentMethod from './PaymentMethod';

/**
 * The PayULatam model module.
 * @module model/PayULatam
 * @version 2.1
 */
class PayULatam {
    /**
     * Constructs a new <code>PayULatam</code>.
     * PayULatam config.
     * @alias module:model/PayULatam
     ...
     * @param credentials {module:model/PayULatamAllOfCredentials} 
     */
    constructor(acceptedCurrencies, gatewayName, method, credentials) { 
        ...
        PayULatam.initialize(this, acceptedCurrencies, gatewayName, method, credentials);
    }
    ...
    /**
     * Constructs a <code>PayULatam</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PayULatam} obj Optional instance to populate.
     * @return {module:model/PayULatam} The populated <code>PayULatam</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PayULatam();
            GatewayAccount.constructFromObject(data, obj);
            GatewayAccount.constructFromObject(data, obj);

            if (data.hasOwnProperty('credentials')) {
                obj['credentials'] = PayULatamAllOfCredentials.constructFromObject(data['credentials']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>PayULatam</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PayULatam</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of PayULatam.RequiredProperties) {
        ...
        if (data['credentials']) { // data not null
          PayULatamAllOfCredentials.validateJSON(data['credentials']);
        }
...
PayULatam.RequiredProperties = ["credentials", "acceptedCurrencies", "gatewayName", "method"];

/**
 * @member {module:model/PayULatamAllOfCredentials} credentials
 */
PayULatam.prototype['credentials'] = undefined;
