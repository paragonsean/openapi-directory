...
import NMIAllOfCredentials from './NMIAllOfCredentials';
import NMIAllOfSettings from './NMIAllOfSettings';
import PaymentCardBrand from './PaymentCardBrand';
import PaymentMethod from './PaymentMethod';

/**
 * The NMI model module.
 * @module model/NMI
 * @version 2.1
 */
class NMI {
    /**
     * Constructs a new <code>NMI</code>.
     * NMI Gateway config.
     * @alias module:model/NMI
     ...
     * @param credentials {module:model/NMIAllOfCredentials} 
     */
    constructor(acceptedCurrencies, gatewayName, method, credentials) { 
        ...
        NMI.initialize(this, acceptedCurrencies, gatewayName, method, credentials);
    }
    ...
    /**
     * Constructs a <code>NMI</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/NMI} obj Optional instance to populate.
     * @return {module:model/NMI} The populated <code>NMI</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('credentials')) {
                obj['credentials'] = NMIAllOfCredentials.constructFromObject(data['credentials']);
            }
            if (data.hasOwnProperty('settings')) {
                obj['settings'] = NMIAllOfSettings.constructFromObject(data['settings']);
            }
            if (data.hasOwnProperty('threeDSecureServer')) {
                obj['threeDSecureServer'] = NMI3dsServers.constructFromObject(data['threeDSecureServer']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>NMI</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>NMI</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of NMI.RequiredProperties) {
        ...
        if (data['credentials']) { // data not null
          NMIAllOfCredentials.validateJSON(data['credentials']);
        }
        // validate the optional field `settings`
        if (data['settings']) { // data not null
          NMIAllOfSettings.validateJSON(data['settings']);
        }
        // validate the optional field `threeDSecureServer`
        if (data['threeDSecureServer']) { // data not null
          NMI3dsServers.validateJSON(data['threeDSecureServer']);
        }
...
NMI.RequiredProperties = ["credentials", "acceptedCurrencies", "gatewayName", "method"];

/**
 * @member {module:model/NMIAllOfCredentials} credentials
 */
NMI.prototype['credentials'] = undefined;

/**
 * @member {module:model/NMIAllOfSettings} settings
 */
NMI.prototype['settings'] = undefined;

/**
 * @member {module:model/NMI3dsServers} threeDSecureServer
 */
NMI.prototype['threeDSecureServer'] = undefined;
