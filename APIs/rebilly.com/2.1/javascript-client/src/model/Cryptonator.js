...
import CryptonatorAllOfCredentials from './CryptonatorAllOfCredentials';
...
/**
 * The Cryptonator model module.
 * @module model/Cryptonator
 * @version 2.1
 */
class Cryptonator {
    /**
     * Constructs a new <code>Cryptonator</code>.
     * Cryptonator config.
     * @alias module:model/Cryptonator
     ...
     * @param credentials {module:model/CryptonatorAllOfCredentials} 
     */
    constructor(acceptedCurrencies, gatewayName, method, credentials) { 
        ...
        Cryptonator.initialize(this, acceptedCurrencies, gatewayName, method, credentials);
    }
    ...
    /**
     * Constructs a <code>Cryptonator</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Cryptonator} obj Optional instance to populate.
     * @return {module:model/Cryptonator} The populated <code>Cryptonator</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new Cryptonator();
            GatewayAccount.constructFromObject(data, obj);
            GatewayAccount.constructFromObject(data, obj);

            if (data.hasOwnProperty('credentials')) {
                obj['credentials'] = CryptonatorAllOfCredentials.constructFromObject(data['credentials']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>Cryptonator</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Cryptonator</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of Cryptonator.RequiredProperties) {
        ...
        if (data['credentials']) { // data not null
          CryptonatorAllOfCredentials.validateJSON(data['credentials']);
        }
...
Cryptonator.RequiredProperties = ["credentials", "acceptedCurrencies", "gatewayName", "method"];

/**
 * @member {module:model/CryptonatorAllOfCredentials} credentials
 */
Cryptonator.prototype['credentials'] = undefined;
