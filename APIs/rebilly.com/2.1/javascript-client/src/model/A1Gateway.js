...
import A1GatewayAllOfCredentials from './A1GatewayAllOfCredentials';
...
/**
 * The A1Gateway model module.
 * @module model/A1Gateway
 * @version 2.1
 */
class A1Gateway {
    /**
     * Constructs a new <code>A1Gateway</code>.
     * A1Gateway config.
     * @alias module:model/A1Gateway
     ...
     * @param credentials {module:model/A1GatewayAllOfCredentials} 
     */
    constructor(acceptedCurrencies, gatewayName, method, credentials) { 
        ...
        A1Gateway.initialize(this, acceptedCurrencies, gatewayName, method, credentials);
    }
    ...
    /**
     * Constructs a <code>A1Gateway</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/A1Gateway} obj Optional instance to populate.
     * @return {module:model/A1Gateway} The populated <code>A1Gateway</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new A1Gateway();
            GatewayAccount.constructFromObject(data, obj);
            GatewayAccount.constructFromObject(data, obj);

            if (data.hasOwnProperty('credentials')) {
                obj['credentials'] = A1GatewayAllOfCredentials.constructFromObject(data['credentials']);
            }
            if (data.hasOwnProperty('threeDSecureServer')) {
                obj['threeDSecureServer'] = A1Gateway3dsServers.constructFromObject(data['threeDSecureServer']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>A1Gateway</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>A1Gateway</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of A1Gateway.RequiredProperties) {
        ...
        if (data['credentials']) { // data not null
          A1GatewayAllOfCredentials.validateJSON(data['credentials']);
        }
        // validate the optional field `threeDSecureServer`
        if (data['threeDSecureServer']) { // data not null
          A1Gateway3dsServers.validateJSON(data['threeDSecureServer']);
        }
...
A1Gateway.RequiredProperties = ["credentials", "acceptedCurrencies", "gatewayName", "method"];

/**
 * @member {module:model/A1GatewayAllOfCredentials} credentials
 */
A1Gateway.prototype['credentials'] = undefined;

/**
 * @member {module:model/A1Gateway3dsServers} threeDSecureServer
 */
A1Gateway.prototype['threeDSecureServer'] = undefined;
