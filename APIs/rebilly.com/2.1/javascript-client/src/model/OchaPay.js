...
import OchaPayAllOfCredentials from './OchaPayAllOfCredentials';
import PaymentCardBrand from './PaymentCardBrand';
import PaymentMethod from './PaymentMethod';

/**
 * The OchaPay model module.
 * @module model/OchaPay
 * @version 2.1
 */
class OchaPay {
    /**
     * Constructs a new <code>OchaPay</code>.
     * OchaPay Gateway config.
     * @alias module:model/OchaPay
     ...
     * @param credentials {module:model/OchaPayAllOfCredentials} 
     */
    constructor(acceptedCurrencies, gatewayName, method, credentials) { 
        ...
        OchaPay.initialize(this, acceptedCurrencies, gatewayName, method, credentials);
    }
    ...
    /**
     * Constructs a <code>OchaPay</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/OchaPay} obj Optional instance to populate.
     * @return {module:model/OchaPay} The populated <code>OchaPay</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('credentials')) {
                obj['credentials'] = OchaPayAllOfCredentials.constructFromObject(data['credentials']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>OchaPay</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>OchaPay</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of OchaPay.RequiredProperties) {
        ...
        if (data['credentials']) { // data not null
          OchaPayAllOfCredentials.validateJSON(data['credentials']);
        }
...
OchaPay.RequiredProperties = ["credentials", "acceptedCurrencies", "gatewayName", "method"];

/**
 * @member {module:model/OchaPayAllOfCredentials} credentials
 */
OchaPay.prototype['credentials'] = undefined;
