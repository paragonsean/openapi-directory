...
import PagsmileAllOfCredentials from './PagsmileAllOfCredentials';
import PaymentCardBrand from './PaymentCardBrand';
import PaymentMethod from './PaymentMethod';

/**
 * The Pagsmile model module.
 * @module model/Pagsmile
 * @version 2.1
 */
class Pagsmile {
    /**
     * Constructs a new <code>Pagsmile</code>.
     * Pagsmile Gateway config.
     * @alias module:model/Pagsmile
     ...
     * @param credentials {module:model/PagsmileAllOfCredentials} 
     */
    constructor(acceptedCurrencies, gatewayName, method, credentials) { 
        ...
        Pagsmile.initialize(this, acceptedCurrencies, gatewayName, method, credentials);
    }
    ...
    /**
     * Constructs a <code>Pagsmile</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Pagsmile} obj Optional instance to populate.
     * @return {module:model/Pagsmile} The populated <code>Pagsmile</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new Pagsmile();
            GatewayAccount.constructFromObject(data, obj);
            GatewayAccount.constructFromObject(data, obj);

            if (data.hasOwnProperty('credentials')) {
                obj['credentials'] = PagsmileAllOfCredentials.constructFromObject(data['credentials']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>Pagsmile</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Pagsmile</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of Pagsmile.RequiredProperties) {
        ...
        if (data['credentials']) { // data not null
          PagsmileAllOfCredentials.validateJSON(data['credentials']);
        }
...
Pagsmile.RequiredProperties = ["credentials", "acceptedCurrencies", "gatewayName", "method"];

/**
 * @member {module:model/PagsmileAllOfCredentials} credentials
 */
Pagsmile.prototype['credentials'] = undefined;
