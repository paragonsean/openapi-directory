...
import SecureTradingAllOfCredentials from './SecureTradingAllOfCredentials';

/**
 * The SecureTrading model module.
 * @module model/SecureTrading
 * @version 2.1
 */
class SecureTrading {
    /**
     * Constructs a new <code>SecureTrading</code>.
     * SecureTrading config.
     * @alias module:model/SecureTrading
     ...
     * @param credentials {module:model/SecureTradingAllOfCredentials} 
     */
    constructor(acceptedCurrencies, gatewayName, method, credentials) { 
        ...
        SecureTrading.initialize(this, acceptedCurrencies, gatewayName, method, credentials);
    }
    ...
    /**
     * Constructs a <code>SecureTrading</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SecureTrading} obj Optional instance to populate.
     * @return {module:model/SecureTrading} The populated <code>SecureTrading</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SecureTrading();
            GatewayAccount.constructFromObject(data, obj);
            GatewayAccount.constructFromObject(data, obj);

            if (data.hasOwnProperty('credentials')) {
                obj['credentials'] = SecureTradingAllOfCredentials.constructFromObject(data['credentials']);
            }
            if (data.hasOwnProperty('threeDSecureServer')) {
                obj['threeDSecureServer'] = SecureTrading3dsServers.constructFromObject(data['threeDSecureServer']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>SecureTrading</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SecureTrading</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of SecureTrading.RequiredProperties) {
        ...
        if (data['credentials']) { // data not null
          SecureTradingAllOfCredentials.validateJSON(data['credentials']);
        }
        // validate the optional field `threeDSecureServer`
        if (data['threeDSecureServer']) { // data not null
          SecureTrading3dsServers.validateJSON(data['threeDSecureServer']);
        }
...
SecureTrading.RequiredProperties = ["credentials", "acceptedCurrencies", "gatewayName", "method"];

/**
 * @member {module:model/SecureTradingAllOfCredentials} credentials
 */
SecureTrading.prototype['credentials'] = undefined;

/**
 * @member {module:model/SecureTrading3dsServers} threeDSecureServer
 */
SecureTrading.prototype['threeDSecureServer'] = undefined;
