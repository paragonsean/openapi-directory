...
import PayClubAllOfCredentials from './PayClubAllOfCredentials';
import PayClubAllOfSettings from './PayClubAllOfSettings';
import PaymentCardBrand from './PaymentCardBrand';
import PaymentMethod from './PaymentMethod';

/**
 * The PayClub model module.
 * @module model/PayClub
 * @version 2.1
 */
class PayClub {
    /**
     * Constructs a new <code>PayClub</code>.
     * PayClub config.
     * @alias module:model/PayClub
     ...
     * @param credentials {module:model/PayClubAllOfCredentials} 
     */
    constructor(acceptedCurrencies, gatewayName, method, credentials) { 
        ...
        PayClub.initialize(this, acceptedCurrencies, gatewayName, method, credentials);
    }
    ...
    /**
     * Constructs a <code>PayClub</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PayClub} obj Optional instance to populate.
     * @return {module:model/PayClub} The populated <code>PayClub</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('credentials')) {
                obj['credentials'] = PayClubAllOfCredentials.constructFromObject(data['credentials']);
            }
            if (data.hasOwnProperty('settings')) {
                obj['settings'] = PayClubAllOfSettings.constructFromObject(data['settings']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>PayClub</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PayClub</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of PayClub.RequiredProperties) {
        ...
        if (data['credentials']) { // data not null
          PayClubAllOfCredentials.validateJSON(data['credentials']);
        }
        // validate the optional field `settings`
        if (data['settings']) { // data not null
          PayClubAllOfSettings.validateJSON(data['settings']);
        }
...
PayClub.RequiredProperties = ["credentials", "acceptedCurrencies", "gatewayName", "method"];

/**
 * @member {module:model/PayClubAllOfCredentials} credentials
 */
PayClub.prototype['credentials'] = undefined;

/**
 * @member {module:model/PayClubAllOfSettings} settings
 */
PayClub.prototype['settings'] = undefined;
