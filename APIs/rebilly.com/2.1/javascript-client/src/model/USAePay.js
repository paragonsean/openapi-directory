...
import USAePayAllOfCredentials from './USAePayAllOfCredentials';

/**
 * The USAePay model module.
 * @module model/USAePay
 * @version 2.1
 */
class USAePay {
    /**
     * Constructs a new <code>USAePay</code>.
     * USAePay Gateway config.
     * @alias module:model/USAePay
     ...
     * @param credentials {module:model/USAePayAllOfCredentials} 
     */
    constructor(acceptedCurrencies, gatewayName, method, credentials) { 
        ...
        USAePay.initialize(this, acceptedCurrencies, gatewayName, method, credentials);
    }
    ...
    /**
     * Constructs a <code>USAePay</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/USAePay} obj Optional instance to populate.
     * @return {module:model/USAePay} The populated <code>USAePay</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('credentials')) {
                obj['credentials'] = USAePayAllOfCredentials.constructFromObject(data['credentials']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>USAePay</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>USAePay</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of USAePay.RequiredProperties) {
        ...
        if (data['credentials']) { // data not null
          USAePayAllOfCredentials.validateJSON(data['credentials']);
        }
...
USAePay.RequiredProperties = ["credentials", "acceptedCurrencies", "gatewayName", "method"];

/**
 * @member {module:model/USAePayAllOfCredentials} credentials
 */
USAePay.prototype['credentials'] = undefined;
