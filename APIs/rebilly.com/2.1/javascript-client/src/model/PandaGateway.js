...
import PandaGatewayAllOfCredentials from './PandaGatewayAllOfCredentials';
import PaymentCardBrand from './PaymentCardBrand';
import PaymentMethod from './PaymentMethod';

/**
 * The PandaGateway model module.
 * @module model/PandaGateway
 * @version 2.1
 */
class PandaGateway {
    /**
     * Constructs a new <code>PandaGateway</code>.
     * Panda Gateway config.
     * @alias module:model/PandaGateway
     ...
     * @param credentials {module:model/PandaGatewayAllOfCredentials} 
     */
    constructor(acceptedCurrencies, gatewayName, method, credentials) { 
        ...
        PandaGateway.initialize(this, acceptedCurrencies, gatewayName, method, credentials);
    }
    ...
    /**
     * Constructs a <code>PandaGateway</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PandaGateway} obj Optional instance to populate.
     * @return {module:model/PandaGateway} The populated <code>PandaGateway</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PandaGateway();
            GatewayAccount.constructFromObject(data, obj);
            GatewayAccount.constructFromObject(data, obj);

            if (data.hasOwnProperty('credentials')) {
                obj['credentials'] = PandaGatewayAllOfCredentials.constructFromObject(data['credentials']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>PandaGateway</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PandaGateway</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of PandaGateway.RequiredProperties) {
        ...
        if (data['credentials']) { // data not null
          PandaGatewayAllOfCredentials.validateJSON(data['credentials']);
        }
...
PandaGateway.RequiredProperties = ["credentials", "acceptedCurrencies", "gatewayName", "method"];

/**
 * @member {module:model/PandaGatewayAllOfCredentials} credentials
 */
PandaGateway.prototype['credentials'] = undefined;
