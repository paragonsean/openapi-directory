...
class TransactionRequest {
     ...
     */
    static initialize(obj, amount, currency, customerId, websiteId, type) { 
        obj['amount'] = amount;
...
TransactionRequest.RequiredProperties = ["amount", "currency", "customerId", "websiteId", "type"];
 ...
 */
TransactionRequest.prototype['billingAddress'] = undefined;

/**
 * ISO 4217 alphabetic currency code.
 * @member {String} currency
 */
TransactionRequest.prototype['currency'] = undefined;

/**
 * Custom Fields list as a map `{\"custom field name\": \"custom field value\", ...}`. The format must follow the saved format (see Custom Fields section for the formats). 
 * @member {Object} customFields
 */
TransactionRequest.prototype['customFields'] = undefined;

/**
 * The customer identifier string.
 * @member {String} customerId
 */
TransactionRequest.prototype['customerId'] = undefined;

/**
 * The payment description.
 * @member {String} description
 */
TransactionRequest.prototype['description'] = undefined;
 ...
 */
TransactionRequest.prototype['gatewayAccountId'] = undefined;

/**
 * The array of invoice identifiers.
 * @member {Array.<String>} invoiceIds
 */
TransactionRequest.prototype['invoiceIds'] = undefined;
 ...
 * @default false
 */
TransactionRequest.prototype['isMerchantInitiated'] = false;
 ...
 * @default false
 */
TransactionRequest.prototype['isProcessedOutside'] = false;
 ...
 */
TransactionRequest.prototype['notificationUrl'] = undefined;
 ...
 */
TransactionRequest.prototype['paymentInstruction'] = undefined;

/**
 * @member {module:model/PaymentInstrument} paymentInstrument
 */
TransactionRequest.prototype['paymentInstrument'] = undefined;
 ...
 */
TransactionRequest.prototype['processedTime'] = undefined;
 ...
 */
TransactionRequest.prototype['redirectUrl'] = undefined;
 ...
 */
TransactionRequest.prototype['riskMetadata'] = undefined;

/**
 * The website identifier string.
 * @member {String} websiteId
 */
TransactionRequest.prototype['websiteId'] = undefined;

/**
 * The type of transaction requested. You should always include the type within your API request. This supports a limited subset of Transaction types.  To refund or void, use the refund endpoint. To `capture` use the `sale` type. If any existing `authorize` transactions are eligible, then they will be captured and the `sale` will be converted to a `capture` type. 
 * @member {module:model/TransactionRequest.TypeEnum} type
 */
