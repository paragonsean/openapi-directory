...
import PaymenTechnologiesAllOfCredentials from './PaymenTechnologiesAllOfCredentials';
import PaymenTechnologiesAllOfSettings from './PaymenTechnologiesAllOfSettings';
import PaymentCardBrand from './PaymentCardBrand';
import PaymentMethod from './PaymentMethod';

/**
 * The PaymenTechnologies model module.
 * @module model/PaymenTechnologies
 * @version 2.1
 */
class PaymenTechnologies {
    /**
     * Constructs a new <code>PaymenTechnologies</code>.
     * PaymenTechnologies Gateway config.
     * @alias module:model/PaymenTechnologies
     ...
     * @param credentials {module:model/PaymenTechnologiesAllOfCredentials} 
     */
    constructor(acceptedCurrencies, gatewayName, method, credentials) { 
        ...
        PaymenTechnologies.initialize(this, acceptedCurrencies, gatewayName, method, credentials);
    }
    ...
    /**
     * Constructs a <code>PaymenTechnologies</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PaymenTechnologies} obj Optional instance to populate.
     * @return {module:model/PaymenTechnologies} The populated <code>PaymenTechnologies</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PaymenTechnologies();
            GatewayAccount.constructFromObject(data, obj);
            GatewayAccount.constructFromObject(data, obj);

            if (data.hasOwnProperty('credentials')) {
                obj['credentials'] = PaymenTechnologiesAllOfCredentials.constructFromObject(data['credentials']);
            }
            if (data.hasOwnProperty('settings')) {
                obj['settings'] = PaymenTechnologiesAllOfSettings.constructFromObject(data['settings']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>PaymenTechnologies</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PaymenTechnologies</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of PaymenTechnologies.RequiredProperties) {
        ...
        if (data['credentials']) { // data not null
          PaymenTechnologiesAllOfCredentials.validateJSON(data['credentials']);
        }
        // validate the optional field `settings`
        if (data['settings']) { // data not null
          PaymenTechnologiesAllOfSettings.validateJSON(data['settings']);
        }
...
PaymenTechnologies.RequiredProperties = ["credentials", "acceptedCurrencies", "gatewayName", "method"];

/**
 * @member {module:model/PaymenTechnologiesAllOfCredentials} credentials
 */
PaymenTechnologies.prototype['credentials'] = undefined;

/**
 * @member {module:model/PaymenTechnologiesAllOfSettings} settings
 */
PaymenTechnologies.prototype['settings'] = undefined;
...
export default PaymenTechnologies;
