...
import SkrillAllOfCredentials from './SkrillAllOfCredentials';

/**
 * The Skrill model module.
 * @module model/Skrill
 * @version 2.1
 */
class Skrill {
    /**
     * Constructs a new <code>Skrill</code>.
     * Skrill config.
     * @alias module:model/Skrill
     ...
     * @param credentials {module:model/SkrillAllOfCredentials} 
     */
    constructor(acceptedCurrencies, gatewayName, method, credentials) { 
        ...
        Skrill.initialize(this, acceptedCurrencies, gatewayName, method, credentials);
    }
    ...
    /**
     * Constructs a <code>Skrill</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Skrill} obj Optional instance to populate.
     * @return {module:model/Skrill} The populated <code>Skrill</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('credentials')) {
                obj['credentials'] = SkrillAllOfCredentials.constructFromObject(data['credentials']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>Skrill</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Skrill</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of Skrill.RequiredProperties) {
        ...
        if (data['credentials']) { // data not null
          SkrillAllOfCredentials.validateJSON(data['credentials']);
        }
...
Skrill.RequiredProperties = ["credentials", "acceptedCurrencies", "gatewayName", "method"];

/**
 * @member {module:model/SkrillAllOfCredentials} credentials
 */
Skrill.prototype['credentials'] = undefined;
