...
import GETAllOfCredentials from './GETAllOfCredentials';
...
class GET {
     ...
     * @param credentials {module:model/GETAllOfCredentials} 
     */
    constructor(acceptedCurrencies, gatewayName, method, credentials) { 
        ...
        GET.initialize(this, acceptedCurrencies, gatewayName, method, credentials);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('credentials')) {
                obj['credentials'] = GETAllOfCredentials.constructFromObject(data['credentials']);
            }
            if (data.hasOwnProperty('threeDSecureServer')) {
                obj['threeDSecureServer'] = GET3dsServers.constructFromObject(data['threeDSecureServer']);
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        if (data['credentials']) { // data not null
          GETAllOfCredentials.validateJSON(data['credentials']);
        }
        // validate the optional field `threeDSecureServer`
        if (data['threeDSecureServer']) { // data not null
          GET3dsServers.validateJSON(data['threeDSecureServer']);
        }
...
GET.RequiredProperties = ["credentials", "acceptedCurrencies", "gatewayName", "method"];

/**
 * @member {module:model/GETAllOfCredentials} credentials
 */
GET.prototype['credentials'] = undefined;

/**
 * @member {module:model/GET3dsServers} threeDSecureServer
 */
GET.prototype['threeDSecureServer'] = undefined;
