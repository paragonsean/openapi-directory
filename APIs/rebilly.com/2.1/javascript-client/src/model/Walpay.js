...
import WalpayAllOfCredentials from './WalpayAllOfCredentials';

/**
 * The Walpay model module.
 * @module model/Walpay
 * @version 2.1
 */
class Walpay {
    /**
     * Constructs a new <code>Walpay</code>.
     * Walpay Gateway config.
     * @alias module:model/Walpay
     ...
     * @param credentials {module:model/WalpayAllOfCredentials} 
     */
    constructor(acceptedCurrencies, gatewayName, method, credentials) { 
        ...
        Walpay.initialize(this, acceptedCurrencies, gatewayName, method, credentials);
    }
    ...
    /**
     * Constructs a <code>Walpay</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Walpay} obj Optional instance to populate.
     * @return {module:model/Walpay} The populated <code>Walpay</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('credentials')) {
                obj['credentials'] = WalpayAllOfCredentials.constructFromObject(data['credentials']);
            }
            if (data.hasOwnProperty('threeDSecureServer')) {
                obj['threeDSecureServer'] = Walpay3dsServers.constructFromObject(data['threeDSecureServer']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>Walpay</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Walpay</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of Walpay.RequiredProperties) {
        ...
        if (data['credentials']) { // data not null
          WalpayAllOfCredentials.validateJSON(data['credentials']);
        }
        // validate the optional field `threeDSecureServer`
        if (data['threeDSecureServer']) { // data not null
          Walpay3dsServers.validateJSON(data['threeDSecureServer']);
        }
...
Walpay.RequiredProperties = ["credentials", "acceptedCurrencies", "gatewayName", "method"];

/**
 * @member {module:model/WalpayAllOfCredentials} credentials
 */
Walpay.prototype['credentials'] = undefined;

/**
 * @member {module:model/Walpay3dsServers} threeDSecureServer
 */
Walpay.prototype['threeDSecureServer'] = undefined;
