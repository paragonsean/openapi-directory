...
import ElavonAllOfCredentials from './ElavonAllOfCredentials';
...
/**
 * The Elavon model module.
 * @module model/Elavon
 * @version 2.1
 */
class Elavon {
    /**
     * Constructs a new <code>Elavon</code>.
     * Elavon config.
     * @alias module:model/Elavon
     ...
     * @param credentials {module:model/ElavonAllOfCredentials} 
     */
    constructor(acceptedCurrencies, gatewayName, method, credentials) { 
        ...
        Elavon.initialize(this, acceptedCurrencies, gatewayName, method, credentials);
    }
    ...
    /**
     * Constructs a <code>Elavon</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Elavon} obj Optional instance to populate.
     * @return {module:model/Elavon} The populated <code>Elavon</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('credentials')) {
                obj['credentials'] = ElavonAllOfCredentials.constructFromObject(data['credentials']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>Elavon</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Elavon</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of Elavon.RequiredProperties) {
        ...
        if (data['credentials']) { // data not null
          ElavonAllOfCredentials.validateJSON(data['credentials']);
        }
...
Elavon.RequiredProperties = ["credentials", "acceptedCurrencies", "gatewayName", "method"];

/**
 * @member {module:model/ElavonAllOfCredentials} credentials
 */
Elavon.prototype['credentials'] = undefined;
