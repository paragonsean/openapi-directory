...
import EProAllOfCredentials from './EProAllOfCredentials';
...
/**
 * The EPro model module.
 * @module model/EPro
 * @version 2.1
 */
class EPro {
    /**
     * Constructs a new <code>EPro</code>.
     * EPro config.
     * @alias module:model/EPro
     ...
     * @param credentials {module:model/EProAllOfCredentials} 
     */
    constructor(acceptedCurrencies, gatewayName, method, credentials) { 
        ...
        EPro.initialize(this, acceptedCurrencies, gatewayName, method, credentials);
    }
    ...
    /**
     * Constructs a <code>EPro</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/EPro} obj Optional instance to populate.
     * @return {module:model/EPro} The populated <code>EPro</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('credentials')) {
                obj['credentials'] = EProAllOfCredentials.constructFromObject(data['credentials']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>EPro</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EPro</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of EPro.RequiredProperties) {
        ...
        if (data['credentials']) { // data not null
          EProAllOfCredentials.validateJSON(data['credentials']);
        }
...
EPro.RequiredProperties = ["credentials", "acceptedCurrencies", "gatewayName", "method"];

/**
 * @member {module:model/EProAllOfCredentials} credentials
 */
EPro.prototype['credentials'] = undefined;
