...
import Inovio3dsServers from './Inovio3dsServers';
import InovioAllOfCredentials from './InovioAllOfCredentials';
import InovioAllOfSettings from './InovioAllOfSettings';
import PaymentCardBrand from './PaymentCardBrand';
import PaymentMethod from './PaymentMethod';

/**
 * The Inovio model module.
 * @module model/Inovio
 * @version 2.1
 */
class Inovio {
    /**
     * Constructs a new <code>Inovio</code>.
     * Inovio config.
     * @alias module:model/Inovio
     ...
     * @param credentials {module:model/InovioAllOfCredentials} 
     * @param settings {module:model/InovioAllOfSettings} 
     */
    constructor(acceptedCurrencies, gatewayName, method, credentials, settings) { 
        ...
        Inovio.initialize(this, acceptedCurrencies, gatewayName, method, credentials, settings);
    }
    ...
    /**
     * Constructs a <code>Inovio</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Inovio} obj Optional instance to populate.
     * @return {module:model/Inovio} The populated <code>Inovio</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('credentials')) {
                obj['credentials'] = InovioAllOfCredentials.constructFromObject(data['credentials']);
            }
            if (data.hasOwnProperty('settings')) {
                obj['settings'] = InovioAllOfSettings.constructFromObject(data['settings']);
            }
            if (data.hasOwnProperty('threeDSecureServer')) {
                obj['threeDSecureServer'] = Inovio3dsServers.constructFromObject(data['threeDSecureServer']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>Inovio</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Inovio</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of Inovio.RequiredProperties) {
        ...
        if (data['credentials']) { // data not null
          InovioAllOfCredentials.validateJSON(data['credentials']);
        }
        // validate the optional field `settings`
        if (data['settings']) { // data not null
          InovioAllOfSettings.validateJSON(data['settings']);
        }
        // validate the optional field `threeDSecureServer`
        if (data['threeDSecureServer']) { // data not null
          Inovio3dsServers.validateJSON(data['threeDSecureServer']);
        }
...
Inovio.RequiredProperties = ["credentials", "settings", "acceptedCurrencies", "gatewayName", "method"];

/**
 * @member {module:model/InovioAllOfCredentials} credentials
 */
Inovio.prototype['credentials'] = undefined;

/**
 * @member {module:model/InovioAllOfSettings} settings
 */
Inovio.prototype['settings'] = undefined;

/**
 * @member {module:model/Inovio3dsServers} threeDSecureServer
 */
Inovio.prototype['threeDSecureServer'] = undefined;
