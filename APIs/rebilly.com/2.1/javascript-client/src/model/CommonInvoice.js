...
/**
 * The CommonInvoice model module.
 * @module model/CommonInvoice
 * @version 2.1
 */
class CommonInvoice {
    /**
     * Constructs a new <code>CommonInvoice</code>.
     * @alias module:model/CommonInvoice
     * @param currency {String} ISO 4217 alphabetic currency code.
     * @param websiteId {String} The website ID.
     */
    constructor(currency, websiteId) { 
     ...
     */
    static initialize(obj, currency, websiteId) { 
    ...
    /**
     * Constructs a <code>CommonInvoice</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CommonInvoice} obj Optional instance to populate.
     * @return {module:model/CommonInvoice} The populated <code>CommonInvoice</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CommonInvoice();
    ...
    /**
     * Validates the JSON data with respect to <code>CommonInvoice</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CommonInvoice</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CommonInvoice.RequiredProperties) {
...
CommonInvoice.RequiredProperties = ["currency", "websiteId"];
