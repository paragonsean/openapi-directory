...
/**
 * The SubscriptionCancellationState model module.
 * @module model/SubscriptionCancellationState
 * @version 2.1
 */
class SubscriptionCancellationState {
    /**
     * Constructs a new <code>SubscriptionCancellationState</code>.
     * @alias module:model/SubscriptionCancellationState
     */
    constructor() { 
        
        SubscriptionCancellationState.initialize(this);
    }
    ...
    /**
     * Constructs a <code>SubscriptionCancellationState</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SubscriptionCancellationState} obj Optional instance to populate.
     * @return {module:model/SubscriptionCancellationState} The populated <code>SubscriptionCancellationState</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SubscriptionCancellationState();
    ...
    /**
     * Validates the JSON data with respect to <code>SubscriptionCancellationState</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SubscriptionCancellationState</code>.
     */
 ...
 * @readonly
 */
SubscriptionCancellationState['CancelCategoryEnum'] = {
 ...
 * @readonly
 */
SubscriptionCancellationState['CanceledByEnum'] = {
...
export default SubscriptionCancellationState;
