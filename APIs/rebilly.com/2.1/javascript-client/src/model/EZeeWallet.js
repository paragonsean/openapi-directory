...
import EZeeWalletAllOfCredentials from './EZeeWalletAllOfCredentials';
...
/**
 * The EZeeWallet model module.
 * @module model/EZeeWallet
 * @version 2.1
 */
class EZeeWallet {
    /**
     * Constructs a new <code>EZeeWallet</code>.
     * eZeeWallet config.
     * @alias module:model/EZeeWallet
     ...
     * @param credentials {module:model/EZeeWalletAllOfCredentials} 
     */
    constructor(acceptedCurrencies, gatewayName, method, credentials) { 
        ...
        EZeeWallet.initialize(this, acceptedCurrencies, gatewayName, method, credentials);
    }
    ...
    /**
     * Constructs a <code>EZeeWallet</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/EZeeWallet} obj Optional instance to populate.
     * @return {module:model/EZeeWallet} The populated <code>EZeeWallet</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new EZeeWallet();
            GatewayAccount.constructFromObject(data, obj);
            GatewayAccount.constructFromObject(data, obj);

            if (data.hasOwnProperty('credentials')) {
                obj['credentials'] = EZeeWalletAllOfCredentials.constructFromObject(data['credentials']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>EZeeWallet</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EZeeWallet</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of EZeeWallet.RequiredProperties) {
        ...
        if (data['credentials']) { // data not null
          EZeeWalletAllOfCredentials.validateJSON(data['credentials']);
        }
...
EZeeWallet.RequiredProperties = ["credentials", "acceptedCurrencies", "gatewayName", "method"];

/**
 * @member {module:model/EZeeWalletAllOfCredentials} credentials
 */
EZeeWallet.prototype['credentials'] = undefined;
