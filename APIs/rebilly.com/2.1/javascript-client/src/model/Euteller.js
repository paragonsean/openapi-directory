...
import EutellerAllOfCredentials from './EutellerAllOfCredentials';
...
/**
 * The Euteller model module.
 * @module model/Euteller
 * @version 2.1
 */
class Euteller {
    /**
     * Constructs a new <code>Euteller</code>.
     * Euteller config.
     * @alias module:model/Euteller
     ...
     * @param credentials {module:model/EutellerAllOfCredentials} 
     */
    constructor(acceptedCurrencies, gatewayName, method, credentials) { 
        ...
        Euteller.initialize(this, acceptedCurrencies, gatewayName, method, credentials);
    }
    ...
    /**
     * Constructs a <code>Euteller</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Euteller} obj Optional instance to populate.
     * @return {module:model/Euteller} The populated <code>Euteller</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new Euteller();
            GatewayAccount.constructFromObject(data, obj);
            GatewayAccount.constructFromObject(data, obj);

            if (data.hasOwnProperty('credentials')) {
                obj['credentials'] = EutellerAllOfCredentials.constructFromObject(data['credentials']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>Euteller</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Euteller</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of Euteller.RequiredProperties) {
        ...
        if (data['credentials']) { // data not null
          EutellerAllOfCredentials.validateJSON(data['credentials']);
        }
...
Euteller.RequiredProperties = ["credentials", "acceptedCurrencies", "gatewayName", "method"];

/**
 * @member {module:model/EutellerAllOfCredentials} credentials
 */
Euteller.prototype['credentials'] = undefined;
