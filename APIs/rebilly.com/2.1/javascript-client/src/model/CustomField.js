...
class CustomField {
     ...
     * @param type {module:model/CustomField.TypeEnum} Type value    | Description ------------- | ------------- array         | An array of strings up to 255 characters, maximum size is 1000 elements boolean       | true or false date          | String of format \"full-date\" (YYYY-MM-DD) from RFC-3339 (full-date) datetime      | String of format \"date-time\" (YYYY-MM-DDTHH:MM:SSZ) from RFC-3339 (date-time) integer       | Cardinal value of -2^31..2^31-1 number        | Float value. It can take cardinal values also which are interpreted as float string        | Regular string up to 255 characters monetary      | A map of 3-letters currency code and amount, e.g. {\"currency\": \"EUR\", \"amount\": 25.30} The type cannot be changed. 
     */
    constructor(type) { 
        
        CustomField.initialize(this, type);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('additionalSchema')) {
                obj['additionalSchema'] = ApiClient.convertToType(data['additionalSchema'], Object);
            }
...
CustomField.RequiredProperties = ["type"];

/**
 * The links related to resource.
 * @member {Array.<module:model/SelfLink>} _links
 */
CustomField.prototype['_links'] = undefined;
 ...
 * @member {Object} additionalSchema
 */
CustomField.prototype['additionalSchema'] = undefined;
 ...
 * @member {module:model/CustomField.TypeEnum} type
 */
