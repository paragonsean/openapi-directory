...
import SagepayAllOfCredentials from './SagepayAllOfCredentials';

/**
 * The Sagepay model module.
 * @module model/Sagepay
 * @version 2.1
 */
class Sagepay {
    /**
     * Constructs a new <code>Sagepay</code>.
     * Sagepay Gateway config.
     * @alias module:model/Sagepay
     ...
     * @param credentials {module:model/SagepayAllOfCredentials} 
     */
    constructor(acceptedCurrencies, gatewayName, method, credentials) { 
        ...
        Sagepay.initialize(this, acceptedCurrencies, gatewayName, method, credentials);
    }
    ...
    /**
     * Constructs a <code>Sagepay</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Sagepay} obj Optional instance to populate.
     * @return {module:model/Sagepay} The populated <code>Sagepay</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('credentials')) {
                obj['credentials'] = SagepayAllOfCredentials.constructFromObject(data['credentials']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>Sagepay</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Sagepay</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of Sagepay.RequiredProperties) {
        ...
        if (data['credentials']) { // data not null
          SagepayAllOfCredentials.validateJSON(data['credentials']);
        }
...
Sagepay.RequiredProperties = ["credentials", "acceptedCurrencies", "gatewayName", "method"];

/**
 * @member {module:model/SagepayAllOfCredentials} credentials
 */
Sagepay.prototype['credentials'] = undefined;
