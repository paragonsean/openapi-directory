...
import CCAvenueAllOfCredentials from './CCAvenueAllOfCredentials';
...
/**
 * The CCAvenue model module.
 * @module model/CCAvenue
 * @version 2.1
 */
class CCAvenue {
    /**
     * Constructs a new <code>CCAvenue</code>.
     * CCAvenue config.
     * @alias module:model/CCAvenue
     ...
     * @param credentials {module:model/CCAvenueAllOfCredentials} 
     */
    constructor(acceptedCurrencies, gatewayName, method, credentials) { 
        ...
        CCAvenue.initialize(this, acceptedCurrencies, gatewayName, method, credentials);
    }
    ...
    /**
     * Constructs a <code>CCAvenue</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CCAvenue} obj Optional instance to populate.
     * @return {module:model/CCAvenue} The populated <code>CCAvenue</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CCAvenue();
            GatewayAccount.constructFromObject(data, obj);
            GatewayAccount.constructFromObject(data, obj);

            if (data.hasOwnProperty('credentials')) {
                obj['credentials'] = CCAvenueAllOfCredentials.constructFromObject(data['credentials']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>CCAvenue</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CCAvenue</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CCAvenue.RequiredProperties) {
        ...
        if (data['credentials']) { // data not null
          CCAvenueAllOfCredentials.validateJSON(data['credentials']);
        }
...
CCAvenue.RequiredProperties = ["credentials", "acceptedCurrencies", "gatewayName", "method"];

/**
 * @member {module:model/CCAvenueAllOfCredentials} credentials
 */
CCAvenue.prototype['credentials'] = undefined;
