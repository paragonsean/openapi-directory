...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RebillyRestApi.CommonPayPalAccount();
  });
  ...
  describe('CommonPayPalAccount', function() {
    it('should create an instance of CommonPayPalAccount', function() {
      // uncomment below and update the code to test CommonPayPalAccount
      //var instance = new RebillyRestApi.CommonPayPalAccount();
      //expect(instance).to.be.a(RebillyRestApi.CommonPayPalAccount);
    });
