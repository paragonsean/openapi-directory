...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RebillyRestApi.PaymentCard();
  });
  ...
  describe('PaymentCard', function() {
    it('should create an instance of PaymentCard', function() {
      ...
      //var instance = new RebillyRestApi.PaymentCard();
      //expect(instance).to.be.a(RebillyRestApi.PaymentCard);
    });

    it('should have the property bankCountry (base name: "bankCountry")', function() {
    ...
    it('should have the property expirationReminderNumber (base name: "expirationReminderNumber")', function() {
      // uncomment below and update the code to test the property expirationReminderNumber
      //var instance = new RebillyRestApi.PaymentCard();
      //expect(instance).to.be();
    });

    it('should have the property expirationReminderTime (base name: "expirationReminderTime")', function() {
      // uncomment below and update the code to test the property expirationReminderTime
      //var instance = new RebillyRestApi.PaymentCard();
      //expect(instance).to.be();
    });

    it('should have the property stickyGatewayAccountId (base name: "stickyGatewayAccountId")', function() {
      // uncomment below and update the code to test the property stickyGatewayAccountId
      //var instance = new RebillyRestApi.PaymentCard();
      //expect(instance).to.be();
    });
