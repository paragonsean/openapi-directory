...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RebillyRestApi.ICEPAYAllOfCredentials();
  });
  ...
  describe('ICEPAYAllOfCredentials', function() {
    it('should create an instance of ICEPAYAllOfCredentials', function() {
      // uncomment below and update the code to test ICEPAYAllOfCredentials
      //var instance = new RebillyRestApi.ICEPAYAllOfCredentials();
      //expect(instance).to.be.a(RebillyRestApi.ICEPAYAllOfCredentials);
    });
