...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RebillyRestApi.Citadel();
  });
  ...
  describe('Citadel', function() {
    it('should create an instance of Citadel', function() {
      // uncomment below and update the code to test Citadel
      //var instance = new RebillyRestApi.Citadel();
      //expect(instance).to.be.a(RebillyRestApi.Citadel);
    });
