...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RebillyRestApi.FlexiblePlan();
  });
  ...
  describe('FlexiblePlan', function() {
    it('should create an instance of FlexiblePlan', function() {
      // uncomment below and update the code to test FlexiblePlan
      //var instance = new RebillyRestApi.FlexiblePlan();
      //expect(instance).to.be.a(RebillyRestApi.FlexiblePlan);
    });
