...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RebillyRestApi.AmexVPC();
  });
  ...
  describe('AmexVPC', function() {
    it('should create an instance of AmexVPC', function() {
      // uncomment below and update the code to test AmexVPC
      //var instance = new RebillyRestApi.AmexVPC();
      //expect(instance).to.be.a(RebillyRestApi.AmexVPC);
    });
