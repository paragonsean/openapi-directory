...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RebillyRestApi.BankAccountUpdatePlain();
  });
  ...
  describe('BankAccountUpdatePlain', function() {
    it('should create an instance of BankAccountUpdatePlain', function() {
      // uncomment below and update the code to test BankAccountUpdatePlain
      //var instance = new RebillyRestApi.BankAccountUpdatePlain();
      //expect(instance).to.be.a(RebillyRestApi.BankAccountUpdatePlain);
    });
