...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RebillyRestApi.ShippingZone();
  });
  ...
  describe('ShippingZone', function() {
    it('should create an instance of ShippingZone', function() {
      // uncomment below and update the code to test ShippingZone
      //var instance = new RebillyRestApi.ShippingZone();
      //expect(instance).to.be.a(RebillyRestApi.ShippingZone);
    });
