...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RebillyRestApi.CyberSourceAllOfCredentials();
  });
  ...
  describe('CyberSourceAllOfCredentials', function() {
    it('should create an instance of CyberSourceAllOfCredentials', function() {
      // uncomment below and update the code to test CyberSourceAllOfCredentials
      //var instance = new RebillyRestApi.CyberSourceAllOfCredentials();
      //expect(instance).to.be.a(RebillyRestApi.CyberSourceAllOfCredentials);
    });
