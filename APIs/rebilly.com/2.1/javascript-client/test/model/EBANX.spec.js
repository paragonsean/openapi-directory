...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RebillyRestApi.EBANX();
  });
  ...
  describe('EBANX', function() {
    it('should create an instance of EBANX', function() {
      // uncomment below and update the code to test EBANX
      //var instance = new RebillyRestApi.EBANX();
      //expect(instance).to.be.a(RebillyRestApi.EBANX);
    });
