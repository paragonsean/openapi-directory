...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RebillyRestApi.PaymentInstruction();
  });
  ...
  describe('PaymentInstruction', function() {
    it('should create an instance of PaymentInstruction', function() {
      // uncomment below and update the code to test PaymentInstruction
      //var instance = new RebillyRestApi.PaymentInstruction();
      //expect(instance).to.be.a(RebillyRestApi.PaymentInstruction);
    });
