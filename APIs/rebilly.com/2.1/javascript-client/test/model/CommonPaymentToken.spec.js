...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RebillyRestApi.CommonPaymentToken();
  });
  ...
  describe('CommonPaymentToken', function() {
    it('should create an instance of CommonPaymentToken', function() {
      // uncomment below and update the code to test CommonPaymentToken
      //var instance = new RebillyRestApi.CommonPaymentToken();
      //expect(instance).to.be.a(RebillyRestApi.CommonPaymentToken);
    });
