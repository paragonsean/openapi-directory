...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RebillyRestApi.PayClub();
  });
  ...
  describe('PayClub', function() {
    it('should create an instance of PayClub', function() {
      // uncomment below and update the code to test PayClub
      //var instance = new RebillyRestApi.PayClub();
      //expect(instance).to.be.a(RebillyRestApi.PayClub);
    });
