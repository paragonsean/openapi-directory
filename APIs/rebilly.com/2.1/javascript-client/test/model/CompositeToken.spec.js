...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RebillyRestApi.CompositeToken();
  });
  ...
  describe('CompositeToken', function() {
    it('should create an instance of CompositeToken', function() {
      // uncomment below and update the code to test CompositeToken
      //var instance = new RebillyRestApi.CompositeToken();
      //expect(instance).to.be.a(RebillyRestApi.CompositeToken);
    });
