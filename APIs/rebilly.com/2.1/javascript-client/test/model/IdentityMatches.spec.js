...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RebillyRestApi.IdentityMatches();
  });
  ...
  describe('IdentityMatches', function() {
    it('should create an instance of IdentityMatches', function() {
      // uncomment below and update the code to test IdentityMatches
      //var instance = new RebillyRestApi.IdentityMatches();
      //expect(instance).to.be.a(RebillyRestApi.IdentityMatches);
    });
