...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RebillyRestApi.HiPayAllOfCredentials();
  });
  ...
  describe('HiPayAllOfCredentials', function() {
    it('should create an instance of HiPayAllOfCredentials', function() {
      // uncomment below and update the code to test HiPayAllOfCredentials
      //var instance = new RebillyRestApi.HiPayAllOfCredentials();
      //expect(instance).to.be.a(RebillyRestApi.HiPayAllOfCredentials);
    });
