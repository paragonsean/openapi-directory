...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RebillyRestApi.MuchBetter();
  });
  ...
  describe('MuchBetter', function() {
    it('should create an instance of MuchBetter', function() {
      // uncomment below and update the code to test MuchBetter
      //var instance = new RebillyRestApi.MuchBetter();
      //expect(instance).to.be.a(RebillyRestApi.MuchBetter);
    });
