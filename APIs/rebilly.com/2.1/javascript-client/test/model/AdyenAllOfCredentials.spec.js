...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RebillyRestApi.AdyenAllOfCredentials();
  });
  ...
  describe('AdyenAllOfCredentials', function() {
    it('should create an instance of AdyenAllOfCredentials', function() {
      // uncomment below and update the code to test AdyenAllOfCredentials
      //var instance = new RebillyRestApi.AdyenAllOfCredentials();
      //expect(instance).to.be.a(RebillyRestApi.AdyenAllOfCredentials);
    });
