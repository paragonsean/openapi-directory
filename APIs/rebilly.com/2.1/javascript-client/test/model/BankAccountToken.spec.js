...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RebillyRestApi.BankAccountToken();
  });
  ...
  describe('BankAccountToken', function() {
    it('should create an instance of BankAccountToken', function() {
      // uncomment below and update the code to test BankAccountToken
      //var instance = new RebillyRestApi.BankAccountToken();
      //expect(instance).to.be.a(RebillyRestApi.BankAccountToken);
    });
