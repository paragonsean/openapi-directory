...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RebillyRestApi.GatewayAccountLimit();
  });
  ...
  describe('GatewayAccountLimit', function() {
    it('should create an instance of GatewayAccountLimit', function() {
      // uncomment below and update the code to test GatewayAccountLimit
      //var instance = new RebillyRestApi.GatewayAccountLimit();
      //expect(instance).to.be.a(RebillyRestApi.GatewayAccountLimit);
    });
