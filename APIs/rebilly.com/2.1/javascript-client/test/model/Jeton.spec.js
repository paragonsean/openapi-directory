...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RebillyRestApi.Jeton();
  });
  ...
  describe('Jeton', function() {
    it('should create an instance of Jeton', function() {
      // uncomment below and update the code to test Jeton
      //var instance = new RebillyRestApi.Jeton();
      //expect(instance).to.be.a(RebillyRestApi.Jeton);
    });
