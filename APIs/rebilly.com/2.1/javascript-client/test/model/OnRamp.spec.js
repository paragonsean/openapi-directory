...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RebillyRestApi.OnRamp();
  });
  ...
  describe('OnRamp', function() {
    it('should create an instance of OnRamp', function() {
      // uncomment below and update the code to test OnRamp
      //var instance = new RebillyRestApi.OnRamp();
      //expect(instance).to.be.a(RebillyRestApi.OnRamp);
    });
