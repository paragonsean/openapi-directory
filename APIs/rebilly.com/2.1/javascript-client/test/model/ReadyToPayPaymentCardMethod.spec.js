...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RebillyRestApi.ReadyToPayPaymentCardMethod();
  });
  ...
  describe('ReadyToPayPaymentCardMethod', function() {
    it('should create an instance of ReadyToPayPaymentCardMethod', function() {
      // uncomment below and update the code to test ReadyToPayPaymentCardMethod
      //var instance = new RebillyRestApi.ReadyToPayPaymentCardMethod();
      //expect(instance).to.be.a(RebillyRestApi.ReadyToPayPaymentCardMethod);
    });
