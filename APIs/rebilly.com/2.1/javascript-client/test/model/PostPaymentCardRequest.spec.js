...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RebillyRestApi.PostPaymentCardRequest();
  });
  ...
  describe('PostPaymentCardRequest', function() {
    it('should create an instance of PostPaymentCardRequest', function() {
      // uncomment below and update the code to test PostPaymentCardRequest
      //var instance = new RebillyRestApi.PostPaymentCardRequest();
      //expect(instance).to.be.a(RebillyRestApi.PostPaymentCardRequest);
    });
