...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RebillyRestApi.KhelocardAllOfCredentials();
  });
  ...
  describe('KhelocardAllOfCredentials', function() {
    it('should create an instance of KhelocardAllOfCredentials', function() {
      // uncomment below and update the code to test KhelocardAllOfCredentials
      //var instance = new RebillyRestApi.KhelocardAllOfCredentials();
      //expect(instance).to.be.a(RebillyRestApi.KhelocardAllOfCredentials);
    });
