...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RebillyRestApi.KycRequest();
  });
  ...
  describe('KycRequest', function() {
    it('should create an instance of KycRequest', function() {
      // uncomment below and update the code to test KycRequest
      //var instance = new RebillyRestApi.KycRequest();
      //expect(instance).to.be.a(RebillyRestApi.KycRequest);
    });
