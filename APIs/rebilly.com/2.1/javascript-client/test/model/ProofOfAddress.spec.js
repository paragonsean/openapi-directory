...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RebillyRestApi.ProofOfAddress();
  });
  ...
  describe('ProofOfAddress', function() {
    it('should create an instance of ProofOfAddress', function() {
      // uncomment below and update the code to test ProofOfAddress
      //var instance = new RebillyRestApi.ProofOfAddress();
      //expect(instance).to.be.a(RebillyRestApi.ProofOfAddress);
    });
