...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RebillyRestApi.Neteller();
  });
  ...
  describe('Neteller', function() {
    it('should create an instance of Neteller', function() {
      // uncomment below and update the code to test Neteller
      //var instance = new RebillyRestApi.Neteller();
      //expect(instance).to.be.a(RebillyRestApi.Neteller);
    });
