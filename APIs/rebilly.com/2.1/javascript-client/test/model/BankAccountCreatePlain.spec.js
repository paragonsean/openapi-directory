...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RebillyRestApi.BankAccountCreatePlain();
  });
  ...
  describe('BankAccountCreatePlain', function() {
    it('should create an instance of BankAccountCreatePlain', function() {
      // uncomment below and update the code to test BankAccountCreatePlain
      //var instance = new RebillyRestApi.BankAccountCreatePlain();
      //expect(instance).to.be.a(RebillyRestApi.BankAccountCreatePlain);
    });
