...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RebillyRestApi.ProofOfIdentity();
  });
  ...
  describe('ProofOfIdentity', function() {
    it('should create an instance of ProofOfIdentity', function() {
      // uncomment below and update the code to test ProofOfIdentity
      //var instance = new RebillyRestApi.ProofOfIdentity();
      //expect(instance).to.be.a(RebillyRestApi.ProofOfIdentity);
    });
