...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RebillyRestApi.Paymero();
  });
  ...
  describe('Paymero', function() {
    it('should create an instance of Paymero', function() {
      // uncomment below and update the code to test Paymero
      //var instance = new RebillyRestApi.Paymero();
      //expect(instance).to.be.a(RebillyRestApi.Paymero);
    });
