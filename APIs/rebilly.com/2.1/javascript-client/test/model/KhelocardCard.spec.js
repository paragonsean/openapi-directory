...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RebillyRestApi.KhelocardCard();
  });
  ...
  describe('KhelocardCard', function() {
    it('should create an instance of KhelocardCard', function() {
      // uncomment below and update the code to test KhelocardCard
      //var instance = new RebillyRestApi.KhelocardCard();
      //expect(instance).to.be.a(RebillyRestApi.KhelocardCard);
    });
