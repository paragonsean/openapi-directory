...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RebillyRestApi.AstroPayCard();
  });
  ...
  describe('AstroPayCard', function() {
    it('should create an instance of AstroPayCard', function() {
      // uncomment below and update the code to test AstroPayCard
      //var instance = new RebillyRestApi.AstroPayCard();
      //expect(instance).to.be.a(RebillyRestApi.AstroPayCard);
    });
