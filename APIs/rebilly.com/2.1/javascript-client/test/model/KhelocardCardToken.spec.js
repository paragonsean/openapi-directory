...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RebillyRestApi.KhelocardCardToken();
  });
  ...
  describe('KhelocardCardToken', function() {
    it('should create an instance of KhelocardCardToken', function() {
      // uncomment below and update the code to test KhelocardCardToken
      //var instance = new RebillyRestApi.KhelocardCardToken();
      //expect(instance).to.be.a(RebillyRestApi.KhelocardCardToken);
    });
