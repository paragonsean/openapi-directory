...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RebillyRestApi.CommonBankAccount();
  });
  ...
  describe('CommonBankAccount', function() {
    it('should create an instance of CommonBankAccount', function() {
      // uncomment below and update the code to test CommonBankAccount
      //var instance = new RebillyRestApi.CommonBankAccount();
      //expect(instance).to.be.a(RebillyRestApi.CommonBankAccount);
    });
