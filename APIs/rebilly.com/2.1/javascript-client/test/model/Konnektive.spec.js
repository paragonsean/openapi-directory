...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RebillyRestApi.Konnektive();
  });
  ...
  describe('Konnektive', function() {
    it('should create an instance of Konnektive', function() {
      // uncomment below and update the code to test Konnektive
      //var instance = new RebillyRestApi.Konnektive();
      //expect(instance).to.be.a(RebillyRestApi.Konnektive);
    });
