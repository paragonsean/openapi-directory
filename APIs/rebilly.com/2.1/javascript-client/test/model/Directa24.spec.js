...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RebillyRestApi.Directa24();
  });
  ...
  describe('Directa24', function() {
    it('should create an instance of Directa24', function() {
      // uncomment below and update the code to test Directa24
      //var instance = new RebillyRestApi.Directa24();
      //expect(instance).to.be.a(RebillyRestApi.Directa24);
    });
