...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RebillyRestApi.PaymentCardCreatePlain();
  });
  ...
  describe('PaymentCardCreatePlain', function() {
    it('should create an instance of PaymentCardCreatePlain', function() {
      // uncomment below and update the code to test PaymentCardCreatePlain
      //var instance = new RebillyRestApi.PaymentCardCreatePlain();
      //expect(instance).to.be.a(RebillyRestApi.PaymentCardCreatePlain);
    });
