...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RebillyRestApi.MtaPay();
  });
  ...
  describe('MtaPay', function() {
    it('should create an instance of MtaPay', function() {
      // uncomment below and update the code to test MtaPay
      //var instance = new RebillyRestApi.MtaPay();
      //expect(instance).to.be.a(RebillyRestApi.MtaPay);
    });
