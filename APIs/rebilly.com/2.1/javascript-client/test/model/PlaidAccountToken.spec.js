...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RebillyRestApi.PlaidAccountToken();
  });
  ...
  describe('PlaidAccountToken', function() {
    it('should create an instance of PlaidAccountToken', function() {
      // uncomment below and update the code to test PlaidAccountToken
      //var instance = new RebillyRestApi.PlaidAccountToken();
      //expect(instance).to.be.a(RebillyRestApi.PlaidAccountToken);
    });
