...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RebillyRestApi.GigadatAllOfCredentials();
  });
  ...
  describe('GigadatAllOfCredentials', function() {
    it('should create an instance of GigadatAllOfCredentials', function() {
      // uncomment below and update the code to test GigadatAllOfCredentials
      //var instance = new RebillyRestApi.GigadatAllOfCredentials();
      //expect(instance).to.be.a(RebillyRestApi.GigadatAllOfCredentials);
    });
