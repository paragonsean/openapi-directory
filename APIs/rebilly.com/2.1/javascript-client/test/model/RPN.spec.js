...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RebillyRestApi.RPN();
  });
  ...
  describe('RPN', function() {
    it('should create an instance of RPN', function() {
      // uncomment below and update the code to test RPN
      //var instance = new RebillyRestApi.RPN();
      //expect(instance).to.be.a(RebillyRestApi.RPN);
    });
