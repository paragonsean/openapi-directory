...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RebillyRestApi.IpayOptions();
  });
  ...
  describe('IpayOptions', function() {
    it('should create an instance of IpayOptions', function() {
      // uncomment below and update the code to test IpayOptions
      //var instance = new RebillyRestApi.IpayOptions();
      //expect(instance).to.be.a(RebillyRestApi.IpayOptions);
    });
