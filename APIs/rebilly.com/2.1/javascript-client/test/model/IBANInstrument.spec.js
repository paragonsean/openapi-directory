...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RebillyRestApi.IBANInstrument();
  });
  ...
  describe('IBANInstrument', function() {
    it('should create an instance of IBANInstrument', function() {
      // uncomment below and update the code to test IBANInstrument
      //var instance = new RebillyRestApi.IBANInstrument();
      //expect(instance).to.be.a(RebillyRestApi.IBANInstrument);
    });
