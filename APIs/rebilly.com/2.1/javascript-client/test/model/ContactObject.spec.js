...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RebillyRestApi.ContactObject();
  });
  ...
  describe('ContactObject', function() {
    it('should create an instance of ContactObject', function() {
      // uncomment below and update the code to test ContactObject
      //var instance = new RebillyRestApi.ContactObject();
      //expect(instance).to.be.a(RebillyRestApi.ContactObject);
    });
