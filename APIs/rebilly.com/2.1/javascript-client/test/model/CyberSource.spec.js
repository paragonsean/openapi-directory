...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RebillyRestApi.CyberSource();
  });
  ...
  describe('CyberSource', function() {
    it('should create an instance of CyberSource', function() {
      // uncomment below and update the code to test CyberSource
      //var instance = new RebillyRestApi.CyberSource();
      //expect(instance).to.be.a(RebillyRestApi.CyberSource);
    });
