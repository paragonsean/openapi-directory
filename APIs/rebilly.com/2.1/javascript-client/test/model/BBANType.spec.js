...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RebillyRestApi.BBANType();
  });
  ...
  describe('BBANType', function() {
    it('should create an instance of BBANType', function() {
      // uncomment below and update the code to test BBANType
      //var instance = new RebillyRestApi.BBANType();
      //expect(instance).to.be.a(RebillyRestApi.BBANType);
    });
