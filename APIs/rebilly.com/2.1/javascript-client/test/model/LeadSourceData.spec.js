...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RebillyRestApi.LeadSourceData();
  });
  ...
  describe('LeadSourceData', function() {
    it('should create an instance of LeadSourceData', function() {
      // uncomment below and update the code to test LeadSourceData
      //var instance = new RebillyRestApi.LeadSourceData();
      //expect(instance).to.be.a(RebillyRestApi.LeadSourceData);
    });
