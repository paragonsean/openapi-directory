...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RebillyRestApi.AML();
  });
  ...
  describe('AML', function() {
    it('should create an instance of AML', function() {
      // uncomment below and update the code to test AML
      //var instance = new RebillyRestApi.AML();
      //expect(instance).to.be.a(RebillyRestApi.AML);
    });
