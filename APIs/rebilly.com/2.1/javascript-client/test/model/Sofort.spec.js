...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RebillyRestApi.Sofort();
  });
  ...
  describe('Sofort', function() {
    it('should create an instance of Sofort', function() {
      // uncomment below and update the code to test Sofort
      //var instance = new RebillyRestApi.Sofort();
      //expect(instance).to.be.a(RebillyRestApi.Sofort);
    });
