...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RebillyRestApi.GooneyAllOfCredentials();
  });
  ...
  describe('GooneyAllOfCredentials', function() {
    it('should create an instance of GooneyAllOfCredentials', function() {
      // uncomment below and update the code to test GooneyAllOfCredentials
      //var instance = new RebillyRestApi.GooneyAllOfCredentials();
      //expect(instance).to.be.a(RebillyRestApi.GooneyAllOfCredentials);
    });
    ...
    it('should have the property apiUser (base name: "apiUser")', function() {
      // uncomment below and update the code to test the property apiUser
      //var instance = new RebillyRestApi.GooneyAllOfCredentials();
      //expect(instance).to.be();
    });
