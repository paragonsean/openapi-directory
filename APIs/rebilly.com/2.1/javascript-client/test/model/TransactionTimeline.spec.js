...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RebillyRestApi.TransactionTimeline();
  });
  ...
  describe('TransactionTimeline', function() {
    it('should create an instance of TransactionTimeline', function() {
      ...
      //var instance = new RebillyRestApi.TransactionTimeline();
      //expect(instance).to.be.a(RebillyRestApi.TransactionTimeline);
    });
    ...
    it('should have the property occurredTime (base name: "occurredTime")', function() {
      // uncomment below and update the code to test the property occurredTime
      //var instance = new RebillyRestApi.TransactionTimeline();
      //expect(instance).to.be();
    });
