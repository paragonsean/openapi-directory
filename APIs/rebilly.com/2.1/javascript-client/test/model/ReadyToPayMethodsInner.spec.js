...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RebillyRestApi.ReadyToPayMethodsInner();
  });
  ...
  describe('ReadyToPayMethodsInner', function() {
    it('should create an instance of ReadyToPayMethodsInner', function() {
      // uncomment below and update the code to test ReadyToPayMethodsInner
      //var instance = new RebillyRestApi.ReadyToPayMethodsInner();
      //expect(instance).to.be.a(RebillyRestApi.ReadyToPayMethodsInner);
    });
