...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RebillyRestApi.UPayCard();
  });
  ...
  describe('UPayCard', function() {
    it('should create an instance of UPayCard', function() {
      // uncomment below and update the code to test UPayCard
      //var instance = new RebillyRestApi.UPayCard();
      //expect(instance).to.be.a(RebillyRestApi.UPayCard);
    });
