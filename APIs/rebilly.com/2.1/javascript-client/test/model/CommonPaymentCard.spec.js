...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RebillyRestApi.CommonPaymentCard();
  });
  ...
  describe('CommonPaymentCard', function() {
    it('should create an instance of CommonPaymentCard', function() {
      // uncomment below and update the code to test CommonPaymentCard
      //var instance = new RebillyRestApi.CommonPaymentCard();
      //expect(instance).to.be.a(RebillyRestApi.CommonPaymentCard);
    });
