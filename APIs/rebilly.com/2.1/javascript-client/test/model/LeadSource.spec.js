...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RebillyRestApi.LeadSource();
  });
  ...
  describe('LeadSource', function() {
    it('should create an instance of LeadSource', function() {
      // uncomment below and update the code to test LeadSource
      //var instance = new RebillyRestApi.LeadSource();
      //expect(instance).to.be.a(RebillyRestApi.LeadSource);
    });
    ...
    it('should have the property salesAgent (base name: "salesAgent")', function() {
      // uncomment below and update the code to test the property salesAgent
      //var instance = new RebillyRestApi.LeadSource();
      //expect(instance).to.be();
    });
    ...
    it('should have the property subAffiliate (base name: "subAffiliate")', function() {
      // uncomment below and update the code to test the property subAffiliate
      //var instance = new RebillyRestApi.LeadSource();
      //expect(instance).to.be();
    });
