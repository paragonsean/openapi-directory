...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RebillyRestApi.CommonPlan();
  });
  ...
  describe('CommonPlan', function() {
    it('should create an instance of CommonPlan', function() {
      // uncomment below and update the code to test CommonPlan
      //var instance = new RebillyRestApi.CommonPlan();
      //expect(instance).to.be.a(RebillyRestApi.CommonPlan);
    });
    ...
    it('should have the property currencySign (base name: "currencySign")', function() {
      // uncomment below and update the code to test the property currencySign
      //var instance = new RebillyRestApi.CommonPlan();
      //expect(instance).to.be();
    });
    ...
    it('should have the property isTrialOnly (base name: "isTrialOnly")', function() {
      // uncomment below and update the code to test the property isTrialOnly
      //var instance = new RebillyRestApi.CommonPlan();
      //expect(instance).to.be();
    });
    ...
    it('should have the property recurringInterval (base name: "recurringInterval")', function() {
      // uncomment below and update the code to test the property recurringInterval
      //var instance = new RebillyRestApi.CommonPlan();
      //expect(instance).to.be();
    });
