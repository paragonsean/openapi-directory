...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RebillyRestApi.TimelineExtraData();
  });
  ...
  describe('TimelineExtraData', function() {
    it('should create an instance of TimelineExtraData', function() {
      // uncomment below and update the code to test TimelineExtraData
      //var instance = new RebillyRestApi.TimelineExtraData();
      //expect(instance).to.be.a(RebillyRestApi.TimelineExtraData);
    });
