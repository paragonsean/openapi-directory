...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RebillyRestApi.TrustlyAllOfCredentials();
  });
  ...
  describe('TrustlyAllOfCredentials', function() {
    it('should create an instance of TrustlyAllOfCredentials', function() {
      // uncomment below and update the code to test TrustlyAllOfCredentials
      //var instance = new RebillyRestApi.TrustlyAllOfCredentials();
      //expect(instance).to.be.a(RebillyRestApi.TrustlyAllOfCredentials);
    });
