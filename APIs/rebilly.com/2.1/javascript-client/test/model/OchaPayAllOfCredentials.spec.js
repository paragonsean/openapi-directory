...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RebillyRestApi.OchaPayAllOfCredentials();
  });
  ...
  describe('OchaPayAllOfCredentials', function() {
    it('should create an instance of OchaPayAllOfCredentials', function() {
      // uncomment below and update the code to test OchaPayAllOfCredentials
      //var instance = new RebillyRestApi.OchaPayAllOfCredentials();
      //expect(instance).to.be.a(RebillyRestApi.OchaPayAllOfCredentials);
    });
