...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RebillyRestApi.Chase();
  });
  ...
  describe('Chase', function() {
    it('should create an instance of Chase', function() {
      // uncomment below and update the code to test Chase
      //var instance = new RebillyRestApi.Chase();
      //expect(instance).to.be.a(RebillyRestApi.Chase);
    });
