...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RebillyRestApi.TimelineExtraDataLinksInner();
  });
  ...
  describe('TimelineExtraDataLinksInner', function() {
    it('should create an instance of TimelineExtraDataLinksInner', function() {
      // uncomment below and update the code to test TimelineExtraDataLinksInner
      //var instance = new RebillyRestApi.TimelineExtraDataLinksInner();
      //expect(instance).to.be.a(RebillyRestApi.TimelineExtraDataLinksInner);
    });
