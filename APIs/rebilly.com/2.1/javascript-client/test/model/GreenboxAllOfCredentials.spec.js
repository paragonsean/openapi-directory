...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RebillyRestApi.GreenboxAllOfCredentials();
  });
  ...
  describe('GreenboxAllOfCredentials', function() {
    it('should create an instance of GreenboxAllOfCredentials', function() {
      // uncomment below and update the code to test GreenboxAllOfCredentials
      //var instance = new RebillyRestApi.GreenboxAllOfCredentials();
      //expect(instance).to.be.a(RebillyRestApi.GreenboxAllOfCredentials);
    });
