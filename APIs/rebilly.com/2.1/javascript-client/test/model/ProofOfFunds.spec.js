...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RebillyRestApi.ProofOfFunds();
  });
  ...
  describe('ProofOfFunds', function() {
    it('should create an instance of ProofOfFunds', function() {
      // uncomment below and update the code to test ProofOfFunds
      //var instance = new RebillyRestApi.ProofOfFunds();
      //expect(instance).to.be.a(RebillyRestApi.ProofOfFunds);
    });
