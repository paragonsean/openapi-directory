...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RebillyRestApi.PatchKycRequestRequest();
  });
  ...
  describe('PatchKycRequestRequest', function() {
    it('should create an instance of PatchKycRequestRequest', function() {
      // uncomment below and update the code to test PatchKycRequestRequest
      //var instance = new RebillyRestApi.PatchKycRequestRequest();
      //expect(instance).to.be.a(RebillyRestApi.PatchKycRequestRequest);
    });
