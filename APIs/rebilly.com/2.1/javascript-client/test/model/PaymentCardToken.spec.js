...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RebillyRestApi.PaymentCardToken();
  });
  ...
  describe('PaymentCardToken', function() {
    it('should create an instance of PaymentCardToken', function() {
      // uncomment below and update the code to test PaymentCardToken
      //var instance = new RebillyRestApi.PaymentCardToken();
      //expect(instance).to.be.a(RebillyRestApi.PaymentCardToken);
    });
    ...
    it('should have the property isUsed (base name: "isUsed")', function() {
      // uncomment below and update the code to test the property isUsed
      //var instance = new RebillyRestApi.PaymentCardToken();
      //expect(instance).to.be();
    });
    ...
    it('should have the property usageTime (base name: "usageTime")', function() {
