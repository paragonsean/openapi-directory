...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RebillyRestApi.BitPay();
  });
  ...
  describe('BitPay', function() {
    it('should create an instance of BitPay', function() {
      // uncomment below and update the code to test BitPay
      //var instance = new RebillyRestApi.BitPay();
      //expect(instance).to.be.a(RebillyRestApi.BitPay);
    });
