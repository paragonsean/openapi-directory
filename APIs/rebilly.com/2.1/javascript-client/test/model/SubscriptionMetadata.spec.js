...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RebillyRestApi.SubscriptionMetadata();
  });
  ...
  describe('SubscriptionMetadata', function() {
    it('should create an instance of SubscriptionMetadata', function() {
      // uncomment below and update the code to test SubscriptionMetadata
      //var instance = new RebillyRestApi.SubscriptionMetadata();
      //expect(instance).to.be.a(RebillyRestApi.SubscriptionMetadata);
    });
