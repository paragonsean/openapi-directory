...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RebillyRestApi.TWINT();
  });
  ...
  describe('TWINT', function() {
    it('should create an instance of TWINT', function() {
      // uncomment below and update the code to test TWINT
      //var instance = new RebillyRestApi.TWINT();
      //expect(instance).to.be.a(RebillyRestApi.TWINT);
    });
