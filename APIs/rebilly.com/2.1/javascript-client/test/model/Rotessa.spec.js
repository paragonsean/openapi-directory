...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RebillyRestApi.Rotessa();
  });
  ...
  describe('Rotessa', function() {
    it('should create an instance of Rotessa', function() {
      // uncomment below and update the code to test Rotessa
      //var instance = new RebillyRestApi.Rotessa();
      //expect(instance).to.be.a(RebillyRestApi.Rotessa);
    });
