...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RebillyRestApi.PaymentInstrument();
  });
  ...
  describe('PaymentInstrument', function() {
    it('should create an instance of PaymentInstrument', function() {
      ...
      //var instance = new RebillyRestApi.PaymentInstrument();
      //expect(instance).to.be.a(RebillyRestApi.PaymentInstrument);
    });
