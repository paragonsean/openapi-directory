...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RebillyRestApi.IBANType();
  });
  ...
  describe('IBANType', function() {
    it('should create an instance of IBANType', function() {
      // uncomment below and update the code to test IBANType
      //var instance = new RebillyRestApi.IBANType();
      //expect(instance).to.be.a(RebillyRestApi.IBANType);
    });
    ...
    it('should have the property accountNumberType (base name: "accountNumberType")', function() {
      // uncomment below and update the code to test the property accountNumberType
      //var instance = new RebillyRestApi.IBANType();
      //expect(instance).to.be();
    });
