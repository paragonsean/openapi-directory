...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RebillyRestApi.EPG();
  });
  ...
  describe('EPG', function() {
    it('should create an instance of EPG', function() {
      // uncomment below and update the code to test EPG
      //var instance = new RebillyRestApi.EPG();
      //expect(instance).to.be.a(RebillyRestApi.EPG);
    });
