...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RebillyRestApi.ProofOfPurchase();
  });
  ...
  describe('ProofOfPurchase', function() {
    it('should create an instance of ProofOfPurchase', function() {
      // uncomment below and update the code to test ProofOfPurchase
      //var instance = new RebillyRestApi.ProofOfPurchase();
      //expect(instance).to.be.a(RebillyRestApi.ProofOfPurchase);
    });
