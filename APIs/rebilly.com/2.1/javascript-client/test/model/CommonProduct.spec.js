...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RebillyRestApi.CommonProduct();
  });
  ...
  describe('CommonProduct', function() {
    it('should create an instance of CommonProduct', function() {
      // uncomment below and update the code to test CommonProduct
      //var instance = new RebillyRestApi.CommonProduct();
      //expect(instance).to.be.a(RebillyRestApi.CommonProduct);
    });
    ...
    it('should have the property requiresShipping (base name: "requiresShipping")', function() {
