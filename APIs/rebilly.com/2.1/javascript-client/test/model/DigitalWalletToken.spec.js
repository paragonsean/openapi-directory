...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RebillyRestApi.DigitalWalletToken();
  });
  ...
  describe('DigitalWalletToken', function() {
    it('should create an instance of DigitalWalletToken', function() {
      // uncomment below and update the code to test DigitalWalletToken
      //var instance = new RebillyRestApi.DigitalWalletToken();
      //expect(instance).to.be.a(RebillyRestApi.DigitalWalletToken);
    });
