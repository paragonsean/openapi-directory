...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RebillyRestApi.OneTimeOrder();
  });
  ...
  describe('OneTimeOrder', function() {
    it('should create an instance of OneTimeOrder', function() {
      // uncomment below and update the code to test OneTimeOrder
      //var instance = new RebillyRestApi.OneTimeOrder();
      //expect(instance).to.be.a(RebillyRestApi.OneTimeOrder);
    });
