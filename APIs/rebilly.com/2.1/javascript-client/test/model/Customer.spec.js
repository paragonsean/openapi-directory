...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RebillyRestApi.Customer();
  });
  ...
  describe('Customer', function() {
    it('should create an instance of Customer', function() {
      ...
      //var instance = new RebillyRestApi.Customer();
      //expect(instance).to.be.a(RebillyRestApi.Customer);
    });
    ...
    it('should have the property invoiceCount (base name: "invoiceCount")', function() {
      // uncomment below and update the code to test the property invoiceCount
      //var instance = new RebillyRestApi.Customer();
      //expect(instance).to.be();
    });
    ...
    it('should have the property lastPaymentTime (base name: "lastPaymentTime")', function() {
      // uncomment below and update the code to test the property lastPaymentTime
      //var instance = new RebillyRestApi.Customer();
      //expect(instance).to.be();
    });

    it('should have the property lifetimeRevenue (base name: "lifetimeRevenue")', function() {
      // uncomment below and update the code to test the property lifetimeRevenue
      //var instance = new RebillyRestApi.Customer();
      //expect(instance).to.be();
    });

    it('should have the property paymentCount (base name: "paymentCount")', function() {
      // uncomment below and update the code to test the property paymentCount
      //var instance = new RebillyRestApi.Customer();
      //expect(instance).to.be();
    });
