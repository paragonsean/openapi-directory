...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RebillyRestApi.ICanPay();
  });
  ...
  describe('ICanPay', function() {
    it('should create an instance of ICanPay', function() {
      // uncomment below and update the code to test ICanPay
      //var instance = new RebillyRestApi.ICanPay();
      //expect(instance).to.be.a(RebillyRestApi.ICanPay);
    });
