...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RebillyRestApi.Cashflows();
  });
  ...
  describe('Cashflows', function() {
    it('should create an instance of Cashflows', function() {
      // uncomment below and update the code to test Cashflows
      //var instance = new RebillyRestApi.Cashflows();
      //expect(instance).to.be.a(RebillyRestApi.Cashflows);
    });
