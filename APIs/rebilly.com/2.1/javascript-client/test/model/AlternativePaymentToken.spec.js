...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RebillyRestApi.AlternativePaymentToken();
  });
  ...
  describe('AlternativePaymentToken', function() {
    it('should create an instance of AlternativePaymentToken', function() {
      // uncomment below and update the code to test AlternativePaymentToken
      //var instance = new RebillyRestApi.AlternativePaymentToken();
      //expect(instance).to.be.a(RebillyRestApi.AlternativePaymentToken);
    });
