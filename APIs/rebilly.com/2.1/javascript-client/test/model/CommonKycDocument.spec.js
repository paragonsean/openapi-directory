...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RebillyRestApi.CommonKycDocument();
  });
  ...
  describe('CommonKycDocument', function() {
    it('should create an instance of CommonKycDocument', function() {
      // uncomment below and update the code to test CommonKycDocument
      //var instance = new RebillyRestApi.CommonKycDocument();
      //expect(instance).to.be.a(RebillyRestApi.CommonKycDocument);
    });
