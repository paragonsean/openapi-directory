...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RebillyRestApi.Gigadat();
  });
  ...
  describe('Gigadat', function() {
    it('should create an instance of Gigadat', function() {
      // uncomment below and update the code to test Gigadat
      //var instance = new RebillyRestApi.Gigadat();
      //expect(instance).to.be.a(RebillyRestApi.Gigadat);
    });
