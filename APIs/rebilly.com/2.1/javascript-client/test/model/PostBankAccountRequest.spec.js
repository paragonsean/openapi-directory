...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RebillyRestApi.PostBankAccountRequest();
  });
  ...
  describe('PostBankAccountRequest', function() {
    it('should create an instance of PostBankAccountRequest', function() {
      // uncomment below and update the code to test PostBankAccountRequest
      //var instance = new RebillyRestApi.PostBankAccountRequest();
      //expect(instance).to.be.a(RebillyRestApi.PostBankAccountRequest);
    });
