...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RebillyRestApi.Finrax();
  });
  ...
  describe('Finrax', function() {
    it('should create an instance of Finrax', function() {
      // uncomment below and update the code to test Finrax
      //var instance = new RebillyRestApi.Finrax();
      //expect(instance).to.be.a(RebillyRestApi.Finrax);
    });
