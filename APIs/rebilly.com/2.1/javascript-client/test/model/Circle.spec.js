...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RebillyRestApi.Circle();
  });
  ...
  describe('Circle', function() {
    it('should create an instance of Circle', function() {
      // uncomment below and update the code to test Circle
      //var instance = new RebillyRestApi.Circle();
      //expect(instance).to.be.a(RebillyRestApi.Circle);
    });
