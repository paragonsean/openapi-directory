...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RebillyRestApi.FinraxAllOfCredentials();
  });
  ...
  describe('FinraxAllOfCredentials', function() {
    it('should create an instance of FinraxAllOfCredentials', function() {
      // uncomment below and update the code to test FinraxAllOfCredentials
      //var instance = new RebillyRestApi.FinraxAllOfCredentials();
      //expect(instance).to.be.a(RebillyRestApi.FinraxAllOfCredentials);
    });
