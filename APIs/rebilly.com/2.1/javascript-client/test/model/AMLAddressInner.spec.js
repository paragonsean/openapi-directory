...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RebillyRestApi.AMLAddressInner();
  });
  ...
  describe('AMLAddressInner', function() {
    it('should create an instance of AMLAddressInner', function() {
      // uncomment below and update the code to test AMLAddressInner
      //var instance = new RebillyRestApi.AMLAddressInner();
      //expect(instance).to.be.a(RebillyRestApi.AMLAddressInner);
    });
