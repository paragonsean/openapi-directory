...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RebillyRestApi.BBANInstrument();
  });
  ...
  describe('BBANInstrument', function() {
    it('should create an instance of BBANInstrument', function() {
      // uncomment below and update the code to test BBANInstrument
      //var instance = new RebillyRestApi.BBANInstrument();
      //expect(instance).to.be.a(RebillyRestApi.BBANInstrument);
    });
