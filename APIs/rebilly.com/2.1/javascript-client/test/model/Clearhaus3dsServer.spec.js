...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RebillyRestApi.Clearhaus3dsServer();
  });
  ...
  describe('Clearhaus3dsServer', function() {
    it('should create an instance of Clearhaus3dsServer', function() {
      // uncomment below and update the code to test Clearhaus3dsServer
      //var instance = new RebillyRestApi.Clearhaus3dsServer();
      //expect(instance).to.be.a(RebillyRestApi.Clearhaus3dsServer);
    });
