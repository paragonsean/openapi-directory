...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RebillyRestApi.PayPalAccount();
  });
  ...
  describe('PayPalAccount', function() {
    it('should create an instance of PayPalAccount', function() {
      // uncomment below and update the code to test PayPalAccount
      //var instance = new RebillyRestApi.PayPalAccount();
      //expect(instance).to.be.a(RebillyRestApi.PayPalAccount);
    });
