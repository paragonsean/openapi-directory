...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RebillyRestApi.RapydAllOfCredentials();
  });
  ...
  describe('RapydAllOfCredentials', function() {
    it('should create an instance of RapydAllOfCredentials', function() {
      // uncomment below and update the code to test RapydAllOfCredentials
      //var instance = new RebillyRestApi.RapydAllOfCredentials();
      //expect(instance).to.be.a(RebillyRestApi.RapydAllOfCredentials);
    });
