...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RebillyRestApi.EcoPayz();
  });
  ...
  describe('EcoPayz', function() {
    it('should create an instance of EcoPayz', function() {
      // uncomment below and update the code to test EcoPayz
      //var instance = new RebillyRestApi.EcoPayz();
      //expect(instance).to.be.a(RebillyRestApi.EcoPayz);
    });
