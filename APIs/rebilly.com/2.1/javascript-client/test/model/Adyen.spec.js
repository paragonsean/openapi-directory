...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RebillyRestApi.Adyen();
  });
  ...
  describe('Adyen', function() {
    it('should create an instance of Adyen', function() {
      // uncomment below and update the code to test Adyen
      //var instance = new RebillyRestApi.Adyen();
      //expect(instance).to.be.a(RebillyRestApi.Adyen);
    });
