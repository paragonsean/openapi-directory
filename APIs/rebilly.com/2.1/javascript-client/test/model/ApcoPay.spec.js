...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RebillyRestApi.ApcoPay();
  });
  ...
  describe('ApcoPay', function() {
    it('should create an instance of ApcoPay', function() {
      // uncomment below and update the code to test ApcoPay
      //var instance = new RebillyRestApi.ApcoPay();
      //expect(instance).to.be.a(RebillyRestApi.ApcoPay);
    });
