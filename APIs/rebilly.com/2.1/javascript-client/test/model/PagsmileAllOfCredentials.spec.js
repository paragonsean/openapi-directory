...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RebillyRestApi.PagsmileAllOfCredentials();
  });
  ...
  describe('PagsmileAllOfCredentials', function() {
    it('should create an instance of PagsmileAllOfCredentials', function() {
      // uncomment below and update the code to test PagsmileAllOfCredentials
      //var instance = new RebillyRestApi.PagsmileAllOfCredentials();
      //expect(instance).to.be.a(RebillyRestApi.PagsmileAllOfCredentials);
    });
