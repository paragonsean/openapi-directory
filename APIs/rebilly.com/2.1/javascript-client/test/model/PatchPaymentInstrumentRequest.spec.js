...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RebillyRestApi.PatchPaymentInstrumentRequest();
  });
  ...
  describe('PatchPaymentInstrumentRequest', function() {
    it('should create an instance of PatchPaymentInstrumentRequest', function() {
      // uncomment below and update the code to test PatchPaymentInstrumentRequest
      //var instance = new RebillyRestApi.PatchPaymentInstrumentRequest();
      //expect(instance).to.be.a(RebillyRestApi.PatchPaymentInstrumentRequest);
    });
