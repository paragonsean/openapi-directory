...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RebillyRestApi.DLocal();
  });
  ...
  describe('DLocal', function() {
    it('should create an instance of DLocal', function() {
      // uncomment below and update the code to test DLocal
      //var instance = new RebillyRestApi.DLocal();
      //expect(instance).to.be.a(RebillyRestApi.DLocal);
    });
