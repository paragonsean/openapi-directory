...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RebillyRestApi.CashToCode();
  });
  ...
  describe('CashToCode', function() {
    it('should create an instance of CashToCode', function() {
      // uncomment below and update the code to test CashToCode
      //var instance = new RebillyRestApi.CashToCode();
      //expect(instance).to.be.a(RebillyRestApi.CashToCode);
    });
