...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RebillyRestApi.Coppr();
  });
  ...
  describe('Coppr', function() {
    it('should create an instance of Coppr', function() {
      // uncomment below and update the code to test Coppr
      //var instance = new RebillyRestApi.Coppr();
      //expect(instance).to.be.a(RebillyRestApi.Coppr);
    });
