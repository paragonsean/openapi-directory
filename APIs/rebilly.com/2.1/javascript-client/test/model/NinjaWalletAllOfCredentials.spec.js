...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RebillyRestApi.NinjaWalletAllOfCredentials();
  });
  ...
  describe('NinjaWalletAllOfCredentials', function() {
    it('should create an instance of NinjaWalletAllOfCredentials', function() {
      // uncomment below and update the code to test NinjaWalletAllOfCredentials
      //var instance = new RebillyRestApi.NinjaWalletAllOfCredentials();
      //expect(instance).to.be.a(RebillyRestApi.NinjaWalletAllOfCredentials);
    });
