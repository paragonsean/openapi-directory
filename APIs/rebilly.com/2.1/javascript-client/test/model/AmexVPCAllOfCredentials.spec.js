...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RebillyRestApi.AmexVPCAllOfCredentials();
  });
  ...
  describe('AmexVPCAllOfCredentials', function() {
    it('should create an instance of AmexVPCAllOfCredentials', function() {
      // uncomment below and update the code to test AmexVPCAllOfCredentials
      //var instance = new RebillyRestApi.AmexVPCAllOfCredentials();
      //expect(instance).to.be.a(RebillyRestApi.AmexVPCAllOfCredentials);
    });
