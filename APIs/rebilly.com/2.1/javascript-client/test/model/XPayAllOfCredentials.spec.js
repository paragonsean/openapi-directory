...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RebillyRestApi.XPayAllOfCredentials();
  });
  ...
  describe('XPayAllOfCredentials', function() {
    it('should create an instance of XPayAllOfCredentials', function() {
      // uncomment below and update the code to test XPayAllOfCredentials
      //var instance = new RebillyRestApi.XPayAllOfCredentials();
      //expect(instance).to.be.a(RebillyRestApi.XPayAllOfCredentials);
    });
