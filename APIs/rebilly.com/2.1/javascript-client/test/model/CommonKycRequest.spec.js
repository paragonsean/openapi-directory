...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RebillyRestApi.CommonKycRequest();
  });
  ...
  describe('CommonKycRequest', function() {
    it('should create an instance of CommonKycRequest', function() {
      // uncomment below and update the code to test CommonKycRequest
      //var instance = new RebillyRestApi.CommonKycRequest();
      //expect(instance).to.be.a(RebillyRestApi.CommonKycRequest);
    });
