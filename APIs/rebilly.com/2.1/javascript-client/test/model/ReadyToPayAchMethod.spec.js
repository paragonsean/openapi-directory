...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RebillyRestApi.ReadyToPayAchMethod();
  });
  ...
  describe('ReadyToPayAchMethod', function() {
    it('should create an instance of ReadyToPayAchMethod', function() {
      // uncomment below and update the code to test ReadyToPayAchMethod
      //var instance = new RebillyRestApi.ReadyToPayAchMethod();
      //expect(instance).to.be.a(RebillyRestApi.ReadyToPayAchMethod);
    });
