...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RebillyRestApi.NeosurfAllOfCredentials();
  });
  ...
  describe('NeosurfAllOfCredentials', function() {
    it('should create an instance of NeosurfAllOfCredentials', function() {
      // uncomment below and update the code to test NeosurfAllOfCredentials
      //var instance = new RebillyRestApi.NeosurfAllOfCredentials();
      //expect(instance).to.be.a(RebillyRestApi.NeosurfAllOfCredentials);
    });
