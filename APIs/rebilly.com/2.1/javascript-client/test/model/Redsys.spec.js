...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RebillyRestApi.Redsys();
  });
  ...
  describe('Redsys', function() {
    it('should create an instance of Redsys', function() {
      // uncomment below and update the code to test Redsys
      //var instance = new RebillyRestApi.Redsys();
      //expect(instance).to.be.a(RebillyRestApi.Redsys);
    });
