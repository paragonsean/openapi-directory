...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RebillyRestApi.AlternativePaymentInstrument2();
  });
  ...
  describe('AlternativePaymentInstrument2', function() {
    it('should create an instance of AlternativePaymentInstrument2', function() {
      // uncomment below and update the code to test AlternativePaymentInstrument2
      //var instance = new RebillyRestApi.AlternativePaymentInstrument2();
      //expect(instance).to.be.a(RebillyRestApi.AlternativePaymentInstrument2);
    });
