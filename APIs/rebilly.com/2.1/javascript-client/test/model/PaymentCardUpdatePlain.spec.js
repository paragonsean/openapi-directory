...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RebillyRestApi.PaymentCardUpdatePlain();
  });
  ...
  describe('PaymentCardUpdatePlain', function() {
    it('should create an instance of PaymentCardUpdatePlain', function() {
      // uncomment below and update the code to test PaymentCardUpdatePlain
      //var instance = new RebillyRestApi.PaymentCardUpdatePlain();
      //expect(instance).to.be.a(RebillyRestApi.PaymentCardUpdatePlain);
    });
