...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RebillyRestApi.CommonInvoice();
  });
  ...
  describe('CommonInvoice', function() {
    it('should create an instance of CommonInvoice', function() {
      // uncomment below and update the code to test CommonInvoice
      //var instance = new RebillyRestApi.CommonInvoice();
      //expect(instance).to.be.a(RebillyRestApi.CommonInvoice);
    });
