# RebillyRestApi.PayPalAccountsApi

All URIs are relative to *https://api-sandbox.rebilly.com*

Method | HTTP request | Description
------------- | ------------- | -------------
[**getPayPalAccount**](PayPalAccountsApi.md#getPayPalAccount) | **GET** /paypal-accounts/{id} | Retrieve a PayPal Account
[**getPayPalAccountCollection**](PayPalAccountsApi.md#getPayPalAccountCollection) | **GET** /paypal-accounts | Retrieve a list of PayPal accounts
[**postPayPalAccount**](PayPalAccountsApi.md#postPayPalAccount) | **POST** /paypal-accounts | Create a PayPal Account
[**postPayPalAccountDeactivation**](PayPalAccountsApi.md#postPayPalAccountDeactivation) | **POST** /paypal-accounts/{id}/deactivation | Deactivate a PayPal Account
[**putPayPalAccount**](PayPalAccountsApi.md#putPayPalAccount) | **PUT** /paypal-accounts/{id} | Create a PayPal account with predefined ID



## getPayPalAccount

> PayPalAccount getPayPalAccount(id, opts)
...
let apiInstance = new RebillyRestApi.PayPalAccountsApi();
...
apiInstance.getPayPalAccount(id, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
> [PayPalAccount] getPayPalAccountCollection(opts)
...
apiInstance.getPayPalAccountCollection(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> PayPalAccount postPayPalAccount(payPalAccount, opts)
...
let apiInstance = new RebillyRestApi.PayPalAccountsApi();
let payPalAccount = new RebillyRestApi.PayPalAccount(); // PayPalAccount | PayPalAccount resource.
let opts = {
  'organizationId': "organizationId_example" // String | Organization identifier in scope of which need to perform request (if not specified, the default organization will be used).
};
apiInstance.postPayPalAccount(payPalAccount, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **payPalAccount** | [**PayPalAccount**](PayPalAccount.md)| PayPalAccount resource. | 
 **organizationId** | **String**| Organization identifier in scope of which need to perform request (if not specified, the default organization will be used). | [optional] 
...
> PayPalAccount postPayPalAccountDeactivation(id, opts)
...
apiInstance.postPayPalAccountDeactivation(id, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> PayPalAccount putPayPalAccount(id, payPalAccount, opts)
...
let apiInstance = new RebillyRestApi.PayPalAccountsApi();
let id = "id_example"; // String | The resource identifier string.
let payPalAccount = new RebillyRestApi.PayPalAccount(); // PayPalAccount | PayPal Account.
let opts = {
  'organizationId': "organizationId_example" // String | Organization identifier in scope of which need to perform request (if not specified, the default organization will be used).
};
apiInstance.putPayPalAccount(id, payPalAccount, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
------------- | ------------- | ------------- | -------------
 **id** | **String**| The resource identifier string. | 
 **payPalAccount** | [**PayPalAccount**](PayPalAccount.md)| PayPal Account. | 
 **organizationId** | **String**| Organization identifier in scope of which need to perform request (if not specified, the default organization will be used). | [optional] 
