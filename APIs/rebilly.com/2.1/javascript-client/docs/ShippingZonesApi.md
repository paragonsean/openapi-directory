# RebillyRestApi.ShippingZonesApi
...
let apiInstance = new RebillyRestApi.ShippingZonesApi();
...
apiInstance.deleteShippingZone(id, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
> ShippingZone getShippingZone(id, opts)
...
apiInstance.getShippingZone(id, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
> [ShippingZone] getShippingZoneCollection(opts)
...
apiInstance.getShippingZoneCollection(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> ShippingZone postShippingZone(shippingZone, opts)
...
let apiInstance = new RebillyRestApi.ShippingZonesApi();
let shippingZone = new RebillyRestApi.ShippingZone(); // ShippingZone | Shipping Zone resource.
let opts = {
  'organizationId': "organizationId_example" // String | Organization identifier in scope of which need to perform request (if not specified, the default organization will be used).
};
apiInstance.postShippingZone(shippingZone, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> ShippingZone putShippingZone(id, shippingZone, opts)
...
apiInstance.putShippingZone(id, shippingZone, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
