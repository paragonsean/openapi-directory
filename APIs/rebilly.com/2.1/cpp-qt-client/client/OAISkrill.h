...
#include "OAISkrill_allOf_credentials.h"
#include <QDateTime>
#include <QList>
#include <QString>
...
class OAISkrill_allOf_credentials;

class OAISkrill : public OAIObject {
public:
    OAISkrill();
    OAISkrill(QString json);
    ~OAISkrill() override;
    ...
    OAISkrill_allOf_credentials getCredentials() const;
    void setCredentials(const OAISkrill_allOf_credentials &credentials);
...
private:
    ...
    OAISkrill_allOf_credentials m_credentials;
...
Q_DECLARE_METATYPE(OpenAPI::OAISkrill)
