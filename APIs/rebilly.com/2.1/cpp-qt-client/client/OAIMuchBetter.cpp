...
OAIMuchBetter::OAIMuchBetter(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIMuchBetter::OAIMuchBetter() {
    this->initializeModel();
}

OAIMuchBetter::~OAIMuchBetter() {}

void OAIMuchBetter::initializeModel() {
...
void OAIMuchBetter::fromJson(QString jsonString) {
...
void OAIMuchBetter::fromJsonObject(QJsonObject json) {
...
QString OAIMuchBetter::asJson() const {
...
QJsonObject OAIMuchBetter::asJsonObject() const {
    QJsonObject obj;
    if (m__links.size() > 0) {
...
QList<OAIGatewayAccount__links_inner> OAIMuchBetter::getLinks() const {
    return m__links;
}
void OAIMuchBetter::setLinks(const QList<OAIGatewayAccount__links_inner> &_links) {
    m__links = _links;
    m__links_isSet = true;
}

bool OAIMuchBetter::is__links_Set() const{
    return m__links_isSet;
}

bool OAIMuchBetter::is__links_Valid() const{
    return m__links_isValid;
}

QList<QString> OAIMuchBetter::getAcceptedCurrencies() const {
    return m_accepted_currencies;
}
void OAIMuchBetter::setAcceptedCurrencies(const QList<QString> &accepted_currencies) {
    m_accepted_currencies = accepted_currencies;
    m_accepted_currencies_isSet = true;
}

bool OAIMuchBetter::is_accepted_currencies_Set() const{
    return m_accepted_currencies_isSet;
}

bool OAIMuchBetter::is_accepted_currencies_Valid() const{
    return m_accepted_currencies_isValid;
}

OAIAcquirerName OAIMuchBetter::getAcquirerName() const {
    return m_acquirer_name;
}
void OAIMuchBetter::setAcquirerName(const OAIAcquirerName &acquirer_name) {
    m_acquirer_name = acquirer_name;
    m_acquirer_name_isSet = true;
}

bool OAIMuchBetter::is_acquirer_name_Set() const{
    return m_acquirer_name_isSet;
}

bool OAIMuchBetter::is_acquirer_name_Valid() const{
    return m_acquirer_name_isValid;
}

QString OAIMuchBetter::getAdditionalFilters() const {
    return m_additional_filters;
}
void OAIMuchBetter::setAdditionalFilters(const QString &additional_filters) {
    m_additional_filters = additional_filters;
    m_additional_filters_isSet = true;
}

bool OAIMuchBetter::is_additional_filters_Set() const{
    return m_additional_filters_isSet;
}

bool OAIMuchBetter::is_additional_filters_Valid() const{
    return m_additional_filters_isValid;
}

qint32 OAIMuchBetter::getApprovalWindowTtl() const {
    return m_approval_window_ttl;
}
void OAIMuchBetter::setApprovalWindowTtl(const qint32 &approval_window_ttl) {
    m_approval_window_ttl = approval_window_ttl;
    m_approval_window_ttl_isSet = true;
}

bool OAIMuchBetter::is_approval_window_ttl_Set() const{
    return m_approval_window_ttl_isSet;
}

bool OAIMuchBetter::is_approval_window_ttl_Valid() const{
    return m_approval_window_ttl_isValid;
}

QString OAIMuchBetter::getCityField() const {
    return m_city_field;
}
void OAIMuchBetter::setCityField(const QString &city_field) {
    m_city_field = city_field;
    m_city_field_isSet = true;
}

bool OAIMuchBetter::is_city_field_Set() const{
    return m_city_field_isSet;
}

bool OAIMuchBetter::is_city_field_Valid() const{
    return m_city_field_isValid;
}

QDateTime OAIMuchBetter::getCreatedTime() const {
    return m_created_time;
}
void OAIMuchBetter::setCreatedTime(const QDateTime &created_time) {
    m_created_time = created_time;
    m_created_time_isSet = true;
}

bool OAIMuchBetter::is_created_time_Set() const{
    return m_created_time_isSet;
}

bool OAIMuchBetter::is_created_time_Valid() const{
    return m_created_time_isValid;
}

QString OAIMuchBetter::getDccForceCurrency() const {
    return m_dcc_force_currency;
}
void OAIMuchBetter::setDccForceCurrency(const QString &dcc_force_currency) {
    m_dcc_force_currency = dcc_force_currency;
    m_dcc_force_currency_isSet = true;
}

bool OAIMuchBetter::is_dcc_force_currency_Set() const{
    return m_dcc_force_currency_isSet;
}

bool OAIMuchBetter::is_dcc_force_currency_Valid() const{
    return m_dcc_force_currency_isValid;
}

qint32 OAIMuchBetter::getDccMarkup() const {
    return m_dcc_markup;
}
void OAIMuchBetter::setDccMarkup(const qint32 &dcc_markup) {
    m_dcc_markup = dcc_markup;
    m_dcc_markup_isSet = true;
}

bool OAIMuchBetter::is_dcc_markup_Set() const{
    return m_dcc_markup_isSet;
}

bool OAIMuchBetter::is_dcc_markup_Valid() const{
    return m_dcc_markup_isValid;
}

QString OAIMuchBetter::getDescriptor() const {
    return m_descriptor;
}
void OAIMuchBetter::setDescriptor(const QString &descriptor) {
    m_descriptor = descriptor;
    m_descriptor_isSet = true;
}

bool OAIMuchBetter::is_descriptor_Set() const{
    return m_descriptor_isSet;
}

bool OAIMuchBetter::is_descriptor_Valid() const{
    return m_descriptor_isValid;
}

OAIDigitalWallets OAIMuchBetter::getDigitalWallets() const {
    return m_digital_wallets;
}
void OAIMuchBetter::setDigitalWallets(const OAIDigitalWallets &digital_wallets) {
    m_digital_wallets = digital_wallets;
    m_digital_wallets_isSet = true;
}

bool OAIMuchBetter::is_digital_wallets_Set() const{
    return m_digital_wallets_isSet;
}

bool OAIMuchBetter::is_digital_wallets_Valid() const{
    return m_digital_wallets_isValid;
}

bool OAIMuchBetter::isDynamicDescriptor() const {
    return m_dynamic_descriptor;
}
void OAIMuchBetter::setDynamicDescriptor(const bool &dynamic_descriptor) {
    m_dynamic_descriptor = dynamic_descriptor;
    m_dynamic_descriptor_isSet = true;
}

bool OAIMuchBetter::is_dynamic_descriptor_Set() const{
    return m_dynamic_descriptor_isSet;
}

bool OAIMuchBetter::is_dynamic_descriptor_Valid() const{
    return m_dynamic_descriptor_isValid;
}

QList<QString> OAIMuchBetter::getExcludedDccQuoteCurrencies() const {
    return m_excluded_dcc_quote_currencies;
}
void OAIMuchBetter::setExcludedDccQuoteCurrencies(const QList<QString> &excluded_dcc_quote_currencies) {
    m_excluded_dcc_quote_currencies = excluded_dcc_quote_currencies;
    m_excluded_dcc_quote_currencies_isSet = true;
}

bool OAIMuchBetter::is_excluded_dcc_quote_currencies_Set() const{
    return m_excluded_dcc_quote_currencies_isSet;
}

bool OAIMuchBetter::is_excluded_dcc_quote_currencies_Valid() const{
    return m_excluded_dcc_quote_currencies_isValid;
}

OAIGatewayName OAIMuchBetter::getGatewayName() const {
    return m_gateway_name;
}
void OAIMuchBetter::setGatewayName(const OAIGatewayName &gateway_name) {
    m_gateway_name = gateway_name;
    m_gateway_name_isSet = true;
}

bool OAIMuchBetter::is_gateway_name_Set() const{
    return m_gateway_name_isSet;
}

bool OAIMuchBetter::is_gateway_name_Valid() const{
    return m_gateway_name_isValid;
}

QString OAIMuchBetter::getId() const {
    return m_id;
}
void OAIMuchBetter::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIMuchBetter::is_id_Set() const{
    return m_id_isSet;
}

bool OAIMuchBetter::is_id_Valid() const{
    return m_id_isValid;
}

bool OAIMuchBetter::isIsDown() const {
    return m_is_down;
}
void OAIMuchBetter::setIsDown(const bool &is_down) {
    m_is_down = is_down;
    m_is_down_isSet = true;
}

bool OAIMuchBetter::is_is_down_Set() const{
    return m_is_down_isSet;
}

bool OAIMuchBetter::is_is_down_Valid() const{
    return m_is_down_isValid;
}

QString OAIMuchBetter::getMerchantCategoryCode() const {
    return m_merchant_category_code;
}
void OAIMuchBetter::setMerchantCategoryCode(const QString &merchant_category_code) {
    m_merchant_category_code = merchant_category_code;
    m_merchant_category_code_isSet = true;
}

bool OAIMuchBetter::is_merchant_category_code_Set() const{
    return m_merchant_category_code_isSet;
}

bool OAIMuchBetter::is_merchant_category_code_Valid() const{
    return m_merchant_category_code_isValid;
}

OAIPaymentMethod OAIMuchBetter::getMethod() const {
    return m_method;
}
void OAIMuchBetter::setMethod(const OAIPaymentMethod &method) {
    m_method = method;
    m_method_isSet = true;
}

bool OAIMuchBetter::is_method_Set() const{
    return m_method_isSet;
}

bool OAIMuchBetter::is_method_Valid() const{
    return m_method_isValid;
}

double OAIMuchBetter::getMonthlyLimit() const {
    return m_monthly_limit;
}
void OAIMuchBetter::setMonthlyLimit(const double &monthly_limit) {
    m_monthly_limit = monthly_limit;
    m_monthly_limit_isSet = true;
}

bool OAIMuchBetter::is_monthly_limit_Set() const{
    return m_monthly_limit_isSet;
}

bool OAIMuchBetter::is_monthly_limit_Valid() const{
    return m_monthly_limit_isValid;
}

QString OAIMuchBetter::getOrganizationId() const {
    return m_organization_id;
}
void OAIMuchBetter::setOrganizationId(const QString &organization_id) {
    m_organization_id = organization_id;
    m_organization_id_isSet = true;
}

bool OAIMuchBetter::is_organization_id_Set() const{
    return m_organization_id_isSet;
}

bool OAIMuchBetter::is_organization_id_Valid() const{
    return m_organization_id_isValid;
}

QList<OAIPaymentCardBrand> OAIMuchBetter::getPaymentCardSchemes() const {
    return m_payment_card_schemes;
}
void OAIMuchBetter::setPaymentCardSchemes(const QList<OAIPaymentCardBrand> &payment_card_schemes) {
    m_payment_card_schemes = payment_card_schemes;
    m_payment_card_schemes_isSet = true;
}

bool OAIMuchBetter::is_payment_card_schemes_Set() const{
    return m_payment_card_schemes_isSet;
}

bool OAIMuchBetter::is_payment_card_schemes_Valid() const{
    return m_payment_card_schemes_isValid;
}

bool OAIMuchBetter::isReconciliationWindowEnabled() const {
    return m_reconciliation_window_enabled;
}
void OAIMuchBetter::setReconciliationWindowEnabled(const bool &reconciliation_window_enabled) {
    m_reconciliation_window_enabled = reconciliation_window_enabled;
    m_reconciliation_window_enabled_isSet = true;
}

bool OAIMuchBetter::is_reconciliation_window_enabled_Set() const{
    return m_reconciliation_window_enabled_isSet;
}

bool OAIMuchBetter::is_reconciliation_window_enabled_Valid() const{
    return m_reconciliation_window_enabled_isValid;
}

qint32 OAIMuchBetter::getReconciliationWindowTtl() const {
    return m_reconciliation_window_ttl;
}
void OAIMuchBetter::setReconciliationWindowTtl(const qint32 &reconciliation_window_ttl) {
    m_reconciliation_window_ttl = reconciliation_window_ttl;
    m_reconciliation_window_ttl_isSet = true;
}

bool OAIMuchBetter::is_reconciliation_window_ttl_Set() const{
    return m_reconciliation_window_ttl_isSet;
}

bool OAIMuchBetter::is_reconciliation_window_ttl_Valid() const{
    return m_reconciliation_window_ttl_isValid;
}

QString OAIMuchBetter::getStatus() const {
    return m_status;
}
void OAIMuchBetter::setStatus(const QString &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIMuchBetter::is_status_Set() const{
    return m_status_isSet;
}

bool OAIMuchBetter::is_status_Valid() const{
    return m_status_isValid;
}

bool OAIMuchBetter::isSticky() const {
    return m_sticky;
}
void OAIMuchBetter::setSticky(const bool &sticky) {
    m_sticky = sticky;
    m_sticky_isSet = true;
}

bool OAIMuchBetter::is_sticky_Set() const{
    return m_sticky_isSet;
}

bool OAIMuchBetter::is_sticky_Valid() const{
    return m_sticky_isValid;
}

bool OAIMuchBetter::isThreeDSecure() const {
    return m_three_d_secure;
}
void OAIMuchBetter::setThreeDSecure(const bool &three_d_secure) {
    m_three_d_secure = three_d_secure;
    m_three_d_secure_isSet = true;
}

bool OAIMuchBetter::is_three_d_secure_Set() const{
    return m_three_d_secure_isSet;
}

bool OAIMuchBetter::is_three_d_secure_Valid() const{
    return m_three_d_secure_isValid;
}

qint32 OAIMuchBetter::getTimeout() const {
    return m_timeout;
}
void OAIMuchBetter::setTimeout(const qint32 &timeout) {
    m_timeout = timeout;
    m_timeout_isSet = true;
}

bool OAIMuchBetter::is_timeout_Set() const{
    return m_timeout_isSet;
}

bool OAIMuchBetter::is_timeout_Valid() const{
    return m_timeout_isValid;
}

QString OAIMuchBetter::getToken() const {
    return m_token;
}
void OAIMuchBetter::setToken(const QString &token) {
    m_token = token;
    m_token_isSet = true;
}

bool OAIMuchBetter::is_token_Set() const{
    return m_token_isSet;
}

bool OAIMuchBetter::is_token_Valid() const{
    return m_token_isValid;
}

QDateTime OAIMuchBetter::getUpdatedTime() const {
    return m_updated_time;
}
void OAIMuchBetter::setUpdatedTime(const QDateTime &updated_time) {
    m_updated_time = updated_time;
    m_updated_time_isSet = true;
}

bool OAIMuchBetter::is_updated_time_Set() const{
    return m_updated_time_isSet;
}

bool OAIMuchBetter::is_updated_time_Valid() const{
    return m_updated_time_isValid;
}

OAIMuchBetter_allOf_credentials OAIMuchBetter::getCredentials() const {
    return m_credentials;
}
void OAIMuchBetter::setCredentials(const OAIMuchBetter_allOf_credentials &credentials) {
    m_credentials = credentials;
    m_credentials_isSet = true;
}

bool OAIMuchBetter::is_credentials_Set() const{
    return m_credentials_isSet;
}

bool OAIMuchBetter::is_credentials_Valid() const{
    return m_credentials_isValid;
}

OAIMuchBetter_allOf_settings OAIMuchBetter::getSettings() const {
    return m_settings;
}
void OAIMuchBetter::setSettings(const OAIMuchBetter_allOf_settings &settings) {
    m_settings = settings;
    m_settings_isSet = true;
}

bool OAIMuchBetter::is_settings_Set() const{
    return m_settings_isSet;
}

bool OAIMuchBetter::is_settings_Valid() const{
    return m_settings_isValid;
}

bool OAIMuchBetter::isSet() const {
...
bool OAIMuchBetter::isValid() const {
