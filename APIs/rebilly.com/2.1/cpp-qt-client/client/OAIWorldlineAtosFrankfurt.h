...
/*
 * OAIWorldlineAtosFrankfurt.h
 *
 * WorldlineAtosFrankfurt Gateway config.
 */

#ifndef OAIWorldlineAtosFrankfurt_H
#define OAIWorldlineAtosFrankfurt_H
...
class OAIWorldlineAtosFrankfurt_allOf_credentials;
class OAIWorldlineAtosFrankfurt_allOf_settings;
class OAIWorldlineAtosFrankfurt3dsServers;

class OAIWorldlineAtosFrankfurt : public OAIObject {
public:
    OAIWorldlineAtosFrankfurt();
    OAIWorldlineAtosFrankfurt(QString json);
    ~OAIWorldlineAtosFrankfurt() override;
    ...
    OAIWorldlineAtosFrankfurt_allOf_credentials getCredentials() const;
    void setCredentials(const OAIWorldlineAtosFrankfurt_allOf_credentials &credentials);
    bool is_credentials_Set() const;
    bool is_credentials_Valid() const;

    OAIWorldlineAtosFrankfurt_allOf_settings getSettings() const;
    void setSettings(const OAIWorldlineAtosFrankfurt_allOf_settings &settings);
    bool is_settings_Set() const;
    bool is_settings_Valid() const;

    OAIWorldlineAtosFrankfurt3dsServers getThreeDSecureServer() const;
    void setThreeDSecureServer(const OAIWorldlineAtosFrankfurt3dsServers &three_d_secure_server);
...
private:
    ...
    OAIWorldlineAtosFrankfurt_allOf_credentials m_credentials;
    bool m_credentials_isSet;
    bool m_credentials_isValid;

    OAIWorldlineAtosFrankfurt_allOf_settings m_settings;
    bool m_settings_isSet;
    bool m_settings_isValid;

    OAIWorldlineAtosFrankfurt3dsServers m_three_d_secure_server;
...
Q_DECLARE_METATYPE(OpenAPI::OAIWorldlineAtosFrankfurt)

#endif // OAIWorldlineAtosFrankfurt_H
