...
class OAIEPG_allOf_credentials;

class OAIEPG : public OAIObject {
public:
    OAIEPG();
    OAIEPG(QString json);
    ~OAIEPG() override;
    ...
    OAIEPG_allOf_credentials getCredentials() const;
    void setCredentials(const OAIEPG_allOf_credentials &credentials);
...
private:
    ...
    OAIEPG_allOf_credentials m_credentials;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEPG)
