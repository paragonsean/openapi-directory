...
class OAIAdyen_allOf_credentials;
class OAIAdyen_allOf_settings;

class OAIAdyen : public OAIObject {
public:
    OAIAdyen();
    OAIAdyen(QString json);
    ~OAIAdyen() override;
    ...
    OAIAdyen_allOf_credentials getCredentials() const;
    void setCredentials(const OAIAdyen_allOf_credentials &credentials);
    bool is_credentials_Set() const;
    bool is_credentials_Valid() const;

    OAIAdyen_allOf_settings getSettings() const;
    void setSettings(const OAIAdyen_allOf_settings &settings);
...
private:
    ...
    OAIAdyen_allOf_credentials m_credentials;
    bool m_credentials_isSet;
    bool m_credentials_isValid;

    OAIAdyen_allOf_settings m_settings;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAdyen)
