...
#ifndef OAIRealtime_H
#define OAIRealtime_H
...
class OAIRealtime_allOf_credentials;

class OAIRealtime : public OAIObject {
public:
    OAIRealtime();
    OAIRealtime(QString json);
    ~OAIRealtime() override;
    ...
    OAIRealtime_allOf_credentials getCredentials() const;
    void setCredentials(const OAIRealtime_allOf_credentials &credentials);
...
private:
    ...
    OAIRealtime_allOf_credentials m_credentials;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRealtime)
