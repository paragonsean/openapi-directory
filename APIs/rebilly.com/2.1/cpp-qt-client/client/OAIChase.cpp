...
OAIChase::OAIChase(QString json) {
...
void OAIChase::fromJson(QString jsonString) {
...
void OAIChase::fromJsonObject(QJsonObject json) {
...
QJsonObject OAIChase::asJsonObject() const {
    QJsonObject obj;
    if (m__links.size() > 0) {
...
QList<OAIGatewayAccount__links_inner> OAIChase::getLinks() const {
    return m__links;
}
void OAIChase::setLinks(const QList<OAIGatewayAccount__links_inner> &_links) {
    m__links = _links;
    m__links_isSet = true;
}

bool OAIChase::is__links_Set() const{
    return m__links_isSet;
}

bool OAIChase::is__links_Valid() const{
    return m__links_isValid;
}

QList<QString> OAIChase::getAcceptedCurrencies() const {
    return m_accepted_currencies;
}
void OAIChase::setAcceptedCurrencies(const QList<QString> &accepted_currencies) {
    m_accepted_currencies = accepted_currencies;
    m_accepted_currencies_isSet = true;
}

bool OAIChase::is_accepted_currencies_Set() const{
    return m_accepted_currencies_isSet;
}

bool OAIChase::is_accepted_currencies_Valid() const{
    return m_accepted_currencies_isValid;
}

OAIAcquirerName OAIChase::getAcquirerName() const {
    return m_acquirer_name;
}
void OAIChase::setAcquirerName(const OAIAcquirerName &acquirer_name) {
    m_acquirer_name = acquirer_name;
    m_acquirer_name_isSet = true;
}

bool OAIChase::is_acquirer_name_Set() const{
    return m_acquirer_name_isSet;
}

bool OAIChase::is_acquirer_name_Valid() const{
    return m_acquirer_name_isValid;
}

QString OAIChase::getAdditionalFilters() const {
    return m_additional_filters;
}
void OAIChase::setAdditionalFilters(const QString &additional_filters) {
    m_additional_filters = additional_filters;
    m_additional_filters_isSet = true;
}

bool OAIChase::is_additional_filters_Set() const{
    return m_additional_filters_isSet;
}

bool OAIChase::is_additional_filters_Valid() const{
    return m_additional_filters_isValid;
}

qint32 OAIChase::getApprovalWindowTtl() const {
    return m_approval_window_ttl;
}
void OAIChase::setApprovalWindowTtl(const qint32 &approval_window_ttl) {
    m_approval_window_ttl = approval_window_ttl;
    m_approval_window_ttl_isSet = true;
}

bool OAIChase::is_approval_window_ttl_Set() const{
    return m_approval_window_ttl_isSet;
}

bool OAIChase::is_approval_window_ttl_Valid() const{
    return m_approval_window_ttl_isValid;
}

QString OAIChase::getCityField() const {
    return m_city_field;
}
void OAIChase::setCityField(const QString &city_field) {
    m_city_field = city_field;
    m_city_field_isSet = true;
}

bool OAIChase::is_city_field_Set() const{
    return m_city_field_isSet;
}

bool OAIChase::is_city_field_Valid() const{
    return m_city_field_isValid;
}

QDateTime OAIChase::getCreatedTime() const {
    return m_created_time;
}
void OAIChase::setCreatedTime(const QDateTime &created_time) {
    m_created_time = created_time;
    m_created_time_isSet = true;
}

bool OAIChase::is_created_time_Set() const{
    return m_created_time_isSet;
}

bool OAIChase::is_created_time_Valid() const{
    return m_created_time_isValid;
}

QString OAIChase::getDccForceCurrency() const {
    return m_dcc_force_currency;
}
void OAIChase::setDccForceCurrency(const QString &dcc_force_currency) {
    m_dcc_force_currency = dcc_force_currency;
    m_dcc_force_currency_isSet = true;
}

bool OAIChase::is_dcc_force_currency_Set() const{
    return m_dcc_force_currency_isSet;
}

bool OAIChase::is_dcc_force_currency_Valid() const{
    return m_dcc_force_currency_isValid;
}

qint32 OAIChase::getDccMarkup() const {
    return m_dcc_markup;
}
void OAIChase::setDccMarkup(const qint32 &dcc_markup) {
    m_dcc_markup = dcc_markup;
    m_dcc_markup_isSet = true;
}

bool OAIChase::is_dcc_markup_Set() const{
    return m_dcc_markup_isSet;
}

bool OAIChase::is_dcc_markup_Valid() const{
    return m_dcc_markup_isValid;
}

QString OAIChase::getDescriptor() const {
    return m_descriptor;
}
void OAIChase::setDescriptor(const QString &descriptor) {
    m_descriptor = descriptor;
    m_descriptor_isSet = true;
}

bool OAIChase::is_descriptor_Set() const{
    return m_descriptor_isSet;
}

bool OAIChase::is_descriptor_Valid() const{
    return m_descriptor_isValid;
}

OAIDigitalWallets OAIChase::getDigitalWallets() const {
    return m_digital_wallets;
}
void OAIChase::setDigitalWallets(const OAIDigitalWallets &digital_wallets) {
    m_digital_wallets = digital_wallets;
    m_digital_wallets_isSet = true;
}

bool OAIChase::is_digital_wallets_Set() const{
    return m_digital_wallets_isSet;
}

bool OAIChase::is_digital_wallets_Valid() const{
    return m_digital_wallets_isValid;
}

bool OAIChase::isDynamicDescriptor() const {
    return m_dynamic_descriptor;
}
void OAIChase::setDynamicDescriptor(const bool &dynamic_descriptor) {
    m_dynamic_descriptor = dynamic_descriptor;
    m_dynamic_descriptor_isSet = true;
}

bool OAIChase::is_dynamic_descriptor_Set() const{
    return m_dynamic_descriptor_isSet;
}

bool OAIChase::is_dynamic_descriptor_Valid() const{
    return m_dynamic_descriptor_isValid;
}

QList<QString> OAIChase::getExcludedDccQuoteCurrencies() const {
    return m_excluded_dcc_quote_currencies;
}
void OAIChase::setExcludedDccQuoteCurrencies(const QList<QString> &excluded_dcc_quote_currencies) {
    m_excluded_dcc_quote_currencies = excluded_dcc_quote_currencies;
    m_excluded_dcc_quote_currencies_isSet = true;
}

bool OAIChase::is_excluded_dcc_quote_currencies_Set() const{
    return m_excluded_dcc_quote_currencies_isSet;
}

bool OAIChase::is_excluded_dcc_quote_currencies_Valid() const{
    return m_excluded_dcc_quote_currencies_isValid;
}

OAIGatewayName OAIChase::getGatewayName() const {
    return m_gateway_name;
}
void OAIChase::setGatewayName(const OAIGatewayName &gateway_name) {
    m_gateway_name = gateway_name;
    m_gateway_name_isSet = true;
}

bool OAIChase::is_gateway_name_Set() const{
    return m_gateway_name_isSet;
}

bool OAIChase::is_gateway_name_Valid() const{
    return m_gateway_name_isValid;
}

QString OAIChase::getId() const {
    return m_id;
}
void OAIChase::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIChase::is_id_Set() const{
    return m_id_isSet;
}

bool OAIChase::is_id_Valid() const{
    return m_id_isValid;
}

bool OAIChase::isIsDown() const {
    return m_is_down;
}
void OAIChase::setIsDown(const bool &is_down) {
    m_is_down = is_down;
    m_is_down_isSet = true;
}

bool OAIChase::is_is_down_Set() const{
    return m_is_down_isSet;
}

bool OAIChase::is_is_down_Valid() const{
    return m_is_down_isValid;
}

QString OAIChase::getMerchantCategoryCode() const {
    return m_merchant_category_code;
}
void OAIChase::setMerchantCategoryCode(const QString &merchant_category_code) {
    m_merchant_category_code = merchant_category_code;
    m_merchant_category_code_isSet = true;
}

bool OAIChase::is_merchant_category_code_Set() const{
    return m_merchant_category_code_isSet;
}

bool OAIChase::is_merchant_category_code_Valid() const{
    return m_merchant_category_code_isValid;
}

OAIPaymentMethod OAIChase::getMethod() const {
    return m_method;
}
void OAIChase::setMethod(const OAIPaymentMethod &method) {
    m_method = method;
    m_method_isSet = true;
}

bool OAIChase::is_method_Set() const{
    return m_method_isSet;
}

bool OAIChase::is_method_Valid() const{
    return m_method_isValid;
}

double OAIChase::getMonthlyLimit() const {
    return m_monthly_limit;
}
void OAIChase::setMonthlyLimit(const double &monthly_limit) {
    m_monthly_limit = monthly_limit;
    m_monthly_limit_isSet = true;
}

bool OAIChase::is_monthly_limit_Set() const{
    return m_monthly_limit_isSet;
}

bool OAIChase::is_monthly_limit_Valid() const{
    return m_monthly_limit_isValid;
}

QString OAIChase::getOrganizationId() const {
    return m_organization_id;
}
void OAIChase::setOrganizationId(const QString &organization_id) {
    m_organization_id = organization_id;
    m_organization_id_isSet = true;
}

bool OAIChase::is_organization_id_Set() const{
    return m_organization_id_isSet;
}

bool OAIChase::is_organization_id_Valid() const{
    return m_organization_id_isValid;
}

QList<OAIPaymentCardBrand> OAIChase::getPaymentCardSchemes() const {
    return m_payment_card_schemes;
}
void OAIChase::setPaymentCardSchemes(const QList<OAIPaymentCardBrand> &payment_card_schemes) {
    m_payment_card_schemes = payment_card_schemes;
    m_payment_card_schemes_isSet = true;
}

bool OAIChase::is_payment_card_schemes_Set() const{
    return m_payment_card_schemes_isSet;
}

bool OAIChase::is_payment_card_schemes_Valid() const{
    return m_payment_card_schemes_isValid;
}

bool OAIChase::isReconciliationWindowEnabled() const {
    return m_reconciliation_window_enabled;
}
void OAIChase::setReconciliationWindowEnabled(const bool &reconciliation_window_enabled) {
    m_reconciliation_window_enabled = reconciliation_window_enabled;
    m_reconciliation_window_enabled_isSet = true;
}

bool OAIChase::is_reconciliation_window_enabled_Set() const{
    return m_reconciliation_window_enabled_isSet;
}

bool OAIChase::is_reconciliation_window_enabled_Valid() const{
    return m_reconciliation_window_enabled_isValid;
}

qint32 OAIChase::getReconciliationWindowTtl() const {
    return m_reconciliation_window_ttl;
}
void OAIChase::setReconciliationWindowTtl(const qint32 &reconciliation_window_ttl) {
    m_reconciliation_window_ttl = reconciliation_window_ttl;
    m_reconciliation_window_ttl_isSet = true;
}

bool OAIChase::is_reconciliation_window_ttl_Set() const{
    return m_reconciliation_window_ttl_isSet;
}

bool OAIChase::is_reconciliation_window_ttl_Valid() const{
    return m_reconciliation_window_ttl_isValid;
}

QString OAIChase::getStatus() const {
    return m_status;
}
void OAIChase::setStatus(const QString &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIChase::is_status_Set() const{
    return m_status_isSet;
}

bool OAIChase::is_status_Valid() const{
    return m_status_isValid;
}

bool OAIChase::isSticky() const {
    return m_sticky;
}
void OAIChase::setSticky(const bool &sticky) {
    m_sticky = sticky;
    m_sticky_isSet = true;
}

bool OAIChase::is_sticky_Set() const{
    return m_sticky_isSet;
}

bool OAIChase::is_sticky_Valid() const{
    return m_sticky_isValid;
}

bool OAIChase::isThreeDSecure() const {
    return m_three_d_secure;
}
void OAIChase::setThreeDSecure(const bool &three_d_secure) {
    m_three_d_secure = three_d_secure;
    m_three_d_secure_isSet = true;
}

bool OAIChase::is_three_d_secure_Set() const{
    return m_three_d_secure_isSet;
}

bool OAIChase::is_three_d_secure_Valid() const{
    return m_three_d_secure_isValid;
}

qint32 OAIChase::getTimeout() const {
    return m_timeout;
}
void OAIChase::setTimeout(const qint32 &timeout) {
    m_timeout = timeout;
    m_timeout_isSet = true;
}

bool OAIChase::is_timeout_Set() const{
    return m_timeout_isSet;
}

bool OAIChase::is_timeout_Valid() const{
    return m_timeout_isValid;
}

QString OAIChase::getToken() const {
    return m_token;
}
void OAIChase::setToken(const QString &token) {
    m_token = token;
    m_token_isSet = true;
}

bool OAIChase::is_token_Set() const{
    return m_token_isSet;
}

bool OAIChase::is_token_Valid() const{
    return m_token_isValid;
}

QDateTime OAIChase::getUpdatedTime() const {
    return m_updated_time;
}
void OAIChase::setUpdatedTime(const QDateTime &updated_time) {
    m_updated_time = updated_time;
    m_updated_time_isSet = true;
}

bool OAIChase::is_updated_time_Set() const{
    return m_updated_time_isSet;
}

bool OAIChase::is_updated_time_Valid() const{
    return m_updated_time_isValid;
}

OAIChase_allOf_credentials OAIChase::getCredentials() const {
    return m_credentials;
}
void OAIChase::setCredentials(const OAIChase_allOf_credentials &credentials) {
    m_credentials = credentials;
    m_credentials_isSet = true;
}

bool OAIChase::is_credentials_Set() const{
    return m_credentials_isSet;
}

bool OAIChase::is_credentials_Valid() const{
    return m_credentials_isValid;
}

bool OAIChase::isSet() const {
