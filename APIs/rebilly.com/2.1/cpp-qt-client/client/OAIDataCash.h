...
#ifndef OAIDataCash_H
#define OAIDataCash_H

#include <QJsonObject>

#include "OAIAcquirerName.h"
#include "OAIDataCash3dsServers.h"
#include "OAIDataCash_allOf_credentials.h"
#include "OAIDataCash_allOf_settings.h"
...
class OAIDataCash_allOf_credentials;
class OAIDataCash_allOf_settings;
class OAIDataCash3dsServers;

class OAIDataCash : public OAIObject {
public:
    OAIDataCash();
    OAIDataCash(QString json);
    ~OAIDataCash() override;
    ...
    OAIDataCash_allOf_credentials getCredentials() const;
    void setCredentials(const OAIDataCash_allOf_credentials &credentials);
    bool is_credentials_Set() const;
    bool is_credentials_Valid() const;

    OAIDataCash_allOf_settings getSettings() const;
    void setSettings(const OAIDataCash_allOf_settings &settings);
    bool is_settings_Set() const;
    bool is_settings_Valid() const;

    OAIDataCash3dsServers getThreeDSecureServer() const;
    void setThreeDSecureServer(const OAIDataCash3dsServers &three_d_secure_server);
...
private:
    ...
    OAIDataCash_allOf_credentials m_credentials;
    bool m_credentials_isSet;
    bool m_credentials_isValid;

    OAIDataCash_allOf_settings m_settings;
    bool m_settings_isSet;
    bool m_settings_isValid;

    OAIDataCash3dsServers m_three_d_secure_server;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDataCash)
