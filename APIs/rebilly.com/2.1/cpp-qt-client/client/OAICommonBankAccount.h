...
/*
 * OAICommonBankAccount.h
 *
 * 
 */

#ifndef OAICommonBankAccount_H
#define OAICommonBankAccount_H
...
class OAICommonBankAccount : public OAIObject {
public:
    OAICommonBankAccount();
    OAICommonBankAccount(QString json);
    ~OAICommonBankAccount() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICommonBankAccount)

#endif // OAICommonBankAccount_H
