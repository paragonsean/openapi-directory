...
OAIRealex::OAIRealex(QString json) {
...
void OAIRealex::initializeModel() {
...
void OAIRealex::fromJson(QString jsonString) {
...
void OAIRealex::fromJsonObject(QJsonObject json) {
...
QString OAIRealex::asJson() const {
...
QJsonObject OAIRealex::asJsonObject() const {
    QJsonObject obj;
    if (m__links.size() > 0) {
...
QList<OAIGatewayAccount__links_inner> OAIRealex::getLinks() const {
    return m__links;
}
void OAIRealex::setLinks(const QList<OAIGatewayAccount__links_inner> &_links) {
    m__links = _links;
    m__links_isSet = true;
}

bool OAIRealex::is__links_Set() const{
    return m__links_isSet;
}

bool OAIRealex::is__links_Valid() const{
    return m__links_isValid;
}

QList<QString> OAIRealex::getAcceptedCurrencies() const {
    return m_accepted_currencies;
}
void OAIRealex::setAcceptedCurrencies(const QList<QString> &accepted_currencies) {
    m_accepted_currencies = accepted_currencies;
    m_accepted_currencies_isSet = true;
}

bool OAIRealex::is_accepted_currencies_Set() const{
    return m_accepted_currencies_isSet;
}

bool OAIRealex::is_accepted_currencies_Valid() const{
    return m_accepted_currencies_isValid;
}

OAIAcquirerName OAIRealex::getAcquirerName() const {
    return m_acquirer_name;
}
void OAIRealex::setAcquirerName(const OAIAcquirerName &acquirer_name) {
    m_acquirer_name = acquirer_name;
    m_acquirer_name_isSet = true;
}

bool OAIRealex::is_acquirer_name_Set() const{
    return m_acquirer_name_isSet;
}

bool OAIRealex::is_acquirer_name_Valid() const{
    return m_acquirer_name_isValid;
}

QString OAIRealex::getAdditionalFilters() const {
    return m_additional_filters;
}
void OAIRealex::setAdditionalFilters(const QString &additional_filters) {
    m_additional_filters = additional_filters;
    m_additional_filters_isSet = true;
}

bool OAIRealex::is_additional_filters_Set() const{
    return m_additional_filters_isSet;
}

bool OAIRealex::is_additional_filters_Valid() const{
    return m_additional_filters_isValid;
}

qint32 OAIRealex::getApprovalWindowTtl() const {
    return m_approval_window_ttl;
}
void OAIRealex::setApprovalWindowTtl(const qint32 &approval_window_ttl) {
    m_approval_window_ttl = approval_window_ttl;
    m_approval_window_ttl_isSet = true;
}

bool OAIRealex::is_approval_window_ttl_Set() const{
    return m_approval_window_ttl_isSet;
}

bool OAIRealex::is_approval_window_ttl_Valid() const{
    return m_approval_window_ttl_isValid;
}

QString OAIRealex::getCityField() const {
    return m_city_field;
}
void OAIRealex::setCityField(const QString &city_field) {
    m_city_field = city_field;
    m_city_field_isSet = true;
}

bool OAIRealex::is_city_field_Set() const{
    return m_city_field_isSet;
}

bool OAIRealex::is_city_field_Valid() const{
    return m_city_field_isValid;
}

QDateTime OAIRealex::getCreatedTime() const {
    return m_created_time;
}
void OAIRealex::setCreatedTime(const QDateTime &created_time) {
    m_created_time = created_time;
    m_created_time_isSet = true;
}

bool OAIRealex::is_created_time_Set() const{
    return m_created_time_isSet;
}

bool OAIRealex::is_created_time_Valid() const{
    return m_created_time_isValid;
}

QString OAIRealex::getDccForceCurrency() const {
    return m_dcc_force_currency;
}
void OAIRealex::setDccForceCurrency(const QString &dcc_force_currency) {
    m_dcc_force_currency = dcc_force_currency;
    m_dcc_force_currency_isSet = true;
}

bool OAIRealex::is_dcc_force_currency_Set() const{
    return m_dcc_force_currency_isSet;
}

bool OAIRealex::is_dcc_force_currency_Valid() const{
    return m_dcc_force_currency_isValid;
}

qint32 OAIRealex::getDccMarkup() const {
    return m_dcc_markup;
}
void OAIRealex::setDccMarkup(const qint32 &dcc_markup) {
    m_dcc_markup = dcc_markup;
    m_dcc_markup_isSet = true;
}

bool OAIRealex::is_dcc_markup_Set() const{
    return m_dcc_markup_isSet;
}

bool OAIRealex::is_dcc_markup_Valid() const{
    return m_dcc_markup_isValid;
}

QString OAIRealex::getDescriptor() const {
    return m_descriptor;
}
void OAIRealex::setDescriptor(const QString &descriptor) {
    m_descriptor = descriptor;
    m_descriptor_isSet = true;
}

bool OAIRealex::is_descriptor_Set() const{
    return m_descriptor_isSet;
}

bool OAIRealex::is_descriptor_Valid() const{
    return m_descriptor_isValid;
}

OAIDigitalWallets OAIRealex::getDigitalWallets() const {
    return m_digital_wallets;
}
void OAIRealex::setDigitalWallets(const OAIDigitalWallets &digital_wallets) {
    m_digital_wallets = digital_wallets;
    m_digital_wallets_isSet = true;
}

bool OAIRealex::is_digital_wallets_Set() const{
    return m_digital_wallets_isSet;
}

bool OAIRealex::is_digital_wallets_Valid() const{
    return m_digital_wallets_isValid;
}

bool OAIRealex::isDynamicDescriptor() const {
    return m_dynamic_descriptor;
}
void OAIRealex::setDynamicDescriptor(const bool &dynamic_descriptor) {
    m_dynamic_descriptor = dynamic_descriptor;
    m_dynamic_descriptor_isSet = true;
}

bool OAIRealex::is_dynamic_descriptor_Set() const{
    return m_dynamic_descriptor_isSet;
}

bool OAIRealex::is_dynamic_descriptor_Valid() const{
    return m_dynamic_descriptor_isValid;
}

QList<QString> OAIRealex::getExcludedDccQuoteCurrencies() const {
    return m_excluded_dcc_quote_currencies;
}
void OAIRealex::setExcludedDccQuoteCurrencies(const QList<QString> &excluded_dcc_quote_currencies) {
    m_excluded_dcc_quote_currencies = excluded_dcc_quote_currencies;
    m_excluded_dcc_quote_currencies_isSet = true;
}

bool OAIRealex::is_excluded_dcc_quote_currencies_Set() const{
    return m_excluded_dcc_quote_currencies_isSet;
}

bool OAIRealex::is_excluded_dcc_quote_currencies_Valid() const{
    return m_excluded_dcc_quote_currencies_isValid;
}

OAIGatewayName OAIRealex::getGatewayName() const {
    return m_gateway_name;
}
void OAIRealex::setGatewayName(const OAIGatewayName &gateway_name) {
    m_gateway_name = gateway_name;
    m_gateway_name_isSet = true;
}

bool OAIRealex::is_gateway_name_Set() const{
    return m_gateway_name_isSet;
}

bool OAIRealex::is_gateway_name_Valid() const{
    return m_gateway_name_isValid;
}

QString OAIRealex::getId() const {
    return m_id;
}
void OAIRealex::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIRealex::is_id_Set() const{
    return m_id_isSet;
}

bool OAIRealex::is_id_Valid() const{
    return m_id_isValid;
}

bool OAIRealex::isIsDown() const {
    return m_is_down;
}
void OAIRealex::setIsDown(const bool &is_down) {
    m_is_down = is_down;
    m_is_down_isSet = true;
}

bool OAIRealex::is_is_down_Set() const{
    return m_is_down_isSet;
}

bool OAIRealex::is_is_down_Valid() const{
    return m_is_down_isValid;
}

QString OAIRealex::getMerchantCategoryCode() const {
    return m_merchant_category_code;
}
void OAIRealex::setMerchantCategoryCode(const QString &merchant_category_code) {
    m_merchant_category_code = merchant_category_code;
    m_merchant_category_code_isSet = true;
}

bool OAIRealex::is_merchant_category_code_Set() const{
    return m_merchant_category_code_isSet;
}

bool OAIRealex::is_merchant_category_code_Valid() const{
    return m_merchant_category_code_isValid;
}

OAIPaymentMethod OAIRealex::getMethod() const {
    return m_method;
}
void OAIRealex::setMethod(const OAIPaymentMethod &method) {
    m_method = method;
    m_method_isSet = true;
}

bool OAIRealex::is_method_Set() const{
    return m_method_isSet;
}

bool OAIRealex::is_method_Valid() const{
    return m_method_isValid;
}

double OAIRealex::getMonthlyLimit() const {
    return m_monthly_limit;
}
void OAIRealex::setMonthlyLimit(const double &monthly_limit) {
    m_monthly_limit = monthly_limit;
    m_monthly_limit_isSet = true;
}

bool OAIRealex::is_monthly_limit_Set() const{
    return m_monthly_limit_isSet;
}

bool OAIRealex::is_monthly_limit_Valid() const{
    return m_monthly_limit_isValid;
}

QString OAIRealex::getOrganizationId() const {
    return m_organization_id;
}
void OAIRealex::setOrganizationId(const QString &organization_id) {
    m_organization_id = organization_id;
    m_organization_id_isSet = true;
}

bool OAIRealex::is_organization_id_Set() const{
    return m_organization_id_isSet;
}

bool OAIRealex::is_organization_id_Valid() const{
    return m_organization_id_isValid;
}

QList<OAIPaymentCardBrand> OAIRealex::getPaymentCardSchemes() const {
    return m_payment_card_schemes;
}
void OAIRealex::setPaymentCardSchemes(const QList<OAIPaymentCardBrand> &payment_card_schemes) {
    m_payment_card_schemes = payment_card_schemes;
    m_payment_card_schemes_isSet = true;
}

bool OAIRealex::is_payment_card_schemes_Set() const{
    return m_payment_card_schemes_isSet;
}

bool OAIRealex::is_payment_card_schemes_Valid() const{
    return m_payment_card_schemes_isValid;
}

bool OAIRealex::isReconciliationWindowEnabled() const {
    return m_reconciliation_window_enabled;
}
void OAIRealex::setReconciliationWindowEnabled(const bool &reconciliation_window_enabled) {
    m_reconciliation_window_enabled = reconciliation_window_enabled;
    m_reconciliation_window_enabled_isSet = true;
}

bool OAIRealex::is_reconciliation_window_enabled_Set() const{
    return m_reconciliation_window_enabled_isSet;
}

bool OAIRealex::is_reconciliation_window_enabled_Valid() const{
    return m_reconciliation_window_enabled_isValid;
}

qint32 OAIRealex::getReconciliationWindowTtl() const {
    return m_reconciliation_window_ttl;
}
void OAIRealex::setReconciliationWindowTtl(const qint32 &reconciliation_window_ttl) {
    m_reconciliation_window_ttl = reconciliation_window_ttl;
    m_reconciliation_window_ttl_isSet = true;
}

bool OAIRealex::is_reconciliation_window_ttl_Set() const{
    return m_reconciliation_window_ttl_isSet;
}

bool OAIRealex::is_reconciliation_window_ttl_Valid() const{
    return m_reconciliation_window_ttl_isValid;
}

QString OAIRealex::getStatus() const {
    return m_status;
}
void OAIRealex::setStatus(const QString &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIRealex::is_status_Set() const{
    return m_status_isSet;
}

bool OAIRealex::is_status_Valid() const{
    return m_status_isValid;
}

bool OAIRealex::isSticky() const {
    return m_sticky;
}
void OAIRealex::setSticky(const bool &sticky) {
    m_sticky = sticky;
    m_sticky_isSet = true;
}

bool OAIRealex::is_sticky_Set() const{
    return m_sticky_isSet;
}

bool OAIRealex::is_sticky_Valid() const{
    return m_sticky_isValid;
}

bool OAIRealex::isThreeDSecure() const {
    return m_three_d_secure;
}
void OAIRealex::setThreeDSecure(const bool &three_d_secure) {
    m_three_d_secure = three_d_secure;
    m_three_d_secure_isSet = true;
}

bool OAIRealex::is_three_d_secure_Set() const{
    return m_three_d_secure_isSet;
}

bool OAIRealex::is_three_d_secure_Valid() const{
    return m_three_d_secure_isValid;
}

qint32 OAIRealex::getTimeout() const {
    return m_timeout;
}
void OAIRealex::setTimeout(const qint32 &timeout) {
    m_timeout = timeout;
    m_timeout_isSet = true;
}

bool OAIRealex::is_timeout_Set() const{
    return m_timeout_isSet;
}

bool OAIRealex::is_timeout_Valid() const{
    return m_timeout_isValid;
}

QString OAIRealex::getToken() const {
    return m_token;
}
void OAIRealex::setToken(const QString &token) {
    m_token = token;
    m_token_isSet = true;
}

bool OAIRealex::is_token_Set() const{
    return m_token_isSet;
}

bool OAIRealex::is_token_Valid() const{
    return m_token_isValid;
}

QDateTime OAIRealex::getUpdatedTime() const {
    return m_updated_time;
}
void OAIRealex::setUpdatedTime(const QDateTime &updated_time) {
    m_updated_time = updated_time;
    m_updated_time_isSet = true;
}

bool OAIRealex::is_updated_time_Set() const{
    return m_updated_time_isSet;
}

bool OAIRealex::is_updated_time_Valid() const{
    return m_updated_time_isValid;
}

OAIRealex_allOf_credentials OAIRealex::getCredentials() const {
    return m_credentials;
}
void OAIRealex::setCredentials(const OAIRealex_allOf_credentials &credentials) {
    m_credentials = credentials;
    m_credentials_isSet = true;
}

bool OAIRealex::is_credentials_Set() const{
    return m_credentials_isSet;
}

bool OAIRealex::is_credentials_Valid() const{
    return m_credentials_isValid;
}

bool OAIRealex::isSet() const {
