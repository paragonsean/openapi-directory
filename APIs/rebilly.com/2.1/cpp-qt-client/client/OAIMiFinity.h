...
#ifndef OAIMiFinity_H
#define OAIMiFinity_H
...
class OAIMiFinity_allOf_credentials;

class OAIMiFinity : public OAIObject {
public:
    OAIMiFinity();
    OAIMiFinity(QString json);
    ~OAIMiFinity() override;
    ...
    OAIMiFinity_allOf_credentials getCredentials() const;
    void setCredentials(const OAIMiFinity_allOf_credentials &credentials);
...
private:
    ...
    OAIMiFinity_allOf_credentials m_credentials;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMiFinity)
