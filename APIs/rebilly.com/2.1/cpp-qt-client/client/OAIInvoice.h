...
#include "OAIInvoice_allOf__embedded.h"
#include "OAIInvoice_allOf__links.h"
...
class OAIInvoiceTax;
class OAIInvoice_allOf__embedded;
class OAIInvoice_allOf__links;
class OAIInvoice_allOf_retryInstruction;
...
public:
    ...
    QList<OAIInvoice_allOf__embedded> getEmbedded() const;
    void setEmbedded(const QList<OAIInvoice_allOf__embedded> &_embedded);
    bool is__embedded_Set() const;
    bool is__embedded_Valid() const;

    QList<OAIInvoice_allOf__links> getLinks() const;
    void setLinks(const QList<OAIInvoice_allOf__links> &_links);
    ...
    qint32 getDueReminderNumber() const;
    void setDueReminderNumber(const qint32 &due_reminder_number);
    bool is_due_reminder_number_Set() const;
    bool is_due_reminder_number_Valid() const;

    QDateTime getDueReminderTime() const;
    void setDueReminderTime(const QDateTime &due_reminder_time);
    bool is_due_reminder_time_Set() const;
    bool is_due_reminder_time_Valid() const;

    OAIInvoice_allOf_retryInstruction getRetryInstruction() const;
    void setRetryInstruction(const OAIInvoice_allOf_retryInstruction &retry_instruction);
...
private:
    ...
    QList<OAIInvoice_allOf__embedded> m__embedded;
    bool m__embedded_isSet;
    bool m__embedded_isValid;

    QList<OAIInvoice_allOf__links> m__links;
    bool m__links_isSet;
    ...
    qint32 m_due_reminder_number;
    bool m_due_reminder_number_isSet;
    bool m_due_reminder_number_isValid;

    QDateTime m_due_reminder_time;
    bool m_due_reminder_time_isSet;
    bool m_due_reminder_time_isValid;

    OAIInvoice_allOf_retryInstruction m_retry_instruction;
