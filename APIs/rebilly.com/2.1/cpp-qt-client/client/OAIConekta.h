...
class OAIConekta_allOf_credentials;

class OAIConekta : public OAIObject {
public:
    OAIConekta();
    OAIConekta(QString json);
    ~OAIConekta() override;
    ...
    OAIConekta_allOf_credentials getCredentials() const;
    void setCredentials(const OAIConekta_allOf_credentials &credentials);
...
private:
    ...
    OAIConekta_allOf_credentials m_credentials;
...
Q_DECLARE_METATYPE(OpenAPI::OAIConekta)
