...
/*
 * OAIBankAccountEmbed.h
 *
 * Bank Account object.
 */

#ifndef OAIBankAccountEmbed_H
#define OAIBankAccountEmbed_H
...
class OAIBankAccountEmbed : public OAIObject {
public:
    OAIBankAccountEmbed();
    OAIBankAccountEmbed(QString json);
    ~OAIBankAccountEmbed() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBankAccountEmbed)

#endif // OAIBankAccountEmbed_H
