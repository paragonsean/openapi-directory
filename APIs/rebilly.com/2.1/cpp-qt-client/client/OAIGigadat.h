...
#include "OAIGigadat_allOf_credentials.h"
...
class OAIGigadat_allOf_credentials;
class OAIGigadat_allOf_settings;

class OAIGigadat : public OAIObject {
public:
    OAIGigadat();
    OAIGigadat(QString json);
    ~OAIGigadat() override;
    ...
    OAIGigadat_allOf_credentials getCredentials() const;
    void setCredentials(const OAIGigadat_allOf_credentials &credentials);
...
private:
    ...
    OAIGigadat_allOf_credentials m_credentials;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGigadat)
