...
#ifndef OAIFinTecSystems_H
#define OAIFinTecSystems_H
...
class OAIFinTecSystems_allOf_credentials;
class OAIFinTecSystems_allOf_settings;

class OAIFinTecSystems : public OAIObject {
public:
    OAIFinTecSystems();
    OAIFinTecSystems(QString json);
    ~OAIFinTecSystems() override;
    ...
    OAIFinTecSystems_allOf_credentials getCredentials() const;
    void setCredentials(const OAIFinTecSystems_allOf_credentials &credentials);
    bool is_credentials_Set() const;
    bool is_credentials_Valid() const;

    OAIFinTecSystems_allOf_settings getSettings() const;
    void setSettings(const OAIFinTecSystems_allOf_settings &settings);
...
private:
    ...
    OAIFinTecSystems_allOf_credentials m_credentials;
    bool m_credentials_isSet;
    bool m_credentials_isValid;

    OAIFinTecSystems_allOf_settings m_settings;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFinTecSystems)

#endif // OAIFinTecSystems_H
