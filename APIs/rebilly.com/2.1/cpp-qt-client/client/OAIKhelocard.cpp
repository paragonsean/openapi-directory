...
OAIKhelocard::OAIKhelocard(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIKhelocard::OAIKhelocard() {
    this->initializeModel();
}

OAIKhelocard::~OAIKhelocard() {}

void OAIKhelocard::initializeModel() {
...
void OAIKhelocard::fromJson(QString jsonString) {
...
void OAIKhelocard::fromJsonObject(QJsonObject json) {
...
QString OAIKhelocard::asJson() const {
...
QJsonObject OAIKhelocard::asJsonObject() const {
    QJsonObject obj;
    if (m__links.size() > 0) {
...
QList<OAIGatewayAccount__links_inner> OAIKhelocard::getLinks() const {
    return m__links;
}
void OAIKhelocard::setLinks(const QList<OAIGatewayAccount__links_inner> &_links) {
    m__links = _links;
    m__links_isSet = true;
}

bool OAIKhelocard::is__links_Set() const{
    return m__links_isSet;
}

bool OAIKhelocard::is__links_Valid() const{
    return m__links_isValid;
}

QList<QString> OAIKhelocard::getAcceptedCurrencies() const {
    return m_accepted_currencies;
}
void OAIKhelocard::setAcceptedCurrencies(const QList<QString> &accepted_currencies) {
    m_accepted_currencies = accepted_currencies;
    m_accepted_currencies_isSet = true;
}

bool OAIKhelocard::is_accepted_currencies_Set() const{
    return m_accepted_currencies_isSet;
}

bool OAIKhelocard::is_accepted_currencies_Valid() const{
    return m_accepted_currencies_isValid;
}

OAIAcquirerName OAIKhelocard::getAcquirerName() const {
    return m_acquirer_name;
}
void OAIKhelocard::setAcquirerName(const OAIAcquirerName &acquirer_name) {
    m_acquirer_name = acquirer_name;
    m_acquirer_name_isSet = true;
}

bool OAIKhelocard::is_acquirer_name_Set() const{
    return m_acquirer_name_isSet;
}

bool OAIKhelocard::is_acquirer_name_Valid() const{
    return m_acquirer_name_isValid;
}

QString OAIKhelocard::getAdditionalFilters() const {
    return m_additional_filters;
}
void OAIKhelocard::setAdditionalFilters(const QString &additional_filters) {
    m_additional_filters = additional_filters;
    m_additional_filters_isSet = true;
}

bool OAIKhelocard::is_additional_filters_Set() const{
    return m_additional_filters_isSet;
}

bool OAIKhelocard::is_additional_filters_Valid() const{
    return m_additional_filters_isValid;
}

qint32 OAIKhelocard::getApprovalWindowTtl() const {
    return m_approval_window_ttl;
}
void OAIKhelocard::setApprovalWindowTtl(const qint32 &approval_window_ttl) {
    m_approval_window_ttl = approval_window_ttl;
    m_approval_window_ttl_isSet = true;
}

bool OAIKhelocard::is_approval_window_ttl_Set() const{
    return m_approval_window_ttl_isSet;
}

bool OAIKhelocard::is_approval_window_ttl_Valid() const{
    return m_approval_window_ttl_isValid;
}

QString OAIKhelocard::getCityField() const {
    return m_city_field;
}
void OAIKhelocard::setCityField(const QString &city_field) {
    m_city_field = city_field;
    m_city_field_isSet = true;
}

bool OAIKhelocard::is_city_field_Set() const{
    return m_city_field_isSet;
}

bool OAIKhelocard::is_city_field_Valid() const{
    return m_city_field_isValid;
}

QDateTime OAIKhelocard::getCreatedTime() const {
    return m_created_time;
}
void OAIKhelocard::setCreatedTime(const QDateTime &created_time) {
    m_created_time = created_time;
    m_created_time_isSet = true;
}

bool OAIKhelocard::is_created_time_Set() const{
    return m_created_time_isSet;
}

bool OAIKhelocard::is_created_time_Valid() const{
    return m_created_time_isValid;
}

QString OAIKhelocard::getDccForceCurrency() const {
    return m_dcc_force_currency;
}
void OAIKhelocard::setDccForceCurrency(const QString &dcc_force_currency) {
    m_dcc_force_currency = dcc_force_currency;
    m_dcc_force_currency_isSet = true;
}

bool OAIKhelocard::is_dcc_force_currency_Set() const{
    return m_dcc_force_currency_isSet;
}

bool OAIKhelocard::is_dcc_force_currency_Valid() const{
    return m_dcc_force_currency_isValid;
}

qint32 OAIKhelocard::getDccMarkup() const {
    return m_dcc_markup;
}
void OAIKhelocard::setDccMarkup(const qint32 &dcc_markup) {
    m_dcc_markup = dcc_markup;
    m_dcc_markup_isSet = true;
}

bool OAIKhelocard::is_dcc_markup_Set() const{
    return m_dcc_markup_isSet;
}

bool OAIKhelocard::is_dcc_markup_Valid() const{
    return m_dcc_markup_isValid;
}

QString OAIKhelocard::getDescriptor() const {
    return m_descriptor;
}
void OAIKhelocard::setDescriptor(const QString &descriptor) {
    m_descriptor = descriptor;
    m_descriptor_isSet = true;
}

bool OAIKhelocard::is_descriptor_Set() const{
    return m_descriptor_isSet;
}

bool OAIKhelocard::is_descriptor_Valid() const{
    return m_descriptor_isValid;
}

OAIDigitalWallets OAIKhelocard::getDigitalWallets() const {
    return m_digital_wallets;
}
void OAIKhelocard::setDigitalWallets(const OAIDigitalWallets &digital_wallets) {
    m_digital_wallets = digital_wallets;
    m_digital_wallets_isSet = true;
}

bool OAIKhelocard::is_digital_wallets_Set() const{
    return m_digital_wallets_isSet;
}

bool OAIKhelocard::is_digital_wallets_Valid() const{
    return m_digital_wallets_isValid;
}

bool OAIKhelocard::isDynamicDescriptor() const {
    return m_dynamic_descriptor;
}
void OAIKhelocard::setDynamicDescriptor(const bool &dynamic_descriptor) {
    m_dynamic_descriptor = dynamic_descriptor;
    m_dynamic_descriptor_isSet = true;
}

bool OAIKhelocard::is_dynamic_descriptor_Set() const{
    return m_dynamic_descriptor_isSet;
}

bool OAIKhelocard::is_dynamic_descriptor_Valid() const{
    return m_dynamic_descriptor_isValid;
}

QList<QString> OAIKhelocard::getExcludedDccQuoteCurrencies() const {
    return m_excluded_dcc_quote_currencies;
}
void OAIKhelocard::setExcludedDccQuoteCurrencies(const QList<QString> &excluded_dcc_quote_currencies) {
    m_excluded_dcc_quote_currencies = excluded_dcc_quote_currencies;
    m_excluded_dcc_quote_currencies_isSet = true;
}

bool OAIKhelocard::is_excluded_dcc_quote_currencies_Set() const{
    return m_excluded_dcc_quote_currencies_isSet;
}

bool OAIKhelocard::is_excluded_dcc_quote_currencies_Valid() const{
    return m_excluded_dcc_quote_currencies_isValid;
}

OAIGatewayName OAIKhelocard::getGatewayName() const {
    return m_gateway_name;
}
void OAIKhelocard::setGatewayName(const OAIGatewayName &gateway_name) {
    m_gateway_name = gateway_name;
    m_gateway_name_isSet = true;
}

bool OAIKhelocard::is_gateway_name_Set() const{
    return m_gateway_name_isSet;
}

bool OAIKhelocard::is_gateway_name_Valid() const{
    return m_gateway_name_isValid;
}

QString OAIKhelocard::getId() const {
    return m_id;
}
void OAIKhelocard::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIKhelocard::is_id_Set() const{
    return m_id_isSet;
}

bool OAIKhelocard::is_id_Valid() const{
    return m_id_isValid;
}

bool OAIKhelocard::isIsDown() const {
    return m_is_down;
}
void OAIKhelocard::setIsDown(const bool &is_down) {
    m_is_down = is_down;
    m_is_down_isSet = true;
}

bool OAIKhelocard::is_is_down_Set() const{
    return m_is_down_isSet;
}

bool OAIKhelocard::is_is_down_Valid() const{
    return m_is_down_isValid;
}

QString OAIKhelocard::getMerchantCategoryCode() const {
    return m_merchant_category_code;
}
void OAIKhelocard::setMerchantCategoryCode(const QString &merchant_category_code) {
    m_merchant_category_code = merchant_category_code;
    m_merchant_category_code_isSet = true;
}

bool OAIKhelocard::is_merchant_category_code_Set() const{
    return m_merchant_category_code_isSet;
}

bool OAIKhelocard::is_merchant_category_code_Valid() const{
    return m_merchant_category_code_isValid;
}

OAIPaymentMethod OAIKhelocard::getMethod() const {
    return m_method;
}
void OAIKhelocard::setMethod(const OAIPaymentMethod &method) {
    m_method = method;
    m_method_isSet = true;
}

bool OAIKhelocard::is_method_Set() const{
    return m_method_isSet;
}

bool OAIKhelocard::is_method_Valid() const{
    return m_method_isValid;
}

double OAIKhelocard::getMonthlyLimit() const {
    return m_monthly_limit;
}
void OAIKhelocard::setMonthlyLimit(const double &monthly_limit) {
    m_monthly_limit = monthly_limit;
    m_monthly_limit_isSet = true;
}

bool OAIKhelocard::is_monthly_limit_Set() const{
    return m_monthly_limit_isSet;
}

bool OAIKhelocard::is_monthly_limit_Valid() const{
    return m_monthly_limit_isValid;
}

QString OAIKhelocard::getOrganizationId() const {
    return m_organization_id;
}
void OAIKhelocard::setOrganizationId(const QString &organization_id) {
    m_organization_id = organization_id;
    m_organization_id_isSet = true;
}

bool OAIKhelocard::is_organization_id_Set() const{
    return m_organization_id_isSet;
}

bool OAIKhelocard::is_organization_id_Valid() const{
    return m_organization_id_isValid;
}

QList<OAIPaymentCardBrand> OAIKhelocard::getPaymentCardSchemes() const {
    return m_payment_card_schemes;
}
void OAIKhelocard::setPaymentCardSchemes(const QList<OAIPaymentCardBrand> &payment_card_schemes) {
    m_payment_card_schemes = payment_card_schemes;
    m_payment_card_schemes_isSet = true;
}

bool OAIKhelocard::is_payment_card_schemes_Set() const{
    return m_payment_card_schemes_isSet;
}

bool OAIKhelocard::is_payment_card_schemes_Valid() const{
    return m_payment_card_schemes_isValid;
}

bool OAIKhelocard::isReconciliationWindowEnabled() const {
    return m_reconciliation_window_enabled;
}
void OAIKhelocard::setReconciliationWindowEnabled(const bool &reconciliation_window_enabled) {
    m_reconciliation_window_enabled = reconciliation_window_enabled;
    m_reconciliation_window_enabled_isSet = true;
}

bool OAIKhelocard::is_reconciliation_window_enabled_Set() const{
    return m_reconciliation_window_enabled_isSet;
}

bool OAIKhelocard::is_reconciliation_window_enabled_Valid() const{
    return m_reconciliation_window_enabled_isValid;
}

qint32 OAIKhelocard::getReconciliationWindowTtl() const {
    return m_reconciliation_window_ttl;
}
void OAIKhelocard::setReconciliationWindowTtl(const qint32 &reconciliation_window_ttl) {
    m_reconciliation_window_ttl = reconciliation_window_ttl;
    m_reconciliation_window_ttl_isSet = true;
}

bool OAIKhelocard::is_reconciliation_window_ttl_Set() const{
    return m_reconciliation_window_ttl_isSet;
}

bool OAIKhelocard::is_reconciliation_window_ttl_Valid() const{
    return m_reconciliation_window_ttl_isValid;
}

QString OAIKhelocard::getStatus() const {
    return m_status;
}
void OAIKhelocard::setStatus(const QString &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIKhelocard::is_status_Set() const{
    return m_status_isSet;
}

bool OAIKhelocard::is_status_Valid() const{
    return m_status_isValid;
}

bool OAIKhelocard::isSticky() const {
    return m_sticky;
}
void OAIKhelocard::setSticky(const bool &sticky) {
    m_sticky = sticky;
    m_sticky_isSet = true;
}

bool OAIKhelocard::is_sticky_Set() const{
    return m_sticky_isSet;
}

bool OAIKhelocard::is_sticky_Valid() const{
    return m_sticky_isValid;
}

bool OAIKhelocard::isThreeDSecure() const {
    return m_three_d_secure;
}
void OAIKhelocard::setThreeDSecure(const bool &three_d_secure) {
    m_three_d_secure = three_d_secure;
    m_three_d_secure_isSet = true;
}

bool OAIKhelocard::is_three_d_secure_Set() const{
    return m_three_d_secure_isSet;
}

bool OAIKhelocard::is_three_d_secure_Valid() const{
    return m_three_d_secure_isValid;
}

qint32 OAIKhelocard::getTimeout() const {
    return m_timeout;
}
void OAIKhelocard::setTimeout(const qint32 &timeout) {
    m_timeout = timeout;
    m_timeout_isSet = true;
}

bool OAIKhelocard::is_timeout_Set() const{
    return m_timeout_isSet;
}

bool OAIKhelocard::is_timeout_Valid() const{
    return m_timeout_isValid;
}

QString OAIKhelocard::getToken() const {
    return m_token;
}
void OAIKhelocard::setToken(const QString &token) {
    m_token = token;
    m_token_isSet = true;
}

bool OAIKhelocard::is_token_Set() const{
    return m_token_isSet;
}

bool OAIKhelocard::is_token_Valid() const{
    return m_token_isValid;
}

QDateTime OAIKhelocard::getUpdatedTime() const {
    return m_updated_time;
}
void OAIKhelocard::setUpdatedTime(const QDateTime &updated_time) {
    m_updated_time = updated_time;
    m_updated_time_isSet = true;
}

bool OAIKhelocard::is_updated_time_Set() const{
    return m_updated_time_isSet;
}

bool OAIKhelocard::is_updated_time_Valid() const{
    return m_updated_time_isValid;
}

OAIKhelocard_allOf_credentials OAIKhelocard::getCredentials() const {
    return m_credentials;
}
void OAIKhelocard::setCredentials(const OAIKhelocard_allOf_credentials &credentials) {
    m_credentials = credentials;
    m_credentials_isSet = true;
}

bool OAIKhelocard::is_credentials_Set() const{
    return m_credentials_isSet;
}

bool OAIKhelocard::is_credentials_Valid() const{
    return m_credentials_isValid;
}

bool OAIKhelocard::isSet() const {
...
bool OAIKhelocard::isValid() const {
