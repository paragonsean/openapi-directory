...
OAICashToCode::OAICashToCode(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICashToCode::OAICashToCode() {
    this->initializeModel();
}

OAICashToCode::~OAICashToCode() {}

void OAICashToCode::initializeModel() {
...
void OAICashToCode::fromJson(QString jsonString) {
...
void OAICashToCode::fromJsonObject(QJsonObject json) {
...
QString OAICashToCode::asJson() const {
...
QJsonObject OAICashToCode::asJsonObject() const {
    QJsonObject obj;
    if (m__links.size() > 0) {
...
QList<OAIGatewayAccount__links_inner> OAICashToCode::getLinks() const {
    return m__links;
}
void OAICashToCode::setLinks(const QList<OAIGatewayAccount__links_inner> &_links) {
    m__links = _links;
    m__links_isSet = true;
}

bool OAICashToCode::is__links_Set() const{
    return m__links_isSet;
}

bool OAICashToCode::is__links_Valid() const{
    return m__links_isValid;
}

QList<QString> OAICashToCode::getAcceptedCurrencies() const {
    return m_accepted_currencies;
}
void OAICashToCode::setAcceptedCurrencies(const QList<QString> &accepted_currencies) {
    m_accepted_currencies = accepted_currencies;
    m_accepted_currencies_isSet = true;
}

bool OAICashToCode::is_accepted_currencies_Set() const{
    return m_accepted_currencies_isSet;
}

bool OAICashToCode::is_accepted_currencies_Valid() const{
    return m_accepted_currencies_isValid;
}

OAIAcquirerName OAICashToCode::getAcquirerName() const {
    return m_acquirer_name;
}
void OAICashToCode::setAcquirerName(const OAIAcquirerName &acquirer_name) {
    m_acquirer_name = acquirer_name;
    m_acquirer_name_isSet = true;
}

bool OAICashToCode::is_acquirer_name_Set() const{
    return m_acquirer_name_isSet;
}

bool OAICashToCode::is_acquirer_name_Valid() const{
    return m_acquirer_name_isValid;
}

QString OAICashToCode::getAdditionalFilters() const {
    return m_additional_filters;
}
void OAICashToCode::setAdditionalFilters(const QString &additional_filters) {
    m_additional_filters = additional_filters;
    m_additional_filters_isSet = true;
}

bool OAICashToCode::is_additional_filters_Set() const{
    return m_additional_filters_isSet;
}

bool OAICashToCode::is_additional_filters_Valid() const{
    return m_additional_filters_isValid;
}

qint32 OAICashToCode::getApprovalWindowTtl() const {
    return m_approval_window_ttl;
}
void OAICashToCode::setApprovalWindowTtl(const qint32 &approval_window_ttl) {
    m_approval_window_ttl = approval_window_ttl;
    m_approval_window_ttl_isSet = true;
}

bool OAICashToCode::is_approval_window_ttl_Set() const{
    return m_approval_window_ttl_isSet;
}

bool OAICashToCode::is_approval_window_ttl_Valid() const{
    return m_approval_window_ttl_isValid;
}

QString OAICashToCode::getCityField() const {
    return m_city_field;
}
void OAICashToCode::setCityField(const QString &city_field) {
    m_city_field = city_field;
    m_city_field_isSet = true;
}

bool OAICashToCode::is_city_field_Set() const{
    return m_city_field_isSet;
}

bool OAICashToCode::is_city_field_Valid() const{
    return m_city_field_isValid;
}

QDateTime OAICashToCode::getCreatedTime() const {
    return m_created_time;
}
void OAICashToCode::setCreatedTime(const QDateTime &created_time) {
    m_created_time = created_time;
    m_created_time_isSet = true;
}

bool OAICashToCode::is_created_time_Set() const{
    return m_created_time_isSet;
}

bool OAICashToCode::is_created_time_Valid() const{
    return m_created_time_isValid;
}

QString OAICashToCode::getDccForceCurrency() const {
    return m_dcc_force_currency;
}
void OAICashToCode::setDccForceCurrency(const QString &dcc_force_currency) {
    m_dcc_force_currency = dcc_force_currency;
    m_dcc_force_currency_isSet = true;
}

bool OAICashToCode::is_dcc_force_currency_Set() const{
    return m_dcc_force_currency_isSet;
}

bool OAICashToCode::is_dcc_force_currency_Valid() const{
    return m_dcc_force_currency_isValid;
}

qint32 OAICashToCode::getDccMarkup() const {
    return m_dcc_markup;
}
void OAICashToCode::setDccMarkup(const qint32 &dcc_markup) {
    m_dcc_markup = dcc_markup;
    m_dcc_markup_isSet = true;
}

bool OAICashToCode::is_dcc_markup_Set() const{
    return m_dcc_markup_isSet;
}

bool OAICashToCode::is_dcc_markup_Valid() const{
    return m_dcc_markup_isValid;
}

QString OAICashToCode::getDescriptor() const {
    return m_descriptor;
}
void OAICashToCode::setDescriptor(const QString &descriptor) {
    m_descriptor = descriptor;
    m_descriptor_isSet = true;
}

bool OAICashToCode::is_descriptor_Set() const{
    return m_descriptor_isSet;
}

bool OAICashToCode::is_descriptor_Valid() const{
    return m_descriptor_isValid;
}

OAIDigitalWallets OAICashToCode::getDigitalWallets() const {
    return m_digital_wallets;
}
void OAICashToCode::setDigitalWallets(const OAIDigitalWallets &digital_wallets) {
    m_digital_wallets = digital_wallets;
    m_digital_wallets_isSet = true;
}

bool OAICashToCode::is_digital_wallets_Set() const{
    return m_digital_wallets_isSet;
}

bool OAICashToCode::is_digital_wallets_Valid() const{
    return m_digital_wallets_isValid;
}

bool OAICashToCode::isDynamicDescriptor() const {
    return m_dynamic_descriptor;
}
void OAICashToCode::setDynamicDescriptor(const bool &dynamic_descriptor) {
    m_dynamic_descriptor = dynamic_descriptor;
    m_dynamic_descriptor_isSet = true;
}

bool OAICashToCode::is_dynamic_descriptor_Set() const{
    return m_dynamic_descriptor_isSet;
}

bool OAICashToCode::is_dynamic_descriptor_Valid() const{
    return m_dynamic_descriptor_isValid;
}

QList<QString> OAICashToCode::getExcludedDccQuoteCurrencies() const {
    return m_excluded_dcc_quote_currencies;
}
void OAICashToCode::setExcludedDccQuoteCurrencies(const QList<QString> &excluded_dcc_quote_currencies) {
    m_excluded_dcc_quote_currencies = excluded_dcc_quote_currencies;
    m_excluded_dcc_quote_currencies_isSet = true;
}

bool OAICashToCode::is_excluded_dcc_quote_currencies_Set() const{
    return m_excluded_dcc_quote_currencies_isSet;
}

bool OAICashToCode::is_excluded_dcc_quote_currencies_Valid() const{
    return m_excluded_dcc_quote_currencies_isValid;
}

OAIGatewayName OAICashToCode::getGatewayName() const {
    return m_gateway_name;
}
void OAICashToCode::setGatewayName(const OAIGatewayName &gateway_name) {
    m_gateway_name = gateway_name;
    m_gateway_name_isSet = true;
}

bool OAICashToCode::is_gateway_name_Set() const{
    return m_gateway_name_isSet;
}

bool OAICashToCode::is_gateway_name_Valid() const{
    return m_gateway_name_isValid;
}

QString OAICashToCode::getId() const {
    return m_id;
}
void OAICashToCode::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAICashToCode::is_id_Set() const{
    return m_id_isSet;
}

bool OAICashToCode::is_id_Valid() const{
    return m_id_isValid;
}

bool OAICashToCode::isIsDown() const {
    return m_is_down;
}
void OAICashToCode::setIsDown(const bool &is_down) {
    m_is_down = is_down;
    m_is_down_isSet = true;
}

bool OAICashToCode::is_is_down_Set() const{
    return m_is_down_isSet;
}

bool OAICashToCode::is_is_down_Valid() const{
    return m_is_down_isValid;
}

QString OAICashToCode::getMerchantCategoryCode() const {
    return m_merchant_category_code;
}
void OAICashToCode::setMerchantCategoryCode(const QString &merchant_category_code) {
    m_merchant_category_code = merchant_category_code;
    m_merchant_category_code_isSet = true;
}

bool OAICashToCode::is_merchant_category_code_Set() const{
    return m_merchant_category_code_isSet;
}

bool OAICashToCode::is_merchant_category_code_Valid() const{
    return m_merchant_category_code_isValid;
}

OAIPaymentMethod OAICashToCode::getMethod() const {
    return m_method;
}
void OAICashToCode::setMethod(const OAIPaymentMethod &method) {
    m_method = method;
    m_method_isSet = true;
}

bool OAICashToCode::is_method_Set() const{
    return m_method_isSet;
}

bool OAICashToCode::is_method_Valid() const{
    return m_method_isValid;
}

double OAICashToCode::getMonthlyLimit() const {
    return m_monthly_limit;
}
void OAICashToCode::setMonthlyLimit(const double &monthly_limit) {
    m_monthly_limit = monthly_limit;
    m_monthly_limit_isSet = true;
}

bool OAICashToCode::is_monthly_limit_Set() const{
    return m_monthly_limit_isSet;
}

bool OAICashToCode::is_monthly_limit_Valid() const{
    return m_monthly_limit_isValid;
}

QString OAICashToCode::getOrganizationId() const {
    return m_organization_id;
}
void OAICashToCode::setOrganizationId(const QString &organization_id) {
    m_organization_id = organization_id;
    m_organization_id_isSet = true;
}

bool OAICashToCode::is_organization_id_Set() const{
    return m_organization_id_isSet;
}

bool OAICashToCode::is_organization_id_Valid() const{
    return m_organization_id_isValid;
}

QList<OAIPaymentCardBrand> OAICashToCode::getPaymentCardSchemes() const {
    return m_payment_card_schemes;
}
void OAICashToCode::setPaymentCardSchemes(const QList<OAIPaymentCardBrand> &payment_card_schemes) {
    m_payment_card_schemes = payment_card_schemes;
    m_payment_card_schemes_isSet = true;
}

bool OAICashToCode::is_payment_card_schemes_Set() const{
    return m_payment_card_schemes_isSet;
}

bool OAICashToCode::is_payment_card_schemes_Valid() const{
    return m_payment_card_schemes_isValid;
}

bool OAICashToCode::isReconciliationWindowEnabled() const {
    return m_reconciliation_window_enabled;
}
void OAICashToCode::setReconciliationWindowEnabled(const bool &reconciliation_window_enabled) {
    m_reconciliation_window_enabled = reconciliation_window_enabled;
    m_reconciliation_window_enabled_isSet = true;
}

bool OAICashToCode::is_reconciliation_window_enabled_Set() const{
    return m_reconciliation_window_enabled_isSet;
}

bool OAICashToCode::is_reconciliation_window_enabled_Valid() const{
    return m_reconciliation_window_enabled_isValid;
}

qint32 OAICashToCode::getReconciliationWindowTtl() const {
    return m_reconciliation_window_ttl;
}
void OAICashToCode::setReconciliationWindowTtl(const qint32 &reconciliation_window_ttl) {
    m_reconciliation_window_ttl = reconciliation_window_ttl;
    m_reconciliation_window_ttl_isSet = true;
}

bool OAICashToCode::is_reconciliation_window_ttl_Set() const{
    return m_reconciliation_window_ttl_isSet;
}

bool OAICashToCode::is_reconciliation_window_ttl_Valid() const{
    return m_reconciliation_window_ttl_isValid;
}

QString OAICashToCode::getStatus() const {
    return m_status;
}
void OAICashToCode::setStatus(const QString &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAICashToCode::is_status_Set() const{
    return m_status_isSet;
}

bool OAICashToCode::is_status_Valid() const{
    return m_status_isValid;
}

bool OAICashToCode::isSticky() const {
    return m_sticky;
}
void OAICashToCode::setSticky(const bool &sticky) {
    m_sticky = sticky;
    m_sticky_isSet = true;
}

bool OAICashToCode::is_sticky_Set() const{
    return m_sticky_isSet;
}

bool OAICashToCode::is_sticky_Valid() const{
    return m_sticky_isValid;
}

bool OAICashToCode::isThreeDSecure() const {
    return m_three_d_secure;
}
void OAICashToCode::setThreeDSecure(const bool &three_d_secure) {
    m_three_d_secure = three_d_secure;
    m_three_d_secure_isSet = true;
}

bool OAICashToCode::is_three_d_secure_Set() const{
    return m_three_d_secure_isSet;
}

bool OAICashToCode::is_three_d_secure_Valid() const{
    return m_three_d_secure_isValid;
}

qint32 OAICashToCode::getTimeout() const {
    return m_timeout;
}
void OAICashToCode::setTimeout(const qint32 &timeout) {
    m_timeout = timeout;
    m_timeout_isSet = true;
}

bool OAICashToCode::is_timeout_Set() const{
    return m_timeout_isSet;
}

bool OAICashToCode::is_timeout_Valid() const{
    return m_timeout_isValid;
}

QString OAICashToCode::getToken() const {
    return m_token;
}
void OAICashToCode::setToken(const QString &token) {
    m_token = token;
    m_token_isSet = true;
}

bool OAICashToCode::is_token_Set() const{
    return m_token_isSet;
}

bool OAICashToCode::is_token_Valid() const{
    return m_token_isValid;
}

QDateTime OAICashToCode::getUpdatedTime() const {
    return m_updated_time;
}
void OAICashToCode::setUpdatedTime(const QDateTime &updated_time) {
    m_updated_time = updated_time;
    m_updated_time_isSet = true;
}

bool OAICashToCode::is_updated_time_Set() const{
    return m_updated_time_isSet;
}

bool OAICashToCode::is_updated_time_Valid() const{
    return m_updated_time_isValid;
}

OAICashToCode_allOf_credentials OAICashToCode::getCredentials() const {
    return m_credentials;
}
void OAICashToCode::setCredentials(const OAICashToCode_allOf_credentials &credentials) {
    m_credentials = credentials;
    m_credentials_isSet = true;
}

bool OAICashToCode::is_credentials_Set() const{
    return m_credentials_isSet;
}

bool OAICashToCode::is_credentials_Valid() const{
    return m_credentials_isValid;
}

OAICashToCode_allOf_settings OAICashToCode::getSettings() const {
    return m_settings;
}
void OAICashToCode::setSettings(const OAICashToCode_allOf_settings &settings) {
    m_settings = settings;
    m_settings_isSet = true;
}

bool OAICashToCode::is_settings_Set() const{
    return m_settings_isSet;
}

bool OAICashToCode::is_settings_Valid() const{
    return m_settings_isValid;
}

bool OAICashToCode::isSet() const {
...
bool OAICashToCode::isValid() const {
