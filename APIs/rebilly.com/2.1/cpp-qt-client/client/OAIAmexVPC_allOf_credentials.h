...
/*
 * OAIAmexVPC_allOf_credentials.h
 *
 * AmexVPC credentials object.
 */

#ifndef OAIAmexVPC_allOf_credentials_H
#define OAIAmexVPC_allOf_credentials_H
...
class OAIAmexVPC_allOf_credentials : public OAIObject {
public:
    OAIAmexVPC_allOf_credentials();
    OAIAmexVPC_allOf_credentials(QString json);
    ~OAIAmexVPC_allOf_credentials() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAmexVPC_allOf_credentials)

#endif // OAIAmexVPC_allOf_credentials_H
