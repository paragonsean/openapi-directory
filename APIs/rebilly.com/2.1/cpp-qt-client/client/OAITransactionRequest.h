...
public:
    ...
    OAIPaymentInstruction getPaymentInstruction() const;
    void setPaymentInstruction(const OAIPaymentInstruction &payment_instruction);
    bool is_payment_instruction_Set() const;
    bool is_payment_instruction_Valid() const;

    Q_DECL_DEPRECATED OAIPaymentInstrument getPaymentInstrument() const;
    Q_DECL_DEPRECATED void setPaymentInstrument(const OAIPaymentInstrument &payment_instrument);
    Q_DECL_DEPRECATED bool is_payment_instrument_Set() const;
    Q_DECL_DEPRECATED bool is_payment_instrument_Valid() const;
...
private:
    ...
    OAIPaymentInstruction m_payment_instruction;
