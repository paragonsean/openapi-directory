...
#include "OAIPaymero_allOf_credentials.h"
#include "OAIPaymero_allOf_settings.h"
#include <QDateTime>
#include <QList>
#include <QString>
...
class OAIPaymero_allOf_credentials;
class OAIPaymero_allOf_settings;

class OAIPaymero : public OAIObject {
public:
    OAIPaymero();
    OAIPaymero(QString json);
    ~OAIPaymero() override;
    ...
    OAIPaymero_allOf_credentials getCredentials() const;
    void setCredentials(const OAIPaymero_allOf_credentials &credentials);
    bool is_credentials_Set() const;
    bool is_credentials_Valid() const;

    OAIPaymero_allOf_settings getSettings() const;
    void setSettings(const OAIPaymero_allOf_settings &settings);
...
private:
    ...
    OAIPaymero_allOf_credentials m_credentials;
    bool m_credentials_isSet;
    bool m_credentials_isValid;

    OAIPaymero_allOf_settings m_settings;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPaymero)
