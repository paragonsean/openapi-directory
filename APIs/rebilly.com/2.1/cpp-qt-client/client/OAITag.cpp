...
QList<OAICommonKycDocument__links_inner> OAITag::getLinks() const {
    return m__links;
}
void OAITag::setLinks(const QList<OAICommonKycDocument__links_inner> &_links) {
    m__links = _links;
    m__links_isSet = true;
}

bool OAITag::is__links_Set() const{
    return m__links_isSet;
}

bool OAITag::is__links_Valid() const{
    return m__links_isValid;
}

QDateTime OAITag::getCreatedTime() const {
    return m_created_time;
}
void OAITag::setCreatedTime(const QDateTime &created_time) {
    m_created_time = created_time;
    m_created_time_isSet = true;
}

bool OAITag::is_created_time_Set() const{
    return m_created_time_isSet;
}

bool OAITag::is_created_time_Valid() const{
...
QDateTime OAITag::getUpdatedTime() const {
    return m_updated_time;
}
void OAITag::setUpdatedTime(const QDateTime &updated_time) {
    m_updated_time = updated_time;
    m_updated_time_isSet = true;
}

bool OAITag::is_updated_time_Set() const{
    return m_updated_time_isSet;
}

bool OAITag::is_updated_time_Valid() const{
