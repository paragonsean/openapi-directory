...
#ifndef OAIFundSend_H
#define OAIFundSend_H

#include <QJsonObject>

#include "OAIAcquirerName.h"
#include "OAIDigitalWallets.h"
#include "OAIFundSend_allOf_credentials.h"
...
class OAIFundSend_allOf_credentials;

class OAIFundSend : public OAIObject {
public:
    OAIFundSend();
    OAIFundSend(QString json);
    ~OAIFundSend() override;
    ...
    OAIFundSend_allOf_credentials getCredentials() const;
    void setCredentials(const OAIFundSend_allOf_credentials &credentials);
...
private:
    ...
    OAIFundSend_allOf_credentials m_credentials;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFundSend)
