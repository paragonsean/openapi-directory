...
/*
 * OAIApcoPay_allOf_credentials.h
 *
 * ApcoPay credentials object.
 */

#ifndef OAIApcoPay_allOf_credentials_H
#define OAIApcoPay_allOf_credentials_H
...
class OAIApcoPay_allOf_credentials : public OAIObject {
public:
    OAIApcoPay_allOf_credentials();
    OAIApcoPay_allOf_credentials(QString json);
    ~OAIApcoPay_allOf_credentials() override;
    ...
    QString getMerchantPassword() const;
    void setMerchantPassword(const QString &merchant_password);
    bool is_merchant_password_Set() const;
    bool is_merchant_password_Valid() const;
...
private:
    ...
    QString m_merchant_password;
    bool m_merchant_password_isSet;
    bool m_merchant_password_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIApcoPay_allOf_credentials)

#endif // OAIApcoPay_allOf_credentials_H
