...
#include "OAIEcoPayz_allOf_credentials.h"
#include "OAIEcoPayz_allOf_settings.h"
...
class OAIEcoPayz_allOf_credentials;
class OAIEcoPayz_allOf_settings;

class OAIEcoPayz : public OAIObject {
public:
    OAIEcoPayz();
    OAIEcoPayz(QString json);
    ~OAIEcoPayz() override;
    ...
    OAIEcoPayz_allOf_credentials getCredentials() const;
    void setCredentials(const OAIEcoPayz_allOf_credentials &credentials);
    bool is_credentials_Set() const;
    bool is_credentials_Valid() const;

    OAIEcoPayz_allOf_settings getSettings() const;
    void setSettings(const OAIEcoPayz_allOf_settings &settings);
...
private:
    ...
    OAIEcoPayz_allOf_credentials m_credentials;
    bool m_credentials_isSet;
    bool m_credentials_isValid;

    OAIEcoPayz_allOf_settings m_settings;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEcoPayz)
