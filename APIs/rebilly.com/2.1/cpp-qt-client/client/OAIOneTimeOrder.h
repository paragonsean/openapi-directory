...
#ifndef OAIOneTimeOrder_H
#define OAIOneTimeOrder_H
...
class OAIOneTimeOrder : public OAIObject {
public:
    OAIOneTimeOrder();
    OAIOneTimeOrder(QString json);
    ~OAIOneTimeOrder() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIOneTimeOrder)

#endif // OAIOneTimeOrder_H
