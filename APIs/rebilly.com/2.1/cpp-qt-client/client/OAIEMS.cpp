...
void OAIEMS::fromJson(QString jsonString) {
...
void OAIEMS::fromJsonObject(QJsonObject json) {
...
QJsonObject OAIEMS::asJsonObject() const {
    QJsonObject obj;
    if (m__links.size() > 0) {
...
QList<OAIGatewayAccount__links_inner> OAIEMS::getLinks() const {
    return m__links;
}
void OAIEMS::setLinks(const QList<OAIGatewayAccount__links_inner> &_links) {
    m__links = _links;
    m__links_isSet = true;
}

bool OAIEMS::is__links_Set() const{
    return m__links_isSet;
}

bool OAIEMS::is__links_Valid() const{
    return m__links_isValid;
}

QList<QString> OAIEMS::getAcceptedCurrencies() const {
    return m_accepted_currencies;
}
void OAIEMS::setAcceptedCurrencies(const QList<QString> &accepted_currencies) {
    m_accepted_currencies = accepted_currencies;
    m_accepted_currencies_isSet = true;
}

bool OAIEMS::is_accepted_currencies_Set() const{
    return m_accepted_currencies_isSet;
}

bool OAIEMS::is_accepted_currencies_Valid() const{
    return m_accepted_currencies_isValid;
}

OAIAcquirerName OAIEMS::getAcquirerName() const {
    return m_acquirer_name;
}
void OAIEMS::setAcquirerName(const OAIAcquirerName &acquirer_name) {
    m_acquirer_name = acquirer_name;
    m_acquirer_name_isSet = true;
}

bool OAIEMS::is_acquirer_name_Set() const{
    return m_acquirer_name_isSet;
}

bool OAIEMS::is_acquirer_name_Valid() const{
    return m_acquirer_name_isValid;
}

QString OAIEMS::getAdditionalFilters() const {
    return m_additional_filters;
}
void OAIEMS::setAdditionalFilters(const QString &additional_filters) {
    m_additional_filters = additional_filters;
    m_additional_filters_isSet = true;
}

bool OAIEMS::is_additional_filters_Set() const{
    return m_additional_filters_isSet;
}

bool OAIEMS::is_additional_filters_Valid() const{
    return m_additional_filters_isValid;
}

qint32 OAIEMS::getApprovalWindowTtl() const {
    return m_approval_window_ttl;
}
void OAIEMS::setApprovalWindowTtl(const qint32 &approval_window_ttl) {
    m_approval_window_ttl = approval_window_ttl;
    m_approval_window_ttl_isSet = true;
}

bool OAIEMS::is_approval_window_ttl_Set() const{
    return m_approval_window_ttl_isSet;
}

bool OAIEMS::is_approval_window_ttl_Valid() const{
    return m_approval_window_ttl_isValid;
}

QString OAIEMS::getCityField() const {
    return m_city_field;
}
void OAIEMS::setCityField(const QString &city_field) {
    m_city_field = city_field;
    m_city_field_isSet = true;
}

bool OAIEMS::is_city_field_Set() const{
    return m_city_field_isSet;
}

bool OAIEMS::is_city_field_Valid() const{
    return m_city_field_isValid;
}

QDateTime OAIEMS::getCreatedTime() const {
    return m_created_time;
}
void OAIEMS::setCreatedTime(const QDateTime &created_time) {
    m_created_time = created_time;
    m_created_time_isSet = true;
}

bool OAIEMS::is_created_time_Set() const{
    return m_created_time_isSet;
}

bool OAIEMS::is_created_time_Valid() const{
    return m_created_time_isValid;
}

QString OAIEMS::getDccForceCurrency() const {
    return m_dcc_force_currency;
}
void OAIEMS::setDccForceCurrency(const QString &dcc_force_currency) {
    m_dcc_force_currency = dcc_force_currency;
    m_dcc_force_currency_isSet = true;
}

bool OAIEMS::is_dcc_force_currency_Set() const{
    return m_dcc_force_currency_isSet;
}

bool OAIEMS::is_dcc_force_currency_Valid() const{
    return m_dcc_force_currency_isValid;
}

qint32 OAIEMS::getDccMarkup() const {
    return m_dcc_markup;
}
void OAIEMS::setDccMarkup(const qint32 &dcc_markup) {
    m_dcc_markup = dcc_markup;
    m_dcc_markup_isSet = true;
}

bool OAIEMS::is_dcc_markup_Set() const{
    return m_dcc_markup_isSet;
}

bool OAIEMS::is_dcc_markup_Valid() const{
    return m_dcc_markup_isValid;
}

QString OAIEMS::getDescriptor() const {
    return m_descriptor;
}
void OAIEMS::setDescriptor(const QString &descriptor) {
    m_descriptor = descriptor;
    m_descriptor_isSet = true;
}

bool OAIEMS::is_descriptor_Set() const{
    return m_descriptor_isSet;
}

bool OAIEMS::is_descriptor_Valid() const{
    return m_descriptor_isValid;
}

OAIDigitalWallets OAIEMS::getDigitalWallets() const {
    return m_digital_wallets;
}
void OAIEMS::setDigitalWallets(const OAIDigitalWallets &digital_wallets) {
    m_digital_wallets = digital_wallets;
    m_digital_wallets_isSet = true;
}

bool OAIEMS::is_digital_wallets_Set() const{
    return m_digital_wallets_isSet;
}

bool OAIEMS::is_digital_wallets_Valid() const{
    return m_digital_wallets_isValid;
}

bool OAIEMS::isDynamicDescriptor() const {
    return m_dynamic_descriptor;
}
void OAIEMS::setDynamicDescriptor(const bool &dynamic_descriptor) {
    m_dynamic_descriptor = dynamic_descriptor;
    m_dynamic_descriptor_isSet = true;
}

bool OAIEMS::is_dynamic_descriptor_Set() const{
    return m_dynamic_descriptor_isSet;
}

bool OAIEMS::is_dynamic_descriptor_Valid() const{
    return m_dynamic_descriptor_isValid;
}

QList<QString> OAIEMS::getExcludedDccQuoteCurrencies() const {
    return m_excluded_dcc_quote_currencies;
}
void OAIEMS::setExcludedDccQuoteCurrencies(const QList<QString> &excluded_dcc_quote_currencies) {
    m_excluded_dcc_quote_currencies = excluded_dcc_quote_currencies;
    m_excluded_dcc_quote_currencies_isSet = true;
}

bool OAIEMS::is_excluded_dcc_quote_currencies_Set() const{
    return m_excluded_dcc_quote_currencies_isSet;
}

bool OAIEMS::is_excluded_dcc_quote_currencies_Valid() const{
    return m_excluded_dcc_quote_currencies_isValid;
}

OAIGatewayName OAIEMS::getGatewayName() const {
    return m_gateway_name;
}
void OAIEMS::setGatewayName(const OAIGatewayName &gateway_name) {
    m_gateway_name = gateway_name;
    m_gateway_name_isSet = true;
}

bool OAIEMS::is_gateway_name_Set() const{
    return m_gateway_name_isSet;
}

bool OAIEMS::is_gateway_name_Valid() const{
    return m_gateway_name_isValid;
}

QString OAIEMS::getId() const {
    return m_id;
}
void OAIEMS::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIEMS::is_id_Set() const{
    return m_id_isSet;
}

bool OAIEMS::is_id_Valid() const{
    return m_id_isValid;
}

bool OAIEMS::isIsDown() const {
    return m_is_down;
}
void OAIEMS::setIsDown(const bool &is_down) {
    m_is_down = is_down;
    m_is_down_isSet = true;
}

bool OAIEMS::is_is_down_Set() const{
    return m_is_down_isSet;
}

bool OAIEMS::is_is_down_Valid() const{
    return m_is_down_isValid;
}

QString OAIEMS::getMerchantCategoryCode() const {
    return m_merchant_category_code;
}
void OAIEMS::setMerchantCategoryCode(const QString &merchant_category_code) {
    m_merchant_category_code = merchant_category_code;
    m_merchant_category_code_isSet = true;
}

bool OAIEMS::is_merchant_category_code_Set() const{
    return m_merchant_category_code_isSet;
}

bool OAIEMS::is_merchant_category_code_Valid() const{
    return m_merchant_category_code_isValid;
}

OAIPaymentMethod OAIEMS::getMethod() const {
    return m_method;
}
void OAIEMS::setMethod(const OAIPaymentMethod &method) {
    m_method = method;
    m_method_isSet = true;
}

bool OAIEMS::is_method_Set() const{
    return m_method_isSet;
}

bool OAIEMS::is_method_Valid() const{
    return m_method_isValid;
}

double OAIEMS::getMonthlyLimit() const {
    return m_monthly_limit;
}
void OAIEMS::setMonthlyLimit(const double &monthly_limit) {
    m_monthly_limit = monthly_limit;
    m_monthly_limit_isSet = true;
}

bool OAIEMS::is_monthly_limit_Set() const{
    return m_monthly_limit_isSet;
}

bool OAIEMS::is_monthly_limit_Valid() const{
    return m_monthly_limit_isValid;
}

QString OAIEMS::getOrganizationId() const {
    return m_organization_id;
}
void OAIEMS::setOrganizationId(const QString &organization_id) {
    m_organization_id = organization_id;
    m_organization_id_isSet = true;
}

bool OAIEMS::is_organization_id_Set() const{
    return m_organization_id_isSet;
}

bool OAIEMS::is_organization_id_Valid() const{
    return m_organization_id_isValid;
}

QList<OAIPaymentCardBrand> OAIEMS::getPaymentCardSchemes() const {
    return m_payment_card_schemes;
}
void OAIEMS::setPaymentCardSchemes(const QList<OAIPaymentCardBrand> &payment_card_schemes) {
    m_payment_card_schemes = payment_card_schemes;
    m_payment_card_schemes_isSet = true;
}

bool OAIEMS::is_payment_card_schemes_Set() const{
    return m_payment_card_schemes_isSet;
}

bool OAIEMS::is_payment_card_schemes_Valid() const{
    return m_payment_card_schemes_isValid;
}

bool OAIEMS::isReconciliationWindowEnabled() const {
    return m_reconciliation_window_enabled;
}
void OAIEMS::setReconciliationWindowEnabled(const bool &reconciliation_window_enabled) {
    m_reconciliation_window_enabled = reconciliation_window_enabled;
    m_reconciliation_window_enabled_isSet = true;
}

bool OAIEMS::is_reconciliation_window_enabled_Set() const{
    return m_reconciliation_window_enabled_isSet;
}

bool OAIEMS::is_reconciliation_window_enabled_Valid() const{
    return m_reconciliation_window_enabled_isValid;
}

qint32 OAIEMS::getReconciliationWindowTtl() const {
    return m_reconciliation_window_ttl;
}
void OAIEMS::setReconciliationWindowTtl(const qint32 &reconciliation_window_ttl) {
    m_reconciliation_window_ttl = reconciliation_window_ttl;
    m_reconciliation_window_ttl_isSet = true;
}

bool OAIEMS::is_reconciliation_window_ttl_Set() const{
    return m_reconciliation_window_ttl_isSet;
}

bool OAIEMS::is_reconciliation_window_ttl_Valid() const{
    return m_reconciliation_window_ttl_isValid;
}

QString OAIEMS::getStatus() const {
    return m_status;
}
void OAIEMS::setStatus(const QString &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIEMS::is_status_Set() const{
    return m_status_isSet;
}

bool OAIEMS::is_status_Valid() const{
    return m_status_isValid;
}

bool OAIEMS::isSticky() const {
    return m_sticky;
}
void OAIEMS::setSticky(const bool &sticky) {
    m_sticky = sticky;
    m_sticky_isSet = true;
}

bool OAIEMS::is_sticky_Set() const{
    return m_sticky_isSet;
}

bool OAIEMS::is_sticky_Valid() const{
    return m_sticky_isValid;
}

bool OAIEMS::isThreeDSecure() const {
    return m_three_d_secure;
}
void OAIEMS::setThreeDSecure(const bool &three_d_secure) {
    m_three_d_secure = three_d_secure;
    m_three_d_secure_isSet = true;
}

bool OAIEMS::is_three_d_secure_Set() const{
    return m_three_d_secure_isSet;
}

bool OAIEMS::is_three_d_secure_Valid() const{
    return m_three_d_secure_isValid;
}

qint32 OAIEMS::getTimeout() const {
    return m_timeout;
}
void OAIEMS::setTimeout(const qint32 &timeout) {
    m_timeout = timeout;
    m_timeout_isSet = true;
}

bool OAIEMS::is_timeout_Set() const{
    return m_timeout_isSet;
}

bool OAIEMS::is_timeout_Valid() const{
    return m_timeout_isValid;
}

QString OAIEMS::getToken() const {
    return m_token;
}
void OAIEMS::setToken(const QString &token) {
    m_token = token;
    m_token_isSet = true;
}

bool OAIEMS::is_token_Set() const{
    return m_token_isSet;
}

bool OAIEMS::is_token_Valid() const{
    return m_token_isValid;
}

QDateTime OAIEMS::getUpdatedTime() const {
    return m_updated_time;
}
void OAIEMS::setUpdatedTime(const QDateTime &updated_time) {
    m_updated_time = updated_time;
    m_updated_time_isSet = true;
}

bool OAIEMS::is_updated_time_Set() const{
    return m_updated_time_isSet;
}

bool OAIEMS::is_updated_time_Valid() const{
    return m_updated_time_isValid;
}

OAIEMS_allOf_credentials OAIEMS::getCredentials() const {
    return m_credentials;
}
void OAIEMS::setCredentials(const OAIEMS_allOf_credentials &credentials) {
    m_credentials = credentials;
    m_credentials_isSet = true;
}

bool OAIEMS::is_credentials_Set() const{
    return m_credentials_isSet;
}

bool OAIEMS::is_credentials_Valid() const{
    return m_credentials_isValid;
}

OAIEMS_allOf_settings OAIEMS::getSettings() const {
    return m_settings;
}
void OAIEMS::setSettings(const OAIEMS_allOf_settings &settings) {
    m_settings = settings;
    m_settings_isSet = true;
}

bool OAIEMS::is_settings_Set() const{
    return m_settings_isSet;
}

bool OAIEMS::is_settings_Valid() const{
    return m_settings_isValid;
}

OAIEMS3dsServers OAIEMS::getThreeDSecureServer() const {
    return m_three_d_secure_server;
}
void OAIEMS::setThreeDSecureServer(const OAIEMS3dsServers &three_d_secure_server) {
    m_three_d_secure_server = three_d_secure_server;
    m_three_d_secure_server_isSet = true;
}

bool OAIEMS::is_three_d_secure_server_Set() const{
    return m_three_d_secure_server_isSet;
}

bool OAIEMS::is_three_d_secure_server_Valid() const{
    return m_three_d_secure_server_isValid;
}

bool OAIEMS::isSet() const {
