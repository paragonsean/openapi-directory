...
OAIPanamerican::OAIPanamerican(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPanamerican::OAIPanamerican() {
    this->initializeModel();
}

OAIPanamerican::~OAIPanamerican() {}

void OAIPanamerican::initializeModel() {
...
void OAIPanamerican::fromJson(QString jsonString) {
...
void OAIPanamerican::fromJsonObject(QJsonObject json) {
...
QString OAIPanamerican::asJson() const {
...
QJsonObject OAIPanamerican::asJsonObject() const {
    QJsonObject obj;
    if (m__links.size() > 0) {
...
QList<OAIGatewayAccount__links_inner> OAIPanamerican::getLinks() const {
    return m__links;
}
void OAIPanamerican::setLinks(const QList<OAIGatewayAccount__links_inner> &_links) {
    m__links = _links;
    m__links_isSet = true;
}

bool OAIPanamerican::is__links_Set() const{
    return m__links_isSet;
}

bool OAIPanamerican::is__links_Valid() const{
    return m__links_isValid;
}

QList<QString> OAIPanamerican::getAcceptedCurrencies() const {
    return m_accepted_currencies;
}
void OAIPanamerican::setAcceptedCurrencies(const QList<QString> &accepted_currencies) {
    m_accepted_currencies = accepted_currencies;
    m_accepted_currencies_isSet = true;
}

bool OAIPanamerican::is_accepted_currencies_Set() const{
    return m_accepted_currencies_isSet;
}

bool OAIPanamerican::is_accepted_currencies_Valid() const{
    return m_accepted_currencies_isValid;
}

OAIAcquirerName OAIPanamerican::getAcquirerName() const {
    return m_acquirer_name;
}
void OAIPanamerican::setAcquirerName(const OAIAcquirerName &acquirer_name) {
    m_acquirer_name = acquirer_name;
    m_acquirer_name_isSet = true;
}

bool OAIPanamerican::is_acquirer_name_Set() const{
    return m_acquirer_name_isSet;
}

bool OAIPanamerican::is_acquirer_name_Valid() const{
    return m_acquirer_name_isValid;
}

QString OAIPanamerican::getAdditionalFilters() const {
    return m_additional_filters;
}
void OAIPanamerican::setAdditionalFilters(const QString &additional_filters) {
    m_additional_filters = additional_filters;
    m_additional_filters_isSet = true;
}

bool OAIPanamerican::is_additional_filters_Set() const{
    return m_additional_filters_isSet;
}

bool OAIPanamerican::is_additional_filters_Valid() const{
    return m_additional_filters_isValid;
}

qint32 OAIPanamerican::getApprovalWindowTtl() const {
    return m_approval_window_ttl;
}
void OAIPanamerican::setApprovalWindowTtl(const qint32 &approval_window_ttl) {
    m_approval_window_ttl = approval_window_ttl;
    m_approval_window_ttl_isSet = true;
}

bool OAIPanamerican::is_approval_window_ttl_Set() const{
    return m_approval_window_ttl_isSet;
}

bool OAIPanamerican::is_approval_window_ttl_Valid() const{
    return m_approval_window_ttl_isValid;
}

QString OAIPanamerican::getCityField() const {
    return m_city_field;
}
void OAIPanamerican::setCityField(const QString &city_field) {
    m_city_field = city_field;
    m_city_field_isSet = true;
}

bool OAIPanamerican::is_city_field_Set() const{
    return m_city_field_isSet;
}

bool OAIPanamerican::is_city_field_Valid() const{
    return m_city_field_isValid;
}

QDateTime OAIPanamerican::getCreatedTime() const {
    return m_created_time;
}
void OAIPanamerican::setCreatedTime(const QDateTime &created_time) {
    m_created_time = created_time;
    m_created_time_isSet = true;
}

bool OAIPanamerican::is_created_time_Set() const{
    return m_created_time_isSet;
}

bool OAIPanamerican::is_created_time_Valid() const{
    return m_created_time_isValid;
}

QString OAIPanamerican::getDccForceCurrency() const {
    return m_dcc_force_currency;
}
void OAIPanamerican::setDccForceCurrency(const QString &dcc_force_currency) {
    m_dcc_force_currency = dcc_force_currency;
    m_dcc_force_currency_isSet = true;
}

bool OAIPanamerican::is_dcc_force_currency_Set() const{
    return m_dcc_force_currency_isSet;
}

bool OAIPanamerican::is_dcc_force_currency_Valid() const{
    return m_dcc_force_currency_isValid;
}

qint32 OAIPanamerican::getDccMarkup() const {
    return m_dcc_markup;
}
void OAIPanamerican::setDccMarkup(const qint32 &dcc_markup) {
    m_dcc_markup = dcc_markup;
    m_dcc_markup_isSet = true;
}

bool OAIPanamerican::is_dcc_markup_Set() const{
    return m_dcc_markup_isSet;
}

bool OAIPanamerican::is_dcc_markup_Valid() const{
    return m_dcc_markup_isValid;
}

QString OAIPanamerican::getDescriptor() const {
    return m_descriptor;
}
void OAIPanamerican::setDescriptor(const QString &descriptor) {
    m_descriptor = descriptor;
    m_descriptor_isSet = true;
}

bool OAIPanamerican::is_descriptor_Set() const{
    return m_descriptor_isSet;
}

bool OAIPanamerican::is_descriptor_Valid() const{
    return m_descriptor_isValid;
}

OAIDigitalWallets OAIPanamerican::getDigitalWallets() const {
    return m_digital_wallets;
}
void OAIPanamerican::setDigitalWallets(const OAIDigitalWallets &digital_wallets) {
    m_digital_wallets = digital_wallets;
    m_digital_wallets_isSet = true;
}

bool OAIPanamerican::is_digital_wallets_Set() const{
    return m_digital_wallets_isSet;
}

bool OAIPanamerican::is_digital_wallets_Valid() const{
    return m_digital_wallets_isValid;
}

bool OAIPanamerican::isDynamicDescriptor() const {
    return m_dynamic_descriptor;
}
void OAIPanamerican::setDynamicDescriptor(const bool &dynamic_descriptor) {
    m_dynamic_descriptor = dynamic_descriptor;
    m_dynamic_descriptor_isSet = true;
}

bool OAIPanamerican::is_dynamic_descriptor_Set() const{
    return m_dynamic_descriptor_isSet;
}

bool OAIPanamerican::is_dynamic_descriptor_Valid() const{
    return m_dynamic_descriptor_isValid;
}

QList<QString> OAIPanamerican::getExcludedDccQuoteCurrencies() const {
    return m_excluded_dcc_quote_currencies;
}
void OAIPanamerican::setExcludedDccQuoteCurrencies(const QList<QString> &excluded_dcc_quote_currencies) {
    m_excluded_dcc_quote_currencies = excluded_dcc_quote_currencies;
    m_excluded_dcc_quote_currencies_isSet = true;
}

bool OAIPanamerican::is_excluded_dcc_quote_currencies_Set() const{
    return m_excluded_dcc_quote_currencies_isSet;
}

bool OAIPanamerican::is_excluded_dcc_quote_currencies_Valid() const{
    return m_excluded_dcc_quote_currencies_isValid;
}

OAIGatewayName OAIPanamerican::getGatewayName() const {
    return m_gateway_name;
}
void OAIPanamerican::setGatewayName(const OAIGatewayName &gateway_name) {
    m_gateway_name = gateway_name;
    m_gateway_name_isSet = true;
}

bool OAIPanamerican::is_gateway_name_Set() const{
    return m_gateway_name_isSet;
}

bool OAIPanamerican::is_gateway_name_Valid() const{
    return m_gateway_name_isValid;
}

QString OAIPanamerican::getId() const {
    return m_id;
}
void OAIPanamerican::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIPanamerican::is_id_Set() const{
    return m_id_isSet;
}

bool OAIPanamerican::is_id_Valid() const{
    return m_id_isValid;
}

bool OAIPanamerican::isIsDown() const {
    return m_is_down;
}
void OAIPanamerican::setIsDown(const bool &is_down) {
    m_is_down = is_down;
    m_is_down_isSet = true;
}

bool OAIPanamerican::is_is_down_Set() const{
    return m_is_down_isSet;
}

bool OAIPanamerican::is_is_down_Valid() const{
    return m_is_down_isValid;
}

QString OAIPanamerican::getMerchantCategoryCode() const {
    return m_merchant_category_code;
}
void OAIPanamerican::setMerchantCategoryCode(const QString &merchant_category_code) {
    m_merchant_category_code = merchant_category_code;
    m_merchant_category_code_isSet = true;
}

bool OAIPanamerican::is_merchant_category_code_Set() const{
    return m_merchant_category_code_isSet;
}

bool OAIPanamerican::is_merchant_category_code_Valid() const{
    return m_merchant_category_code_isValid;
}

OAIPaymentMethod OAIPanamerican::getMethod() const {
    return m_method;
}
void OAIPanamerican::setMethod(const OAIPaymentMethod &method) {
    m_method = method;
    m_method_isSet = true;
}

bool OAIPanamerican::is_method_Set() const{
    return m_method_isSet;
}

bool OAIPanamerican::is_method_Valid() const{
    return m_method_isValid;
}

double OAIPanamerican::getMonthlyLimit() const {
    return m_monthly_limit;
}
void OAIPanamerican::setMonthlyLimit(const double &monthly_limit) {
    m_monthly_limit = monthly_limit;
    m_monthly_limit_isSet = true;
}

bool OAIPanamerican::is_monthly_limit_Set() const{
    return m_monthly_limit_isSet;
}

bool OAIPanamerican::is_monthly_limit_Valid() const{
    return m_monthly_limit_isValid;
}

QString OAIPanamerican::getOrganizationId() const {
    return m_organization_id;
}
void OAIPanamerican::setOrganizationId(const QString &organization_id) {
    m_organization_id = organization_id;
    m_organization_id_isSet = true;
}

bool OAIPanamerican::is_organization_id_Set() const{
    return m_organization_id_isSet;
}

bool OAIPanamerican::is_organization_id_Valid() const{
    return m_organization_id_isValid;
}

QList<OAIPaymentCardBrand> OAIPanamerican::getPaymentCardSchemes() const {
    return m_payment_card_schemes;
}
void OAIPanamerican::setPaymentCardSchemes(const QList<OAIPaymentCardBrand> &payment_card_schemes) {
    m_payment_card_schemes = payment_card_schemes;
    m_payment_card_schemes_isSet = true;
}

bool OAIPanamerican::is_payment_card_schemes_Set() const{
    return m_payment_card_schemes_isSet;
}

bool OAIPanamerican::is_payment_card_schemes_Valid() const{
    return m_payment_card_schemes_isValid;
}

bool OAIPanamerican::isReconciliationWindowEnabled() const {
    return m_reconciliation_window_enabled;
}
void OAIPanamerican::setReconciliationWindowEnabled(const bool &reconciliation_window_enabled) {
    m_reconciliation_window_enabled = reconciliation_window_enabled;
    m_reconciliation_window_enabled_isSet = true;
}

bool OAIPanamerican::is_reconciliation_window_enabled_Set() const{
    return m_reconciliation_window_enabled_isSet;
}

bool OAIPanamerican::is_reconciliation_window_enabled_Valid() const{
    return m_reconciliation_window_enabled_isValid;
}

qint32 OAIPanamerican::getReconciliationWindowTtl() const {
    return m_reconciliation_window_ttl;
}
void OAIPanamerican::setReconciliationWindowTtl(const qint32 &reconciliation_window_ttl) {
    m_reconciliation_window_ttl = reconciliation_window_ttl;
    m_reconciliation_window_ttl_isSet = true;
}

bool OAIPanamerican::is_reconciliation_window_ttl_Set() const{
    return m_reconciliation_window_ttl_isSet;
}

bool OAIPanamerican::is_reconciliation_window_ttl_Valid() const{
    return m_reconciliation_window_ttl_isValid;
}

QString OAIPanamerican::getStatus() const {
    return m_status;
}
void OAIPanamerican::setStatus(const QString &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIPanamerican::is_status_Set() const{
    return m_status_isSet;
}

bool OAIPanamerican::is_status_Valid() const{
    return m_status_isValid;
}

bool OAIPanamerican::isSticky() const {
    return m_sticky;
}
void OAIPanamerican::setSticky(const bool &sticky) {
    m_sticky = sticky;
    m_sticky_isSet = true;
}

bool OAIPanamerican::is_sticky_Set() const{
    return m_sticky_isSet;
}

bool OAIPanamerican::is_sticky_Valid() const{
    return m_sticky_isValid;
}

bool OAIPanamerican::isThreeDSecure() const {
    return m_three_d_secure;
}
void OAIPanamerican::setThreeDSecure(const bool &three_d_secure) {
    m_three_d_secure = three_d_secure;
    m_three_d_secure_isSet = true;
}

bool OAIPanamerican::is_three_d_secure_Set() const{
    return m_three_d_secure_isSet;
}

bool OAIPanamerican::is_three_d_secure_Valid() const{
    return m_three_d_secure_isValid;
}

qint32 OAIPanamerican::getTimeout() const {
    return m_timeout;
}
void OAIPanamerican::setTimeout(const qint32 &timeout) {
    m_timeout = timeout;
    m_timeout_isSet = true;
}

bool OAIPanamerican::is_timeout_Set() const{
    return m_timeout_isSet;
}

bool OAIPanamerican::is_timeout_Valid() const{
    return m_timeout_isValid;
}

QString OAIPanamerican::getToken() const {
    return m_token;
}
void OAIPanamerican::setToken(const QString &token) {
    m_token = token;
    m_token_isSet = true;
}

bool OAIPanamerican::is_token_Set() const{
    return m_token_isSet;
}

bool OAIPanamerican::is_token_Valid() const{
    return m_token_isValid;
}

QDateTime OAIPanamerican::getUpdatedTime() const {
    return m_updated_time;
}
void OAIPanamerican::setUpdatedTime(const QDateTime &updated_time) {
    m_updated_time = updated_time;
    m_updated_time_isSet = true;
}

bool OAIPanamerican::is_updated_time_Set() const{
    return m_updated_time_isSet;
}

bool OAIPanamerican::is_updated_time_Valid() const{
    return m_updated_time_isValid;
}

OAIPanamerican_allOf_credentials OAIPanamerican::getCredentials() const {
    return m_credentials;
}
void OAIPanamerican::setCredentials(const OAIPanamerican_allOf_credentials &credentials) {
    m_credentials = credentials;
    m_credentials_isSet = true;
}

bool OAIPanamerican::is_credentials_Set() const{
    return m_credentials_isSet;
}

bool OAIPanamerican::is_credentials_Valid() const{
    return m_credentials_isValid;
}

OAIPanamerican_allOf_settings OAIPanamerican::getSettings() const {
    return m_settings;
}
void OAIPanamerican::setSettings(const OAIPanamerican_allOf_settings &settings) {
    m_settings = settings;
    m_settings_isSet = true;
}

bool OAIPanamerican::is_settings_Set() const{
    return m_settings_isSet;
}

bool OAIPanamerican::is_settings_Valid() const{
    return m_settings_isValid;
}

OAIPanamerican3dsServers OAIPanamerican::getThreeDSecureServer() const {
    return m_three_d_secure_server;
}
void OAIPanamerican::setThreeDSecureServer(const OAIPanamerican3dsServers &three_d_secure_server) {
    m_three_d_secure_server = three_d_secure_server;
    m_three_d_secure_server_isSet = true;
}

bool OAIPanamerican::is_three_d_secure_server_Set() const{
    return m_three_d_secure_server_isSet;
}

bool OAIPanamerican::is_three_d_secure_server_Valid() const{
    return m_three_d_secure_server_isValid;
}

bool OAIPanamerican::isSet() const {
...
bool OAIPanamerican::isValid() const {
