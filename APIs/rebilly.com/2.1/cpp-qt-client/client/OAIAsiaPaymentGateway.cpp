...
#include "OAIAsiaPaymentGateway.h"
...
OAIAsiaPaymentGateway::OAIAsiaPaymentGateway(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAsiaPaymentGateway::OAIAsiaPaymentGateway() {
    this->initializeModel();
}

OAIAsiaPaymentGateway::~OAIAsiaPaymentGateway() {}

void OAIAsiaPaymentGateway::initializeModel() {
...
void OAIAsiaPaymentGateway::fromJson(QString jsonString) {
...
void OAIAsiaPaymentGateway::fromJsonObject(QJsonObject json) {
...
QString OAIAsiaPaymentGateway::asJson() const {
...
QJsonObject OAIAsiaPaymentGateway::asJsonObject() const {
    QJsonObject obj;
    if (m__links.size() > 0) {
...
QList<OAIGatewayAccount__links_inner> OAIAsiaPaymentGateway::getLinks() const {
    return m__links;
}
void OAIAsiaPaymentGateway::setLinks(const QList<OAIGatewayAccount__links_inner> &_links) {
    m__links = _links;
    m__links_isSet = true;
}

bool OAIAsiaPaymentGateway::is__links_Set() const{
    return m__links_isSet;
}

bool OAIAsiaPaymentGateway::is__links_Valid() const{
    return m__links_isValid;
}

QList<QString> OAIAsiaPaymentGateway::getAcceptedCurrencies() const {
    return m_accepted_currencies;
}
void OAIAsiaPaymentGateway::setAcceptedCurrencies(const QList<QString> &accepted_currencies) {
    m_accepted_currencies = accepted_currencies;
    m_accepted_currencies_isSet = true;
}

bool OAIAsiaPaymentGateway::is_accepted_currencies_Set() const{
    return m_accepted_currencies_isSet;
}

bool OAIAsiaPaymentGateway::is_accepted_currencies_Valid() const{
    return m_accepted_currencies_isValid;
}

OAIAcquirerName OAIAsiaPaymentGateway::getAcquirerName() const {
    return m_acquirer_name;
}
void OAIAsiaPaymentGateway::setAcquirerName(const OAIAcquirerName &acquirer_name) {
    m_acquirer_name = acquirer_name;
    m_acquirer_name_isSet = true;
}

bool OAIAsiaPaymentGateway::is_acquirer_name_Set() const{
    return m_acquirer_name_isSet;
}

bool OAIAsiaPaymentGateway::is_acquirer_name_Valid() const{
    return m_acquirer_name_isValid;
}

QString OAIAsiaPaymentGateway::getAdditionalFilters() const {
    return m_additional_filters;
}
void OAIAsiaPaymentGateway::setAdditionalFilters(const QString &additional_filters) {
    m_additional_filters = additional_filters;
    m_additional_filters_isSet = true;
}

bool OAIAsiaPaymentGateway::is_additional_filters_Set() const{
    return m_additional_filters_isSet;
}

bool OAIAsiaPaymentGateway::is_additional_filters_Valid() const{
    return m_additional_filters_isValid;
}

qint32 OAIAsiaPaymentGateway::getApprovalWindowTtl() const {
    return m_approval_window_ttl;
}
void OAIAsiaPaymentGateway::setApprovalWindowTtl(const qint32 &approval_window_ttl) {
    m_approval_window_ttl = approval_window_ttl;
    m_approval_window_ttl_isSet = true;
}

bool OAIAsiaPaymentGateway::is_approval_window_ttl_Set() const{
    return m_approval_window_ttl_isSet;
}

bool OAIAsiaPaymentGateway::is_approval_window_ttl_Valid() const{
    return m_approval_window_ttl_isValid;
}

QString OAIAsiaPaymentGateway::getCityField() const {
    return m_city_field;
}
void OAIAsiaPaymentGateway::setCityField(const QString &city_field) {
    m_city_field = city_field;
    m_city_field_isSet = true;
}

bool OAIAsiaPaymentGateway::is_city_field_Set() const{
    return m_city_field_isSet;
}

bool OAIAsiaPaymentGateway::is_city_field_Valid() const{
    return m_city_field_isValid;
}

QDateTime OAIAsiaPaymentGateway::getCreatedTime() const {
    return m_created_time;
}
void OAIAsiaPaymentGateway::setCreatedTime(const QDateTime &created_time) {
    m_created_time = created_time;
    m_created_time_isSet = true;
}

bool OAIAsiaPaymentGateway::is_created_time_Set() const{
    return m_created_time_isSet;
}

bool OAIAsiaPaymentGateway::is_created_time_Valid() const{
    return m_created_time_isValid;
}

QString OAIAsiaPaymentGateway::getDccForceCurrency() const {
    return m_dcc_force_currency;
}
void OAIAsiaPaymentGateway::setDccForceCurrency(const QString &dcc_force_currency) {
    m_dcc_force_currency = dcc_force_currency;
    m_dcc_force_currency_isSet = true;
}

bool OAIAsiaPaymentGateway::is_dcc_force_currency_Set() const{
    return m_dcc_force_currency_isSet;
}

bool OAIAsiaPaymentGateway::is_dcc_force_currency_Valid() const{
    return m_dcc_force_currency_isValid;
}

qint32 OAIAsiaPaymentGateway::getDccMarkup() const {
    return m_dcc_markup;
}
void OAIAsiaPaymentGateway::setDccMarkup(const qint32 &dcc_markup) {
    m_dcc_markup = dcc_markup;
    m_dcc_markup_isSet = true;
}

bool OAIAsiaPaymentGateway::is_dcc_markup_Set() const{
    return m_dcc_markup_isSet;
}

bool OAIAsiaPaymentGateway::is_dcc_markup_Valid() const{
    return m_dcc_markup_isValid;
}

QString OAIAsiaPaymentGateway::getDescriptor() const {
    return m_descriptor;
}
void OAIAsiaPaymentGateway::setDescriptor(const QString &descriptor) {
    m_descriptor = descriptor;
    m_descriptor_isSet = true;
}

bool OAIAsiaPaymentGateway::is_descriptor_Set() const{
    return m_descriptor_isSet;
}

bool OAIAsiaPaymentGateway::is_descriptor_Valid() const{
    return m_descriptor_isValid;
}

OAIDigitalWallets OAIAsiaPaymentGateway::getDigitalWallets() const {
    return m_digital_wallets;
}
void OAIAsiaPaymentGateway::setDigitalWallets(const OAIDigitalWallets &digital_wallets) {
    m_digital_wallets = digital_wallets;
    m_digital_wallets_isSet = true;
}

bool OAIAsiaPaymentGateway::is_digital_wallets_Set() const{
    return m_digital_wallets_isSet;
}

bool OAIAsiaPaymentGateway::is_digital_wallets_Valid() const{
    return m_digital_wallets_isValid;
}

bool OAIAsiaPaymentGateway::isDynamicDescriptor() const {
    return m_dynamic_descriptor;
}
void OAIAsiaPaymentGateway::setDynamicDescriptor(const bool &dynamic_descriptor) {
    m_dynamic_descriptor = dynamic_descriptor;
    m_dynamic_descriptor_isSet = true;
}

bool OAIAsiaPaymentGateway::is_dynamic_descriptor_Set() const{
    return m_dynamic_descriptor_isSet;
}

bool OAIAsiaPaymentGateway::is_dynamic_descriptor_Valid() const{
    return m_dynamic_descriptor_isValid;
}

QList<QString> OAIAsiaPaymentGateway::getExcludedDccQuoteCurrencies() const {
    return m_excluded_dcc_quote_currencies;
}
void OAIAsiaPaymentGateway::setExcludedDccQuoteCurrencies(const QList<QString> &excluded_dcc_quote_currencies) {
    m_excluded_dcc_quote_currencies = excluded_dcc_quote_currencies;
    m_excluded_dcc_quote_currencies_isSet = true;
}

bool OAIAsiaPaymentGateway::is_excluded_dcc_quote_currencies_Set() const{
    return m_excluded_dcc_quote_currencies_isSet;
}

bool OAIAsiaPaymentGateway::is_excluded_dcc_quote_currencies_Valid() const{
    return m_excluded_dcc_quote_currencies_isValid;
}

OAIGatewayName OAIAsiaPaymentGateway::getGatewayName() const {
    return m_gateway_name;
}
void OAIAsiaPaymentGateway::setGatewayName(const OAIGatewayName &gateway_name) {
    m_gateway_name = gateway_name;
    m_gateway_name_isSet = true;
}

bool OAIAsiaPaymentGateway::is_gateway_name_Set() const{
    return m_gateway_name_isSet;
}

bool OAIAsiaPaymentGateway::is_gateway_name_Valid() const{
    return m_gateway_name_isValid;
}

QString OAIAsiaPaymentGateway::getId() const {
    return m_id;
}
void OAIAsiaPaymentGateway::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIAsiaPaymentGateway::is_id_Set() const{
    return m_id_isSet;
}

bool OAIAsiaPaymentGateway::is_id_Valid() const{
    return m_id_isValid;
}

bool OAIAsiaPaymentGateway::isIsDown() const {
    return m_is_down;
}
void OAIAsiaPaymentGateway::setIsDown(const bool &is_down) {
    m_is_down = is_down;
    m_is_down_isSet = true;
}

bool OAIAsiaPaymentGateway::is_is_down_Set() const{
    return m_is_down_isSet;
}

bool OAIAsiaPaymentGateway::is_is_down_Valid() const{
    return m_is_down_isValid;
}

QString OAIAsiaPaymentGateway::getMerchantCategoryCode() const {
    return m_merchant_category_code;
}
void OAIAsiaPaymentGateway::setMerchantCategoryCode(const QString &merchant_category_code) {
    m_merchant_category_code = merchant_category_code;
    m_merchant_category_code_isSet = true;
}

bool OAIAsiaPaymentGateway::is_merchant_category_code_Set() const{
    return m_merchant_category_code_isSet;
}

bool OAIAsiaPaymentGateway::is_merchant_category_code_Valid() const{
    return m_merchant_category_code_isValid;
}

OAIPaymentMethod OAIAsiaPaymentGateway::getMethod() const {
    return m_method;
}
void OAIAsiaPaymentGateway::setMethod(const OAIPaymentMethod &method) {
    m_method = method;
    m_method_isSet = true;
}

bool OAIAsiaPaymentGateway::is_method_Set() const{
    return m_method_isSet;
}

bool OAIAsiaPaymentGateway::is_method_Valid() const{
    return m_method_isValid;
}

double OAIAsiaPaymentGateway::getMonthlyLimit() const {
    return m_monthly_limit;
}
void OAIAsiaPaymentGateway::setMonthlyLimit(const double &monthly_limit) {
    m_monthly_limit = monthly_limit;
    m_monthly_limit_isSet = true;
}

bool OAIAsiaPaymentGateway::is_monthly_limit_Set() const{
    return m_monthly_limit_isSet;
}

bool OAIAsiaPaymentGateway::is_monthly_limit_Valid() const{
    return m_monthly_limit_isValid;
}

QString OAIAsiaPaymentGateway::getOrganizationId() const {
    return m_organization_id;
}
void OAIAsiaPaymentGateway::setOrganizationId(const QString &organization_id) {
    m_organization_id = organization_id;
    m_organization_id_isSet = true;
}

bool OAIAsiaPaymentGateway::is_organization_id_Set() const{
    return m_organization_id_isSet;
}

bool OAIAsiaPaymentGateway::is_organization_id_Valid() const{
    return m_organization_id_isValid;
}

QList<OAIPaymentCardBrand> OAIAsiaPaymentGateway::getPaymentCardSchemes() const {
    return m_payment_card_schemes;
}
void OAIAsiaPaymentGateway::setPaymentCardSchemes(const QList<OAIPaymentCardBrand> &payment_card_schemes) {
    m_payment_card_schemes = payment_card_schemes;
    m_payment_card_schemes_isSet = true;
}

bool OAIAsiaPaymentGateway::is_payment_card_schemes_Set() const{
    return m_payment_card_schemes_isSet;
}

bool OAIAsiaPaymentGateway::is_payment_card_schemes_Valid() const{
    return m_payment_card_schemes_isValid;
}

bool OAIAsiaPaymentGateway::isReconciliationWindowEnabled() const {
    return m_reconciliation_window_enabled;
}
void OAIAsiaPaymentGateway::setReconciliationWindowEnabled(const bool &reconciliation_window_enabled) {
    m_reconciliation_window_enabled = reconciliation_window_enabled;
    m_reconciliation_window_enabled_isSet = true;
}

bool OAIAsiaPaymentGateway::is_reconciliation_window_enabled_Set() const{
    return m_reconciliation_window_enabled_isSet;
}

bool OAIAsiaPaymentGateway::is_reconciliation_window_enabled_Valid() const{
    return m_reconciliation_window_enabled_isValid;
}

qint32 OAIAsiaPaymentGateway::getReconciliationWindowTtl() const {
    return m_reconciliation_window_ttl;
}
void OAIAsiaPaymentGateway::setReconciliationWindowTtl(const qint32 &reconciliation_window_ttl) {
    m_reconciliation_window_ttl = reconciliation_window_ttl;
    m_reconciliation_window_ttl_isSet = true;
}

bool OAIAsiaPaymentGateway::is_reconciliation_window_ttl_Set() const{
    return m_reconciliation_window_ttl_isSet;
}

bool OAIAsiaPaymentGateway::is_reconciliation_window_ttl_Valid() const{
    return m_reconciliation_window_ttl_isValid;
}

QString OAIAsiaPaymentGateway::getStatus() const {
    return m_status;
}
void OAIAsiaPaymentGateway::setStatus(const QString &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIAsiaPaymentGateway::is_status_Set() const{
    return m_status_isSet;
}

bool OAIAsiaPaymentGateway::is_status_Valid() const{
    return m_status_isValid;
}

bool OAIAsiaPaymentGateway::isSticky() const {
    return m_sticky;
}
void OAIAsiaPaymentGateway::setSticky(const bool &sticky) {
    m_sticky = sticky;
    m_sticky_isSet = true;
}

bool OAIAsiaPaymentGateway::is_sticky_Set() const{
    return m_sticky_isSet;
}

bool OAIAsiaPaymentGateway::is_sticky_Valid() const{
    return m_sticky_isValid;
}

bool OAIAsiaPaymentGateway::isThreeDSecure() const {
    return m_three_d_secure;
}
void OAIAsiaPaymentGateway::setThreeDSecure(const bool &three_d_secure) {
    m_three_d_secure = three_d_secure;
    m_three_d_secure_isSet = true;
}

bool OAIAsiaPaymentGateway::is_three_d_secure_Set() const{
    return m_three_d_secure_isSet;
}

bool OAIAsiaPaymentGateway::is_three_d_secure_Valid() const{
    return m_three_d_secure_isValid;
}

qint32 OAIAsiaPaymentGateway::getTimeout() const {
    return m_timeout;
}
void OAIAsiaPaymentGateway::setTimeout(const qint32 &timeout) {
    m_timeout = timeout;
    m_timeout_isSet = true;
}

bool OAIAsiaPaymentGateway::is_timeout_Set() const{
    return m_timeout_isSet;
}

bool OAIAsiaPaymentGateway::is_timeout_Valid() const{
    return m_timeout_isValid;
}

QString OAIAsiaPaymentGateway::getToken() const {
    return m_token;
}
void OAIAsiaPaymentGateway::setToken(const QString &token) {
    m_token = token;
    m_token_isSet = true;
}

bool OAIAsiaPaymentGateway::is_token_Set() const{
    return m_token_isSet;
}

bool OAIAsiaPaymentGateway::is_token_Valid() const{
    return m_token_isValid;
}

QDateTime OAIAsiaPaymentGateway::getUpdatedTime() const {
    return m_updated_time;
}
void OAIAsiaPaymentGateway::setUpdatedTime(const QDateTime &updated_time) {
    m_updated_time = updated_time;
    m_updated_time_isSet = true;
}

bool OAIAsiaPaymentGateway::is_updated_time_Set() const{
    return m_updated_time_isSet;
}

bool OAIAsiaPaymentGateway::is_updated_time_Valid() const{
    return m_updated_time_isValid;
}

OAIAsiaPaymentGateway_allOf_credentials OAIAsiaPaymentGateway::getCredentials() const {
    return m_credentials;
}
void OAIAsiaPaymentGateway::setCredentials(const OAIAsiaPaymentGateway_allOf_credentials &credentials) {
    m_credentials = credentials;
    m_credentials_isSet = true;
}

bool OAIAsiaPaymentGateway::is_credentials_Set() const{
    return m_credentials_isSet;
}

bool OAIAsiaPaymentGateway::is_credentials_Valid() const{
    return m_credentials_isValid;
}

bool OAIAsiaPaymentGateway::isSet() const {
...
bool OAIAsiaPaymentGateway::isValid() const {
