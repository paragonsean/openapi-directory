...
/*
 * OAINeosurf_allOf_credentials.h
 *
 * Neosurf credentials object.
 */

#ifndef OAINeosurf_allOf_credentials_H
#define OAINeosurf_allOf_credentials_H
...
class OAINeosurf_allOf_credentials : public OAIObject {
public:
    OAINeosurf_allOf_credentials();
    OAINeosurf_allOf_credentials(QString json);
    ~OAINeosurf_allOf_credentials() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAINeosurf_allOf_credentials)

#endif // OAINeosurf_allOf_credentials_H
