...
OAIVegaaH::OAIVegaaH(QString json) {
...
void OAIVegaaH::initializeModel() {
...
void OAIVegaaH::fromJson(QString jsonString) {
...
void OAIVegaaH::fromJsonObject(QJsonObject json) {
...
QString OAIVegaaH::asJson() const {
...
QJsonObject OAIVegaaH::asJsonObject() const {
    QJsonObject obj;
    if (m__links.size() > 0) {
...
QList<OAIGatewayAccount__links_inner> OAIVegaaH::getLinks() const {
    return m__links;
}
void OAIVegaaH::setLinks(const QList<OAIGatewayAccount__links_inner> &_links) {
    m__links = _links;
    m__links_isSet = true;
}

bool OAIVegaaH::is__links_Set() const{
    return m__links_isSet;
}

bool OAIVegaaH::is__links_Valid() const{
    return m__links_isValid;
}

QList<QString> OAIVegaaH::getAcceptedCurrencies() const {
    return m_accepted_currencies;
}
void OAIVegaaH::setAcceptedCurrencies(const QList<QString> &accepted_currencies) {
    m_accepted_currencies = accepted_currencies;
    m_accepted_currencies_isSet = true;
}

bool OAIVegaaH::is_accepted_currencies_Set() const{
    return m_accepted_currencies_isSet;
}

bool OAIVegaaH::is_accepted_currencies_Valid() const{
    return m_accepted_currencies_isValid;
}

OAIAcquirerName OAIVegaaH::getAcquirerName() const {
    return m_acquirer_name;
}
void OAIVegaaH::setAcquirerName(const OAIAcquirerName &acquirer_name) {
    m_acquirer_name = acquirer_name;
    m_acquirer_name_isSet = true;
}

bool OAIVegaaH::is_acquirer_name_Set() const{
    return m_acquirer_name_isSet;
}

bool OAIVegaaH::is_acquirer_name_Valid() const{
    return m_acquirer_name_isValid;
}

QString OAIVegaaH::getAdditionalFilters() const {
    return m_additional_filters;
}
void OAIVegaaH::setAdditionalFilters(const QString &additional_filters) {
    m_additional_filters = additional_filters;
    m_additional_filters_isSet = true;
}

bool OAIVegaaH::is_additional_filters_Set() const{
    return m_additional_filters_isSet;
}

bool OAIVegaaH::is_additional_filters_Valid() const{
    return m_additional_filters_isValid;
}

qint32 OAIVegaaH::getApprovalWindowTtl() const {
    return m_approval_window_ttl;
}
void OAIVegaaH::setApprovalWindowTtl(const qint32 &approval_window_ttl) {
    m_approval_window_ttl = approval_window_ttl;
    m_approval_window_ttl_isSet = true;
}

bool OAIVegaaH::is_approval_window_ttl_Set() const{
    return m_approval_window_ttl_isSet;
}

bool OAIVegaaH::is_approval_window_ttl_Valid() const{
    return m_approval_window_ttl_isValid;
}

QString OAIVegaaH::getCityField() const {
    return m_city_field;
}
void OAIVegaaH::setCityField(const QString &city_field) {
    m_city_field = city_field;
    m_city_field_isSet = true;
}

bool OAIVegaaH::is_city_field_Set() const{
    return m_city_field_isSet;
}

bool OAIVegaaH::is_city_field_Valid() const{
    return m_city_field_isValid;
}

QDateTime OAIVegaaH::getCreatedTime() const {
    return m_created_time;
}
void OAIVegaaH::setCreatedTime(const QDateTime &created_time) {
    m_created_time = created_time;
    m_created_time_isSet = true;
}

bool OAIVegaaH::is_created_time_Set() const{
    return m_created_time_isSet;
}

bool OAIVegaaH::is_created_time_Valid() const{
    return m_created_time_isValid;
}

QString OAIVegaaH::getDccForceCurrency() const {
    return m_dcc_force_currency;
}
void OAIVegaaH::setDccForceCurrency(const QString &dcc_force_currency) {
    m_dcc_force_currency = dcc_force_currency;
    m_dcc_force_currency_isSet = true;
}

bool OAIVegaaH::is_dcc_force_currency_Set() const{
    return m_dcc_force_currency_isSet;
}

bool OAIVegaaH::is_dcc_force_currency_Valid() const{
    return m_dcc_force_currency_isValid;
}

qint32 OAIVegaaH::getDccMarkup() const {
    return m_dcc_markup;
}
void OAIVegaaH::setDccMarkup(const qint32 &dcc_markup) {
    m_dcc_markup = dcc_markup;
    m_dcc_markup_isSet = true;
}

bool OAIVegaaH::is_dcc_markup_Set() const{
    return m_dcc_markup_isSet;
}

bool OAIVegaaH::is_dcc_markup_Valid() const{
    return m_dcc_markup_isValid;
}

QString OAIVegaaH::getDescriptor() const {
    return m_descriptor;
}
void OAIVegaaH::setDescriptor(const QString &descriptor) {
    m_descriptor = descriptor;
    m_descriptor_isSet = true;
}

bool OAIVegaaH::is_descriptor_Set() const{
    return m_descriptor_isSet;
}

bool OAIVegaaH::is_descriptor_Valid() const{
    return m_descriptor_isValid;
}

OAIDigitalWallets OAIVegaaH::getDigitalWallets() const {
    return m_digital_wallets;
}
void OAIVegaaH::setDigitalWallets(const OAIDigitalWallets &digital_wallets) {
    m_digital_wallets = digital_wallets;
    m_digital_wallets_isSet = true;
}

bool OAIVegaaH::is_digital_wallets_Set() const{
    return m_digital_wallets_isSet;
}

bool OAIVegaaH::is_digital_wallets_Valid() const{
    return m_digital_wallets_isValid;
}

bool OAIVegaaH::isDynamicDescriptor() const {
    return m_dynamic_descriptor;
}
void OAIVegaaH::setDynamicDescriptor(const bool &dynamic_descriptor) {
    m_dynamic_descriptor = dynamic_descriptor;
    m_dynamic_descriptor_isSet = true;
}

bool OAIVegaaH::is_dynamic_descriptor_Set() const{
    return m_dynamic_descriptor_isSet;
}

bool OAIVegaaH::is_dynamic_descriptor_Valid() const{
    return m_dynamic_descriptor_isValid;
}

QList<QString> OAIVegaaH::getExcludedDccQuoteCurrencies() const {
    return m_excluded_dcc_quote_currencies;
}
void OAIVegaaH::setExcludedDccQuoteCurrencies(const QList<QString> &excluded_dcc_quote_currencies) {
    m_excluded_dcc_quote_currencies = excluded_dcc_quote_currencies;
    m_excluded_dcc_quote_currencies_isSet = true;
}

bool OAIVegaaH::is_excluded_dcc_quote_currencies_Set() const{
    return m_excluded_dcc_quote_currencies_isSet;
}

bool OAIVegaaH::is_excluded_dcc_quote_currencies_Valid() const{
    return m_excluded_dcc_quote_currencies_isValid;
}

OAIGatewayName OAIVegaaH::getGatewayName() const {
    return m_gateway_name;
}
void OAIVegaaH::setGatewayName(const OAIGatewayName &gateway_name) {
    m_gateway_name = gateway_name;
    m_gateway_name_isSet = true;
}

bool OAIVegaaH::is_gateway_name_Set() const{
    return m_gateway_name_isSet;
}

bool OAIVegaaH::is_gateway_name_Valid() const{
    return m_gateway_name_isValid;
}

QString OAIVegaaH::getId() const {
    return m_id;
}
void OAIVegaaH::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIVegaaH::is_id_Set() const{
    return m_id_isSet;
}

bool OAIVegaaH::is_id_Valid() const{
    return m_id_isValid;
}

bool OAIVegaaH::isIsDown() const {
    return m_is_down;
}
void OAIVegaaH::setIsDown(const bool &is_down) {
    m_is_down = is_down;
    m_is_down_isSet = true;
}

bool OAIVegaaH::is_is_down_Set() const{
    return m_is_down_isSet;
}

bool OAIVegaaH::is_is_down_Valid() const{
    return m_is_down_isValid;
}

QString OAIVegaaH::getMerchantCategoryCode() const {
    return m_merchant_category_code;
}
void OAIVegaaH::setMerchantCategoryCode(const QString &merchant_category_code) {
    m_merchant_category_code = merchant_category_code;
    m_merchant_category_code_isSet = true;
}

bool OAIVegaaH::is_merchant_category_code_Set() const{
    return m_merchant_category_code_isSet;
}

bool OAIVegaaH::is_merchant_category_code_Valid() const{
    return m_merchant_category_code_isValid;
}

OAIPaymentMethod OAIVegaaH::getMethod() const {
    return m_method;
}
void OAIVegaaH::setMethod(const OAIPaymentMethod &method) {
    m_method = method;
    m_method_isSet = true;
}

bool OAIVegaaH::is_method_Set() const{
    return m_method_isSet;
}

bool OAIVegaaH::is_method_Valid() const{
    return m_method_isValid;
}

double OAIVegaaH::getMonthlyLimit() const {
    return m_monthly_limit;
}
void OAIVegaaH::setMonthlyLimit(const double &monthly_limit) {
    m_monthly_limit = monthly_limit;
    m_monthly_limit_isSet = true;
}

bool OAIVegaaH::is_monthly_limit_Set() const{
    return m_monthly_limit_isSet;
}

bool OAIVegaaH::is_monthly_limit_Valid() const{
    return m_monthly_limit_isValid;
}

QString OAIVegaaH::getOrganizationId() const {
    return m_organization_id;
}
void OAIVegaaH::setOrganizationId(const QString &organization_id) {
    m_organization_id = organization_id;
    m_organization_id_isSet = true;
}

bool OAIVegaaH::is_organization_id_Set() const{
    return m_organization_id_isSet;
}

bool OAIVegaaH::is_organization_id_Valid() const{
    return m_organization_id_isValid;
}

QList<OAIPaymentCardBrand> OAIVegaaH::getPaymentCardSchemes() const {
    return m_payment_card_schemes;
}
void OAIVegaaH::setPaymentCardSchemes(const QList<OAIPaymentCardBrand> &payment_card_schemes) {
    m_payment_card_schemes = payment_card_schemes;
    m_payment_card_schemes_isSet = true;
}

bool OAIVegaaH::is_payment_card_schemes_Set() const{
    return m_payment_card_schemes_isSet;
}

bool OAIVegaaH::is_payment_card_schemes_Valid() const{
    return m_payment_card_schemes_isValid;
}

bool OAIVegaaH::isReconciliationWindowEnabled() const {
    return m_reconciliation_window_enabled;
}
void OAIVegaaH::setReconciliationWindowEnabled(const bool &reconciliation_window_enabled) {
    m_reconciliation_window_enabled = reconciliation_window_enabled;
    m_reconciliation_window_enabled_isSet = true;
}

bool OAIVegaaH::is_reconciliation_window_enabled_Set() const{
    return m_reconciliation_window_enabled_isSet;
}

bool OAIVegaaH::is_reconciliation_window_enabled_Valid() const{
    return m_reconciliation_window_enabled_isValid;
}

qint32 OAIVegaaH::getReconciliationWindowTtl() const {
    return m_reconciliation_window_ttl;
}
void OAIVegaaH::setReconciliationWindowTtl(const qint32 &reconciliation_window_ttl) {
    m_reconciliation_window_ttl = reconciliation_window_ttl;
    m_reconciliation_window_ttl_isSet = true;
}

bool OAIVegaaH::is_reconciliation_window_ttl_Set() const{
    return m_reconciliation_window_ttl_isSet;
}

bool OAIVegaaH::is_reconciliation_window_ttl_Valid() const{
    return m_reconciliation_window_ttl_isValid;
}

QString OAIVegaaH::getStatus() const {
    return m_status;
}
void OAIVegaaH::setStatus(const QString &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIVegaaH::is_status_Set() const{
    return m_status_isSet;
}

bool OAIVegaaH::is_status_Valid() const{
    return m_status_isValid;
}

bool OAIVegaaH::isSticky() const {
    return m_sticky;
}
void OAIVegaaH::setSticky(const bool &sticky) {
    m_sticky = sticky;
    m_sticky_isSet = true;
}

bool OAIVegaaH::is_sticky_Set() const{
    return m_sticky_isSet;
}

bool OAIVegaaH::is_sticky_Valid() const{
    return m_sticky_isValid;
}

bool OAIVegaaH::isThreeDSecure() const {
    return m_three_d_secure;
}
void OAIVegaaH::setThreeDSecure(const bool &three_d_secure) {
    m_three_d_secure = three_d_secure;
    m_three_d_secure_isSet = true;
}

bool OAIVegaaH::is_three_d_secure_Set() const{
    return m_three_d_secure_isSet;
}

bool OAIVegaaH::is_three_d_secure_Valid() const{
    return m_three_d_secure_isValid;
}

qint32 OAIVegaaH::getTimeout() const {
    return m_timeout;
}
void OAIVegaaH::setTimeout(const qint32 &timeout) {
    m_timeout = timeout;
    m_timeout_isSet = true;
}

bool OAIVegaaH::is_timeout_Set() const{
    return m_timeout_isSet;
}

bool OAIVegaaH::is_timeout_Valid() const{
    return m_timeout_isValid;
}

QString OAIVegaaH::getToken() const {
    return m_token;
}
void OAIVegaaH::setToken(const QString &token) {
    m_token = token;
    m_token_isSet = true;
}

bool OAIVegaaH::is_token_Set() const{
    return m_token_isSet;
}

bool OAIVegaaH::is_token_Valid() const{
    return m_token_isValid;
}

QDateTime OAIVegaaH::getUpdatedTime() const {
    return m_updated_time;
}
void OAIVegaaH::setUpdatedTime(const QDateTime &updated_time) {
    m_updated_time = updated_time;
    m_updated_time_isSet = true;
}

bool OAIVegaaH::is_updated_time_Set() const{
    return m_updated_time_isSet;
}

bool OAIVegaaH::is_updated_time_Valid() const{
    return m_updated_time_isValid;
}

OAIVegaaH_allOf_credentials OAIVegaaH::getCredentials() const {
    return m_credentials;
}
void OAIVegaaH::setCredentials(const OAIVegaaH_allOf_credentials &credentials) {
    m_credentials = credentials;
    m_credentials_isSet = true;
}

bool OAIVegaaH::is_credentials_Set() const{
    return m_credentials_isSet;
}

bool OAIVegaaH::is_credentials_Valid() const{
    return m_credentials_isValid;
}

bool OAIVegaaH::isSet() const {
