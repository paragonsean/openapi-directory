...
#ifndef OAIIBANInstrument_H
#define OAIIBANInstrument_H
...
class OAIIBANInstrument : public OAIObject {
public:
    OAIIBANInstrument();
    OAIIBANInstrument(QString json);
    ~OAIIBANInstrument() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIIBANInstrument)

#endif // OAIIBANInstrument_H
