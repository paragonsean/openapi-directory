...
OAIWorldpay::OAIWorldpay(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIWorldpay::OAIWorldpay() {
    this->initializeModel();
}

OAIWorldpay::~OAIWorldpay() {}

void OAIWorldpay::initializeModel() {
...
void OAIWorldpay::fromJson(QString jsonString) {
...
void OAIWorldpay::fromJsonObject(QJsonObject json) {
...
QString OAIWorldpay::asJson() const {
...
QJsonObject OAIWorldpay::asJsonObject() const {
    QJsonObject obj;
    if (m__links.size() > 0) {
...
QList<OAIGatewayAccount__links_inner> OAIWorldpay::getLinks() const {
    return m__links;
}
void OAIWorldpay::setLinks(const QList<OAIGatewayAccount__links_inner> &_links) {
    m__links = _links;
    m__links_isSet = true;
}

bool OAIWorldpay::is__links_Set() const{
    return m__links_isSet;
}

bool OAIWorldpay::is__links_Valid() const{
    return m__links_isValid;
}

QList<QString> OAIWorldpay::getAcceptedCurrencies() const {
    return m_accepted_currencies;
}
void OAIWorldpay::setAcceptedCurrencies(const QList<QString> &accepted_currencies) {
    m_accepted_currencies = accepted_currencies;
    m_accepted_currencies_isSet = true;
}

bool OAIWorldpay::is_accepted_currencies_Set() const{
    return m_accepted_currencies_isSet;
}

bool OAIWorldpay::is_accepted_currencies_Valid() const{
    return m_accepted_currencies_isValid;
}

OAIAcquirerName OAIWorldpay::getAcquirerName() const {
    return m_acquirer_name;
}
void OAIWorldpay::setAcquirerName(const OAIAcquirerName &acquirer_name) {
    m_acquirer_name = acquirer_name;
    m_acquirer_name_isSet = true;
}

bool OAIWorldpay::is_acquirer_name_Set() const{
    return m_acquirer_name_isSet;
}

bool OAIWorldpay::is_acquirer_name_Valid() const{
    return m_acquirer_name_isValid;
}

QString OAIWorldpay::getAdditionalFilters() const {
    return m_additional_filters;
}
void OAIWorldpay::setAdditionalFilters(const QString &additional_filters) {
    m_additional_filters = additional_filters;
    m_additional_filters_isSet = true;
}

bool OAIWorldpay::is_additional_filters_Set() const{
    return m_additional_filters_isSet;
}

bool OAIWorldpay::is_additional_filters_Valid() const{
    return m_additional_filters_isValid;
}

qint32 OAIWorldpay::getApprovalWindowTtl() const {
    return m_approval_window_ttl;
}
void OAIWorldpay::setApprovalWindowTtl(const qint32 &approval_window_ttl) {
    m_approval_window_ttl = approval_window_ttl;
    m_approval_window_ttl_isSet = true;
}

bool OAIWorldpay::is_approval_window_ttl_Set() const{
    return m_approval_window_ttl_isSet;
}

bool OAIWorldpay::is_approval_window_ttl_Valid() const{
    return m_approval_window_ttl_isValid;
}

QString OAIWorldpay::getCityField() const {
    return m_city_field;
}
void OAIWorldpay::setCityField(const QString &city_field) {
    m_city_field = city_field;
    m_city_field_isSet = true;
}

bool OAIWorldpay::is_city_field_Set() const{
    return m_city_field_isSet;
}

bool OAIWorldpay::is_city_field_Valid() const{
    return m_city_field_isValid;
}

QDateTime OAIWorldpay::getCreatedTime() const {
    return m_created_time;
}
void OAIWorldpay::setCreatedTime(const QDateTime &created_time) {
    m_created_time = created_time;
    m_created_time_isSet = true;
}

bool OAIWorldpay::is_created_time_Set() const{
    return m_created_time_isSet;
}

bool OAIWorldpay::is_created_time_Valid() const{
    return m_created_time_isValid;
}

QString OAIWorldpay::getDccForceCurrency() const {
    return m_dcc_force_currency;
}
void OAIWorldpay::setDccForceCurrency(const QString &dcc_force_currency) {
    m_dcc_force_currency = dcc_force_currency;
    m_dcc_force_currency_isSet = true;
}

bool OAIWorldpay::is_dcc_force_currency_Set() const{
    return m_dcc_force_currency_isSet;
}

bool OAIWorldpay::is_dcc_force_currency_Valid() const{
    return m_dcc_force_currency_isValid;
}

qint32 OAIWorldpay::getDccMarkup() const {
    return m_dcc_markup;
}
void OAIWorldpay::setDccMarkup(const qint32 &dcc_markup) {
    m_dcc_markup = dcc_markup;
    m_dcc_markup_isSet = true;
}

bool OAIWorldpay::is_dcc_markup_Set() const{
    return m_dcc_markup_isSet;
}

bool OAIWorldpay::is_dcc_markup_Valid() const{
    return m_dcc_markup_isValid;
}

QString OAIWorldpay::getDescriptor() const {
    return m_descriptor;
}
void OAIWorldpay::setDescriptor(const QString &descriptor) {
    m_descriptor = descriptor;
    m_descriptor_isSet = true;
}

bool OAIWorldpay::is_descriptor_Set() const{
    return m_descriptor_isSet;
}

bool OAIWorldpay::is_descriptor_Valid() const{
    return m_descriptor_isValid;
}

OAIDigitalWallets OAIWorldpay::getDigitalWallets() const {
    return m_digital_wallets;
}
void OAIWorldpay::setDigitalWallets(const OAIDigitalWallets &digital_wallets) {
    m_digital_wallets = digital_wallets;
    m_digital_wallets_isSet = true;
}

bool OAIWorldpay::is_digital_wallets_Set() const{
    return m_digital_wallets_isSet;
}

bool OAIWorldpay::is_digital_wallets_Valid() const{
    return m_digital_wallets_isValid;
}

bool OAIWorldpay::isDynamicDescriptor() const {
    return m_dynamic_descriptor;
}
void OAIWorldpay::setDynamicDescriptor(const bool &dynamic_descriptor) {
    m_dynamic_descriptor = dynamic_descriptor;
    m_dynamic_descriptor_isSet = true;
}

bool OAIWorldpay::is_dynamic_descriptor_Set() const{
    return m_dynamic_descriptor_isSet;
}

bool OAIWorldpay::is_dynamic_descriptor_Valid() const{
    return m_dynamic_descriptor_isValid;
}

QList<QString> OAIWorldpay::getExcludedDccQuoteCurrencies() const {
    return m_excluded_dcc_quote_currencies;
}
void OAIWorldpay::setExcludedDccQuoteCurrencies(const QList<QString> &excluded_dcc_quote_currencies) {
    m_excluded_dcc_quote_currencies = excluded_dcc_quote_currencies;
    m_excluded_dcc_quote_currencies_isSet = true;
}

bool OAIWorldpay::is_excluded_dcc_quote_currencies_Set() const{
    return m_excluded_dcc_quote_currencies_isSet;
}

bool OAIWorldpay::is_excluded_dcc_quote_currencies_Valid() const{
    return m_excluded_dcc_quote_currencies_isValid;
}

OAIGatewayName OAIWorldpay::getGatewayName() const {
    return m_gateway_name;
}
void OAIWorldpay::setGatewayName(const OAIGatewayName &gateway_name) {
    m_gateway_name = gateway_name;
    m_gateway_name_isSet = true;
}

bool OAIWorldpay::is_gateway_name_Set() const{
    return m_gateway_name_isSet;
}

bool OAIWorldpay::is_gateway_name_Valid() const{
    return m_gateway_name_isValid;
}

QString OAIWorldpay::getId() const {
    return m_id;
}
void OAIWorldpay::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIWorldpay::is_id_Set() const{
    return m_id_isSet;
}

bool OAIWorldpay::is_id_Valid() const{
    return m_id_isValid;
}

bool OAIWorldpay::isIsDown() const {
    return m_is_down;
}
void OAIWorldpay::setIsDown(const bool &is_down) {
    m_is_down = is_down;
    m_is_down_isSet = true;
}

bool OAIWorldpay::is_is_down_Set() const{
    return m_is_down_isSet;
}

bool OAIWorldpay::is_is_down_Valid() const{
    return m_is_down_isValid;
}

QString OAIWorldpay::getMerchantCategoryCode() const {
    return m_merchant_category_code;
}
void OAIWorldpay::setMerchantCategoryCode(const QString &merchant_category_code) {
    m_merchant_category_code = merchant_category_code;
    m_merchant_category_code_isSet = true;
}

bool OAIWorldpay::is_merchant_category_code_Set() const{
    return m_merchant_category_code_isSet;
}

bool OAIWorldpay::is_merchant_category_code_Valid() const{
    return m_merchant_category_code_isValid;
}

OAIPaymentMethod OAIWorldpay::getMethod() const {
    return m_method;
}
void OAIWorldpay::setMethod(const OAIPaymentMethod &method) {
    m_method = method;
    m_method_isSet = true;
}

bool OAIWorldpay::is_method_Set() const{
    return m_method_isSet;
}

bool OAIWorldpay::is_method_Valid() const{
    return m_method_isValid;
}

double OAIWorldpay::getMonthlyLimit() const {
    return m_monthly_limit;
}
void OAIWorldpay::setMonthlyLimit(const double &monthly_limit) {
    m_monthly_limit = monthly_limit;
    m_monthly_limit_isSet = true;
}

bool OAIWorldpay::is_monthly_limit_Set() const{
    return m_monthly_limit_isSet;
}

bool OAIWorldpay::is_monthly_limit_Valid() const{
    return m_monthly_limit_isValid;
}

QString OAIWorldpay::getOrganizationId() const {
    return m_organization_id;
}
void OAIWorldpay::setOrganizationId(const QString &organization_id) {
    m_organization_id = organization_id;
    m_organization_id_isSet = true;
}

bool OAIWorldpay::is_organization_id_Set() const{
    return m_organization_id_isSet;
}

bool OAIWorldpay::is_organization_id_Valid() const{
    return m_organization_id_isValid;
}

QList<OAIPaymentCardBrand> OAIWorldpay::getPaymentCardSchemes() const {
    return m_payment_card_schemes;
}
void OAIWorldpay::setPaymentCardSchemes(const QList<OAIPaymentCardBrand> &payment_card_schemes) {
    m_payment_card_schemes = payment_card_schemes;
    m_payment_card_schemes_isSet = true;
}

bool OAIWorldpay::is_payment_card_schemes_Set() const{
    return m_payment_card_schemes_isSet;
}

bool OAIWorldpay::is_payment_card_schemes_Valid() const{
    return m_payment_card_schemes_isValid;
}

bool OAIWorldpay::isReconciliationWindowEnabled() const {
    return m_reconciliation_window_enabled;
}
void OAIWorldpay::setReconciliationWindowEnabled(const bool &reconciliation_window_enabled) {
    m_reconciliation_window_enabled = reconciliation_window_enabled;
    m_reconciliation_window_enabled_isSet = true;
}

bool OAIWorldpay::is_reconciliation_window_enabled_Set() const{
    return m_reconciliation_window_enabled_isSet;
}

bool OAIWorldpay::is_reconciliation_window_enabled_Valid() const{
    return m_reconciliation_window_enabled_isValid;
}

qint32 OAIWorldpay::getReconciliationWindowTtl() const {
    return m_reconciliation_window_ttl;
}
void OAIWorldpay::setReconciliationWindowTtl(const qint32 &reconciliation_window_ttl) {
    m_reconciliation_window_ttl = reconciliation_window_ttl;
    m_reconciliation_window_ttl_isSet = true;
}

bool OAIWorldpay::is_reconciliation_window_ttl_Set() const{
    return m_reconciliation_window_ttl_isSet;
}

bool OAIWorldpay::is_reconciliation_window_ttl_Valid() const{
    return m_reconciliation_window_ttl_isValid;
}

QString OAIWorldpay::getStatus() const {
    return m_status;
}
void OAIWorldpay::setStatus(const QString &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIWorldpay::is_status_Set() const{
    return m_status_isSet;
}

bool OAIWorldpay::is_status_Valid() const{
    return m_status_isValid;
}

bool OAIWorldpay::isSticky() const {
    return m_sticky;
}
void OAIWorldpay::setSticky(const bool &sticky) {
    m_sticky = sticky;
    m_sticky_isSet = true;
}

bool OAIWorldpay::is_sticky_Set() const{
    return m_sticky_isSet;
}

bool OAIWorldpay::is_sticky_Valid() const{
    return m_sticky_isValid;
}

bool OAIWorldpay::isThreeDSecure() const {
    return m_three_d_secure;
}
void OAIWorldpay::setThreeDSecure(const bool &three_d_secure) {
    m_three_d_secure = three_d_secure;
    m_three_d_secure_isSet = true;
}

bool OAIWorldpay::is_three_d_secure_Set() const{
    return m_three_d_secure_isSet;
}

bool OAIWorldpay::is_three_d_secure_Valid() const{
    return m_three_d_secure_isValid;
}

qint32 OAIWorldpay::getTimeout() const {
    return m_timeout;
}
void OAIWorldpay::setTimeout(const qint32 &timeout) {
    m_timeout = timeout;
    m_timeout_isSet = true;
}

bool OAIWorldpay::is_timeout_Set() const{
    return m_timeout_isSet;
}

bool OAIWorldpay::is_timeout_Valid() const{
    return m_timeout_isValid;
}

QString OAIWorldpay::getToken() const {
    return m_token;
}
void OAIWorldpay::setToken(const QString &token) {
    m_token = token;
    m_token_isSet = true;
}

bool OAIWorldpay::is_token_Set() const{
    return m_token_isSet;
}

bool OAIWorldpay::is_token_Valid() const{
    return m_token_isValid;
}

QDateTime OAIWorldpay::getUpdatedTime() const {
    return m_updated_time;
}
void OAIWorldpay::setUpdatedTime(const QDateTime &updated_time) {
    m_updated_time = updated_time;
    m_updated_time_isSet = true;
}

bool OAIWorldpay::is_updated_time_Set() const{
    return m_updated_time_isSet;
}

bool OAIWorldpay::is_updated_time_Valid() const{
    return m_updated_time_isValid;
}

OAIWorldpay_allOf_credentials OAIWorldpay::getCredentials() const {
    return m_credentials;
}
void OAIWorldpay::setCredentials(const OAIWorldpay_allOf_credentials &credentials) {
    m_credentials = credentials;
    m_credentials_isSet = true;
}

bool OAIWorldpay::is_credentials_Set() const{
    return m_credentials_isSet;
}

bool OAIWorldpay::is_credentials_Valid() const{
    return m_credentials_isValid;
}

OAIWorldpay_allOf_settings OAIWorldpay::getSettings() const {
    return m_settings;
}
void OAIWorldpay::setSettings(const OAIWorldpay_allOf_settings &settings) {
    m_settings = settings;
    m_settings_isSet = true;
}

bool OAIWorldpay::is_settings_Set() const{
    return m_settings_isSet;
}

bool OAIWorldpay::is_settings_Valid() const{
    return m_settings_isValid;
}

OAIWorldpay3dsServers OAIWorldpay::getThreeDSecureServer() const {
    return m_three_d_secure_server;
}
void OAIWorldpay::setThreeDSecureServer(const OAIWorldpay3dsServers &three_d_secure_server) {
    m_three_d_secure_server = three_d_secure_server;
    m_three_d_secure_server_isSet = true;
}

bool OAIWorldpay::is_three_d_secure_server_Set() const{
    return m_three_d_secure_server_isSet;
}

bool OAIWorldpay::is_three_d_secure_server_Valid() const{
    return m_three_d_secure_server_isValid;
}

bool OAIWorldpay::isSet() const {
...
bool OAIWorldpay::isValid() const {
