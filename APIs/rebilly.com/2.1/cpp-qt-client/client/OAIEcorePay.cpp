...
OAIEcorePay::OAIEcorePay(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIEcorePay::OAIEcorePay() {
    this->initializeModel();
}

OAIEcorePay::~OAIEcorePay() {}

void OAIEcorePay::initializeModel() {
...
void OAIEcorePay::fromJson(QString jsonString) {
...
void OAIEcorePay::fromJsonObject(QJsonObject json) {
...
QString OAIEcorePay::asJson() const {
...
QJsonObject OAIEcorePay::asJsonObject() const {
    QJsonObject obj;
    if (m__links.size() > 0) {
...
QList<OAIGatewayAccount__links_inner> OAIEcorePay::getLinks() const {
    return m__links;
}
void OAIEcorePay::setLinks(const QList<OAIGatewayAccount__links_inner> &_links) {
    m__links = _links;
    m__links_isSet = true;
}

bool OAIEcorePay::is__links_Set() const{
    return m__links_isSet;
}

bool OAIEcorePay::is__links_Valid() const{
    return m__links_isValid;
}

QList<QString> OAIEcorePay::getAcceptedCurrencies() const {
    return m_accepted_currencies;
}
void OAIEcorePay::setAcceptedCurrencies(const QList<QString> &accepted_currencies) {
    m_accepted_currencies = accepted_currencies;
    m_accepted_currencies_isSet = true;
}

bool OAIEcorePay::is_accepted_currencies_Set() const{
    return m_accepted_currencies_isSet;
}

bool OAIEcorePay::is_accepted_currencies_Valid() const{
    return m_accepted_currencies_isValid;
}

OAIAcquirerName OAIEcorePay::getAcquirerName() const {
    return m_acquirer_name;
}
void OAIEcorePay::setAcquirerName(const OAIAcquirerName &acquirer_name) {
    m_acquirer_name = acquirer_name;
    m_acquirer_name_isSet = true;
}

bool OAIEcorePay::is_acquirer_name_Set() const{
    return m_acquirer_name_isSet;
}

bool OAIEcorePay::is_acquirer_name_Valid() const{
    return m_acquirer_name_isValid;
}

QString OAIEcorePay::getAdditionalFilters() const {
    return m_additional_filters;
}
void OAIEcorePay::setAdditionalFilters(const QString &additional_filters) {
    m_additional_filters = additional_filters;
    m_additional_filters_isSet = true;
}

bool OAIEcorePay::is_additional_filters_Set() const{
    return m_additional_filters_isSet;
}

bool OAIEcorePay::is_additional_filters_Valid() const{
    return m_additional_filters_isValid;
}

qint32 OAIEcorePay::getApprovalWindowTtl() const {
    return m_approval_window_ttl;
}
void OAIEcorePay::setApprovalWindowTtl(const qint32 &approval_window_ttl) {
    m_approval_window_ttl = approval_window_ttl;
    m_approval_window_ttl_isSet = true;
}

bool OAIEcorePay::is_approval_window_ttl_Set() const{
    return m_approval_window_ttl_isSet;
}

bool OAIEcorePay::is_approval_window_ttl_Valid() const{
    return m_approval_window_ttl_isValid;
}

QString OAIEcorePay::getCityField() const {
    return m_city_field;
}
void OAIEcorePay::setCityField(const QString &city_field) {
    m_city_field = city_field;
    m_city_field_isSet = true;
}

bool OAIEcorePay::is_city_field_Set() const{
    return m_city_field_isSet;
}

bool OAIEcorePay::is_city_field_Valid() const{
    return m_city_field_isValid;
}

QDateTime OAIEcorePay::getCreatedTime() const {
    return m_created_time;
}
void OAIEcorePay::setCreatedTime(const QDateTime &created_time) {
    m_created_time = created_time;
    m_created_time_isSet = true;
}

bool OAIEcorePay::is_created_time_Set() const{
    return m_created_time_isSet;
}

bool OAIEcorePay::is_created_time_Valid() const{
    return m_created_time_isValid;
}

QString OAIEcorePay::getDccForceCurrency() const {
    return m_dcc_force_currency;
}
void OAIEcorePay::setDccForceCurrency(const QString &dcc_force_currency) {
    m_dcc_force_currency = dcc_force_currency;
    m_dcc_force_currency_isSet = true;
}

bool OAIEcorePay::is_dcc_force_currency_Set() const{
    return m_dcc_force_currency_isSet;
}

bool OAIEcorePay::is_dcc_force_currency_Valid() const{
    return m_dcc_force_currency_isValid;
}

qint32 OAIEcorePay::getDccMarkup() const {
    return m_dcc_markup;
}
void OAIEcorePay::setDccMarkup(const qint32 &dcc_markup) {
    m_dcc_markup = dcc_markup;
    m_dcc_markup_isSet = true;
}

bool OAIEcorePay::is_dcc_markup_Set() const{
    return m_dcc_markup_isSet;
}

bool OAIEcorePay::is_dcc_markup_Valid() const{
    return m_dcc_markup_isValid;
}

QString OAIEcorePay::getDescriptor() const {
    return m_descriptor;
}
void OAIEcorePay::setDescriptor(const QString &descriptor) {
    m_descriptor = descriptor;
    m_descriptor_isSet = true;
}

bool OAIEcorePay::is_descriptor_Set() const{
    return m_descriptor_isSet;
}

bool OAIEcorePay::is_descriptor_Valid() const{
    return m_descriptor_isValid;
}

OAIDigitalWallets OAIEcorePay::getDigitalWallets() const {
    return m_digital_wallets;
}
void OAIEcorePay::setDigitalWallets(const OAIDigitalWallets &digital_wallets) {
    m_digital_wallets = digital_wallets;
    m_digital_wallets_isSet = true;
}

bool OAIEcorePay::is_digital_wallets_Set() const{
    return m_digital_wallets_isSet;
}

bool OAIEcorePay::is_digital_wallets_Valid() const{
    return m_digital_wallets_isValid;
}

bool OAIEcorePay::isDynamicDescriptor() const {
    return m_dynamic_descriptor;
}
void OAIEcorePay::setDynamicDescriptor(const bool &dynamic_descriptor) {
    m_dynamic_descriptor = dynamic_descriptor;
    m_dynamic_descriptor_isSet = true;
}

bool OAIEcorePay::is_dynamic_descriptor_Set() const{
    return m_dynamic_descriptor_isSet;
}

bool OAIEcorePay::is_dynamic_descriptor_Valid() const{
    return m_dynamic_descriptor_isValid;
}

QList<QString> OAIEcorePay::getExcludedDccQuoteCurrencies() const {
    return m_excluded_dcc_quote_currencies;
}
void OAIEcorePay::setExcludedDccQuoteCurrencies(const QList<QString> &excluded_dcc_quote_currencies) {
    m_excluded_dcc_quote_currencies = excluded_dcc_quote_currencies;
    m_excluded_dcc_quote_currencies_isSet = true;
}

bool OAIEcorePay::is_excluded_dcc_quote_currencies_Set() const{
    return m_excluded_dcc_quote_currencies_isSet;
}

bool OAIEcorePay::is_excluded_dcc_quote_currencies_Valid() const{
    return m_excluded_dcc_quote_currencies_isValid;
}

OAIGatewayName OAIEcorePay::getGatewayName() const {
    return m_gateway_name;
}
void OAIEcorePay::setGatewayName(const OAIGatewayName &gateway_name) {
    m_gateway_name = gateway_name;
    m_gateway_name_isSet = true;
}

bool OAIEcorePay::is_gateway_name_Set() const{
    return m_gateway_name_isSet;
}

bool OAIEcorePay::is_gateway_name_Valid() const{
    return m_gateway_name_isValid;
}

QString OAIEcorePay::getId() const {
    return m_id;
}
void OAIEcorePay::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIEcorePay::is_id_Set() const{
    return m_id_isSet;
}

bool OAIEcorePay::is_id_Valid() const{
    return m_id_isValid;
}

bool OAIEcorePay::isIsDown() const {
    return m_is_down;
}
void OAIEcorePay::setIsDown(const bool &is_down) {
    m_is_down = is_down;
    m_is_down_isSet = true;
}

bool OAIEcorePay::is_is_down_Set() const{
    return m_is_down_isSet;
}

bool OAIEcorePay::is_is_down_Valid() const{
    return m_is_down_isValid;
}

QString OAIEcorePay::getMerchantCategoryCode() const {
    return m_merchant_category_code;
}
void OAIEcorePay::setMerchantCategoryCode(const QString &merchant_category_code) {
    m_merchant_category_code = merchant_category_code;
    m_merchant_category_code_isSet = true;
}

bool OAIEcorePay::is_merchant_category_code_Set() const{
    return m_merchant_category_code_isSet;
}

bool OAIEcorePay::is_merchant_category_code_Valid() const{
    return m_merchant_category_code_isValid;
}

OAIPaymentMethod OAIEcorePay::getMethod() const {
    return m_method;
}
void OAIEcorePay::setMethod(const OAIPaymentMethod &method) {
    m_method = method;
    m_method_isSet = true;
}

bool OAIEcorePay::is_method_Set() const{
    return m_method_isSet;
}

bool OAIEcorePay::is_method_Valid() const{
    return m_method_isValid;
}

double OAIEcorePay::getMonthlyLimit() const {
    return m_monthly_limit;
}
void OAIEcorePay::setMonthlyLimit(const double &monthly_limit) {
    m_monthly_limit = monthly_limit;
    m_monthly_limit_isSet = true;
}

bool OAIEcorePay::is_monthly_limit_Set() const{
    return m_monthly_limit_isSet;
}

bool OAIEcorePay::is_monthly_limit_Valid() const{
    return m_monthly_limit_isValid;
}

QString OAIEcorePay::getOrganizationId() const {
    return m_organization_id;
}
void OAIEcorePay::setOrganizationId(const QString &organization_id) {
    m_organization_id = organization_id;
    m_organization_id_isSet = true;
}

bool OAIEcorePay::is_organization_id_Set() const{
    return m_organization_id_isSet;
}

bool OAIEcorePay::is_organization_id_Valid() const{
    return m_organization_id_isValid;
}

QList<OAIPaymentCardBrand> OAIEcorePay::getPaymentCardSchemes() const {
    return m_payment_card_schemes;
}
void OAIEcorePay::setPaymentCardSchemes(const QList<OAIPaymentCardBrand> &payment_card_schemes) {
    m_payment_card_schemes = payment_card_schemes;
    m_payment_card_schemes_isSet = true;
}

bool OAIEcorePay::is_payment_card_schemes_Set() const{
    return m_payment_card_schemes_isSet;
}

bool OAIEcorePay::is_payment_card_schemes_Valid() const{
    return m_payment_card_schemes_isValid;
}

bool OAIEcorePay::isReconciliationWindowEnabled() const {
    return m_reconciliation_window_enabled;
}
void OAIEcorePay::setReconciliationWindowEnabled(const bool &reconciliation_window_enabled) {
    m_reconciliation_window_enabled = reconciliation_window_enabled;
    m_reconciliation_window_enabled_isSet = true;
}

bool OAIEcorePay::is_reconciliation_window_enabled_Set() const{
    return m_reconciliation_window_enabled_isSet;
}

bool OAIEcorePay::is_reconciliation_window_enabled_Valid() const{
    return m_reconciliation_window_enabled_isValid;
}

qint32 OAIEcorePay::getReconciliationWindowTtl() const {
    return m_reconciliation_window_ttl;
}
void OAIEcorePay::setReconciliationWindowTtl(const qint32 &reconciliation_window_ttl) {
    m_reconciliation_window_ttl = reconciliation_window_ttl;
    m_reconciliation_window_ttl_isSet = true;
}

bool OAIEcorePay::is_reconciliation_window_ttl_Set() const{
    return m_reconciliation_window_ttl_isSet;
}

bool OAIEcorePay::is_reconciliation_window_ttl_Valid() const{
    return m_reconciliation_window_ttl_isValid;
}

QString OAIEcorePay::getStatus() const {
    return m_status;
}
void OAIEcorePay::setStatus(const QString &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIEcorePay::is_status_Set() const{
    return m_status_isSet;
}

bool OAIEcorePay::is_status_Valid() const{
    return m_status_isValid;
}

bool OAIEcorePay::isSticky() const {
    return m_sticky;
}
void OAIEcorePay::setSticky(const bool &sticky) {
    m_sticky = sticky;
    m_sticky_isSet = true;
}

bool OAIEcorePay::is_sticky_Set() const{
    return m_sticky_isSet;
}

bool OAIEcorePay::is_sticky_Valid() const{
    return m_sticky_isValid;
}

bool OAIEcorePay::isThreeDSecure() const {
    return m_three_d_secure;
}
void OAIEcorePay::setThreeDSecure(const bool &three_d_secure) {
    m_three_d_secure = three_d_secure;
    m_three_d_secure_isSet = true;
}

bool OAIEcorePay::is_three_d_secure_Set() const{
    return m_three_d_secure_isSet;
}

bool OAIEcorePay::is_three_d_secure_Valid() const{
    return m_three_d_secure_isValid;
}

qint32 OAIEcorePay::getTimeout() const {
    return m_timeout;
}
void OAIEcorePay::setTimeout(const qint32 &timeout) {
    m_timeout = timeout;
    m_timeout_isSet = true;
}

bool OAIEcorePay::is_timeout_Set() const{
    return m_timeout_isSet;
}

bool OAIEcorePay::is_timeout_Valid() const{
    return m_timeout_isValid;
}

QString OAIEcorePay::getToken() const {
    return m_token;
}
void OAIEcorePay::setToken(const QString &token) {
    m_token = token;
    m_token_isSet = true;
}

bool OAIEcorePay::is_token_Set() const{
    return m_token_isSet;
}

bool OAIEcorePay::is_token_Valid() const{
    return m_token_isValid;
}

QDateTime OAIEcorePay::getUpdatedTime() const {
    return m_updated_time;
}
void OAIEcorePay::setUpdatedTime(const QDateTime &updated_time) {
    m_updated_time = updated_time;
    m_updated_time_isSet = true;
}

bool OAIEcorePay::is_updated_time_Set() const{
    return m_updated_time_isSet;
}

bool OAIEcorePay::is_updated_time_Valid() const{
    return m_updated_time_isValid;
}

OAIEcorePay_allOf_credentials OAIEcorePay::getCredentials() const {
    return m_credentials;
}
void OAIEcorePay::setCredentials(const OAIEcorePay_allOf_credentials &credentials) {
    m_credentials = credentials;
    m_credentials_isSet = true;
}

bool OAIEcorePay::is_credentials_Set() const{
    return m_credentials_isSet;
}

bool OAIEcorePay::is_credentials_Valid() const{
    return m_credentials_isValid;
}

bool OAIEcorePay::isSet() const {
...
bool OAIEcorePay::isValid() const {
