...
OAIFinrax::OAIFinrax(QString json) {
...
void OAIFinrax::initializeModel() {
...
void OAIFinrax::fromJson(QString jsonString) {
...
void OAIFinrax::fromJsonObject(QJsonObject json) {
...
QString OAIFinrax::asJson() const {
...
QJsonObject OAIFinrax::asJsonObject() const {
    QJsonObject obj;
    if (m__links.size() > 0) {
...
QList<OAIGatewayAccount__links_inner> OAIFinrax::getLinks() const {
    return m__links;
}
void OAIFinrax::setLinks(const QList<OAIGatewayAccount__links_inner> &_links) {
    m__links = _links;
    m__links_isSet = true;
}

bool OAIFinrax::is__links_Set() const{
    return m__links_isSet;
}

bool OAIFinrax::is__links_Valid() const{
    return m__links_isValid;
}

QList<QString> OAIFinrax::getAcceptedCurrencies() const {
    return m_accepted_currencies;
}
void OAIFinrax::setAcceptedCurrencies(const QList<QString> &accepted_currencies) {
    m_accepted_currencies = accepted_currencies;
    m_accepted_currencies_isSet = true;
}

bool OAIFinrax::is_accepted_currencies_Set() const{
    return m_accepted_currencies_isSet;
}

bool OAIFinrax::is_accepted_currencies_Valid() const{
    return m_accepted_currencies_isValid;
}

OAIAcquirerName OAIFinrax::getAcquirerName() const {
    return m_acquirer_name;
}
void OAIFinrax::setAcquirerName(const OAIAcquirerName &acquirer_name) {
    m_acquirer_name = acquirer_name;
    m_acquirer_name_isSet = true;
}

bool OAIFinrax::is_acquirer_name_Set() const{
    return m_acquirer_name_isSet;
}

bool OAIFinrax::is_acquirer_name_Valid() const{
    return m_acquirer_name_isValid;
}

QString OAIFinrax::getAdditionalFilters() const {
    return m_additional_filters;
}
void OAIFinrax::setAdditionalFilters(const QString &additional_filters) {
    m_additional_filters = additional_filters;
    m_additional_filters_isSet = true;
}

bool OAIFinrax::is_additional_filters_Set() const{
    return m_additional_filters_isSet;
}

bool OAIFinrax::is_additional_filters_Valid() const{
    return m_additional_filters_isValid;
}

qint32 OAIFinrax::getApprovalWindowTtl() const {
    return m_approval_window_ttl;
}
void OAIFinrax::setApprovalWindowTtl(const qint32 &approval_window_ttl) {
    m_approval_window_ttl = approval_window_ttl;
    m_approval_window_ttl_isSet = true;
}

bool OAIFinrax::is_approval_window_ttl_Set() const{
    return m_approval_window_ttl_isSet;
}

bool OAIFinrax::is_approval_window_ttl_Valid() const{
    return m_approval_window_ttl_isValid;
}

QString OAIFinrax::getCityField() const {
    return m_city_field;
}
void OAIFinrax::setCityField(const QString &city_field) {
    m_city_field = city_field;
    m_city_field_isSet = true;
}

bool OAIFinrax::is_city_field_Set() const{
    return m_city_field_isSet;
}

bool OAIFinrax::is_city_field_Valid() const{
    return m_city_field_isValid;
}

QDateTime OAIFinrax::getCreatedTime() const {
    return m_created_time;
}
void OAIFinrax::setCreatedTime(const QDateTime &created_time) {
    m_created_time = created_time;
    m_created_time_isSet = true;
}

bool OAIFinrax::is_created_time_Set() const{
    return m_created_time_isSet;
}

bool OAIFinrax::is_created_time_Valid() const{
    return m_created_time_isValid;
}

QString OAIFinrax::getDccForceCurrency() const {
    return m_dcc_force_currency;
}
void OAIFinrax::setDccForceCurrency(const QString &dcc_force_currency) {
    m_dcc_force_currency = dcc_force_currency;
    m_dcc_force_currency_isSet = true;
}

bool OAIFinrax::is_dcc_force_currency_Set() const{
    return m_dcc_force_currency_isSet;
}

bool OAIFinrax::is_dcc_force_currency_Valid() const{
    return m_dcc_force_currency_isValid;
}

qint32 OAIFinrax::getDccMarkup() const {
    return m_dcc_markup;
}
void OAIFinrax::setDccMarkup(const qint32 &dcc_markup) {
    m_dcc_markup = dcc_markup;
    m_dcc_markup_isSet = true;
}

bool OAIFinrax::is_dcc_markup_Set() const{
    return m_dcc_markup_isSet;
}

bool OAIFinrax::is_dcc_markup_Valid() const{
    return m_dcc_markup_isValid;
}

QString OAIFinrax::getDescriptor() const {
    return m_descriptor;
}
void OAIFinrax::setDescriptor(const QString &descriptor) {
    m_descriptor = descriptor;
    m_descriptor_isSet = true;
}

bool OAIFinrax::is_descriptor_Set() const{
    return m_descriptor_isSet;
}

bool OAIFinrax::is_descriptor_Valid() const{
    return m_descriptor_isValid;
}

OAIDigitalWallets OAIFinrax::getDigitalWallets() const {
    return m_digital_wallets;
}
void OAIFinrax::setDigitalWallets(const OAIDigitalWallets &digital_wallets) {
    m_digital_wallets = digital_wallets;
    m_digital_wallets_isSet = true;
}

bool OAIFinrax::is_digital_wallets_Set() const{
    return m_digital_wallets_isSet;
}

bool OAIFinrax::is_digital_wallets_Valid() const{
    return m_digital_wallets_isValid;
}

bool OAIFinrax::isDynamicDescriptor() const {
    return m_dynamic_descriptor;
}
void OAIFinrax::setDynamicDescriptor(const bool &dynamic_descriptor) {
    m_dynamic_descriptor = dynamic_descriptor;
    m_dynamic_descriptor_isSet = true;
}

bool OAIFinrax::is_dynamic_descriptor_Set() const{
    return m_dynamic_descriptor_isSet;
}

bool OAIFinrax::is_dynamic_descriptor_Valid() const{
    return m_dynamic_descriptor_isValid;
}

QList<QString> OAIFinrax::getExcludedDccQuoteCurrencies() const {
    return m_excluded_dcc_quote_currencies;
}
void OAIFinrax::setExcludedDccQuoteCurrencies(const QList<QString> &excluded_dcc_quote_currencies) {
    m_excluded_dcc_quote_currencies = excluded_dcc_quote_currencies;
    m_excluded_dcc_quote_currencies_isSet = true;
}

bool OAIFinrax::is_excluded_dcc_quote_currencies_Set() const{
    return m_excluded_dcc_quote_currencies_isSet;
}

bool OAIFinrax::is_excluded_dcc_quote_currencies_Valid() const{
    return m_excluded_dcc_quote_currencies_isValid;
}

OAIGatewayName OAIFinrax::getGatewayName() const {
    return m_gateway_name;
}
void OAIFinrax::setGatewayName(const OAIGatewayName &gateway_name) {
    m_gateway_name = gateway_name;
    m_gateway_name_isSet = true;
}

bool OAIFinrax::is_gateway_name_Set() const{
    return m_gateway_name_isSet;
}

bool OAIFinrax::is_gateway_name_Valid() const{
    return m_gateway_name_isValid;
}

QString OAIFinrax::getId() const {
    return m_id;
}
void OAIFinrax::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIFinrax::is_id_Set() const{
    return m_id_isSet;
}

bool OAIFinrax::is_id_Valid() const{
    return m_id_isValid;
}

bool OAIFinrax::isIsDown() const {
    return m_is_down;
}
void OAIFinrax::setIsDown(const bool &is_down) {
    m_is_down = is_down;
    m_is_down_isSet = true;
}

bool OAIFinrax::is_is_down_Set() const{
    return m_is_down_isSet;
}

bool OAIFinrax::is_is_down_Valid() const{
    return m_is_down_isValid;
}

QString OAIFinrax::getMerchantCategoryCode() const {
    return m_merchant_category_code;
}
void OAIFinrax::setMerchantCategoryCode(const QString &merchant_category_code) {
    m_merchant_category_code = merchant_category_code;
    m_merchant_category_code_isSet = true;
}

bool OAIFinrax::is_merchant_category_code_Set() const{
    return m_merchant_category_code_isSet;
}

bool OAIFinrax::is_merchant_category_code_Valid() const{
    return m_merchant_category_code_isValid;
}

OAIPaymentMethod OAIFinrax::getMethod() const {
    return m_method;
}
void OAIFinrax::setMethod(const OAIPaymentMethod &method) {
    m_method = method;
    m_method_isSet = true;
}

bool OAIFinrax::is_method_Set() const{
    return m_method_isSet;
}

bool OAIFinrax::is_method_Valid() const{
    return m_method_isValid;
}

double OAIFinrax::getMonthlyLimit() const {
    return m_monthly_limit;
}
void OAIFinrax::setMonthlyLimit(const double &monthly_limit) {
    m_monthly_limit = monthly_limit;
    m_monthly_limit_isSet = true;
}

bool OAIFinrax::is_monthly_limit_Set() const{
    return m_monthly_limit_isSet;
}

bool OAIFinrax::is_monthly_limit_Valid() const{
    return m_monthly_limit_isValid;
}

QString OAIFinrax::getOrganizationId() const {
    return m_organization_id;
}
void OAIFinrax::setOrganizationId(const QString &organization_id) {
    m_organization_id = organization_id;
    m_organization_id_isSet = true;
}

bool OAIFinrax::is_organization_id_Set() const{
    return m_organization_id_isSet;
}

bool OAIFinrax::is_organization_id_Valid() const{
    return m_organization_id_isValid;
}

QList<OAIPaymentCardBrand> OAIFinrax::getPaymentCardSchemes() const {
    return m_payment_card_schemes;
}
void OAIFinrax::setPaymentCardSchemes(const QList<OAIPaymentCardBrand> &payment_card_schemes) {
    m_payment_card_schemes = payment_card_schemes;
    m_payment_card_schemes_isSet = true;
}

bool OAIFinrax::is_payment_card_schemes_Set() const{
    return m_payment_card_schemes_isSet;
}

bool OAIFinrax::is_payment_card_schemes_Valid() const{
    return m_payment_card_schemes_isValid;
}

bool OAIFinrax::isReconciliationWindowEnabled() const {
    return m_reconciliation_window_enabled;
}
void OAIFinrax::setReconciliationWindowEnabled(const bool &reconciliation_window_enabled) {
    m_reconciliation_window_enabled = reconciliation_window_enabled;
    m_reconciliation_window_enabled_isSet = true;
}

bool OAIFinrax::is_reconciliation_window_enabled_Set() const{
    return m_reconciliation_window_enabled_isSet;
}

bool OAIFinrax::is_reconciliation_window_enabled_Valid() const{
    return m_reconciliation_window_enabled_isValid;
}

qint32 OAIFinrax::getReconciliationWindowTtl() const {
    return m_reconciliation_window_ttl;
}
void OAIFinrax::setReconciliationWindowTtl(const qint32 &reconciliation_window_ttl) {
    m_reconciliation_window_ttl = reconciliation_window_ttl;
    m_reconciliation_window_ttl_isSet = true;
}

bool OAIFinrax::is_reconciliation_window_ttl_Set() const{
    return m_reconciliation_window_ttl_isSet;
}

bool OAIFinrax::is_reconciliation_window_ttl_Valid() const{
    return m_reconciliation_window_ttl_isValid;
}

QString OAIFinrax::getStatus() const {
    return m_status;
}
void OAIFinrax::setStatus(const QString &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIFinrax::is_status_Set() const{
    return m_status_isSet;
}

bool OAIFinrax::is_status_Valid() const{
    return m_status_isValid;
}

bool OAIFinrax::isSticky() const {
    return m_sticky;
}
void OAIFinrax::setSticky(const bool &sticky) {
    m_sticky = sticky;
    m_sticky_isSet = true;
}

bool OAIFinrax::is_sticky_Set() const{
    return m_sticky_isSet;
}

bool OAIFinrax::is_sticky_Valid() const{
    return m_sticky_isValid;
}

bool OAIFinrax::isThreeDSecure() const {
    return m_three_d_secure;
}
void OAIFinrax::setThreeDSecure(const bool &three_d_secure) {
    m_three_d_secure = three_d_secure;
    m_three_d_secure_isSet = true;
}

bool OAIFinrax::is_three_d_secure_Set() const{
    return m_three_d_secure_isSet;
}

bool OAIFinrax::is_three_d_secure_Valid() const{
    return m_three_d_secure_isValid;
}

qint32 OAIFinrax::getTimeout() const {
    return m_timeout;
}
void OAIFinrax::setTimeout(const qint32 &timeout) {
    m_timeout = timeout;
    m_timeout_isSet = true;
}

bool OAIFinrax::is_timeout_Set() const{
    return m_timeout_isSet;
}

bool OAIFinrax::is_timeout_Valid() const{
    return m_timeout_isValid;
}

QString OAIFinrax::getToken() const {
    return m_token;
}
void OAIFinrax::setToken(const QString &token) {
    m_token = token;
    m_token_isSet = true;
}

bool OAIFinrax::is_token_Set() const{
    return m_token_isSet;
}

bool OAIFinrax::is_token_Valid() const{
    return m_token_isValid;
}

QDateTime OAIFinrax::getUpdatedTime() const {
    return m_updated_time;
}
void OAIFinrax::setUpdatedTime(const QDateTime &updated_time) {
    m_updated_time = updated_time;
    m_updated_time_isSet = true;
}

bool OAIFinrax::is_updated_time_Set() const{
    return m_updated_time_isSet;
}

bool OAIFinrax::is_updated_time_Valid() const{
    return m_updated_time_isValid;
}

OAIFinrax_allOf_credentials OAIFinrax::getCredentials() const {
    return m_credentials;
}
void OAIFinrax::setCredentials(const OAIFinrax_allOf_credentials &credentials) {
    m_credentials = credentials;
    m_credentials_isSet = true;
}

bool OAIFinrax::is_credentials_Set() const{
    return m_credentials_isSet;
}

bool OAIFinrax::is_credentials_Valid() const{
    return m_credentials_isValid;
}

OAIFinrax_allOf_settings OAIFinrax::getSettings() const {
    return m_settings;
}
void OAIFinrax::setSettings(const OAIFinrax_allOf_settings &settings) {
    m_settings = settings;
    m_settings_isSet = true;
}

bool OAIFinrax::is_settings_Set() const{
    return m_settings_isSet;
}

bool OAIFinrax::is_settings_Valid() const{
    return m_settings_isValid;
}

bool OAIFinrax::isSet() const {
