...
OAIPaymentAsia::OAIPaymentAsia(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPaymentAsia::OAIPaymentAsia() {
    this->initializeModel();
}

OAIPaymentAsia::~OAIPaymentAsia() {}

void OAIPaymentAsia::initializeModel() {
...
void OAIPaymentAsia::fromJson(QString jsonString) {
...
void OAIPaymentAsia::fromJsonObject(QJsonObject json) {
...
QString OAIPaymentAsia::asJson() const {
...
QJsonObject OAIPaymentAsia::asJsonObject() const {
    QJsonObject obj;
    if (m__links.size() > 0) {
...
QList<OAIGatewayAccount__links_inner> OAIPaymentAsia::getLinks() const {
    return m__links;
}
void OAIPaymentAsia::setLinks(const QList<OAIGatewayAccount__links_inner> &_links) {
    m__links = _links;
    m__links_isSet = true;
}

bool OAIPaymentAsia::is__links_Set() const{
    return m__links_isSet;
}

bool OAIPaymentAsia::is__links_Valid() const{
    return m__links_isValid;
}

QList<QString> OAIPaymentAsia::getAcceptedCurrencies() const {
    return m_accepted_currencies;
}
void OAIPaymentAsia::setAcceptedCurrencies(const QList<QString> &accepted_currencies) {
    m_accepted_currencies = accepted_currencies;
    m_accepted_currencies_isSet = true;
}

bool OAIPaymentAsia::is_accepted_currencies_Set() const{
    return m_accepted_currencies_isSet;
}

bool OAIPaymentAsia::is_accepted_currencies_Valid() const{
    return m_accepted_currencies_isValid;
}

OAIAcquirerName OAIPaymentAsia::getAcquirerName() const {
    return m_acquirer_name;
}
void OAIPaymentAsia::setAcquirerName(const OAIAcquirerName &acquirer_name) {
    m_acquirer_name = acquirer_name;
    m_acquirer_name_isSet = true;
}

bool OAIPaymentAsia::is_acquirer_name_Set() const{
    return m_acquirer_name_isSet;
}

bool OAIPaymentAsia::is_acquirer_name_Valid() const{
    return m_acquirer_name_isValid;
}

QString OAIPaymentAsia::getAdditionalFilters() const {
    return m_additional_filters;
}
void OAIPaymentAsia::setAdditionalFilters(const QString &additional_filters) {
    m_additional_filters = additional_filters;
    m_additional_filters_isSet = true;
}

bool OAIPaymentAsia::is_additional_filters_Set() const{
    return m_additional_filters_isSet;
}

bool OAIPaymentAsia::is_additional_filters_Valid() const{
    return m_additional_filters_isValid;
}

qint32 OAIPaymentAsia::getApprovalWindowTtl() const {
    return m_approval_window_ttl;
}
void OAIPaymentAsia::setApprovalWindowTtl(const qint32 &approval_window_ttl) {
    m_approval_window_ttl = approval_window_ttl;
    m_approval_window_ttl_isSet = true;
}

bool OAIPaymentAsia::is_approval_window_ttl_Set() const{
    return m_approval_window_ttl_isSet;
}

bool OAIPaymentAsia::is_approval_window_ttl_Valid() const{
    return m_approval_window_ttl_isValid;
}

QString OAIPaymentAsia::getCityField() const {
    return m_city_field;
}
void OAIPaymentAsia::setCityField(const QString &city_field) {
    m_city_field = city_field;
    m_city_field_isSet = true;
}

bool OAIPaymentAsia::is_city_field_Set() const{
    return m_city_field_isSet;
}

bool OAIPaymentAsia::is_city_field_Valid() const{
    return m_city_field_isValid;
}

QDateTime OAIPaymentAsia::getCreatedTime() const {
    return m_created_time;
}
void OAIPaymentAsia::setCreatedTime(const QDateTime &created_time) {
    m_created_time = created_time;
    m_created_time_isSet = true;
}

bool OAIPaymentAsia::is_created_time_Set() const{
    return m_created_time_isSet;
}

bool OAIPaymentAsia::is_created_time_Valid() const{
    return m_created_time_isValid;
}

QString OAIPaymentAsia::getDccForceCurrency() const {
    return m_dcc_force_currency;
}
void OAIPaymentAsia::setDccForceCurrency(const QString &dcc_force_currency) {
    m_dcc_force_currency = dcc_force_currency;
    m_dcc_force_currency_isSet = true;
}

bool OAIPaymentAsia::is_dcc_force_currency_Set() const{
    return m_dcc_force_currency_isSet;
}

bool OAIPaymentAsia::is_dcc_force_currency_Valid() const{
    return m_dcc_force_currency_isValid;
}

qint32 OAIPaymentAsia::getDccMarkup() const {
    return m_dcc_markup;
}
void OAIPaymentAsia::setDccMarkup(const qint32 &dcc_markup) {
    m_dcc_markup = dcc_markup;
    m_dcc_markup_isSet = true;
}

bool OAIPaymentAsia::is_dcc_markup_Set() const{
    return m_dcc_markup_isSet;
}

bool OAIPaymentAsia::is_dcc_markup_Valid() const{
    return m_dcc_markup_isValid;
}

QString OAIPaymentAsia::getDescriptor() const {
    return m_descriptor;
}
void OAIPaymentAsia::setDescriptor(const QString &descriptor) {
    m_descriptor = descriptor;
    m_descriptor_isSet = true;
}

bool OAIPaymentAsia::is_descriptor_Set() const{
    return m_descriptor_isSet;
}

bool OAIPaymentAsia::is_descriptor_Valid() const{
    return m_descriptor_isValid;
}

OAIDigitalWallets OAIPaymentAsia::getDigitalWallets() const {
    return m_digital_wallets;
}
void OAIPaymentAsia::setDigitalWallets(const OAIDigitalWallets &digital_wallets) {
    m_digital_wallets = digital_wallets;
    m_digital_wallets_isSet = true;
}

bool OAIPaymentAsia::is_digital_wallets_Set() const{
    return m_digital_wallets_isSet;
}

bool OAIPaymentAsia::is_digital_wallets_Valid() const{
    return m_digital_wallets_isValid;
}

bool OAIPaymentAsia::isDynamicDescriptor() const {
    return m_dynamic_descriptor;
}
void OAIPaymentAsia::setDynamicDescriptor(const bool &dynamic_descriptor) {
    m_dynamic_descriptor = dynamic_descriptor;
    m_dynamic_descriptor_isSet = true;
}

bool OAIPaymentAsia::is_dynamic_descriptor_Set() const{
    return m_dynamic_descriptor_isSet;
}

bool OAIPaymentAsia::is_dynamic_descriptor_Valid() const{
    return m_dynamic_descriptor_isValid;
}

QList<QString> OAIPaymentAsia::getExcludedDccQuoteCurrencies() const {
    return m_excluded_dcc_quote_currencies;
}
void OAIPaymentAsia::setExcludedDccQuoteCurrencies(const QList<QString> &excluded_dcc_quote_currencies) {
    m_excluded_dcc_quote_currencies = excluded_dcc_quote_currencies;
    m_excluded_dcc_quote_currencies_isSet = true;
}

bool OAIPaymentAsia::is_excluded_dcc_quote_currencies_Set() const{
    return m_excluded_dcc_quote_currencies_isSet;
}

bool OAIPaymentAsia::is_excluded_dcc_quote_currencies_Valid() const{
    return m_excluded_dcc_quote_currencies_isValid;
}

OAIGatewayName OAIPaymentAsia::getGatewayName() const {
    return m_gateway_name;
}
void OAIPaymentAsia::setGatewayName(const OAIGatewayName &gateway_name) {
    m_gateway_name = gateway_name;
    m_gateway_name_isSet = true;
}

bool OAIPaymentAsia::is_gateway_name_Set() const{
    return m_gateway_name_isSet;
}

bool OAIPaymentAsia::is_gateway_name_Valid() const{
    return m_gateway_name_isValid;
}

QString OAIPaymentAsia::getId() const {
    return m_id;
}
void OAIPaymentAsia::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIPaymentAsia::is_id_Set() const{
    return m_id_isSet;
}

bool OAIPaymentAsia::is_id_Valid() const{
    return m_id_isValid;
}

bool OAIPaymentAsia::isIsDown() const {
    return m_is_down;
}
void OAIPaymentAsia::setIsDown(const bool &is_down) {
    m_is_down = is_down;
    m_is_down_isSet = true;
}

bool OAIPaymentAsia::is_is_down_Set() const{
    return m_is_down_isSet;
}

bool OAIPaymentAsia::is_is_down_Valid() const{
    return m_is_down_isValid;
}

QString OAIPaymentAsia::getMerchantCategoryCode() const {
    return m_merchant_category_code;
}
void OAIPaymentAsia::setMerchantCategoryCode(const QString &merchant_category_code) {
    m_merchant_category_code = merchant_category_code;
    m_merchant_category_code_isSet = true;
}

bool OAIPaymentAsia::is_merchant_category_code_Set() const{
    return m_merchant_category_code_isSet;
}

bool OAIPaymentAsia::is_merchant_category_code_Valid() const{
    return m_merchant_category_code_isValid;
}

OAIPaymentMethod OAIPaymentAsia::getMethod() const {
    return m_method;
}
void OAIPaymentAsia::setMethod(const OAIPaymentMethod &method) {
    m_method = method;
    m_method_isSet = true;
}

bool OAIPaymentAsia::is_method_Set() const{
    return m_method_isSet;
}

bool OAIPaymentAsia::is_method_Valid() const{
    return m_method_isValid;
}

double OAIPaymentAsia::getMonthlyLimit() const {
    return m_monthly_limit;
}
void OAIPaymentAsia::setMonthlyLimit(const double &monthly_limit) {
    m_monthly_limit = monthly_limit;
    m_monthly_limit_isSet = true;
}

bool OAIPaymentAsia::is_monthly_limit_Set() const{
    return m_monthly_limit_isSet;
}

bool OAIPaymentAsia::is_monthly_limit_Valid() const{
    return m_monthly_limit_isValid;
}

QString OAIPaymentAsia::getOrganizationId() const {
    return m_organization_id;
}
void OAIPaymentAsia::setOrganizationId(const QString &organization_id) {
    m_organization_id = organization_id;
    m_organization_id_isSet = true;
}

bool OAIPaymentAsia::is_organization_id_Set() const{
    return m_organization_id_isSet;
}

bool OAIPaymentAsia::is_organization_id_Valid() const{
    return m_organization_id_isValid;
}

QList<OAIPaymentCardBrand> OAIPaymentAsia::getPaymentCardSchemes() const {
    return m_payment_card_schemes;
}
void OAIPaymentAsia::setPaymentCardSchemes(const QList<OAIPaymentCardBrand> &payment_card_schemes) {
    m_payment_card_schemes = payment_card_schemes;
    m_payment_card_schemes_isSet = true;
}

bool OAIPaymentAsia::is_payment_card_schemes_Set() const{
    return m_payment_card_schemes_isSet;
}

bool OAIPaymentAsia::is_payment_card_schemes_Valid() const{
    return m_payment_card_schemes_isValid;
}

bool OAIPaymentAsia::isReconciliationWindowEnabled() const {
    return m_reconciliation_window_enabled;
}
void OAIPaymentAsia::setReconciliationWindowEnabled(const bool &reconciliation_window_enabled) {
    m_reconciliation_window_enabled = reconciliation_window_enabled;
    m_reconciliation_window_enabled_isSet = true;
}

bool OAIPaymentAsia::is_reconciliation_window_enabled_Set() const{
    return m_reconciliation_window_enabled_isSet;
}

bool OAIPaymentAsia::is_reconciliation_window_enabled_Valid() const{
    return m_reconciliation_window_enabled_isValid;
}

qint32 OAIPaymentAsia::getReconciliationWindowTtl() const {
    return m_reconciliation_window_ttl;
}
void OAIPaymentAsia::setReconciliationWindowTtl(const qint32 &reconciliation_window_ttl) {
    m_reconciliation_window_ttl = reconciliation_window_ttl;
    m_reconciliation_window_ttl_isSet = true;
}

bool OAIPaymentAsia::is_reconciliation_window_ttl_Set() const{
    return m_reconciliation_window_ttl_isSet;
}

bool OAIPaymentAsia::is_reconciliation_window_ttl_Valid() const{
    return m_reconciliation_window_ttl_isValid;
}

QString OAIPaymentAsia::getStatus() const {
    return m_status;
}
void OAIPaymentAsia::setStatus(const QString &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIPaymentAsia::is_status_Set() const{
    return m_status_isSet;
}

bool OAIPaymentAsia::is_status_Valid() const{
    return m_status_isValid;
}

bool OAIPaymentAsia::isSticky() const {
    return m_sticky;
}
void OAIPaymentAsia::setSticky(const bool &sticky) {
    m_sticky = sticky;
    m_sticky_isSet = true;
}

bool OAIPaymentAsia::is_sticky_Set() const{
    return m_sticky_isSet;
}

bool OAIPaymentAsia::is_sticky_Valid() const{
    return m_sticky_isValid;
}

bool OAIPaymentAsia::isThreeDSecure() const {
    return m_three_d_secure;
}
void OAIPaymentAsia::setThreeDSecure(const bool &three_d_secure) {
    m_three_d_secure = three_d_secure;
    m_three_d_secure_isSet = true;
}

bool OAIPaymentAsia::is_three_d_secure_Set() const{
    return m_three_d_secure_isSet;
}

bool OAIPaymentAsia::is_three_d_secure_Valid() const{
    return m_three_d_secure_isValid;
}

qint32 OAIPaymentAsia::getTimeout() const {
    return m_timeout;
}
void OAIPaymentAsia::setTimeout(const qint32 &timeout) {
    m_timeout = timeout;
    m_timeout_isSet = true;
}

bool OAIPaymentAsia::is_timeout_Set() const{
    return m_timeout_isSet;
}

bool OAIPaymentAsia::is_timeout_Valid() const{
    return m_timeout_isValid;
}

QString OAIPaymentAsia::getToken() const {
    return m_token;
}
void OAIPaymentAsia::setToken(const QString &token) {
    m_token = token;
    m_token_isSet = true;
}

bool OAIPaymentAsia::is_token_Set() const{
    return m_token_isSet;
}

bool OAIPaymentAsia::is_token_Valid() const{
    return m_token_isValid;
}

QDateTime OAIPaymentAsia::getUpdatedTime() const {
    return m_updated_time;
}
void OAIPaymentAsia::setUpdatedTime(const QDateTime &updated_time) {
    m_updated_time = updated_time;
    m_updated_time_isSet = true;
}

bool OAIPaymentAsia::is_updated_time_Set() const{
    return m_updated_time_isSet;
}

bool OAIPaymentAsia::is_updated_time_Valid() const{
    return m_updated_time_isValid;
}

OAIPaymentAsia_allOf_credentials OAIPaymentAsia::getCredentials() const {
    return m_credentials;
}
void OAIPaymentAsia::setCredentials(const OAIPaymentAsia_allOf_credentials &credentials) {
    m_credentials = credentials;
    m_credentials_isSet = true;
}

bool OAIPaymentAsia::is_credentials_Set() const{
    return m_credentials_isSet;
}

bool OAIPaymentAsia::is_credentials_Valid() const{
    return m_credentials_isValid;
}

bool OAIPaymentAsia::isSet() const {
...
bool OAIPaymentAsia::isValid() const {
