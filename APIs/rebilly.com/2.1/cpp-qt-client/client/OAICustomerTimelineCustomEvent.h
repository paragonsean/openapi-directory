...
/*
 * OAICustomerTimelineCustomEvent.h
 *
 * 
 */

#ifndef OAICustomerTimelineCustomEvent_H
#define OAICustomerTimelineCustomEvent_H
...
class OAICustomerTimelineCustomEvent : public OAIObject {
public:
    OAICustomerTimelineCustomEvent();
    OAICustomerTimelineCustomEvent(QString json);
    ~OAICustomerTimelineCustomEvent() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICustomerTimelineCustomEvent)

#endif // OAICustomerTimelineCustomEvent_H
