...
OAICardknox::OAICardknox(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICardknox::OAICardknox() {
    this->initializeModel();
}

OAICardknox::~OAICardknox() {}

void OAICardknox::initializeModel() {
...
void OAICardknox::fromJson(QString jsonString) {
...
void OAICardknox::fromJsonObject(QJsonObject json) {
...
QString OAICardknox::asJson() const {
...
QJsonObject OAICardknox::asJsonObject() const {
    QJsonObject obj;
    if (m__links.size() > 0) {
...
QList<OAIGatewayAccount__links_inner> OAICardknox::getLinks() const {
    return m__links;
}
void OAICardknox::setLinks(const QList<OAIGatewayAccount__links_inner> &_links) {
    m__links = _links;
    m__links_isSet = true;
}

bool OAICardknox::is__links_Set() const{
    return m__links_isSet;
}

bool OAICardknox::is__links_Valid() const{
    return m__links_isValid;
}

QList<QString> OAICardknox::getAcceptedCurrencies() const {
    return m_accepted_currencies;
}
void OAICardknox::setAcceptedCurrencies(const QList<QString> &accepted_currencies) {
    m_accepted_currencies = accepted_currencies;
    m_accepted_currencies_isSet = true;
}

bool OAICardknox::is_accepted_currencies_Set() const{
    return m_accepted_currencies_isSet;
}

bool OAICardknox::is_accepted_currencies_Valid() const{
    return m_accepted_currencies_isValid;
}

OAIAcquirerName OAICardknox::getAcquirerName() const {
    return m_acquirer_name;
}
void OAICardknox::setAcquirerName(const OAIAcquirerName &acquirer_name) {
    m_acquirer_name = acquirer_name;
    m_acquirer_name_isSet = true;
}

bool OAICardknox::is_acquirer_name_Set() const{
    return m_acquirer_name_isSet;
}

bool OAICardknox::is_acquirer_name_Valid() const{
    return m_acquirer_name_isValid;
}

QString OAICardknox::getAdditionalFilters() const {
    return m_additional_filters;
}
void OAICardknox::setAdditionalFilters(const QString &additional_filters) {
    m_additional_filters = additional_filters;
    m_additional_filters_isSet = true;
}

bool OAICardknox::is_additional_filters_Set() const{
    return m_additional_filters_isSet;
}

bool OAICardknox::is_additional_filters_Valid() const{
    return m_additional_filters_isValid;
}

qint32 OAICardknox::getApprovalWindowTtl() const {
    return m_approval_window_ttl;
}
void OAICardknox::setApprovalWindowTtl(const qint32 &approval_window_ttl) {
    m_approval_window_ttl = approval_window_ttl;
    m_approval_window_ttl_isSet = true;
}

bool OAICardknox::is_approval_window_ttl_Set() const{
    return m_approval_window_ttl_isSet;
}

bool OAICardknox::is_approval_window_ttl_Valid() const{
    return m_approval_window_ttl_isValid;
}

QString OAICardknox::getCityField() const {
    return m_city_field;
}
void OAICardknox::setCityField(const QString &city_field) {
    m_city_field = city_field;
    m_city_field_isSet = true;
}

bool OAICardknox::is_city_field_Set() const{
    return m_city_field_isSet;
}

bool OAICardknox::is_city_field_Valid() const{
    return m_city_field_isValid;
}

QDateTime OAICardknox::getCreatedTime() const {
    return m_created_time;
}
void OAICardknox::setCreatedTime(const QDateTime &created_time) {
    m_created_time = created_time;
    m_created_time_isSet = true;
}

bool OAICardknox::is_created_time_Set() const{
    return m_created_time_isSet;
}

bool OAICardknox::is_created_time_Valid() const{
    return m_created_time_isValid;
}

QString OAICardknox::getDccForceCurrency() const {
    return m_dcc_force_currency;
}
void OAICardknox::setDccForceCurrency(const QString &dcc_force_currency) {
    m_dcc_force_currency = dcc_force_currency;
    m_dcc_force_currency_isSet = true;
}

bool OAICardknox::is_dcc_force_currency_Set() const{
    return m_dcc_force_currency_isSet;
}

bool OAICardknox::is_dcc_force_currency_Valid() const{
    return m_dcc_force_currency_isValid;
}

qint32 OAICardknox::getDccMarkup() const {
    return m_dcc_markup;
}
void OAICardknox::setDccMarkup(const qint32 &dcc_markup) {
    m_dcc_markup = dcc_markup;
    m_dcc_markup_isSet = true;
}

bool OAICardknox::is_dcc_markup_Set() const{
    return m_dcc_markup_isSet;
}

bool OAICardknox::is_dcc_markup_Valid() const{
    return m_dcc_markup_isValid;
}

QString OAICardknox::getDescriptor() const {
    return m_descriptor;
}
void OAICardknox::setDescriptor(const QString &descriptor) {
    m_descriptor = descriptor;
    m_descriptor_isSet = true;
}

bool OAICardknox::is_descriptor_Set() const{
    return m_descriptor_isSet;
}

bool OAICardknox::is_descriptor_Valid() const{
    return m_descriptor_isValid;
}

OAIDigitalWallets OAICardknox::getDigitalWallets() const {
    return m_digital_wallets;
}
void OAICardknox::setDigitalWallets(const OAIDigitalWallets &digital_wallets) {
    m_digital_wallets = digital_wallets;
    m_digital_wallets_isSet = true;
}

bool OAICardknox::is_digital_wallets_Set() const{
    return m_digital_wallets_isSet;
}

bool OAICardknox::is_digital_wallets_Valid() const{
    return m_digital_wallets_isValid;
}

bool OAICardknox::isDynamicDescriptor() const {
    return m_dynamic_descriptor;
}
void OAICardknox::setDynamicDescriptor(const bool &dynamic_descriptor) {
    m_dynamic_descriptor = dynamic_descriptor;
    m_dynamic_descriptor_isSet = true;
}

bool OAICardknox::is_dynamic_descriptor_Set() const{
    return m_dynamic_descriptor_isSet;
}

bool OAICardknox::is_dynamic_descriptor_Valid() const{
    return m_dynamic_descriptor_isValid;
}

QList<QString> OAICardknox::getExcludedDccQuoteCurrencies() const {
    return m_excluded_dcc_quote_currencies;
}
void OAICardknox::setExcludedDccQuoteCurrencies(const QList<QString> &excluded_dcc_quote_currencies) {
    m_excluded_dcc_quote_currencies = excluded_dcc_quote_currencies;
    m_excluded_dcc_quote_currencies_isSet = true;
}

bool OAICardknox::is_excluded_dcc_quote_currencies_Set() const{
    return m_excluded_dcc_quote_currencies_isSet;
}

bool OAICardknox::is_excluded_dcc_quote_currencies_Valid() const{
    return m_excluded_dcc_quote_currencies_isValid;
}

OAIGatewayName OAICardknox::getGatewayName() const {
    return m_gateway_name;
}
void OAICardknox::setGatewayName(const OAIGatewayName &gateway_name) {
    m_gateway_name = gateway_name;
    m_gateway_name_isSet = true;
}

bool OAICardknox::is_gateway_name_Set() const{
    return m_gateway_name_isSet;
}

bool OAICardknox::is_gateway_name_Valid() const{
    return m_gateway_name_isValid;
}

QString OAICardknox::getId() const {
    return m_id;
}
void OAICardknox::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAICardknox::is_id_Set() const{
    return m_id_isSet;
}

bool OAICardknox::is_id_Valid() const{
    return m_id_isValid;
}

bool OAICardknox::isIsDown() const {
    return m_is_down;
}
void OAICardknox::setIsDown(const bool &is_down) {
    m_is_down = is_down;
    m_is_down_isSet = true;
}

bool OAICardknox::is_is_down_Set() const{
    return m_is_down_isSet;
}

bool OAICardknox::is_is_down_Valid() const{
    return m_is_down_isValid;
}

QString OAICardknox::getMerchantCategoryCode() const {
    return m_merchant_category_code;
}
void OAICardknox::setMerchantCategoryCode(const QString &merchant_category_code) {
    m_merchant_category_code = merchant_category_code;
    m_merchant_category_code_isSet = true;
}

bool OAICardknox::is_merchant_category_code_Set() const{
    return m_merchant_category_code_isSet;
}

bool OAICardknox::is_merchant_category_code_Valid() const{
    return m_merchant_category_code_isValid;
}

OAIPaymentMethod OAICardknox::getMethod() const {
    return m_method;
}
void OAICardknox::setMethod(const OAIPaymentMethod &method) {
    m_method = method;
    m_method_isSet = true;
}

bool OAICardknox::is_method_Set() const{
    return m_method_isSet;
}

bool OAICardknox::is_method_Valid() const{
    return m_method_isValid;
}

double OAICardknox::getMonthlyLimit() const {
    return m_monthly_limit;
}
void OAICardknox::setMonthlyLimit(const double &monthly_limit) {
    m_monthly_limit = monthly_limit;
    m_monthly_limit_isSet = true;
}

bool OAICardknox::is_monthly_limit_Set() const{
    return m_monthly_limit_isSet;
}

bool OAICardknox::is_monthly_limit_Valid() const{
    return m_monthly_limit_isValid;
}

QString OAICardknox::getOrganizationId() const {
    return m_organization_id;
}
void OAICardknox::setOrganizationId(const QString &organization_id) {
    m_organization_id = organization_id;
    m_organization_id_isSet = true;
}

bool OAICardknox::is_organization_id_Set() const{
    return m_organization_id_isSet;
}

bool OAICardknox::is_organization_id_Valid() const{
    return m_organization_id_isValid;
}

QList<OAIPaymentCardBrand> OAICardknox::getPaymentCardSchemes() const {
    return m_payment_card_schemes;
}
void OAICardknox::setPaymentCardSchemes(const QList<OAIPaymentCardBrand> &payment_card_schemes) {
    m_payment_card_schemes = payment_card_schemes;
    m_payment_card_schemes_isSet = true;
}

bool OAICardknox::is_payment_card_schemes_Set() const{
    return m_payment_card_schemes_isSet;
}

bool OAICardknox::is_payment_card_schemes_Valid() const{
    return m_payment_card_schemes_isValid;
}

bool OAICardknox::isReconciliationWindowEnabled() const {
    return m_reconciliation_window_enabled;
}
void OAICardknox::setReconciliationWindowEnabled(const bool &reconciliation_window_enabled) {
    m_reconciliation_window_enabled = reconciliation_window_enabled;
    m_reconciliation_window_enabled_isSet = true;
}

bool OAICardknox::is_reconciliation_window_enabled_Set() const{
    return m_reconciliation_window_enabled_isSet;
}

bool OAICardknox::is_reconciliation_window_enabled_Valid() const{
    return m_reconciliation_window_enabled_isValid;
}

qint32 OAICardknox::getReconciliationWindowTtl() const {
    return m_reconciliation_window_ttl;
}
void OAICardknox::setReconciliationWindowTtl(const qint32 &reconciliation_window_ttl) {
    m_reconciliation_window_ttl = reconciliation_window_ttl;
    m_reconciliation_window_ttl_isSet = true;
}

bool OAICardknox::is_reconciliation_window_ttl_Set() const{
    return m_reconciliation_window_ttl_isSet;
}

bool OAICardknox::is_reconciliation_window_ttl_Valid() const{
    return m_reconciliation_window_ttl_isValid;
}

QString OAICardknox::getStatus() const {
    return m_status;
}
void OAICardknox::setStatus(const QString &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAICardknox::is_status_Set() const{
    return m_status_isSet;
}

bool OAICardknox::is_status_Valid() const{
    return m_status_isValid;
}

bool OAICardknox::isSticky() const {
    return m_sticky;
}
void OAICardknox::setSticky(const bool &sticky) {
    m_sticky = sticky;
    m_sticky_isSet = true;
}

bool OAICardknox::is_sticky_Set() const{
    return m_sticky_isSet;
}

bool OAICardknox::is_sticky_Valid() const{
    return m_sticky_isValid;
}

bool OAICardknox::isThreeDSecure() const {
    return m_three_d_secure;
}
void OAICardknox::setThreeDSecure(const bool &three_d_secure) {
    m_three_d_secure = three_d_secure;
    m_three_d_secure_isSet = true;
}

bool OAICardknox::is_three_d_secure_Set() const{
    return m_three_d_secure_isSet;
}

bool OAICardknox::is_three_d_secure_Valid() const{
    return m_three_d_secure_isValid;
}

qint32 OAICardknox::getTimeout() const {
    return m_timeout;
}
void OAICardknox::setTimeout(const qint32 &timeout) {
    m_timeout = timeout;
    m_timeout_isSet = true;
}

bool OAICardknox::is_timeout_Set() const{
    return m_timeout_isSet;
}

bool OAICardknox::is_timeout_Valid() const{
    return m_timeout_isValid;
}

QString OAICardknox::getToken() const {
    return m_token;
}
void OAICardknox::setToken(const QString &token) {
    m_token = token;
    m_token_isSet = true;
}

bool OAICardknox::is_token_Set() const{
    return m_token_isSet;
}

bool OAICardknox::is_token_Valid() const{
    return m_token_isValid;
}

QDateTime OAICardknox::getUpdatedTime() const {
    return m_updated_time;
}
void OAICardknox::setUpdatedTime(const QDateTime &updated_time) {
    m_updated_time = updated_time;
    m_updated_time_isSet = true;
}

bool OAICardknox::is_updated_time_Set() const{
    return m_updated_time_isSet;
}

bool OAICardknox::is_updated_time_Valid() const{
    return m_updated_time_isValid;
}

OAICardknox_allOf_credentials OAICardknox::getCredentials() const {
    return m_credentials;
}
void OAICardknox::setCredentials(const OAICardknox_allOf_credentials &credentials) {
    m_credentials = credentials;
    m_credentials_isSet = true;
}

bool OAICardknox::is_credentials_Set() const{
    return m_credentials_isSet;
}

bool OAICardknox::is_credentials_Valid() const{
    return m_credentials_isValid;
}

bool OAICardknox::isSet() const {
...
bool OAICardknox::isValid() const {
