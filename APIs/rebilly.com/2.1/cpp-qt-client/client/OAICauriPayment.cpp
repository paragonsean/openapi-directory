...
OAICauriPayment::OAICauriPayment(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICauriPayment::OAICauriPayment() {
    this->initializeModel();
}

OAICauriPayment::~OAICauriPayment() {}

void OAICauriPayment::initializeModel() {
...
void OAICauriPayment::fromJson(QString jsonString) {
...
void OAICauriPayment::fromJsonObject(QJsonObject json) {
...
QString OAICauriPayment::asJson() const {
...
QJsonObject OAICauriPayment::asJsonObject() const {
    QJsonObject obj;
    if (m__links.size() > 0) {
...
QList<OAIGatewayAccount__links_inner> OAICauriPayment::getLinks() const {
    return m__links;
}
void OAICauriPayment::setLinks(const QList<OAIGatewayAccount__links_inner> &_links) {
    m__links = _links;
    m__links_isSet = true;
}

bool OAICauriPayment::is__links_Set() const{
    return m__links_isSet;
}

bool OAICauriPayment::is__links_Valid() const{
    return m__links_isValid;
}

QList<QString> OAICauriPayment::getAcceptedCurrencies() const {
    return m_accepted_currencies;
}
void OAICauriPayment::setAcceptedCurrencies(const QList<QString> &accepted_currencies) {
    m_accepted_currencies = accepted_currencies;
    m_accepted_currencies_isSet = true;
}

bool OAICauriPayment::is_accepted_currencies_Set() const{
    return m_accepted_currencies_isSet;
}

bool OAICauriPayment::is_accepted_currencies_Valid() const{
    return m_accepted_currencies_isValid;
}

OAIAcquirerName OAICauriPayment::getAcquirerName() const {
    return m_acquirer_name;
}
void OAICauriPayment::setAcquirerName(const OAIAcquirerName &acquirer_name) {
    m_acquirer_name = acquirer_name;
    m_acquirer_name_isSet = true;
}

bool OAICauriPayment::is_acquirer_name_Set() const{
    return m_acquirer_name_isSet;
}

bool OAICauriPayment::is_acquirer_name_Valid() const{
    return m_acquirer_name_isValid;
}

QString OAICauriPayment::getAdditionalFilters() const {
    return m_additional_filters;
}
void OAICauriPayment::setAdditionalFilters(const QString &additional_filters) {
    m_additional_filters = additional_filters;
    m_additional_filters_isSet = true;
}

bool OAICauriPayment::is_additional_filters_Set() const{
    return m_additional_filters_isSet;
}

bool OAICauriPayment::is_additional_filters_Valid() const{
    return m_additional_filters_isValid;
}

qint32 OAICauriPayment::getApprovalWindowTtl() const {
    return m_approval_window_ttl;
}
void OAICauriPayment::setApprovalWindowTtl(const qint32 &approval_window_ttl) {
    m_approval_window_ttl = approval_window_ttl;
    m_approval_window_ttl_isSet = true;
}

bool OAICauriPayment::is_approval_window_ttl_Set() const{
    return m_approval_window_ttl_isSet;
}

bool OAICauriPayment::is_approval_window_ttl_Valid() const{
    return m_approval_window_ttl_isValid;
}

QString OAICauriPayment::getCityField() const {
    return m_city_field;
}
void OAICauriPayment::setCityField(const QString &city_field) {
    m_city_field = city_field;
    m_city_field_isSet = true;
}

bool OAICauriPayment::is_city_field_Set() const{
    return m_city_field_isSet;
}

bool OAICauriPayment::is_city_field_Valid() const{
    return m_city_field_isValid;
}

QDateTime OAICauriPayment::getCreatedTime() const {
    return m_created_time;
}
void OAICauriPayment::setCreatedTime(const QDateTime &created_time) {
    m_created_time = created_time;
    m_created_time_isSet = true;
}

bool OAICauriPayment::is_created_time_Set() const{
    return m_created_time_isSet;
}

bool OAICauriPayment::is_created_time_Valid() const{
    return m_created_time_isValid;
}

QString OAICauriPayment::getDccForceCurrency() const {
    return m_dcc_force_currency;
}
void OAICauriPayment::setDccForceCurrency(const QString &dcc_force_currency) {
    m_dcc_force_currency = dcc_force_currency;
    m_dcc_force_currency_isSet = true;
}

bool OAICauriPayment::is_dcc_force_currency_Set() const{
    return m_dcc_force_currency_isSet;
}

bool OAICauriPayment::is_dcc_force_currency_Valid() const{
    return m_dcc_force_currency_isValid;
}

qint32 OAICauriPayment::getDccMarkup() const {
    return m_dcc_markup;
}
void OAICauriPayment::setDccMarkup(const qint32 &dcc_markup) {
    m_dcc_markup = dcc_markup;
    m_dcc_markup_isSet = true;
}

bool OAICauriPayment::is_dcc_markup_Set() const{
    return m_dcc_markup_isSet;
}

bool OAICauriPayment::is_dcc_markup_Valid() const{
    return m_dcc_markup_isValid;
}

QString OAICauriPayment::getDescriptor() const {
    return m_descriptor;
}
void OAICauriPayment::setDescriptor(const QString &descriptor) {
    m_descriptor = descriptor;
    m_descriptor_isSet = true;
}

bool OAICauriPayment::is_descriptor_Set() const{
    return m_descriptor_isSet;
}

bool OAICauriPayment::is_descriptor_Valid() const{
    return m_descriptor_isValid;
}

OAIDigitalWallets OAICauriPayment::getDigitalWallets() const {
    return m_digital_wallets;
}
void OAICauriPayment::setDigitalWallets(const OAIDigitalWallets &digital_wallets) {
    m_digital_wallets = digital_wallets;
    m_digital_wallets_isSet = true;
}

bool OAICauriPayment::is_digital_wallets_Set() const{
    return m_digital_wallets_isSet;
}

bool OAICauriPayment::is_digital_wallets_Valid() const{
    return m_digital_wallets_isValid;
}

bool OAICauriPayment::isDynamicDescriptor() const {
    return m_dynamic_descriptor;
}
void OAICauriPayment::setDynamicDescriptor(const bool &dynamic_descriptor) {
    m_dynamic_descriptor = dynamic_descriptor;
    m_dynamic_descriptor_isSet = true;
}

bool OAICauriPayment::is_dynamic_descriptor_Set() const{
    return m_dynamic_descriptor_isSet;
}

bool OAICauriPayment::is_dynamic_descriptor_Valid() const{
    return m_dynamic_descriptor_isValid;
}

QList<QString> OAICauriPayment::getExcludedDccQuoteCurrencies() const {
    return m_excluded_dcc_quote_currencies;
}
void OAICauriPayment::setExcludedDccQuoteCurrencies(const QList<QString> &excluded_dcc_quote_currencies) {
    m_excluded_dcc_quote_currencies = excluded_dcc_quote_currencies;
    m_excluded_dcc_quote_currencies_isSet = true;
}

bool OAICauriPayment::is_excluded_dcc_quote_currencies_Set() const{
    return m_excluded_dcc_quote_currencies_isSet;
}

bool OAICauriPayment::is_excluded_dcc_quote_currencies_Valid() const{
    return m_excluded_dcc_quote_currencies_isValid;
}

OAIGatewayName OAICauriPayment::getGatewayName() const {
    return m_gateway_name;
}
void OAICauriPayment::setGatewayName(const OAIGatewayName &gateway_name) {
    m_gateway_name = gateway_name;
    m_gateway_name_isSet = true;
}

bool OAICauriPayment::is_gateway_name_Set() const{
    return m_gateway_name_isSet;
}

bool OAICauriPayment::is_gateway_name_Valid() const{
    return m_gateway_name_isValid;
}

QString OAICauriPayment::getId() const {
    return m_id;
}
void OAICauriPayment::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAICauriPayment::is_id_Set() const{
    return m_id_isSet;
}

bool OAICauriPayment::is_id_Valid() const{
    return m_id_isValid;
}

bool OAICauriPayment::isIsDown() const {
    return m_is_down;
}
void OAICauriPayment::setIsDown(const bool &is_down) {
    m_is_down = is_down;
    m_is_down_isSet = true;
}

bool OAICauriPayment::is_is_down_Set() const{
    return m_is_down_isSet;
}

bool OAICauriPayment::is_is_down_Valid() const{
    return m_is_down_isValid;
}

QString OAICauriPayment::getMerchantCategoryCode() const {
    return m_merchant_category_code;
}
void OAICauriPayment::setMerchantCategoryCode(const QString &merchant_category_code) {
    m_merchant_category_code = merchant_category_code;
    m_merchant_category_code_isSet = true;
}

bool OAICauriPayment::is_merchant_category_code_Set() const{
    return m_merchant_category_code_isSet;
}

bool OAICauriPayment::is_merchant_category_code_Valid() const{
    return m_merchant_category_code_isValid;
}

OAIPaymentMethod OAICauriPayment::getMethod() const {
    return m_method;
}
void OAICauriPayment::setMethod(const OAIPaymentMethod &method) {
    m_method = method;
    m_method_isSet = true;
}

bool OAICauriPayment::is_method_Set() const{
    return m_method_isSet;
}

bool OAICauriPayment::is_method_Valid() const{
    return m_method_isValid;
}

double OAICauriPayment::getMonthlyLimit() const {
    return m_monthly_limit;
}
void OAICauriPayment::setMonthlyLimit(const double &monthly_limit) {
    m_monthly_limit = monthly_limit;
    m_monthly_limit_isSet = true;
}

bool OAICauriPayment::is_monthly_limit_Set() const{
    return m_monthly_limit_isSet;
}

bool OAICauriPayment::is_monthly_limit_Valid() const{
    return m_monthly_limit_isValid;
}

QString OAICauriPayment::getOrganizationId() const {
    return m_organization_id;
}
void OAICauriPayment::setOrganizationId(const QString &organization_id) {
    m_organization_id = organization_id;
    m_organization_id_isSet = true;
}

bool OAICauriPayment::is_organization_id_Set() const{
    return m_organization_id_isSet;
}

bool OAICauriPayment::is_organization_id_Valid() const{
    return m_organization_id_isValid;
}

QList<OAIPaymentCardBrand> OAICauriPayment::getPaymentCardSchemes() const {
    return m_payment_card_schemes;
}
void OAICauriPayment::setPaymentCardSchemes(const QList<OAIPaymentCardBrand> &payment_card_schemes) {
    m_payment_card_schemes = payment_card_schemes;
    m_payment_card_schemes_isSet = true;
}

bool OAICauriPayment::is_payment_card_schemes_Set() const{
    return m_payment_card_schemes_isSet;
}

bool OAICauriPayment::is_payment_card_schemes_Valid() const{
    return m_payment_card_schemes_isValid;
}

bool OAICauriPayment::isReconciliationWindowEnabled() const {
    return m_reconciliation_window_enabled;
}
void OAICauriPayment::setReconciliationWindowEnabled(const bool &reconciliation_window_enabled) {
    m_reconciliation_window_enabled = reconciliation_window_enabled;
    m_reconciliation_window_enabled_isSet = true;
}

bool OAICauriPayment::is_reconciliation_window_enabled_Set() const{
    return m_reconciliation_window_enabled_isSet;
}

bool OAICauriPayment::is_reconciliation_window_enabled_Valid() const{
    return m_reconciliation_window_enabled_isValid;
}

qint32 OAICauriPayment::getReconciliationWindowTtl() const {
    return m_reconciliation_window_ttl;
}
void OAICauriPayment::setReconciliationWindowTtl(const qint32 &reconciliation_window_ttl) {
    m_reconciliation_window_ttl = reconciliation_window_ttl;
    m_reconciliation_window_ttl_isSet = true;
}

bool OAICauriPayment::is_reconciliation_window_ttl_Set() const{
    return m_reconciliation_window_ttl_isSet;
}

bool OAICauriPayment::is_reconciliation_window_ttl_Valid() const{
    return m_reconciliation_window_ttl_isValid;
}

QString OAICauriPayment::getStatus() const {
    return m_status;
}
void OAICauriPayment::setStatus(const QString &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAICauriPayment::is_status_Set() const{
    return m_status_isSet;
}

bool OAICauriPayment::is_status_Valid() const{
    return m_status_isValid;
}

bool OAICauriPayment::isSticky() const {
    return m_sticky;
}
void OAICauriPayment::setSticky(const bool &sticky) {
    m_sticky = sticky;
    m_sticky_isSet = true;
}

bool OAICauriPayment::is_sticky_Set() const{
    return m_sticky_isSet;
}

bool OAICauriPayment::is_sticky_Valid() const{
    return m_sticky_isValid;
}

bool OAICauriPayment::isThreeDSecure() const {
    return m_three_d_secure;
}
void OAICauriPayment::setThreeDSecure(const bool &three_d_secure) {
    m_three_d_secure = three_d_secure;
    m_three_d_secure_isSet = true;
}

bool OAICauriPayment::is_three_d_secure_Set() const{
    return m_three_d_secure_isSet;
}

bool OAICauriPayment::is_three_d_secure_Valid() const{
    return m_three_d_secure_isValid;
}

qint32 OAICauriPayment::getTimeout() const {
    return m_timeout;
}
void OAICauriPayment::setTimeout(const qint32 &timeout) {
    m_timeout = timeout;
    m_timeout_isSet = true;
}

bool OAICauriPayment::is_timeout_Set() const{
    return m_timeout_isSet;
}

bool OAICauriPayment::is_timeout_Valid() const{
    return m_timeout_isValid;
}

QString OAICauriPayment::getToken() const {
    return m_token;
}
void OAICauriPayment::setToken(const QString &token) {
    m_token = token;
    m_token_isSet = true;
}

bool OAICauriPayment::is_token_Set() const{
    return m_token_isSet;
}

bool OAICauriPayment::is_token_Valid() const{
    return m_token_isValid;
}

QDateTime OAICauriPayment::getUpdatedTime() const {
    return m_updated_time;
}
void OAICauriPayment::setUpdatedTime(const QDateTime &updated_time) {
    m_updated_time = updated_time;
    m_updated_time_isSet = true;
}

bool OAICauriPayment::is_updated_time_Set() const{
    return m_updated_time_isSet;
}

bool OAICauriPayment::is_updated_time_Valid() const{
    return m_updated_time_isValid;
}

OAICauriPayment_allOf_credentials OAICauriPayment::getCredentials() const {
    return m_credentials;
}
void OAICauriPayment::setCredentials(const OAICauriPayment_allOf_credentials &credentials) {
    m_credentials = credentials;
    m_credentials_isSet = true;
}

bool OAICauriPayment::is_credentials_Set() const{
    return m_credentials_isSet;
}

bool OAICauriPayment::is_credentials_Valid() const{
    return m_credentials_isValid;
}

bool OAICauriPayment::isSet() const {
...
bool OAICauriPayment::isValid() const {
