...
#ifndef OAIBBANInstrument_H
#define OAIBBANInstrument_H
...
class OAIBBANInstrument : public OAIObject {
public:
    OAIBBANInstrument();
    OAIBBANInstrument(QString json);
    ~OAIBBANInstrument() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBBANInstrument)

#endif // OAIBBANInstrument_H
