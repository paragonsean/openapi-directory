...
class OAIJetPay_allOf_credentials;

class OAIJetPay : public OAIObject {
public:
    OAIJetPay();
    OAIJetPay(QString json);
    ~OAIJetPay() override;
    ...
    OAIJetPay_allOf_credentials getCredentials() const;
    void setCredentials(const OAIJetPay_allOf_credentials &credentials);
...
private:
    ...
    OAIJetPay_allOf_credentials m_credentials;
...
Q_DECLARE_METATYPE(OpenAPI::OAIJetPay)
