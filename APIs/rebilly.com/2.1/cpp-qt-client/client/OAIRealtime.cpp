...
OAIRealtime::OAIRealtime(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIRealtime::OAIRealtime() {
    this->initializeModel();
}

OAIRealtime::~OAIRealtime() {}

void OAIRealtime::initializeModel() {
...
void OAIRealtime::fromJson(QString jsonString) {
...
void OAIRealtime::fromJsonObject(QJsonObject json) {
...
QString OAIRealtime::asJson() const {
...
QJsonObject OAIRealtime::asJsonObject() const {
    QJsonObject obj;
    if (m__links.size() > 0) {
...
QList<OAIGatewayAccount__links_inner> OAIRealtime::getLinks() const {
    return m__links;
}
void OAIRealtime::setLinks(const QList<OAIGatewayAccount__links_inner> &_links) {
    m__links = _links;
    m__links_isSet = true;
}

bool OAIRealtime::is__links_Set() const{
    return m__links_isSet;
}

bool OAIRealtime::is__links_Valid() const{
    return m__links_isValid;
}

QList<QString> OAIRealtime::getAcceptedCurrencies() const {
    return m_accepted_currencies;
}
void OAIRealtime::setAcceptedCurrencies(const QList<QString> &accepted_currencies) {
    m_accepted_currencies = accepted_currencies;
    m_accepted_currencies_isSet = true;
}

bool OAIRealtime::is_accepted_currencies_Set() const{
    return m_accepted_currencies_isSet;
}

bool OAIRealtime::is_accepted_currencies_Valid() const{
    return m_accepted_currencies_isValid;
}

OAIAcquirerName OAIRealtime::getAcquirerName() const {
    return m_acquirer_name;
}
void OAIRealtime::setAcquirerName(const OAIAcquirerName &acquirer_name) {
    m_acquirer_name = acquirer_name;
    m_acquirer_name_isSet = true;
}

bool OAIRealtime::is_acquirer_name_Set() const{
    return m_acquirer_name_isSet;
}

bool OAIRealtime::is_acquirer_name_Valid() const{
    return m_acquirer_name_isValid;
}

QString OAIRealtime::getAdditionalFilters() const {
    return m_additional_filters;
}
void OAIRealtime::setAdditionalFilters(const QString &additional_filters) {
    m_additional_filters = additional_filters;
    m_additional_filters_isSet = true;
}

bool OAIRealtime::is_additional_filters_Set() const{
    return m_additional_filters_isSet;
}

bool OAIRealtime::is_additional_filters_Valid() const{
    return m_additional_filters_isValid;
}

qint32 OAIRealtime::getApprovalWindowTtl() const {
    return m_approval_window_ttl;
}
void OAIRealtime::setApprovalWindowTtl(const qint32 &approval_window_ttl) {
    m_approval_window_ttl = approval_window_ttl;
    m_approval_window_ttl_isSet = true;
}

bool OAIRealtime::is_approval_window_ttl_Set() const{
    return m_approval_window_ttl_isSet;
}

bool OAIRealtime::is_approval_window_ttl_Valid() const{
    return m_approval_window_ttl_isValid;
}

QString OAIRealtime::getCityField() const {
    return m_city_field;
}
void OAIRealtime::setCityField(const QString &city_field) {
    m_city_field = city_field;
    m_city_field_isSet = true;
}

bool OAIRealtime::is_city_field_Set() const{
    return m_city_field_isSet;
}

bool OAIRealtime::is_city_field_Valid() const{
    return m_city_field_isValid;
}

QDateTime OAIRealtime::getCreatedTime() const {
    return m_created_time;
}
void OAIRealtime::setCreatedTime(const QDateTime &created_time) {
    m_created_time = created_time;
    m_created_time_isSet = true;
}

bool OAIRealtime::is_created_time_Set() const{
    return m_created_time_isSet;
}

bool OAIRealtime::is_created_time_Valid() const{
    return m_created_time_isValid;
}

QString OAIRealtime::getDccForceCurrency() const {
    return m_dcc_force_currency;
}
void OAIRealtime::setDccForceCurrency(const QString &dcc_force_currency) {
    m_dcc_force_currency = dcc_force_currency;
    m_dcc_force_currency_isSet = true;
}

bool OAIRealtime::is_dcc_force_currency_Set() const{
    return m_dcc_force_currency_isSet;
}

bool OAIRealtime::is_dcc_force_currency_Valid() const{
    return m_dcc_force_currency_isValid;
}

qint32 OAIRealtime::getDccMarkup() const {
    return m_dcc_markup;
}
void OAIRealtime::setDccMarkup(const qint32 &dcc_markup) {
    m_dcc_markup = dcc_markup;
    m_dcc_markup_isSet = true;
}

bool OAIRealtime::is_dcc_markup_Set() const{
    return m_dcc_markup_isSet;
}

bool OAIRealtime::is_dcc_markup_Valid() const{
    return m_dcc_markup_isValid;
}

QString OAIRealtime::getDescriptor() const {
    return m_descriptor;
}
void OAIRealtime::setDescriptor(const QString &descriptor) {
    m_descriptor = descriptor;
    m_descriptor_isSet = true;
}

bool OAIRealtime::is_descriptor_Set() const{
    return m_descriptor_isSet;
}

bool OAIRealtime::is_descriptor_Valid() const{
    return m_descriptor_isValid;
}

OAIDigitalWallets OAIRealtime::getDigitalWallets() const {
    return m_digital_wallets;
}
void OAIRealtime::setDigitalWallets(const OAIDigitalWallets &digital_wallets) {
    m_digital_wallets = digital_wallets;
    m_digital_wallets_isSet = true;
}

bool OAIRealtime::is_digital_wallets_Set() const{
    return m_digital_wallets_isSet;
}

bool OAIRealtime::is_digital_wallets_Valid() const{
    return m_digital_wallets_isValid;
}

bool OAIRealtime::isDynamicDescriptor() const {
    return m_dynamic_descriptor;
}
void OAIRealtime::setDynamicDescriptor(const bool &dynamic_descriptor) {
    m_dynamic_descriptor = dynamic_descriptor;
    m_dynamic_descriptor_isSet = true;
}

bool OAIRealtime::is_dynamic_descriptor_Set() const{
    return m_dynamic_descriptor_isSet;
}

bool OAIRealtime::is_dynamic_descriptor_Valid() const{
    return m_dynamic_descriptor_isValid;
}

QList<QString> OAIRealtime::getExcludedDccQuoteCurrencies() const {
    return m_excluded_dcc_quote_currencies;
}
void OAIRealtime::setExcludedDccQuoteCurrencies(const QList<QString> &excluded_dcc_quote_currencies) {
    m_excluded_dcc_quote_currencies = excluded_dcc_quote_currencies;
    m_excluded_dcc_quote_currencies_isSet = true;
}

bool OAIRealtime::is_excluded_dcc_quote_currencies_Set() const{
    return m_excluded_dcc_quote_currencies_isSet;
}

bool OAIRealtime::is_excluded_dcc_quote_currencies_Valid() const{
    return m_excluded_dcc_quote_currencies_isValid;
}

OAIGatewayName OAIRealtime::getGatewayName() const {
    return m_gateway_name;
}
void OAIRealtime::setGatewayName(const OAIGatewayName &gateway_name) {
    m_gateway_name = gateway_name;
    m_gateway_name_isSet = true;
}

bool OAIRealtime::is_gateway_name_Set() const{
    return m_gateway_name_isSet;
}

bool OAIRealtime::is_gateway_name_Valid() const{
    return m_gateway_name_isValid;
}

QString OAIRealtime::getId() const {
    return m_id;
}
void OAIRealtime::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIRealtime::is_id_Set() const{
    return m_id_isSet;
}

bool OAIRealtime::is_id_Valid() const{
    return m_id_isValid;
}

bool OAIRealtime::isIsDown() const {
    return m_is_down;
}
void OAIRealtime::setIsDown(const bool &is_down) {
    m_is_down = is_down;
    m_is_down_isSet = true;
}

bool OAIRealtime::is_is_down_Set() const{
    return m_is_down_isSet;
}

bool OAIRealtime::is_is_down_Valid() const{
    return m_is_down_isValid;
}

QString OAIRealtime::getMerchantCategoryCode() const {
    return m_merchant_category_code;
}
void OAIRealtime::setMerchantCategoryCode(const QString &merchant_category_code) {
    m_merchant_category_code = merchant_category_code;
    m_merchant_category_code_isSet = true;
}

bool OAIRealtime::is_merchant_category_code_Set() const{
    return m_merchant_category_code_isSet;
}

bool OAIRealtime::is_merchant_category_code_Valid() const{
    return m_merchant_category_code_isValid;
}

OAIPaymentMethod OAIRealtime::getMethod() const {
    return m_method;
}
void OAIRealtime::setMethod(const OAIPaymentMethod &method) {
    m_method = method;
    m_method_isSet = true;
}

bool OAIRealtime::is_method_Set() const{
    return m_method_isSet;
}

bool OAIRealtime::is_method_Valid() const{
    return m_method_isValid;
}

double OAIRealtime::getMonthlyLimit() const {
    return m_monthly_limit;
}
void OAIRealtime::setMonthlyLimit(const double &monthly_limit) {
    m_monthly_limit = monthly_limit;
    m_monthly_limit_isSet = true;
}

bool OAIRealtime::is_monthly_limit_Set() const{
    return m_monthly_limit_isSet;
}

bool OAIRealtime::is_monthly_limit_Valid() const{
    return m_monthly_limit_isValid;
}

QString OAIRealtime::getOrganizationId() const {
    return m_organization_id;
}
void OAIRealtime::setOrganizationId(const QString &organization_id) {
    m_organization_id = organization_id;
    m_organization_id_isSet = true;
}

bool OAIRealtime::is_organization_id_Set() const{
    return m_organization_id_isSet;
}

bool OAIRealtime::is_organization_id_Valid() const{
    return m_organization_id_isValid;
}

QList<OAIPaymentCardBrand> OAIRealtime::getPaymentCardSchemes() const {
    return m_payment_card_schemes;
}
void OAIRealtime::setPaymentCardSchemes(const QList<OAIPaymentCardBrand> &payment_card_schemes) {
    m_payment_card_schemes = payment_card_schemes;
    m_payment_card_schemes_isSet = true;
}

bool OAIRealtime::is_payment_card_schemes_Set() const{
    return m_payment_card_schemes_isSet;
}

bool OAIRealtime::is_payment_card_schemes_Valid() const{
    return m_payment_card_schemes_isValid;
}

bool OAIRealtime::isReconciliationWindowEnabled() const {
    return m_reconciliation_window_enabled;
}
void OAIRealtime::setReconciliationWindowEnabled(const bool &reconciliation_window_enabled) {
    m_reconciliation_window_enabled = reconciliation_window_enabled;
    m_reconciliation_window_enabled_isSet = true;
}

bool OAIRealtime::is_reconciliation_window_enabled_Set() const{
    return m_reconciliation_window_enabled_isSet;
}

bool OAIRealtime::is_reconciliation_window_enabled_Valid() const{
    return m_reconciliation_window_enabled_isValid;
}

qint32 OAIRealtime::getReconciliationWindowTtl() const {
    return m_reconciliation_window_ttl;
}
void OAIRealtime::setReconciliationWindowTtl(const qint32 &reconciliation_window_ttl) {
    m_reconciliation_window_ttl = reconciliation_window_ttl;
    m_reconciliation_window_ttl_isSet = true;
}

bool OAIRealtime::is_reconciliation_window_ttl_Set() const{
    return m_reconciliation_window_ttl_isSet;
}

bool OAIRealtime::is_reconciliation_window_ttl_Valid() const{
    return m_reconciliation_window_ttl_isValid;
}

QString OAIRealtime::getStatus() const {
    return m_status;
}
void OAIRealtime::setStatus(const QString &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIRealtime::is_status_Set() const{
    return m_status_isSet;
}

bool OAIRealtime::is_status_Valid() const{
    return m_status_isValid;
}

bool OAIRealtime::isSticky() const {
    return m_sticky;
}
void OAIRealtime::setSticky(const bool &sticky) {
    m_sticky = sticky;
    m_sticky_isSet = true;
}

bool OAIRealtime::is_sticky_Set() const{
    return m_sticky_isSet;
}

bool OAIRealtime::is_sticky_Valid() const{
    return m_sticky_isValid;
}

bool OAIRealtime::isThreeDSecure() const {
    return m_three_d_secure;
}
void OAIRealtime::setThreeDSecure(const bool &three_d_secure) {
    m_three_d_secure = three_d_secure;
    m_three_d_secure_isSet = true;
}

bool OAIRealtime::is_three_d_secure_Set() const{
    return m_three_d_secure_isSet;
}

bool OAIRealtime::is_three_d_secure_Valid() const{
    return m_three_d_secure_isValid;
}

qint32 OAIRealtime::getTimeout() const {
    return m_timeout;
}
void OAIRealtime::setTimeout(const qint32 &timeout) {
    m_timeout = timeout;
    m_timeout_isSet = true;
}

bool OAIRealtime::is_timeout_Set() const{
    return m_timeout_isSet;
}

bool OAIRealtime::is_timeout_Valid() const{
    return m_timeout_isValid;
}

QString OAIRealtime::getToken() const {
    return m_token;
}
void OAIRealtime::setToken(const QString &token) {
    m_token = token;
    m_token_isSet = true;
}

bool OAIRealtime::is_token_Set() const{
    return m_token_isSet;
}

bool OAIRealtime::is_token_Valid() const{
    return m_token_isValid;
}

QDateTime OAIRealtime::getUpdatedTime() const {
    return m_updated_time;
}
void OAIRealtime::setUpdatedTime(const QDateTime &updated_time) {
    m_updated_time = updated_time;
    m_updated_time_isSet = true;
}

bool OAIRealtime::is_updated_time_Set() const{
    return m_updated_time_isSet;
}

bool OAIRealtime::is_updated_time_Valid() const{
    return m_updated_time_isValid;
}

OAIRealtime_allOf_credentials OAIRealtime::getCredentials() const {
    return m_credentials;
}
void OAIRealtime::setCredentials(const OAIRealtime_allOf_credentials &credentials) {
    m_credentials = credentials;
    m_credentials_isSet = true;
}

bool OAIRealtime::is_credentials_Set() const{
    return m_credentials_isSet;
}

bool OAIRealtime::is_credentials_Valid() const{
    return m_credentials_isValid;
}

bool OAIRealtime::isSet() const {
...
bool OAIRealtime::isValid() const {
