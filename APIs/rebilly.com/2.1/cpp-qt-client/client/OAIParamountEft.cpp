...
OAIParamountEft::OAIParamountEft(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIParamountEft::OAIParamountEft() {
    this->initializeModel();
}

OAIParamountEft::~OAIParamountEft() {}

void OAIParamountEft::initializeModel() {
...
void OAIParamountEft::fromJson(QString jsonString) {
...
void OAIParamountEft::fromJsonObject(QJsonObject json) {
...
QString OAIParamountEft::asJson() const {
...
QJsonObject OAIParamountEft::asJsonObject() const {
    QJsonObject obj;
    if (m__links.size() > 0) {
...
QList<OAIGatewayAccount__links_inner> OAIParamountEft::getLinks() const {
    return m__links;
}
void OAIParamountEft::setLinks(const QList<OAIGatewayAccount__links_inner> &_links) {
    m__links = _links;
    m__links_isSet = true;
}

bool OAIParamountEft::is__links_Set() const{
    return m__links_isSet;
}

bool OAIParamountEft::is__links_Valid() const{
    return m__links_isValid;
}

QList<QString> OAIParamountEft::getAcceptedCurrencies() const {
    return m_accepted_currencies;
}
void OAIParamountEft::setAcceptedCurrencies(const QList<QString> &accepted_currencies) {
    m_accepted_currencies = accepted_currencies;
    m_accepted_currencies_isSet = true;
}

bool OAIParamountEft::is_accepted_currencies_Set() const{
    return m_accepted_currencies_isSet;
}

bool OAIParamountEft::is_accepted_currencies_Valid() const{
    return m_accepted_currencies_isValid;
}

OAIAcquirerName OAIParamountEft::getAcquirerName() const {
    return m_acquirer_name;
}
void OAIParamountEft::setAcquirerName(const OAIAcquirerName &acquirer_name) {
    m_acquirer_name = acquirer_name;
    m_acquirer_name_isSet = true;
}

bool OAIParamountEft::is_acquirer_name_Set() const{
    return m_acquirer_name_isSet;
}

bool OAIParamountEft::is_acquirer_name_Valid() const{
    return m_acquirer_name_isValid;
}

QString OAIParamountEft::getAdditionalFilters() const {
    return m_additional_filters;
}
void OAIParamountEft::setAdditionalFilters(const QString &additional_filters) {
    m_additional_filters = additional_filters;
    m_additional_filters_isSet = true;
}

bool OAIParamountEft::is_additional_filters_Set() const{
    return m_additional_filters_isSet;
}

bool OAIParamountEft::is_additional_filters_Valid() const{
    return m_additional_filters_isValid;
}

qint32 OAIParamountEft::getApprovalWindowTtl() const {
    return m_approval_window_ttl;
}
void OAIParamountEft::setApprovalWindowTtl(const qint32 &approval_window_ttl) {
    m_approval_window_ttl = approval_window_ttl;
    m_approval_window_ttl_isSet = true;
}

bool OAIParamountEft::is_approval_window_ttl_Set() const{
    return m_approval_window_ttl_isSet;
}

bool OAIParamountEft::is_approval_window_ttl_Valid() const{
    return m_approval_window_ttl_isValid;
}

QString OAIParamountEft::getCityField() const {
    return m_city_field;
}
void OAIParamountEft::setCityField(const QString &city_field) {
    m_city_field = city_field;
    m_city_field_isSet = true;
}

bool OAIParamountEft::is_city_field_Set() const{
    return m_city_field_isSet;
}

bool OAIParamountEft::is_city_field_Valid() const{
    return m_city_field_isValid;
}

QDateTime OAIParamountEft::getCreatedTime() const {
    return m_created_time;
}
void OAIParamountEft::setCreatedTime(const QDateTime &created_time) {
    m_created_time = created_time;
    m_created_time_isSet = true;
}

bool OAIParamountEft::is_created_time_Set() const{
    return m_created_time_isSet;
}

bool OAIParamountEft::is_created_time_Valid() const{
    return m_created_time_isValid;
}

QString OAIParamountEft::getDccForceCurrency() const {
    return m_dcc_force_currency;
}
void OAIParamountEft::setDccForceCurrency(const QString &dcc_force_currency) {
    m_dcc_force_currency = dcc_force_currency;
    m_dcc_force_currency_isSet = true;
}

bool OAIParamountEft::is_dcc_force_currency_Set() const{
    return m_dcc_force_currency_isSet;
}

bool OAIParamountEft::is_dcc_force_currency_Valid() const{
    return m_dcc_force_currency_isValid;
}

qint32 OAIParamountEft::getDccMarkup() const {
    return m_dcc_markup;
}
void OAIParamountEft::setDccMarkup(const qint32 &dcc_markup) {
    m_dcc_markup = dcc_markup;
    m_dcc_markup_isSet = true;
}

bool OAIParamountEft::is_dcc_markup_Set() const{
    return m_dcc_markup_isSet;
}

bool OAIParamountEft::is_dcc_markup_Valid() const{
    return m_dcc_markup_isValid;
}

QString OAIParamountEft::getDescriptor() const {
    return m_descriptor;
}
void OAIParamountEft::setDescriptor(const QString &descriptor) {
    m_descriptor = descriptor;
    m_descriptor_isSet = true;
}

bool OAIParamountEft::is_descriptor_Set() const{
    return m_descriptor_isSet;
}

bool OAIParamountEft::is_descriptor_Valid() const{
    return m_descriptor_isValid;
}

OAIDigitalWallets OAIParamountEft::getDigitalWallets() const {
    return m_digital_wallets;
}
void OAIParamountEft::setDigitalWallets(const OAIDigitalWallets &digital_wallets) {
    m_digital_wallets = digital_wallets;
    m_digital_wallets_isSet = true;
}

bool OAIParamountEft::is_digital_wallets_Set() const{
    return m_digital_wallets_isSet;
}

bool OAIParamountEft::is_digital_wallets_Valid() const{
    return m_digital_wallets_isValid;
}

bool OAIParamountEft::isDynamicDescriptor() const {
    return m_dynamic_descriptor;
}
void OAIParamountEft::setDynamicDescriptor(const bool &dynamic_descriptor) {
    m_dynamic_descriptor = dynamic_descriptor;
    m_dynamic_descriptor_isSet = true;
}

bool OAIParamountEft::is_dynamic_descriptor_Set() const{
    return m_dynamic_descriptor_isSet;
}

bool OAIParamountEft::is_dynamic_descriptor_Valid() const{
    return m_dynamic_descriptor_isValid;
}

QList<QString> OAIParamountEft::getExcludedDccQuoteCurrencies() const {
    return m_excluded_dcc_quote_currencies;
}
void OAIParamountEft::setExcludedDccQuoteCurrencies(const QList<QString> &excluded_dcc_quote_currencies) {
    m_excluded_dcc_quote_currencies = excluded_dcc_quote_currencies;
    m_excluded_dcc_quote_currencies_isSet = true;
}

bool OAIParamountEft::is_excluded_dcc_quote_currencies_Set() const{
    return m_excluded_dcc_quote_currencies_isSet;
}

bool OAIParamountEft::is_excluded_dcc_quote_currencies_Valid() const{
    return m_excluded_dcc_quote_currencies_isValid;
}

OAIGatewayName OAIParamountEft::getGatewayName() const {
    return m_gateway_name;
}
void OAIParamountEft::setGatewayName(const OAIGatewayName &gateway_name) {
    m_gateway_name = gateway_name;
    m_gateway_name_isSet = true;
}

bool OAIParamountEft::is_gateway_name_Set() const{
    return m_gateway_name_isSet;
}

bool OAIParamountEft::is_gateway_name_Valid() const{
    return m_gateway_name_isValid;
}

QString OAIParamountEft::getId() const {
    return m_id;
}
void OAIParamountEft::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIParamountEft::is_id_Set() const{
    return m_id_isSet;
}

bool OAIParamountEft::is_id_Valid() const{
    return m_id_isValid;
}

bool OAIParamountEft::isIsDown() const {
    return m_is_down;
}
void OAIParamountEft::setIsDown(const bool &is_down) {
    m_is_down = is_down;
    m_is_down_isSet = true;
}

bool OAIParamountEft::is_is_down_Set() const{
    return m_is_down_isSet;
}

bool OAIParamountEft::is_is_down_Valid() const{
    return m_is_down_isValid;
}

QString OAIParamountEft::getMerchantCategoryCode() const {
    return m_merchant_category_code;
}
void OAIParamountEft::setMerchantCategoryCode(const QString &merchant_category_code) {
    m_merchant_category_code = merchant_category_code;
    m_merchant_category_code_isSet = true;
}

bool OAIParamountEft::is_merchant_category_code_Set() const{
    return m_merchant_category_code_isSet;
}

bool OAIParamountEft::is_merchant_category_code_Valid() const{
    return m_merchant_category_code_isValid;
}

OAIPaymentMethod OAIParamountEft::getMethod() const {
    return m_method;
}
void OAIParamountEft::setMethod(const OAIPaymentMethod &method) {
    m_method = method;
    m_method_isSet = true;
}

bool OAIParamountEft::is_method_Set() const{
    return m_method_isSet;
}

bool OAIParamountEft::is_method_Valid() const{
    return m_method_isValid;
}

double OAIParamountEft::getMonthlyLimit() const {
    return m_monthly_limit;
}
void OAIParamountEft::setMonthlyLimit(const double &monthly_limit) {
    m_monthly_limit = monthly_limit;
    m_monthly_limit_isSet = true;
}

bool OAIParamountEft::is_monthly_limit_Set() const{
    return m_monthly_limit_isSet;
}

bool OAIParamountEft::is_monthly_limit_Valid() const{
    return m_monthly_limit_isValid;
}

QString OAIParamountEft::getOrganizationId() const {
    return m_organization_id;
}
void OAIParamountEft::setOrganizationId(const QString &organization_id) {
    m_organization_id = organization_id;
    m_organization_id_isSet = true;
}

bool OAIParamountEft::is_organization_id_Set() const{
    return m_organization_id_isSet;
}

bool OAIParamountEft::is_organization_id_Valid() const{
    return m_organization_id_isValid;
}

QList<OAIPaymentCardBrand> OAIParamountEft::getPaymentCardSchemes() const {
    return m_payment_card_schemes;
}
void OAIParamountEft::setPaymentCardSchemes(const QList<OAIPaymentCardBrand> &payment_card_schemes) {
    m_payment_card_schemes = payment_card_schemes;
    m_payment_card_schemes_isSet = true;
}

bool OAIParamountEft::is_payment_card_schemes_Set() const{
    return m_payment_card_schemes_isSet;
}

bool OAIParamountEft::is_payment_card_schemes_Valid() const{
    return m_payment_card_schemes_isValid;
}

bool OAIParamountEft::isReconciliationWindowEnabled() const {
    return m_reconciliation_window_enabled;
}
void OAIParamountEft::setReconciliationWindowEnabled(const bool &reconciliation_window_enabled) {
    m_reconciliation_window_enabled = reconciliation_window_enabled;
    m_reconciliation_window_enabled_isSet = true;
}

bool OAIParamountEft::is_reconciliation_window_enabled_Set() const{
    return m_reconciliation_window_enabled_isSet;
}

bool OAIParamountEft::is_reconciliation_window_enabled_Valid() const{
    return m_reconciliation_window_enabled_isValid;
}

qint32 OAIParamountEft::getReconciliationWindowTtl() const {
    return m_reconciliation_window_ttl;
}
void OAIParamountEft::setReconciliationWindowTtl(const qint32 &reconciliation_window_ttl) {
    m_reconciliation_window_ttl = reconciliation_window_ttl;
    m_reconciliation_window_ttl_isSet = true;
}

bool OAIParamountEft::is_reconciliation_window_ttl_Set() const{
    return m_reconciliation_window_ttl_isSet;
}

bool OAIParamountEft::is_reconciliation_window_ttl_Valid() const{
    return m_reconciliation_window_ttl_isValid;
}

QString OAIParamountEft::getStatus() const {
    return m_status;
}
void OAIParamountEft::setStatus(const QString &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIParamountEft::is_status_Set() const{
    return m_status_isSet;
}

bool OAIParamountEft::is_status_Valid() const{
    return m_status_isValid;
}

bool OAIParamountEft::isSticky() const {
    return m_sticky;
}
void OAIParamountEft::setSticky(const bool &sticky) {
    m_sticky = sticky;
    m_sticky_isSet = true;
}

bool OAIParamountEft::is_sticky_Set() const{
    return m_sticky_isSet;
}

bool OAIParamountEft::is_sticky_Valid() const{
    return m_sticky_isValid;
}

bool OAIParamountEft::isThreeDSecure() const {
    return m_three_d_secure;
}
void OAIParamountEft::setThreeDSecure(const bool &three_d_secure) {
    m_three_d_secure = three_d_secure;
    m_three_d_secure_isSet = true;
}

bool OAIParamountEft::is_three_d_secure_Set() const{
    return m_three_d_secure_isSet;
}

bool OAIParamountEft::is_three_d_secure_Valid() const{
    return m_three_d_secure_isValid;
}

qint32 OAIParamountEft::getTimeout() const {
    return m_timeout;
}
void OAIParamountEft::setTimeout(const qint32 &timeout) {
    m_timeout = timeout;
    m_timeout_isSet = true;
}

bool OAIParamountEft::is_timeout_Set() const{
    return m_timeout_isSet;
}

bool OAIParamountEft::is_timeout_Valid() const{
    return m_timeout_isValid;
}

QString OAIParamountEft::getToken() const {
    return m_token;
}
void OAIParamountEft::setToken(const QString &token) {
    m_token = token;
    m_token_isSet = true;
}

bool OAIParamountEft::is_token_Set() const{
    return m_token_isSet;
}

bool OAIParamountEft::is_token_Valid() const{
    return m_token_isValid;
}

QDateTime OAIParamountEft::getUpdatedTime() const {
    return m_updated_time;
}
void OAIParamountEft::setUpdatedTime(const QDateTime &updated_time) {
    m_updated_time = updated_time;
    m_updated_time_isSet = true;
}

bool OAIParamountEft::is_updated_time_Set() const{
    return m_updated_time_isSet;
}

bool OAIParamountEft::is_updated_time_Valid() const{
    return m_updated_time_isValid;
}

OAIParamountEft_allOf_credentials OAIParamountEft::getCredentials() const {
    return m_credentials;
}
void OAIParamountEft::setCredentials(const OAIParamountEft_allOf_credentials &credentials) {
    m_credentials = credentials;
    m_credentials_isSet = true;
}

bool OAIParamountEft::is_credentials_Set() const{
    return m_credentials_isSet;
}

bool OAIParamountEft::is_credentials_Valid() const{
    return m_credentials_isValid;
}

bool OAIParamountEft::isSet() const {
...
bool OAIParamountEft::isValid() const {
