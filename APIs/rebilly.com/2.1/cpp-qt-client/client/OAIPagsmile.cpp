...
OAIPagsmile::OAIPagsmile(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPagsmile::OAIPagsmile() {
    this->initializeModel();
}

OAIPagsmile::~OAIPagsmile() {}

void OAIPagsmile::initializeModel() {
...
void OAIPagsmile::fromJson(QString jsonString) {
...
void OAIPagsmile::fromJsonObject(QJsonObject json) {
...
QString OAIPagsmile::asJson() const {
...
QJsonObject OAIPagsmile::asJsonObject() const {
    QJsonObject obj;
    if (m__links.size() > 0) {
...
QList<OAIGatewayAccount__links_inner> OAIPagsmile::getLinks() const {
    return m__links;
}
void OAIPagsmile::setLinks(const QList<OAIGatewayAccount__links_inner> &_links) {
    m__links = _links;
    m__links_isSet = true;
}

bool OAIPagsmile::is__links_Set() const{
    return m__links_isSet;
}

bool OAIPagsmile::is__links_Valid() const{
    return m__links_isValid;
}

QList<QString> OAIPagsmile::getAcceptedCurrencies() const {
    return m_accepted_currencies;
}
void OAIPagsmile::setAcceptedCurrencies(const QList<QString> &accepted_currencies) {
    m_accepted_currencies = accepted_currencies;
    m_accepted_currencies_isSet = true;
}

bool OAIPagsmile::is_accepted_currencies_Set() const{
    return m_accepted_currencies_isSet;
}

bool OAIPagsmile::is_accepted_currencies_Valid() const{
    return m_accepted_currencies_isValid;
}

OAIAcquirerName OAIPagsmile::getAcquirerName() const {
    return m_acquirer_name;
}
void OAIPagsmile::setAcquirerName(const OAIAcquirerName &acquirer_name) {
    m_acquirer_name = acquirer_name;
    m_acquirer_name_isSet = true;
}

bool OAIPagsmile::is_acquirer_name_Set() const{
    return m_acquirer_name_isSet;
}

bool OAIPagsmile::is_acquirer_name_Valid() const{
    return m_acquirer_name_isValid;
}

QString OAIPagsmile::getAdditionalFilters() const {
    return m_additional_filters;
}
void OAIPagsmile::setAdditionalFilters(const QString &additional_filters) {
    m_additional_filters = additional_filters;
    m_additional_filters_isSet = true;
}

bool OAIPagsmile::is_additional_filters_Set() const{
    return m_additional_filters_isSet;
}

bool OAIPagsmile::is_additional_filters_Valid() const{
    return m_additional_filters_isValid;
}

qint32 OAIPagsmile::getApprovalWindowTtl() const {
    return m_approval_window_ttl;
}
void OAIPagsmile::setApprovalWindowTtl(const qint32 &approval_window_ttl) {
    m_approval_window_ttl = approval_window_ttl;
    m_approval_window_ttl_isSet = true;
}

bool OAIPagsmile::is_approval_window_ttl_Set() const{
    return m_approval_window_ttl_isSet;
}

bool OAIPagsmile::is_approval_window_ttl_Valid() const{
    return m_approval_window_ttl_isValid;
}

QString OAIPagsmile::getCityField() const {
    return m_city_field;
}
void OAIPagsmile::setCityField(const QString &city_field) {
    m_city_field = city_field;
    m_city_field_isSet = true;
}

bool OAIPagsmile::is_city_field_Set() const{
    return m_city_field_isSet;
}

bool OAIPagsmile::is_city_field_Valid() const{
    return m_city_field_isValid;
}

QDateTime OAIPagsmile::getCreatedTime() const {
    return m_created_time;
}
void OAIPagsmile::setCreatedTime(const QDateTime &created_time) {
    m_created_time = created_time;
    m_created_time_isSet = true;
}

bool OAIPagsmile::is_created_time_Set() const{
    return m_created_time_isSet;
}

bool OAIPagsmile::is_created_time_Valid() const{
    return m_created_time_isValid;
}

QString OAIPagsmile::getDccForceCurrency() const {
    return m_dcc_force_currency;
}
void OAIPagsmile::setDccForceCurrency(const QString &dcc_force_currency) {
    m_dcc_force_currency = dcc_force_currency;
    m_dcc_force_currency_isSet = true;
}

bool OAIPagsmile::is_dcc_force_currency_Set() const{
    return m_dcc_force_currency_isSet;
}

bool OAIPagsmile::is_dcc_force_currency_Valid() const{
    return m_dcc_force_currency_isValid;
}

qint32 OAIPagsmile::getDccMarkup() const {
    return m_dcc_markup;
}
void OAIPagsmile::setDccMarkup(const qint32 &dcc_markup) {
    m_dcc_markup = dcc_markup;
    m_dcc_markup_isSet = true;
}

bool OAIPagsmile::is_dcc_markup_Set() const{
    return m_dcc_markup_isSet;
}

bool OAIPagsmile::is_dcc_markup_Valid() const{
    return m_dcc_markup_isValid;
}

QString OAIPagsmile::getDescriptor() const {
    return m_descriptor;
}
void OAIPagsmile::setDescriptor(const QString &descriptor) {
    m_descriptor = descriptor;
    m_descriptor_isSet = true;
}

bool OAIPagsmile::is_descriptor_Set() const{
    return m_descriptor_isSet;
}

bool OAIPagsmile::is_descriptor_Valid() const{
    return m_descriptor_isValid;
}

OAIDigitalWallets OAIPagsmile::getDigitalWallets() const {
    return m_digital_wallets;
}
void OAIPagsmile::setDigitalWallets(const OAIDigitalWallets &digital_wallets) {
    m_digital_wallets = digital_wallets;
    m_digital_wallets_isSet = true;
}

bool OAIPagsmile::is_digital_wallets_Set() const{
    return m_digital_wallets_isSet;
}

bool OAIPagsmile::is_digital_wallets_Valid() const{
    return m_digital_wallets_isValid;
}

bool OAIPagsmile::isDynamicDescriptor() const {
    return m_dynamic_descriptor;
}
void OAIPagsmile::setDynamicDescriptor(const bool &dynamic_descriptor) {
    m_dynamic_descriptor = dynamic_descriptor;
    m_dynamic_descriptor_isSet = true;
}

bool OAIPagsmile::is_dynamic_descriptor_Set() const{
    return m_dynamic_descriptor_isSet;
}

bool OAIPagsmile::is_dynamic_descriptor_Valid() const{
    return m_dynamic_descriptor_isValid;
}

QList<QString> OAIPagsmile::getExcludedDccQuoteCurrencies() const {
    return m_excluded_dcc_quote_currencies;
}
void OAIPagsmile::setExcludedDccQuoteCurrencies(const QList<QString> &excluded_dcc_quote_currencies) {
    m_excluded_dcc_quote_currencies = excluded_dcc_quote_currencies;
    m_excluded_dcc_quote_currencies_isSet = true;
}

bool OAIPagsmile::is_excluded_dcc_quote_currencies_Set() const{
    return m_excluded_dcc_quote_currencies_isSet;
}

bool OAIPagsmile::is_excluded_dcc_quote_currencies_Valid() const{
    return m_excluded_dcc_quote_currencies_isValid;
}

OAIGatewayName OAIPagsmile::getGatewayName() const {
    return m_gateway_name;
}
void OAIPagsmile::setGatewayName(const OAIGatewayName &gateway_name) {
    m_gateway_name = gateway_name;
    m_gateway_name_isSet = true;
}

bool OAIPagsmile::is_gateway_name_Set() const{
    return m_gateway_name_isSet;
}

bool OAIPagsmile::is_gateway_name_Valid() const{
    return m_gateway_name_isValid;
}

QString OAIPagsmile::getId() const {
    return m_id;
}
void OAIPagsmile::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIPagsmile::is_id_Set() const{
    return m_id_isSet;
}

bool OAIPagsmile::is_id_Valid() const{
    return m_id_isValid;
}

bool OAIPagsmile::isIsDown() const {
    return m_is_down;
}
void OAIPagsmile::setIsDown(const bool &is_down) {
    m_is_down = is_down;
    m_is_down_isSet = true;
}

bool OAIPagsmile::is_is_down_Set() const{
    return m_is_down_isSet;
}

bool OAIPagsmile::is_is_down_Valid() const{
    return m_is_down_isValid;
}

QString OAIPagsmile::getMerchantCategoryCode() const {
    return m_merchant_category_code;
}
void OAIPagsmile::setMerchantCategoryCode(const QString &merchant_category_code) {
    m_merchant_category_code = merchant_category_code;
    m_merchant_category_code_isSet = true;
}

bool OAIPagsmile::is_merchant_category_code_Set() const{
    return m_merchant_category_code_isSet;
}

bool OAIPagsmile::is_merchant_category_code_Valid() const{
    return m_merchant_category_code_isValid;
}

OAIPaymentMethod OAIPagsmile::getMethod() const {
    return m_method;
}
void OAIPagsmile::setMethod(const OAIPaymentMethod &method) {
    m_method = method;
    m_method_isSet = true;
}

bool OAIPagsmile::is_method_Set() const{
    return m_method_isSet;
}

bool OAIPagsmile::is_method_Valid() const{
    return m_method_isValid;
}

double OAIPagsmile::getMonthlyLimit() const {
    return m_monthly_limit;
}
void OAIPagsmile::setMonthlyLimit(const double &monthly_limit) {
    m_monthly_limit = monthly_limit;
    m_monthly_limit_isSet = true;
}

bool OAIPagsmile::is_monthly_limit_Set() const{
    return m_monthly_limit_isSet;
}

bool OAIPagsmile::is_monthly_limit_Valid() const{
    return m_monthly_limit_isValid;
}

QString OAIPagsmile::getOrganizationId() const {
    return m_organization_id;
}
void OAIPagsmile::setOrganizationId(const QString &organization_id) {
    m_organization_id = organization_id;
    m_organization_id_isSet = true;
}

bool OAIPagsmile::is_organization_id_Set() const{
    return m_organization_id_isSet;
}

bool OAIPagsmile::is_organization_id_Valid() const{
    return m_organization_id_isValid;
}

QList<OAIPaymentCardBrand> OAIPagsmile::getPaymentCardSchemes() const {
    return m_payment_card_schemes;
}
void OAIPagsmile::setPaymentCardSchemes(const QList<OAIPaymentCardBrand> &payment_card_schemes) {
    m_payment_card_schemes = payment_card_schemes;
    m_payment_card_schemes_isSet = true;
}

bool OAIPagsmile::is_payment_card_schemes_Set() const{
    return m_payment_card_schemes_isSet;
}

bool OAIPagsmile::is_payment_card_schemes_Valid() const{
    return m_payment_card_schemes_isValid;
}

bool OAIPagsmile::isReconciliationWindowEnabled() const {
    return m_reconciliation_window_enabled;
}
void OAIPagsmile::setReconciliationWindowEnabled(const bool &reconciliation_window_enabled) {
    m_reconciliation_window_enabled = reconciliation_window_enabled;
    m_reconciliation_window_enabled_isSet = true;
}

bool OAIPagsmile::is_reconciliation_window_enabled_Set() const{
    return m_reconciliation_window_enabled_isSet;
}

bool OAIPagsmile::is_reconciliation_window_enabled_Valid() const{
    return m_reconciliation_window_enabled_isValid;
}

qint32 OAIPagsmile::getReconciliationWindowTtl() const {
    return m_reconciliation_window_ttl;
}
void OAIPagsmile::setReconciliationWindowTtl(const qint32 &reconciliation_window_ttl) {
    m_reconciliation_window_ttl = reconciliation_window_ttl;
    m_reconciliation_window_ttl_isSet = true;
}

bool OAIPagsmile::is_reconciliation_window_ttl_Set() const{
    return m_reconciliation_window_ttl_isSet;
}

bool OAIPagsmile::is_reconciliation_window_ttl_Valid() const{
    return m_reconciliation_window_ttl_isValid;
}

QString OAIPagsmile::getStatus() const {
    return m_status;
}
void OAIPagsmile::setStatus(const QString &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIPagsmile::is_status_Set() const{
    return m_status_isSet;
}

bool OAIPagsmile::is_status_Valid() const{
    return m_status_isValid;
}

bool OAIPagsmile::isSticky() const {
    return m_sticky;
}
void OAIPagsmile::setSticky(const bool &sticky) {
    m_sticky = sticky;
    m_sticky_isSet = true;
}

bool OAIPagsmile::is_sticky_Set() const{
    return m_sticky_isSet;
}

bool OAIPagsmile::is_sticky_Valid() const{
    return m_sticky_isValid;
}

bool OAIPagsmile::isThreeDSecure() const {
    return m_three_d_secure;
}
void OAIPagsmile::setThreeDSecure(const bool &three_d_secure) {
    m_three_d_secure = three_d_secure;
    m_three_d_secure_isSet = true;
}

bool OAIPagsmile::is_three_d_secure_Set() const{
    return m_three_d_secure_isSet;
}

bool OAIPagsmile::is_three_d_secure_Valid() const{
    return m_three_d_secure_isValid;
}

qint32 OAIPagsmile::getTimeout() const {
    return m_timeout;
}
void OAIPagsmile::setTimeout(const qint32 &timeout) {
    m_timeout = timeout;
    m_timeout_isSet = true;
}

bool OAIPagsmile::is_timeout_Set() const{
    return m_timeout_isSet;
}

bool OAIPagsmile::is_timeout_Valid() const{
    return m_timeout_isValid;
}

QString OAIPagsmile::getToken() const {
    return m_token;
}
void OAIPagsmile::setToken(const QString &token) {
    m_token = token;
    m_token_isSet = true;
}

bool OAIPagsmile::is_token_Set() const{
    return m_token_isSet;
}

bool OAIPagsmile::is_token_Valid() const{
    return m_token_isValid;
}

QDateTime OAIPagsmile::getUpdatedTime() const {
    return m_updated_time;
}
void OAIPagsmile::setUpdatedTime(const QDateTime &updated_time) {
    m_updated_time = updated_time;
    m_updated_time_isSet = true;
}

bool OAIPagsmile::is_updated_time_Set() const{
    return m_updated_time_isSet;
}

bool OAIPagsmile::is_updated_time_Valid() const{
    return m_updated_time_isValid;
}

OAIPagsmile_allOf_credentials OAIPagsmile::getCredentials() const {
    return m_credentials;
}
void OAIPagsmile::setCredentials(const OAIPagsmile_allOf_credentials &credentials) {
    m_credentials = credentials;
    m_credentials_isSet = true;
}

bool OAIPagsmile::is_credentials_Set() const{
    return m_credentials_isSet;
}

bool OAIPagsmile::is_credentials_Valid() const{
    return m_credentials_isValid;
}

bool OAIPagsmile::isSet() const {
...
bool OAIPagsmile::isValid() const {
