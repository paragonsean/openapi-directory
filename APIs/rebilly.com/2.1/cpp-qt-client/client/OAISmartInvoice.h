...
#ifndef OAISmartInvoice_H
#define OAISmartInvoice_H
...
class OAISmartInvoice_allOf_credentials;
class OAISmartInvoice3dsServers;

class OAISmartInvoice : public OAIObject {
public:
    OAISmartInvoice();
    OAISmartInvoice(QString json);
    ~OAISmartInvoice() override;
    ...
    OAISmartInvoice_allOf_credentials getCredentials() const;
    void setCredentials(const OAISmartInvoice_allOf_credentials &credentials);
    bool is_credentials_Set() const;
    bool is_credentials_Valid() const;

    OAISmartInvoice3dsServers getThreeDSecureServer() const;
    void setThreeDSecureServer(const OAISmartInvoice3dsServers &three_d_secure_server);
...
private:
    ...
    OAISmartInvoice_allOf_credentials m_credentials;
    bool m_credentials_isSet;
    bool m_credentials_isValid;

    OAISmartInvoice3dsServers m_three_d_secure_server;
...
Q_DECLARE_METATYPE(OpenAPI::OAISmartInvoice)

#endif // OAISmartInvoice_H
