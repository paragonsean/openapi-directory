...
void OAINMI::fromJson(QString jsonString) {
...
void OAINMI::fromJsonObject(QJsonObject json) {
...
QJsonObject OAINMI::asJsonObject() const {
    QJsonObject obj;
    if (m__links.size() > 0) {
...
QList<OAIGatewayAccount__links_inner> OAINMI::getLinks() const {
    return m__links;
}
void OAINMI::setLinks(const QList<OAIGatewayAccount__links_inner> &_links) {
    m__links = _links;
    m__links_isSet = true;
}

bool OAINMI::is__links_Set() const{
    return m__links_isSet;
}

bool OAINMI::is__links_Valid() const{
    return m__links_isValid;
}

QList<QString> OAINMI::getAcceptedCurrencies() const {
    return m_accepted_currencies;
}
void OAINMI::setAcceptedCurrencies(const QList<QString> &accepted_currencies) {
    m_accepted_currencies = accepted_currencies;
    m_accepted_currencies_isSet = true;
}

bool OAINMI::is_accepted_currencies_Set() const{
    return m_accepted_currencies_isSet;
}

bool OAINMI::is_accepted_currencies_Valid() const{
    return m_accepted_currencies_isValid;
}

OAIAcquirerName OAINMI::getAcquirerName() const {
    return m_acquirer_name;
}
void OAINMI::setAcquirerName(const OAIAcquirerName &acquirer_name) {
    m_acquirer_name = acquirer_name;
    m_acquirer_name_isSet = true;
}

bool OAINMI::is_acquirer_name_Set() const{
    return m_acquirer_name_isSet;
}

bool OAINMI::is_acquirer_name_Valid() const{
    return m_acquirer_name_isValid;
}

QString OAINMI::getAdditionalFilters() const {
    return m_additional_filters;
}
void OAINMI::setAdditionalFilters(const QString &additional_filters) {
    m_additional_filters = additional_filters;
    m_additional_filters_isSet = true;
}

bool OAINMI::is_additional_filters_Set() const{
    return m_additional_filters_isSet;
}

bool OAINMI::is_additional_filters_Valid() const{
    return m_additional_filters_isValid;
}

qint32 OAINMI::getApprovalWindowTtl() const {
    return m_approval_window_ttl;
}
void OAINMI::setApprovalWindowTtl(const qint32 &approval_window_ttl) {
    m_approval_window_ttl = approval_window_ttl;
    m_approval_window_ttl_isSet = true;
}

bool OAINMI::is_approval_window_ttl_Set() const{
    return m_approval_window_ttl_isSet;
}

bool OAINMI::is_approval_window_ttl_Valid() const{
    return m_approval_window_ttl_isValid;
}

QString OAINMI::getCityField() const {
    return m_city_field;
}
void OAINMI::setCityField(const QString &city_field) {
    m_city_field = city_field;
    m_city_field_isSet = true;
}

bool OAINMI::is_city_field_Set() const{
    return m_city_field_isSet;
}

bool OAINMI::is_city_field_Valid() const{
    return m_city_field_isValid;
}

QDateTime OAINMI::getCreatedTime() const {
    return m_created_time;
}
void OAINMI::setCreatedTime(const QDateTime &created_time) {
    m_created_time = created_time;
    m_created_time_isSet = true;
}

bool OAINMI::is_created_time_Set() const{
    return m_created_time_isSet;
}

bool OAINMI::is_created_time_Valid() const{
    return m_created_time_isValid;
}

QString OAINMI::getDccForceCurrency() const {
    return m_dcc_force_currency;
}
void OAINMI::setDccForceCurrency(const QString &dcc_force_currency) {
    m_dcc_force_currency = dcc_force_currency;
    m_dcc_force_currency_isSet = true;
}

bool OAINMI::is_dcc_force_currency_Set() const{
    return m_dcc_force_currency_isSet;
}

bool OAINMI::is_dcc_force_currency_Valid() const{
    return m_dcc_force_currency_isValid;
}

qint32 OAINMI::getDccMarkup() const {
    return m_dcc_markup;
}
void OAINMI::setDccMarkup(const qint32 &dcc_markup) {
    m_dcc_markup = dcc_markup;
    m_dcc_markup_isSet = true;
}

bool OAINMI::is_dcc_markup_Set() const{
    return m_dcc_markup_isSet;
}

bool OAINMI::is_dcc_markup_Valid() const{
    return m_dcc_markup_isValid;
}

QString OAINMI::getDescriptor() const {
    return m_descriptor;
}
void OAINMI::setDescriptor(const QString &descriptor) {
    m_descriptor = descriptor;
    m_descriptor_isSet = true;
}

bool OAINMI::is_descriptor_Set() const{
    return m_descriptor_isSet;
}

bool OAINMI::is_descriptor_Valid() const{
    return m_descriptor_isValid;
}

OAIDigitalWallets OAINMI::getDigitalWallets() const {
    return m_digital_wallets;
}
void OAINMI::setDigitalWallets(const OAIDigitalWallets &digital_wallets) {
    m_digital_wallets = digital_wallets;
    m_digital_wallets_isSet = true;
}

bool OAINMI::is_digital_wallets_Set() const{
    return m_digital_wallets_isSet;
}

bool OAINMI::is_digital_wallets_Valid() const{
    return m_digital_wallets_isValid;
}

bool OAINMI::isDynamicDescriptor() const {
    return m_dynamic_descriptor;
}
void OAINMI::setDynamicDescriptor(const bool &dynamic_descriptor) {
    m_dynamic_descriptor = dynamic_descriptor;
    m_dynamic_descriptor_isSet = true;
}

bool OAINMI::is_dynamic_descriptor_Set() const{
    return m_dynamic_descriptor_isSet;
}

bool OAINMI::is_dynamic_descriptor_Valid() const{
    return m_dynamic_descriptor_isValid;
}

QList<QString> OAINMI::getExcludedDccQuoteCurrencies() const {
    return m_excluded_dcc_quote_currencies;
}
void OAINMI::setExcludedDccQuoteCurrencies(const QList<QString> &excluded_dcc_quote_currencies) {
    m_excluded_dcc_quote_currencies = excluded_dcc_quote_currencies;
    m_excluded_dcc_quote_currencies_isSet = true;
}

bool OAINMI::is_excluded_dcc_quote_currencies_Set() const{
    return m_excluded_dcc_quote_currencies_isSet;
}

bool OAINMI::is_excluded_dcc_quote_currencies_Valid() const{
    return m_excluded_dcc_quote_currencies_isValid;
}

OAIGatewayName OAINMI::getGatewayName() const {
    return m_gateway_name;
}
void OAINMI::setGatewayName(const OAIGatewayName &gateway_name) {
    m_gateway_name = gateway_name;
    m_gateway_name_isSet = true;
}

bool OAINMI::is_gateway_name_Set() const{
    return m_gateway_name_isSet;
}

bool OAINMI::is_gateway_name_Valid() const{
    return m_gateway_name_isValid;
}

QString OAINMI::getId() const {
    return m_id;
}
void OAINMI::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAINMI::is_id_Set() const{
    return m_id_isSet;
}

bool OAINMI::is_id_Valid() const{
    return m_id_isValid;
}

bool OAINMI::isIsDown() const {
    return m_is_down;
}
void OAINMI::setIsDown(const bool &is_down) {
    m_is_down = is_down;
    m_is_down_isSet = true;
}

bool OAINMI::is_is_down_Set() const{
    return m_is_down_isSet;
}

bool OAINMI::is_is_down_Valid() const{
    return m_is_down_isValid;
}

QString OAINMI::getMerchantCategoryCode() const {
    return m_merchant_category_code;
}
void OAINMI::setMerchantCategoryCode(const QString &merchant_category_code) {
    m_merchant_category_code = merchant_category_code;
    m_merchant_category_code_isSet = true;
}

bool OAINMI::is_merchant_category_code_Set() const{
    return m_merchant_category_code_isSet;
}

bool OAINMI::is_merchant_category_code_Valid() const{
    return m_merchant_category_code_isValid;
}

OAIPaymentMethod OAINMI::getMethod() const {
    return m_method;
}
void OAINMI::setMethod(const OAIPaymentMethod &method) {
    m_method = method;
    m_method_isSet = true;
}

bool OAINMI::is_method_Set() const{
    return m_method_isSet;
}

bool OAINMI::is_method_Valid() const{
    return m_method_isValid;
}

double OAINMI::getMonthlyLimit() const {
    return m_monthly_limit;
}
void OAINMI::setMonthlyLimit(const double &monthly_limit) {
    m_monthly_limit = monthly_limit;
    m_monthly_limit_isSet = true;
}

bool OAINMI::is_monthly_limit_Set() const{
    return m_monthly_limit_isSet;
}

bool OAINMI::is_monthly_limit_Valid() const{
    return m_monthly_limit_isValid;
}

QString OAINMI::getOrganizationId() const {
    return m_organization_id;
}
void OAINMI::setOrganizationId(const QString &organization_id) {
    m_organization_id = organization_id;
    m_organization_id_isSet = true;
}

bool OAINMI::is_organization_id_Set() const{
    return m_organization_id_isSet;
}

bool OAINMI::is_organization_id_Valid() const{
    return m_organization_id_isValid;
}

QList<OAIPaymentCardBrand> OAINMI::getPaymentCardSchemes() const {
    return m_payment_card_schemes;
}
void OAINMI::setPaymentCardSchemes(const QList<OAIPaymentCardBrand> &payment_card_schemes) {
    m_payment_card_schemes = payment_card_schemes;
    m_payment_card_schemes_isSet = true;
}

bool OAINMI::is_payment_card_schemes_Set() const{
    return m_payment_card_schemes_isSet;
}

bool OAINMI::is_payment_card_schemes_Valid() const{
    return m_payment_card_schemes_isValid;
}

bool OAINMI::isReconciliationWindowEnabled() const {
    return m_reconciliation_window_enabled;
}
void OAINMI::setReconciliationWindowEnabled(const bool &reconciliation_window_enabled) {
    m_reconciliation_window_enabled = reconciliation_window_enabled;
    m_reconciliation_window_enabled_isSet = true;
}

bool OAINMI::is_reconciliation_window_enabled_Set() const{
    return m_reconciliation_window_enabled_isSet;
}

bool OAINMI::is_reconciliation_window_enabled_Valid() const{
    return m_reconciliation_window_enabled_isValid;
}

qint32 OAINMI::getReconciliationWindowTtl() const {
    return m_reconciliation_window_ttl;
}
void OAINMI::setReconciliationWindowTtl(const qint32 &reconciliation_window_ttl) {
    m_reconciliation_window_ttl = reconciliation_window_ttl;
    m_reconciliation_window_ttl_isSet = true;
}

bool OAINMI::is_reconciliation_window_ttl_Set() const{
    return m_reconciliation_window_ttl_isSet;
}

bool OAINMI::is_reconciliation_window_ttl_Valid() const{
    return m_reconciliation_window_ttl_isValid;
}

QString OAINMI::getStatus() const {
    return m_status;
}
void OAINMI::setStatus(const QString &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAINMI::is_status_Set() const{
    return m_status_isSet;
}

bool OAINMI::is_status_Valid() const{
    return m_status_isValid;
}

bool OAINMI::isSticky() const {
    return m_sticky;
}
void OAINMI::setSticky(const bool &sticky) {
    m_sticky = sticky;
    m_sticky_isSet = true;
}

bool OAINMI::is_sticky_Set() const{
    return m_sticky_isSet;
}

bool OAINMI::is_sticky_Valid() const{
    return m_sticky_isValid;
}

bool OAINMI::isThreeDSecure() const {
    return m_three_d_secure;
}
void OAINMI::setThreeDSecure(const bool &three_d_secure) {
    m_three_d_secure = three_d_secure;
    m_three_d_secure_isSet = true;
}

bool OAINMI::is_three_d_secure_Set() const{
    return m_three_d_secure_isSet;
}

bool OAINMI::is_three_d_secure_Valid() const{
    return m_three_d_secure_isValid;
}

qint32 OAINMI::getTimeout() const {
    return m_timeout;
}
void OAINMI::setTimeout(const qint32 &timeout) {
    m_timeout = timeout;
    m_timeout_isSet = true;
}

bool OAINMI::is_timeout_Set() const{
    return m_timeout_isSet;
}

bool OAINMI::is_timeout_Valid() const{
    return m_timeout_isValid;
}

QString OAINMI::getToken() const {
    return m_token;
}
void OAINMI::setToken(const QString &token) {
    m_token = token;
    m_token_isSet = true;
}

bool OAINMI::is_token_Set() const{
    return m_token_isSet;
}

bool OAINMI::is_token_Valid() const{
    return m_token_isValid;
}

QDateTime OAINMI::getUpdatedTime() const {
    return m_updated_time;
}
void OAINMI::setUpdatedTime(const QDateTime &updated_time) {
    m_updated_time = updated_time;
    m_updated_time_isSet = true;
}

bool OAINMI::is_updated_time_Set() const{
    return m_updated_time_isSet;
}

bool OAINMI::is_updated_time_Valid() const{
    return m_updated_time_isValid;
}

OAINMI_allOf_credentials OAINMI::getCredentials() const {
    return m_credentials;
}
void OAINMI::setCredentials(const OAINMI_allOf_credentials &credentials) {
    m_credentials = credentials;
    m_credentials_isSet = true;
}

bool OAINMI::is_credentials_Set() const{
    return m_credentials_isSet;
}

bool OAINMI::is_credentials_Valid() const{
    return m_credentials_isValid;
}

OAINMI_allOf_settings OAINMI::getSettings() const {
    return m_settings;
}
void OAINMI::setSettings(const OAINMI_allOf_settings &settings) {
    m_settings = settings;
    m_settings_isSet = true;
}

bool OAINMI::is_settings_Set() const{
    return m_settings_isSet;
}

bool OAINMI::is_settings_Valid() const{
    return m_settings_isValid;
}

OAINMI3dsServers OAINMI::getThreeDSecureServer() const {
    return m_three_d_secure_server;
}
void OAINMI::setThreeDSecureServer(const OAINMI3dsServers &three_d_secure_server) {
    m_three_d_secure_server = three_d_secure_server;
    m_three_d_secure_server_isSet = true;
}

bool OAINMI::is_three_d_secure_server_Set() const{
    return m_three_d_secure_server_isSet;
}

bool OAINMI::is_three_d_secure_server_Valid() const{
    return m_three_d_secure_server_isValid;
}

bool OAINMI::isSet() const {
