...
/*
 * OAIInstrumentReference.h
 *
 * 
 */

#ifndef OAIInstrumentReference_H
#define OAIInstrumentReference_H
...
class OAIInstrumentReference : public OAIObject {
public:
    OAIInstrumentReference();
    OAIInstrumentReference(QString json);
    ~OAIInstrumentReference() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIInstrumentReference)

#endif // OAIInstrumentReference_H
