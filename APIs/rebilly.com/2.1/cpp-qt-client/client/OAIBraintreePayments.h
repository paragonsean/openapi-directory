...
/*
 * OAIBraintreePayments.h
 *
 * BraintreePayments Gateway config.
 */

#ifndef OAIBraintreePayments_H
#define OAIBraintreePayments_H

#include <QJsonObject>

#include "OAIAcquirerName.h"
#include "OAIBraintreePayments_allOf_credentials.h"
...
class OAIBraintreePayments_allOf_credentials;

class OAIBraintreePayments : public OAIObject {
public:
    OAIBraintreePayments();
    OAIBraintreePayments(QString json);
    ~OAIBraintreePayments() override;
    ...
    OAIBraintreePayments_allOf_credentials getCredentials() const;
    void setCredentials(const OAIBraintreePayments_allOf_credentials &credentials);
...
private:
    ...
    OAIBraintreePayments_allOf_credentials m_credentials;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBraintreePayments)

#endif // OAIBraintreePayments_H
