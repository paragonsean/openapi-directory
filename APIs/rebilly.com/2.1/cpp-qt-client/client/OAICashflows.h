...
#ifndef OAICashflows_H
#define OAICashflows_H
...
class OAICashflows_allOf_credentials;

class OAICashflows : public OAIObject {
public:
    OAICashflows();
    OAICashflows(QString json);
    ~OAICashflows() override;
    ...
    OAICashflows_allOf_credentials getCredentials() const;
    void setCredentials(const OAICashflows_allOf_credentials &credentials);
...
private:
    ...
    OAICashflows_allOf_credentials m_credentials;
...
Q_DECLARE_METATYPE(OpenAPI::OAICashflows)

#endif // OAICashflows_H
