...
class OAIInovio_allOf_credentials;
class OAIInovio_allOf_settings;
class OAIInovio3dsServers;

class OAIInovio : public OAIObject {
public:
    OAIInovio();
    OAIInovio(QString json);
    ~OAIInovio() override;
    ...
    OAIInovio_allOf_credentials getCredentials() const;
    void setCredentials(const OAIInovio_allOf_credentials &credentials);
    bool is_credentials_Set() const;
    bool is_credentials_Valid() const;

    OAIInovio_allOf_settings getSettings() const;
    void setSettings(const OAIInovio_allOf_settings &settings);
    bool is_settings_Set() const;
    bool is_settings_Valid() const;

    OAIInovio3dsServers getThreeDSecureServer() const;
    void setThreeDSecureServer(const OAIInovio3dsServers &three_d_secure_server);
...
private:
    ...
    OAIInovio_allOf_credentials m_credentials;
    bool m_credentials_isSet;
    bool m_credentials_isValid;

    OAIInovio_allOf_settings m_settings;
    bool m_settings_isSet;
    bool m_settings_isValid;

    OAIInovio3dsServers m_three_d_secure_server;
...
Q_DECLARE_METATYPE(OpenAPI::OAIInovio)
