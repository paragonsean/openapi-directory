...
/*
 * OAICitadel_allOf_credentials.h
 *
 * Citadel credentials object.
 */

#ifndef OAICitadel_allOf_credentials_H
#define OAICitadel_allOf_credentials_H
...
class OAICitadel_allOf_credentials : public OAIObject {
public:
    OAICitadel_allOf_credentials();
    OAICitadel_allOf_credentials(QString json);
    ~OAICitadel_allOf_credentials() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICitadel_allOf_credentials)

#endif // OAICitadel_allOf_credentials_H
