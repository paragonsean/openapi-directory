...
OAIMtaPay::OAIMtaPay(QString json) {
...
void OAIMtaPay::initializeModel() {
...
void OAIMtaPay::fromJson(QString jsonString) {
...
void OAIMtaPay::fromJsonObject(QJsonObject json) {
...
QString OAIMtaPay::asJson() const {
...
QJsonObject OAIMtaPay::asJsonObject() const {
    QJsonObject obj;
    if (m__links.size() > 0) {
...
QList<OAIGatewayAccount__links_inner> OAIMtaPay::getLinks() const {
    return m__links;
}
void OAIMtaPay::setLinks(const QList<OAIGatewayAccount__links_inner> &_links) {
    m__links = _links;
    m__links_isSet = true;
}

bool OAIMtaPay::is__links_Set() const{
    return m__links_isSet;
}

bool OAIMtaPay::is__links_Valid() const{
    return m__links_isValid;
}

QList<QString> OAIMtaPay::getAcceptedCurrencies() const {
    return m_accepted_currencies;
}
void OAIMtaPay::setAcceptedCurrencies(const QList<QString> &accepted_currencies) {
    m_accepted_currencies = accepted_currencies;
    m_accepted_currencies_isSet = true;
}

bool OAIMtaPay::is_accepted_currencies_Set() const{
    return m_accepted_currencies_isSet;
}

bool OAIMtaPay::is_accepted_currencies_Valid() const{
    return m_accepted_currencies_isValid;
}

OAIAcquirerName OAIMtaPay::getAcquirerName() const {
    return m_acquirer_name;
}
void OAIMtaPay::setAcquirerName(const OAIAcquirerName &acquirer_name) {
    m_acquirer_name = acquirer_name;
    m_acquirer_name_isSet = true;
}

bool OAIMtaPay::is_acquirer_name_Set() const{
    return m_acquirer_name_isSet;
}

bool OAIMtaPay::is_acquirer_name_Valid() const{
    return m_acquirer_name_isValid;
}

QString OAIMtaPay::getAdditionalFilters() const {
    return m_additional_filters;
}
void OAIMtaPay::setAdditionalFilters(const QString &additional_filters) {
    m_additional_filters = additional_filters;
    m_additional_filters_isSet = true;
}

bool OAIMtaPay::is_additional_filters_Set() const{
    return m_additional_filters_isSet;
}

bool OAIMtaPay::is_additional_filters_Valid() const{
    return m_additional_filters_isValid;
}

qint32 OAIMtaPay::getApprovalWindowTtl() const {
    return m_approval_window_ttl;
}
void OAIMtaPay::setApprovalWindowTtl(const qint32 &approval_window_ttl) {
    m_approval_window_ttl = approval_window_ttl;
    m_approval_window_ttl_isSet = true;
}

bool OAIMtaPay::is_approval_window_ttl_Set() const{
    return m_approval_window_ttl_isSet;
}

bool OAIMtaPay::is_approval_window_ttl_Valid() const{
    return m_approval_window_ttl_isValid;
}

QString OAIMtaPay::getCityField() const {
    return m_city_field;
}
void OAIMtaPay::setCityField(const QString &city_field) {
    m_city_field = city_field;
    m_city_field_isSet = true;
}

bool OAIMtaPay::is_city_field_Set() const{
    return m_city_field_isSet;
}

bool OAIMtaPay::is_city_field_Valid() const{
    return m_city_field_isValid;
}

QDateTime OAIMtaPay::getCreatedTime() const {
    return m_created_time;
}
void OAIMtaPay::setCreatedTime(const QDateTime &created_time) {
    m_created_time = created_time;
    m_created_time_isSet = true;
}

bool OAIMtaPay::is_created_time_Set() const{
    return m_created_time_isSet;
}

bool OAIMtaPay::is_created_time_Valid() const{
    return m_created_time_isValid;
}

QString OAIMtaPay::getDccForceCurrency() const {
    return m_dcc_force_currency;
}
void OAIMtaPay::setDccForceCurrency(const QString &dcc_force_currency) {
    m_dcc_force_currency = dcc_force_currency;
    m_dcc_force_currency_isSet = true;
}

bool OAIMtaPay::is_dcc_force_currency_Set() const{
    return m_dcc_force_currency_isSet;
}

bool OAIMtaPay::is_dcc_force_currency_Valid() const{
    return m_dcc_force_currency_isValid;
}

qint32 OAIMtaPay::getDccMarkup() const {
    return m_dcc_markup;
}
void OAIMtaPay::setDccMarkup(const qint32 &dcc_markup) {
    m_dcc_markup = dcc_markup;
    m_dcc_markup_isSet = true;
}

bool OAIMtaPay::is_dcc_markup_Set() const{
    return m_dcc_markup_isSet;
}

bool OAIMtaPay::is_dcc_markup_Valid() const{
    return m_dcc_markup_isValid;
}

QString OAIMtaPay::getDescriptor() const {
    return m_descriptor;
}
void OAIMtaPay::setDescriptor(const QString &descriptor) {
    m_descriptor = descriptor;
    m_descriptor_isSet = true;
}

bool OAIMtaPay::is_descriptor_Set() const{
    return m_descriptor_isSet;
}

bool OAIMtaPay::is_descriptor_Valid() const{
    return m_descriptor_isValid;
}

OAIDigitalWallets OAIMtaPay::getDigitalWallets() const {
    return m_digital_wallets;
}
void OAIMtaPay::setDigitalWallets(const OAIDigitalWallets &digital_wallets) {
    m_digital_wallets = digital_wallets;
    m_digital_wallets_isSet = true;
}

bool OAIMtaPay::is_digital_wallets_Set() const{
    return m_digital_wallets_isSet;
}

bool OAIMtaPay::is_digital_wallets_Valid() const{
    return m_digital_wallets_isValid;
}

bool OAIMtaPay::isDynamicDescriptor() const {
    return m_dynamic_descriptor;
}
void OAIMtaPay::setDynamicDescriptor(const bool &dynamic_descriptor) {
    m_dynamic_descriptor = dynamic_descriptor;
    m_dynamic_descriptor_isSet = true;
}

bool OAIMtaPay::is_dynamic_descriptor_Set() const{
    return m_dynamic_descriptor_isSet;
}

bool OAIMtaPay::is_dynamic_descriptor_Valid() const{
    return m_dynamic_descriptor_isValid;
}

QList<QString> OAIMtaPay::getExcludedDccQuoteCurrencies() const {
    return m_excluded_dcc_quote_currencies;
}
void OAIMtaPay::setExcludedDccQuoteCurrencies(const QList<QString> &excluded_dcc_quote_currencies) {
    m_excluded_dcc_quote_currencies = excluded_dcc_quote_currencies;
    m_excluded_dcc_quote_currencies_isSet = true;
}

bool OAIMtaPay::is_excluded_dcc_quote_currencies_Set() const{
    return m_excluded_dcc_quote_currencies_isSet;
}

bool OAIMtaPay::is_excluded_dcc_quote_currencies_Valid() const{
    return m_excluded_dcc_quote_currencies_isValid;
}

OAIGatewayName OAIMtaPay::getGatewayName() const {
    return m_gateway_name;
}
void OAIMtaPay::setGatewayName(const OAIGatewayName &gateway_name) {
    m_gateway_name = gateway_name;
    m_gateway_name_isSet = true;
}

bool OAIMtaPay::is_gateway_name_Set() const{
    return m_gateway_name_isSet;
}

bool OAIMtaPay::is_gateway_name_Valid() const{
    return m_gateway_name_isValid;
}

QString OAIMtaPay::getId() const {
    return m_id;
}
void OAIMtaPay::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIMtaPay::is_id_Set() const{
    return m_id_isSet;
}

bool OAIMtaPay::is_id_Valid() const{
    return m_id_isValid;
}

bool OAIMtaPay::isIsDown() const {
    return m_is_down;
}
void OAIMtaPay::setIsDown(const bool &is_down) {
    m_is_down = is_down;
    m_is_down_isSet = true;
}

bool OAIMtaPay::is_is_down_Set() const{
    return m_is_down_isSet;
}

bool OAIMtaPay::is_is_down_Valid() const{
    return m_is_down_isValid;
}

QString OAIMtaPay::getMerchantCategoryCode() const {
    return m_merchant_category_code;
}
void OAIMtaPay::setMerchantCategoryCode(const QString &merchant_category_code) {
    m_merchant_category_code = merchant_category_code;
    m_merchant_category_code_isSet = true;
}

bool OAIMtaPay::is_merchant_category_code_Set() const{
    return m_merchant_category_code_isSet;
}

bool OAIMtaPay::is_merchant_category_code_Valid() const{
    return m_merchant_category_code_isValid;
}

OAIPaymentMethod OAIMtaPay::getMethod() const {
    return m_method;
}
void OAIMtaPay::setMethod(const OAIPaymentMethod &method) {
    m_method = method;
    m_method_isSet = true;
}

bool OAIMtaPay::is_method_Set() const{
    return m_method_isSet;
}

bool OAIMtaPay::is_method_Valid() const{
    return m_method_isValid;
}

double OAIMtaPay::getMonthlyLimit() const {
    return m_monthly_limit;
}
void OAIMtaPay::setMonthlyLimit(const double &monthly_limit) {
    m_monthly_limit = monthly_limit;
    m_monthly_limit_isSet = true;
}

bool OAIMtaPay::is_monthly_limit_Set() const{
    return m_monthly_limit_isSet;
}

bool OAIMtaPay::is_monthly_limit_Valid() const{
    return m_monthly_limit_isValid;
}

QString OAIMtaPay::getOrganizationId() const {
    return m_organization_id;
}
void OAIMtaPay::setOrganizationId(const QString &organization_id) {
    m_organization_id = organization_id;
    m_organization_id_isSet = true;
}

bool OAIMtaPay::is_organization_id_Set() const{
    return m_organization_id_isSet;
}

bool OAIMtaPay::is_organization_id_Valid() const{
    return m_organization_id_isValid;
}

QList<OAIPaymentCardBrand> OAIMtaPay::getPaymentCardSchemes() const {
    return m_payment_card_schemes;
}
void OAIMtaPay::setPaymentCardSchemes(const QList<OAIPaymentCardBrand> &payment_card_schemes) {
    m_payment_card_schemes = payment_card_schemes;
    m_payment_card_schemes_isSet = true;
}

bool OAIMtaPay::is_payment_card_schemes_Set() const{
    return m_payment_card_schemes_isSet;
}

bool OAIMtaPay::is_payment_card_schemes_Valid() const{
    return m_payment_card_schemes_isValid;
}

bool OAIMtaPay::isReconciliationWindowEnabled() const {
    return m_reconciliation_window_enabled;
}
void OAIMtaPay::setReconciliationWindowEnabled(const bool &reconciliation_window_enabled) {
    m_reconciliation_window_enabled = reconciliation_window_enabled;
    m_reconciliation_window_enabled_isSet = true;
}

bool OAIMtaPay::is_reconciliation_window_enabled_Set() const{
    return m_reconciliation_window_enabled_isSet;
}

bool OAIMtaPay::is_reconciliation_window_enabled_Valid() const{
    return m_reconciliation_window_enabled_isValid;
}

qint32 OAIMtaPay::getReconciliationWindowTtl() const {
    return m_reconciliation_window_ttl;
}
void OAIMtaPay::setReconciliationWindowTtl(const qint32 &reconciliation_window_ttl) {
    m_reconciliation_window_ttl = reconciliation_window_ttl;
    m_reconciliation_window_ttl_isSet = true;
}

bool OAIMtaPay::is_reconciliation_window_ttl_Set() const{
    return m_reconciliation_window_ttl_isSet;
}

bool OAIMtaPay::is_reconciliation_window_ttl_Valid() const{
    return m_reconciliation_window_ttl_isValid;
}

QString OAIMtaPay::getStatus() const {
    return m_status;
}
void OAIMtaPay::setStatus(const QString &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIMtaPay::is_status_Set() const{
    return m_status_isSet;
}

bool OAIMtaPay::is_status_Valid() const{
    return m_status_isValid;
}

bool OAIMtaPay::isSticky() const {
    return m_sticky;
}
void OAIMtaPay::setSticky(const bool &sticky) {
    m_sticky = sticky;
    m_sticky_isSet = true;
}

bool OAIMtaPay::is_sticky_Set() const{
    return m_sticky_isSet;
}

bool OAIMtaPay::is_sticky_Valid() const{
    return m_sticky_isValid;
}

bool OAIMtaPay::isThreeDSecure() const {
    return m_three_d_secure;
}
void OAIMtaPay::setThreeDSecure(const bool &three_d_secure) {
    m_three_d_secure = three_d_secure;
    m_three_d_secure_isSet = true;
}

bool OAIMtaPay::is_three_d_secure_Set() const{
    return m_three_d_secure_isSet;
}

bool OAIMtaPay::is_three_d_secure_Valid() const{
    return m_three_d_secure_isValid;
}

qint32 OAIMtaPay::getTimeout() const {
    return m_timeout;
}
void OAIMtaPay::setTimeout(const qint32 &timeout) {
    m_timeout = timeout;
    m_timeout_isSet = true;
}

bool OAIMtaPay::is_timeout_Set() const{
    return m_timeout_isSet;
}

bool OAIMtaPay::is_timeout_Valid() const{
    return m_timeout_isValid;
}

QString OAIMtaPay::getToken() const {
    return m_token;
}
void OAIMtaPay::setToken(const QString &token) {
    m_token = token;
    m_token_isSet = true;
}

bool OAIMtaPay::is_token_Set() const{
    return m_token_isSet;
}

bool OAIMtaPay::is_token_Valid() const{
    return m_token_isValid;
}

QDateTime OAIMtaPay::getUpdatedTime() const {
    return m_updated_time;
}
void OAIMtaPay::setUpdatedTime(const QDateTime &updated_time) {
    m_updated_time = updated_time;
    m_updated_time_isSet = true;
}

bool OAIMtaPay::is_updated_time_Set() const{
    return m_updated_time_isSet;
}

bool OAIMtaPay::is_updated_time_Valid() const{
    return m_updated_time_isValid;
}

OAIMtaPay_allOf_credentials OAIMtaPay::getCredentials() const {
    return m_credentials;
}
void OAIMtaPay::setCredentials(const OAIMtaPay_allOf_credentials &credentials) {
    m_credentials = credentials;
    m_credentials_isSet = true;
}

bool OAIMtaPay::is_credentials_Set() const{
    return m_credentials_isSet;
}

bool OAIMtaPay::is_credentials_Valid() const{
    return m_credentials_isValid;
}

OAIMtaPay_allOf_settings OAIMtaPay::getSettings() const {
    return m_settings;
}
void OAIMtaPay::setSettings(const OAIMtaPay_allOf_settings &settings) {
    m_settings = settings;
    m_settings_isSet = true;
}

bool OAIMtaPay::is_settings_Set() const{
    return m_settings_isSet;
}

bool OAIMtaPay::is_settings_Valid() const{
    return m_settings_isValid;
}

bool OAIMtaPay::isSet() const {
