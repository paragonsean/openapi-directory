...
OAIGooney::OAIGooney(QString json) {
...
void OAIGooney::initializeModel() {
...
void OAIGooney::fromJson(QString jsonString) {
...
void OAIGooney::fromJsonObject(QJsonObject json) {
...
QString OAIGooney::asJson() const {
...
QJsonObject OAIGooney::asJsonObject() const {
    QJsonObject obj;
    if (m__links.size() > 0) {
...
QList<OAIGatewayAccount__links_inner> OAIGooney::getLinks() const {
    return m__links;
}
void OAIGooney::setLinks(const QList<OAIGatewayAccount__links_inner> &_links) {
    m__links = _links;
    m__links_isSet = true;
}

bool OAIGooney::is__links_Set() const{
    return m__links_isSet;
}

bool OAIGooney::is__links_Valid() const{
    return m__links_isValid;
}

QList<QString> OAIGooney::getAcceptedCurrencies() const {
    return m_accepted_currencies;
}
void OAIGooney::setAcceptedCurrencies(const QList<QString> &accepted_currencies) {
    m_accepted_currencies = accepted_currencies;
    m_accepted_currencies_isSet = true;
}

bool OAIGooney::is_accepted_currencies_Set() const{
    return m_accepted_currencies_isSet;
}

bool OAIGooney::is_accepted_currencies_Valid() const{
    return m_accepted_currencies_isValid;
}

OAIAcquirerName OAIGooney::getAcquirerName() const {
    return m_acquirer_name;
}
void OAIGooney::setAcquirerName(const OAIAcquirerName &acquirer_name) {
    m_acquirer_name = acquirer_name;
    m_acquirer_name_isSet = true;
}

bool OAIGooney::is_acquirer_name_Set() const{
    return m_acquirer_name_isSet;
}

bool OAIGooney::is_acquirer_name_Valid() const{
    return m_acquirer_name_isValid;
}

QString OAIGooney::getAdditionalFilters() const {
    return m_additional_filters;
}
void OAIGooney::setAdditionalFilters(const QString &additional_filters) {
    m_additional_filters = additional_filters;
    m_additional_filters_isSet = true;
}

bool OAIGooney::is_additional_filters_Set() const{
    return m_additional_filters_isSet;
}

bool OAIGooney::is_additional_filters_Valid() const{
    return m_additional_filters_isValid;
}

qint32 OAIGooney::getApprovalWindowTtl() const {
    return m_approval_window_ttl;
}
void OAIGooney::setApprovalWindowTtl(const qint32 &approval_window_ttl) {
    m_approval_window_ttl = approval_window_ttl;
    m_approval_window_ttl_isSet = true;
}

bool OAIGooney::is_approval_window_ttl_Set() const{
    return m_approval_window_ttl_isSet;
}

bool OAIGooney::is_approval_window_ttl_Valid() const{
    return m_approval_window_ttl_isValid;
}

QString OAIGooney::getCityField() const {
    return m_city_field;
}
void OAIGooney::setCityField(const QString &city_field) {
    m_city_field = city_field;
    m_city_field_isSet = true;
}

bool OAIGooney::is_city_field_Set() const{
    return m_city_field_isSet;
}

bool OAIGooney::is_city_field_Valid() const{
    return m_city_field_isValid;
}

QDateTime OAIGooney::getCreatedTime() const {
    return m_created_time;
}
void OAIGooney::setCreatedTime(const QDateTime &created_time) {
    m_created_time = created_time;
    m_created_time_isSet = true;
}

bool OAIGooney::is_created_time_Set() const{
    return m_created_time_isSet;
}

bool OAIGooney::is_created_time_Valid() const{
    return m_created_time_isValid;
}

QString OAIGooney::getDccForceCurrency() const {
    return m_dcc_force_currency;
}
void OAIGooney::setDccForceCurrency(const QString &dcc_force_currency) {
    m_dcc_force_currency = dcc_force_currency;
    m_dcc_force_currency_isSet = true;
}

bool OAIGooney::is_dcc_force_currency_Set() const{
    return m_dcc_force_currency_isSet;
}

bool OAIGooney::is_dcc_force_currency_Valid() const{
    return m_dcc_force_currency_isValid;
}

qint32 OAIGooney::getDccMarkup() const {
    return m_dcc_markup;
}
void OAIGooney::setDccMarkup(const qint32 &dcc_markup) {
    m_dcc_markup = dcc_markup;
    m_dcc_markup_isSet = true;
}

bool OAIGooney::is_dcc_markup_Set() const{
    return m_dcc_markup_isSet;
}

bool OAIGooney::is_dcc_markup_Valid() const{
    return m_dcc_markup_isValid;
}

QString OAIGooney::getDescriptor() const {
    return m_descriptor;
}
void OAIGooney::setDescriptor(const QString &descriptor) {
    m_descriptor = descriptor;
    m_descriptor_isSet = true;
}

bool OAIGooney::is_descriptor_Set() const{
    return m_descriptor_isSet;
}

bool OAIGooney::is_descriptor_Valid() const{
    return m_descriptor_isValid;
}

OAIDigitalWallets OAIGooney::getDigitalWallets() const {
    return m_digital_wallets;
}
void OAIGooney::setDigitalWallets(const OAIDigitalWallets &digital_wallets) {
    m_digital_wallets = digital_wallets;
    m_digital_wallets_isSet = true;
}

bool OAIGooney::is_digital_wallets_Set() const{
    return m_digital_wallets_isSet;
}

bool OAIGooney::is_digital_wallets_Valid() const{
    return m_digital_wallets_isValid;
}

bool OAIGooney::isDynamicDescriptor() const {
    return m_dynamic_descriptor;
}
void OAIGooney::setDynamicDescriptor(const bool &dynamic_descriptor) {
    m_dynamic_descriptor = dynamic_descriptor;
    m_dynamic_descriptor_isSet = true;
}

bool OAIGooney::is_dynamic_descriptor_Set() const{
    return m_dynamic_descriptor_isSet;
}

bool OAIGooney::is_dynamic_descriptor_Valid() const{
    return m_dynamic_descriptor_isValid;
}

QList<QString> OAIGooney::getExcludedDccQuoteCurrencies() const {
    return m_excluded_dcc_quote_currencies;
}
void OAIGooney::setExcludedDccQuoteCurrencies(const QList<QString> &excluded_dcc_quote_currencies) {
    m_excluded_dcc_quote_currencies = excluded_dcc_quote_currencies;
    m_excluded_dcc_quote_currencies_isSet = true;
}

bool OAIGooney::is_excluded_dcc_quote_currencies_Set() const{
    return m_excluded_dcc_quote_currencies_isSet;
}

bool OAIGooney::is_excluded_dcc_quote_currencies_Valid() const{
    return m_excluded_dcc_quote_currencies_isValid;
}

OAIGatewayName OAIGooney::getGatewayName() const {
    return m_gateway_name;
}
void OAIGooney::setGatewayName(const OAIGatewayName &gateway_name) {
    m_gateway_name = gateway_name;
    m_gateway_name_isSet = true;
}

bool OAIGooney::is_gateway_name_Set() const{
    return m_gateway_name_isSet;
}

bool OAIGooney::is_gateway_name_Valid() const{
    return m_gateway_name_isValid;
}

QString OAIGooney::getId() const {
    return m_id;
}
void OAIGooney::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIGooney::is_id_Set() const{
    return m_id_isSet;
}

bool OAIGooney::is_id_Valid() const{
    return m_id_isValid;
}

bool OAIGooney::isIsDown() const {
    return m_is_down;
}
void OAIGooney::setIsDown(const bool &is_down) {
    m_is_down = is_down;
    m_is_down_isSet = true;
}

bool OAIGooney::is_is_down_Set() const{
    return m_is_down_isSet;
}

bool OAIGooney::is_is_down_Valid() const{
    return m_is_down_isValid;
}

QString OAIGooney::getMerchantCategoryCode() const {
    return m_merchant_category_code;
}
void OAIGooney::setMerchantCategoryCode(const QString &merchant_category_code) {
    m_merchant_category_code = merchant_category_code;
    m_merchant_category_code_isSet = true;
}

bool OAIGooney::is_merchant_category_code_Set() const{
    return m_merchant_category_code_isSet;
}

bool OAIGooney::is_merchant_category_code_Valid() const{
    return m_merchant_category_code_isValid;
}

OAIPaymentMethod OAIGooney::getMethod() const {
    return m_method;
}
void OAIGooney::setMethod(const OAIPaymentMethod &method) {
    m_method = method;
    m_method_isSet = true;
}

bool OAIGooney::is_method_Set() const{
    return m_method_isSet;
}

bool OAIGooney::is_method_Valid() const{
    return m_method_isValid;
}

double OAIGooney::getMonthlyLimit() const {
    return m_monthly_limit;
}
void OAIGooney::setMonthlyLimit(const double &monthly_limit) {
    m_monthly_limit = monthly_limit;
    m_monthly_limit_isSet = true;
}

bool OAIGooney::is_monthly_limit_Set() const{
    return m_monthly_limit_isSet;
}

bool OAIGooney::is_monthly_limit_Valid() const{
    return m_monthly_limit_isValid;
}

QString OAIGooney::getOrganizationId() const {
    return m_organization_id;
}
void OAIGooney::setOrganizationId(const QString &organization_id) {
    m_organization_id = organization_id;
    m_organization_id_isSet = true;
}

bool OAIGooney::is_organization_id_Set() const{
    return m_organization_id_isSet;
}

bool OAIGooney::is_organization_id_Valid() const{
    return m_organization_id_isValid;
}

QList<OAIPaymentCardBrand> OAIGooney::getPaymentCardSchemes() const {
    return m_payment_card_schemes;
}
void OAIGooney::setPaymentCardSchemes(const QList<OAIPaymentCardBrand> &payment_card_schemes) {
    m_payment_card_schemes = payment_card_schemes;
    m_payment_card_schemes_isSet = true;
}

bool OAIGooney::is_payment_card_schemes_Set() const{
    return m_payment_card_schemes_isSet;
}

bool OAIGooney::is_payment_card_schemes_Valid() const{
    return m_payment_card_schemes_isValid;
}

bool OAIGooney::isReconciliationWindowEnabled() const {
    return m_reconciliation_window_enabled;
}
void OAIGooney::setReconciliationWindowEnabled(const bool &reconciliation_window_enabled) {
    m_reconciliation_window_enabled = reconciliation_window_enabled;
    m_reconciliation_window_enabled_isSet = true;
}

bool OAIGooney::is_reconciliation_window_enabled_Set() const{
    return m_reconciliation_window_enabled_isSet;
}

bool OAIGooney::is_reconciliation_window_enabled_Valid() const{
    return m_reconciliation_window_enabled_isValid;
}

qint32 OAIGooney::getReconciliationWindowTtl() const {
    return m_reconciliation_window_ttl;
}
void OAIGooney::setReconciliationWindowTtl(const qint32 &reconciliation_window_ttl) {
    m_reconciliation_window_ttl = reconciliation_window_ttl;
    m_reconciliation_window_ttl_isSet = true;
}

bool OAIGooney::is_reconciliation_window_ttl_Set() const{
    return m_reconciliation_window_ttl_isSet;
}

bool OAIGooney::is_reconciliation_window_ttl_Valid() const{
    return m_reconciliation_window_ttl_isValid;
}

QString OAIGooney::getStatus() const {
    return m_status;
}
void OAIGooney::setStatus(const QString &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIGooney::is_status_Set() const{
    return m_status_isSet;
}

bool OAIGooney::is_status_Valid() const{
    return m_status_isValid;
}

bool OAIGooney::isSticky() const {
    return m_sticky;
}
void OAIGooney::setSticky(const bool &sticky) {
    m_sticky = sticky;
    m_sticky_isSet = true;
}

bool OAIGooney::is_sticky_Set() const{
    return m_sticky_isSet;
}

bool OAIGooney::is_sticky_Valid() const{
    return m_sticky_isValid;
}

bool OAIGooney::isThreeDSecure() const {
    return m_three_d_secure;
}
void OAIGooney::setThreeDSecure(const bool &three_d_secure) {
    m_three_d_secure = three_d_secure;
    m_three_d_secure_isSet = true;
}

bool OAIGooney::is_three_d_secure_Set() const{
    return m_three_d_secure_isSet;
}

bool OAIGooney::is_three_d_secure_Valid() const{
    return m_three_d_secure_isValid;
}

qint32 OAIGooney::getTimeout() const {
    return m_timeout;
}
void OAIGooney::setTimeout(const qint32 &timeout) {
    m_timeout = timeout;
    m_timeout_isSet = true;
}

bool OAIGooney::is_timeout_Set() const{
    return m_timeout_isSet;
}

bool OAIGooney::is_timeout_Valid() const{
    return m_timeout_isValid;
}

QString OAIGooney::getToken() const {
    return m_token;
}
void OAIGooney::setToken(const QString &token) {
    m_token = token;
    m_token_isSet = true;
}

bool OAIGooney::is_token_Set() const{
    return m_token_isSet;
}

bool OAIGooney::is_token_Valid() const{
    return m_token_isValid;
}

QDateTime OAIGooney::getUpdatedTime() const {
    return m_updated_time;
}
void OAIGooney::setUpdatedTime(const QDateTime &updated_time) {
    m_updated_time = updated_time;
    m_updated_time_isSet = true;
}

bool OAIGooney::is_updated_time_Set() const{
    return m_updated_time_isSet;
}

bool OAIGooney::is_updated_time_Valid() const{
    return m_updated_time_isValid;
}

OAIGooney_allOf_credentials OAIGooney::getCredentials() const {
    return m_credentials;
}
void OAIGooney::setCredentials(const OAIGooney_allOf_credentials &credentials) {
    m_credentials = credentials;
    m_credentials_isSet = true;
}

bool OAIGooney::is_credentials_Set() const{
    return m_credentials_isSet;
}

bool OAIGooney::is_credentials_Valid() const{
    return m_credentials_isValid;
}

bool OAIGooney::isSet() const {
