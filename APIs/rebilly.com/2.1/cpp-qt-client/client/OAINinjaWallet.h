...
#ifndef OAINinjaWallet_H
#define OAINinjaWallet_H
...
class OAINinjaWallet_allOf_credentials;

class OAINinjaWallet : public OAIObject {
public:
    OAINinjaWallet();
    OAINinjaWallet(QString json);
    ~OAINinjaWallet() override;
    ...
    OAINinjaWallet_allOf_credentials getCredentials() const;
    void setCredentials(const OAINinjaWallet_allOf_credentials &credentials);
...
private:
    ...
    OAINinjaWallet_allOf_credentials m_credentials;
...
Q_DECLARE_METATYPE(OpenAPI::OAINinjaWallet)

#endif // OAINinjaWallet_H
