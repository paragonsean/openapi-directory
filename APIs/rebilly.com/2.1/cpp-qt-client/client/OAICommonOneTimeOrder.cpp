...
#include "OAICommonOneTimeOrder.h"
...
OAICommonOneTimeOrder::OAICommonOneTimeOrder(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICommonOneTimeOrder::OAICommonOneTimeOrder() {
    this->initializeModel();
}

OAICommonOneTimeOrder::~OAICommonOneTimeOrder() {}

void OAICommonOneTimeOrder::initializeModel() {
...
void OAICommonOneTimeOrder::fromJson(QString jsonString) {
...
void OAICommonOneTimeOrder::fromJsonObject(QJsonObject json) {
...
QString OAICommonOneTimeOrder::asJson() const {
...
QJsonObject OAICommonOneTimeOrder::asJsonObject() const {
    QJsonObject obj;
...
QDateTime OAICommonOneTimeOrder::getActivationTime() const {
    return m_activation_time;
}
void OAICommonOneTimeOrder::setActivationTime(const QDateTime &activation_time) {
    m_activation_time = activation_time;
    m_activation_time_isSet = true;
}

bool OAICommonOneTimeOrder::is_activation_time_Set() const{
    return m_activation_time_isSet;
}

bool OAICommonOneTimeOrder::is_activation_time_Valid() const{
    return m_activation_time_isValid;
}

OAIContactObject OAICommonOneTimeOrder::getBillingAddress() const {
    return m_billing_address;
}
void OAICommonOneTimeOrder::setBillingAddress(const OAIContactObject &billing_address) {
    m_billing_address = billing_address;
    m_billing_address_isSet = true;
}

bool OAICommonOneTimeOrder::is_billing_address_Set() const{
    return m_billing_address_isSet;
}

bool OAICommonOneTimeOrder::is_billing_address_Valid() const{
    return m_billing_address_isValid;
}

QString OAICommonOneTimeOrder::getBillingStatus() const {
    return m_billing_status;
}
void OAICommonOneTimeOrder::setBillingStatus(const QString &billing_status) {
    m_billing_status = billing_status;
    m_billing_status_isSet = true;
}

bool OAICommonOneTimeOrder::is_billing_status_Set() const{
    return m_billing_status_isSet;
}

bool OAICommonOneTimeOrder::is_billing_status_Valid() const{
    return m_billing_status_isValid;
}

QList<QString> OAICommonOneTimeOrder::getCouponIds() const {
    return m_coupon_ids;
}
void OAICommonOneTimeOrder::setCouponIds(const QList<QString> &coupon_ids) {
    m_coupon_ids = coupon_ids;
    m_coupon_ids_isSet = true;
}

bool OAICommonOneTimeOrder::is_coupon_ids_Set() const{
    return m_coupon_ids_isSet;
}

bool OAICommonOneTimeOrder::is_coupon_ids_Valid() const{
    return m_coupon_ids_isValid;
}

OAIContactObject OAICommonOneTimeOrder::getDeliveryAddress() const {
    return m_delivery_address;
}
void OAICommonOneTimeOrder::setDeliveryAddress(const OAIContactObject &delivery_address) {
    m_delivery_address = delivery_address;
    m_delivery_address_isSet = true;
}

bool OAICommonOneTimeOrder::is_delivery_address_Set() const{
    return m_delivery_address_isSet;
}

bool OAICommonOneTimeOrder::is_delivery_address_Valid() const{
    return m_delivery_address_isValid;
}

QString OAICommonOneTimeOrder::getId() const {
    return m_id;
}
void OAICommonOneTimeOrder::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAICommonOneTimeOrder::is_id_Set() const{
    return m_id_isSet;
}

bool OAICommonOneTimeOrder::is_id_Valid() const{
    return m_id_isValid;
}

QString OAICommonOneTimeOrder::getInitialInvoiceId() const {
    return m_initial_invoice_id;
}
void OAICommonOneTimeOrder::setInitialInvoiceId(const QString &initial_invoice_id) {
    m_initial_invoice_id = initial_invoice_id;
    m_initial_invoice_id_isSet = true;
}

bool OAICommonOneTimeOrder::is_initial_invoice_id_Set() const{
    return m_initial_invoice_id_isSet;
}

bool OAICommonOneTimeOrder::is_initial_invoice_id_Valid() const{
    return m_initial_invoice_id_isValid;
}

QList<OAICommonSubscription_items_inner> OAICommonOneTimeOrder::getItems() const {
    return m_items;
}
void OAICommonOneTimeOrder::setItems(const QList<OAICommonSubscription_items_inner> &items) {
    m_items = items;
    m_items_isSet = true;
}

bool OAICommonOneTimeOrder::is_items_Set() const{
    return m_items_isSet;
}

bool OAICommonOneTimeOrder::is_items_Valid() const{
    return m_items_isValid;
}

QString OAICommonOneTimeOrder::getOrderType() const {
    return m_order_type;
}
void OAICommonOneTimeOrder::setOrderType(const QString &order_type) {
    m_order_type = order_type;
    m_order_type_isSet = true;
}

bool OAICommonOneTimeOrder::is_order_type_Set() const{
    return m_order_type_isSet;
}

bool OAICommonOneTimeOrder::is_order_type_Valid() const{
    return m_order_type_isValid;
}

QString OAICommonOneTimeOrder::getPoNumber() const {
    return m_po_number;
}
void OAICommonOneTimeOrder::setPoNumber(const QString &po_number) {
    m_po_number = po_number;
    m_po_number_isSet = true;
}

bool OAICommonOneTimeOrder::is_po_number_Set() const{
    return m_po_number_isSet;
}

bool OAICommonOneTimeOrder::is_po_number_Valid() const{
    return m_po_number_isValid;
}

QString OAICommonOneTimeOrder::getRecentInvoiceId() const {
    return m_recent_invoice_id;
}
void OAICommonOneTimeOrder::setRecentInvoiceId(const QString &recent_invoice_id) {
    m_recent_invoice_id = recent_invoice_id;
    m_recent_invoice_id_isSet = true;
}

bool OAICommonOneTimeOrder::is_recent_invoice_id_Set() const{
    return m_recent_invoice_id_isSet;
}

bool OAICommonOneTimeOrder::is_recent_invoice_id_Valid() const{
    return m_recent_invoice_id_isValid;
}

QDateTime OAICommonOneTimeOrder::getVoidTime() const {
    return m_void_time;
}
void OAICommonOneTimeOrder::setVoidTime(const QDateTime &void_time) {
    m_void_time = void_time;
    m_void_time_isSet = true;
}

bool OAICommonOneTimeOrder::is_void_time_Set() const{
    return m_void_time_isSet;
}

bool OAICommonOneTimeOrder::is_void_time_Valid() const{
    return m_void_time_isValid;
}

QString OAICommonOneTimeOrder::getWebsiteId() const {
    return m_website_id;
}
void OAICommonOneTimeOrder::setWebsiteId(const QString &website_id) {
    m_website_id = website_id;
    m_website_id_isSet = true;
}

bool OAICommonOneTimeOrder::is_website_id_Set() const{
    return m_website_id_isSet;
}

bool OAICommonOneTimeOrder::is_website_id_Valid() const{
    return m_website_id_isValid;
}

QString OAICommonOneTimeOrder::getStatus() const {
    return m_status;
}
void OAICommonOneTimeOrder::setStatus(const QString &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAICommonOneTimeOrder::is_status_Set() const{
    return m_status_isSet;
}

bool OAICommonOneTimeOrder::is_status_Valid() const{
    return m_status_isValid;
}

bool OAICommonOneTimeOrder::isSet() const {
...
bool OAICommonOneTimeOrder::isValid() const {
