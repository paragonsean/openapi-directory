...
/*
 * OAIPatchKycRequest_request.h
 *
 * 
 */

#ifndef OAIPatchKycRequest_request_H
#define OAIPatchKycRequest_request_H

#include <QJsonObject>

#include "OAICommonKycRequest_documents_inner.h"
#include "OAIKycRequest_allOf__links.h"
#include <QDateTime>
#include <QJsonValue>
#include <QList>
#include <QString>
...
namespace OpenAPI {
class OAICommonKycRequest_documents_inner;
class OAIKycRequest_allOf__links;

class OAIPatchKycRequest_request : public OAIObject {
public:
    OAIPatchKycRequest_request();
    OAIPatchKycRequest_request(QString json);
    ~OAIPatchKycRequest_request() override;
    ...
    QList<OAICommonKycRequest_documents_inner> getDocuments() const;
    void setDocuments(const QList<OAICommonKycRequest_documents_inner> &documents);
    ...
    QList<OAIKycRequest_allOf__links> getLinks() const;
    void setLinks(const QList<OAIKycRequest_allOf__links> &_links);
    bool is__links_Set() const;
    bool is__links_Valid() const;

    QJsonValue getCustomerId() const;
    void setCustomerId(const QJsonValue &customer_id);
...
private:
    ...
    QList<OAICommonKycRequest_documents_inner> m_documents;
    ...
    QList<OAIKycRequest_allOf__links> m__links;
    bool m__links_isSet;
    bool m__links_isValid;

    QJsonValue m_customer_id;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPatchKycRequest_request)

#endif // OAIPatchKycRequest_request_H
