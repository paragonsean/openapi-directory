...
class OAIChase_allOf_credentials;

class OAIChase : public OAIObject {
public:
    OAIChase();
    OAIChase(QString json);
    ~OAIChase() override;
    ...
    OAIChase_allOf_credentials getCredentials() const;
    void setCredentials(const OAIChase_allOf_credentials &credentials);
...
private:
    ...
    OAIChase_allOf_credentials m_credentials;
...
Q_DECLARE_METATYPE(OpenAPI::OAIChase)
