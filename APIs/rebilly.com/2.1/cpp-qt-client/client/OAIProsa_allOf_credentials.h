...
/*
 * OAIProsa_allOf_credentials.h
 *
 * Prosa credentials object.
 */

#ifndef OAIProsa_allOf_credentials_H
#define OAIProsa_allOf_credentials_H
...
class OAIProsa_allOf_credentials : public OAIObject {
public:
    OAIProsa_allOf_credentials();
    OAIProsa_allOf_credentials(QString json);
    ~OAIProsa_allOf_credentials() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIProsa_allOf_credentials)

#endif // OAIProsa_allOf_credentials_H
