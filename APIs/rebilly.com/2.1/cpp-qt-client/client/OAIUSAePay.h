...
#include "OAIUSAePay_allOf_credentials.h"
#include <QDateTime>
#include <QList>
#include <QString>
...
class OAIUSAePay_allOf_credentials;

class OAIUSAePay : public OAIObject {
public:
    OAIUSAePay();
    OAIUSAePay(QString json);
    ~OAIUSAePay() override;
    ...
    OAIUSAePay_allOf_credentials getCredentials() const;
    void setCredentials(const OAIUSAePay_allOf_credentials &credentials);
...
private:
    ...
    OAIUSAePay_allOf_credentials m_credentials;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUSAePay)
