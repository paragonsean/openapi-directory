...
OAICoppr::OAICoppr(QString json) {
...
void OAICoppr::fromJson(QString jsonString) {
...
void OAICoppr::fromJsonObject(QJsonObject json) {
...
QJsonObject OAICoppr::asJsonObject() const {
    QJsonObject obj;
    if (m__links.size() > 0) {
...
QList<OAIGatewayAccount__links_inner> OAICoppr::getLinks() const {
    return m__links;
}
void OAICoppr::setLinks(const QList<OAIGatewayAccount__links_inner> &_links) {
    m__links = _links;
    m__links_isSet = true;
}

bool OAICoppr::is__links_Set() const{
    return m__links_isSet;
}

bool OAICoppr::is__links_Valid() const{
    return m__links_isValid;
}

QList<QString> OAICoppr::getAcceptedCurrencies() const {
    return m_accepted_currencies;
}
void OAICoppr::setAcceptedCurrencies(const QList<QString> &accepted_currencies) {
    m_accepted_currencies = accepted_currencies;
    m_accepted_currencies_isSet = true;
}

bool OAICoppr::is_accepted_currencies_Set() const{
    return m_accepted_currencies_isSet;
}

bool OAICoppr::is_accepted_currencies_Valid() const{
    return m_accepted_currencies_isValid;
}

OAIAcquirerName OAICoppr::getAcquirerName() const {
    return m_acquirer_name;
}
void OAICoppr::setAcquirerName(const OAIAcquirerName &acquirer_name) {
    m_acquirer_name = acquirer_name;
    m_acquirer_name_isSet = true;
}

bool OAICoppr::is_acquirer_name_Set() const{
    return m_acquirer_name_isSet;
}

bool OAICoppr::is_acquirer_name_Valid() const{
    return m_acquirer_name_isValid;
}

QString OAICoppr::getAdditionalFilters() const {
    return m_additional_filters;
}
void OAICoppr::setAdditionalFilters(const QString &additional_filters) {
    m_additional_filters = additional_filters;
    m_additional_filters_isSet = true;
}

bool OAICoppr::is_additional_filters_Set() const{
    return m_additional_filters_isSet;
}

bool OAICoppr::is_additional_filters_Valid() const{
    return m_additional_filters_isValid;
}

qint32 OAICoppr::getApprovalWindowTtl() const {
    return m_approval_window_ttl;
}
void OAICoppr::setApprovalWindowTtl(const qint32 &approval_window_ttl) {
    m_approval_window_ttl = approval_window_ttl;
    m_approval_window_ttl_isSet = true;
}

bool OAICoppr::is_approval_window_ttl_Set() const{
    return m_approval_window_ttl_isSet;
}

bool OAICoppr::is_approval_window_ttl_Valid() const{
    return m_approval_window_ttl_isValid;
}

QString OAICoppr::getCityField() const {
    return m_city_field;
}
void OAICoppr::setCityField(const QString &city_field) {
    m_city_field = city_field;
    m_city_field_isSet = true;
}

bool OAICoppr::is_city_field_Set() const{
    return m_city_field_isSet;
}

bool OAICoppr::is_city_field_Valid() const{
    return m_city_field_isValid;
}

QDateTime OAICoppr::getCreatedTime() const {
    return m_created_time;
}
void OAICoppr::setCreatedTime(const QDateTime &created_time) {
    m_created_time = created_time;
    m_created_time_isSet = true;
}

bool OAICoppr::is_created_time_Set() const{
    return m_created_time_isSet;
}

bool OAICoppr::is_created_time_Valid() const{
    return m_created_time_isValid;
}

QString OAICoppr::getDccForceCurrency() const {
    return m_dcc_force_currency;
}
void OAICoppr::setDccForceCurrency(const QString &dcc_force_currency) {
    m_dcc_force_currency = dcc_force_currency;
    m_dcc_force_currency_isSet = true;
}

bool OAICoppr::is_dcc_force_currency_Set() const{
    return m_dcc_force_currency_isSet;
}

bool OAICoppr::is_dcc_force_currency_Valid() const{
    return m_dcc_force_currency_isValid;
}

qint32 OAICoppr::getDccMarkup() const {
    return m_dcc_markup;
}
void OAICoppr::setDccMarkup(const qint32 &dcc_markup) {
    m_dcc_markup = dcc_markup;
    m_dcc_markup_isSet = true;
}

bool OAICoppr::is_dcc_markup_Set() const{
    return m_dcc_markup_isSet;
}

bool OAICoppr::is_dcc_markup_Valid() const{
    return m_dcc_markup_isValid;
}

QString OAICoppr::getDescriptor() const {
    return m_descriptor;
}
void OAICoppr::setDescriptor(const QString &descriptor) {
    m_descriptor = descriptor;
    m_descriptor_isSet = true;
}

bool OAICoppr::is_descriptor_Set() const{
    return m_descriptor_isSet;
}

bool OAICoppr::is_descriptor_Valid() const{
    return m_descriptor_isValid;
}

OAIDigitalWallets OAICoppr::getDigitalWallets() const {
    return m_digital_wallets;
}
void OAICoppr::setDigitalWallets(const OAIDigitalWallets &digital_wallets) {
    m_digital_wallets = digital_wallets;
    m_digital_wallets_isSet = true;
}

bool OAICoppr::is_digital_wallets_Set() const{
    return m_digital_wallets_isSet;
}

bool OAICoppr::is_digital_wallets_Valid() const{
    return m_digital_wallets_isValid;
}

bool OAICoppr::isDynamicDescriptor() const {
    return m_dynamic_descriptor;
}
void OAICoppr::setDynamicDescriptor(const bool &dynamic_descriptor) {
    m_dynamic_descriptor = dynamic_descriptor;
    m_dynamic_descriptor_isSet = true;
}

bool OAICoppr::is_dynamic_descriptor_Set() const{
    return m_dynamic_descriptor_isSet;
}

bool OAICoppr::is_dynamic_descriptor_Valid() const{
    return m_dynamic_descriptor_isValid;
}

QList<QString> OAICoppr::getExcludedDccQuoteCurrencies() const {
    return m_excluded_dcc_quote_currencies;
}
void OAICoppr::setExcludedDccQuoteCurrencies(const QList<QString> &excluded_dcc_quote_currencies) {
    m_excluded_dcc_quote_currencies = excluded_dcc_quote_currencies;
    m_excluded_dcc_quote_currencies_isSet = true;
}

bool OAICoppr::is_excluded_dcc_quote_currencies_Set() const{
    return m_excluded_dcc_quote_currencies_isSet;
}

bool OAICoppr::is_excluded_dcc_quote_currencies_Valid() const{
    return m_excluded_dcc_quote_currencies_isValid;
}

OAIGatewayName OAICoppr::getGatewayName() const {
    return m_gateway_name;
}
void OAICoppr::setGatewayName(const OAIGatewayName &gateway_name) {
    m_gateway_name = gateway_name;
    m_gateway_name_isSet = true;
}

bool OAICoppr::is_gateway_name_Set() const{
    return m_gateway_name_isSet;
}

bool OAICoppr::is_gateway_name_Valid() const{
    return m_gateway_name_isValid;
}

QString OAICoppr::getId() const {
    return m_id;
}
void OAICoppr::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAICoppr::is_id_Set() const{
    return m_id_isSet;
}

bool OAICoppr::is_id_Valid() const{
    return m_id_isValid;
}

bool OAICoppr::isIsDown() const {
    return m_is_down;
}
void OAICoppr::setIsDown(const bool &is_down) {
    m_is_down = is_down;
    m_is_down_isSet = true;
}

bool OAICoppr::is_is_down_Set() const{
    return m_is_down_isSet;
}

bool OAICoppr::is_is_down_Valid() const{
    return m_is_down_isValid;
}

QString OAICoppr::getMerchantCategoryCode() const {
    return m_merchant_category_code;
}
void OAICoppr::setMerchantCategoryCode(const QString &merchant_category_code) {
    m_merchant_category_code = merchant_category_code;
    m_merchant_category_code_isSet = true;
}

bool OAICoppr::is_merchant_category_code_Set() const{
    return m_merchant_category_code_isSet;
}

bool OAICoppr::is_merchant_category_code_Valid() const{
    return m_merchant_category_code_isValid;
}

OAIPaymentMethod OAICoppr::getMethod() const {
    return m_method;
}
void OAICoppr::setMethod(const OAIPaymentMethod &method) {
    m_method = method;
    m_method_isSet = true;
}

bool OAICoppr::is_method_Set() const{
    return m_method_isSet;
}

bool OAICoppr::is_method_Valid() const{
    return m_method_isValid;
}

double OAICoppr::getMonthlyLimit() const {
    return m_monthly_limit;
}
void OAICoppr::setMonthlyLimit(const double &monthly_limit) {
    m_monthly_limit = monthly_limit;
    m_monthly_limit_isSet = true;
}

bool OAICoppr::is_monthly_limit_Set() const{
    return m_monthly_limit_isSet;
}

bool OAICoppr::is_monthly_limit_Valid() const{
    return m_monthly_limit_isValid;
}

QString OAICoppr::getOrganizationId() const {
    return m_organization_id;
}
void OAICoppr::setOrganizationId(const QString &organization_id) {
    m_organization_id = organization_id;
    m_organization_id_isSet = true;
}

bool OAICoppr::is_organization_id_Set() const{
    return m_organization_id_isSet;
}

bool OAICoppr::is_organization_id_Valid() const{
    return m_organization_id_isValid;
}

QList<OAIPaymentCardBrand> OAICoppr::getPaymentCardSchemes() const {
    return m_payment_card_schemes;
}
void OAICoppr::setPaymentCardSchemes(const QList<OAIPaymentCardBrand> &payment_card_schemes) {
    m_payment_card_schemes = payment_card_schemes;
    m_payment_card_schemes_isSet = true;
}

bool OAICoppr::is_payment_card_schemes_Set() const{
    return m_payment_card_schemes_isSet;
}

bool OAICoppr::is_payment_card_schemes_Valid() const{
    return m_payment_card_schemes_isValid;
}

bool OAICoppr::isReconciliationWindowEnabled() const {
    return m_reconciliation_window_enabled;
}
void OAICoppr::setReconciliationWindowEnabled(const bool &reconciliation_window_enabled) {
    m_reconciliation_window_enabled = reconciliation_window_enabled;
    m_reconciliation_window_enabled_isSet = true;
}

bool OAICoppr::is_reconciliation_window_enabled_Set() const{
    return m_reconciliation_window_enabled_isSet;
}

bool OAICoppr::is_reconciliation_window_enabled_Valid() const{
    return m_reconciliation_window_enabled_isValid;
}

qint32 OAICoppr::getReconciliationWindowTtl() const {
    return m_reconciliation_window_ttl;
}
void OAICoppr::setReconciliationWindowTtl(const qint32 &reconciliation_window_ttl) {
    m_reconciliation_window_ttl = reconciliation_window_ttl;
    m_reconciliation_window_ttl_isSet = true;
}

bool OAICoppr::is_reconciliation_window_ttl_Set() const{
    return m_reconciliation_window_ttl_isSet;
}

bool OAICoppr::is_reconciliation_window_ttl_Valid() const{
    return m_reconciliation_window_ttl_isValid;
}

QString OAICoppr::getStatus() const {
    return m_status;
}
void OAICoppr::setStatus(const QString &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAICoppr::is_status_Set() const{
    return m_status_isSet;
}

bool OAICoppr::is_status_Valid() const{
    return m_status_isValid;
}

bool OAICoppr::isSticky() const {
    return m_sticky;
}
void OAICoppr::setSticky(const bool &sticky) {
    m_sticky = sticky;
    m_sticky_isSet = true;
}

bool OAICoppr::is_sticky_Set() const{
    return m_sticky_isSet;
}

bool OAICoppr::is_sticky_Valid() const{
    return m_sticky_isValid;
}

bool OAICoppr::isThreeDSecure() const {
    return m_three_d_secure;
}
void OAICoppr::setThreeDSecure(const bool &three_d_secure) {
    m_three_d_secure = three_d_secure;
    m_three_d_secure_isSet = true;
}

bool OAICoppr::is_three_d_secure_Set() const{
    return m_three_d_secure_isSet;
}

bool OAICoppr::is_three_d_secure_Valid() const{
    return m_three_d_secure_isValid;
}

qint32 OAICoppr::getTimeout() const {
    return m_timeout;
}
void OAICoppr::setTimeout(const qint32 &timeout) {
    m_timeout = timeout;
    m_timeout_isSet = true;
}

bool OAICoppr::is_timeout_Set() const{
    return m_timeout_isSet;
}

bool OAICoppr::is_timeout_Valid() const{
    return m_timeout_isValid;
}

QString OAICoppr::getToken() const {
    return m_token;
}
void OAICoppr::setToken(const QString &token) {
    m_token = token;
    m_token_isSet = true;
}

bool OAICoppr::is_token_Set() const{
    return m_token_isSet;
}

bool OAICoppr::is_token_Valid() const{
    return m_token_isValid;
}

QDateTime OAICoppr::getUpdatedTime() const {
    return m_updated_time;
}
void OAICoppr::setUpdatedTime(const QDateTime &updated_time) {
    m_updated_time = updated_time;
    m_updated_time_isSet = true;
}

bool OAICoppr::is_updated_time_Set() const{
    return m_updated_time_isSet;
}

bool OAICoppr::is_updated_time_Valid() const{
    return m_updated_time_isValid;
}

OAICoppr_allOf_credentials OAICoppr::getCredentials() const {
    return m_credentials;
}
void OAICoppr::setCredentials(const OAICoppr_allOf_credentials &credentials) {
    m_credentials = credentials;
    m_credentials_isSet = true;
}

bool OAICoppr::is_credentials_Set() const{
    return m_credentials_isSet;
}

bool OAICoppr::is_credentials_Valid() const{
    return m_credentials_isValid;
}

OAICoppr_allOf_settings OAICoppr::getSettings() const {
    return m_settings;
}
void OAICoppr::setSettings(const OAICoppr_allOf_settings &settings) {
    m_settings = settings;
    m_settings_isSet = true;
}

bool OAICoppr::is_settings_Set() const{
    return m_settings_isSet;
}

bool OAICoppr::is_settings_Valid() const{
    return m_settings_isValid;
}

bool OAICoppr::isSet() const {
