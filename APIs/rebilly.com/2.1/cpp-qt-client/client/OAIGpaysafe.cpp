...
OAIGpaysafe::OAIGpaysafe(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGpaysafe::OAIGpaysafe() {
    this->initializeModel();
}

OAIGpaysafe::~OAIGpaysafe() {}

void OAIGpaysafe::initializeModel() {
...
void OAIGpaysafe::fromJson(QString jsonString) {
...
void OAIGpaysafe::fromJsonObject(QJsonObject json) {
...
QString OAIGpaysafe::asJson() const {
...
QJsonObject OAIGpaysafe::asJsonObject() const {
    QJsonObject obj;
    if (m__links.size() > 0) {
...
QList<OAIGatewayAccount__links_inner> OAIGpaysafe::getLinks() const {
    return m__links;
}
void OAIGpaysafe::setLinks(const QList<OAIGatewayAccount__links_inner> &_links) {
    m__links = _links;
    m__links_isSet = true;
}

bool OAIGpaysafe::is__links_Set() const{
    return m__links_isSet;
}

bool OAIGpaysafe::is__links_Valid() const{
    return m__links_isValid;
}

QList<QString> OAIGpaysafe::getAcceptedCurrencies() const {
    return m_accepted_currencies;
}
void OAIGpaysafe::setAcceptedCurrencies(const QList<QString> &accepted_currencies) {
    m_accepted_currencies = accepted_currencies;
    m_accepted_currencies_isSet = true;
}

bool OAIGpaysafe::is_accepted_currencies_Set() const{
    return m_accepted_currencies_isSet;
}

bool OAIGpaysafe::is_accepted_currencies_Valid() const{
    return m_accepted_currencies_isValid;
}

OAIAcquirerName OAIGpaysafe::getAcquirerName() const {
    return m_acquirer_name;
}
void OAIGpaysafe::setAcquirerName(const OAIAcquirerName &acquirer_name) {
    m_acquirer_name = acquirer_name;
    m_acquirer_name_isSet = true;
}

bool OAIGpaysafe::is_acquirer_name_Set() const{
    return m_acquirer_name_isSet;
}

bool OAIGpaysafe::is_acquirer_name_Valid() const{
    return m_acquirer_name_isValid;
}

QString OAIGpaysafe::getAdditionalFilters() const {
    return m_additional_filters;
}
void OAIGpaysafe::setAdditionalFilters(const QString &additional_filters) {
    m_additional_filters = additional_filters;
    m_additional_filters_isSet = true;
}

bool OAIGpaysafe::is_additional_filters_Set() const{
    return m_additional_filters_isSet;
}

bool OAIGpaysafe::is_additional_filters_Valid() const{
    return m_additional_filters_isValid;
}

qint32 OAIGpaysafe::getApprovalWindowTtl() const {
    return m_approval_window_ttl;
}
void OAIGpaysafe::setApprovalWindowTtl(const qint32 &approval_window_ttl) {
    m_approval_window_ttl = approval_window_ttl;
    m_approval_window_ttl_isSet = true;
}

bool OAIGpaysafe::is_approval_window_ttl_Set() const{
    return m_approval_window_ttl_isSet;
}

bool OAIGpaysafe::is_approval_window_ttl_Valid() const{
    return m_approval_window_ttl_isValid;
}

QString OAIGpaysafe::getCityField() const {
    return m_city_field;
}
void OAIGpaysafe::setCityField(const QString &city_field) {
    m_city_field = city_field;
    m_city_field_isSet = true;
}

bool OAIGpaysafe::is_city_field_Set() const{
    return m_city_field_isSet;
}

bool OAIGpaysafe::is_city_field_Valid() const{
    return m_city_field_isValid;
}

QDateTime OAIGpaysafe::getCreatedTime() const {
    return m_created_time;
}
void OAIGpaysafe::setCreatedTime(const QDateTime &created_time) {
    m_created_time = created_time;
    m_created_time_isSet = true;
}

bool OAIGpaysafe::is_created_time_Set() const{
    return m_created_time_isSet;
}

bool OAIGpaysafe::is_created_time_Valid() const{
    return m_created_time_isValid;
}

QString OAIGpaysafe::getDccForceCurrency() const {
    return m_dcc_force_currency;
}
void OAIGpaysafe::setDccForceCurrency(const QString &dcc_force_currency) {
    m_dcc_force_currency = dcc_force_currency;
    m_dcc_force_currency_isSet = true;
}

bool OAIGpaysafe::is_dcc_force_currency_Set() const{
    return m_dcc_force_currency_isSet;
}

bool OAIGpaysafe::is_dcc_force_currency_Valid() const{
    return m_dcc_force_currency_isValid;
}

qint32 OAIGpaysafe::getDccMarkup() const {
    return m_dcc_markup;
}
void OAIGpaysafe::setDccMarkup(const qint32 &dcc_markup) {
    m_dcc_markup = dcc_markup;
    m_dcc_markup_isSet = true;
}

bool OAIGpaysafe::is_dcc_markup_Set() const{
    return m_dcc_markup_isSet;
}

bool OAIGpaysafe::is_dcc_markup_Valid() const{
    return m_dcc_markup_isValid;
}

QString OAIGpaysafe::getDescriptor() const {
    return m_descriptor;
}
void OAIGpaysafe::setDescriptor(const QString &descriptor) {
    m_descriptor = descriptor;
    m_descriptor_isSet = true;
}

bool OAIGpaysafe::is_descriptor_Set() const{
    return m_descriptor_isSet;
}

bool OAIGpaysafe::is_descriptor_Valid() const{
    return m_descriptor_isValid;
}

OAIDigitalWallets OAIGpaysafe::getDigitalWallets() const {
    return m_digital_wallets;
}
void OAIGpaysafe::setDigitalWallets(const OAIDigitalWallets &digital_wallets) {
    m_digital_wallets = digital_wallets;
    m_digital_wallets_isSet = true;
}

bool OAIGpaysafe::is_digital_wallets_Set() const{
    return m_digital_wallets_isSet;
}

bool OAIGpaysafe::is_digital_wallets_Valid() const{
    return m_digital_wallets_isValid;
}

bool OAIGpaysafe::isDynamicDescriptor() const {
    return m_dynamic_descriptor;
}
void OAIGpaysafe::setDynamicDescriptor(const bool &dynamic_descriptor) {
    m_dynamic_descriptor = dynamic_descriptor;
    m_dynamic_descriptor_isSet = true;
}

bool OAIGpaysafe::is_dynamic_descriptor_Set() const{
    return m_dynamic_descriptor_isSet;
}

bool OAIGpaysafe::is_dynamic_descriptor_Valid() const{
    return m_dynamic_descriptor_isValid;
}

QList<QString> OAIGpaysafe::getExcludedDccQuoteCurrencies() const {
    return m_excluded_dcc_quote_currencies;
}
void OAIGpaysafe::setExcludedDccQuoteCurrencies(const QList<QString> &excluded_dcc_quote_currencies) {
    m_excluded_dcc_quote_currencies = excluded_dcc_quote_currencies;
    m_excluded_dcc_quote_currencies_isSet = true;
}

bool OAIGpaysafe::is_excluded_dcc_quote_currencies_Set() const{
    return m_excluded_dcc_quote_currencies_isSet;
}

bool OAIGpaysafe::is_excluded_dcc_quote_currencies_Valid() const{
    return m_excluded_dcc_quote_currencies_isValid;
}

OAIGatewayName OAIGpaysafe::getGatewayName() const {
    return m_gateway_name;
}
void OAIGpaysafe::setGatewayName(const OAIGatewayName &gateway_name) {
    m_gateway_name = gateway_name;
    m_gateway_name_isSet = true;
}

bool OAIGpaysafe::is_gateway_name_Set() const{
    return m_gateway_name_isSet;
}

bool OAIGpaysafe::is_gateway_name_Valid() const{
    return m_gateway_name_isValid;
}

QString OAIGpaysafe::getId() const {
    return m_id;
}
void OAIGpaysafe::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIGpaysafe::is_id_Set() const{
    return m_id_isSet;
}

bool OAIGpaysafe::is_id_Valid() const{
    return m_id_isValid;
}

bool OAIGpaysafe::isIsDown() const {
    return m_is_down;
}
void OAIGpaysafe::setIsDown(const bool &is_down) {
    m_is_down = is_down;
    m_is_down_isSet = true;
}

bool OAIGpaysafe::is_is_down_Set() const{
    return m_is_down_isSet;
}

bool OAIGpaysafe::is_is_down_Valid() const{
    return m_is_down_isValid;
}

QString OAIGpaysafe::getMerchantCategoryCode() const {
    return m_merchant_category_code;
}
void OAIGpaysafe::setMerchantCategoryCode(const QString &merchant_category_code) {
    m_merchant_category_code = merchant_category_code;
    m_merchant_category_code_isSet = true;
}

bool OAIGpaysafe::is_merchant_category_code_Set() const{
    return m_merchant_category_code_isSet;
}

bool OAIGpaysafe::is_merchant_category_code_Valid() const{
    return m_merchant_category_code_isValid;
}

OAIPaymentMethod OAIGpaysafe::getMethod() const {
    return m_method;
}
void OAIGpaysafe::setMethod(const OAIPaymentMethod &method) {
    m_method = method;
    m_method_isSet = true;
}

bool OAIGpaysafe::is_method_Set() const{
    return m_method_isSet;
}

bool OAIGpaysafe::is_method_Valid() const{
    return m_method_isValid;
}

double OAIGpaysafe::getMonthlyLimit() const {
    return m_monthly_limit;
}
void OAIGpaysafe::setMonthlyLimit(const double &monthly_limit) {
    m_monthly_limit = monthly_limit;
    m_monthly_limit_isSet = true;
}

bool OAIGpaysafe::is_monthly_limit_Set() const{
    return m_monthly_limit_isSet;
}

bool OAIGpaysafe::is_monthly_limit_Valid() const{
    return m_monthly_limit_isValid;
}

QString OAIGpaysafe::getOrganizationId() const {
    return m_organization_id;
}
void OAIGpaysafe::setOrganizationId(const QString &organization_id) {
    m_organization_id = organization_id;
    m_organization_id_isSet = true;
}

bool OAIGpaysafe::is_organization_id_Set() const{
    return m_organization_id_isSet;
}

bool OAIGpaysafe::is_organization_id_Valid() const{
    return m_organization_id_isValid;
}

QList<OAIPaymentCardBrand> OAIGpaysafe::getPaymentCardSchemes() const {
    return m_payment_card_schemes;
}
void OAIGpaysafe::setPaymentCardSchemes(const QList<OAIPaymentCardBrand> &payment_card_schemes) {
    m_payment_card_schemes = payment_card_schemes;
    m_payment_card_schemes_isSet = true;
}

bool OAIGpaysafe::is_payment_card_schemes_Set() const{
    return m_payment_card_schemes_isSet;
}

bool OAIGpaysafe::is_payment_card_schemes_Valid() const{
    return m_payment_card_schemes_isValid;
}

bool OAIGpaysafe::isReconciliationWindowEnabled() const {
    return m_reconciliation_window_enabled;
}
void OAIGpaysafe::setReconciliationWindowEnabled(const bool &reconciliation_window_enabled) {
    m_reconciliation_window_enabled = reconciliation_window_enabled;
    m_reconciliation_window_enabled_isSet = true;
}

bool OAIGpaysafe::is_reconciliation_window_enabled_Set() const{
    return m_reconciliation_window_enabled_isSet;
}

bool OAIGpaysafe::is_reconciliation_window_enabled_Valid() const{
    return m_reconciliation_window_enabled_isValid;
}

qint32 OAIGpaysafe::getReconciliationWindowTtl() const {
    return m_reconciliation_window_ttl;
}
void OAIGpaysafe::setReconciliationWindowTtl(const qint32 &reconciliation_window_ttl) {
    m_reconciliation_window_ttl = reconciliation_window_ttl;
    m_reconciliation_window_ttl_isSet = true;
}

bool OAIGpaysafe::is_reconciliation_window_ttl_Set() const{
    return m_reconciliation_window_ttl_isSet;
}

bool OAIGpaysafe::is_reconciliation_window_ttl_Valid() const{
    return m_reconciliation_window_ttl_isValid;
}

QString OAIGpaysafe::getStatus() const {
    return m_status;
}
void OAIGpaysafe::setStatus(const QString &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIGpaysafe::is_status_Set() const{
    return m_status_isSet;
}

bool OAIGpaysafe::is_status_Valid() const{
    return m_status_isValid;
}

bool OAIGpaysafe::isSticky() const {
    return m_sticky;
}
void OAIGpaysafe::setSticky(const bool &sticky) {
    m_sticky = sticky;
    m_sticky_isSet = true;
}

bool OAIGpaysafe::is_sticky_Set() const{
    return m_sticky_isSet;
}

bool OAIGpaysafe::is_sticky_Valid() const{
    return m_sticky_isValid;
}

bool OAIGpaysafe::isThreeDSecure() const {
    return m_three_d_secure;
}
void OAIGpaysafe::setThreeDSecure(const bool &three_d_secure) {
    m_three_d_secure = three_d_secure;
    m_three_d_secure_isSet = true;
}

bool OAIGpaysafe::is_three_d_secure_Set() const{
    return m_three_d_secure_isSet;
}

bool OAIGpaysafe::is_three_d_secure_Valid() const{
    return m_three_d_secure_isValid;
}

qint32 OAIGpaysafe::getTimeout() const {
    return m_timeout;
}
void OAIGpaysafe::setTimeout(const qint32 &timeout) {
    m_timeout = timeout;
    m_timeout_isSet = true;
}

bool OAIGpaysafe::is_timeout_Set() const{
    return m_timeout_isSet;
}

bool OAIGpaysafe::is_timeout_Valid() const{
    return m_timeout_isValid;
}

QString OAIGpaysafe::getToken() const {
    return m_token;
}
void OAIGpaysafe::setToken(const QString &token) {
    m_token = token;
    m_token_isSet = true;
}

bool OAIGpaysafe::is_token_Set() const{
    return m_token_isSet;
}

bool OAIGpaysafe::is_token_Valid() const{
    return m_token_isValid;
}

QDateTime OAIGpaysafe::getUpdatedTime() const {
    return m_updated_time;
}
void OAIGpaysafe::setUpdatedTime(const QDateTime &updated_time) {
    m_updated_time = updated_time;
    m_updated_time_isSet = true;
}

bool OAIGpaysafe::is_updated_time_Set() const{
    return m_updated_time_isSet;
}

bool OAIGpaysafe::is_updated_time_Valid() const{
    return m_updated_time_isValid;
}

OAIGpaysafe_allOf_credentials OAIGpaysafe::getCredentials() const {
    return m_credentials;
}
void OAIGpaysafe::setCredentials(const OAIGpaysafe_allOf_credentials &credentials) {
    m_credentials = credentials;
    m_credentials_isSet = true;
}

bool OAIGpaysafe::is_credentials_Set() const{
    return m_credentials_isSet;
}

bool OAIGpaysafe::is_credentials_Valid() const{
    return m_credentials_isValid;
}

bool OAIGpaysafe::isSet() const {
...
bool OAIGpaysafe::isValid() const {
