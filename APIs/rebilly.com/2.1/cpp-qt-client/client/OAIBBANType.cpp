...
OAIBBANType::OAIBBANType(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIBBANType::OAIBBANType() {
    this->initializeModel();
}

OAIBBANType::~OAIBBANType() {}

void OAIBBANType::initializeModel() {
...
void OAIBBANType::fromJson(QString jsonString) {
...
void OAIBBANType::fromJsonObject(QJsonObject json) {
...
QString OAIBBANType::asJson() const {
...
QJsonObject OAIBBANType::asJsonObject() const {
    QJsonObject obj;
...
QString OAIBBANType::getAccountNumber() const {
    return m_account_number;
}
void OAIBBANType::setAccountNumber(const QString &account_number) {
    m_account_number = account_number;
    m_account_number_isSet = true;
}

bool OAIBBANType::is_account_number_Set() const{
    return m_account_number_isSet;
}

bool OAIBBANType::is_account_number_Valid() const{
    return m_account_number_isValid;
}

QString OAIBBANType::getAccountNumberType() const {
    return m_account_number_type;
}
void OAIBBANType::setAccountNumberType(const QString &account_number_type) {
    m_account_number_type = account_number_type;
    m_account_number_type_isSet = true;
}

bool OAIBBANType::is_account_number_type_Set() const{
    return m_account_number_type_isSet;
}

bool OAIBBANType::is_account_number_type_Valid() const{
    return m_account_number_type_isValid;
}

QString OAIBBANType::getAccountType() const {
    return m_account_type;
}
void OAIBBANType::setAccountType(const QString &account_type) {
    m_account_type = account_type;
    m_account_type_isSet = true;
}

bool OAIBBANType::is_account_type_Set() const{
    return m_account_type_isSet;
}

bool OAIBBANType::is_account_type_Valid() const{
    return m_account_type_isValid;
}

QString OAIBBANType::getBankName() const {
    return m_bank_name;
}
void OAIBBANType::setBankName(const QString &bank_name) {
    m_bank_name = bank_name;
    m_bank_name_isSet = true;
}

bool OAIBBANType::is_bank_name_Set() const{
    return m_bank_name_isSet;
}

bool OAIBBANType::is_bank_name_Valid() const{
    return m_bank_name_isValid;
}

QString OAIBBANType::getBic() const {
    return m_bic;
}
void OAIBBANType::setBic(const QString &bic) {
    m_bic = bic;
    m_bic_isSet = true;
}

bool OAIBBANType::is_bic_Set() const{
    return m_bic_isSet;
}

bool OAIBBANType::is_bic_Valid() const{
    return m_bic_isValid;
}

OAIContactObject OAIBBANType::getBillingAddress() const {
    return m_billing_address;
}
void OAIBBANType::setBillingAddress(const OAIContactObject &billing_address) {
    m_billing_address = billing_address;
    m_billing_address_isSet = true;
}

bool OAIBBANType::is_billing_address_Set() const{
    return m_billing_address_isSet;
}

bool OAIBBANType::is_billing_address_Valid() const{
    return m_billing_address_isValid;
}

OAIObject OAIBBANType::getCustomFields() const {
    return m_custom_fields;
}
void OAIBBANType::setCustomFields(const OAIObject &custom_fields) {
    m_custom_fields = custom_fields;
    m_custom_fields_isSet = true;
}

bool OAIBBANType::is_custom_fields_Set() const{
    return m_custom_fields_isSet;
}

bool OAIBBANType::is_custom_fields_Valid() const{
    return m_custom_fields_isValid;
}

QString OAIBBANType::getCustomerId() const {
    return m_customer_id;
}
void OAIBBANType::setCustomerId(const QString &customer_id) {
    m_customer_id = customer_id;
    m_customer_id_isSet = true;
}

bool OAIBBANType::is_customer_id_Set() const{
    return m_customer_id_isSet;
}

bool OAIBBANType::is_customer_id_Valid() const{
    return m_customer_id_isValid;
}

QString OAIBBANType::getMethod() const {
    return m_method;
}
void OAIBBANType::setMethod(const QString &method) {
    m_method = method;
    m_method_isSet = true;
}

bool OAIBBANType::is_method_Set() const{
    return m_method_isSet;
}

bool OAIBBANType::is_method_Valid() const{
    return m_method_isValid;
}

OAIRiskMetadata OAIBBANType::getRiskMetadata() const {
    return m_risk_metadata;
}
void OAIBBANType::setRiskMetadata(const OAIRiskMetadata &risk_metadata) {
    m_risk_metadata = risk_metadata;
    m_risk_metadata_isSet = true;
}

bool OAIBBANType::is_risk_metadata_Set() const{
    return m_risk_metadata_isSet;
}

bool OAIBBANType::is_risk_metadata_Valid() const{
    return m_risk_metadata_isValid;
}

QString OAIBBANType::getRoutingNumber() const {
    return m_routing_number;
}
void OAIBBANType::setRoutingNumber(const QString &routing_number) {
    m_routing_number = routing_number;
    m_routing_number_isSet = true;
}

bool OAIBBANType::is_routing_number_Set() const{
    return m_routing_number_isSet;
}

bool OAIBBANType::is_routing_number_Valid() const{
    return m_routing_number_isValid;
}

bool OAIBBANType::isSet() const {
...
bool OAIBBANType::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_account_number_isValid && m_account_number_type_isValid && m_account_type_isValid && m_billing_address_isValid && m_customer_id_isValid && m_method_isValid && m_routing_number_isValid && true;
}
