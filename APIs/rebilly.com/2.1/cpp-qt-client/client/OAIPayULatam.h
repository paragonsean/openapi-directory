...
#ifndef OAIPayULatam_H
#define OAIPayULatam_H
...
class OAIPayULatam_allOf_credentials;

class OAIPayULatam : public OAIObject {
public:
    OAIPayULatam();
    OAIPayULatam(QString json);
    ~OAIPayULatam() override;
    ...
    OAIPayULatam_allOf_credentials getCredentials() const;
    void setCredentials(const OAIPayULatam_allOf_credentials &credentials);
...
private:
    ...
    OAIPayULatam_allOf_credentials m_credentials;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPayULatam)

#endif // OAIPayULatam_H
