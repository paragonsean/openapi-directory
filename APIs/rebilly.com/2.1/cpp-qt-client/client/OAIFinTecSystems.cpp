...
OAIFinTecSystems::OAIFinTecSystems(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIFinTecSystems::OAIFinTecSystems() {
    this->initializeModel();
}

OAIFinTecSystems::~OAIFinTecSystems() {}

void OAIFinTecSystems::initializeModel() {
...
void OAIFinTecSystems::fromJson(QString jsonString) {
...
void OAIFinTecSystems::fromJsonObject(QJsonObject json) {
...
QString OAIFinTecSystems::asJson() const {
...
QJsonObject OAIFinTecSystems::asJsonObject() const {
    QJsonObject obj;
    if (m__links.size() > 0) {
...
QList<OAIGatewayAccount__links_inner> OAIFinTecSystems::getLinks() const {
    return m__links;
}
void OAIFinTecSystems::setLinks(const QList<OAIGatewayAccount__links_inner> &_links) {
    m__links = _links;
    m__links_isSet = true;
}

bool OAIFinTecSystems::is__links_Set() const{
    return m__links_isSet;
}

bool OAIFinTecSystems::is__links_Valid() const{
    return m__links_isValid;
}

QList<QString> OAIFinTecSystems::getAcceptedCurrencies() const {
    return m_accepted_currencies;
}
void OAIFinTecSystems::setAcceptedCurrencies(const QList<QString> &accepted_currencies) {
    m_accepted_currencies = accepted_currencies;
    m_accepted_currencies_isSet = true;
}

bool OAIFinTecSystems::is_accepted_currencies_Set() const{
    return m_accepted_currencies_isSet;
}

bool OAIFinTecSystems::is_accepted_currencies_Valid() const{
    return m_accepted_currencies_isValid;
}

OAIAcquirerName OAIFinTecSystems::getAcquirerName() const {
    return m_acquirer_name;
}
void OAIFinTecSystems::setAcquirerName(const OAIAcquirerName &acquirer_name) {
    m_acquirer_name = acquirer_name;
    m_acquirer_name_isSet = true;
}

bool OAIFinTecSystems::is_acquirer_name_Set() const{
    return m_acquirer_name_isSet;
}

bool OAIFinTecSystems::is_acquirer_name_Valid() const{
    return m_acquirer_name_isValid;
}

QString OAIFinTecSystems::getAdditionalFilters() const {
    return m_additional_filters;
}
void OAIFinTecSystems::setAdditionalFilters(const QString &additional_filters) {
    m_additional_filters = additional_filters;
    m_additional_filters_isSet = true;
}

bool OAIFinTecSystems::is_additional_filters_Set() const{
    return m_additional_filters_isSet;
}

bool OAIFinTecSystems::is_additional_filters_Valid() const{
    return m_additional_filters_isValid;
}

qint32 OAIFinTecSystems::getApprovalWindowTtl() const {
    return m_approval_window_ttl;
}
void OAIFinTecSystems::setApprovalWindowTtl(const qint32 &approval_window_ttl) {
    m_approval_window_ttl = approval_window_ttl;
    m_approval_window_ttl_isSet = true;
}

bool OAIFinTecSystems::is_approval_window_ttl_Set() const{
    return m_approval_window_ttl_isSet;
}

bool OAIFinTecSystems::is_approval_window_ttl_Valid() const{
    return m_approval_window_ttl_isValid;
}

QString OAIFinTecSystems::getCityField() const {
    return m_city_field;
}
void OAIFinTecSystems::setCityField(const QString &city_field) {
    m_city_field = city_field;
    m_city_field_isSet = true;
}

bool OAIFinTecSystems::is_city_field_Set() const{
    return m_city_field_isSet;
}

bool OAIFinTecSystems::is_city_field_Valid() const{
    return m_city_field_isValid;
}

QDateTime OAIFinTecSystems::getCreatedTime() const {
    return m_created_time;
}
void OAIFinTecSystems::setCreatedTime(const QDateTime &created_time) {
    m_created_time = created_time;
    m_created_time_isSet = true;
}

bool OAIFinTecSystems::is_created_time_Set() const{
    return m_created_time_isSet;
}

bool OAIFinTecSystems::is_created_time_Valid() const{
    return m_created_time_isValid;
}

QString OAIFinTecSystems::getDccForceCurrency() const {
    return m_dcc_force_currency;
}
void OAIFinTecSystems::setDccForceCurrency(const QString &dcc_force_currency) {
    m_dcc_force_currency = dcc_force_currency;
    m_dcc_force_currency_isSet = true;
}

bool OAIFinTecSystems::is_dcc_force_currency_Set() const{
    return m_dcc_force_currency_isSet;
}

bool OAIFinTecSystems::is_dcc_force_currency_Valid() const{
    return m_dcc_force_currency_isValid;
}

qint32 OAIFinTecSystems::getDccMarkup() const {
    return m_dcc_markup;
}
void OAIFinTecSystems::setDccMarkup(const qint32 &dcc_markup) {
    m_dcc_markup = dcc_markup;
    m_dcc_markup_isSet = true;
}

bool OAIFinTecSystems::is_dcc_markup_Set() const{
    return m_dcc_markup_isSet;
}

bool OAIFinTecSystems::is_dcc_markup_Valid() const{
    return m_dcc_markup_isValid;
}

QString OAIFinTecSystems::getDescriptor() const {
    return m_descriptor;
}
void OAIFinTecSystems::setDescriptor(const QString &descriptor) {
    m_descriptor = descriptor;
    m_descriptor_isSet = true;
}

bool OAIFinTecSystems::is_descriptor_Set() const{
    return m_descriptor_isSet;
}

bool OAIFinTecSystems::is_descriptor_Valid() const{
    return m_descriptor_isValid;
}

OAIDigitalWallets OAIFinTecSystems::getDigitalWallets() const {
    return m_digital_wallets;
}
void OAIFinTecSystems::setDigitalWallets(const OAIDigitalWallets &digital_wallets) {
    m_digital_wallets = digital_wallets;
    m_digital_wallets_isSet = true;
}

bool OAIFinTecSystems::is_digital_wallets_Set() const{
    return m_digital_wallets_isSet;
}

bool OAIFinTecSystems::is_digital_wallets_Valid() const{
    return m_digital_wallets_isValid;
}

bool OAIFinTecSystems::isDynamicDescriptor() const {
    return m_dynamic_descriptor;
}
void OAIFinTecSystems::setDynamicDescriptor(const bool &dynamic_descriptor) {
    m_dynamic_descriptor = dynamic_descriptor;
    m_dynamic_descriptor_isSet = true;
}

bool OAIFinTecSystems::is_dynamic_descriptor_Set() const{
    return m_dynamic_descriptor_isSet;
}

bool OAIFinTecSystems::is_dynamic_descriptor_Valid() const{
    return m_dynamic_descriptor_isValid;
}

QList<QString> OAIFinTecSystems::getExcludedDccQuoteCurrencies() const {
    return m_excluded_dcc_quote_currencies;
}
void OAIFinTecSystems::setExcludedDccQuoteCurrencies(const QList<QString> &excluded_dcc_quote_currencies) {
    m_excluded_dcc_quote_currencies = excluded_dcc_quote_currencies;
    m_excluded_dcc_quote_currencies_isSet = true;
}

bool OAIFinTecSystems::is_excluded_dcc_quote_currencies_Set() const{
    return m_excluded_dcc_quote_currencies_isSet;
}

bool OAIFinTecSystems::is_excluded_dcc_quote_currencies_Valid() const{
    return m_excluded_dcc_quote_currencies_isValid;
}

OAIGatewayName OAIFinTecSystems::getGatewayName() const {
    return m_gateway_name;
}
void OAIFinTecSystems::setGatewayName(const OAIGatewayName &gateway_name) {
    m_gateway_name = gateway_name;
    m_gateway_name_isSet = true;
}

bool OAIFinTecSystems::is_gateway_name_Set() const{
    return m_gateway_name_isSet;
}

bool OAIFinTecSystems::is_gateway_name_Valid() const{
    return m_gateway_name_isValid;
}

QString OAIFinTecSystems::getId() const {
    return m_id;
}
void OAIFinTecSystems::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIFinTecSystems::is_id_Set() const{
    return m_id_isSet;
}

bool OAIFinTecSystems::is_id_Valid() const{
    return m_id_isValid;
}

bool OAIFinTecSystems::isIsDown() const {
    return m_is_down;
}
void OAIFinTecSystems::setIsDown(const bool &is_down) {
    m_is_down = is_down;
    m_is_down_isSet = true;
}

bool OAIFinTecSystems::is_is_down_Set() const{
    return m_is_down_isSet;
}

bool OAIFinTecSystems::is_is_down_Valid() const{
    return m_is_down_isValid;
}

QString OAIFinTecSystems::getMerchantCategoryCode() const {
    return m_merchant_category_code;
}
void OAIFinTecSystems::setMerchantCategoryCode(const QString &merchant_category_code) {
    m_merchant_category_code = merchant_category_code;
    m_merchant_category_code_isSet = true;
}

bool OAIFinTecSystems::is_merchant_category_code_Set() const{
    return m_merchant_category_code_isSet;
}

bool OAIFinTecSystems::is_merchant_category_code_Valid() const{
    return m_merchant_category_code_isValid;
}

OAIPaymentMethod OAIFinTecSystems::getMethod() const {
    return m_method;
}
void OAIFinTecSystems::setMethod(const OAIPaymentMethod &method) {
    m_method = method;
    m_method_isSet = true;
}

bool OAIFinTecSystems::is_method_Set() const{
    return m_method_isSet;
}

bool OAIFinTecSystems::is_method_Valid() const{
    return m_method_isValid;
}

double OAIFinTecSystems::getMonthlyLimit() const {
    return m_monthly_limit;
}
void OAIFinTecSystems::setMonthlyLimit(const double &monthly_limit) {
    m_monthly_limit = monthly_limit;
    m_monthly_limit_isSet = true;
}

bool OAIFinTecSystems::is_monthly_limit_Set() const{
    return m_monthly_limit_isSet;
}

bool OAIFinTecSystems::is_monthly_limit_Valid() const{
    return m_monthly_limit_isValid;
}

QString OAIFinTecSystems::getOrganizationId() const {
    return m_organization_id;
}
void OAIFinTecSystems::setOrganizationId(const QString &organization_id) {
    m_organization_id = organization_id;
    m_organization_id_isSet = true;
}

bool OAIFinTecSystems::is_organization_id_Set() const{
    return m_organization_id_isSet;
}

bool OAIFinTecSystems::is_organization_id_Valid() const{
    return m_organization_id_isValid;
}

QList<OAIPaymentCardBrand> OAIFinTecSystems::getPaymentCardSchemes() const {
    return m_payment_card_schemes;
}
void OAIFinTecSystems::setPaymentCardSchemes(const QList<OAIPaymentCardBrand> &payment_card_schemes) {
    m_payment_card_schemes = payment_card_schemes;
    m_payment_card_schemes_isSet = true;
}

bool OAIFinTecSystems::is_payment_card_schemes_Set() const{
    return m_payment_card_schemes_isSet;
}

bool OAIFinTecSystems::is_payment_card_schemes_Valid() const{
    return m_payment_card_schemes_isValid;
}

bool OAIFinTecSystems::isReconciliationWindowEnabled() const {
    return m_reconciliation_window_enabled;
}
void OAIFinTecSystems::setReconciliationWindowEnabled(const bool &reconciliation_window_enabled) {
    m_reconciliation_window_enabled = reconciliation_window_enabled;
    m_reconciliation_window_enabled_isSet = true;
}

bool OAIFinTecSystems::is_reconciliation_window_enabled_Set() const{
    return m_reconciliation_window_enabled_isSet;
}

bool OAIFinTecSystems::is_reconciliation_window_enabled_Valid() const{
    return m_reconciliation_window_enabled_isValid;
}

qint32 OAIFinTecSystems::getReconciliationWindowTtl() const {
    return m_reconciliation_window_ttl;
}
void OAIFinTecSystems::setReconciliationWindowTtl(const qint32 &reconciliation_window_ttl) {
    m_reconciliation_window_ttl = reconciliation_window_ttl;
    m_reconciliation_window_ttl_isSet = true;
}

bool OAIFinTecSystems::is_reconciliation_window_ttl_Set() const{
    return m_reconciliation_window_ttl_isSet;
}

bool OAIFinTecSystems::is_reconciliation_window_ttl_Valid() const{
    return m_reconciliation_window_ttl_isValid;
}

QString OAIFinTecSystems::getStatus() const {
    return m_status;
}
void OAIFinTecSystems::setStatus(const QString &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIFinTecSystems::is_status_Set() const{
    return m_status_isSet;
}

bool OAIFinTecSystems::is_status_Valid() const{
    return m_status_isValid;
}

bool OAIFinTecSystems::isSticky() const {
    return m_sticky;
}
void OAIFinTecSystems::setSticky(const bool &sticky) {
    m_sticky = sticky;
    m_sticky_isSet = true;
}

bool OAIFinTecSystems::is_sticky_Set() const{
    return m_sticky_isSet;
}

bool OAIFinTecSystems::is_sticky_Valid() const{
    return m_sticky_isValid;
}

bool OAIFinTecSystems::isThreeDSecure() const {
    return m_three_d_secure;
}
void OAIFinTecSystems::setThreeDSecure(const bool &three_d_secure) {
    m_three_d_secure = three_d_secure;
    m_three_d_secure_isSet = true;
}

bool OAIFinTecSystems::is_three_d_secure_Set() const{
    return m_three_d_secure_isSet;
}

bool OAIFinTecSystems::is_three_d_secure_Valid() const{
    return m_three_d_secure_isValid;
}

qint32 OAIFinTecSystems::getTimeout() const {
    return m_timeout;
}
void OAIFinTecSystems::setTimeout(const qint32 &timeout) {
    m_timeout = timeout;
    m_timeout_isSet = true;
}

bool OAIFinTecSystems::is_timeout_Set() const{
    return m_timeout_isSet;
}

bool OAIFinTecSystems::is_timeout_Valid() const{
    return m_timeout_isValid;
}

QString OAIFinTecSystems::getToken() const {
    return m_token;
}
void OAIFinTecSystems::setToken(const QString &token) {
    m_token = token;
    m_token_isSet = true;
}

bool OAIFinTecSystems::is_token_Set() const{
    return m_token_isSet;
}

bool OAIFinTecSystems::is_token_Valid() const{
    return m_token_isValid;
}

QDateTime OAIFinTecSystems::getUpdatedTime() const {
    return m_updated_time;
}
void OAIFinTecSystems::setUpdatedTime(const QDateTime &updated_time) {
    m_updated_time = updated_time;
    m_updated_time_isSet = true;
}

bool OAIFinTecSystems::is_updated_time_Set() const{
    return m_updated_time_isSet;
}

bool OAIFinTecSystems::is_updated_time_Valid() const{
    return m_updated_time_isValid;
}

OAIFinTecSystems_allOf_credentials OAIFinTecSystems::getCredentials() const {
    return m_credentials;
}
void OAIFinTecSystems::setCredentials(const OAIFinTecSystems_allOf_credentials &credentials) {
    m_credentials = credentials;
    m_credentials_isSet = true;
}

bool OAIFinTecSystems::is_credentials_Set() const{
    return m_credentials_isSet;
}

bool OAIFinTecSystems::is_credentials_Valid() const{
    return m_credentials_isValid;
}

OAIFinTecSystems_allOf_settings OAIFinTecSystems::getSettings() const {
    return m_settings;
}
void OAIFinTecSystems::setSettings(const OAIFinTecSystems_allOf_settings &settings) {
    m_settings = settings;
    m_settings_isSet = true;
}

bool OAIFinTecSystems::is_settings_Set() const{
    return m_settings_isSet;
}

bool OAIFinTecSystems::is_settings_Valid() const{
    return m_settings_isValid;
}

bool OAIFinTecSystems::isSet() const {
...
bool OAIFinTecSystems::isValid() const {
