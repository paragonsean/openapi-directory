...
/*
 * OAIGatewayAccountLimit.h
 *
 * 
 */

#ifndef OAIGatewayAccountLimit_H
#define OAIGatewayAccountLimit_H
...
class OAIGatewayAccountLimit : public OAIObject {
public:
    OAIGatewayAccountLimit();
    OAIGatewayAccountLimit(QString json);
    ~OAIGatewayAccountLimit() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGatewayAccountLimit)

#endif // OAIGatewayAccountLimit_H
