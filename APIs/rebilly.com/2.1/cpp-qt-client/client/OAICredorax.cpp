...
OAICredorax::OAICredorax(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICredorax::OAICredorax() {
    this->initializeModel();
}

OAICredorax::~OAICredorax() {}

void OAICredorax::initializeModel() {
...
void OAICredorax::fromJson(QString jsonString) {
...
void OAICredorax::fromJsonObject(QJsonObject json) {
...
QString OAICredorax::asJson() const {
...
QJsonObject OAICredorax::asJsonObject() const {
    QJsonObject obj;
    if (m__links.size() > 0) {
...
QList<OAIGatewayAccount__links_inner> OAICredorax::getLinks() const {
    return m__links;
}
void OAICredorax::setLinks(const QList<OAIGatewayAccount__links_inner> &_links) {
    m__links = _links;
    m__links_isSet = true;
}

bool OAICredorax::is__links_Set() const{
    return m__links_isSet;
}

bool OAICredorax::is__links_Valid() const{
    return m__links_isValid;
}

QList<QString> OAICredorax::getAcceptedCurrencies() const {
    return m_accepted_currencies;
}
void OAICredorax::setAcceptedCurrencies(const QList<QString> &accepted_currencies) {
    m_accepted_currencies = accepted_currencies;
    m_accepted_currencies_isSet = true;
}

bool OAICredorax::is_accepted_currencies_Set() const{
    return m_accepted_currencies_isSet;
}

bool OAICredorax::is_accepted_currencies_Valid() const{
    return m_accepted_currencies_isValid;
}

OAIAcquirerName OAICredorax::getAcquirerName() const {
    return m_acquirer_name;
}
void OAICredorax::setAcquirerName(const OAIAcquirerName &acquirer_name) {
    m_acquirer_name = acquirer_name;
    m_acquirer_name_isSet = true;
}

bool OAICredorax::is_acquirer_name_Set() const{
    return m_acquirer_name_isSet;
}

bool OAICredorax::is_acquirer_name_Valid() const{
    return m_acquirer_name_isValid;
}

QString OAICredorax::getAdditionalFilters() const {
    return m_additional_filters;
}
void OAICredorax::setAdditionalFilters(const QString &additional_filters) {
    m_additional_filters = additional_filters;
    m_additional_filters_isSet = true;
}

bool OAICredorax::is_additional_filters_Set() const{
    return m_additional_filters_isSet;
}

bool OAICredorax::is_additional_filters_Valid() const{
    return m_additional_filters_isValid;
}

qint32 OAICredorax::getApprovalWindowTtl() const {
    return m_approval_window_ttl;
}
void OAICredorax::setApprovalWindowTtl(const qint32 &approval_window_ttl) {
    m_approval_window_ttl = approval_window_ttl;
    m_approval_window_ttl_isSet = true;
}

bool OAICredorax::is_approval_window_ttl_Set() const{
    return m_approval_window_ttl_isSet;
}

bool OAICredorax::is_approval_window_ttl_Valid() const{
    return m_approval_window_ttl_isValid;
}

QString OAICredorax::getCityField() const {
    return m_city_field;
}
void OAICredorax::setCityField(const QString &city_field) {
    m_city_field = city_field;
    m_city_field_isSet = true;
}

bool OAICredorax::is_city_field_Set() const{
    return m_city_field_isSet;
}

bool OAICredorax::is_city_field_Valid() const{
    return m_city_field_isValid;
}

QDateTime OAICredorax::getCreatedTime() const {
    return m_created_time;
}
void OAICredorax::setCreatedTime(const QDateTime &created_time) {
    m_created_time = created_time;
    m_created_time_isSet = true;
}

bool OAICredorax::is_created_time_Set() const{
    return m_created_time_isSet;
}

bool OAICredorax::is_created_time_Valid() const{
    return m_created_time_isValid;
}

QString OAICredorax::getDccForceCurrency() const {
    return m_dcc_force_currency;
}
void OAICredorax::setDccForceCurrency(const QString &dcc_force_currency) {
    m_dcc_force_currency = dcc_force_currency;
    m_dcc_force_currency_isSet = true;
}

bool OAICredorax::is_dcc_force_currency_Set() const{
    return m_dcc_force_currency_isSet;
}

bool OAICredorax::is_dcc_force_currency_Valid() const{
    return m_dcc_force_currency_isValid;
}

qint32 OAICredorax::getDccMarkup() const {
    return m_dcc_markup;
}
void OAICredorax::setDccMarkup(const qint32 &dcc_markup) {
    m_dcc_markup = dcc_markup;
    m_dcc_markup_isSet = true;
}

bool OAICredorax::is_dcc_markup_Set() const{
    return m_dcc_markup_isSet;
}

bool OAICredorax::is_dcc_markup_Valid() const{
    return m_dcc_markup_isValid;
}

QString OAICredorax::getDescriptor() const {
    return m_descriptor;
}
void OAICredorax::setDescriptor(const QString &descriptor) {
    m_descriptor = descriptor;
    m_descriptor_isSet = true;
}

bool OAICredorax::is_descriptor_Set() const{
    return m_descriptor_isSet;
}

bool OAICredorax::is_descriptor_Valid() const{
    return m_descriptor_isValid;
}

OAIDigitalWallets OAICredorax::getDigitalWallets() const {
    return m_digital_wallets;
}
void OAICredorax::setDigitalWallets(const OAIDigitalWallets &digital_wallets) {
    m_digital_wallets = digital_wallets;
    m_digital_wallets_isSet = true;
}

bool OAICredorax::is_digital_wallets_Set() const{
    return m_digital_wallets_isSet;
}

bool OAICredorax::is_digital_wallets_Valid() const{
    return m_digital_wallets_isValid;
}

bool OAICredorax::isDynamicDescriptor() const {
    return m_dynamic_descriptor;
}
void OAICredorax::setDynamicDescriptor(const bool &dynamic_descriptor) {
    m_dynamic_descriptor = dynamic_descriptor;
    m_dynamic_descriptor_isSet = true;
}

bool OAICredorax::is_dynamic_descriptor_Set() const{
    return m_dynamic_descriptor_isSet;
}

bool OAICredorax::is_dynamic_descriptor_Valid() const{
    return m_dynamic_descriptor_isValid;
}

QList<QString> OAICredorax::getExcludedDccQuoteCurrencies() const {
    return m_excluded_dcc_quote_currencies;
}
void OAICredorax::setExcludedDccQuoteCurrencies(const QList<QString> &excluded_dcc_quote_currencies) {
    m_excluded_dcc_quote_currencies = excluded_dcc_quote_currencies;
    m_excluded_dcc_quote_currencies_isSet = true;
}

bool OAICredorax::is_excluded_dcc_quote_currencies_Set() const{
    return m_excluded_dcc_quote_currencies_isSet;
}

bool OAICredorax::is_excluded_dcc_quote_currencies_Valid() const{
    return m_excluded_dcc_quote_currencies_isValid;
}

OAIGatewayName OAICredorax::getGatewayName() const {
    return m_gateway_name;
}
void OAICredorax::setGatewayName(const OAIGatewayName &gateway_name) {
    m_gateway_name = gateway_name;
    m_gateway_name_isSet = true;
}

bool OAICredorax::is_gateway_name_Set() const{
    return m_gateway_name_isSet;
}

bool OAICredorax::is_gateway_name_Valid() const{
    return m_gateway_name_isValid;
}

QString OAICredorax::getId() const {
    return m_id;
}
void OAICredorax::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAICredorax::is_id_Set() const{
    return m_id_isSet;
}

bool OAICredorax::is_id_Valid() const{
    return m_id_isValid;
}

bool OAICredorax::isIsDown() const {
    return m_is_down;
}
void OAICredorax::setIsDown(const bool &is_down) {
    m_is_down = is_down;
    m_is_down_isSet = true;
}

bool OAICredorax::is_is_down_Set() const{
    return m_is_down_isSet;
}

bool OAICredorax::is_is_down_Valid() const{
    return m_is_down_isValid;
}

QString OAICredorax::getMerchantCategoryCode() const {
    return m_merchant_category_code;
}
void OAICredorax::setMerchantCategoryCode(const QString &merchant_category_code) {
    m_merchant_category_code = merchant_category_code;
    m_merchant_category_code_isSet = true;
}

bool OAICredorax::is_merchant_category_code_Set() const{
    return m_merchant_category_code_isSet;
}

bool OAICredorax::is_merchant_category_code_Valid() const{
    return m_merchant_category_code_isValid;
}

OAIPaymentMethod OAICredorax::getMethod() const {
    return m_method;
}
void OAICredorax::setMethod(const OAIPaymentMethod &method) {
    m_method = method;
    m_method_isSet = true;
}

bool OAICredorax::is_method_Set() const{
    return m_method_isSet;
}

bool OAICredorax::is_method_Valid() const{
    return m_method_isValid;
}

double OAICredorax::getMonthlyLimit() const {
    return m_monthly_limit;
}
void OAICredorax::setMonthlyLimit(const double &monthly_limit) {
    m_monthly_limit = monthly_limit;
    m_monthly_limit_isSet = true;
}

bool OAICredorax::is_monthly_limit_Set() const{
    return m_monthly_limit_isSet;
}

bool OAICredorax::is_monthly_limit_Valid() const{
    return m_monthly_limit_isValid;
}

QString OAICredorax::getOrganizationId() const {
    return m_organization_id;
}
void OAICredorax::setOrganizationId(const QString &organization_id) {
    m_organization_id = organization_id;
    m_organization_id_isSet = true;
}

bool OAICredorax::is_organization_id_Set() const{
    return m_organization_id_isSet;
}

bool OAICredorax::is_organization_id_Valid() const{
    return m_organization_id_isValid;
}

QList<OAIPaymentCardBrand> OAICredorax::getPaymentCardSchemes() const {
    return m_payment_card_schemes;
}
void OAICredorax::setPaymentCardSchemes(const QList<OAIPaymentCardBrand> &payment_card_schemes) {
    m_payment_card_schemes = payment_card_schemes;
    m_payment_card_schemes_isSet = true;
}

bool OAICredorax::is_payment_card_schemes_Set() const{
    return m_payment_card_schemes_isSet;
}

bool OAICredorax::is_payment_card_schemes_Valid() const{
    return m_payment_card_schemes_isValid;
}

bool OAICredorax::isReconciliationWindowEnabled() const {
    return m_reconciliation_window_enabled;
}
void OAICredorax::setReconciliationWindowEnabled(const bool &reconciliation_window_enabled) {
    m_reconciliation_window_enabled = reconciliation_window_enabled;
    m_reconciliation_window_enabled_isSet = true;
}

bool OAICredorax::is_reconciliation_window_enabled_Set() const{
    return m_reconciliation_window_enabled_isSet;
}

bool OAICredorax::is_reconciliation_window_enabled_Valid() const{
    return m_reconciliation_window_enabled_isValid;
}

qint32 OAICredorax::getReconciliationWindowTtl() const {
    return m_reconciliation_window_ttl;
}
void OAICredorax::setReconciliationWindowTtl(const qint32 &reconciliation_window_ttl) {
    m_reconciliation_window_ttl = reconciliation_window_ttl;
    m_reconciliation_window_ttl_isSet = true;
}

bool OAICredorax::is_reconciliation_window_ttl_Set() const{
    return m_reconciliation_window_ttl_isSet;
}

bool OAICredorax::is_reconciliation_window_ttl_Valid() const{
    return m_reconciliation_window_ttl_isValid;
}

QString OAICredorax::getStatus() const {
    return m_status;
}
void OAICredorax::setStatus(const QString &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAICredorax::is_status_Set() const{
    return m_status_isSet;
}

bool OAICredorax::is_status_Valid() const{
    return m_status_isValid;
}

bool OAICredorax::isSticky() const {
    return m_sticky;
}
void OAICredorax::setSticky(const bool &sticky) {
    m_sticky = sticky;
    m_sticky_isSet = true;
}

bool OAICredorax::is_sticky_Set() const{
    return m_sticky_isSet;
}

bool OAICredorax::is_sticky_Valid() const{
    return m_sticky_isValid;
}

bool OAICredorax::isThreeDSecure() const {
    return m_three_d_secure;
}
void OAICredorax::setThreeDSecure(const bool &three_d_secure) {
    m_three_d_secure = three_d_secure;
    m_three_d_secure_isSet = true;
}

bool OAICredorax::is_three_d_secure_Set() const{
    return m_three_d_secure_isSet;
}

bool OAICredorax::is_three_d_secure_Valid() const{
    return m_three_d_secure_isValid;
}

qint32 OAICredorax::getTimeout() const {
    return m_timeout;
}
void OAICredorax::setTimeout(const qint32 &timeout) {
    m_timeout = timeout;
    m_timeout_isSet = true;
}

bool OAICredorax::is_timeout_Set() const{
    return m_timeout_isSet;
}

bool OAICredorax::is_timeout_Valid() const{
    return m_timeout_isValid;
}

QString OAICredorax::getToken() const {
    return m_token;
}
void OAICredorax::setToken(const QString &token) {
    m_token = token;
    m_token_isSet = true;
}

bool OAICredorax::is_token_Set() const{
    return m_token_isSet;
}

bool OAICredorax::is_token_Valid() const{
    return m_token_isValid;
}

QDateTime OAICredorax::getUpdatedTime() const {
    return m_updated_time;
}
void OAICredorax::setUpdatedTime(const QDateTime &updated_time) {
    m_updated_time = updated_time;
    m_updated_time_isSet = true;
}

bool OAICredorax::is_updated_time_Set() const{
    return m_updated_time_isSet;
}

bool OAICredorax::is_updated_time_Valid() const{
    return m_updated_time_isValid;
}

OAICredorax_allOf_credentials OAICredorax::getCredentials() const {
    return m_credentials;
}
void OAICredorax::setCredentials(const OAICredorax_allOf_credentials &credentials) {
    m_credentials = credentials;
    m_credentials_isSet = true;
}

bool OAICredorax::is_credentials_Set() const{
    return m_credentials_isSet;
}

bool OAICredorax::is_credentials_Valid() const{
    return m_credentials_isValid;
}

bool OAICredorax::isSet() const {
...
bool OAICredorax::isValid() const {
