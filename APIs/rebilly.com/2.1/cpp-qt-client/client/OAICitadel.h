...
class OAICitadel_allOf_credentials;

class OAICitadel : public OAIObject {
public:
    OAICitadel();
    OAICitadel(QString json);
    ~OAICitadel() override;
    ...
    OAICitadel_allOf_credentials getCredentials() const;
    void setCredentials(const OAICitadel_allOf_credentials &credentials);
...
private:
    ...
    OAICitadel_allOf_credentials m_credentials;
...
Q_DECLARE_METATYPE(OpenAPI::OAICitadel)
