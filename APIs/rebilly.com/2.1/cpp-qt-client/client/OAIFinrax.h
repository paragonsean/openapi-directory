...
class OAIFinrax_allOf_credentials;
class OAIFinrax_allOf_settings;

class OAIFinrax : public OAIObject {
public:
    OAIFinrax();
    OAIFinrax(QString json);
    ~OAIFinrax() override;
    ...
    OAIFinrax_allOf_credentials getCredentials() const;
    void setCredentials(const OAIFinrax_allOf_credentials &credentials);
    bool is_credentials_Set() const;
    bool is_credentials_Valid() const;

    OAIFinrax_allOf_settings getSettings() const;
    void setSettings(const OAIFinrax_allOf_settings &settings);
...
private:
    ...
    OAIFinrax_allOf_credentials m_credentials;
    bool m_credentials_isSet;
    bool m_credentials_isValid;

    OAIFinrax_allOf_settings m_settings;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFinrax)
