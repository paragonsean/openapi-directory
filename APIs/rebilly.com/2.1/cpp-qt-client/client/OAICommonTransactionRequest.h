...
/*
 * OAICommonTransactionRequest.h
 *
 * 
 */

#ifndef OAICommonTransactionRequest_H
#define OAICommonTransactionRequest_H
...
class OAICommonTransactionRequest : public OAIObject {
public:
    OAICommonTransactionRequest();
    OAICommonTransactionRequest(QString json);
    ~OAICommonTransactionRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICommonTransactionRequest)

#endif // OAICommonTransactionRequest_H
