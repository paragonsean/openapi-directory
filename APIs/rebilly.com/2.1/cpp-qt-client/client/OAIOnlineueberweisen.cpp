...
#include "OAIOnlineueberweisen.h"
...
OAIOnlineueberweisen::OAIOnlineueberweisen(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIOnlineueberweisen::OAIOnlineueberweisen() {
    this->initializeModel();
}

OAIOnlineueberweisen::~OAIOnlineueberweisen() {}

void OAIOnlineueberweisen::initializeModel() {
...
void OAIOnlineueberweisen::fromJson(QString jsonString) {
...
void OAIOnlineueberweisen::fromJsonObject(QJsonObject json) {
...
QString OAIOnlineueberweisen::asJson() const {
...
QJsonObject OAIOnlineueberweisen::asJsonObject() const {
    QJsonObject obj;
    if (m__links.size() > 0) {
...
QList<OAIGatewayAccount__links_inner> OAIOnlineueberweisen::getLinks() const {
    return m__links;
}
void OAIOnlineueberweisen::setLinks(const QList<OAIGatewayAccount__links_inner> &_links) {
    m__links = _links;
    m__links_isSet = true;
}

bool OAIOnlineueberweisen::is__links_Set() const{
    return m__links_isSet;
}

bool OAIOnlineueberweisen::is__links_Valid() const{
    return m__links_isValid;
}

QList<QString> OAIOnlineueberweisen::getAcceptedCurrencies() const {
    return m_accepted_currencies;
}
void OAIOnlineueberweisen::setAcceptedCurrencies(const QList<QString> &accepted_currencies) {
    m_accepted_currencies = accepted_currencies;
    m_accepted_currencies_isSet = true;
}

bool OAIOnlineueberweisen::is_accepted_currencies_Set() const{
    return m_accepted_currencies_isSet;
}

bool OAIOnlineueberweisen::is_accepted_currencies_Valid() const{
    return m_accepted_currencies_isValid;
}

OAIAcquirerName OAIOnlineueberweisen::getAcquirerName() const {
    return m_acquirer_name;
}
void OAIOnlineueberweisen::setAcquirerName(const OAIAcquirerName &acquirer_name) {
    m_acquirer_name = acquirer_name;
    m_acquirer_name_isSet = true;
}

bool OAIOnlineueberweisen::is_acquirer_name_Set() const{
    return m_acquirer_name_isSet;
}

bool OAIOnlineueberweisen::is_acquirer_name_Valid() const{
    return m_acquirer_name_isValid;
}

QString OAIOnlineueberweisen::getAdditionalFilters() const {
    return m_additional_filters;
}
void OAIOnlineueberweisen::setAdditionalFilters(const QString &additional_filters) {
    m_additional_filters = additional_filters;
    m_additional_filters_isSet = true;
}

bool OAIOnlineueberweisen::is_additional_filters_Set() const{
    return m_additional_filters_isSet;
}

bool OAIOnlineueberweisen::is_additional_filters_Valid() const{
    return m_additional_filters_isValid;
}

qint32 OAIOnlineueberweisen::getApprovalWindowTtl() const {
    return m_approval_window_ttl;
}
void OAIOnlineueberweisen::setApprovalWindowTtl(const qint32 &approval_window_ttl) {
    m_approval_window_ttl = approval_window_ttl;
    m_approval_window_ttl_isSet = true;
}

bool OAIOnlineueberweisen::is_approval_window_ttl_Set() const{
    return m_approval_window_ttl_isSet;
}

bool OAIOnlineueberweisen::is_approval_window_ttl_Valid() const{
    return m_approval_window_ttl_isValid;
}

QString OAIOnlineueberweisen::getCityField() const {
    return m_city_field;
}
void OAIOnlineueberweisen::setCityField(const QString &city_field) {
    m_city_field = city_field;
    m_city_field_isSet = true;
}

bool OAIOnlineueberweisen::is_city_field_Set() const{
    return m_city_field_isSet;
}

bool OAIOnlineueberweisen::is_city_field_Valid() const{
    return m_city_field_isValid;
}

QDateTime OAIOnlineueberweisen::getCreatedTime() const {
    return m_created_time;
}
void OAIOnlineueberweisen::setCreatedTime(const QDateTime &created_time) {
    m_created_time = created_time;
    m_created_time_isSet = true;
}

bool OAIOnlineueberweisen::is_created_time_Set() const{
    return m_created_time_isSet;
}

bool OAIOnlineueberweisen::is_created_time_Valid() const{
    return m_created_time_isValid;
}

QString OAIOnlineueberweisen::getDccForceCurrency() const {
    return m_dcc_force_currency;
}
void OAIOnlineueberweisen::setDccForceCurrency(const QString &dcc_force_currency) {
    m_dcc_force_currency = dcc_force_currency;
    m_dcc_force_currency_isSet = true;
}

bool OAIOnlineueberweisen::is_dcc_force_currency_Set() const{
    return m_dcc_force_currency_isSet;
}

bool OAIOnlineueberweisen::is_dcc_force_currency_Valid() const{
    return m_dcc_force_currency_isValid;
}

qint32 OAIOnlineueberweisen::getDccMarkup() const {
    return m_dcc_markup;
}
void OAIOnlineueberweisen::setDccMarkup(const qint32 &dcc_markup) {
    m_dcc_markup = dcc_markup;
    m_dcc_markup_isSet = true;
}

bool OAIOnlineueberweisen::is_dcc_markup_Set() const{
    return m_dcc_markup_isSet;
}

bool OAIOnlineueberweisen::is_dcc_markup_Valid() const{
    return m_dcc_markup_isValid;
}

QString OAIOnlineueberweisen::getDescriptor() const {
    return m_descriptor;
}
void OAIOnlineueberweisen::setDescriptor(const QString &descriptor) {
    m_descriptor = descriptor;
    m_descriptor_isSet = true;
}

bool OAIOnlineueberweisen::is_descriptor_Set() const{
    return m_descriptor_isSet;
}

bool OAIOnlineueberweisen::is_descriptor_Valid() const{
    return m_descriptor_isValid;
}

OAIDigitalWallets OAIOnlineueberweisen::getDigitalWallets() const {
    return m_digital_wallets;
}
void OAIOnlineueberweisen::setDigitalWallets(const OAIDigitalWallets &digital_wallets) {
    m_digital_wallets = digital_wallets;
    m_digital_wallets_isSet = true;
}

bool OAIOnlineueberweisen::is_digital_wallets_Set() const{
    return m_digital_wallets_isSet;
}

bool OAIOnlineueberweisen::is_digital_wallets_Valid() const{
    return m_digital_wallets_isValid;
}

bool OAIOnlineueberweisen::isDynamicDescriptor() const {
    return m_dynamic_descriptor;
}
void OAIOnlineueberweisen::setDynamicDescriptor(const bool &dynamic_descriptor) {
    m_dynamic_descriptor = dynamic_descriptor;
    m_dynamic_descriptor_isSet = true;
}

bool OAIOnlineueberweisen::is_dynamic_descriptor_Set() const{
    return m_dynamic_descriptor_isSet;
}

bool OAIOnlineueberweisen::is_dynamic_descriptor_Valid() const{
    return m_dynamic_descriptor_isValid;
}

QList<QString> OAIOnlineueberweisen::getExcludedDccQuoteCurrencies() const {
    return m_excluded_dcc_quote_currencies;
}
void OAIOnlineueberweisen::setExcludedDccQuoteCurrencies(const QList<QString> &excluded_dcc_quote_currencies) {
    m_excluded_dcc_quote_currencies = excluded_dcc_quote_currencies;
    m_excluded_dcc_quote_currencies_isSet = true;
}

bool OAIOnlineueberweisen::is_excluded_dcc_quote_currencies_Set() const{
    return m_excluded_dcc_quote_currencies_isSet;
}

bool OAIOnlineueberweisen::is_excluded_dcc_quote_currencies_Valid() const{
    return m_excluded_dcc_quote_currencies_isValid;
}

OAIGatewayName OAIOnlineueberweisen::getGatewayName() const {
    return m_gateway_name;
}
void OAIOnlineueberweisen::setGatewayName(const OAIGatewayName &gateway_name) {
    m_gateway_name = gateway_name;
    m_gateway_name_isSet = true;
}

bool OAIOnlineueberweisen::is_gateway_name_Set() const{
    return m_gateway_name_isSet;
}

bool OAIOnlineueberweisen::is_gateway_name_Valid() const{
    return m_gateway_name_isValid;
}

QString OAIOnlineueberweisen::getId() const {
    return m_id;
}
void OAIOnlineueberweisen::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIOnlineueberweisen::is_id_Set() const{
    return m_id_isSet;
}

bool OAIOnlineueberweisen::is_id_Valid() const{
    return m_id_isValid;
}

bool OAIOnlineueberweisen::isIsDown() const {
    return m_is_down;
}
void OAIOnlineueberweisen::setIsDown(const bool &is_down) {
    m_is_down = is_down;
    m_is_down_isSet = true;
}

bool OAIOnlineueberweisen::is_is_down_Set() const{
    return m_is_down_isSet;
}

bool OAIOnlineueberweisen::is_is_down_Valid() const{
    return m_is_down_isValid;
}

QString OAIOnlineueberweisen::getMerchantCategoryCode() const {
    return m_merchant_category_code;
}
void OAIOnlineueberweisen::setMerchantCategoryCode(const QString &merchant_category_code) {
    m_merchant_category_code = merchant_category_code;
    m_merchant_category_code_isSet = true;
}

bool OAIOnlineueberweisen::is_merchant_category_code_Set() const{
    return m_merchant_category_code_isSet;
}

bool OAIOnlineueberweisen::is_merchant_category_code_Valid() const{
    return m_merchant_category_code_isValid;
}

OAIPaymentMethod OAIOnlineueberweisen::getMethod() const {
    return m_method;
}
void OAIOnlineueberweisen::setMethod(const OAIPaymentMethod &method) {
    m_method = method;
    m_method_isSet = true;
}

bool OAIOnlineueberweisen::is_method_Set() const{
    return m_method_isSet;
}

bool OAIOnlineueberweisen::is_method_Valid() const{
    return m_method_isValid;
}

double OAIOnlineueberweisen::getMonthlyLimit() const {
    return m_monthly_limit;
}
void OAIOnlineueberweisen::setMonthlyLimit(const double &monthly_limit) {
    m_monthly_limit = monthly_limit;
    m_monthly_limit_isSet = true;
}

bool OAIOnlineueberweisen::is_monthly_limit_Set() const{
    return m_monthly_limit_isSet;
}

bool OAIOnlineueberweisen::is_monthly_limit_Valid() const{
    return m_monthly_limit_isValid;
}

QString OAIOnlineueberweisen::getOrganizationId() const {
    return m_organization_id;
}
void OAIOnlineueberweisen::setOrganizationId(const QString &organization_id) {
    m_organization_id = organization_id;
    m_organization_id_isSet = true;
}

bool OAIOnlineueberweisen::is_organization_id_Set() const{
    return m_organization_id_isSet;
}

bool OAIOnlineueberweisen::is_organization_id_Valid() const{
    return m_organization_id_isValid;
}

QList<OAIPaymentCardBrand> OAIOnlineueberweisen::getPaymentCardSchemes() const {
    return m_payment_card_schemes;
}
void OAIOnlineueberweisen::setPaymentCardSchemes(const QList<OAIPaymentCardBrand> &payment_card_schemes) {
    m_payment_card_schemes = payment_card_schemes;
    m_payment_card_schemes_isSet = true;
}

bool OAIOnlineueberweisen::is_payment_card_schemes_Set() const{
    return m_payment_card_schemes_isSet;
}

bool OAIOnlineueberweisen::is_payment_card_schemes_Valid() const{
    return m_payment_card_schemes_isValid;
}

bool OAIOnlineueberweisen::isReconciliationWindowEnabled() const {
    return m_reconciliation_window_enabled;
}
void OAIOnlineueberweisen::setReconciliationWindowEnabled(const bool &reconciliation_window_enabled) {
    m_reconciliation_window_enabled = reconciliation_window_enabled;
    m_reconciliation_window_enabled_isSet = true;
}

bool OAIOnlineueberweisen::is_reconciliation_window_enabled_Set() const{
    return m_reconciliation_window_enabled_isSet;
}

bool OAIOnlineueberweisen::is_reconciliation_window_enabled_Valid() const{
    return m_reconciliation_window_enabled_isValid;
}

qint32 OAIOnlineueberweisen::getReconciliationWindowTtl() const {
    return m_reconciliation_window_ttl;
}
void OAIOnlineueberweisen::setReconciliationWindowTtl(const qint32 &reconciliation_window_ttl) {
    m_reconciliation_window_ttl = reconciliation_window_ttl;
    m_reconciliation_window_ttl_isSet = true;
}

bool OAIOnlineueberweisen::is_reconciliation_window_ttl_Set() const{
    return m_reconciliation_window_ttl_isSet;
}

bool OAIOnlineueberweisen::is_reconciliation_window_ttl_Valid() const{
    return m_reconciliation_window_ttl_isValid;
}

QString OAIOnlineueberweisen::getStatus() const {
    return m_status;
}
void OAIOnlineueberweisen::setStatus(const QString &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIOnlineueberweisen::is_status_Set() const{
    return m_status_isSet;
}

bool OAIOnlineueberweisen::is_status_Valid() const{
    return m_status_isValid;
}

bool OAIOnlineueberweisen::isSticky() const {
    return m_sticky;
}
void OAIOnlineueberweisen::setSticky(const bool &sticky) {
    m_sticky = sticky;
    m_sticky_isSet = true;
}

bool OAIOnlineueberweisen::is_sticky_Set() const{
    return m_sticky_isSet;
}

bool OAIOnlineueberweisen::is_sticky_Valid() const{
    return m_sticky_isValid;
}

bool OAIOnlineueberweisen::isThreeDSecure() const {
    return m_three_d_secure;
}
void OAIOnlineueberweisen::setThreeDSecure(const bool &three_d_secure) {
    m_three_d_secure = three_d_secure;
    m_three_d_secure_isSet = true;
}

bool OAIOnlineueberweisen::is_three_d_secure_Set() const{
    return m_three_d_secure_isSet;
}

bool OAIOnlineueberweisen::is_three_d_secure_Valid() const{
    return m_three_d_secure_isValid;
}

qint32 OAIOnlineueberweisen::getTimeout() const {
    return m_timeout;
}
void OAIOnlineueberweisen::setTimeout(const qint32 &timeout) {
    m_timeout = timeout;
    m_timeout_isSet = true;
}

bool OAIOnlineueberweisen::is_timeout_Set() const{
    return m_timeout_isSet;
}

bool OAIOnlineueberweisen::is_timeout_Valid() const{
    return m_timeout_isValid;
}

QString OAIOnlineueberweisen::getToken() const {
    return m_token;
}
void OAIOnlineueberweisen::setToken(const QString &token) {
    m_token = token;
    m_token_isSet = true;
}

bool OAIOnlineueberweisen::is_token_Set() const{
    return m_token_isSet;
}

bool OAIOnlineueberweisen::is_token_Valid() const{
    return m_token_isValid;
}

QDateTime OAIOnlineueberweisen::getUpdatedTime() const {
    return m_updated_time;
}
void OAIOnlineueberweisen::setUpdatedTime(const QDateTime &updated_time) {
    m_updated_time = updated_time;
    m_updated_time_isSet = true;
}

bool OAIOnlineueberweisen::is_updated_time_Set() const{
    return m_updated_time_isSet;
}

bool OAIOnlineueberweisen::is_updated_time_Valid() const{
    return m_updated_time_isValid;
}

OAIOnlineueberweisen_allOf_credentials OAIOnlineueberweisen::getCredentials() const {
    return m_credentials;
}
void OAIOnlineueberweisen::setCredentials(const OAIOnlineueberweisen_allOf_credentials &credentials) {
    m_credentials = credentials;
    m_credentials_isSet = true;
}

bool OAIOnlineueberweisen::is_credentials_Set() const{
    return m_credentials_isSet;
}

bool OAIOnlineueberweisen::is_credentials_Valid() const{
    return m_credentials_isValid;
}

OAIOnlineueberweisen_allOf_settings OAIOnlineueberweisen::getSettings() const {
    return m_settings;
}
void OAIOnlineueberweisen::setSettings(const OAIOnlineueberweisen_allOf_settings &settings) {
    m_settings = settings;
    m_settings_isSet = true;
}

bool OAIOnlineueberweisen::is_settings_Set() const{
    return m_settings_isSet;
}

bool OAIOnlineueberweisen::is_settings_Valid() const{
    return m_settings_isValid;
}

bool OAIOnlineueberweisen::isSet() const {
...
bool OAIOnlineueberweisen::isValid() const {
