...
#include "OAIEzyEFT_allOf_credentials.h"
...
class OAIEzyEFT_allOf_credentials;

class OAIEzyEFT : public OAIObject {
public:
    OAIEzyEFT();
    OAIEzyEFT(QString json);
    ~OAIEzyEFT() override;
    ...
    OAIEzyEFT_allOf_credentials getCredentials() const;
    void setCredentials(const OAIEzyEFT_allOf_credentials &credentials);
...
private:
    ...
    OAIEzyEFT_allOf_credentials m_credentials;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEzyEFT)
