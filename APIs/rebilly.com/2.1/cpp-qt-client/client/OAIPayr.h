...
class OAIPayr_allOf_credentials;

class OAIPayr : public OAIObject {
public:
    OAIPayr();
    OAIPayr(QString json);
    ~OAIPayr() override;
    ...
    OAIPayr_allOf_credentials getCredentials() const;
    void setCredentials(const OAIPayr_allOf_credentials &credentials);
...
private:
    ...
    OAIPayr_allOf_credentials m_credentials;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPayr)
