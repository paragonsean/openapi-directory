...
class OAIAmexVPC_allOf_credentials;
class OAIAmexVPC_allOf_settings;

class OAIAmexVPC : public OAIObject {
public:
    OAIAmexVPC();
    OAIAmexVPC(QString json);
    ~OAIAmexVPC() override;
    ...
    OAIAmexVPC_allOf_credentials getCredentials() const;
    void setCredentials(const OAIAmexVPC_allOf_credentials &credentials);
    bool is_credentials_Set() const;
    bool is_credentials_Valid() const;

    OAIAmexVPC_allOf_settings getSettings() const;
    void setSettings(const OAIAmexVPC_allOf_settings &settings);
...
private:
    ...
    OAIAmexVPC_allOf_credentials m_credentials;
    bool m_credentials_isSet;
    bool m_credentials_isValid;

    OAIAmexVPC_allOf_settings m_settings;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAmexVPC)
