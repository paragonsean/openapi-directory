...
#include "OAILoonie_allOf_credentials.h"
...
class OAILoonie_allOf_credentials;

class OAILoonie : public OAIObject {
public:
    OAILoonie();
    OAILoonie(QString json);
    ~OAILoonie() override;
    ...
    OAILoonie_allOf_credentials getCredentials() const;
    void setCredentials(const OAILoonie_allOf_credentials &credentials);
...
private:
    ...
    OAILoonie_allOf_credentials m_credentials;
...
Q_DECLARE_METATYPE(OpenAPI::OAILoonie)
