...
OAIDirecta24::OAIDirecta24(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDirecta24::OAIDirecta24() {
    this->initializeModel();
}

OAIDirecta24::~OAIDirecta24() {}

void OAIDirecta24::initializeModel() {
...
void OAIDirecta24::fromJson(QString jsonString) {
...
void OAIDirecta24::fromJsonObject(QJsonObject json) {
...
QString OAIDirecta24::asJson() const {
...
QJsonObject OAIDirecta24::asJsonObject() const {
    QJsonObject obj;
    if (m__links.size() > 0) {
...
QList<OAIGatewayAccount__links_inner> OAIDirecta24::getLinks() const {
    return m__links;
}
void OAIDirecta24::setLinks(const QList<OAIGatewayAccount__links_inner> &_links) {
    m__links = _links;
    m__links_isSet = true;
}

bool OAIDirecta24::is__links_Set() const{
    return m__links_isSet;
}

bool OAIDirecta24::is__links_Valid() const{
    return m__links_isValid;
}

QList<QString> OAIDirecta24::getAcceptedCurrencies() const {
    return m_accepted_currencies;
}
void OAIDirecta24::setAcceptedCurrencies(const QList<QString> &accepted_currencies) {
    m_accepted_currencies = accepted_currencies;
    m_accepted_currencies_isSet = true;
}

bool OAIDirecta24::is_accepted_currencies_Set() const{
    return m_accepted_currencies_isSet;
}

bool OAIDirecta24::is_accepted_currencies_Valid() const{
    return m_accepted_currencies_isValid;
}

OAIAcquirerName OAIDirecta24::getAcquirerName() const {
    return m_acquirer_name;
}
void OAIDirecta24::setAcquirerName(const OAIAcquirerName &acquirer_name) {
    m_acquirer_name = acquirer_name;
    m_acquirer_name_isSet = true;
}

bool OAIDirecta24::is_acquirer_name_Set() const{
    return m_acquirer_name_isSet;
}

bool OAIDirecta24::is_acquirer_name_Valid() const{
    return m_acquirer_name_isValid;
}

QString OAIDirecta24::getAdditionalFilters() const {
    return m_additional_filters;
}
void OAIDirecta24::setAdditionalFilters(const QString &additional_filters) {
    m_additional_filters = additional_filters;
    m_additional_filters_isSet = true;
}

bool OAIDirecta24::is_additional_filters_Set() const{
    return m_additional_filters_isSet;
}

bool OAIDirecta24::is_additional_filters_Valid() const{
    return m_additional_filters_isValid;
}

qint32 OAIDirecta24::getApprovalWindowTtl() const {
    return m_approval_window_ttl;
}
void OAIDirecta24::setApprovalWindowTtl(const qint32 &approval_window_ttl) {
    m_approval_window_ttl = approval_window_ttl;
    m_approval_window_ttl_isSet = true;
}

bool OAIDirecta24::is_approval_window_ttl_Set() const{
    return m_approval_window_ttl_isSet;
}

bool OAIDirecta24::is_approval_window_ttl_Valid() const{
    return m_approval_window_ttl_isValid;
}

QString OAIDirecta24::getCityField() const {
    return m_city_field;
}
void OAIDirecta24::setCityField(const QString &city_field) {
    m_city_field = city_field;
    m_city_field_isSet = true;
}

bool OAIDirecta24::is_city_field_Set() const{
    return m_city_field_isSet;
}

bool OAIDirecta24::is_city_field_Valid() const{
    return m_city_field_isValid;
}

QDateTime OAIDirecta24::getCreatedTime() const {
    return m_created_time;
}
void OAIDirecta24::setCreatedTime(const QDateTime &created_time) {
    m_created_time = created_time;
    m_created_time_isSet = true;
}

bool OAIDirecta24::is_created_time_Set() const{
    return m_created_time_isSet;
}

bool OAIDirecta24::is_created_time_Valid() const{
    return m_created_time_isValid;
}

QString OAIDirecta24::getDccForceCurrency() const {
    return m_dcc_force_currency;
}
void OAIDirecta24::setDccForceCurrency(const QString &dcc_force_currency) {
    m_dcc_force_currency = dcc_force_currency;
    m_dcc_force_currency_isSet = true;
}

bool OAIDirecta24::is_dcc_force_currency_Set() const{
    return m_dcc_force_currency_isSet;
}

bool OAIDirecta24::is_dcc_force_currency_Valid() const{
    return m_dcc_force_currency_isValid;
}

qint32 OAIDirecta24::getDccMarkup() const {
    return m_dcc_markup;
}
void OAIDirecta24::setDccMarkup(const qint32 &dcc_markup) {
    m_dcc_markup = dcc_markup;
    m_dcc_markup_isSet = true;
}

bool OAIDirecta24::is_dcc_markup_Set() const{
    return m_dcc_markup_isSet;
}

bool OAIDirecta24::is_dcc_markup_Valid() const{
    return m_dcc_markup_isValid;
}

QString OAIDirecta24::getDescriptor() const {
    return m_descriptor;
}
void OAIDirecta24::setDescriptor(const QString &descriptor) {
    m_descriptor = descriptor;
    m_descriptor_isSet = true;
}

bool OAIDirecta24::is_descriptor_Set() const{
    return m_descriptor_isSet;
}

bool OAIDirecta24::is_descriptor_Valid() const{
    return m_descriptor_isValid;
}

OAIDigitalWallets OAIDirecta24::getDigitalWallets() const {
    return m_digital_wallets;
}
void OAIDirecta24::setDigitalWallets(const OAIDigitalWallets &digital_wallets) {
    m_digital_wallets = digital_wallets;
    m_digital_wallets_isSet = true;
}

bool OAIDirecta24::is_digital_wallets_Set() const{
    return m_digital_wallets_isSet;
}

bool OAIDirecta24::is_digital_wallets_Valid() const{
    return m_digital_wallets_isValid;
}

bool OAIDirecta24::isDynamicDescriptor() const {
    return m_dynamic_descriptor;
}
void OAIDirecta24::setDynamicDescriptor(const bool &dynamic_descriptor) {
    m_dynamic_descriptor = dynamic_descriptor;
    m_dynamic_descriptor_isSet = true;
}

bool OAIDirecta24::is_dynamic_descriptor_Set() const{
    return m_dynamic_descriptor_isSet;
}

bool OAIDirecta24::is_dynamic_descriptor_Valid() const{
    return m_dynamic_descriptor_isValid;
}

QList<QString> OAIDirecta24::getExcludedDccQuoteCurrencies() const {
    return m_excluded_dcc_quote_currencies;
}
void OAIDirecta24::setExcludedDccQuoteCurrencies(const QList<QString> &excluded_dcc_quote_currencies) {
    m_excluded_dcc_quote_currencies = excluded_dcc_quote_currencies;
    m_excluded_dcc_quote_currencies_isSet = true;
}

bool OAIDirecta24::is_excluded_dcc_quote_currencies_Set() const{
    return m_excluded_dcc_quote_currencies_isSet;
}

bool OAIDirecta24::is_excluded_dcc_quote_currencies_Valid() const{
    return m_excluded_dcc_quote_currencies_isValid;
}

OAIGatewayName OAIDirecta24::getGatewayName() const {
    return m_gateway_name;
}
void OAIDirecta24::setGatewayName(const OAIGatewayName &gateway_name) {
    m_gateway_name = gateway_name;
    m_gateway_name_isSet = true;
}

bool OAIDirecta24::is_gateway_name_Set() const{
    return m_gateway_name_isSet;
}

bool OAIDirecta24::is_gateway_name_Valid() const{
    return m_gateway_name_isValid;
}

QString OAIDirecta24::getId() const {
    return m_id;
}
void OAIDirecta24::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIDirecta24::is_id_Set() const{
    return m_id_isSet;
}

bool OAIDirecta24::is_id_Valid() const{
    return m_id_isValid;
}

bool OAIDirecta24::isIsDown() const {
    return m_is_down;
}
void OAIDirecta24::setIsDown(const bool &is_down) {
    m_is_down = is_down;
    m_is_down_isSet = true;
}

bool OAIDirecta24::is_is_down_Set() const{
    return m_is_down_isSet;
}

bool OAIDirecta24::is_is_down_Valid() const{
    return m_is_down_isValid;
}

QString OAIDirecta24::getMerchantCategoryCode() const {
    return m_merchant_category_code;
}
void OAIDirecta24::setMerchantCategoryCode(const QString &merchant_category_code) {
    m_merchant_category_code = merchant_category_code;
    m_merchant_category_code_isSet = true;
}

bool OAIDirecta24::is_merchant_category_code_Set() const{
    return m_merchant_category_code_isSet;
}

bool OAIDirecta24::is_merchant_category_code_Valid() const{
    return m_merchant_category_code_isValid;
}

OAIPaymentMethod OAIDirecta24::getMethod() const {
    return m_method;
}
void OAIDirecta24::setMethod(const OAIPaymentMethod &method) {
    m_method = method;
    m_method_isSet = true;
}

bool OAIDirecta24::is_method_Set() const{
    return m_method_isSet;
}

bool OAIDirecta24::is_method_Valid() const{
    return m_method_isValid;
}

double OAIDirecta24::getMonthlyLimit() const {
    return m_monthly_limit;
}
void OAIDirecta24::setMonthlyLimit(const double &monthly_limit) {
    m_monthly_limit = monthly_limit;
    m_monthly_limit_isSet = true;
}

bool OAIDirecta24::is_monthly_limit_Set() const{
    return m_monthly_limit_isSet;
}

bool OAIDirecta24::is_monthly_limit_Valid() const{
    return m_monthly_limit_isValid;
}

QString OAIDirecta24::getOrganizationId() const {
    return m_organization_id;
}
void OAIDirecta24::setOrganizationId(const QString &organization_id) {
    m_organization_id = organization_id;
    m_organization_id_isSet = true;
}

bool OAIDirecta24::is_organization_id_Set() const{
    return m_organization_id_isSet;
}

bool OAIDirecta24::is_organization_id_Valid() const{
    return m_organization_id_isValid;
}

QList<OAIPaymentCardBrand> OAIDirecta24::getPaymentCardSchemes() const {
    return m_payment_card_schemes;
}
void OAIDirecta24::setPaymentCardSchemes(const QList<OAIPaymentCardBrand> &payment_card_schemes) {
    m_payment_card_schemes = payment_card_schemes;
    m_payment_card_schemes_isSet = true;
}

bool OAIDirecta24::is_payment_card_schemes_Set() const{
    return m_payment_card_schemes_isSet;
}

bool OAIDirecta24::is_payment_card_schemes_Valid() const{
    return m_payment_card_schemes_isValid;
}

bool OAIDirecta24::isReconciliationWindowEnabled() const {
    return m_reconciliation_window_enabled;
}
void OAIDirecta24::setReconciliationWindowEnabled(const bool &reconciliation_window_enabled) {
    m_reconciliation_window_enabled = reconciliation_window_enabled;
    m_reconciliation_window_enabled_isSet = true;
}

bool OAIDirecta24::is_reconciliation_window_enabled_Set() const{
    return m_reconciliation_window_enabled_isSet;
}

bool OAIDirecta24::is_reconciliation_window_enabled_Valid() const{
    return m_reconciliation_window_enabled_isValid;
}

qint32 OAIDirecta24::getReconciliationWindowTtl() const {
    return m_reconciliation_window_ttl;
}
void OAIDirecta24::setReconciliationWindowTtl(const qint32 &reconciliation_window_ttl) {
    m_reconciliation_window_ttl = reconciliation_window_ttl;
    m_reconciliation_window_ttl_isSet = true;
}

bool OAIDirecta24::is_reconciliation_window_ttl_Set() const{
    return m_reconciliation_window_ttl_isSet;
}

bool OAIDirecta24::is_reconciliation_window_ttl_Valid() const{
    return m_reconciliation_window_ttl_isValid;
}

QString OAIDirecta24::getStatus() const {
    return m_status;
}
void OAIDirecta24::setStatus(const QString &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIDirecta24::is_status_Set() const{
    return m_status_isSet;
}

bool OAIDirecta24::is_status_Valid() const{
    return m_status_isValid;
}

bool OAIDirecta24::isSticky() const {
    return m_sticky;
}
void OAIDirecta24::setSticky(const bool &sticky) {
    m_sticky = sticky;
    m_sticky_isSet = true;
}

bool OAIDirecta24::is_sticky_Set() const{
    return m_sticky_isSet;
}

bool OAIDirecta24::is_sticky_Valid() const{
    return m_sticky_isValid;
}

bool OAIDirecta24::isThreeDSecure() const {
    return m_three_d_secure;
}
void OAIDirecta24::setThreeDSecure(const bool &three_d_secure) {
    m_three_d_secure = three_d_secure;
    m_three_d_secure_isSet = true;
}

bool OAIDirecta24::is_three_d_secure_Set() const{
    return m_three_d_secure_isSet;
}

bool OAIDirecta24::is_three_d_secure_Valid() const{
    return m_three_d_secure_isValid;
}

qint32 OAIDirecta24::getTimeout() const {
    return m_timeout;
}
void OAIDirecta24::setTimeout(const qint32 &timeout) {
    m_timeout = timeout;
    m_timeout_isSet = true;
}

bool OAIDirecta24::is_timeout_Set() const{
    return m_timeout_isSet;
}

bool OAIDirecta24::is_timeout_Valid() const{
    return m_timeout_isValid;
}

QString OAIDirecta24::getToken() const {
    return m_token;
}
void OAIDirecta24::setToken(const QString &token) {
    m_token = token;
    m_token_isSet = true;
}

bool OAIDirecta24::is_token_Set() const{
    return m_token_isSet;
}

bool OAIDirecta24::is_token_Valid() const{
    return m_token_isValid;
}

QDateTime OAIDirecta24::getUpdatedTime() const {
    return m_updated_time;
}
void OAIDirecta24::setUpdatedTime(const QDateTime &updated_time) {
    m_updated_time = updated_time;
    m_updated_time_isSet = true;
}

bool OAIDirecta24::is_updated_time_Set() const{
    return m_updated_time_isSet;
}

bool OAIDirecta24::is_updated_time_Valid() const{
    return m_updated_time_isValid;
}

OAIDirecta24_allOf_credentials OAIDirecta24::getCredentials() const {
    return m_credentials;
}
void OAIDirecta24::setCredentials(const OAIDirecta24_allOf_credentials &credentials) {
    m_credentials = credentials;
    m_credentials_isSet = true;
}

bool OAIDirecta24::is_credentials_Set() const{
    return m_credentials_isSet;
}

bool OAIDirecta24::is_credentials_Valid() const{
    return m_credentials_isValid;
}

OAIDirecta24_allOf_settings OAIDirecta24::getSettings() const {
    return m_settings;
}
void OAIDirecta24::setSettings(const OAIDirecta24_allOf_settings &settings) {
    m_settings = settings;
    m_settings_isSet = true;
}

bool OAIDirecta24::is_settings_Set() const{
    return m_settings_isSet;
}

bool OAIDirecta24::is_settings_Valid() const{
    return m_settings_isValid;
}

bool OAIDirecta24::isSet() const {
...
bool OAIDirecta24::isValid() const {
