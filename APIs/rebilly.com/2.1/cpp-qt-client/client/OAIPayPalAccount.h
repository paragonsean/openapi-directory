...
#ifndef OAIPayPalAccount_H
#define OAIPayPalAccount_H
...
class OAIPayPalAccount : public OAIObject {
public:
    OAIPayPalAccount();
    OAIPayPalAccount(QString json);
    ~OAIPayPalAccount() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPayPalAccount)

#endif // OAIPayPalAccount_H
