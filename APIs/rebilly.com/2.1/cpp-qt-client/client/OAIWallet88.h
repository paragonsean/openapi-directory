...
#ifndef OAIWallet88_H
#define OAIWallet88_H
...
#include "OAIWallet88_allOf_credentials.h"
#include <QDateTime>
#include <QList>
#include <QString>
...
class OAIWallet88_allOf_credentials;

class OAIWallet88 : public OAIObject {
public:
    OAIWallet88();
    OAIWallet88(QString json);
    ~OAIWallet88() override;
    ...
    OAIWallet88_allOf_credentials getCredentials() const;
    void setCredentials(const OAIWallet88_allOf_credentials &credentials);
...
private:
    ...
    OAIWallet88_allOf_credentials m_credentials;
...
Q_DECLARE_METATYPE(OpenAPI::OAIWallet88)
