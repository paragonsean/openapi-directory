...
#ifndef OAIStaticGateway_H
#define OAIStaticGateway_H
...
class OAIStaticGateway : public OAIObject {
public:
    OAIStaticGateway();
    OAIStaticGateway(QString json);
    ~OAIStaticGateway() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStaticGateway)

#endif // OAIStaticGateway_H
