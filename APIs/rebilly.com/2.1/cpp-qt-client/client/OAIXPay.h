...
class OAIXPay_allOf_credentials;

class OAIXPay : public OAIObject {
public:
    OAIXPay();
    OAIXPay(QString json);
    ~OAIXPay() override;
    ...
    OAIXPay_allOf_credentials getCredentials() const;
    void setCredentials(const OAIXPay_allOf_credentials &credentials);
...
private:
    ...
    OAIXPay_allOf_credentials m_credentials;
...
Q_DECLARE_METATYPE(OpenAPI::OAIXPay)
