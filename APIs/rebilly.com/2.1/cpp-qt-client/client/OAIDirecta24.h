...
#ifndef OAIDirecta24_H
#define OAIDirecta24_H

#include <QJsonObject>

#include "OAIAcquirerName.h"
#include "OAIDigitalWallets.h"
#include "OAIDirecta24_allOf_credentials.h"
#include "OAIDirecta24_allOf_settings.h"
...
class OAIDirecta24_allOf_credentials;
class OAIDirecta24_allOf_settings;

class OAIDirecta24 : public OAIObject {
public:
    OAIDirecta24();
    OAIDirecta24(QString json);
    ~OAIDirecta24() override;
    ...
    OAIDirecta24_allOf_credentials getCredentials() const;
    void setCredentials(const OAIDirecta24_allOf_credentials &credentials);
    bool is_credentials_Set() const;
    bool is_credentials_Valid() const;

    OAIDirecta24_allOf_settings getSettings() const;
    void setSettings(const OAIDirecta24_allOf_settings &settings);
...
private:
    ...
    OAIDirecta24_allOf_credentials m_credentials;
    bool m_credentials_isSet;
    bool m_credentials_isValid;

    OAIDirecta24_allOf_settings m_settings;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDirecta24)

#endif // OAIDirecta24_H
