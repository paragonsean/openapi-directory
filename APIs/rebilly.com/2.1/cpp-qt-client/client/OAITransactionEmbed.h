...
/*
 * OAITransactionEmbed.h
 *
 * Transaction object.
 */

#ifndef OAITransactionEmbed_H
#define OAITransactionEmbed_H
...
class OAITransactionEmbed : public OAIObject {
public:
    OAITransactionEmbed();
    OAITransactionEmbed(QString json);
    ~OAITransactionEmbed() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITransactionEmbed)

#endif // OAITransactionEmbed_H
