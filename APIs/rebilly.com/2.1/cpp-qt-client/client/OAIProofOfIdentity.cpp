...
OAIProofOfIdentity::OAIProofOfIdentity(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIProofOfIdentity::OAIProofOfIdentity() {
    this->initializeModel();
}

OAIProofOfIdentity::~OAIProofOfIdentity() {}

void OAIProofOfIdentity::initializeModel() {
...
void OAIProofOfIdentity::fromJson(QString jsonString) {
...
void OAIProofOfIdentity::fromJsonObject(QJsonObject json) {
...
QString OAIProofOfIdentity::asJson() const {
...
QJsonObject OAIProofOfIdentity::asJsonObject() const {
    QJsonObject obj;
    if (m__links.size() > 0) {
...
QList<OAIProofOfIdentity_allOf__links> OAIProofOfIdentity::getLinks() const {
    return m__links;
}
void OAIProofOfIdentity::setLinks(const QList<OAIProofOfIdentity_allOf__links> &_links) {
    m__links = _links;
    m__links_isSet = true;
}

bool OAIProofOfIdentity::is__links_Set() const{
    return m__links_isSet;
}

bool OAIProofOfIdentity::is__links_Valid() const{
    return m__links_isValid;
}

QDateTime OAIProofOfIdentity::getCreatedTime() const {
    return m_created_time;
}
void OAIProofOfIdentity::setCreatedTime(const QDateTime &created_time) {
    m_created_time = created_time;
    m_created_time_isSet = true;
}

bool OAIProofOfIdentity::is_created_time_Set() const{
    return m_created_time_isSet;
}

bool OAIProofOfIdentity::is_created_time_Valid() const{
    return m_created_time_isValid;
}

OAIKycDocumentSubtypes OAIProofOfIdentity::getDocumentSubtype() const {
    return m_document_subtype;
}
void OAIProofOfIdentity::setDocumentSubtype(const OAIKycDocumentSubtypes &document_subtype) {
    m_document_subtype = document_subtype;
    m_document_subtype_isSet = true;
}

bool OAIProofOfIdentity::is_document_subtype_Set() const{
    return m_document_subtype_isSet;
}

bool OAIProofOfIdentity::is_document_subtype_Valid() const{
    return m_document_subtype_isValid;
}

OAIKycDocumentTypes OAIProofOfIdentity::getDocumentType() const {
    return m_document_type;
}
void OAIProofOfIdentity::setDocumentType(const OAIKycDocumentTypes &document_type) {
    m_document_type = document_type;
    m_document_type_isSet = true;
}

bool OAIProofOfIdentity::is_document_type_Set() const{
    return m_document_type_isSet;
}

bool OAIProofOfIdentity::is_document_type_Valid() const{
    return m_document_type_isValid;
}

QString OAIProofOfIdentity::getFileId() const {
    return m_file_id;
}
void OAIProofOfIdentity::setFileId(const QString &file_id) {
    m_file_id = file_id;
    m_file_id_isSet = true;
}

bool OAIProofOfIdentity::is_file_id_Set() const{
    return m_file_id_isSet;
}

bool OAIProofOfIdentity::is_file_id_Valid() const{
    return m_file_id_isValid;
}

QList<QString> OAIProofOfIdentity::getFileIds() const {
    return m_file_ids;
}
void OAIProofOfIdentity::setFileIds(const QList<QString> &file_ids) {
    m_file_ids = file_ids;
    m_file_ids_isSet = true;
}

bool OAIProofOfIdentity::is_file_ids_Set() const{
    return m_file_ids_isSet;
}

bool OAIProofOfIdentity::is_file_ids_Valid() const{
    return m_file_ids_isValid;
}

QString OAIProofOfIdentity::getId() const {
    return m_id;
}
void OAIProofOfIdentity::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIProofOfIdentity::is_id_Set() const{
    return m_id_isSet;
}

bool OAIProofOfIdentity::is_id_Valid() const{
    return m_id_isValid;
}

QDateTime OAIProofOfIdentity::getProcessedTime() const {
    return m_processed_time;
}
void OAIProofOfIdentity::setProcessedTime(const QDateTime &processed_time) {
    m_processed_time = processed_time;
    m_processed_time_isSet = true;
}

bool OAIProofOfIdentity::is_processed_time_Set() const{
    return m_processed_time_isSet;
}

bool OAIProofOfIdentity::is_processed_time_Valid() const{
    return m_processed_time_isValid;
}

OAIKycDocumentRejection OAIProofOfIdentity::getRejectionReason() const {
    return m_rejection_reason;
}
void OAIProofOfIdentity::setRejectionReason(const OAIKycDocumentRejection &rejection_reason) {
    m_rejection_reason = rejection_reason;
    m_rejection_reason_isSet = true;
}

bool OAIProofOfIdentity::is_rejection_reason_Set() const{
    return m_rejection_reason_isSet;
}

bool OAIProofOfIdentity::is_rejection_reason_Valid() const{
    return m_rejection_reason_isValid;
}

QString OAIProofOfIdentity::getRequestId() const {
    return m_request_id;
}
void OAIProofOfIdentity::setRequestId(const QString &request_id) {
    m_request_id = request_id;
    m_request_id_isSet = true;
}

bool OAIProofOfIdentity::is_request_id_Set() const{
    return m_request_id_isSet;
}

bool OAIProofOfIdentity::is_request_id_Valid() const{
    return m_request_id_isValid;
}

QString OAIProofOfIdentity::getStatus() const {
    return m_status;
}
void OAIProofOfIdentity::setStatus(const QString &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIProofOfIdentity::is_status_Set() const{
    return m_status_isSet;
}

bool OAIProofOfIdentity::is_status_Valid() const{
    return m_status_isValid;
}

QDateTime OAIProofOfIdentity::getUpdatedTime() const {
    return m_updated_time;
}
void OAIProofOfIdentity::setUpdatedTime(const QDateTime &updated_time) {
    m_updated_time = updated_time;
    m_updated_time_isSet = true;
}

bool OAIProofOfIdentity::is_updated_time_Set() const{
    return m_updated_time_isSet;
}

bool OAIProofOfIdentity::is_updated_time_Valid() const{
    return m_updated_time_isValid;
}

QString OAIProofOfIdentity::getCustomerId() const {
    return m_customer_id;
}
void OAIProofOfIdentity::setCustomerId(const QString &customer_id) {
    m_customer_id = customer_id;
    m_customer_id_isSet = true;
}

bool OAIProofOfIdentity::is_customer_id_Set() const{
    return m_customer_id_isSet;
}

bool OAIProofOfIdentity::is_customer_id_Valid() const{
    return m_customer_id_isValid;
}

qint32 OAIProofOfIdentity::getMatchLevel() const {
    return m_match_level;
}
void OAIProofOfIdentity::setMatchLevel(const qint32 &match_level) {
    m_match_level = match_level;
    m_match_level_isSet = true;
}

bool OAIProofOfIdentity::is_match_level_Set() const{
    return m_match_level_isSet;
}

bool OAIProofOfIdentity::is_match_level_Valid() const{
    return m_match_level_isValid;
}

QString OAIProofOfIdentity::getNotes() const {
    return m_notes;
}
void OAIProofOfIdentity::setNotes(const QString &notes) {
    m_notes = notes;
    m_notes_isSet = true;
}

bool OAIProofOfIdentity::is_notes_Set() const{
    return m_notes_isSet;
}

bool OAIProofOfIdentity::is_notes_Valid() const{
    return m_notes_isValid;
}

QString OAIProofOfIdentity::getReason() const {
    return m_reason;
}
void OAIProofOfIdentity::setReason(const QString &reason) {
    m_reason = reason;
    m_reason_isSet = true;
}

bool OAIProofOfIdentity::is_reason_Set() const{
    return m_reason_isSet;
}

bool OAIProofOfIdentity::is_reason_Valid() const{
    return m_reason_isValid;
}

QDateTime OAIProofOfIdentity::getReviewTime() const {
    return m_review_time;
}
void OAIProofOfIdentity::setReviewTime(const QDateTime &review_time) {
    m_review_time = review_time;
    m_review_time_isSet = true;
}

bool OAIProofOfIdentity::is_review_time_Set() const{
    return m_review_time_isSet;
}

bool OAIProofOfIdentity::is_review_time_Valid() const{
    return m_review_time_isValid;
}

QString OAIProofOfIdentity::getReviewerId() const {
    return m_reviewer_id;
}
void OAIProofOfIdentity::setReviewerId(const QString &reviewer_id) {
    m_reviewer_id = reviewer_id;
    m_reviewer_id_isSet = true;
}

bool OAIProofOfIdentity::is_reviewer_id_Set() const{
    return m_reviewer_id_isSet;
}

bool OAIProofOfIdentity::is_reviewer_id_Valid() const{
    return m_reviewer_id_isValid;
}

QString OAIProofOfIdentity::getReviewerName() const {
    return m_reviewer_name;
}
void OAIProofOfIdentity::setReviewerName(const QString &reviewer_name) {
    m_reviewer_name = reviewer_name;
    m_reviewer_name_isSet = true;
}

bool OAIProofOfIdentity::is_reviewer_name_Set() const{
    return m_reviewer_name_isSet;
}

bool OAIProofOfIdentity::is_reviewer_name_Valid() const{
    return m_reviewer_name_isValid;
}

OAIProofOfIdentity_allOf_documentMatches OAIProofOfIdentity::getDocumentMatches() const {
    return m_document_matches;
}
void OAIProofOfIdentity::setDocumentMatches(const OAIProofOfIdentity_allOf_documentMatches &document_matches) {
    m_document_matches = document_matches;
    m_document_matches_isSet = true;
}

bool OAIProofOfIdentity::is_document_matches_Set() const{
    return m_document_matches_isSet;
}

bool OAIProofOfIdentity::is_document_matches_Valid() const{
    return m_document_matches_isValid;
}

OAIProofOfIdentity_allOf_documentMatches OAIProofOfIdentity::getParsedData() const {
    return m_parsed_data;
}
void OAIProofOfIdentity::setParsedData(const OAIProofOfIdentity_allOf_documentMatches &parsed_data) {
    m_parsed_data = parsed_data;
    m_parsed_data_isSet = true;
}

bool OAIProofOfIdentity::is_parsed_data_Set() const{
    return m_parsed_data_isSet;
}

bool OAIProofOfIdentity::is_parsed_data_Valid() const{
    return m_parsed_data_isValid;
}

bool OAIProofOfIdentity::isSet() const {
...
bool OAIProofOfIdentity::isValid() const {
