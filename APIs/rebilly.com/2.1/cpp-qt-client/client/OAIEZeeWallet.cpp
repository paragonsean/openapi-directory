...
OAIEZeeWallet::OAIEZeeWallet(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIEZeeWallet::OAIEZeeWallet() {
    this->initializeModel();
}

OAIEZeeWallet::~OAIEZeeWallet() {}

void OAIEZeeWallet::initializeModel() {
...
void OAIEZeeWallet::fromJson(QString jsonString) {
...
void OAIEZeeWallet::fromJsonObject(QJsonObject json) {
...
QString OAIEZeeWallet::asJson() const {
...
QJsonObject OAIEZeeWallet::asJsonObject() const {
    QJsonObject obj;
    if (m__links.size() > 0) {
...
QList<OAIGatewayAccount__links_inner> OAIEZeeWallet::getLinks() const {
    return m__links;
}
void OAIEZeeWallet::setLinks(const QList<OAIGatewayAccount__links_inner> &_links) {
    m__links = _links;
    m__links_isSet = true;
}

bool OAIEZeeWallet::is__links_Set() const{
    return m__links_isSet;
}

bool OAIEZeeWallet::is__links_Valid() const{
    return m__links_isValid;
}

QList<QString> OAIEZeeWallet::getAcceptedCurrencies() const {
    return m_accepted_currencies;
}
void OAIEZeeWallet::setAcceptedCurrencies(const QList<QString> &accepted_currencies) {
    m_accepted_currencies = accepted_currencies;
    m_accepted_currencies_isSet = true;
}

bool OAIEZeeWallet::is_accepted_currencies_Set() const{
    return m_accepted_currencies_isSet;
}

bool OAIEZeeWallet::is_accepted_currencies_Valid() const{
    return m_accepted_currencies_isValid;
}

OAIAcquirerName OAIEZeeWallet::getAcquirerName() const {
    return m_acquirer_name;
}
void OAIEZeeWallet::setAcquirerName(const OAIAcquirerName &acquirer_name) {
    m_acquirer_name = acquirer_name;
    m_acquirer_name_isSet = true;
}

bool OAIEZeeWallet::is_acquirer_name_Set() const{
    return m_acquirer_name_isSet;
}

bool OAIEZeeWallet::is_acquirer_name_Valid() const{
    return m_acquirer_name_isValid;
}

QString OAIEZeeWallet::getAdditionalFilters() const {
    return m_additional_filters;
}
void OAIEZeeWallet::setAdditionalFilters(const QString &additional_filters) {
    m_additional_filters = additional_filters;
    m_additional_filters_isSet = true;
}

bool OAIEZeeWallet::is_additional_filters_Set() const{
    return m_additional_filters_isSet;
}

bool OAIEZeeWallet::is_additional_filters_Valid() const{
    return m_additional_filters_isValid;
}

qint32 OAIEZeeWallet::getApprovalWindowTtl() const {
    return m_approval_window_ttl;
}
void OAIEZeeWallet::setApprovalWindowTtl(const qint32 &approval_window_ttl) {
    m_approval_window_ttl = approval_window_ttl;
    m_approval_window_ttl_isSet = true;
}

bool OAIEZeeWallet::is_approval_window_ttl_Set() const{
    return m_approval_window_ttl_isSet;
}

bool OAIEZeeWallet::is_approval_window_ttl_Valid() const{
    return m_approval_window_ttl_isValid;
}

QString OAIEZeeWallet::getCityField() const {
    return m_city_field;
}
void OAIEZeeWallet::setCityField(const QString &city_field) {
    m_city_field = city_field;
    m_city_field_isSet = true;
}

bool OAIEZeeWallet::is_city_field_Set() const{
    return m_city_field_isSet;
}

bool OAIEZeeWallet::is_city_field_Valid() const{
    return m_city_field_isValid;
}

QDateTime OAIEZeeWallet::getCreatedTime() const {
    return m_created_time;
}
void OAIEZeeWallet::setCreatedTime(const QDateTime &created_time) {
    m_created_time = created_time;
    m_created_time_isSet = true;
}

bool OAIEZeeWallet::is_created_time_Set() const{
    return m_created_time_isSet;
}

bool OAIEZeeWallet::is_created_time_Valid() const{
    return m_created_time_isValid;
}

QString OAIEZeeWallet::getDccForceCurrency() const {
    return m_dcc_force_currency;
}
void OAIEZeeWallet::setDccForceCurrency(const QString &dcc_force_currency) {
    m_dcc_force_currency = dcc_force_currency;
    m_dcc_force_currency_isSet = true;
}

bool OAIEZeeWallet::is_dcc_force_currency_Set() const{
    return m_dcc_force_currency_isSet;
}

bool OAIEZeeWallet::is_dcc_force_currency_Valid() const{
    return m_dcc_force_currency_isValid;
}

qint32 OAIEZeeWallet::getDccMarkup() const {
    return m_dcc_markup;
}
void OAIEZeeWallet::setDccMarkup(const qint32 &dcc_markup) {
    m_dcc_markup = dcc_markup;
    m_dcc_markup_isSet = true;
}

bool OAIEZeeWallet::is_dcc_markup_Set() const{
    return m_dcc_markup_isSet;
}

bool OAIEZeeWallet::is_dcc_markup_Valid() const{
    return m_dcc_markup_isValid;
}

QString OAIEZeeWallet::getDescriptor() const {
    return m_descriptor;
}
void OAIEZeeWallet::setDescriptor(const QString &descriptor) {
    m_descriptor = descriptor;
    m_descriptor_isSet = true;
}

bool OAIEZeeWallet::is_descriptor_Set() const{
    return m_descriptor_isSet;
}

bool OAIEZeeWallet::is_descriptor_Valid() const{
    return m_descriptor_isValid;
}

OAIDigitalWallets OAIEZeeWallet::getDigitalWallets() const {
    return m_digital_wallets;
}
void OAIEZeeWallet::setDigitalWallets(const OAIDigitalWallets &digital_wallets) {
    m_digital_wallets = digital_wallets;
    m_digital_wallets_isSet = true;
}

bool OAIEZeeWallet::is_digital_wallets_Set() const{
    return m_digital_wallets_isSet;
}

bool OAIEZeeWallet::is_digital_wallets_Valid() const{
    return m_digital_wallets_isValid;
}

bool OAIEZeeWallet::isDynamicDescriptor() const {
    return m_dynamic_descriptor;
}
void OAIEZeeWallet::setDynamicDescriptor(const bool &dynamic_descriptor) {
    m_dynamic_descriptor = dynamic_descriptor;
    m_dynamic_descriptor_isSet = true;
}

bool OAIEZeeWallet::is_dynamic_descriptor_Set() const{
    return m_dynamic_descriptor_isSet;
}

bool OAIEZeeWallet::is_dynamic_descriptor_Valid() const{
    return m_dynamic_descriptor_isValid;
}

QList<QString> OAIEZeeWallet::getExcludedDccQuoteCurrencies() const {
    return m_excluded_dcc_quote_currencies;
}
void OAIEZeeWallet::setExcludedDccQuoteCurrencies(const QList<QString> &excluded_dcc_quote_currencies) {
    m_excluded_dcc_quote_currencies = excluded_dcc_quote_currencies;
    m_excluded_dcc_quote_currencies_isSet = true;
}

bool OAIEZeeWallet::is_excluded_dcc_quote_currencies_Set() const{
    return m_excluded_dcc_quote_currencies_isSet;
}

bool OAIEZeeWallet::is_excluded_dcc_quote_currencies_Valid() const{
    return m_excluded_dcc_quote_currencies_isValid;
}

OAIGatewayName OAIEZeeWallet::getGatewayName() const {
    return m_gateway_name;
}
void OAIEZeeWallet::setGatewayName(const OAIGatewayName &gateway_name) {
    m_gateway_name = gateway_name;
    m_gateway_name_isSet = true;
}

bool OAIEZeeWallet::is_gateway_name_Set() const{
    return m_gateway_name_isSet;
}

bool OAIEZeeWallet::is_gateway_name_Valid() const{
    return m_gateway_name_isValid;
}

QString OAIEZeeWallet::getId() const {
    return m_id;
}
void OAIEZeeWallet::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIEZeeWallet::is_id_Set() const{
    return m_id_isSet;
}

bool OAIEZeeWallet::is_id_Valid() const{
    return m_id_isValid;
}

bool OAIEZeeWallet::isIsDown() const {
    return m_is_down;
}
void OAIEZeeWallet::setIsDown(const bool &is_down) {
    m_is_down = is_down;
    m_is_down_isSet = true;
}

bool OAIEZeeWallet::is_is_down_Set() const{
    return m_is_down_isSet;
}

bool OAIEZeeWallet::is_is_down_Valid() const{
    return m_is_down_isValid;
}

QString OAIEZeeWallet::getMerchantCategoryCode() const {
    return m_merchant_category_code;
}
void OAIEZeeWallet::setMerchantCategoryCode(const QString &merchant_category_code) {
    m_merchant_category_code = merchant_category_code;
    m_merchant_category_code_isSet = true;
}

bool OAIEZeeWallet::is_merchant_category_code_Set() const{
    return m_merchant_category_code_isSet;
}

bool OAIEZeeWallet::is_merchant_category_code_Valid() const{
    return m_merchant_category_code_isValid;
}

OAIPaymentMethod OAIEZeeWallet::getMethod() const {
    return m_method;
}
void OAIEZeeWallet::setMethod(const OAIPaymentMethod &method) {
    m_method = method;
    m_method_isSet = true;
}

bool OAIEZeeWallet::is_method_Set() const{
    return m_method_isSet;
}

bool OAIEZeeWallet::is_method_Valid() const{
    return m_method_isValid;
}

double OAIEZeeWallet::getMonthlyLimit() const {
    return m_monthly_limit;
}
void OAIEZeeWallet::setMonthlyLimit(const double &monthly_limit) {
    m_monthly_limit = monthly_limit;
    m_monthly_limit_isSet = true;
}

bool OAIEZeeWallet::is_monthly_limit_Set() const{
    return m_monthly_limit_isSet;
}

bool OAIEZeeWallet::is_monthly_limit_Valid() const{
    return m_monthly_limit_isValid;
}

QString OAIEZeeWallet::getOrganizationId() const {
    return m_organization_id;
}
void OAIEZeeWallet::setOrganizationId(const QString &organization_id) {
    m_organization_id = organization_id;
    m_organization_id_isSet = true;
}

bool OAIEZeeWallet::is_organization_id_Set() const{
    return m_organization_id_isSet;
}

bool OAIEZeeWallet::is_organization_id_Valid() const{
    return m_organization_id_isValid;
}

QList<OAIPaymentCardBrand> OAIEZeeWallet::getPaymentCardSchemes() const {
    return m_payment_card_schemes;
}
void OAIEZeeWallet::setPaymentCardSchemes(const QList<OAIPaymentCardBrand> &payment_card_schemes) {
    m_payment_card_schemes = payment_card_schemes;
    m_payment_card_schemes_isSet = true;
}

bool OAIEZeeWallet::is_payment_card_schemes_Set() const{
    return m_payment_card_schemes_isSet;
}

bool OAIEZeeWallet::is_payment_card_schemes_Valid() const{
    return m_payment_card_schemes_isValid;
}

bool OAIEZeeWallet::isReconciliationWindowEnabled() const {
    return m_reconciliation_window_enabled;
}
void OAIEZeeWallet::setReconciliationWindowEnabled(const bool &reconciliation_window_enabled) {
    m_reconciliation_window_enabled = reconciliation_window_enabled;
    m_reconciliation_window_enabled_isSet = true;
}

bool OAIEZeeWallet::is_reconciliation_window_enabled_Set() const{
    return m_reconciliation_window_enabled_isSet;
}

bool OAIEZeeWallet::is_reconciliation_window_enabled_Valid() const{
    return m_reconciliation_window_enabled_isValid;
}

qint32 OAIEZeeWallet::getReconciliationWindowTtl() const {
    return m_reconciliation_window_ttl;
}
void OAIEZeeWallet::setReconciliationWindowTtl(const qint32 &reconciliation_window_ttl) {
    m_reconciliation_window_ttl = reconciliation_window_ttl;
    m_reconciliation_window_ttl_isSet = true;
}

bool OAIEZeeWallet::is_reconciliation_window_ttl_Set() const{
    return m_reconciliation_window_ttl_isSet;
}

bool OAIEZeeWallet::is_reconciliation_window_ttl_Valid() const{
    return m_reconciliation_window_ttl_isValid;
}

QString OAIEZeeWallet::getStatus() const {
    return m_status;
}
void OAIEZeeWallet::setStatus(const QString &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIEZeeWallet::is_status_Set() const{
    return m_status_isSet;
}

bool OAIEZeeWallet::is_status_Valid() const{
    return m_status_isValid;
}

bool OAIEZeeWallet::isSticky() const {
    return m_sticky;
}
void OAIEZeeWallet::setSticky(const bool &sticky) {
    m_sticky = sticky;
    m_sticky_isSet = true;
}

bool OAIEZeeWallet::is_sticky_Set() const{
    return m_sticky_isSet;
}

bool OAIEZeeWallet::is_sticky_Valid() const{
    return m_sticky_isValid;
}

bool OAIEZeeWallet::isThreeDSecure() const {
    return m_three_d_secure;
}
void OAIEZeeWallet::setThreeDSecure(const bool &three_d_secure) {
    m_three_d_secure = three_d_secure;
    m_three_d_secure_isSet = true;
}

bool OAIEZeeWallet::is_three_d_secure_Set() const{
    return m_three_d_secure_isSet;
}

bool OAIEZeeWallet::is_three_d_secure_Valid() const{
    return m_three_d_secure_isValid;
}

qint32 OAIEZeeWallet::getTimeout() const {
    return m_timeout;
}
void OAIEZeeWallet::setTimeout(const qint32 &timeout) {
    m_timeout = timeout;
    m_timeout_isSet = true;
}

bool OAIEZeeWallet::is_timeout_Set() const{
    return m_timeout_isSet;
}

bool OAIEZeeWallet::is_timeout_Valid() const{
    return m_timeout_isValid;
}

QString OAIEZeeWallet::getToken() const {
    return m_token;
}
void OAIEZeeWallet::setToken(const QString &token) {
    m_token = token;
    m_token_isSet = true;
}

bool OAIEZeeWallet::is_token_Set() const{
    return m_token_isSet;
}

bool OAIEZeeWallet::is_token_Valid() const{
    return m_token_isValid;
}

QDateTime OAIEZeeWallet::getUpdatedTime() const {
    return m_updated_time;
}
void OAIEZeeWallet::setUpdatedTime(const QDateTime &updated_time) {
    m_updated_time = updated_time;
    m_updated_time_isSet = true;
}

bool OAIEZeeWallet::is_updated_time_Set() const{
    return m_updated_time_isSet;
}

bool OAIEZeeWallet::is_updated_time_Valid() const{
    return m_updated_time_isValid;
}

OAIEZeeWallet_allOf_credentials OAIEZeeWallet::getCredentials() const {
    return m_credentials;
}
void OAIEZeeWallet::setCredentials(const OAIEZeeWallet_allOf_credentials &credentials) {
    m_credentials = credentials;
    m_credentials_isSet = true;
}

bool OAIEZeeWallet::is_credentials_Set() const{
    return m_credentials_isSet;
}

bool OAIEZeeWallet::is_credentials_Valid() const{
    return m_credentials_isValid;
}

bool OAIEZeeWallet::isSet() const {
...
bool OAIEZeeWallet::isValid() const {
