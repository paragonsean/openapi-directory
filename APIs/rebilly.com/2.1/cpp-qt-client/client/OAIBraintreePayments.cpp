...
#include "OAIBraintreePayments.h"
...
OAIBraintreePayments::OAIBraintreePayments(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIBraintreePayments::OAIBraintreePayments() {
    this->initializeModel();
}

OAIBraintreePayments::~OAIBraintreePayments() {}

void OAIBraintreePayments::initializeModel() {
...
void OAIBraintreePayments::fromJson(QString jsonString) {
...
void OAIBraintreePayments::fromJsonObject(QJsonObject json) {
...
QString OAIBraintreePayments::asJson() const {
...
QJsonObject OAIBraintreePayments::asJsonObject() const {
    QJsonObject obj;
    if (m__links.size() > 0) {
...
QList<OAIGatewayAccount__links_inner> OAIBraintreePayments::getLinks() const {
    return m__links;
}
void OAIBraintreePayments::setLinks(const QList<OAIGatewayAccount__links_inner> &_links) {
    m__links = _links;
    m__links_isSet = true;
}

bool OAIBraintreePayments::is__links_Set() const{
    return m__links_isSet;
}

bool OAIBraintreePayments::is__links_Valid() const{
    return m__links_isValid;
}

QList<QString> OAIBraintreePayments::getAcceptedCurrencies() const {
    return m_accepted_currencies;
}
void OAIBraintreePayments::setAcceptedCurrencies(const QList<QString> &accepted_currencies) {
    m_accepted_currencies = accepted_currencies;
    m_accepted_currencies_isSet = true;
}

bool OAIBraintreePayments::is_accepted_currencies_Set() const{
    return m_accepted_currencies_isSet;
}

bool OAIBraintreePayments::is_accepted_currencies_Valid() const{
    return m_accepted_currencies_isValid;
}

OAIAcquirerName OAIBraintreePayments::getAcquirerName() const {
    return m_acquirer_name;
}
void OAIBraintreePayments::setAcquirerName(const OAIAcquirerName &acquirer_name) {
    m_acquirer_name = acquirer_name;
    m_acquirer_name_isSet = true;
}

bool OAIBraintreePayments::is_acquirer_name_Set() const{
    return m_acquirer_name_isSet;
}

bool OAIBraintreePayments::is_acquirer_name_Valid() const{
    return m_acquirer_name_isValid;
}

QString OAIBraintreePayments::getAdditionalFilters() const {
    return m_additional_filters;
}
void OAIBraintreePayments::setAdditionalFilters(const QString &additional_filters) {
    m_additional_filters = additional_filters;
    m_additional_filters_isSet = true;
}

bool OAIBraintreePayments::is_additional_filters_Set() const{
    return m_additional_filters_isSet;
}

bool OAIBraintreePayments::is_additional_filters_Valid() const{
    return m_additional_filters_isValid;
}

qint32 OAIBraintreePayments::getApprovalWindowTtl() const {
    return m_approval_window_ttl;
}
void OAIBraintreePayments::setApprovalWindowTtl(const qint32 &approval_window_ttl) {
    m_approval_window_ttl = approval_window_ttl;
    m_approval_window_ttl_isSet = true;
}

bool OAIBraintreePayments::is_approval_window_ttl_Set() const{
    return m_approval_window_ttl_isSet;
}

bool OAIBraintreePayments::is_approval_window_ttl_Valid() const{
    return m_approval_window_ttl_isValid;
}

QString OAIBraintreePayments::getCityField() const {
    return m_city_field;
}
void OAIBraintreePayments::setCityField(const QString &city_field) {
    m_city_field = city_field;
    m_city_field_isSet = true;
}

bool OAIBraintreePayments::is_city_field_Set() const{
    return m_city_field_isSet;
}

bool OAIBraintreePayments::is_city_field_Valid() const{
    return m_city_field_isValid;
}

QDateTime OAIBraintreePayments::getCreatedTime() const {
    return m_created_time;
}
void OAIBraintreePayments::setCreatedTime(const QDateTime &created_time) {
    m_created_time = created_time;
    m_created_time_isSet = true;
}

bool OAIBraintreePayments::is_created_time_Set() const{
    return m_created_time_isSet;
}

bool OAIBraintreePayments::is_created_time_Valid() const{
    return m_created_time_isValid;
}

QString OAIBraintreePayments::getDccForceCurrency() const {
    return m_dcc_force_currency;
}
void OAIBraintreePayments::setDccForceCurrency(const QString &dcc_force_currency) {
    m_dcc_force_currency = dcc_force_currency;
    m_dcc_force_currency_isSet = true;
}

bool OAIBraintreePayments::is_dcc_force_currency_Set() const{
    return m_dcc_force_currency_isSet;
}

bool OAIBraintreePayments::is_dcc_force_currency_Valid() const{
    return m_dcc_force_currency_isValid;
}

qint32 OAIBraintreePayments::getDccMarkup() const {
    return m_dcc_markup;
}
void OAIBraintreePayments::setDccMarkup(const qint32 &dcc_markup) {
    m_dcc_markup = dcc_markup;
    m_dcc_markup_isSet = true;
}

bool OAIBraintreePayments::is_dcc_markup_Set() const{
    return m_dcc_markup_isSet;
}

bool OAIBraintreePayments::is_dcc_markup_Valid() const{
    return m_dcc_markup_isValid;
}

QString OAIBraintreePayments::getDescriptor() const {
    return m_descriptor;
}
void OAIBraintreePayments::setDescriptor(const QString &descriptor) {
    m_descriptor = descriptor;
    m_descriptor_isSet = true;
}

bool OAIBraintreePayments::is_descriptor_Set() const{
    return m_descriptor_isSet;
}

bool OAIBraintreePayments::is_descriptor_Valid() const{
    return m_descriptor_isValid;
}

OAIDigitalWallets OAIBraintreePayments::getDigitalWallets() const {
    return m_digital_wallets;
}
void OAIBraintreePayments::setDigitalWallets(const OAIDigitalWallets &digital_wallets) {
    m_digital_wallets = digital_wallets;
    m_digital_wallets_isSet = true;
}

bool OAIBraintreePayments::is_digital_wallets_Set() const{
    return m_digital_wallets_isSet;
}

bool OAIBraintreePayments::is_digital_wallets_Valid() const{
    return m_digital_wallets_isValid;
}

bool OAIBraintreePayments::isDynamicDescriptor() const {
    return m_dynamic_descriptor;
}
void OAIBraintreePayments::setDynamicDescriptor(const bool &dynamic_descriptor) {
    m_dynamic_descriptor = dynamic_descriptor;
    m_dynamic_descriptor_isSet = true;
}

bool OAIBraintreePayments::is_dynamic_descriptor_Set() const{
    return m_dynamic_descriptor_isSet;
}

bool OAIBraintreePayments::is_dynamic_descriptor_Valid() const{
    return m_dynamic_descriptor_isValid;
}

QList<QString> OAIBraintreePayments::getExcludedDccQuoteCurrencies() const {
    return m_excluded_dcc_quote_currencies;
}
void OAIBraintreePayments::setExcludedDccQuoteCurrencies(const QList<QString> &excluded_dcc_quote_currencies) {
    m_excluded_dcc_quote_currencies = excluded_dcc_quote_currencies;
    m_excluded_dcc_quote_currencies_isSet = true;
}

bool OAIBraintreePayments::is_excluded_dcc_quote_currencies_Set() const{
    return m_excluded_dcc_quote_currencies_isSet;
}

bool OAIBraintreePayments::is_excluded_dcc_quote_currencies_Valid() const{
    return m_excluded_dcc_quote_currencies_isValid;
}

OAIGatewayName OAIBraintreePayments::getGatewayName() const {
    return m_gateway_name;
}
void OAIBraintreePayments::setGatewayName(const OAIGatewayName &gateway_name) {
    m_gateway_name = gateway_name;
    m_gateway_name_isSet = true;
}

bool OAIBraintreePayments::is_gateway_name_Set() const{
    return m_gateway_name_isSet;
}

bool OAIBraintreePayments::is_gateway_name_Valid() const{
    return m_gateway_name_isValid;
}

QString OAIBraintreePayments::getId() const {
    return m_id;
}
void OAIBraintreePayments::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIBraintreePayments::is_id_Set() const{
    return m_id_isSet;
}

bool OAIBraintreePayments::is_id_Valid() const{
    return m_id_isValid;
}

bool OAIBraintreePayments::isIsDown() const {
    return m_is_down;
}
void OAIBraintreePayments::setIsDown(const bool &is_down) {
    m_is_down = is_down;
    m_is_down_isSet = true;
}

bool OAIBraintreePayments::is_is_down_Set() const{
    return m_is_down_isSet;
}

bool OAIBraintreePayments::is_is_down_Valid() const{
    return m_is_down_isValid;
}

QString OAIBraintreePayments::getMerchantCategoryCode() const {
    return m_merchant_category_code;
}
void OAIBraintreePayments::setMerchantCategoryCode(const QString &merchant_category_code) {
    m_merchant_category_code = merchant_category_code;
    m_merchant_category_code_isSet = true;
}

bool OAIBraintreePayments::is_merchant_category_code_Set() const{
    return m_merchant_category_code_isSet;
}

bool OAIBraintreePayments::is_merchant_category_code_Valid() const{
    return m_merchant_category_code_isValid;
}

OAIPaymentMethod OAIBraintreePayments::getMethod() const {
    return m_method;
}
void OAIBraintreePayments::setMethod(const OAIPaymentMethod &method) {
    m_method = method;
    m_method_isSet = true;
}

bool OAIBraintreePayments::is_method_Set() const{
    return m_method_isSet;
}

bool OAIBraintreePayments::is_method_Valid() const{
    return m_method_isValid;
}

double OAIBraintreePayments::getMonthlyLimit() const {
    return m_monthly_limit;
}
void OAIBraintreePayments::setMonthlyLimit(const double &monthly_limit) {
    m_monthly_limit = monthly_limit;
    m_monthly_limit_isSet = true;
}

bool OAIBraintreePayments::is_monthly_limit_Set() const{
    return m_monthly_limit_isSet;
}

bool OAIBraintreePayments::is_monthly_limit_Valid() const{
    return m_monthly_limit_isValid;
}

QString OAIBraintreePayments::getOrganizationId() const {
    return m_organization_id;
}
void OAIBraintreePayments::setOrganizationId(const QString &organization_id) {
    m_organization_id = organization_id;
    m_organization_id_isSet = true;
}

bool OAIBraintreePayments::is_organization_id_Set() const{
    return m_organization_id_isSet;
}

bool OAIBraintreePayments::is_organization_id_Valid() const{
    return m_organization_id_isValid;
}

QList<OAIPaymentCardBrand> OAIBraintreePayments::getPaymentCardSchemes() const {
    return m_payment_card_schemes;
}
void OAIBraintreePayments::setPaymentCardSchemes(const QList<OAIPaymentCardBrand> &payment_card_schemes) {
    m_payment_card_schemes = payment_card_schemes;
    m_payment_card_schemes_isSet = true;
}

bool OAIBraintreePayments::is_payment_card_schemes_Set() const{
    return m_payment_card_schemes_isSet;
}

bool OAIBraintreePayments::is_payment_card_schemes_Valid() const{
    return m_payment_card_schemes_isValid;
}

bool OAIBraintreePayments::isReconciliationWindowEnabled() const {
    return m_reconciliation_window_enabled;
}
void OAIBraintreePayments::setReconciliationWindowEnabled(const bool &reconciliation_window_enabled) {
    m_reconciliation_window_enabled = reconciliation_window_enabled;
    m_reconciliation_window_enabled_isSet = true;
}

bool OAIBraintreePayments::is_reconciliation_window_enabled_Set() const{
    return m_reconciliation_window_enabled_isSet;
}

bool OAIBraintreePayments::is_reconciliation_window_enabled_Valid() const{
    return m_reconciliation_window_enabled_isValid;
}

qint32 OAIBraintreePayments::getReconciliationWindowTtl() const {
    return m_reconciliation_window_ttl;
}
void OAIBraintreePayments::setReconciliationWindowTtl(const qint32 &reconciliation_window_ttl) {
    m_reconciliation_window_ttl = reconciliation_window_ttl;
    m_reconciliation_window_ttl_isSet = true;
}

bool OAIBraintreePayments::is_reconciliation_window_ttl_Set() const{
    return m_reconciliation_window_ttl_isSet;
}

bool OAIBraintreePayments::is_reconciliation_window_ttl_Valid() const{
    return m_reconciliation_window_ttl_isValid;
}

QString OAIBraintreePayments::getStatus() const {
    return m_status;
}
void OAIBraintreePayments::setStatus(const QString &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIBraintreePayments::is_status_Set() const{
    return m_status_isSet;
}

bool OAIBraintreePayments::is_status_Valid() const{
    return m_status_isValid;
}

bool OAIBraintreePayments::isSticky() const {
    return m_sticky;
}
void OAIBraintreePayments::setSticky(const bool &sticky) {
    m_sticky = sticky;
    m_sticky_isSet = true;
}

bool OAIBraintreePayments::is_sticky_Set() const{
    return m_sticky_isSet;
}

bool OAIBraintreePayments::is_sticky_Valid() const{
    return m_sticky_isValid;
}

bool OAIBraintreePayments::isThreeDSecure() const {
    return m_three_d_secure;
}
void OAIBraintreePayments::setThreeDSecure(const bool &three_d_secure) {
    m_three_d_secure = three_d_secure;
    m_three_d_secure_isSet = true;
}

bool OAIBraintreePayments::is_three_d_secure_Set() const{
    return m_three_d_secure_isSet;
}

bool OAIBraintreePayments::is_three_d_secure_Valid() const{
    return m_three_d_secure_isValid;
}

qint32 OAIBraintreePayments::getTimeout() const {
    return m_timeout;
}
void OAIBraintreePayments::setTimeout(const qint32 &timeout) {
    m_timeout = timeout;
    m_timeout_isSet = true;
}

bool OAIBraintreePayments::is_timeout_Set() const{
    return m_timeout_isSet;
}

bool OAIBraintreePayments::is_timeout_Valid() const{
    return m_timeout_isValid;
}

QString OAIBraintreePayments::getToken() const {
    return m_token;
}
void OAIBraintreePayments::setToken(const QString &token) {
    m_token = token;
    m_token_isSet = true;
}

bool OAIBraintreePayments::is_token_Set() const{
    return m_token_isSet;
}

bool OAIBraintreePayments::is_token_Valid() const{
    return m_token_isValid;
}

QDateTime OAIBraintreePayments::getUpdatedTime() const {
    return m_updated_time;
}
void OAIBraintreePayments::setUpdatedTime(const QDateTime &updated_time) {
    m_updated_time = updated_time;
    m_updated_time_isSet = true;
}

bool OAIBraintreePayments::is_updated_time_Set() const{
    return m_updated_time_isSet;
}

bool OAIBraintreePayments::is_updated_time_Valid() const{
    return m_updated_time_isValid;
}

OAIBraintreePayments_allOf_credentials OAIBraintreePayments::getCredentials() const {
    return m_credentials;
}
void OAIBraintreePayments::setCredentials(const OAIBraintreePayments_allOf_credentials &credentials) {
    m_credentials = credentials;
    m_credentials_isSet = true;
}

bool OAIBraintreePayments::is_credentials_Set() const{
    return m_credentials_isSet;
}

bool OAIBraintreePayments::is_credentials_Valid() const{
    return m_credentials_isValid;
}

bool OAIBraintreePayments::isSet() const {
...
bool OAIBraintreePayments::isValid() const {
