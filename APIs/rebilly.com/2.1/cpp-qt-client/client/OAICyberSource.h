...
#ifndef OAICyberSource_H
#define OAICyberSource_H

#include <QJsonObject>

#include "OAIAcquirerName.h"
#include "OAICyberSource_allOf_credentials.h"
...
class OAICyberSource_allOf_credentials;

class OAICyberSource : public OAIObject {
public:
    OAICyberSource();
    OAICyberSource(QString json);
    ~OAICyberSource() override;
    ...
    OAICyberSource_allOf_credentials getCredentials() const;
    void setCredentials(const OAICyberSource_allOf_credentials &credentials);
...
private:
    ...
    OAICyberSource_allOf_credentials m_credentials;
...
Q_DECLARE_METATYPE(OpenAPI::OAICyberSource)

#endif // OAICyberSource_H
