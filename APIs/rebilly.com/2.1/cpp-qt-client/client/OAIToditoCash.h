...
#ifndef OAIToditoCash_H
#define OAIToditoCash_H
...
#include "OAIToditoCash_allOf_credentials.h"
#include <QDateTime>
#include <QList>
#include <QString>
...
class OAIToditoCash_allOf_credentials;

class OAIToditoCash : public OAIObject {
public:
    OAIToditoCash();
    OAIToditoCash(QString json);
    ~OAIToditoCash() override;
    ...
    OAIToditoCash_allOf_credentials getCredentials() const;
    void setCredentials(const OAIToditoCash_allOf_credentials &credentials);
...
private:
    ...
    OAIToditoCash_allOf_credentials m_credentials;
...
Q_DECLARE_METATYPE(OpenAPI::OAIToditoCash)

#endif // OAIToditoCash_H
