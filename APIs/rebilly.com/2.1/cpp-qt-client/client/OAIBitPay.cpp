...
OAIBitPay::OAIBitPay(QString json) {
...
void OAIBitPay::initializeModel() {
...
void OAIBitPay::fromJson(QString jsonString) {
...
void OAIBitPay::fromJsonObject(QJsonObject json) {
...
QString OAIBitPay::asJson() const {
...
QJsonObject OAIBitPay::asJsonObject() const {
    QJsonObject obj;
    if (m__links.size() > 0) {
...
QList<OAIGatewayAccount__links_inner> OAIBitPay::getLinks() const {
    return m__links;
}
void OAIBitPay::setLinks(const QList<OAIGatewayAccount__links_inner> &_links) {
    m__links = _links;
    m__links_isSet = true;
}

bool OAIBitPay::is__links_Set() const{
    return m__links_isSet;
}

bool OAIBitPay::is__links_Valid() const{
    return m__links_isValid;
}

QList<QString> OAIBitPay::getAcceptedCurrencies() const {
    return m_accepted_currencies;
}
void OAIBitPay::setAcceptedCurrencies(const QList<QString> &accepted_currencies) {
    m_accepted_currencies = accepted_currencies;
    m_accepted_currencies_isSet = true;
}

bool OAIBitPay::is_accepted_currencies_Set() const{
    return m_accepted_currencies_isSet;
}

bool OAIBitPay::is_accepted_currencies_Valid() const{
    return m_accepted_currencies_isValid;
}

OAIAcquirerName OAIBitPay::getAcquirerName() const {
    return m_acquirer_name;
}
void OAIBitPay::setAcquirerName(const OAIAcquirerName &acquirer_name) {
    m_acquirer_name = acquirer_name;
    m_acquirer_name_isSet = true;
}

bool OAIBitPay::is_acquirer_name_Set() const{
    return m_acquirer_name_isSet;
}

bool OAIBitPay::is_acquirer_name_Valid() const{
    return m_acquirer_name_isValid;
}

QString OAIBitPay::getAdditionalFilters() const {
    return m_additional_filters;
}
void OAIBitPay::setAdditionalFilters(const QString &additional_filters) {
    m_additional_filters = additional_filters;
    m_additional_filters_isSet = true;
}

bool OAIBitPay::is_additional_filters_Set() const{
    return m_additional_filters_isSet;
}

bool OAIBitPay::is_additional_filters_Valid() const{
    return m_additional_filters_isValid;
}

qint32 OAIBitPay::getApprovalWindowTtl() const {
    return m_approval_window_ttl;
}
void OAIBitPay::setApprovalWindowTtl(const qint32 &approval_window_ttl) {
    m_approval_window_ttl = approval_window_ttl;
    m_approval_window_ttl_isSet = true;
}

bool OAIBitPay::is_approval_window_ttl_Set() const{
    return m_approval_window_ttl_isSet;
}

bool OAIBitPay::is_approval_window_ttl_Valid() const{
    return m_approval_window_ttl_isValid;
}

QString OAIBitPay::getCityField() const {
    return m_city_field;
}
void OAIBitPay::setCityField(const QString &city_field) {
    m_city_field = city_field;
    m_city_field_isSet = true;
}

bool OAIBitPay::is_city_field_Set() const{
    return m_city_field_isSet;
}

bool OAIBitPay::is_city_field_Valid() const{
    return m_city_field_isValid;
}

QDateTime OAIBitPay::getCreatedTime() const {
    return m_created_time;
}
void OAIBitPay::setCreatedTime(const QDateTime &created_time) {
    m_created_time = created_time;
    m_created_time_isSet = true;
}

bool OAIBitPay::is_created_time_Set() const{
    return m_created_time_isSet;
}

bool OAIBitPay::is_created_time_Valid() const{
    return m_created_time_isValid;
}

QString OAIBitPay::getDccForceCurrency() const {
    return m_dcc_force_currency;
}
void OAIBitPay::setDccForceCurrency(const QString &dcc_force_currency) {
    m_dcc_force_currency = dcc_force_currency;
    m_dcc_force_currency_isSet = true;
}

bool OAIBitPay::is_dcc_force_currency_Set() const{
    return m_dcc_force_currency_isSet;
}

bool OAIBitPay::is_dcc_force_currency_Valid() const{
    return m_dcc_force_currency_isValid;
}

qint32 OAIBitPay::getDccMarkup() const {
    return m_dcc_markup;
}
void OAIBitPay::setDccMarkup(const qint32 &dcc_markup) {
    m_dcc_markup = dcc_markup;
    m_dcc_markup_isSet = true;
}

bool OAIBitPay::is_dcc_markup_Set() const{
    return m_dcc_markup_isSet;
}

bool OAIBitPay::is_dcc_markup_Valid() const{
    return m_dcc_markup_isValid;
}

QString OAIBitPay::getDescriptor() const {
    return m_descriptor;
}
void OAIBitPay::setDescriptor(const QString &descriptor) {
    m_descriptor = descriptor;
    m_descriptor_isSet = true;
}

bool OAIBitPay::is_descriptor_Set() const{
    return m_descriptor_isSet;
}

bool OAIBitPay::is_descriptor_Valid() const{
    return m_descriptor_isValid;
}

OAIDigitalWallets OAIBitPay::getDigitalWallets() const {
    return m_digital_wallets;
}
void OAIBitPay::setDigitalWallets(const OAIDigitalWallets &digital_wallets) {
    m_digital_wallets = digital_wallets;
    m_digital_wallets_isSet = true;
}

bool OAIBitPay::is_digital_wallets_Set() const{
    return m_digital_wallets_isSet;
}

bool OAIBitPay::is_digital_wallets_Valid() const{
    return m_digital_wallets_isValid;
}

bool OAIBitPay::isDynamicDescriptor() const {
    return m_dynamic_descriptor;
}
void OAIBitPay::setDynamicDescriptor(const bool &dynamic_descriptor) {
    m_dynamic_descriptor = dynamic_descriptor;
    m_dynamic_descriptor_isSet = true;
}

bool OAIBitPay::is_dynamic_descriptor_Set() const{
    return m_dynamic_descriptor_isSet;
}

bool OAIBitPay::is_dynamic_descriptor_Valid() const{
    return m_dynamic_descriptor_isValid;
}

QList<QString> OAIBitPay::getExcludedDccQuoteCurrencies() const {
    return m_excluded_dcc_quote_currencies;
}
void OAIBitPay::setExcludedDccQuoteCurrencies(const QList<QString> &excluded_dcc_quote_currencies) {
    m_excluded_dcc_quote_currencies = excluded_dcc_quote_currencies;
    m_excluded_dcc_quote_currencies_isSet = true;
}

bool OAIBitPay::is_excluded_dcc_quote_currencies_Set() const{
    return m_excluded_dcc_quote_currencies_isSet;
}

bool OAIBitPay::is_excluded_dcc_quote_currencies_Valid() const{
    return m_excluded_dcc_quote_currencies_isValid;
}

OAIGatewayName OAIBitPay::getGatewayName() const {
    return m_gateway_name;
}
void OAIBitPay::setGatewayName(const OAIGatewayName &gateway_name) {
    m_gateway_name = gateway_name;
    m_gateway_name_isSet = true;
}

bool OAIBitPay::is_gateway_name_Set() const{
    return m_gateway_name_isSet;
}

bool OAIBitPay::is_gateway_name_Valid() const{
    return m_gateway_name_isValid;
}

QString OAIBitPay::getId() const {
    return m_id;
}
void OAIBitPay::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIBitPay::is_id_Set() const{
    return m_id_isSet;
}

bool OAIBitPay::is_id_Valid() const{
    return m_id_isValid;
}

bool OAIBitPay::isIsDown() const {
    return m_is_down;
}
void OAIBitPay::setIsDown(const bool &is_down) {
    m_is_down = is_down;
    m_is_down_isSet = true;
}

bool OAIBitPay::is_is_down_Set() const{
    return m_is_down_isSet;
}

bool OAIBitPay::is_is_down_Valid() const{
    return m_is_down_isValid;
}

QString OAIBitPay::getMerchantCategoryCode() const {
    return m_merchant_category_code;
}
void OAIBitPay::setMerchantCategoryCode(const QString &merchant_category_code) {
    m_merchant_category_code = merchant_category_code;
    m_merchant_category_code_isSet = true;
}

bool OAIBitPay::is_merchant_category_code_Set() const{
    return m_merchant_category_code_isSet;
}

bool OAIBitPay::is_merchant_category_code_Valid() const{
    return m_merchant_category_code_isValid;
}

OAIPaymentMethod OAIBitPay::getMethod() const {
    return m_method;
}
void OAIBitPay::setMethod(const OAIPaymentMethod &method) {
    m_method = method;
    m_method_isSet = true;
}

bool OAIBitPay::is_method_Set() const{
    return m_method_isSet;
}

bool OAIBitPay::is_method_Valid() const{
    return m_method_isValid;
}

double OAIBitPay::getMonthlyLimit() const {
    return m_monthly_limit;
}
void OAIBitPay::setMonthlyLimit(const double &monthly_limit) {
    m_monthly_limit = monthly_limit;
    m_monthly_limit_isSet = true;
}

bool OAIBitPay::is_monthly_limit_Set() const{
    return m_monthly_limit_isSet;
}

bool OAIBitPay::is_monthly_limit_Valid() const{
    return m_monthly_limit_isValid;
}

QString OAIBitPay::getOrganizationId() const {
    return m_organization_id;
}
void OAIBitPay::setOrganizationId(const QString &organization_id) {
    m_organization_id = organization_id;
    m_organization_id_isSet = true;
}

bool OAIBitPay::is_organization_id_Set() const{
    return m_organization_id_isSet;
}

bool OAIBitPay::is_organization_id_Valid() const{
    return m_organization_id_isValid;
}

QList<OAIPaymentCardBrand> OAIBitPay::getPaymentCardSchemes() const {
    return m_payment_card_schemes;
}
void OAIBitPay::setPaymentCardSchemes(const QList<OAIPaymentCardBrand> &payment_card_schemes) {
    m_payment_card_schemes = payment_card_schemes;
    m_payment_card_schemes_isSet = true;
}

bool OAIBitPay::is_payment_card_schemes_Set() const{
    return m_payment_card_schemes_isSet;
}

bool OAIBitPay::is_payment_card_schemes_Valid() const{
    return m_payment_card_schemes_isValid;
}

bool OAIBitPay::isReconciliationWindowEnabled() const {
    return m_reconciliation_window_enabled;
}
void OAIBitPay::setReconciliationWindowEnabled(const bool &reconciliation_window_enabled) {
    m_reconciliation_window_enabled = reconciliation_window_enabled;
    m_reconciliation_window_enabled_isSet = true;
}

bool OAIBitPay::is_reconciliation_window_enabled_Set() const{
    return m_reconciliation_window_enabled_isSet;
}

bool OAIBitPay::is_reconciliation_window_enabled_Valid() const{
    return m_reconciliation_window_enabled_isValid;
}

qint32 OAIBitPay::getReconciliationWindowTtl() const {
    return m_reconciliation_window_ttl;
}
void OAIBitPay::setReconciliationWindowTtl(const qint32 &reconciliation_window_ttl) {
    m_reconciliation_window_ttl = reconciliation_window_ttl;
    m_reconciliation_window_ttl_isSet = true;
}

bool OAIBitPay::is_reconciliation_window_ttl_Set() const{
    return m_reconciliation_window_ttl_isSet;
}

bool OAIBitPay::is_reconciliation_window_ttl_Valid() const{
    return m_reconciliation_window_ttl_isValid;
}

QString OAIBitPay::getStatus() const {
    return m_status;
}
void OAIBitPay::setStatus(const QString &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIBitPay::is_status_Set() const{
    return m_status_isSet;
}

bool OAIBitPay::is_status_Valid() const{
    return m_status_isValid;
}

bool OAIBitPay::isSticky() const {
    return m_sticky;
}
void OAIBitPay::setSticky(const bool &sticky) {
    m_sticky = sticky;
    m_sticky_isSet = true;
}

bool OAIBitPay::is_sticky_Set() const{
    return m_sticky_isSet;
}

bool OAIBitPay::is_sticky_Valid() const{
    return m_sticky_isValid;
}

bool OAIBitPay::isThreeDSecure() const {
    return m_three_d_secure;
}
void OAIBitPay::setThreeDSecure(const bool &three_d_secure) {
    m_three_d_secure = three_d_secure;
    m_three_d_secure_isSet = true;
}

bool OAIBitPay::is_three_d_secure_Set() const{
    return m_three_d_secure_isSet;
}

bool OAIBitPay::is_three_d_secure_Valid() const{
    return m_three_d_secure_isValid;
}

qint32 OAIBitPay::getTimeout() const {
    return m_timeout;
}
void OAIBitPay::setTimeout(const qint32 &timeout) {
    m_timeout = timeout;
    m_timeout_isSet = true;
}

bool OAIBitPay::is_timeout_Set() const{
    return m_timeout_isSet;
}

bool OAIBitPay::is_timeout_Valid() const{
    return m_timeout_isValid;
}

QString OAIBitPay::getToken() const {
    return m_token;
}
void OAIBitPay::setToken(const QString &token) {
    m_token = token;
    m_token_isSet = true;
}

bool OAIBitPay::is_token_Set() const{
    return m_token_isSet;
}

bool OAIBitPay::is_token_Valid() const{
    return m_token_isValid;
}

QDateTime OAIBitPay::getUpdatedTime() const {
    return m_updated_time;
}
void OAIBitPay::setUpdatedTime(const QDateTime &updated_time) {
    m_updated_time = updated_time;
    m_updated_time_isSet = true;
}

bool OAIBitPay::is_updated_time_Set() const{
    return m_updated_time_isSet;
}

bool OAIBitPay::is_updated_time_Valid() const{
    return m_updated_time_isValid;
}

OAIBitPay_allOf_credentials OAIBitPay::getCredentials() const {
    return m_credentials;
}
void OAIBitPay::setCredentials(const OAIBitPay_allOf_credentials &credentials) {
    m_credentials = credentials;
    m_credentials_isSet = true;
}

bool OAIBitPay::is_credentials_Set() const{
    return m_credentials_isSet;
}

bool OAIBitPay::is_credentials_Valid() const{
    return m_credentials_isValid;
}

bool OAIBitPay::isSet() const {
