...
OAIIlixium::OAIIlixium(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIIlixium::OAIIlixium() {
    this->initializeModel();
}

OAIIlixium::~OAIIlixium() {}

void OAIIlixium::initializeModel() {
...
void OAIIlixium::fromJson(QString jsonString) {
...
void OAIIlixium::fromJsonObject(QJsonObject json) {
...
QString OAIIlixium::asJson() const {
...
QJsonObject OAIIlixium::asJsonObject() const {
    QJsonObject obj;
    if (m__links.size() > 0) {
...
QList<OAIGatewayAccount__links_inner> OAIIlixium::getLinks() const {
    return m__links;
}
void OAIIlixium::setLinks(const QList<OAIGatewayAccount__links_inner> &_links) {
    m__links = _links;
    m__links_isSet = true;
}

bool OAIIlixium::is__links_Set() const{
    return m__links_isSet;
}

bool OAIIlixium::is__links_Valid() const{
    return m__links_isValid;
}

QList<QString> OAIIlixium::getAcceptedCurrencies() const {
    return m_accepted_currencies;
}
void OAIIlixium::setAcceptedCurrencies(const QList<QString> &accepted_currencies) {
    m_accepted_currencies = accepted_currencies;
    m_accepted_currencies_isSet = true;
}

bool OAIIlixium::is_accepted_currencies_Set() const{
    return m_accepted_currencies_isSet;
}

bool OAIIlixium::is_accepted_currencies_Valid() const{
    return m_accepted_currencies_isValid;
}

OAIAcquirerName OAIIlixium::getAcquirerName() const {
    return m_acquirer_name;
}
void OAIIlixium::setAcquirerName(const OAIAcquirerName &acquirer_name) {
    m_acquirer_name = acquirer_name;
    m_acquirer_name_isSet = true;
}

bool OAIIlixium::is_acquirer_name_Set() const{
    return m_acquirer_name_isSet;
}

bool OAIIlixium::is_acquirer_name_Valid() const{
    return m_acquirer_name_isValid;
}

QString OAIIlixium::getAdditionalFilters() const {
    return m_additional_filters;
}
void OAIIlixium::setAdditionalFilters(const QString &additional_filters) {
    m_additional_filters = additional_filters;
    m_additional_filters_isSet = true;
}

bool OAIIlixium::is_additional_filters_Set() const{
    return m_additional_filters_isSet;
}

bool OAIIlixium::is_additional_filters_Valid() const{
    return m_additional_filters_isValid;
}

qint32 OAIIlixium::getApprovalWindowTtl() const {
    return m_approval_window_ttl;
}
void OAIIlixium::setApprovalWindowTtl(const qint32 &approval_window_ttl) {
    m_approval_window_ttl = approval_window_ttl;
    m_approval_window_ttl_isSet = true;
}

bool OAIIlixium::is_approval_window_ttl_Set() const{
    return m_approval_window_ttl_isSet;
}

bool OAIIlixium::is_approval_window_ttl_Valid() const{
    return m_approval_window_ttl_isValid;
}

QString OAIIlixium::getCityField() const {
    return m_city_field;
}
void OAIIlixium::setCityField(const QString &city_field) {
    m_city_field = city_field;
    m_city_field_isSet = true;
}

bool OAIIlixium::is_city_field_Set() const{
    return m_city_field_isSet;
}

bool OAIIlixium::is_city_field_Valid() const{
    return m_city_field_isValid;
}

QDateTime OAIIlixium::getCreatedTime() const {
    return m_created_time;
}
void OAIIlixium::setCreatedTime(const QDateTime &created_time) {
    m_created_time = created_time;
    m_created_time_isSet = true;
}

bool OAIIlixium::is_created_time_Set() const{
    return m_created_time_isSet;
}

bool OAIIlixium::is_created_time_Valid() const{
    return m_created_time_isValid;
}

QString OAIIlixium::getDccForceCurrency() const {
    return m_dcc_force_currency;
}
void OAIIlixium::setDccForceCurrency(const QString &dcc_force_currency) {
    m_dcc_force_currency = dcc_force_currency;
    m_dcc_force_currency_isSet = true;
}

bool OAIIlixium::is_dcc_force_currency_Set() const{
    return m_dcc_force_currency_isSet;
}

bool OAIIlixium::is_dcc_force_currency_Valid() const{
    return m_dcc_force_currency_isValid;
}

qint32 OAIIlixium::getDccMarkup() const {
    return m_dcc_markup;
}
void OAIIlixium::setDccMarkup(const qint32 &dcc_markup) {
    m_dcc_markup = dcc_markup;
    m_dcc_markup_isSet = true;
}

bool OAIIlixium::is_dcc_markup_Set() const{
    return m_dcc_markup_isSet;
}

bool OAIIlixium::is_dcc_markup_Valid() const{
    return m_dcc_markup_isValid;
}

QString OAIIlixium::getDescriptor() const {
    return m_descriptor;
}
void OAIIlixium::setDescriptor(const QString &descriptor) {
    m_descriptor = descriptor;
    m_descriptor_isSet = true;
}

bool OAIIlixium::is_descriptor_Set() const{
    return m_descriptor_isSet;
}

bool OAIIlixium::is_descriptor_Valid() const{
    return m_descriptor_isValid;
}

OAIDigitalWallets OAIIlixium::getDigitalWallets() const {
    return m_digital_wallets;
}
void OAIIlixium::setDigitalWallets(const OAIDigitalWallets &digital_wallets) {
    m_digital_wallets = digital_wallets;
    m_digital_wallets_isSet = true;
}

bool OAIIlixium::is_digital_wallets_Set() const{
    return m_digital_wallets_isSet;
}

bool OAIIlixium::is_digital_wallets_Valid() const{
    return m_digital_wallets_isValid;
}

bool OAIIlixium::isDynamicDescriptor() const {
    return m_dynamic_descriptor;
}
void OAIIlixium::setDynamicDescriptor(const bool &dynamic_descriptor) {
    m_dynamic_descriptor = dynamic_descriptor;
    m_dynamic_descriptor_isSet = true;
}

bool OAIIlixium::is_dynamic_descriptor_Set() const{
    return m_dynamic_descriptor_isSet;
}

bool OAIIlixium::is_dynamic_descriptor_Valid() const{
    return m_dynamic_descriptor_isValid;
}

QList<QString> OAIIlixium::getExcludedDccQuoteCurrencies() const {
    return m_excluded_dcc_quote_currencies;
}
void OAIIlixium::setExcludedDccQuoteCurrencies(const QList<QString> &excluded_dcc_quote_currencies) {
    m_excluded_dcc_quote_currencies = excluded_dcc_quote_currencies;
    m_excluded_dcc_quote_currencies_isSet = true;
}

bool OAIIlixium::is_excluded_dcc_quote_currencies_Set() const{
    return m_excluded_dcc_quote_currencies_isSet;
}

bool OAIIlixium::is_excluded_dcc_quote_currencies_Valid() const{
    return m_excluded_dcc_quote_currencies_isValid;
}

OAIGatewayName OAIIlixium::getGatewayName() const {
    return m_gateway_name;
}
void OAIIlixium::setGatewayName(const OAIGatewayName &gateway_name) {
    m_gateway_name = gateway_name;
    m_gateway_name_isSet = true;
}

bool OAIIlixium::is_gateway_name_Set() const{
    return m_gateway_name_isSet;
}

bool OAIIlixium::is_gateway_name_Valid() const{
    return m_gateway_name_isValid;
}

QString OAIIlixium::getId() const {
    return m_id;
}
void OAIIlixium::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIIlixium::is_id_Set() const{
    return m_id_isSet;
}

bool OAIIlixium::is_id_Valid() const{
    return m_id_isValid;
}

bool OAIIlixium::isIsDown() const {
    return m_is_down;
}
void OAIIlixium::setIsDown(const bool &is_down) {
    m_is_down = is_down;
    m_is_down_isSet = true;
}

bool OAIIlixium::is_is_down_Set() const{
    return m_is_down_isSet;
}

bool OAIIlixium::is_is_down_Valid() const{
    return m_is_down_isValid;
}

QString OAIIlixium::getMerchantCategoryCode() const {
    return m_merchant_category_code;
}
void OAIIlixium::setMerchantCategoryCode(const QString &merchant_category_code) {
    m_merchant_category_code = merchant_category_code;
    m_merchant_category_code_isSet = true;
}

bool OAIIlixium::is_merchant_category_code_Set() const{
    return m_merchant_category_code_isSet;
}

bool OAIIlixium::is_merchant_category_code_Valid() const{
    return m_merchant_category_code_isValid;
}

OAIPaymentMethod OAIIlixium::getMethod() const {
    return m_method;
}
void OAIIlixium::setMethod(const OAIPaymentMethod &method) {
    m_method = method;
    m_method_isSet = true;
}

bool OAIIlixium::is_method_Set() const{
    return m_method_isSet;
}

bool OAIIlixium::is_method_Valid() const{
    return m_method_isValid;
}

double OAIIlixium::getMonthlyLimit() const {
    return m_monthly_limit;
}
void OAIIlixium::setMonthlyLimit(const double &monthly_limit) {
    m_monthly_limit = monthly_limit;
    m_monthly_limit_isSet = true;
}

bool OAIIlixium::is_monthly_limit_Set() const{
    return m_monthly_limit_isSet;
}

bool OAIIlixium::is_monthly_limit_Valid() const{
    return m_monthly_limit_isValid;
}

QString OAIIlixium::getOrganizationId() const {
    return m_organization_id;
}
void OAIIlixium::setOrganizationId(const QString &organization_id) {
    m_organization_id = organization_id;
    m_organization_id_isSet = true;
}

bool OAIIlixium::is_organization_id_Set() const{
    return m_organization_id_isSet;
}

bool OAIIlixium::is_organization_id_Valid() const{
    return m_organization_id_isValid;
}

QList<OAIPaymentCardBrand> OAIIlixium::getPaymentCardSchemes() const {
    return m_payment_card_schemes;
}
void OAIIlixium::setPaymentCardSchemes(const QList<OAIPaymentCardBrand> &payment_card_schemes) {
    m_payment_card_schemes = payment_card_schemes;
    m_payment_card_schemes_isSet = true;
}

bool OAIIlixium::is_payment_card_schemes_Set() const{
    return m_payment_card_schemes_isSet;
}

bool OAIIlixium::is_payment_card_schemes_Valid() const{
    return m_payment_card_schemes_isValid;
}

bool OAIIlixium::isReconciliationWindowEnabled() const {
    return m_reconciliation_window_enabled;
}
void OAIIlixium::setReconciliationWindowEnabled(const bool &reconciliation_window_enabled) {
    m_reconciliation_window_enabled = reconciliation_window_enabled;
    m_reconciliation_window_enabled_isSet = true;
}

bool OAIIlixium::is_reconciliation_window_enabled_Set() const{
    return m_reconciliation_window_enabled_isSet;
}

bool OAIIlixium::is_reconciliation_window_enabled_Valid() const{
    return m_reconciliation_window_enabled_isValid;
}

qint32 OAIIlixium::getReconciliationWindowTtl() const {
    return m_reconciliation_window_ttl;
}
void OAIIlixium::setReconciliationWindowTtl(const qint32 &reconciliation_window_ttl) {
    m_reconciliation_window_ttl = reconciliation_window_ttl;
    m_reconciliation_window_ttl_isSet = true;
}

bool OAIIlixium::is_reconciliation_window_ttl_Set() const{
    return m_reconciliation_window_ttl_isSet;
}

bool OAIIlixium::is_reconciliation_window_ttl_Valid() const{
    return m_reconciliation_window_ttl_isValid;
}

QString OAIIlixium::getStatus() const {
    return m_status;
}
void OAIIlixium::setStatus(const QString &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIIlixium::is_status_Set() const{
    return m_status_isSet;
}

bool OAIIlixium::is_status_Valid() const{
    return m_status_isValid;
}

bool OAIIlixium::isSticky() const {
    return m_sticky;
}
void OAIIlixium::setSticky(const bool &sticky) {
    m_sticky = sticky;
    m_sticky_isSet = true;
}

bool OAIIlixium::is_sticky_Set() const{
    return m_sticky_isSet;
}

bool OAIIlixium::is_sticky_Valid() const{
    return m_sticky_isValid;
}

bool OAIIlixium::isThreeDSecure() const {
    return m_three_d_secure;
}
void OAIIlixium::setThreeDSecure(const bool &three_d_secure) {
    m_three_d_secure = three_d_secure;
    m_three_d_secure_isSet = true;
}

bool OAIIlixium::is_three_d_secure_Set() const{
    return m_three_d_secure_isSet;
}

bool OAIIlixium::is_three_d_secure_Valid() const{
    return m_three_d_secure_isValid;
}

qint32 OAIIlixium::getTimeout() const {
    return m_timeout;
}
void OAIIlixium::setTimeout(const qint32 &timeout) {
    m_timeout = timeout;
    m_timeout_isSet = true;
}

bool OAIIlixium::is_timeout_Set() const{
    return m_timeout_isSet;
}

bool OAIIlixium::is_timeout_Valid() const{
    return m_timeout_isValid;
}

QString OAIIlixium::getToken() const {
    return m_token;
}
void OAIIlixium::setToken(const QString &token) {
    m_token = token;
    m_token_isSet = true;
}

bool OAIIlixium::is_token_Set() const{
    return m_token_isSet;
}

bool OAIIlixium::is_token_Valid() const{
    return m_token_isValid;
}

QDateTime OAIIlixium::getUpdatedTime() const {
    return m_updated_time;
}
void OAIIlixium::setUpdatedTime(const QDateTime &updated_time) {
    m_updated_time = updated_time;
    m_updated_time_isSet = true;
}

bool OAIIlixium::is_updated_time_Set() const{
    return m_updated_time_isSet;
}

bool OAIIlixium::is_updated_time_Valid() const{
    return m_updated_time_isValid;
}

OAIIlixium_allOf_credentials OAIIlixium::getCredentials() const {
    return m_credentials;
}
void OAIIlixium::setCredentials(const OAIIlixium_allOf_credentials &credentials) {
    m_credentials = credentials;
    m_credentials_isSet = true;
}

bool OAIIlixium::is_credentials_Set() const{
    return m_credentials_isSet;
}

bool OAIIlixium::is_credentials_Valid() const{
    return m_credentials_isValid;
}

OAIIlixium_allOf_settings OAIIlixium::getSettings() const {
    return m_settings;
}
void OAIIlixium::setSettings(const OAIIlixium_allOf_settings &settings) {
    m_settings = settings;
    m_settings_isSet = true;
}

bool OAIIlixium::is_settings_Set() const{
    return m_settings_isSet;
}

bool OAIIlixium::is_settings_Valid() const{
    return m_settings_isValid;
}

OAIIlixium3dsServers OAIIlixium::getThreeDSecureServer() const {
    return m_three_d_secure_server;
}
void OAIIlixium::setThreeDSecureServer(const OAIIlixium3dsServers &three_d_secure_server) {
    m_three_d_secure_server = three_d_secure_server;
    m_three_d_secure_server_isSet = true;
}

bool OAIIlixium::is_three_d_secure_server_Set() const{
    return m_three_d_secure_server_isSet;
}

bool OAIIlixium::is_three_d_secure_server_Valid() const{
    return m_three_d_secure_server_isValid;
}

bool OAIIlixium::isSet() const {
