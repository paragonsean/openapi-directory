...
/*
 * OAIRapyd_allOf_credentials.h
 *
 * Rapyd credentials object.
 */

#ifndef OAIRapyd_allOf_credentials_H
#define OAIRapyd_allOf_credentials_H
...
class OAIRapyd_allOf_credentials : public OAIObject {
public:
    OAIRapyd_allOf_credentials();
    OAIRapyd_allOf_credentials(QString json);
    ~OAIRapyd_allOf_credentials() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRapyd_allOf_credentials)

#endif // OAIRapyd_allOf_credentials_H
