...
class OAIPayClub_allOf_credentials;
class OAIPayClub_allOf_settings;

class OAIPayClub : public OAIObject {
public:
    OAIPayClub();
    OAIPayClub(QString json);
    ~OAIPayClub() override;
    ...
    OAIPayClub_allOf_credentials getCredentials() const;
    void setCredentials(const OAIPayClub_allOf_credentials &credentials);
    bool is_credentials_Set() const;
    bool is_credentials_Valid() const;

    OAIPayClub_allOf_settings getSettings() const;
    void setSettings(const OAIPayClub_allOf_settings &settings);
...
private:
    ...
    OAIPayClub_allOf_credentials m_credentials;
    bool m_credentials_isSet;
    bool m_credentials_isValid;

    OAIPayClub_allOf_settings m_settings;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPayClub)
