...
OAIPostFinance::OAIPostFinance(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPostFinance::OAIPostFinance() {
    this->initializeModel();
}

OAIPostFinance::~OAIPostFinance() {}

void OAIPostFinance::initializeModel() {
...
void OAIPostFinance::fromJson(QString jsonString) {
...
void OAIPostFinance::fromJsonObject(QJsonObject json) {
...
QString OAIPostFinance::asJson() const {
...
QJsonObject OAIPostFinance::asJsonObject() const {
    QJsonObject obj;
    if (m__links.size() > 0) {
...
QList<OAIGatewayAccount__links_inner> OAIPostFinance::getLinks() const {
    return m__links;
}
void OAIPostFinance::setLinks(const QList<OAIGatewayAccount__links_inner> &_links) {
    m__links = _links;
    m__links_isSet = true;
}

bool OAIPostFinance::is__links_Set() const{
    return m__links_isSet;
}

bool OAIPostFinance::is__links_Valid() const{
    return m__links_isValid;
}

QList<QString> OAIPostFinance::getAcceptedCurrencies() const {
    return m_accepted_currencies;
}
void OAIPostFinance::setAcceptedCurrencies(const QList<QString> &accepted_currencies) {
    m_accepted_currencies = accepted_currencies;
    m_accepted_currencies_isSet = true;
}

bool OAIPostFinance::is_accepted_currencies_Set() const{
    return m_accepted_currencies_isSet;
}

bool OAIPostFinance::is_accepted_currencies_Valid() const{
    return m_accepted_currencies_isValid;
}

OAIAcquirerName OAIPostFinance::getAcquirerName() const {
    return m_acquirer_name;
}
void OAIPostFinance::setAcquirerName(const OAIAcquirerName &acquirer_name) {
    m_acquirer_name = acquirer_name;
    m_acquirer_name_isSet = true;
}

bool OAIPostFinance::is_acquirer_name_Set() const{
    return m_acquirer_name_isSet;
}

bool OAIPostFinance::is_acquirer_name_Valid() const{
    return m_acquirer_name_isValid;
}

QString OAIPostFinance::getAdditionalFilters() const {
    return m_additional_filters;
}
void OAIPostFinance::setAdditionalFilters(const QString &additional_filters) {
    m_additional_filters = additional_filters;
    m_additional_filters_isSet = true;
}

bool OAIPostFinance::is_additional_filters_Set() const{
    return m_additional_filters_isSet;
}

bool OAIPostFinance::is_additional_filters_Valid() const{
    return m_additional_filters_isValid;
}

qint32 OAIPostFinance::getApprovalWindowTtl() const {
    return m_approval_window_ttl;
}
void OAIPostFinance::setApprovalWindowTtl(const qint32 &approval_window_ttl) {
    m_approval_window_ttl = approval_window_ttl;
    m_approval_window_ttl_isSet = true;
}

bool OAIPostFinance::is_approval_window_ttl_Set() const{
    return m_approval_window_ttl_isSet;
}

bool OAIPostFinance::is_approval_window_ttl_Valid() const{
    return m_approval_window_ttl_isValid;
}

QString OAIPostFinance::getCityField() const {
    return m_city_field;
}
void OAIPostFinance::setCityField(const QString &city_field) {
    m_city_field = city_field;
    m_city_field_isSet = true;
}

bool OAIPostFinance::is_city_field_Set() const{
    return m_city_field_isSet;
}

bool OAIPostFinance::is_city_field_Valid() const{
    return m_city_field_isValid;
}

QDateTime OAIPostFinance::getCreatedTime() const {
    return m_created_time;
}
void OAIPostFinance::setCreatedTime(const QDateTime &created_time) {
    m_created_time = created_time;
    m_created_time_isSet = true;
}

bool OAIPostFinance::is_created_time_Set() const{
    return m_created_time_isSet;
}

bool OAIPostFinance::is_created_time_Valid() const{
    return m_created_time_isValid;
}

QString OAIPostFinance::getDccForceCurrency() const {
    return m_dcc_force_currency;
}
void OAIPostFinance::setDccForceCurrency(const QString &dcc_force_currency) {
    m_dcc_force_currency = dcc_force_currency;
    m_dcc_force_currency_isSet = true;
}

bool OAIPostFinance::is_dcc_force_currency_Set() const{
    return m_dcc_force_currency_isSet;
}

bool OAIPostFinance::is_dcc_force_currency_Valid() const{
    return m_dcc_force_currency_isValid;
}

qint32 OAIPostFinance::getDccMarkup() const {
    return m_dcc_markup;
}
void OAIPostFinance::setDccMarkup(const qint32 &dcc_markup) {
    m_dcc_markup = dcc_markup;
    m_dcc_markup_isSet = true;
}

bool OAIPostFinance::is_dcc_markup_Set() const{
    return m_dcc_markup_isSet;
}

bool OAIPostFinance::is_dcc_markup_Valid() const{
    return m_dcc_markup_isValid;
}

QString OAIPostFinance::getDescriptor() const {
    return m_descriptor;
}
void OAIPostFinance::setDescriptor(const QString &descriptor) {
    m_descriptor = descriptor;
    m_descriptor_isSet = true;
}

bool OAIPostFinance::is_descriptor_Set() const{
    return m_descriptor_isSet;
}

bool OAIPostFinance::is_descriptor_Valid() const{
    return m_descriptor_isValid;
}

OAIDigitalWallets OAIPostFinance::getDigitalWallets() const {
    return m_digital_wallets;
}
void OAIPostFinance::setDigitalWallets(const OAIDigitalWallets &digital_wallets) {
    m_digital_wallets = digital_wallets;
    m_digital_wallets_isSet = true;
}

bool OAIPostFinance::is_digital_wallets_Set() const{
    return m_digital_wallets_isSet;
}

bool OAIPostFinance::is_digital_wallets_Valid() const{
    return m_digital_wallets_isValid;
}

bool OAIPostFinance::isDynamicDescriptor() const {
    return m_dynamic_descriptor;
}
void OAIPostFinance::setDynamicDescriptor(const bool &dynamic_descriptor) {
    m_dynamic_descriptor = dynamic_descriptor;
    m_dynamic_descriptor_isSet = true;
}

bool OAIPostFinance::is_dynamic_descriptor_Set() const{
    return m_dynamic_descriptor_isSet;
}

bool OAIPostFinance::is_dynamic_descriptor_Valid() const{
    return m_dynamic_descriptor_isValid;
}

QList<QString> OAIPostFinance::getExcludedDccQuoteCurrencies() const {
    return m_excluded_dcc_quote_currencies;
}
void OAIPostFinance::setExcludedDccQuoteCurrencies(const QList<QString> &excluded_dcc_quote_currencies) {
    m_excluded_dcc_quote_currencies = excluded_dcc_quote_currencies;
    m_excluded_dcc_quote_currencies_isSet = true;
}

bool OAIPostFinance::is_excluded_dcc_quote_currencies_Set() const{
    return m_excluded_dcc_quote_currencies_isSet;
}

bool OAIPostFinance::is_excluded_dcc_quote_currencies_Valid() const{
    return m_excluded_dcc_quote_currencies_isValid;
}

OAIGatewayName OAIPostFinance::getGatewayName() const {
    return m_gateway_name;
}
void OAIPostFinance::setGatewayName(const OAIGatewayName &gateway_name) {
    m_gateway_name = gateway_name;
    m_gateway_name_isSet = true;
}

bool OAIPostFinance::is_gateway_name_Set() const{
    return m_gateway_name_isSet;
}

bool OAIPostFinance::is_gateway_name_Valid() const{
    return m_gateway_name_isValid;
}

QString OAIPostFinance::getId() const {
    return m_id;
}
void OAIPostFinance::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIPostFinance::is_id_Set() const{
    return m_id_isSet;
}

bool OAIPostFinance::is_id_Valid() const{
    return m_id_isValid;
}

bool OAIPostFinance::isIsDown() const {
    return m_is_down;
}
void OAIPostFinance::setIsDown(const bool &is_down) {
    m_is_down = is_down;
    m_is_down_isSet = true;
}

bool OAIPostFinance::is_is_down_Set() const{
    return m_is_down_isSet;
}

bool OAIPostFinance::is_is_down_Valid() const{
    return m_is_down_isValid;
}

QString OAIPostFinance::getMerchantCategoryCode() const {
    return m_merchant_category_code;
}
void OAIPostFinance::setMerchantCategoryCode(const QString &merchant_category_code) {
    m_merchant_category_code = merchant_category_code;
    m_merchant_category_code_isSet = true;
}

bool OAIPostFinance::is_merchant_category_code_Set() const{
    return m_merchant_category_code_isSet;
}

bool OAIPostFinance::is_merchant_category_code_Valid() const{
    return m_merchant_category_code_isValid;
}

OAIPaymentMethod OAIPostFinance::getMethod() const {
    return m_method;
}
void OAIPostFinance::setMethod(const OAIPaymentMethod &method) {
    m_method = method;
    m_method_isSet = true;
}

bool OAIPostFinance::is_method_Set() const{
    return m_method_isSet;
}

bool OAIPostFinance::is_method_Valid() const{
    return m_method_isValid;
}

double OAIPostFinance::getMonthlyLimit() const {
    return m_monthly_limit;
}
void OAIPostFinance::setMonthlyLimit(const double &monthly_limit) {
    m_monthly_limit = monthly_limit;
    m_monthly_limit_isSet = true;
}

bool OAIPostFinance::is_monthly_limit_Set() const{
    return m_monthly_limit_isSet;
}

bool OAIPostFinance::is_monthly_limit_Valid() const{
    return m_monthly_limit_isValid;
}

QString OAIPostFinance::getOrganizationId() const {
    return m_organization_id;
}
void OAIPostFinance::setOrganizationId(const QString &organization_id) {
    m_organization_id = organization_id;
    m_organization_id_isSet = true;
}

bool OAIPostFinance::is_organization_id_Set() const{
    return m_organization_id_isSet;
}

bool OAIPostFinance::is_organization_id_Valid() const{
    return m_organization_id_isValid;
}

QList<OAIPaymentCardBrand> OAIPostFinance::getPaymentCardSchemes() const {
    return m_payment_card_schemes;
}
void OAIPostFinance::setPaymentCardSchemes(const QList<OAIPaymentCardBrand> &payment_card_schemes) {
    m_payment_card_schemes = payment_card_schemes;
    m_payment_card_schemes_isSet = true;
}

bool OAIPostFinance::is_payment_card_schemes_Set() const{
    return m_payment_card_schemes_isSet;
}

bool OAIPostFinance::is_payment_card_schemes_Valid() const{
    return m_payment_card_schemes_isValid;
}

bool OAIPostFinance::isReconciliationWindowEnabled() const {
    return m_reconciliation_window_enabled;
}
void OAIPostFinance::setReconciliationWindowEnabled(const bool &reconciliation_window_enabled) {
    m_reconciliation_window_enabled = reconciliation_window_enabled;
    m_reconciliation_window_enabled_isSet = true;
}

bool OAIPostFinance::is_reconciliation_window_enabled_Set() const{
    return m_reconciliation_window_enabled_isSet;
}

bool OAIPostFinance::is_reconciliation_window_enabled_Valid() const{
    return m_reconciliation_window_enabled_isValid;
}

qint32 OAIPostFinance::getReconciliationWindowTtl() const {
    return m_reconciliation_window_ttl;
}
void OAIPostFinance::setReconciliationWindowTtl(const qint32 &reconciliation_window_ttl) {
    m_reconciliation_window_ttl = reconciliation_window_ttl;
    m_reconciliation_window_ttl_isSet = true;
}

bool OAIPostFinance::is_reconciliation_window_ttl_Set() const{
    return m_reconciliation_window_ttl_isSet;
}

bool OAIPostFinance::is_reconciliation_window_ttl_Valid() const{
    return m_reconciliation_window_ttl_isValid;
}

QString OAIPostFinance::getStatus() const {
    return m_status;
}
void OAIPostFinance::setStatus(const QString &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIPostFinance::is_status_Set() const{
    return m_status_isSet;
}

bool OAIPostFinance::is_status_Valid() const{
    return m_status_isValid;
}

bool OAIPostFinance::isSticky() const {
    return m_sticky;
}
void OAIPostFinance::setSticky(const bool &sticky) {
    m_sticky = sticky;
    m_sticky_isSet = true;
}

bool OAIPostFinance::is_sticky_Set() const{
    return m_sticky_isSet;
}

bool OAIPostFinance::is_sticky_Valid() const{
    return m_sticky_isValid;
}

bool OAIPostFinance::isThreeDSecure() const {
    return m_three_d_secure;
}
void OAIPostFinance::setThreeDSecure(const bool &three_d_secure) {
    m_three_d_secure = three_d_secure;
    m_three_d_secure_isSet = true;
}

bool OAIPostFinance::is_three_d_secure_Set() const{
    return m_three_d_secure_isSet;
}

bool OAIPostFinance::is_three_d_secure_Valid() const{
    return m_three_d_secure_isValid;
}

qint32 OAIPostFinance::getTimeout() const {
    return m_timeout;
}
void OAIPostFinance::setTimeout(const qint32 &timeout) {
    m_timeout = timeout;
    m_timeout_isSet = true;
}

bool OAIPostFinance::is_timeout_Set() const{
    return m_timeout_isSet;
}

bool OAIPostFinance::is_timeout_Valid() const{
    return m_timeout_isValid;
}

QString OAIPostFinance::getToken() const {
    return m_token;
}
void OAIPostFinance::setToken(const QString &token) {
    m_token = token;
    m_token_isSet = true;
}

bool OAIPostFinance::is_token_Set() const{
    return m_token_isSet;
}

bool OAIPostFinance::is_token_Valid() const{
    return m_token_isValid;
}

QDateTime OAIPostFinance::getUpdatedTime() const {
    return m_updated_time;
}
void OAIPostFinance::setUpdatedTime(const QDateTime &updated_time) {
    m_updated_time = updated_time;
    m_updated_time_isSet = true;
}

bool OAIPostFinance::is_updated_time_Set() const{
    return m_updated_time_isSet;
}

bool OAIPostFinance::is_updated_time_Valid() const{
    return m_updated_time_isValid;
}

OAIPostFinance_allOf_credentials OAIPostFinance::getCredentials() const {
    return m_credentials;
}
void OAIPostFinance::setCredentials(const OAIPostFinance_allOf_credentials &credentials) {
    m_credentials = credentials;
    m_credentials_isSet = true;
}

bool OAIPostFinance::is_credentials_Set() const{
    return m_credentials_isSet;
}

bool OAIPostFinance::is_credentials_Valid() const{
    return m_credentials_isValid;
}

bool OAIPostFinance::isSet() const {
...
bool OAIPostFinance::isValid() const {
