...
QString OAIBankAccount::getAccountNumberType() const {
    return m_account_number_type;
}
void OAIBankAccount::setAccountNumberType(const QString &account_number_type) {
    m_account_number_type = account_number_type;
    m_account_number_type_isSet = true;
}

bool OAIBankAccount::is_account_number_type_Set() const{
    return m_account_number_type_isSet;
}

bool OAIBankAccount::is_account_number_type_Valid() const{
...
OAIContactObject OAIBankAccount::getBillingAddress() const {
    return m_billing_address;
}
void OAIBankAccount::setBillingAddress(const OAIContactObject &billing_address) {
    m_billing_address = billing_address;
    m_billing_address_isSet = true;
}

bool OAIBankAccount::is_billing_address_Set() const{
    return m_billing_address_isSet;
}

bool OAIBankAccount::is_billing_address_Valid() const{
    return m_billing_address_isValid;
}

QDateTime OAIBankAccount::getCreatedTime() const {
    return m_created_time;
}
void OAIBankAccount::setCreatedTime(const QDateTime &created_time) {
    m_created_time = created_time;
    m_created_time_isSet = true;
}

bool OAIBankAccount::is_created_time_Set() const{
    return m_created_time_isSet;
}

bool OAIBankAccount::is_created_time_Valid() const{
    return m_created_time_isValid;
}

OAIObject OAIBankAccount::getCustomFields() const {
    return m_custom_fields;
}
void OAIBankAccount::setCustomFields(const OAIObject &custom_fields) {
    m_custom_fields = custom_fields;
    m_custom_fields_isSet = true;
}

bool OAIBankAccount::is_custom_fields_Set() const{
    return m_custom_fields_isSet;
}

bool OAIBankAccount::is_custom_fields_Valid() const{
    return m_custom_fields_isValid;
}

QString OAIBankAccount::getCustomerId() const {
    return m_customer_id;
}
void OAIBankAccount::setCustomerId(const QString &customer_id) {
    m_customer_id = customer_id;
    m_customer_id_isSet = true;
}

bool OAIBankAccount::is_customer_id_Set() const{
    return m_customer_id_isSet;
}

bool OAIBankAccount::is_customer_id_Valid() const{
...
QString OAIBankAccount::getLast4() const {
    return m_last4;
}
void OAIBankAccount::setLast4(const QString &last4) {
    m_last4 = last4;
    m_last4_isSet = true;
}

bool OAIBankAccount::is_last4_Set() const{
    return m_last4_isSet;
}

bool OAIBankAccount::is_last4_Valid() const{
    return m_last4_isValid;
}

QString OAIBankAccount::getMethod() const {
    return m_method;
}
void OAIBankAccount::setMethod(const QString &method) {
    m_method = method;
    m_method_isSet = true;
}

bool OAIBankAccount::is_method_Set() const{
    return m_method_isSet;
}

bool OAIBankAccount::is_method_Valid() const{
    return m_method_isValid;
}

OAIRiskMetadata OAIBankAccount::getRiskMetadata() const {
    return m_risk_metadata;
}
void OAIBankAccount::setRiskMetadata(const OAIRiskMetadata &risk_metadata) {
    m_risk_metadata = risk_metadata;
    m_risk_metadata_isSet = true;
}

bool OAIBankAccount::is_risk_metadata_Set() const{
    return m_risk_metadata_isSet;
}

bool OAIBankAccount::is_risk_metadata_Valid() const{
...
QDateTime OAIBankAccount::getUpdatedTime() const {
    return m_updated_time;
}
void OAIBankAccount::setUpdatedTime(const QDateTime &updated_time) {
    m_updated_time = updated_time;
    m_updated_time_isSet = true;
}

bool OAIBankAccount::is_updated_time_Set() const{
    return m_updated_time_isSet;
}

bool OAIBankAccount::is_updated_time_Valid() const{
    return m_updated_time_isValid;
}

QList<OAIBankAccount_allOf__embedded> OAIBankAccount::getEmbedded() const {
    return m__embedded;
}
void OAIBankAccount::setEmbedded(const QList<OAIBankAccount_allOf__embedded> &_embedded) {
    m__embedded = _embedded;
    m__embedded_isSet = true;
}

bool OAIBankAccount::is__embedded_Set() const{
    return m__embedded_isSet;
}

bool OAIBankAccount::is__embedded_Valid() const{
    return m__embedded_isValid;
}

QList<OAIBankAccount_allOf__links> OAIBankAccount::getLinks() const {
    return m__links;
}
void OAIBankAccount::setLinks(const QList<OAIBankAccount_allOf__links> &_links) {
    m__links = _links;
    m__links_isSet = true;
}

bool OAIBankAccount::is__links_Set() const{
    return m__links_isSet;
}

bool OAIBankAccount::is__links_Valid() const{
