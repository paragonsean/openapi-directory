...
class OAIBitPay_allOf_credentials;

class OAIBitPay : public OAIObject {
public:
    OAIBitPay();
    OAIBitPay(QString json);
    ~OAIBitPay() override;
    ...
    OAIBitPay_allOf_credentials getCredentials() const;
    void setCredentials(const OAIBitPay_allOf_credentials &credentials);
...
private:
    ...
    OAIBitPay_allOf_credentials m_credentials;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBitPay)
