...
#include "OAIPaymenTechnologies.h"
...
OAIPaymenTechnologies::OAIPaymenTechnologies(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPaymenTechnologies::OAIPaymenTechnologies() {
    this->initializeModel();
}

OAIPaymenTechnologies::~OAIPaymenTechnologies() {}

void OAIPaymenTechnologies::initializeModel() {
...
void OAIPaymenTechnologies::fromJson(QString jsonString) {
...
void OAIPaymenTechnologies::fromJsonObject(QJsonObject json) {
...
QString OAIPaymenTechnologies::asJson() const {
...
QJsonObject OAIPaymenTechnologies::asJsonObject() const {
    QJsonObject obj;
    if (m__links.size() > 0) {
...
QList<OAIGatewayAccount__links_inner> OAIPaymenTechnologies::getLinks() const {
    return m__links;
}
void OAIPaymenTechnologies::setLinks(const QList<OAIGatewayAccount__links_inner> &_links) {
    m__links = _links;
    m__links_isSet = true;
}

bool OAIPaymenTechnologies::is__links_Set() const{
    return m__links_isSet;
}

bool OAIPaymenTechnologies::is__links_Valid() const{
    return m__links_isValid;
}

QList<QString> OAIPaymenTechnologies::getAcceptedCurrencies() const {
    return m_accepted_currencies;
}
void OAIPaymenTechnologies::setAcceptedCurrencies(const QList<QString> &accepted_currencies) {
    m_accepted_currencies = accepted_currencies;
    m_accepted_currencies_isSet = true;
}

bool OAIPaymenTechnologies::is_accepted_currencies_Set() const{
    return m_accepted_currencies_isSet;
}

bool OAIPaymenTechnologies::is_accepted_currencies_Valid() const{
    return m_accepted_currencies_isValid;
}

OAIAcquirerName OAIPaymenTechnologies::getAcquirerName() const {
    return m_acquirer_name;
}
void OAIPaymenTechnologies::setAcquirerName(const OAIAcquirerName &acquirer_name) {
    m_acquirer_name = acquirer_name;
    m_acquirer_name_isSet = true;
}

bool OAIPaymenTechnologies::is_acquirer_name_Set() const{
    return m_acquirer_name_isSet;
}

bool OAIPaymenTechnologies::is_acquirer_name_Valid() const{
    return m_acquirer_name_isValid;
}

QString OAIPaymenTechnologies::getAdditionalFilters() const {
    return m_additional_filters;
}
void OAIPaymenTechnologies::setAdditionalFilters(const QString &additional_filters) {
    m_additional_filters = additional_filters;
    m_additional_filters_isSet = true;
}

bool OAIPaymenTechnologies::is_additional_filters_Set() const{
    return m_additional_filters_isSet;
}

bool OAIPaymenTechnologies::is_additional_filters_Valid() const{
    return m_additional_filters_isValid;
}

qint32 OAIPaymenTechnologies::getApprovalWindowTtl() const {
    return m_approval_window_ttl;
}
void OAIPaymenTechnologies::setApprovalWindowTtl(const qint32 &approval_window_ttl) {
    m_approval_window_ttl = approval_window_ttl;
    m_approval_window_ttl_isSet = true;
}

bool OAIPaymenTechnologies::is_approval_window_ttl_Set() const{
    return m_approval_window_ttl_isSet;
}

bool OAIPaymenTechnologies::is_approval_window_ttl_Valid() const{
    return m_approval_window_ttl_isValid;
}

QString OAIPaymenTechnologies::getCityField() const {
    return m_city_field;
}
void OAIPaymenTechnologies::setCityField(const QString &city_field) {
    m_city_field = city_field;
    m_city_field_isSet = true;
}

bool OAIPaymenTechnologies::is_city_field_Set() const{
    return m_city_field_isSet;
}

bool OAIPaymenTechnologies::is_city_field_Valid() const{
    return m_city_field_isValid;
}

QDateTime OAIPaymenTechnologies::getCreatedTime() const {
    return m_created_time;
}
void OAIPaymenTechnologies::setCreatedTime(const QDateTime &created_time) {
    m_created_time = created_time;
    m_created_time_isSet = true;
}

bool OAIPaymenTechnologies::is_created_time_Set() const{
    return m_created_time_isSet;
}

bool OAIPaymenTechnologies::is_created_time_Valid() const{
    return m_created_time_isValid;
}

QString OAIPaymenTechnologies::getDccForceCurrency() const {
    return m_dcc_force_currency;
}
void OAIPaymenTechnologies::setDccForceCurrency(const QString &dcc_force_currency) {
    m_dcc_force_currency = dcc_force_currency;
    m_dcc_force_currency_isSet = true;
}

bool OAIPaymenTechnologies::is_dcc_force_currency_Set() const{
    return m_dcc_force_currency_isSet;
}

bool OAIPaymenTechnologies::is_dcc_force_currency_Valid() const{
    return m_dcc_force_currency_isValid;
}

qint32 OAIPaymenTechnologies::getDccMarkup() const {
    return m_dcc_markup;
}
void OAIPaymenTechnologies::setDccMarkup(const qint32 &dcc_markup) {
    m_dcc_markup = dcc_markup;
    m_dcc_markup_isSet = true;
}

bool OAIPaymenTechnologies::is_dcc_markup_Set() const{
    return m_dcc_markup_isSet;
}

bool OAIPaymenTechnologies::is_dcc_markup_Valid() const{
    return m_dcc_markup_isValid;
}

QString OAIPaymenTechnologies::getDescriptor() const {
    return m_descriptor;
}
void OAIPaymenTechnologies::setDescriptor(const QString &descriptor) {
    m_descriptor = descriptor;
    m_descriptor_isSet = true;
}

bool OAIPaymenTechnologies::is_descriptor_Set() const{
    return m_descriptor_isSet;
}

bool OAIPaymenTechnologies::is_descriptor_Valid() const{
    return m_descriptor_isValid;
}

OAIDigitalWallets OAIPaymenTechnologies::getDigitalWallets() const {
    return m_digital_wallets;
}
void OAIPaymenTechnologies::setDigitalWallets(const OAIDigitalWallets &digital_wallets) {
    m_digital_wallets = digital_wallets;
    m_digital_wallets_isSet = true;
}

bool OAIPaymenTechnologies::is_digital_wallets_Set() const{
    return m_digital_wallets_isSet;
}

bool OAIPaymenTechnologies::is_digital_wallets_Valid() const{
    return m_digital_wallets_isValid;
}

bool OAIPaymenTechnologies::isDynamicDescriptor() const {
    return m_dynamic_descriptor;
}
void OAIPaymenTechnologies::setDynamicDescriptor(const bool &dynamic_descriptor) {
    m_dynamic_descriptor = dynamic_descriptor;
    m_dynamic_descriptor_isSet = true;
}

bool OAIPaymenTechnologies::is_dynamic_descriptor_Set() const{
    return m_dynamic_descriptor_isSet;
}

bool OAIPaymenTechnologies::is_dynamic_descriptor_Valid() const{
    return m_dynamic_descriptor_isValid;
}

QList<QString> OAIPaymenTechnologies::getExcludedDccQuoteCurrencies() const {
    return m_excluded_dcc_quote_currencies;
}
void OAIPaymenTechnologies::setExcludedDccQuoteCurrencies(const QList<QString> &excluded_dcc_quote_currencies) {
    m_excluded_dcc_quote_currencies = excluded_dcc_quote_currencies;
    m_excluded_dcc_quote_currencies_isSet = true;
}

bool OAIPaymenTechnologies::is_excluded_dcc_quote_currencies_Set() const{
    return m_excluded_dcc_quote_currencies_isSet;
}

bool OAIPaymenTechnologies::is_excluded_dcc_quote_currencies_Valid() const{
    return m_excluded_dcc_quote_currencies_isValid;
}

OAIGatewayName OAIPaymenTechnologies::getGatewayName() const {
    return m_gateway_name;
}
void OAIPaymenTechnologies::setGatewayName(const OAIGatewayName &gateway_name) {
    m_gateway_name = gateway_name;
    m_gateway_name_isSet = true;
}

bool OAIPaymenTechnologies::is_gateway_name_Set() const{
    return m_gateway_name_isSet;
}

bool OAIPaymenTechnologies::is_gateway_name_Valid() const{
    return m_gateway_name_isValid;
}

QString OAIPaymenTechnologies::getId() const {
    return m_id;
}
void OAIPaymenTechnologies::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIPaymenTechnologies::is_id_Set() const{
    return m_id_isSet;
}

bool OAIPaymenTechnologies::is_id_Valid() const{
    return m_id_isValid;
}

bool OAIPaymenTechnologies::isIsDown() const {
    return m_is_down;
}
void OAIPaymenTechnologies::setIsDown(const bool &is_down) {
    m_is_down = is_down;
    m_is_down_isSet = true;
}

bool OAIPaymenTechnologies::is_is_down_Set() const{
    return m_is_down_isSet;
}

bool OAIPaymenTechnologies::is_is_down_Valid() const{
    return m_is_down_isValid;
}

QString OAIPaymenTechnologies::getMerchantCategoryCode() const {
    return m_merchant_category_code;
}
void OAIPaymenTechnologies::setMerchantCategoryCode(const QString &merchant_category_code) {
    m_merchant_category_code = merchant_category_code;
    m_merchant_category_code_isSet = true;
}

bool OAIPaymenTechnologies::is_merchant_category_code_Set() const{
    return m_merchant_category_code_isSet;
}

bool OAIPaymenTechnologies::is_merchant_category_code_Valid() const{
    return m_merchant_category_code_isValid;
}

OAIPaymentMethod OAIPaymenTechnologies::getMethod() const {
    return m_method;
}
void OAIPaymenTechnologies::setMethod(const OAIPaymentMethod &method) {
    m_method = method;
    m_method_isSet = true;
}

bool OAIPaymenTechnologies::is_method_Set() const{
    return m_method_isSet;
}

bool OAIPaymenTechnologies::is_method_Valid() const{
    return m_method_isValid;
}

double OAIPaymenTechnologies::getMonthlyLimit() const {
    return m_monthly_limit;
}
void OAIPaymenTechnologies::setMonthlyLimit(const double &monthly_limit) {
    m_monthly_limit = monthly_limit;
    m_monthly_limit_isSet = true;
}

bool OAIPaymenTechnologies::is_monthly_limit_Set() const{
    return m_monthly_limit_isSet;
}

bool OAIPaymenTechnologies::is_monthly_limit_Valid() const{
    return m_monthly_limit_isValid;
}

QString OAIPaymenTechnologies::getOrganizationId() const {
    return m_organization_id;
}
void OAIPaymenTechnologies::setOrganizationId(const QString &organization_id) {
    m_organization_id = organization_id;
    m_organization_id_isSet = true;
}

bool OAIPaymenTechnologies::is_organization_id_Set() const{
    return m_organization_id_isSet;
}

bool OAIPaymenTechnologies::is_organization_id_Valid() const{
    return m_organization_id_isValid;
}

QList<OAIPaymentCardBrand> OAIPaymenTechnologies::getPaymentCardSchemes() const {
    return m_payment_card_schemes;
}
void OAIPaymenTechnologies::setPaymentCardSchemes(const QList<OAIPaymentCardBrand> &payment_card_schemes) {
    m_payment_card_schemes = payment_card_schemes;
    m_payment_card_schemes_isSet = true;
}

bool OAIPaymenTechnologies::is_payment_card_schemes_Set() const{
    return m_payment_card_schemes_isSet;
}

bool OAIPaymenTechnologies::is_payment_card_schemes_Valid() const{
    return m_payment_card_schemes_isValid;
}

bool OAIPaymenTechnologies::isReconciliationWindowEnabled() const {
    return m_reconciliation_window_enabled;
}
void OAIPaymenTechnologies::setReconciliationWindowEnabled(const bool &reconciliation_window_enabled) {
    m_reconciliation_window_enabled = reconciliation_window_enabled;
    m_reconciliation_window_enabled_isSet = true;
}

bool OAIPaymenTechnologies::is_reconciliation_window_enabled_Set() const{
    return m_reconciliation_window_enabled_isSet;
}

bool OAIPaymenTechnologies::is_reconciliation_window_enabled_Valid() const{
    return m_reconciliation_window_enabled_isValid;
}

qint32 OAIPaymenTechnologies::getReconciliationWindowTtl() const {
    return m_reconciliation_window_ttl;
}
void OAIPaymenTechnologies::setReconciliationWindowTtl(const qint32 &reconciliation_window_ttl) {
    m_reconciliation_window_ttl = reconciliation_window_ttl;
    m_reconciliation_window_ttl_isSet = true;
}

bool OAIPaymenTechnologies::is_reconciliation_window_ttl_Set() const{
    return m_reconciliation_window_ttl_isSet;
}

bool OAIPaymenTechnologies::is_reconciliation_window_ttl_Valid() const{
    return m_reconciliation_window_ttl_isValid;
}

QString OAIPaymenTechnologies::getStatus() const {
    return m_status;
}
void OAIPaymenTechnologies::setStatus(const QString &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIPaymenTechnologies::is_status_Set() const{
    return m_status_isSet;
}

bool OAIPaymenTechnologies::is_status_Valid() const{
    return m_status_isValid;
}

bool OAIPaymenTechnologies::isSticky() const {
    return m_sticky;
}
void OAIPaymenTechnologies::setSticky(const bool &sticky) {
    m_sticky = sticky;
    m_sticky_isSet = true;
}

bool OAIPaymenTechnologies::is_sticky_Set() const{
    return m_sticky_isSet;
}

bool OAIPaymenTechnologies::is_sticky_Valid() const{
    return m_sticky_isValid;
}

bool OAIPaymenTechnologies::isThreeDSecure() const {
    return m_three_d_secure;
}
void OAIPaymenTechnologies::setThreeDSecure(const bool &three_d_secure) {
    m_three_d_secure = three_d_secure;
    m_three_d_secure_isSet = true;
}

bool OAIPaymenTechnologies::is_three_d_secure_Set() const{
    return m_three_d_secure_isSet;
}

bool OAIPaymenTechnologies::is_three_d_secure_Valid() const{
    return m_three_d_secure_isValid;
}

qint32 OAIPaymenTechnologies::getTimeout() const {
    return m_timeout;
}
void OAIPaymenTechnologies::setTimeout(const qint32 &timeout) {
    m_timeout = timeout;
    m_timeout_isSet = true;
}

bool OAIPaymenTechnologies::is_timeout_Set() const{
    return m_timeout_isSet;
}

bool OAIPaymenTechnologies::is_timeout_Valid() const{
    return m_timeout_isValid;
}

QString OAIPaymenTechnologies::getToken() const {
    return m_token;
}
void OAIPaymenTechnologies::setToken(const QString &token) {
    m_token = token;
    m_token_isSet = true;
}

bool OAIPaymenTechnologies::is_token_Set() const{
    return m_token_isSet;
}

bool OAIPaymenTechnologies::is_token_Valid() const{
    return m_token_isValid;
}

QDateTime OAIPaymenTechnologies::getUpdatedTime() const {
    return m_updated_time;
}
void OAIPaymenTechnologies::setUpdatedTime(const QDateTime &updated_time) {
    m_updated_time = updated_time;
    m_updated_time_isSet = true;
}

bool OAIPaymenTechnologies::is_updated_time_Set() const{
    return m_updated_time_isSet;
}

bool OAIPaymenTechnologies::is_updated_time_Valid() const{
    return m_updated_time_isValid;
}

OAIPaymenTechnologies_allOf_credentials OAIPaymenTechnologies::getCredentials() const {
    return m_credentials;
}
void OAIPaymenTechnologies::setCredentials(const OAIPaymenTechnologies_allOf_credentials &credentials) {
    m_credentials = credentials;
    m_credentials_isSet = true;
}

bool OAIPaymenTechnologies::is_credentials_Set() const{
    return m_credentials_isSet;
}

bool OAIPaymenTechnologies::is_credentials_Valid() const{
    return m_credentials_isValid;
}

OAIPaymenTechnologies_allOf_settings OAIPaymenTechnologies::getSettings() const {
    return m_settings;
}
void OAIPaymenTechnologies::setSettings(const OAIPaymenTechnologies_allOf_settings &settings) {
    m_settings = settings;
    m_settings_isSet = true;
}

bool OAIPaymenTechnologies::is_settings_Set() const{
    return m_settings_isSet;
}

bool OAIPaymenTechnologies::is_settings_Valid() const{
    return m_settings_isValid;
}

bool OAIPaymenTechnologies::isSet() const {
...
bool OAIPaymenTechnologies::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_accepted_currencies_isValid && m_gateway_name_isValid && m_method_isValid && m_credentials_isValid && true;
}
