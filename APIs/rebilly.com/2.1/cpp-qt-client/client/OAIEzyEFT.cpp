...
OAIEzyEFT::OAIEzyEFT(QString json) {
...
void OAIEzyEFT::initializeModel() {
...
void OAIEzyEFT::fromJson(QString jsonString) {
...
void OAIEzyEFT::fromJsonObject(QJsonObject json) {
...
QString OAIEzyEFT::asJson() const {
...
QJsonObject OAIEzyEFT::asJsonObject() const {
    QJsonObject obj;
    if (m__links.size() > 0) {
...
QList<OAIGatewayAccount__links_inner> OAIEzyEFT::getLinks() const {
    return m__links;
}
void OAIEzyEFT::setLinks(const QList<OAIGatewayAccount__links_inner> &_links) {
    m__links = _links;
    m__links_isSet = true;
}

bool OAIEzyEFT::is__links_Set() const{
    return m__links_isSet;
}

bool OAIEzyEFT::is__links_Valid() const{
    return m__links_isValid;
}

QList<QString> OAIEzyEFT::getAcceptedCurrencies() const {
    return m_accepted_currencies;
}
void OAIEzyEFT::setAcceptedCurrencies(const QList<QString> &accepted_currencies) {
    m_accepted_currencies = accepted_currencies;
    m_accepted_currencies_isSet = true;
}

bool OAIEzyEFT::is_accepted_currencies_Set() const{
    return m_accepted_currencies_isSet;
}

bool OAIEzyEFT::is_accepted_currencies_Valid() const{
    return m_accepted_currencies_isValid;
}

OAIAcquirerName OAIEzyEFT::getAcquirerName() const {
    return m_acquirer_name;
}
void OAIEzyEFT::setAcquirerName(const OAIAcquirerName &acquirer_name) {
    m_acquirer_name = acquirer_name;
    m_acquirer_name_isSet = true;
}

bool OAIEzyEFT::is_acquirer_name_Set() const{
    return m_acquirer_name_isSet;
}

bool OAIEzyEFT::is_acquirer_name_Valid() const{
    return m_acquirer_name_isValid;
}

QString OAIEzyEFT::getAdditionalFilters() const {
    return m_additional_filters;
}
void OAIEzyEFT::setAdditionalFilters(const QString &additional_filters) {
    m_additional_filters = additional_filters;
    m_additional_filters_isSet = true;
}

bool OAIEzyEFT::is_additional_filters_Set() const{
    return m_additional_filters_isSet;
}

bool OAIEzyEFT::is_additional_filters_Valid() const{
    return m_additional_filters_isValid;
}

qint32 OAIEzyEFT::getApprovalWindowTtl() const {
    return m_approval_window_ttl;
}
void OAIEzyEFT::setApprovalWindowTtl(const qint32 &approval_window_ttl) {
    m_approval_window_ttl = approval_window_ttl;
    m_approval_window_ttl_isSet = true;
}

bool OAIEzyEFT::is_approval_window_ttl_Set() const{
    return m_approval_window_ttl_isSet;
}

bool OAIEzyEFT::is_approval_window_ttl_Valid() const{
    return m_approval_window_ttl_isValid;
}

QString OAIEzyEFT::getCityField() const {
    return m_city_field;
}
void OAIEzyEFT::setCityField(const QString &city_field) {
    m_city_field = city_field;
    m_city_field_isSet = true;
}

bool OAIEzyEFT::is_city_field_Set() const{
    return m_city_field_isSet;
}

bool OAIEzyEFT::is_city_field_Valid() const{
    return m_city_field_isValid;
}

QDateTime OAIEzyEFT::getCreatedTime() const {
    return m_created_time;
}
void OAIEzyEFT::setCreatedTime(const QDateTime &created_time) {
    m_created_time = created_time;
    m_created_time_isSet = true;
}

bool OAIEzyEFT::is_created_time_Set() const{
    return m_created_time_isSet;
}

bool OAIEzyEFT::is_created_time_Valid() const{
    return m_created_time_isValid;
}

QString OAIEzyEFT::getDccForceCurrency() const {
    return m_dcc_force_currency;
}
void OAIEzyEFT::setDccForceCurrency(const QString &dcc_force_currency) {
    m_dcc_force_currency = dcc_force_currency;
    m_dcc_force_currency_isSet = true;
}

bool OAIEzyEFT::is_dcc_force_currency_Set() const{
    return m_dcc_force_currency_isSet;
}

bool OAIEzyEFT::is_dcc_force_currency_Valid() const{
    return m_dcc_force_currency_isValid;
}

qint32 OAIEzyEFT::getDccMarkup() const {
    return m_dcc_markup;
}
void OAIEzyEFT::setDccMarkup(const qint32 &dcc_markup) {
    m_dcc_markup = dcc_markup;
    m_dcc_markup_isSet = true;
}

bool OAIEzyEFT::is_dcc_markup_Set() const{
    return m_dcc_markup_isSet;
}

bool OAIEzyEFT::is_dcc_markup_Valid() const{
    return m_dcc_markup_isValid;
}

QString OAIEzyEFT::getDescriptor() const {
    return m_descriptor;
}
void OAIEzyEFT::setDescriptor(const QString &descriptor) {
    m_descriptor = descriptor;
    m_descriptor_isSet = true;
}

bool OAIEzyEFT::is_descriptor_Set() const{
    return m_descriptor_isSet;
}

bool OAIEzyEFT::is_descriptor_Valid() const{
    return m_descriptor_isValid;
}

OAIDigitalWallets OAIEzyEFT::getDigitalWallets() const {
    return m_digital_wallets;
}
void OAIEzyEFT::setDigitalWallets(const OAIDigitalWallets &digital_wallets) {
    m_digital_wallets = digital_wallets;
    m_digital_wallets_isSet = true;
}

bool OAIEzyEFT::is_digital_wallets_Set() const{
    return m_digital_wallets_isSet;
}

bool OAIEzyEFT::is_digital_wallets_Valid() const{
    return m_digital_wallets_isValid;
}

bool OAIEzyEFT::isDynamicDescriptor() const {
    return m_dynamic_descriptor;
}
void OAIEzyEFT::setDynamicDescriptor(const bool &dynamic_descriptor) {
    m_dynamic_descriptor = dynamic_descriptor;
    m_dynamic_descriptor_isSet = true;
}

bool OAIEzyEFT::is_dynamic_descriptor_Set() const{
    return m_dynamic_descriptor_isSet;
}

bool OAIEzyEFT::is_dynamic_descriptor_Valid() const{
    return m_dynamic_descriptor_isValid;
}

QList<QString> OAIEzyEFT::getExcludedDccQuoteCurrencies() const {
    return m_excluded_dcc_quote_currencies;
}
void OAIEzyEFT::setExcludedDccQuoteCurrencies(const QList<QString> &excluded_dcc_quote_currencies) {
    m_excluded_dcc_quote_currencies = excluded_dcc_quote_currencies;
    m_excluded_dcc_quote_currencies_isSet = true;
}

bool OAIEzyEFT::is_excluded_dcc_quote_currencies_Set() const{
    return m_excluded_dcc_quote_currencies_isSet;
}

bool OAIEzyEFT::is_excluded_dcc_quote_currencies_Valid() const{
    return m_excluded_dcc_quote_currencies_isValid;
}

OAIGatewayName OAIEzyEFT::getGatewayName() const {
    return m_gateway_name;
}
void OAIEzyEFT::setGatewayName(const OAIGatewayName &gateway_name) {
    m_gateway_name = gateway_name;
    m_gateway_name_isSet = true;
}

bool OAIEzyEFT::is_gateway_name_Set() const{
    return m_gateway_name_isSet;
}

bool OAIEzyEFT::is_gateway_name_Valid() const{
    return m_gateway_name_isValid;
}

QString OAIEzyEFT::getId() const {
    return m_id;
}
void OAIEzyEFT::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIEzyEFT::is_id_Set() const{
    return m_id_isSet;
}

bool OAIEzyEFT::is_id_Valid() const{
    return m_id_isValid;
}

bool OAIEzyEFT::isIsDown() const {
    return m_is_down;
}
void OAIEzyEFT::setIsDown(const bool &is_down) {
    m_is_down = is_down;
    m_is_down_isSet = true;
}

bool OAIEzyEFT::is_is_down_Set() const{
    return m_is_down_isSet;
}

bool OAIEzyEFT::is_is_down_Valid() const{
    return m_is_down_isValid;
}

QString OAIEzyEFT::getMerchantCategoryCode() const {
    return m_merchant_category_code;
}
void OAIEzyEFT::setMerchantCategoryCode(const QString &merchant_category_code) {
    m_merchant_category_code = merchant_category_code;
    m_merchant_category_code_isSet = true;
}

bool OAIEzyEFT::is_merchant_category_code_Set() const{
    return m_merchant_category_code_isSet;
}

bool OAIEzyEFT::is_merchant_category_code_Valid() const{
    return m_merchant_category_code_isValid;
}

OAIPaymentMethod OAIEzyEFT::getMethod() const {
    return m_method;
}
void OAIEzyEFT::setMethod(const OAIPaymentMethod &method) {
    m_method = method;
    m_method_isSet = true;
}

bool OAIEzyEFT::is_method_Set() const{
    return m_method_isSet;
}

bool OAIEzyEFT::is_method_Valid() const{
    return m_method_isValid;
}

double OAIEzyEFT::getMonthlyLimit() const {
    return m_monthly_limit;
}
void OAIEzyEFT::setMonthlyLimit(const double &monthly_limit) {
    m_monthly_limit = monthly_limit;
    m_monthly_limit_isSet = true;
}

bool OAIEzyEFT::is_monthly_limit_Set() const{
    return m_monthly_limit_isSet;
}

bool OAIEzyEFT::is_monthly_limit_Valid() const{
    return m_monthly_limit_isValid;
}

QString OAIEzyEFT::getOrganizationId() const {
    return m_organization_id;
}
void OAIEzyEFT::setOrganizationId(const QString &organization_id) {
    m_organization_id = organization_id;
    m_organization_id_isSet = true;
}

bool OAIEzyEFT::is_organization_id_Set() const{
    return m_organization_id_isSet;
}

bool OAIEzyEFT::is_organization_id_Valid() const{
    return m_organization_id_isValid;
}

QList<OAIPaymentCardBrand> OAIEzyEFT::getPaymentCardSchemes() const {
    return m_payment_card_schemes;
}
void OAIEzyEFT::setPaymentCardSchemes(const QList<OAIPaymentCardBrand> &payment_card_schemes) {
    m_payment_card_schemes = payment_card_schemes;
    m_payment_card_schemes_isSet = true;
}

bool OAIEzyEFT::is_payment_card_schemes_Set() const{
    return m_payment_card_schemes_isSet;
}

bool OAIEzyEFT::is_payment_card_schemes_Valid() const{
    return m_payment_card_schemes_isValid;
}

bool OAIEzyEFT::isReconciliationWindowEnabled() const {
    return m_reconciliation_window_enabled;
}
void OAIEzyEFT::setReconciliationWindowEnabled(const bool &reconciliation_window_enabled) {
    m_reconciliation_window_enabled = reconciliation_window_enabled;
    m_reconciliation_window_enabled_isSet = true;
}

bool OAIEzyEFT::is_reconciliation_window_enabled_Set() const{
    return m_reconciliation_window_enabled_isSet;
}

bool OAIEzyEFT::is_reconciliation_window_enabled_Valid() const{
    return m_reconciliation_window_enabled_isValid;
}

qint32 OAIEzyEFT::getReconciliationWindowTtl() const {
    return m_reconciliation_window_ttl;
}
void OAIEzyEFT::setReconciliationWindowTtl(const qint32 &reconciliation_window_ttl) {
    m_reconciliation_window_ttl = reconciliation_window_ttl;
    m_reconciliation_window_ttl_isSet = true;
}

bool OAIEzyEFT::is_reconciliation_window_ttl_Set() const{
    return m_reconciliation_window_ttl_isSet;
}

bool OAIEzyEFT::is_reconciliation_window_ttl_Valid() const{
    return m_reconciliation_window_ttl_isValid;
}

QString OAIEzyEFT::getStatus() const {
    return m_status;
}
void OAIEzyEFT::setStatus(const QString &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIEzyEFT::is_status_Set() const{
    return m_status_isSet;
}

bool OAIEzyEFT::is_status_Valid() const{
    return m_status_isValid;
}

bool OAIEzyEFT::isSticky() const {
    return m_sticky;
}
void OAIEzyEFT::setSticky(const bool &sticky) {
    m_sticky = sticky;
    m_sticky_isSet = true;
}

bool OAIEzyEFT::is_sticky_Set() const{
    return m_sticky_isSet;
}

bool OAIEzyEFT::is_sticky_Valid() const{
    return m_sticky_isValid;
}

bool OAIEzyEFT::isThreeDSecure() const {
    return m_three_d_secure;
}
void OAIEzyEFT::setThreeDSecure(const bool &three_d_secure) {
    m_three_d_secure = three_d_secure;
    m_three_d_secure_isSet = true;
}

bool OAIEzyEFT::is_three_d_secure_Set() const{
    return m_three_d_secure_isSet;
}

bool OAIEzyEFT::is_three_d_secure_Valid() const{
    return m_three_d_secure_isValid;
}

qint32 OAIEzyEFT::getTimeout() const {
    return m_timeout;
}
void OAIEzyEFT::setTimeout(const qint32 &timeout) {
    m_timeout = timeout;
    m_timeout_isSet = true;
}

bool OAIEzyEFT::is_timeout_Set() const{
    return m_timeout_isSet;
}

bool OAIEzyEFT::is_timeout_Valid() const{
    return m_timeout_isValid;
}

QString OAIEzyEFT::getToken() const {
    return m_token;
}
void OAIEzyEFT::setToken(const QString &token) {
    m_token = token;
    m_token_isSet = true;
}

bool OAIEzyEFT::is_token_Set() const{
    return m_token_isSet;
}

bool OAIEzyEFT::is_token_Valid() const{
    return m_token_isValid;
}

QDateTime OAIEzyEFT::getUpdatedTime() const {
    return m_updated_time;
}
void OAIEzyEFT::setUpdatedTime(const QDateTime &updated_time) {
    m_updated_time = updated_time;
    m_updated_time_isSet = true;
}

bool OAIEzyEFT::is_updated_time_Set() const{
    return m_updated_time_isSet;
}

bool OAIEzyEFT::is_updated_time_Valid() const{
    return m_updated_time_isValid;
}

OAIEzyEFT_allOf_credentials OAIEzyEFT::getCredentials() const {
    return m_credentials;
}
void OAIEzyEFT::setCredentials(const OAIEzyEFT_allOf_credentials &credentials) {
    m_credentials = credentials;
    m_credentials_isSet = true;
}

bool OAIEzyEFT::is_credentials_Set() const{
    return m_credentials_isSet;
}

bool OAIEzyEFT::is_credentials_Valid() const{
    return m_credentials_isValid;
}

bool OAIEzyEFT::isSet() const {
