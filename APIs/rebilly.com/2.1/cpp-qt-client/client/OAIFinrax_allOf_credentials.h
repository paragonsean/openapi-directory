...
/*
 * OAIFinrax_allOf_credentials.h
 *
 * Finrax credentials object.
 */

#ifndef OAIFinrax_allOf_credentials_H
#define OAIFinrax_allOf_credentials_H
...
class OAIFinrax_allOf_credentials : public OAIObject {
public:
    OAIFinrax_allOf_credentials();
    OAIFinrax_allOf_credentials(QString json);
    ~OAIFinrax_allOf_credentials() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFinrax_allOf_credentials)

#endif // OAIFinrax_allOf_credentials_H
