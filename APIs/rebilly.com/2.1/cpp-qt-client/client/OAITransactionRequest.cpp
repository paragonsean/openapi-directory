...
double OAITransactionRequest::getAmount() const {
    return m_amount;
}
void OAITransactionRequest::setAmount(const double &amount) {
    m_amount = amount;
    m_amount_isSet = true;
}

bool OAITransactionRequest::is_amount_Set() const{
    return m_amount_isSet;
}

bool OAITransactionRequest::is_amount_Valid() const{
    return m_amount_isValid;
}

OAIContactObject OAITransactionRequest::getBillingAddress() const {
    return m_billing_address;
}
void OAITransactionRequest::setBillingAddress(const OAIContactObject &billing_address) {
    m_billing_address = billing_address;
    m_billing_address_isSet = true;
}

bool OAITransactionRequest::is_billing_address_Set() const{
    return m_billing_address_isSet;
}

bool OAITransactionRequest::is_billing_address_Valid() const{
    return m_billing_address_isValid;
}

QString OAITransactionRequest::getCurrency() const {
    return m_currency;
}
void OAITransactionRequest::setCurrency(const QString &currency) {
    m_currency = currency;
    m_currency_isSet = true;
}

bool OAITransactionRequest::is_currency_Set() const{
    return m_currency_isSet;
}

bool OAITransactionRequest::is_currency_Valid() const{
    return m_currency_isValid;
}

OAIObject OAITransactionRequest::getCustomFields() const {
    return m_custom_fields;
}
void OAITransactionRequest::setCustomFields(const OAIObject &custom_fields) {
    m_custom_fields = custom_fields;
    m_custom_fields_isSet = true;
}

bool OAITransactionRequest::is_custom_fields_Set() const{
    return m_custom_fields_isSet;
}

bool OAITransactionRequest::is_custom_fields_Valid() const{
    return m_custom_fields_isValid;
}

QString OAITransactionRequest::getCustomerId() const {
    return m_customer_id;
}
void OAITransactionRequest::setCustomerId(const QString &customer_id) {
    m_customer_id = customer_id;
    m_customer_id_isSet = true;
}

bool OAITransactionRequest::is_customer_id_Set() const{
    return m_customer_id_isSet;
}

bool OAITransactionRequest::is_customer_id_Valid() const{
    return m_customer_id_isValid;
}

QString OAITransactionRequest::getDescription() const {
    return m_description;
}
void OAITransactionRequest::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAITransactionRequest::is_description_Set() const{
    return m_description_isSet;
}

bool OAITransactionRequest::is_description_Valid() const{
    return m_description_isValid;
}

QString OAITransactionRequest::getGatewayAccountId() const {
    return m_gateway_account_id;
}
void OAITransactionRequest::setGatewayAccountId(const QString &gateway_account_id) {
    m_gateway_account_id = gateway_account_id;
    m_gateway_account_id_isSet = true;
}

bool OAITransactionRequest::is_gateway_account_id_Set() const{
    return m_gateway_account_id_isSet;
}

bool OAITransactionRequest::is_gateway_account_id_Valid() const{
    return m_gateway_account_id_isValid;
}

QList<QString> OAITransactionRequest::getInvoiceIds() const {
    return m_invoice_ids;
}
void OAITransactionRequest::setInvoiceIds(const QList<QString> &invoice_ids) {
    m_invoice_ids = invoice_ids;
    m_invoice_ids_isSet = true;
}

bool OAITransactionRequest::is_invoice_ids_Set() const{
    return m_invoice_ids_isSet;
}

bool OAITransactionRequest::is_invoice_ids_Valid() const{
    return m_invoice_ids_isValid;
}

bool OAITransactionRequest::isIsMerchantInitiated() const {
    return m_is_merchant_initiated;
}
void OAITransactionRequest::setIsMerchantInitiated(const bool &is_merchant_initiated) {
    m_is_merchant_initiated = is_merchant_initiated;
    m_is_merchant_initiated_isSet = true;
}

bool OAITransactionRequest::is_is_merchant_initiated_Set() const{
    return m_is_merchant_initiated_isSet;
}

bool OAITransactionRequest::is_is_merchant_initiated_Valid() const{
    return m_is_merchant_initiated_isValid;
}

bool OAITransactionRequest::isIsProcessedOutside() const {
    return m_is_processed_outside;
}
void OAITransactionRequest::setIsProcessedOutside(const bool &is_processed_outside) {
    m_is_processed_outside = is_processed_outside;
    m_is_processed_outside_isSet = true;
}

bool OAITransactionRequest::is_is_processed_outside_Set() const{
    return m_is_processed_outside_isSet;
}

bool OAITransactionRequest::is_is_processed_outside_Valid() const{
    return m_is_processed_outside_isValid;
}

QString OAITransactionRequest::getNotificationUrl() const {
    return m_notification_url;
}
void OAITransactionRequest::setNotificationUrl(const QString &notification_url) {
    m_notification_url = notification_url;
    m_notification_url_isSet = true;
}

bool OAITransactionRequest::is_notification_url_Set() const{
    return m_notification_url_isSet;
}

bool OAITransactionRequest::is_notification_url_Valid() const{
    return m_notification_url_isValid;
}

OAIPaymentInstruction OAITransactionRequest::getPaymentInstruction() const {
    return m_payment_instruction;
}
void OAITransactionRequest::setPaymentInstruction(const OAIPaymentInstruction &payment_instruction) {
    m_payment_instruction = payment_instruction;
    m_payment_instruction_isSet = true;
}

bool OAITransactionRequest::is_payment_instruction_Set() const{
    return m_payment_instruction_isSet;
}

bool OAITransactionRequest::is_payment_instruction_Valid() const{
    return m_payment_instruction_isValid;
}

OAIPaymentInstrument OAITransactionRequest::getPaymentInstrument() const {
    return m_payment_instrument;
}
void OAITransactionRequest::setPaymentInstrument(const OAIPaymentInstrument &payment_instrument) {
    m_payment_instrument = payment_instrument;
    m_payment_instrument_isSet = true;
}

bool OAITransactionRequest::is_payment_instrument_Set() const{
    return m_payment_instrument_isSet;
}

bool OAITransactionRequest::is_payment_instrument_Valid() const{
    return m_payment_instrument_isValid;
}

QDateTime OAITransactionRequest::getProcessedTime() const {
    return m_processed_time;
}
void OAITransactionRequest::setProcessedTime(const QDateTime &processed_time) {
    m_processed_time = processed_time;
    m_processed_time_isSet = true;
}

bool OAITransactionRequest::is_processed_time_Set() const{
    return m_processed_time_isSet;
}

bool OAITransactionRequest::is_processed_time_Valid() const{
    return m_processed_time_isValid;
}

QString OAITransactionRequest::getRedirectUrl() const {
    return m_redirect_url;
}
void OAITransactionRequest::setRedirectUrl(const QString &redirect_url) {
    m_redirect_url = redirect_url;
    m_redirect_url_isSet = true;
}

bool OAITransactionRequest::is_redirect_url_Set() const{
    return m_redirect_url_isSet;
}

bool OAITransactionRequest::is_redirect_url_Valid() const{
    return m_redirect_url_isValid;
}

QString OAITransactionRequest::getRequestId() const {
    return m_request_id;
}
void OAITransactionRequest::setRequestId(const QString &request_id) {
    m_request_id = request_id;
    m_request_id_isSet = true;
}

bool OAITransactionRequest::is_request_id_Set() const{
    return m_request_id_isSet;
}

bool OAITransactionRequest::is_request_id_Valid() const{
    return m_request_id_isValid;
}

OAIRiskMetadata OAITransactionRequest::getRiskMetadata() const {
    return m_risk_metadata;
}
void OAITransactionRequest::setRiskMetadata(const OAIRiskMetadata &risk_metadata) {
    m_risk_metadata = risk_metadata;
    m_risk_metadata_isSet = true;
}

bool OAITransactionRequest::is_risk_metadata_Set() const{
    return m_risk_metadata_isSet;
}

bool OAITransactionRequest::is_risk_metadata_Valid() const{
    return m_risk_metadata_isValid;
}

QString OAITransactionRequest::getWebsiteId() const {
    return m_website_id;
}
void OAITransactionRequest::setWebsiteId(const QString &website_id) {
    m_website_id = website_id;
    m_website_id_isSet = true;
}

bool OAITransactionRequest::is_website_id_Set() const{
    return m_website_id_isSet;
}

bool OAITransactionRequest::is_website_id_Valid() const{
    return m_website_id_isValid;
}

QString OAITransactionRequest::getType() const {
    return m_type;
}
void OAITransactionRequest::setType(const QString &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAITransactionRequest::is_type_Set() const{
    return m_type_isSet;
}

bool OAITransactionRequest::is_type_Valid() const{
...
bool OAITransactionRequest::isValid() const {
    ...
    return m_amount_isValid && m_currency_isValid && m_customer_id_isValid && m_website_id_isValid && m_type_isValid && true;
}
