...
#ifndef OAICoinPayments_H
#define OAICoinPayments_H
...
class OAICoinPayments_allOf_credentials;

class OAICoinPayments : public OAIObject {
public:
    OAICoinPayments();
    OAICoinPayments(QString json);
    ~OAICoinPayments() override;
    ...
    OAICoinPayments_allOf_credentials getCredentials() const;
    void setCredentials(const OAICoinPayments_allOf_credentials &credentials);
...
private:
    ...
    OAICoinPayments_allOf_credentials m_credentials;
...
Q_DECLARE_METATYPE(OpenAPI::OAICoinPayments)

#endif // OAICoinPayments_H
