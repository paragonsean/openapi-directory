...
OAIPayULatam::OAIPayULatam(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPayULatam::OAIPayULatam() {
    this->initializeModel();
}

OAIPayULatam::~OAIPayULatam() {}

void OAIPayULatam::initializeModel() {
...
void OAIPayULatam::fromJson(QString jsonString) {
...
void OAIPayULatam::fromJsonObject(QJsonObject json) {
...
QString OAIPayULatam::asJson() const {
...
QJsonObject OAIPayULatam::asJsonObject() const {
    QJsonObject obj;
    if (m__links.size() > 0) {
...
QList<OAIGatewayAccount__links_inner> OAIPayULatam::getLinks() const {
    return m__links;
}
void OAIPayULatam::setLinks(const QList<OAIGatewayAccount__links_inner> &_links) {
    m__links = _links;
    m__links_isSet = true;
}

bool OAIPayULatam::is__links_Set() const{
    return m__links_isSet;
}

bool OAIPayULatam::is__links_Valid() const{
    return m__links_isValid;
}

QList<QString> OAIPayULatam::getAcceptedCurrencies() const {
    return m_accepted_currencies;
}
void OAIPayULatam::setAcceptedCurrencies(const QList<QString> &accepted_currencies) {
    m_accepted_currencies = accepted_currencies;
    m_accepted_currencies_isSet = true;
}

bool OAIPayULatam::is_accepted_currencies_Set() const{
    return m_accepted_currencies_isSet;
}

bool OAIPayULatam::is_accepted_currencies_Valid() const{
    return m_accepted_currencies_isValid;
}

OAIAcquirerName OAIPayULatam::getAcquirerName() const {
    return m_acquirer_name;
}
void OAIPayULatam::setAcquirerName(const OAIAcquirerName &acquirer_name) {
    m_acquirer_name = acquirer_name;
    m_acquirer_name_isSet = true;
}

bool OAIPayULatam::is_acquirer_name_Set() const{
    return m_acquirer_name_isSet;
}

bool OAIPayULatam::is_acquirer_name_Valid() const{
    return m_acquirer_name_isValid;
}

QString OAIPayULatam::getAdditionalFilters() const {
    return m_additional_filters;
}
void OAIPayULatam::setAdditionalFilters(const QString &additional_filters) {
    m_additional_filters = additional_filters;
    m_additional_filters_isSet = true;
}

bool OAIPayULatam::is_additional_filters_Set() const{
    return m_additional_filters_isSet;
}

bool OAIPayULatam::is_additional_filters_Valid() const{
    return m_additional_filters_isValid;
}

qint32 OAIPayULatam::getApprovalWindowTtl() const {
    return m_approval_window_ttl;
}
void OAIPayULatam::setApprovalWindowTtl(const qint32 &approval_window_ttl) {
    m_approval_window_ttl = approval_window_ttl;
    m_approval_window_ttl_isSet = true;
}

bool OAIPayULatam::is_approval_window_ttl_Set() const{
    return m_approval_window_ttl_isSet;
}

bool OAIPayULatam::is_approval_window_ttl_Valid() const{
    return m_approval_window_ttl_isValid;
}

QString OAIPayULatam::getCityField() const {
    return m_city_field;
}
void OAIPayULatam::setCityField(const QString &city_field) {
    m_city_field = city_field;
    m_city_field_isSet = true;
}

bool OAIPayULatam::is_city_field_Set() const{
    return m_city_field_isSet;
}

bool OAIPayULatam::is_city_field_Valid() const{
    return m_city_field_isValid;
}

QDateTime OAIPayULatam::getCreatedTime() const {
    return m_created_time;
}
void OAIPayULatam::setCreatedTime(const QDateTime &created_time) {
    m_created_time = created_time;
    m_created_time_isSet = true;
}

bool OAIPayULatam::is_created_time_Set() const{
    return m_created_time_isSet;
}

bool OAIPayULatam::is_created_time_Valid() const{
    return m_created_time_isValid;
}

QString OAIPayULatam::getDccForceCurrency() const {
    return m_dcc_force_currency;
}
void OAIPayULatam::setDccForceCurrency(const QString &dcc_force_currency) {
    m_dcc_force_currency = dcc_force_currency;
    m_dcc_force_currency_isSet = true;
}

bool OAIPayULatam::is_dcc_force_currency_Set() const{
    return m_dcc_force_currency_isSet;
}

bool OAIPayULatam::is_dcc_force_currency_Valid() const{
    return m_dcc_force_currency_isValid;
}

qint32 OAIPayULatam::getDccMarkup() const {
    return m_dcc_markup;
}
void OAIPayULatam::setDccMarkup(const qint32 &dcc_markup) {
    m_dcc_markup = dcc_markup;
    m_dcc_markup_isSet = true;
}

bool OAIPayULatam::is_dcc_markup_Set() const{
    return m_dcc_markup_isSet;
}

bool OAIPayULatam::is_dcc_markup_Valid() const{
    return m_dcc_markup_isValid;
}

QString OAIPayULatam::getDescriptor() const {
    return m_descriptor;
}
void OAIPayULatam::setDescriptor(const QString &descriptor) {
    m_descriptor = descriptor;
    m_descriptor_isSet = true;
}

bool OAIPayULatam::is_descriptor_Set() const{
    return m_descriptor_isSet;
}

bool OAIPayULatam::is_descriptor_Valid() const{
    return m_descriptor_isValid;
}

OAIDigitalWallets OAIPayULatam::getDigitalWallets() const {
    return m_digital_wallets;
}
void OAIPayULatam::setDigitalWallets(const OAIDigitalWallets &digital_wallets) {
    m_digital_wallets = digital_wallets;
    m_digital_wallets_isSet = true;
}

bool OAIPayULatam::is_digital_wallets_Set() const{
    return m_digital_wallets_isSet;
}

bool OAIPayULatam::is_digital_wallets_Valid() const{
    return m_digital_wallets_isValid;
}

bool OAIPayULatam::isDynamicDescriptor() const {
    return m_dynamic_descriptor;
}
void OAIPayULatam::setDynamicDescriptor(const bool &dynamic_descriptor) {
    m_dynamic_descriptor = dynamic_descriptor;
    m_dynamic_descriptor_isSet = true;
}

bool OAIPayULatam::is_dynamic_descriptor_Set() const{
    return m_dynamic_descriptor_isSet;
}

bool OAIPayULatam::is_dynamic_descriptor_Valid() const{
    return m_dynamic_descriptor_isValid;
}

QList<QString> OAIPayULatam::getExcludedDccQuoteCurrencies() const {
    return m_excluded_dcc_quote_currencies;
}
void OAIPayULatam::setExcludedDccQuoteCurrencies(const QList<QString> &excluded_dcc_quote_currencies) {
    m_excluded_dcc_quote_currencies = excluded_dcc_quote_currencies;
    m_excluded_dcc_quote_currencies_isSet = true;
}

bool OAIPayULatam::is_excluded_dcc_quote_currencies_Set() const{
    return m_excluded_dcc_quote_currencies_isSet;
}

bool OAIPayULatam::is_excluded_dcc_quote_currencies_Valid() const{
    return m_excluded_dcc_quote_currencies_isValid;
}

OAIGatewayName OAIPayULatam::getGatewayName() const {
    return m_gateway_name;
}
void OAIPayULatam::setGatewayName(const OAIGatewayName &gateway_name) {
    m_gateway_name = gateway_name;
    m_gateway_name_isSet = true;
}

bool OAIPayULatam::is_gateway_name_Set() const{
    return m_gateway_name_isSet;
}

bool OAIPayULatam::is_gateway_name_Valid() const{
    return m_gateway_name_isValid;
}

QString OAIPayULatam::getId() const {
    return m_id;
}
void OAIPayULatam::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIPayULatam::is_id_Set() const{
    return m_id_isSet;
}

bool OAIPayULatam::is_id_Valid() const{
    return m_id_isValid;
}

bool OAIPayULatam::isIsDown() const {
    return m_is_down;
}
void OAIPayULatam::setIsDown(const bool &is_down) {
    m_is_down = is_down;
    m_is_down_isSet = true;
}

bool OAIPayULatam::is_is_down_Set() const{
    return m_is_down_isSet;
}

bool OAIPayULatam::is_is_down_Valid() const{
    return m_is_down_isValid;
}

QString OAIPayULatam::getMerchantCategoryCode() const {
    return m_merchant_category_code;
}
void OAIPayULatam::setMerchantCategoryCode(const QString &merchant_category_code) {
    m_merchant_category_code = merchant_category_code;
    m_merchant_category_code_isSet = true;
}

bool OAIPayULatam::is_merchant_category_code_Set() const{
    return m_merchant_category_code_isSet;
}

bool OAIPayULatam::is_merchant_category_code_Valid() const{
    return m_merchant_category_code_isValid;
}

OAIPaymentMethod OAIPayULatam::getMethod() const {
    return m_method;
}
void OAIPayULatam::setMethod(const OAIPaymentMethod &method) {
    m_method = method;
    m_method_isSet = true;
}

bool OAIPayULatam::is_method_Set() const{
    return m_method_isSet;
}

bool OAIPayULatam::is_method_Valid() const{
    return m_method_isValid;
}

double OAIPayULatam::getMonthlyLimit() const {
    return m_monthly_limit;
}
void OAIPayULatam::setMonthlyLimit(const double &monthly_limit) {
    m_monthly_limit = monthly_limit;
    m_monthly_limit_isSet = true;
}

bool OAIPayULatam::is_monthly_limit_Set() const{
    return m_monthly_limit_isSet;
}

bool OAIPayULatam::is_monthly_limit_Valid() const{
    return m_monthly_limit_isValid;
}

QString OAIPayULatam::getOrganizationId() const {
    return m_organization_id;
}
void OAIPayULatam::setOrganizationId(const QString &organization_id) {
    m_organization_id = organization_id;
    m_organization_id_isSet = true;
}

bool OAIPayULatam::is_organization_id_Set() const{
    return m_organization_id_isSet;
}

bool OAIPayULatam::is_organization_id_Valid() const{
    return m_organization_id_isValid;
}

QList<OAIPaymentCardBrand> OAIPayULatam::getPaymentCardSchemes() const {
    return m_payment_card_schemes;
}
void OAIPayULatam::setPaymentCardSchemes(const QList<OAIPaymentCardBrand> &payment_card_schemes) {
    m_payment_card_schemes = payment_card_schemes;
    m_payment_card_schemes_isSet = true;
}

bool OAIPayULatam::is_payment_card_schemes_Set() const{
    return m_payment_card_schemes_isSet;
}

bool OAIPayULatam::is_payment_card_schemes_Valid() const{
    return m_payment_card_schemes_isValid;
}

bool OAIPayULatam::isReconciliationWindowEnabled() const {
    return m_reconciliation_window_enabled;
}
void OAIPayULatam::setReconciliationWindowEnabled(const bool &reconciliation_window_enabled) {
    m_reconciliation_window_enabled = reconciliation_window_enabled;
    m_reconciliation_window_enabled_isSet = true;
}

bool OAIPayULatam::is_reconciliation_window_enabled_Set() const{
    return m_reconciliation_window_enabled_isSet;
}

bool OAIPayULatam::is_reconciliation_window_enabled_Valid() const{
    return m_reconciliation_window_enabled_isValid;
}

qint32 OAIPayULatam::getReconciliationWindowTtl() const {
    return m_reconciliation_window_ttl;
}
void OAIPayULatam::setReconciliationWindowTtl(const qint32 &reconciliation_window_ttl) {
    m_reconciliation_window_ttl = reconciliation_window_ttl;
    m_reconciliation_window_ttl_isSet = true;
}

bool OAIPayULatam::is_reconciliation_window_ttl_Set() const{
    return m_reconciliation_window_ttl_isSet;
}

bool OAIPayULatam::is_reconciliation_window_ttl_Valid() const{
    return m_reconciliation_window_ttl_isValid;
}

QString OAIPayULatam::getStatus() const {
    return m_status;
}
void OAIPayULatam::setStatus(const QString &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIPayULatam::is_status_Set() const{
    return m_status_isSet;
}

bool OAIPayULatam::is_status_Valid() const{
    return m_status_isValid;
}

bool OAIPayULatam::isSticky() const {
    return m_sticky;
}
void OAIPayULatam::setSticky(const bool &sticky) {
    m_sticky = sticky;
    m_sticky_isSet = true;
}

bool OAIPayULatam::is_sticky_Set() const{
    return m_sticky_isSet;
}

bool OAIPayULatam::is_sticky_Valid() const{
    return m_sticky_isValid;
}

bool OAIPayULatam::isThreeDSecure() const {
    return m_three_d_secure;
}
void OAIPayULatam::setThreeDSecure(const bool &three_d_secure) {
    m_three_d_secure = three_d_secure;
    m_three_d_secure_isSet = true;
}

bool OAIPayULatam::is_three_d_secure_Set() const{
    return m_three_d_secure_isSet;
}

bool OAIPayULatam::is_three_d_secure_Valid() const{
    return m_three_d_secure_isValid;
}

qint32 OAIPayULatam::getTimeout() const {
    return m_timeout;
}
void OAIPayULatam::setTimeout(const qint32 &timeout) {
    m_timeout = timeout;
    m_timeout_isSet = true;
}

bool OAIPayULatam::is_timeout_Set() const{
    return m_timeout_isSet;
}

bool OAIPayULatam::is_timeout_Valid() const{
    return m_timeout_isValid;
}

QString OAIPayULatam::getToken() const {
    return m_token;
}
void OAIPayULatam::setToken(const QString &token) {
    m_token = token;
    m_token_isSet = true;
}

bool OAIPayULatam::is_token_Set() const{
    return m_token_isSet;
}

bool OAIPayULatam::is_token_Valid() const{
    return m_token_isValid;
}

QDateTime OAIPayULatam::getUpdatedTime() const {
    return m_updated_time;
}
void OAIPayULatam::setUpdatedTime(const QDateTime &updated_time) {
    m_updated_time = updated_time;
    m_updated_time_isSet = true;
}

bool OAIPayULatam::is_updated_time_Set() const{
    return m_updated_time_isSet;
}

bool OAIPayULatam::is_updated_time_Valid() const{
    return m_updated_time_isValid;
}

OAIPayULatam_allOf_credentials OAIPayULatam::getCredentials() const {
    return m_credentials;
}
void OAIPayULatam::setCredentials(const OAIPayULatam_allOf_credentials &credentials) {
    m_credentials = credentials;
    m_credentials_isSet = true;
}

bool OAIPayULatam::is_credentials_Set() const{
    return m_credentials_isSet;
}

bool OAIPayULatam::is_credentials_Valid() const{
    return m_credentials_isValid;
}

bool OAIPayULatam::isSet() const {
...
bool OAIPayULatam::isValid() const {
