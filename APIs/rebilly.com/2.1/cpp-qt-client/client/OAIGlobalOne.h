...
#ifndef OAIGlobalOne_H
#define OAIGlobalOne_H
...
class OAIGlobalOne_allOf_credentials;

class OAIGlobalOne : public OAIObject {
public:
    OAIGlobalOne();
    OAIGlobalOne(QString json);
    ~OAIGlobalOne() override;
    ...
    OAIGlobalOne_allOf_credentials getCredentials() const;
    void setCredentials(const OAIGlobalOne_allOf_credentials &credentials);
...
private:
    ...
    OAIGlobalOne_allOf_credentials m_credentials;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGlobalOne)

#endif // OAIGlobalOne_H
