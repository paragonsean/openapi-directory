...
/*
 * OAIKhelocardCardToken.h
 *
 * 
 */

#ifndef OAIKhelocardCardToken_H
#define OAIKhelocardCardToken_H
...
class OAIKhelocardCardToken : public OAIObject {
public:
    OAIKhelocardCardToken();
    OAIKhelocardCardToken(QString json);
    ~OAIKhelocardCardToken() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIKhelocardCardToken)

#endif // OAIKhelocardCardToken_H
