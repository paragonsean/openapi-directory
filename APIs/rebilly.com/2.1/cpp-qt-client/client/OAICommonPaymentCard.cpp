...
#include "OAICommonPaymentCard.h"
...
OAICommonPaymentCard::OAICommonPaymentCard(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICommonPaymentCard::OAICommonPaymentCard() {
    this->initializeModel();
}

OAICommonPaymentCard::~OAICommonPaymentCard() {}

void OAICommonPaymentCard::initializeModel() {
...
void OAICommonPaymentCard::fromJson(QString jsonString) {
...
void OAICommonPaymentCard::fromJsonObject(QJsonObject json) {
...
QString OAICommonPaymentCard::asJson() const {
...
QJsonObject OAICommonPaymentCard::asJsonObject() const {
    QJsonObject obj;
...
QString OAICommonPaymentCard::getBankCountry() const {
    return m_bank_country;
}
void OAICommonPaymentCard::setBankCountry(const QString &bank_country) {
    m_bank_country = bank_country;
    m_bank_country_isSet = true;
}

bool OAICommonPaymentCard::is_bank_country_Set() const{
    return m_bank_country_isSet;
}

bool OAICommonPaymentCard::is_bank_country_Valid() const{
    return m_bank_country_isValid;
}

QString OAICommonPaymentCard::getBankName() const {
    return m_bank_name;
}
void OAICommonPaymentCard::setBankName(const QString &bank_name) {
    m_bank_name = bank_name;
    m_bank_name_isSet = true;
}

bool OAICommonPaymentCard::is_bank_name_Set() const{
    return m_bank_name_isSet;
}

bool OAICommonPaymentCard::is_bank_name_Valid() const{
    return m_bank_name_isValid;
}

OAIContactObject OAICommonPaymentCard::getBillingAddress() const {
    return m_billing_address;
}
void OAICommonPaymentCard::setBillingAddress(const OAIContactObject &billing_address) {
    m_billing_address = billing_address;
    m_billing_address_isSet = true;
}

bool OAICommonPaymentCard::is_billing_address_Set() const{
    return m_billing_address_isSet;
}

bool OAICommonPaymentCard::is_billing_address_Valid() const{
    return m_billing_address_isValid;
}

QString OAICommonPaymentCard::getBin() const {
    return m_bin;
}
void OAICommonPaymentCard::setBin(const QString &bin) {
    m_bin = bin;
    m_bin_isSet = true;
}

bool OAICommonPaymentCard::is_bin_Set() const{
    return m_bin_isSet;
}

bool OAICommonPaymentCard::is_bin_Valid() const{
    return m_bin_isValid;
}

OAIPaymentCardBrand OAICommonPaymentCard::getBrand() const {
    return m_brand;
}
void OAICommonPaymentCard::setBrand(const OAIPaymentCardBrand &brand) {
    m_brand = brand;
    m_brand_isSet = true;
}

bool OAICommonPaymentCard::is_brand_Set() const{
    return m_brand_isSet;
}

bool OAICommonPaymentCard::is_brand_Valid() const{
    return m_brand_isValid;
}

QDateTime OAICommonPaymentCard::getCreatedTime() const {
    return m_created_time;
}
void OAICommonPaymentCard::setCreatedTime(const QDateTime &created_time) {
    m_created_time = created_time;
    m_created_time_isSet = true;
}

bool OAICommonPaymentCard::is_created_time_Set() const{
    return m_created_time_isSet;
}

bool OAICommonPaymentCard::is_created_time_Valid() const{
    return m_created_time_isValid;
}

OAIObject OAICommonPaymentCard::getCustomFields() const {
    return m_custom_fields;
}
void OAICommonPaymentCard::setCustomFields(const OAIObject &custom_fields) {
    m_custom_fields = custom_fields;
    m_custom_fields_isSet = true;
}

bool OAICommonPaymentCard::is_custom_fields_Set() const{
    return m_custom_fields_isSet;
}

bool OAICommonPaymentCard::is_custom_fields_Valid() const{
    return m_custom_fields_isValid;
}

QString OAICommonPaymentCard::getCustomerId() const {
    return m_customer_id;
}
void OAICommonPaymentCard::setCustomerId(const QString &customer_id) {
    m_customer_id = customer_id;
    m_customer_id_isSet = true;
}

bool OAICommonPaymentCard::is_customer_id_Set() const{
    return m_customer_id_isSet;
}

bool OAICommonPaymentCard::is_customer_id_Valid() const{
    return m_customer_id_isValid;
}

QString OAICommonPaymentCard::getCvv() const {
    return m_cvv;
}
void OAICommonPaymentCard::setCvv(const QString &cvv) {
    m_cvv = cvv;
    m_cvv_isSet = true;
}

bool OAICommonPaymentCard::is_cvv_Set() const{
    return m_cvv_isSet;
}

bool OAICommonPaymentCard::is_cvv_Valid() const{
    return m_cvv_isValid;
}

qint32 OAICommonPaymentCard::getExpMonth() const {
    return m_exp_month;
}
void OAICommonPaymentCard::setExpMonth(const qint32 &exp_month) {
    m_exp_month = exp_month;
    m_exp_month_isSet = true;
}

bool OAICommonPaymentCard::is_exp_month_Set() const{
    return m_exp_month_isSet;
}

bool OAICommonPaymentCard::is_exp_month_Valid() const{
    return m_exp_month_isValid;
}

qint32 OAICommonPaymentCard::getExpYear() const {
    return m_exp_year;
}
void OAICommonPaymentCard::setExpYear(const qint32 &exp_year) {
    m_exp_year = exp_year;
    m_exp_year_isSet = true;
}

bool OAICommonPaymentCard::is_exp_year_Set() const{
    return m_exp_year_isSet;
}

bool OAICommonPaymentCard::is_exp_year_Valid() const{
    return m_exp_year_isValid;
}

QString OAICommonPaymentCard::getFingerprint() const {
    return m_fingerprint;
}
void OAICommonPaymentCard::setFingerprint(const QString &fingerprint) {
    m_fingerprint = fingerprint;
    m_fingerprint_isSet = true;
}

bool OAICommonPaymentCard::is_fingerprint_Set() const{
    return m_fingerprint_isSet;
}

bool OAICommonPaymentCard::is_fingerprint_Valid() const{
    return m_fingerprint_isValid;
}

QString OAICommonPaymentCard::getId() const {
    return m_id;
}
void OAICommonPaymentCard::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAICommonPaymentCard::is_id_Set() const{
    return m_id_isSet;
}

bool OAICommonPaymentCard::is_id_Valid() const{
    return m_id_isValid;
}

QString OAICommonPaymentCard::getLast4() const {
    return m_last4;
}
void OAICommonPaymentCard::setLast4(const QString &last4) {
    m_last4 = last4;
    m_last4_isSet = true;
}

bool OAICommonPaymentCard::is_last4_Set() const{
    return m_last4_isSet;
}

bool OAICommonPaymentCard::is_last4_Valid() const{
    return m_last4_isValid;
}

QString OAICommonPaymentCard::getMethod() const {
    return m_method;
}
void OAICommonPaymentCard::setMethod(const QString &method) {
    m_method = method;
    m_method_isSet = true;
}

bool OAICommonPaymentCard::is_method_Set() const{
    return m_method_isSet;
}

bool OAICommonPaymentCard::is_method_Valid() const{
    return m_method_isValid;
}

QString OAICommonPaymentCard::getPan() const {
    return m_pan;
}
void OAICommonPaymentCard::setPan(const QString &pan) {
    m_pan = pan;
    m_pan_isSet = true;
}

bool OAICommonPaymentCard::is_pan_Set() const{
    return m_pan_isSet;
}

bool OAICommonPaymentCard::is_pan_Valid() const{
    return m_pan_isValid;
}

OAIRiskMetadata OAICommonPaymentCard::getRiskMetadata() const {
    return m_risk_metadata;
}
void OAICommonPaymentCard::setRiskMetadata(const OAIRiskMetadata &risk_metadata) {
    m_risk_metadata = risk_metadata;
    m_risk_metadata_isSet = true;
}

bool OAICommonPaymentCard::is_risk_metadata_Set() const{
    return m_risk_metadata_isSet;
}

bool OAICommonPaymentCard::is_risk_metadata_Valid() const{
    return m_risk_metadata_isValid;
}

QString OAICommonPaymentCard::getStatus() const {
    return m_status;
}
void OAICommonPaymentCard::setStatus(const QString &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAICommonPaymentCard::is_status_Set() const{
    return m_status_isSet;
}

bool OAICommonPaymentCard::is_status_Valid() const{
    return m_status_isValid;
}

QDateTime OAICommonPaymentCard::getUpdatedTime() const {
    return m_updated_time;
}
void OAICommonPaymentCard::setUpdatedTime(const QDateTime &updated_time) {
    m_updated_time = updated_time;
    m_updated_time_isSet = true;
}

bool OAICommonPaymentCard::is_updated_time_Set() const{
    return m_updated_time_isSet;
}

bool OAICommonPaymentCard::is_updated_time_Valid() const{
    return m_updated_time_isValid;
}

bool OAICommonPaymentCard::isSet() const {
...
bool OAICommonPaymentCard::isValid() const {
