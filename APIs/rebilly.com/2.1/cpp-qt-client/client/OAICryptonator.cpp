...
OAICryptonator::OAICryptonator(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICryptonator::OAICryptonator() {
    this->initializeModel();
}

OAICryptonator::~OAICryptonator() {}

void OAICryptonator::initializeModel() {
...
void OAICryptonator::fromJson(QString jsonString) {
...
void OAICryptonator::fromJsonObject(QJsonObject json) {
...
QString OAICryptonator::asJson() const {
...
QJsonObject OAICryptonator::asJsonObject() const {
    QJsonObject obj;
    if (m__links.size() > 0) {
...
QList<OAIGatewayAccount__links_inner> OAICryptonator::getLinks() const {
    return m__links;
}
void OAICryptonator::setLinks(const QList<OAIGatewayAccount__links_inner> &_links) {
    m__links = _links;
    m__links_isSet = true;
}

bool OAICryptonator::is__links_Set() const{
    return m__links_isSet;
}

bool OAICryptonator::is__links_Valid() const{
    return m__links_isValid;
}

QList<QString> OAICryptonator::getAcceptedCurrencies() const {
    return m_accepted_currencies;
}
void OAICryptonator::setAcceptedCurrencies(const QList<QString> &accepted_currencies) {
    m_accepted_currencies = accepted_currencies;
    m_accepted_currencies_isSet = true;
}

bool OAICryptonator::is_accepted_currencies_Set() const{
    return m_accepted_currencies_isSet;
}

bool OAICryptonator::is_accepted_currencies_Valid() const{
    return m_accepted_currencies_isValid;
}

OAIAcquirerName OAICryptonator::getAcquirerName() const {
    return m_acquirer_name;
}
void OAICryptonator::setAcquirerName(const OAIAcquirerName &acquirer_name) {
    m_acquirer_name = acquirer_name;
    m_acquirer_name_isSet = true;
}

bool OAICryptonator::is_acquirer_name_Set() const{
    return m_acquirer_name_isSet;
}

bool OAICryptonator::is_acquirer_name_Valid() const{
    return m_acquirer_name_isValid;
}

QString OAICryptonator::getAdditionalFilters() const {
    return m_additional_filters;
}
void OAICryptonator::setAdditionalFilters(const QString &additional_filters) {
    m_additional_filters = additional_filters;
    m_additional_filters_isSet = true;
}

bool OAICryptonator::is_additional_filters_Set() const{
    return m_additional_filters_isSet;
}

bool OAICryptonator::is_additional_filters_Valid() const{
    return m_additional_filters_isValid;
}

qint32 OAICryptonator::getApprovalWindowTtl() const {
    return m_approval_window_ttl;
}
void OAICryptonator::setApprovalWindowTtl(const qint32 &approval_window_ttl) {
    m_approval_window_ttl = approval_window_ttl;
    m_approval_window_ttl_isSet = true;
}

bool OAICryptonator::is_approval_window_ttl_Set() const{
    return m_approval_window_ttl_isSet;
}

bool OAICryptonator::is_approval_window_ttl_Valid() const{
    return m_approval_window_ttl_isValid;
}

QString OAICryptonator::getCityField() const {
    return m_city_field;
}
void OAICryptonator::setCityField(const QString &city_field) {
    m_city_field = city_field;
    m_city_field_isSet = true;
}

bool OAICryptonator::is_city_field_Set() const{
    return m_city_field_isSet;
}

bool OAICryptonator::is_city_field_Valid() const{
    return m_city_field_isValid;
}

QDateTime OAICryptonator::getCreatedTime() const {
    return m_created_time;
}
void OAICryptonator::setCreatedTime(const QDateTime &created_time) {
    m_created_time = created_time;
    m_created_time_isSet = true;
}

bool OAICryptonator::is_created_time_Set() const{
    return m_created_time_isSet;
}

bool OAICryptonator::is_created_time_Valid() const{
    return m_created_time_isValid;
}

QString OAICryptonator::getDccForceCurrency() const {
    return m_dcc_force_currency;
}
void OAICryptonator::setDccForceCurrency(const QString &dcc_force_currency) {
    m_dcc_force_currency = dcc_force_currency;
    m_dcc_force_currency_isSet = true;
}

bool OAICryptonator::is_dcc_force_currency_Set() const{
    return m_dcc_force_currency_isSet;
}

bool OAICryptonator::is_dcc_force_currency_Valid() const{
    return m_dcc_force_currency_isValid;
}

qint32 OAICryptonator::getDccMarkup() const {
    return m_dcc_markup;
}
void OAICryptonator::setDccMarkup(const qint32 &dcc_markup) {
    m_dcc_markup = dcc_markup;
    m_dcc_markup_isSet = true;
}

bool OAICryptonator::is_dcc_markup_Set() const{
    return m_dcc_markup_isSet;
}

bool OAICryptonator::is_dcc_markup_Valid() const{
    return m_dcc_markup_isValid;
}

QString OAICryptonator::getDescriptor() const {
    return m_descriptor;
}
void OAICryptonator::setDescriptor(const QString &descriptor) {
    m_descriptor = descriptor;
    m_descriptor_isSet = true;
}

bool OAICryptonator::is_descriptor_Set() const{
    return m_descriptor_isSet;
}

bool OAICryptonator::is_descriptor_Valid() const{
    return m_descriptor_isValid;
}

OAIDigitalWallets OAICryptonator::getDigitalWallets() const {
    return m_digital_wallets;
}
void OAICryptonator::setDigitalWallets(const OAIDigitalWallets &digital_wallets) {
    m_digital_wallets = digital_wallets;
    m_digital_wallets_isSet = true;
}

bool OAICryptonator::is_digital_wallets_Set() const{
    return m_digital_wallets_isSet;
}

bool OAICryptonator::is_digital_wallets_Valid() const{
    return m_digital_wallets_isValid;
}

bool OAICryptonator::isDynamicDescriptor() const {
    return m_dynamic_descriptor;
}
void OAICryptonator::setDynamicDescriptor(const bool &dynamic_descriptor) {
    m_dynamic_descriptor = dynamic_descriptor;
    m_dynamic_descriptor_isSet = true;
}

bool OAICryptonator::is_dynamic_descriptor_Set() const{
    return m_dynamic_descriptor_isSet;
}

bool OAICryptonator::is_dynamic_descriptor_Valid() const{
    return m_dynamic_descriptor_isValid;
}

QList<QString> OAICryptonator::getExcludedDccQuoteCurrencies() const {
    return m_excluded_dcc_quote_currencies;
}
void OAICryptonator::setExcludedDccQuoteCurrencies(const QList<QString> &excluded_dcc_quote_currencies) {
    m_excluded_dcc_quote_currencies = excluded_dcc_quote_currencies;
    m_excluded_dcc_quote_currencies_isSet = true;
}

bool OAICryptonator::is_excluded_dcc_quote_currencies_Set() const{
    return m_excluded_dcc_quote_currencies_isSet;
}

bool OAICryptonator::is_excluded_dcc_quote_currencies_Valid() const{
    return m_excluded_dcc_quote_currencies_isValid;
}

OAIGatewayName OAICryptonator::getGatewayName() const {
    return m_gateway_name;
}
void OAICryptonator::setGatewayName(const OAIGatewayName &gateway_name) {
    m_gateway_name = gateway_name;
    m_gateway_name_isSet = true;
}

bool OAICryptonator::is_gateway_name_Set() const{
    return m_gateway_name_isSet;
}

bool OAICryptonator::is_gateway_name_Valid() const{
    return m_gateway_name_isValid;
}

QString OAICryptonator::getId() const {
    return m_id;
}
void OAICryptonator::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAICryptonator::is_id_Set() const{
    return m_id_isSet;
}

bool OAICryptonator::is_id_Valid() const{
    return m_id_isValid;
}

bool OAICryptonator::isIsDown() const {
    return m_is_down;
}
void OAICryptonator::setIsDown(const bool &is_down) {
    m_is_down = is_down;
    m_is_down_isSet = true;
}

bool OAICryptonator::is_is_down_Set() const{
    return m_is_down_isSet;
}

bool OAICryptonator::is_is_down_Valid() const{
    return m_is_down_isValid;
}

QString OAICryptonator::getMerchantCategoryCode() const {
    return m_merchant_category_code;
}
void OAICryptonator::setMerchantCategoryCode(const QString &merchant_category_code) {
    m_merchant_category_code = merchant_category_code;
    m_merchant_category_code_isSet = true;
}

bool OAICryptonator::is_merchant_category_code_Set() const{
    return m_merchant_category_code_isSet;
}

bool OAICryptonator::is_merchant_category_code_Valid() const{
    return m_merchant_category_code_isValid;
}

OAIPaymentMethod OAICryptonator::getMethod() const {
    return m_method;
}
void OAICryptonator::setMethod(const OAIPaymentMethod &method) {
    m_method = method;
    m_method_isSet = true;
}

bool OAICryptonator::is_method_Set() const{
    return m_method_isSet;
}

bool OAICryptonator::is_method_Valid() const{
    return m_method_isValid;
}

double OAICryptonator::getMonthlyLimit() const {
    return m_monthly_limit;
}
void OAICryptonator::setMonthlyLimit(const double &monthly_limit) {
    m_monthly_limit = monthly_limit;
    m_monthly_limit_isSet = true;
}

bool OAICryptonator::is_monthly_limit_Set() const{
    return m_monthly_limit_isSet;
}

bool OAICryptonator::is_monthly_limit_Valid() const{
    return m_monthly_limit_isValid;
}

QString OAICryptonator::getOrganizationId() const {
    return m_organization_id;
}
void OAICryptonator::setOrganizationId(const QString &organization_id) {
    m_organization_id = organization_id;
    m_organization_id_isSet = true;
}

bool OAICryptonator::is_organization_id_Set() const{
    return m_organization_id_isSet;
}

bool OAICryptonator::is_organization_id_Valid() const{
    return m_organization_id_isValid;
}

QList<OAIPaymentCardBrand> OAICryptonator::getPaymentCardSchemes() const {
    return m_payment_card_schemes;
}
void OAICryptonator::setPaymentCardSchemes(const QList<OAIPaymentCardBrand> &payment_card_schemes) {
    m_payment_card_schemes = payment_card_schemes;
    m_payment_card_schemes_isSet = true;
}

bool OAICryptonator::is_payment_card_schemes_Set() const{
    return m_payment_card_schemes_isSet;
}

bool OAICryptonator::is_payment_card_schemes_Valid() const{
    return m_payment_card_schemes_isValid;
}

bool OAICryptonator::isReconciliationWindowEnabled() const {
    return m_reconciliation_window_enabled;
}
void OAICryptonator::setReconciliationWindowEnabled(const bool &reconciliation_window_enabled) {
    m_reconciliation_window_enabled = reconciliation_window_enabled;
    m_reconciliation_window_enabled_isSet = true;
}

bool OAICryptonator::is_reconciliation_window_enabled_Set() const{
    return m_reconciliation_window_enabled_isSet;
}

bool OAICryptonator::is_reconciliation_window_enabled_Valid() const{
    return m_reconciliation_window_enabled_isValid;
}

qint32 OAICryptonator::getReconciliationWindowTtl() const {
    return m_reconciliation_window_ttl;
}
void OAICryptonator::setReconciliationWindowTtl(const qint32 &reconciliation_window_ttl) {
    m_reconciliation_window_ttl = reconciliation_window_ttl;
    m_reconciliation_window_ttl_isSet = true;
}

bool OAICryptonator::is_reconciliation_window_ttl_Set() const{
    return m_reconciliation_window_ttl_isSet;
}

bool OAICryptonator::is_reconciliation_window_ttl_Valid() const{
    return m_reconciliation_window_ttl_isValid;
}

QString OAICryptonator::getStatus() const {
    return m_status;
}
void OAICryptonator::setStatus(const QString &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAICryptonator::is_status_Set() const{
    return m_status_isSet;
}

bool OAICryptonator::is_status_Valid() const{
    return m_status_isValid;
}

bool OAICryptonator::isSticky() const {
    return m_sticky;
}
void OAICryptonator::setSticky(const bool &sticky) {
    m_sticky = sticky;
    m_sticky_isSet = true;
}

bool OAICryptonator::is_sticky_Set() const{
    return m_sticky_isSet;
}

bool OAICryptonator::is_sticky_Valid() const{
    return m_sticky_isValid;
}

bool OAICryptonator::isThreeDSecure() const {
    return m_three_d_secure;
}
void OAICryptonator::setThreeDSecure(const bool &three_d_secure) {
    m_three_d_secure = three_d_secure;
    m_three_d_secure_isSet = true;
}

bool OAICryptonator::is_three_d_secure_Set() const{
    return m_three_d_secure_isSet;
}

bool OAICryptonator::is_three_d_secure_Valid() const{
    return m_three_d_secure_isValid;
}

qint32 OAICryptonator::getTimeout() const {
    return m_timeout;
}
void OAICryptonator::setTimeout(const qint32 &timeout) {
    m_timeout = timeout;
    m_timeout_isSet = true;
}

bool OAICryptonator::is_timeout_Set() const{
    return m_timeout_isSet;
}

bool OAICryptonator::is_timeout_Valid() const{
    return m_timeout_isValid;
}

QString OAICryptonator::getToken() const {
    return m_token;
}
void OAICryptonator::setToken(const QString &token) {
    m_token = token;
    m_token_isSet = true;
}

bool OAICryptonator::is_token_Set() const{
    return m_token_isSet;
}

bool OAICryptonator::is_token_Valid() const{
    return m_token_isValid;
}

QDateTime OAICryptonator::getUpdatedTime() const {
    return m_updated_time;
}
void OAICryptonator::setUpdatedTime(const QDateTime &updated_time) {
    m_updated_time = updated_time;
    m_updated_time_isSet = true;
}

bool OAICryptonator::is_updated_time_Set() const{
    return m_updated_time_isSet;
}

bool OAICryptonator::is_updated_time_Valid() const{
    return m_updated_time_isValid;
}

OAICryptonator_allOf_credentials OAICryptonator::getCredentials() const {
    return m_credentials;
}
void OAICryptonator::setCredentials(const OAICryptonator_allOf_credentials &credentials) {
    m_credentials = credentials;
    m_credentials_isSet = true;
}

bool OAICryptonator::is_credentials_Set() const{
    return m_credentials_isSet;
}

bool OAICryptonator::is_credentials_Valid() const{
    return m_credentials_isValid;
}

bool OAICryptonator::isSet() const {
...
bool OAICryptonator::isValid() const {
