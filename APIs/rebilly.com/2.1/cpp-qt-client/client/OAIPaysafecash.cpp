...
OAIPaysafecash::OAIPaysafecash(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPaysafecash::OAIPaysafecash() {
    this->initializeModel();
}

OAIPaysafecash::~OAIPaysafecash() {}

void OAIPaysafecash::initializeModel() {
...
void OAIPaysafecash::fromJson(QString jsonString) {
...
void OAIPaysafecash::fromJsonObject(QJsonObject json) {
...
QString OAIPaysafecash::asJson() const {
...
QJsonObject OAIPaysafecash::asJsonObject() const {
    QJsonObject obj;
    if (m__links.size() > 0) {
...
QList<OAIGatewayAccount__links_inner> OAIPaysafecash::getLinks() const {
    return m__links;
}
void OAIPaysafecash::setLinks(const QList<OAIGatewayAccount__links_inner> &_links) {
    m__links = _links;
    m__links_isSet = true;
}

bool OAIPaysafecash::is__links_Set() const{
    return m__links_isSet;
}

bool OAIPaysafecash::is__links_Valid() const{
    return m__links_isValid;
}

QList<QString> OAIPaysafecash::getAcceptedCurrencies() const {
    return m_accepted_currencies;
}
void OAIPaysafecash::setAcceptedCurrencies(const QList<QString> &accepted_currencies) {
    m_accepted_currencies = accepted_currencies;
    m_accepted_currencies_isSet = true;
}

bool OAIPaysafecash::is_accepted_currencies_Set() const{
    return m_accepted_currencies_isSet;
}

bool OAIPaysafecash::is_accepted_currencies_Valid() const{
    return m_accepted_currencies_isValid;
}

OAIAcquirerName OAIPaysafecash::getAcquirerName() const {
    return m_acquirer_name;
}
void OAIPaysafecash::setAcquirerName(const OAIAcquirerName &acquirer_name) {
    m_acquirer_name = acquirer_name;
    m_acquirer_name_isSet = true;
}

bool OAIPaysafecash::is_acquirer_name_Set() const{
    return m_acquirer_name_isSet;
}

bool OAIPaysafecash::is_acquirer_name_Valid() const{
    return m_acquirer_name_isValid;
}

QString OAIPaysafecash::getAdditionalFilters() const {
    return m_additional_filters;
}
void OAIPaysafecash::setAdditionalFilters(const QString &additional_filters) {
    m_additional_filters = additional_filters;
    m_additional_filters_isSet = true;
}

bool OAIPaysafecash::is_additional_filters_Set() const{
    return m_additional_filters_isSet;
}

bool OAIPaysafecash::is_additional_filters_Valid() const{
    return m_additional_filters_isValid;
}

qint32 OAIPaysafecash::getApprovalWindowTtl() const {
    return m_approval_window_ttl;
}
void OAIPaysafecash::setApprovalWindowTtl(const qint32 &approval_window_ttl) {
    m_approval_window_ttl = approval_window_ttl;
    m_approval_window_ttl_isSet = true;
}

bool OAIPaysafecash::is_approval_window_ttl_Set() const{
    return m_approval_window_ttl_isSet;
}

bool OAIPaysafecash::is_approval_window_ttl_Valid() const{
    return m_approval_window_ttl_isValid;
}

QString OAIPaysafecash::getCityField() const {
    return m_city_field;
}
void OAIPaysafecash::setCityField(const QString &city_field) {
    m_city_field = city_field;
    m_city_field_isSet = true;
}

bool OAIPaysafecash::is_city_field_Set() const{
    return m_city_field_isSet;
}

bool OAIPaysafecash::is_city_field_Valid() const{
    return m_city_field_isValid;
}

QDateTime OAIPaysafecash::getCreatedTime() const {
    return m_created_time;
}
void OAIPaysafecash::setCreatedTime(const QDateTime &created_time) {
    m_created_time = created_time;
    m_created_time_isSet = true;
}

bool OAIPaysafecash::is_created_time_Set() const{
    return m_created_time_isSet;
}

bool OAIPaysafecash::is_created_time_Valid() const{
    return m_created_time_isValid;
}

QString OAIPaysafecash::getDccForceCurrency() const {
    return m_dcc_force_currency;
}
void OAIPaysafecash::setDccForceCurrency(const QString &dcc_force_currency) {
    m_dcc_force_currency = dcc_force_currency;
    m_dcc_force_currency_isSet = true;
}

bool OAIPaysafecash::is_dcc_force_currency_Set() const{
    return m_dcc_force_currency_isSet;
}

bool OAIPaysafecash::is_dcc_force_currency_Valid() const{
    return m_dcc_force_currency_isValid;
}

qint32 OAIPaysafecash::getDccMarkup() const {
    return m_dcc_markup;
}
void OAIPaysafecash::setDccMarkup(const qint32 &dcc_markup) {
    m_dcc_markup = dcc_markup;
    m_dcc_markup_isSet = true;
}

bool OAIPaysafecash::is_dcc_markup_Set() const{
    return m_dcc_markup_isSet;
}

bool OAIPaysafecash::is_dcc_markup_Valid() const{
    return m_dcc_markup_isValid;
}

QString OAIPaysafecash::getDescriptor() const {
    return m_descriptor;
}
void OAIPaysafecash::setDescriptor(const QString &descriptor) {
    m_descriptor = descriptor;
    m_descriptor_isSet = true;
}

bool OAIPaysafecash::is_descriptor_Set() const{
    return m_descriptor_isSet;
}

bool OAIPaysafecash::is_descriptor_Valid() const{
    return m_descriptor_isValid;
}

OAIDigitalWallets OAIPaysafecash::getDigitalWallets() const {
    return m_digital_wallets;
}
void OAIPaysafecash::setDigitalWallets(const OAIDigitalWallets &digital_wallets) {
    m_digital_wallets = digital_wallets;
    m_digital_wallets_isSet = true;
}

bool OAIPaysafecash::is_digital_wallets_Set() const{
    return m_digital_wallets_isSet;
}

bool OAIPaysafecash::is_digital_wallets_Valid() const{
    return m_digital_wallets_isValid;
}

bool OAIPaysafecash::isDynamicDescriptor() const {
    return m_dynamic_descriptor;
}
void OAIPaysafecash::setDynamicDescriptor(const bool &dynamic_descriptor) {
    m_dynamic_descriptor = dynamic_descriptor;
    m_dynamic_descriptor_isSet = true;
}

bool OAIPaysafecash::is_dynamic_descriptor_Set() const{
    return m_dynamic_descriptor_isSet;
}

bool OAIPaysafecash::is_dynamic_descriptor_Valid() const{
    return m_dynamic_descriptor_isValid;
}

QList<QString> OAIPaysafecash::getExcludedDccQuoteCurrencies() const {
    return m_excluded_dcc_quote_currencies;
}
void OAIPaysafecash::setExcludedDccQuoteCurrencies(const QList<QString> &excluded_dcc_quote_currencies) {
    m_excluded_dcc_quote_currencies = excluded_dcc_quote_currencies;
    m_excluded_dcc_quote_currencies_isSet = true;
}

bool OAIPaysafecash::is_excluded_dcc_quote_currencies_Set() const{
    return m_excluded_dcc_quote_currencies_isSet;
}

bool OAIPaysafecash::is_excluded_dcc_quote_currencies_Valid() const{
    return m_excluded_dcc_quote_currencies_isValid;
}

OAIGatewayName OAIPaysafecash::getGatewayName() const {
    return m_gateway_name;
}
void OAIPaysafecash::setGatewayName(const OAIGatewayName &gateway_name) {
    m_gateway_name = gateway_name;
    m_gateway_name_isSet = true;
}

bool OAIPaysafecash::is_gateway_name_Set() const{
    return m_gateway_name_isSet;
}

bool OAIPaysafecash::is_gateway_name_Valid() const{
    return m_gateway_name_isValid;
}

QString OAIPaysafecash::getId() const {
    return m_id;
}
void OAIPaysafecash::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIPaysafecash::is_id_Set() const{
    return m_id_isSet;
}

bool OAIPaysafecash::is_id_Valid() const{
    return m_id_isValid;
}

bool OAIPaysafecash::isIsDown() const {
    return m_is_down;
}
void OAIPaysafecash::setIsDown(const bool &is_down) {
    m_is_down = is_down;
    m_is_down_isSet = true;
}

bool OAIPaysafecash::is_is_down_Set() const{
    return m_is_down_isSet;
}

bool OAIPaysafecash::is_is_down_Valid() const{
    return m_is_down_isValid;
}

QString OAIPaysafecash::getMerchantCategoryCode() const {
    return m_merchant_category_code;
}
void OAIPaysafecash::setMerchantCategoryCode(const QString &merchant_category_code) {
    m_merchant_category_code = merchant_category_code;
    m_merchant_category_code_isSet = true;
}

bool OAIPaysafecash::is_merchant_category_code_Set() const{
    return m_merchant_category_code_isSet;
}

bool OAIPaysafecash::is_merchant_category_code_Valid() const{
    return m_merchant_category_code_isValid;
}

OAIPaymentMethod OAIPaysafecash::getMethod() const {
    return m_method;
}
void OAIPaysafecash::setMethod(const OAIPaymentMethod &method) {
    m_method = method;
    m_method_isSet = true;
}

bool OAIPaysafecash::is_method_Set() const{
    return m_method_isSet;
}

bool OAIPaysafecash::is_method_Valid() const{
    return m_method_isValid;
}

double OAIPaysafecash::getMonthlyLimit() const {
    return m_monthly_limit;
}
void OAIPaysafecash::setMonthlyLimit(const double &monthly_limit) {
    m_monthly_limit = monthly_limit;
    m_monthly_limit_isSet = true;
}

bool OAIPaysafecash::is_monthly_limit_Set() const{
    return m_monthly_limit_isSet;
}

bool OAIPaysafecash::is_monthly_limit_Valid() const{
    return m_monthly_limit_isValid;
}

QString OAIPaysafecash::getOrganizationId() const {
    return m_organization_id;
}
void OAIPaysafecash::setOrganizationId(const QString &organization_id) {
    m_organization_id = organization_id;
    m_organization_id_isSet = true;
}

bool OAIPaysafecash::is_organization_id_Set() const{
    return m_organization_id_isSet;
}

bool OAIPaysafecash::is_organization_id_Valid() const{
    return m_organization_id_isValid;
}

QList<OAIPaymentCardBrand> OAIPaysafecash::getPaymentCardSchemes() const {
    return m_payment_card_schemes;
}
void OAIPaysafecash::setPaymentCardSchemes(const QList<OAIPaymentCardBrand> &payment_card_schemes) {
    m_payment_card_schemes = payment_card_schemes;
    m_payment_card_schemes_isSet = true;
}

bool OAIPaysafecash::is_payment_card_schemes_Set() const{
    return m_payment_card_schemes_isSet;
}

bool OAIPaysafecash::is_payment_card_schemes_Valid() const{
    return m_payment_card_schemes_isValid;
}

bool OAIPaysafecash::isReconciliationWindowEnabled() const {
    return m_reconciliation_window_enabled;
}
void OAIPaysafecash::setReconciliationWindowEnabled(const bool &reconciliation_window_enabled) {
    m_reconciliation_window_enabled = reconciliation_window_enabled;
    m_reconciliation_window_enabled_isSet = true;
}

bool OAIPaysafecash::is_reconciliation_window_enabled_Set() const{
    return m_reconciliation_window_enabled_isSet;
}

bool OAIPaysafecash::is_reconciliation_window_enabled_Valid() const{
    return m_reconciliation_window_enabled_isValid;
}

qint32 OAIPaysafecash::getReconciliationWindowTtl() const {
    return m_reconciliation_window_ttl;
}
void OAIPaysafecash::setReconciliationWindowTtl(const qint32 &reconciliation_window_ttl) {
    m_reconciliation_window_ttl = reconciliation_window_ttl;
    m_reconciliation_window_ttl_isSet = true;
}

bool OAIPaysafecash::is_reconciliation_window_ttl_Set() const{
    return m_reconciliation_window_ttl_isSet;
}

bool OAIPaysafecash::is_reconciliation_window_ttl_Valid() const{
    return m_reconciliation_window_ttl_isValid;
}

QString OAIPaysafecash::getStatus() const {
    return m_status;
}
void OAIPaysafecash::setStatus(const QString &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIPaysafecash::is_status_Set() const{
    return m_status_isSet;
}

bool OAIPaysafecash::is_status_Valid() const{
    return m_status_isValid;
}

bool OAIPaysafecash::isSticky() const {
    return m_sticky;
}
void OAIPaysafecash::setSticky(const bool &sticky) {
    m_sticky = sticky;
    m_sticky_isSet = true;
}

bool OAIPaysafecash::is_sticky_Set() const{
    return m_sticky_isSet;
}

bool OAIPaysafecash::is_sticky_Valid() const{
    return m_sticky_isValid;
}

bool OAIPaysafecash::isThreeDSecure() const {
    return m_three_d_secure;
}
void OAIPaysafecash::setThreeDSecure(const bool &three_d_secure) {
    m_three_d_secure = three_d_secure;
    m_three_d_secure_isSet = true;
}

bool OAIPaysafecash::is_three_d_secure_Set() const{
    return m_three_d_secure_isSet;
}

bool OAIPaysafecash::is_three_d_secure_Valid() const{
    return m_three_d_secure_isValid;
}

qint32 OAIPaysafecash::getTimeout() const {
    return m_timeout;
}
void OAIPaysafecash::setTimeout(const qint32 &timeout) {
    m_timeout = timeout;
    m_timeout_isSet = true;
}

bool OAIPaysafecash::is_timeout_Set() const{
    return m_timeout_isSet;
}

bool OAIPaysafecash::is_timeout_Valid() const{
    return m_timeout_isValid;
}

QString OAIPaysafecash::getToken() const {
    return m_token;
}
void OAIPaysafecash::setToken(const QString &token) {
    m_token = token;
    m_token_isSet = true;
}

bool OAIPaysafecash::is_token_Set() const{
    return m_token_isSet;
}

bool OAIPaysafecash::is_token_Valid() const{
    return m_token_isValid;
}

QDateTime OAIPaysafecash::getUpdatedTime() const {
    return m_updated_time;
}
void OAIPaysafecash::setUpdatedTime(const QDateTime &updated_time) {
    m_updated_time = updated_time;
    m_updated_time_isSet = true;
}

bool OAIPaysafecash::is_updated_time_Set() const{
    return m_updated_time_isSet;
}

bool OAIPaysafecash::is_updated_time_Valid() const{
    return m_updated_time_isValid;
}

OAIPaysafecash_allOf_credentials OAIPaysafecash::getCredentials() const {
    return m_credentials;
}
void OAIPaysafecash::setCredentials(const OAIPaysafecash_allOf_credentials &credentials) {
    m_credentials = credentials;
    m_credentials_isSet = true;
}

bool OAIPaysafecash::is_credentials_Set() const{
    return m_credentials_isSet;
}

bool OAIPaysafecash::is_credentials_Valid() const{
    return m_credentials_isValid;
}

bool OAIPaysafecash::isSet() const {
...
bool OAIPaysafecash::isValid() const {
