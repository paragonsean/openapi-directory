...
#ifndef OAIPaysafecash_H
#define OAIPaysafecash_H
...
class OAIPaysafecash_allOf_credentials;

class OAIPaysafecash : public OAIObject {
public:
    OAIPaysafecash();
    OAIPaysafecash(QString json);
    ~OAIPaysafecash() override;
    ...
    OAIPaysafecash_allOf_credentials getCredentials() const;
    void setCredentials(const OAIPaysafecash_allOf_credentials &credentials);
...
private:
    ...
    OAIPaysafecash_allOf_credentials m_credentials;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPaysafecash)

#endif // OAIPaysafecash_H
