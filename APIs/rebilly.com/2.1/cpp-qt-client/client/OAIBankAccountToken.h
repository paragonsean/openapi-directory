...
/*
 * OAIBankAccountToken.h
 *
 * 
 */

#ifndef OAIBankAccountToken_H
#define OAIBankAccountToken_H

#include <QJsonObject>

#include "OAIBankAccountInstrument.h"
...
class OAIBankAccountInstrument;
class OAISelfLink;
class OAILeadSource;
class OAIRiskMetadata;

class OAIBankAccountToken : public OAIObject {
public:
    OAIBankAccountToken();
    OAIBankAccountToken(QString json);
    ~OAIBankAccountToken() override;
    ...
    OAIBankAccountInstrument getPaymentInstrument() const;
    void setPaymentInstrument(const OAIBankAccountInstrument &payment_instrument);
...
private:
    ...
    OAIBankAccountInstrument m_payment_instrument;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBankAccountToken)

#endif // OAIBankAccountToken_H
