...
#ifndef OAIINOVAPAY_H
#define OAIINOVAPAY_H
...
#include "OAIINOVAPAY_allOf_credentials.h"
...
class OAIINOVAPAY_allOf_credentials;

class OAIINOVAPAY : public OAIObject {
public:
    OAIINOVAPAY();
    OAIINOVAPAY(QString json);
    ~OAIINOVAPAY() override;
    ...
    OAIINOVAPAY_allOf_credentials getCredentials() const;
    void setCredentials(const OAIINOVAPAY_allOf_credentials &credentials);
...
private:
    ...
    OAIINOVAPAY_allOf_credentials m_credentials;
...
Q_DECLARE_METATYPE(OpenAPI::OAIINOVAPAY)
