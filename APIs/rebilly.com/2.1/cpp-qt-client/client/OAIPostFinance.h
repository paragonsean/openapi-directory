...
#ifndef OAIPostFinance_H
#define OAIPostFinance_H
...
#include "OAIPostFinance_allOf_credentials.h"
#include <QDateTime>
#include <QList>
#include <QString>
...
class OAIPostFinance_allOf_credentials;

class OAIPostFinance : public OAIObject {
public:
    OAIPostFinance();
    OAIPostFinance(QString json);
    ~OAIPostFinance() override;
    ...
    OAIPostFinance_allOf_credentials getCredentials() const;
    void setCredentials(const OAIPostFinance_allOf_credentials &credentials);
...
private:
    ...
    OAIPostFinance_allOf_credentials m_credentials;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPostFinance)

#endif // OAIPostFinance_H
