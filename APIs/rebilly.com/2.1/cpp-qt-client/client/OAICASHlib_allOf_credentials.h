...
/*
 * OAICASHlib_allOf_credentials.h
 *
 * CASHlib credentials object.
 */

#ifndef OAICASHlib_allOf_credentials_H
#define OAICASHlib_allOf_credentials_H
...
class OAICASHlib_allOf_credentials : public OAIObject {
public:
    OAICASHlib_allOf_credentials();
    OAICASHlib_allOf_credentials(QString json);
    ~OAICASHlib_allOf_credentials() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICASHlib_allOf_credentials)

#endif // OAICASHlib_allOf_credentials_H
