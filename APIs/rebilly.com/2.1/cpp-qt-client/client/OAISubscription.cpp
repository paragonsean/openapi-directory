...
QString OAISubscription::getOrderType() const {
    return m_order_type;
}
void OAISubscription::setOrderType(const QString &order_type) {
    m_order_type = order_type;
    m_order_type_isSet = true;
}

bool OAISubscription::is_order_type_Set() const{
    return m_order_type_isSet;
}

bool OAISubscription::is_order_type_Valid() const{
