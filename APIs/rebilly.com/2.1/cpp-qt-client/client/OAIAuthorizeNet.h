...
#ifndef OAIAuthorizeNet_H
#define OAIAuthorizeNet_H
...
class OAIAuthorizeNet_allOf_credentials;

class OAIAuthorizeNet : public OAIObject {
public:
    OAIAuthorizeNet();
    OAIAuthorizeNet(QString json);
    ~OAIAuthorizeNet() override;
    ...
    OAIAuthorizeNet_allOf_credentials getCredentials() const;
    void setCredentials(const OAIAuthorizeNet_allOf_credentials &credentials);
...
private:
    ...
    OAIAuthorizeNet_allOf_credentials m_credentials;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAuthorizeNet)

#endif // OAIAuthorizeNet_H
