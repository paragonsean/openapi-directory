...
OAIA1Gateway::OAIA1Gateway(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIA1Gateway::OAIA1Gateway() {
    this->initializeModel();
}

OAIA1Gateway::~OAIA1Gateway() {}

void OAIA1Gateway::initializeModel() {
...
void OAIA1Gateway::fromJson(QString jsonString) {
...
void OAIA1Gateway::fromJsonObject(QJsonObject json) {
...
QString OAIA1Gateway::asJson() const {
...
QJsonObject OAIA1Gateway::asJsonObject() const {
    QJsonObject obj;
    if (m__links.size() > 0) {
...
QList<OAIGatewayAccount__links_inner> OAIA1Gateway::getLinks() const {
    return m__links;
}
void OAIA1Gateway::setLinks(const QList<OAIGatewayAccount__links_inner> &_links) {
    m__links = _links;
    m__links_isSet = true;
}

bool OAIA1Gateway::is__links_Set() const{
    return m__links_isSet;
}

bool OAIA1Gateway::is__links_Valid() const{
    return m__links_isValid;
}

QList<QString> OAIA1Gateway::getAcceptedCurrencies() const {
    return m_accepted_currencies;
}
void OAIA1Gateway::setAcceptedCurrencies(const QList<QString> &accepted_currencies) {
    m_accepted_currencies = accepted_currencies;
    m_accepted_currencies_isSet = true;
}

bool OAIA1Gateway::is_accepted_currencies_Set() const{
    return m_accepted_currencies_isSet;
}

bool OAIA1Gateway::is_accepted_currencies_Valid() const{
    return m_accepted_currencies_isValid;
}

OAIAcquirerName OAIA1Gateway::getAcquirerName() const {
    return m_acquirer_name;
}
void OAIA1Gateway::setAcquirerName(const OAIAcquirerName &acquirer_name) {
    m_acquirer_name = acquirer_name;
    m_acquirer_name_isSet = true;
}

bool OAIA1Gateway::is_acquirer_name_Set() const{
    return m_acquirer_name_isSet;
}

bool OAIA1Gateway::is_acquirer_name_Valid() const{
    return m_acquirer_name_isValid;
}

QString OAIA1Gateway::getAdditionalFilters() const {
    return m_additional_filters;
}
void OAIA1Gateway::setAdditionalFilters(const QString &additional_filters) {
    m_additional_filters = additional_filters;
    m_additional_filters_isSet = true;
}

bool OAIA1Gateway::is_additional_filters_Set() const{
    return m_additional_filters_isSet;
}

bool OAIA1Gateway::is_additional_filters_Valid() const{
    return m_additional_filters_isValid;
}

qint32 OAIA1Gateway::getApprovalWindowTtl() const {
    return m_approval_window_ttl;
}
void OAIA1Gateway::setApprovalWindowTtl(const qint32 &approval_window_ttl) {
    m_approval_window_ttl = approval_window_ttl;
    m_approval_window_ttl_isSet = true;
}

bool OAIA1Gateway::is_approval_window_ttl_Set() const{
    return m_approval_window_ttl_isSet;
}

bool OAIA1Gateway::is_approval_window_ttl_Valid() const{
    return m_approval_window_ttl_isValid;
}

QString OAIA1Gateway::getCityField() const {
    return m_city_field;
}
void OAIA1Gateway::setCityField(const QString &city_field) {
    m_city_field = city_field;
    m_city_field_isSet = true;
}

bool OAIA1Gateway::is_city_field_Set() const{
    return m_city_field_isSet;
}

bool OAIA1Gateway::is_city_field_Valid() const{
    return m_city_field_isValid;
}

QDateTime OAIA1Gateway::getCreatedTime() const {
    return m_created_time;
}
void OAIA1Gateway::setCreatedTime(const QDateTime &created_time) {
    m_created_time = created_time;
    m_created_time_isSet = true;
}

bool OAIA1Gateway::is_created_time_Set() const{
    return m_created_time_isSet;
}

bool OAIA1Gateway::is_created_time_Valid() const{
    return m_created_time_isValid;
}

QString OAIA1Gateway::getDccForceCurrency() const {
    return m_dcc_force_currency;
}
void OAIA1Gateway::setDccForceCurrency(const QString &dcc_force_currency) {
    m_dcc_force_currency = dcc_force_currency;
    m_dcc_force_currency_isSet = true;
}

bool OAIA1Gateway::is_dcc_force_currency_Set() const{
    return m_dcc_force_currency_isSet;
}

bool OAIA1Gateway::is_dcc_force_currency_Valid() const{
    return m_dcc_force_currency_isValid;
}

qint32 OAIA1Gateway::getDccMarkup() const {
    return m_dcc_markup;
}
void OAIA1Gateway::setDccMarkup(const qint32 &dcc_markup) {
    m_dcc_markup = dcc_markup;
    m_dcc_markup_isSet = true;
}

bool OAIA1Gateway::is_dcc_markup_Set() const{
    return m_dcc_markup_isSet;
}

bool OAIA1Gateway::is_dcc_markup_Valid() const{
    return m_dcc_markup_isValid;
}

QString OAIA1Gateway::getDescriptor() const {
    return m_descriptor;
}
void OAIA1Gateway::setDescriptor(const QString &descriptor) {
    m_descriptor = descriptor;
    m_descriptor_isSet = true;
}

bool OAIA1Gateway::is_descriptor_Set() const{
    return m_descriptor_isSet;
}

bool OAIA1Gateway::is_descriptor_Valid() const{
    return m_descriptor_isValid;
}

OAIDigitalWallets OAIA1Gateway::getDigitalWallets() const {
    return m_digital_wallets;
}
void OAIA1Gateway::setDigitalWallets(const OAIDigitalWallets &digital_wallets) {
    m_digital_wallets = digital_wallets;
    m_digital_wallets_isSet = true;
}

bool OAIA1Gateway::is_digital_wallets_Set() const{
    return m_digital_wallets_isSet;
}

bool OAIA1Gateway::is_digital_wallets_Valid() const{
    return m_digital_wallets_isValid;
}

bool OAIA1Gateway::isDynamicDescriptor() const {
    return m_dynamic_descriptor;
}
void OAIA1Gateway::setDynamicDescriptor(const bool &dynamic_descriptor) {
    m_dynamic_descriptor = dynamic_descriptor;
    m_dynamic_descriptor_isSet = true;
}

bool OAIA1Gateway::is_dynamic_descriptor_Set() const{
    return m_dynamic_descriptor_isSet;
}

bool OAIA1Gateway::is_dynamic_descriptor_Valid() const{
    return m_dynamic_descriptor_isValid;
}

QList<QString> OAIA1Gateway::getExcludedDccQuoteCurrencies() const {
    return m_excluded_dcc_quote_currencies;
}
void OAIA1Gateway::setExcludedDccQuoteCurrencies(const QList<QString> &excluded_dcc_quote_currencies) {
    m_excluded_dcc_quote_currencies = excluded_dcc_quote_currencies;
    m_excluded_dcc_quote_currencies_isSet = true;
}

bool OAIA1Gateway::is_excluded_dcc_quote_currencies_Set() const{
    return m_excluded_dcc_quote_currencies_isSet;
}

bool OAIA1Gateway::is_excluded_dcc_quote_currencies_Valid() const{
    return m_excluded_dcc_quote_currencies_isValid;
}

OAIGatewayName OAIA1Gateway::getGatewayName() const {
    return m_gateway_name;
}
void OAIA1Gateway::setGatewayName(const OAIGatewayName &gateway_name) {
    m_gateway_name = gateway_name;
    m_gateway_name_isSet = true;
}

bool OAIA1Gateway::is_gateway_name_Set() const{
    return m_gateway_name_isSet;
}

bool OAIA1Gateway::is_gateway_name_Valid() const{
    return m_gateway_name_isValid;
}

QString OAIA1Gateway::getId() const {
    return m_id;
}
void OAIA1Gateway::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIA1Gateway::is_id_Set() const{
    return m_id_isSet;
}

bool OAIA1Gateway::is_id_Valid() const{
    return m_id_isValid;
}

bool OAIA1Gateway::isIsDown() const {
    return m_is_down;
}
void OAIA1Gateway::setIsDown(const bool &is_down) {
    m_is_down = is_down;
    m_is_down_isSet = true;
}

bool OAIA1Gateway::is_is_down_Set() const{
    return m_is_down_isSet;
}

bool OAIA1Gateway::is_is_down_Valid() const{
    return m_is_down_isValid;
}

QString OAIA1Gateway::getMerchantCategoryCode() const {
    return m_merchant_category_code;
}
void OAIA1Gateway::setMerchantCategoryCode(const QString &merchant_category_code) {
    m_merchant_category_code = merchant_category_code;
    m_merchant_category_code_isSet = true;
}

bool OAIA1Gateway::is_merchant_category_code_Set() const{
    return m_merchant_category_code_isSet;
}

bool OAIA1Gateway::is_merchant_category_code_Valid() const{
    return m_merchant_category_code_isValid;
}

OAIPaymentMethod OAIA1Gateway::getMethod() const {
    return m_method;
}
void OAIA1Gateway::setMethod(const OAIPaymentMethod &method) {
    m_method = method;
    m_method_isSet = true;
}

bool OAIA1Gateway::is_method_Set() const{
    return m_method_isSet;
}

bool OAIA1Gateway::is_method_Valid() const{
    return m_method_isValid;
}

double OAIA1Gateway::getMonthlyLimit() const {
    return m_monthly_limit;
}
void OAIA1Gateway::setMonthlyLimit(const double &monthly_limit) {
    m_monthly_limit = monthly_limit;
    m_monthly_limit_isSet = true;
}

bool OAIA1Gateway::is_monthly_limit_Set() const{
    return m_monthly_limit_isSet;
}

bool OAIA1Gateway::is_monthly_limit_Valid() const{
    return m_monthly_limit_isValid;
}

QString OAIA1Gateway::getOrganizationId() const {
    return m_organization_id;
}
void OAIA1Gateway::setOrganizationId(const QString &organization_id) {
    m_organization_id = organization_id;
    m_organization_id_isSet = true;
}

bool OAIA1Gateway::is_organization_id_Set() const{
    return m_organization_id_isSet;
}

bool OAIA1Gateway::is_organization_id_Valid() const{
    return m_organization_id_isValid;
}

QList<OAIPaymentCardBrand> OAIA1Gateway::getPaymentCardSchemes() const {
    return m_payment_card_schemes;
}
void OAIA1Gateway::setPaymentCardSchemes(const QList<OAIPaymentCardBrand> &payment_card_schemes) {
    m_payment_card_schemes = payment_card_schemes;
    m_payment_card_schemes_isSet = true;
}

bool OAIA1Gateway::is_payment_card_schemes_Set() const{
    return m_payment_card_schemes_isSet;
}

bool OAIA1Gateway::is_payment_card_schemes_Valid() const{
    return m_payment_card_schemes_isValid;
}

bool OAIA1Gateway::isReconciliationWindowEnabled() const {
    return m_reconciliation_window_enabled;
}
void OAIA1Gateway::setReconciliationWindowEnabled(const bool &reconciliation_window_enabled) {
    m_reconciliation_window_enabled = reconciliation_window_enabled;
    m_reconciliation_window_enabled_isSet = true;
}

bool OAIA1Gateway::is_reconciliation_window_enabled_Set() const{
    return m_reconciliation_window_enabled_isSet;
}

bool OAIA1Gateway::is_reconciliation_window_enabled_Valid() const{
    return m_reconciliation_window_enabled_isValid;
}

qint32 OAIA1Gateway::getReconciliationWindowTtl() const {
    return m_reconciliation_window_ttl;
}
void OAIA1Gateway::setReconciliationWindowTtl(const qint32 &reconciliation_window_ttl) {
    m_reconciliation_window_ttl = reconciliation_window_ttl;
    m_reconciliation_window_ttl_isSet = true;
}

bool OAIA1Gateway::is_reconciliation_window_ttl_Set() const{
    return m_reconciliation_window_ttl_isSet;
}

bool OAIA1Gateway::is_reconciliation_window_ttl_Valid() const{
    return m_reconciliation_window_ttl_isValid;
}

QString OAIA1Gateway::getStatus() const {
    return m_status;
}
void OAIA1Gateway::setStatus(const QString &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIA1Gateway::is_status_Set() const{
    return m_status_isSet;
}

bool OAIA1Gateway::is_status_Valid() const{
    return m_status_isValid;
}

bool OAIA1Gateway::isSticky() const {
    return m_sticky;
}
void OAIA1Gateway::setSticky(const bool &sticky) {
    m_sticky = sticky;
    m_sticky_isSet = true;
}

bool OAIA1Gateway::is_sticky_Set() const{
    return m_sticky_isSet;
}

bool OAIA1Gateway::is_sticky_Valid() const{
    return m_sticky_isValid;
}

bool OAIA1Gateway::isThreeDSecure() const {
    return m_three_d_secure;
}
void OAIA1Gateway::setThreeDSecure(const bool &three_d_secure) {
    m_three_d_secure = three_d_secure;
    m_three_d_secure_isSet = true;
}

bool OAIA1Gateway::is_three_d_secure_Set() const{
    return m_three_d_secure_isSet;
}

bool OAIA1Gateway::is_three_d_secure_Valid() const{
    return m_three_d_secure_isValid;
}

qint32 OAIA1Gateway::getTimeout() const {
    return m_timeout;
}
void OAIA1Gateway::setTimeout(const qint32 &timeout) {
    m_timeout = timeout;
    m_timeout_isSet = true;
}

bool OAIA1Gateway::is_timeout_Set() const{
    return m_timeout_isSet;
}

bool OAIA1Gateway::is_timeout_Valid() const{
    return m_timeout_isValid;
}

QString OAIA1Gateway::getToken() const {
    return m_token;
}
void OAIA1Gateway::setToken(const QString &token) {
    m_token = token;
    m_token_isSet = true;
}

bool OAIA1Gateway::is_token_Set() const{
    return m_token_isSet;
}

bool OAIA1Gateway::is_token_Valid() const{
    return m_token_isValid;
}

QDateTime OAIA1Gateway::getUpdatedTime() const {
    return m_updated_time;
}
void OAIA1Gateway::setUpdatedTime(const QDateTime &updated_time) {
    m_updated_time = updated_time;
    m_updated_time_isSet = true;
}

bool OAIA1Gateway::is_updated_time_Set() const{
    return m_updated_time_isSet;
}

bool OAIA1Gateway::is_updated_time_Valid() const{
    return m_updated_time_isValid;
}

OAIA1Gateway_allOf_credentials OAIA1Gateway::getCredentials() const {
    return m_credentials;
}
void OAIA1Gateway::setCredentials(const OAIA1Gateway_allOf_credentials &credentials) {
    m_credentials = credentials;
    m_credentials_isSet = true;
}

bool OAIA1Gateway::is_credentials_Set() const{
    return m_credentials_isSet;
}

bool OAIA1Gateway::is_credentials_Valid() const{
    return m_credentials_isValid;
}

OAIA1Gateway3dsServers OAIA1Gateway::getThreeDSecureServer() const {
    return m_three_d_secure_server;
}
void OAIA1Gateway::setThreeDSecureServer(const OAIA1Gateway3dsServers &three_d_secure_server) {
    m_three_d_secure_server = three_d_secure_server;
    m_three_d_secure_server_isSet = true;
}

bool OAIA1Gateway::is_three_d_secure_server_Set() const{
    return m_three_d_secure_server_isSet;
}

bool OAIA1Gateway::is_three_d_secure_server_Valid() const{
    return m_three_d_secure_server_isValid;
}

bool OAIA1Gateway::isSet() const {
...
bool OAIA1Gateway::isValid() const {
