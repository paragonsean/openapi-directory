...
class OAIOchaPay_allOf_credentials;

class OAIOchaPay : public OAIObject {
public:
    OAIOchaPay();
    OAIOchaPay(QString json);
    ~OAIOchaPay() override;
    ...
    OAIOchaPay_allOf_credentials getCredentials() const;
    void setCredentials(const OAIOchaPay_allOf_credentials &credentials);
...
private:
    ...
    OAIOchaPay_allOf_credentials m_credentials;
...
Q_DECLARE_METATYPE(OpenAPI::OAIOchaPay)
