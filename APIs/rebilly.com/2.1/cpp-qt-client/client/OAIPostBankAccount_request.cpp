...
#include "OAIPostBankAccount_request.h"
...
OAIPostBankAccount_request::OAIPostBankAccount_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPostBankAccount_request::OAIPostBankAccount_request() {
    this->initializeModel();
}

OAIPostBankAccount_request::~OAIPostBankAccount_request() {}

void OAIPostBankAccount_request::initializeModel() {
...
void OAIPostBankAccount_request::fromJson(QString jsonString) {
...
void OAIPostBankAccount_request::fromJsonObject(QJsonObject json) {
...
QString OAIPostBankAccount_request::asJson() const {
...
QJsonObject OAIPostBankAccount_request::asJsonObject() const {
    QJsonObject obj;
...
OAIObject OAIPostBankAccount_request::getCustomFields() const {
    return m_custom_fields;
}
void OAIPostBankAccount_request::setCustomFields(const OAIObject &custom_fields) {
    m_custom_fields = custom_fields;
    m_custom_fields_isSet = true;
}

bool OAIPostBankAccount_request::is_custom_fields_Set() const{
    return m_custom_fields_isSet;
}

bool OAIPostBankAccount_request::is_custom_fields_Valid() const{
    return m_custom_fields_isValid;
}

QString OAIPostBankAccount_request::getCustomerId() const {
    return m_customer_id;
}
void OAIPostBankAccount_request::setCustomerId(const QString &customer_id) {
    m_customer_id = customer_id;
    m_customer_id_isSet = true;
}

bool OAIPostBankAccount_request::is_customer_id_Set() const{
    return m_customer_id_isSet;
}

bool OAIPostBankAccount_request::is_customer_id_Valid() const{
    return m_customer_id_isValid;
}

QString OAIPostBankAccount_request::getToken() const {
    return m_token;
}
void OAIPostBankAccount_request::setToken(const QString &token) {
    m_token = token;
    m_token_isSet = true;
}

bool OAIPostBankAccount_request::is_token_Set() const{
    return m_token_isSet;
}

bool OAIPostBankAccount_request::is_token_Valid() const{
    return m_token_isValid;
}

QString OAIPostBankAccount_request::getAccountNumber() const {
    return m_account_number;
}
void OAIPostBankAccount_request::setAccountNumber(const QString &account_number) {
    m_account_number = account_number;
    m_account_number_isSet = true;
}

bool OAIPostBankAccount_request::is_account_number_Set() const{
    return m_account_number_isSet;
}

bool OAIPostBankAccount_request::is_account_number_Valid() const{
    return m_account_number_isValid;
}

QString OAIPostBankAccount_request::getAccountNumberType() const {
    return m_account_number_type;
}
void OAIPostBankAccount_request::setAccountNumberType(const QString &account_number_type) {
    m_account_number_type = account_number_type;
    m_account_number_type_isSet = true;
}

bool OAIPostBankAccount_request::is_account_number_type_Set() const{
    return m_account_number_type_isSet;
}

bool OAIPostBankAccount_request::is_account_number_type_Valid() const{
    return m_account_number_type_isValid;
}

QString OAIPostBankAccount_request::getAccountType() const {
    return m_account_type;
}
void OAIPostBankAccount_request::setAccountType(const QString &account_type) {
    m_account_type = account_type;
    m_account_type_isSet = true;
}

bool OAIPostBankAccount_request::is_account_type_Set() const{
    return m_account_type_isSet;
}

bool OAIPostBankAccount_request::is_account_type_Valid() const{
    return m_account_type_isValid;
}

QString OAIPostBankAccount_request::getBankName() const {
    return m_bank_name;
}
void OAIPostBankAccount_request::setBankName(const QString &bank_name) {
    m_bank_name = bank_name;
    m_bank_name_isSet = true;
}

bool OAIPostBankAccount_request::is_bank_name_Set() const{
    return m_bank_name_isSet;
}

bool OAIPostBankAccount_request::is_bank_name_Valid() const{
    return m_bank_name_isValid;
}

QString OAIPostBankAccount_request::getBic() const {
    return m_bic;
}
void OAIPostBankAccount_request::setBic(const QString &bic) {
    m_bic = bic;
    m_bic_isSet = true;
}

bool OAIPostBankAccount_request::is_bic_Set() const{
    return m_bic_isSet;
}

bool OAIPostBankAccount_request::is_bic_Valid() const{
    return m_bic_isValid;
}

OAIContactObject OAIPostBankAccount_request::getBillingAddress() const {
    return m_billing_address;
}
void OAIPostBankAccount_request::setBillingAddress(const OAIContactObject &billing_address) {
    m_billing_address = billing_address;
    m_billing_address_isSet = true;
}

bool OAIPostBankAccount_request::is_billing_address_Set() const{
    return m_billing_address_isSet;
}

bool OAIPostBankAccount_request::is_billing_address_Valid() const{
    return m_billing_address_isValid;
}

QString OAIPostBankAccount_request::getMethod() const {
    return m_method;
}
void OAIPostBankAccount_request::setMethod(const QString &method) {
    m_method = method;
    m_method_isSet = true;
}

bool OAIPostBankAccount_request::is_method_Set() const{
    return m_method_isSet;
}

bool OAIPostBankAccount_request::is_method_Valid() const{
    return m_method_isValid;
}

OAIRiskMetadata OAIPostBankAccount_request::getRiskMetadata() const {
    return m_risk_metadata;
}
void OAIPostBankAccount_request::setRiskMetadata(const OAIRiskMetadata &risk_metadata) {
    m_risk_metadata = risk_metadata;
    m_risk_metadata_isSet = true;
}

bool OAIPostBankAccount_request::is_risk_metadata_Set() const{
    return m_risk_metadata_isSet;
}

bool OAIPostBankAccount_request::is_risk_metadata_Valid() const{
    return m_risk_metadata_isValid;
}

QString OAIPostBankAccount_request::getRoutingNumber() const {
    return m_routing_number;
}
void OAIPostBankAccount_request::setRoutingNumber(const QString &routing_number) {
    m_routing_number = routing_number;
    m_routing_number_isSet = true;
}

bool OAIPostBankAccount_request::is_routing_number_Set() const{
    return m_routing_number_isSet;
}

bool OAIPostBankAccount_request::is_routing_number_Valid() const{
    return m_routing_number_isValid;
}

bool OAIPostBankAccount_request::isSet() const {
...
bool OAIPostBankAccount_request::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_customer_id_isValid && m_token_isValid && m_account_number_isValid && m_account_number_type_isValid && m_account_type_isValid && m_billing_address_isValid && m_method_isValid && m_routing_number_isValid && true;
}
