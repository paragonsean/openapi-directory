...
#include "OAIPaysafe_allOf_credentials.h"
#include <QDateTime>
#include <QList>
#include <QString>
...
class OAIPaysafe_allOf_credentials;
class OAIPaysafe3dsServers;

class OAIPaysafe : public OAIObject {
public:
    OAIPaysafe();
    OAIPaysafe(QString json);
    ~OAIPaysafe() override;
    ...
    OAIPaysafe_allOf_credentials getCredentials() const;
    void setCredentials(const OAIPaysafe_allOf_credentials &credentials);
    bool is_credentials_Set() const;
    bool is_credentials_Valid() const;

    OAIPaysafe3dsServers getThreeDSecureServer() const;
    void setThreeDSecureServer(const OAIPaysafe3dsServers &three_d_secure_server);
...
private:
    ...
    OAIPaysafe_allOf_credentials m_credentials;
    bool m_credentials_isSet;
    bool m_credentials_isValid;

    OAIPaysafe3dsServers m_three_d_secure_server;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPaysafe)
