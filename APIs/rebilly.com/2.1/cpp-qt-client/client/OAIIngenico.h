...
#ifndef OAIIngenico_H
#define OAIIngenico_H
...
class OAIIngenico_allOf_credentials;
class OAIIngenico3dsServers;

class OAIIngenico : public OAIObject {
public:
    OAIIngenico();
    OAIIngenico(QString json);
    ~OAIIngenico() override;
    ...
    OAIIngenico_allOf_credentials getCredentials() const;
    void setCredentials(const OAIIngenico_allOf_credentials &credentials);
    bool is_credentials_Set() const;
    bool is_credentials_Valid() const;

    OAIIngenico3dsServers getThreeDSecureServer() const;
    void setThreeDSecureServer(const OAIIngenico3dsServers &three_d_secure_server);
...
private:
    ...
    OAIIngenico_allOf_credentials m_credentials;
    bool m_credentials_isSet;
    bool m_credentials_isValid;

    OAIIngenico3dsServers m_three_d_secure_server;
...
Q_DECLARE_METATYPE(OpenAPI::OAIIngenico)
