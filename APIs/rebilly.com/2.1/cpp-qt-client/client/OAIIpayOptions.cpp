...
OAIIpayOptions::OAIIpayOptions(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIIpayOptions::OAIIpayOptions() {
    this->initializeModel();
}

OAIIpayOptions::~OAIIpayOptions() {}

void OAIIpayOptions::initializeModel() {
...
void OAIIpayOptions::fromJson(QString jsonString) {
...
void OAIIpayOptions::fromJsonObject(QJsonObject json) {
...
QString OAIIpayOptions::asJson() const {
...
QJsonObject OAIIpayOptions::asJsonObject() const {
    QJsonObject obj;
    if (m__links.size() > 0) {
...
QList<OAIGatewayAccount__links_inner> OAIIpayOptions::getLinks() const {
    return m__links;
}
void OAIIpayOptions::setLinks(const QList<OAIGatewayAccount__links_inner> &_links) {
    m__links = _links;
    m__links_isSet = true;
}

bool OAIIpayOptions::is__links_Set() const{
    return m__links_isSet;
}

bool OAIIpayOptions::is__links_Valid() const{
    return m__links_isValid;
}

QList<QString> OAIIpayOptions::getAcceptedCurrencies() const {
    return m_accepted_currencies;
}
void OAIIpayOptions::setAcceptedCurrencies(const QList<QString> &accepted_currencies) {
    m_accepted_currencies = accepted_currencies;
    m_accepted_currencies_isSet = true;
}

bool OAIIpayOptions::is_accepted_currencies_Set() const{
    return m_accepted_currencies_isSet;
}

bool OAIIpayOptions::is_accepted_currencies_Valid() const{
    return m_accepted_currencies_isValid;
}

OAIAcquirerName OAIIpayOptions::getAcquirerName() const {
    return m_acquirer_name;
}
void OAIIpayOptions::setAcquirerName(const OAIAcquirerName &acquirer_name) {
    m_acquirer_name = acquirer_name;
    m_acquirer_name_isSet = true;
}

bool OAIIpayOptions::is_acquirer_name_Set() const{
    return m_acquirer_name_isSet;
}

bool OAIIpayOptions::is_acquirer_name_Valid() const{
    return m_acquirer_name_isValid;
}

QString OAIIpayOptions::getAdditionalFilters() const {
    return m_additional_filters;
}
void OAIIpayOptions::setAdditionalFilters(const QString &additional_filters) {
    m_additional_filters = additional_filters;
    m_additional_filters_isSet = true;
}

bool OAIIpayOptions::is_additional_filters_Set() const{
    return m_additional_filters_isSet;
}

bool OAIIpayOptions::is_additional_filters_Valid() const{
    return m_additional_filters_isValid;
}

qint32 OAIIpayOptions::getApprovalWindowTtl() const {
    return m_approval_window_ttl;
}
void OAIIpayOptions::setApprovalWindowTtl(const qint32 &approval_window_ttl) {
    m_approval_window_ttl = approval_window_ttl;
    m_approval_window_ttl_isSet = true;
}

bool OAIIpayOptions::is_approval_window_ttl_Set() const{
    return m_approval_window_ttl_isSet;
}

bool OAIIpayOptions::is_approval_window_ttl_Valid() const{
    return m_approval_window_ttl_isValid;
}

QString OAIIpayOptions::getCityField() const {
    return m_city_field;
}
void OAIIpayOptions::setCityField(const QString &city_field) {
    m_city_field = city_field;
    m_city_field_isSet = true;
}

bool OAIIpayOptions::is_city_field_Set() const{
    return m_city_field_isSet;
}

bool OAIIpayOptions::is_city_field_Valid() const{
    return m_city_field_isValid;
}

QDateTime OAIIpayOptions::getCreatedTime() const {
    return m_created_time;
}
void OAIIpayOptions::setCreatedTime(const QDateTime &created_time) {
    m_created_time = created_time;
    m_created_time_isSet = true;
}

bool OAIIpayOptions::is_created_time_Set() const{
    return m_created_time_isSet;
}

bool OAIIpayOptions::is_created_time_Valid() const{
    return m_created_time_isValid;
}

QString OAIIpayOptions::getDccForceCurrency() const {
    return m_dcc_force_currency;
}
void OAIIpayOptions::setDccForceCurrency(const QString &dcc_force_currency) {
    m_dcc_force_currency = dcc_force_currency;
    m_dcc_force_currency_isSet = true;
}

bool OAIIpayOptions::is_dcc_force_currency_Set() const{
    return m_dcc_force_currency_isSet;
}

bool OAIIpayOptions::is_dcc_force_currency_Valid() const{
    return m_dcc_force_currency_isValid;
}

qint32 OAIIpayOptions::getDccMarkup() const {
    return m_dcc_markup;
}
void OAIIpayOptions::setDccMarkup(const qint32 &dcc_markup) {
    m_dcc_markup = dcc_markup;
    m_dcc_markup_isSet = true;
}

bool OAIIpayOptions::is_dcc_markup_Set() const{
    return m_dcc_markup_isSet;
}

bool OAIIpayOptions::is_dcc_markup_Valid() const{
    return m_dcc_markup_isValid;
}

QString OAIIpayOptions::getDescriptor() const {
    return m_descriptor;
}
void OAIIpayOptions::setDescriptor(const QString &descriptor) {
    m_descriptor = descriptor;
    m_descriptor_isSet = true;
}

bool OAIIpayOptions::is_descriptor_Set() const{
    return m_descriptor_isSet;
}

bool OAIIpayOptions::is_descriptor_Valid() const{
    return m_descriptor_isValid;
}

OAIDigitalWallets OAIIpayOptions::getDigitalWallets() const {
    return m_digital_wallets;
}
void OAIIpayOptions::setDigitalWallets(const OAIDigitalWallets &digital_wallets) {
    m_digital_wallets = digital_wallets;
    m_digital_wallets_isSet = true;
}

bool OAIIpayOptions::is_digital_wallets_Set() const{
    return m_digital_wallets_isSet;
}

bool OAIIpayOptions::is_digital_wallets_Valid() const{
    return m_digital_wallets_isValid;
}

bool OAIIpayOptions::isDynamicDescriptor() const {
    return m_dynamic_descriptor;
}
void OAIIpayOptions::setDynamicDescriptor(const bool &dynamic_descriptor) {
    m_dynamic_descriptor = dynamic_descriptor;
    m_dynamic_descriptor_isSet = true;
}

bool OAIIpayOptions::is_dynamic_descriptor_Set() const{
    return m_dynamic_descriptor_isSet;
}

bool OAIIpayOptions::is_dynamic_descriptor_Valid() const{
    return m_dynamic_descriptor_isValid;
}

QList<QString> OAIIpayOptions::getExcludedDccQuoteCurrencies() const {
    return m_excluded_dcc_quote_currencies;
}
void OAIIpayOptions::setExcludedDccQuoteCurrencies(const QList<QString> &excluded_dcc_quote_currencies) {
    m_excluded_dcc_quote_currencies = excluded_dcc_quote_currencies;
    m_excluded_dcc_quote_currencies_isSet = true;
}

bool OAIIpayOptions::is_excluded_dcc_quote_currencies_Set() const{
    return m_excluded_dcc_quote_currencies_isSet;
}

bool OAIIpayOptions::is_excluded_dcc_quote_currencies_Valid() const{
    return m_excluded_dcc_quote_currencies_isValid;
}

OAIGatewayName OAIIpayOptions::getGatewayName() const {
    return m_gateway_name;
}
void OAIIpayOptions::setGatewayName(const OAIGatewayName &gateway_name) {
    m_gateway_name = gateway_name;
    m_gateway_name_isSet = true;
}

bool OAIIpayOptions::is_gateway_name_Set() const{
    return m_gateway_name_isSet;
}

bool OAIIpayOptions::is_gateway_name_Valid() const{
    return m_gateway_name_isValid;
}

QString OAIIpayOptions::getId() const {
    return m_id;
}
void OAIIpayOptions::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIIpayOptions::is_id_Set() const{
    return m_id_isSet;
}

bool OAIIpayOptions::is_id_Valid() const{
    return m_id_isValid;
}

bool OAIIpayOptions::isIsDown() const {
    return m_is_down;
}
void OAIIpayOptions::setIsDown(const bool &is_down) {
    m_is_down = is_down;
    m_is_down_isSet = true;
}

bool OAIIpayOptions::is_is_down_Set() const{
    return m_is_down_isSet;
}

bool OAIIpayOptions::is_is_down_Valid() const{
    return m_is_down_isValid;
}

QString OAIIpayOptions::getMerchantCategoryCode() const {
    return m_merchant_category_code;
}
void OAIIpayOptions::setMerchantCategoryCode(const QString &merchant_category_code) {
    m_merchant_category_code = merchant_category_code;
    m_merchant_category_code_isSet = true;
}

bool OAIIpayOptions::is_merchant_category_code_Set() const{
    return m_merchant_category_code_isSet;
}

bool OAIIpayOptions::is_merchant_category_code_Valid() const{
    return m_merchant_category_code_isValid;
}

OAIPaymentMethod OAIIpayOptions::getMethod() const {
    return m_method;
}
void OAIIpayOptions::setMethod(const OAIPaymentMethod &method) {
    m_method = method;
    m_method_isSet = true;
}

bool OAIIpayOptions::is_method_Set() const{
    return m_method_isSet;
}

bool OAIIpayOptions::is_method_Valid() const{
    return m_method_isValid;
}

double OAIIpayOptions::getMonthlyLimit() const {
    return m_monthly_limit;
}
void OAIIpayOptions::setMonthlyLimit(const double &monthly_limit) {
    m_monthly_limit = monthly_limit;
    m_monthly_limit_isSet = true;
}

bool OAIIpayOptions::is_monthly_limit_Set() const{
    return m_monthly_limit_isSet;
}

bool OAIIpayOptions::is_monthly_limit_Valid() const{
    return m_monthly_limit_isValid;
}

QString OAIIpayOptions::getOrganizationId() const {
    return m_organization_id;
}
void OAIIpayOptions::setOrganizationId(const QString &organization_id) {
    m_organization_id = organization_id;
    m_organization_id_isSet = true;
}

bool OAIIpayOptions::is_organization_id_Set() const{
    return m_organization_id_isSet;
}

bool OAIIpayOptions::is_organization_id_Valid() const{
    return m_organization_id_isValid;
}

QList<OAIPaymentCardBrand> OAIIpayOptions::getPaymentCardSchemes() const {
    return m_payment_card_schemes;
}
void OAIIpayOptions::setPaymentCardSchemes(const QList<OAIPaymentCardBrand> &payment_card_schemes) {
    m_payment_card_schemes = payment_card_schemes;
    m_payment_card_schemes_isSet = true;
}

bool OAIIpayOptions::is_payment_card_schemes_Set() const{
    return m_payment_card_schemes_isSet;
}

bool OAIIpayOptions::is_payment_card_schemes_Valid() const{
    return m_payment_card_schemes_isValid;
}

bool OAIIpayOptions::isReconciliationWindowEnabled() const {
    return m_reconciliation_window_enabled;
}
void OAIIpayOptions::setReconciliationWindowEnabled(const bool &reconciliation_window_enabled) {
    m_reconciliation_window_enabled = reconciliation_window_enabled;
    m_reconciliation_window_enabled_isSet = true;
}

bool OAIIpayOptions::is_reconciliation_window_enabled_Set() const{
    return m_reconciliation_window_enabled_isSet;
}

bool OAIIpayOptions::is_reconciliation_window_enabled_Valid() const{
    return m_reconciliation_window_enabled_isValid;
}

qint32 OAIIpayOptions::getReconciliationWindowTtl() const {
    return m_reconciliation_window_ttl;
}
void OAIIpayOptions::setReconciliationWindowTtl(const qint32 &reconciliation_window_ttl) {
    m_reconciliation_window_ttl = reconciliation_window_ttl;
    m_reconciliation_window_ttl_isSet = true;
}

bool OAIIpayOptions::is_reconciliation_window_ttl_Set() const{
    return m_reconciliation_window_ttl_isSet;
}

bool OAIIpayOptions::is_reconciliation_window_ttl_Valid() const{
    return m_reconciliation_window_ttl_isValid;
}

QString OAIIpayOptions::getStatus() const {
    return m_status;
}
void OAIIpayOptions::setStatus(const QString &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIIpayOptions::is_status_Set() const{
    return m_status_isSet;
}

bool OAIIpayOptions::is_status_Valid() const{
    return m_status_isValid;
}

bool OAIIpayOptions::isSticky() const {
    return m_sticky;
}
void OAIIpayOptions::setSticky(const bool &sticky) {
    m_sticky = sticky;
    m_sticky_isSet = true;
}

bool OAIIpayOptions::is_sticky_Set() const{
    return m_sticky_isSet;
}

bool OAIIpayOptions::is_sticky_Valid() const{
    return m_sticky_isValid;
}

bool OAIIpayOptions::isThreeDSecure() const {
    return m_three_d_secure;
}
void OAIIpayOptions::setThreeDSecure(const bool &three_d_secure) {
    m_three_d_secure = three_d_secure;
    m_three_d_secure_isSet = true;
}

bool OAIIpayOptions::is_three_d_secure_Set() const{
    return m_three_d_secure_isSet;
}

bool OAIIpayOptions::is_three_d_secure_Valid() const{
    return m_three_d_secure_isValid;
}

qint32 OAIIpayOptions::getTimeout() const {
    return m_timeout;
}
void OAIIpayOptions::setTimeout(const qint32 &timeout) {
    m_timeout = timeout;
    m_timeout_isSet = true;
}

bool OAIIpayOptions::is_timeout_Set() const{
    return m_timeout_isSet;
}

bool OAIIpayOptions::is_timeout_Valid() const{
    return m_timeout_isValid;
}

QString OAIIpayOptions::getToken() const {
    return m_token;
}
void OAIIpayOptions::setToken(const QString &token) {
    m_token = token;
    m_token_isSet = true;
}

bool OAIIpayOptions::is_token_Set() const{
    return m_token_isSet;
}

bool OAIIpayOptions::is_token_Valid() const{
    return m_token_isValid;
}

QDateTime OAIIpayOptions::getUpdatedTime() const {
    return m_updated_time;
}
void OAIIpayOptions::setUpdatedTime(const QDateTime &updated_time) {
    m_updated_time = updated_time;
    m_updated_time_isSet = true;
}

bool OAIIpayOptions::is_updated_time_Set() const{
    return m_updated_time_isSet;
}

bool OAIIpayOptions::is_updated_time_Valid() const{
    return m_updated_time_isValid;
}

OAIIpayOptions_allOf_credentials OAIIpayOptions::getCredentials() const {
    return m_credentials;
}
void OAIIpayOptions::setCredentials(const OAIIpayOptions_allOf_credentials &credentials) {
    m_credentials = credentials;
    m_credentials_isSet = true;
}

bool OAIIpayOptions::is_credentials_Set() const{
    return m_credentials_isSet;
}

bool OAIIpayOptions::is_credentials_Valid() const{
    return m_credentials_isValid;
}

OAIIpayOptions_allOf_settings OAIIpayOptions::getSettings() const {
    return m_settings;
}
void OAIIpayOptions::setSettings(const OAIIpayOptions_allOf_settings &settings) {
    m_settings = settings;
    m_settings_isSet = true;
}

bool OAIIpayOptions::is_settings_Set() const{
    return m_settings_isSet;
}

bool OAIIpayOptions::is_settings_Valid() const{
    return m_settings_isValid;
}

bool OAIIpayOptions::isSet() const {
...
bool OAIIpayOptions::isValid() const {
