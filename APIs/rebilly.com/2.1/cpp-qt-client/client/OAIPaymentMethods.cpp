...
QList<OAIPaymentMethod> OAIPaymentMethods::getMethods() const {
    return m_methods;
}
void OAIPaymentMethods::setMethods(const QList<OAIPaymentMethod> &methods) {
    m_methods = methods;
    m_methods_isSet = true;
}

bool OAIPaymentMethods::is_methods_Set() const{
    return m_methods_isSet;
}

bool OAIPaymentMethods::is_methods_Valid() const{
