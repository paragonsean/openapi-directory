...
/*
 * OAIVCreditos_allOf_credentials.h
 *
 * VCreditos credentials object.
 */

#ifndef OAIVCreditos_allOf_credentials_H
#define OAIVCreditos_allOf_credentials_H
...
class OAIVCreditos_allOf_credentials : public OAIObject {
public:
    OAIVCreditos_allOf_credentials();
    OAIVCreditos_allOf_credentials(QString json);
    ~OAIVCreditos_allOf_credentials() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIVCreditos_allOf_credentials)

#endif // OAIVCreditos_allOf_credentials_H
