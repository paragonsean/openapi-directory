...
QString OAIPercent::getType() const {
    return m_type;
}
void OAIPercent::setType(const QString &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAIPercent::is_type_Set() const{
    return m_type_isSet;
}

bool OAIPercent::is_type_Valid() const{
    return m_type_isValid;
}

double OAIPercent::getValue() const {
    return m_value;
}
void OAIPercent::setValue(const double &value) {
    m_value = value;
    m_value_isSet = true;
}

bool OAIPercent::is_value_Set() const{
    return m_value_isSet;
}

bool OAIPercent::is_value_Valid() const{
