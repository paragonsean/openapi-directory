...
#include "OAIPayCash_allOf_credentials.h"
...
class OAIPayCash_allOf_credentials;

class OAIPayCash : public OAIObject {
public:
    OAIPayCash();
    OAIPayCash(QString json);
    ~OAIPayCash() override;
    ...
    OAIPayCash_allOf_credentials getCredentials() const;
    void setCredentials(const OAIPayCash_allOf_credentials &credentials);
...
private:
    ...
    OAIPayCash_allOf_credentials m_credentials;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPayCash)
