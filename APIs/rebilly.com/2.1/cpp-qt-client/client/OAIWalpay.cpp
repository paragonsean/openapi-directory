...
OAIWalpay::OAIWalpay(QString json) {
...
void OAIWalpay::initializeModel() {
...
void OAIWalpay::fromJson(QString jsonString) {
...
void OAIWalpay::fromJsonObject(QJsonObject json) {
...
QString OAIWalpay::asJson() const {
...
QJsonObject OAIWalpay::asJsonObject() const {
    QJsonObject obj;
    if (m__links.size() > 0) {
...
QList<OAIGatewayAccount__links_inner> OAIWalpay::getLinks() const {
    return m__links;
}
void OAIWalpay::setLinks(const QList<OAIGatewayAccount__links_inner> &_links) {
    m__links = _links;
    m__links_isSet = true;
}

bool OAIWalpay::is__links_Set() const{
    return m__links_isSet;
}

bool OAIWalpay::is__links_Valid() const{
    return m__links_isValid;
}

QList<QString> OAIWalpay::getAcceptedCurrencies() const {
    return m_accepted_currencies;
}
void OAIWalpay::setAcceptedCurrencies(const QList<QString> &accepted_currencies) {
    m_accepted_currencies = accepted_currencies;
    m_accepted_currencies_isSet = true;
}

bool OAIWalpay::is_accepted_currencies_Set() const{
    return m_accepted_currencies_isSet;
}

bool OAIWalpay::is_accepted_currencies_Valid() const{
    return m_accepted_currencies_isValid;
}

OAIAcquirerName OAIWalpay::getAcquirerName() const {
    return m_acquirer_name;
}
void OAIWalpay::setAcquirerName(const OAIAcquirerName &acquirer_name) {
    m_acquirer_name = acquirer_name;
    m_acquirer_name_isSet = true;
}

bool OAIWalpay::is_acquirer_name_Set() const{
    return m_acquirer_name_isSet;
}

bool OAIWalpay::is_acquirer_name_Valid() const{
    return m_acquirer_name_isValid;
}

QString OAIWalpay::getAdditionalFilters() const {
    return m_additional_filters;
}
void OAIWalpay::setAdditionalFilters(const QString &additional_filters) {
    m_additional_filters = additional_filters;
    m_additional_filters_isSet = true;
}

bool OAIWalpay::is_additional_filters_Set() const{
    return m_additional_filters_isSet;
}

bool OAIWalpay::is_additional_filters_Valid() const{
    return m_additional_filters_isValid;
}

qint32 OAIWalpay::getApprovalWindowTtl() const {
    return m_approval_window_ttl;
}
void OAIWalpay::setApprovalWindowTtl(const qint32 &approval_window_ttl) {
    m_approval_window_ttl = approval_window_ttl;
    m_approval_window_ttl_isSet = true;
}

bool OAIWalpay::is_approval_window_ttl_Set() const{
    return m_approval_window_ttl_isSet;
}

bool OAIWalpay::is_approval_window_ttl_Valid() const{
    return m_approval_window_ttl_isValid;
}

QString OAIWalpay::getCityField() const {
    return m_city_field;
}
void OAIWalpay::setCityField(const QString &city_field) {
    m_city_field = city_field;
    m_city_field_isSet = true;
}

bool OAIWalpay::is_city_field_Set() const{
    return m_city_field_isSet;
}

bool OAIWalpay::is_city_field_Valid() const{
    return m_city_field_isValid;
}

QDateTime OAIWalpay::getCreatedTime() const {
    return m_created_time;
}
void OAIWalpay::setCreatedTime(const QDateTime &created_time) {
    m_created_time = created_time;
    m_created_time_isSet = true;
}

bool OAIWalpay::is_created_time_Set() const{
    return m_created_time_isSet;
}

bool OAIWalpay::is_created_time_Valid() const{
    return m_created_time_isValid;
}

QString OAIWalpay::getDccForceCurrency() const {
    return m_dcc_force_currency;
}
void OAIWalpay::setDccForceCurrency(const QString &dcc_force_currency) {
    m_dcc_force_currency = dcc_force_currency;
    m_dcc_force_currency_isSet = true;
}

bool OAIWalpay::is_dcc_force_currency_Set() const{
    return m_dcc_force_currency_isSet;
}

bool OAIWalpay::is_dcc_force_currency_Valid() const{
    return m_dcc_force_currency_isValid;
}

qint32 OAIWalpay::getDccMarkup() const {
    return m_dcc_markup;
}
void OAIWalpay::setDccMarkup(const qint32 &dcc_markup) {
    m_dcc_markup = dcc_markup;
    m_dcc_markup_isSet = true;
}

bool OAIWalpay::is_dcc_markup_Set() const{
    return m_dcc_markup_isSet;
}

bool OAIWalpay::is_dcc_markup_Valid() const{
    return m_dcc_markup_isValid;
}

QString OAIWalpay::getDescriptor() const {
    return m_descriptor;
}
void OAIWalpay::setDescriptor(const QString &descriptor) {
    m_descriptor = descriptor;
    m_descriptor_isSet = true;
}

bool OAIWalpay::is_descriptor_Set() const{
    return m_descriptor_isSet;
}

bool OAIWalpay::is_descriptor_Valid() const{
    return m_descriptor_isValid;
}

OAIDigitalWallets OAIWalpay::getDigitalWallets() const {
    return m_digital_wallets;
}
void OAIWalpay::setDigitalWallets(const OAIDigitalWallets &digital_wallets) {
    m_digital_wallets = digital_wallets;
    m_digital_wallets_isSet = true;
}

bool OAIWalpay::is_digital_wallets_Set() const{
    return m_digital_wallets_isSet;
}

bool OAIWalpay::is_digital_wallets_Valid() const{
    return m_digital_wallets_isValid;
}

bool OAIWalpay::isDynamicDescriptor() const {
    return m_dynamic_descriptor;
}
void OAIWalpay::setDynamicDescriptor(const bool &dynamic_descriptor) {
    m_dynamic_descriptor = dynamic_descriptor;
    m_dynamic_descriptor_isSet = true;
}

bool OAIWalpay::is_dynamic_descriptor_Set() const{
    return m_dynamic_descriptor_isSet;
}

bool OAIWalpay::is_dynamic_descriptor_Valid() const{
    return m_dynamic_descriptor_isValid;
}

QList<QString> OAIWalpay::getExcludedDccQuoteCurrencies() const {
    return m_excluded_dcc_quote_currencies;
}
void OAIWalpay::setExcludedDccQuoteCurrencies(const QList<QString> &excluded_dcc_quote_currencies) {
    m_excluded_dcc_quote_currencies = excluded_dcc_quote_currencies;
    m_excluded_dcc_quote_currencies_isSet = true;
}

bool OAIWalpay::is_excluded_dcc_quote_currencies_Set() const{
    return m_excluded_dcc_quote_currencies_isSet;
}

bool OAIWalpay::is_excluded_dcc_quote_currencies_Valid() const{
    return m_excluded_dcc_quote_currencies_isValid;
}

OAIGatewayName OAIWalpay::getGatewayName() const {
    return m_gateway_name;
}
void OAIWalpay::setGatewayName(const OAIGatewayName &gateway_name) {
    m_gateway_name = gateway_name;
    m_gateway_name_isSet = true;
}

bool OAIWalpay::is_gateway_name_Set() const{
    return m_gateway_name_isSet;
}

bool OAIWalpay::is_gateway_name_Valid() const{
    return m_gateway_name_isValid;
}

QString OAIWalpay::getId() const {
    return m_id;
}
void OAIWalpay::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIWalpay::is_id_Set() const{
    return m_id_isSet;
}

bool OAIWalpay::is_id_Valid() const{
    return m_id_isValid;
}

bool OAIWalpay::isIsDown() const {
    return m_is_down;
}
void OAIWalpay::setIsDown(const bool &is_down) {
    m_is_down = is_down;
    m_is_down_isSet = true;
}

bool OAIWalpay::is_is_down_Set() const{
    return m_is_down_isSet;
}

bool OAIWalpay::is_is_down_Valid() const{
    return m_is_down_isValid;
}

QString OAIWalpay::getMerchantCategoryCode() const {
    return m_merchant_category_code;
}
void OAIWalpay::setMerchantCategoryCode(const QString &merchant_category_code) {
    m_merchant_category_code = merchant_category_code;
    m_merchant_category_code_isSet = true;
}

bool OAIWalpay::is_merchant_category_code_Set() const{
    return m_merchant_category_code_isSet;
}

bool OAIWalpay::is_merchant_category_code_Valid() const{
    return m_merchant_category_code_isValid;
}

OAIPaymentMethod OAIWalpay::getMethod() const {
    return m_method;
}
void OAIWalpay::setMethod(const OAIPaymentMethod &method) {
    m_method = method;
    m_method_isSet = true;
}

bool OAIWalpay::is_method_Set() const{
    return m_method_isSet;
}

bool OAIWalpay::is_method_Valid() const{
    return m_method_isValid;
}

double OAIWalpay::getMonthlyLimit() const {
    return m_monthly_limit;
}
void OAIWalpay::setMonthlyLimit(const double &monthly_limit) {
    m_monthly_limit = monthly_limit;
    m_monthly_limit_isSet = true;
}

bool OAIWalpay::is_monthly_limit_Set() const{
    return m_monthly_limit_isSet;
}

bool OAIWalpay::is_monthly_limit_Valid() const{
    return m_monthly_limit_isValid;
}

QString OAIWalpay::getOrganizationId() const {
    return m_organization_id;
}
void OAIWalpay::setOrganizationId(const QString &organization_id) {
    m_organization_id = organization_id;
    m_organization_id_isSet = true;
}

bool OAIWalpay::is_organization_id_Set() const{
    return m_organization_id_isSet;
}

bool OAIWalpay::is_organization_id_Valid() const{
    return m_organization_id_isValid;
}

QList<OAIPaymentCardBrand> OAIWalpay::getPaymentCardSchemes() const {
    return m_payment_card_schemes;
}
void OAIWalpay::setPaymentCardSchemes(const QList<OAIPaymentCardBrand> &payment_card_schemes) {
    m_payment_card_schemes = payment_card_schemes;
    m_payment_card_schemes_isSet = true;
}

bool OAIWalpay::is_payment_card_schemes_Set() const{
    return m_payment_card_schemes_isSet;
}

bool OAIWalpay::is_payment_card_schemes_Valid() const{
    return m_payment_card_schemes_isValid;
}

bool OAIWalpay::isReconciliationWindowEnabled() const {
    return m_reconciliation_window_enabled;
}
void OAIWalpay::setReconciliationWindowEnabled(const bool &reconciliation_window_enabled) {
    m_reconciliation_window_enabled = reconciliation_window_enabled;
    m_reconciliation_window_enabled_isSet = true;
}

bool OAIWalpay::is_reconciliation_window_enabled_Set() const{
    return m_reconciliation_window_enabled_isSet;
}

bool OAIWalpay::is_reconciliation_window_enabled_Valid() const{
    return m_reconciliation_window_enabled_isValid;
}

qint32 OAIWalpay::getReconciliationWindowTtl() const {
    return m_reconciliation_window_ttl;
}
void OAIWalpay::setReconciliationWindowTtl(const qint32 &reconciliation_window_ttl) {
    m_reconciliation_window_ttl = reconciliation_window_ttl;
    m_reconciliation_window_ttl_isSet = true;
}

bool OAIWalpay::is_reconciliation_window_ttl_Set() const{
    return m_reconciliation_window_ttl_isSet;
}

bool OAIWalpay::is_reconciliation_window_ttl_Valid() const{
    return m_reconciliation_window_ttl_isValid;
}

QString OAIWalpay::getStatus() const {
    return m_status;
}
void OAIWalpay::setStatus(const QString &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIWalpay::is_status_Set() const{
    return m_status_isSet;
}

bool OAIWalpay::is_status_Valid() const{
    return m_status_isValid;
}

bool OAIWalpay::isSticky() const {
    return m_sticky;
}
void OAIWalpay::setSticky(const bool &sticky) {
    m_sticky = sticky;
    m_sticky_isSet = true;
}

bool OAIWalpay::is_sticky_Set() const{
    return m_sticky_isSet;
}

bool OAIWalpay::is_sticky_Valid() const{
    return m_sticky_isValid;
}

bool OAIWalpay::isThreeDSecure() const {
    return m_three_d_secure;
}
void OAIWalpay::setThreeDSecure(const bool &three_d_secure) {
    m_three_d_secure = three_d_secure;
    m_three_d_secure_isSet = true;
}

bool OAIWalpay::is_three_d_secure_Set() const{
    return m_three_d_secure_isSet;
}

bool OAIWalpay::is_three_d_secure_Valid() const{
    return m_three_d_secure_isValid;
}

qint32 OAIWalpay::getTimeout() const {
    return m_timeout;
}
void OAIWalpay::setTimeout(const qint32 &timeout) {
    m_timeout = timeout;
    m_timeout_isSet = true;
}

bool OAIWalpay::is_timeout_Set() const{
    return m_timeout_isSet;
}

bool OAIWalpay::is_timeout_Valid() const{
    return m_timeout_isValid;
}

QString OAIWalpay::getToken() const {
    return m_token;
}
void OAIWalpay::setToken(const QString &token) {
    m_token = token;
    m_token_isSet = true;
}

bool OAIWalpay::is_token_Set() const{
    return m_token_isSet;
}

bool OAIWalpay::is_token_Valid() const{
    return m_token_isValid;
}

QDateTime OAIWalpay::getUpdatedTime() const {
    return m_updated_time;
}
void OAIWalpay::setUpdatedTime(const QDateTime &updated_time) {
    m_updated_time = updated_time;
    m_updated_time_isSet = true;
}

bool OAIWalpay::is_updated_time_Set() const{
    return m_updated_time_isSet;
}

bool OAIWalpay::is_updated_time_Valid() const{
    return m_updated_time_isValid;
}

OAIWalpay_allOf_credentials OAIWalpay::getCredentials() const {
    return m_credentials;
}
void OAIWalpay::setCredentials(const OAIWalpay_allOf_credentials &credentials) {
    m_credentials = credentials;
    m_credentials_isSet = true;
}

bool OAIWalpay::is_credentials_Set() const{
    return m_credentials_isSet;
}

bool OAIWalpay::is_credentials_Valid() const{
    return m_credentials_isValid;
}

OAIWalpay3dsServers OAIWalpay::getThreeDSecureServer() const {
    return m_three_d_secure_server;
}
void OAIWalpay::setThreeDSecureServer(const OAIWalpay3dsServers &three_d_secure_server) {
    m_three_d_secure_server = three_d_secure_server;
    m_three_d_secure_server_isSet = true;
}

bool OAIWalpay::is_three_d_secure_server_Set() const{
    return m_three_d_secure_server_isSet;
}

bool OAIWalpay::is_three_d_secure_server_Valid() const{
    return m_three_d_secure_server_isValid;
}

bool OAIWalpay::isSet() const {
