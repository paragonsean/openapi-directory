...
#include "OAIJeton_allOf_credentials.h"
#include "OAIJeton_allOf_settings.h"
...
class OAIJeton_allOf_credentials;
class OAIJeton_allOf_settings;

class OAIJeton : public OAIObject {
public:
    OAIJeton();
    OAIJeton(QString json);
    ~OAIJeton() override;
    ...
    OAIJeton_allOf_credentials getCredentials() const;
    void setCredentials(const OAIJeton_allOf_credentials &credentials);
    bool is_credentials_Set() const;
    bool is_credentials_Valid() const;

    OAIJeton_allOf_settings getSettings() const;
    void setSettings(const OAIJeton_allOf_settings &settings);
...
private:
    ...
    OAIJeton_allOf_credentials m_credentials;
    bool m_credentials_isSet;
    bool m_credentials_isValid;

    OAIJeton_allOf_settings m_settings;
...
Q_DECLARE_METATYPE(OpenAPI::OAIJeton)
