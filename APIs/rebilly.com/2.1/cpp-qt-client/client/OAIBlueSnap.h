...
#ifndef OAIBlueSnap_H
#define OAIBlueSnap_H

#include <QJsonObject>

#include "OAIAcquirerName.h"
#include "OAIBlueSnap_allOf_credentials.h"
...
class OAIBlueSnap_allOf_credentials;

class OAIBlueSnap : public OAIObject {
public:
    OAIBlueSnap();
    OAIBlueSnap(QString json);
    ~OAIBlueSnap() override;
    ...
    OAIBlueSnap_allOf_credentials getCredentials() const;
    void setCredentials(const OAIBlueSnap_allOf_credentials &credentials);
...
private:
    ...
    OAIBlueSnap_allOf_credentials m_credentials;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBlueSnap)
