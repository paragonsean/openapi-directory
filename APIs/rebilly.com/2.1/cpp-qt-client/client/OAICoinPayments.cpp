...
OAICoinPayments::OAICoinPayments(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICoinPayments::OAICoinPayments() {
    this->initializeModel();
}

OAICoinPayments::~OAICoinPayments() {}

void OAICoinPayments::initializeModel() {
...
void OAICoinPayments::fromJson(QString jsonString) {
...
void OAICoinPayments::fromJsonObject(QJsonObject json) {
...
QString OAICoinPayments::asJson() const {
...
QJsonObject OAICoinPayments::asJsonObject() const {
    QJsonObject obj;
    if (m__links.size() > 0) {
...
QList<OAIGatewayAccount__links_inner> OAICoinPayments::getLinks() const {
    return m__links;
}
void OAICoinPayments::setLinks(const QList<OAIGatewayAccount__links_inner> &_links) {
    m__links = _links;
    m__links_isSet = true;
}

bool OAICoinPayments::is__links_Set() const{
    return m__links_isSet;
}

bool OAICoinPayments::is__links_Valid() const{
    return m__links_isValid;
}

QList<QString> OAICoinPayments::getAcceptedCurrencies() const {
    return m_accepted_currencies;
}
void OAICoinPayments::setAcceptedCurrencies(const QList<QString> &accepted_currencies) {
    m_accepted_currencies = accepted_currencies;
    m_accepted_currencies_isSet = true;
}

bool OAICoinPayments::is_accepted_currencies_Set() const{
    return m_accepted_currencies_isSet;
}

bool OAICoinPayments::is_accepted_currencies_Valid() const{
    return m_accepted_currencies_isValid;
}

OAIAcquirerName OAICoinPayments::getAcquirerName() const {
    return m_acquirer_name;
}
void OAICoinPayments::setAcquirerName(const OAIAcquirerName &acquirer_name) {
    m_acquirer_name = acquirer_name;
    m_acquirer_name_isSet = true;
}

bool OAICoinPayments::is_acquirer_name_Set() const{
    return m_acquirer_name_isSet;
}

bool OAICoinPayments::is_acquirer_name_Valid() const{
    return m_acquirer_name_isValid;
}

QString OAICoinPayments::getAdditionalFilters() const {
    return m_additional_filters;
}
void OAICoinPayments::setAdditionalFilters(const QString &additional_filters) {
    m_additional_filters = additional_filters;
    m_additional_filters_isSet = true;
}

bool OAICoinPayments::is_additional_filters_Set() const{
    return m_additional_filters_isSet;
}

bool OAICoinPayments::is_additional_filters_Valid() const{
    return m_additional_filters_isValid;
}

qint32 OAICoinPayments::getApprovalWindowTtl() const {
    return m_approval_window_ttl;
}
void OAICoinPayments::setApprovalWindowTtl(const qint32 &approval_window_ttl) {
    m_approval_window_ttl = approval_window_ttl;
    m_approval_window_ttl_isSet = true;
}

bool OAICoinPayments::is_approval_window_ttl_Set() const{
    return m_approval_window_ttl_isSet;
}

bool OAICoinPayments::is_approval_window_ttl_Valid() const{
    return m_approval_window_ttl_isValid;
}

QString OAICoinPayments::getCityField() const {
    return m_city_field;
}
void OAICoinPayments::setCityField(const QString &city_field) {
    m_city_field = city_field;
    m_city_field_isSet = true;
}

bool OAICoinPayments::is_city_field_Set() const{
    return m_city_field_isSet;
}

bool OAICoinPayments::is_city_field_Valid() const{
    return m_city_field_isValid;
}

QDateTime OAICoinPayments::getCreatedTime() const {
    return m_created_time;
}
void OAICoinPayments::setCreatedTime(const QDateTime &created_time) {
    m_created_time = created_time;
    m_created_time_isSet = true;
}

bool OAICoinPayments::is_created_time_Set() const{
    return m_created_time_isSet;
}

bool OAICoinPayments::is_created_time_Valid() const{
    return m_created_time_isValid;
}

QString OAICoinPayments::getDccForceCurrency() const {
    return m_dcc_force_currency;
}
void OAICoinPayments::setDccForceCurrency(const QString &dcc_force_currency) {
    m_dcc_force_currency = dcc_force_currency;
    m_dcc_force_currency_isSet = true;
}

bool OAICoinPayments::is_dcc_force_currency_Set() const{
    return m_dcc_force_currency_isSet;
}

bool OAICoinPayments::is_dcc_force_currency_Valid() const{
    return m_dcc_force_currency_isValid;
}

qint32 OAICoinPayments::getDccMarkup() const {
    return m_dcc_markup;
}
void OAICoinPayments::setDccMarkup(const qint32 &dcc_markup) {
    m_dcc_markup = dcc_markup;
    m_dcc_markup_isSet = true;
}

bool OAICoinPayments::is_dcc_markup_Set() const{
    return m_dcc_markup_isSet;
}

bool OAICoinPayments::is_dcc_markup_Valid() const{
    return m_dcc_markup_isValid;
}

QString OAICoinPayments::getDescriptor() const {
    return m_descriptor;
}
void OAICoinPayments::setDescriptor(const QString &descriptor) {
    m_descriptor = descriptor;
    m_descriptor_isSet = true;
}

bool OAICoinPayments::is_descriptor_Set() const{
    return m_descriptor_isSet;
}

bool OAICoinPayments::is_descriptor_Valid() const{
    return m_descriptor_isValid;
}

OAIDigitalWallets OAICoinPayments::getDigitalWallets() const {
    return m_digital_wallets;
}
void OAICoinPayments::setDigitalWallets(const OAIDigitalWallets &digital_wallets) {
    m_digital_wallets = digital_wallets;
    m_digital_wallets_isSet = true;
}

bool OAICoinPayments::is_digital_wallets_Set() const{
    return m_digital_wallets_isSet;
}

bool OAICoinPayments::is_digital_wallets_Valid() const{
    return m_digital_wallets_isValid;
}

bool OAICoinPayments::isDynamicDescriptor() const {
    return m_dynamic_descriptor;
}
void OAICoinPayments::setDynamicDescriptor(const bool &dynamic_descriptor) {
    m_dynamic_descriptor = dynamic_descriptor;
    m_dynamic_descriptor_isSet = true;
}

bool OAICoinPayments::is_dynamic_descriptor_Set() const{
    return m_dynamic_descriptor_isSet;
}

bool OAICoinPayments::is_dynamic_descriptor_Valid() const{
    return m_dynamic_descriptor_isValid;
}

QList<QString> OAICoinPayments::getExcludedDccQuoteCurrencies() const {
    return m_excluded_dcc_quote_currencies;
}
void OAICoinPayments::setExcludedDccQuoteCurrencies(const QList<QString> &excluded_dcc_quote_currencies) {
    m_excluded_dcc_quote_currencies = excluded_dcc_quote_currencies;
    m_excluded_dcc_quote_currencies_isSet = true;
}

bool OAICoinPayments::is_excluded_dcc_quote_currencies_Set() const{
    return m_excluded_dcc_quote_currencies_isSet;
}

bool OAICoinPayments::is_excluded_dcc_quote_currencies_Valid() const{
    return m_excluded_dcc_quote_currencies_isValid;
}

OAIGatewayName OAICoinPayments::getGatewayName() const {
    return m_gateway_name;
}
void OAICoinPayments::setGatewayName(const OAIGatewayName &gateway_name) {
    m_gateway_name = gateway_name;
    m_gateway_name_isSet = true;
}

bool OAICoinPayments::is_gateway_name_Set() const{
    return m_gateway_name_isSet;
}

bool OAICoinPayments::is_gateway_name_Valid() const{
    return m_gateway_name_isValid;
}

QString OAICoinPayments::getId() const {
    return m_id;
}
void OAICoinPayments::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAICoinPayments::is_id_Set() const{
    return m_id_isSet;
}

bool OAICoinPayments::is_id_Valid() const{
    return m_id_isValid;
}

bool OAICoinPayments::isIsDown() const {
    return m_is_down;
}
void OAICoinPayments::setIsDown(const bool &is_down) {
    m_is_down = is_down;
    m_is_down_isSet = true;
}

bool OAICoinPayments::is_is_down_Set() const{
    return m_is_down_isSet;
}

bool OAICoinPayments::is_is_down_Valid() const{
    return m_is_down_isValid;
}

QString OAICoinPayments::getMerchantCategoryCode() const {
    return m_merchant_category_code;
}
void OAICoinPayments::setMerchantCategoryCode(const QString &merchant_category_code) {
    m_merchant_category_code = merchant_category_code;
    m_merchant_category_code_isSet = true;
}

bool OAICoinPayments::is_merchant_category_code_Set() const{
    return m_merchant_category_code_isSet;
}

bool OAICoinPayments::is_merchant_category_code_Valid() const{
    return m_merchant_category_code_isValid;
}

OAIPaymentMethod OAICoinPayments::getMethod() const {
    return m_method;
}
void OAICoinPayments::setMethod(const OAIPaymentMethod &method) {
    m_method = method;
    m_method_isSet = true;
}

bool OAICoinPayments::is_method_Set() const{
    return m_method_isSet;
}

bool OAICoinPayments::is_method_Valid() const{
    return m_method_isValid;
}

double OAICoinPayments::getMonthlyLimit() const {
    return m_monthly_limit;
}
void OAICoinPayments::setMonthlyLimit(const double &monthly_limit) {
    m_monthly_limit = monthly_limit;
    m_monthly_limit_isSet = true;
}

bool OAICoinPayments::is_monthly_limit_Set() const{
    return m_monthly_limit_isSet;
}

bool OAICoinPayments::is_monthly_limit_Valid() const{
    return m_monthly_limit_isValid;
}

QString OAICoinPayments::getOrganizationId() const {
    return m_organization_id;
}
void OAICoinPayments::setOrganizationId(const QString &organization_id) {
    m_organization_id = organization_id;
    m_organization_id_isSet = true;
}

bool OAICoinPayments::is_organization_id_Set() const{
    return m_organization_id_isSet;
}

bool OAICoinPayments::is_organization_id_Valid() const{
    return m_organization_id_isValid;
}

QList<OAIPaymentCardBrand> OAICoinPayments::getPaymentCardSchemes() const {
    return m_payment_card_schemes;
}
void OAICoinPayments::setPaymentCardSchemes(const QList<OAIPaymentCardBrand> &payment_card_schemes) {
    m_payment_card_schemes = payment_card_schemes;
    m_payment_card_schemes_isSet = true;
}

bool OAICoinPayments::is_payment_card_schemes_Set() const{
    return m_payment_card_schemes_isSet;
}

bool OAICoinPayments::is_payment_card_schemes_Valid() const{
    return m_payment_card_schemes_isValid;
}

bool OAICoinPayments::isReconciliationWindowEnabled() const {
    return m_reconciliation_window_enabled;
}
void OAICoinPayments::setReconciliationWindowEnabled(const bool &reconciliation_window_enabled) {
    m_reconciliation_window_enabled = reconciliation_window_enabled;
    m_reconciliation_window_enabled_isSet = true;
}

bool OAICoinPayments::is_reconciliation_window_enabled_Set() const{
    return m_reconciliation_window_enabled_isSet;
}

bool OAICoinPayments::is_reconciliation_window_enabled_Valid() const{
    return m_reconciliation_window_enabled_isValid;
}

qint32 OAICoinPayments::getReconciliationWindowTtl() const {
    return m_reconciliation_window_ttl;
}
void OAICoinPayments::setReconciliationWindowTtl(const qint32 &reconciliation_window_ttl) {
    m_reconciliation_window_ttl = reconciliation_window_ttl;
    m_reconciliation_window_ttl_isSet = true;
}

bool OAICoinPayments::is_reconciliation_window_ttl_Set() const{
    return m_reconciliation_window_ttl_isSet;
}

bool OAICoinPayments::is_reconciliation_window_ttl_Valid() const{
    return m_reconciliation_window_ttl_isValid;
}

QString OAICoinPayments::getStatus() const {
    return m_status;
}
void OAICoinPayments::setStatus(const QString &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAICoinPayments::is_status_Set() const{
    return m_status_isSet;
}

bool OAICoinPayments::is_status_Valid() const{
    return m_status_isValid;
}

bool OAICoinPayments::isSticky() const {
    return m_sticky;
}
void OAICoinPayments::setSticky(const bool &sticky) {
    m_sticky = sticky;
    m_sticky_isSet = true;
}

bool OAICoinPayments::is_sticky_Set() const{
    return m_sticky_isSet;
}

bool OAICoinPayments::is_sticky_Valid() const{
    return m_sticky_isValid;
}

bool OAICoinPayments::isThreeDSecure() const {
    return m_three_d_secure;
}
void OAICoinPayments::setThreeDSecure(const bool &three_d_secure) {
    m_three_d_secure = three_d_secure;
    m_three_d_secure_isSet = true;
}

bool OAICoinPayments::is_three_d_secure_Set() const{
    return m_three_d_secure_isSet;
}

bool OAICoinPayments::is_three_d_secure_Valid() const{
    return m_three_d_secure_isValid;
}

qint32 OAICoinPayments::getTimeout() const {
    return m_timeout;
}
void OAICoinPayments::setTimeout(const qint32 &timeout) {
    m_timeout = timeout;
    m_timeout_isSet = true;
}

bool OAICoinPayments::is_timeout_Set() const{
    return m_timeout_isSet;
}

bool OAICoinPayments::is_timeout_Valid() const{
    return m_timeout_isValid;
}

QString OAICoinPayments::getToken() const {
    return m_token;
}
void OAICoinPayments::setToken(const QString &token) {
    m_token = token;
    m_token_isSet = true;
}

bool OAICoinPayments::is_token_Set() const{
    return m_token_isSet;
}

bool OAICoinPayments::is_token_Valid() const{
    return m_token_isValid;
}

QDateTime OAICoinPayments::getUpdatedTime() const {
    return m_updated_time;
}
void OAICoinPayments::setUpdatedTime(const QDateTime &updated_time) {
    m_updated_time = updated_time;
    m_updated_time_isSet = true;
}

bool OAICoinPayments::is_updated_time_Set() const{
    return m_updated_time_isSet;
}

bool OAICoinPayments::is_updated_time_Valid() const{
    return m_updated_time_isValid;
}

OAICoinPayments_allOf_credentials OAICoinPayments::getCredentials() const {
    return m_credentials;
}
void OAICoinPayments::setCredentials(const OAICoinPayments_allOf_credentials &credentials) {
    m_credentials = credentials;
    m_credentials_isSet = true;
}

bool OAICoinPayments::is_credentials_Set() const{
    return m_credentials_isSet;
}

bool OAICoinPayments::is_credentials_Valid() const{
    return m_credentials_isValid;
}

bool OAICoinPayments::isSet() const {
...
bool OAICoinPayments::isValid() const {
