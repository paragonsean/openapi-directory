...
#include "OAIBambora_allOf_credentials.h"
...
class OAIBambora_allOf_credentials;

class OAIBambora : public OAIObject {
public:
    OAIBambora();
    OAIBambora(QString json);
    ~OAIBambora() override;
    ...
    OAIBambora_allOf_credentials getCredentials() const;
    void setCredentials(const OAIBambora_allOf_credentials &credentials);
...
private:
    ...
    OAIBambora_allOf_credentials m_credentials;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBambora)
