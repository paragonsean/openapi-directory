...
class OAIZimpler_allOf_credentials;

class OAIZimpler : public OAIObject {
public:
    OAIZimpler();
    OAIZimpler(QString json);
    ~OAIZimpler() override;
    ...
    OAIZimpler_allOf_credentials getCredentials() const;
    void setCredentials(const OAIZimpler_allOf_credentials &credentials);
...
private:
    ...
    OAIZimpler_allOf_credentials m_credentials;
...
Q_DECLARE_METATYPE(OpenAPI::OAIZimpler)
