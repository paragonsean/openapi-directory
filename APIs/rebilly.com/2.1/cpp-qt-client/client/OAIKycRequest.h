...
#ifndef OAIKycRequest_H
#define OAIKycRequest_H
...
class OAIKycRequest : public OAIObject {
public:
    OAIKycRequest();
    OAIKycRequest(QString json);
    ~OAIKycRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIKycRequest)

#endif // OAIKycRequest_H
