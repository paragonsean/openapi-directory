...
#include "OAIFile__links_inner.h"
#include <QDateTime>
#include <QList>
#include <QString>
...
public:
    ...
    QList<OAIFile__links_inner> getLinks() const;
    void setLinks(const QList<OAIFile__links_inner> &_links);
...
private:
    ...
    QList<OAIFile__links_inner> m__links;
    bool m__links_isSet;
