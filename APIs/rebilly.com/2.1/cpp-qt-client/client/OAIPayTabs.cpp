...
OAIPayTabs::OAIPayTabs(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPayTabs::OAIPayTabs() {
    this->initializeModel();
}

OAIPayTabs::~OAIPayTabs() {}

void OAIPayTabs::initializeModel() {
...
void OAIPayTabs::fromJson(QString jsonString) {
...
void OAIPayTabs::fromJsonObject(QJsonObject json) {
...
QString OAIPayTabs::asJson() const {
...
QJsonObject OAIPayTabs::asJsonObject() const {
    QJsonObject obj;
    if (m__links.size() > 0) {
...
QList<OAIGatewayAccount__links_inner> OAIPayTabs::getLinks() const {
    return m__links;
}
void OAIPayTabs::setLinks(const QList<OAIGatewayAccount__links_inner> &_links) {
    m__links = _links;
    m__links_isSet = true;
}

bool OAIPayTabs::is__links_Set() const{
    return m__links_isSet;
}

bool OAIPayTabs::is__links_Valid() const{
    return m__links_isValid;
}

QList<QString> OAIPayTabs::getAcceptedCurrencies() const {
    return m_accepted_currencies;
}
void OAIPayTabs::setAcceptedCurrencies(const QList<QString> &accepted_currencies) {
    m_accepted_currencies = accepted_currencies;
    m_accepted_currencies_isSet = true;
}

bool OAIPayTabs::is_accepted_currencies_Set() const{
    return m_accepted_currencies_isSet;
}

bool OAIPayTabs::is_accepted_currencies_Valid() const{
    return m_accepted_currencies_isValid;
}

OAIAcquirerName OAIPayTabs::getAcquirerName() const {
    return m_acquirer_name;
}
void OAIPayTabs::setAcquirerName(const OAIAcquirerName &acquirer_name) {
    m_acquirer_name = acquirer_name;
    m_acquirer_name_isSet = true;
}

bool OAIPayTabs::is_acquirer_name_Set() const{
    return m_acquirer_name_isSet;
}

bool OAIPayTabs::is_acquirer_name_Valid() const{
    return m_acquirer_name_isValid;
}

QString OAIPayTabs::getAdditionalFilters() const {
    return m_additional_filters;
}
void OAIPayTabs::setAdditionalFilters(const QString &additional_filters) {
    m_additional_filters = additional_filters;
    m_additional_filters_isSet = true;
}

bool OAIPayTabs::is_additional_filters_Set() const{
    return m_additional_filters_isSet;
}

bool OAIPayTabs::is_additional_filters_Valid() const{
    return m_additional_filters_isValid;
}

qint32 OAIPayTabs::getApprovalWindowTtl() const {
    return m_approval_window_ttl;
}
void OAIPayTabs::setApprovalWindowTtl(const qint32 &approval_window_ttl) {
    m_approval_window_ttl = approval_window_ttl;
    m_approval_window_ttl_isSet = true;
}

bool OAIPayTabs::is_approval_window_ttl_Set() const{
    return m_approval_window_ttl_isSet;
}

bool OAIPayTabs::is_approval_window_ttl_Valid() const{
    return m_approval_window_ttl_isValid;
}

QString OAIPayTabs::getCityField() const {
    return m_city_field;
}
void OAIPayTabs::setCityField(const QString &city_field) {
    m_city_field = city_field;
    m_city_field_isSet = true;
}

bool OAIPayTabs::is_city_field_Set() const{
    return m_city_field_isSet;
}

bool OAIPayTabs::is_city_field_Valid() const{
    return m_city_field_isValid;
}

QDateTime OAIPayTabs::getCreatedTime() const {
    return m_created_time;
}
void OAIPayTabs::setCreatedTime(const QDateTime &created_time) {
    m_created_time = created_time;
    m_created_time_isSet = true;
}

bool OAIPayTabs::is_created_time_Set() const{
    return m_created_time_isSet;
}

bool OAIPayTabs::is_created_time_Valid() const{
    return m_created_time_isValid;
}

QString OAIPayTabs::getDccForceCurrency() const {
    return m_dcc_force_currency;
}
void OAIPayTabs::setDccForceCurrency(const QString &dcc_force_currency) {
    m_dcc_force_currency = dcc_force_currency;
    m_dcc_force_currency_isSet = true;
}

bool OAIPayTabs::is_dcc_force_currency_Set() const{
    return m_dcc_force_currency_isSet;
}

bool OAIPayTabs::is_dcc_force_currency_Valid() const{
    return m_dcc_force_currency_isValid;
}

qint32 OAIPayTabs::getDccMarkup() const {
    return m_dcc_markup;
}
void OAIPayTabs::setDccMarkup(const qint32 &dcc_markup) {
    m_dcc_markup = dcc_markup;
    m_dcc_markup_isSet = true;
}

bool OAIPayTabs::is_dcc_markup_Set() const{
    return m_dcc_markup_isSet;
}

bool OAIPayTabs::is_dcc_markup_Valid() const{
    return m_dcc_markup_isValid;
}

QString OAIPayTabs::getDescriptor() const {
    return m_descriptor;
}
void OAIPayTabs::setDescriptor(const QString &descriptor) {
    m_descriptor = descriptor;
    m_descriptor_isSet = true;
}

bool OAIPayTabs::is_descriptor_Set() const{
    return m_descriptor_isSet;
}

bool OAIPayTabs::is_descriptor_Valid() const{
    return m_descriptor_isValid;
}

OAIDigitalWallets OAIPayTabs::getDigitalWallets() const {
    return m_digital_wallets;
}
void OAIPayTabs::setDigitalWallets(const OAIDigitalWallets &digital_wallets) {
    m_digital_wallets = digital_wallets;
    m_digital_wallets_isSet = true;
}

bool OAIPayTabs::is_digital_wallets_Set() const{
    return m_digital_wallets_isSet;
}

bool OAIPayTabs::is_digital_wallets_Valid() const{
    return m_digital_wallets_isValid;
}

bool OAIPayTabs::isDynamicDescriptor() const {
    return m_dynamic_descriptor;
}
void OAIPayTabs::setDynamicDescriptor(const bool &dynamic_descriptor) {
    m_dynamic_descriptor = dynamic_descriptor;
    m_dynamic_descriptor_isSet = true;
}

bool OAIPayTabs::is_dynamic_descriptor_Set() const{
    return m_dynamic_descriptor_isSet;
}

bool OAIPayTabs::is_dynamic_descriptor_Valid() const{
    return m_dynamic_descriptor_isValid;
}

QList<QString> OAIPayTabs::getExcludedDccQuoteCurrencies() const {
    return m_excluded_dcc_quote_currencies;
}
void OAIPayTabs::setExcludedDccQuoteCurrencies(const QList<QString> &excluded_dcc_quote_currencies) {
    m_excluded_dcc_quote_currencies = excluded_dcc_quote_currencies;
    m_excluded_dcc_quote_currencies_isSet = true;
}

bool OAIPayTabs::is_excluded_dcc_quote_currencies_Set() const{
    return m_excluded_dcc_quote_currencies_isSet;
}

bool OAIPayTabs::is_excluded_dcc_quote_currencies_Valid() const{
    return m_excluded_dcc_quote_currencies_isValid;
}

OAIGatewayName OAIPayTabs::getGatewayName() const {
    return m_gateway_name;
}
void OAIPayTabs::setGatewayName(const OAIGatewayName &gateway_name) {
    m_gateway_name = gateway_name;
    m_gateway_name_isSet = true;
}

bool OAIPayTabs::is_gateway_name_Set() const{
    return m_gateway_name_isSet;
}

bool OAIPayTabs::is_gateway_name_Valid() const{
    return m_gateway_name_isValid;
}

QString OAIPayTabs::getId() const {
    return m_id;
}
void OAIPayTabs::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIPayTabs::is_id_Set() const{
    return m_id_isSet;
}

bool OAIPayTabs::is_id_Valid() const{
    return m_id_isValid;
}

bool OAIPayTabs::isIsDown() const {
    return m_is_down;
}
void OAIPayTabs::setIsDown(const bool &is_down) {
    m_is_down = is_down;
    m_is_down_isSet = true;
}

bool OAIPayTabs::is_is_down_Set() const{
    return m_is_down_isSet;
}

bool OAIPayTabs::is_is_down_Valid() const{
    return m_is_down_isValid;
}

QString OAIPayTabs::getMerchantCategoryCode() const {
    return m_merchant_category_code;
}
void OAIPayTabs::setMerchantCategoryCode(const QString &merchant_category_code) {
    m_merchant_category_code = merchant_category_code;
    m_merchant_category_code_isSet = true;
}

bool OAIPayTabs::is_merchant_category_code_Set() const{
    return m_merchant_category_code_isSet;
}

bool OAIPayTabs::is_merchant_category_code_Valid() const{
    return m_merchant_category_code_isValid;
}

OAIPaymentMethod OAIPayTabs::getMethod() const {
    return m_method;
}
void OAIPayTabs::setMethod(const OAIPaymentMethod &method) {
    m_method = method;
    m_method_isSet = true;
}

bool OAIPayTabs::is_method_Set() const{
    return m_method_isSet;
}

bool OAIPayTabs::is_method_Valid() const{
    return m_method_isValid;
}

double OAIPayTabs::getMonthlyLimit() const {
    return m_monthly_limit;
}
void OAIPayTabs::setMonthlyLimit(const double &monthly_limit) {
    m_monthly_limit = monthly_limit;
    m_monthly_limit_isSet = true;
}

bool OAIPayTabs::is_monthly_limit_Set() const{
    return m_monthly_limit_isSet;
}

bool OAIPayTabs::is_monthly_limit_Valid() const{
    return m_monthly_limit_isValid;
}

QString OAIPayTabs::getOrganizationId() const {
    return m_organization_id;
}
void OAIPayTabs::setOrganizationId(const QString &organization_id) {
    m_organization_id = organization_id;
    m_organization_id_isSet = true;
}

bool OAIPayTabs::is_organization_id_Set() const{
    return m_organization_id_isSet;
}

bool OAIPayTabs::is_organization_id_Valid() const{
    return m_organization_id_isValid;
}

QList<OAIPaymentCardBrand> OAIPayTabs::getPaymentCardSchemes() const {
    return m_payment_card_schemes;
}
void OAIPayTabs::setPaymentCardSchemes(const QList<OAIPaymentCardBrand> &payment_card_schemes) {
    m_payment_card_schemes = payment_card_schemes;
    m_payment_card_schemes_isSet = true;
}

bool OAIPayTabs::is_payment_card_schemes_Set() const{
    return m_payment_card_schemes_isSet;
}

bool OAIPayTabs::is_payment_card_schemes_Valid() const{
    return m_payment_card_schemes_isValid;
}

bool OAIPayTabs::isReconciliationWindowEnabled() const {
    return m_reconciliation_window_enabled;
}
void OAIPayTabs::setReconciliationWindowEnabled(const bool &reconciliation_window_enabled) {
    m_reconciliation_window_enabled = reconciliation_window_enabled;
    m_reconciliation_window_enabled_isSet = true;
}

bool OAIPayTabs::is_reconciliation_window_enabled_Set() const{
    return m_reconciliation_window_enabled_isSet;
}

bool OAIPayTabs::is_reconciliation_window_enabled_Valid() const{
    return m_reconciliation_window_enabled_isValid;
}

qint32 OAIPayTabs::getReconciliationWindowTtl() const {
    return m_reconciliation_window_ttl;
}
void OAIPayTabs::setReconciliationWindowTtl(const qint32 &reconciliation_window_ttl) {
    m_reconciliation_window_ttl = reconciliation_window_ttl;
    m_reconciliation_window_ttl_isSet = true;
}

bool OAIPayTabs::is_reconciliation_window_ttl_Set() const{
    return m_reconciliation_window_ttl_isSet;
}

bool OAIPayTabs::is_reconciliation_window_ttl_Valid() const{
    return m_reconciliation_window_ttl_isValid;
}

QString OAIPayTabs::getStatus() const {
    return m_status;
}
void OAIPayTabs::setStatus(const QString &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIPayTabs::is_status_Set() const{
    return m_status_isSet;
}

bool OAIPayTabs::is_status_Valid() const{
    return m_status_isValid;
}

bool OAIPayTabs::isSticky() const {
    return m_sticky;
}
void OAIPayTabs::setSticky(const bool &sticky) {
    m_sticky = sticky;
    m_sticky_isSet = true;
}

bool OAIPayTabs::is_sticky_Set() const{
    return m_sticky_isSet;
}

bool OAIPayTabs::is_sticky_Valid() const{
    return m_sticky_isValid;
}

bool OAIPayTabs::isThreeDSecure() const {
    return m_three_d_secure;
}
void OAIPayTabs::setThreeDSecure(const bool &three_d_secure) {
    m_three_d_secure = three_d_secure;
    m_three_d_secure_isSet = true;
}

bool OAIPayTabs::is_three_d_secure_Set() const{
    return m_three_d_secure_isSet;
}

bool OAIPayTabs::is_three_d_secure_Valid() const{
    return m_three_d_secure_isValid;
}

qint32 OAIPayTabs::getTimeout() const {
    return m_timeout;
}
void OAIPayTabs::setTimeout(const qint32 &timeout) {
    m_timeout = timeout;
    m_timeout_isSet = true;
}

bool OAIPayTabs::is_timeout_Set() const{
    return m_timeout_isSet;
}

bool OAIPayTabs::is_timeout_Valid() const{
    return m_timeout_isValid;
}

QString OAIPayTabs::getToken() const {
    return m_token;
}
void OAIPayTabs::setToken(const QString &token) {
    m_token = token;
    m_token_isSet = true;
}

bool OAIPayTabs::is_token_Set() const{
    return m_token_isSet;
}

bool OAIPayTabs::is_token_Valid() const{
    return m_token_isValid;
}

QDateTime OAIPayTabs::getUpdatedTime() const {
    return m_updated_time;
}
void OAIPayTabs::setUpdatedTime(const QDateTime &updated_time) {
    m_updated_time = updated_time;
    m_updated_time_isSet = true;
}

bool OAIPayTabs::is_updated_time_Set() const{
    return m_updated_time_isSet;
}

bool OAIPayTabs::is_updated_time_Valid() const{
    return m_updated_time_isValid;
}

OAIPayTabs_allOf_credentials OAIPayTabs::getCredentials() const {
    return m_credentials;
}
void OAIPayTabs::setCredentials(const OAIPayTabs_allOf_credentials &credentials) {
    m_credentials = credentials;
    m_credentials_isSet = true;
}

bool OAIPayTabs::is_credentials_Set() const{
    return m_credentials_isSet;
}

bool OAIPayTabs::is_credentials_Valid() const{
    return m_credentials_isValid;
}

bool OAIPayTabs::isSet() const {
