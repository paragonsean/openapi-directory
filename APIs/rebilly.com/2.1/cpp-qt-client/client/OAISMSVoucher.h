...
#ifndef OAISMSVoucher_H
#define OAISMSVoucher_H
...
#include "OAISMSVoucher_allOf_credentials.h"
#include <QDateTime>
#include <QList>
#include <QString>
...
class OAISMSVoucher_allOf_credentials;

class OAISMSVoucher : public OAIObject {
public:
    OAISMSVoucher();
    OAISMSVoucher(QString json);
    ~OAISMSVoucher() override;
    ...
    OAISMSVoucher_allOf_credentials getCredentials() const;
    void setCredentials(const OAISMSVoucher_allOf_credentials &credentials);
...
private:
    ...
    OAISMSVoucher_allOf_credentials m_credentials;
...
Q_DECLARE_METATYPE(OpenAPI::OAISMSVoucher)

#endif // OAISMSVoucher_H
