...
class OAICASHlib_allOf_credentials;

class OAICASHlib : public OAIObject {
public:
    OAICASHlib();
    OAICASHlib(QString json);
    ~OAICASHlib() override;
    ...
    OAICASHlib_allOf_credentials getCredentials() const;
    void setCredentials(const OAICASHlib_allOf_credentials &credentials);
...
private:
    ...
    OAICASHlib_allOf_credentials m_credentials;
...
Q_DECLARE_METATYPE(OpenAPI::OAICASHlib)
