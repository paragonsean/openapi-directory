...
OAIMyFatoorah::OAIMyFatoorah(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIMyFatoorah::OAIMyFatoorah() {
    this->initializeModel();
}

OAIMyFatoorah::~OAIMyFatoorah() {}

void OAIMyFatoorah::initializeModel() {
...
void OAIMyFatoorah::fromJson(QString jsonString) {
...
void OAIMyFatoorah::fromJsonObject(QJsonObject json) {
...
QString OAIMyFatoorah::asJson() const {
...
QJsonObject OAIMyFatoorah::asJsonObject() const {
    QJsonObject obj;
    if (m__links.size() > 0) {
...
QList<OAIGatewayAccount__links_inner> OAIMyFatoorah::getLinks() const {
    return m__links;
}
void OAIMyFatoorah::setLinks(const QList<OAIGatewayAccount__links_inner> &_links) {
    m__links = _links;
    m__links_isSet = true;
}

bool OAIMyFatoorah::is__links_Set() const{
    return m__links_isSet;
}

bool OAIMyFatoorah::is__links_Valid() const{
    return m__links_isValid;
}

QList<QString> OAIMyFatoorah::getAcceptedCurrencies() const {
    return m_accepted_currencies;
}
void OAIMyFatoorah::setAcceptedCurrencies(const QList<QString> &accepted_currencies) {
    m_accepted_currencies = accepted_currencies;
    m_accepted_currencies_isSet = true;
}

bool OAIMyFatoorah::is_accepted_currencies_Set() const{
    return m_accepted_currencies_isSet;
}

bool OAIMyFatoorah::is_accepted_currencies_Valid() const{
    return m_accepted_currencies_isValid;
}

OAIAcquirerName OAIMyFatoorah::getAcquirerName() const {
    return m_acquirer_name;
}
void OAIMyFatoorah::setAcquirerName(const OAIAcquirerName &acquirer_name) {
    m_acquirer_name = acquirer_name;
    m_acquirer_name_isSet = true;
}

bool OAIMyFatoorah::is_acquirer_name_Set() const{
    return m_acquirer_name_isSet;
}

bool OAIMyFatoorah::is_acquirer_name_Valid() const{
    return m_acquirer_name_isValid;
}

QString OAIMyFatoorah::getAdditionalFilters() const {
    return m_additional_filters;
}
void OAIMyFatoorah::setAdditionalFilters(const QString &additional_filters) {
    m_additional_filters = additional_filters;
    m_additional_filters_isSet = true;
}

bool OAIMyFatoorah::is_additional_filters_Set() const{
    return m_additional_filters_isSet;
}

bool OAIMyFatoorah::is_additional_filters_Valid() const{
    return m_additional_filters_isValid;
}

qint32 OAIMyFatoorah::getApprovalWindowTtl() const {
    return m_approval_window_ttl;
}
void OAIMyFatoorah::setApprovalWindowTtl(const qint32 &approval_window_ttl) {
    m_approval_window_ttl = approval_window_ttl;
    m_approval_window_ttl_isSet = true;
}

bool OAIMyFatoorah::is_approval_window_ttl_Set() const{
    return m_approval_window_ttl_isSet;
}

bool OAIMyFatoorah::is_approval_window_ttl_Valid() const{
    return m_approval_window_ttl_isValid;
}

QString OAIMyFatoorah::getCityField() const {
    return m_city_field;
}
void OAIMyFatoorah::setCityField(const QString &city_field) {
    m_city_field = city_field;
    m_city_field_isSet = true;
}

bool OAIMyFatoorah::is_city_field_Set() const{
    return m_city_field_isSet;
}

bool OAIMyFatoorah::is_city_field_Valid() const{
    return m_city_field_isValid;
}

QDateTime OAIMyFatoorah::getCreatedTime() const {
    return m_created_time;
}
void OAIMyFatoorah::setCreatedTime(const QDateTime &created_time) {
    m_created_time = created_time;
    m_created_time_isSet = true;
}

bool OAIMyFatoorah::is_created_time_Set() const{
    return m_created_time_isSet;
}

bool OAIMyFatoorah::is_created_time_Valid() const{
    return m_created_time_isValid;
}

QString OAIMyFatoorah::getDccForceCurrency() const {
    return m_dcc_force_currency;
}
void OAIMyFatoorah::setDccForceCurrency(const QString &dcc_force_currency) {
    m_dcc_force_currency = dcc_force_currency;
    m_dcc_force_currency_isSet = true;
}

bool OAIMyFatoorah::is_dcc_force_currency_Set() const{
    return m_dcc_force_currency_isSet;
}

bool OAIMyFatoorah::is_dcc_force_currency_Valid() const{
    return m_dcc_force_currency_isValid;
}

qint32 OAIMyFatoorah::getDccMarkup() const {
    return m_dcc_markup;
}
void OAIMyFatoorah::setDccMarkup(const qint32 &dcc_markup) {
    m_dcc_markup = dcc_markup;
    m_dcc_markup_isSet = true;
}

bool OAIMyFatoorah::is_dcc_markup_Set() const{
    return m_dcc_markup_isSet;
}

bool OAIMyFatoorah::is_dcc_markup_Valid() const{
    return m_dcc_markup_isValid;
}

QString OAIMyFatoorah::getDescriptor() const {
    return m_descriptor;
}
void OAIMyFatoorah::setDescriptor(const QString &descriptor) {
    m_descriptor = descriptor;
    m_descriptor_isSet = true;
}

bool OAIMyFatoorah::is_descriptor_Set() const{
    return m_descriptor_isSet;
}

bool OAIMyFatoorah::is_descriptor_Valid() const{
    return m_descriptor_isValid;
}

OAIDigitalWallets OAIMyFatoorah::getDigitalWallets() const {
    return m_digital_wallets;
}
void OAIMyFatoorah::setDigitalWallets(const OAIDigitalWallets &digital_wallets) {
    m_digital_wallets = digital_wallets;
    m_digital_wallets_isSet = true;
}

bool OAIMyFatoorah::is_digital_wallets_Set() const{
    return m_digital_wallets_isSet;
}

bool OAIMyFatoorah::is_digital_wallets_Valid() const{
    return m_digital_wallets_isValid;
}

bool OAIMyFatoorah::isDynamicDescriptor() const {
    return m_dynamic_descriptor;
}
void OAIMyFatoorah::setDynamicDescriptor(const bool &dynamic_descriptor) {
    m_dynamic_descriptor = dynamic_descriptor;
    m_dynamic_descriptor_isSet = true;
}

bool OAIMyFatoorah::is_dynamic_descriptor_Set() const{
    return m_dynamic_descriptor_isSet;
}

bool OAIMyFatoorah::is_dynamic_descriptor_Valid() const{
    return m_dynamic_descriptor_isValid;
}

QList<QString> OAIMyFatoorah::getExcludedDccQuoteCurrencies() const {
    return m_excluded_dcc_quote_currencies;
}
void OAIMyFatoorah::setExcludedDccQuoteCurrencies(const QList<QString> &excluded_dcc_quote_currencies) {
    m_excluded_dcc_quote_currencies = excluded_dcc_quote_currencies;
    m_excluded_dcc_quote_currencies_isSet = true;
}

bool OAIMyFatoorah::is_excluded_dcc_quote_currencies_Set() const{
    return m_excluded_dcc_quote_currencies_isSet;
}

bool OAIMyFatoorah::is_excluded_dcc_quote_currencies_Valid() const{
    return m_excluded_dcc_quote_currencies_isValid;
}

OAIGatewayName OAIMyFatoorah::getGatewayName() const {
    return m_gateway_name;
}
void OAIMyFatoorah::setGatewayName(const OAIGatewayName &gateway_name) {
    m_gateway_name = gateway_name;
    m_gateway_name_isSet = true;
}

bool OAIMyFatoorah::is_gateway_name_Set() const{
    return m_gateway_name_isSet;
}

bool OAIMyFatoorah::is_gateway_name_Valid() const{
    return m_gateway_name_isValid;
}

QString OAIMyFatoorah::getId() const {
    return m_id;
}
void OAIMyFatoorah::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIMyFatoorah::is_id_Set() const{
    return m_id_isSet;
}

bool OAIMyFatoorah::is_id_Valid() const{
    return m_id_isValid;
}

bool OAIMyFatoorah::isIsDown() const {
    return m_is_down;
}
void OAIMyFatoorah::setIsDown(const bool &is_down) {
    m_is_down = is_down;
    m_is_down_isSet = true;
}

bool OAIMyFatoorah::is_is_down_Set() const{
    return m_is_down_isSet;
}

bool OAIMyFatoorah::is_is_down_Valid() const{
    return m_is_down_isValid;
}

QString OAIMyFatoorah::getMerchantCategoryCode() const {
    return m_merchant_category_code;
}
void OAIMyFatoorah::setMerchantCategoryCode(const QString &merchant_category_code) {
    m_merchant_category_code = merchant_category_code;
    m_merchant_category_code_isSet = true;
}

bool OAIMyFatoorah::is_merchant_category_code_Set() const{
    return m_merchant_category_code_isSet;
}

bool OAIMyFatoorah::is_merchant_category_code_Valid() const{
    return m_merchant_category_code_isValid;
}

OAIPaymentMethod OAIMyFatoorah::getMethod() const {
    return m_method;
}
void OAIMyFatoorah::setMethod(const OAIPaymentMethod &method) {
    m_method = method;
    m_method_isSet = true;
}

bool OAIMyFatoorah::is_method_Set() const{
    return m_method_isSet;
}

bool OAIMyFatoorah::is_method_Valid() const{
    return m_method_isValid;
}

double OAIMyFatoorah::getMonthlyLimit() const {
    return m_monthly_limit;
}
void OAIMyFatoorah::setMonthlyLimit(const double &monthly_limit) {
    m_monthly_limit = monthly_limit;
    m_monthly_limit_isSet = true;
}

bool OAIMyFatoorah::is_monthly_limit_Set() const{
    return m_monthly_limit_isSet;
}

bool OAIMyFatoorah::is_monthly_limit_Valid() const{
    return m_monthly_limit_isValid;
}

QString OAIMyFatoorah::getOrganizationId() const {
    return m_organization_id;
}
void OAIMyFatoorah::setOrganizationId(const QString &organization_id) {
    m_organization_id = organization_id;
    m_organization_id_isSet = true;
}

bool OAIMyFatoorah::is_organization_id_Set() const{
    return m_organization_id_isSet;
}

bool OAIMyFatoorah::is_organization_id_Valid() const{
    return m_organization_id_isValid;
}

QList<OAIPaymentCardBrand> OAIMyFatoorah::getPaymentCardSchemes() const {
    return m_payment_card_schemes;
}
void OAIMyFatoorah::setPaymentCardSchemes(const QList<OAIPaymentCardBrand> &payment_card_schemes) {
    m_payment_card_schemes = payment_card_schemes;
    m_payment_card_schemes_isSet = true;
}

bool OAIMyFatoorah::is_payment_card_schemes_Set() const{
    return m_payment_card_schemes_isSet;
}

bool OAIMyFatoorah::is_payment_card_schemes_Valid() const{
    return m_payment_card_schemes_isValid;
}

bool OAIMyFatoorah::isReconciliationWindowEnabled() const {
    return m_reconciliation_window_enabled;
}
void OAIMyFatoorah::setReconciliationWindowEnabled(const bool &reconciliation_window_enabled) {
    m_reconciliation_window_enabled = reconciliation_window_enabled;
    m_reconciliation_window_enabled_isSet = true;
}

bool OAIMyFatoorah::is_reconciliation_window_enabled_Set() const{
    return m_reconciliation_window_enabled_isSet;
}

bool OAIMyFatoorah::is_reconciliation_window_enabled_Valid() const{
    return m_reconciliation_window_enabled_isValid;
}

qint32 OAIMyFatoorah::getReconciliationWindowTtl() const {
    return m_reconciliation_window_ttl;
}
void OAIMyFatoorah::setReconciliationWindowTtl(const qint32 &reconciliation_window_ttl) {
    m_reconciliation_window_ttl = reconciliation_window_ttl;
    m_reconciliation_window_ttl_isSet = true;
}

bool OAIMyFatoorah::is_reconciliation_window_ttl_Set() const{
    return m_reconciliation_window_ttl_isSet;
}

bool OAIMyFatoorah::is_reconciliation_window_ttl_Valid() const{
    return m_reconciliation_window_ttl_isValid;
}

QString OAIMyFatoorah::getStatus() const {
    return m_status;
}
void OAIMyFatoorah::setStatus(const QString &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIMyFatoorah::is_status_Set() const{
    return m_status_isSet;
}

bool OAIMyFatoorah::is_status_Valid() const{
    return m_status_isValid;
}

bool OAIMyFatoorah::isSticky() const {
    return m_sticky;
}
void OAIMyFatoorah::setSticky(const bool &sticky) {
    m_sticky = sticky;
    m_sticky_isSet = true;
}

bool OAIMyFatoorah::is_sticky_Set() const{
    return m_sticky_isSet;
}

bool OAIMyFatoorah::is_sticky_Valid() const{
    return m_sticky_isValid;
}

bool OAIMyFatoorah::isThreeDSecure() const {
    return m_three_d_secure;
}
void OAIMyFatoorah::setThreeDSecure(const bool &three_d_secure) {
    m_three_d_secure = three_d_secure;
    m_three_d_secure_isSet = true;
}

bool OAIMyFatoorah::is_three_d_secure_Set() const{
    return m_three_d_secure_isSet;
}

bool OAIMyFatoorah::is_three_d_secure_Valid() const{
    return m_three_d_secure_isValid;
}

qint32 OAIMyFatoorah::getTimeout() const {
    return m_timeout;
}
void OAIMyFatoorah::setTimeout(const qint32 &timeout) {
    m_timeout = timeout;
    m_timeout_isSet = true;
}

bool OAIMyFatoorah::is_timeout_Set() const{
    return m_timeout_isSet;
}

bool OAIMyFatoorah::is_timeout_Valid() const{
    return m_timeout_isValid;
}

QString OAIMyFatoorah::getToken() const {
    return m_token;
}
void OAIMyFatoorah::setToken(const QString &token) {
    m_token = token;
    m_token_isSet = true;
}

bool OAIMyFatoorah::is_token_Set() const{
    return m_token_isSet;
}

bool OAIMyFatoorah::is_token_Valid() const{
    return m_token_isValid;
}

QDateTime OAIMyFatoorah::getUpdatedTime() const {
    return m_updated_time;
}
void OAIMyFatoorah::setUpdatedTime(const QDateTime &updated_time) {
    m_updated_time = updated_time;
    m_updated_time_isSet = true;
}

bool OAIMyFatoorah::is_updated_time_Set() const{
    return m_updated_time_isSet;
}

bool OAIMyFatoorah::is_updated_time_Valid() const{
    return m_updated_time_isValid;
}

OAIMyFatoorah_allOf_credentials OAIMyFatoorah::getCredentials() const {
    return m_credentials;
}
void OAIMyFatoorah::setCredentials(const OAIMyFatoorah_allOf_credentials &credentials) {
    m_credentials = credentials;
    m_credentials_isSet = true;
}

bool OAIMyFatoorah::is_credentials_Set() const{
    return m_credentials_isSet;
}

bool OAIMyFatoorah::is_credentials_Valid() const{
    return m_credentials_isValid;
}

bool OAIMyFatoorah::isSet() const {
...
bool OAIMyFatoorah::isValid() const {
