...
OAIPaymero::OAIPaymero(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPaymero::OAIPaymero() {
    this->initializeModel();
}

OAIPaymero::~OAIPaymero() {}

void OAIPaymero::initializeModel() {
...
void OAIPaymero::fromJson(QString jsonString) {
...
void OAIPaymero::fromJsonObject(QJsonObject json) {
...
QString OAIPaymero::asJson() const {
...
QJsonObject OAIPaymero::asJsonObject() const {
    QJsonObject obj;
    if (m__links.size() > 0) {
...
QList<OAIGatewayAccount__links_inner> OAIPaymero::getLinks() const {
    return m__links;
}
void OAIPaymero::setLinks(const QList<OAIGatewayAccount__links_inner> &_links) {
    m__links = _links;
    m__links_isSet = true;
}

bool OAIPaymero::is__links_Set() const{
    return m__links_isSet;
}

bool OAIPaymero::is__links_Valid() const{
    return m__links_isValid;
}

QList<QString> OAIPaymero::getAcceptedCurrencies() const {
    return m_accepted_currencies;
}
void OAIPaymero::setAcceptedCurrencies(const QList<QString> &accepted_currencies) {
    m_accepted_currencies = accepted_currencies;
    m_accepted_currencies_isSet = true;
}

bool OAIPaymero::is_accepted_currencies_Set() const{
    return m_accepted_currencies_isSet;
}

bool OAIPaymero::is_accepted_currencies_Valid() const{
    return m_accepted_currencies_isValid;
}

OAIAcquirerName OAIPaymero::getAcquirerName() const {
    return m_acquirer_name;
}
void OAIPaymero::setAcquirerName(const OAIAcquirerName &acquirer_name) {
    m_acquirer_name = acquirer_name;
    m_acquirer_name_isSet = true;
}

bool OAIPaymero::is_acquirer_name_Set() const{
    return m_acquirer_name_isSet;
}

bool OAIPaymero::is_acquirer_name_Valid() const{
    return m_acquirer_name_isValid;
}

QString OAIPaymero::getAdditionalFilters() const {
    return m_additional_filters;
}
void OAIPaymero::setAdditionalFilters(const QString &additional_filters) {
    m_additional_filters = additional_filters;
    m_additional_filters_isSet = true;
}

bool OAIPaymero::is_additional_filters_Set() const{
    return m_additional_filters_isSet;
}

bool OAIPaymero::is_additional_filters_Valid() const{
    return m_additional_filters_isValid;
}

qint32 OAIPaymero::getApprovalWindowTtl() const {
    return m_approval_window_ttl;
}
void OAIPaymero::setApprovalWindowTtl(const qint32 &approval_window_ttl) {
    m_approval_window_ttl = approval_window_ttl;
    m_approval_window_ttl_isSet = true;
}

bool OAIPaymero::is_approval_window_ttl_Set() const{
    return m_approval_window_ttl_isSet;
}

bool OAIPaymero::is_approval_window_ttl_Valid() const{
    return m_approval_window_ttl_isValid;
}

QString OAIPaymero::getCityField() const {
    return m_city_field;
}
void OAIPaymero::setCityField(const QString &city_field) {
    m_city_field = city_field;
    m_city_field_isSet = true;
}

bool OAIPaymero::is_city_field_Set() const{
    return m_city_field_isSet;
}

bool OAIPaymero::is_city_field_Valid() const{
    return m_city_field_isValid;
}

QDateTime OAIPaymero::getCreatedTime() const {
    return m_created_time;
}
void OAIPaymero::setCreatedTime(const QDateTime &created_time) {
    m_created_time = created_time;
    m_created_time_isSet = true;
}

bool OAIPaymero::is_created_time_Set() const{
    return m_created_time_isSet;
}

bool OAIPaymero::is_created_time_Valid() const{
    return m_created_time_isValid;
}

QString OAIPaymero::getDccForceCurrency() const {
    return m_dcc_force_currency;
}
void OAIPaymero::setDccForceCurrency(const QString &dcc_force_currency) {
    m_dcc_force_currency = dcc_force_currency;
    m_dcc_force_currency_isSet = true;
}

bool OAIPaymero::is_dcc_force_currency_Set() const{
    return m_dcc_force_currency_isSet;
}

bool OAIPaymero::is_dcc_force_currency_Valid() const{
    return m_dcc_force_currency_isValid;
}

qint32 OAIPaymero::getDccMarkup() const {
    return m_dcc_markup;
}
void OAIPaymero::setDccMarkup(const qint32 &dcc_markup) {
    m_dcc_markup = dcc_markup;
    m_dcc_markup_isSet = true;
}

bool OAIPaymero::is_dcc_markup_Set() const{
    return m_dcc_markup_isSet;
}

bool OAIPaymero::is_dcc_markup_Valid() const{
    return m_dcc_markup_isValid;
}

QString OAIPaymero::getDescriptor() const {
    return m_descriptor;
}
void OAIPaymero::setDescriptor(const QString &descriptor) {
    m_descriptor = descriptor;
    m_descriptor_isSet = true;
}

bool OAIPaymero::is_descriptor_Set() const{
    return m_descriptor_isSet;
}

bool OAIPaymero::is_descriptor_Valid() const{
    return m_descriptor_isValid;
}

OAIDigitalWallets OAIPaymero::getDigitalWallets() const {
    return m_digital_wallets;
}
void OAIPaymero::setDigitalWallets(const OAIDigitalWallets &digital_wallets) {
    m_digital_wallets = digital_wallets;
    m_digital_wallets_isSet = true;
}

bool OAIPaymero::is_digital_wallets_Set() const{
    return m_digital_wallets_isSet;
}

bool OAIPaymero::is_digital_wallets_Valid() const{
    return m_digital_wallets_isValid;
}

bool OAIPaymero::isDynamicDescriptor() const {
    return m_dynamic_descriptor;
}
void OAIPaymero::setDynamicDescriptor(const bool &dynamic_descriptor) {
    m_dynamic_descriptor = dynamic_descriptor;
    m_dynamic_descriptor_isSet = true;
}

bool OAIPaymero::is_dynamic_descriptor_Set() const{
    return m_dynamic_descriptor_isSet;
}

bool OAIPaymero::is_dynamic_descriptor_Valid() const{
    return m_dynamic_descriptor_isValid;
}

QList<QString> OAIPaymero::getExcludedDccQuoteCurrencies() const {
    return m_excluded_dcc_quote_currencies;
}
void OAIPaymero::setExcludedDccQuoteCurrencies(const QList<QString> &excluded_dcc_quote_currencies) {
    m_excluded_dcc_quote_currencies = excluded_dcc_quote_currencies;
    m_excluded_dcc_quote_currencies_isSet = true;
}

bool OAIPaymero::is_excluded_dcc_quote_currencies_Set() const{
    return m_excluded_dcc_quote_currencies_isSet;
}

bool OAIPaymero::is_excluded_dcc_quote_currencies_Valid() const{
    return m_excluded_dcc_quote_currencies_isValid;
}

OAIGatewayName OAIPaymero::getGatewayName() const {
    return m_gateway_name;
}
void OAIPaymero::setGatewayName(const OAIGatewayName &gateway_name) {
    m_gateway_name = gateway_name;
    m_gateway_name_isSet = true;
}

bool OAIPaymero::is_gateway_name_Set() const{
    return m_gateway_name_isSet;
}

bool OAIPaymero::is_gateway_name_Valid() const{
    return m_gateway_name_isValid;
}

QString OAIPaymero::getId() const {
    return m_id;
}
void OAIPaymero::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIPaymero::is_id_Set() const{
    return m_id_isSet;
}

bool OAIPaymero::is_id_Valid() const{
    return m_id_isValid;
}

bool OAIPaymero::isIsDown() const {
    return m_is_down;
}
void OAIPaymero::setIsDown(const bool &is_down) {
    m_is_down = is_down;
    m_is_down_isSet = true;
}

bool OAIPaymero::is_is_down_Set() const{
    return m_is_down_isSet;
}

bool OAIPaymero::is_is_down_Valid() const{
    return m_is_down_isValid;
}

QString OAIPaymero::getMerchantCategoryCode() const {
    return m_merchant_category_code;
}
void OAIPaymero::setMerchantCategoryCode(const QString &merchant_category_code) {
    m_merchant_category_code = merchant_category_code;
    m_merchant_category_code_isSet = true;
}

bool OAIPaymero::is_merchant_category_code_Set() const{
    return m_merchant_category_code_isSet;
}

bool OAIPaymero::is_merchant_category_code_Valid() const{
    return m_merchant_category_code_isValid;
}

OAIPaymentMethod OAIPaymero::getMethod() const {
    return m_method;
}
void OAIPaymero::setMethod(const OAIPaymentMethod &method) {
    m_method = method;
    m_method_isSet = true;
}

bool OAIPaymero::is_method_Set() const{
    return m_method_isSet;
}

bool OAIPaymero::is_method_Valid() const{
    return m_method_isValid;
}

double OAIPaymero::getMonthlyLimit() const {
    return m_monthly_limit;
}
void OAIPaymero::setMonthlyLimit(const double &monthly_limit) {
    m_monthly_limit = monthly_limit;
    m_monthly_limit_isSet = true;
}

bool OAIPaymero::is_monthly_limit_Set() const{
    return m_monthly_limit_isSet;
}

bool OAIPaymero::is_monthly_limit_Valid() const{
    return m_monthly_limit_isValid;
}

QString OAIPaymero::getOrganizationId() const {
    return m_organization_id;
}
void OAIPaymero::setOrganizationId(const QString &organization_id) {
    m_organization_id = organization_id;
    m_organization_id_isSet = true;
}

bool OAIPaymero::is_organization_id_Set() const{
    return m_organization_id_isSet;
}

bool OAIPaymero::is_organization_id_Valid() const{
    return m_organization_id_isValid;
}

QList<OAIPaymentCardBrand> OAIPaymero::getPaymentCardSchemes() const {
    return m_payment_card_schemes;
}
void OAIPaymero::setPaymentCardSchemes(const QList<OAIPaymentCardBrand> &payment_card_schemes) {
    m_payment_card_schemes = payment_card_schemes;
    m_payment_card_schemes_isSet = true;
}

bool OAIPaymero::is_payment_card_schemes_Set() const{
    return m_payment_card_schemes_isSet;
}

bool OAIPaymero::is_payment_card_schemes_Valid() const{
    return m_payment_card_schemes_isValid;
}

bool OAIPaymero::isReconciliationWindowEnabled() const {
    return m_reconciliation_window_enabled;
}
void OAIPaymero::setReconciliationWindowEnabled(const bool &reconciliation_window_enabled) {
    m_reconciliation_window_enabled = reconciliation_window_enabled;
    m_reconciliation_window_enabled_isSet = true;
}

bool OAIPaymero::is_reconciliation_window_enabled_Set() const{
    return m_reconciliation_window_enabled_isSet;
}

bool OAIPaymero::is_reconciliation_window_enabled_Valid() const{
    return m_reconciliation_window_enabled_isValid;
}

qint32 OAIPaymero::getReconciliationWindowTtl() const {
    return m_reconciliation_window_ttl;
}
void OAIPaymero::setReconciliationWindowTtl(const qint32 &reconciliation_window_ttl) {
    m_reconciliation_window_ttl = reconciliation_window_ttl;
    m_reconciliation_window_ttl_isSet = true;
}

bool OAIPaymero::is_reconciliation_window_ttl_Set() const{
    return m_reconciliation_window_ttl_isSet;
}

bool OAIPaymero::is_reconciliation_window_ttl_Valid() const{
    return m_reconciliation_window_ttl_isValid;
}

QString OAIPaymero::getStatus() const {
    return m_status;
}
void OAIPaymero::setStatus(const QString &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIPaymero::is_status_Set() const{
    return m_status_isSet;
}

bool OAIPaymero::is_status_Valid() const{
    return m_status_isValid;
}

bool OAIPaymero::isSticky() const {
    return m_sticky;
}
void OAIPaymero::setSticky(const bool &sticky) {
    m_sticky = sticky;
    m_sticky_isSet = true;
}

bool OAIPaymero::is_sticky_Set() const{
    return m_sticky_isSet;
}

bool OAIPaymero::is_sticky_Valid() const{
    return m_sticky_isValid;
}

bool OAIPaymero::isThreeDSecure() const {
    return m_three_d_secure;
}
void OAIPaymero::setThreeDSecure(const bool &three_d_secure) {
    m_three_d_secure = three_d_secure;
    m_three_d_secure_isSet = true;
}

bool OAIPaymero::is_three_d_secure_Set() const{
    return m_three_d_secure_isSet;
}

bool OAIPaymero::is_three_d_secure_Valid() const{
    return m_three_d_secure_isValid;
}

qint32 OAIPaymero::getTimeout() const {
    return m_timeout;
}
void OAIPaymero::setTimeout(const qint32 &timeout) {
    m_timeout = timeout;
    m_timeout_isSet = true;
}

bool OAIPaymero::is_timeout_Set() const{
    return m_timeout_isSet;
}

bool OAIPaymero::is_timeout_Valid() const{
    return m_timeout_isValid;
}

QString OAIPaymero::getToken() const {
    return m_token;
}
void OAIPaymero::setToken(const QString &token) {
    m_token = token;
    m_token_isSet = true;
}

bool OAIPaymero::is_token_Set() const{
    return m_token_isSet;
}

bool OAIPaymero::is_token_Valid() const{
    return m_token_isValid;
}

QDateTime OAIPaymero::getUpdatedTime() const {
    return m_updated_time;
}
void OAIPaymero::setUpdatedTime(const QDateTime &updated_time) {
    m_updated_time = updated_time;
    m_updated_time_isSet = true;
}

bool OAIPaymero::is_updated_time_Set() const{
    return m_updated_time_isSet;
}

bool OAIPaymero::is_updated_time_Valid() const{
    return m_updated_time_isValid;
}

OAIPaymero_allOf_credentials OAIPaymero::getCredentials() const {
    return m_credentials;
}
void OAIPaymero::setCredentials(const OAIPaymero_allOf_credentials &credentials) {
    m_credentials = credentials;
    m_credentials_isSet = true;
}

bool OAIPaymero::is_credentials_Set() const{
    return m_credentials_isSet;
}

bool OAIPaymero::is_credentials_Valid() const{
    return m_credentials_isValid;
}

OAIPaymero_allOf_settings OAIPaymero::getSettings() const {
    return m_settings;
}
void OAIPaymero::setSettings(const OAIPaymero_allOf_settings &settings) {
    m_settings = settings;
    m_settings_isSet = true;
}

bool OAIPaymero::is_settings_Set() const{
    return m_settings_isSet;
}

bool OAIPaymero::is_settings_Valid() const{
    return m_settings_isValid;
}

bool OAIPaymero::isSet() const {
