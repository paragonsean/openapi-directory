...
/*
 * OAIPaymentCardUpdatePlain.h
 *
 * 
 */

#ifndef OAIPaymentCardUpdatePlain_H
#define OAIPaymentCardUpdatePlain_H
...
class OAIPaymentCardUpdatePlain : public OAIObject {
public:
    OAIPaymentCardUpdatePlain();
    OAIPaymentCardUpdatePlain(QString json);
    ~OAIPaymentCardUpdatePlain() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPaymentCardUpdatePlain)

#endif // OAIPaymentCardUpdatePlain_H
