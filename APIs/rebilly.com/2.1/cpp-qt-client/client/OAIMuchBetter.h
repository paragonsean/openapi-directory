...
#ifndef OAIMuchBetter_H
#define OAIMuchBetter_H
...
#include "OAIMuchBetter_allOf_credentials.h"
#include "OAIMuchBetter_allOf_settings.h"
...
class OAIMuchBetter_allOf_credentials;
class OAIMuchBetter_allOf_settings;

class OAIMuchBetter : public OAIObject {
public:
    OAIMuchBetter();
    OAIMuchBetter(QString json);
    ~OAIMuchBetter() override;
    ...
    OAIMuchBetter_allOf_credentials getCredentials() const;
    void setCredentials(const OAIMuchBetter_allOf_credentials &credentials);
    bool is_credentials_Set() const;
    bool is_credentials_Valid() const;

    OAIMuchBetter_allOf_settings getSettings() const;
    void setSettings(const OAIMuchBetter_allOf_settings &settings);
...
private:
    ...
    OAIMuchBetter_allOf_credentials m_credentials;
    bool m_credentials_isSet;
    bool m_credentials_isValid;

    OAIMuchBetter_allOf_settings m_settings;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMuchBetter)

#endif // OAIMuchBetter_H
