...
OAILoonie::OAILoonie(QString json) {
...
void OAILoonie::initializeModel() {
...
void OAILoonie::fromJson(QString jsonString) {
...
void OAILoonie::fromJsonObject(QJsonObject json) {
...
QString OAILoonie::asJson() const {
...
QJsonObject OAILoonie::asJsonObject() const {
    QJsonObject obj;
    if (m__links.size() > 0) {
...
QList<OAIGatewayAccount__links_inner> OAILoonie::getLinks() const {
    return m__links;
}
void OAILoonie::setLinks(const QList<OAIGatewayAccount__links_inner> &_links) {
    m__links = _links;
    m__links_isSet = true;
}

bool OAILoonie::is__links_Set() const{
    return m__links_isSet;
}

bool OAILoonie::is__links_Valid() const{
    return m__links_isValid;
}

QList<QString> OAILoonie::getAcceptedCurrencies() const {
    return m_accepted_currencies;
}
void OAILoonie::setAcceptedCurrencies(const QList<QString> &accepted_currencies) {
    m_accepted_currencies = accepted_currencies;
    m_accepted_currencies_isSet = true;
}

bool OAILoonie::is_accepted_currencies_Set() const{
    return m_accepted_currencies_isSet;
}

bool OAILoonie::is_accepted_currencies_Valid() const{
    return m_accepted_currencies_isValid;
}

OAIAcquirerName OAILoonie::getAcquirerName() const {
    return m_acquirer_name;
}
void OAILoonie::setAcquirerName(const OAIAcquirerName &acquirer_name) {
    m_acquirer_name = acquirer_name;
    m_acquirer_name_isSet = true;
}

bool OAILoonie::is_acquirer_name_Set() const{
    return m_acquirer_name_isSet;
}

bool OAILoonie::is_acquirer_name_Valid() const{
    return m_acquirer_name_isValid;
}

QString OAILoonie::getAdditionalFilters() const {
    return m_additional_filters;
}
void OAILoonie::setAdditionalFilters(const QString &additional_filters) {
    m_additional_filters = additional_filters;
    m_additional_filters_isSet = true;
}

bool OAILoonie::is_additional_filters_Set() const{
    return m_additional_filters_isSet;
}

bool OAILoonie::is_additional_filters_Valid() const{
    return m_additional_filters_isValid;
}

qint32 OAILoonie::getApprovalWindowTtl() const {
    return m_approval_window_ttl;
}
void OAILoonie::setApprovalWindowTtl(const qint32 &approval_window_ttl) {
    m_approval_window_ttl = approval_window_ttl;
    m_approval_window_ttl_isSet = true;
}

bool OAILoonie::is_approval_window_ttl_Set() const{
    return m_approval_window_ttl_isSet;
}

bool OAILoonie::is_approval_window_ttl_Valid() const{
    return m_approval_window_ttl_isValid;
}

QString OAILoonie::getCityField() const {
    return m_city_field;
}
void OAILoonie::setCityField(const QString &city_field) {
    m_city_field = city_field;
    m_city_field_isSet = true;
}

bool OAILoonie::is_city_field_Set() const{
    return m_city_field_isSet;
}

bool OAILoonie::is_city_field_Valid() const{
    return m_city_field_isValid;
}

QDateTime OAILoonie::getCreatedTime() const {
    return m_created_time;
}
void OAILoonie::setCreatedTime(const QDateTime &created_time) {
    m_created_time = created_time;
    m_created_time_isSet = true;
}

bool OAILoonie::is_created_time_Set() const{
    return m_created_time_isSet;
}

bool OAILoonie::is_created_time_Valid() const{
    return m_created_time_isValid;
}

QString OAILoonie::getDccForceCurrency() const {
    return m_dcc_force_currency;
}
void OAILoonie::setDccForceCurrency(const QString &dcc_force_currency) {
    m_dcc_force_currency = dcc_force_currency;
    m_dcc_force_currency_isSet = true;
}

bool OAILoonie::is_dcc_force_currency_Set() const{
    return m_dcc_force_currency_isSet;
}

bool OAILoonie::is_dcc_force_currency_Valid() const{
    return m_dcc_force_currency_isValid;
}

qint32 OAILoonie::getDccMarkup() const {
    return m_dcc_markup;
}
void OAILoonie::setDccMarkup(const qint32 &dcc_markup) {
    m_dcc_markup = dcc_markup;
    m_dcc_markup_isSet = true;
}

bool OAILoonie::is_dcc_markup_Set() const{
    return m_dcc_markup_isSet;
}

bool OAILoonie::is_dcc_markup_Valid() const{
    return m_dcc_markup_isValid;
}

QString OAILoonie::getDescriptor() const {
    return m_descriptor;
}
void OAILoonie::setDescriptor(const QString &descriptor) {
    m_descriptor = descriptor;
    m_descriptor_isSet = true;
}

bool OAILoonie::is_descriptor_Set() const{
    return m_descriptor_isSet;
}

bool OAILoonie::is_descriptor_Valid() const{
    return m_descriptor_isValid;
}

OAIDigitalWallets OAILoonie::getDigitalWallets() const {
    return m_digital_wallets;
}
void OAILoonie::setDigitalWallets(const OAIDigitalWallets &digital_wallets) {
    m_digital_wallets = digital_wallets;
    m_digital_wallets_isSet = true;
}

bool OAILoonie::is_digital_wallets_Set() const{
    return m_digital_wallets_isSet;
}

bool OAILoonie::is_digital_wallets_Valid() const{
    return m_digital_wallets_isValid;
}

bool OAILoonie::isDynamicDescriptor() const {
    return m_dynamic_descriptor;
}
void OAILoonie::setDynamicDescriptor(const bool &dynamic_descriptor) {
    m_dynamic_descriptor = dynamic_descriptor;
    m_dynamic_descriptor_isSet = true;
}

bool OAILoonie::is_dynamic_descriptor_Set() const{
    return m_dynamic_descriptor_isSet;
}

bool OAILoonie::is_dynamic_descriptor_Valid() const{
    return m_dynamic_descriptor_isValid;
}

QList<QString> OAILoonie::getExcludedDccQuoteCurrencies() const {
    return m_excluded_dcc_quote_currencies;
}
void OAILoonie::setExcludedDccQuoteCurrencies(const QList<QString> &excluded_dcc_quote_currencies) {
    m_excluded_dcc_quote_currencies = excluded_dcc_quote_currencies;
    m_excluded_dcc_quote_currencies_isSet = true;
}

bool OAILoonie::is_excluded_dcc_quote_currencies_Set() const{
    return m_excluded_dcc_quote_currencies_isSet;
}

bool OAILoonie::is_excluded_dcc_quote_currencies_Valid() const{
    return m_excluded_dcc_quote_currencies_isValid;
}

OAIGatewayName OAILoonie::getGatewayName() const {
    return m_gateway_name;
}
void OAILoonie::setGatewayName(const OAIGatewayName &gateway_name) {
    m_gateway_name = gateway_name;
    m_gateway_name_isSet = true;
}

bool OAILoonie::is_gateway_name_Set() const{
    return m_gateway_name_isSet;
}

bool OAILoonie::is_gateway_name_Valid() const{
    return m_gateway_name_isValid;
}

QString OAILoonie::getId() const {
    return m_id;
}
void OAILoonie::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAILoonie::is_id_Set() const{
    return m_id_isSet;
}

bool OAILoonie::is_id_Valid() const{
    return m_id_isValid;
}

bool OAILoonie::isIsDown() const {
    return m_is_down;
}
void OAILoonie::setIsDown(const bool &is_down) {
    m_is_down = is_down;
    m_is_down_isSet = true;
}

bool OAILoonie::is_is_down_Set() const{
    return m_is_down_isSet;
}

bool OAILoonie::is_is_down_Valid() const{
    return m_is_down_isValid;
}

QString OAILoonie::getMerchantCategoryCode() const {
    return m_merchant_category_code;
}
void OAILoonie::setMerchantCategoryCode(const QString &merchant_category_code) {
    m_merchant_category_code = merchant_category_code;
    m_merchant_category_code_isSet = true;
}

bool OAILoonie::is_merchant_category_code_Set() const{
    return m_merchant_category_code_isSet;
}

bool OAILoonie::is_merchant_category_code_Valid() const{
    return m_merchant_category_code_isValid;
}

OAIPaymentMethod OAILoonie::getMethod() const {
    return m_method;
}
void OAILoonie::setMethod(const OAIPaymentMethod &method) {
    m_method = method;
    m_method_isSet = true;
}

bool OAILoonie::is_method_Set() const{
    return m_method_isSet;
}

bool OAILoonie::is_method_Valid() const{
    return m_method_isValid;
}

double OAILoonie::getMonthlyLimit() const {
    return m_monthly_limit;
}
void OAILoonie::setMonthlyLimit(const double &monthly_limit) {
    m_monthly_limit = monthly_limit;
    m_monthly_limit_isSet = true;
}

bool OAILoonie::is_monthly_limit_Set() const{
    return m_monthly_limit_isSet;
}

bool OAILoonie::is_monthly_limit_Valid() const{
    return m_monthly_limit_isValid;
}

QString OAILoonie::getOrganizationId() const {
    return m_organization_id;
}
void OAILoonie::setOrganizationId(const QString &organization_id) {
    m_organization_id = organization_id;
    m_organization_id_isSet = true;
}

bool OAILoonie::is_organization_id_Set() const{
    return m_organization_id_isSet;
}

bool OAILoonie::is_organization_id_Valid() const{
    return m_organization_id_isValid;
}

QList<OAIPaymentCardBrand> OAILoonie::getPaymentCardSchemes() const {
    return m_payment_card_schemes;
}
void OAILoonie::setPaymentCardSchemes(const QList<OAIPaymentCardBrand> &payment_card_schemes) {
    m_payment_card_schemes = payment_card_schemes;
    m_payment_card_schemes_isSet = true;
}

bool OAILoonie::is_payment_card_schemes_Set() const{
    return m_payment_card_schemes_isSet;
}

bool OAILoonie::is_payment_card_schemes_Valid() const{
    return m_payment_card_schemes_isValid;
}

bool OAILoonie::isReconciliationWindowEnabled() const {
    return m_reconciliation_window_enabled;
}
void OAILoonie::setReconciliationWindowEnabled(const bool &reconciliation_window_enabled) {
    m_reconciliation_window_enabled = reconciliation_window_enabled;
    m_reconciliation_window_enabled_isSet = true;
}

bool OAILoonie::is_reconciliation_window_enabled_Set() const{
    return m_reconciliation_window_enabled_isSet;
}

bool OAILoonie::is_reconciliation_window_enabled_Valid() const{
    return m_reconciliation_window_enabled_isValid;
}

qint32 OAILoonie::getReconciliationWindowTtl() const {
    return m_reconciliation_window_ttl;
}
void OAILoonie::setReconciliationWindowTtl(const qint32 &reconciliation_window_ttl) {
    m_reconciliation_window_ttl = reconciliation_window_ttl;
    m_reconciliation_window_ttl_isSet = true;
}

bool OAILoonie::is_reconciliation_window_ttl_Set() const{
    return m_reconciliation_window_ttl_isSet;
}

bool OAILoonie::is_reconciliation_window_ttl_Valid() const{
    return m_reconciliation_window_ttl_isValid;
}

QString OAILoonie::getStatus() const {
    return m_status;
}
void OAILoonie::setStatus(const QString &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAILoonie::is_status_Set() const{
    return m_status_isSet;
}

bool OAILoonie::is_status_Valid() const{
    return m_status_isValid;
}

bool OAILoonie::isSticky() const {
    return m_sticky;
}
void OAILoonie::setSticky(const bool &sticky) {
    m_sticky = sticky;
    m_sticky_isSet = true;
}

bool OAILoonie::is_sticky_Set() const{
    return m_sticky_isSet;
}

bool OAILoonie::is_sticky_Valid() const{
    return m_sticky_isValid;
}

bool OAILoonie::isThreeDSecure() const {
    return m_three_d_secure;
}
void OAILoonie::setThreeDSecure(const bool &three_d_secure) {
    m_three_d_secure = three_d_secure;
    m_three_d_secure_isSet = true;
}

bool OAILoonie::is_three_d_secure_Set() const{
    return m_three_d_secure_isSet;
}

bool OAILoonie::is_three_d_secure_Valid() const{
    return m_three_d_secure_isValid;
}

qint32 OAILoonie::getTimeout() const {
    return m_timeout;
}
void OAILoonie::setTimeout(const qint32 &timeout) {
    m_timeout = timeout;
    m_timeout_isSet = true;
}

bool OAILoonie::is_timeout_Set() const{
    return m_timeout_isSet;
}

bool OAILoonie::is_timeout_Valid() const{
    return m_timeout_isValid;
}

QString OAILoonie::getToken() const {
    return m_token;
}
void OAILoonie::setToken(const QString &token) {
    m_token = token;
    m_token_isSet = true;
}

bool OAILoonie::is_token_Set() const{
    return m_token_isSet;
}

bool OAILoonie::is_token_Valid() const{
    return m_token_isValid;
}

QDateTime OAILoonie::getUpdatedTime() const {
    return m_updated_time;
}
void OAILoonie::setUpdatedTime(const QDateTime &updated_time) {
    m_updated_time = updated_time;
    m_updated_time_isSet = true;
}

bool OAILoonie::is_updated_time_Set() const{
    return m_updated_time_isSet;
}

bool OAILoonie::is_updated_time_Valid() const{
    return m_updated_time_isValid;
}

OAILoonie_allOf_credentials OAILoonie::getCredentials() const {
    return m_credentials;
}
void OAILoonie::setCredentials(const OAILoonie_allOf_credentials &credentials) {
    m_credentials = credentials;
    m_credentials_isSet = true;
}

bool OAILoonie::is_credentials_Set() const{
    return m_credentials_isSet;
}

bool OAILoonie::is_credentials_Valid() const{
    return m_credentials_isValid;
}

bool OAILoonie::isSet() const {
