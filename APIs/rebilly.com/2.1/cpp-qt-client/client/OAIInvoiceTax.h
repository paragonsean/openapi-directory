...
#ifndef OAIInvoiceTax_H
#define OAIInvoiceTax_H
...
class OAIInvoiceTax : public OAIObject {
public:
    OAIInvoiceTax();
    OAIInvoiceTax(QString json);
    ~OAIInvoiceTax() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIInvoiceTax)

#endif // OAIInvoiceTax_H
