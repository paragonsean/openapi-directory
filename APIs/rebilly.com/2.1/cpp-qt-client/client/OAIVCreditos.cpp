...
OAIVCreditos::OAIVCreditos(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIVCreditos::OAIVCreditos() {
    this->initializeModel();
}

OAIVCreditos::~OAIVCreditos() {}

void OAIVCreditos::initializeModel() {
...
void OAIVCreditos::fromJson(QString jsonString) {
...
void OAIVCreditos::fromJsonObject(QJsonObject json) {
...
QString OAIVCreditos::asJson() const {
...
QJsonObject OAIVCreditos::asJsonObject() const {
    QJsonObject obj;
    if (m__links.size() > 0) {
...
QList<OAIGatewayAccount__links_inner> OAIVCreditos::getLinks() const {
    return m__links;
}
void OAIVCreditos::setLinks(const QList<OAIGatewayAccount__links_inner> &_links) {
    m__links = _links;
    m__links_isSet = true;
}

bool OAIVCreditos::is__links_Set() const{
    return m__links_isSet;
}

bool OAIVCreditos::is__links_Valid() const{
    return m__links_isValid;
}

QList<QString> OAIVCreditos::getAcceptedCurrencies() const {
    return m_accepted_currencies;
}
void OAIVCreditos::setAcceptedCurrencies(const QList<QString> &accepted_currencies) {
    m_accepted_currencies = accepted_currencies;
    m_accepted_currencies_isSet = true;
}

bool OAIVCreditos::is_accepted_currencies_Set() const{
    return m_accepted_currencies_isSet;
}

bool OAIVCreditos::is_accepted_currencies_Valid() const{
    return m_accepted_currencies_isValid;
}

OAIAcquirerName OAIVCreditos::getAcquirerName() const {
    return m_acquirer_name;
}
void OAIVCreditos::setAcquirerName(const OAIAcquirerName &acquirer_name) {
    m_acquirer_name = acquirer_name;
    m_acquirer_name_isSet = true;
}

bool OAIVCreditos::is_acquirer_name_Set() const{
    return m_acquirer_name_isSet;
}

bool OAIVCreditos::is_acquirer_name_Valid() const{
    return m_acquirer_name_isValid;
}

QString OAIVCreditos::getAdditionalFilters() const {
    return m_additional_filters;
}
void OAIVCreditos::setAdditionalFilters(const QString &additional_filters) {
    m_additional_filters = additional_filters;
    m_additional_filters_isSet = true;
}

bool OAIVCreditos::is_additional_filters_Set() const{
    return m_additional_filters_isSet;
}

bool OAIVCreditos::is_additional_filters_Valid() const{
    return m_additional_filters_isValid;
}

qint32 OAIVCreditos::getApprovalWindowTtl() const {
    return m_approval_window_ttl;
}
void OAIVCreditos::setApprovalWindowTtl(const qint32 &approval_window_ttl) {
    m_approval_window_ttl = approval_window_ttl;
    m_approval_window_ttl_isSet = true;
}

bool OAIVCreditos::is_approval_window_ttl_Set() const{
    return m_approval_window_ttl_isSet;
}

bool OAIVCreditos::is_approval_window_ttl_Valid() const{
    return m_approval_window_ttl_isValid;
}

QString OAIVCreditos::getCityField() const {
    return m_city_field;
}
void OAIVCreditos::setCityField(const QString &city_field) {
    m_city_field = city_field;
    m_city_field_isSet = true;
}

bool OAIVCreditos::is_city_field_Set() const{
    return m_city_field_isSet;
}

bool OAIVCreditos::is_city_field_Valid() const{
    return m_city_field_isValid;
}

QDateTime OAIVCreditos::getCreatedTime() const {
    return m_created_time;
}
void OAIVCreditos::setCreatedTime(const QDateTime &created_time) {
    m_created_time = created_time;
    m_created_time_isSet = true;
}

bool OAIVCreditos::is_created_time_Set() const{
    return m_created_time_isSet;
}

bool OAIVCreditos::is_created_time_Valid() const{
    return m_created_time_isValid;
}

QString OAIVCreditos::getDccForceCurrency() const {
    return m_dcc_force_currency;
}
void OAIVCreditos::setDccForceCurrency(const QString &dcc_force_currency) {
    m_dcc_force_currency = dcc_force_currency;
    m_dcc_force_currency_isSet = true;
}

bool OAIVCreditos::is_dcc_force_currency_Set() const{
    return m_dcc_force_currency_isSet;
}

bool OAIVCreditos::is_dcc_force_currency_Valid() const{
    return m_dcc_force_currency_isValid;
}

qint32 OAIVCreditos::getDccMarkup() const {
    return m_dcc_markup;
}
void OAIVCreditos::setDccMarkup(const qint32 &dcc_markup) {
    m_dcc_markup = dcc_markup;
    m_dcc_markup_isSet = true;
}

bool OAIVCreditos::is_dcc_markup_Set() const{
    return m_dcc_markup_isSet;
}

bool OAIVCreditos::is_dcc_markup_Valid() const{
    return m_dcc_markup_isValid;
}

QString OAIVCreditos::getDescriptor() const {
    return m_descriptor;
}
void OAIVCreditos::setDescriptor(const QString &descriptor) {
    m_descriptor = descriptor;
    m_descriptor_isSet = true;
}

bool OAIVCreditos::is_descriptor_Set() const{
    return m_descriptor_isSet;
}

bool OAIVCreditos::is_descriptor_Valid() const{
    return m_descriptor_isValid;
}

OAIDigitalWallets OAIVCreditos::getDigitalWallets() const {
    return m_digital_wallets;
}
void OAIVCreditos::setDigitalWallets(const OAIDigitalWallets &digital_wallets) {
    m_digital_wallets = digital_wallets;
    m_digital_wallets_isSet = true;
}

bool OAIVCreditos::is_digital_wallets_Set() const{
    return m_digital_wallets_isSet;
}

bool OAIVCreditos::is_digital_wallets_Valid() const{
    return m_digital_wallets_isValid;
}

bool OAIVCreditos::isDynamicDescriptor() const {
    return m_dynamic_descriptor;
}
void OAIVCreditos::setDynamicDescriptor(const bool &dynamic_descriptor) {
    m_dynamic_descriptor = dynamic_descriptor;
    m_dynamic_descriptor_isSet = true;
}

bool OAIVCreditos::is_dynamic_descriptor_Set() const{
    return m_dynamic_descriptor_isSet;
}

bool OAIVCreditos::is_dynamic_descriptor_Valid() const{
    return m_dynamic_descriptor_isValid;
}

QList<QString> OAIVCreditos::getExcludedDccQuoteCurrencies() const {
    return m_excluded_dcc_quote_currencies;
}
void OAIVCreditos::setExcludedDccQuoteCurrencies(const QList<QString> &excluded_dcc_quote_currencies) {
    m_excluded_dcc_quote_currencies = excluded_dcc_quote_currencies;
    m_excluded_dcc_quote_currencies_isSet = true;
}

bool OAIVCreditos::is_excluded_dcc_quote_currencies_Set() const{
    return m_excluded_dcc_quote_currencies_isSet;
}

bool OAIVCreditos::is_excluded_dcc_quote_currencies_Valid() const{
    return m_excluded_dcc_quote_currencies_isValid;
}

OAIGatewayName OAIVCreditos::getGatewayName() const {
    return m_gateway_name;
}
void OAIVCreditos::setGatewayName(const OAIGatewayName &gateway_name) {
    m_gateway_name = gateway_name;
    m_gateway_name_isSet = true;
}

bool OAIVCreditos::is_gateway_name_Set() const{
    return m_gateway_name_isSet;
}

bool OAIVCreditos::is_gateway_name_Valid() const{
    return m_gateway_name_isValid;
}

QString OAIVCreditos::getId() const {
    return m_id;
}
void OAIVCreditos::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIVCreditos::is_id_Set() const{
    return m_id_isSet;
}

bool OAIVCreditos::is_id_Valid() const{
    return m_id_isValid;
}

bool OAIVCreditos::isIsDown() const {
    return m_is_down;
}
void OAIVCreditos::setIsDown(const bool &is_down) {
    m_is_down = is_down;
    m_is_down_isSet = true;
}

bool OAIVCreditos::is_is_down_Set() const{
    return m_is_down_isSet;
}

bool OAIVCreditos::is_is_down_Valid() const{
    return m_is_down_isValid;
}

QString OAIVCreditos::getMerchantCategoryCode() const {
    return m_merchant_category_code;
}
void OAIVCreditos::setMerchantCategoryCode(const QString &merchant_category_code) {
    m_merchant_category_code = merchant_category_code;
    m_merchant_category_code_isSet = true;
}

bool OAIVCreditos::is_merchant_category_code_Set() const{
    return m_merchant_category_code_isSet;
}

bool OAIVCreditos::is_merchant_category_code_Valid() const{
    return m_merchant_category_code_isValid;
}

OAIPaymentMethod OAIVCreditos::getMethod() const {
    return m_method;
}
void OAIVCreditos::setMethod(const OAIPaymentMethod &method) {
    m_method = method;
    m_method_isSet = true;
}

bool OAIVCreditos::is_method_Set() const{
    return m_method_isSet;
}

bool OAIVCreditos::is_method_Valid() const{
    return m_method_isValid;
}

double OAIVCreditos::getMonthlyLimit() const {
    return m_monthly_limit;
}
void OAIVCreditos::setMonthlyLimit(const double &monthly_limit) {
    m_monthly_limit = monthly_limit;
    m_monthly_limit_isSet = true;
}

bool OAIVCreditos::is_monthly_limit_Set() const{
    return m_monthly_limit_isSet;
}

bool OAIVCreditos::is_monthly_limit_Valid() const{
    return m_monthly_limit_isValid;
}

QString OAIVCreditos::getOrganizationId() const {
    return m_organization_id;
}
void OAIVCreditos::setOrganizationId(const QString &organization_id) {
    m_organization_id = organization_id;
    m_organization_id_isSet = true;
}

bool OAIVCreditos::is_organization_id_Set() const{
    return m_organization_id_isSet;
}

bool OAIVCreditos::is_organization_id_Valid() const{
    return m_organization_id_isValid;
}

QList<OAIPaymentCardBrand> OAIVCreditos::getPaymentCardSchemes() const {
    return m_payment_card_schemes;
}
void OAIVCreditos::setPaymentCardSchemes(const QList<OAIPaymentCardBrand> &payment_card_schemes) {
    m_payment_card_schemes = payment_card_schemes;
    m_payment_card_schemes_isSet = true;
}

bool OAIVCreditos::is_payment_card_schemes_Set() const{
    return m_payment_card_schemes_isSet;
}

bool OAIVCreditos::is_payment_card_schemes_Valid() const{
    return m_payment_card_schemes_isValid;
}

bool OAIVCreditos::isReconciliationWindowEnabled() const {
    return m_reconciliation_window_enabled;
}
void OAIVCreditos::setReconciliationWindowEnabled(const bool &reconciliation_window_enabled) {
    m_reconciliation_window_enabled = reconciliation_window_enabled;
    m_reconciliation_window_enabled_isSet = true;
}

bool OAIVCreditos::is_reconciliation_window_enabled_Set() const{
    return m_reconciliation_window_enabled_isSet;
}

bool OAIVCreditos::is_reconciliation_window_enabled_Valid() const{
    return m_reconciliation_window_enabled_isValid;
}

qint32 OAIVCreditos::getReconciliationWindowTtl() const {
    return m_reconciliation_window_ttl;
}
void OAIVCreditos::setReconciliationWindowTtl(const qint32 &reconciliation_window_ttl) {
    m_reconciliation_window_ttl = reconciliation_window_ttl;
    m_reconciliation_window_ttl_isSet = true;
}

bool OAIVCreditos::is_reconciliation_window_ttl_Set() const{
    return m_reconciliation_window_ttl_isSet;
}

bool OAIVCreditos::is_reconciliation_window_ttl_Valid() const{
    return m_reconciliation_window_ttl_isValid;
}

QString OAIVCreditos::getStatus() const {
    return m_status;
}
void OAIVCreditos::setStatus(const QString &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIVCreditos::is_status_Set() const{
    return m_status_isSet;
}

bool OAIVCreditos::is_status_Valid() const{
    return m_status_isValid;
}

bool OAIVCreditos::isSticky() const {
    return m_sticky;
}
void OAIVCreditos::setSticky(const bool &sticky) {
    m_sticky = sticky;
    m_sticky_isSet = true;
}

bool OAIVCreditos::is_sticky_Set() const{
    return m_sticky_isSet;
}

bool OAIVCreditos::is_sticky_Valid() const{
    return m_sticky_isValid;
}

bool OAIVCreditos::isThreeDSecure() const {
    return m_three_d_secure;
}
void OAIVCreditos::setThreeDSecure(const bool &three_d_secure) {
    m_three_d_secure = three_d_secure;
    m_three_d_secure_isSet = true;
}

bool OAIVCreditos::is_three_d_secure_Set() const{
    return m_three_d_secure_isSet;
}

bool OAIVCreditos::is_three_d_secure_Valid() const{
    return m_three_d_secure_isValid;
}

qint32 OAIVCreditos::getTimeout() const {
    return m_timeout;
}
void OAIVCreditos::setTimeout(const qint32 &timeout) {
    m_timeout = timeout;
    m_timeout_isSet = true;
}

bool OAIVCreditos::is_timeout_Set() const{
    return m_timeout_isSet;
}

bool OAIVCreditos::is_timeout_Valid() const{
    return m_timeout_isValid;
}

QString OAIVCreditos::getToken() const {
    return m_token;
}
void OAIVCreditos::setToken(const QString &token) {
    m_token = token;
    m_token_isSet = true;
}

bool OAIVCreditos::is_token_Set() const{
    return m_token_isSet;
}

bool OAIVCreditos::is_token_Valid() const{
    return m_token_isValid;
}

QDateTime OAIVCreditos::getUpdatedTime() const {
    return m_updated_time;
}
void OAIVCreditos::setUpdatedTime(const QDateTime &updated_time) {
    m_updated_time = updated_time;
    m_updated_time_isSet = true;
}

bool OAIVCreditos::is_updated_time_Set() const{
    return m_updated_time_isSet;
}

bool OAIVCreditos::is_updated_time_Valid() const{
    return m_updated_time_isValid;
}

OAIVCreditos_allOf_credentials OAIVCreditos::getCredentials() const {
    return m_credentials;
}
void OAIVCreditos::setCredentials(const OAIVCreditos_allOf_credentials &credentials) {
    m_credentials = credentials;
    m_credentials_isSet = true;
}

bool OAIVCreditos::is_credentials_Set() const{
    return m_credentials_isSet;
}

bool OAIVCreditos::is_credentials_Valid() const{
    return m_credentials_isValid;
}

bool OAIVCreditos::isSet() const {
...
bool OAIVCreditos::isValid() const {
