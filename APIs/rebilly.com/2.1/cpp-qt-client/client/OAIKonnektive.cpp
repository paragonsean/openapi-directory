...
OAIKonnektive::OAIKonnektive(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIKonnektive::OAIKonnektive() {
    this->initializeModel();
}

OAIKonnektive::~OAIKonnektive() {}

void OAIKonnektive::initializeModel() {
...
void OAIKonnektive::fromJson(QString jsonString) {
...
void OAIKonnektive::fromJsonObject(QJsonObject json) {
...
QString OAIKonnektive::asJson() const {
...
QJsonObject OAIKonnektive::asJsonObject() const {
    QJsonObject obj;
    if (m__links.size() > 0) {
...
QList<OAIGatewayAccount__links_inner> OAIKonnektive::getLinks() const {
    return m__links;
}
void OAIKonnektive::setLinks(const QList<OAIGatewayAccount__links_inner> &_links) {
    m__links = _links;
    m__links_isSet = true;
}

bool OAIKonnektive::is__links_Set() const{
    return m__links_isSet;
}

bool OAIKonnektive::is__links_Valid() const{
    return m__links_isValid;
}

QList<QString> OAIKonnektive::getAcceptedCurrencies() const {
    return m_accepted_currencies;
}
void OAIKonnektive::setAcceptedCurrencies(const QList<QString> &accepted_currencies) {
    m_accepted_currencies = accepted_currencies;
    m_accepted_currencies_isSet = true;
}

bool OAIKonnektive::is_accepted_currencies_Set() const{
    return m_accepted_currencies_isSet;
}

bool OAIKonnektive::is_accepted_currencies_Valid() const{
    return m_accepted_currencies_isValid;
}

OAIAcquirerName OAIKonnektive::getAcquirerName() const {
    return m_acquirer_name;
}
void OAIKonnektive::setAcquirerName(const OAIAcquirerName &acquirer_name) {
    m_acquirer_name = acquirer_name;
    m_acquirer_name_isSet = true;
}

bool OAIKonnektive::is_acquirer_name_Set() const{
    return m_acquirer_name_isSet;
}

bool OAIKonnektive::is_acquirer_name_Valid() const{
    return m_acquirer_name_isValid;
}

QString OAIKonnektive::getAdditionalFilters() const {
    return m_additional_filters;
}
void OAIKonnektive::setAdditionalFilters(const QString &additional_filters) {
    m_additional_filters = additional_filters;
    m_additional_filters_isSet = true;
}

bool OAIKonnektive::is_additional_filters_Set() const{
    return m_additional_filters_isSet;
}

bool OAIKonnektive::is_additional_filters_Valid() const{
    return m_additional_filters_isValid;
}

qint32 OAIKonnektive::getApprovalWindowTtl() const {
    return m_approval_window_ttl;
}
void OAIKonnektive::setApprovalWindowTtl(const qint32 &approval_window_ttl) {
    m_approval_window_ttl = approval_window_ttl;
    m_approval_window_ttl_isSet = true;
}

bool OAIKonnektive::is_approval_window_ttl_Set() const{
    return m_approval_window_ttl_isSet;
}

bool OAIKonnektive::is_approval_window_ttl_Valid() const{
    return m_approval_window_ttl_isValid;
}

QString OAIKonnektive::getCityField() const {
    return m_city_field;
}
void OAIKonnektive::setCityField(const QString &city_field) {
    m_city_field = city_field;
    m_city_field_isSet = true;
}

bool OAIKonnektive::is_city_field_Set() const{
    return m_city_field_isSet;
}

bool OAIKonnektive::is_city_field_Valid() const{
    return m_city_field_isValid;
}

QDateTime OAIKonnektive::getCreatedTime() const {
    return m_created_time;
}
void OAIKonnektive::setCreatedTime(const QDateTime &created_time) {
    m_created_time = created_time;
    m_created_time_isSet = true;
}

bool OAIKonnektive::is_created_time_Set() const{
    return m_created_time_isSet;
}

bool OAIKonnektive::is_created_time_Valid() const{
    return m_created_time_isValid;
}

QString OAIKonnektive::getDccForceCurrency() const {
    return m_dcc_force_currency;
}
void OAIKonnektive::setDccForceCurrency(const QString &dcc_force_currency) {
    m_dcc_force_currency = dcc_force_currency;
    m_dcc_force_currency_isSet = true;
}

bool OAIKonnektive::is_dcc_force_currency_Set() const{
    return m_dcc_force_currency_isSet;
}

bool OAIKonnektive::is_dcc_force_currency_Valid() const{
    return m_dcc_force_currency_isValid;
}

qint32 OAIKonnektive::getDccMarkup() const {
    return m_dcc_markup;
}
void OAIKonnektive::setDccMarkup(const qint32 &dcc_markup) {
    m_dcc_markup = dcc_markup;
    m_dcc_markup_isSet = true;
}

bool OAIKonnektive::is_dcc_markup_Set() const{
    return m_dcc_markup_isSet;
}

bool OAIKonnektive::is_dcc_markup_Valid() const{
    return m_dcc_markup_isValid;
}

QString OAIKonnektive::getDescriptor() const {
    return m_descriptor;
}
void OAIKonnektive::setDescriptor(const QString &descriptor) {
    m_descriptor = descriptor;
    m_descriptor_isSet = true;
}

bool OAIKonnektive::is_descriptor_Set() const{
    return m_descriptor_isSet;
}

bool OAIKonnektive::is_descriptor_Valid() const{
    return m_descriptor_isValid;
}

OAIDigitalWallets OAIKonnektive::getDigitalWallets() const {
    return m_digital_wallets;
}
void OAIKonnektive::setDigitalWallets(const OAIDigitalWallets &digital_wallets) {
    m_digital_wallets = digital_wallets;
    m_digital_wallets_isSet = true;
}

bool OAIKonnektive::is_digital_wallets_Set() const{
    return m_digital_wallets_isSet;
}

bool OAIKonnektive::is_digital_wallets_Valid() const{
    return m_digital_wallets_isValid;
}

bool OAIKonnektive::isDynamicDescriptor() const {
    return m_dynamic_descriptor;
}
void OAIKonnektive::setDynamicDescriptor(const bool &dynamic_descriptor) {
    m_dynamic_descriptor = dynamic_descriptor;
    m_dynamic_descriptor_isSet = true;
}

bool OAIKonnektive::is_dynamic_descriptor_Set() const{
    return m_dynamic_descriptor_isSet;
}

bool OAIKonnektive::is_dynamic_descriptor_Valid() const{
    return m_dynamic_descriptor_isValid;
}

QList<QString> OAIKonnektive::getExcludedDccQuoteCurrencies() const {
    return m_excluded_dcc_quote_currencies;
}
void OAIKonnektive::setExcludedDccQuoteCurrencies(const QList<QString> &excluded_dcc_quote_currencies) {
    m_excluded_dcc_quote_currencies = excluded_dcc_quote_currencies;
    m_excluded_dcc_quote_currencies_isSet = true;
}

bool OAIKonnektive::is_excluded_dcc_quote_currencies_Set() const{
    return m_excluded_dcc_quote_currencies_isSet;
}

bool OAIKonnektive::is_excluded_dcc_quote_currencies_Valid() const{
    return m_excluded_dcc_quote_currencies_isValid;
}

OAIGatewayName OAIKonnektive::getGatewayName() const {
    return m_gateway_name;
}
void OAIKonnektive::setGatewayName(const OAIGatewayName &gateway_name) {
    m_gateway_name = gateway_name;
    m_gateway_name_isSet = true;
}

bool OAIKonnektive::is_gateway_name_Set() const{
    return m_gateway_name_isSet;
}

bool OAIKonnektive::is_gateway_name_Valid() const{
    return m_gateway_name_isValid;
}

QString OAIKonnektive::getId() const {
    return m_id;
}
void OAIKonnektive::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIKonnektive::is_id_Set() const{
    return m_id_isSet;
}

bool OAIKonnektive::is_id_Valid() const{
    return m_id_isValid;
}

bool OAIKonnektive::isIsDown() const {
    return m_is_down;
}
void OAIKonnektive::setIsDown(const bool &is_down) {
    m_is_down = is_down;
    m_is_down_isSet = true;
}

bool OAIKonnektive::is_is_down_Set() const{
    return m_is_down_isSet;
}

bool OAIKonnektive::is_is_down_Valid() const{
    return m_is_down_isValid;
}

QString OAIKonnektive::getMerchantCategoryCode() const {
    return m_merchant_category_code;
}
void OAIKonnektive::setMerchantCategoryCode(const QString &merchant_category_code) {
    m_merchant_category_code = merchant_category_code;
    m_merchant_category_code_isSet = true;
}

bool OAIKonnektive::is_merchant_category_code_Set() const{
    return m_merchant_category_code_isSet;
}

bool OAIKonnektive::is_merchant_category_code_Valid() const{
    return m_merchant_category_code_isValid;
}

OAIPaymentMethod OAIKonnektive::getMethod() const {
    return m_method;
}
void OAIKonnektive::setMethod(const OAIPaymentMethod &method) {
    m_method = method;
    m_method_isSet = true;
}

bool OAIKonnektive::is_method_Set() const{
    return m_method_isSet;
}

bool OAIKonnektive::is_method_Valid() const{
    return m_method_isValid;
}

double OAIKonnektive::getMonthlyLimit() const {
    return m_monthly_limit;
}
void OAIKonnektive::setMonthlyLimit(const double &monthly_limit) {
    m_monthly_limit = monthly_limit;
    m_monthly_limit_isSet = true;
}

bool OAIKonnektive::is_monthly_limit_Set() const{
    return m_monthly_limit_isSet;
}

bool OAIKonnektive::is_monthly_limit_Valid() const{
    return m_monthly_limit_isValid;
}

QString OAIKonnektive::getOrganizationId() const {
    return m_organization_id;
}
void OAIKonnektive::setOrganizationId(const QString &organization_id) {
    m_organization_id = organization_id;
    m_organization_id_isSet = true;
}

bool OAIKonnektive::is_organization_id_Set() const{
    return m_organization_id_isSet;
}

bool OAIKonnektive::is_organization_id_Valid() const{
    return m_organization_id_isValid;
}

QList<OAIPaymentCardBrand> OAIKonnektive::getPaymentCardSchemes() const {
    return m_payment_card_schemes;
}
void OAIKonnektive::setPaymentCardSchemes(const QList<OAIPaymentCardBrand> &payment_card_schemes) {
    m_payment_card_schemes = payment_card_schemes;
    m_payment_card_schemes_isSet = true;
}

bool OAIKonnektive::is_payment_card_schemes_Set() const{
    return m_payment_card_schemes_isSet;
}

bool OAIKonnektive::is_payment_card_schemes_Valid() const{
    return m_payment_card_schemes_isValid;
}

bool OAIKonnektive::isReconciliationWindowEnabled() const {
    return m_reconciliation_window_enabled;
}
void OAIKonnektive::setReconciliationWindowEnabled(const bool &reconciliation_window_enabled) {
    m_reconciliation_window_enabled = reconciliation_window_enabled;
    m_reconciliation_window_enabled_isSet = true;
}

bool OAIKonnektive::is_reconciliation_window_enabled_Set() const{
    return m_reconciliation_window_enabled_isSet;
}

bool OAIKonnektive::is_reconciliation_window_enabled_Valid() const{
    return m_reconciliation_window_enabled_isValid;
}

qint32 OAIKonnektive::getReconciliationWindowTtl() const {
    return m_reconciliation_window_ttl;
}
void OAIKonnektive::setReconciliationWindowTtl(const qint32 &reconciliation_window_ttl) {
    m_reconciliation_window_ttl = reconciliation_window_ttl;
    m_reconciliation_window_ttl_isSet = true;
}

bool OAIKonnektive::is_reconciliation_window_ttl_Set() const{
    return m_reconciliation_window_ttl_isSet;
}

bool OAIKonnektive::is_reconciliation_window_ttl_Valid() const{
    return m_reconciliation_window_ttl_isValid;
}

QString OAIKonnektive::getStatus() const {
    return m_status;
}
void OAIKonnektive::setStatus(const QString &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIKonnektive::is_status_Set() const{
    return m_status_isSet;
}

bool OAIKonnektive::is_status_Valid() const{
    return m_status_isValid;
}

bool OAIKonnektive::isSticky() const {
    return m_sticky;
}
void OAIKonnektive::setSticky(const bool &sticky) {
    m_sticky = sticky;
    m_sticky_isSet = true;
}

bool OAIKonnektive::is_sticky_Set() const{
    return m_sticky_isSet;
}

bool OAIKonnektive::is_sticky_Valid() const{
    return m_sticky_isValid;
}

bool OAIKonnektive::isThreeDSecure() const {
    return m_three_d_secure;
}
void OAIKonnektive::setThreeDSecure(const bool &three_d_secure) {
    m_three_d_secure = three_d_secure;
    m_three_d_secure_isSet = true;
}

bool OAIKonnektive::is_three_d_secure_Set() const{
    return m_three_d_secure_isSet;
}

bool OAIKonnektive::is_three_d_secure_Valid() const{
    return m_three_d_secure_isValid;
}

qint32 OAIKonnektive::getTimeout() const {
    return m_timeout;
}
void OAIKonnektive::setTimeout(const qint32 &timeout) {
    m_timeout = timeout;
    m_timeout_isSet = true;
}

bool OAIKonnektive::is_timeout_Set() const{
    return m_timeout_isSet;
}

bool OAIKonnektive::is_timeout_Valid() const{
    return m_timeout_isValid;
}

QString OAIKonnektive::getToken() const {
    return m_token;
}
void OAIKonnektive::setToken(const QString &token) {
    m_token = token;
    m_token_isSet = true;
}

bool OAIKonnektive::is_token_Set() const{
    return m_token_isSet;
}

bool OAIKonnektive::is_token_Valid() const{
    return m_token_isValid;
}

QDateTime OAIKonnektive::getUpdatedTime() const {
    return m_updated_time;
}
void OAIKonnektive::setUpdatedTime(const QDateTime &updated_time) {
    m_updated_time = updated_time;
    m_updated_time_isSet = true;
}

bool OAIKonnektive::is_updated_time_Set() const{
    return m_updated_time_isSet;
}

bool OAIKonnektive::is_updated_time_Valid() const{
    return m_updated_time_isValid;
}

OAIKonnektive_allOf_credentials OAIKonnektive::getCredentials() const {
    return m_credentials;
}
void OAIKonnektive::setCredentials(const OAIKonnektive_allOf_credentials &credentials) {
    m_credentials = credentials;
    m_credentials_isSet = true;
}

bool OAIKonnektive::is_credentials_Set() const{
    return m_credentials_isSet;
}

bool OAIKonnektive::is_credentials_Valid() const{
    return m_credentials_isValid;
}

OAIKonnektive_allOf_settings OAIKonnektive::getSettings() const {
    return m_settings;
}
void OAIKonnektive::setSettings(const OAIKonnektive_allOf_settings &settings) {
    m_settings = settings;
    m_settings_isSet = true;
}

bool OAIKonnektive::is_settings_Set() const{
    return m_settings_isSet;
}

bool OAIKonnektive::is_settings_Valid() const{
    return m_settings_isValid;
}

bool OAIKonnektive::isSet() const {
...
bool OAIKonnektive::isValid() const {
