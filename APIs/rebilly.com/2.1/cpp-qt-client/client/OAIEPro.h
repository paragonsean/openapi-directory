...
#include "OAIEPro_allOf_credentials.h"
...
class OAIEPro_allOf_credentials;

class OAIEPro : public OAIObject {
public:
    OAIEPro();
    OAIEPro(QString json);
    ~OAIEPro() override;
    ...
    OAIEPro_allOf_credentials getCredentials() const;
    void setCredentials(const OAIEPro_allOf_credentials &credentials);
...
private:
    ...
    OAIEPro_allOf_credentials m_credentials;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEPro)
