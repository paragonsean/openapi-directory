...
#ifndef OAIReadyToPay_H
#define OAIReadyToPay_H

#include <QJsonObject>

#include "OAIContactObject.h"
#include "OAIReadyToPayAmount.h"
#include "OAIReadyToPayItems.h"
#include "OAIReadyToPayItems_items_inner.h"
...
class OAIReadyToPayItems_items_inner;

class OAIReadyToPay : public OAIObject {
public:
    OAIReadyToPay();
    OAIReadyToPay(QString json);
    ~OAIReadyToPay() override;
    ...
    QList<OAIReadyToPayItems_items_inner> getItems() const;
    void setItems(const QList<OAIReadyToPayItems_items_inner> &items);
...
private:
    ...
    QList<OAIReadyToPayItems_items_inner> m_items;
    bool m_items_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIReadyToPay)

#endif // OAIReadyToPay_H
