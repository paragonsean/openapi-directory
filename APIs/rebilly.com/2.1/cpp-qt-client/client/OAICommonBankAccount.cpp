...
#include "OAICommonBankAccount.h"
...
OAICommonBankAccount::OAICommonBankAccount(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICommonBankAccount::OAICommonBankAccount() {
    this->initializeModel();
}

OAICommonBankAccount::~OAICommonBankAccount() {}

void OAICommonBankAccount::initializeModel() {
...
void OAICommonBankAccount::fromJson(QString jsonString) {
...
void OAICommonBankAccount::fromJsonObject(QJsonObject json) {
...
QString OAICommonBankAccount::asJson() const {
...
QJsonObject OAICommonBankAccount::asJsonObject() const {
    QJsonObject obj;
...
QString OAICommonBankAccount::getAccountNumberType() const {
    return m_account_number_type;
}
void OAICommonBankAccount::setAccountNumberType(const QString &account_number_type) {
    m_account_number_type = account_number_type;
    m_account_number_type_isSet = true;
}

bool OAICommonBankAccount::is_account_number_type_Set() const{
    return m_account_number_type_isSet;
}

bool OAICommonBankAccount::is_account_number_type_Valid() const{
    return m_account_number_type_isValid;
}

QString OAICommonBankAccount::getAccountType() const {
    return m_account_type;
}
void OAICommonBankAccount::setAccountType(const QString &account_type) {
    m_account_type = account_type;
    m_account_type_isSet = true;
}

bool OAICommonBankAccount::is_account_type_Set() const{
    return m_account_type_isSet;
}

bool OAICommonBankAccount::is_account_type_Valid() const{
    return m_account_type_isValid;
}

QString OAICommonBankAccount::getBankName() const {
    return m_bank_name;
}
void OAICommonBankAccount::setBankName(const QString &bank_name) {
    m_bank_name = bank_name;
    m_bank_name_isSet = true;
}

bool OAICommonBankAccount::is_bank_name_Set() const{
    return m_bank_name_isSet;
}

bool OAICommonBankAccount::is_bank_name_Valid() const{
    return m_bank_name_isValid;
}

QString OAICommonBankAccount::getBic() const {
    return m_bic;
}
void OAICommonBankAccount::setBic(const QString &bic) {
    m_bic = bic;
    m_bic_isSet = true;
}

bool OAICommonBankAccount::is_bic_Set() const{
    return m_bic_isSet;
}

bool OAICommonBankAccount::is_bic_Valid() const{
    return m_bic_isValid;
}

OAIContactObject OAICommonBankAccount::getBillingAddress() const {
    return m_billing_address;
}
void OAICommonBankAccount::setBillingAddress(const OAIContactObject &billing_address) {
    m_billing_address = billing_address;
    m_billing_address_isSet = true;
}

bool OAICommonBankAccount::is_billing_address_Set() const{
    return m_billing_address_isSet;
}

bool OAICommonBankAccount::is_billing_address_Valid() const{
    return m_billing_address_isValid;
}

QDateTime OAICommonBankAccount::getCreatedTime() const {
    return m_created_time;
}
void OAICommonBankAccount::setCreatedTime(const QDateTime &created_time) {
    m_created_time = created_time;
    m_created_time_isSet = true;
}

bool OAICommonBankAccount::is_created_time_Set() const{
    return m_created_time_isSet;
}

bool OAICommonBankAccount::is_created_time_Valid() const{
    return m_created_time_isValid;
}

OAIObject OAICommonBankAccount::getCustomFields() const {
    return m_custom_fields;
}
void OAICommonBankAccount::setCustomFields(const OAIObject &custom_fields) {
    m_custom_fields = custom_fields;
    m_custom_fields_isSet = true;
}

bool OAICommonBankAccount::is_custom_fields_Set() const{
    return m_custom_fields_isSet;
}

bool OAICommonBankAccount::is_custom_fields_Valid() const{
    return m_custom_fields_isValid;
}

QString OAICommonBankAccount::getCustomerId() const {
    return m_customer_id;
}
void OAICommonBankAccount::setCustomerId(const QString &customer_id) {
    m_customer_id = customer_id;
    m_customer_id_isSet = true;
}

bool OAICommonBankAccount::is_customer_id_Set() const{
    return m_customer_id_isSet;
}

bool OAICommonBankAccount::is_customer_id_Valid() const{
    return m_customer_id_isValid;
}

QString OAICommonBankAccount::getFingerprint() const {
    return m_fingerprint;
}
void OAICommonBankAccount::setFingerprint(const QString &fingerprint) {
    m_fingerprint = fingerprint;
    m_fingerprint_isSet = true;
}

bool OAICommonBankAccount::is_fingerprint_Set() const{
    return m_fingerprint_isSet;
}

bool OAICommonBankAccount::is_fingerprint_Valid() const{
    return m_fingerprint_isValid;
}

QString OAICommonBankAccount::getId() const {
    return m_id;
}
void OAICommonBankAccount::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAICommonBankAccount::is_id_Set() const{
    return m_id_isSet;
}

bool OAICommonBankAccount::is_id_Valid() const{
    return m_id_isValid;
}

QString OAICommonBankAccount::getLast4() const {
    return m_last4;
}
void OAICommonBankAccount::setLast4(const QString &last4) {
    m_last4 = last4;
    m_last4_isSet = true;
}

bool OAICommonBankAccount::is_last4_Set() const{
    return m_last4_isSet;
}

bool OAICommonBankAccount::is_last4_Valid() const{
    return m_last4_isValid;
}

QString OAICommonBankAccount::getMethod() const {
    return m_method;
}
void OAICommonBankAccount::setMethod(const QString &method) {
    m_method = method;
    m_method_isSet = true;
}

bool OAICommonBankAccount::is_method_Set() const{
    return m_method_isSet;
}

bool OAICommonBankAccount::is_method_Valid() const{
    return m_method_isValid;
}

OAIRiskMetadata OAICommonBankAccount::getRiskMetadata() const {
    return m_risk_metadata;
}
void OAICommonBankAccount::setRiskMetadata(const OAIRiskMetadata &risk_metadata) {
    m_risk_metadata = risk_metadata;
    m_risk_metadata_isSet = true;
}

bool OAICommonBankAccount::is_risk_metadata_Set() const{
    return m_risk_metadata_isSet;
}

bool OAICommonBankAccount::is_risk_metadata_Valid() const{
    return m_risk_metadata_isValid;
}

QString OAICommonBankAccount::getRoutingNumber() const {
    return m_routing_number;
}
void OAICommonBankAccount::setRoutingNumber(const QString &routing_number) {
    m_routing_number = routing_number;
    m_routing_number_isSet = true;
}

bool OAICommonBankAccount::is_routing_number_Set() const{
    return m_routing_number_isSet;
}

bool OAICommonBankAccount::is_routing_number_Valid() const{
    return m_routing_number_isValid;
}

QString OAICommonBankAccount::getStatus() const {
    return m_status;
}
void OAICommonBankAccount::setStatus(const QString &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAICommonBankAccount::is_status_Set() const{
    return m_status_isSet;
}

bool OAICommonBankAccount::is_status_Valid() const{
    return m_status_isValid;
}

QDateTime OAICommonBankAccount::getUpdatedTime() const {
    return m_updated_time;
}
void OAICommonBankAccount::setUpdatedTime(const QDateTime &updated_time) {
    m_updated_time = updated_time;
    m_updated_time_isSet = true;
}

bool OAICommonBankAccount::is_updated_time_Set() const{
    return m_updated_time_isSet;
}

bool OAICommonBankAccount::is_updated_time_Valid() const{
    return m_updated_time_isValid;
}

bool OAICommonBankAccount::isSet() const {
...
bool OAICommonBankAccount::isValid() const {
