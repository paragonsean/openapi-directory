...
#ifndef OAICryptonator_H
#define OAICryptonator_H
...
class OAICryptonator_allOf_credentials;

class OAICryptonator : public OAIObject {
public:
    OAICryptonator();
    OAICryptonator(QString json);
    ~OAICryptonator() override;
    ...
    OAICryptonator_allOf_credentials getCredentials() const;
    void setCredentials(const OAICryptonator_allOf_credentials &credentials);
...
private:
    ...
    OAICryptonator_allOf_credentials m_credentials;
...
Q_DECLARE_METATYPE(OpenAPI::OAICryptonator)

#endif // OAICryptonator_H
