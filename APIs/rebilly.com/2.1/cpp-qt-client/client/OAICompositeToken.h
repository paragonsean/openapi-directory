...
#ifndef OAICompositeToken_H
#define OAICompositeToken_H
...
#include "OAIDigitalWalletToken.h"
#include "OAIKhelocardCardToken.h"
#include "OAILeadSource.h"
#include "OAIObject.h"
#include "OAIPaymentCardToken.h"
#include "OAIPlaidAccountToken.h"
...
class OAICompositeToken : public OAIObject {
public:
    OAICompositeToken();
    OAICompositeToken(QString json);
    ~OAICompositeToken() override;
    ...
    OAIObject getPaymentInstrument() const;
    void setPaymentInstrument(const OAIObject &payment_instrument);
    ...
    bool isIsUsed() const;
    void setIsUsed(const bool &is_used);
    bool is_is_used_Set() const;
    bool is_is_used_Valid() const;

    OAILeadSource getLeadSource() const;
    void setLeadSource(const OAILeadSource &lead_source);
    ...
    QDateTime getUsageTime() const;
    void setUsageTime(const QDateTime &usage_time);
    bool is_usage_time_Set() const;
    bool is_usage_time_Valid() const;
...
private:
    ...
    OAIObject m_payment_instrument;
    ...
    bool m_is_used;
    bool m_is_used_isSet;
    bool m_is_used_isValid;

    OAILeadSource m_lead_source;
    ...
    QDateTime m_usage_time;
    bool m_usage_time_isSet;
    bool m_usage_time_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAICompositeToken)

#endif // OAICompositeToken_H
