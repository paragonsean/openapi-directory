...
OAINeosurf::OAINeosurf(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAINeosurf::OAINeosurf() {
    this->initializeModel();
}

OAINeosurf::~OAINeosurf() {}

void OAINeosurf::initializeModel() {
...
void OAINeosurf::fromJson(QString jsonString) {
...
void OAINeosurf::fromJsonObject(QJsonObject json) {
...
QString OAINeosurf::asJson() const {
...
QJsonObject OAINeosurf::asJsonObject() const {
    QJsonObject obj;
    if (m__links.size() > 0) {
...
QList<OAIGatewayAccount__links_inner> OAINeosurf::getLinks() const {
    return m__links;
}
void OAINeosurf::setLinks(const QList<OAIGatewayAccount__links_inner> &_links) {
    m__links = _links;
    m__links_isSet = true;
}

bool OAINeosurf::is__links_Set() const{
    return m__links_isSet;
}

bool OAINeosurf::is__links_Valid() const{
    return m__links_isValid;
}

QList<QString> OAINeosurf::getAcceptedCurrencies() const {
    return m_accepted_currencies;
}
void OAINeosurf::setAcceptedCurrencies(const QList<QString> &accepted_currencies) {
    m_accepted_currencies = accepted_currencies;
    m_accepted_currencies_isSet = true;
}

bool OAINeosurf::is_accepted_currencies_Set() const{
    return m_accepted_currencies_isSet;
}

bool OAINeosurf::is_accepted_currencies_Valid() const{
    return m_accepted_currencies_isValid;
}

OAIAcquirerName OAINeosurf::getAcquirerName() const {
    return m_acquirer_name;
}
void OAINeosurf::setAcquirerName(const OAIAcquirerName &acquirer_name) {
    m_acquirer_name = acquirer_name;
    m_acquirer_name_isSet = true;
}

bool OAINeosurf::is_acquirer_name_Set() const{
    return m_acquirer_name_isSet;
}

bool OAINeosurf::is_acquirer_name_Valid() const{
    return m_acquirer_name_isValid;
}

QString OAINeosurf::getAdditionalFilters() const {
    return m_additional_filters;
}
void OAINeosurf::setAdditionalFilters(const QString &additional_filters) {
    m_additional_filters = additional_filters;
    m_additional_filters_isSet = true;
}

bool OAINeosurf::is_additional_filters_Set() const{
    return m_additional_filters_isSet;
}

bool OAINeosurf::is_additional_filters_Valid() const{
    return m_additional_filters_isValid;
}

qint32 OAINeosurf::getApprovalWindowTtl() const {
    return m_approval_window_ttl;
}
void OAINeosurf::setApprovalWindowTtl(const qint32 &approval_window_ttl) {
    m_approval_window_ttl = approval_window_ttl;
    m_approval_window_ttl_isSet = true;
}

bool OAINeosurf::is_approval_window_ttl_Set() const{
    return m_approval_window_ttl_isSet;
}

bool OAINeosurf::is_approval_window_ttl_Valid() const{
    return m_approval_window_ttl_isValid;
}

QString OAINeosurf::getCityField() const {
    return m_city_field;
}
void OAINeosurf::setCityField(const QString &city_field) {
    m_city_field = city_field;
    m_city_field_isSet = true;
}

bool OAINeosurf::is_city_field_Set() const{
    return m_city_field_isSet;
}

bool OAINeosurf::is_city_field_Valid() const{
    return m_city_field_isValid;
}

QDateTime OAINeosurf::getCreatedTime() const {
    return m_created_time;
}
void OAINeosurf::setCreatedTime(const QDateTime &created_time) {
    m_created_time = created_time;
    m_created_time_isSet = true;
}

bool OAINeosurf::is_created_time_Set() const{
    return m_created_time_isSet;
}

bool OAINeosurf::is_created_time_Valid() const{
    return m_created_time_isValid;
}

QString OAINeosurf::getDccForceCurrency() const {
    return m_dcc_force_currency;
}
void OAINeosurf::setDccForceCurrency(const QString &dcc_force_currency) {
    m_dcc_force_currency = dcc_force_currency;
    m_dcc_force_currency_isSet = true;
}

bool OAINeosurf::is_dcc_force_currency_Set() const{
    return m_dcc_force_currency_isSet;
}

bool OAINeosurf::is_dcc_force_currency_Valid() const{
    return m_dcc_force_currency_isValid;
}

qint32 OAINeosurf::getDccMarkup() const {
    return m_dcc_markup;
}
void OAINeosurf::setDccMarkup(const qint32 &dcc_markup) {
    m_dcc_markup = dcc_markup;
    m_dcc_markup_isSet = true;
}

bool OAINeosurf::is_dcc_markup_Set() const{
    return m_dcc_markup_isSet;
}

bool OAINeosurf::is_dcc_markup_Valid() const{
    return m_dcc_markup_isValid;
}

QString OAINeosurf::getDescriptor() const {
    return m_descriptor;
}
void OAINeosurf::setDescriptor(const QString &descriptor) {
    m_descriptor = descriptor;
    m_descriptor_isSet = true;
}

bool OAINeosurf::is_descriptor_Set() const{
    return m_descriptor_isSet;
}

bool OAINeosurf::is_descriptor_Valid() const{
    return m_descriptor_isValid;
}

OAIDigitalWallets OAINeosurf::getDigitalWallets() const {
    return m_digital_wallets;
}
void OAINeosurf::setDigitalWallets(const OAIDigitalWallets &digital_wallets) {
    m_digital_wallets = digital_wallets;
    m_digital_wallets_isSet = true;
}

bool OAINeosurf::is_digital_wallets_Set() const{
    return m_digital_wallets_isSet;
}

bool OAINeosurf::is_digital_wallets_Valid() const{
    return m_digital_wallets_isValid;
}

bool OAINeosurf::isDynamicDescriptor() const {
    return m_dynamic_descriptor;
}
void OAINeosurf::setDynamicDescriptor(const bool &dynamic_descriptor) {
    m_dynamic_descriptor = dynamic_descriptor;
    m_dynamic_descriptor_isSet = true;
}

bool OAINeosurf::is_dynamic_descriptor_Set() const{
    return m_dynamic_descriptor_isSet;
}

bool OAINeosurf::is_dynamic_descriptor_Valid() const{
    return m_dynamic_descriptor_isValid;
}

QList<QString> OAINeosurf::getExcludedDccQuoteCurrencies() const {
    return m_excluded_dcc_quote_currencies;
}
void OAINeosurf::setExcludedDccQuoteCurrencies(const QList<QString> &excluded_dcc_quote_currencies) {
    m_excluded_dcc_quote_currencies = excluded_dcc_quote_currencies;
    m_excluded_dcc_quote_currencies_isSet = true;
}

bool OAINeosurf::is_excluded_dcc_quote_currencies_Set() const{
    return m_excluded_dcc_quote_currencies_isSet;
}

bool OAINeosurf::is_excluded_dcc_quote_currencies_Valid() const{
    return m_excluded_dcc_quote_currencies_isValid;
}

OAIGatewayName OAINeosurf::getGatewayName() const {
    return m_gateway_name;
}
void OAINeosurf::setGatewayName(const OAIGatewayName &gateway_name) {
    m_gateway_name = gateway_name;
    m_gateway_name_isSet = true;
}

bool OAINeosurf::is_gateway_name_Set() const{
    return m_gateway_name_isSet;
}

bool OAINeosurf::is_gateway_name_Valid() const{
    return m_gateway_name_isValid;
}

QString OAINeosurf::getId() const {
    return m_id;
}
void OAINeosurf::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAINeosurf::is_id_Set() const{
    return m_id_isSet;
}

bool OAINeosurf::is_id_Valid() const{
    return m_id_isValid;
}

bool OAINeosurf::isIsDown() const {
    return m_is_down;
}
void OAINeosurf::setIsDown(const bool &is_down) {
    m_is_down = is_down;
    m_is_down_isSet = true;
}

bool OAINeosurf::is_is_down_Set() const{
    return m_is_down_isSet;
}

bool OAINeosurf::is_is_down_Valid() const{
    return m_is_down_isValid;
}

QString OAINeosurf::getMerchantCategoryCode() const {
    return m_merchant_category_code;
}
void OAINeosurf::setMerchantCategoryCode(const QString &merchant_category_code) {
    m_merchant_category_code = merchant_category_code;
    m_merchant_category_code_isSet = true;
}

bool OAINeosurf::is_merchant_category_code_Set() const{
    return m_merchant_category_code_isSet;
}

bool OAINeosurf::is_merchant_category_code_Valid() const{
    return m_merchant_category_code_isValid;
}

OAIPaymentMethod OAINeosurf::getMethod() const {
    return m_method;
}
void OAINeosurf::setMethod(const OAIPaymentMethod &method) {
    m_method = method;
    m_method_isSet = true;
}

bool OAINeosurf::is_method_Set() const{
    return m_method_isSet;
}

bool OAINeosurf::is_method_Valid() const{
    return m_method_isValid;
}

double OAINeosurf::getMonthlyLimit() const {
    return m_monthly_limit;
}
void OAINeosurf::setMonthlyLimit(const double &monthly_limit) {
    m_monthly_limit = monthly_limit;
    m_monthly_limit_isSet = true;
}

bool OAINeosurf::is_monthly_limit_Set() const{
    return m_monthly_limit_isSet;
}

bool OAINeosurf::is_monthly_limit_Valid() const{
    return m_monthly_limit_isValid;
}

QString OAINeosurf::getOrganizationId() const {
    return m_organization_id;
}
void OAINeosurf::setOrganizationId(const QString &organization_id) {
    m_organization_id = organization_id;
    m_organization_id_isSet = true;
}

bool OAINeosurf::is_organization_id_Set() const{
    return m_organization_id_isSet;
}

bool OAINeosurf::is_organization_id_Valid() const{
    return m_organization_id_isValid;
}

QList<OAIPaymentCardBrand> OAINeosurf::getPaymentCardSchemes() const {
    return m_payment_card_schemes;
}
void OAINeosurf::setPaymentCardSchemes(const QList<OAIPaymentCardBrand> &payment_card_schemes) {
    m_payment_card_schemes = payment_card_schemes;
    m_payment_card_schemes_isSet = true;
}

bool OAINeosurf::is_payment_card_schemes_Set() const{
    return m_payment_card_schemes_isSet;
}

bool OAINeosurf::is_payment_card_schemes_Valid() const{
    return m_payment_card_schemes_isValid;
}

bool OAINeosurf::isReconciliationWindowEnabled() const {
    return m_reconciliation_window_enabled;
}
void OAINeosurf::setReconciliationWindowEnabled(const bool &reconciliation_window_enabled) {
    m_reconciliation_window_enabled = reconciliation_window_enabled;
    m_reconciliation_window_enabled_isSet = true;
}

bool OAINeosurf::is_reconciliation_window_enabled_Set() const{
    return m_reconciliation_window_enabled_isSet;
}

bool OAINeosurf::is_reconciliation_window_enabled_Valid() const{
    return m_reconciliation_window_enabled_isValid;
}

qint32 OAINeosurf::getReconciliationWindowTtl() const {
    return m_reconciliation_window_ttl;
}
void OAINeosurf::setReconciliationWindowTtl(const qint32 &reconciliation_window_ttl) {
    m_reconciliation_window_ttl = reconciliation_window_ttl;
    m_reconciliation_window_ttl_isSet = true;
}

bool OAINeosurf::is_reconciliation_window_ttl_Set() const{
    return m_reconciliation_window_ttl_isSet;
}

bool OAINeosurf::is_reconciliation_window_ttl_Valid() const{
    return m_reconciliation_window_ttl_isValid;
}

QString OAINeosurf::getStatus() const {
    return m_status;
}
void OAINeosurf::setStatus(const QString &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAINeosurf::is_status_Set() const{
    return m_status_isSet;
}

bool OAINeosurf::is_status_Valid() const{
    return m_status_isValid;
}

bool OAINeosurf::isSticky() const {
    return m_sticky;
}
void OAINeosurf::setSticky(const bool &sticky) {
    m_sticky = sticky;
    m_sticky_isSet = true;
}

bool OAINeosurf::is_sticky_Set() const{
    return m_sticky_isSet;
}

bool OAINeosurf::is_sticky_Valid() const{
    return m_sticky_isValid;
}

bool OAINeosurf::isThreeDSecure() const {
    return m_three_d_secure;
}
void OAINeosurf::setThreeDSecure(const bool &three_d_secure) {
    m_three_d_secure = three_d_secure;
    m_three_d_secure_isSet = true;
}

bool OAINeosurf::is_three_d_secure_Set() const{
    return m_three_d_secure_isSet;
}

bool OAINeosurf::is_three_d_secure_Valid() const{
    return m_three_d_secure_isValid;
}

qint32 OAINeosurf::getTimeout() const {
    return m_timeout;
}
void OAINeosurf::setTimeout(const qint32 &timeout) {
    m_timeout = timeout;
    m_timeout_isSet = true;
}

bool OAINeosurf::is_timeout_Set() const{
    return m_timeout_isSet;
}

bool OAINeosurf::is_timeout_Valid() const{
    return m_timeout_isValid;
}

QString OAINeosurf::getToken() const {
    return m_token;
}
void OAINeosurf::setToken(const QString &token) {
    m_token = token;
    m_token_isSet = true;
}

bool OAINeosurf::is_token_Set() const{
    return m_token_isSet;
}

bool OAINeosurf::is_token_Valid() const{
    return m_token_isValid;
}

QDateTime OAINeosurf::getUpdatedTime() const {
    return m_updated_time;
}
void OAINeosurf::setUpdatedTime(const QDateTime &updated_time) {
    m_updated_time = updated_time;
    m_updated_time_isSet = true;
}

bool OAINeosurf::is_updated_time_Set() const{
    return m_updated_time_isSet;
}

bool OAINeosurf::is_updated_time_Valid() const{
    return m_updated_time_isValid;
}

OAINeosurf_allOf_credentials OAINeosurf::getCredentials() const {
    return m_credentials;
}
void OAINeosurf::setCredentials(const OAINeosurf_allOf_credentials &credentials) {
    m_credentials = credentials;
    m_credentials_isSet = true;
}

bool OAINeosurf::is_credentials_Set() const{
    return m_credentials_isSet;
}

bool OAINeosurf::is_credentials_Valid() const{
    return m_credentials_isValid;
}

bool OAINeosurf::isSet() const {
