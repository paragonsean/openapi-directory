...
#ifndef OAIUPayCard_H
#define OAIUPayCard_H
...
class OAIUPayCard_allOf_credentials;
class OAIUPayCard_allOf_settings;

class OAIUPayCard : public OAIObject {
public:
    OAIUPayCard();
    OAIUPayCard(QString json);
    ~OAIUPayCard() override;
    ...
    OAIUPayCard_allOf_credentials getCredentials() const;
    void setCredentials(const OAIUPayCard_allOf_credentials &credentials);
    bool is_credentials_Set() const;
    bool is_credentials_Valid() const;

    OAIUPayCard_allOf_settings getSettings() const;
    void setSettings(const OAIUPayCard_allOf_settings &settings);
...
private:
    ...
    OAIUPayCard_allOf_credentials m_credentials;
    bool m_credentials_isSet;
    bool m_credentials_isValid;

    OAIUPayCard_allOf_settings m_settings;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUPayCard)
