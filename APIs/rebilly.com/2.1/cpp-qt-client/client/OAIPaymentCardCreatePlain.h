...
/*
 * OAIPaymentCardCreatePlain.h
 *
 * 
 */

#ifndef OAIPaymentCardCreatePlain_H
#define OAIPaymentCardCreatePlain_H
...
class OAIPaymentCardCreatePlain : public OAIObject {
public:
    OAIPaymentCardCreatePlain();
    OAIPaymentCardCreatePlain(QString json);
    ~OAIPaymentCardCreatePlain() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPaymentCardCreatePlain)

#endif // OAIPaymentCardCreatePlain_H
