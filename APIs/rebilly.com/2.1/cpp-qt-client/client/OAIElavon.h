...
class OAIElavon_allOf_credentials;

class OAIElavon : public OAIObject {
public:
    OAIElavon();
    OAIElavon(QString json);
    ~OAIElavon() override;
    ...
    OAIElavon_allOf_credentials getCredentials() const;
    void setCredentials(const OAIElavon_allOf_credentials &credentials);
...
private:
    ...
    OAIElavon_allOf_credentials m_credentials;
...
Q_DECLARE_METATYPE(OpenAPI::OAIElavon)
