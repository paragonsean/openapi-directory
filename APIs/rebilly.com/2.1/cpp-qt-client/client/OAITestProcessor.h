...
#ifndef OAITestProcessor_H
#define OAITestProcessor_H
...
class OAITestProcessor3dsServers;

class OAITestProcessor : public OAIObject {
public:
    OAITestProcessor();
    OAITestProcessor(QString json);
    ~OAITestProcessor() override;
    ...
    OAITestProcessor3dsServers getThreeDSecureServer() const;
    void setThreeDSecureServer(const OAITestProcessor3dsServers &three_d_secure_server);
...
private:
    ...
    OAITestProcessor3dsServers m_three_d_secure_server;
...
Q_DECLARE_METATYPE(OpenAPI::OAITestProcessor)

#endif // OAITestProcessor_H
