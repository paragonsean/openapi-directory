...
OAIParamountInterac::OAIParamountInterac(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIParamountInterac::OAIParamountInterac() {
    this->initializeModel();
}

OAIParamountInterac::~OAIParamountInterac() {}

void OAIParamountInterac::initializeModel() {
...
void OAIParamountInterac::fromJson(QString jsonString) {
...
void OAIParamountInterac::fromJsonObject(QJsonObject json) {
...
QString OAIParamountInterac::asJson() const {
...
QJsonObject OAIParamountInterac::asJsonObject() const {
    QJsonObject obj;
    if (m__links.size() > 0) {
...
QList<OAIGatewayAccount__links_inner> OAIParamountInterac::getLinks() const {
    return m__links;
}
void OAIParamountInterac::setLinks(const QList<OAIGatewayAccount__links_inner> &_links) {
    m__links = _links;
    m__links_isSet = true;
}

bool OAIParamountInterac::is__links_Set() const{
    return m__links_isSet;
}

bool OAIParamountInterac::is__links_Valid() const{
    return m__links_isValid;
}

QList<QString> OAIParamountInterac::getAcceptedCurrencies() const {
    return m_accepted_currencies;
}
void OAIParamountInterac::setAcceptedCurrencies(const QList<QString> &accepted_currencies) {
    m_accepted_currencies = accepted_currencies;
    m_accepted_currencies_isSet = true;
}

bool OAIParamountInterac::is_accepted_currencies_Set() const{
    return m_accepted_currencies_isSet;
}

bool OAIParamountInterac::is_accepted_currencies_Valid() const{
    return m_accepted_currencies_isValid;
}

OAIAcquirerName OAIParamountInterac::getAcquirerName() const {
    return m_acquirer_name;
}
void OAIParamountInterac::setAcquirerName(const OAIAcquirerName &acquirer_name) {
    m_acquirer_name = acquirer_name;
    m_acquirer_name_isSet = true;
}

bool OAIParamountInterac::is_acquirer_name_Set() const{
    return m_acquirer_name_isSet;
}

bool OAIParamountInterac::is_acquirer_name_Valid() const{
    return m_acquirer_name_isValid;
}

QString OAIParamountInterac::getAdditionalFilters() const {
    return m_additional_filters;
}
void OAIParamountInterac::setAdditionalFilters(const QString &additional_filters) {
    m_additional_filters = additional_filters;
    m_additional_filters_isSet = true;
}

bool OAIParamountInterac::is_additional_filters_Set() const{
    return m_additional_filters_isSet;
}

bool OAIParamountInterac::is_additional_filters_Valid() const{
    return m_additional_filters_isValid;
}

qint32 OAIParamountInterac::getApprovalWindowTtl() const {
    return m_approval_window_ttl;
}
void OAIParamountInterac::setApprovalWindowTtl(const qint32 &approval_window_ttl) {
    m_approval_window_ttl = approval_window_ttl;
    m_approval_window_ttl_isSet = true;
}

bool OAIParamountInterac::is_approval_window_ttl_Set() const{
    return m_approval_window_ttl_isSet;
}

bool OAIParamountInterac::is_approval_window_ttl_Valid() const{
    return m_approval_window_ttl_isValid;
}

QString OAIParamountInterac::getCityField() const {
    return m_city_field;
}
void OAIParamountInterac::setCityField(const QString &city_field) {
    m_city_field = city_field;
    m_city_field_isSet = true;
}

bool OAIParamountInterac::is_city_field_Set() const{
    return m_city_field_isSet;
}

bool OAIParamountInterac::is_city_field_Valid() const{
    return m_city_field_isValid;
}

QDateTime OAIParamountInterac::getCreatedTime() const {
    return m_created_time;
}
void OAIParamountInterac::setCreatedTime(const QDateTime &created_time) {
    m_created_time = created_time;
    m_created_time_isSet = true;
}

bool OAIParamountInterac::is_created_time_Set() const{
    return m_created_time_isSet;
}

bool OAIParamountInterac::is_created_time_Valid() const{
    return m_created_time_isValid;
}

QString OAIParamountInterac::getDccForceCurrency() const {
    return m_dcc_force_currency;
}
void OAIParamountInterac::setDccForceCurrency(const QString &dcc_force_currency) {
    m_dcc_force_currency = dcc_force_currency;
    m_dcc_force_currency_isSet = true;
}

bool OAIParamountInterac::is_dcc_force_currency_Set() const{
    return m_dcc_force_currency_isSet;
}

bool OAIParamountInterac::is_dcc_force_currency_Valid() const{
    return m_dcc_force_currency_isValid;
}

qint32 OAIParamountInterac::getDccMarkup() const {
    return m_dcc_markup;
}
void OAIParamountInterac::setDccMarkup(const qint32 &dcc_markup) {
    m_dcc_markup = dcc_markup;
    m_dcc_markup_isSet = true;
}

bool OAIParamountInterac::is_dcc_markup_Set() const{
    return m_dcc_markup_isSet;
}

bool OAIParamountInterac::is_dcc_markup_Valid() const{
    return m_dcc_markup_isValid;
}

QString OAIParamountInterac::getDescriptor() const {
    return m_descriptor;
}
void OAIParamountInterac::setDescriptor(const QString &descriptor) {
    m_descriptor = descriptor;
    m_descriptor_isSet = true;
}

bool OAIParamountInterac::is_descriptor_Set() const{
    return m_descriptor_isSet;
}

bool OAIParamountInterac::is_descriptor_Valid() const{
    return m_descriptor_isValid;
}

OAIDigitalWallets OAIParamountInterac::getDigitalWallets() const {
    return m_digital_wallets;
}
void OAIParamountInterac::setDigitalWallets(const OAIDigitalWallets &digital_wallets) {
    m_digital_wallets = digital_wallets;
    m_digital_wallets_isSet = true;
}

bool OAIParamountInterac::is_digital_wallets_Set() const{
    return m_digital_wallets_isSet;
}

bool OAIParamountInterac::is_digital_wallets_Valid() const{
    return m_digital_wallets_isValid;
}

bool OAIParamountInterac::isDynamicDescriptor() const {
    return m_dynamic_descriptor;
}
void OAIParamountInterac::setDynamicDescriptor(const bool &dynamic_descriptor) {
    m_dynamic_descriptor = dynamic_descriptor;
    m_dynamic_descriptor_isSet = true;
}

bool OAIParamountInterac::is_dynamic_descriptor_Set() const{
    return m_dynamic_descriptor_isSet;
}

bool OAIParamountInterac::is_dynamic_descriptor_Valid() const{
    return m_dynamic_descriptor_isValid;
}

QList<QString> OAIParamountInterac::getExcludedDccQuoteCurrencies() const {
    return m_excluded_dcc_quote_currencies;
}
void OAIParamountInterac::setExcludedDccQuoteCurrencies(const QList<QString> &excluded_dcc_quote_currencies) {
    m_excluded_dcc_quote_currencies = excluded_dcc_quote_currencies;
    m_excluded_dcc_quote_currencies_isSet = true;
}

bool OAIParamountInterac::is_excluded_dcc_quote_currencies_Set() const{
    return m_excluded_dcc_quote_currencies_isSet;
}

bool OAIParamountInterac::is_excluded_dcc_quote_currencies_Valid() const{
    return m_excluded_dcc_quote_currencies_isValid;
}

OAIGatewayName OAIParamountInterac::getGatewayName() const {
    return m_gateway_name;
}
void OAIParamountInterac::setGatewayName(const OAIGatewayName &gateway_name) {
    m_gateway_name = gateway_name;
    m_gateway_name_isSet = true;
}

bool OAIParamountInterac::is_gateway_name_Set() const{
    return m_gateway_name_isSet;
}

bool OAIParamountInterac::is_gateway_name_Valid() const{
    return m_gateway_name_isValid;
}

QString OAIParamountInterac::getId() const {
    return m_id;
}
void OAIParamountInterac::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIParamountInterac::is_id_Set() const{
    return m_id_isSet;
}

bool OAIParamountInterac::is_id_Valid() const{
    return m_id_isValid;
}

bool OAIParamountInterac::isIsDown() const {
    return m_is_down;
}
void OAIParamountInterac::setIsDown(const bool &is_down) {
    m_is_down = is_down;
    m_is_down_isSet = true;
}

bool OAIParamountInterac::is_is_down_Set() const{
    return m_is_down_isSet;
}

bool OAIParamountInterac::is_is_down_Valid() const{
    return m_is_down_isValid;
}

QString OAIParamountInterac::getMerchantCategoryCode() const {
    return m_merchant_category_code;
}
void OAIParamountInterac::setMerchantCategoryCode(const QString &merchant_category_code) {
    m_merchant_category_code = merchant_category_code;
    m_merchant_category_code_isSet = true;
}

bool OAIParamountInterac::is_merchant_category_code_Set() const{
    return m_merchant_category_code_isSet;
}

bool OAIParamountInterac::is_merchant_category_code_Valid() const{
    return m_merchant_category_code_isValid;
}

OAIPaymentMethod OAIParamountInterac::getMethod() const {
    return m_method;
}
void OAIParamountInterac::setMethod(const OAIPaymentMethod &method) {
    m_method = method;
    m_method_isSet = true;
}

bool OAIParamountInterac::is_method_Set() const{
    return m_method_isSet;
}

bool OAIParamountInterac::is_method_Valid() const{
    return m_method_isValid;
}

double OAIParamountInterac::getMonthlyLimit() const {
    return m_monthly_limit;
}
void OAIParamountInterac::setMonthlyLimit(const double &monthly_limit) {
    m_monthly_limit = monthly_limit;
    m_monthly_limit_isSet = true;
}

bool OAIParamountInterac::is_monthly_limit_Set() const{
    return m_monthly_limit_isSet;
}

bool OAIParamountInterac::is_monthly_limit_Valid() const{
    return m_monthly_limit_isValid;
}

QString OAIParamountInterac::getOrganizationId() const {
    return m_organization_id;
}
void OAIParamountInterac::setOrganizationId(const QString &organization_id) {
    m_organization_id = organization_id;
    m_organization_id_isSet = true;
}

bool OAIParamountInterac::is_organization_id_Set() const{
    return m_organization_id_isSet;
}

bool OAIParamountInterac::is_organization_id_Valid() const{
    return m_organization_id_isValid;
}

QList<OAIPaymentCardBrand> OAIParamountInterac::getPaymentCardSchemes() const {
    return m_payment_card_schemes;
}
void OAIParamountInterac::setPaymentCardSchemes(const QList<OAIPaymentCardBrand> &payment_card_schemes) {
    m_payment_card_schemes = payment_card_schemes;
    m_payment_card_schemes_isSet = true;
}

bool OAIParamountInterac::is_payment_card_schemes_Set() const{
    return m_payment_card_schemes_isSet;
}

bool OAIParamountInterac::is_payment_card_schemes_Valid() const{
    return m_payment_card_schemes_isValid;
}

bool OAIParamountInterac::isReconciliationWindowEnabled() const {
    return m_reconciliation_window_enabled;
}
void OAIParamountInterac::setReconciliationWindowEnabled(const bool &reconciliation_window_enabled) {
    m_reconciliation_window_enabled = reconciliation_window_enabled;
    m_reconciliation_window_enabled_isSet = true;
}

bool OAIParamountInterac::is_reconciliation_window_enabled_Set() const{
    return m_reconciliation_window_enabled_isSet;
}

bool OAIParamountInterac::is_reconciliation_window_enabled_Valid() const{
    return m_reconciliation_window_enabled_isValid;
}

qint32 OAIParamountInterac::getReconciliationWindowTtl() const {
    return m_reconciliation_window_ttl;
}
void OAIParamountInterac::setReconciliationWindowTtl(const qint32 &reconciliation_window_ttl) {
    m_reconciliation_window_ttl = reconciliation_window_ttl;
    m_reconciliation_window_ttl_isSet = true;
}

bool OAIParamountInterac::is_reconciliation_window_ttl_Set() const{
    return m_reconciliation_window_ttl_isSet;
}

bool OAIParamountInterac::is_reconciliation_window_ttl_Valid() const{
    return m_reconciliation_window_ttl_isValid;
}

QString OAIParamountInterac::getStatus() const {
    return m_status;
}
void OAIParamountInterac::setStatus(const QString &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIParamountInterac::is_status_Set() const{
    return m_status_isSet;
}

bool OAIParamountInterac::is_status_Valid() const{
    return m_status_isValid;
}

bool OAIParamountInterac::isSticky() const {
    return m_sticky;
}
void OAIParamountInterac::setSticky(const bool &sticky) {
    m_sticky = sticky;
    m_sticky_isSet = true;
}

bool OAIParamountInterac::is_sticky_Set() const{
    return m_sticky_isSet;
}

bool OAIParamountInterac::is_sticky_Valid() const{
    return m_sticky_isValid;
}

bool OAIParamountInterac::isThreeDSecure() const {
    return m_three_d_secure;
}
void OAIParamountInterac::setThreeDSecure(const bool &three_d_secure) {
    m_three_d_secure = three_d_secure;
    m_three_d_secure_isSet = true;
}

bool OAIParamountInterac::is_three_d_secure_Set() const{
    return m_three_d_secure_isSet;
}

bool OAIParamountInterac::is_three_d_secure_Valid() const{
    return m_three_d_secure_isValid;
}

qint32 OAIParamountInterac::getTimeout() const {
    return m_timeout;
}
void OAIParamountInterac::setTimeout(const qint32 &timeout) {
    m_timeout = timeout;
    m_timeout_isSet = true;
}

bool OAIParamountInterac::is_timeout_Set() const{
    return m_timeout_isSet;
}

bool OAIParamountInterac::is_timeout_Valid() const{
    return m_timeout_isValid;
}

QString OAIParamountInterac::getToken() const {
    return m_token;
}
void OAIParamountInterac::setToken(const QString &token) {
    m_token = token;
    m_token_isSet = true;
}

bool OAIParamountInterac::is_token_Set() const{
    return m_token_isSet;
}

bool OAIParamountInterac::is_token_Valid() const{
    return m_token_isValid;
}

QDateTime OAIParamountInterac::getUpdatedTime() const {
    return m_updated_time;
}
void OAIParamountInterac::setUpdatedTime(const QDateTime &updated_time) {
    m_updated_time = updated_time;
    m_updated_time_isSet = true;
}

bool OAIParamountInterac::is_updated_time_Set() const{
    return m_updated_time_isSet;
}

bool OAIParamountInterac::is_updated_time_Valid() const{
    return m_updated_time_isValid;
}

OAIParamountInterac_allOf_credentials OAIParamountInterac::getCredentials() const {
    return m_credentials;
}
void OAIParamountInterac::setCredentials(const OAIParamountInterac_allOf_credentials &credentials) {
    m_credentials = credentials;
    m_credentials_isSet = true;
}

bool OAIParamountInterac::is_credentials_Set() const{
    return m_credentials_isSet;
}

bool OAIParamountInterac::is_credentials_Valid() const{
    return m_credentials_isValid;
}

OAIGigadat_allOf_settings OAIParamountInterac::getSettings() const {
    return m_settings;
}
void OAIParamountInterac::setSettings(const OAIGigadat_allOf_settings &settings) {
    m_settings = settings;
    m_settings_isSet = true;
}

bool OAIParamountInterac::is_settings_Set() const{
    return m_settings_isSet;
}

bool OAIParamountInterac::is_settings_Valid() const{
    return m_settings_isValid;
}

bool OAIParamountInterac::isSet() const {
...
bool OAIParamountInterac::isValid() const {
