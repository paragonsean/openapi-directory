...
OAIMoneris::OAIMoneris(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIMoneris::OAIMoneris() {
    this->initializeModel();
}

OAIMoneris::~OAIMoneris() {}

void OAIMoneris::initializeModel() {
...
void OAIMoneris::fromJson(QString jsonString) {
...
void OAIMoneris::fromJsonObject(QJsonObject json) {
...
QString OAIMoneris::asJson() const {
...
QJsonObject OAIMoneris::asJsonObject() const {
    QJsonObject obj;
    if (m__links.size() > 0) {
...
QList<OAIGatewayAccount__links_inner> OAIMoneris::getLinks() const {
    return m__links;
}
void OAIMoneris::setLinks(const QList<OAIGatewayAccount__links_inner> &_links) {
    m__links = _links;
    m__links_isSet = true;
}

bool OAIMoneris::is__links_Set() const{
    return m__links_isSet;
}

bool OAIMoneris::is__links_Valid() const{
    return m__links_isValid;
}

QList<QString> OAIMoneris::getAcceptedCurrencies() const {
    return m_accepted_currencies;
}
void OAIMoneris::setAcceptedCurrencies(const QList<QString> &accepted_currencies) {
    m_accepted_currencies = accepted_currencies;
    m_accepted_currencies_isSet = true;
}

bool OAIMoneris::is_accepted_currencies_Set() const{
    return m_accepted_currencies_isSet;
}

bool OAIMoneris::is_accepted_currencies_Valid() const{
    return m_accepted_currencies_isValid;
}

OAIAcquirerName OAIMoneris::getAcquirerName() const {
    return m_acquirer_name;
}
void OAIMoneris::setAcquirerName(const OAIAcquirerName &acquirer_name) {
    m_acquirer_name = acquirer_name;
    m_acquirer_name_isSet = true;
}

bool OAIMoneris::is_acquirer_name_Set() const{
    return m_acquirer_name_isSet;
}

bool OAIMoneris::is_acquirer_name_Valid() const{
    return m_acquirer_name_isValid;
}

QString OAIMoneris::getAdditionalFilters() const {
    return m_additional_filters;
}
void OAIMoneris::setAdditionalFilters(const QString &additional_filters) {
    m_additional_filters = additional_filters;
    m_additional_filters_isSet = true;
}

bool OAIMoneris::is_additional_filters_Set() const{
    return m_additional_filters_isSet;
}

bool OAIMoneris::is_additional_filters_Valid() const{
    return m_additional_filters_isValid;
}

qint32 OAIMoneris::getApprovalWindowTtl() const {
    return m_approval_window_ttl;
}
void OAIMoneris::setApprovalWindowTtl(const qint32 &approval_window_ttl) {
    m_approval_window_ttl = approval_window_ttl;
    m_approval_window_ttl_isSet = true;
}

bool OAIMoneris::is_approval_window_ttl_Set() const{
    return m_approval_window_ttl_isSet;
}

bool OAIMoneris::is_approval_window_ttl_Valid() const{
    return m_approval_window_ttl_isValid;
}

QString OAIMoneris::getCityField() const {
    return m_city_field;
}
void OAIMoneris::setCityField(const QString &city_field) {
    m_city_field = city_field;
    m_city_field_isSet = true;
}

bool OAIMoneris::is_city_field_Set() const{
    return m_city_field_isSet;
}

bool OAIMoneris::is_city_field_Valid() const{
    return m_city_field_isValid;
}

QDateTime OAIMoneris::getCreatedTime() const {
    return m_created_time;
}
void OAIMoneris::setCreatedTime(const QDateTime &created_time) {
    m_created_time = created_time;
    m_created_time_isSet = true;
}

bool OAIMoneris::is_created_time_Set() const{
    return m_created_time_isSet;
}

bool OAIMoneris::is_created_time_Valid() const{
    return m_created_time_isValid;
}

QString OAIMoneris::getDccForceCurrency() const {
    return m_dcc_force_currency;
}
void OAIMoneris::setDccForceCurrency(const QString &dcc_force_currency) {
    m_dcc_force_currency = dcc_force_currency;
    m_dcc_force_currency_isSet = true;
}

bool OAIMoneris::is_dcc_force_currency_Set() const{
    return m_dcc_force_currency_isSet;
}

bool OAIMoneris::is_dcc_force_currency_Valid() const{
    return m_dcc_force_currency_isValid;
}

qint32 OAIMoneris::getDccMarkup() const {
    return m_dcc_markup;
}
void OAIMoneris::setDccMarkup(const qint32 &dcc_markup) {
    m_dcc_markup = dcc_markup;
    m_dcc_markup_isSet = true;
}

bool OAIMoneris::is_dcc_markup_Set() const{
    return m_dcc_markup_isSet;
}

bool OAIMoneris::is_dcc_markup_Valid() const{
    return m_dcc_markup_isValid;
}

QString OAIMoneris::getDescriptor() const {
    return m_descriptor;
}
void OAIMoneris::setDescriptor(const QString &descriptor) {
    m_descriptor = descriptor;
    m_descriptor_isSet = true;
}

bool OAIMoneris::is_descriptor_Set() const{
    return m_descriptor_isSet;
}

bool OAIMoneris::is_descriptor_Valid() const{
    return m_descriptor_isValid;
}

OAIDigitalWallets OAIMoneris::getDigitalWallets() const {
    return m_digital_wallets;
}
void OAIMoneris::setDigitalWallets(const OAIDigitalWallets &digital_wallets) {
    m_digital_wallets = digital_wallets;
    m_digital_wallets_isSet = true;
}

bool OAIMoneris::is_digital_wallets_Set() const{
    return m_digital_wallets_isSet;
}

bool OAIMoneris::is_digital_wallets_Valid() const{
    return m_digital_wallets_isValid;
}

bool OAIMoneris::isDynamicDescriptor() const {
    return m_dynamic_descriptor;
}
void OAIMoneris::setDynamicDescriptor(const bool &dynamic_descriptor) {
    m_dynamic_descriptor = dynamic_descriptor;
    m_dynamic_descriptor_isSet = true;
}

bool OAIMoneris::is_dynamic_descriptor_Set() const{
    return m_dynamic_descriptor_isSet;
}

bool OAIMoneris::is_dynamic_descriptor_Valid() const{
    return m_dynamic_descriptor_isValid;
}

QList<QString> OAIMoneris::getExcludedDccQuoteCurrencies() const {
    return m_excluded_dcc_quote_currencies;
}
void OAIMoneris::setExcludedDccQuoteCurrencies(const QList<QString> &excluded_dcc_quote_currencies) {
    m_excluded_dcc_quote_currencies = excluded_dcc_quote_currencies;
    m_excluded_dcc_quote_currencies_isSet = true;
}

bool OAIMoneris::is_excluded_dcc_quote_currencies_Set() const{
    return m_excluded_dcc_quote_currencies_isSet;
}

bool OAIMoneris::is_excluded_dcc_quote_currencies_Valid() const{
    return m_excluded_dcc_quote_currencies_isValid;
}

OAIGatewayName OAIMoneris::getGatewayName() const {
    return m_gateway_name;
}
void OAIMoneris::setGatewayName(const OAIGatewayName &gateway_name) {
    m_gateway_name = gateway_name;
    m_gateway_name_isSet = true;
}

bool OAIMoneris::is_gateway_name_Set() const{
    return m_gateway_name_isSet;
}

bool OAIMoneris::is_gateway_name_Valid() const{
    return m_gateway_name_isValid;
}

QString OAIMoneris::getId() const {
    return m_id;
}
void OAIMoneris::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIMoneris::is_id_Set() const{
    return m_id_isSet;
}

bool OAIMoneris::is_id_Valid() const{
    return m_id_isValid;
}

bool OAIMoneris::isIsDown() const {
    return m_is_down;
}
void OAIMoneris::setIsDown(const bool &is_down) {
    m_is_down = is_down;
    m_is_down_isSet = true;
}

bool OAIMoneris::is_is_down_Set() const{
    return m_is_down_isSet;
}

bool OAIMoneris::is_is_down_Valid() const{
    return m_is_down_isValid;
}

QString OAIMoneris::getMerchantCategoryCode() const {
    return m_merchant_category_code;
}
void OAIMoneris::setMerchantCategoryCode(const QString &merchant_category_code) {
    m_merchant_category_code = merchant_category_code;
    m_merchant_category_code_isSet = true;
}

bool OAIMoneris::is_merchant_category_code_Set() const{
    return m_merchant_category_code_isSet;
}

bool OAIMoneris::is_merchant_category_code_Valid() const{
    return m_merchant_category_code_isValid;
}

OAIPaymentMethod OAIMoneris::getMethod() const {
    return m_method;
}
void OAIMoneris::setMethod(const OAIPaymentMethod &method) {
    m_method = method;
    m_method_isSet = true;
}

bool OAIMoneris::is_method_Set() const{
    return m_method_isSet;
}

bool OAIMoneris::is_method_Valid() const{
    return m_method_isValid;
}

double OAIMoneris::getMonthlyLimit() const {
    return m_monthly_limit;
}
void OAIMoneris::setMonthlyLimit(const double &monthly_limit) {
    m_monthly_limit = monthly_limit;
    m_monthly_limit_isSet = true;
}

bool OAIMoneris::is_monthly_limit_Set() const{
    return m_monthly_limit_isSet;
}

bool OAIMoneris::is_monthly_limit_Valid() const{
    return m_monthly_limit_isValid;
}

QString OAIMoneris::getOrganizationId() const {
    return m_organization_id;
}
void OAIMoneris::setOrganizationId(const QString &organization_id) {
    m_organization_id = organization_id;
    m_organization_id_isSet = true;
}

bool OAIMoneris::is_organization_id_Set() const{
    return m_organization_id_isSet;
}

bool OAIMoneris::is_organization_id_Valid() const{
    return m_organization_id_isValid;
}

QList<OAIPaymentCardBrand> OAIMoneris::getPaymentCardSchemes() const {
    return m_payment_card_schemes;
}
void OAIMoneris::setPaymentCardSchemes(const QList<OAIPaymentCardBrand> &payment_card_schemes) {
    m_payment_card_schemes = payment_card_schemes;
    m_payment_card_schemes_isSet = true;
}

bool OAIMoneris::is_payment_card_schemes_Set() const{
    return m_payment_card_schemes_isSet;
}

bool OAIMoneris::is_payment_card_schemes_Valid() const{
    return m_payment_card_schemes_isValid;
}

bool OAIMoneris::isReconciliationWindowEnabled() const {
    return m_reconciliation_window_enabled;
}
void OAIMoneris::setReconciliationWindowEnabled(const bool &reconciliation_window_enabled) {
    m_reconciliation_window_enabled = reconciliation_window_enabled;
    m_reconciliation_window_enabled_isSet = true;
}

bool OAIMoneris::is_reconciliation_window_enabled_Set() const{
    return m_reconciliation_window_enabled_isSet;
}

bool OAIMoneris::is_reconciliation_window_enabled_Valid() const{
    return m_reconciliation_window_enabled_isValid;
}

qint32 OAIMoneris::getReconciliationWindowTtl() const {
    return m_reconciliation_window_ttl;
}
void OAIMoneris::setReconciliationWindowTtl(const qint32 &reconciliation_window_ttl) {
    m_reconciliation_window_ttl = reconciliation_window_ttl;
    m_reconciliation_window_ttl_isSet = true;
}

bool OAIMoneris::is_reconciliation_window_ttl_Set() const{
    return m_reconciliation_window_ttl_isSet;
}

bool OAIMoneris::is_reconciliation_window_ttl_Valid() const{
    return m_reconciliation_window_ttl_isValid;
}

QString OAIMoneris::getStatus() const {
    return m_status;
}
void OAIMoneris::setStatus(const QString &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIMoneris::is_status_Set() const{
    return m_status_isSet;
}

bool OAIMoneris::is_status_Valid() const{
    return m_status_isValid;
}

bool OAIMoneris::isSticky() const {
    return m_sticky;
}
void OAIMoneris::setSticky(const bool &sticky) {
    m_sticky = sticky;
    m_sticky_isSet = true;
}

bool OAIMoneris::is_sticky_Set() const{
    return m_sticky_isSet;
}

bool OAIMoneris::is_sticky_Valid() const{
    return m_sticky_isValid;
}

bool OAIMoneris::isThreeDSecure() const {
    return m_three_d_secure;
}
void OAIMoneris::setThreeDSecure(const bool &three_d_secure) {
    m_three_d_secure = three_d_secure;
    m_three_d_secure_isSet = true;
}

bool OAIMoneris::is_three_d_secure_Set() const{
    return m_three_d_secure_isSet;
}

bool OAIMoneris::is_three_d_secure_Valid() const{
    return m_three_d_secure_isValid;
}

qint32 OAIMoneris::getTimeout() const {
    return m_timeout;
}
void OAIMoneris::setTimeout(const qint32 &timeout) {
    m_timeout = timeout;
    m_timeout_isSet = true;
}

bool OAIMoneris::is_timeout_Set() const{
    return m_timeout_isSet;
}

bool OAIMoneris::is_timeout_Valid() const{
    return m_timeout_isValid;
}

QString OAIMoneris::getToken() const {
    return m_token;
}
void OAIMoneris::setToken(const QString &token) {
    m_token = token;
    m_token_isSet = true;
}

bool OAIMoneris::is_token_Set() const{
    return m_token_isSet;
}

bool OAIMoneris::is_token_Valid() const{
    return m_token_isValid;
}

QDateTime OAIMoneris::getUpdatedTime() const {
    return m_updated_time;
}
void OAIMoneris::setUpdatedTime(const QDateTime &updated_time) {
    m_updated_time = updated_time;
    m_updated_time_isSet = true;
}

bool OAIMoneris::is_updated_time_Set() const{
    return m_updated_time_isSet;
}

bool OAIMoneris::is_updated_time_Valid() const{
    return m_updated_time_isValid;
}

OAIMoneris_allOf_credentials OAIMoneris::getCredentials() const {
    return m_credentials;
}
void OAIMoneris::setCredentials(const OAIMoneris_allOf_credentials &credentials) {
    m_credentials = credentials;
    m_credentials_isSet = true;
}

bool OAIMoneris::is_credentials_Set() const{
    return m_credentials_isSet;
}

bool OAIMoneris::is_credentials_Valid() const{
    return m_credentials_isValid;
}

bool OAIMoneris::isSet() const {
