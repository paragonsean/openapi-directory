...
/*
 * OAIVaultedInstrument.h
 *
 * Vaulted payment instrument.
 */

#ifndef OAIVaultedInstrument_H
#define OAIVaultedInstrument_H
...
class OAIVaultedInstrument : public OAIObject {
public:
    OAIVaultedInstrument();
    OAIVaultedInstrument(QString json);
    ~OAIVaultedInstrument() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIVaultedInstrument)

#endif // OAIVaultedInstrument_H
