...
#ifndef OAIKhelocard_H
#define OAIKhelocard_H
...
#include "OAIKhelocard_allOf_credentials.h"
...
class OAIKhelocard_allOf_credentials;

class OAIKhelocard : public OAIObject {
public:
    OAIKhelocard();
    OAIKhelocard(QString json);
    ~OAIKhelocard() override;
    ...
    OAIKhelocard_allOf_credentials getCredentials() const;
    void setCredentials(const OAIKhelocard_allOf_credentials &credentials);
...
private:
    ...
    OAIKhelocard_allOf_credentials m_credentials;
...
Q_DECLARE_METATYPE(OpenAPI::OAIKhelocard)

#endif // OAIKhelocard_H
