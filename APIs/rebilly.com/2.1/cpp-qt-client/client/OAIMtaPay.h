...
class OAIMtaPay_allOf_credentials;
class OAIMtaPay_allOf_settings;

class OAIMtaPay : public OAIObject {
public:
    OAIMtaPay();
    OAIMtaPay(QString json);
    ~OAIMtaPay() override;
    ...
    OAIMtaPay_allOf_credentials getCredentials() const;
    void setCredentials(const OAIMtaPay_allOf_credentials &credentials);
    bool is_credentials_Set() const;
    bool is_credentials_Valid() const;

    OAIMtaPay_allOf_settings getSettings() const;
    void setSettings(const OAIMtaPay_allOf_settings &settings);
...
private:
    ...
    OAIMtaPay_allOf_credentials m_credentials;
    bool m_credentials_isSet;
    bool m_credentials_isValid;

    OAIMtaPay_allOf_settings m_settings;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMtaPay)
