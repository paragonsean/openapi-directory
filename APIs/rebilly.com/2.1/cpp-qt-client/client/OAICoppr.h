...
#include "OAICoppr_allOf_credentials.h"
#include "OAICoppr_allOf_settings.h"
...
class OAICoppr_allOf_credentials;
class OAICoppr_allOf_settings;

class OAICoppr : public OAIObject {
public:
    OAICoppr();
    OAICoppr(QString json);
    ~OAICoppr() override;
    ...
    OAICoppr_allOf_credentials getCredentials() const;
    void setCredentials(const OAICoppr_allOf_credentials &credentials);
    bool is_credentials_Set() const;
    bool is_credentials_Valid() const;

    OAICoppr_allOf_settings getSettings() const;
    void setSettings(const OAICoppr_allOf_settings &settings);
...
private:
    ...
    OAICoppr_allOf_credentials m_credentials;
    bool m_credentials_isSet;
    bool m_credentials_isValid;

    OAICoppr_allOf_settings m_settings;
...
Q_DECLARE_METATYPE(OpenAPI::OAICoppr)
