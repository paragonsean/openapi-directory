...
OAICCAvenue::OAICCAvenue(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICCAvenue::OAICCAvenue() {
    this->initializeModel();
}

OAICCAvenue::~OAICCAvenue() {}

void OAICCAvenue::initializeModel() {
...
void OAICCAvenue::fromJson(QString jsonString) {
...
void OAICCAvenue::fromJsonObject(QJsonObject json) {
...
QString OAICCAvenue::asJson() const {
...
QJsonObject OAICCAvenue::asJsonObject() const {
    QJsonObject obj;
    if (m__links.size() > 0) {
...
QList<OAIGatewayAccount__links_inner> OAICCAvenue::getLinks() const {
    return m__links;
}
void OAICCAvenue::setLinks(const QList<OAIGatewayAccount__links_inner> &_links) {
    m__links = _links;
    m__links_isSet = true;
}

bool OAICCAvenue::is__links_Set() const{
    return m__links_isSet;
}

bool OAICCAvenue::is__links_Valid() const{
    return m__links_isValid;
}

QList<QString> OAICCAvenue::getAcceptedCurrencies() const {
    return m_accepted_currencies;
}
void OAICCAvenue::setAcceptedCurrencies(const QList<QString> &accepted_currencies) {
    m_accepted_currencies = accepted_currencies;
    m_accepted_currencies_isSet = true;
}

bool OAICCAvenue::is_accepted_currencies_Set() const{
    return m_accepted_currencies_isSet;
}

bool OAICCAvenue::is_accepted_currencies_Valid() const{
    return m_accepted_currencies_isValid;
}

OAIAcquirerName OAICCAvenue::getAcquirerName() const {
    return m_acquirer_name;
}
void OAICCAvenue::setAcquirerName(const OAIAcquirerName &acquirer_name) {
    m_acquirer_name = acquirer_name;
    m_acquirer_name_isSet = true;
}

bool OAICCAvenue::is_acquirer_name_Set() const{
    return m_acquirer_name_isSet;
}

bool OAICCAvenue::is_acquirer_name_Valid() const{
    return m_acquirer_name_isValid;
}

QString OAICCAvenue::getAdditionalFilters() const {
    return m_additional_filters;
}
void OAICCAvenue::setAdditionalFilters(const QString &additional_filters) {
    m_additional_filters = additional_filters;
    m_additional_filters_isSet = true;
}

bool OAICCAvenue::is_additional_filters_Set() const{
    return m_additional_filters_isSet;
}

bool OAICCAvenue::is_additional_filters_Valid() const{
    return m_additional_filters_isValid;
}

qint32 OAICCAvenue::getApprovalWindowTtl() const {
    return m_approval_window_ttl;
}
void OAICCAvenue::setApprovalWindowTtl(const qint32 &approval_window_ttl) {
    m_approval_window_ttl = approval_window_ttl;
    m_approval_window_ttl_isSet = true;
}

bool OAICCAvenue::is_approval_window_ttl_Set() const{
    return m_approval_window_ttl_isSet;
}

bool OAICCAvenue::is_approval_window_ttl_Valid() const{
    return m_approval_window_ttl_isValid;
}

QString OAICCAvenue::getCityField() const {
    return m_city_field;
}
void OAICCAvenue::setCityField(const QString &city_field) {
    m_city_field = city_field;
    m_city_field_isSet = true;
}

bool OAICCAvenue::is_city_field_Set() const{
    return m_city_field_isSet;
}

bool OAICCAvenue::is_city_field_Valid() const{
    return m_city_field_isValid;
}

QDateTime OAICCAvenue::getCreatedTime() const {
    return m_created_time;
}
void OAICCAvenue::setCreatedTime(const QDateTime &created_time) {
    m_created_time = created_time;
    m_created_time_isSet = true;
}

bool OAICCAvenue::is_created_time_Set() const{
    return m_created_time_isSet;
}

bool OAICCAvenue::is_created_time_Valid() const{
    return m_created_time_isValid;
}

QString OAICCAvenue::getDccForceCurrency() const {
    return m_dcc_force_currency;
}
void OAICCAvenue::setDccForceCurrency(const QString &dcc_force_currency) {
    m_dcc_force_currency = dcc_force_currency;
    m_dcc_force_currency_isSet = true;
}

bool OAICCAvenue::is_dcc_force_currency_Set() const{
    return m_dcc_force_currency_isSet;
}

bool OAICCAvenue::is_dcc_force_currency_Valid() const{
    return m_dcc_force_currency_isValid;
}

qint32 OAICCAvenue::getDccMarkup() const {
    return m_dcc_markup;
}
void OAICCAvenue::setDccMarkup(const qint32 &dcc_markup) {
    m_dcc_markup = dcc_markup;
    m_dcc_markup_isSet = true;
}

bool OAICCAvenue::is_dcc_markup_Set() const{
    return m_dcc_markup_isSet;
}

bool OAICCAvenue::is_dcc_markup_Valid() const{
    return m_dcc_markup_isValid;
}

QString OAICCAvenue::getDescriptor() const {
    return m_descriptor;
}
void OAICCAvenue::setDescriptor(const QString &descriptor) {
    m_descriptor = descriptor;
    m_descriptor_isSet = true;
}

bool OAICCAvenue::is_descriptor_Set() const{
    return m_descriptor_isSet;
}

bool OAICCAvenue::is_descriptor_Valid() const{
    return m_descriptor_isValid;
}

OAIDigitalWallets OAICCAvenue::getDigitalWallets() const {
    return m_digital_wallets;
}
void OAICCAvenue::setDigitalWallets(const OAIDigitalWallets &digital_wallets) {
    m_digital_wallets = digital_wallets;
    m_digital_wallets_isSet = true;
}

bool OAICCAvenue::is_digital_wallets_Set() const{
    return m_digital_wallets_isSet;
}

bool OAICCAvenue::is_digital_wallets_Valid() const{
    return m_digital_wallets_isValid;
}

bool OAICCAvenue::isDynamicDescriptor() const {
    return m_dynamic_descriptor;
}
void OAICCAvenue::setDynamicDescriptor(const bool &dynamic_descriptor) {
    m_dynamic_descriptor = dynamic_descriptor;
    m_dynamic_descriptor_isSet = true;
}

bool OAICCAvenue::is_dynamic_descriptor_Set() const{
    return m_dynamic_descriptor_isSet;
}

bool OAICCAvenue::is_dynamic_descriptor_Valid() const{
    return m_dynamic_descriptor_isValid;
}

QList<QString> OAICCAvenue::getExcludedDccQuoteCurrencies() const {
    return m_excluded_dcc_quote_currencies;
}
void OAICCAvenue::setExcludedDccQuoteCurrencies(const QList<QString> &excluded_dcc_quote_currencies) {
    m_excluded_dcc_quote_currencies = excluded_dcc_quote_currencies;
    m_excluded_dcc_quote_currencies_isSet = true;
}

bool OAICCAvenue::is_excluded_dcc_quote_currencies_Set() const{
    return m_excluded_dcc_quote_currencies_isSet;
}

bool OAICCAvenue::is_excluded_dcc_quote_currencies_Valid() const{
    return m_excluded_dcc_quote_currencies_isValid;
}

OAIGatewayName OAICCAvenue::getGatewayName() const {
    return m_gateway_name;
}
void OAICCAvenue::setGatewayName(const OAIGatewayName &gateway_name) {
    m_gateway_name = gateway_name;
    m_gateway_name_isSet = true;
}

bool OAICCAvenue::is_gateway_name_Set() const{
    return m_gateway_name_isSet;
}

bool OAICCAvenue::is_gateway_name_Valid() const{
    return m_gateway_name_isValid;
}

QString OAICCAvenue::getId() const {
    return m_id;
}
void OAICCAvenue::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAICCAvenue::is_id_Set() const{
    return m_id_isSet;
}

bool OAICCAvenue::is_id_Valid() const{
    return m_id_isValid;
}

bool OAICCAvenue::isIsDown() const {
    return m_is_down;
}
void OAICCAvenue::setIsDown(const bool &is_down) {
    m_is_down = is_down;
    m_is_down_isSet = true;
}

bool OAICCAvenue::is_is_down_Set() const{
    return m_is_down_isSet;
}

bool OAICCAvenue::is_is_down_Valid() const{
    return m_is_down_isValid;
}

QString OAICCAvenue::getMerchantCategoryCode() const {
    return m_merchant_category_code;
}
void OAICCAvenue::setMerchantCategoryCode(const QString &merchant_category_code) {
    m_merchant_category_code = merchant_category_code;
    m_merchant_category_code_isSet = true;
}

bool OAICCAvenue::is_merchant_category_code_Set() const{
    return m_merchant_category_code_isSet;
}

bool OAICCAvenue::is_merchant_category_code_Valid() const{
    return m_merchant_category_code_isValid;
}

OAIPaymentMethod OAICCAvenue::getMethod() const {
    return m_method;
}
void OAICCAvenue::setMethod(const OAIPaymentMethod &method) {
    m_method = method;
    m_method_isSet = true;
}

bool OAICCAvenue::is_method_Set() const{
    return m_method_isSet;
}

bool OAICCAvenue::is_method_Valid() const{
    return m_method_isValid;
}

double OAICCAvenue::getMonthlyLimit() const {
    return m_monthly_limit;
}
void OAICCAvenue::setMonthlyLimit(const double &monthly_limit) {
    m_monthly_limit = monthly_limit;
    m_monthly_limit_isSet = true;
}

bool OAICCAvenue::is_monthly_limit_Set() const{
    return m_monthly_limit_isSet;
}

bool OAICCAvenue::is_monthly_limit_Valid() const{
    return m_monthly_limit_isValid;
}

QString OAICCAvenue::getOrganizationId() const {
    return m_organization_id;
}
void OAICCAvenue::setOrganizationId(const QString &organization_id) {
    m_organization_id = organization_id;
    m_organization_id_isSet = true;
}

bool OAICCAvenue::is_organization_id_Set() const{
    return m_organization_id_isSet;
}

bool OAICCAvenue::is_organization_id_Valid() const{
    return m_organization_id_isValid;
}

QList<OAIPaymentCardBrand> OAICCAvenue::getPaymentCardSchemes() const {
    return m_payment_card_schemes;
}
void OAICCAvenue::setPaymentCardSchemes(const QList<OAIPaymentCardBrand> &payment_card_schemes) {
    m_payment_card_schemes = payment_card_schemes;
    m_payment_card_schemes_isSet = true;
}

bool OAICCAvenue::is_payment_card_schemes_Set() const{
    return m_payment_card_schemes_isSet;
}

bool OAICCAvenue::is_payment_card_schemes_Valid() const{
    return m_payment_card_schemes_isValid;
}

bool OAICCAvenue::isReconciliationWindowEnabled() const {
    return m_reconciliation_window_enabled;
}
void OAICCAvenue::setReconciliationWindowEnabled(const bool &reconciliation_window_enabled) {
    m_reconciliation_window_enabled = reconciliation_window_enabled;
    m_reconciliation_window_enabled_isSet = true;
}

bool OAICCAvenue::is_reconciliation_window_enabled_Set() const{
    return m_reconciliation_window_enabled_isSet;
}

bool OAICCAvenue::is_reconciliation_window_enabled_Valid() const{
    return m_reconciliation_window_enabled_isValid;
}

qint32 OAICCAvenue::getReconciliationWindowTtl() const {
    return m_reconciliation_window_ttl;
}
void OAICCAvenue::setReconciliationWindowTtl(const qint32 &reconciliation_window_ttl) {
    m_reconciliation_window_ttl = reconciliation_window_ttl;
    m_reconciliation_window_ttl_isSet = true;
}

bool OAICCAvenue::is_reconciliation_window_ttl_Set() const{
    return m_reconciliation_window_ttl_isSet;
}

bool OAICCAvenue::is_reconciliation_window_ttl_Valid() const{
    return m_reconciliation_window_ttl_isValid;
}

QString OAICCAvenue::getStatus() const {
    return m_status;
}
void OAICCAvenue::setStatus(const QString &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAICCAvenue::is_status_Set() const{
    return m_status_isSet;
}

bool OAICCAvenue::is_status_Valid() const{
    return m_status_isValid;
}

bool OAICCAvenue::isSticky() const {
    return m_sticky;
}
void OAICCAvenue::setSticky(const bool &sticky) {
    m_sticky = sticky;
    m_sticky_isSet = true;
}

bool OAICCAvenue::is_sticky_Set() const{
    return m_sticky_isSet;
}

bool OAICCAvenue::is_sticky_Valid() const{
    return m_sticky_isValid;
}

bool OAICCAvenue::isThreeDSecure() const {
    return m_three_d_secure;
}
void OAICCAvenue::setThreeDSecure(const bool &three_d_secure) {
    m_three_d_secure = three_d_secure;
    m_three_d_secure_isSet = true;
}

bool OAICCAvenue::is_three_d_secure_Set() const{
    return m_three_d_secure_isSet;
}

bool OAICCAvenue::is_three_d_secure_Valid() const{
    return m_three_d_secure_isValid;
}

qint32 OAICCAvenue::getTimeout() const {
    return m_timeout;
}
void OAICCAvenue::setTimeout(const qint32 &timeout) {
    m_timeout = timeout;
    m_timeout_isSet = true;
}

bool OAICCAvenue::is_timeout_Set() const{
    return m_timeout_isSet;
}

bool OAICCAvenue::is_timeout_Valid() const{
    return m_timeout_isValid;
}

QString OAICCAvenue::getToken() const {
    return m_token;
}
void OAICCAvenue::setToken(const QString &token) {
    m_token = token;
    m_token_isSet = true;
}

bool OAICCAvenue::is_token_Set() const{
    return m_token_isSet;
}

bool OAICCAvenue::is_token_Valid() const{
    return m_token_isValid;
}

QDateTime OAICCAvenue::getUpdatedTime() const {
    return m_updated_time;
}
void OAICCAvenue::setUpdatedTime(const QDateTime &updated_time) {
    m_updated_time = updated_time;
    m_updated_time_isSet = true;
}

bool OAICCAvenue::is_updated_time_Set() const{
    return m_updated_time_isSet;
}

bool OAICCAvenue::is_updated_time_Valid() const{
    return m_updated_time_isValid;
}

OAICCAvenue_allOf_credentials OAICCAvenue::getCredentials() const {
    return m_credentials;
}
void OAICCAvenue::setCredentials(const OAICCAvenue_allOf_credentials &credentials) {
    m_credentials = credentials;
    m_credentials_isSet = true;
}

bool OAICCAvenue::is_credentials_Set() const{
    return m_credentials_isSet;
}

bool OAICCAvenue::is_credentials_Valid() const{
    return m_credentials_isValid;
}

bool OAICCAvenue::isSet() const {
...
bool OAICCAvenue::isValid() const {
