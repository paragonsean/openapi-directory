...
QString OAIDiscount::getMethod() const {
    return m_method;
}
void OAIDiscount::setMethod(const QString &method) {
    m_method = method;
    m_method_isSet = true;
}

bool OAIDiscount::is_method_Set() const{
    return m_method_isSet;
}

bool OAIDiscount::is_method_Valid() const{
