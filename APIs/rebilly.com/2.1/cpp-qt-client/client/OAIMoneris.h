...
#include "OAIMoneris_allOf_credentials.h"
...
class OAIMoneris_allOf_credentials;

class OAIMoneris : public OAIObject {
public:
    OAIMoneris();
    OAIMoneris(QString json);
    ~OAIMoneris() override;
    ...
    OAIMoneris_allOf_credentials getCredentials() const;
    void setCredentials(const OAIMoneris_allOf_credentials &credentials);
...
private:
    ...
    OAIMoneris_allOf_credentials m_credentials;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMoneris)
