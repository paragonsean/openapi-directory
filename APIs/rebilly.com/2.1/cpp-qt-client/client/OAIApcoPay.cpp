...
OAIApcoPay::OAIApcoPay(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIApcoPay::OAIApcoPay() {
    this->initializeModel();
}

OAIApcoPay::~OAIApcoPay() {}

void OAIApcoPay::initializeModel() {
...
void OAIApcoPay::fromJson(QString jsonString) {
...
void OAIApcoPay::fromJsonObject(QJsonObject json) {
...
QString OAIApcoPay::asJson() const {
...
QJsonObject OAIApcoPay::asJsonObject() const {
    QJsonObject obj;
    if (m__links.size() > 0) {
...
QList<OAIGatewayAccount__links_inner> OAIApcoPay::getLinks() const {
    return m__links;
}
void OAIApcoPay::setLinks(const QList<OAIGatewayAccount__links_inner> &_links) {
    m__links = _links;
    m__links_isSet = true;
}

bool OAIApcoPay::is__links_Set() const{
    return m__links_isSet;
}

bool OAIApcoPay::is__links_Valid() const{
    return m__links_isValid;
}

QList<QString> OAIApcoPay::getAcceptedCurrencies() const {
    return m_accepted_currencies;
}
void OAIApcoPay::setAcceptedCurrencies(const QList<QString> &accepted_currencies) {
    m_accepted_currencies = accepted_currencies;
    m_accepted_currencies_isSet = true;
}

bool OAIApcoPay::is_accepted_currencies_Set() const{
    return m_accepted_currencies_isSet;
}

bool OAIApcoPay::is_accepted_currencies_Valid() const{
    return m_accepted_currencies_isValid;
}

OAIAcquirerName OAIApcoPay::getAcquirerName() const {
    return m_acquirer_name;
}
void OAIApcoPay::setAcquirerName(const OAIAcquirerName &acquirer_name) {
    m_acquirer_name = acquirer_name;
    m_acquirer_name_isSet = true;
}

bool OAIApcoPay::is_acquirer_name_Set() const{
    return m_acquirer_name_isSet;
}

bool OAIApcoPay::is_acquirer_name_Valid() const{
    return m_acquirer_name_isValid;
}

QString OAIApcoPay::getAdditionalFilters() const {
    return m_additional_filters;
}
void OAIApcoPay::setAdditionalFilters(const QString &additional_filters) {
    m_additional_filters = additional_filters;
    m_additional_filters_isSet = true;
}

bool OAIApcoPay::is_additional_filters_Set() const{
    return m_additional_filters_isSet;
}

bool OAIApcoPay::is_additional_filters_Valid() const{
    return m_additional_filters_isValid;
}

qint32 OAIApcoPay::getApprovalWindowTtl() const {
    return m_approval_window_ttl;
}
void OAIApcoPay::setApprovalWindowTtl(const qint32 &approval_window_ttl) {
    m_approval_window_ttl = approval_window_ttl;
    m_approval_window_ttl_isSet = true;
}

bool OAIApcoPay::is_approval_window_ttl_Set() const{
    return m_approval_window_ttl_isSet;
}

bool OAIApcoPay::is_approval_window_ttl_Valid() const{
    return m_approval_window_ttl_isValid;
}

QString OAIApcoPay::getCityField() const {
    return m_city_field;
}
void OAIApcoPay::setCityField(const QString &city_field) {
    m_city_field = city_field;
    m_city_field_isSet = true;
}

bool OAIApcoPay::is_city_field_Set() const{
    return m_city_field_isSet;
}

bool OAIApcoPay::is_city_field_Valid() const{
    return m_city_field_isValid;
}

QDateTime OAIApcoPay::getCreatedTime() const {
    return m_created_time;
}
void OAIApcoPay::setCreatedTime(const QDateTime &created_time) {
    m_created_time = created_time;
    m_created_time_isSet = true;
}

bool OAIApcoPay::is_created_time_Set() const{
    return m_created_time_isSet;
}

bool OAIApcoPay::is_created_time_Valid() const{
    return m_created_time_isValid;
}

QString OAIApcoPay::getDccForceCurrency() const {
    return m_dcc_force_currency;
}
void OAIApcoPay::setDccForceCurrency(const QString &dcc_force_currency) {
    m_dcc_force_currency = dcc_force_currency;
    m_dcc_force_currency_isSet = true;
}

bool OAIApcoPay::is_dcc_force_currency_Set() const{
    return m_dcc_force_currency_isSet;
}

bool OAIApcoPay::is_dcc_force_currency_Valid() const{
    return m_dcc_force_currency_isValid;
}

qint32 OAIApcoPay::getDccMarkup() const {
    return m_dcc_markup;
}
void OAIApcoPay::setDccMarkup(const qint32 &dcc_markup) {
    m_dcc_markup = dcc_markup;
    m_dcc_markup_isSet = true;
}

bool OAIApcoPay::is_dcc_markup_Set() const{
    return m_dcc_markup_isSet;
}

bool OAIApcoPay::is_dcc_markup_Valid() const{
    return m_dcc_markup_isValid;
}

QString OAIApcoPay::getDescriptor() const {
    return m_descriptor;
}
void OAIApcoPay::setDescriptor(const QString &descriptor) {
    m_descriptor = descriptor;
    m_descriptor_isSet = true;
}

bool OAIApcoPay::is_descriptor_Set() const{
    return m_descriptor_isSet;
}

bool OAIApcoPay::is_descriptor_Valid() const{
    return m_descriptor_isValid;
}

OAIDigitalWallets OAIApcoPay::getDigitalWallets() const {
    return m_digital_wallets;
}
void OAIApcoPay::setDigitalWallets(const OAIDigitalWallets &digital_wallets) {
    m_digital_wallets = digital_wallets;
    m_digital_wallets_isSet = true;
}

bool OAIApcoPay::is_digital_wallets_Set() const{
    return m_digital_wallets_isSet;
}

bool OAIApcoPay::is_digital_wallets_Valid() const{
    return m_digital_wallets_isValid;
}

bool OAIApcoPay::isDynamicDescriptor() const {
    return m_dynamic_descriptor;
}
void OAIApcoPay::setDynamicDescriptor(const bool &dynamic_descriptor) {
    m_dynamic_descriptor = dynamic_descriptor;
    m_dynamic_descriptor_isSet = true;
}

bool OAIApcoPay::is_dynamic_descriptor_Set() const{
    return m_dynamic_descriptor_isSet;
}

bool OAIApcoPay::is_dynamic_descriptor_Valid() const{
    return m_dynamic_descriptor_isValid;
}

QList<QString> OAIApcoPay::getExcludedDccQuoteCurrencies() const {
    return m_excluded_dcc_quote_currencies;
}
void OAIApcoPay::setExcludedDccQuoteCurrencies(const QList<QString> &excluded_dcc_quote_currencies) {
    m_excluded_dcc_quote_currencies = excluded_dcc_quote_currencies;
    m_excluded_dcc_quote_currencies_isSet = true;
}

bool OAIApcoPay::is_excluded_dcc_quote_currencies_Set() const{
    return m_excluded_dcc_quote_currencies_isSet;
}

bool OAIApcoPay::is_excluded_dcc_quote_currencies_Valid() const{
    return m_excluded_dcc_quote_currencies_isValid;
}

OAIGatewayName OAIApcoPay::getGatewayName() const {
    return m_gateway_name;
}
void OAIApcoPay::setGatewayName(const OAIGatewayName &gateway_name) {
    m_gateway_name = gateway_name;
    m_gateway_name_isSet = true;
}

bool OAIApcoPay::is_gateway_name_Set() const{
    return m_gateway_name_isSet;
}

bool OAIApcoPay::is_gateway_name_Valid() const{
    return m_gateway_name_isValid;
}

QString OAIApcoPay::getId() const {
    return m_id;
}
void OAIApcoPay::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIApcoPay::is_id_Set() const{
    return m_id_isSet;
}

bool OAIApcoPay::is_id_Valid() const{
    return m_id_isValid;
}

bool OAIApcoPay::isIsDown() const {
    return m_is_down;
}
void OAIApcoPay::setIsDown(const bool &is_down) {
    m_is_down = is_down;
    m_is_down_isSet = true;
}

bool OAIApcoPay::is_is_down_Set() const{
    return m_is_down_isSet;
}

bool OAIApcoPay::is_is_down_Valid() const{
    return m_is_down_isValid;
}

QString OAIApcoPay::getMerchantCategoryCode() const {
    return m_merchant_category_code;
}
void OAIApcoPay::setMerchantCategoryCode(const QString &merchant_category_code) {
    m_merchant_category_code = merchant_category_code;
    m_merchant_category_code_isSet = true;
}

bool OAIApcoPay::is_merchant_category_code_Set() const{
    return m_merchant_category_code_isSet;
}

bool OAIApcoPay::is_merchant_category_code_Valid() const{
    return m_merchant_category_code_isValid;
}

OAIPaymentMethod OAIApcoPay::getMethod() const {
    return m_method;
}
void OAIApcoPay::setMethod(const OAIPaymentMethod &method) {
    m_method = method;
    m_method_isSet = true;
}

bool OAIApcoPay::is_method_Set() const{
    return m_method_isSet;
}

bool OAIApcoPay::is_method_Valid() const{
    return m_method_isValid;
}

double OAIApcoPay::getMonthlyLimit() const {
    return m_monthly_limit;
}
void OAIApcoPay::setMonthlyLimit(const double &monthly_limit) {
    m_monthly_limit = monthly_limit;
    m_monthly_limit_isSet = true;
}

bool OAIApcoPay::is_monthly_limit_Set() const{
    return m_monthly_limit_isSet;
}

bool OAIApcoPay::is_monthly_limit_Valid() const{
    return m_monthly_limit_isValid;
}

QString OAIApcoPay::getOrganizationId() const {
    return m_organization_id;
}
void OAIApcoPay::setOrganizationId(const QString &organization_id) {
    m_organization_id = organization_id;
    m_organization_id_isSet = true;
}

bool OAIApcoPay::is_organization_id_Set() const{
    return m_organization_id_isSet;
}

bool OAIApcoPay::is_organization_id_Valid() const{
    return m_organization_id_isValid;
}

QList<OAIPaymentCardBrand> OAIApcoPay::getPaymentCardSchemes() const {
    return m_payment_card_schemes;
}
void OAIApcoPay::setPaymentCardSchemes(const QList<OAIPaymentCardBrand> &payment_card_schemes) {
    m_payment_card_schemes = payment_card_schemes;
    m_payment_card_schemes_isSet = true;
}

bool OAIApcoPay::is_payment_card_schemes_Set() const{
    return m_payment_card_schemes_isSet;
}

bool OAIApcoPay::is_payment_card_schemes_Valid() const{
    return m_payment_card_schemes_isValid;
}

bool OAIApcoPay::isReconciliationWindowEnabled() const {
    return m_reconciliation_window_enabled;
}
void OAIApcoPay::setReconciliationWindowEnabled(const bool &reconciliation_window_enabled) {
    m_reconciliation_window_enabled = reconciliation_window_enabled;
    m_reconciliation_window_enabled_isSet = true;
}

bool OAIApcoPay::is_reconciliation_window_enabled_Set() const{
    return m_reconciliation_window_enabled_isSet;
}

bool OAIApcoPay::is_reconciliation_window_enabled_Valid() const{
    return m_reconciliation_window_enabled_isValid;
}

qint32 OAIApcoPay::getReconciliationWindowTtl() const {
    return m_reconciliation_window_ttl;
}
void OAIApcoPay::setReconciliationWindowTtl(const qint32 &reconciliation_window_ttl) {
    m_reconciliation_window_ttl = reconciliation_window_ttl;
    m_reconciliation_window_ttl_isSet = true;
}

bool OAIApcoPay::is_reconciliation_window_ttl_Set() const{
    return m_reconciliation_window_ttl_isSet;
}

bool OAIApcoPay::is_reconciliation_window_ttl_Valid() const{
    return m_reconciliation_window_ttl_isValid;
}

QString OAIApcoPay::getStatus() const {
    return m_status;
}
void OAIApcoPay::setStatus(const QString &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIApcoPay::is_status_Set() const{
    return m_status_isSet;
}

bool OAIApcoPay::is_status_Valid() const{
    return m_status_isValid;
}

bool OAIApcoPay::isSticky() const {
    return m_sticky;
}
void OAIApcoPay::setSticky(const bool &sticky) {
    m_sticky = sticky;
    m_sticky_isSet = true;
}

bool OAIApcoPay::is_sticky_Set() const{
    return m_sticky_isSet;
}

bool OAIApcoPay::is_sticky_Valid() const{
    return m_sticky_isValid;
}

bool OAIApcoPay::isThreeDSecure() const {
    return m_three_d_secure;
}
void OAIApcoPay::setThreeDSecure(const bool &three_d_secure) {
    m_three_d_secure = three_d_secure;
    m_three_d_secure_isSet = true;
}

bool OAIApcoPay::is_three_d_secure_Set() const{
    return m_three_d_secure_isSet;
}

bool OAIApcoPay::is_three_d_secure_Valid() const{
    return m_three_d_secure_isValid;
}

qint32 OAIApcoPay::getTimeout() const {
    return m_timeout;
}
void OAIApcoPay::setTimeout(const qint32 &timeout) {
    m_timeout = timeout;
    m_timeout_isSet = true;
}

bool OAIApcoPay::is_timeout_Set() const{
    return m_timeout_isSet;
}

bool OAIApcoPay::is_timeout_Valid() const{
    return m_timeout_isValid;
}

QString OAIApcoPay::getToken() const {
    return m_token;
}
void OAIApcoPay::setToken(const QString &token) {
    m_token = token;
    m_token_isSet = true;
}

bool OAIApcoPay::is_token_Set() const{
    return m_token_isSet;
}

bool OAIApcoPay::is_token_Valid() const{
    return m_token_isValid;
}

QDateTime OAIApcoPay::getUpdatedTime() const {
    return m_updated_time;
}
void OAIApcoPay::setUpdatedTime(const QDateTime &updated_time) {
    m_updated_time = updated_time;
    m_updated_time_isSet = true;
}

bool OAIApcoPay::is_updated_time_Set() const{
    return m_updated_time_isSet;
}

bool OAIApcoPay::is_updated_time_Valid() const{
    return m_updated_time_isValid;
}

OAIApcoPay_allOf_credentials OAIApcoPay::getCredentials() const {
    return m_credentials;
}
void OAIApcoPay::setCredentials(const OAIApcoPay_allOf_credentials &credentials) {
    m_credentials = credentials;
    m_credentials_isSet = true;
}

bool OAIApcoPay::is_credentials_Set() const{
    return m_credentials_isSet;
}

bool OAIApcoPay::is_credentials_Valid() const{
    return m_credentials_isValid;
}

OAIApcoPay_allOf_settings OAIApcoPay::getSettings() const {
    return m_settings;
}
void OAIApcoPay::setSettings(const OAIApcoPay_allOf_settings &settings) {
    m_settings = settings;
    m_settings_isSet = true;
}

bool OAIApcoPay::is_settings_Set() const{
    return m_settings_isSet;
}

bool OAIApcoPay::is_settings_Valid() const{
    return m_settings_isValid;
}

bool OAIApcoPay::isSet() const {
