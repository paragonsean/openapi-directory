...
/*
 * OAIOnlineueberweisen.h
 *
 * Onlineueberweisen config.
 */

#ifndef OAIOnlineueberweisen_H
#define OAIOnlineueberweisen_H
...
#include "OAIOnlineueberweisen_allOf_settings.h"
...
class OAIOnlineueberweisen_allOf_credentials;
class OAIOnlineueberweisen_allOf_settings;

class OAIOnlineueberweisen : public OAIObject {
public:
    OAIOnlineueberweisen();
    OAIOnlineueberweisen(QString json);
    ~OAIOnlineueberweisen() override;
    ...
    OAIOnlineueberweisen_allOf_credentials getCredentials() const;
    void setCredentials(const OAIOnlineueberweisen_allOf_credentials &credentials);
    bool is_credentials_Set() const;
    bool is_credentials_Valid() const;

    OAIOnlineueberweisen_allOf_settings getSettings() const;
    void setSettings(const OAIOnlineueberweisen_allOf_settings &settings);
...
private:
    ...
    OAIOnlineueberweisen_allOf_credentials m_credentials;
    bool m_credentials_isSet;
    bool m_credentials_isValid;

    OAIOnlineueberweisen_allOf_settings m_settings;
...
Q_DECLARE_METATYPE(OpenAPI::OAIOnlineueberweisen)

#endif // OAIOnlineueberweisen_H
