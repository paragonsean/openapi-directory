...
OAISecureTrading::OAISecureTrading(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISecureTrading::OAISecureTrading() {
    this->initializeModel();
}

OAISecureTrading::~OAISecureTrading() {}

void OAISecureTrading::initializeModel() {
    ...
    m_three_d_secure_server_isSet = false;
    m_three_d_secure_server_isValid = false;
}

void OAISecureTrading::fromJson(QString jsonString) {
...
void OAISecureTrading::fromJsonObject(QJsonObject json) {
    ...
    m_three_d_secure_server_isValid = ::OpenAPI::fromJsonValue(m_three_d_secure_server, json[QString("threeDSecureServer")]);
    m_three_d_secure_server_isSet = !json[QString("threeDSecureServer")].isNull() && m_three_d_secure_server_isValid;
}

QString OAISecureTrading::asJson() const {
...
QJsonObject OAISecureTrading::asJsonObject() const {
    QJsonObject obj;
    if (m__links.size() > 0) {
    ...
    if (m_three_d_secure_server.isSet()) {
        obj.insert(QString("threeDSecureServer"), ::OpenAPI::toJsonValue(m_three_d_secure_server));
    }
    return obj;
}

QList<OAIGatewayAccount__links_inner> OAISecureTrading::getLinks() const {
    return m__links;
}
void OAISecureTrading::setLinks(const QList<OAIGatewayAccount__links_inner> &_links) {
    m__links = _links;
    m__links_isSet = true;
}

bool OAISecureTrading::is__links_Set() const{
    return m__links_isSet;
}

bool OAISecureTrading::is__links_Valid() const{
    return m__links_isValid;
}

QList<QString> OAISecureTrading::getAcceptedCurrencies() const {
    return m_accepted_currencies;
}
void OAISecureTrading::setAcceptedCurrencies(const QList<QString> &accepted_currencies) {
    m_accepted_currencies = accepted_currencies;
    m_accepted_currencies_isSet = true;
}

bool OAISecureTrading::is_accepted_currencies_Set() const{
    return m_accepted_currencies_isSet;
}

bool OAISecureTrading::is_accepted_currencies_Valid() const{
    return m_accepted_currencies_isValid;
}

OAIAcquirerName OAISecureTrading::getAcquirerName() const {
    return m_acquirer_name;
}
void OAISecureTrading::setAcquirerName(const OAIAcquirerName &acquirer_name) {
    m_acquirer_name = acquirer_name;
    m_acquirer_name_isSet = true;
}

bool OAISecureTrading::is_acquirer_name_Set() const{
    return m_acquirer_name_isSet;
}

bool OAISecureTrading::is_acquirer_name_Valid() const{
    return m_acquirer_name_isValid;
}

QString OAISecureTrading::getAdditionalFilters() const {
    return m_additional_filters;
}
void OAISecureTrading::setAdditionalFilters(const QString &additional_filters) {
    m_additional_filters = additional_filters;
    m_additional_filters_isSet = true;
}

bool OAISecureTrading::is_additional_filters_Set() const{
    return m_additional_filters_isSet;
}

bool OAISecureTrading::is_additional_filters_Valid() const{
    return m_additional_filters_isValid;
}

qint32 OAISecureTrading::getApprovalWindowTtl() const {
    return m_approval_window_ttl;
}
void OAISecureTrading::setApprovalWindowTtl(const qint32 &approval_window_ttl) {
    m_approval_window_ttl = approval_window_ttl;
    m_approval_window_ttl_isSet = true;
}

bool OAISecureTrading::is_approval_window_ttl_Set() const{
    return m_approval_window_ttl_isSet;
}

bool OAISecureTrading::is_approval_window_ttl_Valid() const{
    return m_approval_window_ttl_isValid;
}

QString OAISecureTrading::getCityField() const {
    return m_city_field;
}
void OAISecureTrading::setCityField(const QString &city_field) {
    m_city_field = city_field;
    m_city_field_isSet = true;
}

bool OAISecureTrading::is_city_field_Set() const{
    return m_city_field_isSet;
}

bool OAISecureTrading::is_city_field_Valid() const{
    return m_city_field_isValid;
}

QDateTime OAISecureTrading::getCreatedTime() const {
    return m_created_time;
}
void OAISecureTrading::setCreatedTime(const QDateTime &created_time) {
    m_created_time = created_time;
    m_created_time_isSet = true;
}

bool OAISecureTrading::is_created_time_Set() const{
    return m_created_time_isSet;
}

bool OAISecureTrading::is_created_time_Valid() const{
    return m_created_time_isValid;
}

QString OAISecureTrading::getDccForceCurrency() const {
    return m_dcc_force_currency;
}
void OAISecureTrading::setDccForceCurrency(const QString &dcc_force_currency) {
    m_dcc_force_currency = dcc_force_currency;
    m_dcc_force_currency_isSet = true;
}

bool OAISecureTrading::is_dcc_force_currency_Set() const{
    return m_dcc_force_currency_isSet;
}

bool OAISecureTrading::is_dcc_force_currency_Valid() const{
    return m_dcc_force_currency_isValid;
}

qint32 OAISecureTrading::getDccMarkup() const {
    return m_dcc_markup;
}
void OAISecureTrading::setDccMarkup(const qint32 &dcc_markup) {
    m_dcc_markup = dcc_markup;
    m_dcc_markup_isSet = true;
}

bool OAISecureTrading::is_dcc_markup_Set() const{
    return m_dcc_markup_isSet;
}

bool OAISecureTrading::is_dcc_markup_Valid() const{
    return m_dcc_markup_isValid;
}

QString OAISecureTrading::getDescriptor() const {
    return m_descriptor;
}
void OAISecureTrading::setDescriptor(const QString &descriptor) {
    m_descriptor = descriptor;
    m_descriptor_isSet = true;
}

bool OAISecureTrading::is_descriptor_Set() const{
    return m_descriptor_isSet;
}

bool OAISecureTrading::is_descriptor_Valid() const{
    return m_descriptor_isValid;
}

OAIDigitalWallets OAISecureTrading::getDigitalWallets() const {
    return m_digital_wallets;
}
void OAISecureTrading::setDigitalWallets(const OAIDigitalWallets &digital_wallets) {
    m_digital_wallets = digital_wallets;
    m_digital_wallets_isSet = true;
}

bool OAISecureTrading::is_digital_wallets_Set() const{
    return m_digital_wallets_isSet;
}

bool OAISecureTrading::is_digital_wallets_Valid() const{
    return m_digital_wallets_isValid;
}

bool OAISecureTrading::isDynamicDescriptor() const {
    return m_dynamic_descriptor;
}
void OAISecureTrading::setDynamicDescriptor(const bool &dynamic_descriptor) {
    m_dynamic_descriptor = dynamic_descriptor;
    m_dynamic_descriptor_isSet = true;
}

bool OAISecureTrading::is_dynamic_descriptor_Set() const{
    return m_dynamic_descriptor_isSet;
}

bool OAISecureTrading::is_dynamic_descriptor_Valid() const{
    return m_dynamic_descriptor_isValid;
}

QList<QString> OAISecureTrading::getExcludedDccQuoteCurrencies() const {
    return m_excluded_dcc_quote_currencies;
}
void OAISecureTrading::setExcludedDccQuoteCurrencies(const QList<QString> &excluded_dcc_quote_currencies) {
    m_excluded_dcc_quote_currencies = excluded_dcc_quote_currencies;
    m_excluded_dcc_quote_currencies_isSet = true;
}

bool OAISecureTrading::is_excluded_dcc_quote_currencies_Set() const{
    return m_excluded_dcc_quote_currencies_isSet;
}

bool OAISecureTrading::is_excluded_dcc_quote_currencies_Valid() const{
    return m_excluded_dcc_quote_currencies_isValid;
}

OAIGatewayName OAISecureTrading::getGatewayName() const {
    return m_gateway_name;
}
void OAISecureTrading::setGatewayName(const OAIGatewayName &gateway_name) {
    m_gateway_name = gateway_name;
    m_gateway_name_isSet = true;
}

bool OAISecureTrading::is_gateway_name_Set() const{
    return m_gateway_name_isSet;
}

bool OAISecureTrading::is_gateway_name_Valid() const{
    return m_gateway_name_isValid;
}

QString OAISecureTrading::getId() const {
    return m_id;
}
void OAISecureTrading::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAISecureTrading::is_id_Set() const{
    return m_id_isSet;
}

bool OAISecureTrading::is_id_Valid() const{
    return m_id_isValid;
}

bool OAISecureTrading::isIsDown() const {
    return m_is_down;
}
void OAISecureTrading::setIsDown(const bool &is_down) {
    m_is_down = is_down;
    m_is_down_isSet = true;
}

bool OAISecureTrading::is_is_down_Set() const{
    return m_is_down_isSet;
}

bool OAISecureTrading::is_is_down_Valid() const{
    return m_is_down_isValid;
}

QString OAISecureTrading::getMerchantCategoryCode() const {
    return m_merchant_category_code;
}
void OAISecureTrading::setMerchantCategoryCode(const QString &merchant_category_code) {
    m_merchant_category_code = merchant_category_code;
    m_merchant_category_code_isSet = true;
}

bool OAISecureTrading::is_merchant_category_code_Set() const{
    return m_merchant_category_code_isSet;
}

bool OAISecureTrading::is_merchant_category_code_Valid() const{
    return m_merchant_category_code_isValid;
}

OAIPaymentMethod OAISecureTrading::getMethod() const {
    return m_method;
}
void OAISecureTrading::setMethod(const OAIPaymentMethod &method) {
    m_method = method;
    m_method_isSet = true;
}

bool OAISecureTrading::is_method_Set() const{
    return m_method_isSet;
}

bool OAISecureTrading::is_method_Valid() const{
    return m_method_isValid;
}

double OAISecureTrading::getMonthlyLimit() const {
    return m_monthly_limit;
}
void OAISecureTrading::setMonthlyLimit(const double &monthly_limit) {
    m_monthly_limit = monthly_limit;
    m_monthly_limit_isSet = true;
}

bool OAISecureTrading::is_monthly_limit_Set() const{
    return m_monthly_limit_isSet;
}

bool OAISecureTrading::is_monthly_limit_Valid() const{
    return m_monthly_limit_isValid;
}

QString OAISecureTrading::getOrganizationId() const {
    return m_organization_id;
}
void OAISecureTrading::setOrganizationId(const QString &organization_id) {
    m_organization_id = organization_id;
    m_organization_id_isSet = true;
}

bool OAISecureTrading::is_organization_id_Set() const{
    return m_organization_id_isSet;
}

bool OAISecureTrading::is_organization_id_Valid() const{
    return m_organization_id_isValid;
}

QList<OAIPaymentCardBrand> OAISecureTrading::getPaymentCardSchemes() const {
    return m_payment_card_schemes;
}
void OAISecureTrading::setPaymentCardSchemes(const QList<OAIPaymentCardBrand> &payment_card_schemes) {
    m_payment_card_schemes = payment_card_schemes;
    m_payment_card_schemes_isSet = true;
}

bool OAISecureTrading::is_payment_card_schemes_Set() const{
    return m_payment_card_schemes_isSet;
}

bool OAISecureTrading::is_payment_card_schemes_Valid() const{
    return m_payment_card_schemes_isValid;
}

bool OAISecureTrading::isReconciliationWindowEnabled() const {
    return m_reconciliation_window_enabled;
}
void OAISecureTrading::setReconciliationWindowEnabled(const bool &reconciliation_window_enabled) {
    m_reconciliation_window_enabled = reconciliation_window_enabled;
    m_reconciliation_window_enabled_isSet = true;
}

bool OAISecureTrading::is_reconciliation_window_enabled_Set() const{
    return m_reconciliation_window_enabled_isSet;
}

bool OAISecureTrading::is_reconciliation_window_enabled_Valid() const{
    return m_reconciliation_window_enabled_isValid;
}

qint32 OAISecureTrading::getReconciliationWindowTtl() const {
    return m_reconciliation_window_ttl;
}
void OAISecureTrading::setReconciliationWindowTtl(const qint32 &reconciliation_window_ttl) {
    m_reconciliation_window_ttl = reconciliation_window_ttl;
    m_reconciliation_window_ttl_isSet = true;
}

bool OAISecureTrading::is_reconciliation_window_ttl_Set() const{
    return m_reconciliation_window_ttl_isSet;
}

bool OAISecureTrading::is_reconciliation_window_ttl_Valid() const{
    return m_reconciliation_window_ttl_isValid;
}

QString OAISecureTrading::getStatus() const {
    return m_status;
}
void OAISecureTrading::setStatus(const QString &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAISecureTrading::is_status_Set() const{
    return m_status_isSet;
}

bool OAISecureTrading::is_status_Valid() const{
    return m_status_isValid;
}

bool OAISecureTrading::isSticky() const {
    return m_sticky;
}
void OAISecureTrading::setSticky(const bool &sticky) {
    m_sticky = sticky;
    m_sticky_isSet = true;
}

bool OAISecureTrading::is_sticky_Set() const{
    return m_sticky_isSet;
}

bool OAISecureTrading::is_sticky_Valid() const{
    return m_sticky_isValid;
}

bool OAISecureTrading::isThreeDSecure() const {
    return m_three_d_secure;
}
void OAISecureTrading::setThreeDSecure(const bool &three_d_secure) {
    m_three_d_secure = three_d_secure;
    m_three_d_secure_isSet = true;
}

bool OAISecureTrading::is_three_d_secure_Set() const{
    return m_three_d_secure_isSet;
}

bool OAISecureTrading::is_three_d_secure_Valid() const{
    return m_three_d_secure_isValid;
}

qint32 OAISecureTrading::getTimeout() const {
    return m_timeout;
}
void OAISecureTrading::setTimeout(const qint32 &timeout) {
    m_timeout = timeout;
    m_timeout_isSet = true;
}

bool OAISecureTrading::is_timeout_Set() const{
    return m_timeout_isSet;
}

bool OAISecureTrading::is_timeout_Valid() const{
    return m_timeout_isValid;
}

QString OAISecureTrading::getToken() const {
    return m_token;
}
void OAISecureTrading::setToken(const QString &token) {
    m_token = token;
    m_token_isSet = true;
}

bool OAISecureTrading::is_token_Set() const{
    return m_token_isSet;
}

bool OAISecureTrading::is_token_Valid() const{
    return m_token_isValid;
}

QDateTime OAISecureTrading::getUpdatedTime() const {
    return m_updated_time;
}
void OAISecureTrading::setUpdatedTime(const QDateTime &updated_time) {
    m_updated_time = updated_time;
    m_updated_time_isSet = true;
}

bool OAISecureTrading::is_updated_time_Set() const{
    return m_updated_time_isSet;
}

bool OAISecureTrading::is_updated_time_Valid() const{
    return m_updated_time_isValid;
}

OAISecureTrading_allOf_credentials OAISecureTrading::getCredentials() const {
    return m_credentials;
}
void OAISecureTrading::setCredentials(const OAISecureTrading_allOf_credentials &credentials) {
    m_credentials = credentials;
    m_credentials_isSet = true;
}

bool OAISecureTrading::is_credentials_Set() const{
    return m_credentials_isSet;
}

bool OAISecureTrading::is_credentials_Valid() const{
    return m_credentials_isValid;
}

OAISecureTrading3dsServers OAISecureTrading::getThreeDSecureServer() const {
    return m_three_d_secure_server;
}
void OAISecureTrading::setThreeDSecureServer(const OAISecureTrading3dsServers &three_d_secure_server) {
    m_three_d_secure_server = three_d_secure_server;
    m_three_d_secure_server_isSet = true;
}

bool OAISecureTrading::is_three_d_secure_server_Set() const{
    return m_three_d_secure_server_isSet;
}

bool OAISecureTrading::is_three_d_secure_server_Valid() const{
    return m_three_d_secure_server_isValid;
}

bool OAISecureTrading::isSet() const {
...
bool OAISecureTrading::isValid() const {
