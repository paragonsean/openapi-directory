...
#include "OAICommonTransactionRequest.h"
...
OAICommonTransactionRequest::OAICommonTransactionRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICommonTransactionRequest::OAICommonTransactionRequest() {
    this->initializeModel();
}

OAICommonTransactionRequest::~OAICommonTransactionRequest() {}

void OAICommonTransactionRequest::initializeModel() {
...
void OAICommonTransactionRequest::fromJson(QString jsonString) {
...
void OAICommonTransactionRequest::fromJsonObject(QJsonObject json) {
...
QString OAICommonTransactionRequest::asJson() const {
...
QJsonObject OAICommonTransactionRequest::asJsonObject() const {
    QJsonObject obj;
    if (m_amount_isSet) {
...
double OAICommonTransactionRequest::getAmount() const {
    return m_amount;
}
void OAICommonTransactionRequest::setAmount(const double &amount) {
    m_amount = amount;
    m_amount_isSet = true;
}

bool OAICommonTransactionRequest::is_amount_Set() const{
    return m_amount_isSet;
}

bool OAICommonTransactionRequest::is_amount_Valid() const{
    return m_amount_isValid;
}

OAIContactObject OAICommonTransactionRequest::getBillingAddress() const {
    return m_billing_address;
}
void OAICommonTransactionRequest::setBillingAddress(const OAIContactObject &billing_address) {
    m_billing_address = billing_address;
    m_billing_address_isSet = true;
}

bool OAICommonTransactionRequest::is_billing_address_Set() const{
    return m_billing_address_isSet;
}

bool OAICommonTransactionRequest::is_billing_address_Valid() const{
    return m_billing_address_isValid;
}

QString OAICommonTransactionRequest::getCurrency() const {
    return m_currency;
}
void OAICommonTransactionRequest::setCurrency(const QString &currency) {
    m_currency = currency;
    m_currency_isSet = true;
}

bool OAICommonTransactionRequest::is_currency_Set() const{
    return m_currency_isSet;
}

bool OAICommonTransactionRequest::is_currency_Valid() const{
    return m_currency_isValid;
}

OAIObject OAICommonTransactionRequest::getCustomFields() const {
    return m_custom_fields;
}
void OAICommonTransactionRequest::setCustomFields(const OAIObject &custom_fields) {
    m_custom_fields = custom_fields;
    m_custom_fields_isSet = true;
}

bool OAICommonTransactionRequest::is_custom_fields_Set() const{
    return m_custom_fields_isSet;
}

bool OAICommonTransactionRequest::is_custom_fields_Valid() const{
    return m_custom_fields_isValid;
}

QString OAICommonTransactionRequest::getCustomerId() const {
    return m_customer_id;
}
void OAICommonTransactionRequest::setCustomerId(const QString &customer_id) {
    m_customer_id = customer_id;
    m_customer_id_isSet = true;
}

bool OAICommonTransactionRequest::is_customer_id_Set() const{
    return m_customer_id_isSet;
}

bool OAICommonTransactionRequest::is_customer_id_Valid() const{
    return m_customer_id_isValid;
}

QString OAICommonTransactionRequest::getDescription() const {
    return m_description;
}
void OAICommonTransactionRequest::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAICommonTransactionRequest::is_description_Set() const{
    return m_description_isSet;
}

bool OAICommonTransactionRequest::is_description_Valid() const{
    return m_description_isValid;
}

QString OAICommonTransactionRequest::getGatewayAccountId() const {
    return m_gateway_account_id;
}
void OAICommonTransactionRequest::setGatewayAccountId(const QString &gateway_account_id) {
    m_gateway_account_id = gateway_account_id;
    m_gateway_account_id_isSet = true;
}

bool OAICommonTransactionRequest::is_gateway_account_id_Set() const{
    return m_gateway_account_id_isSet;
}

bool OAICommonTransactionRequest::is_gateway_account_id_Valid() const{
    return m_gateway_account_id_isValid;
}

QList<QString> OAICommonTransactionRequest::getInvoiceIds() const {
    return m_invoice_ids;
}
void OAICommonTransactionRequest::setInvoiceIds(const QList<QString> &invoice_ids) {
    m_invoice_ids = invoice_ids;
    m_invoice_ids_isSet = true;
}

bool OAICommonTransactionRequest::is_invoice_ids_Set() const{
    return m_invoice_ids_isSet;
}

bool OAICommonTransactionRequest::is_invoice_ids_Valid() const{
    return m_invoice_ids_isValid;
}

bool OAICommonTransactionRequest::isIsMerchantInitiated() const {
    return m_is_merchant_initiated;
}
void OAICommonTransactionRequest::setIsMerchantInitiated(const bool &is_merchant_initiated) {
    m_is_merchant_initiated = is_merchant_initiated;
    m_is_merchant_initiated_isSet = true;
}

bool OAICommonTransactionRequest::is_is_merchant_initiated_Set() const{
    return m_is_merchant_initiated_isSet;
}

bool OAICommonTransactionRequest::is_is_merchant_initiated_Valid() const{
    return m_is_merchant_initiated_isValid;
}

bool OAICommonTransactionRequest::isIsProcessedOutside() const {
    return m_is_processed_outside;
}
void OAICommonTransactionRequest::setIsProcessedOutside(const bool &is_processed_outside) {
    m_is_processed_outside = is_processed_outside;
    m_is_processed_outside_isSet = true;
}

bool OAICommonTransactionRequest::is_is_processed_outside_Set() const{
    return m_is_processed_outside_isSet;
}

bool OAICommonTransactionRequest::is_is_processed_outside_Valid() const{
    return m_is_processed_outside_isValid;
}

QString OAICommonTransactionRequest::getNotificationUrl() const {
    return m_notification_url;
}
void OAICommonTransactionRequest::setNotificationUrl(const QString &notification_url) {
    m_notification_url = notification_url;
    m_notification_url_isSet = true;
}

bool OAICommonTransactionRequest::is_notification_url_Set() const{
    return m_notification_url_isSet;
}

bool OAICommonTransactionRequest::is_notification_url_Valid() const{
    return m_notification_url_isValid;
}

OAIPaymentInstruction OAICommonTransactionRequest::getPaymentInstruction() const {
    return m_payment_instruction;
}
void OAICommonTransactionRequest::setPaymentInstruction(const OAIPaymentInstruction &payment_instruction) {
    m_payment_instruction = payment_instruction;
    m_payment_instruction_isSet = true;
}

bool OAICommonTransactionRequest::is_payment_instruction_Set() const{
    return m_payment_instruction_isSet;
}

bool OAICommonTransactionRequest::is_payment_instruction_Valid() const{
    return m_payment_instruction_isValid;
}

OAIPaymentInstrument OAICommonTransactionRequest::getPaymentInstrument() const {
    return m_payment_instrument;
}
void OAICommonTransactionRequest::setPaymentInstrument(const OAIPaymentInstrument &payment_instrument) {
    m_payment_instrument = payment_instrument;
    m_payment_instrument_isSet = true;
}

bool OAICommonTransactionRequest::is_payment_instrument_Set() const{
    return m_payment_instrument_isSet;
}

bool OAICommonTransactionRequest::is_payment_instrument_Valid() const{
    return m_payment_instrument_isValid;
}

QDateTime OAICommonTransactionRequest::getProcessedTime() const {
    return m_processed_time;
}
void OAICommonTransactionRequest::setProcessedTime(const QDateTime &processed_time) {
    m_processed_time = processed_time;
    m_processed_time_isSet = true;
}

bool OAICommonTransactionRequest::is_processed_time_Set() const{
    return m_processed_time_isSet;
}

bool OAICommonTransactionRequest::is_processed_time_Valid() const{
    return m_processed_time_isValid;
}

QString OAICommonTransactionRequest::getRedirectUrl() const {
    return m_redirect_url;
}
void OAICommonTransactionRequest::setRedirectUrl(const QString &redirect_url) {
    m_redirect_url = redirect_url;
    m_redirect_url_isSet = true;
}

bool OAICommonTransactionRequest::is_redirect_url_Set() const{
    return m_redirect_url_isSet;
}

bool OAICommonTransactionRequest::is_redirect_url_Valid() const{
    return m_redirect_url_isValid;
}

QString OAICommonTransactionRequest::getRequestId() const {
    return m_request_id;
}
void OAICommonTransactionRequest::setRequestId(const QString &request_id) {
    m_request_id = request_id;
    m_request_id_isSet = true;
}

bool OAICommonTransactionRequest::is_request_id_Set() const{
    return m_request_id_isSet;
}

bool OAICommonTransactionRequest::is_request_id_Valid() const{
    return m_request_id_isValid;
}

OAIRiskMetadata OAICommonTransactionRequest::getRiskMetadata() const {
    return m_risk_metadata;
}
void OAICommonTransactionRequest::setRiskMetadata(const OAIRiskMetadata &risk_metadata) {
    m_risk_metadata = risk_metadata;
    m_risk_metadata_isSet = true;
}

bool OAICommonTransactionRequest::is_risk_metadata_Set() const{
    return m_risk_metadata_isSet;
}

bool OAICommonTransactionRequest::is_risk_metadata_Valid() const{
    return m_risk_metadata_isValid;
}

QString OAICommonTransactionRequest::getWebsiteId() const {
    return m_website_id;
}
void OAICommonTransactionRequest::setWebsiteId(const QString &website_id) {
    m_website_id = website_id;
    m_website_id_isSet = true;
}

bool OAICommonTransactionRequest::is_website_id_Set() const{
    return m_website_id_isSet;
}

bool OAICommonTransactionRequest::is_website_id_Valid() const{
    return m_website_id_isValid;
}

bool OAICommonTransactionRequest::isSet() const {
...
bool OAICommonTransactionRequest::isValid() const {
