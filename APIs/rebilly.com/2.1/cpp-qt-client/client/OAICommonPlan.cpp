...
OAICommonPlan::OAICommonPlan(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICommonPlan::OAICommonPlan() {
    this->initializeModel();
}

OAICommonPlan::~OAICommonPlan() {}

void OAICommonPlan::initializeModel() {
...
void OAICommonPlan::fromJson(QString jsonString) {
...
void OAICommonPlan::fromJsonObject(QJsonObject json) {
...
QString OAICommonPlan::asJson() const {
...
QJsonObject OAICommonPlan::asJsonObject() const {
    QJsonObject obj;
...
QDateTime OAICommonPlan::getCreatedTime() const {
    return m_created_time;
}
void OAICommonPlan::setCreatedTime(const QDateTime &created_time) {
    m_created_time = created_time;
    m_created_time_isSet = true;
}

bool OAICommonPlan::is_created_time_Set() const{
    return m_created_time_isSet;
}

bool OAICommonPlan::is_created_time_Valid() const{
    return m_created_time_isValid;
}

QString OAICommonPlan::getCurrency() const {
    return m_currency;
}
void OAICommonPlan::setCurrency(const QString &currency) {
    m_currency = currency;
    m_currency_isSet = true;
}

bool OAICommonPlan::is_currency_Set() const{
    return m_currency_isSet;
}

bool OAICommonPlan::is_currency_Valid() const{
    return m_currency_isValid;
}

QString OAICommonPlan::getCurrencySign() const {
    return m_currency_sign;
}
void OAICommonPlan::setCurrencySign(const QString &currency_sign) {
    m_currency_sign = currency_sign;
    m_currency_sign_isSet = true;
}

bool OAICommonPlan::is_currency_sign_Set() const{
    return m_currency_sign_isSet;
}

bool OAICommonPlan::is_currency_sign_Valid() const{
    return m_currency_sign_isValid;
}

OAIObject OAICommonPlan::getCustomFields() const {
    return m_custom_fields;
}
void OAICommonPlan::setCustomFields(const OAIObject &custom_fields) {
    m_custom_fields = custom_fields;
    m_custom_fields_isSet = true;
}

bool OAICommonPlan::is_custom_fields_Set() const{
    return m_custom_fields_isSet;
}

bool OAICommonPlan::is_custom_fields_Valid() const{
    return m_custom_fields_isValid;
}

QString OAICommonPlan::getId() const {
    return m_id;
}
void OAICommonPlan::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAICommonPlan::is_id_Set() const{
    return m_id_isSet;
}

bool OAICommonPlan::is_id_Valid() const{
    return m_id_isValid;
}

bool OAICommonPlan::isIsTrialOnly() const {
    return m_is_trial_only;
}
void OAICommonPlan::setIsTrialOnly(const bool &is_trial_only) {
    m_is_trial_only = is_trial_only;
    m_is_trial_only_isSet = true;
}

bool OAICommonPlan::is_is_trial_only_Set() const{
    return m_is_trial_only_isSet;
}

bool OAICommonPlan::is_is_trial_only_Valid() const{
    return m_is_trial_only_isValid;
}

QString OAICommonPlan::getName() const {
    return m_name;
}
void OAICommonPlan::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAICommonPlan::is_name_Set() const{
    return m_name_isSet;
}

bool OAICommonPlan::is_name_Valid() const{
    return m_name_isValid;
}

OAIPlanPriceFormula OAICommonPlan::getPricing() const {
    return m_pricing;
}
void OAICommonPlan::setPricing(const OAIPlanPriceFormula &pricing) {
    m_pricing = pricing;
    m_pricing_isSet = true;
}

bool OAICommonPlan::is_pricing_Set() const{
    return m_pricing_isSet;
}

bool OAICommonPlan::is_pricing_Valid() const{
    return m_pricing_isValid;
}

QString OAICommonPlan::getProductId() const {
    return m_product_id;
}
void OAICommonPlan::setProductId(const QString &product_id) {
    m_product_id = product_id;
    m_product_id_isSet = true;
}

bool OAICommonPlan::is_product_id_Set() const{
    return m_product_id_isSet;
}

bool OAICommonPlan::is_product_id_Valid() const{
    return m_product_id_isValid;
}

QMap<QString, QString> OAICommonPlan::getProductOptions() const {
    return m_product_options;
}
void OAICommonPlan::setProductOptions(const QMap<QString, QString> &product_options) {
    m_product_options = product_options;
    m_product_options_isSet = true;
}

bool OAICommonPlan::is_product_options_Set() const{
    return m_product_options_isSet;
}

bool OAICommonPlan::is_product_options_Valid() const{
    return m_product_options_isValid;
}

OAICommonPlan_recurringInterval OAICommonPlan::getRecurringInterval() const {
    return m_recurring_interval;
}
void OAICommonPlan::setRecurringInterval(const OAICommonPlan_recurringInterval &recurring_interval) {
    m_recurring_interval = recurring_interval;
    m_recurring_interval_isSet = true;
}

bool OAICommonPlan::is_recurring_interval_Set() const{
    return m_recurring_interval_isSet;
}

bool OAICommonPlan::is_recurring_interval_Valid() const{
    return m_recurring_interval_isValid;
}

qint32 OAICommonPlan::getRevision() const {
    return m_revision;
}
void OAICommonPlan::setRevision(const qint32 &revision) {
    m_revision = revision;
    m_revision_isSet = true;
}

bool OAICommonPlan::is_revision_Set() const{
    return m_revision_isSet;
}

bool OAICommonPlan::is_revision_Valid() const{
    return m_revision_isValid;
}

OAICommonPlan_setup OAICommonPlan::getSetup() const {
    return m_setup;
}
void OAICommonPlan::setSetup(const OAICommonPlan_setup &setup) {
    m_setup = setup;
    m_setup_isSet = true;
}

bool OAICommonPlan::is_setup_Set() const{
    return m_setup_isSet;
}

bool OAICommonPlan::is_setup_Valid() const{
    return m_setup_isValid;
}

OAICommonPlan_trial OAICommonPlan::getTrial() const {
    return m_trial;
}
void OAICommonPlan::setTrial(const OAICommonPlan_trial &trial) {
    m_trial = trial;
    m_trial_isSet = true;
}

bool OAICommonPlan::is_trial_Set() const{
    return m_trial_isSet;
}

bool OAICommonPlan::is_trial_Valid() const{
    return m_trial_isValid;
}

QDateTime OAICommonPlan::getUpdatedTime() const {
    return m_updated_time;
}
void OAICommonPlan::setUpdatedTime(const QDateTime &updated_time) {
    m_updated_time = updated_time;
    m_updated_time_isSet = true;
}

bool OAICommonPlan::is_updated_time_Set() const{
    return m_updated_time_isSet;
}

bool OAICommonPlan::is_updated_time_Valid() const{
    return m_updated_time_isValid;
}

bool OAICommonPlan::isSet() const {
...
bool OAICommonPlan::isValid() const {
