...
/*
 * OAIBankAccountCreatePlain.h
 *
 * 
 */

#ifndef OAIBankAccountCreatePlain_H
#define OAIBankAccountCreatePlain_H
...
class OAIBankAccountCreatePlain : public OAIObject {
public:
    OAIBankAccountCreatePlain();
    OAIBankAccountCreatePlain(QString json);
    ~OAIBankAccountCreatePlain() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBankAccountCreatePlain)

#endif // OAIBankAccountCreatePlain_H
