...
#ifndef OAIIBANType_H
#define OAIIBANType_H
...
class OAIIBANType : public OAIObject {
public:
    OAIIBANType();
    OAIIBANType(QString json);
    ~OAIIBANType() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIIBANType)
