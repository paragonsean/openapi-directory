...
OAIStripe::OAIStripe(QString json) {
...
void OAIStripe::initializeModel() {
...
void OAIStripe::fromJson(QString jsonString) {
...
void OAIStripe::fromJsonObject(QJsonObject json) {
...
QString OAIStripe::asJson() const {
...
QJsonObject OAIStripe::asJsonObject() const {
    QJsonObject obj;
    if (m__links.size() > 0) {
...
QList<OAIGatewayAccount__links_inner> OAIStripe::getLinks() const {
    return m__links;
}
void OAIStripe::setLinks(const QList<OAIGatewayAccount__links_inner> &_links) {
    m__links = _links;
    m__links_isSet = true;
}

bool OAIStripe::is__links_Set() const{
    return m__links_isSet;
}

bool OAIStripe::is__links_Valid() const{
    return m__links_isValid;
}

QList<QString> OAIStripe::getAcceptedCurrencies() const {
    return m_accepted_currencies;
}
void OAIStripe::setAcceptedCurrencies(const QList<QString> &accepted_currencies) {
    m_accepted_currencies = accepted_currencies;
    m_accepted_currencies_isSet = true;
}

bool OAIStripe::is_accepted_currencies_Set() const{
    return m_accepted_currencies_isSet;
}

bool OAIStripe::is_accepted_currencies_Valid() const{
    return m_accepted_currencies_isValid;
}

OAIAcquirerName OAIStripe::getAcquirerName() const {
    return m_acquirer_name;
}
void OAIStripe::setAcquirerName(const OAIAcquirerName &acquirer_name) {
    m_acquirer_name = acquirer_name;
    m_acquirer_name_isSet = true;
}

bool OAIStripe::is_acquirer_name_Set() const{
    return m_acquirer_name_isSet;
}

bool OAIStripe::is_acquirer_name_Valid() const{
    return m_acquirer_name_isValid;
}

QString OAIStripe::getAdditionalFilters() const {
    return m_additional_filters;
}
void OAIStripe::setAdditionalFilters(const QString &additional_filters) {
    m_additional_filters = additional_filters;
    m_additional_filters_isSet = true;
}

bool OAIStripe::is_additional_filters_Set() const{
    return m_additional_filters_isSet;
}

bool OAIStripe::is_additional_filters_Valid() const{
    return m_additional_filters_isValid;
}

qint32 OAIStripe::getApprovalWindowTtl() const {
    return m_approval_window_ttl;
}
void OAIStripe::setApprovalWindowTtl(const qint32 &approval_window_ttl) {
    m_approval_window_ttl = approval_window_ttl;
    m_approval_window_ttl_isSet = true;
}

bool OAIStripe::is_approval_window_ttl_Set() const{
    return m_approval_window_ttl_isSet;
}

bool OAIStripe::is_approval_window_ttl_Valid() const{
    return m_approval_window_ttl_isValid;
}

QString OAIStripe::getCityField() const {
    return m_city_field;
}
void OAIStripe::setCityField(const QString &city_field) {
    m_city_field = city_field;
    m_city_field_isSet = true;
}

bool OAIStripe::is_city_field_Set() const{
    return m_city_field_isSet;
}

bool OAIStripe::is_city_field_Valid() const{
    return m_city_field_isValid;
}

QDateTime OAIStripe::getCreatedTime() const {
    return m_created_time;
}
void OAIStripe::setCreatedTime(const QDateTime &created_time) {
    m_created_time = created_time;
    m_created_time_isSet = true;
}

bool OAIStripe::is_created_time_Set() const{
    return m_created_time_isSet;
}

bool OAIStripe::is_created_time_Valid() const{
    return m_created_time_isValid;
}

QString OAIStripe::getDccForceCurrency() const {
    return m_dcc_force_currency;
}
void OAIStripe::setDccForceCurrency(const QString &dcc_force_currency) {
    m_dcc_force_currency = dcc_force_currency;
    m_dcc_force_currency_isSet = true;
}

bool OAIStripe::is_dcc_force_currency_Set() const{
    return m_dcc_force_currency_isSet;
}

bool OAIStripe::is_dcc_force_currency_Valid() const{
    return m_dcc_force_currency_isValid;
}

qint32 OAIStripe::getDccMarkup() const {
    return m_dcc_markup;
}
void OAIStripe::setDccMarkup(const qint32 &dcc_markup) {
    m_dcc_markup = dcc_markup;
    m_dcc_markup_isSet = true;
}

bool OAIStripe::is_dcc_markup_Set() const{
    return m_dcc_markup_isSet;
}

bool OAIStripe::is_dcc_markup_Valid() const{
    return m_dcc_markup_isValid;
}

QString OAIStripe::getDescriptor() const {
    return m_descriptor;
}
void OAIStripe::setDescriptor(const QString &descriptor) {
    m_descriptor = descriptor;
    m_descriptor_isSet = true;
}

bool OAIStripe::is_descriptor_Set() const{
    return m_descriptor_isSet;
}

bool OAIStripe::is_descriptor_Valid() const{
    return m_descriptor_isValid;
}

OAIDigitalWallets OAIStripe::getDigitalWallets() const {
    return m_digital_wallets;
}
void OAIStripe::setDigitalWallets(const OAIDigitalWallets &digital_wallets) {
    m_digital_wallets = digital_wallets;
    m_digital_wallets_isSet = true;
}

bool OAIStripe::is_digital_wallets_Set() const{
    return m_digital_wallets_isSet;
}

bool OAIStripe::is_digital_wallets_Valid() const{
    return m_digital_wallets_isValid;
}

bool OAIStripe::isDynamicDescriptor() const {
    return m_dynamic_descriptor;
}
void OAIStripe::setDynamicDescriptor(const bool &dynamic_descriptor) {
    m_dynamic_descriptor = dynamic_descriptor;
    m_dynamic_descriptor_isSet = true;
}

bool OAIStripe::is_dynamic_descriptor_Set() const{
    return m_dynamic_descriptor_isSet;
}

bool OAIStripe::is_dynamic_descriptor_Valid() const{
    return m_dynamic_descriptor_isValid;
}

QList<QString> OAIStripe::getExcludedDccQuoteCurrencies() const {
    return m_excluded_dcc_quote_currencies;
}
void OAIStripe::setExcludedDccQuoteCurrencies(const QList<QString> &excluded_dcc_quote_currencies) {
    m_excluded_dcc_quote_currencies = excluded_dcc_quote_currencies;
    m_excluded_dcc_quote_currencies_isSet = true;
}

bool OAIStripe::is_excluded_dcc_quote_currencies_Set() const{
    return m_excluded_dcc_quote_currencies_isSet;
}

bool OAIStripe::is_excluded_dcc_quote_currencies_Valid() const{
    return m_excluded_dcc_quote_currencies_isValid;
}

OAIGatewayName OAIStripe::getGatewayName() const {
    return m_gateway_name;
}
void OAIStripe::setGatewayName(const OAIGatewayName &gateway_name) {
    m_gateway_name = gateway_name;
    m_gateway_name_isSet = true;
}

bool OAIStripe::is_gateway_name_Set() const{
    return m_gateway_name_isSet;
}

bool OAIStripe::is_gateway_name_Valid() const{
    return m_gateway_name_isValid;
}

QString OAIStripe::getId() const {
    return m_id;
}
void OAIStripe::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIStripe::is_id_Set() const{
    return m_id_isSet;
}

bool OAIStripe::is_id_Valid() const{
    return m_id_isValid;
}

bool OAIStripe::isIsDown() const {
    return m_is_down;
}
void OAIStripe::setIsDown(const bool &is_down) {
    m_is_down = is_down;
    m_is_down_isSet = true;
}

bool OAIStripe::is_is_down_Set() const{
    return m_is_down_isSet;
}

bool OAIStripe::is_is_down_Valid() const{
    return m_is_down_isValid;
}

QString OAIStripe::getMerchantCategoryCode() const {
    return m_merchant_category_code;
}
void OAIStripe::setMerchantCategoryCode(const QString &merchant_category_code) {
    m_merchant_category_code = merchant_category_code;
    m_merchant_category_code_isSet = true;
}

bool OAIStripe::is_merchant_category_code_Set() const{
    return m_merchant_category_code_isSet;
}

bool OAIStripe::is_merchant_category_code_Valid() const{
    return m_merchant_category_code_isValid;
}

OAIPaymentMethod OAIStripe::getMethod() const {
    return m_method;
}
void OAIStripe::setMethod(const OAIPaymentMethod &method) {
    m_method = method;
    m_method_isSet = true;
}

bool OAIStripe::is_method_Set() const{
    return m_method_isSet;
}

bool OAIStripe::is_method_Valid() const{
    return m_method_isValid;
}

double OAIStripe::getMonthlyLimit() const {
    return m_monthly_limit;
}
void OAIStripe::setMonthlyLimit(const double &monthly_limit) {
    m_monthly_limit = monthly_limit;
    m_monthly_limit_isSet = true;
}

bool OAIStripe::is_monthly_limit_Set() const{
    return m_monthly_limit_isSet;
}

bool OAIStripe::is_monthly_limit_Valid() const{
    return m_monthly_limit_isValid;
}

QString OAIStripe::getOrganizationId() const {
    return m_organization_id;
}
void OAIStripe::setOrganizationId(const QString &organization_id) {
    m_organization_id = organization_id;
    m_organization_id_isSet = true;
}

bool OAIStripe::is_organization_id_Set() const{
    return m_organization_id_isSet;
}

bool OAIStripe::is_organization_id_Valid() const{
    return m_organization_id_isValid;
}

QList<OAIPaymentCardBrand> OAIStripe::getPaymentCardSchemes() const {
    return m_payment_card_schemes;
}
void OAIStripe::setPaymentCardSchemes(const QList<OAIPaymentCardBrand> &payment_card_schemes) {
    m_payment_card_schemes = payment_card_schemes;
    m_payment_card_schemes_isSet = true;
}

bool OAIStripe::is_payment_card_schemes_Set() const{
    return m_payment_card_schemes_isSet;
}

bool OAIStripe::is_payment_card_schemes_Valid() const{
    return m_payment_card_schemes_isValid;
}

bool OAIStripe::isReconciliationWindowEnabled() const {
    return m_reconciliation_window_enabled;
}
void OAIStripe::setReconciliationWindowEnabled(const bool &reconciliation_window_enabled) {
    m_reconciliation_window_enabled = reconciliation_window_enabled;
    m_reconciliation_window_enabled_isSet = true;
}

bool OAIStripe::is_reconciliation_window_enabled_Set() const{
    return m_reconciliation_window_enabled_isSet;
}

bool OAIStripe::is_reconciliation_window_enabled_Valid() const{
    return m_reconciliation_window_enabled_isValid;
}

qint32 OAIStripe::getReconciliationWindowTtl() const {
    return m_reconciliation_window_ttl;
}
void OAIStripe::setReconciliationWindowTtl(const qint32 &reconciliation_window_ttl) {
    m_reconciliation_window_ttl = reconciliation_window_ttl;
    m_reconciliation_window_ttl_isSet = true;
}

bool OAIStripe::is_reconciliation_window_ttl_Set() const{
    return m_reconciliation_window_ttl_isSet;
}

bool OAIStripe::is_reconciliation_window_ttl_Valid() const{
    return m_reconciliation_window_ttl_isValid;
}

QString OAIStripe::getStatus() const {
    return m_status;
}
void OAIStripe::setStatus(const QString &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIStripe::is_status_Set() const{
    return m_status_isSet;
}

bool OAIStripe::is_status_Valid() const{
    return m_status_isValid;
}

bool OAIStripe::isSticky() const {
    return m_sticky;
}
void OAIStripe::setSticky(const bool &sticky) {
    m_sticky = sticky;
    m_sticky_isSet = true;
}

bool OAIStripe::is_sticky_Set() const{
    return m_sticky_isSet;
}

bool OAIStripe::is_sticky_Valid() const{
    return m_sticky_isValid;
}

bool OAIStripe::isThreeDSecure() const {
    return m_three_d_secure;
}
void OAIStripe::setThreeDSecure(const bool &three_d_secure) {
    m_three_d_secure = three_d_secure;
    m_three_d_secure_isSet = true;
}

bool OAIStripe::is_three_d_secure_Set() const{
    return m_three_d_secure_isSet;
}

bool OAIStripe::is_three_d_secure_Valid() const{
    return m_three_d_secure_isValid;
}

qint32 OAIStripe::getTimeout() const {
    return m_timeout;
}
void OAIStripe::setTimeout(const qint32 &timeout) {
    m_timeout = timeout;
    m_timeout_isSet = true;
}

bool OAIStripe::is_timeout_Set() const{
    return m_timeout_isSet;
}

bool OAIStripe::is_timeout_Valid() const{
    return m_timeout_isValid;
}

QString OAIStripe::getToken() const {
    return m_token;
}
void OAIStripe::setToken(const QString &token) {
    m_token = token;
    m_token_isSet = true;
}

bool OAIStripe::is_token_Set() const{
    return m_token_isSet;
}

bool OAIStripe::is_token_Valid() const{
    return m_token_isValid;
}

QDateTime OAIStripe::getUpdatedTime() const {
    return m_updated_time;
}
void OAIStripe::setUpdatedTime(const QDateTime &updated_time) {
    m_updated_time = updated_time;
    m_updated_time_isSet = true;
}

bool OAIStripe::is_updated_time_Set() const{
    return m_updated_time_isSet;
}

bool OAIStripe::is_updated_time_Valid() const{
    return m_updated_time_isValid;
}

OAIStripe_allOf_settings OAIStripe::getSettings() const {
    return m_settings;
}
void OAIStripe::setSettings(const OAIStripe_allOf_settings &settings) {
    m_settings = settings;
    m_settings_isSet = true;
}

bool OAIStripe::is_settings_Set() const{
    return m_settings_isSet;
}

bool OAIStripe::is_settings_Valid() const{
    return m_settings_isValid;
}

OAIStripe3dsServers OAIStripe::getThreeDSecureServer() const {
    return m_three_d_secure_server;
}
void OAIStripe::setThreeDSecureServer(const OAIStripe3dsServers &three_d_secure_server) {
    m_three_d_secure_server = three_d_secure_server;
    m_three_d_secure_server_isSet = true;
}

bool OAIStripe::is_three_d_secure_server_Set() const{
    return m_three_d_secure_server_isSet;
}

bool OAIStripe::is_three_d_secure_server_Valid() const{
    return m_three_d_secure_server_isValid;
}

bool OAIStripe::isSet() const {
