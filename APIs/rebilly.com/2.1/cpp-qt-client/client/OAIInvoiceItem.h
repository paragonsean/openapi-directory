...
namespace OpenAPI {
class OAIInvoiceItem__embedded_inner;
class OAIInvoiceItem__links_inner;
...
public:
    ...
    QList<OAIInvoiceItem__embedded_inner> getEmbedded() const;
    void setEmbedded(const QList<OAIInvoiceItem__embedded_inner> &_embedded);
    bool is__embedded_Set() const;
    bool is__embedded_Valid() const;

    QList<OAIInvoiceItem__links_inner> getLinks() const;
    void setLinks(const QList<OAIInvoiceItem__links_inner> &_links);
    ...
    qint32 getPeriodNumber() const;
    void setPeriodNumber(const qint32 &period_number);
    bool is_period_number_Set() const;
    bool is_period_number_Valid() const;
...
private:
    ...
    QList<OAIInvoiceItem__embedded_inner> m__embedded;
    bool m__embedded_isSet;
    bool m__embedded_isValid;

    QList<OAIInvoiceItem__links_inner> m__links;
    bool m__links_isSet;
    ...
    qint32 m_period_number;
    bool m_period_number_isSet;
    bool m_period_number_isValid;
