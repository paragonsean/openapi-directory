...
OAIAstroPayCard::OAIAstroPayCard(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAstroPayCard::OAIAstroPayCard() {
    this->initializeModel();
}

OAIAstroPayCard::~OAIAstroPayCard() {}

void OAIAstroPayCard::initializeModel() {
...
void OAIAstroPayCard::fromJson(QString jsonString) {
...
void OAIAstroPayCard::fromJsonObject(QJsonObject json) {
...
QString OAIAstroPayCard::asJson() const {
...
QJsonObject OAIAstroPayCard::asJsonObject() const {
    QJsonObject obj;
    if (m__links.size() > 0) {
...
QList<OAIGatewayAccount__links_inner> OAIAstroPayCard::getLinks() const {
    return m__links;
}
void OAIAstroPayCard::setLinks(const QList<OAIGatewayAccount__links_inner> &_links) {
    m__links = _links;
    m__links_isSet = true;
}

bool OAIAstroPayCard::is__links_Set() const{
    return m__links_isSet;
}

bool OAIAstroPayCard::is__links_Valid() const{
    return m__links_isValid;
}

QList<QString> OAIAstroPayCard::getAcceptedCurrencies() const {
    return m_accepted_currencies;
}
void OAIAstroPayCard::setAcceptedCurrencies(const QList<QString> &accepted_currencies) {
    m_accepted_currencies = accepted_currencies;
    m_accepted_currencies_isSet = true;
}

bool OAIAstroPayCard::is_accepted_currencies_Set() const{
    return m_accepted_currencies_isSet;
}

bool OAIAstroPayCard::is_accepted_currencies_Valid() const{
    return m_accepted_currencies_isValid;
}

OAIAcquirerName OAIAstroPayCard::getAcquirerName() const {
    return m_acquirer_name;
}
void OAIAstroPayCard::setAcquirerName(const OAIAcquirerName &acquirer_name) {
    m_acquirer_name = acquirer_name;
    m_acquirer_name_isSet = true;
}

bool OAIAstroPayCard::is_acquirer_name_Set() const{
    return m_acquirer_name_isSet;
}

bool OAIAstroPayCard::is_acquirer_name_Valid() const{
    return m_acquirer_name_isValid;
}

QString OAIAstroPayCard::getAdditionalFilters() const {
    return m_additional_filters;
}
void OAIAstroPayCard::setAdditionalFilters(const QString &additional_filters) {
    m_additional_filters = additional_filters;
    m_additional_filters_isSet = true;
}

bool OAIAstroPayCard::is_additional_filters_Set() const{
    return m_additional_filters_isSet;
}

bool OAIAstroPayCard::is_additional_filters_Valid() const{
    return m_additional_filters_isValid;
}

qint32 OAIAstroPayCard::getApprovalWindowTtl() const {
    return m_approval_window_ttl;
}
void OAIAstroPayCard::setApprovalWindowTtl(const qint32 &approval_window_ttl) {
    m_approval_window_ttl = approval_window_ttl;
    m_approval_window_ttl_isSet = true;
}

bool OAIAstroPayCard::is_approval_window_ttl_Set() const{
    return m_approval_window_ttl_isSet;
}

bool OAIAstroPayCard::is_approval_window_ttl_Valid() const{
    return m_approval_window_ttl_isValid;
}

QString OAIAstroPayCard::getCityField() const {
    return m_city_field;
}
void OAIAstroPayCard::setCityField(const QString &city_field) {
    m_city_field = city_field;
    m_city_field_isSet = true;
}

bool OAIAstroPayCard::is_city_field_Set() const{
    return m_city_field_isSet;
}

bool OAIAstroPayCard::is_city_field_Valid() const{
    return m_city_field_isValid;
}

QDateTime OAIAstroPayCard::getCreatedTime() const {
    return m_created_time;
}
void OAIAstroPayCard::setCreatedTime(const QDateTime &created_time) {
    m_created_time = created_time;
    m_created_time_isSet = true;
}

bool OAIAstroPayCard::is_created_time_Set() const{
    return m_created_time_isSet;
}

bool OAIAstroPayCard::is_created_time_Valid() const{
    return m_created_time_isValid;
}

QString OAIAstroPayCard::getDccForceCurrency() const {
    return m_dcc_force_currency;
}
void OAIAstroPayCard::setDccForceCurrency(const QString &dcc_force_currency) {
    m_dcc_force_currency = dcc_force_currency;
    m_dcc_force_currency_isSet = true;
}

bool OAIAstroPayCard::is_dcc_force_currency_Set() const{
    return m_dcc_force_currency_isSet;
}

bool OAIAstroPayCard::is_dcc_force_currency_Valid() const{
    return m_dcc_force_currency_isValid;
}

qint32 OAIAstroPayCard::getDccMarkup() const {
    return m_dcc_markup;
}
void OAIAstroPayCard::setDccMarkup(const qint32 &dcc_markup) {
    m_dcc_markup = dcc_markup;
    m_dcc_markup_isSet = true;
}

bool OAIAstroPayCard::is_dcc_markup_Set() const{
    return m_dcc_markup_isSet;
}

bool OAIAstroPayCard::is_dcc_markup_Valid() const{
    return m_dcc_markup_isValid;
}

QString OAIAstroPayCard::getDescriptor() const {
    return m_descriptor;
}
void OAIAstroPayCard::setDescriptor(const QString &descriptor) {
    m_descriptor = descriptor;
    m_descriptor_isSet = true;
}

bool OAIAstroPayCard::is_descriptor_Set() const{
    return m_descriptor_isSet;
}

bool OAIAstroPayCard::is_descriptor_Valid() const{
    return m_descriptor_isValid;
}

OAIDigitalWallets OAIAstroPayCard::getDigitalWallets() const {
    return m_digital_wallets;
}
void OAIAstroPayCard::setDigitalWallets(const OAIDigitalWallets &digital_wallets) {
    m_digital_wallets = digital_wallets;
    m_digital_wallets_isSet = true;
}

bool OAIAstroPayCard::is_digital_wallets_Set() const{
    return m_digital_wallets_isSet;
}

bool OAIAstroPayCard::is_digital_wallets_Valid() const{
    return m_digital_wallets_isValid;
}

bool OAIAstroPayCard::isDynamicDescriptor() const {
    return m_dynamic_descriptor;
}
void OAIAstroPayCard::setDynamicDescriptor(const bool &dynamic_descriptor) {
    m_dynamic_descriptor = dynamic_descriptor;
    m_dynamic_descriptor_isSet = true;
}

bool OAIAstroPayCard::is_dynamic_descriptor_Set() const{
    return m_dynamic_descriptor_isSet;
}

bool OAIAstroPayCard::is_dynamic_descriptor_Valid() const{
    return m_dynamic_descriptor_isValid;
}

QList<QString> OAIAstroPayCard::getExcludedDccQuoteCurrencies() const {
    return m_excluded_dcc_quote_currencies;
}
void OAIAstroPayCard::setExcludedDccQuoteCurrencies(const QList<QString> &excluded_dcc_quote_currencies) {
    m_excluded_dcc_quote_currencies = excluded_dcc_quote_currencies;
    m_excluded_dcc_quote_currencies_isSet = true;
}

bool OAIAstroPayCard::is_excluded_dcc_quote_currencies_Set() const{
    return m_excluded_dcc_quote_currencies_isSet;
}

bool OAIAstroPayCard::is_excluded_dcc_quote_currencies_Valid() const{
    return m_excluded_dcc_quote_currencies_isValid;
}

OAIGatewayName OAIAstroPayCard::getGatewayName() const {
    return m_gateway_name;
}
void OAIAstroPayCard::setGatewayName(const OAIGatewayName &gateway_name) {
    m_gateway_name = gateway_name;
    m_gateway_name_isSet = true;
}

bool OAIAstroPayCard::is_gateway_name_Set() const{
    return m_gateway_name_isSet;
}

bool OAIAstroPayCard::is_gateway_name_Valid() const{
    return m_gateway_name_isValid;
}

QString OAIAstroPayCard::getId() const {
    return m_id;
}
void OAIAstroPayCard::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIAstroPayCard::is_id_Set() const{
    return m_id_isSet;
}

bool OAIAstroPayCard::is_id_Valid() const{
    return m_id_isValid;
}

bool OAIAstroPayCard::isIsDown() const {
    return m_is_down;
}
void OAIAstroPayCard::setIsDown(const bool &is_down) {
    m_is_down = is_down;
    m_is_down_isSet = true;
}

bool OAIAstroPayCard::is_is_down_Set() const{
    return m_is_down_isSet;
}

bool OAIAstroPayCard::is_is_down_Valid() const{
    return m_is_down_isValid;
}

QString OAIAstroPayCard::getMerchantCategoryCode() const {
    return m_merchant_category_code;
}
void OAIAstroPayCard::setMerchantCategoryCode(const QString &merchant_category_code) {
    m_merchant_category_code = merchant_category_code;
    m_merchant_category_code_isSet = true;
}

bool OAIAstroPayCard::is_merchant_category_code_Set() const{
    return m_merchant_category_code_isSet;
}

bool OAIAstroPayCard::is_merchant_category_code_Valid() const{
    return m_merchant_category_code_isValid;
}

OAIPaymentMethod OAIAstroPayCard::getMethod() const {
    return m_method;
}
void OAIAstroPayCard::setMethod(const OAIPaymentMethod &method) {
    m_method = method;
    m_method_isSet = true;
}

bool OAIAstroPayCard::is_method_Set() const{
    return m_method_isSet;
}

bool OAIAstroPayCard::is_method_Valid() const{
    return m_method_isValid;
}

double OAIAstroPayCard::getMonthlyLimit() const {
    return m_monthly_limit;
}
void OAIAstroPayCard::setMonthlyLimit(const double &monthly_limit) {
    m_monthly_limit = monthly_limit;
    m_monthly_limit_isSet = true;
}

bool OAIAstroPayCard::is_monthly_limit_Set() const{
    return m_monthly_limit_isSet;
}

bool OAIAstroPayCard::is_monthly_limit_Valid() const{
    return m_monthly_limit_isValid;
}

QString OAIAstroPayCard::getOrganizationId() const {
    return m_organization_id;
}
void OAIAstroPayCard::setOrganizationId(const QString &organization_id) {
    m_organization_id = organization_id;
    m_organization_id_isSet = true;
}

bool OAIAstroPayCard::is_organization_id_Set() const{
    return m_organization_id_isSet;
}

bool OAIAstroPayCard::is_organization_id_Valid() const{
    return m_organization_id_isValid;
}

QList<OAIPaymentCardBrand> OAIAstroPayCard::getPaymentCardSchemes() const {
    return m_payment_card_schemes;
}
void OAIAstroPayCard::setPaymentCardSchemes(const QList<OAIPaymentCardBrand> &payment_card_schemes) {
    m_payment_card_schemes = payment_card_schemes;
    m_payment_card_schemes_isSet = true;
}

bool OAIAstroPayCard::is_payment_card_schemes_Set() const{
    return m_payment_card_schemes_isSet;
}

bool OAIAstroPayCard::is_payment_card_schemes_Valid() const{
    return m_payment_card_schemes_isValid;
}

bool OAIAstroPayCard::isReconciliationWindowEnabled() const {
    return m_reconciliation_window_enabled;
}
void OAIAstroPayCard::setReconciliationWindowEnabled(const bool &reconciliation_window_enabled) {
    m_reconciliation_window_enabled = reconciliation_window_enabled;
    m_reconciliation_window_enabled_isSet = true;
}

bool OAIAstroPayCard::is_reconciliation_window_enabled_Set() const{
    return m_reconciliation_window_enabled_isSet;
}

bool OAIAstroPayCard::is_reconciliation_window_enabled_Valid() const{
    return m_reconciliation_window_enabled_isValid;
}

qint32 OAIAstroPayCard::getReconciliationWindowTtl() const {
    return m_reconciliation_window_ttl;
}
void OAIAstroPayCard::setReconciliationWindowTtl(const qint32 &reconciliation_window_ttl) {
    m_reconciliation_window_ttl = reconciliation_window_ttl;
    m_reconciliation_window_ttl_isSet = true;
}

bool OAIAstroPayCard::is_reconciliation_window_ttl_Set() const{
    return m_reconciliation_window_ttl_isSet;
}

bool OAIAstroPayCard::is_reconciliation_window_ttl_Valid() const{
    return m_reconciliation_window_ttl_isValid;
}

QString OAIAstroPayCard::getStatus() const {
    return m_status;
}
void OAIAstroPayCard::setStatus(const QString &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIAstroPayCard::is_status_Set() const{
    return m_status_isSet;
}

bool OAIAstroPayCard::is_status_Valid() const{
    return m_status_isValid;
}

bool OAIAstroPayCard::isSticky() const {
    return m_sticky;
}
void OAIAstroPayCard::setSticky(const bool &sticky) {
    m_sticky = sticky;
    m_sticky_isSet = true;
}

bool OAIAstroPayCard::is_sticky_Set() const{
    return m_sticky_isSet;
}

bool OAIAstroPayCard::is_sticky_Valid() const{
    return m_sticky_isValid;
}

bool OAIAstroPayCard::isThreeDSecure() const {
    return m_three_d_secure;
}
void OAIAstroPayCard::setThreeDSecure(const bool &three_d_secure) {
    m_three_d_secure = three_d_secure;
    m_three_d_secure_isSet = true;
}

bool OAIAstroPayCard::is_three_d_secure_Set() const{
    return m_three_d_secure_isSet;
}

bool OAIAstroPayCard::is_three_d_secure_Valid() const{
    return m_three_d_secure_isValid;
}

qint32 OAIAstroPayCard::getTimeout() const {
    return m_timeout;
}
void OAIAstroPayCard::setTimeout(const qint32 &timeout) {
    m_timeout = timeout;
    m_timeout_isSet = true;
}

bool OAIAstroPayCard::is_timeout_Set() const{
    return m_timeout_isSet;
}

bool OAIAstroPayCard::is_timeout_Valid() const{
    return m_timeout_isValid;
}

QString OAIAstroPayCard::getToken() const {
    return m_token;
}
void OAIAstroPayCard::setToken(const QString &token) {
    m_token = token;
    m_token_isSet = true;
}

bool OAIAstroPayCard::is_token_Set() const{
    return m_token_isSet;
}

bool OAIAstroPayCard::is_token_Valid() const{
    return m_token_isValid;
}

QDateTime OAIAstroPayCard::getUpdatedTime() const {
    return m_updated_time;
}
void OAIAstroPayCard::setUpdatedTime(const QDateTime &updated_time) {
    m_updated_time = updated_time;
    m_updated_time_isSet = true;
}

bool OAIAstroPayCard::is_updated_time_Set() const{
    return m_updated_time_isSet;
}

bool OAIAstroPayCard::is_updated_time_Valid() const{
    return m_updated_time_isValid;
}

OAIAstroPayCard_allOf_credentials OAIAstroPayCard::getCredentials() const {
    return m_credentials;
}
void OAIAstroPayCard::setCredentials(const OAIAstroPayCard_allOf_credentials &credentials) {
    m_credentials = credentials;
    m_credentials_isSet = true;
}

bool OAIAstroPayCard::is_credentials_Set() const{
    return m_credentials_isSet;
}

bool OAIAstroPayCard::is_credentials_Valid() const{
    return m_credentials_isValid;
}

OAIAstroPayCard_allOf_settings OAIAstroPayCard::getSettings() const {
    return m_settings;
}
void OAIAstroPayCard::setSettings(const OAIAstroPayCard_allOf_settings &settings) {
    m_settings = settings;
    m_settings_isSet = true;
}

bool OAIAstroPayCard::is_settings_Set() const{
    return m_settings_isSet;
}

bool OAIAstroPayCard::is_settings_Valid() const{
    return m_settings_isValid;
}

bool OAIAstroPayCard::isSet() const {
...
bool OAIAstroPayCard::isValid() const {
