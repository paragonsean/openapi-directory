...
class OAIICanPay_allOf_credentials;
class OAIPaymenTechnologies_allOf_settings;

class OAIICanPay : public OAIObject {
public:
    OAIICanPay();
    OAIICanPay(QString json);
    ~OAIICanPay() override;
    ...
    OAIICanPay_allOf_credentials getCredentials() const;
    void setCredentials(const OAIICanPay_allOf_credentials &credentials);
...
private:
    ...
    OAIICanPay_allOf_credentials m_credentials;
...
Q_DECLARE_METATYPE(OpenAPI::OAIICanPay)
