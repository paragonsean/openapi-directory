...
OAIPandaGateway::OAIPandaGateway(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPandaGateway::OAIPandaGateway() {
    this->initializeModel();
}

OAIPandaGateway::~OAIPandaGateway() {}

void OAIPandaGateway::initializeModel() {
...
void OAIPandaGateway::fromJson(QString jsonString) {
...
void OAIPandaGateway::fromJsonObject(QJsonObject json) {
...
QString OAIPandaGateway::asJson() const {
...
QJsonObject OAIPandaGateway::asJsonObject() const {
    QJsonObject obj;
    if (m__links.size() > 0) {
...
QList<OAIGatewayAccount__links_inner> OAIPandaGateway::getLinks() const {
    return m__links;
}
void OAIPandaGateway::setLinks(const QList<OAIGatewayAccount__links_inner> &_links) {
    m__links = _links;
    m__links_isSet = true;
}

bool OAIPandaGateway::is__links_Set() const{
    return m__links_isSet;
}

bool OAIPandaGateway::is__links_Valid() const{
    return m__links_isValid;
}

QList<QString> OAIPandaGateway::getAcceptedCurrencies() const {
    return m_accepted_currencies;
}
void OAIPandaGateway::setAcceptedCurrencies(const QList<QString> &accepted_currencies) {
    m_accepted_currencies = accepted_currencies;
    m_accepted_currencies_isSet = true;
}

bool OAIPandaGateway::is_accepted_currencies_Set() const{
    return m_accepted_currencies_isSet;
}

bool OAIPandaGateway::is_accepted_currencies_Valid() const{
    return m_accepted_currencies_isValid;
}

OAIAcquirerName OAIPandaGateway::getAcquirerName() const {
    return m_acquirer_name;
}
void OAIPandaGateway::setAcquirerName(const OAIAcquirerName &acquirer_name) {
    m_acquirer_name = acquirer_name;
    m_acquirer_name_isSet = true;
}

bool OAIPandaGateway::is_acquirer_name_Set() const{
    return m_acquirer_name_isSet;
}

bool OAIPandaGateway::is_acquirer_name_Valid() const{
    return m_acquirer_name_isValid;
}

QString OAIPandaGateway::getAdditionalFilters() const {
    return m_additional_filters;
}
void OAIPandaGateway::setAdditionalFilters(const QString &additional_filters) {
    m_additional_filters = additional_filters;
    m_additional_filters_isSet = true;
}

bool OAIPandaGateway::is_additional_filters_Set() const{
    return m_additional_filters_isSet;
}

bool OAIPandaGateway::is_additional_filters_Valid() const{
    return m_additional_filters_isValid;
}

qint32 OAIPandaGateway::getApprovalWindowTtl() const {
    return m_approval_window_ttl;
}
void OAIPandaGateway::setApprovalWindowTtl(const qint32 &approval_window_ttl) {
    m_approval_window_ttl = approval_window_ttl;
    m_approval_window_ttl_isSet = true;
}

bool OAIPandaGateway::is_approval_window_ttl_Set() const{
    return m_approval_window_ttl_isSet;
}

bool OAIPandaGateway::is_approval_window_ttl_Valid() const{
    return m_approval_window_ttl_isValid;
}

QString OAIPandaGateway::getCityField() const {
    return m_city_field;
}
void OAIPandaGateway::setCityField(const QString &city_field) {
    m_city_field = city_field;
    m_city_field_isSet = true;
}

bool OAIPandaGateway::is_city_field_Set() const{
    return m_city_field_isSet;
}

bool OAIPandaGateway::is_city_field_Valid() const{
    return m_city_field_isValid;
}

QDateTime OAIPandaGateway::getCreatedTime() const {
    return m_created_time;
}
void OAIPandaGateway::setCreatedTime(const QDateTime &created_time) {
    m_created_time = created_time;
    m_created_time_isSet = true;
}

bool OAIPandaGateway::is_created_time_Set() const{
    return m_created_time_isSet;
}

bool OAIPandaGateway::is_created_time_Valid() const{
    return m_created_time_isValid;
}

QString OAIPandaGateway::getDccForceCurrency() const {
    return m_dcc_force_currency;
}
void OAIPandaGateway::setDccForceCurrency(const QString &dcc_force_currency) {
    m_dcc_force_currency = dcc_force_currency;
    m_dcc_force_currency_isSet = true;
}

bool OAIPandaGateway::is_dcc_force_currency_Set() const{
    return m_dcc_force_currency_isSet;
}

bool OAIPandaGateway::is_dcc_force_currency_Valid() const{
    return m_dcc_force_currency_isValid;
}

qint32 OAIPandaGateway::getDccMarkup() const {
    return m_dcc_markup;
}
void OAIPandaGateway::setDccMarkup(const qint32 &dcc_markup) {
    m_dcc_markup = dcc_markup;
    m_dcc_markup_isSet = true;
}

bool OAIPandaGateway::is_dcc_markup_Set() const{
    return m_dcc_markup_isSet;
}

bool OAIPandaGateway::is_dcc_markup_Valid() const{
    return m_dcc_markup_isValid;
}

QString OAIPandaGateway::getDescriptor() const {
    return m_descriptor;
}
void OAIPandaGateway::setDescriptor(const QString &descriptor) {
    m_descriptor = descriptor;
    m_descriptor_isSet = true;
}

bool OAIPandaGateway::is_descriptor_Set() const{
    return m_descriptor_isSet;
}

bool OAIPandaGateway::is_descriptor_Valid() const{
    return m_descriptor_isValid;
}

OAIDigitalWallets OAIPandaGateway::getDigitalWallets() const {
    return m_digital_wallets;
}
void OAIPandaGateway::setDigitalWallets(const OAIDigitalWallets &digital_wallets) {
    m_digital_wallets = digital_wallets;
    m_digital_wallets_isSet = true;
}

bool OAIPandaGateway::is_digital_wallets_Set() const{
    return m_digital_wallets_isSet;
}

bool OAIPandaGateway::is_digital_wallets_Valid() const{
    return m_digital_wallets_isValid;
}

bool OAIPandaGateway::isDynamicDescriptor() const {
    return m_dynamic_descriptor;
}
void OAIPandaGateway::setDynamicDescriptor(const bool &dynamic_descriptor) {
    m_dynamic_descriptor = dynamic_descriptor;
    m_dynamic_descriptor_isSet = true;
}

bool OAIPandaGateway::is_dynamic_descriptor_Set() const{
    return m_dynamic_descriptor_isSet;
}

bool OAIPandaGateway::is_dynamic_descriptor_Valid() const{
    return m_dynamic_descriptor_isValid;
}

QList<QString> OAIPandaGateway::getExcludedDccQuoteCurrencies() const {
    return m_excluded_dcc_quote_currencies;
}
void OAIPandaGateway::setExcludedDccQuoteCurrencies(const QList<QString> &excluded_dcc_quote_currencies) {
    m_excluded_dcc_quote_currencies = excluded_dcc_quote_currencies;
    m_excluded_dcc_quote_currencies_isSet = true;
}

bool OAIPandaGateway::is_excluded_dcc_quote_currencies_Set() const{
    return m_excluded_dcc_quote_currencies_isSet;
}

bool OAIPandaGateway::is_excluded_dcc_quote_currencies_Valid() const{
    return m_excluded_dcc_quote_currencies_isValid;
}

OAIGatewayName OAIPandaGateway::getGatewayName() const {
    return m_gateway_name;
}
void OAIPandaGateway::setGatewayName(const OAIGatewayName &gateway_name) {
    m_gateway_name = gateway_name;
    m_gateway_name_isSet = true;
}

bool OAIPandaGateway::is_gateway_name_Set() const{
    return m_gateway_name_isSet;
}

bool OAIPandaGateway::is_gateway_name_Valid() const{
    return m_gateway_name_isValid;
}

QString OAIPandaGateway::getId() const {
    return m_id;
}
void OAIPandaGateway::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIPandaGateway::is_id_Set() const{
    return m_id_isSet;
}

bool OAIPandaGateway::is_id_Valid() const{
    return m_id_isValid;
}

bool OAIPandaGateway::isIsDown() const {
    return m_is_down;
}
void OAIPandaGateway::setIsDown(const bool &is_down) {
    m_is_down = is_down;
    m_is_down_isSet = true;
}

bool OAIPandaGateway::is_is_down_Set() const{
    return m_is_down_isSet;
}

bool OAIPandaGateway::is_is_down_Valid() const{
    return m_is_down_isValid;
}

QString OAIPandaGateway::getMerchantCategoryCode() const {
    return m_merchant_category_code;
}
void OAIPandaGateway::setMerchantCategoryCode(const QString &merchant_category_code) {
    m_merchant_category_code = merchant_category_code;
    m_merchant_category_code_isSet = true;
}

bool OAIPandaGateway::is_merchant_category_code_Set() const{
    return m_merchant_category_code_isSet;
}

bool OAIPandaGateway::is_merchant_category_code_Valid() const{
    return m_merchant_category_code_isValid;
}

OAIPaymentMethod OAIPandaGateway::getMethod() const {
    return m_method;
}
void OAIPandaGateway::setMethod(const OAIPaymentMethod &method) {
    m_method = method;
    m_method_isSet = true;
}

bool OAIPandaGateway::is_method_Set() const{
    return m_method_isSet;
}

bool OAIPandaGateway::is_method_Valid() const{
    return m_method_isValid;
}

double OAIPandaGateway::getMonthlyLimit() const {
    return m_monthly_limit;
}
void OAIPandaGateway::setMonthlyLimit(const double &monthly_limit) {
    m_monthly_limit = monthly_limit;
    m_monthly_limit_isSet = true;
}

bool OAIPandaGateway::is_monthly_limit_Set() const{
    return m_monthly_limit_isSet;
}

bool OAIPandaGateway::is_monthly_limit_Valid() const{
    return m_monthly_limit_isValid;
}

QString OAIPandaGateway::getOrganizationId() const {
    return m_organization_id;
}
void OAIPandaGateway::setOrganizationId(const QString &organization_id) {
    m_organization_id = organization_id;
    m_organization_id_isSet = true;
}

bool OAIPandaGateway::is_organization_id_Set() const{
    return m_organization_id_isSet;
}

bool OAIPandaGateway::is_organization_id_Valid() const{
    return m_organization_id_isValid;
}

QList<OAIPaymentCardBrand> OAIPandaGateway::getPaymentCardSchemes() const {
    return m_payment_card_schemes;
}
void OAIPandaGateway::setPaymentCardSchemes(const QList<OAIPaymentCardBrand> &payment_card_schemes) {
    m_payment_card_schemes = payment_card_schemes;
    m_payment_card_schemes_isSet = true;
}

bool OAIPandaGateway::is_payment_card_schemes_Set() const{
    return m_payment_card_schemes_isSet;
}

bool OAIPandaGateway::is_payment_card_schemes_Valid() const{
    return m_payment_card_schemes_isValid;
}

bool OAIPandaGateway::isReconciliationWindowEnabled() const {
    return m_reconciliation_window_enabled;
}
void OAIPandaGateway::setReconciliationWindowEnabled(const bool &reconciliation_window_enabled) {
    m_reconciliation_window_enabled = reconciliation_window_enabled;
    m_reconciliation_window_enabled_isSet = true;
}

bool OAIPandaGateway::is_reconciliation_window_enabled_Set() const{
    return m_reconciliation_window_enabled_isSet;
}

bool OAIPandaGateway::is_reconciliation_window_enabled_Valid() const{
    return m_reconciliation_window_enabled_isValid;
}

qint32 OAIPandaGateway::getReconciliationWindowTtl() const {
    return m_reconciliation_window_ttl;
}
void OAIPandaGateway::setReconciliationWindowTtl(const qint32 &reconciliation_window_ttl) {
    m_reconciliation_window_ttl = reconciliation_window_ttl;
    m_reconciliation_window_ttl_isSet = true;
}

bool OAIPandaGateway::is_reconciliation_window_ttl_Set() const{
    return m_reconciliation_window_ttl_isSet;
}

bool OAIPandaGateway::is_reconciliation_window_ttl_Valid() const{
    return m_reconciliation_window_ttl_isValid;
}

QString OAIPandaGateway::getStatus() const {
    return m_status;
}
void OAIPandaGateway::setStatus(const QString &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIPandaGateway::is_status_Set() const{
    return m_status_isSet;
}

bool OAIPandaGateway::is_status_Valid() const{
    return m_status_isValid;
}

bool OAIPandaGateway::isSticky() const {
    return m_sticky;
}
void OAIPandaGateway::setSticky(const bool &sticky) {
    m_sticky = sticky;
    m_sticky_isSet = true;
}

bool OAIPandaGateway::is_sticky_Set() const{
    return m_sticky_isSet;
}

bool OAIPandaGateway::is_sticky_Valid() const{
    return m_sticky_isValid;
}

bool OAIPandaGateway::isThreeDSecure() const {
    return m_three_d_secure;
}
void OAIPandaGateway::setThreeDSecure(const bool &three_d_secure) {
    m_three_d_secure = three_d_secure;
    m_three_d_secure_isSet = true;
}

bool OAIPandaGateway::is_three_d_secure_Set() const{
    return m_three_d_secure_isSet;
}

bool OAIPandaGateway::is_three_d_secure_Valid() const{
    return m_three_d_secure_isValid;
}

qint32 OAIPandaGateway::getTimeout() const {
    return m_timeout;
}
void OAIPandaGateway::setTimeout(const qint32 &timeout) {
    m_timeout = timeout;
    m_timeout_isSet = true;
}

bool OAIPandaGateway::is_timeout_Set() const{
    return m_timeout_isSet;
}

bool OAIPandaGateway::is_timeout_Valid() const{
    return m_timeout_isValid;
}

QString OAIPandaGateway::getToken() const {
    return m_token;
}
void OAIPandaGateway::setToken(const QString &token) {
    m_token = token;
    m_token_isSet = true;
}

bool OAIPandaGateway::is_token_Set() const{
    return m_token_isSet;
}

bool OAIPandaGateway::is_token_Valid() const{
    return m_token_isValid;
}

QDateTime OAIPandaGateway::getUpdatedTime() const {
    return m_updated_time;
}
void OAIPandaGateway::setUpdatedTime(const QDateTime &updated_time) {
    m_updated_time = updated_time;
    m_updated_time_isSet = true;
}

bool OAIPandaGateway::is_updated_time_Set() const{
    return m_updated_time_isSet;
}

bool OAIPandaGateway::is_updated_time_Valid() const{
    return m_updated_time_isValid;
}

OAIPandaGateway_allOf_credentials OAIPandaGateway::getCredentials() const {
    return m_credentials;
}
void OAIPandaGateway::setCredentials(const OAIPandaGateway_allOf_credentials &credentials) {
    m_credentials = credentials;
    m_credentials_isSet = true;
}

bool OAIPandaGateway::is_credentials_Set() const{
    return m_credentials_isSet;
}

bool OAIPandaGateway::is_credentials_Valid() const{
    return m_credentials_isValid;
}

bool OAIPandaGateway::isSet() const {
...
bool OAIPandaGateway::isValid() const {
