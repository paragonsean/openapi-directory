...
/*
 * OAICommonTransaction.h
 *
 * 
 */

#ifndef OAICommonTransaction_H
#define OAICommonTransaction_H
...
class OAIInstrumentReference;

class OAICommonTransaction : public OAIObject {
public:
    OAICommonTransaction();
    OAICommonTransaction(QString json);
    ~OAICommonTransaction() override;
    ...
    OAIInstrumentReference getPaymentInstrument() const;
    void setPaymentInstrument(const OAIInstrumentReference &payment_instrument);
...
private:
    ...
    OAIInstrumentReference m_payment_instrument;
...
Q_DECLARE_METATYPE(OpenAPI::OAICommonTransaction)

#endif // OAICommonTransaction_H
