...
#include "OAIPayPal_allOf_settings.h"
...
class OAIPayPal_allOf_settings;

class OAIPayPal : public OAIObject {
public:
    OAIPayPal();
    OAIPayPal(QString json);
    ~OAIPayPal() override;
    ...
    OAIPayPal_allOf_settings getSettings() const;
    void setSettings(const OAIPayPal_allOf_settings &settings);
...
private:
    ...
    OAIPayPal_allOf_settings m_settings;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPayPal)
