...
OAISeamlessChex::OAISeamlessChex(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISeamlessChex::OAISeamlessChex() {
    this->initializeModel();
}

OAISeamlessChex::~OAISeamlessChex() {}

void OAISeamlessChex::initializeModel() {
...
void OAISeamlessChex::fromJson(QString jsonString) {
...
void OAISeamlessChex::fromJsonObject(QJsonObject json) {
...
QString OAISeamlessChex::asJson() const {
...
QJsonObject OAISeamlessChex::asJsonObject() const {
    QJsonObject obj;
    if (m__links.size() > 0) {
...
QList<OAIGatewayAccount__links_inner> OAISeamlessChex::getLinks() const {
    return m__links;
}
void OAISeamlessChex::setLinks(const QList<OAIGatewayAccount__links_inner> &_links) {
    m__links = _links;
    m__links_isSet = true;
}

bool OAISeamlessChex::is__links_Set() const{
    return m__links_isSet;
}

bool OAISeamlessChex::is__links_Valid() const{
    return m__links_isValid;
}

QList<QString> OAISeamlessChex::getAcceptedCurrencies() const {
    return m_accepted_currencies;
}
void OAISeamlessChex::setAcceptedCurrencies(const QList<QString> &accepted_currencies) {
    m_accepted_currencies = accepted_currencies;
    m_accepted_currencies_isSet = true;
}

bool OAISeamlessChex::is_accepted_currencies_Set() const{
    return m_accepted_currencies_isSet;
}

bool OAISeamlessChex::is_accepted_currencies_Valid() const{
    return m_accepted_currencies_isValid;
}

OAIAcquirerName OAISeamlessChex::getAcquirerName() const {
    return m_acquirer_name;
}
void OAISeamlessChex::setAcquirerName(const OAIAcquirerName &acquirer_name) {
    m_acquirer_name = acquirer_name;
    m_acquirer_name_isSet = true;
}

bool OAISeamlessChex::is_acquirer_name_Set() const{
    return m_acquirer_name_isSet;
}

bool OAISeamlessChex::is_acquirer_name_Valid() const{
    return m_acquirer_name_isValid;
}

QString OAISeamlessChex::getAdditionalFilters() const {
    return m_additional_filters;
}
void OAISeamlessChex::setAdditionalFilters(const QString &additional_filters) {
    m_additional_filters = additional_filters;
    m_additional_filters_isSet = true;
}

bool OAISeamlessChex::is_additional_filters_Set() const{
    return m_additional_filters_isSet;
}

bool OAISeamlessChex::is_additional_filters_Valid() const{
    return m_additional_filters_isValid;
}

qint32 OAISeamlessChex::getApprovalWindowTtl() const {
    return m_approval_window_ttl;
}
void OAISeamlessChex::setApprovalWindowTtl(const qint32 &approval_window_ttl) {
    m_approval_window_ttl = approval_window_ttl;
    m_approval_window_ttl_isSet = true;
}

bool OAISeamlessChex::is_approval_window_ttl_Set() const{
    return m_approval_window_ttl_isSet;
}

bool OAISeamlessChex::is_approval_window_ttl_Valid() const{
    return m_approval_window_ttl_isValid;
}

QString OAISeamlessChex::getCityField() const {
    return m_city_field;
}
void OAISeamlessChex::setCityField(const QString &city_field) {
    m_city_field = city_field;
    m_city_field_isSet = true;
}

bool OAISeamlessChex::is_city_field_Set() const{
    return m_city_field_isSet;
}

bool OAISeamlessChex::is_city_field_Valid() const{
    return m_city_field_isValid;
}

QDateTime OAISeamlessChex::getCreatedTime() const {
    return m_created_time;
}
void OAISeamlessChex::setCreatedTime(const QDateTime &created_time) {
    m_created_time = created_time;
    m_created_time_isSet = true;
}

bool OAISeamlessChex::is_created_time_Set() const{
    return m_created_time_isSet;
}

bool OAISeamlessChex::is_created_time_Valid() const{
    return m_created_time_isValid;
}

QString OAISeamlessChex::getDccForceCurrency() const {
    return m_dcc_force_currency;
}
void OAISeamlessChex::setDccForceCurrency(const QString &dcc_force_currency) {
    m_dcc_force_currency = dcc_force_currency;
    m_dcc_force_currency_isSet = true;
}

bool OAISeamlessChex::is_dcc_force_currency_Set() const{
    return m_dcc_force_currency_isSet;
}

bool OAISeamlessChex::is_dcc_force_currency_Valid() const{
    return m_dcc_force_currency_isValid;
}

qint32 OAISeamlessChex::getDccMarkup() const {
    return m_dcc_markup;
}
void OAISeamlessChex::setDccMarkup(const qint32 &dcc_markup) {
    m_dcc_markup = dcc_markup;
    m_dcc_markup_isSet = true;
}

bool OAISeamlessChex::is_dcc_markup_Set() const{
    return m_dcc_markup_isSet;
}

bool OAISeamlessChex::is_dcc_markup_Valid() const{
    return m_dcc_markup_isValid;
}

QString OAISeamlessChex::getDescriptor() const {
    return m_descriptor;
}
void OAISeamlessChex::setDescriptor(const QString &descriptor) {
    m_descriptor = descriptor;
    m_descriptor_isSet = true;
}

bool OAISeamlessChex::is_descriptor_Set() const{
    return m_descriptor_isSet;
}

bool OAISeamlessChex::is_descriptor_Valid() const{
    return m_descriptor_isValid;
}

OAIDigitalWallets OAISeamlessChex::getDigitalWallets() const {
    return m_digital_wallets;
}
void OAISeamlessChex::setDigitalWallets(const OAIDigitalWallets &digital_wallets) {
    m_digital_wallets = digital_wallets;
    m_digital_wallets_isSet = true;
}

bool OAISeamlessChex::is_digital_wallets_Set() const{
    return m_digital_wallets_isSet;
}

bool OAISeamlessChex::is_digital_wallets_Valid() const{
    return m_digital_wallets_isValid;
}

bool OAISeamlessChex::isDynamicDescriptor() const {
    return m_dynamic_descriptor;
}
void OAISeamlessChex::setDynamicDescriptor(const bool &dynamic_descriptor) {
    m_dynamic_descriptor = dynamic_descriptor;
    m_dynamic_descriptor_isSet = true;
}

bool OAISeamlessChex::is_dynamic_descriptor_Set() const{
    return m_dynamic_descriptor_isSet;
}

bool OAISeamlessChex::is_dynamic_descriptor_Valid() const{
    return m_dynamic_descriptor_isValid;
}

QList<QString> OAISeamlessChex::getExcludedDccQuoteCurrencies() const {
    return m_excluded_dcc_quote_currencies;
}
void OAISeamlessChex::setExcludedDccQuoteCurrencies(const QList<QString> &excluded_dcc_quote_currencies) {
    m_excluded_dcc_quote_currencies = excluded_dcc_quote_currencies;
    m_excluded_dcc_quote_currencies_isSet = true;
}

bool OAISeamlessChex::is_excluded_dcc_quote_currencies_Set() const{
    return m_excluded_dcc_quote_currencies_isSet;
}

bool OAISeamlessChex::is_excluded_dcc_quote_currencies_Valid() const{
    return m_excluded_dcc_quote_currencies_isValid;
}

OAIGatewayName OAISeamlessChex::getGatewayName() const {
    return m_gateway_name;
}
void OAISeamlessChex::setGatewayName(const OAIGatewayName &gateway_name) {
    m_gateway_name = gateway_name;
    m_gateway_name_isSet = true;
}

bool OAISeamlessChex::is_gateway_name_Set() const{
    return m_gateway_name_isSet;
}

bool OAISeamlessChex::is_gateway_name_Valid() const{
    return m_gateway_name_isValid;
}

QString OAISeamlessChex::getId() const {
    return m_id;
}
void OAISeamlessChex::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAISeamlessChex::is_id_Set() const{
    return m_id_isSet;
}

bool OAISeamlessChex::is_id_Valid() const{
    return m_id_isValid;
}

bool OAISeamlessChex::isIsDown() const {
    return m_is_down;
}
void OAISeamlessChex::setIsDown(const bool &is_down) {
    m_is_down = is_down;
    m_is_down_isSet = true;
}

bool OAISeamlessChex::is_is_down_Set() const{
    return m_is_down_isSet;
}

bool OAISeamlessChex::is_is_down_Valid() const{
    return m_is_down_isValid;
}

QString OAISeamlessChex::getMerchantCategoryCode() const {
    return m_merchant_category_code;
}
void OAISeamlessChex::setMerchantCategoryCode(const QString &merchant_category_code) {
    m_merchant_category_code = merchant_category_code;
    m_merchant_category_code_isSet = true;
}

bool OAISeamlessChex::is_merchant_category_code_Set() const{
    return m_merchant_category_code_isSet;
}

bool OAISeamlessChex::is_merchant_category_code_Valid() const{
    return m_merchant_category_code_isValid;
}

OAIPaymentMethod OAISeamlessChex::getMethod() const {
    return m_method;
}
void OAISeamlessChex::setMethod(const OAIPaymentMethod &method) {
    m_method = method;
    m_method_isSet = true;
}

bool OAISeamlessChex::is_method_Set() const{
    return m_method_isSet;
}

bool OAISeamlessChex::is_method_Valid() const{
    return m_method_isValid;
}

double OAISeamlessChex::getMonthlyLimit() const {
    return m_monthly_limit;
}
void OAISeamlessChex::setMonthlyLimit(const double &monthly_limit) {
    m_monthly_limit = monthly_limit;
    m_monthly_limit_isSet = true;
}

bool OAISeamlessChex::is_monthly_limit_Set() const{
    return m_monthly_limit_isSet;
}

bool OAISeamlessChex::is_monthly_limit_Valid() const{
    return m_monthly_limit_isValid;
}

QString OAISeamlessChex::getOrganizationId() const {
    return m_organization_id;
}
void OAISeamlessChex::setOrganizationId(const QString &organization_id) {
    m_organization_id = organization_id;
    m_organization_id_isSet = true;
}

bool OAISeamlessChex::is_organization_id_Set() const{
    return m_organization_id_isSet;
}

bool OAISeamlessChex::is_organization_id_Valid() const{
    return m_organization_id_isValid;
}

QList<OAIPaymentCardBrand> OAISeamlessChex::getPaymentCardSchemes() const {
    return m_payment_card_schemes;
}
void OAISeamlessChex::setPaymentCardSchemes(const QList<OAIPaymentCardBrand> &payment_card_schemes) {
    m_payment_card_schemes = payment_card_schemes;
    m_payment_card_schemes_isSet = true;
}

bool OAISeamlessChex::is_payment_card_schemes_Set() const{
    return m_payment_card_schemes_isSet;
}

bool OAISeamlessChex::is_payment_card_schemes_Valid() const{
    return m_payment_card_schemes_isValid;
}

bool OAISeamlessChex::isReconciliationWindowEnabled() const {
    return m_reconciliation_window_enabled;
}
void OAISeamlessChex::setReconciliationWindowEnabled(const bool &reconciliation_window_enabled) {
    m_reconciliation_window_enabled = reconciliation_window_enabled;
    m_reconciliation_window_enabled_isSet = true;
}

bool OAISeamlessChex::is_reconciliation_window_enabled_Set() const{
    return m_reconciliation_window_enabled_isSet;
}

bool OAISeamlessChex::is_reconciliation_window_enabled_Valid() const{
    return m_reconciliation_window_enabled_isValid;
}

qint32 OAISeamlessChex::getReconciliationWindowTtl() const {
    return m_reconciliation_window_ttl;
}
void OAISeamlessChex::setReconciliationWindowTtl(const qint32 &reconciliation_window_ttl) {
    m_reconciliation_window_ttl = reconciliation_window_ttl;
    m_reconciliation_window_ttl_isSet = true;
}

bool OAISeamlessChex::is_reconciliation_window_ttl_Set() const{
    return m_reconciliation_window_ttl_isSet;
}

bool OAISeamlessChex::is_reconciliation_window_ttl_Valid() const{
    return m_reconciliation_window_ttl_isValid;
}

QString OAISeamlessChex::getStatus() const {
    return m_status;
}
void OAISeamlessChex::setStatus(const QString &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAISeamlessChex::is_status_Set() const{
    return m_status_isSet;
}

bool OAISeamlessChex::is_status_Valid() const{
    return m_status_isValid;
}

bool OAISeamlessChex::isSticky() const {
    return m_sticky;
}
void OAISeamlessChex::setSticky(const bool &sticky) {
    m_sticky = sticky;
    m_sticky_isSet = true;
}

bool OAISeamlessChex::is_sticky_Set() const{
    return m_sticky_isSet;
}

bool OAISeamlessChex::is_sticky_Valid() const{
    return m_sticky_isValid;
}

bool OAISeamlessChex::isThreeDSecure() const {
    return m_three_d_secure;
}
void OAISeamlessChex::setThreeDSecure(const bool &three_d_secure) {
    m_three_d_secure = three_d_secure;
    m_three_d_secure_isSet = true;
}

bool OAISeamlessChex::is_three_d_secure_Set() const{
    return m_three_d_secure_isSet;
}

bool OAISeamlessChex::is_three_d_secure_Valid() const{
    return m_three_d_secure_isValid;
}

qint32 OAISeamlessChex::getTimeout() const {
    return m_timeout;
}
void OAISeamlessChex::setTimeout(const qint32 &timeout) {
    m_timeout = timeout;
    m_timeout_isSet = true;
}

bool OAISeamlessChex::is_timeout_Set() const{
    return m_timeout_isSet;
}

bool OAISeamlessChex::is_timeout_Valid() const{
    return m_timeout_isValid;
}

QString OAISeamlessChex::getToken() const {
    return m_token;
}
void OAISeamlessChex::setToken(const QString &token) {
    m_token = token;
    m_token_isSet = true;
}

bool OAISeamlessChex::is_token_Set() const{
    return m_token_isSet;
}

bool OAISeamlessChex::is_token_Valid() const{
    return m_token_isValid;
}

QDateTime OAISeamlessChex::getUpdatedTime() const {
    return m_updated_time;
}
void OAISeamlessChex::setUpdatedTime(const QDateTime &updated_time) {
    m_updated_time = updated_time;
    m_updated_time_isSet = true;
}

bool OAISeamlessChex::is_updated_time_Set() const{
    return m_updated_time_isSet;
}

bool OAISeamlessChex::is_updated_time_Valid() const{
    return m_updated_time_isValid;
}

OAISeamlessChex_allOf_credentials OAISeamlessChex::getCredentials() const {
    return m_credentials;
}
void OAISeamlessChex::setCredentials(const OAISeamlessChex_allOf_credentials &credentials) {
    m_credentials = credentials;
    m_credentials_isSet = true;
}

bool OAISeamlessChex::is_credentials_Set() const{
    return m_credentials_isSet;
}

bool OAISeamlessChex::is_credentials_Valid() const{
    return m_credentials_isValid;
}

bool OAISeamlessChex::isSet() const {
...
bool OAISeamlessChex::isValid() const {
