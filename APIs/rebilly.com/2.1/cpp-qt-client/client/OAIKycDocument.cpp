...
OAIKycDocument::OAIKycDocument(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIKycDocument::OAIKycDocument() {
    this->initializeModel();
}

OAIKycDocument::~OAIKycDocument() {}

void OAIKycDocument::initializeModel() {
...
void OAIKycDocument::fromJson(QString jsonString) {
...
void OAIKycDocument::fromJsonObject(QJsonObject json) {
...
QString OAIKycDocument::asJson() const {
...
QJsonObject OAIKycDocument::asJsonObject() const {
    QJsonObject obj;
    if (m__links.size() > 0) {
...
QList<OAICommonKycDocument__links_inner> OAIKycDocument::getLinks() const {
    return m__links;
}
void OAIKycDocument::setLinks(const QList<OAICommonKycDocument__links_inner> &_links) {
    m__links = _links;
    m__links_isSet = true;
}

bool OAIKycDocument::is__links_Set() const{
    return m__links_isSet;
}

bool OAIKycDocument::is__links_Valid() const{
    return m__links_isValid;
}

QDateTime OAIKycDocument::getCreatedTime() const {
    return m_created_time;
}
void OAIKycDocument::setCreatedTime(const QDateTime &created_time) {
    m_created_time = created_time;
    m_created_time_isSet = true;
}

bool OAIKycDocument::is_created_time_Set() const{
    return m_created_time_isSet;
}

bool OAIKycDocument::is_created_time_Valid() const{
    return m_created_time_isValid;
}

OAIKycDocumentSubtypes OAIKycDocument::getDocumentSubtype() const {
    return m_document_subtype;
}
void OAIKycDocument::setDocumentSubtype(const OAIKycDocumentSubtypes &document_subtype) {
    m_document_subtype = document_subtype;
    m_document_subtype_isSet = true;
}

bool OAIKycDocument::is_document_subtype_Set() const{
    return m_document_subtype_isSet;
}

bool OAIKycDocument::is_document_subtype_Valid() const{
    return m_document_subtype_isValid;
}

OAIKycDocumentTypes OAIKycDocument::getDocumentType() const {
    return m_document_type;
}
void OAIKycDocument::setDocumentType(const OAIKycDocumentTypes &document_type) {
    m_document_type = document_type;
    m_document_type_isSet = true;
}

bool OAIKycDocument::is_document_type_Set() const{
    return m_document_type_isSet;
}

bool OAIKycDocument::is_document_type_Valid() const{
    return m_document_type_isValid;
}

QString OAIKycDocument::getFileId() const {
    return m_file_id;
}
void OAIKycDocument::setFileId(const QString &file_id) {
    m_file_id = file_id;
    m_file_id_isSet = true;
}

bool OAIKycDocument::is_file_id_Set() const{
    return m_file_id_isSet;
}

bool OAIKycDocument::is_file_id_Valid() const{
    return m_file_id_isValid;
}

QList<QString> OAIKycDocument::getFileIds() const {
    return m_file_ids;
}
void OAIKycDocument::setFileIds(const QList<QString> &file_ids) {
    m_file_ids = file_ids;
    m_file_ids_isSet = true;
}

bool OAIKycDocument::is_file_ids_Set() const{
    return m_file_ids_isSet;
}

bool OAIKycDocument::is_file_ids_Valid() const{
    return m_file_ids_isValid;
}

QString OAIKycDocument::getId() const {
    return m_id;
}
void OAIKycDocument::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIKycDocument::is_id_Set() const{
    return m_id_isSet;
}

bool OAIKycDocument::is_id_Valid() const{
    return m_id_isValid;
}

QDateTime OAIKycDocument::getProcessedTime() const {
    return m_processed_time;
}
void OAIKycDocument::setProcessedTime(const QDateTime &processed_time) {
    m_processed_time = processed_time;
    m_processed_time_isSet = true;
}

bool OAIKycDocument::is_processed_time_Set() const{
    return m_processed_time_isSet;
}

bool OAIKycDocument::is_processed_time_Valid() const{
    return m_processed_time_isValid;
}

OAIKycDocumentRejection OAIKycDocument::getRejectionReason() const {
    return m_rejection_reason;
}
void OAIKycDocument::setRejectionReason(const OAIKycDocumentRejection &rejection_reason) {
    m_rejection_reason = rejection_reason;
    m_rejection_reason_isSet = true;
}

bool OAIKycDocument::is_rejection_reason_Set() const{
    return m_rejection_reason_isSet;
}

bool OAIKycDocument::is_rejection_reason_Valid() const{
    return m_rejection_reason_isValid;
}

QString OAIKycDocument::getRequestId() const {
    return m_request_id;
}
void OAIKycDocument::setRequestId(const QString &request_id) {
    m_request_id = request_id;
    m_request_id_isSet = true;
}

bool OAIKycDocument::is_request_id_Set() const{
    return m_request_id_isSet;
}

bool OAIKycDocument::is_request_id_Valid() const{
    return m_request_id_isValid;
}

QString OAIKycDocument::getStatus() const {
    return m_status;
}
void OAIKycDocument::setStatus(const QString &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIKycDocument::is_status_Set() const{
    return m_status_isSet;
}

bool OAIKycDocument::is_status_Valid() const{
    return m_status_isValid;
}

QDateTime OAIKycDocument::getUpdatedTime() const {
    return m_updated_time;
}
void OAIKycDocument::setUpdatedTime(const QDateTime &updated_time) {
    m_updated_time = updated_time;
    m_updated_time_isSet = true;
}

bool OAIKycDocument::is_updated_time_Set() const{
    return m_updated_time_isSet;
}

bool OAIKycDocument::is_updated_time_Valid() const{
    return m_updated_time_isValid;
}

QString OAIKycDocument::getCustomerId() const {
    return m_customer_id;
}
void OAIKycDocument::setCustomerId(const QString &customer_id) {
    m_customer_id = customer_id;
    m_customer_id_isSet = true;
}

bool OAIKycDocument::is_customer_id_Set() const{
    return m_customer_id_isSet;
}

bool OAIKycDocument::is_customer_id_Valid() const{
    return m_customer_id_isValid;
}

qint32 OAIKycDocument::getMatchLevel() const {
    return m_match_level;
}
void OAIKycDocument::setMatchLevel(const qint32 &match_level) {
    m_match_level = match_level;
    m_match_level_isSet = true;
}

bool OAIKycDocument::is_match_level_Set() const{
    return m_match_level_isSet;
}

bool OAIKycDocument::is_match_level_Valid() const{
    return m_match_level_isValid;
}

QString OAIKycDocument::getNotes() const {
    return m_notes;
}
void OAIKycDocument::setNotes(const QString &notes) {
    m_notes = notes;
    m_notes_isSet = true;
}

bool OAIKycDocument::is_notes_Set() const{
    return m_notes_isSet;
}

bool OAIKycDocument::is_notes_Valid() const{
    return m_notes_isValid;
}

QString OAIKycDocument::getReason() const {
    return m_reason;
}
void OAIKycDocument::setReason(const QString &reason) {
    m_reason = reason;
    m_reason_isSet = true;
}

bool OAIKycDocument::is_reason_Set() const{
    return m_reason_isSet;
}

bool OAIKycDocument::is_reason_Valid() const{
    return m_reason_isValid;
}

QDateTime OAIKycDocument::getReviewTime() const {
    return m_review_time;
}
void OAIKycDocument::setReviewTime(const QDateTime &review_time) {
    m_review_time = review_time;
    m_review_time_isSet = true;
}

bool OAIKycDocument::is_review_time_Set() const{
    return m_review_time_isSet;
}

bool OAIKycDocument::is_review_time_Valid() const{
    return m_review_time_isValid;
}

QString OAIKycDocument::getReviewerId() const {
    return m_reviewer_id;
}
void OAIKycDocument::setReviewerId(const QString &reviewer_id) {
    m_reviewer_id = reviewer_id;
    m_reviewer_id_isSet = true;
}

bool OAIKycDocument::is_reviewer_id_Set() const{
    return m_reviewer_id_isSet;
}

bool OAIKycDocument::is_reviewer_id_Valid() const{
    return m_reviewer_id_isValid;
}

QString OAIKycDocument::getReviewerName() const {
    return m_reviewer_name;
}
void OAIKycDocument::setReviewerName(const QString &reviewer_name) {
    m_reviewer_name = reviewer_name;
    m_reviewer_name_isSet = true;
}

bool OAIKycDocument::is_reviewer_name_Set() const{
    return m_reviewer_name_isSet;
}

bool OAIKycDocument::is_reviewer_name_Valid() const{
    return m_reviewer_name_isValid;
}

bool OAIKycDocument::isSet() const {
...
bool OAIKycDocument::isValid() const {
