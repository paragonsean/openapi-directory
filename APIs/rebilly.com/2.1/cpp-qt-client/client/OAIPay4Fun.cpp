...
OAIPay4Fun::OAIPay4Fun(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPay4Fun::OAIPay4Fun() {
    this->initializeModel();
}

OAIPay4Fun::~OAIPay4Fun() {}

void OAIPay4Fun::initializeModel() {
...
void OAIPay4Fun::fromJson(QString jsonString) {
...
void OAIPay4Fun::fromJsonObject(QJsonObject json) {
...
QString OAIPay4Fun::asJson() const {
...
QJsonObject OAIPay4Fun::asJsonObject() const {
    QJsonObject obj;
    if (m__links.size() > 0) {
...
QList<OAIGatewayAccount__links_inner> OAIPay4Fun::getLinks() const {
    return m__links;
}
void OAIPay4Fun::setLinks(const QList<OAIGatewayAccount__links_inner> &_links) {
    m__links = _links;
    m__links_isSet = true;
}

bool OAIPay4Fun::is__links_Set() const{
    return m__links_isSet;
}

bool OAIPay4Fun::is__links_Valid() const{
    return m__links_isValid;
}

QList<QString> OAIPay4Fun::getAcceptedCurrencies() const {
    return m_accepted_currencies;
}
void OAIPay4Fun::setAcceptedCurrencies(const QList<QString> &accepted_currencies) {
    m_accepted_currencies = accepted_currencies;
    m_accepted_currencies_isSet = true;
}

bool OAIPay4Fun::is_accepted_currencies_Set() const{
    return m_accepted_currencies_isSet;
}

bool OAIPay4Fun::is_accepted_currencies_Valid() const{
    return m_accepted_currencies_isValid;
}

OAIAcquirerName OAIPay4Fun::getAcquirerName() const {
    return m_acquirer_name;
}
void OAIPay4Fun::setAcquirerName(const OAIAcquirerName &acquirer_name) {
    m_acquirer_name = acquirer_name;
    m_acquirer_name_isSet = true;
}

bool OAIPay4Fun::is_acquirer_name_Set() const{
    return m_acquirer_name_isSet;
}

bool OAIPay4Fun::is_acquirer_name_Valid() const{
    return m_acquirer_name_isValid;
}

QString OAIPay4Fun::getAdditionalFilters() const {
    return m_additional_filters;
}
void OAIPay4Fun::setAdditionalFilters(const QString &additional_filters) {
    m_additional_filters = additional_filters;
    m_additional_filters_isSet = true;
}

bool OAIPay4Fun::is_additional_filters_Set() const{
    return m_additional_filters_isSet;
}

bool OAIPay4Fun::is_additional_filters_Valid() const{
    return m_additional_filters_isValid;
}

qint32 OAIPay4Fun::getApprovalWindowTtl() const {
    return m_approval_window_ttl;
}
void OAIPay4Fun::setApprovalWindowTtl(const qint32 &approval_window_ttl) {
    m_approval_window_ttl = approval_window_ttl;
    m_approval_window_ttl_isSet = true;
}

bool OAIPay4Fun::is_approval_window_ttl_Set() const{
    return m_approval_window_ttl_isSet;
}

bool OAIPay4Fun::is_approval_window_ttl_Valid() const{
    return m_approval_window_ttl_isValid;
}

QString OAIPay4Fun::getCityField() const {
    return m_city_field;
}
void OAIPay4Fun::setCityField(const QString &city_field) {
    m_city_field = city_field;
    m_city_field_isSet = true;
}

bool OAIPay4Fun::is_city_field_Set() const{
    return m_city_field_isSet;
}

bool OAIPay4Fun::is_city_field_Valid() const{
    return m_city_field_isValid;
}

QDateTime OAIPay4Fun::getCreatedTime() const {
    return m_created_time;
}
void OAIPay4Fun::setCreatedTime(const QDateTime &created_time) {
    m_created_time = created_time;
    m_created_time_isSet = true;
}

bool OAIPay4Fun::is_created_time_Set() const{
    return m_created_time_isSet;
}

bool OAIPay4Fun::is_created_time_Valid() const{
    return m_created_time_isValid;
}

QString OAIPay4Fun::getDccForceCurrency() const {
    return m_dcc_force_currency;
}
void OAIPay4Fun::setDccForceCurrency(const QString &dcc_force_currency) {
    m_dcc_force_currency = dcc_force_currency;
    m_dcc_force_currency_isSet = true;
}

bool OAIPay4Fun::is_dcc_force_currency_Set() const{
    return m_dcc_force_currency_isSet;
}

bool OAIPay4Fun::is_dcc_force_currency_Valid() const{
    return m_dcc_force_currency_isValid;
}

qint32 OAIPay4Fun::getDccMarkup() const {
    return m_dcc_markup;
}
void OAIPay4Fun::setDccMarkup(const qint32 &dcc_markup) {
    m_dcc_markup = dcc_markup;
    m_dcc_markup_isSet = true;
}

bool OAIPay4Fun::is_dcc_markup_Set() const{
    return m_dcc_markup_isSet;
}

bool OAIPay4Fun::is_dcc_markup_Valid() const{
    return m_dcc_markup_isValid;
}

QString OAIPay4Fun::getDescriptor() const {
    return m_descriptor;
}
void OAIPay4Fun::setDescriptor(const QString &descriptor) {
    m_descriptor = descriptor;
    m_descriptor_isSet = true;
}

bool OAIPay4Fun::is_descriptor_Set() const{
    return m_descriptor_isSet;
}

bool OAIPay4Fun::is_descriptor_Valid() const{
    return m_descriptor_isValid;
}

OAIDigitalWallets OAIPay4Fun::getDigitalWallets() const {
    return m_digital_wallets;
}
void OAIPay4Fun::setDigitalWallets(const OAIDigitalWallets &digital_wallets) {
    m_digital_wallets = digital_wallets;
    m_digital_wallets_isSet = true;
}

bool OAIPay4Fun::is_digital_wallets_Set() const{
    return m_digital_wallets_isSet;
}

bool OAIPay4Fun::is_digital_wallets_Valid() const{
    return m_digital_wallets_isValid;
}

bool OAIPay4Fun::isDynamicDescriptor() const {
    return m_dynamic_descriptor;
}
void OAIPay4Fun::setDynamicDescriptor(const bool &dynamic_descriptor) {
    m_dynamic_descriptor = dynamic_descriptor;
    m_dynamic_descriptor_isSet = true;
}

bool OAIPay4Fun::is_dynamic_descriptor_Set() const{
    return m_dynamic_descriptor_isSet;
}

bool OAIPay4Fun::is_dynamic_descriptor_Valid() const{
    return m_dynamic_descriptor_isValid;
}

QList<QString> OAIPay4Fun::getExcludedDccQuoteCurrencies() const {
    return m_excluded_dcc_quote_currencies;
}
void OAIPay4Fun::setExcludedDccQuoteCurrencies(const QList<QString> &excluded_dcc_quote_currencies) {
    m_excluded_dcc_quote_currencies = excluded_dcc_quote_currencies;
    m_excluded_dcc_quote_currencies_isSet = true;
}

bool OAIPay4Fun::is_excluded_dcc_quote_currencies_Set() const{
    return m_excluded_dcc_quote_currencies_isSet;
}

bool OAIPay4Fun::is_excluded_dcc_quote_currencies_Valid() const{
    return m_excluded_dcc_quote_currencies_isValid;
}

OAIGatewayName OAIPay4Fun::getGatewayName() const {
    return m_gateway_name;
}
void OAIPay4Fun::setGatewayName(const OAIGatewayName &gateway_name) {
    m_gateway_name = gateway_name;
    m_gateway_name_isSet = true;
}

bool OAIPay4Fun::is_gateway_name_Set() const{
    return m_gateway_name_isSet;
}

bool OAIPay4Fun::is_gateway_name_Valid() const{
    return m_gateway_name_isValid;
}

QString OAIPay4Fun::getId() const {
    return m_id;
}
void OAIPay4Fun::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIPay4Fun::is_id_Set() const{
    return m_id_isSet;
}

bool OAIPay4Fun::is_id_Valid() const{
    return m_id_isValid;
}

bool OAIPay4Fun::isIsDown() const {
    return m_is_down;
}
void OAIPay4Fun::setIsDown(const bool &is_down) {
    m_is_down = is_down;
    m_is_down_isSet = true;
}

bool OAIPay4Fun::is_is_down_Set() const{
    return m_is_down_isSet;
}

bool OAIPay4Fun::is_is_down_Valid() const{
    return m_is_down_isValid;
}

QString OAIPay4Fun::getMerchantCategoryCode() const {
    return m_merchant_category_code;
}
void OAIPay4Fun::setMerchantCategoryCode(const QString &merchant_category_code) {
    m_merchant_category_code = merchant_category_code;
    m_merchant_category_code_isSet = true;
}

bool OAIPay4Fun::is_merchant_category_code_Set() const{
    return m_merchant_category_code_isSet;
}

bool OAIPay4Fun::is_merchant_category_code_Valid() const{
    return m_merchant_category_code_isValid;
}

OAIPaymentMethod OAIPay4Fun::getMethod() const {
    return m_method;
}
void OAIPay4Fun::setMethod(const OAIPaymentMethod &method) {
    m_method = method;
    m_method_isSet = true;
}

bool OAIPay4Fun::is_method_Set() const{
    return m_method_isSet;
}

bool OAIPay4Fun::is_method_Valid() const{
    return m_method_isValid;
}

double OAIPay4Fun::getMonthlyLimit() const {
    return m_monthly_limit;
}
void OAIPay4Fun::setMonthlyLimit(const double &monthly_limit) {
    m_monthly_limit = monthly_limit;
    m_monthly_limit_isSet = true;
}

bool OAIPay4Fun::is_monthly_limit_Set() const{
    return m_monthly_limit_isSet;
}

bool OAIPay4Fun::is_monthly_limit_Valid() const{
    return m_monthly_limit_isValid;
}

QString OAIPay4Fun::getOrganizationId() const {
    return m_organization_id;
}
void OAIPay4Fun::setOrganizationId(const QString &organization_id) {
    m_organization_id = organization_id;
    m_organization_id_isSet = true;
}

bool OAIPay4Fun::is_organization_id_Set() const{
    return m_organization_id_isSet;
}

bool OAIPay4Fun::is_organization_id_Valid() const{
    return m_organization_id_isValid;
}

QList<OAIPaymentCardBrand> OAIPay4Fun::getPaymentCardSchemes() const {
    return m_payment_card_schemes;
}
void OAIPay4Fun::setPaymentCardSchemes(const QList<OAIPaymentCardBrand> &payment_card_schemes) {
    m_payment_card_schemes = payment_card_schemes;
    m_payment_card_schemes_isSet = true;
}

bool OAIPay4Fun::is_payment_card_schemes_Set() const{
    return m_payment_card_schemes_isSet;
}

bool OAIPay4Fun::is_payment_card_schemes_Valid() const{
    return m_payment_card_schemes_isValid;
}

bool OAIPay4Fun::isReconciliationWindowEnabled() const {
    return m_reconciliation_window_enabled;
}
void OAIPay4Fun::setReconciliationWindowEnabled(const bool &reconciliation_window_enabled) {
    m_reconciliation_window_enabled = reconciliation_window_enabled;
    m_reconciliation_window_enabled_isSet = true;
}

bool OAIPay4Fun::is_reconciliation_window_enabled_Set() const{
    return m_reconciliation_window_enabled_isSet;
}

bool OAIPay4Fun::is_reconciliation_window_enabled_Valid() const{
    return m_reconciliation_window_enabled_isValid;
}

qint32 OAIPay4Fun::getReconciliationWindowTtl() const {
    return m_reconciliation_window_ttl;
}
void OAIPay4Fun::setReconciliationWindowTtl(const qint32 &reconciliation_window_ttl) {
    m_reconciliation_window_ttl = reconciliation_window_ttl;
    m_reconciliation_window_ttl_isSet = true;
}

bool OAIPay4Fun::is_reconciliation_window_ttl_Set() const{
    return m_reconciliation_window_ttl_isSet;
}

bool OAIPay4Fun::is_reconciliation_window_ttl_Valid() const{
    return m_reconciliation_window_ttl_isValid;
}

QString OAIPay4Fun::getStatus() const {
    return m_status;
}
void OAIPay4Fun::setStatus(const QString &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIPay4Fun::is_status_Set() const{
    return m_status_isSet;
}

bool OAIPay4Fun::is_status_Valid() const{
    return m_status_isValid;
}

bool OAIPay4Fun::isSticky() const {
    return m_sticky;
}
void OAIPay4Fun::setSticky(const bool &sticky) {
    m_sticky = sticky;
    m_sticky_isSet = true;
}

bool OAIPay4Fun::is_sticky_Set() const{
    return m_sticky_isSet;
}

bool OAIPay4Fun::is_sticky_Valid() const{
    return m_sticky_isValid;
}

bool OAIPay4Fun::isThreeDSecure() const {
    return m_three_d_secure;
}
void OAIPay4Fun::setThreeDSecure(const bool &three_d_secure) {
    m_three_d_secure = three_d_secure;
    m_three_d_secure_isSet = true;
}

bool OAIPay4Fun::is_three_d_secure_Set() const{
    return m_three_d_secure_isSet;
}

bool OAIPay4Fun::is_three_d_secure_Valid() const{
    return m_three_d_secure_isValid;
}

qint32 OAIPay4Fun::getTimeout() const {
    return m_timeout;
}
void OAIPay4Fun::setTimeout(const qint32 &timeout) {
    m_timeout = timeout;
    m_timeout_isSet = true;
}

bool OAIPay4Fun::is_timeout_Set() const{
    return m_timeout_isSet;
}

bool OAIPay4Fun::is_timeout_Valid() const{
    return m_timeout_isValid;
}

QString OAIPay4Fun::getToken() const {
    return m_token;
}
void OAIPay4Fun::setToken(const QString &token) {
    m_token = token;
    m_token_isSet = true;
}

bool OAIPay4Fun::is_token_Set() const{
    return m_token_isSet;
}

bool OAIPay4Fun::is_token_Valid() const{
    return m_token_isValid;
}

QDateTime OAIPay4Fun::getUpdatedTime() const {
    return m_updated_time;
}
void OAIPay4Fun::setUpdatedTime(const QDateTime &updated_time) {
    m_updated_time = updated_time;
    m_updated_time_isSet = true;
}

bool OAIPay4Fun::is_updated_time_Set() const{
    return m_updated_time_isSet;
}

bool OAIPay4Fun::is_updated_time_Valid() const{
    return m_updated_time_isValid;
}

OAIPay4Fun_allOf_credentials OAIPay4Fun::getCredentials() const {
    return m_credentials;
}
void OAIPay4Fun::setCredentials(const OAIPay4Fun_allOf_credentials &credentials) {
    m_credentials = credentials;
    m_credentials_isSet = true;
}

bool OAIPay4Fun::is_credentials_Set() const{
    return m_credentials_isSet;
}

bool OAIPay4Fun::is_credentials_Valid() const{
    return m_credentials_isValid;
}

bool OAIPay4Fun::isSet() const {
