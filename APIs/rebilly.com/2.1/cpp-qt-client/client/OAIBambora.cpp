...
OAIBambora::OAIBambora(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIBambora::OAIBambora() {
    this->initializeModel();
}

OAIBambora::~OAIBambora() {}

void OAIBambora::initializeModel() {
...
void OAIBambora::fromJson(QString jsonString) {
...
void OAIBambora::fromJsonObject(QJsonObject json) {
...
QString OAIBambora::asJson() const {
...
QJsonObject OAIBambora::asJsonObject() const {
    QJsonObject obj;
    if (m__links.size() > 0) {
...
QList<OAIGatewayAccount__links_inner> OAIBambora::getLinks() const {
    return m__links;
}
void OAIBambora::setLinks(const QList<OAIGatewayAccount__links_inner> &_links) {
    m__links = _links;
    m__links_isSet = true;
}

bool OAIBambora::is__links_Set() const{
    return m__links_isSet;
}

bool OAIBambora::is__links_Valid() const{
    return m__links_isValid;
}

QList<QString> OAIBambora::getAcceptedCurrencies() const {
    return m_accepted_currencies;
}
void OAIBambora::setAcceptedCurrencies(const QList<QString> &accepted_currencies) {
    m_accepted_currencies = accepted_currencies;
    m_accepted_currencies_isSet = true;
}

bool OAIBambora::is_accepted_currencies_Set() const{
    return m_accepted_currencies_isSet;
}

bool OAIBambora::is_accepted_currencies_Valid() const{
    return m_accepted_currencies_isValid;
}

OAIAcquirerName OAIBambora::getAcquirerName() const {
    return m_acquirer_name;
}
void OAIBambora::setAcquirerName(const OAIAcquirerName &acquirer_name) {
    m_acquirer_name = acquirer_name;
    m_acquirer_name_isSet = true;
}

bool OAIBambora::is_acquirer_name_Set() const{
    return m_acquirer_name_isSet;
}

bool OAIBambora::is_acquirer_name_Valid() const{
    return m_acquirer_name_isValid;
}

QString OAIBambora::getAdditionalFilters() const {
    return m_additional_filters;
}
void OAIBambora::setAdditionalFilters(const QString &additional_filters) {
    m_additional_filters = additional_filters;
    m_additional_filters_isSet = true;
}

bool OAIBambora::is_additional_filters_Set() const{
    return m_additional_filters_isSet;
}

bool OAIBambora::is_additional_filters_Valid() const{
    return m_additional_filters_isValid;
}

qint32 OAIBambora::getApprovalWindowTtl() const {
    return m_approval_window_ttl;
}
void OAIBambora::setApprovalWindowTtl(const qint32 &approval_window_ttl) {
    m_approval_window_ttl = approval_window_ttl;
    m_approval_window_ttl_isSet = true;
}

bool OAIBambora::is_approval_window_ttl_Set() const{
    return m_approval_window_ttl_isSet;
}

bool OAIBambora::is_approval_window_ttl_Valid() const{
    return m_approval_window_ttl_isValid;
}

QString OAIBambora::getCityField() const {
    return m_city_field;
}
void OAIBambora::setCityField(const QString &city_field) {
    m_city_field = city_field;
    m_city_field_isSet = true;
}

bool OAIBambora::is_city_field_Set() const{
    return m_city_field_isSet;
}

bool OAIBambora::is_city_field_Valid() const{
    return m_city_field_isValid;
}

QDateTime OAIBambora::getCreatedTime() const {
    return m_created_time;
}
void OAIBambora::setCreatedTime(const QDateTime &created_time) {
    m_created_time = created_time;
    m_created_time_isSet = true;
}

bool OAIBambora::is_created_time_Set() const{
    return m_created_time_isSet;
}

bool OAIBambora::is_created_time_Valid() const{
    return m_created_time_isValid;
}

QString OAIBambora::getDccForceCurrency() const {
    return m_dcc_force_currency;
}
void OAIBambora::setDccForceCurrency(const QString &dcc_force_currency) {
    m_dcc_force_currency = dcc_force_currency;
    m_dcc_force_currency_isSet = true;
}

bool OAIBambora::is_dcc_force_currency_Set() const{
    return m_dcc_force_currency_isSet;
}

bool OAIBambora::is_dcc_force_currency_Valid() const{
    return m_dcc_force_currency_isValid;
}

qint32 OAIBambora::getDccMarkup() const {
    return m_dcc_markup;
}
void OAIBambora::setDccMarkup(const qint32 &dcc_markup) {
    m_dcc_markup = dcc_markup;
    m_dcc_markup_isSet = true;
}

bool OAIBambora::is_dcc_markup_Set() const{
    return m_dcc_markup_isSet;
}

bool OAIBambora::is_dcc_markup_Valid() const{
    return m_dcc_markup_isValid;
}

QString OAIBambora::getDescriptor() const {
    return m_descriptor;
}
void OAIBambora::setDescriptor(const QString &descriptor) {
    m_descriptor = descriptor;
    m_descriptor_isSet = true;
}

bool OAIBambora::is_descriptor_Set() const{
    return m_descriptor_isSet;
}

bool OAIBambora::is_descriptor_Valid() const{
    return m_descriptor_isValid;
}

OAIDigitalWallets OAIBambora::getDigitalWallets() const {
    return m_digital_wallets;
}
void OAIBambora::setDigitalWallets(const OAIDigitalWallets &digital_wallets) {
    m_digital_wallets = digital_wallets;
    m_digital_wallets_isSet = true;
}

bool OAIBambora::is_digital_wallets_Set() const{
    return m_digital_wallets_isSet;
}

bool OAIBambora::is_digital_wallets_Valid() const{
    return m_digital_wallets_isValid;
}

bool OAIBambora::isDynamicDescriptor() const {
    return m_dynamic_descriptor;
}
void OAIBambora::setDynamicDescriptor(const bool &dynamic_descriptor) {
    m_dynamic_descriptor = dynamic_descriptor;
    m_dynamic_descriptor_isSet = true;
}

bool OAIBambora::is_dynamic_descriptor_Set() const{
    return m_dynamic_descriptor_isSet;
}

bool OAIBambora::is_dynamic_descriptor_Valid() const{
    return m_dynamic_descriptor_isValid;
}

QList<QString> OAIBambora::getExcludedDccQuoteCurrencies() const {
    return m_excluded_dcc_quote_currencies;
}
void OAIBambora::setExcludedDccQuoteCurrencies(const QList<QString> &excluded_dcc_quote_currencies) {
    m_excluded_dcc_quote_currencies = excluded_dcc_quote_currencies;
    m_excluded_dcc_quote_currencies_isSet = true;
}

bool OAIBambora::is_excluded_dcc_quote_currencies_Set() const{
    return m_excluded_dcc_quote_currencies_isSet;
}

bool OAIBambora::is_excluded_dcc_quote_currencies_Valid() const{
    return m_excluded_dcc_quote_currencies_isValid;
}

OAIGatewayName OAIBambora::getGatewayName() const {
    return m_gateway_name;
}
void OAIBambora::setGatewayName(const OAIGatewayName &gateway_name) {
    m_gateway_name = gateway_name;
    m_gateway_name_isSet = true;
}

bool OAIBambora::is_gateway_name_Set() const{
    return m_gateway_name_isSet;
}

bool OAIBambora::is_gateway_name_Valid() const{
    return m_gateway_name_isValid;
}

QString OAIBambora::getId() const {
    return m_id;
}
void OAIBambora::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIBambora::is_id_Set() const{
    return m_id_isSet;
}

bool OAIBambora::is_id_Valid() const{
    return m_id_isValid;
}

bool OAIBambora::isIsDown() const {
    return m_is_down;
}
void OAIBambora::setIsDown(const bool &is_down) {
    m_is_down = is_down;
    m_is_down_isSet = true;
}

bool OAIBambora::is_is_down_Set() const{
    return m_is_down_isSet;
}

bool OAIBambora::is_is_down_Valid() const{
    return m_is_down_isValid;
}

QString OAIBambora::getMerchantCategoryCode() const {
    return m_merchant_category_code;
}
void OAIBambora::setMerchantCategoryCode(const QString &merchant_category_code) {
    m_merchant_category_code = merchant_category_code;
    m_merchant_category_code_isSet = true;
}

bool OAIBambora::is_merchant_category_code_Set() const{
    return m_merchant_category_code_isSet;
}

bool OAIBambora::is_merchant_category_code_Valid() const{
    return m_merchant_category_code_isValid;
}

OAIPaymentMethod OAIBambora::getMethod() const {
    return m_method;
}
void OAIBambora::setMethod(const OAIPaymentMethod &method) {
    m_method = method;
    m_method_isSet = true;
}

bool OAIBambora::is_method_Set() const{
    return m_method_isSet;
}

bool OAIBambora::is_method_Valid() const{
    return m_method_isValid;
}

double OAIBambora::getMonthlyLimit() const {
    return m_monthly_limit;
}
void OAIBambora::setMonthlyLimit(const double &monthly_limit) {
    m_monthly_limit = monthly_limit;
    m_monthly_limit_isSet = true;
}

bool OAIBambora::is_monthly_limit_Set() const{
    return m_monthly_limit_isSet;
}

bool OAIBambora::is_monthly_limit_Valid() const{
    return m_monthly_limit_isValid;
}

QString OAIBambora::getOrganizationId() const {
    return m_organization_id;
}
void OAIBambora::setOrganizationId(const QString &organization_id) {
    m_organization_id = organization_id;
    m_organization_id_isSet = true;
}

bool OAIBambora::is_organization_id_Set() const{
    return m_organization_id_isSet;
}

bool OAIBambora::is_organization_id_Valid() const{
    return m_organization_id_isValid;
}

QList<OAIPaymentCardBrand> OAIBambora::getPaymentCardSchemes() const {
    return m_payment_card_schemes;
}
void OAIBambora::setPaymentCardSchemes(const QList<OAIPaymentCardBrand> &payment_card_schemes) {
    m_payment_card_schemes = payment_card_schemes;
    m_payment_card_schemes_isSet = true;
}

bool OAIBambora::is_payment_card_schemes_Set() const{
    return m_payment_card_schemes_isSet;
}

bool OAIBambora::is_payment_card_schemes_Valid() const{
    return m_payment_card_schemes_isValid;
}

bool OAIBambora::isReconciliationWindowEnabled() const {
    return m_reconciliation_window_enabled;
}
void OAIBambora::setReconciliationWindowEnabled(const bool &reconciliation_window_enabled) {
    m_reconciliation_window_enabled = reconciliation_window_enabled;
    m_reconciliation_window_enabled_isSet = true;
}

bool OAIBambora::is_reconciliation_window_enabled_Set() const{
    return m_reconciliation_window_enabled_isSet;
}

bool OAIBambora::is_reconciliation_window_enabled_Valid() const{
    return m_reconciliation_window_enabled_isValid;
}

qint32 OAIBambora::getReconciliationWindowTtl() const {
    return m_reconciliation_window_ttl;
}
void OAIBambora::setReconciliationWindowTtl(const qint32 &reconciliation_window_ttl) {
    m_reconciliation_window_ttl = reconciliation_window_ttl;
    m_reconciliation_window_ttl_isSet = true;
}

bool OAIBambora::is_reconciliation_window_ttl_Set() const{
    return m_reconciliation_window_ttl_isSet;
}

bool OAIBambora::is_reconciliation_window_ttl_Valid() const{
    return m_reconciliation_window_ttl_isValid;
}

QString OAIBambora::getStatus() const {
    return m_status;
}
void OAIBambora::setStatus(const QString &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIBambora::is_status_Set() const{
    return m_status_isSet;
}

bool OAIBambora::is_status_Valid() const{
    return m_status_isValid;
}

bool OAIBambora::isSticky() const {
    return m_sticky;
}
void OAIBambora::setSticky(const bool &sticky) {
    m_sticky = sticky;
    m_sticky_isSet = true;
}

bool OAIBambora::is_sticky_Set() const{
    return m_sticky_isSet;
}

bool OAIBambora::is_sticky_Valid() const{
    return m_sticky_isValid;
}

bool OAIBambora::isThreeDSecure() const {
    return m_three_d_secure;
}
void OAIBambora::setThreeDSecure(const bool &three_d_secure) {
    m_three_d_secure = three_d_secure;
    m_three_d_secure_isSet = true;
}

bool OAIBambora::is_three_d_secure_Set() const{
    return m_three_d_secure_isSet;
}

bool OAIBambora::is_three_d_secure_Valid() const{
    return m_three_d_secure_isValid;
}

qint32 OAIBambora::getTimeout() const {
    return m_timeout;
}
void OAIBambora::setTimeout(const qint32 &timeout) {
    m_timeout = timeout;
    m_timeout_isSet = true;
}

bool OAIBambora::is_timeout_Set() const{
    return m_timeout_isSet;
}

bool OAIBambora::is_timeout_Valid() const{
    return m_timeout_isValid;
}

QString OAIBambora::getToken() const {
    return m_token;
}
void OAIBambora::setToken(const QString &token) {
    m_token = token;
    m_token_isSet = true;
}

bool OAIBambora::is_token_Set() const{
    return m_token_isSet;
}

bool OAIBambora::is_token_Valid() const{
    return m_token_isValid;
}

QDateTime OAIBambora::getUpdatedTime() const {
    return m_updated_time;
}
void OAIBambora::setUpdatedTime(const QDateTime &updated_time) {
    m_updated_time = updated_time;
    m_updated_time_isSet = true;
}

bool OAIBambora::is_updated_time_Set() const{
    return m_updated_time_isSet;
}

bool OAIBambora::is_updated_time_Valid() const{
    return m_updated_time_isValid;
}

OAIBambora_allOf_credentials OAIBambora::getCredentials() const {
    return m_credentials;
}
void OAIBambora::setCredentials(const OAIBambora_allOf_credentials &credentials) {
    m_credentials = credentials;
    m_credentials_isSet = true;
}

bool OAIBambora::is_credentials_Set() const{
    return m_credentials_isSet;
}

bool OAIBambora::is_credentials_Valid() const{
    return m_credentials_isValid;
}

bool OAIBambora::isSet() const {
