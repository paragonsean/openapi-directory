...
#ifndef OAINetbanking_H
#define OAINetbanking_H
...
class OAINetbanking_allOf_credentials;

class OAINetbanking : public OAIObject {
public:
    OAINetbanking();
    OAINetbanking(QString json);
    ~OAINetbanking() override;
    ...
    OAINetbanking_allOf_credentials getCredentials() const;
    void setCredentials(const OAINetbanking_allOf_credentials &credentials);
...
private:
    ...
    OAINetbanking_allOf_credentials m_credentials;
...
Q_DECLARE_METATYPE(OpenAPI::OAINetbanking)

#endif // OAINetbanking_H
