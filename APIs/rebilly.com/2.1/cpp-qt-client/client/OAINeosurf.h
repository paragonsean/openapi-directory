...
class OAINeosurf_allOf_credentials;

class OAINeosurf : public OAIObject {
public:
    OAINeosurf();
    OAINeosurf(QString json);
    ~OAINeosurf() override;
    ...
    OAINeosurf_allOf_credentials getCredentials() const;
    void setCredentials(const OAINeosurf_allOf_credentials &credentials);
...
private:
    ...
    OAINeosurf_allOf_credentials m_credentials;
...
Q_DECLARE_METATYPE(OpenAPI::OAINeosurf)
