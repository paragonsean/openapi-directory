...
/*
 * OAICommonPaymentToken.h
 *
 * 
 */

#ifndef OAICommonPaymentToken_H
#define OAICommonPaymentToken_H
...
class OAICommonPaymentToken : public OAIObject {
public:
    OAICommonPaymentToken();
    OAICommonPaymentToken(QString json);
    ~OAICommonPaymentToken() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICommonPaymentToken)

#endif // OAICommonPaymentToken_H
