...
#include "OAITrustly_allOf_credentials.h"
#include <QDateTime>
#include <QList>
#include <QString>
...
class OAITrustly_allOf_credentials;

class OAITrustly : public OAIObject {
public:
    OAITrustly();
    OAITrustly(QString json);
    ~OAITrustly() override;
    ...
    OAITrustly_allOf_credentials getCredentials() const;
    void setCredentials(const OAITrustly_allOf_credentials &credentials);
...
private:
    ...
    OAITrustly_allOf_credentials m_credentials;
...
Q_DECLARE_METATYPE(OpenAPI::OAITrustly)
