...
#ifndef OAIPandaGateway_H
#define OAIPandaGateway_H
...
#include "OAIPandaGateway_allOf_credentials.h"
...
class OAIPandaGateway_allOf_credentials;

class OAIPandaGateway : public OAIObject {
public:
    OAIPandaGateway();
    OAIPandaGateway(QString json);
    ~OAIPandaGateway() override;
    ...
    OAIPandaGateway_allOf_credentials getCredentials() const;
    void setCredentials(const OAIPandaGateway_allOf_credentials &credentials);
...
private:
    ...
    OAIPandaGateway_allOf_credentials m_credentials;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPandaGateway)

#endif // OAIPandaGateway_H
