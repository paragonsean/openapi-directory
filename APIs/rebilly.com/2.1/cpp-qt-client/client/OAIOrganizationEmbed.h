...
/*
 * OAIOrganizationEmbed.h
 *
 * Organization object.
 */

#ifndef OAIOrganizationEmbed_H
#define OAIOrganizationEmbed_H
...
class OAIOrganizationEmbed : public OAIObject {
public:
    OAIOrganizationEmbed();
    OAIOrganizationEmbed(QString json);
    ~OAIOrganizationEmbed() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIOrganizationEmbed)

#endif // OAIOrganizationEmbed_H
