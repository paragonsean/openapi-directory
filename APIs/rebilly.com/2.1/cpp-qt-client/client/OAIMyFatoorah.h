...
#ifndef OAIMyFatoorah_H
#define OAIMyFatoorah_H
...
class OAIMyFatoorah_allOf_credentials;

class OAIMyFatoorah : public OAIObject {
public:
    OAIMyFatoorah();
    OAIMyFatoorah(QString json);
    ~OAIMyFatoorah() override;
    ...
    OAIMyFatoorah_allOf_credentials getCredentials() const;
    void setCredentials(const OAIMyFatoorah_allOf_credentials &credentials);
...
private:
    ...
    OAIMyFatoorah_allOf_credentials m_credentials;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMyFatoorah)

#endif // OAIMyFatoorah_H
