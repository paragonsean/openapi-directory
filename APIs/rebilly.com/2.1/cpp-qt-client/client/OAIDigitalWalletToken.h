...
/*
 * OAIDigitalWalletToken.h
 *
 * 
 */

#ifndef OAIDigitalWalletToken_H
#define OAIDigitalWalletToken_H
...
class OAIDigitalWalletToken : public OAIObject {
public:
    OAIDigitalWalletToken();
    OAIDigitalWalletToken(QString json);
    ~OAIDigitalWalletToken() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDigitalWalletToken)

#endif // OAIDigitalWalletToken_H
