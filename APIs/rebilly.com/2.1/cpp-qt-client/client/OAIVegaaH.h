...
class OAIVegaaH_allOf_credentials;

class OAIVegaaH : public OAIObject {
public:
    OAIVegaaH();
    OAIVegaaH(QString json);
    ~OAIVegaaH() override;
    ...
    OAIVegaaH_allOf_credentials getCredentials() const;
    void setCredentials(const OAIVegaaH_allOf_credentials &credentials);
...
private:
    ...
    OAIVegaaH_allOf_credentials m_credentials;
...
Q_DECLARE_METATYPE(OpenAPI::OAIVegaaH)
