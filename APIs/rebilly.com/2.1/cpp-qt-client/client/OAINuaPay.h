...
class OAINuaPay_allOf_credentials;

class OAINuaPay : public OAIObject {
public:
    OAINuaPay();
    OAINuaPay(QString json);
    ~OAINuaPay() override;
    ...
    OAINuaPay_allOf_credentials getCredentials() const;
    void setCredentials(const OAINuaPay_allOf_credentials &credentials);
...
private:
    ...
    OAINuaPay_allOf_credentials m_credentials;
...
Q_DECLARE_METATYPE(OpenAPI::OAINuaPay)
