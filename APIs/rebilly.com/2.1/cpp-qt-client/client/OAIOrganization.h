...
class OAIOrganizationQuestionnaire;
...
public:
    ...
    QString getInvoiceTimeZone() const;
    void setInvoiceTimeZone(const QString &invoice_time_zone);
    bool is_invoice_time_zone_Set() const;
    bool is_invoice_time_zone_Valid() const;
    ...
    OAIOrganizationQuestionnaire getQuestionnaire() const;
    void setQuestionnaire(const OAIOrganizationQuestionnaire &questionnaire);
    ...
    QString getTaxDescriptor() const;
    void setTaxDescriptor(const QString &tax_descriptor);
    bool is_tax_descriptor_Set() const;
    bool is_tax_descriptor_Valid() const;
...
private:
    ...
    QString m_invoice_time_zone;
    bool m_invoice_time_zone_isSet;
    bool m_invoice_time_zone_isValid;
    ...
    OAIOrganizationQuestionnaire m_questionnaire;
    ...
    QString m_tax_descriptor;
    bool m_tax_descriptor_isSet;
    bool m_tax_descriptor_isValid;
