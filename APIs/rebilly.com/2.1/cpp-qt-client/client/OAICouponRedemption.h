...
/*
 * OAICouponRedemption.h
 *
 * Coupons redemption log.
 */

#ifndef OAICouponRedemption_H
#define OAICouponRedemption_H

#include <QJsonObject>

#include "OAIRedemptionRestriction.h"
...
namespace OpenAPI {
class OAISelfLink;
class OAIRedemptionRestriction;

class OAICouponRedemption : public OAIObject {
public:
    OAICouponRedemption();
    OAICouponRedemption(QString json);
    ~OAICouponRedemption() override;
    ...
    QList<OAIRedemptionRestriction> getAdditionalRestrictions() const;
    void setAdditionalRestrictions(const QList<OAIRedemptionRestriction> &additional_restrictions);
    bool is_additional_restrictions_Set() const;
    bool is_additional_restrictions_Valid() const;
...
private:
    ...
    QList<OAIRedemptionRestriction> m_additional_restrictions;
    bool m_additional_restrictions_isSet;
    bool m_additional_restrictions_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAICouponRedemption)

#endif // OAICouponRedemption_H
