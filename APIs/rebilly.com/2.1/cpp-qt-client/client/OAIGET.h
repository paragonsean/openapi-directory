...
#include "OAIGET_allOf_credentials.h"
...
class OAIGET_allOf_credentials;
class OAIGET3dsServers;

class OAIGET : public OAIObject {
public:
    OAIGET();
    OAIGET(QString json);
    ~OAIGET() override;
    ...
    OAIGET_allOf_credentials getCredentials() const;
    void setCredentials(const OAIGET_allOf_credentials &credentials);
    bool is_credentials_Set() const;
    bool is_credentials_Valid() const;

    OAIGET3dsServers getThreeDSecureServer() const;
    void setThreeDSecureServer(const OAIGET3dsServers &three_d_secure_server);
...
private:
    ...
    OAIGET_allOf_credentials m_credentials;
    bool m_credentials_isSet;
    bool m_credentials_isValid;

    OAIGET3dsServers m_three_d_secure_server;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGET)
