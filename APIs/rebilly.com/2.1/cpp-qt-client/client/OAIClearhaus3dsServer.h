...
/*
 * OAIClearhaus3dsServer.h
 *
 * Clearhaus 3DS Server Credentials.
 */

#ifndef OAIClearhaus3dsServer_H
#define OAIClearhaus3dsServer_H
...
class OAIClearhaus3dsServer : public OAIObject {
public:
    OAIClearhaus3dsServer();
    OAIClearhaus3dsServer(QString json);
    ~OAIClearhaus3dsServer() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIClearhaus3dsServer)

#endif // OAIClearhaus3dsServer_H
