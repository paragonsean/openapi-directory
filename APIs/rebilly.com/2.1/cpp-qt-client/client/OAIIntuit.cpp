...
OAIIntuit::OAIIntuit(QString json) {
...
void OAIIntuit::initializeModel() {
...
void OAIIntuit::fromJson(QString jsonString) {
...
void OAIIntuit::fromJsonObject(QJsonObject json) {
...
QString OAIIntuit::asJson() const {
...
QJsonObject OAIIntuit::asJsonObject() const {
    QJsonObject obj;
    if (m__links.size() > 0) {
...
QList<OAIGatewayAccount__links_inner> OAIIntuit::getLinks() const {
    return m__links;
}
void OAIIntuit::setLinks(const QList<OAIGatewayAccount__links_inner> &_links) {
    m__links = _links;
    m__links_isSet = true;
}

bool OAIIntuit::is__links_Set() const{
    return m__links_isSet;
}

bool OAIIntuit::is__links_Valid() const{
    return m__links_isValid;
}

QList<QString> OAIIntuit::getAcceptedCurrencies() const {
    return m_accepted_currencies;
}
void OAIIntuit::setAcceptedCurrencies(const QList<QString> &accepted_currencies) {
    m_accepted_currencies = accepted_currencies;
    m_accepted_currencies_isSet = true;
}

bool OAIIntuit::is_accepted_currencies_Set() const{
    return m_accepted_currencies_isSet;
}

bool OAIIntuit::is_accepted_currencies_Valid() const{
    return m_accepted_currencies_isValid;
}

OAIAcquirerName OAIIntuit::getAcquirerName() const {
    return m_acquirer_name;
}
void OAIIntuit::setAcquirerName(const OAIAcquirerName &acquirer_name) {
    m_acquirer_name = acquirer_name;
    m_acquirer_name_isSet = true;
}

bool OAIIntuit::is_acquirer_name_Set() const{
    return m_acquirer_name_isSet;
}

bool OAIIntuit::is_acquirer_name_Valid() const{
    return m_acquirer_name_isValid;
}

QString OAIIntuit::getAdditionalFilters() const {
    return m_additional_filters;
}
void OAIIntuit::setAdditionalFilters(const QString &additional_filters) {
    m_additional_filters = additional_filters;
    m_additional_filters_isSet = true;
}

bool OAIIntuit::is_additional_filters_Set() const{
    return m_additional_filters_isSet;
}

bool OAIIntuit::is_additional_filters_Valid() const{
    return m_additional_filters_isValid;
}

qint32 OAIIntuit::getApprovalWindowTtl() const {
    return m_approval_window_ttl;
}
void OAIIntuit::setApprovalWindowTtl(const qint32 &approval_window_ttl) {
    m_approval_window_ttl = approval_window_ttl;
    m_approval_window_ttl_isSet = true;
}

bool OAIIntuit::is_approval_window_ttl_Set() const{
    return m_approval_window_ttl_isSet;
}

bool OAIIntuit::is_approval_window_ttl_Valid() const{
    return m_approval_window_ttl_isValid;
}

QString OAIIntuit::getCityField() const {
    return m_city_field;
}
void OAIIntuit::setCityField(const QString &city_field) {
    m_city_field = city_field;
    m_city_field_isSet = true;
}

bool OAIIntuit::is_city_field_Set() const{
    return m_city_field_isSet;
}

bool OAIIntuit::is_city_field_Valid() const{
    return m_city_field_isValid;
}

QDateTime OAIIntuit::getCreatedTime() const {
    return m_created_time;
}
void OAIIntuit::setCreatedTime(const QDateTime &created_time) {
    m_created_time = created_time;
    m_created_time_isSet = true;
}

bool OAIIntuit::is_created_time_Set() const{
    return m_created_time_isSet;
}

bool OAIIntuit::is_created_time_Valid() const{
    return m_created_time_isValid;
}

QString OAIIntuit::getDccForceCurrency() const {
    return m_dcc_force_currency;
}
void OAIIntuit::setDccForceCurrency(const QString &dcc_force_currency) {
    m_dcc_force_currency = dcc_force_currency;
    m_dcc_force_currency_isSet = true;
}

bool OAIIntuit::is_dcc_force_currency_Set() const{
    return m_dcc_force_currency_isSet;
}

bool OAIIntuit::is_dcc_force_currency_Valid() const{
    return m_dcc_force_currency_isValid;
}

qint32 OAIIntuit::getDccMarkup() const {
    return m_dcc_markup;
}
void OAIIntuit::setDccMarkup(const qint32 &dcc_markup) {
    m_dcc_markup = dcc_markup;
    m_dcc_markup_isSet = true;
}

bool OAIIntuit::is_dcc_markup_Set() const{
    return m_dcc_markup_isSet;
}

bool OAIIntuit::is_dcc_markup_Valid() const{
    return m_dcc_markup_isValid;
}

QString OAIIntuit::getDescriptor() const {
    return m_descriptor;
}
void OAIIntuit::setDescriptor(const QString &descriptor) {
    m_descriptor = descriptor;
    m_descriptor_isSet = true;
}

bool OAIIntuit::is_descriptor_Set() const{
    return m_descriptor_isSet;
}

bool OAIIntuit::is_descriptor_Valid() const{
    return m_descriptor_isValid;
}

OAIDigitalWallets OAIIntuit::getDigitalWallets() const {
    return m_digital_wallets;
}
void OAIIntuit::setDigitalWallets(const OAIDigitalWallets &digital_wallets) {
    m_digital_wallets = digital_wallets;
    m_digital_wallets_isSet = true;
}

bool OAIIntuit::is_digital_wallets_Set() const{
    return m_digital_wallets_isSet;
}

bool OAIIntuit::is_digital_wallets_Valid() const{
    return m_digital_wallets_isValid;
}

bool OAIIntuit::isDynamicDescriptor() const {
    return m_dynamic_descriptor;
}
void OAIIntuit::setDynamicDescriptor(const bool &dynamic_descriptor) {
    m_dynamic_descriptor = dynamic_descriptor;
    m_dynamic_descriptor_isSet = true;
}

bool OAIIntuit::is_dynamic_descriptor_Set() const{
    return m_dynamic_descriptor_isSet;
}

bool OAIIntuit::is_dynamic_descriptor_Valid() const{
    return m_dynamic_descriptor_isValid;
}

QList<QString> OAIIntuit::getExcludedDccQuoteCurrencies() const {
    return m_excluded_dcc_quote_currencies;
}
void OAIIntuit::setExcludedDccQuoteCurrencies(const QList<QString> &excluded_dcc_quote_currencies) {
    m_excluded_dcc_quote_currencies = excluded_dcc_quote_currencies;
    m_excluded_dcc_quote_currencies_isSet = true;
}

bool OAIIntuit::is_excluded_dcc_quote_currencies_Set() const{
    return m_excluded_dcc_quote_currencies_isSet;
}

bool OAIIntuit::is_excluded_dcc_quote_currencies_Valid() const{
    return m_excluded_dcc_quote_currencies_isValid;
}

OAIGatewayName OAIIntuit::getGatewayName() const {
    return m_gateway_name;
}
void OAIIntuit::setGatewayName(const OAIGatewayName &gateway_name) {
    m_gateway_name = gateway_name;
    m_gateway_name_isSet = true;
}

bool OAIIntuit::is_gateway_name_Set() const{
    return m_gateway_name_isSet;
}

bool OAIIntuit::is_gateway_name_Valid() const{
    return m_gateway_name_isValid;
}

QString OAIIntuit::getId() const {
    return m_id;
}
void OAIIntuit::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIIntuit::is_id_Set() const{
    return m_id_isSet;
}

bool OAIIntuit::is_id_Valid() const{
    return m_id_isValid;
}

bool OAIIntuit::isIsDown() const {
    return m_is_down;
}
void OAIIntuit::setIsDown(const bool &is_down) {
    m_is_down = is_down;
    m_is_down_isSet = true;
}

bool OAIIntuit::is_is_down_Set() const{
    return m_is_down_isSet;
}

bool OAIIntuit::is_is_down_Valid() const{
    return m_is_down_isValid;
}

QString OAIIntuit::getMerchantCategoryCode() const {
    return m_merchant_category_code;
}
void OAIIntuit::setMerchantCategoryCode(const QString &merchant_category_code) {
    m_merchant_category_code = merchant_category_code;
    m_merchant_category_code_isSet = true;
}

bool OAIIntuit::is_merchant_category_code_Set() const{
    return m_merchant_category_code_isSet;
}

bool OAIIntuit::is_merchant_category_code_Valid() const{
    return m_merchant_category_code_isValid;
}

OAIPaymentMethod OAIIntuit::getMethod() const {
    return m_method;
}
void OAIIntuit::setMethod(const OAIPaymentMethod &method) {
    m_method = method;
    m_method_isSet = true;
}

bool OAIIntuit::is_method_Set() const{
    return m_method_isSet;
}

bool OAIIntuit::is_method_Valid() const{
    return m_method_isValid;
}

double OAIIntuit::getMonthlyLimit() const {
    return m_monthly_limit;
}
void OAIIntuit::setMonthlyLimit(const double &monthly_limit) {
    m_monthly_limit = monthly_limit;
    m_monthly_limit_isSet = true;
}

bool OAIIntuit::is_monthly_limit_Set() const{
    return m_monthly_limit_isSet;
}

bool OAIIntuit::is_monthly_limit_Valid() const{
    return m_monthly_limit_isValid;
}

QString OAIIntuit::getOrganizationId() const {
    return m_organization_id;
}
void OAIIntuit::setOrganizationId(const QString &organization_id) {
    m_organization_id = organization_id;
    m_organization_id_isSet = true;
}

bool OAIIntuit::is_organization_id_Set() const{
    return m_organization_id_isSet;
}

bool OAIIntuit::is_organization_id_Valid() const{
    return m_organization_id_isValid;
}

QList<OAIPaymentCardBrand> OAIIntuit::getPaymentCardSchemes() const {
    return m_payment_card_schemes;
}
void OAIIntuit::setPaymentCardSchemes(const QList<OAIPaymentCardBrand> &payment_card_schemes) {
    m_payment_card_schemes = payment_card_schemes;
    m_payment_card_schemes_isSet = true;
}

bool OAIIntuit::is_payment_card_schemes_Set() const{
    return m_payment_card_schemes_isSet;
}

bool OAIIntuit::is_payment_card_schemes_Valid() const{
    return m_payment_card_schemes_isValid;
}

bool OAIIntuit::isReconciliationWindowEnabled() const {
    return m_reconciliation_window_enabled;
}
void OAIIntuit::setReconciliationWindowEnabled(const bool &reconciliation_window_enabled) {
    m_reconciliation_window_enabled = reconciliation_window_enabled;
    m_reconciliation_window_enabled_isSet = true;
}

bool OAIIntuit::is_reconciliation_window_enabled_Set() const{
    return m_reconciliation_window_enabled_isSet;
}

bool OAIIntuit::is_reconciliation_window_enabled_Valid() const{
    return m_reconciliation_window_enabled_isValid;
}

qint32 OAIIntuit::getReconciliationWindowTtl() const {
    return m_reconciliation_window_ttl;
}
void OAIIntuit::setReconciliationWindowTtl(const qint32 &reconciliation_window_ttl) {
    m_reconciliation_window_ttl = reconciliation_window_ttl;
    m_reconciliation_window_ttl_isSet = true;
}

bool OAIIntuit::is_reconciliation_window_ttl_Set() const{
    return m_reconciliation_window_ttl_isSet;
}

bool OAIIntuit::is_reconciliation_window_ttl_Valid() const{
    return m_reconciliation_window_ttl_isValid;
}

QString OAIIntuit::getStatus() const {
    return m_status;
}
void OAIIntuit::setStatus(const QString &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIIntuit::is_status_Set() const{
    return m_status_isSet;
}

bool OAIIntuit::is_status_Valid() const{
    return m_status_isValid;
}

bool OAIIntuit::isSticky() const {
    return m_sticky;
}
void OAIIntuit::setSticky(const bool &sticky) {
    m_sticky = sticky;
    m_sticky_isSet = true;
}

bool OAIIntuit::is_sticky_Set() const{
    return m_sticky_isSet;
}

bool OAIIntuit::is_sticky_Valid() const{
    return m_sticky_isValid;
}

bool OAIIntuit::isThreeDSecure() const {
    return m_three_d_secure;
}
void OAIIntuit::setThreeDSecure(const bool &three_d_secure) {
    m_three_d_secure = three_d_secure;
    m_three_d_secure_isSet = true;
}

bool OAIIntuit::is_three_d_secure_Set() const{
    return m_three_d_secure_isSet;
}

bool OAIIntuit::is_three_d_secure_Valid() const{
    return m_three_d_secure_isValid;
}

qint32 OAIIntuit::getTimeout() const {
    return m_timeout;
}
void OAIIntuit::setTimeout(const qint32 &timeout) {
    m_timeout = timeout;
    m_timeout_isSet = true;
}

bool OAIIntuit::is_timeout_Set() const{
    return m_timeout_isSet;
}

bool OAIIntuit::is_timeout_Valid() const{
    return m_timeout_isValid;
}

QString OAIIntuit::getToken() const {
    return m_token;
}
void OAIIntuit::setToken(const QString &token) {
    m_token = token;
    m_token_isSet = true;
}

bool OAIIntuit::is_token_Set() const{
    return m_token_isSet;
}

bool OAIIntuit::is_token_Valid() const{
    return m_token_isValid;
}

QDateTime OAIIntuit::getUpdatedTime() const {
    return m_updated_time;
}
void OAIIntuit::setUpdatedTime(const QDateTime &updated_time) {
    m_updated_time = updated_time;
    m_updated_time_isSet = true;
}

bool OAIIntuit::is_updated_time_Set() const{
    return m_updated_time_isSet;
}

bool OAIIntuit::is_updated_time_Valid() const{
    return m_updated_time_isValid;
}

OAIIntuit_allOf_credentials OAIIntuit::getCredentials() const {
    return m_credentials;
}
void OAIIntuit::setCredentials(const OAIIntuit_allOf_credentials &credentials) {
    m_credentials = credentials;
    m_credentials_isSet = true;
}

bool OAIIntuit::is_credentials_Set() const{
    return m_credentials_isSet;
}

bool OAIIntuit::is_credentials_Valid() const{
    return m_credentials_isValid;
}

bool OAIIntuit::isSet() const {
