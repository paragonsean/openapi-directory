...
/*
 * OAICommonPaymentCard.h
 *
 * 
 */

#ifndef OAICommonPaymentCard_H
#define OAICommonPaymentCard_H
...
class OAICommonPaymentCard : public OAIObject {
public:
    OAICommonPaymentCard();
    OAICommonPaymentCard(QString json);
    ~OAICommonPaymentCard() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICommonPaymentCard)

#endif // OAICommonPaymentCard_H
