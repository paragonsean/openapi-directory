...
/*
 * OAIPaymentInstrumentUpdateToken.h
 *
 * 
 */

#ifndef OAIPaymentInstrumentUpdateToken_H
#define OAIPaymentInstrumentUpdateToken_H
...
class OAIPaymentInstrumentUpdateToken : public OAIObject {
public:
    OAIPaymentInstrumentUpdateToken();
    OAIPaymentInstrumentUpdateToken(QString json);
    ~OAIPaymentInstrumentUpdateToken() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPaymentInstrumentUpdateToken)

#endif // OAIPaymentInstrumentUpdateToken_H
