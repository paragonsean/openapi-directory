...
#include "OAIIlixium3dsServers.h"
#include "OAIIlixium_allOf_credentials.h"
...
class OAIIlixium_allOf_credentials;
class OAIIlixium_allOf_settings;
class OAIIlixium3dsServers;

class OAIIlixium : public OAIObject {
public:
    OAIIlixium();
    OAIIlixium(QString json);
    ~OAIIlixium() override;
    ...
    OAIIlixium_allOf_credentials getCredentials() const;
    void setCredentials(const OAIIlixium_allOf_credentials &credentials);
    bool is_credentials_Set() const;
    bool is_credentials_Valid() const;

    OAIIlixium_allOf_settings getSettings() const;
    void setSettings(const OAIIlixium_allOf_settings &settings);
    bool is_settings_Set() const;
    bool is_settings_Valid() const;

    OAIIlixium3dsServers getThreeDSecureServer() const;
    void setThreeDSecureServer(const OAIIlixium3dsServers &three_d_secure_server);
...
private:
    ...
    OAIIlixium_allOf_credentials m_credentials;
    bool m_credentials_isSet;
    bool m_credentials_isValid;

    OAIIlixium_allOf_settings m_settings;
    bool m_settings_isSet;
    bool m_settings_isValid;

    OAIIlixium3dsServers m_three_d_secure_server;
...
Q_DECLARE_METATYPE(OpenAPI::OAIIlixium)
