...
OAIPayvision::OAIPayvision(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPayvision::OAIPayvision() {
    this->initializeModel();
}

OAIPayvision::~OAIPayvision() {}

void OAIPayvision::initializeModel() {
...
void OAIPayvision::fromJson(QString jsonString) {
...
void OAIPayvision::fromJsonObject(QJsonObject json) {
...
QString OAIPayvision::asJson() const {
...
QJsonObject OAIPayvision::asJsonObject() const {
    QJsonObject obj;
    if (m__links.size() > 0) {
...
QList<OAIGatewayAccount__links_inner> OAIPayvision::getLinks() const {
    return m__links;
}
void OAIPayvision::setLinks(const QList<OAIGatewayAccount__links_inner> &_links) {
    m__links = _links;
    m__links_isSet = true;
}

bool OAIPayvision::is__links_Set() const{
    return m__links_isSet;
}

bool OAIPayvision::is__links_Valid() const{
    return m__links_isValid;
}

QList<QString> OAIPayvision::getAcceptedCurrencies() const {
    return m_accepted_currencies;
}
void OAIPayvision::setAcceptedCurrencies(const QList<QString> &accepted_currencies) {
    m_accepted_currencies = accepted_currencies;
    m_accepted_currencies_isSet = true;
}

bool OAIPayvision::is_accepted_currencies_Set() const{
    return m_accepted_currencies_isSet;
}

bool OAIPayvision::is_accepted_currencies_Valid() const{
    return m_accepted_currencies_isValid;
}

OAIAcquirerName OAIPayvision::getAcquirerName() const {
    return m_acquirer_name;
}
void OAIPayvision::setAcquirerName(const OAIAcquirerName &acquirer_name) {
    m_acquirer_name = acquirer_name;
    m_acquirer_name_isSet = true;
}

bool OAIPayvision::is_acquirer_name_Set() const{
    return m_acquirer_name_isSet;
}

bool OAIPayvision::is_acquirer_name_Valid() const{
    return m_acquirer_name_isValid;
}

QString OAIPayvision::getAdditionalFilters() const {
    return m_additional_filters;
}
void OAIPayvision::setAdditionalFilters(const QString &additional_filters) {
    m_additional_filters = additional_filters;
    m_additional_filters_isSet = true;
}

bool OAIPayvision::is_additional_filters_Set() const{
    return m_additional_filters_isSet;
}

bool OAIPayvision::is_additional_filters_Valid() const{
    return m_additional_filters_isValid;
}

qint32 OAIPayvision::getApprovalWindowTtl() const {
    return m_approval_window_ttl;
}
void OAIPayvision::setApprovalWindowTtl(const qint32 &approval_window_ttl) {
    m_approval_window_ttl = approval_window_ttl;
    m_approval_window_ttl_isSet = true;
}

bool OAIPayvision::is_approval_window_ttl_Set() const{
    return m_approval_window_ttl_isSet;
}

bool OAIPayvision::is_approval_window_ttl_Valid() const{
    return m_approval_window_ttl_isValid;
}

QString OAIPayvision::getCityField() const {
    return m_city_field;
}
void OAIPayvision::setCityField(const QString &city_field) {
    m_city_field = city_field;
    m_city_field_isSet = true;
}

bool OAIPayvision::is_city_field_Set() const{
    return m_city_field_isSet;
}

bool OAIPayvision::is_city_field_Valid() const{
    return m_city_field_isValid;
}

QDateTime OAIPayvision::getCreatedTime() const {
    return m_created_time;
}
void OAIPayvision::setCreatedTime(const QDateTime &created_time) {
    m_created_time = created_time;
    m_created_time_isSet = true;
}

bool OAIPayvision::is_created_time_Set() const{
    return m_created_time_isSet;
}

bool OAIPayvision::is_created_time_Valid() const{
    return m_created_time_isValid;
}

QString OAIPayvision::getDccForceCurrency() const {
    return m_dcc_force_currency;
}
void OAIPayvision::setDccForceCurrency(const QString &dcc_force_currency) {
    m_dcc_force_currency = dcc_force_currency;
    m_dcc_force_currency_isSet = true;
}

bool OAIPayvision::is_dcc_force_currency_Set() const{
    return m_dcc_force_currency_isSet;
}

bool OAIPayvision::is_dcc_force_currency_Valid() const{
    return m_dcc_force_currency_isValid;
}

qint32 OAIPayvision::getDccMarkup() const {
    return m_dcc_markup;
}
void OAIPayvision::setDccMarkup(const qint32 &dcc_markup) {
    m_dcc_markup = dcc_markup;
    m_dcc_markup_isSet = true;
}

bool OAIPayvision::is_dcc_markup_Set() const{
    return m_dcc_markup_isSet;
}

bool OAIPayvision::is_dcc_markup_Valid() const{
    return m_dcc_markup_isValid;
}

QString OAIPayvision::getDescriptor() const {
    return m_descriptor;
}
void OAIPayvision::setDescriptor(const QString &descriptor) {
    m_descriptor = descriptor;
    m_descriptor_isSet = true;
}

bool OAIPayvision::is_descriptor_Set() const{
    return m_descriptor_isSet;
}

bool OAIPayvision::is_descriptor_Valid() const{
    return m_descriptor_isValid;
}

OAIDigitalWallets OAIPayvision::getDigitalWallets() const {
    return m_digital_wallets;
}
void OAIPayvision::setDigitalWallets(const OAIDigitalWallets &digital_wallets) {
    m_digital_wallets = digital_wallets;
    m_digital_wallets_isSet = true;
}

bool OAIPayvision::is_digital_wallets_Set() const{
    return m_digital_wallets_isSet;
}

bool OAIPayvision::is_digital_wallets_Valid() const{
    return m_digital_wallets_isValid;
}

bool OAIPayvision::isDynamicDescriptor() const {
    return m_dynamic_descriptor;
}
void OAIPayvision::setDynamicDescriptor(const bool &dynamic_descriptor) {
    m_dynamic_descriptor = dynamic_descriptor;
    m_dynamic_descriptor_isSet = true;
}

bool OAIPayvision::is_dynamic_descriptor_Set() const{
    return m_dynamic_descriptor_isSet;
}

bool OAIPayvision::is_dynamic_descriptor_Valid() const{
    return m_dynamic_descriptor_isValid;
}

QList<QString> OAIPayvision::getExcludedDccQuoteCurrencies() const {
    return m_excluded_dcc_quote_currencies;
}
void OAIPayvision::setExcludedDccQuoteCurrencies(const QList<QString> &excluded_dcc_quote_currencies) {
    m_excluded_dcc_quote_currencies = excluded_dcc_quote_currencies;
    m_excluded_dcc_quote_currencies_isSet = true;
}

bool OAIPayvision::is_excluded_dcc_quote_currencies_Set() const{
    return m_excluded_dcc_quote_currencies_isSet;
}

bool OAIPayvision::is_excluded_dcc_quote_currencies_Valid() const{
    return m_excluded_dcc_quote_currencies_isValid;
}

OAIGatewayName OAIPayvision::getGatewayName() const {
    return m_gateway_name;
}
void OAIPayvision::setGatewayName(const OAIGatewayName &gateway_name) {
    m_gateway_name = gateway_name;
    m_gateway_name_isSet = true;
}

bool OAIPayvision::is_gateway_name_Set() const{
    return m_gateway_name_isSet;
}

bool OAIPayvision::is_gateway_name_Valid() const{
    return m_gateway_name_isValid;
}

QString OAIPayvision::getId() const {
    return m_id;
}
void OAIPayvision::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIPayvision::is_id_Set() const{
    return m_id_isSet;
}

bool OAIPayvision::is_id_Valid() const{
    return m_id_isValid;
}

bool OAIPayvision::isIsDown() const {
    return m_is_down;
}
void OAIPayvision::setIsDown(const bool &is_down) {
    m_is_down = is_down;
    m_is_down_isSet = true;
}

bool OAIPayvision::is_is_down_Set() const{
    return m_is_down_isSet;
}

bool OAIPayvision::is_is_down_Valid() const{
    return m_is_down_isValid;
}

QString OAIPayvision::getMerchantCategoryCode() const {
    return m_merchant_category_code;
}
void OAIPayvision::setMerchantCategoryCode(const QString &merchant_category_code) {
    m_merchant_category_code = merchant_category_code;
    m_merchant_category_code_isSet = true;
}

bool OAIPayvision::is_merchant_category_code_Set() const{
    return m_merchant_category_code_isSet;
}

bool OAIPayvision::is_merchant_category_code_Valid() const{
    return m_merchant_category_code_isValid;
}

OAIPaymentMethod OAIPayvision::getMethod() const {
    return m_method;
}
void OAIPayvision::setMethod(const OAIPaymentMethod &method) {
    m_method = method;
    m_method_isSet = true;
}

bool OAIPayvision::is_method_Set() const{
    return m_method_isSet;
}

bool OAIPayvision::is_method_Valid() const{
    return m_method_isValid;
}

double OAIPayvision::getMonthlyLimit() const {
    return m_monthly_limit;
}
void OAIPayvision::setMonthlyLimit(const double &monthly_limit) {
    m_monthly_limit = monthly_limit;
    m_monthly_limit_isSet = true;
}

bool OAIPayvision::is_monthly_limit_Set() const{
    return m_monthly_limit_isSet;
}

bool OAIPayvision::is_monthly_limit_Valid() const{
    return m_monthly_limit_isValid;
}

QString OAIPayvision::getOrganizationId() const {
    return m_organization_id;
}
void OAIPayvision::setOrganizationId(const QString &organization_id) {
    m_organization_id = organization_id;
    m_organization_id_isSet = true;
}

bool OAIPayvision::is_organization_id_Set() const{
    return m_organization_id_isSet;
}

bool OAIPayvision::is_organization_id_Valid() const{
    return m_organization_id_isValid;
}

QList<OAIPaymentCardBrand> OAIPayvision::getPaymentCardSchemes() const {
    return m_payment_card_schemes;
}
void OAIPayvision::setPaymentCardSchemes(const QList<OAIPaymentCardBrand> &payment_card_schemes) {
    m_payment_card_schemes = payment_card_schemes;
    m_payment_card_schemes_isSet = true;
}

bool OAIPayvision::is_payment_card_schemes_Set() const{
    return m_payment_card_schemes_isSet;
}

bool OAIPayvision::is_payment_card_schemes_Valid() const{
    return m_payment_card_schemes_isValid;
}

bool OAIPayvision::isReconciliationWindowEnabled() const {
    return m_reconciliation_window_enabled;
}
void OAIPayvision::setReconciliationWindowEnabled(const bool &reconciliation_window_enabled) {
    m_reconciliation_window_enabled = reconciliation_window_enabled;
    m_reconciliation_window_enabled_isSet = true;
}

bool OAIPayvision::is_reconciliation_window_enabled_Set() const{
    return m_reconciliation_window_enabled_isSet;
}

bool OAIPayvision::is_reconciliation_window_enabled_Valid() const{
    return m_reconciliation_window_enabled_isValid;
}

qint32 OAIPayvision::getReconciliationWindowTtl() const {
    return m_reconciliation_window_ttl;
}
void OAIPayvision::setReconciliationWindowTtl(const qint32 &reconciliation_window_ttl) {
    m_reconciliation_window_ttl = reconciliation_window_ttl;
    m_reconciliation_window_ttl_isSet = true;
}

bool OAIPayvision::is_reconciliation_window_ttl_Set() const{
    return m_reconciliation_window_ttl_isSet;
}

bool OAIPayvision::is_reconciliation_window_ttl_Valid() const{
    return m_reconciliation_window_ttl_isValid;
}

QString OAIPayvision::getStatus() const {
    return m_status;
}
void OAIPayvision::setStatus(const QString &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIPayvision::is_status_Set() const{
    return m_status_isSet;
}

bool OAIPayvision::is_status_Valid() const{
    return m_status_isValid;
}

bool OAIPayvision::isSticky() const {
    return m_sticky;
}
void OAIPayvision::setSticky(const bool &sticky) {
    m_sticky = sticky;
    m_sticky_isSet = true;
}

bool OAIPayvision::is_sticky_Set() const{
    return m_sticky_isSet;
}

bool OAIPayvision::is_sticky_Valid() const{
    return m_sticky_isValid;
}

bool OAIPayvision::isThreeDSecure() const {
    return m_three_d_secure;
}
void OAIPayvision::setThreeDSecure(const bool &three_d_secure) {
    m_three_d_secure = three_d_secure;
    m_three_d_secure_isSet = true;
}

bool OAIPayvision::is_three_d_secure_Set() const{
    return m_three_d_secure_isSet;
}

bool OAIPayvision::is_three_d_secure_Valid() const{
    return m_three_d_secure_isValid;
}

qint32 OAIPayvision::getTimeout() const {
    return m_timeout;
}
void OAIPayvision::setTimeout(const qint32 &timeout) {
    m_timeout = timeout;
    m_timeout_isSet = true;
}

bool OAIPayvision::is_timeout_Set() const{
    return m_timeout_isSet;
}

bool OAIPayvision::is_timeout_Valid() const{
    return m_timeout_isValid;
}

QString OAIPayvision::getToken() const {
    return m_token;
}
void OAIPayvision::setToken(const QString &token) {
    m_token = token;
    m_token_isSet = true;
}

bool OAIPayvision::is_token_Set() const{
    return m_token_isSet;
}

bool OAIPayvision::is_token_Valid() const{
    return m_token_isValid;
}

QDateTime OAIPayvision::getUpdatedTime() const {
    return m_updated_time;
}
void OAIPayvision::setUpdatedTime(const QDateTime &updated_time) {
    m_updated_time = updated_time;
    m_updated_time_isSet = true;
}

bool OAIPayvision::is_updated_time_Set() const{
    return m_updated_time_isSet;
}

bool OAIPayvision::is_updated_time_Valid() const{
    return m_updated_time_isValid;
}

OAIPayvision_allOf_credentials OAIPayvision::getCredentials() const {
    return m_credentials;
}
void OAIPayvision::setCredentials(const OAIPayvision_allOf_credentials &credentials) {
    m_credentials = credentials;
    m_credentials_isSet = true;
}

bool OAIPayvision::is_credentials_Set() const{
    return m_credentials_isSet;
}

bool OAIPayvision::is_credentials_Valid() const{
    return m_credentials_isValid;
}

OAIPayvision_allOf_settings OAIPayvision::getSettings() const {
    return m_settings;
}
void OAIPayvision::setSettings(const OAIPayvision_allOf_settings &settings) {
    m_settings = settings;
    m_settings_isSet = true;
}

bool OAIPayvision::is_settings_Set() const{
    return m_settings_isSet;
}

bool OAIPayvision::is_settings_Valid() const{
    return m_settings_isValid;
}

OAIPayvision3dsServers OAIPayvision::getThreeDSecureServer() const {
    return m_three_d_secure_server;
}
void OAIPayvision::setThreeDSecureServer(const OAIPayvision3dsServers &three_d_secure_server) {
    m_three_d_secure_server = three_d_secure_server;
    m_three_d_secure_server_isSet = true;
}

bool OAIPayvision::is_three_d_secure_server_Set() const{
    return m_three_d_secure_server_isSet;
}

bool OAIPayvision::is_three_d_secure_server_Valid() const{
    return m_three_d_secure_server_isValid;
}

bool OAIPayvision::isSet() const {
...
bool OAIPayvision::isValid() const {
