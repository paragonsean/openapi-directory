...
/*
 * OAIAdyen_allOf_credentials.h
 *
 * Adyen credentials object.
 */

#ifndef OAIAdyen_allOf_credentials_H
#define OAIAdyen_allOf_credentials_H
...
class OAIAdyen_allOf_credentials : public OAIObject {
public:
    OAIAdyen_allOf_credentials();
    OAIAdyen_allOf_credentials(QString json);
    ~OAIAdyen_allOf_credentials() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAdyen_allOf_credentials)

#endif // OAIAdyen_allOf_credentials_H
