...
#ifndef OAIGatewayAccount_H
#define OAIGatewayAccount_H
...
class OAIGatewayAccount : public OAIObject {
public:
    OAIGatewayAccount();
    OAIGatewayAccount(QString json);
    ~OAIGatewayAccount() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGatewayAccount)

#endif // OAIGatewayAccount_H
