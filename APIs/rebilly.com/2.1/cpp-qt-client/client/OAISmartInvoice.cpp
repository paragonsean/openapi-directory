...
OAISmartInvoice::OAISmartInvoice(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISmartInvoice::OAISmartInvoice() {
    this->initializeModel();
}

OAISmartInvoice::~OAISmartInvoice() {}

void OAISmartInvoice::initializeModel() {
...
void OAISmartInvoice::fromJson(QString jsonString) {
...
void OAISmartInvoice::fromJsonObject(QJsonObject json) {
...
QString OAISmartInvoice::asJson() const {
...
QJsonObject OAISmartInvoice::asJsonObject() const {
    QJsonObject obj;
    if (m__links.size() > 0) {
...
QList<OAIGatewayAccount__links_inner> OAISmartInvoice::getLinks() const {
    return m__links;
}
void OAISmartInvoice::setLinks(const QList<OAIGatewayAccount__links_inner> &_links) {
    m__links = _links;
    m__links_isSet = true;
}

bool OAISmartInvoice::is__links_Set() const{
    return m__links_isSet;
}

bool OAISmartInvoice::is__links_Valid() const{
    return m__links_isValid;
}

QList<QString> OAISmartInvoice::getAcceptedCurrencies() const {
    return m_accepted_currencies;
}
void OAISmartInvoice::setAcceptedCurrencies(const QList<QString> &accepted_currencies) {
    m_accepted_currencies = accepted_currencies;
    m_accepted_currencies_isSet = true;
}

bool OAISmartInvoice::is_accepted_currencies_Set() const{
    return m_accepted_currencies_isSet;
}

bool OAISmartInvoice::is_accepted_currencies_Valid() const{
    return m_accepted_currencies_isValid;
}

OAIAcquirerName OAISmartInvoice::getAcquirerName() const {
    return m_acquirer_name;
}
void OAISmartInvoice::setAcquirerName(const OAIAcquirerName &acquirer_name) {
    m_acquirer_name = acquirer_name;
    m_acquirer_name_isSet = true;
}

bool OAISmartInvoice::is_acquirer_name_Set() const{
    return m_acquirer_name_isSet;
}

bool OAISmartInvoice::is_acquirer_name_Valid() const{
    return m_acquirer_name_isValid;
}

QString OAISmartInvoice::getAdditionalFilters() const {
    return m_additional_filters;
}
void OAISmartInvoice::setAdditionalFilters(const QString &additional_filters) {
    m_additional_filters = additional_filters;
    m_additional_filters_isSet = true;
}

bool OAISmartInvoice::is_additional_filters_Set() const{
    return m_additional_filters_isSet;
}

bool OAISmartInvoice::is_additional_filters_Valid() const{
    return m_additional_filters_isValid;
}

qint32 OAISmartInvoice::getApprovalWindowTtl() const {
    return m_approval_window_ttl;
}
void OAISmartInvoice::setApprovalWindowTtl(const qint32 &approval_window_ttl) {
    m_approval_window_ttl = approval_window_ttl;
    m_approval_window_ttl_isSet = true;
}

bool OAISmartInvoice::is_approval_window_ttl_Set() const{
    return m_approval_window_ttl_isSet;
}

bool OAISmartInvoice::is_approval_window_ttl_Valid() const{
    return m_approval_window_ttl_isValid;
}

QString OAISmartInvoice::getCityField() const {
    return m_city_field;
}
void OAISmartInvoice::setCityField(const QString &city_field) {
    m_city_field = city_field;
    m_city_field_isSet = true;
}

bool OAISmartInvoice::is_city_field_Set() const{
    return m_city_field_isSet;
}

bool OAISmartInvoice::is_city_field_Valid() const{
    return m_city_field_isValid;
}

QDateTime OAISmartInvoice::getCreatedTime() const {
    return m_created_time;
}
void OAISmartInvoice::setCreatedTime(const QDateTime &created_time) {
    m_created_time = created_time;
    m_created_time_isSet = true;
}

bool OAISmartInvoice::is_created_time_Set() const{
    return m_created_time_isSet;
}

bool OAISmartInvoice::is_created_time_Valid() const{
    return m_created_time_isValid;
}

QString OAISmartInvoice::getDccForceCurrency() const {
    return m_dcc_force_currency;
}
void OAISmartInvoice::setDccForceCurrency(const QString &dcc_force_currency) {
    m_dcc_force_currency = dcc_force_currency;
    m_dcc_force_currency_isSet = true;
}

bool OAISmartInvoice::is_dcc_force_currency_Set() const{
    return m_dcc_force_currency_isSet;
}

bool OAISmartInvoice::is_dcc_force_currency_Valid() const{
    return m_dcc_force_currency_isValid;
}

qint32 OAISmartInvoice::getDccMarkup() const {
    return m_dcc_markup;
}
void OAISmartInvoice::setDccMarkup(const qint32 &dcc_markup) {
    m_dcc_markup = dcc_markup;
    m_dcc_markup_isSet = true;
}

bool OAISmartInvoice::is_dcc_markup_Set() const{
    return m_dcc_markup_isSet;
}

bool OAISmartInvoice::is_dcc_markup_Valid() const{
    return m_dcc_markup_isValid;
}

QString OAISmartInvoice::getDescriptor() const {
    return m_descriptor;
}
void OAISmartInvoice::setDescriptor(const QString &descriptor) {
    m_descriptor = descriptor;
    m_descriptor_isSet = true;
}

bool OAISmartInvoice::is_descriptor_Set() const{
    return m_descriptor_isSet;
}

bool OAISmartInvoice::is_descriptor_Valid() const{
    return m_descriptor_isValid;
}

OAIDigitalWallets OAISmartInvoice::getDigitalWallets() const {
    return m_digital_wallets;
}
void OAISmartInvoice::setDigitalWallets(const OAIDigitalWallets &digital_wallets) {
    m_digital_wallets = digital_wallets;
    m_digital_wallets_isSet = true;
}

bool OAISmartInvoice::is_digital_wallets_Set() const{
    return m_digital_wallets_isSet;
}

bool OAISmartInvoice::is_digital_wallets_Valid() const{
    return m_digital_wallets_isValid;
}

bool OAISmartInvoice::isDynamicDescriptor() const {
    return m_dynamic_descriptor;
}
void OAISmartInvoice::setDynamicDescriptor(const bool &dynamic_descriptor) {
    m_dynamic_descriptor = dynamic_descriptor;
    m_dynamic_descriptor_isSet = true;
}

bool OAISmartInvoice::is_dynamic_descriptor_Set() const{
    return m_dynamic_descriptor_isSet;
}

bool OAISmartInvoice::is_dynamic_descriptor_Valid() const{
    return m_dynamic_descriptor_isValid;
}

QList<QString> OAISmartInvoice::getExcludedDccQuoteCurrencies() const {
    return m_excluded_dcc_quote_currencies;
}
void OAISmartInvoice::setExcludedDccQuoteCurrencies(const QList<QString> &excluded_dcc_quote_currencies) {
    m_excluded_dcc_quote_currencies = excluded_dcc_quote_currencies;
    m_excluded_dcc_quote_currencies_isSet = true;
}

bool OAISmartInvoice::is_excluded_dcc_quote_currencies_Set() const{
    return m_excluded_dcc_quote_currencies_isSet;
}

bool OAISmartInvoice::is_excluded_dcc_quote_currencies_Valid() const{
    return m_excluded_dcc_quote_currencies_isValid;
}

OAIGatewayName OAISmartInvoice::getGatewayName() const {
    return m_gateway_name;
}
void OAISmartInvoice::setGatewayName(const OAIGatewayName &gateway_name) {
    m_gateway_name = gateway_name;
    m_gateway_name_isSet = true;
}

bool OAISmartInvoice::is_gateway_name_Set() const{
    return m_gateway_name_isSet;
}

bool OAISmartInvoice::is_gateway_name_Valid() const{
    return m_gateway_name_isValid;
}

QString OAISmartInvoice::getId() const {
    return m_id;
}
void OAISmartInvoice::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAISmartInvoice::is_id_Set() const{
    return m_id_isSet;
}

bool OAISmartInvoice::is_id_Valid() const{
    return m_id_isValid;
}

bool OAISmartInvoice::isIsDown() const {
    return m_is_down;
}
void OAISmartInvoice::setIsDown(const bool &is_down) {
    m_is_down = is_down;
    m_is_down_isSet = true;
}

bool OAISmartInvoice::is_is_down_Set() const{
    return m_is_down_isSet;
}

bool OAISmartInvoice::is_is_down_Valid() const{
    return m_is_down_isValid;
}

QString OAISmartInvoice::getMerchantCategoryCode() const {
    return m_merchant_category_code;
}
void OAISmartInvoice::setMerchantCategoryCode(const QString &merchant_category_code) {
    m_merchant_category_code = merchant_category_code;
    m_merchant_category_code_isSet = true;
}

bool OAISmartInvoice::is_merchant_category_code_Set() const{
    return m_merchant_category_code_isSet;
}

bool OAISmartInvoice::is_merchant_category_code_Valid() const{
    return m_merchant_category_code_isValid;
}

OAIPaymentMethod OAISmartInvoice::getMethod() const {
    return m_method;
}
void OAISmartInvoice::setMethod(const OAIPaymentMethod &method) {
    m_method = method;
    m_method_isSet = true;
}

bool OAISmartInvoice::is_method_Set() const{
    return m_method_isSet;
}

bool OAISmartInvoice::is_method_Valid() const{
    return m_method_isValid;
}

double OAISmartInvoice::getMonthlyLimit() const {
    return m_monthly_limit;
}
void OAISmartInvoice::setMonthlyLimit(const double &monthly_limit) {
    m_monthly_limit = monthly_limit;
    m_monthly_limit_isSet = true;
}

bool OAISmartInvoice::is_monthly_limit_Set() const{
    return m_monthly_limit_isSet;
}

bool OAISmartInvoice::is_monthly_limit_Valid() const{
    return m_monthly_limit_isValid;
}

QString OAISmartInvoice::getOrganizationId() const {
    return m_organization_id;
}
void OAISmartInvoice::setOrganizationId(const QString &organization_id) {
    m_organization_id = organization_id;
    m_organization_id_isSet = true;
}

bool OAISmartInvoice::is_organization_id_Set() const{
    return m_organization_id_isSet;
}

bool OAISmartInvoice::is_organization_id_Valid() const{
    return m_organization_id_isValid;
}

QList<OAIPaymentCardBrand> OAISmartInvoice::getPaymentCardSchemes() const {
    return m_payment_card_schemes;
}
void OAISmartInvoice::setPaymentCardSchemes(const QList<OAIPaymentCardBrand> &payment_card_schemes) {
    m_payment_card_schemes = payment_card_schemes;
    m_payment_card_schemes_isSet = true;
}

bool OAISmartInvoice::is_payment_card_schemes_Set() const{
    return m_payment_card_schemes_isSet;
}

bool OAISmartInvoice::is_payment_card_schemes_Valid() const{
    return m_payment_card_schemes_isValid;
}

bool OAISmartInvoice::isReconciliationWindowEnabled() const {
    return m_reconciliation_window_enabled;
}
void OAISmartInvoice::setReconciliationWindowEnabled(const bool &reconciliation_window_enabled) {
    m_reconciliation_window_enabled = reconciliation_window_enabled;
    m_reconciliation_window_enabled_isSet = true;
}

bool OAISmartInvoice::is_reconciliation_window_enabled_Set() const{
    return m_reconciliation_window_enabled_isSet;
}

bool OAISmartInvoice::is_reconciliation_window_enabled_Valid() const{
    return m_reconciliation_window_enabled_isValid;
}

qint32 OAISmartInvoice::getReconciliationWindowTtl() const {
    return m_reconciliation_window_ttl;
}
void OAISmartInvoice::setReconciliationWindowTtl(const qint32 &reconciliation_window_ttl) {
    m_reconciliation_window_ttl = reconciliation_window_ttl;
    m_reconciliation_window_ttl_isSet = true;
}

bool OAISmartInvoice::is_reconciliation_window_ttl_Set() const{
    return m_reconciliation_window_ttl_isSet;
}

bool OAISmartInvoice::is_reconciliation_window_ttl_Valid() const{
    return m_reconciliation_window_ttl_isValid;
}

QString OAISmartInvoice::getStatus() const {
    return m_status;
}
void OAISmartInvoice::setStatus(const QString &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAISmartInvoice::is_status_Set() const{
    return m_status_isSet;
}

bool OAISmartInvoice::is_status_Valid() const{
    return m_status_isValid;
}

bool OAISmartInvoice::isSticky() const {
    return m_sticky;
}
void OAISmartInvoice::setSticky(const bool &sticky) {
    m_sticky = sticky;
    m_sticky_isSet = true;
}

bool OAISmartInvoice::is_sticky_Set() const{
    return m_sticky_isSet;
}

bool OAISmartInvoice::is_sticky_Valid() const{
    return m_sticky_isValid;
}

bool OAISmartInvoice::isThreeDSecure() const {
    return m_three_d_secure;
}
void OAISmartInvoice::setThreeDSecure(const bool &three_d_secure) {
    m_three_d_secure = three_d_secure;
    m_three_d_secure_isSet = true;
}

bool OAISmartInvoice::is_three_d_secure_Set() const{
    return m_three_d_secure_isSet;
}

bool OAISmartInvoice::is_three_d_secure_Valid() const{
    return m_three_d_secure_isValid;
}

qint32 OAISmartInvoice::getTimeout() const {
    return m_timeout;
}
void OAISmartInvoice::setTimeout(const qint32 &timeout) {
    m_timeout = timeout;
    m_timeout_isSet = true;
}

bool OAISmartInvoice::is_timeout_Set() const{
    return m_timeout_isSet;
}

bool OAISmartInvoice::is_timeout_Valid() const{
    return m_timeout_isValid;
}

QString OAISmartInvoice::getToken() const {
    return m_token;
}
void OAISmartInvoice::setToken(const QString &token) {
    m_token = token;
    m_token_isSet = true;
}

bool OAISmartInvoice::is_token_Set() const{
    return m_token_isSet;
}

bool OAISmartInvoice::is_token_Valid() const{
    return m_token_isValid;
}

QDateTime OAISmartInvoice::getUpdatedTime() const {
    return m_updated_time;
}
void OAISmartInvoice::setUpdatedTime(const QDateTime &updated_time) {
    m_updated_time = updated_time;
    m_updated_time_isSet = true;
}

bool OAISmartInvoice::is_updated_time_Set() const{
    return m_updated_time_isSet;
}

bool OAISmartInvoice::is_updated_time_Valid() const{
    return m_updated_time_isValid;
}

OAISmartInvoice_allOf_credentials OAISmartInvoice::getCredentials() const {
    return m_credentials;
}
void OAISmartInvoice::setCredentials(const OAISmartInvoice_allOf_credentials &credentials) {
    m_credentials = credentials;
    m_credentials_isSet = true;
}

bool OAISmartInvoice::is_credentials_Set() const{
    return m_credentials_isSet;
}

bool OAISmartInvoice::is_credentials_Valid() const{
    return m_credentials_isValid;
}

OAISmartInvoice3dsServers OAISmartInvoice::getThreeDSecureServer() const {
    return m_three_d_secure_server;
}
void OAISmartInvoice::setThreeDSecureServer(const OAISmartInvoice3dsServers &three_d_secure_server) {
    m_three_d_secure_server = three_d_secure_server;
    m_three_d_secure_server_isSet = true;
}

bool OAISmartInvoice::is_three_d_secure_server_Set() const{
    return m_three_d_secure_server_isSet;
}

bool OAISmartInvoice::is_three_d_secure_server_Valid() const{
    return m_three_d_secure_server_isValid;
}

bool OAISmartInvoice::isSet() const {
...
bool OAISmartInvoice::isValid() const {
