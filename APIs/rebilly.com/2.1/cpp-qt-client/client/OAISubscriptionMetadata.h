...
/*
 * OAISubscriptionMetadata.h
 *
 * 
 */

#ifndef OAISubscriptionMetadata_H
#define OAISubscriptionMetadata_H
...
#include "OAISubscriptionMetadata__links_inner.h"
#include <QDateTime>
#include <QList>
...
namespace OpenAPI {
class OAISubscriptionMetadata__embedded_inner;
class OAISubscriptionMetadata__links_inner;
class OAIRiskMetadata;

class OAISubscriptionMetadata : public OAIObject {
public:
    OAISubscriptionMetadata();
    OAISubscriptionMetadata(QString json);
    ~OAISubscriptionMetadata() override;
    ...
    QList<OAISubscriptionMetadata__embedded_inner> getEmbedded() const;
    void setEmbedded(const QList<OAISubscriptionMetadata__embedded_inner> &_embedded);
    bool is__embedded_Set() const;
    bool is__embedded_Valid() const;

    QList<OAISubscriptionMetadata__links_inner> getLinks() const;
    void setLinks(const QList<OAISubscriptionMetadata__links_inner> &_links);
...
private:
    ...
    QList<OAISubscriptionMetadata__embedded_inner> m__embedded;
    bool m__embedded_isSet;
    bool m__embedded_isValid;

    QList<OAISubscriptionMetadata__links_inner> m__links;
    bool m__links_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAISubscriptionMetadata)

#endif // OAISubscriptionMetadata_H
