...
class OAISagepay_allOf_credentials;

class OAISagepay : public OAIObject {
public:
    OAISagepay();
    OAISagepay(QString json);
    ~OAISagepay() override;
    ...
    OAISagepay_allOf_credentials getCredentials() const;
    void setCredentials(const OAISagepay_allOf_credentials &credentials);
...
private:
    ...
    OAISagepay_allOf_credentials m_credentials;
...
Q_DECLARE_METATYPE(OpenAPI::OAISagepay)
