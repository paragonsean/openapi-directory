...
#ifndef OAIGpaysafe_H
#define OAIGpaysafe_H
...
class OAIGpaysafe_allOf_credentials;

class OAIGpaysafe : public OAIObject {
public:
    OAIGpaysafe();
    OAIGpaysafe(QString json);
    ~OAIGpaysafe() override;
    ...
    OAIGpaysafe_allOf_credentials getCredentials() const;
    void setCredentials(const OAIGpaysafe_allOf_credentials &credentials);
...
private:
    ...
    OAIGpaysafe_allOf_credentials m_credentials;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGpaysafe)
