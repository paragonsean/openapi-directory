...
OAIInovio::OAIInovio(QString json) {
...
void OAIInovio::initializeModel() {
...
void OAIInovio::fromJson(QString jsonString) {
...
void OAIInovio::fromJsonObject(QJsonObject json) {
...
QString OAIInovio::asJson() const {
...
QJsonObject OAIInovio::asJsonObject() const {
    QJsonObject obj;
    if (m__links.size() > 0) {
...
QList<OAIGatewayAccount__links_inner> OAIInovio::getLinks() const {
    return m__links;
}
void OAIInovio::setLinks(const QList<OAIGatewayAccount__links_inner> &_links) {
    m__links = _links;
    m__links_isSet = true;
}

bool OAIInovio::is__links_Set() const{
    return m__links_isSet;
}

bool OAIInovio::is__links_Valid() const{
    return m__links_isValid;
}

QList<QString> OAIInovio::getAcceptedCurrencies() const {
    return m_accepted_currencies;
}
void OAIInovio::setAcceptedCurrencies(const QList<QString> &accepted_currencies) {
    m_accepted_currencies = accepted_currencies;
    m_accepted_currencies_isSet = true;
}

bool OAIInovio::is_accepted_currencies_Set() const{
    return m_accepted_currencies_isSet;
}

bool OAIInovio::is_accepted_currencies_Valid() const{
    return m_accepted_currencies_isValid;
}

OAIAcquirerName OAIInovio::getAcquirerName() const {
    return m_acquirer_name;
}
void OAIInovio::setAcquirerName(const OAIAcquirerName &acquirer_name) {
    m_acquirer_name = acquirer_name;
    m_acquirer_name_isSet = true;
}

bool OAIInovio::is_acquirer_name_Set() const{
    return m_acquirer_name_isSet;
}

bool OAIInovio::is_acquirer_name_Valid() const{
    return m_acquirer_name_isValid;
}

QString OAIInovio::getAdditionalFilters() const {
    return m_additional_filters;
}
void OAIInovio::setAdditionalFilters(const QString &additional_filters) {
    m_additional_filters = additional_filters;
    m_additional_filters_isSet = true;
}

bool OAIInovio::is_additional_filters_Set() const{
    return m_additional_filters_isSet;
}

bool OAIInovio::is_additional_filters_Valid() const{
    return m_additional_filters_isValid;
}

qint32 OAIInovio::getApprovalWindowTtl() const {
    return m_approval_window_ttl;
}
void OAIInovio::setApprovalWindowTtl(const qint32 &approval_window_ttl) {
    m_approval_window_ttl = approval_window_ttl;
    m_approval_window_ttl_isSet = true;
}

bool OAIInovio::is_approval_window_ttl_Set() const{
    return m_approval_window_ttl_isSet;
}

bool OAIInovio::is_approval_window_ttl_Valid() const{
    return m_approval_window_ttl_isValid;
}

QString OAIInovio::getCityField() const {
    return m_city_field;
}
void OAIInovio::setCityField(const QString &city_field) {
    m_city_field = city_field;
    m_city_field_isSet = true;
}

bool OAIInovio::is_city_field_Set() const{
    return m_city_field_isSet;
}

bool OAIInovio::is_city_field_Valid() const{
    return m_city_field_isValid;
}

QDateTime OAIInovio::getCreatedTime() const {
    return m_created_time;
}
void OAIInovio::setCreatedTime(const QDateTime &created_time) {
    m_created_time = created_time;
    m_created_time_isSet = true;
}

bool OAIInovio::is_created_time_Set() const{
    return m_created_time_isSet;
}

bool OAIInovio::is_created_time_Valid() const{
    return m_created_time_isValid;
}

QString OAIInovio::getDccForceCurrency() const {
    return m_dcc_force_currency;
}
void OAIInovio::setDccForceCurrency(const QString &dcc_force_currency) {
    m_dcc_force_currency = dcc_force_currency;
    m_dcc_force_currency_isSet = true;
}

bool OAIInovio::is_dcc_force_currency_Set() const{
    return m_dcc_force_currency_isSet;
}

bool OAIInovio::is_dcc_force_currency_Valid() const{
    return m_dcc_force_currency_isValid;
}

qint32 OAIInovio::getDccMarkup() const {
    return m_dcc_markup;
}
void OAIInovio::setDccMarkup(const qint32 &dcc_markup) {
    m_dcc_markup = dcc_markup;
    m_dcc_markup_isSet = true;
}

bool OAIInovio::is_dcc_markup_Set() const{
    return m_dcc_markup_isSet;
}

bool OAIInovio::is_dcc_markup_Valid() const{
    return m_dcc_markup_isValid;
}

QString OAIInovio::getDescriptor() const {
    return m_descriptor;
}
void OAIInovio::setDescriptor(const QString &descriptor) {
    m_descriptor = descriptor;
    m_descriptor_isSet = true;
}

bool OAIInovio::is_descriptor_Set() const{
    return m_descriptor_isSet;
}

bool OAIInovio::is_descriptor_Valid() const{
    return m_descriptor_isValid;
}

OAIDigitalWallets OAIInovio::getDigitalWallets() const {
    return m_digital_wallets;
}
void OAIInovio::setDigitalWallets(const OAIDigitalWallets &digital_wallets) {
    m_digital_wallets = digital_wallets;
    m_digital_wallets_isSet = true;
}

bool OAIInovio::is_digital_wallets_Set() const{
    return m_digital_wallets_isSet;
}

bool OAIInovio::is_digital_wallets_Valid() const{
    return m_digital_wallets_isValid;
}

bool OAIInovio::isDynamicDescriptor() const {
    return m_dynamic_descriptor;
}
void OAIInovio::setDynamicDescriptor(const bool &dynamic_descriptor) {
    m_dynamic_descriptor = dynamic_descriptor;
    m_dynamic_descriptor_isSet = true;
}

bool OAIInovio::is_dynamic_descriptor_Set() const{
    return m_dynamic_descriptor_isSet;
}

bool OAIInovio::is_dynamic_descriptor_Valid() const{
    return m_dynamic_descriptor_isValid;
}

QList<QString> OAIInovio::getExcludedDccQuoteCurrencies() const {
    return m_excluded_dcc_quote_currencies;
}
void OAIInovio::setExcludedDccQuoteCurrencies(const QList<QString> &excluded_dcc_quote_currencies) {
    m_excluded_dcc_quote_currencies = excluded_dcc_quote_currencies;
    m_excluded_dcc_quote_currencies_isSet = true;
}

bool OAIInovio::is_excluded_dcc_quote_currencies_Set() const{
    return m_excluded_dcc_quote_currencies_isSet;
}

bool OAIInovio::is_excluded_dcc_quote_currencies_Valid() const{
    return m_excluded_dcc_quote_currencies_isValid;
}

OAIGatewayName OAIInovio::getGatewayName() const {
    return m_gateway_name;
}
void OAIInovio::setGatewayName(const OAIGatewayName &gateway_name) {
    m_gateway_name = gateway_name;
    m_gateway_name_isSet = true;
}

bool OAIInovio::is_gateway_name_Set() const{
    return m_gateway_name_isSet;
}

bool OAIInovio::is_gateway_name_Valid() const{
    return m_gateway_name_isValid;
}

QString OAIInovio::getId() const {
    return m_id;
}
void OAIInovio::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIInovio::is_id_Set() const{
    return m_id_isSet;
}

bool OAIInovio::is_id_Valid() const{
    return m_id_isValid;
}

bool OAIInovio::isIsDown() const {
    return m_is_down;
}
void OAIInovio::setIsDown(const bool &is_down) {
    m_is_down = is_down;
    m_is_down_isSet = true;
}

bool OAIInovio::is_is_down_Set() const{
    return m_is_down_isSet;
}

bool OAIInovio::is_is_down_Valid() const{
    return m_is_down_isValid;
}

QString OAIInovio::getMerchantCategoryCode() const {
    return m_merchant_category_code;
}
void OAIInovio::setMerchantCategoryCode(const QString &merchant_category_code) {
    m_merchant_category_code = merchant_category_code;
    m_merchant_category_code_isSet = true;
}

bool OAIInovio::is_merchant_category_code_Set() const{
    return m_merchant_category_code_isSet;
}

bool OAIInovio::is_merchant_category_code_Valid() const{
    return m_merchant_category_code_isValid;
}

OAIPaymentMethod OAIInovio::getMethod() const {
    return m_method;
}
void OAIInovio::setMethod(const OAIPaymentMethod &method) {
    m_method = method;
    m_method_isSet = true;
}

bool OAIInovio::is_method_Set() const{
    return m_method_isSet;
}

bool OAIInovio::is_method_Valid() const{
    return m_method_isValid;
}

double OAIInovio::getMonthlyLimit() const {
    return m_monthly_limit;
}
void OAIInovio::setMonthlyLimit(const double &monthly_limit) {
    m_monthly_limit = monthly_limit;
    m_monthly_limit_isSet = true;
}

bool OAIInovio::is_monthly_limit_Set() const{
    return m_monthly_limit_isSet;
}

bool OAIInovio::is_monthly_limit_Valid() const{
    return m_monthly_limit_isValid;
}

QString OAIInovio::getOrganizationId() const {
    return m_organization_id;
}
void OAIInovio::setOrganizationId(const QString &organization_id) {
    m_organization_id = organization_id;
    m_organization_id_isSet = true;
}

bool OAIInovio::is_organization_id_Set() const{
    return m_organization_id_isSet;
}

bool OAIInovio::is_organization_id_Valid() const{
    return m_organization_id_isValid;
}

QList<OAIPaymentCardBrand> OAIInovio::getPaymentCardSchemes() const {
    return m_payment_card_schemes;
}
void OAIInovio::setPaymentCardSchemes(const QList<OAIPaymentCardBrand> &payment_card_schemes) {
    m_payment_card_schemes = payment_card_schemes;
    m_payment_card_schemes_isSet = true;
}

bool OAIInovio::is_payment_card_schemes_Set() const{
    return m_payment_card_schemes_isSet;
}

bool OAIInovio::is_payment_card_schemes_Valid() const{
    return m_payment_card_schemes_isValid;
}

bool OAIInovio::isReconciliationWindowEnabled() const {
    return m_reconciliation_window_enabled;
}
void OAIInovio::setReconciliationWindowEnabled(const bool &reconciliation_window_enabled) {
    m_reconciliation_window_enabled = reconciliation_window_enabled;
    m_reconciliation_window_enabled_isSet = true;
}

bool OAIInovio::is_reconciliation_window_enabled_Set() const{
    return m_reconciliation_window_enabled_isSet;
}

bool OAIInovio::is_reconciliation_window_enabled_Valid() const{
    return m_reconciliation_window_enabled_isValid;
}

qint32 OAIInovio::getReconciliationWindowTtl() const {
    return m_reconciliation_window_ttl;
}
void OAIInovio::setReconciliationWindowTtl(const qint32 &reconciliation_window_ttl) {
    m_reconciliation_window_ttl = reconciliation_window_ttl;
    m_reconciliation_window_ttl_isSet = true;
}

bool OAIInovio::is_reconciliation_window_ttl_Set() const{
    return m_reconciliation_window_ttl_isSet;
}

bool OAIInovio::is_reconciliation_window_ttl_Valid() const{
    return m_reconciliation_window_ttl_isValid;
}

QString OAIInovio::getStatus() const {
    return m_status;
}
void OAIInovio::setStatus(const QString &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIInovio::is_status_Set() const{
    return m_status_isSet;
}

bool OAIInovio::is_status_Valid() const{
    return m_status_isValid;
}

bool OAIInovio::isSticky() const {
    return m_sticky;
}
void OAIInovio::setSticky(const bool &sticky) {
    m_sticky = sticky;
    m_sticky_isSet = true;
}

bool OAIInovio::is_sticky_Set() const{
    return m_sticky_isSet;
}

bool OAIInovio::is_sticky_Valid() const{
    return m_sticky_isValid;
}

bool OAIInovio::isThreeDSecure() const {
    return m_three_d_secure;
}
void OAIInovio::setThreeDSecure(const bool &three_d_secure) {
    m_three_d_secure = three_d_secure;
    m_three_d_secure_isSet = true;
}

bool OAIInovio::is_three_d_secure_Set() const{
    return m_three_d_secure_isSet;
}

bool OAIInovio::is_three_d_secure_Valid() const{
    return m_three_d_secure_isValid;
}

qint32 OAIInovio::getTimeout() const {
    return m_timeout;
}
void OAIInovio::setTimeout(const qint32 &timeout) {
    m_timeout = timeout;
    m_timeout_isSet = true;
}

bool OAIInovio::is_timeout_Set() const{
    return m_timeout_isSet;
}

bool OAIInovio::is_timeout_Valid() const{
    return m_timeout_isValid;
}

QString OAIInovio::getToken() const {
    return m_token;
}
void OAIInovio::setToken(const QString &token) {
    m_token = token;
    m_token_isSet = true;
}

bool OAIInovio::is_token_Set() const{
    return m_token_isSet;
}

bool OAIInovio::is_token_Valid() const{
    return m_token_isValid;
}

QDateTime OAIInovio::getUpdatedTime() const {
    return m_updated_time;
}
void OAIInovio::setUpdatedTime(const QDateTime &updated_time) {
    m_updated_time = updated_time;
    m_updated_time_isSet = true;
}

bool OAIInovio::is_updated_time_Set() const{
    return m_updated_time_isSet;
}

bool OAIInovio::is_updated_time_Valid() const{
    return m_updated_time_isValid;
}

OAIInovio_allOf_credentials OAIInovio::getCredentials() const {
    return m_credentials;
}
void OAIInovio::setCredentials(const OAIInovio_allOf_credentials &credentials) {
    m_credentials = credentials;
    m_credentials_isSet = true;
}

bool OAIInovio::is_credentials_Set() const{
    return m_credentials_isSet;
}

bool OAIInovio::is_credentials_Valid() const{
    return m_credentials_isValid;
}

OAIInovio_allOf_settings OAIInovio::getSettings() const {
    return m_settings;
}
void OAIInovio::setSettings(const OAIInovio_allOf_settings &settings) {
    m_settings = settings;
    m_settings_isSet = true;
}

bool OAIInovio::is_settings_Set() const{
    return m_settings_isSet;
}

bool OAIInovio::is_settings_Valid() const{
    return m_settings_isValid;
}

OAIInovio3dsServers OAIInovio::getThreeDSecureServer() const {
    return m_three_d_secure_server;
}
void OAIInovio::setThreeDSecureServer(const OAIInovio3dsServers &three_d_secure_server) {
    m_three_d_secure_server = three_d_secure_server;
    m_three_d_secure_server_isSet = true;
}

bool OAIInovio::is_three_d_secure_server_Set() const{
    return m_three_d_secure_server_isSet;
}

bool OAIInovio::is_three_d_secure_server_Valid() const{
    return m_three_d_secure_server_isValid;
}

bool OAIInovio::isSet() const {
