...
/*
 * OAIAlternativePaymentToken.h
 *
 * 
 */

#ifndef OAIAlternativePaymentToken_H
#define OAIAlternativePaymentToken_H
...
class OAIAlternativePaymentToken : public OAIObject {
public:
    OAIAlternativePaymentToken();
    OAIAlternativePaymentToken(QString json);
    ~OAIAlternativePaymentToken() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAlternativePaymentToken)

#endif // OAIAlternativePaymentToken_H
