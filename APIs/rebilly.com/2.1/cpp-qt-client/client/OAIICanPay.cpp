...
OAIICanPay::OAIICanPay(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIICanPay::OAIICanPay() {
    this->initializeModel();
}

OAIICanPay::~OAIICanPay() {}

void OAIICanPay::initializeModel() {
...
void OAIICanPay::fromJson(QString jsonString) {
...
void OAIICanPay::fromJsonObject(QJsonObject json) {
...
QString OAIICanPay::asJson() const {
...
QJsonObject OAIICanPay::asJsonObject() const {
    QJsonObject obj;
    if (m__links.size() > 0) {
...
QList<OAIGatewayAccount__links_inner> OAIICanPay::getLinks() const {
    return m__links;
}
void OAIICanPay::setLinks(const QList<OAIGatewayAccount__links_inner> &_links) {
    m__links = _links;
    m__links_isSet = true;
}

bool OAIICanPay::is__links_Set() const{
    return m__links_isSet;
}

bool OAIICanPay::is__links_Valid() const{
    return m__links_isValid;
}

QList<QString> OAIICanPay::getAcceptedCurrencies() const {
    return m_accepted_currencies;
}
void OAIICanPay::setAcceptedCurrencies(const QList<QString> &accepted_currencies) {
    m_accepted_currencies = accepted_currencies;
    m_accepted_currencies_isSet = true;
}

bool OAIICanPay::is_accepted_currencies_Set() const{
    return m_accepted_currencies_isSet;
}

bool OAIICanPay::is_accepted_currencies_Valid() const{
    return m_accepted_currencies_isValid;
}

OAIAcquirerName OAIICanPay::getAcquirerName() const {
    return m_acquirer_name;
}
void OAIICanPay::setAcquirerName(const OAIAcquirerName &acquirer_name) {
    m_acquirer_name = acquirer_name;
    m_acquirer_name_isSet = true;
}

bool OAIICanPay::is_acquirer_name_Set() const{
    return m_acquirer_name_isSet;
}

bool OAIICanPay::is_acquirer_name_Valid() const{
    return m_acquirer_name_isValid;
}

QString OAIICanPay::getAdditionalFilters() const {
    return m_additional_filters;
}
void OAIICanPay::setAdditionalFilters(const QString &additional_filters) {
    m_additional_filters = additional_filters;
    m_additional_filters_isSet = true;
}

bool OAIICanPay::is_additional_filters_Set() const{
    return m_additional_filters_isSet;
}

bool OAIICanPay::is_additional_filters_Valid() const{
    return m_additional_filters_isValid;
}

qint32 OAIICanPay::getApprovalWindowTtl() const {
    return m_approval_window_ttl;
}
void OAIICanPay::setApprovalWindowTtl(const qint32 &approval_window_ttl) {
    m_approval_window_ttl = approval_window_ttl;
    m_approval_window_ttl_isSet = true;
}

bool OAIICanPay::is_approval_window_ttl_Set() const{
    return m_approval_window_ttl_isSet;
}

bool OAIICanPay::is_approval_window_ttl_Valid() const{
    return m_approval_window_ttl_isValid;
}

QString OAIICanPay::getCityField() const {
    return m_city_field;
}
void OAIICanPay::setCityField(const QString &city_field) {
    m_city_field = city_field;
    m_city_field_isSet = true;
}

bool OAIICanPay::is_city_field_Set() const{
    return m_city_field_isSet;
}

bool OAIICanPay::is_city_field_Valid() const{
    return m_city_field_isValid;
}

QDateTime OAIICanPay::getCreatedTime() const {
    return m_created_time;
}
void OAIICanPay::setCreatedTime(const QDateTime &created_time) {
    m_created_time = created_time;
    m_created_time_isSet = true;
}

bool OAIICanPay::is_created_time_Set() const{
    return m_created_time_isSet;
}

bool OAIICanPay::is_created_time_Valid() const{
    return m_created_time_isValid;
}

QString OAIICanPay::getDccForceCurrency() const {
    return m_dcc_force_currency;
}
void OAIICanPay::setDccForceCurrency(const QString &dcc_force_currency) {
    m_dcc_force_currency = dcc_force_currency;
    m_dcc_force_currency_isSet = true;
}

bool OAIICanPay::is_dcc_force_currency_Set() const{
    return m_dcc_force_currency_isSet;
}

bool OAIICanPay::is_dcc_force_currency_Valid() const{
    return m_dcc_force_currency_isValid;
}

qint32 OAIICanPay::getDccMarkup() const {
    return m_dcc_markup;
}
void OAIICanPay::setDccMarkup(const qint32 &dcc_markup) {
    m_dcc_markup = dcc_markup;
    m_dcc_markup_isSet = true;
}

bool OAIICanPay::is_dcc_markup_Set() const{
    return m_dcc_markup_isSet;
}

bool OAIICanPay::is_dcc_markup_Valid() const{
    return m_dcc_markup_isValid;
}

QString OAIICanPay::getDescriptor() const {
    return m_descriptor;
}
void OAIICanPay::setDescriptor(const QString &descriptor) {
    m_descriptor = descriptor;
    m_descriptor_isSet = true;
}

bool OAIICanPay::is_descriptor_Set() const{
    return m_descriptor_isSet;
}

bool OAIICanPay::is_descriptor_Valid() const{
    return m_descriptor_isValid;
}

OAIDigitalWallets OAIICanPay::getDigitalWallets() const {
    return m_digital_wallets;
}
void OAIICanPay::setDigitalWallets(const OAIDigitalWallets &digital_wallets) {
    m_digital_wallets = digital_wallets;
    m_digital_wallets_isSet = true;
}

bool OAIICanPay::is_digital_wallets_Set() const{
    return m_digital_wallets_isSet;
}

bool OAIICanPay::is_digital_wallets_Valid() const{
    return m_digital_wallets_isValid;
}

bool OAIICanPay::isDynamicDescriptor() const {
    return m_dynamic_descriptor;
}
void OAIICanPay::setDynamicDescriptor(const bool &dynamic_descriptor) {
    m_dynamic_descriptor = dynamic_descriptor;
    m_dynamic_descriptor_isSet = true;
}

bool OAIICanPay::is_dynamic_descriptor_Set() const{
    return m_dynamic_descriptor_isSet;
}

bool OAIICanPay::is_dynamic_descriptor_Valid() const{
    return m_dynamic_descriptor_isValid;
}

QList<QString> OAIICanPay::getExcludedDccQuoteCurrencies() const {
    return m_excluded_dcc_quote_currencies;
}
void OAIICanPay::setExcludedDccQuoteCurrencies(const QList<QString> &excluded_dcc_quote_currencies) {
    m_excluded_dcc_quote_currencies = excluded_dcc_quote_currencies;
    m_excluded_dcc_quote_currencies_isSet = true;
}

bool OAIICanPay::is_excluded_dcc_quote_currencies_Set() const{
    return m_excluded_dcc_quote_currencies_isSet;
}

bool OAIICanPay::is_excluded_dcc_quote_currencies_Valid() const{
    return m_excluded_dcc_quote_currencies_isValid;
}

OAIGatewayName OAIICanPay::getGatewayName() const {
    return m_gateway_name;
}
void OAIICanPay::setGatewayName(const OAIGatewayName &gateway_name) {
    m_gateway_name = gateway_name;
    m_gateway_name_isSet = true;
}

bool OAIICanPay::is_gateway_name_Set() const{
    return m_gateway_name_isSet;
}

bool OAIICanPay::is_gateway_name_Valid() const{
    return m_gateway_name_isValid;
}

QString OAIICanPay::getId() const {
    return m_id;
}
void OAIICanPay::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIICanPay::is_id_Set() const{
    return m_id_isSet;
}

bool OAIICanPay::is_id_Valid() const{
    return m_id_isValid;
}

bool OAIICanPay::isIsDown() const {
    return m_is_down;
}
void OAIICanPay::setIsDown(const bool &is_down) {
    m_is_down = is_down;
    m_is_down_isSet = true;
}

bool OAIICanPay::is_is_down_Set() const{
    return m_is_down_isSet;
}

bool OAIICanPay::is_is_down_Valid() const{
    return m_is_down_isValid;
}

QString OAIICanPay::getMerchantCategoryCode() const {
    return m_merchant_category_code;
}
void OAIICanPay::setMerchantCategoryCode(const QString &merchant_category_code) {
    m_merchant_category_code = merchant_category_code;
    m_merchant_category_code_isSet = true;
}

bool OAIICanPay::is_merchant_category_code_Set() const{
    return m_merchant_category_code_isSet;
}

bool OAIICanPay::is_merchant_category_code_Valid() const{
    return m_merchant_category_code_isValid;
}

OAIPaymentMethod OAIICanPay::getMethod() const {
    return m_method;
}
void OAIICanPay::setMethod(const OAIPaymentMethod &method) {
    m_method = method;
    m_method_isSet = true;
}

bool OAIICanPay::is_method_Set() const{
    return m_method_isSet;
}

bool OAIICanPay::is_method_Valid() const{
    return m_method_isValid;
}

double OAIICanPay::getMonthlyLimit() const {
    return m_monthly_limit;
}
void OAIICanPay::setMonthlyLimit(const double &monthly_limit) {
    m_monthly_limit = monthly_limit;
    m_monthly_limit_isSet = true;
}

bool OAIICanPay::is_monthly_limit_Set() const{
    return m_monthly_limit_isSet;
}

bool OAIICanPay::is_monthly_limit_Valid() const{
    return m_monthly_limit_isValid;
}

QString OAIICanPay::getOrganizationId() const {
    return m_organization_id;
}
void OAIICanPay::setOrganizationId(const QString &organization_id) {
    m_organization_id = organization_id;
    m_organization_id_isSet = true;
}

bool OAIICanPay::is_organization_id_Set() const{
    return m_organization_id_isSet;
}

bool OAIICanPay::is_organization_id_Valid() const{
    return m_organization_id_isValid;
}

QList<OAIPaymentCardBrand> OAIICanPay::getPaymentCardSchemes() const {
    return m_payment_card_schemes;
}
void OAIICanPay::setPaymentCardSchemes(const QList<OAIPaymentCardBrand> &payment_card_schemes) {
    m_payment_card_schemes = payment_card_schemes;
    m_payment_card_schemes_isSet = true;
}

bool OAIICanPay::is_payment_card_schemes_Set() const{
    return m_payment_card_schemes_isSet;
}

bool OAIICanPay::is_payment_card_schemes_Valid() const{
    return m_payment_card_schemes_isValid;
}

bool OAIICanPay::isReconciliationWindowEnabled() const {
    return m_reconciliation_window_enabled;
}
void OAIICanPay::setReconciliationWindowEnabled(const bool &reconciliation_window_enabled) {
    m_reconciliation_window_enabled = reconciliation_window_enabled;
    m_reconciliation_window_enabled_isSet = true;
}

bool OAIICanPay::is_reconciliation_window_enabled_Set() const{
    return m_reconciliation_window_enabled_isSet;
}

bool OAIICanPay::is_reconciliation_window_enabled_Valid() const{
    return m_reconciliation_window_enabled_isValid;
}

qint32 OAIICanPay::getReconciliationWindowTtl() const {
    return m_reconciliation_window_ttl;
}
void OAIICanPay::setReconciliationWindowTtl(const qint32 &reconciliation_window_ttl) {
    m_reconciliation_window_ttl = reconciliation_window_ttl;
    m_reconciliation_window_ttl_isSet = true;
}

bool OAIICanPay::is_reconciliation_window_ttl_Set() const{
    return m_reconciliation_window_ttl_isSet;
}

bool OAIICanPay::is_reconciliation_window_ttl_Valid() const{
    return m_reconciliation_window_ttl_isValid;
}

QString OAIICanPay::getStatus() const {
    return m_status;
}
void OAIICanPay::setStatus(const QString &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIICanPay::is_status_Set() const{
    return m_status_isSet;
}

bool OAIICanPay::is_status_Valid() const{
    return m_status_isValid;
}

bool OAIICanPay::isSticky() const {
    return m_sticky;
}
void OAIICanPay::setSticky(const bool &sticky) {
    m_sticky = sticky;
    m_sticky_isSet = true;
}

bool OAIICanPay::is_sticky_Set() const{
    return m_sticky_isSet;
}

bool OAIICanPay::is_sticky_Valid() const{
    return m_sticky_isValid;
}

bool OAIICanPay::isThreeDSecure() const {
    return m_three_d_secure;
}
void OAIICanPay::setThreeDSecure(const bool &three_d_secure) {
    m_three_d_secure = three_d_secure;
    m_three_d_secure_isSet = true;
}

bool OAIICanPay::is_three_d_secure_Set() const{
    return m_three_d_secure_isSet;
}

bool OAIICanPay::is_three_d_secure_Valid() const{
    return m_three_d_secure_isValid;
}

qint32 OAIICanPay::getTimeout() const {
    return m_timeout;
}
void OAIICanPay::setTimeout(const qint32 &timeout) {
    m_timeout = timeout;
    m_timeout_isSet = true;
}

bool OAIICanPay::is_timeout_Set() const{
    return m_timeout_isSet;
}

bool OAIICanPay::is_timeout_Valid() const{
    return m_timeout_isValid;
}

QString OAIICanPay::getToken() const {
    return m_token;
}
void OAIICanPay::setToken(const QString &token) {
    m_token = token;
    m_token_isSet = true;
}

bool OAIICanPay::is_token_Set() const{
    return m_token_isSet;
}

bool OAIICanPay::is_token_Valid() const{
    return m_token_isValid;
}

QDateTime OAIICanPay::getUpdatedTime() const {
    return m_updated_time;
}
void OAIICanPay::setUpdatedTime(const QDateTime &updated_time) {
    m_updated_time = updated_time;
    m_updated_time_isSet = true;
}

bool OAIICanPay::is_updated_time_Set() const{
    return m_updated_time_isSet;
}

bool OAIICanPay::is_updated_time_Valid() const{
    return m_updated_time_isValid;
}

OAIICanPay_allOf_credentials OAIICanPay::getCredentials() const {
    return m_credentials;
}
void OAIICanPay::setCredentials(const OAIICanPay_allOf_credentials &credentials) {
    m_credentials = credentials;
    m_credentials_isSet = true;
}

bool OAIICanPay::is_credentials_Set() const{
    return m_credentials_isSet;
}

bool OAIICanPay::is_credentials_Valid() const{
    return m_credentials_isValid;
}

OAIPaymenTechnologies_allOf_settings OAIICanPay::getSettings() const {
    return m_settings;
}
void OAIICanPay::setSettings(const OAIPaymenTechnologies_allOf_settings &settings) {
    m_settings = settings;
    m_settings_isSet = true;
}

bool OAIICanPay::is_settings_Set() const{
    return m_settings_isSet;
}

bool OAIICanPay::is_settings_Valid() const{
    return m_settings_isValid;
}

bool OAIICanPay::isSet() const {
