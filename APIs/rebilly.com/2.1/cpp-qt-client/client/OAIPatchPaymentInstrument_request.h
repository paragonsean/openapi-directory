...
/*
 * OAIPatchPaymentInstrument_request.h
 *
 * 
 */

#ifndef OAIPatchPaymentInstrument_request_H
#define OAIPatchPaymentInstrument_request_H
...
class OAIPatchPaymentInstrument_request : public OAIObject {
public:
    OAIPatchPaymentInstrument_request();
    OAIPatchPaymentInstrument_request(QString json);
    ~OAIPatchPaymentInstrument_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPatchPaymentInstrument_request)

#endif // OAIPatchPaymentInstrument_request_H
