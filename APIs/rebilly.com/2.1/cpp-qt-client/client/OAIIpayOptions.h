...
#ifndef OAIIpayOptions_H
#define OAIIpayOptions_H
...
class OAIIpayOptions_allOf_credentials;
class OAIIpayOptions_allOf_settings;

class OAIIpayOptions : public OAIObject {
public:
    OAIIpayOptions();
    OAIIpayOptions(QString json);
    ~OAIIpayOptions() override;
    ...
    OAIIpayOptions_allOf_credentials getCredentials() const;
    void setCredentials(const OAIIpayOptions_allOf_credentials &credentials);
    bool is_credentials_Set() const;
    bool is_credentials_Valid() const;

    OAIIpayOptions_allOf_settings getSettings() const;
    void setSettings(const OAIIpayOptions_allOf_settings &settings);
...
private:
    ...
    OAIIpayOptions_allOf_credentials m_credentials;
    bool m_credentials_isSet;
    bool m_credentials_isValid;

    OAIIpayOptions_allOf_settings m_settings;
...
Q_DECLARE_METATYPE(OpenAPI::OAIIpayOptions)

#endif // OAIIpayOptions_H
