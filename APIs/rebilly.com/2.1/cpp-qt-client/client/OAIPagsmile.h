...
#ifndef OAIPagsmile_H
#define OAIPagsmile_H
...
class OAIPagsmile_allOf_credentials;

class OAIPagsmile : public OAIObject {
public:
    OAIPagsmile();
    OAIPagsmile(QString json);
    ~OAIPagsmile() override;
    ...
    OAIPagsmile_allOf_credentials getCredentials() const;
    void setCredentials(const OAIPagsmile_allOf_credentials &credentials);
...
private:
    ...
    OAIPagsmile_allOf_credentials m_credentials;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPagsmile)
