...
/*
 * OAITrustly_allOf_credentials.h
 *
 * Trustly credentials object.
 */

#ifndef OAITrustly_allOf_credentials_H
#define OAITrustly_allOf_credentials_H
...
class OAITrustly_allOf_credentials : public OAIObject {
public:
    OAITrustly_allOf_credentials();
    OAITrustly_allOf_credentials(QString json);
    ~OAITrustly_allOf_credentials() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITrustly_allOf_credentials)

#endif // OAITrustly_allOf_credentials_H
