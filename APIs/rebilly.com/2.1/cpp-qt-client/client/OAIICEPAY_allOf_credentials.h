...
/*
 * OAIICEPAY_allOf_credentials.h
 *
 * ICEPAY credentials object.
 */

#ifndef OAIICEPAY_allOf_credentials_H
#define OAIICEPAY_allOf_credentials_H
...
class OAIICEPAY_allOf_credentials : public OAIObject {
public:
    OAIICEPAY_allOf_credentials();
    OAIICEPAY_allOf_credentials(QString json);
    ~OAIICEPAY_allOf_credentials() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIICEPAY_allOf_credentials)

#endif // OAIICEPAY_allOf_credentials_H
