...
OAITestProcessor::OAITestProcessor(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAITestProcessor::OAITestProcessor() {
    this->initializeModel();
}

OAITestProcessor::~OAITestProcessor() {}

void OAITestProcessor::initializeModel() {
...
void OAITestProcessor::fromJson(QString jsonString) {
...
void OAITestProcessor::fromJsonObject(QJsonObject json) {
...
QString OAITestProcessor::asJson() const {
...
QJsonObject OAITestProcessor::asJsonObject() const {
    QJsonObject obj;
    if (m__links.size() > 0) {
...
QList<OAIGatewayAccount__links_inner> OAITestProcessor::getLinks() const {
    return m__links;
}
void OAITestProcessor::setLinks(const QList<OAIGatewayAccount__links_inner> &_links) {
    m__links = _links;
    m__links_isSet = true;
}

bool OAITestProcessor::is__links_Set() const{
    return m__links_isSet;
}

bool OAITestProcessor::is__links_Valid() const{
    return m__links_isValid;
}

QList<QString> OAITestProcessor::getAcceptedCurrencies() const {
    return m_accepted_currencies;
}
void OAITestProcessor::setAcceptedCurrencies(const QList<QString> &accepted_currencies) {
    m_accepted_currencies = accepted_currencies;
    m_accepted_currencies_isSet = true;
}

bool OAITestProcessor::is_accepted_currencies_Set() const{
    return m_accepted_currencies_isSet;
}

bool OAITestProcessor::is_accepted_currencies_Valid() const{
    return m_accepted_currencies_isValid;
}

OAIAcquirerName OAITestProcessor::getAcquirerName() const {
    return m_acquirer_name;
}
void OAITestProcessor::setAcquirerName(const OAIAcquirerName &acquirer_name) {
    m_acquirer_name = acquirer_name;
    m_acquirer_name_isSet = true;
}

bool OAITestProcessor::is_acquirer_name_Set() const{
    return m_acquirer_name_isSet;
}

bool OAITestProcessor::is_acquirer_name_Valid() const{
    return m_acquirer_name_isValid;
}

QString OAITestProcessor::getAdditionalFilters() const {
    return m_additional_filters;
}
void OAITestProcessor::setAdditionalFilters(const QString &additional_filters) {
    m_additional_filters = additional_filters;
    m_additional_filters_isSet = true;
}

bool OAITestProcessor::is_additional_filters_Set() const{
    return m_additional_filters_isSet;
}

bool OAITestProcessor::is_additional_filters_Valid() const{
    return m_additional_filters_isValid;
}

qint32 OAITestProcessor::getApprovalWindowTtl() const {
    return m_approval_window_ttl;
}
void OAITestProcessor::setApprovalWindowTtl(const qint32 &approval_window_ttl) {
    m_approval_window_ttl = approval_window_ttl;
    m_approval_window_ttl_isSet = true;
}

bool OAITestProcessor::is_approval_window_ttl_Set() const{
    return m_approval_window_ttl_isSet;
}

bool OAITestProcessor::is_approval_window_ttl_Valid() const{
    return m_approval_window_ttl_isValid;
}

QString OAITestProcessor::getCityField() const {
    return m_city_field;
}
void OAITestProcessor::setCityField(const QString &city_field) {
    m_city_field = city_field;
    m_city_field_isSet = true;
}

bool OAITestProcessor::is_city_field_Set() const{
    return m_city_field_isSet;
}

bool OAITestProcessor::is_city_field_Valid() const{
    return m_city_field_isValid;
}

QDateTime OAITestProcessor::getCreatedTime() const {
    return m_created_time;
}
void OAITestProcessor::setCreatedTime(const QDateTime &created_time) {
    m_created_time = created_time;
    m_created_time_isSet = true;
}

bool OAITestProcessor::is_created_time_Set() const{
    return m_created_time_isSet;
}

bool OAITestProcessor::is_created_time_Valid() const{
    return m_created_time_isValid;
}

QString OAITestProcessor::getDccForceCurrency() const {
    return m_dcc_force_currency;
}
void OAITestProcessor::setDccForceCurrency(const QString &dcc_force_currency) {
    m_dcc_force_currency = dcc_force_currency;
    m_dcc_force_currency_isSet = true;
}

bool OAITestProcessor::is_dcc_force_currency_Set() const{
    return m_dcc_force_currency_isSet;
}

bool OAITestProcessor::is_dcc_force_currency_Valid() const{
    return m_dcc_force_currency_isValid;
}

qint32 OAITestProcessor::getDccMarkup() const {
    return m_dcc_markup;
}
void OAITestProcessor::setDccMarkup(const qint32 &dcc_markup) {
    m_dcc_markup = dcc_markup;
    m_dcc_markup_isSet = true;
}

bool OAITestProcessor::is_dcc_markup_Set() const{
    return m_dcc_markup_isSet;
}

bool OAITestProcessor::is_dcc_markup_Valid() const{
    return m_dcc_markup_isValid;
}

QString OAITestProcessor::getDescriptor() const {
    return m_descriptor;
}
void OAITestProcessor::setDescriptor(const QString &descriptor) {
    m_descriptor = descriptor;
    m_descriptor_isSet = true;
}

bool OAITestProcessor::is_descriptor_Set() const{
    return m_descriptor_isSet;
}

bool OAITestProcessor::is_descriptor_Valid() const{
    return m_descriptor_isValid;
}

OAIDigitalWallets OAITestProcessor::getDigitalWallets() const {
    return m_digital_wallets;
}
void OAITestProcessor::setDigitalWallets(const OAIDigitalWallets &digital_wallets) {
    m_digital_wallets = digital_wallets;
    m_digital_wallets_isSet = true;
}

bool OAITestProcessor::is_digital_wallets_Set() const{
    return m_digital_wallets_isSet;
}

bool OAITestProcessor::is_digital_wallets_Valid() const{
    return m_digital_wallets_isValid;
}

bool OAITestProcessor::isDynamicDescriptor() const {
    return m_dynamic_descriptor;
}
void OAITestProcessor::setDynamicDescriptor(const bool &dynamic_descriptor) {
    m_dynamic_descriptor = dynamic_descriptor;
    m_dynamic_descriptor_isSet = true;
}

bool OAITestProcessor::is_dynamic_descriptor_Set() const{
    return m_dynamic_descriptor_isSet;
}

bool OAITestProcessor::is_dynamic_descriptor_Valid() const{
    return m_dynamic_descriptor_isValid;
}

QList<QString> OAITestProcessor::getExcludedDccQuoteCurrencies() const {
    return m_excluded_dcc_quote_currencies;
}
void OAITestProcessor::setExcludedDccQuoteCurrencies(const QList<QString> &excluded_dcc_quote_currencies) {
    m_excluded_dcc_quote_currencies = excluded_dcc_quote_currencies;
    m_excluded_dcc_quote_currencies_isSet = true;
}

bool OAITestProcessor::is_excluded_dcc_quote_currencies_Set() const{
    return m_excluded_dcc_quote_currencies_isSet;
}

bool OAITestProcessor::is_excluded_dcc_quote_currencies_Valid() const{
    return m_excluded_dcc_quote_currencies_isValid;
}

OAIGatewayName OAITestProcessor::getGatewayName() const {
    return m_gateway_name;
}
void OAITestProcessor::setGatewayName(const OAIGatewayName &gateway_name) {
    m_gateway_name = gateway_name;
    m_gateway_name_isSet = true;
}

bool OAITestProcessor::is_gateway_name_Set() const{
    return m_gateway_name_isSet;
}

bool OAITestProcessor::is_gateway_name_Valid() const{
    return m_gateway_name_isValid;
}

QString OAITestProcessor::getId() const {
    return m_id;
}
void OAITestProcessor::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAITestProcessor::is_id_Set() const{
    return m_id_isSet;
}

bool OAITestProcessor::is_id_Valid() const{
    return m_id_isValid;
}

bool OAITestProcessor::isIsDown() const {
    return m_is_down;
}
void OAITestProcessor::setIsDown(const bool &is_down) {
    m_is_down = is_down;
    m_is_down_isSet = true;
}

bool OAITestProcessor::is_is_down_Set() const{
    return m_is_down_isSet;
}

bool OAITestProcessor::is_is_down_Valid() const{
    return m_is_down_isValid;
}

QString OAITestProcessor::getMerchantCategoryCode() const {
    return m_merchant_category_code;
}
void OAITestProcessor::setMerchantCategoryCode(const QString &merchant_category_code) {
    m_merchant_category_code = merchant_category_code;
    m_merchant_category_code_isSet = true;
}

bool OAITestProcessor::is_merchant_category_code_Set() const{
    return m_merchant_category_code_isSet;
}

bool OAITestProcessor::is_merchant_category_code_Valid() const{
    return m_merchant_category_code_isValid;
}

OAIPaymentMethod OAITestProcessor::getMethod() const {
    return m_method;
}
void OAITestProcessor::setMethod(const OAIPaymentMethod &method) {
    m_method = method;
    m_method_isSet = true;
}

bool OAITestProcessor::is_method_Set() const{
    return m_method_isSet;
}

bool OAITestProcessor::is_method_Valid() const{
    return m_method_isValid;
}

double OAITestProcessor::getMonthlyLimit() const {
    return m_monthly_limit;
}
void OAITestProcessor::setMonthlyLimit(const double &monthly_limit) {
    m_monthly_limit = monthly_limit;
    m_monthly_limit_isSet = true;
}

bool OAITestProcessor::is_monthly_limit_Set() const{
    return m_monthly_limit_isSet;
}

bool OAITestProcessor::is_monthly_limit_Valid() const{
    return m_monthly_limit_isValid;
}

QString OAITestProcessor::getOrganizationId() const {
    return m_organization_id;
}
void OAITestProcessor::setOrganizationId(const QString &organization_id) {
    m_organization_id = organization_id;
    m_organization_id_isSet = true;
}

bool OAITestProcessor::is_organization_id_Set() const{
    return m_organization_id_isSet;
}

bool OAITestProcessor::is_organization_id_Valid() const{
    return m_organization_id_isValid;
}

QList<OAIPaymentCardBrand> OAITestProcessor::getPaymentCardSchemes() const {
    return m_payment_card_schemes;
}
void OAITestProcessor::setPaymentCardSchemes(const QList<OAIPaymentCardBrand> &payment_card_schemes) {
    m_payment_card_schemes = payment_card_schemes;
    m_payment_card_schemes_isSet = true;
}

bool OAITestProcessor::is_payment_card_schemes_Set() const{
    return m_payment_card_schemes_isSet;
}

bool OAITestProcessor::is_payment_card_schemes_Valid() const{
    return m_payment_card_schemes_isValid;
}

bool OAITestProcessor::isReconciliationWindowEnabled() const {
    return m_reconciliation_window_enabled;
}
void OAITestProcessor::setReconciliationWindowEnabled(const bool &reconciliation_window_enabled) {
    m_reconciliation_window_enabled = reconciliation_window_enabled;
    m_reconciliation_window_enabled_isSet = true;
}

bool OAITestProcessor::is_reconciliation_window_enabled_Set() const{
    return m_reconciliation_window_enabled_isSet;
}

bool OAITestProcessor::is_reconciliation_window_enabled_Valid() const{
    return m_reconciliation_window_enabled_isValid;
}

qint32 OAITestProcessor::getReconciliationWindowTtl() const {
    return m_reconciliation_window_ttl;
}
void OAITestProcessor::setReconciliationWindowTtl(const qint32 &reconciliation_window_ttl) {
    m_reconciliation_window_ttl = reconciliation_window_ttl;
    m_reconciliation_window_ttl_isSet = true;
}

bool OAITestProcessor::is_reconciliation_window_ttl_Set() const{
    return m_reconciliation_window_ttl_isSet;
}

bool OAITestProcessor::is_reconciliation_window_ttl_Valid() const{
    return m_reconciliation_window_ttl_isValid;
}

QString OAITestProcessor::getStatus() const {
    return m_status;
}
void OAITestProcessor::setStatus(const QString &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAITestProcessor::is_status_Set() const{
    return m_status_isSet;
}

bool OAITestProcessor::is_status_Valid() const{
    return m_status_isValid;
}

bool OAITestProcessor::isSticky() const {
    return m_sticky;
}
void OAITestProcessor::setSticky(const bool &sticky) {
    m_sticky = sticky;
    m_sticky_isSet = true;
}

bool OAITestProcessor::is_sticky_Set() const{
    return m_sticky_isSet;
}

bool OAITestProcessor::is_sticky_Valid() const{
    return m_sticky_isValid;
}

bool OAITestProcessor::isThreeDSecure() const {
    return m_three_d_secure;
}
void OAITestProcessor::setThreeDSecure(const bool &three_d_secure) {
    m_three_d_secure = three_d_secure;
    m_three_d_secure_isSet = true;
}

bool OAITestProcessor::is_three_d_secure_Set() const{
    return m_three_d_secure_isSet;
}

bool OAITestProcessor::is_three_d_secure_Valid() const{
    return m_three_d_secure_isValid;
}

qint32 OAITestProcessor::getTimeout() const {
    return m_timeout;
}
void OAITestProcessor::setTimeout(const qint32 &timeout) {
    m_timeout = timeout;
    m_timeout_isSet = true;
}

bool OAITestProcessor::is_timeout_Set() const{
    return m_timeout_isSet;
}

bool OAITestProcessor::is_timeout_Valid() const{
    return m_timeout_isValid;
}

QString OAITestProcessor::getToken() const {
    return m_token;
}
void OAITestProcessor::setToken(const QString &token) {
    m_token = token;
    m_token_isSet = true;
}

bool OAITestProcessor::is_token_Set() const{
    return m_token_isSet;
}

bool OAITestProcessor::is_token_Valid() const{
    return m_token_isValid;
}

QDateTime OAITestProcessor::getUpdatedTime() const {
    return m_updated_time;
}
void OAITestProcessor::setUpdatedTime(const QDateTime &updated_time) {
    m_updated_time = updated_time;
    m_updated_time_isSet = true;
}

bool OAITestProcessor::is_updated_time_Set() const{
    return m_updated_time_isSet;
}

bool OAITestProcessor::is_updated_time_Valid() const{
    return m_updated_time_isValid;
}

OAITestProcessor3dsServers OAITestProcessor::getThreeDSecureServer() const {
    return m_three_d_secure_server;
}
void OAITestProcessor::setThreeDSecureServer(const OAITestProcessor3dsServers &three_d_secure_server) {
    m_three_d_secure_server = three_d_secure_server;
    m_three_d_secure_server_isSet = true;
}

bool OAITestProcessor::is_three_d_secure_server_Set() const{
    return m_three_d_secure_server_isSet;
}

bool OAITestProcessor::is_three_d_secure_server_Valid() const{
    return m_three_d_secure_server_isValid;
}

bool OAITestProcessor::isSet() const {
...
bool OAITestProcessor::isValid() const {
