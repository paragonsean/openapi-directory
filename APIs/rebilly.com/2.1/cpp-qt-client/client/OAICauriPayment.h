...
#ifndef OAICauriPayment_H
#define OAICauriPayment_H

#include <QJsonObject>

#include "OAIAcquirerName.h"
#include "OAICauriPayment_allOf_credentials.h"
...
class OAICauriPayment_allOf_credentials;

class OAICauriPayment : public OAIObject {
public:
    OAICauriPayment();
    OAICauriPayment(QString json);
    ~OAICauriPayment() override;
    ...
    OAICauriPayment_allOf_credentials getCredentials() const;
    void setCredentials(const OAICauriPayment_allOf_credentials &credentials);
...
private:
    ...
    OAICauriPayment_allOf_credentials m_credentials;
...
Q_DECLARE_METATYPE(OpenAPI::OAICauriPayment)

#endif // OAICauriPayment_H
