...
OAINGenius::OAINGenius(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAINGenius::OAINGenius() {
    this->initializeModel();
}

OAINGenius::~OAINGenius() {}

void OAINGenius::initializeModel() {
...
void OAINGenius::fromJson(QString jsonString) {
...
void OAINGenius::fromJsonObject(QJsonObject json) {
...
QString OAINGenius::asJson() const {
...
QJsonObject OAINGenius::asJsonObject() const {
    QJsonObject obj;
    if (m__links.size() > 0) {
...
QList<OAIGatewayAccount__links_inner> OAINGenius::getLinks() const {
    return m__links;
}
void OAINGenius::setLinks(const QList<OAIGatewayAccount__links_inner> &_links) {
    m__links = _links;
    m__links_isSet = true;
}

bool OAINGenius::is__links_Set() const{
    return m__links_isSet;
}

bool OAINGenius::is__links_Valid() const{
    return m__links_isValid;
}

QList<QString> OAINGenius::getAcceptedCurrencies() const {
    return m_accepted_currencies;
}
void OAINGenius::setAcceptedCurrencies(const QList<QString> &accepted_currencies) {
    m_accepted_currencies = accepted_currencies;
    m_accepted_currencies_isSet = true;
}

bool OAINGenius::is_accepted_currencies_Set() const{
    return m_accepted_currencies_isSet;
}

bool OAINGenius::is_accepted_currencies_Valid() const{
    return m_accepted_currencies_isValid;
}

OAIAcquirerName OAINGenius::getAcquirerName() const {
    return m_acquirer_name;
}
void OAINGenius::setAcquirerName(const OAIAcquirerName &acquirer_name) {
    m_acquirer_name = acquirer_name;
    m_acquirer_name_isSet = true;
}

bool OAINGenius::is_acquirer_name_Set() const{
    return m_acquirer_name_isSet;
}

bool OAINGenius::is_acquirer_name_Valid() const{
    return m_acquirer_name_isValid;
}

QString OAINGenius::getAdditionalFilters() const {
    return m_additional_filters;
}
void OAINGenius::setAdditionalFilters(const QString &additional_filters) {
    m_additional_filters = additional_filters;
    m_additional_filters_isSet = true;
}

bool OAINGenius::is_additional_filters_Set() const{
    return m_additional_filters_isSet;
}

bool OAINGenius::is_additional_filters_Valid() const{
    return m_additional_filters_isValid;
}

qint32 OAINGenius::getApprovalWindowTtl() const {
    return m_approval_window_ttl;
}
void OAINGenius::setApprovalWindowTtl(const qint32 &approval_window_ttl) {
    m_approval_window_ttl = approval_window_ttl;
    m_approval_window_ttl_isSet = true;
}

bool OAINGenius::is_approval_window_ttl_Set() const{
    return m_approval_window_ttl_isSet;
}

bool OAINGenius::is_approval_window_ttl_Valid() const{
    return m_approval_window_ttl_isValid;
}

QString OAINGenius::getCityField() const {
    return m_city_field;
}
void OAINGenius::setCityField(const QString &city_field) {
    m_city_field = city_field;
    m_city_field_isSet = true;
}

bool OAINGenius::is_city_field_Set() const{
    return m_city_field_isSet;
}

bool OAINGenius::is_city_field_Valid() const{
    return m_city_field_isValid;
}

QDateTime OAINGenius::getCreatedTime() const {
    return m_created_time;
}
void OAINGenius::setCreatedTime(const QDateTime &created_time) {
    m_created_time = created_time;
    m_created_time_isSet = true;
}

bool OAINGenius::is_created_time_Set() const{
    return m_created_time_isSet;
}

bool OAINGenius::is_created_time_Valid() const{
    return m_created_time_isValid;
}

QString OAINGenius::getDccForceCurrency() const {
    return m_dcc_force_currency;
}
void OAINGenius::setDccForceCurrency(const QString &dcc_force_currency) {
    m_dcc_force_currency = dcc_force_currency;
    m_dcc_force_currency_isSet = true;
}

bool OAINGenius::is_dcc_force_currency_Set() const{
    return m_dcc_force_currency_isSet;
}

bool OAINGenius::is_dcc_force_currency_Valid() const{
    return m_dcc_force_currency_isValid;
}

qint32 OAINGenius::getDccMarkup() const {
    return m_dcc_markup;
}
void OAINGenius::setDccMarkup(const qint32 &dcc_markup) {
    m_dcc_markup = dcc_markup;
    m_dcc_markup_isSet = true;
}

bool OAINGenius::is_dcc_markup_Set() const{
    return m_dcc_markup_isSet;
}

bool OAINGenius::is_dcc_markup_Valid() const{
    return m_dcc_markup_isValid;
}

QString OAINGenius::getDescriptor() const {
    return m_descriptor;
}
void OAINGenius::setDescriptor(const QString &descriptor) {
    m_descriptor = descriptor;
    m_descriptor_isSet = true;
}

bool OAINGenius::is_descriptor_Set() const{
    return m_descriptor_isSet;
}

bool OAINGenius::is_descriptor_Valid() const{
    return m_descriptor_isValid;
}

OAIDigitalWallets OAINGenius::getDigitalWallets() const {
    return m_digital_wallets;
}
void OAINGenius::setDigitalWallets(const OAIDigitalWallets &digital_wallets) {
    m_digital_wallets = digital_wallets;
    m_digital_wallets_isSet = true;
}

bool OAINGenius::is_digital_wallets_Set() const{
    return m_digital_wallets_isSet;
}

bool OAINGenius::is_digital_wallets_Valid() const{
    return m_digital_wallets_isValid;
}

bool OAINGenius::isDynamicDescriptor() const {
    return m_dynamic_descriptor;
}
void OAINGenius::setDynamicDescriptor(const bool &dynamic_descriptor) {
    m_dynamic_descriptor = dynamic_descriptor;
    m_dynamic_descriptor_isSet = true;
}

bool OAINGenius::is_dynamic_descriptor_Set() const{
    return m_dynamic_descriptor_isSet;
}

bool OAINGenius::is_dynamic_descriptor_Valid() const{
    return m_dynamic_descriptor_isValid;
}

QList<QString> OAINGenius::getExcludedDccQuoteCurrencies() const {
    return m_excluded_dcc_quote_currencies;
}
void OAINGenius::setExcludedDccQuoteCurrencies(const QList<QString> &excluded_dcc_quote_currencies) {
    m_excluded_dcc_quote_currencies = excluded_dcc_quote_currencies;
    m_excluded_dcc_quote_currencies_isSet = true;
}

bool OAINGenius::is_excluded_dcc_quote_currencies_Set() const{
    return m_excluded_dcc_quote_currencies_isSet;
}

bool OAINGenius::is_excluded_dcc_quote_currencies_Valid() const{
    return m_excluded_dcc_quote_currencies_isValid;
}

OAIGatewayName OAINGenius::getGatewayName() const {
    return m_gateway_name;
}
void OAINGenius::setGatewayName(const OAIGatewayName &gateway_name) {
    m_gateway_name = gateway_name;
    m_gateway_name_isSet = true;
}

bool OAINGenius::is_gateway_name_Set() const{
    return m_gateway_name_isSet;
}

bool OAINGenius::is_gateway_name_Valid() const{
    return m_gateway_name_isValid;
}

QString OAINGenius::getId() const {
    return m_id;
}
void OAINGenius::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAINGenius::is_id_Set() const{
    return m_id_isSet;
}

bool OAINGenius::is_id_Valid() const{
    return m_id_isValid;
}

bool OAINGenius::isIsDown() const {
    return m_is_down;
}
void OAINGenius::setIsDown(const bool &is_down) {
    m_is_down = is_down;
    m_is_down_isSet = true;
}

bool OAINGenius::is_is_down_Set() const{
    return m_is_down_isSet;
}

bool OAINGenius::is_is_down_Valid() const{
    return m_is_down_isValid;
}

QString OAINGenius::getMerchantCategoryCode() const {
    return m_merchant_category_code;
}
void OAINGenius::setMerchantCategoryCode(const QString &merchant_category_code) {
    m_merchant_category_code = merchant_category_code;
    m_merchant_category_code_isSet = true;
}

bool OAINGenius::is_merchant_category_code_Set() const{
    return m_merchant_category_code_isSet;
}

bool OAINGenius::is_merchant_category_code_Valid() const{
    return m_merchant_category_code_isValid;
}

OAIPaymentMethod OAINGenius::getMethod() const {
    return m_method;
}
void OAINGenius::setMethod(const OAIPaymentMethod &method) {
    m_method = method;
    m_method_isSet = true;
}

bool OAINGenius::is_method_Set() const{
    return m_method_isSet;
}

bool OAINGenius::is_method_Valid() const{
    return m_method_isValid;
}

double OAINGenius::getMonthlyLimit() const {
    return m_monthly_limit;
}
void OAINGenius::setMonthlyLimit(const double &monthly_limit) {
    m_monthly_limit = monthly_limit;
    m_monthly_limit_isSet = true;
}

bool OAINGenius::is_monthly_limit_Set() const{
    return m_monthly_limit_isSet;
}

bool OAINGenius::is_monthly_limit_Valid() const{
    return m_monthly_limit_isValid;
}

QString OAINGenius::getOrganizationId() const {
    return m_organization_id;
}
void OAINGenius::setOrganizationId(const QString &organization_id) {
    m_organization_id = organization_id;
    m_organization_id_isSet = true;
}

bool OAINGenius::is_organization_id_Set() const{
    return m_organization_id_isSet;
}

bool OAINGenius::is_organization_id_Valid() const{
    return m_organization_id_isValid;
}

QList<OAIPaymentCardBrand> OAINGenius::getPaymentCardSchemes() const {
    return m_payment_card_schemes;
}
void OAINGenius::setPaymentCardSchemes(const QList<OAIPaymentCardBrand> &payment_card_schemes) {
    m_payment_card_schemes = payment_card_schemes;
    m_payment_card_schemes_isSet = true;
}

bool OAINGenius::is_payment_card_schemes_Set() const{
    return m_payment_card_schemes_isSet;
}

bool OAINGenius::is_payment_card_schemes_Valid() const{
    return m_payment_card_schemes_isValid;
}

bool OAINGenius::isReconciliationWindowEnabled() const {
    return m_reconciliation_window_enabled;
}
void OAINGenius::setReconciliationWindowEnabled(const bool &reconciliation_window_enabled) {
    m_reconciliation_window_enabled = reconciliation_window_enabled;
    m_reconciliation_window_enabled_isSet = true;
}

bool OAINGenius::is_reconciliation_window_enabled_Set() const{
    return m_reconciliation_window_enabled_isSet;
}

bool OAINGenius::is_reconciliation_window_enabled_Valid() const{
    return m_reconciliation_window_enabled_isValid;
}

qint32 OAINGenius::getReconciliationWindowTtl() const {
    return m_reconciliation_window_ttl;
}
void OAINGenius::setReconciliationWindowTtl(const qint32 &reconciliation_window_ttl) {
    m_reconciliation_window_ttl = reconciliation_window_ttl;
    m_reconciliation_window_ttl_isSet = true;
}

bool OAINGenius::is_reconciliation_window_ttl_Set() const{
    return m_reconciliation_window_ttl_isSet;
}

bool OAINGenius::is_reconciliation_window_ttl_Valid() const{
    return m_reconciliation_window_ttl_isValid;
}

QString OAINGenius::getStatus() const {
    return m_status;
}
void OAINGenius::setStatus(const QString &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAINGenius::is_status_Set() const{
    return m_status_isSet;
}

bool OAINGenius::is_status_Valid() const{
    return m_status_isValid;
}

bool OAINGenius::isSticky() const {
    return m_sticky;
}
void OAINGenius::setSticky(const bool &sticky) {
    m_sticky = sticky;
    m_sticky_isSet = true;
}

bool OAINGenius::is_sticky_Set() const{
    return m_sticky_isSet;
}

bool OAINGenius::is_sticky_Valid() const{
    return m_sticky_isValid;
}

bool OAINGenius::isThreeDSecure() const {
    return m_three_d_secure;
}
void OAINGenius::setThreeDSecure(const bool &three_d_secure) {
    m_three_d_secure = three_d_secure;
    m_three_d_secure_isSet = true;
}

bool OAINGenius::is_three_d_secure_Set() const{
    return m_three_d_secure_isSet;
}

bool OAINGenius::is_three_d_secure_Valid() const{
    return m_three_d_secure_isValid;
}

qint32 OAINGenius::getTimeout() const {
    return m_timeout;
}
void OAINGenius::setTimeout(const qint32 &timeout) {
    m_timeout = timeout;
    m_timeout_isSet = true;
}

bool OAINGenius::is_timeout_Set() const{
    return m_timeout_isSet;
}

bool OAINGenius::is_timeout_Valid() const{
    return m_timeout_isValid;
}

QString OAINGenius::getToken() const {
    return m_token;
}
void OAINGenius::setToken(const QString &token) {
    m_token = token;
    m_token_isSet = true;
}

bool OAINGenius::is_token_Set() const{
    return m_token_isSet;
}

bool OAINGenius::is_token_Valid() const{
    return m_token_isValid;
}

QDateTime OAINGenius::getUpdatedTime() const {
    return m_updated_time;
}
void OAINGenius::setUpdatedTime(const QDateTime &updated_time) {
    m_updated_time = updated_time;
    m_updated_time_isSet = true;
}

bool OAINGenius::is_updated_time_Set() const{
    return m_updated_time_isSet;
}

bool OAINGenius::is_updated_time_Valid() const{
    return m_updated_time_isValid;
}

OAINGenius_allOf_credentials OAINGenius::getCredentials() const {
    return m_credentials;
}
void OAINGenius::setCredentials(const OAINGenius_allOf_credentials &credentials) {
    m_credentials = credentials;
    m_credentials_isSet = true;
}

bool OAINGenius::is_credentials_Set() const{
    return m_credentials_isSet;
}

bool OAINGenius::is_credentials_Valid() const{
    return m_credentials_isValid;
}

OAINGenius3dsServers OAINGenius::getThreeDSecureServer() const {
    return m_three_d_secure_server;
}
void OAINGenius::setThreeDSecureServer(const OAINGenius3dsServers &three_d_secure_server) {
    m_three_d_secure_server = three_d_secure_server;
    m_three_d_secure_server_isSet = true;
}

bool OAINGenius::is_three_d_secure_server_Set() const{
    return m_three_d_secure_server_isSet;
}

bool OAINGenius::is_three_d_secure_server_Valid() const{
    return m_three_d_secure_server_isValid;
}

bool OAINGenius::isSet() const {
