...
/*
 * OAISmartInvoice_allOf_credentials.h
 *
 * SmartInvoice credentials object.
 */

#ifndef OAISmartInvoice_allOf_credentials_H
#define OAISmartInvoice_allOf_credentials_H
...
class OAISmartInvoice_allOf_credentials : public OAIObject {
public:
    OAISmartInvoice_allOf_credentials();
    OAISmartInvoice_allOf_credentials(QString json);
    ~OAISmartInvoice_allOf_credentials() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISmartInvoice_allOf_credentials)

#endif // OAISmartInvoice_allOf_credentials_H
