...
OAIPlugnpay::OAIPlugnpay(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPlugnpay::OAIPlugnpay() {
    this->initializeModel();
}

OAIPlugnpay::~OAIPlugnpay() {}

void OAIPlugnpay::initializeModel() {
...
void OAIPlugnpay::fromJson(QString jsonString) {
...
void OAIPlugnpay::fromJsonObject(QJsonObject json) {
...
QString OAIPlugnpay::asJson() const {
...
QJsonObject OAIPlugnpay::asJsonObject() const {
    QJsonObject obj;
    if (m__links.size() > 0) {
...
QList<OAIGatewayAccount__links_inner> OAIPlugnpay::getLinks() const {
    return m__links;
}
void OAIPlugnpay::setLinks(const QList<OAIGatewayAccount__links_inner> &_links) {
    m__links = _links;
    m__links_isSet = true;
}

bool OAIPlugnpay::is__links_Set() const{
    return m__links_isSet;
}

bool OAIPlugnpay::is__links_Valid() const{
    return m__links_isValid;
}

QList<QString> OAIPlugnpay::getAcceptedCurrencies() const {
    return m_accepted_currencies;
}
void OAIPlugnpay::setAcceptedCurrencies(const QList<QString> &accepted_currencies) {
    m_accepted_currencies = accepted_currencies;
    m_accepted_currencies_isSet = true;
}

bool OAIPlugnpay::is_accepted_currencies_Set() const{
    return m_accepted_currencies_isSet;
}

bool OAIPlugnpay::is_accepted_currencies_Valid() const{
    return m_accepted_currencies_isValid;
}

OAIAcquirerName OAIPlugnpay::getAcquirerName() const {
    return m_acquirer_name;
}
void OAIPlugnpay::setAcquirerName(const OAIAcquirerName &acquirer_name) {
    m_acquirer_name = acquirer_name;
    m_acquirer_name_isSet = true;
}

bool OAIPlugnpay::is_acquirer_name_Set() const{
    return m_acquirer_name_isSet;
}

bool OAIPlugnpay::is_acquirer_name_Valid() const{
    return m_acquirer_name_isValid;
}

QString OAIPlugnpay::getAdditionalFilters() const {
    return m_additional_filters;
}
void OAIPlugnpay::setAdditionalFilters(const QString &additional_filters) {
    m_additional_filters = additional_filters;
    m_additional_filters_isSet = true;
}

bool OAIPlugnpay::is_additional_filters_Set() const{
    return m_additional_filters_isSet;
}

bool OAIPlugnpay::is_additional_filters_Valid() const{
    return m_additional_filters_isValid;
}

qint32 OAIPlugnpay::getApprovalWindowTtl() const {
    return m_approval_window_ttl;
}
void OAIPlugnpay::setApprovalWindowTtl(const qint32 &approval_window_ttl) {
    m_approval_window_ttl = approval_window_ttl;
    m_approval_window_ttl_isSet = true;
}

bool OAIPlugnpay::is_approval_window_ttl_Set() const{
    return m_approval_window_ttl_isSet;
}

bool OAIPlugnpay::is_approval_window_ttl_Valid() const{
    return m_approval_window_ttl_isValid;
}

QString OAIPlugnpay::getCityField() const {
    return m_city_field;
}
void OAIPlugnpay::setCityField(const QString &city_field) {
    m_city_field = city_field;
    m_city_field_isSet = true;
}

bool OAIPlugnpay::is_city_field_Set() const{
    return m_city_field_isSet;
}

bool OAIPlugnpay::is_city_field_Valid() const{
    return m_city_field_isValid;
}

QDateTime OAIPlugnpay::getCreatedTime() const {
    return m_created_time;
}
void OAIPlugnpay::setCreatedTime(const QDateTime &created_time) {
    m_created_time = created_time;
    m_created_time_isSet = true;
}

bool OAIPlugnpay::is_created_time_Set() const{
    return m_created_time_isSet;
}

bool OAIPlugnpay::is_created_time_Valid() const{
    return m_created_time_isValid;
}

QString OAIPlugnpay::getDccForceCurrency() const {
    return m_dcc_force_currency;
}
void OAIPlugnpay::setDccForceCurrency(const QString &dcc_force_currency) {
    m_dcc_force_currency = dcc_force_currency;
    m_dcc_force_currency_isSet = true;
}

bool OAIPlugnpay::is_dcc_force_currency_Set() const{
    return m_dcc_force_currency_isSet;
}

bool OAIPlugnpay::is_dcc_force_currency_Valid() const{
    return m_dcc_force_currency_isValid;
}

qint32 OAIPlugnpay::getDccMarkup() const {
    return m_dcc_markup;
}
void OAIPlugnpay::setDccMarkup(const qint32 &dcc_markup) {
    m_dcc_markup = dcc_markup;
    m_dcc_markup_isSet = true;
}

bool OAIPlugnpay::is_dcc_markup_Set() const{
    return m_dcc_markup_isSet;
}

bool OAIPlugnpay::is_dcc_markup_Valid() const{
    return m_dcc_markup_isValid;
}

QString OAIPlugnpay::getDescriptor() const {
    return m_descriptor;
}
void OAIPlugnpay::setDescriptor(const QString &descriptor) {
    m_descriptor = descriptor;
    m_descriptor_isSet = true;
}

bool OAIPlugnpay::is_descriptor_Set() const{
    return m_descriptor_isSet;
}

bool OAIPlugnpay::is_descriptor_Valid() const{
    return m_descriptor_isValid;
}

OAIDigitalWallets OAIPlugnpay::getDigitalWallets() const {
    return m_digital_wallets;
}
void OAIPlugnpay::setDigitalWallets(const OAIDigitalWallets &digital_wallets) {
    m_digital_wallets = digital_wallets;
    m_digital_wallets_isSet = true;
}

bool OAIPlugnpay::is_digital_wallets_Set() const{
    return m_digital_wallets_isSet;
}

bool OAIPlugnpay::is_digital_wallets_Valid() const{
    return m_digital_wallets_isValid;
}

bool OAIPlugnpay::isDynamicDescriptor() const {
    return m_dynamic_descriptor;
}
void OAIPlugnpay::setDynamicDescriptor(const bool &dynamic_descriptor) {
    m_dynamic_descriptor = dynamic_descriptor;
    m_dynamic_descriptor_isSet = true;
}

bool OAIPlugnpay::is_dynamic_descriptor_Set() const{
    return m_dynamic_descriptor_isSet;
}

bool OAIPlugnpay::is_dynamic_descriptor_Valid() const{
    return m_dynamic_descriptor_isValid;
}

QList<QString> OAIPlugnpay::getExcludedDccQuoteCurrencies() const {
    return m_excluded_dcc_quote_currencies;
}
void OAIPlugnpay::setExcludedDccQuoteCurrencies(const QList<QString> &excluded_dcc_quote_currencies) {
    m_excluded_dcc_quote_currencies = excluded_dcc_quote_currencies;
    m_excluded_dcc_quote_currencies_isSet = true;
}

bool OAIPlugnpay::is_excluded_dcc_quote_currencies_Set() const{
    return m_excluded_dcc_quote_currencies_isSet;
}

bool OAIPlugnpay::is_excluded_dcc_quote_currencies_Valid() const{
    return m_excluded_dcc_quote_currencies_isValid;
}

OAIGatewayName OAIPlugnpay::getGatewayName() const {
    return m_gateway_name;
}
void OAIPlugnpay::setGatewayName(const OAIGatewayName &gateway_name) {
    m_gateway_name = gateway_name;
    m_gateway_name_isSet = true;
}

bool OAIPlugnpay::is_gateway_name_Set() const{
    return m_gateway_name_isSet;
}

bool OAIPlugnpay::is_gateway_name_Valid() const{
    return m_gateway_name_isValid;
}

QString OAIPlugnpay::getId() const {
    return m_id;
}
void OAIPlugnpay::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIPlugnpay::is_id_Set() const{
    return m_id_isSet;
}

bool OAIPlugnpay::is_id_Valid() const{
    return m_id_isValid;
}

bool OAIPlugnpay::isIsDown() const {
    return m_is_down;
}
void OAIPlugnpay::setIsDown(const bool &is_down) {
    m_is_down = is_down;
    m_is_down_isSet = true;
}

bool OAIPlugnpay::is_is_down_Set() const{
    return m_is_down_isSet;
}

bool OAIPlugnpay::is_is_down_Valid() const{
    return m_is_down_isValid;
}

QString OAIPlugnpay::getMerchantCategoryCode() const {
    return m_merchant_category_code;
}
void OAIPlugnpay::setMerchantCategoryCode(const QString &merchant_category_code) {
    m_merchant_category_code = merchant_category_code;
    m_merchant_category_code_isSet = true;
}

bool OAIPlugnpay::is_merchant_category_code_Set() const{
    return m_merchant_category_code_isSet;
}

bool OAIPlugnpay::is_merchant_category_code_Valid() const{
    return m_merchant_category_code_isValid;
}

OAIPaymentMethod OAIPlugnpay::getMethod() const {
    return m_method;
}
void OAIPlugnpay::setMethod(const OAIPaymentMethod &method) {
    m_method = method;
    m_method_isSet = true;
}

bool OAIPlugnpay::is_method_Set() const{
    return m_method_isSet;
}

bool OAIPlugnpay::is_method_Valid() const{
    return m_method_isValid;
}

double OAIPlugnpay::getMonthlyLimit() const {
    return m_monthly_limit;
}
void OAIPlugnpay::setMonthlyLimit(const double &monthly_limit) {
    m_monthly_limit = monthly_limit;
    m_monthly_limit_isSet = true;
}

bool OAIPlugnpay::is_monthly_limit_Set() const{
    return m_monthly_limit_isSet;
}

bool OAIPlugnpay::is_monthly_limit_Valid() const{
    return m_monthly_limit_isValid;
}

QString OAIPlugnpay::getOrganizationId() const {
    return m_organization_id;
}
void OAIPlugnpay::setOrganizationId(const QString &organization_id) {
    m_organization_id = organization_id;
    m_organization_id_isSet = true;
}

bool OAIPlugnpay::is_organization_id_Set() const{
    return m_organization_id_isSet;
}

bool OAIPlugnpay::is_organization_id_Valid() const{
    return m_organization_id_isValid;
}

QList<OAIPaymentCardBrand> OAIPlugnpay::getPaymentCardSchemes() const {
    return m_payment_card_schemes;
}
void OAIPlugnpay::setPaymentCardSchemes(const QList<OAIPaymentCardBrand> &payment_card_schemes) {
    m_payment_card_schemes = payment_card_schemes;
    m_payment_card_schemes_isSet = true;
}

bool OAIPlugnpay::is_payment_card_schemes_Set() const{
    return m_payment_card_schemes_isSet;
}

bool OAIPlugnpay::is_payment_card_schemes_Valid() const{
    return m_payment_card_schemes_isValid;
}

bool OAIPlugnpay::isReconciliationWindowEnabled() const {
    return m_reconciliation_window_enabled;
}
void OAIPlugnpay::setReconciliationWindowEnabled(const bool &reconciliation_window_enabled) {
    m_reconciliation_window_enabled = reconciliation_window_enabled;
    m_reconciliation_window_enabled_isSet = true;
}

bool OAIPlugnpay::is_reconciliation_window_enabled_Set() const{
    return m_reconciliation_window_enabled_isSet;
}

bool OAIPlugnpay::is_reconciliation_window_enabled_Valid() const{
    return m_reconciliation_window_enabled_isValid;
}

qint32 OAIPlugnpay::getReconciliationWindowTtl() const {
    return m_reconciliation_window_ttl;
}
void OAIPlugnpay::setReconciliationWindowTtl(const qint32 &reconciliation_window_ttl) {
    m_reconciliation_window_ttl = reconciliation_window_ttl;
    m_reconciliation_window_ttl_isSet = true;
}

bool OAIPlugnpay::is_reconciliation_window_ttl_Set() const{
    return m_reconciliation_window_ttl_isSet;
}

bool OAIPlugnpay::is_reconciliation_window_ttl_Valid() const{
    return m_reconciliation_window_ttl_isValid;
}

QString OAIPlugnpay::getStatus() const {
    return m_status;
}
void OAIPlugnpay::setStatus(const QString &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIPlugnpay::is_status_Set() const{
    return m_status_isSet;
}

bool OAIPlugnpay::is_status_Valid() const{
    return m_status_isValid;
}

bool OAIPlugnpay::isSticky() const {
    return m_sticky;
}
void OAIPlugnpay::setSticky(const bool &sticky) {
    m_sticky = sticky;
    m_sticky_isSet = true;
}

bool OAIPlugnpay::is_sticky_Set() const{
    return m_sticky_isSet;
}

bool OAIPlugnpay::is_sticky_Valid() const{
    return m_sticky_isValid;
}

bool OAIPlugnpay::isThreeDSecure() const {
    return m_three_d_secure;
}
void OAIPlugnpay::setThreeDSecure(const bool &three_d_secure) {
    m_three_d_secure = three_d_secure;
    m_three_d_secure_isSet = true;
}

bool OAIPlugnpay::is_three_d_secure_Set() const{
    return m_three_d_secure_isSet;
}

bool OAIPlugnpay::is_three_d_secure_Valid() const{
    return m_three_d_secure_isValid;
}

qint32 OAIPlugnpay::getTimeout() const {
    return m_timeout;
}
void OAIPlugnpay::setTimeout(const qint32 &timeout) {
    m_timeout = timeout;
    m_timeout_isSet = true;
}

bool OAIPlugnpay::is_timeout_Set() const{
    return m_timeout_isSet;
}

bool OAIPlugnpay::is_timeout_Valid() const{
    return m_timeout_isValid;
}

QString OAIPlugnpay::getToken() const {
    return m_token;
}
void OAIPlugnpay::setToken(const QString &token) {
    m_token = token;
    m_token_isSet = true;
}

bool OAIPlugnpay::is_token_Set() const{
    return m_token_isSet;
}

bool OAIPlugnpay::is_token_Valid() const{
    return m_token_isValid;
}

QDateTime OAIPlugnpay::getUpdatedTime() const {
    return m_updated_time;
}
void OAIPlugnpay::setUpdatedTime(const QDateTime &updated_time) {
    m_updated_time = updated_time;
    m_updated_time_isSet = true;
}

bool OAIPlugnpay::is_updated_time_Set() const{
    return m_updated_time_isSet;
}

bool OAIPlugnpay::is_updated_time_Valid() const{
    return m_updated_time_isValid;
}

OAIPlugnpay_allOf_credentials OAIPlugnpay::getCredentials() const {
    return m_credentials;
}
void OAIPlugnpay::setCredentials(const OAIPlugnpay_allOf_credentials &credentials) {
    m_credentials = credentials;
    m_credentials_isSet = true;
}

bool OAIPlugnpay::is_credentials_Set() const{
    return m_credentials_isSet;
}

bool OAIPlugnpay::is_credentials_Valid() const{
    return m_credentials_isValid;
}

bool OAIPlugnpay::isSet() const {
...
bool OAIPlugnpay::isValid() const {
