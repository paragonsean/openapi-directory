...
/*
 * OAIPaymentCardCreateToken.h
 *
 * 
 */

#ifndef OAIPaymentCardCreateToken_H
#define OAIPaymentCardCreateToken_H
...
class OAIPaymentCardCreateToken : public OAIObject {
public:
    OAIPaymentCardCreateToken();
    OAIPaymentCardCreateToken(QString json);
    ~OAIPaymentCardCreateToken() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPaymentCardCreateToken)

#endif // OAIPaymentCardCreateToken_H
