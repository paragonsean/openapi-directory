 ...
 * OAIRebilly.h
 *
 * Rebilly-based shipping which is calculated by shipping zones.
 */
...
class OAIRebilly : public OAIObject {
public:
    OAIRebilly();
    OAIRebilly(QString json);
    ~OAIRebilly() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRebilly)
