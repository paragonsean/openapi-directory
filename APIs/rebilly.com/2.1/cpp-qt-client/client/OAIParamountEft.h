...
#ifndef OAIParamountEft_H
#define OAIParamountEft_H
...
#include "OAIParamountEft_allOf_credentials.h"
...
class OAIParamountEft_allOf_credentials;

class OAIParamountEft : public OAIObject {
public:
    OAIParamountEft();
    OAIParamountEft(QString json);
    ~OAIParamountEft() override;
    ...
    OAIParamountEft_allOf_credentials getCredentials() const;
    void setCredentials(const OAIParamountEft_allOf_credentials &credentials);
...
private:
    ...
    OAIParamountEft_allOf_credentials m_credentials;
...
Q_DECLARE_METATYPE(OpenAPI::OAIParamountEft)

#endif // OAIParamountEft_H
