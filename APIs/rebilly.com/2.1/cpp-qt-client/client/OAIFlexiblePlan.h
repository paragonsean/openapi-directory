...
#ifndef OAIFlexiblePlan_H
#define OAIFlexiblePlan_H
...
class OAIFlexiblePlan : public OAIObject {
public:
    OAIFlexiblePlan();
    OAIFlexiblePlan(QString json);
    ~OAIFlexiblePlan() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFlexiblePlan)

#endif // OAIFlexiblePlan_H
