...
/*
 * OAIParamountInterac.h
 *
 * ParamountInterac config.
 */

#ifndef OAIParamountInterac_H
#define OAIParamountInterac_H
...
#include "OAIGigadat_allOf_settings.h"
#include "OAIParamountInterac_allOf_credentials.h"
...
class OAIParamountInterac_allOf_credentials;
class OAIGigadat_allOf_settings;

class OAIParamountInterac : public OAIObject {
public:
    OAIParamountInterac();
    OAIParamountInterac(QString json);
    ~OAIParamountInterac() override;
    ...
    OAIParamountInterac_allOf_credentials getCredentials() const;
    void setCredentials(const OAIParamountInterac_allOf_credentials &credentials);
    bool is_credentials_Set() const;
    bool is_credentials_Valid() const;

    OAIGigadat_allOf_settings getSettings() const;
    void setSettings(const OAIGigadat_allOf_settings &settings);
...
private:
    ...
    OAIParamountInterac_allOf_credentials m_credentials;
    bool m_credentials_isSet;
    bool m_credentials_isValid;

    OAIGigadat_allOf_settings m_settings;
...
Q_DECLARE_METATYPE(OpenAPI::OAIParamountInterac)

#endif // OAIParamountInterac_H
