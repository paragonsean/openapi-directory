...
void OAIPaymentInstrument::initializeModel() {
    ...
    m_received_by_isSet = false;
    m_received_by_isValid = false;
...
void OAIPaymentInstrument::fromJsonObject(QJsonObject json) {
    ...
    m_received_by_isValid = ::OpenAPI::fromJsonValue(m_received_by, json[QString("receivedBy")]);
    m_received_by_isSet = !json[QString("receivedBy")].isNull() && m_received_by_isValid;
...
QJsonObject OAIPaymentInstrument::asJsonObject() const {
    ...
    if (m_received_by_isSet) {
        obj.insert(QString("receivedBy"), ::OpenAPI::toJsonValue(m_received_by));
    }
...
QString OAIPaymentInstrument::getMethod() const {
    return m_method;
}
void OAIPaymentInstrument::setMethod(const QString &method) {
    m_method = method;
    m_method_isSet = true;
}

bool OAIPaymentInstrument::is_method_Set() const{
    return m_method_isSet;
}

bool OAIPaymentInstrument::is_method_Valid() const{
    return m_method_isValid;
}

QJsonValue OAIPaymentInstrument::getPaymentInstrumentId() const {
    return m_payment_instrument_id;
}
void OAIPaymentInstrument::setPaymentInstrumentId(const QJsonValue &payment_instrument_id) {
    m_payment_instrument_id = payment_instrument_id;
    m_payment_instrument_id_isSet = true;
}

bool OAIPaymentInstrument::is_payment_instrument_id_Set() const{
    return m_payment_instrument_id_isSet;
}

bool OAIPaymentInstrument::is_payment_instrument_id_Valid() const{
    return m_payment_instrument_id_isValid;
}

QString OAIPaymentInstrument::getReceivedBy() const {
    return m_received_by;
}
void OAIPaymentInstrument::setReceivedBy(const QString &received_by) {
    m_received_by = received_by;
    m_received_by_isSet = true;
}

bool OAIPaymentInstrument::is_received_by_Set() const{
    return m_received_by_isSet;
}

bool OAIPaymentInstrument::is_received_by_Valid() const{
    return m_received_by_isValid;
}
...
bool OAIPaymentInstrument::isValid() const {
    ...
    return m_method_isValid && m_payment_instrument_id_isValid && true;
}
