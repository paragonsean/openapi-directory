...
#include "OAISofort_allOf_credentials.h"
#include <QDateTime>
#include <QList>
#include <QString>
...
class OAISofort_allOf_credentials;

class OAISofort : public OAIObject {
public:
    OAISofort();
    OAISofort(QString json);
    ~OAISofort() override;
    ...
    OAISofort_allOf_credentials getCredentials() const;
    void setCredentials(const OAISofort_allOf_credentials &credentials);
...
private:
    ...
    OAISofort_allOf_credentials m_credentials;
...
Q_DECLARE_METATYPE(OpenAPI::OAISofort)
