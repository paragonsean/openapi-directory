...
#ifndef OAIGreenbox_H
#define OAIGreenbox_H
...
class OAIGreenbox_allOf_credentials;

class OAIGreenbox : public OAIObject {
public:
    OAIGreenbox();
    OAIGreenbox(QString json);
    ~OAIGreenbox() override;
    ...
    OAIGreenbox_allOf_credentials getCredentials() const;
    void setCredentials(const OAIGreenbox_allOf_credentials &credentials);
...
private:
    ...
    OAIGreenbox_allOf_credentials m_credentials;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGreenbox)
