...
#include "OAIIDebit_allOf_credentials.h"
...
class OAIIDebit_allOf_credentials;

class OAIIDebit : public OAIObject {
public:
    OAIIDebit();
    OAIIDebit(QString json);
    ~OAIIDebit() override;
    ...
    OAIIDebit_allOf_credentials getCredentials() const;
    void setCredentials(const OAIIDebit_allOf_credentials &credentials);
...
private:
    ...
    OAIIDebit_allOf_credentials m_credentials;
...
Q_DECLARE_METATYPE(OpenAPI::OAIIDebit)
