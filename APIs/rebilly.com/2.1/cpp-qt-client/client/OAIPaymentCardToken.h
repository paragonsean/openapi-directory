...
/*
 * OAIPaymentCardToken.h
 *
 * 
 */

#ifndef OAIPaymentCardToken_H
#define OAIPaymentCardToken_H
...
class OAIPaymentCardToken : public OAIObject {
public:
    OAIPaymentCardToken();
    OAIPaymentCardToken(QString json);
    ~OAIPaymentCardToken() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPaymentCardToken)

#endif // OAIPaymentCardToken_H
