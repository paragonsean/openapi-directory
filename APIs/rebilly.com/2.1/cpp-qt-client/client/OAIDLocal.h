...
#include "OAIDLocal_allOf_credentials.h"
...
class OAIDLocal_allOf_credentials;
class OAIDLocal_allOf_settings;

class OAIDLocal : public OAIObject {
public:
    OAIDLocal();
    OAIDLocal(QString json);
    ~OAIDLocal() override;
    ...
    OAIDLocal_allOf_credentials getCredentials() const;
    void setCredentials(const OAIDLocal_allOf_credentials &credentials);
    bool is_credentials_Set() const;
    bool is_credentials_Valid() const;

    OAIDLocal_allOf_settings getSettings() const;
    void setSettings(const OAIDLocal_allOf_settings &settings);
...
private:
    ...
    OAIDLocal_allOf_credentials m_credentials;
    bool m_credentials_isSet;
    bool m_credentials_isValid;

    OAIDLocal_allOf_settings m_settings;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDLocal)
