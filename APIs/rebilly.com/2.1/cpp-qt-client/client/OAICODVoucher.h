...
#ifndef OAICODVoucher_H
#define OAICODVoucher_H
...
class OAICODVoucher_allOf_credentials;

class OAICODVoucher : public OAIObject {
public:
    OAICODVoucher();
    OAICODVoucher(QString json);
    ~OAICODVoucher() override;
    ...
    OAICODVoucher_allOf_credentials getCredentials() const;
    void setCredentials(const OAICODVoucher_allOf_credentials &credentials);
...
private:
    ...
    OAICODVoucher_allOf_credentials m_credentials;
...
Q_DECLARE_METATYPE(OpenAPI::OAICODVoucher)

#endif // OAICODVoucher_H
