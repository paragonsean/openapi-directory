...
OAICayan::OAICayan(QString json) {
...
void OAICayan::fromJson(QString jsonString) {
...
void OAICayan::fromJsonObject(QJsonObject json) {
...
QJsonObject OAICayan::asJsonObject() const {
    QJsonObject obj;
    if (m__links.size() > 0) {
...
QList<OAIGatewayAccount__links_inner> OAICayan::getLinks() const {
    return m__links;
}
void OAICayan::setLinks(const QList<OAIGatewayAccount__links_inner> &_links) {
    m__links = _links;
    m__links_isSet = true;
}

bool OAICayan::is__links_Set() const{
    return m__links_isSet;
}

bool OAICayan::is__links_Valid() const{
    return m__links_isValid;
}

QList<QString> OAICayan::getAcceptedCurrencies() const {
    return m_accepted_currencies;
}
void OAICayan::setAcceptedCurrencies(const QList<QString> &accepted_currencies) {
    m_accepted_currencies = accepted_currencies;
    m_accepted_currencies_isSet = true;
}

bool OAICayan::is_accepted_currencies_Set() const{
    return m_accepted_currencies_isSet;
}

bool OAICayan::is_accepted_currencies_Valid() const{
    return m_accepted_currencies_isValid;
}

OAIAcquirerName OAICayan::getAcquirerName() const {
    return m_acquirer_name;
}
void OAICayan::setAcquirerName(const OAIAcquirerName &acquirer_name) {
    m_acquirer_name = acquirer_name;
    m_acquirer_name_isSet = true;
}

bool OAICayan::is_acquirer_name_Set() const{
    return m_acquirer_name_isSet;
}

bool OAICayan::is_acquirer_name_Valid() const{
    return m_acquirer_name_isValid;
}

QString OAICayan::getAdditionalFilters() const {
    return m_additional_filters;
}
void OAICayan::setAdditionalFilters(const QString &additional_filters) {
    m_additional_filters = additional_filters;
    m_additional_filters_isSet = true;
}

bool OAICayan::is_additional_filters_Set() const{
    return m_additional_filters_isSet;
}

bool OAICayan::is_additional_filters_Valid() const{
    return m_additional_filters_isValid;
}

qint32 OAICayan::getApprovalWindowTtl() const {
    return m_approval_window_ttl;
}
void OAICayan::setApprovalWindowTtl(const qint32 &approval_window_ttl) {
    m_approval_window_ttl = approval_window_ttl;
    m_approval_window_ttl_isSet = true;
}

bool OAICayan::is_approval_window_ttl_Set() const{
    return m_approval_window_ttl_isSet;
}

bool OAICayan::is_approval_window_ttl_Valid() const{
    return m_approval_window_ttl_isValid;
}

QString OAICayan::getCityField() const {
    return m_city_field;
}
void OAICayan::setCityField(const QString &city_field) {
    m_city_field = city_field;
    m_city_field_isSet = true;
}

bool OAICayan::is_city_field_Set() const{
    return m_city_field_isSet;
}

bool OAICayan::is_city_field_Valid() const{
    return m_city_field_isValid;
}

QDateTime OAICayan::getCreatedTime() const {
    return m_created_time;
}
void OAICayan::setCreatedTime(const QDateTime &created_time) {
    m_created_time = created_time;
    m_created_time_isSet = true;
}

bool OAICayan::is_created_time_Set() const{
    return m_created_time_isSet;
}

bool OAICayan::is_created_time_Valid() const{
    return m_created_time_isValid;
}

QString OAICayan::getDccForceCurrency() const {
    return m_dcc_force_currency;
}
void OAICayan::setDccForceCurrency(const QString &dcc_force_currency) {
    m_dcc_force_currency = dcc_force_currency;
    m_dcc_force_currency_isSet = true;
}

bool OAICayan::is_dcc_force_currency_Set() const{
    return m_dcc_force_currency_isSet;
}

bool OAICayan::is_dcc_force_currency_Valid() const{
    return m_dcc_force_currency_isValid;
}

qint32 OAICayan::getDccMarkup() const {
    return m_dcc_markup;
}
void OAICayan::setDccMarkup(const qint32 &dcc_markup) {
    m_dcc_markup = dcc_markup;
    m_dcc_markup_isSet = true;
}

bool OAICayan::is_dcc_markup_Set() const{
    return m_dcc_markup_isSet;
}

bool OAICayan::is_dcc_markup_Valid() const{
    return m_dcc_markup_isValid;
}

QString OAICayan::getDescriptor() const {
    return m_descriptor;
}
void OAICayan::setDescriptor(const QString &descriptor) {
    m_descriptor = descriptor;
    m_descriptor_isSet = true;
}

bool OAICayan::is_descriptor_Set() const{
    return m_descriptor_isSet;
}

bool OAICayan::is_descriptor_Valid() const{
    return m_descriptor_isValid;
}

OAIDigitalWallets OAICayan::getDigitalWallets() const {
    return m_digital_wallets;
}
void OAICayan::setDigitalWallets(const OAIDigitalWallets &digital_wallets) {
    m_digital_wallets = digital_wallets;
    m_digital_wallets_isSet = true;
}

bool OAICayan::is_digital_wallets_Set() const{
    return m_digital_wallets_isSet;
}

bool OAICayan::is_digital_wallets_Valid() const{
    return m_digital_wallets_isValid;
}

bool OAICayan::isDynamicDescriptor() const {
    return m_dynamic_descriptor;
}
void OAICayan::setDynamicDescriptor(const bool &dynamic_descriptor) {
    m_dynamic_descriptor = dynamic_descriptor;
    m_dynamic_descriptor_isSet = true;
}

bool OAICayan::is_dynamic_descriptor_Set() const{
    return m_dynamic_descriptor_isSet;
}

bool OAICayan::is_dynamic_descriptor_Valid() const{
    return m_dynamic_descriptor_isValid;
}

QList<QString> OAICayan::getExcludedDccQuoteCurrencies() const {
    return m_excluded_dcc_quote_currencies;
}
void OAICayan::setExcludedDccQuoteCurrencies(const QList<QString> &excluded_dcc_quote_currencies) {
    m_excluded_dcc_quote_currencies = excluded_dcc_quote_currencies;
    m_excluded_dcc_quote_currencies_isSet = true;
}

bool OAICayan::is_excluded_dcc_quote_currencies_Set() const{
    return m_excluded_dcc_quote_currencies_isSet;
}

bool OAICayan::is_excluded_dcc_quote_currencies_Valid() const{
    return m_excluded_dcc_quote_currencies_isValid;
}

OAIGatewayName OAICayan::getGatewayName() const {
    return m_gateway_name;
}
void OAICayan::setGatewayName(const OAIGatewayName &gateway_name) {
    m_gateway_name = gateway_name;
    m_gateway_name_isSet = true;
}

bool OAICayan::is_gateway_name_Set() const{
    return m_gateway_name_isSet;
}

bool OAICayan::is_gateway_name_Valid() const{
    return m_gateway_name_isValid;
}

QString OAICayan::getId() const {
    return m_id;
}
void OAICayan::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAICayan::is_id_Set() const{
    return m_id_isSet;
}

bool OAICayan::is_id_Valid() const{
    return m_id_isValid;
}

bool OAICayan::isIsDown() const {
    return m_is_down;
}
void OAICayan::setIsDown(const bool &is_down) {
    m_is_down = is_down;
    m_is_down_isSet = true;
}

bool OAICayan::is_is_down_Set() const{
    return m_is_down_isSet;
}

bool OAICayan::is_is_down_Valid() const{
    return m_is_down_isValid;
}

QString OAICayan::getMerchantCategoryCode() const {
    return m_merchant_category_code;
}
void OAICayan::setMerchantCategoryCode(const QString &merchant_category_code) {
    m_merchant_category_code = merchant_category_code;
    m_merchant_category_code_isSet = true;
}

bool OAICayan::is_merchant_category_code_Set() const{
    return m_merchant_category_code_isSet;
}

bool OAICayan::is_merchant_category_code_Valid() const{
    return m_merchant_category_code_isValid;
}

OAIPaymentMethod OAICayan::getMethod() const {
    return m_method;
}
void OAICayan::setMethod(const OAIPaymentMethod &method) {
    m_method = method;
    m_method_isSet = true;
}

bool OAICayan::is_method_Set() const{
    return m_method_isSet;
}

bool OAICayan::is_method_Valid() const{
    return m_method_isValid;
}

double OAICayan::getMonthlyLimit() const {
    return m_monthly_limit;
}
void OAICayan::setMonthlyLimit(const double &monthly_limit) {
    m_monthly_limit = monthly_limit;
    m_monthly_limit_isSet = true;
}

bool OAICayan::is_monthly_limit_Set() const{
    return m_monthly_limit_isSet;
}

bool OAICayan::is_monthly_limit_Valid() const{
    return m_monthly_limit_isValid;
}

QString OAICayan::getOrganizationId() const {
    return m_organization_id;
}
void OAICayan::setOrganizationId(const QString &organization_id) {
    m_organization_id = organization_id;
    m_organization_id_isSet = true;
}

bool OAICayan::is_organization_id_Set() const{
    return m_organization_id_isSet;
}

bool OAICayan::is_organization_id_Valid() const{
    return m_organization_id_isValid;
}

QList<OAIPaymentCardBrand> OAICayan::getPaymentCardSchemes() const {
    return m_payment_card_schemes;
}
void OAICayan::setPaymentCardSchemes(const QList<OAIPaymentCardBrand> &payment_card_schemes) {
    m_payment_card_schemes = payment_card_schemes;
    m_payment_card_schemes_isSet = true;
}

bool OAICayan::is_payment_card_schemes_Set() const{
    return m_payment_card_schemes_isSet;
}

bool OAICayan::is_payment_card_schemes_Valid() const{
    return m_payment_card_schemes_isValid;
}

bool OAICayan::isReconciliationWindowEnabled() const {
    return m_reconciliation_window_enabled;
}
void OAICayan::setReconciliationWindowEnabled(const bool &reconciliation_window_enabled) {
    m_reconciliation_window_enabled = reconciliation_window_enabled;
    m_reconciliation_window_enabled_isSet = true;
}

bool OAICayan::is_reconciliation_window_enabled_Set() const{
    return m_reconciliation_window_enabled_isSet;
}

bool OAICayan::is_reconciliation_window_enabled_Valid() const{
    return m_reconciliation_window_enabled_isValid;
}

qint32 OAICayan::getReconciliationWindowTtl() const {
    return m_reconciliation_window_ttl;
}
void OAICayan::setReconciliationWindowTtl(const qint32 &reconciliation_window_ttl) {
    m_reconciliation_window_ttl = reconciliation_window_ttl;
    m_reconciliation_window_ttl_isSet = true;
}

bool OAICayan::is_reconciliation_window_ttl_Set() const{
    return m_reconciliation_window_ttl_isSet;
}

bool OAICayan::is_reconciliation_window_ttl_Valid() const{
    return m_reconciliation_window_ttl_isValid;
}

QString OAICayan::getStatus() const {
    return m_status;
}
void OAICayan::setStatus(const QString &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAICayan::is_status_Set() const{
    return m_status_isSet;
}

bool OAICayan::is_status_Valid() const{
    return m_status_isValid;
}

bool OAICayan::isSticky() const {
    return m_sticky;
}
void OAICayan::setSticky(const bool &sticky) {
    m_sticky = sticky;
    m_sticky_isSet = true;
}

bool OAICayan::is_sticky_Set() const{
    return m_sticky_isSet;
}

bool OAICayan::is_sticky_Valid() const{
    return m_sticky_isValid;
}

bool OAICayan::isThreeDSecure() const {
    return m_three_d_secure;
}
void OAICayan::setThreeDSecure(const bool &three_d_secure) {
    m_three_d_secure = three_d_secure;
    m_three_d_secure_isSet = true;
}

bool OAICayan::is_three_d_secure_Set() const{
    return m_three_d_secure_isSet;
}

bool OAICayan::is_three_d_secure_Valid() const{
    return m_three_d_secure_isValid;
}

qint32 OAICayan::getTimeout() const {
    return m_timeout;
}
void OAICayan::setTimeout(const qint32 &timeout) {
    m_timeout = timeout;
    m_timeout_isSet = true;
}

bool OAICayan::is_timeout_Set() const{
    return m_timeout_isSet;
}

bool OAICayan::is_timeout_Valid() const{
    return m_timeout_isValid;
}

QString OAICayan::getToken() const {
    return m_token;
}
void OAICayan::setToken(const QString &token) {
    m_token = token;
    m_token_isSet = true;
}

bool OAICayan::is_token_Set() const{
    return m_token_isSet;
}

bool OAICayan::is_token_Valid() const{
    return m_token_isValid;
}

QDateTime OAICayan::getUpdatedTime() const {
    return m_updated_time;
}
void OAICayan::setUpdatedTime(const QDateTime &updated_time) {
    m_updated_time = updated_time;
    m_updated_time_isSet = true;
}

bool OAICayan::is_updated_time_Set() const{
    return m_updated_time_isSet;
}

bool OAICayan::is_updated_time_Valid() const{
    return m_updated_time_isValid;
}

OAICayan_allOf_credentials OAICayan::getCredentials() const {
    return m_credentials;
}
void OAICayan::setCredentials(const OAICayan_allOf_credentials &credentials) {
    m_credentials = credentials;
    m_credentials_isSet = true;
}

bool OAICayan::is_credentials_Set() const{
    return m_credentials_isSet;
}

bool OAICayan::is_credentials_Valid() const{
    return m_credentials_isValid;
}

bool OAICayan::isSet() const {
