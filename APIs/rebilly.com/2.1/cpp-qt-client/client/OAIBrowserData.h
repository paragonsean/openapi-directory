...
#ifndef OAIBrowserData_H
#define OAIBrowserData_H
...
class OAIBrowserData : public OAIObject {
public:
    OAIBrowserData();
    OAIBrowserData(QString json);
    ~OAIBrowserData() override;
    ...
    bool isIsJavaEnabled() const;
    void setIsJavaEnabled(const bool &is_java_enabled);
    bool is_is_java_enabled_Set() const;
    bool is_is_java_enabled_Valid() const;
...
private:
    ...
    bool m_is_java_enabled;
    bool m_is_java_enabled_isSet;
    bool m_is_java_enabled_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBrowserData)

#endif // OAIBrowserData_H
