...
OAIPayCash::OAIPayCash(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPayCash::OAIPayCash() {
    this->initializeModel();
}

OAIPayCash::~OAIPayCash() {}

void OAIPayCash::initializeModel() {
...
void OAIPayCash::fromJson(QString jsonString) {
...
void OAIPayCash::fromJsonObject(QJsonObject json) {
...
QString OAIPayCash::asJson() const {
...
QJsonObject OAIPayCash::asJsonObject() const {
    QJsonObject obj;
    if (m__links.size() > 0) {
...
QList<OAIGatewayAccount__links_inner> OAIPayCash::getLinks() const {
    return m__links;
}
void OAIPayCash::setLinks(const QList<OAIGatewayAccount__links_inner> &_links) {
    m__links = _links;
    m__links_isSet = true;
}

bool OAIPayCash::is__links_Set() const{
    return m__links_isSet;
}

bool OAIPayCash::is__links_Valid() const{
    return m__links_isValid;
}

QList<QString> OAIPayCash::getAcceptedCurrencies() const {
    return m_accepted_currencies;
}
void OAIPayCash::setAcceptedCurrencies(const QList<QString> &accepted_currencies) {
    m_accepted_currencies = accepted_currencies;
    m_accepted_currencies_isSet = true;
}

bool OAIPayCash::is_accepted_currencies_Set() const{
    return m_accepted_currencies_isSet;
}

bool OAIPayCash::is_accepted_currencies_Valid() const{
    return m_accepted_currencies_isValid;
}

OAIAcquirerName OAIPayCash::getAcquirerName() const {
    return m_acquirer_name;
}
void OAIPayCash::setAcquirerName(const OAIAcquirerName &acquirer_name) {
    m_acquirer_name = acquirer_name;
    m_acquirer_name_isSet = true;
}

bool OAIPayCash::is_acquirer_name_Set() const{
    return m_acquirer_name_isSet;
}

bool OAIPayCash::is_acquirer_name_Valid() const{
    return m_acquirer_name_isValid;
}

QString OAIPayCash::getAdditionalFilters() const {
    return m_additional_filters;
}
void OAIPayCash::setAdditionalFilters(const QString &additional_filters) {
    m_additional_filters = additional_filters;
    m_additional_filters_isSet = true;
}

bool OAIPayCash::is_additional_filters_Set() const{
    return m_additional_filters_isSet;
}

bool OAIPayCash::is_additional_filters_Valid() const{
    return m_additional_filters_isValid;
}

qint32 OAIPayCash::getApprovalWindowTtl() const {
    return m_approval_window_ttl;
}
void OAIPayCash::setApprovalWindowTtl(const qint32 &approval_window_ttl) {
    m_approval_window_ttl = approval_window_ttl;
    m_approval_window_ttl_isSet = true;
}

bool OAIPayCash::is_approval_window_ttl_Set() const{
    return m_approval_window_ttl_isSet;
}

bool OAIPayCash::is_approval_window_ttl_Valid() const{
    return m_approval_window_ttl_isValid;
}

QString OAIPayCash::getCityField() const {
    return m_city_field;
}
void OAIPayCash::setCityField(const QString &city_field) {
    m_city_field = city_field;
    m_city_field_isSet = true;
}

bool OAIPayCash::is_city_field_Set() const{
    return m_city_field_isSet;
}

bool OAIPayCash::is_city_field_Valid() const{
    return m_city_field_isValid;
}

QDateTime OAIPayCash::getCreatedTime() const {
    return m_created_time;
}
void OAIPayCash::setCreatedTime(const QDateTime &created_time) {
    m_created_time = created_time;
    m_created_time_isSet = true;
}

bool OAIPayCash::is_created_time_Set() const{
    return m_created_time_isSet;
}

bool OAIPayCash::is_created_time_Valid() const{
    return m_created_time_isValid;
}

QString OAIPayCash::getDccForceCurrency() const {
    return m_dcc_force_currency;
}
void OAIPayCash::setDccForceCurrency(const QString &dcc_force_currency) {
    m_dcc_force_currency = dcc_force_currency;
    m_dcc_force_currency_isSet = true;
}

bool OAIPayCash::is_dcc_force_currency_Set() const{
    return m_dcc_force_currency_isSet;
}

bool OAIPayCash::is_dcc_force_currency_Valid() const{
    return m_dcc_force_currency_isValid;
}

qint32 OAIPayCash::getDccMarkup() const {
    return m_dcc_markup;
}
void OAIPayCash::setDccMarkup(const qint32 &dcc_markup) {
    m_dcc_markup = dcc_markup;
    m_dcc_markup_isSet = true;
}

bool OAIPayCash::is_dcc_markup_Set() const{
    return m_dcc_markup_isSet;
}

bool OAIPayCash::is_dcc_markup_Valid() const{
    return m_dcc_markup_isValid;
}

QString OAIPayCash::getDescriptor() const {
    return m_descriptor;
}
void OAIPayCash::setDescriptor(const QString &descriptor) {
    m_descriptor = descriptor;
    m_descriptor_isSet = true;
}

bool OAIPayCash::is_descriptor_Set() const{
    return m_descriptor_isSet;
}

bool OAIPayCash::is_descriptor_Valid() const{
    return m_descriptor_isValid;
}

OAIDigitalWallets OAIPayCash::getDigitalWallets() const {
    return m_digital_wallets;
}
void OAIPayCash::setDigitalWallets(const OAIDigitalWallets &digital_wallets) {
    m_digital_wallets = digital_wallets;
    m_digital_wallets_isSet = true;
}

bool OAIPayCash::is_digital_wallets_Set() const{
    return m_digital_wallets_isSet;
}

bool OAIPayCash::is_digital_wallets_Valid() const{
    return m_digital_wallets_isValid;
}

bool OAIPayCash::isDynamicDescriptor() const {
    return m_dynamic_descriptor;
}
void OAIPayCash::setDynamicDescriptor(const bool &dynamic_descriptor) {
    m_dynamic_descriptor = dynamic_descriptor;
    m_dynamic_descriptor_isSet = true;
}

bool OAIPayCash::is_dynamic_descriptor_Set() const{
    return m_dynamic_descriptor_isSet;
}

bool OAIPayCash::is_dynamic_descriptor_Valid() const{
    return m_dynamic_descriptor_isValid;
}

QList<QString> OAIPayCash::getExcludedDccQuoteCurrencies() const {
    return m_excluded_dcc_quote_currencies;
}
void OAIPayCash::setExcludedDccQuoteCurrencies(const QList<QString> &excluded_dcc_quote_currencies) {
    m_excluded_dcc_quote_currencies = excluded_dcc_quote_currencies;
    m_excluded_dcc_quote_currencies_isSet = true;
}

bool OAIPayCash::is_excluded_dcc_quote_currencies_Set() const{
    return m_excluded_dcc_quote_currencies_isSet;
}

bool OAIPayCash::is_excluded_dcc_quote_currencies_Valid() const{
    return m_excluded_dcc_quote_currencies_isValid;
}

OAIGatewayName OAIPayCash::getGatewayName() const {
    return m_gateway_name;
}
void OAIPayCash::setGatewayName(const OAIGatewayName &gateway_name) {
    m_gateway_name = gateway_name;
    m_gateway_name_isSet = true;
}

bool OAIPayCash::is_gateway_name_Set() const{
    return m_gateway_name_isSet;
}

bool OAIPayCash::is_gateway_name_Valid() const{
    return m_gateway_name_isValid;
}

QString OAIPayCash::getId() const {
    return m_id;
}
void OAIPayCash::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIPayCash::is_id_Set() const{
    return m_id_isSet;
}

bool OAIPayCash::is_id_Valid() const{
    return m_id_isValid;
}

bool OAIPayCash::isIsDown() const {
    return m_is_down;
}
void OAIPayCash::setIsDown(const bool &is_down) {
    m_is_down = is_down;
    m_is_down_isSet = true;
}

bool OAIPayCash::is_is_down_Set() const{
    return m_is_down_isSet;
}

bool OAIPayCash::is_is_down_Valid() const{
    return m_is_down_isValid;
}

QString OAIPayCash::getMerchantCategoryCode() const {
    return m_merchant_category_code;
}
void OAIPayCash::setMerchantCategoryCode(const QString &merchant_category_code) {
    m_merchant_category_code = merchant_category_code;
    m_merchant_category_code_isSet = true;
}

bool OAIPayCash::is_merchant_category_code_Set() const{
    return m_merchant_category_code_isSet;
}

bool OAIPayCash::is_merchant_category_code_Valid() const{
    return m_merchant_category_code_isValid;
}

OAIPaymentMethod OAIPayCash::getMethod() const {
    return m_method;
}
void OAIPayCash::setMethod(const OAIPaymentMethod &method) {
    m_method = method;
    m_method_isSet = true;
}

bool OAIPayCash::is_method_Set() const{
    return m_method_isSet;
}

bool OAIPayCash::is_method_Valid() const{
    return m_method_isValid;
}

double OAIPayCash::getMonthlyLimit() const {
    return m_monthly_limit;
}
void OAIPayCash::setMonthlyLimit(const double &monthly_limit) {
    m_monthly_limit = monthly_limit;
    m_monthly_limit_isSet = true;
}

bool OAIPayCash::is_monthly_limit_Set() const{
    return m_monthly_limit_isSet;
}

bool OAIPayCash::is_monthly_limit_Valid() const{
    return m_monthly_limit_isValid;
}

QString OAIPayCash::getOrganizationId() const {
    return m_organization_id;
}
void OAIPayCash::setOrganizationId(const QString &organization_id) {
    m_organization_id = organization_id;
    m_organization_id_isSet = true;
}

bool OAIPayCash::is_organization_id_Set() const{
    return m_organization_id_isSet;
}

bool OAIPayCash::is_organization_id_Valid() const{
    return m_organization_id_isValid;
}

QList<OAIPaymentCardBrand> OAIPayCash::getPaymentCardSchemes() const {
    return m_payment_card_schemes;
}
void OAIPayCash::setPaymentCardSchemes(const QList<OAIPaymentCardBrand> &payment_card_schemes) {
    m_payment_card_schemes = payment_card_schemes;
    m_payment_card_schemes_isSet = true;
}

bool OAIPayCash::is_payment_card_schemes_Set() const{
    return m_payment_card_schemes_isSet;
}

bool OAIPayCash::is_payment_card_schemes_Valid() const{
    return m_payment_card_schemes_isValid;
}

bool OAIPayCash::isReconciliationWindowEnabled() const {
    return m_reconciliation_window_enabled;
}
void OAIPayCash::setReconciliationWindowEnabled(const bool &reconciliation_window_enabled) {
    m_reconciliation_window_enabled = reconciliation_window_enabled;
    m_reconciliation_window_enabled_isSet = true;
}

bool OAIPayCash::is_reconciliation_window_enabled_Set() const{
    return m_reconciliation_window_enabled_isSet;
}

bool OAIPayCash::is_reconciliation_window_enabled_Valid() const{
    return m_reconciliation_window_enabled_isValid;
}

qint32 OAIPayCash::getReconciliationWindowTtl() const {
    return m_reconciliation_window_ttl;
}
void OAIPayCash::setReconciliationWindowTtl(const qint32 &reconciliation_window_ttl) {
    m_reconciliation_window_ttl = reconciliation_window_ttl;
    m_reconciliation_window_ttl_isSet = true;
}

bool OAIPayCash::is_reconciliation_window_ttl_Set() const{
    return m_reconciliation_window_ttl_isSet;
}

bool OAIPayCash::is_reconciliation_window_ttl_Valid() const{
    return m_reconciliation_window_ttl_isValid;
}

QString OAIPayCash::getStatus() const {
    return m_status;
}
void OAIPayCash::setStatus(const QString &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIPayCash::is_status_Set() const{
    return m_status_isSet;
}

bool OAIPayCash::is_status_Valid() const{
    return m_status_isValid;
}

bool OAIPayCash::isSticky() const {
    return m_sticky;
}
void OAIPayCash::setSticky(const bool &sticky) {
    m_sticky = sticky;
    m_sticky_isSet = true;
}

bool OAIPayCash::is_sticky_Set() const{
    return m_sticky_isSet;
}

bool OAIPayCash::is_sticky_Valid() const{
    return m_sticky_isValid;
}

bool OAIPayCash::isThreeDSecure() const {
    return m_three_d_secure;
}
void OAIPayCash::setThreeDSecure(const bool &three_d_secure) {
    m_three_d_secure = three_d_secure;
    m_three_d_secure_isSet = true;
}

bool OAIPayCash::is_three_d_secure_Set() const{
    return m_three_d_secure_isSet;
}

bool OAIPayCash::is_three_d_secure_Valid() const{
    return m_three_d_secure_isValid;
}

qint32 OAIPayCash::getTimeout() const {
    return m_timeout;
}
void OAIPayCash::setTimeout(const qint32 &timeout) {
    m_timeout = timeout;
    m_timeout_isSet = true;
}

bool OAIPayCash::is_timeout_Set() const{
    return m_timeout_isSet;
}

bool OAIPayCash::is_timeout_Valid() const{
    return m_timeout_isValid;
}

QString OAIPayCash::getToken() const {
    return m_token;
}
void OAIPayCash::setToken(const QString &token) {
    m_token = token;
    m_token_isSet = true;
}

bool OAIPayCash::is_token_Set() const{
    return m_token_isSet;
}

bool OAIPayCash::is_token_Valid() const{
    return m_token_isValid;
}

QDateTime OAIPayCash::getUpdatedTime() const {
    return m_updated_time;
}
void OAIPayCash::setUpdatedTime(const QDateTime &updated_time) {
    m_updated_time = updated_time;
    m_updated_time_isSet = true;
}

bool OAIPayCash::is_updated_time_Set() const{
    return m_updated_time_isSet;
}

bool OAIPayCash::is_updated_time_Valid() const{
    return m_updated_time_isValid;
}

OAIPayCash_allOf_credentials OAIPayCash::getCredentials() const {
    return m_credentials;
}
void OAIPayCash::setCredentials(const OAIPayCash_allOf_credentials &credentials) {
    m_credentials = credentials;
    m_credentials_isSet = true;
}

bool OAIPayCash::is_credentials_Set() const{
    return m_credentials_isSet;
}

bool OAIPayCash::is_credentials_Valid() const{
    return m_credentials_isValid;
}

bool OAIPayCash::isSet() const {
