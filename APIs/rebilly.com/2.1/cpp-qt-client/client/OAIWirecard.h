...
#ifndef OAIWirecard_H
#define OAIWirecard_H
...
#include "OAIWirecard_allOf_credentials.h"
#include <QDateTime>
#include <QList>
#include <QString>
...
class OAIWirecard_allOf_credentials;
class OAIWirecard3dsServers;

class OAIWirecard : public OAIObject {
public:
    OAIWirecard();
    OAIWirecard(QString json);
    ~OAIWirecard() override;
    ...
    OAIWirecard_allOf_credentials getCredentials() const;
    void setCredentials(const OAIWirecard_allOf_credentials &credentials);
    bool is_credentials_Set() const;
    bool is_credentials_Valid() const;

    OAIWirecard3dsServers getThreeDSecureServer() const;
    void setThreeDSecureServer(const OAIWirecard3dsServers &three_d_secure_server);
...
private:
    ...
    OAIWirecard_allOf_credentials m_credentials;
    bool m_credentials_isSet;
    bool m_credentials_isValid;

    OAIWirecard3dsServers m_three_d_secure_server;
...
Q_DECLARE_METATYPE(OpenAPI::OAIWirecard)
