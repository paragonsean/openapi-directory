...
/*
 * OAIPostBankAccount_request.h
 *
 * 
 */

#ifndef OAIPostBankAccount_request_H
#define OAIPostBankAccount_request_H

#include <QJsonObject>

#include "OAIBankAccountCreatePlain.h"
...
class OAIPostBankAccount_request : public OAIObject {
public:
    OAIPostBankAccount_request();
    OAIPostBankAccount_request(QString json);
    ~OAIPostBankAccount_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPostBankAccount_request)

#endif // OAIPostBankAccount_request_H
