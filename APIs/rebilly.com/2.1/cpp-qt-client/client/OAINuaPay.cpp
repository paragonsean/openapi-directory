...
OAINuaPay::OAINuaPay(QString json) {
...
void OAINuaPay::initializeModel() {
...
void OAINuaPay::fromJson(QString jsonString) {
...
void OAINuaPay::fromJsonObject(QJsonObject json) {
...
QString OAINuaPay::asJson() const {
...
QJsonObject OAINuaPay::asJsonObject() const {
    QJsonObject obj;
    if (m__links.size() > 0) {
...
QList<OAIGatewayAccount__links_inner> OAINuaPay::getLinks() const {
    return m__links;
}
void OAINuaPay::setLinks(const QList<OAIGatewayAccount__links_inner> &_links) {
    m__links = _links;
    m__links_isSet = true;
}

bool OAINuaPay::is__links_Set() const{
    return m__links_isSet;
}

bool OAINuaPay::is__links_Valid() const{
    return m__links_isValid;
}

QList<QString> OAINuaPay::getAcceptedCurrencies() const {
    return m_accepted_currencies;
}
void OAINuaPay::setAcceptedCurrencies(const QList<QString> &accepted_currencies) {
    m_accepted_currencies = accepted_currencies;
    m_accepted_currencies_isSet = true;
}

bool OAINuaPay::is_accepted_currencies_Set() const{
    return m_accepted_currencies_isSet;
}

bool OAINuaPay::is_accepted_currencies_Valid() const{
    return m_accepted_currencies_isValid;
}

OAIAcquirerName OAINuaPay::getAcquirerName() const {
    return m_acquirer_name;
}
void OAINuaPay::setAcquirerName(const OAIAcquirerName &acquirer_name) {
    m_acquirer_name = acquirer_name;
    m_acquirer_name_isSet = true;
}

bool OAINuaPay::is_acquirer_name_Set() const{
    return m_acquirer_name_isSet;
}

bool OAINuaPay::is_acquirer_name_Valid() const{
    return m_acquirer_name_isValid;
}

QString OAINuaPay::getAdditionalFilters() const {
    return m_additional_filters;
}
void OAINuaPay::setAdditionalFilters(const QString &additional_filters) {
    m_additional_filters = additional_filters;
    m_additional_filters_isSet = true;
}

bool OAINuaPay::is_additional_filters_Set() const{
    return m_additional_filters_isSet;
}

bool OAINuaPay::is_additional_filters_Valid() const{
    return m_additional_filters_isValid;
}

qint32 OAINuaPay::getApprovalWindowTtl() const {
    return m_approval_window_ttl;
}
void OAINuaPay::setApprovalWindowTtl(const qint32 &approval_window_ttl) {
    m_approval_window_ttl = approval_window_ttl;
    m_approval_window_ttl_isSet = true;
}

bool OAINuaPay::is_approval_window_ttl_Set() const{
    return m_approval_window_ttl_isSet;
}

bool OAINuaPay::is_approval_window_ttl_Valid() const{
    return m_approval_window_ttl_isValid;
}

QString OAINuaPay::getCityField() const {
    return m_city_field;
}
void OAINuaPay::setCityField(const QString &city_field) {
    m_city_field = city_field;
    m_city_field_isSet = true;
}

bool OAINuaPay::is_city_field_Set() const{
    return m_city_field_isSet;
}

bool OAINuaPay::is_city_field_Valid() const{
    return m_city_field_isValid;
}

QDateTime OAINuaPay::getCreatedTime() const {
    return m_created_time;
}
void OAINuaPay::setCreatedTime(const QDateTime &created_time) {
    m_created_time = created_time;
    m_created_time_isSet = true;
}

bool OAINuaPay::is_created_time_Set() const{
    return m_created_time_isSet;
}

bool OAINuaPay::is_created_time_Valid() const{
    return m_created_time_isValid;
}

QString OAINuaPay::getDccForceCurrency() const {
    return m_dcc_force_currency;
}
void OAINuaPay::setDccForceCurrency(const QString &dcc_force_currency) {
    m_dcc_force_currency = dcc_force_currency;
    m_dcc_force_currency_isSet = true;
}

bool OAINuaPay::is_dcc_force_currency_Set() const{
    return m_dcc_force_currency_isSet;
}

bool OAINuaPay::is_dcc_force_currency_Valid() const{
    return m_dcc_force_currency_isValid;
}

qint32 OAINuaPay::getDccMarkup() const {
    return m_dcc_markup;
}
void OAINuaPay::setDccMarkup(const qint32 &dcc_markup) {
    m_dcc_markup = dcc_markup;
    m_dcc_markup_isSet = true;
}

bool OAINuaPay::is_dcc_markup_Set() const{
    return m_dcc_markup_isSet;
}

bool OAINuaPay::is_dcc_markup_Valid() const{
    return m_dcc_markup_isValid;
}

QString OAINuaPay::getDescriptor() const {
    return m_descriptor;
}
void OAINuaPay::setDescriptor(const QString &descriptor) {
    m_descriptor = descriptor;
    m_descriptor_isSet = true;
}

bool OAINuaPay::is_descriptor_Set() const{
    return m_descriptor_isSet;
}

bool OAINuaPay::is_descriptor_Valid() const{
    return m_descriptor_isValid;
}

OAIDigitalWallets OAINuaPay::getDigitalWallets() const {
    return m_digital_wallets;
}
void OAINuaPay::setDigitalWallets(const OAIDigitalWallets &digital_wallets) {
    m_digital_wallets = digital_wallets;
    m_digital_wallets_isSet = true;
}

bool OAINuaPay::is_digital_wallets_Set() const{
    return m_digital_wallets_isSet;
}

bool OAINuaPay::is_digital_wallets_Valid() const{
    return m_digital_wallets_isValid;
}

bool OAINuaPay::isDynamicDescriptor() const {
    return m_dynamic_descriptor;
}
void OAINuaPay::setDynamicDescriptor(const bool &dynamic_descriptor) {
    m_dynamic_descriptor = dynamic_descriptor;
    m_dynamic_descriptor_isSet = true;
}

bool OAINuaPay::is_dynamic_descriptor_Set() const{
    return m_dynamic_descriptor_isSet;
}

bool OAINuaPay::is_dynamic_descriptor_Valid() const{
    return m_dynamic_descriptor_isValid;
}

QList<QString> OAINuaPay::getExcludedDccQuoteCurrencies() const {
    return m_excluded_dcc_quote_currencies;
}
void OAINuaPay::setExcludedDccQuoteCurrencies(const QList<QString> &excluded_dcc_quote_currencies) {
    m_excluded_dcc_quote_currencies = excluded_dcc_quote_currencies;
    m_excluded_dcc_quote_currencies_isSet = true;
}

bool OAINuaPay::is_excluded_dcc_quote_currencies_Set() const{
    return m_excluded_dcc_quote_currencies_isSet;
}

bool OAINuaPay::is_excluded_dcc_quote_currencies_Valid() const{
    return m_excluded_dcc_quote_currencies_isValid;
}

OAIGatewayName OAINuaPay::getGatewayName() const {
    return m_gateway_name;
}
void OAINuaPay::setGatewayName(const OAIGatewayName &gateway_name) {
    m_gateway_name = gateway_name;
    m_gateway_name_isSet = true;
}

bool OAINuaPay::is_gateway_name_Set() const{
    return m_gateway_name_isSet;
}

bool OAINuaPay::is_gateway_name_Valid() const{
    return m_gateway_name_isValid;
}

QString OAINuaPay::getId() const {
    return m_id;
}
void OAINuaPay::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAINuaPay::is_id_Set() const{
    return m_id_isSet;
}

bool OAINuaPay::is_id_Valid() const{
    return m_id_isValid;
}

bool OAINuaPay::isIsDown() const {
    return m_is_down;
}
void OAINuaPay::setIsDown(const bool &is_down) {
    m_is_down = is_down;
    m_is_down_isSet = true;
}

bool OAINuaPay::is_is_down_Set() const{
    return m_is_down_isSet;
}

bool OAINuaPay::is_is_down_Valid() const{
    return m_is_down_isValid;
}

QString OAINuaPay::getMerchantCategoryCode() const {
    return m_merchant_category_code;
}
void OAINuaPay::setMerchantCategoryCode(const QString &merchant_category_code) {
    m_merchant_category_code = merchant_category_code;
    m_merchant_category_code_isSet = true;
}

bool OAINuaPay::is_merchant_category_code_Set() const{
    return m_merchant_category_code_isSet;
}

bool OAINuaPay::is_merchant_category_code_Valid() const{
    return m_merchant_category_code_isValid;
}

OAIPaymentMethod OAINuaPay::getMethod() const {
    return m_method;
}
void OAINuaPay::setMethod(const OAIPaymentMethod &method) {
    m_method = method;
    m_method_isSet = true;
}

bool OAINuaPay::is_method_Set() const{
    return m_method_isSet;
}

bool OAINuaPay::is_method_Valid() const{
    return m_method_isValid;
}

double OAINuaPay::getMonthlyLimit() const {
    return m_monthly_limit;
}
void OAINuaPay::setMonthlyLimit(const double &monthly_limit) {
    m_monthly_limit = monthly_limit;
    m_monthly_limit_isSet = true;
}

bool OAINuaPay::is_monthly_limit_Set() const{
    return m_monthly_limit_isSet;
}

bool OAINuaPay::is_monthly_limit_Valid() const{
    return m_monthly_limit_isValid;
}

QString OAINuaPay::getOrganizationId() const {
    return m_organization_id;
}
void OAINuaPay::setOrganizationId(const QString &organization_id) {
    m_organization_id = organization_id;
    m_organization_id_isSet = true;
}

bool OAINuaPay::is_organization_id_Set() const{
    return m_organization_id_isSet;
}

bool OAINuaPay::is_organization_id_Valid() const{
    return m_organization_id_isValid;
}

QList<OAIPaymentCardBrand> OAINuaPay::getPaymentCardSchemes() const {
    return m_payment_card_schemes;
}
void OAINuaPay::setPaymentCardSchemes(const QList<OAIPaymentCardBrand> &payment_card_schemes) {
    m_payment_card_schemes = payment_card_schemes;
    m_payment_card_schemes_isSet = true;
}

bool OAINuaPay::is_payment_card_schemes_Set() const{
    return m_payment_card_schemes_isSet;
}

bool OAINuaPay::is_payment_card_schemes_Valid() const{
    return m_payment_card_schemes_isValid;
}

bool OAINuaPay::isReconciliationWindowEnabled() const {
    return m_reconciliation_window_enabled;
}
void OAINuaPay::setReconciliationWindowEnabled(const bool &reconciliation_window_enabled) {
    m_reconciliation_window_enabled = reconciliation_window_enabled;
    m_reconciliation_window_enabled_isSet = true;
}

bool OAINuaPay::is_reconciliation_window_enabled_Set() const{
    return m_reconciliation_window_enabled_isSet;
}

bool OAINuaPay::is_reconciliation_window_enabled_Valid() const{
    return m_reconciliation_window_enabled_isValid;
}

qint32 OAINuaPay::getReconciliationWindowTtl() const {
    return m_reconciliation_window_ttl;
}
void OAINuaPay::setReconciliationWindowTtl(const qint32 &reconciliation_window_ttl) {
    m_reconciliation_window_ttl = reconciliation_window_ttl;
    m_reconciliation_window_ttl_isSet = true;
}

bool OAINuaPay::is_reconciliation_window_ttl_Set() const{
    return m_reconciliation_window_ttl_isSet;
}

bool OAINuaPay::is_reconciliation_window_ttl_Valid() const{
    return m_reconciliation_window_ttl_isValid;
}

QString OAINuaPay::getStatus() const {
    return m_status;
}
void OAINuaPay::setStatus(const QString &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAINuaPay::is_status_Set() const{
    return m_status_isSet;
}

bool OAINuaPay::is_status_Valid() const{
    return m_status_isValid;
}

bool OAINuaPay::isSticky() const {
    return m_sticky;
}
void OAINuaPay::setSticky(const bool &sticky) {
    m_sticky = sticky;
    m_sticky_isSet = true;
}

bool OAINuaPay::is_sticky_Set() const{
    return m_sticky_isSet;
}

bool OAINuaPay::is_sticky_Valid() const{
    return m_sticky_isValid;
}

bool OAINuaPay::isThreeDSecure() const {
    return m_three_d_secure;
}
void OAINuaPay::setThreeDSecure(const bool &three_d_secure) {
    m_three_d_secure = three_d_secure;
    m_three_d_secure_isSet = true;
}

bool OAINuaPay::is_three_d_secure_Set() const{
    return m_three_d_secure_isSet;
}

bool OAINuaPay::is_three_d_secure_Valid() const{
    return m_three_d_secure_isValid;
}

qint32 OAINuaPay::getTimeout() const {
    return m_timeout;
}
void OAINuaPay::setTimeout(const qint32 &timeout) {
    m_timeout = timeout;
    m_timeout_isSet = true;
}

bool OAINuaPay::is_timeout_Set() const{
    return m_timeout_isSet;
}

bool OAINuaPay::is_timeout_Valid() const{
    return m_timeout_isValid;
}

QString OAINuaPay::getToken() const {
    return m_token;
}
void OAINuaPay::setToken(const QString &token) {
    m_token = token;
    m_token_isSet = true;
}

bool OAINuaPay::is_token_Set() const{
    return m_token_isSet;
}

bool OAINuaPay::is_token_Valid() const{
    return m_token_isValid;
}

QDateTime OAINuaPay::getUpdatedTime() const {
    return m_updated_time;
}
void OAINuaPay::setUpdatedTime(const QDateTime &updated_time) {
    m_updated_time = updated_time;
    m_updated_time_isSet = true;
}

bool OAINuaPay::is_updated_time_Set() const{
    return m_updated_time_isSet;
}

bool OAINuaPay::is_updated_time_Valid() const{
    return m_updated_time_isValid;
}

OAINuaPay_allOf_credentials OAINuaPay::getCredentials() const {
    return m_credentials;
}
void OAINuaPay::setCredentials(const OAINuaPay_allOf_credentials &credentials) {
    m_credentials = credentials;
    m_credentials_isSet = true;
}

bool OAINuaPay::is_credentials_Set() const{
    return m_credentials_isSet;
}

bool OAINuaPay::is_credentials_Valid() const{
    return m_credentials_isValid;
}

bool OAINuaPay::isSet() const {
