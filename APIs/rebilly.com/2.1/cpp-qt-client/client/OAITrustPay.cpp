...
OAITrustPay::OAITrustPay(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAITrustPay::OAITrustPay() {
    this->initializeModel();
}

OAITrustPay::~OAITrustPay() {}

void OAITrustPay::initializeModel() {
...
void OAITrustPay::fromJson(QString jsonString) {
...
void OAITrustPay::fromJsonObject(QJsonObject json) {
...
QString OAITrustPay::asJson() const {
...
QJsonObject OAITrustPay::asJsonObject() const {
    QJsonObject obj;
    if (m__links.size() > 0) {
...
QList<OAIGatewayAccount__links_inner> OAITrustPay::getLinks() const {
    return m__links;
}
void OAITrustPay::setLinks(const QList<OAIGatewayAccount__links_inner> &_links) {
    m__links = _links;
    m__links_isSet = true;
}

bool OAITrustPay::is__links_Set() const{
    return m__links_isSet;
}

bool OAITrustPay::is__links_Valid() const{
    return m__links_isValid;
}

QList<QString> OAITrustPay::getAcceptedCurrencies() const {
    return m_accepted_currencies;
}
void OAITrustPay::setAcceptedCurrencies(const QList<QString> &accepted_currencies) {
    m_accepted_currencies = accepted_currencies;
    m_accepted_currencies_isSet = true;
}

bool OAITrustPay::is_accepted_currencies_Set() const{
    return m_accepted_currencies_isSet;
}

bool OAITrustPay::is_accepted_currencies_Valid() const{
    return m_accepted_currencies_isValid;
}

OAIAcquirerName OAITrustPay::getAcquirerName() const {
    return m_acquirer_name;
}
void OAITrustPay::setAcquirerName(const OAIAcquirerName &acquirer_name) {
    m_acquirer_name = acquirer_name;
    m_acquirer_name_isSet = true;
}

bool OAITrustPay::is_acquirer_name_Set() const{
    return m_acquirer_name_isSet;
}

bool OAITrustPay::is_acquirer_name_Valid() const{
    return m_acquirer_name_isValid;
}

QString OAITrustPay::getAdditionalFilters() const {
    return m_additional_filters;
}
void OAITrustPay::setAdditionalFilters(const QString &additional_filters) {
    m_additional_filters = additional_filters;
    m_additional_filters_isSet = true;
}

bool OAITrustPay::is_additional_filters_Set() const{
    return m_additional_filters_isSet;
}

bool OAITrustPay::is_additional_filters_Valid() const{
    return m_additional_filters_isValid;
}

qint32 OAITrustPay::getApprovalWindowTtl() const {
    return m_approval_window_ttl;
}
void OAITrustPay::setApprovalWindowTtl(const qint32 &approval_window_ttl) {
    m_approval_window_ttl = approval_window_ttl;
    m_approval_window_ttl_isSet = true;
}

bool OAITrustPay::is_approval_window_ttl_Set() const{
    return m_approval_window_ttl_isSet;
}

bool OAITrustPay::is_approval_window_ttl_Valid() const{
    return m_approval_window_ttl_isValid;
}

QString OAITrustPay::getCityField() const {
    return m_city_field;
}
void OAITrustPay::setCityField(const QString &city_field) {
    m_city_field = city_field;
    m_city_field_isSet = true;
}

bool OAITrustPay::is_city_field_Set() const{
    return m_city_field_isSet;
}

bool OAITrustPay::is_city_field_Valid() const{
    return m_city_field_isValid;
}

QDateTime OAITrustPay::getCreatedTime() const {
    return m_created_time;
}
void OAITrustPay::setCreatedTime(const QDateTime &created_time) {
    m_created_time = created_time;
    m_created_time_isSet = true;
}

bool OAITrustPay::is_created_time_Set() const{
    return m_created_time_isSet;
}

bool OAITrustPay::is_created_time_Valid() const{
    return m_created_time_isValid;
}

QString OAITrustPay::getDccForceCurrency() const {
    return m_dcc_force_currency;
}
void OAITrustPay::setDccForceCurrency(const QString &dcc_force_currency) {
    m_dcc_force_currency = dcc_force_currency;
    m_dcc_force_currency_isSet = true;
}

bool OAITrustPay::is_dcc_force_currency_Set() const{
    return m_dcc_force_currency_isSet;
}

bool OAITrustPay::is_dcc_force_currency_Valid() const{
    return m_dcc_force_currency_isValid;
}

qint32 OAITrustPay::getDccMarkup() const {
    return m_dcc_markup;
}
void OAITrustPay::setDccMarkup(const qint32 &dcc_markup) {
    m_dcc_markup = dcc_markup;
    m_dcc_markup_isSet = true;
}

bool OAITrustPay::is_dcc_markup_Set() const{
    return m_dcc_markup_isSet;
}

bool OAITrustPay::is_dcc_markup_Valid() const{
    return m_dcc_markup_isValid;
}

QString OAITrustPay::getDescriptor() const {
    return m_descriptor;
}
void OAITrustPay::setDescriptor(const QString &descriptor) {
    m_descriptor = descriptor;
    m_descriptor_isSet = true;
}

bool OAITrustPay::is_descriptor_Set() const{
    return m_descriptor_isSet;
}

bool OAITrustPay::is_descriptor_Valid() const{
    return m_descriptor_isValid;
}

OAIDigitalWallets OAITrustPay::getDigitalWallets() const {
    return m_digital_wallets;
}
void OAITrustPay::setDigitalWallets(const OAIDigitalWallets &digital_wallets) {
    m_digital_wallets = digital_wallets;
    m_digital_wallets_isSet = true;
}

bool OAITrustPay::is_digital_wallets_Set() const{
    return m_digital_wallets_isSet;
}

bool OAITrustPay::is_digital_wallets_Valid() const{
    return m_digital_wallets_isValid;
}

bool OAITrustPay::isDynamicDescriptor() const {
    return m_dynamic_descriptor;
}
void OAITrustPay::setDynamicDescriptor(const bool &dynamic_descriptor) {
    m_dynamic_descriptor = dynamic_descriptor;
    m_dynamic_descriptor_isSet = true;
}

bool OAITrustPay::is_dynamic_descriptor_Set() const{
    return m_dynamic_descriptor_isSet;
}

bool OAITrustPay::is_dynamic_descriptor_Valid() const{
    return m_dynamic_descriptor_isValid;
}

QList<QString> OAITrustPay::getExcludedDccQuoteCurrencies() const {
    return m_excluded_dcc_quote_currencies;
}
void OAITrustPay::setExcludedDccQuoteCurrencies(const QList<QString> &excluded_dcc_quote_currencies) {
    m_excluded_dcc_quote_currencies = excluded_dcc_quote_currencies;
    m_excluded_dcc_quote_currencies_isSet = true;
}

bool OAITrustPay::is_excluded_dcc_quote_currencies_Set() const{
    return m_excluded_dcc_quote_currencies_isSet;
}

bool OAITrustPay::is_excluded_dcc_quote_currencies_Valid() const{
    return m_excluded_dcc_quote_currencies_isValid;
}

OAIGatewayName OAITrustPay::getGatewayName() const {
    return m_gateway_name;
}
void OAITrustPay::setGatewayName(const OAIGatewayName &gateway_name) {
    m_gateway_name = gateway_name;
    m_gateway_name_isSet = true;
}

bool OAITrustPay::is_gateway_name_Set() const{
    return m_gateway_name_isSet;
}

bool OAITrustPay::is_gateway_name_Valid() const{
    return m_gateway_name_isValid;
}

QString OAITrustPay::getId() const {
    return m_id;
}
void OAITrustPay::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAITrustPay::is_id_Set() const{
    return m_id_isSet;
}

bool OAITrustPay::is_id_Valid() const{
    return m_id_isValid;
}

bool OAITrustPay::isIsDown() const {
    return m_is_down;
}
void OAITrustPay::setIsDown(const bool &is_down) {
    m_is_down = is_down;
    m_is_down_isSet = true;
}

bool OAITrustPay::is_is_down_Set() const{
    return m_is_down_isSet;
}

bool OAITrustPay::is_is_down_Valid() const{
    return m_is_down_isValid;
}

QString OAITrustPay::getMerchantCategoryCode() const {
    return m_merchant_category_code;
}
void OAITrustPay::setMerchantCategoryCode(const QString &merchant_category_code) {
    m_merchant_category_code = merchant_category_code;
    m_merchant_category_code_isSet = true;
}

bool OAITrustPay::is_merchant_category_code_Set() const{
    return m_merchant_category_code_isSet;
}

bool OAITrustPay::is_merchant_category_code_Valid() const{
    return m_merchant_category_code_isValid;
}

OAIPaymentMethod OAITrustPay::getMethod() const {
    return m_method;
}
void OAITrustPay::setMethod(const OAIPaymentMethod &method) {
    m_method = method;
    m_method_isSet = true;
}

bool OAITrustPay::is_method_Set() const{
    return m_method_isSet;
}

bool OAITrustPay::is_method_Valid() const{
    return m_method_isValid;
}

double OAITrustPay::getMonthlyLimit() const {
    return m_monthly_limit;
}
void OAITrustPay::setMonthlyLimit(const double &monthly_limit) {
    m_monthly_limit = monthly_limit;
    m_monthly_limit_isSet = true;
}

bool OAITrustPay::is_monthly_limit_Set() const{
    return m_monthly_limit_isSet;
}

bool OAITrustPay::is_monthly_limit_Valid() const{
    return m_monthly_limit_isValid;
}

QString OAITrustPay::getOrganizationId() const {
    return m_organization_id;
}
void OAITrustPay::setOrganizationId(const QString &organization_id) {
    m_organization_id = organization_id;
    m_organization_id_isSet = true;
}

bool OAITrustPay::is_organization_id_Set() const{
    return m_organization_id_isSet;
}

bool OAITrustPay::is_organization_id_Valid() const{
    return m_organization_id_isValid;
}

QList<OAIPaymentCardBrand> OAITrustPay::getPaymentCardSchemes() const {
    return m_payment_card_schemes;
}
void OAITrustPay::setPaymentCardSchemes(const QList<OAIPaymentCardBrand> &payment_card_schemes) {
    m_payment_card_schemes = payment_card_schemes;
    m_payment_card_schemes_isSet = true;
}

bool OAITrustPay::is_payment_card_schemes_Set() const{
    return m_payment_card_schemes_isSet;
}

bool OAITrustPay::is_payment_card_schemes_Valid() const{
    return m_payment_card_schemes_isValid;
}

bool OAITrustPay::isReconciliationWindowEnabled() const {
    return m_reconciliation_window_enabled;
}
void OAITrustPay::setReconciliationWindowEnabled(const bool &reconciliation_window_enabled) {
    m_reconciliation_window_enabled = reconciliation_window_enabled;
    m_reconciliation_window_enabled_isSet = true;
}

bool OAITrustPay::is_reconciliation_window_enabled_Set() const{
    return m_reconciliation_window_enabled_isSet;
}

bool OAITrustPay::is_reconciliation_window_enabled_Valid() const{
    return m_reconciliation_window_enabled_isValid;
}

qint32 OAITrustPay::getReconciliationWindowTtl() const {
    return m_reconciliation_window_ttl;
}
void OAITrustPay::setReconciliationWindowTtl(const qint32 &reconciliation_window_ttl) {
    m_reconciliation_window_ttl = reconciliation_window_ttl;
    m_reconciliation_window_ttl_isSet = true;
}

bool OAITrustPay::is_reconciliation_window_ttl_Set() const{
    return m_reconciliation_window_ttl_isSet;
}

bool OAITrustPay::is_reconciliation_window_ttl_Valid() const{
    return m_reconciliation_window_ttl_isValid;
}

QString OAITrustPay::getStatus() const {
    return m_status;
}
void OAITrustPay::setStatus(const QString &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAITrustPay::is_status_Set() const{
    return m_status_isSet;
}

bool OAITrustPay::is_status_Valid() const{
    return m_status_isValid;
}

bool OAITrustPay::isSticky() const {
    return m_sticky;
}
void OAITrustPay::setSticky(const bool &sticky) {
    m_sticky = sticky;
    m_sticky_isSet = true;
}

bool OAITrustPay::is_sticky_Set() const{
    return m_sticky_isSet;
}

bool OAITrustPay::is_sticky_Valid() const{
    return m_sticky_isValid;
}

bool OAITrustPay::isThreeDSecure() const {
    return m_three_d_secure;
}
void OAITrustPay::setThreeDSecure(const bool &three_d_secure) {
    m_three_d_secure = three_d_secure;
    m_three_d_secure_isSet = true;
}

bool OAITrustPay::is_three_d_secure_Set() const{
    return m_three_d_secure_isSet;
}

bool OAITrustPay::is_three_d_secure_Valid() const{
    return m_three_d_secure_isValid;
}

qint32 OAITrustPay::getTimeout() const {
    return m_timeout;
}
void OAITrustPay::setTimeout(const qint32 &timeout) {
    m_timeout = timeout;
    m_timeout_isSet = true;
}

bool OAITrustPay::is_timeout_Set() const{
    return m_timeout_isSet;
}

bool OAITrustPay::is_timeout_Valid() const{
    return m_timeout_isValid;
}

QString OAITrustPay::getToken() const {
    return m_token;
}
void OAITrustPay::setToken(const QString &token) {
    m_token = token;
    m_token_isSet = true;
}

bool OAITrustPay::is_token_Set() const{
    return m_token_isSet;
}

bool OAITrustPay::is_token_Valid() const{
    return m_token_isValid;
}

QDateTime OAITrustPay::getUpdatedTime() const {
    return m_updated_time;
}
void OAITrustPay::setUpdatedTime(const QDateTime &updated_time) {
    m_updated_time = updated_time;
    m_updated_time_isSet = true;
}

bool OAITrustPay::is_updated_time_Set() const{
    return m_updated_time_isSet;
}

bool OAITrustPay::is_updated_time_Valid() const{
    return m_updated_time_isValid;
}

OAITrustPay_allOf_credentials OAITrustPay::getCredentials() const {
    return m_credentials;
}
void OAITrustPay::setCredentials(const OAITrustPay_allOf_credentials &credentials) {
    m_credentials = credentials;
    m_credentials_isSet = true;
}

bool OAITrustPay::is_credentials_Set() const{
    return m_credentials_isSet;
}

bool OAITrustPay::is_credentials_Valid() const{
    return m_credentials_isValid;
}

bool OAITrustPay::isSet() const {
...
bool OAITrustPay::isValid() const {
