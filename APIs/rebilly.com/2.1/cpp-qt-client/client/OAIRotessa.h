...
#include "OAIRotessa_allOf_credentials.h"
...
class OAIRotessa_allOf_credentials;
class OAIRotessa_allOf_settings;

class OAIRotessa : public OAIObject {
public:
    OAIRotessa();
    OAIRotessa(QString json);
    ~OAIRotessa() override;
    ...
    OAIRotessa_allOf_credentials getCredentials() const;
    void setCredentials(const OAIRotessa_allOf_credentials &credentials);
    bool is_credentials_Set() const;
    bool is_credentials_Valid() const;

    OAIRotessa_allOf_settings getSettings() const;
    void setSettings(const OAIRotessa_allOf_settings &settings);
...
private:
    ...
    OAIRotessa_allOf_credentials m_credentials;
    bool m_credentials_isSet;
    bool m_credentials_isValid;

    OAIRotessa_allOf_settings m_settings;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRotessa)
