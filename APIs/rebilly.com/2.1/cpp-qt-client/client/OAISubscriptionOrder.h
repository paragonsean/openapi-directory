...
/*
 * OAISubscriptionOrder.h
 *
 * 
 */

#ifndef OAISubscriptionOrder_H
#define OAISubscriptionOrder_H
...
class OAISubscriptionOrder : public OAIObject {
public:
    OAISubscriptionOrder();
    OAISubscriptionOrder(QString json);
    ~OAISubscriptionOrder() override;
    ...
    QString getCancelCategory() const;
    void setCancelCategory(const QString &cancel_category);
    bool is_cancel_category_Set() const;
    bool is_cancel_category_Valid() const;
    ...
    qint32 getRenewalReminderNumber() const;
    void setRenewalReminderNumber(const qint32 &renewal_reminder_number);
    bool is_renewal_reminder_number_Set() const;
    bool is_renewal_reminder_number_Valid() const;

    QDateTime getRenewalReminderTime() const;
    void setRenewalReminderTime(const QDateTime &renewal_reminder_time);
    bool is_renewal_reminder_time_Set() const;
    bool is_renewal_reminder_time_Valid() const;

    qint32 getTrialReminderNumber() const;
    void setTrialReminderNumber(const qint32 &trial_reminder_number);
    bool is_trial_reminder_number_Set() const;
    bool is_trial_reminder_number_Valid() const;

    QDateTime getTrialReminderTime() const;
    void setTrialReminderTime(const QDateTime &trial_reminder_time);
    bool is_trial_reminder_time_Set() const;
    bool is_trial_reminder_time_Valid() const;
...
private:
    ...
    QString m_cancel_category;
    bool m_cancel_category_isSet;
    bool m_cancel_category_isValid;
    ...
    qint32 m_renewal_reminder_number;
    bool m_renewal_reminder_number_isSet;
    bool m_renewal_reminder_number_isValid;

    QDateTime m_renewal_reminder_time;
    bool m_renewal_reminder_time_isSet;
    bool m_renewal_reminder_time_isValid;

    qint32 m_trial_reminder_number;
    bool m_trial_reminder_number_isSet;
    bool m_trial_reminder_number_isValid;

    QDateTime m_trial_reminder_time;
    bool m_trial_reminder_time_isSet;
    bool m_trial_reminder_time_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAISubscriptionOrder)

#endif // OAISubscriptionOrder_H
