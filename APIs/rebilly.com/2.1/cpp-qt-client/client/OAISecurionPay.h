...
#ifndef OAISecurionPay_H
#define OAISecurionPay_H
...
#include "OAISecurionPay3dsServers.h"
#include "OAISecurionPay_allOf_credentials.h"
#include <QDateTime>
#include <QList>
#include <QString>
...
class OAISecurionPay_allOf_credentials;
class OAISecurionPay3dsServers;

class OAISecurionPay : public OAIObject {
public:
    OAISecurionPay();
    OAISecurionPay(QString json);
    ~OAISecurionPay() override;
    ...
    OAISecurionPay_allOf_credentials getCredentials() const;
    void setCredentials(const OAISecurionPay_allOf_credentials &credentials);
    bool is_credentials_Set() const;
    bool is_credentials_Valid() const;

    OAISecurionPay3dsServers getThreeDSecureServer() const;
    void setThreeDSecureServer(const OAISecurionPay3dsServers &three_d_secure_server);
...
private:
    ...
    OAISecurionPay_allOf_credentials m_credentials;
    bool m_credentials_isSet;
    bool m_credentials_isValid;

    OAISecurionPay3dsServers m_three_d_secure_server;
...
Q_DECLARE_METATYPE(OpenAPI::OAISecurionPay)

#endif // OAISecurionPay_H
