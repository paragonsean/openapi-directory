...
/*
 * OAIAsiaPaymentGateway.h
 *
 * AsiaPaymentGateway config.
 */

#ifndef OAIAsiaPaymentGateway_H
#define OAIAsiaPaymentGateway_H

#include <QJsonObject>

#include "OAIAcquirerName.h"
#include "OAIAsiaPaymentGateway_allOf_credentials.h"
...
class OAIAsiaPaymentGateway_allOf_credentials;

class OAIAsiaPaymentGateway : public OAIObject {
public:
    OAIAsiaPaymentGateway();
    OAIAsiaPaymentGateway(QString json);
    ~OAIAsiaPaymentGateway() override;
    ...
    OAIAsiaPaymentGateway_allOf_credentials getCredentials() const;
    void setCredentials(const OAIAsiaPaymentGateway_allOf_credentials &credentials);
...
private:
    ...
    OAIAsiaPaymentGateway_allOf_credentials m_credentials;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAsiaPaymentGateway)

#endif // OAIAsiaPaymentGateway_H
