...
#ifndef OAIBBANType_H
#define OAIBBANType_H
...
class OAIBBANType : public OAIObject {
public:
    OAIBBANType();
    OAIBBANType(QString json);
    ~OAIBBANType() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBBANType)
