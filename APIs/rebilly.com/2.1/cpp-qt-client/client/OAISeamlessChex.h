...
#ifndef OAISeamlessChex_H
#define OAISeamlessChex_H
...
class OAISeamlessChex_allOf_credentials;

class OAISeamlessChex : public OAIObject {
public:
    OAISeamlessChex();
    OAISeamlessChex(QString json);
    ~OAISeamlessChex() override;
    ...
    OAISeamlessChex_allOf_credentials getCredentials() const;
    void setCredentials(const OAISeamlessChex_allOf_credentials &credentials);
...
private:
    ...
    OAISeamlessChex_allOf_credentials m_credentials;
...
Q_DECLARE_METATYPE(OpenAPI::OAISeamlessChex)

#endif // OAISeamlessChex_H
