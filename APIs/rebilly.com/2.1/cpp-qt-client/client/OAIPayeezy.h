...
#include "OAIPayeezy_allOf_credentials.h"
...
class OAIPayeezy_allOf_credentials;

class OAIPayeezy : public OAIObject {
public:
    OAIPayeezy();
    OAIPayeezy(QString json);
    ~OAIPayeezy() override;
    ...
    OAIPayeezy_allOf_credentials getCredentials() const;
    void setCredentials(const OAIPayeezy_allOf_credentials &credentials);
...
private:
    ...
    OAIPayeezy_allOf_credentials m_credentials;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPayeezy)
