...
OAIPaysafe::OAIPaysafe(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPaysafe::OAIPaysafe() {
    this->initializeModel();
}

OAIPaysafe::~OAIPaysafe() {}

void OAIPaysafe::initializeModel() {
...
void OAIPaysafe::fromJson(QString jsonString) {
...
void OAIPaysafe::fromJsonObject(QJsonObject json) {
...
QString OAIPaysafe::asJson() const {
...
QJsonObject OAIPaysafe::asJsonObject() const {
    QJsonObject obj;
    if (m__links.size() > 0) {
...
QList<OAIGatewayAccount__links_inner> OAIPaysafe::getLinks() const {
    return m__links;
}
void OAIPaysafe::setLinks(const QList<OAIGatewayAccount__links_inner> &_links) {
    m__links = _links;
    m__links_isSet = true;
}

bool OAIPaysafe::is__links_Set() const{
    return m__links_isSet;
}

bool OAIPaysafe::is__links_Valid() const{
    return m__links_isValid;
}

QList<QString> OAIPaysafe::getAcceptedCurrencies() const {
    return m_accepted_currencies;
}
void OAIPaysafe::setAcceptedCurrencies(const QList<QString> &accepted_currencies) {
    m_accepted_currencies = accepted_currencies;
    m_accepted_currencies_isSet = true;
}

bool OAIPaysafe::is_accepted_currencies_Set() const{
    return m_accepted_currencies_isSet;
}

bool OAIPaysafe::is_accepted_currencies_Valid() const{
    return m_accepted_currencies_isValid;
}

OAIAcquirerName OAIPaysafe::getAcquirerName() const {
    return m_acquirer_name;
}
void OAIPaysafe::setAcquirerName(const OAIAcquirerName &acquirer_name) {
    m_acquirer_name = acquirer_name;
    m_acquirer_name_isSet = true;
}

bool OAIPaysafe::is_acquirer_name_Set() const{
    return m_acquirer_name_isSet;
}

bool OAIPaysafe::is_acquirer_name_Valid() const{
    return m_acquirer_name_isValid;
}

QString OAIPaysafe::getAdditionalFilters() const {
    return m_additional_filters;
}
void OAIPaysafe::setAdditionalFilters(const QString &additional_filters) {
    m_additional_filters = additional_filters;
    m_additional_filters_isSet = true;
}

bool OAIPaysafe::is_additional_filters_Set() const{
    return m_additional_filters_isSet;
}

bool OAIPaysafe::is_additional_filters_Valid() const{
    return m_additional_filters_isValid;
}

qint32 OAIPaysafe::getApprovalWindowTtl() const {
    return m_approval_window_ttl;
}
void OAIPaysafe::setApprovalWindowTtl(const qint32 &approval_window_ttl) {
    m_approval_window_ttl = approval_window_ttl;
    m_approval_window_ttl_isSet = true;
}

bool OAIPaysafe::is_approval_window_ttl_Set() const{
    return m_approval_window_ttl_isSet;
}

bool OAIPaysafe::is_approval_window_ttl_Valid() const{
    return m_approval_window_ttl_isValid;
}

QString OAIPaysafe::getCityField() const {
    return m_city_field;
}
void OAIPaysafe::setCityField(const QString &city_field) {
    m_city_field = city_field;
    m_city_field_isSet = true;
}

bool OAIPaysafe::is_city_field_Set() const{
    return m_city_field_isSet;
}

bool OAIPaysafe::is_city_field_Valid() const{
    return m_city_field_isValid;
}

QDateTime OAIPaysafe::getCreatedTime() const {
    return m_created_time;
}
void OAIPaysafe::setCreatedTime(const QDateTime &created_time) {
    m_created_time = created_time;
    m_created_time_isSet = true;
}

bool OAIPaysafe::is_created_time_Set() const{
    return m_created_time_isSet;
}

bool OAIPaysafe::is_created_time_Valid() const{
    return m_created_time_isValid;
}

QString OAIPaysafe::getDccForceCurrency() const {
    return m_dcc_force_currency;
}
void OAIPaysafe::setDccForceCurrency(const QString &dcc_force_currency) {
    m_dcc_force_currency = dcc_force_currency;
    m_dcc_force_currency_isSet = true;
}

bool OAIPaysafe::is_dcc_force_currency_Set() const{
    return m_dcc_force_currency_isSet;
}

bool OAIPaysafe::is_dcc_force_currency_Valid() const{
    return m_dcc_force_currency_isValid;
}

qint32 OAIPaysafe::getDccMarkup() const {
    return m_dcc_markup;
}
void OAIPaysafe::setDccMarkup(const qint32 &dcc_markup) {
    m_dcc_markup = dcc_markup;
    m_dcc_markup_isSet = true;
}

bool OAIPaysafe::is_dcc_markup_Set() const{
    return m_dcc_markup_isSet;
}

bool OAIPaysafe::is_dcc_markup_Valid() const{
    return m_dcc_markup_isValid;
}

QString OAIPaysafe::getDescriptor() const {
    return m_descriptor;
}
void OAIPaysafe::setDescriptor(const QString &descriptor) {
    m_descriptor = descriptor;
    m_descriptor_isSet = true;
}

bool OAIPaysafe::is_descriptor_Set() const{
    return m_descriptor_isSet;
}

bool OAIPaysafe::is_descriptor_Valid() const{
    return m_descriptor_isValid;
}

OAIDigitalWallets OAIPaysafe::getDigitalWallets() const {
    return m_digital_wallets;
}
void OAIPaysafe::setDigitalWallets(const OAIDigitalWallets &digital_wallets) {
    m_digital_wallets = digital_wallets;
    m_digital_wallets_isSet = true;
}

bool OAIPaysafe::is_digital_wallets_Set() const{
    return m_digital_wallets_isSet;
}

bool OAIPaysafe::is_digital_wallets_Valid() const{
    return m_digital_wallets_isValid;
}

bool OAIPaysafe::isDynamicDescriptor() const {
    return m_dynamic_descriptor;
}
void OAIPaysafe::setDynamicDescriptor(const bool &dynamic_descriptor) {
    m_dynamic_descriptor = dynamic_descriptor;
    m_dynamic_descriptor_isSet = true;
}

bool OAIPaysafe::is_dynamic_descriptor_Set() const{
    return m_dynamic_descriptor_isSet;
}

bool OAIPaysafe::is_dynamic_descriptor_Valid() const{
    return m_dynamic_descriptor_isValid;
}

QList<QString> OAIPaysafe::getExcludedDccQuoteCurrencies() const {
    return m_excluded_dcc_quote_currencies;
}
void OAIPaysafe::setExcludedDccQuoteCurrencies(const QList<QString> &excluded_dcc_quote_currencies) {
    m_excluded_dcc_quote_currencies = excluded_dcc_quote_currencies;
    m_excluded_dcc_quote_currencies_isSet = true;
}

bool OAIPaysafe::is_excluded_dcc_quote_currencies_Set() const{
    return m_excluded_dcc_quote_currencies_isSet;
}

bool OAIPaysafe::is_excluded_dcc_quote_currencies_Valid() const{
    return m_excluded_dcc_quote_currencies_isValid;
}

OAIGatewayName OAIPaysafe::getGatewayName() const {
    return m_gateway_name;
}
void OAIPaysafe::setGatewayName(const OAIGatewayName &gateway_name) {
    m_gateway_name = gateway_name;
    m_gateway_name_isSet = true;
}

bool OAIPaysafe::is_gateway_name_Set() const{
    return m_gateway_name_isSet;
}

bool OAIPaysafe::is_gateway_name_Valid() const{
    return m_gateway_name_isValid;
}

QString OAIPaysafe::getId() const {
    return m_id;
}
void OAIPaysafe::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIPaysafe::is_id_Set() const{
    return m_id_isSet;
}

bool OAIPaysafe::is_id_Valid() const{
    return m_id_isValid;
}

bool OAIPaysafe::isIsDown() const {
    return m_is_down;
}
void OAIPaysafe::setIsDown(const bool &is_down) {
    m_is_down = is_down;
    m_is_down_isSet = true;
}

bool OAIPaysafe::is_is_down_Set() const{
    return m_is_down_isSet;
}

bool OAIPaysafe::is_is_down_Valid() const{
    return m_is_down_isValid;
}

QString OAIPaysafe::getMerchantCategoryCode() const {
    return m_merchant_category_code;
}
void OAIPaysafe::setMerchantCategoryCode(const QString &merchant_category_code) {
    m_merchant_category_code = merchant_category_code;
    m_merchant_category_code_isSet = true;
}

bool OAIPaysafe::is_merchant_category_code_Set() const{
    return m_merchant_category_code_isSet;
}

bool OAIPaysafe::is_merchant_category_code_Valid() const{
    return m_merchant_category_code_isValid;
}

OAIPaymentMethod OAIPaysafe::getMethod() const {
    return m_method;
}
void OAIPaysafe::setMethod(const OAIPaymentMethod &method) {
    m_method = method;
    m_method_isSet = true;
}

bool OAIPaysafe::is_method_Set() const{
    return m_method_isSet;
}

bool OAIPaysafe::is_method_Valid() const{
    return m_method_isValid;
}

double OAIPaysafe::getMonthlyLimit() const {
    return m_monthly_limit;
}
void OAIPaysafe::setMonthlyLimit(const double &monthly_limit) {
    m_monthly_limit = monthly_limit;
    m_monthly_limit_isSet = true;
}

bool OAIPaysafe::is_monthly_limit_Set() const{
    return m_monthly_limit_isSet;
}

bool OAIPaysafe::is_monthly_limit_Valid() const{
    return m_monthly_limit_isValid;
}

QString OAIPaysafe::getOrganizationId() const {
    return m_organization_id;
}
void OAIPaysafe::setOrganizationId(const QString &organization_id) {
    m_organization_id = organization_id;
    m_organization_id_isSet = true;
}

bool OAIPaysafe::is_organization_id_Set() const{
    return m_organization_id_isSet;
}

bool OAIPaysafe::is_organization_id_Valid() const{
    return m_organization_id_isValid;
}

QList<OAIPaymentCardBrand> OAIPaysafe::getPaymentCardSchemes() const {
    return m_payment_card_schemes;
}
void OAIPaysafe::setPaymentCardSchemes(const QList<OAIPaymentCardBrand> &payment_card_schemes) {
    m_payment_card_schemes = payment_card_schemes;
    m_payment_card_schemes_isSet = true;
}

bool OAIPaysafe::is_payment_card_schemes_Set() const{
    return m_payment_card_schemes_isSet;
}

bool OAIPaysafe::is_payment_card_schemes_Valid() const{
    return m_payment_card_schemes_isValid;
}

bool OAIPaysafe::isReconciliationWindowEnabled() const {
    return m_reconciliation_window_enabled;
}
void OAIPaysafe::setReconciliationWindowEnabled(const bool &reconciliation_window_enabled) {
    m_reconciliation_window_enabled = reconciliation_window_enabled;
    m_reconciliation_window_enabled_isSet = true;
}

bool OAIPaysafe::is_reconciliation_window_enabled_Set() const{
    return m_reconciliation_window_enabled_isSet;
}

bool OAIPaysafe::is_reconciliation_window_enabled_Valid() const{
    return m_reconciliation_window_enabled_isValid;
}

qint32 OAIPaysafe::getReconciliationWindowTtl() const {
    return m_reconciliation_window_ttl;
}
void OAIPaysafe::setReconciliationWindowTtl(const qint32 &reconciliation_window_ttl) {
    m_reconciliation_window_ttl = reconciliation_window_ttl;
    m_reconciliation_window_ttl_isSet = true;
}

bool OAIPaysafe::is_reconciliation_window_ttl_Set() const{
    return m_reconciliation_window_ttl_isSet;
}

bool OAIPaysafe::is_reconciliation_window_ttl_Valid() const{
    return m_reconciliation_window_ttl_isValid;
}

QString OAIPaysafe::getStatus() const {
    return m_status;
}
void OAIPaysafe::setStatus(const QString &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIPaysafe::is_status_Set() const{
    return m_status_isSet;
}

bool OAIPaysafe::is_status_Valid() const{
    return m_status_isValid;
}

bool OAIPaysafe::isSticky() const {
    return m_sticky;
}
void OAIPaysafe::setSticky(const bool &sticky) {
    m_sticky = sticky;
    m_sticky_isSet = true;
}

bool OAIPaysafe::is_sticky_Set() const{
    return m_sticky_isSet;
}

bool OAIPaysafe::is_sticky_Valid() const{
    return m_sticky_isValid;
}

bool OAIPaysafe::isThreeDSecure() const {
    return m_three_d_secure;
}
void OAIPaysafe::setThreeDSecure(const bool &three_d_secure) {
    m_three_d_secure = three_d_secure;
    m_three_d_secure_isSet = true;
}

bool OAIPaysafe::is_three_d_secure_Set() const{
    return m_three_d_secure_isSet;
}

bool OAIPaysafe::is_three_d_secure_Valid() const{
    return m_three_d_secure_isValid;
}

qint32 OAIPaysafe::getTimeout() const {
    return m_timeout;
}
void OAIPaysafe::setTimeout(const qint32 &timeout) {
    m_timeout = timeout;
    m_timeout_isSet = true;
}

bool OAIPaysafe::is_timeout_Set() const{
    return m_timeout_isSet;
}

bool OAIPaysafe::is_timeout_Valid() const{
    return m_timeout_isValid;
}

QString OAIPaysafe::getToken() const {
    return m_token;
}
void OAIPaysafe::setToken(const QString &token) {
    m_token = token;
    m_token_isSet = true;
}

bool OAIPaysafe::is_token_Set() const{
    return m_token_isSet;
}

bool OAIPaysafe::is_token_Valid() const{
    return m_token_isValid;
}

QDateTime OAIPaysafe::getUpdatedTime() const {
    return m_updated_time;
}
void OAIPaysafe::setUpdatedTime(const QDateTime &updated_time) {
    m_updated_time = updated_time;
    m_updated_time_isSet = true;
}

bool OAIPaysafe::is_updated_time_Set() const{
    return m_updated_time_isSet;
}

bool OAIPaysafe::is_updated_time_Valid() const{
    return m_updated_time_isValid;
}

OAIPaysafe_allOf_credentials OAIPaysafe::getCredentials() const {
    return m_credentials;
}
void OAIPaysafe::setCredentials(const OAIPaysafe_allOf_credentials &credentials) {
    m_credentials = credentials;
    m_credentials_isSet = true;
}

bool OAIPaysafe::is_credentials_Set() const{
    return m_credentials_isSet;
}

bool OAIPaysafe::is_credentials_Valid() const{
    return m_credentials_isValid;
}

OAIPaysafe3dsServers OAIPaysafe::getThreeDSecureServer() const {
    return m_three_d_secure_server;
}
void OAIPaysafe::setThreeDSecureServer(const OAIPaysafe3dsServers &three_d_secure_server) {
    m_three_d_secure_server = three_d_secure_server;
    m_three_d_secure_server_isSet = true;
}

bool OAIPaysafe::is_three_d_secure_server_Set() const{
    return m_three_d_secure_server_isSet;
}

bool OAIPaysafe::is_three_d_secure_server_Valid() const{
    return m_three_d_secure_server_isValid;
}

bool OAIPaysafe::isSet() const {
