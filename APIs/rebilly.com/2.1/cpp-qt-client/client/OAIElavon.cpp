...
OAIElavon::OAIElavon(QString json) {
...
void OAIElavon::initializeModel() {
...
void OAIElavon::fromJson(QString jsonString) {
...
void OAIElavon::fromJsonObject(QJsonObject json) {
...
QString OAIElavon::asJson() const {
...
QJsonObject OAIElavon::asJsonObject() const {
    QJsonObject obj;
    if (m__links.size() > 0) {
...
QList<OAIGatewayAccount__links_inner> OAIElavon::getLinks() const {
    return m__links;
}
void OAIElavon::setLinks(const QList<OAIGatewayAccount__links_inner> &_links) {
    m__links = _links;
    m__links_isSet = true;
}

bool OAIElavon::is__links_Set() const{
    return m__links_isSet;
}

bool OAIElavon::is__links_Valid() const{
    return m__links_isValid;
}

QList<QString> OAIElavon::getAcceptedCurrencies() const {
    return m_accepted_currencies;
}
void OAIElavon::setAcceptedCurrencies(const QList<QString> &accepted_currencies) {
    m_accepted_currencies = accepted_currencies;
    m_accepted_currencies_isSet = true;
}

bool OAIElavon::is_accepted_currencies_Set() const{
    return m_accepted_currencies_isSet;
}

bool OAIElavon::is_accepted_currencies_Valid() const{
    return m_accepted_currencies_isValid;
}

OAIAcquirerName OAIElavon::getAcquirerName() const {
    return m_acquirer_name;
}
void OAIElavon::setAcquirerName(const OAIAcquirerName &acquirer_name) {
    m_acquirer_name = acquirer_name;
    m_acquirer_name_isSet = true;
}

bool OAIElavon::is_acquirer_name_Set() const{
    return m_acquirer_name_isSet;
}

bool OAIElavon::is_acquirer_name_Valid() const{
    return m_acquirer_name_isValid;
}

QString OAIElavon::getAdditionalFilters() const {
    return m_additional_filters;
}
void OAIElavon::setAdditionalFilters(const QString &additional_filters) {
    m_additional_filters = additional_filters;
    m_additional_filters_isSet = true;
}

bool OAIElavon::is_additional_filters_Set() const{
    return m_additional_filters_isSet;
}

bool OAIElavon::is_additional_filters_Valid() const{
    return m_additional_filters_isValid;
}

qint32 OAIElavon::getApprovalWindowTtl() const {
    return m_approval_window_ttl;
}
void OAIElavon::setApprovalWindowTtl(const qint32 &approval_window_ttl) {
    m_approval_window_ttl = approval_window_ttl;
    m_approval_window_ttl_isSet = true;
}

bool OAIElavon::is_approval_window_ttl_Set() const{
    return m_approval_window_ttl_isSet;
}

bool OAIElavon::is_approval_window_ttl_Valid() const{
    return m_approval_window_ttl_isValid;
}

QString OAIElavon::getCityField() const {
    return m_city_field;
}
void OAIElavon::setCityField(const QString &city_field) {
    m_city_field = city_field;
    m_city_field_isSet = true;
}

bool OAIElavon::is_city_field_Set() const{
    return m_city_field_isSet;
}

bool OAIElavon::is_city_field_Valid() const{
    return m_city_field_isValid;
}

QDateTime OAIElavon::getCreatedTime() const {
    return m_created_time;
}
void OAIElavon::setCreatedTime(const QDateTime &created_time) {
    m_created_time = created_time;
    m_created_time_isSet = true;
}

bool OAIElavon::is_created_time_Set() const{
    return m_created_time_isSet;
}

bool OAIElavon::is_created_time_Valid() const{
    return m_created_time_isValid;
}

QString OAIElavon::getDccForceCurrency() const {
    return m_dcc_force_currency;
}
void OAIElavon::setDccForceCurrency(const QString &dcc_force_currency) {
    m_dcc_force_currency = dcc_force_currency;
    m_dcc_force_currency_isSet = true;
}

bool OAIElavon::is_dcc_force_currency_Set() const{
    return m_dcc_force_currency_isSet;
}

bool OAIElavon::is_dcc_force_currency_Valid() const{
    return m_dcc_force_currency_isValid;
}

qint32 OAIElavon::getDccMarkup() const {
    return m_dcc_markup;
}
void OAIElavon::setDccMarkup(const qint32 &dcc_markup) {
    m_dcc_markup = dcc_markup;
    m_dcc_markup_isSet = true;
}

bool OAIElavon::is_dcc_markup_Set() const{
    return m_dcc_markup_isSet;
}

bool OAIElavon::is_dcc_markup_Valid() const{
    return m_dcc_markup_isValid;
}

QString OAIElavon::getDescriptor() const {
    return m_descriptor;
}
void OAIElavon::setDescriptor(const QString &descriptor) {
    m_descriptor = descriptor;
    m_descriptor_isSet = true;
}

bool OAIElavon::is_descriptor_Set() const{
    return m_descriptor_isSet;
}

bool OAIElavon::is_descriptor_Valid() const{
    return m_descriptor_isValid;
}

OAIDigitalWallets OAIElavon::getDigitalWallets() const {
    return m_digital_wallets;
}
void OAIElavon::setDigitalWallets(const OAIDigitalWallets &digital_wallets) {
    m_digital_wallets = digital_wallets;
    m_digital_wallets_isSet = true;
}

bool OAIElavon::is_digital_wallets_Set() const{
    return m_digital_wallets_isSet;
}

bool OAIElavon::is_digital_wallets_Valid() const{
    return m_digital_wallets_isValid;
}

bool OAIElavon::isDynamicDescriptor() const {
    return m_dynamic_descriptor;
}
void OAIElavon::setDynamicDescriptor(const bool &dynamic_descriptor) {
    m_dynamic_descriptor = dynamic_descriptor;
    m_dynamic_descriptor_isSet = true;
}

bool OAIElavon::is_dynamic_descriptor_Set() const{
    return m_dynamic_descriptor_isSet;
}

bool OAIElavon::is_dynamic_descriptor_Valid() const{
    return m_dynamic_descriptor_isValid;
}

QList<QString> OAIElavon::getExcludedDccQuoteCurrencies() const {
    return m_excluded_dcc_quote_currencies;
}
void OAIElavon::setExcludedDccQuoteCurrencies(const QList<QString> &excluded_dcc_quote_currencies) {
    m_excluded_dcc_quote_currencies = excluded_dcc_quote_currencies;
    m_excluded_dcc_quote_currencies_isSet = true;
}

bool OAIElavon::is_excluded_dcc_quote_currencies_Set() const{
    return m_excluded_dcc_quote_currencies_isSet;
}

bool OAIElavon::is_excluded_dcc_quote_currencies_Valid() const{
    return m_excluded_dcc_quote_currencies_isValid;
}

OAIGatewayName OAIElavon::getGatewayName() const {
    return m_gateway_name;
}
void OAIElavon::setGatewayName(const OAIGatewayName &gateway_name) {
    m_gateway_name = gateway_name;
    m_gateway_name_isSet = true;
}

bool OAIElavon::is_gateway_name_Set() const{
    return m_gateway_name_isSet;
}

bool OAIElavon::is_gateway_name_Valid() const{
    return m_gateway_name_isValid;
}

QString OAIElavon::getId() const {
    return m_id;
}
void OAIElavon::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIElavon::is_id_Set() const{
    return m_id_isSet;
}

bool OAIElavon::is_id_Valid() const{
    return m_id_isValid;
}

bool OAIElavon::isIsDown() const {
    return m_is_down;
}
void OAIElavon::setIsDown(const bool &is_down) {
    m_is_down = is_down;
    m_is_down_isSet = true;
}

bool OAIElavon::is_is_down_Set() const{
    return m_is_down_isSet;
}

bool OAIElavon::is_is_down_Valid() const{
    return m_is_down_isValid;
}

QString OAIElavon::getMerchantCategoryCode() const {
    return m_merchant_category_code;
}
void OAIElavon::setMerchantCategoryCode(const QString &merchant_category_code) {
    m_merchant_category_code = merchant_category_code;
    m_merchant_category_code_isSet = true;
}

bool OAIElavon::is_merchant_category_code_Set() const{
    return m_merchant_category_code_isSet;
}

bool OAIElavon::is_merchant_category_code_Valid() const{
    return m_merchant_category_code_isValid;
}

OAIPaymentMethod OAIElavon::getMethod() const {
    return m_method;
}
void OAIElavon::setMethod(const OAIPaymentMethod &method) {
    m_method = method;
    m_method_isSet = true;
}

bool OAIElavon::is_method_Set() const{
    return m_method_isSet;
}

bool OAIElavon::is_method_Valid() const{
    return m_method_isValid;
}

double OAIElavon::getMonthlyLimit() const {
    return m_monthly_limit;
}
void OAIElavon::setMonthlyLimit(const double &monthly_limit) {
    m_monthly_limit = monthly_limit;
    m_monthly_limit_isSet = true;
}

bool OAIElavon::is_monthly_limit_Set() const{
    return m_monthly_limit_isSet;
}

bool OAIElavon::is_monthly_limit_Valid() const{
    return m_monthly_limit_isValid;
}

QString OAIElavon::getOrganizationId() const {
    return m_organization_id;
}
void OAIElavon::setOrganizationId(const QString &organization_id) {
    m_organization_id = organization_id;
    m_organization_id_isSet = true;
}

bool OAIElavon::is_organization_id_Set() const{
    return m_organization_id_isSet;
}

bool OAIElavon::is_organization_id_Valid() const{
    return m_organization_id_isValid;
}

QList<OAIPaymentCardBrand> OAIElavon::getPaymentCardSchemes() const {
    return m_payment_card_schemes;
}
void OAIElavon::setPaymentCardSchemes(const QList<OAIPaymentCardBrand> &payment_card_schemes) {
    m_payment_card_schemes = payment_card_schemes;
    m_payment_card_schemes_isSet = true;
}

bool OAIElavon::is_payment_card_schemes_Set() const{
    return m_payment_card_schemes_isSet;
}

bool OAIElavon::is_payment_card_schemes_Valid() const{
    return m_payment_card_schemes_isValid;
}

bool OAIElavon::isReconciliationWindowEnabled() const {
    return m_reconciliation_window_enabled;
}
void OAIElavon::setReconciliationWindowEnabled(const bool &reconciliation_window_enabled) {
    m_reconciliation_window_enabled = reconciliation_window_enabled;
    m_reconciliation_window_enabled_isSet = true;
}

bool OAIElavon::is_reconciliation_window_enabled_Set() const{
    return m_reconciliation_window_enabled_isSet;
}

bool OAIElavon::is_reconciliation_window_enabled_Valid() const{
    return m_reconciliation_window_enabled_isValid;
}

qint32 OAIElavon::getReconciliationWindowTtl() const {
    return m_reconciliation_window_ttl;
}
void OAIElavon::setReconciliationWindowTtl(const qint32 &reconciliation_window_ttl) {
    m_reconciliation_window_ttl = reconciliation_window_ttl;
    m_reconciliation_window_ttl_isSet = true;
}

bool OAIElavon::is_reconciliation_window_ttl_Set() const{
    return m_reconciliation_window_ttl_isSet;
}

bool OAIElavon::is_reconciliation_window_ttl_Valid() const{
    return m_reconciliation_window_ttl_isValid;
}

QString OAIElavon::getStatus() const {
    return m_status;
}
void OAIElavon::setStatus(const QString &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIElavon::is_status_Set() const{
    return m_status_isSet;
}

bool OAIElavon::is_status_Valid() const{
    return m_status_isValid;
}

bool OAIElavon::isSticky() const {
    return m_sticky;
}
void OAIElavon::setSticky(const bool &sticky) {
    m_sticky = sticky;
    m_sticky_isSet = true;
}

bool OAIElavon::is_sticky_Set() const{
    return m_sticky_isSet;
}

bool OAIElavon::is_sticky_Valid() const{
    return m_sticky_isValid;
}

bool OAIElavon::isThreeDSecure() const {
    return m_three_d_secure;
}
void OAIElavon::setThreeDSecure(const bool &three_d_secure) {
    m_three_d_secure = three_d_secure;
    m_three_d_secure_isSet = true;
}

bool OAIElavon::is_three_d_secure_Set() const{
    return m_three_d_secure_isSet;
}

bool OAIElavon::is_three_d_secure_Valid() const{
    return m_three_d_secure_isValid;
}

qint32 OAIElavon::getTimeout() const {
    return m_timeout;
}
void OAIElavon::setTimeout(const qint32 &timeout) {
    m_timeout = timeout;
    m_timeout_isSet = true;
}

bool OAIElavon::is_timeout_Set() const{
    return m_timeout_isSet;
}

bool OAIElavon::is_timeout_Valid() const{
    return m_timeout_isValid;
}

QString OAIElavon::getToken() const {
    return m_token;
}
void OAIElavon::setToken(const QString &token) {
    m_token = token;
    m_token_isSet = true;
}

bool OAIElavon::is_token_Set() const{
    return m_token_isSet;
}

bool OAIElavon::is_token_Valid() const{
    return m_token_isValid;
}

QDateTime OAIElavon::getUpdatedTime() const {
    return m_updated_time;
}
void OAIElavon::setUpdatedTime(const QDateTime &updated_time) {
    m_updated_time = updated_time;
    m_updated_time_isSet = true;
}

bool OAIElavon::is_updated_time_Set() const{
    return m_updated_time_isSet;
}

bool OAIElavon::is_updated_time_Valid() const{
    return m_updated_time_isValid;
}

OAIElavon_allOf_credentials OAIElavon::getCredentials() const {
    return m_credentials;
}
void OAIElavon::setCredentials(const OAIElavon_allOf_credentials &credentials) {
    m_credentials = credentials;
    m_credentials_isSet = true;
}

bool OAIElavon::is_credentials_Set() const{
    return m_credentials_isSet;
}

bool OAIElavon::is_credentials_Valid() const{
    return m_credentials_isValid;
}

bool OAIElavon::isSet() const {
