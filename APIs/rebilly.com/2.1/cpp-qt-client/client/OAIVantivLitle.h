...
#ifndef OAIVantivLitle_H
#define OAIVantivLitle_H
...
#include "OAIVantivLitle3dsServers.h"
...
class OAIVantivLitle_allOf_credentials;
class OAIVantivLitle3dsServers;

class OAIVantivLitle : public OAIObject {
public:
    OAIVantivLitle();
    OAIVantivLitle(QString json);
    ~OAIVantivLitle() override;
    ...
    OAIVantivLitle_allOf_credentials getCredentials() const;
    void setCredentials(const OAIVantivLitle_allOf_credentials &credentials);
    bool is_credentials_Set() const;
    bool is_credentials_Valid() const;

    OAIVantivLitle3dsServers getThreeDSecureServer() const;
    void setThreeDSecureServer(const OAIVantivLitle3dsServers &three_d_secure_server);
...
private:
    ...
    OAIVantivLitle_allOf_credentials m_credentials;
    bool m_credentials_isSet;
    bool m_credentials_isValid;

    OAIVantivLitle3dsServers m_three_d_secure_server;
...
Q_DECLARE_METATYPE(OpenAPI::OAIVantivLitle)

#endif // OAIVantivLitle_H
