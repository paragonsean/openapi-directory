...
OAIPayPal::OAIPayPal(QString json) {
...
void OAIPayPal::initializeModel() {
...
void OAIPayPal::fromJson(QString jsonString) {
...
void OAIPayPal::fromJsonObject(QJsonObject json) {
...
QString OAIPayPal::asJson() const {
...
QJsonObject OAIPayPal::asJsonObject() const {
    QJsonObject obj;
    if (m__links.size() > 0) {
...
QList<OAIGatewayAccount__links_inner> OAIPayPal::getLinks() const {
    return m__links;
}
void OAIPayPal::setLinks(const QList<OAIGatewayAccount__links_inner> &_links) {
    m__links = _links;
    m__links_isSet = true;
}

bool OAIPayPal::is__links_Set() const{
    return m__links_isSet;
}

bool OAIPayPal::is__links_Valid() const{
    return m__links_isValid;
}

QList<QString> OAIPayPal::getAcceptedCurrencies() const {
    return m_accepted_currencies;
}
void OAIPayPal::setAcceptedCurrencies(const QList<QString> &accepted_currencies) {
    m_accepted_currencies = accepted_currencies;
    m_accepted_currencies_isSet = true;
}

bool OAIPayPal::is_accepted_currencies_Set() const{
    return m_accepted_currencies_isSet;
}

bool OAIPayPal::is_accepted_currencies_Valid() const{
    return m_accepted_currencies_isValid;
}

OAIAcquirerName OAIPayPal::getAcquirerName() const {
    return m_acquirer_name;
}
void OAIPayPal::setAcquirerName(const OAIAcquirerName &acquirer_name) {
    m_acquirer_name = acquirer_name;
    m_acquirer_name_isSet = true;
}

bool OAIPayPal::is_acquirer_name_Set() const{
    return m_acquirer_name_isSet;
}

bool OAIPayPal::is_acquirer_name_Valid() const{
    return m_acquirer_name_isValid;
}

QString OAIPayPal::getAdditionalFilters() const {
    return m_additional_filters;
}
void OAIPayPal::setAdditionalFilters(const QString &additional_filters) {
    m_additional_filters = additional_filters;
    m_additional_filters_isSet = true;
}

bool OAIPayPal::is_additional_filters_Set() const{
    return m_additional_filters_isSet;
}

bool OAIPayPal::is_additional_filters_Valid() const{
    return m_additional_filters_isValid;
}

qint32 OAIPayPal::getApprovalWindowTtl() const {
    return m_approval_window_ttl;
}
void OAIPayPal::setApprovalWindowTtl(const qint32 &approval_window_ttl) {
    m_approval_window_ttl = approval_window_ttl;
    m_approval_window_ttl_isSet = true;
}

bool OAIPayPal::is_approval_window_ttl_Set() const{
    return m_approval_window_ttl_isSet;
}

bool OAIPayPal::is_approval_window_ttl_Valid() const{
    return m_approval_window_ttl_isValid;
}

QString OAIPayPal::getCityField() const {
    return m_city_field;
}
void OAIPayPal::setCityField(const QString &city_field) {
    m_city_field = city_field;
    m_city_field_isSet = true;
}

bool OAIPayPal::is_city_field_Set() const{
    return m_city_field_isSet;
}

bool OAIPayPal::is_city_field_Valid() const{
    return m_city_field_isValid;
}

QDateTime OAIPayPal::getCreatedTime() const {
    return m_created_time;
}
void OAIPayPal::setCreatedTime(const QDateTime &created_time) {
    m_created_time = created_time;
    m_created_time_isSet = true;
}

bool OAIPayPal::is_created_time_Set() const{
    return m_created_time_isSet;
}

bool OAIPayPal::is_created_time_Valid() const{
    return m_created_time_isValid;
}

QString OAIPayPal::getDccForceCurrency() const {
    return m_dcc_force_currency;
}
void OAIPayPal::setDccForceCurrency(const QString &dcc_force_currency) {
    m_dcc_force_currency = dcc_force_currency;
    m_dcc_force_currency_isSet = true;
}

bool OAIPayPal::is_dcc_force_currency_Set() const{
    return m_dcc_force_currency_isSet;
}

bool OAIPayPal::is_dcc_force_currency_Valid() const{
    return m_dcc_force_currency_isValid;
}

qint32 OAIPayPal::getDccMarkup() const {
    return m_dcc_markup;
}
void OAIPayPal::setDccMarkup(const qint32 &dcc_markup) {
    m_dcc_markup = dcc_markup;
    m_dcc_markup_isSet = true;
}

bool OAIPayPal::is_dcc_markup_Set() const{
    return m_dcc_markup_isSet;
}

bool OAIPayPal::is_dcc_markup_Valid() const{
    return m_dcc_markup_isValid;
}

QString OAIPayPal::getDescriptor() const {
    return m_descriptor;
}
void OAIPayPal::setDescriptor(const QString &descriptor) {
    m_descriptor = descriptor;
    m_descriptor_isSet = true;
}

bool OAIPayPal::is_descriptor_Set() const{
    return m_descriptor_isSet;
}

bool OAIPayPal::is_descriptor_Valid() const{
    return m_descriptor_isValid;
}

OAIDigitalWallets OAIPayPal::getDigitalWallets() const {
    return m_digital_wallets;
}
void OAIPayPal::setDigitalWallets(const OAIDigitalWallets &digital_wallets) {
    m_digital_wallets = digital_wallets;
    m_digital_wallets_isSet = true;
}

bool OAIPayPal::is_digital_wallets_Set() const{
    return m_digital_wallets_isSet;
}

bool OAIPayPal::is_digital_wallets_Valid() const{
    return m_digital_wallets_isValid;
}

bool OAIPayPal::isDynamicDescriptor() const {
    return m_dynamic_descriptor;
}
void OAIPayPal::setDynamicDescriptor(const bool &dynamic_descriptor) {
    m_dynamic_descriptor = dynamic_descriptor;
    m_dynamic_descriptor_isSet = true;
}

bool OAIPayPal::is_dynamic_descriptor_Set() const{
    return m_dynamic_descriptor_isSet;
}

bool OAIPayPal::is_dynamic_descriptor_Valid() const{
    return m_dynamic_descriptor_isValid;
}

QList<QString> OAIPayPal::getExcludedDccQuoteCurrencies() const {
    return m_excluded_dcc_quote_currencies;
}
void OAIPayPal::setExcludedDccQuoteCurrencies(const QList<QString> &excluded_dcc_quote_currencies) {
    m_excluded_dcc_quote_currencies = excluded_dcc_quote_currencies;
    m_excluded_dcc_quote_currencies_isSet = true;
}

bool OAIPayPal::is_excluded_dcc_quote_currencies_Set() const{
    return m_excluded_dcc_quote_currencies_isSet;
}

bool OAIPayPal::is_excluded_dcc_quote_currencies_Valid() const{
    return m_excluded_dcc_quote_currencies_isValid;
}

OAIGatewayName OAIPayPal::getGatewayName() const {
    return m_gateway_name;
}
void OAIPayPal::setGatewayName(const OAIGatewayName &gateway_name) {
    m_gateway_name = gateway_name;
    m_gateway_name_isSet = true;
}

bool OAIPayPal::is_gateway_name_Set() const{
    return m_gateway_name_isSet;
}

bool OAIPayPal::is_gateway_name_Valid() const{
    return m_gateway_name_isValid;
}

QString OAIPayPal::getId() const {
    return m_id;
}
void OAIPayPal::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIPayPal::is_id_Set() const{
    return m_id_isSet;
}

bool OAIPayPal::is_id_Valid() const{
    return m_id_isValid;
}

bool OAIPayPal::isIsDown() const {
    return m_is_down;
}
void OAIPayPal::setIsDown(const bool &is_down) {
    m_is_down = is_down;
    m_is_down_isSet = true;
}

bool OAIPayPal::is_is_down_Set() const{
    return m_is_down_isSet;
}

bool OAIPayPal::is_is_down_Valid() const{
    return m_is_down_isValid;
}

QString OAIPayPal::getMerchantCategoryCode() const {
    return m_merchant_category_code;
}
void OAIPayPal::setMerchantCategoryCode(const QString &merchant_category_code) {
    m_merchant_category_code = merchant_category_code;
    m_merchant_category_code_isSet = true;
}

bool OAIPayPal::is_merchant_category_code_Set() const{
    return m_merchant_category_code_isSet;
}

bool OAIPayPal::is_merchant_category_code_Valid() const{
    return m_merchant_category_code_isValid;
}

OAIPaymentMethod OAIPayPal::getMethod() const {
    return m_method;
}
void OAIPayPal::setMethod(const OAIPaymentMethod &method) {
    m_method = method;
    m_method_isSet = true;
}

bool OAIPayPal::is_method_Set() const{
    return m_method_isSet;
}

bool OAIPayPal::is_method_Valid() const{
    return m_method_isValid;
}

double OAIPayPal::getMonthlyLimit() const {
    return m_monthly_limit;
}
void OAIPayPal::setMonthlyLimit(const double &monthly_limit) {
    m_monthly_limit = monthly_limit;
    m_monthly_limit_isSet = true;
}

bool OAIPayPal::is_monthly_limit_Set() const{
    return m_monthly_limit_isSet;
}

bool OAIPayPal::is_monthly_limit_Valid() const{
    return m_monthly_limit_isValid;
}

QString OAIPayPal::getOrganizationId() const {
    return m_organization_id;
}
void OAIPayPal::setOrganizationId(const QString &organization_id) {
    m_organization_id = organization_id;
    m_organization_id_isSet = true;
}

bool OAIPayPal::is_organization_id_Set() const{
    return m_organization_id_isSet;
}

bool OAIPayPal::is_organization_id_Valid() const{
    return m_organization_id_isValid;
}

QList<OAIPaymentCardBrand> OAIPayPal::getPaymentCardSchemes() const {
    return m_payment_card_schemes;
}
void OAIPayPal::setPaymentCardSchemes(const QList<OAIPaymentCardBrand> &payment_card_schemes) {
    m_payment_card_schemes = payment_card_schemes;
    m_payment_card_schemes_isSet = true;
}

bool OAIPayPal::is_payment_card_schemes_Set() const{
    return m_payment_card_schemes_isSet;
}

bool OAIPayPal::is_payment_card_schemes_Valid() const{
    return m_payment_card_schemes_isValid;
}

bool OAIPayPal::isReconciliationWindowEnabled() const {
    return m_reconciliation_window_enabled;
}
void OAIPayPal::setReconciliationWindowEnabled(const bool &reconciliation_window_enabled) {
    m_reconciliation_window_enabled = reconciliation_window_enabled;
    m_reconciliation_window_enabled_isSet = true;
}

bool OAIPayPal::is_reconciliation_window_enabled_Set() const{
    return m_reconciliation_window_enabled_isSet;
}

bool OAIPayPal::is_reconciliation_window_enabled_Valid() const{
    return m_reconciliation_window_enabled_isValid;
}

qint32 OAIPayPal::getReconciliationWindowTtl() const {
    return m_reconciliation_window_ttl;
}
void OAIPayPal::setReconciliationWindowTtl(const qint32 &reconciliation_window_ttl) {
    m_reconciliation_window_ttl = reconciliation_window_ttl;
    m_reconciliation_window_ttl_isSet = true;
}

bool OAIPayPal::is_reconciliation_window_ttl_Set() const{
    return m_reconciliation_window_ttl_isSet;
}

bool OAIPayPal::is_reconciliation_window_ttl_Valid() const{
    return m_reconciliation_window_ttl_isValid;
}

QString OAIPayPal::getStatus() const {
    return m_status;
}
void OAIPayPal::setStatus(const QString &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIPayPal::is_status_Set() const{
    return m_status_isSet;
}

bool OAIPayPal::is_status_Valid() const{
    return m_status_isValid;
}

bool OAIPayPal::isSticky() const {
    return m_sticky;
}
void OAIPayPal::setSticky(const bool &sticky) {
    m_sticky = sticky;
    m_sticky_isSet = true;
}

bool OAIPayPal::is_sticky_Set() const{
    return m_sticky_isSet;
}

bool OAIPayPal::is_sticky_Valid() const{
    return m_sticky_isValid;
}

bool OAIPayPal::isThreeDSecure() const {
    return m_three_d_secure;
}
void OAIPayPal::setThreeDSecure(const bool &three_d_secure) {
    m_three_d_secure = three_d_secure;
    m_three_d_secure_isSet = true;
}

bool OAIPayPal::is_three_d_secure_Set() const{
    return m_three_d_secure_isSet;
}

bool OAIPayPal::is_three_d_secure_Valid() const{
    return m_three_d_secure_isValid;
}

qint32 OAIPayPal::getTimeout() const {
    return m_timeout;
}
void OAIPayPal::setTimeout(const qint32 &timeout) {
    m_timeout = timeout;
    m_timeout_isSet = true;
}

bool OAIPayPal::is_timeout_Set() const{
    return m_timeout_isSet;
}

bool OAIPayPal::is_timeout_Valid() const{
    return m_timeout_isValid;
}

QString OAIPayPal::getToken() const {
    return m_token;
}
void OAIPayPal::setToken(const QString &token) {
    m_token = token;
    m_token_isSet = true;
}

bool OAIPayPal::is_token_Set() const{
    return m_token_isSet;
}

bool OAIPayPal::is_token_Valid() const{
    return m_token_isValid;
}

QDateTime OAIPayPal::getUpdatedTime() const {
    return m_updated_time;
}
void OAIPayPal::setUpdatedTime(const QDateTime &updated_time) {
    m_updated_time = updated_time;
    m_updated_time_isSet = true;
}

bool OAIPayPal::is_updated_time_Set() const{
    return m_updated_time_isSet;
}

bool OAIPayPal::is_updated_time_Valid() const{
    return m_updated_time_isValid;
}

OAIPayPal_allOf_settings OAIPayPal::getSettings() const {
    return m_settings;
}
void OAIPayPal::setSettings(const OAIPayPal_allOf_settings &settings) {
    m_settings = settings;
    m_settings_isSet = true;
}

bool OAIPayPal::is_settings_Set() const{
    return m_settings_isSet;
}

bool OAIPayPal::is_settings_Valid() const{
    return m_settings_isValid;
}

bool OAIPayPal::isSet() const {
...
bool OAIPayPal::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_accepted_currencies_isValid && m_gateway_name_isValid && m_method_isValid && m_settings_isValid && true;
}
