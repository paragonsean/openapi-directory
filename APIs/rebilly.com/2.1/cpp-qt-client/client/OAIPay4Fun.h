...
#include "OAIPay4Fun_allOf_credentials.h"
...
class OAIPay4Fun_allOf_credentials;

class OAIPay4Fun : public OAIObject {
public:
    OAIPay4Fun();
    OAIPay4Fun(QString json);
    ~OAIPay4Fun() override;
    ...
    OAIPay4Fun_allOf_credentials getCredentials() const;
    void setCredentials(const OAIPay4Fun_allOf_credentials &credentials);
...
private:
    ...
    OAIPay4Fun_allOf_credentials m_credentials;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPay4Fun)
