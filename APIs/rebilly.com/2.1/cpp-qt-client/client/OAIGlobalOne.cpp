...
OAIGlobalOne::OAIGlobalOne(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGlobalOne::OAIGlobalOne() {
    this->initializeModel();
}

OAIGlobalOne::~OAIGlobalOne() {}

void OAIGlobalOne::initializeModel() {
...
void OAIGlobalOne::fromJson(QString jsonString) {
...
void OAIGlobalOne::fromJsonObject(QJsonObject json) {
...
QString OAIGlobalOne::asJson() const {
...
QJsonObject OAIGlobalOne::asJsonObject() const {
    QJsonObject obj;
    if (m__links.size() > 0) {
...
QList<OAIGatewayAccount__links_inner> OAIGlobalOne::getLinks() const {
    return m__links;
}
void OAIGlobalOne::setLinks(const QList<OAIGatewayAccount__links_inner> &_links) {
    m__links = _links;
    m__links_isSet = true;
}

bool OAIGlobalOne::is__links_Set() const{
    return m__links_isSet;
}

bool OAIGlobalOne::is__links_Valid() const{
    return m__links_isValid;
}

QList<QString> OAIGlobalOne::getAcceptedCurrencies() const {
    return m_accepted_currencies;
}
void OAIGlobalOne::setAcceptedCurrencies(const QList<QString> &accepted_currencies) {
    m_accepted_currencies = accepted_currencies;
    m_accepted_currencies_isSet = true;
}

bool OAIGlobalOne::is_accepted_currencies_Set() const{
    return m_accepted_currencies_isSet;
}

bool OAIGlobalOne::is_accepted_currencies_Valid() const{
    return m_accepted_currencies_isValid;
}

OAIAcquirerName OAIGlobalOne::getAcquirerName() const {
    return m_acquirer_name;
}
void OAIGlobalOne::setAcquirerName(const OAIAcquirerName &acquirer_name) {
    m_acquirer_name = acquirer_name;
    m_acquirer_name_isSet = true;
}

bool OAIGlobalOne::is_acquirer_name_Set() const{
    return m_acquirer_name_isSet;
}

bool OAIGlobalOne::is_acquirer_name_Valid() const{
    return m_acquirer_name_isValid;
}

QString OAIGlobalOne::getAdditionalFilters() const {
    return m_additional_filters;
}
void OAIGlobalOne::setAdditionalFilters(const QString &additional_filters) {
    m_additional_filters = additional_filters;
    m_additional_filters_isSet = true;
}

bool OAIGlobalOne::is_additional_filters_Set() const{
    return m_additional_filters_isSet;
}

bool OAIGlobalOne::is_additional_filters_Valid() const{
    return m_additional_filters_isValid;
}

qint32 OAIGlobalOne::getApprovalWindowTtl() const {
    return m_approval_window_ttl;
}
void OAIGlobalOne::setApprovalWindowTtl(const qint32 &approval_window_ttl) {
    m_approval_window_ttl = approval_window_ttl;
    m_approval_window_ttl_isSet = true;
}

bool OAIGlobalOne::is_approval_window_ttl_Set() const{
    return m_approval_window_ttl_isSet;
}

bool OAIGlobalOne::is_approval_window_ttl_Valid() const{
    return m_approval_window_ttl_isValid;
}

QString OAIGlobalOne::getCityField() const {
    return m_city_field;
}
void OAIGlobalOne::setCityField(const QString &city_field) {
    m_city_field = city_field;
    m_city_field_isSet = true;
}

bool OAIGlobalOne::is_city_field_Set() const{
    return m_city_field_isSet;
}

bool OAIGlobalOne::is_city_field_Valid() const{
    return m_city_field_isValid;
}

QDateTime OAIGlobalOne::getCreatedTime() const {
    return m_created_time;
}
void OAIGlobalOne::setCreatedTime(const QDateTime &created_time) {
    m_created_time = created_time;
    m_created_time_isSet = true;
}

bool OAIGlobalOne::is_created_time_Set() const{
    return m_created_time_isSet;
}

bool OAIGlobalOne::is_created_time_Valid() const{
    return m_created_time_isValid;
}

QString OAIGlobalOne::getDccForceCurrency() const {
    return m_dcc_force_currency;
}
void OAIGlobalOne::setDccForceCurrency(const QString &dcc_force_currency) {
    m_dcc_force_currency = dcc_force_currency;
    m_dcc_force_currency_isSet = true;
}

bool OAIGlobalOne::is_dcc_force_currency_Set() const{
    return m_dcc_force_currency_isSet;
}

bool OAIGlobalOne::is_dcc_force_currency_Valid() const{
    return m_dcc_force_currency_isValid;
}

qint32 OAIGlobalOne::getDccMarkup() const {
    return m_dcc_markup;
}
void OAIGlobalOne::setDccMarkup(const qint32 &dcc_markup) {
    m_dcc_markup = dcc_markup;
    m_dcc_markup_isSet = true;
}

bool OAIGlobalOne::is_dcc_markup_Set() const{
    return m_dcc_markup_isSet;
}

bool OAIGlobalOne::is_dcc_markup_Valid() const{
    return m_dcc_markup_isValid;
}

QString OAIGlobalOne::getDescriptor() const {
    return m_descriptor;
}
void OAIGlobalOne::setDescriptor(const QString &descriptor) {
    m_descriptor = descriptor;
    m_descriptor_isSet = true;
}

bool OAIGlobalOne::is_descriptor_Set() const{
    return m_descriptor_isSet;
}

bool OAIGlobalOne::is_descriptor_Valid() const{
    return m_descriptor_isValid;
}

OAIDigitalWallets OAIGlobalOne::getDigitalWallets() const {
    return m_digital_wallets;
}
void OAIGlobalOne::setDigitalWallets(const OAIDigitalWallets &digital_wallets) {
    m_digital_wallets = digital_wallets;
    m_digital_wallets_isSet = true;
}

bool OAIGlobalOne::is_digital_wallets_Set() const{
    return m_digital_wallets_isSet;
}

bool OAIGlobalOne::is_digital_wallets_Valid() const{
    return m_digital_wallets_isValid;
}

bool OAIGlobalOne::isDynamicDescriptor() const {
    return m_dynamic_descriptor;
}
void OAIGlobalOne::setDynamicDescriptor(const bool &dynamic_descriptor) {
    m_dynamic_descriptor = dynamic_descriptor;
    m_dynamic_descriptor_isSet = true;
}

bool OAIGlobalOne::is_dynamic_descriptor_Set() const{
    return m_dynamic_descriptor_isSet;
}

bool OAIGlobalOne::is_dynamic_descriptor_Valid() const{
    return m_dynamic_descriptor_isValid;
}

QList<QString> OAIGlobalOne::getExcludedDccQuoteCurrencies() const {
    return m_excluded_dcc_quote_currencies;
}
void OAIGlobalOne::setExcludedDccQuoteCurrencies(const QList<QString> &excluded_dcc_quote_currencies) {
    m_excluded_dcc_quote_currencies = excluded_dcc_quote_currencies;
    m_excluded_dcc_quote_currencies_isSet = true;
}

bool OAIGlobalOne::is_excluded_dcc_quote_currencies_Set() const{
    return m_excluded_dcc_quote_currencies_isSet;
}

bool OAIGlobalOne::is_excluded_dcc_quote_currencies_Valid() const{
    return m_excluded_dcc_quote_currencies_isValid;
}

OAIGatewayName OAIGlobalOne::getGatewayName() const {
    return m_gateway_name;
}
void OAIGlobalOne::setGatewayName(const OAIGatewayName &gateway_name) {
    m_gateway_name = gateway_name;
    m_gateway_name_isSet = true;
}

bool OAIGlobalOne::is_gateway_name_Set() const{
    return m_gateway_name_isSet;
}

bool OAIGlobalOne::is_gateway_name_Valid() const{
    return m_gateway_name_isValid;
}

QString OAIGlobalOne::getId() const {
    return m_id;
}
void OAIGlobalOne::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIGlobalOne::is_id_Set() const{
    return m_id_isSet;
}

bool OAIGlobalOne::is_id_Valid() const{
    return m_id_isValid;
}

bool OAIGlobalOne::isIsDown() const {
    return m_is_down;
}
void OAIGlobalOne::setIsDown(const bool &is_down) {
    m_is_down = is_down;
    m_is_down_isSet = true;
}

bool OAIGlobalOne::is_is_down_Set() const{
    return m_is_down_isSet;
}

bool OAIGlobalOne::is_is_down_Valid() const{
    return m_is_down_isValid;
}

QString OAIGlobalOne::getMerchantCategoryCode() const {
    return m_merchant_category_code;
}
void OAIGlobalOne::setMerchantCategoryCode(const QString &merchant_category_code) {
    m_merchant_category_code = merchant_category_code;
    m_merchant_category_code_isSet = true;
}

bool OAIGlobalOne::is_merchant_category_code_Set() const{
    return m_merchant_category_code_isSet;
}

bool OAIGlobalOne::is_merchant_category_code_Valid() const{
    return m_merchant_category_code_isValid;
}

OAIPaymentMethod OAIGlobalOne::getMethod() const {
    return m_method;
}
void OAIGlobalOne::setMethod(const OAIPaymentMethod &method) {
    m_method = method;
    m_method_isSet = true;
}

bool OAIGlobalOne::is_method_Set() const{
    return m_method_isSet;
}

bool OAIGlobalOne::is_method_Valid() const{
    return m_method_isValid;
}

double OAIGlobalOne::getMonthlyLimit() const {
    return m_monthly_limit;
}
void OAIGlobalOne::setMonthlyLimit(const double &monthly_limit) {
    m_monthly_limit = monthly_limit;
    m_monthly_limit_isSet = true;
}

bool OAIGlobalOne::is_monthly_limit_Set() const{
    return m_monthly_limit_isSet;
}

bool OAIGlobalOne::is_monthly_limit_Valid() const{
    return m_monthly_limit_isValid;
}

QString OAIGlobalOne::getOrganizationId() const {
    return m_organization_id;
}
void OAIGlobalOne::setOrganizationId(const QString &organization_id) {
    m_organization_id = organization_id;
    m_organization_id_isSet = true;
}

bool OAIGlobalOne::is_organization_id_Set() const{
    return m_organization_id_isSet;
}

bool OAIGlobalOne::is_organization_id_Valid() const{
    return m_organization_id_isValid;
}

QList<OAIPaymentCardBrand> OAIGlobalOne::getPaymentCardSchemes() const {
    return m_payment_card_schemes;
}
void OAIGlobalOne::setPaymentCardSchemes(const QList<OAIPaymentCardBrand> &payment_card_schemes) {
    m_payment_card_schemes = payment_card_schemes;
    m_payment_card_schemes_isSet = true;
}

bool OAIGlobalOne::is_payment_card_schemes_Set() const{
    return m_payment_card_schemes_isSet;
}

bool OAIGlobalOne::is_payment_card_schemes_Valid() const{
    return m_payment_card_schemes_isValid;
}

bool OAIGlobalOne::isReconciliationWindowEnabled() const {
    return m_reconciliation_window_enabled;
}
void OAIGlobalOne::setReconciliationWindowEnabled(const bool &reconciliation_window_enabled) {
    m_reconciliation_window_enabled = reconciliation_window_enabled;
    m_reconciliation_window_enabled_isSet = true;
}

bool OAIGlobalOne::is_reconciliation_window_enabled_Set() const{
    return m_reconciliation_window_enabled_isSet;
}

bool OAIGlobalOne::is_reconciliation_window_enabled_Valid() const{
    return m_reconciliation_window_enabled_isValid;
}

qint32 OAIGlobalOne::getReconciliationWindowTtl() const {
    return m_reconciliation_window_ttl;
}
void OAIGlobalOne::setReconciliationWindowTtl(const qint32 &reconciliation_window_ttl) {
    m_reconciliation_window_ttl = reconciliation_window_ttl;
    m_reconciliation_window_ttl_isSet = true;
}

bool OAIGlobalOne::is_reconciliation_window_ttl_Set() const{
    return m_reconciliation_window_ttl_isSet;
}

bool OAIGlobalOne::is_reconciliation_window_ttl_Valid() const{
    return m_reconciliation_window_ttl_isValid;
}

QString OAIGlobalOne::getStatus() const {
    return m_status;
}
void OAIGlobalOne::setStatus(const QString &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIGlobalOne::is_status_Set() const{
    return m_status_isSet;
}

bool OAIGlobalOne::is_status_Valid() const{
    return m_status_isValid;
}

bool OAIGlobalOne::isSticky() const {
    return m_sticky;
}
void OAIGlobalOne::setSticky(const bool &sticky) {
    m_sticky = sticky;
    m_sticky_isSet = true;
}

bool OAIGlobalOne::is_sticky_Set() const{
    return m_sticky_isSet;
}

bool OAIGlobalOne::is_sticky_Valid() const{
    return m_sticky_isValid;
}

bool OAIGlobalOne::isThreeDSecure() const {
    return m_three_d_secure;
}
void OAIGlobalOne::setThreeDSecure(const bool &three_d_secure) {
    m_three_d_secure = three_d_secure;
    m_three_d_secure_isSet = true;
}

bool OAIGlobalOne::is_three_d_secure_Set() const{
    return m_three_d_secure_isSet;
}

bool OAIGlobalOne::is_three_d_secure_Valid() const{
    return m_three_d_secure_isValid;
}

qint32 OAIGlobalOne::getTimeout() const {
    return m_timeout;
}
void OAIGlobalOne::setTimeout(const qint32 &timeout) {
    m_timeout = timeout;
    m_timeout_isSet = true;
}

bool OAIGlobalOne::is_timeout_Set() const{
    return m_timeout_isSet;
}

bool OAIGlobalOne::is_timeout_Valid() const{
    return m_timeout_isValid;
}

QString OAIGlobalOne::getToken() const {
    return m_token;
}
void OAIGlobalOne::setToken(const QString &token) {
    m_token = token;
    m_token_isSet = true;
}

bool OAIGlobalOne::is_token_Set() const{
    return m_token_isSet;
}

bool OAIGlobalOne::is_token_Valid() const{
    return m_token_isValid;
}

QDateTime OAIGlobalOne::getUpdatedTime() const {
    return m_updated_time;
}
void OAIGlobalOne::setUpdatedTime(const QDateTime &updated_time) {
    m_updated_time = updated_time;
    m_updated_time_isSet = true;
}

bool OAIGlobalOne::is_updated_time_Set() const{
    return m_updated_time_isSet;
}

bool OAIGlobalOne::is_updated_time_Valid() const{
    return m_updated_time_isValid;
}

OAIGlobalOne_allOf_credentials OAIGlobalOne::getCredentials() const {
    return m_credentials;
}
void OAIGlobalOne::setCredentials(const OAIGlobalOne_allOf_credentials &credentials) {
    m_credentials = credentials;
    m_credentials_isSet = true;
}

bool OAIGlobalOne::is_credentials_Set() const{
    return m_credentials_isSet;
}

bool OAIGlobalOne::is_credentials_Valid() const{
    return m_credentials_isValid;
}

bool OAIGlobalOne::isSet() const {
...
bool OAIGlobalOne::isValid() const {
