...
OAIAdyen::OAIAdyen(QString json) {
...
void OAIAdyen::fromJson(QString jsonString) {
...
void OAIAdyen::fromJsonObject(QJsonObject json) {
...
QJsonObject OAIAdyen::asJsonObject() const {
    QJsonObject obj;
    if (m__links.size() > 0) {
...
QList<OAIGatewayAccount__links_inner> OAIAdyen::getLinks() const {
    return m__links;
}
void OAIAdyen::setLinks(const QList<OAIGatewayAccount__links_inner> &_links) {
    m__links = _links;
    m__links_isSet = true;
}

bool OAIAdyen::is__links_Set() const{
    return m__links_isSet;
}

bool OAIAdyen::is__links_Valid() const{
    return m__links_isValid;
}

QList<QString> OAIAdyen::getAcceptedCurrencies() const {
    return m_accepted_currencies;
}
void OAIAdyen::setAcceptedCurrencies(const QList<QString> &accepted_currencies) {
    m_accepted_currencies = accepted_currencies;
    m_accepted_currencies_isSet = true;
}

bool OAIAdyen::is_accepted_currencies_Set() const{
    return m_accepted_currencies_isSet;
}

bool OAIAdyen::is_accepted_currencies_Valid() const{
    return m_accepted_currencies_isValid;
}

OAIAcquirerName OAIAdyen::getAcquirerName() const {
    return m_acquirer_name;
}
void OAIAdyen::setAcquirerName(const OAIAcquirerName &acquirer_name) {
    m_acquirer_name = acquirer_name;
    m_acquirer_name_isSet = true;
}

bool OAIAdyen::is_acquirer_name_Set() const{
    return m_acquirer_name_isSet;
}

bool OAIAdyen::is_acquirer_name_Valid() const{
    return m_acquirer_name_isValid;
}

QString OAIAdyen::getAdditionalFilters() const {
    return m_additional_filters;
}
void OAIAdyen::setAdditionalFilters(const QString &additional_filters) {
    m_additional_filters = additional_filters;
    m_additional_filters_isSet = true;
}

bool OAIAdyen::is_additional_filters_Set() const{
    return m_additional_filters_isSet;
}

bool OAIAdyen::is_additional_filters_Valid() const{
    return m_additional_filters_isValid;
}

qint32 OAIAdyen::getApprovalWindowTtl() const {
    return m_approval_window_ttl;
}
void OAIAdyen::setApprovalWindowTtl(const qint32 &approval_window_ttl) {
    m_approval_window_ttl = approval_window_ttl;
    m_approval_window_ttl_isSet = true;
}

bool OAIAdyen::is_approval_window_ttl_Set() const{
    return m_approval_window_ttl_isSet;
}

bool OAIAdyen::is_approval_window_ttl_Valid() const{
    return m_approval_window_ttl_isValid;
}

QString OAIAdyen::getCityField() const {
    return m_city_field;
}
void OAIAdyen::setCityField(const QString &city_field) {
    m_city_field = city_field;
    m_city_field_isSet = true;
}

bool OAIAdyen::is_city_field_Set() const{
    return m_city_field_isSet;
}

bool OAIAdyen::is_city_field_Valid() const{
    return m_city_field_isValid;
}

QDateTime OAIAdyen::getCreatedTime() const {
    return m_created_time;
}
void OAIAdyen::setCreatedTime(const QDateTime &created_time) {
    m_created_time = created_time;
    m_created_time_isSet = true;
}

bool OAIAdyen::is_created_time_Set() const{
    return m_created_time_isSet;
}

bool OAIAdyen::is_created_time_Valid() const{
    return m_created_time_isValid;
}

QString OAIAdyen::getDccForceCurrency() const {
    return m_dcc_force_currency;
}
void OAIAdyen::setDccForceCurrency(const QString &dcc_force_currency) {
    m_dcc_force_currency = dcc_force_currency;
    m_dcc_force_currency_isSet = true;
}

bool OAIAdyen::is_dcc_force_currency_Set() const{
    return m_dcc_force_currency_isSet;
}

bool OAIAdyen::is_dcc_force_currency_Valid() const{
    return m_dcc_force_currency_isValid;
}

qint32 OAIAdyen::getDccMarkup() const {
    return m_dcc_markup;
}
void OAIAdyen::setDccMarkup(const qint32 &dcc_markup) {
    m_dcc_markup = dcc_markup;
    m_dcc_markup_isSet = true;
}

bool OAIAdyen::is_dcc_markup_Set() const{
    return m_dcc_markup_isSet;
}

bool OAIAdyen::is_dcc_markup_Valid() const{
    return m_dcc_markup_isValid;
}

QString OAIAdyen::getDescriptor() const {
    return m_descriptor;
}
void OAIAdyen::setDescriptor(const QString &descriptor) {
    m_descriptor = descriptor;
    m_descriptor_isSet = true;
}

bool OAIAdyen::is_descriptor_Set() const{
    return m_descriptor_isSet;
}

bool OAIAdyen::is_descriptor_Valid() const{
    return m_descriptor_isValid;
}

OAIDigitalWallets OAIAdyen::getDigitalWallets() const {
    return m_digital_wallets;
}
void OAIAdyen::setDigitalWallets(const OAIDigitalWallets &digital_wallets) {
    m_digital_wallets = digital_wallets;
    m_digital_wallets_isSet = true;
}

bool OAIAdyen::is_digital_wallets_Set() const{
    return m_digital_wallets_isSet;
}

bool OAIAdyen::is_digital_wallets_Valid() const{
    return m_digital_wallets_isValid;
}

bool OAIAdyen::isDynamicDescriptor() const {
    return m_dynamic_descriptor;
}
void OAIAdyen::setDynamicDescriptor(const bool &dynamic_descriptor) {
    m_dynamic_descriptor = dynamic_descriptor;
    m_dynamic_descriptor_isSet = true;
}

bool OAIAdyen::is_dynamic_descriptor_Set() const{
    return m_dynamic_descriptor_isSet;
}

bool OAIAdyen::is_dynamic_descriptor_Valid() const{
    return m_dynamic_descriptor_isValid;
}

QList<QString> OAIAdyen::getExcludedDccQuoteCurrencies() const {
    return m_excluded_dcc_quote_currencies;
}
void OAIAdyen::setExcludedDccQuoteCurrencies(const QList<QString> &excluded_dcc_quote_currencies) {
    m_excluded_dcc_quote_currencies = excluded_dcc_quote_currencies;
    m_excluded_dcc_quote_currencies_isSet = true;
}

bool OAIAdyen::is_excluded_dcc_quote_currencies_Set() const{
    return m_excluded_dcc_quote_currencies_isSet;
}

bool OAIAdyen::is_excluded_dcc_quote_currencies_Valid() const{
    return m_excluded_dcc_quote_currencies_isValid;
}

OAIGatewayName OAIAdyen::getGatewayName() const {
    return m_gateway_name;
}
void OAIAdyen::setGatewayName(const OAIGatewayName &gateway_name) {
    m_gateway_name = gateway_name;
    m_gateway_name_isSet = true;
}

bool OAIAdyen::is_gateway_name_Set() const{
    return m_gateway_name_isSet;
}

bool OAIAdyen::is_gateway_name_Valid() const{
    return m_gateway_name_isValid;
}

QString OAIAdyen::getId() const {
    return m_id;
}
void OAIAdyen::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIAdyen::is_id_Set() const{
    return m_id_isSet;
}

bool OAIAdyen::is_id_Valid() const{
    return m_id_isValid;
}

bool OAIAdyen::isIsDown() const {
    return m_is_down;
}
void OAIAdyen::setIsDown(const bool &is_down) {
    m_is_down = is_down;
    m_is_down_isSet = true;
}

bool OAIAdyen::is_is_down_Set() const{
    return m_is_down_isSet;
}

bool OAIAdyen::is_is_down_Valid() const{
    return m_is_down_isValid;
}

QString OAIAdyen::getMerchantCategoryCode() const {
    return m_merchant_category_code;
}
void OAIAdyen::setMerchantCategoryCode(const QString &merchant_category_code) {
    m_merchant_category_code = merchant_category_code;
    m_merchant_category_code_isSet = true;
}

bool OAIAdyen::is_merchant_category_code_Set() const{
    return m_merchant_category_code_isSet;
}

bool OAIAdyen::is_merchant_category_code_Valid() const{
    return m_merchant_category_code_isValid;
}

OAIPaymentMethod OAIAdyen::getMethod() const {
    return m_method;
}
void OAIAdyen::setMethod(const OAIPaymentMethod &method) {
    m_method = method;
    m_method_isSet = true;
}

bool OAIAdyen::is_method_Set() const{
    return m_method_isSet;
}

bool OAIAdyen::is_method_Valid() const{
    return m_method_isValid;
}

double OAIAdyen::getMonthlyLimit() const {
    return m_monthly_limit;
}
void OAIAdyen::setMonthlyLimit(const double &monthly_limit) {
    m_monthly_limit = monthly_limit;
    m_monthly_limit_isSet = true;
}

bool OAIAdyen::is_monthly_limit_Set() const{
    return m_monthly_limit_isSet;
}

bool OAIAdyen::is_monthly_limit_Valid() const{
    return m_monthly_limit_isValid;
}

QString OAIAdyen::getOrganizationId() const {
    return m_organization_id;
}
void OAIAdyen::setOrganizationId(const QString &organization_id) {
    m_organization_id = organization_id;
    m_organization_id_isSet = true;
}

bool OAIAdyen::is_organization_id_Set() const{
    return m_organization_id_isSet;
}

bool OAIAdyen::is_organization_id_Valid() const{
    return m_organization_id_isValid;
}

QList<OAIPaymentCardBrand> OAIAdyen::getPaymentCardSchemes() const {
    return m_payment_card_schemes;
}
void OAIAdyen::setPaymentCardSchemes(const QList<OAIPaymentCardBrand> &payment_card_schemes) {
    m_payment_card_schemes = payment_card_schemes;
    m_payment_card_schemes_isSet = true;
}

bool OAIAdyen::is_payment_card_schemes_Set() const{
    return m_payment_card_schemes_isSet;
}

bool OAIAdyen::is_payment_card_schemes_Valid() const{
    return m_payment_card_schemes_isValid;
}

bool OAIAdyen::isReconciliationWindowEnabled() const {
    return m_reconciliation_window_enabled;
}
void OAIAdyen::setReconciliationWindowEnabled(const bool &reconciliation_window_enabled) {
    m_reconciliation_window_enabled = reconciliation_window_enabled;
    m_reconciliation_window_enabled_isSet = true;
}

bool OAIAdyen::is_reconciliation_window_enabled_Set() const{
    return m_reconciliation_window_enabled_isSet;
}

bool OAIAdyen::is_reconciliation_window_enabled_Valid() const{
    return m_reconciliation_window_enabled_isValid;
}

qint32 OAIAdyen::getReconciliationWindowTtl() const {
    return m_reconciliation_window_ttl;
}
void OAIAdyen::setReconciliationWindowTtl(const qint32 &reconciliation_window_ttl) {
    m_reconciliation_window_ttl = reconciliation_window_ttl;
    m_reconciliation_window_ttl_isSet = true;
}

bool OAIAdyen::is_reconciliation_window_ttl_Set() const{
    return m_reconciliation_window_ttl_isSet;
}

bool OAIAdyen::is_reconciliation_window_ttl_Valid() const{
    return m_reconciliation_window_ttl_isValid;
}

QString OAIAdyen::getStatus() const {
    return m_status;
}
void OAIAdyen::setStatus(const QString &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIAdyen::is_status_Set() const{
    return m_status_isSet;
}

bool OAIAdyen::is_status_Valid() const{
    return m_status_isValid;
}

bool OAIAdyen::isSticky() const {
    return m_sticky;
}
void OAIAdyen::setSticky(const bool &sticky) {
    m_sticky = sticky;
    m_sticky_isSet = true;
}

bool OAIAdyen::is_sticky_Set() const{
    return m_sticky_isSet;
}

bool OAIAdyen::is_sticky_Valid() const{
    return m_sticky_isValid;
}

bool OAIAdyen::isThreeDSecure() const {
    return m_three_d_secure;
}
void OAIAdyen::setThreeDSecure(const bool &three_d_secure) {
    m_three_d_secure = three_d_secure;
    m_three_d_secure_isSet = true;
}

bool OAIAdyen::is_three_d_secure_Set() const{
    return m_three_d_secure_isSet;
}

bool OAIAdyen::is_three_d_secure_Valid() const{
    return m_three_d_secure_isValid;
}

qint32 OAIAdyen::getTimeout() const {
    return m_timeout;
}
void OAIAdyen::setTimeout(const qint32 &timeout) {
    m_timeout = timeout;
    m_timeout_isSet = true;
}

bool OAIAdyen::is_timeout_Set() const{
    return m_timeout_isSet;
}

bool OAIAdyen::is_timeout_Valid() const{
    return m_timeout_isValid;
}

QString OAIAdyen::getToken() const {
    return m_token;
}
void OAIAdyen::setToken(const QString &token) {
    m_token = token;
    m_token_isSet = true;
}

bool OAIAdyen::is_token_Set() const{
    return m_token_isSet;
}

bool OAIAdyen::is_token_Valid() const{
    return m_token_isValid;
}

QDateTime OAIAdyen::getUpdatedTime() const {
    return m_updated_time;
}
void OAIAdyen::setUpdatedTime(const QDateTime &updated_time) {
    m_updated_time = updated_time;
    m_updated_time_isSet = true;
}

bool OAIAdyen::is_updated_time_Set() const{
    return m_updated_time_isSet;
}

bool OAIAdyen::is_updated_time_Valid() const{
    return m_updated_time_isValid;
}

OAIAdyen_allOf_credentials OAIAdyen::getCredentials() const {
    return m_credentials;
}
void OAIAdyen::setCredentials(const OAIAdyen_allOf_credentials &credentials) {
    m_credentials = credentials;
    m_credentials_isSet = true;
}

bool OAIAdyen::is_credentials_Set() const{
    return m_credentials_isSet;
}

bool OAIAdyen::is_credentials_Valid() const{
    return m_credentials_isValid;
}

OAIAdyen_allOf_settings OAIAdyen::getSettings() const {
    return m_settings;
}
void OAIAdyen::setSettings(const OAIAdyen_allOf_settings &settings) {
    m_settings = settings;
    m_settings_isSet = true;
}

bool OAIAdyen::is_settings_Set() const{
    return m_settings_isSet;
}

bool OAIAdyen::is_settings_Valid() const{
    return m_settings_isValid;
}

bool OAIAdyen::isSet() const {
