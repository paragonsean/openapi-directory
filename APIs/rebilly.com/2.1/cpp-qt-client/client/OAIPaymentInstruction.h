...
/*
 * OAIPaymentInstruction.h
 *
 * 
 */

#ifndef OAIPaymentInstruction_H
#define OAIPaymentInstruction_H

#include <QJsonObject>

#include "OAIPaymentInstrument_3.h"
...
class OAIPaymentInstruction : public OAIObject {
public:
    OAIPaymentInstruction();
    OAIPaymentInstruction(QString json);
    ~OAIPaymentInstruction() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPaymentInstruction)

#endif // OAIPaymentInstruction_H
