...
OAIFlexepin::OAIFlexepin(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIFlexepin::OAIFlexepin() {
    this->initializeModel();
}

OAIFlexepin::~OAIFlexepin() {}

void OAIFlexepin::initializeModel() {
...
void OAIFlexepin::fromJson(QString jsonString) {
...
void OAIFlexepin::fromJsonObject(QJsonObject json) {
...
QString OAIFlexepin::asJson() const {
...
QJsonObject OAIFlexepin::asJsonObject() const {
    QJsonObject obj;
    if (m__links.size() > 0) {
...
QList<OAIGatewayAccount__links_inner> OAIFlexepin::getLinks() const {
    return m__links;
}
void OAIFlexepin::setLinks(const QList<OAIGatewayAccount__links_inner> &_links) {
    m__links = _links;
    m__links_isSet = true;
}

bool OAIFlexepin::is__links_Set() const{
    return m__links_isSet;
}

bool OAIFlexepin::is__links_Valid() const{
    return m__links_isValid;
}

QList<QString> OAIFlexepin::getAcceptedCurrencies() const {
    return m_accepted_currencies;
}
void OAIFlexepin::setAcceptedCurrencies(const QList<QString> &accepted_currencies) {
    m_accepted_currencies = accepted_currencies;
    m_accepted_currencies_isSet = true;
}

bool OAIFlexepin::is_accepted_currencies_Set() const{
    return m_accepted_currencies_isSet;
}

bool OAIFlexepin::is_accepted_currencies_Valid() const{
    return m_accepted_currencies_isValid;
}

OAIAcquirerName OAIFlexepin::getAcquirerName() const {
    return m_acquirer_name;
}
void OAIFlexepin::setAcquirerName(const OAIAcquirerName &acquirer_name) {
    m_acquirer_name = acquirer_name;
    m_acquirer_name_isSet = true;
}

bool OAIFlexepin::is_acquirer_name_Set() const{
    return m_acquirer_name_isSet;
}

bool OAIFlexepin::is_acquirer_name_Valid() const{
    return m_acquirer_name_isValid;
}

QString OAIFlexepin::getAdditionalFilters() const {
    return m_additional_filters;
}
void OAIFlexepin::setAdditionalFilters(const QString &additional_filters) {
    m_additional_filters = additional_filters;
    m_additional_filters_isSet = true;
}

bool OAIFlexepin::is_additional_filters_Set() const{
    return m_additional_filters_isSet;
}

bool OAIFlexepin::is_additional_filters_Valid() const{
    return m_additional_filters_isValid;
}

qint32 OAIFlexepin::getApprovalWindowTtl() const {
    return m_approval_window_ttl;
}
void OAIFlexepin::setApprovalWindowTtl(const qint32 &approval_window_ttl) {
    m_approval_window_ttl = approval_window_ttl;
    m_approval_window_ttl_isSet = true;
}

bool OAIFlexepin::is_approval_window_ttl_Set() const{
    return m_approval_window_ttl_isSet;
}

bool OAIFlexepin::is_approval_window_ttl_Valid() const{
    return m_approval_window_ttl_isValid;
}

QString OAIFlexepin::getCityField() const {
    return m_city_field;
}
void OAIFlexepin::setCityField(const QString &city_field) {
    m_city_field = city_field;
    m_city_field_isSet = true;
}

bool OAIFlexepin::is_city_field_Set() const{
    return m_city_field_isSet;
}

bool OAIFlexepin::is_city_field_Valid() const{
    return m_city_field_isValid;
}

QDateTime OAIFlexepin::getCreatedTime() const {
    return m_created_time;
}
void OAIFlexepin::setCreatedTime(const QDateTime &created_time) {
    m_created_time = created_time;
    m_created_time_isSet = true;
}

bool OAIFlexepin::is_created_time_Set() const{
    return m_created_time_isSet;
}

bool OAIFlexepin::is_created_time_Valid() const{
    return m_created_time_isValid;
}

QString OAIFlexepin::getDccForceCurrency() const {
    return m_dcc_force_currency;
}
void OAIFlexepin::setDccForceCurrency(const QString &dcc_force_currency) {
    m_dcc_force_currency = dcc_force_currency;
    m_dcc_force_currency_isSet = true;
}

bool OAIFlexepin::is_dcc_force_currency_Set() const{
    return m_dcc_force_currency_isSet;
}

bool OAIFlexepin::is_dcc_force_currency_Valid() const{
    return m_dcc_force_currency_isValid;
}

qint32 OAIFlexepin::getDccMarkup() const {
    return m_dcc_markup;
}
void OAIFlexepin::setDccMarkup(const qint32 &dcc_markup) {
    m_dcc_markup = dcc_markup;
    m_dcc_markup_isSet = true;
}

bool OAIFlexepin::is_dcc_markup_Set() const{
    return m_dcc_markup_isSet;
}

bool OAIFlexepin::is_dcc_markup_Valid() const{
    return m_dcc_markup_isValid;
}

QString OAIFlexepin::getDescriptor() const {
    return m_descriptor;
}
void OAIFlexepin::setDescriptor(const QString &descriptor) {
    m_descriptor = descriptor;
    m_descriptor_isSet = true;
}

bool OAIFlexepin::is_descriptor_Set() const{
    return m_descriptor_isSet;
}

bool OAIFlexepin::is_descriptor_Valid() const{
    return m_descriptor_isValid;
}

OAIDigitalWallets OAIFlexepin::getDigitalWallets() const {
    return m_digital_wallets;
}
void OAIFlexepin::setDigitalWallets(const OAIDigitalWallets &digital_wallets) {
    m_digital_wallets = digital_wallets;
    m_digital_wallets_isSet = true;
}

bool OAIFlexepin::is_digital_wallets_Set() const{
    return m_digital_wallets_isSet;
}

bool OAIFlexepin::is_digital_wallets_Valid() const{
    return m_digital_wallets_isValid;
}

bool OAIFlexepin::isDynamicDescriptor() const {
    return m_dynamic_descriptor;
}
void OAIFlexepin::setDynamicDescriptor(const bool &dynamic_descriptor) {
    m_dynamic_descriptor = dynamic_descriptor;
    m_dynamic_descriptor_isSet = true;
}

bool OAIFlexepin::is_dynamic_descriptor_Set() const{
    return m_dynamic_descriptor_isSet;
}

bool OAIFlexepin::is_dynamic_descriptor_Valid() const{
    return m_dynamic_descriptor_isValid;
}

QList<QString> OAIFlexepin::getExcludedDccQuoteCurrencies() const {
    return m_excluded_dcc_quote_currencies;
}
void OAIFlexepin::setExcludedDccQuoteCurrencies(const QList<QString> &excluded_dcc_quote_currencies) {
    m_excluded_dcc_quote_currencies = excluded_dcc_quote_currencies;
    m_excluded_dcc_quote_currencies_isSet = true;
}

bool OAIFlexepin::is_excluded_dcc_quote_currencies_Set() const{
    return m_excluded_dcc_quote_currencies_isSet;
}

bool OAIFlexepin::is_excluded_dcc_quote_currencies_Valid() const{
    return m_excluded_dcc_quote_currencies_isValid;
}

OAIGatewayName OAIFlexepin::getGatewayName() const {
    return m_gateway_name;
}
void OAIFlexepin::setGatewayName(const OAIGatewayName &gateway_name) {
    m_gateway_name = gateway_name;
    m_gateway_name_isSet = true;
}

bool OAIFlexepin::is_gateway_name_Set() const{
    return m_gateway_name_isSet;
}

bool OAIFlexepin::is_gateway_name_Valid() const{
    return m_gateway_name_isValid;
}

QString OAIFlexepin::getId() const {
    return m_id;
}
void OAIFlexepin::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIFlexepin::is_id_Set() const{
    return m_id_isSet;
}

bool OAIFlexepin::is_id_Valid() const{
    return m_id_isValid;
}

bool OAIFlexepin::isIsDown() const {
    return m_is_down;
}
void OAIFlexepin::setIsDown(const bool &is_down) {
    m_is_down = is_down;
    m_is_down_isSet = true;
}

bool OAIFlexepin::is_is_down_Set() const{
    return m_is_down_isSet;
}

bool OAIFlexepin::is_is_down_Valid() const{
    return m_is_down_isValid;
}

QString OAIFlexepin::getMerchantCategoryCode() const {
    return m_merchant_category_code;
}
void OAIFlexepin::setMerchantCategoryCode(const QString &merchant_category_code) {
    m_merchant_category_code = merchant_category_code;
    m_merchant_category_code_isSet = true;
}

bool OAIFlexepin::is_merchant_category_code_Set() const{
    return m_merchant_category_code_isSet;
}

bool OAIFlexepin::is_merchant_category_code_Valid() const{
    return m_merchant_category_code_isValid;
}

OAIPaymentMethod OAIFlexepin::getMethod() const {
    return m_method;
}
void OAIFlexepin::setMethod(const OAIPaymentMethod &method) {
    m_method = method;
    m_method_isSet = true;
}

bool OAIFlexepin::is_method_Set() const{
    return m_method_isSet;
}

bool OAIFlexepin::is_method_Valid() const{
    return m_method_isValid;
}

double OAIFlexepin::getMonthlyLimit() const {
    return m_monthly_limit;
}
void OAIFlexepin::setMonthlyLimit(const double &monthly_limit) {
    m_monthly_limit = monthly_limit;
    m_monthly_limit_isSet = true;
}

bool OAIFlexepin::is_monthly_limit_Set() const{
    return m_monthly_limit_isSet;
}

bool OAIFlexepin::is_monthly_limit_Valid() const{
    return m_monthly_limit_isValid;
}

QString OAIFlexepin::getOrganizationId() const {
    return m_organization_id;
}
void OAIFlexepin::setOrganizationId(const QString &organization_id) {
    m_organization_id = organization_id;
    m_organization_id_isSet = true;
}

bool OAIFlexepin::is_organization_id_Set() const{
    return m_organization_id_isSet;
}

bool OAIFlexepin::is_organization_id_Valid() const{
    return m_organization_id_isValid;
}

QList<OAIPaymentCardBrand> OAIFlexepin::getPaymentCardSchemes() const {
    return m_payment_card_schemes;
}
void OAIFlexepin::setPaymentCardSchemes(const QList<OAIPaymentCardBrand> &payment_card_schemes) {
    m_payment_card_schemes = payment_card_schemes;
    m_payment_card_schemes_isSet = true;
}

bool OAIFlexepin::is_payment_card_schemes_Set() const{
    return m_payment_card_schemes_isSet;
}

bool OAIFlexepin::is_payment_card_schemes_Valid() const{
    return m_payment_card_schemes_isValid;
}

bool OAIFlexepin::isReconciliationWindowEnabled() const {
    return m_reconciliation_window_enabled;
}
void OAIFlexepin::setReconciliationWindowEnabled(const bool &reconciliation_window_enabled) {
    m_reconciliation_window_enabled = reconciliation_window_enabled;
    m_reconciliation_window_enabled_isSet = true;
}

bool OAIFlexepin::is_reconciliation_window_enabled_Set() const{
    return m_reconciliation_window_enabled_isSet;
}

bool OAIFlexepin::is_reconciliation_window_enabled_Valid() const{
    return m_reconciliation_window_enabled_isValid;
}

qint32 OAIFlexepin::getReconciliationWindowTtl() const {
    return m_reconciliation_window_ttl;
}
void OAIFlexepin::setReconciliationWindowTtl(const qint32 &reconciliation_window_ttl) {
    m_reconciliation_window_ttl = reconciliation_window_ttl;
    m_reconciliation_window_ttl_isSet = true;
}

bool OAIFlexepin::is_reconciliation_window_ttl_Set() const{
    return m_reconciliation_window_ttl_isSet;
}

bool OAIFlexepin::is_reconciliation_window_ttl_Valid() const{
    return m_reconciliation_window_ttl_isValid;
}

QString OAIFlexepin::getStatus() const {
    return m_status;
}
void OAIFlexepin::setStatus(const QString &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIFlexepin::is_status_Set() const{
    return m_status_isSet;
}

bool OAIFlexepin::is_status_Valid() const{
    return m_status_isValid;
}

bool OAIFlexepin::isSticky() const {
    return m_sticky;
}
void OAIFlexepin::setSticky(const bool &sticky) {
    m_sticky = sticky;
    m_sticky_isSet = true;
}

bool OAIFlexepin::is_sticky_Set() const{
    return m_sticky_isSet;
}

bool OAIFlexepin::is_sticky_Valid() const{
    return m_sticky_isValid;
}

bool OAIFlexepin::isThreeDSecure() const {
    return m_three_d_secure;
}
void OAIFlexepin::setThreeDSecure(const bool &three_d_secure) {
    m_three_d_secure = three_d_secure;
    m_three_d_secure_isSet = true;
}

bool OAIFlexepin::is_three_d_secure_Set() const{
    return m_three_d_secure_isSet;
}

bool OAIFlexepin::is_three_d_secure_Valid() const{
    return m_three_d_secure_isValid;
}

qint32 OAIFlexepin::getTimeout() const {
    return m_timeout;
}
void OAIFlexepin::setTimeout(const qint32 &timeout) {
    m_timeout = timeout;
    m_timeout_isSet = true;
}

bool OAIFlexepin::is_timeout_Set() const{
    return m_timeout_isSet;
}

bool OAIFlexepin::is_timeout_Valid() const{
    return m_timeout_isValid;
}

QString OAIFlexepin::getToken() const {
    return m_token;
}
void OAIFlexepin::setToken(const QString &token) {
    m_token = token;
    m_token_isSet = true;
}

bool OAIFlexepin::is_token_Set() const{
    return m_token_isSet;
}

bool OAIFlexepin::is_token_Valid() const{
    return m_token_isValid;
}

QDateTime OAIFlexepin::getUpdatedTime() const {
    return m_updated_time;
}
void OAIFlexepin::setUpdatedTime(const QDateTime &updated_time) {
    m_updated_time = updated_time;
    m_updated_time_isSet = true;
}

bool OAIFlexepin::is_updated_time_Set() const{
    return m_updated_time_isSet;
}

bool OAIFlexepin::is_updated_time_Valid() const{
    return m_updated_time_isValid;
}

OAIFlexepin_allOf_credentials OAIFlexepin::getCredentials() const {
    return m_credentials;
}
void OAIFlexepin::setCredentials(const OAIFlexepin_allOf_credentials &credentials) {
    m_credentials = credentials;
    m_credentials_isSet = true;
}

bool OAIFlexepin::is_credentials_Set() const{
    return m_credentials_isSet;
}

bool OAIFlexepin::is_credentials_Valid() const{
    return m_credentials_isValid;
}

bool OAIFlexepin::isSet() const {
...
bool OAIFlexepin::isValid() const {
