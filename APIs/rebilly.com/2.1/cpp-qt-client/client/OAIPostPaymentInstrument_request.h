...
/*
 * OAIPostPaymentInstrument_request.h
 *
 * 
 */

#ifndef OAIPostPaymentInstrument_request_H
#define OAIPostPaymentInstrument_request_H
...
#include "OAIPaymentCardCreatePlain.h"
...
class OAIPayPalAccount_allOf__embedded;
class OAIPayPalAccount_allOf__links;

class OAIPostPaymentInstrument_request : public OAIObject {
public:
    OAIPostPaymentInstrument_request();
    OAIPostPaymentInstrument_request(QString json);
    ~OAIPostPaymentInstrument_request() override;
    ...
    QList<OAIPayPalAccount_allOf__embedded> getEmbedded() const;
    void setEmbedded(const QList<OAIPayPalAccount_allOf__embedded> &_embedded);
    bool is__embedded_Set() const;
    bool is__embedded_Valid() const;

    QList<OAIPayPalAccount_allOf__links> getLinks() const;
    void setLinks(const QList<OAIPayPalAccount_allOf__links> &_links);
...
private:
    ...
    QList<OAIPayPalAccount_allOf__embedded> m__embedded;
    bool m__embedded_isSet;
    bool m__embedded_isValid;

    QList<OAIPayPalAccount_allOf__links> m__links;
    bool m__links_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPostPaymentInstrument_request)

#endif // OAIPostPaymentInstrument_request_H
