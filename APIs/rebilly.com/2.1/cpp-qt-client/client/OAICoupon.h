...
#include "OAICouponRestriction.h"
...
public:
    ...
    OAIDiscount getDiscount() const;
    void setDiscount(const OAIDiscount &discount);
    bool is_discount_Set() const;
    bool is_discount_Valid() const;

    QDateTime getExpiredTime() const;
    void setExpiredTime(const QDateTime &expired_time);
    bool is_expired_time_Set() const;
    bool is_expired_time_Valid() const;
    ...
    qint32 getRedemptionsCount() const;
    void setRedemptionsCount(const qint32 &redemptions_count);
    bool is_redemptions_count_Set() const;
    bool is_redemptions_count_Valid() const;

    QList<OAICouponRestriction> getRestrictions() const;
    void setRestrictions(const QList<OAICouponRestriction> &restrictions);
...
private:
    ...
    OAIDiscount m_discount;
    bool m_discount_isSet;
    bool m_discount_isValid;

    QDateTime m_expired_time;
    bool m_expired_time_isSet;
    bool m_expired_time_isValid;
    ...
    qint32 m_redemptions_count;
    bool m_redemptions_count_isSet;
    bool m_redemptions_count_isValid;

    QList<OAICouponRestriction> m_restrictions;
