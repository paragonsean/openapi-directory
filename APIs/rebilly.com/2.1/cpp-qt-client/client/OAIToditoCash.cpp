...
OAIToditoCash::OAIToditoCash(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIToditoCash::OAIToditoCash() {
    this->initializeModel();
}

OAIToditoCash::~OAIToditoCash() {}

void OAIToditoCash::initializeModel() {
...
void OAIToditoCash::fromJson(QString jsonString) {
...
void OAIToditoCash::fromJsonObject(QJsonObject json) {
...
QString OAIToditoCash::asJson() const {
...
QJsonObject OAIToditoCash::asJsonObject() const {
    QJsonObject obj;
    if (m__links.size() > 0) {
...
QList<OAIGatewayAccount__links_inner> OAIToditoCash::getLinks() const {
    return m__links;
}
void OAIToditoCash::setLinks(const QList<OAIGatewayAccount__links_inner> &_links) {
    m__links = _links;
    m__links_isSet = true;
}

bool OAIToditoCash::is__links_Set() const{
    return m__links_isSet;
}

bool OAIToditoCash::is__links_Valid() const{
    return m__links_isValid;
}

QList<QString> OAIToditoCash::getAcceptedCurrencies() const {
    return m_accepted_currencies;
}
void OAIToditoCash::setAcceptedCurrencies(const QList<QString> &accepted_currencies) {
    m_accepted_currencies = accepted_currencies;
    m_accepted_currencies_isSet = true;
}

bool OAIToditoCash::is_accepted_currencies_Set() const{
    return m_accepted_currencies_isSet;
}

bool OAIToditoCash::is_accepted_currencies_Valid() const{
    return m_accepted_currencies_isValid;
}

OAIAcquirerName OAIToditoCash::getAcquirerName() const {
    return m_acquirer_name;
}
void OAIToditoCash::setAcquirerName(const OAIAcquirerName &acquirer_name) {
    m_acquirer_name = acquirer_name;
    m_acquirer_name_isSet = true;
}

bool OAIToditoCash::is_acquirer_name_Set() const{
    return m_acquirer_name_isSet;
}

bool OAIToditoCash::is_acquirer_name_Valid() const{
    return m_acquirer_name_isValid;
}

QString OAIToditoCash::getAdditionalFilters() const {
    return m_additional_filters;
}
void OAIToditoCash::setAdditionalFilters(const QString &additional_filters) {
    m_additional_filters = additional_filters;
    m_additional_filters_isSet = true;
}

bool OAIToditoCash::is_additional_filters_Set() const{
    return m_additional_filters_isSet;
}

bool OAIToditoCash::is_additional_filters_Valid() const{
    return m_additional_filters_isValid;
}

qint32 OAIToditoCash::getApprovalWindowTtl() const {
    return m_approval_window_ttl;
}
void OAIToditoCash::setApprovalWindowTtl(const qint32 &approval_window_ttl) {
    m_approval_window_ttl = approval_window_ttl;
    m_approval_window_ttl_isSet = true;
}

bool OAIToditoCash::is_approval_window_ttl_Set() const{
    return m_approval_window_ttl_isSet;
}

bool OAIToditoCash::is_approval_window_ttl_Valid() const{
    return m_approval_window_ttl_isValid;
}

QString OAIToditoCash::getCityField() const {
    return m_city_field;
}
void OAIToditoCash::setCityField(const QString &city_field) {
    m_city_field = city_field;
    m_city_field_isSet = true;
}

bool OAIToditoCash::is_city_field_Set() const{
    return m_city_field_isSet;
}

bool OAIToditoCash::is_city_field_Valid() const{
    return m_city_field_isValid;
}

QDateTime OAIToditoCash::getCreatedTime() const {
    return m_created_time;
}
void OAIToditoCash::setCreatedTime(const QDateTime &created_time) {
    m_created_time = created_time;
    m_created_time_isSet = true;
}

bool OAIToditoCash::is_created_time_Set() const{
    return m_created_time_isSet;
}

bool OAIToditoCash::is_created_time_Valid() const{
    return m_created_time_isValid;
}

QString OAIToditoCash::getDccForceCurrency() const {
    return m_dcc_force_currency;
}
void OAIToditoCash::setDccForceCurrency(const QString &dcc_force_currency) {
    m_dcc_force_currency = dcc_force_currency;
    m_dcc_force_currency_isSet = true;
}

bool OAIToditoCash::is_dcc_force_currency_Set() const{
    return m_dcc_force_currency_isSet;
}

bool OAIToditoCash::is_dcc_force_currency_Valid() const{
    return m_dcc_force_currency_isValid;
}

qint32 OAIToditoCash::getDccMarkup() const {
    return m_dcc_markup;
}
void OAIToditoCash::setDccMarkup(const qint32 &dcc_markup) {
    m_dcc_markup = dcc_markup;
    m_dcc_markup_isSet = true;
}

bool OAIToditoCash::is_dcc_markup_Set() const{
    return m_dcc_markup_isSet;
}

bool OAIToditoCash::is_dcc_markup_Valid() const{
    return m_dcc_markup_isValid;
}

QString OAIToditoCash::getDescriptor() const {
    return m_descriptor;
}
void OAIToditoCash::setDescriptor(const QString &descriptor) {
    m_descriptor = descriptor;
    m_descriptor_isSet = true;
}

bool OAIToditoCash::is_descriptor_Set() const{
    return m_descriptor_isSet;
}

bool OAIToditoCash::is_descriptor_Valid() const{
    return m_descriptor_isValid;
}

OAIDigitalWallets OAIToditoCash::getDigitalWallets() const {
    return m_digital_wallets;
}
void OAIToditoCash::setDigitalWallets(const OAIDigitalWallets &digital_wallets) {
    m_digital_wallets = digital_wallets;
    m_digital_wallets_isSet = true;
}

bool OAIToditoCash::is_digital_wallets_Set() const{
    return m_digital_wallets_isSet;
}

bool OAIToditoCash::is_digital_wallets_Valid() const{
    return m_digital_wallets_isValid;
}

bool OAIToditoCash::isDynamicDescriptor() const {
    return m_dynamic_descriptor;
}
void OAIToditoCash::setDynamicDescriptor(const bool &dynamic_descriptor) {
    m_dynamic_descriptor = dynamic_descriptor;
    m_dynamic_descriptor_isSet = true;
}

bool OAIToditoCash::is_dynamic_descriptor_Set() const{
    return m_dynamic_descriptor_isSet;
}

bool OAIToditoCash::is_dynamic_descriptor_Valid() const{
    return m_dynamic_descriptor_isValid;
}

QList<QString> OAIToditoCash::getExcludedDccQuoteCurrencies() const {
    return m_excluded_dcc_quote_currencies;
}
void OAIToditoCash::setExcludedDccQuoteCurrencies(const QList<QString> &excluded_dcc_quote_currencies) {
    m_excluded_dcc_quote_currencies = excluded_dcc_quote_currencies;
    m_excluded_dcc_quote_currencies_isSet = true;
}

bool OAIToditoCash::is_excluded_dcc_quote_currencies_Set() const{
    return m_excluded_dcc_quote_currencies_isSet;
}

bool OAIToditoCash::is_excluded_dcc_quote_currencies_Valid() const{
    return m_excluded_dcc_quote_currencies_isValid;
}

OAIGatewayName OAIToditoCash::getGatewayName() const {
    return m_gateway_name;
}
void OAIToditoCash::setGatewayName(const OAIGatewayName &gateway_name) {
    m_gateway_name = gateway_name;
    m_gateway_name_isSet = true;
}

bool OAIToditoCash::is_gateway_name_Set() const{
    return m_gateway_name_isSet;
}

bool OAIToditoCash::is_gateway_name_Valid() const{
    return m_gateway_name_isValid;
}

QString OAIToditoCash::getId() const {
    return m_id;
}
void OAIToditoCash::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIToditoCash::is_id_Set() const{
    return m_id_isSet;
}

bool OAIToditoCash::is_id_Valid() const{
    return m_id_isValid;
}

bool OAIToditoCash::isIsDown() const {
    return m_is_down;
}
void OAIToditoCash::setIsDown(const bool &is_down) {
    m_is_down = is_down;
    m_is_down_isSet = true;
}

bool OAIToditoCash::is_is_down_Set() const{
    return m_is_down_isSet;
}

bool OAIToditoCash::is_is_down_Valid() const{
    return m_is_down_isValid;
}

QString OAIToditoCash::getMerchantCategoryCode() const {
    return m_merchant_category_code;
}
void OAIToditoCash::setMerchantCategoryCode(const QString &merchant_category_code) {
    m_merchant_category_code = merchant_category_code;
    m_merchant_category_code_isSet = true;
}

bool OAIToditoCash::is_merchant_category_code_Set() const{
    return m_merchant_category_code_isSet;
}

bool OAIToditoCash::is_merchant_category_code_Valid() const{
    return m_merchant_category_code_isValid;
}

OAIPaymentMethod OAIToditoCash::getMethod() const {
    return m_method;
}
void OAIToditoCash::setMethod(const OAIPaymentMethod &method) {
    m_method = method;
    m_method_isSet = true;
}

bool OAIToditoCash::is_method_Set() const{
    return m_method_isSet;
}

bool OAIToditoCash::is_method_Valid() const{
    return m_method_isValid;
}

double OAIToditoCash::getMonthlyLimit() const {
    return m_monthly_limit;
}
void OAIToditoCash::setMonthlyLimit(const double &monthly_limit) {
    m_monthly_limit = monthly_limit;
    m_monthly_limit_isSet = true;
}

bool OAIToditoCash::is_monthly_limit_Set() const{
    return m_monthly_limit_isSet;
}

bool OAIToditoCash::is_monthly_limit_Valid() const{
    return m_monthly_limit_isValid;
}

QString OAIToditoCash::getOrganizationId() const {
    return m_organization_id;
}
void OAIToditoCash::setOrganizationId(const QString &organization_id) {
    m_organization_id = organization_id;
    m_organization_id_isSet = true;
}

bool OAIToditoCash::is_organization_id_Set() const{
    return m_organization_id_isSet;
}

bool OAIToditoCash::is_organization_id_Valid() const{
    return m_organization_id_isValid;
}

QList<OAIPaymentCardBrand> OAIToditoCash::getPaymentCardSchemes() const {
    return m_payment_card_schemes;
}
void OAIToditoCash::setPaymentCardSchemes(const QList<OAIPaymentCardBrand> &payment_card_schemes) {
    m_payment_card_schemes = payment_card_schemes;
    m_payment_card_schemes_isSet = true;
}

bool OAIToditoCash::is_payment_card_schemes_Set() const{
    return m_payment_card_schemes_isSet;
}

bool OAIToditoCash::is_payment_card_schemes_Valid() const{
    return m_payment_card_schemes_isValid;
}

bool OAIToditoCash::isReconciliationWindowEnabled() const {
    return m_reconciliation_window_enabled;
}
void OAIToditoCash::setReconciliationWindowEnabled(const bool &reconciliation_window_enabled) {
    m_reconciliation_window_enabled = reconciliation_window_enabled;
    m_reconciliation_window_enabled_isSet = true;
}

bool OAIToditoCash::is_reconciliation_window_enabled_Set() const{
    return m_reconciliation_window_enabled_isSet;
}

bool OAIToditoCash::is_reconciliation_window_enabled_Valid() const{
    return m_reconciliation_window_enabled_isValid;
}

qint32 OAIToditoCash::getReconciliationWindowTtl() const {
    return m_reconciliation_window_ttl;
}
void OAIToditoCash::setReconciliationWindowTtl(const qint32 &reconciliation_window_ttl) {
    m_reconciliation_window_ttl = reconciliation_window_ttl;
    m_reconciliation_window_ttl_isSet = true;
}

bool OAIToditoCash::is_reconciliation_window_ttl_Set() const{
    return m_reconciliation_window_ttl_isSet;
}

bool OAIToditoCash::is_reconciliation_window_ttl_Valid() const{
    return m_reconciliation_window_ttl_isValid;
}

QString OAIToditoCash::getStatus() const {
    return m_status;
}
void OAIToditoCash::setStatus(const QString &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIToditoCash::is_status_Set() const{
    return m_status_isSet;
}

bool OAIToditoCash::is_status_Valid() const{
    return m_status_isValid;
}

bool OAIToditoCash::isSticky() const {
    return m_sticky;
}
void OAIToditoCash::setSticky(const bool &sticky) {
    m_sticky = sticky;
    m_sticky_isSet = true;
}

bool OAIToditoCash::is_sticky_Set() const{
    return m_sticky_isSet;
}

bool OAIToditoCash::is_sticky_Valid() const{
    return m_sticky_isValid;
}

bool OAIToditoCash::isThreeDSecure() const {
    return m_three_d_secure;
}
void OAIToditoCash::setThreeDSecure(const bool &three_d_secure) {
    m_three_d_secure = three_d_secure;
    m_three_d_secure_isSet = true;
}

bool OAIToditoCash::is_three_d_secure_Set() const{
    return m_three_d_secure_isSet;
}

bool OAIToditoCash::is_three_d_secure_Valid() const{
    return m_three_d_secure_isValid;
}

qint32 OAIToditoCash::getTimeout() const {
    return m_timeout;
}
void OAIToditoCash::setTimeout(const qint32 &timeout) {
    m_timeout = timeout;
    m_timeout_isSet = true;
}

bool OAIToditoCash::is_timeout_Set() const{
    return m_timeout_isSet;
}

bool OAIToditoCash::is_timeout_Valid() const{
    return m_timeout_isValid;
}

QString OAIToditoCash::getToken() const {
    return m_token;
}
void OAIToditoCash::setToken(const QString &token) {
    m_token = token;
    m_token_isSet = true;
}

bool OAIToditoCash::is_token_Set() const{
    return m_token_isSet;
}

bool OAIToditoCash::is_token_Valid() const{
    return m_token_isValid;
}

QDateTime OAIToditoCash::getUpdatedTime() const {
    return m_updated_time;
}
void OAIToditoCash::setUpdatedTime(const QDateTime &updated_time) {
    m_updated_time = updated_time;
    m_updated_time_isSet = true;
}

bool OAIToditoCash::is_updated_time_Set() const{
    return m_updated_time_isSet;
}

bool OAIToditoCash::is_updated_time_Valid() const{
    return m_updated_time_isValid;
}

OAIToditoCash_allOf_credentials OAIToditoCash::getCredentials() const {
    return m_credentials;
}
void OAIToditoCash::setCredentials(const OAIToditoCash_allOf_credentials &credentials) {
    m_credentials = credentials;
    m_credentials_isSet = true;
}

bool OAIToditoCash::is_credentials_Set() const{
    return m_credentials_isSet;
}

bool OAIToditoCash::is_credentials_Valid() const{
    return m_credentials_isValid;
}

bool OAIToditoCash::isSet() const {
...
bool OAIToditoCash::isValid() const {
