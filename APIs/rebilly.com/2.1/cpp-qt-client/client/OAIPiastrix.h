...
#ifndef OAIPiastrix_H
#define OAIPiastrix_H
...
#include "OAIPiastrix_allOf_credentials.h"
#include "OAIPiastrix_allOf_settings.h"
#include <QDateTime>
#include <QList>
#include <QString>
...
class OAIPiastrix_allOf_credentials;
class OAIPiastrix_allOf_settings;
class OAIPiastrix3dsServers;

class OAIPiastrix : public OAIObject {
public:
    OAIPiastrix();
    OAIPiastrix(QString json);
    ~OAIPiastrix() override;
    ...
    OAIPiastrix_allOf_credentials getCredentials() const;
    void setCredentials(const OAIPiastrix_allOf_credentials &credentials);
    bool is_credentials_Set() const;
    bool is_credentials_Valid() const;

    OAIPiastrix_allOf_settings getSettings() const;
    void setSettings(const OAIPiastrix_allOf_settings &settings);
    bool is_settings_Set() const;
    bool is_settings_Valid() const;

    OAIPiastrix3dsServers getThreeDSecureServer() const;
    void setThreeDSecureServer(const OAIPiastrix3dsServers &three_d_secure_server);
...
private:
    ...
    OAIPiastrix_allOf_credentials m_credentials;
    bool m_credentials_isSet;
    bool m_credentials_isValid;

    OAIPiastrix_allOf_settings m_settings;
    bool m_settings_isSet;
    bool m_settings_isValid;

    OAIPiastrix3dsServers m_three_d_secure_server;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPiastrix)
