...
/*
 * OAIPlaidAccountToken.h
 *
 * 
 */

#ifndef OAIPlaidAccountToken_H
#define OAIPlaidAccountToken_H
...
class OAIPlaidAccountToken : public OAIObject {
public:
    OAIPlaidAccountToken();
    OAIPlaidAccountToken(QString json);
    ~OAIPlaidAccountToken() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPlaidAccountToken)

#endif // OAIPlaidAccountToken_H
