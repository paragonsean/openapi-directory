...
#include "OAIContactEmails_inner.h"
#include "OAIContactPhoneNumbers_inner.h"
#include <QList>
#include <QString>
...
namespace OpenAPI {
class OAIContactEmails_inner;
class OAIContactPhoneNumbers_inner;
...
public:
    ...
    QList<OAIContactEmails_inner> getEmails() const;
    void setEmails(const QList<OAIContactEmails_inner> &emails);
    ...
    QList<OAIContactPhoneNumbers_inner> getPhoneNumbers() const;
    void setPhoneNumbers(const QList<OAIContactPhoneNumbers_inner> &phone_numbers);
...
private:
    ...
    QList<OAIContactEmails_inner> m_emails;
    bool m_emails_isSet;
    ...
    QList<OAIContactPhoneNumbers_inner> m_phone_numbers;
