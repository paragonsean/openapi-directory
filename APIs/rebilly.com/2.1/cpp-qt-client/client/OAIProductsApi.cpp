...
void OAIProductsApi::deleteProduct(const QString &id, const ::OpenAPI::OptionalParam<QString> &organization_id) {
...
void OAIProductsApi::getProduct(const QString &id, const ::OpenAPI::OptionalParam<QString> &organization_id) {
...
void OAIProductsApi::getProductCollection(const ::OpenAPI::OptionalParam<QString> &organization_id, const ::OpenAPI::OptionalParam<QString> &filter, const ::OpenAPI::OptionalParam<QList<QString>> &sort, const ::OpenAPI::OptionalParam<qint32> &limit, const ::OpenAPI::OptionalParam<qint32> &offset, const ::OpenAPI::OptionalParam<QString> &q) {
    QString fullPath = QString(_serverConfigs["getProductCollection"][_serverIndices.value("getProductCollection")].URL()+"/products");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIProductsApi::getProductCollectionCallback);
    connect(this, &OAIProductsApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIProductsApi::getProductCollectionCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
...
void OAIProductsApi::postProduct(const OAIProduct &oai_product, const ::OpenAPI::OptionalParam<QString> &organization_id) {
    QString fullPath = QString(_serverConfigs["postProduct"][_serverIndices.value("postProduct")].URL()+"/products");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIProductsApi::postProductCallback);
    connect(this, &OAIProductsApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIProductsApi::postProductCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
...
void OAIProductsApi::putProduct(const QString &id, const OAIProduct &oai_product, const ::OpenAPI::OptionalParam<QString> &organization_id) {
    QString fullPath = QString(_serverConfigs["putProduct"][_serverIndices.value("putProduct")].URL()+"/products/{id}");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIProductsApi::putProductCallback);
    connect(this, &OAIProductsApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIProductsApi::putProductCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT putProductSignal(output);
        Q_EMIT putProductSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT putProductSignalE(output, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT putProductSignalError(output, error_type, error_str);
