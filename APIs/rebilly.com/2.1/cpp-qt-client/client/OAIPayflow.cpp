...
OAIPayflow::OAIPayflow(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPayflow::OAIPayflow() {
    this->initializeModel();
}

OAIPayflow::~OAIPayflow() {}

void OAIPayflow::initializeModel() {
...
void OAIPayflow::fromJson(QString jsonString) {
...
void OAIPayflow::fromJsonObject(QJsonObject json) {
...
QString OAIPayflow::asJson() const {
...
QJsonObject OAIPayflow::asJsonObject() const {
    QJsonObject obj;
    if (m__links.size() > 0) {
...
QList<OAIGatewayAccount__links_inner> OAIPayflow::getLinks() const {
    return m__links;
}
void OAIPayflow::setLinks(const QList<OAIGatewayAccount__links_inner> &_links) {
    m__links = _links;
    m__links_isSet = true;
}

bool OAIPayflow::is__links_Set() const{
    return m__links_isSet;
}

bool OAIPayflow::is__links_Valid() const{
    return m__links_isValid;
}

QList<QString> OAIPayflow::getAcceptedCurrencies() const {
    return m_accepted_currencies;
}
void OAIPayflow::setAcceptedCurrencies(const QList<QString> &accepted_currencies) {
    m_accepted_currencies = accepted_currencies;
    m_accepted_currencies_isSet = true;
}

bool OAIPayflow::is_accepted_currencies_Set() const{
    return m_accepted_currencies_isSet;
}

bool OAIPayflow::is_accepted_currencies_Valid() const{
    return m_accepted_currencies_isValid;
}

OAIAcquirerName OAIPayflow::getAcquirerName() const {
    return m_acquirer_name;
}
void OAIPayflow::setAcquirerName(const OAIAcquirerName &acquirer_name) {
    m_acquirer_name = acquirer_name;
    m_acquirer_name_isSet = true;
}

bool OAIPayflow::is_acquirer_name_Set() const{
    return m_acquirer_name_isSet;
}

bool OAIPayflow::is_acquirer_name_Valid() const{
    return m_acquirer_name_isValid;
}

QString OAIPayflow::getAdditionalFilters() const {
    return m_additional_filters;
}
void OAIPayflow::setAdditionalFilters(const QString &additional_filters) {
    m_additional_filters = additional_filters;
    m_additional_filters_isSet = true;
}

bool OAIPayflow::is_additional_filters_Set() const{
    return m_additional_filters_isSet;
}

bool OAIPayflow::is_additional_filters_Valid() const{
    return m_additional_filters_isValid;
}

qint32 OAIPayflow::getApprovalWindowTtl() const {
    return m_approval_window_ttl;
}
void OAIPayflow::setApprovalWindowTtl(const qint32 &approval_window_ttl) {
    m_approval_window_ttl = approval_window_ttl;
    m_approval_window_ttl_isSet = true;
}

bool OAIPayflow::is_approval_window_ttl_Set() const{
    return m_approval_window_ttl_isSet;
}

bool OAIPayflow::is_approval_window_ttl_Valid() const{
    return m_approval_window_ttl_isValid;
}

QString OAIPayflow::getCityField() const {
    return m_city_field;
}
void OAIPayflow::setCityField(const QString &city_field) {
    m_city_field = city_field;
    m_city_field_isSet = true;
}

bool OAIPayflow::is_city_field_Set() const{
    return m_city_field_isSet;
}

bool OAIPayflow::is_city_field_Valid() const{
    return m_city_field_isValid;
}

QDateTime OAIPayflow::getCreatedTime() const {
    return m_created_time;
}
void OAIPayflow::setCreatedTime(const QDateTime &created_time) {
    m_created_time = created_time;
    m_created_time_isSet = true;
}

bool OAIPayflow::is_created_time_Set() const{
    return m_created_time_isSet;
}

bool OAIPayflow::is_created_time_Valid() const{
    return m_created_time_isValid;
}

QString OAIPayflow::getDccForceCurrency() const {
    return m_dcc_force_currency;
}
void OAIPayflow::setDccForceCurrency(const QString &dcc_force_currency) {
    m_dcc_force_currency = dcc_force_currency;
    m_dcc_force_currency_isSet = true;
}

bool OAIPayflow::is_dcc_force_currency_Set() const{
    return m_dcc_force_currency_isSet;
}

bool OAIPayflow::is_dcc_force_currency_Valid() const{
    return m_dcc_force_currency_isValid;
}

qint32 OAIPayflow::getDccMarkup() const {
    return m_dcc_markup;
}
void OAIPayflow::setDccMarkup(const qint32 &dcc_markup) {
    m_dcc_markup = dcc_markup;
    m_dcc_markup_isSet = true;
}

bool OAIPayflow::is_dcc_markup_Set() const{
    return m_dcc_markup_isSet;
}

bool OAIPayflow::is_dcc_markup_Valid() const{
    return m_dcc_markup_isValid;
}

QString OAIPayflow::getDescriptor() const {
    return m_descriptor;
}
void OAIPayflow::setDescriptor(const QString &descriptor) {
    m_descriptor = descriptor;
    m_descriptor_isSet = true;
}

bool OAIPayflow::is_descriptor_Set() const{
    return m_descriptor_isSet;
}

bool OAIPayflow::is_descriptor_Valid() const{
    return m_descriptor_isValid;
}

OAIDigitalWallets OAIPayflow::getDigitalWallets() const {
    return m_digital_wallets;
}
void OAIPayflow::setDigitalWallets(const OAIDigitalWallets &digital_wallets) {
    m_digital_wallets = digital_wallets;
    m_digital_wallets_isSet = true;
}

bool OAIPayflow::is_digital_wallets_Set() const{
    return m_digital_wallets_isSet;
}

bool OAIPayflow::is_digital_wallets_Valid() const{
    return m_digital_wallets_isValid;
}

bool OAIPayflow::isDynamicDescriptor() const {
    return m_dynamic_descriptor;
}
void OAIPayflow::setDynamicDescriptor(const bool &dynamic_descriptor) {
    m_dynamic_descriptor = dynamic_descriptor;
    m_dynamic_descriptor_isSet = true;
}

bool OAIPayflow::is_dynamic_descriptor_Set() const{
    return m_dynamic_descriptor_isSet;
}

bool OAIPayflow::is_dynamic_descriptor_Valid() const{
    return m_dynamic_descriptor_isValid;
}

QList<QString> OAIPayflow::getExcludedDccQuoteCurrencies() const {
    return m_excluded_dcc_quote_currencies;
}
void OAIPayflow::setExcludedDccQuoteCurrencies(const QList<QString> &excluded_dcc_quote_currencies) {
    m_excluded_dcc_quote_currencies = excluded_dcc_quote_currencies;
    m_excluded_dcc_quote_currencies_isSet = true;
}

bool OAIPayflow::is_excluded_dcc_quote_currencies_Set() const{
    return m_excluded_dcc_quote_currencies_isSet;
}

bool OAIPayflow::is_excluded_dcc_quote_currencies_Valid() const{
    return m_excluded_dcc_quote_currencies_isValid;
}

OAIGatewayName OAIPayflow::getGatewayName() const {
    return m_gateway_name;
}
void OAIPayflow::setGatewayName(const OAIGatewayName &gateway_name) {
    m_gateway_name = gateway_name;
    m_gateway_name_isSet = true;
}

bool OAIPayflow::is_gateway_name_Set() const{
    return m_gateway_name_isSet;
}

bool OAIPayflow::is_gateway_name_Valid() const{
    return m_gateway_name_isValid;
}

QString OAIPayflow::getId() const {
    return m_id;
}
void OAIPayflow::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIPayflow::is_id_Set() const{
    return m_id_isSet;
}

bool OAIPayflow::is_id_Valid() const{
    return m_id_isValid;
}

bool OAIPayflow::isIsDown() const {
    return m_is_down;
}
void OAIPayflow::setIsDown(const bool &is_down) {
    m_is_down = is_down;
    m_is_down_isSet = true;
}

bool OAIPayflow::is_is_down_Set() const{
    return m_is_down_isSet;
}

bool OAIPayflow::is_is_down_Valid() const{
    return m_is_down_isValid;
}

QString OAIPayflow::getMerchantCategoryCode() const {
    return m_merchant_category_code;
}
void OAIPayflow::setMerchantCategoryCode(const QString &merchant_category_code) {
    m_merchant_category_code = merchant_category_code;
    m_merchant_category_code_isSet = true;
}

bool OAIPayflow::is_merchant_category_code_Set() const{
    return m_merchant_category_code_isSet;
}

bool OAIPayflow::is_merchant_category_code_Valid() const{
    return m_merchant_category_code_isValid;
}

OAIPaymentMethod OAIPayflow::getMethod() const {
    return m_method;
}
void OAIPayflow::setMethod(const OAIPaymentMethod &method) {
    m_method = method;
    m_method_isSet = true;
}

bool OAIPayflow::is_method_Set() const{
    return m_method_isSet;
}

bool OAIPayflow::is_method_Valid() const{
    return m_method_isValid;
}

double OAIPayflow::getMonthlyLimit() const {
    return m_monthly_limit;
}
void OAIPayflow::setMonthlyLimit(const double &monthly_limit) {
    m_monthly_limit = monthly_limit;
    m_monthly_limit_isSet = true;
}

bool OAIPayflow::is_monthly_limit_Set() const{
    return m_monthly_limit_isSet;
}

bool OAIPayflow::is_monthly_limit_Valid() const{
    return m_monthly_limit_isValid;
}

QString OAIPayflow::getOrganizationId() const {
    return m_organization_id;
}
void OAIPayflow::setOrganizationId(const QString &organization_id) {
    m_organization_id = organization_id;
    m_organization_id_isSet = true;
}

bool OAIPayflow::is_organization_id_Set() const{
    return m_organization_id_isSet;
}

bool OAIPayflow::is_organization_id_Valid() const{
    return m_organization_id_isValid;
}

QList<OAIPaymentCardBrand> OAIPayflow::getPaymentCardSchemes() const {
    return m_payment_card_schemes;
}
void OAIPayflow::setPaymentCardSchemes(const QList<OAIPaymentCardBrand> &payment_card_schemes) {
    m_payment_card_schemes = payment_card_schemes;
    m_payment_card_schemes_isSet = true;
}

bool OAIPayflow::is_payment_card_schemes_Set() const{
    return m_payment_card_schemes_isSet;
}

bool OAIPayflow::is_payment_card_schemes_Valid() const{
    return m_payment_card_schemes_isValid;
}

bool OAIPayflow::isReconciliationWindowEnabled() const {
    return m_reconciliation_window_enabled;
}
void OAIPayflow::setReconciliationWindowEnabled(const bool &reconciliation_window_enabled) {
    m_reconciliation_window_enabled = reconciliation_window_enabled;
    m_reconciliation_window_enabled_isSet = true;
}

bool OAIPayflow::is_reconciliation_window_enabled_Set() const{
    return m_reconciliation_window_enabled_isSet;
}

bool OAIPayflow::is_reconciliation_window_enabled_Valid() const{
    return m_reconciliation_window_enabled_isValid;
}

qint32 OAIPayflow::getReconciliationWindowTtl() const {
    return m_reconciliation_window_ttl;
}
void OAIPayflow::setReconciliationWindowTtl(const qint32 &reconciliation_window_ttl) {
    m_reconciliation_window_ttl = reconciliation_window_ttl;
    m_reconciliation_window_ttl_isSet = true;
}

bool OAIPayflow::is_reconciliation_window_ttl_Set() const{
    return m_reconciliation_window_ttl_isSet;
}

bool OAIPayflow::is_reconciliation_window_ttl_Valid() const{
    return m_reconciliation_window_ttl_isValid;
}

QString OAIPayflow::getStatus() const {
    return m_status;
}
void OAIPayflow::setStatus(const QString &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIPayflow::is_status_Set() const{
    return m_status_isSet;
}

bool OAIPayflow::is_status_Valid() const{
    return m_status_isValid;
}

bool OAIPayflow::isSticky() const {
    return m_sticky;
}
void OAIPayflow::setSticky(const bool &sticky) {
    m_sticky = sticky;
    m_sticky_isSet = true;
}

bool OAIPayflow::is_sticky_Set() const{
    return m_sticky_isSet;
}

bool OAIPayflow::is_sticky_Valid() const{
    return m_sticky_isValid;
}

bool OAIPayflow::isThreeDSecure() const {
    return m_three_d_secure;
}
void OAIPayflow::setThreeDSecure(const bool &three_d_secure) {
    m_three_d_secure = three_d_secure;
    m_three_d_secure_isSet = true;
}

bool OAIPayflow::is_three_d_secure_Set() const{
    return m_three_d_secure_isSet;
}

bool OAIPayflow::is_three_d_secure_Valid() const{
    return m_three_d_secure_isValid;
}

qint32 OAIPayflow::getTimeout() const {
    return m_timeout;
}
void OAIPayflow::setTimeout(const qint32 &timeout) {
    m_timeout = timeout;
    m_timeout_isSet = true;
}

bool OAIPayflow::is_timeout_Set() const{
    return m_timeout_isSet;
}

bool OAIPayflow::is_timeout_Valid() const{
    return m_timeout_isValid;
}

QString OAIPayflow::getToken() const {
    return m_token;
}
void OAIPayflow::setToken(const QString &token) {
    m_token = token;
    m_token_isSet = true;
}

bool OAIPayflow::is_token_Set() const{
    return m_token_isSet;
}

bool OAIPayflow::is_token_Valid() const{
    return m_token_isValid;
}

QDateTime OAIPayflow::getUpdatedTime() const {
    return m_updated_time;
}
void OAIPayflow::setUpdatedTime(const QDateTime &updated_time) {
    m_updated_time = updated_time;
    m_updated_time_isSet = true;
}

bool OAIPayflow::is_updated_time_Set() const{
    return m_updated_time_isSet;
}

bool OAIPayflow::is_updated_time_Valid() const{
    return m_updated_time_isValid;
}

OAIPayflow_allOf_credentials OAIPayflow::getCredentials() const {
    return m_credentials;
}
void OAIPayflow::setCredentials(const OAIPayflow_allOf_credentials &credentials) {
    m_credentials = credentials;
    m_credentials_isSet = true;
}

bool OAIPayflow::is_credentials_Set() const{
    return m_credentials_isSet;
}

bool OAIPayflow::is_credentials_Valid() const{
    return m_credentials_isValid;
}

bool OAIPayflow::isSet() const {
