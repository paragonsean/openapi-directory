...
class OAINMI_allOf_credentials;
class OAINMI_allOf_settings;
class OAINMI3dsServers;

class OAINMI : public OAIObject {
public:
    OAINMI();
    OAINMI(QString json);
    ~OAINMI() override;
    ...
    OAINMI_allOf_credentials getCredentials() const;
    void setCredentials(const OAINMI_allOf_credentials &credentials);
    bool is_credentials_Set() const;
    bool is_credentials_Valid() const;

    OAINMI_allOf_settings getSettings() const;
    void setSettings(const OAINMI_allOf_settings &settings);
    bool is_settings_Set() const;
    bool is_settings_Valid() const;

    OAINMI3dsServers getThreeDSecureServer() const;
    void setThreeDSecureServer(const OAINMI3dsServers &three_d_secure_server);
...
private:
    ...
    OAINMI_allOf_credentials m_credentials;
    bool m_credentials_isSet;
    bool m_credentials_isValid;

    OAINMI_allOf_settings m_settings;
    bool m_settings_isSet;
    bool m_settings_isValid;

    OAINMI3dsServers m_three_d_secure_server;
...
Q_DECLARE_METATYPE(OpenAPI::OAINMI)
