...
OAIVantivLitle::OAIVantivLitle(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIVantivLitle::OAIVantivLitle() {
    this->initializeModel();
}

OAIVantivLitle::~OAIVantivLitle() {}

void OAIVantivLitle::initializeModel() {
...
void OAIVantivLitle::fromJson(QString jsonString) {
...
void OAIVantivLitle::fromJsonObject(QJsonObject json) {
...
QString OAIVantivLitle::asJson() const {
...
QJsonObject OAIVantivLitle::asJsonObject() const {
    QJsonObject obj;
    if (m__links.size() > 0) {
...
QList<OAIGatewayAccount__links_inner> OAIVantivLitle::getLinks() const {
    return m__links;
}
void OAIVantivLitle::setLinks(const QList<OAIGatewayAccount__links_inner> &_links) {
    m__links = _links;
    m__links_isSet = true;
}

bool OAIVantivLitle::is__links_Set() const{
    return m__links_isSet;
}

bool OAIVantivLitle::is__links_Valid() const{
    return m__links_isValid;
}

QList<QString> OAIVantivLitle::getAcceptedCurrencies() const {
    return m_accepted_currencies;
}
void OAIVantivLitle::setAcceptedCurrencies(const QList<QString> &accepted_currencies) {
    m_accepted_currencies = accepted_currencies;
    m_accepted_currencies_isSet = true;
}

bool OAIVantivLitle::is_accepted_currencies_Set() const{
    return m_accepted_currencies_isSet;
}

bool OAIVantivLitle::is_accepted_currencies_Valid() const{
    return m_accepted_currencies_isValid;
}

OAIAcquirerName OAIVantivLitle::getAcquirerName() const {
    return m_acquirer_name;
}
void OAIVantivLitle::setAcquirerName(const OAIAcquirerName &acquirer_name) {
    m_acquirer_name = acquirer_name;
    m_acquirer_name_isSet = true;
}

bool OAIVantivLitle::is_acquirer_name_Set() const{
    return m_acquirer_name_isSet;
}

bool OAIVantivLitle::is_acquirer_name_Valid() const{
    return m_acquirer_name_isValid;
}

QString OAIVantivLitle::getAdditionalFilters() const {
    return m_additional_filters;
}
void OAIVantivLitle::setAdditionalFilters(const QString &additional_filters) {
    m_additional_filters = additional_filters;
    m_additional_filters_isSet = true;
}

bool OAIVantivLitle::is_additional_filters_Set() const{
    return m_additional_filters_isSet;
}

bool OAIVantivLitle::is_additional_filters_Valid() const{
    return m_additional_filters_isValid;
}

qint32 OAIVantivLitle::getApprovalWindowTtl() const {
    return m_approval_window_ttl;
}
void OAIVantivLitle::setApprovalWindowTtl(const qint32 &approval_window_ttl) {
    m_approval_window_ttl = approval_window_ttl;
    m_approval_window_ttl_isSet = true;
}

bool OAIVantivLitle::is_approval_window_ttl_Set() const{
    return m_approval_window_ttl_isSet;
}

bool OAIVantivLitle::is_approval_window_ttl_Valid() const{
    return m_approval_window_ttl_isValid;
}

QString OAIVantivLitle::getCityField() const {
    return m_city_field;
}
void OAIVantivLitle::setCityField(const QString &city_field) {
    m_city_field = city_field;
    m_city_field_isSet = true;
}

bool OAIVantivLitle::is_city_field_Set() const{
    return m_city_field_isSet;
}

bool OAIVantivLitle::is_city_field_Valid() const{
    return m_city_field_isValid;
}

QDateTime OAIVantivLitle::getCreatedTime() const {
    return m_created_time;
}
void OAIVantivLitle::setCreatedTime(const QDateTime &created_time) {
    m_created_time = created_time;
    m_created_time_isSet = true;
}

bool OAIVantivLitle::is_created_time_Set() const{
    return m_created_time_isSet;
}

bool OAIVantivLitle::is_created_time_Valid() const{
    return m_created_time_isValid;
}

QString OAIVantivLitle::getDccForceCurrency() const {
    return m_dcc_force_currency;
}
void OAIVantivLitle::setDccForceCurrency(const QString &dcc_force_currency) {
    m_dcc_force_currency = dcc_force_currency;
    m_dcc_force_currency_isSet = true;
}

bool OAIVantivLitle::is_dcc_force_currency_Set() const{
    return m_dcc_force_currency_isSet;
}

bool OAIVantivLitle::is_dcc_force_currency_Valid() const{
    return m_dcc_force_currency_isValid;
}

qint32 OAIVantivLitle::getDccMarkup() const {
    return m_dcc_markup;
}
void OAIVantivLitle::setDccMarkup(const qint32 &dcc_markup) {
    m_dcc_markup = dcc_markup;
    m_dcc_markup_isSet = true;
}

bool OAIVantivLitle::is_dcc_markup_Set() const{
    return m_dcc_markup_isSet;
}

bool OAIVantivLitle::is_dcc_markup_Valid() const{
    return m_dcc_markup_isValid;
}

QString OAIVantivLitle::getDescriptor() const {
    return m_descriptor;
}
void OAIVantivLitle::setDescriptor(const QString &descriptor) {
    m_descriptor = descriptor;
    m_descriptor_isSet = true;
}

bool OAIVantivLitle::is_descriptor_Set() const{
    return m_descriptor_isSet;
}

bool OAIVantivLitle::is_descriptor_Valid() const{
    return m_descriptor_isValid;
}

OAIDigitalWallets OAIVantivLitle::getDigitalWallets() const {
    return m_digital_wallets;
}
void OAIVantivLitle::setDigitalWallets(const OAIDigitalWallets &digital_wallets) {
    m_digital_wallets = digital_wallets;
    m_digital_wallets_isSet = true;
}

bool OAIVantivLitle::is_digital_wallets_Set() const{
    return m_digital_wallets_isSet;
}

bool OAIVantivLitle::is_digital_wallets_Valid() const{
    return m_digital_wallets_isValid;
}

bool OAIVantivLitle::isDynamicDescriptor() const {
    return m_dynamic_descriptor;
}
void OAIVantivLitle::setDynamicDescriptor(const bool &dynamic_descriptor) {
    m_dynamic_descriptor = dynamic_descriptor;
    m_dynamic_descriptor_isSet = true;
}

bool OAIVantivLitle::is_dynamic_descriptor_Set() const{
    return m_dynamic_descriptor_isSet;
}

bool OAIVantivLitle::is_dynamic_descriptor_Valid() const{
    return m_dynamic_descriptor_isValid;
}

QList<QString> OAIVantivLitle::getExcludedDccQuoteCurrencies() const {
    return m_excluded_dcc_quote_currencies;
}
void OAIVantivLitle::setExcludedDccQuoteCurrencies(const QList<QString> &excluded_dcc_quote_currencies) {
    m_excluded_dcc_quote_currencies = excluded_dcc_quote_currencies;
    m_excluded_dcc_quote_currencies_isSet = true;
}

bool OAIVantivLitle::is_excluded_dcc_quote_currencies_Set() const{
    return m_excluded_dcc_quote_currencies_isSet;
}

bool OAIVantivLitle::is_excluded_dcc_quote_currencies_Valid() const{
    return m_excluded_dcc_quote_currencies_isValid;
}

OAIGatewayName OAIVantivLitle::getGatewayName() const {
    return m_gateway_name;
}
void OAIVantivLitle::setGatewayName(const OAIGatewayName &gateway_name) {
    m_gateway_name = gateway_name;
    m_gateway_name_isSet = true;
}

bool OAIVantivLitle::is_gateway_name_Set() const{
    return m_gateway_name_isSet;
}

bool OAIVantivLitle::is_gateway_name_Valid() const{
    return m_gateway_name_isValid;
}

QString OAIVantivLitle::getId() const {
    return m_id;
}
void OAIVantivLitle::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIVantivLitle::is_id_Set() const{
    return m_id_isSet;
}

bool OAIVantivLitle::is_id_Valid() const{
    return m_id_isValid;
}

bool OAIVantivLitle::isIsDown() const {
    return m_is_down;
}
void OAIVantivLitle::setIsDown(const bool &is_down) {
    m_is_down = is_down;
    m_is_down_isSet = true;
}

bool OAIVantivLitle::is_is_down_Set() const{
    return m_is_down_isSet;
}

bool OAIVantivLitle::is_is_down_Valid() const{
    return m_is_down_isValid;
}

QString OAIVantivLitle::getMerchantCategoryCode() const {
    return m_merchant_category_code;
}
void OAIVantivLitle::setMerchantCategoryCode(const QString &merchant_category_code) {
    m_merchant_category_code = merchant_category_code;
    m_merchant_category_code_isSet = true;
}

bool OAIVantivLitle::is_merchant_category_code_Set() const{
    return m_merchant_category_code_isSet;
}

bool OAIVantivLitle::is_merchant_category_code_Valid() const{
    return m_merchant_category_code_isValid;
}

OAIPaymentMethod OAIVantivLitle::getMethod() const {
    return m_method;
}
void OAIVantivLitle::setMethod(const OAIPaymentMethod &method) {
    m_method = method;
    m_method_isSet = true;
}

bool OAIVantivLitle::is_method_Set() const{
    return m_method_isSet;
}

bool OAIVantivLitle::is_method_Valid() const{
    return m_method_isValid;
}

double OAIVantivLitle::getMonthlyLimit() const {
    return m_monthly_limit;
}
void OAIVantivLitle::setMonthlyLimit(const double &monthly_limit) {
    m_monthly_limit = monthly_limit;
    m_monthly_limit_isSet = true;
}

bool OAIVantivLitle::is_monthly_limit_Set() const{
    return m_monthly_limit_isSet;
}

bool OAIVantivLitle::is_monthly_limit_Valid() const{
    return m_monthly_limit_isValid;
}

QString OAIVantivLitle::getOrganizationId() const {
    return m_organization_id;
}
void OAIVantivLitle::setOrganizationId(const QString &organization_id) {
    m_organization_id = organization_id;
    m_organization_id_isSet = true;
}

bool OAIVantivLitle::is_organization_id_Set() const{
    return m_organization_id_isSet;
}

bool OAIVantivLitle::is_organization_id_Valid() const{
    return m_organization_id_isValid;
}

QList<OAIPaymentCardBrand> OAIVantivLitle::getPaymentCardSchemes() const {
    return m_payment_card_schemes;
}
void OAIVantivLitle::setPaymentCardSchemes(const QList<OAIPaymentCardBrand> &payment_card_schemes) {
    m_payment_card_schemes = payment_card_schemes;
    m_payment_card_schemes_isSet = true;
}

bool OAIVantivLitle::is_payment_card_schemes_Set() const{
    return m_payment_card_schemes_isSet;
}

bool OAIVantivLitle::is_payment_card_schemes_Valid() const{
    return m_payment_card_schemes_isValid;
}

bool OAIVantivLitle::isReconciliationWindowEnabled() const {
    return m_reconciliation_window_enabled;
}
void OAIVantivLitle::setReconciliationWindowEnabled(const bool &reconciliation_window_enabled) {
    m_reconciliation_window_enabled = reconciliation_window_enabled;
    m_reconciliation_window_enabled_isSet = true;
}

bool OAIVantivLitle::is_reconciliation_window_enabled_Set() const{
    return m_reconciliation_window_enabled_isSet;
}

bool OAIVantivLitle::is_reconciliation_window_enabled_Valid() const{
    return m_reconciliation_window_enabled_isValid;
}

qint32 OAIVantivLitle::getReconciliationWindowTtl() const {
    return m_reconciliation_window_ttl;
}
void OAIVantivLitle::setReconciliationWindowTtl(const qint32 &reconciliation_window_ttl) {
    m_reconciliation_window_ttl = reconciliation_window_ttl;
    m_reconciliation_window_ttl_isSet = true;
}

bool OAIVantivLitle::is_reconciliation_window_ttl_Set() const{
    return m_reconciliation_window_ttl_isSet;
}

bool OAIVantivLitle::is_reconciliation_window_ttl_Valid() const{
    return m_reconciliation_window_ttl_isValid;
}

QString OAIVantivLitle::getStatus() const {
    return m_status;
}
void OAIVantivLitle::setStatus(const QString &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIVantivLitle::is_status_Set() const{
    return m_status_isSet;
}

bool OAIVantivLitle::is_status_Valid() const{
    return m_status_isValid;
}

bool OAIVantivLitle::isSticky() const {
    return m_sticky;
}
void OAIVantivLitle::setSticky(const bool &sticky) {
    m_sticky = sticky;
    m_sticky_isSet = true;
}

bool OAIVantivLitle::is_sticky_Set() const{
    return m_sticky_isSet;
}

bool OAIVantivLitle::is_sticky_Valid() const{
    return m_sticky_isValid;
}

bool OAIVantivLitle::isThreeDSecure() const {
    return m_three_d_secure;
}
void OAIVantivLitle::setThreeDSecure(const bool &three_d_secure) {
    m_three_d_secure = three_d_secure;
    m_three_d_secure_isSet = true;
}

bool OAIVantivLitle::is_three_d_secure_Set() const{
    return m_three_d_secure_isSet;
}

bool OAIVantivLitle::is_three_d_secure_Valid() const{
    return m_three_d_secure_isValid;
}

qint32 OAIVantivLitle::getTimeout() const {
    return m_timeout;
}
void OAIVantivLitle::setTimeout(const qint32 &timeout) {
    m_timeout = timeout;
    m_timeout_isSet = true;
}

bool OAIVantivLitle::is_timeout_Set() const{
    return m_timeout_isSet;
}

bool OAIVantivLitle::is_timeout_Valid() const{
    return m_timeout_isValid;
}

QString OAIVantivLitle::getToken() const {
    return m_token;
}
void OAIVantivLitle::setToken(const QString &token) {
    m_token = token;
    m_token_isSet = true;
}

bool OAIVantivLitle::is_token_Set() const{
    return m_token_isSet;
}

bool OAIVantivLitle::is_token_Valid() const{
    return m_token_isValid;
}

QDateTime OAIVantivLitle::getUpdatedTime() const {
    return m_updated_time;
}
void OAIVantivLitle::setUpdatedTime(const QDateTime &updated_time) {
    m_updated_time = updated_time;
    m_updated_time_isSet = true;
}

bool OAIVantivLitle::is_updated_time_Set() const{
    return m_updated_time_isSet;
}

bool OAIVantivLitle::is_updated_time_Valid() const{
    return m_updated_time_isValid;
}

OAIVantivLitle_allOf_credentials OAIVantivLitle::getCredentials() const {
    return m_credentials;
}
void OAIVantivLitle::setCredentials(const OAIVantivLitle_allOf_credentials &credentials) {
    m_credentials = credentials;
    m_credentials_isSet = true;
}

bool OAIVantivLitle::is_credentials_Set() const{
    return m_credentials_isSet;
}

bool OAIVantivLitle::is_credentials_Valid() const{
    return m_credentials_isValid;
}

OAIVantivLitle3dsServers OAIVantivLitle::getThreeDSecureServer() const {
    return m_three_d_secure_server;
}
void OAIVantivLitle::setThreeDSecureServer(const OAIVantivLitle3dsServers &three_d_secure_server) {
    m_three_d_secure_server = three_d_secure_server;
    m_three_d_secure_server_isSet = true;
}

bool OAIVantivLitle::is_three_d_secure_server_Set() const{
    return m_three_d_secure_server_isSet;
}

bool OAIVantivLitle::is_three_d_secure_server_Valid() const{
    return m_three_d_secure_server_isValid;
}

bool OAIVantivLitle::isSet() const {
...
bool OAIVantivLitle::isValid() const {
