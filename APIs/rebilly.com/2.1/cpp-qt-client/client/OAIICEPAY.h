...
class OAIICEPAY_allOf_credentials;

class OAIICEPAY : public OAIObject {
public:
    OAIICEPAY();
    OAIICEPAY(QString json);
    ~OAIICEPAY() override;
    ...
    OAIICEPAY_allOf_credentials getCredentials() const;
    void setCredentials(const OAIICEPAY_allOf_credentials &credentials);
...
private:
    ...
    OAIICEPAY_allOf_credentials m_credentials;
...
Q_DECLARE_METATYPE(OpenAPI::OAIICEPAY)
