...
/*
 * OAIAirpay_allOf_credentials.h
 *
 * Airpay credentials object.
 */

#ifndef OAIAirpay_allOf_credentials_H
#define OAIAirpay_allOf_credentials_H
...
class OAIAirpay_allOf_credentials : public OAIObject {
public:
    OAIAirpay_allOf_credentials();
    OAIAirpay_allOf_credentials(QString json);
    ~OAIAirpay_allOf_credentials() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAirpay_allOf_credentials)

#endif // OAIAirpay_allOf_credentials_H
