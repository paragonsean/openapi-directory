...
/*
 * OAIParamountInterac_allOf_credentials.h
 *
 * ParamountInterac credentials object.
 */

#ifndef OAIParamountInterac_allOf_credentials_H
#define OAIParamountInterac_allOf_credentials_H
...
class OAIParamountInterac_allOf_credentials : public OAIObject {
public:
    OAIParamountInterac_allOf_credentials();
    OAIParamountInterac_allOf_credentials(QString json);
    ~OAIParamountInterac_allOf_credentials() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIParamountInterac_allOf_credentials)

#endif // OAIParamountInterac_allOf_credentials_H
