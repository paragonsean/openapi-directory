...
#ifndef OAIPaymentAsia_H
#define OAIPaymentAsia_H
...
#include "OAIPaymentAsia_allOf_credentials.h"
...
class OAIPaymentAsia_allOf_credentials;

class OAIPaymentAsia : public OAIObject {
public:
    OAIPaymentAsia();
    OAIPaymentAsia(QString json);
    ~OAIPaymentAsia() override;
    ...
    OAIPaymentAsia_allOf_credentials getCredentials() const;
    void setCredentials(const OAIPaymentAsia_allOf_credentials &credentials);
...
private:
    ...
    OAIPaymentAsia_allOf_credentials m_credentials;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPaymentAsia)

#endif // OAIPaymentAsia_H
