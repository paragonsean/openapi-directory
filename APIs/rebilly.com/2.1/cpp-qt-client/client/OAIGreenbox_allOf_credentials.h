...
/*
 * OAIGreenbox_allOf_credentials.h
 *
 * Greenbox credentials object.
 */

#ifndef OAIGreenbox_allOf_credentials_H
#define OAIGreenbox_allOf_credentials_H
...
class OAIGreenbox_allOf_credentials : public OAIObject {
public:
    OAIGreenbox_allOf_credentials();
    OAIGreenbox_allOf_credentials(QString json);
    ~OAIGreenbox_allOf_credentials() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGreenbox_allOf_credentials)

#endif // OAIGreenbox_allOf_credentials_H
