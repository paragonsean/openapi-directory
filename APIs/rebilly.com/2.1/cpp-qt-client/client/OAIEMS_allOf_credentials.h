...
/*
 * OAIEMS_allOf_credentials.h
 *
 * EMS credentials object.
 */

#ifndef OAIEMS_allOf_credentials_H
#define OAIEMS_allOf_credentials_H
...
class OAIEMS_allOf_credentials : public OAIObject {
public:
    OAIEMS_allOf_credentials();
    OAIEMS_allOf_credentials(QString json);
    ~OAIEMS_allOf_credentials() override;
    ...
    void setClientCertificatePassword(const QString &client_certificate_password);
    bool is_client_certificate_password_Set() const;
    bool is_client_certificate_password_Valid() const;
    ...
    QString getPrivateKeyPassword() const;
    void setPrivateKeyPassword(const QString &private_key_password);
    bool is_private_key_password_Set() const;
    bool is_private_key_password_Valid() const;
...
private:
    ...
    QString m_client_certificate_password;
    bool m_client_certificate_password_isSet;
    bool m_client_certificate_password_isValid;
    ...
    QString m_private_key_password;
    bool m_private_key_password_isSet;
    bool m_private_key_password_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEMS_allOf_credentials)

#endif // OAIEMS_allOf_credentials_H
