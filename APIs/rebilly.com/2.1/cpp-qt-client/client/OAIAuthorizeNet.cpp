...
OAIAuthorizeNet::OAIAuthorizeNet(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAuthorizeNet::OAIAuthorizeNet() {
    this->initializeModel();
}

OAIAuthorizeNet::~OAIAuthorizeNet() {}

void OAIAuthorizeNet::initializeModel() {
...
void OAIAuthorizeNet::fromJson(QString jsonString) {
...
void OAIAuthorizeNet::fromJsonObject(QJsonObject json) {
...
QString OAIAuthorizeNet::asJson() const {
...
QJsonObject OAIAuthorizeNet::asJsonObject() const {
    QJsonObject obj;
    if (m__links.size() > 0) {
...
QList<OAIGatewayAccount__links_inner> OAIAuthorizeNet::getLinks() const {
    return m__links;
}
void OAIAuthorizeNet::setLinks(const QList<OAIGatewayAccount__links_inner> &_links) {
    m__links = _links;
    m__links_isSet = true;
}

bool OAIAuthorizeNet::is__links_Set() const{
    return m__links_isSet;
}

bool OAIAuthorizeNet::is__links_Valid() const{
    return m__links_isValid;
}

QList<QString> OAIAuthorizeNet::getAcceptedCurrencies() const {
    return m_accepted_currencies;
}
void OAIAuthorizeNet::setAcceptedCurrencies(const QList<QString> &accepted_currencies) {
    m_accepted_currencies = accepted_currencies;
    m_accepted_currencies_isSet = true;
}

bool OAIAuthorizeNet::is_accepted_currencies_Set() const{
    return m_accepted_currencies_isSet;
}

bool OAIAuthorizeNet::is_accepted_currencies_Valid() const{
    return m_accepted_currencies_isValid;
}

OAIAcquirerName OAIAuthorizeNet::getAcquirerName() const {
    return m_acquirer_name;
}
void OAIAuthorizeNet::setAcquirerName(const OAIAcquirerName &acquirer_name) {
    m_acquirer_name = acquirer_name;
    m_acquirer_name_isSet = true;
}

bool OAIAuthorizeNet::is_acquirer_name_Set() const{
    return m_acquirer_name_isSet;
}

bool OAIAuthorizeNet::is_acquirer_name_Valid() const{
    return m_acquirer_name_isValid;
}

QString OAIAuthorizeNet::getAdditionalFilters() const {
    return m_additional_filters;
}
void OAIAuthorizeNet::setAdditionalFilters(const QString &additional_filters) {
    m_additional_filters = additional_filters;
    m_additional_filters_isSet = true;
}

bool OAIAuthorizeNet::is_additional_filters_Set() const{
    return m_additional_filters_isSet;
}

bool OAIAuthorizeNet::is_additional_filters_Valid() const{
    return m_additional_filters_isValid;
}

qint32 OAIAuthorizeNet::getApprovalWindowTtl() const {
    return m_approval_window_ttl;
}
void OAIAuthorizeNet::setApprovalWindowTtl(const qint32 &approval_window_ttl) {
    m_approval_window_ttl = approval_window_ttl;
    m_approval_window_ttl_isSet = true;
}

bool OAIAuthorizeNet::is_approval_window_ttl_Set() const{
    return m_approval_window_ttl_isSet;
}

bool OAIAuthorizeNet::is_approval_window_ttl_Valid() const{
    return m_approval_window_ttl_isValid;
}

QString OAIAuthorizeNet::getCityField() const {
    return m_city_field;
}
void OAIAuthorizeNet::setCityField(const QString &city_field) {
    m_city_field = city_field;
    m_city_field_isSet = true;
}

bool OAIAuthorizeNet::is_city_field_Set() const{
    return m_city_field_isSet;
}

bool OAIAuthorizeNet::is_city_field_Valid() const{
    return m_city_field_isValid;
}

QDateTime OAIAuthorizeNet::getCreatedTime() const {
    return m_created_time;
}
void OAIAuthorizeNet::setCreatedTime(const QDateTime &created_time) {
    m_created_time = created_time;
    m_created_time_isSet = true;
}

bool OAIAuthorizeNet::is_created_time_Set() const{
    return m_created_time_isSet;
}

bool OAIAuthorizeNet::is_created_time_Valid() const{
    return m_created_time_isValid;
}

QString OAIAuthorizeNet::getDccForceCurrency() const {
    return m_dcc_force_currency;
}
void OAIAuthorizeNet::setDccForceCurrency(const QString &dcc_force_currency) {
    m_dcc_force_currency = dcc_force_currency;
    m_dcc_force_currency_isSet = true;
}

bool OAIAuthorizeNet::is_dcc_force_currency_Set() const{
    return m_dcc_force_currency_isSet;
}

bool OAIAuthorizeNet::is_dcc_force_currency_Valid() const{
    return m_dcc_force_currency_isValid;
}

qint32 OAIAuthorizeNet::getDccMarkup() const {
    return m_dcc_markup;
}
void OAIAuthorizeNet::setDccMarkup(const qint32 &dcc_markup) {
    m_dcc_markup = dcc_markup;
    m_dcc_markup_isSet = true;
}

bool OAIAuthorizeNet::is_dcc_markup_Set() const{
    return m_dcc_markup_isSet;
}

bool OAIAuthorizeNet::is_dcc_markup_Valid() const{
    return m_dcc_markup_isValid;
}

QString OAIAuthorizeNet::getDescriptor() const {
    return m_descriptor;
}
void OAIAuthorizeNet::setDescriptor(const QString &descriptor) {
    m_descriptor = descriptor;
    m_descriptor_isSet = true;
}

bool OAIAuthorizeNet::is_descriptor_Set() const{
    return m_descriptor_isSet;
}

bool OAIAuthorizeNet::is_descriptor_Valid() const{
    return m_descriptor_isValid;
}

OAIDigitalWallets OAIAuthorizeNet::getDigitalWallets() const {
    return m_digital_wallets;
}
void OAIAuthorizeNet::setDigitalWallets(const OAIDigitalWallets &digital_wallets) {
    m_digital_wallets = digital_wallets;
    m_digital_wallets_isSet = true;
}

bool OAIAuthorizeNet::is_digital_wallets_Set() const{
    return m_digital_wallets_isSet;
}

bool OAIAuthorizeNet::is_digital_wallets_Valid() const{
    return m_digital_wallets_isValid;
}

bool OAIAuthorizeNet::isDynamicDescriptor() const {
    return m_dynamic_descriptor;
}
void OAIAuthorizeNet::setDynamicDescriptor(const bool &dynamic_descriptor) {
    m_dynamic_descriptor = dynamic_descriptor;
    m_dynamic_descriptor_isSet = true;
}

bool OAIAuthorizeNet::is_dynamic_descriptor_Set() const{
    return m_dynamic_descriptor_isSet;
}

bool OAIAuthorizeNet::is_dynamic_descriptor_Valid() const{
    return m_dynamic_descriptor_isValid;
}

QList<QString> OAIAuthorizeNet::getExcludedDccQuoteCurrencies() const {
    return m_excluded_dcc_quote_currencies;
}
void OAIAuthorizeNet::setExcludedDccQuoteCurrencies(const QList<QString> &excluded_dcc_quote_currencies) {
    m_excluded_dcc_quote_currencies = excluded_dcc_quote_currencies;
    m_excluded_dcc_quote_currencies_isSet = true;
}

bool OAIAuthorizeNet::is_excluded_dcc_quote_currencies_Set() const{
    return m_excluded_dcc_quote_currencies_isSet;
}

bool OAIAuthorizeNet::is_excluded_dcc_quote_currencies_Valid() const{
    return m_excluded_dcc_quote_currencies_isValid;
}

OAIGatewayName OAIAuthorizeNet::getGatewayName() const {
    return m_gateway_name;
}
void OAIAuthorizeNet::setGatewayName(const OAIGatewayName &gateway_name) {
    m_gateway_name = gateway_name;
    m_gateway_name_isSet = true;
}

bool OAIAuthorizeNet::is_gateway_name_Set() const{
    return m_gateway_name_isSet;
}

bool OAIAuthorizeNet::is_gateway_name_Valid() const{
    return m_gateway_name_isValid;
}

QString OAIAuthorizeNet::getId() const {
    return m_id;
}
void OAIAuthorizeNet::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIAuthorizeNet::is_id_Set() const{
    return m_id_isSet;
}

bool OAIAuthorizeNet::is_id_Valid() const{
    return m_id_isValid;
}

bool OAIAuthorizeNet::isIsDown() const {
    return m_is_down;
}
void OAIAuthorizeNet::setIsDown(const bool &is_down) {
    m_is_down = is_down;
    m_is_down_isSet = true;
}

bool OAIAuthorizeNet::is_is_down_Set() const{
    return m_is_down_isSet;
}

bool OAIAuthorizeNet::is_is_down_Valid() const{
    return m_is_down_isValid;
}

QString OAIAuthorizeNet::getMerchantCategoryCode() const {
    return m_merchant_category_code;
}
void OAIAuthorizeNet::setMerchantCategoryCode(const QString &merchant_category_code) {
    m_merchant_category_code = merchant_category_code;
    m_merchant_category_code_isSet = true;
}

bool OAIAuthorizeNet::is_merchant_category_code_Set() const{
    return m_merchant_category_code_isSet;
}

bool OAIAuthorizeNet::is_merchant_category_code_Valid() const{
    return m_merchant_category_code_isValid;
}

OAIPaymentMethod OAIAuthorizeNet::getMethod() const {
    return m_method;
}
void OAIAuthorizeNet::setMethod(const OAIPaymentMethod &method) {
    m_method = method;
    m_method_isSet = true;
}

bool OAIAuthorizeNet::is_method_Set() const{
    return m_method_isSet;
}

bool OAIAuthorizeNet::is_method_Valid() const{
    return m_method_isValid;
}

double OAIAuthorizeNet::getMonthlyLimit() const {
    return m_monthly_limit;
}
void OAIAuthorizeNet::setMonthlyLimit(const double &monthly_limit) {
    m_monthly_limit = monthly_limit;
    m_monthly_limit_isSet = true;
}

bool OAIAuthorizeNet::is_monthly_limit_Set() const{
    return m_monthly_limit_isSet;
}

bool OAIAuthorizeNet::is_monthly_limit_Valid() const{
    return m_monthly_limit_isValid;
}

QString OAIAuthorizeNet::getOrganizationId() const {
    return m_organization_id;
}
void OAIAuthorizeNet::setOrganizationId(const QString &organization_id) {
    m_organization_id = organization_id;
    m_organization_id_isSet = true;
}

bool OAIAuthorizeNet::is_organization_id_Set() const{
    return m_organization_id_isSet;
}

bool OAIAuthorizeNet::is_organization_id_Valid() const{
    return m_organization_id_isValid;
}

QList<OAIPaymentCardBrand> OAIAuthorizeNet::getPaymentCardSchemes() const {
    return m_payment_card_schemes;
}
void OAIAuthorizeNet::setPaymentCardSchemes(const QList<OAIPaymentCardBrand> &payment_card_schemes) {
    m_payment_card_schemes = payment_card_schemes;
    m_payment_card_schemes_isSet = true;
}

bool OAIAuthorizeNet::is_payment_card_schemes_Set() const{
    return m_payment_card_schemes_isSet;
}

bool OAIAuthorizeNet::is_payment_card_schemes_Valid() const{
    return m_payment_card_schemes_isValid;
}

bool OAIAuthorizeNet::isReconciliationWindowEnabled() const {
    return m_reconciliation_window_enabled;
}
void OAIAuthorizeNet::setReconciliationWindowEnabled(const bool &reconciliation_window_enabled) {
    m_reconciliation_window_enabled = reconciliation_window_enabled;
    m_reconciliation_window_enabled_isSet = true;
}

bool OAIAuthorizeNet::is_reconciliation_window_enabled_Set() const{
    return m_reconciliation_window_enabled_isSet;
}

bool OAIAuthorizeNet::is_reconciliation_window_enabled_Valid() const{
    return m_reconciliation_window_enabled_isValid;
}

qint32 OAIAuthorizeNet::getReconciliationWindowTtl() const {
    return m_reconciliation_window_ttl;
}
void OAIAuthorizeNet::setReconciliationWindowTtl(const qint32 &reconciliation_window_ttl) {
    m_reconciliation_window_ttl = reconciliation_window_ttl;
    m_reconciliation_window_ttl_isSet = true;
}

bool OAIAuthorizeNet::is_reconciliation_window_ttl_Set() const{
    return m_reconciliation_window_ttl_isSet;
}

bool OAIAuthorizeNet::is_reconciliation_window_ttl_Valid() const{
    return m_reconciliation_window_ttl_isValid;
}

QString OAIAuthorizeNet::getStatus() const {
    return m_status;
}
void OAIAuthorizeNet::setStatus(const QString &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIAuthorizeNet::is_status_Set() const{
    return m_status_isSet;
}

bool OAIAuthorizeNet::is_status_Valid() const{
    return m_status_isValid;
}

bool OAIAuthorizeNet::isSticky() const {
    return m_sticky;
}
void OAIAuthorizeNet::setSticky(const bool &sticky) {
    m_sticky = sticky;
    m_sticky_isSet = true;
}

bool OAIAuthorizeNet::is_sticky_Set() const{
    return m_sticky_isSet;
}

bool OAIAuthorizeNet::is_sticky_Valid() const{
    return m_sticky_isValid;
}

bool OAIAuthorizeNet::isThreeDSecure() const {
    return m_three_d_secure;
}
void OAIAuthorizeNet::setThreeDSecure(const bool &three_d_secure) {
    m_three_d_secure = three_d_secure;
    m_three_d_secure_isSet = true;
}

bool OAIAuthorizeNet::is_three_d_secure_Set() const{
    return m_three_d_secure_isSet;
}

bool OAIAuthorizeNet::is_three_d_secure_Valid() const{
    return m_three_d_secure_isValid;
}

qint32 OAIAuthorizeNet::getTimeout() const {
    return m_timeout;
}
void OAIAuthorizeNet::setTimeout(const qint32 &timeout) {
    m_timeout = timeout;
    m_timeout_isSet = true;
}

bool OAIAuthorizeNet::is_timeout_Set() const{
    return m_timeout_isSet;
}

bool OAIAuthorizeNet::is_timeout_Valid() const{
    return m_timeout_isValid;
}

QString OAIAuthorizeNet::getToken() const {
    return m_token;
}
void OAIAuthorizeNet::setToken(const QString &token) {
    m_token = token;
    m_token_isSet = true;
}

bool OAIAuthorizeNet::is_token_Set() const{
    return m_token_isSet;
}

bool OAIAuthorizeNet::is_token_Valid() const{
    return m_token_isValid;
}

QDateTime OAIAuthorizeNet::getUpdatedTime() const {
    return m_updated_time;
}
void OAIAuthorizeNet::setUpdatedTime(const QDateTime &updated_time) {
    m_updated_time = updated_time;
    m_updated_time_isSet = true;
}

bool OAIAuthorizeNet::is_updated_time_Set() const{
    return m_updated_time_isSet;
}

bool OAIAuthorizeNet::is_updated_time_Valid() const{
    return m_updated_time_isValid;
}

OAIAuthorizeNet_allOf_credentials OAIAuthorizeNet::getCredentials() const {
    return m_credentials;
}
void OAIAuthorizeNet::setCredentials(const OAIAuthorizeNet_allOf_credentials &credentials) {
    m_credentials = credentials;
    m_credentials_isSet = true;
}

bool OAIAuthorizeNet::is_credentials_Set() const{
    return m_credentials_isSet;
}

bool OAIAuthorizeNet::is_credentials_Valid() const{
    return m_credentials_isValid;
}

bool OAIAuthorizeNet::isSet() const {
...
bool OAIAuthorizeNet::isValid() const {
