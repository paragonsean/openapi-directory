...
class OAIEMS_allOf_credentials;
class OAIEMS_allOf_settings;
class OAIEMS3dsServers;

class OAIEMS : public OAIObject {
public:
    OAIEMS();
    OAIEMS(QString json);
    ~OAIEMS() override;
    ...
    OAIEMS_allOf_credentials getCredentials() const;
    void setCredentials(const OAIEMS_allOf_credentials &credentials);
    bool is_credentials_Set() const;
    bool is_credentials_Valid() const;

    OAIEMS_allOf_settings getSettings() const;
    void setSettings(const OAIEMS_allOf_settings &settings);
    bool is_settings_Set() const;
    bool is_settings_Valid() const;

    OAIEMS3dsServers getThreeDSecureServer() const;
    void setThreeDSecureServer(const OAIEMS3dsServers &three_d_secure_server);
...
private:
    ...
    OAIEMS_allOf_credentials m_credentials;
    bool m_credentials_isSet;
    bool m_credentials_isValid;

    OAIEMS_allOf_settings m_settings;
    bool m_settings_isSet;
    bool m_settings_isValid;

    OAIEMS3dsServers m_three_d_secure_server;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEMS)
