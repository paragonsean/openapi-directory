...
#include "OAIRPN_allOf_credentials.h"
#include <QDateTime>
#include <QList>
#include <QString>
...
class OAIRPN_allOf_credentials;

class OAIRPN : public OAIObject {
public:
    OAIRPN();
    OAIRPN(QString json);
    ~OAIRPN() override;
    ...
    OAIRPN_allOf_credentials getCredentials() const;
    void setCredentials(const OAIRPN_allOf_credentials &credentials);
...
private:
    ...
    OAIRPN_allOf_credentials m_credentials;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRPN)
