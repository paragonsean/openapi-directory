...
OAIInvoiceIssue::OAIInvoiceIssue(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIInvoiceIssue::OAIInvoiceIssue() {
    this->initializeModel();
}

OAIInvoiceIssue::~OAIInvoiceIssue() {}

void OAIInvoiceIssue::initializeModel() {
...
void OAIInvoiceIssue::fromJson(QString jsonString) {
...
void OAIInvoiceIssue::fromJsonObject(QJsonObject json) {
...
QString OAIInvoiceIssue::asJson() const {
...
QJsonObject OAIInvoiceIssue::asJsonObject() const {
    QJsonObject obj;
    if (m_due_time_isSet) {
...
QDateTime OAIInvoiceIssue::getDueTime() const {
    return m_due_time;
}
void OAIInvoiceIssue::setDueTime(const QDateTime &due_time) {
    m_due_time = due_time;
    m_due_time_isSet = true;
}

bool OAIInvoiceIssue::is_due_time_Set() const{
    return m_due_time_isSet;
}

bool OAIInvoiceIssue::is_due_time_Valid() const{
    return m_due_time_isValid;
}

QDateTime OAIInvoiceIssue::getIssuedTime() const {
    return m_issued_time;
}
void OAIInvoiceIssue::setIssuedTime(const QDateTime &issued_time) {
    m_issued_time = issued_time;
    m_issued_time_isSet = true;
}

bool OAIInvoiceIssue::is_issued_time_Set() const{
    return m_issued_time_isSet;
}

bool OAIInvoiceIssue::is_issued_time_Valid() const{
    return m_issued_time_isValid;
}

bool OAIInvoiceIssue::isSet() const {
...
bool OAIInvoiceIssue::isValid() const {
