...
#ifndef OAICCAvenue_H
#define OAICCAvenue_H

#include <QJsonObject>

#include "OAIAcquirerName.h"
#include "OAICCAvenue_allOf_credentials.h"
...
class OAICCAvenue_allOf_credentials;

class OAICCAvenue : public OAIObject {
public:
    OAICCAvenue();
    OAICCAvenue(QString json);
    ~OAICCAvenue() override;
    ...
    OAICCAvenue_allOf_credentials getCredentials() const;
    void setCredentials(const OAICCAvenue_allOf_credentials &credentials);
...
private:
    ...
    OAICCAvenue_allOf_credentials m_credentials;
...
Q_DECLARE_METATYPE(OpenAPI::OAICCAvenue)
