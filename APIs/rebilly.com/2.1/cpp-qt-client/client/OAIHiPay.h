...
#include "OAIHiPay_allOf_credentials.h"
...
class OAIHiPay_allOf_credentials;

class OAIHiPay : public OAIObject {
public:
    OAIHiPay();
    OAIHiPay(QString json);
    ~OAIHiPay() override;
    ...
    OAIHiPay_allOf_credentials getCredentials() const;
    void setCredentials(const OAIHiPay_allOf_credentials &credentials);
...
private:
    ...
    OAIHiPay_allOf_credentials m_credentials;
...
Q_DECLARE_METATYPE(OpenAPI::OAIHiPay)
