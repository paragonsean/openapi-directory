...
/*
 * OAIPaymenTechnologies.h
 *
 * PaymenTechnologies Gateway config.
 */

#ifndef OAIPaymenTechnologies_H
#define OAIPaymenTechnologies_H
...
class OAIPaymenTechnologies_allOf_credentials;
class OAIPaymenTechnologies_allOf_settings;

class OAIPaymenTechnologies : public OAIObject {
public:
    OAIPaymenTechnologies();
    OAIPaymenTechnologies(QString json);
    ~OAIPaymenTechnologies() override;
    ...
    OAIPaymenTechnologies_allOf_credentials getCredentials() const;
    void setCredentials(const OAIPaymenTechnologies_allOf_credentials &credentials);
    bool is_credentials_Set() const;
    bool is_credentials_Valid() const;

    OAIPaymenTechnologies_allOf_settings getSettings() const;
    void setSettings(const OAIPaymenTechnologies_allOf_settings &settings);
...
private:
    ...
    OAIPaymenTechnologies_allOf_credentials m_credentials;
    bool m_credentials_isSet;
    bool m_credentials_isValid;

    OAIPaymenTechnologies_allOf_settings m_settings;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPaymenTechnologies)

#endif // OAIPaymenTechnologies_H
