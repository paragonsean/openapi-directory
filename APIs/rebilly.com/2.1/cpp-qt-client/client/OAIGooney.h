...
class OAIGooney_allOf_credentials;

class OAIGooney : public OAIObject {
public:
    OAIGooney();
    OAIGooney(QString json);
    ~OAIGooney() override;
    ...
    OAIGooney_allOf_credentials getCredentials() const;
    void setCredentials(const OAIGooney_allOf_credentials &credentials);
...
private:
    ...
    OAIGooney_allOf_credentials m_credentials;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGooney)
