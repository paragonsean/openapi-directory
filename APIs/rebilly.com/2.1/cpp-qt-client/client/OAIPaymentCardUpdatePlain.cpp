...
OAIPaymentCardUpdatePlain::OAIPaymentCardUpdatePlain(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPaymentCardUpdatePlain::OAIPaymentCardUpdatePlain() {
    this->initializeModel();
}

OAIPaymentCardUpdatePlain::~OAIPaymentCardUpdatePlain() {}

void OAIPaymentCardUpdatePlain::initializeModel() {
...
void OAIPaymentCardUpdatePlain::fromJson(QString jsonString) {
...
void OAIPaymentCardUpdatePlain::fromJsonObject(QJsonObject json) {
...
QString OAIPaymentCardUpdatePlain::asJson() const {
...
QJsonObject OAIPaymentCardUpdatePlain::asJsonObject() const {
    QJsonObject obj;
...
OAIContactObject OAIPaymentCardUpdatePlain::getBillingAddress() const {
    return m_billing_address;
}
void OAIPaymentCardUpdatePlain::setBillingAddress(const OAIContactObject &billing_address) {
    m_billing_address = billing_address;
    m_billing_address_isSet = true;
}

bool OAIPaymentCardUpdatePlain::is_billing_address_Set() const{
    return m_billing_address_isSet;
}

bool OAIPaymentCardUpdatePlain::is_billing_address_Valid() const{
    return m_billing_address_isValid;
}

OAIObject OAIPaymentCardUpdatePlain::getCustomFields() const {
    return m_custom_fields;
}
void OAIPaymentCardUpdatePlain::setCustomFields(const OAIObject &custom_fields) {
    m_custom_fields = custom_fields;
    m_custom_fields_isSet = true;
}

bool OAIPaymentCardUpdatePlain::is_custom_fields_Set() const{
    return m_custom_fields_isSet;
}

bool OAIPaymentCardUpdatePlain::is_custom_fields_Valid() const{
    return m_custom_fields_isValid;
}

QString OAIPaymentCardUpdatePlain::getCvv() const {
    return m_cvv;
}
void OAIPaymentCardUpdatePlain::setCvv(const QString &cvv) {
    m_cvv = cvv;
    m_cvv_isSet = true;
}

bool OAIPaymentCardUpdatePlain::is_cvv_Set() const{
    return m_cvv_isSet;
}

bool OAIPaymentCardUpdatePlain::is_cvv_Valid() const{
    return m_cvv_isValid;
}

qint32 OAIPaymentCardUpdatePlain::getExpMonth() const {
    return m_exp_month;
}
void OAIPaymentCardUpdatePlain::setExpMonth(const qint32 &exp_month) {
    m_exp_month = exp_month;
    m_exp_month_isSet = true;
}

bool OAIPaymentCardUpdatePlain::is_exp_month_Set() const{
    return m_exp_month_isSet;
}

bool OAIPaymentCardUpdatePlain::is_exp_month_Valid() const{
    return m_exp_month_isValid;
}

qint32 OAIPaymentCardUpdatePlain::getExpYear() const {
    return m_exp_year;
}
void OAIPaymentCardUpdatePlain::setExpYear(const qint32 &exp_year) {
    m_exp_year = exp_year;
    m_exp_year_isSet = true;
}

bool OAIPaymentCardUpdatePlain::is_exp_year_Set() const{
    return m_exp_year_isSet;
}

bool OAIPaymentCardUpdatePlain::is_exp_year_Valid() const{
    return m_exp_year_isValid;
}

QString OAIPaymentCardUpdatePlain::getStickyGatewayAccountId() const {
    return m_sticky_gateway_account_id;
}
void OAIPaymentCardUpdatePlain::setStickyGatewayAccountId(const QString &sticky_gateway_account_id) {
    m_sticky_gateway_account_id = sticky_gateway_account_id;
    m_sticky_gateway_account_id_isSet = true;
}

bool OAIPaymentCardUpdatePlain::is_sticky_gateway_account_id_Set() const{
    return m_sticky_gateway_account_id_isSet;
}

bool OAIPaymentCardUpdatePlain::is_sticky_gateway_account_id_Valid() const{
    return m_sticky_gateway_account_id_isValid;
}

bool OAIPaymentCardUpdatePlain::isSet() const {
...
bool OAIPaymentCardUpdatePlain::isValid() const {
