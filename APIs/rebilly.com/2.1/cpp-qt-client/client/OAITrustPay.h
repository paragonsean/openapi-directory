...
#ifndef OAITrustPay_H
#define OAITrustPay_H
...
#include "OAITrustPay_allOf_credentials.h"
#include <QDateTime>
#include <QList>
#include <QString>
...
class OAITrustPay_allOf_credentials;

class OAITrustPay : public OAIObject {
public:
    OAITrustPay();
    OAITrustPay(QString json);
    ~OAITrustPay() override;
    ...
    OAITrustPay_allOf_credentials getCredentials() const;
    void setCredentials(const OAITrustPay_allOf_credentials &credentials);
...
private:
    ...
    OAITrustPay_allOf_credentials m_credentials;
...
Q_DECLARE_METATYPE(OpenAPI::OAITrustPay)
