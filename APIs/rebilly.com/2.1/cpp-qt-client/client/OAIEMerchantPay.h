...
#ifndef OAIEMerchantPay_H
#define OAIEMerchantPay_H
...
#include "OAIEMerchantPay_allOf_settings.h"
...
class OAIEMerchantPay_allOf_credentials;
class OAIEMerchantPay_allOf_settings;
class OAIEMerchantPay3dsServers;

class OAIEMerchantPay : public OAIObject {
public:
    OAIEMerchantPay();
    OAIEMerchantPay(QString json);
    ~OAIEMerchantPay() override;
    ...
    OAIEMerchantPay_allOf_credentials getCredentials() const;
    void setCredentials(const OAIEMerchantPay_allOf_credentials &credentials);
    bool is_credentials_Set() const;
    bool is_credentials_Valid() const;

    OAIEMerchantPay_allOf_settings getSettings() const;
    void setSettings(const OAIEMerchantPay_allOf_settings &settings);
    bool is_settings_Set() const;
    bool is_settings_Valid() const;

    OAIEMerchantPay3dsServers getThreeDSecureServer() const;
    void setThreeDSecureServer(const OAIEMerchantPay3dsServers &three_d_secure_server);
...
private:
    ...
    OAIEMerchantPay_allOf_credentials m_credentials;
    bool m_credentials_isSet;
    bool m_credentials_isValid;

    OAIEMerchantPay_allOf_settings m_settings;
    bool m_settings_isSet;
    bool m_settings_isValid;

    OAIEMerchantPay3dsServers m_three_d_secure_server;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEMerchantPay)

#endif // OAIEMerchantPay_H
