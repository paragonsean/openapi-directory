...
#ifndef OAICardknox_H
#define OAICardknox_H
...
class OAICardknox_allOf_credentials;

class OAICardknox : public OAIObject {
public:
    OAICardknox();
    OAICardknox(QString json);
    ~OAICardknox() override;
    ...
    OAICardknox_allOf_credentials getCredentials() const;
    void setCredentials(const OAICardknox_allOf_credentials &credentials);
...
private:
    ...
    OAICardknox_allOf_credentials m_credentials;
...
Q_DECLARE_METATYPE(OpenAPI::OAICardknox)
