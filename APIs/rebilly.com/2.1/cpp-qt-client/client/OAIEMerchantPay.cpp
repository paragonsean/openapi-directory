...
OAIEMerchantPay::OAIEMerchantPay(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIEMerchantPay::OAIEMerchantPay() {
    this->initializeModel();
}

OAIEMerchantPay::~OAIEMerchantPay() {}

void OAIEMerchantPay::initializeModel() {
...
void OAIEMerchantPay::fromJson(QString jsonString) {
...
void OAIEMerchantPay::fromJsonObject(QJsonObject json) {
...
QString OAIEMerchantPay::asJson() const {
...
QJsonObject OAIEMerchantPay::asJsonObject() const {
    QJsonObject obj;
    if (m__links.size() > 0) {
...
QList<OAIGatewayAccount__links_inner> OAIEMerchantPay::getLinks() const {
    return m__links;
}
void OAIEMerchantPay::setLinks(const QList<OAIGatewayAccount__links_inner> &_links) {
    m__links = _links;
    m__links_isSet = true;
}

bool OAIEMerchantPay::is__links_Set() const{
    return m__links_isSet;
}

bool OAIEMerchantPay::is__links_Valid() const{
    return m__links_isValid;
}

QList<QString> OAIEMerchantPay::getAcceptedCurrencies() const {
    return m_accepted_currencies;
}
void OAIEMerchantPay::setAcceptedCurrencies(const QList<QString> &accepted_currencies) {
    m_accepted_currencies = accepted_currencies;
    m_accepted_currencies_isSet = true;
}

bool OAIEMerchantPay::is_accepted_currencies_Set() const{
    return m_accepted_currencies_isSet;
}

bool OAIEMerchantPay::is_accepted_currencies_Valid() const{
    return m_accepted_currencies_isValid;
}

OAIAcquirerName OAIEMerchantPay::getAcquirerName() const {
    return m_acquirer_name;
}
void OAIEMerchantPay::setAcquirerName(const OAIAcquirerName &acquirer_name) {
    m_acquirer_name = acquirer_name;
    m_acquirer_name_isSet = true;
}

bool OAIEMerchantPay::is_acquirer_name_Set() const{
    return m_acquirer_name_isSet;
}

bool OAIEMerchantPay::is_acquirer_name_Valid() const{
    return m_acquirer_name_isValid;
}

QString OAIEMerchantPay::getAdditionalFilters() const {
    return m_additional_filters;
}
void OAIEMerchantPay::setAdditionalFilters(const QString &additional_filters) {
    m_additional_filters = additional_filters;
    m_additional_filters_isSet = true;
}

bool OAIEMerchantPay::is_additional_filters_Set() const{
    return m_additional_filters_isSet;
}

bool OAIEMerchantPay::is_additional_filters_Valid() const{
    return m_additional_filters_isValid;
}

qint32 OAIEMerchantPay::getApprovalWindowTtl() const {
    return m_approval_window_ttl;
}
void OAIEMerchantPay::setApprovalWindowTtl(const qint32 &approval_window_ttl) {
    m_approval_window_ttl = approval_window_ttl;
    m_approval_window_ttl_isSet = true;
}

bool OAIEMerchantPay::is_approval_window_ttl_Set() const{
    return m_approval_window_ttl_isSet;
}

bool OAIEMerchantPay::is_approval_window_ttl_Valid() const{
    return m_approval_window_ttl_isValid;
}

QString OAIEMerchantPay::getCityField() const {
    return m_city_field;
}
void OAIEMerchantPay::setCityField(const QString &city_field) {
    m_city_field = city_field;
    m_city_field_isSet = true;
}

bool OAIEMerchantPay::is_city_field_Set() const{
    return m_city_field_isSet;
}

bool OAIEMerchantPay::is_city_field_Valid() const{
    return m_city_field_isValid;
}

QDateTime OAIEMerchantPay::getCreatedTime() const {
    return m_created_time;
}
void OAIEMerchantPay::setCreatedTime(const QDateTime &created_time) {
    m_created_time = created_time;
    m_created_time_isSet = true;
}

bool OAIEMerchantPay::is_created_time_Set() const{
    return m_created_time_isSet;
}

bool OAIEMerchantPay::is_created_time_Valid() const{
    return m_created_time_isValid;
}

QString OAIEMerchantPay::getDccForceCurrency() const {
    return m_dcc_force_currency;
}
void OAIEMerchantPay::setDccForceCurrency(const QString &dcc_force_currency) {
    m_dcc_force_currency = dcc_force_currency;
    m_dcc_force_currency_isSet = true;
}

bool OAIEMerchantPay::is_dcc_force_currency_Set() const{
    return m_dcc_force_currency_isSet;
}

bool OAIEMerchantPay::is_dcc_force_currency_Valid() const{
    return m_dcc_force_currency_isValid;
}

qint32 OAIEMerchantPay::getDccMarkup() const {
    return m_dcc_markup;
}
void OAIEMerchantPay::setDccMarkup(const qint32 &dcc_markup) {
    m_dcc_markup = dcc_markup;
    m_dcc_markup_isSet = true;
}

bool OAIEMerchantPay::is_dcc_markup_Set() const{
    return m_dcc_markup_isSet;
}

bool OAIEMerchantPay::is_dcc_markup_Valid() const{
    return m_dcc_markup_isValid;
}

QString OAIEMerchantPay::getDescriptor() const {
    return m_descriptor;
}
void OAIEMerchantPay::setDescriptor(const QString &descriptor) {
    m_descriptor = descriptor;
    m_descriptor_isSet = true;
}

bool OAIEMerchantPay::is_descriptor_Set() const{
    return m_descriptor_isSet;
}

bool OAIEMerchantPay::is_descriptor_Valid() const{
    return m_descriptor_isValid;
}

OAIDigitalWallets OAIEMerchantPay::getDigitalWallets() const {
    return m_digital_wallets;
}
void OAIEMerchantPay::setDigitalWallets(const OAIDigitalWallets &digital_wallets) {
    m_digital_wallets = digital_wallets;
    m_digital_wallets_isSet = true;
}

bool OAIEMerchantPay::is_digital_wallets_Set() const{
    return m_digital_wallets_isSet;
}

bool OAIEMerchantPay::is_digital_wallets_Valid() const{
    return m_digital_wallets_isValid;
}

bool OAIEMerchantPay::isDynamicDescriptor() const {
    return m_dynamic_descriptor;
}
void OAIEMerchantPay::setDynamicDescriptor(const bool &dynamic_descriptor) {
    m_dynamic_descriptor = dynamic_descriptor;
    m_dynamic_descriptor_isSet = true;
}

bool OAIEMerchantPay::is_dynamic_descriptor_Set() const{
    return m_dynamic_descriptor_isSet;
}

bool OAIEMerchantPay::is_dynamic_descriptor_Valid() const{
    return m_dynamic_descriptor_isValid;
}

QList<QString> OAIEMerchantPay::getExcludedDccQuoteCurrencies() const {
    return m_excluded_dcc_quote_currencies;
}
void OAIEMerchantPay::setExcludedDccQuoteCurrencies(const QList<QString> &excluded_dcc_quote_currencies) {
    m_excluded_dcc_quote_currencies = excluded_dcc_quote_currencies;
    m_excluded_dcc_quote_currencies_isSet = true;
}

bool OAIEMerchantPay::is_excluded_dcc_quote_currencies_Set() const{
    return m_excluded_dcc_quote_currencies_isSet;
}

bool OAIEMerchantPay::is_excluded_dcc_quote_currencies_Valid() const{
    return m_excluded_dcc_quote_currencies_isValid;
}

OAIGatewayName OAIEMerchantPay::getGatewayName() const {
    return m_gateway_name;
}
void OAIEMerchantPay::setGatewayName(const OAIGatewayName &gateway_name) {
    m_gateway_name = gateway_name;
    m_gateway_name_isSet = true;
}

bool OAIEMerchantPay::is_gateway_name_Set() const{
    return m_gateway_name_isSet;
}

bool OAIEMerchantPay::is_gateway_name_Valid() const{
    return m_gateway_name_isValid;
}

QString OAIEMerchantPay::getId() const {
    return m_id;
}
void OAIEMerchantPay::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIEMerchantPay::is_id_Set() const{
    return m_id_isSet;
}

bool OAIEMerchantPay::is_id_Valid() const{
    return m_id_isValid;
}

bool OAIEMerchantPay::isIsDown() const {
    return m_is_down;
}
void OAIEMerchantPay::setIsDown(const bool &is_down) {
    m_is_down = is_down;
    m_is_down_isSet = true;
}

bool OAIEMerchantPay::is_is_down_Set() const{
    return m_is_down_isSet;
}

bool OAIEMerchantPay::is_is_down_Valid() const{
    return m_is_down_isValid;
}

QString OAIEMerchantPay::getMerchantCategoryCode() const {
    return m_merchant_category_code;
}
void OAIEMerchantPay::setMerchantCategoryCode(const QString &merchant_category_code) {
    m_merchant_category_code = merchant_category_code;
    m_merchant_category_code_isSet = true;
}

bool OAIEMerchantPay::is_merchant_category_code_Set() const{
    return m_merchant_category_code_isSet;
}

bool OAIEMerchantPay::is_merchant_category_code_Valid() const{
    return m_merchant_category_code_isValid;
}

OAIPaymentMethod OAIEMerchantPay::getMethod() const {
    return m_method;
}
void OAIEMerchantPay::setMethod(const OAIPaymentMethod &method) {
    m_method = method;
    m_method_isSet = true;
}

bool OAIEMerchantPay::is_method_Set() const{
    return m_method_isSet;
}

bool OAIEMerchantPay::is_method_Valid() const{
    return m_method_isValid;
}

double OAIEMerchantPay::getMonthlyLimit() const {
    return m_monthly_limit;
}
void OAIEMerchantPay::setMonthlyLimit(const double &monthly_limit) {
    m_monthly_limit = monthly_limit;
    m_monthly_limit_isSet = true;
}

bool OAIEMerchantPay::is_monthly_limit_Set() const{
    return m_monthly_limit_isSet;
}

bool OAIEMerchantPay::is_monthly_limit_Valid() const{
    return m_monthly_limit_isValid;
}

QString OAIEMerchantPay::getOrganizationId() const {
    return m_organization_id;
}
void OAIEMerchantPay::setOrganizationId(const QString &organization_id) {
    m_organization_id = organization_id;
    m_organization_id_isSet = true;
}

bool OAIEMerchantPay::is_organization_id_Set() const{
    return m_organization_id_isSet;
}

bool OAIEMerchantPay::is_organization_id_Valid() const{
    return m_organization_id_isValid;
}

QList<OAIPaymentCardBrand> OAIEMerchantPay::getPaymentCardSchemes() const {
    return m_payment_card_schemes;
}
void OAIEMerchantPay::setPaymentCardSchemes(const QList<OAIPaymentCardBrand> &payment_card_schemes) {
    m_payment_card_schemes = payment_card_schemes;
    m_payment_card_schemes_isSet = true;
}

bool OAIEMerchantPay::is_payment_card_schemes_Set() const{
    return m_payment_card_schemes_isSet;
}

bool OAIEMerchantPay::is_payment_card_schemes_Valid() const{
    return m_payment_card_schemes_isValid;
}

bool OAIEMerchantPay::isReconciliationWindowEnabled() const {
    return m_reconciliation_window_enabled;
}
void OAIEMerchantPay::setReconciliationWindowEnabled(const bool &reconciliation_window_enabled) {
    m_reconciliation_window_enabled = reconciliation_window_enabled;
    m_reconciliation_window_enabled_isSet = true;
}

bool OAIEMerchantPay::is_reconciliation_window_enabled_Set() const{
    return m_reconciliation_window_enabled_isSet;
}

bool OAIEMerchantPay::is_reconciliation_window_enabled_Valid() const{
    return m_reconciliation_window_enabled_isValid;
}

qint32 OAIEMerchantPay::getReconciliationWindowTtl() const {
    return m_reconciliation_window_ttl;
}
void OAIEMerchantPay::setReconciliationWindowTtl(const qint32 &reconciliation_window_ttl) {
    m_reconciliation_window_ttl = reconciliation_window_ttl;
    m_reconciliation_window_ttl_isSet = true;
}

bool OAIEMerchantPay::is_reconciliation_window_ttl_Set() const{
    return m_reconciliation_window_ttl_isSet;
}

bool OAIEMerchantPay::is_reconciliation_window_ttl_Valid() const{
    return m_reconciliation_window_ttl_isValid;
}

QString OAIEMerchantPay::getStatus() const {
    return m_status;
}
void OAIEMerchantPay::setStatus(const QString &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIEMerchantPay::is_status_Set() const{
    return m_status_isSet;
}

bool OAIEMerchantPay::is_status_Valid() const{
    return m_status_isValid;
}

bool OAIEMerchantPay::isSticky() const {
    return m_sticky;
}
void OAIEMerchantPay::setSticky(const bool &sticky) {
    m_sticky = sticky;
    m_sticky_isSet = true;
}

bool OAIEMerchantPay::is_sticky_Set() const{
    return m_sticky_isSet;
}

bool OAIEMerchantPay::is_sticky_Valid() const{
    return m_sticky_isValid;
}

bool OAIEMerchantPay::isThreeDSecure() const {
    return m_three_d_secure;
}
void OAIEMerchantPay::setThreeDSecure(const bool &three_d_secure) {
    m_three_d_secure = three_d_secure;
    m_three_d_secure_isSet = true;
}

bool OAIEMerchantPay::is_three_d_secure_Set() const{
    return m_three_d_secure_isSet;
}

bool OAIEMerchantPay::is_three_d_secure_Valid() const{
    return m_three_d_secure_isValid;
}

qint32 OAIEMerchantPay::getTimeout() const {
    return m_timeout;
}
void OAIEMerchantPay::setTimeout(const qint32 &timeout) {
    m_timeout = timeout;
    m_timeout_isSet = true;
}

bool OAIEMerchantPay::is_timeout_Set() const{
    return m_timeout_isSet;
}

bool OAIEMerchantPay::is_timeout_Valid() const{
    return m_timeout_isValid;
}

QString OAIEMerchantPay::getToken() const {
    return m_token;
}
void OAIEMerchantPay::setToken(const QString &token) {
    m_token = token;
    m_token_isSet = true;
}

bool OAIEMerchantPay::is_token_Set() const{
    return m_token_isSet;
}

bool OAIEMerchantPay::is_token_Valid() const{
    return m_token_isValid;
}

QDateTime OAIEMerchantPay::getUpdatedTime() const {
    return m_updated_time;
}
void OAIEMerchantPay::setUpdatedTime(const QDateTime &updated_time) {
    m_updated_time = updated_time;
    m_updated_time_isSet = true;
}

bool OAIEMerchantPay::is_updated_time_Set() const{
    return m_updated_time_isSet;
}

bool OAIEMerchantPay::is_updated_time_Valid() const{
    return m_updated_time_isValid;
}

OAIEMerchantPay_allOf_credentials OAIEMerchantPay::getCredentials() const {
    return m_credentials;
}
void OAIEMerchantPay::setCredentials(const OAIEMerchantPay_allOf_credentials &credentials) {
    m_credentials = credentials;
    m_credentials_isSet = true;
}

bool OAIEMerchantPay::is_credentials_Set() const{
    return m_credentials_isSet;
}

bool OAIEMerchantPay::is_credentials_Valid() const{
    return m_credentials_isValid;
}

OAIEMerchantPay_allOf_settings OAIEMerchantPay::getSettings() const {
    return m_settings;
}
void OAIEMerchantPay::setSettings(const OAIEMerchantPay_allOf_settings &settings) {
    m_settings = settings;
    m_settings_isSet = true;
}

bool OAIEMerchantPay::is_settings_Set() const{
    return m_settings_isSet;
}

bool OAIEMerchantPay::is_settings_Valid() const{
    return m_settings_isValid;
}

OAIEMerchantPay3dsServers OAIEMerchantPay::getThreeDSecureServer() const {
    return m_three_d_secure_server;
}
void OAIEMerchantPay::setThreeDSecureServer(const OAIEMerchantPay3dsServers &three_d_secure_server) {
    m_three_d_secure_server = three_d_secure_server;
    m_three_d_secure_server_isSet = true;
}

bool OAIEMerchantPay::is_three_d_secure_server_Set() const{
    return m_three_d_secure_server_isSet;
}

bool OAIEMerchantPay::is_three_d_secure_server_Valid() const{
    return m_three_d_secure_server_isValid;
}

bool OAIEMerchantPay::isSet() const {
...
bool OAIEMerchantPay::isValid() const {
