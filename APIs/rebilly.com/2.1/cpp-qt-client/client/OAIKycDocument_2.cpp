...
OAIKycDocument_2::OAIKycDocument_2(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIKycDocument_2::OAIKycDocument_2() {
    this->initializeModel();
}

OAIKycDocument_2::~OAIKycDocument_2() {}

void OAIKycDocument_2::initializeModel() {
...
void OAIKycDocument_2::fromJson(QString jsonString) {
...
void OAIKycDocument_2::fromJsonObject(QJsonObject json) {
...
QString OAIKycDocument_2::asJson() const {
...
QJsonObject OAIKycDocument_2::asJsonObject() const {
    QJsonObject obj;
    if (m__links.size() > 0) {
...
QList<OAICommonKycDocument__links_inner> OAIKycDocument_2::getLinks() const {
    return m__links;
}
void OAIKycDocument_2::setLinks(const QList<OAICommonKycDocument__links_inner> &_links) {
    m__links = _links;
    m__links_isSet = true;
}

bool OAIKycDocument_2::is__links_Set() const{
    return m__links_isSet;
}

bool OAIKycDocument_2::is__links_Valid() const{
    return m__links_isValid;
}

QDateTime OAIKycDocument_2::getCreatedTime() const {
    return m_created_time;
}
void OAIKycDocument_2::setCreatedTime(const QDateTime &created_time) {
    m_created_time = created_time;
    m_created_time_isSet = true;
}

bool OAIKycDocument_2::is_created_time_Set() const{
    return m_created_time_isSet;
}

bool OAIKycDocument_2::is_created_time_Valid() const{
    return m_created_time_isValid;
}

OAIKycDocumentSubtypes OAIKycDocument_2::getDocumentSubtype() const {
    return m_document_subtype;
}
void OAIKycDocument_2::setDocumentSubtype(const OAIKycDocumentSubtypes &document_subtype) {
    m_document_subtype = document_subtype;
    m_document_subtype_isSet = true;
}

bool OAIKycDocument_2::is_document_subtype_Set() const{
    return m_document_subtype_isSet;
}

bool OAIKycDocument_2::is_document_subtype_Valid() const{
    return m_document_subtype_isValid;
}

OAIKycDocumentTypes OAIKycDocument_2::getDocumentType() const {
    return m_document_type;
}
void OAIKycDocument_2::setDocumentType(const OAIKycDocumentTypes &document_type) {
    m_document_type = document_type;
    m_document_type_isSet = true;
}

bool OAIKycDocument_2::is_document_type_Set() const{
    return m_document_type_isSet;
}

bool OAIKycDocument_2::is_document_type_Valid() const{
    return m_document_type_isValid;
}

QString OAIKycDocument_2::getFileId() const {
    return m_file_id;
}
void OAIKycDocument_2::setFileId(const QString &file_id) {
    m_file_id = file_id;
    m_file_id_isSet = true;
}

bool OAIKycDocument_2::is_file_id_Set() const{
    return m_file_id_isSet;
}

bool OAIKycDocument_2::is_file_id_Valid() const{
    return m_file_id_isValid;
}

QList<QString> OAIKycDocument_2::getFileIds() const {
    return m_file_ids;
}
void OAIKycDocument_2::setFileIds(const QList<QString> &file_ids) {
    m_file_ids = file_ids;
    m_file_ids_isSet = true;
}

bool OAIKycDocument_2::is_file_ids_Set() const{
    return m_file_ids_isSet;
}

bool OAIKycDocument_2::is_file_ids_Valid() const{
    return m_file_ids_isValid;
}

QString OAIKycDocument_2::getId() const {
    return m_id;
}
void OAIKycDocument_2::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIKycDocument_2::is_id_Set() const{
    return m_id_isSet;
}

bool OAIKycDocument_2::is_id_Valid() const{
    return m_id_isValid;
}

QDateTime OAIKycDocument_2::getProcessedTime() const {
    return m_processed_time;
}
void OAIKycDocument_2::setProcessedTime(const QDateTime &processed_time) {
    m_processed_time = processed_time;
    m_processed_time_isSet = true;
}

bool OAIKycDocument_2::is_processed_time_Set() const{
    return m_processed_time_isSet;
}

bool OAIKycDocument_2::is_processed_time_Valid() const{
    return m_processed_time_isValid;
}

OAIKycDocumentRejection OAIKycDocument_2::getRejectionReason() const {
    return m_rejection_reason;
}
void OAIKycDocument_2::setRejectionReason(const OAIKycDocumentRejection &rejection_reason) {
    m_rejection_reason = rejection_reason;
    m_rejection_reason_isSet = true;
}

bool OAIKycDocument_2::is_rejection_reason_Set() const{
    return m_rejection_reason_isSet;
}

bool OAIKycDocument_2::is_rejection_reason_Valid() const{
    return m_rejection_reason_isValid;
}

QString OAIKycDocument_2::getRequestId() const {
    return m_request_id;
}
void OAIKycDocument_2::setRequestId(const QString &request_id) {
    m_request_id = request_id;
    m_request_id_isSet = true;
}

bool OAIKycDocument_2::is_request_id_Set() const{
    return m_request_id_isSet;
}

bool OAIKycDocument_2::is_request_id_Valid() const{
    return m_request_id_isValid;
}

QString OAIKycDocument_2::getStatus() const {
    return m_status;
}
void OAIKycDocument_2::setStatus(const QString &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIKycDocument_2::is_status_Set() const{
    return m_status_isSet;
}

bool OAIKycDocument_2::is_status_Valid() const{
    return m_status_isValid;
}

QDateTime OAIKycDocument_2::getUpdatedTime() const {
    return m_updated_time;
}
void OAIKycDocument_2::setUpdatedTime(const QDateTime &updated_time) {
    m_updated_time = updated_time;
    m_updated_time_isSet = true;
}

bool OAIKycDocument_2::is_updated_time_Set() const{
    return m_updated_time_isSet;
}

bool OAIKycDocument_2::is_updated_time_Valid() const{
    return m_updated_time_isValid;
}

QString OAIKycDocument_2::getCustomerId() const {
    return m_customer_id;
}
void OAIKycDocument_2::setCustomerId(const QString &customer_id) {
    m_customer_id = customer_id;
    m_customer_id_isSet = true;
}

bool OAIKycDocument_2::is_customer_id_Set() const{
    return m_customer_id_isSet;
}

bool OAIKycDocument_2::is_customer_id_Valid() const{
    return m_customer_id_isValid;
}

qint32 OAIKycDocument_2::getMatchLevel() const {
    return m_match_level;
}
void OAIKycDocument_2::setMatchLevel(const qint32 &match_level) {
    m_match_level = match_level;
    m_match_level_isSet = true;
}

bool OAIKycDocument_2::is_match_level_Set() const{
    return m_match_level_isSet;
}

bool OAIKycDocument_2::is_match_level_Valid() const{
    return m_match_level_isValid;
}

QString OAIKycDocument_2::getNotes() const {
    return m_notes;
}
void OAIKycDocument_2::setNotes(const QString &notes) {
    m_notes = notes;
    m_notes_isSet = true;
}

bool OAIKycDocument_2::is_notes_Set() const{
    return m_notes_isSet;
}

bool OAIKycDocument_2::is_notes_Valid() const{
    return m_notes_isValid;
}

QString OAIKycDocument_2::getReason() const {
    return m_reason;
}
void OAIKycDocument_2::setReason(const QString &reason) {
    m_reason = reason;
    m_reason_isSet = true;
}

bool OAIKycDocument_2::is_reason_Set() const{
    return m_reason_isSet;
}

bool OAIKycDocument_2::is_reason_Valid() const{
    return m_reason_isValid;
}

QDateTime OAIKycDocument_2::getReviewTime() const {
    return m_review_time;
}
void OAIKycDocument_2::setReviewTime(const QDateTime &review_time) {
    m_review_time = review_time;
    m_review_time_isSet = true;
}

bool OAIKycDocument_2::is_review_time_Set() const{
    return m_review_time_isSet;
}

bool OAIKycDocument_2::is_review_time_Valid() const{
    return m_review_time_isValid;
}

QString OAIKycDocument_2::getReviewerId() const {
    return m_reviewer_id;
}
void OAIKycDocument_2::setReviewerId(const QString &reviewer_id) {
    m_reviewer_id = reviewer_id;
    m_reviewer_id_isSet = true;
}

bool OAIKycDocument_2::is_reviewer_id_Set() const{
    return m_reviewer_id_isSet;
}

bool OAIKycDocument_2::is_reviewer_id_Valid() const{
    return m_reviewer_id_isValid;
}

QString OAIKycDocument_2::getReviewerName() const {
    return m_reviewer_name;
}
void OAIKycDocument_2::setReviewerName(const QString &reviewer_name) {
    m_reviewer_name = reviewer_name;
    m_reviewer_name_isSet = true;
}

bool OAIKycDocument_2::is_reviewer_name_Set() const{
    return m_reviewer_name_isSet;
}

bool OAIKycDocument_2::is_reviewer_name_Valid() const{
    return m_reviewer_name_isValid;
}

OAIProofOfAddress_allOf_documentMatches OAIKycDocument_2::getDocumentMatches() const {
    return m_document_matches;
}
void OAIKycDocument_2::setDocumentMatches(const OAIProofOfAddress_allOf_documentMatches &document_matches) {
    m_document_matches = document_matches;
    m_document_matches_isSet = true;
}

bool OAIKycDocument_2::is_document_matches_Set() const{
    return m_document_matches_isSet;
}

bool OAIKycDocument_2::is_document_matches_Valid() const{
    return m_document_matches_isValid;
}

OAIProofOfAddress_allOf_documentMatches OAIKycDocument_2::getParsedData() const {
    return m_parsed_data;
}
void OAIKycDocument_2::setParsedData(const OAIProofOfAddress_allOf_documentMatches &parsed_data) {
    m_parsed_data = parsed_data;
    m_parsed_data_isSet = true;
}

bool OAIKycDocument_2::is_parsed_data_Set() const{
    return m_parsed_data_isSet;
}

bool OAIKycDocument_2::is_parsed_data_Valid() const{
    return m_parsed_data_isValid;
}

bool OAIKycDocument_2::isSet() const {
...
bool OAIKycDocument_2::isValid() const {
