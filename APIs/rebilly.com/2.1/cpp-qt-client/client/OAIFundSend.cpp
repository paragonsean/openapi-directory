...
OAIFundSend::OAIFundSend(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIFundSend::OAIFundSend() {
    this->initializeModel();
}

OAIFundSend::~OAIFundSend() {}

void OAIFundSend::initializeModel() {
...
void OAIFundSend::fromJson(QString jsonString) {
...
void OAIFundSend::fromJsonObject(QJsonObject json) {
...
QString OAIFundSend::asJson() const {
...
QJsonObject OAIFundSend::asJsonObject() const {
    QJsonObject obj;
    if (m__links.size() > 0) {
...
QList<OAIGatewayAccount__links_inner> OAIFundSend::getLinks() const {
    return m__links;
}
void OAIFundSend::setLinks(const QList<OAIGatewayAccount__links_inner> &_links) {
    m__links = _links;
    m__links_isSet = true;
}

bool OAIFundSend::is__links_Set() const{
    return m__links_isSet;
}

bool OAIFundSend::is__links_Valid() const{
    return m__links_isValid;
}

QList<QString> OAIFundSend::getAcceptedCurrencies() const {
    return m_accepted_currencies;
}
void OAIFundSend::setAcceptedCurrencies(const QList<QString> &accepted_currencies) {
    m_accepted_currencies = accepted_currencies;
    m_accepted_currencies_isSet = true;
}

bool OAIFundSend::is_accepted_currencies_Set() const{
    return m_accepted_currencies_isSet;
}

bool OAIFundSend::is_accepted_currencies_Valid() const{
    return m_accepted_currencies_isValid;
}

OAIAcquirerName OAIFundSend::getAcquirerName() const {
    return m_acquirer_name;
}
void OAIFundSend::setAcquirerName(const OAIAcquirerName &acquirer_name) {
    m_acquirer_name = acquirer_name;
    m_acquirer_name_isSet = true;
}

bool OAIFundSend::is_acquirer_name_Set() const{
    return m_acquirer_name_isSet;
}

bool OAIFundSend::is_acquirer_name_Valid() const{
    return m_acquirer_name_isValid;
}

QString OAIFundSend::getAdditionalFilters() const {
    return m_additional_filters;
}
void OAIFundSend::setAdditionalFilters(const QString &additional_filters) {
    m_additional_filters = additional_filters;
    m_additional_filters_isSet = true;
}

bool OAIFundSend::is_additional_filters_Set() const{
    return m_additional_filters_isSet;
}

bool OAIFundSend::is_additional_filters_Valid() const{
    return m_additional_filters_isValid;
}

qint32 OAIFundSend::getApprovalWindowTtl() const {
    return m_approval_window_ttl;
}
void OAIFundSend::setApprovalWindowTtl(const qint32 &approval_window_ttl) {
    m_approval_window_ttl = approval_window_ttl;
    m_approval_window_ttl_isSet = true;
}

bool OAIFundSend::is_approval_window_ttl_Set() const{
    return m_approval_window_ttl_isSet;
}

bool OAIFundSend::is_approval_window_ttl_Valid() const{
    return m_approval_window_ttl_isValid;
}

QString OAIFundSend::getCityField() const {
    return m_city_field;
}
void OAIFundSend::setCityField(const QString &city_field) {
    m_city_field = city_field;
    m_city_field_isSet = true;
}

bool OAIFundSend::is_city_field_Set() const{
    return m_city_field_isSet;
}

bool OAIFundSend::is_city_field_Valid() const{
    return m_city_field_isValid;
}

QDateTime OAIFundSend::getCreatedTime() const {
    return m_created_time;
}
void OAIFundSend::setCreatedTime(const QDateTime &created_time) {
    m_created_time = created_time;
    m_created_time_isSet = true;
}

bool OAIFundSend::is_created_time_Set() const{
    return m_created_time_isSet;
}

bool OAIFundSend::is_created_time_Valid() const{
    return m_created_time_isValid;
}

QString OAIFundSend::getDccForceCurrency() const {
    return m_dcc_force_currency;
}
void OAIFundSend::setDccForceCurrency(const QString &dcc_force_currency) {
    m_dcc_force_currency = dcc_force_currency;
    m_dcc_force_currency_isSet = true;
}

bool OAIFundSend::is_dcc_force_currency_Set() const{
    return m_dcc_force_currency_isSet;
}

bool OAIFundSend::is_dcc_force_currency_Valid() const{
    return m_dcc_force_currency_isValid;
}

qint32 OAIFundSend::getDccMarkup() const {
    return m_dcc_markup;
}
void OAIFundSend::setDccMarkup(const qint32 &dcc_markup) {
    m_dcc_markup = dcc_markup;
    m_dcc_markup_isSet = true;
}

bool OAIFundSend::is_dcc_markup_Set() const{
    return m_dcc_markup_isSet;
}

bool OAIFundSend::is_dcc_markup_Valid() const{
    return m_dcc_markup_isValid;
}

QString OAIFundSend::getDescriptor() const {
    return m_descriptor;
}
void OAIFundSend::setDescriptor(const QString &descriptor) {
    m_descriptor = descriptor;
    m_descriptor_isSet = true;
}

bool OAIFundSend::is_descriptor_Set() const{
    return m_descriptor_isSet;
}

bool OAIFundSend::is_descriptor_Valid() const{
    return m_descriptor_isValid;
}

OAIDigitalWallets OAIFundSend::getDigitalWallets() const {
    return m_digital_wallets;
}
void OAIFundSend::setDigitalWallets(const OAIDigitalWallets &digital_wallets) {
    m_digital_wallets = digital_wallets;
    m_digital_wallets_isSet = true;
}

bool OAIFundSend::is_digital_wallets_Set() const{
    return m_digital_wallets_isSet;
}

bool OAIFundSend::is_digital_wallets_Valid() const{
    return m_digital_wallets_isValid;
}

bool OAIFundSend::isDynamicDescriptor() const {
    return m_dynamic_descriptor;
}
void OAIFundSend::setDynamicDescriptor(const bool &dynamic_descriptor) {
    m_dynamic_descriptor = dynamic_descriptor;
    m_dynamic_descriptor_isSet = true;
}

bool OAIFundSend::is_dynamic_descriptor_Set() const{
    return m_dynamic_descriptor_isSet;
}

bool OAIFundSend::is_dynamic_descriptor_Valid() const{
    return m_dynamic_descriptor_isValid;
}

QList<QString> OAIFundSend::getExcludedDccQuoteCurrencies() const {
    return m_excluded_dcc_quote_currencies;
}
void OAIFundSend::setExcludedDccQuoteCurrencies(const QList<QString> &excluded_dcc_quote_currencies) {
    m_excluded_dcc_quote_currencies = excluded_dcc_quote_currencies;
    m_excluded_dcc_quote_currencies_isSet = true;
}

bool OAIFundSend::is_excluded_dcc_quote_currencies_Set() const{
    return m_excluded_dcc_quote_currencies_isSet;
}

bool OAIFundSend::is_excluded_dcc_quote_currencies_Valid() const{
    return m_excluded_dcc_quote_currencies_isValid;
}

OAIGatewayName OAIFundSend::getGatewayName() const {
    return m_gateway_name;
}
void OAIFundSend::setGatewayName(const OAIGatewayName &gateway_name) {
    m_gateway_name = gateway_name;
    m_gateway_name_isSet = true;
}

bool OAIFundSend::is_gateway_name_Set() const{
    return m_gateway_name_isSet;
}

bool OAIFundSend::is_gateway_name_Valid() const{
    return m_gateway_name_isValid;
}

QString OAIFundSend::getId() const {
    return m_id;
}
void OAIFundSend::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIFundSend::is_id_Set() const{
    return m_id_isSet;
}

bool OAIFundSend::is_id_Valid() const{
    return m_id_isValid;
}

bool OAIFundSend::isIsDown() const {
    return m_is_down;
}
void OAIFundSend::setIsDown(const bool &is_down) {
    m_is_down = is_down;
    m_is_down_isSet = true;
}

bool OAIFundSend::is_is_down_Set() const{
    return m_is_down_isSet;
}

bool OAIFundSend::is_is_down_Valid() const{
    return m_is_down_isValid;
}

QString OAIFundSend::getMerchantCategoryCode() const {
    return m_merchant_category_code;
}
void OAIFundSend::setMerchantCategoryCode(const QString &merchant_category_code) {
    m_merchant_category_code = merchant_category_code;
    m_merchant_category_code_isSet = true;
}

bool OAIFundSend::is_merchant_category_code_Set() const{
    return m_merchant_category_code_isSet;
}

bool OAIFundSend::is_merchant_category_code_Valid() const{
    return m_merchant_category_code_isValid;
}

OAIPaymentMethod OAIFundSend::getMethod() const {
    return m_method;
}
void OAIFundSend::setMethod(const OAIPaymentMethod &method) {
    m_method = method;
    m_method_isSet = true;
}

bool OAIFundSend::is_method_Set() const{
    return m_method_isSet;
}

bool OAIFundSend::is_method_Valid() const{
    return m_method_isValid;
}

double OAIFundSend::getMonthlyLimit() const {
    return m_monthly_limit;
}
void OAIFundSend::setMonthlyLimit(const double &monthly_limit) {
    m_monthly_limit = monthly_limit;
    m_monthly_limit_isSet = true;
}

bool OAIFundSend::is_monthly_limit_Set() const{
    return m_monthly_limit_isSet;
}

bool OAIFundSend::is_monthly_limit_Valid() const{
    return m_monthly_limit_isValid;
}

QString OAIFundSend::getOrganizationId() const {
    return m_organization_id;
}
void OAIFundSend::setOrganizationId(const QString &organization_id) {
    m_organization_id = organization_id;
    m_organization_id_isSet = true;
}

bool OAIFundSend::is_organization_id_Set() const{
    return m_organization_id_isSet;
}

bool OAIFundSend::is_organization_id_Valid() const{
    return m_organization_id_isValid;
}

QList<OAIPaymentCardBrand> OAIFundSend::getPaymentCardSchemes() const {
    return m_payment_card_schemes;
}
void OAIFundSend::setPaymentCardSchemes(const QList<OAIPaymentCardBrand> &payment_card_schemes) {
    m_payment_card_schemes = payment_card_schemes;
    m_payment_card_schemes_isSet = true;
}

bool OAIFundSend::is_payment_card_schemes_Set() const{
    return m_payment_card_schemes_isSet;
}

bool OAIFundSend::is_payment_card_schemes_Valid() const{
    return m_payment_card_schemes_isValid;
}

bool OAIFundSend::isReconciliationWindowEnabled() const {
    return m_reconciliation_window_enabled;
}
void OAIFundSend::setReconciliationWindowEnabled(const bool &reconciliation_window_enabled) {
    m_reconciliation_window_enabled = reconciliation_window_enabled;
    m_reconciliation_window_enabled_isSet = true;
}

bool OAIFundSend::is_reconciliation_window_enabled_Set() const{
    return m_reconciliation_window_enabled_isSet;
}

bool OAIFundSend::is_reconciliation_window_enabled_Valid() const{
    return m_reconciliation_window_enabled_isValid;
}

qint32 OAIFundSend::getReconciliationWindowTtl() const {
    return m_reconciliation_window_ttl;
}
void OAIFundSend::setReconciliationWindowTtl(const qint32 &reconciliation_window_ttl) {
    m_reconciliation_window_ttl = reconciliation_window_ttl;
    m_reconciliation_window_ttl_isSet = true;
}

bool OAIFundSend::is_reconciliation_window_ttl_Set() const{
    return m_reconciliation_window_ttl_isSet;
}

bool OAIFundSend::is_reconciliation_window_ttl_Valid() const{
    return m_reconciliation_window_ttl_isValid;
}

QString OAIFundSend::getStatus() const {
    return m_status;
}
void OAIFundSend::setStatus(const QString &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIFundSend::is_status_Set() const{
    return m_status_isSet;
}

bool OAIFundSend::is_status_Valid() const{
    return m_status_isValid;
}

bool OAIFundSend::isSticky() const {
    return m_sticky;
}
void OAIFundSend::setSticky(const bool &sticky) {
    m_sticky = sticky;
    m_sticky_isSet = true;
}

bool OAIFundSend::is_sticky_Set() const{
    return m_sticky_isSet;
}

bool OAIFundSend::is_sticky_Valid() const{
    return m_sticky_isValid;
}

bool OAIFundSend::isThreeDSecure() const {
    return m_three_d_secure;
}
void OAIFundSend::setThreeDSecure(const bool &three_d_secure) {
    m_three_d_secure = three_d_secure;
    m_three_d_secure_isSet = true;
}

bool OAIFundSend::is_three_d_secure_Set() const{
    return m_three_d_secure_isSet;
}

bool OAIFundSend::is_three_d_secure_Valid() const{
    return m_three_d_secure_isValid;
}

qint32 OAIFundSend::getTimeout() const {
    return m_timeout;
}
void OAIFundSend::setTimeout(const qint32 &timeout) {
    m_timeout = timeout;
    m_timeout_isSet = true;
}

bool OAIFundSend::is_timeout_Set() const{
    return m_timeout_isSet;
}

bool OAIFundSend::is_timeout_Valid() const{
    return m_timeout_isValid;
}

QString OAIFundSend::getToken() const {
    return m_token;
}
void OAIFundSend::setToken(const QString &token) {
    m_token = token;
    m_token_isSet = true;
}

bool OAIFundSend::is_token_Set() const{
    return m_token_isSet;
}

bool OAIFundSend::is_token_Valid() const{
    return m_token_isValid;
}

QDateTime OAIFundSend::getUpdatedTime() const {
    return m_updated_time;
}
void OAIFundSend::setUpdatedTime(const QDateTime &updated_time) {
    m_updated_time = updated_time;
    m_updated_time_isSet = true;
}

bool OAIFundSend::is_updated_time_Set() const{
    return m_updated_time_isSet;
}

bool OAIFundSend::is_updated_time_Valid() const{
    return m_updated_time_isValid;
}

OAIFundSend_allOf_credentials OAIFundSend::getCredentials() const {
    return m_credentials;
}
void OAIFundSend::setCredentials(const OAIFundSend_allOf_credentials &credentials) {
    m_credentials = credentials;
    m_credentials_isSet = true;
}

bool OAIFundSend::is_credentials_Set() const{
    return m_credentials_isSet;
}

bool OAIFundSend::is_credentials_Valid() const{
    return m_credentials_isValid;
}

bool OAIFundSend::isSet() const {
...
bool OAIFundSend::isValid() const {
