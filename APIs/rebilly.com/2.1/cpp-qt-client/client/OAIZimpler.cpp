...
OAIZimpler::OAIZimpler(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIZimpler::OAIZimpler() {
    this->initializeModel();
}

OAIZimpler::~OAIZimpler() {}

void OAIZimpler::initializeModel() {
...
void OAIZimpler::fromJson(QString jsonString) {
...
void OAIZimpler::fromJsonObject(QJsonObject json) {
...
QString OAIZimpler::asJson() const {
...
QJsonObject OAIZimpler::asJsonObject() const {
    QJsonObject obj;
    if (m__links.size() > 0) {
...
QList<OAIGatewayAccount__links_inner> OAIZimpler::getLinks() const {
    return m__links;
}
void OAIZimpler::setLinks(const QList<OAIGatewayAccount__links_inner> &_links) {
    m__links = _links;
    m__links_isSet = true;
}

bool OAIZimpler::is__links_Set() const{
    return m__links_isSet;
}

bool OAIZimpler::is__links_Valid() const{
    return m__links_isValid;
}

QList<QString> OAIZimpler::getAcceptedCurrencies() const {
    return m_accepted_currencies;
}
void OAIZimpler::setAcceptedCurrencies(const QList<QString> &accepted_currencies) {
    m_accepted_currencies = accepted_currencies;
    m_accepted_currencies_isSet = true;
}

bool OAIZimpler::is_accepted_currencies_Set() const{
    return m_accepted_currencies_isSet;
}

bool OAIZimpler::is_accepted_currencies_Valid() const{
    return m_accepted_currencies_isValid;
}

OAIAcquirerName OAIZimpler::getAcquirerName() const {
    return m_acquirer_name;
}
void OAIZimpler::setAcquirerName(const OAIAcquirerName &acquirer_name) {
    m_acquirer_name = acquirer_name;
    m_acquirer_name_isSet = true;
}

bool OAIZimpler::is_acquirer_name_Set() const{
    return m_acquirer_name_isSet;
}

bool OAIZimpler::is_acquirer_name_Valid() const{
    return m_acquirer_name_isValid;
}

QString OAIZimpler::getAdditionalFilters() const {
    return m_additional_filters;
}
void OAIZimpler::setAdditionalFilters(const QString &additional_filters) {
    m_additional_filters = additional_filters;
    m_additional_filters_isSet = true;
}

bool OAIZimpler::is_additional_filters_Set() const{
    return m_additional_filters_isSet;
}

bool OAIZimpler::is_additional_filters_Valid() const{
    return m_additional_filters_isValid;
}

qint32 OAIZimpler::getApprovalWindowTtl() const {
    return m_approval_window_ttl;
}
void OAIZimpler::setApprovalWindowTtl(const qint32 &approval_window_ttl) {
    m_approval_window_ttl = approval_window_ttl;
    m_approval_window_ttl_isSet = true;
}

bool OAIZimpler::is_approval_window_ttl_Set() const{
    return m_approval_window_ttl_isSet;
}

bool OAIZimpler::is_approval_window_ttl_Valid() const{
    return m_approval_window_ttl_isValid;
}

QString OAIZimpler::getCityField() const {
    return m_city_field;
}
void OAIZimpler::setCityField(const QString &city_field) {
    m_city_field = city_field;
    m_city_field_isSet = true;
}

bool OAIZimpler::is_city_field_Set() const{
    return m_city_field_isSet;
}

bool OAIZimpler::is_city_field_Valid() const{
    return m_city_field_isValid;
}

QDateTime OAIZimpler::getCreatedTime() const {
    return m_created_time;
}
void OAIZimpler::setCreatedTime(const QDateTime &created_time) {
    m_created_time = created_time;
    m_created_time_isSet = true;
}

bool OAIZimpler::is_created_time_Set() const{
    return m_created_time_isSet;
}

bool OAIZimpler::is_created_time_Valid() const{
    return m_created_time_isValid;
}

QString OAIZimpler::getDccForceCurrency() const {
    return m_dcc_force_currency;
}
void OAIZimpler::setDccForceCurrency(const QString &dcc_force_currency) {
    m_dcc_force_currency = dcc_force_currency;
    m_dcc_force_currency_isSet = true;
}

bool OAIZimpler::is_dcc_force_currency_Set() const{
    return m_dcc_force_currency_isSet;
}

bool OAIZimpler::is_dcc_force_currency_Valid() const{
    return m_dcc_force_currency_isValid;
}

qint32 OAIZimpler::getDccMarkup() const {
    return m_dcc_markup;
}
void OAIZimpler::setDccMarkup(const qint32 &dcc_markup) {
    m_dcc_markup = dcc_markup;
    m_dcc_markup_isSet = true;
}

bool OAIZimpler::is_dcc_markup_Set() const{
    return m_dcc_markup_isSet;
}

bool OAIZimpler::is_dcc_markup_Valid() const{
    return m_dcc_markup_isValid;
}

QString OAIZimpler::getDescriptor() const {
    return m_descriptor;
}
void OAIZimpler::setDescriptor(const QString &descriptor) {
    m_descriptor = descriptor;
    m_descriptor_isSet = true;
}

bool OAIZimpler::is_descriptor_Set() const{
    return m_descriptor_isSet;
}

bool OAIZimpler::is_descriptor_Valid() const{
    return m_descriptor_isValid;
}

OAIDigitalWallets OAIZimpler::getDigitalWallets() const {
    return m_digital_wallets;
}
void OAIZimpler::setDigitalWallets(const OAIDigitalWallets &digital_wallets) {
    m_digital_wallets = digital_wallets;
    m_digital_wallets_isSet = true;
}

bool OAIZimpler::is_digital_wallets_Set() const{
    return m_digital_wallets_isSet;
}

bool OAIZimpler::is_digital_wallets_Valid() const{
    return m_digital_wallets_isValid;
}

bool OAIZimpler::isDynamicDescriptor() const {
    return m_dynamic_descriptor;
}
void OAIZimpler::setDynamicDescriptor(const bool &dynamic_descriptor) {
    m_dynamic_descriptor = dynamic_descriptor;
    m_dynamic_descriptor_isSet = true;
}

bool OAIZimpler::is_dynamic_descriptor_Set() const{
    return m_dynamic_descriptor_isSet;
}

bool OAIZimpler::is_dynamic_descriptor_Valid() const{
    return m_dynamic_descriptor_isValid;
}

QList<QString> OAIZimpler::getExcludedDccQuoteCurrencies() const {
    return m_excluded_dcc_quote_currencies;
}
void OAIZimpler::setExcludedDccQuoteCurrencies(const QList<QString> &excluded_dcc_quote_currencies) {
    m_excluded_dcc_quote_currencies = excluded_dcc_quote_currencies;
    m_excluded_dcc_quote_currencies_isSet = true;
}

bool OAIZimpler::is_excluded_dcc_quote_currencies_Set() const{
    return m_excluded_dcc_quote_currencies_isSet;
}

bool OAIZimpler::is_excluded_dcc_quote_currencies_Valid() const{
    return m_excluded_dcc_quote_currencies_isValid;
}

OAIGatewayName OAIZimpler::getGatewayName() const {
    return m_gateway_name;
}
void OAIZimpler::setGatewayName(const OAIGatewayName &gateway_name) {
    m_gateway_name = gateway_name;
    m_gateway_name_isSet = true;
}

bool OAIZimpler::is_gateway_name_Set() const{
    return m_gateway_name_isSet;
}

bool OAIZimpler::is_gateway_name_Valid() const{
    return m_gateway_name_isValid;
}

QString OAIZimpler::getId() const {
    return m_id;
}
void OAIZimpler::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIZimpler::is_id_Set() const{
    return m_id_isSet;
}

bool OAIZimpler::is_id_Valid() const{
    return m_id_isValid;
}

bool OAIZimpler::isIsDown() const {
    return m_is_down;
}
void OAIZimpler::setIsDown(const bool &is_down) {
    m_is_down = is_down;
    m_is_down_isSet = true;
}

bool OAIZimpler::is_is_down_Set() const{
    return m_is_down_isSet;
}

bool OAIZimpler::is_is_down_Valid() const{
    return m_is_down_isValid;
}

QString OAIZimpler::getMerchantCategoryCode() const {
    return m_merchant_category_code;
}
void OAIZimpler::setMerchantCategoryCode(const QString &merchant_category_code) {
    m_merchant_category_code = merchant_category_code;
    m_merchant_category_code_isSet = true;
}

bool OAIZimpler::is_merchant_category_code_Set() const{
    return m_merchant_category_code_isSet;
}

bool OAIZimpler::is_merchant_category_code_Valid() const{
    return m_merchant_category_code_isValid;
}

OAIPaymentMethod OAIZimpler::getMethod() const {
    return m_method;
}
void OAIZimpler::setMethod(const OAIPaymentMethod &method) {
    m_method = method;
    m_method_isSet = true;
}

bool OAIZimpler::is_method_Set() const{
    return m_method_isSet;
}

bool OAIZimpler::is_method_Valid() const{
    return m_method_isValid;
}

double OAIZimpler::getMonthlyLimit() const {
    return m_monthly_limit;
}
void OAIZimpler::setMonthlyLimit(const double &monthly_limit) {
    m_monthly_limit = monthly_limit;
    m_monthly_limit_isSet = true;
}

bool OAIZimpler::is_monthly_limit_Set() const{
    return m_monthly_limit_isSet;
}

bool OAIZimpler::is_monthly_limit_Valid() const{
    return m_monthly_limit_isValid;
}

QString OAIZimpler::getOrganizationId() const {
    return m_organization_id;
}
void OAIZimpler::setOrganizationId(const QString &organization_id) {
    m_organization_id = organization_id;
    m_organization_id_isSet = true;
}

bool OAIZimpler::is_organization_id_Set() const{
    return m_organization_id_isSet;
}

bool OAIZimpler::is_organization_id_Valid() const{
    return m_organization_id_isValid;
}

QList<OAIPaymentCardBrand> OAIZimpler::getPaymentCardSchemes() const {
    return m_payment_card_schemes;
}
void OAIZimpler::setPaymentCardSchemes(const QList<OAIPaymentCardBrand> &payment_card_schemes) {
    m_payment_card_schemes = payment_card_schemes;
    m_payment_card_schemes_isSet = true;
}

bool OAIZimpler::is_payment_card_schemes_Set() const{
    return m_payment_card_schemes_isSet;
}

bool OAIZimpler::is_payment_card_schemes_Valid() const{
    return m_payment_card_schemes_isValid;
}

bool OAIZimpler::isReconciliationWindowEnabled() const {
    return m_reconciliation_window_enabled;
}
void OAIZimpler::setReconciliationWindowEnabled(const bool &reconciliation_window_enabled) {
    m_reconciliation_window_enabled = reconciliation_window_enabled;
    m_reconciliation_window_enabled_isSet = true;
}

bool OAIZimpler::is_reconciliation_window_enabled_Set() const{
    return m_reconciliation_window_enabled_isSet;
}

bool OAIZimpler::is_reconciliation_window_enabled_Valid() const{
    return m_reconciliation_window_enabled_isValid;
}

qint32 OAIZimpler::getReconciliationWindowTtl() const {
    return m_reconciliation_window_ttl;
}
void OAIZimpler::setReconciliationWindowTtl(const qint32 &reconciliation_window_ttl) {
    m_reconciliation_window_ttl = reconciliation_window_ttl;
    m_reconciliation_window_ttl_isSet = true;
}

bool OAIZimpler::is_reconciliation_window_ttl_Set() const{
    return m_reconciliation_window_ttl_isSet;
}

bool OAIZimpler::is_reconciliation_window_ttl_Valid() const{
    return m_reconciliation_window_ttl_isValid;
}

QString OAIZimpler::getStatus() const {
    return m_status;
}
void OAIZimpler::setStatus(const QString &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIZimpler::is_status_Set() const{
    return m_status_isSet;
}

bool OAIZimpler::is_status_Valid() const{
    return m_status_isValid;
}

bool OAIZimpler::isSticky() const {
    return m_sticky;
}
void OAIZimpler::setSticky(const bool &sticky) {
    m_sticky = sticky;
    m_sticky_isSet = true;
}

bool OAIZimpler::is_sticky_Set() const{
    return m_sticky_isSet;
}

bool OAIZimpler::is_sticky_Valid() const{
    return m_sticky_isValid;
}

bool OAIZimpler::isThreeDSecure() const {
    return m_three_d_secure;
}
void OAIZimpler::setThreeDSecure(const bool &three_d_secure) {
    m_three_d_secure = three_d_secure;
    m_three_d_secure_isSet = true;
}

bool OAIZimpler::is_three_d_secure_Set() const{
    return m_three_d_secure_isSet;
}

bool OAIZimpler::is_three_d_secure_Valid() const{
    return m_three_d_secure_isValid;
}

qint32 OAIZimpler::getTimeout() const {
    return m_timeout;
}
void OAIZimpler::setTimeout(const qint32 &timeout) {
    m_timeout = timeout;
    m_timeout_isSet = true;
}

bool OAIZimpler::is_timeout_Set() const{
    return m_timeout_isSet;
}

bool OAIZimpler::is_timeout_Valid() const{
    return m_timeout_isValid;
}

QString OAIZimpler::getToken() const {
    return m_token;
}
void OAIZimpler::setToken(const QString &token) {
    m_token = token;
    m_token_isSet = true;
}

bool OAIZimpler::is_token_Set() const{
    return m_token_isSet;
}

bool OAIZimpler::is_token_Valid() const{
    return m_token_isValid;
}

QDateTime OAIZimpler::getUpdatedTime() const {
    return m_updated_time;
}
void OAIZimpler::setUpdatedTime(const QDateTime &updated_time) {
    m_updated_time = updated_time;
    m_updated_time_isSet = true;
}

bool OAIZimpler::is_updated_time_Set() const{
    return m_updated_time_isSet;
}

bool OAIZimpler::is_updated_time_Valid() const{
    return m_updated_time_isValid;
}

OAIZimpler_allOf_credentials OAIZimpler::getCredentials() const {
    return m_credentials;
}
void OAIZimpler::setCredentials(const OAIZimpler_allOf_credentials &credentials) {
    m_credentials = credentials;
    m_credentials_isSet = true;
}

bool OAIZimpler::is_credentials_Set() const{
    return m_credentials_isSet;
}

bool OAIZimpler::is_credentials_Valid() const{
    return m_credentials_isValid;
}

bool OAIZimpler::isSet() const {
