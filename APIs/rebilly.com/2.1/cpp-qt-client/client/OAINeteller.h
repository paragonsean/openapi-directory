...
#ifndef OAINeteller_H
#define OAINeteller_H
...
class OAINeteller_allOf_credentials;
class OAINeteller_allOf_settings;

class OAINeteller : public OAIObject {
public:
    OAINeteller();
    OAINeteller(QString json);
    ~OAINeteller() override;
    ...
    OAINeteller_allOf_credentials getCredentials() const;
    void setCredentials(const OAINeteller_allOf_credentials &credentials);
    bool is_credentials_Set() const;
    bool is_credentials_Valid() const;

    OAINeteller_allOf_settings getSettings() const;
    void setSettings(const OAINeteller_allOf_settings &settings);
...
private:
    ...
    OAINeteller_allOf_credentials m_credentials;
    bool m_credentials_isSet;
    bool m_credentials_isValid;

    OAINeteller_allOf_settings m_settings;
...
Q_DECLARE_METATYPE(OpenAPI::OAINeteller)
