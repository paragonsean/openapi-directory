...
OAIGreenbox::OAIGreenbox(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGreenbox::OAIGreenbox() {
    this->initializeModel();
}

OAIGreenbox::~OAIGreenbox() {}

void OAIGreenbox::initializeModel() {
...
void OAIGreenbox::fromJson(QString jsonString) {
...
void OAIGreenbox::fromJsonObject(QJsonObject json) {
...
QString OAIGreenbox::asJson() const {
...
QJsonObject OAIGreenbox::asJsonObject() const {
    QJsonObject obj;
    if (m__links.size() > 0) {
...
QList<OAIGatewayAccount__links_inner> OAIGreenbox::getLinks() const {
    return m__links;
}
void OAIGreenbox::setLinks(const QList<OAIGatewayAccount__links_inner> &_links) {
    m__links = _links;
    m__links_isSet = true;
}

bool OAIGreenbox::is__links_Set() const{
    return m__links_isSet;
}

bool OAIGreenbox::is__links_Valid() const{
    return m__links_isValid;
}

QList<QString> OAIGreenbox::getAcceptedCurrencies() const {
    return m_accepted_currencies;
}
void OAIGreenbox::setAcceptedCurrencies(const QList<QString> &accepted_currencies) {
    m_accepted_currencies = accepted_currencies;
    m_accepted_currencies_isSet = true;
}

bool OAIGreenbox::is_accepted_currencies_Set() const{
    return m_accepted_currencies_isSet;
}

bool OAIGreenbox::is_accepted_currencies_Valid() const{
    return m_accepted_currencies_isValid;
}

OAIAcquirerName OAIGreenbox::getAcquirerName() const {
    return m_acquirer_name;
}
void OAIGreenbox::setAcquirerName(const OAIAcquirerName &acquirer_name) {
    m_acquirer_name = acquirer_name;
    m_acquirer_name_isSet = true;
}

bool OAIGreenbox::is_acquirer_name_Set() const{
    return m_acquirer_name_isSet;
}

bool OAIGreenbox::is_acquirer_name_Valid() const{
    return m_acquirer_name_isValid;
}

QString OAIGreenbox::getAdditionalFilters() const {
    return m_additional_filters;
}
void OAIGreenbox::setAdditionalFilters(const QString &additional_filters) {
    m_additional_filters = additional_filters;
    m_additional_filters_isSet = true;
}

bool OAIGreenbox::is_additional_filters_Set() const{
    return m_additional_filters_isSet;
}

bool OAIGreenbox::is_additional_filters_Valid() const{
    return m_additional_filters_isValid;
}

qint32 OAIGreenbox::getApprovalWindowTtl() const {
    return m_approval_window_ttl;
}
void OAIGreenbox::setApprovalWindowTtl(const qint32 &approval_window_ttl) {
    m_approval_window_ttl = approval_window_ttl;
    m_approval_window_ttl_isSet = true;
}

bool OAIGreenbox::is_approval_window_ttl_Set() const{
    return m_approval_window_ttl_isSet;
}

bool OAIGreenbox::is_approval_window_ttl_Valid() const{
    return m_approval_window_ttl_isValid;
}

QString OAIGreenbox::getCityField() const {
    return m_city_field;
}
void OAIGreenbox::setCityField(const QString &city_field) {
    m_city_field = city_field;
    m_city_field_isSet = true;
}

bool OAIGreenbox::is_city_field_Set() const{
    return m_city_field_isSet;
}

bool OAIGreenbox::is_city_field_Valid() const{
    return m_city_field_isValid;
}

QDateTime OAIGreenbox::getCreatedTime() const {
    return m_created_time;
}
void OAIGreenbox::setCreatedTime(const QDateTime &created_time) {
    m_created_time = created_time;
    m_created_time_isSet = true;
}

bool OAIGreenbox::is_created_time_Set() const{
    return m_created_time_isSet;
}

bool OAIGreenbox::is_created_time_Valid() const{
    return m_created_time_isValid;
}

QString OAIGreenbox::getDccForceCurrency() const {
    return m_dcc_force_currency;
}
void OAIGreenbox::setDccForceCurrency(const QString &dcc_force_currency) {
    m_dcc_force_currency = dcc_force_currency;
    m_dcc_force_currency_isSet = true;
}

bool OAIGreenbox::is_dcc_force_currency_Set() const{
    return m_dcc_force_currency_isSet;
}

bool OAIGreenbox::is_dcc_force_currency_Valid() const{
    return m_dcc_force_currency_isValid;
}

qint32 OAIGreenbox::getDccMarkup() const {
    return m_dcc_markup;
}
void OAIGreenbox::setDccMarkup(const qint32 &dcc_markup) {
    m_dcc_markup = dcc_markup;
    m_dcc_markup_isSet = true;
}

bool OAIGreenbox::is_dcc_markup_Set() const{
    return m_dcc_markup_isSet;
}

bool OAIGreenbox::is_dcc_markup_Valid() const{
    return m_dcc_markup_isValid;
}

QString OAIGreenbox::getDescriptor() const {
    return m_descriptor;
}
void OAIGreenbox::setDescriptor(const QString &descriptor) {
    m_descriptor = descriptor;
    m_descriptor_isSet = true;
}

bool OAIGreenbox::is_descriptor_Set() const{
    return m_descriptor_isSet;
}

bool OAIGreenbox::is_descriptor_Valid() const{
    return m_descriptor_isValid;
}

OAIDigitalWallets OAIGreenbox::getDigitalWallets() const {
    return m_digital_wallets;
}
void OAIGreenbox::setDigitalWallets(const OAIDigitalWallets &digital_wallets) {
    m_digital_wallets = digital_wallets;
    m_digital_wallets_isSet = true;
}

bool OAIGreenbox::is_digital_wallets_Set() const{
    return m_digital_wallets_isSet;
}

bool OAIGreenbox::is_digital_wallets_Valid() const{
    return m_digital_wallets_isValid;
}

bool OAIGreenbox::isDynamicDescriptor() const {
    return m_dynamic_descriptor;
}
void OAIGreenbox::setDynamicDescriptor(const bool &dynamic_descriptor) {
    m_dynamic_descriptor = dynamic_descriptor;
    m_dynamic_descriptor_isSet = true;
}

bool OAIGreenbox::is_dynamic_descriptor_Set() const{
    return m_dynamic_descriptor_isSet;
}

bool OAIGreenbox::is_dynamic_descriptor_Valid() const{
    return m_dynamic_descriptor_isValid;
}

QList<QString> OAIGreenbox::getExcludedDccQuoteCurrencies() const {
    return m_excluded_dcc_quote_currencies;
}
void OAIGreenbox::setExcludedDccQuoteCurrencies(const QList<QString> &excluded_dcc_quote_currencies) {
    m_excluded_dcc_quote_currencies = excluded_dcc_quote_currencies;
    m_excluded_dcc_quote_currencies_isSet = true;
}

bool OAIGreenbox::is_excluded_dcc_quote_currencies_Set() const{
    return m_excluded_dcc_quote_currencies_isSet;
}

bool OAIGreenbox::is_excluded_dcc_quote_currencies_Valid() const{
    return m_excluded_dcc_quote_currencies_isValid;
}

OAIGatewayName OAIGreenbox::getGatewayName() const {
    return m_gateway_name;
}
void OAIGreenbox::setGatewayName(const OAIGatewayName &gateway_name) {
    m_gateway_name = gateway_name;
    m_gateway_name_isSet = true;
}

bool OAIGreenbox::is_gateway_name_Set() const{
    return m_gateway_name_isSet;
}

bool OAIGreenbox::is_gateway_name_Valid() const{
    return m_gateway_name_isValid;
}

QString OAIGreenbox::getId() const {
    return m_id;
}
void OAIGreenbox::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIGreenbox::is_id_Set() const{
    return m_id_isSet;
}

bool OAIGreenbox::is_id_Valid() const{
    return m_id_isValid;
}

bool OAIGreenbox::isIsDown() const {
    return m_is_down;
}
void OAIGreenbox::setIsDown(const bool &is_down) {
    m_is_down = is_down;
    m_is_down_isSet = true;
}

bool OAIGreenbox::is_is_down_Set() const{
    return m_is_down_isSet;
}

bool OAIGreenbox::is_is_down_Valid() const{
    return m_is_down_isValid;
}

QString OAIGreenbox::getMerchantCategoryCode() const {
    return m_merchant_category_code;
}
void OAIGreenbox::setMerchantCategoryCode(const QString &merchant_category_code) {
    m_merchant_category_code = merchant_category_code;
    m_merchant_category_code_isSet = true;
}

bool OAIGreenbox::is_merchant_category_code_Set() const{
    return m_merchant_category_code_isSet;
}

bool OAIGreenbox::is_merchant_category_code_Valid() const{
    return m_merchant_category_code_isValid;
}

OAIPaymentMethod OAIGreenbox::getMethod() const {
    return m_method;
}
void OAIGreenbox::setMethod(const OAIPaymentMethod &method) {
    m_method = method;
    m_method_isSet = true;
}

bool OAIGreenbox::is_method_Set() const{
    return m_method_isSet;
}

bool OAIGreenbox::is_method_Valid() const{
    return m_method_isValid;
}

double OAIGreenbox::getMonthlyLimit() const {
    return m_monthly_limit;
}
void OAIGreenbox::setMonthlyLimit(const double &monthly_limit) {
    m_monthly_limit = monthly_limit;
    m_monthly_limit_isSet = true;
}

bool OAIGreenbox::is_monthly_limit_Set() const{
    return m_monthly_limit_isSet;
}

bool OAIGreenbox::is_monthly_limit_Valid() const{
    return m_monthly_limit_isValid;
}

QString OAIGreenbox::getOrganizationId() const {
    return m_organization_id;
}
void OAIGreenbox::setOrganizationId(const QString &organization_id) {
    m_organization_id = organization_id;
    m_organization_id_isSet = true;
}

bool OAIGreenbox::is_organization_id_Set() const{
    return m_organization_id_isSet;
}

bool OAIGreenbox::is_organization_id_Valid() const{
    return m_organization_id_isValid;
}

QList<OAIPaymentCardBrand> OAIGreenbox::getPaymentCardSchemes() const {
    return m_payment_card_schemes;
}
void OAIGreenbox::setPaymentCardSchemes(const QList<OAIPaymentCardBrand> &payment_card_schemes) {
    m_payment_card_schemes = payment_card_schemes;
    m_payment_card_schemes_isSet = true;
}

bool OAIGreenbox::is_payment_card_schemes_Set() const{
    return m_payment_card_schemes_isSet;
}

bool OAIGreenbox::is_payment_card_schemes_Valid() const{
    return m_payment_card_schemes_isValid;
}

bool OAIGreenbox::isReconciliationWindowEnabled() const {
    return m_reconciliation_window_enabled;
}
void OAIGreenbox::setReconciliationWindowEnabled(const bool &reconciliation_window_enabled) {
    m_reconciliation_window_enabled = reconciliation_window_enabled;
    m_reconciliation_window_enabled_isSet = true;
}

bool OAIGreenbox::is_reconciliation_window_enabled_Set() const{
    return m_reconciliation_window_enabled_isSet;
}

bool OAIGreenbox::is_reconciliation_window_enabled_Valid() const{
    return m_reconciliation_window_enabled_isValid;
}

qint32 OAIGreenbox::getReconciliationWindowTtl() const {
    return m_reconciliation_window_ttl;
}
void OAIGreenbox::setReconciliationWindowTtl(const qint32 &reconciliation_window_ttl) {
    m_reconciliation_window_ttl = reconciliation_window_ttl;
    m_reconciliation_window_ttl_isSet = true;
}

bool OAIGreenbox::is_reconciliation_window_ttl_Set() const{
    return m_reconciliation_window_ttl_isSet;
}

bool OAIGreenbox::is_reconciliation_window_ttl_Valid() const{
    return m_reconciliation_window_ttl_isValid;
}

QString OAIGreenbox::getStatus() const {
    return m_status;
}
void OAIGreenbox::setStatus(const QString &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIGreenbox::is_status_Set() const{
    return m_status_isSet;
}

bool OAIGreenbox::is_status_Valid() const{
    return m_status_isValid;
}

bool OAIGreenbox::isSticky() const {
    return m_sticky;
}
void OAIGreenbox::setSticky(const bool &sticky) {
    m_sticky = sticky;
    m_sticky_isSet = true;
}

bool OAIGreenbox::is_sticky_Set() const{
    return m_sticky_isSet;
}

bool OAIGreenbox::is_sticky_Valid() const{
    return m_sticky_isValid;
}

bool OAIGreenbox::isThreeDSecure() const {
    return m_three_d_secure;
}
void OAIGreenbox::setThreeDSecure(const bool &three_d_secure) {
    m_three_d_secure = three_d_secure;
    m_three_d_secure_isSet = true;
}

bool OAIGreenbox::is_three_d_secure_Set() const{
    return m_three_d_secure_isSet;
}

bool OAIGreenbox::is_three_d_secure_Valid() const{
    return m_three_d_secure_isValid;
}

qint32 OAIGreenbox::getTimeout() const {
    return m_timeout;
}
void OAIGreenbox::setTimeout(const qint32 &timeout) {
    m_timeout = timeout;
    m_timeout_isSet = true;
}

bool OAIGreenbox::is_timeout_Set() const{
    return m_timeout_isSet;
}

bool OAIGreenbox::is_timeout_Valid() const{
    return m_timeout_isValid;
}

QString OAIGreenbox::getToken() const {
    return m_token;
}
void OAIGreenbox::setToken(const QString &token) {
    m_token = token;
    m_token_isSet = true;
}

bool OAIGreenbox::is_token_Set() const{
    return m_token_isSet;
}

bool OAIGreenbox::is_token_Valid() const{
    return m_token_isValid;
}

QDateTime OAIGreenbox::getUpdatedTime() const {
    return m_updated_time;
}
void OAIGreenbox::setUpdatedTime(const QDateTime &updated_time) {
    m_updated_time = updated_time;
    m_updated_time_isSet = true;
}

bool OAIGreenbox::is_updated_time_Set() const{
    return m_updated_time_isSet;
}

bool OAIGreenbox::is_updated_time_Valid() const{
    return m_updated_time_isValid;
}

OAIGreenbox_allOf_credentials OAIGreenbox::getCredentials() const {
    return m_credentials;
}
void OAIGreenbox::setCredentials(const OAIGreenbox_allOf_credentials &credentials) {
    m_credentials = credentials;
    m_credentials_isSet = true;
}

bool OAIGreenbox::is_credentials_Set() const{
    return m_credentials_isSet;
}

bool OAIGreenbox::is_credentials_Valid() const{
    return m_credentials_isValid;
}

bool OAIGreenbox::isSet() const {
...
bool OAIGreenbox::isValid() const {
