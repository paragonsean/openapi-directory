...
#ifndef OAIPlugnpay_H
#define OAIPlugnpay_H
...
#include "OAIPlugnpay_allOf_credentials.h"
#include <QDateTime>
#include <QList>
#include <QString>
...
class OAIPlugnpay_allOf_credentials;

class OAIPlugnpay : public OAIObject {
public:
    OAIPlugnpay();
    OAIPlugnpay(QString json);
    ~OAIPlugnpay() override;
    ...
    OAIPlugnpay_allOf_credentials getCredentials() const;
    void setCredentials(const OAIPlugnpay_allOf_credentials &credentials);
...
private:
    ...
    OAIPlugnpay_allOf_credentials m_credentials;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPlugnpay)
