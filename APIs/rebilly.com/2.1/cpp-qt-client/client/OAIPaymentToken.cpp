...
QString OAIPaymentToken::getToken() const {
    return m_token;
}
void OAIPaymentToken::setToken(const QString &token) {
    m_token = token;
    m_token_isSet = true;
}

bool OAIPaymentToken::is_token_Set() const{
    return m_token_isSet;
}

bool OAIPaymentToken::is_token_Valid() const{
