...
/*
 * OAIKhelocard_allOf_credentials.h
 *
 * Credentials object.
 */

#ifndef OAIKhelocard_allOf_credentials_H
#define OAIKhelocard_allOf_credentials_H
...
class OAIKhelocard_allOf_credentials : public OAIObject {
public:
    OAIKhelocard_allOf_credentials();
    OAIKhelocard_allOf_credentials(QString json);
    ~OAIKhelocard_allOf_credentials() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIKhelocard_allOf_credentials)

#endif // OAIKhelocard_allOf_credentials_H
