...
/*
 * OAICommonPayPalAccount.h
 *
 * 
 */

#ifndef OAICommonPayPalAccount_H
#define OAICommonPayPalAccount_H
...
class OAICommonPayPalAccount : public OAIObject {
public:
    OAICommonPayPalAccount();
    OAICommonPayPalAccount(QString json);
    ~OAICommonPayPalAccount() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICommonPayPalAccount)

#endif // OAICommonPayPalAccount_H
