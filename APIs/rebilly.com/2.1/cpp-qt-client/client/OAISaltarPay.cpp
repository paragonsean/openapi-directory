...
OAISaltarPay::OAISaltarPay(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISaltarPay::OAISaltarPay() {
    this->initializeModel();
}

OAISaltarPay::~OAISaltarPay() {}

void OAISaltarPay::initializeModel() {
...
void OAISaltarPay::fromJson(QString jsonString) {
...
void OAISaltarPay::fromJsonObject(QJsonObject json) {
...
QString OAISaltarPay::asJson() const {
...
QJsonObject OAISaltarPay::asJsonObject() const {
    QJsonObject obj;
    if (m__links.size() > 0) {
...
QList<OAIGatewayAccount__links_inner> OAISaltarPay::getLinks() const {
    return m__links;
}
void OAISaltarPay::setLinks(const QList<OAIGatewayAccount__links_inner> &_links) {
    m__links = _links;
    m__links_isSet = true;
}

bool OAISaltarPay::is__links_Set() const{
    return m__links_isSet;
}

bool OAISaltarPay::is__links_Valid() const{
    return m__links_isValid;
}

QList<QString> OAISaltarPay::getAcceptedCurrencies() const {
    return m_accepted_currencies;
}
void OAISaltarPay::setAcceptedCurrencies(const QList<QString> &accepted_currencies) {
    m_accepted_currencies = accepted_currencies;
    m_accepted_currencies_isSet = true;
}

bool OAISaltarPay::is_accepted_currencies_Set() const{
    return m_accepted_currencies_isSet;
}

bool OAISaltarPay::is_accepted_currencies_Valid() const{
    return m_accepted_currencies_isValid;
}

OAIAcquirerName OAISaltarPay::getAcquirerName() const {
    return m_acquirer_name;
}
void OAISaltarPay::setAcquirerName(const OAIAcquirerName &acquirer_name) {
    m_acquirer_name = acquirer_name;
    m_acquirer_name_isSet = true;
}

bool OAISaltarPay::is_acquirer_name_Set() const{
    return m_acquirer_name_isSet;
}

bool OAISaltarPay::is_acquirer_name_Valid() const{
    return m_acquirer_name_isValid;
}

QString OAISaltarPay::getAdditionalFilters() const {
    return m_additional_filters;
}
void OAISaltarPay::setAdditionalFilters(const QString &additional_filters) {
    m_additional_filters = additional_filters;
    m_additional_filters_isSet = true;
}

bool OAISaltarPay::is_additional_filters_Set() const{
    return m_additional_filters_isSet;
}

bool OAISaltarPay::is_additional_filters_Valid() const{
    return m_additional_filters_isValid;
}

qint32 OAISaltarPay::getApprovalWindowTtl() const {
    return m_approval_window_ttl;
}
void OAISaltarPay::setApprovalWindowTtl(const qint32 &approval_window_ttl) {
    m_approval_window_ttl = approval_window_ttl;
    m_approval_window_ttl_isSet = true;
}

bool OAISaltarPay::is_approval_window_ttl_Set() const{
    return m_approval_window_ttl_isSet;
}

bool OAISaltarPay::is_approval_window_ttl_Valid() const{
    return m_approval_window_ttl_isValid;
}

QString OAISaltarPay::getCityField() const {
    return m_city_field;
}
void OAISaltarPay::setCityField(const QString &city_field) {
    m_city_field = city_field;
    m_city_field_isSet = true;
}

bool OAISaltarPay::is_city_field_Set() const{
    return m_city_field_isSet;
}

bool OAISaltarPay::is_city_field_Valid() const{
    return m_city_field_isValid;
}

QDateTime OAISaltarPay::getCreatedTime() const {
    return m_created_time;
}
void OAISaltarPay::setCreatedTime(const QDateTime &created_time) {
    m_created_time = created_time;
    m_created_time_isSet = true;
}

bool OAISaltarPay::is_created_time_Set() const{
    return m_created_time_isSet;
}

bool OAISaltarPay::is_created_time_Valid() const{
    return m_created_time_isValid;
}

QString OAISaltarPay::getDccForceCurrency() const {
    return m_dcc_force_currency;
}
void OAISaltarPay::setDccForceCurrency(const QString &dcc_force_currency) {
    m_dcc_force_currency = dcc_force_currency;
    m_dcc_force_currency_isSet = true;
}

bool OAISaltarPay::is_dcc_force_currency_Set() const{
    return m_dcc_force_currency_isSet;
}

bool OAISaltarPay::is_dcc_force_currency_Valid() const{
    return m_dcc_force_currency_isValid;
}

qint32 OAISaltarPay::getDccMarkup() const {
    return m_dcc_markup;
}
void OAISaltarPay::setDccMarkup(const qint32 &dcc_markup) {
    m_dcc_markup = dcc_markup;
    m_dcc_markup_isSet = true;
}

bool OAISaltarPay::is_dcc_markup_Set() const{
    return m_dcc_markup_isSet;
}

bool OAISaltarPay::is_dcc_markup_Valid() const{
    return m_dcc_markup_isValid;
}

QString OAISaltarPay::getDescriptor() const {
    return m_descriptor;
}
void OAISaltarPay::setDescriptor(const QString &descriptor) {
    m_descriptor = descriptor;
    m_descriptor_isSet = true;
}

bool OAISaltarPay::is_descriptor_Set() const{
    return m_descriptor_isSet;
}

bool OAISaltarPay::is_descriptor_Valid() const{
    return m_descriptor_isValid;
}

OAIDigitalWallets OAISaltarPay::getDigitalWallets() const {
    return m_digital_wallets;
}
void OAISaltarPay::setDigitalWallets(const OAIDigitalWallets &digital_wallets) {
    m_digital_wallets = digital_wallets;
    m_digital_wallets_isSet = true;
}

bool OAISaltarPay::is_digital_wallets_Set() const{
    return m_digital_wallets_isSet;
}

bool OAISaltarPay::is_digital_wallets_Valid() const{
    return m_digital_wallets_isValid;
}

bool OAISaltarPay::isDynamicDescriptor() const {
    return m_dynamic_descriptor;
}
void OAISaltarPay::setDynamicDescriptor(const bool &dynamic_descriptor) {
    m_dynamic_descriptor = dynamic_descriptor;
    m_dynamic_descriptor_isSet = true;
}

bool OAISaltarPay::is_dynamic_descriptor_Set() const{
    return m_dynamic_descriptor_isSet;
}

bool OAISaltarPay::is_dynamic_descriptor_Valid() const{
    return m_dynamic_descriptor_isValid;
}

QList<QString> OAISaltarPay::getExcludedDccQuoteCurrencies() const {
    return m_excluded_dcc_quote_currencies;
}
void OAISaltarPay::setExcludedDccQuoteCurrencies(const QList<QString> &excluded_dcc_quote_currencies) {
    m_excluded_dcc_quote_currencies = excluded_dcc_quote_currencies;
    m_excluded_dcc_quote_currencies_isSet = true;
}

bool OAISaltarPay::is_excluded_dcc_quote_currencies_Set() const{
    return m_excluded_dcc_quote_currencies_isSet;
}

bool OAISaltarPay::is_excluded_dcc_quote_currencies_Valid() const{
    return m_excluded_dcc_quote_currencies_isValid;
}

OAIGatewayName OAISaltarPay::getGatewayName() const {
    return m_gateway_name;
}
void OAISaltarPay::setGatewayName(const OAIGatewayName &gateway_name) {
    m_gateway_name = gateway_name;
    m_gateway_name_isSet = true;
}

bool OAISaltarPay::is_gateway_name_Set() const{
    return m_gateway_name_isSet;
}

bool OAISaltarPay::is_gateway_name_Valid() const{
    return m_gateway_name_isValid;
}

QString OAISaltarPay::getId() const {
    return m_id;
}
void OAISaltarPay::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAISaltarPay::is_id_Set() const{
    return m_id_isSet;
}

bool OAISaltarPay::is_id_Valid() const{
    return m_id_isValid;
}

bool OAISaltarPay::isIsDown() const {
    return m_is_down;
}
void OAISaltarPay::setIsDown(const bool &is_down) {
    m_is_down = is_down;
    m_is_down_isSet = true;
}

bool OAISaltarPay::is_is_down_Set() const{
    return m_is_down_isSet;
}

bool OAISaltarPay::is_is_down_Valid() const{
    return m_is_down_isValid;
}

QString OAISaltarPay::getMerchantCategoryCode() const {
    return m_merchant_category_code;
}
void OAISaltarPay::setMerchantCategoryCode(const QString &merchant_category_code) {
    m_merchant_category_code = merchant_category_code;
    m_merchant_category_code_isSet = true;
}

bool OAISaltarPay::is_merchant_category_code_Set() const{
    return m_merchant_category_code_isSet;
}

bool OAISaltarPay::is_merchant_category_code_Valid() const{
    return m_merchant_category_code_isValid;
}

OAIPaymentMethod OAISaltarPay::getMethod() const {
    return m_method;
}
void OAISaltarPay::setMethod(const OAIPaymentMethod &method) {
    m_method = method;
    m_method_isSet = true;
}

bool OAISaltarPay::is_method_Set() const{
    return m_method_isSet;
}

bool OAISaltarPay::is_method_Valid() const{
    return m_method_isValid;
}

double OAISaltarPay::getMonthlyLimit() const {
    return m_monthly_limit;
}
void OAISaltarPay::setMonthlyLimit(const double &monthly_limit) {
    m_monthly_limit = monthly_limit;
    m_monthly_limit_isSet = true;
}

bool OAISaltarPay::is_monthly_limit_Set() const{
    return m_monthly_limit_isSet;
}

bool OAISaltarPay::is_monthly_limit_Valid() const{
    return m_monthly_limit_isValid;
}

QString OAISaltarPay::getOrganizationId() const {
    return m_organization_id;
}
void OAISaltarPay::setOrganizationId(const QString &organization_id) {
    m_organization_id = organization_id;
    m_organization_id_isSet = true;
}

bool OAISaltarPay::is_organization_id_Set() const{
    return m_organization_id_isSet;
}

bool OAISaltarPay::is_organization_id_Valid() const{
    return m_organization_id_isValid;
}

QList<OAIPaymentCardBrand> OAISaltarPay::getPaymentCardSchemes() const {
    return m_payment_card_schemes;
}
void OAISaltarPay::setPaymentCardSchemes(const QList<OAIPaymentCardBrand> &payment_card_schemes) {
    m_payment_card_schemes = payment_card_schemes;
    m_payment_card_schemes_isSet = true;
}

bool OAISaltarPay::is_payment_card_schemes_Set() const{
    return m_payment_card_schemes_isSet;
}

bool OAISaltarPay::is_payment_card_schemes_Valid() const{
    return m_payment_card_schemes_isValid;
}

bool OAISaltarPay::isReconciliationWindowEnabled() const {
    return m_reconciliation_window_enabled;
}
void OAISaltarPay::setReconciliationWindowEnabled(const bool &reconciliation_window_enabled) {
    m_reconciliation_window_enabled = reconciliation_window_enabled;
    m_reconciliation_window_enabled_isSet = true;
}

bool OAISaltarPay::is_reconciliation_window_enabled_Set() const{
    return m_reconciliation_window_enabled_isSet;
}

bool OAISaltarPay::is_reconciliation_window_enabled_Valid() const{
    return m_reconciliation_window_enabled_isValid;
}

qint32 OAISaltarPay::getReconciliationWindowTtl() const {
    return m_reconciliation_window_ttl;
}
void OAISaltarPay::setReconciliationWindowTtl(const qint32 &reconciliation_window_ttl) {
    m_reconciliation_window_ttl = reconciliation_window_ttl;
    m_reconciliation_window_ttl_isSet = true;
}

bool OAISaltarPay::is_reconciliation_window_ttl_Set() const{
    return m_reconciliation_window_ttl_isSet;
}

bool OAISaltarPay::is_reconciliation_window_ttl_Valid() const{
    return m_reconciliation_window_ttl_isValid;
}

QString OAISaltarPay::getStatus() const {
    return m_status;
}
void OAISaltarPay::setStatus(const QString &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAISaltarPay::is_status_Set() const{
    return m_status_isSet;
}

bool OAISaltarPay::is_status_Valid() const{
    return m_status_isValid;
}

bool OAISaltarPay::isSticky() const {
    return m_sticky;
}
void OAISaltarPay::setSticky(const bool &sticky) {
    m_sticky = sticky;
    m_sticky_isSet = true;
}

bool OAISaltarPay::is_sticky_Set() const{
    return m_sticky_isSet;
}

bool OAISaltarPay::is_sticky_Valid() const{
    return m_sticky_isValid;
}

bool OAISaltarPay::isThreeDSecure() const {
    return m_three_d_secure;
}
void OAISaltarPay::setThreeDSecure(const bool &three_d_secure) {
    m_three_d_secure = three_d_secure;
    m_three_d_secure_isSet = true;
}

bool OAISaltarPay::is_three_d_secure_Set() const{
    return m_three_d_secure_isSet;
}

bool OAISaltarPay::is_three_d_secure_Valid() const{
    return m_three_d_secure_isValid;
}

qint32 OAISaltarPay::getTimeout() const {
    return m_timeout;
}
void OAISaltarPay::setTimeout(const qint32 &timeout) {
    m_timeout = timeout;
    m_timeout_isSet = true;
}

bool OAISaltarPay::is_timeout_Set() const{
    return m_timeout_isSet;
}

bool OAISaltarPay::is_timeout_Valid() const{
    return m_timeout_isValid;
}

QString OAISaltarPay::getToken() const {
    return m_token;
}
void OAISaltarPay::setToken(const QString &token) {
    m_token = token;
    m_token_isSet = true;
}

bool OAISaltarPay::is_token_Set() const{
    return m_token_isSet;
}

bool OAISaltarPay::is_token_Valid() const{
    return m_token_isValid;
}

QDateTime OAISaltarPay::getUpdatedTime() const {
    return m_updated_time;
}
void OAISaltarPay::setUpdatedTime(const QDateTime &updated_time) {
    m_updated_time = updated_time;
    m_updated_time_isSet = true;
}

bool OAISaltarPay::is_updated_time_Set() const{
    return m_updated_time_isSet;
}

bool OAISaltarPay::is_updated_time_Valid() const{
    return m_updated_time_isValid;
}

OAISaltarPay_allOf_credentials OAISaltarPay::getCredentials() const {
    return m_credentials;
}
void OAISaltarPay::setCredentials(const OAISaltarPay_allOf_credentials &credentials) {
    m_credentials = credentials;
    m_credentials_isSet = true;
}

bool OAISaltarPay::is_credentials_Set() const{
    return m_credentials_isSet;
}

bool OAISaltarPay::is_credentials_Valid() const{
    return m_credentials_isValid;
}

bool OAISaltarPay::isSet() const {
...
bool OAISaltarPay::isValid() const {
