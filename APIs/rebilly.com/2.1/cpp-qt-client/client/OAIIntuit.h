...
#include "OAIIntuit_allOf_credentials.h"
...
class OAIIntuit_allOf_credentials;

class OAIIntuit : public OAIObject {
public:
    OAIIntuit();
    OAIIntuit(QString json);
    ~OAIIntuit() override;
    ...
    OAIIntuit_allOf_credentials getCredentials() const;
    void setCredentials(const OAIIntuit_allOf_credentials &credentials);
...
private:
    ...
    OAIIntuit_allOf_credentials m_credentials;
...
Q_DECLARE_METATYPE(OpenAPI::OAIIntuit)
