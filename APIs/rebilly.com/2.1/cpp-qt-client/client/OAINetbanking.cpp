...
OAINetbanking::OAINetbanking(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAINetbanking::OAINetbanking() {
    this->initializeModel();
}

OAINetbanking::~OAINetbanking() {}

void OAINetbanking::initializeModel() {
...
void OAINetbanking::fromJson(QString jsonString) {
...
void OAINetbanking::fromJsonObject(QJsonObject json) {
...
QString OAINetbanking::asJson() const {
...
QJsonObject OAINetbanking::asJsonObject() const {
    QJsonObject obj;
    if (m__links.size() > 0) {
...
QList<OAIGatewayAccount__links_inner> OAINetbanking::getLinks() const {
    return m__links;
}
void OAINetbanking::setLinks(const QList<OAIGatewayAccount__links_inner> &_links) {
    m__links = _links;
    m__links_isSet = true;
}

bool OAINetbanking::is__links_Set() const{
    return m__links_isSet;
}

bool OAINetbanking::is__links_Valid() const{
    return m__links_isValid;
}

QList<QString> OAINetbanking::getAcceptedCurrencies() const {
    return m_accepted_currencies;
}
void OAINetbanking::setAcceptedCurrencies(const QList<QString> &accepted_currencies) {
    m_accepted_currencies = accepted_currencies;
    m_accepted_currencies_isSet = true;
}

bool OAINetbanking::is_accepted_currencies_Set() const{
    return m_accepted_currencies_isSet;
}

bool OAINetbanking::is_accepted_currencies_Valid() const{
    return m_accepted_currencies_isValid;
}

OAIAcquirerName OAINetbanking::getAcquirerName() const {
    return m_acquirer_name;
}
void OAINetbanking::setAcquirerName(const OAIAcquirerName &acquirer_name) {
    m_acquirer_name = acquirer_name;
    m_acquirer_name_isSet = true;
}

bool OAINetbanking::is_acquirer_name_Set() const{
    return m_acquirer_name_isSet;
}

bool OAINetbanking::is_acquirer_name_Valid() const{
    return m_acquirer_name_isValid;
}

QString OAINetbanking::getAdditionalFilters() const {
    return m_additional_filters;
}
void OAINetbanking::setAdditionalFilters(const QString &additional_filters) {
    m_additional_filters = additional_filters;
    m_additional_filters_isSet = true;
}

bool OAINetbanking::is_additional_filters_Set() const{
    return m_additional_filters_isSet;
}

bool OAINetbanking::is_additional_filters_Valid() const{
    return m_additional_filters_isValid;
}

qint32 OAINetbanking::getApprovalWindowTtl() const {
    return m_approval_window_ttl;
}
void OAINetbanking::setApprovalWindowTtl(const qint32 &approval_window_ttl) {
    m_approval_window_ttl = approval_window_ttl;
    m_approval_window_ttl_isSet = true;
}

bool OAINetbanking::is_approval_window_ttl_Set() const{
    return m_approval_window_ttl_isSet;
}

bool OAINetbanking::is_approval_window_ttl_Valid() const{
    return m_approval_window_ttl_isValid;
}

QString OAINetbanking::getCityField() const {
    return m_city_field;
}
void OAINetbanking::setCityField(const QString &city_field) {
    m_city_field = city_field;
    m_city_field_isSet = true;
}

bool OAINetbanking::is_city_field_Set() const{
    return m_city_field_isSet;
}

bool OAINetbanking::is_city_field_Valid() const{
    return m_city_field_isValid;
}

QDateTime OAINetbanking::getCreatedTime() const {
    return m_created_time;
}
void OAINetbanking::setCreatedTime(const QDateTime &created_time) {
    m_created_time = created_time;
    m_created_time_isSet = true;
}

bool OAINetbanking::is_created_time_Set() const{
    return m_created_time_isSet;
}

bool OAINetbanking::is_created_time_Valid() const{
    return m_created_time_isValid;
}

QString OAINetbanking::getDccForceCurrency() const {
    return m_dcc_force_currency;
}
void OAINetbanking::setDccForceCurrency(const QString &dcc_force_currency) {
    m_dcc_force_currency = dcc_force_currency;
    m_dcc_force_currency_isSet = true;
}

bool OAINetbanking::is_dcc_force_currency_Set() const{
    return m_dcc_force_currency_isSet;
}

bool OAINetbanking::is_dcc_force_currency_Valid() const{
    return m_dcc_force_currency_isValid;
}

qint32 OAINetbanking::getDccMarkup() const {
    return m_dcc_markup;
}
void OAINetbanking::setDccMarkup(const qint32 &dcc_markup) {
    m_dcc_markup = dcc_markup;
    m_dcc_markup_isSet = true;
}

bool OAINetbanking::is_dcc_markup_Set() const{
    return m_dcc_markup_isSet;
}

bool OAINetbanking::is_dcc_markup_Valid() const{
    return m_dcc_markup_isValid;
}

QString OAINetbanking::getDescriptor() const {
    return m_descriptor;
}
void OAINetbanking::setDescriptor(const QString &descriptor) {
    m_descriptor = descriptor;
    m_descriptor_isSet = true;
}

bool OAINetbanking::is_descriptor_Set() const{
    return m_descriptor_isSet;
}

bool OAINetbanking::is_descriptor_Valid() const{
    return m_descriptor_isValid;
}

OAIDigitalWallets OAINetbanking::getDigitalWallets() const {
    return m_digital_wallets;
}
void OAINetbanking::setDigitalWallets(const OAIDigitalWallets &digital_wallets) {
    m_digital_wallets = digital_wallets;
    m_digital_wallets_isSet = true;
}

bool OAINetbanking::is_digital_wallets_Set() const{
    return m_digital_wallets_isSet;
}

bool OAINetbanking::is_digital_wallets_Valid() const{
    return m_digital_wallets_isValid;
}

bool OAINetbanking::isDynamicDescriptor() const {
    return m_dynamic_descriptor;
}
void OAINetbanking::setDynamicDescriptor(const bool &dynamic_descriptor) {
    m_dynamic_descriptor = dynamic_descriptor;
    m_dynamic_descriptor_isSet = true;
}

bool OAINetbanking::is_dynamic_descriptor_Set() const{
    return m_dynamic_descriptor_isSet;
}

bool OAINetbanking::is_dynamic_descriptor_Valid() const{
    return m_dynamic_descriptor_isValid;
}

QList<QString> OAINetbanking::getExcludedDccQuoteCurrencies() const {
    return m_excluded_dcc_quote_currencies;
}
void OAINetbanking::setExcludedDccQuoteCurrencies(const QList<QString> &excluded_dcc_quote_currencies) {
    m_excluded_dcc_quote_currencies = excluded_dcc_quote_currencies;
    m_excluded_dcc_quote_currencies_isSet = true;
}

bool OAINetbanking::is_excluded_dcc_quote_currencies_Set() const{
    return m_excluded_dcc_quote_currencies_isSet;
}

bool OAINetbanking::is_excluded_dcc_quote_currencies_Valid() const{
    return m_excluded_dcc_quote_currencies_isValid;
}

OAIGatewayName OAINetbanking::getGatewayName() const {
    return m_gateway_name;
}
void OAINetbanking::setGatewayName(const OAIGatewayName &gateway_name) {
    m_gateway_name = gateway_name;
    m_gateway_name_isSet = true;
}

bool OAINetbanking::is_gateway_name_Set() const{
    return m_gateway_name_isSet;
}

bool OAINetbanking::is_gateway_name_Valid() const{
    return m_gateway_name_isValid;
}

QString OAINetbanking::getId() const {
    return m_id;
}
void OAINetbanking::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAINetbanking::is_id_Set() const{
    return m_id_isSet;
}

bool OAINetbanking::is_id_Valid() const{
    return m_id_isValid;
}

bool OAINetbanking::isIsDown() const {
    return m_is_down;
}
void OAINetbanking::setIsDown(const bool &is_down) {
    m_is_down = is_down;
    m_is_down_isSet = true;
}

bool OAINetbanking::is_is_down_Set() const{
    return m_is_down_isSet;
}

bool OAINetbanking::is_is_down_Valid() const{
    return m_is_down_isValid;
}

QString OAINetbanking::getMerchantCategoryCode() const {
    return m_merchant_category_code;
}
void OAINetbanking::setMerchantCategoryCode(const QString &merchant_category_code) {
    m_merchant_category_code = merchant_category_code;
    m_merchant_category_code_isSet = true;
}

bool OAINetbanking::is_merchant_category_code_Set() const{
    return m_merchant_category_code_isSet;
}

bool OAINetbanking::is_merchant_category_code_Valid() const{
    return m_merchant_category_code_isValid;
}

OAIPaymentMethod OAINetbanking::getMethod() const {
    return m_method;
}
void OAINetbanking::setMethod(const OAIPaymentMethod &method) {
    m_method = method;
    m_method_isSet = true;
}

bool OAINetbanking::is_method_Set() const{
    return m_method_isSet;
}

bool OAINetbanking::is_method_Valid() const{
    return m_method_isValid;
}

double OAINetbanking::getMonthlyLimit() const {
    return m_monthly_limit;
}
void OAINetbanking::setMonthlyLimit(const double &monthly_limit) {
    m_monthly_limit = monthly_limit;
    m_monthly_limit_isSet = true;
}

bool OAINetbanking::is_monthly_limit_Set() const{
    return m_monthly_limit_isSet;
}

bool OAINetbanking::is_monthly_limit_Valid() const{
    return m_monthly_limit_isValid;
}

QString OAINetbanking::getOrganizationId() const {
    return m_organization_id;
}
void OAINetbanking::setOrganizationId(const QString &organization_id) {
    m_organization_id = organization_id;
    m_organization_id_isSet = true;
}

bool OAINetbanking::is_organization_id_Set() const{
    return m_organization_id_isSet;
}

bool OAINetbanking::is_organization_id_Valid() const{
    return m_organization_id_isValid;
}

QList<OAIPaymentCardBrand> OAINetbanking::getPaymentCardSchemes() const {
    return m_payment_card_schemes;
}
void OAINetbanking::setPaymentCardSchemes(const QList<OAIPaymentCardBrand> &payment_card_schemes) {
    m_payment_card_schemes = payment_card_schemes;
    m_payment_card_schemes_isSet = true;
}

bool OAINetbanking::is_payment_card_schemes_Set() const{
    return m_payment_card_schemes_isSet;
}

bool OAINetbanking::is_payment_card_schemes_Valid() const{
    return m_payment_card_schemes_isValid;
}

bool OAINetbanking::isReconciliationWindowEnabled() const {
    return m_reconciliation_window_enabled;
}
void OAINetbanking::setReconciliationWindowEnabled(const bool &reconciliation_window_enabled) {
    m_reconciliation_window_enabled = reconciliation_window_enabled;
    m_reconciliation_window_enabled_isSet = true;
}

bool OAINetbanking::is_reconciliation_window_enabled_Set() const{
    return m_reconciliation_window_enabled_isSet;
}

bool OAINetbanking::is_reconciliation_window_enabled_Valid() const{
    return m_reconciliation_window_enabled_isValid;
}

qint32 OAINetbanking::getReconciliationWindowTtl() const {
    return m_reconciliation_window_ttl;
}
void OAINetbanking::setReconciliationWindowTtl(const qint32 &reconciliation_window_ttl) {
    m_reconciliation_window_ttl = reconciliation_window_ttl;
    m_reconciliation_window_ttl_isSet = true;
}

bool OAINetbanking::is_reconciliation_window_ttl_Set() const{
    return m_reconciliation_window_ttl_isSet;
}

bool OAINetbanking::is_reconciliation_window_ttl_Valid() const{
    return m_reconciliation_window_ttl_isValid;
}

QString OAINetbanking::getStatus() const {
    return m_status;
}
void OAINetbanking::setStatus(const QString &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAINetbanking::is_status_Set() const{
    return m_status_isSet;
}

bool OAINetbanking::is_status_Valid() const{
    return m_status_isValid;
}

bool OAINetbanking::isSticky() const {
    return m_sticky;
}
void OAINetbanking::setSticky(const bool &sticky) {
    m_sticky = sticky;
    m_sticky_isSet = true;
}

bool OAINetbanking::is_sticky_Set() const{
    return m_sticky_isSet;
}

bool OAINetbanking::is_sticky_Valid() const{
    return m_sticky_isValid;
}

bool OAINetbanking::isThreeDSecure() const {
    return m_three_d_secure;
}
void OAINetbanking::setThreeDSecure(const bool &three_d_secure) {
    m_three_d_secure = three_d_secure;
    m_three_d_secure_isSet = true;
}

bool OAINetbanking::is_three_d_secure_Set() const{
    return m_three_d_secure_isSet;
}

bool OAINetbanking::is_three_d_secure_Valid() const{
    return m_three_d_secure_isValid;
}

qint32 OAINetbanking::getTimeout() const {
    return m_timeout;
}
void OAINetbanking::setTimeout(const qint32 &timeout) {
    m_timeout = timeout;
    m_timeout_isSet = true;
}

bool OAINetbanking::is_timeout_Set() const{
    return m_timeout_isSet;
}

bool OAINetbanking::is_timeout_Valid() const{
    return m_timeout_isValid;
}

QString OAINetbanking::getToken() const {
    return m_token;
}
void OAINetbanking::setToken(const QString &token) {
    m_token = token;
    m_token_isSet = true;
}

bool OAINetbanking::is_token_Set() const{
    return m_token_isSet;
}

bool OAINetbanking::is_token_Valid() const{
    return m_token_isValid;
}

QDateTime OAINetbanking::getUpdatedTime() const {
    return m_updated_time;
}
void OAINetbanking::setUpdatedTime(const QDateTime &updated_time) {
    m_updated_time = updated_time;
    m_updated_time_isSet = true;
}

bool OAINetbanking::is_updated_time_Set() const{
    return m_updated_time_isSet;
}

bool OAINetbanking::is_updated_time_Valid() const{
    return m_updated_time_isValid;
}

OAINetbanking_allOf_credentials OAINetbanking::getCredentials() const {
    return m_credentials;
}
void OAINetbanking::setCredentials(const OAINetbanking_allOf_credentials &credentials) {
    m_credentials = credentials;
    m_credentials_isSet = true;
}

bool OAINetbanking::is_credentials_Set() const{
    return m_credentials_isSet;
}

bool OAINetbanking::is_credentials_Valid() const{
    return m_credentials_isValid;
}

bool OAINetbanking::isSet() const {
...
bool OAINetbanking::isValid() const {
