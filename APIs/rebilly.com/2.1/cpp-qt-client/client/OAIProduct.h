...
public:
    ...
    QString getAccountingCode() const;
    void setAccountingCode(const QString &accounting_code);
    bool is_accounting_code_Set() const;
    bool is_accounting_code_Valid() const;
...
private:
    ...
    QString m_accounting_code;
    bool m_accounting_code_isSet;
    bool m_accounting_code_isValid;
