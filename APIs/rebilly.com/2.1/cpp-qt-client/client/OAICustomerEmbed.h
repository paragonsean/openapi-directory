...
#ifndef OAICustomerEmbed_H
#define OAICustomerEmbed_H
...
class OAICustomerEmbed : public OAIObject {
public:
    OAICustomerEmbed();
    OAICustomerEmbed(QString json);
    ~OAICustomerEmbed() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICustomerEmbed)

#endif // OAICustomerEmbed_H
