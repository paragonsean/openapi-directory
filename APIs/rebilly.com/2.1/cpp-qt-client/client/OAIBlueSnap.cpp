...
OAIBlueSnap::OAIBlueSnap(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIBlueSnap::OAIBlueSnap() {
    this->initializeModel();
}

OAIBlueSnap::~OAIBlueSnap() {}

void OAIBlueSnap::initializeModel() {
...
void OAIBlueSnap::fromJson(QString jsonString) {
...
void OAIBlueSnap::fromJsonObject(QJsonObject json) {
...
QString OAIBlueSnap::asJson() const {
...
QJsonObject OAIBlueSnap::asJsonObject() const {
    QJsonObject obj;
    if (m__links.size() > 0) {
...
QList<OAIGatewayAccount__links_inner> OAIBlueSnap::getLinks() const {
    return m__links;
}
void OAIBlueSnap::setLinks(const QList<OAIGatewayAccount__links_inner> &_links) {
    m__links = _links;
    m__links_isSet = true;
}

bool OAIBlueSnap::is__links_Set() const{
    return m__links_isSet;
}

bool OAIBlueSnap::is__links_Valid() const{
    return m__links_isValid;
}

QList<QString> OAIBlueSnap::getAcceptedCurrencies() const {
    return m_accepted_currencies;
}
void OAIBlueSnap::setAcceptedCurrencies(const QList<QString> &accepted_currencies) {
    m_accepted_currencies = accepted_currencies;
    m_accepted_currencies_isSet = true;
}

bool OAIBlueSnap::is_accepted_currencies_Set() const{
    return m_accepted_currencies_isSet;
}

bool OAIBlueSnap::is_accepted_currencies_Valid() const{
    return m_accepted_currencies_isValid;
}

OAIAcquirerName OAIBlueSnap::getAcquirerName() const {
    return m_acquirer_name;
}
void OAIBlueSnap::setAcquirerName(const OAIAcquirerName &acquirer_name) {
    m_acquirer_name = acquirer_name;
    m_acquirer_name_isSet = true;
}

bool OAIBlueSnap::is_acquirer_name_Set() const{
    return m_acquirer_name_isSet;
}

bool OAIBlueSnap::is_acquirer_name_Valid() const{
    return m_acquirer_name_isValid;
}

QString OAIBlueSnap::getAdditionalFilters() const {
    return m_additional_filters;
}
void OAIBlueSnap::setAdditionalFilters(const QString &additional_filters) {
    m_additional_filters = additional_filters;
    m_additional_filters_isSet = true;
}

bool OAIBlueSnap::is_additional_filters_Set() const{
    return m_additional_filters_isSet;
}

bool OAIBlueSnap::is_additional_filters_Valid() const{
    return m_additional_filters_isValid;
}

qint32 OAIBlueSnap::getApprovalWindowTtl() const {
    return m_approval_window_ttl;
}
void OAIBlueSnap::setApprovalWindowTtl(const qint32 &approval_window_ttl) {
    m_approval_window_ttl = approval_window_ttl;
    m_approval_window_ttl_isSet = true;
}

bool OAIBlueSnap::is_approval_window_ttl_Set() const{
    return m_approval_window_ttl_isSet;
}

bool OAIBlueSnap::is_approval_window_ttl_Valid() const{
    return m_approval_window_ttl_isValid;
}

QString OAIBlueSnap::getCityField() const {
    return m_city_field;
}
void OAIBlueSnap::setCityField(const QString &city_field) {
    m_city_field = city_field;
    m_city_field_isSet = true;
}

bool OAIBlueSnap::is_city_field_Set() const{
    return m_city_field_isSet;
}

bool OAIBlueSnap::is_city_field_Valid() const{
    return m_city_field_isValid;
}

QDateTime OAIBlueSnap::getCreatedTime() const {
    return m_created_time;
}
void OAIBlueSnap::setCreatedTime(const QDateTime &created_time) {
    m_created_time = created_time;
    m_created_time_isSet = true;
}

bool OAIBlueSnap::is_created_time_Set() const{
    return m_created_time_isSet;
}

bool OAIBlueSnap::is_created_time_Valid() const{
    return m_created_time_isValid;
}

QString OAIBlueSnap::getDccForceCurrency() const {
    return m_dcc_force_currency;
}
void OAIBlueSnap::setDccForceCurrency(const QString &dcc_force_currency) {
    m_dcc_force_currency = dcc_force_currency;
    m_dcc_force_currency_isSet = true;
}

bool OAIBlueSnap::is_dcc_force_currency_Set() const{
    return m_dcc_force_currency_isSet;
}

bool OAIBlueSnap::is_dcc_force_currency_Valid() const{
    return m_dcc_force_currency_isValid;
}

qint32 OAIBlueSnap::getDccMarkup() const {
    return m_dcc_markup;
}
void OAIBlueSnap::setDccMarkup(const qint32 &dcc_markup) {
    m_dcc_markup = dcc_markup;
    m_dcc_markup_isSet = true;
}

bool OAIBlueSnap::is_dcc_markup_Set() const{
    return m_dcc_markup_isSet;
}

bool OAIBlueSnap::is_dcc_markup_Valid() const{
    return m_dcc_markup_isValid;
}

QString OAIBlueSnap::getDescriptor() const {
    return m_descriptor;
}
void OAIBlueSnap::setDescriptor(const QString &descriptor) {
    m_descriptor = descriptor;
    m_descriptor_isSet = true;
}

bool OAIBlueSnap::is_descriptor_Set() const{
    return m_descriptor_isSet;
}

bool OAIBlueSnap::is_descriptor_Valid() const{
    return m_descriptor_isValid;
}

OAIDigitalWallets OAIBlueSnap::getDigitalWallets() const {
    return m_digital_wallets;
}
void OAIBlueSnap::setDigitalWallets(const OAIDigitalWallets &digital_wallets) {
    m_digital_wallets = digital_wallets;
    m_digital_wallets_isSet = true;
}

bool OAIBlueSnap::is_digital_wallets_Set() const{
    return m_digital_wallets_isSet;
}

bool OAIBlueSnap::is_digital_wallets_Valid() const{
    return m_digital_wallets_isValid;
}

bool OAIBlueSnap::isDynamicDescriptor() const {
    return m_dynamic_descriptor;
}
void OAIBlueSnap::setDynamicDescriptor(const bool &dynamic_descriptor) {
    m_dynamic_descriptor = dynamic_descriptor;
    m_dynamic_descriptor_isSet = true;
}

bool OAIBlueSnap::is_dynamic_descriptor_Set() const{
    return m_dynamic_descriptor_isSet;
}

bool OAIBlueSnap::is_dynamic_descriptor_Valid() const{
    return m_dynamic_descriptor_isValid;
}

QList<QString> OAIBlueSnap::getExcludedDccQuoteCurrencies() const {
    return m_excluded_dcc_quote_currencies;
}
void OAIBlueSnap::setExcludedDccQuoteCurrencies(const QList<QString> &excluded_dcc_quote_currencies) {
    m_excluded_dcc_quote_currencies = excluded_dcc_quote_currencies;
    m_excluded_dcc_quote_currencies_isSet = true;
}

bool OAIBlueSnap::is_excluded_dcc_quote_currencies_Set() const{
    return m_excluded_dcc_quote_currencies_isSet;
}

bool OAIBlueSnap::is_excluded_dcc_quote_currencies_Valid() const{
    return m_excluded_dcc_quote_currencies_isValid;
}

OAIGatewayName OAIBlueSnap::getGatewayName() const {
    return m_gateway_name;
}
void OAIBlueSnap::setGatewayName(const OAIGatewayName &gateway_name) {
    m_gateway_name = gateway_name;
    m_gateway_name_isSet = true;
}

bool OAIBlueSnap::is_gateway_name_Set() const{
    return m_gateway_name_isSet;
}

bool OAIBlueSnap::is_gateway_name_Valid() const{
    return m_gateway_name_isValid;
}

QString OAIBlueSnap::getId() const {
    return m_id;
}
void OAIBlueSnap::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIBlueSnap::is_id_Set() const{
    return m_id_isSet;
}

bool OAIBlueSnap::is_id_Valid() const{
    return m_id_isValid;
}

bool OAIBlueSnap::isIsDown() const {
    return m_is_down;
}
void OAIBlueSnap::setIsDown(const bool &is_down) {
    m_is_down = is_down;
    m_is_down_isSet = true;
}

bool OAIBlueSnap::is_is_down_Set() const{
    return m_is_down_isSet;
}

bool OAIBlueSnap::is_is_down_Valid() const{
    return m_is_down_isValid;
}

QString OAIBlueSnap::getMerchantCategoryCode() const {
    return m_merchant_category_code;
}
void OAIBlueSnap::setMerchantCategoryCode(const QString &merchant_category_code) {
    m_merchant_category_code = merchant_category_code;
    m_merchant_category_code_isSet = true;
}

bool OAIBlueSnap::is_merchant_category_code_Set() const{
    return m_merchant_category_code_isSet;
}

bool OAIBlueSnap::is_merchant_category_code_Valid() const{
    return m_merchant_category_code_isValid;
}

OAIPaymentMethod OAIBlueSnap::getMethod() const {
    return m_method;
}
void OAIBlueSnap::setMethod(const OAIPaymentMethod &method) {
    m_method = method;
    m_method_isSet = true;
}

bool OAIBlueSnap::is_method_Set() const{
    return m_method_isSet;
}

bool OAIBlueSnap::is_method_Valid() const{
    return m_method_isValid;
}

double OAIBlueSnap::getMonthlyLimit() const {
    return m_monthly_limit;
}
void OAIBlueSnap::setMonthlyLimit(const double &monthly_limit) {
    m_monthly_limit = monthly_limit;
    m_monthly_limit_isSet = true;
}

bool OAIBlueSnap::is_monthly_limit_Set() const{
    return m_monthly_limit_isSet;
}

bool OAIBlueSnap::is_monthly_limit_Valid() const{
    return m_monthly_limit_isValid;
}

QString OAIBlueSnap::getOrganizationId() const {
    return m_organization_id;
}
void OAIBlueSnap::setOrganizationId(const QString &organization_id) {
    m_organization_id = organization_id;
    m_organization_id_isSet = true;
}

bool OAIBlueSnap::is_organization_id_Set() const{
    return m_organization_id_isSet;
}

bool OAIBlueSnap::is_organization_id_Valid() const{
    return m_organization_id_isValid;
}

QList<OAIPaymentCardBrand> OAIBlueSnap::getPaymentCardSchemes() const {
    return m_payment_card_schemes;
}
void OAIBlueSnap::setPaymentCardSchemes(const QList<OAIPaymentCardBrand> &payment_card_schemes) {
    m_payment_card_schemes = payment_card_schemes;
    m_payment_card_schemes_isSet = true;
}

bool OAIBlueSnap::is_payment_card_schemes_Set() const{
    return m_payment_card_schemes_isSet;
}

bool OAIBlueSnap::is_payment_card_schemes_Valid() const{
    return m_payment_card_schemes_isValid;
}

bool OAIBlueSnap::isReconciliationWindowEnabled() const {
    return m_reconciliation_window_enabled;
}
void OAIBlueSnap::setReconciliationWindowEnabled(const bool &reconciliation_window_enabled) {
    m_reconciliation_window_enabled = reconciliation_window_enabled;
    m_reconciliation_window_enabled_isSet = true;
}

bool OAIBlueSnap::is_reconciliation_window_enabled_Set() const{
    return m_reconciliation_window_enabled_isSet;
}

bool OAIBlueSnap::is_reconciliation_window_enabled_Valid() const{
    return m_reconciliation_window_enabled_isValid;
}

qint32 OAIBlueSnap::getReconciliationWindowTtl() const {
    return m_reconciliation_window_ttl;
}
void OAIBlueSnap::setReconciliationWindowTtl(const qint32 &reconciliation_window_ttl) {
    m_reconciliation_window_ttl = reconciliation_window_ttl;
    m_reconciliation_window_ttl_isSet = true;
}

bool OAIBlueSnap::is_reconciliation_window_ttl_Set() const{
    return m_reconciliation_window_ttl_isSet;
}

bool OAIBlueSnap::is_reconciliation_window_ttl_Valid() const{
    return m_reconciliation_window_ttl_isValid;
}

QString OAIBlueSnap::getStatus() const {
    return m_status;
}
void OAIBlueSnap::setStatus(const QString &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIBlueSnap::is_status_Set() const{
    return m_status_isSet;
}

bool OAIBlueSnap::is_status_Valid() const{
    return m_status_isValid;
}

bool OAIBlueSnap::isSticky() const {
    return m_sticky;
}
void OAIBlueSnap::setSticky(const bool &sticky) {
    m_sticky = sticky;
    m_sticky_isSet = true;
}

bool OAIBlueSnap::is_sticky_Set() const{
    return m_sticky_isSet;
}

bool OAIBlueSnap::is_sticky_Valid() const{
    return m_sticky_isValid;
}

bool OAIBlueSnap::isThreeDSecure() const {
    return m_three_d_secure;
}
void OAIBlueSnap::setThreeDSecure(const bool &three_d_secure) {
    m_three_d_secure = three_d_secure;
    m_three_d_secure_isSet = true;
}

bool OAIBlueSnap::is_three_d_secure_Set() const{
    return m_three_d_secure_isSet;
}

bool OAIBlueSnap::is_three_d_secure_Valid() const{
    return m_three_d_secure_isValid;
}

qint32 OAIBlueSnap::getTimeout() const {
    return m_timeout;
}
void OAIBlueSnap::setTimeout(const qint32 &timeout) {
    m_timeout = timeout;
    m_timeout_isSet = true;
}

bool OAIBlueSnap::is_timeout_Set() const{
    return m_timeout_isSet;
}

bool OAIBlueSnap::is_timeout_Valid() const{
    return m_timeout_isValid;
}

QString OAIBlueSnap::getToken() const {
    return m_token;
}
void OAIBlueSnap::setToken(const QString &token) {
    m_token = token;
    m_token_isSet = true;
}

bool OAIBlueSnap::is_token_Set() const{
    return m_token_isSet;
}

bool OAIBlueSnap::is_token_Valid() const{
    return m_token_isValid;
}

QDateTime OAIBlueSnap::getUpdatedTime() const {
    return m_updated_time;
}
void OAIBlueSnap::setUpdatedTime(const QDateTime &updated_time) {
    m_updated_time = updated_time;
    m_updated_time_isSet = true;
}

bool OAIBlueSnap::is_updated_time_Set() const{
    return m_updated_time_isSet;
}

bool OAIBlueSnap::is_updated_time_Valid() const{
    return m_updated_time_isValid;
}

OAIBlueSnap_allOf_credentials OAIBlueSnap::getCredentials() const {
    return m_credentials;
}
void OAIBlueSnap::setCredentials(const OAIBlueSnap_allOf_credentials &credentials) {
    m_credentials = credentials;
    m_credentials_isSet = true;
}

bool OAIBlueSnap::is_credentials_Set() const{
    return m_credentials_isSet;
}

bool OAIBlueSnap::is_credentials_Valid() const{
    return m_credentials_isValid;
}

bool OAIBlueSnap::isSet() const {
...
bool OAIBlueSnap::isValid() const {
