...
/*
 * OAIPostPaymentCard_request.h
 *
 * 
 */

#ifndef OAIPostPaymentCard_request_H
#define OAIPostPaymentCard_request_H
...
class OAIPostPaymentCard_request : public OAIObject {
public:
    OAIPostPaymentCard_request();
    OAIPostPaymentCard_request(QString json);
    ~OAIPostPaymentCard_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPostPaymentCard_request)

#endif // OAIPostPaymentCard_request_H
