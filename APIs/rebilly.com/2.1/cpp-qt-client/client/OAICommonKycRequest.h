...
/*
 * OAICommonKycRequest.h
 *
 * 
 */

#ifndef OAICommonKycRequest_H
#define OAICommonKycRequest_H
...
class OAICommonKycRequest : public OAIObject {
public:
    OAICommonKycRequest();
    OAICommonKycRequest(QString json);
    ~OAICommonKycRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICommonKycRequest)

#endif // OAICommonKycRequest_H
