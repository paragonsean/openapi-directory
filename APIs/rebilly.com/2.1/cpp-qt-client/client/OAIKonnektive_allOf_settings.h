...
/*
 * OAIKonnektive_allOf_settings.h
 *
 * Settings object.
 */

#ifndef OAIKonnektive_allOf_settings_H
#define OAIKonnektive_allOf_settings_H
...
class OAIKonnektive_allOf_settings : public OAIObject {
public:
    OAIKonnektive_allOf_settings();
    OAIKonnektive_allOf_settings(QString json);
    ~OAIKonnektive_allOf_settings() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIKonnektive_allOf_settings)

#endif // OAIKonnektive_allOf_settings_H
