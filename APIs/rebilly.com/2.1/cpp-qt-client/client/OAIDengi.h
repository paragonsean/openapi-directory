...
#include "OAIDengi_allOf_credentials.h"
...
class OAIDengi_allOf_credentials;

class OAIDengi : public OAIObject {
public:
    OAIDengi();
    OAIDengi(QString json);
    ~OAIDengi() override;
    ...
    OAIDengi_allOf_credentials getCredentials() const;
    void setCredentials(const OAIDengi_allOf_credentials &credentials);
...
private:
    ...
    OAIDengi_allOf_credentials m_credentials;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDengi)
