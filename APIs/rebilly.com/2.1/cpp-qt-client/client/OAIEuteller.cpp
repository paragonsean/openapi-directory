...
OAIEuteller::OAIEuteller(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIEuteller::OAIEuteller() {
    this->initializeModel();
}

OAIEuteller::~OAIEuteller() {}

void OAIEuteller::initializeModel() {
...
void OAIEuteller::fromJson(QString jsonString) {
...
void OAIEuteller::fromJsonObject(QJsonObject json) {
...
QString OAIEuteller::asJson() const {
...
QJsonObject OAIEuteller::asJsonObject() const {
    QJsonObject obj;
    if (m__links.size() > 0) {
...
QList<OAIGatewayAccount__links_inner> OAIEuteller::getLinks() const {
    return m__links;
}
void OAIEuteller::setLinks(const QList<OAIGatewayAccount__links_inner> &_links) {
    m__links = _links;
    m__links_isSet = true;
}

bool OAIEuteller::is__links_Set() const{
    return m__links_isSet;
}

bool OAIEuteller::is__links_Valid() const{
    return m__links_isValid;
}

QList<QString> OAIEuteller::getAcceptedCurrencies() const {
    return m_accepted_currencies;
}
void OAIEuteller::setAcceptedCurrencies(const QList<QString> &accepted_currencies) {
    m_accepted_currencies = accepted_currencies;
    m_accepted_currencies_isSet = true;
}

bool OAIEuteller::is_accepted_currencies_Set() const{
    return m_accepted_currencies_isSet;
}

bool OAIEuteller::is_accepted_currencies_Valid() const{
    return m_accepted_currencies_isValid;
}

OAIAcquirerName OAIEuteller::getAcquirerName() const {
    return m_acquirer_name;
}
void OAIEuteller::setAcquirerName(const OAIAcquirerName &acquirer_name) {
    m_acquirer_name = acquirer_name;
    m_acquirer_name_isSet = true;
}

bool OAIEuteller::is_acquirer_name_Set() const{
    return m_acquirer_name_isSet;
}

bool OAIEuteller::is_acquirer_name_Valid() const{
    return m_acquirer_name_isValid;
}

QString OAIEuteller::getAdditionalFilters() const {
    return m_additional_filters;
}
void OAIEuteller::setAdditionalFilters(const QString &additional_filters) {
    m_additional_filters = additional_filters;
    m_additional_filters_isSet = true;
}

bool OAIEuteller::is_additional_filters_Set() const{
    return m_additional_filters_isSet;
}

bool OAIEuteller::is_additional_filters_Valid() const{
    return m_additional_filters_isValid;
}

qint32 OAIEuteller::getApprovalWindowTtl() const {
    return m_approval_window_ttl;
}
void OAIEuteller::setApprovalWindowTtl(const qint32 &approval_window_ttl) {
    m_approval_window_ttl = approval_window_ttl;
    m_approval_window_ttl_isSet = true;
}

bool OAIEuteller::is_approval_window_ttl_Set() const{
    return m_approval_window_ttl_isSet;
}

bool OAIEuteller::is_approval_window_ttl_Valid() const{
    return m_approval_window_ttl_isValid;
}

QString OAIEuteller::getCityField() const {
    return m_city_field;
}
void OAIEuteller::setCityField(const QString &city_field) {
    m_city_field = city_field;
    m_city_field_isSet = true;
}

bool OAIEuteller::is_city_field_Set() const{
    return m_city_field_isSet;
}

bool OAIEuteller::is_city_field_Valid() const{
    return m_city_field_isValid;
}

QDateTime OAIEuteller::getCreatedTime() const {
    return m_created_time;
}
void OAIEuteller::setCreatedTime(const QDateTime &created_time) {
    m_created_time = created_time;
    m_created_time_isSet = true;
}

bool OAIEuteller::is_created_time_Set() const{
    return m_created_time_isSet;
}

bool OAIEuteller::is_created_time_Valid() const{
    return m_created_time_isValid;
}

QString OAIEuteller::getDccForceCurrency() const {
    return m_dcc_force_currency;
}
void OAIEuteller::setDccForceCurrency(const QString &dcc_force_currency) {
    m_dcc_force_currency = dcc_force_currency;
    m_dcc_force_currency_isSet = true;
}

bool OAIEuteller::is_dcc_force_currency_Set() const{
    return m_dcc_force_currency_isSet;
}

bool OAIEuteller::is_dcc_force_currency_Valid() const{
    return m_dcc_force_currency_isValid;
}

qint32 OAIEuteller::getDccMarkup() const {
    return m_dcc_markup;
}
void OAIEuteller::setDccMarkup(const qint32 &dcc_markup) {
    m_dcc_markup = dcc_markup;
    m_dcc_markup_isSet = true;
}

bool OAIEuteller::is_dcc_markup_Set() const{
    return m_dcc_markup_isSet;
}

bool OAIEuteller::is_dcc_markup_Valid() const{
    return m_dcc_markup_isValid;
}

QString OAIEuteller::getDescriptor() const {
    return m_descriptor;
}
void OAIEuteller::setDescriptor(const QString &descriptor) {
    m_descriptor = descriptor;
    m_descriptor_isSet = true;
}

bool OAIEuteller::is_descriptor_Set() const{
    return m_descriptor_isSet;
}

bool OAIEuteller::is_descriptor_Valid() const{
    return m_descriptor_isValid;
}

OAIDigitalWallets OAIEuteller::getDigitalWallets() const {
    return m_digital_wallets;
}
void OAIEuteller::setDigitalWallets(const OAIDigitalWallets &digital_wallets) {
    m_digital_wallets = digital_wallets;
    m_digital_wallets_isSet = true;
}

bool OAIEuteller::is_digital_wallets_Set() const{
    return m_digital_wallets_isSet;
}

bool OAIEuteller::is_digital_wallets_Valid() const{
    return m_digital_wallets_isValid;
}

bool OAIEuteller::isDynamicDescriptor() const {
    return m_dynamic_descriptor;
}
void OAIEuteller::setDynamicDescriptor(const bool &dynamic_descriptor) {
    m_dynamic_descriptor = dynamic_descriptor;
    m_dynamic_descriptor_isSet = true;
}

bool OAIEuteller::is_dynamic_descriptor_Set() const{
    return m_dynamic_descriptor_isSet;
}

bool OAIEuteller::is_dynamic_descriptor_Valid() const{
    return m_dynamic_descriptor_isValid;
}

QList<QString> OAIEuteller::getExcludedDccQuoteCurrencies() const {
    return m_excluded_dcc_quote_currencies;
}
void OAIEuteller::setExcludedDccQuoteCurrencies(const QList<QString> &excluded_dcc_quote_currencies) {
    m_excluded_dcc_quote_currencies = excluded_dcc_quote_currencies;
    m_excluded_dcc_quote_currencies_isSet = true;
}

bool OAIEuteller::is_excluded_dcc_quote_currencies_Set() const{
    return m_excluded_dcc_quote_currencies_isSet;
}

bool OAIEuteller::is_excluded_dcc_quote_currencies_Valid() const{
    return m_excluded_dcc_quote_currencies_isValid;
}

OAIGatewayName OAIEuteller::getGatewayName() const {
    return m_gateway_name;
}
void OAIEuteller::setGatewayName(const OAIGatewayName &gateway_name) {
    m_gateway_name = gateway_name;
    m_gateway_name_isSet = true;
}

bool OAIEuteller::is_gateway_name_Set() const{
    return m_gateway_name_isSet;
}

bool OAIEuteller::is_gateway_name_Valid() const{
    return m_gateway_name_isValid;
}

QString OAIEuteller::getId() const {
    return m_id;
}
void OAIEuteller::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIEuteller::is_id_Set() const{
    return m_id_isSet;
}

bool OAIEuteller::is_id_Valid() const{
    return m_id_isValid;
}

bool OAIEuteller::isIsDown() const {
    return m_is_down;
}
void OAIEuteller::setIsDown(const bool &is_down) {
    m_is_down = is_down;
    m_is_down_isSet = true;
}

bool OAIEuteller::is_is_down_Set() const{
    return m_is_down_isSet;
}

bool OAIEuteller::is_is_down_Valid() const{
    return m_is_down_isValid;
}

QString OAIEuteller::getMerchantCategoryCode() const {
    return m_merchant_category_code;
}
void OAIEuteller::setMerchantCategoryCode(const QString &merchant_category_code) {
    m_merchant_category_code = merchant_category_code;
    m_merchant_category_code_isSet = true;
}

bool OAIEuteller::is_merchant_category_code_Set() const{
    return m_merchant_category_code_isSet;
}

bool OAIEuteller::is_merchant_category_code_Valid() const{
    return m_merchant_category_code_isValid;
}

OAIPaymentMethod OAIEuteller::getMethod() const {
    return m_method;
}
void OAIEuteller::setMethod(const OAIPaymentMethod &method) {
    m_method = method;
    m_method_isSet = true;
}

bool OAIEuteller::is_method_Set() const{
    return m_method_isSet;
}

bool OAIEuteller::is_method_Valid() const{
    return m_method_isValid;
}

double OAIEuteller::getMonthlyLimit() const {
    return m_monthly_limit;
}
void OAIEuteller::setMonthlyLimit(const double &monthly_limit) {
    m_monthly_limit = monthly_limit;
    m_monthly_limit_isSet = true;
}

bool OAIEuteller::is_monthly_limit_Set() const{
    return m_monthly_limit_isSet;
}

bool OAIEuteller::is_monthly_limit_Valid() const{
    return m_monthly_limit_isValid;
}

QString OAIEuteller::getOrganizationId() const {
    return m_organization_id;
}
void OAIEuteller::setOrganizationId(const QString &organization_id) {
    m_organization_id = organization_id;
    m_organization_id_isSet = true;
}

bool OAIEuteller::is_organization_id_Set() const{
    return m_organization_id_isSet;
}

bool OAIEuteller::is_organization_id_Valid() const{
    return m_organization_id_isValid;
}

QList<OAIPaymentCardBrand> OAIEuteller::getPaymentCardSchemes() const {
    return m_payment_card_schemes;
}
void OAIEuteller::setPaymentCardSchemes(const QList<OAIPaymentCardBrand> &payment_card_schemes) {
    m_payment_card_schemes = payment_card_schemes;
    m_payment_card_schemes_isSet = true;
}

bool OAIEuteller::is_payment_card_schemes_Set() const{
    return m_payment_card_schemes_isSet;
}

bool OAIEuteller::is_payment_card_schemes_Valid() const{
    return m_payment_card_schemes_isValid;
}

bool OAIEuteller::isReconciliationWindowEnabled() const {
    return m_reconciliation_window_enabled;
}
void OAIEuteller::setReconciliationWindowEnabled(const bool &reconciliation_window_enabled) {
    m_reconciliation_window_enabled = reconciliation_window_enabled;
    m_reconciliation_window_enabled_isSet = true;
}

bool OAIEuteller::is_reconciliation_window_enabled_Set() const{
    return m_reconciliation_window_enabled_isSet;
}

bool OAIEuteller::is_reconciliation_window_enabled_Valid() const{
    return m_reconciliation_window_enabled_isValid;
}

qint32 OAIEuteller::getReconciliationWindowTtl() const {
    return m_reconciliation_window_ttl;
}
void OAIEuteller::setReconciliationWindowTtl(const qint32 &reconciliation_window_ttl) {
    m_reconciliation_window_ttl = reconciliation_window_ttl;
    m_reconciliation_window_ttl_isSet = true;
}

bool OAIEuteller::is_reconciliation_window_ttl_Set() const{
    return m_reconciliation_window_ttl_isSet;
}

bool OAIEuteller::is_reconciliation_window_ttl_Valid() const{
    return m_reconciliation_window_ttl_isValid;
}

QString OAIEuteller::getStatus() const {
    return m_status;
}
void OAIEuteller::setStatus(const QString &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIEuteller::is_status_Set() const{
    return m_status_isSet;
}

bool OAIEuteller::is_status_Valid() const{
    return m_status_isValid;
}

bool OAIEuteller::isSticky() const {
    return m_sticky;
}
void OAIEuteller::setSticky(const bool &sticky) {
    m_sticky = sticky;
    m_sticky_isSet = true;
}

bool OAIEuteller::is_sticky_Set() const{
    return m_sticky_isSet;
}

bool OAIEuteller::is_sticky_Valid() const{
    return m_sticky_isValid;
}

bool OAIEuteller::isThreeDSecure() const {
    return m_three_d_secure;
}
void OAIEuteller::setThreeDSecure(const bool &three_d_secure) {
    m_three_d_secure = three_d_secure;
    m_three_d_secure_isSet = true;
}

bool OAIEuteller::is_three_d_secure_Set() const{
    return m_three_d_secure_isSet;
}

bool OAIEuteller::is_three_d_secure_Valid() const{
    return m_three_d_secure_isValid;
}

qint32 OAIEuteller::getTimeout() const {
    return m_timeout;
}
void OAIEuteller::setTimeout(const qint32 &timeout) {
    m_timeout = timeout;
    m_timeout_isSet = true;
}

bool OAIEuteller::is_timeout_Set() const{
    return m_timeout_isSet;
}

bool OAIEuteller::is_timeout_Valid() const{
    return m_timeout_isValid;
}

QString OAIEuteller::getToken() const {
    return m_token;
}
void OAIEuteller::setToken(const QString &token) {
    m_token = token;
    m_token_isSet = true;
}

bool OAIEuteller::is_token_Set() const{
    return m_token_isSet;
}

bool OAIEuteller::is_token_Valid() const{
    return m_token_isValid;
}

QDateTime OAIEuteller::getUpdatedTime() const {
    return m_updated_time;
}
void OAIEuteller::setUpdatedTime(const QDateTime &updated_time) {
    m_updated_time = updated_time;
    m_updated_time_isSet = true;
}

bool OAIEuteller::is_updated_time_Set() const{
    return m_updated_time_isSet;
}

bool OAIEuteller::is_updated_time_Valid() const{
    return m_updated_time_isValid;
}

OAIEuteller_allOf_credentials OAIEuteller::getCredentials() const {
    return m_credentials;
}
void OAIEuteller::setCredentials(const OAIEuteller_allOf_credentials &credentials) {
    m_credentials = credentials;
    m_credentials_isSet = true;
}

bool OAIEuteller::is_credentials_Set() const{
    return m_credentials_isSet;
}

bool OAIEuteller::is_credentials_Valid() const{
    return m_credentials_isValid;
}

bool OAIEuteller::isSet() const {
...
bool OAIEuteller::isValid() const {
