...
OAIKhelocardCardToken::OAIKhelocardCardToken(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIKhelocardCardToken::OAIKhelocardCardToken() {
    this->initializeModel();
}

OAIKhelocardCardToken::~OAIKhelocardCardToken() {}

void OAIKhelocardCardToken::initializeModel() {
...
void OAIKhelocardCardToken::fromJson(QString jsonString) {
...
void OAIKhelocardCardToken::fromJsonObject(QJsonObject json) {
...
QString OAIKhelocardCardToken::asJson() const {
...
QJsonObject OAIKhelocardCardToken::asJsonObject() const {
    QJsonObject obj;
...
OAIContactObject OAIKhelocardCardToken::getBillingAddress() const {
    return m_billing_address;
}
void OAIKhelocardCardToken::setBillingAddress(const OAIContactObject &billing_address) {
    m_billing_address = billing_address;
    m_billing_address_isSet = true;
}

bool OAIKhelocardCardToken::is_billing_address_Set() const{
    return m_billing_address_isSet;
}

bool OAIKhelocardCardToken::is_billing_address_Valid() const{
    return m_billing_address_isValid;
}

QString OAIKhelocardCardToken::getMethod() const {
    return m_method;
}
void OAIKhelocardCardToken::setMethod(const QString &method) {
    m_method = method;
    m_method_isSet = true;
}

bool OAIKhelocardCardToken::is_method_Set() const{
    return m_method_isSet;
}

bool OAIKhelocardCardToken::is_method_Valid() const{
    return m_method_isValid;
}

OAIObject OAIKhelocardCardToken::getPaymentInstrument() const {
    return m_payment_instrument;
}
void OAIKhelocardCardToken::setPaymentInstrument(const OAIObject &payment_instrument) {
    m_payment_instrument = payment_instrument;
    m_payment_instrument_isSet = true;
}

bool OAIKhelocardCardToken::is_payment_instrument_Set() const{
    return m_payment_instrument_isSet;
}

bool OAIKhelocardCardToken::is_payment_instrument_Valid() const{
    return m_payment_instrument_isValid;
}

QList<OAISelfLink> OAIKhelocardCardToken::getLinks() const {
    return m__links;
}
void OAIKhelocardCardToken::setLinks(const QList<OAISelfLink> &_links) {
    m__links = _links;
    m__links_isSet = true;
}

bool OAIKhelocardCardToken::is__links_Set() const{
    return m__links_isSet;
}

bool OAIKhelocardCardToken::is__links_Valid() const{
    return m__links_isValid;
}

QDateTime OAIKhelocardCardToken::getCreatedTime() const {
    return m_created_time;
}
void OAIKhelocardCardToken::setCreatedTime(const QDateTime &created_time) {
    m_created_time = created_time;
    m_created_time_isSet = true;
}

bool OAIKhelocardCardToken::is_created_time_Set() const{
    return m_created_time_isSet;
}

bool OAIKhelocardCardToken::is_created_time_Valid() const{
    return m_created_time_isValid;
}

QDateTime OAIKhelocardCardToken::getExpirationTime() const {
    return m_expiration_time;
}
void OAIKhelocardCardToken::setExpirationTime(const QDateTime &expiration_time) {
    m_expiration_time = expiration_time;
    m_expiration_time_isSet = true;
}

bool OAIKhelocardCardToken::is_expiration_time_Set() const{
    return m_expiration_time_isSet;
}

bool OAIKhelocardCardToken::is_expiration_time_Valid() const{
    return m_expiration_time_isValid;
}

QString OAIKhelocardCardToken::getId() const {
    return m_id;
}
void OAIKhelocardCardToken::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIKhelocardCardToken::is_id_Set() const{
    return m_id_isSet;
}

bool OAIKhelocardCardToken::is_id_Valid() const{
    return m_id_isValid;
}

bool OAIKhelocardCardToken::isIsUsed() const {
    return m_is_used;
}
void OAIKhelocardCardToken::setIsUsed(const bool &is_used) {
    m_is_used = is_used;
    m_is_used_isSet = true;
}

bool OAIKhelocardCardToken::is_is_used_Set() const{
    return m_is_used_isSet;
}

bool OAIKhelocardCardToken::is_is_used_Valid() const{
    return m_is_used_isValid;
}

OAILeadSource OAIKhelocardCardToken::getLeadSource() const {
    return m_lead_source;
}
void OAIKhelocardCardToken::setLeadSource(const OAILeadSource &lead_source) {
    m_lead_source = lead_source;
    m_lead_source_isSet = true;
}

bool OAIKhelocardCardToken::is_lead_source_Set() const{
    return m_lead_source_isSet;
}

bool OAIKhelocardCardToken::is_lead_source_Valid() const{
    return m_lead_source_isValid;
}

OAIRiskMetadata OAIKhelocardCardToken::getRiskMetadata() const {
    return m_risk_metadata;
}
void OAIKhelocardCardToken::setRiskMetadata(const OAIRiskMetadata &risk_metadata) {
    m_risk_metadata = risk_metadata;
    m_risk_metadata_isSet = true;
}

bool OAIKhelocardCardToken::is_risk_metadata_Set() const{
    return m_risk_metadata_isSet;
}

bool OAIKhelocardCardToken::is_risk_metadata_Valid() const{
    return m_risk_metadata_isValid;
}

QDateTime OAIKhelocardCardToken::getUpdatedTime() const {
    return m_updated_time;
}
void OAIKhelocardCardToken::setUpdatedTime(const QDateTime &updated_time) {
    m_updated_time = updated_time;
    m_updated_time_isSet = true;
}

bool OAIKhelocardCardToken::is_updated_time_Set() const{
    return m_updated_time_isSet;
}

bool OAIKhelocardCardToken::is_updated_time_Valid() const{
    return m_updated_time_isValid;
}

QDateTime OAIKhelocardCardToken::getUsageTime() const {
    return m_usage_time;
}
void OAIKhelocardCardToken::setUsageTime(const QDateTime &usage_time) {
    m_usage_time = usage_time;
    m_usage_time_isSet = true;
}

bool OAIKhelocardCardToken::is_usage_time_Set() const{
    return m_usage_time_isSet;
}

bool OAIKhelocardCardToken::is_usage_time_Valid() const{
    return m_usage_time_isValid;
}

bool OAIKhelocardCardToken::isSet() const {
...
bool OAIKhelocardCardToken::isValid() const {
