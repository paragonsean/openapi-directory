...
/*
 * OAICommonSubscription.h
 *
 * 
 */

#ifndef OAICommonSubscription_H
#define OAICommonSubscription_H
...
class OAICommonSubscription : public OAIObject {
public:
    OAICommonSubscription();
    OAICommonSubscription(QString json);
    ~OAICommonSubscription() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICommonSubscription)

#endif // OAICommonSubscription_H
