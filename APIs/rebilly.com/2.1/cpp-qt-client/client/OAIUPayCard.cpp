...
OAIUPayCard::OAIUPayCard(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUPayCard::OAIUPayCard() {
    this->initializeModel();
}

OAIUPayCard::~OAIUPayCard() {}

void OAIUPayCard::initializeModel() {
...
void OAIUPayCard::fromJson(QString jsonString) {
...
void OAIUPayCard::fromJsonObject(QJsonObject json) {
...
QString OAIUPayCard::asJson() const {
...
QJsonObject OAIUPayCard::asJsonObject() const {
    QJsonObject obj;
    if (m__links.size() > 0) {
...
QList<OAIGatewayAccount__links_inner> OAIUPayCard::getLinks() const {
    return m__links;
}
void OAIUPayCard::setLinks(const QList<OAIGatewayAccount__links_inner> &_links) {
    m__links = _links;
    m__links_isSet = true;
}

bool OAIUPayCard::is__links_Set() const{
    return m__links_isSet;
}

bool OAIUPayCard::is__links_Valid() const{
    return m__links_isValid;
}

QList<QString> OAIUPayCard::getAcceptedCurrencies() const {
    return m_accepted_currencies;
}
void OAIUPayCard::setAcceptedCurrencies(const QList<QString> &accepted_currencies) {
    m_accepted_currencies = accepted_currencies;
    m_accepted_currencies_isSet = true;
}

bool OAIUPayCard::is_accepted_currencies_Set() const{
    return m_accepted_currencies_isSet;
}

bool OAIUPayCard::is_accepted_currencies_Valid() const{
    return m_accepted_currencies_isValid;
}

OAIAcquirerName OAIUPayCard::getAcquirerName() const {
    return m_acquirer_name;
}
void OAIUPayCard::setAcquirerName(const OAIAcquirerName &acquirer_name) {
    m_acquirer_name = acquirer_name;
    m_acquirer_name_isSet = true;
}

bool OAIUPayCard::is_acquirer_name_Set() const{
    return m_acquirer_name_isSet;
}

bool OAIUPayCard::is_acquirer_name_Valid() const{
    return m_acquirer_name_isValid;
}

QString OAIUPayCard::getAdditionalFilters() const {
    return m_additional_filters;
}
void OAIUPayCard::setAdditionalFilters(const QString &additional_filters) {
    m_additional_filters = additional_filters;
    m_additional_filters_isSet = true;
}

bool OAIUPayCard::is_additional_filters_Set() const{
    return m_additional_filters_isSet;
}

bool OAIUPayCard::is_additional_filters_Valid() const{
    return m_additional_filters_isValid;
}

qint32 OAIUPayCard::getApprovalWindowTtl() const {
    return m_approval_window_ttl;
}
void OAIUPayCard::setApprovalWindowTtl(const qint32 &approval_window_ttl) {
    m_approval_window_ttl = approval_window_ttl;
    m_approval_window_ttl_isSet = true;
}

bool OAIUPayCard::is_approval_window_ttl_Set() const{
    return m_approval_window_ttl_isSet;
}

bool OAIUPayCard::is_approval_window_ttl_Valid() const{
    return m_approval_window_ttl_isValid;
}

QString OAIUPayCard::getCityField() const {
    return m_city_field;
}
void OAIUPayCard::setCityField(const QString &city_field) {
    m_city_field = city_field;
    m_city_field_isSet = true;
}

bool OAIUPayCard::is_city_field_Set() const{
    return m_city_field_isSet;
}

bool OAIUPayCard::is_city_field_Valid() const{
    return m_city_field_isValid;
}

QDateTime OAIUPayCard::getCreatedTime() const {
    return m_created_time;
}
void OAIUPayCard::setCreatedTime(const QDateTime &created_time) {
    m_created_time = created_time;
    m_created_time_isSet = true;
}

bool OAIUPayCard::is_created_time_Set() const{
    return m_created_time_isSet;
}

bool OAIUPayCard::is_created_time_Valid() const{
    return m_created_time_isValid;
}

QString OAIUPayCard::getDccForceCurrency() const {
    return m_dcc_force_currency;
}
void OAIUPayCard::setDccForceCurrency(const QString &dcc_force_currency) {
    m_dcc_force_currency = dcc_force_currency;
    m_dcc_force_currency_isSet = true;
}

bool OAIUPayCard::is_dcc_force_currency_Set() const{
    return m_dcc_force_currency_isSet;
}

bool OAIUPayCard::is_dcc_force_currency_Valid() const{
    return m_dcc_force_currency_isValid;
}

qint32 OAIUPayCard::getDccMarkup() const {
    return m_dcc_markup;
}
void OAIUPayCard::setDccMarkup(const qint32 &dcc_markup) {
    m_dcc_markup = dcc_markup;
    m_dcc_markup_isSet = true;
}

bool OAIUPayCard::is_dcc_markup_Set() const{
    return m_dcc_markup_isSet;
}

bool OAIUPayCard::is_dcc_markup_Valid() const{
    return m_dcc_markup_isValid;
}

QString OAIUPayCard::getDescriptor() const {
    return m_descriptor;
}
void OAIUPayCard::setDescriptor(const QString &descriptor) {
    m_descriptor = descriptor;
    m_descriptor_isSet = true;
}

bool OAIUPayCard::is_descriptor_Set() const{
    return m_descriptor_isSet;
}

bool OAIUPayCard::is_descriptor_Valid() const{
    return m_descriptor_isValid;
}

OAIDigitalWallets OAIUPayCard::getDigitalWallets() const {
    return m_digital_wallets;
}
void OAIUPayCard::setDigitalWallets(const OAIDigitalWallets &digital_wallets) {
    m_digital_wallets = digital_wallets;
    m_digital_wallets_isSet = true;
}

bool OAIUPayCard::is_digital_wallets_Set() const{
    return m_digital_wallets_isSet;
}

bool OAIUPayCard::is_digital_wallets_Valid() const{
    return m_digital_wallets_isValid;
}

bool OAIUPayCard::isDynamicDescriptor() const {
    return m_dynamic_descriptor;
}
void OAIUPayCard::setDynamicDescriptor(const bool &dynamic_descriptor) {
    m_dynamic_descriptor = dynamic_descriptor;
    m_dynamic_descriptor_isSet = true;
}

bool OAIUPayCard::is_dynamic_descriptor_Set() const{
    return m_dynamic_descriptor_isSet;
}

bool OAIUPayCard::is_dynamic_descriptor_Valid() const{
    return m_dynamic_descriptor_isValid;
}

QList<QString> OAIUPayCard::getExcludedDccQuoteCurrencies() const {
    return m_excluded_dcc_quote_currencies;
}
void OAIUPayCard::setExcludedDccQuoteCurrencies(const QList<QString> &excluded_dcc_quote_currencies) {
    m_excluded_dcc_quote_currencies = excluded_dcc_quote_currencies;
    m_excluded_dcc_quote_currencies_isSet = true;
}

bool OAIUPayCard::is_excluded_dcc_quote_currencies_Set() const{
    return m_excluded_dcc_quote_currencies_isSet;
}

bool OAIUPayCard::is_excluded_dcc_quote_currencies_Valid() const{
    return m_excluded_dcc_quote_currencies_isValid;
}

OAIGatewayName OAIUPayCard::getGatewayName() const {
    return m_gateway_name;
}
void OAIUPayCard::setGatewayName(const OAIGatewayName &gateway_name) {
    m_gateway_name = gateway_name;
    m_gateway_name_isSet = true;
}

bool OAIUPayCard::is_gateway_name_Set() const{
    return m_gateway_name_isSet;
}

bool OAIUPayCard::is_gateway_name_Valid() const{
    return m_gateway_name_isValid;
}

QString OAIUPayCard::getId() const {
    return m_id;
}
void OAIUPayCard::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIUPayCard::is_id_Set() const{
    return m_id_isSet;
}

bool OAIUPayCard::is_id_Valid() const{
    return m_id_isValid;
}

bool OAIUPayCard::isIsDown() const {
    return m_is_down;
}
void OAIUPayCard::setIsDown(const bool &is_down) {
    m_is_down = is_down;
    m_is_down_isSet = true;
}

bool OAIUPayCard::is_is_down_Set() const{
    return m_is_down_isSet;
}

bool OAIUPayCard::is_is_down_Valid() const{
    return m_is_down_isValid;
}

QString OAIUPayCard::getMerchantCategoryCode() const {
    return m_merchant_category_code;
}
void OAIUPayCard::setMerchantCategoryCode(const QString &merchant_category_code) {
    m_merchant_category_code = merchant_category_code;
    m_merchant_category_code_isSet = true;
}

bool OAIUPayCard::is_merchant_category_code_Set() const{
    return m_merchant_category_code_isSet;
}

bool OAIUPayCard::is_merchant_category_code_Valid() const{
    return m_merchant_category_code_isValid;
}

OAIPaymentMethod OAIUPayCard::getMethod() const {
    return m_method;
}
void OAIUPayCard::setMethod(const OAIPaymentMethod &method) {
    m_method = method;
    m_method_isSet = true;
}

bool OAIUPayCard::is_method_Set() const{
    return m_method_isSet;
}

bool OAIUPayCard::is_method_Valid() const{
    return m_method_isValid;
}

double OAIUPayCard::getMonthlyLimit() const {
    return m_monthly_limit;
}
void OAIUPayCard::setMonthlyLimit(const double &monthly_limit) {
    m_monthly_limit = monthly_limit;
    m_monthly_limit_isSet = true;
}

bool OAIUPayCard::is_monthly_limit_Set() const{
    return m_monthly_limit_isSet;
}

bool OAIUPayCard::is_monthly_limit_Valid() const{
    return m_monthly_limit_isValid;
}

QString OAIUPayCard::getOrganizationId() const {
    return m_organization_id;
}
void OAIUPayCard::setOrganizationId(const QString &organization_id) {
    m_organization_id = organization_id;
    m_organization_id_isSet = true;
}

bool OAIUPayCard::is_organization_id_Set() const{
    return m_organization_id_isSet;
}

bool OAIUPayCard::is_organization_id_Valid() const{
    return m_organization_id_isValid;
}

QList<OAIPaymentCardBrand> OAIUPayCard::getPaymentCardSchemes() const {
    return m_payment_card_schemes;
}
void OAIUPayCard::setPaymentCardSchemes(const QList<OAIPaymentCardBrand> &payment_card_schemes) {
    m_payment_card_schemes = payment_card_schemes;
    m_payment_card_schemes_isSet = true;
}

bool OAIUPayCard::is_payment_card_schemes_Set() const{
    return m_payment_card_schemes_isSet;
}

bool OAIUPayCard::is_payment_card_schemes_Valid() const{
    return m_payment_card_schemes_isValid;
}

bool OAIUPayCard::isReconciliationWindowEnabled() const {
    return m_reconciliation_window_enabled;
}
void OAIUPayCard::setReconciliationWindowEnabled(const bool &reconciliation_window_enabled) {
    m_reconciliation_window_enabled = reconciliation_window_enabled;
    m_reconciliation_window_enabled_isSet = true;
}

bool OAIUPayCard::is_reconciliation_window_enabled_Set() const{
    return m_reconciliation_window_enabled_isSet;
}

bool OAIUPayCard::is_reconciliation_window_enabled_Valid() const{
    return m_reconciliation_window_enabled_isValid;
}

qint32 OAIUPayCard::getReconciliationWindowTtl() const {
    return m_reconciliation_window_ttl;
}
void OAIUPayCard::setReconciliationWindowTtl(const qint32 &reconciliation_window_ttl) {
    m_reconciliation_window_ttl = reconciliation_window_ttl;
    m_reconciliation_window_ttl_isSet = true;
}

bool OAIUPayCard::is_reconciliation_window_ttl_Set() const{
    return m_reconciliation_window_ttl_isSet;
}

bool OAIUPayCard::is_reconciliation_window_ttl_Valid() const{
    return m_reconciliation_window_ttl_isValid;
}

QString OAIUPayCard::getStatus() const {
    return m_status;
}
void OAIUPayCard::setStatus(const QString &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIUPayCard::is_status_Set() const{
    return m_status_isSet;
}

bool OAIUPayCard::is_status_Valid() const{
    return m_status_isValid;
}

bool OAIUPayCard::isSticky() const {
    return m_sticky;
}
void OAIUPayCard::setSticky(const bool &sticky) {
    m_sticky = sticky;
    m_sticky_isSet = true;
}

bool OAIUPayCard::is_sticky_Set() const{
    return m_sticky_isSet;
}

bool OAIUPayCard::is_sticky_Valid() const{
    return m_sticky_isValid;
}

bool OAIUPayCard::isThreeDSecure() const {
    return m_three_d_secure;
}
void OAIUPayCard::setThreeDSecure(const bool &three_d_secure) {
    m_three_d_secure = three_d_secure;
    m_three_d_secure_isSet = true;
}

bool OAIUPayCard::is_three_d_secure_Set() const{
    return m_three_d_secure_isSet;
}

bool OAIUPayCard::is_three_d_secure_Valid() const{
    return m_three_d_secure_isValid;
}

qint32 OAIUPayCard::getTimeout() const {
    return m_timeout;
}
void OAIUPayCard::setTimeout(const qint32 &timeout) {
    m_timeout = timeout;
    m_timeout_isSet = true;
}

bool OAIUPayCard::is_timeout_Set() const{
    return m_timeout_isSet;
}

bool OAIUPayCard::is_timeout_Valid() const{
    return m_timeout_isValid;
}

QString OAIUPayCard::getToken() const {
    return m_token;
}
void OAIUPayCard::setToken(const QString &token) {
    m_token = token;
    m_token_isSet = true;
}

bool OAIUPayCard::is_token_Set() const{
    return m_token_isSet;
}

bool OAIUPayCard::is_token_Valid() const{
    return m_token_isValid;
}

QDateTime OAIUPayCard::getUpdatedTime() const {
    return m_updated_time;
}
void OAIUPayCard::setUpdatedTime(const QDateTime &updated_time) {
    m_updated_time = updated_time;
    m_updated_time_isSet = true;
}

bool OAIUPayCard::is_updated_time_Set() const{
    return m_updated_time_isSet;
}

bool OAIUPayCard::is_updated_time_Valid() const{
    return m_updated_time_isValid;
}

OAIUPayCard_allOf_credentials OAIUPayCard::getCredentials() const {
    return m_credentials;
}
void OAIUPayCard::setCredentials(const OAIUPayCard_allOf_credentials &credentials) {
    m_credentials = credentials;
    m_credentials_isSet = true;
}

bool OAIUPayCard::is_credentials_Set() const{
    return m_credentials_isSet;
}

bool OAIUPayCard::is_credentials_Valid() const{
    return m_credentials_isValid;
}

OAIUPayCard_allOf_settings OAIUPayCard::getSettings() const {
    return m_settings;
}
void OAIUPayCard::setSettings(const OAIUPayCard_allOf_settings &settings) {
    m_settings = settings;
    m_settings_isSet = true;
}

bool OAIUPayCard::is_settings_Set() const{
    return m_settings_isSet;
}

bool OAIUPayCard::is_settings_Valid() const{
    return m_settings_isValid;
}

bool OAIUPayCard::isSet() const {
...
bool OAIUPayCard::isValid() const {
