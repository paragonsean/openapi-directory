...
OAIDragonphoenix::OAIDragonphoenix(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDragonphoenix::OAIDragonphoenix() {
    this->initializeModel();
}

OAIDragonphoenix::~OAIDragonphoenix() {}

void OAIDragonphoenix::initializeModel() {
...
void OAIDragonphoenix::fromJson(QString jsonString) {
...
void OAIDragonphoenix::fromJsonObject(QJsonObject json) {
...
QString OAIDragonphoenix::asJson() const {
...
QJsonObject OAIDragonphoenix::asJsonObject() const {
    QJsonObject obj;
    if (m__links.size() > 0) {
...
QList<OAIGatewayAccount__links_inner> OAIDragonphoenix::getLinks() const {
    return m__links;
}
void OAIDragonphoenix::setLinks(const QList<OAIGatewayAccount__links_inner> &_links) {
    m__links = _links;
    m__links_isSet = true;
}

bool OAIDragonphoenix::is__links_Set() const{
    return m__links_isSet;
}

bool OAIDragonphoenix::is__links_Valid() const{
    return m__links_isValid;
}

QList<QString> OAIDragonphoenix::getAcceptedCurrencies() const {
    return m_accepted_currencies;
}
void OAIDragonphoenix::setAcceptedCurrencies(const QList<QString> &accepted_currencies) {
    m_accepted_currencies = accepted_currencies;
    m_accepted_currencies_isSet = true;
}

bool OAIDragonphoenix::is_accepted_currencies_Set() const{
    return m_accepted_currencies_isSet;
}

bool OAIDragonphoenix::is_accepted_currencies_Valid() const{
    return m_accepted_currencies_isValid;
}

OAIAcquirerName OAIDragonphoenix::getAcquirerName() const {
    return m_acquirer_name;
}
void OAIDragonphoenix::setAcquirerName(const OAIAcquirerName &acquirer_name) {
    m_acquirer_name = acquirer_name;
    m_acquirer_name_isSet = true;
}

bool OAIDragonphoenix::is_acquirer_name_Set() const{
    return m_acquirer_name_isSet;
}

bool OAIDragonphoenix::is_acquirer_name_Valid() const{
    return m_acquirer_name_isValid;
}

QString OAIDragonphoenix::getAdditionalFilters() const {
    return m_additional_filters;
}
void OAIDragonphoenix::setAdditionalFilters(const QString &additional_filters) {
    m_additional_filters = additional_filters;
    m_additional_filters_isSet = true;
}

bool OAIDragonphoenix::is_additional_filters_Set() const{
    return m_additional_filters_isSet;
}

bool OAIDragonphoenix::is_additional_filters_Valid() const{
    return m_additional_filters_isValid;
}

qint32 OAIDragonphoenix::getApprovalWindowTtl() const {
    return m_approval_window_ttl;
}
void OAIDragonphoenix::setApprovalWindowTtl(const qint32 &approval_window_ttl) {
    m_approval_window_ttl = approval_window_ttl;
    m_approval_window_ttl_isSet = true;
}

bool OAIDragonphoenix::is_approval_window_ttl_Set() const{
    return m_approval_window_ttl_isSet;
}

bool OAIDragonphoenix::is_approval_window_ttl_Valid() const{
    return m_approval_window_ttl_isValid;
}

QString OAIDragonphoenix::getCityField() const {
    return m_city_field;
}
void OAIDragonphoenix::setCityField(const QString &city_field) {
    m_city_field = city_field;
    m_city_field_isSet = true;
}

bool OAIDragonphoenix::is_city_field_Set() const{
    return m_city_field_isSet;
}

bool OAIDragonphoenix::is_city_field_Valid() const{
    return m_city_field_isValid;
}

QDateTime OAIDragonphoenix::getCreatedTime() const {
    return m_created_time;
}
void OAIDragonphoenix::setCreatedTime(const QDateTime &created_time) {
    m_created_time = created_time;
    m_created_time_isSet = true;
}

bool OAIDragonphoenix::is_created_time_Set() const{
    return m_created_time_isSet;
}

bool OAIDragonphoenix::is_created_time_Valid() const{
    return m_created_time_isValid;
}

QString OAIDragonphoenix::getDccForceCurrency() const {
    return m_dcc_force_currency;
}
void OAIDragonphoenix::setDccForceCurrency(const QString &dcc_force_currency) {
    m_dcc_force_currency = dcc_force_currency;
    m_dcc_force_currency_isSet = true;
}

bool OAIDragonphoenix::is_dcc_force_currency_Set() const{
    return m_dcc_force_currency_isSet;
}

bool OAIDragonphoenix::is_dcc_force_currency_Valid() const{
    return m_dcc_force_currency_isValid;
}

qint32 OAIDragonphoenix::getDccMarkup() const {
    return m_dcc_markup;
}
void OAIDragonphoenix::setDccMarkup(const qint32 &dcc_markup) {
    m_dcc_markup = dcc_markup;
    m_dcc_markup_isSet = true;
}

bool OAIDragonphoenix::is_dcc_markup_Set() const{
    return m_dcc_markup_isSet;
}

bool OAIDragonphoenix::is_dcc_markup_Valid() const{
    return m_dcc_markup_isValid;
}

QString OAIDragonphoenix::getDescriptor() const {
    return m_descriptor;
}
void OAIDragonphoenix::setDescriptor(const QString &descriptor) {
    m_descriptor = descriptor;
    m_descriptor_isSet = true;
}

bool OAIDragonphoenix::is_descriptor_Set() const{
    return m_descriptor_isSet;
}

bool OAIDragonphoenix::is_descriptor_Valid() const{
    return m_descriptor_isValid;
}

OAIDigitalWallets OAIDragonphoenix::getDigitalWallets() const {
    return m_digital_wallets;
}
void OAIDragonphoenix::setDigitalWallets(const OAIDigitalWallets &digital_wallets) {
    m_digital_wallets = digital_wallets;
    m_digital_wallets_isSet = true;
}

bool OAIDragonphoenix::is_digital_wallets_Set() const{
    return m_digital_wallets_isSet;
}

bool OAIDragonphoenix::is_digital_wallets_Valid() const{
    return m_digital_wallets_isValid;
}

bool OAIDragonphoenix::isDynamicDescriptor() const {
    return m_dynamic_descriptor;
}
void OAIDragonphoenix::setDynamicDescriptor(const bool &dynamic_descriptor) {
    m_dynamic_descriptor = dynamic_descriptor;
    m_dynamic_descriptor_isSet = true;
}

bool OAIDragonphoenix::is_dynamic_descriptor_Set() const{
    return m_dynamic_descriptor_isSet;
}

bool OAIDragonphoenix::is_dynamic_descriptor_Valid() const{
    return m_dynamic_descriptor_isValid;
}

QList<QString> OAIDragonphoenix::getExcludedDccQuoteCurrencies() const {
    return m_excluded_dcc_quote_currencies;
}
void OAIDragonphoenix::setExcludedDccQuoteCurrencies(const QList<QString> &excluded_dcc_quote_currencies) {
    m_excluded_dcc_quote_currencies = excluded_dcc_quote_currencies;
    m_excluded_dcc_quote_currencies_isSet = true;
}

bool OAIDragonphoenix::is_excluded_dcc_quote_currencies_Set() const{
    return m_excluded_dcc_quote_currencies_isSet;
}

bool OAIDragonphoenix::is_excluded_dcc_quote_currencies_Valid() const{
    return m_excluded_dcc_quote_currencies_isValid;
}

OAIGatewayName OAIDragonphoenix::getGatewayName() const {
    return m_gateway_name;
}
void OAIDragonphoenix::setGatewayName(const OAIGatewayName &gateway_name) {
    m_gateway_name = gateway_name;
    m_gateway_name_isSet = true;
}

bool OAIDragonphoenix::is_gateway_name_Set() const{
    return m_gateway_name_isSet;
}

bool OAIDragonphoenix::is_gateway_name_Valid() const{
    return m_gateway_name_isValid;
}

QString OAIDragonphoenix::getId() const {
    return m_id;
}
void OAIDragonphoenix::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIDragonphoenix::is_id_Set() const{
    return m_id_isSet;
}

bool OAIDragonphoenix::is_id_Valid() const{
    return m_id_isValid;
}

bool OAIDragonphoenix::isIsDown() const {
    return m_is_down;
}
void OAIDragonphoenix::setIsDown(const bool &is_down) {
    m_is_down = is_down;
    m_is_down_isSet = true;
}

bool OAIDragonphoenix::is_is_down_Set() const{
    return m_is_down_isSet;
}

bool OAIDragonphoenix::is_is_down_Valid() const{
    return m_is_down_isValid;
}

QString OAIDragonphoenix::getMerchantCategoryCode() const {
    return m_merchant_category_code;
}
void OAIDragonphoenix::setMerchantCategoryCode(const QString &merchant_category_code) {
    m_merchant_category_code = merchant_category_code;
    m_merchant_category_code_isSet = true;
}

bool OAIDragonphoenix::is_merchant_category_code_Set() const{
    return m_merchant_category_code_isSet;
}

bool OAIDragonphoenix::is_merchant_category_code_Valid() const{
    return m_merchant_category_code_isValid;
}

OAIPaymentMethod OAIDragonphoenix::getMethod() const {
    return m_method;
}
void OAIDragonphoenix::setMethod(const OAIPaymentMethod &method) {
    m_method = method;
    m_method_isSet = true;
}

bool OAIDragonphoenix::is_method_Set() const{
    return m_method_isSet;
}

bool OAIDragonphoenix::is_method_Valid() const{
    return m_method_isValid;
}

double OAIDragonphoenix::getMonthlyLimit() const {
    return m_monthly_limit;
}
void OAIDragonphoenix::setMonthlyLimit(const double &monthly_limit) {
    m_monthly_limit = monthly_limit;
    m_monthly_limit_isSet = true;
}

bool OAIDragonphoenix::is_monthly_limit_Set() const{
    return m_monthly_limit_isSet;
}

bool OAIDragonphoenix::is_monthly_limit_Valid() const{
    return m_monthly_limit_isValid;
}

QString OAIDragonphoenix::getOrganizationId() const {
    return m_organization_id;
}
void OAIDragonphoenix::setOrganizationId(const QString &organization_id) {
    m_organization_id = organization_id;
    m_organization_id_isSet = true;
}

bool OAIDragonphoenix::is_organization_id_Set() const{
    return m_organization_id_isSet;
}

bool OAIDragonphoenix::is_organization_id_Valid() const{
    return m_organization_id_isValid;
}

QList<OAIPaymentCardBrand> OAIDragonphoenix::getPaymentCardSchemes() const {
    return m_payment_card_schemes;
}
void OAIDragonphoenix::setPaymentCardSchemes(const QList<OAIPaymentCardBrand> &payment_card_schemes) {
    m_payment_card_schemes = payment_card_schemes;
    m_payment_card_schemes_isSet = true;
}

bool OAIDragonphoenix::is_payment_card_schemes_Set() const{
    return m_payment_card_schemes_isSet;
}

bool OAIDragonphoenix::is_payment_card_schemes_Valid() const{
    return m_payment_card_schemes_isValid;
}

bool OAIDragonphoenix::isReconciliationWindowEnabled() const {
    return m_reconciliation_window_enabled;
}
void OAIDragonphoenix::setReconciliationWindowEnabled(const bool &reconciliation_window_enabled) {
    m_reconciliation_window_enabled = reconciliation_window_enabled;
    m_reconciliation_window_enabled_isSet = true;
}

bool OAIDragonphoenix::is_reconciliation_window_enabled_Set() const{
    return m_reconciliation_window_enabled_isSet;
}

bool OAIDragonphoenix::is_reconciliation_window_enabled_Valid() const{
    return m_reconciliation_window_enabled_isValid;
}

qint32 OAIDragonphoenix::getReconciliationWindowTtl() const {
    return m_reconciliation_window_ttl;
}
void OAIDragonphoenix::setReconciliationWindowTtl(const qint32 &reconciliation_window_ttl) {
    m_reconciliation_window_ttl = reconciliation_window_ttl;
    m_reconciliation_window_ttl_isSet = true;
}

bool OAIDragonphoenix::is_reconciliation_window_ttl_Set() const{
    return m_reconciliation_window_ttl_isSet;
}

bool OAIDragonphoenix::is_reconciliation_window_ttl_Valid() const{
    return m_reconciliation_window_ttl_isValid;
}

QString OAIDragonphoenix::getStatus() const {
    return m_status;
}
void OAIDragonphoenix::setStatus(const QString &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIDragonphoenix::is_status_Set() const{
    return m_status_isSet;
}

bool OAIDragonphoenix::is_status_Valid() const{
    return m_status_isValid;
}

bool OAIDragonphoenix::isSticky() const {
    return m_sticky;
}
void OAIDragonphoenix::setSticky(const bool &sticky) {
    m_sticky = sticky;
    m_sticky_isSet = true;
}

bool OAIDragonphoenix::is_sticky_Set() const{
    return m_sticky_isSet;
}

bool OAIDragonphoenix::is_sticky_Valid() const{
    return m_sticky_isValid;
}

bool OAIDragonphoenix::isThreeDSecure() const {
    return m_three_d_secure;
}
void OAIDragonphoenix::setThreeDSecure(const bool &three_d_secure) {
    m_three_d_secure = three_d_secure;
    m_three_d_secure_isSet = true;
}

bool OAIDragonphoenix::is_three_d_secure_Set() const{
    return m_three_d_secure_isSet;
}

bool OAIDragonphoenix::is_three_d_secure_Valid() const{
    return m_three_d_secure_isValid;
}

qint32 OAIDragonphoenix::getTimeout() const {
    return m_timeout;
}
void OAIDragonphoenix::setTimeout(const qint32 &timeout) {
    m_timeout = timeout;
    m_timeout_isSet = true;
}

bool OAIDragonphoenix::is_timeout_Set() const{
    return m_timeout_isSet;
}

bool OAIDragonphoenix::is_timeout_Valid() const{
    return m_timeout_isValid;
}

QString OAIDragonphoenix::getToken() const {
    return m_token;
}
void OAIDragonphoenix::setToken(const QString &token) {
    m_token = token;
    m_token_isSet = true;
}

bool OAIDragonphoenix::is_token_Set() const{
    return m_token_isSet;
}

bool OAIDragonphoenix::is_token_Valid() const{
    return m_token_isValid;
}

QDateTime OAIDragonphoenix::getUpdatedTime() const {
    return m_updated_time;
}
void OAIDragonphoenix::setUpdatedTime(const QDateTime &updated_time) {
    m_updated_time = updated_time;
    m_updated_time_isSet = true;
}

bool OAIDragonphoenix::is_updated_time_Set() const{
    return m_updated_time_isSet;
}

bool OAIDragonphoenix::is_updated_time_Valid() const{
    return m_updated_time_isValid;
}

OAIDragonphoenix_allOf_credentials OAIDragonphoenix::getCredentials() const {
    return m_credentials;
}
void OAIDragonphoenix::setCredentials(const OAIDragonphoenix_allOf_credentials &credentials) {
    m_credentials = credentials;
    m_credentials_isSet = true;
}

bool OAIDragonphoenix::is_credentials_Set() const{
    return m_credentials_isSet;
}

bool OAIDragonphoenix::is_credentials_Valid() const{
    return m_credentials_isValid;
}

bool OAIDragonphoenix::isSet() const {
...
bool OAIDragonphoenix::isValid() const {
