...
class OAIRapyd_allOf_credentials;

class OAIRapyd : public OAIObject {
public:
    OAIRapyd();
    OAIRapyd(QString json);
    ~OAIRapyd() override;
    ...
    OAIRapyd_allOf_credentials getCredentials() const;
    void setCredentials(const OAIRapyd_allOf_credentials &credentials);
...
private:
    ...
    OAIRapyd_allOf_credentials m_credentials;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRapyd)
