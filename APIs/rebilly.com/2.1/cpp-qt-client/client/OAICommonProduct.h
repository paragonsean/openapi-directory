...
#ifndef OAICommonProduct_H
#define OAICommonProduct_H
...
class OAICommonProduct : public OAIObject {
public:
    OAICommonProduct();
    OAICommonProduct(QString json);
    ~OAICommonProduct() override;
    ...
    bool isRequiresShipping() const;
    void setRequiresShipping(const bool &requires_shipping);
    bool is_requires_shipping_Set() const;
    bool is_requires_shipping_Valid() const;
...
private:
    ...
    bool m_requires_shipping;
    bool m_requires_shipping_isSet;
    bool m_requires_shipping_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAICommonProduct)

#endif // OAICommonProduct_H
