...
#ifndef OAIShippingZone_H
#define OAIShippingZone_H

#include <QJsonObject>

#include "OAIPriceBasedShippingRate.h"
...
namespace OpenAPI {
class OAISelfLink;
class OAIPriceBasedShippingRate;

class OAIShippingZone : public OAIObject {
public:
    OAIShippingZone();
    OAIShippingZone(QString json);
    ~OAIShippingZone() override;
    ...
    QJsonValue getIsDefault() const;
    void setIsDefault(const QJsonValue &is_default);
    ...
    QList<OAIPriceBasedShippingRate> getRates() const;
    void setRates(const QList<OAIPriceBasedShippingRate> &rates);
...
private:
    ...
    QList<OAIPriceBasedShippingRate> m_rates;
    bool m_rates_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIShippingZone)

#endif // OAIShippingZone_H
