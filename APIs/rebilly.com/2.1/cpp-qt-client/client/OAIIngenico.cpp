...
OAIIngenico::OAIIngenico(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIIngenico::OAIIngenico() {
    this->initializeModel();
}

OAIIngenico::~OAIIngenico() {}

void OAIIngenico::initializeModel() {
...
void OAIIngenico::fromJson(QString jsonString) {
...
void OAIIngenico::fromJsonObject(QJsonObject json) {
...
QString OAIIngenico::asJson() const {
...
QJsonObject OAIIngenico::asJsonObject() const {
    QJsonObject obj;
    if (m__links.size() > 0) {
...
QList<OAIGatewayAccount__links_inner> OAIIngenico::getLinks() const {
    return m__links;
}
void OAIIngenico::setLinks(const QList<OAIGatewayAccount__links_inner> &_links) {
    m__links = _links;
    m__links_isSet = true;
}

bool OAIIngenico::is__links_Set() const{
    return m__links_isSet;
}

bool OAIIngenico::is__links_Valid() const{
    return m__links_isValid;
}

QList<QString> OAIIngenico::getAcceptedCurrencies() const {
    return m_accepted_currencies;
}
void OAIIngenico::setAcceptedCurrencies(const QList<QString> &accepted_currencies) {
    m_accepted_currencies = accepted_currencies;
    m_accepted_currencies_isSet = true;
}

bool OAIIngenico::is_accepted_currencies_Set() const{
    return m_accepted_currencies_isSet;
}

bool OAIIngenico::is_accepted_currencies_Valid() const{
    return m_accepted_currencies_isValid;
}

OAIAcquirerName OAIIngenico::getAcquirerName() const {
    return m_acquirer_name;
}
void OAIIngenico::setAcquirerName(const OAIAcquirerName &acquirer_name) {
    m_acquirer_name = acquirer_name;
    m_acquirer_name_isSet = true;
}

bool OAIIngenico::is_acquirer_name_Set() const{
    return m_acquirer_name_isSet;
}

bool OAIIngenico::is_acquirer_name_Valid() const{
    return m_acquirer_name_isValid;
}

QString OAIIngenico::getAdditionalFilters() const {
    return m_additional_filters;
}
void OAIIngenico::setAdditionalFilters(const QString &additional_filters) {
    m_additional_filters = additional_filters;
    m_additional_filters_isSet = true;
}

bool OAIIngenico::is_additional_filters_Set() const{
    return m_additional_filters_isSet;
}

bool OAIIngenico::is_additional_filters_Valid() const{
    return m_additional_filters_isValid;
}

qint32 OAIIngenico::getApprovalWindowTtl() const {
    return m_approval_window_ttl;
}
void OAIIngenico::setApprovalWindowTtl(const qint32 &approval_window_ttl) {
    m_approval_window_ttl = approval_window_ttl;
    m_approval_window_ttl_isSet = true;
}

bool OAIIngenico::is_approval_window_ttl_Set() const{
    return m_approval_window_ttl_isSet;
}

bool OAIIngenico::is_approval_window_ttl_Valid() const{
    return m_approval_window_ttl_isValid;
}

QString OAIIngenico::getCityField() const {
    return m_city_field;
}
void OAIIngenico::setCityField(const QString &city_field) {
    m_city_field = city_field;
    m_city_field_isSet = true;
}

bool OAIIngenico::is_city_field_Set() const{
    return m_city_field_isSet;
}

bool OAIIngenico::is_city_field_Valid() const{
    return m_city_field_isValid;
}

QDateTime OAIIngenico::getCreatedTime() const {
    return m_created_time;
}
void OAIIngenico::setCreatedTime(const QDateTime &created_time) {
    m_created_time = created_time;
    m_created_time_isSet = true;
}

bool OAIIngenico::is_created_time_Set() const{
    return m_created_time_isSet;
}

bool OAIIngenico::is_created_time_Valid() const{
    return m_created_time_isValid;
}

QString OAIIngenico::getDccForceCurrency() const {
    return m_dcc_force_currency;
}
void OAIIngenico::setDccForceCurrency(const QString &dcc_force_currency) {
    m_dcc_force_currency = dcc_force_currency;
    m_dcc_force_currency_isSet = true;
}

bool OAIIngenico::is_dcc_force_currency_Set() const{
    return m_dcc_force_currency_isSet;
}

bool OAIIngenico::is_dcc_force_currency_Valid() const{
    return m_dcc_force_currency_isValid;
}

qint32 OAIIngenico::getDccMarkup() const {
    return m_dcc_markup;
}
void OAIIngenico::setDccMarkup(const qint32 &dcc_markup) {
    m_dcc_markup = dcc_markup;
    m_dcc_markup_isSet = true;
}

bool OAIIngenico::is_dcc_markup_Set() const{
    return m_dcc_markup_isSet;
}

bool OAIIngenico::is_dcc_markup_Valid() const{
    return m_dcc_markup_isValid;
}

QString OAIIngenico::getDescriptor() const {
    return m_descriptor;
}
void OAIIngenico::setDescriptor(const QString &descriptor) {
    m_descriptor = descriptor;
    m_descriptor_isSet = true;
}

bool OAIIngenico::is_descriptor_Set() const{
    return m_descriptor_isSet;
}

bool OAIIngenico::is_descriptor_Valid() const{
    return m_descriptor_isValid;
}

OAIDigitalWallets OAIIngenico::getDigitalWallets() const {
    return m_digital_wallets;
}
void OAIIngenico::setDigitalWallets(const OAIDigitalWallets &digital_wallets) {
    m_digital_wallets = digital_wallets;
    m_digital_wallets_isSet = true;
}

bool OAIIngenico::is_digital_wallets_Set() const{
    return m_digital_wallets_isSet;
}

bool OAIIngenico::is_digital_wallets_Valid() const{
    return m_digital_wallets_isValid;
}

bool OAIIngenico::isDynamicDescriptor() const {
    return m_dynamic_descriptor;
}
void OAIIngenico::setDynamicDescriptor(const bool &dynamic_descriptor) {
    m_dynamic_descriptor = dynamic_descriptor;
    m_dynamic_descriptor_isSet = true;
}

bool OAIIngenico::is_dynamic_descriptor_Set() const{
    return m_dynamic_descriptor_isSet;
}

bool OAIIngenico::is_dynamic_descriptor_Valid() const{
    return m_dynamic_descriptor_isValid;
}

QList<QString> OAIIngenico::getExcludedDccQuoteCurrencies() const {
    return m_excluded_dcc_quote_currencies;
}
void OAIIngenico::setExcludedDccQuoteCurrencies(const QList<QString> &excluded_dcc_quote_currencies) {
    m_excluded_dcc_quote_currencies = excluded_dcc_quote_currencies;
    m_excluded_dcc_quote_currencies_isSet = true;
}

bool OAIIngenico::is_excluded_dcc_quote_currencies_Set() const{
    return m_excluded_dcc_quote_currencies_isSet;
}

bool OAIIngenico::is_excluded_dcc_quote_currencies_Valid() const{
    return m_excluded_dcc_quote_currencies_isValid;
}

OAIGatewayName OAIIngenico::getGatewayName() const {
    return m_gateway_name;
}
void OAIIngenico::setGatewayName(const OAIGatewayName &gateway_name) {
    m_gateway_name = gateway_name;
    m_gateway_name_isSet = true;
}

bool OAIIngenico::is_gateway_name_Set() const{
    return m_gateway_name_isSet;
}

bool OAIIngenico::is_gateway_name_Valid() const{
    return m_gateway_name_isValid;
}

QString OAIIngenico::getId() const {
    return m_id;
}
void OAIIngenico::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIIngenico::is_id_Set() const{
    return m_id_isSet;
}

bool OAIIngenico::is_id_Valid() const{
    return m_id_isValid;
}

bool OAIIngenico::isIsDown() const {
    return m_is_down;
}
void OAIIngenico::setIsDown(const bool &is_down) {
    m_is_down = is_down;
    m_is_down_isSet = true;
}

bool OAIIngenico::is_is_down_Set() const{
    return m_is_down_isSet;
}

bool OAIIngenico::is_is_down_Valid() const{
    return m_is_down_isValid;
}

QString OAIIngenico::getMerchantCategoryCode() const {
    return m_merchant_category_code;
}
void OAIIngenico::setMerchantCategoryCode(const QString &merchant_category_code) {
    m_merchant_category_code = merchant_category_code;
    m_merchant_category_code_isSet = true;
}

bool OAIIngenico::is_merchant_category_code_Set() const{
    return m_merchant_category_code_isSet;
}

bool OAIIngenico::is_merchant_category_code_Valid() const{
    return m_merchant_category_code_isValid;
}

OAIPaymentMethod OAIIngenico::getMethod() const {
    return m_method;
}
void OAIIngenico::setMethod(const OAIPaymentMethod &method) {
    m_method = method;
    m_method_isSet = true;
}

bool OAIIngenico::is_method_Set() const{
    return m_method_isSet;
}

bool OAIIngenico::is_method_Valid() const{
    return m_method_isValid;
}

double OAIIngenico::getMonthlyLimit() const {
    return m_monthly_limit;
}
void OAIIngenico::setMonthlyLimit(const double &monthly_limit) {
    m_monthly_limit = monthly_limit;
    m_monthly_limit_isSet = true;
}

bool OAIIngenico::is_monthly_limit_Set() const{
    return m_monthly_limit_isSet;
}

bool OAIIngenico::is_monthly_limit_Valid() const{
    return m_monthly_limit_isValid;
}

QString OAIIngenico::getOrganizationId() const {
    return m_organization_id;
}
void OAIIngenico::setOrganizationId(const QString &organization_id) {
    m_organization_id = organization_id;
    m_organization_id_isSet = true;
}

bool OAIIngenico::is_organization_id_Set() const{
    return m_organization_id_isSet;
}

bool OAIIngenico::is_organization_id_Valid() const{
    return m_organization_id_isValid;
}

QList<OAIPaymentCardBrand> OAIIngenico::getPaymentCardSchemes() const {
    return m_payment_card_schemes;
}
void OAIIngenico::setPaymentCardSchemes(const QList<OAIPaymentCardBrand> &payment_card_schemes) {
    m_payment_card_schemes = payment_card_schemes;
    m_payment_card_schemes_isSet = true;
}

bool OAIIngenico::is_payment_card_schemes_Set() const{
    return m_payment_card_schemes_isSet;
}

bool OAIIngenico::is_payment_card_schemes_Valid() const{
    return m_payment_card_schemes_isValid;
}

bool OAIIngenico::isReconciliationWindowEnabled() const {
    return m_reconciliation_window_enabled;
}
void OAIIngenico::setReconciliationWindowEnabled(const bool &reconciliation_window_enabled) {
    m_reconciliation_window_enabled = reconciliation_window_enabled;
    m_reconciliation_window_enabled_isSet = true;
}

bool OAIIngenico::is_reconciliation_window_enabled_Set() const{
    return m_reconciliation_window_enabled_isSet;
}

bool OAIIngenico::is_reconciliation_window_enabled_Valid() const{
    return m_reconciliation_window_enabled_isValid;
}

qint32 OAIIngenico::getReconciliationWindowTtl() const {
    return m_reconciliation_window_ttl;
}
void OAIIngenico::setReconciliationWindowTtl(const qint32 &reconciliation_window_ttl) {
    m_reconciliation_window_ttl = reconciliation_window_ttl;
    m_reconciliation_window_ttl_isSet = true;
}

bool OAIIngenico::is_reconciliation_window_ttl_Set() const{
    return m_reconciliation_window_ttl_isSet;
}

bool OAIIngenico::is_reconciliation_window_ttl_Valid() const{
    return m_reconciliation_window_ttl_isValid;
}

QString OAIIngenico::getStatus() const {
    return m_status;
}
void OAIIngenico::setStatus(const QString &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIIngenico::is_status_Set() const{
    return m_status_isSet;
}

bool OAIIngenico::is_status_Valid() const{
    return m_status_isValid;
}

bool OAIIngenico::isSticky() const {
    return m_sticky;
}
void OAIIngenico::setSticky(const bool &sticky) {
    m_sticky = sticky;
    m_sticky_isSet = true;
}

bool OAIIngenico::is_sticky_Set() const{
    return m_sticky_isSet;
}

bool OAIIngenico::is_sticky_Valid() const{
    return m_sticky_isValid;
}

bool OAIIngenico::isThreeDSecure() const {
    return m_three_d_secure;
}
void OAIIngenico::setThreeDSecure(const bool &three_d_secure) {
    m_three_d_secure = three_d_secure;
    m_three_d_secure_isSet = true;
}

bool OAIIngenico::is_three_d_secure_Set() const{
    return m_three_d_secure_isSet;
}

bool OAIIngenico::is_three_d_secure_Valid() const{
    return m_three_d_secure_isValid;
}

qint32 OAIIngenico::getTimeout() const {
    return m_timeout;
}
void OAIIngenico::setTimeout(const qint32 &timeout) {
    m_timeout = timeout;
    m_timeout_isSet = true;
}

bool OAIIngenico::is_timeout_Set() const{
    return m_timeout_isSet;
}

bool OAIIngenico::is_timeout_Valid() const{
    return m_timeout_isValid;
}

QString OAIIngenico::getToken() const {
    return m_token;
}
void OAIIngenico::setToken(const QString &token) {
    m_token = token;
    m_token_isSet = true;
}

bool OAIIngenico::is_token_Set() const{
    return m_token_isSet;
}

bool OAIIngenico::is_token_Valid() const{
    return m_token_isValid;
}

QDateTime OAIIngenico::getUpdatedTime() const {
    return m_updated_time;
}
void OAIIngenico::setUpdatedTime(const QDateTime &updated_time) {
    m_updated_time = updated_time;
    m_updated_time_isSet = true;
}

bool OAIIngenico::is_updated_time_Set() const{
    return m_updated_time_isSet;
}

bool OAIIngenico::is_updated_time_Valid() const{
    return m_updated_time_isValid;
}

OAIIngenico_allOf_credentials OAIIngenico::getCredentials() const {
    return m_credentials;
}
void OAIIngenico::setCredentials(const OAIIngenico_allOf_credentials &credentials) {
    m_credentials = credentials;
    m_credentials_isSet = true;
}

bool OAIIngenico::is_credentials_Set() const{
    return m_credentials_isSet;
}

bool OAIIngenico::is_credentials_Valid() const{
    return m_credentials_isValid;
}

OAIIngenico3dsServers OAIIngenico::getThreeDSecureServer() const {
    return m_three_d_secure_server;
}
void OAIIngenico::setThreeDSecureServer(const OAIIngenico3dsServers &three_d_secure_server) {
    m_three_d_secure_server = three_d_secure_server;
    m_three_d_secure_server_isSet = true;
}

bool OAIIngenico::is_three_d_secure_server_Set() const{
    return m_three_d_secure_server_isSet;
}

bool OAIIngenico::is_three_d_secure_server_Valid() const{
    return m_three_d_secure_server_isValid;
}

bool OAIIngenico::isSet() const {
...
bool OAIIngenico::isValid() const {
