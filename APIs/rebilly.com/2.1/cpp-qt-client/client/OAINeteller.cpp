...
OAINeteller::OAINeteller(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAINeteller::OAINeteller() {
    this->initializeModel();
}

OAINeteller::~OAINeteller() {}

void OAINeteller::initializeModel() {
...
void OAINeteller::fromJson(QString jsonString) {
...
void OAINeteller::fromJsonObject(QJsonObject json) {
...
QString OAINeteller::asJson() const {
...
QJsonObject OAINeteller::asJsonObject() const {
    QJsonObject obj;
    if (m__links.size() > 0) {
...
QList<OAIGatewayAccount__links_inner> OAINeteller::getLinks() const {
    return m__links;
}
void OAINeteller::setLinks(const QList<OAIGatewayAccount__links_inner> &_links) {
    m__links = _links;
    m__links_isSet = true;
}

bool OAINeteller::is__links_Set() const{
    return m__links_isSet;
}

bool OAINeteller::is__links_Valid() const{
    return m__links_isValid;
}

QList<QString> OAINeteller::getAcceptedCurrencies() const {
    return m_accepted_currencies;
}
void OAINeteller::setAcceptedCurrencies(const QList<QString> &accepted_currencies) {
    m_accepted_currencies = accepted_currencies;
    m_accepted_currencies_isSet = true;
}

bool OAINeteller::is_accepted_currencies_Set() const{
    return m_accepted_currencies_isSet;
}

bool OAINeteller::is_accepted_currencies_Valid() const{
    return m_accepted_currencies_isValid;
}

OAIAcquirerName OAINeteller::getAcquirerName() const {
    return m_acquirer_name;
}
void OAINeteller::setAcquirerName(const OAIAcquirerName &acquirer_name) {
    m_acquirer_name = acquirer_name;
    m_acquirer_name_isSet = true;
}

bool OAINeteller::is_acquirer_name_Set() const{
    return m_acquirer_name_isSet;
}

bool OAINeteller::is_acquirer_name_Valid() const{
    return m_acquirer_name_isValid;
}

QString OAINeteller::getAdditionalFilters() const {
    return m_additional_filters;
}
void OAINeteller::setAdditionalFilters(const QString &additional_filters) {
    m_additional_filters = additional_filters;
    m_additional_filters_isSet = true;
}

bool OAINeteller::is_additional_filters_Set() const{
    return m_additional_filters_isSet;
}

bool OAINeteller::is_additional_filters_Valid() const{
    return m_additional_filters_isValid;
}

qint32 OAINeteller::getApprovalWindowTtl() const {
    return m_approval_window_ttl;
}
void OAINeteller::setApprovalWindowTtl(const qint32 &approval_window_ttl) {
    m_approval_window_ttl = approval_window_ttl;
    m_approval_window_ttl_isSet = true;
}

bool OAINeteller::is_approval_window_ttl_Set() const{
    return m_approval_window_ttl_isSet;
}

bool OAINeteller::is_approval_window_ttl_Valid() const{
    return m_approval_window_ttl_isValid;
}

QString OAINeteller::getCityField() const {
    return m_city_field;
}
void OAINeteller::setCityField(const QString &city_field) {
    m_city_field = city_field;
    m_city_field_isSet = true;
}

bool OAINeteller::is_city_field_Set() const{
    return m_city_field_isSet;
}

bool OAINeteller::is_city_field_Valid() const{
    return m_city_field_isValid;
}

QDateTime OAINeteller::getCreatedTime() const {
    return m_created_time;
}
void OAINeteller::setCreatedTime(const QDateTime &created_time) {
    m_created_time = created_time;
    m_created_time_isSet = true;
}

bool OAINeteller::is_created_time_Set() const{
    return m_created_time_isSet;
}

bool OAINeteller::is_created_time_Valid() const{
    return m_created_time_isValid;
}

QString OAINeteller::getDccForceCurrency() const {
    return m_dcc_force_currency;
}
void OAINeteller::setDccForceCurrency(const QString &dcc_force_currency) {
    m_dcc_force_currency = dcc_force_currency;
    m_dcc_force_currency_isSet = true;
}

bool OAINeteller::is_dcc_force_currency_Set() const{
    return m_dcc_force_currency_isSet;
}

bool OAINeteller::is_dcc_force_currency_Valid() const{
    return m_dcc_force_currency_isValid;
}

qint32 OAINeteller::getDccMarkup() const {
    return m_dcc_markup;
}
void OAINeteller::setDccMarkup(const qint32 &dcc_markup) {
    m_dcc_markup = dcc_markup;
    m_dcc_markup_isSet = true;
}

bool OAINeteller::is_dcc_markup_Set() const{
    return m_dcc_markup_isSet;
}

bool OAINeteller::is_dcc_markup_Valid() const{
    return m_dcc_markup_isValid;
}

QString OAINeteller::getDescriptor() const {
    return m_descriptor;
}
void OAINeteller::setDescriptor(const QString &descriptor) {
    m_descriptor = descriptor;
    m_descriptor_isSet = true;
}

bool OAINeteller::is_descriptor_Set() const{
    return m_descriptor_isSet;
}

bool OAINeteller::is_descriptor_Valid() const{
    return m_descriptor_isValid;
}

OAIDigitalWallets OAINeteller::getDigitalWallets() const {
    return m_digital_wallets;
}
void OAINeteller::setDigitalWallets(const OAIDigitalWallets &digital_wallets) {
    m_digital_wallets = digital_wallets;
    m_digital_wallets_isSet = true;
}

bool OAINeteller::is_digital_wallets_Set() const{
    return m_digital_wallets_isSet;
}

bool OAINeteller::is_digital_wallets_Valid() const{
    return m_digital_wallets_isValid;
}

bool OAINeteller::isDynamicDescriptor() const {
    return m_dynamic_descriptor;
}
void OAINeteller::setDynamicDescriptor(const bool &dynamic_descriptor) {
    m_dynamic_descriptor = dynamic_descriptor;
    m_dynamic_descriptor_isSet = true;
}

bool OAINeteller::is_dynamic_descriptor_Set() const{
    return m_dynamic_descriptor_isSet;
}

bool OAINeteller::is_dynamic_descriptor_Valid() const{
    return m_dynamic_descriptor_isValid;
}

QList<QString> OAINeteller::getExcludedDccQuoteCurrencies() const {
    return m_excluded_dcc_quote_currencies;
}
void OAINeteller::setExcludedDccQuoteCurrencies(const QList<QString> &excluded_dcc_quote_currencies) {
    m_excluded_dcc_quote_currencies = excluded_dcc_quote_currencies;
    m_excluded_dcc_quote_currencies_isSet = true;
}

bool OAINeteller::is_excluded_dcc_quote_currencies_Set() const{
    return m_excluded_dcc_quote_currencies_isSet;
}

bool OAINeteller::is_excluded_dcc_quote_currencies_Valid() const{
    return m_excluded_dcc_quote_currencies_isValid;
}

OAIGatewayName OAINeteller::getGatewayName() const {
    return m_gateway_name;
}
void OAINeteller::setGatewayName(const OAIGatewayName &gateway_name) {
    m_gateway_name = gateway_name;
    m_gateway_name_isSet = true;
}

bool OAINeteller::is_gateway_name_Set() const{
    return m_gateway_name_isSet;
}

bool OAINeteller::is_gateway_name_Valid() const{
    return m_gateway_name_isValid;
}

QString OAINeteller::getId() const {
    return m_id;
}
void OAINeteller::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAINeteller::is_id_Set() const{
    return m_id_isSet;
}

bool OAINeteller::is_id_Valid() const{
    return m_id_isValid;
}

bool OAINeteller::isIsDown() const {
    return m_is_down;
}
void OAINeteller::setIsDown(const bool &is_down) {
    m_is_down = is_down;
    m_is_down_isSet = true;
}

bool OAINeteller::is_is_down_Set() const{
    return m_is_down_isSet;
}

bool OAINeteller::is_is_down_Valid() const{
    return m_is_down_isValid;
}

QString OAINeteller::getMerchantCategoryCode() const {
    return m_merchant_category_code;
}
void OAINeteller::setMerchantCategoryCode(const QString &merchant_category_code) {
    m_merchant_category_code = merchant_category_code;
    m_merchant_category_code_isSet = true;
}

bool OAINeteller::is_merchant_category_code_Set() const{
    return m_merchant_category_code_isSet;
}

bool OAINeteller::is_merchant_category_code_Valid() const{
    return m_merchant_category_code_isValid;
}

OAIPaymentMethod OAINeteller::getMethod() const {
    return m_method;
}
void OAINeteller::setMethod(const OAIPaymentMethod &method) {
    m_method = method;
    m_method_isSet = true;
}

bool OAINeteller::is_method_Set() const{
    return m_method_isSet;
}

bool OAINeteller::is_method_Valid() const{
    return m_method_isValid;
}

double OAINeteller::getMonthlyLimit() const {
    return m_monthly_limit;
}
void OAINeteller::setMonthlyLimit(const double &monthly_limit) {
    m_monthly_limit = monthly_limit;
    m_monthly_limit_isSet = true;
}

bool OAINeteller::is_monthly_limit_Set() const{
    return m_monthly_limit_isSet;
}

bool OAINeteller::is_monthly_limit_Valid() const{
    return m_monthly_limit_isValid;
}

QString OAINeteller::getOrganizationId() const {
    return m_organization_id;
}
void OAINeteller::setOrganizationId(const QString &organization_id) {
    m_organization_id = organization_id;
    m_organization_id_isSet = true;
}

bool OAINeteller::is_organization_id_Set() const{
    return m_organization_id_isSet;
}

bool OAINeteller::is_organization_id_Valid() const{
    return m_organization_id_isValid;
}

QList<OAIPaymentCardBrand> OAINeteller::getPaymentCardSchemes() const {
    return m_payment_card_schemes;
}
void OAINeteller::setPaymentCardSchemes(const QList<OAIPaymentCardBrand> &payment_card_schemes) {
    m_payment_card_schemes = payment_card_schemes;
    m_payment_card_schemes_isSet = true;
}

bool OAINeteller::is_payment_card_schemes_Set() const{
    return m_payment_card_schemes_isSet;
}

bool OAINeteller::is_payment_card_schemes_Valid() const{
    return m_payment_card_schemes_isValid;
}

bool OAINeteller::isReconciliationWindowEnabled() const {
    return m_reconciliation_window_enabled;
}
void OAINeteller::setReconciliationWindowEnabled(const bool &reconciliation_window_enabled) {
    m_reconciliation_window_enabled = reconciliation_window_enabled;
    m_reconciliation_window_enabled_isSet = true;
}

bool OAINeteller::is_reconciliation_window_enabled_Set() const{
    return m_reconciliation_window_enabled_isSet;
}

bool OAINeteller::is_reconciliation_window_enabled_Valid() const{
    return m_reconciliation_window_enabled_isValid;
}

qint32 OAINeteller::getReconciliationWindowTtl() const {
    return m_reconciliation_window_ttl;
}
void OAINeteller::setReconciliationWindowTtl(const qint32 &reconciliation_window_ttl) {
    m_reconciliation_window_ttl = reconciliation_window_ttl;
    m_reconciliation_window_ttl_isSet = true;
}

bool OAINeteller::is_reconciliation_window_ttl_Set() const{
    return m_reconciliation_window_ttl_isSet;
}

bool OAINeteller::is_reconciliation_window_ttl_Valid() const{
    return m_reconciliation_window_ttl_isValid;
}

QString OAINeteller::getStatus() const {
    return m_status;
}
void OAINeteller::setStatus(const QString &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAINeteller::is_status_Set() const{
    return m_status_isSet;
}

bool OAINeteller::is_status_Valid() const{
    return m_status_isValid;
}

bool OAINeteller::isSticky() const {
    return m_sticky;
}
void OAINeteller::setSticky(const bool &sticky) {
    m_sticky = sticky;
    m_sticky_isSet = true;
}

bool OAINeteller::is_sticky_Set() const{
    return m_sticky_isSet;
}

bool OAINeteller::is_sticky_Valid() const{
    return m_sticky_isValid;
}

bool OAINeteller::isThreeDSecure() const {
    return m_three_d_secure;
}
void OAINeteller::setThreeDSecure(const bool &three_d_secure) {
    m_three_d_secure = three_d_secure;
    m_three_d_secure_isSet = true;
}

bool OAINeteller::is_three_d_secure_Set() const{
    return m_three_d_secure_isSet;
}

bool OAINeteller::is_three_d_secure_Valid() const{
    return m_three_d_secure_isValid;
}

qint32 OAINeteller::getTimeout() const {
    return m_timeout;
}
void OAINeteller::setTimeout(const qint32 &timeout) {
    m_timeout = timeout;
    m_timeout_isSet = true;
}

bool OAINeteller::is_timeout_Set() const{
    return m_timeout_isSet;
}

bool OAINeteller::is_timeout_Valid() const{
    return m_timeout_isValid;
}

QString OAINeteller::getToken() const {
    return m_token;
}
void OAINeteller::setToken(const QString &token) {
    m_token = token;
    m_token_isSet = true;
}

bool OAINeteller::is_token_Set() const{
    return m_token_isSet;
}

bool OAINeteller::is_token_Valid() const{
    return m_token_isValid;
}

QDateTime OAINeteller::getUpdatedTime() const {
    return m_updated_time;
}
void OAINeteller::setUpdatedTime(const QDateTime &updated_time) {
    m_updated_time = updated_time;
    m_updated_time_isSet = true;
}

bool OAINeteller::is_updated_time_Set() const{
    return m_updated_time_isSet;
}

bool OAINeteller::is_updated_time_Valid() const{
    return m_updated_time_isValid;
}

OAINeteller_allOf_credentials OAINeteller::getCredentials() const {
    return m_credentials;
}
void OAINeteller::setCredentials(const OAINeteller_allOf_credentials &credentials) {
    m_credentials = credentials;
    m_credentials_isSet = true;
}

bool OAINeteller::is_credentials_Set() const{
    return m_credentials_isSet;
}

bool OAINeteller::is_credentials_Valid() const{
    return m_credentials_isValid;
}

OAINeteller_allOf_settings OAINeteller::getSettings() const {
    return m_settings;
}
void OAINeteller::setSettings(const OAINeteller_allOf_settings &settings) {
    m_settings = settings;
    m_settings_isSet = true;
}

bool OAINeteller::is_settings_Set() const{
    return m_settings_isSet;
}

bool OAINeteller::is_settings_Valid() const{
    return m_settings_isValid;
}

bool OAINeteller::isSet() const {
...
bool OAINeteller::isValid() const {
