...
QList<OAIGatewayAccount__links_inner> OAIGET::getLinks() const {
    return m__links;
}
void OAIGET::setLinks(const QList<OAIGatewayAccount__links_inner> &_links) {
    m__links = _links;
    m__links_isSet = true;
}

bool OAIGET::is__links_Set() const{
    return m__links_isSet;
}

bool OAIGET::is__links_Valid() const{
    return m__links_isValid;
}

QList<QString> OAIGET::getAcceptedCurrencies() const {
    return m_accepted_currencies;
}
void OAIGET::setAcceptedCurrencies(const QList<QString> &accepted_currencies) {
    m_accepted_currencies = accepted_currencies;
    m_accepted_currencies_isSet = true;
}

bool OAIGET::is_accepted_currencies_Set() const{
    return m_accepted_currencies_isSet;
}

bool OAIGET::is_accepted_currencies_Valid() const{
    return m_accepted_currencies_isValid;
}

OAIAcquirerName OAIGET::getAcquirerName() const {
    return m_acquirer_name;
}
void OAIGET::setAcquirerName(const OAIAcquirerName &acquirer_name) {
    m_acquirer_name = acquirer_name;
    m_acquirer_name_isSet = true;
}

bool OAIGET::is_acquirer_name_Set() const{
    return m_acquirer_name_isSet;
}

bool OAIGET::is_acquirer_name_Valid() const{
    return m_acquirer_name_isValid;
}

QString OAIGET::getAdditionalFilters() const {
    return m_additional_filters;
}
void OAIGET::setAdditionalFilters(const QString &additional_filters) {
    m_additional_filters = additional_filters;
    m_additional_filters_isSet = true;
}

bool OAIGET::is_additional_filters_Set() const{
    return m_additional_filters_isSet;
}

bool OAIGET::is_additional_filters_Valid() const{
    return m_additional_filters_isValid;
}

qint32 OAIGET::getApprovalWindowTtl() const {
    return m_approval_window_ttl;
}
void OAIGET::setApprovalWindowTtl(const qint32 &approval_window_ttl) {
    m_approval_window_ttl = approval_window_ttl;
    m_approval_window_ttl_isSet = true;
}

bool OAIGET::is_approval_window_ttl_Set() const{
    return m_approval_window_ttl_isSet;
}

bool OAIGET::is_approval_window_ttl_Valid() const{
    return m_approval_window_ttl_isValid;
}

QString OAIGET::getCityField() const {
    return m_city_field;
}
void OAIGET::setCityField(const QString &city_field) {
    m_city_field = city_field;
    m_city_field_isSet = true;
}

bool OAIGET::is_city_field_Set() const{
    return m_city_field_isSet;
}

bool OAIGET::is_city_field_Valid() const{
    return m_city_field_isValid;
}

QDateTime OAIGET::getCreatedTime() const {
    return m_created_time;
}
void OAIGET::setCreatedTime(const QDateTime &created_time) {
    m_created_time = created_time;
    m_created_time_isSet = true;
}

bool OAIGET::is_created_time_Set() const{
    return m_created_time_isSet;
}

bool OAIGET::is_created_time_Valid() const{
    return m_created_time_isValid;
}

QString OAIGET::getDccForceCurrency() const {
    return m_dcc_force_currency;
}
void OAIGET::setDccForceCurrency(const QString &dcc_force_currency) {
    m_dcc_force_currency = dcc_force_currency;
    m_dcc_force_currency_isSet = true;
}

bool OAIGET::is_dcc_force_currency_Set() const{
    return m_dcc_force_currency_isSet;
}

bool OAIGET::is_dcc_force_currency_Valid() const{
    return m_dcc_force_currency_isValid;
}

qint32 OAIGET::getDccMarkup() const {
    return m_dcc_markup;
}
void OAIGET::setDccMarkup(const qint32 &dcc_markup) {
    m_dcc_markup = dcc_markup;
    m_dcc_markup_isSet = true;
}

bool OAIGET::is_dcc_markup_Set() const{
    return m_dcc_markup_isSet;
}

bool OAIGET::is_dcc_markup_Valid() const{
    return m_dcc_markup_isValid;
}

QString OAIGET::getDescriptor() const {
    return m_descriptor;
}
void OAIGET::setDescriptor(const QString &descriptor) {
    m_descriptor = descriptor;
    m_descriptor_isSet = true;
}

bool OAIGET::is_descriptor_Set() const{
    return m_descriptor_isSet;
}

bool OAIGET::is_descriptor_Valid() const{
    return m_descriptor_isValid;
}

OAIDigitalWallets OAIGET::getDigitalWallets() const {
    return m_digital_wallets;
}
void OAIGET::setDigitalWallets(const OAIDigitalWallets &digital_wallets) {
    m_digital_wallets = digital_wallets;
    m_digital_wallets_isSet = true;
}

bool OAIGET::is_digital_wallets_Set() const{
    return m_digital_wallets_isSet;
}

bool OAIGET::is_digital_wallets_Valid() const{
    return m_digital_wallets_isValid;
}

bool OAIGET::isDynamicDescriptor() const {
    return m_dynamic_descriptor;
}
void OAIGET::setDynamicDescriptor(const bool &dynamic_descriptor) {
    m_dynamic_descriptor = dynamic_descriptor;
    m_dynamic_descriptor_isSet = true;
}

bool OAIGET::is_dynamic_descriptor_Set() const{
    return m_dynamic_descriptor_isSet;
}

bool OAIGET::is_dynamic_descriptor_Valid() const{
    return m_dynamic_descriptor_isValid;
}

QList<QString> OAIGET::getExcludedDccQuoteCurrencies() const {
    return m_excluded_dcc_quote_currencies;
}
void OAIGET::setExcludedDccQuoteCurrencies(const QList<QString> &excluded_dcc_quote_currencies) {
    m_excluded_dcc_quote_currencies = excluded_dcc_quote_currencies;
    m_excluded_dcc_quote_currencies_isSet = true;
}

bool OAIGET::is_excluded_dcc_quote_currencies_Set() const{
    return m_excluded_dcc_quote_currencies_isSet;
}

bool OAIGET::is_excluded_dcc_quote_currencies_Valid() const{
    return m_excluded_dcc_quote_currencies_isValid;
}

OAIGatewayName OAIGET::getGatewayName() const {
    return m_gateway_name;
}
void OAIGET::setGatewayName(const OAIGatewayName &gateway_name) {
    m_gateway_name = gateway_name;
    m_gateway_name_isSet = true;
}

bool OAIGET::is_gateway_name_Set() const{
    return m_gateway_name_isSet;
}

bool OAIGET::is_gateway_name_Valid() const{
    return m_gateway_name_isValid;
}

QString OAIGET::getId() const {
    return m_id;
}
void OAIGET::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIGET::is_id_Set() const{
    return m_id_isSet;
}

bool OAIGET::is_id_Valid() const{
    return m_id_isValid;
}

bool OAIGET::isIsDown() const {
    return m_is_down;
}
void OAIGET::setIsDown(const bool &is_down) {
    m_is_down = is_down;
    m_is_down_isSet = true;
}

bool OAIGET::is_is_down_Set() const{
    return m_is_down_isSet;
}

bool OAIGET::is_is_down_Valid() const{
    return m_is_down_isValid;
}

QString OAIGET::getMerchantCategoryCode() const {
    return m_merchant_category_code;
}
void OAIGET::setMerchantCategoryCode(const QString &merchant_category_code) {
    m_merchant_category_code = merchant_category_code;
    m_merchant_category_code_isSet = true;
}

bool OAIGET::is_merchant_category_code_Set() const{
    return m_merchant_category_code_isSet;
}

bool OAIGET::is_merchant_category_code_Valid() const{
    return m_merchant_category_code_isValid;
}

OAIPaymentMethod OAIGET::getMethod() const {
    return m_method;
}
void OAIGET::setMethod(const OAIPaymentMethod &method) {
    m_method = method;
    m_method_isSet = true;
}

bool OAIGET::is_method_Set() const{
    return m_method_isSet;
}

bool OAIGET::is_method_Valid() const{
    return m_method_isValid;
}

double OAIGET::getMonthlyLimit() const {
    return m_monthly_limit;
}
void OAIGET::setMonthlyLimit(const double &monthly_limit) {
    m_monthly_limit = monthly_limit;
    m_monthly_limit_isSet = true;
}

bool OAIGET::is_monthly_limit_Set() const{
    return m_monthly_limit_isSet;
}

bool OAIGET::is_monthly_limit_Valid() const{
    return m_monthly_limit_isValid;
}

QString OAIGET::getOrganizationId() const {
    return m_organization_id;
}
void OAIGET::setOrganizationId(const QString &organization_id) {
    m_organization_id = organization_id;
    m_organization_id_isSet = true;
}

bool OAIGET::is_organization_id_Set() const{
    return m_organization_id_isSet;
}

bool OAIGET::is_organization_id_Valid() const{
    return m_organization_id_isValid;
}

QList<OAIPaymentCardBrand> OAIGET::getPaymentCardSchemes() const {
    return m_payment_card_schemes;
}
void OAIGET::setPaymentCardSchemes(const QList<OAIPaymentCardBrand> &payment_card_schemes) {
    m_payment_card_schemes = payment_card_schemes;
    m_payment_card_schemes_isSet = true;
}

bool OAIGET::is_payment_card_schemes_Set() const{
    return m_payment_card_schemes_isSet;
}

bool OAIGET::is_payment_card_schemes_Valid() const{
    return m_payment_card_schemes_isValid;
}

bool OAIGET::isReconciliationWindowEnabled() const {
    return m_reconciliation_window_enabled;
}
void OAIGET::setReconciliationWindowEnabled(const bool &reconciliation_window_enabled) {
    m_reconciliation_window_enabled = reconciliation_window_enabled;
    m_reconciliation_window_enabled_isSet = true;
}

bool OAIGET::is_reconciliation_window_enabled_Set() const{
    return m_reconciliation_window_enabled_isSet;
}

bool OAIGET::is_reconciliation_window_enabled_Valid() const{
    return m_reconciliation_window_enabled_isValid;
}

qint32 OAIGET::getReconciliationWindowTtl() const {
    return m_reconciliation_window_ttl;
}
void OAIGET::setReconciliationWindowTtl(const qint32 &reconciliation_window_ttl) {
    m_reconciliation_window_ttl = reconciliation_window_ttl;
    m_reconciliation_window_ttl_isSet = true;
}

bool OAIGET::is_reconciliation_window_ttl_Set() const{
    return m_reconciliation_window_ttl_isSet;
}

bool OAIGET::is_reconciliation_window_ttl_Valid() const{
    return m_reconciliation_window_ttl_isValid;
}

QString OAIGET::getStatus() const {
    return m_status;
}
void OAIGET::setStatus(const QString &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIGET::is_status_Set() const{
    return m_status_isSet;
}

bool OAIGET::is_status_Valid() const{
    return m_status_isValid;
}

bool OAIGET::isSticky() const {
    return m_sticky;
}
void OAIGET::setSticky(const bool &sticky) {
    m_sticky = sticky;
    m_sticky_isSet = true;
}

bool OAIGET::is_sticky_Set() const{
    return m_sticky_isSet;
}

bool OAIGET::is_sticky_Valid() const{
    return m_sticky_isValid;
}

bool OAIGET::isThreeDSecure() const {
    return m_three_d_secure;
}
void OAIGET::setThreeDSecure(const bool &three_d_secure) {
    m_three_d_secure = three_d_secure;
    m_three_d_secure_isSet = true;
}

bool OAIGET::is_three_d_secure_Set() const{
    return m_three_d_secure_isSet;
}

bool OAIGET::is_three_d_secure_Valid() const{
    return m_three_d_secure_isValid;
}

qint32 OAIGET::getTimeout() const {
    return m_timeout;
}
void OAIGET::setTimeout(const qint32 &timeout) {
    m_timeout = timeout;
    m_timeout_isSet = true;
}

bool OAIGET::is_timeout_Set() const{
    return m_timeout_isSet;
}

bool OAIGET::is_timeout_Valid() const{
    return m_timeout_isValid;
}

QString OAIGET::getToken() const {
    return m_token;
}
void OAIGET::setToken(const QString &token) {
    m_token = token;
    m_token_isSet = true;
}

bool OAIGET::is_token_Set() const{
    return m_token_isSet;
}

bool OAIGET::is_token_Valid() const{
    return m_token_isValid;
}

QDateTime OAIGET::getUpdatedTime() const {
    return m_updated_time;
}
void OAIGET::setUpdatedTime(const QDateTime &updated_time) {
    m_updated_time = updated_time;
    m_updated_time_isSet = true;
}

bool OAIGET::is_updated_time_Set() const{
    return m_updated_time_isSet;
}

bool OAIGET::is_updated_time_Valid() const{
    return m_updated_time_isValid;
}

OAIGET_allOf_credentials OAIGET::getCredentials() const {
    return m_credentials;
}
void OAIGET::setCredentials(const OAIGET_allOf_credentials &credentials) {
    m_credentials = credentials;
    m_credentials_isSet = true;
}

bool OAIGET::is_credentials_Set() const{
    return m_credentials_isSet;
}

bool OAIGET::is_credentials_Valid() const{
    return m_credentials_isValid;
}

OAIGET3dsServers OAIGET::getThreeDSecureServer() const {
    return m_three_d_secure_server;
}
void OAIGET::setThreeDSecureServer(const OAIGET3dsServers &three_d_secure_server) {
    m_three_d_secure_server = three_d_secure_server;
    m_three_d_secure_server_isSet = true;
}

bool OAIGET::is_three_d_secure_server_Set() const{
    return m_three_d_secure_server_isSet;
}

bool OAIGET::is_three_d_secure_server_Valid() const{
