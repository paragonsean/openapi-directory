...
OAIWirecard::OAIWirecard(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIWirecard::OAIWirecard() {
    this->initializeModel();
}

OAIWirecard::~OAIWirecard() {}

void OAIWirecard::initializeModel() {
...
void OAIWirecard::fromJson(QString jsonString) {
...
void OAIWirecard::fromJsonObject(QJsonObject json) {
...
QString OAIWirecard::asJson() const {
...
QJsonObject OAIWirecard::asJsonObject() const {
    QJsonObject obj;
    if (m__links.size() > 0) {
...
QList<OAIGatewayAccount__links_inner> OAIWirecard::getLinks() const {
    return m__links;
}
void OAIWirecard::setLinks(const QList<OAIGatewayAccount__links_inner> &_links) {
    m__links = _links;
    m__links_isSet = true;
}

bool OAIWirecard::is__links_Set() const{
    return m__links_isSet;
}

bool OAIWirecard::is__links_Valid() const{
    return m__links_isValid;
}

QList<QString> OAIWirecard::getAcceptedCurrencies() const {
    return m_accepted_currencies;
}
void OAIWirecard::setAcceptedCurrencies(const QList<QString> &accepted_currencies) {
    m_accepted_currencies = accepted_currencies;
    m_accepted_currencies_isSet = true;
}

bool OAIWirecard::is_accepted_currencies_Set() const{
    return m_accepted_currencies_isSet;
}

bool OAIWirecard::is_accepted_currencies_Valid() const{
    return m_accepted_currencies_isValid;
}

OAIAcquirerName OAIWirecard::getAcquirerName() const {
    return m_acquirer_name;
}
void OAIWirecard::setAcquirerName(const OAIAcquirerName &acquirer_name) {
    m_acquirer_name = acquirer_name;
    m_acquirer_name_isSet = true;
}

bool OAIWirecard::is_acquirer_name_Set() const{
    return m_acquirer_name_isSet;
}

bool OAIWirecard::is_acquirer_name_Valid() const{
    return m_acquirer_name_isValid;
}

QString OAIWirecard::getAdditionalFilters() const {
    return m_additional_filters;
}
void OAIWirecard::setAdditionalFilters(const QString &additional_filters) {
    m_additional_filters = additional_filters;
    m_additional_filters_isSet = true;
}

bool OAIWirecard::is_additional_filters_Set() const{
    return m_additional_filters_isSet;
}

bool OAIWirecard::is_additional_filters_Valid() const{
    return m_additional_filters_isValid;
}

qint32 OAIWirecard::getApprovalWindowTtl() const {
    return m_approval_window_ttl;
}
void OAIWirecard::setApprovalWindowTtl(const qint32 &approval_window_ttl) {
    m_approval_window_ttl = approval_window_ttl;
    m_approval_window_ttl_isSet = true;
}

bool OAIWirecard::is_approval_window_ttl_Set() const{
    return m_approval_window_ttl_isSet;
}

bool OAIWirecard::is_approval_window_ttl_Valid() const{
    return m_approval_window_ttl_isValid;
}

QString OAIWirecard::getCityField() const {
    return m_city_field;
}
void OAIWirecard::setCityField(const QString &city_field) {
    m_city_field = city_field;
    m_city_field_isSet = true;
}

bool OAIWirecard::is_city_field_Set() const{
    return m_city_field_isSet;
}

bool OAIWirecard::is_city_field_Valid() const{
    return m_city_field_isValid;
}

QDateTime OAIWirecard::getCreatedTime() const {
    return m_created_time;
}
void OAIWirecard::setCreatedTime(const QDateTime &created_time) {
    m_created_time = created_time;
    m_created_time_isSet = true;
}

bool OAIWirecard::is_created_time_Set() const{
    return m_created_time_isSet;
}

bool OAIWirecard::is_created_time_Valid() const{
    return m_created_time_isValid;
}

QString OAIWirecard::getDccForceCurrency() const {
    return m_dcc_force_currency;
}
void OAIWirecard::setDccForceCurrency(const QString &dcc_force_currency) {
    m_dcc_force_currency = dcc_force_currency;
    m_dcc_force_currency_isSet = true;
}

bool OAIWirecard::is_dcc_force_currency_Set() const{
    return m_dcc_force_currency_isSet;
}

bool OAIWirecard::is_dcc_force_currency_Valid() const{
    return m_dcc_force_currency_isValid;
}

qint32 OAIWirecard::getDccMarkup() const {
    return m_dcc_markup;
}
void OAIWirecard::setDccMarkup(const qint32 &dcc_markup) {
    m_dcc_markup = dcc_markup;
    m_dcc_markup_isSet = true;
}

bool OAIWirecard::is_dcc_markup_Set() const{
    return m_dcc_markup_isSet;
}

bool OAIWirecard::is_dcc_markup_Valid() const{
    return m_dcc_markup_isValid;
}

QString OAIWirecard::getDescriptor() const {
    return m_descriptor;
}
void OAIWirecard::setDescriptor(const QString &descriptor) {
    m_descriptor = descriptor;
    m_descriptor_isSet = true;
}

bool OAIWirecard::is_descriptor_Set() const{
    return m_descriptor_isSet;
}

bool OAIWirecard::is_descriptor_Valid() const{
    return m_descriptor_isValid;
}

OAIDigitalWallets OAIWirecard::getDigitalWallets() const {
    return m_digital_wallets;
}
void OAIWirecard::setDigitalWallets(const OAIDigitalWallets &digital_wallets) {
    m_digital_wallets = digital_wallets;
    m_digital_wallets_isSet = true;
}

bool OAIWirecard::is_digital_wallets_Set() const{
    return m_digital_wallets_isSet;
}

bool OAIWirecard::is_digital_wallets_Valid() const{
    return m_digital_wallets_isValid;
}

bool OAIWirecard::isDynamicDescriptor() const {
    return m_dynamic_descriptor;
}
void OAIWirecard::setDynamicDescriptor(const bool &dynamic_descriptor) {
    m_dynamic_descriptor = dynamic_descriptor;
    m_dynamic_descriptor_isSet = true;
}

bool OAIWirecard::is_dynamic_descriptor_Set() const{
    return m_dynamic_descriptor_isSet;
}

bool OAIWirecard::is_dynamic_descriptor_Valid() const{
    return m_dynamic_descriptor_isValid;
}

QList<QString> OAIWirecard::getExcludedDccQuoteCurrencies() const {
    return m_excluded_dcc_quote_currencies;
}
void OAIWirecard::setExcludedDccQuoteCurrencies(const QList<QString> &excluded_dcc_quote_currencies) {
    m_excluded_dcc_quote_currencies = excluded_dcc_quote_currencies;
    m_excluded_dcc_quote_currencies_isSet = true;
}

bool OAIWirecard::is_excluded_dcc_quote_currencies_Set() const{
    return m_excluded_dcc_quote_currencies_isSet;
}

bool OAIWirecard::is_excluded_dcc_quote_currencies_Valid() const{
    return m_excluded_dcc_quote_currencies_isValid;
}

OAIGatewayName OAIWirecard::getGatewayName() const {
    return m_gateway_name;
}
void OAIWirecard::setGatewayName(const OAIGatewayName &gateway_name) {
    m_gateway_name = gateway_name;
    m_gateway_name_isSet = true;
}

bool OAIWirecard::is_gateway_name_Set() const{
    return m_gateway_name_isSet;
}

bool OAIWirecard::is_gateway_name_Valid() const{
    return m_gateway_name_isValid;
}

QString OAIWirecard::getId() const {
    return m_id;
}
void OAIWirecard::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIWirecard::is_id_Set() const{
    return m_id_isSet;
}

bool OAIWirecard::is_id_Valid() const{
    return m_id_isValid;
}

bool OAIWirecard::isIsDown() const {
    return m_is_down;
}
void OAIWirecard::setIsDown(const bool &is_down) {
    m_is_down = is_down;
    m_is_down_isSet = true;
}

bool OAIWirecard::is_is_down_Set() const{
    return m_is_down_isSet;
}

bool OAIWirecard::is_is_down_Valid() const{
    return m_is_down_isValid;
}

QString OAIWirecard::getMerchantCategoryCode() const {
    return m_merchant_category_code;
}
void OAIWirecard::setMerchantCategoryCode(const QString &merchant_category_code) {
    m_merchant_category_code = merchant_category_code;
    m_merchant_category_code_isSet = true;
}

bool OAIWirecard::is_merchant_category_code_Set() const{
    return m_merchant_category_code_isSet;
}

bool OAIWirecard::is_merchant_category_code_Valid() const{
    return m_merchant_category_code_isValid;
}

OAIPaymentMethod OAIWirecard::getMethod() const {
    return m_method;
}
void OAIWirecard::setMethod(const OAIPaymentMethod &method) {
    m_method = method;
    m_method_isSet = true;
}

bool OAIWirecard::is_method_Set() const{
    return m_method_isSet;
}

bool OAIWirecard::is_method_Valid() const{
    return m_method_isValid;
}

double OAIWirecard::getMonthlyLimit() const {
    return m_monthly_limit;
}
void OAIWirecard::setMonthlyLimit(const double &monthly_limit) {
    m_monthly_limit = monthly_limit;
    m_monthly_limit_isSet = true;
}

bool OAIWirecard::is_monthly_limit_Set() const{
    return m_monthly_limit_isSet;
}

bool OAIWirecard::is_monthly_limit_Valid() const{
    return m_monthly_limit_isValid;
}

QString OAIWirecard::getOrganizationId() const {
    return m_organization_id;
}
void OAIWirecard::setOrganizationId(const QString &organization_id) {
    m_organization_id = organization_id;
    m_organization_id_isSet = true;
}

bool OAIWirecard::is_organization_id_Set() const{
    return m_organization_id_isSet;
}

bool OAIWirecard::is_organization_id_Valid() const{
    return m_organization_id_isValid;
}

QList<OAIPaymentCardBrand> OAIWirecard::getPaymentCardSchemes() const {
    return m_payment_card_schemes;
}
void OAIWirecard::setPaymentCardSchemes(const QList<OAIPaymentCardBrand> &payment_card_schemes) {
    m_payment_card_schemes = payment_card_schemes;
    m_payment_card_schemes_isSet = true;
}

bool OAIWirecard::is_payment_card_schemes_Set() const{
    return m_payment_card_schemes_isSet;
}

bool OAIWirecard::is_payment_card_schemes_Valid() const{
    return m_payment_card_schemes_isValid;
}

bool OAIWirecard::isReconciliationWindowEnabled() const {
    return m_reconciliation_window_enabled;
}
void OAIWirecard::setReconciliationWindowEnabled(const bool &reconciliation_window_enabled) {
    m_reconciliation_window_enabled = reconciliation_window_enabled;
    m_reconciliation_window_enabled_isSet = true;
}

bool OAIWirecard::is_reconciliation_window_enabled_Set() const{
    return m_reconciliation_window_enabled_isSet;
}

bool OAIWirecard::is_reconciliation_window_enabled_Valid() const{
    return m_reconciliation_window_enabled_isValid;
}

qint32 OAIWirecard::getReconciliationWindowTtl() const {
    return m_reconciliation_window_ttl;
}
void OAIWirecard::setReconciliationWindowTtl(const qint32 &reconciliation_window_ttl) {
    m_reconciliation_window_ttl = reconciliation_window_ttl;
    m_reconciliation_window_ttl_isSet = true;
}

bool OAIWirecard::is_reconciliation_window_ttl_Set() const{
    return m_reconciliation_window_ttl_isSet;
}

bool OAIWirecard::is_reconciliation_window_ttl_Valid() const{
    return m_reconciliation_window_ttl_isValid;
}

QString OAIWirecard::getStatus() const {
    return m_status;
}
void OAIWirecard::setStatus(const QString &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIWirecard::is_status_Set() const{
    return m_status_isSet;
}

bool OAIWirecard::is_status_Valid() const{
    return m_status_isValid;
}

bool OAIWirecard::isSticky() const {
    return m_sticky;
}
void OAIWirecard::setSticky(const bool &sticky) {
    m_sticky = sticky;
    m_sticky_isSet = true;
}

bool OAIWirecard::is_sticky_Set() const{
    return m_sticky_isSet;
}

bool OAIWirecard::is_sticky_Valid() const{
    return m_sticky_isValid;
}

bool OAIWirecard::isThreeDSecure() const {
    return m_three_d_secure;
}
void OAIWirecard::setThreeDSecure(const bool &three_d_secure) {
    m_three_d_secure = three_d_secure;
    m_three_d_secure_isSet = true;
}

bool OAIWirecard::is_three_d_secure_Set() const{
    return m_three_d_secure_isSet;
}

bool OAIWirecard::is_three_d_secure_Valid() const{
    return m_three_d_secure_isValid;
}

qint32 OAIWirecard::getTimeout() const {
    return m_timeout;
}
void OAIWirecard::setTimeout(const qint32 &timeout) {
    m_timeout = timeout;
    m_timeout_isSet = true;
}

bool OAIWirecard::is_timeout_Set() const{
    return m_timeout_isSet;
}

bool OAIWirecard::is_timeout_Valid() const{
    return m_timeout_isValid;
}

QString OAIWirecard::getToken() const {
    return m_token;
}
void OAIWirecard::setToken(const QString &token) {
    m_token = token;
    m_token_isSet = true;
}

bool OAIWirecard::is_token_Set() const{
    return m_token_isSet;
}

bool OAIWirecard::is_token_Valid() const{
    return m_token_isValid;
}

QDateTime OAIWirecard::getUpdatedTime() const {
    return m_updated_time;
}
void OAIWirecard::setUpdatedTime(const QDateTime &updated_time) {
    m_updated_time = updated_time;
    m_updated_time_isSet = true;
}

bool OAIWirecard::is_updated_time_Set() const{
    return m_updated_time_isSet;
}

bool OAIWirecard::is_updated_time_Valid() const{
    return m_updated_time_isValid;
}

OAIWirecard_allOf_credentials OAIWirecard::getCredentials() const {
    return m_credentials;
}
void OAIWirecard::setCredentials(const OAIWirecard_allOf_credentials &credentials) {
    m_credentials = credentials;
    m_credentials_isSet = true;
}

bool OAIWirecard::is_credentials_Set() const{
    return m_credentials_isSet;
}

bool OAIWirecard::is_credentials_Valid() const{
    return m_credentials_isValid;
}

OAIWirecard3dsServers OAIWirecard::getThreeDSecureServer() const {
    return m_three_d_secure_server;
}
void OAIWirecard::setThreeDSecureServer(const OAIWirecard3dsServers &three_d_secure_server) {
    m_three_d_secure_server = three_d_secure_server;
    m_three_d_secure_server_isSet = true;
}

bool OAIWirecard::is_three_d_secure_server_Set() const{
    return m_three_d_secure_server_isSet;
}

bool OAIWirecard::is_three_d_secure_server_Valid() const{
    return m_three_d_secure_server_isValid;
}

bool OAIWirecard::isSet() const {
...
bool OAIWirecard::isValid() const {
