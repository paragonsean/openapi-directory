...
#include "OAIICheque_allOf_credentials.h"
...
class OAIICheque_allOf_credentials;

class OAIICheque : public OAIObject {
public:
    OAIICheque();
    OAIICheque(QString json);
    ~OAIICheque() override;
    ...
    OAIICheque_allOf_credentials getCredentials() const;
    void setCredentials(const OAIICheque_allOf_credentials &credentials);
...
private:
    ...
    OAIICheque_allOf_credentials m_credentials;
...
Q_DECLARE_METATYPE(OpenAPI::OAIICheque)
