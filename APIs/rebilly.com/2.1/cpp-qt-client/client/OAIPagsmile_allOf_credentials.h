...
/*
 * OAIPagsmile_allOf_credentials.h
 *
 * 
 */

#ifndef OAIPagsmile_allOf_credentials_H
#define OAIPagsmile_allOf_credentials_H
...
class OAIPagsmile_allOf_credentials : public OAIObject {
public:
    OAIPagsmile_allOf_credentials();
    OAIPagsmile_allOf_credentials(QString json);
    ~OAIPagsmile_allOf_credentials() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPagsmile_allOf_credentials)

#endif // OAIPagsmile_allOf_credentials_H
