...
OAIBBANInstrument::OAIBBANInstrument(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIBBANInstrument::OAIBBANInstrument() {
    this->initializeModel();
}

OAIBBANInstrument::~OAIBBANInstrument() {}

void OAIBBANInstrument::initializeModel() {
...
void OAIBBANInstrument::fromJson(QString jsonString) {
...
void OAIBBANInstrument::fromJsonObject(QJsonObject json) {
...
QString OAIBBANInstrument::asJson() const {
...
QJsonObject OAIBBANInstrument::asJsonObject() const {
    QJsonObject obj;
...
QString OAIBBANInstrument::getAccountNumberType() const {
    return m_account_number_type;
}
void OAIBBANInstrument::setAccountNumberType(const QString &account_number_type) {
    m_account_number_type = account_number_type;
    m_account_number_type_isSet = true;
}

bool OAIBBANInstrument::is_account_number_type_Set() const{
    return m_account_number_type_isSet;
}

bool OAIBBANInstrument::is_account_number_type_Valid() const{
    return m_account_number_type_isValid;
}

QString OAIBBANInstrument::getAccountNumber() const {
    return m_account_number;
}
void OAIBBANInstrument::setAccountNumber(const QString &account_number) {
    m_account_number = account_number;
    m_account_number_isSet = true;
}

bool OAIBBANInstrument::is_account_number_Set() const{
    return m_account_number_isSet;
}

bool OAIBBANInstrument::is_account_number_Valid() const{
    return m_account_number_isValid;
}

QString OAIBBANInstrument::getAccountType() const {
    return m_account_type;
}
void OAIBBANInstrument::setAccountType(const QString &account_type) {
    m_account_type = account_type;
    m_account_type_isSet = true;
}

bool OAIBBANInstrument::is_account_type_Set() const{
    return m_account_type_isSet;
}

bool OAIBBANInstrument::is_account_type_Valid() const{
    return m_account_type_isValid;
}

QString OAIBBANInstrument::getBankName() const {
    return m_bank_name;
}
void OAIBBANInstrument::setBankName(const QString &bank_name) {
    m_bank_name = bank_name;
    m_bank_name_isSet = true;
}

bool OAIBBANInstrument::is_bank_name_Set() const{
    return m_bank_name_isSet;
}

bool OAIBBANInstrument::is_bank_name_Valid() const{
    return m_bank_name_isValid;
}

QString OAIBBANInstrument::getBic() const {
    return m_bic;
}
void OAIBBANInstrument::setBic(const QString &bic) {
    m_bic = bic;
    m_bic_isSet = true;
}

bool OAIBBANInstrument::is_bic_Set() const{
    return m_bic_isSet;
}

bool OAIBBANInstrument::is_bic_Valid() const{
    return m_bic_isValid;
}

QString OAIBBANInstrument::getLast4() const {
    return m_last4;
}
void OAIBBANInstrument::setLast4(const QString &last4) {
    m_last4 = last4;
    m_last4_isSet = true;
}

bool OAIBBANInstrument::is_last4_Set() const{
    return m_last4_isSet;
}

bool OAIBBANInstrument::is_last4_Valid() const{
    return m_last4_isValid;
}

QString OAIBBANInstrument::getRoutingNumber() const {
    return m_routing_number;
}
void OAIBBANInstrument::setRoutingNumber(const QString &routing_number) {
    m_routing_number = routing_number;
    m_routing_number_isSet = true;
}

bool OAIBBANInstrument::is_routing_number_Set() const{
    return m_routing_number_isSet;
}

bool OAIBBANInstrument::is_routing_number_Valid() const{
    return m_routing_number_isValid;
}

bool OAIBBANInstrument::isSet() const {
...
bool OAIBBANInstrument::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_account_number_type_isValid && m_account_number_isValid && m_account_type_isValid && m_routing_number_isValid && true;
}
