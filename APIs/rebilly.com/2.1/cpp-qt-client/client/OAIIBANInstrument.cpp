...
OAIIBANInstrument::OAIIBANInstrument(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIIBANInstrument::OAIIBANInstrument() {
    this->initializeModel();
}

OAIIBANInstrument::~OAIIBANInstrument() {}

void OAIIBANInstrument::initializeModel() {
...
void OAIIBANInstrument::fromJson(QString jsonString) {
...
void OAIIBANInstrument::fromJsonObject(QJsonObject json) {
...
QString OAIIBANInstrument::asJson() const {
...
QJsonObject OAIIBANInstrument::asJsonObject() const {
    QJsonObject obj;
...
QString OAIIBANInstrument::getAccountNumberType() const {
    return m_account_number_type;
}
void OAIIBANInstrument::setAccountNumberType(const QString &account_number_type) {
    m_account_number_type = account_number_type;
    m_account_number_type_isSet = true;
}

bool OAIIBANInstrument::is_account_number_type_Set() const{
    return m_account_number_type_isSet;
}

bool OAIIBANInstrument::is_account_number_type_Valid() const{
    return m_account_number_type_isValid;
}

QString OAIIBANInstrument::getAccountNumber() const {
    return m_account_number;
}
void OAIIBANInstrument::setAccountNumber(const QString &account_number) {
    m_account_number = account_number;
    m_account_number_isSet = true;
}

bool OAIIBANInstrument::is_account_number_Set() const{
    return m_account_number_isSet;
}

bool OAIIBANInstrument::is_account_number_Valid() const{
    return m_account_number_isValid;
}

QString OAIIBANInstrument::getBankName() const {
    return m_bank_name;
}
void OAIIBANInstrument::setBankName(const QString &bank_name) {
    m_bank_name = bank_name;
    m_bank_name_isSet = true;
}

bool OAIIBANInstrument::is_bank_name_Set() const{
    return m_bank_name_isSet;
}

bool OAIIBANInstrument::is_bank_name_Valid() const{
    return m_bank_name_isValid;
}

QString OAIIBANInstrument::getBic() const {
    return m_bic;
}
void OAIIBANInstrument::setBic(const QString &bic) {
    m_bic = bic;
    m_bic_isSet = true;
}

bool OAIIBANInstrument::is_bic_Set() const{
    return m_bic_isSet;
}

bool OAIIBANInstrument::is_bic_Valid() const{
    return m_bic_isValid;
}

QString OAIIBANInstrument::getLast4() const {
    return m_last4;
}
void OAIIBANInstrument::setLast4(const QString &last4) {
    m_last4 = last4;
    m_last4_isSet = true;
}

bool OAIIBANInstrument::is_last4_Set() const{
    return m_last4_isSet;
}

bool OAIIBANInstrument::is_last4_Valid() const{
    return m_last4_isValid;
}

bool OAIIBANInstrument::isSet() const {
...
bool OAIIBANInstrument::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_account_number_type_isValid && m_account_number_isValid && true;
}
