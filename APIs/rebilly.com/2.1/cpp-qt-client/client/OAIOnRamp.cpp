...
OAIOnRamp::OAIOnRamp(QString json) {
...
void OAIOnRamp::initializeModel() {
...
void OAIOnRamp::fromJson(QString jsonString) {
...
void OAIOnRamp::fromJsonObject(QJsonObject json) {
...
QString OAIOnRamp::asJson() const {
...
QJsonObject OAIOnRamp::asJsonObject() const {
    QJsonObject obj;
    if (m__links.size() > 0) {
...
QList<OAIGatewayAccount__links_inner> OAIOnRamp::getLinks() const {
    return m__links;
}
void OAIOnRamp::setLinks(const QList<OAIGatewayAccount__links_inner> &_links) {
    m__links = _links;
    m__links_isSet = true;
}

bool OAIOnRamp::is__links_Set() const{
    return m__links_isSet;
}

bool OAIOnRamp::is__links_Valid() const{
    return m__links_isValid;
}

QList<QString> OAIOnRamp::getAcceptedCurrencies() const {
    return m_accepted_currencies;
}
void OAIOnRamp::setAcceptedCurrencies(const QList<QString> &accepted_currencies) {
    m_accepted_currencies = accepted_currencies;
    m_accepted_currencies_isSet = true;
}

bool OAIOnRamp::is_accepted_currencies_Set() const{
    return m_accepted_currencies_isSet;
}

bool OAIOnRamp::is_accepted_currencies_Valid() const{
    return m_accepted_currencies_isValid;
}

OAIAcquirerName OAIOnRamp::getAcquirerName() const {
    return m_acquirer_name;
}
void OAIOnRamp::setAcquirerName(const OAIAcquirerName &acquirer_name) {
    m_acquirer_name = acquirer_name;
    m_acquirer_name_isSet = true;
}

bool OAIOnRamp::is_acquirer_name_Set() const{
    return m_acquirer_name_isSet;
}

bool OAIOnRamp::is_acquirer_name_Valid() const{
    return m_acquirer_name_isValid;
}

QString OAIOnRamp::getAdditionalFilters() const {
    return m_additional_filters;
}
void OAIOnRamp::setAdditionalFilters(const QString &additional_filters) {
    m_additional_filters = additional_filters;
    m_additional_filters_isSet = true;
}

bool OAIOnRamp::is_additional_filters_Set() const{
    return m_additional_filters_isSet;
}

bool OAIOnRamp::is_additional_filters_Valid() const{
    return m_additional_filters_isValid;
}

qint32 OAIOnRamp::getApprovalWindowTtl() const {
    return m_approval_window_ttl;
}
void OAIOnRamp::setApprovalWindowTtl(const qint32 &approval_window_ttl) {
    m_approval_window_ttl = approval_window_ttl;
    m_approval_window_ttl_isSet = true;
}

bool OAIOnRamp::is_approval_window_ttl_Set() const{
    return m_approval_window_ttl_isSet;
}

bool OAIOnRamp::is_approval_window_ttl_Valid() const{
    return m_approval_window_ttl_isValid;
}

QString OAIOnRamp::getCityField() const {
    return m_city_field;
}
void OAIOnRamp::setCityField(const QString &city_field) {
    m_city_field = city_field;
    m_city_field_isSet = true;
}

bool OAIOnRamp::is_city_field_Set() const{
    return m_city_field_isSet;
}

bool OAIOnRamp::is_city_field_Valid() const{
    return m_city_field_isValid;
}

QDateTime OAIOnRamp::getCreatedTime() const {
    return m_created_time;
}
void OAIOnRamp::setCreatedTime(const QDateTime &created_time) {
    m_created_time = created_time;
    m_created_time_isSet = true;
}

bool OAIOnRamp::is_created_time_Set() const{
    return m_created_time_isSet;
}

bool OAIOnRamp::is_created_time_Valid() const{
    return m_created_time_isValid;
}

QString OAIOnRamp::getDccForceCurrency() const {
    return m_dcc_force_currency;
}
void OAIOnRamp::setDccForceCurrency(const QString &dcc_force_currency) {
    m_dcc_force_currency = dcc_force_currency;
    m_dcc_force_currency_isSet = true;
}

bool OAIOnRamp::is_dcc_force_currency_Set() const{
    return m_dcc_force_currency_isSet;
}

bool OAIOnRamp::is_dcc_force_currency_Valid() const{
    return m_dcc_force_currency_isValid;
}

qint32 OAIOnRamp::getDccMarkup() const {
    return m_dcc_markup;
}
void OAIOnRamp::setDccMarkup(const qint32 &dcc_markup) {
    m_dcc_markup = dcc_markup;
    m_dcc_markup_isSet = true;
}

bool OAIOnRamp::is_dcc_markup_Set() const{
    return m_dcc_markup_isSet;
}

bool OAIOnRamp::is_dcc_markup_Valid() const{
    return m_dcc_markup_isValid;
}

QString OAIOnRamp::getDescriptor() const {
    return m_descriptor;
}
void OAIOnRamp::setDescriptor(const QString &descriptor) {
    m_descriptor = descriptor;
    m_descriptor_isSet = true;
}

bool OAIOnRamp::is_descriptor_Set() const{
    return m_descriptor_isSet;
}

bool OAIOnRamp::is_descriptor_Valid() const{
    return m_descriptor_isValid;
}

OAIDigitalWallets OAIOnRamp::getDigitalWallets() const {
    return m_digital_wallets;
}
void OAIOnRamp::setDigitalWallets(const OAIDigitalWallets &digital_wallets) {
    m_digital_wallets = digital_wallets;
    m_digital_wallets_isSet = true;
}

bool OAIOnRamp::is_digital_wallets_Set() const{
    return m_digital_wallets_isSet;
}

bool OAIOnRamp::is_digital_wallets_Valid() const{
    return m_digital_wallets_isValid;
}

bool OAIOnRamp::isDynamicDescriptor() const {
    return m_dynamic_descriptor;
}
void OAIOnRamp::setDynamicDescriptor(const bool &dynamic_descriptor) {
    m_dynamic_descriptor = dynamic_descriptor;
    m_dynamic_descriptor_isSet = true;
}

bool OAIOnRamp::is_dynamic_descriptor_Set() const{
    return m_dynamic_descriptor_isSet;
}

bool OAIOnRamp::is_dynamic_descriptor_Valid() const{
    return m_dynamic_descriptor_isValid;
}

QList<QString> OAIOnRamp::getExcludedDccQuoteCurrencies() const {
    return m_excluded_dcc_quote_currencies;
}
void OAIOnRamp::setExcludedDccQuoteCurrencies(const QList<QString> &excluded_dcc_quote_currencies) {
    m_excluded_dcc_quote_currencies = excluded_dcc_quote_currencies;
    m_excluded_dcc_quote_currencies_isSet = true;
}

bool OAIOnRamp::is_excluded_dcc_quote_currencies_Set() const{
    return m_excluded_dcc_quote_currencies_isSet;
}

bool OAIOnRamp::is_excluded_dcc_quote_currencies_Valid() const{
    return m_excluded_dcc_quote_currencies_isValid;
}

OAIGatewayName OAIOnRamp::getGatewayName() const {
    return m_gateway_name;
}
void OAIOnRamp::setGatewayName(const OAIGatewayName &gateway_name) {
    m_gateway_name = gateway_name;
    m_gateway_name_isSet = true;
}

bool OAIOnRamp::is_gateway_name_Set() const{
    return m_gateway_name_isSet;
}

bool OAIOnRamp::is_gateway_name_Valid() const{
    return m_gateway_name_isValid;
}

QString OAIOnRamp::getId() const {
    return m_id;
}
void OAIOnRamp::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIOnRamp::is_id_Set() const{
    return m_id_isSet;
}

bool OAIOnRamp::is_id_Valid() const{
    return m_id_isValid;
}

bool OAIOnRamp::isIsDown() const {
    return m_is_down;
}
void OAIOnRamp::setIsDown(const bool &is_down) {
    m_is_down = is_down;
    m_is_down_isSet = true;
}

bool OAIOnRamp::is_is_down_Set() const{
    return m_is_down_isSet;
}

bool OAIOnRamp::is_is_down_Valid() const{
    return m_is_down_isValid;
}

QString OAIOnRamp::getMerchantCategoryCode() const {
    return m_merchant_category_code;
}
void OAIOnRamp::setMerchantCategoryCode(const QString &merchant_category_code) {
    m_merchant_category_code = merchant_category_code;
    m_merchant_category_code_isSet = true;
}

bool OAIOnRamp::is_merchant_category_code_Set() const{
    return m_merchant_category_code_isSet;
}

bool OAIOnRamp::is_merchant_category_code_Valid() const{
    return m_merchant_category_code_isValid;
}

OAIPaymentMethod OAIOnRamp::getMethod() const {
    return m_method;
}
void OAIOnRamp::setMethod(const OAIPaymentMethod &method) {
    m_method = method;
    m_method_isSet = true;
}

bool OAIOnRamp::is_method_Set() const{
    return m_method_isSet;
}

bool OAIOnRamp::is_method_Valid() const{
    return m_method_isValid;
}

double OAIOnRamp::getMonthlyLimit() const {
    return m_monthly_limit;
}
void OAIOnRamp::setMonthlyLimit(const double &monthly_limit) {
    m_monthly_limit = monthly_limit;
    m_monthly_limit_isSet = true;
}

bool OAIOnRamp::is_monthly_limit_Set() const{
    return m_monthly_limit_isSet;
}

bool OAIOnRamp::is_monthly_limit_Valid() const{
    return m_monthly_limit_isValid;
}

QString OAIOnRamp::getOrganizationId() const {
    return m_organization_id;
}
void OAIOnRamp::setOrganizationId(const QString &organization_id) {
    m_organization_id = organization_id;
    m_organization_id_isSet = true;
}

bool OAIOnRamp::is_organization_id_Set() const{
    return m_organization_id_isSet;
}

bool OAIOnRamp::is_organization_id_Valid() const{
    return m_organization_id_isValid;
}

QList<OAIPaymentCardBrand> OAIOnRamp::getPaymentCardSchemes() const {
    return m_payment_card_schemes;
}
void OAIOnRamp::setPaymentCardSchemes(const QList<OAIPaymentCardBrand> &payment_card_schemes) {
    m_payment_card_schemes = payment_card_schemes;
    m_payment_card_schemes_isSet = true;
}

bool OAIOnRamp::is_payment_card_schemes_Set() const{
    return m_payment_card_schemes_isSet;
}

bool OAIOnRamp::is_payment_card_schemes_Valid() const{
    return m_payment_card_schemes_isValid;
}

bool OAIOnRamp::isReconciliationWindowEnabled() const {
    return m_reconciliation_window_enabled;
}
void OAIOnRamp::setReconciliationWindowEnabled(const bool &reconciliation_window_enabled) {
    m_reconciliation_window_enabled = reconciliation_window_enabled;
    m_reconciliation_window_enabled_isSet = true;
}

bool OAIOnRamp::is_reconciliation_window_enabled_Set() const{
    return m_reconciliation_window_enabled_isSet;
}

bool OAIOnRamp::is_reconciliation_window_enabled_Valid() const{
    return m_reconciliation_window_enabled_isValid;
}

qint32 OAIOnRamp::getReconciliationWindowTtl() const {
    return m_reconciliation_window_ttl;
}
void OAIOnRamp::setReconciliationWindowTtl(const qint32 &reconciliation_window_ttl) {
    m_reconciliation_window_ttl = reconciliation_window_ttl;
    m_reconciliation_window_ttl_isSet = true;
}

bool OAIOnRamp::is_reconciliation_window_ttl_Set() const{
    return m_reconciliation_window_ttl_isSet;
}

bool OAIOnRamp::is_reconciliation_window_ttl_Valid() const{
    return m_reconciliation_window_ttl_isValid;
}

QString OAIOnRamp::getStatus() const {
    return m_status;
}
void OAIOnRamp::setStatus(const QString &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIOnRamp::is_status_Set() const{
    return m_status_isSet;
}

bool OAIOnRamp::is_status_Valid() const{
    return m_status_isValid;
}

bool OAIOnRamp::isSticky() const {
    return m_sticky;
}
void OAIOnRamp::setSticky(const bool &sticky) {
    m_sticky = sticky;
    m_sticky_isSet = true;
}

bool OAIOnRamp::is_sticky_Set() const{
    return m_sticky_isSet;
}

bool OAIOnRamp::is_sticky_Valid() const{
    return m_sticky_isValid;
}

bool OAIOnRamp::isThreeDSecure() const {
    return m_three_d_secure;
}
void OAIOnRamp::setThreeDSecure(const bool &three_d_secure) {
    m_three_d_secure = three_d_secure;
    m_three_d_secure_isSet = true;
}

bool OAIOnRamp::is_three_d_secure_Set() const{
    return m_three_d_secure_isSet;
}

bool OAIOnRamp::is_three_d_secure_Valid() const{
    return m_three_d_secure_isValid;
}

qint32 OAIOnRamp::getTimeout() const {
    return m_timeout;
}
void OAIOnRamp::setTimeout(const qint32 &timeout) {
    m_timeout = timeout;
    m_timeout_isSet = true;
}

bool OAIOnRamp::is_timeout_Set() const{
    return m_timeout_isSet;
}

bool OAIOnRamp::is_timeout_Valid() const{
    return m_timeout_isValid;
}

QString OAIOnRamp::getToken() const {
    return m_token;
}
void OAIOnRamp::setToken(const QString &token) {
    m_token = token;
    m_token_isSet = true;
}

bool OAIOnRamp::is_token_Set() const{
    return m_token_isSet;
}

bool OAIOnRamp::is_token_Valid() const{
    return m_token_isValid;
}

QDateTime OAIOnRamp::getUpdatedTime() const {
    return m_updated_time;
}
void OAIOnRamp::setUpdatedTime(const QDateTime &updated_time) {
    m_updated_time = updated_time;
    m_updated_time_isSet = true;
}

bool OAIOnRamp::is_updated_time_Set() const{
    return m_updated_time_isSet;
}

bool OAIOnRamp::is_updated_time_Valid() const{
    return m_updated_time_isValid;
}

OAIOnRamp_allOf_credentials OAIOnRamp::getCredentials() const {
    return m_credentials;
}
void OAIOnRamp::setCredentials(const OAIOnRamp_allOf_credentials &credentials) {
    m_credentials = credentials;
    m_credentials_isSet = true;
}

bool OAIOnRamp::is_credentials_Set() const{
    return m_credentials_isSet;
}

bool OAIOnRamp::is_credentials_Valid() const{
    return m_credentials_isValid;
}

bool OAIOnRamp::isSet() const {
