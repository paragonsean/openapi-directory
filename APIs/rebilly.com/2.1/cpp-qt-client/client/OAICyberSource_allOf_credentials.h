...
/*
 * OAICyberSource_allOf_credentials.h
 *
 * CyberSource credentials object.
 */

#ifndef OAICyberSource_allOf_credentials_H
#define OAICyberSource_allOf_credentials_H
...
class OAICyberSource_allOf_credentials : public OAIObject {
public:
    OAICyberSource_allOf_credentials();
    OAICyberSource_allOf_credentials(QString json);
    ~OAICyberSource_allOf_credentials() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICyberSource_allOf_credentials)

#endif // OAICyberSource_allOf_credentials_H
