...
/*
 * OAIBankAccountUpdatePlain.h
 *
 * 
 */

#ifndef OAIBankAccountUpdatePlain_H
#define OAIBankAccountUpdatePlain_H
...
class OAIBankAccountUpdatePlain : public OAIObject {
public:
    OAIBankAccountUpdatePlain();
    OAIBankAccountUpdatePlain(QString json);
    ~OAIBankAccountUpdatePlain() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBankAccountUpdatePlain)

#endif // OAIBankAccountUpdatePlain_H
