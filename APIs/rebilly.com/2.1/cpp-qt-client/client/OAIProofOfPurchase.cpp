...
OAIProofOfPurchase::OAIProofOfPurchase(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIProofOfPurchase::OAIProofOfPurchase() {
    this->initializeModel();
}

OAIProofOfPurchase::~OAIProofOfPurchase() {}

void OAIProofOfPurchase::initializeModel() {
...
void OAIProofOfPurchase::fromJson(QString jsonString) {
...
void OAIProofOfPurchase::fromJsonObject(QJsonObject json) {
...
QString OAIProofOfPurchase::asJson() const {
...
QJsonObject OAIProofOfPurchase::asJsonObject() const {
    QJsonObject obj;
    if (m__links.size() > 0) {
...
QList<OAICommonKycDocument__links_inner> OAIProofOfPurchase::getLinks() const {
    return m__links;
}
void OAIProofOfPurchase::setLinks(const QList<OAICommonKycDocument__links_inner> &_links) {
    m__links = _links;
    m__links_isSet = true;
}

bool OAIProofOfPurchase::is__links_Set() const{
    return m__links_isSet;
}

bool OAIProofOfPurchase::is__links_Valid() const{
    return m__links_isValid;
}

QDateTime OAIProofOfPurchase::getCreatedTime() const {
    return m_created_time;
}
void OAIProofOfPurchase::setCreatedTime(const QDateTime &created_time) {
    m_created_time = created_time;
    m_created_time_isSet = true;
}

bool OAIProofOfPurchase::is_created_time_Set() const{
    return m_created_time_isSet;
}

bool OAIProofOfPurchase::is_created_time_Valid() const{
    return m_created_time_isValid;
}

OAIKycDocumentSubtypes OAIProofOfPurchase::getDocumentSubtype() const {
    return m_document_subtype;
}
void OAIProofOfPurchase::setDocumentSubtype(const OAIKycDocumentSubtypes &document_subtype) {
    m_document_subtype = document_subtype;
    m_document_subtype_isSet = true;
}

bool OAIProofOfPurchase::is_document_subtype_Set() const{
    return m_document_subtype_isSet;
}

bool OAIProofOfPurchase::is_document_subtype_Valid() const{
    return m_document_subtype_isValid;
}

OAIKycDocumentTypes OAIProofOfPurchase::getDocumentType() const {
    return m_document_type;
}
void OAIProofOfPurchase::setDocumentType(const OAIKycDocumentTypes &document_type) {
    m_document_type = document_type;
    m_document_type_isSet = true;
}

bool OAIProofOfPurchase::is_document_type_Set() const{
    return m_document_type_isSet;
}

bool OAIProofOfPurchase::is_document_type_Valid() const{
    return m_document_type_isValid;
}

QString OAIProofOfPurchase::getFileId() const {
    return m_file_id;
}
void OAIProofOfPurchase::setFileId(const QString &file_id) {
    m_file_id = file_id;
    m_file_id_isSet = true;
}

bool OAIProofOfPurchase::is_file_id_Set() const{
    return m_file_id_isSet;
}

bool OAIProofOfPurchase::is_file_id_Valid() const{
    return m_file_id_isValid;
}

QList<QString> OAIProofOfPurchase::getFileIds() const {
    return m_file_ids;
}
void OAIProofOfPurchase::setFileIds(const QList<QString> &file_ids) {
    m_file_ids = file_ids;
    m_file_ids_isSet = true;
}

bool OAIProofOfPurchase::is_file_ids_Set() const{
    return m_file_ids_isSet;
}

bool OAIProofOfPurchase::is_file_ids_Valid() const{
    return m_file_ids_isValid;
}

QString OAIProofOfPurchase::getId() const {
    return m_id;
}
void OAIProofOfPurchase::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIProofOfPurchase::is_id_Set() const{
    return m_id_isSet;
}

bool OAIProofOfPurchase::is_id_Valid() const{
    return m_id_isValid;
}

QDateTime OAIProofOfPurchase::getProcessedTime() const {
    return m_processed_time;
}
void OAIProofOfPurchase::setProcessedTime(const QDateTime &processed_time) {
    m_processed_time = processed_time;
    m_processed_time_isSet = true;
}

bool OAIProofOfPurchase::is_processed_time_Set() const{
    return m_processed_time_isSet;
}

bool OAIProofOfPurchase::is_processed_time_Valid() const{
    return m_processed_time_isValid;
}

OAIKycDocumentRejection OAIProofOfPurchase::getRejectionReason() const {
    return m_rejection_reason;
}
void OAIProofOfPurchase::setRejectionReason(const OAIKycDocumentRejection &rejection_reason) {
    m_rejection_reason = rejection_reason;
    m_rejection_reason_isSet = true;
}

bool OAIProofOfPurchase::is_rejection_reason_Set() const{
    return m_rejection_reason_isSet;
}

bool OAIProofOfPurchase::is_rejection_reason_Valid() const{
    return m_rejection_reason_isValid;
}

QString OAIProofOfPurchase::getRequestId() const {
    return m_request_id;
}
void OAIProofOfPurchase::setRequestId(const QString &request_id) {
    m_request_id = request_id;
    m_request_id_isSet = true;
}

bool OAIProofOfPurchase::is_request_id_Set() const{
    return m_request_id_isSet;
}

bool OAIProofOfPurchase::is_request_id_Valid() const{
    return m_request_id_isValid;
}

QString OAIProofOfPurchase::getStatus() const {
    return m_status;
}
void OAIProofOfPurchase::setStatus(const QString &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIProofOfPurchase::is_status_Set() const{
    return m_status_isSet;
}

bool OAIProofOfPurchase::is_status_Valid() const{
    return m_status_isValid;
}

QDateTime OAIProofOfPurchase::getUpdatedTime() const {
    return m_updated_time;
}
void OAIProofOfPurchase::setUpdatedTime(const QDateTime &updated_time) {
    m_updated_time = updated_time;
    m_updated_time_isSet = true;
}

bool OAIProofOfPurchase::is_updated_time_Set() const{
    return m_updated_time_isSet;
}

bool OAIProofOfPurchase::is_updated_time_Valid() const{
    return m_updated_time_isValid;
}

QString OAIProofOfPurchase::getCustomerId() const {
    return m_customer_id;
}
void OAIProofOfPurchase::setCustomerId(const QString &customer_id) {
    m_customer_id = customer_id;
    m_customer_id_isSet = true;
}

bool OAIProofOfPurchase::is_customer_id_Set() const{
    return m_customer_id_isSet;
}

bool OAIProofOfPurchase::is_customer_id_Valid() const{
    return m_customer_id_isValid;
}

qint32 OAIProofOfPurchase::getMatchLevel() const {
    return m_match_level;
}
void OAIProofOfPurchase::setMatchLevel(const qint32 &match_level) {
    m_match_level = match_level;
    m_match_level_isSet = true;
}

bool OAIProofOfPurchase::is_match_level_Set() const{
    return m_match_level_isSet;
}

bool OAIProofOfPurchase::is_match_level_Valid() const{
    return m_match_level_isValid;
}

QString OAIProofOfPurchase::getNotes() const {
    return m_notes;
}
void OAIProofOfPurchase::setNotes(const QString &notes) {
    m_notes = notes;
    m_notes_isSet = true;
}

bool OAIProofOfPurchase::is_notes_Set() const{
    return m_notes_isSet;
}

bool OAIProofOfPurchase::is_notes_Valid() const{
    return m_notes_isValid;
}

QString OAIProofOfPurchase::getReason() const {
    return m_reason;
}
void OAIProofOfPurchase::setReason(const QString &reason) {
    m_reason = reason;
    m_reason_isSet = true;
}

bool OAIProofOfPurchase::is_reason_Set() const{
    return m_reason_isSet;
}

bool OAIProofOfPurchase::is_reason_Valid() const{
    return m_reason_isValid;
}

QDateTime OAIProofOfPurchase::getReviewTime() const {
    return m_review_time;
}
void OAIProofOfPurchase::setReviewTime(const QDateTime &review_time) {
    m_review_time = review_time;
    m_review_time_isSet = true;
}

bool OAIProofOfPurchase::is_review_time_Set() const{
    return m_review_time_isSet;
}

bool OAIProofOfPurchase::is_review_time_Valid() const{
    return m_review_time_isValid;
}

QString OAIProofOfPurchase::getReviewerId() const {
    return m_reviewer_id;
}
void OAIProofOfPurchase::setReviewerId(const QString &reviewer_id) {
    m_reviewer_id = reviewer_id;
    m_reviewer_id_isSet = true;
}

bool OAIProofOfPurchase::is_reviewer_id_Set() const{
    return m_reviewer_id_isSet;
}

bool OAIProofOfPurchase::is_reviewer_id_Valid() const{
    return m_reviewer_id_isValid;
}

QString OAIProofOfPurchase::getReviewerName() const {
    return m_reviewer_name;
}
void OAIProofOfPurchase::setReviewerName(const QString &reviewer_name) {
    m_reviewer_name = reviewer_name;
    m_reviewer_name_isSet = true;
}

bool OAIProofOfPurchase::is_reviewer_name_Set() const{
    return m_reviewer_name_isSet;
}

bool OAIProofOfPurchase::is_reviewer_name_Valid() const{
    return m_reviewer_name_isValid;
}

bool OAIProofOfPurchase::isSet() const {
...
bool OAIProofOfPurchase::isValid() const {
