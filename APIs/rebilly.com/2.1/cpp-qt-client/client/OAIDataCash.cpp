...
OAIDataCash::OAIDataCash(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDataCash::OAIDataCash() {
    this->initializeModel();
}

OAIDataCash::~OAIDataCash() {}

void OAIDataCash::initializeModel() {
...
void OAIDataCash::fromJson(QString jsonString) {
...
void OAIDataCash::fromJsonObject(QJsonObject json) {
...
QString OAIDataCash::asJson() const {
...
QJsonObject OAIDataCash::asJsonObject() const {
    QJsonObject obj;
    if (m__links.size() > 0) {
...
QList<OAIGatewayAccount__links_inner> OAIDataCash::getLinks() const {
    return m__links;
}
void OAIDataCash::setLinks(const QList<OAIGatewayAccount__links_inner> &_links) {
    m__links = _links;
    m__links_isSet = true;
}

bool OAIDataCash::is__links_Set() const{
    return m__links_isSet;
}

bool OAIDataCash::is__links_Valid() const{
    return m__links_isValid;
}

QList<QString> OAIDataCash::getAcceptedCurrencies() const {
    return m_accepted_currencies;
}
void OAIDataCash::setAcceptedCurrencies(const QList<QString> &accepted_currencies) {
    m_accepted_currencies = accepted_currencies;
    m_accepted_currencies_isSet = true;
}

bool OAIDataCash::is_accepted_currencies_Set() const{
    return m_accepted_currencies_isSet;
}

bool OAIDataCash::is_accepted_currencies_Valid() const{
    return m_accepted_currencies_isValid;
}

OAIAcquirerName OAIDataCash::getAcquirerName() const {
    return m_acquirer_name;
}
void OAIDataCash::setAcquirerName(const OAIAcquirerName &acquirer_name) {
    m_acquirer_name = acquirer_name;
    m_acquirer_name_isSet = true;
}

bool OAIDataCash::is_acquirer_name_Set() const{
    return m_acquirer_name_isSet;
}

bool OAIDataCash::is_acquirer_name_Valid() const{
    return m_acquirer_name_isValid;
}

QString OAIDataCash::getAdditionalFilters() const {
    return m_additional_filters;
}
void OAIDataCash::setAdditionalFilters(const QString &additional_filters) {
    m_additional_filters = additional_filters;
    m_additional_filters_isSet = true;
}

bool OAIDataCash::is_additional_filters_Set() const{
    return m_additional_filters_isSet;
}

bool OAIDataCash::is_additional_filters_Valid() const{
    return m_additional_filters_isValid;
}

qint32 OAIDataCash::getApprovalWindowTtl() const {
    return m_approval_window_ttl;
}
void OAIDataCash::setApprovalWindowTtl(const qint32 &approval_window_ttl) {
    m_approval_window_ttl = approval_window_ttl;
    m_approval_window_ttl_isSet = true;
}

bool OAIDataCash::is_approval_window_ttl_Set() const{
    return m_approval_window_ttl_isSet;
}

bool OAIDataCash::is_approval_window_ttl_Valid() const{
    return m_approval_window_ttl_isValid;
}

QString OAIDataCash::getCityField() const {
    return m_city_field;
}
void OAIDataCash::setCityField(const QString &city_field) {
    m_city_field = city_field;
    m_city_field_isSet = true;
}

bool OAIDataCash::is_city_field_Set() const{
    return m_city_field_isSet;
}

bool OAIDataCash::is_city_field_Valid() const{
    return m_city_field_isValid;
}

QDateTime OAIDataCash::getCreatedTime() const {
    return m_created_time;
}
void OAIDataCash::setCreatedTime(const QDateTime &created_time) {
    m_created_time = created_time;
    m_created_time_isSet = true;
}

bool OAIDataCash::is_created_time_Set() const{
    return m_created_time_isSet;
}

bool OAIDataCash::is_created_time_Valid() const{
    return m_created_time_isValid;
}

QString OAIDataCash::getDccForceCurrency() const {
    return m_dcc_force_currency;
}
void OAIDataCash::setDccForceCurrency(const QString &dcc_force_currency) {
    m_dcc_force_currency = dcc_force_currency;
    m_dcc_force_currency_isSet = true;
}

bool OAIDataCash::is_dcc_force_currency_Set() const{
    return m_dcc_force_currency_isSet;
}

bool OAIDataCash::is_dcc_force_currency_Valid() const{
    return m_dcc_force_currency_isValid;
}

qint32 OAIDataCash::getDccMarkup() const {
    return m_dcc_markup;
}
void OAIDataCash::setDccMarkup(const qint32 &dcc_markup) {
    m_dcc_markup = dcc_markup;
    m_dcc_markup_isSet = true;
}

bool OAIDataCash::is_dcc_markup_Set() const{
    return m_dcc_markup_isSet;
}

bool OAIDataCash::is_dcc_markup_Valid() const{
    return m_dcc_markup_isValid;
}

QString OAIDataCash::getDescriptor() const {
    return m_descriptor;
}
void OAIDataCash::setDescriptor(const QString &descriptor) {
    m_descriptor = descriptor;
    m_descriptor_isSet = true;
}

bool OAIDataCash::is_descriptor_Set() const{
    return m_descriptor_isSet;
}

bool OAIDataCash::is_descriptor_Valid() const{
    return m_descriptor_isValid;
}

OAIDigitalWallets OAIDataCash::getDigitalWallets() const {
    return m_digital_wallets;
}
void OAIDataCash::setDigitalWallets(const OAIDigitalWallets &digital_wallets) {
    m_digital_wallets = digital_wallets;
    m_digital_wallets_isSet = true;
}

bool OAIDataCash::is_digital_wallets_Set() const{
    return m_digital_wallets_isSet;
}

bool OAIDataCash::is_digital_wallets_Valid() const{
    return m_digital_wallets_isValid;
}

bool OAIDataCash::isDynamicDescriptor() const {
    return m_dynamic_descriptor;
}
void OAIDataCash::setDynamicDescriptor(const bool &dynamic_descriptor) {
    m_dynamic_descriptor = dynamic_descriptor;
    m_dynamic_descriptor_isSet = true;
}

bool OAIDataCash::is_dynamic_descriptor_Set() const{
    return m_dynamic_descriptor_isSet;
}

bool OAIDataCash::is_dynamic_descriptor_Valid() const{
    return m_dynamic_descriptor_isValid;
}

QList<QString> OAIDataCash::getExcludedDccQuoteCurrencies() const {
    return m_excluded_dcc_quote_currencies;
}
void OAIDataCash::setExcludedDccQuoteCurrencies(const QList<QString> &excluded_dcc_quote_currencies) {
    m_excluded_dcc_quote_currencies = excluded_dcc_quote_currencies;
    m_excluded_dcc_quote_currencies_isSet = true;
}

bool OAIDataCash::is_excluded_dcc_quote_currencies_Set() const{
    return m_excluded_dcc_quote_currencies_isSet;
}

bool OAIDataCash::is_excluded_dcc_quote_currencies_Valid() const{
    return m_excluded_dcc_quote_currencies_isValid;
}

OAIGatewayName OAIDataCash::getGatewayName() const {
    return m_gateway_name;
}
void OAIDataCash::setGatewayName(const OAIGatewayName &gateway_name) {
    m_gateway_name = gateway_name;
    m_gateway_name_isSet = true;
}

bool OAIDataCash::is_gateway_name_Set() const{
    return m_gateway_name_isSet;
}

bool OAIDataCash::is_gateway_name_Valid() const{
    return m_gateway_name_isValid;
}

QString OAIDataCash::getId() const {
    return m_id;
}
void OAIDataCash::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIDataCash::is_id_Set() const{
    return m_id_isSet;
}

bool OAIDataCash::is_id_Valid() const{
    return m_id_isValid;
}

bool OAIDataCash::isIsDown() const {
    return m_is_down;
}
void OAIDataCash::setIsDown(const bool &is_down) {
    m_is_down = is_down;
    m_is_down_isSet = true;
}

bool OAIDataCash::is_is_down_Set() const{
    return m_is_down_isSet;
}

bool OAIDataCash::is_is_down_Valid() const{
    return m_is_down_isValid;
}

QString OAIDataCash::getMerchantCategoryCode() const {
    return m_merchant_category_code;
}
void OAIDataCash::setMerchantCategoryCode(const QString &merchant_category_code) {
    m_merchant_category_code = merchant_category_code;
    m_merchant_category_code_isSet = true;
}

bool OAIDataCash::is_merchant_category_code_Set() const{
    return m_merchant_category_code_isSet;
}

bool OAIDataCash::is_merchant_category_code_Valid() const{
    return m_merchant_category_code_isValid;
}

OAIPaymentMethod OAIDataCash::getMethod() const {
    return m_method;
}
void OAIDataCash::setMethod(const OAIPaymentMethod &method) {
    m_method = method;
    m_method_isSet = true;
}

bool OAIDataCash::is_method_Set() const{
    return m_method_isSet;
}

bool OAIDataCash::is_method_Valid() const{
    return m_method_isValid;
}

double OAIDataCash::getMonthlyLimit() const {
    return m_monthly_limit;
}
void OAIDataCash::setMonthlyLimit(const double &monthly_limit) {
    m_monthly_limit = monthly_limit;
    m_monthly_limit_isSet = true;
}

bool OAIDataCash::is_monthly_limit_Set() const{
    return m_monthly_limit_isSet;
}

bool OAIDataCash::is_monthly_limit_Valid() const{
    return m_monthly_limit_isValid;
}

QString OAIDataCash::getOrganizationId() const {
    return m_organization_id;
}
void OAIDataCash::setOrganizationId(const QString &organization_id) {
    m_organization_id = organization_id;
    m_organization_id_isSet = true;
}

bool OAIDataCash::is_organization_id_Set() const{
    return m_organization_id_isSet;
}

bool OAIDataCash::is_organization_id_Valid() const{
    return m_organization_id_isValid;
}

QList<OAIPaymentCardBrand> OAIDataCash::getPaymentCardSchemes() const {
    return m_payment_card_schemes;
}
void OAIDataCash::setPaymentCardSchemes(const QList<OAIPaymentCardBrand> &payment_card_schemes) {
    m_payment_card_schemes = payment_card_schemes;
    m_payment_card_schemes_isSet = true;
}

bool OAIDataCash::is_payment_card_schemes_Set() const{
    return m_payment_card_schemes_isSet;
}

bool OAIDataCash::is_payment_card_schemes_Valid() const{
    return m_payment_card_schemes_isValid;
}

bool OAIDataCash::isReconciliationWindowEnabled() const {
    return m_reconciliation_window_enabled;
}
void OAIDataCash::setReconciliationWindowEnabled(const bool &reconciliation_window_enabled) {
    m_reconciliation_window_enabled = reconciliation_window_enabled;
    m_reconciliation_window_enabled_isSet = true;
}

bool OAIDataCash::is_reconciliation_window_enabled_Set() const{
    return m_reconciliation_window_enabled_isSet;
}

bool OAIDataCash::is_reconciliation_window_enabled_Valid() const{
    return m_reconciliation_window_enabled_isValid;
}

qint32 OAIDataCash::getReconciliationWindowTtl() const {
    return m_reconciliation_window_ttl;
}
void OAIDataCash::setReconciliationWindowTtl(const qint32 &reconciliation_window_ttl) {
    m_reconciliation_window_ttl = reconciliation_window_ttl;
    m_reconciliation_window_ttl_isSet = true;
}

bool OAIDataCash::is_reconciliation_window_ttl_Set() const{
    return m_reconciliation_window_ttl_isSet;
}

bool OAIDataCash::is_reconciliation_window_ttl_Valid() const{
    return m_reconciliation_window_ttl_isValid;
}

QString OAIDataCash::getStatus() const {
    return m_status;
}
void OAIDataCash::setStatus(const QString &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIDataCash::is_status_Set() const{
    return m_status_isSet;
}

bool OAIDataCash::is_status_Valid() const{
    return m_status_isValid;
}

bool OAIDataCash::isSticky() const {
    return m_sticky;
}
void OAIDataCash::setSticky(const bool &sticky) {
    m_sticky = sticky;
    m_sticky_isSet = true;
}

bool OAIDataCash::is_sticky_Set() const{
    return m_sticky_isSet;
}

bool OAIDataCash::is_sticky_Valid() const{
    return m_sticky_isValid;
}

bool OAIDataCash::isThreeDSecure() const {
    return m_three_d_secure;
}
void OAIDataCash::setThreeDSecure(const bool &three_d_secure) {
    m_three_d_secure = three_d_secure;
    m_three_d_secure_isSet = true;
}

bool OAIDataCash::is_three_d_secure_Set() const{
    return m_three_d_secure_isSet;
}

bool OAIDataCash::is_three_d_secure_Valid() const{
    return m_three_d_secure_isValid;
}

qint32 OAIDataCash::getTimeout() const {
    return m_timeout;
}
void OAIDataCash::setTimeout(const qint32 &timeout) {
    m_timeout = timeout;
    m_timeout_isSet = true;
}

bool OAIDataCash::is_timeout_Set() const{
    return m_timeout_isSet;
}

bool OAIDataCash::is_timeout_Valid() const{
    return m_timeout_isValid;
}

QString OAIDataCash::getToken() const {
    return m_token;
}
void OAIDataCash::setToken(const QString &token) {
    m_token = token;
    m_token_isSet = true;
}

bool OAIDataCash::is_token_Set() const{
    return m_token_isSet;
}

bool OAIDataCash::is_token_Valid() const{
    return m_token_isValid;
}

QDateTime OAIDataCash::getUpdatedTime() const {
    return m_updated_time;
}
void OAIDataCash::setUpdatedTime(const QDateTime &updated_time) {
    m_updated_time = updated_time;
    m_updated_time_isSet = true;
}

bool OAIDataCash::is_updated_time_Set() const{
    return m_updated_time_isSet;
}

bool OAIDataCash::is_updated_time_Valid() const{
    return m_updated_time_isValid;
}

OAIDataCash_allOf_credentials OAIDataCash::getCredentials() const {
    return m_credentials;
}
void OAIDataCash::setCredentials(const OAIDataCash_allOf_credentials &credentials) {
    m_credentials = credentials;
    m_credentials_isSet = true;
}

bool OAIDataCash::is_credentials_Set() const{
    return m_credentials_isSet;
}

bool OAIDataCash::is_credentials_Valid() const{
    return m_credentials_isValid;
}

OAIDataCash_allOf_settings OAIDataCash::getSettings() const {
    return m_settings;
}
void OAIDataCash::setSettings(const OAIDataCash_allOf_settings &settings) {
    m_settings = settings;
    m_settings_isSet = true;
}

bool OAIDataCash::is_settings_Set() const{
    return m_settings_isSet;
}

bool OAIDataCash::is_settings_Valid() const{
    return m_settings_isValid;
}

OAIDataCash3dsServers OAIDataCash::getThreeDSecureServer() const {
    return m_three_d_secure_server;
}
void OAIDataCash::setThreeDSecureServer(const OAIDataCash3dsServers &three_d_secure_server) {
    m_three_d_secure_server = three_d_secure_server;
    m_three_d_secure_server_isSet = true;
}

bool OAIDataCash::is_three_d_secure_server_Set() const{
    return m_three_d_secure_server_isSet;
}

bool OAIDataCash::is_three_d_secure_server_Valid() const{
    return m_three_d_secure_server_isValid;
}

bool OAIDataCash::isSet() const {
...
bool OAIDataCash::isValid() const {
