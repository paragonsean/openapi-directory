...
#ifndef OAIPayvision_H
#define OAIPayvision_H
...
#include "OAIPayvision_allOf_settings.h"
#include <QDateTime>
#include <QList>
#include <QString>
...
class OAIPayvision_allOf_credentials;
class OAIPayvision_allOf_settings;
class OAIPayvision3dsServers;

class OAIPayvision : public OAIObject {
public:
    OAIPayvision();
    OAIPayvision(QString json);
    ~OAIPayvision() override;
    ...
    OAIPayvision_allOf_credentials getCredentials() const;
    void setCredentials(const OAIPayvision_allOf_credentials &credentials);
    bool is_credentials_Set() const;
    bool is_credentials_Valid() const;

    OAIPayvision_allOf_settings getSettings() const;
    void setSettings(const OAIPayvision_allOf_settings &settings);
    bool is_settings_Set() const;
    bool is_settings_Valid() const;

    OAIPayvision3dsServers getThreeDSecureServer() const;
    void setThreeDSecureServer(const OAIPayvision3dsServers &three_d_secure_server);
...
private:
    ...
    OAIPayvision_allOf_credentials m_credentials;
    bool m_credentials_isSet;
    bool m_credentials_isValid;

    OAIPayvision_allOf_settings m_settings;
    bool m_settings_isSet;
    bool m_settings_isValid;

    OAIPayvision3dsServers m_three_d_secure_server;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPayvision)

#endif // OAIPayvision_H
