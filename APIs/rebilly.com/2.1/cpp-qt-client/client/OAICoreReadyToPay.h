...
#ifndef OAICoreReadyToPay_H
#define OAICoreReadyToPay_H
...
class OAICoreReadyToPay : public OAIObject {
public:
    OAICoreReadyToPay();
    OAICoreReadyToPay(QString json);
    ~OAICoreReadyToPay() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICoreReadyToPay)

#endif // OAICoreReadyToPay_H
