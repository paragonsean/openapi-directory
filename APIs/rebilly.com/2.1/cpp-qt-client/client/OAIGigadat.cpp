...
OAIGigadat::OAIGigadat(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGigadat::OAIGigadat() {
    this->initializeModel();
}

OAIGigadat::~OAIGigadat() {}

void OAIGigadat::initializeModel() {
...
void OAIGigadat::fromJson(QString jsonString) {
...
void OAIGigadat::fromJsonObject(QJsonObject json) {
...
QString OAIGigadat::asJson() const {
...
QJsonObject OAIGigadat::asJsonObject() const {
    QJsonObject obj;
    if (m__links.size() > 0) {
...
QList<OAIGatewayAccount__links_inner> OAIGigadat::getLinks() const {
    return m__links;
}
void OAIGigadat::setLinks(const QList<OAIGatewayAccount__links_inner> &_links) {
    m__links = _links;
    m__links_isSet = true;
}

bool OAIGigadat::is__links_Set() const{
    return m__links_isSet;
}

bool OAIGigadat::is__links_Valid() const{
    return m__links_isValid;
}

QList<QString> OAIGigadat::getAcceptedCurrencies() const {
    return m_accepted_currencies;
}
void OAIGigadat::setAcceptedCurrencies(const QList<QString> &accepted_currencies) {
    m_accepted_currencies = accepted_currencies;
    m_accepted_currencies_isSet = true;
}

bool OAIGigadat::is_accepted_currencies_Set() const{
    return m_accepted_currencies_isSet;
}

bool OAIGigadat::is_accepted_currencies_Valid() const{
    return m_accepted_currencies_isValid;
}

OAIAcquirerName OAIGigadat::getAcquirerName() const {
    return m_acquirer_name;
}
void OAIGigadat::setAcquirerName(const OAIAcquirerName &acquirer_name) {
    m_acquirer_name = acquirer_name;
    m_acquirer_name_isSet = true;
}

bool OAIGigadat::is_acquirer_name_Set() const{
    return m_acquirer_name_isSet;
}

bool OAIGigadat::is_acquirer_name_Valid() const{
    return m_acquirer_name_isValid;
}

QString OAIGigadat::getAdditionalFilters() const {
    return m_additional_filters;
}
void OAIGigadat::setAdditionalFilters(const QString &additional_filters) {
    m_additional_filters = additional_filters;
    m_additional_filters_isSet = true;
}

bool OAIGigadat::is_additional_filters_Set() const{
    return m_additional_filters_isSet;
}

bool OAIGigadat::is_additional_filters_Valid() const{
    return m_additional_filters_isValid;
}

qint32 OAIGigadat::getApprovalWindowTtl() const {
    return m_approval_window_ttl;
}
void OAIGigadat::setApprovalWindowTtl(const qint32 &approval_window_ttl) {
    m_approval_window_ttl = approval_window_ttl;
    m_approval_window_ttl_isSet = true;
}

bool OAIGigadat::is_approval_window_ttl_Set() const{
    return m_approval_window_ttl_isSet;
}

bool OAIGigadat::is_approval_window_ttl_Valid() const{
    return m_approval_window_ttl_isValid;
}

QString OAIGigadat::getCityField() const {
    return m_city_field;
}
void OAIGigadat::setCityField(const QString &city_field) {
    m_city_field = city_field;
    m_city_field_isSet = true;
}

bool OAIGigadat::is_city_field_Set() const{
    return m_city_field_isSet;
}

bool OAIGigadat::is_city_field_Valid() const{
    return m_city_field_isValid;
}

QDateTime OAIGigadat::getCreatedTime() const {
    return m_created_time;
}
void OAIGigadat::setCreatedTime(const QDateTime &created_time) {
    m_created_time = created_time;
    m_created_time_isSet = true;
}

bool OAIGigadat::is_created_time_Set() const{
    return m_created_time_isSet;
}

bool OAIGigadat::is_created_time_Valid() const{
    return m_created_time_isValid;
}

QString OAIGigadat::getDccForceCurrency() const {
    return m_dcc_force_currency;
}
void OAIGigadat::setDccForceCurrency(const QString &dcc_force_currency) {
    m_dcc_force_currency = dcc_force_currency;
    m_dcc_force_currency_isSet = true;
}

bool OAIGigadat::is_dcc_force_currency_Set() const{
    return m_dcc_force_currency_isSet;
}

bool OAIGigadat::is_dcc_force_currency_Valid() const{
    return m_dcc_force_currency_isValid;
}

qint32 OAIGigadat::getDccMarkup() const {
    return m_dcc_markup;
}
void OAIGigadat::setDccMarkup(const qint32 &dcc_markup) {
    m_dcc_markup = dcc_markup;
    m_dcc_markup_isSet = true;
}

bool OAIGigadat::is_dcc_markup_Set() const{
    return m_dcc_markup_isSet;
}

bool OAIGigadat::is_dcc_markup_Valid() const{
    return m_dcc_markup_isValid;
}

QString OAIGigadat::getDescriptor() const {
    return m_descriptor;
}
void OAIGigadat::setDescriptor(const QString &descriptor) {
    m_descriptor = descriptor;
    m_descriptor_isSet = true;
}

bool OAIGigadat::is_descriptor_Set() const{
    return m_descriptor_isSet;
}

bool OAIGigadat::is_descriptor_Valid() const{
    return m_descriptor_isValid;
}

OAIDigitalWallets OAIGigadat::getDigitalWallets() const {
    return m_digital_wallets;
}
void OAIGigadat::setDigitalWallets(const OAIDigitalWallets &digital_wallets) {
    m_digital_wallets = digital_wallets;
    m_digital_wallets_isSet = true;
}

bool OAIGigadat::is_digital_wallets_Set() const{
    return m_digital_wallets_isSet;
}

bool OAIGigadat::is_digital_wallets_Valid() const{
    return m_digital_wallets_isValid;
}

bool OAIGigadat::isDynamicDescriptor() const {
    return m_dynamic_descriptor;
}
void OAIGigadat::setDynamicDescriptor(const bool &dynamic_descriptor) {
    m_dynamic_descriptor = dynamic_descriptor;
    m_dynamic_descriptor_isSet = true;
}

bool OAIGigadat::is_dynamic_descriptor_Set() const{
    return m_dynamic_descriptor_isSet;
}

bool OAIGigadat::is_dynamic_descriptor_Valid() const{
    return m_dynamic_descriptor_isValid;
}

QList<QString> OAIGigadat::getExcludedDccQuoteCurrencies() const {
    return m_excluded_dcc_quote_currencies;
}
void OAIGigadat::setExcludedDccQuoteCurrencies(const QList<QString> &excluded_dcc_quote_currencies) {
    m_excluded_dcc_quote_currencies = excluded_dcc_quote_currencies;
    m_excluded_dcc_quote_currencies_isSet = true;
}

bool OAIGigadat::is_excluded_dcc_quote_currencies_Set() const{
    return m_excluded_dcc_quote_currencies_isSet;
}

bool OAIGigadat::is_excluded_dcc_quote_currencies_Valid() const{
    return m_excluded_dcc_quote_currencies_isValid;
}

OAIGatewayName OAIGigadat::getGatewayName() const {
    return m_gateway_name;
}
void OAIGigadat::setGatewayName(const OAIGatewayName &gateway_name) {
    m_gateway_name = gateway_name;
    m_gateway_name_isSet = true;
}

bool OAIGigadat::is_gateway_name_Set() const{
    return m_gateway_name_isSet;
}

bool OAIGigadat::is_gateway_name_Valid() const{
    return m_gateway_name_isValid;
}

QString OAIGigadat::getId() const {
    return m_id;
}
void OAIGigadat::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIGigadat::is_id_Set() const{
    return m_id_isSet;
}

bool OAIGigadat::is_id_Valid() const{
    return m_id_isValid;
}

bool OAIGigadat::isIsDown() const {
    return m_is_down;
}
void OAIGigadat::setIsDown(const bool &is_down) {
    m_is_down = is_down;
    m_is_down_isSet = true;
}

bool OAIGigadat::is_is_down_Set() const{
    return m_is_down_isSet;
}

bool OAIGigadat::is_is_down_Valid() const{
    return m_is_down_isValid;
}

QString OAIGigadat::getMerchantCategoryCode() const {
    return m_merchant_category_code;
}
void OAIGigadat::setMerchantCategoryCode(const QString &merchant_category_code) {
    m_merchant_category_code = merchant_category_code;
    m_merchant_category_code_isSet = true;
}

bool OAIGigadat::is_merchant_category_code_Set() const{
    return m_merchant_category_code_isSet;
}

bool OAIGigadat::is_merchant_category_code_Valid() const{
    return m_merchant_category_code_isValid;
}

OAIPaymentMethod OAIGigadat::getMethod() const {
    return m_method;
}
void OAIGigadat::setMethod(const OAIPaymentMethod &method) {
    m_method = method;
    m_method_isSet = true;
}

bool OAIGigadat::is_method_Set() const{
    return m_method_isSet;
}

bool OAIGigadat::is_method_Valid() const{
    return m_method_isValid;
}

double OAIGigadat::getMonthlyLimit() const {
    return m_monthly_limit;
}
void OAIGigadat::setMonthlyLimit(const double &monthly_limit) {
    m_monthly_limit = monthly_limit;
    m_monthly_limit_isSet = true;
}

bool OAIGigadat::is_monthly_limit_Set() const{
    return m_monthly_limit_isSet;
}

bool OAIGigadat::is_monthly_limit_Valid() const{
    return m_monthly_limit_isValid;
}

QString OAIGigadat::getOrganizationId() const {
    return m_organization_id;
}
void OAIGigadat::setOrganizationId(const QString &organization_id) {
    m_organization_id = organization_id;
    m_organization_id_isSet = true;
}

bool OAIGigadat::is_organization_id_Set() const{
    return m_organization_id_isSet;
}

bool OAIGigadat::is_organization_id_Valid() const{
    return m_organization_id_isValid;
}

QList<OAIPaymentCardBrand> OAIGigadat::getPaymentCardSchemes() const {
    return m_payment_card_schemes;
}
void OAIGigadat::setPaymentCardSchemes(const QList<OAIPaymentCardBrand> &payment_card_schemes) {
    m_payment_card_schemes = payment_card_schemes;
    m_payment_card_schemes_isSet = true;
}

bool OAIGigadat::is_payment_card_schemes_Set() const{
    return m_payment_card_schemes_isSet;
}

bool OAIGigadat::is_payment_card_schemes_Valid() const{
    return m_payment_card_schemes_isValid;
}

bool OAIGigadat::isReconciliationWindowEnabled() const {
    return m_reconciliation_window_enabled;
}
void OAIGigadat::setReconciliationWindowEnabled(const bool &reconciliation_window_enabled) {
    m_reconciliation_window_enabled = reconciliation_window_enabled;
    m_reconciliation_window_enabled_isSet = true;
}

bool OAIGigadat::is_reconciliation_window_enabled_Set() const{
    return m_reconciliation_window_enabled_isSet;
}

bool OAIGigadat::is_reconciliation_window_enabled_Valid() const{
    return m_reconciliation_window_enabled_isValid;
}

qint32 OAIGigadat::getReconciliationWindowTtl() const {
    return m_reconciliation_window_ttl;
}
void OAIGigadat::setReconciliationWindowTtl(const qint32 &reconciliation_window_ttl) {
    m_reconciliation_window_ttl = reconciliation_window_ttl;
    m_reconciliation_window_ttl_isSet = true;
}

bool OAIGigadat::is_reconciliation_window_ttl_Set() const{
    return m_reconciliation_window_ttl_isSet;
}

bool OAIGigadat::is_reconciliation_window_ttl_Valid() const{
    return m_reconciliation_window_ttl_isValid;
}

QString OAIGigadat::getStatus() const {
    return m_status;
}
void OAIGigadat::setStatus(const QString &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIGigadat::is_status_Set() const{
    return m_status_isSet;
}

bool OAIGigadat::is_status_Valid() const{
    return m_status_isValid;
}

bool OAIGigadat::isSticky() const {
    return m_sticky;
}
void OAIGigadat::setSticky(const bool &sticky) {
    m_sticky = sticky;
    m_sticky_isSet = true;
}

bool OAIGigadat::is_sticky_Set() const{
    return m_sticky_isSet;
}

bool OAIGigadat::is_sticky_Valid() const{
    return m_sticky_isValid;
}

bool OAIGigadat::isThreeDSecure() const {
    return m_three_d_secure;
}
void OAIGigadat::setThreeDSecure(const bool &three_d_secure) {
    m_three_d_secure = three_d_secure;
    m_three_d_secure_isSet = true;
}

bool OAIGigadat::is_three_d_secure_Set() const{
    return m_three_d_secure_isSet;
}

bool OAIGigadat::is_three_d_secure_Valid() const{
    return m_three_d_secure_isValid;
}

qint32 OAIGigadat::getTimeout() const {
    return m_timeout;
}
void OAIGigadat::setTimeout(const qint32 &timeout) {
    m_timeout = timeout;
    m_timeout_isSet = true;
}

bool OAIGigadat::is_timeout_Set() const{
    return m_timeout_isSet;
}

bool OAIGigadat::is_timeout_Valid() const{
    return m_timeout_isValid;
}

QString OAIGigadat::getToken() const {
    return m_token;
}
void OAIGigadat::setToken(const QString &token) {
    m_token = token;
    m_token_isSet = true;
}

bool OAIGigadat::is_token_Set() const{
    return m_token_isSet;
}

bool OAIGigadat::is_token_Valid() const{
    return m_token_isValid;
}

QDateTime OAIGigadat::getUpdatedTime() const {
    return m_updated_time;
}
void OAIGigadat::setUpdatedTime(const QDateTime &updated_time) {
    m_updated_time = updated_time;
    m_updated_time_isSet = true;
}

bool OAIGigadat::is_updated_time_Set() const{
    return m_updated_time_isSet;
}

bool OAIGigadat::is_updated_time_Valid() const{
    return m_updated_time_isValid;
}

OAIGigadat_allOf_credentials OAIGigadat::getCredentials() const {
    return m_credentials;
}
void OAIGigadat::setCredentials(const OAIGigadat_allOf_credentials &credentials) {
    m_credentials = credentials;
    m_credentials_isSet = true;
}

bool OAIGigadat::is_credentials_Set() const{
    return m_credentials_isSet;
}

bool OAIGigadat::is_credentials_Valid() const{
    return m_credentials_isValid;
}

OAIGigadat_allOf_settings OAIGigadat::getSettings() const {
    return m_settings;
}
void OAIGigadat::setSettings(const OAIGigadat_allOf_settings &settings) {
    m_settings = settings;
    m_settings_isSet = true;
}

bool OAIGigadat::is_settings_Set() const{
    return m_settings_isSet;
}

bool OAIGigadat::is_settings_Valid() const{
    return m_settings_isValid;
}

bool OAIGigadat::isSet() const {
