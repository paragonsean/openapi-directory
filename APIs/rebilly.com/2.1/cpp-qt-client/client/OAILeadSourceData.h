...
#ifndef OAILeadSourceData_H
#define OAILeadSourceData_H
...
namespace OpenAPI {
class OAIBankAccount_allOf__links;

class OAILeadSourceData : public OAIObject {
public:
    OAILeadSourceData();
    OAILeadSourceData(QString json);
    ~OAILeadSourceData() override;
    ...
    QList<OAIBankAccount_allOf__links> getLinks() const;
    void setLinks(const QList<OAIBankAccount_allOf__links> &_links);
    bool is__links_Set() const;
    bool is__links_Valid() const;

    QString getAffiliate() const;
    void setAffiliate(const QString &affiliate);
    ...
    QString getSalesAgent() const;
    void setSalesAgent(const QString &sales_agent);
    bool is_sales_agent_Set() const;
    bool is_sales_agent_Valid() const;
    ...
    QString getSubAffiliate() const;
    void setSubAffiliate(const QString &sub_affiliate);
    bool is_sub_affiliate_Set() const;
    bool is_sub_affiliate_Valid() const;
...
private:
    ...
    QList<OAIBankAccount_allOf__links> m__links;
    bool m__links_isSet;
    ...
    QString m_sales_agent;
    bool m_sales_agent_isSet;
    bool m_sales_agent_isValid;

    QString m_source;
    bool m_source_isSet;
    bool m_source_isValid;

    QString m_sub_affiliate;
    bool m_sub_affiliate_isSet;
    bool m_sub_affiliate_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAILeadSourceData)

#endif // OAILeadSourceData_H
