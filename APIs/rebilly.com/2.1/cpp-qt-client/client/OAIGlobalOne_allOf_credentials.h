...
/*
 * OAIGlobalOne_allOf_credentials.h
 *
 * 
 */

#ifndef OAIGlobalOne_allOf_credentials_H
#define OAIGlobalOne_allOf_credentials_H
...
class OAIGlobalOne_allOf_credentials : public OAIObject {
public:
    OAIGlobalOne_allOf_credentials();
    OAIGlobalOne_allOf_credentials(QString json);
    ~OAIGlobalOne_allOf_credentials() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGlobalOne_allOf_credentials)

#endif // OAIGlobalOne_allOf_credentials_H
