...
/*
 * OAIPaymentInstrument_2.h
 *
 * 
 */

#ifndef OAIPaymentInstrument_2_H
#define OAIPaymentInstrument_2_H

#include <QJsonObject>

#include "OAIAlternativePaymentInstrument_2.h"
#include "OAIAlternativePaymentInstrument_2__embedded_inner.h"
#include "OAIAlternativePaymentInstrument_2__links_inner.h"
#include "OAIAlternativePaymentMethods.h"
#include "OAIBankAccount.h"
#include "OAIContactObject.h"
#include "OAIKhelocardCard.h"
#include "OAIObject.h"
...
class OAIAlternativePaymentInstrument_2__embedded_inner;
class OAIAlternativePaymentInstrument_2__links_inner;

class OAIPaymentInstrument_2 : public OAIObject {
public:
    OAIPaymentInstrument_2();
    OAIPaymentInstrument_2(QString json);
    ~OAIPaymentInstrument_2() override;
    ...
    OAIAlternativePaymentMethods getMethod() const;
    void setMethod(const OAIAlternativePaymentMethods &method);
    ...
    QList<OAIAlternativePaymentInstrument_2__embedded_inner> getEmbedded() const;
    void setEmbedded(const QList<OAIAlternativePaymentInstrument_2__embedded_inner> &_embedded);
    bool is__embedded_Set() const;
    bool is__embedded_Valid() const;

    QList<OAIAlternativePaymentInstrument_2__links_inner> getLinks() const;
    void setLinks(const QList<OAIAlternativePaymentInstrument_2__links_inner> &_links);
    ...
    QString getAccountNumberType() const;
    void setAccountNumberType(const QString &account_number_type);
    bool is_account_number_type_Set() const;
    bool is_account_number_type_Valid() const;
...
private:
    ...
    OAIAlternativePaymentMethods m_method;
    bool m_method_isSet;
    ...
    QList<OAIAlternativePaymentInstrument_2__embedded_inner> m__embedded;
    bool m__embedded_isSet;
    bool m__embedded_isValid;

    QList<OAIAlternativePaymentInstrument_2__links_inner> m__links;
    bool m__links_isSet;
    ...
    QString m_account_number_type;
    bool m_account_number_type_isSet;
    bool m_account_number_type_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPaymentInstrument_2)

#endif // OAIPaymentInstrument_2_H
