...
#ifndef OAIWorldpay_H
#define OAIWorldpay_H
...
#include "OAIWorldpay_allOf_settings.h"
#include <QDateTime>
#include <QList>
#include <QString>
...
class OAIWorldpay_allOf_credentials;
class OAIWorldpay_allOf_settings;
class OAIWorldpay3dsServers;

class OAIWorldpay : public OAIObject {
public:
    OAIWorldpay();
    OAIWorldpay(QString json);
    ~OAIWorldpay() override;
    ...
    OAIWorldpay_allOf_credentials getCredentials() const;
    void setCredentials(const OAIWorldpay_allOf_credentials &credentials);
    bool is_credentials_Set() const;
    bool is_credentials_Valid() const;

    OAIWorldpay_allOf_settings getSettings() const;
    void setSettings(const OAIWorldpay_allOf_settings &settings);
    bool is_settings_Set() const;
    bool is_settings_Valid() const;

    OAIWorldpay3dsServers getThreeDSecureServer() const;
    void setThreeDSecureServer(const OAIWorldpay3dsServers &three_d_secure_server);
...
private:
    ...
    OAIWorldpay_allOf_credentials m_credentials;
    bool m_credentials_isSet;
    bool m_credentials_isValid;

    OAIWorldpay_allOf_settings m_settings;
    bool m_settings_isSet;
    bool m_settings_isValid;

    OAIWorldpay3dsServers m_three_d_secure_server;
...
Q_DECLARE_METATYPE(OpenAPI::OAIWorldpay)
