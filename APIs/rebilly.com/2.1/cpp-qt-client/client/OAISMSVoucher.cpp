...
OAISMSVoucher::OAISMSVoucher(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISMSVoucher::OAISMSVoucher() {
    this->initializeModel();
}

OAISMSVoucher::~OAISMSVoucher() {}

void OAISMSVoucher::initializeModel() {
...
void OAISMSVoucher::fromJson(QString jsonString) {
...
void OAISMSVoucher::fromJsonObject(QJsonObject json) {
...
QString OAISMSVoucher::asJson() const {
...
QJsonObject OAISMSVoucher::asJsonObject() const {
    QJsonObject obj;
    if (m__links.size() > 0) {
...
QList<OAIGatewayAccount__links_inner> OAISMSVoucher::getLinks() const {
    return m__links;
}
void OAISMSVoucher::setLinks(const QList<OAIGatewayAccount__links_inner> &_links) {
    m__links = _links;
    m__links_isSet = true;
}

bool OAISMSVoucher::is__links_Set() const{
    return m__links_isSet;
}

bool OAISMSVoucher::is__links_Valid() const{
    return m__links_isValid;
}

QList<QString> OAISMSVoucher::getAcceptedCurrencies() const {
    return m_accepted_currencies;
}
void OAISMSVoucher::setAcceptedCurrencies(const QList<QString> &accepted_currencies) {
    m_accepted_currencies = accepted_currencies;
    m_accepted_currencies_isSet = true;
}

bool OAISMSVoucher::is_accepted_currencies_Set() const{
    return m_accepted_currencies_isSet;
}

bool OAISMSVoucher::is_accepted_currencies_Valid() const{
    return m_accepted_currencies_isValid;
}

OAIAcquirerName OAISMSVoucher::getAcquirerName() const {
    return m_acquirer_name;
}
void OAISMSVoucher::setAcquirerName(const OAIAcquirerName &acquirer_name) {
    m_acquirer_name = acquirer_name;
    m_acquirer_name_isSet = true;
}

bool OAISMSVoucher::is_acquirer_name_Set() const{
    return m_acquirer_name_isSet;
}

bool OAISMSVoucher::is_acquirer_name_Valid() const{
    return m_acquirer_name_isValid;
}

QString OAISMSVoucher::getAdditionalFilters() const {
    return m_additional_filters;
}
void OAISMSVoucher::setAdditionalFilters(const QString &additional_filters) {
    m_additional_filters = additional_filters;
    m_additional_filters_isSet = true;
}

bool OAISMSVoucher::is_additional_filters_Set() const{
    return m_additional_filters_isSet;
}

bool OAISMSVoucher::is_additional_filters_Valid() const{
    return m_additional_filters_isValid;
}

qint32 OAISMSVoucher::getApprovalWindowTtl() const {
    return m_approval_window_ttl;
}
void OAISMSVoucher::setApprovalWindowTtl(const qint32 &approval_window_ttl) {
    m_approval_window_ttl = approval_window_ttl;
    m_approval_window_ttl_isSet = true;
}

bool OAISMSVoucher::is_approval_window_ttl_Set() const{
    return m_approval_window_ttl_isSet;
}

bool OAISMSVoucher::is_approval_window_ttl_Valid() const{
    return m_approval_window_ttl_isValid;
}

QString OAISMSVoucher::getCityField() const {
    return m_city_field;
}
void OAISMSVoucher::setCityField(const QString &city_field) {
    m_city_field = city_field;
    m_city_field_isSet = true;
}

bool OAISMSVoucher::is_city_field_Set() const{
    return m_city_field_isSet;
}

bool OAISMSVoucher::is_city_field_Valid() const{
    return m_city_field_isValid;
}

QDateTime OAISMSVoucher::getCreatedTime() const {
    return m_created_time;
}
void OAISMSVoucher::setCreatedTime(const QDateTime &created_time) {
    m_created_time = created_time;
    m_created_time_isSet = true;
}

bool OAISMSVoucher::is_created_time_Set() const{
    return m_created_time_isSet;
}

bool OAISMSVoucher::is_created_time_Valid() const{
    return m_created_time_isValid;
}

QString OAISMSVoucher::getDccForceCurrency() const {
    return m_dcc_force_currency;
}
void OAISMSVoucher::setDccForceCurrency(const QString &dcc_force_currency) {
    m_dcc_force_currency = dcc_force_currency;
    m_dcc_force_currency_isSet = true;
}

bool OAISMSVoucher::is_dcc_force_currency_Set() const{
    return m_dcc_force_currency_isSet;
}

bool OAISMSVoucher::is_dcc_force_currency_Valid() const{
    return m_dcc_force_currency_isValid;
}

qint32 OAISMSVoucher::getDccMarkup() const {
    return m_dcc_markup;
}
void OAISMSVoucher::setDccMarkup(const qint32 &dcc_markup) {
    m_dcc_markup = dcc_markup;
    m_dcc_markup_isSet = true;
}

bool OAISMSVoucher::is_dcc_markup_Set() const{
    return m_dcc_markup_isSet;
}

bool OAISMSVoucher::is_dcc_markup_Valid() const{
    return m_dcc_markup_isValid;
}

QString OAISMSVoucher::getDescriptor() const {
    return m_descriptor;
}
void OAISMSVoucher::setDescriptor(const QString &descriptor) {
    m_descriptor = descriptor;
    m_descriptor_isSet = true;
}

bool OAISMSVoucher::is_descriptor_Set() const{
    return m_descriptor_isSet;
}

bool OAISMSVoucher::is_descriptor_Valid() const{
    return m_descriptor_isValid;
}

OAIDigitalWallets OAISMSVoucher::getDigitalWallets() const {
    return m_digital_wallets;
}
void OAISMSVoucher::setDigitalWallets(const OAIDigitalWallets &digital_wallets) {
    m_digital_wallets = digital_wallets;
    m_digital_wallets_isSet = true;
}

bool OAISMSVoucher::is_digital_wallets_Set() const{
    return m_digital_wallets_isSet;
}

bool OAISMSVoucher::is_digital_wallets_Valid() const{
    return m_digital_wallets_isValid;
}

bool OAISMSVoucher::isDynamicDescriptor() const {
    return m_dynamic_descriptor;
}
void OAISMSVoucher::setDynamicDescriptor(const bool &dynamic_descriptor) {
    m_dynamic_descriptor = dynamic_descriptor;
    m_dynamic_descriptor_isSet = true;
}

bool OAISMSVoucher::is_dynamic_descriptor_Set() const{
    return m_dynamic_descriptor_isSet;
}

bool OAISMSVoucher::is_dynamic_descriptor_Valid() const{
    return m_dynamic_descriptor_isValid;
}

QList<QString> OAISMSVoucher::getExcludedDccQuoteCurrencies() const {
    return m_excluded_dcc_quote_currencies;
}
void OAISMSVoucher::setExcludedDccQuoteCurrencies(const QList<QString> &excluded_dcc_quote_currencies) {
    m_excluded_dcc_quote_currencies = excluded_dcc_quote_currencies;
    m_excluded_dcc_quote_currencies_isSet = true;
}

bool OAISMSVoucher::is_excluded_dcc_quote_currencies_Set() const{
    return m_excluded_dcc_quote_currencies_isSet;
}

bool OAISMSVoucher::is_excluded_dcc_quote_currencies_Valid() const{
    return m_excluded_dcc_quote_currencies_isValid;
}

OAIGatewayName OAISMSVoucher::getGatewayName() const {
    return m_gateway_name;
}
void OAISMSVoucher::setGatewayName(const OAIGatewayName &gateway_name) {
    m_gateway_name = gateway_name;
    m_gateway_name_isSet = true;
}

bool OAISMSVoucher::is_gateway_name_Set() const{
    return m_gateway_name_isSet;
}

bool OAISMSVoucher::is_gateway_name_Valid() const{
    return m_gateway_name_isValid;
}

QString OAISMSVoucher::getId() const {
    return m_id;
}
void OAISMSVoucher::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAISMSVoucher::is_id_Set() const{
    return m_id_isSet;
}

bool OAISMSVoucher::is_id_Valid() const{
    return m_id_isValid;
}

bool OAISMSVoucher::isIsDown() const {
    return m_is_down;
}
void OAISMSVoucher::setIsDown(const bool &is_down) {
    m_is_down = is_down;
    m_is_down_isSet = true;
}

bool OAISMSVoucher::is_is_down_Set() const{
    return m_is_down_isSet;
}

bool OAISMSVoucher::is_is_down_Valid() const{
    return m_is_down_isValid;
}

QString OAISMSVoucher::getMerchantCategoryCode() const {
    return m_merchant_category_code;
}
void OAISMSVoucher::setMerchantCategoryCode(const QString &merchant_category_code) {
    m_merchant_category_code = merchant_category_code;
    m_merchant_category_code_isSet = true;
}

bool OAISMSVoucher::is_merchant_category_code_Set() const{
    return m_merchant_category_code_isSet;
}

bool OAISMSVoucher::is_merchant_category_code_Valid() const{
    return m_merchant_category_code_isValid;
}

OAIPaymentMethod OAISMSVoucher::getMethod() const {
    return m_method;
}
void OAISMSVoucher::setMethod(const OAIPaymentMethod &method) {
    m_method = method;
    m_method_isSet = true;
}

bool OAISMSVoucher::is_method_Set() const{
    return m_method_isSet;
}

bool OAISMSVoucher::is_method_Valid() const{
    return m_method_isValid;
}

double OAISMSVoucher::getMonthlyLimit() const {
    return m_monthly_limit;
}
void OAISMSVoucher::setMonthlyLimit(const double &monthly_limit) {
    m_monthly_limit = monthly_limit;
    m_monthly_limit_isSet = true;
}

bool OAISMSVoucher::is_monthly_limit_Set() const{
    return m_monthly_limit_isSet;
}

bool OAISMSVoucher::is_monthly_limit_Valid() const{
    return m_monthly_limit_isValid;
}

QString OAISMSVoucher::getOrganizationId() const {
    return m_organization_id;
}
void OAISMSVoucher::setOrganizationId(const QString &organization_id) {
    m_organization_id = organization_id;
    m_organization_id_isSet = true;
}

bool OAISMSVoucher::is_organization_id_Set() const{
    return m_organization_id_isSet;
}

bool OAISMSVoucher::is_organization_id_Valid() const{
    return m_organization_id_isValid;
}

QList<OAIPaymentCardBrand> OAISMSVoucher::getPaymentCardSchemes() const {
    return m_payment_card_schemes;
}
void OAISMSVoucher::setPaymentCardSchemes(const QList<OAIPaymentCardBrand> &payment_card_schemes) {
    m_payment_card_schemes = payment_card_schemes;
    m_payment_card_schemes_isSet = true;
}

bool OAISMSVoucher::is_payment_card_schemes_Set() const{
    return m_payment_card_schemes_isSet;
}

bool OAISMSVoucher::is_payment_card_schemes_Valid() const{
    return m_payment_card_schemes_isValid;
}

bool OAISMSVoucher::isReconciliationWindowEnabled() const {
    return m_reconciliation_window_enabled;
}
void OAISMSVoucher::setReconciliationWindowEnabled(const bool &reconciliation_window_enabled) {
    m_reconciliation_window_enabled = reconciliation_window_enabled;
    m_reconciliation_window_enabled_isSet = true;
}

bool OAISMSVoucher::is_reconciliation_window_enabled_Set() const{
    return m_reconciliation_window_enabled_isSet;
}

bool OAISMSVoucher::is_reconciliation_window_enabled_Valid() const{
    return m_reconciliation_window_enabled_isValid;
}

qint32 OAISMSVoucher::getReconciliationWindowTtl() const {
    return m_reconciliation_window_ttl;
}
void OAISMSVoucher::setReconciliationWindowTtl(const qint32 &reconciliation_window_ttl) {
    m_reconciliation_window_ttl = reconciliation_window_ttl;
    m_reconciliation_window_ttl_isSet = true;
}

bool OAISMSVoucher::is_reconciliation_window_ttl_Set() const{
    return m_reconciliation_window_ttl_isSet;
}

bool OAISMSVoucher::is_reconciliation_window_ttl_Valid() const{
    return m_reconciliation_window_ttl_isValid;
}

QString OAISMSVoucher::getStatus() const {
    return m_status;
}
void OAISMSVoucher::setStatus(const QString &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAISMSVoucher::is_status_Set() const{
    return m_status_isSet;
}

bool OAISMSVoucher::is_status_Valid() const{
    return m_status_isValid;
}

bool OAISMSVoucher::isSticky() const {
    return m_sticky;
}
void OAISMSVoucher::setSticky(const bool &sticky) {
    m_sticky = sticky;
    m_sticky_isSet = true;
}

bool OAISMSVoucher::is_sticky_Set() const{
    return m_sticky_isSet;
}

bool OAISMSVoucher::is_sticky_Valid() const{
    return m_sticky_isValid;
}

bool OAISMSVoucher::isThreeDSecure() const {
    return m_three_d_secure;
}
void OAISMSVoucher::setThreeDSecure(const bool &three_d_secure) {
    m_three_d_secure = three_d_secure;
    m_three_d_secure_isSet = true;
}

bool OAISMSVoucher::is_three_d_secure_Set() const{
    return m_three_d_secure_isSet;
}

bool OAISMSVoucher::is_three_d_secure_Valid() const{
    return m_three_d_secure_isValid;
}

qint32 OAISMSVoucher::getTimeout() const {
    return m_timeout;
}
void OAISMSVoucher::setTimeout(const qint32 &timeout) {
    m_timeout = timeout;
    m_timeout_isSet = true;
}

bool OAISMSVoucher::is_timeout_Set() const{
    return m_timeout_isSet;
}

bool OAISMSVoucher::is_timeout_Valid() const{
    return m_timeout_isValid;
}

QString OAISMSVoucher::getToken() const {
    return m_token;
}
void OAISMSVoucher::setToken(const QString &token) {
    m_token = token;
    m_token_isSet = true;
}

bool OAISMSVoucher::is_token_Set() const{
    return m_token_isSet;
}

bool OAISMSVoucher::is_token_Valid() const{
    return m_token_isValid;
}

QDateTime OAISMSVoucher::getUpdatedTime() const {
    return m_updated_time;
}
void OAISMSVoucher::setUpdatedTime(const QDateTime &updated_time) {
    m_updated_time = updated_time;
    m_updated_time_isSet = true;
}

bool OAISMSVoucher::is_updated_time_Set() const{
    return m_updated_time_isSet;
}

bool OAISMSVoucher::is_updated_time_Valid() const{
    return m_updated_time_isValid;
}

OAISMSVoucher_allOf_credentials OAISMSVoucher::getCredentials() const {
    return m_credentials;
}
void OAISMSVoucher::setCredentials(const OAISMSVoucher_allOf_credentials &credentials) {
    m_credentials = credentials;
    m_credentials_isSet = true;
}

bool OAISMSVoucher::is_credentials_Set() const{
    return m_credentials_isSet;
}

bool OAISMSVoucher::is_credentials_Valid() const{
    return m_credentials_isValid;
}

bool OAISMSVoucher::isSet() const {
...
bool OAISMSVoucher::isValid() const {
