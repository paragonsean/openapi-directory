...
#ifndef OAIVCreditos_H
#define OAIVCreditos_H
...
#include "OAIVCreditos_allOf_credentials.h"
#include <QDateTime>
#include <QList>
#include <QString>
...
class OAIVCreditos_allOf_credentials;

class OAIVCreditos : public OAIObject {
public:
    OAIVCreditos();
    OAIVCreditos(QString json);
    ~OAIVCreditos() override;
    ...
    OAIVCreditos_allOf_credentials getCredentials() const;
    void setCredentials(const OAIVCreditos_allOf_credentials &credentials);
...
private:
    ...
    OAIVCreditos_allOf_credentials m_credentials;
...
Q_DECLARE_METATYPE(OpenAPI::OAIVCreditos)

#endif // OAIVCreditos_H
