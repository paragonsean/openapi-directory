...
#ifndef OAIKonnektive_H
#define OAIKonnektive_H
...
#include "OAIKonnektive_allOf_credentials.h"
...
class OAIKonnektive_allOf_credentials;
class OAIKonnektive_allOf_settings;

class OAIKonnektive : public OAIObject {
public:
    OAIKonnektive();
    OAIKonnektive(QString json);
    ~OAIKonnektive() override;
    ...
    OAIKonnektive_allOf_credentials getCredentials() const;
    void setCredentials(const OAIKonnektive_allOf_credentials &credentials);
    bool is_credentials_Set() const;
    bool is_credentials_Valid() const;

    OAIKonnektive_allOf_settings getSettings() const;
    void setSettings(const OAIKonnektive_allOf_settings &settings);
...
private:
    ...
    OAIKonnektive_allOf_credentials m_credentials;
    bool m_credentials_isSet;
    bool m_credentials_isValid;

    OAIKonnektive_allOf_settings m_settings;
...
Q_DECLARE_METATYPE(OpenAPI::OAIKonnektive)

#endif // OAIKonnektive_H
