...
OAITrustsPay::OAITrustsPay(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAITrustsPay::OAITrustsPay() {
    this->initializeModel();
}

OAITrustsPay::~OAITrustsPay() {}

void OAITrustsPay::initializeModel() {
...
void OAITrustsPay::fromJson(QString jsonString) {
...
void OAITrustsPay::fromJsonObject(QJsonObject json) {
...
QString OAITrustsPay::asJson() const {
...
QJsonObject OAITrustsPay::asJsonObject() const {
    QJsonObject obj;
    if (m__links.size() > 0) {
...
QList<OAIGatewayAccount__links_inner> OAITrustsPay::getLinks() const {
    return m__links;
}
void OAITrustsPay::setLinks(const QList<OAIGatewayAccount__links_inner> &_links) {
    m__links = _links;
    m__links_isSet = true;
}

bool OAITrustsPay::is__links_Set() const{
    return m__links_isSet;
}

bool OAITrustsPay::is__links_Valid() const{
    return m__links_isValid;
}

QList<QString> OAITrustsPay::getAcceptedCurrencies() const {
    return m_accepted_currencies;
}
void OAITrustsPay::setAcceptedCurrencies(const QList<QString> &accepted_currencies) {
    m_accepted_currencies = accepted_currencies;
    m_accepted_currencies_isSet = true;
}

bool OAITrustsPay::is_accepted_currencies_Set() const{
    return m_accepted_currencies_isSet;
}

bool OAITrustsPay::is_accepted_currencies_Valid() const{
    return m_accepted_currencies_isValid;
}

OAIAcquirerName OAITrustsPay::getAcquirerName() const {
    return m_acquirer_name;
}
void OAITrustsPay::setAcquirerName(const OAIAcquirerName &acquirer_name) {
    m_acquirer_name = acquirer_name;
    m_acquirer_name_isSet = true;
}

bool OAITrustsPay::is_acquirer_name_Set() const{
    return m_acquirer_name_isSet;
}

bool OAITrustsPay::is_acquirer_name_Valid() const{
    return m_acquirer_name_isValid;
}

QString OAITrustsPay::getAdditionalFilters() const {
    return m_additional_filters;
}
void OAITrustsPay::setAdditionalFilters(const QString &additional_filters) {
    m_additional_filters = additional_filters;
    m_additional_filters_isSet = true;
}

bool OAITrustsPay::is_additional_filters_Set() const{
    return m_additional_filters_isSet;
}

bool OAITrustsPay::is_additional_filters_Valid() const{
    return m_additional_filters_isValid;
}

qint32 OAITrustsPay::getApprovalWindowTtl() const {
    return m_approval_window_ttl;
}
void OAITrustsPay::setApprovalWindowTtl(const qint32 &approval_window_ttl) {
    m_approval_window_ttl = approval_window_ttl;
    m_approval_window_ttl_isSet = true;
}

bool OAITrustsPay::is_approval_window_ttl_Set() const{
    return m_approval_window_ttl_isSet;
}

bool OAITrustsPay::is_approval_window_ttl_Valid() const{
    return m_approval_window_ttl_isValid;
}

QString OAITrustsPay::getCityField() const {
    return m_city_field;
}
void OAITrustsPay::setCityField(const QString &city_field) {
    m_city_field = city_field;
    m_city_field_isSet = true;
}

bool OAITrustsPay::is_city_field_Set() const{
    return m_city_field_isSet;
}

bool OAITrustsPay::is_city_field_Valid() const{
    return m_city_field_isValid;
}

QDateTime OAITrustsPay::getCreatedTime() const {
    return m_created_time;
}
void OAITrustsPay::setCreatedTime(const QDateTime &created_time) {
    m_created_time = created_time;
    m_created_time_isSet = true;
}

bool OAITrustsPay::is_created_time_Set() const{
    return m_created_time_isSet;
}

bool OAITrustsPay::is_created_time_Valid() const{
    return m_created_time_isValid;
}

QString OAITrustsPay::getDccForceCurrency() const {
    return m_dcc_force_currency;
}
void OAITrustsPay::setDccForceCurrency(const QString &dcc_force_currency) {
    m_dcc_force_currency = dcc_force_currency;
    m_dcc_force_currency_isSet = true;
}

bool OAITrustsPay::is_dcc_force_currency_Set() const{
    return m_dcc_force_currency_isSet;
}

bool OAITrustsPay::is_dcc_force_currency_Valid() const{
    return m_dcc_force_currency_isValid;
}

qint32 OAITrustsPay::getDccMarkup() const {
    return m_dcc_markup;
}
void OAITrustsPay::setDccMarkup(const qint32 &dcc_markup) {
    m_dcc_markup = dcc_markup;
    m_dcc_markup_isSet = true;
}

bool OAITrustsPay::is_dcc_markup_Set() const{
    return m_dcc_markup_isSet;
}

bool OAITrustsPay::is_dcc_markup_Valid() const{
    return m_dcc_markup_isValid;
}

QString OAITrustsPay::getDescriptor() const {
    return m_descriptor;
}
void OAITrustsPay::setDescriptor(const QString &descriptor) {
    m_descriptor = descriptor;
    m_descriptor_isSet = true;
}

bool OAITrustsPay::is_descriptor_Set() const{
    return m_descriptor_isSet;
}

bool OAITrustsPay::is_descriptor_Valid() const{
    return m_descriptor_isValid;
}

OAIDigitalWallets OAITrustsPay::getDigitalWallets() const {
    return m_digital_wallets;
}
void OAITrustsPay::setDigitalWallets(const OAIDigitalWallets &digital_wallets) {
    m_digital_wallets = digital_wallets;
    m_digital_wallets_isSet = true;
}

bool OAITrustsPay::is_digital_wallets_Set() const{
    return m_digital_wallets_isSet;
}

bool OAITrustsPay::is_digital_wallets_Valid() const{
    return m_digital_wallets_isValid;
}

bool OAITrustsPay::isDynamicDescriptor() const {
    return m_dynamic_descriptor;
}
void OAITrustsPay::setDynamicDescriptor(const bool &dynamic_descriptor) {
    m_dynamic_descriptor = dynamic_descriptor;
    m_dynamic_descriptor_isSet = true;
}

bool OAITrustsPay::is_dynamic_descriptor_Set() const{
    return m_dynamic_descriptor_isSet;
}

bool OAITrustsPay::is_dynamic_descriptor_Valid() const{
    return m_dynamic_descriptor_isValid;
}

QList<QString> OAITrustsPay::getExcludedDccQuoteCurrencies() const {
    return m_excluded_dcc_quote_currencies;
}
void OAITrustsPay::setExcludedDccQuoteCurrencies(const QList<QString> &excluded_dcc_quote_currencies) {
    m_excluded_dcc_quote_currencies = excluded_dcc_quote_currencies;
    m_excluded_dcc_quote_currencies_isSet = true;
}

bool OAITrustsPay::is_excluded_dcc_quote_currencies_Set() const{
    return m_excluded_dcc_quote_currencies_isSet;
}

bool OAITrustsPay::is_excluded_dcc_quote_currencies_Valid() const{
    return m_excluded_dcc_quote_currencies_isValid;
}

OAIGatewayName OAITrustsPay::getGatewayName() const {
    return m_gateway_name;
}
void OAITrustsPay::setGatewayName(const OAIGatewayName &gateway_name) {
    m_gateway_name = gateway_name;
    m_gateway_name_isSet = true;
}

bool OAITrustsPay::is_gateway_name_Set() const{
    return m_gateway_name_isSet;
}

bool OAITrustsPay::is_gateway_name_Valid() const{
    return m_gateway_name_isValid;
}

QString OAITrustsPay::getId() const {
    return m_id;
}
void OAITrustsPay::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAITrustsPay::is_id_Set() const{
    return m_id_isSet;
}

bool OAITrustsPay::is_id_Valid() const{
    return m_id_isValid;
}

bool OAITrustsPay::isIsDown() const {
    return m_is_down;
}
void OAITrustsPay::setIsDown(const bool &is_down) {
    m_is_down = is_down;
    m_is_down_isSet = true;
}

bool OAITrustsPay::is_is_down_Set() const{
    return m_is_down_isSet;
}

bool OAITrustsPay::is_is_down_Valid() const{
    return m_is_down_isValid;
}

QString OAITrustsPay::getMerchantCategoryCode() const {
    return m_merchant_category_code;
}
void OAITrustsPay::setMerchantCategoryCode(const QString &merchant_category_code) {
    m_merchant_category_code = merchant_category_code;
    m_merchant_category_code_isSet = true;
}

bool OAITrustsPay::is_merchant_category_code_Set() const{
    return m_merchant_category_code_isSet;
}

bool OAITrustsPay::is_merchant_category_code_Valid() const{
    return m_merchant_category_code_isValid;
}

OAIPaymentMethod OAITrustsPay::getMethod() const {
    return m_method;
}
void OAITrustsPay::setMethod(const OAIPaymentMethod &method) {
    m_method = method;
    m_method_isSet = true;
}

bool OAITrustsPay::is_method_Set() const{
    return m_method_isSet;
}

bool OAITrustsPay::is_method_Valid() const{
    return m_method_isValid;
}

double OAITrustsPay::getMonthlyLimit() const {
    return m_monthly_limit;
}
void OAITrustsPay::setMonthlyLimit(const double &monthly_limit) {
    m_monthly_limit = monthly_limit;
    m_monthly_limit_isSet = true;
}

bool OAITrustsPay::is_monthly_limit_Set() const{
    return m_monthly_limit_isSet;
}

bool OAITrustsPay::is_monthly_limit_Valid() const{
    return m_monthly_limit_isValid;
}

QString OAITrustsPay::getOrganizationId() const {
    return m_organization_id;
}
void OAITrustsPay::setOrganizationId(const QString &organization_id) {
    m_organization_id = organization_id;
    m_organization_id_isSet = true;
}

bool OAITrustsPay::is_organization_id_Set() const{
    return m_organization_id_isSet;
}

bool OAITrustsPay::is_organization_id_Valid() const{
    return m_organization_id_isValid;
}

QList<OAIPaymentCardBrand> OAITrustsPay::getPaymentCardSchemes() const {
    return m_payment_card_schemes;
}
void OAITrustsPay::setPaymentCardSchemes(const QList<OAIPaymentCardBrand> &payment_card_schemes) {
    m_payment_card_schemes = payment_card_schemes;
    m_payment_card_schemes_isSet = true;
}

bool OAITrustsPay::is_payment_card_schemes_Set() const{
    return m_payment_card_schemes_isSet;
}

bool OAITrustsPay::is_payment_card_schemes_Valid() const{
    return m_payment_card_schemes_isValid;
}

bool OAITrustsPay::isReconciliationWindowEnabled() const {
    return m_reconciliation_window_enabled;
}
void OAITrustsPay::setReconciliationWindowEnabled(const bool &reconciliation_window_enabled) {
    m_reconciliation_window_enabled = reconciliation_window_enabled;
    m_reconciliation_window_enabled_isSet = true;
}

bool OAITrustsPay::is_reconciliation_window_enabled_Set() const{
    return m_reconciliation_window_enabled_isSet;
}

bool OAITrustsPay::is_reconciliation_window_enabled_Valid() const{
    return m_reconciliation_window_enabled_isValid;
}

qint32 OAITrustsPay::getReconciliationWindowTtl() const {
    return m_reconciliation_window_ttl;
}
void OAITrustsPay::setReconciliationWindowTtl(const qint32 &reconciliation_window_ttl) {
    m_reconciliation_window_ttl = reconciliation_window_ttl;
    m_reconciliation_window_ttl_isSet = true;
}

bool OAITrustsPay::is_reconciliation_window_ttl_Set() const{
    return m_reconciliation_window_ttl_isSet;
}

bool OAITrustsPay::is_reconciliation_window_ttl_Valid() const{
    return m_reconciliation_window_ttl_isValid;
}

QString OAITrustsPay::getStatus() const {
    return m_status;
}
void OAITrustsPay::setStatus(const QString &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAITrustsPay::is_status_Set() const{
    return m_status_isSet;
}

bool OAITrustsPay::is_status_Valid() const{
    return m_status_isValid;
}

bool OAITrustsPay::isSticky() const {
    return m_sticky;
}
void OAITrustsPay::setSticky(const bool &sticky) {
    m_sticky = sticky;
    m_sticky_isSet = true;
}

bool OAITrustsPay::is_sticky_Set() const{
    return m_sticky_isSet;
}

bool OAITrustsPay::is_sticky_Valid() const{
    return m_sticky_isValid;
}

bool OAITrustsPay::isThreeDSecure() const {
    return m_three_d_secure;
}
void OAITrustsPay::setThreeDSecure(const bool &three_d_secure) {
    m_three_d_secure = three_d_secure;
    m_three_d_secure_isSet = true;
}

bool OAITrustsPay::is_three_d_secure_Set() const{
    return m_three_d_secure_isSet;
}

bool OAITrustsPay::is_three_d_secure_Valid() const{
    return m_three_d_secure_isValid;
}

qint32 OAITrustsPay::getTimeout() const {
    return m_timeout;
}
void OAITrustsPay::setTimeout(const qint32 &timeout) {
    m_timeout = timeout;
    m_timeout_isSet = true;
}

bool OAITrustsPay::is_timeout_Set() const{
    return m_timeout_isSet;
}

bool OAITrustsPay::is_timeout_Valid() const{
    return m_timeout_isValid;
}

QString OAITrustsPay::getToken() const {
    return m_token;
}
void OAITrustsPay::setToken(const QString &token) {
    m_token = token;
    m_token_isSet = true;
}

bool OAITrustsPay::is_token_Set() const{
    return m_token_isSet;
}

bool OAITrustsPay::is_token_Valid() const{
    return m_token_isValid;
}

QDateTime OAITrustsPay::getUpdatedTime() const {
    return m_updated_time;
}
void OAITrustsPay::setUpdatedTime(const QDateTime &updated_time) {
    m_updated_time = updated_time;
    m_updated_time_isSet = true;
}

bool OAITrustsPay::is_updated_time_Set() const{
    return m_updated_time_isSet;
}

bool OAITrustsPay::is_updated_time_Valid() const{
    return m_updated_time_isValid;
}

OAITrustsPay_allOf_credentials OAITrustsPay::getCredentials() const {
    return m_credentials;
}
void OAITrustsPay::setCredentials(const OAITrustsPay_allOf_credentials &credentials) {
    m_credentials = credentials;
    m_credentials_isSet = true;
}

bool OAITrustsPay::is_credentials_Set() const{
    return m_credentials_isSet;
}

bool OAITrustsPay::is_credentials_Valid() const{
    return m_credentials_isValid;
}

bool OAITrustsPay::isSet() const {
...
bool OAITrustsPay::isValid() const {
