...
OAIPayClub::OAIPayClub(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPayClub::OAIPayClub() {
    this->initializeModel();
}

OAIPayClub::~OAIPayClub() {}

void OAIPayClub::initializeModel() {
...
void OAIPayClub::fromJson(QString jsonString) {
...
void OAIPayClub::fromJsonObject(QJsonObject json) {
...
QString OAIPayClub::asJson() const {
...
QJsonObject OAIPayClub::asJsonObject() const {
    QJsonObject obj;
    if (m__links.size() > 0) {
...
QList<OAIGatewayAccount__links_inner> OAIPayClub::getLinks() const {
    return m__links;
}
void OAIPayClub::setLinks(const QList<OAIGatewayAccount__links_inner> &_links) {
    m__links = _links;
    m__links_isSet = true;
}

bool OAIPayClub::is__links_Set() const{
    return m__links_isSet;
}

bool OAIPayClub::is__links_Valid() const{
    return m__links_isValid;
}

QList<QString> OAIPayClub::getAcceptedCurrencies() const {
    return m_accepted_currencies;
}
void OAIPayClub::setAcceptedCurrencies(const QList<QString> &accepted_currencies) {
    m_accepted_currencies = accepted_currencies;
    m_accepted_currencies_isSet = true;
}

bool OAIPayClub::is_accepted_currencies_Set() const{
    return m_accepted_currencies_isSet;
}

bool OAIPayClub::is_accepted_currencies_Valid() const{
    return m_accepted_currencies_isValid;
}

OAIAcquirerName OAIPayClub::getAcquirerName() const {
    return m_acquirer_name;
}
void OAIPayClub::setAcquirerName(const OAIAcquirerName &acquirer_name) {
    m_acquirer_name = acquirer_name;
    m_acquirer_name_isSet = true;
}

bool OAIPayClub::is_acquirer_name_Set() const{
    return m_acquirer_name_isSet;
}

bool OAIPayClub::is_acquirer_name_Valid() const{
    return m_acquirer_name_isValid;
}

QString OAIPayClub::getAdditionalFilters() const {
    return m_additional_filters;
}
void OAIPayClub::setAdditionalFilters(const QString &additional_filters) {
    m_additional_filters = additional_filters;
    m_additional_filters_isSet = true;
}

bool OAIPayClub::is_additional_filters_Set() const{
    return m_additional_filters_isSet;
}

bool OAIPayClub::is_additional_filters_Valid() const{
    return m_additional_filters_isValid;
}

qint32 OAIPayClub::getApprovalWindowTtl() const {
    return m_approval_window_ttl;
}
void OAIPayClub::setApprovalWindowTtl(const qint32 &approval_window_ttl) {
    m_approval_window_ttl = approval_window_ttl;
    m_approval_window_ttl_isSet = true;
}

bool OAIPayClub::is_approval_window_ttl_Set() const{
    return m_approval_window_ttl_isSet;
}

bool OAIPayClub::is_approval_window_ttl_Valid() const{
    return m_approval_window_ttl_isValid;
}

QString OAIPayClub::getCityField() const {
    return m_city_field;
}
void OAIPayClub::setCityField(const QString &city_field) {
    m_city_field = city_field;
    m_city_field_isSet = true;
}

bool OAIPayClub::is_city_field_Set() const{
    return m_city_field_isSet;
}

bool OAIPayClub::is_city_field_Valid() const{
    return m_city_field_isValid;
}

QDateTime OAIPayClub::getCreatedTime() const {
    return m_created_time;
}
void OAIPayClub::setCreatedTime(const QDateTime &created_time) {
    m_created_time = created_time;
    m_created_time_isSet = true;
}

bool OAIPayClub::is_created_time_Set() const{
    return m_created_time_isSet;
}

bool OAIPayClub::is_created_time_Valid() const{
    return m_created_time_isValid;
}

QString OAIPayClub::getDccForceCurrency() const {
    return m_dcc_force_currency;
}
void OAIPayClub::setDccForceCurrency(const QString &dcc_force_currency) {
    m_dcc_force_currency = dcc_force_currency;
    m_dcc_force_currency_isSet = true;
}

bool OAIPayClub::is_dcc_force_currency_Set() const{
    return m_dcc_force_currency_isSet;
}

bool OAIPayClub::is_dcc_force_currency_Valid() const{
    return m_dcc_force_currency_isValid;
}

qint32 OAIPayClub::getDccMarkup() const {
    return m_dcc_markup;
}
void OAIPayClub::setDccMarkup(const qint32 &dcc_markup) {
    m_dcc_markup = dcc_markup;
    m_dcc_markup_isSet = true;
}

bool OAIPayClub::is_dcc_markup_Set() const{
    return m_dcc_markup_isSet;
}

bool OAIPayClub::is_dcc_markup_Valid() const{
    return m_dcc_markup_isValid;
}

QString OAIPayClub::getDescriptor() const {
    return m_descriptor;
}
void OAIPayClub::setDescriptor(const QString &descriptor) {
    m_descriptor = descriptor;
    m_descriptor_isSet = true;
}

bool OAIPayClub::is_descriptor_Set() const{
    return m_descriptor_isSet;
}

bool OAIPayClub::is_descriptor_Valid() const{
    return m_descriptor_isValid;
}

OAIDigitalWallets OAIPayClub::getDigitalWallets() const {
    return m_digital_wallets;
}
void OAIPayClub::setDigitalWallets(const OAIDigitalWallets &digital_wallets) {
    m_digital_wallets = digital_wallets;
    m_digital_wallets_isSet = true;
}

bool OAIPayClub::is_digital_wallets_Set() const{
    return m_digital_wallets_isSet;
}

bool OAIPayClub::is_digital_wallets_Valid() const{
    return m_digital_wallets_isValid;
}

bool OAIPayClub::isDynamicDescriptor() const {
    return m_dynamic_descriptor;
}
void OAIPayClub::setDynamicDescriptor(const bool &dynamic_descriptor) {
    m_dynamic_descriptor = dynamic_descriptor;
    m_dynamic_descriptor_isSet = true;
}

bool OAIPayClub::is_dynamic_descriptor_Set() const{
    return m_dynamic_descriptor_isSet;
}

bool OAIPayClub::is_dynamic_descriptor_Valid() const{
    return m_dynamic_descriptor_isValid;
}

QList<QString> OAIPayClub::getExcludedDccQuoteCurrencies() const {
    return m_excluded_dcc_quote_currencies;
}
void OAIPayClub::setExcludedDccQuoteCurrencies(const QList<QString> &excluded_dcc_quote_currencies) {
    m_excluded_dcc_quote_currencies = excluded_dcc_quote_currencies;
    m_excluded_dcc_quote_currencies_isSet = true;
}

bool OAIPayClub::is_excluded_dcc_quote_currencies_Set() const{
    return m_excluded_dcc_quote_currencies_isSet;
}

bool OAIPayClub::is_excluded_dcc_quote_currencies_Valid() const{
    return m_excluded_dcc_quote_currencies_isValid;
}

OAIGatewayName OAIPayClub::getGatewayName() const {
    return m_gateway_name;
}
void OAIPayClub::setGatewayName(const OAIGatewayName &gateway_name) {
    m_gateway_name = gateway_name;
    m_gateway_name_isSet = true;
}

bool OAIPayClub::is_gateway_name_Set() const{
    return m_gateway_name_isSet;
}

bool OAIPayClub::is_gateway_name_Valid() const{
    return m_gateway_name_isValid;
}

QString OAIPayClub::getId() const {
    return m_id;
}
void OAIPayClub::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIPayClub::is_id_Set() const{
    return m_id_isSet;
}

bool OAIPayClub::is_id_Valid() const{
    return m_id_isValid;
}

bool OAIPayClub::isIsDown() const {
    return m_is_down;
}
void OAIPayClub::setIsDown(const bool &is_down) {
    m_is_down = is_down;
    m_is_down_isSet = true;
}

bool OAIPayClub::is_is_down_Set() const{
    return m_is_down_isSet;
}

bool OAIPayClub::is_is_down_Valid() const{
    return m_is_down_isValid;
}

QString OAIPayClub::getMerchantCategoryCode() const {
    return m_merchant_category_code;
}
void OAIPayClub::setMerchantCategoryCode(const QString &merchant_category_code) {
    m_merchant_category_code = merchant_category_code;
    m_merchant_category_code_isSet = true;
}

bool OAIPayClub::is_merchant_category_code_Set() const{
    return m_merchant_category_code_isSet;
}

bool OAIPayClub::is_merchant_category_code_Valid() const{
    return m_merchant_category_code_isValid;
}

OAIPaymentMethod OAIPayClub::getMethod() const {
    return m_method;
}
void OAIPayClub::setMethod(const OAIPaymentMethod &method) {
    m_method = method;
    m_method_isSet = true;
}

bool OAIPayClub::is_method_Set() const{
    return m_method_isSet;
}

bool OAIPayClub::is_method_Valid() const{
    return m_method_isValid;
}

double OAIPayClub::getMonthlyLimit() const {
    return m_monthly_limit;
}
void OAIPayClub::setMonthlyLimit(const double &monthly_limit) {
    m_monthly_limit = monthly_limit;
    m_monthly_limit_isSet = true;
}

bool OAIPayClub::is_monthly_limit_Set() const{
    return m_monthly_limit_isSet;
}

bool OAIPayClub::is_monthly_limit_Valid() const{
    return m_monthly_limit_isValid;
}

QString OAIPayClub::getOrganizationId() const {
    return m_organization_id;
}
void OAIPayClub::setOrganizationId(const QString &organization_id) {
    m_organization_id = organization_id;
    m_organization_id_isSet = true;
}

bool OAIPayClub::is_organization_id_Set() const{
    return m_organization_id_isSet;
}

bool OAIPayClub::is_organization_id_Valid() const{
    return m_organization_id_isValid;
}

QList<OAIPaymentCardBrand> OAIPayClub::getPaymentCardSchemes() const {
    return m_payment_card_schemes;
}
void OAIPayClub::setPaymentCardSchemes(const QList<OAIPaymentCardBrand> &payment_card_schemes) {
    m_payment_card_schemes = payment_card_schemes;
    m_payment_card_schemes_isSet = true;
}

bool OAIPayClub::is_payment_card_schemes_Set() const{
    return m_payment_card_schemes_isSet;
}

bool OAIPayClub::is_payment_card_schemes_Valid() const{
    return m_payment_card_schemes_isValid;
}

bool OAIPayClub::isReconciliationWindowEnabled() const {
    return m_reconciliation_window_enabled;
}
void OAIPayClub::setReconciliationWindowEnabled(const bool &reconciliation_window_enabled) {
    m_reconciliation_window_enabled = reconciliation_window_enabled;
    m_reconciliation_window_enabled_isSet = true;
}

bool OAIPayClub::is_reconciliation_window_enabled_Set() const{
    return m_reconciliation_window_enabled_isSet;
}

bool OAIPayClub::is_reconciliation_window_enabled_Valid() const{
    return m_reconciliation_window_enabled_isValid;
}

qint32 OAIPayClub::getReconciliationWindowTtl() const {
    return m_reconciliation_window_ttl;
}
void OAIPayClub::setReconciliationWindowTtl(const qint32 &reconciliation_window_ttl) {
    m_reconciliation_window_ttl = reconciliation_window_ttl;
    m_reconciliation_window_ttl_isSet = true;
}

bool OAIPayClub::is_reconciliation_window_ttl_Set() const{
    return m_reconciliation_window_ttl_isSet;
}

bool OAIPayClub::is_reconciliation_window_ttl_Valid() const{
    return m_reconciliation_window_ttl_isValid;
}

QString OAIPayClub::getStatus() const {
    return m_status;
}
void OAIPayClub::setStatus(const QString &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIPayClub::is_status_Set() const{
    return m_status_isSet;
}

bool OAIPayClub::is_status_Valid() const{
    return m_status_isValid;
}

bool OAIPayClub::isSticky() const {
    return m_sticky;
}
void OAIPayClub::setSticky(const bool &sticky) {
    m_sticky = sticky;
    m_sticky_isSet = true;
}

bool OAIPayClub::is_sticky_Set() const{
    return m_sticky_isSet;
}

bool OAIPayClub::is_sticky_Valid() const{
    return m_sticky_isValid;
}

bool OAIPayClub::isThreeDSecure() const {
    return m_three_d_secure;
}
void OAIPayClub::setThreeDSecure(const bool &three_d_secure) {
    m_three_d_secure = three_d_secure;
    m_three_d_secure_isSet = true;
}

bool OAIPayClub::is_three_d_secure_Set() const{
    return m_three_d_secure_isSet;
}

bool OAIPayClub::is_three_d_secure_Valid() const{
    return m_three_d_secure_isValid;
}

qint32 OAIPayClub::getTimeout() const {
    return m_timeout;
}
void OAIPayClub::setTimeout(const qint32 &timeout) {
    m_timeout = timeout;
    m_timeout_isSet = true;
}

bool OAIPayClub::is_timeout_Set() const{
    return m_timeout_isSet;
}

bool OAIPayClub::is_timeout_Valid() const{
    return m_timeout_isValid;
}

QString OAIPayClub::getToken() const {
    return m_token;
}
void OAIPayClub::setToken(const QString &token) {
    m_token = token;
    m_token_isSet = true;
}

bool OAIPayClub::is_token_Set() const{
    return m_token_isSet;
}

bool OAIPayClub::is_token_Valid() const{
    return m_token_isValid;
}

QDateTime OAIPayClub::getUpdatedTime() const {
    return m_updated_time;
}
void OAIPayClub::setUpdatedTime(const QDateTime &updated_time) {
    m_updated_time = updated_time;
    m_updated_time_isSet = true;
}

bool OAIPayClub::is_updated_time_Set() const{
    return m_updated_time_isSet;
}

bool OAIPayClub::is_updated_time_Valid() const{
    return m_updated_time_isValid;
}

OAIPayClub_allOf_credentials OAIPayClub::getCredentials() const {
    return m_credentials;
}
void OAIPayClub::setCredentials(const OAIPayClub_allOf_credentials &credentials) {
    m_credentials = credentials;
    m_credentials_isSet = true;
}

bool OAIPayClub::is_credentials_Set() const{
    return m_credentials_isSet;
}

bool OAIPayClub::is_credentials_Valid() const{
    return m_credentials_isValid;
}

OAIPayClub_allOf_settings OAIPayClub::getSettings() const {
    return m_settings;
}
void OAIPayClub::setSettings(const OAIPayClub_allOf_settings &settings) {
    m_settings = settings;
    m_settings_isSet = true;
}

bool OAIPayClub::is_settings_Set() const{
    return m_settings_isSet;
}

bool OAIPayClub::is_settings_Valid() const{
    return m_settings_isValid;
}

bool OAIPayClub::isSet() const {
