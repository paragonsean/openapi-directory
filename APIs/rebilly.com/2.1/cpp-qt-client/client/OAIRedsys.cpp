...
OAIRedsys::OAIRedsys(QString json) {
...
void OAIRedsys::initializeModel() {
...
void OAIRedsys::fromJson(QString jsonString) {
...
void OAIRedsys::fromJsonObject(QJsonObject json) {
...
QString OAIRedsys::asJson() const {
...
QJsonObject OAIRedsys::asJsonObject() const {
    QJsonObject obj;
    if (m__links.size() > 0) {
...
QList<OAIGatewayAccount__links_inner> OAIRedsys::getLinks() const {
    return m__links;
}
void OAIRedsys::setLinks(const QList<OAIGatewayAccount__links_inner> &_links) {
    m__links = _links;
    m__links_isSet = true;
}

bool OAIRedsys::is__links_Set() const{
    return m__links_isSet;
}

bool OAIRedsys::is__links_Valid() const{
    return m__links_isValid;
}

QList<QString> OAIRedsys::getAcceptedCurrencies() const {
    return m_accepted_currencies;
}
void OAIRedsys::setAcceptedCurrencies(const QList<QString> &accepted_currencies) {
    m_accepted_currencies = accepted_currencies;
    m_accepted_currencies_isSet = true;
}

bool OAIRedsys::is_accepted_currencies_Set() const{
    return m_accepted_currencies_isSet;
}

bool OAIRedsys::is_accepted_currencies_Valid() const{
    return m_accepted_currencies_isValid;
}

OAIAcquirerName OAIRedsys::getAcquirerName() const {
    return m_acquirer_name;
}
void OAIRedsys::setAcquirerName(const OAIAcquirerName &acquirer_name) {
    m_acquirer_name = acquirer_name;
    m_acquirer_name_isSet = true;
}

bool OAIRedsys::is_acquirer_name_Set() const{
    return m_acquirer_name_isSet;
}

bool OAIRedsys::is_acquirer_name_Valid() const{
    return m_acquirer_name_isValid;
}

QString OAIRedsys::getAdditionalFilters() const {
    return m_additional_filters;
}
void OAIRedsys::setAdditionalFilters(const QString &additional_filters) {
    m_additional_filters = additional_filters;
    m_additional_filters_isSet = true;
}

bool OAIRedsys::is_additional_filters_Set() const{
    return m_additional_filters_isSet;
}

bool OAIRedsys::is_additional_filters_Valid() const{
    return m_additional_filters_isValid;
}

qint32 OAIRedsys::getApprovalWindowTtl() const {
    return m_approval_window_ttl;
}
void OAIRedsys::setApprovalWindowTtl(const qint32 &approval_window_ttl) {
    m_approval_window_ttl = approval_window_ttl;
    m_approval_window_ttl_isSet = true;
}

bool OAIRedsys::is_approval_window_ttl_Set() const{
    return m_approval_window_ttl_isSet;
}

bool OAIRedsys::is_approval_window_ttl_Valid() const{
    return m_approval_window_ttl_isValid;
}

QString OAIRedsys::getCityField() const {
    return m_city_field;
}
void OAIRedsys::setCityField(const QString &city_field) {
    m_city_field = city_field;
    m_city_field_isSet = true;
}

bool OAIRedsys::is_city_field_Set() const{
    return m_city_field_isSet;
}

bool OAIRedsys::is_city_field_Valid() const{
    return m_city_field_isValid;
}

QDateTime OAIRedsys::getCreatedTime() const {
    return m_created_time;
}
void OAIRedsys::setCreatedTime(const QDateTime &created_time) {
    m_created_time = created_time;
    m_created_time_isSet = true;
}

bool OAIRedsys::is_created_time_Set() const{
    return m_created_time_isSet;
}

bool OAIRedsys::is_created_time_Valid() const{
    return m_created_time_isValid;
}

QString OAIRedsys::getDccForceCurrency() const {
    return m_dcc_force_currency;
}
void OAIRedsys::setDccForceCurrency(const QString &dcc_force_currency) {
    m_dcc_force_currency = dcc_force_currency;
    m_dcc_force_currency_isSet = true;
}

bool OAIRedsys::is_dcc_force_currency_Set() const{
    return m_dcc_force_currency_isSet;
}

bool OAIRedsys::is_dcc_force_currency_Valid() const{
    return m_dcc_force_currency_isValid;
}

qint32 OAIRedsys::getDccMarkup() const {
    return m_dcc_markup;
}
void OAIRedsys::setDccMarkup(const qint32 &dcc_markup) {
    m_dcc_markup = dcc_markup;
    m_dcc_markup_isSet = true;
}

bool OAIRedsys::is_dcc_markup_Set() const{
    return m_dcc_markup_isSet;
}

bool OAIRedsys::is_dcc_markup_Valid() const{
    return m_dcc_markup_isValid;
}

QString OAIRedsys::getDescriptor() const {
    return m_descriptor;
}
void OAIRedsys::setDescriptor(const QString &descriptor) {
    m_descriptor = descriptor;
    m_descriptor_isSet = true;
}

bool OAIRedsys::is_descriptor_Set() const{
    return m_descriptor_isSet;
}

bool OAIRedsys::is_descriptor_Valid() const{
    return m_descriptor_isValid;
}

OAIDigitalWallets OAIRedsys::getDigitalWallets() const {
    return m_digital_wallets;
}
void OAIRedsys::setDigitalWallets(const OAIDigitalWallets &digital_wallets) {
    m_digital_wallets = digital_wallets;
    m_digital_wallets_isSet = true;
}

bool OAIRedsys::is_digital_wallets_Set() const{
    return m_digital_wallets_isSet;
}

bool OAIRedsys::is_digital_wallets_Valid() const{
    return m_digital_wallets_isValid;
}

bool OAIRedsys::isDynamicDescriptor() const {
    return m_dynamic_descriptor;
}
void OAIRedsys::setDynamicDescriptor(const bool &dynamic_descriptor) {
    m_dynamic_descriptor = dynamic_descriptor;
    m_dynamic_descriptor_isSet = true;
}

bool OAIRedsys::is_dynamic_descriptor_Set() const{
    return m_dynamic_descriptor_isSet;
}

bool OAIRedsys::is_dynamic_descriptor_Valid() const{
    return m_dynamic_descriptor_isValid;
}

QList<QString> OAIRedsys::getExcludedDccQuoteCurrencies() const {
    return m_excluded_dcc_quote_currencies;
}
void OAIRedsys::setExcludedDccQuoteCurrencies(const QList<QString> &excluded_dcc_quote_currencies) {
    m_excluded_dcc_quote_currencies = excluded_dcc_quote_currencies;
    m_excluded_dcc_quote_currencies_isSet = true;
}

bool OAIRedsys::is_excluded_dcc_quote_currencies_Set() const{
    return m_excluded_dcc_quote_currencies_isSet;
}

bool OAIRedsys::is_excluded_dcc_quote_currencies_Valid() const{
    return m_excluded_dcc_quote_currencies_isValid;
}

OAIGatewayName OAIRedsys::getGatewayName() const {
    return m_gateway_name;
}
void OAIRedsys::setGatewayName(const OAIGatewayName &gateway_name) {
    m_gateway_name = gateway_name;
    m_gateway_name_isSet = true;
}

bool OAIRedsys::is_gateway_name_Set() const{
    return m_gateway_name_isSet;
}

bool OAIRedsys::is_gateway_name_Valid() const{
    return m_gateway_name_isValid;
}

QString OAIRedsys::getId() const {
    return m_id;
}
void OAIRedsys::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIRedsys::is_id_Set() const{
    return m_id_isSet;
}

bool OAIRedsys::is_id_Valid() const{
    return m_id_isValid;
}

bool OAIRedsys::isIsDown() const {
    return m_is_down;
}
void OAIRedsys::setIsDown(const bool &is_down) {
    m_is_down = is_down;
    m_is_down_isSet = true;
}

bool OAIRedsys::is_is_down_Set() const{
    return m_is_down_isSet;
}

bool OAIRedsys::is_is_down_Valid() const{
    return m_is_down_isValid;
}

QString OAIRedsys::getMerchantCategoryCode() const {
    return m_merchant_category_code;
}
void OAIRedsys::setMerchantCategoryCode(const QString &merchant_category_code) {
    m_merchant_category_code = merchant_category_code;
    m_merchant_category_code_isSet = true;
}

bool OAIRedsys::is_merchant_category_code_Set() const{
    return m_merchant_category_code_isSet;
}

bool OAIRedsys::is_merchant_category_code_Valid() const{
    return m_merchant_category_code_isValid;
}

OAIPaymentMethod OAIRedsys::getMethod() const {
    return m_method;
}
void OAIRedsys::setMethod(const OAIPaymentMethod &method) {
    m_method = method;
    m_method_isSet = true;
}

bool OAIRedsys::is_method_Set() const{
    return m_method_isSet;
}

bool OAIRedsys::is_method_Valid() const{
    return m_method_isValid;
}

double OAIRedsys::getMonthlyLimit() const {
    return m_monthly_limit;
}
void OAIRedsys::setMonthlyLimit(const double &monthly_limit) {
    m_monthly_limit = monthly_limit;
    m_monthly_limit_isSet = true;
}

bool OAIRedsys::is_monthly_limit_Set() const{
    return m_monthly_limit_isSet;
}

bool OAIRedsys::is_monthly_limit_Valid() const{
    return m_monthly_limit_isValid;
}

QString OAIRedsys::getOrganizationId() const {
    return m_organization_id;
}
void OAIRedsys::setOrganizationId(const QString &organization_id) {
    m_organization_id = organization_id;
    m_organization_id_isSet = true;
}

bool OAIRedsys::is_organization_id_Set() const{
    return m_organization_id_isSet;
}

bool OAIRedsys::is_organization_id_Valid() const{
    return m_organization_id_isValid;
}

QList<OAIPaymentCardBrand> OAIRedsys::getPaymentCardSchemes() const {
    return m_payment_card_schemes;
}
void OAIRedsys::setPaymentCardSchemes(const QList<OAIPaymentCardBrand> &payment_card_schemes) {
    m_payment_card_schemes = payment_card_schemes;
    m_payment_card_schemes_isSet = true;
}

bool OAIRedsys::is_payment_card_schemes_Set() const{
    return m_payment_card_schemes_isSet;
}

bool OAIRedsys::is_payment_card_schemes_Valid() const{
    return m_payment_card_schemes_isValid;
}

bool OAIRedsys::isReconciliationWindowEnabled() const {
    return m_reconciliation_window_enabled;
}
void OAIRedsys::setReconciliationWindowEnabled(const bool &reconciliation_window_enabled) {
    m_reconciliation_window_enabled = reconciliation_window_enabled;
    m_reconciliation_window_enabled_isSet = true;
}

bool OAIRedsys::is_reconciliation_window_enabled_Set() const{
    return m_reconciliation_window_enabled_isSet;
}

bool OAIRedsys::is_reconciliation_window_enabled_Valid() const{
    return m_reconciliation_window_enabled_isValid;
}

qint32 OAIRedsys::getReconciliationWindowTtl() const {
    return m_reconciliation_window_ttl;
}
void OAIRedsys::setReconciliationWindowTtl(const qint32 &reconciliation_window_ttl) {
    m_reconciliation_window_ttl = reconciliation_window_ttl;
    m_reconciliation_window_ttl_isSet = true;
}

bool OAIRedsys::is_reconciliation_window_ttl_Set() const{
    return m_reconciliation_window_ttl_isSet;
}

bool OAIRedsys::is_reconciliation_window_ttl_Valid() const{
    return m_reconciliation_window_ttl_isValid;
}

QString OAIRedsys::getStatus() const {
    return m_status;
}
void OAIRedsys::setStatus(const QString &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIRedsys::is_status_Set() const{
    return m_status_isSet;
}

bool OAIRedsys::is_status_Valid() const{
    return m_status_isValid;
}

bool OAIRedsys::isSticky() const {
    return m_sticky;
}
void OAIRedsys::setSticky(const bool &sticky) {
    m_sticky = sticky;
    m_sticky_isSet = true;
}

bool OAIRedsys::is_sticky_Set() const{
    return m_sticky_isSet;
}

bool OAIRedsys::is_sticky_Valid() const{
    return m_sticky_isValid;
}

bool OAIRedsys::isThreeDSecure() const {
    return m_three_d_secure;
}
void OAIRedsys::setThreeDSecure(const bool &three_d_secure) {
    m_three_d_secure = three_d_secure;
    m_three_d_secure_isSet = true;
}

bool OAIRedsys::is_three_d_secure_Set() const{
    return m_three_d_secure_isSet;
}

bool OAIRedsys::is_three_d_secure_Valid() const{
    return m_three_d_secure_isValid;
}

qint32 OAIRedsys::getTimeout() const {
    return m_timeout;
}
void OAIRedsys::setTimeout(const qint32 &timeout) {
    m_timeout = timeout;
    m_timeout_isSet = true;
}

bool OAIRedsys::is_timeout_Set() const{
    return m_timeout_isSet;
}

bool OAIRedsys::is_timeout_Valid() const{
    return m_timeout_isValid;
}

QString OAIRedsys::getToken() const {
    return m_token;
}
void OAIRedsys::setToken(const QString &token) {
    m_token = token;
    m_token_isSet = true;
}

bool OAIRedsys::is_token_Set() const{
    return m_token_isSet;
}

bool OAIRedsys::is_token_Valid() const{
    return m_token_isValid;
}

QDateTime OAIRedsys::getUpdatedTime() const {
    return m_updated_time;
}
void OAIRedsys::setUpdatedTime(const QDateTime &updated_time) {
    m_updated_time = updated_time;
    m_updated_time_isSet = true;
}

bool OAIRedsys::is_updated_time_Set() const{
    return m_updated_time_isSet;
}

bool OAIRedsys::is_updated_time_Valid() const{
    return m_updated_time_isValid;
}

OAIRedsys_allOf_credentials OAIRedsys::getCredentials() const {
    return m_credentials;
}
void OAIRedsys::setCredentials(const OAIRedsys_allOf_credentials &credentials) {
    m_credentials = credentials;
    m_credentials_isSet = true;
}

bool OAIRedsys::is_credentials_Set() const{
    return m_credentials_isSet;
}

bool OAIRedsys::is_credentials_Valid() const{
    return m_credentials_isValid;
}

bool OAIRedsys::isSet() const {
