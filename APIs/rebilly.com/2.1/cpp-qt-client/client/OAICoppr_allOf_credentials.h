...
/*
 * OAICoppr_allOf_credentials.h
 *
 * Coppr credentials object.
 */

#ifndef OAICoppr_allOf_credentials_H
#define OAICoppr_allOf_credentials_H
...
class OAICoppr_allOf_credentials : public OAIObject {
public:
    OAICoppr_allOf_credentials();
    OAICoppr_allOf_credentials(QString json);
    ~OAICoppr_allOf_credentials() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICoppr_allOf_credentials)

#endif // OAICoppr_allOf_credentials_H
