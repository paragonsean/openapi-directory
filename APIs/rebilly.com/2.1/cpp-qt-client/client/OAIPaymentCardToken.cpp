...
OAIPaymentCardToken::OAIPaymentCardToken(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPaymentCardToken::OAIPaymentCardToken() {
    this->initializeModel();
}

OAIPaymentCardToken::~OAIPaymentCardToken() {}

void OAIPaymentCardToken::initializeModel() {
...
void OAIPaymentCardToken::fromJson(QString jsonString) {
...
void OAIPaymentCardToken::fromJsonObject(QJsonObject json) {
...
QString OAIPaymentCardToken::asJson() const {
...
QJsonObject OAIPaymentCardToken::asJsonObject() const {
    QJsonObject obj;
...
OAIContactObject OAIPaymentCardToken::getBillingAddress() const {
    return m_billing_address;
}
void OAIPaymentCardToken::setBillingAddress(const OAIContactObject &billing_address) {
    m_billing_address = billing_address;
    m_billing_address_isSet = true;
}

bool OAIPaymentCardToken::is_billing_address_Set() const{
    return m_billing_address_isSet;
}

bool OAIPaymentCardToken::is_billing_address_Valid() const{
    return m_billing_address_isValid;
}

QString OAIPaymentCardToken::getMethod() const {
    return m_method;
}
void OAIPaymentCardToken::setMethod(const QString &method) {
    m_method = method;
    m_method_isSet = true;
}

bool OAIPaymentCardToken::is_method_Set() const{
    return m_method_isSet;
}

bool OAIPaymentCardToken::is_method_Valid() const{
    return m_method_isValid;
}

OAIObject OAIPaymentCardToken::getPaymentInstrument() const {
    return m_payment_instrument;
}
void OAIPaymentCardToken::setPaymentInstrument(const OAIObject &payment_instrument) {
    m_payment_instrument = payment_instrument;
    m_payment_instrument_isSet = true;
}

bool OAIPaymentCardToken::is_payment_instrument_Set() const{
    return m_payment_instrument_isSet;
}

bool OAIPaymentCardToken::is_payment_instrument_Valid() const{
    return m_payment_instrument_isValid;
}

QList<OAISelfLink> OAIPaymentCardToken::getLinks() const {
    return m__links;
}
void OAIPaymentCardToken::setLinks(const QList<OAISelfLink> &_links) {
    m__links = _links;
    m__links_isSet = true;
}

bool OAIPaymentCardToken::is__links_Set() const{
    return m__links_isSet;
}

bool OAIPaymentCardToken::is__links_Valid() const{
    return m__links_isValid;
}

QDateTime OAIPaymentCardToken::getCreatedTime() const {
    return m_created_time;
}
void OAIPaymentCardToken::setCreatedTime(const QDateTime &created_time) {
    m_created_time = created_time;
    m_created_time_isSet = true;
}

bool OAIPaymentCardToken::is_created_time_Set() const{
    return m_created_time_isSet;
}

bool OAIPaymentCardToken::is_created_time_Valid() const{
    return m_created_time_isValid;
}

QDateTime OAIPaymentCardToken::getExpirationTime() const {
    return m_expiration_time;
}
void OAIPaymentCardToken::setExpirationTime(const QDateTime &expiration_time) {
    m_expiration_time = expiration_time;
    m_expiration_time_isSet = true;
}

bool OAIPaymentCardToken::is_expiration_time_Set() const{
    return m_expiration_time_isSet;
}

bool OAIPaymentCardToken::is_expiration_time_Valid() const{
    return m_expiration_time_isValid;
}

QString OAIPaymentCardToken::getId() const {
    return m_id;
}
void OAIPaymentCardToken::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIPaymentCardToken::is_id_Set() const{
    return m_id_isSet;
}

bool OAIPaymentCardToken::is_id_Valid() const{
    return m_id_isValid;
}

bool OAIPaymentCardToken::isIsUsed() const {
    return m_is_used;
}
void OAIPaymentCardToken::setIsUsed(const bool &is_used) {
    m_is_used = is_used;
    m_is_used_isSet = true;
}

bool OAIPaymentCardToken::is_is_used_Set() const{
    return m_is_used_isSet;
}

bool OAIPaymentCardToken::is_is_used_Valid() const{
    return m_is_used_isValid;
}

OAILeadSource OAIPaymentCardToken::getLeadSource() const {
    return m_lead_source;
}
void OAIPaymentCardToken::setLeadSource(const OAILeadSource &lead_source) {
    m_lead_source = lead_source;
    m_lead_source_isSet = true;
}

bool OAIPaymentCardToken::is_lead_source_Set() const{
    return m_lead_source_isSet;
}

bool OAIPaymentCardToken::is_lead_source_Valid() const{
    return m_lead_source_isValid;
}

OAIRiskMetadata OAIPaymentCardToken::getRiskMetadata() const {
    return m_risk_metadata;
}
void OAIPaymentCardToken::setRiskMetadata(const OAIRiskMetadata &risk_metadata) {
    m_risk_metadata = risk_metadata;
    m_risk_metadata_isSet = true;
}

bool OAIPaymentCardToken::is_risk_metadata_Set() const{
    return m_risk_metadata_isSet;
}

bool OAIPaymentCardToken::is_risk_metadata_Valid() const{
    return m_risk_metadata_isValid;
}

QDateTime OAIPaymentCardToken::getUpdatedTime() const {
    return m_updated_time;
}
void OAIPaymentCardToken::setUpdatedTime(const QDateTime &updated_time) {
    m_updated_time = updated_time;
    m_updated_time_isSet = true;
}

bool OAIPaymentCardToken::is_updated_time_Set() const{
    return m_updated_time_isSet;
}

bool OAIPaymentCardToken::is_updated_time_Valid() const{
    return m_updated_time_isValid;
}

QDateTime OAIPaymentCardToken::getUsageTime() const {
    return m_usage_time;
}
void OAIPaymentCardToken::setUsageTime(const QDateTime &usage_time) {
    m_usage_time = usage_time;
    m_usage_time_isSet = true;
}

bool OAIPaymentCardToken::is_usage_time_Set() const{
    return m_usage_time_isSet;
}

bool OAIPaymentCardToken::is_usage_time_Valid() const{
    return m_usage_time_isValid;
}

bool OAIPaymentCardToken::isSet() const {
...
bool OAIPaymentCardToken::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_method_isValid && m_payment_instrument_isValid && true;
}
