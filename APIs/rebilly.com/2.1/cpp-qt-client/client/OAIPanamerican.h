...
#ifndef OAIPanamerican_H
#define OAIPanamerican_H
...
class OAIPanamerican_allOf_credentials;
class OAIPanamerican_allOf_settings;
class OAIPanamerican3dsServers;

class OAIPanamerican : public OAIObject {
public:
    OAIPanamerican();
    OAIPanamerican(QString json);
    ~OAIPanamerican() override;
    ...
    OAIPanamerican_allOf_credentials getCredentials() const;
    void setCredentials(const OAIPanamerican_allOf_credentials &credentials);
    bool is_credentials_Set() const;
    bool is_credentials_Valid() const;

    OAIPanamerican_allOf_settings getSettings() const;
    void setSettings(const OAIPanamerican_allOf_settings &settings);
    bool is_settings_Set() const;
    bool is_settings_Valid() const;

    OAIPanamerican3dsServers getThreeDSecureServer() const;
    void setThreeDSecureServer(const OAIPanamerican3dsServers &three_d_secure_server);
...
private:
    ...
    OAIPanamerican_allOf_credentials m_credentials;
    bool m_credentials_isSet;
    bool m_credentials_isValid;

    OAIPanamerican_allOf_settings m_settings;
    bool m_settings_isSet;
    bool m_settings_isValid;

    OAIPanamerican3dsServers m_three_d_secure_server;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPanamerican)

#endif // OAIPanamerican_H
