...
class OAIBankAccount_allOf__embedded;
...
public:
    ...
    QList<OAIBankAccount_allOf__embedded> getEmbedded() const;
    void setEmbedded(const QList<OAIBankAccount_allOf__embedded> &_embedded);
...
private:
    ...
    QList<OAIBankAccount_allOf__embedded> m__embedded;
