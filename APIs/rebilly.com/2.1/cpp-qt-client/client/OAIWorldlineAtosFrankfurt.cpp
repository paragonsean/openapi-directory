...
#include "OAIWorldlineAtosFrankfurt.h"
...
OAIWorldlineAtosFrankfurt::OAIWorldlineAtosFrankfurt(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIWorldlineAtosFrankfurt::OAIWorldlineAtosFrankfurt() {
    this->initializeModel();
}

OAIWorldlineAtosFrankfurt::~OAIWorldlineAtosFrankfurt() {}

void OAIWorldlineAtosFrankfurt::initializeModel() {
...
void OAIWorldlineAtosFrankfurt::fromJson(QString jsonString) {
...
void OAIWorldlineAtosFrankfurt::fromJsonObject(QJsonObject json) {
...
QString OAIWorldlineAtosFrankfurt::asJson() const {
...
QJsonObject OAIWorldlineAtosFrankfurt::asJsonObject() const {
    QJsonObject obj;
    if (m__links.size() > 0) {
...
QList<OAIGatewayAccount__links_inner> OAIWorldlineAtosFrankfurt::getLinks() const {
    return m__links;
}
void OAIWorldlineAtosFrankfurt::setLinks(const QList<OAIGatewayAccount__links_inner> &_links) {
    m__links = _links;
    m__links_isSet = true;
}

bool OAIWorldlineAtosFrankfurt::is__links_Set() const{
    return m__links_isSet;
}

bool OAIWorldlineAtosFrankfurt::is__links_Valid() const{
    return m__links_isValid;
}

QList<QString> OAIWorldlineAtosFrankfurt::getAcceptedCurrencies() const {
    return m_accepted_currencies;
}
void OAIWorldlineAtosFrankfurt::setAcceptedCurrencies(const QList<QString> &accepted_currencies) {
    m_accepted_currencies = accepted_currencies;
    m_accepted_currencies_isSet = true;
}

bool OAIWorldlineAtosFrankfurt::is_accepted_currencies_Set() const{
    return m_accepted_currencies_isSet;
}

bool OAIWorldlineAtosFrankfurt::is_accepted_currencies_Valid() const{
    return m_accepted_currencies_isValid;
}

OAIAcquirerName OAIWorldlineAtosFrankfurt::getAcquirerName() const {
    return m_acquirer_name;
}
void OAIWorldlineAtosFrankfurt::setAcquirerName(const OAIAcquirerName &acquirer_name) {
    m_acquirer_name = acquirer_name;
    m_acquirer_name_isSet = true;
}

bool OAIWorldlineAtosFrankfurt::is_acquirer_name_Set() const{
    return m_acquirer_name_isSet;
}

bool OAIWorldlineAtosFrankfurt::is_acquirer_name_Valid() const{
    return m_acquirer_name_isValid;
}

QString OAIWorldlineAtosFrankfurt::getAdditionalFilters() const {
    return m_additional_filters;
}
void OAIWorldlineAtosFrankfurt::setAdditionalFilters(const QString &additional_filters) {
    m_additional_filters = additional_filters;
    m_additional_filters_isSet = true;
}

bool OAIWorldlineAtosFrankfurt::is_additional_filters_Set() const{
    return m_additional_filters_isSet;
}

bool OAIWorldlineAtosFrankfurt::is_additional_filters_Valid() const{
    return m_additional_filters_isValid;
}

qint32 OAIWorldlineAtosFrankfurt::getApprovalWindowTtl() const {
    return m_approval_window_ttl;
}
void OAIWorldlineAtosFrankfurt::setApprovalWindowTtl(const qint32 &approval_window_ttl) {
    m_approval_window_ttl = approval_window_ttl;
    m_approval_window_ttl_isSet = true;
}

bool OAIWorldlineAtosFrankfurt::is_approval_window_ttl_Set() const{
    return m_approval_window_ttl_isSet;
}

bool OAIWorldlineAtosFrankfurt::is_approval_window_ttl_Valid() const{
    return m_approval_window_ttl_isValid;
}

QString OAIWorldlineAtosFrankfurt::getCityField() const {
    return m_city_field;
}
void OAIWorldlineAtosFrankfurt::setCityField(const QString &city_field) {
    m_city_field = city_field;
    m_city_field_isSet = true;
}

bool OAIWorldlineAtosFrankfurt::is_city_field_Set() const{
    return m_city_field_isSet;
}

bool OAIWorldlineAtosFrankfurt::is_city_field_Valid() const{
    return m_city_field_isValid;
}

QDateTime OAIWorldlineAtosFrankfurt::getCreatedTime() const {
    return m_created_time;
}
void OAIWorldlineAtosFrankfurt::setCreatedTime(const QDateTime &created_time) {
    m_created_time = created_time;
    m_created_time_isSet = true;
}

bool OAIWorldlineAtosFrankfurt::is_created_time_Set() const{
    return m_created_time_isSet;
}

bool OAIWorldlineAtosFrankfurt::is_created_time_Valid() const{
    return m_created_time_isValid;
}

QString OAIWorldlineAtosFrankfurt::getDccForceCurrency() const {
    return m_dcc_force_currency;
}
void OAIWorldlineAtosFrankfurt::setDccForceCurrency(const QString &dcc_force_currency) {
    m_dcc_force_currency = dcc_force_currency;
    m_dcc_force_currency_isSet = true;
}

bool OAIWorldlineAtosFrankfurt::is_dcc_force_currency_Set() const{
    return m_dcc_force_currency_isSet;
}

bool OAIWorldlineAtosFrankfurt::is_dcc_force_currency_Valid() const{
    return m_dcc_force_currency_isValid;
}

qint32 OAIWorldlineAtosFrankfurt::getDccMarkup() const {
    return m_dcc_markup;
}
void OAIWorldlineAtosFrankfurt::setDccMarkup(const qint32 &dcc_markup) {
    m_dcc_markup = dcc_markup;
    m_dcc_markup_isSet = true;
}

bool OAIWorldlineAtosFrankfurt::is_dcc_markup_Set() const{
    return m_dcc_markup_isSet;
}

bool OAIWorldlineAtosFrankfurt::is_dcc_markup_Valid() const{
    return m_dcc_markup_isValid;
}

QString OAIWorldlineAtosFrankfurt::getDescriptor() const {
    return m_descriptor;
}
void OAIWorldlineAtosFrankfurt::setDescriptor(const QString &descriptor) {
    m_descriptor = descriptor;
    m_descriptor_isSet = true;
}

bool OAIWorldlineAtosFrankfurt::is_descriptor_Set() const{
    return m_descriptor_isSet;
}

bool OAIWorldlineAtosFrankfurt::is_descriptor_Valid() const{
    return m_descriptor_isValid;
}

OAIDigitalWallets OAIWorldlineAtosFrankfurt::getDigitalWallets() const {
    return m_digital_wallets;
}
void OAIWorldlineAtosFrankfurt::setDigitalWallets(const OAIDigitalWallets &digital_wallets) {
    m_digital_wallets = digital_wallets;
    m_digital_wallets_isSet = true;
}

bool OAIWorldlineAtosFrankfurt::is_digital_wallets_Set() const{
    return m_digital_wallets_isSet;
}

bool OAIWorldlineAtosFrankfurt::is_digital_wallets_Valid() const{
    return m_digital_wallets_isValid;
}

bool OAIWorldlineAtosFrankfurt::isDynamicDescriptor() const {
    return m_dynamic_descriptor;
}
void OAIWorldlineAtosFrankfurt::setDynamicDescriptor(const bool &dynamic_descriptor) {
    m_dynamic_descriptor = dynamic_descriptor;
    m_dynamic_descriptor_isSet = true;
}

bool OAIWorldlineAtosFrankfurt::is_dynamic_descriptor_Set() const{
    return m_dynamic_descriptor_isSet;
}

bool OAIWorldlineAtosFrankfurt::is_dynamic_descriptor_Valid() const{
    return m_dynamic_descriptor_isValid;
}

QList<QString> OAIWorldlineAtosFrankfurt::getExcludedDccQuoteCurrencies() const {
    return m_excluded_dcc_quote_currencies;
}
void OAIWorldlineAtosFrankfurt::setExcludedDccQuoteCurrencies(const QList<QString> &excluded_dcc_quote_currencies) {
    m_excluded_dcc_quote_currencies = excluded_dcc_quote_currencies;
    m_excluded_dcc_quote_currencies_isSet = true;
}

bool OAIWorldlineAtosFrankfurt::is_excluded_dcc_quote_currencies_Set() const{
    return m_excluded_dcc_quote_currencies_isSet;
}

bool OAIWorldlineAtosFrankfurt::is_excluded_dcc_quote_currencies_Valid() const{
    return m_excluded_dcc_quote_currencies_isValid;
}

OAIGatewayName OAIWorldlineAtosFrankfurt::getGatewayName() const {
    return m_gateway_name;
}
void OAIWorldlineAtosFrankfurt::setGatewayName(const OAIGatewayName &gateway_name) {
    m_gateway_name = gateway_name;
    m_gateway_name_isSet = true;
}

bool OAIWorldlineAtosFrankfurt::is_gateway_name_Set() const{
    return m_gateway_name_isSet;
}

bool OAIWorldlineAtosFrankfurt::is_gateway_name_Valid() const{
    return m_gateway_name_isValid;
}

QString OAIWorldlineAtosFrankfurt::getId() const {
    return m_id;
}
void OAIWorldlineAtosFrankfurt::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIWorldlineAtosFrankfurt::is_id_Set() const{
    return m_id_isSet;
}

bool OAIWorldlineAtosFrankfurt::is_id_Valid() const{
    return m_id_isValid;
}

bool OAIWorldlineAtosFrankfurt::isIsDown() const {
    return m_is_down;
}
void OAIWorldlineAtosFrankfurt::setIsDown(const bool &is_down) {
    m_is_down = is_down;
    m_is_down_isSet = true;
}

bool OAIWorldlineAtosFrankfurt::is_is_down_Set() const{
    return m_is_down_isSet;
}

bool OAIWorldlineAtosFrankfurt::is_is_down_Valid() const{
    return m_is_down_isValid;
}

QString OAIWorldlineAtosFrankfurt::getMerchantCategoryCode() const {
    return m_merchant_category_code;
}
void OAIWorldlineAtosFrankfurt::setMerchantCategoryCode(const QString &merchant_category_code) {
    m_merchant_category_code = merchant_category_code;
    m_merchant_category_code_isSet = true;
}

bool OAIWorldlineAtosFrankfurt::is_merchant_category_code_Set() const{
    return m_merchant_category_code_isSet;
}

bool OAIWorldlineAtosFrankfurt::is_merchant_category_code_Valid() const{
    return m_merchant_category_code_isValid;
}

OAIPaymentMethod OAIWorldlineAtosFrankfurt::getMethod() const {
    return m_method;
}
void OAIWorldlineAtosFrankfurt::setMethod(const OAIPaymentMethod &method) {
    m_method = method;
    m_method_isSet = true;
}

bool OAIWorldlineAtosFrankfurt::is_method_Set() const{
    return m_method_isSet;
}

bool OAIWorldlineAtosFrankfurt::is_method_Valid() const{
    return m_method_isValid;
}

double OAIWorldlineAtosFrankfurt::getMonthlyLimit() const {
    return m_monthly_limit;
}
void OAIWorldlineAtosFrankfurt::setMonthlyLimit(const double &monthly_limit) {
    m_monthly_limit = monthly_limit;
    m_monthly_limit_isSet = true;
}

bool OAIWorldlineAtosFrankfurt::is_monthly_limit_Set() const{
    return m_monthly_limit_isSet;
}

bool OAIWorldlineAtosFrankfurt::is_monthly_limit_Valid() const{
    return m_monthly_limit_isValid;
}

QString OAIWorldlineAtosFrankfurt::getOrganizationId() const {
    return m_organization_id;
}
void OAIWorldlineAtosFrankfurt::setOrganizationId(const QString &organization_id) {
    m_organization_id = organization_id;
    m_organization_id_isSet = true;
}

bool OAIWorldlineAtosFrankfurt::is_organization_id_Set() const{
    return m_organization_id_isSet;
}

bool OAIWorldlineAtosFrankfurt::is_organization_id_Valid() const{
    return m_organization_id_isValid;
}

QList<OAIPaymentCardBrand> OAIWorldlineAtosFrankfurt::getPaymentCardSchemes() const {
    return m_payment_card_schemes;
}
void OAIWorldlineAtosFrankfurt::setPaymentCardSchemes(const QList<OAIPaymentCardBrand> &payment_card_schemes) {
    m_payment_card_schemes = payment_card_schemes;
    m_payment_card_schemes_isSet = true;
}

bool OAIWorldlineAtosFrankfurt::is_payment_card_schemes_Set() const{
    return m_payment_card_schemes_isSet;
}

bool OAIWorldlineAtosFrankfurt::is_payment_card_schemes_Valid() const{
    return m_payment_card_schemes_isValid;
}

bool OAIWorldlineAtosFrankfurt::isReconciliationWindowEnabled() const {
    return m_reconciliation_window_enabled;
}
void OAIWorldlineAtosFrankfurt::setReconciliationWindowEnabled(const bool &reconciliation_window_enabled) {
    m_reconciliation_window_enabled = reconciliation_window_enabled;
    m_reconciliation_window_enabled_isSet = true;
}

bool OAIWorldlineAtosFrankfurt::is_reconciliation_window_enabled_Set() const{
    return m_reconciliation_window_enabled_isSet;
}

bool OAIWorldlineAtosFrankfurt::is_reconciliation_window_enabled_Valid() const{
    return m_reconciliation_window_enabled_isValid;
}

qint32 OAIWorldlineAtosFrankfurt::getReconciliationWindowTtl() const {
    return m_reconciliation_window_ttl;
}
void OAIWorldlineAtosFrankfurt::setReconciliationWindowTtl(const qint32 &reconciliation_window_ttl) {
    m_reconciliation_window_ttl = reconciliation_window_ttl;
    m_reconciliation_window_ttl_isSet = true;
}

bool OAIWorldlineAtosFrankfurt::is_reconciliation_window_ttl_Set() const{
    return m_reconciliation_window_ttl_isSet;
}

bool OAIWorldlineAtosFrankfurt::is_reconciliation_window_ttl_Valid() const{
    return m_reconciliation_window_ttl_isValid;
}

QString OAIWorldlineAtosFrankfurt::getStatus() const {
    return m_status;
}
void OAIWorldlineAtosFrankfurt::setStatus(const QString &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIWorldlineAtosFrankfurt::is_status_Set() const{
    return m_status_isSet;
}

bool OAIWorldlineAtosFrankfurt::is_status_Valid() const{
    return m_status_isValid;
}

bool OAIWorldlineAtosFrankfurt::isSticky() const {
    return m_sticky;
}
void OAIWorldlineAtosFrankfurt::setSticky(const bool &sticky) {
    m_sticky = sticky;
    m_sticky_isSet = true;
}

bool OAIWorldlineAtosFrankfurt::is_sticky_Set() const{
    return m_sticky_isSet;
}

bool OAIWorldlineAtosFrankfurt::is_sticky_Valid() const{
    return m_sticky_isValid;
}

bool OAIWorldlineAtosFrankfurt::isThreeDSecure() const {
    return m_three_d_secure;
}
void OAIWorldlineAtosFrankfurt::setThreeDSecure(const bool &three_d_secure) {
    m_three_d_secure = three_d_secure;
    m_three_d_secure_isSet = true;
}

bool OAIWorldlineAtosFrankfurt::is_three_d_secure_Set() const{
    return m_three_d_secure_isSet;
}

bool OAIWorldlineAtosFrankfurt::is_three_d_secure_Valid() const{
    return m_three_d_secure_isValid;
}

qint32 OAIWorldlineAtosFrankfurt::getTimeout() const {
    return m_timeout;
}
void OAIWorldlineAtosFrankfurt::setTimeout(const qint32 &timeout) {
    m_timeout = timeout;
    m_timeout_isSet = true;
}

bool OAIWorldlineAtosFrankfurt::is_timeout_Set() const{
    return m_timeout_isSet;
}

bool OAIWorldlineAtosFrankfurt::is_timeout_Valid() const{
    return m_timeout_isValid;
}

QString OAIWorldlineAtosFrankfurt::getToken() const {
    return m_token;
}
void OAIWorldlineAtosFrankfurt::setToken(const QString &token) {
    m_token = token;
    m_token_isSet = true;
}

bool OAIWorldlineAtosFrankfurt::is_token_Set() const{
    return m_token_isSet;
}

bool OAIWorldlineAtosFrankfurt::is_token_Valid() const{
    return m_token_isValid;
}

QDateTime OAIWorldlineAtosFrankfurt::getUpdatedTime() const {
    return m_updated_time;
}
void OAIWorldlineAtosFrankfurt::setUpdatedTime(const QDateTime &updated_time) {
    m_updated_time = updated_time;
    m_updated_time_isSet = true;
}

bool OAIWorldlineAtosFrankfurt::is_updated_time_Set() const{
    return m_updated_time_isSet;
}

bool OAIWorldlineAtosFrankfurt::is_updated_time_Valid() const{
    return m_updated_time_isValid;
}

OAIWorldlineAtosFrankfurt_allOf_credentials OAIWorldlineAtosFrankfurt::getCredentials() const {
    return m_credentials;
}
void OAIWorldlineAtosFrankfurt::setCredentials(const OAIWorldlineAtosFrankfurt_allOf_credentials &credentials) {
    m_credentials = credentials;
    m_credentials_isSet = true;
}

bool OAIWorldlineAtosFrankfurt::is_credentials_Set() const{
    return m_credentials_isSet;
}

bool OAIWorldlineAtosFrankfurt::is_credentials_Valid() const{
    return m_credentials_isValid;
}

OAIWorldlineAtosFrankfurt_allOf_settings OAIWorldlineAtosFrankfurt::getSettings() const {
    return m_settings;
}
void OAIWorldlineAtosFrankfurt::setSettings(const OAIWorldlineAtosFrankfurt_allOf_settings &settings) {
    m_settings = settings;
    m_settings_isSet = true;
}

bool OAIWorldlineAtosFrankfurt::is_settings_Set() const{
    return m_settings_isSet;
}

bool OAIWorldlineAtosFrankfurt::is_settings_Valid() const{
    return m_settings_isValid;
}

OAIWorldlineAtosFrankfurt3dsServers OAIWorldlineAtosFrankfurt::getThreeDSecureServer() const {
    return m_three_d_secure_server;
}
void OAIWorldlineAtosFrankfurt::setThreeDSecureServer(const OAIWorldlineAtosFrankfurt3dsServers &three_d_secure_server) {
    m_three_d_secure_server = three_d_secure_server;
    m_three_d_secure_server_isSet = true;
}

bool OAIWorldlineAtosFrankfurt::is_three_d_secure_server_Set() const{
    return m_three_d_secure_server_isSet;
}

bool OAIWorldlineAtosFrankfurt::is_three_d_secure_server_Valid() const{
    return m_three_d_secure_server_isValid;
}

bool OAIWorldlineAtosFrankfurt::isSet() const {
...
bool OAIWorldlineAtosFrankfurt::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_accepted_currencies_isValid && m_gateway_name_isValid && m_method_isValid && m_credentials_isValid && m_settings_isValid && true;
}
