...
#ifndef OAIInvoiceIssue_H
#define OAIInvoiceIssue_H
...
class OAIInvoiceIssue : public OAIObject {
public:
    OAIInvoiceIssue();
    OAIInvoiceIssue(QString json);
    ~OAIInvoiceIssue() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIInvoiceIssue)

#endif // OAIInvoiceIssue_H
