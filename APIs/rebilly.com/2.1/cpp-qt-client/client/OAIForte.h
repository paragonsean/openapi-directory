...
class OAIForte_allOf_credentials;

class OAIForte : public OAIObject {
public:
    OAIForte();
    OAIForte(QString json);
    ~OAIForte() override;
    ...
    OAIForte_allOf_credentials getCredentials() const;
    void setCredentials(const OAIForte_allOf_credentials &credentials);
...
private:
    ...
    OAIForte_allOf_credentials m_credentials;
...
Q_DECLARE_METATYPE(OpenAPI::OAIForte)
