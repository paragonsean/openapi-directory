...
#ifndef OAISecureTrading_H
#define OAISecureTrading_H
...
#include "OAISecureTrading3dsServers.h"
#include "OAISecureTrading_allOf_credentials.h"
#include <QDateTime>
#include <QList>
#include <QString>
...
class OAISecureTrading_allOf_credentials;
class OAISecureTrading3dsServers;

class OAISecureTrading : public OAIObject {
public:
    OAISecureTrading();
    OAISecureTrading(QString json);
    ~OAISecureTrading() override;
    ...
    OAISecureTrading_allOf_credentials getCredentials() const;
    void setCredentials(const OAISecureTrading_allOf_credentials &credentials);
    bool is_credentials_Set() const;
    bool is_credentials_Valid() const;

    OAISecureTrading3dsServers getThreeDSecureServer() const;
    void setThreeDSecureServer(const OAISecureTrading3dsServers &three_d_secure_server);
...
private:
    ...
    OAISecureTrading_allOf_credentials m_credentials;
    bool m_credentials_isSet;
    bool m_credentials_isValid;

    OAISecureTrading3dsServers m_three_d_secure_server;
...
Q_DECLARE_METATYPE(OpenAPI::OAISecureTrading)

#endif // OAISecureTrading_H
