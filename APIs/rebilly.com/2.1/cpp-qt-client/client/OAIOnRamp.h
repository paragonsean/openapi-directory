...
class OAIOnRamp_allOf_credentials;

class OAIOnRamp : public OAIObject {
public:
    OAIOnRamp();
    OAIOnRamp(QString json);
    ~OAIOnRamp() override;
    ...
    OAIOnRamp_allOf_credentials getCredentials() const;
    void setCredentials(const OAIOnRamp_allOf_credentials &credentials);
...
private:
    ...
    OAIOnRamp_allOf_credentials m_credentials;
...
Q_DECLARE_METATYPE(OpenAPI::OAIOnRamp)
