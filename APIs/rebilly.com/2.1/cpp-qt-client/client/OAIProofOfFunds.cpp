...
OAIProofOfFunds::OAIProofOfFunds(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIProofOfFunds::OAIProofOfFunds() {
    this->initializeModel();
}

OAIProofOfFunds::~OAIProofOfFunds() {}

void OAIProofOfFunds::initializeModel() {
...
void OAIProofOfFunds::fromJson(QString jsonString) {
...
void OAIProofOfFunds::fromJsonObject(QJsonObject json) {
...
QString OAIProofOfFunds::asJson() const {
...
QJsonObject OAIProofOfFunds::asJsonObject() const {
    QJsonObject obj;
    if (m__links.size() > 0) {
...
QList<OAICommonKycDocument__links_inner> OAIProofOfFunds::getLinks() const {
    return m__links;
}
void OAIProofOfFunds::setLinks(const QList<OAICommonKycDocument__links_inner> &_links) {
    m__links = _links;
    m__links_isSet = true;
}

bool OAIProofOfFunds::is__links_Set() const{
    return m__links_isSet;
}

bool OAIProofOfFunds::is__links_Valid() const{
    return m__links_isValid;
}

QDateTime OAIProofOfFunds::getCreatedTime() const {
    return m_created_time;
}
void OAIProofOfFunds::setCreatedTime(const QDateTime &created_time) {
    m_created_time = created_time;
    m_created_time_isSet = true;
}

bool OAIProofOfFunds::is_created_time_Set() const{
    return m_created_time_isSet;
}

bool OAIProofOfFunds::is_created_time_Valid() const{
    return m_created_time_isValid;
}

OAIKycDocumentSubtypes OAIProofOfFunds::getDocumentSubtype() const {
    return m_document_subtype;
}
void OAIProofOfFunds::setDocumentSubtype(const OAIKycDocumentSubtypes &document_subtype) {
    m_document_subtype = document_subtype;
    m_document_subtype_isSet = true;
}

bool OAIProofOfFunds::is_document_subtype_Set() const{
    return m_document_subtype_isSet;
}

bool OAIProofOfFunds::is_document_subtype_Valid() const{
    return m_document_subtype_isValid;
}

OAIKycDocumentTypes OAIProofOfFunds::getDocumentType() const {
    return m_document_type;
}
void OAIProofOfFunds::setDocumentType(const OAIKycDocumentTypes &document_type) {
    m_document_type = document_type;
    m_document_type_isSet = true;
}

bool OAIProofOfFunds::is_document_type_Set() const{
    return m_document_type_isSet;
}

bool OAIProofOfFunds::is_document_type_Valid() const{
    return m_document_type_isValid;
}

QString OAIProofOfFunds::getFileId() const {
    return m_file_id;
}
void OAIProofOfFunds::setFileId(const QString &file_id) {
    m_file_id = file_id;
    m_file_id_isSet = true;
}

bool OAIProofOfFunds::is_file_id_Set() const{
    return m_file_id_isSet;
}

bool OAIProofOfFunds::is_file_id_Valid() const{
    return m_file_id_isValid;
}

QList<QString> OAIProofOfFunds::getFileIds() const {
    return m_file_ids;
}
void OAIProofOfFunds::setFileIds(const QList<QString> &file_ids) {
    m_file_ids = file_ids;
    m_file_ids_isSet = true;
}

bool OAIProofOfFunds::is_file_ids_Set() const{
    return m_file_ids_isSet;
}

bool OAIProofOfFunds::is_file_ids_Valid() const{
    return m_file_ids_isValid;
}

QString OAIProofOfFunds::getId() const {
    return m_id;
}
void OAIProofOfFunds::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIProofOfFunds::is_id_Set() const{
    return m_id_isSet;
}

bool OAIProofOfFunds::is_id_Valid() const{
    return m_id_isValid;
}

QDateTime OAIProofOfFunds::getProcessedTime() const {
    return m_processed_time;
}
void OAIProofOfFunds::setProcessedTime(const QDateTime &processed_time) {
    m_processed_time = processed_time;
    m_processed_time_isSet = true;
}

bool OAIProofOfFunds::is_processed_time_Set() const{
    return m_processed_time_isSet;
}

bool OAIProofOfFunds::is_processed_time_Valid() const{
    return m_processed_time_isValid;
}

OAIKycDocumentRejection OAIProofOfFunds::getRejectionReason() const {
    return m_rejection_reason;
}
void OAIProofOfFunds::setRejectionReason(const OAIKycDocumentRejection &rejection_reason) {
    m_rejection_reason = rejection_reason;
    m_rejection_reason_isSet = true;
}

bool OAIProofOfFunds::is_rejection_reason_Set() const{
    return m_rejection_reason_isSet;
}

bool OAIProofOfFunds::is_rejection_reason_Valid() const{
    return m_rejection_reason_isValid;
}

QString OAIProofOfFunds::getRequestId() const {
    return m_request_id;
}
void OAIProofOfFunds::setRequestId(const QString &request_id) {
    m_request_id = request_id;
    m_request_id_isSet = true;
}

bool OAIProofOfFunds::is_request_id_Set() const{
    return m_request_id_isSet;
}

bool OAIProofOfFunds::is_request_id_Valid() const{
    return m_request_id_isValid;
}

QString OAIProofOfFunds::getStatus() const {
    return m_status;
}
void OAIProofOfFunds::setStatus(const QString &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIProofOfFunds::is_status_Set() const{
    return m_status_isSet;
}

bool OAIProofOfFunds::is_status_Valid() const{
    return m_status_isValid;
}

QDateTime OAIProofOfFunds::getUpdatedTime() const {
    return m_updated_time;
}
void OAIProofOfFunds::setUpdatedTime(const QDateTime &updated_time) {
    m_updated_time = updated_time;
    m_updated_time_isSet = true;
}

bool OAIProofOfFunds::is_updated_time_Set() const{
    return m_updated_time_isSet;
}

bool OAIProofOfFunds::is_updated_time_Valid() const{
    return m_updated_time_isValid;
}

QString OAIProofOfFunds::getCustomerId() const {
    return m_customer_id;
}
void OAIProofOfFunds::setCustomerId(const QString &customer_id) {
    m_customer_id = customer_id;
    m_customer_id_isSet = true;
}

bool OAIProofOfFunds::is_customer_id_Set() const{
    return m_customer_id_isSet;
}

bool OAIProofOfFunds::is_customer_id_Valid() const{
    return m_customer_id_isValid;
}

qint32 OAIProofOfFunds::getMatchLevel() const {
    return m_match_level;
}
void OAIProofOfFunds::setMatchLevel(const qint32 &match_level) {
    m_match_level = match_level;
    m_match_level_isSet = true;
}

bool OAIProofOfFunds::is_match_level_Set() const{
    return m_match_level_isSet;
}

bool OAIProofOfFunds::is_match_level_Valid() const{
    return m_match_level_isValid;
}

QString OAIProofOfFunds::getNotes() const {
    return m_notes;
}
void OAIProofOfFunds::setNotes(const QString &notes) {
    m_notes = notes;
    m_notes_isSet = true;
}

bool OAIProofOfFunds::is_notes_Set() const{
    return m_notes_isSet;
}

bool OAIProofOfFunds::is_notes_Valid() const{
    return m_notes_isValid;
}

QString OAIProofOfFunds::getReason() const {
    return m_reason;
}
void OAIProofOfFunds::setReason(const QString &reason) {
    m_reason = reason;
    m_reason_isSet = true;
}

bool OAIProofOfFunds::is_reason_Set() const{
    return m_reason_isSet;
}

bool OAIProofOfFunds::is_reason_Valid() const{
    return m_reason_isValid;
}

QDateTime OAIProofOfFunds::getReviewTime() const {
    return m_review_time;
}
void OAIProofOfFunds::setReviewTime(const QDateTime &review_time) {
    m_review_time = review_time;
    m_review_time_isSet = true;
}

bool OAIProofOfFunds::is_review_time_Set() const{
    return m_review_time_isSet;
}

bool OAIProofOfFunds::is_review_time_Valid() const{
    return m_review_time_isValid;
}

QString OAIProofOfFunds::getReviewerId() const {
    return m_reviewer_id;
}
void OAIProofOfFunds::setReviewerId(const QString &reviewer_id) {
    m_reviewer_id = reviewer_id;
    m_reviewer_id_isSet = true;
}

bool OAIProofOfFunds::is_reviewer_id_Set() const{
    return m_reviewer_id_isSet;
}

bool OAIProofOfFunds::is_reviewer_id_Valid() const{
    return m_reviewer_id_isValid;
}

QString OAIProofOfFunds::getReviewerName() const {
    return m_reviewer_name;
}
void OAIProofOfFunds::setReviewerName(const QString &reviewer_name) {
    m_reviewer_name = reviewer_name;
    m_reviewer_name_isSet = true;
}

bool OAIProofOfFunds::is_reviewer_name_Set() const{
    return m_reviewer_name_isSet;
}

bool OAIProofOfFunds::is_reviewer_name_Valid() const{
    return m_reviewer_name_isValid;
}

bool OAIProofOfFunds::isSet() const {
...
bool OAIProofOfFunds::isValid() const {
