...
OAICitadel::OAICitadel(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICitadel::OAICitadel() {
    this->initializeModel();
}

OAICitadel::~OAICitadel() {}

void OAICitadel::initializeModel() {
...
void OAICitadel::fromJson(QString jsonString) {
...
void OAICitadel::fromJsonObject(QJsonObject json) {
...
QString OAICitadel::asJson() const {
...
QJsonObject OAICitadel::asJsonObject() const {
    QJsonObject obj;
    if (m__links.size() > 0) {
...
QList<OAIGatewayAccount__links_inner> OAICitadel::getLinks() const {
    return m__links;
}
void OAICitadel::setLinks(const QList<OAIGatewayAccount__links_inner> &_links) {
    m__links = _links;
    m__links_isSet = true;
}

bool OAICitadel::is__links_Set() const{
    return m__links_isSet;
}

bool OAICitadel::is__links_Valid() const{
    return m__links_isValid;
}

QList<QString> OAICitadel::getAcceptedCurrencies() const {
    return m_accepted_currencies;
}
void OAICitadel::setAcceptedCurrencies(const QList<QString> &accepted_currencies) {
    m_accepted_currencies = accepted_currencies;
    m_accepted_currencies_isSet = true;
}

bool OAICitadel::is_accepted_currencies_Set() const{
    return m_accepted_currencies_isSet;
}

bool OAICitadel::is_accepted_currencies_Valid() const{
    return m_accepted_currencies_isValid;
}

OAIAcquirerName OAICitadel::getAcquirerName() const {
    return m_acquirer_name;
}
void OAICitadel::setAcquirerName(const OAIAcquirerName &acquirer_name) {
    m_acquirer_name = acquirer_name;
    m_acquirer_name_isSet = true;
}

bool OAICitadel::is_acquirer_name_Set() const{
    return m_acquirer_name_isSet;
}

bool OAICitadel::is_acquirer_name_Valid() const{
    return m_acquirer_name_isValid;
}

QString OAICitadel::getAdditionalFilters() const {
    return m_additional_filters;
}
void OAICitadel::setAdditionalFilters(const QString &additional_filters) {
    m_additional_filters = additional_filters;
    m_additional_filters_isSet = true;
}

bool OAICitadel::is_additional_filters_Set() const{
    return m_additional_filters_isSet;
}

bool OAICitadel::is_additional_filters_Valid() const{
    return m_additional_filters_isValid;
}

qint32 OAICitadel::getApprovalWindowTtl() const {
    return m_approval_window_ttl;
}
void OAICitadel::setApprovalWindowTtl(const qint32 &approval_window_ttl) {
    m_approval_window_ttl = approval_window_ttl;
    m_approval_window_ttl_isSet = true;
}

bool OAICitadel::is_approval_window_ttl_Set() const{
    return m_approval_window_ttl_isSet;
}

bool OAICitadel::is_approval_window_ttl_Valid() const{
    return m_approval_window_ttl_isValid;
}

QString OAICitadel::getCityField() const {
    return m_city_field;
}
void OAICitadel::setCityField(const QString &city_field) {
    m_city_field = city_field;
    m_city_field_isSet = true;
}

bool OAICitadel::is_city_field_Set() const{
    return m_city_field_isSet;
}

bool OAICitadel::is_city_field_Valid() const{
    return m_city_field_isValid;
}

QDateTime OAICitadel::getCreatedTime() const {
    return m_created_time;
}
void OAICitadel::setCreatedTime(const QDateTime &created_time) {
    m_created_time = created_time;
    m_created_time_isSet = true;
}

bool OAICitadel::is_created_time_Set() const{
    return m_created_time_isSet;
}

bool OAICitadel::is_created_time_Valid() const{
    return m_created_time_isValid;
}

QString OAICitadel::getDccForceCurrency() const {
    return m_dcc_force_currency;
}
void OAICitadel::setDccForceCurrency(const QString &dcc_force_currency) {
    m_dcc_force_currency = dcc_force_currency;
    m_dcc_force_currency_isSet = true;
}

bool OAICitadel::is_dcc_force_currency_Set() const{
    return m_dcc_force_currency_isSet;
}

bool OAICitadel::is_dcc_force_currency_Valid() const{
    return m_dcc_force_currency_isValid;
}

qint32 OAICitadel::getDccMarkup() const {
    return m_dcc_markup;
}
void OAICitadel::setDccMarkup(const qint32 &dcc_markup) {
    m_dcc_markup = dcc_markup;
    m_dcc_markup_isSet = true;
}

bool OAICitadel::is_dcc_markup_Set() const{
    return m_dcc_markup_isSet;
}

bool OAICitadel::is_dcc_markup_Valid() const{
    return m_dcc_markup_isValid;
}

QString OAICitadel::getDescriptor() const {
    return m_descriptor;
}
void OAICitadel::setDescriptor(const QString &descriptor) {
    m_descriptor = descriptor;
    m_descriptor_isSet = true;
}

bool OAICitadel::is_descriptor_Set() const{
    return m_descriptor_isSet;
}

bool OAICitadel::is_descriptor_Valid() const{
    return m_descriptor_isValid;
}

OAIDigitalWallets OAICitadel::getDigitalWallets() const {
    return m_digital_wallets;
}
void OAICitadel::setDigitalWallets(const OAIDigitalWallets &digital_wallets) {
    m_digital_wallets = digital_wallets;
    m_digital_wallets_isSet = true;
}

bool OAICitadel::is_digital_wallets_Set() const{
    return m_digital_wallets_isSet;
}

bool OAICitadel::is_digital_wallets_Valid() const{
    return m_digital_wallets_isValid;
}

bool OAICitadel::isDynamicDescriptor() const {
    return m_dynamic_descriptor;
}
void OAICitadel::setDynamicDescriptor(const bool &dynamic_descriptor) {
    m_dynamic_descriptor = dynamic_descriptor;
    m_dynamic_descriptor_isSet = true;
}

bool OAICitadel::is_dynamic_descriptor_Set() const{
    return m_dynamic_descriptor_isSet;
}

bool OAICitadel::is_dynamic_descriptor_Valid() const{
    return m_dynamic_descriptor_isValid;
}

QList<QString> OAICitadel::getExcludedDccQuoteCurrencies() const {
    return m_excluded_dcc_quote_currencies;
}
void OAICitadel::setExcludedDccQuoteCurrencies(const QList<QString> &excluded_dcc_quote_currencies) {
    m_excluded_dcc_quote_currencies = excluded_dcc_quote_currencies;
    m_excluded_dcc_quote_currencies_isSet = true;
}

bool OAICitadel::is_excluded_dcc_quote_currencies_Set() const{
    return m_excluded_dcc_quote_currencies_isSet;
}

bool OAICitadel::is_excluded_dcc_quote_currencies_Valid() const{
    return m_excluded_dcc_quote_currencies_isValid;
}

OAIGatewayName OAICitadel::getGatewayName() const {
    return m_gateway_name;
}
void OAICitadel::setGatewayName(const OAIGatewayName &gateway_name) {
    m_gateway_name = gateway_name;
    m_gateway_name_isSet = true;
}

bool OAICitadel::is_gateway_name_Set() const{
    return m_gateway_name_isSet;
}

bool OAICitadel::is_gateway_name_Valid() const{
    return m_gateway_name_isValid;
}

QString OAICitadel::getId() const {
    return m_id;
}
void OAICitadel::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAICitadel::is_id_Set() const{
    return m_id_isSet;
}

bool OAICitadel::is_id_Valid() const{
    return m_id_isValid;
}

bool OAICitadel::isIsDown() const {
    return m_is_down;
}
void OAICitadel::setIsDown(const bool &is_down) {
    m_is_down = is_down;
    m_is_down_isSet = true;
}

bool OAICitadel::is_is_down_Set() const{
    return m_is_down_isSet;
}

bool OAICitadel::is_is_down_Valid() const{
    return m_is_down_isValid;
}

QString OAICitadel::getMerchantCategoryCode() const {
    return m_merchant_category_code;
}
void OAICitadel::setMerchantCategoryCode(const QString &merchant_category_code) {
    m_merchant_category_code = merchant_category_code;
    m_merchant_category_code_isSet = true;
}

bool OAICitadel::is_merchant_category_code_Set() const{
    return m_merchant_category_code_isSet;
}

bool OAICitadel::is_merchant_category_code_Valid() const{
    return m_merchant_category_code_isValid;
}

OAIPaymentMethod OAICitadel::getMethod() const {
    return m_method;
}
void OAICitadel::setMethod(const OAIPaymentMethod &method) {
    m_method = method;
    m_method_isSet = true;
}

bool OAICitadel::is_method_Set() const{
    return m_method_isSet;
}

bool OAICitadel::is_method_Valid() const{
    return m_method_isValid;
}

double OAICitadel::getMonthlyLimit() const {
    return m_monthly_limit;
}
void OAICitadel::setMonthlyLimit(const double &monthly_limit) {
    m_monthly_limit = monthly_limit;
    m_monthly_limit_isSet = true;
}

bool OAICitadel::is_monthly_limit_Set() const{
    return m_monthly_limit_isSet;
}

bool OAICitadel::is_monthly_limit_Valid() const{
    return m_monthly_limit_isValid;
}

QString OAICitadel::getOrganizationId() const {
    return m_organization_id;
}
void OAICitadel::setOrganizationId(const QString &organization_id) {
    m_organization_id = organization_id;
    m_organization_id_isSet = true;
}

bool OAICitadel::is_organization_id_Set() const{
    return m_organization_id_isSet;
}

bool OAICitadel::is_organization_id_Valid() const{
    return m_organization_id_isValid;
}

QList<OAIPaymentCardBrand> OAICitadel::getPaymentCardSchemes() const {
    return m_payment_card_schemes;
}
void OAICitadel::setPaymentCardSchemes(const QList<OAIPaymentCardBrand> &payment_card_schemes) {
    m_payment_card_schemes = payment_card_schemes;
    m_payment_card_schemes_isSet = true;
}

bool OAICitadel::is_payment_card_schemes_Set() const{
    return m_payment_card_schemes_isSet;
}

bool OAICitadel::is_payment_card_schemes_Valid() const{
    return m_payment_card_schemes_isValid;
}

bool OAICitadel::isReconciliationWindowEnabled() const {
    return m_reconciliation_window_enabled;
}
void OAICitadel::setReconciliationWindowEnabled(const bool &reconciliation_window_enabled) {
    m_reconciliation_window_enabled = reconciliation_window_enabled;
    m_reconciliation_window_enabled_isSet = true;
}

bool OAICitadel::is_reconciliation_window_enabled_Set() const{
    return m_reconciliation_window_enabled_isSet;
}

bool OAICitadel::is_reconciliation_window_enabled_Valid() const{
    return m_reconciliation_window_enabled_isValid;
}

qint32 OAICitadel::getReconciliationWindowTtl() const {
    return m_reconciliation_window_ttl;
}
void OAICitadel::setReconciliationWindowTtl(const qint32 &reconciliation_window_ttl) {
    m_reconciliation_window_ttl = reconciliation_window_ttl;
    m_reconciliation_window_ttl_isSet = true;
}

bool OAICitadel::is_reconciliation_window_ttl_Set() const{
    return m_reconciliation_window_ttl_isSet;
}

bool OAICitadel::is_reconciliation_window_ttl_Valid() const{
    return m_reconciliation_window_ttl_isValid;
}

QString OAICitadel::getStatus() const {
    return m_status;
}
void OAICitadel::setStatus(const QString &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAICitadel::is_status_Set() const{
    return m_status_isSet;
}

bool OAICitadel::is_status_Valid() const{
    return m_status_isValid;
}

bool OAICitadel::isSticky() const {
    return m_sticky;
}
void OAICitadel::setSticky(const bool &sticky) {
    m_sticky = sticky;
    m_sticky_isSet = true;
}

bool OAICitadel::is_sticky_Set() const{
    return m_sticky_isSet;
}

bool OAICitadel::is_sticky_Valid() const{
    return m_sticky_isValid;
}

bool OAICitadel::isThreeDSecure() const {
    return m_three_d_secure;
}
void OAICitadel::setThreeDSecure(const bool &three_d_secure) {
    m_three_d_secure = three_d_secure;
    m_three_d_secure_isSet = true;
}

bool OAICitadel::is_three_d_secure_Set() const{
    return m_three_d_secure_isSet;
}

bool OAICitadel::is_three_d_secure_Valid() const{
    return m_three_d_secure_isValid;
}

qint32 OAICitadel::getTimeout() const {
    return m_timeout;
}
void OAICitadel::setTimeout(const qint32 &timeout) {
    m_timeout = timeout;
    m_timeout_isSet = true;
}

bool OAICitadel::is_timeout_Set() const{
    return m_timeout_isSet;
}

bool OAICitadel::is_timeout_Valid() const{
    return m_timeout_isValid;
}

QString OAICitadel::getToken() const {
    return m_token;
}
void OAICitadel::setToken(const QString &token) {
    m_token = token;
    m_token_isSet = true;
}

bool OAICitadel::is_token_Set() const{
    return m_token_isSet;
}

bool OAICitadel::is_token_Valid() const{
    return m_token_isValid;
}

QDateTime OAICitadel::getUpdatedTime() const {
    return m_updated_time;
}
void OAICitadel::setUpdatedTime(const QDateTime &updated_time) {
    m_updated_time = updated_time;
    m_updated_time_isSet = true;
}

bool OAICitadel::is_updated_time_Set() const{
    return m_updated_time_isSet;
}

bool OAICitadel::is_updated_time_Valid() const{
    return m_updated_time_isValid;
}

OAICitadel_allOf_credentials OAICitadel::getCredentials() const {
    return m_credentials;
}
void OAICitadel::setCredentials(const OAICitadel_allOf_credentials &credentials) {
    m_credentials = credentials;
    m_credentials_isSet = true;
}

bool OAICitadel::is_credentials_Set() const{
    return m_credentials_isSet;
}

bool OAICitadel::is_credentials_Valid() const{
    return m_credentials_isValid;
}

bool OAICitadel::isSet() const {
