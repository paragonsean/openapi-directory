...
/*
 * OAIPiastrix_allOf_credentials.h
 *
 * Piastrix credentials object.
 */

#ifndef OAIPiastrix_allOf_credentials_H
#define OAIPiastrix_allOf_credentials_H
...
class OAIPiastrix_allOf_credentials : public OAIObject {
public:
    OAIPiastrix_allOf_credentials();
    OAIPiastrix_allOf_credentials(QString json);
    ~OAIPiastrix_allOf_credentials() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPiastrix_allOf_credentials)

#endif // OAIPiastrix_allOf_credentials_H
