...
#ifndef OAITrustsPay_H
#define OAITrustsPay_H
...
class OAITrustsPay_allOf_credentials;

class OAITrustsPay : public OAIObject {
public:
    OAITrustsPay();
    OAITrustsPay(QString json);
    ~OAITrustsPay() override;
    ...
    OAITrustsPay_allOf_credentials getCredentials() const;
    void setCredentials(const OAITrustsPay_allOf_credentials &credentials);
...
private:
    ...
    OAITrustsPay_allOf_credentials m_credentials;
...
Q_DECLARE_METATYPE(OpenAPI::OAITrustsPay)

#endif // OAITrustsPay_H
