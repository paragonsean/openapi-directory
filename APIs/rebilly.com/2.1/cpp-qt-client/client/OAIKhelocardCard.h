...
#ifndef OAIKhelocardCard_H
#define OAIKhelocardCard_H
...
class OAIKhelocardCard : public OAIObject {
public:
    OAIKhelocardCard();
    OAIKhelocardCard(QString json);
    ~OAIKhelocardCard() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIKhelocardCard)

#endif // OAIKhelocardCard_H
