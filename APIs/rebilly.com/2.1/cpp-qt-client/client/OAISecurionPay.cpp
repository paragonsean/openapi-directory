...
OAISecurionPay::OAISecurionPay(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISecurionPay::OAISecurionPay() {
    this->initializeModel();
}

OAISecurionPay::~OAISecurionPay() {}

void OAISecurionPay::initializeModel() {
...
void OAISecurionPay::fromJson(QString jsonString) {
...
void OAISecurionPay::fromJsonObject(QJsonObject json) {
...
QString OAISecurionPay::asJson() const {
...
QJsonObject OAISecurionPay::asJsonObject() const {
    QJsonObject obj;
    if (m__links.size() > 0) {
...
QList<OAIGatewayAccount__links_inner> OAISecurionPay::getLinks() const {
    return m__links;
}
void OAISecurionPay::setLinks(const QList<OAIGatewayAccount__links_inner> &_links) {
    m__links = _links;
    m__links_isSet = true;
}

bool OAISecurionPay::is__links_Set() const{
    return m__links_isSet;
}

bool OAISecurionPay::is__links_Valid() const{
    return m__links_isValid;
}

QList<QString> OAISecurionPay::getAcceptedCurrencies() const {
    return m_accepted_currencies;
}
void OAISecurionPay::setAcceptedCurrencies(const QList<QString> &accepted_currencies) {
    m_accepted_currencies = accepted_currencies;
    m_accepted_currencies_isSet = true;
}

bool OAISecurionPay::is_accepted_currencies_Set() const{
    return m_accepted_currencies_isSet;
}

bool OAISecurionPay::is_accepted_currencies_Valid() const{
    return m_accepted_currencies_isValid;
}

OAIAcquirerName OAISecurionPay::getAcquirerName() const {
    return m_acquirer_name;
}
void OAISecurionPay::setAcquirerName(const OAIAcquirerName &acquirer_name) {
    m_acquirer_name = acquirer_name;
    m_acquirer_name_isSet = true;
}

bool OAISecurionPay::is_acquirer_name_Set() const{
    return m_acquirer_name_isSet;
}

bool OAISecurionPay::is_acquirer_name_Valid() const{
    return m_acquirer_name_isValid;
}

QString OAISecurionPay::getAdditionalFilters() const {
    return m_additional_filters;
}
void OAISecurionPay::setAdditionalFilters(const QString &additional_filters) {
    m_additional_filters = additional_filters;
    m_additional_filters_isSet = true;
}

bool OAISecurionPay::is_additional_filters_Set() const{
    return m_additional_filters_isSet;
}

bool OAISecurionPay::is_additional_filters_Valid() const{
    return m_additional_filters_isValid;
}

qint32 OAISecurionPay::getApprovalWindowTtl() const {
    return m_approval_window_ttl;
}
void OAISecurionPay::setApprovalWindowTtl(const qint32 &approval_window_ttl) {
    m_approval_window_ttl = approval_window_ttl;
    m_approval_window_ttl_isSet = true;
}

bool OAISecurionPay::is_approval_window_ttl_Set() const{
    return m_approval_window_ttl_isSet;
}

bool OAISecurionPay::is_approval_window_ttl_Valid() const{
    return m_approval_window_ttl_isValid;
}

QString OAISecurionPay::getCityField() const {
    return m_city_field;
}
void OAISecurionPay::setCityField(const QString &city_field) {
    m_city_field = city_field;
    m_city_field_isSet = true;
}

bool OAISecurionPay::is_city_field_Set() const{
    return m_city_field_isSet;
}

bool OAISecurionPay::is_city_field_Valid() const{
    return m_city_field_isValid;
}

QDateTime OAISecurionPay::getCreatedTime() const {
    return m_created_time;
}
void OAISecurionPay::setCreatedTime(const QDateTime &created_time) {
    m_created_time = created_time;
    m_created_time_isSet = true;
}

bool OAISecurionPay::is_created_time_Set() const{
    return m_created_time_isSet;
}

bool OAISecurionPay::is_created_time_Valid() const{
    return m_created_time_isValid;
}

QString OAISecurionPay::getDccForceCurrency() const {
    return m_dcc_force_currency;
}
void OAISecurionPay::setDccForceCurrency(const QString &dcc_force_currency) {
    m_dcc_force_currency = dcc_force_currency;
    m_dcc_force_currency_isSet = true;
}

bool OAISecurionPay::is_dcc_force_currency_Set() const{
    return m_dcc_force_currency_isSet;
}

bool OAISecurionPay::is_dcc_force_currency_Valid() const{
    return m_dcc_force_currency_isValid;
}

qint32 OAISecurionPay::getDccMarkup() const {
    return m_dcc_markup;
}
void OAISecurionPay::setDccMarkup(const qint32 &dcc_markup) {
    m_dcc_markup = dcc_markup;
    m_dcc_markup_isSet = true;
}

bool OAISecurionPay::is_dcc_markup_Set() const{
    return m_dcc_markup_isSet;
}

bool OAISecurionPay::is_dcc_markup_Valid() const{
    return m_dcc_markup_isValid;
}

QString OAISecurionPay::getDescriptor() const {
    return m_descriptor;
}
void OAISecurionPay::setDescriptor(const QString &descriptor) {
    m_descriptor = descriptor;
    m_descriptor_isSet = true;
}

bool OAISecurionPay::is_descriptor_Set() const{
    return m_descriptor_isSet;
}

bool OAISecurionPay::is_descriptor_Valid() const{
    return m_descriptor_isValid;
}

OAIDigitalWallets OAISecurionPay::getDigitalWallets() const {
    return m_digital_wallets;
}
void OAISecurionPay::setDigitalWallets(const OAIDigitalWallets &digital_wallets) {
    m_digital_wallets = digital_wallets;
    m_digital_wallets_isSet = true;
}

bool OAISecurionPay::is_digital_wallets_Set() const{
    return m_digital_wallets_isSet;
}

bool OAISecurionPay::is_digital_wallets_Valid() const{
    return m_digital_wallets_isValid;
}

bool OAISecurionPay::isDynamicDescriptor() const {
    return m_dynamic_descriptor;
}
void OAISecurionPay::setDynamicDescriptor(const bool &dynamic_descriptor) {
    m_dynamic_descriptor = dynamic_descriptor;
    m_dynamic_descriptor_isSet = true;
}

bool OAISecurionPay::is_dynamic_descriptor_Set() const{
    return m_dynamic_descriptor_isSet;
}

bool OAISecurionPay::is_dynamic_descriptor_Valid() const{
    return m_dynamic_descriptor_isValid;
}

QList<QString> OAISecurionPay::getExcludedDccQuoteCurrencies() const {
    return m_excluded_dcc_quote_currencies;
}
void OAISecurionPay::setExcludedDccQuoteCurrencies(const QList<QString> &excluded_dcc_quote_currencies) {
    m_excluded_dcc_quote_currencies = excluded_dcc_quote_currencies;
    m_excluded_dcc_quote_currencies_isSet = true;
}

bool OAISecurionPay::is_excluded_dcc_quote_currencies_Set() const{
    return m_excluded_dcc_quote_currencies_isSet;
}

bool OAISecurionPay::is_excluded_dcc_quote_currencies_Valid() const{
    return m_excluded_dcc_quote_currencies_isValid;
}

OAIGatewayName OAISecurionPay::getGatewayName() const {
    return m_gateway_name;
}
void OAISecurionPay::setGatewayName(const OAIGatewayName &gateway_name) {
    m_gateway_name = gateway_name;
    m_gateway_name_isSet = true;
}

bool OAISecurionPay::is_gateway_name_Set() const{
    return m_gateway_name_isSet;
}

bool OAISecurionPay::is_gateway_name_Valid() const{
    return m_gateway_name_isValid;
}

QString OAISecurionPay::getId() const {
    return m_id;
}
void OAISecurionPay::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAISecurionPay::is_id_Set() const{
    return m_id_isSet;
}

bool OAISecurionPay::is_id_Valid() const{
    return m_id_isValid;
}

bool OAISecurionPay::isIsDown() const {
    return m_is_down;
}
void OAISecurionPay::setIsDown(const bool &is_down) {
    m_is_down = is_down;
    m_is_down_isSet = true;
}

bool OAISecurionPay::is_is_down_Set() const{
    return m_is_down_isSet;
}

bool OAISecurionPay::is_is_down_Valid() const{
    return m_is_down_isValid;
}

QString OAISecurionPay::getMerchantCategoryCode() const {
    return m_merchant_category_code;
}
void OAISecurionPay::setMerchantCategoryCode(const QString &merchant_category_code) {
    m_merchant_category_code = merchant_category_code;
    m_merchant_category_code_isSet = true;
}

bool OAISecurionPay::is_merchant_category_code_Set() const{
    return m_merchant_category_code_isSet;
}

bool OAISecurionPay::is_merchant_category_code_Valid() const{
    return m_merchant_category_code_isValid;
}

OAIPaymentMethod OAISecurionPay::getMethod() const {
    return m_method;
}
void OAISecurionPay::setMethod(const OAIPaymentMethod &method) {
    m_method = method;
    m_method_isSet = true;
}

bool OAISecurionPay::is_method_Set() const{
    return m_method_isSet;
}

bool OAISecurionPay::is_method_Valid() const{
    return m_method_isValid;
}

double OAISecurionPay::getMonthlyLimit() const {
    return m_monthly_limit;
}
void OAISecurionPay::setMonthlyLimit(const double &monthly_limit) {
    m_monthly_limit = monthly_limit;
    m_monthly_limit_isSet = true;
}

bool OAISecurionPay::is_monthly_limit_Set() const{
    return m_monthly_limit_isSet;
}

bool OAISecurionPay::is_monthly_limit_Valid() const{
    return m_monthly_limit_isValid;
}

QString OAISecurionPay::getOrganizationId() const {
    return m_organization_id;
}
void OAISecurionPay::setOrganizationId(const QString &organization_id) {
    m_organization_id = organization_id;
    m_organization_id_isSet = true;
}

bool OAISecurionPay::is_organization_id_Set() const{
    return m_organization_id_isSet;
}

bool OAISecurionPay::is_organization_id_Valid() const{
    return m_organization_id_isValid;
}

QList<OAIPaymentCardBrand> OAISecurionPay::getPaymentCardSchemes() const {
    return m_payment_card_schemes;
}
void OAISecurionPay::setPaymentCardSchemes(const QList<OAIPaymentCardBrand> &payment_card_schemes) {
    m_payment_card_schemes = payment_card_schemes;
    m_payment_card_schemes_isSet = true;
}

bool OAISecurionPay::is_payment_card_schemes_Set() const{
    return m_payment_card_schemes_isSet;
}

bool OAISecurionPay::is_payment_card_schemes_Valid() const{
    return m_payment_card_schemes_isValid;
}

bool OAISecurionPay::isReconciliationWindowEnabled() const {
    return m_reconciliation_window_enabled;
}
void OAISecurionPay::setReconciliationWindowEnabled(const bool &reconciliation_window_enabled) {
    m_reconciliation_window_enabled = reconciliation_window_enabled;
    m_reconciliation_window_enabled_isSet = true;
}

bool OAISecurionPay::is_reconciliation_window_enabled_Set() const{
    return m_reconciliation_window_enabled_isSet;
}

bool OAISecurionPay::is_reconciliation_window_enabled_Valid() const{
    return m_reconciliation_window_enabled_isValid;
}

qint32 OAISecurionPay::getReconciliationWindowTtl() const {
    return m_reconciliation_window_ttl;
}
void OAISecurionPay::setReconciliationWindowTtl(const qint32 &reconciliation_window_ttl) {
    m_reconciliation_window_ttl = reconciliation_window_ttl;
    m_reconciliation_window_ttl_isSet = true;
}

bool OAISecurionPay::is_reconciliation_window_ttl_Set() const{
    return m_reconciliation_window_ttl_isSet;
}

bool OAISecurionPay::is_reconciliation_window_ttl_Valid() const{
    return m_reconciliation_window_ttl_isValid;
}

QString OAISecurionPay::getStatus() const {
    return m_status;
}
void OAISecurionPay::setStatus(const QString &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAISecurionPay::is_status_Set() const{
    return m_status_isSet;
}

bool OAISecurionPay::is_status_Valid() const{
    return m_status_isValid;
}

bool OAISecurionPay::isSticky() const {
    return m_sticky;
}
void OAISecurionPay::setSticky(const bool &sticky) {
    m_sticky = sticky;
    m_sticky_isSet = true;
}

bool OAISecurionPay::is_sticky_Set() const{
    return m_sticky_isSet;
}

bool OAISecurionPay::is_sticky_Valid() const{
    return m_sticky_isValid;
}

bool OAISecurionPay::isThreeDSecure() const {
    return m_three_d_secure;
}
void OAISecurionPay::setThreeDSecure(const bool &three_d_secure) {
    m_three_d_secure = three_d_secure;
    m_three_d_secure_isSet = true;
}

bool OAISecurionPay::is_three_d_secure_Set() const{
    return m_three_d_secure_isSet;
}

bool OAISecurionPay::is_three_d_secure_Valid() const{
    return m_three_d_secure_isValid;
}

qint32 OAISecurionPay::getTimeout() const {
    return m_timeout;
}
void OAISecurionPay::setTimeout(const qint32 &timeout) {
    m_timeout = timeout;
    m_timeout_isSet = true;
}

bool OAISecurionPay::is_timeout_Set() const{
    return m_timeout_isSet;
}

bool OAISecurionPay::is_timeout_Valid() const{
    return m_timeout_isValid;
}

QString OAISecurionPay::getToken() const {
    return m_token;
}
void OAISecurionPay::setToken(const QString &token) {
    m_token = token;
    m_token_isSet = true;
}

bool OAISecurionPay::is_token_Set() const{
    return m_token_isSet;
}

bool OAISecurionPay::is_token_Valid() const{
    return m_token_isValid;
}

QDateTime OAISecurionPay::getUpdatedTime() const {
    return m_updated_time;
}
void OAISecurionPay::setUpdatedTime(const QDateTime &updated_time) {
    m_updated_time = updated_time;
    m_updated_time_isSet = true;
}

bool OAISecurionPay::is_updated_time_Set() const{
    return m_updated_time_isSet;
}

bool OAISecurionPay::is_updated_time_Valid() const{
    return m_updated_time_isValid;
}

OAISecurionPay_allOf_credentials OAISecurionPay::getCredentials() const {
    return m_credentials;
}
void OAISecurionPay::setCredentials(const OAISecurionPay_allOf_credentials &credentials) {
    m_credentials = credentials;
    m_credentials_isSet = true;
}

bool OAISecurionPay::is_credentials_Set() const{
    return m_credentials_isSet;
}

bool OAISecurionPay::is_credentials_Valid() const{
    return m_credentials_isValid;
}

OAISecurionPay3dsServers OAISecurionPay::getThreeDSecureServer() const {
    return m_three_d_secure_server;
}
void OAISecurionPay::setThreeDSecureServer(const OAISecurionPay3dsServers &three_d_secure_server) {
    m_three_d_secure_server = three_d_secure_server;
    m_three_d_secure_server_isSet = true;
}

bool OAISecurionPay::is_three_d_secure_server_Set() const{
    return m_three_d_secure_server_isSet;
}

bool OAISecurionPay::is_three_d_secure_server_Valid() const{
    return m_three_d_secure_server_isValid;
}

bool OAISecurionPay::isSet() const {
...
bool OAISecurionPay::isValid() const {
