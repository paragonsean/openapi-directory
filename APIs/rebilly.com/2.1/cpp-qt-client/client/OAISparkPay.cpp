...
OAISparkPay::OAISparkPay(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISparkPay::OAISparkPay() {
    this->initializeModel();
}

OAISparkPay::~OAISparkPay() {}

void OAISparkPay::initializeModel() {
...
void OAISparkPay::fromJson(QString jsonString) {
...
void OAISparkPay::fromJsonObject(QJsonObject json) {
...
QString OAISparkPay::asJson() const {
...
QJsonObject OAISparkPay::asJsonObject() const {
    QJsonObject obj;
    if (m__links.size() > 0) {
...
QList<OAIGatewayAccount__links_inner> OAISparkPay::getLinks() const {
    return m__links;
}
void OAISparkPay::setLinks(const QList<OAIGatewayAccount__links_inner> &_links) {
    m__links = _links;
    m__links_isSet = true;
}

bool OAISparkPay::is__links_Set() const{
    return m__links_isSet;
}

bool OAISparkPay::is__links_Valid() const{
    return m__links_isValid;
}

QList<QString> OAISparkPay::getAcceptedCurrencies() const {
    return m_accepted_currencies;
}
void OAISparkPay::setAcceptedCurrencies(const QList<QString> &accepted_currencies) {
    m_accepted_currencies = accepted_currencies;
    m_accepted_currencies_isSet = true;
}

bool OAISparkPay::is_accepted_currencies_Set() const{
    return m_accepted_currencies_isSet;
}

bool OAISparkPay::is_accepted_currencies_Valid() const{
    return m_accepted_currencies_isValid;
}

OAIAcquirerName OAISparkPay::getAcquirerName() const {
    return m_acquirer_name;
}
void OAISparkPay::setAcquirerName(const OAIAcquirerName &acquirer_name) {
    m_acquirer_name = acquirer_name;
    m_acquirer_name_isSet = true;
}

bool OAISparkPay::is_acquirer_name_Set() const{
    return m_acquirer_name_isSet;
}

bool OAISparkPay::is_acquirer_name_Valid() const{
    return m_acquirer_name_isValid;
}

QString OAISparkPay::getAdditionalFilters() const {
    return m_additional_filters;
}
void OAISparkPay::setAdditionalFilters(const QString &additional_filters) {
    m_additional_filters = additional_filters;
    m_additional_filters_isSet = true;
}

bool OAISparkPay::is_additional_filters_Set() const{
    return m_additional_filters_isSet;
}

bool OAISparkPay::is_additional_filters_Valid() const{
    return m_additional_filters_isValid;
}

qint32 OAISparkPay::getApprovalWindowTtl() const {
    return m_approval_window_ttl;
}
void OAISparkPay::setApprovalWindowTtl(const qint32 &approval_window_ttl) {
    m_approval_window_ttl = approval_window_ttl;
    m_approval_window_ttl_isSet = true;
}

bool OAISparkPay::is_approval_window_ttl_Set() const{
    return m_approval_window_ttl_isSet;
}

bool OAISparkPay::is_approval_window_ttl_Valid() const{
    return m_approval_window_ttl_isValid;
}

QString OAISparkPay::getCityField() const {
    return m_city_field;
}
void OAISparkPay::setCityField(const QString &city_field) {
    m_city_field = city_field;
    m_city_field_isSet = true;
}

bool OAISparkPay::is_city_field_Set() const{
    return m_city_field_isSet;
}

bool OAISparkPay::is_city_field_Valid() const{
    return m_city_field_isValid;
}

QDateTime OAISparkPay::getCreatedTime() const {
    return m_created_time;
}
void OAISparkPay::setCreatedTime(const QDateTime &created_time) {
    m_created_time = created_time;
    m_created_time_isSet = true;
}

bool OAISparkPay::is_created_time_Set() const{
    return m_created_time_isSet;
}

bool OAISparkPay::is_created_time_Valid() const{
    return m_created_time_isValid;
}

QString OAISparkPay::getDccForceCurrency() const {
    return m_dcc_force_currency;
}
void OAISparkPay::setDccForceCurrency(const QString &dcc_force_currency) {
    m_dcc_force_currency = dcc_force_currency;
    m_dcc_force_currency_isSet = true;
}

bool OAISparkPay::is_dcc_force_currency_Set() const{
    return m_dcc_force_currency_isSet;
}

bool OAISparkPay::is_dcc_force_currency_Valid() const{
    return m_dcc_force_currency_isValid;
}

qint32 OAISparkPay::getDccMarkup() const {
    return m_dcc_markup;
}
void OAISparkPay::setDccMarkup(const qint32 &dcc_markup) {
    m_dcc_markup = dcc_markup;
    m_dcc_markup_isSet = true;
}

bool OAISparkPay::is_dcc_markup_Set() const{
    return m_dcc_markup_isSet;
}

bool OAISparkPay::is_dcc_markup_Valid() const{
    return m_dcc_markup_isValid;
}

QString OAISparkPay::getDescriptor() const {
    return m_descriptor;
}
void OAISparkPay::setDescriptor(const QString &descriptor) {
    m_descriptor = descriptor;
    m_descriptor_isSet = true;
}

bool OAISparkPay::is_descriptor_Set() const{
    return m_descriptor_isSet;
}

bool OAISparkPay::is_descriptor_Valid() const{
    return m_descriptor_isValid;
}

OAIDigitalWallets OAISparkPay::getDigitalWallets() const {
    return m_digital_wallets;
}
void OAISparkPay::setDigitalWallets(const OAIDigitalWallets &digital_wallets) {
    m_digital_wallets = digital_wallets;
    m_digital_wallets_isSet = true;
}

bool OAISparkPay::is_digital_wallets_Set() const{
    return m_digital_wallets_isSet;
}

bool OAISparkPay::is_digital_wallets_Valid() const{
    return m_digital_wallets_isValid;
}

bool OAISparkPay::isDynamicDescriptor() const {
    return m_dynamic_descriptor;
}
void OAISparkPay::setDynamicDescriptor(const bool &dynamic_descriptor) {
    m_dynamic_descriptor = dynamic_descriptor;
    m_dynamic_descriptor_isSet = true;
}

bool OAISparkPay::is_dynamic_descriptor_Set() const{
    return m_dynamic_descriptor_isSet;
}

bool OAISparkPay::is_dynamic_descriptor_Valid() const{
    return m_dynamic_descriptor_isValid;
}

QList<QString> OAISparkPay::getExcludedDccQuoteCurrencies() const {
    return m_excluded_dcc_quote_currencies;
}
void OAISparkPay::setExcludedDccQuoteCurrencies(const QList<QString> &excluded_dcc_quote_currencies) {
    m_excluded_dcc_quote_currencies = excluded_dcc_quote_currencies;
    m_excluded_dcc_quote_currencies_isSet = true;
}

bool OAISparkPay::is_excluded_dcc_quote_currencies_Set() const{
    return m_excluded_dcc_quote_currencies_isSet;
}

bool OAISparkPay::is_excluded_dcc_quote_currencies_Valid() const{
    return m_excluded_dcc_quote_currencies_isValid;
}

OAIGatewayName OAISparkPay::getGatewayName() const {
    return m_gateway_name;
}
void OAISparkPay::setGatewayName(const OAIGatewayName &gateway_name) {
    m_gateway_name = gateway_name;
    m_gateway_name_isSet = true;
}

bool OAISparkPay::is_gateway_name_Set() const{
    return m_gateway_name_isSet;
}

bool OAISparkPay::is_gateway_name_Valid() const{
    return m_gateway_name_isValid;
}

QString OAISparkPay::getId() const {
    return m_id;
}
void OAISparkPay::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAISparkPay::is_id_Set() const{
    return m_id_isSet;
}

bool OAISparkPay::is_id_Valid() const{
    return m_id_isValid;
}

bool OAISparkPay::isIsDown() const {
    return m_is_down;
}
void OAISparkPay::setIsDown(const bool &is_down) {
    m_is_down = is_down;
    m_is_down_isSet = true;
}

bool OAISparkPay::is_is_down_Set() const{
    return m_is_down_isSet;
}

bool OAISparkPay::is_is_down_Valid() const{
    return m_is_down_isValid;
}

QString OAISparkPay::getMerchantCategoryCode() const {
    return m_merchant_category_code;
}
void OAISparkPay::setMerchantCategoryCode(const QString &merchant_category_code) {
    m_merchant_category_code = merchant_category_code;
    m_merchant_category_code_isSet = true;
}

bool OAISparkPay::is_merchant_category_code_Set() const{
    return m_merchant_category_code_isSet;
}

bool OAISparkPay::is_merchant_category_code_Valid() const{
    return m_merchant_category_code_isValid;
}

OAIPaymentMethod OAISparkPay::getMethod() const {
    return m_method;
}
void OAISparkPay::setMethod(const OAIPaymentMethod &method) {
    m_method = method;
    m_method_isSet = true;
}

bool OAISparkPay::is_method_Set() const{
    return m_method_isSet;
}

bool OAISparkPay::is_method_Valid() const{
    return m_method_isValid;
}

double OAISparkPay::getMonthlyLimit() const {
    return m_monthly_limit;
}
void OAISparkPay::setMonthlyLimit(const double &monthly_limit) {
    m_monthly_limit = monthly_limit;
    m_monthly_limit_isSet = true;
}

bool OAISparkPay::is_monthly_limit_Set() const{
    return m_monthly_limit_isSet;
}

bool OAISparkPay::is_monthly_limit_Valid() const{
    return m_monthly_limit_isValid;
}

QString OAISparkPay::getOrganizationId() const {
    return m_organization_id;
}
void OAISparkPay::setOrganizationId(const QString &organization_id) {
    m_organization_id = organization_id;
    m_organization_id_isSet = true;
}

bool OAISparkPay::is_organization_id_Set() const{
    return m_organization_id_isSet;
}

bool OAISparkPay::is_organization_id_Valid() const{
    return m_organization_id_isValid;
}

QList<OAIPaymentCardBrand> OAISparkPay::getPaymentCardSchemes() const {
    return m_payment_card_schemes;
}
void OAISparkPay::setPaymentCardSchemes(const QList<OAIPaymentCardBrand> &payment_card_schemes) {
    m_payment_card_schemes = payment_card_schemes;
    m_payment_card_schemes_isSet = true;
}

bool OAISparkPay::is_payment_card_schemes_Set() const{
    return m_payment_card_schemes_isSet;
}

bool OAISparkPay::is_payment_card_schemes_Valid() const{
    return m_payment_card_schemes_isValid;
}

bool OAISparkPay::isReconciliationWindowEnabled() const {
    return m_reconciliation_window_enabled;
}
void OAISparkPay::setReconciliationWindowEnabled(const bool &reconciliation_window_enabled) {
    m_reconciliation_window_enabled = reconciliation_window_enabled;
    m_reconciliation_window_enabled_isSet = true;
}

bool OAISparkPay::is_reconciliation_window_enabled_Set() const{
    return m_reconciliation_window_enabled_isSet;
}

bool OAISparkPay::is_reconciliation_window_enabled_Valid() const{
    return m_reconciliation_window_enabled_isValid;
}

qint32 OAISparkPay::getReconciliationWindowTtl() const {
    return m_reconciliation_window_ttl;
}
void OAISparkPay::setReconciliationWindowTtl(const qint32 &reconciliation_window_ttl) {
    m_reconciliation_window_ttl = reconciliation_window_ttl;
    m_reconciliation_window_ttl_isSet = true;
}

bool OAISparkPay::is_reconciliation_window_ttl_Set() const{
    return m_reconciliation_window_ttl_isSet;
}

bool OAISparkPay::is_reconciliation_window_ttl_Valid() const{
    return m_reconciliation_window_ttl_isValid;
}

QString OAISparkPay::getStatus() const {
    return m_status;
}
void OAISparkPay::setStatus(const QString &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAISparkPay::is_status_Set() const{
    return m_status_isSet;
}

bool OAISparkPay::is_status_Valid() const{
    return m_status_isValid;
}

bool OAISparkPay::isSticky() const {
    return m_sticky;
}
void OAISparkPay::setSticky(const bool &sticky) {
    m_sticky = sticky;
    m_sticky_isSet = true;
}

bool OAISparkPay::is_sticky_Set() const{
    return m_sticky_isSet;
}

bool OAISparkPay::is_sticky_Valid() const{
    return m_sticky_isValid;
}

bool OAISparkPay::isThreeDSecure() const {
    return m_three_d_secure;
}
void OAISparkPay::setThreeDSecure(const bool &three_d_secure) {
    m_three_d_secure = three_d_secure;
    m_three_d_secure_isSet = true;
}

bool OAISparkPay::is_three_d_secure_Set() const{
    return m_three_d_secure_isSet;
}

bool OAISparkPay::is_three_d_secure_Valid() const{
    return m_three_d_secure_isValid;
}

qint32 OAISparkPay::getTimeout() const {
    return m_timeout;
}
void OAISparkPay::setTimeout(const qint32 &timeout) {
    m_timeout = timeout;
    m_timeout_isSet = true;
}

bool OAISparkPay::is_timeout_Set() const{
    return m_timeout_isSet;
}

bool OAISparkPay::is_timeout_Valid() const{
    return m_timeout_isValid;
}

QString OAISparkPay::getToken() const {
    return m_token;
}
void OAISparkPay::setToken(const QString &token) {
    m_token = token;
    m_token_isSet = true;
}

bool OAISparkPay::is_token_Set() const{
    return m_token_isSet;
}

bool OAISparkPay::is_token_Valid() const{
    return m_token_isValid;
}

QDateTime OAISparkPay::getUpdatedTime() const {
    return m_updated_time;
}
void OAISparkPay::setUpdatedTime(const QDateTime &updated_time) {
    m_updated_time = updated_time;
    m_updated_time_isSet = true;
}

bool OAISparkPay::is_updated_time_Set() const{
    return m_updated_time_isSet;
}

bool OAISparkPay::is_updated_time_Valid() const{
    return m_updated_time_isValid;
}

OAISparkPay_allOf_credentials OAISparkPay::getCredentials() const {
    return m_credentials;
}
void OAISparkPay::setCredentials(const OAISparkPay_allOf_credentials &credentials) {
    m_credentials = credentials;
    m_credentials_isSet = true;
}

bool OAISparkPay::is_credentials_Set() const{
    return m_credentials_isSet;
}

bool OAISparkPay::is_credentials_Valid() const{
    return m_credentials_isValid;
}

bool OAISparkPay::isSet() const {
...
bool OAISparkPay::isValid() const {
