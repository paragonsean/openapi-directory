...
/*
 * OAIPostKycDocumentMatches_request.h
 *
 * 
 */

#ifndef OAIPostKycDocumentMatches_request_H
#define OAIPostKycDocumentMatches_request_H
...
class OAIPostKycDocumentMatches_request : public OAIObject {
public:
    OAIPostKycDocumentMatches_request();
    OAIPostKycDocumentMatches_request(QString json);
    ~OAIPostKycDocumentMatches_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPostKycDocumentMatches_request)

#endif // OAIPostKycDocumentMatches_request_H
