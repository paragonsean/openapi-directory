...
#ifndef OAIClearhaus_H
#define OAIClearhaus_H

#include <QJsonObject>

#include "OAIAcquirerName.h"
#include "OAIClearhaus3dsServers.h"
#include "OAIClearhaus_allOf_credentials.h"
...
class OAIClearhaus_allOf_credentials;
class OAIClearhaus3dsServers;

class OAIClearhaus : public OAIObject {
public:
    OAIClearhaus();
    OAIClearhaus(QString json);
    ~OAIClearhaus() override;
    ...
    OAIClearhaus_allOf_credentials getCredentials() const;
    void setCredentials(const OAIClearhaus_allOf_credentials &credentials);
    bool is_credentials_Set() const;
    bool is_credentials_Valid() const;

    OAIClearhaus3dsServers getThreeDSecureServer() const;
    void setThreeDSecureServer(const OAIClearhaus3dsServers &three_d_secure_server);
...
private:
    ...
    OAIClearhaus_allOf_credentials m_credentials;
    bool m_credentials_isSet;
    bool m_credentials_isValid;

    OAIClearhaus3dsServers m_three_d_secure_server;
...
Q_DECLARE_METATYPE(OpenAPI::OAIClearhaus)

#endif // OAIClearhaus_H
