...
/*
 * OAIBankAccountCreateToken.h
 *
 * 
 */

#ifndef OAIBankAccountCreateToken_H
#define OAIBankAccountCreateToken_H
...
class OAIBankAccountCreateToken : public OAIObject {
public:
    OAIBankAccountCreateToken();
    OAIBankAccountCreateToken(QString json);
    ~OAIBankAccountCreateToken() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBankAccountCreateToken)

#endif // OAIBankAccountCreateToken_H
