...
class OAIRealex_allOf_credentials;

class OAIRealex : public OAIObject {
public:
    OAIRealex();
    OAIRealex(QString json);
    ~OAIRealex() override;
    ...
    OAIRealex_allOf_credentials getCredentials() const;
    void setCredentials(const OAIRealex_allOf_credentials &credentials);
...
private:
    ...
    OAIRealex_allOf_credentials m_credentials;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRealex)
