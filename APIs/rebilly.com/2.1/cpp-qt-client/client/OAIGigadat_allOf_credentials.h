...
/*
 * OAIGigadat_allOf_credentials.h
 *
 * Gigadat credentials object.
 */

#ifndef OAIGigadat_allOf_credentials_H
#define OAIGigadat_allOf_credentials_H
...
class OAIGigadat_allOf_credentials : public OAIObject {
public:
    OAIGigadat_allOf_credentials();
    OAIGigadat_allOf_credentials(QString json);
    ~OAIGigadat_allOf_credentials() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGigadat_allOf_credentials)

#endif // OAIGigadat_allOf_credentials_H
