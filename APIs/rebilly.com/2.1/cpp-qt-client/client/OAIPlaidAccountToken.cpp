...
OAIPlaidAccountToken::OAIPlaidAccountToken(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPlaidAccountToken::OAIPlaidAccountToken() {
    this->initializeModel();
}

OAIPlaidAccountToken::~OAIPlaidAccountToken() {}

void OAIPlaidAccountToken::initializeModel() {
...
void OAIPlaidAccountToken::fromJson(QString jsonString) {
...
void OAIPlaidAccountToken::fromJsonObject(QJsonObject json) {
...
QString OAIPlaidAccountToken::asJson() const {
...
QJsonObject OAIPlaidAccountToken::asJsonObject() const {
    QJsonObject obj;
...
OAIContactObject OAIPlaidAccountToken::getBillingAddress() const {
    return m_billing_address;
}
void OAIPlaidAccountToken::setBillingAddress(const OAIContactObject &billing_address) {
    m_billing_address = billing_address;
    m_billing_address_isSet = true;
}

bool OAIPlaidAccountToken::is_billing_address_Set() const{
    return m_billing_address_isSet;
}

bool OAIPlaidAccountToken::is_billing_address_Valid() const{
    return m_billing_address_isValid;
}

QString OAIPlaidAccountToken::getMethod() const {
    return m_method;
}
void OAIPlaidAccountToken::setMethod(const QString &method) {
    m_method = method;
    m_method_isSet = true;
}

bool OAIPlaidAccountToken::is_method_Set() const{
    return m_method_isSet;
}

bool OAIPlaidAccountToken::is_method_Valid() const{
    return m_method_isValid;
}

OAIObject OAIPlaidAccountToken::getPaymentInstrument() const {
    return m_payment_instrument;
}
void OAIPlaidAccountToken::setPaymentInstrument(const OAIObject &payment_instrument) {
    m_payment_instrument = payment_instrument;
    m_payment_instrument_isSet = true;
}

bool OAIPlaidAccountToken::is_payment_instrument_Set() const{
    return m_payment_instrument_isSet;
}

bool OAIPlaidAccountToken::is_payment_instrument_Valid() const{
    return m_payment_instrument_isValid;
}

QList<OAISelfLink> OAIPlaidAccountToken::getLinks() const {
    return m__links;
}
void OAIPlaidAccountToken::setLinks(const QList<OAISelfLink> &_links) {
    m__links = _links;
    m__links_isSet = true;
}

bool OAIPlaidAccountToken::is__links_Set() const{
    return m__links_isSet;
}

bool OAIPlaidAccountToken::is__links_Valid() const{
    return m__links_isValid;
}

QDateTime OAIPlaidAccountToken::getCreatedTime() const {
    return m_created_time;
}
void OAIPlaidAccountToken::setCreatedTime(const QDateTime &created_time) {
    m_created_time = created_time;
    m_created_time_isSet = true;
}

bool OAIPlaidAccountToken::is_created_time_Set() const{
    return m_created_time_isSet;
}

bool OAIPlaidAccountToken::is_created_time_Valid() const{
    return m_created_time_isValid;
}

QDateTime OAIPlaidAccountToken::getExpirationTime() const {
    return m_expiration_time;
}
void OAIPlaidAccountToken::setExpirationTime(const QDateTime &expiration_time) {
    m_expiration_time = expiration_time;
    m_expiration_time_isSet = true;
}

bool OAIPlaidAccountToken::is_expiration_time_Set() const{
    return m_expiration_time_isSet;
}

bool OAIPlaidAccountToken::is_expiration_time_Valid() const{
    return m_expiration_time_isValid;
}

QString OAIPlaidAccountToken::getId() const {
    return m_id;
}
void OAIPlaidAccountToken::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIPlaidAccountToken::is_id_Set() const{
    return m_id_isSet;
}

bool OAIPlaidAccountToken::is_id_Valid() const{
    return m_id_isValid;
}

bool OAIPlaidAccountToken::isIsUsed() const {
    return m_is_used;
}
void OAIPlaidAccountToken::setIsUsed(const bool &is_used) {
    m_is_used = is_used;
    m_is_used_isSet = true;
}

bool OAIPlaidAccountToken::is_is_used_Set() const{
    return m_is_used_isSet;
}

bool OAIPlaidAccountToken::is_is_used_Valid() const{
    return m_is_used_isValid;
}

OAILeadSource OAIPlaidAccountToken::getLeadSource() const {
    return m_lead_source;
}
void OAIPlaidAccountToken::setLeadSource(const OAILeadSource &lead_source) {
    m_lead_source = lead_source;
    m_lead_source_isSet = true;
}

bool OAIPlaidAccountToken::is_lead_source_Set() const{
    return m_lead_source_isSet;
}

bool OAIPlaidAccountToken::is_lead_source_Valid() const{
    return m_lead_source_isValid;
}

OAIRiskMetadata OAIPlaidAccountToken::getRiskMetadata() const {
    return m_risk_metadata;
}
void OAIPlaidAccountToken::setRiskMetadata(const OAIRiskMetadata &risk_metadata) {
    m_risk_metadata = risk_metadata;
    m_risk_metadata_isSet = true;
}

bool OAIPlaidAccountToken::is_risk_metadata_Set() const{
    return m_risk_metadata_isSet;
}

bool OAIPlaidAccountToken::is_risk_metadata_Valid() const{
    return m_risk_metadata_isValid;
}

QDateTime OAIPlaidAccountToken::getUpdatedTime() const {
    return m_updated_time;
}
void OAIPlaidAccountToken::setUpdatedTime(const QDateTime &updated_time) {
    m_updated_time = updated_time;
    m_updated_time_isSet = true;
}

bool OAIPlaidAccountToken::is_updated_time_Set() const{
    return m_updated_time_isSet;
}

bool OAIPlaidAccountToken::is_updated_time_Valid() const{
    return m_updated_time_isValid;
}

QDateTime OAIPlaidAccountToken::getUsageTime() const {
    return m_usage_time;
}
void OAIPlaidAccountToken::setUsageTime(const QDateTime &usage_time) {
    m_usage_time = usage_time;
    m_usage_time_isSet = true;
}

bool OAIPlaidAccountToken::is_usage_time_Set() const{
    return m_usage_time_isSet;
}

bool OAIPlaidAccountToken::is_usage_time_Valid() const{
    return m_usage_time_isValid;
}

bool OAIPlaidAccountToken::isSet() const {
...
bool OAIPlaidAccountToken::isValid() const {
