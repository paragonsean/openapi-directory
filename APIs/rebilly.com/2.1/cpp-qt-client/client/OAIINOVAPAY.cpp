...
OAIINOVAPAY::OAIINOVAPAY(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIINOVAPAY::OAIINOVAPAY() {
    this->initializeModel();
}

OAIINOVAPAY::~OAIINOVAPAY() {}

void OAIINOVAPAY::initializeModel() {
...
void OAIINOVAPAY::fromJson(QString jsonString) {
...
void OAIINOVAPAY::fromJsonObject(QJsonObject json) {
...
QString OAIINOVAPAY::asJson() const {
...
QJsonObject OAIINOVAPAY::asJsonObject() const {
    QJsonObject obj;
    if (m__links.size() > 0) {
...
QList<OAIGatewayAccount__links_inner> OAIINOVAPAY::getLinks() const {
    return m__links;
}
void OAIINOVAPAY::setLinks(const QList<OAIGatewayAccount__links_inner> &_links) {
    m__links = _links;
    m__links_isSet = true;
}

bool OAIINOVAPAY::is__links_Set() const{
    return m__links_isSet;
}

bool OAIINOVAPAY::is__links_Valid() const{
    return m__links_isValid;
}

QList<QString> OAIINOVAPAY::getAcceptedCurrencies() const {
    return m_accepted_currencies;
}
void OAIINOVAPAY::setAcceptedCurrencies(const QList<QString> &accepted_currencies) {
    m_accepted_currencies = accepted_currencies;
    m_accepted_currencies_isSet = true;
}

bool OAIINOVAPAY::is_accepted_currencies_Set() const{
    return m_accepted_currencies_isSet;
}

bool OAIINOVAPAY::is_accepted_currencies_Valid() const{
    return m_accepted_currencies_isValid;
}

OAIAcquirerName OAIINOVAPAY::getAcquirerName() const {
    return m_acquirer_name;
}
void OAIINOVAPAY::setAcquirerName(const OAIAcquirerName &acquirer_name) {
    m_acquirer_name = acquirer_name;
    m_acquirer_name_isSet = true;
}

bool OAIINOVAPAY::is_acquirer_name_Set() const{
    return m_acquirer_name_isSet;
}

bool OAIINOVAPAY::is_acquirer_name_Valid() const{
    return m_acquirer_name_isValid;
}

QString OAIINOVAPAY::getAdditionalFilters() const {
    return m_additional_filters;
}
void OAIINOVAPAY::setAdditionalFilters(const QString &additional_filters) {
    m_additional_filters = additional_filters;
    m_additional_filters_isSet = true;
}

bool OAIINOVAPAY::is_additional_filters_Set() const{
    return m_additional_filters_isSet;
}

bool OAIINOVAPAY::is_additional_filters_Valid() const{
    return m_additional_filters_isValid;
}

qint32 OAIINOVAPAY::getApprovalWindowTtl() const {
    return m_approval_window_ttl;
}
void OAIINOVAPAY::setApprovalWindowTtl(const qint32 &approval_window_ttl) {
    m_approval_window_ttl = approval_window_ttl;
    m_approval_window_ttl_isSet = true;
}

bool OAIINOVAPAY::is_approval_window_ttl_Set() const{
    return m_approval_window_ttl_isSet;
}

bool OAIINOVAPAY::is_approval_window_ttl_Valid() const{
    return m_approval_window_ttl_isValid;
}

QString OAIINOVAPAY::getCityField() const {
    return m_city_field;
}
void OAIINOVAPAY::setCityField(const QString &city_field) {
    m_city_field = city_field;
    m_city_field_isSet = true;
}

bool OAIINOVAPAY::is_city_field_Set() const{
    return m_city_field_isSet;
}

bool OAIINOVAPAY::is_city_field_Valid() const{
    return m_city_field_isValid;
}

QDateTime OAIINOVAPAY::getCreatedTime() const {
    return m_created_time;
}
void OAIINOVAPAY::setCreatedTime(const QDateTime &created_time) {
    m_created_time = created_time;
    m_created_time_isSet = true;
}

bool OAIINOVAPAY::is_created_time_Set() const{
    return m_created_time_isSet;
}

bool OAIINOVAPAY::is_created_time_Valid() const{
    return m_created_time_isValid;
}

QString OAIINOVAPAY::getDccForceCurrency() const {
    return m_dcc_force_currency;
}
void OAIINOVAPAY::setDccForceCurrency(const QString &dcc_force_currency) {
    m_dcc_force_currency = dcc_force_currency;
    m_dcc_force_currency_isSet = true;
}

bool OAIINOVAPAY::is_dcc_force_currency_Set() const{
    return m_dcc_force_currency_isSet;
}

bool OAIINOVAPAY::is_dcc_force_currency_Valid() const{
    return m_dcc_force_currency_isValid;
}

qint32 OAIINOVAPAY::getDccMarkup() const {
    return m_dcc_markup;
}
void OAIINOVAPAY::setDccMarkup(const qint32 &dcc_markup) {
    m_dcc_markup = dcc_markup;
    m_dcc_markup_isSet = true;
}

bool OAIINOVAPAY::is_dcc_markup_Set() const{
    return m_dcc_markup_isSet;
}

bool OAIINOVAPAY::is_dcc_markup_Valid() const{
    return m_dcc_markup_isValid;
}

QString OAIINOVAPAY::getDescriptor() const {
    return m_descriptor;
}
void OAIINOVAPAY::setDescriptor(const QString &descriptor) {
    m_descriptor = descriptor;
    m_descriptor_isSet = true;
}

bool OAIINOVAPAY::is_descriptor_Set() const{
    return m_descriptor_isSet;
}

bool OAIINOVAPAY::is_descriptor_Valid() const{
    return m_descriptor_isValid;
}

OAIDigitalWallets OAIINOVAPAY::getDigitalWallets() const {
    return m_digital_wallets;
}
void OAIINOVAPAY::setDigitalWallets(const OAIDigitalWallets &digital_wallets) {
    m_digital_wallets = digital_wallets;
    m_digital_wallets_isSet = true;
}

bool OAIINOVAPAY::is_digital_wallets_Set() const{
    return m_digital_wallets_isSet;
}

bool OAIINOVAPAY::is_digital_wallets_Valid() const{
    return m_digital_wallets_isValid;
}

bool OAIINOVAPAY::isDynamicDescriptor() const {
    return m_dynamic_descriptor;
}
void OAIINOVAPAY::setDynamicDescriptor(const bool &dynamic_descriptor) {
    m_dynamic_descriptor = dynamic_descriptor;
    m_dynamic_descriptor_isSet = true;
}

bool OAIINOVAPAY::is_dynamic_descriptor_Set() const{
    return m_dynamic_descriptor_isSet;
}

bool OAIINOVAPAY::is_dynamic_descriptor_Valid() const{
    return m_dynamic_descriptor_isValid;
}

QList<QString> OAIINOVAPAY::getExcludedDccQuoteCurrencies() const {
    return m_excluded_dcc_quote_currencies;
}
void OAIINOVAPAY::setExcludedDccQuoteCurrencies(const QList<QString> &excluded_dcc_quote_currencies) {
    m_excluded_dcc_quote_currencies = excluded_dcc_quote_currencies;
    m_excluded_dcc_quote_currencies_isSet = true;
}

bool OAIINOVAPAY::is_excluded_dcc_quote_currencies_Set() const{
    return m_excluded_dcc_quote_currencies_isSet;
}

bool OAIINOVAPAY::is_excluded_dcc_quote_currencies_Valid() const{
    return m_excluded_dcc_quote_currencies_isValid;
}

OAIGatewayName OAIINOVAPAY::getGatewayName() const {
    return m_gateway_name;
}
void OAIINOVAPAY::setGatewayName(const OAIGatewayName &gateway_name) {
    m_gateway_name = gateway_name;
    m_gateway_name_isSet = true;
}

bool OAIINOVAPAY::is_gateway_name_Set() const{
    return m_gateway_name_isSet;
}

bool OAIINOVAPAY::is_gateway_name_Valid() const{
    return m_gateway_name_isValid;
}

QString OAIINOVAPAY::getId() const {
    return m_id;
}
void OAIINOVAPAY::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIINOVAPAY::is_id_Set() const{
    return m_id_isSet;
}

bool OAIINOVAPAY::is_id_Valid() const{
    return m_id_isValid;
}

bool OAIINOVAPAY::isIsDown() const {
    return m_is_down;
}
void OAIINOVAPAY::setIsDown(const bool &is_down) {
    m_is_down = is_down;
    m_is_down_isSet = true;
}

bool OAIINOVAPAY::is_is_down_Set() const{
    return m_is_down_isSet;
}

bool OAIINOVAPAY::is_is_down_Valid() const{
    return m_is_down_isValid;
}

QString OAIINOVAPAY::getMerchantCategoryCode() const {
    return m_merchant_category_code;
}
void OAIINOVAPAY::setMerchantCategoryCode(const QString &merchant_category_code) {
    m_merchant_category_code = merchant_category_code;
    m_merchant_category_code_isSet = true;
}

bool OAIINOVAPAY::is_merchant_category_code_Set() const{
    return m_merchant_category_code_isSet;
}

bool OAIINOVAPAY::is_merchant_category_code_Valid() const{
    return m_merchant_category_code_isValid;
}

OAIPaymentMethod OAIINOVAPAY::getMethod() const {
    return m_method;
}
void OAIINOVAPAY::setMethod(const OAIPaymentMethod &method) {
    m_method = method;
    m_method_isSet = true;
}

bool OAIINOVAPAY::is_method_Set() const{
    return m_method_isSet;
}

bool OAIINOVAPAY::is_method_Valid() const{
    return m_method_isValid;
}

double OAIINOVAPAY::getMonthlyLimit() const {
    return m_monthly_limit;
}
void OAIINOVAPAY::setMonthlyLimit(const double &monthly_limit) {
    m_monthly_limit = monthly_limit;
    m_monthly_limit_isSet = true;
}

bool OAIINOVAPAY::is_monthly_limit_Set() const{
    return m_monthly_limit_isSet;
}

bool OAIINOVAPAY::is_monthly_limit_Valid() const{
    return m_monthly_limit_isValid;
}

QString OAIINOVAPAY::getOrganizationId() const {
    return m_organization_id;
}
void OAIINOVAPAY::setOrganizationId(const QString &organization_id) {
    m_organization_id = organization_id;
    m_organization_id_isSet = true;
}

bool OAIINOVAPAY::is_organization_id_Set() const{
    return m_organization_id_isSet;
}

bool OAIINOVAPAY::is_organization_id_Valid() const{
    return m_organization_id_isValid;
}

QList<OAIPaymentCardBrand> OAIINOVAPAY::getPaymentCardSchemes() const {
    return m_payment_card_schemes;
}
void OAIINOVAPAY::setPaymentCardSchemes(const QList<OAIPaymentCardBrand> &payment_card_schemes) {
    m_payment_card_schemes = payment_card_schemes;
    m_payment_card_schemes_isSet = true;
}

bool OAIINOVAPAY::is_payment_card_schemes_Set() const{
    return m_payment_card_schemes_isSet;
}

bool OAIINOVAPAY::is_payment_card_schemes_Valid() const{
    return m_payment_card_schemes_isValid;
}

bool OAIINOVAPAY::isReconciliationWindowEnabled() const {
    return m_reconciliation_window_enabled;
}
void OAIINOVAPAY::setReconciliationWindowEnabled(const bool &reconciliation_window_enabled) {
    m_reconciliation_window_enabled = reconciliation_window_enabled;
    m_reconciliation_window_enabled_isSet = true;
}

bool OAIINOVAPAY::is_reconciliation_window_enabled_Set() const{
    return m_reconciliation_window_enabled_isSet;
}

bool OAIINOVAPAY::is_reconciliation_window_enabled_Valid() const{
    return m_reconciliation_window_enabled_isValid;
}

qint32 OAIINOVAPAY::getReconciliationWindowTtl() const {
    return m_reconciliation_window_ttl;
}
void OAIINOVAPAY::setReconciliationWindowTtl(const qint32 &reconciliation_window_ttl) {
    m_reconciliation_window_ttl = reconciliation_window_ttl;
    m_reconciliation_window_ttl_isSet = true;
}

bool OAIINOVAPAY::is_reconciliation_window_ttl_Set() const{
    return m_reconciliation_window_ttl_isSet;
}

bool OAIINOVAPAY::is_reconciliation_window_ttl_Valid() const{
    return m_reconciliation_window_ttl_isValid;
}

QString OAIINOVAPAY::getStatus() const {
    return m_status;
}
void OAIINOVAPAY::setStatus(const QString &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIINOVAPAY::is_status_Set() const{
    return m_status_isSet;
}

bool OAIINOVAPAY::is_status_Valid() const{
    return m_status_isValid;
}

bool OAIINOVAPAY::isSticky() const {
    return m_sticky;
}
void OAIINOVAPAY::setSticky(const bool &sticky) {
    m_sticky = sticky;
    m_sticky_isSet = true;
}

bool OAIINOVAPAY::is_sticky_Set() const{
    return m_sticky_isSet;
}

bool OAIINOVAPAY::is_sticky_Valid() const{
    return m_sticky_isValid;
}

bool OAIINOVAPAY::isThreeDSecure() const {
    return m_three_d_secure;
}
void OAIINOVAPAY::setThreeDSecure(const bool &three_d_secure) {
    m_three_d_secure = three_d_secure;
    m_three_d_secure_isSet = true;
}

bool OAIINOVAPAY::is_three_d_secure_Set() const{
    return m_three_d_secure_isSet;
}

bool OAIINOVAPAY::is_three_d_secure_Valid() const{
    return m_three_d_secure_isValid;
}

qint32 OAIINOVAPAY::getTimeout() const {
    return m_timeout;
}
void OAIINOVAPAY::setTimeout(const qint32 &timeout) {
    m_timeout = timeout;
    m_timeout_isSet = true;
}

bool OAIINOVAPAY::is_timeout_Set() const{
    return m_timeout_isSet;
}

bool OAIINOVAPAY::is_timeout_Valid() const{
    return m_timeout_isValid;
}

QString OAIINOVAPAY::getToken() const {
    return m_token;
}
void OAIINOVAPAY::setToken(const QString &token) {
    m_token = token;
    m_token_isSet = true;
}

bool OAIINOVAPAY::is_token_Set() const{
    return m_token_isSet;
}

bool OAIINOVAPAY::is_token_Valid() const{
    return m_token_isValid;
}

QDateTime OAIINOVAPAY::getUpdatedTime() const {
    return m_updated_time;
}
void OAIINOVAPAY::setUpdatedTime(const QDateTime &updated_time) {
    m_updated_time = updated_time;
    m_updated_time_isSet = true;
}

bool OAIINOVAPAY::is_updated_time_Set() const{
    return m_updated_time_isSet;
}

bool OAIINOVAPAY::is_updated_time_Valid() const{
    return m_updated_time_isValid;
}

OAIINOVAPAY_allOf_credentials OAIINOVAPAY::getCredentials() const {
    return m_credentials;
}
void OAIINOVAPAY::setCredentials(const OAIINOVAPAY_allOf_credentials &credentials) {
    m_credentials = credentials;
    m_credentials_isSet = true;
}

bool OAIINOVAPAY::is_credentials_Set() const{
    return m_credentials_isSet;
}

bool OAIINOVAPAY::is_credentials_Valid() const{
    return m_credentials_isValid;
}

bool OAIINOVAPAY::isSet() const {
...
bool OAIINOVAPAY::isValid() const {
