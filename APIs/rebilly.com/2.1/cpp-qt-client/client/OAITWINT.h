...
class OAITWINT_allOf_credentials;
class OAITWINT_allOf_settings;

class OAITWINT : public OAIObject {
public:
    OAITWINT();
    OAITWINT(QString json);
    ~OAITWINT() override;
    ...
    OAITWINT_allOf_credentials getCredentials() const;
    void setCredentials(const OAITWINT_allOf_credentials &credentials);
    bool is_credentials_Set() const;
    bool is_credentials_Valid() const;

    OAITWINT_allOf_settings getSettings() const;
    void setSettings(const OAITWINT_allOf_settings &settings);
...
private:
    ...
    OAITWINT_allOf_credentials m_credentials;
    bool m_credentials_isSet;
    bool m_credentials_isValid;

    OAITWINT_allOf_settings m_settings;
...
Q_DECLARE_METATYPE(OpenAPI::OAITWINT)
