...
#ifndef OAIEuteller_H
#define OAIEuteller_H
...
class OAIEuteller_allOf_credentials;

class OAIEuteller : public OAIObject {
public:
    OAIEuteller();
    OAIEuteller(QString json);
    ~OAIEuteller() override;
    ...
    OAIEuteller_allOf_credentials getCredentials() const;
    void setCredentials(const OAIEuteller_allOf_credentials &credentials);
...
private:
    ...
    OAIEuteller_allOf_credentials m_credentials;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEuteller)
