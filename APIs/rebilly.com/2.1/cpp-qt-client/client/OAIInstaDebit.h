...
#ifndef OAIInstaDebit_H
#define OAIInstaDebit_H
...
class OAIInstaDebit_allOf_credentials;

class OAIInstaDebit : public OAIObject {
public:
    OAIInstaDebit();
    OAIInstaDebit(QString json);
    ~OAIInstaDebit() override;
    ...
    OAIInstaDebit_allOf_credentials getCredentials() const;
    void setCredentials(const OAIInstaDebit_allOf_credentials &credentials);
...
private:
    ...
    OAIInstaDebit_allOf_credentials m_credentials;
...
Q_DECLARE_METATYPE(OpenAPI::OAIInstaDebit)

#endif // OAIInstaDebit_H
