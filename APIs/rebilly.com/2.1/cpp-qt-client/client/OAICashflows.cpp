...
OAICashflows::OAICashflows(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICashflows::OAICashflows() {
    this->initializeModel();
}

OAICashflows::~OAICashflows() {}

void OAICashflows::initializeModel() {
...
void OAICashflows::fromJson(QString jsonString) {
...
void OAICashflows::fromJsonObject(QJsonObject json) {
...
QString OAICashflows::asJson() const {
...
QJsonObject OAICashflows::asJsonObject() const {
    QJsonObject obj;
    if (m__links.size() > 0) {
...
QList<OAIGatewayAccount__links_inner> OAICashflows::getLinks() const {
    return m__links;
}
void OAICashflows::setLinks(const QList<OAIGatewayAccount__links_inner> &_links) {
    m__links = _links;
    m__links_isSet = true;
}

bool OAICashflows::is__links_Set() const{
    return m__links_isSet;
}

bool OAICashflows::is__links_Valid() const{
    return m__links_isValid;
}

QList<QString> OAICashflows::getAcceptedCurrencies() const {
    return m_accepted_currencies;
}
void OAICashflows::setAcceptedCurrencies(const QList<QString> &accepted_currencies) {
    m_accepted_currencies = accepted_currencies;
    m_accepted_currencies_isSet = true;
}

bool OAICashflows::is_accepted_currencies_Set() const{
    return m_accepted_currencies_isSet;
}

bool OAICashflows::is_accepted_currencies_Valid() const{
    return m_accepted_currencies_isValid;
}

OAIAcquirerName OAICashflows::getAcquirerName() const {
    return m_acquirer_name;
}
void OAICashflows::setAcquirerName(const OAIAcquirerName &acquirer_name) {
    m_acquirer_name = acquirer_name;
    m_acquirer_name_isSet = true;
}

bool OAICashflows::is_acquirer_name_Set() const{
    return m_acquirer_name_isSet;
}

bool OAICashflows::is_acquirer_name_Valid() const{
    return m_acquirer_name_isValid;
}

QString OAICashflows::getAdditionalFilters() const {
    return m_additional_filters;
}
void OAICashflows::setAdditionalFilters(const QString &additional_filters) {
    m_additional_filters = additional_filters;
    m_additional_filters_isSet = true;
}

bool OAICashflows::is_additional_filters_Set() const{
    return m_additional_filters_isSet;
}

bool OAICashflows::is_additional_filters_Valid() const{
    return m_additional_filters_isValid;
}

qint32 OAICashflows::getApprovalWindowTtl() const {
    return m_approval_window_ttl;
}
void OAICashflows::setApprovalWindowTtl(const qint32 &approval_window_ttl) {
    m_approval_window_ttl = approval_window_ttl;
    m_approval_window_ttl_isSet = true;
}

bool OAICashflows::is_approval_window_ttl_Set() const{
    return m_approval_window_ttl_isSet;
}

bool OAICashflows::is_approval_window_ttl_Valid() const{
    return m_approval_window_ttl_isValid;
}

QString OAICashflows::getCityField() const {
    return m_city_field;
}
void OAICashflows::setCityField(const QString &city_field) {
    m_city_field = city_field;
    m_city_field_isSet = true;
}

bool OAICashflows::is_city_field_Set() const{
    return m_city_field_isSet;
}

bool OAICashflows::is_city_field_Valid() const{
    return m_city_field_isValid;
}

QDateTime OAICashflows::getCreatedTime() const {
    return m_created_time;
}
void OAICashflows::setCreatedTime(const QDateTime &created_time) {
    m_created_time = created_time;
    m_created_time_isSet = true;
}

bool OAICashflows::is_created_time_Set() const{
    return m_created_time_isSet;
}

bool OAICashflows::is_created_time_Valid() const{
    return m_created_time_isValid;
}

QString OAICashflows::getDccForceCurrency() const {
    return m_dcc_force_currency;
}
void OAICashflows::setDccForceCurrency(const QString &dcc_force_currency) {
    m_dcc_force_currency = dcc_force_currency;
    m_dcc_force_currency_isSet = true;
}

bool OAICashflows::is_dcc_force_currency_Set() const{
    return m_dcc_force_currency_isSet;
}

bool OAICashflows::is_dcc_force_currency_Valid() const{
    return m_dcc_force_currency_isValid;
}

qint32 OAICashflows::getDccMarkup() const {
    return m_dcc_markup;
}
void OAICashflows::setDccMarkup(const qint32 &dcc_markup) {
    m_dcc_markup = dcc_markup;
    m_dcc_markup_isSet = true;
}

bool OAICashflows::is_dcc_markup_Set() const{
    return m_dcc_markup_isSet;
}

bool OAICashflows::is_dcc_markup_Valid() const{
    return m_dcc_markup_isValid;
}

QString OAICashflows::getDescriptor() const {
    return m_descriptor;
}
void OAICashflows::setDescriptor(const QString &descriptor) {
    m_descriptor = descriptor;
    m_descriptor_isSet = true;
}

bool OAICashflows::is_descriptor_Set() const{
    return m_descriptor_isSet;
}

bool OAICashflows::is_descriptor_Valid() const{
    return m_descriptor_isValid;
}

OAIDigitalWallets OAICashflows::getDigitalWallets() const {
    return m_digital_wallets;
}
void OAICashflows::setDigitalWallets(const OAIDigitalWallets &digital_wallets) {
    m_digital_wallets = digital_wallets;
    m_digital_wallets_isSet = true;
}

bool OAICashflows::is_digital_wallets_Set() const{
    return m_digital_wallets_isSet;
}

bool OAICashflows::is_digital_wallets_Valid() const{
    return m_digital_wallets_isValid;
}

bool OAICashflows::isDynamicDescriptor() const {
    return m_dynamic_descriptor;
}
void OAICashflows::setDynamicDescriptor(const bool &dynamic_descriptor) {
    m_dynamic_descriptor = dynamic_descriptor;
    m_dynamic_descriptor_isSet = true;
}

bool OAICashflows::is_dynamic_descriptor_Set() const{
    return m_dynamic_descriptor_isSet;
}

bool OAICashflows::is_dynamic_descriptor_Valid() const{
    return m_dynamic_descriptor_isValid;
}

QList<QString> OAICashflows::getExcludedDccQuoteCurrencies() const {
    return m_excluded_dcc_quote_currencies;
}
void OAICashflows::setExcludedDccQuoteCurrencies(const QList<QString> &excluded_dcc_quote_currencies) {
    m_excluded_dcc_quote_currencies = excluded_dcc_quote_currencies;
    m_excluded_dcc_quote_currencies_isSet = true;
}

bool OAICashflows::is_excluded_dcc_quote_currencies_Set() const{
    return m_excluded_dcc_quote_currencies_isSet;
}

bool OAICashflows::is_excluded_dcc_quote_currencies_Valid() const{
    return m_excluded_dcc_quote_currencies_isValid;
}

OAIGatewayName OAICashflows::getGatewayName() const {
    return m_gateway_name;
}
void OAICashflows::setGatewayName(const OAIGatewayName &gateway_name) {
    m_gateway_name = gateway_name;
    m_gateway_name_isSet = true;
}

bool OAICashflows::is_gateway_name_Set() const{
    return m_gateway_name_isSet;
}

bool OAICashflows::is_gateway_name_Valid() const{
    return m_gateway_name_isValid;
}

QString OAICashflows::getId() const {
    return m_id;
}
void OAICashflows::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAICashflows::is_id_Set() const{
    return m_id_isSet;
}

bool OAICashflows::is_id_Valid() const{
    return m_id_isValid;
}

bool OAICashflows::isIsDown() const {
    return m_is_down;
}
void OAICashflows::setIsDown(const bool &is_down) {
    m_is_down = is_down;
    m_is_down_isSet = true;
}

bool OAICashflows::is_is_down_Set() const{
    return m_is_down_isSet;
}

bool OAICashflows::is_is_down_Valid() const{
    return m_is_down_isValid;
}

QString OAICashflows::getMerchantCategoryCode() const {
    return m_merchant_category_code;
}
void OAICashflows::setMerchantCategoryCode(const QString &merchant_category_code) {
    m_merchant_category_code = merchant_category_code;
    m_merchant_category_code_isSet = true;
}

bool OAICashflows::is_merchant_category_code_Set() const{
    return m_merchant_category_code_isSet;
}

bool OAICashflows::is_merchant_category_code_Valid() const{
    return m_merchant_category_code_isValid;
}

OAIPaymentMethod OAICashflows::getMethod() const {
    return m_method;
}
void OAICashflows::setMethod(const OAIPaymentMethod &method) {
    m_method = method;
    m_method_isSet = true;
}

bool OAICashflows::is_method_Set() const{
    return m_method_isSet;
}

bool OAICashflows::is_method_Valid() const{
    return m_method_isValid;
}

double OAICashflows::getMonthlyLimit() const {
    return m_monthly_limit;
}
void OAICashflows::setMonthlyLimit(const double &monthly_limit) {
    m_monthly_limit = monthly_limit;
    m_monthly_limit_isSet = true;
}

bool OAICashflows::is_monthly_limit_Set() const{
    return m_monthly_limit_isSet;
}

bool OAICashflows::is_monthly_limit_Valid() const{
    return m_monthly_limit_isValid;
}

QString OAICashflows::getOrganizationId() const {
    return m_organization_id;
}
void OAICashflows::setOrganizationId(const QString &organization_id) {
    m_organization_id = organization_id;
    m_organization_id_isSet = true;
}

bool OAICashflows::is_organization_id_Set() const{
    return m_organization_id_isSet;
}

bool OAICashflows::is_organization_id_Valid() const{
    return m_organization_id_isValid;
}

QList<OAIPaymentCardBrand> OAICashflows::getPaymentCardSchemes() const {
    return m_payment_card_schemes;
}
void OAICashflows::setPaymentCardSchemes(const QList<OAIPaymentCardBrand> &payment_card_schemes) {
    m_payment_card_schemes = payment_card_schemes;
    m_payment_card_schemes_isSet = true;
}

bool OAICashflows::is_payment_card_schemes_Set() const{
    return m_payment_card_schemes_isSet;
}

bool OAICashflows::is_payment_card_schemes_Valid() const{
    return m_payment_card_schemes_isValid;
}

bool OAICashflows::isReconciliationWindowEnabled() const {
    return m_reconciliation_window_enabled;
}
void OAICashflows::setReconciliationWindowEnabled(const bool &reconciliation_window_enabled) {
    m_reconciliation_window_enabled = reconciliation_window_enabled;
    m_reconciliation_window_enabled_isSet = true;
}

bool OAICashflows::is_reconciliation_window_enabled_Set() const{
    return m_reconciliation_window_enabled_isSet;
}

bool OAICashflows::is_reconciliation_window_enabled_Valid() const{
    return m_reconciliation_window_enabled_isValid;
}

qint32 OAICashflows::getReconciliationWindowTtl() const {
    return m_reconciliation_window_ttl;
}
void OAICashflows::setReconciliationWindowTtl(const qint32 &reconciliation_window_ttl) {
    m_reconciliation_window_ttl = reconciliation_window_ttl;
    m_reconciliation_window_ttl_isSet = true;
}

bool OAICashflows::is_reconciliation_window_ttl_Set() const{
    return m_reconciliation_window_ttl_isSet;
}

bool OAICashflows::is_reconciliation_window_ttl_Valid() const{
    return m_reconciliation_window_ttl_isValid;
}

QString OAICashflows::getStatus() const {
    return m_status;
}
void OAICashflows::setStatus(const QString &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAICashflows::is_status_Set() const{
    return m_status_isSet;
}

bool OAICashflows::is_status_Valid() const{
    return m_status_isValid;
}

bool OAICashflows::isSticky() const {
    return m_sticky;
}
void OAICashflows::setSticky(const bool &sticky) {
    m_sticky = sticky;
    m_sticky_isSet = true;
}

bool OAICashflows::is_sticky_Set() const{
    return m_sticky_isSet;
}

bool OAICashflows::is_sticky_Valid() const{
    return m_sticky_isValid;
}

bool OAICashflows::isThreeDSecure() const {
    return m_three_d_secure;
}
void OAICashflows::setThreeDSecure(const bool &three_d_secure) {
    m_three_d_secure = three_d_secure;
    m_three_d_secure_isSet = true;
}

bool OAICashflows::is_three_d_secure_Set() const{
    return m_three_d_secure_isSet;
}

bool OAICashflows::is_three_d_secure_Valid() const{
    return m_three_d_secure_isValid;
}

qint32 OAICashflows::getTimeout() const {
    return m_timeout;
}
void OAICashflows::setTimeout(const qint32 &timeout) {
    m_timeout = timeout;
    m_timeout_isSet = true;
}

bool OAICashflows::is_timeout_Set() const{
    return m_timeout_isSet;
}

bool OAICashflows::is_timeout_Valid() const{
    return m_timeout_isValid;
}

QString OAICashflows::getToken() const {
    return m_token;
}
void OAICashflows::setToken(const QString &token) {
    m_token = token;
    m_token_isSet = true;
}

bool OAICashflows::is_token_Set() const{
    return m_token_isSet;
}

bool OAICashflows::is_token_Valid() const{
    return m_token_isValid;
}

QDateTime OAICashflows::getUpdatedTime() const {
    return m_updated_time;
}
void OAICashflows::setUpdatedTime(const QDateTime &updated_time) {
    m_updated_time = updated_time;
    m_updated_time_isSet = true;
}

bool OAICashflows::is_updated_time_Set() const{
    return m_updated_time_isSet;
}

bool OAICashflows::is_updated_time_Valid() const{
    return m_updated_time_isValid;
}

OAICashflows_allOf_credentials OAICashflows::getCredentials() const {
    return m_credentials;
}
void OAICashflows::setCredentials(const OAICashflows_allOf_credentials &credentials) {
    m_credentials = credentials;
    m_credentials_isSet = true;
}

bool OAICashflows::is_credentials_Set() const{
    return m_credentials_isSet;
}

bool OAICashflows::is_credentials_Valid() const{
    return m_credentials_isValid;
}

bool OAICashflows::isSet() const {
...
bool OAICashflows::isValid() const {
