...
OAIAmexVPC::OAIAmexVPC(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAmexVPC::OAIAmexVPC() {
    this->initializeModel();
}

OAIAmexVPC::~OAIAmexVPC() {}

void OAIAmexVPC::initializeModel() {
...
void OAIAmexVPC::fromJson(QString jsonString) {
...
void OAIAmexVPC::fromJsonObject(QJsonObject json) {
...
QString OAIAmexVPC::asJson() const {
...
QJsonObject OAIAmexVPC::asJsonObject() const {
    QJsonObject obj;
    if (m__links.size() > 0) {
...
QList<OAIGatewayAccount__links_inner> OAIAmexVPC::getLinks() const {
    return m__links;
}
void OAIAmexVPC::setLinks(const QList<OAIGatewayAccount__links_inner> &_links) {
    m__links = _links;
    m__links_isSet = true;
}

bool OAIAmexVPC::is__links_Set() const{
    return m__links_isSet;
}

bool OAIAmexVPC::is__links_Valid() const{
    return m__links_isValid;
}

QList<QString> OAIAmexVPC::getAcceptedCurrencies() const {
    return m_accepted_currencies;
}
void OAIAmexVPC::setAcceptedCurrencies(const QList<QString> &accepted_currencies) {
    m_accepted_currencies = accepted_currencies;
    m_accepted_currencies_isSet = true;
}

bool OAIAmexVPC::is_accepted_currencies_Set() const{
    return m_accepted_currencies_isSet;
}

bool OAIAmexVPC::is_accepted_currencies_Valid() const{
    return m_accepted_currencies_isValid;
}

OAIAcquirerName OAIAmexVPC::getAcquirerName() const {
    return m_acquirer_name;
}
void OAIAmexVPC::setAcquirerName(const OAIAcquirerName &acquirer_name) {
    m_acquirer_name = acquirer_name;
    m_acquirer_name_isSet = true;
}

bool OAIAmexVPC::is_acquirer_name_Set() const{
    return m_acquirer_name_isSet;
}

bool OAIAmexVPC::is_acquirer_name_Valid() const{
    return m_acquirer_name_isValid;
}

QString OAIAmexVPC::getAdditionalFilters() const {
    return m_additional_filters;
}
void OAIAmexVPC::setAdditionalFilters(const QString &additional_filters) {
    m_additional_filters = additional_filters;
    m_additional_filters_isSet = true;
}

bool OAIAmexVPC::is_additional_filters_Set() const{
    return m_additional_filters_isSet;
}

bool OAIAmexVPC::is_additional_filters_Valid() const{
    return m_additional_filters_isValid;
}

qint32 OAIAmexVPC::getApprovalWindowTtl() const {
    return m_approval_window_ttl;
}
void OAIAmexVPC::setApprovalWindowTtl(const qint32 &approval_window_ttl) {
    m_approval_window_ttl = approval_window_ttl;
    m_approval_window_ttl_isSet = true;
}

bool OAIAmexVPC::is_approval_window_ttl_Set() const{
    return m_approval_window_ttl_isSet;
}

bool OAIAmexVPC::is_approval_window_ttl_Valid() const{
    return m_approval_window_ttl_isValid;
}

QString OAIAmexVPC::getCityField() const {
    return m_city_field;
}
void OAIAmexVPC::setCityField(const QString &city_field) {
    m_city_field = city_field;
    m_city_field_isSet = true;
}

bool OAIAmexVPC::is_city_field_Set() const{
    return m_city_field_isSet;
}

bool OAIAmexVPC::is_city_field_Valid() const{
    return m_city_field_isValid;
}

QDateTime OAIAmexVPC::getCreatedTime() const {
    return m_created_time;
}
void OAIAmexVPC::setCreatedTime(const QDateTime &created_time) {
    m_created_time = created_time;
    m_created_time_isSet = true;
}

bool OAIAmexVPC::is_created_time_Set() const{
    return m_created_time_isSet;
}

bool OAIAmexVPC::is_created_time_Valid() const{
    return m_created_time_isValid;
}

QString OAIAmexVPC::getDccForceCurrency() const {
    return m_dcc_force_currency;
}
void OAIAmexVPC::setDccForceCurrency(const QString &dcc_force_currency) {
    m_dcc_force_currency = dcc_force_currency;
    m_dcc_force_currency_isSet = true;
}

bool OAIAmexVPC::is_dcc_force_currency_Set() const{
    return m_dcc_force_currency_isSet;
}

bool OAIAmexVPC::is_dcc_force_currency_Valid() const{
    return m_dcc_force_currency_isValid;
}

qint32 OAIAmexVPC::getDccMarkup() const {
    return m_dcc_markup;
}
void OAIAmexVPC::setDccMarkup(const qint32 &dcc_markup) {
    m_dcc_markup = dcc_markup;
    m_dcc_markup_isSet = true;
}

bool OAIAmexVPC::is_dcc_markup_Set() const{
    return m_dcc_markup_isSet;
}

bool OAIAmexVPC::is_dcc_markup_Valid() const{
    return m_dcc_markup_isValid;
}

QString OAIAmexVPC::getDescriptor() const {
    return m_descriptor;
}
void OAIAmexVPC::setDescriptor(const QString &descriptor) {
    m_descriptor = descriptor;
    m_descriptor_isSet = true;
}

bool OAIAmexVPC::is_descriptor_Set() const{
    return m_descriptor_isSet;
}

bool OAIAmexVPC::is_descriptor_Valid() const{
    return m_descriptor_isValid;
}

OAIDigitalWallets OAIAmexVPC::getDigitalWallets() const {
    return m_digital_wallets;
}
void OAIAmexVPC::setDigitalWallets(const OAIDigitalWallets &digital_wallets) {
    m_digital_wallets = digital_wallets;
    m_digital_wallets_isSet = true;
}

bool OAIAmexVPC::is_digital_wallets_Set() const{
    return m_digital_wallets_isSet;
}

bool OAIAmexVPC::is_digital_wallets_Valid() const{
    return m_digital_wallets_isValid;
}

bool OAIAmexVPC::isDynamicDescriptor() const {
    return m_dynamic_descriptor;
}
void OAIAmexVPC::setDynamicDescriptor(const bool &dynamic_descriptor) {
    m_dynamic_descriptor = dynamic_descriptor;
    m_dynamic_descriptor_isSet = true;
}

bool OAIAmexVPC::is_dynamic_descriptor_Set() const{
    return m_dynamic_descriptor_isSet;
}

bool OAIAmexVPC::is_dynamic_descriptor_Valid() const{
    return m_dynamic_descriptor_isValid;
}

QList<QString> OAIAmexVPC::getExcludedDccQuoteCurrencies() const {
    return m_excluded_dcc_quote_currencies;
}
void OAIAmexVPC::setExcludedDccQuoteCurrencies(const QList<QString> &excluded_dcc_quote_currencies) {
    m_excluded_dcc_quote_currencies = excluded_dcc_quote_currencies;
    m_excluded_dcc_quote_currencies_isSet = true;
}

bool OAIAmexVPC::is_excluded_dcc_quote_currencies_Set() const{
    return m_excluded_dcc_quote_currencies_isSet;
}

bool OAIAmexVPC::is_excluded_dcc_quote_currencies_Valid() const{
    return m_excluded_dcc_quote_currencies_isValid;
}

OAIGatewayName OAIAmexVPC::getGatewayName() const {
    return m_gateway_name;
}
void OAIAmexVPC::setGatewayName(const OAIGatewayName &gateway_name) {
    m_gateway_name = gateway_name;
    m_gateway_name_isSet = true;
}

bool OAIAmexVPC::is_gateway_name_Set() const{
    return m_gateway_name_isSet;
}

bool OAIAmexVPC::is_gateway_name_Valid() const{
    return m_gateway_name_isValid;
}

QString OAIAmexVPC::getId() const {
    return m_id;
}
void OAIAmexVPC::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIAmexVPC::is_id_Set() const{
    return m_id_isSet;
}

bool OAIAmexVPC::is_id_Valid() const{
    return m_id_isValid;
}

bool OAIAmexVPC::isIsDown() const {
    return m_is_down;
}
void OAIAmexVPC::setIsDown(const bool &is_down) {
    m_is_down = is_down;
    m_is_down_isSet = true;
}

bool OAIAmexVPC::is_is_down_Set() const{
    return m_is_down_isSet;
}

bool OAIAmexVPC::is_is_down_Valid() const{
    return m_is_down_isValid;
}

QString OAIAmexVPC::getMerchantCategoryCode() const {
    return m_merchant_category_code;
}
void OAIAmexVPC::setMerchantCategoryCode(const QString &merchant_category_code) {
    m_merchant_category_code = merchant_category_code;
    m_merchant_category_code_isSet = true;
}

bool OAIAmexVPC::is_merchant_category_code_Set() const{
    return m_merchant_category_code_isSet;
}

bool OAIAmexVPC::is_merchant_category_code_Valid() const{
    return m_merchant_category_code_isValid;
}

OAIPaymentMethod OAIAmexVPC::getMethod() const {
    return m_method;
}
void OAIAmexVPC::setMethod(const OAIPaymentMethod &method) {
    m_method = method;
    m_method_isSet = true;
}

bool OAIAmexVPC::is_method_Set() const{
    return m_method_isSet;
}

bool OAIAmexVPC::is_method_Valid() const{
    return m_method_isValid;
}

double OAIAmexVPC::getMonthlyLimit() const {
    return m_monthly_limit;
}
void OAIAmexVPC::setMonthlyLimit(const double &monthly_limit) {
    m_monthly_limit = monthly_limit;
    m_monthly_limit_isSet = true;
}

bool OAIAmexVPC::is_monthly_limit_Set() const{
    return m_monthly_limit_isSet;
}

bool OAIAmexVPC::is_monthly_limit_Valid() const{
    return m_monthly_limit_isValid;
}

QString OAIAmexVPC::getOrganizationId() const {
    return m_organization_id;
}
void OAIAmexVPC::setOrganizationId(const QString &organization_id) {
    m_organization_id = organization_id;
    m_organization_id_isSet = true;
}

bool OAIAmexVPC::is_organization_id_Set() const{
    return m_organization_id_isSet;
}

bool OAIAmexVPC::is_organization_id_Valid() const{
    return m_organization_id_isValid;
}

QList<OAIPaymentCardBrand> OAIAmexVPC::getPaymentCardSchemes() const {
    return m_payment_card_schemes;
}
void OAIAmexVPC::setPaymentCardSchemes(const QList<OAIPaymentCardBrand> &payment_card_schemes) {
    m_payment_card_schemes = payment_card_schemes;
    m_payment_card_schemes_isSet = true;
}

bool OAIAmexVPC::is_payment_card_schemes_Set() const{
    return m_payment_card_schemes_isSet;
}

bool OAIAmexVPC::is_payment_card_schemes_Valid() const{
    return m_payment_card_schemes_isValid;
}

bool OAIAmexVPC::isReconciliationWindowEnabled() const {
    return m_reconciliation_window_enabled;
}
void OAIAmexVPC::setReconciliationWindowEnabled(const bool &reconciliation_window_enabled) {
    m_reconciliation_window_enabled = reconciliation_window_enabled;
    m_reconciliation_window_enabled_isSet = true;
}

bool OAIAmexVPC::is_reconciliation_window_enabled_Set() const{
    return m_reconciliation_window_enabled_isSet;
}

bool OAIAmexVPC::is_reconciliation_window_enabled_Valid() const{
    return m_reconciliation_window_enabled_isValid;
}

qint32 OAIAmexVPC::getReconciliationWindowTtl() const {
    return m_reconciliation_window_ttl;
}
void OAIAmexVPC::setReconciliationWindowTtl(const qint32 &reconciliation_window_ttl) {
    m_reconciliation_window_ttl = reconciliation_window_ttl;
    m_reconciliation_window_ttl_isSet = true;
}

bool OAIAmexVPC::is_reconciliation_window_ttl_Set() const{
    return m_reconciliation_window_ttl_isSet;
}

bool OAIAmexVPC::is_reconciliation_window_ttl_Valid() const{
    return m_reconciliation_window_ttl_isValid;
}

QString OAIAmexVPC::getStatus() const {
    return m_status;
}
void OAIAmexVPC::setStatus(const QString &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIAmexVPC::is_status_Set() const{
    return m_status_isSet;
}

bool OAIAmexVPC::is_status_Valid() const{
    return m_status_isValid;
}

bool OAIAmexVPC::isSticky() const {
    return m_sticky;
}
void OAIAmexVPC::setSticky(const bool &sticky) {
    m_sticky = sticky;
    m_sticky_isSet = true;
}

bool OAIAmexVPC::is_sticky_Set() const{
    return m_sticky_isSet;
}

bool OAIAmexVPC::is_sticky_Valid() const{
    return m_sticky_isValid;
}

bool OAIAmexVPC::isThreeDSecure() const {
    return m_three_d_secure;
}
void OAIAmexVPC::setThreeDSecure(const bool &three_d_secure) {
    m_three_d_secure = three_d_secure;
    m_three_d_secure_isSet = true;
}

bool OAIAmexVPC::is_three_d_secure_Set() const{
    return m_three_d_secure_isSet;
}

bool OAIAmexVPC::is_three_d_secure_Valid() const{
    return m_three_d_secure_isValid;
}

qint32 OAIAmexVPC::getTimeout() const {
    return m_timeout;
}
void OAIAmexVPC::setTimeout(const qint32 &timeout) {
    m_timeout = timeout;
    m_timeout_isSet = true;
}

bool OAIAmexVPC::is_timeout_Set() const{
    return m_timeout_isSet;
}

bool OAIAmexVPC::is_timeout_Valid() const{
    return m_timeout_isValid;
}

QString OAIAmexVPC::getToken() const {
    return m_token;
}
void OAIAmexVPC::setToken(const QString &token) {
    m_token = token;
    m_token_isSet = true;
}

bool OAIAmexVPC::is_token_Set() const{
    return m_token_isSet;
}

bool OAIAmexVPC::is_token_Valid() const{
    return m_token_isValid;
}

QDateTime OAIAmexVPC::getUpdatedTime() const {
    return m_updated_time;
}
void OAIAmexVPC::setUpdatedTime(const QDateTime &updated_time) {
    m_updated_time = updated_time;
    m_updated_time_isSet = true;
}

bool OAIAmexVPC::is_updated_time_Set() const{
    return m_updated_time_isSet;
}

bool OAIAmexVPC::is_updated_time_Valid() const{
    return m_updated_time_isValid;
}

OAIAmexVPC_allOf_credentials OAIAmexVPC::getCredentials() const {
    return m_credentials;
}
void OAIAmexVPC::setCredentials(const OAIAmexVPC_allOf_credentials &credentials) {
    m_credentials = credentials;
    m_credentials_isSet = true;
}

bool OAIAmexVPC::is_credentials_Set() const{
    return m_credentials_isSet;
}

bool OAIAmexVPC::is_credentials_Valid() const{
    return m_credentials_isValid;
}

OAIAmexVPC_allOf_settings OAIAmexVPC::getSettings() const {
    return m_settings;
}
void OAIAmexVPC::setSettings(const OAIAmexVPC_allOf_settings &settings) {
    m_settings = settings;
    m_settings_isSet = true;
}

bool OAIAmexVPC::is_settings_Set() const{
    return m_settings_isSet;
}

bool OAIAmexVPC::is_settings_Valid() const{
    return m_settings_isValid;
}

bool OAIAmexVPC::isSet() const {
