...
class OAIAirpay_allOf_credentials;

class OAIAirpay : public OAIObject {
public:
    OAIAirpay();
    OAIAirpay(QString json);
    ~OAIAirpay() override;
    ...
    OAIAirpay_allOf_credentials getCredentials() const;
    void setCredentials(const OAIAirpay_allOf_credentials &credentials);
...
private:
    ...
    OAIAirpay_allOf_credentials m_credentials;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAirpay)
