...
#ifndef OAISparkPay_H
#define OAISparkPay_H
...
class OAISparkPay_allOf_credentials;

class OAISparkPay : public OAIObject {
public:
    OAISparkPay();
    OAISparkPay(QString json);
    ~OAISparkPay() override;
    ...
    OAISparkPay_allOf_credentials getCredentials() const;
    void setCredentials(const OAISparkPay_allOf_credentials &credentials);
...
private:
    ...
    OAISparkPay_allOf_credentials m_credentials;
...
Q_DECLARE_METATYPE(OpenAPI::OAISparkPay)
