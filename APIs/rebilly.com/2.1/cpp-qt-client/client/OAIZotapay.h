...
class OAIZotapay_allOf_credentials;

class OAIZotapay : public OAIObject {
public:
    OAIZotapay();
    OAIZotapay(QString json);
    ~OAIZotapay() override;
    ...
    OAIZotapay_allOf_credentials getCredentials() const;
    void setCredentials(const OAIZotapay_allOf_credentials &credentials);
...
private:
    ...
    OAIZotapay_allOf_credentials m_credentials;
...
Q_DECLARE_METATYPE(OpenAPI::OAIZotapay)
