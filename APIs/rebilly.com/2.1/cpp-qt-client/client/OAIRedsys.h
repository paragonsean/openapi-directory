...
class OAIRedsys_allOf_credentials;

class OAIRedsys : public OAIObject {
public:
    OAIRedsys();
    OAIRedsys(QString json);
    ~OAIRedsys() override;
    ...
    OAIRedsys_allOf_credentials getCredentials() const;
    void setCredentials(const OAIRedsys_allOf_credentials &credentials);
...
private:
    ...
    OAIRedsys_allOf_credentials m_credentials;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRedsys)
