...
/*
 * OAIXPay_allOf_credentials.h
 *
 * XPay credentials object.
 */

#ifndef OAIXPay_allOf_credentials_H
#define OAIXPay_allOf_credentials_H
...
class OAIXPay_allOf_credentials : public OAIObject {
public:
    OAIXPay_allOf_credentials();
    OAIXPay_allOf_credentials(QString json);
    ~OAIXPay_allOf_credentials() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIXPay_allOf_credentials)

#endif // OAIXPay_allOf_credentials_H
