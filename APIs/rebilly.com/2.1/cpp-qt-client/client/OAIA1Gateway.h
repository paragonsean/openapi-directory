...
#ifndef OAIA1Gateway_H
#define OAIA1Gateway_H

#include <QJsonObject>

#include "OAIA1Gateway3dsServers.h"
#include "OAIA1Gateway_allOf_credentials.h"
...
class OAIA1Gateway_allOf_credentials;
class OAIA1Gateway3dsServers;

class OAIA1Gateway : public OAIObject {
public:
    OAIA1Gateway();
    OAIA1Gateway(QString json);
    ~OAIA1Gateway() override;
    ...
    OAIA1Gateway_allOf_credentials getCredentials() const;
    void setCredentials(const OAIA1Gateway_allOf_credentials &credentials);
    bool is_credentials_Set() const;
    bool is_credentials_Valid() const;

    OAIA1Gateway3dsServers getThreeDSecureServer() const;
    void setThreeDSecureServer(const OAIA1Gateway3dsServers &three_d_secure_server);
...
private:
    ...
    OAIA1Gateway_allOf_credentials m_credentials;
    bool m_credentials_isSet;
    bool m_credentials_isValid;

    OAIA1Gateway3dsServers m_three_d_secure_server;
...
Q_DECLARE_METATYPE(OpenAPI::OAIA1Gateway)

#endif // OAIA1Gateway_H
