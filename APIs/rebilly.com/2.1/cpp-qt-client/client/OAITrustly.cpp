...
OAITrustly::OAITrustly(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAITrustly::OAITrustly() {
    this->initializeModel();
}

OAITrustly::~OAITrustly() {}

void OAITrustly::initializeModel() {
...
void OAITrustly::fromJson(QString jsonString) {
...
void OAITrustly::fromJsonObject(QJsonObject json) {
...
QString OAITrustly::asJson() const {
...
QJsonObject OAITrustly::asJsonObject() const {
    QJsonObject obj;
    if (m__links.size() > 0) {
...
QList<OAIGatewayAccount__links_inner> OAITrustly::getLinks() const {
    return m__links;
}
void OAITrustly::setLinks(const QList<OAIGatewayAccount__links_inner> &_links) {
    m__links = _links;
    m__links_isSet = true;
}

bool OAITrustly::is__links_Set() const{
    return m__links_isSet;
}

bool OAITrustly::is__links_Valid() const{
    return m__links_isValid;
}

QList<QString> OAITrustly::getAcceptedCurrencies() const {
    return m_accepted_currencies;
}
void OAITrustly::setAcceptedCurrencies(const QList<QString> &accepted_currencies) {
    m_accepted_currencies = accepted_currencies;
    m_accepted_currencies_isSet = true;
}

bool OAITrustly::is_accepted_currencies_Set() const{
    return m_accepted_currencies_isSet;
}

bool OAITrustly::is_accepted_currencies_Valid() const{
    return m_accepted_currencies_isValid;
}

OAIAcquirerName OAITrustly::getAcquirerName() const {
    return m_acquirer_name;
}
void OAITrustly::setAcquirerName(const OAIAcquirerName &acquirer_name) {
    m_acquirer_name = acquirer_name;
    m_acquirer_name_isSet = true;
}

bool OAITrustly::is_acquirer_name_Set() const{
    return m_acquirer_name_isSet;
}

bool OAITrustly::is_acquirer_name_Valid() const{
    return m_acquirer_name_isValid;
}

QString OAITrustly::getAdditionalFilters() const {
    return m_additional_filters;
}
void OAITrustly::setAdditionalFilters(const QString &additional_filters) {
    m_additional_filters = additional_filters;
    m_additional_filters_isSet = true;
}

bool OAITrustly::is_additional_filters_Set() const{
    return m_additional_filters_isSet;
}

bool OAITrustly::is_additional_filters_Valid() const{
    return m_additional_filters_isValid;
}

qint32 OAITrustly::getApprovalWindowTtl() const {
    return m_approval_window_ttl;
}
void OAITrustly::setApprovalWindowTtl(const qint32 &approval_window_ttl) {
    m_approval_window_ttl = approval_window_ttl;
    m_approval_window_ttl_isSet = true;
}

bool OAITrustly::is_approval_window_ttl_Set() const{
    return m_approval_window_ttl_isSet;
}

bool OAITrustly::is_approval_window_ttl_Valid() const{
    return m_approval_window_ttl_isValid;
}

QString OAITrustly::getCityField() const {
    return m_city_field;
}
void OAITrustly::setCityField(const QString &city_field) {
    m_city_field = city_field;
    m_city_field_isSet = true;
}

bool OAITrustly::is_city_field_Set() const{
    return m_city_field_isSet;
}

bool OAITrustly::is_city_field_Valid() const{
    return m_city_field_isValid;
}

QDateTime OAITrustly::getCreatedTime() const {
    return m_created_time;
}
void OAITrustly::setCreatedTime(const QDateTime &created_time) {
    m_created_time = created_time;
    m_created_time_isSet = true;
}

bool OAITrustly::is_created_time_Set() const{
    return m_created_time_isSet;
}

bool OAITrustly::is_created_time_Valid() const{
    return m_created_time_isValid;
}

QString OAITrustly::getDccForceCurrency() const {
    return m_dcc_force_currency;
}
void OAITrustly::setDccForceCurrency(const QString &dcc_force_currency) {
    m_dcc_force_currency = dcc_force_currency;
    m_dcc_force_currency_isSet = true;
}

bool OAITrustly::is_dcc_force_currency_Set() const{
    return m_dcc_force_currency_isSet;
}

bool OAITrustly::is_dcc_force_currency_Valid() const{
    return m_dcc_force_currency_isValid;
}

qint32 OAITrustly::getDccMarkup() const {
    return m_dcc_markup;
}
void OAITrustly::setDccMarkup(const qint32 &dcc_markup) {
    m_dcc_markup = dcc_markup;
    m_dcc_markup_isSet = true;
}

bool OAITrustly::is_dcc_markup_Set() const{
    return m_dcc_markup_isSet;
}

bool OAITrustly::is_dcc_markup_Valid() const{
    return m_dcc_markup_isValid;
}

QString OAITrustly::getDescriptor() const {
    return m_descriptor;
}
void OAITrustly::setDescriptor(const QString &descriptor) {
    m_descriptor = descriptor;
    m_descriptor_isSet = true;
}

bool OAITrustly::is_descriptor_Set() const{
    return m_descriptor_isSet;
}

bool OAITrustly::is_descriptor_Valid() const{
    return m_descriptor_isValid;
}

OAIDigitalWallets OAITrustly::getDigitalWallets() const {
    return m_digital_wallets;
}
void OAITrustly::setDigitalWallets(const OAIDigitalWallets &digital_wallets) {
    m_digital_wallets = digital_wallets;
    m_digital_wallets_isSet = true;
}

bool OAITrustly::is_digital_wallets_Set() const{
    return m_digital_wallets_isSet;
}

bool OAITrustly::is_digital_wallets_Valid() const{
    return m_digital_wallets_isValid;
}

bool OAITrustly::isDynamicDescriptor() const {
    return m_dynamic_descriptor;
}
void OAITrustly::setDynamicDescriptor(const bool &dynamic_descriptor) {
    m_dynamic_descriptor = dynamic_descriptor;
    m_dynamic_descriptor_isSet = true;
}

bool OAITrustly::is_dynamic_descriptor_Set() const{
    return m_dynamic_descriptor_isSet;
}

bool OAITrustly::is_dynamic_descriptor_Valid() const{
    return m_dynamic_descriptor_isValid;
}

QList<QString> OAITrustly::getExcludedDccQuoteCurrencies() const {
    return m_excluded_dcc_quote_currencies;
}
void OAITrustly::setExcludedDccQuoteCurrencies(const QList<QString> &excluded_dcc_quote_currencies) {
    m_excluded_dcc_quote_currencies = excluded_dcc_quote_currencies;
    m_excluded_dcc_quote_currencies_isSet = true;
}

bool OAITrustly::is_excluded_dcc_quote_currencies_Set() const{
    return m_excluded_dcc_quote_currencies_isSet;
}

bool OAITrustly::is_excluded_dcc_quote_currencies_Valid() const{
    return m_excluded_dcc_quote_currencies_isValid;
}

OAIGatewayName OAITrustly::getGatewayName() const {
    return m_gateway_name;
}
void OAITrustly::setGatewayName(const OAIGatewayName &gateway_name) {
    m_gateway_name = gateway_name;
    m_gateway_name_isSet = true;
}

bool OAITrustly::is_gateway_name_Set() const{
    return m_gateway_name_isSet;
}

bool OAITrustly::is_gateway_name_Valid() const{
    return m_gateway_name_isValid;
}

QString OAITrustly::getId() const {
    return m_id;
}
void OAITrustly::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAITrustly::is_id_Set() const{
    return m_id_isSet;
}

bool OAITrustly::is_id_Valid() const{
    return m_id_isValid;
}

bool OAITrustly::isIsDown() const {
    return m_is_down;
}
void OAITrustly::setIsDown(const bool &is_down) {
    m_is_down = is_down;
    m_is_down_isSet = true;
}

bool OAITrustly::is_is_down_Set() const{
    return m_is_down_isSet;
}

bool OAITrustly::is_is_down_Valid() const{
    return m_is_down_isValid;
}

QString OAITrustly::getMerchantCategoryCode() const {
    return m_merchant_category_code;
}
void OAITrustly::setMerchantCategoryCode(const QString &merchant_category_code) {
    m_merchant_category_code = merchant_category_code;
    m_merchant_category_code_isSet = true;
}

bool OAITrustly::is_merchant_category_code_Set() const{
    return m_merchant_category_code_isSet;
}

bool OAITrustly::is_merchant_category_code_Valid() const{
    return m_merchant_category_code_isValid;
}

OAIPaymentMethod OAITrustly::getMethod() const {
    return m_method;
}
void OAITrustly::setMethod(const OAIPaymentMethod &method) {
    m_method = method;
    m_method_isSet = true;
}

bool OAITrustly::is_method_Set() const{
    return m_method_isSet;
}

bool OAITrustly::is_method_Valid() const{
    return m_method_isValid;
}

double OAITrustly::getMonthlyLimit() const {
    return m_monthly_limit;
}
void OAITrustly::setMonthlyLimit(const double &monthly_limit) {
    m_monthly_limit = monthly_limit;
    m_monthly_limit_isSet = true;
}

bool OAITrustly::is_monthly_limit_Set() const{
    return m_monthly_limit_isSet;
}

bool OAITrustly::is_monthly_limit_Valid() const{
    return m_monthly_limit_isValid;
}

QString OAITrustly::getOrganizationId() const {
    return m_organization_id;
}
void OAITrustly::setOrganizationId(const QString &organization_id) {
    m_organization_id = organization_id;
    m_organization_id_isSet = true;
}

bool OAITrustly::is_organization_id_Set() const{
    return m_organization_id_isSet;
}

bool OAITrustly::is_organization_id_Valid() const{
    return m_organization_id_isValid;
}

QList<OAIPaymentCardBrand> OAITrustly::getPaymentCardSchemes() const {
    return m_payment_card_schemes;
}
void OAITrustly::setPaymentCardSchemes(const QList<OAIPaymentCardBrand> &payment_card_schemes) {
    m_payment_card_schemes = payment_card_schemes;
    m_payment_card_schemes_isSet = true;
}

bool OAITrustly::is_payment_card_schemes_Set() const{
    return m_payment_card_schemes_isSet;
}

bool OAITrustly::is_payment_card_schemes_Valid() const{
    return m_payment_card_schemes_isValid;
}

bool OAITrustly::isReconciliationWindowEnabled() const {
    return m_reconciliation_window_enabled;
}
void OAITrustly::setReconciliationWindowEnabled(const bool &reconciliation_window_enabled) {
    m_reconciliation_window_enabled = reconciliation_window_enabled;
    m_reconciliation_window_enabled_isSet = true;
}

bool OAITrustly::is_reconciliation_window_enabled_Set() const{
    return m_reconciliation_window_enabled_isSet;
}

bool OAITrustly::is_reconciliation_window_enabled_Valid() const{
    return m_reconciliation_window_enabled_isValid;
}

qint32 OAITrustly::getReconciliationWindowTtl() const {
    return m_reconciliation_window_ttl;
}
void OAITrustly::setReconciliationWindowTtl(const qint32 &reconciliation_window_ttl) {
    m_reconciliation_window_ttl = reconciliation_window_ttl;
    m_reconciliation_window_ttl_isSet = true;
}

bool OAITrustly::is_reconciliation_window_ttl_Set() const{
    return m_reconciliation_window_ttl_isSet;
}

bool OAITrustly::is_reconciliation_window_ttl_Valid() const{
    return m_reconciliation_window_ttl_isValid;
}

QString OAITrustly::getStatus() const {
    return m_status;
}
void OAITrustly::setStatus(const QString &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAITrustly::is_status_Set() const{
    return m_status_isSet;
}

bool OAITrustly::is_status_Valid() const{
    return m_status_isValid;
}

bool OAITrustly::isSticky() const {
    return m_sticky;
}
void OAITrustly::setSticky(const bool &sticky) {
    m_sticky = sticky;
    m_sticky_isSet = true;
}

bool OAITrustly::is_sticky_Set() const{
    return m_sticky_isSet;
}

bool OAITrustly::is_sticky_Valid() const{
    return m_sticky_isValid;
}

bool OAITrustly::isThreeDSecure() const {
    return m_three_d_secure;
}
void OAITrustly::setThreeDSecure(const bool &three_d_secure) {
    m_three_d_secure = three_d_secure;
    m_three_d_secure_isSet = true;
}

bool OAITrustly::is_three_d_secure_Set() const{
    return m_three_d_secure_isSet;
}

bool OAITrustly::is_three_d_secure_Valid() const{
    return m_three_d_secure_isValid;
}

qint32 OAITrustly::getTimeout() const {
    return m_timeout;
}
void OAITrustly::setTimeout(const qint32 &timeout) {
    m_timeout = timeout;
    m_timeout_isSet = true;
}

bool OAITrustly::is_timeout_Set() const{
    return m_timeout_isSet;
}

bool OAITrustly::is_timeout_Valid() const{
    return m_timeout_isValid;
}

QString OAITrustly::getToken() const {
    return m_token;
}
void OAITrustly::setToken(const QString &token) {
    m_token = token;
    m_token_isSet = true;
}

bool OAITrustly::is_token_Set() const{
    return m_token_isSet;
}

bool OAITrustly::is_token_Valid() const{
    return m_token_isValid;
}

QDateTime OAITrustly::getUpdatedTime() const {
    return m_updated_time;
}
void OAITrustly::setUpdatedTime(const QDateTime &updated_time) {
    m_updated_time = updated_time;
    m_updated_time_isSet = true;
}

bool OAITrustly::is_updated_time_Set() const{
    return m_updated_time_isSet;
}

bool OAITrustly::is_updated_time_Valid() const{
    return m_updated_time_isValid;
}

OAITrustly_allOf_credentials OAITrustly::getCredentials() const {
    return m_credentials;
}
void OAITrustly::setCredentials(const OAITrustly_allOf_credentials &credentials) {
    m_credentials = credentials;
    m_credentials_isSet = true;
}

bool OAITrustly::is_credentials_Set() const{
    return m_credentials_isSet;
}

bool OAITrustly::is_credentials_Valid() const{
    return m_credentials_isValid;
}

bool OAITrustly::isSet() const {
