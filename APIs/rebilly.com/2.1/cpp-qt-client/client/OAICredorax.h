...
#ifndef OAICredorax_H
#define OAICredorax_H
...
class OAICredorax_allOf_credentials;

class OAICredorax : public OAIObject {
public:
    OAICredorax();
    OAICredorax(QString json);
    ~OAICredorax() override;
    ...
    OAICredorax_allOf_credentials getCredentials() const;
    void setCredentials(const OAICredorax_allOf_credentials &credentials);
...
private:
    ...
    OAICredorax_allOf_credentials m_credentials;
...
Q_DECLARE_METATYPE(OpenAPI::OAICredorax)
