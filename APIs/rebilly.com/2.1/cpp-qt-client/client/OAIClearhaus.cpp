...
OAIClearhaus::OAIClearhaus(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIClearhaus::OAIClearhaus() {
    this->initializeModel();
}

OAIClearhaus::~OAIClearhaus() {}

void OAIClearhaus::initializeModel() {
...
void OAIClearhaus::fromJson(QString jsonString) {
...
void OAIClearhaus::fromJsonObject(QJsonObject json) {
...
QString OAIClearhaus::asJson() const {
...
QJsonObject OAIClearhaus::asJsonObject() const {
    QJsonObject obj;
    if (m__links.size() > 0) {
...
QList<OAIGatewayAccount__links_inner> OAIClearhaus::getLinks() const {
    return m__links;
}
void OAIClearhaus::setLinks(const QList<OAIGatewayAccount__links_inner> &_links) {
    m__links = _links;
    m__links_isSet = true;
}

bool OAIClearhaus::is__links_Set() const{
    return m__links_isSet;
}

bool OAIClearhaus::is__links_Valid() const{
    return m__links_isValid;
}

QList<QString> OAIClearhaus::getAcceptedCurrencies() const {
    return m_accepted_currencies;
}
void OAIClearhaus::setAcceptedCurrencies(const QList<QString> &accepted_currencies) {
    m_accepted_currencies = accepted_currencies;
    m_accepted_currencies_isSet = true;
}

bool OAIClearhaus::is_accepted_currencies_Set() const{
    return m_accepted_currencies_isSet;
}

bool OAIClearhaus::is_accepted_currencies_Valid() const{
    return m_accepted_currencies_isValid;
}

OAIAcquirerName OAIClearhaus::getAcquirerName() const {
    return m_acquirer_name;
}
void OAIClearhaus::setAcquirerName(const OAIAcquirerName &acquirer_name) {
    m_acquirer_name = acquirer_name;
    m_acquirer_name_isSet = true;
}

bool OAIClearhaus::is_acquirer_name_Set() const{
    return m_acquirer_name_isSet;
}

bool OAIClearhaus::is_acquirer_name_Valid() const{
    return m_acquirer_name_isValid;
}

QString OAIClearhaus::getAdditionalFilters() const {
    return m_additional_filters;
}
void OAIClearhaus::setAdditionalFilters(const QString &additional_filters) {
    m_additional_filters = additional_filters;
    m_additional_filters_isSet = true;
}

bool OAIClearhaus::is_additional_filters_Set() const{
    return m_additional_filters_isSet;
}

bool OAIClearhaus::is_additional_filters_Valid() const{
    return m_additional_filters_isValid;
}

qint32 OAIClearhaus::getApprovalWindowTtl() const {
    return m_approval_window_ttl;
}
void OAIClearhaus::setApprovalWindowTtl(const qint32 &approval_window_ttl) {
    m_approval_window_ttl = approval_window_ttl;
    m_approval_window_ttl_isSet = true;
}

bool OAIClearhaus::is_approval_window_ttl_Set() const{
    return m_approval_window_ttl_isSet;
}

bool OAIClearhaus::is_approval_window_ttl_Valid() const{
    return m_approval_window_ttl_isValid;
}

QString OAIClearhaus::getCityField() const {
    return m_city_field;
}
void OAIClearhaus::setCityField(const QString &city_field) {
    m_city_field = city_field;
    m_city_field_isSet = true;
}

bool OAIClearhaus::is_city_field_Set() const{
    return m_city_field_isSet;
}

bool OAIClearhaus::is_city_field_Valid() const{
    return m_city_field_isValid;
}

QDateTime OAIClearhaus::getCreatedTime() const {
    return m_created_time;
}
void OAIClearhaus::setCreatedTime(const QDateTime &created_time) {
    m_created_time = created_time;
    m_created_time_isSet = true;
}

bool OAIClearhaus::is_created_time_Set() const{
    return m_created_time_isSet;
}

bool OAIClearhaus::is_created_time_Valid() const{
    return m_created_time_isValid;
}

QString OAIClearhaus::getDccForceCurrency() const {
    return m_dcc_force_currency;
}
void OAIClearhaus::setDccForceCurrency(const QString &dcc_force_currency) {
    m_dcc_force_currency = dcc_force_currency;
    m_dcc_force_currency_isSet = true;
}

bool OAIClearhaus::is_dcc_force_currency_Set() const{
    return m_dcc_force_currency_isSet;
}

bool OAIClearhaus::is_dcc_force_currency_Valid() const{
    return m_dcc_force_currency_isValid;
}

qint32 OAIClearhaus::getDccMarkup() const {
    return m_dcc_markup;
}
void OAIClearhaus::setDccMarkup(const qint32 &dcc_markup) {
    m_dcc_markup = dcc_markup;
    m_dcc_markup_isSet = true;
}

bool OAIClearhaus::is_dcc_markup_Set() const{
    return m_dcc_markup_isSet;
}

bool OAIClearhaus::is_dcc_markup_Valid() const{
    return m_dcc_markup_isValid;
}

QString OAIClearhaus::getDescriptor() const {
    return m_descriptor;
}
void OAIClearhaus::setDescriptor(const QString &descriptor) {
    m_descriptor = descriptor;
    m_descriptor_isSet = true;
}

bool OAIClearhaus::is_descriptor_Set() const{
    return m_descriptor_isSet;
}

bool OAIClearhaus::is_descriptor_Valid() const{
    return m_descriptor_isValid;
}

OAIDigitalWallets OAIClearhaus::getDigitalWallets() const {
    return m_digital_wallets;
}
void OAIClearhaus::setDigitalWallets(const OAIDigitalWallets &digital_wallets) {
    m_digital_wallets = digital_wallets;
    m_digital_wallets_isSet = true;
}

bool OAIClearhaus::is_digital_wallets_Set() const{
    return m_digital_wallets_isSet;
}

bool OAIClearhaus::is_digital_wallets_Valid() const{
    return m_digital_wallets_isValid;
}

bool OAIClearhaus::isDynamicDescriptor() const {
    return m_dynamic_descriptor;
}
void OAIClearhaus::setDynamicDescriptor(const bool &dynamic_descriptor) {
    m_dynamic_descriptor = dynamic_descriptor;
    m_dynamic_descriptor_isSet = true;
}

bool OAIClearhaus::is_dynamic_descriptor_Set() const{
    return m_dynamic_descriptor_isSet;
}

bool OAIClearhaus::is_dynamic_descriptor_Valid() const{
    return m_dynamic_descriptor_isValid;
}

QList<QString> OAIClearhaus::getExcludedDccQuoteCurrencies() const {
    return m_excluded_dcc_quote_currencies;
}
void OAIClearhaus::setExcludedDccQuoteCurrencies(const QList<QString> &excluded_dcc_quote_currencies) {
    m_excluded_dcc_quote_currencies = excluded_dcc_quote_currencies;
    m_excluded_dcc_quote_currencies_isSet = true;
}

bool OAIClearhaus::is_excluded_dcc_quote_currencies_Set() const{
    return m_excluded_dcc_quote_currencies_isSet;
}

bool OAIClearhaus::is_excluded_dcc_quote_currencies_Valid() const{
    return m_excluded_dcc_quote_currencies_isValid;
}

OAIGatewayName OAIClearhaus::getGatewayName() const {
    return m_gateway_name;
}
void OAIClearhaus::setGatewayName(const OAIGatewayName &gateway_name) {
    m_gateway_name = gateway_name;
    m_gateway_name_isSet = true;
}

bool OAIClearhaus::is_gateway_name_Set() const{
    return m_gateway_name_isSet;
}

bool OAIClearhaus::is_gateway_name_Valid() const{
    return m_gateway_name_isValid;
}

QString OAIClearhaus::getId() const {
    return m_id;
}
void OAIClearhaus::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIClearhaus::is_id_Set() const{
    return m_id_isSet;
}

bool OAIClearhaus::is_id_Valid() const{
    return m_id_isValid;
}

bool OAIClearhaus::isIsDown() const {
    return m_is_down;
}
void OAIClearhaus::setIsDown(const bool &is_down) {
    m_is_down = is_down;
    m_is_down_isSet = true;
}

bool OAIClearhaus::is_is_down_Set() const{
    return m_is_down_isSet;
}

bool OAIClearhaus::is_is_down_Valid() const{
    return m_is_down_isValid;
}

QString OAIClearhaus::getMerchantCategoryCode() const {
    return m_merchant_category_code;
}
void OAIClearhaus::setMerchantCategoryCode(const QString &merchant_category_code) {
    m_merchant_category_code = merchant_category_code;
    m_merchant_category_code_isSet = true;
}

bool OAIClearhaus::is_merchant_category_code_Set() const{
    return m_merchant_category_code_isSet;
}

bool OAIClearhaus::is_merchant_category_code_Valid() const{
    return m_merchant_category_code_isValid;
}

OAIPaymentMethod OAIClearhaus::getMethod() const {
    return m_method;
}
void OAIClearhaus::setMethod(const OAIPaymentMethod &method) {
    m_method = method;
    m_method_isSet = true;
}

bool OAIClearhaus::is_method_Set() const{
    return m_method_isSet;
}

bool OAIClearhaus::is_method_Valid() const{
    return m_method_isValid;
}

double OAIClearhaus::getMonthlyLimit() const {
    return m_monthly_limit;
}
void OAIClearhaus::setMonthlyLimit(const double &monthly_limit) {
    m_monthly_limit = monthly_limit;
    m_monthly_limit_isSet = true;
}

bool OAIClearhaus::is_monthly_limit_Set() const{
    return m_monthly_limit_isSet;
}

bool OAIClearhaus::is_monthly_limit_Valid() const{
    return m_monthly_limit_isValid;
}

QString OAIClearhaus::getOrganizationId() const {
    return m_organization_id;
}
void OAIClearhaus::setOrganizationId(const QString &organization_id) {
    m_organization_id = organization_id;
    m_organization_id_isSet = true;
}

bool OAIClearhaus::is_organization_id_Set() const{
    return m_organization_id_isSet;
}

bool OAIClearhaus::is_organization_id_Valid() const{
    return m_organization_id_isValid;
}

QList<OAIPaymentCardBrand> OAIClearhaus::getPaymentCardSchemes() const {
    return m_payment_card_schemes;
}
void OAIClearhaus::setPaymentCardSchemes(const QList<OAIPaymentCardBrand> &payment_card_schemes) {
    m_payment_card_schemes = payment_card_schemes;
    m_payment_card_schemes_isSet = true;
}

bool OAIClearhaus::is_payment_card_schemes_Set() const{
    return m_payment_card_schemes_isSet;
}

bool OAIClearhaus::is_payment_card_schemes_Valid() const{
    return m_payment_card_schemes_isValid;
}

bool OAIClearhaus::isReconciliationWindowEnabled() const {
    return m_reconciliation_window_enabled;
}
void OAIClearhaus::setReconciliationWindowEnabled(const bool &reconciliation_window_enabled) {
    m_reconciliation_window_enabled = reconciliation_window_enabled;
    m_reconciliation_window_enabled_isSet = true;
}

bool OAIClearhaus::is_reconciliation_window_enabled_Set() const{
    return m_reconciliation_window_enabled_isSet;
}

bool OAIClearhaus::is_reconciliation_window_enabled_Valid() const{
    return m_reconciliation_window_enabled_isValid;
}

qint32 OAIClearhaus::getReconciliationWindowTtl() const {
    return m_reconciliation_window_ttl;
}
void OAIClearhaus::setReconciliationWindowTtl(const qint32 &reconciliation_window_ttl) {
    m_reconciliation_window_ttl = reconciliation_window_ttl;
    m_reconciliation_window_ttl_isSet = true;
}

bool OAIClearhaus::is_reconciliation_window_ttl_Set() const{
    return m_reconciliation_window_ttl_isSet;
}

bool OAIClearhaus::is_reconciliation_window_ttl_Valid() const{
    return m_reconciliation_window_ttl_isValid;
}

QString OAIClearhaus::getStatus() const {
    return m_status;
}
void OAIClearhaus::setStatus(const QString &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIClearhaus::is_status_Set() const{
    return m_status_isSet;
}

bool OAIClearhaus::is_status_Valid() const{
    return m_status_isValid;
}

bool OAIClearhaus::isSticky() const {
    return m_sticky;
}
void OAIClearhaus::setSticky(const bool &sticky) {
    m_sticky = sticky;
    m_sticky_isSet = true;
}

bool OAIClearhaus::is_sticky_Set() const{
    return m_sticky_isSet;
}

bool OAIClearhaus::is_sticky_Valid() const{
    return m_sticky_isValid;
}

bool OAIClearhaus::isThreeDSecure() const {
    return m_three_d_secure;
}
void OAIClearhaus::setThreeDSecure(const bool &three_d_secure) {
    m_three_d_secure = three_d_secure;
    m_three_d_secure_isSet = true;
}

bool OAIClearhaus::is_three_d_secure_Set() const{
    return m_three_d_secure_isSet;
}

bool OAIClearhaus::is_three_d_secure_Valid() const{
    return m_three_d_secure_isValid;
}

qint32 OAIClearhaus::getTimeout() const {
    return m_timeout;
}
void OAIClearhaus::setTimeout(const qint32 &timeout) {
    m_timeout = timeout;
    m_timeout_isSet = true;
}

bool OAIClearhaus::is_timeout_Set() const{
    return m_timeout_isSet;
}

bool OAIClearhaus::is_timeout_Valid() const{
    return m_timeout_isValid;
}

QString OAIClearhaus::getToken() const {
    return m_token;
}
void OAIClearhaus::setToken(const QString &token) {
    m_token = token;
    m_token_isSet = true;
}

bool OAIClearhaus::is_token_Set() const{
    return m_token_isSet;
}

bool OAIClearhaus::is_token_Valid() const{
    return m_token_isValid;
}

QDateTime OAIClearhaus::getUpdatedTime() const {
    return m_updated_time;
}
void OAIClearhaus::setUpdatedTime(const QDateTime &updated_time) {
    m_updated_time = updated_time;
    m_updated_time_isSet = true;
}

bool OAIClearhaus::is_updated_time_Set() const{
    return m_updated_time_isSet;
}

bool OAIClearhaus::is_updated_time_Valid() const{
    return m_updated_time_isValid;
}

OAIClearhaus_allOf_credentials OAIClearhaus::getCredentials() const {
    return m_credentials;
}
void OAIClearhaus::setCredentials(const OAIClearhaus_allOf_credentials &credentials) {
    m_credentials = credentials;
    m_credentials_isSet = true;
}

bool OAIClearhaus::is_credentials_Set() const{
    return m_credentials_isSet;
}

bool OAIClearhaus::is_credentials_Valid() const{
    return m_credentials_isValid;
}

OAIClearhaus3dsServers OAIClearhaus::getThreeDSecureServer() const {
    return m_three_d_secure_server;
}
void OAIClearhaus::setThreeDSecureServer(const OAIClearhaus3dsServers &three_d_secure_server) {
    m_three_d_secure_server = three_d_secure_server;
    m_three_d_secure_server_isSet = true;
}

bool OAIClearhaus::is_three_d_secure_server_Set() const{
    return m_three_d_secure_server_isSet;
}

bool OAIClearhaus::is_three_d_secure_server_Valid() const{
    return m_three_d_secure_server_isValid;
}

bool OAIClearhaus::isSet() const {
...
bool OAIClearhaus::isValid() const {
