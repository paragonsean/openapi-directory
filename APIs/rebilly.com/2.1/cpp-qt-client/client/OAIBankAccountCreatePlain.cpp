...
OAIBankAccountCreatePlain::OAIBankAccountCreatePlain(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIBankAccountCreatePlain::OAIBankAccountCreatePlain() {
    this->initializeModel();
}

OAIBankAccountCreatePlain::~OAIBankAccountCreatePlain() {}

void OAIBankAccountCreatePlain::initializeModel() {
...
void OAIBankAccountCreatePlain::fromJson(QString jsonString) {
...
void OAIBankAccountCreatePlain::fromJsonObject(QJsonObject json) {
...
QString OAIBankAccountCreatePlain::asJson() const {
...
QJsonObject OAIBankAccountCreatePlain::asJsonObject() const {
    QJsonObject obj;
...
QString OAIBankAccountCreatePlain::getAccountNumber() const {
    return m_account_number;
}
void OAIBankAccountCreatePlain::setAccountNumber(const QString &account_number) {
    m_account_number = account_number;
    m_account_number_isSet = true;
}

bool OAIBankAccountCreatePlain::is_account_number_Set() const{
    return m_account_number_isSet;
}

bool OAIBankAccountCreatePlain::is_account_number_Valid() const{
    return m_account_number_isValid;
}

QString OAIBankAccountCreatePlain::getAccountNumberType() const {
    return m_account_number_type;
}
void OAIBankAccountCreatePlain::setAccountNumberType(const QString &account_number_type) {
    m_account_number_type = account_number_type;
    m_account_number_type_isSet = true;
}

bool OAIBankAccountCreatePlain::is_account_number_type_Set() const{
    return m_account_number_type_isSet;
}

bool OAIBankAccountCreatePlain::is_account_number_type_Valid() const{
    return m_account_number_type_isValid;
}

QString OAIBankAccountCreatePlain::getAccountType() const {
    return m_account_type;
}
void OAIBankAccountCreatePlain::setAccountType(const QString &account_type) {
    m_account_type = account_type;
    m_account_type_isSet = true;
}

bool OAIBankAccountCreatePlain::is_account_type_Set() const{
    return m_account_type_isSet;
}

bool OAIBankAccountCreatePlain::is_account_type_Valid() const{
    return m_account_type_isValid;
}

QString OAIBankAccountCreatePlain::getBankName() const {
    return m_bank_name;
}
void OAIBankAccountCreatePlain::setBankName(const QString &bank_name) {
    m_bank_name = bank_name;
    m_bank_name_isSet = true;
}

bool OAIBankAccountCreatePlain::is_bank_name_Set() const{
    return m_bank_name_isSet;
}

bool OAIBankAccountCreatePlain::is_bank_name_Valid() const{
    return m_bank_name_isValid;
}

QString OAIBankAccountCreatePlain::getBic() const {
    return m_bic;
}
void OAIBankAccountCreatePlain::setBic(const QString &bic) {
    m_bic = bic;
    m_bic_isSet = true;
}

bool OAIBankAccountCreatePlain::is_bic_Set() const{
    return m_bic_isSet;
}

bool OAIBankAccountCreatePlain::is_bic_Valid() const{
    return m_bic_isValid;
}

OAIContactObject OAIBankAccountCreatePlain::getBillingAddress() const {
    return m_billing_address;
}
void OAIBankAccountCreatePlain::setBillingAddress(const OAIContactObject &billing_address) {
    m_billing_address = billing_address;
    m_billing_address_isSet = true;
}

bool OAIBankAccountCreatePlain::is_billing_address_Set() const{
    return m_billing_address_isSet;
}

bool OAIBankAccountCreatePlain::is_billing_address_Valid() const{
    return m_billing_address_isValid;
}

OAIObject OAIBankAccountCreatePlain::getCustomFields() const {
    return m_custom_fields;
}
void OAIBankAccountCreatePlain::setCustomFields(const OAIObject &custom_fields) {
    m_custom_fields = custom_fields;
    m_custom_fields_isSet = true;
}

bool OAIBankAccountCreatePlain::is_custom_fields_Set() const{
    return m_custom_fields_isSet;
}

bool OAIBankAccountCreatePlain::is_custom_fields_Valid() const{
    return m_custom_fields_isValid;
}

QString OAIBankAccountCreatePlain::getCustomerId() const {
    return m_customer_id;
}
void OAIBankAccountCreatePlain::setCustomerId(const QString &customer_id) {
    m_customer_id = customer_id;
    m_customer_id_isSet = true;
}

bool OAIBankAccountCreatePlain::is_customer_id_Set() const{
    return m_customer_id_isSet;
}

bool OAIBankAccountCreatePlain::is_customer_id_Valid() const{
    return m_customer_id_isValid;
}

QString OAIBankAccountCreatePlain::getMethod() const {
    return m_method;
}
void OAIBankAccountCreatePlain::setMethod(const QString &method) {
    m_method = method;
    m_method_isSet = true;
}

bool OAIBankAccountCreatePlain::is_method_Set() const{
    return m_method_isSet;
}

bool OAIBankAccountCreatePlain::is_method_Valid() const{
    return m_method_isValid;
}

OAIRiskMetadata OAIBankAccountCreatePlain::getRiskMetadata() const {
    return m_risk_metadata;
}
void OAIBankAccountCreatePlain::setRiskMetadata(const OAIRiskMetadata &risk_metadata) {
    m_risk_metadata = risk_metadata;
    m_risk_metadata_isSet = true;
}

bool OAIBankAccountCreatePlain::is_risk_metadata_Set() const{
    return m_risk_metadata_isSet;
}

bool OAIBankAccountCreatePlain::is_risk_metadata_Valid() const{
    return m_risk_metadata_isValid;
}

QString OAIBankAccountCreatePlain::getRoutingNumber() const {
    return m_routing_number;
}
void OAIBankAccountCreatePlain::setRoutingNumber(const QString &routing_number) {
    m_routing_number = routing_number;
    m_routing_number_isSet = true;
}

bool OAIBankAccountCreatePlain::is_routing_number_Set() const{
    return m_routing_number_isSet;
}

bool OAIBankAccountCreatePlain::is_routing_number_Valid() const{
    return m_routing_number_isValid;
}

bool OAIBankAccountCreatePlain::isSet() const {
...
bool OAIBankAccountCreatePlain::isValid() const {
