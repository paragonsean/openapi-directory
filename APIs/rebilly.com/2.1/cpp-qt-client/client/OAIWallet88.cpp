...
OAIWallet88::OAIWallet88(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIWallet88::OAIWallet88() {
    this->initializeModel();
}

OAIWallet88::~OAIWallet88() {}

void OAIWallet88::initializeModel() {
...
void OAIWallet88::fromJson(QString jsonString) {
...
void OAIWallet88::fromJsonObject(QJsonObject json) {
...
QString OAIWallet88::asJson() const {
...
QJsonObject OAIWallet88::asJsonObject() const {
    QJsonObject obj;
    if (m__links.size() > 0) {
...
QList<OAIGatewayAccount__links_inner> OAIWallet88::getLinks() const {
    return m__links;
}
void OAIWallet88::setLinks(const QList<OAIGatewayAccount__links_inner> &_links) {
    m__links = _links;
    m__links_isSet = true;
}

bool OAIWallet88::is__links_Set() const{
    return m__links_isSet;
}

bool OAIWallet88::is__links_Valid() const{
    return m__links_isValid;
}

QList<QString> OAIWallet88::getAcceptedCurrencies() const {
    return m_accepted_currencies;
}
void OAIWallet88::setAcceptedCurrencies(const QList<QString> &accepted_currencies) {
    m_accepted_currencies = accepted_currencies;
    m_accepted_currencies_isSet = true;
}

bool OAIWallet88::is_accepted_currencies_Set() const{
    return m_accepted_currencies_isSet;
}

bool OAIWallet88::is_accepted_currencies_Valid() const{
    return m_accepted_currencies_isValid;
}

OAIAcquirerName OAIWallet88::getAcquirerName() const {
    return m_acquirer_name;
}
void OAIWallet88::setAcquirerName(const OAIAcquirerName &acquirer_name) {
    m_acquirer_name = acquirer_name;
    m_acquirer_name_isSet = true;
}

bool OAIWallet88::is_acquirer_name_Set() const{
    return m_acquirer_name_isSet;
}

bool OAIWallet88::is_acquirer_name_Valid() const{
    return m_acquirer_name_isValid;
}

QString OAIWallet88::getAdditionalFilters() const {
    return m_additional_filters;
}
void OAIWallet88::setAdditionalFilters(const QString &additional_filters) {
    m_additional_filters = additional_filters;
    m_additional_filters_isSet = true;
}

bool OAIWallet88::is_additional_filters_Set() const{
    return m_additional_filters_isSet;
}

bool OAIWallet88::is_additional_filters_Valid() const{
    return m_additional_filters_isValid;
}

qint32 OAIWallet88::getApprovalWindowTtl() const {
    return m_approval_window_ttl;
}
void OAIWallet88::setApprovalWindowTtl(const qint32 &approval_window_ttl) {
    m_approval_window_ttl = approval_window_ttl;
    m_approval_window_ttl_isSet = true;
}

bool OAIWallet88::is_approval_window_ttl_Set() const{
    return m_approval_window_ttl_isSet;
}

bool OAIWallet88::is_approval_window_ttl_Valid() const{
    return m_approval_window_ttl_isValid;
}

QString OAIWallet88::getCityField() const {
    return m_city_field;
}
void OAIWallet88::setCityField(const QString &city_field) {
    m_city_field = city_field;
    m_city_field_isSet = true;
}

bool OAIWallet88::is_city_field_Set() const{
    return m_city_field_isSet;
}

bool OAIWallet88::is_city_field_Valid() const{
    return m_city_field_isValid;
}

QDateTime OAIWallet88::getCreatedTime() const {
    return m_created_time;
}
void OAIWallet88::setCreatedTime(const QDateTime &created_time) {
    m_created_time = created_time;
    m_created_time_isSet = true;
}

bool OAIWallet88::is_created_time_Set() const{
    return m_created_time_isSet;
}

bool OAIWallet88::is_created_time_Valid() const{
    return m_created_time_isValid;
}

QString OAIWallet88::getDccForceCurrency() const {
    return m_dcc_force_currency;
}
void OAIWallet88::setDccForceCurrency(const QString &dcc_force_currency) {
    m_dcc_force_currency = dcc_force_currency;
    m_dcc_force_currency_isSet = true;
}

bool OAIWallet88::is_dcc_force_currency_Set() const{
    return m_dcc_force_currency_isSet;
}

bool OAIWallet88::is_dcc_force_currency_Valid() const{
    return m_dcc_force_currency_isValid;
}

qint32 OAIWallet88::getDccMarkup() const {
    return m_dcc_markup;
}
void OAIWallet88::setDccMarkup(const qint32 &dcc_markup) {
    m_dcc_markup = dcc_markup;
    m_dcc_markup_isSet = true;
}

bool OAIWallet88::is_dcc_markup_Set() const{
    return m_dcc_markup_isSet;
}

bool OAIWallet88::is_dcc_markup_Valid() const{
    return m_dcc_markup_isValid;
}

QString OAIWallet88::getDescriptor() const {
    return m_descriptor;
}
void OAIWallet88::setDescriptor(const QString &descriptor) {
    m_descriptor = descriptor;
    m_descriptor_isSet = true;
}

bool OAIWallet88::is_descriptor_Set() const{
    return m_descriptor_isSet;
}

bool OAIWallet88::is_descriptor_Valid() const{
    return m_descriptor_isValid;
}

OAIDigitalWallets OAIWallet88::getDigitalWallets() const {
    return m_digital_wallets;
}
void OAIWallet88::setDigitalWallets(const OAIDigitalWallets &digital_wallets) {
    m_digital_wallets = digital_wallets;
    m_digital_wallets_isSet = true;
}

bool OAIWallet88::is_digital_wallets_Set() const{
    return m_digital_wallets_isSet;
}

bool OAIWallet88::is_digital_wallets_Valid() const{
    return m_digital_wallets_isValid;
}

bool OAIWallet88::isDynamicDescriptor() const {
    return m_dynamic_descriptor;
}
void OAIWallet88::setDynamicDescriptor(const bool &dynamic_descriptor) {
    m_dynamic_descriptor = dynamic_descriptor;
    m_dynamic_descriptor_isSet = true;
}

bool OAIWallet88::is_dynamic_descriptor_Set() const{
    return m_dynamic_descriptor_isSet;
}

bool OAIWallet88::is_dynamic_descriptor_Valid() const{
    return m_dynamic_descriptor_isValid;
}

QList<QString> OAIWallet88::getExcludedDccQuoteCurrencies() const {
    return m_excluded_dcc_quote_currencies;
}
void OAIWallet88::setExcludedDccQuoteCurrencies(const QList<QString> &excluded_dcc_quote_currencies) {
    m_excluded_dcc_quote_currencies = excluded_dcc_quote_currencies;
    m_excluded_dcc_quote_currencies_isSet = true;
}

bool OAIWallet88::is_excluded_dcc_quote_currencies_Set() const{
    return m_excluded_dcc_quote_currencies_isSet;
}

bool OAIWallet88::is_excluded_dcc_quote_currencies_Valid() const{
    return m_excluded_dcc_quote_currencies_isValid;
}

OAIGatewayName OAIWallet88::getGatewayName() const {
    return m_gateway_name;
}
void OAIWallet88::setGatewayName(const OAIGatewayName &gateway_name) {
    m_gateway_name = gateway_name;
    m_gateway_name_isSet = true;
}

bool OAIWallet88::is_gateway_name_Set() const{
    return m_gateway_name_isSet;
}

bool OAIWallet88::is_gateway_name_Valid() const{
    return m_gateway_name_isValid;
}

QString OAIWallet88::getId() const {
    return m_id;
}
void OAIWallet88::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIWallet88::is_id_Set() const{
    return m_id_isSet;
}

bool OAIWallet88::is_id_Valid() const{
    return m_id_isValid;
}

bool OAIWallet88::isIsDown() const {
    return m_is_down;
}
void OAIWallet88::setIsDown(const bool &is_down) {
    m_is_down = is_down;
    m_is_down_isSet = true;
}

bool OAIWallet88::is_is_down_Set() const{
    return m_is_down_isSet;
}

bool OAIWallet88::is_is_down_Valid() const{
    return m_is_down_isValid;
}

QString OAIWallet88::getMerchantCategoryCode() const {
    return m_merchant_category_code;
}
void OAIWallet88::setMerchantCategoryCode(const QString &merchant_category_code) {
    m_merchant_category_code = merchant_category_code;
    m_merchant_category_code_isSet = true;
}

bool OAIWallet88::is_merchant_category_code_Set() const{
    return m_merchant_category_code_isSet;
}

bool OAIWallet88::is_merchant_category_code_Valid() const{
    return m_merchant_category_code_isValid;
}

OAIPaymentMethod OAIWallet88::getMethod() const {
    return m_method;
}
void OAIWallet88::setMethod(const OAIPaymentMethod &method) {
    m_method = method;
    m_method_isSet = true;
}

bool OAIWallet88::is_method_Set() const{
    return m_method_isSet;
}

bool OAIWallet88::is_method_Valid() const{
    return m_method_isValid;
}

double OAIWallet88::getMonthlyLimit() const {
    return m_monthly_limit;
}
void OAIWallet88::setMonthlyLimit(const double &monthly_limit) {
    m_monthly_limit = monthly_limit;
    m_monthly_limit_isSet = true;
}

bool OAIWallet88::is_monthly_limit_Set() const{
    return m_monthly_limit_isSet;
}

bool OAIWallet88::is_monthly_limit_Valid() const{
    return m_monthly_limit_isValid;
}

QString OAIWallet88::getOrganizationId() const {
    return m_organization_id;
}
void OAIWallet88::setOrganizationId(const QString &organization_id) {
    m_organization_id = organization_id;
    m_organization_id_isSet = true;
}

bool OAIWallet88::is_organization_id_Set() const{
    return m_organization_id_isSet;
}

bool OAIWallet88::is_organization_id_Valid() const{
    return m_organization_id_isValid;
}

QList<OAIPaymentCardBrand> OAIWallet88::getPaymentCardSchemes() const {
    return m_payment_card_schemes;
}
void OAIWallet88::setPaymentCardSchemes(const QList<OAIPaymentCardBrand> &payment_card_schemes) {
    m_payment_card_schemes = payment_card_schemes;
    m_payment_card_schemes_isSet = true;
}

bool OAIWallet88::is_payment_card_schemes_Set() const{
    return m_payment_card_schemes_isSet;
}

bool OAIWallet88::is_payment_card_schemes_Valid() const{
    return m_payment_card_schemes_isValid;
}

bool OAIWallet88::isReconciliationWindowEnabled() const {
    return m_reconciliation_window_enabled;
}
void OAIWallet88::setReconciliationWindowEnabled(const bool &reconciliation_window_enabled) {
    m_reconciliation_window_enabled = reconciliation_window_enabled;
    m_reconciliation_window_enabled_isSet = true;
}

bool OAIWallet88::is_reconciliation_window_enabled_Set() const{
    return m_reconciliation_window_enabled_isSet;
}

bool OAIWallet88::is_reconciliation_window_enabled_Valid() const{
    return m_reconciliation_window_enabled_isValid;
}

qint32 OAIWallet88::getReconciliationWindowTtl() const {
    return m_reconciliation_window_ttl;
}
void OAIWallet88::setReconciliationWindowTtl(const qint32 &reconciliation_window_ttl) {
    m_reconciliation_window_ttl = reconciliation_window_ttl;
    m_reconciliation_window_ttl_isSet = true;
}

bool OAIWallet88::is_reconciliation_window_ttl_Set() const{
    return m_reconciliation_window_ttl_isSet;
}

bool OAIWallet88::is_reconciliation_window_ttl_Valid() const{
    return m_reconciliation_window_ttl_isValid;
}

QString OAIWallet88::getStatus() const {
    return m_status;
}
void OAIWallet88::setStatus(const QString &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIWallet88::is_status_Set() const{
    return m_status_isSet;
}

bool OAIWallet88::is_status_Valid() const{
    return m_status_isValid;
}

bool OAIWallet88::isSticky() const {
    return m_sticky;
}
void OAIWallet88::setSticky(const bool &sticky) {
    m_sticky = sticky;
    m_sticky_isSet = true;
}

bool OAIWallet88::is_sticky_Set() const{
    return m_sticky_isSet;
}

bool OAIWallet88::is_sticky_Valid() const{
    return m_sticky_isValid;
}

bool OAIWallet88::isThreeDSecure() const {
    return m_three_d_secure;
}
void OAIWallet88::setThreeDSecure(const bool &three_d_secure) {
    m_three_d_secure = three_d_secure;
    m_three_d_secure_isSet = true;
}

bool OAIWallet88::is_three_d_secure_Set() const{
    return m_three_d_secure_isSet;
}

bool OAIWallet88::is_three_d_secure_Valid() const{
    return m_three_d_secure_isValid;
}

qint32 OAIWallet88::getTimeout() const {
    return m_timeout;
}
void OAIWallet88::setTimeout(const qint32 &timeout) {
    m_timeout = timeout;
    m_timeout_isSet = true;
}

bool OAIWallet88::is_timeout_Set() const{
    return m_timeout_isSet;
}

bool OAIWallet88::is_timeout_Valid() const{
    return m_timeout_isValid;
}

QString OAIWallet88::getToken() const {
    return m_token;
}
void OAIWallet88::setToken(const QString &token) {
    m_token = token;
    m_token_isSet = true;
}

bool OAIWallet88::is_token_Set() const{
    return m_token_isSet;
}

bool OAIWallet88::is_token_Valid() const{
    return m_token_isValid;
}

QDateTime OAIWallet88::getUpdatedTime() const {
    return m_updated_time;
}
void OAIWallet88::setUpdatedTime(const QDateTime &updated_time) {
    m_updated_time = updated_time;
    m_updated_time_isSet = true;
}

bool OAIWallet88::is_updated_time_Set() const{
    return m_updated_time_isSet;
}

bool OAIWallet88::is_updated_time_Valid() const{
    return m_updated_time_isValid;
}

OAIWallet88_allOf_credentials OAIWallet88::getCredentials() const {
    return m_credentials;
}
void OAIWallet88::setCredentials(const OAIWallet88_allOf_credentials &credentials) {
    m_credentials = credentials;
    m_credentials_isSet = true;
}

bool OAIWallet88::is_credentials_Set() const{
    return m_credentials_isSet;
}

bool OAIWallet88::is_credentials_Valid() const{
    return m_credentials_isValid;
}

bool OAIWallet88::isSet() const {
...
bool OAIWallet88::isValid() const {
