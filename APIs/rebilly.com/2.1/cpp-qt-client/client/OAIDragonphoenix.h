...
#ifndef OAIDragonphoenix_H
#define OAIDragonphoenix_H
...
class OAIDragonphoenix_allOf_credentials;

class OAIDragonphoenix : public OAIObject {
public:
    OAIDragonphoenix();
    OAIDragonphoenix(QString json);
    ~OAIDragonphoenix() override;
    ...
    OAIDragonphoenix_allOf_credentials getCredentials() const;
    void setCredentials(const OAIDragonphoenix_allOf_credentials &credentials);
...
private:
    ...
    OAIDragonphoenix_allOf_credentials m_credentials;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDragonphoenix)

#endif // OAIDragonphoenix_H
