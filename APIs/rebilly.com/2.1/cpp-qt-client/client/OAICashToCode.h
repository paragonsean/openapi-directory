...
#ifndef OAICashToCode_H
#define OAICashToCode_H

#include <QJsonObject>

#include "OAIAcquirerName.h"
#include "OAICashToCode_allOf_credentials.h"
#include "OAICashToCode_allOf_settings.h"
...
class OAICashToCode_allOf_credentials;
class OAICashToCode_allOf_settings;

class OAICashToCode : public OAIObject {
public:
    OAICashToCode();
    OAICashToCode(QString json);
    ~OAICashToCode() override;
    ...
    OAICashToCode_allOf_credentials getCredentials() const;
    void setCredentials(const OAICashToCode_allOf_credentials &credentials);
    bool is_credentials_Set() const;
    bool is_credentials_Valid() const;

    OAICashToCode_allOf_settings getSettings() const;
    void setSettings(const OAICashToCode_allOf_settings &settings);
...
private:
    ...
    OAICashToCode_allOf_credentials m_credentials;
    bool m_credentials_isSet;
    bool m_credentials_isValid;

    OAICashToCode_allOf_settings m_settings;
...
Q_DECLARE_METATYPE(OpenAPI::OAICashToCode)

#endif // OAICashToCode_H
