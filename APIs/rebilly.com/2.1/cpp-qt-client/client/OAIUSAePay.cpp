...
OAIUSAePay::OAIUSAePay(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUSAePay::OAIUSAePay() {
    this->initializeModel();
}

OAIUSAePay::~OAIUSAePay() {}

void OAIUSAePay::initializeModel() {
...
void OAIUSAePay::fromJson(QString jsonString) {
...
void OAIUSAePay::fromJsonObject(QJsonObject json) {
...
QString OAIUSAePay::asJson() const {
...
QJsonObject OAIUSAePay::asJsonObject() const {
    QJsonObject obj;
    if (m__links.size() > 0) {
...
QList<OAIGatewayAccount__links_inner> OAIUSAePay::getLinks() const {
    return m__links;
}
void OAIUSAePay::setLinks(const QList<OAIGatewayAccount__links_inner> &_links) {
    m__links = _links;
    m__links_isSet = true;
}

bool OAIUSAePay::is__links_Set() const{
    return m__links_isSet;
}

bool OAIUSAePay::is__links_Valid() const{
    return m__links_isValid;
}

QList<QString> OAIUSAePay::getAcceptedCurrencies() const {
    return m_accepted_currencies;
}
void OAIUSAePay::setAcceptedCurrencies(const QList<QString> &accepted_currencies) {
    m_accepted_currencies = accepted_currencies;
    m_accepted_currencies_isSet = true;
}

bool OAIUSAePay::is_accepted_currencies_Set() const{
    return m_accepted_currencies_isSet;
}

bool OAIUSAePay::is_accepted_currencies_Valid() const{
    return m_accepted_currencies_isValid;
}

OAIAcquirerName OAIUSAePay::getAcquirerName() const {
    return m_acquirer_name;
}
void OAIUSAePay::setAcquirerName(const OAIAcquirerName &acquirer_name) {
    m_acquirer_name = acquirer_name;
    m_acquirer_name_isSet = true;
}

bool OAIUSAePay::is_acquirer_name_Set() const{
    return m_acquirer_name_isSet;
}

bool OAIUSAePay::is_acquirer_name_Valid() const{
    return m_acquirer_name_isValid;
}

QString OAIUSAePay::getAdditionalFilters() const {
    return m_additional_filters;
}
void OAIUSAePay::setAdditionalFilters(const QString &additional_filters) {
    m_additional_filters = additional_filters;
    m_additional_filters_isSet = true;
}

bool OAIUSAePay::is_additional_filters_Set() const{
    return m_additional_filters_isSet;
}

bool OAIUSAePay::is_additional_filters_Valid() const{
    return m_additional_filters_isValid;
}

qint32 OAIUSAePay::getApprovalWindowTtl() const {
    return m_approval_window_ttl;
}
void OAIUSAePay::setApprovalWindowTtl(const qint32 &approval_window_ttl) {
    m_approval_window_ttl = approval_window_ttl;
    m_approval_window_ttl_isSet = true;
}

bool OAIUSAePay::is_approval_window_ttl_Set() const{
    return m_approval_window_ttl_isSet;
}

bool OAIUSAePay::is_approval_window_ttl_Valid() const{
    return m_approval_window_ttl_isValid;
}

QString OAIUSAePay::getCityField() const {
    return m_city_field;
}
void OAIUSAePay::setCityField(const QString &city_field) {
    m_city_field = city_field;
    m_city_field_isSet = true;
}

bool OAIUSAePay::is_city_field_Set() const{
    return m_city_field_isSet;
}

bool OAIUSAePay::is_city_field_Valid() const{
    return m_city_field_isValid;
}

QDateTime OAIUSAePay::getCreatedTime() const {
    return m_created_time;
}
void OAIUSAePay::setCreatedTime(const QDateTime &created_time) {
    m_created_time = created_time;
    m_created_time_isSet = true;
}

bool OAIUSAePay::is_created_time_Set() const{
    return m_created_time_isSet;
}

bool OAIUSAePay::is_created_time_Valid() const{
    return m_created_time_isValid;
}

QString OAIUSAePay::getDccForceCurrency() const {
    return m_dcc_force_currency;
}
void OAIUSAePay::setDccForceCurrency(const QString &dcc_force_currency) {
    m_dcc_force_currency = dcc_force_currency;
    m_dcc_force_currency_isSet = true;
}

bool OAIUSAePay::is_dcc_force_currency_Set() const{
    return m_dcc_force_currency_isSet;
}

bool OAIUSAePay::is_dcc_force_currency_Valid() const{
    return m_dcc_force_currency_isValid;
}

qint32 OAIUSAePay::getDccMarkup() const {
    return m_dcc_markup;
}
void OAIUSAePay::setDccMarkup(const qint32 &dcc_markup) {
    m_dcc_markup = dcc_markup;
    m_dcc_markup_isSet = true;
}

bool OAIUSAePay::is_dcc_markup_Set() const{
    return m_dcc_markup_isSet;
}

bool OAIUSAePay::is_dcc_markup_Valid() const{
    return m_dcc_markup_isValid;
}

QString OAIUSAePay::getDescriptor() const {
    return m_descriptor;
}
void OAIUSAePay::setDescriptor(const QString &descriptor) {
    m_descriptor = descriptor;
    m_descriptor_isSet = true;
}

bool OAIUSAePay::is_descriptor_Set() const{
    return m_descriptor_isSet;
}

bool OAIUSAePay::is_descriptor_Valid() const{
    return m_descriptor_isValid;
}

OAIDigitalWallets OAIUSAePay::getDigitalWallets() const {
    return m_digital_wallets;
}
void OAIUSAePay::setDigitalWallets(const OAIDigitalWallets &digital_wallets) {
    m_digital_wallets = digital_wallets;
    m_digital_wallets_isSet = true;
}

bool OAIUSAePay::is_digital_wallets_Set() const{
    return m_digital_wallets_isSet;
}

bool OAIUSAePay::is_digital_wallets_Valid() const{
    return m_digital_wallets_isValid;
}

bool OAIUSAePay::isDynamicDescriptor() const {
    return m_dynamic_descriptor;
}
void OAIUSAePay::setDynamicDescriptor(const bool &dynamic_descriptor) {
    m_dynamic_descriptor = dynamic_descriptor;
    m_dynamic_descriptor_isSet = true;
}

bool OAIUSAePay::is_dynamic_descriptor_Set() const{
    return m_dynamic_descriptor_isSet;
}

bool OAIUSAePay::is_dynamic_descriptor_Valid() const{
    return m_dynamic_descriptor_isValid;
}

QList<QString> OAIUSAePay::getExcludedDccQuoteCurrencies() const {
    return m_excluded_dcc_quote_currencies;
}
void OAIUSAePay::setExcludedDccQuoteCurrencies(const QList<QString> &excluded_dcc_quote_currencies) {
    m_excluded_dcc_quote_currencies = excluded_dcc_quote_currencies;
    m_excluded_dcc_quote_currencies_isSet = true;
}

bool OAIUSAePay::is_excluded_dcc_quote_currencies_Set() const{
    return m_excluded_dcc_quote_currencies_isSet;
}

bool OAIUSAePay::is_excluded_dcc_quote_currencies_Valid() const{
    return m_excluded_dcc_quote_currencies_isValid;
}

OAIGatewayName OAIUSAePay::getGatewayName() const {
    return m_gateway_name;
}
void OAIUSAePay::setGatewayName(const OAIGatewayName &gateway_name) {
    m_gateway_name = gateway_name;
    m_gateway_name_isSet = true;
}

bool OAIUSAePay::is_gateway_name_Set() const{
    return m_gateway_name_isSet;
}

bool OAIUSAePay::is_gateway_name_Valid() const{
    return m_gateway_name_isValid;
}

QString OAIUSAePay::getId() const {
    return m_id;
}
void OAIUSAePay::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIUSAePay::is_id_Set() const{
    return m_id_isSet;
}

bool OAIUSAePay::is_id_Valid() const{
    return m_id_isValid;
}

bool OAIUSAePay::isIsDown() const {
    return m_is_down;
}
void OAIUSAePay::setIsDown(const bool &is_down) {
    m_is_down = is_down;
    m_is_down_isSet = true;
}

bool OAIUSAePay::is_is_down_Set() const{
    return m_is_down_isSet;
}

bool OAIUSAePay::is_is_down_Valid() const{
    return m_is_down_isValid;
}

QString OAIUSAePay::getMerchantCategoryCode() const {
    return m_merchant_category_code;
}
void OAIUSAePay::setMerchantCategoryCode(const QString &merchant_category_code) {
    m_merchant_category_code = merchant_category_code;
    m_merchant_category_code_isSet = true;
}

bool OAIUSAePay::is_merchant_category_code_Set() const{
    return m_merchant_category_code_isSet;
}

bool OAIUSAePay::is_merchant_category_code_Valid() const{
    return m_merchant_category_code_isValid;
}

OAIPaymentMethod OAIUSAePay::getMethod() const {
    return m_method;
}
void OAIUSAePay::setMethod(const OAIPaymentMethod &method) {
    m_method = method;
    m_method_isSet = true;
}

bool OAIUSAePay::is_method_Set() const{
    return m_method_isSet;
}

bool OAIUSAePay::is_method_Valid() const{
    return m_method_isValid;
}

double OAIUSAePay::getMonthlyLimit() const {
    return m_monthly_limit;
}
void OAIUSAePay::setMonthlyLimit(const double &monthly_limit) {
    m_monthly_limit = monthly_limit;
    m_monthly_limit_isSet = true;
}

bool OAIUSAePay::is_monthly_limit_Set() const{
    return m_monthly_limit_isSet;
}

bool OAIUSAePay::is_monthly_limit_Valid() const{
    return m_monthly_limit_isValid;
}

QString OAIUSAePay::getOrganizationId() const {
    return m_organization_id;
}
void OAIUSAePay::setOrganizationId(const QString &organization_id) {
    m_organization_id = organization_id;
    m_organization_id_isSet = true;
}

bool OAIUSAePay::is_organization_id_Set() const{
    return m_organization_id_isSet;
}

bool OAIUSAePay::is_organization_id_Valid() const{
    return m_organization_id_isValid;
}

QList<OAIPaymentCardBrand> OAIUSAePay::getPaymentCardSchemes() const {
    return m_payment_card_schemes;
}
void OAIUSAePay::setPaymentCardSchemes(const QList<OAIPaymentCardBrand> &payment_card_schemes) {
    m_payment_card_schemes = payment_card_schemes;
    m_payment_card_schemes_isSet = true;
}

bool OAIUSAePay::is_payment_card_schemes_Set() const{
    return m_payment_card_schemes_isSet;
}

bool OAIUSAePay::is_payment_card_schemes_Valid() const{
    return m_payment_card_schemes_isValid;
}

bool OAIUSAePay::isReconciliationWindowEnabled() const {
    return m_reconciliation_window_enabled;
}
void OAIUSAePay::setReconciliationWindowEnabled(const bool &reconciliation_window_enabled) {
    m_reconciliation_window_enabled = reconciliation_window_enabled;
    m_reconciliation_window_enabled_isSet = true;
}

bool OAIUSAePay::is_reconciliation_window_enabled_Set() const{
    return m_reconciliation_window_enabled_isSet;
}

bool OAIUSAePay::is_reconciliation_window_enabled_Valid() const{
    return m_reconciliation_window_enabled_isValid;
}

qint32 OAIUSAePay::getReconciliationWindowTtl() const {
    return m_reconciliation_window_ttl;
}
void OAIUSAePay::setReconciliationWindowTtl(const qint32 &reconciliation_window_ttl) {
    m_reconciliation_window_ttl = reconciliation_window_ttl;
    m_reconciliation_window_ttl_isSet = true;
}

bool OAIUSAePay::is_reconciliation_window_ttl_Set() const{
    return m_reconciliation_window_ttl_isSet;
}

bool OAIUSAePay::is_reconciliation_window_ttl_Valid() const{
    return m_reconciliation_window_ttl_isValid;
}

QString OAIUSAePay::getStatus() const {
    return m_status;
}
void OAIUSAePay::setStatus(const QString &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIUSAePay::is_status_Set() const{
    return m_status_isSet;
}

bool OAIUSAePay::is_status_Valid() const{
    return m_status_isValid;
}

bool OAIUSAePay::isSticky() const {
    return m_sticky;
}
void OAIUSAePay::setSticky(const bool &sticky) {
    m_sticky = sticky;
    m_sticky_isSet = true;
}

bool OAIUSAePay::is_sticky_Set() const{
    return m_sticky_isSet;
}

bool OAIUSAePay::is_sticky_Valid() const{
    return m_sticky_isValid;
}

bool OAIUSAePay::isThreeDSecure() const {
    return m_three_d_secure;
}
void OAIUSAePay::setThreeDSecure(const bool &three_d_secure) {
    m_three_d_secure = three_d_secure;
    m_three_d_secure_isSet = true;
}

bool OAIUSAePay::is_three_d_secure_Set() const{
    return m_three_d_secure_isSet;
}

bool OAIUSAePay::is_three_d_secure_Valid() const{
    return m_three_d_secure_isValid;
}

qint32 OAIUSAePay::getTimeout() const {
    return m_timeout;
}
void OAIUSAePay::setTimeout(const qint32 &timeout) {
    m_timeout = timeout;
    m_timeout_isSet = true;
}

bool OAIUSAePay::is_timeout_Set() const{
    return m_timeout_isSet;
}

bool OAIUSAePay::is_timeout_Valid() const{
    return m_timeout_isValid;
}

QString OAIUSAePay::getToken() const {
    return m_token;
}
void OAIUSAePay::setToken(const QString &token) {
    m_token = token;
    m_token_isSet = true;
}

bool OAIUSAePay::is_token_Set() const{
    return m_token_isSet;
}

bool OAIUSAePay::is_token_Valid() const{
    return m_token_isValid;
}

QDateTime OAIUSAePay::getUpdatedTime() const {
    return m_updated_time;
}
void OAIUSAePay::setUpdatedTime(const QDateTime &updated_time) {
    m_updated_time = updated_time;
    m_updated_time_isSet = true;
}

bool OAIUSAePay::is_updated_time_Set() const{
    return m_updated_time_isSet;
}

bool OAIUSAePay::is_updated_time_Valid() const{
    return m_updated_time_isValid;
}

OAIUSAePay_allOf_credentials OAIUSAePay::getCredentials() const {
    return m_credentials;
}
void OAIUSAePay::setCredentials(const OAIUSAePay_allOf_credentials &credentials) {
    m_credentials = credentials;
    m_credentials_isSet = true;
}

bool OAIUSAePay::is_credentials_Set() const{
    return m_credentials_isSet;
}

bool OAIUSAePay::is_credentials_Valid() const{
    return m_credentials_isValid;
}

bool OAIUSAePay::isSet() const {
