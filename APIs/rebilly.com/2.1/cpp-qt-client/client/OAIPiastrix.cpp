...
OAIPiastrix::OAIPiastrix(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPiastrix::OAIPiastrix() {
    this->initializeModel();
}

OAIPiastrix::~OAIPiastrix() {}

void OAIPiastrix::initializeModel() {
...
void OAIPiastrix::fromJson(QString jsonString) {
...
void OAIPiastrix::fromJsonObject(QJsonObject json) {
...
QString OAIPiastrix::asJson() const {
...
QJsonObject OAIPiastrix::asJsonObject() const {
    QJsonObject obj;
    if (m__links.size() > 0) {
...
QList<OAIGatewayAccount__links_inner> OAIPiastrix::getLinks() const {
    return m__links;
}
void OAIPiastrix::setLinks(const QList<OAIGatewayAccount__links_inner> &_links) {
    m__links = _links;
    m__links_isSet = true;
}

bool OAIPiastrix::is__links_Set() const{
    return m__links_isSet;
}

bool OAIPiastrix::is__links_Valid() const{
    return m__links_isValid;
}

QList<QString> OAIPiastrix::getAcceptedCurrencies() const {
    return m_accepted_currencies;
}
void OAIPiastrix::setAcceptedCurrencies(const QList<QString> &accepted_currencies) {
    m_accepted_currencies = accepted_currencies;
    m_accepted_currencies_isSet = true;
}

bool OAIPiastrix::is_accepted_currencies_Set() const{
    return m_accepted_currencies_isSet;
}

bool OAIPiastrix::is_accepted_currencies_Valid() const{
    return m_accepted_currencies_isValid;
}

OAIAcquirerName OAIPiastrix::getAcquirerName() const {
    return m_acquirer_name;
}
void OAIPiastrix::setAcquirerName(const OAIAcquirerName &acquirer_name) {
    m_acquirer_name = acquirer_name;
    m_acquirer_name_isSet = true;
}

bool OAIPiastrix::is_acquirer_name_Set() const{
    return m_acquirer_name_isSet;
}

bool OAIPiastrix::is_acquirer_name_Valid() const{
    return m_acquirer_name_isValid;
}

QString OAIPiastrix::getAdditionalFilters() const {
    return m_additional_filters;
}
void OAIPiastrix::setAdditionalFilters(const QString &additional_filters) {
    m_additional_filters = additional_filters;
    m_additional_filters_isSet = true;
}

bool OAIPiastrix::is_additional_filters_Set() const{
    return m_additional_filters_isSet;
}

bool OAIPiastrix::is_additional_filters_Valid() const{
    return m_additional_filters_isValid;
}

qint32 OAIPiastrix::getApprovalWindowTtl() const {
    return m_approval_window_ttl;
}
void OAIPiastrix::setApprovalWindowTtl(const qint32 &approval_window_ttl) {
    m_approval_window_ttl = approval_window_ttl;
    m_approval_window_ttl_isSet = true;
}

bool OAIPiastrix::is_approval_window_ttl_Set() const{
    return m_approval_window_ttl_isSet;
}

bool OAIPiastrix::is_approval_window_ttl_Valid() const{
    return m_approval_window_ttl_isValid;
}

QString OAIPiastrix::getCityField() const {
    return m_city_field;
}
void OAIPiastrix::setCityField(const QString &city_field) {
    m_city_field = city_field;
    m_city_field_isSet = true;
}

bool OAIPiastrix::is_city_field_Set() const{
    return m_city_field_isSet;
}

bool OAIPiastrix::is_city_field_Valid() const{
    return m_city_field_isValid;
}

QDateTime OAIPiastrix::getCreatedTime() const {
    return m_created_time;
}
void OAIPiastrix::setCreatedTime(const QDateTime &created_time) {
    m_created_time = created_time;
    m_created_time_isSet = true;
}

bool OAIPiastrix::is_created_time_Set() const{
    return m_created_time_isSet;
}

bool OAIPiastrix::is_created_time_Valid() const{
    return m_created_time_isValid;
}

QString OAIPiastrix::getDccForceCurrency() const {
    return m_dcc_force_currency;
}
void OAIPiastrix::setDccForceCurrency(const QString &dcc_force_currency) {
    m_dcc_force_currency = dcc_force_currency;
    m_dcc_force_currency_isSet = true;
}

bool OAIPiastrix::is_dcc_force_currency_Set() const{
    return m_dcc_force_currency_isSet;
}

bool OAIPiastrix::is_dcc_force_currency_Valid() const{
    return m_dcc_force_currency_isValid;
}

qint32 OAIPiastrix::getDccMarkup() const {
    return m_dcc_markup;
}
void OAIPiastrix::setDccMarkup(const qint32 &dcc_markup) {
    m_dcc_markup = dcc_markup;
    m_dcc_markup_isSet = true;
}

bool OAIPiastrix::is_dcc_markup_Set() const{
    return m_dcc_markup_isSet;
}

bool OAIPiastrix::is_dcc_markup_Valid() const{
    return m_dcc_markup_isValid;
}

QString OAIPiastrix::getDescriptor() const {
    return m_descriptor;
}
void OAIPiastrix::setDescriptor(const QString &descriptor) {
    m_descriptor = descriptor;
    m_descriptor_isSet = true;
}

bool OAIPiastrix::is_descriptor_Set() const{
    return m_descriptor_isSet;
}

bool OAIPiastrix::is_descriptor_Valid() const{
    return m_descriptor_isValid;
}

OAIDigitalWallets OAIPiastrix::getDigitalWallets() const {
    return m_digital_wallets;
}
void OAIPiastrix::setDigitalWallets(const OAIDigitalWallets &digital_wallets) {
    m_digital_wallets = digital_wallets;
    m_digital_wallets_isSet = true;
}

bool OAIPiastrix::is_digital_wallets_Set() const{
    return m_digital_wallets_isSet;
}

bool OAIPiastrix::is_digital_wallets_Valid() const{
    return m_digital_wallets_isValid;
}

bool OAIPiastrix::isDynamicDescriptor() const {
    return m_dynamic_descriptor;
}
void OAIPiastrix::setDynamicDescriptor(const bool &dynamic_descriptor) {
    m_dynamic_descriptor = dynamic_descriptor;
    m_dynamic_descriptor_isSet = true;
}

bool OAIPiastrix::is_dynamic_descriptor_Set() const{
    return m_dynamic_descriptor_isSet;
}

bool OAIPiastrix::is_dynamic_descriptor_Valid() const{
    return m_dynamic_descriptor_isValid;
}

QList<QString> OAIPiastrix::getExcludedDccQuoteCurrencies() const {
    return m_excluded_dcc_quote_currencies;
}
void OAIPiastrix::setExcludedDccQuoteCurrencies(const QList<QString> &excluded_dcc_quote_currencies) {
    m_excluded_dcc_quote_currencies = excluded_dcc_quote_currencies;
    m_excluded_dcc_quote_currencies_isSet = true;
}

bool OAIPiastrix::is_excluded_dcc_quote_currencies_Set() const{
    return m_excluded_dcc_quote_currencies_isSet;
}

bool OAIPiastrix::is_excluded_dcc_quote_currencies_Valid() const{
    return m_excluded_dcc_quote_currencies_isValid;
}

OAIGatewayName OAIPiastrix::getGatewayName() const {
    return m_gateway_name;
}
void OAIPiastrix::setGatewayName(const OAIGatewayName &gateway_name) {
    m_gateway_name = gateway_name;
    m_gateway_name_isSet = true;
}

bool OAIPiastrix::is_gateway_name_Set() const{
    return m_gateway_name_isSet;
}

bool OAIPiastrix::is_gateway_name_Valid() const{
    return m_gateway_name_isValid;
}

QString OAIPiastrix::getId() const {
    return m_id;
}
void OAIPiastrix::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIPiastrix::is_id_Set() const{
    return m_id_isSet;
}

bool OAIPiastrix::is_id_Valid() const{
    return m_id_isValid;
}

bool OAIPiastrix::isIsDown() const {
    return m_is_down;
}
void OAIPiastrix::setIsDown(const bool &is_down) {
    m_is_down = is_down;
    m_is_down_isSet = true;
}

bool OAIPiastrix::is_is_down_Set() const{
    return m_is_down_isSet;
}

bool OAIPiastrix::is_is_down_Valid() const{
    return m_is_down_isValid;
}

QString OAIPiastrix::getMerchantCategoryCode() const {
    return m_merchant_category_code;
}
void OAIPiastrix::setMerchantCategoryCode(const QString &merchant_category_code) {
    m_merchant_category_code = merchant_category_code;
    m_merchant_category_code_isSet = true;
}

bool OAIPiastrix::is_merchant_category_code_Set() const{
    return m_merchant_category_code_isSet;
}

bool OAIPiastrix::is_merchant_category_code_Valid() const{
    return m_merchant_category_code_isValid;
}

OAIPaymentMethod OAIPiastrix::getMethod() const {
    return m_method;
}
void OAIPiastrix::setMethod(const OAIPaymentMethod &method) {
    m_method = method;
    m_method_isSet = true;
}

bool OAIPiastrix::is_method_Set() const{
    return m_method_isSet;
}

bool OAIPiastrix::is_method_Valid() const{
    return m_method_isValid;
}

double OAIPiastrix::getMonthlyLimit() const {
    return m_monthly_limit;
}
void OAIPiastrix::setMonthlyLimit(const double &monthly_limit) {
    m_monthly_limit = monthly_limit;
    m_monthly_limit_isSet = true;
}

bool OAIPiastrix::is_monthly_limit_Set() const{
    return m_monthly_limit_isSet;
}

bool OAIPiastrix::is_monthly_limit_Valid() const{
    return m_monthly_limit_isValid;
}

QString OAIPiastrix::getOrganizationId() const {
    return m_organization_id;
}
void OAIPiastrix::setOrganizationId(const QString &organization_id) {
    m_organization_id = organization_id;
    m_organization_id_isSet = true;
}

bool OAIPiastrix::is_organization_id_Set() const{
    return m_organization_id_isSet;
}

bool OAIPiastrix::is_organization_id_Valid() const{
    return m_organization_id_isValid;
}

QList<OAIPaymentCardBrand> OAIPiastrix::getPaymentCardSchemes() const {
    return m_payment_card_schemes;
}
void OAIPiastrix::setPaymentCardSchemes(const QList<OAIPaymentCardBrand> &payment_card_schemes) {
    m_payment_card_schemes = payment_card_schemes;
    m_payment_card_schemes_isSet = true;
}

bool OAIPiastrix::is_payment_card_schemes_Set() const{
    return m_payment_card_schemes_isSet;
}

bool OAIPiastrix::is_payment_card_schemes_Valid() const{
    return m_payment_card_schemes_isValid;
}

bool OAIPiastrix::isReconciliationWindowEnabled() const {
    return m_reconciliation_window_enabled;
}
void OAIPiastrix::setReconciliationWindowEnabled(const bool &reconciliation_window_enabled) {
    m_reconciliation_window_enabled = reconciliation_window_enabled;
    m_reconciliation_window_enabled_isSet = true;
}

bool OAIPiastrix::is_reconciliation_window_enabled_Set() const{
    return m_reconciliation_window_enabled_isSet;
}

bool OAIPiastrix::is_reconciliation_window_enabled_Valid() const{
    return m_reconciliation_window_enabled_isValid;
}

qint32 OAIPiastrix::getReconciliationWindowTtl() const {
    return m_reconciliation_window_ttl;
}
void OAIPiastrix::setReconciliationWindowTtl(const qint32 &reconciliation_window_ttl) {
    m_reconciliation_window_ttl = reconciliation_window_ttl;
    m_reconciliation_window_ttl_isSet = true;
}

bool OAIPiastrix::is_reconciliation_window_ttl_Set() const{
    return m_reconciliation_window_ttl_isSet;
}

bool OAIPiastrix::is_reconciliation_window_ttl_Valid() const{
    return m_reconciliation_window_ttl_isValid;
}

QString OAIPiastrix::getStatus() const {
    return m_status;
}
void OAIPiastrix::setStatus(const QString &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIPiastrix::is_status_Set() const{
    return m_status_isSet;
}

bool OAIPiastrix::is_status_Valid() const{
    return m_status_isValid;
}

bool OAIPiastrix::isSticky() const {
    return m_sticky;
}
void OAIPiastrix::setSticky(const bool &sticky) {
    m_sticky = sticky;
    m_sticky_isSet = true;
}

bool OAIPiastrix::is_sticky_Set() const{
    return m_sticky_isSet;
}

bool OAIPiastrix::is_sticky_Valid() const{
    return m_sticky_isValid;
}

bool OAIPiastrix::isThreeDSecure() const {
    return m_three_d_secure;
}
void OAIPiastrix::setThreeDSecure(const bool &three_d_secure) {
    m_three_d_secure = three_d_secure;
    m_three_d_secure_isSet = true;
}

bool OAIPiastrix::is_three_d_secure_Set() const{
    return m_three_d_secure_isSet;
}

bool OAIPiastrix::is_three_d_secure_Valid() const{
    return m_three_d_secure_isValid;
}

qint32 OAIPiastrix::getTimeout() const {
    return m_timeout;
}
void OAIPiastrix::setTimeout(const qint32 &timeout) {
    m_timeout = timeout;
    m_timeout_isSet = true;
}

bool OAIPiastrix::is_timeout_Set() const{
    return m_timeout_isSet;
}

bool OAIPiastrix::is_timeout_Valid() const{
    return m_timeout_isValid;
}

QString OAIPiastrix::getToken() const {
    return m_token;
}
void OAIPiastrix::setToken(const QString &token) {
    m_token = token;
    m_token_isSet = true;
}

bool OAIPiastrix::is_token_Set() const{
    return m_token_isSet;
}

bool OAIPiastrix::is_token_Valid() const{
    return m_token_isValid;
}

QDateTime OAIPiastrix::getUpdatedTime() const {
    return m_updated_time;
}
void OAIPiastrix::setUpdatedTime(const QDateTime &updated_time) {
    m_updated_time = updated_time;
    m_updated_time_isSet = true;
}

bool OAIPiastrix::is_updated_time_Set() const{
    return m_updated_time_isSet;
}

bool OAIPiastrix::is_updated_time_Valid() const{
    return m_updated_time_isValid;
}

OAIPiastrix_allOf_credentials OAIPiastrix::getCredentials() const {
    return m_credentials;
}
void OAIPiastrix::setCredentials(const OAIPiastrix_allOf_credentials &credentials) {
    m_credentials = credentials;
    m_credentials_isSet = true;
}

bool OAIPiastrix::is_credentials_Set() const{
    return m_credentials_isSet;
}

bool OAIPiastrix::is_credentials_Valid() const{
    return m_credentials_isValid;
}

OAIPiastrix_allOf_settings OAIPiastrix::getSettings() const {
    return m_settings;
}
void OAIPiastrix::setSettings(const OAIPiastrix_allOf_settings &settings) {
    m_settings = settings;
    m_settings_isSet = true;
}

bool OAIPiastrix::is_settings_Set() const{
    return m_settings_isSet;
}

bool OAIPiastrix::is_settings_Valid() const{
    return m_settings_isValid;
}

OAIPiastrix3dsServers OAIPiastrix::getThreeDSecureServer() const {
    return m_three_d_secure_server;
}
void OAIPiastrix::setThreeDSecureServer(const OAIPiastrix3dsServers &three_d_secure_server) {
    m_three_d_secure_server = three_d_secure_server;
    m_three_d_secure_server_isSet = true;
}

bool OAIPiastrix::is_three_d_secure_server_Set() const{
    return m_three_d_secure_server_isSet;
}

bool OAIPiastrix::is_three_d_secure_server_Valid() const{
    return m_three_d_secure_server_isValid;
}

bool OAIPiastrix::isSet() const {
...
bool OAIPiastrix::isValid() const {
