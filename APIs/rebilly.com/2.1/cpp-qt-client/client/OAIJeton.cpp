...
OAIJeton::OAIJeton(QString json) {
...
void OAIJeton::fromJson(QString jsonString) {
...
void OAIJeton::fromJsonObject(QJsonObject json) {
...
QJsonObject OAIJeton::asJsonObject() const {
    QJsonObject obj;
    if (m__links.size() > 0) {
...
QList<OAIGatewayAccount__links_inner> OAIJeton::getLinks() const {
    return m__links;
}
void OAIJeton::setLinks(const QList<OAIGatewayAccount__links_inner> &_links) {
    m__links = _links;
    m__links_isSet = true;
}

bool OAIJeton::is__links_Set() const{
    return m__links_isSet;
}

bool OAIJeton::is__links_Valid() const{
    return m__links_isValid;
}

QList<QString> OAIJeton::getAcceptedCurrencies() const {
    return m_accepted_currencies;
}
void OAIJeton::setAcceptedCurrencies(const QList<QString> &accepted_currencies) {
    m_accepted_currencies = accepted_currencies;
    m_accepted_currencies_isSet = true;
}

bool OAIJeton::is_accepted_currencies_Set() const{
    return m_accepted_currencies_isSet;
}

bool OAIJeton::is_accepted_currencies_Valid() const{
    return m_accepted_currencies_isValid;
}

OAIAcquirerName OAIJeton::getAcquirerName() const {
    return m_acquirer_name;
}
void OAIJeton::setAcquirerName(const OAIAcquirerName &acquirer_name) {
    m_acquirer_name = acquirer_name;
    m_acquirer_name_isSet = true;
}

bool OAIJeton::is_acquirer_name_Set() const{
    return m_acquirer_name_isSet;
}

bool OAIJeton::is_acquirer_name_Valid() const{
    return m_acquirer_name_isValid;
}

QString OAIJeton::getAdditionalFilters() const {
    return m_additional_filters;
}
void OAIJeton::setAdditionalFilters(const QString &additional_filters) {
    m_additional_filters = additional_filters;
    m_additional_filters_isSet = true;
}

bool OAIJeton::is_additional_filters_Set() const{
    return m_additional_filters_isSet;
}

bool OAIJeton::is_additional_filters_Valid() const{
    return m_additional_filters_isValid;
}

qint32 OAIJeton::getApprovalWindowTtl() const {
    return m_approval_window_ttl;
}
void OAIJeton::setApprovalWindowTtl(const qint32 &approval_window_ttl) {
    m_approval_window_ttl = approval_window_ttl;
    m_approval_window_ttl_isSet = true;
}

bool OAIJeton::is_approval_window_ttl_Set() const{
    return m_approval_window_ttl_isSet;
}

bool OAIJeton::is_approval_window_ttl_Valid() const{
    return m_approval_window_ttl_isValid;
}

QString OAIJeton::getCityField() const {
    return m_city_field;
}
void OAIJeton::setCityField(const QString &city_field) {
    m_city_field = city_field;
    m_city_field_isSet = true;
}

bool OAIJeton::is_city_field_Set() const{
    return m_city_field_isSet;
}

bool OAIJeton::is_city_field_Valid() const{
    return m_city_field_isValid;
}

QDateTime OAIJeton::getCreatedTime() const {
    return m_created_time;
}
void OAIJeton::setCreatedTime(const QDateTime &created_time) {
    m_created_time = created_time;
    m_created_time_isSet = true;
}

bool OAIJeton::is_created_time_Set() const{
    return m_created_time_isSet;
}

bool OAIJeton::is_created_time_Valid() const{
    return m_created_time_isValid;
}

QString OAIJeton::getDccForceCurrency() const {
    return m_dcc_force_currency;
}
void OAIJeton::setDccForceCurrency(const QString &dcc_force_currency) {
    m_dcc_force_currency = dcc_force_currency;
    m_dcc_force_currency_isSet = true;
}

bool OAIJeton::is_dcc_force_currency_Set() const{
    return m_dcc_force_currency_isSet;
}

bool OAIJeton::is_dcc_force_currency_Valid() const{
    return m_dcc_force_currency_isValid;
}

qint32 OAIJeton::getDccMarkup() const {
    return m_dcc_markup;
}
void OAIJeton::setDccMarkup(const qint32 &dcc_markup) {
    m_dcc_markup = dcc_markup;
    m_dcc_markup_isSet = true;
}

bool OAIJeton::is_dcc_markup_Set() const{
    return m_dcc_markup_isSet;
}

bool OAIJeton::is_dcc_markup_Valid() const{
    return m_dcc_markup_isValid;
}

QString OAIJeton::getDescriptor() const {
    return m_descriptor;
}
void OAIJeton::setDescriptor(const QString &descriptor) {
    m_descriptor = descriptor;
    m_descriptor_isSet = true;
}

bool OAIJeton::is_descriptor_Set() const{
    return m_descriptor_isSet;
}

bool OAIJeton::is_descriptor_Valid() const{
    return m_descriptor_isValid;
}

OAIDigitalWallets OAIJeton::getDigitalWallets() const {
    return m_digital_wallets;
}
void OAIJeton::setDigitalWallets(const OAIDigitalWallets &digital_wallets) {
    m_digital_wallets = digital_wallets;
    m_digital_wallets_isSet = true;
}

bool OAIJeton::is_digital_wallets_Set() const{
    return m_digital_wallets_isSet;
}

bool OAIJeton::is_digital_wallets_Valid() const{
    return m_digital_wallets_isValid;
}

bool OAIJeton::isDynamicDescriptor() const {
    return m_dynamic_descriptor;
}
void OAIJeton::setDynamicDescriptor(const bool &dynamic_descriptor) {
    m_dynamic_descriptor = dynamic_descriptor;
    m_dynamic_descriptor_isSet = true;
}

bool OAIJeton::is_dynamic_descriptor_Set() const{
    return m_dynamic_descriptor_isSet;
}

bool OAIJeton::is_dynamic_descriptor_Valid() const{
    return m_dynamic_descriptor_isValid;
}

QList<QString> OAIJeton::getExcludedDccQuoteCurrencies() const {
    return m_excluded_dcc_quote_currencies;
}
void OAIJeton::setExcludedDccQuoteCurrencies(const QList<QString> &excluded_dcc_quote_currencies) {
    m_excluded_dcc_quote_currencies = excluded_dcc_quote_currencies;
    m_excluded_dcc_quote_currencies_isSet = true;
}

bool OAIJeton::is_excluded_dcc_quote_currencies_Set() const{
    return m_excluded_dcc_quote_currencies_isSet;
}

bool OAIJeton::is_excluded_dcc_quote_currencies_Valid() const{
    return m_excluded_dcc_quote_currencies_isValid;
}

OAIGatewayName OAIJeton::getGatewayName() const {
    return m_gateway_name;
}
void OAIJeton::setGatewayName(const OAIGatewayName &gateway_name) {
    m_gateway_name = gateway_name;
    m_gateway_name_isSet = true;
}

bool OAIJeton::is_gateway_name_Set() const{
    return m_gateway_name_isSet;
}

bool OAIJeton::is_gateway_name_Valid() const{
    return m_gateway_name_isValid;
}

QString OAIJeton::getId() const {
    return m_id;
}
void OAIJeton::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIJeton::is_id_Set() const{
    return m_id_isSet;
}

bool OAIJeton::is_id_Valid() const{
    return m_id_isValid;
}

bool OAIJeton::isIsDown() const {
    return m_is_down;
}
void OAIJeton::setIsDown(const bool &is_down) {
    m_is_down = is_down;
    m_is_down_isSet = true;
}

bool OAIJeton::is_is_down_Set() const{
    return m_is_down_isSet;
}

bool OAIJeton::is_is_down_Valid() const{
    return m_is_down_isValid;
}

QString OAIJeton::getMerchantCategoryCode() const {
    return m_merchant_category_code;
}
void OAIJeton::setMerchantCategoryCode(const QString &merchant_category_code) {
    m_merchant_category_code = merchant_category_code;
    m_merchant_category_code_isSet = true;
}

bool OAIJeton::is_merchant_category_code_Set() const{
    return m_merchant_category_code_isSet;
}

bool OAIJeton::is_merchant_category_code_Valid() const{
    return m_merchant_category_code_isValid;
}

OAIPaymentMethod OAIJeton::getMethod() const {
    return m_method;
}
void OAIJeton::setMethod(const OAIPaymentMethod &method) {
    m_method = method;
    m_method_isSet = true;
}

bool OAIJeton::is_method_Set() const{
    return m_method_isSet;
}

bool OAIJeton::is_method_Valid() const{
    return m_method_isValid;
}

double OAIJeton::getMonthlyLimit() const {
    return m_monthly_limit;
}
void OAIJeton::setMonthlyLimit(const double &monthly_limit) {
    m_monthly_limit = monthly_limit;
    m_monthly_limit_isSet = true;
}

bool OAIJeton::is_monthly_limit_Set() const{
    return m_monthly_limit_isSet;
}

bool OAIJeton::is_monthly_limit_Valid() const{
    return m_monthly_limit_isValid;
}

QString OAIJeton::getOrganizationId() const {
    return m_organization_id;
}
void OAIJeton::setOrganizationId(const QString &organization_id) {
    m_organization_id = organization_id;
    m_organization_id_isSet = true;
}

bool OAIJeton::is_organization_id_Set() const{
    return m_organization_id_isSet;
}

bool OAIJeton::is_organization_id_Valid() const{
    return m_organization_id_isValid;
}

QList<OAIPaymentCardBrand> OAIJeton::getPaymentCardSchemes() const {
    return m_payment_card_schemes;
}
void OAIJeton::setPaymentCardSchemes(const QList<OAIPaymentCardBrand> &payment_card_schemes) {
    m_payment_card_schemes = payment_card_schemes;
    m_payment_card_schemes_isSet = true;
}

bool OAIJeton::is_payment_card_schemes_Set() const{
    return m_payment_card_schemes_isSet;
}

bool OAIJeton::is_payment_card_schemes_Valid() const{
    return m_payment_card_schemes_isValid;
}

bool OAIJeton::isReconciliationWindowEnabled() const {
    return m_reconciliation_window_enabled;
}
void OAIJeton::setReconciliationWindowEnabled(const bool &reconciliation_window_enabled) {
    m_reconciliation_window_enabled = reconciliation_window_enabled;
    m_reconciliation_window_enabled_isSet = true;
}

bool OAIJeton::is_reconciliation_window_enabled_Set() const{
    return m_reconciliation_window_enabled_isSet;
}

bool OAIJeton::is_reconciliation_window_enabled_Valid() const{
    return m_reconciliation_window_enabled_isValid;
}

qint32 OAIJeton::getReconciliationWindowTtl() const {
    return m_reconciliation_window_ttl;
}
void OAIJeton::setReconciliationWindowTtl(const qint32 &reconciliation_window_ttl) {
    m_reconciliation_window_ttl = reconciliation_window_ttl;
    m_reconciliation_window_ttl_isSet = true;
}

bool OAIJeton::is_reconciliation_window_ttl_Set() const{
    return m_reconciliation_window_ttl_isSet;
}

bool OAIJeton::is_reconciliation_window_ttl_Valid() const{
    return m_reconciliation_window_ttl_isValid;
}

QString OAIJeton::getStatus() const {
    return m_status;
}
void OAIJeton::setStatus(const QString &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIJeton::is_status_Set() const{
    return m_status_isSet;
}

bool OAIJeton::is_status_Valid() const{
    return m_status_isValid;
}

bool OAIJeton::isSticky() const {
    return m_sticky;
}
void OAIJeton::setSticky(const bool &sticky) {
    m_sticky = sticky;
    m_sticky_isSet = true;
}

bool OAIJeton::is_sticky_Set() const{
    return m_sticky_isSet;
}

bool OAIJeton::is_sticky_Valid() const{
    return m_sticky_isValid;
}

bool OAIJeton::isThreeDSecure() const {
    return m_three_d_secure;
}
void OAIJeton::setThreeDSecure(const bool &three_d_secure) {
    m_three_d_secure = three_d_secure;
    m_three_d_secure_isSet = true;
}

bool OAIJeton::is_three_d_secure_Set() const{
    return m_three_d_secure_isSet;
}

bool OAIJeton::is_three_d_secure_Valid() const{
    return m_three_d_secure_isValid;
}

qint32 OAIJeton::getTimeout() const {
    return m_timeout;
}
void OAIJeton::setTimeout(const qint32 &timeout) {
    m_timeout = timeout;
    m_timeout_isSet = true;
}

bool OAIJeton::is_timeout_Set() const{
    return m_timeout_isSet;
}

bool OAIJeton::is_timeout_Valid() const{
    return m_timeout_isValid;
}

QString OAIJeton::getToken() const {
    return m_token;
}
void OAIJeton::setToken(const QString &token) {
    m_token = token;
    m_token_isSet = true;
}

bool OAIJeton::is_token_Set() const{
    return m_token_isSet;
}

bool OAIJeton::is_token_Valid() const{
    return m_token_isValid;
}

QDateTime OAIJeton::getUpdatedTime() const {
    return m_updated_time;
}
void OAIJeton::setUpdatedTime(const QDateTime &updated_time) {
    m_updated_time = updated_time;
    m_updated_time_isSet = true;
}

bool OAIJeton::is_updated_time_Set() const{
    return m_updated_time_isSet;
}

bool OAIJeton::is_updated_time_Valid() const{
    return m_updated_time_isValid;
}

OAIJeton_allOf_credentials OAIJeton::getCredentials() const {
    return m_credentials;
}
void OAIJeton::setCredentials(const OAIJeton_allOf_credentials &credentials) {
    m_credentials = credentials;
    m_credentials_isSet = true;
}

bool OAIJeton::is_credentials_Set() const{
    return m_credentials_isSet;
}

bool OAIJeton::is_credentials_Valid() const{
    return m_credentials_isValid;
}

OAIJeton_allOf_settings OAIJeton::getSettings() const {
    return m_settings;
}
void OAIJeton::setSettings(const OAIJeton_allOf_settings &settings) {
    m_settings = settings;
    m_settings_isSet = true;
}

bool OAIJeton::is_settings_Set() const{
    return m_settings_isSet;
}

bool OAIJeton::is_settings_Valid() const{
    return m_settings_isValid;
}

bool OAIJeton::isSet() const {
