...
#include "OAICayan_allOf_credentials.h"
...
class OAICayan_allOf_credentials;

class OAICayan : public OAIObject {
public:
    OAICayan();
    OAICayan(QString json);
    ~OAICayan() override;
    ...
    OAICayan_allOf_credentials getCredentials() const;
    void setCredentials(const OAICayan_allOf_credentials &credentials);
...
private:
    ...
    OAICayan_allOf_credentials m_credentials;
...
Q_DECLARE_METATYPE(OpenAPI::OAICayan)
