...
OAICompositeToken::OAICompositeToken(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICompositeToken::OAICompositeToken() {
    this->initializeModel();
}

OAICompositeToken::~OAICompositeToken() {}

void OAICompositeToken::initializeModel() {
...
void OAICompositeToken::fromJson(QString jsonString) {
...
void OAICompositeToken::fromJsonObject(QJsonObject json) {
...
QString OAICompositeToken::asJson() const {
...
QJsonObject OAICompositeToken::asJsonObject() const {
    QJsonObject obj;
...
OAIContactObject OAICompositeToken::getBillingAddress() const {
    return m_billing_address;
}
void OAICompositeToken::setBillingAddress(const OAIContactObject &billing_address) {
    m_billing_address = billing_address;
    m_billing_address_isSet = true;
}

bool OAICompositeToken::is_billing_address_Set() const{
    return m_billing_address_isSet;
}

bool OAICompositeToken::is_billing_address_Valid() const{
    return m_billing_address_isValid;
}

QString OAICompositeToken::getMethod() const {
    return m_method;
}
void OAICompositeToken::setMethod(const QString &method) {
    m_method = method;
    m_method_isSet = true;
}

bool OAICompositeToken::is_method_Set() const{
    return m_method_isSet;
}

bool OAICompositeToken::is_method_Valid() const{
    return m_method_isValid;
}

OAIObject OAICompositeToken::getPaymentInstrument() const {
    return m_payment_instrument;
}
void OAICompositeToken::setPaymentInstrument(const OAIObject &payment_instrument) {
    m_payment_instrument = payment_instrument;
    m_payment_instrument_isSet = true;
}

bool OAICompositeToken::is_payment_instrument_Set() const{
    return m_payment_instrument_isSet;
}

bool OAICompositeToken::is_payment_instrument_Valid() const{
    return m_payment_instrument_isValid;
}

QList<OAISelfLink> OAICompositeToken::getLinks() const {
    return m__links;
}
void OAICompositeToken::setLinks(const QList<OAISelfLink> &_links) {
    m__links = _links;
    m__links_isSet = true;
}

bool OAICompositeToken::is__links_Set() const{
    return m__links_isSet;
}

bool OAICompositeToken::is__links_Valid() const{
    return m__links_isValid;
}

QDateTime OAICompositeToken::getCreatedTime() const {
    return m_created_time;
}
void OAICompositeToken::setCreatedTime(const QDateTime &created_time) {
    m_created_time = created_time;
    m_created_time_isSet = true;
}

bool OAICompositeToken::is_created_time_Set() const{
    return m_created_time_isSet;
}

bool OAICompositeToken::is_created_time_Valid() const{
    return m_created_time_isValid;
}

QDateTime OAICompositeToken::getExpirationTime() const {
    return m_expiration_time;
}
void OAICompositeToken::setExpirationTime(const QDateTime &expiration_time) {
    m_expiration_time = expiration_time;
    m_expiration_time_isSet = true;
}

bool OAICompositeToken::is_expiration_time_Set() const{
    return m_expiration_time_isSet;
}

bool OAICompositeToken::is_expiration_time_Valid() const{
    return m_expiration_time_isValid;
}

QString OAICompositeToken::getId() const {
    return m_id;
}
void OAICompositeToken::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAICompositeToken::is_id_Set() const{
    return m_id_isSet;
}

bool OAICompositeToken::is_id_Valid() const{
    return m_id_isValid;
}

bool OAICompositeToken::isIsUsed() const {
    return m_is_used;
}
void OAICompositeToken::setIsUsed(const bool &is_used) {
    m_is_used = is_used;
    m_is_used_isSet = true;
}

bool OAICompositeToken::is_is_used_Set() const{
    return m_is_used_isSet;
}

bool OAICompositeToken::is_is_used_Valid() const{
    return m_is_used_isValid;
}

OAILeadSource OAICompositeToken::getLeadSource() const {
    return m_lead_source;
}
void OAICompositeToken::setLeadSource(const OAILeadSource &lead_source) {
    m_lead_source = lead_source;
    m_lead_source_isSet = true;
}

bool OAICompositeToken::is_lead_source_Set() const{
    return m_lead_source_isSet;
}

bool OAICompositeToken::is_lead_source_Valid() const{
    return m_lead_source_isValid;
}

OAIRiskMetadata OAICompositeToken::getRiskMetadata() const {
    return m_risk_metadata;
}
void OAICompositeToken::setRiskMetadata(const OAIRiskMetadata &risk_metadata) {
    m_risk_metadata = risk_metadata;
    m_risk_metadata_isSet = true;
}

bool OAICompositeToken::is_risk_metadata_Set() const{
    return m_risk_metadata_isSet;
}

bool OAICompositeToken::is_risk_metadata_Valid() const{
    return m_risk_metadata_isValid;
}

QDateTime OAICompositeToken::getUpdatedTime() const {
    return m_updated_time;
}
void OAICompositeToken::setUpdatedTime(const QDateTime &updated_time) {
    m_updated_time = updated_time;
    m_updated_time_isSet = true;
}

bool OAICompositeToken::is_updated_time_Set() const{
    return m_updated_time_isSet;
}

bool OAICompositeToken::is_updated_time_Valid() const{
    return m_updated_time_isValid;
}

QDateTime OAICompositeToken::getUsageTime() const {
    return m_usage_time;
}
void OAICompositeToken::setUsageTime(const QDateTime &usage_time) {
    m_usage_time = usage_time;
    m_usage_time_isSet = true;
}

bool OAICompositeToken::is_usage_time_Set() const{
    return m_usage_time_isSet;
}

bool OAICompositeToken::is_usage_time_Valid() const{
    return m_usage_time_isValid;
}

bool OAICompositeToken::isSet() const {
...
bool OAICompositeToken::isValid() const {
