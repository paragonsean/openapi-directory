...
OAIEcoPayz::OAIEcoPayz(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIEcoPayz::OAIEcoPayz() {
    this->initializeModel();
}

OAIEcoPayz::~OAIEcoPayz() {}

void OAIEcoPayz::initializeModel() {
...
void OAIEcoPayz::fromJson(QString jsonString) {
...
void OAIEcoPayz::fromJsonObject(QJsonObject json) {
...
QString OAIEcoPayz::asJson() const {
...
QJsonObject OAIEcoPayz::asJsonObject() const {
    QJsonObject obj;
    if (m__links.size() > 0) {
...
QList<OAIGatewayAccount__links_inner> OAIEcoPayz::getLinks() const {
    return m__links;
}
void OAIEcoPayz::setLinks(const QList<OAIGatewayAccount__links_inner> &_links) {
    m__links = _links;
    m__links_isSet = true;
}

bool OAIEcoPayz::is__links_Set() const{
    return m__links_isSet;
}

bool OAIEcoPayz::is__links_Valid() const{
    return m__links_isValid;
}

QList<QString> OAIEcoPayz::getAcceptedCurrencies() const {
    return m_accepted_currencies;
}
void OAIEcoPayz::setAcceptedCurrencies(const QList<QString> &accepted_currencies) {
    m_accepted_currencies = accepted_currencies;
    m_accepted_currencies_isSet = true;
}

bool OAIEcoPayz::is_accepted_currencies_Set() const{
    return m_accepted_currencies_isSet;
}

bool OAIEcoPayz::is_accepted_currencies_Valid() const{
    return m_accepted_currencies_isValid;
}

OAIAcquirerName OAIEcoPayz::getAcquirerName() const {
    return m_acquirer_name;
}
void OAIEcoPayz::setAcquirerName(const OAIAcquirerName &acquirer_name) {
    m_acquirer_name = acquirer_name;
    m_acquirer_name_isSet = true;
}

bool OAIEcoPayz::is_acquirer_name_Set() const{
    return m_acquirer_name_isSet;
}

bool OAIEcoPayz::is_acquirer_name_Valid() const{
    return m_acquirer_name_isValid;
}

QString OAIEcoPayz::getAdditionalFilters() const {
    return m_additional_filters;
}
void OAIEcoPayz::setAdditionalFilters(const QString &additional_filters) {
    m_additional_filters = additional_filters;
    m_additional_filters_isSet = true;
}

bool OAIEcoPayz::is_additional_filters_Set() const{
    return m_additional_filters_isSet;
}

bool OAIEcoPayz::is_additional_filters_Valid() const{
    return m_additional_filters_isValid;
}

qint32 OAIEcoPayz::getApprovalWindowTtl() const {
    return m_approval_window_ttl;
}
void OAIEcoPayz::setApprovalWindowTtl(const qint32 &approval_window_ttl) {
    m_approval_window_ttl = approval_window_ttl;
    m_approval_window_ttl_isSet = true;
}

bool OAIEcoPayz::is_approval_window_ttl_Set() const{
    return m_approval_window_ttl_isSet;
}

bool OAIEcoPayz::is_approval_window_ttl_Valid() const{
    return m_approval_window_ttl_isValid;
}

QString OAIEcoPayz::getCityField() const {
    return m_city_field;
}
void OAIEcoPayz::setCityField(const QString &city_field) {
    m_city_field = city_field;
    m_city_field_isSet = true;
}

bool OAIEcoPayz::is_city_field_Set() const{
    return m_city_field_isSet;
}

bool OAIEcoPayz::is_city_field_Valid() const{
    return m_city_field_isValid;
}

QDateTime OAIEcoPayz::getCreatedTime() const {
    return m_created_time;
}
void OAIEcoPayz::setCreatedTime(const QDateTime &created_time) {
    m_created_time = created_time;
    m_created_time_isSet = true;
}

bool OAIEcoPayz::is_created_time_Set() const{
    return m_created_time_isSet;
}

bool OAIEcoPayz::is_created_time_Valid() const{
    return m_created_time_isValid;
}

QString OAIEcoPayz::getDccForceCurrency() const {
    return m_dcc_force_currency;
}
void OAIEcoPayz::setDccForceCurrency(const QString &dcc_force_currency) {
    m_dcc_force_currency = dcc_force_currency;
    m_dcc_force_currency_isSet = true;
}

bool OAIEcoPayz::is_dcc_force_currency_Set() const{
    return m_dcc_force_currency_isSet;
}

bool OAIEcoPayz::is_dcc_force_currency_Valid() const{
    return m_dcc_force_currency_isValid;
}

qint32 OAIEcoPayz::getDccMarkup() const {
    return m_dcc_markup;
}
void OAIEcoPayz::setDccMarkup(const qint32 &dcc_markup) {
    m_dcc_markup = dcc_markup;
    m_dcc_markup_isSet = true;
}

bool OAIEcoPayz::is_dcc_markup_Set() const{
    return m_dcc_markup_isSet;
}

bool OAIEcoPayz::is_dcc_markup_Valid() const{
    return m_dcc_markup_isValid;
}

QString OAIEcoPayz::getDescriptor() const {
    return m_descriptor;
}
void OAIEcoPayz::setDescriptor(const QString &descriptor) {
    m_descriptor = descriptor;
    m_descriptor_isSet = true;
}

bool OAIEcoPayz::is_descriptor_Set() const{
    return m_descriptor_isSet;
}

bool OAIEcoPayz::is_descriptor_Valid() const{
    return m_descriptor_isValid;
}

OAIDigitalWallets OAIEcoPayz::getDigitalWallets() const {
    return m_digital_wallets;
}
void OAIEcoPayz::setDigitalWallets(const OAIDigitalWallets &digital_wallets) {
    m_digital_wallets = digital_wallets;
    m_digital_wallets_isSet = true;
}

bool OAIEcoPayz::is_digital_wallets_Set() const{
    return m_digital_wallets_isSet;
}

bool OAIEcoPayz::is_digital_wallets_Valid() const{
    return m_digital_wallets_isValid;
}

bool OAIEcoPayz::isDynamicDescriptor() const {
    return m_dynamic_descriptor;
}
void OAIEcoPayz::setDynamicDescriptor(const bool &dynamic_descriptor) {
    m_dynamic_descriptor = dynamic_descriptor;
    m_dynamic_descriptor_isSet = true;
}

bool OAIEcoPayz::is_dynamic_descriptor_Set() const{
    return m_dynamic_descriptor_isSet;
}

bool OAIEcoPayz::is_dynamic_descriptor_Valid() const{
    return m_dynamic_descriptor_isValid;
}

QList<QString> OAIEcoPayz::getExcludedDccQuoteCurrencies() const {
    return m_excluded_dcc_quote_currencies;
}
void OAIEcoPayz::setExcludedDccQuoteCurrencies(const QList<QString> &excluded_dcc_quote_currencies) {
    m_excluded_dcc_quote_currencies = excluded_dcc_quote_currencies;
    m_excluded_dcc_quote_currencies_isSet = true;
}

bool OAIEcoPayz::is_excluded_dcc_quote_currencies_Set() const{
    return m_excluded_dcc_quote_currencies_isSet;
}

bool OAIEcoPayz::is_excluded_dcc_quote_currencies_Valid() const{
    return m_excluded_dcc_quote_currencies_isValid;
}

OAIGatewayName OAIEcoPayz::getGatewayName() const {
    return m_gateway_name;
}
void OAIEcoPayz::setGatewayName(const OAIGatewayName &gateway_name) {
    m_gateway_name = gateway_name;
    m_gateway_name_isSet = true;
}

bool OAIEcoPayz::is_gateway_name_Set() const{
    return m_gateway_name_isSet;
}

bool OAIEcoPayz::is_gateway_name_Valid() const{
    return m_gateway_name_isValid;
}

QString OAIEcoPayz::getId() const {
    return m_id;
}
void OAIEcoPayz::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIEcoPayz::is_id_Set() const{
    return m_id_isSet;
}

bool OAIEcoPayz::is_id_Valid() const{
    return m_id_isValid;
}

bool OAIEcoPayz::isIsDown() const {
    return m_is_down;
}
void OAIEcoPayz::setIsDown(const bool &is_down) {
    m_is_down = is_down;
    m_is_down_isSet = true;
}

bool OAIEcoPayz::is_is_down_Set() const{
    return m_is_down_isSet;
}

bool OAIEcoPayz::is_is_down_Valid() const{
    return m_is_down_isValid;
}

QString OAIEcoPayz::getMerchantCategoryCode() const {
    return m_merchant_category_code;
}
void OAIEcoPayz::setMerchantCategoryCode(const QString &merchant_category_code) {
    m_merchant_category_code = merchant_category_code;
    m_merchant_category_code_isSet = true;
}

bool OAIEcoPayz::is_merchant_category_code_Set() const{
    return m_merchant_category_code_isSet;
}

bool OAIEcoPayz::is_merchant_category_code_Valid() const{
    return m_merchant_category_code_isValid;
}

OAIPaymentMethod OAIEcoPayz::getMethod() const {
    return m_method;
}
void OAIEcoPayz::setMethod(const OAIPaymentMethod &method) {
    m_method = method;
    m_method_isSet = true;
}

bool OAIEcoPayz::is_method_Set() const{
    return m_method_isSet;
}

bool OAIEcoPayz::is_method_Valid() const{
    return m_method_isValid;
}

double OAIEcoPayz::getMonthlyLimit() const {
    return m_monthly_limit;
}
void OAIEcoPayz::setMonthlyLimit(const double &monthly_limit) {
    m_monthly_limit = monthly_limit;
    m_monthly_limit_isSet = true;
}

bool OAIEcoPayz::is_monthly_limit_Set() const{
    return m_monthly_limit_isSet;
}

bool OAIEcoPayz::is_monthly_limit_Valid() const{
    return m_monthly_limit_isValid;
}

QString OAIEcoPayz::getOrganizationId() const {
    return m_organization_id;
}
void OAIEcoPayz::setOrganizationId(const QString &organization_id) {
    m_organization_id = organization_id;
    m_organization_id_isSet = true;
}

bool OAIEcoPayz::is_organization_id_Set() const{
    return m_organization_id_isSet;
}

bool OAIEcoPayz::is_organization_id_Valid() const{
    return m_organization_id_isValid;
}

QList<OAIPaymentCardBrand> OAIEcoPayz::getPaymentCardSchemes() const {
    return m_payment_card_schemes;
}
void OAIEcoPayz::setPaymentCardSchemes(const QList<OAIPaymentCardBrand> &payment_card_schemes) {
    m_payment_card_schemes = payment_card_schemes;
    m_payment_card_schemes_isSet = true;
}

bool OAIEcoPayz::is_payment_card_schemes_Set() const{
    return m_payment_card_schemes_isSet;
}

bool OAIEcoPayz::is_payment_card_schemes_Valid() const{
    return m_payment_card_schemes_isValid;
}

bool OAIEcoPayz::isReconciliationWindowEnabled() const {
    return m_reconciliation_window_enabled;
}
void OAIEcoPayz::setReconciliationWindowEnabled(const bool &reconciliation_window_enabled) {
    m_reconciliation_window_enabled = reconciliation_window_enabled;
    m_reconciliation_window_enabled_isSet = true;
}

bool OAIEcoPayz::is_reconciliation_window_enabled_Set() const{
    return m_reconciliation_window_enabled_isSet;
}

bool OAIEcoPayz::is_reconciliation_window_enabled_Valid() const{
    return m_reconciliation_window_enabled_isValid;
}

qint32 OAIEcoPayz::getReconciliationWindowTtl() const {
    return m_reconciliation_window_ttl;
}
void OAIEcoPayz::setReconciliationWindowTtl(const qint32 &reconciliation_window_ttl) {
    m_reconciliation_window_ttl = reconciliation_window_ttl;
    m_reconciliation_window_ttl_isSet = true;
}

bool OAIEcoPayz::is_reconciliation_window_ttl_Set() const{
    return m_reconciliation_window_ttl_isSet;
}

bool OAIEcoPayz::is_reconciliation_window_ttl_Valid() const{
    return m_reconciliation_window_ttl_isValid;
}

QString OAIEcoPayz::getStatus() const {
    return m_status;
}
void OAIEcoPayz::setStatus(const QString &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIEcoPayz::is_status_Set() const{
    return m_status_isSet;
}

bool OAIEcoPayz::is_status_Valid() const{
    return m_status_isValid;
}

bool OAIEcoPayz::isSticky() const {
    return m_sticky;
}
void OAIEcoPayz::setSticky(const bool &sticky) {
    m_sticky = sticky;
    m_sticky_isSet = true;
}

bool OAIEcoPayz::is_sticky_Set() const{
    return m_sticky_isSet;
}

bool OAIEcoPayz::is_sticky_Valid() const{
    return m_sticky_isValid;
}

bool OAIEcoPayz::isThreeDSecure() const {
    return m_three_d_secure;
}
void OAIEcoPayz::setThreeDSecure(const bool &three_d_secure) {
    m_three_d_secure = three_d_secure;
    m_three_d_secure_isSet = true;
}

bool OAIEcoPayz::is_three_d_secure_Set() const{
    return m_three_d_secure_isSet;
}

bool OAIEcoPayz::is_three_d_secure_Valid() const{
    return m_three_d_secure_isValid;
}

qint32 OAIEcoPayz::getTimeout() const {
    return m_timeout;
}
void OAIEcoPayz::setTimeout(const qint32 &timeout) {
    m_timeout = timeout;
    m_timeout_isSet = true;
}

bool OAIEcoPayz::is_timeout_Set() const{
    return m_timeout_isSet;
}

bool OAIEcoPayz::is_timeout_Valid() const{
    return m_timeout_isValid;
}

QString OAIEcoPayz::getToken() const {
    return m_token;
}
void OAIEcoPayz::setToken(const QString &token) {
    m_token = token;
    m_token_isSet = true;
}

bool OAIEcoPayz::is_token_Set() const{
    return m_token_isSet;
}

bool OAIEcoPayz::is_token_Valid() const{
    return m_token_isValid;
}

QDateTime OAIEcoPayz::getUpdatedTime() const {
    return m_updated_time;
}
void OAIEcoPayz::setUpdatedTime(const QDateTime &updated_time) {
    m_updated_time = updated_time;
    m_updated_time_isSet = true;
}

bool OAIEcoPayz::is_updated_time_Set() const{
    return m_updated_time_isSet;
}

bool OAIEcoPayz::is_updated_time_Valid() const{
    return m_updated_time_isValid;
}

OAIEcoPayz_allOf_credentials OAIEcoPayz::getCredentials() const {
    return m_credentials;
}
void OAIEcoPayz::setCredentials(const OAIEcoPayz_allOf_credentials &credentials) {
    m_credentials = credentials;
    m_credentials_isSet = true;
}

bool OAIEcoPayz::is_credentials_Set() const{
    return m_credentials_isSet;
}

bool OAIEcoPayz::is_credentials_Valid() const{
    return m_credentials_isValid;
}

OAIEcoPayz_allOf_settings OAIEcoPayz::getSettings() const {
    return m_settings;
}
void OAIEcoPayz::setSettings(const OAIEcoPayz_allOf_settings &settings) {
    m_settings = settings;
    m_settings_isSet = true;
}

bool OAIEcoPayz::is_settings_Set() const{
    return m_settings_isSet;
}

bool OAIEcoPayz::is_settings_Valid() const{
    return m_settings_isValid;
}

bool OAIEcoPayz::isSet() const {
