...
#include "OAIProsa_allOf_credentials.h"
#include <QDateTime>
#include <QList>
#include <QString>
...
class OAIProsa_allOf_credentials;

class OAIProsa : public OAIObject {
public:
    OAIProsa();
    OAIProsa(QString json);
    ~OAIProsa() override;
    ...
    OAIProsa_allOf_credentials getCredentials() const;
    void setCredentials(const OAIProsa_allOf_credentials &credentials);
...
private:
    ...
    OAIProsa_allOf_credentials m_credentials;
...
Q_DECLARE_METATYPE(OpenAPI::OAIProsa)
