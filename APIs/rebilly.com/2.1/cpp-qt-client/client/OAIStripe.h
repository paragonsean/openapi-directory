...
class OAIStripe_allOf_settings;
class OAIStripe3dsServers;

class OAIStripe : public OAIObject {
public:
    OAIStripe();
    OAIStripe(QString json);
    ~OAIStripe() override;
    ...
    OAIStripe_allOf_settings getSettings() const;
    void setSettings(const OAIStripe_allOf_settings &settings);
    bool is_settings_Set() const;
    bool is_settings_Valid() const;

    OAIStripe3dsServers getThreeDSecureServer() const;
    void setThreeDSecureServer(const OAIStripe3dsServers &three_d_secure_server);
...
private:
    ...
    OAIStripe_allOf_settings m_settings;
    bool m_settings_isSet;
    bool m_settings_isValid;

    OAIStripe3dsServers m_three_d_secure_server;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStripe)
