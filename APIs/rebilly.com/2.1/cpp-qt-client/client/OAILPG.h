...
class OAILPG_allOf_credentials;

class OAILPG : public OAIObject {
public:
    OAILPG();
    OAILPG(QString json);
    ~OAILPG() override;
    ...
    OAILPG_allOf_credentials getCredentials() const;
    void setCredentials(const OAILPG_allOf_credentials &credentials);
...
private:
    ...
    OAILPG_allOf_credentials m_credentials;
...
Q_DECLARE_METATYPE(OpenAPI::OAILPG)
