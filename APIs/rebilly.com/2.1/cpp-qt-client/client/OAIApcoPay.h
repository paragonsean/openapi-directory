...
class OAIApcoPay_allOf_credentials;
class OAIApcoPay_allOf_settings;

class OAIApcoPay : public OAIObject {
public:
    OAIApcoPay();
    OAIApcoPay(QString json);
    ~OAIApcoPay() override;
    ...
    OAIApcoPay_allOf_credentials getCredentials() const;
    void setCredentials(const OAIApcoPay_allOf_credentials &credentials);
    bool is_credentials_Set() const;
    bool is_credentials_Valid() const;

    OAIApcoPay_allOf_settings getSettings() const;
    void setSettings(const OAIApcoPay_allOf_settings &settings);
...
private:
    ...
    OAIApcoPay_allOf_credentials m_credentials;
    bool m_credentials_isSet;
    bool m_credentials_isValid;

    OAIApcoPay_allOf_settings m_settings;
...
Q_DECLARE_METATYPE(OpenAPI::OAIApcoPay)
