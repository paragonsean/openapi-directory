...
class OAIEBANX_allOf_credentials;

class OAIEBANX : public OAIObject {
public:
    OAIEBANX();
    OAIEBANX(QString json);
    ~OAIEBANX() override;
    ...
    OAIEBANX_allOf_credentials getCredentials() const;
    void setCredentials(const OAIEBANX_allOf_credentials &credentials);
...
private:
    ...
    OAIEBANX_allOf_credentials m_credentials;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEBANX)
