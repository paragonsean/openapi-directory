...
OAIStaticGateway::OAIStaticGateway(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIStaticGateway::OAIStaticGateway() {
    this->initializeModel();
}

OAIStaticGateway::~OAIStaticGateway() {}

void OAIStaticGateway::initializeModel() {
...
void OAIStaticGateway::fromJson(QString jsonString) {
...
void OAIStaticGateway::fromJsonObject(QJsonObject json) {
...
QString OAIStaticGateway::asJson() const {
...
QJsonObject OAIStaticGateway::asJsonObject() const {
    QJsonObject obj;
    if (m__links.size() > 0) {
...
QList<OAIGatewayAccount__links_inner> OAIStaticGateway::getLinks() const {
    return m__links;
}
void OAIStaticGateway::setLinks(const QList<OAIGatewayAccount__links_inner> &_links) {
    m__links = _links;
    m__links_isSet = true;
}

bool OAIStaticGateway::is__links_Set() const{
    return m__links_isSet;
}

bool OAIStaticGateway::is__links_Valid() const{
    return m__links_isValid;
}

QList<QString> OAIStaticGateway::getAcceptedCurrencies() const {
    return m_accepted_currencies;
}
void OAIStaticGateway::setAcceptedCurrencies(const QList<QString> &accepted_currencies) {
    m_accepted_currencies = accepted_currencies;
    m_accepted_currencies_isSet = true;
}

bool OAIStaticGateway::is_accepted_currencies_Set() const{
    return m_accepted_currencies_isSet;
}

bool OAIStaticGateway::is_accepted_currencies_Valid() const{
    return m_accepted_currencies_isValid;
}

OAIAcquirerName OAIStaticGateway::getAcquirerName() const {
    return m_acquirer_name;
}
void OAIStaticGateway::setAcquirerName(const OAIAcquirerName &acquirer_name) {
    m_acquirer_name = acquirer_name;
    m_acquirer_name_isSet = true;
}

bool OAIStaticGateway::is_acquirer_name_Set() const{
    return m_acquirer_name_isSet;
}

bool OAIStaticGateway::is_acquirer_name_Valid() const{
    return m_acquirer_name_isValid;
}

QString OAIStaticGateway::getAdditionalFilters() const {
    return m_additional_filters;
}
void OAIStaticGateway::setAdditionalFilters(const QString &additional_filters) {
    m_additional_filters = additional_filters;
    m_additional_filters_isSet = true;
}

bool OAIStaticGateway::is_additional_filters_Set() const{
    return m_additional_filters_isSet;
}

bool OAIStaticGateway::is_additional_filters_Valid() const{
    return m_additional_filters_isValid;
}

qint32 OAIStaticGateway::getApprovalWindowTtl() const {
    return m_approval_window_ttl;
}
void OAIStaticGateway::setApprovalWindowTtl(const qint32 &approval_window_ttl) {
    m_approval_window_ttl = approval_window_ttl;
    m_approval_window_ttl_isSet = true;
}

bool OAIStaticGateway::is_approval_window_ttl_Set() const{
    return m_approval_window_ttl_isSet;
}

bool OAIStaticGateway::is_approval_window_ttl_Valid() const{
    return m_approval_window_ttl_isValid;
}

QString OAIStaticGateway::getCityField() const {
    return m_city_field;
}
void OAIStaticGateway::setCityField(const QString &city_field) {
    m_city_field = city_field;
    m_city_field_isSet = true;
}

bool OAIStaticGateway::is_city_field_Set() const{
    return m_city_field_isSet;
}

bool OAIStaticGateway::is_city_field_Valid() const{
    return m_city_field_isValid;
}

QDateTime OAIStaticGateway::getCreatedTime() const {
    return m_created_time;
}
void OAIStaticGateway::setCreatedTime(const QDateTime &created_time) {
    m_created_time = created_time;
    m_created_time_isSet = true;
}

bool OAIStaticGateway::is_created_time_Set() const{
    return m_created_time_isSet;
}

bool OAIStaticGateway::is_created_time_Valid() const{
    return m_created_time_isValid;
}

QString OAIStaticGateway::getDccForceCurrency() const {
    return m_dcc_force_currency;
}
void OAIStaticGateway::setDccForceCurrency(const QString &dcc_force_currency) {
    m_dcc_force_currency = dcc_force_currency;
    m_dcc_force_currency_isSet = true;
}

bool OAIStaticGateway::is_dcc_force_currency_Set() const{
    return m_dcc_force_currency_isSet;
}

bool OAIStaticGateway::is_dcc_force_currency_Valid() const{
    return m_dcc_force_currency_isValid;
}

qint32 OAIStaticGateway::getDccMarkup() const {
    return m_dcc_markup;
}
void OAIStaticGateway::setDccMarkup(const qint32 &dcc_markup) {
    m_dcc_markup = dcc_markup;
    m_dcc_markup_isSet = true;
}

bool OAIStaticGateway::is_dcc_markup_Set() const{
    return m_dcc_markup_isSet;
}

bool OAIStaticGateway::is_dcc_markup_Valid() const{
    return m_dcc_markup_isValid;
}

QString OAIStaticGateway::getDescriptor() const {
    return m_descriptor;
}
void OAIStaticGateway::setDescriptor(const QString &descriptor) {
    m_descriptor = descriptor;
    m_descriptor_isSet = true;
}

bool OAIStaticGateway::is_descriptor_Set() const{
    return m_descriptor_isSet;
}

bool OAIStaticGateway::is_descriptor_Valid() const{
    return m_descriptor_isValid;
}

OAIDigitalWallets OAIStaticGateway::getDigitalWallets() const {
    return m_digital_wallets;
}
void OAIStaticGateway::setDigitalWallets(const OAIDigitalWallets &digital_wallets) {
    m_digital_wallets = digital_wallets;
    m_digital_wallets_isSet = true;
}

bool OAIStaticGateway::is_digital_wallets_Set() const{
    return m_digital_wallets_isSet;
}

bool OAIStaticGateway::is_digital_wallets_Valid() const{
    return m_digital_wallets_isValid;
}

bool OAIStaticGateway::isDynamicDescriptor() const {
    return m_dynamic_descriptor;
}
void OAIStaticGateway::setDynamicDescriptor(const bool &dynamic_descriptor) {
    m_dynamic_descriptor = dynamic_descriptor;
    m_dynamic_descriptor_isSet = true;
}

bool OAIStaticGateway::is_dynamic_descriptor_Set() const{
    return m_dynamic_descriptor_isSet;
}

bool OAIStaticGateway::is_dynamic_descriptor_Valid() const{
    return m_dynamic_descriptor_isValid;
}

QList<QString> OAIStaticGateway::getExcludedDccQuoteCurrencies() const {
    return m_excluded_dcc_quote_currencies;
}
void OAIStaticGateway::setExcludedDccQuoteCurrencies(const QList<QString> &excluded_dcc_quote_currencies) {
    m_excluded_dcc_quote_currencies = excluded_dcc_quote_currencies;
    m_excluded_dcc_quote_currencies_isSet = true;
}

bool OAIStaticGateway::is_excluded_dcc_quote_currencies_Set() const{
    return m_excluded_dcc_quote_currencies_isSet;
}

bool OAIStaticGateway::is_excluded_dcc_quote_currencies_Valid() const{
    return m_excluded_dcc_quote_currencies_isValid;
}

OAIGatewayName OAIStaticGateway::getGatewayName() const {
    return m_gateway_name;
}
void OAIStaticGateway::setGatewayName(const OAIGatewayName &gateway_name) {
    m_gateway_name = gateway_name;
    m_gateway_name_isSet = true;
}

bool OAIStaticGateway::is_gateway_name_Set() const{
    return m_gateway_name_isSet;
}

bool OAIStaticGateway::is_gateway_name_Valid() const{
    return m_gateway_name_isValid;
}

QString OAIStaticGateway::getId() const {
    return m_id;
}
void OAIStaticGateway::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIStaticGateway::is_id_Set() const{
    return m_id_isSet;
}

bool OAIStaticGateway::is_id_Valid() const{
    return m_id_isValid;
}

bool OAIStaticGateway::isIsDown() const {
    return m_is_down;
}
void OAIStaticGateway::setIsDown(const bool &is_down) {
    m_is_down = is_down;
    m_is_down_isSet = true;
}

bool OAIStaticGateway::is_is_down_Set() const{
    return m_is_down_isSet;
}

bool OAIStaticGateway::is_is_down_Valid() const{
    return m_is_down_isValid;
}

QString OAIStaticGateway::getMerchantCategoryCode() const {
    return m_merchant_category_code;
}
void OAIStaticGateway::setMerchantCategoryCode(const QString &merchant_category_code) {
    m_merchant_category_code = merchant_category_code;
    m_merchant_category_code_isSet = true;
}

bool OAIStaticGateway::is_merchant_category_code_Set() const{
    return m_merchant_category_code_isSet;
}

bool OAIStaticGateway::is_merchant_category_code_Valid() const{
    return m_merchant_category_code_isValid;
}

OAIPaymentMethod OAIStaticGateway::getMethod() const {
    return m_method;
}
void OAIStaticGateway::setMethod(const OAIPaymentMethod &method) {
    m_method = method;
    m_method_isSet = true;
}

bool OAIStaticGateway::is_method_Set() const{
    return m_method_isSet;
}

bool OAIStaticGateway::is_method_Valid() const{
    return m_method_isValid;
}

double OAIStaticGateway::getMonthlyLimit() const {
    return m_monthly_limit;
}
void OAIStaticGateway::setMonthlyLimit(const double &monthly_limit) {
    m_monthly_limit = monthly_limit;
    m_monthly_limit_isSet = true;
}

bool OAIStaticGateway::is_monthly_limit_Set() const{
    return m_monthly_limit_isSet;
}

bool OAIStaticGateway::is_monthly_limit_Valid() const{
    return m_monthly_limit_isValid;
}

QString OAIStaticGateway::getOrganizationId() const {
    return m_organization_id;
}
void OAIStaticGateway::setOrganizationId(const QString &organization_id) {
    m_organization_id = organization_id;
    m_organization_id_isSet = true;
}

bool OAIStaticGateway::is_organization_id_Set() const{
    return m_organization_id_isSet;
}

bool OAIStaticGateway::is_organization_id_Valid() const{
    return m_organization_id_isValid;
}

QList<OAIPaymentCardBrand> OAIStaticGateway::getPaymentCardSchemes() const {
    return m_payment_card_schemes;
}
void OAIStaticGateway::setPaymentCardSchemes(const QList<OAIPaymentCardBrand> &payment_card_schemes) {
    m_payment_card_schemes = payment_card_schemes;
    m_payment_card_schemes_isSet = true;
}

bool OAIStaticGateway::is_payment_card_schemes_Set() const{
    return m_payment_card_schemes_isSet;
}

bool OAIStaticGateway::is_payment_card_schemes_Valid() const{
    return m_payment_card_schemes_isValid;
}

bool OAIStaticGateway::isReconciliationWindowEnabled() const {
    return m_reconciliation_window_enabled;
}
void OAIStaticGateway::setReconciliationWindowEnabled(const bool &reconciliation_window_enabled) {
    m_reconciliation_window_enabled = reconciliation_window_enabled;
    m_reconciliation_window_enabled_isSet = true;
}

bool OAIStaticGateway::is_reconciliation_window_enabled_Set() const{
    return m_reconciliation_window_enabled_isSet;
}

bool OAIStaticGateway::is_reconciliation_window_enabled_Valid() const{
    return m_reconciliation_window_enabled_isValid;
}

qint32 OAIStaticGateway::getReconciliationWindowTtl() const {
    return m_reconciliation_window_ttl;
}
void OAIStaticGateway::setReconciliationWindowTtl(const qint32 &reconciliation_window_ttl) {
    m_reconciliation_window_ttl = reconciliation_window_ttl;
    m_reconciliation_window_ttl_isSet = true;
}

bool OAIStaticGateway::is_reconciliation_window_ttl_Set() const{
    return m_reconciliation_window_ttl_isSet;
}

bool OAIStaticGateway::is_reconciliation_window_ttl_Valid() const{
    return m_reconciliation_window_ttl_isValid;
}

QString OAIStaticGateway::getStatus() const {
    return m_status;
}
void OAIStaticGateway::setStatus(const QString &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIStaticGateway::is_status_Set() const{
    return m_status_isSet;
}

bool OAIStaticGateway::is_status_Valid() const{
    return m_status_isValid;
}

bool OAIStaticGateway::isSticky() const {
    return m_sticky;
}
void OAIStaticGateway::setSticky(const bool &sticky) {
    m_sticky = sticky;
    m_sticky_isSet = true;
}

bool OAIStaticGateway::is_sticky_Set() const{
    return m_sticky_isSet;
}

bool OAIStaticGateway::is_sticky_Valid() const{
    return m_sticky_isValid;
}

bool OAIStaticGateway::isThreeDSecure() const {
    return m_three_d_secure;
}
void OAIStaticGateway::setThreeDSecure(const bool &three_d_secure) {
    m_three_d_secure = three_d_secure;
    m_three_d_secure_isSet = true;
}

bool OAIStaticGateway::is_three_d_secure_Set() const{
    return m_three_d_secure_isSet;
}

bool OAIStaticGateway::is_three_d_secure_Valid() const{
    return m_three_d_secure_isValid;
}

qint32 OAIStaticGateway::getTimeout() const {
    return m_timeout;
}
void OAIStaticGateway::setTimeout(const qint32 &timeout) {
    m_timeout = timeout;
    m_timeout_isSet = true;
}

bool OAIStaticGateway::is_timeout_Set() const{
    return m_timeout_isSet;
}

bool OAIStaticGateway::is_timeout_Valid() const{
    return m_timeout_isValid;
}

QString OAIStaticGateway::getToken() const {
    return m_token;
}
void OAIStaticGateway::setToken(const QString &token) {
    m_token = token;
    m_token_isSet = true;
}

bool OAIStaticGateway::is_token_Set() const{
    return m_token_isSet;
}

bool OAIStaticGateway::is_token_Valid() const{
    return m_token_isValid;
}

QDateTime OAIStaticGateway::getUpdatedTime() const {
    return m_updated_time;
}
void OAIStaticGateway::setUpdatedTime(const QDateTime &updated_time) {
    m_updated_time = updated_time;
    m_updated_time_isSet = true;
}

bool OAIStaticGateway::is_updated_time_Set() const{
    return m_updated_time_isSet;
}

bool OAIStaticGateway::is_updated_time_Valid() const{
    return m_updated_time_isValid;
}

bool OAIStaticGateway::isSet() const {
...
bool OAIStaticGateway::isValid() const {
