...
OAINinjaWallet::OAINinjaWallet(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAINinjaWallet::OAINinjaWallet() {
    this->initializeModel();
}

OAINinjaWallet::~OAINinjaWallet() {}

void OAINinjaWallet::initializeModel() {
...
void OAINinjaWallet::fromJson(QString jsonString) {
...
void OAINinjaWallet::fromJsonObject(QJsonObject json) {
...
QString OAINinjaWallet::asJson() const {
...
QJsonObject OAINinjaWallet::asJsonObject() const {
    QJsonObject obj;
    if (m__links.size() > 0) {
...
QList<OAIGatewayAccount__links_inner> OAINinjaWallet::getLinks() const {
    return m__links;
}
void OAINinjaWallet::setLinks(const QList<OAIGatewayAccount__links_inner> &_links) {
    m__links = _links;
    m__links_isSet = true;
}

bool OAINinjaWallet::is__links_Set() const{
    return m__links_isSet;
}

bool OAINinjaWallet::is__links_Valid() const{
    return m__links_isValid;
}

QList<QString> OAINinjaWallet::getAcceptedCurrencies() const {
    return m_accepted_currencies;
}
void OAINinjaWallet::setAcceptedCurrencies(const QList<QString> &accepted_currencies) {
    m_accepted_currencies = accepted_currencies;
    m_accepted_currencies_isSet = true;
}

bool OAINinjaWallet::is_accepted_currencies_Set() const{
    return m_accepted_currencies_isSet;
}

bool OAINinjaWallet::is_accepted_currencies_Valid() const{
    return m_accepted_currencies_isValid;
}

OAIAcquirerName OAINinjaWallet::getAcquirerName() const {
    return m_acquirer_name;
}
void OAINinjaWallet::setAcquirerName(const OAIAcquirerName &acquirer_name) {
    m_acquirer_name = acquirer_name;
    m_acquirer_name_isSet = true;
}

bool OAINinjaWallet::is_acquirer_name_Set() const{
    return m_acquirer_name_isSet;
}

bool OAINinjaWallet::is_acquirer_name_Valid() const{
    return m_acquirer_name_isValid;
}

QString OAINinjaWallet::getAdditionalFilters() const {
    return m_additional_filters;
}
void OAINinjaWallet::setAdditionalFilters(const QString &additional_filters) {
    m_additional_filters = additional_filters;
    m_additional_filters_isSet = true;
}

bool OAINinjaWallet::is_additional_filters_Set() const{
    return m_additional_filters_isSet;
}

bool OAINinjaWallet::is_additional_filters_Valid() const{
    return m_additional_filters_isValid;
}

qint32 OAINinjaWallet::getApprovalWindowTtl() const {
    return m_approval_window_ttl;
}
void OAINinjaWallet::setApprovalWindowTtl(const qint32 &approval_window_ttl) {
    m_approval_window_ttl = approval_window_ttl;
    m_approval_window_ttl_isSet = true;
}

bool OAINinjaWallet::is_approval_window_ttl_Set() const{
    return m_approval_window_ttl_isSet;
}

bool OAINinjaWallet::is_approval_window_ttl_Valid() const{
    return m_approval_window_ttl_isValid;
}

QString OAINinjaWallet::getCityField() const {
    return m_city_field;
}
void OAINinjaWallet::setCityField(const QString &city_field) {
    m_city_field = city_field;
    m_city_field_isSet = true;
}

bool OAINinjaWallet::is_city_field_Set() const{
    return m_city_field_isSet;
}

bool OAINinjaWallet::is_city_field_Valid() const{
    return m_city_field_isValid;
}

QDateTime OAINinjaWallet::getCreatedTime() const {
    return m_created_time;
}
void OAINinjaWallet::setCreatedTime(const QDateTime &created_time) {
    m_created_time = created_time;
    m_created_time_isSet = true;
}

bool OAINinjaWallet::is_created_time_Set() const{
    return m_created_time_isSet;
}

bool OAINinjaWallet::is_created_time_Valid() const{
    return m_created_time_isValid;
}

QString OAINinjaWallet::getDccForceCurrency() const {
    return m_dcc_force_currency;
}
void OAINinjaWallet::setDccForceCurrency(const QString &dcc_force_currency) {
    m_dcc_force_currency = dcc_force_currency;
    m_dcc_force_currency_isSet = true;
}

bool OAINinjaWallet::is_dcc_force_currency_Set() const{
    return m_dcc_force_currency_isSet;
}

bool OAINinjaWallet::is_dcc_force_currency_Valid() const{
    return m_dcc_force_currency_isValid;
}

qint32 OAINinjaWallet::getDccMarkup() const {
    return m_dcc_markup;
}
void OAINinjaWallet::setDccMarkup(const qint32 &dcc_markup) {
    m_dcc_markup = dcc_markup;
    m_dcc_markup_isSet = true;
}

bool OAINinjaWallet::is_dcc_markup_Set() const{
    return m_dcc_markup_isSet;
}

bool OAINinjaWallet::is_dcc_markup_Valid() const{
    return m_dcc_markup_isValid;
}

QString OAINinjaWallet::getDescriptor() const {
    return m_descriptor;
}
void OAINinjaWallet::setDescriptor(const QString &descriptor) {
    m_descriptor = descriptor;
    m_descriptor_isSet = true;
}

bool OAINinjaWallet::is_descriptor_Set() const{
    return m_descriptor_isSet;
}

bool OAINinjaWallet::is_descriptor_Valid() const{
    return m_descriptor_isValid;
}

OAIDigitalWallets OAINinjaWallet::getDigitalWallets() const {
    return m_digital_wallets;
}
void OAINinjaWallet::setDigitalWallets(const OAIDigitalWallets &digital_wallets) {
    m_digital_wallets = digital_wallets;
    m_digital_wallets_isSet = true;
}

bool OAINinjaWallet::is_digital_wallets_Set() const{
    return m_digital_wallets_isSet;
}

bool OAINinjaWallet::is_digital_wallets_Valid() const{
    return m_digital_wallets_isValid;
}

bool OAINinjaWallet::isDynamicDescriptor() const {
    return m_dynamic_descriptor;
}
void OAINinjaWallet::setDynamicDescriptor(const bool &dynamic_descriptor) {
    m_dynamic_descriptor = dynamic_descriptor;
    m_dynamic_descriptor_isSet = true;
}

bool OAINinjaWallet::is_dynamic_descriptor_Set() const{
    return m_dynamic_descriptor_isSet;
}

bool OAINinjaWallet::is_dynamic_descriptor_Valid() const{
    return m_dynamic_descriptor_isValid;
}

QList<QString> OAINinjaWallet::getExcludedDccQuoteCurrencies() const {
    return m_excluded_dcc_quote_currencies;
}
void OAINinjaWallet::setExcludedDccQuoteCurrencies(const QList<QString> &excluded_dcc_quote_currencies) {
    m_excluded_dcc_quote_currencies = excluded_dcc_quote_currencies;
    m_excluded_dcc_quote_currencies_isSet = true;
}

bool OAINinjaWallet::is_excluded_dcc_quote_currencies_Set() const{
    return m_excluded_dcc_quote_currencies_isSet;
}

bool OAINinjaWallet::is_excluded_dcc_quote_currencies_Valid() const{
    return m_excluded_dcc_quote_currencies_isValid;
}

OAIGatewayName OAINinjaWallet::getGatewayName() const {
    return m_gateway_name;
}
void OAINinjaWallet::setGatewayName(const OAIGatewayName &gateway_name) {
    m_gateway_name = gateway_name;
    m_gateway_name_isSet = true;
}

bool OAINinjaWallet::is_gateway_name_Set() const{
    return m_gateway_name_isSet;
}

bool OAINinjaWallet::is_gateway_name_Valid() const{
    return m_gateway_name_isValid;
}

QString OAINinjaWallet::getId() const {
    return m_id;
}
void OAINinjaWallet::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAINinjaWallet::is_id_Set() const{
    return m_id_isSet;
}

bool OAINinjaWallet::is_id_Valid() const{
    return m_id_isValid;
}

bool OAINinjaWallet::isIsDown() const {
    return m_is_down;
}
void OAINinjaWallet::setIsDown(const bool &is_down) {
    m_is_down = is_down;
    m_is_down_isSet = true;
}

bool OAINinjaWallet::is_is_down_Set() const{
    return m_is_down_isSet;
}

bool OAINinjaWallet::is_is_down_Valid() const{
    return m_is_down_isValid;
}

QString OAINinjaWallet::getMerchantCategoryCode() const {
    return m_merchant_category_code;
}
void OAINinjaWallet::setMerchantCategoryCode(const QString &merchant_category_code) {
    m_merchant_category_code = merchant_category_code;
    m_merchant_category_code_isSet = true;
}

bool OAINinjaWallet::is_merchant_category_code_Set() const{
    return m_merchant_category_code_isSet;
}

bool OAINinjaWallet::is_merchant_category_code_Valid() const{
    return m_merchant_category_code_isValid;
}

OAIPaymentMethod OAINinjaWallet::getMethod() const {
    return m_method;
}
void OAINinjaWallet::setMethod(const OAIPaymentMethod &method) {
    m_method = method;
    m_method_isSet = true;
}

bool OAINinjaWallet::is_method_Set() const{
    return m_method_isSet;
}

bool OAINinjaWallet::is_method_Valid() const{
    return m_method_isValid;
}

double OAINinjaWallet::getMonthlyLimit() const {
    return m_monthly_limit;
}
void OAINinjaWallet::setMonthlyLimit(const double &monthly_limit) {
    m_monthly_limit = monthly_limit;
    m_monthly_limit_isSet = true;
}

bool OAINinjaWallet::is_monthly_limit_Set() const{
    return m_monthly_limit_isSet;
}

bool OAINinjaWallet::is_monthly_limit_Valid() const{
    return m_monthly_limit_isValid;
}

QString OAINinjaWallet::getOrganizationId() const {
    return m_organization_id;
}
void OAINinjaWallet::setOrganizationId(const QString &organization_id) {
    m_organization_id = organization_id;
    m_organization_id_isSet = true;
}

bool OAINinjaWallet::is_organization_id_Set() const{
    return m_organization_id_isSet;
}

bool OAINinjaWallet::is_organization_id_Valid() const{
    return m_organization_id_isValid;
}

QList<OAIPaymentCardBrand> OAINinjaWallet::getPaymentCardSchemes() const {
    return m_payment_card_schemes;
}
void OAINinjaWallet::setPaymentCardSchemes(const QList<OAIPaymentCardBrand> &payment_card_schemes) {
    m_payment_card_schemes = payment_card_schemes;
    m_payment_card_schemes_isSet = true;
}

bool OAINinjaWallet::is_payment_card_schemes_Set() const{
    return m_payment_card_schemes_isSet;
}

bool OAINinjaWallet::is_payment_card_schemes_Valid() const{
    return m_payment_card_schemes_isValid;
}

bool OAINinjaWallet::isReconciliationWindowEnabled() const {
    return m_reconciliation_window_enabled;
}
void OAINinjaWallet::setReconciliationWindowEnabled(const bool &reconciliation_window_enabled) {
    m_reconciliation_window_enabled = reconciliation_window_enabled;
    m_reconciliation_window_enabled_isSet = true;
}

bool OAINinjaWallet::is_reconciliation_window_enabled_Set() const{
    return m_reconciliation_window_enabled_isSet;
}

bool OAINinjaWallet::is_reconciliation_window_enabled_Valid() const{
    return m_reconciliation_window_enabled_isValid;
}

qint32 OAINinjaWallet::getReconciliationWindowTtl() const {
    return m_reconciliation_window_ttl;
}
void OAINinjaWallet::setReconciliationWindowTtl(const qint32 &reconciliation_window_ttl) {
    m_reconciliation_window_ttl = reconciliation_window_ttl;
    m_reconciliation_window_ttl_isSet = true;
}

bool OAINinjaWallet::is_reconciliation_window_ttl_Set() const{
    return m_reconciliation_window_ttl_isSet;
}

bool OAINinjaWallet::is_reconciliation_window_ttl_Valid() const{
    return m_reconciliation_window_ttl_isValid;
}

QString OAINinjaWallet::getStatus() const {
    return m_status;
}
void OAINinjaWallet::setStatus(const QString &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAINinjaWallet::is_status_Set() const{
    return m_status_isSet;
}

bool OAINinjaWallet::is_status_Valid() const{
    return m_status_isValid;
}

bool OAINinjaWallet::isSticky() const {
    return m_sticky;
}
void OAINinjaWallet::setSticky(const bool &sticky) {
    m_sticky = sticky;
    m_sticky_isSet = true;
}

bool OAINinjaWallet::is_sticky_Set() const{
    return m_sticky_isSet;
}

bool OAINinjaWallet::is_sticky_Valid() const{
    return m_sticky_isValid;
}

bool OAINinjaWallet::isThreeDSecure() const {
    return m_three_d_secure;
}
void OAINinjaWallet::setThreeDSecure(const bool &three_d_secure) {
    m_three_d_secure = three_d_secure;
    m_three_d_secure_isSet = true;
}

bool OAINinjaWallet::is_three_d_secure_Set() const{
    return m_three_d_secure_isSet;
}

bool OAINinjaWallet::is_three_d_secure_Valid() const{
    return m_three_d_secure_isValid;
}

qint32 OAINinjaWallet::getTimeout() const {
    return m_timeout;
}
void OAINinjaWallet::setTimeout(const qint32 &timeout) {
    m_timeout = timeout;
    m_timeout_isSet = true;
}

bool OAINinjaWallet::is_timeout_Set() const{
    return m_timeout_isSet;
}

bool OAINinjaWallet::is_timeout_Valid() const{
    return m_timeout_isValid;
}

QString OAINinjaWallet::getToken() const {
    return m_token;
}
void OAINinjaWallet::setToken(const QString &token) {
    m_token = token;
    m_token_isSet = true;
}

bool OAINinjaWallet::is_token_Set() const{
    return m_token_isSet;
}

bool OAINinjaWallet::is_token_Valid() const{
    return m_token_isValid;
}

QDateTime OAINinjaWallet::getUpdatedTime() const {
    return m_updated_time;
}
void OAINinjaWallet::setUpdatedTime(const QDateTime &updated_time) {
    m_updated_time = updated_time;
    m_updated_time_isSet = true;
}

bool OAINinjaWallet::is_updated_time_Set() const{
    return m_updated_time_isSet;
}

bool OAINinjaWallet::is_updated_time_Valid() const{
    return m_updated_time_isValid;
}

OAINinjaWallet_allOf_credentials OAINinjaWallet::getCredentials() const {
    return m_credentials;
}
void OAINinjaWallet::setCredentials(const OAINinjaWallet_allOf_credentials &credentials) {
    m_credentials = credentials;
    m_credentials_isSet = true;
}

bool OAINinjaWallet::is_credentials_Set() const{
    return m_credentials_isSet;
}

bool OAINinjaWallet::is_credentials_Valid() const{
    return m_credentials_isValid;
}

bool OAINinjaWallet::isSet() const {
...
bool OAINinjaWallet::isValid() const {
