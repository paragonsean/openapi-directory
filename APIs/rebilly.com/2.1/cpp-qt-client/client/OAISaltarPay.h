...
#ifndef OAISaltarPay_H
#define OAISaltarPay_H
...
class OAISaltarPay_allOf_credentials;

class OAISaltarPay : public OAIObject {
public:
    OAISaltarPay();
    OAISaltarPay(QString json);
    ~OAISaltarPay() override;
    ...
    OAISaltarPay_allOf_credentials getCredentials() const;
    void setCredentials(const OAISaltarPay_allOf_credentials &credentials);
...
private:
    ...
    OAISaltarPay_allOf_credentials m_credentials;
...
Q_DECLARE_METATYPE(OpenAPI::OAISaltarPay)

#endif // OAISaltarPay_H
