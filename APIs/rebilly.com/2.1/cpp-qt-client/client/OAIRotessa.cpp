...
OAIRotessa::OAIRotessa(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIRotessa::OAIRotessa() {
    this->initializeModel();
}

OAIRotessa::~OAIRotessa() {}

void OAIRotessa::initializeModel() {
...
void OAIRotessa::fromJson(QString jsonString) {
...
void OAIRotessa::fromJsonObject(QJsonObject json) {
...
QString OAIRotessa::asJson() const {
...
QJsonObject OAIRotessa::asJsonObject() const {
    QJsonObject obj;
    if (m__links.size() > 0) {
...
QList<OAIGatewayAccount__links_inner> OAIRotessa::getLinks() const {
    return m__links;
}
void OAIRotessa::setLinks(const QList<OAIGatewayAccount__links_inner> &_links) {
    m__links = _links;
    m__links_isSet = true;
}

bool OAIRotessa::is__links_Set() const{
    return m__links_isSet;
}

bool OAIRotessa::is__links_Valid() const{
    return m__links_isValid;
}

QList<QString> OAIRotessa::getAcceptedCurrencies() const {
    return m_accepted_currencies;
}
void OAIRotessa::setAcceptedCurrencies(const QList<QString> &accepted_currencies) {
    m_accepted_currencies = accepted_currencies;
    m_accepted_currencies_isSet = true;
}

bool OAIRotessa::is_accepted_currencies_Set() const{
    return m_accepted_currencies_isSet;
}

bool OAIRotessa::is_accepted_currencies_Valid() const{
    return m_accepted_currencies_isValid;
}

OAIAcquirerName OAIRotessa::getAcquirerName() const {
    return m_acquirer_name;
}
void OAIRotessa::setAcquirerName(const OAIAcquirerName &acquirer_name) {
    m_acquirer_name = acquirer_name;
    m_acquirer_name_isSet = true;
}

bool OAIRotessa::is_acquirer_name_Set() const{
    return m_acquirer_name_isSet;
}

bool OAIRotessa::is_acquirer_name_Valid() const{
    return m_acquirer_name_isValid;
}

QString OAIRotessa::getAdditionalFilters() const {
    return m_additional_filters;
}
void OAIRotessa::setAdditionalFilters(const QString &additional_filters) {
    m_additional_filters = additional_filters;
    m_additional_filters_isSet = true;
}

bool OAIRotessa::is_additional_filters_Set() const{
    return m_additional_filters_isSet;
}

bool OAIRotessa::is_additional_filters_Valid() const{
    return m_additional_filters_isValid;
}

qint32 OAIRotessa::getApprovalWindowTtl() const {
    return m_approval_window_ttl;
}
void OAIRotessa::setApprovalWindowTtl(const qint32 &approval_window_ttl) {
    m_approval_window_ttl = approval_window_ttl;
    m_approval_window_ttl_isSet = true;
}

bool OAIRotessa::is_approval_window_ttl_Set() const{
    return m_approval_window_ttl_isSet;
}

bool OAIRotessa::is_approval_window_ttl_Valid() const{
    return m_approval_window_ttl_isValid;
}

QString OAIRotessa::getCityField() const {
    return m_city_field;
}
void OAIRotessa::setCityField(const QString &city_field) {
    m_city_field = city_field;
    m_city_field_isSet = true;
}

bool OAIRotessa::is_city_field_Set() const{
    return m_city_field_isSet;
}

bool OAIRotessa::is_city_field_Valid() const{
    return m_city_field_isValid;
}

QDateTime OAIRotessa::getCreatedTime() const {
    return m_created_time;
}
void OAIRotessa::setCreatedTime(const QDateTime &created_time) {
    m_created_time = created_time;
    m_created_time_isSet = true;
}

bool OAIRotessa::is_created_time_Set() const{
    return m_created_time_isSet;
}

bool OAIRotessa::is_created_time_Valid() const{
    return m_created_time_isValid;
}

QString OAIRotessa::getDccForceCurrency() const {
    return m_dcc_force_currency;
}
void OAIRotessa::setDccForceCurrency(const QString &dcc_force_currency) {
    m_dcc_force_currency = dcc_force_currency;
    m_dcc_force_currency_isSet = true;
}

bool OAIRotessa::is_dcc_force_currency_Set() const{
    return m_dcc_force_currency_isSet;
}

bool OAIRotessa::is_dcc_force_currency_Valid() const{
    return m_dcc_force_currency_isValid;
}

qint32 OAIRotessa::getDccMarkup() const {
    return m_dcc_markup;
}
void OAIRotessa::setDccMarkup(const qint32 &dcc_markup) {
    m_dcc_markup = dcc_markup;
    m_dcc_markup_isSet = true;
}

bool OAIRotessa::is_dcc_markup_Set() const{
    return m_dcc_markup_isSet;
}

bool OAIRotessa::is_dcc_markup_Valid() const{
    return m_dcc_markup_isValid;
}

QString OAIRotessa::getDescriptor() const {
    return m_descriptor;
}
void OAIRotessa::setDescriptor(const QString &descriptor) {
    m_descriptor = descriptor;
    m_descriptor_isSet = true;
}

bool OAIRotessa::is_descriptor_Set() const{
    return m_descriptor_isSet;
}

bool OAIRotessa::is_descriptor_Valid() const{
    return m_descriptor_isValid;
}

OAIDigitalWallets OAIRotessa::getDigitalWallets() const {
    return m_digital_wallets;
}
void OAIRotessa::setDigitalWallets(const OAIDigitalWallets &digital_wallets) {
    m_digital_wallets = digital_wallets;
    m_digital_wallets_isSet = true;
}

bool OAIRotessa::is_digital_wallets_Set() const{
    return m_digital_wallets_isSet;
}

bool OAIRotessa::is_digital_wallets_Valid() const{
    return m_digital_wallets_isValid;
}

bool OAIRotessa::isDynamicDescriptor() const {
    return m_dynamic_descriptor;
}
void OAIRotessa::setDynamicDescriptor(const bool &dynamic_descriptor) {
    m_dynamic_descriptor = dynamic_descriptor;
    m_dynamic_descriptor_isSet = true;
}

bool OAIRotessa::is_dynamic_descriptor_Set() const{
    return m_dynamic_descriptor_isSet;
}

bool OAIRotessa::is_dynamic_descriptor_Valid() const{
    return m_dynamic_descriptor_isValid;
}

QList<QString> OAIRotessa::getExcludedDccQuoteCurrencies() const {
    return m_excluded_dcc_quote_currencies;
}
void OAIRotessa::setExcludedDccQuoteCurrencies(const QList<QString> &excluded_dcc_quote_currencies) {
    m_excluded_dcc_quote_currencies = excluded_dcc_quote_currencies;
    m_excluded_dcc_quote_currencies_isSet = true;
}

bool OAIRotessa::is_excluded_dcc_quote_currencies_Set() const{
    return m_excluded_dcc_quote_currencies_isSet;
}

bool OAIRotessa::is_excluded_dcc_quote_currencies_Valid() const{
    return m_excluded_dcc_quote_currencies_isValid;
}

OAIGatewayName OAIRotessa::getGatewayName() const {
    return m_gateway_name;
}
void OAIRotessa::setGatewayName(const OAIGatewayName &gateway_name) {
    m_gateway_name = gateway_name;
    m_gateway_name_isSet = true;
}

bool OAIRotessa::is_gateway_name_Set() const{
    return m_gateway_name_isSet;
}

bool OAIRotessa::is_gateway_name_Valid() const{
    return m_gateway_name_isValid;
}

QString OAIRotessa::getId() const {
    return m_id;
}
void OAIRotessa::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIRotessa::is_id_Set() const{
    return m_id_isSet;
}

bool OAIRotessa::is_id_Valid() const{
    return m_id_isValid;
}

bool OAIRotessa::isIsDown() const {
    return m_is_down;
}
void OAIRotessa::setIsDown(const bool &is_down) {
    m_is_down = is_down;
    m_is_down_isSet = true;
}

bool OAIRotessa::is_is_down_Set() const{
    return m_is_down_isSet;
}

bool OAIRotessa::is_is_down_Valid() const{
    return m_is_down_isValid;
}

QString OAIRotessa::getMerchantCategoryCode() const {
    return m_merchant_category_code;
}
void OAIRotessa::setMerchantCategoryCode(const QString &merchant_category_code) {
    m_merchant_category_code = merchant_category_code;
    m_merchant_category_code_isSet = true;
}

bool OAIRotessa::is_merchant_category_code_Set() const{
    return m_merchant_category_code_isSet;
}

bool OAIRotessa::is_merchant_category_code_Valid() const{
    return m_merchant_category_code_isValid;
}

OAIPaymentMethod OAIRotessa::getMethod() const {
    return m_method;
}
void OAIRotessa::setMethod(const OAIPaymentMethod &method) {
    m_method = method;
    m_method_isSet = true;
}

bool OAIRotessa::is_method_Set() const{
    return m_method_isSet;
}

bool OAIRotessa::is_method_Valid() const{
    return m_method_isValid;
}

double OAIRotessa::getMonthlyLimit() const {
    return m_monthly_limit;
}
void OAIRotessa::setMonthlyLimit(const double &monthly_limit) {
    m_monthly_limit = monthly_limit;
    m_monthly_limit_isSet = true;
}

bool OAIRotessa::is_monthly_limit_Set() const{
    return m_monthly_limit_isSet;
}

bool OAIRotessa::is_monthly_limit_Valid() const{
    return m_monthly_limit_isValid;
}

QString OAIRotessa::getOrganizationId() const {
    return m_organization_id;
}
void OAIRotessa::setOrganizationId(const QString &organization_id) {
    m_organization_id = organization_id;
    m_organization_id_isSet = true;
}

bool OAIRotessa::is_organization_id_Set() const{
    return m_organization_id_isSet;
}

bool OAIRotessa::is_organization_id_Valid() const{
    return m_organization_id_isValid;
}

QList<OAIPaymentCardBrand> OAIRotessa::getPaymentCardSchemes() const {
    return m_payment_card_schemes;
}
void OAIRotessa::setPaymentCardSchemes(const QList<OAIPaymentCardBrand> &payment_card_schemes) {
    m_payment_card_schemes = payment_card_schemes;
    m_payment_card_schemes_isSet = true;
}

bool OAIRotessa::is_payment_card_schemes_Set() const{
    return m_payment_card_schemes_isSet;
}

bool OAIRotessa::is_payment_card_schemes_Valid() const{
    return m_payment_card_schemes_isValid;
}

bool OAIRotessa::isReconciliationWindowEnabled() const {
    return m_reconciliation_window_enabled;
}
void OAIRotessa::setReconciliationWindowEnabled(const bool &reconciliation_window_enabled) {
    m_reconciliation_window_enabled = reconciliation_window_enabled;
    m_reconciliation_window_enabled_isSet = true;
}

bool OAIRotessa::is_reconciliation_window_enabled_Set() const{
    return m_reconciliation_window_enabled_isSet;
}

bool OAIRotessa::is_reconciliation_window_enabled_Valid() const{
    return m_reconciliation_window_enabled_isValid;
}

qint32 OAIRotessa::getReconciliationWindowTtl() const {
    return m_reconciliation_window_ttl;
}
void OAIRotessa::setReconciliationWindowTtl(const qint32 &reconciliation_window_ttl) {
    m_reconciliation_window_ttl = reconciliation_window_ttl;
    m_reconciliation_window_ttl_isSet = true;
}

bool OAIRotessa::is_reconciliation_window_ttl_Set() const{
    return m_reconciliation_window_ttl_isSet;
}

bool OAIRotessa::is_reconciliation_window_ttl_Valid() const{
    return m_reconciliation_window_ttl_isValid;
}

QString OAIRotessa::getStatus() const {
    return m_status;
}
void OAIRotessa::setStatus(const QString &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIRotessa::is_status_Set() const{
    return m_status_isSet;
}

bool OAIRotessa::is_status_Valid() const{
    return m_status_isValid;
}

bool OAIRotessa::isSticky() const {
    return m_sticky;
}
void OAIRotessa::setSticky(const bool &sticky) {
    m_sticky = sticky;
    m_sticky_isSet = true;
}

bool OAIRotessa::is_sticky_Set() const{
    return m_sticky_isSet;
}

bool OAIRotessa::is_sticky_Valid() const{
    return m_sticky_isValid;
}

bool OAIRotessa::isThreeDSecure() const {
    return m_three_d_secure;
}
void OAIRotessa::setThreeDSecure(const bool &three_d_secure) {
    m_three_d_secure = three_d_secure;
    m_three_d_secure_isSet = true;
}

bool OAIRotessa::is_three_d_secure_Set() const{
    return m_three_d_secure_isSet;
}

bool OAIRotessa::is_three_d_secure_Valid() const{
    return m_three_d_secure_isValid;
}

qint32 OAIRotessa::getTimeout() const {
    return m_timeout;
}
void OAIRotessa::setTimeout(const qint32 &timeout) {
    m_timeout = timeout;
    m_timeout_isSet = true;
}

bool OAIRotessa::is_timeout_Set() const{
    return m_timeout_isSet;
}

bool OAIRotessa::is_timeout_Valid() const{
    return m_timeout_isValid;
}

QString OAIRotessa::getToken() const {
    return m_token;
}
void OAIRotessa::setToken(const QString &token) {
    m_token = token;
    m_token_isSet = true;
}

bool OAIRotessa::is_token_Set() const{
    return m_token_isSet;
}

bool OAIRotessa::is_token_Valid() const{
    return m_token_isValid;
}

QDateTime OAIRotessa::getUpdatedTime() const {
    return m_updated_time;
}
void OAIRotessa::setUpdatedTime(const QDateTime &updated_time) {
    m_updated_time = updated_time;
    m_updated_time_isSet = true;
}

bool OAIRotessa::is_updated_time_Set() const{
    return m_updated_time_isSet;
}

bool OAIRotessa::is_updated_time_Valid() const{
    return m_updated_time_isValid;
}

OAIRotessa_allOf_credentials OAIRotessa::getCredentials() const {
    return m_credentials;
}
void OAIRotessa::setCredentials(const OAIRotessa_allOf_credentials &credentials) {
    m_credentials = credentials;
    m_credentials_isSet = true;
}

bool OAIRotessa::is_credentials_Set() const{
    return m_credentials_isSet;
}

bool OAIRotessa::is_credentials_Valid() const{
    return m_credentials_isValid;
}

OAIRotessa_allOf_settings OAIRotessa::getSettings() const {
    return m_settings;
}
void OAIRotessa::setSettings(const OAIRotessa_allOf_settings &settings) {
    m_settings = settings;
    m_settings_isSet = true;
}

bool OAIRotessa::is_settings_Set() const{
    return m_settings_isSet;
}

bool OAIRotessa::is_settings_Valid() const{
    return m_settings_isValid;
}

bool OAIRotessa::isSet() const {
