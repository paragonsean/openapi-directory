...
/*
 * OAICauriPayment_allOf_credentials.h
 *
 * CauriPayment credentials object.
 */

#ifndef OAICauriPayment_allOf_credentials_H
#define OAICauriPayment_allOf_credentials_H
...
class OAICauriPayment_allOf_credentials : public OAIObject {
public:
    OAICauriPayment_allOf_credentials();
    OAICauriPayment_allOf_credentials(QString json);
    ~OAICauriPayment_allOf_credentials() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICauriPayment_allOf_credentials)

#endif // OAICauriPayment_allOf_credentials_H
