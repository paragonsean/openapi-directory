...
OAIMiFinity::OAIMiFinity(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIMiFinity::OAIMiFinity() {
    this->initializeModel();
}

OAIMiFinity::~OAIMiFinity() {}

void OAIMiFinity::initializeModel() {
...
void OAIMiFinity::fromJson(QString jsonString) {
...
void OAIMiFinity::fromJsonObject(QJsonObject json) {
...
QString OAIMiFinity::asJson() const {
...
QJsonObject OAIMiFinity::asJsonObject() const {
    QJsonObject obj;
    if (m__links.size() > 0) {
...
QList<OAIGatewayAccount__links_inner> OAIMiFinity::getLinks() const {
    return m__links;
}
void OAIMiFinity::setLinks(const QList<OAIGatewayAccount__links_inner> &_links) {
    m__links = _links;
    m__links_isSet = true;
}

bool OAIMiFinity::is__links_Set() const{
    return m__links_isSet;
}

bool OAIMiFinity::is__links_Valid() const{
    return m__links_isValid;
}

QList<QString> OAIMiFinity::getAcceptedCurrencies() const {
    return m_accepted_currencies;
}
void OAIMiFinity::setAcceptedCurrencies(const QList<QString> &accepted_currencies) {
    m_accepted_currencies = accepted_currencies;
    m_accepted_currencies_isSet = true;
}

bool OAIMiFinity::is_accepted_currencies_Set() const{
    return m_accepted_currencies_isSet;
}

bool OAIMiFinity::is_accepted_currencies_Valid() const{
    return m_accepted_currencies_isValid;
}

OAIAcquirerName OAIMiFinity::getAcquirerName() const {
    return m_acquirer_name;
}
void OAIMiFinity::setAcquirerName(const OAIAcquirerName &acquirer_name) {
    m_acquirer_name = acquirer_name;
    m_acquirer_name_isSet = true;
}

bool OAIMiFinity::is_acquirer_name_Set() const{
    return m_acquirer_name_isSet;
}

bool OAIMiFinity::is_acquirer_name_Valid() const{
    return m_acquirer_name_isValid;
}

QString OAIMiFinity::getAdditionalFilters() const {
    return m_additional_filters;
}
void OAIMiFinity::setAdditionalFilters(const QString &additional_filters) {
    m_additional_filters = additional_filters;
    m_additional_filters_isSet = true;
}

bool OAIMiFinity::is_additional_filters_Set() const{
    return m_additional_filters_isSet;
}

bool OAIMiFinity::is_additional_filters_Valid() const{
    return m_additional_filters_isValid;
}

qint32 OAIMiFinity::getApprovalWindowTtl() const {
    return m_approval_window_ttl;
}
void OAIMiFinity::setApprovalWindowTtl(const qint32 &approval_window_ttl) {
    m_approval_window_ttl = approval_window_ttl;
    m_approval_window_ttl_isSet = true;
}

bool OAIMiFinity::is_approval_window_ttl_Set() const{
    return m_approval_window_ttl_isSet;
}

bool OAIMiFinity::is_approval_window_ttl_Valid() const{
    return m_approval_window_ttl_isValid;
}

QString OAIMiFinity::getCityField() const {
    return m_city_field;
}
void OAIMiFinity::setCityField(const QString &city_field) {
    m_city_field = city_field;
    m_city_field_isSet = true;
}

bool OAIMiFinity::is_city_field_Set() const{
    return m_city_field_isSet;
}

bool OAIMiFinity::is_city_field_Valid() const{
    return m_city_field_isValid;
}

QDateTime OAIMiFinity::getCreatedTime() const {
    return m_created_time;
}
void OAIMiFinity::setCreatedTime(const QDateTime &created_time) {
    m_created_time = created_time;
    m_created_time_isSet = true;
}

bool OAIMiFinity::is_created_time_Set() const{
    return m_created_time_isSet;
}

bool OAIMiFinity::is_created_time_Valid() const{
    return m_created_time_isValid;
}

QString OAIMiFinity::getDccForceCurrency() const {
    return m_dcc_force_currency;
}
void OAIMiFinity::setDccForceCurrency(const QString &dcc_force_currency) {
    m_dcc_force_currency = dcc_force_currency;
    m_dcc_force_currency_isSet = true;
}

bool OAIMiFinity::is_dcc_force_currency_Set() const{
    return m_dcc_force_currency_isSet;
}

bool OAIMiFinity::is_dcc_force_currency_Valid() const{
    return m_dcc_force_currency_isValid;
}

qint32 OAIMiFinity::getDccMarkup() const {
    return m_dcc_markup;
}
void OAIMiFinity::setDccMarkup(const qint32 &dcc_markup) {
    m_dcc_markup = dcc_markup;
    m_dcc_markup_isSet = true;
}

bool OAIMiFinity::is_dcc_markup_Set() const{
    return m_dcc_markup_isSet;
}

bool OAIMiFinity::is_dcc_markup_Valid() const{
    return m_dcc_markup_isValid;
}

QString OAIMiFinity::getDescriptor() const {
    return m_descriptor;
}
void OAIMiFinity::setDescriptor(const QString &descriptor) {
    m_descriptor = descriptor;
    m_descriptor_isSet = true;
}

bool OAIMiFinity::is_descriptor_Set() const{
    return m_descriptor_isSet;
}

bool OAIMiFinity::is_descriptor_Valid() const{
    return m_descriptor_isValid;
}

OAIDigitalWallets OAIMiFinity::getDigitalWallets() const {
    return m_digital_wallets;
}
void OAIMiFinity::setDigitalWallets(const OAIDigitalWallets &digital_wallets) {
    m_digital_wallets = digital_wallets;
    m_digital_wallets_isSet = true;
}

bool OAIMiFinity::is_digital_wallets_Set() const{
    return m_digital_wallets_isSet;
}

bool OAIMiFinity::is_digital_wallets_Valid() const{
    return m_digital_wallets_isValid;
}

bool OAIMiFinity::isDynamicDescriptor() const {
    return m_dynamic_descriptor;
}
void OAIMiFinity::setDynamicDescriptor(const bool &dynamic_descriptor) {
    m_dynamic_descriptor = dynamic_descriptor;
    m_dynamic_descriptor_isSet = true;
}

bool OAIMiFinity::is_dynamic_descriptor_Set() const{
    return m_dynamic_descriptor_isSet;
}

bool OAIMiFinity::is_dynamic_descriptor_Valid() const{
    return m_dynamic_descriptor_isValid;
}

QList<QString> OAIMiFinity::getExcludedDccQuoteCurrencies() const {
    return m_excluded_dcc_quote_currencies;
}
void OAIMiFinity::setExcludedDccQuoteCurrencies(const QList<QString> &excluded_dcc_quote_currencies) {
    m_excluded_dcc_quote_currencies = excluded_dcc_quote_currencies;
    m_excluded_dcc_quote_currencies_isSet = true;
}

bool OAIMiFinity::is_excluded_dcc_quote_currencies_Set() const{
    return m_excluded_dcc_quote_currencies_isSet;
}

bool OAIMiFinity::is_excluded_dcc_quote_currencies_Valid() const{
    return m_excluded_dcc_quote_currencies_isValid;
}

OAIGatewayName OAIMiFinity::getGatewayName() const {
    return m_gateway_name;
}
void OAIMiFinity::setGatewayName(const OAIGatewayName &gateway_name) {
    m_gateway_name = gateway_name;
    m_gateway_name_isSet = true;
}

bool OAIMiFinity::is_gateway_name_Set() const{
    return m_gateway_name_isSet;
}

bool OAIMiFinity::is_gateway_name_Valid() const{
    return m_gateway_name_isValid;
}

QString OAIMiFinity::getId() const {
    return m_id;
}
void OAIMiFinity::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIMiFinity::is_id_Set() const{
    return m_id_isSet;
}

bool OAIMiFinity::is_id_Valid() const{
    return m_id_isValid;
}

bool OAIMiFinity::isIsDown() const {
    return m_is_down;
}
void OAIMiFinity::setIsDown(const bool &is_down) {
    m_is_down = is_down;
    m_is_down_isSet = true;
}

bool OAIMiFinity::is_is_down_Set() const{
    return m_is_down_isSet;
}

bool OAIMiFinity::is_is_down_Valid() const{
    return m_is_down_isValid;
}

QString OAIMiFinity::getMerchantCategoryCode() const {
    return m_merchant_category_code;
}
void OAIMiFinity::setMerchantCategoryCode(const QString &merchant_category_code) {
    m_merchant_category_code = merchant_category_code;
    m_merchant_category_code_isSet = true;
}

bool OAIMiFinity::is_merchant_category_code_Set() const{
    return m_merchant_category_code_isSet;
}

bool OAIMiFinity::is_merchant_category_code_Valid() const{
    return m_merchant_category_code_isValid;
}

OAIPaymentMethod OAIMiFinity::getMethod() const {
    return m_method;
}
void OAIMiFinity::setMethod(const OAIPaymentMethod &method) {
    m_method = method;
    m_method_isSet = true;
}

bool OAIMiFinity::is_method_Set() const{
    return m_method_isSet;
}

bool OAIMiFinity::is_method_Valid() const{
    return m_method_isValid;
}

double OAIMiFinity::getMonthlyLimit() const {
    return m_monthly_limit;
}
void OAIMiFinity::setMonthlyLimit(const double &monthly_limit) {
    m_monthly_limit = monthly_limit;
    m_monthly_limit_isSet = true;
}

bool OAIMiFinity::is_monthly_limit_Set() const{
    return m_monthly_limit_isSet;
}

bool OAIMiFinity::is_monthly_limit_Valid() const{
    return m_monthly_limit_isValid;
}

QString OAIMiFinity::getOrganizationId() const {
    return m_organization_id;
}
void OAIMiFinity::setOrganizationId(const QString &organization_id) {
    m_organization_id = organization_id;
    m_organization_id_isSet = true;
}

bool OAIMiFinity::is_organization_id_Set() const{
    return m_organization_id_isSet;
}

bool OAIMiFinity::is_organization_id_Valid() const{
    return m_organization_id_isValid;
}

QList<OAIPaymentCardBrand> OAIMiFinity::getPaymentCardSchemes() const {
    return m_payment_card_schemes;
}
void OAIMiFinity::setPaymentCardSchemes(const QList<OAIPaymentCardBrand> &payment_card_schemes) {
    m_payment_card_schemes = payment_card_schemes;
    m_payment_card_schemes_isSet = true;
}

bool OAIMiFinity::is_payment_card_schemes_Set() const{
    return m_payment_card_schemes_isSet;
}

bool OAIMiFinity::is_payment_card_schemes_Valid() const{
    return m_payment_card_schemes_isValid;
}

bool OAIMiFinity::isReconciliationWindowEnabled() const {
    return m_reconciliation_window_enabled;
}
void OAIMiFinity::setReconciliationWindowEnabled(const bool &reconciliation_window_enabled) {
    m_reconciliation_window_enabled = reconciliation_window_enabled;
    m_reconciliation_window_enabled_isSet = true;
}

bool OAIMiFinity::is_reconciliation_window_enabled_Set() const{
    return m_reconciliation_window_enabled_isSet;
}

bool OAIMiFinity::is_reconciliation_window_enabled_Valid() const{
    return m_reconciliation_window_enabled_isValid;
}

qint32 OAIMiFinity::getReconciliationWindowTtl() const {
    return m_reconciliation_window_ttl;
}
void OAIMiFinity::setReconciliationWindowTtl(const qint32 &reconciliation_window_ttl) {
    m_reconciliation_window_ttl = reconciliation_window_ttl;
    m_reconciliation_window_ttl_isSet = true;
}

bool OAIMiFinity::is_reconciliation_window_ttl_Set() const{
    return m_reconciliation_window_ttl_isSet;
}

bool OAIMiFinity::is_reconciliation_window_ttl_Valid() const{
    return m_reconciliation_window_ttl_isValid;
}

QString OAIMiFinity::getStatus() const {
    return m_status;
}
void OAIMiFinity::setStatus(const QString &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIMiFinity::is_status_Set() const{
    return m_status_isSet;
}

bool OAIMiFinity::is_status_Valid() const{
    return m_status_isValid;
}

bool OAIMiFinity::isSticky() const {
    return m_sticky;
}
void OAIMiFinity::setSticky(const bool &sticky) {
    m_sticky = sticky;
    m_sticky_isSet = true;
}

bool OAIMiFinity::is_sticky_Set() const{
    return m_sticky_isSet;
}

bool OAIMiFinity::is_sticky_Valid() const{
    return m_sticky_isValid;
}

bool OAIMiFinity::isThreeDSecure() const {
    return m_three_d_secure;
}
void OAIMiFinity::setThreeDSecure(const bool &three_d_secure) {
    m_three_d_secure = three_d_secure;
    m_three_d_secure_isSet = true;
}

bool OAIMiFinity::is_three_d_secure_Set() const{
    return m_three_d_secure_isSet;
}

bool OAIMiFinity::is_three_d_secure_Valid() const{
    return m_three_d_secure_isValid;
}

qint32 OAIMiFinity::getTimeout() const {
    return m_timeout;
}
void OAIMiFinity::setTimeout(const qint32 &timeout) {
    m_timeout = timeout;
    m_timeout_isSet = true;
}

bool OAIMiFinity::is_timeout_Set() const{
    return m_timeout_isSet;
}

bool OAIMiFinity::is_timeout_Valid() const{
    return m_timeout_isValid;
}

QString OAIMiFinity::getToken() const {
    return m_token;
}
void OAIMiFinity::setToken(const QString &token) {
    m_token = token;
    m_token_isSet = true;
}

bool OAIMiFinity::is_token_Set() const{
    return m_token_isSet;
}

bool OAIMiFinity::is_token_Valid() const{
    return m_token_isValid;
}

QDateTime OAIMiFinity::getUpdatedTime() const {
    return m_updated_time;
}
void OAIMiFinity::setUpdatedTime(const QDateTime &updated_time) {
    m_updated_time = updated_time;
    m_updated_time_isSet = true;
}

bool OAIMiFinity::is_updated_time_Set() const{
    return m_updated_time_isSet;
}

bool OAIMiFinity::is_updated_time_Valid() const{
    return m_updated_time_isValid;
}

OAIMiFinity_allOf_credentials OAIMiFinity::getCredentials() const {
    return m_credentials;
}
void OAIMiFinity::setCredentials(const OAIMiFinity_allOf_credentials &credentials) {
    m_credentials = credentials;
    m_credentials_isSet = true;
}

bool OAIMiFinity::is_credentials_Set() const{
    return m_credentials_isSet;
}

bool OAIMiFinity::is_credentials_Valid() const{
    return m_credentials_isValid;
}

bool OAIMiFinity::isSet() const {
...
bool OAIMiFinity::isValid() const {
