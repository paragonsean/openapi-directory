...
#ifndef OAIEcorePay_H
#define OAIEcorePay_H

#include <QJsonObject>

#include "OAIAcquirerName.h"
#include "OAIDigitalWallets.h"
#include "OAIEcorePay_allOf_credentials.h"
...
class OAIEcorePay_allOf_credentials;

class OAIEcorePay : public OAIObject {
public:
    OAIEcorePay();
    OAIEcorePay(QString json);
    ~OAIEcorePay() override;
    ...
    OAIEcorePay_allOf_credentials getCredentials() const;
    void setCredentials(const OAIEcorePay_allOf_credentials &credentials);
...
private:
    ...
    OAIEcorePay_allOf_credentials m_credentials;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEcorePay)
