...
OAICyberSource::OAICyberSource(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICyberSource::OAICyberSource() {
    this->initializeModel();
}

OAICyberSource::~OAICyberSource() {}

void OAICyberSource::initializeModel() {
...
void OAICyberSource::fromJson(QString jsonString) {
...
void OAICyberSource::fromJsonObject(QJsonObject json) {
...
QString OAICyberSource::asJson() const {
...
QJsonObject OAICyberSource::asJsonObject() const {
    QJsonObject obj;
    if (m__links.size() > 0) {
...
QList<OAIGatewayAccount__links_inner> OAICyberSource::getLinks() const {
    return m__links;
}
void OAICyberSource::setLinks(const QList<OAIGatewayAccount__links_inner> &_links) {
    m__links = _links;
    m__links_isSet = true;
}

bool OAICyberSource::is__links_Set() const{
    return m__links_isSet;
}

bool OAICyberSource::is__links_Valid() const{
    return m__links_isValid;
}

QList<QString> OAICyberSource::getAcceptedCurrencies() const {
    return m_accepted_currencies;
}
void OAICyberSource::setAcceptedCurrencies(const QList<QString> &accepted_currencies) {
    m_accepted_currencies = accepted_currencies;
    m_accepted_currencies_isSet = true;
}

bool OAICyberSource::is_accepted_currencies_Set() const{
    return m_accepted_currencies_isSet;
}

bool OAICyberSource::is_accepted_currencies_Valid() const{
    return m_accepted_currencies_isValid;
}

OAIAcquirerName OAICyberSource::getAcquirerName() const {
    return m_acquirer_name;
}
void OAICyberSource::setAcquirerName(const OAIAcquirerName &acquirer_name) {
    m_acquirer_name = acquirer_name;
    m_acquirer_name_isSet = true;
}

bool OAICyberSource::is_acquirer_name_Set() const{
    return m_acquirer_name_isSet;
}

bool OAICyberSource::is_acquirer_name_Valid() const{
    return m_acquirer_name_isValid;
}

QString OAICyberSource::getAdditionalFilters() const {
    return m_additional_filters;
}
void OAICyberSource::setAdditionalFilters(const QString &additional_filters) {
    m_additional_filters = additional_filters;
    m_additional_filters_isSet = true;
}

bool OAICyberSource::is_additional_filters_Set() const{
    return m_additional_filters_isSet;
}

bool OAICyberSource::is_additional_filters_Valid() const{
    return m_additional_filters_isValid;
}

qint32 OAICyberSource::getApprovalWindowTtl() const {
    return m_approval_window_ttl;
}
void OAICyberSource::setApprovalWindowTtl(const qint32 &approval_window_ttl) {
    m_approval_window_ttl = approval_window_ttl;
    m_approval_window_ttl_isSet = true;
}

bool OAICyberSource::is_approval_window_ttl_Set() const{
    return m_approval_window_ttl_isSet;
}

bool OAICyberSource::is_approval_window_ttl_Valid() const{
    return m_approval_window_ttl_isValid;
}

QString OAICyberSource::getCityField() const {
    return m_city_field;
}
void OAICyberSource::setCityField(const QString &city_field) {
    m_city_field = city_field;
    m_city_field_isSet = true;
}

bool OAICyberSource::is_city_field_Set() const{
    return m_city_field_isSet;
}

bool OAICyberSource::is_city_field_Valid() const{
    return m_city_field_isValid;
}

QDateTime OAICyberSource::getCreatedTime() const {
    return m_created_time;
}
void OAICyberSource::setCreatedTime(const QDateTime &created_time) {
    m_created_time = created_time;
    m_created_time_isSet = true;
}

bool OAICyberSource::is_created_time_Set() const{
    return m_created_time_isSet;
}

bool OAICyberSource::is_created_time_Valid() const{
    return m_created_time_isValid;
}

QString OAICyberSource::getDccForceCurrency() const {
    return m_dcc_force_currency;
}
void OAICyberSource::setDccForceCurrency(const QString &dcc_force_currency) {
    m_dcc_force_currency = dcc_force_currency;
    m_dcc_force_currency_isSet = true;
}

bool OAICyberSource::is_dcc_force_currency_Set() const{
    return m_dcc_force_currency_isSet;
}

bool OAICyberSource::is_dcc_force_currency_Valid() const{
    return m_dcc_force_currency_isValid;
}

qint32 OAICyberSource::getDccMarkup() const {
    return m_dcc_markup;
}
void OAICyberSource::setDccMarkup(const qint32 &dcc_markup) {
    m_dcc_markup = dcc_markup;
    m_dcc_markup_isSet = true;
}

bool OAICyberSource::is_dcc_markup_Set() const{
    return m_dcc_markup_isSet;
}

bool OAICyberSource::is_dcc_markup_Valid() const{
    return m_dcc_markup_isValid;
}

QString OAICyberSource::getDescriptor() const {
    return m_descriptor;
}
void OAICyberSource::setDescriptor(const QString &descriptor) {
    m_descriptor = descriptor;
    m_descriptor_isSet = true;
}

bool OAICyberSource::is_descriptor_Set() const{
    return m_descriptor_isSet;
}

bool OAICyberSource::is_descriptor_Valid() const{
    return m_descriptor_isValid;
}

OAIDigitalWallets OAICyberSource::getDigitalWallets() const {
    return m_digital_wallets;
}
void OAICyberSource::setDigitalWallets(const OAIDigitalWallets &digital_wallets) {
    m_digital_wallets = digital_wallets;
    m_digital_wallets_isSet = true;
}

bool OAICyberSource::is_digital_wallets_Set() const{
    return m_digital_wallets_isSet;
}

bool OAICyberSource::is_digital_wallets_Valid() const{
    return m_digital_wallets_isValid;
}

bool OAICyberSource::isDynamicDescriptor() const {
    return m_dynamic_descriptor;
}
void OAICyberSource::setDynamicDescriptor(const bool &dynamic_descriptor) {
    m_dynamic_descriptor = dynamic_descriptor;
    m_dynamic_descriptor_isSet = true;
}

bool OAICyberSource::is_dynamic_descriptor_Set() const{
    return m_dynamic_descriptor_isSet;
}

bool OAICyberSource::is_dynamic_descriptor_Valid() const{
    return m_dynamic_descriptor_isValid;
}

QList<QString> OAICyberSource::getExcludedDccQuoteCurrencies() const {
    return m_excluded_dcc_quote_currencies;
}
void OAICyberSource::setExcludedDccQuoteCurrencies(const QList<QString> &excluded_dcc_quote_currencies) {
    m_excluded_dcc_quote_currencies = excluded_dcc_quote_currencies;
    m_excluded_dcc_quote_currencies_isSet = true;
}

bool OAICyberSource::is_excluded_dcc_quote_currencies_Set() const{
    return m_excluded_dcc_quote_currencies_isSet;
}

bool OAICyberSource::is_excluded_dcc_quote_currencies_Valid() const{
    return m_excluded_dcc_quote_currencies_isValid;
}

OAIGatewayName OAICyberSource::getGatewayName() const {
    return m_gateway_name;
}
void OAICyberSource::setGatewayName(const OAIGatewayName &gateway_name) {
    m_gateway_name = gateway_name;
    m_gateway_name_isSet = true;
}

bool OAICyberSource::is_gateway_name_Set() const{
    return m_gateway_name_isSet;
}

bool OAICyberSource::is_gateway_name_Valid() const{
    return m_gateway_name_isValid;
}

QString OAICyberSource::getId() const {
    return m_id;
}
void OAICyberSource::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAICyberSource::is_id_Set() const{
    return m_id_isSet;
}

bool OAICyberSource::is_id_Valid() const{
    return m_id_isValid;
}

bool OAICyberSource::isIsDown() const {
    return m_is_down;
}
void OAICyberSource::setIsDown(const bool &is_down) {
    m_is_down = is_down;
    m_is_down_isSet = true;
}

bool OAICyberSource::is_is_down_Set() const{
    return m_is_down_isSet;
}

bool OAICyberSource::is_is_down_Valid() const{
    return m_is_down_isValid;
}

QString OAICyberSource::getMerchantCategoryCode() const {
    return m_merchant_category_code;
}
void OAICyberSource::setMerchantCategoryCode(const QString &merchant_category_code) {
    m_merchant_category_code = merchant_category_code;
    m_merchant_category_code_isSet = true;
}

bool OAICyberSource::is_merchant_category_code_Set() const{
    return m_merchant_category_code_isSet;
}

bool OAICyberSource::is_merchant_category_code_Valid() const{
    return m_merchant_category_code_isValid;
}

OAIPaymentMethod OAICyberSource::getMethod() const {
    return m_method;
}
void OAICyberSource::setMethod(const OAIPaymentMethod &method) {
    m_method = method;
    m_method_isSet = true;
}

bool OAICyberSource::is_method_Set() const{
    return m_method_isSet;
}

bool OAICyberSource::is_method_Valid() const{
    return m_method_isValid;
}

double OAICyberSource::getMonthlyLimit() const {
    return m_monthly_limit;
}
void OAICyberSource::setMonthlyLimit(const double &monthly_limit) {
    m_monthly_limit = monthly_limit;
    m_monthly_limit_isSet = true;
}

bool OAICyberSource::is_monthly_limit_Set() const{
    return m_monthly_limit_isSet;
}

bool OAICyberSource::is_monthly_limit_Valid() const{
    return m_monthly_limit_isValid;
}

QString OAICyberSource::getOrganizationId() const {
    return m_organization_id;
}
void OAICyberSource::setOrganizationId(const QString &organization_id) {
    m_organization_id = organization_id;
    m_organization_id_isSet = true;
}

bool OAICyberSource::is_organization_id_Set() const{
    return m_organization_id_isSet;
}

bool OAICyberSource::is_organization_id_Valid() const{
    return m_organization_id_isValid;
}

QList<OAIPaymentCardBrand> OAICyberSource::getPaymentCardSchemes() const {
    return m_payment_card_schemes;
}
void OAICyberSource::setPaymentCardSchemes(const QList<OAIPaymentCardBrand> &payment_card_schemes) {
    m_payment_card_schemes = payment_card_schemes;
    m_payment_card_schemes_isSet = true;
}

bool OAICyberSource::is_payment_card_schemes_Set() const{
    return m_payment_card_schemes_isSet;
}

bool OAICyberSource::is_payment_card_schemes_Valid() const{
    return m_payment_card_schemes_isValid;
}

bool OAICyberSource::isReconciliationWindowEnabled() const {
    return m_reconciliation_window_enabled;
}
void OAICyberSource::setReconciliationWindowEnabled(const bool &reconciliation_window_enabled) {
    m_reconciliation_window_enabled = reconciliation_window_enabled;
    m_reconciliation_window_enabled_isSet = true;
}

bool OAICyberSource::is_reconciliation_window_enabled_Set() const{
    return m_reconciliation_window_enabled_isSet;
}

bool OAICyberSource::is_reconciliation_window_enabled_Valid() const{
    return m_reconciliation_window_enabled_isValid;
}

qint32 OAICyberSource::getReconciliationWindowTtl() const {
    return m_reconciliation_window_ttl;
}
void OAICyberSource::setReconciliationWindowTtl(const qint32 &reconciliation_window_ttl) {
    m_reconciliation_window_ttl = reconciliation_window_ttl;
    m_reconciliation_window_ttl_isSet = true;
}

bool OAICyberSource::is_reconciliation_window_ttl_Set() const{
    return m_reconciliation_window_ttl_isSet;
}

bool OAICyberSource::is_reconciliation_window_ttl_Valid() const{
    return m_reconciliation_window_ttl_isValid;
}

QString OAICyberSource::getStatus() const {
    return m_status;
}
void OAICyberSource::setStatus(const QString &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAICyberSource::is_status_Set() const{
    return m_status_isSet;
}

bool OAICyberSource::is_status_Valid() const{
    return m_status_isValid;
}

bool OAICyberSource::isSticky() const {
    return m_sticky;
}
void OAICyberSource::setSticky(const bool &sticky) {
    m_sticky = sticky;
    m_sticky_isSet = true;
}

bool OAICyberSource::is_sticky_Set() const{
    return m_sticky_isSet;
}

bool OAICyberSource::is_sticky_Valid() const{
    return m_sticky_isValid;
}

bool OAICyberSource::isThreeDSecure() const {
    return m_three_d_secure;
}
void OAICyberSource::setThreeDSecure(const bool &three_d_secure) {
    m_three_d_secure = three_d_secure;
    m_three_d_secure_isSet = true;
}

bool OAICyberSource::is_three_d_secure_Set() const{
    return m_three_d_secure_isSet;
}

bool OAICyberSource::is_three_d_secure_Valid() const{
    return m_three_d_secure_isValid;
}

qint32 OAICyberSource::getTimeout() const {
    return m_timeout;
}
void OAICyberSource::setTimeout(const qint32 &timeout) {
    m_timeout = timeout;
    m_timeout_isSet = true;
}

bool OAICyberSource::is_timeout_Set() const{
    return m_timeout_isSet;
}

bool OAICyberSource::is_timeout_Valid() const{
    return m_timeout_isValid;
}

QString OAICyberSource::getToken() const {
    return m_token;
}
void OAICyberSource::setToken(const QString &token) {
    m_token = token;
    m_token_isSet = true;
}

bool OAICyberSource::is_token_Set() const{
    return m_token_isSet;
}

bool OAICyberSource::is_token_Valid() const{
    return m_token_isValid;
}

QDateTime OAICyberSource::getUpdatedTime() const {
    return m_updated_time;
}
void OAICyberSource::setUpdatedTime(const QDateTime &updated_time) {
    m_updated_time = updated_time;
    m_updated_time_isSet = true;
}

bool OAICyberSource::is_updated_time_Set() const{
    return m_updated_time_isSet;
}

bool OAICyberSource::is_updated_time_Valid() const{
    return m_updated_time_isValid;
}

OAICyberSource_allOf_credentials OAICyberSource::getCredentials() const {
    return m_credentials;
}
void OAICyberSource::setCredentials(const OAICyberSource_allOf_credentials &credentials) {
    m_credentials = credentials;
    m_credentials_isSet = true;
}

bool OAICyberSource::is_credentials_Set() const{
    return m_credentials_isSet;
}

bool OAICyberSource::is_credentials_Valid() const{
    return m_credentials_isValid;
}

bool OAICyberSource::isSet() const {
...
bool OAICyberSource::isValid() const {
