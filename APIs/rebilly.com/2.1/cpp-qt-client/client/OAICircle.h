...
class OAICircle_allOf_credentials;
...
public:
    ...
    OAICircle_allOf_credentials getCredentials() const;
    void setCredentials(const OAICircle_allOf_credentials &credentials);
...
private:
    ...
    OAICircle_allOf_credentials m_credentials;
