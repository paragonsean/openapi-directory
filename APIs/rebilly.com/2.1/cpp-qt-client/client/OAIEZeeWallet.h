...
#ifndef OAIEZeeWallet_H
#define OAIEZeeWallet_H
...
class OAIEZeeWallet_allOf_credentials;

class OAIEZeeWallet : public OAIObject {
public:
    OAIEZeeWallet();
    OAIEZeeWallet(QString json);
    ~OAIEZeeWallet() override;
    ...
    OAIEZeeWallet_allOf_credentials getCredentials() const;
    void setCredentials(const OAIEZeeWallet_allOf_credentials &credentials);
...
private:
    ...
    OAIEZeeWallet_allOf_credentials m_credentials;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEZeeWallet)

#endif // OAIEZeeWallet_H
