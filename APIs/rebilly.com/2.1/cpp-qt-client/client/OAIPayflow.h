...
#include "OAIPayflow_allOf_credentials.h"
...
class OAIPayflow_allOf_credentials;

class OAIPayflow : public OAIObject {
public:
    OAIPayflow();
    OAIPayflow(QString json);
    ~OAIPayflow() override;
    ...
    OAIPayflow_allOf_credentials getCredentials() const;
    void setCredentials(const OAIPayflow_allOf_credentials &credentials);
...
private:
    ...
    OAIPayflow_allOf_credentials m_credentials;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPayflow)
