...
#include "OAIPayTabs_allOf_credentials.h"
...
class OAIPayTabs_allOf_credentials;

class OAIPayTabs : public OAIObject {
public:
    OAIPayTabs();
    OAIPayTabs(QString json);
    ~OAIPayTabs() override;
    ...
    OAIPayTabs_allOf_credentials getCredentials() const;
    void setCredentials(const OAIPayTabs_allOf_credentials &credentials);
...
private:
    ...
    OAIPayTabs_allOf_credentials m_credentials;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPayTabs)
