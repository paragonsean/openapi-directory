...
/*
 * OAISparkPay_allOf_credentials.h
 *
 * SparkPay credentials object.
 */

#ifndef OAISparkPay_allOf_credentials_H
#define OAISparkPay_allOf_credentials_H
...
class OAISparkPay_allOf_credentials : public OAIObject {
public:
    OAISparkPay_allOf_credentials();
    OAISparkPay_allOf_credentials(QString json);
    ~OAISparkPay_allOf_credentials() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISparkPay_allOf_credentials)

#endif // OAISparkPay_allOf_credentials_H
