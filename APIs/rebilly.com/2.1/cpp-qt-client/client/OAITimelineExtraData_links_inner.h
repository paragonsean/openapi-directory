...
/*
 * OAITimelineExtraData_links_inner.h
 *
 * 
 */

#ifndef OAITimelineExtraData_links_inner_H
#define OAITimelineExtraData_links_inner_H
...
class OAITimelineExtraData_links_inner : public OAIObject {
public:
    OAITimelineExtraData_links_inner();
    OAITimelineExtraData_links_inner(QString json);
    ~OAITimelineExtraData_links_inner() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITimelineExtraData_links_inner)

#endif // OAITimelineExtraData_links_inner_H
