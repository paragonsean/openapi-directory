...
/*
 * OAIZimpler_allOf_credentials.h
 *
 * Zimpler credentials object.
 */

#ifndef OAIZimpler_allOf_credentials_H
#define OAIZimpler_allOf_credentials_H
...
class OAIZimpler_allOf_credentials : public OAIObject {
public:
    OAIZimpler_allOf_credentials();
    OAIZimpler_allOf_credentials(QString json);
    ~OAIZimpler_allOf_credentials() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIZimpler_allOf_credentials)

#endif // OAIZimpler_allOf_credentials_H
