...
#ifndef OAIAstroPayCard_H
#define OAIAstroPayCard_H

#include <QJsonObject>

#include "OAIAcquirerName.h"
#include "OAIAstroPayCard_allOf_credentials.h"
#include "OAIAstroPayCard_allOf_settings.h"
...
class OAIAstroPayCard_allOf_credentials;
class OAIAstroPayCard_allOf_settings;

class OAIAstroPayCard : public OAIObject {
public:
    OAIAstroPayCard();
    OAIAstroPayCard(QString json);
    ~OAIAstroPayCard() override;
    ...
    OAIAstroPayCard_allOf_credentials getCredentials() const;
    void setCredentials(const OAIAstroPayCard_allOf_credentials &credentials);
    bool is_credentials_Set() const;
    bool is_credentials_Valid() const;

    OAIAstroPayCard_allOf_settings getSettings() const;
    void setSettings(const OAIAstroPayCard_allOf_settings &settings);
...
private:
    ...
    OAIAstroPayCard_allOf_credentials m_credentials;
    bool m_credentials_isSet;
    bool m_credentials_isValid;

    OAIAstroPayCard_allOf_settings m_settings;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAstroPayCard)

#endif // OAIAstroPayCard_H
