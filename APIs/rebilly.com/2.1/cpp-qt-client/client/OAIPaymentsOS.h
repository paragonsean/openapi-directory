...
#ifndef OAIPaymentsOS_H
#define OAIPaymentsOS_H
...
class OAIPaymentsOS_allOf_credentials;

class OAIPaymentsOS : public OAIObject {
public:
    OAIPaymentsOS();
    OAIPaymentsOS(QString json);
    ~OAIPaymentsOS() override;
    ...
    OAIPaymentsOS_allOf_credentials getCredentials() const;
    void setCredentials(const OAIPaymentsOS_allOf_credentials &credentials);
...
private:
    ...
    OAIPaymentsOS_allOf_credentials m_credentials;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPaymentsOS)

#endif // OAIPaymentsOS_H
