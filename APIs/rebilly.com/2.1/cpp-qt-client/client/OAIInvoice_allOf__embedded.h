...
/*
 * OAIInvoice_allOf__embedded.h
 *
 * 
 */

#ifndef OAIInvoice_allOf__embedded_H
#define OAIInvoice_allOf__embedded_H
...
class OAIInvoice_allOf__embedded : public OAIObject {
public:
    OAIInvoice_allOf__embedded();
    OAIInvoice_allOf__embedded(QString json);
    ~OAIInvoice_allOf__embedded() override;
    ...
    OAIObject getWebsite() const;
    void setWebsite(const OAIObject &website);
...
Q_DECLARE_METATYPE(OpenAPI::OAIInvoice_allOf__embedded)

#endif // OAIInvoice_allOf__embedded_H
