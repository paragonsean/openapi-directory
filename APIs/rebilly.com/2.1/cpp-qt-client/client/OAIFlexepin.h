...
#ifndef OAIFlexepin_H
#define OAIFlexepin_H
...
class OAIFlexepin_allOf_credentials;

class OAIFlexepin : public OAIObject {
public:
    OAIFlexepin();
    OAIFlexepin(QString json);
    ~OAIFlexepin() override;
    ...
    OAIFlexepin_allOf_credentials getCredentials() const;
    void setCredentials(const OAIFlexepin_allOf_credentials &credentials);
...
private:
    ...
    OAIFlexepin_allOf_credentials m_credentials;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFlexepin)
