...
class OAIWalpay_allOf_credentials;
class OAIWalpay3dsServers;

class OAIWalpay : public OAIObject {
public:
    OAIWalpay();
    OAIWalpay(QString json);
    ~OAIWalpay() override;
    ...
    OAIWalpay_allOf_credentials getCredentials() const;
    void setCredentials(const OAIWalpay_allOf_credentials &credentials);
    bool is_credentials_Set() const;
    bool is_credentials_Valid() const;

    OAIWalpay3dsServers getThreeDSecureServer() const;
    void setThreeDSecureServer(const OAIWalpay3dsServers &three_d_secure_server);
...
private:
    ...
    OAIWalpay_allOf_credentials m_credentials;
    bool m_credentials_isSet;
    bool m_credentials_isValid;

    OAIWalpay3dsServers m_three_d_secure_server;
...
Q_DECLARE_METATYPE(OpenAPI::OAIWalpay)
