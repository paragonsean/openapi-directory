...
public class CountryResponse {
  ...
  public CountryResponse errors(List<Error> errors) {
    this.errors = errors;
    return this;
  }

  public CountryResponse addErrorsItem(Error errorsItem) {
    if (this.errors == null) {
  ...
  public CountryResponse data(CountryDetails data) {
    this.data = data;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.errors, countryResponse.errors) &&
        Objects.equals(this.data, countryResponse.data);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        CountryDetails.validateJsonElement(jsonObj.get("data"));
      }
  }
