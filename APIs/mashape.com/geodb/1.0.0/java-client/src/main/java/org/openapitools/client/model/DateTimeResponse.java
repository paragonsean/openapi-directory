...
public class DateTimeResponse {
  ...
  public DateTimeResponse errors(List<Error> errors) {
    this.errors = errors;
    return this;
  }

  public DateTimeResponse addErrorsItem(Error errorsItem) {
    if (this.errors == null) {
  ...
  public DateTimeResponse data(OffsetDateTime data) {
    this.data = data;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    DateTimeResponse dateTimeResponse = (DateTimeResponse) o;
    return Objects.equals(this.errors, dateTimeResponse.errors) &&
        Objects.equals(this.data, dateTimeResponse.data);
  }
  ...
  public String toString() {
    ...
    sb.append("class DateTimeResponse {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DateTimeResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DateTimeResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DateTimeResponse is not found in the empty JSON string", DateTimeResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DateTimeResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DateTimeResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DateTimeResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DateTimeResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DateTimeResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DateTimeResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<DateTimeResponse>() {
           @Override
           public void write(JsonWriter out, DateTimeResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DateTimeResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DateTimeResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DateTimeResponse
   * @throws IOException if the JSON string is invalid with respect to DateTimeResponse
   */
  public static DateTimeResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DateTimeResponse.class);
  }

  /**
   * Convert an instance of DateTimeResponse to an JSON string
   *
   * @return JSON string
   */
