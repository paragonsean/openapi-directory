...
public class CountrySummary {
  ...
  public CountrySummary currencyCodes(List<String> currencyCodes) {
    this.currencyCodes = currencyCodes;
    return this;
  }

  public CountrySummary addCurrencyCodesItem(String currencyCodesItem) {
  ...
  public CountrySummary wikiDataId(String wikiDataId) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.code, countrySummary.code) &&
        Objects.equals(this.currencyCodes, countrySummary.currencyCodes) &&
        Objects.equals(this.name, countrySummary.name) &&
        Objects.equals(this.wikiDataId, countrySummary.wikiDataId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(code, currencyCodes, name, wikiDataId);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to CountrySummary
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CountrySummary.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CountrySummary is not found in the empty JSON string", CountrySummary.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CountrySummary.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CountrySummary` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CountrySummary.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CountrySummary' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CountrySummary> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CountrySummary.class));

       return (TypeAdapter<T>) new TypeAdapter<CountrySummary>() {
           @Override
           public void write(JsonWriter out, CountrySummary value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CountrySummary read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CountrySummary given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CountrySummary
   * @throws IOException if the JSON string is invalid with respect to CountrySummary
   */
  public static CountrySummary fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CountrySummary.class);
  }

  /**
   * Convert an instance of CountrySummary to an JSON string
   *
   * @return JSON string
   */
