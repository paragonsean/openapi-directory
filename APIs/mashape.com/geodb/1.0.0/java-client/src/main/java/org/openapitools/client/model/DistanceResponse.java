...
public class DistanceResponse {
  ...
  public DistanceResponse errors(List<Error> errors) {
    this.errors = errors;
    return this;
  }

  public DistanceResponse addErrorsItem(Error errorsItem) {
    if (this.errors == null) {
  ...
  public DistanceResponse data(Double data) {
    this.data = data;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.errors, distanceResponse.errors) &&
        Objects.equals(this.data, distanceResponse.data);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to DistanceResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DistanceResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DistanceResponse is not found in the empty JSON string", DistanceResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DistanceResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DistanceResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DistanceResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DistanceResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DistanceResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DistanceResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<DistanceResponse>() {
           @Override
           public void write(JsonWriter out, DistanceResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DistanceResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DistanceResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DistanceResponse
   * @throws IOException if the JSON string is invalid with respect to DistanceResponse
   */
  public static DistanceResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DistanceResponse.class);
  }

  /**
   * Convert an instance of DistanceResponse to an JSON string
   *
   * @return JSON string
   */
