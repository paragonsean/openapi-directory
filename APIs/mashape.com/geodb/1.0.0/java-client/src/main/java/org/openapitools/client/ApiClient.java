...
public class ApiClient {
    ...
    private String basePath = "https://wft-geo-db.p.rapidapi.com/v1";
    ...
    public ApiClient() {
        ...
        authentications.put("UserSecurity", new ApiKeyAuth("header", "x-rapidapi-key"));
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://wft-geo-db.p.rapidapi.com/v1
