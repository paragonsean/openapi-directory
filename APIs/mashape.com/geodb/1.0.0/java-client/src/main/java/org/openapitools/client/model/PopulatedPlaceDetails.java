...
public class PopulatedPlaceDetails {
  ...
  public static final String SERIALIZED_NAME_ELEVATION_METERS = "elevationMeters";
  @SerializedName(SERIALIZED_NAME_ELEVATION_METERS)
  ...
  static {
    ...
    openapiFields.add("elevationMeters");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PopulatedPlaceDetails
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PopulatedPlaceDetails.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PopulatedPlaceDetails is not found in the empty JSON string", PopulatedPlaceDetails.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PopulatedPlaceDetails.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PopulatedPlaceDetails` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PopulatedPlaceDetails.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PopulatedPlaceDetails' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PopulatedPlaceDetails> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PopulatedPlaceDetails.class));

       return (TypeAdapter<T>) new TypeAdapter<PopulatedPlaceDetails>() {
           @Override
           public void write(JsonWriter out, PopulatedPlaceDetails value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PopulatedPlaceDetails read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PopulatedPlaceDetails given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PopulatedPlaceDetails
   * @throws IOException if the JSON string is invalid with respect to PopulatedPlaceDetails
   */
  public static PopulatedPlaceDetails fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PopulatedPlaceDetails.class);
  }

  /**
   * Convert an instance of PopulatedPlaceDetails to an JSON string
   *
   * @return JSON string
   */
