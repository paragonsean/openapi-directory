...
public class ForbiddenResponse {
  ...
  public ForbiddenResponse errors(List<Error> errors) {
    this.errors = errors;
    return this;
  }

  public ForbiddenResponse addErrorsItem(Error errorsItem) {
    if (this.errors == null) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.errors, forbiddenResponse.errors);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ForbiddenResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ForbiddenResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ForbiddenResponse is not found in the empty JSON string", ForbiddenResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ForbiddenResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ForbiddenResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ForbiddenResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ForbiddenResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ForbiddenResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ForbiddenResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<ForbiddenResponse>() {
           @Override
           public void write(JsonWriter out, ForbiddenResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ForbiddenResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ForbiddenResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ForbiddenResponse
   * @throws IOException if the JSON string is invalid with respect to ForbiddenResponse
   */
  public static ForbiddenResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ForbiddenResponse.class);
  }

  /**
   * Convert an instance of ForbiddenResponse to an JSON string
   *
   * @return JSON string
   */
