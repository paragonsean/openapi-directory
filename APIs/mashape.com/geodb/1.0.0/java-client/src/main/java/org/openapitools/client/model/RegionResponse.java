...
public class RegionResponse {
  ...
  private RegionDetails data;

  public RegionResponse() {
  }

  public RegionResponse errors(List<Error> errors) {
    this.errors = errors;
    return this;
  }

  public RegionResponse addErrorsItem(Error errorsItem) {
    if (this.errors == null) {
  ...
  public RegionResponse data(RegionDetails data) {
    this.data = data;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public RegionDetails getData() {
    return data;
  }

  public void setData(RegionDetails data) {
    this.data = data;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.errors, regionResponse.errors) &&
        Objects.equals(this.data, regionResponse.data);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RegionResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `RegionResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        RegionDetails.validateJsonElement(jsonObj.get("data"));
      }
  }
