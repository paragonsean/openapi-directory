...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GeoDbCitiesApi.LocaleApi();
  });
  ...
  describe('LocaleApi', function() {
    ...
    describe('getLanguagesUsingGET', function() {
      it('should call getLanguagesUsingGET successfully', function(done) {
        //uncomment below and update the code to test getLanguagesUsingGET
        //instance.getLanguagesUsingGET(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('getLocalesUsingGET', function() {
      it('should call getLocalesUsingGET successfully', function(done) {
        //uncomment below and update the code to test getLocalesUsingGET
        //instance.getLocalesUsingGET(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('getTimeZoneDateTimeUsingGET', function() {
      it('should call getTimeZoneDateTimeUsingGET successfully', function(done) {
        //uncomment below and update the code to test getTimeZoneDateTimeUsingGET
        //instance.getTimeZoneDateTimeUsingGET(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('getTimeZoneTimeUsingGET', function() {
      it('should call getTimeZoneTimeUsingGET successfully', function(done) {
        //uncomment below and update the code to test getTimeZoneTimeUsingGET
        //instance.getTimeZoneTimeUsingGET(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('getTimeZoneUsingGET', function() {
      it('should call getTimeZoneUsingGET successfully', function(done) {
        //uncomment below and update the code to test getTimeZoneUsingGET
        //instance.getTimeZoneUsingGET(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('getTimezonesUsingGET', function() {
      it('should call getTimezonesUsingGET successfully', function(done) {
        //uncomment below and update the code to test getTimezonesUsingGET
        //instance.getTimezonesUsingGET(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
