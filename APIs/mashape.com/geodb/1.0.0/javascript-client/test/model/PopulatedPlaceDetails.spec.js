...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GeoDbCitiesApi.PopulatedPlaceDetails();
  });
  ...
  describe('PopulatedPlaceDetails', function() {
    it('should create an instance of PopulatedPlaceDetails', function() {
      // uncomment below and update the code to test PopulatedPlaceDetails
      //var instance = new GeoDbCitiesApi.PopulatedPlaceDetails();
      //expect(instance).to.be.a(GeoDbCitiesApi.PopulatedPlaceDetails);
    });
    ...
    it('should have the property elevationMeters (base name: "elevationMeters")', function() {
      // uncomment below and update the code to test the property elevationMeters
      //var instance = new GeoDbCitiesApi.PopulatedPlaceDetails();
      //expect(instance).to.be();
    });
