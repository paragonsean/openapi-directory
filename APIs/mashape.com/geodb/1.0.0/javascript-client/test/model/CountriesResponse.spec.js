...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GeoDbCitiesApi.CountriesResponse();
  });
  ...
  describe('CountriesResponse', function() {
    it('should create an instance of CountriesResponse', function() {
      ...
      //var instance = new GeoDbCitiesApi.CountriesResponse();
      //expect(instance).to.be.a(GeoDbCitiesApi.CountriesResponse);
    });
