...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GeoDbCitiesApi.TimeZonesResponse();
  });
  ...
  describe('TimeZonesResponse', function() {
    it('should create an instance of TimeZonesResponse', function() {
      // uncomment below and update the code to test TimeZonesResponse
      //var instance = new GeoDbCitiesApi.TimeZonesResponse();
      //expect(instance).to.be.a(GeoDbCitiesApi.TimeZonesResponse);
    });
