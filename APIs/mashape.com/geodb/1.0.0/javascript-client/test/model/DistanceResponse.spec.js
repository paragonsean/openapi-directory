...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GeoDbCitiesApi.DistanceResponse();
  });
  ...
  describe('DistanceResponse', function() {
    it('should create an instance of DistanceResponse', function() {
      // uncomment below and update the code to test DistanceResponse
      //var instance = new GeoDbCitiesApi.DistanceResponse();
      //expect(instance).to.be.a(GeoDbCitiesApi.DistanceResponse);
    });
