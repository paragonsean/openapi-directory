...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GeoDbCitiesApi.ForbiddenResponse();
  });
  ...
  describe('ForbiddenResponse', function() {
    it('should create an instance of ForbiddenResponse', function() {
      ...
      //var instance = new GeoDbCitiesApi.ForbiddenResponse();
      //expect(instance).to.be.a(GeoDbCitiesApi.ForbiddenResponse);
    });
