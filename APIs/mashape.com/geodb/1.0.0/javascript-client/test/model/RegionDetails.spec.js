...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GeoDbCitiesApi.RegionDetails();
  });
  ...
  describe('RegionDetails', function() {
    it('should create an instance of RegionDetails', function() {
      // uncomment below and update the code to test RegionDetails
      //var instance = new GeoDbCitiesApi.RegionDetails();
      //expect(instance).to.be.a(GeoDbCitiesApi.RegionDetails);
    });
    ...
    it('should have the property numCities (base name: "numCities")', function() {
      // uncomment below and update the code to test the property numCities
      //var instance = new GeoDbCitiesApi.RegionDetails();
      //expect(instance).to.be();
    });
