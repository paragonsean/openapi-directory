...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GeoDbCitiesApi.TimeZoneDescriptor();
  });
  ...
  describe('TimeZoneDescriptor', function() {
    it('should create an instance of TimeZoneDescriptor', function() {
      // uncomment below and update the code to test TimeZoneDescriptor
      //var instance = new GeoDbCitiesApi.TimeZoneDescriptor();
      //expect(instance).to.be.a(GeoDbCitiesApi.TimeZoneDescriptor);
    });
    ...
    it('should have the property rawUtcOffsetHours (base name: "rawUtcOffsetHours")', function() {
      // uncomment below and update the code to test the property rawUtcOffsetHours
      //var instance = new GeoDbCitiesApi.TimeZoneDescriptor();
      //expect(instance).to.be();
    });
