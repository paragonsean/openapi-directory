...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GeoDbCitiesApi.DateTimeResponse();
  });
  ...
  describe('DateTimeResponse', function() {
    it('should create an instance of DateTimeResponse', function() {
      // uncomment below and update the code to test DateTimeResponse
      //var instance = new GeoDbCitiesApi.DateTimeResponse();
      //expect(instance).to.be.a(GeoDbCitiesApi.DateTimeResponse);
    });
