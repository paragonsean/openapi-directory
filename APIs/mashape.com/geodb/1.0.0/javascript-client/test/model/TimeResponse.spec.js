...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GeoDbCitiesApi.TimeResponse();
  });
  ...
  describe('TimeResponse', function() {
    it('should create an instance of TimeResponse', function() {
      // uncomment below and update the code to test TimeResponse
      //var instance = new GeoDbCitiesApi.TimeResponse();
      //expect(instance).to.be.a(GeoDbCitiesApi.TimeResponse);
    });
