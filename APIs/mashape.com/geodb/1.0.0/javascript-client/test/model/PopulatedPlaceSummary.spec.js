...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GeoDbCitiesApi.PopulatedPlaceSummary();
  });
  ...
  describe('PopulatedPlaceSummary', function() {
    it('should create an instance of PopulatedPlaceSummary', function() {
      // uncomment below and update the code to test PopulatedPlaceSummary
      //var instance = new GeoDbCitiesApi.PopulatedPlaceSummary();
      //expect(instance).to.be.a(GeoDbCitiesApi.PopulatedPlaceSummary);
    });
