...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GeoDbCitiesApi.LanguageDescriptor();
  });
  ...
  describe('LanguageDescriptor', function() {
    it('should create an instance of LanguageDescriptor', function() {
      // uncomment below and update the code to test LanguageDescriptor
      //var instance = new GeoDbCitiesApi.LanguageDescriptor();
      //expect(instance).to.be.a(GeoDbCitiesApi.LanguageDescriptor);
    });
