...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GeoDbCitiesApi.PopulatedPlacesResponse();
  });
  ...
  describe('PopulatedPlacesResponse', function() {
    it('should create an instance of PopulatedPlacesResponse', function() {
      // uncomment below and update the code to test PopulatedPlacesResponse
      //var instance = new GeoDbCitiesApi.PopulatedPlacesResponse();
      //expect(instance).to.be.a(GeoDbCitiesApi.PopulatedPlacesResponse);
    });
