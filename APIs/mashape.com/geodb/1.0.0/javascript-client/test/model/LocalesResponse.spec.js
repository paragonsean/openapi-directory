...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GeoDbCitiesApi.LocalesResponse();
  });
  ...
  describe('LocalesResponse', function() {
    it('should create an instance of LocalesResponse', function() {
      // uncomment below and update the code to test LocalesResponse
      //var instance = new GeoDbCitiesApi.LocalesResponse();
      //expect(instance).to.be.a(GeoDbCitiesApi.LocalesResponse);
    });
