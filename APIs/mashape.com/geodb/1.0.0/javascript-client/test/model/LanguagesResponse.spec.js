...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GeoDbCitiesApi.LanguagesResponse();
  });
  ...
  describe('LanguagesResponse', function() {
    it('should create an instance of LanguagesResponse', function() {
      // uncomment below and update the code to test LanguagesResponse
      //var instance = new GeoDbCitiesApi.LanguagesResponse();
      //expect(instance).to.be.a(GeoDbCitiesApi.LanguagesResponse);
    });
