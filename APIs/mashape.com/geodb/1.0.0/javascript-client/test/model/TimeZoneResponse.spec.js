...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GeoDbCitiesApi.TimeZoneResponse();
  });
  ...
  describe('TimeZoneResponse', function() {
    it('should create an instance of TimeZoneResponse', function() {
      // uncomment below and update the code to test TimeZoneResponse
      //var instance = new GeoDbCitiesApi.TimeZoneResponse();
      //expect(instance).to.be.a(GeoDbCitiesApi.TimeZoneResponse);
    });
