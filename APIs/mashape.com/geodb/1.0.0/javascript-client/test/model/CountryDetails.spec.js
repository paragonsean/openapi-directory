...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GeoDbCitiesApi.CountryDetails();
  });
  ...
  describe('CountryDetails', function() {
    it('should create an instance of CountryDetails', function() {
      ...
      //var instance = new GeoDbCitiesApi.CountryDetails();
      //expect(instance).to.be.a(GeoDbCitiesApi.CountryDetails);
    });
    ...
    it('should have the property currencyCodes (base name: "currencyCodes")', function() {
      // uncomment below and update the code to test the property currencyCodes
      //var instance = new GeoDbCitiesApi.CountryDetails();
      //expect(instance).to.be();
    });

    it('should have the property flagImageUri (base name: "flagImageUri")', function() {
      // uncomment below and update the code to test the property flagImageUri
      //var instance = new GeoDbCitiesApi.CountryDetails();
      //expect(instance).to.be();
    });
    ...
    it('should have the property wikiDataId (base name: "wikiDataId")', function() {
      // uncomment below and update the code to test the property wikiDataId
      //var instance = new GeoDbCitiesApi.CountryDetails();
      //expect(instance).to.be();
    });
