...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GeoDbCitiesApi.RegionsResponse();
  });
  ...
  describe('RegionsResponse', function() {
    it('should create an instance of RegionsResponse', function() {
      // uncomment below and update the code to test RegionsResponse
      //var instance = new GeoDbCitiesApi.RegionsResponse();
      //expect(instance).to.be.a(GeoDbCitiesApi.RegionsResponse);
    });
