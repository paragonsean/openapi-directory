...
(function(root, factory) {
  ...
  describe('PopulatedPlaceType', function() {
    it('should create an instance of PopulatedPlaceType', function() {
      // uncomment below and update the code to test PopulatedPlaceType
      //var instance = new GeoDbCitiesApi.PopulatedPlaceType();
      //expect(instance).to.be.a(GeoDbCitiesApi.PopulatedPlaceType);
    });
