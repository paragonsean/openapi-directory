...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GeoDbCitiesApi.CurrenciesResponse();
  });
  ...
  describe('CurrenciesResponse', function() {
    it('should create an instance of CurrenciesResponse', function() {
      ...
      //var instance = new GeoDbCitiesApi.CurrenciesResponse();
      //expect(instance).to.be.a(GeoDbCitiesApi.CurrenciesResponse);
    });
