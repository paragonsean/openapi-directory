...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GeoDbCitiesApi.RegionResponse();
  });
  ...
  describe('RegionResponse', function() {
    it('should create an instance of RegionResponse', function() {
      // uncomment below and update the code to test RegionResponse
      //var instance = new GeoDbCitiesApi.RegionResponse();
      //expect(instance).to.be.a(GeoDbCitiesApi.RegionResponse);
    });
