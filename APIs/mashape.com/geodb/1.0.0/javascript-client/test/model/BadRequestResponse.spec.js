...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GeoDbCitiesApi.BadRequestResponse();
  });
  ...
  describe('BadRequestResponse', function() {
    it('should create an instance of BadRequestResponse', function() {
      ...
      //var instance = new GeoDbCitiesApi.BadRequestResponse();
      //expect(instance).to.be.a(GeoDbCitiesApi.BadRequestResponse);
    });
