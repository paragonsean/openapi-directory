...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GeoDbCitiesApi.BaseCollectionResponse();
  });
  ...
  describe('BaseCollectionResponse', function() {
    it('should create an instance of BaseCollectionResponse', function() {
      // uncomment below and update the code to test BaseCollectionResponse
      //var instance = new GeoDbCitiesApi.BaseCollectionResponse();
      //expect(instance).to.be.a(GeoDbCitiesApi.BaseCollectionResponse);
    });
