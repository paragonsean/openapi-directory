...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GeoDbCitiesApi.PopulatedPlaceResponse();
  });
  ...
  describe('PopulatedPlaceResponse', function() {
    it('should create an instance of PopulatedPlaceResponse', function() {
      // uncomment below and update the code to test PopulatedPlaceResponse
      //var instance = new GeoDbCitiesApi.PopulatedPlaceResponse();
      //expect(instance).to.be.a(GeoDbCitiesApi.PopulatedPlaceResponse);
    });
