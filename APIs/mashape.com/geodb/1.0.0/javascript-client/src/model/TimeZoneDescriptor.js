...
/**
 * The TimeZoneDescriptor model module.
 * @module model/TimeZoneDescriptor
 * @version 1.0.0
 */
class TimeZoneDescriptor {
    /**
     * Constructs a new <code>TimeZoneDescriptor</code>.
     * A time-zone
     * @alias module:model/TimeZoneDescriptor
     */
    constructor() { 
        
        TimeZoneDescriptor.initialize(this);
    }
    ...
    /**
     * Constructs a <code>TimeZoneDescriptor</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/TimeZoneDescriptor} obj Optional instance to populate.
     * @return {module:model/TimeZoneDescriptor} The populated <code>TimeZoneDescriptor</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new TimeZoneDescriptor();
            ...
            if (data.hasOwnProperty('rawUtcOffsetHours')) {
                obj['rawUtcOffsetHours'] = ApiClient.convertToType(data['rawUtcOffsetHours'], 'Number');
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>TimeZoneDescriptor</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TimeZoneDescriptor</code>.
     */
 ...
 * @member {String} id
 */
TimeZoneDescriptor.prototype['id'] = undefined;

/**
 * The time-zone name
 * @member {String} name
 */
TimeZoneDescriptor.prototype['name'] = undefined;

/**
 * The number of hours this time-zone is offset from UTC
 * @member {Number} rawUtcOffsetHours
 */
TimeZoneDescriptor.prototype['rawUtcOffsetHours'] = undefined;
...
export default TimeZoneDescriptor;
