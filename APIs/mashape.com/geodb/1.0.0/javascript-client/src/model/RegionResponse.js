...
class RegionResponse {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('data')) {
                obj['data'] = RegionDetails.constructFromObject(data['data']);
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        if (data['data']) { // data not null
          RegionDetails.validateJSON(data['data']);
        }
 ...
 */
RegionResponse.prototype['errors'] = undefined;

/**
 * @member {module:model/RegionDetails} data
 */
