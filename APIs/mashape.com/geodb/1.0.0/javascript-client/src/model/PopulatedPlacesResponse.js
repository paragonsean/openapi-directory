...
import PopulatedPlaceSummary from './PopulatedPlaceSummary';

/**
 * The PopulatedPlacesResponse model module.
 * @module model/PopulatedPlacesResponse
 * @version 1.0.0
 */
class PopulatedPlacesResponse {
    /**
     * Constructs a new <code>PopulatedPlacesResponse</code>.
     * A list of populated places
     * @alias module:model/PopulatedPlacesResponse
     * @implements module:model/BaseCollectionResponse
     */
    constructor() { 
        BaseCollectionResponse.initialize(this);
        PopulatedPlacesResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PopulatedPlacesResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PopulatedPlacesResponse} obj Optional instance to populate.
     * @return {module:model/PopulatedPlacesResponse} The populated <code>PopulatedPlacesResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PopulatedPlacesResponse();
            ...
            if (data.hasOwnProperty('data')) {
                obj['data'] = ApiClient.convertToType(data['data'], [PopulatedPlaceSummary]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>PopulatedPlacesResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PopulatedPlacesResponse</code>.
     */
    static validateJSON(data) {
        ...
        if (data['data']) { // data not null
            ...
            for (const item of data['data']) {
                PopulatedPlaceSummary.validateJSON(item);
            };
        }
 ...
 */
PopulatedPlacesResponse.prototype['errors'] = undefined;

/**
 * @member {Array.<module:model/Link>} links
 */
PopulatedPlacesResponse.prototype['links'] = undefined;

/**
 * @member {module:model/Metadata} metadata
 */
PopulatedPlacesResponse.prototype['metadata'] = undefined;

/**
 * @member {Array.<module:model/PopulatedPlaceSummary>} data
 */
PopulatedPlacesResponse.prototype['data'] = undefined;


// Implement BaseCollectionResponse interface:
/**
 * @member {Array.<module:model/Error>} errors
 */
...
export default PopulatedPlacesResponse;
