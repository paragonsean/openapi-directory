...
/**
* Enum class PopulatedPlaceType.
* @enum {}
* @readonly
*/
export default class PopulatedPlaceType {
    ...
    /**
    * Returns a <code>PopulatedPlaceType</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/PopulatedPlaceType} The enum <code>PopulatedPlaceType</code> value.
    */
