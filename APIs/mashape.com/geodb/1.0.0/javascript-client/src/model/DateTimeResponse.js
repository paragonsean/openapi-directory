...
/**
 * The DateTimeResponse model module.
 * @module model/DateTimeResponse
 * @version 1.0.0
 */
class DateTimeResponse {
    /**
     * Constructs a new <code>DateTimeResponse</code>.
     * An ISO-6801 date-time response
     * @alias module:model/DateTimeResponse
     * @implements module:model/BaseResponse
     */
    constructor() { 
        BaseResponse.initialize(this);
        DateTimeResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DateTimeResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DateTimeResponse} obj Optional instance to populate.
     * @return {module:model/DateTimeResponse} The populated <code>DateTimeResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DateTimeResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>DateTimeResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DateTimeResponse</code>.
     */
 ...
 */
DateTimeResponse.prototype['errors'] = undefined;

/**
 * The date-time in ISO-6801 format: yyyyMMdd'T'HHmmssZ
 * @member {Date} data
 */
DateTimeResponse.prototype['data'] = undefined;
