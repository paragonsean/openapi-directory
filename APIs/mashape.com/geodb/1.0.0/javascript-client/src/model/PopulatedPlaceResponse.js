...
import PopulatedPlaceDetails from './PopulatedPlaceDetails';

/**
 * The PopulatedPlaceResponse model module.
 * @module model/PopulatedPlaceResponse
 * @version 1.0.0
 */
class PopulatedPlaceResponse {
    /**
     * Constructs a new <code>PopulatedPlaceResponse</code>.
     * Populated-place details response
     * @alias module:model/PopulatedPlaceResponse
     * @implements module:model/BaseResponse
     */
    constructor() { 
        BaseResponse.initialize(this);
        PopulatedPlaceResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PopulatedPlaceResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PopulatedPlaceResponse} obj Optional instance to populate.
     * @return {module:model/PopulatedPlaceResponse} The populated <code>PopulatedPlaceResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PopulatedPlaceResponse();
            ...
            if (data.hasOwnProperty('data')) {
                obj['data'] = PopulatedPlaceDetails.constructFromObject(data['data']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>PopulatedPlaceResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PopulatedPlaceResponse</code>.
     */
    static validateJSON(data) {
        ...
        if (data['data']) { // data not null
          PopulatedPlaceDetails.validateJSON(data['data']);
        }
 ...
 */
PopulatedPlaceResponse.prototype['errors'] = undefined;

/**
 * @member {module:model/PopulatedPlaceDetails} data
 */
PopulatedPlaceResponse.prototype['data'] = undefined;
...
export default PopulatedPlaceResponse;
