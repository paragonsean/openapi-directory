...
class RegionsResponse {
    ...
    constructor() { 
        ...
        RegionsResponse.initialize(this);
    }
    ...
    /**
     * Validates the JSON data with respect to <code>RegionsResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RegionsResponse</code>.
     */
    static validateJSON(data) {
        ...
        if (data['data']) { // data not null
            ...
            for (const item of data['data']) {
                RegionSummary.validateJSON(item);
            };
        }
 ...
 */
RegionsResponse.prototype['errors'] = undefined;

/**
 * @member {Array.<module:model/Link>} links
 */
RegionsResponse.prototype['links'] = undefined;

/**
 * @member {module:model/Metadata} metadata
 */
RegionsResponse.prototype['metadata'] = undefined;

/**
 * A list of RegionSummaries
 * @member {Array.<module:model/RegionSummary>} data
 */
RegionsResponse.prototype['data'] = undefined;
...
export default RegionsResponse;
