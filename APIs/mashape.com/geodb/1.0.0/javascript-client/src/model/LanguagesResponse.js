...
import LanguageDescriptor from './LanguageDescriptor';
...
class LanguagesResponse {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('data')) {
                obj['data'] = ApiClient.convertToType(data['data'], [LanguageDescriptor]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>LanguagesResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>LanguagesResponse</code>.
     */
    static validateJSON(data) {
        ...
        if (data['data']) { // data not null
            ...
            for (const item of data['data']) {
                LanguageDescriptor.validateJSON(item);
            };
        }
 ...
 */
LanguagesResponse.prototype['errors'] = undefined;

/**
 * @member {Array.<module:model/Link>} links
 */
LanguagesResponse.prototype['links'] = undefined;

/**
 * @member {module:model/Metadata} metadata
 */
LanguagesResponse.prototype['metadata'] = undefined;

/**
 * @member {Array.<module:model/LanguageDescriptor>} data
 */
LanguagesResponse.prototype['data'] = undefined;
