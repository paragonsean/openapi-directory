 ...
 * @member {String} code
 */
CountrySummary.prototype['code'] = undefined;

/**
 * A list of supported ISO-4217 currency codes
 * @member {Array.<String>} currencyCodes
 */
CountrySummary.prototype['currencyCodes'] = undefined;

/**
 * The country name (varies by languageCode)
 * @member {String} name
 */
CountrySummary.prototype['name'] = undefined;

/**
 * The country WikiData id
 * @member {String} wikiDataId
 */
CountrySummary.prototype['wikiDataId'] = undefined;
