...
class CountryResponse {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('data')) {
                obj['data'] = CountryDetails.constructFromObject(data['data']);
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        if (data['data']) { // data not null
          CountryDetails.validateJSON(data['data']);
        }
 ...
 */
CountryResponse.prototype['errors'] = undefined;

/**
 * @member {module:model/CountryDetails} data
 */
