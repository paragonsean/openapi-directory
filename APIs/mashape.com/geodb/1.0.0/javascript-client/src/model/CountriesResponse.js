    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('data')) {
                obj['data'] = ApiClient.convertToType(data['data'], [CountrySummary]);
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        if (data['data']) { // data not null
            ...
            for (const item of data['data']) {
                CountrySummary.validateJSON(item);
            };
        }
 ...
 */
CountriesResponse.prototype['errors'] = undefined;

/**
 * @member {Array.<module:model/Link>} links
 */
CountriesResponse.prototype['links'] = undefined;

/**
 * @member {module:model/Metadata} metadata
 */
CountriesResponse.prototype['metadata'] = undefined;

/**
 * @member {Array.<module:model/CountrySummary>} data
 */
