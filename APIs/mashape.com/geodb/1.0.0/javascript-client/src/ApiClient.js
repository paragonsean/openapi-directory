...
class ApiClient {
     ...
     */
    constructor(basePath = 'https://wft-geo-db.p.rapidapi.com/v1') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default https://wft-geo-db.p.rapidapi.com/v1
         */
        ...
        this.authentications = {
            'UserSecurity': {type: 'apiKey', 'in': 'header', name: 'x-rapidapi-key'}
        }
