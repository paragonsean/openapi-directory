...
class BaseResponse(Model):
    ...
    def __init__(self, errors: List[Error]=None):
        ...
        :param errors: The errors of this BaseResponse.
        """
        self.openapi_types = {
            'errors': List[Error]
        }
    ...
    @property
    def errors(self):
        """Gets the errors of this BaseResponse.


        :return: The errors of this BaseResponse.
        :rtype: List[Error]
        """
        return self._errors
    ...
    def errors(self, errors):
        """Sets the errors of this BaseResponse.
