...
OAIRegionsResponse::OAIRegionsResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIRegionsResponse::OAIRegionsResponse() {
    this->initializeModel();
}

OAIRegionsResponse::~OAIRegionsResponse() {}

void OAIRegionsResponse::initializeModel() {
...
void OAIRegionsResponse::fromJson(QString jsonString) {
...
void OAIRegionsResponse::fromJsonObject(QJsonObject json) {
...
QString OAIRegionsResponse::asJson() const {
...
QJsonObject OAIRegionsResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_errors.size() > 0) {
...
QList<OAIError> OAIRegionsResponse::getErrors() const {
    return m_errors;
}
void OAIRegionsResponse::setErrors(const QList<OAIError> &errors) {
    m_errors = errors;
    m_errors_isSet = true;
}

bool OAIRegionsResponse::is_errors_Set() const{
    return m_errors_isSet;
}

bool OAIRegionsResponse::is_errors_Valid() const{
    return m_errors_isValid;
}

QList<OAILink> OAIRegionsResponse::getLinks() const {
    return m_links;
}
void OAIRegionsResponse::setLinks(const QList<OAILink> &links) {
    m_links = links;
    m_links_isSet = true;
}

bool OAIRegionsResponse::is_links_Set() const{
    return m_links_isSet;
}

bool OAIRegionsResponse::is_links_Valid() const{
    return m_links_isValid;
}

OAIMetadata OAIRegionsResponse::getMetadata() const {
    return m_metadata;
}
void OAIRegionsResponse::setMetadata(const OAIMetadata &metadata) {
    m_metadata = metadata;
    m_metadata_isSet = true;
}

bool OAIRegionsResponse::is_metadata_Set() const{
    return m_metadata_isSet;
}

bool OAIRegionsResponse::is_metadata_Valid() const{
    return m_metadata_isValid;
}

QList<OAIRegionSummary> OAIRegionsResponse::getData() const {
    return m_data;
}
void OAIRegionsResponse::setData(const QList<OAIRegionSummary> &data) {
    m_data = data;
    m_data_isSet = true;
}

bool OAIRegionsResponse::is_data_Set() const{
    return m_data_isSet;
}

bool OAIRegionsResponse::is_data_Valid() const{
    return m_data_isValid;
}

bool OAIRegionsResponse::isSet() const {
...
bool OAIRegionsResponse::isValid() const {
