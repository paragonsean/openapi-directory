...
OAILocalesResponse::OAILocalesResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAILocalesResponse::OAILocalesResponse() {
    this->initializeModel();
}

OAILocalesResponse::~OAILocalesResponse() {}

void OAILocalesResponse::initializeModel() {
...
void OAILocalesResponse::fromJson(QString jsonString) {
...
void OAILocalesResponse::fromJsonObject(QJsonObject json) {
...
QString OAILocalesResponse::asJson() const {
...
QJsonObject OAILocalesResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_errors.size() > 0) {
...
QList<OAIError> OAILocalesResponse::getErrors() const {
    return m_errors;
}
void OAILocalesResponse::setErrors(const QList<OAIError> &errors) {
    m_errors = errors;
    m_errors_isSet = true;
}

bool OAILocalesResponse::is_errors_Set() const{
    return m_errors_isSet;
}

bool OAILocalesResponse::is_errors_Valid() const{
    return m_errors_isValid;
}

QList<OAILink> OAILocalesResponse::getLinks() const {
    return m_links;
}
void OAILocalesResponse::setLinks(const QList<OAILink> &links) {
    m_links = links;
    m_links_isSet = true;
}

bool OAILocalesResponse::is_links_Set() const{
    return m_links_isSet;
}

bool OAILocalesResponse::is_links_Valid() const{
    return m_links_isValid;
}

OAIMetadata OAILocalesResponse::getMetadata() const {
    return m_metadata;
}
void OAILocalesResponse::setMetadata(const OAIMetadata &metadata) {
    m_metadata = metadata;
    m_metadata_isSet = true;
}

bool OAILocalesResponse::is_metadata_Set() const{
    return m_metadata_isSet;
}

bool OAILocalesResponse::is_metadata_Valid() const{
    return m_metadata_isValid;
}

QList<OAILocale> OAILocalesResponse::getData() const {
    return m_data;
}
void OAILocalesResponse::setData(const QList<OAILocale> &data) {
    m_data = data;
    m_data_isSet = true;
}

bool OAILocalesResponse::is_data_Set() const{
    return m_data_isSet;
}

bool OAILocalesResponse::is_data_Valid() const{
    return m_data_isValid;
}

bool OAILocalesResponse::isSet() const {
...
bool OAILocalesResponse::isValid() const {
