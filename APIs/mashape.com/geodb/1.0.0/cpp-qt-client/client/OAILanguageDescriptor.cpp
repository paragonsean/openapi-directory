...
#include "OAILanguageDescriptor.h"
...
OAILanguageDescriptor::OAILanguageDescriptor(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAILanguageDescriptor::OAILanguageDescriptor() {
    this->initializeModel();
}

OAILanguageDescriptor::~OAILanguageDescriptor() {}

void OAILanguageDescriptor::initializeModel() {
...
void OAILanguageDescriptor::fromJson(QString jsonString) {
...
void OAILanguageDescriptor::fromJsonObject(QJsonObject json) {
...
QString OAILanguageDescriptor::asJson() const {
...
QJsonObject OAILanguageDescriptor::asJsonObject() const {
    QJsonObject obj;
    if (m_code_isSet) {
...
QString OAILanguageDescriptor::getCode() const {
    return m_code;
}
void OAILanguageDescriptor::setCode(const QString &code) {
    m_code = code;
    m_code_isSet = true;
}

bool OAILanguageDescriptor::is_code_Set() const{
    return m_code_isSet;
}

bool OAILanguageDescriptor::is_code_Valid() const{
    return m_code_isValid;
}

QString OAILanguageDescriptor::getName() const {
    return m_name;
}
void OAILanguageDescriptor::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAILanguageDescriptor::is_name_Set() const{
    return m_name_isSet;
}

bool OAILanguageDescriptor::is_name_Valid() const{
    return m_name_isValid;
}

bool OAILanguageDescriptor::isSet() const {
...
bool OAILanguageDescriptor::isValid() const {
