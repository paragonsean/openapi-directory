...
OAILanguagesResponse::OAILanguagesResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAILanguagesResponse::OAILanguagesResponse() {
    this->initializeModel();
}

OAILanguagesResponse::~OAILanguagesResponse() {}

void OAILanguagesResponse::initializeModel() {
...
void OAILanguagesResponse::fromJson(QString jsonString) {
...
void OAILanguagesResponse::fromJsonObject(QJsonObject json) {
...
QString OAILanguagesResponse::asJson() const {
...
QJsonObject OAILanguagesResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_errors.size() > 0) {
...
QList<OAIError> OAILanguagesResponse::getErrors() const {
    return m_errors;
}
void OAILanguagesResponse::setErrors(const QList<OAIError> &errors) {
    m_errors = errors;
    m_errors_isSet = true;
}

bool OAILanguagesResponse::is_errors_Set() const{
    return m_errors_isSet;
}

bool OAILanguagesResponse::is_errors_Valid() const{
    return m_errors_isValid;
}

QList<OAILink> OAILanguagesResponse::getLinks() const {
    return m_links;
}
void OAILanguagesResponse::setLinks(const QList<OAILink> &links) {
    m_links = links;
    m_links_isSet = true;
}

bool OAILanguagesResponse::is_links_Set() const{
    return m_links_isSet;
}

bool OAILanguagesResponse::is_links_Valid() const{
    return m_links_isValid;
}

OAIMetadata OAILanguagesResponse::getMetadata() const {
    return m_metadata;
}
void OAILanguagesResponse::setMetadata(const OAIMetadata &metadata) {
    m_metadata = metadata;
    m_metadata_isSet = true;
}

bool OAILanguagesResponse::is_metadata_Set() const{
    return m_metadata_isSet;
}

bool OAILanguagesResponse::is_metadata_Valid() const{
    return m_metadata_isValid;
}

QList<OAILanguageDescriptor> OAILanguagesResponse::getData() const {
    return m_data;
}
void OAILanguagesResponse::setData(const QList<OAILanguageDescriptor> &data) {
    m_data = data;
    m_data_isSet = true;
}

bool OAILanguagesResponse::is_data_Set() const{
    return m_data_isSet;
}

bool OAILanguagesResponse::is_data_Valid() const{
    return m_data_isValid;
}

bool OAILanguagesResponse::isSet() const {
...
bool OAILanguagesResponse::isValid() const {
