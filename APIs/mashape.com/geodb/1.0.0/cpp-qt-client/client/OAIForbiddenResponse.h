...
/*
 * OAIForbiddenResponse.h
 *
 * Forbidden Response
 */

#ifndef OAIForbiddenResponse_H
#define OAIForbiddenResponse_H
...
class OAIForbiddenResponse : public OAIObject {
public:
    OAIForbiddenResponse();
    OAIForbiddenResponse(QString json);
    ~OAIForbiddenResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIForbiddenResponse)

#endif // OAIForbiddenResponse_H
