...
OAIDateTimeResponse::OAIDateTimeResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDateTimeResponse::OAIDateTimeResponse() {
    this->initializeModel();
}

OAIDateTimeResponse::~OAIDateTimeResponse() {}

void OAIDateTimeResponse::initializeModel() {
...
void OAIDateTimeResponse::fromJson(QString jsonString) {
...
void OAIDateTimeResponse::fromJsonObject(QJsonObject json) {
...
QString OAIDateTimeResponse::asJson() const {
...
QJsonObject OAIDateTimeResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_errors.size() > 0) {
...
QList<OAIError> OAIDateTimeResponse::getErrors() const {
    return m_errors;
}
void OAIDateTimeResponse::setErrors(const QList<OAIError> &errors) {
    m_errors = errors;
    m_errors_isSet = true;
}

bool OAIDateTimeResponse::is_errors_Set() const{
    return m_errors_isSet;
}

bool OAIDateTimeResponse::is_errors_Valid() const{
    return m_errors_isValid;
}

QDateTime OAIDateTimeResponse::getData() const {
    return m_data;
}
void OAIDateTimeResponse::setData(const QDateTime &data) {
    m_data = data;
    m_data_isSet = true;
}

bool OAIDateTimeResponse::is_data_Set() const{
    return m_data_isSet;
}

bool OAIDateTimeResponse::is_data_Valid() const{
    return m_data_isValid;
}

bool OAIDateTimeResponse::isSet() const {
...
bool OAIDateTimeResponse::isValid() const {
