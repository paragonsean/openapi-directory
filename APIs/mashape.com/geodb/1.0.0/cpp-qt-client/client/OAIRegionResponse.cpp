...
OAIRegionResponse::OAIRegionResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIRegionResponse::OAIRegionResponse() {
    this->initializeModel();
}

OAIRegionResponse::~OAIRegionResponse() {}

void OAIRegionResponse::initializeModel() {
...
void OAIRegionResponse::fromJson(QString jsonString) {
...
void OAIRegionResponse::fromJsonObject(QJsonObject json) {
...
QString OAIRegionResponse::asJson() const {
...
QJsonObject OAIRegionResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_errors.size() > 0) {
...
QList<OAIError> OAIRegionResponse::getErrors() const {
    return m_errors;
}
void OAIRegionResponse::setErrors(const QList<OAIError> &errors) {
    m_errors = errors;
    m_errors_isSet = true;
}

bool OAIRegionResponse::is_errors_Set() const{
    return m_errors_isSet;
}

bool OAIRegionResponse::is_errors_Valid() const{
    return m_errors_isValid;
}

OAIRegionDetails OAIRegionResponse::getData() const {
    return m_data;
}
void OAIRegionResponse::setData(const OAIRegionDetails &data) {
    m_data = data;
    m_data_isSet = true;
}

bool OAIRegionResponse::is_data_Set() const{
    return m_data_isSet;
}

bool OAIRegionResponse::is_data_Valid() const{
    return m_data_isValid;
}

bool OAIRegionResponse::isSet() const {
...
bool OAIRegionResponse::isValid() const {
