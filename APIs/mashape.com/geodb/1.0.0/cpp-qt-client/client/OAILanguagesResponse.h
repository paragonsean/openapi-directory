...
/*
 * OAILanguagesResponse.h
 *
 * A list of languages supported by the system
 */

#ifndef OAILanguagesResponse_H
#define OAILanguagesResponse_H
...
class OAILink;
class OAIMetadata;
class OAILanguageDescriptor;

class OAILanguagesResponse : public OAIObject {
public:
    OAILanguagesResponse();
    OAILanguagesResponse(QString json);
    ~OAILanguagesResponse() override;
    ...
    QList<OAILanguageDescriptor> getData() const;
    void setData(const QList<OAILanguageDescriptor> &data);
...
private:
    ...
    QList<OAILanguageDescriptor> m_data;
    bool m_data_isSet;
    bool m_data_isValid;
};
...
Q_DECLARE_METATYPE(OpenAPI::OAILanguagesResponse)

#endif // OAILanguagesResponse_H
