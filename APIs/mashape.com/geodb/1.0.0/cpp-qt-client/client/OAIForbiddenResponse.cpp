...
OAIForbiddenResponse::OAIForbiddenResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIForbiddenResponse::OAIForbiddenResponse() {
    this->initializeModel();
}

OAIForbiddenResponse::~OAIForbiddenResponse() {}

void OAIForbiddenResponse::initializeModel() {

    m_errors_isSet = false;
    m_errors_isValid = false;
}

void OAIForbiddenResponse::fromJson(QString jsonString) {
...
void OAIForbiddenResponse::fromJsonObject(QJsonObject json) {

    m_errors_isValid = ::OpenAPI::fromJsonValue(m_errors, json[QString("errors")]);
    m_errors_isSet = !json[QString("errors")].isNull() && m_errors_isValid;
}

QString OAIForbiddenResponse::asJson() const {
...
QJsonObject OAIForbiddenResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_errors.size() > 0) {
...
QList<OAIError> OAIForbiddenResponse::getErrors() const {
    return m_errors;
}
void OAIForbiddenResponse::setErrors(const QList<OAIError> &errors) {
    m_errors = errors;
    m_errors_isSet = true;
}

bool OAIForbiddenResponse::is_errors_Set() const{
    return m_errors_isSet;
}

bool OAIForbiddenResponse::is_errors_Valid() const{
    return m_errors_isValid;
}

bool OAIForbiddenResponse::isSet() const {
...
bool OAIForbiddenResponse::isValid() const {
