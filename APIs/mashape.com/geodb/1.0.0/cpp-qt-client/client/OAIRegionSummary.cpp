...
QString OAIRegionSummary::getCountryCode() const {
    return m_country_code;
}
void OAIRegionSummary::setCountryCode(const QString &country_code) {
    m_country_code = country_code;
    m_country_code_isSet = true;
}

bool OAIRegionSummary::is_country_code_Set() const{
    return m_country_code_isSet;
}

bool OAIRegionSummary::is_country_code_Valid() const{
    return m_country_code_isValid;
}

QString OAIRegionSummary::getFipsCode() const {
    return m_fips_code;
}
void OAIRegionSummary::setFipsCode(const QString &fips_code) {
    m_fips_code = fips_code;
    m_fips_code_isSet = true;
}

bool OAIRegionSummary::is_fips_code_Set() const{
    return m_fips_code_isSet;
}

bool OAIRegionSummary::is_fips_code_Valid() const{
    return m_fips_code_isValid;
}

QString OAIRegionSummary::getIsoCode() const {
    return m_iso_code;
}
void OAIRegionSummary::setIsoCode(const QString &iso_code) {
    m_iso_code = iso_code;
    m_iso_code_isSet = true;
}

bool OAIRegionSummary::is_iso_code_Set() const{
    return m_iso_code_isSet;
}

bool OAIRegionSummary::is_iso_code_Valid() const{
...
QString OAIRegionSummary::getWikiDataId() const {
    return m_wiki_data_id;
}
void OAIRegionSummary::setWikiDataId(const QString &wiki_data_id) {
    m_wiki_data_id = wiki_data_id;
    m_wiki_data_id_isSet = true;
}

bool OAIRegionSummary::is_wiki_data_id_Set() const{
    return m_wiki_data_id_isSet;
}

bool OAIRegionSummary::is_wiki_data_id_Valid() const{
