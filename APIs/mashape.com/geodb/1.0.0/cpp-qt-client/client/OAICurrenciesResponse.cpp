...
QList<OAIError> OAICurrenciesResponse::getErrors() const {
    return m_errors;
}
void OAICurrenciesResponse::setErrors(const QList<OAIError> &errors) {
    m_errors = errors;
    m_errors_isSet = true;
}

bool OAICurrenciesResponse::is_errors_Set() const{
    return m_errors_isSet;
}

bool OAICurrenciesResponse::is_errors_Valid() const{
    return m_errors_isValid;
}

QList<OAILink> OAICurrenciesResponse::getLinks() const {
    return m_links;
}
void OAICurrenciesResponse::setLinks(const QList<OAILink> &links) {
    m_links = links;
    m_links_isSet = true;
}
...
OAIMetadata OAICurrenciesResponse::getMetadata() const {
    return m_metadata;
}
void OAICurrenciesResponse::setMetadata(const OAIMetadata &metadata) {
    m_metadata = metadata;
    m_metadata_isSet = true;
}

bool OAICurrenciesResponse::is_metadata_Set() const{
    return m_metadata_isSet;
}

bool OAICurrenciesResponse::is_metadata_Valid() const{
