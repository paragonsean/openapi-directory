...
/*
 * OAIPopulatedPlaceResponse.h
 *
 * Populated-place details response
 */

#ifndef OAIPopulatedPlaceResponse_H
#define OAIPopulatedPlaceResponse_H
...
namespace OpenAPI {
class OAIError;
class OAIPopulatedPlaceDetails;

class OAIPopulatedPlaceResponse : public OAIObject {
public:
    OAIPopulatedPlaceResponse();
    OAIPopulatedPlaceResponse(QString json);
    ~OAIPopulatedPlaceResponse() override;
    ...
    OAIPopulatedPlaceDetails getData() const;
    void setData(const OAIPopulatedPlaceDetails &data);
...
private:
    ...
    OAIPopulatedPlaceDetails m_data;
    bool m_data_isSet;
    bool m_data_isValid;
};
...
Q_DECLARE_METATYPE(OpenAPI::OAIPopulatedPlaceResponse)

#endif // OAIPopulatedPlaceResponse_H
