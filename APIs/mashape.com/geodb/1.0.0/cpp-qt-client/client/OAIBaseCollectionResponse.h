...
/*
 * OAIBaseCollectionResponse.h
 *
 * Common properties for all collection  responses
 */

#ifndef OAIBaseCollectionResponse_H
#define OAIBaseCollectionResponse_H
...
class OAIBaseCollectionResponse : public OAIObject {
public:
    OAIBaseCollectionResponse();
    OAIBaseCollectionResponse(QString json);
    ~OAIBaseCollectionResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBaseCollectionResponse)

#endif // OAIBaseCollectionResponse_H
