...
/*
 * OAITimeZonesResponse.h
 *
 * A list of time-zones
 */

#ifndef OAITimeZonesResponse_H
#define OAITimeZonesResponse_H
...
class OAILink;
class OAIMetadata;
class OAITimeZoneDescriptor;

class OAITimeZonesResponse : public OAIObject {
public:
    OAITimeZonesResponse();
    OAITimeZonesResponse(QString json);
    ~OAITimeZonesResponse() override;
    ...
    QList<OAITimeZoneDescriptor> getData() const;
    void setData(const QList<OAITimeZoneDescriptor> &data);
...
private:
    ...
    QList<OAITimeZoneDescriptor> m_data;
    bool m_data_isSet;
    bool m_data_isValid;
};
...
Q_DECLARE_METATYPE(OpenAPI::OAITimeZonesResponse)

#endif // OAITimeZonesResponse_H
