...
#ifndef OAIRegionResponse_H
#define OAIRegionResponse_H
...
namespace OpenAPI {
class OAIError;
class OAIRegionDetails;

class OAIRegionResponse : public OAIObject {
public:
    OAIRegionResponse();
    OAIRegionResponse(QString json);
    ~OAIRegionResponse() override;
    ...
    OAIRegionDetails getData() const;
    void setData(const OAIRegionDetails &data);
...
Q_DECLARE_METATYPE(OpenAPI::OAIRegionResponse)

#endif // OAIRegionResponse_H
