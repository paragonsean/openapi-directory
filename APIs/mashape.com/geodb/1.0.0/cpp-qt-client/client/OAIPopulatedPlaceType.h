...
class OAIPopulatedPlaceType : public OAIEnum {
public:
    OAIPopulatedPlaceType();
    OAIPopulatedPlaceType(QString json);
    ~OAIPopulatedPlaceType() override;
    ...
    enum class eOAIPopulatedPlaceType {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        ADM2, 
        CITY
    };
    OAIPopulatedPlaceType::eOAIPopulatedPlaceType getValue() const;
    void setValue(const OAIPopulatedPlaceType::eOAIPopulatedPlaceType& value);
...
private:
    ...
    eOAIPopulatedPlaceType m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPopulatedPlaceType)

#endif // OAIPopulatedPlaceType_H
