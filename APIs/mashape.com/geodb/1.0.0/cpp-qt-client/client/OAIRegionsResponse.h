...
/*
 * OAIRegionsResponse.h
 *
 * A list of country regions
 */

#ifndef OAIRegionsResponse_H
#define OAIRegionsResponse_H
...
class OAIRegionsResponse : public OAIObject {
public:
    OAIRegionsResponse();
    OAIRegionsResponse(QString json);
    ~OAIRegionsResponse() override;
    ...
    QList<OAIRegionSummary> getData() const;
    void setData(const QList<OAIRegionSummary> &data);
...
Q_DECLARE_METATYPE(OpenAPI::OAIRegionsResponse)

#endif // OAIRegionsResponse_H
