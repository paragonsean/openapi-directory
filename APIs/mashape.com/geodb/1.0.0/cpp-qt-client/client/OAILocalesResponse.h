...
/*
 * OAILocalesResponse.h
 *
 * A list of locales
 */

#ifndef OAILocalesResponse_H
#define OAILocalesResponse_H
...
class OAILocalesResponse : public OAIObject {
public:
    OAILocalesResponse();
    OAILocalesResponse(QString json);
    ~OAILocalesResponse() override;
    ...
    QList<OAILocale> getData() const;
    void setData(const QList<OAILocale> &data);
...
Q_DECLARE_METATYPE(OpenAPI::OAILocalesResponse)

#endif // OAILocalesResponse_H
