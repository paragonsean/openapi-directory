...
OAIPopulatedPlacesResponse::OAIPopulatedPlacesResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPopulatedPlacesResponse::OAIPopulatedPlacesResponse() {
    this->initializeModel();
}

OAIPopulatedPlacesResponse::~OAIPopulatedPlacesResponse() {}

void OAIPopulatedPlacesResponse::initializeModel() {
...
void OAIPopulatedPlacesResponse::fromJson(QString jsonString) {
...
void OAIPopulatedPlacesResponse::fromJsonObject(QJsonObject json) {
...
QString OAIPopulatedPlacesResponse::asJson() const {
...
QJsonObject OAIPopulatedPlacesResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_errors.size() > 0) {
...
QList<OAIError> OAIPopulatedPlacesResponse::getErrors() const {
    return m_errors;
}
void OAIPopulatedPlacesResponse::setErrors(const QList<OAIError> &errors) {
    m_errors = errors;
    m_errors_isSet = true;
}

bool OAIPopulatedPlacesResponse::is_errors_Set() const{
    return m_errors_isSet;
}

bool OAIPopulatedPlacesResponse::is_errors_Valid() const{
    return m_errors_isValid;
}

QList<OAILink> OAIPopulatedPlacesResponse::getLinks() const {
    return m_links;
}
void OAIPopulatedPlacesResponse::setLinks(const QList<OAILink> &links) {
    m_links = links;
    m_links_isSet = true;
}

bool OAIPopulatedPlacesResponse::is_links_Set() const{
    return m_links_isSet;
}

bool OAIPopulatedPlacesResponse::is_links_Valid() const{
    return m_links_isValid;
}

OAIMetadata OAIPopulatedPlacesResponse::getMetadata() const {
    return m_metadata;
}
void OAIPopulatedPlacesResponse::setMetadata(const OAIMetadata &metadata) {
    m_metadata = metadata;
    m_metadata_isSet = true;
}

bool OAIPopulatedPlacesResponse::is_metadata_Set() const{
    return m_metadata_isSet;
}

bool OAIPopulatedPlacesResponse::is_metadata_Valid() const{
    return m_metadata_isValid;
}

QList<OAIPopulatedPlaceSummary> OAIPopulatedPlacesResponse::getData() const {
    return m_data;
}
void OAIPopulatedPlacesResponse::setData(const QList<OAIPopulatedPlaceSummary> &data) {
    m_data = data;
    m_data_isSet = true;
}

bool OAIPopulatedPlacesResponse::is_data_Set() const{
    return m_data_isSet;
}

bool OAIPopulatedPlacesResponse::is_data_Valid() const{
    return m_data_isValid;
}

bool OAIPopulatedPlacesResponse::isSet() const {
...
bool OAIPopulatedPlacesResponse::isValid() const {
