...
QList<OAIError> OAIBaseResponse::getErrors() const {
    return m_errors;
}
void OAIBaseResponse::setErrors(const QList<OAIError> &errors) {
    m_errors = errors;
    m_errors_isSet = true;
}

bool OAIBaseResponse::is_errors_Set() const{
    return m_errors_isSet;
}

bool OAIBaseResponse::is_errors_Valid() const{
