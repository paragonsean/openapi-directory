...
/*
 * OAICountryResponse.h
 *
 * Country details response
 */

#ifndef OAICountryResponse_H
#define OAICountryResponse_H
...
namespace OpenAPI {
class OAIError;
class OAICountryDetails;

class OAICountryResponse : public OAIObject {
public:
    OAICountryResponse();
    OAICountryResponse(QString json);
    ~OAICountryResponse() override;
    ...
    OAICountryDetails getData() const;
    void setData(const OAICountryDetails &data);
...
Q_DECLARE_METATYPE(OpenAPI::OAICountryResponse)

#endif // OAICountryResponse_H
