...
/*
 * OAIPopulatedPlaceSummary.h
 *
 * Minimal populated-place info
 */

#ifndef OAIPopulatedPlaceSummary_H
#define OAIPopulatedPlaceSummary_H
...
class OAIPopulatedPlaceSummary : public OAIObject {
public:
    OAIPopulatedPlaceSummary();
    OAIPopulatedPlaceSummary(QString json);
    ~OAIPopulatedPlaceSummary() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPopulatedPlaceSummary)

#endif // OAIPopulatedPlaceSummary_H
