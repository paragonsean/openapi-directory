...
QList<OAIError> OAICountriesResponse::getErrors() const {
    return m_errors;
}
void OAICountriesResponse::setErrors(const QList<OAIError> &errors) {
    m_errors = errors;
    m_errors_isSet = true;
}

bool OAICountriesResponse::is_errors_Set() const{
    return m_errors_isSet;
}

bool OAICountriesResponse::is_errors_Valid() const{
    return m_errors_isValid;
}

QList<OAILink> OAICountriesResponse::getLinks() const {
    return m_links;
}
void OAICountriesResponse::setLinks(const QList<OAILink> &links) {
    m_links = links;
    m_links_isSet = true;
}

bool OAICountriesResponse::is_links_Set() const{
    return m_links_isSet;
}

bool OAICountriesResponse::is_links_Valid() const{
    return m_links_isValid;
}

OAIMetadata OAICountriesResponse::getMetadata() const {
    return m_metadata;
}
void OAICountriesResponse::setMetadata(const OAIMetadata &metadata) {
    m_metadata = metadata;
    m_metadata_isSet = true;
}

bool OAICountriesResponse::is_metadata_Set() const{
    return m_metadata_isSet;
}

bool OAICountriesResponse::is_metadata_Valid() const{
    return m_metadata_isValid;
}

QList<OAICountrySummary> OAICountriesResponse::getData() const {
    return m_data;
}
void OAICountriesResponse::setData(const QList<OAICountrySummary> &data) {
    m_data = data;
    m_data_isSet = true;
}

bool OAICountriesResponse::is_data_Set() const{
    return m_data_isSet;
}

bool OAICountriesResponse::is_data_Valid() const{
