...
#ifndef OAITimeResponse_H
#define OAITimeResponse_H
...
class OAITimeResponse : public OAIObject {
public:
    OAITimeResponse();
    OAITimeResponse(QString json);
    ~OAITimeResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITimeResponse)

#endif // OAITimeResponse_H
