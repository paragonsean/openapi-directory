...
qint64 OAIMetadata::getCurrentOffset() const {
    return m_current_offset;
}
void OAIMetadata::setCurrentOffset(const qint64 &current_offset) {
    m_current_offset = current_offset;
    m_current_offset_isSet = true;
}

bool OAIMetadata::is_current_offset_Set() const{
    return m_current_offset_isSet;
}

bool OAIMetadata::is_current_offset_Valid() const{
    return m_current_offset_isValid;
}

qint64 OAIMetadata::getTotalCount() const {
    return m_total_count;
}
void OAIMetadata::setTotalCount(const qint64 &total_count) {
    m_total_count = total_count;
    m_total_count_isSet = true;
}

bool OAIMetadata::is_total_count_Set() const{
    return m_total_count_isSet;
}

bool OAIMetadata::is_total_count_Valid() const{
