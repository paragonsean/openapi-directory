...
/*
 * OAILanguageDescriptor.h
 *
 * A language supported by the service
 */

#ifndef OAILanguageDescriptor_H
#define OAILanguageDescriptor_H
...
class OAILanguageDescriptor : public OAIObject {
public:
    OAILanguageDescriptor();
    OAILanguageDescriptor(QString json);
    ~OAILanguageDescriptor() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILanguageDescriptor)

#endif // OAILanguageDescriptor_H
