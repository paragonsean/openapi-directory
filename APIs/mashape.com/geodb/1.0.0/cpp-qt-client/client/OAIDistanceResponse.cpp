...
OAIDistanceResponse::OAIDistanceResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDistanceResponse::OAIDistanceResponse() {
    this->initializeModel();
}

OAIDistanceResponse::~OAIDistanceResponse() {}

void OAIDistanceResponse::initializeModel() {
...
void OAIDistanceResponse::fromJson(QString jsonString) {
...
void OAIDistanceResponse::fromJsonObject(QJsonObject json) {
...
QString OAIDistanceResponse::asJson() const {
...
QJsonObject OAIDistanceResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_errors.size() > 0) {
...
QList<OAIError> OAIDistanceResponse::getErrors() const {
    return m_errors;
}
void OAIDistanceResponse::setErrors(const QList<OAIError> &errors) {
    m_errors = errors;
    m_errors_isSet = true;
}

bool OAIDistanceResponse::is_errors_Set() const{
    return m_errors_isSet;
}

bool OAIDistanceResponse::is_errors_Valid() const{
    return m_errors_isValid;
}

double OAIDistanceResponse::getData() const {
    return m_data;
}
void OAIDistanceResponse::setData(const double &data) {
    m_data = data;
    m_data_isSet = true;
}

bool OAIDistanceResponse::is_data_Set() const{
    return m_data_isSet;
}

bool OAIDistanceResponse::is_data_Valid() const{
    return m_data_isValid;
}

bool OAIDistanceResponse::isSet() const {
...
bool OAIDistanceResponse::isValid() const {
