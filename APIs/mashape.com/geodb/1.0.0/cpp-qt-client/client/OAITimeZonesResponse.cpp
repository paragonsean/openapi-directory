...
OAITimeZonesResponse::OAITimeZonesResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAITimeZonesResponse::OAITimeZonesResponse() {
    this->initializeModel();
}

OAITimeZonesResponse::~OAITimeZonesResponse() {}

void OAITimeZonesResponse::initializeModel() {
...
void OAITimeZonesResponse::fromJson(QString jsonString) {
...
void OAITimeZonesResponse::fromJsonObject(QJsonObject json) {
...
QString OAITimeZonesResponse::asJson() const {
...
QJsonObject OAITimeZonesResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_errors.size() > 0) {
...
QList<OAIError> OAITimeZonesResponse::getErrors() const {
    return m_errors;
}
void OAITimeZonesResponse::setErrors(const QList<OAIError> &errors) {
    m_errors = errors;
    m_errors_isSet = true;
}

bool OAITimeZonesResponse::is_errors_Set() const{
    return m_errors_isSet;
}

bool OAITimeZonesResponse::is_errors_Valid() const{
    return m_errors_isValid;
}

QList<OAILink> OAITimeZonesResponse::getLinks() const {
    return m_links;
}
void OAITimeZonesResponse::setLinks(const QList<OAILink> &links) {
    m_links = links;
    m_links_isSet = true;
}

bool OAITimeZonesResponse::is_links_Set() const{
    return m_links_isSet;
}

bool OAITimeZonesResponse::is_links_Valid() const{
    return m_links_isValid;
}

OAIMetadata OAITimeZonesResponse::getMetadata() const {
    return m_metadata;
}
void OAITimeZonesResponse::setMetadata(const OAIMetadata &metadata) {
    m_metadata = metadata;
    m_metadata_isSet = true;
}

bool OAITimeZonesResponse::is_metadata_Set() const{
    return m_metadata_isSet;
}

bool OAITimeZonesResponse::is_metadata_Valid() const{
    return m_metadata_isValid;
}

QList<OAITimeZoneDescriptor> OAITimeZonesResponse::getData() const {
    return m_data;
}
void OAITimeZonesResponse::setData(const QList<OAITimeZoneDescriptor> &data) {
    m_data = data;
    m_data_isSet = true;
}

bool OAITimeZonesResponse::is_data_Set() const{
    return m_data_isSet;
}

bool OAITimeZonesResponse::is_data_Valid() const{
    return m_data_isValid;
}

bool OAITimeZonesResponse::isSet() const {
...
bool OAITimeZonesResponse::isValid() const {
