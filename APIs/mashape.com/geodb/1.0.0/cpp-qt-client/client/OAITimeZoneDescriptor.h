...
/*
 * OAITimeZoneDescriptor.h
 *
 * A time-zone
 */

#ifndef OAITimeZoneDescriptor_H
#define OAITimeZoneDescriptor_H
...
class OAITimeZoneDescriptor : public OAIObject {
public:
    OAITimeZoneDescriptor();
    OAITimeZoneDescriptor(QString json);
    ~OAITimeZoneDescriptor() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITimeZoneDescriptor)

#endif // OAITimeZoneDescriptor_H
