...
QList<OAIError> OAINotFoundResponse::getErrors() const {
    return m_errors;
}
void OAINotFoundResponse::setErrors(const QList<OAIError> &errors) {
    m_errors = errors;
    m_errors_isSet = true;
}

bool OAINotFoundResponse::is_errors_Set() const{
    return m_errors_isSet;
}

bool OAINotFoundResponse::is_errors_Valid() const{
