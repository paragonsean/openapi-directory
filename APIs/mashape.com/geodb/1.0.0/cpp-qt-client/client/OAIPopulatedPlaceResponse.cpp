...
OAIPopulatedPlaceResponse::OAIPopulatedPlaceResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPopulatedPlaceResponse::OAIPopulatedPlaceResponse() {
    this->initializeModel();
}

OAIPopulatedPlaceResponse::~OAIPopulatedPlaceResponse() {}

void OAIPopulatedPlaceResponse::initializeModel() {
...
void OAIPopulatedPlaceResponse::fromJson(QString jsonString) {
...
void OAIPopulatedPlaceResponse::fromJsonObject(QJsonObject json) {
...
QString OAIPopulatedPlaceResponse::asJson() const {
...
QJsonObject OAIPopulatedPlaceResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_errors.size() > 0) {
...
QList<OAIError> OAIPopulatedPlaceResponse::getErrors() const {
    return m_errors;
}
void OAIPopulatedPlaceResponse::setErrors(const QList<OAIError> &errors) {
    m_errors = errors;
    m_errors_isSet = true;
}

bool OAIPopulatedPlaceResponse::is_errors_Set() const{
    return m_errors_isSet;
}

bool OAIPopulatedPlaceResponse::is_errors_Valid() const{
    return m_errors_isValid;
}

OAIPopulatedPlaceDetails OAIPopulatedPlaceResponse::getData() const {
    return m_data;
}
void OAIPopulatedPlaceResponse::setData(const OAIPopulatedPlaceDetails &data) {
    m_data = data;
    m_data_isSet = true;
}

bool OAIPopulatedPlaceResponse::is_data_Set() const{
    return m_data_isSet;
}

bool OAIPopulatedPlaceResponse::is_data_Valid() const{
    return m_data_isValid;
}

bool OAIPopulatedPlaceResponse::isSet() const {
...
bool OAIPopulatedPlaceResponse::isValid() const {
