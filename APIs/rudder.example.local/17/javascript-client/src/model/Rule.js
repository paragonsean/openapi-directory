...
import DirectiveTagsInner from './DirectiveTagsInner';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('tags')) {
                obj['tags'] = ApiClient.convertToType(data['tags'], [DirectiveTagsInner]);
            }
            if (data.hasOwnProperty('targets')) {
                obj['targets'] = ApiClient.convertToType(data['targets'], [RuleTargetsInner]);
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        if (data['tags']) { // data not null
            ...
            for (const item of data['tags']) {
                DirectiveTagsInner.validateJSON(item);
            };
        }
        if (data['targets']) { // data not null
            ...
            for (const item of data['targets']) {
                RuleTargetsInner.validateJSON(item);
            };
        }
 ...
 */
Rule.prototype['directives'] = undefined;
 ...
 */
Rule.prototype['longDescription'] = undefined;

/**
 * One line rule description
 * @member {String} shortDescription
 */
Rule.prototype['shortDescription'] = undefined;

/**
 * If true it is an internal Rudder rule
 * @member {Boolean} system
 */
Rule.prototype['system'] = undefined;

/**
 * @member {Array.<module:model/DirectiveTagsInner>} tags
 */
Rule.prototype['tags'] = undefined;

/**
 * Node and special groups targeted by that rule
 * @member {Array.<module:model/RuleTargetsInner>} targets
 */
Rule.prototype['targets'] = undefined;
