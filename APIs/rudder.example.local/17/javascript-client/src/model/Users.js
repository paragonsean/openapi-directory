...
class Users {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('isPreHahed')) {
                obj['isPreHahed'] = ApiClient.convertToType(data['isPreHahed'], 'Boolean');
            }
 ...
 * @member {Boolean} isPreHahed
 */
Users.prototype['isPreHahed'] = undefined;
 ...
 */
Users.prototype['role'] = undefined;
