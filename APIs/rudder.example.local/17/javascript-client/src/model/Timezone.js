...
class Timezone {
     ...
     * @param name {String} The standard name of the timezone
     * @param offset {String} Timezone offset compared to UTC, in +/-HHMM format
     */
    constructor(name, offset) { 
        
        Timezone.initialize(this, name, offset);
    }
...
Timezone.RequiredProperties = ["name", "offset"];
