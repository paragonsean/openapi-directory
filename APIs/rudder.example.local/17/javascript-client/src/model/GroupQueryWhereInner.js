...
/**
 * The GroupQueryWhereInner model module.
 * @module model/GroupQueryWhereInner
 * @version 17
 */
class GroupQueryWhereInner {
    /**
     * Constructs a new <code>GroupQueryWhereInner</code>.
     * @alias module:model/GroupQueryWhereInner
     */
    constructor() { 
        
        GroupQueryWhereInner.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GroupQueryWhereInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GroupQueryWhereInner} obj Optional instance to populate.
     * @return {module:model/GroupQueryWhereInner} The populated <code>GroupQueryWhereInner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GroupQueryWhereInner();
    ...
    /**
     * Validates the JSON data with respect to <code>GroupQueryWhereInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GroupQueryWhereInner</code>.
     */
 ...
 */
GroupQueryWhereInner.prototype['attribute'] = undefined;

/**
 * Comparator to use
 * @member {String} comparator
 */
GroupQueryWhereInner.prototype['comparator'] = undefined;

/**
 * Type of the object
 * @member {String} objectType
 */
GroupQueryWhereInner.prototype['objectType'] = undefined;

/**
 * Value to compare against
 * @member {String} value
 */
GroupQueryWhereInner.prototype['value'] = undefined;
...
export default GroupQueryWhereInner;
