...
/**
 * The NodeFullNetworkInterfacesInner model module.
 * @module model/NodeFullNetworkInterfacesInner
 * @version 17
 */
class NodeFullNetworkInterfacesInner {
    /**
     * Constructs a new <code>NodeFullNetworkInterfacesInner</code>.
     * @alias module:model/NodeFullNetworkInterfacesInner
     */
    constructor() { 
        
        NodeFullNetworkInterfacesInner.initialize(this);
    }
    ...
    /**
     * Constructs a <code>NodeFullNetworkInterfacesInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/NodeFullNetworkInterfacesInner} obj Optional instance to populate.
     * @return {module:model/NodeFullNetworkInterfacesInner} The populated <code>NodeFullNetworkInterfacesInner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new NodeFullNetworkInterfacesInner();
    ...
    /**
     * Validates the JSON data with respect to <code>NodeFullNetworkInterfacesInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>NodeFullNetworkInterfacesInner</code>.
     */
    static validateJSON(data) {
        ...
        if (!Array.isArray(data['mask'])) {
            throw new Error("Expected the field `mask` to be an array in the JSON data but got " + data['mask']);
        }
        // ensure the json data is a string
 ...
 */
NodeFullNetworkInterfacesInner.prototype['dhcpServer'] = undefined;

/**
 * IP addresses of the network interface
 * @member {Array.<String>} ipAddresses
 */
NodeFullNetworkInterfacesInner.prototype['ipAddresses'] = undefined;

/**
 * MAC address of the network interface
 * @member {String} macAddress
 */
NodeFullNetworkInterfacesInner.prototype['macAddress'] = undefined;

/**
 * @member {Array.<String>} mask
 */
NodeFullNetworkInterfacesInner.prototype['mask'] = undefined;

/**
 * Interface name (for ex \"eth0\")
 * @member {String} name
 */
NodeFullNetworkInterfacesInner.prototype['name'] = undefined;

/**
 * Information about synchronization speed
 * @member {String} speed
 */
NodeFullNetworkInterfacesInner.prototype['speed'] = undefined;

/**
 * network interface status (enabled or not, up or down)
 * @member {String} status
 */
NodeFullNetworkInterfacesInner.prototype['status'] = undefined;

/**
 * Information about the type of network interface
 * @member {String} type
 */
NodeFullNetworkInterfacesInner.prototype['type'] = undefined;
...
export default NodeFullNetworkInterfacesInner;
