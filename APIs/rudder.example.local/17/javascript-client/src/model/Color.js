...
class Color {
     ...
     * @param alpha {Number} percentage of opacity
     * @param blue {Number} percentage of blue component
     * @param green {Number} percentage of green component
     * @param red {Number} percentage of red component
     */
    constructor(alpha, blue, green, red) { 
        
        Color.initialize(this, alpha, blue, green, red);
    }
     ...
     */
    static initialize(obj, alpha, blue, green, red) { 
        obj['alpha'] = alpha;
        obj['blue'] = blue;
        obj['green'] = green;
        obj['red'] = red;
...
Color.RequiredProperties = ["alpha", "blue", "green", "red"];
