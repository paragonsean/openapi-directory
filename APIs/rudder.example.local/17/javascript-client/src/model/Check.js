...
class Check {
     ...
     * @param msg {String} Message about the check
     * @param name {String} Name of the check
     * @param status {module:model/Check.StatusEnum} The severity status of the check
     */
    constructor(msg, name, status) { 
        
        Check.initialize(this, msg, name, status);
    }
     ...
     */
    static initialize(obj, msg, name, status) { 
        obj['msg'] = msg;
        obj['name'] = name;
        obj['status'] = status;
    }
...
Check.RequiredProperties = ["msg", "name", "status"];

/**
 * Message about the check
 * @member {String} msg
 */
Check.prototype['msg'] = undefined;
