...
import GroupQueryWhereInner from './GroupQueryWhereInner';
...
class GroupQuery {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('where')) {
                obj['where'] = ApiClient.convertToType(data['where'], [GroupQueryWhereInner]);
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        if (data['composition'] && !(typeof data['composition'] === 'string' || data['composition'] instanceof String)) {
            throw new Error("Expected the field `composition` to be a primitive type in the JSON string but got " + data['composition']);
        }
        // ensure the json data is a string
        ...
        if (data['where']) { // data not null
            ...
            for (const item of data['where']) {
                GroupQueryWhereInner.validateJSON(item);
            };
        }
 ...
 * @member {module:model/GroupQuery.CompositionEnum} composition
 * @default 'and'
 */
GroupQuery.prototype['composition'] = 'and';
 ...
 * @default 'node'
 */
GroupQuery.prototype['select'] = 'node';

/**
 * List of criteria
 * @member {Array.<module:model/GroupQueryWhereInner>} where
 */
GroupQuery.prototype['where'] = undefined;
