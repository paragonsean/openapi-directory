...
class Logo {
     ...
     * @param enable {Boolean} Whether the wide logo is displayed or not
     */
    constructor(enable) { 
        
        Logo.initialize(this, enable);
    }
...
Logo.RequiredProperties = ["enable"];

/**
 * Whether the wide logo is displayed or not
 * @member {Boolean} enable
 */
Logo.prototype['enable'] = undefined;
