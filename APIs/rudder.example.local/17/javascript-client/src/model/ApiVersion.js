...
import ApiVersionAllInner from './ApiVersionAllInner';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('all')) {
                obj['all'] = ApiClient.convertToType(data['all'], [ApiVersionAllInner]);
            }
    ...
    static validateJSON(data) {
        if (data['all']) { // data not null
            ...
            for (const item of data['all']) {
                ApiVersionAllInner.validateJSON(item);
            };
        }
 ...
 * @member {Array.<module:model/ApiVersionAllInner>} all
 */
ApiVersion.prototype['all'] = undefined;

/**
 * Latest API version available
 * @member {Number} latest
 */
ApiVersion.prototype['latest'] = undefined;
