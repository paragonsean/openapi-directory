...
/**
 * The NodeAddInner model module.
 * @module model/NodeAddInner
 * @version 17
 */
class NodeAddInner {
    /**
     * Constructs a new <code>NodeAddInner</code>.
     * @alias module:model/NodeAddInner
     * @param hostname {String} The fully qualified name of the node
     * @param id {String} The Rudder node unique identifier in /opt/rudder/etc/uuid.hive
     * @param ipAddresses {Array.<String>} an array of IPs.
     * @param machineType {module:model/NodeAddInner.MachineTypeEnum} The kind of machine for the node (use vm for a generic VM)
     ...
     * @param status {module:model/NodeAddInner.StatusEnum} Target status of the node
     */
    constructor(hostname, id, ipAddresses, machineType, os, properties, status) { 
        
        NodeAddInner.initialize(this, hostname, id, ipAddresses, machineType, os, properties, status);
    }
     ...
     */
    static initialize(obj, hostname, id, ipAddresses, machineType, os, properties, status) { 
    ...
    /**
     * Constructs a <code>NodeAddInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/NodeAddInner} obj Optional instance to populate.
     * @return {module:model/NodeAddInner} The populated <code>NodeAddInner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new NodeAddInner();
    ...
    /**
     * Validates the JSON data with respect to <code>NodeAddInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>NodeAddInner</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of NodeAddInner.RequiredProperties) {
...
NodeAddInner.RequiredProperties = ["hostname", "id", "ipAddresses", "machineType", "os", "properties", "status"];

/**
 * @member {module:model/AgentKey} agentKey
 */
NodeAddInner.prototype['agentKey'] = undefined;

/**
 * The fully qualified name of the node
 * @member {String} hostname
 */
NodeAddInner.prototype['hostname'] = undefined;

/**
 * The Rudder node unique identifier in /opt/rudder/etc/uuid.hive
 * @member {String} id
 */
NodeAddInner.prototype['id'] = undefined;

/**
 * an array of IPs.
 * @member {Array.<String>} ipAddresses
 */
NodeAddInner.prototype['ipAddresses'] = undefined;

/**
 * The kind of machine for the node (use vm for a generic VM)
 * @member {module:model/NodeAddInner.MachineTypeEnum} machineType
 */
NodeAddInner.prototype['machineType'] = undefined;

/**
 * @member {module:model/Os} os
 */
NodeAddInner.prototype['os'] = undefined;
 ...
 * @member {module:model/NodeAddInner.PolicyModeEnum} policyMode
 */
NodeAddInner.prototype['policyMode'] = undefined;

/**
 * The policy server ID for that node. By default, \"root\"
 * @member {String} policyServerId
 */
NodeAddInner.prototype['policyServerId'] = undefined;
 ...
 */
NodeAddInner.prototype['properties'] = undefined;

/**
 * Node lifecycle state. Can only be specified when status=accepted. If not specified, enable is used
 * @member {module:model/NodeAddInner.StateEnum} state
 */
NodeAddInner.prototype['state'] = undefined;

/**
 * Target status of the node
 * @member {module:model/NodeAddInner.StatusEnum} status
 */
NodeAddInner.prototype['status'] = undefined;

/**
 * @member {module:model/Timezone} timezone
 */
NodeAddInner.prototype['timezone'] = undefined;
