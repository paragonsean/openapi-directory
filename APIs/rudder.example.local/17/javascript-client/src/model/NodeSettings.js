...
class NodeSettings {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('agentKey')) {
                obj['agentKey'] = AgentKey.constructFromObject(data['agentKey']);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['agentKey']) { // data not null
          AgentKey.validateJSON(data['agentKey']);
        }
...
/**
 * @member {module:model/AgentKey} agentKey
 */
NodeSettings.prototype['agentKey'] = undefined;

/**
 * In which mode the node will apply its configuration policy. Use `default` to use the global mode.
 * @member {module:model/NodeSettings.PolicyModeEnum} policyMode
 */
NodeSettings.prototype['policyMode'] = undefined;

/**
 * @member {Array.<module:model/NodeAddInnerPropertiesInner>} properties
 */
NodeSettings.prototype['properties'] = undefined;
 ...
 * @member {module:model/NodeSettings.StateEnum} state
 */
NodeSettings.prototype['state'] = undefined;
