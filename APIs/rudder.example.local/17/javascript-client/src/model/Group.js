...
import GroupPropertiesInner from './GroupPropertiesInner';
...
class Group {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('groupClass')) {
                obj['groupClass'] = ApiClient.convertToType(data['groupClass'], ['String']);
            }
            ...
            if (data.hasOwnProperty('properties')) {
                obj['properties'] = ApiClient.convertToType(data['properties'], [GroupPropertiesInner]);
            }
            if (data.hasOwnProperty('query')) {
                obj['query'] = GroupQuery.constructFromObject(data['query']);
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        if (!Array.isArray(data['groupClass'])) {
            throw new Error("Expected the field `groupClass` to be an array in the JSON data but got " + data['groupClass']);
        }
        // ensure the json data is a string
        ...
        if (data['properties']) { // data not null
            ...
            for (const item of data['properties']) {
                GroupPropertiesInner.validateJSON(item);
            };
        }
        // validate the optional field `query`
        if (data['query']) { // data not null
          GroupQuery.validateJSON(data['query']);
        }
 ...
 * @default true
 */
Group.prototype['enabled'] = true;

/**
 * @member {Array.<String>} groupClass
 */
Group.prototype['groupClass'] = undefined;
 ...
 */
Group.prototype['nodeIds'] = undefined;

/**
 * Group properties
 * @member {Array.<module:model/GroupPropertiesInner>} properties
 */
Group.prototype['properties'] = undefined;

/**
 * @member {module:model/GroupQuery} query
 */
Group.prototype['query'] = undefined;
