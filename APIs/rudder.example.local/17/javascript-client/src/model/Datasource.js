...
import DatasourceRunParameters from './DatasourceRunParameters';
...
class Datasource {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('runParameters')) {
                obj['runParameters'] = DatasourceRunParameters.constructFromObject(data['runParameters']);
            }
            if (data.hasOwnProperty('type')) {
                obj['type'] = DatasourceType.constructFromObject(data['type']);
            }
            if (data.hasOwnProperty('updateTimeout')) {
                obj['updateTimeout'] = ApiClient.convertToType(data['updateTimeout'], 'Number');
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        // validate the optional field `runParameters`
        if (data['runParameters']) { // data not null
          DatasourceRunParameters.validateJSON(data['runParameters']);
        }
...
/**
 * @member {module:model/DatasourceRunParameters} runParameters
 */
Datasource.prototype['runParameters'] = undefined;
 ...
 * @member {Number} updateTimeout
 */
Datasource.prototype['updateTimeout'] = undefined;
