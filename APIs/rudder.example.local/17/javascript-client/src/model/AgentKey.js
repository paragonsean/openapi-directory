...
class AgentKey {
     ...
     * @param value {String} Certificate (or public key for <6.0 agents) used by the agent. Be careful write a \"\\n\" after header line and before footer line, JSON does not keep formatting in string.
     */
    constructor(value) { 
        
        AgentKey.initialize(this, value);
    }
    ...
    /**
     * Validates the JSON data with respect to <code>AgentKey</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AgentKey</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of AgentKey.RequiredProperties) {
...
AgentKey.RequiredProperties = ["value"];
 ...
 * @member {module:model/AgentKey.StatusEnum} status
 */
AgentKey.prototype['status'] = undefined;

/**
 * Certificate (or public key for <6.0 agents) used by the agent. Be careful write a \"\\n\" after header line and before footer line, JSON does not keep formatting in string.
 * @member {String} value
 */
AgentKey.prototype['value'] = undefined;
