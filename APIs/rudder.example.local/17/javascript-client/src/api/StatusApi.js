...
export default class StatusApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the none operation.
     * @callback module:api/StatusApi~noneCallback
     ...
     * @param {module:api/StatusApi~noneCallback} callback The callback function, accepting three arguments: error, data, response
