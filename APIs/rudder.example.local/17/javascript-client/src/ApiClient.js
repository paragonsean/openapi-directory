...
class ApiClient {
     ...
     */
    constructor(basePath = 'https://rudder.example.local/rudder/api/latest') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
        ...
        this.authentications = {
            'API-Tokens': {type: 'apiKey', 'in': 'header', name: 'X-API-Token'}
        }
         ...
         */
        this.defaultHeaders = {
            'User-Agent': 'OpenAPI-Generator/17/Javascript'
        };
