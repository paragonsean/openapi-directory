# RudderApi.DatasourceTypeParameters
...
**headers** | [**[DatasourceTypeParametersHeadersInner]**](DatasourceTypeParametersHeadersInner.md) | Represent HTTP headers for the query. Rudder expansion available. | [optional] 
...
**requestMethod** | **String** | HTTP method to use to contact the URL. | [optional] 
**requestMode** | [**DatasourceTypeParametersRequestMode**](DatasourceTypeParametersRequestMode.md) |  | [optional] 
**requestTimeout** | **Number** | Timeout in seconds for each HTTP request | [optional] 
