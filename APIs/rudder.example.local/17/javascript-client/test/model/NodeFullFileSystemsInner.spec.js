...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RudderApi.NodeFullFileSystemsInner();
  });
  ...
  describe('NodeFullFileSystemsInner', function() {
    it('should create an instance of NodeFullFileSystemsInner', function() {
      // uncomment below and update the code to test NodeFullFileSystemsInner
      //var instance = new RudderApi.NodeFullFileSystemsInner();
      //expect(instance).to.be.a(RudderApi.NodeFullFileSystemsInner);
    });
