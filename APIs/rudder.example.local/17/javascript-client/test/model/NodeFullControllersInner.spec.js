...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RudderApi.NodeFullControllersInner();
  });
  ...
  describe('NodeFullControllersInner', function() {
    it('should create an instance of NodeFullControllersInner', function() {
      // uncomment below and update the code to test NodeFullControllersInner
      //var instance = new RudderApi.NodeFullControllersInner();
      //expect(instance).to.be.a(RudderApi.NodeFullControllersInner);
    });
