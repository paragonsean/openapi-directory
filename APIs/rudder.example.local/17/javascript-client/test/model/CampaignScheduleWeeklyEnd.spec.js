...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RudderApi.CampaignScheduleWeeklyEnd();
  });
  ...
  describe('CampaignScheduleWeeklyEnd', function() {
    it('should create an instance of CampaignScheduleWeeklyEnd', function() {
      // uncomment below and update the code to test CampaignScheduleWeeklyEnd
      //var instance = new RudderApi.CampaignScheduleWeeklyEnd();
      //expect(instance).to.be.a(RudderApi.CampaignScheduleWeeklyEnd);
    });
