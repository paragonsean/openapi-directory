...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RudderApi.DirectiveNodeCompliance();
  });
  ...
  describe('DirectiveNodeCompliance', function() {
    it('should create an instance of DirectiveNodeCompliance', function() {
      // uncomment below and update the code to test DirectiveNodeCompliance
      //var instance = new RudderApi.DirectiveNodeCompliance();
      //expect(instance).to.be.a(RudderApi.DirectiveNodeCompliance);
    });
