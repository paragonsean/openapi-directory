...
(function(root, factory) {
  ...
  describe('Users', function() {
    it('should create an instance of Users', function() {
      ...
      //var instance = new RudderApi.Users();
      //expect(instance).to.be.a(RudderApi.Users);
    });

    it('should have the property isPreHahed (base name: "isPreHahed")', function() {
      // uncomment below and update the code to test the property isPreHahed
      //var instance = new RudderApi.Users();
