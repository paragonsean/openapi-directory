...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RudderApi.RuleWithCategory();
  });
  ...
  describe('RuleWithCategory', function() {
    it('should create an instance of RuleWithCategory', function() {
      // uncomment below and update the code to test RuleWithCategory
      //var instance = new RudderApi.RuleWithCategory();
      //expect(instance).to.be.a(RudderApi.RuleWithCategory);
    });
