...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RudderApi.GetUserInfo200ResponseData();
  });
  ...
  describe('GetUserInfo200ResponseData', function() {
    it('should create an instance of GetUserInfo200ResponseData', function() {
      // uncomment below and update the code to test GetUserInfo200ResponseData
      //var instance = new RudderApi.GetUserInfo200ResponseData();
      //expect(instance).to.be.a(RudderApi.GetUserInfo200ResponseData);
    });
