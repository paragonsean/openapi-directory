...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RudderApi.MethodsCondition();
  });
  ...
  describe('MethodsCondition', function() {
    it('should create an instance of MethodsCondition', function() {
      // uncomment below and update the code to test MethodsCondition
      //var instance = new RudderApi.MethodsCondition();
      //expect(instance).to.be.a(RudderApi.MethodsCondition);
    });
