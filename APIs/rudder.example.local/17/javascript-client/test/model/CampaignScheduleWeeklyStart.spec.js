...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RudderApi.CampaignScheduleWeeklyStart();
  });
  ...
  describe('CampaignScheduleWeeklyStart', function() {
    it('should create an instance of CampaignScheduleWeeklyStart', function() {
      // uncomment below and update the code to test CampaignScheduleWeeklyStart
      //var instance = new RudderApi.CampaignScheduleWeeklyStart();
      //expect(instance).to.be.a(RudderApi.CampaignScheduleWeeklyStart);
    });
