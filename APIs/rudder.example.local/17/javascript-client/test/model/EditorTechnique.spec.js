...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RudderApi.EditorTechnique();
  });
  ...
  describe('EditorTechnique', function() {
    it('should create an instance of EditorTechnique', function() {
      // uncomment below and update the code to test EditorTechnique
      //var instance = new RudderApi.EditorTechnique();
      //expect(instance).to.be.a(RudderApi.EditorTechnique);
    });
