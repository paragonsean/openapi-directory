...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RudderApi.CampaignScheduleMonthlyStart();
  });
  ...
  describe('CampaignScheduleMonthlyStart', function() {
    it('should create an instance of CampaignScheduleMonthlyStart', function() {
      // uncomment below and update the code to test CampaignScheduleMonthlyStart
      //var instance = new RudderApi.CampaignScheduleMonthlyStart();
      //expect(instance).to.be.a(RudderApi.CampaignScheduleMonthlyStart);
    });
