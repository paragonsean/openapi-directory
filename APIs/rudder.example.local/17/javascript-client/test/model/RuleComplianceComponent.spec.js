...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RudderApi.RuleComplianceComponent();
  });
  ...
  describe('RuleComplianceComponent', function() {
    it('should create an instance of RuleComplianceComponent', function() {
      // uncomment below and update the code to test RuleComplianceComponent
      //var instance = new RudderApi.RuleComplianceComponent();
      //expect(instance).to.be.a(RudderApi.RuleComplianceComponent);
    });
