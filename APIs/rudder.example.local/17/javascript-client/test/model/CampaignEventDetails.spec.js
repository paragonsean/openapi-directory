...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RudderApi.CampaignEventDetails();
  });
  ...
  describe('CampaignEventDetails', function() {
    it('should create an instance of CampaignEventDetails', function() {
      // uncomment below and update the code to test CampaignEventDetails
      //var instance = new RudderApi.CampaignEventDetails();
      //expect(instance).to.be.a(RudderApi.CampaignEventDetails);
    });
