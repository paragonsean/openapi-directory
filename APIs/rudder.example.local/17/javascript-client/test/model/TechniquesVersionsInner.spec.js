...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RudderApi.TechniquesVersionsInner();
  });
  ...
  describe('TechniquesVersionsInner', function() {
    it('should create an instance of TechniquesVersionsInner', function() {
      // uncomment below and update the code to test TechniquesVersionsInner
      //var instance = new RudderApi.TechniquesVersionsInner();
      //expect(instance).to.be.a(RudderApi.TechniquesVersionsInner);
    });
