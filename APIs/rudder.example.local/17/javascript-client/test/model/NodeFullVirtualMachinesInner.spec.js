...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RudderApi.NodeFullVirtualMachinesInner();
  });
  ...
  describe('NodeFullVirtualMachinesInner', function() {
    it('should create an instance of NodeFullVirtualMachinesInner', function() {
      // uncomment below and update the code to test NodeFullVirtualMachinesInner
      //var instance = new RudderApi.NodeFullVirtualMachinesInner();
      //expect(instance).to.be.a(RudderApi.NodeFullVirtualMachinesInner);
    });
