...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RudderApi.TechniqueMethodCall();
  });
  ...
  describe('TechniqueMethodCall', function() {
    it('should create an instance of TechniqueMethodCall', function() {
      // uncomment below and update the code to test TechniqueMethodCall
      //var instance = new RudderApi.TechniqueMethodCall();
      //expect(instance).to.be.a(RudderApi.TechniqueMethodCall);
    });
    ...
    it('should have the property disableReporting (base name: "disableReporting")', function() {
      // uncomment below and update the code to test the property disableReporting
      //var instance = new RudderApi.TechniqueMethodCall();
      //expect(instance).to.be();
    });
