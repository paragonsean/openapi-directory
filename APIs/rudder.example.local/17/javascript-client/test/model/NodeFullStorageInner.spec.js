...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RudderApi.NodeFullStorageInner();
  });
  ...
  describe('NodeFullStorageInner', function() {
    it('should create an instance of NodeFullStorageInner', function() {
      // uncomment below and update the code to test NodeFullStorageInner
      //var instance = new RudderApi.NodeFullStorageInner();
      //expect(instance).to.be.a(RudderApi.NodeFullStorageInner);
    });
