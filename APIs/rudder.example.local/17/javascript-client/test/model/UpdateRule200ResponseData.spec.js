...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RudderApi.UpdateRule200ResponseData();
  });
  ...
  describe('UpdateRule200ResponseData', function() {
    it('should create an instance of UpdateRule200ResponseData', function() {
      // uncomment below and update the code to test UpdateRule200ResponseData
      //var instance = new RudderApi.UpdateRule200ResponseData();
      //expect(instance).to.be.a(RudderApi.UpdateRule200ResponseData);
    });
