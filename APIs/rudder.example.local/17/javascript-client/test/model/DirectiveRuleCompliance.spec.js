...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RudderApi.DirectiveRuleCompliance();
  });
  ...
  describe('DirectiveRuleCompliance', function() {
    it('should create an instance of DirectiveRuleCompliance', function() {
      // uncomment below and update the code to test DirectiveRuleCompliance
      //var instance = new RudderApi.DirectiveRuleCompliance();
      //expect(instance).to.be.a(RudderApi.DirectiveRuleCompliance);
    });
