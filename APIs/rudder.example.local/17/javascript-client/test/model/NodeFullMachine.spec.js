...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RudderApi.NodeFullMachine();
  });
  ...
  describe('NodeFullMachine', function() {
    it('should create an instance of NodeFullMachine', function() {
      // uncomment below and update the code to test NodeFullMachine
      //var instance = new RudderApi.NodeFullMachine();
      //expect(instance).to.be.a(RudderApi.NodeFullMachine);
    });
