...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RudderApi.NodeFullSoftwareInnerLicense();
  });
  ...
  describe('NodeFullSoftwareInnerLicense', function() {
    it('should create an instance of NodeFullSoftwareInnerLicense', function() {
      // uncomment below and update the code to test NodeFullSoftwareInnerLicense
      //var instance = new RudderApi.NodeFullSoftwareInnerLicense();
      //expect(instance).to.be.a(RudderApi.NodeFullSoftwareInnerLicense);
    });
    ...
    it('should have the property productKey (base name: "productKey")', function() {
      // uncomment below and update the code to test the property productKey
      //var instance = new RudderApi.NodeFullSoftwareInnerLicense();
      //expect(instance).to.be();
    });
