...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RudderApi.CampaignEventNodeResult();
  });
  ...
  describe('CampaignEventNodeResult', function() {
    it('should create an instance of CampaignEventNodeResult', function() {
      // uncomment below and update the code to test CampaignEventNodeResult
      //var instance = new RudderApi.CampaignEventNodeResult();
      //expect(instance).to.be.a(RudderApi.CampaignEventNodeResult);
    });
