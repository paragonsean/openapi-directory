...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RudderApi.GroupNew();
  });
  ...
  describe('GroupNew', function() {
    it('should create an instance of GroupNew', function() {
      // uncomment below and update the code to test GroupNew
      //var instance = new RudderApi.GroupNew();
      //expect(instance).to.be.a(RudderApi.GroupNew);
    });
