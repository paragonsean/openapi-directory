...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RudderApi.CreateNodes200ResponseData();
  });
  ...
  describe('CreateNodes200ResponseData', function() {
    it('should create an instance of CreateNodes200ResponseData', function() {
      // uncomment below and update the code to test CreateNodes200ResponseData
      //var instance = new RudderApi.CreateNodes200ResponseData();
      //expect(instance).to.be.a(RudderApi.CreateNodes200ResponseData);
    });
