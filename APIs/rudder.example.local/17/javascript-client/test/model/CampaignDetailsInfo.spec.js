...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RudderApi.CampaignDetailsInfo();
  });
  ...
  describe('CampaignDetailsInfo', function() {
    it('should create an instance of CampaignDetailsInfo', function() {
      // uncomment below and update the code to test CampaignDetailsInfo
      //var instance = new RudderApi.CampaignDetailsInfo();
      //expect(instance).to.be.a(RudderApi.CampaignDetailsInfo);
    });
