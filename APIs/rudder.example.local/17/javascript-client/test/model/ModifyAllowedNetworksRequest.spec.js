...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RudderApi.ModifyAllowedNetworksRequest();
  });
  ...
  describe('ModifyAllowedNetworksRequest', function() {
    it('should create an instance of ModifyAllowedNetworksRequest', function() {
      // uncomment below and update the code to test ModifyAllowedNetworksRequest
      //var instance = new RudderApi.ModifyAllowedNetworksRequest();
      //expect(instance).to.be.a(RudderApi.ModifyAllowedNetworksRequest);
    });
