...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RudderApi.AgentKey();
  });
  ...
  describe('AgentKey', function() {
    it('should create an instance of AgentKey', function() {
      // uncomment below and update the code to test AgentKey
      //var instance = new RudderApi.AgentKey();
      //expect(instance).to.be.a(RudderApi.AgentKey);
    });
