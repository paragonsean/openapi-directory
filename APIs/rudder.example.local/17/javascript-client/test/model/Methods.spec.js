...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RudderApi.Methods();
  });
  ...
  describe('Methods', function() {
    it('should create an instance of Methods', function() {
      // uncomment below and update the code to test Methods
      //var instance = new RudderApi.Methods();
      //expect(instance).to.be.a(RudderApi.Methods);
    });
