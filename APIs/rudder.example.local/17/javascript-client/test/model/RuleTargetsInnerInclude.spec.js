...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RudderApi.RuleTargetsInnerInclude();
  });
  ...
  describe('RuleTargetsInnerInclude', function() {
    it('should create an instance of RuleTargetsInnerInclude', function() {
      // uncomment below and update the code to test RuleTargetsInnerInclude
      //var instance = new RudderApi.RuleTargetsInnerInclude();
      //expect(instance).to.be.a(RudderApi.RuleTargetsInnerInclude);
    });
