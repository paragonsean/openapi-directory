...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RudderApi.NodeComplianceComponent();
  });
  ...
  describe('NodeComplianceComponent', function() {
    it('should create an instance of NodeComplianceComponent', function() {
      // uncomment below and update the code to test NodeComplianceComponent
      //var instance = new RudderApi.NodeComplianceComponent();
      //expect(instance).to.be.a(RudderApi.NodeComplianceComponent);
    });
