...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RudderApi.TechniqueCategory();
  });
  ...
  describe('TechniqueCategory', function() {
    it('should create an instance of TechniqueCategory', function() {
      // uncomment below and update the code to test TechniqueCategory
      //var instance = new RudderApi.TechniqueCategory();
      //expect(instance).to.be.a(RudderApi.TechniqueCategory);
    });
