...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RudderApi.GroupQueryWhereInner();
  });
  ...
  describe('GroupQueryWhereInner', function() {
    it('should create an instance of GroupQueryWhereInner', function() {
      // uncomment below and update the code to test GroupQueryWhereInner
      //var instance = new RudderApi.GroupQueryWhereInner();
      //expect(instance).to.be.a(RudderApi.GroupQueryWhereInner);
    });
