...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RudderApi.Directive();
  });
  ...
  describe('Directive', function() {
    it('should create an instance of Directive', function() {
      // uncomment below and update the code to test Directive
      //var instance = new RudderApi.Directive();
      //expect(instance).to.be.a(RudderApi.Directive);
    });
