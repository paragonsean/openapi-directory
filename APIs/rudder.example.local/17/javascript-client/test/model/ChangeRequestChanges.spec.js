...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RudderApi.ChangeRequestChanges();
  });
  ...
  describe('ChangeRequestChanges', function() {
    it('should create an instance of ChangeRequestChanges', function() {
      // uncomment below and update the code to test ChangeRequestChanges
      //var instance = new RudderApi.ChangeRequestChanges();
      //expect(instance).to.be.a(RudderApi.ChangeRequestChanges);
    });
