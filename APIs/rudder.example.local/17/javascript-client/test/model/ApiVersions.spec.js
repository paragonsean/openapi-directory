...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RudderApi.ApiVersions();
  });
  ...
  describe('ApiVersions', function() {
    it('should create an instance of ApiVersions', function() {
      // uncomment below and update the code to test ApiVersions
      //var instance = new RudderApi.ApiVersions();
      //expect(instance).to.be.a(RudderApi.ApiVersions);
    });
