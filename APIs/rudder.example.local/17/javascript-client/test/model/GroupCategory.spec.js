...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RudderApi.GroupCategory();
  });
  ...
  describe('GroupCategory', function() {
    it('should create an instance of GroupCategory', function() {
      // uncomment below and update the code to test GroupCategory
      //var instance = new RudderApi.GroupCategory();
      //expect(instance).to.be.a(RudderApi.GroupCategory);
    });
