...
(function(root, factory) {
  ...
  describe('Rule', function() {
    it('should create an instance of Rule', function() {
      ...
      //var instance = new RudderApi.Rule();
      //expect(instance).to.be.a(RudderApi.Rule);
    });

    it('should have the property directives (base name: "directives")', function() {
      // uncomment below and update the code to test the property directives
      //var instance = new RudderApi.Rule();
