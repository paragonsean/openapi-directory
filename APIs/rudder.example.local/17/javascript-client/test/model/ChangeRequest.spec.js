...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RudderApi.ChangeRequest();
  });
  ...
  describe('ChangeRequest', function() {
    it('should create an instance of ChangeRequest', function() {
      ...
      //var instance = new RudderApi.ChangeRequest();
      //expect(instance).to.be.a(RudderApi.ChangeRequest);
    });

    it('should have the property acceptable (base name: "acceptable")', function() {
      // uncomment below and update the code to test the property acceptable
      //var instance = new RudderApi.ChangeRequest();
