...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RudderApi.NodeFullNetworkInterfacesInner();
  });
  ...
  describe('NodeFullNetworkInterfacesInner', function() {
    it('should create an instance of NodeFullNetworkInterfacesInner', function() {
      // uncomment below and update the code to test NodeFullNetworkInterfacesInner
      //var instance = new RudderApi.NodeFullNetworkInterfacesInner();
      //expect(instance).to.be.a(RudderApi.NodeFullNetworkInterfacesInner);
    });
