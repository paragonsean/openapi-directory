...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RudderApi.TechniquesRevisionsInner();
  });
  ...
  describe('TechniquesRevisionsInner', function() {
    it('should create an instance of TechniquesRevisionsInner', function() {
      // uncomment below and update the code to test TechniquesRevisionsInner
      //var instance = new RudderApi.TechniquesRevisionsInner();
      //expect(instance).to.be.a(RudderApi.TechniquesRevisionsInner);
    });
