...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RudderApi.RuleTargetsInner();
  });
  ...
  describe('RuleTargetsInner', function() {
    it('should create an instance of RuleTargetsInner', function() {
      // uncomment below and update the code to test RuleTargetsInner
      //var instance = new RudderApi.RuleTargetsInner();
      //expect(instance).to.be.a(RudderApi.RuleTargetsInner);
    });
