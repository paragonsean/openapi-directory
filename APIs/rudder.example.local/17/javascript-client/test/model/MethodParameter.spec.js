...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RudderApi.MethodParameter();
  });
  ...
  describe('MethodParameter', function() {
    it('should create an instance of MethodParameter', function() {
      // uncomment below and update the code to test MethodParameter
      //var instance = new RudderApi.MethodParameter();
      //expect(instance).to.be.a(RudderApi.MethodParameter);
    });
