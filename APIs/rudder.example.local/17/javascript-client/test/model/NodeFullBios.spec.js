...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RudderApi.NodeFullBios();
  });
  ...
  describe('NodeFullBios', function() {
    it('should create an instance of NodeFullBios', function() {
      // uncomment below and update the code to test NodeFullBios
      //var instance = new RudderApi.NodeFullBios();
      //expect(instance).to.be.a(RudderApi.NodeFullBios);
    });
