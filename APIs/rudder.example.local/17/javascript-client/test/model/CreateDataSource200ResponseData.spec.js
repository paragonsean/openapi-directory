...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RudderApi.CreateDataSource200ResponseData();
  });
  ...
  describe('CreateDataSource200ResponseData', function() {
    it('should create an instance of CreateDataSource200ResponseData', function() {
      // uncomment below and update the code to test CreateDataSource200ResponseData
      //var instance = new RudderApi.CreateDataSource200ResponseData();
      //expect(instance).to.be.a(RudderApi.CreateDataSource200ResponseData);
    });
