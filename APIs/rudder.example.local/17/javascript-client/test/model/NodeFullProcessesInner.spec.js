...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RudderApi.NodeFullProcessesInner();
  });
  ...
  describe('NodeFullProcessesInner', function() {
    it('should create an instance of NodeFullProcessesInner', function() {
      // uncomment below and update the code to test NodeFullProcessesInner
      //var instance = new RudderApi.NodeFullProcessesInner();
      //expect(instance).to.be.a(RudderApi.NodeFullProcessesInner);
    });
    ...
    it('should have the property virtualMemory (base name: "virtualMemory")', function() {
      // uncomment below and update the code to test the property virtualMemory
      //var instance = new RudderApi.NodeFullProcessesInner();
      //expect(instance).to.be();
    });
