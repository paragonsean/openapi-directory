...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RudderApi.DirectiveNew();
  });
  ...
  describe('DirectiveNew', function() {
    it('should create an instance of DirectiveNew', function() {
      // uncomment below and update the code to test DirectiveNew
      //var instance = new RudderApi.DirectiveNew();
      //expect(instance).to.be.a(RudderApi.DirectiveNew);
    });
    ...
    it('should have the property techniqueName (base name: "techniqueName")', function() {
      // uncomment below and update the code to test the property techniqueName
      //var instance = new RudderApi.DirectiveNew();
      //expect(instance).to.be();
    });

    it('should have the property techniqueVersion (base name: "techniqueVersion")', function() {
      // uncomment below and update the code to test the property techniqueVersion
      //var instance = new RudderApi.DirectiveNew();
      //expect(instance).to.be();
    });
