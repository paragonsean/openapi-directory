...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RudderApi.GroupNewQuery();
  });
  ...
  describe('GroupNewQuery', function() {
    it('should create an instance of GroupNewQuery', function() {
      // uncomment below and update the code to test GroupNewQuery
      //var instance = new RudderApi.GroupNewQuery();
      //expect(instance).to.be.a(RudderApi.GroupNewQuery);
    });
