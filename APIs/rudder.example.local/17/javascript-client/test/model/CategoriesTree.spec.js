...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RudderApi.CategoriesTree();
  });
  ...
  describe('CategoriesTree', function() {
    it('should create an instance of CategoriesTree', function() {
      // uncomment below and update the code to test CategoriesTree
      //var instance = new RudderApi.CategoriesTree();
      //expect(instance).to.be.a(RudderApi.CategoriesTree);
    });
