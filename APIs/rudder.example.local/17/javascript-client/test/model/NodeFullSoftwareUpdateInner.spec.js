...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RudderApi.NodeFullSoftwareUpdateInner();
  });
  ...
  describe('NodeFullSoftwareUpdateInner', function() {
    it('should create an instance of NodeFullSoftwareUpdateInner', function() {
      // uncomment below and update the code to test NodeFullSoftwareUpdateInner
      //var instance = new RudderApi.NodeFullSoftwareUpdateInner();
      //expect(instance).to.be.a(RudderApi.NodeFullSoftwareUpdateInner);
    });
