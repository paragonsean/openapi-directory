...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RudderApi.GetDirectivesCompliance200ResponseDataDirectivesCompliance();
  });
  ...
  describe('GetDirectivesCompliance200ResponseDataDirectivesCompliance', function() {
    it('should create an instance of GetDirectivesCompliance200ResponseDataDirectivesCompliance', function() {
      // uncomment below and update the code to test GetDirectivesCompliance200ResponseDataDirectivesCompliance
      //var instance = new RudderApi.GetDirectivesCompliance200ResponseDataDirectivesCompliance();
      //expect(instance).to.be.a(RudderApi.GetDirectivesCompliance200ResponseDataDirectivesCompliance);
    });
