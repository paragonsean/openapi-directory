...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RudderApi.TechniqueBlock();
  });
  ...
  describe('TechniqueBlock', function() {
    it('should create an instance of TechniqueBlock', function() {
      // uncomment below and update the code to test TechniqueBlock
      //var instance = new RudderApi.TechniqueBlock();
      //expect(instance).to.be.a(RudderApi.TechniqueBlock);
    });
    ...
    it('should have the property reportingLogic (base name: "reportingLogic")', function() {
      // uncomment below and update the code to test the property reportingLogic
      //var instance = new RudderApi.TechniqueBlock();
      //expect(instance).to.be();
    });
