...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RudderApi.UpdateCVERequest();
  });
  ...
  describe('UpdateCVERequest', function() {
    it('should create an instance of UpdateCVERequest', function() {
      // uncomment below and update the code to test UpdateCVERequest
      //var instance = new RudderApi.UpdateCVERequest();
      //expect(instance).to.be.a(RudderApi.UpdateCVERequest);
    });
