...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RudderApi.NodeFullSoftwareInner();
  });
  ...
  describe('NodeFullSoftwareInner', function() {
    it('should create an instance of NodeFullSoftwareInner', function() {
      // uncomment below and update the code to test NodeFullSoftwareInner
      //var instance = new RudderApi.NodeFullSoftwareInner();
      //expect(instance).to.be.a(RudderApi.NodeFullSoftwareInner);
    });
