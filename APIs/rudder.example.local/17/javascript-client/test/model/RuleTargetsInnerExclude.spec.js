...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RudderApi.RuleTargetsInnerExclude();
  });
  ...
  describe('RuleTargetsInnerExclude', function() {
    it('should create an instance of RuleTargetsInnerExclude', function() {
      // uncomment below and update the code to test RuleTargetsInnerExclude
      //var instance = new RudderApi.RuleTargetsInnerExclude();
      //expect(instance).to.be.a(RudderApi.RuleTargetsInnerExclude);
    });
