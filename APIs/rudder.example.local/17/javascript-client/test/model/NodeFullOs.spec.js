...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RudderApi.NodeFullOs();
  });
  ...
  describe('NodeFullOs', function() {
    it('should create an instance of NodeFullOs', function() {
      // uncomment below and update the code to test NodeFullOs
      //var instance = new RudderApi.NodeFullOs();
      //expect(instance).to.be.a(RudderApi.NodeFullOs);
    });
    ...
    it('should have the property servicePack (base name: "servicePack")', function() {
      // uncomment below and update the code to test the property servicePack
      //var instance = new RudderApi.NodeFullOs();
      //expect(instance).to.be();
    });
