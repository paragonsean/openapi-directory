...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RudderApi.CveCheckScore();
  });
  ...
  describe('CveCheckScore', function() {
    it('should create an instance of CveCheckScore', function() {
      // uncomment below and update the code to test CveCheckScore
      //var instance = new RudderApi.CveCheckScore();
      //expect(instance).to.be.a(RudderApi.CveCheckScore);
    });
