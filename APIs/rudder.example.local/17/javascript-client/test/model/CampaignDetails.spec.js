...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RudderApi.CampaignDetails();
  });
  ...
  describe('CampaignDetails', function() {
    it('should create an instance of CampaignDetails', function() {
      // uncomment below and update the code to test CampaignDetails
      //var instance = new RudderApi.CampaignDetails();
      //expect(instance).to.be.a(RudderApi.CampaignDetails);
    });
