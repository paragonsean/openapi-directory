...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RudderApi.NodeFullMemoriesInner();
  });
  ...
  describe('NodeFullMemoriesInner', function() {
    it('should create an instance of NodeFullMemoriesInner', function() {
      // uncomment below and update the code to test NodeFullMemoriesInner
      //var instance = new RudderApi.NodeFullMemoriesInner();
      //expect(instance).to.be.a(RudderApi.NodeFullMemoriesInner);
    });
    ...
    it('should have the property slotNumber (base name: "slotNumber")', function() {
      // uncomment below and update the code to test the property slotNumber
      //var instance = new RudderApi.NodeFullMemoriesInner();
      //expect(instance).to.be();
    });
