...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RudderApi.NodeFullVideosInner();
  });
  ...
  describe('NodeFullVideosInner', function() {
    it('should create an instance of NodeFullVideosInner', function() {
      // uncomment below and update the code to test NodeFullVideosInner
      //var instance = new RudderApi.NodeFullVideosInner();
      //expect(instance).to.be.a(RudderApi.NodeFullVideosInner);
    });

    it('should have the property chipset (base name: "chipset")', function() {
      // uncomment below and update the code to test the property chipset
      //var instance = new RudderApi.NodeFullVideosInner();
