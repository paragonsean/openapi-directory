...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RudderApi.NodeFull();
  });
  ...
  describe('NodeFull', function() {
    it('should create an instance of NodeFull', function() {
      // uncomment below and update the code to test NodeFull
      //var instance = new RudderApi.NodeFull();
      //expect(instance).to.be.a(RudderApi.NodeFull);
    });
    ...
    it('should have the property architectureDescription (base name: "architectureDescription")', function() {
      // uncomment below and update the code to test the property architectureDescription
      //var instance = new RudderApi.NodeFull();
      //expect(instance).to.be();
    });
    ...
    it('should have the property managementTechnology (base name: "managementTechnology")', function() {
      // uncomment below and update the code to test the property managementTechnology
      //var instance = new RudderApi.NodeFull();
      //expect(instance).to.be();
    });

    it('should have the property managementTechnologyDetails (base name: "managementTechnologyDetails")', function() {
      // uncomment below and update the code to test the property managementTechnologyDetails
      //var instance = new RudderApi.NodeFull();
      //expect(instance).to.be();
    });

    it('should have the property memories (base name: "memories")', function() {
      // uncomment below and update the code to test the property memories
      //var instance = new RudderApi.NodeFull();
      //expect(instance).to.be();
    });
