...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RudderApi.CampaignScheduleMonthlyEnd();
  });
  ...
  describe('CampaignScheduleMonthlyEnd', function() {
    it('should create an instance of CampaignScheduleMonthlyEnd', function() {
      // uncomment below and update the code to test CampaignScheduleMonthlyEnd
      //var instance = new RudderApi.CampaignScheduleMonthlyEnd();
      //expect(instance).to.be.a(RudderApi.CampaignScheduleMonthlyEnd);
    });
