...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RudderApi.CampaignEventResult();
  });
  ...
  describe('CampaignEventResult', function() {
    it('should create an instance of CampaignEventResult', function() {
      // uncomment below and update the code to test CampaignEventResult
      //var instance = new RudderApi.CampaignEventResult();
      //expect(instance).to.be.a(RudderApi.CampaignEventResult);
    });
