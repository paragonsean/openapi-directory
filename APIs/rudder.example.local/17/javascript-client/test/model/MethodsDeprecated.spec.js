...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RudderApi.MethodsDeprecated();
  });
  ...
  describe('MethodsDeprecated', function() {
    it('should create an instance of MethodsDeprecated', function() {
      // uncomment below and update the code to test MethodsDeprecated
      //var instance = new RudderApi.MethodsDeprecated();
      //expect(instance).to.be.a(RudderApi.MethodsDeprecated);
    });
    ...
    it('should have the property replacedBy (base name: "replacedBy")', function() {
