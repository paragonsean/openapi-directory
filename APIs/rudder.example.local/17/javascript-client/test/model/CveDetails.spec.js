...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RudderApi.CveDetails();
  });
  ...
  describe('CveDetails', function() {
    it('should create an instance of CveDetails', function() {
      // uncomment below and update the code to test CveDetails
      //var instance = new RudderApi.CveDetails();
      //expect(instance).to.be.a(RudderApi.CveDetails);
    });
    ...
    it('should have the property cweIds (base name: "cweIds")', function() {
      // uncomment below and update the code to test the property cweIds
      //var instance = new RudderApi.CveDetails();
      //expect(instance).to.be();
    });
