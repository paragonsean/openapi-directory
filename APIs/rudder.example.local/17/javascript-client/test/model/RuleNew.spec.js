...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RudderApi.RuleNew();
  });
  ...
  describe('RuleNew', function() {
    it('should create an instance of RuleNew', function() {
      // uncomment below and update the code to test RuleNew
      //var instance = new RudderApi.RuleNew();
      //expect(instance).to.be.a(RudderApi.RuleNew);
    });
