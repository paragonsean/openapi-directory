...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RudderApi.UserManagementApi();
  });
  ...
  describe('UserManagementApi', function() {
    ...
    describe('reloadUserConf', function() {
      it('should call reloadUserConf successfully', function(done) {
        //uncomment below and update the code to test reloadUserConf
        //instance.reloadUserConf(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
