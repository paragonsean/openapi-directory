...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RudderApi.SecretManagementApi();
  });
  ...
  describe('SecretManagementApi', function() {
    describe('addSecret', function() {
      it('should call addSecret successfully', function(done) {
        //uncomment below and update the code to test addSecret
        //instance.addSecret(function(error) {
    ...
    describe('getAllSecrets', function() {
      it('should call getAllSecrets successfully', function(done) {
        //uncomment below and update the code to test getAllSecrets
        //instance.getAllSecrets(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
