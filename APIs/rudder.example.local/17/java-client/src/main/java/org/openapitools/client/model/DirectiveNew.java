...
public class DirectiveNew {
  ...
  public DirectiveNew displayName(String displayName) {
  ...
  public DirectiveNew enabled(Boolean enabled) {
  ...
  public DirectiveNew id(UUID id) {
    this.id = id;
    return this;
  }
  ...
  public DirectiveNew longDescription(String longDescription) {
  ...
  public DirectiveNew parameters(Object parameters) {
  ...
  public DirectiveNew priority(Integer priority) {
  ...
  public DirectiveNew shortDescription(String shortDescription) {
  ...
  public DirectiveNew source(UUID source) {
    this.source = source;
    return this;
  }
  ...
  public DirectiveNew system(Boolean system) {
    this.system = system;
    return this;
  }
  ...
  public DirectiveNew tags(List<DirectiveTagsInner> tags) {
    this.tags = tags;
    return this;
  }

  public DirectiveNew addTagsItem(DirectiveTagsInner tagsItem) {
    if (this.tags == null) {
  ...
  public DirectiveNew techniqueName(String techniqueName) {
  ...
  public DirectiveNew techniqueVersion(String techniqueVersion) {
  ...
  public boolean equals(Object o) {
    ...
    DirectiveNew directiveNew = (DirectiveNew) o;
    return Objects.equals(this.displayName, directiveNew.displayName) &&
        Objects.equals(this.enabled, directiveNew.enabled) &&
        Objects.equals(this.id, directiveNew.id) &&
        Objects.equals(this.longDescription, directiveNew.longDescription) &&
        Objects.equals(this.parameters, directiveNew.parameters) &&
        Objects.equals(this.priority, directiveNew.priority) &&
        Objects.equals(this.shortDescription, directiveNew.shortDescription) &&
        Objects.equals(this.source, directiveNew.source) &&
        Objects.equals(this.system, directiveNew.system) &&
        Objects.equals(this.tags, directiveNew.tags) &&
        Objects.equals(this.techniqueName, directiveNew.techniqueName) &&
        Objects.equals(this.techniqueVersion, directiveNew.techniqueVersion);
  }

  @Override
  public int hashCode() {
    return Objects.hash(displayName, enabled, id, longDescription, parameters, priority, shortDescription, source, system, tags, techniqueName, techniqueVersion);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DirectiveNew {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DirectiveNew
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DirectiveNew.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DirectiveNew is not found in the empty JSON string", DirectiveNew.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DirectiveNew.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DirectiveNew` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DirectiveNew.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DirectiveNew' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DirectiveNew> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DirectiveNew.class));

       return (TypeAdapter<T>) new TypeAdapter<DirectiveNew>() {
           @Override
           public void write(JsonWriter out, DirectiveNew value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DirectiveNew read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DirectiveNew given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DirectiveNew
   * @throws IOException if the JSON string is invalid with respect to DirectiveNew
   */
  public static DirectiveNew fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DirectiveNew.class);
  }

  /**
   * Convert an instance of DirectiveNew to an JSON string
   *
   * @return JSON string
   */
