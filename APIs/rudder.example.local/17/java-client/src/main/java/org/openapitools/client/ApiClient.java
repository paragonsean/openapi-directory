...
public class ApiClient {
    ...
    private String basePath = "https://rudder.example.local/rudder/api/latest";
    ...
    public ApiClient() {
        ...
        authentications.put("API-Tokens", new ApiKeyAuth("header", "X-API-Token"));
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/17/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://rudder.example.local/rudder/api/latest
