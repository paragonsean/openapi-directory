...
public class RuleNew {
  ...
  public RuleNew category(UUID category) {
  ...
  public RuleNew directives(List<String> directives) {
    this.directives = directives;
    return this;
  }

  public RuleNew addDirectivesItem(String directivesItem) {
  ...
  public RuleNew displayName(String displayName) {
  ...
  public RuleNew enabled(Boolean enabled) {
  ...
  public RuleNew longDescription(String longDescription) {
  ...
  public RuleNew shortDescription(String shortDescription) {
  ...
  public RuleNew source(UUID source) {
    this.source = source;
    return this;
  }
  ...
  public RuleNew system(Boolean system) {
    this.system = system;
    return this;
  }
  ...
  public RuleNew tags(List<DirectiveTagsInner> tags) {
    this.tags = tags;
    return this;
  }

  public RuleNew addTagsItem(DirectiveTagsInner tagsItem) {
    if (this.tags == null) {
  ...
  public RuleNew targets(List<RuleTargetsInner> targets) {
    this.targets = targets;
    return this;
  }

  public RuleNew addTargetsItem(RuleTargetsInner targetsItem) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.category, ruleNew.category) &&
        Objects.equals(this.directives, ruleNew.directives) &&
        Objects.equals(this.displayName, ruleNew.displayName) &&
        Objects.equals(this.enabled, ruleNew.enabled) &&
        Objects.equals(this.id, ruleNew.id) &&
        Objects.equals(this.longDescription, ruleNew.longDescription) &&
        Objects.equals(this.shortDescription, ruleNew.shortDescription) &&
        Objects.equals(this.source, ruleNew.source) &&
        Objects.equals(this.system, ruleNew.system) &&
        Objects.equals(this.tags, ruleNew.tags) &&
        Objects.equals(this.targets, ruleNew.targets);
  }

  @Override
  public int hashCode() {
    return Objects.hash(category, directives, displayName, enabled, id, longDescription, shortDescription, source, system, tags, targets);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class RuleNew {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to RuleNew
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RuleNew.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in RuleNew is not found in the empty JSON string", RuleNew.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RuleNew.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `RuleNew` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RuleNew.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RuleNew' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RuleNew> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RuleNew.class));

       return (TypeAdapter<T>) new TypeAdapter<RuleNew>() {
           @Override
           public void write(JsonWriter out, RuleNew value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public RuleNew read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of RuleNew given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of RuleNew
   * @throws IOException if the JSON string is invalid with respect to RuleNew
   */
  public static RuleNew fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RuleNew.class);
  }

  /**
   * Convert an instance of RuleNew to an JSON string
   *
   * @return JSON string
   */
