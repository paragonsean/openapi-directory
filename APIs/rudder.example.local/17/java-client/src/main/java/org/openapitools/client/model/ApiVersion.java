...
import org.openapitools.client.model.ApiVersionAllInner;
...
public class ApiVersion {
  ...
  private List<ApiVersionAllInner> all = new ArrayList<>();
  ...
  public ApiVersion all(List<ApiVersionAllInner> all) {
    this.all = all;
    return this;
  }

  public ApiVersion addAllItem(ApiVersionAllInner allItem) {
    if (this.all == null) {
  ...
  public List<ApiVersionAllInner> getAll() {
    return all;
  }

  public void setAll(List<ApiVersionAllInner> all) {
    this.all = all;
  }


  public ApiVersion latest(Integer latest) {
    this.latest = latest;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.all, apiVersion.all) &&
        Objects.equals(this.latest, apiVersion.latest);
  }
      ...
      if (jsonObj.get("all") != null && !jsonObj.get("all").isJsonNull()) {
        ...
        if (jsonArrayall != null) {
          ...
          for (int i = 0; i < jsonArrayall.size(); i++) {
            ApiVersionAllInner.validateJsonElement(jsonArrayall.get(i));
          };
        }
      }
  }
