...
import org.openapitools.client.model.GroupPropertiesInner;
import org.openapitools.client.model.GroupQuery;
...
public class Group {
  ...
  public static final String SERIALIZED_NAME_GROUP_CLASS = "groupClass";
  @SerializedName(SERIALIZED_NAME_GROUP_CLASS)
  private List<String> groupClass = new ArrayList<>();
  ...
  private List<GroupPropertiesInner> properties = new ArrayList<>();
  ...
  public Group dynamic(Boolean dynamic) {
  ...
  public Group groupClass(List<String> groupClass) {
    this.groupClass = groupClass;
    return this;
  }

  public Group addGroupClassItem(String groupClassItem) {
    if (this.groupClass == null) {
      this.groupClass = new ArrayList<>();
    }
    this.groupClass.add(groupClassItem);
    return this;
  }
  ...
  public Group nodeIds(List<String> nodeIds) {
    this.nodeIds = nodeIds;
    return this;
  }

  public Group addNodeIdsItem(String nodeIdsItem) {
  ...
  public Group properties(List<GroupPropertiesInner> properties) {
    this.properties = properties;
    return this;
  }

  public Group addPropertiesItem(GroupPropertiesInner propertiesItem) {
   ...
   */
  @javax.annotation.Nullable
  public List<GroupPropertiesInner> getProperties() {
    return properties;
  }

  public void setProperties(List<GroupPropertiesInner> properties) {
    this.properties = properties;
  }


  public Group query(GroupQuery query) {
    this.query = query;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.description, group.description) &&
        ...
        Objects.equals(this.dynamic, group.dynamic) &&
        Objects.equals(this.enabled, group.enabled) &&
        Objects.equals(this.groupClass, group.groupClass) &&
        Objects.equals(this.id, group.id) &&
        Objects.equals(this.nodeIds, group.nodeIds) &&
        Objects.equals(this.properties, group.properties) &&
        Objects.equals(this.query, group.query);
  }

  @Override
  public int hashCode() {
    return Objects.hash(description, displayName, dynamic, enabled, groupClass, id, nodeIds, properties, query);
  }
  ...
  public String toString() {
    ...
    sb.append("    groupClass: ").append(toIndentedString(groupClass)).append("\n");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("groupClass") != null && !jsonObj.get("groupClass").isJsonNull() && !jsonObj.get("groupClass").isJsonArray()) {
        throw new IllegalArgumentException(String.format("Expected the field `groupClass` to be an array in the JSON string but got `%s`", jsonObj.get("groupClass").toString()));
      }
      ...
      if (jsonObj.get("properties") != null && !jsonObj.get("properties").isJsonNull()) {
        ...
        if (jsonArrayproperties != null) {
          ...
          for (int i = 0; i < jsonArrayproperties.size(); i++) {
            GroupPropertiesInner.validateJsonElement(jsonArrayproperties.get(i));
          };
        }
      }
      // validate the optional field `query`
      if (jsonObj.get("query") != null && !jsonObj.get("query").isJsonNull()) {
        GroupQuery.validateJsonElement(jsonObj.get("query"));
      }
  }
