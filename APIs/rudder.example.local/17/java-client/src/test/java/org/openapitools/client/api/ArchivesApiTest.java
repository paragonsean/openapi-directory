...
import java.io.File;
import org.openapitools.client.model.Import200Response;
...
public class ArchivesApiTest {
    ...
    public void callImportTest() throws ApiException {
        File archive = null;
        String merge = null;
        Import200Response response = api.callImport(archive, merge);
    ...
    public void exportTest() throws ApiException {
        ...
        File response = api.export(rules, directives, techniques, groups, include);
        // TODO: test validations
    }
