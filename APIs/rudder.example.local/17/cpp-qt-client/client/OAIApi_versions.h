...
#ifndef OAIApi_versions_H
#define OAIApi_versions_H
...
class OAIApi_versions : public OAIObject {
public:
    OAIApi_versions();
    OAIApi_versions(QString json);
    ~OAIApi_versions() override;
    ...
    QList<OAIApi_version> getAll() const;
    void setAll(const QList<OAIApi_version> &all);
...
Q_DECLARE_METATYPE(OpenAPI::OAIApi_versions)

#endif // OAIApi_versions_H
