...
/*
 * OAINode_full_memories_inner.h
 *
 * Memory slots
 */

#ifndef OAINode_full_memories_inner_H
#define OAINode_full_memories_inner_H
...
class OAINode_full_memories_inner : public OAIObject {
public:
    OAINode_full_memories_inner();
    OAINode_full_memories_inner(QString json);
    ~OAINode_full_memories_inner() override;
    ...
    qint32 getSlotNumber() const;
    void setSlotNumber(const qint32 &slot_number);
    bool is_slot_number_Set() const;
    bool is_slot_number_Valid() const;
...
private:
    ...
    qint32 m_slot_number;
    bool m_slot_number_isSet;
    bool m_slot_number_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAINode_full_memories_inner)

#endif // OAINode_full_memories_inner_H
