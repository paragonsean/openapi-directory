...
/*
 * OAINode_full_fileSystems_inner.h
 *
 * 
 */

#ifndef OAINode_full_fileSystems_inner_H
#define OAINode_full_fileSystems_inner_H
...
class OAINode_full_fileSystems_inner : public OAIObject {
public:
    OAINode_full_fileSystems_inner();
    OAINode_full_fileSystems_inner(QString json);
    ~OAINode_full_fileSystems_inner() override;
    ...
    qint32 getFreeSpace() const;
    void setFreeSpace(const qint32 &free_space);
    ...
    qint32 getTotalSpace() const;
    void setTotalSpace(const qint32 &total_space);
...
Q_DECLARE_METATYPE(OpenAPI::OAINode_full_fileSystems_inner)

#endif // OAINode_full_fileSystems_inner_H
