...
#ifndef OAIValidated_user_H
#define OAIValidated_user_H
...
class OAIValidated_user : public OAIObject {
public:
    OAIValidated_user();
    OAIValidated_user(QString json);
    ~OAIValidated_user() override;
    ...
    void setUserExists(const bool &user_exists);
    bool is_user_exists_Set() const;
    bool is_user_exists_Valid() const;
...
private:
    ...
    bool m_user_exists;
    bool m_user_exists_isSet;
    bool m_user_exists_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIValidated_user)

#endif // OAIValidated_user_H
