...
/*
 * OAITechniques_versions_inner.h
 *
 * 
 */

#ifndef OAITechniques_versions_inner_H
#define OAITechniques_versions_inner_H
...
class OAITechniques_versions_inner : public OAIObject {
public:
    OAITechniques_versions_inner();
    OAITechniques_versions_inner(QString json);
    ~OAITechniques_versions_inner() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITechniques_versions_inner)

#endif // OAITechniques_versions_inner_H
