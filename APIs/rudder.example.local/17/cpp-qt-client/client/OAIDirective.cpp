...
OAIDirective::OAIDirective(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDirective::OAIDirective() {
    this->initializeModel();
}

OAIDirective::~OAIDirective() {}

void OAIDirective::initializeModel() {
...
void OAIDirective::fromJson(QString jsonString) {
...
void OAIDirective::fromJsonObject(QJsonObject json) {
...
QString OAIDirective::asJson() const {
...
QJsonObject OAIDirective::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDirective::getDisplayName() const {
    return m_display_name;
}
void OAIDirective::setDisplayName(const QString &display_name) {
    m_display_name = display_name;
    m_display_name_isSet = true;
}

bool OAIDirective::is_display_name_Set() const{
    return m_display_name_isSet;
}

bool OAIDirective::is_display_name_Valid() const{
    return m_display_name_isValid;
}

bool OAIDirective::isEnabled() const {
    return m_enabled;
}
void OAIDirective::setEnabled(const bool &enabled) {
    m_enabled = enabled;
    m_enabled_isSet = true;
}

bool OAIDirective::is_enabled_Set() const{
    return m_enabled_isSet;
}

bool OAIDirective::is_enabled_Valid() const{
    return m_enabled_isValid;
}

QString OAIDirective::getId() const {
    return m_id;
}
void OAIDirective::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIDirective::is_id_Set() const{
    return m_id_isSet;
}

bool OAIDirective::is_id_Valid() const{
    return m_id_isValid;
}

QString OAIDirective::getLongDescription() const {
    return m_long_description;
}
void OAIDirective::setLongDescription(const QString &long_description) {
    m_long_description = long_description;
    m_long_description_isSet = true;
}

bool OAIDirective::is_long_description_Set() const{
    return m_long_description_isSet;
}

bool OAIDirective::is_long_description_Valid() const{
    return m_long_description_isValid;
}

OAIObject OAIDirective::getParameters() const {
    return m_parameters;
}
void OAIDirective::setParameters(const OAIObject &parameters) {
    m_parameters = parameters;
    m_parameters_isSet = true;
}

bool OAIDirective::is_parameters_Set() const{
    return m_parameters_isSet;
}

bool OAIDirective::is_parameters_Valid() const{
    return m_parameters_isValid;
}

QString OAIDirective::getPolicyMode() const {
    return m_policy_mode;
}
void OAIDirective::setPolicyMode(const QString &policy_mode) {
    m_policy_mode = policy_mode;
    m_policy_mode_isSet = true;
}

bool OAIDirective::is_policy_mode_Set() const{
    return m_policy_mode_isSet;
}

bool OAIDirective::is_policy_mode_Valid() const{
    return m_policy_mode_isValid;
}

qint32 OAIDirective::getPriority() const {
    return m_priority;
}
void OAIDirective::setPriority(const qint32 &priority) {
    m_priority = priority;
    m_priority_isSet = true;
}

bool OAIDirective::is_priority_Set() const{
    return m_priority_isSet;
}

bool OAIDirective::is_priority_Valid() const{
    return m_priority_isValid;
}

QString OAIDirective::getShortDescription() const {
    return m_short_description;
}
void OAIDirective::setShortDescription(const QString &short_description) {
    m_short_description = short_description;
    m_short_description_isSet = true;
}

bool OAIDirective::is_short_description_Set() const{
    return m_short_description_isSet;
}

bool OAIDirective::is_short_description_Valid() const{
    return m_short_description_isValid;
}

bool OAIDirective::isSystem() const {
    return m_system;
}
void OAIDirective::setSystem(const bool &system) {
    m_system = system;
    m_system_isSet = true;
}

bool OAIDirective::is_system_Set() const{
    return m_system_isSet;
}

bool OAIDirective::is_system_Valid() const{
    return m_system_isValid;
}

QList<OAIDirective_tags_inner> OAIDirective::getTags() const {
    return m_tags;
}
void OAIDirective::setTags(const QList<OAIDirective_tags_inner> &tags) {
    m_tags = tags;
    m_tags_isSet = true;
}

bool OAIDirective::is_tags_Set() const{
    return m_tags_isSet;
}

bool OAIDirective::is_tags_Valid() const{
    return m_tags_isValid;
}

QString OAIDirective::getTechniqueName() const {
    return m_technique_name;
}
void OAIDirective::setTechniqueName(const QString &technique_name) {
    m_technique_name = technique_name;
    m_technique_name_isSet = true;
}

bool OAIDirective::is_technique_name_Set() const{
    return m_technique_name_isSet;
}

bool OAIDirective::is_technique_name_Valid() const{
    return m_technique_name_isValid;
}

QString OAIDirective::getTechniqueVersion() const {
    return m_technique_version;
}
void OAIDirective::setTechniqueVersion(const QString &technique_version) {
    m_technique_version = technique_version;
    m_technique_version_isSet = true;
}

bool OAIDirective::is_technique_version_Set() const{
    return m_technique_version_isSet;
}

bool OAIDirective::is_technique_version_Valid() const{
    return m_technique_version_isValid;
}

bool OAIDirective::isSet() const {
...
bool OAIDirective::isValid() const {
