...
OAIDirective_node_compliance_complianceDetails::OAIDirective_node_compliance_complianceDetails(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDirective_node_compliance_complianceDetails::OAIDirective_node_compliance_complianceDetails() {
    this->initializeModel();
}

OAIDirective_node_compliance_complianceDetails::~OAIDirective_node_compliance_complianceDetails() {}

void OAIDirective_node_compliance_complianceDetails::initializeModel() {
...
void OAIDirective_node_compliance_complianceDetails::fromJson(QString jsonString) {
...
void OAIDirective_node_compliance_complianceDetails::fromJsonObject(QJsonObject json) {
...
QString OAIDirective_node_compliance_complianceDetails::asJson() const {
...
QJsonObject OAIDirective_node_compliance_complianceDetails::asJsonObject() const {
    QJsonObject obj;
    if (m_error_isSet) {
...
float OAIDirective_node_compliance_complianceDetails::getError() const {
    return m_error;
}
void OAIDirective_node_compliance_complianceDetails::setError(const float &error) {
    m_error = error;
    m_error_isSet = true;
}

bool OAIDirective_node_compliance_complianceDetails::is_error_Set() const{
    return m_error_isSet;
}

bool OAIDirective_node_compliance_complianceDetails::is_error_Valid() const{
    return m_error_isValid;
}

float OAIDirective_node_compliance_complianceDetails::getNoReport() const {
    return m_no_report;
}
void OAIDirective_node_compliance_complianceDetails::setNoReport(const float &no_report) {
    m_no_report = no_report;
    m_no_report_isSet = true;
}

bool OAIDirective_node_compliance_complianceDetails::is_no_report_Set() const{
    return m_no_report_isSet;
}

bool OAIDirective_node_compliance_complianceDetails::is_no_report_Valid() const{
    return m_no_report_isValid;
}

float OAIDirective_node_compliance_complianceDetails::getSuccessAlreadyOk() const {
    return m_success_already_ok;
}
void OAIDirective_node_compliance_complianceDetails::setSuccessAlreadyOk(const float &success_already_ok) {
    m_success_already_ok = success_already_ok;
    m_success_already_ok_isSet = true;
}

bool OAIDirective_node_compliance_complianceDetails::is_success_already_ok_Set() const{
    return m_success_already_ok_isSet;
}

bool OAIDirective_node_compliance_complianceDetails::is_success_already_ok_Valid() const{
    return m_success_already_ok_isValid;
}

float OAIDirective_node_compliance_complianceDetails::getSuccessNotApplicable() const {
    return m_success_not_applicable;
}
void OAIDirective_node_compliance_complianceDetails::setSuccessNotApplicable(const float &success_not_applicable) {
    m_success_not_applicable = success_not_applicable;
    m_success_not_applicable_isSet = true;
}

bool OAIDirective_node_compliance_complianceDetails::is_success_not_applicable_Set() const{
    return m_success_not_applicable_isSet;
}

bool OAIDirective_node_compliance_complianceDetails::is_success_not_applicable_Valid() const{
    return m_success_not_applicable_isValid;
}

float OAIDirective_node_compliance_complianceDetails::getSuccessRepaired() const {
    return m_success_repaired;
}
void OAIDirective_node_compliance_complianceDetails::setSuccessRepaired(const float &success_repaired) {
    m_success_repaired = success_repaired;
    m_success_repaired_isSet = true;
}

bool OAIDirective_node_compliance_complianceDetails::is_success_repaired_Set() const{
    return m_success_repaired_isSet;
}

bool OAIDirective_node_compliance_complianceDetails::is_success_repaired_Valid() const{
    return m_success_repaired_isValid;
}

float OAIDirective_node_compliance_complianceDetails::getUnexpectedMissingComponent() const {
    return m_unexpected_missing_component;
}
void OAIDirective_node_compliance_complianceDetails::setUnexpectedMissingComponent(const float &unexpected_missing_component) {
    m_unexpected_missing_component = unexpected_missing_component;
    m_unexpected_missing_component_isSet = true;
}

bool OAIDirective_node_compliance_complianceDetails::is_unexpected_missing_component_Set() const{
    return m_unexpected_missing_component_isSet;
}

bool OAIDirective_node_compliance_complianceDetails::is_unexpected_missing_component_Valid() const{
    return m_unexpected_missing_component_isValid;
}

float OAIDirective_node_compliance_complianceDetails::getUnexpectedUnknownComponent() const {
    return m_unexpected_unknown_component;
}
void OAIDirective_node_compliance_complianceDetails::setUnexpectedUnknownComponent(const float &unexpected_unknown_component) {
    m_unexpected_unknown_component = unexpected_unknown_component;
    m_unexpected_unknown_component_isSet = true;
}

bool OAIDirective_node_compliance_complianceDetails::is_unexpected_unknown_component_Set() const{
    return m_unexpected_unknown_component_isSet;
}

bool OAIDirective_node_compliance_complianceDetails::is_unexpected_unknown_component_Valid() const{
    return m_unexpected_unknown_component_isValid;
}

bool OAIDirective_node_compliance_complianceDetails::isSet() const {
...
bool OAIDirective_node_compliance_complianceDetails::isValid() const {
