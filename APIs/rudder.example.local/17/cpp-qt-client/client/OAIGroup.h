...
public:
    ...
    QList<QString> getGroupClass() const;
    void setGroupClass(const QList<QString> &group_class);
    bool is_group_class_Set() const;
    bool is_group_class_Valid() const;
    ...
    OAIGroup_query getQuery() const;
    void setQuery(const OAIGroup_query &query);
...
private:
    ...
    QList<QString> m_group_class;
    bool m_group_class_isSet;
    bool m_group_class_isValid;
