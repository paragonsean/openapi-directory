...
/*
 * OAIGroup_query_where_inner.h
 *
 * 
 */

#ifndef OAIGroup_query_where_inner_H
#define OAIGroup_query_where_inner_H
...
class OAIGroup_query_where_inner : public OAIObject {
public:
    OAIGroup_query_where_inner();
    OAIGroup_query_where_inner(QString json);
    ~OAIGroup_query_where_inner() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGroup_query_where_inner)

#endif // OAIGroup_query_where_inner_H
