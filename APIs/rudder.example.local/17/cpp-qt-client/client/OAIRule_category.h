...
#ifndef OAIRule_category_H
#define OAIRule_category_H
...
class OAIRule_category : public OAIObject {
public:
    OAIRule_category();
    OAIRule_category(QString json);
    ~OAIRule_category() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRule_category)

#endif // OAIRule_category_H
