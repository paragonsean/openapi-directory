...
void OAIGroup::initializeModel() {
    ...
    m_group_class_isSet = false;
    m_group_class_isValid = false;
...
void OAIGroup::fromJsonObject(QJsonObject json) {
    ...
    m_group_class_isValid = ::OpenAPI::fromJsonValue(m_group_class, json[QString("groupClass")]);
    m_group_class_isSet = !json[QString("groupClass")].isNull() && m_group_class_isValid;
...
QJsonObject OAIGroup::asJsonObject() const {
    ...
    if (m_group_class.size() > 0) {
        obj.insert(QString("groupClass"), ::OpenAPI::toJsonValue(m_group_class));
    }
    if (m_id_isSet) {
...
bool OAIGroup::isDynamic() const {
    return m_dynamic;
}
void OAIGroup::setDynamic(const bool &dynamic) {
    m_dynamic = dynamic;
    m_dynamic_isSet = true;
}

bool OAIGroup::is_dynamic_Set() const{
    return m_dynamic_isSet;
}

bool OAIGroup::is_dynamic_Valid() const{
    return m_dynamic_isValid;
}

bool OAIGroup::isEnabled() const {
    return m_enabled;
}
void OAIGroup::setEnabled(const bool &enabled) {
    m_enabled = enabled;
    m_enabled_isSet = true;
}

bool OAIGroup::is_enabled_Set() const{
    return m_enabled_isSet;
}

bool OAIGroup::is_enabled_Valid() const{
    return m_enabled_isValid;
}

QList<QString> OAIGroup::getGroupClass() const {
    return m_group_class;
}
void OAIGroup::setGroupClass(const QList<QString> &group_class) {
    m_group_class = group_class;
    m_group_class_isSet = true;
}

bool OAIGroup::is_group_class_Set() const{
    return m_group_class_isSet;
}

bool OAIGroup::is_group_class_Valid() const{
    return m_group_class_isValid;
}
...
QList<QString> OAIGroup::getNodeIds() const {
    return m_node_ids;
}
void OAIGroup::setNodeIds(const QList<QString> &node_ids) {
    m_node_ids = node_ids;
    m_node_ids_isSet = true;
}

bool OAIGroup::is_node_ids_Set() const{
    return m_node_ids_isSet;
}

bool OAIGroup::is_node_ids_Valid() const{
    return m_node_ids_isValid;
}

QList<OAIGroup_properties_inner> OAIGroup::getProperties() const {
    return m_properties;
}
void OAIGroup::setProperties(const QList<OAIGroup_properties_inner> &properties) {
...
OAIGroup_query OAIGroup::getQuery() const {
    return m_query;
}
void OAIGroup::setQuery(const OAIGroup_query &query) {
    m_query = query;
    m_query_isSet = true;
}

bool OAIGroup::is_query_Set() const{
    return m_query_isSet;
}

bool OAIGroup::is_query_Valid() const{
