...
/*
 * OAICampaign_schedule_oneshot.h
 *
 * 
 */

#ifndef OAICampaign_schedule_oneshot_H
#define OAICampaign_schedule_oneshot_H
...
class OAICampaign_schedule_oneshot : public OAIObject {
public:
    OAICampaign_schedule_oneshot();
    OAICampaign_schedule_oneshot(QString json);
    ~OAICampaign_schedule_oneshot() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICampaign_schedule_oneshot)

#endif // OAICampaign_schedule_oneshot_H
