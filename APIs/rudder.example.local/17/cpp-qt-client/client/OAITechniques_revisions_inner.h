...
/*
 * OAITechniques_revisions_inner.h
 *
 * 
 */

#ifndef OAITechniques_revisions_inner_H
#define OAITechniques_revisions_inner_H
...
class OAITechniques_revisions_inner : public OAIObject {
public:
    OAITechniques_revisions_inner();
    OAITechniques_revisions_inner(QString json);
    ~OAITechniques_revisions_inner() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITechniques_revisions_inner)

#endif // OAITechniques_revisions_inner_H
