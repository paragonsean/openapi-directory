...
OAIRule_compliance_component_complianceDetails::OAIRule_compliance_component_complianceDetails(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIRule_compliance_component_complianceDetails::OAIRule_compliance_component_complianceDetails() {
    this->initializeModel();
}

OAIRule_compliance_component_complianceDetails::~OAIRule_compliance_component_complianceDetails() {}

void OAIRule_compliance_component_complianceDetails::initializeModel() {
...
void OAIRule_compliance_component_complianceDetails::fromJson(QString jsonString) {
...
void OAIRule_compliance_component_complianceDetails::fromJsonObject(QJsonObject json) {
...
QString OAIRule_compliance_component_complianceDetails::asJson() const {
...
QJsonObject OAIRule_compliance_component_complianceDetails::asJsonObject() const {
    QJsonObject obj;
    if (m_error_isSet) {
...
float OAIRule_compliance_component_complianceDetails::getError() const {
    return m_error;
}
void OAIRule_compliance_component_complianceDetails::setError(const float &error) {
    m_error = error;
    m_error_isSet = true;
}

bool OAIRule_compliance_component_complianceDetails::is_error_Set() const{
    return m_error_isSet;
}

bool OAIRule_compliance_component_complianceDetails::is_error_Valid() const{
    return m_error_isValid;
}

float OAIRule_compliance_component_complianceDetails::getNoReport() const {
    return m_no_report;
}
void OAIRule_compliance_component_complianceDetails::setNoReport(const float &no_report) {
    m_no_report = no_report;
    m_no_report_isSet = true;
}

bool OAIRule_compliance_component_complianceDetails::is_no_report_Set() const{
    return m_no_report_isSet;
}

bool OAIRule_compliance_component_complianceDetails::is_no_report_Valid() const{
    return m_no_report_isValid;
}

float OAIRule_compliance_component_complianceDetails::getSuccessAlreadyOk() const {
    return m_success_already_ok;
}
void OAIRule_compliance_component_complianceDetails::setSuccessAlreadyOk(const float &success_already_ok) {
    m_success_already_ok = success_already_ok;
    m_success_already_ok_isSet = true;
}

bool OAIRule_compliance_component_complianceDetails::is_success_already_ok_Set() const{
    return m_success_already_ok_isSet;
}

bool OAIRule_compliance_component_complianceDetails::is_success_already_ok_Valid() const{
    return m_success_already_ok_isValid;
}

float OAIRule_compliance_component_complianceDetails::getSuccessNotApplicable() const {
    return m_success_not_applicable;
}
void OAIRule_compliance_component_complianceDetails::setSuccessNotApplicable(const float &success_not_applicable) {
    m_success_not_applicable = success_not_applicable;
    m_success_not_applicable_isSet = true;
}

bool OAIRule_compliance_component_complianceDetails::is_success_not_applicable_Set() const{
    return m_success_not_applicable_isSet;
}

bool OAIRule_compliance_component_complianceDetails::is_success_not_applicable_Valid() const{
    return m_success_not_applicable_isValid;
}

float OAIRule_compliance_component_complianceDetails::getSuccessRepaired() const {
    return m_success_repaired;
}
void OAIRule_compliance_component_complianceDetails::setSuccessRepaired(const float &success_repaired) {
    m_success_repaired = success_repaired;
    m_success_repaired_isSet = true;
}

bool OAIRule_compliance_component_complianceDetails::is_success_repaired_Set() const{
    return m_success_repaired_isSet;
}

bool OAIRule_compliance_component_complianceDetails::is_success_repaired_Valid() const{
    return m_success_repaired_isValid;
}

float OAIRule_compliance_component_complianceDetails::getUnexpectedMissingComponent() const {
    return m_unexpected_missing_component;
}
void OAIRule_compliance_component_complianceDetails::setUnexpectedMissingComponent(const float &unexpected_missing_component) {
    m_unexpected_missing_component = unexpected_missing_component;
    m_unexpected_missing_component_isSet = true;
}

bool OAIRule_compliance_component_complianceDetails::is_unexpected_missing_component_Set() const{
    return m_unexpected_missing_component_isSet;
}

bool OAIRule_compliance_component_complianceDetails::is_unexpected_missing_component_Valid() const{
    return m_unexpected_missing_component_isValid;
}

float OAIRule_compliance_component_complianceDetails::getUnexpectedUnknownComponent() const {
    return m_unexpected_unknown_component;
}
void OAIRule_compliance_component_complianceDetails::setUnexpectedUnknownComponent(const float &unexpected_unknown_component) {
    m_unexpected_unknown_component = unexpected_unknown_component;
    m_unexpected_unknown_component_isSet = true;
}

bool OAIRule_compliance_component_complianceDetails::is_unexpected_unknown_component_Set() const{
    return m_unexpected_unknown_component_isSet;
}

bool OAIRule_compliance_component_complianceDetails::is_unexpected_unknown_component_Valid() const{
    return m_unexpected_unknown_component_isValid;
}

bool OAIRule_compliance_component_complianceDetails::isSet() const {
...
bool OAIRule_compliance_component_complianceDetails::isValid() const {
