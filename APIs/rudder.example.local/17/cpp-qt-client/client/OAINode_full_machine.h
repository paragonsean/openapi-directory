...
/*
 * OAINode_full_machine.h
 *
 * Information about the underlying machine
 */

#ifndef OAINode_full_machine_H
#define OAINode_full_machine_H
...
class OAINode_full_machine : public OAIObject {
public:
    OAINode_full_machine();
    OAINode_full_machine(QString json);
    ~OAINode_full_machine() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAINode_full_machine)

#endif // OAINode_full_machine_H
