...
/*
 * OAICampaign_schedule_monthly_end.h
 *
 * Date when the campaign should end
 */

#ifndef OAICampaign_schedule_monthly_end_H
#define OAICampaign_schedule_monthly_end_H
...
class OAICampaign_schedule_monthly_end : public OAIObject {
public:
    OAICampaign_schedule_monthly_end();
    OAICampaign_schedule_monthly_end(QString json);
    ~OAICampaign_schedule_monthly_end() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICampaign_schedule_monthly_end)

#endif // OAICampaign_schedule_monthly_end_H
