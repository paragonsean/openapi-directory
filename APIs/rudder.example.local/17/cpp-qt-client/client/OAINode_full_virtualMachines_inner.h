...
/*
 * OAINode_full_virtualMachines_inner.h
 *
 * 
 */

#ifndef OAINode_full_virtualMachines_inner_H
#define OAINode_full_virtualMachines_inner_H
...
class OAINode_full_virtualMachines_inner : public OAIObject {
public:
    OAINode_full_virtualMachines_inner();
    OAINode_full_virtualMachines_inner(QString json);
    ~OAINode_full_virtualMachines_inner() override;
    ...
    bool is_subsystem_Set() const;
    bool is_subsystem_Valid() const;
...
private:
    ...
    QString m_subsystem;
    bool m_subsystem_isSet;
    bool m_subsystem_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAINode_full_virtualMachines_inner)

#endif // OAINode_full_virtualMachines_inner_H
