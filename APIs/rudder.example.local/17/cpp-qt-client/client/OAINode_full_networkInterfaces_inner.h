...
/*
 * OAINode_full_networkInterfaces_inner.h
 *
 * 
 */

#ifndef OAINode_full_networkInterfaces_inner_H
#define OAINode_full_networkInterfaces_inner_H
...
class OAINode_full_networkInterfaces_inner : public OAIObject {
public:
    OAINode_full_networkInterfaces_inner();
    OAINode_full_networkInterfaces_inner(QString json);
    ~OAINode_full_networkInterfaces_inner() override;
    ...
    QList<QString> getMask() const;
    void setMask(const QList<QString> &mask);
...
Q_DECLARE_METATYPE(OpenAPI::OAINode_full_networkInterfaces_inner)

#endif // OAINode_full_networkInterfaces_inner_H
