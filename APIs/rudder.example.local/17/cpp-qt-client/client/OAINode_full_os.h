...
#ifndef OAINode_full_os_H
#define OAINode_full_os_H
...
class OAINode_full_os : public OAIObject {
public:
    OAINode_full_os();
    OAINode_full_os(QString json);
    ~OAINode_full_os() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAINode_full_os)

#endif // OAINode_full_os_H
