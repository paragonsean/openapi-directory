...
public:
    ...
    void setOverridable(const bool &overridable);
    bool is_overridable_Set() const;
    bool is_overridable_Valid() const;
...
private:
    ...
    bool m_overridable;
    bool m_overridable_isSet;
    bool m_overridable_isValid;
