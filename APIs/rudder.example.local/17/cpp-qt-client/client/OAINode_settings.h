...
#ifndef OAINode_settings_H
#define OAINode_settings_H
...
class OAINode_settings : public OAIObject {
public:
    OAINode_settings();
    OAINode_settings(QString json);
    ~OAINode_settings() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAINode_settings)

#endif // OAINode_settings_H
