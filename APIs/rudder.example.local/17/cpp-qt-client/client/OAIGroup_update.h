...
#ifndef OAIGroup_update_H
#define OAIGroup_update_H
...
class OAIGroup_update : public OAIObject {
public:
    OAIGroup_update();
    OAIGroup_update(QString json);
    ~OAIGroup_update() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGroup_update)

#endif // OAIGroup_update_H
