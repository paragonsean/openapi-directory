...
void OAIParameter::initializeModel() {
    ...
    m_overridable_isSet = false;
    m_overridable_isValid = false;
...
void OAIParameter::fromJsonObject(QJsonObject json) {
    ...
    m_overridable_isValid = ::OpenAPI::fromJsonValue(m_overridable, json[QString("overridable")]);
    m_overridable_isSet = !json[QString("overridable")].isNull() && m_overridable_isValid;
...
QJsonObject OAIParameter::asJsonObject() const {
    ...
    if (m_overridable_isSet) {
        obj.insert(QString("overridable"), ::OpenAPI::toJsonValue(m_overridable));
    }
    if (m_value_isSet) {
...
QString OAIParameter::getId() const {
    return m_id;
}
void OAIParameter::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}
...
bool OAIParameter::isOverridable() const {
    return m_overridable;
}
void OAIParameter::setOverridable(const bool &overridable) {
    m_overridable = overridable;
    m_overridable_isSet = true;
}

bool OAIParameter::is_overridable_Set() const{
    return m_overridable_isSet;
}

bool OAIParameter::is_overridable_Valid() const{
    return m_overridable_isValid;
}
