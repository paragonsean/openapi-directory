...
QList<QString> OAIRule::getDirectives() const {
    return m_directives;
}
void OAIRule::setDirectives(const QList<QString> &directives) {
    m_directives = directives;
    m_directives_isSet = true;
}

bool OAIRule::is_directives_Set() const{
    return m_directives_isSet;
}

bool OAIRule::is_directives_Valid() const{
...
QString OAIRule::getLongDescription() const {
    return m_long_description;
}
void OAIRule::setLongDescription(const QString &long_description) {
    m_long_description = long_description;
    m_long_description_isSet = true;
}

bool OAIRule::is_long_description_Set() const{
    return m_long_description_isSet;
}

bool OAIRule::is_long_description_Valid() const{
    return m_long_description_isValid;
}

QString OAIRule::getShortDescription() const {
    return m_short_description;
}
void OAIRule::setShortDescription(const QString &short_description) {
    m_short_description = short_description;
    m_short_description_isSet = true;
}

bool OAIRule::is_short_description_Set() const{
    return m_short_description_isSet;
}

bool OAIRule::is_short_description_Valid() const{
    return m_short_description_isValid;
}

bool OAIRule::isSystem() const {
    return m_system;
}
void OAIRule::setSystem(const bool &system) {
    m_system = system;
    m_system_isSet = true;
}

bool OAIRule::is_system_Set() const{
    return m_system_isSet;
}

bool OAIRule::is_system_Valid() const{
    return m_system_isValid;
}

QList<OAIDirective_tags_inner> OAIRule::getTags() const {
    return m_tags;
}
void OAIRule::setTags(const QList<OAIDirective_tags_inner> &tags) {
    m_tags = tags;
    m_tags_isSet = true;
}
...
QList<OAIRule_targets_inner> OAIRule::getTargets() const {
    return m_targets;
}
void OAIRule::setTargets(const QList<OAIRule_targets_inner> &targets) {
    m_targets = targets;
    m_targets_isSet = true;
}

bool OAIRule::is_targets_Set() const{
    return m_targets_isSet;
}

bool OAIRule::is_targets_Valid() const{
