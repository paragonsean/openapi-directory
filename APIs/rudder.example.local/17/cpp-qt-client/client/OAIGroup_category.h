...
#ifndef OAIGroup_category_H
#define OAIGroup_category_H
...
class OAIGroup_category : public OAIObject {
public:
    OAIGroup_category();
    OAIGroup_category(QString json);
    ~OAIGroup_category() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGroup_category)

#endif // OAIGroup_category_H
