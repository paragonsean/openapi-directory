...
QString OAICheck::getMsg() const {
    return m_msg;
}
void OAICheck::setMsg(const QString &msg) {
    m_msg = msg;
    m_msg_isSet = true;
}

bool OAICheck::is_msg_Set() const{
    return m_msg_isSet;
}

bool OAICheck::is_msg_Valid() const{
    return m_msg_isValid;
}

QString OAICheck::getName() const {
    return m_name;
}
void OAICheck::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAICheck::is_name_Set() const{
    return m_name_isSet;
}

bool OAICheck::is_name_Valid() const{
...
bool OAICheck::isValid() const {
    ...
    return m_msg_isValid && m_name_isValid && m_status_isValid && true;
}
