...
#ifndef OAIChange_request_H
#define OAIChange_request_H
...
namespace OpenAPI {
class OAIChange_request_changes;

class OAIChange_request : public OAIObject {
public:
    OAIChange_request();
    OAIChange_request(QString json);
    ~OAIChange_request() override;
    ...
    bool is_acceptable_Set() const;
    bool is_acceptable_Valid() const;

    OAIChange_request_changes getChanges() const;
    void setChanges(const OAIChange_request_changes &changes);
...
private:
    ...
    bool m_acceptable;
    bool m_acceptable_isSet;
    bool m_acceptable_isValid;

    OAIChange_request_changes m_changes;
...
Q_DECLARE_METATYPE(OpenAPI::OAIChange_request)

#endif // OAIChange_request_H
