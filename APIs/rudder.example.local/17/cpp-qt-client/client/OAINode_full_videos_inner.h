...
/*
 * OAINode_full_videos_inner.h
 *
 * 
 */

#ifndef OAINode_full_videos_inner_H
#define OAINode_full_videos_inner_H
...
class OAINode_full_videos_inner : public OAIObject {
public:
    OAINode_full_videos_inner();
    OAINode_full_videos_inner(QString json);
    ~OAINode_full_videos_inner() override;
    ...
    void setChipset(const QString &chipset);
    bool is_chipset_Set() const;
    bool is_chipset_Valid() const;
...
private:
    ...
    QString m_chipset;
    bool m_chipset_isSet;
    bool m_chipset_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAINode_full_videos_inner)

#endif // OAINode_full_videos_inner_H
