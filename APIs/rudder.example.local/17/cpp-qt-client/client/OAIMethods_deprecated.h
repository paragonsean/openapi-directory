...
/*
 * OAIMethods_deprecated.h
 *
 * Is this method deprecated?
 */

#ifndef OAIMethods_deprecated_H
#define OAIMethods_deprecated_H
...
class OAIMethods_deprecated : public OAIObject {
public:
    OAIMethods_deprecated();
    OAIMethods_deprecated(QString json);
    ~OAIMethods_deprecated() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMethods_deprecated)

#endif // OAIMethods_deprecated_H
