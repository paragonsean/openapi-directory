...
/*
 * OAICveDetails_cvssv2.h
 *
 * CVSS V2 of the CVE
 */

#ifndef OAICveDetails_cvssv2_H
#define OAICveDetails_cvssv2_H
...
class OAICveDetails_cvssv2 : public OAIObject {
public:
    OAICveDetails_cvssv2();
    OAICveDetails_cvssv2(QString json);
    ~OAICveDetails_cvssv2() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICveDetails_cvssv2)

#endif // OAICveDetails_cvssv2_H
