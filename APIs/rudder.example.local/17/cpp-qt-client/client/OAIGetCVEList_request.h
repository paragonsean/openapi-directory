...
/*
 * OAIGetCVEList_request.h
 *
 * List of CVE ids you want
 */

#ifndef OAIGetCVEList_request_H
#define OAIGetCVEList_request_H
...
class OAIGetCVEList_request : public OAIObject {
public:
    OAIGetCVEList_request();
    OAIGetCVEList_request(QString json);
    ~OAIGetCVEList_request() override;
    ...
    QString getMinScore() const;
    void setMinScore(const QString &min_score);
    bool is_min_score_Set() const;
    bool is_min_score_Valid() const;

    bool isOnlyScore() const;
    void setOnlyScore(const bool &only_score);
    bool is_only_score_Set() const;
    bool is_only_score_Valid() const;
...
private:
    ...
    bool m_only_score;
    bool m_only_score_isSet;
    bool m_only_score_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetCVEList_request)

#endif // OAIGetCVEList_request_H
