...
bool OAILogo::isEnable() const {
    return m_enable;
}
void OAILogo::setEnable(const bool &enable) {
    m_enable = enable;
    m_enable_isSet = true;
}

bool OAILogo::is_enable_Set() const{
    return m_enable_isSet;
}

bool OAILogo::is_enable_Valid() const{
