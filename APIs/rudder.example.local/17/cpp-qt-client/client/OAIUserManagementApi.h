...
#include "OAIAddUser_200_response.h"
#include "OAIDeleteUser_200_response.h"
#include "OAIGetRole_200_response.h"
#include "OAIGetUserInfo_200_response.h"
#include "OAIReloadUserConf_200_response.h"
...
public:
    ...
    /**
    * @param[in]  oai_users OAIUsers [required]
    */
    virtual void addUser(const OAIUsers &oai_users);
    ...
    */
    ...
    virtual void reloadUserConf();

    /**
    * @param[in]  username QString [required]
    * @param[in]  oai_users OAIUsers [required]
    */
    virtual void updateUser(const QString &username, const OAIUsers &oai_users);
...
private:
    ...
    void reloadUserConfCallback(OAIHttpRequestWorker *worker);
    void updateUserCallback(OAIHttpRequestWorker *worker);

Q_SIGNALS:

    void addUserSignal(OAIAddUser_200_response summary);
    void deleteUserSignal(OAIDeleteUser_200_response summary);
    void getRoleSignal(OAIGetRole_200_response summary);
    void getUserInfoSignal(OAIGetUserInfo_200_response summary);
    void reloadUserConfSignal(OAIReloadUserConf_200_response summary);
    void updateUserSignal(OAIUpdateUser_200_response summary);


    void addUserSignalFull(OAIHttpRequestWorker *worker, OAIAddUser_200_response summary);
    void deleteUserSignalFull(OAIHttpRequestWorker *worker, OAIDeleteUser_200_response summary);
    void getRoleSignalFull(OAIHttpRequestWorker *worker, OAIGetRole_200_response summary);
    void getUserInfoSignalFull(OAIHttpRequestWorker *worker, OAIGetUserInfo_200_response summary);
    void reloadUserConfSignalFull(OAIHttpRequestWorker *worker, OAIReloadUserConf_200_response summary);
    ...
    void addUserSignalE(OAIAddUser_200_response summary, QNetworkReply::NetworkError error_type, QString error_str);
    void addUserSignalError(OAIAddUser_200_response summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    void getRoleSignalE(OAIGetRole_200_response summary, QNetworkReply::NetworkError error_type, QString error_str);
    void getRoleSignalError(OAIGetRole_200_response summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use getUserInfoSignalError() instead")
    void getUserInfoSignalE(OAIGetUserInfo_200_response summary, QNetworkReply::NetworkError error_type, QString error_str);
    void getUserInfoSignalError(OAIGetUserInfo_200_response summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use reloadUserConfSignalError() instead")
    void reloadUserConfSignalE(OAIReloadUserConf_200_response summary, QNetworkReply::NetworkError error_type, QString error_str);
    void reloadUserConfSignalError(OAIReloadUserConf_200_response summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use reloadUserConfSignalErrorFull() instead")
    void reloadUserConfSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void reloadUserConfSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
