...
#ifndef OAIRule_new_H
#define OAIRule_new_H
...
class OAIRule_new : public OAIObject {
public:
    OAIRule_new();
    OAIRule_new(QString json);
    ~OAIRule_new() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRule_new)
