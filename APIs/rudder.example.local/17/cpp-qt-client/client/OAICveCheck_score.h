...
#ifndef OAICveCheck_score_H
#define OAICveCheck_score_H
...
class OAICveCheck_score : public OAIObject {
public:
    OAICveCheck_score();
    OAICveCheck_score(QString json);
    ~OAICveCheck_score() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICveCheck_score)

#endif // OAICveCheck_score_H
