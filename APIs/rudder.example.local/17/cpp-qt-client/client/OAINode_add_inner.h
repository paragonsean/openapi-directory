...
#ifndef OAINode_add_inner_H
#define OAINode_add_inner_H

#include <QJsonObject>

#include "OAIAgent_key.h"
...
class OAINode_add_inner : public OAIObject {
public:
    OAINode_add_inner();
    OAINode_add_inner(QString json);
    ~OAINode_add_inner() override;
    ...
    OAIAgent_key getAgentKey() const;
    void setAgentKey(const OAIAgent_key &agent_key);
    bool is_agent_key_Set() const;
    bool is_agent_key_Valid() const;
...
private:
    ...
    OAIAgent_key m_agent_key;
    bool m_agent_key_isSet;
    bool m_agent_key_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAINode_add_inner)

#endif // OAINode_add_inner_H
