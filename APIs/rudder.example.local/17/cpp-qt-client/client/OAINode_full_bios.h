...
#ifndef OAINode_full_bios_H
#define OAINode_full_bios_H
...
class OAINode_full_bios : public OAIObject {
public:
    OAINode_full_bios();
    OAINode_full_bios(QString json);
    ~OAINode_full_bios() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAINode_full_bios)

#endif // OAINode_full_bios_H
