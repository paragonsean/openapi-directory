...
/*
 * OAINode_full_storage_inner.h
 *
 * 
 */

#ifndef OAINode_full_storage_inner_H
#define OAINode_full_storage_inner_H
...
class OAINode_full_storage_inner : public OAIObject {
public:
    OAINode_full_storage_inner();
    OAINode_full_storage_inner(QString json);
    ~OAINode_full_storage_inner() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAINode_full_storage_inner)

#endif // OAINode_full_storage_inner_H
