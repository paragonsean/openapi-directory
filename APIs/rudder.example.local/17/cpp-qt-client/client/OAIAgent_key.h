...
#ifndef OAIAgent_key_H
#define OAIAgent_key_H
...
class OAIAgent_key : public OAIObject {
public:
    OAIAgent_key();
    OAIAgent_key(QString json);
    ~OAIAgent_key() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAgent_key)

#endif // OAIAgent_key_H
