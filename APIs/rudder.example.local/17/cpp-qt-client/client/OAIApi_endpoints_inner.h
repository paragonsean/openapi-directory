...
#ifndef OAIApi_endpoints_inner_H
#define OAIApi_endpoints_inner_H
...
class OAIApi_endpoints_inner : public OAIObject {
public:
    OAIApi_endpoints_inner();
    OAIApi_endpoints_inner(QString json);
    ~OAIApi_endpoints_inner() override;
    ...
    QJsonValue getHttpVerb() const;
    void setHttpVerb(const QJsonValue &http_verb);
...
Q_DECLARE_METATYPE(OpenAPI::OAIApi_endpoints_inner)

#endif // OAIApi_endpoints_inner_H
