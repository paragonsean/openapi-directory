...
/*
 * OAICampaign_schedule_monthly_start.h
 *
 * Date when the campaign should start
 */

#ifndef OAICampaign_schedule_monthly_start_H
#define OAICampaign_schedule_monthly_start_H
...
class OAICampaign_schedule_monthly_start : public OAIObject {
public:
    OAICampaign_schedule_monthly_start();
    OAICampaign_schedule_monthly_start(QString json);
    ~OAICampaign_schedule_monthly_start() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICampaign_schedule_monthly_start)

#endif // OAICampaign_schedule_monthly_start_H
