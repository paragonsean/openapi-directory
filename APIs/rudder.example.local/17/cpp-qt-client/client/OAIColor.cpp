...
double OAIColor::getAlpha() const {
    return m_alpha;
}
void OAIColor::setAlpha(const double &alpha) {
    m_alpha = alpha;
    m_alpha_isSet = true;
}
...
double OAIColor::getBlue() const {
    return m_blue;
}
void OAIColor::setBlue(const double &blue) {
    m_blue = blue;
    m_blue_isSet = true;
}
...
double OAIColor::getGreen() const {
    return m_green;
}
void OAIColor::setGreen(const double &green) {
    m_green = green;
    m_green_isSet = true;
}
...
double OAIColor::getRed() const {
    return m_red;
}
void OAIColor::setRed(const double &red) {
    m_red = red;
    m_red_isSet = true;
}
...
bool OAIColor::isValid() const {
    ...
    return m_alpha_isValid && m_blue_isValid && m_green_isValid && m_red_isValid && true;
}
