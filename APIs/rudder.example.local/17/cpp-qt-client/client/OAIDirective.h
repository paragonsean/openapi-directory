...
#ifndef OAIDirective_H
#define OAIDirective_H
...
class OAIDirective : public OAIObject {
public:
    OAIDirective();
    OAIDirective(QString json);
    ~OAIDirective() override;
    ...
    QString getTechniqueName() const;
    void setTechniqueName(const QString &technique_name);
    bool is_technique_name_Set() const;
    bool is_technique_name_Valid() const;

    QString getTechniqueVersion() const;
    void setTechniqueVersion(const QString &technique_version);
    bool is_technique_version_Set() const;
    bool is_technique_version_Valid() const;
...
private:
    ...
    QString m_technique_name;
    bool m_technique_name_isSet;
    bool m_technique_name_isValid;

    QString m_technique_version;
    bool m_technique_version_isSet;
    bool m_technique_version_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIDirective)

#endif // OAIDirective_H
