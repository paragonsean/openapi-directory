...
/*
 * OAIMethods_condition.h
 *
 * Conditions generated by this method
 */

#ifndef OAIMethods_condition_H
#define OAIMethods_condition_H
...
class OAIMethods_condition : public OAIObject {
public:
    OAIMethods_condition();
    OAIMethods_condition(QString json);
    ~OAIMethods_condition() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMethods_condition)

#endif // OAIMethods_condition_H
