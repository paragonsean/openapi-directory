...
#include "OAIDirective_tags_inner.h"
#include "OAIRule_targets_inner.h"
#include <QList>
#include <QString>
...
namespace OpenAPI {
class OAIDirective_tags_inner;
class OAIRule_targets_inner;
...
public:
    ...
    QList<QString> getDirectives() const;
    void setDirectives(const QList<QString> &directives);
    bool is_directives_Set() const;
    bool is_directives_Valid() const;
    ...
    QList<OAIDirective_tags_inner> getTags() const;
    void setTags(const QList<OAIDirective_tags_inner> &tags);
    bool is_tags_Set() const;
    bool is_tags_Valid() const;

    QList<OAIRule_targets_inner> getTargets() const;
    void setTargets(const QList<OAIRule_targets_inner> &targets);
...
private:
    ...
    QList<QString> m_directives;
    bool m_directives_isSet;
    bool m_directives_isValid;
    ...
    QList<OAIDirective_tags_inner> m_tags;
    bool m_tags_isSet;
    bool m_tags_isValid;

    QList<OAIRule_targets_inner> m_targets;
