...
class GroupQuery(Model):
    ...
    def __init__(self, composition: str='and', select: str='node', where: List[GroupQueryWhereInner]=None):
        ...
        :param composition: The composition of this GroupQuery.
        :param select: The select of this GroupQuery.
        :param where: The where of this GroupQuery.
        """
        self.openapi_types = {
            'composition': str,
            'select': str,
    ...
    def from_dict(cls, dikt: dict) -> 'GroupQuery':
        ...
        :param dikt: A dict.
        :return: The group_query of this GroupQuery.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def composition(self):
        """Gets the composition of this GroupQuery.

        Boolean operator to use between each  `where` criteria.

        :return: The composition of this GroupQuery.
        :rtype: str
        """
    ...
    def composition(self, composition):
        """Sets the composition of this GroupQuery.
    ...
    @property
    def select(self):
        """Gets the select of this GroupQuery.
        ...
        :return: The select of this GroupQuery.
        :rtype: str
        """
        return self._select
    ...
    def select(self, select):
        """Sets the select of this GroupQuery.
    ...
    @property
    def where(self):
        """Gets the where of this GroupQuery.

        List of criteria

        :return: The where of this GroupQuery.
    ...
    def where(self, where):
        """Sets the where of this GroupQuery.
