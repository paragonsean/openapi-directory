# FunTranslationsBrailleApi.BrailleApi
...
```javascript
import FunTranslationsBrailleApi from 'fun_translations_braille_api';
let defaultClient = FunTranslationsBrailleApi.ApiClient.instance;
...
let apiInstance = new FunTranslationsBrailleApi.BrailleApi();
