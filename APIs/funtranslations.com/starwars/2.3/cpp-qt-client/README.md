...
#include <iostream>
#include "../client/OAIStarwarsApi.h"
...
void Example::exampleFunction1(){
     OAIStarwarsApi apiInstance;
     
      // Configure API key authorization: X-Funtranslations-Api-Secret
      apiInstance.setApiKey("YOUR API KEY NAME","YOUR API KEY");

      QEventLoop loop;
      connect(&apiInstance, &OAIStarwarsApi::translateCheunhGetSignal, [&]() {
          loop.quit();
      });
      connect(&apiInstance, &OAIStarwarsApi::translateCheunhGetSignalE, [&](QNetworkReply::NetworkError, QString error_str) {
