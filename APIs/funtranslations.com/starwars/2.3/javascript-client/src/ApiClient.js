...
class ApiClient {
     ...
     */
    constructor(basePath = 'https://api.funtranslations.com') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default https://api.funtranslations.com
         */
        ...
        this.authentications = {
            'X-Funtranslations-Api-Secret': {type: 'apiKey', 'in': 'header', name: 'X-Funtranslations-Api-Secret'}
        }
         ...
         */
        this.defaultHeaders = {
            'User-Agent': 'OpenAPI-Generator/2.3/Javascript'
        };
