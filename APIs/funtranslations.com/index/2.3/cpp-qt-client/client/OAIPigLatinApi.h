...
#ifndef OAI_OAIPigLatinApi_H
#define OAI_OAIPigLatinApi_H
...
class OAIPigLatinApi : public QObject {
    Q_OBJECT

public:
    OAIPigLatinApi(const int timeOut = 0);
    ~OAIPigLatinApi();
    ...
    */
    virtual void translatePiglatinGet(const QString &text);
...
private:
    ...
    void translatePiglatinGetCallback(OAIHttpRequestWorker *worker);

Q_SIGNALS:

    void translatePiglatinGetSignal();


    void translatePiglatinGetSignalFull(OAIHttpRequestWorker *worker);

    Q_DECL_DEPRECATED_X("Use translatePiglatinGetSignalError() instead")
    void translatePiglatinGetSignalE(QNetworkReply::NetworkError error_type, QString error_str);
    void translatePiglatinGetSignalError(QNetworkReply::NetworkError error_type, const QString &error_str);

    Q_DECL_DEPRECATED_X("Use translatePiglatinGetSignalErrorFull() instead")
    void translatePiglatinGetSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void translatePiglatinGetSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
