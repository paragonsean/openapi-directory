...
#ifndef OAI_OAIStartrekApi_H
#define OAI_OAIStartrekApi_H
...
class OAIStartrekApi : public QObject {
    Q_OBJECT

public:
    OAIStartrekApi(const int timeOut = 0);
    ~OAIStartrekApi();
    ...
    */
    virtual void translateKlingonGet(const QString &text);

    /**
    * @param[in]  text QString [required]
    */
    virtual void translateVulcanGet(const QString &text);
...
private:
    ...
    void translateKlingonGetCallback(OAIHttpRequestWorker *worker);
    void translateVulcanGetCallback(OAIHttpRequestWorker *worker);

Q_SIGNALS:

    void translateKlingonGetSignal();
    void translateVulcanGetSignal();


    void translateKlingonGetSignalFull(OAIHttpRequestWorker *worker);
    void translateVulcanGetSignalFull(OAIHttpRequestWorker *worker);

    Q_DECL_DEPRECATED_X("Use translateKlingonGetSignalError() instead")
    void translateKlingonGetSignalE(QNetworkReply::NetworkError error_type, QString error_str);
    void translateKlingonGetSignalError(QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use translateVulcanGetSignalError() instead")
    void translateVulcanGetSignalE(QNetworkReply::NetworkError error_type, QString error_str);
    void translateVulcanGetSignalError(QNetworkReply::NetworkError error_type, const QString &error_str);

    Q_DECL_DEPRECATED_X("Use translateKlingonGetSignalErrorFull() instead")
    void translateKlingonGetSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void translateKlingonGetSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use translateVulcanGetSignalErrorFull() instead")
    void translateVulcanGetSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void translateVulcanGetSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
