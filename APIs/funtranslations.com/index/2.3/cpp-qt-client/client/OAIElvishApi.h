...
#ifndef OAI_OAIElvishApi_H
#define OAI_OAIElvishApi_H
...
class OAIElvishApi : public QObject {
    Q_OBJECT

public:
    OAIElvishApi(const int timeOut = 0);
    ~OAIElvishApi();
    ...
    */
    virtual void translateQuneyaGet(const QString &text);

    /**
    * @param[in]  text QString [required]
    */
    virtual void translateSindarinGet(const QString &text);
...
private:
    ...
    void translateQuneyaGetCallback(OAIHttpRequestWorker *worker);
    void translateSindarinGetCallback(OAIHttpRequestWorker *worker);

Q_SIGNALS:

    void translateQuneyaGetSignal();
    void translateSindarinGetSignal();


    void translateQuneyaGetSignalFull(OAIHttpRequestWorker *worker);
    void translateSindarinGetSignalFull(OAIHttpRequestWorker *worker);

    Q_DECL_DEPRECATED_X("Use translateQuneyaGetSignalError() instead")
    void translateQuneyaGetSignalE(QNetworkReply::NetworkError error_type, QString error_str);
    void translateQuneyaGetSignalError(QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use translateSindarinGetSignalError() instead")
    void translateSindarinGetSignalE(QNetworkReply::NetworkError error_type, QString error_str);
    void translateSindarinGetSignalError(QNetworkReply::NetworkError error_type, const QString &error_str);

    Q_DECL_DEPRECATED_X("Use translateQuneyaGetSignalErrorFull() instead")
    void translateQuneyaGetSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void translateQuneyaGetSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use translateSindarinGetSignalErrorFull() instead")
    void translateSindarinGetSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void translateSindarinGetSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
