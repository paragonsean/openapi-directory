...
#ifndef OAI_OAIInternetFADApi_H
#define OAI_OAIInternetFADApi_H
...
class OAIInternetFADApi : public QObject {
    Q_OBJECT

public:
    OAIInternetFADApi(const int timeOut = 0);
    ~OAIInternetFADApi();
    ...
    */
    virtual void translateErmahgerdGet(const QString &text);
...
private:
    ...
    void translateErmahgerdGetCallback(OAIHttpRequestWorker *worker);

Q_SIGNALS:

    void translateErmahgerdGetSignal();


    void translateErmahgerdGetSignalFull(OAIHttpRequestWorker *worker);

    Q_DECL_DEPRECATED_X("Use translateErmahgerdGetSignalError() instead")
    void translateErmahgerdGetSignalE(QNetworkReply::NetworkError error_type, QString error_str);
    void translateErmahgerdGetSignalError(QNetworkReply::NetworkError error_type, const QString &error_str);

    Q_DECL_DEPRECATED_X("Use translateErmahgerdGetSignalErrorFull() instead")
    void translateErmahgerdGetSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void translateErmahgerdGetSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
