...
/**
* InternetFAD service.
* @module api/InternetFADApi
* @version 2.3
*/
export default class InternetFADApi {

    /**
    * Constructs a new InternetFADApi. 
    * @alias module:api/InternetFADApi
    * @class
    ...
    */
    ...
    /**
     * Callback function to receive the result of the translateErmahgerdGet operation.
     * @callback module:api/InternetFADApi~translateErmahgerdGetCallback
     ...
     * @param {module:api/InternetFADApi~translateErmahgerdGetCallback} callback The callback function, accepting three arguments: error, data, response
     */
    translateErmahgerdGet(text, callback) {
      let postBody = null;
      // verify the required parameter 'text' is set
      if (text === undefined || text === null) {
        throw new Error("Missing the required parameter 'text' when calling translateErmahgerdGet");
      }
