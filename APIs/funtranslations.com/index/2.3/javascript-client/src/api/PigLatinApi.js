...
/**
* PigLatin service.
* @module api/PigLatinApi
* @version 2.3
*/
export default class PigLatinApi {

    /**
    * Constructs a new PigLatinApi. 
    * @alias module:api/PigLatinApi
    * @class
    ...
    */
    ...
    /**
     * Callback function to receive the result of the translatePiglatinGet operation.
     * @callback module:api/PigLatinApi~translatePiglatinGetCallback
     ...
     * @param {module:api/PigLatinApi~translatePiglatinGetCallback} callback The callback function, accepting three arguments: error, data, response
     */
    translatePiglatinGet(text, callback) {
      let postBody = null;
      // verify the required parameter 'text' is set
      if (text === undefined || text === null) {
        throw new Error("Missing the required parameter 'text' when calling translatePiglatinGet");
      }
