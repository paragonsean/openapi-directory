...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FunTranslationsApi.GameOfThronesApi();
  });
  ...
  describe('GameOfThronesApi', function() {
    describe('translateDothrakiGet', function() {
      it('should call translateDothrakiGet successfully', function(done) {
        //uncomment below and update the code to test translateDothrakiGet
        //instance.translateDothrakiGet(function(error) {
    ...
    describe('translateValyrianGet', function() {
      it('should call translateValyrianGet successfully', function(done) {
        //uncomment below and update the code to test translateValyrianGet
        //instance.translateValyrianGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
