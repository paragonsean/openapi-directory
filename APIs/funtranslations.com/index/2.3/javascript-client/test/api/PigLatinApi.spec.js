...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FunTranslationsApi.PigLatinApi();
  });
  ...
  describe('PigLatinApi', function() {
    describe('translatePiglatinGet', function() {
      it('should call translatePiglatinGet successfully', function(done) {
        //uncomment below and update the code to test translatePiglatinGet
        //instance.translatePiglatinGet(function(error) {
