...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FunTranslationsApi.CharactersApi();
  });
  ...
  describe('CharactersApi', function() {
    describe('translateChefGet', function() {
      it('should call translateChefGet successfully', function(done) {
        //uncomment below and update the code to test translateChefGet
        //instance.translateChefGet(function(error) {
    ...
    describe('translateDolanGet', function() {
      it('should call translateDolanGet successfully', function(done) {
        //uncomment below and update the code to test translateDolanGet
        //instance.translateDolanGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('translateFerblatinGet', function() {
      it('should call translateFerblatinGet successfully', function(done) {
        //uncomment below and update the code to test translateFerblatinGet
        //instance.translateFerblatinGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('translateFuddGet', function() {
      it('should call translateFuddGet successfully', function(done) {
        //uncomment below and update the code to test translateFuddGet
        //instance.translateFuddGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('translateMinionGet', function() {
      it('should call translateMinionGet successfully', function(done) {
        //uncomment below and update the code to test translateMinionGet
        //instance.translateMinionGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('translatePirateGet', function() {
      it('should call translatePirateGet successfully', function(done) {
        //uncomment below and update the code to test translatePirateGet
        //instance.translatePirateGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
