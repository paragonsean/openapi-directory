...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FunTranslationsApi.ElvishApi();
  });
  ...
  describe('ElvishApi', function() {
    describe('translateQuneyaGet', function() {
      it('should call translateQuneyaGet successfully', function(done) {
        //uncomment below and update the code to test translateQuneyaGet
        //instance.translateQuneyaGet(function(error) {
    ...
    describe('translateSindarinGet', function() {
      it('should call translateSindarinGet successfully', function(done) {
        //uncomment below and update the code to test translateSindarinGet
        //instance.translateSindarinGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
