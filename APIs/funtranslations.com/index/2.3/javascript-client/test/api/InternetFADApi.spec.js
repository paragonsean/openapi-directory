...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FunTranslationsApi.InternetFADApi();
  });
  ...
  describe('InternetFADApi', function() {
    describe('translateErmahgerdGet', function() {
      it('should call translateErmahgerdGet successfully', function(done) {
        //uncomment below and update the code to test translateErmahgerdGet
        //instance.translateErmahgerdGet(function(error) {
