...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FunTranslationsApi.MorseApi();
  });
  ...
  describe('MorseApi', function() {
    describe('translateMorse2englishGet', function() {
      it('should call translateMorse2englishGet successfully', function(done) {
        //uncomment below and update the code to test translateMorse2englishGet
        //instance.translateMorse2englishGet(function(error) {
    ...
    describe('translateMorseAudioGet', function() {
      it('should call translateMorseAudioGet successfully', function(done) {
        //uncomment below and update the code to test translateMorseAudioGet
        //instance.translateMorseAudioGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('translateMorseGet', function() {
      it('should call translateMorseGet successfully', function(done) {
        //uncomment below and update the code to test translateMorseGet
        //instance.translateMorseGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
