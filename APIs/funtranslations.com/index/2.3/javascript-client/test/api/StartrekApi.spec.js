...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FunTranslationsApi.StartrekApi();
  });
  ...
  describe('StartrekApi', function() {
    describe('translateKlingonGet', function() {
      it('should call translateKlingonGet successfully', function(done) {
        //uncomment below and update the code to test translateKlingonGet
        //instance.translateKlingonGet(function(error) {
    ...
    describe('translateVulcanGet', function() {
      it('should call translateVulcanGet successfully', function(done) {
        //uncomment below and update the code to test translateVulcanGet
        //instance.translateVulcanGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
