...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FunTranslationsApi.DialectApi();
  });
  ...
  describe('DialectApi', function() {
    describe('translateBrooklynGet', function() {
      it('should call translateBrooklynGet successfully', function(done) {
        //uncomment below and update the code to test translateBrooklynGet
        //instance.translateBrooklynGet(function(error) {
    ...
    describe('translateCockneyGet', function() {
      it('should call translateCockneyGet successfully', function(done) {
        //uncomment below and update the code to test translateCockneyGet
        //instance.translateCockneyGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('translateJiveGet', function() {
      it('should call translateJiveGet successfully', function(done) {
        //uncomment below and update the code to test translateJiveGet
        //instance.translateJiveGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('translateValspeakGet', function() {
      it('should call translateValspeakGet successfully', function(done) {
        //uncomment below and update the code to test translateValspeakGet
        //instance.translateValspeakGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
