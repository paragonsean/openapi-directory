# FunTranslationsApi.StartrekApi
...
let apiInstance = new FunTranslationsApi.StartrekApi();
let text = "text_example"; // String | Text to translate
apiInstance.translateKlingonGet(text, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
let apiInstance = new FunTranslationsApi.StartrekApi();
let text = "text_example"; // String | Text to translate
apiInstance.translateVulcanGet(text, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully.');
