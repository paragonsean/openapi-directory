...
public class InternetFadApi {
    private ApiClient localVarApiClient;
    private int localHostIndex;
    private String localCustomBaseUrl;

    public InternetFadApi() {
        this(Configuration.getDefaultApiClient());
    }

    public InternetFadApi(ApiClient apiClient) {
    ...
    /**
     * Build call for translateErmahgerdGet
     ...
     */
    public okhttp3.Call translateErmahgerdGetCall(String text, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/translate/ermahgerd";
    ...
    private okhttp3.Call translateErmahgerdGetValidateBeforeCall(String text, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'text' is set
        if (text == null) {
            throw new ApiException("Missing the required parameter 'text' when calling translateErmahgerdGet(Async)");
        }

        return translateErmahgerdGetCall(text, _callback);
     ...
     */
    public void translateErmahgerdGet(String text) throws ApiException {
        translateErmahgerdGetWithHttpInfo(text);
    }
     ...
     */
    public ApiResponse<Void> translateErmahgerdGetWithHttpInfo(String text) throws ApiException {
        okhttp3.Call localVarCall = translateErmahgerdGetValidateBeforeCall(text, null);
     ...
     */
    public okhttp3.Call translateErmahgerdGetAsync(String text, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = translateErmahgerdGetValidateBeforeCall(text, _callback);
