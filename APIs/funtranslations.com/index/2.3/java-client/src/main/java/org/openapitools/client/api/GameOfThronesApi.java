...
public class GameOfThronesApi {
    ...
    public GameOfThronesApi() {
        this(Configuration.getDefaultApiClient());
    }

    public GameOfThronesApi(ApiClient apiClient) {
    ...
    /**
     * Build call for translateDothrakiGet
     ...
     */
    public okhttp3.Call translateDothrakiGetCall(String text, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/translate/dothraki";
    ...
    private okhttp3.Call translateDothrakiGetValidateBeforeCall(String text, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'text' is set
        if (text == null) {
            throw new ApiException("Missing the required parameter 'text' when calling translateDothrakiGet(Async)");
        }

        return translateDothrakiGetCall(text, _callback);
     ...
     */
    public void translateDothrakiGet(String text) throws ApiException {
        translateDothrakiGetWithHttpInfo(text);
    }
     ...
     */
    public ApiResponse<Void> translateDothrakiGetWithHttpInfo(String text) throws ApiException {
        okhttp3.Call localVarCall = translateDothrakiGetValidateBeforeCall(text, null);
     ...
     */
    public okhttp3.Call translateDothrakiGetAsync(String text, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = translateDothrakiGetValidateBeforeCall(text, _callback);
        localVarApiClient.executeAsync(localVarCall, _callback);
        return localVarCall;
    }
    /**
     * Build call for translateValyrianGet
     * @param text Text to translate (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    public okhttp3.Call translateValyrianGetCall(String text, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/translate/valyrian";
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call translateValyrianGetValidateBeforeCall(String text, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'text' is set
        if (text == null) {
            throw new ApiException("Missing the required parameter 'text' when calling translateValyrianGet(Async)");
        }

        return translateValyrianGetCall(text, _callback);
     ...
     */
    public void translateValyrianGet(String text) throws ApiException {
        translateValyrianGetWithHttpInfo(text);
    }
     ...
     */
    public ApiResponse<Void> translateValyrianGetWithHttpInfo(String text) throws ApiException {
        okhttp3.Call localVarCall = translateValyrianGetValidateBeforeCall(text, null);
        return localVarApiClient.execute(localVarCall);
    }
     ...
     */
    public okhttp3.Call translateValyrianGetAsync(String text, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = translateValyrianGetValidateBeforeCall(text, _callback);
        localVarApiClient.executeAsync(localVarCall, _callback);
        return localVarCall;
    }
}
