...
public class ElvishApi {
    ...
    public ElvishApi(ApiClient apiClient) {
    ...
    /**
     * Build call for translateQuneyaGet
     ...
     */
    public okhttp3.Call translateQuneyaGetCall(String text, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/translate/quneya";
    ...
    private okhttp3.Call translateQuneyaGetValidateBeforeCall(String text, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'text' is set
        if (text == null) {
            throw new ApiException("Missing the required parameter 'text' when calling translateQuneyaGet(Async)");
        }

        return translateQuneyaGetCall(text, _callback);
     ...
     */
    public void translateQuneyaGet(String text) throws ApiException {
        translateQuneyaGetWithHttpInfo(text);
    }
     ...
     */
    public ApiResponse<Void> translateQuneyaGetWithHttpInfo(String text) throws ApiException {
        okhttp3.Call localVarCall = translateQuneyaGetValidateBeforeCall(text, null);
     ...
     */
    public okhttp3.Call translateQuneyaGetAsync(String text, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = translateQuneyaGetValidateBeforeCall(text, _callback);
        localVarApiClient.executeAsync(localVarCall, _callback);
        return localVarCall;
    }
    /**
     * Build call for translateSindarinGet
     * @param text Text to translate (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    public okhttp3.Call translateSindarinGetCall(String text, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/translate/sindarin";
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call translateSindarinGetValidateBeforeCall(String text, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'text' is set
        if (text == null) {
            throw new ApiException("Missing the required parameter 'text' when calling translateSindarinGet(Async)");
        }

        return translateSindarinGetCall(text, _callback);
     ...
     */
    public void translateSindarinGet(String text) throws ApiException {
        translateSindarinGetWithHttpInfo(text);
    }
     ...
     */
    public ApiResponse<Void> translateSindarinGetWithHttpInfo(String text) throws ApiException {
        okhttp3.Call localVarCall = translateSindarinGetValidateBeforeCall(text, null);
        return localVarApiClient.execute(localVarCall);
    }
     ...
     */
    public okhttp3.Call translateSindarinGetAsync(String text, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = translateSindarinGetValidateBeforeCall(text, _callback);
        localVarApiClient.executeAsync(localVarCall, _callback);
        return localVarCall;
    }
}
