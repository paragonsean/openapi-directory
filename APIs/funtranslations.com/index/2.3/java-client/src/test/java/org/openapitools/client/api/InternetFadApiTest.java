...
/**
 * API tests for InternetFadApi
 */
@Disabled
public class InternetFadApiTest {

    private final InternetFadApi api = new InternetFadApi();
     ...
     */
    @Test
    public void translateErmahgerdGetTest() throws ApiException {
        String text = null;
        api.translateErmahgerdGet(text);
