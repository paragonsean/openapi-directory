...
/**
 * API tests for PigLatinApi
 */
@Disabled
public class PigLatinApiTest {

    private final PigLatinApi api = new PigLatinApi();
     ...
     */
    @Test
    public void translatePiglatinGetTest() throws ApiException {
        String text = null;
        api.translatePiglatinGet(text);
