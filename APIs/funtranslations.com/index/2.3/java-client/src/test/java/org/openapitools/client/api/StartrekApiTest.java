...
/**
 * API tests for StartrekApi
 */
@Disabled
public class StartrekApiTest {

    private final StartrekApi api = new StartrekApi();
     ...
     */
    @Test
    public void translateKlingonGetTest() throws ApiException {
        String text = null;
        api.translateKlingonGet(text);
     ...
     */
    @Test
    public void translateVulcanGetTest() throws ApiException {
        String text = null;
        api.translateVulcanGet(text);
        // TODO: test validations
    }
