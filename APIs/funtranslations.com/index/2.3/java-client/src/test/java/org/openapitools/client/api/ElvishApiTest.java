...
/**
 * API tests for ElvishApi
 */
@Disabled
public class ElvishApiTest {

    private final ElvishApi api = new ElvishApi();
     ...
     */
    @Test
    public void translateQuneyaGetTest() throws ApiException {
        String text = null;
        api.translateQuneyaGet(text);
     ...
     */
    @Test
    public void translateSindarinGetTest() throws ApiException {
        String text = null;
        api.translateSindarinGet(text);
        // TODO: test validations
    }
