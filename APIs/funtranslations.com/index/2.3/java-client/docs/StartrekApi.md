...
|------------- | ------------- | -------------|
| [**translateKlingonGet**](StartrekApi.md#translateKlingonGet) | **GET** /translate/klingon |  |
| [**translateVulcanGet**](StartrekApi.md#translateVulcanGet) | **GET** /translate/vulcan |  |


<a id="translateKlingonGet"></a>
# **translateKlingonGet**
> translateKlingonGet(text)
...
import org.openapitools.client.api.StartrekApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    StartrekApi apiInstance = new StartrekApi(defaultClient);
    String text = "text_example"; // String | Text to translate
    try {
      apiInstance.translateKlingonGet(text);
    } catch (ApiException e) {
      System.err.println("Exception when calling StartrekApi#translateKlingonGet");
...
<a id="translateVulcanGet"></a>
# **translateVulcanGet**
> translateVulcanGet(text)
...
public class Example {
  public static void main(String[] args) {
    ...
    String text = "text_example"; // String | Text to translate
    try {
      apiInstance.translateVulcanGet(text);
    } catch (ApiException e) {
      System.err.println("Exception when calling StartrekApi#translateVulcanGet");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
