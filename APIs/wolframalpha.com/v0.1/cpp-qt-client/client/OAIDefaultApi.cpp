...
void OAIDefaultApi::initializeServerConfigs() {
    ...
    QUrl("https://www.wolframalpha.com"),
    "Wolfram Server for ChatGPT",
    QMap<QString, OAIServerVariable>()));
    _serverConfigs.insert("getWolframAlphaResults", defaultConf);
    _serverIndices.insert("getWolframAlphaResults", 0);
    _serverConfigs.insert("getWolframCloudResults", defaultConf);
    _serverIndices.insert("getWolframCloudResults", 0);
}
...
void OAIDefaultApi::getWolframAlphaResults(const QString &input) {
    QString fullPath = QString(_serverConfigs["getWolframAlphaResults"][_serverIndices.value("getWolframAlphaResults")].URL()+"/api/v1/llm-api");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIDefaultApi::getWolframAlphaResultsCallback);
...
void OAIDefaultApi::getWolframAlphaResultsCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT getWolframAlphaResultsSignal();
        Q_EMIT getWolframAlphaResultsSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT getWolframAlphaResultsSignalE(error_type, error_str);
        Q_EMIT getWolframAlphaResultsSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT getWolframAlphaResultsSignalError(error_type, error_str);
        Q_EMIT getWolframAlphaResultsSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIDefaultApi::getWolframCloudResults(const QString &input) {
    QString fullPath = QString(_serverConfigs["getWolframCloudResults"][_serverIndices.value("getWolframCloudResults")].URL()+"/api/v1/cloud-plugin");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIDefaultApi::getWolframCloudResultsCallback);
    connect(this, &OAIDefaultApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIDefaultApi::getWolframCloudResultsCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT getWolframCloudResultsSignal();
        Q_EMIT getWolframCloudResultsSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT getWolframCloudResultsSignalE(error_type, error_str);
        Q_EMIT getWolframCloudResultsSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT getWolframCloudResultsSignalError(error_type, error_str);
        Q_EMIT getWolframCloudResultsSignalErrorFull(worker, error_type, error_str);
    }
}
