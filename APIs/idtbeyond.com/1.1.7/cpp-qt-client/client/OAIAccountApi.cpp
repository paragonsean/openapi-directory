...
void OAIAccountApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("iatuBalanceGet", defaultConf);
    _serverIndices.insert("iatuBalanceGet", 0);
}
...
void OAIAccountApi::iatuBalanceGet(const QString &x_idt_beyond_app_id, const QString &x_idt_beyond_app_key) {
    QString fullPath = QString(_serverConfigs["iatuBalanceGet"][_serverIndices.value("iatuBalanceGet")].URL()+"/iatu/balance");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIAccountApi::iatuBalanceGetCallback);
...
void OAIAccountApi::iatuBalanceGetCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT iatuBalanceGetSignal();
        Q_EMIT iatuBalanceGetSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT iatuBalanceGetSignalE(error_type, error_str);
        Q_EMIT iatuBalanceGetSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT iatuBalanceGetSignalError(error_type, error_str);
        Q_EMIT iatuBalanceGetSignalErrorFull(worker, error_type, error_str);
    }
}
