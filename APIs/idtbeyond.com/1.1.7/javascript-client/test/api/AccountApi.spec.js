...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ActiveDocumentationForV1.AccountApi();
  });
  ...
  describe('AccountApi', function() {
    describe('iatuBalanceGet', function() {
      it('should call iatuBalanceGet successfully', function(done) {
        //uncomment below and update the code to test iatuBalanceGet
        //instance.iatuBalanceGet(function(error) {
