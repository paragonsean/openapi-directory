...
public:
    ...
    /**
    * @param[in]  sungforcategory QString [required]
    */
    virtual void resourcesGet(const QString &sungforcategory);
...
Q_SIGNALS:
    ...
    void resourcesGetSignal();


    void resourcesGetSignalFull(OAIHttpRequestWorker *worker);

    Q_DECL_DEPRECATED_X("Use resourcesGetSignalError() instead")
    void resourcesGetSignalE(QNetworkReply::NetworkError error_type, QString error_str);
    void resourcesGetSignalError(QNetworkReply::NetworkError error_type, const QString &error_str);
