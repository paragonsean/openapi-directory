...
void OAIDefaultApi::initializeServerConfigs() {
    ...
    QUrl("https://api-rv.herokuapp.com/rv/v1"),
...
void OAIDefaultApi::resourcesGet(const QString &sungforcategory) {
    ...
    
    {
        ...
        queryDelimiter = getParamStyleDelimiter(queryStyle, "sungforcategory", false);
        if (fullPath.indexOf("?") > 0)
            fullPath.append(queryPrefix);
        else
            fullPath.append("?");

        fullPath.append(QUrl::toPercentEncoding("sungforcategory")).append(querySuffix).append(QUrl::toPercentEncoding(sungforcategory));
    }
