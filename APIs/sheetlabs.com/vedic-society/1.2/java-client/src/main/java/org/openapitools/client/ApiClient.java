...
public class ApiClient {
    ...
    private String basePath = "https://api-vs.herokuapp.com/vs/v1";
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/1.2/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://api-vs.herokuapp.com/vs/v1
