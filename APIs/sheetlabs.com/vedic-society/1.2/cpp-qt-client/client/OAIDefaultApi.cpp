...
void OAIDefaultApi::initializeServerConfigs() {
    ...
    QUrl("https://api-vs.herokuapp.com/vs/v1"),
...
void OAIDefaultApi::resourcesGet(const QString &description) {
    QString fullPath = QString(_serverConfigs["resourcesGet"][_serverIndices.value("resourcesGet")].URL()+"/resources");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIDefaultApi::resourcesGetCallback);
...
void OAIDefaultApi::resourcesGetCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT resourcesGetSignal();
        Q_EMIT resourcesGetSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT resourcesGetSignalE(error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT resourcesGetSignalError(error_type, error_str);
