...
VsApi - JavaScript client for vs_api
# Introduction
...
To use the link you just defined in your project, switch to the directory you want to use your vs_api from, and run:
...
```javascript
var VsApi = require('vs_api');


var api = new VsApi.DefaultApi()
var description = "description_example"; // {String} The string you are looking for in the word meaning, for example, chariot. Wildcards are allowed, for example, char\\*.
...
api.resourcesGet(description, callback);
...
------------ | ------------- | ------------- | -------------
*VsApi.DefaultApi* | [**resourcesGet**](docs/DefaultApi.md#resourcesGet) | **GET** /resources | Fetch all meanings that contain a specific English string
