...
public class GeographicData {
  ...
  public static final String SERIALIZED_NAME_MARKET_AREA = "marketArea";
  @SerializedName(SERIALIZED_NAME_MARKET_AREA)
  private String marketArea;

  public GeographicData() {
  }

  public GeographicData county(String county) {
    this.county = county;
    return this;
  }
  ...
  public GeographicData directions(String directions) {
  ...
  public GeographicData lat(Double lat) {
    this.lat = lat;
    return this;
  }
  ...
  public GeographicData lng(Double lng) {
    this.lng = lng;
    return this;
  }
  ...
  public GeographicData marketArea(String marketArea) {
  ...
  public boolean equals(Object o) {
    ...
    GeographicData geographicData = (GeographicData) o;
    return Objects.equals(this.county, geographicData.county) &&
        Objects.equals(this.directions, geographicData.directions) &&
        Objects.equals(this.lat, geographicData.lat) &&
        Objects.equals(this.lng, geographicData.lng) &&
        Objects.equals(this.marketArea, geographicData.marketArea);
  }

  @Override
  public int hashCode() {
    return Objects.hash(county, directions, lat, lng, marketArea);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class GeographicData {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GeographicData
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GeographicData.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GeographicData is not found in the empty JSON string", GeographicData.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GeographicData.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GeographicData` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if ((jsonObj.get("marketArea") != null && !jsonObj.get("marketArea").isJsonNull()) && !jsonObj.get("marketArea").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `marketArea` to be a primitive type in the JSON string but got `%s`", jsonObj.get("marketArea").toString()));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GeographicData.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GeographicData' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GeographicData> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GeographicData.class));

       return (TypeAdapter<T>) new TypeAdapter<GeographicData>() {
           @Override
           public void write(JsonWriter out, GeographicData value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GeographicData read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GeographicData given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GeographicData
   * @throws IOException if the JSON string is invalid with respect to GeographicData
   */
  public static GeographicData fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GeographicData.class);
  }

  /**
   * Convert an instance of GeographicData to an JSON string
   *
   * @return JSON string
   */
