...
public class Parking {
  ...
  public static final String SERIALIZED_NAME_LEASED = "leased";
  @SerializedName(SERIALIZED_NAME_LEASED)
  ...
  public Parking leased(String leased) {
    this.leased = leased;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.description, parking.description) &&
        Objects.equals(this.leased, parking.leased) &&
        Objects.equals(this.spaces, parking.spaces);
  }

  @Override
  public int hashCode() {
    return Objects.hash(description, leased, spaces);
  }
  ...
  public String toString() {
    ...
    sb.append("    leased: ").append(toIndentedString(leased)).append("\n");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if ((jsonObj.get("leased") != null && !jsonObj.get("leased").isJsonNull()) && !jsonObj.get("leased").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `leased` to be a primitive type in the JSON string but got `%s`", jsonObj.get("leased").toString()));
      }
  }
