...
/**
 * The OpenHouse model module.
 * @module model/OpenHouse
 * @version 1.0.0
 */
class OpenHouse {
    /**
     * Constructs a new <code>OpenHouse</code>.
     * SimplyRETS Open House object
     * @alias module:model/OpenHouse
     */
    constructor() { 
        
        OpenHouse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>OpenHouse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/OpenHouse} obj Optional instance to populate.
     * @return {module:model/OpenHouse} The populated <code>OpenHouse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new OpenHouse();
            ...
            if (data.hasOwnProperty('inputId')) {
                obj['inputId'] = ApiClient.convertToType(data['inputId'], Object);
            }
            if (data.hasOwnProperty('listing')) {
                obj['listing'] = Listing.constructFromObject(data['listing']);
            }
            if (data.hasOwnProperty('openHouseId')) {
                obj['openHouseId'] = ApiClient.convertToType(data['openHouseId'], 'String');
            }
            if (data.hasOwnProperty('openHouseKey')) {
                obj['openHouseKey'] = ApiClient.convertToType(data['openHouseKey'], 'String');
            }
            if (data.hasOwnProperty('refreshments')) {
                obj['refreshments'] = ApiClient.convertToType(data['refreshments'], 'String');
            }
    ...
    /**
     * Validates the JSON data with respect to <code>OpenHouse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>OpenHouse</code>.
     */
    static validateJSON(data) {
        ...
        // ensure the json data is a string
        if (data['openHouseId'] && !(typeof data['openHouseId'] === 'string' || data['openHouseId'] instanceof String)) {
            throw new Error("Expected the field `openHouseId` to be a primitive type in the JSON string but got " + data['openHouseId']);
        }
        // ensure the json data is a string
        if (data['openHouseKey'] && !(typeof data['openHouseKey'] === 'string' || data['openHouseKey'] instanceof String)) {
            throw new Error("Expected the field `openHouseKey` to be a primitive type in the JSON string but got " + data['openHouseKey']);
        }
        // ensure the json data is a string
        if (data['refreshments'] && !(typeof data['refreshments'] === 'string' || data['refreshments'] instanceof String)) {
            throw new Error("Expected the field `refreshments` to be a primitive type in the JSON string but got " + data['refreshments']);
        }
        // ensure the json data is a string
 ...
 */
OpenHouse.prototype['description'] = undefined;

/**
 * The ending date time for the open house
 * @member {Date} endTime
 */
OpenHouse.prototype['endTime'] = undefined;

/**
 * The MLS number for the showing agent or agent which created the OpenHouse in the MLS database. 
 * @member {Object} inputId
 */
OpenHouse.prototype['inputId'] = undefined;

/**
 * @member {module:model/Listing} listing
 */
OpenHouse.prototype['listing'] = undefined;

/**
 * The MLS number or id provided by the MLS 
 * @member {String} openHouseId
 */
OpenHouse.prototype['openHouseId'] = undefined;

/**
 * A unique identifier for the open house which is specific to the SimplyRETS API 
 * @member {String} openHouseKey
 */
OpenHouse.prototype['openHouseKey'] = undefined;

/**
 * Provided
 * @member {String} refreshments
 */
OpenHouse.prototype['refreshments'] = undefined;

/**
 * Start Date for the open house
 * @member {Date} startTime
 */
OpenHouse.prototype['startTime'] = undefined;

/**
 * The open house type. For example, Public or Private
 * @member {String} type
 */
OpenHouse.prototype['type'] = undefined;
