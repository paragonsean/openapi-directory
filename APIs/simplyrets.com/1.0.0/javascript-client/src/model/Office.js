...
class Office {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('servingName')) {
                obj['servingName'] = ApiClient.convertToType(data['servingName'], 'String');
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        if (data['brokerid'] && !(typeof data['brokerid'] === 'string' || data['brokerid'] instanceof String)) {
            throw new Error("Expected the field `brokerid` to be a primitive type in the JSON string but got " + data['brokerid']);
        }
        ...
        // ensure the json data is a string
        if (data['servingName'] && !(typeof data['servingName'] === 'string' || data['servingName'] instanceof String)) {
            throw new Error("Expected the field `servingName` to be a primitive type in the JSON string but got " + data['servingName']);
        }
 ...
 */
Office.prototype['brokerid'] = undefined;

/**
 * @member {module:model/ContactInformation} contact
 */
Office.prototype['contact'] = undefined;
 ...
 * @member {String} servingName
 */
Office.prototype['servingName'] = undefined;
