...
class Agent {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('contact')) {
                obj['contact'] = ContactInformation.constructFromObject(data['contact']);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['contact']) { // data not null
          ContactInformation.validateJSON(data['contact']);
        }
...
/**
 * @member {module:model/ContactInformation} contact
 */
 ...
 */
Agent.prototype['firstName'] = undefined;
 ...
 */
Agent.prototype['lastName'] = undefined;
