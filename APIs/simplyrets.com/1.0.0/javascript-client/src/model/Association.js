...
class Association {
    ...
    static validateJSON(data) {
        ...
        if (data['amenities'] && !(typeof data['amenities'] === 'string' || data['amenities'] instanceof String)) {
            throw new Error("Expected the field `amenities` to be a primitive type in the JSON string but got " + data['amenities']);
        }
        // ensure the json data is a string
 ...
 */
Association.prototype['amenities'] = undefined;

/**
 * Association fee
 * @member {Number} fee
 */
Association.prototype['fee'] = undefined;
