...
/**
 * The MlsInformation model module.
 * @module model/MlsInformation
 * @version 1.0.0
 */
class MlsInformation {
    /**
     * Constructs a new <code>MlsInformation</code>.
     * RETS MLS Vendor Data
     * @alias module:model/MlsInformation
     */
    constructor() { 
        
        MlsInformation.initialize(this);
    }
    ...
    /**
     * Constructs a <code>MlsInformation</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/MlsInformation} obj Optional instance to populate.
     * @return {module:model/MlsInformation} The populated <code>MlsInformation</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new MlsInformation();

            if (data.hasOwnProperty('area')) {
                obj['area'] = ApiClient.convertToType(data['area'], 'String');
            }
            if (data.hasOwnProperty('areaMinor')) {
                obj['areaMinor'] = ApiClient.convertToType(data['areaMinor'], 'String');
            }
            if (data.hasOwnProperty('daysOnMarket')) {
                obj['daysOnMarket'] = ApiClient.convertToType(data['daysOnMarket'], 'Number');
            }
            if (data.hasOwnProperty('originatingSystemName')) {
                obj['originatingSystemName'] = ApiClient.convertToType(data['originatingSystemName'], 'String');
            }
    ...
    /**
     * Validates the JSON data with respect to <code>MlsInformation</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>MlsInformation</code>.
     */
    static validateJSON(data) {
        ...
        // ensure the json data is a string
        if (data['areaMinor'] && !(typeof data['areaMinor'] === 'string' || data['areaMinor'] instanceof String)) {
            throw new Error("Expected the field `areaMinor` to be a primitive type in the JSON string but got " + data['areaMinor']);
        }
        // ensure the json data is a string
        if (data['originatingSystemName'] && !(typeof data['originatingSystemName'] === 'string' || data['originatingSystemName'] instanceof String)) {
            throw new Error("Expected the field `originatingSystemName` to be a primitive type in the JSON string but got " + data['originatingSystemName']);
        }
        // ensure the json data is a string
 ...
 * @member {String} originatingSystemName
 */
MlsInformation.prototype['originatingSystemName'] = undefined;
 ...
 * @member {module:model/MlsInformation.StatusEnum} status
 */
MlsInformation.prototype['status'] = undefined;

/**
 * Raw MLS status text. This `field` comes directly from your RETS data field and is not normalized. 
 * @member {String} statusText
 */
MlsInformation.prototype['statusText'] = undefined;
...
MlsInformation['StatusEnum'] = {
    ...
    /**
     * value: "ActiveUnderContract (Backup-Offer)"
     * @const
     */
    "ActiveUnderContract (Backup-Offer)": "ActiveUnderContract (Backup-Offer)",
