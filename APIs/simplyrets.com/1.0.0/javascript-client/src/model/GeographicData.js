...
/**
 * The GeographicData model module.
 * @module model/GeographicData
 * @version 1.0.0
 */
class GeographicData {
    /**
     * Constructs a new <code>GeographicData</code>.
     * RETS MLS Geographic Data
     * @alias module:model/GeographicData
     */
    constructor() { 
        
        GeographicData.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GeographicData</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GeographicData} obj Optional instance to populate.
     * @return {module:model/GeographicData} The populated <code>GeographicData</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GeographicData();
            ...
            if (data.hasOwnProperty('marketArea')) {
                obj['marketArea'] = ApiClient.convertToType(data['marketArea'], 'String');
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>GeographicData</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GeographicData</code>.
     */
    static validateJSON(data) {
        ...
        // ensure the json data is a string
        if (data['marketArea'] && !(typeof data['marketArea'] === 'string' || data['marketArea'] instanceof String)) {
            throw new Error("Expected the field `marketArea` to be a primitive type in the JSON string but got " + data['marketArea']);
        }
 ...
 */
GeographicData.prototype['county'] = undefined;

/**
 * Directions to the property
 * @member {String} directions
 */
GeographicData.prototype['directions'] = undefined;

/**
 * Listing latitude (if available)
 * @member {Number} lat
 */
GeographicData.prototype['lat'] = undefined;

/**
 * Listing longitude (if available)
 * @member {Number} lng
 */
GeographicData.prototype['lng'] = undefined;

/**
 * Listing GeoMarket area. May be the same as mlsArea
 * @member {String} marketArea
 */
GeographicData.prototype['marketArea'] = undefined;
