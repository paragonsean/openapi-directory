...
class School {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('elementarySchool')) {
                obj['elementarySchool'] = ApiClient.convertToType(data['elementarySchool'], 'String');
            }
            if (data.hasOwnProperty('highSchool')) {
                obj['highSchool'] = ApiClient.convertToType(data['highSchool'], 'String');
            }
            if (data.hasOwnProperty('middleSchool')) {
                obj['middleSchool'] = ApiClient.convertToType(data['middleSchool'], 'String');
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        // ensure the json data is a string
        if (data['elementarySchool'] && !(typeof data['elementarySchool'] === 'string' || data['elementarySchool'] instanceof String)) {
            throw new Error("Expected the field `elementarySchool` to be a primitive type in the JSON string but got " + data['elementarySchool']);
        }
        // ensure the json data is a string
        ...
        // ensure the json data is a string
        if (data['middleSchool'] && !(typeof data['middleSchool'] === 'string' || data['middleSchool'] instanceof String)) {
            throw new Error("Expected the field `middleSchool` to be a primitive type in the JSON string but got " + data['middleSchool']);
        }
 ...
 * @member {String} elementarySchool
 */
School.prototype['elementarySchool'] = undefined;

/**
 * High school name
 * @member {String} highSchool
 */
School.prototype['highSchool'] = undefined;

/**
 * Middle or junior school name
 * @member {String} middleSchool
 */
School.prototype['middleSchool'] = undefined;
