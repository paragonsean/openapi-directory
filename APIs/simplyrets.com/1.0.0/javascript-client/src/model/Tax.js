...
class Tax {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('taxAnnualAmount')) {
                obj['taxAnnualAmount'] = ApiClient.convertToType(data['taxAnnualAmount'], 'String');
            }
    ...
    static validateJSON(data) {
        ...
        // ensure the json data is a string
        if (data['taxAnnualAmount'] && !(typeof data['taxAnnualAmount'] === 'string' || data['taxAnnualAmount'] instanceof String)) {
            throw new Error("Expected the field `taxAnnualAmount` to be a primitive type in the JSON string but got " + data['taxAnnualAmount']);
        }
 ...
 * @member {String} taxAnnualAmount
 */
Tax.prototype['taxAnnualAmount'] = undefined;

/**
 * Tax Year
 * @member {Number} taxYear
 */
Tax.prototype['taxYear'] = undefined;
