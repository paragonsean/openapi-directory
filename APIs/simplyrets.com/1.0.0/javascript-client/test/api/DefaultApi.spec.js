...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SimplyRets.DefaultApi();
  });
  ...
  describe('DefaultApi', function() {
    describe('openhousesGet', function() {
      it('should call openhousesGet successfully', function(done) {
        //uncomment below and update the code to test openhousesGet
        //instance.openhousesGet(function(error) {
    ...
    describe('openhousesOpenHouseKeyGet', function() {
      it('should call openhousesOpenHouseKeyGet successfully', function(done) {
        //uncomment below and update the code to test openhousesOpenHouseKeyGet
        //instance.openhousesOpenHouseKeyGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('propertiesMlsIdGet', function() {
      it('should call propertiesMlsIdGet successfully', function(done) {
        //uncomment below and update the code to test propertiesMlsIdGet
        //instance.propertiesMlsIdGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
