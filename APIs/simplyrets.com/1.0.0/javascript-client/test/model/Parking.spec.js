...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SimplyRets.Parking();
  });
  ...
  describe('Parking', function() {
    it('should create an instance of Parking', function() {
      ...
      //var instance = new SimplyRets.Parking();
      //expect(instance).to.be.a(SimplyRets.Parking);
    });
    ...
    it('should have the property leased (base name: "leased")', function() {
      // uncomment below and update the code to test the property leased
      //var instance = new SimplyRets.Parking();
      //expect(instance).to.be();
    });
