...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SimplyRets.Office();
  });
  ...
  describe('Office', function() {
    it('should create an instance of Office', function() {
      ...
      //var instance = new SimplyRets.Office();
      //expect(instance).to.be.a(SimplyRets.Office);
    });
    ...
    it('should have the property servingName (base name: "servingName")', function() {
      // uncomment below and update the code to test the property servingName
      //var instance = new SimplyRets.Office();
      //expect(instance).to.be();
    });
