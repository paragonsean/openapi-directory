...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SimplyRets.OpenHouse();
  });
  ...
  describe('OpenHouse', function() {
    it('should create an instance of OpenHouse', function() {
      // uncomment below and update the code to test OpenHouse
      //var instance = new SimplyRets.OpenHouse();
      //expect(instance).to.be.a(SimplyRets.OpenHouse);
    });
    ...
    it('should have the property openHouseId (base name: "openHouseId")', function() {
      // uncomment below and update the code to test the property openHouseId
      //var instance = new SimplyRets.OpenHouse();
      //expect(instance).to.be();
    });

    it('should have the property openHouseKey (base name: "openHouseKey")', function() {
      // uncomment below and update the code to test the property openHouseKey
      //var instance = new SimplyRets.OpenHouse();
      //expect(instance).to.be();
    });

    it('should have the property refreshments (base name: "refreshments")', function() {
      // uncomment below and update the code to test the property refreshments
      //var instance = new SimplyRets.OpenHouse();
      //expect(instance).to.be();
    });
