...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SimplyRets.GeographicData();
  });
  ...
  describe('GeographicData', function() {
    it('should create an instance of GeographicData', function() {
      // uncomment below and update the code to test GeographicData
      //var instance = new SimplyRets.GeographicData();
      //expect(instance).to.be.a(SimplyRets.GeographicData);
    });
    ...
    it('should have the property marketArea (base name: "marketArea")', function() {
      // uncomment below and update the code to test the property marketArea
      //var instance = new SimplyRets.GeographicData();
      //expect(instance).to.be();
    });
