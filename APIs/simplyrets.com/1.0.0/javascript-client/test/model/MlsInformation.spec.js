...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SimplyRets.MlsInformation();
  });
  ...
  describe('MlsInformation', function() {
    it('should create an instance of MlsInformation', function() {
      // uncomment below and update the code to test MlsInformation
      //var instance = new SimplyRets.MlsInformation();
      //expect(instance).to.be.a(SimplyRets.MlsInformation);
    });
    ...
    it('should have the property areaMinor (base name: "areaMinor")', function() {
      // uncomment below and update the code to test the property areaMinor
      //var instance = new SimplyRets.MlsInformation();
      //expect(instance).to.be();
    });
    ...
    it('should have the property originatingSystemName (base name: "originatingSystemName")', function() {
      // uncomment below and update the code to test the property originatingSystemName
      //var instance = new SimplyRets.MlsInformation();
      //expect(instance).to.be();
    });
