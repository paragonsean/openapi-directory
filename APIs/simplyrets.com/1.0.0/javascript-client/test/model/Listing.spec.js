...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SimplyRets.Listing();
  });
  ...
  describe('Listing', function() {
    it('should create an instance of Listing', function() {
      ...
      //var instance = new SimplyRets.Listing();
      //expect(instance).to.be.a(SimplyRets.Listing);
    });
    ...
    it('should have the property coAgent (base name: "coAgent")', function() {
    ...
    it('should have the property leaseTerm (base name: "leaseTerm")', function() {
    ...
    it('should have the property mls (base name: "mls")', function() {
      // uncomment below and update the code to test the property mls
      //var instance = new SimplyRets.Listing();
      //expect(instance).to.be();
    });

    it('should have the property mlsId (base name: "mlsId")', function() {
      // uncomment below and update the code to test the property mlsId
      //var instance = new SimplyRets.Listing();
      //expect(instance).to.be();
    });
    ...
    it('should have the property privateRemarks (base name: "privateRemarks")', function() {
      // uncomment below and update the code to test the property privateRemarks
      //var instance = new SimplyRets.Listing();
      //expect(instance).to.be();
    });
    ...
    it('should have the property showingInstructions (base name: "showingInstructions")', function() {
      // uncomment below and update the code to test the property showingInstructions
      //var instance = new SimplyRets.Listing();
      //expect(instance).to.be();
    });
    ...
    it('should have the property virtualTourUrl (base name: "virtualTourUrl")', function() {
      // uncomment below and update the code to test the property virtualTourUrl
      //var instance = new SimplyRets.Listing();
      //expect(instance).to.be();
    });
