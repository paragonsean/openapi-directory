...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SimplyRets.StreetAddress();
  });
  ...
  describe('StreetAddress', function() {
    it('should create an instance of StreetAddress', function() {
      // uncomment below and update the code to test StreetAddress
      //var instance = new SimplyRets.StreetAddress();
      //expect(instance).to.be.a(SimplyRets.StreetAddress);
    });
    ...
    it('should have the property crossStreet (base name: "crossStreet")', function() {
      // uncomment below and update the code to test the property crossStreet
      //var instance = new SimplyRets.StreetAddress();
      //expect(instance).to.be();
    });
    ...
    it('should have the property streetNumberText (base name: "streetNumberText")', function() {
      // uncomment below and update the code to test the property streetNumberText
      //var instance = new SimplyRets.StreetAddress();
      //expect(instance).to.be();
    });
