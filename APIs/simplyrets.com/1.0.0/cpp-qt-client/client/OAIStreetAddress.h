...
#ifndef OAIStreetAddress_H
#define OAIStreetAddress_H
...
class OAIStreetAddress : public OAIObject {
public:
    OAIStreetAddress();
    OAIStreetAddress(QString json);
    ~OAIStreetAddress() override;
    ...
    QString getCrossStreet() const;
    void setCrossStreet(const QString &cross_street);
    bool is_cross_street_Set() const;
    bool is_cross_street_Valid() const;
    ...
    qint64 getStreetNumber() const;
    void setStreetNumber(const qint64 &street_number);
    bool is_street_number_Set() const;
    bool is_street_number_Valid() const;

    QString getStreetNumberText() const;
    void setStreetNumberText(const QString &street_number_text);
    bool is_street_number_text_Set() const;
    bool is_street_number_text_Valid() const;
...
private:
    ...
    QString m_cross_street;
    bool m_cross_street_isSet;
    bool m_cross_street_isValid;
    ...
    qint64 m_street_number;
    bool m_street_number_isSet;
    bool m_street_number_isValid;

    QString m_street_number_text;
    bool m_street_number_text_isSet;
    bool m_street_number_text_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIStreetAddress)

#endif // OAIStreetAddress_H
