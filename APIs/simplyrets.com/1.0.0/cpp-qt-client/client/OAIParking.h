...
public:
    ...
    QString getLeased() const;
    void setLeased(const QString &leased);
    bool is_leased_Set() const;
    bool is_leased_Valid() const;

    qint32 getSpaces() const;
    void setSpaces(const qint32 &spaces);
