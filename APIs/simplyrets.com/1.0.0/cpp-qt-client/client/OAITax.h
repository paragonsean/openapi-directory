...
public:
    ...
    QString getTaxAnnualAmount() const;
    void setTaxAnnualAmount(const QString &tax_annual_amount);
    bool is_tax_annual_amount_Set() const;
    bool is_tax_annual_amount_Valid() const;

    qint64 getTaxYear() const;
    void setTaxYear(const qint64 &tax_year);
...
private:
    ...
    QString m_tax_annual_amount;
    bool m_tax_annual_amount_isSet;
    bool m_tax_annual_amount_isValid;
