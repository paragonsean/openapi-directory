...
void OAIParking::initializeModel() {
    ...
    m_leased_isSet = false;
    m_leased_isValid = false;
...
void OAIParking::fromJsonObject(QJsonObject json) {
    ...
    m_leased_isValid = ::OpenAPI::fromJsonValue(m_leased, json[QString("leased")]);
    m_leased_isSet = !json[QString("leased")].isNull() && m_leased_isValid;
...
QJsonObject OAIParking::asJsonObject() const {
    ...
    if (m_leased_isSet) {
        obj.insert(QString("leased"), ::OpenAPI::toJsonValue(m_leased));
    }
    if (m_spaces_isSet) {
...
QString OAIParking::getDescription() const {
    return m_description;
}
void OAIParking::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAIParking::is_description_Set() const{
    return m_description_isSet;
}

bool OAIParking::is_description_Valid() const{
    return m_description_isValid;
}

QString OAIParking::getLeased() const {
    return m_leased;
}
void OAIParking::setLeased(const QString &leased) {
    m_leased = leased;
    m_leased_isSet = true;
}

bool OAIParking::is_leased_Set() const{
    return m_leased_isSet;
}

bool OAIParking::is_leased_Valid() const{
    return m_leased_isValid;
}

qint32 OAIParking::getSpaces() const {
    return m_spaces;
}
void OAIParking::setSpaces(const qint32 &spaces) {
    m_spaces = spaces;
    m_spaces_isSet = true;
}

bool OAIParking::is_spaces_Set() const{
    return m_spaces_isSet;
}

bool OAIParking::is_spaces_Valid() const{
