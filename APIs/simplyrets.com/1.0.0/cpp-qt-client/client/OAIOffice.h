...
public:
    ...
    bool is_brokerid_Set() const;
    bool is_brokerid_Valid() const;
    ...
    QString getServingName() const;
    void setServingName(const QString &serving_name);
    bool is_serving_name_Set() const;
    bool is_serving_name_Valid() const;
...
private:
    ...
    QString m_brokerid;
    bool m_brokerid_isSet;
    bool m_brokerid_isValid;
    ...
    QString m_serving_name;
    bool m_serving_name_isSet;
    bool m_serving_name_isValid;
};
