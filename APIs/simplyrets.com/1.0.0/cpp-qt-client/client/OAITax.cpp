...
void OAITax::initializeModel() {
    ...
    m_tax_annual_amount_isSet = false;
    m_tax_annual_amount_isValid = false;
...
void OAITax::fromJsonObject(QJsonObject json) {
    ...
    m_tax_annual_amount_isValid = ::OpenAPI::fromJsonValue(m_tax_annual_amount, json[QString("taxAnnualAmount")]);
    m_tax_annual_amount_isSet = !json[QString("taxAnnualAmount")].isNull() && m_tax_annual_amount_isValid;
...
QJsonObject OAITax::asJsonObject() const {
    ...
    if (m_tax_annual_amount_isSet) {
        obj.insert(QString("taxAnnualAmount"), ::OpenAPI::toJsonValue(m_tax_annual_amount));
    }
    if (m_tax_year_isSet) {
...
QString OAITax::getId() const {
    return m_id;
}
void OAITax::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAITax::is_id_Set() const{
    return m_id_isSet;
}

bool OAITax::is_id_Valid() const{
    return m_id_isValid;
}

QString OAITax::getTaxAnnualAmount() const {
    return m_tax_annual_amount;
}
void OAITax::setTaxAnnualAmount(const QString &tax_annual_amount) {
    m_tax_annual_amount = tax_annual_amount;
    m_tax_annual_amount_isSet = true;
}

bool OAITax::is_tax_annual_amount_Set() const{
    return m_tax_annual_amount_isSet;
}

bool OAITax::is_tax_annual_amount_Valid() const{
    return m_tax_annual_amount_isValid;
}

qint64 OAITax::getTaxYear() const {
    return m_tax_year;
}
void OAITax::setTaxYear(const qint64 &tax_year) {
    m_tax_year = tax_year;
    m_tax_year_isSet = true;
}

bool OAITax::is_tax_year_Set() const{
    return m_tax_year_isSet;
}

bool OAITax::is_tax_year_Valid() const{
