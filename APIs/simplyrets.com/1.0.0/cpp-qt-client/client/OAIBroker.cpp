...
OAIBroker::OAIBroker(QString json) {
...
void OAIBroker::initializeModel() {

    m_startdate_isSet = false;
    m_startdate_isValid = false;
}

void OAIBroker::fromJson(QString jsonString) {
...
void OAIBroker::fromJsonObject(QJsonObject json) {

    m_startdate_isValid = ::OpenAPI::fromJsonValue(m_startdate, json[QString("startdate")]);
    m_startdate_isSet = !json[QString("startdate")].isNull() && m_startdate_isValid;
}

QString OAIBroker::asJson() const {
...
QJsonObject OAIBroker::asJsonObject() const {
    QJsonObject obj;
    if (m_startdate_isSet) {
        obj.insert(QString("startdate"), ::OpenAPI::toJsonValue(m_startdate));
    }
    return obj;
}

QDateTime OAIBroker::getStartdate() const {
    return m_startdate;
}
void OAIBroker::setStartdate(const QDateTime &startdate) {
    m_startdate = startdate;
    m_startdate_isSet = true;
}

bool OAIBroker::is_startdate_Set() const{
    return m_startdate_isSet;
}

bool OAIBroker::is_startdate_Valid() const{
    return m_startdate_isValid;
}

bool OAIBroker::isSet() const {
