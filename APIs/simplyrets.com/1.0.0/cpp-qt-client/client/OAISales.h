...
public:
    ...
    QDateTime getCloseDate() const;
    void setCloseDate(const QDateTime &close_date);
    bool is_close_date_Set() const;
    bool is_close_date_Valid() const;

    qint64 getClosePrice() const;
    void setClosePrice(const qint64 &close_price);
    bool is_close_price_Set() const;
    bool is_close_price_Valid() const;

    QDateTime getContractDate() const;
    void setContractDate(const QDateTime &contract_date);
    bool is_contract_date_Set() const;
    bool is_contract_date_Valid() const;
...
private:
    ...
    QDateTime m_close_date;
    bool m_close_date_isSet;
    bool m_close_date_isValid;

    qint64 m_close_price;
    bool m_close_price_isSet;
    bool m_close_price_isValid;

    QDateTime m_contract_date;
    bool m_contract_date_isSet;
    bool m_contract_date_isValid;
