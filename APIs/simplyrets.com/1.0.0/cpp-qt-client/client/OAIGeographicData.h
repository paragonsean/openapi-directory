...
#ifndef OAIGeographicData_H
#define OAIGeographicData_H
...
class OAIGeographicData : public OAIObject {
public:
    OAIGeographicData();
    OAIGeographicData(QString json);
    ~OAIGeographicData() override;
    ...
    QString getMarketArea() const;
    void setMarketArea(const QString &market_area);
    bool is_market_area_Set() const;
    bool is_market_area_Valid() const;
...
private:
    ...
    QString m_market_area;
    bool m_market_area_isSet;
    bool m_market_area_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIGeographicData)

#endif // OAIGeographicData_H
