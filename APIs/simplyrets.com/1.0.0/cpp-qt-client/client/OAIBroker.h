...
class OAIBroker : public OAIObject {
public:
    OAIBroker();
    OAIBroker(QString json);
    ~OAIBroker() override;
    ...
    bool is_startdate_Set() const;
    bool is_startdate_Valid() const;
...
private:
    ...
    bool m_startdate_isSet;
    bool m_startdate_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIBroker)
