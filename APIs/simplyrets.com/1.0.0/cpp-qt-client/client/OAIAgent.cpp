...
OAIContactInformation OAIAgent::getContact() const {
    return m_contact;
}
void OAIAgent::setContact(const OAIContactInformation &contact) {
    m_contact = contact;
    m_contact_isSet = true;
}

bool OAIAgent::is_contact_Set() const{
    return m_contact_isSet;
}

bool OAIAgent::is_contact_Valid() const{
    return m_contact_isValid;
}

QString OAIAgent::getFirstName() const {
    return m_first_name;
}
void OAIAgent::setFirstName(const QString &first_name) {
    m_first_name = first_name;
    m_first_name_isSet = true;
}

bool OAIAgent::is_first_name_Set() const{
    return m_first_name_isSet;
}

bool OAIAgent::is_first_name_Valid() const{
    return m_first_name_isValid;
}

QString OAIAgent::getId() const {
    return m_id;
}
void OAIAgent::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIAgent::is_id_Set() const{
    return m_id_isSet;
}

bool OAIAgent::is_id_Valid() const{
    return m_id_isValid;
}

QString OAIAgent::getLastName() const {
    return m_last_name;
}
void OAIAgent::setLastName(const QString &last_name) {
    m_last_name = last_name;
    m_last_name_isSet = true;
}

bool OAIAgent::is_last_name_Set() const{
    return m_last_name_isSet;
}

bool OAIAgent::is_last_name_Valid() const{
