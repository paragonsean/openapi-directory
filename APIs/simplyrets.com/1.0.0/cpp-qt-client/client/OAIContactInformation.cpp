...
QString OAIContactInformation::getCell() const {
    return m_cell;
}
void OAIContactInformation::setCell(const QString &cell) {
    m_cell = cell;
    m_cell_isSet = true;
}

bool OAIContactInformation::is_cell_Set() const{
    return m_cell_isSet;
}

bool OAIContactInformation::is_cell_Valid() const{
...
QString OAIContactInformation::getOffice() const {
    return m_office;
}
void OAIContactInformation::setOffice(const QString &office) {
    m_office = office;
    m_office_isSet = true;
}

bool OAIContactInformation::is_office_Set() const{
    return m_office_isSet;
}

bool OAIContactInformation::is_office_Valid() const{
