...
#ifndef OAIMlsInformation_H
#define OAIMlsInformation_H
...
class OAIMlsInformation : public OAIObject {
public:
    OAIMlsInformation();
    OAIMlsInformation(QString json);
    ~OAIMlsInformation() override;
    ...
    QString getAreaMinor() const;
    void setAreaMinor(const QString &area_minor);
    bool is_area_minor_Set() const;
    bool is_area_minor_Valid() const;

    qint64 getDaysOnMarket() const;
    void setDaysOnMarket(const qint64 &days_on_market);
    bool is_days_on_market_Set() const;
    bool is_days_on_market_Valid() const;

    QString getOriginatingSystemName() const;
    void setOriginatingSystemName(const QString &originating_system_name);
    bool is_originating_system_name_Set() const;
    bool is_originating_system_name_Valid() const;
...
private:
    ...
    QString m_area_minor;
    bool m_area_minor_isSet;
    bool m_area_minor_isValid;

    qint64 m_days_on_market;
    bool m_days_on_market_isSet;
    bool m_days_on_market_isValid;

    QString m_originating_system_name;
    bool m_originating_system_name_isSet;
    bool m_originating_system_name_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMlsInformation)

#endif // OAIMlsInformation_H
