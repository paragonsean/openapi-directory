...
OAIArchiveHistory::OAIArchiveHistory(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIArchiveHistory::OAIArchiveHistory() {
    this->initializeModel();
}

OAIArchiveHistory::~OAIArchiveHistory() {}

void OAIArchiveHistory::initializeModel() {
...
void OAIArchiveHistory::fromJson(QString jsonString) {
...
void OAIArchiveHistory::fromJsonObject(QJsonObject json) {
...
QString OAIArchiveHistory::asJson() const {
...
QJsonObject OAIArchiveHistory::asJsonObject() const {
    QJsonObject obj;
    if (m_archived_isSet) {
...
bool OAIArchiveHistory::isArchived() const {
    return m_archived;
}
void OAIArchiveHistory::setArchived(const bool &archived) {
    m_archived = archived;
    m_archived_isSet = true;
}

bool OAIArchiveHistory::is_archived_Set() const{
    return m_archived_isSet;
}

bool OAIArchiveHistory::is_archived_Valid() const{
    return m_archived_isValid;
}

QString OAIArchiveHistory::getModifiedAt() const {
    return m_modified_at;
}
void OAIArchiveHistory::setModifiedAt(const QString &modified_at) {
    m_modified_at = modified_at;
    m_modified_at_isSet = true;
}

bool OAIArchiveHistory::is_modified_at_Set() const{
    return m_modified_at_isSet;
}

bool OAIArchiveHistory::is_modified_at_Valid() const{
    return m_modified_at_isValid;
}

QString OAIArchiveHistory::getNotes() const {
    return m_notes;
}
void OAIArchiveHistory::setNotes(const QString &notes) {
    m_notes = notes;
    m_notes_isSet = true;
}

bool OAIArchiveHistory::is_notes_Set() const{
    return m_notes_isSet;
}

bool OAIArchiveHistory::is_notes_Valid() const{
    return m_notes_isValid;
}

QString OAIArchiveHistory::getReason() const {
    return m_reason;
}
void OAIArchiveHistory::setReason(const QString &reason) {
    m_reason = reason;
    m_reason_isSet = true;
}

bool OAIArchiveHistory::is_reason_Set() const{
    return m_reason_isSet;
}

bool OAIArchiveHistory::is_reason_Valid() const{
    return m_reason_isValid;
}

bool OAIArchiveHistory::isSet() const {
...
bool OAIArchiveHistory::isValid() const {
