...
#ifndef OAIActionMetric_H
#define OAIActionMetric_H
...
namespace OpenAPI {
class OAIActionMetric_validations;

class OAIActionMetric : public OAIObject {
public:
    OAIActionMetric();
    OAIActionMetric(QString json);
    ~OAIActionMetric() override;
    ...
    OAIObject getGoal() const;
    void setGoal(const OAIObject &goal);
    ...
    OAIActionMetric_validations getValidations() const;
    void setValidations(const OAIActionMetric_validations &validations);
...
private:
    ...
    OAIActionMetric_validations m_validations;
...
Q_DECLARE_METATYPE(OpenAPI::OAIActionMetric)

#endif // OAIActionMetric_H
