...
#ifndef OAI_OAIBundleApi_H
#define OAI_OAIBundleApi_H
...
#include "OAICreateBundleRequest.h"
#include "OAICreateBundleResponse.h"
#include "OAICreateOrUpdateErrorResponse.h"
#include "OAIFetchBundleResponse.h"
#include "OAIFetchErrorResponse.h"
#include "OAIUpdateBundleRequest.h"
...
class OAIBundleApi : public QObject {
    Q_OBJECT

public:
    OAIBundleApi(const int timeOut = 0);
    ~OAIBundleApi();
    ...
    /**
    * @param[in]  oai_create_bundle_request OAICreateBundleRequest [required]
    */
    virtual void createBundle(const OAICreateBundleRequest &oai_create_bundle_request);

    /**
    * @param[in]  id QString [required]
    */
    virtual void fetchBundle(const QString &id);

    /**
    * @param[in]  id QString [required]
    * @param[in]  oai_update_bundle_request OAIUpdateBundleRequest [required]
    */
    virtual void updateBundle(const QString &id, const OAIUpdateBundleRequest &oai_update_bundle_request);
...
Q_SIGNALS:
    ...
    void createBundleSignal(OAICreateBundleResponse summary);
    void fetchBundleSignal(OAIFetchBundleResponse summary);
    void updateBundleSignal(OAIUpdateBundleResponse summary);


    void createBundleSignalFull(OAIHttpRequestWorker *worker, OAICreateBundleResponse summary);
    void fetchBundleSignalFull(OAIHttpRequestWorker *worker, OAIFetchBundleResponse summary);
    void updateBundleSignalFull(OAIHttpRequestWorker *worker, OAIUpdateBundleResponse summary);

    Q_DECL_DEPRECATED_X("Use createBundleSignalError() instead")
    void createBundleSignalE(OAICreateBundleResponse summary, QNetworkReply::NetworkError error_type, QString error_str);
    void createBundleSignalError(OAICreateBundleResponse summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use fetchBundleSignalError() instead")
    void fetchBundleSignalE(OAIFetchBundleResponse summary, QNetworkReply::NetworkError error_type, QString error_str);
    void fetchBundleSignalError(OAIFetchBundleResponse summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use updateBundleSignalError() instead")
    void updateBundleSignalE(OAIUpdateBundleResponse summary, QNetworkReply::NetworkError error_type, QString error_str);
    void updateBundleSignalError(OAIUpdateBundleResponse summary, QNetworkReply::NetworkError error_type, const QString &error_str);
