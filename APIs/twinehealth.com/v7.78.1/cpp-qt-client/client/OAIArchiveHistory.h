...
#ifndef OAIArchiveHistory_H
#define OAIArchiveHistory_H
...
class OAIArchiveHistory : public OAIObject {
public:
    OAIArchiveHistory();
    OAIArchiveHistory(QString json);
    ~OAIArchiveHistory() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIArchiveHistory)

#endif // OAIArchiveHistory_H
