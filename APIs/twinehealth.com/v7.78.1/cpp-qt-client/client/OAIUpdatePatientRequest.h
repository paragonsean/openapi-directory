...
/*
 * OAIUpdatePatientRequest.h
 *
 * 
 */

#ifndef OAIUpdatePatientRequest_H
#define OAIUpdatePatientRequest_H
...
class OAIUpdatePatientRequest : public OAIObject {
public:
    OAIUpdatePatientRequest();
    OAIUpdatePatientRequest(QString json);
    ~OAIUpdatePatientRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdatePatientRequest)

#endif // OAIUpdatePatientRequest_H
