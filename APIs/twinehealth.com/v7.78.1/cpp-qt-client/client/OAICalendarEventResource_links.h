...
/*
 * OAICalendarEventResource_links.h
 *
 * 
 */

#ifndef OAICalendarEventResource_links_H
#define OAICalendarEventResource_links_H
...
class OAICalendarEventResource_links : public OAIObject {
public:
    OAICalendarEventResource_links();
    OAICalendarEventResource_links(QString json);
    ~OAICalendarEventResource_links() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICalendarEventResource_links)

#endif // OAICalendarEventResource_links_H
