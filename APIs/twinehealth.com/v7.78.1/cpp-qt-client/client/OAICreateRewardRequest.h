...
/*
 * OAICreateRewardRequest.h
 *
 * 
 */

#ifndef OAICreateRewardRequest_H
#define OAICreateRewardRequest_H
...
class OAICreateRewardRequest : public OAIObject {
public:
    OAICreateRewardRequest();
    OAICreateRewardRequest(QString json);
    ~OAICreateRewardRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateRewardRequest)

#endif // OAICreateRewardRequest_H
