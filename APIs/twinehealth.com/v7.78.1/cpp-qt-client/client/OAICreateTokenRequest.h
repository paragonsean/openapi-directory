...
namespace OpenAPI {
class OAICreateTokenRequest_data;
...
public:
    ...
    OAICreateTokenRequest_data getData() const;
    void setData(const OAICreateTokenRequest_data &data);
...
private:
    ...
    OAICreateTokenRequest_data m_data;
    bool m_data_isSet;
    bool m_data_isValid;
};
