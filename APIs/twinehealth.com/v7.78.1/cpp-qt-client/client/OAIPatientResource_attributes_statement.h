...
/*
 * OAIPatientResource_attributes_statement.h
 *
 * A patient&#39;s motivation statement.
 */

#ifndef OAIPatientResource_attributes_statement_H
#define OAIPatientResource_attributes_statement_H
...
class OAIPatientResource_attributes_statement : public OAIObject {
public:
    OAIPatientResource_attributes_statement();
    OAIPatientResource_attributes_statement(QString json);
    ~OAIPatientResource_attributes_statement() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPatientResource_attributes_statement)

#endif // OAIPatientResource_attributes_statement_H
