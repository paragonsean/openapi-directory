...
/*
 * OAIUpsertPatientRequest_meta_query_identifier.h
 *
 * Identifier to match patient
 */

#ifndef OAIUpsertPatientRequest_meta_query_identifier_H
#define OAIUpsertPatientRequest_meta_query_identifier_H
...
class OAIUpsertPatientRequest_meta_query_identifier : public OAIObject {
public:
    OAIUpsertPatientRequest_meta_query_identifier();
    OAIUpsertPatientRequest_meta_query_identifier(QString json);
    ~OAIUpsertPatientRequest_meta_query_identifier() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpsertPatientRequest_meta_query_identifier)

#endif // OAIUpsertPatientRequest_meta_query_identifier_H
