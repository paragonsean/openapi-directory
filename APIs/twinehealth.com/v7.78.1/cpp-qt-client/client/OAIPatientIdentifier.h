...
/*
 * OAIPatientIdentifier.h
 *
 * 
 */

#ifndef OAIPatientIdentifier_H
#define OAIPatientIdentifier_H
...
class OAIPatientIdentifier : public OAIObject {
public:
    OAIPatientIdentifier();
    OAIPatientIdentifier(QString json);
    ~OAIPatientIdentifier() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPatientIdentifier)

#endif // OAIPatientIdentifier_H
