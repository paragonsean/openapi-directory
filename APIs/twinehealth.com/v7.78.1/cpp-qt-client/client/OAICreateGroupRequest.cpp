...
OAIGroupResource OAICreateGroupRequest::getData() const {
    return m_data;
}
void OAICreateGroupRequest::setData(const OAIGroupResource &data) {
    m_data = data;
    m_data_isSet = true;
}

bool OAICreateGroupRequest::is_data_Set() const{
    return m_data_isSet;
}

bool OAICreateGroupRequest::is_data_Valid() const{
