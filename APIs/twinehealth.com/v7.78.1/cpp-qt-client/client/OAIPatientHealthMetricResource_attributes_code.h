...
/*
 * OAIPatientHealthMetricResource_attributes_code.h
 *
 * 
 */

#ifndef OAIPatientHealthMetricResource_attributes_code_H
#define OAIPatientHealthMetricResource_attributes_code_H
...
class OAIPatientHealthMetricResource_attributes_code : public OAIObject {
public:
    OAIPatientHealthMetricResource_attributes_code();
    OAIPatientHealthMetricResource_attributes_code(QString json);
    ~OAIPatientHealthMetricResource_attributes_code() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPatientHealthMetricResource_attributes_code)

#endif // OAIPatientHealthMetricResource_attributes_code_H
