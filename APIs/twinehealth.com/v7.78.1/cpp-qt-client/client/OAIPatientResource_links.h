...
/*
 * OAIPatientResource_links.h
 *
 * 
 */

#ifndef OAIPatientResource_links_H
#define OAIPatientResource_links_H
...
class OAIPatientResource_links : public OAIObject {
public:
    OAIPatientResource_links();
    OAIPatientResource_links(QString json);
    ~OAIPatientResource_links() override;
    ...
    QString getTwineWebApp() const;
    void setTwineWebApp(const QString &twine_web_app);
    bool is_twine_web_app_Set() const;
    bool is_twine_web_app_Valid() const;
...
private:
    ...
    QString m_twine_web_app;
    bool m_twine_web_app_isSet;
    bool m_twine_web_app_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIPatientResource_links)

#endif // OAIPatientResource_links_H
