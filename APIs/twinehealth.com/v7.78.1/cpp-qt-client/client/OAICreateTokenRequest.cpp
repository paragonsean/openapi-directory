...
OAICreateTokenRequest_data OAICreateTokenRequest::getData() const {
    return m_data;
}
void OAICreateTokenRequest::setData(const OAICreateTokenRequest_data &data) {
    m_data = data;
    m_data_isSet = true;
}

bool OAICreateTokenRequest::is_data_Set() const{
    return m_data_isSet;
}

bool OAICreateTokenRequest::is_data_Valid() const{
