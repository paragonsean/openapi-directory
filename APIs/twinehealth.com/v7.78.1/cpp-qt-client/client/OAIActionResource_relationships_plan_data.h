...
/*
 * OAIActionResource_relationships_plan_data.h
 *
 * 
 */

#ifndef OAIActionResource_relationships_plan_data_H
#define OAIActionResource_relationships_plan_data_H
...
class OAIActionResource_relationships_plan_data : public OAIObject {
public:
    OAIActionResource_relationships_plan_data();
    OAIActionResource_relationships_plan_data(QString json);
    ~OAIActionResource_relationships_plan_data() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIActionResource_relationships_plan_data)

#endif // OAIActionResource_relationships_plan_data_H
