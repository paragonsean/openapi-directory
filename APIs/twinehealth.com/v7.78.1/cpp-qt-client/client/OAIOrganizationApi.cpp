...
void OAIOrganizationApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("fetchOrganization", defaultConf);
    _serverIndices.insert("fetchOrganization", 0);
}
...
void OAIOrganizationApi::fetchOrganization(const QString &id) {
    QString fullPath = QString(_serverConfigs["fetchOrganization"][_serverIndices.value("fetchOrganization")].URL()+"/organization/{id}");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIOrganizationApi::fetchOrganizationCallback);
...
void OAIOrganizationApi::fetchOrganizationCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT fetchOrganizationSignal(output);
        Q_EMIT fetchOrganizationSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT fetchOrganizationSignalE(output, error_type, error_str);
        Q_EMIT fetchOrganizationSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT fetchOrganizationSignalError(output, error_type, error_str);
        Q_EMIT fetchOrganizationSignalErrorFull(worker, error_type, error_str);
    }
}
