...
/*
 * OAIHealthProfileQuestionResource_links.h
 *
 * 
 */

#ifndef OAIHealthProfileQuestionResource_links_H
#define OAIHealthProfileQuestionResource_links_H
...
class OAIHealthProfileQuestionResource_links : public OAIObject {
public:
    OAIHealthProfileQuestionResource_links();
    OAIHealthProfileQuestionResource_links(QString json);
    ~OAIHealthProfileQuestionResource_links() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIHealthProfileQuestionResource_links)

#endif // OAIHealthProfileQuestionResource_links_H
