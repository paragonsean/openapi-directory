...
/*
 * OAIGroupResource_attributes.h
 *
 * 
 */

#ifndef OAIGroupResource_attributes_H
#define OAIGroupResource_attributes_H
...
class OAIGroupResource_attributes : public OAIObject {
public:
    OAIGroupResource_attributes();
    OAIGroupResource_attributes(QString json);
    ~OAIGroupResource_attributes() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGroupResource_attributes)

#endif // OAIGroupResource_attributes_H
