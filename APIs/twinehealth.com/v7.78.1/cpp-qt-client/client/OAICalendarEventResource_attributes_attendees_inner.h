...
/*
 * OAICalendarEventResource_attributes_attendees_inner.h
 *
 * 
 */

#ifndef OAICalendarEventResource_attributes_attendees_inner_H
#define OAICalendarEventResource_attributes_attendees_inner_H
...
class OAICalendarEventResource_attributes_attendees_inner : public OAIObject {
public:
    OAICalendarEventResource_attributes_attendees_inner();
    OAICalendarEventResource_attributes_attendees_inner(QString json);
    ~OAICalendarEventResource_attributes_attendees_inner() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICalendarEventResource_attributes_attendees_inner)

#endif // OAICalendarEventResource_attributes_attendees_inner_H
