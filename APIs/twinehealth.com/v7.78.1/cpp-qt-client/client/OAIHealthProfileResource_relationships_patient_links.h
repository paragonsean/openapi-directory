...
/*
 * OAIHealthProfileResource_relationships_patient_links.h
 *
 * 
 */

#ifndef OAIHealthProfileResource_relationships_patient_links_H
#define OAIHealthProfileResource_relationships_patient_links_H
...
class OAIHealthProfileResource_relationships_patient_links : public OAIObject {
public:
    OAIHealthProfileResource_relationships_patient_links();
    OAIHealthProfileResource_relationships_patient_links(QString json);
    ~OAIHealthProfileResource_relationships_patient_links() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIHealthProfileResource_relationships_patient_links)

#endif // OAIHealthProfileResource_relationships_patient_links_H
