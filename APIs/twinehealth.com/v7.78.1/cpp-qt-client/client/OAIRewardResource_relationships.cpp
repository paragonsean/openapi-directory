...
#include "OAIRewardResource_relationships.h"
...
OAIRewardResource_relationships::OAIRewardResource_relationships(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIRewardResource_relationships::OAIRewardResource_relationships() {
    this->initializeModel();
}

OAIRewardResource_relationships::~OAIRewardResource_relationships() {}

void OAIRewardResource_relationships::initializeModel() {
...
void OAIRewardResource_relationships::fromJson(QString jsonString) {
...
void OAIRewardResource_relationships::fromJsonObject(QJsonObject json) {
...
QString OAIRewardResource_relationships::asJson() const {
...
QJsonObject OAIRewardResource_relationships::asJsonObject() const {
    QJsonObject obj;
    if (m_patient.isSet()) {
...
OAIRewardEarningFulfillmentResource_relationships_patient OAIRewardResource_relationships::getPatient() const {
    return m_patient;
}
void OAIRewardResource_relationships::setPatient(const OAIRewardEarningFulfillmentResource_relationships_patient &patient) {
    m_patient = patient;
    m_patient_isSet = true;
}

bool OAIRewardResource_relationships::is_patient_Set() const{
    return m_patient_isSet;
}

bool OAIRewardResource_relationships::is_patient_Valid() const{
    return m_patient_isValid;
}

OAIEmailHistoryResource_relationships_receiver OAIRewardResource_relationships::getRewardProgramActivation() const {
    return m_reward_program_activation;
}
void OAIRewardResource_relationships::setRewardProgramActivation(const OAIEmailHistoryResource_relationships_receiver &reward_program_activation) {
    m_reward_program_activation = reward_program_activation;
    m_reward_program_activation_isSet = true;
}

bool OAIRewardResource_relationships::is_reward_program_activation_Set() const{
    return m_reward_program_activation_isSet;
}

bool OAIRewardResource_relationships::is_reward_program_activation_Valid() const{
    return m_reward_program_activation_isValid;
}

bool OAIRewardResource_relationships::isSet() const {
...
bool OAIRewardResource_relationships::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_reward_program_activation_isValid && true;
}
