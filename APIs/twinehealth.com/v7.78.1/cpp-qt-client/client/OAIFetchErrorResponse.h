...
/*
 * OAIFetchErrorResponse.h
 *
 * 
 */

#ifndef OAIFetchErrorResponse_H
#define OAIFetchErrorResponse_H
...
class OAIFetchErrorResponse : public OAIObject {
public:
    OAIFetchErrorResponse();
    OAIFetchErrorResponse(QString json);
    ~OAIFetchErrorResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFetchErrorResponse)

#endif // OAIFetchErrorResponse_H
