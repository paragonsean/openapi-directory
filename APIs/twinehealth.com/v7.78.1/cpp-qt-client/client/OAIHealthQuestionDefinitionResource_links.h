...
/*
 * OAIHealthQuestionDefinitionResource_links.h
 *
 * 
 */

#ifndef OAIHealthQuestionDefinitionResource_links_H
#define OAIHealthQuestionDefinitionResource_links_H
...
class OAIHealthQuestionDefinitionResource_links : public OAIObject {
public:
    OAIHealthQuestionDefinitionResource_links();
    OAIHealthQuestionDefinitionResource_links(QString json);
    ~OAIHealthQuestionDefinitionResource_links() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIHealthQuestionDefinitionResource_links)

#endif // OAIHealthQuestionDefinitionResource_links_H
