...
OAITokenResource OAICreateTokenResponse::getData() const {
    return m_data;
}
void OAICreateTokenResponse::setData(const OAITokenResource &data) {
    m_data = data;
    m_data_isSet = true;
}

bool OAICreateTokenResponse::is_data_Set() const{
    return m_data_isSet;
}

bool OAICreateTokenResponse::is_data_Valid() const{
    return m_data_isValid;
}

QList<OAIGroupResource> OAICreateTokenResponse::getIncluded() const {
    return m_included;
}
void OAICreateTokenResponse::setIncluded(const QList<OAIGroupResource> &included) {
    m_included = included;
    m_included_isSet = true;
}

bool OAICreateTokenResponse::is_included_Set() const{
    return m_included_isSet;
}

bool OAICreateTokenResponse::is_included_Valid() const{
    return m_included_isValid;
}

OAICreateOrUpdateMetaResponse OAICreateTokenResponse::getMeta() const {
    return m_meta;
}
void OAICreateTokenResponse::setMeta(const OAICreateOrUpdateMetaResponse &meta) {
    m_meta = meta;
    m_meta_isSet = true;
}

bool OAICreateTokenResponse::is_meta_Set() const{
    return m_meta_isSet;
}

bool OAICreateTokenResponse::is_meta_Valid() const{
