...
/*
 * OAIBundleResource_attributes.h
 *
 * 
 */

#ifndef OAIBundleResource_attributes_H
#define OAIBundleResource_attributes_H
...
class OAIBundleResource_attributes : public OAIObject {
public:
    OAIBundleResource_attributes();
    OAIBundleResource_attributes(QString json);
    ~OAIBundleResource_attributes() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBundleResource_attributes)

#endif // OAIBundleResource_attributes_H
