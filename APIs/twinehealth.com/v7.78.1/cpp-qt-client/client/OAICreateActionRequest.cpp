...
OAIActionResource OAICreateActionRequest::getData() const {
    return m_data;
}
void OAICreateActionRequest::setData(const OAIActionResource &data) {
    m_data = data;
    m_data_isSet = true;
}

bool OAICreateActionRequest::is_data_Set() const{
    return m_data_isSet;
}

bool OAICreateActionRequest::is_data_Valid() const{
