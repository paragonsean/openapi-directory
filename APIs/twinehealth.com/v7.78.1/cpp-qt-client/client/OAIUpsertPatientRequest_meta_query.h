...
/*
 * OAIUpsertPatientRequest_meta_query.h
 *
 * 
 */

#ifndef OAIUpsertPatientRequest_meta_query_H
#define OAIUpsertPatientRequest_meta_query_H
...
namespace OpenAPI {
class OAIUpsertPatientRequest_meta_query_identifier;

class OAIUpsertPatientRequest_meta_query : public OAIObject {
public:
    OAIUpsertPatientRequest_meta_query();
    OAIUpsertPatientRequest_meta_query(QString json);
    ~OAIUpsertPatientRequest_meta_query() override;
    ...
    OAIUpsertPatientRequest_meta_query_identifier getIdentifier() const;
    void setIdentifier(const OAIUpsertPatientRequest_meta_query_identifier &identifier);
...
private:
    ...
    OAIUpsertPatientRequest_meta_query_identifier m_identifier;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpsertPatientRequest_meta_query)

#endif // OAIUpsertPatientRequest_meta_query_H
