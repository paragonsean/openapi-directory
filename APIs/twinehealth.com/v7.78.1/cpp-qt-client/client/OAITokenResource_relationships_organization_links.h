...
/*
 * OAITokenResource_relationships_organization_links.h
 *
 * 
 */

#ifndef OAITokenResource_relationships_organization_links_H
#define OAITokenResource_relationships_organization_links_H
...
class OAITokenResource_relationships_organization_links : public OAIObject {
public:
    OAITokenResource_relationships_organization_links();
    OAITokenResource_relationships_organization_links(QString json);
    ~OAITokenResource_relationships_organization_links() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITokenResource_relationships_organization_links)

#endif // OAITokenResource_relationships_organization_links_H
