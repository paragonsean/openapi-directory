...
/*
 * OAICreateBundleRequest.h
 *
 * 
 */

#ifndef OAICreateBundleRequest_H
#define OAICreateBundleRequest_H
...
class OAICreateBundleRequest : public OAIObject {
public:
    OAICreateBundleRequest();
    OAICreateBundleRequest(QString json);
    ~OAICreateBundleRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateBundleRequest)

#endif // OAICreateBundleRequest_H
