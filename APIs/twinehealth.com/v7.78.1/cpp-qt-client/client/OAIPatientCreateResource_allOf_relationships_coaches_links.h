...
/*
 * OAIPatientCreateResource_allOf_relationships_coaches_links.h
 *
 * 
 */

#ifndef OAIPatientCreateResource_allOf_relationships_coaches_links_H
#define OAIPatientCreateResource_allOf_relationships_coaches_links_H
...
class OAIPatientCreateResource_allOf_relationships_coaches_links : public OAIObject {
public:
    OAIPatientCreateResource_allOf_relationships_coaches_links();
    OAIPatientCreateResource_allOf_relationships_coaches_links(QString json);
    ~OAIPatientCreateResource_allOf_relationships_coaches_links() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPatientCreateResource_allOf_relationships_coaches_links)

#endif // OAIPatientCreateResource_allOf_relationships_coaches_links_H
