...
/*
 * OAICoachResource_links.h
 *
 * 
 */

#ifndef OAICoachResource_links_H
#define OAICoachResource_links_H
...
class OAICoachResource_links : public OAIObject {
public:
    OAICoachResource_links();
    OAICoachResource_links(QString json);
    ~OAICoachResource_links() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICoachResource_links)

#endif // OAICoachResource_links_H
