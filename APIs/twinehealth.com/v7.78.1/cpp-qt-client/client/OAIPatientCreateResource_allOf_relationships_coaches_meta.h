...
/*
 * OAIPatientCreateResource_allOf_relationships_coaches_meta.h
 *
 * 
 */

#ifndef OAIPatientCreateResource_allOf_relationships_coaches_meta_H
#define OAIPatientCreateResource_allOf_relationships_coaches_meta_H
...
class OAIPatientCreateResource_allOf_relationships_coaches_meta : public OAIObject {
public:
    OAIPatientCreateResource_allOf_relationships_coaches_meta();
    OAIPatientCreateResource_allOf_relationships_coaches_meta(QString json);
    ~OAIPatientCreateResource_allOf_relationships_coaches_meta() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPatientCreateResource_allOf_relationships_coaches_meta)

#endif // OAIPatientCreateResource_allOf_relationships_coaches_meta_H
