...
/*
 * OAICalendarEventResponseResource_attributes.h
 *
 * 
 */

#ifndef OAICalendarEventResponseResource_attributes_H
#define OAICalendarEventResponseResource_attributes_H
...
class OAICalendarEventResponseResource_attributes : public OAIObject {
public:
    OAICalendarEventResponseResource_attributes();
    OAICalendarEventResponseResource_attributes(QString json);
    ~OAICalendarEventResponseResource_attributes() override;
    ...
    OAIObject getAttendee() const;
    void setAttendee(const OAIObject &attendee);
...
Q_DECLARE_METATYPE(OpenAPI::OAICalendarEventResponseResource_attributes)

#endif // OAICalendarEventResponseResource_attributes_H
