...
/*
 * OAIHealthProfileResource_relationships_questions_links.h
 *
 * 
 */

#ifndef OAIHealthProfileResource_relationships_questions_links_H
#define OAIHealthProfileResource_relationships_questions_links_H
...
class OAIHealthProfileResource_relationships_questions_links : public OAIObject {
public:
    OAIHealthProfileResource_relationships_questions_links();
    OAIHealthProfileResource_relationships_questions_links(QString json);
    ~OAIHealthProfileResource_relationships_questions_links() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIHealthProfileResource_relationships_questions_links)

#endif // OAIHealthProfileResource_relationships_questions_links_H
