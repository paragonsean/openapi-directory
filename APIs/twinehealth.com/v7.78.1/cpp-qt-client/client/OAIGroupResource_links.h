...
/*
 * OAIGroupResource_links.h
 *
 * 
 */

#ifndef OAIGroupResource_links_H
#define OAIGroupResource_links_H
...
class OAIGroupResource_links : public OAIObject {
public:
    OAIGroupResource_links();
    OAIGroupResource_links(QString json);
    ~OAIGroupResource_links() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGroupResource_links)

#endif // OAIGroupResource_links_H
