...
/*
 * OAICollectionResponseLinks.h
 *
 * 
 */

#ifndef OAICollectionResponseLinks_H
#define OAICollectionResponseLinks_H
...
class OAICollectionResponseLinks : public OAIObject {
public:
    OAICollectionResponseLinks();
    OAICollectionResponseLinks(QString json);
    ~OAICollectionResponseLinks() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICollectionResponseLinks)

#endif // OAICollectionResponseLinks_H
