...
#ifndef OAIError_source_H
#define OAIError_source_H
...
class OAIError_source : public OAIObject {
public:
    OAIError_source();
    OAIError_source(QString json);
    ~OAIError_source() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIError_source)

#endif // OAIError_source_H
