...
/*
 * OAICreateOrUpdateMetaResponse.h
 *
 * 
 */

#ifndef OAICreateOrUpdateMetaResponse_H
#define OAICreateOrUpdateMetaResponse_H
...
class OAICreateOrUpdateMetaResponse : public OAIObject {
public:
    OAICreateOrUpdateMetaResponse();
    OAICreateOrUpdateMetaResponse(QString json);
    ~OAICreateOrUpdateMetaResponse() override;
    ...
    QList<QString> getIgnored() const;
    void setIgnored(const QList<QString> &ignored);
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateOrUpdateMetaResponse)

#endif // OAICreateOrUpdateMetaResponse_H
