...
/*
 * OAIPatientPlanSummaryResource_links.h
 *
 * 
 */

#ifndef OAIPatientPlanSummaryResource_links_H
#define OAIPatientPlanSummaryResource_links_H
...
class OAIPatientPlanSummaryResource_links : public OAIObject {
public:
    OAIPatientPlanSummaryResource_links();
    OAIPatientPlanSummaryResource_links(QString json);
    ~OAIPatientPlanSummaryResource_links() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPatientPlanSummaryResource_links)

#endif // OAIPatientPlanSummaryResource_links_H
