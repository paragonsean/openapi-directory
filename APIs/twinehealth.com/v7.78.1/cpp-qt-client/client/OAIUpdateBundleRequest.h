...
/*
 * OAIUpdateBundleRequest.h
 *
 * 
 */

#ifndef OAIUpdateBundleRequest_H
#define OAIUpdateBundleRequest_H
...
class OAIUpdateBundleRequest : public OAIObject {
public:
    OAIUpdateBundleRequest();
    OAIUpdateBundleRequest(QString json);
    ~OAIUpdateBundleRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateBundleRequest)

#endif // OAIUpdateBundleRequest_H
