...
/*
 * OAIFetchMetaResponse.h
 *
 * 
 */

#ifndef OAIFetchMetaResponse_H
#define OAIFetchMetaResponse_H
...
class OAIFetchMetaResponse : public OAIObject {
public:
    OAIFetchMetaResponse();
    OAIFetchMetaResponse(QString json);
    ~OAIFetchMetaResponse() override;
    ...
    QString getReqId() const;
    void setReqId(const QString &req_id);
    bool is_req_id_Set() const;
    bool is_req_id_Valid() const;
...
private:
    ...
    QString m_req_id;
    bool m_req_id_isSet;
    bool m_req_id_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIFetchMetaResponse)

#endif // OAIFetchMetaResponse_H
