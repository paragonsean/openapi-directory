...
#ifndef OAIActionWindow_H
#define OAIActionWindow_H
...
class OAIActionWindow : public OAIObject {
public:
    OAIActionWindow();
    OAIActionWindow(QString json);
    ~OAIActionWindow() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIActionWindow)

#endif // OAIActionWindow_H
