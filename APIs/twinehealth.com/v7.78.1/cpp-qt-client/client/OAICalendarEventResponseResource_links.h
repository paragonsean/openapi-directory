...
/*
 * OAICalendarEventResponseResource_links.h
 *
 * 
 */

#ifndef OAICalendarEventResponseResource_links_H
#define OAICalendarEventResponseResource_links_H
...
class OAICalendarEventResponseResource_links : public OAIObject {
public:
    OAICalendarEventResponseResource_links();
    OAICalendarEventResponseResource_links(QString json);
    ~OAICalendarEventResponseResource_links() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICalendarEventResponseResource_links)

#endif // OAICalendarEventResponseResource_links_H
