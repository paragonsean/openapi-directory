...
OAIActionResource OAIFetchActionResponse::getData() const {
    return m_data;
}
void OAIFetchActionResponse::setData(const OAIActionResource &data) {
    m_data = data;
    m_data_isSet = true;
}

bool OAIFetchActionResponse::is_data_Set() const{
    return m_data_isSet;
}

bool OAIFetchActionResponse::is_data_Valid() const{
    return m_data_isValid;
}

OAIFetchMetaResponse OAIFetchActionResponse::getMeta() const {
    return m_meta;
}
void OAIFetchActionResponse::setMeta(const OAIFetchMetaResponse &meta) {
    m_meta = meta;
    m_meta_isSet = true;
}

bool OAIFetchActionResponse::is_meta_Set() const{
    return m_meta_isSet;
}

bool OAIFetchActionResponse::is_meta_Valid() const{
