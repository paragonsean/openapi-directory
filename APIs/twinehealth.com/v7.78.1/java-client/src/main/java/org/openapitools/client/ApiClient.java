...
public class ApiClient {
    ...
    private String basePath = "https://api.twinehealth.com/pub";
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/v7.78.1/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://api.twinehealth.com/pub
