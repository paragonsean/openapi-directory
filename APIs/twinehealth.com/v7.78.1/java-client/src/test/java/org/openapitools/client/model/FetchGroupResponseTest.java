...
/**
 * Model tests for FetchGroupResponse
 */
public class FetchGroupResponseTest {
    private final FetchGroupResponse model = new FetchGroupResponse();
