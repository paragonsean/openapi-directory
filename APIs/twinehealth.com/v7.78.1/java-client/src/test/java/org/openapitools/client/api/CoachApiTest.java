...
/**
 * API tests for CoachApi
 */
@Disabled
public class CoachApiTest {

    private final CoachApi api = new CoachApi();
     ...
     */
    @Test
    public void fetchCoachTest() throws ApiException {
        String id = null;
        FetchCoachResponse response = api.fetchCoach(id);
     ...
     */
    @Test
    public void fetchCoachesTest() throws ApiException {
        String filterGroups = null;
        String filterOrganization = null;
        FetchCoachesResponse response = api.fetchCoaches(filterGroups, filterOrganization);
        // TODO: test validations
    }
