...
/**
 * API tests for HealthProfileApi
 */
@Disabled
public class HealthProfileApiTest {

    private final HealthProfileApi api = new HealthProfileApi();
     ...
     */
    @Test
    public void fetchHealthProfileTest() throws ApiException {
        String id = null;
        String include = null;
        FetchHealthProfileResponse response = api.fetchHealthProfile(id, include);
     ...
     */
    @Test
    public void fetchHealthProfilesTest() throws ApiException {
        ...
        String include = null;
        FetchHealthProfilesResponse response = api.fetchHealthProfiles(filterPatient, filterGroups, filterOrganization, pageNumber, pageSize, pageLimit, pageCursor, include);
        // TODO: test validations
    }
