...
/**
 * API tests for ResultApi
 */
@Disabled
public class ResultApiTest {

    private final ResultApi api = new ResultApi();
     ...
     */
    @Test
    public void fetchPatientHealthResultTest() throws ApiException {
        String id = null;
        FetchPatientHealthResultResponse response = api.fetchPatientHealthResult(id);
     ...
     */
    @Test
    public void fetchPatientHealthResultsTest() throws ApiException {
        String filterPatient = null;
        String filterActions = null;
        String filterStartAt = null;
        String filterEndAt = null;
        String filterThreads = null;
        ...
        FetchPatientHealthResultResponse response = api.fetchPatientHealthResults(filterPatient, filterActions, filterStartAt, filterEndAt, filterThreads, filterCreatedAt, filterUpdatedAt, pageNumber, pageSize, pageLimit, pageAfter);
        // TODO: test validations
    }
