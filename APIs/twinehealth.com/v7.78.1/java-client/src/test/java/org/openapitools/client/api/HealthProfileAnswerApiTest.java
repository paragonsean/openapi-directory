...
/**
 * API tests for HealthProfileAnswerApi
 */
@Disabled
public class HealthProfileAnswerApiTest {

    private final HealthProfileAnswerApi api = new HealthProfileAnswerApi();
     ...
     */
    @Test
    public void fetchHealthProfileAnswerTest() throws ApiException {
        String id = null;
        String include = null;
        FetchHealthProfileAnswerResponse response = api.fetchHealthProfileAnswer(id, include);
     ...
     */
    @Test
    public void fetchHealthProfileAnswersTest() throws ApiException {
        ...
        String include = null;
        FetchHealthProfileAnswersResponse response = api.fetchHealthProfileAnswers(filterPatient, filterGroups, filterOrganization, pageNumber, pageSize, pageLimit, pageCursor, include);
        // TODO: test validations
    }
