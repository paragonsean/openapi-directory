...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FitbitPlusApi.ResultApi();
  });
  ...
  describe('ResultApi', function() {
    describe('fetchPatientHealthResult', function() {
      it('should call fetchPatientHealthResult successfully', function(done) {
        //uncomment below and update the code to test fetchPatientHealthResult
        //instance.fetchPatientHealthResult(function(error) {
    ...
    describe('fetchPatientHealthResults', function() {
      it('should call fetchPatientHealthResults successfully', function(done) {
        //uncomment below and update the code to test fetchPatientHealthResults
        //instance.fetchPatientHealthResults(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
