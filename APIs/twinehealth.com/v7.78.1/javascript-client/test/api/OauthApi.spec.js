...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FitbitPlusApi.OauthApi();
  });
  ...
  describe('OauthApi', function() {
    ...
    describe('fetchTokenGroups', function() {
      it('should call fetchTokenGroups successfully', function(done) {
        //uncomment below and update the code to test fetchTokenGroups
        //instance.fetchTokenGroups(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('fetchTokenOrganization', function() {
      it('should call fetchTokenOrganization successfully', function(done) {
        //uncomment below and update the code to test fetchTokenOrganization
        //instance.fetchTokenOrganization(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
