...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FitbitPlusApi.RewardApi();
  });
  ...
  describe('RewardApi', function() {
    ...
    describe('fetchReward', function() {
      it('should call fetchReward successfully', function(done) {
        //uncomment below and update the code to test fetchReward
        //instance.fetchReward(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('fetchRewards', function() {
      it('should call fetchRewards successfully', function(done) {
        //uncomment below and update the code to test fetchRewards
        //instance.fetchRewards(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
