...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FitbitPlusApi.CalendarEventResponseApi();
  });
  ...
  describe('CalendarEventResponseApi', function() {
    describe('createCalendarEventResponse', function() {
      it('should call createCalendarEventResponse successfully', function(done) {
        //uncomment below and update the code to test createCalendarEventResponse
        //instance.createCalendarEventResponse(function(error) {
