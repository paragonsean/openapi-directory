...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FitbitPlusApi.HealthProfileApi();
  });
  ...
  describe('HealthProfileApi', function() {
    describe('fetchHealthProfile', function() {
      it('should call fetchHealthProfile successfully', function(done) {
        //uncomment below and update the code to test fetchHealthProfile
        //instance.fetchHealthProfile(function(error) {
    ...
    describe('fetchHealthProfiles', function() {
      it('should call fetchHealthProfiles successfully', function(done) {
        //uncomment below and update the code to test fetchHealthProfiles
        //instance.fetchHealthProfiles(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
