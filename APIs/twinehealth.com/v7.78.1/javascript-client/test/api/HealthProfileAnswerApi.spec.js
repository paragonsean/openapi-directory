...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FitbitPlusApi.HealthProfileAnswerApi();
  });
  ...
  describe('HealthProfileAnswerApi', function() {
    describe('fetchHealthProfileAnswer', function() {
      it('should call fetchHealthProfileAnswer successfully', function(done) {
        //uncomment below and update the code to test fetchHealthProfileAnswer
        //instance.fetchHealthProfileAnswer(function(error) {
    ...
    describe('fetchHealthProfileAnswers', function() {
      it('should call fetchHealthProfileAnswers successfully', function(done) {
        //uncomment below and update the code to test fetchHealthProfileAnswers
        //instance.fetchHealthProfileAnswers(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
