...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FitbitPlusApi.CoachApi();
  });
  ...
  describe('CoachApi', function() {
    describe('fetchCoach', function() {
      it('should call fetchCoach successfully', function(done) {
        //uncomment below and update the code to test fetchCoach
        //instance.fetchCoach(function(error) {
    ...
    describe('fetchCoaches', function() {
      it('should call fetchCoaches successfully', function(done) {
        //uncomment below and update the code to test fetchCoaches
        //instance.fetchCoaches(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
