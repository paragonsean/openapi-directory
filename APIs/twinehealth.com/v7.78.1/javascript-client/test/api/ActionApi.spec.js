...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FitbitPlusApi.ActionApi();
  });
  ...
  describe('ActionApi', function() {
    ...
    describe('fetchAction', function() {
      it('should call fetchAction successfully', function(done) {
        //uncomment below and update the code to test fetchAction
        //instance.fetchAction(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
