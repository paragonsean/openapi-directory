...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FitbitPlusApi.OrganizationApi();
  });
  ...
  describe('OrganizationApi', function() {
    describe('fetchOrganization', function() {
      it('should call fetchOrganization successfully', function(done) {
        //uncomment below and update the code to test fetchOrganization
        //instance.fetchOrganization(function(error) {
