...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FitbitPlusApi.EmailHistoryApi();
  });
  ...
  describe('EmailHistoryApi', function() {
    describe('fetchEmailHistories', function() {
      it('should call fetchEmailHistories successfully', function(done) {
        //uncomment below and update the code to test fetchEmailHistories
        //instance.fetchEmailHistories(function(error) {
    ...
    describe('fetchEmailHistory', function() {
      it('should call fetchEmailHistory successfully', function(done) {
        //uncomment below and update the code to test fetchEmailHistory
        //instance.fetchEmailHistory(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
