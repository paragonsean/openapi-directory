...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FitbitPlusApi.UpdateBundleResponse();
  });
  ...
  describe('UpdateBundleResponse', function() {
    it('should create an instance of UpdateBundleResponse', function() {
      // uncomment below and update the code to test UpdateBundleResponse
      //var instance = new FitbitPlusApi.UpdateBundleResponse();
      //expect(instance).to.be.a(FitbitPlusApi.UpdateBundleResponse);
    });
