...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FitbitPlusApi.RewardResourceRelationships();
  });
  ...
  describe('RewardResourceRelationships', function() {
    it('should create an instance of RewardResourceRelationships', function() {
      // uncomment below and update the code to test RewardResourceRelationships
      //var instance = new FitbitPlusApi.RewardResourceRelationships();
      //expect(instance).to.be.a(FitbitPlusApi.RewardResourceRelationships);
    });
