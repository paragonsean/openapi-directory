...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FitbitPlusApi.HealthProfileQuestionResourceRelationships();
  });
  ...
  describe('HealthProfileQuestionResourceRelationships', function() {
    it('should create an instance of HealthProfileQuestionResourceRelationships', function() {
      // uncomment below and update the code to test HealthProfileQuestionResourceRelationships
      //var instance = new FitbitPlusApi.HealthProfileQuestionResourceRelationships();
      //expect(instance).to.be.a(FitbitPlusApi.HealthProfileQuestionResourceRelationships);
    });
    ...
    it('should have the property questionDefinition (base name: "question_definition")', function() {
      // uncomment below and update the code to test the property questionDefinition
      //var instance = new FitbitPlusApi.HealthProfileQuestionResourceRelationships();
      //expect(instance).to.be();
    });
