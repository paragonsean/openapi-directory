...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FitbitPlusApi.FetchCalendarEventsResponse();
  });
  ...
  describe('FetchCalendarEventsResponse', function() {
    it('should create an instance of FetchCalendarEventsResponse', function() {
      // uncomment below and update the code to test FetchCalendarEventsResponse
      //var instance = new FitbitPlusApi.FetchCalendarEventsResponse();
      //expect(instance).to.be.a(FitbitPlusApi.FetchCalendarEventsResponse);
    });
