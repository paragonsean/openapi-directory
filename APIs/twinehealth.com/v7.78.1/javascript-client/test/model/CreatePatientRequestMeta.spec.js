...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FitbitPlusApi.CreatePatientRequestMeta();
  });
  ...
  describe('CreatePatientRequestMeta', function() {
    it('should create an instance of CreatePatientRequestMeta', function() {
      // uncomment below and update the code to test CreatePatientRequestMeta
      //var instance = new FitbitPlusApi.CreatePatientRequestMeta();
      //expect(instance).to.be.a(FitbitPlusApi.CreatePatientRequestMeta);
    });
