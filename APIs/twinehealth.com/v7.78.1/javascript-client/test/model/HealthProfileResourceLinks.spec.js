...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FitbitPlusApi.HealthProfileResourceLinks();
  });
  ...
  describe('HealthProfileResourceLinks', function() {
    it('should create an instance of HealthProfileResourceLinks', function() {
      // uncomment below and update the code to test HealthProfileResourceLinks
      //var instance = new FitbitPlusApi.HealthProfileResourceLinks();
      //expect(instance).to.be.a(FitbitPlusApi.HealthProfileResourceLinks);
    });
