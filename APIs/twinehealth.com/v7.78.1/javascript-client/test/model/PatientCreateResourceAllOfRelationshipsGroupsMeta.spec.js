...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FitbitPlusApi.PatientCreateResourceAllOfRelationshipsGroupsMeta();
  });
  ...
  describe('PatientCreateResourceAllOfRelationshipsGroupsMeta', function() {
    it('should create an instance of PatientCreateResourceAllOfRelationshipsGroupsMeta', function() {
      // uncomment below and update the code to test PatientCreateResourceAllOfRelationshipsGroupsMeta
      //var instance = new FitbitPlusApi.PatientCreateResourceAllOfRelationshipsGroupsMeta();
      //expect(instance).to.be.a(FitbitPlusApi.PatientCreateResourceAllOfRelationshipsGroupsMeta);
    });
