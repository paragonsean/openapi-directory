...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FitbitPlusApi.ActionMetric();
  });
  ...
  describe('ActionMetric', function() {
    it('should create an instance of ActionMetric', function() {
      // uncomment below and update the code to test ActionMetric
      //var instance = new FitbitPlusApi.ActionMetric();
      //expect(instance).to.be.a(FitbitPlusApi.ActionMetric);
    });
