...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FitbitPlusApi.TokenResourceRelationships();
  });
  ...
  describe('TokenResourceRelationships', function() {
    it('should create an instance of TokenResourceRelationships', function() {
      // uncomment below and update the code to test TokenResourceRelationships
      //var instance = new FitbitPlusApi.TokenResourceRelationships();
      //expect(instance).to.be.a(FitbitPlusApi.TokenResourceRelationships);
    });
