...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FitbitPlusApi.BundleResourceAttributes();
  });
  ...
  describe('BundleResourceAttributes', function() {
    it('should create an instance of BundleResourceAttributes', function() {
      // uncomment below and update the code to test BundleResourceAttributes
      //var instance = new FitbitPlusApi.BundleResourceAttributes();
      //expect(instance).to.be.a(FitbitPlusApi.BundleResourceAttributes);
    });
    ...
    it('should have the property effectiveFrom (base name: "effective_from")', function() {
      // uncomment below and update the code to test the property effectiveFrom
      //var instance = new FitbitPlusApi.BundleResourceAttributes();
      //expect(instance).to.be();
    });

    it('should have the property effectiveTo (base name: "effective_to")', function() {
