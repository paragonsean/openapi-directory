...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FitbitPlusApi.ActionWindow();
  });
  ...
  describe('ActionWindow', function() {
    it('should create an instance of ActionWindow', function() {
      // uncomment below and update the code to test ActionWindow
      //var instance = new FitbitPlusApi.ActionWindow();
      //expect(instance).to.be.a(FitbitPlusApi.ActionWindow);
    });
