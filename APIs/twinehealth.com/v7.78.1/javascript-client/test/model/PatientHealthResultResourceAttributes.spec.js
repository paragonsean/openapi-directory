...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FitbitPlusApi.PatientHealthResultResourceAttributes();
  });
  ...
  describe('PatientHealthResultResourceAttributes', function() {
    it('should create an instance of PatientHealthResultResourceAttributes', function() {
      // uncomment below and update the code to test PatientHealthResultResourceAttributes
      //var instance = new FitbitPlusApi.PatientHealthResultResourceAttributes();
      //expect(instance).to.be.a(FitbitPlusApi.PatientHealthResultResourceAttributes);
    });

    it('should have the property thread (base name: "_thread")', function() {
    ...
    it('should have the property occurredAtTimeZone (base name: "occurred_at_time_zone")', function() {
      // uncomment below and update the code to test the property occurredAtTimeZone
      //var instance = new FitbitPlusApi.PatientHealthResultResourceAttributes();
      //expect(instance).to.be();
    });
