...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FitbitPlusApi.CreateTokenRequestDataAttributes();
  });
  ...
  describe('CreateTokenRequestDataAttributes', function() {
    it('should create an instance of CreateTokenRequestDataAttributes', function() {
      // uncomment below and update the code to test CreateTokenRequestDataAttributes
      //var instance = new FitbitPlusApi.CreateTokenRequestDataAttributes();
      //expect(instance).to.be.a(FitbitPlusApi.CreateTokenRequestDataAttributes);
    });
