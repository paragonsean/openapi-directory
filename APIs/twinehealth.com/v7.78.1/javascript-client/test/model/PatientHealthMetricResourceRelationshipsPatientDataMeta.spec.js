...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FitbitPlusApi.PatientHealthMetricResourceRelationshipsPatientDataMeta();
  });
  ...
  describe('PatientHealthMetricResourceRelationshipsPatientDataMeta', function() {
    it('should create an instance of PatientHealthMetricResourceRelationshipsPatientDataMeta', function() {
      // uncomment below and update the code to test PatientHealthMetricResourceRelationshipsPatientDataMeta
      //var instance = new FitbitPlusApi.PatientHealthMetricResourceRelationshipsPatientDataMeta();
      //expect(instance).to.be.a(FitbitPlusApi.PatientHealthMetricResourceRelationshipsPatientDataMeta);
    });
