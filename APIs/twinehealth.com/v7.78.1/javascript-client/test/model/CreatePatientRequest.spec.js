...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FitbitPlusApi.CreatePatientRequest();
  });
  ...
  describe('CreatePatientRequest', function() {
    it('should create an instance of CreatePatientRequest', function() {
      // uncomment below and update the code to test CreatePatientRequest
      //var instance = new FitbitPlusApi.CreatePatientRequest();
      //expect(instance).to.be.a(FitbitPlusApi.CreatePatientRequest);
    });
