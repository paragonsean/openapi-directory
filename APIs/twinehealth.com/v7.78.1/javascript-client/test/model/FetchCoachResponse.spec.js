...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FitbitPlusApi.FetchCoachResponse();
  });
  ...
  describe('FetchCoachResponse', function() {
    it('should create an instance of FetchCoachResponse', function() {
      // uncomment below and update the code to test FetchCoachResponse
      //var instance = new FitbitPlusApi.FetchCoachResponse();
      //expect(instance).to.be.a(FitbitPlusApi.FetchCoachResponse);
    });
