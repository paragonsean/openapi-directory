...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FitbitPlusApi.HealthProfileQuestionResourceRelationshipsAnswer();
  });
  ...
  describe('HealthProfileQuestionResourceRelationshipsAnswer', function() {
    it('should create an instance of HealthProfileQuestionResourceRelationshipsAnswer', function() {
      // uncomment below and update the code to test HealthProfileQuestionResourceRelationshipsAnswer
      //var instance = new FitbitPlusApi.HealthProfileQuestionResourceRelationshipsAnswer();
      //expect(instance).to.be.a(FitbitPlusApi.HealthProfileQuestionResourceRelationshipsAnswer);
    });
