...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FitbitPlusApi.CreateBundleRequest();
  });
  ...
  describe('CreateBundleRequest', function() {
    it('should create an instance of CreateBundleRequest', function() {
      // uncomment below and update the code to test CreateBundleRequest
      //var instance = new FitbitPlusApi.CreateBundleRequest();
      //expect(instance).to.be.a(FitbitPlusApi.CreateBundleRequest);
    });
