...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FitbitPlusApi.CoachResourceAttributes();
  });
  ...
  describe('CoachResourceAttributes', function() {
    it('should create an instance of CoachResourceAttributes', function() {
      // uncomment below and update the code to test CoachResourceAttributes
      //var instance = new FitbitPlusApi.CoachResourceAttributes();
      //expect(instance).to.be.a(FitbitPlusApi.CoachResourceAttributes);
    });
