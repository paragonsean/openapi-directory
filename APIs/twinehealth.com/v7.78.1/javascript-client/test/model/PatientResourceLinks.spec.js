...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FitbitPlusApi.PatientResourceLinks();
  });
  ...
  describe('PatientResourceLinks', function() {
    it('should create an instance of PatientResourceLinks', function() {
      // uncomment below and update the code to test PatientResourceLinks
      //var instance = new FitbitPlusApi.PatientResourceLinks();
      //expect(instance).to.be.a(FitbitPlusApi.PatientResourceLinks);
    });
    ...
    it('should have the property twineWebApp (base name: "twine_web_app")', function() {
      // uncomment below and update the code to test the property twineWebApp
      //var instance = new FitbitPlusApi.PatientResourceLinks();
      //expect(instance).to.be();
    });
