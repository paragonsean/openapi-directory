...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FitbitPlusApi.HealthProfileAnswerResourceRelationshipsPatientLinks();
  });
  ...
  describe('HealthProfileAnswerResourceRelationshipsPatientLinks', function() {
    it('should create an instance of HealthProfileAnswerResourceRelationshipsPatientLinks', function() {
      // uncomment below and update the code to test HealthProfileAnswerResourceRelationshipsPatientLinks
      //var instance = new FitbitPlusApi.HealthProfileAnswerResourceRelationshipsPatientLinks();
      //expect(instance).to.be.a(FitbitPlusApi.HealthProfileAnswerResourceRelationshipsPatientLinks);
    });
