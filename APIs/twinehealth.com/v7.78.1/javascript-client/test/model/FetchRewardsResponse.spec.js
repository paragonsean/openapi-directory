...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FitbitPlusApi.FetchRewardsResponse();
  });
  ...
  describe('FetchRewardsResponse', function() {
    it('should create an instance of FetchRewardsResponse', function() {
      // uncomment below and update the code to test FetchRewardsResponse
      //var instance = new FitbitPlusApi.FetchRewardsResponse();
      //expect(instance).to.be.a(FitbitPlusApi.FetchRewardsResponse);
    });
