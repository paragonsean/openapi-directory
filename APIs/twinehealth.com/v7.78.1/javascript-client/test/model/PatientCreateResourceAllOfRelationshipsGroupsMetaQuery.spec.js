...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FitbitPlusApi.PatientCreateResourceAllOfRelationshipsGroupsMetaQuery();
  });
  ...
  describe('PatientCreateResourceAllOfRelationshipsGroupsMetaQuery', function() {
    it('should create an instance of PatientCreateResourceAllOfRelationshipsGroupsMetaQuery', function() {
      // uncomment below and update the code to test PatientCreateResourceAllOfRelationshipsGroupsMetaQuery
      //var instance = new FitbitPlusApi.PatientCreateResourceAllOfRelationshipsGroupsMetaQuery();
      //expect(instance).to.be.a(FitbitPlusApi.PatientCreateResourceAllOfRelationshipsGroupsMetaQuery);
    });
