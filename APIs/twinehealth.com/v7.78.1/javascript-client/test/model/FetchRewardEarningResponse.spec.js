...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FitbitPlusApi.FetchRewardEarningResponse();
  });
  ...
  describe('FetchRewardEarningResponse', function() {
    it('should create an instance of FetchRewardEarningResponse', function() {
      // uncomment below and update the code to test FetchRewardEarningResponse
      //var instance = new FitbitPlusApi.FetchRewardEarningResponse();
      //expect(instance).to.be.a(FitbitPlusApi.FetchRewardEarningResponse);
    });
