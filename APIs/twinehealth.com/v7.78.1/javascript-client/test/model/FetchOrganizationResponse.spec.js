...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FitbitPlusApi.FetchOrganizationResponse();
  });
  ...
  describe('FetchOrganizationResponse', function() {
    it('should create an instance of FetchOrganizationResponse', function() {
      // uncomment below and update the code to test FetchOrganizationResponse
      //var instance = new FitbitPlusApi.FetchOrganizationResponse();
      //expect(instance).to.be.a(FitbitPlusApi.FetchOrganizationResponse);
    });
