...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FitbitPlusApi.PatientCreateResourceAllOfRelationshipsGroupsData();
  });
  ...
  describe('PatientCreateResourceAllOfRelationshipsGroupsData', function() {
    it('should create an instance of PatientCreateResourceAllOfRelationshipsGroupsData', function() {
      // uncomment below and update the code to test PatientCreateResourceAllOfRelationshipsGroupsData
      //var instance = new FitbitPlusApi.PatientCreateResourceAllOfRelationshipsGroupsData();
      //expect(instance).to.be.a(FitbitPlusApi.PatientCreateResourceAllOfRelationshipsGroupsData);
    });
