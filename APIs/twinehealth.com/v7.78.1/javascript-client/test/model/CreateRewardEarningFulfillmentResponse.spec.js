...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FitbitPlusApi.CreateRewardEarningFulfillmentResponse();
  });
  ...
  describe('CreateRewardEarningFulfillmentResponse', function() {
    it('should create an instance of CreateRewardEarningFulfillmentResponse', function() {
      // uncomment below and update the code to test CreateRewardEarningFulfillmentResponse
      //var instance = new FitbitPlusApi.CreateRewardEarningFulfillmentResponse();
      //expect(instance).to.be.a(FitbitPlusApi.CreateRewardEarningFulfillmentResponse);
    });
