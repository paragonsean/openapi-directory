...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FitbitPlusApi.PatientPlanSummaryResourceRelationshipsActionsDataInner();
  });
  ...
  describe('PatientPlanSummaryResourceRelationshipsActionsDataInner', function() {
    it('should create an instance of PatientPlanSummaryResourceRelationshipsActionsDataInner', function() {
      // uncomment below and update the code to test PatientPlanSummaryResourceRelationshipsActionsDataInner
      //var instance = new FitbitPlusApi.PatientPlanSummaryResourceRelationshipsActionsDataInner();
      //expect(instance).to.be.a(FitbitPlusApi.PatientPlanSummaryResourceRelationshipsActionsDataInner);
    });
