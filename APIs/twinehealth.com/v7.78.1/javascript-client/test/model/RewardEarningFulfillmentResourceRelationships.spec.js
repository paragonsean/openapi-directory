...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FitbitPlusApi.RewardEarningFulfillmentResourceRelationships();
  });
  ...
  describe('RewardEarningFulfillmentResourceRelationships', function() {
    it('should create an instance of RewardEarningFulfillmentResourceRelationships', function() {
      // uncomment below and update the code to test RewardEarningFulfillmentResourceRelationships
      //var instance = new FitbitPlusApi.RewardEarningFulfillmentResourceRelationships();
      //expect(instance).to.be.a(FitbitPlusApi.RewardEarningFulfillmentResourceRelationships);
    });
    ...
    it('should have the property rewardEarning (base name: "reward_earning")', function() {
      // uncomment below and update the code to test the property rewardEarning
      //var instance = new FitbitPlusApi.RewardEarningFulfillmentResourceRelationships();
      //expect(instance).to.be();
    });
