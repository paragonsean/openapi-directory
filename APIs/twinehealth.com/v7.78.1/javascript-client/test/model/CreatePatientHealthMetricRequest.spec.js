...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FitbitPlusApi.CreatePatientHealthMetricRequest();
  });
  ...
  describe('CreatePatientHealthMetricRequest', function() {
    it('should create an instance of CreatePatientHealthMetricRequest', function() {
      // uncomment below and update the code to test CreatePatientHealthMetricRequest
      //var instance = new FitbitPlusApi.CreatePatientHealthMetricRequest();
      //expect(instance).to.be.a(FitbitPlusApi.CreatePatientHealthMetricRequest);
    });
