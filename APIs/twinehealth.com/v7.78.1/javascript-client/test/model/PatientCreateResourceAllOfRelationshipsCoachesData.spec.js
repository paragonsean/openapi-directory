...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FitbitPlusApi.PatientCreateResourceAllOfRelationshipsCoachesData();
  });
  ...
  describe('PatientCreateResourceAllOfRelationshipsCoachesData', function() {
    it('should create an instance of PatientCreateResourceAllOfRelationshipsCoachesData', function() {
      // uncomment below and update the code to test PatientCreateResourceAllOfRelationshipsCoachesData
      //var instance = new FitbitPlusApi.PatientCreateResourceAllOfRelationshipsCoachesData();
      //expect(instance).to.be.a(FitbitPlusApi.PatientCreateResourceAllOfRelationshipsCoachesData);
    });
