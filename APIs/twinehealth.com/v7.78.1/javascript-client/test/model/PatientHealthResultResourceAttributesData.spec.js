...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FitbitPlusApi.PatientHealthResultResourceAttributesData();
  });
  ...
  describe('PatientHealthResultResourceAttributesData', function() {
    it('should create an instance of PatientHealthResultResourceAttributesData', function() {
      // uncomment below and update the code to test PatientHealthResultResourceAttributesData
      //var instance = new FitbitPlusApi.PatientHealthResultResourceAttributesData();
      //expect(instance).to.be.a(FitbitPlusApi.PatientHealthResultResourceAttributesData);
    });
