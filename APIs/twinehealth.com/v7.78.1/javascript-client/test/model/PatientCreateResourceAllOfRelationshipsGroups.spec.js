...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FitbitPlusApi.PatientCreateResourceAllOfRelationshipsGroups();
  });
  ...
  describe('PatientCreateResourceAllOfRelationshipsGroups', function() {
    it('should create an instance of PatientCreateResourceAllOfRelationshipsGroups', function() {
      // uncomment below and update the code to test PatientCreateResourceAllOfRelationshipsGroups
      //var instance = new FitbitPlusApi.PatientCreateResourceAllOfRelationshipsGroups();
      //expect(instance).to.be.a(FitbitPlusApi.PatientCreateResourceAllOfRelationshipsGroups);
    });
