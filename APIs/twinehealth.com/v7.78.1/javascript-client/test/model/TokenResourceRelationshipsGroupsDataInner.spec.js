...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FitbitPlusApi.TokenResourceRelationshipsGroupsDataInner();
  });
  ...
  describe('TokenResourceRelationshipsGroupsDataInner', function() {
    it('should create an instance of TokenResourceRelationshipsGroupsDataInner', function() {
      // uncomment below and update the code to test TokenResourceRelationshipsGroupsDataInner
      //var instance = new FitbitPlusApi.TokenResourceRelationshipsGroupsDataInner();
      //expect(instance).to.be.a(FitbitPlusApi.TokenResourceRelationshipsGroupsDataInner);
    });
