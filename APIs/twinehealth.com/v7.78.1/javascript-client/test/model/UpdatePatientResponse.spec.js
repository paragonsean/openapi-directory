...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FitbitPlusApi.UpdatePatientResponse();
  });
  ...
  describe('UpdatePatientResponse', function() {
    it('should create an instance of UpdatePatientResponse', function() {
      // uncomment below and update the code to test UpdatePatientResponse
      //var instance = new FitbitPlusApi.UpdatePatientResponse();
      //expect(instance).to.be.a(FitbitPlusApi.UpdatePatientResponse);
    });
