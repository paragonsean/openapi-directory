...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FitbitPlusApi.RewardEarningResourceRelationships();
  });
  ...
  describe('RewardEarningResourceRelationships', function() {
    it('should create an instance of RewardEarningResourceRelationships', function() {
      // uncomment below and update the code to test RewardEarningResourceRelationships
      //var instance = new FitbitPlusApi.RewardEarningResourceRelationships();
      //expect(instance).to.be.a(FitbitPlusApi.RewardEarningResourceRelationships);
    });
    ...
    it('should have the property rewardProgramActivation (base name: "reward_program_activation")', function() {
      // uncomment below and update the code to test the property rewardProgramActivation
      //var instance = new FitbitPlusApi.RewardEarningResourceRelationships();
      //expect(instance).to.be();
    });
