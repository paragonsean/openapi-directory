...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FitbitPlusApi.CalendarEventResourceAttributes();
  });
  ...
  describe('CalendarEventResourceAttributes', function() {
    it('should create an instance of CalendarEventResourceAttributes', function() {
      // uncomment below and update the code to test CalendarEventResourceAttributes
      //var instance = new FitbitPlusApi.CalendarEventResourceAttributes();
      //expect(instance).to.be.a(FitbitPlusApi.CalendarEventResourceAttributes);
    });
