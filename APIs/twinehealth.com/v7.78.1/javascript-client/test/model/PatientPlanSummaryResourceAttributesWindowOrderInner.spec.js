...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FitbitPlusApi.PatientPlanSummaryResourceAttributesWindowOrderInner();
  });
  ...
  describe('PatientPlanSummaryResourceAttributesWindowOrderInner', function() {
    it('should create an instance of PatientPlanSummaryResourceAttributesWindowOrderInner', function() {
      // uncomment below and update the code to test PatientPlanSummaryResourceAttributesWindowOrderInner
      //var instance = new FitbitPlusApi.PatientPlanSummaryResourceAttributesWindowOrderInner();
      //expect(instance).to.be.a(FitbitPlusApi.PatientPlanSummaryResourceAttributesWindowOrderInner);
    });

    it('should have the property actions (base name: "_actions")', function() {
