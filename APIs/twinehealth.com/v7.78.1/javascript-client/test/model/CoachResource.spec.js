...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FitbitPlusApi.CoachResource();
  });
  ...
  describe('CoachResource', function() {
    it('should create an instance of CoachResource', function() {
      // uncomment below and update the code to test CoachResource
      //var instance = new FitbitPlusApi.CoachResource();
      //expect(instance).to.be.a(FitbitPlusApi.CoachResource);
    });
