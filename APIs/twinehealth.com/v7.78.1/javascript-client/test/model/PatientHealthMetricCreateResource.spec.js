...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FitbitPlusApi.PatientHealthMetricCreateResource();
  });
  ...
  describe('PatientHealthMetricCreateResource', function() {
    it('should create an instance of PatientHealthMetricCreateResource', function() {
      // uncomment below and update the code to test PatientHealthMetricCreateResource
      //var instance = new FitbitPlusApi.PatientHealthMetricCreateResource();
      //expect(instance).to.be.a(FitbitPlusApi.PatientHealthMetricCreateResource);
    });
