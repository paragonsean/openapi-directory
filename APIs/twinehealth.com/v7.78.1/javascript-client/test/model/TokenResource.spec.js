...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FitbitPlusApi.TokenResource();
  });
  ...
  describe('TokenResource', function() {
    it('should create an instance of TokenResource', function() {
      // uncomment below and update the code to test TokenResource
      //var instance = new FitbitPlusApi.TokenResource();
      //expect(instance).to.be.a(FitbitPlusApi.TokenResource);
    });
