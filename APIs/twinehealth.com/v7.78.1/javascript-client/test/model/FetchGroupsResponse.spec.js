...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FitbitPlusApi.FetchGroupsResponse();
  });
  ...
  describe('FetchGroupsResponse', function() {
    it('should create an instance of FetchGroupsResponse', function() {
      // uncomment below and update the code to test FetchGroupsResponse
      //var instance = new FitbitPlusApi.FetchGroupsResponse();
      //expect(instance).to.be.a(FitbitPlusApi.FetchGroupsResponse);
    });
