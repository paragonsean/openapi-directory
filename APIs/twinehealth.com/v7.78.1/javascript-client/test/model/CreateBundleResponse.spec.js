...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FitbitPlusApi.CreateBundleResponse();
  });
  ...
  describe('CreateBundleResponse', function() {
    it('should create an instance of CreateBundleResponse', function() {
      // uncomment below and update the code to test CreateBundleResponse
      //var instance = new FitbitPlusApi.CreateBundleResponse();
      //expect(instance).to.be.a(FitbitPlusApi.CreateBundleResponse);
    });
