...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FitbitPlusApi.CalendarEventResource();
  });
  ...
  describe('CalendarEventResource', function() {
    it('should create an instance of CalendarEventResource', function() {
      // uncomment below and update the code to test CalendarEventResource
      //var instance = new FitbitPlusApi.CalendarEventResource();
      //expect(instance).to.be.a(FitbitPlusApi.CalendarEventResource);
    });
