...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FitbitPlusApi.FetchHealthProfileResponse();
  });
  ...
  describe('FetchHealthProfileResponse', function() {
    it('should create an instance of FetchHealthProfileResponse', function() {
      // uncomment below and update the code to test FetchHealthProfileResponse
      //var instance = new FitbitPlusApi.FetchHealthProfileResponse();
      //expect(instance).to.be.a(FitbitPlusApi.FetchHealthProfileResponse);
    });
