...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FitbitPlusApi.CollectionResponseLinks();
  });
  ...
  describe('CollectionResponseLinks', function() {
    it('should create an instance of CollectionResponseLinks', function() {
      // uncomment below and update the code to test CollectionResponseLinks
      //var instance = new FitbitPlusApi.CollectionResponseLinks();
      //expect(instance).to.be.a(FitbitPlusApi.CollectionResponseLinks);
    });
