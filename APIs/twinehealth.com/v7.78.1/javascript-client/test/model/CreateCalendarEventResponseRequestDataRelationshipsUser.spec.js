...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FitbitPlusApi.CreateCalendarEventResponseRequestDataRelationshipsUser();
  });
  ...
  describe('CreateCalendarEventResponseRequestDataRelationshipsUser', function() {
    it('should create an instance of CreateCalendarEventResponseRequestDataRelationshipsUser', function() {
      // uncomment below and update the code to test CreateCalendarEventResponseRequestDataRelationshipsUser
      //var instance = new FitbitPlusApi.CreateCalendarEventResponseRequestDataRelationshipsUser();
      //expect(instance).to.be.a(FitbitPlusApi.CreateCalendarEventResponseRequestDataRelationshipsUser);
    });
