...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FitbitPlusApi.FetchHealthProfileAnswersResponse();
  });
  ...
  describe('FetchHealthProfileAnswersResponse', function() {
    it('should create an instance of FetchHealthProfileAnswersResponse', function() {
      // uncomment below and update the code to test FetchHealthProfileAnswersResponse
      //var instance = new FitbitPlusApi.FetchHealthProfileAnswersResponse();
      //expect(instance).to.be.a(FitbitPlusApi.FetchHealthProfileAnswersResponse);
    });
