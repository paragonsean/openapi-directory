...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FitbitPlusApi.RewardEarningFulfillmentResourceRelationshipsPatient();
  });
  ...
  describe('RewardEarningFulfillmentResourceRelationshipsPatient', function() {
    it('should create an instance of RewardEarningFulfillmentResourceRelationshipsPatient', function() {
      // uncomment below and update the code to test RewardEarningFulfillmentResourceRelationshipsPatient
      //var instance = new FitbitPlusApi.RewardEarningFulfillmentResourceRelationshipsPatient();
      //expect(instance).to.be.a(FitbitPlusApi.RewardEarningFulfillmentResourceRelationshipsPatient);
    });
