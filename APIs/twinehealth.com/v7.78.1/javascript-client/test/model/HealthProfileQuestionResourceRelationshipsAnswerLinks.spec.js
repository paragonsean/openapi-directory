...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FitbitPlusApi.HealthProfileQuestionResourceRelationshipsAnswerLinks();
  });
  ...
  describe('HealthProfileQuestionResourceRelationshipsAnswerLinks', function() {
    it('should create an instance of HealthProfileQuestionResourceRelationshipsAnswerLinks', function() {
      // uncomment below and update the code to test HealthProfileQuestionResourceRelationshipsAnswerLinks
      //var instance = new FitbitPlusApi.HealthProfileQuestionResourceRelationshipsAnswerLinks();
      //expect(instance).to.be.a(FitbitPlusApi.HealthProfileQuestionResourceRelationshipsAnswerLinks);
    });
