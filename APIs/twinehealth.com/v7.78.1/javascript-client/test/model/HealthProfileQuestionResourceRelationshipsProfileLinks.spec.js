...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FitbitPlusApi.HealthProfileQuestionResourceRelationshipsProfileLinks();
  });
  ...
  describe('HealthProfileQuestionResourceRelationshipsProfileLinks', function() {
    it('should create an instance of HealthProfileQuestionResourceRelationshipsProfileLinks', function() {
      // uncomment below and update the code to test HealthProfileQuestionResourceRelationshipsProfileLinks
      //var instance = new FitbitPlusApi.HealthProfileQuestionResourceRelationshipsProfileLinks();
      //expect(instance).to.be.a(FitbitPlusApi.HealthProfileQuestionResourceRelationshipsProfileLinks);
    });
