...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FitbitPlusApi.FetchPatientsResponse();
  });
  ...
  describe('FetchPatientsResponse', function() {
    it('should create an instance of FetchPatientsResponse', function() {
      // uncomment below and update the code to test FetchPatientsResponse
      //var instance = new FitbitPlusApi.FetchPatientsResponse();
      //expect(instance).to.be.a(FitbitPlusApi.FetchPatientsResponse);
    });
