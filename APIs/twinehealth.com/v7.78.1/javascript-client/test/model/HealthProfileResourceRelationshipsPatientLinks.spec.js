...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FitbitPlusApi.HealthProfileResourceRelationshipsPatientLinks();
  });
  ...
  describe('HealthProfileResourceRelationshipsPatientLinks', function() {
    it('should create an instance of HealthProfileResourceRelationshipsPatientLinks', function() {
      // uncomment below and update the code to test HealthProfileResourceRelationshipsPatientLinks
      //var instance = new FitbitPlusApi.HealthProfileResourceRelationshipsPatientLinks();
      //expect(instance).to.be.a(FitbitPlusApi.HealthProfileResourceRelationshipsPatientLinks);
    });
