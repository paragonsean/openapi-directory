...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FitbitPlusApi.PatientPlanSummaryResourceRelationshipsActions();
  });
  ...
  describe('PatientPlanSummaryResourceRelationshipsActions', function() {
    it('should create an instance of PatientPlanSummaryResourceRelationshipsActions', function() {
      // uncomment below and update the code to test PatientPlanSummaryResourceRelationshipsActions
      //var instance = new FitbitPlusApi.PatientPlanSummaryResourceRelationshipsActions();
      //expect(instance).to.be.a(FitbitPlusApi.PatientPlanSummaryResourceRelationshipsActions);
    });
