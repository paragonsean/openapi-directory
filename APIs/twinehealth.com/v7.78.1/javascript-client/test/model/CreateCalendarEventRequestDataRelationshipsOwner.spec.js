...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FitbitPlusApi.CreateCalendarEventRequestDataRelationshipsOwner();
  });
  ...
  describe('CreateCalendarEventRequestDataRelationshipsOwner', function() {
    it('should create an instance of CreateCalendarEventRequestDataRelationshipsOwner', function() {
      // uncomment below and update the code to test CreateCalendarEventRequestDataRelationshipsOwner
      //var instance = new FitbitPlusApi.CreateCalendarEventRequestDataRelationshipsOwner();
      //expect(instance).to.be.a(FitbitPlusApi.CreateCalendarEventRequestDataRelationshipsOwner);
    });
