...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FitbitPlusApi.HealthProfileResourceRelationshipsQuestionsLinks();
  });
  ...
  describe('HealthProfileResourceRelationshipsQuestionsLinks', function() {
    it('should create an instance of HealthProfileResourceRelationshipsQuestionsLinks', function() {
      // uncomment below and update the code to test HealthProfileResourceRelationshipsQuestionsLinks
      //var instance = new FitbitPlusApi.HealthProfileResourceRelationshipsQuestionsLinks();
      //expect(instance).to.be.a(FitbitPlusApi.HealthProfileResourceRelationshipsQuestionsLinks);
    });
