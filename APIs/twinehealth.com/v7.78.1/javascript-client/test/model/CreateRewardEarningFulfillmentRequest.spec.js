...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FitbitPlusApi.CreateRewardEarningFulfillmentRequest();
  });
  ...
  describe('CreateRewardEarningFulfillmentRequest', function() {
    it('should create an instance of CreateRewardEarningFulfillmentRequest', function() {
      // uncomment below and update the code to test CreateRewardEarningFulfillmentRequest
      //var instance = new FitbitPlusApi.CreateRewardEarningFulfillmentRequest();
      //expect(instance).to.be.a(FitbitPlusApi.CreateRewardEarningFulfillmentRequest);
    });
