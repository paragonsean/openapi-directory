...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FitbitPlusApi.UpdateCalendarEventRequestDataRelationshipsOwner();
  });
  ...
  describe('UpdateCalendarEventRequestDataRelationshipsOwner', function() {
    it('should create an instance of UpdateCalendarEventRequestDataRelationshipsOwner', function() {
      // uncomment below and update the code to test UpdateCalendarEventRequestDataRelationshipsOwner
      //var instance = new FitbitPlusApi.UpdateCalendarEventRequestDataRelationshipsOwner();
      //expect(instance).to.be.a(FitbitPlusApi.UpdateCalendarEventRequestDataRelationshipsOwner);
    });
