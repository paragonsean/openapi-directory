...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FitbitPlusApi.FetchBundleResponse();
  });
  ...
  describe('FetchBundleResponse', function() {
    it('should create an instance of FetchBundleResponse', function() {
      // uncomment below and update the code to test FetchBundleResponse
      //var instance = new FitbitPlusApi.FetchBundleResponse();
      //expect(instance).to.be.a(FitbitPlusApi.FetchBundleResponse);
    });
