...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FitbitPlusApi.CoachResourceLinks();
  });
  ...
  describe('CoachResourceLinks', function() {
    it('should create an instance of CoachResourceLinks', function() {
      // uncomment below and update the code to test CoachResourceLinks
      //var instance = new FitbitPlusApi.CoachResourceLinks();
      //expect(instance).to.be.a(FitbitPlusApi.CoachResourceLinks);
    });
