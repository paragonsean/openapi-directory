...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FitbitPlusApi.CreateOrUpdateErrorResponse();
  });
  ...
  describe('CreateOrUpdateErrorResponse', function() {
    it('should create an instance of CreateOrUpdateErrorResponse', function() {
      // uncomment below and update the code to test CreateOrUpdateErrorResponse
      //var instance = new FitbitPlusApi.CreateOrUpdateErrorResponse();
      //expect(instance).to.be.a(FitbitPlusApi.CreateOrUpdateErrorResponse);
    });
