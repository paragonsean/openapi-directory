...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FitbitPlusApi.EmailHistoryResourceAttributes();
  });
  ...
  describe('EmailHistoryResourceAttributes', function() {
    it('should create an instance of EmailHistoryResourceAttributes', function() {
      // uncomment below and update the code to test EmailHistoryResourceAttributes
      //var instance = new FitbitPlusApi.EmailHistoryResourceAttributes();
      //expect(instance).to.be.a(FitbitPlusApi.EmailHistoryResourceAttributes);
    });
    ...
    it('should have the property emailType (base name: "email_type")', function() {
    ...
    it('should have the property statusTimes (base name: "status_times")', function() {
      // uncomment below and update the code to test the property statusTimes
      //var instance = new FitbitPlusApi.EmailHistoryResourceAttributes();
      //expect(instance).to.be();
    });

    it('should have the property twineEmailId (base name: "twine_email_id")', function() {
      // uncomment below and update the code to test the property twineEmailId
      //var instance = new FitbitPlusApi.EmailHistoryResourceAttributes();
      //expect(instance).to.be();
    });
