...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FitbitPlusApi.FetchCoachesResponse();
  });
  ...
  describe('FetchCoachesResponse', function() {
    it('should create an instance of FetchCoachesResponse', function() {
      // uncomment below and update the code to test FetchCoachesResponse
      //var instance = new FitbitPlusApi.FetchCoachesResponse();
      //expect(instance).to.be.a(FitbitPlusApi.FetchCoachesResponse);
    });
