...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FitbitPlusApi.UpdateBundleRequest();
  });
  ...
  describe('UpdateBundleRequest', function() {
    it('should create an instance of UpdateBundleRequest', function() {
      // uncomment below and update the code to test UpdateBundleRequest
      //var instance = new FitbitPlusApi.UpdateBundleRequest();
      //expect(instance).to.be.a(FitbitPlusApi.UpdateBundleRequest);
    });
