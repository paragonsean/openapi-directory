...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FitbitPlusApi.FetchMetaResponse();
  });
  ...
  describe('FetchMetaResponse', function() {
    it('should create an instance of FetchMetaResponse', function() {
      // uncomment below and update the code to test FetchMetaResponse
      //var instance = new FitbitPlusApi.FetchMetaResponse();
      //expect(instance).to.be.a(FitbitPlusApi.FetchMetaResponse);
    });
