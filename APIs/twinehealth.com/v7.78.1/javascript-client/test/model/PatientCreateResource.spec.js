...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FitbitPlusApi.PatientCreateResource();
  });
  ...
  describe('PatientCreateResource', function() {
    it('should create an instance of PatientCreateResource', function() {
      // uncomment below and update the code to test PatientCreateResource
      //var instance = new FitbitPlusApi.PatientCreateResource();
      //expect(instance).to.be.a(FitbitPlusApi.PatientCreateResource);
    });
