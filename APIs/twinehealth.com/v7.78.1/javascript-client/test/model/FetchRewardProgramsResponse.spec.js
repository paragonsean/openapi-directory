...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FitbitPlusApi.FetchRewardProgramsResponse();
  });
  ...
  describe('FetchRewardProgramsResponse', function() {
    it('should create an instance of FetchRewardProgramsResponse', function() {
      // uncomment below and update the code to test FetchRewardProgramsResponse
      //var instance = new FitbitPlusApi.FetchRewardProgramsResponse();
      //expect(instance).to.be.a(FitbitPlusApi.FetchRewardProgramsResponse);
    });
