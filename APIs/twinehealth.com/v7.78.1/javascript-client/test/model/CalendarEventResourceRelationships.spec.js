...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FitbitPlusApi.CalendarEventResourceRelationships();
  });
  ...
  describe('CalendarEventResourceRelationships', function() {
    it('should create an instance of CalendarEventResourceRelationships', function() {
      // uncomment below and update the code to test CalendarEventResourceRelationships
      //var instance = new FitbitPlusApi.CalendarEventResourceRelationships();
      //expect(instance).to.be.a(FitbitPlusApi.CalendarEventResourceRelationships);
    });
