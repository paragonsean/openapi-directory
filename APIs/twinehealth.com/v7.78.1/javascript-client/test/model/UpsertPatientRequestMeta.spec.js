...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FitbitPlusApi.UpsertPatientRequestMeta();
  });
  ...
  describe('UpsertPatientRequestMeta', function() {
    it('should create an instance of UpsertPatientRequestMeta', function() {
      // uncomment below and update the code to test UpsertPatientRequestMeta
      //var instance = new FitbitPlusApi.UpsertPatientRequestMeta();
      //expect(instance).to.be.a(FitbitPlusApi.UpsertPatientRequestMeta);
    });
