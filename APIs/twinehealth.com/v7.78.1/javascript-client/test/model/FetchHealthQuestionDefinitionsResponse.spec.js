...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FitbitPlusApi.FetchHealthQuestionDefinitionsResponse();
  });
  ...
  describe('FetchHealthQuestionDefinitionsResponse', function() {
    it('should create an instance of FetchHealthQuestionDefinitionsResponse', function() {
      // uncomment below and update the code to test FetchHealthQuestionDefinitionsResponse
      //var instance = new FitbitPlusApi.FetchHealthQuestionDefinitionsResponse();
      //expect(instance).to.be.a(FitbitPlusApi.FetchHealthQuestionDefinitionsResponse);
    });
