...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FitbitPlusApi.BundleResourceRelationships();
  });
  ...
  describe('BundleResourceRelationships', function() {
    it('should create an instance of BundleResourceRelationships', function() {
      // uncomment below and update the code to test BundleResourceRelationships
      //var instance = new FitbitPlusApi.BundleResourceRelationships();
      //expect(instance).to.be.a(FitbitPlusApi.BundleResourceRelationships);
    });
