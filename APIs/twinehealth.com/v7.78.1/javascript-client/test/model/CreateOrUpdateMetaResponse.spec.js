...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FitbitPlusApi.CreateOrUpdateMetaResponse();
  });
  ...
  describe('CreateOrUpdateMetaResponse', function() {
    it('should create an instance of CreateOrUpdateMetaResponse', function() {
      // uncomment below and update the code to test CreateOrUpdateMetaResponse
      //var instance = new FitbitPlusApi.CreateOrUpdateMetaResponse();
      //expect(instance).to.be.a(FitbitPlusApi.CreateOrUpdateMetaResponse);
    });
