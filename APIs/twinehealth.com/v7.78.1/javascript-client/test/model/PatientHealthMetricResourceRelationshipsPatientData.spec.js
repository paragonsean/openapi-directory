...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FitbitPlusApi.PatientHealthMetricResourceRelationshipsPatientData();
  });
  ...
  describe('PatientHealthMetricResourceRelationshipsPatientData', function() {
    it('should create an instance of PatientHealthMetricResourceRelationshipsPatientData', function() {
      // uncomment below and update the code to test PatientHealthMetricResourceRelationshipsPatientData
      //var instance = new FitbitPlusApi.PatientHealthMetricResourceRelationshipsPatientData();
      //expect(instance).to.be.a(FitbitPlusApi.PatientHealthMetricResourceRelationshipsPatientData);
    });
