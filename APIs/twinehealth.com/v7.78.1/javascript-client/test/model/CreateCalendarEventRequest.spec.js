...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FitbitPlusApi.CreateCalendarEventRequest();
  });
  ...
  describe('CreateCalendarEventRequest', function() {
    it('should create an instance of CreateCalendarEventRequest', function() {
      // uncomment below and update the code to test CreateCalendarEventRequest
      //var instance = new FitbitPlusApi.CreateCalendarEventRequest();
      //expect(instance).to.be.a(FitbitPlusApi.CreateCalendarEventRequest);
    });
