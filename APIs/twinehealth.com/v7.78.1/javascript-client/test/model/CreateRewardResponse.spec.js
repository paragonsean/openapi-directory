...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FitbitPlusApi.CreateRewardResponse();
  });
  ...
  describe('CreateRewardResponse', function() {
    it('should create an instance of CreateRewardResponse', function() {
      // uncomment below and update the code to test CreateRewardResponse
      //var instance = new FitbitPlusApi.CreateRewardResponse();
      //expect(instance).to.be.a(FitbitPlusApi.CreateRewardResponse);
    });
