...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FitbitPlusApi.PatientHealthResultResourceRelationshipsPatientData();
  });
  ...
  describe('PatientHealthResultResourceRelationshipsPatientData', function() {
    it('should create an instance of PatientHealthResultResourceRelationshipsPatientData', function() {
      // uncomment below and update the code to test PatientHealthResultResourceRelationshipsPatientData
      //var instance = new FitbitPlusApi.PatientHealthResultResourceRelationshipsPatientData();
      //expect(instance).to.be.a(FitbitPlusApi.PatientHealthResultResourceRelationshipsPatientData);
    });
