...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FitbitPlusApi.CreatePatientResponse();
  });
  ...
  describe('CreatePatientResponse', function() {
    it('should create an instance of CreatePatientResponse', function() {
      // uncomment below and update the code to test CreatePatientResponse
      //var instance = new FitbitPlusApi.CreatePatientResponse();
      //expect(instance).to.be.a(FitbitPlusApi.CreatePatientResponse);
    });
