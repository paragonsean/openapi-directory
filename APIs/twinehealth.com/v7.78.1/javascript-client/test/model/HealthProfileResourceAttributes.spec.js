...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FitbitPlusApi.HealthProfileResourceAttributes();
  });
  ...
  describe('HealthProfileResourceAttributes', function() {
    it('should create an instance of HealthProfileResourceAttributes', function() {
      // uncomment below and update the code to test HealthProfileResourceAttributes
      //var instance = new FitbitPlusApi.HealthProfileResourceAttributes();
      //expect(instance).to.be.a(FitbitPlusApi.HealthProfileResourceAttributes);
    });
