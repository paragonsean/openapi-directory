...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FitbitPlusApi.TokenResourceRelationshipsGroups();
  });
  ...
  describe('TokenResourceRelationshipsGroups', function() {
    it('should create an instance of TokenResourceRelationshipsGroups', function() {
      // uncomment below and update the code to test TokenResourceRelationshipsGroups
      //var instance = new FitbitPlusApi.TokenResourceRelationshipsGroups();
      //expect(instance).to.be.a(FitbitPlusApi.TokenResourceRelationshipsGroups);
    });
