...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FitbitPlusApi.HealthProfileQuestionResource();
  });
  ...
  describe('HealthProfileQuestionResource', function() {
    it('should create an instance of HealthProfileQuestionResource', function() {
      // uncomment below and update the code to test HealthProfileQuestionResource
      //var instance = new FitbitPlusApi.HealthProfileQuestionResource();
      //expect(instance).to.be.a(FitbitPlusApi.HealthProfileQuestionResource);
    });
