...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FitbitPlusApi.PatientCreateResourceAllOfRelationshipsCoaches();
  });
  ...
  describe('PatientCreateResourceAllOfRelationshipsCoaches', function() {
    it('should create an instance of PatientCreateResourceAllOfRelationshipsCoaches', function() {
      // uncomment below and update the code to test PatientCreateResourceAllOfRelationshipsCoaches
      //var instance = new FitbitPlusApi.PatientCreateResourceAllOfRelationshipsCoaches();
      //expect(instance).to.be.a(FitbitPlusApi.PatientCreateResourceAllOfRelationshipsCoaches);
    });
