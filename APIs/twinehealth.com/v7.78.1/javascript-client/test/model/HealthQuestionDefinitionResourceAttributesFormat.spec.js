...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FitbitPlusApi.HealthQuestionDefinitionResourceAttributesFormat();
  });
  ...
  describe('HealthQuestionDefinitionResourceAttributesFormat', function() {
    it('should create an instance of HealthQuestionDefinitionResourceAttributesFormat', function() {
      // uncomment below and update the code to test HealthQuestionDefinitionResourceAttributesFormat
      //var instance = new FitbitPlusApi.HealthQuestionDefinitionResourceAttributesFormat();
      //expect(instance).to.be.a(FitbitPlusApi.HealthQuestionDefinitionResourceAttributesFormat);
    });
