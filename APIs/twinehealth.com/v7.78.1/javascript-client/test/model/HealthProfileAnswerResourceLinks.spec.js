...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FitbitPlusApi.HealthProfileAnswerResourceLinks();
  });
  ...
  describe('HealthProfileAnswerResourceLinks', function() {
    it('should create an instance of HealthProfileAnswerResourceLinks', function() {
      // uncomment below and update the code to test HealthProfileAnswerResourceLinks
      //var instance = new FitbitPlusApi.HealthProfileAnswerResourceLinks();
      //expect(instance).to.be.a(FitbitPlusApi.HealthProfileAnswerResourceLinks);
    });
