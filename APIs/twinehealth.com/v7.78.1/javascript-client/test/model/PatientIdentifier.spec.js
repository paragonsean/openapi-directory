...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FitbitPlusApi.PatientIdentifier();
  });
  ...
  describe('PatientIdentifier', function() {
    it('should create an instance of PatientIdentifier', function() {
      // uncomment below and update the code to test PatientIdentifier
      //var instance = new FitbitPlusApi.PatientIdentifier();
      //expect(instance).to.be.a(FitbitPlusApi.PatientIdentifier);
    });
