...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FitbitPlusApi.PatientResourceAttributes();
  });
  ...
  describe('PatientResourceAttributes', function() {
    it('should create an instance of PatientResourceAttributes', function() {
      // uncomment below and update the code to test PatientResourceAttributes
      //var instance = new FitbitPlusApi.PatientResourceAttributes();
      //expect(instance).to.be.a(FitbitPlusApi.PatientResourceAttributes);
    });
    ...
    it('should have the property archiveHistory (base name: "archive_history")', function() {
      // uncomment below and update the code to test the property archiveHistory
      //var instance = new FitbitPlusApi.PatientResourceAttributes();
      //expect(instance).to.be();
    });
    ...
    it('should have the property firstAccessAt (base name: "first_access_at")', function() {
    ...
    it('should have the property lastAccessAt (base name: "last_access_at")', function() {
