...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FitbitPlusApi.FetchHealthProfileAnswerResponse();
  });
  ...
  describe('FetchHealthProfileAnswerResponse', function() {
    it('should create an instance of FetchHealthProfileAnswerResponse', function() {
      // uncomment below and update the code to test FetchHealthProfileAnswerResponse
      //var instance = new FitbitPlusApi.FetchHealthProfileAnswerResponse();
      //expect(instance).to.be.a(FitbitPlusApi.FetchHealthProfileAnswerResponse);
    });
