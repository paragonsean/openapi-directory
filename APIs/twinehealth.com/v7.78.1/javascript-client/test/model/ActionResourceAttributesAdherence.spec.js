...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FitbitPlusApi.ActionResourceAttributesAdherence();
  });
  ...
  describe('ActionResourceAttributesAdherence', function() {
    it('should create an instance of ActionResourceAttributesAdherence', function() {
      // uncomment below and update the code to test ActionResourceAttributesAdherence
      //var instance = new FitbitPlusApi.ActionResourceAttributesAdherence();
      //expect(instance).to.be.a(FitbitPlusApi.ActionResourceAttributesAdherence);
    });
