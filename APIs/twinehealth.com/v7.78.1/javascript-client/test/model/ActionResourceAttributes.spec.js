...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FitbitPlusApi.ActionResourceAttributes();
  });
  ...
  describe('ActionResourceAttributes', function() {
    it('should create an instance of ActionResourceAttributes', function() {
      // uncomment below and update the code to test ActionResourceAttributes
      //var instance = new FitbitPlusApi.ActionResourceAttributes();
      //expect(instance).to.be.a(FitbitPlusApi.ActionResourceAttributes);
    });
    ...
    it('should have the property adherence (base name: "adherence")', function() {
      // uncomment below and update the code to test the property adherence
      //var instance = new FitbitPlusApi.ActionResourceAttributes();
      //expect(instance).to.be();
    });
    ...
    it('should have the property frequencyGoal (base name: "frequency_goal")', function() {
      // uncomment below and update the code to test the property frequencyGoal
      //var instance = new FitbitPlusApi.ActionResourceAttributes();
      //expect(instance).to.be();
    });
    ...
    it('should have the property intake (base name: "intake")', function() {
      // uncomment below and update the code to test the property intake
      //var instance = new FitbitPlusApi.ActionResourceAttributes();
      //expect(instance).to.be();
    });

    it('should have the property metricRequired (base name: "metric_required")', function() {
      // uncomment below and update the code to test the property metricRequired
      //var instance = new FitbitPlusApi.ActionResourceAttributes();
      //expect(instance).to.be();
    });
    ...
    it('should have the property staticTitle (base name: "static_title")', function() {
      // uncomment below and update the code to test the property staticTitle
      //var instance = new FitbitPlusApi.ActionResourceAttributes();
      //expect(instance).to.be();
    });
