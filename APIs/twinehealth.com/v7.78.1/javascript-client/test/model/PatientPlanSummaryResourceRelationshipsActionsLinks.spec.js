...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FitbitPlusApi.PatientPlanSummaryResourceRelationshipsActionsLinks();
  });
  ...
  describe('PatientPlanSummaryResourceRelationshipsActionsLinks', function() {
    it('should create an instance of PatientPlanSummaryResourceRelationshipsActionsLinks', function() {
      // uncomment below and update the code to test PatientPlanSummaryResourceRelationshipsActionsLinks
      //var instance = new FitbitPlusApi.PatientPlanSummaryResourceRelationshipsActionsLinks();
      //expect(instance).to.be.a(FitbitPlusApi.PatientPlanSummaryResourceRelationshipsActionsLinks);
    });
