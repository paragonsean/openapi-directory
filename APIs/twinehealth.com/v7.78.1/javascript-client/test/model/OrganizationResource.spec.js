...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FitbitPlusApi.OrganizationResource();
  });
  ...
  describe('OrganizationResource', function() {
    it('should create an instance of OrganizationResource', function() {
      // uncomment below and update the code to test OrganizationResource
      //var instance = new FitbitPlusApi.OrganizationResource();
      //expect(instance).to.be.a(FitbitPlusApi.OrganizationResource);
    });
