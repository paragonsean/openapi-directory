...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FitbitPlusApi.PatientPlanSummaryResource();
  });
  ...
  describe('PatientPlanSummaryResource', function() {
    it('should create an instance of PatientPlanSummaryResource', function() {
      // uncomment below and update the code to test PatientPlanSummaryResource
      //var instance = new FitbitPlusApi.PatientPlanSummaryResource();
      //expect(instance).to.be.a(FitbitPlusApi.PatientPlanSummaryResource);
    });
