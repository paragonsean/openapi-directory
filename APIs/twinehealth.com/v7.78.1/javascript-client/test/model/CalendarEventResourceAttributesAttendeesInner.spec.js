...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FitbitPlusApi.CalendarEventResourceAttributesAttendeesInner();
  });
  ...
  describe('CalendarEventResourceAttributesAttendeesInner', function() {
    it('should create an instance of CalendarEventResourceAttributesAttendeesInner', function() {
      // uncomment below and update the code to test CalendarEventResourceAttributesAttendeesInner
      //var instance = new FitbitPlusApi.CalendarEventResourceAttributesAttendeesInner();
      //expect(instance).to.be.a(FitbitPlusApi.CalendarEventResourceAttributesAttendeesInner);
    });
