...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FitbitPlusApi.PatientResourceRelationships();
  });
  ...
  describe('PatientResourceRelationships', function() {
    it('should create an instance of PatientResourceRelationships', function() {
      // uncomment below and update the code to test PatientResourceRelationships
      //var instance = new FitbitPlusApi.PatientResourceRelationships();
      //expect(instance).to.be.a(FitbitPlusApi.PatientResourceRelationships);
    });
