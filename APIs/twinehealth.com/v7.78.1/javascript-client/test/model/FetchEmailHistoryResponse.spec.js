...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FitbitPlusApi.FetchEmailHistoryResponse();
  });
  ...
  describe('FetchEmailHistoryResponse', function() {
    it('should create an instance of FetchEmailHistoryResponse', function() {
      // uncomment below and update the code to test FetchEmailHistoryResponse
      //var instance = new FitbitPlusApi.FetchEmailHistoryResponse();
      //expect(instance).to.be.a(FitbitPlusApi.FetchEmailHistoryResponse);
    });
