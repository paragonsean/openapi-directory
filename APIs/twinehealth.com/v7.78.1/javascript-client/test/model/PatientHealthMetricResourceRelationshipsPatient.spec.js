...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FitbitPlusApi.PatientHealthMetricResourceRelationshipsPatient();
  });
  ...
  describe('PatientHealthMetricResourceRelationshipsPatient', function() {
    it('should create an instance of PatientHealthMetricResourceRelationshipsPatient', function() {
      // uncomment below and update the code to test PatientHealthMetricResourceRelationshipsPatient
      //var instance = new FitbitPlusApi.PatientHealthMetricResourceRelationshipsPatient();
      //expect(instance).to.be.a(FitbitPlusApi.PatientHealthMetricResourceRelationshipsPatient);
    });
