...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FitbitPlusApi.FetchPatientHealthResultResponse();
  });
  ...
  describe('FetchPatientHealthResultResponse', function() {
    it('should create an instance of FetchPatientHealthResultResponse', function() {
      // uncomment below and update the code to test FetchPatientHealthResultResponse
      //var instance = new FitbitPlusApi.FetchPatientHealthResultResponse();
      //expect(instance).to.be.a(FitbitPlusApi.FetchPatientHealthResultResponse);
    });
