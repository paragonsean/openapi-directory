...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FitbitPlusApi.PatientCreateResourceAllOfRelationshipsCoachesLinks();
  });
  ...
  describe('PatientCreateResourceAllOfRelationshipsCoachesLinks', function() {
    it('should create an instance of PatientCreateResourceAllOfRelationshipsCoachesLinks', function() {
      // uncomment below and update the code to test PatientCreateResourceAllOfRelationshipsCoachesLinks
      //var instance = new FitbitPlusApi.PatientCreateResourceAllOfRelationshipsCoachesLinks();
      //expect(instance).to.be.a(FitbitPlusApi.PatientCreateResourceAllOfRelationshipsCoachesLinks);
    });
