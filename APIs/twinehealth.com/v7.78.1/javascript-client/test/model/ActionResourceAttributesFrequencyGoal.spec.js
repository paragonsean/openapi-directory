...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FitbitPlusApi.ActionResourceAttributesFrequencyGoal();
  });
  ...
  describe('ActionResourceAttributesFrequencyGoal', function() {
    it('should create an instance of ActionResourceAttributesFrequencyGoal', function() {
      // uncomment below and update the code to test ActionResourceAttributesFrequencyGoal
      //var instance = new FitbitPlusApi.ActionResourceAttributesFrequencyGoal();
      //expect(instance).to.be.a(FitbitPlusApi.ActionResourceAttributesFrequencyGoal);
    });
