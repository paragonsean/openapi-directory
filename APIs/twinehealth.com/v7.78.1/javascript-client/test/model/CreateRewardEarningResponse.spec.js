...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FitbitPlusApi.CreateRewardEarningResponse();
  });
  ...
  describe('CreateRewardEarningResponse', function() {
    it('should create an instance of CreateRewardEarningResponse', function() {
      // uncomment below and update the code to test CreateRewardEarningResponse
      //var instance = new FitbitPlusApi.CreateRewardEarningResponse();
      //expect(instance).to.be.a(FitbitPlusApi.CreateRewardEarningResponse);
    });
