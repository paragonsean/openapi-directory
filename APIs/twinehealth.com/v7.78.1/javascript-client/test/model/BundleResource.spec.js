...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FitbitPlusApi.BundleResource();
  });
  ...
  describe('BundleResource', function() {
    it('should create an instance of BundleResource', function() {
      // uncomment below and update the code to test BundleResource
      //var instance = new FitbitPlusApi.BundleResource();
      //expect(instance).to.be.a(FitbitPlusApi.BundleResource);
    });
