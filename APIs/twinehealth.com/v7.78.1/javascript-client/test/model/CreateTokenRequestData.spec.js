...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FitbitPlusApi.CreateTokenRequestData();
  });
  ...
  describe('CreateTokenRequestData', function() {
    it('should create an instance of CreateTokenRequestData', function() {
      // uncomment below and update the code to test CreateTokenRequestData
      //var instance = new FitbitPlusApi.CreateTokenRequestData();
      //expect(instance).to.be.a(FitbitPlusApi.CreateTokenRequestData);
    });
