...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FitbitPlusApi.EmailHistoryResourceAttributesStatusTimes();
  });
  ...
  describe('EmailHistoryResourceAttributesStatusTimes', function() {
    it('should create an instance of EmailHistoryResourceAttributesStatusTimes', function() {
      // uncomment below and update the code to test EmailHistoryResourceAttributesStatusTimes
      //var instance = new FitbitPlusApi.EmailHistoryResourceAttributesStatusTimes();
      //expect(instance).to.be.a(FitbitPlusApi.EmailHistoryResourceAttributesStatusTimes);
    });
    ...
    it('should have the property spamreport (base name: "spamreport")', function() {
      // uncomment below and update the code to test the property spamreport
      //var instance = new FitbitPlusApi.EmailHistoryResourceAttributesStatusTimes();
      //expect(instance).to.be();
    });
