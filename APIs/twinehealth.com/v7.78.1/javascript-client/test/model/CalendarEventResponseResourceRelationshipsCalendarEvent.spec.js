...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FitbitPlusApi.CalendarEventResponseResourceRelationshipsCalendarEvent();
  });
  ...
  describe('CalendarEventResponseResourceRelationshipsCalendarEvent', function() {
    it('should create an instance of CalendarEventResponseResourceRelationshipsCalendarEvent', function() {
      // uncomment below and update the code to test CalendarEventResponseResourceRelationshipsCalendarEvent
      //var instance = new FitbitPlusApi.CalendarEventResponseResourceRelationshipsCalendarEvent();
      //expect(instance).to.be.a(FitbitPlusApi.CalendarEventResponseResourceRelationshipsCalendarEvent);
    });
