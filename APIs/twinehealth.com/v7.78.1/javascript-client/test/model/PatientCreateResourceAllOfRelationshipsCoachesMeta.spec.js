...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FitbitPlusApi.PatientCreateResourceAllOfRelationshipsCoachesMeta();
  });
  ...
  describe('PatientCreateResourceAllOfRelationshipsCoachesMeta', function() {
    it('should create an instance of PatientCreateResourceAllOfRelationshipsCoachesMeta', function() {
      // uncomment below and update the code to test PatientCreateResourceAllOfRelationshipsCoachesMeta
      //var instance = new FitbitPlusApi.PatientCreateResourceAllOfRelationshipsCoachesMeta();
      //expect(instance).to.be.a(FitbitPlusApi.PatientCreateResourceAllOfRelationshipsCoachesMeta);
    });
