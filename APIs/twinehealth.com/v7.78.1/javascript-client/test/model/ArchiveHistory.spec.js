...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FitbitPlusApi.ArchiveHistory();
  });
  ...
  describe('ArchiveHistory', function() {
    it('should create an instance of ArchiveHistory', function() {
      // uncomment below and update the code to test ArchiveHistory
      //var instance = new FitbitPlusApi.ArchiveHistory();
      //expect(instance).to.be.a(FitbitPlusApi.ArchiveHistory);
    });
