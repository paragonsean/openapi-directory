...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FitbitPlusApi.PatientPlanSummaryResourceLinks();
  });
  ...
  describe('PatientPlanSummaryResourceLinks', function() {
    it('should create an instance of PatientPlanSummaryResourceLinks', function() {
      // uncomment below and update the code to test PatientPlanSummaryResourceLinks
      //var instance = new FitbitPlusApi.PatientPlanSummaryResourceLinks();
      //expect(instance).to.be.a(FitbitPlusApi.PatientPlanSummaryResourceLinks);
    });
