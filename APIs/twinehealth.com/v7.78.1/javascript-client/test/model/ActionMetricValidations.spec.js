...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FitbitPlusApi.ActionMetricValidations();
  });
  ...
  describe('ActionMetricValidations', function() {
    it('should create an instance of ActionMetricValidations', function() {
      // uncomment below and update the code to test ActionMetricValidations
      //var instance = new FitbitPlusApi.ActionMetricValidations();
      //expect(instance).to.be.a(FitbitPlusApi.ActionMetricValidations);
    });
