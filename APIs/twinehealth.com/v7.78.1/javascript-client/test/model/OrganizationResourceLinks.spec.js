...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FitbitPlusApi.OrganizationResourceLinks();
  });
  ...
  describe('OrganizationResourceLinks', function() {
    it('should create an instance of OrganizationResourceLinks', function() {
      // uncomment below and update the code to test OrganizationResourceLinks
      //var instance = new FitbitPlusApi.OrganizationResourceLinks();
      //expect(instance).to.be.a(FitbitPlusApi.OrganizationResourceLinks);
    });
