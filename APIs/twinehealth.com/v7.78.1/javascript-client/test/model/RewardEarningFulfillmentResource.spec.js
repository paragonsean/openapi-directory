...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FitbitPlusApi.RewardEarningFulfillmentResource();
  });
  ...
  describe('RewardEarningFulfillmentResource', function() {
    it('should create an instance of RewardEarningFulfillmentResource', function() {
      // uncomment below and update the code to test RewardEarningFulfillmentResource
      //var instance = new FitbitPlusApi.RewardEarningFulfillmentResource();
      //expect(instance).to.be.a(FitbitPlusApi.RewardEarningFulfillmentResource);
    });
