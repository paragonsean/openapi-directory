...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FitbitPlusApi.GroupResourceAttributes();
  });
  ...
  describe('GroupResourceAttributes', function() {
    it('should create an instance of GroupResourceAttributes', function() {
      // uncomment below and update the code to test GroupResourceAttributes
      //var instance = new FitbitPlusApi.GroupResourceAttributes();
      //expect(instance).to.be.a(FitbitPlusApi.GroupResourceAttributes);
    });
