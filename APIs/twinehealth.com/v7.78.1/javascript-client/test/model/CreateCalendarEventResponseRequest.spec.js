...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FitbitPlusApi.CreateCalendarEventResponseRequest();
  });
  ...
  describe('CreateCalendarEventResponseRequest', function() {
    it('should create an instance of CreateCalendarEventResponseRequest', function() {
      // uncomment below and update the code to test CreateCalendarEventResponseRequest
      //var instance = new FitbitPlusApi.CreateCalendarEventResponseRequest();
      //expect(instance).to.be.a(FitbitPlusApi.CreateCalendarEventResponseRequest);
    });
