...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FitbitPlusApi.TokenResourceAttributes();
  });
  ...
  describe('TokenResourceAttributes', function() {
    it('should create an instance of TokenResourceAttributes', function() {
      // uncomment below and update the code to test TokenResourceAttributes
      //var instance = new FitbitPlusApi.TokenResourceAttributes();
      //expect(instance).to.be.a(FitbitPlusApi.TokenResourceAttributes);
    });
