...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FitbitPlusApi.FetchPatientResponse();
  });
  ...
  describe('FetchPatientResponse', function() {
    it('should create an instance of FetchPatientResponse', function() {
      // uncomment below and update the code to test FetchPatientResponse
      //var instance = new FitbitPlusApi.FetchPatientResponse();
      //expect(instance).to.be.a(FitbitPlusApi.FetchPatientResponse);
    });
