...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FitbitPlusApi.RewardProgramActivationResource();
  });
  ...
  describe('RewardProgramActivationResource', function() {
    it('should create an instance of RewardProgramActivationResource', function() {
      // uncomment below and update the code to test RewardProgramActivationResource
      //var instance = new FitbitPlusApi.RewardProgramActivationResource();
      //expect(instance).to.be.a(FitbitPlusApi.RewardProgramActivationResource);
    });
