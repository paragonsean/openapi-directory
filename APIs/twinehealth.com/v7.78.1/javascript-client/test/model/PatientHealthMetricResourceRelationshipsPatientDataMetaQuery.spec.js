...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FitbitPlusApi.PatientHealthMetricResourceRelationshipsPatientDataMetaQuery();
  });
  ...
  describe('PatientHealthMetricResourceRelationshipsPatientDataMetaQuery', function() {
    it('should create an instance of PatientHealthMetricResourceRelationshipsPatientDataMetaQuery', function() {
      // uncomment below and update the code to test PatientHealthMetricResourceRelationshipsPatientDataMetaQuery
      //var instance = new FitbitPlusApi.PatientHealthMetricResourceRelationshipsPatientDataMetaQuery();
      //expect(instance).to.be.a(FitbitPlusApi.PatientHealthMetricResourceRelationshipsPatientDataMetaQuery);
    });
