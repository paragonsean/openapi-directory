...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FitbitPlusApi.HealthQuestionDefinitionResourceAttributesFormatDataInner();
  });
  ...
  describe('HealthQuestionDefinitionResourceAttributesFormatDataInner', function() {
    it('should create an instance of HealthQuestionDefinitionResourceAttributesFormatDataInner', function() {
      // uncomment below and update the code to test HealthQuestionDefinitionResourceAttributesFormatDataInner
      //var instance = new FitbitPlusApi.HealthQuestionDefinitionResourceAttributesFormatDataInner();
      //expect(instance).to.be.a(FitbitPlusApi.HealthQuestionDefinitionResourceAttributesFormatDataInner);
    });
