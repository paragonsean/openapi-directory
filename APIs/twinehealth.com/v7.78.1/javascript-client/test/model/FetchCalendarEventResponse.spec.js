...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FitbitPlusApi.FetchCalendarEventResponse();
  });
  ...
  describe('FetchCalendarEventResponse', function() {
    it('should create an instance of FetchCalendarEventResponse', function() {
      // uncomment below and update the code to test FetchCalendarEventResponse
      //var instance = new FitbitPlusApi.FetchCalendarEventResponse();
      //expect(instance).to.be.a(FitbitPlusApi.FetchCalendarEventResponse);
    });
