...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FitbitPlusApi.FetchGroupResponse();
  });
  ...
  describe('FetchGroupResponse', function() {
    it('should create an instance of FetchGroupResponse', function() {
      // uncomment below and update the code to test FetchGroupResponse
      //var instance = new FitbitPlusApi.FetchGroupResponse();
      //expect(instance).to.be.a(FitbitPlusApi.FetchGroupResponse);
    });
