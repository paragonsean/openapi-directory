...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FitbitPlusApi.UpdateCalendarEventRequest();
  });
  ...
  describe('UpdateCalendarEventRequest', function() {
    it('should create an instance of UpdateCalendarEventRequest', function() {
      // uncomment below and update the code to test UpdateCalendarEventRequest
      //var instance = new FitbitPlusApi.UpdateCalendarEventRequest();
      //expect(instance).to.be.a(FitbitPlusApi.UpdateCalendarEventRequest);
    });
