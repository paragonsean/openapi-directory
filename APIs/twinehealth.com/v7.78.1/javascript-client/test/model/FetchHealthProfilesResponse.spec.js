...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FitbitPlusApi.FetchHealthProfilesResponse();
  });
  ...
  describe('FetchHealthProfilesResponse', function() {
    it('should create an instance of FetchHealthProfilesResponse', function() {
      // uncomment below and update the code to test FetchHealthProfilesResponse
      //var instance = new FitbitPlusApi.FetchHealthProfilesResponse();
      //expect(instance).to.be.a(FitbitPlusApi.FetchHealthProfilesResponse);
    });
