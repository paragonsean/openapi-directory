...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FitbitPlusApi.FetchPatientPlanSummaryResponse();
  });
  ...
  describe('FetchPatientPlanSummaryResponse', function() {
    it('should create an instance of FetchPatientPlanSummaryResponse', function() {
      // uncomment below and update the code to test FetchPatientPlanSummaryResponse
      //var instance = new FitbitPlusApi.FetchPatientPlanSummaryResponse();
      //expect(instance).to.be.a(FitbitPlusApi.FetchPatientPlanSummaryResponse);
    });
