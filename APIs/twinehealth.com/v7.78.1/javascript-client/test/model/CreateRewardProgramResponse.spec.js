...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FitbitPlusApi.CreateRewardProgramResponse();
  });
  ...
  describe('CreateRewardProgramResponse', function() {
    it('should create an instance of CreateRewardProgramResponse', function() {
      // uncomment below and update the code to test CreateRewardProgramResponse
      //var instance = new FitbitPlusApi.CreateRewardProgramResponse();
      //expect(instance).to.be.a(FitbitPlusApi.CreateRewardProgramResponse);
    });
