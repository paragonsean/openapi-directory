...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FitbitPlusApi.CalendarEventResponseResourceRelationshipsUser();
  });
  ...
  describe('CalendarEventResponseResourceRelationshipsUser', function() {
    it('should create an instance of CalendarEventResponseResourceRelationshipsUser', function() {
      // uncomment below and update the code to test CalendarEventResponseResourceRelationshipsUser
      //var instance = new FitbitPlusApi.CalendarEventResponseResourceRelationshipsUser();
      //expect(instance).to.be.a(FitbitPlusApi.CalendarEventResponseResourceRelationshipsUser);
    });
