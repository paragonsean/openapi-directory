...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FitbitPlusApi.HealthProfileQuestionResourceRelationshipsProfile();
  });
  ...
  describe('HealthProfileQuestionResourceRelationshipsProfile', function() {
    it('should create an instance of HealthProfileQuestionResourceRelationshipsProfile', function() {
      // uncomment below and update the code to test HealthProfileQuestionResourceRelationshipsProfile
      //var instance = new FitbitPlusApi.HealthProfileQuestionResourceRelationshipsProfile();
      //expect(instance).to.be.a(FitbitPlusApi.HealthProfileQuestionResourceRelationshipsProfile);
    });
