...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FitbitPlusApi.FetchErrorResponse();
  });
  ...
  describe('FetchErrorResponse', function() {
    it('should create an instance of FetchErrorResponse', function() {
      // uncomment below and update the code to test FetchErrorResponse
      //var instance = new FitbitPlusApi.FetchErrorResponse();
      //expect(instance).to.be.a(FitbitPlusApi.FetchErrorResponse);
    });
