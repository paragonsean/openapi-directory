...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FitbitPlusApi.CreateRewardEarningRequest();
  });
  ...
  describe('CreateRewardEarningRequest', function() {
    it('should create an instance of CreateRewardEarningRequest', function() {
      // uncomment below and update the code to test CreateRewardEarningRequest
      //var instance = new FitbitPlusApi.CreateRewardEarningRequest();
      //expect(instance).to.be.a(FitbitPlusApi.CreateRewardEarningRequest);
    });
