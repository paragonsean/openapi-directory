...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FitbitPlusApi.FetchPatientPlanSummariesResponse();
  });
  ...
  describe('FetchPatientPlanSummariesResponse', function() {
    it('should create an instance of FetchPatientPlanSummariesResponse', function() {
      // uncomment below and update the code to test FetchPatientPlanSummariesResponse
      //var instance = new FitbitPlusApi.FetchPatientPlanSummariesResponse();
      //expect(instance).to.be.a(FitbitPlusApi.FetchPatientPlanSummariesResponse);
    });
