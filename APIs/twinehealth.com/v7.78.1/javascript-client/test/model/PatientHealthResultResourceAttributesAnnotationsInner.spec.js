...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FitbitPlusApi.PatientHealthResultResourceAttributesAnnotationsInner();
  });
  ...
  describe('PatientHealthResultResourceAttributesAnnotationsInner', function() {
    it('should create an instance of PatientHealthResultResourceAttributesAnnotationsInner', function() {
      // uncomment below and update the code to test PatientHealthResultResourceAttributesAnnotationsInner
      //var instance = new FitbitPlusApi.PatientHealthResultResourceAttributesAnnotationsInner();
      //expect(instance).to.be.a(FitbitPlusApi.PatientHealthResultResourceAttributesAnnotationsInner);
    });
