...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FitbitPlusApi.CalendarEventResourceLinks();
  });
  ...
  describe('CalendarEventResourceLinks', function() {
    it('should create an instance of CalendarEventResourceLinks', function() {
      // uncomment below and update the code to test CalendarEventResourceLinks
      //var instance = new FitbitPlusApi.CalendarEventResourceLinks();
      //expect(instance).to.be.a(FitbitPlusApi.CalendarEventResourceLinks);
    });
