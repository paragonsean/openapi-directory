...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FitbitPlusApi.HealthProfileResource();
  });
  ...
  describe('HealthProfileResource', function() {
    it('should create an instance of HealthProfileResource', function() {
      // uncomment below and update the code to test HealthProfileResource
      //var instance = new FitbitPlusApi.HealthProfileResource();
      //expect(instance).to.be.a(FitbitPlusApi.HealthProfileResource);
    });
