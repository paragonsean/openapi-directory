...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FitbitPlusApi.PatientHealthResultResourceRelationshipsPatient();
  });
  ...
  describe('PatientHealthResultResourceRelationshipsPatient', function() {
    it('should create an instance of PatientHealthResultResourceRelationshipsPatient', function() {
      // uncomment below and update the code to test PatientHealthResultResourceRelationshipsPatient
      //var instance = new FitbitPlusApi.PatientHealthResultResourceRelationshipsPatient();
      //expect(instance).to.be.a(FitbitPlusApi.PatientHealthResultResourceRelationshipsPatient);
    });
