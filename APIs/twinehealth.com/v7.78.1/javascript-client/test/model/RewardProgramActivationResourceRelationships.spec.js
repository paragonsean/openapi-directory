...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FitbitPlusApi.RewardProgramActivationResourceRelationships();
  });
  ...
  describe('RewardProgramActivationResourceRelationships', function() {
    it('should create an instance of RewardProgramActivationResourceRelationships', function() {
      // uncomment below and update the code to test RewardProgramActivationResourceRelationships
      //var instance = new FitbitPlusApi.RewardProgramActivationResourceRelationships();
      //expect(instance).to.be.a(FitbitPlusApi.RewardProgramActivationResourceRelationships);
    });
    ...
    it('should have the property rewardProgram (base name: "reward_program")', function() {
      // uncomment below and update the code to test the property rewardProgram
      //var instance = new FitbitPlusApi.RewardProgramActivationResourceRelationships();
      //expect(instance).to.be();
    });
