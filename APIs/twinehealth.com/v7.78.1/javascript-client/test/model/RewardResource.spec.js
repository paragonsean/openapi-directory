...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FitbitPlusApi.RewardResource();
  });
  ...
  describe('RewardResource', function() {
    it('should create an instance of RewardResource', function() {
      // uncomment below and update the code to test RewardResource
      //var instance = new FitbitPlusApi.RewardResource();
      //expect(instance).to.be.a(FitbitPlusApi.RewardResource);
    });
