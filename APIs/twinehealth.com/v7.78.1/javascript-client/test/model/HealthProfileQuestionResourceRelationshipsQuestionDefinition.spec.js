...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FitbitPlusApi.HealthProfileQuestionResourceRelationshipsQuestionDefinition();
  });
  ...
  describe('HealthProfileQuestionResourceRelationshipsQuestionDefinition', function() {
    it('should create an instance of HealthProfileQuestionResourceRelationshipsQuestionDefinition', function() {
      // uncomment below and update the code to test HealthProfileQuestionResourceRelationshipsQuestionDefinition
      //var instance = new FitbitPlusApi.HealthProfileQuestionResourceRelationshipsQuestionDefinition();
      //expect(instance).to.be.a(FitbitPlusApi.HealthProfileQuestionResourceRelationshipsQuestionDefinition);
    });
