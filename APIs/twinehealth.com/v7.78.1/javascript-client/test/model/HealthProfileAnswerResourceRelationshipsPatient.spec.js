...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FitbitPlusApi.HealthProfileAnswerResourceRelationshipsPatient();
  });
  ...
  describe('HealthProfileAnswerResourceRelationshipsPatient', function() {
    it('should create an instance of HealthProfileAnswerResourceRelationshipsPatient', function() {
      // uncomment below and update the code to test HealthProfileAnswerResourceRelationshipsPatient
      //var instance = new FitbitPlusApi.HealthProfileAnswerResourceRelationshipsPatient();
      //expect(instance).to.be.a(FitbitPlusApi.HealthProfileAnswerResourceRelationshipsPatient);
    });
