...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FitbitPlusApi.UpdatePatientRequest();
  });
  ...
  describe('UpdatePatientRequest', function() {
    it('should create an instance of UpdatePatientRequest', function() {
      // uncomment below and update the code to test UpdatePatientRequest
      //var instance = new FitbitPlusApi.UpdatePatientRequest();
      //expect(instance).to.be.a(FitbitPlusApi.UpdatePatientRequest);
    });
