...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FitbitPlusApi.UpsertPatientRequest();
  });
  ...
  describe('UpsertPatientRequest', function() {
    it('should create an instance of UpsertPatientRequest', function() {
      // uncomment below and update the code to test UpsertPatientRequest
      //var instance = new FitbitPlusApi.UpsertPatientRequest();
      //expect(instance).to.be.a(FitbitPlusApi.UpsertPatientRequest);
    });
