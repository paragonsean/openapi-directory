...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FitbitPlusApi.PatientResource();
  });
  ...
  describe('PatientResource', function() {
    it('should create an instance of PatientResource', function() {
      // uncomment below and update the code to test PatientResource
      //var instance = new FitbitPlusApi.PatientResource();
      //expect(instance).to.be.a(FitbitPlusApi.PatientResource);
    });
