...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FitbitPlusApi.PatientPlanSummaryResourceRelationships();
  });
  ...
  describe('PatientPlanSummaryResourceRelationships', function() {
    it('should create an instance of PatientPlanSummaryResourceRelationships', function() {
      // uncomment below and update the code to test PatientPlanSummaryResourceRelationships
      //var instance = new FitbitPlusApi.PatientPlanSummaryResourceRelationships();
      //expect(instance).to.be.a(FitbitPlusApi.PatientPlanSummaryResourceRelationships);
    });
    ...
    it('should have the property currentResults (base name: "current_results")', function() {
      // uncomment below and update the code to test the property currentResults
      //var instance = new FitbitPlusApi.PatientPlanSummaryResourceRelationships();
      //expect(instance).to.be();
    });
