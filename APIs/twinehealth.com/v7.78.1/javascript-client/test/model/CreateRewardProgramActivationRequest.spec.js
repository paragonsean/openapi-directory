...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FitbitPlusApi.CreateRewardProgramActivationRequest();
  });
  ...
  describe('CreateRewardProgramActivationRequest', function() {
    it('should create an instance of CreateRewardProgramActivationRequest', function() {
      // uncomment below and update the code to test CreateRewardProgramActivationRequest
      //var instance = new FitbitPlusApi.CreateRewardProgramActivationRequest();
      //expect(instance).to.be.a(FitbitPlusApi.CreateRewardProgramActivationRequest);
    });
