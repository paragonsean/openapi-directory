...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FitbitPlusApi.CalendarEventResponseResourceRelationshipsCalendarEventLinks();
  });
  ...
  describe('CalendarEventResponseResourceRelationshipsCalendarEventLinks', function() {
    it('should create an instance of CalendarEventResponseResourceRelationshipsCalendarEventLinks', function() {
      // uncomment below and update the code to test CalendarEventResponseResourceRelationshipsCalendarEventLinks
      //var instance = new FitbitPlusApi.CalendarEventResponseResourceRelationshipsCalendarEventLinks();
      //expect(instance).to.be.a(FitbitPlusApi.CalendarEventResponseResourceRelationshipsCalendarEventLinks);
    });
