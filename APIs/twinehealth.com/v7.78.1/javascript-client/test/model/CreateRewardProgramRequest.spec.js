...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FitbitPlusApi.CreateRewardProgramRequest();
  });
  ...
  describe('CreateRewardProgramRequest', function() {
    it('should create an instance of CreateRewardProgramRequest', function() {
      // uncomment below and update the code to test CreateRewardProgramRequest
      //var instance = new FitbitPlusApi.CreateRewardProgramRequest();
      //expect(instance).to.be.a(FitbitPlusApi.CreateRewardProgramRequest);
    });
