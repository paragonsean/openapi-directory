...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FitbitPlusApi.CreatePatientHealthMetricResponse();
  });
  ...
  describe('CreatePatientHealthMetricResponse', function() {
    it('should create an instance of CreatePatientHealthMetricResponse', function() {
      // uncomment below and update the code to test CreatePatientHealthMetricResponse
      //var instance = new FitbitPlusApi.CreatePatientHealthMetricResponse();
      //expect(instance).to.be.a(FitbitPlusApi.CreatePatientHealthMetricResponse);
    });
