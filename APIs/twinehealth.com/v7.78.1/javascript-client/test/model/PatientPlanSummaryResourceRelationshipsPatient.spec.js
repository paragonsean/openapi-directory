...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FitbitPlusApi.PatientPlanSummaryResourceRelationshipsPatient();
  });
  ...
  describe('PatientPlanSummaryResourceRelationshipsPatient', function() {
    it('should create an instance of PatientPlanSummaryResourceRelationshipsPatient', function() {
      // uncomment below and update the code to test PatientPlanSummaryResourceRelationshipsPatient
      //var instance = new FitbitPlusApi.PatientPlanSummaryResourceRelationshipsPatient();
      //expect(instance).to.be.a(FitbitPlusApi.PatientPlanSummaryResourceRelationshipsPatient);
    });
