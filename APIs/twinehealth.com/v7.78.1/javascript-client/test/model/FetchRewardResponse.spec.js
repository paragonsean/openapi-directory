...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FitbitPlusApi.FetchRewardResponse();
  });
  ...
  describe('FetchRewardResponse', function() {
    it('should create an instance of FetchRewardResponse', function() {
      // uncomment below and update the code to test FetchRewardResponse
      //var instance = new FitbitPlusApi.FetchRewardResponse();
      //expect(instance).to.be.a(FitbitPlusApi.FetchRewardResponse);
    });
