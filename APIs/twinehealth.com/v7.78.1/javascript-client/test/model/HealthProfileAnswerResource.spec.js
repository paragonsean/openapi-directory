...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FitbitPlusApi.HealthProfileAnswerResource();
  });
  ...
  describe('HealthProfileAnswerResource', function() {
    it('should create an instance of HealthProfileAnswerResource', function() {
      // uncomment below and update the code to test HealthProfileAnswerResource
      //var instance = new FitbitPlusApi.HealthProfileAnswerResource();
      //expect(instance).to.be.a(FitbitPlusApi.HealthProfileAnswerResource);
    });
