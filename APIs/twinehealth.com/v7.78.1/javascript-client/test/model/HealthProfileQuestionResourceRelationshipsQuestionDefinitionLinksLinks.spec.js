...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FitbitPlusApi.HealthProfileQuestionResourceRelationshipsQuestionDefinitionLinksLinks();
  });
  ...
  describe('HealthProfileQuestionResourceRelationshipsQuestionDefinitionLinksLinks', function() {
    it('should create an instance of HealthProfileQuestionResourceRelationshipsQuestionDefinitionLinksLinks', function() {
      // uncomment below and update the code to test HealthProfileQuestionResourceRelationshipsQuestionDefinitionLinksLinks
      //var instance = new FitbitPlusApi.HealthProfileQuestionResourceRelationshipsQuestionDefinitionLinksLinks();
      //expect(instance).to.be.a(FitbitPlusApi.HealthProfileQuestionResourceRelationshipsQuestionDefinitionLinksLinks);
    });
