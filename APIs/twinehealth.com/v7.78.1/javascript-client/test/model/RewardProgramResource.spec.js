...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FitbitPlusApi.RewardProgramResource();
  });
  ...
  describe('RewardProgramResource', function() {
    it('should create an instance of RewardProgramResource', function() {
      // uncomment below and update the code to test RewardProgramResource
      //var instance = new FitbitPlusApi.RewardProgramResource();
      //expect(instance).to.be.a(FitbitPlusApi.RewardProgramResource);
    });
