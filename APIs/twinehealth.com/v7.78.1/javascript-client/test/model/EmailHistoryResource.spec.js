...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FitbitPlusApi.EmailHistoryResource();
  });
  ...
  describe('EmailHistoryResource', function() {
    it('should create an instance of EmailHistoryResource', function() {
      // uncomment below and update the code to test EmailHistoryResource
      //var instance = new FitbitPlusApi.EmailHistoryResource();
      //expect(instance).to.be.a(FitbitPlusApi.EmailHistoryResource);
    });
