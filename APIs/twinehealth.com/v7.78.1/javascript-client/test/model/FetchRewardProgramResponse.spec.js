...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FitbitPlusApi.FetchRewardProgramResponse();
  });
  ...
  describe('FetchRewardProgramResponse', function() {
    it('should create an instance of FetchRewardProgramResponse', function() {
      // uncomment below and update the code to test FetchRewardProgramResponse
      //var instance = new FitbitPlusApi.FetchRewardProgramResponse();
      //expect(instance).to.be.a(FitbitPlusApi.FetchRewardProgramResponse);
    });
