...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FitbitPlusApi.EmailHistoryResourceRelationships();
  });
  ...
  describe('EmailHistoryResourceRelationships', function() {
    it('should create an instance of EmailHistoryResourceRelationships', function() {
      // uncomment below and update the code to test EmailHistoryResourceRelationships
      //var instance = new FitbitPlusApi.EmailHistoryResourceRelationships();
      //expect(instance).to.be.a(FitbitPlusApi.EmailHistoryResourceRelationships);
    });
