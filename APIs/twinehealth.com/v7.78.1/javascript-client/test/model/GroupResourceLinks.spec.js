...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FitbitPlusApi.GroupResourceLinks();
  });
  ...
  describe('GroupResourceLinks', function() {
    it('should create an instance of GroupResourceLinks', function() {
      // uncomment below and update the code to test GroupResourceLinks
      //var instance = new FitbitPlusApi.GroupResourceLinks();
      //expect(instance).to.be.a(FitbitPlusApi.GroupResourceLinks);
    });
