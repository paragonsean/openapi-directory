...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FitbitPlusApi.CreateTokenRequest();
  });
  ...
  describe('CreateTokenRequest', function() {
    it('should create an instance of CreateTokenRequest', function() {
      ...
      //var instance = new FitbitPlusApi.CreateTokenRequest();
      //expect(instance).to.be.a(FitbitPlusApi.CreateTokenRequest);
    });
