...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FitbitPlusApi.PatientHealthMetricResourceRelationships();
  });
  ...
  describe('PatientHealthMetricResourceRelationships', function() {
    it('should create an instance of PatientHealthMetricResourceRelationships', function() {
      // uncomment below and update the code to test PatientHealthMetricResourceRelationships
      //var instance = new FitbitPlusApi.PatientHealthMetricResourceRelationships();
      //expect(instance).to.be.a(FitbitPlusApi.PatientHealthMetricResourceRelationships);
    });
