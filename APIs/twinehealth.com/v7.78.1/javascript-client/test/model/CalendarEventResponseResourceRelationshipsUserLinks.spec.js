...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FitbitPlusApi.CalendarEventResponseResourceRelationshipsUserLinks();
  });
  ...
  describe('CalendarEventResponseResourceRelationshipsUserLinks', function() {
    it('should create an instance of CalendarEventResponseResourceRelationshipsUserLinks', function() {
      // uncomment below and update the code to test CalendarEventResponseResourceRelationshipsUserLinks
      //var instance = new FitbitPlusApi.CalendarEventResponseResourceRelationshipsUserLinks();
      //expect(instance).to.be.a(FitbitPlusApi.CalendarEventResponseResourceRelationshipsUserLinks);
    });
