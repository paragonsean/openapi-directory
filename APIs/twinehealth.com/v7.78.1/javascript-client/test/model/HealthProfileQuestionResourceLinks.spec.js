...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FitbitPlusApi.HealthProfileQuestionResourceLinks();
  });
  ...
  describe('HealthProfileQuestionResourceLinks', function() {
    it('should create an instance of HealthProfileQuestionResourceLinks', function() {
      // uncomment below and update the code to test HealthProfileQuestionResourceLinks
      //var instance = new FitbitPlusApi.HealthProfileQuestionResourceLinks();
      //expect(instance).to.be.a(FitbitPlusApi.HealthProfileQuestionResourceLinks);
    });
