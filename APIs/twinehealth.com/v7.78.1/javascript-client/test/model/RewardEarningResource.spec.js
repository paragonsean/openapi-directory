...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FitbitPlusApi.RewardEarningResource();
  });
  ...
  describe('RewardEarningResource', function() {
    it('should create an instance of RewardEarningResource', function() {
      // uncomment below and update the code to test RewardEarningResource
      //var instance = new FitbitPlusApi.RewardEarningResource();
      //expect(instance).to.be.a(FitbitPlusApi.RewardEarningResource);
    });
