...
export default class ActionApi {
    ...
    */
     ...
     * @callback module:api/ActionApi~createActionCallback
     ...
     * @param {module:api/ActionApi~createActionCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/CreateActionResponse}
     */
    createAction(createActionRequest, callback) {
    ...
    /**
     * Callback function to receive the result of the fetchAction operation.
     * @callback module:api/ActionApi~fetchActionCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:api/ActionApi~fetchActionCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/FetchActionResponse}
     */
    fetchAction(id, callback) {
      let postBody = null;
      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling fetchAction");
      }
     ...
     * @callback module:api/ActionApi~updateActionCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:api/ActionApi~updateActionCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/UpdateActionResponse}
     */
    updateAction(id, updateActionRequest, callback) {
