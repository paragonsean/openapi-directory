...
/**
 * The FetchErrorResponse model module.
 * @module model/FetchErrorResponse
 * @version v7.78.1
 */
class FetchErrorResponse {
    /**
     * Constructs a new <code>FetchErrorResponse</code>.
     * @alias module:model/FetchErrorResponse
     */
    constructor() { 
        
        FetchErrorResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>FetchErrorResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/FetchErrorResponse} obj Optional instance to populate.
     * @return {module:model/FetchErrorResponse} The populated <code>FetchErrorResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new FetchErrorResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>FetchErrorResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>FetchErrorResponse</code>.
     */
 ...
 */
FetchErrorResponse.prototype['errors'] = undefined;

/**
 * @member {module:model/FetchMetaResponse} meta
 */
FetchErrorResponse.prototype['meta'] = undefined;
...
export default FetchErrorResponse;
