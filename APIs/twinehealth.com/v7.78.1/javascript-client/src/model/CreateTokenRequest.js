...
class CreateTokenRequest {
     ...
     * @param data {module:model/CreateTokenRequestData} 
     */
    constructor(data) { 
        
        CreateTokenRequest.initialize(this, data);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('data')) {
                obj['data'] = CreateTokenRequestData.constructFromObject(data['data']);
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        if (data['data']) { // data not null
          CreateTokenRequestData.validateJSON(data['data']);
        }
...
CreateTokenRequest.RequiredProperties = ["data"];

/**
 * @member {module:model/CreateTokenRequestData} data
 */
CreateTokenRequest.prototype['data'] = undefined;
