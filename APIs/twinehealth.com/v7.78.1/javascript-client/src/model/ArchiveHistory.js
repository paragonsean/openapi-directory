...
/**
 * The ArchiveHistory model module.
 * @module model/ArchiveHistory
 * @version v7.78.1
 */
class ArchiveHistory {
    /**
     * Constructs a new <code>ArchiveHistory</code>.
     * @alias module:model/ArchiveHistory
     */
    constructor() { 
        
        ArchiveHistory.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ArchiveHistory</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ArchiveHistory} obj Optional instance to populate.
     * @return {module:model/ArchiveHistory} The populated <code>ArchiveHistory</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ArchiveHistory();
    ...
    /**
     * Validates the JSON data with respect to <code>ArchiveHistory</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ArchiveHistory</code>.
     */
 ...
 */
ArchiveHistory.prototype['archived'] = undefined;

/**
 * @member {String} modified_at
 */
ArchiveHistory.prototype['modified_at'] = undefined;

/**
 * @member {String} notes
 */
ArchiveHistory.prototype['notes'] = undefined;

/**
 * @member {String} reason
 */
ArchiveHistory.prototype['reason'] = undefined;
