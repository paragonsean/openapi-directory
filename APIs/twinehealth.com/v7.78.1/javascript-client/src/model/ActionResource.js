...
import ActionResourceAttributes from './ActionResourceAttributes';
import ActionResourceRelationships from './ActionResourceRelationships';
...
class ActionResource {
    ...
    constructor(id, type) { 
        ...
        ActionResource.initialize(this, id, type);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('attributes')) {
                obj['attributes'] = ActionResourceAttributes.constructFromObject(data['attributes']);
            }
            if (data.hasOwnProperty('id')) {
                obj['id'] = ApiClient.convertToType(data['id'], 'String');
            }
            if (data.hasOwnProperty('relationships')) {
                obj['relationships'] = ActionResourceRelationships.constructFromObject(data['relationships']);
            }
    ...
    static validateJSON(data) {
        ...
        for (const property of ActionResource.RequiredProperties) {
        ...
        if (data['attributes']) { // data not null
          ActionResourceAttributes.validateJSON(data['attributes']);
        }
        ...
        if (data['relationships']) { // data not null
          ActionResourceRelationships.validateJSON(data['relationships']);
        }
        // ensure the json data is a string
...
ActionResource.RequiredProperties = ["id", "type"];

/**
 * @member {module:model/ActionResourceAttributes} attributes
 */
ActionResource.prototype['attributes'] = undefined;

/**
 * @member {String} id
 */
ActionResource.prototype['id'] = undefined;

/**
 * @member {module:model/ActionResourceRelationships} relationships
 */
ActionResource.prototype['relationships'] = undefined;

/**
 * @member {String} type
 */
ActionResource.prototype['type'] = undefined;
