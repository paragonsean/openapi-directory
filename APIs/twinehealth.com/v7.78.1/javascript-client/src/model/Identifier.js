...
class Identifier {
    ...
    constructor(system, value) { 
        ...
        Identifier.initialize(this, system, value);
    }
...
Identifier.RequiredProperties = ["system", "value"];

/**
 * @member {String} label
 */
Identifier.prototype['label'] = undefined;

/**
 * @member {String} system
 */
Identifier.prototype['system'] = undefined;
