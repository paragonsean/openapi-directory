...
/**
 * The FetchCalendarEventResponse model module.
 * @module model/FetchCalendarEventResponse
 * @version v7.78.1
 */
class FetchCalendarEventResponse {
    /**
     * Constructs a new <code>FetchCalendarEventResponse</code>.
     * @alias module:model/FetchCalendarEventResponse
     */
    constructor() { 
        
        FetchCalendarEventResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>FetchCalendarEventResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/FetchCalendarEventResponse} obj Optional instance to populate.
     * @return {module:model/FetchCalendarEventResponse} The populated <code>FetchCalendarEventResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new FetchCalendarEventResponse();

            if (data.hasOwnProperty('data')) {
                obj['data'] = CalendarEventResource.constructFromObject(data['data']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>FetchCalendarEventResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>FetchCalendarEventResponse</code>.
     */
    static validateJSON(data) {
        // validate the optional field `data`
        if (data['data']) { // data not null
          CalendarEventResource.validateJSON(data['data']);
        }
...
/**
 * @member {module:model/CalendarEventResource} data
 */
FetchCalendarEventResponse.prototype['data'] = undefined;
 ...
 */
FetchCalendarEventResponse.prototype['included'] = undefined;

/**
 * @member {module:model/FetchMetaResponse} meta
 */
FetchCalendarEventResponse.prototype['meta'] = undefined;
...
export default FetchCalendarEventResponse;
