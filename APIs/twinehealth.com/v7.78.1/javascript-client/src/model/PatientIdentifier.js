...
/**
 * The PatientIdentifier model module.
 * @module model/PatientIdentifier
 * @version v7.78.1
 */
class PatientIdentifier {
    /**
     * Constructs a new <code>PatientIdentifier</code>.
     * @alias module:model/PatientIdentifier
     * @param system {String} 
     * @param value {String} 
     */
    constructor(system, value) { 
        
        PatientIdentifier.initialize(this, system, value);
    }
    ...
    /**
     * Constructs a <code>PatientIdentifier</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PatientIdentifier} obj Optional instance to populate.
     * @return {module:model/PatientIdentifier} The populated <code>PatientIdentifier</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PatientIdentifier();
    ...
    /**
     * Validates the JSON data with respect to <code>PatientIdentifier</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PatientIdentifier</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of PatientIdentifier.RequiredProperties) {
...
PatientIdentifier.RequiredProperties = ["system", "value"];

/**
 * @member {String} label
 */
PatientIdentifier.prototype['label'] = undefined;

/**
 * @member {String} system
 */
PatientIdentifier.prototype['system'] = undefined;
 ...
 * @default true
 */
PatientIdentifier.prototype['unique'] = true;

/**
 * @member {String} value
 */
PatientIdentifier.prototype['value'] = undefined;
