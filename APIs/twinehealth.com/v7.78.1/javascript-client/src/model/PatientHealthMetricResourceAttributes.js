...
/**
 * The PatientHealthMetricResourceAttributes model module.
 * @module model/PatientHealthMetricResourceAttributes
 * @version v7.78.1
 */
class PatientHealthMetricResourceAttributes {
    /**
     * Constructs a new <code>PatientHealthMetricResourceAttributes</code>.
     * @alias module:model/PatientHealthMetricResourceAttributes
     */
    constructor() { 
        
        PatientHealthMetricResourceAttributes.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PatientHealthMetricResourceAttributes</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PatientHealthMetricResourceAttributes} obj Optional instance to populate.
     * @return {module:model/PatientHealthMetricResourceAttributes} The populated <code>PatientHealthMetricResourceAttributes</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PatientHealthMetricResourceAttributes();

            if (data.hasOwnProperty('code')) {
                obj['code'] = PatientHealthMetricResourceAttributesCode.constructFromObject(data['code']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>PatientHealthMetricResourceAttributes</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PatientHealthMetricResourceAttributes</code>.
     */
    static validateJSON(data) {
        // validate the optional field `code`
        if (data['code']) { // data not null
          PatientHealthMetricResourceAttributesCode.validateJSON(data['code']);
        }
...
/**
 * @member {module:model/PatientHealthMetricResourceAttributesCode} code
 */
PatientHealthMetricResourceAttributes.prototype['code'] = undefined;

/**
 * @member {Number} diastolic
 */
PatientHealthMetricResourceAttributes.prototype['diastolic'] = undefined;

/**
 * @member {String} occurred_at
 */
PatientHealthMetricResourceAttributes.prototype['occurred_at'] = undefined;

/**
 * @member {Number} systolic
 */
PatientHealthMetricResourceAttributes.prototype['systolic'] = undefined;

/**
 * @member {module:model/PatientHealthMetricResourceAttributes.TypeEnum} type
 */
PatientHealthMetricResourceAttributes.prototype['type'] = undefined;

/**
 * @member {String} unit
 */
PatientHealthMetricResourceAttributes.prototype['unit'] = undefined;

/**
 * Can be any value (number, boolean, string, object) depending on the metric type. Most values are of type number.
 * @member {Object} value
 */
PatientHealthMetricResourceAttributes.prototype['value'] = undefined;
 ...
 * @readonly
 */
PatientHealthMetricResourceAttributes['TypeEnum'] = {
...
export default PatientHealthMetricResourceAttributes;
