...
class PhoneNumber {
     ...
     * @param type {module:model/PhoneNumber.TypeEnum} 
     * @param value {String} 
     */
    constructor(primary, type, value) { 
        
        PhoneNumber.initialize(this, primary, type, value);
    }
     ...
     */
    static initialize(obj, primary, type, value) { 
        obj['primary'] = primary;
        obj['type'] = type;
        obj['value'] = value;
    }
...
PhoneNumber.RequiredProperties = ["primary", "type", "value"];
