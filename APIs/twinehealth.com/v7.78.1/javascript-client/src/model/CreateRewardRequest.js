...
class CreateRewardRequest {
    ...
    constructor(data) { 
        ...
        CreateRewardRequest.initialize(this, data);
    }
    ...
    /**
     * Validates the JSON data with respect to <code>CreateRewardRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateRewardRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CreateRewardRequest.RequiredProperties) {
...
CreateRewardRequest.RequiredProperties = ["data"];

/**
 * @member {module:model/RewardResource} data
 */
CreateRewardRequest.prototype['data'] = undefined;
