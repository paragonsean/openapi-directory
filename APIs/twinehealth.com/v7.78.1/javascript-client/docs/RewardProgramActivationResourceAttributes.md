# FitbitPlusApi.RewardProgramActivationResourceAttributes
...
**active** | **Boolean** | If true, the reward program is currently active. | [optional] [default to true]
**allocatedCount** | **Number** | Number of rewards allocated. (Read-only property) | [optional] [readonly] 
...
**earnedCount** | **Number** | Number of reward earnings. (Read-only property) | [optional] [readonly] 
...
**totalAllocatedValue** | **Number** | Total value of reward allocated. (Read-only property) | [optional] [readonly] 
**totalEarnedValue** | **Number** | Total value of reward earnings. (Read-only property) | [optional] [readonly] 
