# FitbitPlusApi.CalendarEventResourceAttributes
...
**attendees** | [**[CalendarEventResourceAttributesAttendeesInner]**](CalendarEventResourceAttributesAttendeesInner.md) | List of attendees for the calendar event | [optional] 
...
**type** | **String** | The type of calendar event. Immutable after event creation. | [optional] 
...
* `plan-check-in` (value: `"plan-check-in"`)

* `reminder` (value: `"reminder"`)

* `telephone-call` (value: `"telephone-call"`)

* `office-visit` (value: `"office-visit"`)

* `video-call` (value: `"video-call"`)
