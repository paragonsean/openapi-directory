...
class CopyMessagePostRequestReplyMarkup(Model):
    ...
    def __init__(self, inline_keyboard: List[List[InlineKeyboardButton]]=None, keyboard: List[List[KeyboardButton]]=None, one_time_keyboard: bool=False, resize_keyboard: bool=False, selective: bool=None, remove_keyboard: bool=None, force_reply: bool=None):
        """CopyMessagePostRequestReplyMarkup - a model defined in OpenAPI

        :param inline_keyboard: The inline_keyboard of this CopyMessagePostRequestReplyMarkup.
        :param keyboard: The keyboard of this CopyMessagePostRequestReplyMarkup.
        :param one_time_keyboard: The one_time_keyboard of this CopyMessagePostRequestReplyMarkup.
        :param resize_keyboard: The resize_keyboard of this CopyMessagePostRequestReplyMarkup.
        :param selective: The selective of this CopyMessagePostRequestReplyMarkup.
        :param remove_keyboard: The remove_keyboard of this CopyMessagePostRequestReplyMarkup.
        :param force_reply: The force_reply of this CopyMessagePostRequestReplyMarkup.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'CopyMessagePostRequestReplyMarkup':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The _copyMessage_post_request_reply_markup of this CopyMessagePostRequestReplyMarkup.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def inline_keyboard(self):
        """Gets the inline_keyboard of this CopyMessagePostRequestReplyMarkup.

        Array of button rows, each represented by an Array of [InlineKeyboardButton](https://core.telegram.org/bots/api/#inlinekeyboardbutton) objects

        :return: The inline_keyboard of this CopyMessagePostRequestReplyMarkup.
    ...
    def inline_keyboard(self, inline_keyboard):
        """Sets the inline_keyboard of this CopyMessagePostRequestReplyMarkup.
    ...
    @property
    def keyboard(self):
        """Gets the keyboard of this CopyMessagePostRequestReplyMarkup.

        Array of button rows, each represented by an Array of [KeyboardButton](https://core.telegram.org/bots/api/#keyboardbutton) objects

        :return: The keyboard of this CopyMessagePostRequestReplyMarkup.
    ...
    def keyboard(self, keyboard):
        """Sets the keyboard of this CopyMessagePostRequestReplyMarkup.
    ...
    def one_time_keyboard(self):
        """Gets the one_time_keyboard of this CopyMessagePostRequestReplyMarkup.

        *Optional*. Requests clients to hide the keyboard as soon as it's been used. The keyboard will still be available, but clients will automatically display the usual letter-keyboard in the chat – the user can press a special button in the input field to see the custom keyboard again. Defaults to *false*.

        :return: The one_time_keyboard of this CopyMessagePostRequestReplyMarkup.
        :rtype: bool
        """
    ...
    def one_time_keyboard(self, one_time_keyboard):
        """Sets the one_time_keyboard of this CopyMessagePostRequestReplyMarkup.
    ...
    def resize_keyboard(self):
        """Gets the resize_keyboard of this CopyMessagePostRequestReplyMarkup.

        *Optional*. Requests clients to resize the keyboard vertically for optimal fit (e.g., make the keyboard smaller if there are just two rows of buttons). Defaults to *false*, in which case the custom keyboard is always of the same height as the app's standard keyboard.

        :return: The resize_keyboard of this CopyMessagePostRequestReplyMarkup.
        :rtype: bool
        """
    ...
    def resize_keyboard(self, resize_keyboard):
        """Sets the resize_keyboard of this CopyMessagePostRequestReplyMarkup.
    ...
    @property
    def selective(self):
        """Gets the selective of this CopyMessagePostRequestReplyMarkup.
        ...
        *Optional*. Use this parameter if you want to force reply from specific users only. Targets: 1) users that are @mentioned in the *text* of the [Message](https://core.telegram.org/bots/api/#message) object; 2) if the bot's message is a reply (has *reply\\_to\\_message\\_id*), sender of the original message.
        ...
        :return: The selective of this CopyMessagePostRequestReplyMarkup.
        :rtype: bool
        """
    ...
    def selective(self, selective):
        """Sets the selective of this CopyMessagePostRequestReplyMarkup.
    ...
    def remove_keyboard(self):
        """Gets the remove_keyboard of this CopyMessagePostRequestReplyMarkup.
        ...
        :return: The remove_keyboard of this CopyMessagePostRequestReplyMarkup.
        :rtype: bool
        """
    ...
    def remove_keyboard(self, remove_keyboard):
        """Sets the remove_keyboard of this CopyMessagePostRequestReplyMarkup.
    ...
    def force_reply(self):
        """Gets the force_reply of this CopyMessagePostRequestReplyMarkup.

        Shows reply interface to the user, as if they manually selected the bot's message and tapped 'Reply'

        :return: The force_reply of this CopyMessagePostRequestReplyMarkup.
        :rtype: bool
        """
    ...
    def force_reply(self, force_reply):
        """Sets the force_reply of this CopyMessagePostRequestReplyMarkup.
