...
/*
 * OAIInlineQueryResultCachedVideo.h
 *
...
#ifndef OAIInlineQueryResultCachedVideo_H
#define OAIInlineQueryResultCachedVideo_H
...
class OAIInlineQueryResultCachedVideo : public OAIObject {
public:
    OAIInlineQueryResultCachedVideo();
    OAIInlineQueryResultCachedVideo(QString json);
    ~OAIInlineQueryResultCachedVideo() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIInlineQueryResultCachedVideo)

#endif // OAIInlineQueryResultCachedVideo_H
