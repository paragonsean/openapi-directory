...
OAI_copyMessage_post_request_chat_id OAI_pinChatMessage_post_request::getChatId() const {
    return m_chat_id;
}
void OAI_pinChatMessage_post_request::setChatId(const OAI_copyMessage_post_request_chat_id &chat_id) {
    m_chat_id = chat_id;
