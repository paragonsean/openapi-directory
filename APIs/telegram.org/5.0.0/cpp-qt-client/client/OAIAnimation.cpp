...
OAIPhotoSize OAIAnimation::getThumb() const {
    return m_thumb;
}
void OAIAnimation::setThumb(const OAIPhotoSize &thumb) {
    m_thumb = thumb;
    m_thumb_isSet = true;
}

bool OAIAnimation::is_thumb_Set() const{
    return m_thumb_isSet;
}

bool OAIAnimation::is_thumb_Valid() const{
