...
/*
 * OAIInlineQueryResultCachedPhoto.h
 *
...
#ifndef OAIInlineQueryResultCachedPhoto_H
#define OAIInlineQueryResultCachedPhoto_H
...
class OAIInlineQueryResultCachedPhoto : public OAIObject {
public:
    OAIInlineQueryResultCachedPhoto();
    OAIInlineQueryResultCachedPhoto(QString json);
    ~OAIInlineQueryResultCachedPhoto() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIInlineQueryResultCachedPhoto)

#endif // OAIInlineQueryResultCachedPhoto_H
