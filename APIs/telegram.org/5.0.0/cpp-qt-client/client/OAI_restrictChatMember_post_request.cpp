...
OAI_deleteChatStickerSet_post_request_chat_id OAI_restrictChatMember_post_request::getChatId() const {
    return m_chat_id;
}
void OAI_restrictChatMember_post_request::setChatId(const OAI_deleteChatStickerSet_post_request_chat_id &chat_id) {
    m_chat_id = chat_id;
...
bool OAI_restrictChatMember_post_request::isValid() const {
    ...
    return m_chat_id_isValid && m_permissions_isValid && m_user_id_isValid && true;
}
