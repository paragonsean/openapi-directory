...
/*
 * OAI_sendContact_post_request_reply_markup.h
 *
...
#ifndef OAI_sendContact_post_request_reply_markup_H
#define OAI_sendContact_post_request_reply_markup_H
...
class OAI_sendContact_post_request_reply_markup : public OAIObject {
public:
    OAI_sendContact_post_request_reply_markup();
    OAI_sendContact_post_request_reply_markup(QString json);
    ~OAI_sendContact_post_request_reply_markup() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAI_sendContact_post_request_reply_markup)

#endif // OAI_sendContact_post_request_reply_markup_H
