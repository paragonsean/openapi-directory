...
|**captionEntities** | [**List&lt;MessageEntity&gt;**](MessageEntity.md) | List of special entities that appear in the new caption, which can be specified instead of *parse\\_mode* |  [optional] |
