...
public class InlineQueryResultCachedVoice {
  ...
  public static final String SERIALIZED_NAME_VOICE_FILE_ID = "voice_file_id";
  @SerializedName(SERIALIZED_NAME_VOICE_FILE_ID)
  ...
  public InlineQueryResultCachedVoice addCaptionEntitiesItem(MessageEntity captionEntitiesItem) {
  ...
  public InlineQueryResultCachedVoice id(String id) {
    this.id = id;
    return this;
  }
  ...
  public InlineQueryResultCachedVoice inputMessageContent(InputMessageContent inputMessageContent) {
  ...
  public InlineQueryResultCachedVoice parseMode(String parseMode) {
  ...
  public InlineQueryResultCachedVoice replyMarkup(InlineKeyboardMarkup replyMarkup) {
  ...
  public InlineQueryResultCachedVoice title(String title) {
    this.title = title;
    return this;
  }
  ...
  public InlineQueryResultCachedVoice type(String type) {
    this.type = type;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    InlineQueryResultCachedVoice inlineQueryResultCachedVoice = (InlineQueryResultCachedVoice) o;
    return Objects.equals(this.caption, inlineQueryResultCachedVoice.caption) &&
        Objects.equals(this.captionEntities, inlineQueryResultCachedVoice.captionEntities) &&
        Objects.equals(this.id, inlineQueryResultCachedVoice.id) &&
        Objects.equals(this.inputMessageContent, inlineQueryResultCachedVoice.inputMessageContent) &&
        Objects.equals(this.parseMode, inlineQueryResultCachedVoice.parseMode) &&
        Objects.equals(this.replyMarkup, inlineQueryResultCachedVoice.replyMarkup) &&
        Objects.equals(this.title, inlineQueryResultCachedVoice.title) &&
        Objects.equals(this.type, inlineQueryResultCachedVoice.type) &&
        Objects.equals(this.voiceFileId, inlineQueryResultCachedVoice.voiceFileId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(caption, captionEntities, id, inputMessageContent, parseMode, replyMarkup, title, type, voiceFileId);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class InlineQueryResultCachedVoice {\n");
    ...
    sb.append("    voiceFileId: ").append(toIndentedString(voiceFileId)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("voice_file_id");
    ...
    openapiRequiredFields.add("voice_file_id");
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to InlineQueryResultCachedVoice
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!InlineQueryResultCachedVoice.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in InlineQueryResultCachedVoice is not found in the empty JSON string", InlineQueryResultCachedVoice.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!InlineQueryResultCachedVoice.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `InlineQueryResultCachedVoice` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : InlineQueryResultCachedVoice.openapiRequiredFields) {
      ...
      if (!jsonObj.get("voice_file_id").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `voice_file_id` to be a primitive type in the JSON string but got `%s`", jsonObj.get("voice_file_id").toString()));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!InlineQueryResultCachedVoice.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'InlineQueryResultCachedVoice' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<InlineQueryResultCachedVoice> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(InlineQueryResultCachedVoice.class));

       return (TypeAdapter<T>) new TypeAdapter<InlineQueryResultCachedVoice>() {
           @Override
           public void write(JsonWriter out, InlineQueryResultCachedVoice value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public InlineQueryResultCachedVoice read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of InlineQueryResultCachedVoice given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of InlineQueryResultCachedVoice
   * @throws IOException if the JSON string is invalid with respect to InlineQueryResultCachedVoice
   */
  public static InlineQueryResultCachedVoice fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, InlineQueryResultCachedVoice.class);
  }

  /**
   * Convert an instance of InlineQueryResultCachedVoice to an JSON string
   *
   * @return JSON string
   */
