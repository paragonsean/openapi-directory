...
public class InlineQueryResultPhoto {
  ...
  public InlineQueryResultPhoto addCaptionEntitiesItem(MessageEntity captionEntitiesItem) {
  ...
  public InlineQueryResultPhoto id(String id) {
    this.id = id;
    return this;
  }
  ...
  public InlineQueryResultPhoto inputMessageContent(InputMessageContent inputMessageContent) {
  ...
  public InlineQueryResultPhoto parseMode(String parseMode) {
  ...
  public InlineQueryResultPhoto replyMarkup(InlineKeyboardMarkup replyMarkup) {
  ...
  public InlineQueryResultPhoto thumbUrl(String thumbUrl) {
  ...
  public InlineQueryResultPhoto type(String type) {
    this.type = type;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    InlineQueryResultPhoto inlineQueryResultPhoto = (InlineQueryResultPhoto) o;
    return Objects.equals(this.caption, inlineQueryResultPhoto.caption) &&
        Objects.equals(this.captionEntities, inlineQueryResultPhoto.captionEntities) &&
        Objects.equals(this.description, inlineQueryResultPhoto.description) &&
        Objects.equals(this.id, inlineQueryResultPhoto.id) &&
        Objects.equals(this.inputMessageContent, inlineQueryResultPhoto.inputMessageContent) &&
        Objects.equals(this.parseMode, inlineQueryResultPhoto.parseMode) &&
        Objects.equals(this.photoHeight, inlineQueryResultPhoto.photoHeight) &&
        Objects.equals(this.photoUrl, inlineQueryResultPhoto.photoUrl) &&
        Objects.equals(this.photoWidth, inlineQueryResultPhoto.photoWidth) &&
        Objects.equals(this.replyMarkup, inlineQueryResultPhoto.replyMarkup) &&
        Objects.equals(this.thumbUrl, inlineQueryResultPhoto.thumbUrl) &&
        Objects.equals(this.title, inlineQueryResultPhoto.title) &&
        Objects.equals(this.type, inlineQueryResultPhoto.type);
  }

  @Override
  public int hashCode() {
    return Objects.hash(caption, captionEntities, description, id, inputMessageContent, parseMode, photoHeight, photoUrl, photoWidth, replyMarkup, thumbUrl, title, type);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class InlineQueryResultPhoto {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to InlineQueryResultPhoto
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!InlineQueryResultPhoto.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in InlineQueryResultPhoto is not found in the empty JSON string", InlineQueryResultPhoto.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!InlineQueryResultPhoto.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `InlineQueryResultPhoto` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : InlineQueryResultPhoto.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!InlineQueryResultPhoto.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'InlineQueryResultPhoto' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<InlineQueryResultPhoto> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(InlineQueryResultPhoto.class));

       return (TypeAdapter<T>) new TypeAdapter<InlineQueryResultPhoto>() {
           @Override
           public void write(JsonWriter out, InlineQueryResultPhoto value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public InlineQueryResultPhoto read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of InlineQueryResultPhoto given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of InlineQueryResultPhoto
   * @throws IOException if the JSON string is invalid with respect to InlineQueryResultPhoto
   */
  public static InlineQueryResultPhoto fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, InlineQueryResultPhoto.class);
  }

  /**
   * Convert an instance of InlineQueryResultPhoto to an JSON string
   *
   * @return JSON string
   */
