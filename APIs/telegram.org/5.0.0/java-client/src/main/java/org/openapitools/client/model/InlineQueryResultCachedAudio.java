...
public class InlineQueryResultCachedAudio {
  public static final String SERIALIZED_NAME_AUDIO_FILE_ID = "audio_file_id";
  ...
  public InlineQueryResultCachedAudio addCaptionEntitiesItem(MessageEntity captionEntitiesItem) {
  ...
  public InlineQueryResultCachedAudio id(String id) {
    this.id = id;
    return this;
  }
  ...
  public InlineQueryResultCachedAudio inputMessageContent(InputMessageContent inputMessageContent) {
  ...
  public InlineQueryResultCachedAudio parseMode(String parseMode) {
  ...
  public InlineQueryResultCachedAudio replyMarkup(InlineKeyboardMarkup replyMarkup) {
  ...
  public InlineQueryResultCachedAudio type(String type) {
    this.type = type;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    InlineQueryResultCachedAudio inlineQueryResultCachedAudio = (InlineQueryResultCachedAudio) o;
    return Objects.equals(this.audioFileId, inlineQueryResultCachedAudio.audioFileId) &&
        Objects.equals(this.caption, inlineQueryResultCachedAudio.caption) &&
        Objects.equals(this.captionEntities, inlineQueryResultCachedAudio.captionEntities) &&
        Objects.equals(this.id, inlineQueryResultCachedAudio.id) &&
        Objects.equals(this.inputMessageContent, inlineQueryResultCachedAudio.inputMessageContent) &&
        Objects.equals(this.parseMode, inlineQueryResultCachedAudio.parseMode) &&
        Objects.equals(this.replyMarkup, inlineQueryResultCachedAudio.replyMarkup) &&
        Objects.equals(this.type, inlineQueryResultCachedAudio.type);
  }

  @Override
  public int hashCode() {
    return Objects.hash(audioFileId, caption, captionEntities, id, inputMessageContent, parseMode, replyMarkup, type);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class InlineQueryResultCachedAudio {\n");
  ...
  static {
    ...
    openapiFields.add("audio_file_id");
    ...
    openapiRequiredFields.add("audio_file_id");
   ...
   * @throws IOException if the JSON Element is invalid with respect to InlineQueryResultCachedAudio
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!InlineQueryResultCachedAudio.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in InlineQueryResultCachedAudio is not found in the empty JSON string", InlineQueryResultCachedAudio.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!InlineQueryResultCachedAudio.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `InlineQueryResultCachedAudio` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : InlineQueryResultCachedAudio.openapiRequiredFields) {
        if (jsonElement.getAsJsonObject().get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      if (!jsonObj.get("audio_file_id").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `audio_file_id` to be a primitive type in the JSON string but got `%s`", jsonObj.get("audio_file_id").toString()));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!InlineQueryResultCachedAudio.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'InlineQueryResultCachedAudio' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<InlineQueryResultCachedAudio> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(InlineQueryResultCachedAudio.class));

       return (TypeAdapter<T>) new TypeAdapter<InlineQueryResultCachedAudio>() {
           @Override
           public void write(JsonWriter out, InlineQueryResultCachedAudio value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public InlineQueryResultCachedAudio read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of InlineQueryResultCachedAudio given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of InlineQueryResultCachedAudio
   * @throws IOException if the JSON string is invalid with respect to InlineQueryResultCachedAudio
   */
  public static InlineQueryResultCachedAudio fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, InlineQueryResultCachedAudio.class);
  }

  /**
   * Convert an instance of InlineQueryResultCachedAudio to an JSON string
   *
   * @return JSON string
   */
