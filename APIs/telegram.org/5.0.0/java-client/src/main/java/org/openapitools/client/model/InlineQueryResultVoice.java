...
public class InlineQueryResultVoice {
  ...
  public static final String SERIALIZED_NAME_VOICE_DURATION = "voice_duration";
  @SerializedName(SERIALIZED_NAME_VOICE_DURATION)
  ...
  public InlineQueryResultVoice addCaptionEntitiesItem(MessageEntity captionEntitiesItem) {
  ...
  public InlineQueryResultVoice id(String id) {
    this.id = id;
    return this;
  }
  ...
  public InlineQueryResultVoice inputMessageContent(InputMessageContent inputMessageContent) {
  ...
  public InlineQueryResultVoice parseMode(String parseMode) {
  ...
  public InlineQueryResultVoice replyMarkup(InlineKeyboardMarkup replyMarkup) {
  ...
  public InlineQueryResultVoice title(String title) {
    this.title = title;
    return this;
  }
  ...
  public InlineQueryResultVoice type(String type) {
    this.type = type;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    InlineQueryResultVoice inlineQueryResultVoice = (InlineQueryResultVoice) o;
    return Objects.equals(this.caption, inlineQueryResultVoice.caption) &&
        Objects.equals(this.captionEntities, inlineQueryResultVoice.captionEntities) &&
        Objects.equals(this.id, inlineQueryResultVoice.id) &&
        Objects.equals(this.inputMessageContent, inlineQueryResultVoice.inputMessageContent) &&
        Objects.equals(this.parseMode, inlineQueryResultVoice.parseMode) &&
        Objects.equals(this.replyMarkup, inlineQueryResultVoice.replyMarkup) &&
        Objects.equals(this.title, inlineQueryResultVoice.title) &&
        Objects.equals(this.type, inlineQueryResultVoice.type) &&
        Objects.equals(this.voiceDuration, inlineQueryResultVoice.voiceDuration) &&
        Objects.equals(this.voiceUrl, inlineQueryResultVoice.voiceUrl);
  }

  @Override
  public int hashCode() {
    return Objects.hash(caption, captionEntities, id, inputMessageContent, parseMode, replyMarkup, title, type, voiceDuration, voiceUrl);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class InlineQueryResultVoice {\n");
    ...
    sb.append("    voiceDuration: ").append(toIndentedString(voiceDuration)).append("\n");
  ...
  static {
    ...
    openapiFields.add("voice_duration");
    ...
    openapiRequiredFields.add("voice_url");
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to InlineQueryResultVoice
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!InlineQueryResultVoice.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in InlineQueryResultVoice is not found in the empty JSON string", InlineQueryResultVoice.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!InlineQueryResultVoice.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `InlineQueryResultVoice` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : InlineQueryResultVoice.openapiRequiredFields) {
      ...
      if (!jsonObj.get("voice_url").isJsonPrimitive()) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!InlineQueryResultVoice.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'InlineQueryResultVoice' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<InlineQueryResultVoice> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(InlineQueryResultVoice.class));

       return (TypeAdapter<T>) new TypeAdapter<InlineQueryResultVoice>() {
           @Override
           public void write(JsonWriter out, InlineQueryResultVoice value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public InlineQueryResultVoice read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of InlineQueryResultVoice given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of InlineQueryResultVoice
   * @throws IOException if the JSON string is invalid with respect to InlineQueryResultVoice
   */
  public static InlineQueryResultVoice fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, InlineQueryResultVoice.class);
  }

  /**
   * Convert an instance of InlineQueryResultVoice to an JSON string
   *
   * @return JSON string
   */
