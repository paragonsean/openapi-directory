...
public class InlineQueryResultCachedVideo {
  ...
  public InlineQueryResultCachedVideo addCaptionEntitiesItem(MessageEntity captionEntitiesItem) {
  ...
  public InlineQueryResultCachedVideo id(String id) {
    this.id = id;
    return this;
  }
  ...
  public InlineQueryResultCachedVideo inputMessageContent(InputMessageContent inputMessageContent) {
  ...
  public InlineQueryResultCachedVideo parseMode(String parseMode) {
  ...
  public InlineQueryResultCachedVideo replyMarkup(InlineKeyboardMarkup replyMarkup) {
  ...
  public InlineQueryResultCachedVideo title(String title) {
    this.title = title;
    return this;
  }
  ...
  public InlineQueryResultCachedVideo type(String type) {
    this.type = type;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    InlineQueryResultCachedVideo inlineQueryResultCachedVideo = (InlineQueryResultCachedVideo) o;
    return Objects.equals(this.caption, inlineQueryResultCachedVideo.caption) &&
        Objects.equals(this.captionEntities, inlineQueryResultCachedVideo.captionEntities) &&
        Objects.equals(this.description, inlineQueryResultCachedVideo.description) &&
        Objects.equals(this.id, inlineQueryResultCachedVideo.id) &&
        Objects.equals(this.inputMessageContent, inlineQueryResultCachedVideo.inputMessageContent) &&
        Objects.equals(this.parseMode, inlineQueryResultCachedVideo.parseMode) &&
        Objects.equals(this.replyMarkup, inlineQueryResultCachedVideo.replyMarkup) &&
        Objects.equals(this.title, inlineQueryResultCachedVideo.title) &&
        Objects.equals(this.type, inlineQueryResultCachedVideo.type) &&
        Objects.equals(this.videoFileId, inlineQueryResultCachedVideo.videoFileId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(caption, captionEntities, description, id, inputMessageContent, parseMode, replyMarkup, title, type, videoFileId);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class InlineQueryResultCachedVideo {\n");
  ...
  static {
    ...
    openapiRequiredFields.add("video_file_id");
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to InlineQueryResultCachedVideo
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!InlineQueryResultCachedVideo.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in InlineQueryResultCachedVideo is not found in the empty JSON string", InlineQueryResultCachedVideo.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!InlineQueryResultCachedVideo.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `InlineQueryResultCachedVideo` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : InlineQueryResultCachedVideo.openapiRequiredFields) {
      ...
      if (!jsonObj.get("video_file_id").isJsonPrimitive()) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!InlineQueryResultCachedVideo.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'InlineQueryResultCachedVideo' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<InlineQueryResultCachedVideo> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(InlineQueryResultCachedVideo.class));

       return (TypeAdapter<T>) new TypeAdapter<InlineQueryResultCachedVideo>() {
           @Override
           public void write(JsonWriter out, InlineQueryResultCachedVideo value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public InlineQueryResultCachedVideo read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of InlineQueryResultCachedVideo given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of InlineQueryResultCachedVideo
   * @throws IOException if the JSON string is invalid with respect to InlineQueryResultCachedVideo
   */
  public static InlineQueryResultCachedVideo fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, InlineQueryResultCachedVideo.class);
  }

  /**
   * Convert an instance of InlineQueryResultCachedVideo to an JSON string
   *
   * @return JSON string
   */
