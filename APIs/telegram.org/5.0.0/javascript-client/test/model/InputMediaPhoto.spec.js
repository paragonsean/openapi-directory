...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TelegramBotApi.InputMediaPhoto();
  });
  ...
  describe('InputMediaPhoto', function() {
    it('should create an instance of InputMediaPhoto', function() {
      // uncomment below and update the code to test InputMediaPhoto
      //var instance = new TelegramBotApi.InputMediaPhoto();
      //expect(instance).to.be.a(TelegramBotApi.InputMediaPhoto);
    });
