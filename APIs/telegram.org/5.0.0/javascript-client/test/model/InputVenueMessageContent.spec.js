...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TelegramBotApi.InputVenueMessageContent();
  });
  ...
  describe('InputVenueMessageContent', function() {
    it('should create an instance of InputVenueMessageContent', function() {
      // uncomment below and update the code to test InputVenueMessageContent
      //var instance = new TelegramBotApi.InputVenueMessageContent();
      //expect(instance).to.be.a(TelegramBotApi.InputVenueMessageContent);
    });
