...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TelegramBotApi.InlineQueryResultMpeg4Gif();
  });
  ...
  describe('InlineQueryResultMpeg4Gif', function() {
    it('should create an instance of InlineQueryResultMpeg4Gif', function() {
      // uncomment below and update the code to test InlineQueryResultMpeg4Gif
      //var instance = new TelegramBotApi.InlineQueryResultMpeg4Gif();
      //expect(instance).to.be.a(TelegramBotApi.InlineQueryResultMpeg4Gif);
    });
