...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TelegramBotApi.InlineQueryResultCachedVoice();
  });
  ...
  describe('InlineQueryResultCachedVoice', function() {
    it('should create an instance of InlineQueryResultCachedVoice', function() {
      // uncomment below and update the code to test InlineQueryResultCachedVoice
      //var instance = new TelegramBotApi.InlineQueryResultCachedVoice();
      //expect(instance).to.be.a(TelegramBotApi.InlineQueryResultCachedVoice);
    });
