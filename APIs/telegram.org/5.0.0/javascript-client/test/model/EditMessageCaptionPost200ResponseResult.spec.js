...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TelegramBotApi.EditMessageCaptionPost200ResponseResult();
  });
  ...
  describe('EditMessageCaptionPost200ResponseResult', function() {
    it('should create an instance of EditMessageCaptionPost200ResponseResult', function() {
      // uncomment below and update the code to test EditMessageCaptionPost200ResponseResult
      //var instance = new TelegramBotApi.EditMessageCaptionPost200ResponseResult();
      //expect(instance).to.be.a(TelegramBotApi.EditMessageCaptionPost200ResponseResult);
    });
