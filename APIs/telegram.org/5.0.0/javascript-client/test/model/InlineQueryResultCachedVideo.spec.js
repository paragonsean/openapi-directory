...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TelegramBotApi.InlineQueryResultCachedVideo();
  });
  ...
  describe('InlineQueryResultCachedVideo', function() {
    it('should create an instance of InlineQueryResultCachedVideo', function() {
      // uncomment below and update the code to test InlineQueryResultCachedVideo
      //var instance = new TelegramBotApi.InlineQueryResultCachedVideo();
      //expect(instance).to.be.a(TelegramBotApi.InlineQueryResultCachedVideo);
    });
