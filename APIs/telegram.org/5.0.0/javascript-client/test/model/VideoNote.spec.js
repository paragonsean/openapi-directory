...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TelegramBotApi.VideoNote();
  });
  ...
  describe('VideoNote', function() {
    it('should create an instance of VideoNote', function() {
      // uncomment below and update the code to test VideoNote
      //var instance = new TelegramBotApi.VideoNote();
      //expect(instance).to.be.a(TelegramBotApi.VideoNote);
    });
