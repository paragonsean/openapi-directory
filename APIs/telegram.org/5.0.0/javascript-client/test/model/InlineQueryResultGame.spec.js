...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TelegramBotApi.InlineQueryResultGame();
  });
  ...
  describe('InlineQueryResultGame', function() {
    it('should create an instance of InlineQueryResultGame', function() {
      // uncomment below and update the code to test InlineQueryResultGame
      //var instance = new TelegramBotApi.InlineQueryResultGame();
      //expect(instance).to.be.a(TelegramBotApi.InlineQueryResultGame);
    });
