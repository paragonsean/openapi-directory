...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TelegramBotApi.InputLocationMessageContent();
  });
  ...
  describe('InputLocationMessageContent', function() {
    it('should create an instance of InputLocationMessageContent', function() {
      // uncomment below and update the code to test InputLocationMessageContent
      //var instance = new TelegramBotApi.InputLocationMessageContent();
      //expect(instance).to.be.a(TelegramBotApi.InputLocationMessageContent);
    });
