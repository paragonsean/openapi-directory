...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TelegramBotApi.InlineQueryResultCachedGif();
  });
  ...
  describe('InlineQueryResultCachedGif', function() {
    it('should create an instance of InlineQueryResultCachedGif', function() {
      // uncomment below and update the code to test InlineQueryResultCachedGif
      //var instance = new TelegramBotApi.InlineQueryResultCachedGif();
      //expect(instance).to.be.a(TelegramBotApi.InlineQueryResultCachedGif);
    });
