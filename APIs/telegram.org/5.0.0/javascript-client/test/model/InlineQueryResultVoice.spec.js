...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TelegramBotApi.InlineQueryResultVoice();
  });
  ...
  describe('InlineQueryResultVoice', function() {
    it('should create an instance of InlineQueryResultVoice', function() {
      // uncomment below and update the code to test InlineQueryResultVoice
      //var instance = new TelegramBotApi.InlineQueryResultVoice();
      //expect(instance).to.be.a(TelegramBotApi.InlineQueryResultVoice);
    });
