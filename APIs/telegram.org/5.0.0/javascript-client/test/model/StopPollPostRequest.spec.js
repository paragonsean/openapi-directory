...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TelegramBotApi.StopPollPostRequest();
  });
  ...
  describe('StopPollPostRequest', function() {
    it('should create an instance of StopPollPostRequest', function() {
      // uncomment below and update the code to test StopPollPostRequest
      //var instance = new TelegramBotApi.StopPollPostRequest();
      //expect(instance).to.be.a(TelegramBotApi.StopPollPostRequest);
    });
