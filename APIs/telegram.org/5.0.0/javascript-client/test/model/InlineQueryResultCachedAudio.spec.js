...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TelegramBotApi.InlineQueryResultCachedAudio();
  });
  ...
  describe('InlineQueryResultCachedAudio', function() {
    it('should create an instance of InlineQueryResultCachedAudio', function() {
      // uncomment below and update the code to test InlineQueryResultCachedAudio
      //var instance = new TelegramBotApi.InlineQueryResultCachedAudio();
      //expect(instance).to.be.a(TelegramBotApi.InlineQueryResultCachedAudio);
    });
