...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TelegramBotApi.InlineQueryResultCachedMpeg4Gif();
  });
  ...
  describe('InlineQueryResultCachedMpeg4Gif', function() {
    it('should create an instance of InlineQueryResultCachedMpeg4Gif', function() {
      // uncomment below and update the code to test InlineQueryResultCachedMpeg4Gif
      //var instance = new TelegramBotApi.InlineQueryResultCachedMpeg4Gif();
      //expect(instance).to.be.a(TelegramBotApi.InlineQueryResultCachedMpeg4Gif);
    });
