...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TelegramBotApi.InputMediaVideo();
  });
  ...
  describe('InputMediaVideo', function() {
    it('should create an instance of InputMediaVideo', function() {
      // uncomment below and update the code to test InputMediaVideo
      //var instance = new TelegramBotApi.InputMediaVideo();
      //expect(instance).to.be.a(TelegramBotApi.InputMediaVideo);
    });
