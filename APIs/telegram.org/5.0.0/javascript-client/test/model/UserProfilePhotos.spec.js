...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TelegramBotApi.UserProfilePhotos();
  });
  ...
  describe('UserProfilePhotos', function() {
    it('should create an instance of UserProfilePhotos', function() {
      // uncomment below and update the code to test UserProfilePhotos
      //var instance = new TelegramBotApi.UserProfilePhotos();
      //expect(instance).to.be.a(TelegramBotApi.UserProfilePhotos);
    });
