...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TelegramBotApi.InlineQueryResultCachedDocument();
  });
  ...
  describe('InlineQueryResultCachedDocument', function() {
    it('should create an instance of InlineQueryResultCachedDocument', function() {
      // uncomment below and update the code to test InlineQueryResultCachedDocument
      //var instance = new TelegramBotApi.InlineQueryResultCachedDocument();
      //expect(instance).to.be.a(TelegramBotApi.InlineQueryResultCachedDocument);
    });
