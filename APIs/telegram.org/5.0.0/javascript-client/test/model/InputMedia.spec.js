...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TelegramBotApi.InputMedia();
  });
  ...
  describe('InputMedia', function() {
    it('should create an instance of InputMedia', function() {
      // uncomment below and update the code to test InputMedia
      //var instance = new TelegramBotApi.InputMedia();
      //expect(instance).to.be.a(TelegramBotApi.InputMedia);
    });
