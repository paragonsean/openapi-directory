...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TelegramBotApi.InlineQueryResultVideo();
  });
  ...
  describe('InlineQueryResultVideo', function() {
    it('should create an instance of InlineQueryResultVideo', function() {
      // uncomment below and update the code to test InlineQueryResultVideo
      //var instance = new TelegramBotApi.InlineQueryResultVideo();
      //expect(instance).to.be.a(TelegramBotApi.InlineQueryResultVideo);
    });
