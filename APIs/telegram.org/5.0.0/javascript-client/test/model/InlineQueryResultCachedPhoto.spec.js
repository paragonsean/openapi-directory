...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TelegramBotApi.InlineQueryResultCachedPhoto();
  });
  ...
  describe('InlineQueryResultCachedPhoto', function() {
    it('should create an instance of InlineQueryResultCachedPhoto', function() {
      // uncomment below and update the code to test InlineQueryResultCachedPhoto
      //var instance = new TelegramBotApi.InlineQueryResultCachedPhoto();
      //expect(instance).to.be.a(TelegramBotApi.InlineQueryResultCachedPhoto);
    });
