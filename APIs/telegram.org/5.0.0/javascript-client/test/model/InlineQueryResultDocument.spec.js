...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TelegramBotApi.InlineQueryResultDocument();
  });
  ...
  describe('InlineQueryResultDocument', function() {
    it('should create an instance of InlineQueryResultDocument', function() {
      // uncomment below and update the code to test InlineQueryResultDocument
      //var instance = new TelegramBotApi.InlineQueryResultDocument();
      //expect(instance).to.be.a(TelegramBotApi.InlineQueryResultDocument);
    });
