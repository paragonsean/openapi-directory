...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TelegramBotApi.InputMediaDocument();
  });
  ...
  describe('InputMediaDocument', function() {
    it('should create an instance of InputMediaDocument', function() {
      // uncomment below and update the code to test InputMediaDocument
      //var instance = new TelegramBotApi.InputMediaDocument();
      //expect(instance).to.be.a(TelegramBotApi.InputMediaDocument);
    });
