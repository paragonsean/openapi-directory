# TelegramBotApi.EditMessageCaptionPostRequest
...
**captionEntities** | [**[MessageEntity]**](MessageEntity.md) | List of special entities that appear in the caption, which can be specified instead of *parse\\_mode* | [optional] 
