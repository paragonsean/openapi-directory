...
**forwardText** | **String** | *Optional*. New text of the button in forwarded messages. | [optional] 
**requestWriteAccess** | **Boolean** | *Optional*. Pass True to request the permission for your bot to send messages to the user. | [optional] 
