# TelegramBotApi.StopMessageLiveLocationPostRequest
...
**messageId** | **Number** | Required if *inline\\_message\\_id* is not specified. Identifier of the message with live location to stop | [optional] 
