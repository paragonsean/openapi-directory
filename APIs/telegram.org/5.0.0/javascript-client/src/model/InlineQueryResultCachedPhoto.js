...
/**
 * The InlineQueryResultCachedPhoto model module.
 * @module model/InlineQueryResultCachedPhoto
 * @version 5.0.0
 */
class InlineQueryResultCachedPhoto {
    /**
     * Constructs a new <code>InlineQueryResultCachedPhoto</code>.
     ...
     * @alias module:model/InlineQueryResultCachedPhoto
     ...
     */
    constructor(id, photoFileId, type) { 
        
        InlineQueryResultCachedPhoto.initialize(this, id, photoFileId, type);
    }
     ...
     */
    static initialize(obj, id, photoFileId, type) { 
        obj['id'] = id;
        obj['photo_file_id'] = photoFileId;
        obj['type'] = type;
    }

    /**
     * Constructs a <code>InlineQueryResultCachedPhoto</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/InlineQueryResultCachedPhoto} obj Optional instance to populate.
     * @return {module:model/InlineQueryResultCachedPhoto} The populated <code>InlineQueryResultCachedPhoto</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new InlineQueryResultCachedPhoto();
            ...
            if (data.hasOwnProperty('photo_file_id')) {
                obj['photo_file_id'] = ApiClient.convertToType(data['photo_file_id'], 'String');
            }
    ...
    /**
     * Validates the JSON data with respect to <code>InlineQueryResultCachedPhoto</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>InlineQueryResultCachedPhoto</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of InlineQueryResultCachedPhoto.RequiredProperties) {
        ...
        // ensure the json data is a string
        if (data['photo_file_id'] && !(typeof data['photo_file_id'] === 'string' || data['photo_file_id'] instanceof String)) {
            throw new Error("Expected the field `photo_file_id` to be a primitive type in the JSON string but got " + data['photo_file_id']);
        }
...
InlineQueryResultCachedPhoto.RequiredProperties = ["id", "photo_file_id", "type"];

/**
 * *Optional*. Caption of the photo to be sent, 0-1024 characters after entities parsing
 * @member {String} caption
 */
InlineQueryResultCachedPhoto.prototype['caption'] = undefined;

/**
 * *Optional*. List of special entities that appear in the caption, which can be specified instead of *parse\\_mode*
 * @member {Array.<module:model/MessageEntity>} caption_entities
 */
InlineQueryResultCachedPhoto.prototype['caption_entities'] = undefined;

/**
 * *Optional*. Short description of the result
 * @member {String} description
 */
InlineQueryResultCachedPhoto.prototype['description'] = undefined;

/**
 * Unique identifier for this result, 1-64 bytes
 * @member {String} id
 */
InlineQueryResultCachedPhoto.prototype['id'] = undefined;

/**
 * @member {module:model/InputMessageContent} input_message_content
 */
InlineQueryResultCachedPhoto.prototype['input_message_content'] = undefined;

/**
 * *Optional*. Mode for parsing entities in the photo caption. See [formatting options](https://core.telegram.org/bots/api/#formatting-options) for more details.
 * @member {String} parse_mode
 */
InlineQueryResultCachedPhoto.prototype['parse_mode'] = undefined;

/**
 * A valid file identifier of the photo
 * @member {String} photo_file_id
 */
InlineQueryResultCachedPhoto.prototype['photo_file_id'] = undefined;

/**
 * @member {module:model/InlineKeyboardMarkup} reply_markup
 */
InlineQueryResultCachedPhoto.prototype['reply_markup'] = undefined;

/**
 * *Optional*. Title for the result
 * @member {String} title
 */
InlineQueryResultCachedPhoto.prototype['title'] = undefined;

/**
 * Type of the result, must be *photo*
 * @member {String} type
 */
InlineQueryResultCachedPhoto.prototype['type'] = undefined;
