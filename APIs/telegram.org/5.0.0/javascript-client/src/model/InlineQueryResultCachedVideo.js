...
/**
 * The InlineQueryResultCachedVideo model module.
 * @module model/InlineQueryResultCachedVideo
 * @version 5.0.0
 */
class InlineQueryResultCachedVideo {
    /**
     * Constructs a new <code>InlineQueryResultCachedVideo</code>.
     ...
     * @alias module:model/InlineQueryResultCachedVideo
     ...
     */
    constructor(id, title, type, videoFileId) { 
        
        InlineQueryResultCachedVideo.initialize(this, id, title, type, videoFileId);
    }
     ...
     */
    static initialize(obj, id, title, type, videoFileId) { 
        obj['id'] = id;
        obj['title'] = title;
        obj['type'] = type;
        obj['video_file_id'] = videoFileId;
    }

    /**
     * Constructs a <code>InlineQueryResultCachedVideo</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/InlineQueryResultCachedVideo} obj Optional instance to populate.
     * @return {module:model/InlineQueryResultCachedVideo} The populated <code>InlineQueryResultCachedVideo</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new InlineQueryResultCachedVideo();
            ...
            if (data.hasOwnProperty('video_file_id')) {
                obj['video_file_id'] = ApiClient.convertToType(data['video_file_id'], 'String');
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>InlineQueryResultCachedVideo</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>InlineQueryResultCachedVideo</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of InlineQueryResultCachedVideo.RequiredProperties) {
        ...
        // ensure the json data is a string
        if (data['video_file_id'] && !(typeof data['video_file_id'] === 'string' || data['video_file_id'] instanceof String)) {
            throw new Error("Expected the field `video_file_id` to be a primitive type in the JSON string but got " + data['video_file_id']);
        }
...
InlineQueryResultCachedVideo.RequiredProperties = ["id", "title", "type", "video_file_id"];

/**
 * *Optional*. Caption of the video to be sent, 0-1024 characters after entities parsing
 * @member {String} caption
 */
InlineQueryResultCachedVideo.prototype['caption'] = undefined;

/**
 * *Optional*. List of special entities that appear in the caption, which can be specified instead of *parse\\_mode*
 * @member {Array.<module:model/MessageEntity>} caption_entities
 */
InlineQueryResultCachedVideo.prototype['caption_entities'] = undefined;

/**
 * *Optional*. Short description of the result
 * @member {String} description
 */
InlineQueryResultCachedVideo.prototype['description'] = undefined;

/**
 * Unique identifier for this result, 1-64 bytes
 * @member {String} id
 */
InlineQueryResultCachedVideo.prototype['id'] = undefined;

/**
 * @member {module:model/InputMessageContent} input_message_content
 */
InlineQueryResultCachedVideo.prototype['input_message_content'] = undefined;

/**
 * *Optional*. Mode for parsing entities in the video caption. See [formatting options](https://core.telegram.org/bots/api/#formatting-options) for more details.
 * @member {String} parse_mode
 */
InlineQueryResultCachedVideo.prototype['parse_mode'] = undefined;

/**
 * @member {module:model/InlineKeyboardMarkup} reply_markup
 */
InlineQueryResultCachedVideo.prototype['reply_markup'] = undefined;

/**
 * Title for the result
 * @member {String} title
 */
InlineQueryResultCachedVideo.prototype['title'] = undefined;

/**
 * Type of the result, must be *video*
 * @member {String} type
 */
InlineQueryResultCachedVideo.prototype['type'] = undefined;

/**
 * A valid file identifier for the video file
 * @member {String} video_file_id
 */
InlineQueryResultCachedVideo.prototype['video_file_id'] = undefined;
