...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BillbeeApi.RechnungsdruckWebAppControllersApiInvoice();
  });
  ...
  describe('RechnungsdruckWebAppControllersApiInvoice', function() {
    it('should create an instance of RechnungsdruckWebAppControllersApiInvoice', function() {
      // uncomment below and update the code to test RechnungsdruckWebAppControllersApiInvoice
      //var instance = new BillbeeApi.RechnungsdruckWebAppControllersApiInvoice();
      //expect(instance).to.be.a(BillbeeApi.RechnungsdruckWebAppControllersApiInvoice);
    });
    ...
    it('should have the property pDFData (base name: "PDFData")', function() {
      // uncomment below and update the code to test the property pDFData
      //var instance = new BillbeeApi.RechnungsdruckWebAppControllersApiInvoice();
      //expect(instance).to.be();
    });

    it('should have the property pdfDownloadUrl (base name: "PdfDownloadUrl")', function() {
      // uncomment below and update the code to test the property pdfDownloadUrl
      //var instance = new BillbeeApi.RechnungsdruckWebAppControllersApiInvoice();
      //expect(instance).to.be();
    });
