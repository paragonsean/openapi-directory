...
public class ApiClient {
    ...
    private String basePath = "https://app.billbee.io";
    ...
    public ApiClient() {
        ...
        authentications.put("X-Billbee-Api-Key", new ApiKeyAuth("header", "X-Billbee-Api-Key"));
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://app.billbee.io
