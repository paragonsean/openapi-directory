...
|------------ | ------------- | ------------- | -------------|
|**data** | [**List&lt;BillbeeInterfacesBillbeeAPIModelArticleApiCustomFieldDefinitionModel&gt;**](BillbeeInterfacesBillbeeAPIModelArticleApiCustomFieldDefinitionModel.md) |  |  [optional] |
