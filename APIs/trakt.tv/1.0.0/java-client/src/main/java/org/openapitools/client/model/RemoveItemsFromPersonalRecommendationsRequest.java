...
import org.openapitools.client.model.RemoveItemsFromCollectionRequestMoviesInner;
import org.openapitools.client.model.RemoveItemsFromPersonalRecommendationsRequestShowsInner;
...
public class RemoveItemsFromPersonalRecommendationsRequest {
  public static final String SERIALIZED_NAME_MOVIES = "movies";
  @SerializedName(SERIALIZED_NAME_MOVIES)
  private List<RemoveItemsFromCollectionRequestMoviesInner> movies = new ArrayList<>();

  public static final String SERIALIZED_NAME_SHOWS = "shows";
  @SerializedName(SERIALIZED_NAME_SHOWS)
  private List<RemoveItemsFromPersonalRecommendationsRequestShowsInner> shows = new ArrayList<>();

  public RemoveItemsFromPersonalRecommendationsRequest() {
  }

  public RemoveItemsFromPersonalRecommendationsRequest movies(List<RemoveItemsFromCollectionRequestMoviesInner> movies) {
    this.movies = movies;
    return this;
  }

  public RemoveItemsFromPersonalRecommendationsRequest addMoviesItem(RemoveItemsFromCollectionRequestMoviesInner moviesItem) {
    if (this.movies == null) {
  ...
  public List<RemoveItemsFromCollectionRequestMoviesInner> getMovies() {
    return movies;
  }

  public void setMovies(List<RemoveItemsFromCollectionRequestMoviesInner> movies) {
    this.movies = movies;
  }


  public RemoveItemsFromPersonalRecommendationsRequest shows(List<RemoveItemsFromPersonalRecommendationsRequestShowsInner> shows) {
    this.shows = shows;
    return this;
  }

  public RemoveItemsFromPersonalRecommendationsRequest addShowsItem(RemoveItemsFromPersonalRecommendationsRequestShowsInner showsItem) {
    if (this.shows == null) {
   ...
   */
  @javax.annotation.Nullable
  public List<RemoveItemsFromPersonalRecommendationsRequestShowsInner> getShows() {
    return shows;
  }

  public void setShows(List<RemoveItemsFromPersonalRecommendationsRequestShowsInner> shows) {
    this.shows = shows;
  }
  ...
  public boolean equals(Object o) {
    ...
    RemoveItemsFromPersonalRecommendationsRequest removeItemsFromPersonalRecommendationsRequest = (RemoveItemsFromPersonalRecommendationsRequest) o;
    return Objects.equals(this.movies, removeItemsFromPersonalRecommendationsRequest.movies) &&
        Objects.equals(this.shows, removeItemsFromPersonalRecommendationsRequest.shows);
  }

  @Override
  public int hashCode() {
    return Objects.hash(movies, shows);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class RemoveItemsFromPersonalRecommendationsRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to RemoveItemsFromPersonalRecommendationsRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RemoveItemsFromPersonalRecommendationsRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in RemoveItemsFromPersonalRecommendationsRequest is not found in the empty JSON string", RemoveItemsFromPersonalRecommendationsRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RemoveItemsFromPersonalRecommendationsRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `RemoveItemsFromPersonalRecommendationsRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("movies") != null && !jsonObj.get("movies").isJsonNull()) {
        ...
        if (jsonArraymovies != null) {
          ...
          for (int i = 0; i < jsonArraymovies.size(); i++) {
            RemoveItemsFromCollectionRequestMoviesInner.validateJsonElement(jsonArraymovies.get(i));
          };
        }
      }
      if (jsonObj.get("shows") != null && !jsonObj.get("shows").isJsonNull()) {
        ...
        if (jsonArrayshows != null) {
          ...
          for (int i = 0; i < jsonArrayshows.size(); i++) {
            RemoveItemsFromPersonalRecommendationsRequestShowsInner.validateJsonElement(jsonArrayshows.get(i));
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RemoveItemsFromPersonalRecommendationsRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RemoveItemsFromPersonalRecommendationsRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RemoveItemsFromPersonalRecommendationsRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RemoveItemsFromPersonalRecommendationsRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<RemoveItemsFromPersonalRecommendationsRequest>() {
           @Override
           public void write(JsonWriter out, RemoveItemsFromPersonalRecommendationsRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public RemoveItemsFromPersonalRecommendationsRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of RemoveItemsFromPersonalRecommendationsRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of RemoveItemsFromPersonalRecommendationsRequest
   * @throws IOException if the JSON string is invalid with respect to RemoveItemsFromPersonalRecommendationsRequest
   */
  public static RemoveItemsFromPersonalRecommendationsRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RemoveItemsFromPersonalRecommendationsRequest.class);
  }

  /**
   * Convert an instance of RemoveItemsFromPersonalRecommendationsRequest to an JSON string
   *
   * @return JSON string
   */
