...
public class StartWatchingInAMediaCenterRequest {
  ...
  public StartWatchingInAMediaCenterRequest() {
  }

  public StartWatchingInAMediaCenterRequest appDate(String appDate) {
  ...
  public StartWatchingInAMediaCenterRequest appVersion(String appVersion) {
  ...
  public StartWatchingInAMediaCenterRequest movie(CheckIntoAnItemRequestMovie movie) {
    this.movie = movie;
    return this;
  }
  ...
  public StartWatchingInAMediaCenterRequest progress(BigDecimal progress) {
  ...
  public boolean equals(Object o) {
    ...
    StartWatchingInAMediaCenterRequest startWatchingInAMediaCenterRequest = (StartWatchingInAMediaCenterRequest) o;
    return Objects.equals(this.appDate, startWatchingInAMediaCenterRequest.appDate) &&
        Objects.equals(this.appVersion, startWatchingInAMediaCenterRequest.appVersion) &&
        Objects.equals(this.movie, startWatchingInAMediaCenterRequest.movie) &&
        Objects.equals(this.progress, startWatchingInAMediaCenterRequest.progress);
  }
  ...
  public String toString() {
    ...
    sb.append("class StartWatchingInAMediaCenterRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to StartWatchingInAMediaCenterRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StartWatchingInAMediaCenterRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in StartWatchingInAMediaCenterRequest is not found in the empty JSON string", StartWatchingInAMediaCenterRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!StartWatchingInAMediaCenterRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `StartWatchingInAMediaCenterRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!StartWatchingInAMediaCenterRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'StartWatchingInAMediaCenterRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<StartWatchingInAMediaCenterRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(StartWatchingInAMediaCenterRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<StartWatchingInAMediaCenterRequest>() {
           @Override
           public void write(JsonWriter out, StartWatchingInAMediaCenterRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public StartWatchingInAMediaCenterRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of StartWatchingInAMediaCenterRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of StartWatchingInAMediaCenterRequest
   * @throws IOException if the JSON string is invalid with respect to StartWatchingInAMediaCenterRequest
   */
  public static StartWatchingInAMediaCenterRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, StartWatchingInAMediaCenterRequest.class);
  }

  /**
   * Convert an instance of StartWatchingInAMediaCenterRequest to an JSON string
   *
   * @return JSON string
   */
