...
public class AddNewRatingsRequestSeasonsInner {
  ...
  public AddNewRatingsRequestSeasonsInner() {
  }

  public AddNewRatingsRequestSeasonsInner ids(AddItemsToCollectionRequestSeasonsInnerIds ids) {
    this.ids = ids;
    return this;
  }
  ...
  public AddNewRatingsRequestSeasonsInner rating(BigDecimal rating) {
    this.rating = rating;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    AddNewRatingsRequestSeasonsInner addNewRatingsRequestSeasonsInner = (AddNewRatingsRequestSeasonsInner) o;
    return Objects.equals(this.ids, addNewRatingsRequestSeasonsInner.ids) &&
        Objects.equals(this.rating, addNewRatingsRequestSeasonsInner.rating);
  }
  ...
  public String toString() {
    ...
    sb.append("class AddNewRatingsRequestSeasonsInner {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AddNewRatingsRequestSeasonsInner
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AddNewRatingsRequestSeasonsInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AddNewRatingsRequestSeasonsInner is not found in the empty JSON string", AddNewRatingsRequestSeasonsInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AddNewRatingsRequestSeasonsInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AddNewRatingsRequestSeasonsInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AddNewRatingsRequestSeasonsInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AddNewRatingsRequestSeasonsInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AddNewRatingsRequestSeasonsInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AddNewRatingsRequestSeasonsInner.class));

       return (TypeAdapter<T>) new TypeAdapter<AddNewRatingsRequestSeasonsInner>() {
           @Override
           public void write(JsonWriter out, AddNewRatingsRequestSeasonsInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AddNewRatingsRequestSeasonsInner read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AddNewRatingsRequestSeasonsInner given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AddNewRatingsRequestSeasonsInner
   * @throws IOException if the JSON string is invalid with respect to AddNewRatingsRequestSeasonsInner
   */
  public static AddNewRatingsRequestSeasonsInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AddNewRatingsRequestSeasonsInner.class);
  }

  /**
   * Convert an instance of AddNewRatingsRequestSeasonsInner to an JSON string
   *
   * @return JSON string
   */
