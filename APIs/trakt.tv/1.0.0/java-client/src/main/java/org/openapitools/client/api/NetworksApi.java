...
public class NetworksApi {
     ...
     */
    public okhttp3.Call getNetworksCall(String traktApiVersion, String traktApiKey, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call getNetworksValidateBeforeCall(String traktApiVersion, String traktApiKey, final ApiCallback _callback) throws ApiException {
        return getNetworksCall(traktApiVersion, traktApiKey, _callback);
     ...
     */
    public void getNetworks(String traktApiVersion, String traktApiKey) throws ApiException {
        getNetworksWithHttpInfo(traktApiVersion, traktApiKey);
    }
     ...
     */
    public ApiResponse<Void> getNetworksWithHttpInfo(String traktApiVersion, String traktApiKey) throws ApiException {
        okhttp3.Call localVarCall = getNetworksValidateBeforeCall(traktApiVersion, traktApiKey, null);
        return localVarApiClient.execute(localVarCall);
    }

    /**
     * Get networks (asynchronously)
     * Get a list of all TV networks, including the name.
     * @param traktApiVersion e.g. 2 (optional)
     * @param traktApiKey e.g. [client_id] (optional)
     ...
     */
    public okhttp3.Call getNetworksAsync(String traktApiVersion, String traktApiKey, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = getNetworksValidateBeforeCall(traktApiVersion, traktApiKey, _callback);
