...
public class UpdatePersonalListRequest {
  ...
  public UpdatePersonalListRequest() {
  }

  public UpdatePersonalListRequest displayNumbers(Boolean displayNumbers) {
  ...
  public UpdatePersonalListRequest name(String name) {
    this.name = name;
    return this;
  }
  ...
  public UpdatePersonalListRequest privacy(String privacy) {
  ...
  public UpdatePersonalListRequest sortBy(String sortBy) {
    this.sortBy = sortBy;
    return this;
  }
  ...
  public UpdatePersonalListRequest sortHow(String sortHow) {
  ...
  public boolean equals(Object o) {
    ...
    UpdatePersonalListRequest updatePersonalListRequest = (UpdatePersonalListRequest) o;
    return Objects.equals(this.displayNumbers, updatePersonalListRequest.displayNumbers) &&
        Objects.equals(this.name, updatePersonalListRequest.name) &&
        Objects.equals(this.privacy, updatePersonalListRequest.privacy) &&
        Objects.equals(this.sortBy, updatePersonalListRequest.sortBy) &&
        Objects.equals(this.sortHow, updatePersonalListRequest.sortHow);
  }

  @Override
  public int hashCode() {
    return Objects.hash(displayNumbers, name, privacy, sortBy, sortHow);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class UpdatePersonalListRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdatePersonalListRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdatePersonalListRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdatePersonalListRequest is not found in the empty JSON string", UpdatePersonalListRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdatePersonalListRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdatePersonalListRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdatePersonalListRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdatePersonalListRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdatePersonalListRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdatePersonalListRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdatePersonalListRequest>() {
           @Override
           public void write(JsonWriter out, UpdatePersonalListRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdatePersonalListRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdatePersonalListRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdatePersonalListRequest
   * @throws IOException if the JSON string is invalid with respect to UpdatePersonalListRequest
   */
  public static UpdatePersonalListRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdatePersonalListRequest.class);
  }

  /**
   * Convert an instance of UpdatePersonalListRequest to an JSON string
   *
   * @return JSON string
   */
