...
public class AddItemsToPersonalRecommendationsRequestMoviesInner {
  ...
  public AddItemsToPersonalRecommendationsRequestMoviesInner() {
  }

  public AddItemsToPersonalRecommendationsRequestMoviesInner ids(CheckIntoAnItemRequestMovieIds ids) {
    this.ids = ids;
    return this;
  }
  ...
  public AddItemsToPersonalRecommendationsRequestMoviesInner notes(String notes) {
    this.notes = notes;
    return this;
  }
  ...
  public AddItemsToPersonalRecommendationsRequestMoviesInner title(String title) {
    this.title = title;
    return this;
  }
  ...
  public AddItemsToPersonalRecommendationsRequestMoviesInner year(BigDecimal year) {
    this.year = year;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    AddItemsToPersonalRecommendationsRequestMoviesInner addItemsToPersonalRecommendationsRequestMoviesInner = (AddItemsToPersonalRecommendationsRequestMoviesInner) o;
    return Objects.equals(this.ids, addItemsToPersonalRecommendationsRequestMoviesInner.ids) &&
        Objects.equals(this.notes, addItemsToPersonalRecommendationsRequestMoviesInner.notes) &&
        Objects.equals(this.title, addItemsToPersonalRecommendationsRequestMoviesInner.title) &&
        Objects.equals(this.year, addItemsToPersonalRecommendationsRequestMoviesInner.year);
  }

  @Override
  public int hashCode() {
    return Objects.hash(ids, notes, title, year);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AddItemsToPersonalRecommendationsRequestMoviesInner {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AddItemsToPersonalRecommendationsRequestMoviesInner
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AddItemsToPersonalRecommendationsRequestMoviesInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AddItemsToPersonalRecommendationsRequestMoviesInner is not found in the empty JSON string", AddItemsToPersonalRecommendationsRequestMoviesInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AddItemsToPersonalRecommendationsRequestMoviesInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AddItemsToPersonalRecommendationsRequestMoviesInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AddItemsToPersonalRecommendationsRequestMoviesInner.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AddItemsToPersonalRecommendationsRequestMoviesInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AddItemsToPersonalRecommendationsRequestMoviesInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AddItemsToPersonalRecommendationsRequestMoviesInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AddItemsToPersonalRecommendationsRequestMoviesInner.class));

       return (TypeAdapter<T>) new TypeAdapter<AddItemsToPersonalRecommendationsRequestMoviesInner>() {
           @Override
           public void write(JsonWriter out, AddItemsToPersonalRecommendationsRequestMoviesInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AddItemsToPersonalRecommendationsRequestMoviesInner read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AddItemsToPersonalRecommendationsRequestMoviesInner given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AddItemsToPersonalRecommendationsRequestMoviesInner
   * @throws IOException if the JSON string is invalid with respect to AddItemsToPersonalRecommendationsRequestMoviesInner
   */
  public static AddItemsToPersonalRecommendationsRequestMoviesInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AddItemsToPersonalRecommendationsRequestMoviesInner.class);
  }

  /**
   * Convert an instance of AddItemsToPersonalRecommendationsRequestMoviesInner to an JSON string
   *
   * @return JSON string
   */
