...
public class CreatePersonalListRequest {
  ...
  public static final String SERIALIZED_NAME_DISPLAY_NUMBERS = "display_numbers";
  @SerializedName(SERIALIZED_NAME_DISPLAY_NUMBERS)
  ...
  public static final String SERIALIZED_NAME_SORT_HOW = "sort_how";
  @SerializedName(SERIALIZED_NAME_SORT_HOW)
  private String sortHow;

  public CreatePersonalListRequest() {
  }

  public CreatePersonalListRequest allowComments(Boolean allowComments) {
  ...
  public CreatePersonalListRequest description(String description) {
  ...
  public CreatePersonalListRequest displayNumbers(Boolean displayNumbers) {
  ...
  public CreatePersonalListRequest name(String name) {
    this.name = name;
    return this;
  }
  ...
  public CreatePersonalListRequest privacy(String privacy) {
  ...
  public CreatePersonalListRequest sortBy(String sortBy) {
    this.sortBy = sortBy;
    return this;
  }
  ...
  public CreatePersonalListRequest sortHow(String sortHow) {
  ...
  public boolean equals(Object o) {
    ...
    CreatePersonalListRequest createPersonalListRequest = (CreatePersonalListRequest) o;
    return Objects.equals(this.allowComments, createPersonalListRequest.allowComments) &&
        Objects.equals(this.description, createPersonalListRequest.description) &&
        Objects.equals(this.displayNumbers, createPersonalListRequest.displayNumbers) &&
        Objects.equals(this.name, createPersonalListRequest.name) &&
        Objects.equals(this.privacy, createPersonalListRequest.privacy) &&
        Objects.equals(this.sortBy, createPersonalListRequest.sortBy) &&
        Objects.equals(this.sortHow, createPersonalListRequest.sortHow);
  }

  @Override
  public int hashCode() {
    return Objects.hash(allowComments, description, displayNumbers, name, privacy, sortBy, sortHow);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CreatePersonalListRequest {\n");
    sb.append("    allowComments: ").append(toIndentedString(allowComments)).append("\n");
    sb.append("    description: ").append(toIndentedString(description)).append("\n");
    sb.append("    displayNumbers: ").append(toIndentedString(displayNumbers)).append("\n");
    sb.append("    name: ").append(toIndentedString(name)).append("\n");
    sb.append("    privacy: ").append(toIndentedString(privacy)).append("\n");
    sb.append("    sortBy: ").append(toIndentedString(sortBy)).append("\n");
    sb.append("    sortHow: ").append(toIndentedString(sortHow)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("display_numbers");
    openapiFields.add("name");
    openapiFields.add("privacy");
    openapiFields.add("sort_by");
    openapiFields.add("sort_how");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreatePersonalListRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreatePersonalListRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreatePersonalListRequest is not found in the empty JSON string", CreatePersonalListRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreatePersonalListRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreatePersonalListRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if ((jsonObj.get("sort_how") != null && !jsonObj.get("sort_how").isJsonNull()) && !jsonObj.get("sort_how").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `sort_how` to be a primitive type in the JSON string but got `%s`", jsonObj.get("sort_how").toString()));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreatePersonalListRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreatePersonalListRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreatePersonalListRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreatePersonalListRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<CreatePersonalListRequest>() {
           @Override
           public void write(JsonWriter out, CreatePersonalListRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreatePersonalListRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreatePersonalListRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreatePersonalListRequest
   * @throws IOException if the JSON string is invalid with respect to CreatePersonalListRequest
   */
  public static CreatePersonalListRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreatePersonalListRequest.class);
  }

  /**
   * Convert an instance of CreatePersonalListRequest to an JSON string
   *
   * @return JSON string
   */
