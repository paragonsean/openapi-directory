...
public class AddItemsToPersonalListRequestMoviesInnerIds {
  ...
  public AddItemsToPersonalListRequestMoviesInnerIds() {
  }

  public AddItemsToPersonalListRequestMoviesInnerIds imdb(String imdb) {
    this.imdb = imdb;
    return this;
  }
  ...
  public AddItemsToPersonalListRequestMoviesInnerIds trakt(BigDecimal trakt) {
    this.trakt = trakt;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    AddItemsToPersonalListRequestMoviesInnerIds addItemsToPersonalListRequestMoviesInnerIds = (AddItemsToPersonalListRequestMoviesInnerIds) o;
    return Objects.equals(this.imdb, addItemsToPersonalListRequestMoviesInnerIds.imdb) &&
        Objects.equals(this.trakt, addItemsToPersonalListRequestMoviesInnerIds.trakt);
  }

  @Override
  public int hashCode() {
    return Objects.hash(imdb, trakt);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AddItemsToPersonalListRequestMoviesInnerIds {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AddItemsToPersonalListRequestMoviesInnerIds
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AddItemsToPersonalListRequestMoviesInnerIds.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AddItemsToPersonalListRequestMoviesInnerIds is not found in the empty JSON string", AddItemsToPersonalListRequestMoviesInnerIds.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AddItemsToPersonalListRequestMoviesInnerIds.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AddItemsToPersonalListRequestMoviesInnerIds` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AddItemsToPersonalListRequestMoviesInnerIds.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AddItemsToPersonalListRequestMoviesInnerIds' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AddItemsToPersonalListRequestMoviesInnerIds> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AddItemsToPersonalListRequestMoviesInnerIds.class));

       return (TypeAdapter<T>) new TypeAdapter<AddItemsToPersonalListRequestMoviesInnerIds>() {
           @Override
           public void write(JsonWriter out, AddItemsToPersonalListRequestMoviesInnerIds value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AddItemsToPersonalListRequestMoviesInnerIds read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AddItemsToPersonalListRequestMoviesInnerIds given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AddItemsToPersonalListRequestMoviesInnerIds
   * @throws IOException if the JSON string is invalid with respect to AddItemsToPersonalListRequestMoviesInnerIds
   */
  public static AddItemsToPersonalListRequestMoviesInnerIds fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AddItemsToPersonalListRequestMoviesInnerIds.class);
  }

  /**
   * Convert an instance of AddItemsToPersonalListRequestMoviesInnerIds to an JSON string
   *
   * @return JSON string
   */
