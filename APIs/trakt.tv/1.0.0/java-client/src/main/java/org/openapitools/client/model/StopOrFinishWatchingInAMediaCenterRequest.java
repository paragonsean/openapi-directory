...
public class StopOrFinishWatchingInAMediaCenterRequest {
  ...
  public StopOrFinishWatchingInAMediaCenterRequest() {
  }

  public StopOrFinishWatchingInAMediaCenterRequest appDate(String appDate) {
  ...
  public StopOrFinishWatchingInAMediaCenterRequest appVersion(String appVersion) {
  ...
  public StopOrFinishWatchingInAMediaCenterRequest movie(CheckIntoAnItemRequestMovie movie) {
    this.movie = movie;
    return this;
  }
  ...
  public StopOrFinishWatchingInAMediaCenterRequest progress(BigDecimal progress) {
  ...
  public boolean equals(Object o) {
    ...
    StopOrFinishWatchingInAMediaCenterRequest stopOrFinishWatchingInAMediaCenterRequest = (StopOrFinishWatchingInAMediaCenterRequest) o;
    return Objects.equals(this.appDate, stopOrFinishWatchingInAMediaCenterRequest.appDate) &&
        Objects.equals(this.appVersion, stopOrFinishWatchingInAMediaCenterRequest.appVersion) &&
        Objects.equals(this.movie, stopOrFinishWatchingInAMediaCenterRequest.movie) &&
        Objects.equals(this.progress, stopOrFinishWatchingInAMediaCenterRequest.progress);
  }
  ...
  public String toString() {
    ...
    sb.append("class StopOrFinishWatchingInAMediaCenterRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to StopOrFinishWatchingInAMediaCenterRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StopOrFinishWatchingInAMediaCenterRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in StopOrFinishWatchingInAMediaCenterRequest is not found in the empty JSON string", StopOrFinishWatchingInAMediaCenterRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!StopOrFinishWatchingInAMediaCenterRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `StopOrFinishWatchingInAMediaCenterRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!StopOrFinishWatchingInAMediaCenterRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'StopOrFinishWatchingInAMediaCenterRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<StopOrFinishWatchingInAMediaCenterRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(StopOrFinishWatchingInAMediaCenterRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<StopOrFinishWatchingInAMediaCenterRequest>() {
           @Override
           public void write(JsonWriter out, StopOrFinishWatchingInAMediaCenterRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public StopOrFinishWatchingInAMediaCenterRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of StopOrFinishWatchingInAMediaCenterRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of StopOrFinishWatchingInAMediaCenterRequest
   * @throws IOException if the JSON string is invalid with respect to StopOrFinishWatchingInAMediaCenterRequest
   */
  public static StopOrFinishWatchingInAMediaCenterRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, StopOrFinishWatchingInAMediaCenterRequest.class);
  }

  /**
   * Convert an instance of StopOrFinishWatchingInAMediaCenterRequest to an JSON string
   *
   * @return JSON string
   */
