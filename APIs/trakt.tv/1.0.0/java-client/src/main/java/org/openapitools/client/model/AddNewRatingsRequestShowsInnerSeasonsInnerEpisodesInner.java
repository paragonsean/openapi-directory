...
public class AddNewRatingsRequestShowsInnerSeasonsInnerEpisodesInner {
  ...
  public AddNewRatingsRequestShowsInnerSeasonsInnerEpisodesInner() {
  }

  public AddNewRatingsRequestShowsInnerSeasonsInnerEpisodesInner number(BigDecimal number) {
    this.number = number;
    return this;
  }
  ...
  public AddNewRatingsRequestShowsInnerSeasonsInnerEpisodesInner rating(BigDecimal rating) {
    this.rating = rating;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    AddNewRatingsRequestShowsInnerSeasonsInnerEpisodesInner addNewRatingsRequestShowsInnerSeasonsInnerEpisodesInner = (AddNewRatingsRequestShowsInnerSeasonsInnerEpisodesInner) o;
    return Objects.equals(this.number, addNewRatingsRequestShowsInnerSeasonsInnerEpisodesInner.number) &&
        Objects.equals(this.rating, addNewRatingsRequestShowsInnerSeasonsInnerEpisodesInner.rating);
  }

  @Override
  public int hashCode() {
    return Objects.hash(number, rating);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AddNewRatingsRequestShowsInnerSeasonsInnerEpisodesInner {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AddNewRatingsRequestShowsInnerSeasonsInnerEpisodesInner
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AddNewRatingsRequestShowsInnerSeasonsInnerEpisodesInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AddNewRatingsRequestShowsInnerSeasonsInnerEpisodesInner is not found in the empty JSON string", AddNewRatingsRequestShowsInnerSeasonsInnerEpisodesInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AddNewRatingsRequestShowsInnerSeasonsInnerEpisodesInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AddNewRatingsRequestShowsInnerSeasonsInnerEpisodesInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AddNewRatingsRequestShowsInnerSeasonsInnerEpisodesInner.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AddNewRatingsRequestShowsInnerSeasonsInnerEpisodesInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AddNewRatingsRequestShowsInnerSeasonsInnerEpisodesInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AddNewRatingsRequestShowsInnerSeasonsInnerEpisodesInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AddNewRatingsRequestShowsInnerSeasonsInnerEpisodesInner.class));

       return (TypeAdapter<T>) new TypeAdapter<AddNewRatingsRequestShowsInnerSeasonsInnerEpisodesInner>() {
           @Override
           public void write(JsonWriter out, AddNewRatingsRequestShowsInnerSeasonsInnerEpisodesInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AddNewRatingsRequestShowsInnerSeasonsInnerEpisodesInner read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AddNewRatingsRequestShowsInnerSeasonsInnerEpisodesInner given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AddNewRatingsRequestShowsInnerSeasonsInnerEpisodesInner
   * @throws IOException if the JSON string is invalid with respect to AddNewRatingsRequestShowsInnerSeasonsInnerEpisodesInner
   */
  public static AddNewRatingsRequestShowsInnerSeasonsInnerEpisodesInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AddNewRatingsRequestShowsInnerSeasonsInnerEpisodesInner.class);
  }

  /**
   * Convert an instance of AddNewRatingsRequestShowsInnerSeasonsInnerEpisodesInner to an JSON string
   *
   * @return JSON string
   */
