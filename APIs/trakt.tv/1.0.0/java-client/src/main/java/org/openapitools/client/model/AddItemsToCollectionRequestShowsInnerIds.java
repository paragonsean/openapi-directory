...
public class AddItemsToCollectionRequestShowsInnerIds {
  ...
  public AddItemsToCollectionRequestShowsInnerIds() {
  }

  public AddItemsToCollectionRequestShowsInnerIds imdb(String imdb) {
    this.imdb = imdb;
    return this;
  }
  ...
  public AddItemsToCollectionRequestShowsInnerIds slug(String slug) {
    this.slug = slug;
    return this;
  }
  ...
  public AddItemsToCollectionRequestShowsInnerIds tmdb(BigDecimal tmdb) {
    this.tmdb = tmdb;
    return this;
  }
  ...
  public AddItemsToCollectionRequestShowsInnerIds trakt(BigDecimal trakt) {
    this.trakt = trakt;
    return this;
  }
  ...
  public AddItemsToCollectionRequestShowsInnerIds tvdb(BigDecimal tvdb) {
    this.tvdb = tvdb;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    AddItemsToCollectionRequestShowsInnerIds addItemsToCollectionRequestShowsInnerIds = (AddItemsToCollectionRequestShowsInnerIds) o;
    return Objects.equals(this.imdb, addItemsToCollectionRequestShowsInnerIds.imdb) &&
        Objects.equals(this.slug, addItemsToCollectionRequestShowsInnerIds.slug) &&
        Objects.equals(this.tmdb, addItemsToCollectionRequestShowsInnerIds.tmdb) &&
        Objects.equals(this.trakt, addItemsToCollectionRequestShowsInnerIds.trakt) &&
        Objects.equals(this.tvdb, addItemsToCollectionRequestShowsInnerIds.tvdb);
  }

  @Override
  public int hashCode() {
    return Objects.hash(imdb, slug, tmdb, trakt, tvdb);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AddItemsToCollectionRequestShowsInnerIds {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AddItemsToCollectionRequestShowsInnerIds
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AddItemsToCollectionRequestShowsInnerIds.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AddItemsToCollectionRequestShowsInnerIds is not found in the empty JSON string", AddItemsToCollectionRequestShowsInnerIds.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AddItemsToCollectionRequestShowsInnerIds.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AddItemsToCollectionRequestShowsInnerIds` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AddItemsToCollectionRequestShowsInnerIds.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AddItemsToCollectionRequestShowsInnerIds' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AddItemsToCollectionRequestShowsInnerIds> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AddItemsToCollectionRequestShowsInnerIds.class));

       return (TypeAdapter<T>) new TypeAdapter<AddItemsToCollectionRequestShowsInnerIds>() {
           @Override
           public void write(JsonWriter out, AddItemsToCollectionRequestShowsInnerIds value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AddItemsToCollectionRequestShowsInnerIds read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AddItemsToCollectionRequestShowsInnerIds given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AddItemsToCollectionRequestShowsInnerIds
   * @throws IOException if the JSON string is invalid with respect to AddItemsToCollectionRequestShowsInnerIds
   */
  public static AddItemsToCollectionRequestShowsInnerIds fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AddItemsToCollectionRequestShowsInnerIds.class);
  }

  /**
   * Convert an instance of AddItemsToCollectionRequestShowsInnerIds to an JSON string
   *
   * @return JSON string
   */
