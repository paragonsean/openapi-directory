...
import org.openapitools.client.model.ExchangeRefreshTokenForAccessTokenRequest;
import org.openapitools.client.model.RevokeAnAccessTokenRequest;
...
public class AuthenticationOAuthApi {
    private ApiClient localVarApiClient;
    private int localHostIndex;
    private String localCustomBaseUrl;

    public AuthenticationOAuthApi() {
        this(Configuration.getDefaultApiClient());
    }

    public AuthenticationOAuthApi(ApiClient apiClient) {
    ...
    /**
     * Build call for authorizeApplication
     * @param responseType Must be set to code. (required)
     * @param clientId Get this from your app settings. (required)
     * @param redirectUri URI specified in your app settings. (required)
     * @param state State variable for CSRF purposes. (optional)
     * @param body Default to the sign up page. (optional)
     ...
     */
    public okhttp3.Call authorizeApplicationCall(String responseType, String clientId, String redirectUri, String state, String body, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call authorizeApplicationValidateBeforeCall(String responseType, String clientId, String redirectUri, String state, String body, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'responseType' is set
        if (responseType == null) {
            throw new ApiException("Missing the required parameter 'responseType' when calling authorizeApplication(Async)");
        }

        // verify the required parameter 'clientId' is set
        if (clientId == null) {
            throw new ApiException("Missing the required parameter 'clientId' when calling authorizeApplication(Async)");
        }

        // verify the required parameter 'redirectUri' is set
        if (redirectUri == null) {
            throw new ApiException("Missing the required parameter 'redirectUri' when calling authorizeApplication(Async)");
        }

        return authorizeApplicationCall(responseType, clientId, redirectUri, state, body, _callback);
     ...
     */
    public void authorizeApplication(String responseType, String clientId, String redirectUri, String state, String body) throws ApiException {
        authorizeApplicationWithHttpInfo(responseType, clientId, redirectUri, state, body);
    }
     ...
     */
    public ApiResponse<Void> authorizeApplicationWithHttpInfo(String responseType, String clientId, String redirectUri, String state, String body) throws ApiException {
        okhttp3.Call localVarCall = authorizeApplicationValidateBeforeCall(responseType, clientId, redirectUri, state, body, null);
        return localVarApiClient.execute(localVarCall);
    }

    /**
     * Authorize Application (asynchronously)
     * Construct then redirect to this URL. The Trakt website will request permissions for your app, which the user needs to approve. If the user isn&#39;t signed into Trakt, it will ask them to do so. Send &#x60;signup&#x3D;true&#x60; if you prefer the account sign up page to be the default.  **Note:** You should use the normal **https://trakt.tv** hostname when creating this URL and not the API URL.
     * @param responseType Must be set to code. (required)
     * @param clientId Get this from your app settings. (required)
     * @param redirectUri URI specified in your app settings. (required)
     ...
     */
    public okhttp3.Call authorizeApplicationAsync(String responseType, String clientId, String redirectUri, String state, String body, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = authorizeApplicationValidateBeforeCall(responseType, clientId, redirectUri, state, body, _callback);
        localVarApiClient.executeAsync(localVarCall, _callback);
        return localVarCall;
    }
    /**
     * Build call for exchangeRefreshTokenForAccessToken
     * @param exchangeRefreshTokenForAccessTokenRequest  (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> If the &#x60;refresh_token&#x60; is valid, you&#39;ll get the &#x60;access_token&#x60; back. </td><td>  -  </td></tr>
        <tr><td> 401 </td><td> If the &#x60;refresh_token&#x60; is invalid, you&#39;ll get a &#x60;401&#x60; error. </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call exchangeRefreshTokenForAccessTokenCall(ExchangeRefreshTokenForAccessTokenRequest exchangeRefreshTokenForAccessTokenRequest, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        Object localVarPostBody = exchangeRefreshTokenForAccessTokenRequest;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call exchangeRefreshTokenForAccessTokenValidateBeforeCall(ExchangeRefreshTokenForAccessTokenRequest exchangeRefreshTokenForAccessTokenRequest, final ApiCallback _callback) throws ApiException {
        return exchangeRefreshTokenForAccessTokenCall(exchangeRefreshTokenForAccessTokenRequest, _callback);
     ...
     */
    public void exchangeRefreshTokenForAccessToken(ExchangeRefreshTokenForAccessTokenRequest exchangeRefreshTokenForAccessTokenRequest) throws ApiException {
        exchangeRefreshTokenForAccessTokenWithHttpInfo(exchangeRefreshTokenForAccessTokenRequest);
    }
     ...
     */
    public ApiResponse<Void> exchangeRefreshTokenForAccessTokenWithHttpInfo(ExchangeRefreshTokenForAccessTokenRequest exchangeRefreshTokenForAccessTokenRequest) throws ApiException {
        okhttp3.Call localVarCall = exchangeRefreshTokenForAccessTokenValidateBeforeCall(exchangeRefreshTokenForAccessTokenRequest, null);
        return localVarApiClient.execute(localVarCall);
    }

    /**
     * Exchange refresh_token for access_token (asynchronously)
     * Use the &#x60;refresh_token&#x60; to get a new &#x60;access_token&#x60; without asking the user to re-authenticate. The &#x60;access_token&#x60; is valid for 3 months before it needs to be refreshed again.  #### JSON POST Data  | Key | Type | Value | |---|---|---| | &#x60;refresh_token&#x60; &lt;span style&#x3D;\&quot;color:red;\&quot;&gt;*&lt;/a&gt; | string | Saved from the initial token method. | | &#x60;client_id&#x60; &lt;span style&#x3D;\&quot;color:red;\&quot;&gt;*&lt;/a&gt; | string | Get this from your app settings. | | &#x60;client_secret&#x60; &lt;span style&#x3D;\&quot;color:red;\&quot;&gt;*&lt;/a&gt; | string | Get this from your app settings. | | &#x60;redirect_uri&#x60; &lt;span style&#x3D;\&quot;color:red;\&quot;&gt;*&lt;/a&gt; | string | URI specified in your app settings. | | &#x60;grant_type&#x60; &lt;span style&#x3D;\&quot;color:red;\&quot;&gt;* &lt;/a&gt; | string | &#x60;refresh_token&#x60; |
     * @param exchangeRefreshTokenForAccessTokenRequest  (optional)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
     ...
     */
    public okhttp3.Call exchangeRefreshTokenForAccessTokenAsync(ExchangeRefreshTokenForAccessTokenRequest exchangeRefreshTokenForAccessTokenRequest, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = exchangeRefreshTokenForAccessTokenValidateBeforeCall(exchangeRefreshTokenForAccessTokenRequest, _callback);
        localVarApiClient.executeAsync(localVarCall, _callback);
        return localVarCall;
    }
    /**
     * Build call for revokeAnAccessToken
     * @param revokeAnAccessTokenRequest  (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     */
    public okhttp3.Call revokeAnAccessTokenCall(RevokeAnAccessTokenRequest revokeAnAccessTokenRequest, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        Object localVarPostBody = revokeAnAccessTokenRequest;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call revokeAnAccessTokenValidateBeforeCall(RevokeAnAccessTokenRequest revokeAnAccessTokenRequest, final ApiCallback _callback) throws ApiException {
        return revokeAnAccessTokenCall(revokeAnAccessTokenRequest, _callback);
     ...
     */
    public void revokeAnAccessToken(RevokeAnAccessTokenRequest revokeAnAccessTokenRequest) throws ApiException {
        revokeAnAccessTokenWithHttpInfo(revokeAnAccessTokenRequest);
    }
     ...
     */
    public ApiResponse<Void> revokeAnAccessTokenWithHttpInfo(RevokeAnAccessTokenRequest revokeAnAccessTokenRequest) throws ApiException {
        okhttp3.Call localVarCall = revokeAnAccessTokenValidateBeforeCall(revokeAnAccessTokenRequest, null);
        return localVarApiClient.execute(localVarCall);
    }

    /**
     * Revoke an access_token (asynchronously)
     * An &#x60;access_token&#x60; can be revoked when a user signs out of their Trakt account in your app. This is not required, but might improve the user experience so the user doesn&#39;t have an unused app connection hanging around.  #### JSON POST Data  | Key | Type | Value | |---|---|---| | &#x60;token&#x60; &lt;span style&#x3D;\&quot;color:red;\&quot;&gt;*&lt;/a&gt; | string | A valid OAuth &#x60;access_token&#x60;. | | &#x60;client_id&#x60; &lt;span style&#x3D;\&quot;color:red;\&quot;&gt;*&lt;/a&gt; | string | Get this from your app settings. | | &#x60;client_secret&#x60; &lt;span style&#x3D;\&quot;color:red;\&quot;&gt;*&lt;/a&gt; | string | Get this from your app settings. |
     * @param revokeAnAccessTokenRequest  (optional)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
     ...
     */
    public okhttp3.Call revokeAnAccessTokenAsync(RevokeAnAccessTokenRequest revokeAnAccessTokenRequest, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = revokeAnAccessTokenValidateBeforeCall(revokeAnAccessTokenRequest, _callback);
        localVarApiClient.executeAsync(localVarCall, _callback);
        return localVarCall;
    }
}
