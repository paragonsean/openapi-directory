...
import org.openapitools.client.model.AddItemsToPersonalListRequestMoviesInner;
import org.openapitools.client.model.AddItemsToPersonalListRequestPeopleInner;
import org.openapitools.client.model.AddItemsToPersonalListRequestShowsInner;
...
public class AddItemsToPersonalListRequest {
  ...
  private List<AddItemsToPersonalListRequestMoviesInner> movies = new ArrayList<>();
  ...
  private List<AddItemsToPersonalListRequestShowsInner> shows = new ArrayList<>();

  public AddItemsToPersonalListRequest() {
  }

  public AddItemsToPersonalListRequest episodes(List<AddItemsToCollectionRequestEpisodesInner> episodes) {
    this.episodes = episodes;
    return this;
  }

  public AddItemsToPersonalListRequest addEpisodesItem(AddItemsToCollectionRequestEpisodesInner episodesItem) {
  ...
  public AddItemsToPersonalListRequest movies(List<AddItemsToPersonalListRequestMoviesInner> movies) {
    this.movies = movies;
    return this;
  }

  public AddItemsToPersonalListRequest addMoviesItem(AddItemsToPersonalListRequestMoviesInner moviesItem) {
    if (this.movies == null) {
   ...
   */
  @javax.annotation.Nullable
  public List<AddItemsToPersonalListRequestMoviesInner> getMovies() {
    return movies;
  }

  public void setMovies(List<AddItemsToPersonalListRequestMoviesInner> movies) {
    this.movies = movies;
  }


  public AddItemsToPersonalListRequest people(List<AddItemsToPersonalListRequestPeopleInner> people) {
    this.people = people;
    return this;
  }

  public AddItemsToPersonalListRequest addPeopleItem(AddItemsToPersonalListRequestPeopleInner peopleItem) {
    if (this.people == null) {
  ...
  public AddItemsToPersonalListRequest seasons(List<AddItemsToCollectionRequestSeasonsInner> seasons) {
    this.seasons = seasons;
    return this;
  }

  public AddItemsToPersonalListRequest addSeasonsItem(AddItemsToCollectionRequestSeasonsInner seasonsItem) {
  ...
  public AddItemsToPersonalListRequest shows(List<AddItemsToPersonalListRequestShowsInner> shows) {
    this.shows = shows;
    return this;
  }

  public AddItemsToPersonalListRequest addShowsItem(AddItemsToPersonalListRequestShowsInner showsItem) {
    if (this.shows == null) {
   ...
   */
  @javax.annotation.Nullable
  public List<AddItemsToPersonalListRequestShowsInner> getShows() {
    return shows;
  }

  public void setShows(List<AddItemsToPersonalListRequestShowsInner> shows) {
    this.shows = shows;
  }
  ...
  public boolean equals(Object o) {
    ...
    AddItemsToPersonalListRequest addItemsToPersonalListRequest = (AddItemsToPersonalListRequest) o;
    return Objects.equals(this.episodes, addItemsToPersonalListRequest.episodes) &&
        Objects.equals(this.movies, addItemsToPersonalListRequest.movies) &&
        Objects.equals(this.people, addItemsToPersonalListRequest.people) &&
        Objects.equals(this.seasons, addItemsToPersonalListRequest.seasons) &&
        Objects.equals(this.shows, addItemsToPersonalListRequest.shows);
  }
  ...
  public String toString() {
    ...
    sb.append("class AddItemsToPersonalListRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AddItemsToPersonalListRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AddItemsToPersonalListRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AddItemsToPersonalListRequest is not found in the empty JSON string", AddItemsToPersonalListRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AddItemsToPersonalListRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AddItemsToPersonalListRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("movies") != null && !jsonObj.get("movies").isJsonNull()) {
        ...
        if (jsonArraymovies != null) {
          ...
          for (int i = 0; i < jsonArraymovies.size(); i++) {
            AddItemsToPersonalListRequestMoviesInner.validateJsonElement(jsonArraymovies.get(i));
          };
        }
      }
      ...
      if (jsonObj.get("shows") != null && !jsonObj.get("shows").isJsonNull()) {
        ...
        if (jsonArrayshows != null) {
          ...
          for (int i = 0; i < jsonArrayshows.size(); i++) {
            AddItemsToPersonalListRequestShowsInner.validateJsonElement(jsonArrayshows.get(i));
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AddItemsToPersonalListRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AddItemsToPersonalListRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AddItemsToPersonalListRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AddItemsToPersonalListRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<AddItemsToPersonalListRequest>() {
           @Override
           public void write(JsonWriter out, AddItemsToPersonalListRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AddItemsToPersonalListRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AddItemsToPersonalListRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AddItemsToPersonalListRequest
   * @throws IOException if the JSON string is invalid with respect to AddItemsToPersonalListRequest
   */
  public static AddItemsToPersonalListRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AddItemsToPersonalListRequest.class);
  }

  /**
   * Convert an instance of AddItemsToPersonalListRequest to an JSON string
   *
   * @return JSON string
   */
