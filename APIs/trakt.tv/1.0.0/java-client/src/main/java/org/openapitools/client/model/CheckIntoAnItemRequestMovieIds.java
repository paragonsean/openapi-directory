...
public class CheckIntoAnItemRequestMovieIds {
  ...
  public CheckIntoAnItemRequestMovieIds() {
  }

  public CheckIntoAnItemRequestMovieIds imdb(String imdb) {
    this.imdb = imdb;
    return this;
  }
  ...
  public CheckIntoAnItemRequestMovieIds slug(String slug) {
    this.slug = slug;
    return this;
  }
  ...
  public CheckIntoAnItemRequestMovieIds tmdb(BigDecimal tmdb) {
    this.tmdb = tmdb;
    return this;
  }
  ...
  public CheckIntoAnItemRequestMovieIds trakt(BigDecimal trakt) {
    this.trakt = trakt;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    CheckIntoAnItemRequestMovieIds checkIntoAnItemRequestMovieIds = (CheckIntoAnItemRequestMovieIds) o;
    return Objects.equals(this.imdb, checkIntoAnItemRequestMovieIds.imdb) &&
        Objects.equals(this.slug, checkIntoAnItemRequestMovieIds.slug) &&
        Objects.equals(this.tmdb, checkIntoAnItemRequestMovieIds.tmdb) &&
        Objects.equals(this.trakt, checkIntoAnItemRequestMovieIds.trakt);
  }

  @Override
  public int hashCode() {
    return Objects.hash(imdb, slug, tmdb, trakt);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CheckIntoAnItemRequestMovieIds {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CheckIntoAnItemRequestMovieIds
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CheckIntoAnItemRequestMovieIds.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CheckIntoAnItemRequestMovieIds is not found in the empty JSON string", CheckIntoAnItemRequestMovieIds.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CheckIntoAnItemRequestMovieIds.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CheckIntoAnItemRequestMovieIds` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CheckIntoAnItemRequestMovieIds.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CheckIntoAnItemRequestMovieIds' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CheckIntoAnItemRequestMovieIds> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CheckIntoAnItemRequestMovieIds.class));

       return (TypeAdapter<T>) new TypeAdapter<CheckIntoAnItemRequestMovieIds>() {
           @Override
           public void write(JsonWriter out, CheckIntoAnItemRequestMovieIds value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CheckIntoAnItemRequestMovieIds read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CheckIntoAnItemRequestMovieIds given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CheckIntoAnItemRequestMovieIds
   * @throws IOException if the JSON string is invalid with respect to CheckIntoAnItemRequestMovieIds
   */
  public static CheckIntoAnItemRequestMovieIds fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CheckIntoAnItemRequestMovieIds.class);
  }

  /**
   * Convert an instance of CheckIntoAnItemRequestMovieIds to an JSON string
   *
   * @return JSON string
   */
