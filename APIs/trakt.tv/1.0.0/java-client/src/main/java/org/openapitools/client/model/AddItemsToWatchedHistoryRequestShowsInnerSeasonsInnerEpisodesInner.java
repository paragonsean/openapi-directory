...
public class AddItemsToWatchedHistoryRequestShowsInnerSeasonsInnerEpisodesInner {
  ...
  public AddItemsToWatchedHistoryRequestShowsInnerSeasonsInnerEpisodesInner() {
  }

  public AddItemsToWatchedHistoryRequestShowsInnerSeasonsInnerEpisodesInner number(BigDecimal number) {
    this.number = number;
    return this;
  }
  ...
  public AddItemsToWatchedHistoryRequestShowsInnerSeasonsInnerEpisodesInner watchedAt(String watchedAt) {
  ...
  public boolean equals(Object o) {
    ...
    AddItemsToWatchedHistoryRequestShowsInnerSeasonsInnerEpisodesInner addItemsToWatchedHistoryRequestShowsInnerSeasonsInnerEpisodesInner = (AddItemsToWatchedHistoryRequestShowsInnerSeasonsInnerEpisodesInner) o;
    return Objects.equals(this.number, addItemsToWatchedHistoryRequestShowsInnerSeasonsInnerEpisodesInner.number) &&
        Objects.equals(this.watchedAt, addItemsToWatchedHistoryRequestShowsInnerSeasonsInnerEpisodesInner.watchedAt);
  }

  @Override
  public int hashCode() {
    return Objects.hash(number, watchedAt);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AddItemsToWatchedHistoryRequestShowsInnerSeasonsInnerEpisodesInner {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AddItemsToWatchedHistoryRequestShowsInnerSeasonsInnerEpisodesInner
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AddItemsToWatchedHistoryRequestShowsInnerSeasonsInnerEpisodesInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AddItemsToWatchedHistoryRequestShowsInnerSeasonsInnerEpisodesInner is not found in the empty JSON string", AddItemsToWatchedHistoryRequestShowsInnerSeasonsInnerEpisodesInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AddItemsToWatchedHistoryRequestShowsInnerSeasonsInnerEpisodesInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AddItemsToWatchedHistoryRequestShowsInnerSeasonsInnerEpisodesInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AddItemsToWatchedHistoryRequestShowsInnerSeasonsInnerEpisodesInner.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AddItemsToWatchedHistoryRequestShowsInnerSeasonsInnerEpisodesInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AddItemsToWatchedHistoryRequestShowsInnerSeasonsInnerEpisodesInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AddItemsToWatchedHistoryRequestShowsInnerSeasonsInnerEpisodesInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AddItemsToWatchedHistoryRequestShowsInnerSeasonsInnerEpisodesInner.class));

       return (TypeAdapter<T>) new TypeAdapter<AddItemsToWatchedHistoryRequestShowsInnerSeasonsInnerEpisodesInner>() {
           @Override
           public void write(JsonWriter out, AddItemsToWatchedHistoryRequestShowsInnerSeasonsInnerEpisodesInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AddItemsToWatchedHistoryRequestShowsInnerSeasonsInnerEpisodesInner read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AddItemsToWatchedHistoryRequestShowsInnerSeasonsInnerEpisodesInner given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AddItemsToWatchedHistoryRequestShowsInnerSeasonsInnerEpisodesInner
   * @throws IOException if the JSON string is invalid with respect to AddItemsToWatchedHistoryRequestShowsInnerSeasonsInnerEpisodesInner
   */
  public static AddItemsToWatchedHistoryRequestShowsInnerSeasonsInnerEpisodesInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AddItemsToWatchedHistoryRequestShowsInnerSeasonsInnerEpisodesInner.class);
  }

  /**
   * Convert an instance of AddItemsToWatchedHistoryRequestShowsInnerSeasonsInnerEpisodesInner to an JSON string
   *
   * @return JSON string
   */
