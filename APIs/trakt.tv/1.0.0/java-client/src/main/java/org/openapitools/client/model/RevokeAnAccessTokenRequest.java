...
public class RevokeAnAccessTokenRequest {
  ...
  public RevokeAnAccessTokenRequest() {
  }

  public RevokeAnAccessTokenRequest clientId(String clientId) {
  ...
  public RevokeAnAccessTokenRequest clientSecret(String clientSecret) {
  ...
  public RevokeAnAccessTokenRequest token(String token) {
    this.token = token;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    RevokeAnAccessTokenRequest revokeAnAccessTokenRequest = (RevokeAnAccessTokenRequest) o;
    return Objects.equals(this.clientId, revokeAnAccessTokenRequest.clientId) &&
        Objects.equals(this.clientSecret, revokeAnAccessTokenRequest.clientSecret) &&
        Objects.equals(this.token, revokeAnAccessTokenRequest.token);
  }
  ...
  public String toString() {
    ...
    sb.append("class RevokeAnAccessTokenRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to RevokeAnAccessTokenRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RevokeAnAccessTokenRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in RevokeAnAccessTokenRequest is not found in the empty JSON string", RevokeAnAccessTokenRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RevokeAnAccessTokenRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `RevokeAnAccessTokenRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RevokeAnAccessTokenRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RevokeAnAccessTokenRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RevokeAnAccessTokenRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RevokeAnAccessTokenRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<RevokeAnAccessTokenRequest>() {
           @Override
           public void write(JsonWriter out, RevokeAnAccessTokenRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public RevokeAnAccessTokenRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of RevokeAnAccessTokenRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of RevokeAnAccessTokenRequest
   * @throws IOException if the JSON string is invalid with respect to RevokeAnAccessTokenRequest
   */
  public static RevokeAnAccessTokenRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RevokeAnAccessTokenRequest.class);
  }

  /**
   * Convert an instance of RevokeAnAccessTokenRequest to an JSON string
   *
   * @return JSON string
   */
