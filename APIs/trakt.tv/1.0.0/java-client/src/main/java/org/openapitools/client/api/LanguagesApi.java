...
public class LanguagesApi {
     ...
     */
    public okhttp3.Call getLanguagesCall(String type, String traktApiVersion, String traktApiKey, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/languages/{type}"
    ...
    private okhttp3.Call getLanguagesValidateBeforeCall(String type, String traktApiVersion, String traktApiKey, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'type' is set
        if (type == null) {
            throw new ApiException("Missing the required parameter 'type' when calling getLanguages(Async)");
        }

        return getLanguagesCall(type, traktApiVersion, traktApiKey, _callback);
     ...
     */
    public void getLanguages(String type, String traktApiVersion, String traktApiKey) throws ApiException {
        getLanguagesWithHttpInfo(type, traktApiVersion, traktApiKey);
    }
     ...
     */
    public ApiResponse<Void> getLanguagesWithHttpInfo(String type, String traktApiVersion, String traktApiKey) throws ApiException {
        okhttp3.Call localVarCall = getLanguagesValidateBeforeCall(type, traktApiVersion, traktApiKey, null);
     ...
     */
    public okhttp3.Call getLanguagesAsync(String type, String traktApiVersion, String traktApiKey, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = getLanguagesValidateBeforeCall(type, traktApiVersion, traktApiKey, _callback);
