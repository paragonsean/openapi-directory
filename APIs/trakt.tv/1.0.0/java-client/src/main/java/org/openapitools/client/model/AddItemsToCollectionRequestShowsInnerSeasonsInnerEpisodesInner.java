...
public class AddItemsToCollectionRequestShowsInnerSeasonsInnerEpisodesInner {
  ...
  public AddItemsToCollectionRequestShowsInnerSeasonsInnerEpisodesInner() {
  }

  public AddItemsToCollectionRequestShowsInnerSeasonsInnerEpisodesInner audio(String audio) {
    this.audio = audio;
    return this;
  }
  ...
  public AddItemsToCollectionRequestShowsInnerSeasonsInnerEpisodesInner audioChannels(String audioChannels) {
  ...
  public AddItemsToCollectionRequestShowsInnerSeasonsInnerEpisodesInner mediaType(String mediaType) {
  ...
  public AddItemsToCollectionRequestShowsInnerSeasonsInnerEpisodesInner number(BigDecimal number) {
    this.number = number;
    return this;
  }
  ...
  public AddItemsToCollectionRequestShowsInnerSeasonsInnerEpisodesInner resolution(String resolution) {
  ...
  public boolean equals(Object o) {
    ...
    AddItemsToCollectionRequestShowsInnerSeasonsInnerEpisodesInner addItemsToCollectionRequestShowsInnerSeasonsInnerEpisodesInner = (AddItemsToCollectionRequestShowsInnerSeasonsInnerEpisodesInner) o;
    return Objects.equals(this.audio, addItemsToCollectionRequestShowsInnerSeasonsInnerEpisodesInner.audio) &&
        Objects.equals(this.audioChannels, addItemsToCollectionRequestShowsInnerSeasonsInnerEpisodesInner.audioChannels) &&
        Objects.equals(this.mediaType, addItemsToCollectionRequestShowsInnerSeasonsInnerEpisodesInner.mediaType) &&
        Objects.equals(this.number, addItemsToCollectionRequestShowsInnerSeasonsInnerEpisodesInner.number) &&
        Objects.equals(this.resolution, addItemsToCollectionRequestShowsInnerSeasonsInnerEpisodesInner.resolution);
  }

  @Override
  public int hashCode() {
    return Objects.hash(audio, audioChannels, mediaType, number, resolution);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AddItemsToCollectionRequestShowsInnerSeasonsInnerEpisodesInner {\n");
  ...
  static {
    ...
    openapiFields.add("audio_channels");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AddItemsToCollectionRequestShowsInnerSeasonsInnerEpisodesInner
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AddItemsToCollectionRequestShowsInnerSeasonsInnerEpisodesInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AddItemsToCollectionRequestShowsInnerSeasonsInnerEpisodesInner is not found in the empty JSON string", AddItemsToCollectionRequestShowsInnerSeasonsInnerEpisodesInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AddItemsToCollectionRequestShowsInnerSeasonsInnerEpisodesInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AddItemsToCollectionRequestShowsInnerSeasonsInnerEpisodesInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AddItemsToCollectionRequestShowsInnerSeasonsInnerEpisodesInner.openapiRequiredFields) {
      ...
      if ((jsonObj.get("audio_channels") != null && !jsonObj.get("audio_channels").isJsonNull()) && !jsonObj.get("audio_channels").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `audio_channels` to be a primitive type in the JSON string but got `%s`", jsonObj.get("audio_channels").toString()));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AddItemsToCollectionRequestShowsInnerSeasonsInnerEpisodesInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AddItemsToCollectionRequestShowsInnerSeasonsInnerEpisodesInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AddItemsToCollectionRequestShowsInnerSeasonsInnerEpisodesInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AddItemsToCollectionRequestShowsInnerSeasonsInnerEpisodesInner.class));

       return (TypeAdapter<T>) new TypeAdapter<AddItemsToCollectionRequestShowsInnerSeasonsInnerEpisodesInner>() {
           @Override
           public void write(JsonWriter out, AddItemsToCollectionRequestShowsInnerSeasonsInnerEpisodesInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AddItemsToCollectionRequestShowsInnerSeasonsInnerEpisodesInner read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AddItemsToCollectionRequestShowsInnerSeasonsInnerEpisodesInner given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AddItemsToCollectionRequestShowsInnerSeasonsInnerEpisodesInner
   * @throws IOException if the JSON string is invalid with respect to AddItemsToCollectionRequestShowsInnerSeasonsInnerEpisodesInner
   */
  public static AddItemsToCollectionRequestShowsInnerSeasonsInnerEpisodesInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AddItemsToCollectionRequestShowsInnerSeasonsInnerEpisodesInner.class);
  }

  /**
   * Convert an instance of AddItemsToCollectionRequestShowsInnerSeasonsInnerEpisodesInner to an JSON string
   *
   * @return JSON string
   */
