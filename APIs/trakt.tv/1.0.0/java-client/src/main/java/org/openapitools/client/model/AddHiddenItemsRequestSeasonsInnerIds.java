...
public class AddHiddenItemsRequestSeasonsInnerIds {
  public static final String SERIALIZED_NAME_TRAKT = "trakt";
  @SerializedName(SERIALIZED_NAME_TRAKT)
  private BigDecimal trakt;

  public AddHiddenItemsRequestSeasonsInnerIds() {
  }

  public AddHiddenItemsRequestSeasonsInnerIds trakt(BigDecimal trakt) {
    this.trakt = trakt;
    return this;
  }
  ...
  public BigDecimal getTrakt() {
    return trakt;
  }

  public void setTrakt(BigDecimal trakt) {
    this.trakt = trakt;
  }
  ...
  public boolean equals(Object o) {
    ...
    AddHiddenItemsRequestSeasonsInnerIds addHiddenItemsRequestSeasonsInnerIds = (AddHiddenItemsRequestSeasonsInnerIds) o;
    return Objects.equals(this.trakt, addHiddenItemsRequestSeasonsInnerIds.trakt);
  }

  @Override
  public int hashCode() {
    return Objects.hash(trakt);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AddHiddenItemsRequestSeasonsInnerIds {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AddHiddenItemsRequestSeasonsInnerIds
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AddHiddenItemsRequestSeasonsInnerIds.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AddHiddenItemsRequestSeasonsInnerIds is not found in the empty JSON string", AddHiddenItemsRequestSeasonsInnerIds.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AddHiddenItemsRequestSeasonsInnerIds.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AddHiddenItemsRequestSeasonsInnerIds` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AddHiddenItemsRequestSeasonsInnerIds.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AddHiddenItemsRequestSeasonsInnerIds' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AddHiddenItemsRequestSeasonsInnerIds> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AddHiddenItemsRequestSeasonsInnerIds.class));

       return (TypeAdapter<T>) new TypeAdapter<AddHiddenItemsRequestSeasonsInnerIds>() {
           @Override
           public void write(JsonWriter out, AddHiddenItemsRequestSeasonsInnerIds value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AddHiddenItemsRequestSeasonsInnerIds read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AddHiddenItemsRequestSeasonsInnerIds given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AddHiddenItemsRequestSeasonsInnerIds
   * @throws IOException if the JSON string is invalid with respect to AddHiddenItemsRequestSeasonsInnerIds
   */
  public static AddHiddenItemsRequestSeasonsInnerIds fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AddHiddenItemsRequestSeasonsInnerIds.class);
  }

  /**
   * Convert an instance of AddHiddenItemsRequestSeasonsInnerIds to an JSON string
   *
   * @return JSON string
   */
