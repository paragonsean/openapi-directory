...
import org.openapitools.client.model.AddItemsToCollectionRequestEpisodesInner;
import org.openapitools.client.model.AddItemsToCollectionRequestSeasonsInner;
import org.openapitools.client.model.AddItemsToPersonalListRequestPeopleInner;
import org.openapitools.client.model.RemoveItemsFromPersonalListRequestMoviesInner;
import org.openapitools.client.model.RemoveItemsFromPersonalListRequestShowsInner;
...
public class RemoveItemsFromPersonalListRequest {
  public static final String SERIALIZED_NAME_EPISODES = "episodes";
  @SerializedName(SERIALIZED_NAME_EPISODES)
  private List<AddItemsToCollectionRequestEpisodesInner> episodes = new ArrayList<>();

  public static final String SERIALIZED_NAME_MOVIES = "movies";
  @SerializedName(SERIALIZED_NAME_MOVIES)
  private List<RemoveItemsFromPersonalListRequestMoviesInner> movies = new ArrayList<>();

  public static final String SERIALIZED_NAME_PEOPLE = "people";
  @SerializedName(SERIALIZED_NAME_PEOPLE)
  private List<AddItemsToPersonalListRequestPeopleInner> people = new ArrayList<>();

  public static final String SERIALIZED_NAME_SEASONS = "seasons";
  @SerializedName(SERIALIZED_NAME_SEASONS)
  private List<AddItemsToCollectionRequestSeasonsInner> seasons = new ArrayList<>();

  public static final String SERIALIZED_NAME_SHOWS = "shows";
  @SerializedName(SERIALIZED_NAME_SHOWS)
  private List<RemoveItemsFromPersonalListRequestShowsInner> shows = new ArrayList<>();

  public RemoveItemsFromPersonalListRequest() {
  }

  public RemoveItemsFromPersonalListRequest episodes(List<AddItemsToCollectionRequestEpisodesInner> episodes) {
    this.episodes = episodes;
    return this;
  }

  public RemoveItemsFromPersonalListRequest addEpisodesItem(AddItemsToCollectionRequestEpisodesInner episodesItem) {
  ...
  public List<AddItemsToCollectionRequestEpisodesInner> getEpisodes() {
    return episodes;
  }

  public void setEpisodes(List<AddItemsToCollectionRequestEpisodesInner> episodes) {
    this.episodes = episodes;
  }


  public RemoveItemsFromPersonalListRequest movies(List<RemoveItemsFromPersonalListRequestMoviesInner> movies) {
    this.movies = movies;
    return this;
  }

  public RemoveItemsFromPersonalListRequest addMoviesItem(RemoveItemsFromPersonalListRequestMoviesInner moviesItem) {
    if (this.movies == null) {
   ...
   */
  @javax.annotation.Nullable
  public List<RemoveItemsFromPersonalListRequestMoviesInner> getMovies() {
    return movies;
  }

  public void setMovies(List<RemoveItemsFromPersonalListRequestMoviesInner> movies) {
    this.movies = movies;
  }


  public RemoveItemsFromPersonalListRequest people(List<AddItemsToPersonalListRequestPeopleInner> people) {
    this.people = people;
    return this;
  }

  public RemoveItemsFromPersonalListRequest addPeopleItem(AddItemsToPersonalListRequestPeopleInner peopleItem) {
    if (this.people == null) {
   ...
   */
  @javax.annotation.Nullable
  public List<AddItemsToPersonalListRequestPeopleInner> getPeople() {
    return people;
  }

  public void setPeople(List<AddItemsToPersonalListRequestPeopleInner> people) {
    this.people = people;
  }


  public RemoveItemsFromPersonalListRequest seasons(List<AddItemsToCollectionRequestSeasonsInner> seasons) {
    this.seasons = seasons;
    return this;
  }

  public RemoveItemsFromPersonalListRequest addSeasonsItem(AddItemsToCollectionRequestSeasonsInner seasonsItem) {
   ...
   */
  @javax.annotation.Nullable
  public List<AddItemsToCollectionRequestSeasonsInner> getSeasons() {
    return seasons;
  }

  public void setSeasons(List<AddItemsToCollectionRequestSeasonsInner> seasons) {
    this.seasons = seasons;
  }


  public RemoveItemsFromPersonalListRequest shows(List<RemoveItemsFromPersonalListRequestShowsInner> shows) {
    this.shows = shows;
    return this;
  }

  public RemoveItemsFromPersonalListRequest addShowsItem(RemoveItemsFromPersonalListRequestShowsInner showsItem) {
    if (this.shows == null) {
   ...
   */
  @javax.annotation.Nullable
  public List<RemoveItemsFromPersonalListRequestShowsInner> getShows() {
    return shows;
  }

  public void setShows(List<RemoveItemsFromPersonalListRequestShowsInner> shows) {
    this.shows = shows;
  }
  ...
  public boolean equals(Object o) {
    ...
    RemoveItemsFromPersonalListRequest removeItemsFromPersonalListRequest = (RemoveItemsFromPersonalListRequest) o;
    return Objects.equals(this.episodes, removeItemsFromPersonalListRequest.episodes) &&
        Objects.equals(this.movies, removeItemsFromPersonalListRequest.movies) &&
        Objects.equals(this.people, removeItemsFromPersonalListRequest.people) &&
        Objects.equals(this.seasons, removeItemsFromPersonalListRequest.seasons) &&
        Objects.equals(this.shows, removeItemsFromPersonalListRequest.shows);
  }

  @Override
  public int hashCode() {
    return Objects.hash(episodes, movies, people, seasons, shows);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class RemoveItemsFromPersonalListRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to RemoveItemsFromPersonalListRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RemoveItemsFromPersonalListRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in RemoveItemsFromPersonalListRequest is not found in the empty JSON string", RemoveItemsFromPersonalListRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RemoveItemsFromPersonalListRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `RemoveItemsFromPersonalListRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("episodes") != null && !jsonObj.get("episodes").isJsonNull()) {
        ...
        if (jsonArrayepisodes != null) {
          ...
          for (int i = 0; i < jsonArrayepisodes.size(); i++) {
            AddItemsToCollectionRequestEpisodesInner.validateJsonElement(jsonArrayepisodes.get(i));
          };
        }
      }
      if (jsonObj.get("movies") != null && !jsonObj.get("movies").isJsonNull()) {
        ...
        if (jsonArraymovies != null) {
          ...
          for (int i = 0; i < jsonArraymovies.size(); i++) {
            RemoveItemsFromPersonalListRequestMoviesInner.validateJsonElement(jsonArraymovies.get(i));
          };
        }
      }
      if (jsonObj.get("people") != null && !jsonObj.get("people").isJsonNull()) {
        ...
        if (jsonArraypeople != null) {
          ...
          for (int i = 0; i < jsonArraypeople.size(); i++) {
            AddItemsToPersonalListRequestPeopleInner.validateJsonElement(jsonArraypeople.get(i));
          };
        }
      }
      if (jsonObj.get("seasons") != null && !jsonObj.get("seasons").isJsonNull()) {
        ...
        if (jsonArrayseasons != null) {
          ...
          for (int i = 0; i < jsonArrayseasons.size(); i++) {
            AddItemsToCollectionRequestSeasonsInner.validateJsonElement(jsonArrayseasons.get(i));
          };
        }
      }
      if (jsonObj.get("shows") != null && !jsonObj.get("shows").isJsonNull()) {
        ...
        if (jsonArrayshows != null) {
          ...
          for (int i = 0; i < jsonArrayshows.size(); i++) {
            RemoveItemsFromPersonalListRequestShowsInner.validateJsonElement(jsonArrayshows.get(i));
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RemoveItemsFromPersonalListRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RemoveItemsFromPersonalListRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RemoveItemsFromPersonalListRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RemoveItemsFromPersonalListRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<RemoveItemsFromPersonalListRequest>() {
           @Override
           public void write(JsonWriter out, RemoveItemsFromPersonalListRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public RemoveItemsFromPersonalListRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of RemoveItemsFromPersonalListRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of RemoveItemsFromPersonalListRequest
   * @throws IOException if the JSON string is invalid with respect to RemoveItemsFromPersonalListRequest
   */
  public static RemoveItemsFromPersonalListRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RemoveItemsFromPersonalListRequest.class);
  }

  /**
   * Convert an instance of RemoveItemsFromPersonalListRequest to an JSON string
   *
   * @return JSON string
   */
