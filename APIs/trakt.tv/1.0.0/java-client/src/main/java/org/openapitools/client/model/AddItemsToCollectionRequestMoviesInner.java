...
public class AddItemsToCollectionRequestMoviesInner {
  ...
  public AddItemsToCollectionRequestMoviesInner() {
  }

  public AddItemsToCollectionRequestMoviesInner audio(String audio) {
    this.audio = audio;
    return this;
  }
  ...
  public AddItemsToCollectionRequestMoviesInner audioChannels(String audioChannels) {
  ...
  public AddItemsToCollectionRequestMoviesInner collectedAt(String collectedAt) {
  ...
  public AddItemsToCollectionRequestMoviesInner hdr(String hdr) {
    this.hdr = hdr;
    return this;
  }
  ...
  public AddItemsToCollectionRequestMoviesInner ids(CheckIntoAnItemRequestMovieIds ids) {
    this.ids = ids;
    return this;
  }
  ...
  public AddItemsToCollectionRequestMoviesInner mediaType(String mediaType) {
  ...
  public AddItemsToCollectionRequestMoviesInner resolution(String resolution) {
  ...
  public AddItemsToCollectionRequestMoviesInner title(String title) {
    this.title = title;
    return this;
  }
  ...
  public AddItemsToCollectionRequestMoviesInner year(BigDecimal year) {
    this.year = year;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    AddItemsToCollectionRequestMoviesInner addItemsToCollectionRequestMoviesInner = (AddItemsToCollectionRequestMoviesInner) o;
    return Objects.equals(this.audio, addItemsToCollectionRequestMoviesInner.audio) &&
        Objects.equals(this.audioChannels, addItemsToCollectionRequestMoviesInner.audioChannels) &&
        Objects.equals(this.collectedAt, addItemsToCollectionRequestMoviesInner.collectedAt) &&
        Objects.equals(this.hdr, addItemsToCollectionRequestMoviesInner.hdr) &&
        Objects.equals(this.ids, addItemsToCollectionRequestMoviesInner.ids) &&
        Objects.equals(this.mediaType, addItemsToCollectionRequestMoviesInner.mediaType) &&
        Objects.equals(this.resolution, addItemsToCollectionRequestMoviesInner.resolution) &&
        Objects.equals(this.title, addItemsToCollectionRequestMoviesInner.title) &&
        Objects.equals(this.year, addItemsToCollectionRequestMoviesInner.year);
  }

  @Override
  public int hashCode() {
    return Objects.hash(audio, audioChannels, collectedAt, hdr, ids, mediaType, resolution, title, year);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AddItemsToCollectionRequestMoviesInner {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AddItemsToCollectionRequestMoviesInner
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AddItemsToCollectionRequestMoviesInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AddItemsToCollectionRequestMoviesInner is not found in the empty JSON string", AddItemsToCollectionRequestMoviesInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AddItemsToCollectionRequestMoviesInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AddItemsToCollectionRequestMoviesInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AddItemsToCollectionRequestMoviesInner.openapiRequiredFields) {
      ...
      if ((jsonObj.get("collected_at") != null && !jsonObj.get("collected_at").isJsonNull()) && !jsonObj.get("collected_at").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `collected_at` to be a primitive type in the JSON string but got `%s`", jsonObj.get("collected_at").toString()));
      }
      if ((jsonObj.get("hdr") != null && !jsonObj.get("hdr").isJsonNull()) && !jsonObj.get("hdr").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `hdr` to be a primitive type in the JSON string but got `%s`", jsonObj.get("hdr").toString()));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AddItemsToCollectionRequestMoviesInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AddItemsToCollectionRequestMoviesInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AddItemsToCollectionRequestMoviesInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AddItemsToCollectionRequestMoviesInner.class));

       return (TypeAdapter<T>) new TypeAdapter<AddItemsToCollectionRequestMoviesInner>() {
           @Override
           public void write(JsonWriter out, AddItemsToCollectionRequestMoviesInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AddItemsToCollectionRequestMoviesInner read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AddItemsToCollectionRequestMoviesInner given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AddItemsToCollectionRequestMoviesInner
   * @throws IOException if the JSON string is invalid with respect to AddItemsToCollectionRequestMoviesInner
   */
  public static AddItemsToCollectionRequestMoviesInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AddItemsToCollectionRequestMoviesInner.class);
  }

  /**
   * Convert an instance of AddItemsToCollectionRequestMoviesInner to an JSON string
   *
   * @return JSON string
   */
