...
import org.openapitools.client.model.AddNewRatingsRequestEpisodesInner;
import org.openapitools.client.model.AddNewRatingsRequestMoviesInner;
import org.openapitools.client.model.AddNewRatingsRequestSeasonsInner;
import org.openapitools.client.model.AddNewRatingsRequestShowsInner;
...
public class AddNewRatingsRequest {
  public static final String SERIALIZED_NAME_EPISODES = "episodes";
  @SerializedName(SERIALIZED_NAME_EPISODES)
  private List<AddNewRatingsRequestEpisodesInner> episodes = new ArrayList<>();

  public static final String SERIALIZED_NAME_MOVIES = "movies";
  @SerializedName(SERIALIZED_NAME_MOVIES)
  private List<AddNewRatingsRequestMoviesInner> movies = new ArrayList<>();

  public static final String SERIALIZED_NAME_SEASONS = "seasons";
  @SerializedName(SERIALIZED_NAME_SEASONS)
  private List<AddNewRatingsRequestSeasonsInner> seasons = new ArrayList<>();

  public static final String SERIALIZED_NAME_SHOWS = "shows";
  @SerializedName(SERIALIZED_NAME_SHOWS)
  private List<AddNewRatingsRequestShowsInner> shows = new ArrayList<>();

  public AddNewRatingsRequest() {
  }

  public AddNewRatingsRequest episodes(List<AddNewRatingsRequestEpisodesInner> episodes) {
    this.episodes = episodes;
    return this;
  }

  public AddNewRatingsRequest addEpisodesItem(AddNewRatingsRequestEpisodesInner episodesItem) {
  ...
  public List<AddNewRatingsRequestEpisodesInner> getEpisodes() {
    return episodes;
  }

  public void setEpisodes(List<AddNewRatingsRequestEpisodesInner> episodes) {
    this.episodes = episodes;
  }


  public AddNewRatingsRequest movies(List<AddNewRatingsRequestMoviesInner> movies) {
    this.movies = movies;
    return this;
  }

  public AddNewRatingsRequest addMoviesItem(AddNewRatingsRequestMoviesInner moviesItem) {
    if (this.movies == null) {
   ...
   */
  @javax.annotation.Nullable
  public List<AddNewRatingsRequestMoviesInner> getMovies() {
    return movies;
  }

  public void setMovies(List<AddNewRatingsRequestMoviesInner> movies) {
    this.movies = movies;
  }


  public AddNewRatingsRequest seasons(List<AddNewRatingsRequestSeasonsInner> seasons) {
    this.seasons = seasons;
    return this;
  }

  public AddNewRatingsRequest addSeasonsItem(AddNewRatingsRequestSeasonsInner seasonsItem) {
   ...
   */
  @javax.annotation.Nullable
  public List<AddNewRatingsRequestSeasonsInner> getSeasons() {
    return seasons;
  }

  public void setSeasons(List<AddNewRatingsRequestSeasonsInner> seasons) {
    this.seasons = seasons;
  }


  public AddNewRatingsRequest shows(List<AddNewRatingsRequestShowsInner> shows) {
    this.shows = shows;
    return this;
  }

  public AddNewRatingsRequest addShowsItem(AddNewRatingsRequestShowsInner showsItem) {
    if (this.shows == null) {
   ...
   */
  @javax.annotation.Nullable
  public List<AddNewRatingsRequestShowsInner> getShows() {
    return shows;
  }

  public void setShows(List<AddNewRatingsRequestShowsInner> shows) {
    this.shows = shows;
  }
  ...
  public boolean equals(Object o) {
    ...
    AddNewRatingsRequest addNewRatingsRequest = (AddNewRatingsRequest) o;
    return Objects.equals(this.episodes, addNewRatingsRequest.episodes) &&
        Objects.equals(this.movies, addNewRatingsRequest.movies) &&
        Objects.equals(this.seasons, addNewRatingsRequest.seasons) &&
        Objects.equals(this.shows, addNewRatingsRequest.shows);
  }
  ...
  public String toString() {
    ...
    sb.append("class AddNewRatingsRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AddNewRatingsRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AddNewRatingsRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AddNewRatingsRequest is not found in the empty JSON string", AddNewRatingsRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AddNewRatingsRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AddNewRatingsRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("episodes") != null && !jsonObj.get("episodes").isJsonNull()) {
        ...
        if (jsonArrayepisodes != null) {
          ...
          for (int i = 0; i < jsonArrayepisodes.size(); i++) {
            AddNewRatingsRequestEpisodesInner.validateJsonElement(jsonArrayepisodes.get(i));
          };
        }
      }
      if (jsonObj.get("movies") != null && !jsonObj.get("movies").isJsonNull()) {
        ...
        if (jsonArraymovies != null) {
          ...
          for (int i = 0; i < jsonArraymovies.size(); i++) {
            AddNewRatingsRequestMoviesInner.validateJsonElement(jsonArraymovies.get(i));
          };
        }
      }
      if (jsonObj.get("seasons") != null && !jsonObj.get("seasons").isJsonNull()) {
        ...
        if (jsonArrayseasons != null) {
          ...
          for (int i = 0; i < jsonArrayseasons.size(); i++) {
            AddNewRatingsRequestSeasonsInner.validateJsonElement(jsonArrayseasons.get(i));
          };
        }
      }
      if (jsonObj.get("shows") != null && !jsonObj.get("shows").isJsonNull()) {
        ...
        if (jsonArrayshows != null) {
          ...
          for (int i = 0; i < jsonArrayshows.size(); i++) {
            AddNewRatingsRequestShowsInner.validateJsonElement(jsonArrayshows.get(i));
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AddNewRatingsRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AddNewRatingsRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AddNewRatingsRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AddNewRatingsRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<AddNewRatingsRequest>() {
           @Override
           public void write(JsonWriter out, AddNewRatingsRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AddNewRatingsRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AddNewRatingsRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AddNewRatingsRequest
   * @throws IOException if the JSON string is invalid with respect to AddNewRatingsRequest
   */
  public static AddNewRatingsRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AddNewRatingsRequest.class);
  }

  /**
   * Convert an instance of AddNewRatingsRequest to an JSON string
   *
   * @return JSON string
   */
