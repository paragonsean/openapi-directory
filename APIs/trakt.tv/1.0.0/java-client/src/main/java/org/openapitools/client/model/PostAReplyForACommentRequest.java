...
public class PostAReplyForACommentRequest {
  ...
  public PostAReplyForACommentRequest() {
  }

  public PostAReplyForACommentRequest comment(String comment) {
  ...
  public PostAReplyForACommentRequest spoiler(Boolean spoiler) {
  ...
  public boolean equals(Object o) {
    ...
    PostAReplyForACommentRequest postAReplyForACommentRequest = (PostAReplyForACommentRequest) o;
    return Objects.equals(this.comment, postAReplyForACommentRequest.comment) &&
        Objects.equals(this.spoiler, postAReplyForACommentRequest.spoiler);
  }

  @Override
  public int hashCode() {
    return Objects.hash(comment, spoiler);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class PostAReplyForACommentRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PostAReplyForACommentRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PostAReplyForACommentRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PostAReplyForACommentRequest is not found in the empty JSON string", PostAReplyForACommentRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PostAReplyForACommentRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PostAReplyForACommentRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PostAReplyForACommentRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PostAReplyForACommentRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PostAReplyForACommentRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PostAReplyForACommentRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<PostAReplyForACommentRequest>() {
           @Override
           public void write(JsonWriter out, PostAReplyForACommentRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PostAReplyForACommentRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PostAReplyForACommentRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PostAReplyForACommentRequest
   * @throws IOException if the JSON string is invalid with respect to PostAReplyForACommentRequest
   */
  public static PostAReplyForACommentRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PostAReplyForACommentRequest.class);
  }

  /**
   * Convert an instance of PostAReplyForACommentRequest to an JSON string
   *
   * @return JSON string
   */
