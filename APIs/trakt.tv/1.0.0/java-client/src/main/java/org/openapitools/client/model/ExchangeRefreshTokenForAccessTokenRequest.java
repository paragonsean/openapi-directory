...
public class ExchangeRefreshTokenForAccessTokenRequest {
  ...
  public ExchangeRefreshTokenForAccessTokenRequest() {
  }

  public ExchangeRefreshTokenForAccessTokenRequest clientId(String clientId) {
  ...
  public ExchangeRefreshTokenForAccessTokenRequest clientSecret(String clientSecret) {
  ...
  public ExchangeRefreshTokenForAccessTokenRequest grantType(String grantType) {
  ...
  public ExchangeRefreshTokenForAccessTokenRequest redirectUri(String redirectUri) {
  ...
  public ExchangeRefreshTokenForAccessTokenRequest refreshToken(String refreshToken) {
  ...
  public boolean equals(Object o) {
    ...
    ExchangeRefreshTokenForAccessTokenRequest exchangeRefreshTokenForAccessTokenRequest = (ExchangeRefreshTokenForAccessTokenRequest) o;
    return Objects.equals(this.clientId, exchangeRefreshTokenForAccessTokenRequest.clientId) &&
        Objects.equals(this.clientSecret, exchangeRefreshTokenForAccessTokenRequest.clientSecret) &&
        Objects.equals(this.grantType, exchangeRefreshTokenForAccessTokenRequest.grantType) &&
        Objects.equals(this.redirectUri, exchangeRefreshTokenForAccessTokenRequest.redirectUri) &&
        Objects.equals(this.refreshToken, exchangeRefreshTokenForAccessTokenRequest.refreshToken);
  }

  @Override
  public int hashCode() {
    return Objects.hash(clientId, clientSecret, grantType, redirectUri, refreshToken);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ExchangeRefreshTokenForAccessTokenRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ExchangeRefreshTokenForAccessTokenRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ExchangeRefreshTokenForAccessTokenRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ExchangeRefreshTokenForAccessTokenRequest is not found in the empty JSON string", ExchangeRefreshTokenForAccessTokenRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ExchangeRefreshTokenForAccessTokenRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ExchangeRefreshTokenForAccessTokenRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ExchangeRefreshTokenForAccessTokenRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ExchangeRefreshTokenForAccessTokenRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ExchangeRefreshTokenForAccessTokenRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ExchangeRefreshTokenForAccessTokenRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<ExchangeRefreshTokenForAccessTokenRequest>() {
           @Override
           public void write(JsonWriter out, ExchangeRefreshTokenForAccessTokenRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ExchangeRefreshTokenForAccessTokenRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ExchangeRefreshTokenForAccessTokenRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ExchangeRefreshTokenForAccessTokenRequest
   * @throws IOException if the JSON string is invalid with respect to ExchangeRefreshTokenForAccessTokenRequest
   */
  public static ExchangeRefreshTokenForAccessTokenRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ExchangeRefreshTokenForAccessTokenRequest.class);
  }

  /**
   * Convert an instance of ExchangeRefreshTokenForAccessTokenRequest to an JSON string
   *
   * @return JSON string
   */
