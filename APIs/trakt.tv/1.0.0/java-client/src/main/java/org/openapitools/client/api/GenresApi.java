...
public class GenresApi {
     ...
     */
    public okhttp3.Call getGenresCall(String type, String traktApiVersion, String traktApiKey, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/genres/{type}"
    ...
    private okhttp3.Call getGenresValidateBeforeCall(String type, String traktApiVersion, String traktApiKey, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'type' is set
        if (type == null) {
            throw new ApiException("Missing the required parameter 'type' when calling getGenres(Async)");
        }

        return getGenresCall(type, traktApiVersion, traktApiKey, _callback);
     ...
     */
    public void getGenres(String type, String traktApiVersion, String traktApiKey) throws ApiException {
        getGenresWithHttpInfo(type, traktApiVersion, traktApiKey);
    }
     ...
     */
    public ApiResponse<Void> getGenresWithHttpInfo(String type, String traktApiVersion, String traktApiKey) throws ApiException {
        okhttp3.Call localVarCall = getGenresValidateBeforeCall(type, traktApiVersion, traktApiKey, null);
        return localVarApiClient.execute(localVarCall);
    }

    /**
     * Get genres (asynchronously)
     * Get a list of all genres, including names and slugs.
     * @param type  (required)
     * @param traktApiVersion e.g. 2 (optional)
     * @param traktApiKey e.g. [client_id] (optional)
     ...
     */
    public okhttp3.Call getGenresAsync(String type, String traktApiVersion, String traktApiKey, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = getGenresValidateBeforeCall(type, traktApiVersion, traktApiKey, _callback);
