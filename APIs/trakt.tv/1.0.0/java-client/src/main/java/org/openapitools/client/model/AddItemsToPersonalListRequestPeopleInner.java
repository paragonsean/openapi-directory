...
import org.openapitools.client.model.CheckIntoAnItemRequestMovieIds;
...
public class AddItemsToPersonalListRequestPeopleInner {
  public static final String SERIALIZED_NAME_IDS = "ids";
  @SerializedName(SERIALIZED_NAME_IDS)
  private CheckIntoAnItemRequestMovieIds ids;

  public static final String SERIALIZED_NAME_NAME = "name";
  @SerializedName(SERIALIZED_NAME_NAME)
  private String name;

  public AddItemsToPersonalListRequestPeopleInner() {
  }

  public AddItemsToPersonalListRequestPeopleInner ids(CheckIntoAnItemRequestMovieIds ids) {
    this.ids = ids;
    return this;
  }
  ...
  public CheckIntoAnItemRequestMovieIds getIds() {
    return ids;
  }

  public void setIds(CheckIntoAnItemRequestMovieIds ids) {
    this.ids = ids;
  }


  public AddItemsToPersonalListRequestPeopleInner name(String name) {
    this.name = name;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    AddItemsToPersonalListRequestPeopleInner addItemsToPersonalListRequestPeopleInner = (AddItemsToPersonalListRequestPeopleInner) o;
    return Objects.equals(this.ids, addItemsToPersonalListRequestPeopleInner.ids) &&
        Objects.equals(this.name, addItemsToPersonalListRequestPeopleInner.name);
  }
  ...
  public String toString() {
    ...
    sb.append("class AddItemsToPersonalListRequestPeopleInner {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AddItemsToPersonalListRequestPeopleInner
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AddItemsToPersonalListRequestPeopleInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AddItemsToPersonalListRequestPeopleInner is not found in the empty JSON string", AddItemsToPersonalListRequestPeopleInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AddItemsToPersonalListRequestPeopleInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AddItemsToPersonalListRequestPeopleInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `ids`
      if (jsonObj.get("ids") != null && !jsonObj.get("ids").isJsonNull()) {
        CheckIntoAnItemRequestMovieIds.validateJsonElement(jsonObj.get("ids"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AddItemsToPersonalListRequestPeopleInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AddItemsToPersonalListRequestPeopleInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AddItemsToPersonalListRequestPeopleInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AddItemsToPersonalListRequestPeopleInner.class));

       return (TypeAdapter<T>) new TypeAdapter<AddItemsToPersonalListRequestPeopleInner>() {
           @Override
           public void write(JsonWriter out, AddItemsToPersonalListRequestPeopleInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AddItemsToPersonalListRequestPeopleInner read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AddItemsToPersonalListRequestPeopleInner given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AddItemsToPersonalListRequestPeopleInner
   * @throws IOException if the JSON string is invalid with respect to AddItemsToPersonalListRequestPeopleInner
   */
  public static AddItemsToPersonalListRequestPeopleInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AddItemsToPersonalListRequestPeopleInner.class);
  }

  /**
   * Convert an instance of AddItemsToPersonalListRequestPeopleInner to an JSON string
   *
   * @return JSON string
   */
