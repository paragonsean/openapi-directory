...
public class RemoveItemsFromPersonalListRequestMoviesInner {
  public static final String SERIALIZED_NAME_IDS = "ids";
  @SerializedName(SERIALIZED_NAME_IDS)
  private AddItemsToPersonalListRequestMoviesInnerIds ids;

  public RemoveItemsFromPersonalListRequestMoviesInner() {
  }

  public RemoveItemsFromPersonalListRequestMoviesInner ids(AddItemsToPersonalListRequestMoviesInnerIds ids) {
    this.ids = ids;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    RemoveItemsFromPersonalListRequestMoviesInner removeItemsFromPersonalListRequestMoviesInner = (RemoveItemsFromPersonalListRequestMoviesInner) o;
    return Objects.equals(this.ids, removeItemsFromPersonalListRequestMoviesInner.ids);
  }
  ...
  public String toString() {
    ...
    sb.append("class RemoveItemsFromPersonalListRequestMoviesInner {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to RemoveItemsFromPersonalListRequestMoviesInner
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RemoveItemsFromPersonalListRequestMoviesInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in RemoveItemsFromPersonalListRequestMoviesInner is not found in the empty JSON string", RemoveItemsFromPersonalListRequestMoviesInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RemoveItemsFromPersonalListRequestMoviesInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `RemoveItemsFromPersonalListRequestMoviesInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : RemoveItemsFromPersonalListRequestMoviesInner.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RemoveItemsFromPersonalListRequestMoviesInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RemoveItemsFromPersonalListRequestMoviesInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RemoveItemsFromPersonalListRequestMoviesInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RemoveItemsFromPersonalListRequestMoviesInner.class));

       return (TypeAdapter<T>) new TypeAdapter<RemoveItemsFromPersonalListRequestMoviesInner>() {
           @Override
           public void write(JsonWriter out, RemoveItemsFromPersonalListRequestMoviesInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public RemoveItemsFromPersonalListRequestMoviesInner read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of RemoveItemsFromPersonalListRequestMoviesInner given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of RemoveItemsFromPersonalListRequestMoviesInner
   * @throws IOException if the JSON string is invalid with respect to RemoveItemsFromPersonalListRequestMoviesInner
   */
  public static RemoveItemsFromPersonalListRequestMoviesInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RemoveItemsFromPersonalListRequestMoviesInner.class);
  }

  /**
   * Convert an instance of RemoveItemsFromPersonalListRequestMoviesInner to an JSON string
   *
   * @return JSON string
   */
