...
import org.openapitools.client.model.AddItemsToPersonalListRequestMoviesInnerIds;
...
public class AddItemsToPersonalListRequestMoviesInner {
  public static final String SERIALIZED_NAME_IDS = "ids";
  @SerializedName(SERIALIZED_NAME_IDS)
  private AddItemsToPersonalListRequestMoviesInnerIds ids;

  public static final String SERIALIZED_NAME_NOTES = "notes";
  @SerializedName(SERIALIZED_NAME_NOTES)
  private String notes;

  public AddItemsToPersonalListRequestMoviesInner() {
  }

  public AddItemsToPersonalListRequestMoviesInner ids(AddItemsToPersonalListRequestMoviesInnerIds ids) {
    this.ids = ids;
    return this;
  }
  ...
  public AddItemsToPersonalListRequestMoviesInnerIds getIds() {
    return ids;
  }

  public void setIds(AddItemsToPersonalListRequestMoviesInnerIds ids) {
    this.ids = ids;
  }


  public AddItemsToPersonalListRequestMoviesInner notes(String notes) {
    this.notes = notes;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    AddItemsToPersonalListRequestMoviesInner addItemsToPersonalListRequestMoviesInner = (AddItemsToPersonalListRequestMoviesInner) o;
    return Objects.equals(this.ids, addItemsToPersonalListRequestMoviesInner.ids) &&
        Objects.equals(this.notes, addItemsToPersonalListRequestMoviesInner.notes);
  }
  ...
  public String toString() {
    ...
    sb.append("class AddItemsToPersonalListRequestMoviesInner {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AddItemsToPersonalListRequestMoviesInner
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AddItemsToPersonalListRequestMoviesInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AddItemsToPersonalListRequestMoviesInner is not found in the empty JSON string", AddItemsToPersonalListRequestMoviesInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AddItemsToPersonalListRequestMoviesInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AddItemsToPersonalListRequestMoviesInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AddItemsToPersonalListRequestMoviesInner.openapiRequiredFields) {
      ...
      AddItemsToPersonalListRequestMoviesInnerIds.validateJsonElement(jsonObj.get("ids"));
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AddItemsToPersonalListRequestMoviesInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AddItemsToPersonalListRequestMoviesInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AddItemsToPersonalListRequestMoviesInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AddItemsToPersonalListRequestMoviesInner.class));

       return (TypeAdapter<T>) new TypeAdapter<AddItemsToPersonalListRequestMoviesInner>() {
           @Override
           public void write(JsonWriter out, AddItemsToPersonalListRequestMoviesInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AddItemsToPersonalListRequestMoviesInner read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AddItemsToPersonalListRequestMoviesInner given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AddItemsToPersonalListRequestMoviesInner
   * @throws IOException if the JSON string is invalid with respect to AddItemsToPersonalListRequestMoviesInner
   */
  public static AddItemsToPersonalListRequestMoviesInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AddItemsToPersonalListRequestMoviesInner.class);
  }

  /**
   * Convert an instance of AddItemsToPersonalListRequestMoviesInner to an JSON string
   *
   * @return JSON string
   */
