...
public class AddNewRatingsRequestMoviesInner {
  ...
  public AddNewRatingsRequestMoviesInner() {
  }

  public AddNewRatingsRequestMoviesInner ids(CheckIntoAnItemRequestMovieIds ids) {
    this.ids = ids;
    return this;
  }
  ...
  public AddNewRatingsRequestMoviesInner ratedAt(String ratedAt) {
  ...
  public AddNewRatingsRequestMoviesInner rating(BigDecimal rating) {
    this.rating = rating;
    return this;
  }
  ...
  public AddNewRatingsRequestMoviesInner title(String title) {
    this.title = title;
    return this;
  }
  ...
  public AddNewRatingsRequestMoviesInner year(BigDecimal year) {
    this.year = year;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    AddNewRatingsRequestMoviesInner addNewRatingsRequestMoviesInner = (AddNewRatingsRequestMoviesInner) o;
    return Objects.equals(this.ids, addNewRatingsRequestMoviesInner.ids) &&
        Objects.equals(this.ratedAt, addNewRatingsRequestMoviesInner.ratedAt) &&
        Objects.equals(this.rating, addNewRatingsRequestMoviesInner.rating) &&
        Objects.equals(this.title, addNewRatingsRequestMoviesInner.title) &&
        Objects.equals(this.year, addNewRatingsRequestMoviesInner.year);
  }

  @Override
  public int hashCode() {
    return Objects.hash(ids, ratedAt, rating, title, year);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AddNewRatingsRequestMoviesInner {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AddNewRatingsRequestMoviesInner
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AddNewRatingsRequestMoviesInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AddNewRatingsRequestMoviesInner is not found in the empty JSON string", AddNewRatingsRequestMoviesInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AddNewRatingsRequestMoviesInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AddNewRatingsRequestMoviesInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AddNewRatingsRequestMoviesInner.openapiRequiredFields) {
      ...
      if ((jsonObj.get("rated_at") != null && !jsonObj.get("rated_at").isJsonNull()) && !jsonObj.get("rated_at").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `rated_at` to be a primitive type in the JSON string but got `%s`", jsonObj.get("rated_at").toString()));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AddNewRatingsRequestMoviesInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AddNewRatingsRequestMoviesInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AddNewRatingsRequestMoviesInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AddNewRatingsRequestMoviesInner.class));

       return (TypeAdapter<T>) new TypeAdapter<AddNewRatingsRequestMoviesInner>() {
           @Override
           public void write(JsonWriter out, AddNewRatingsRequestMoviesInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AddNewRatingsRequestMoviesInner read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AddNewRatingsRequestMoviesInner given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AddNewRatingsRequestMoviesInner
   * @throws IOException if the JSON string is invalid with respect to AddNewRatingsRequestMoviesInner
   */
  public static AddNewRatingsRequestMoviesInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AddNewRatingsRequestMoviesInner.class);
  }

  /**
   * Convert an instance of AddNewRatingsRequestMoviesInner to an JSON string
   *
   * @return JSON string
   */
