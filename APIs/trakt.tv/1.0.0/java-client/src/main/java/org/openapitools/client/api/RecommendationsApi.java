...
public class RecommendationsApi {
     ...
     * @param ignoreCollected filter out collected movies (optional)
     * @param ignoreWatchlisted filter out watchlisted movies (optional)
     ...
     */
    public okhttp3.Call getMovieRecommendationsCall(String ignoreCollected, String ignoreWatchlisted, String traktApiVersion, String traktApiKey, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/recommendations/movies";
        ...
        if (ignoreCollected != null) {
            localVarQueryParams.addAll(localVarApiClient.parameterToPair("ignore_collected", ignoreCollected));
        }

        if (ignoreWatchlisted != null) {
            localVarQueryParams.addAll(localVarApiClient.parameterToPair("ignore_watchlisted", ignoreWatchlisted));
        }
    ...
    private okhttp3.Call getMovieRecommendationsValidateBeforeCall(String ignoreCollected, String ignoreWatchlisted, String traktApiVersion, String traktApiKey, final ApiCallback _callback) throws ApiException {
        return getMovieRecommendationsCall(ignoreCollected, ignoreWatchlisted, traktApiVersion, traktApiKey, _callback);
     ...
     */
    public void getMovieRecommendations(String ignoreCollected, String ignoreWatchlisted, String traktApiVersion, String traktApiKey) throws ApiException {
        getMovieRecommendationsWithHttpInfo(ignoreCollected, ignoreWatchlisted, traktApiVersion, traktApiKey);
    }
     ...
     */
    public ApiResponse<Void> getMovieRecommendationsWithHttpInfo(String ignoreCollected, String ignoreWatchlisted, String traktApiVersion, String traktApiKey) throws ApiException {
        okhttp3.Call localVarCall = getMovieRecommendationsValidateBeforeCall(ignoreCollected, ignoreWatchlisted, traktApiVersion, traktApiKey, null);
        return localVarApiClient.execute(localVarCall);
    }

    /**
     * Get movie recommendations (asynchronously)
     * #### &amp;#128274; OAuth Required &amp;#10024; Extended Info  Movie recommendations for a user. By default, &#x60;10&#x60; results are returned. You can send a &#x60;limit&#x60; to get up to &#x60;100&#x60; results per page. Set &#x60;ignore_collected&#x3D;true&#x60; to filter out movies the user has already collected or &#x60;ignore_watchlisted&#x3D;true&#x60; to filter out movies the user has already watchlisted.  The &#x60;recommended_by&#x60; array contains all users who recommended the item along with any notes they added.
     * @param ignoreCollected filter out collected movies (optional)
     * @param ignoreWatchlisted filter out watchlisted movies (optional)
     * @param traktApiVersion e.g. 2 (optional)
     ...
     */
    public okhttp3.Call getMovieRecommendationsAsync(String ignoreCollected, String ignoreWatchlisted, String traktApiVersion, String traktApiKey, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = getMovieRecommendationsValidateBeforeCall(ignoreCollected, ignoreWatchlisted, traktApiVersion, traktApiKey, _callback);
        localVarApiClient.executeAsync(localVarCall, _callback);
        return localVarCall;
    }
    /**
     * Build call for getShowRecommendations
     * @param ignoreCollected filter out collected shows (optional)
     * @param ignoreWatchlisted filter out watchlisted movies (optional)
     * @param traktApiVersion e.g. 2 (optional)
     * @param traktApiKey e.g. [client_id] (optional)
     * @param _callback Callback for upload/download progress
     ...
     */
    public okhttp3.Call getShowRecommendationsCall(String ignoreCollected, String ignoreWatchlisted, String traktApiVersion, String traktApiKey, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/recommendations/shows";
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getShowRecommendationsValidateBeforeCall(String ignoreCollected, String ignoreWatchlisted, String traktApiVersion, String traktApiKey, final ApiCallback _callback) throws ApiException {
        return getShowRecommendationsCall(ignoreCollected, ignoreWatchlisted, traktApiVersion, traktApiKey, _callback);
     ...
     */
    public void getShowRecommendations(String ignoreCollected, String ignoreWatchlisted, String traktApiVersion, String traktApiKey) throws ApiException {
        getShowRecommendationsWithHttpInfo(ignoreCollected, ignoreWatchlisted, traktApiVersion, traktApiKey);
    }
     ...
     */
    public ApiResponse<Void> getShowRecommendationsWithHttpInfo(String ignoreCollected, String ignoreWatchlisted, String traktApiVersion, String traktApiKey) throws ApiException {
        okhttp3.Call localVarCall = getShowRecommendationsValidateBeforeCall(ignoreCollected, ignoreWatchlisted, traktApiVersion, traktApiKey, null);
        return localVarApiClient.execute(localVarCall);
    }

    /**
     * Get show recommendations (asynchronously)
     * #### &amp;#128274; OAuth Required &amp;#10024; Extended Info  TV show recommendations for a user. By default, &#x60;10&#x60; results are returned. You can send a &#x60;limit&#x60; to get up to &#x60;100&#x60; results per page. Set &#x60;ignore_collected&#x3D;true&#x60; to filter out shows the user has already collected or &#x60;ignore_watchlisted&#x3D;true&#x60; to filter out shows the user has already watchlisted.  The &#x60;recommended_by&#x60; array contains all users who recommended the item along with any notes they added.
     * @param ignoreCollected filter out collected shows (optional)
     * @param ignoreWatchlisted filter out watchlisted movies (optional)
     * @param traktApiVersion e.g. 2 (optional)
     ...
     */
    public okhttp3.Call getShowRecommendationsAsync(String ignoreCollected, String ignoreWatchlisted, String traktApiVersion, String traktApiKey, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = getShowRecommendationsValidateBeforeCall(ignoreCollected, ignoreWatchlisted, traktApiVersion, traktApiKey, _callback);
        localVarApiClient.executeAsync(localVarCall, _callback);
        return localVarCall;
    }
    /**
     * Build call for hideAMovieRecommendation
     ...
     */
    public okhttp3.Call hideAMovieRecommendationCall(String id, String traktApiVersion, String traktApiKey, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/recommendations/movies/{id}"
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call hideAMovieRecommendationValidateBeforeCall(String id, String traktApiVersion, String traktApiKey, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new ApiException("Missing the required parameter 'id' when calling hideAMovieRecommendation(Async)");
        }

        return hideAMovieRecommendationCall(id, traktApiVersion, traktApiKey, _callback);
     ...
     */
    public void hideAMovieRecommendation(String id, String traktApiVersion, String traktApiKey) throws ApiException {
        hideAMovieRecommendationWithHttpInfo(id, traktApiVersion, traktApiKey);
    }
     ...
     */
    public ApiResponse<Void> hideAMovieRecommendationWithHttpInfo(String id, String traktApiVersion, String traktApiKey) throws ApiException {
        okhttp3.Call localVarCall = hideAMovieRecommendationValidateBeforeCall(id, traktApiVersion, traktApiKey, null);
        return localVarApiClient.execute(localVarCall);
    }

    /**
     * Hide a movie recommendation (asynchronously)
     * #### &amp;#128274; OAuth Required  Hide a movie from getting recommended anymore.
     * @param id Trakt ID, Trakt slug, or IMDB ID (required)
     * @param traktApiVersion e.g. 2 (optional)
     * @param traktApiKey e.g. [client_id] (optional)
     ...
     */
    public okhttp3.Call hideAMovieRecommendationAsync(String id, String traktApiVersion, String traktApiKey, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = hideAMovieRecommendationValidateBeforeCall(id, traktApiVersion, traktApiKey, _callback);
        localVarApiClient.executeAsync(localVarCall, _callback);
        return localVarCall;
    }
    /**
     * Build call for hideAShowRecommendation
     * @param id Trakt ID, Trakt slug, or IMDB ID (required)
     * @param traktApiVersion e.g. 2 (optional)
     * @param traktApiKey e.g. [client_id] (optional)
     * @param _callback Callback for upload/download progress
     ...
     */
    public okhttp3.Call hideAShowRecommendationCall(String id, String traktApiVersion, String traktApiKey, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/recommendations/shows/{id}"
            .replace("{" + "id" + "}", localVarApiClient.escapeString(id.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call hideAShowRecommendationValidateBeforeCall(String id, String traktApiVersion, String traktApiKey, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new ApiException("Missing the required parameter 'id' when calling hideAShowRecommendation(Async)");
        }

        return hideAShowRecommendationCall(id, traktApiVersion, traktApiKey, _callback);
     ...
     */
    public void hideAShowRecommendation(String id, String traktApiVersion, String traktApiKey) throws ApiException {
        hideAShowRecommendationWithHttpInfo(id, traktApiVersion, traktApiKey);
    }
     ...
     */
    public ApiResponse<Void> hideAShowRecommendationWithHttpInfo(String id, String traktApiVersion, String traktApiKey) throws ApiException {
        okhttp3.Call localVarCall = hideAShowRecommendationValidateBeforeCall(id, traktApiVersion, traktApiKey, null);
        return localVarApiClient.execute(localVarCall);
    }

    /**
     * Hide a show recommendation (asynchronously)
     * #### &amp;#128274; OAuth Required  Hide a show from getting recommended anymore.
     * @param id Trakt ID, Trakt slug, or IMDB ID (required)
     * @param traktApiVersion e.g. 2 (optional)
     * @param traktApiKey e.g. [client_id] (optional)
     ...
     */
    public okhttp3.Call hideAShowRecommendationAsync(String id, String traktApiVersion, String traktApiKey, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = hideAShowRecommendationValidateBeforeCall(id, traktApiVersion, traktApiKey, _callback);
        localVarApiClient.executeAsync(localVarCall, _callback);
        return localVarCall;
    }
}
