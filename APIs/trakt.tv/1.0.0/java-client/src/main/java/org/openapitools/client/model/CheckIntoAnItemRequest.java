...
import org.openapitools.client.model.CheckIntoAnItemRequestSharing;
...
public class CheckIntoAnItemRequest {
  ...
  private CheckIntoAnItemRequestSharing sharing;

  public CheckIntoAnItemRequest() {
  }

  public CheckIntoAnItemRequest appDate(String appDate) {
  ...
  public CheckIntoAnItemRequest appVersion(String appVersion) {
  ...
  public CheckIntoAnItemRequest message(String message) {
  ...
  public CheckIntoAnItemRequest movie(CheckIntoAnItemRequestMovie movie) {
    this.movie = movie;
    return this;
  }
  ...
  public CheckIntoAnItemRequest sharing(CheckIntoAnItemRequestSharing sharing) {
   ...
   */
  @javax.annotation.Nullable
  public CheckIntoAnItemRequestSharing getSharing() {
    return sharing;
  }

  public void setSharing(CheckIntoAnItemRequestSharing sharing) {
    this.sharing = sharing;
  }
  ...
  public boolean equals(Object o) {
    ...
    CheckIntoAnItemRequest checkIntoAnItemRequest = (CheckIntoAnItemRequest) o;
    return Objects.equals(this.appDate, checkIntoAnItemRequest.appDate) &&
        Objects.equals(this.appVersion, checkIntoAnItemRequest.appVersion) &&
        Objects.equals(this.message, checkIntoAnItemRequest.message) &&
        Objects.equals(this.movie, checkIntoAnItemRequest.movie) &&
        Objects.equals(this.sharing, checkIntoAnItemRequest.sharing);
  }

  @Override
  public int hashCode() {
    return Objects.hash(appDate, appVersion, message, movie, sharing);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CheckIntoAnItemRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CheckIntoAnItemRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CheckIntoAnItemRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CheckIntoAnItemRequest is not found in the empty JSON string", CheckIntoAnItemRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CheckIntoAnItemRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CheckIntoAnItemRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("sharing") != null && !jsonObj.get("sharing").isJsonNull()) {
        CheckIntoAnItemRequestSharing.validateJsonElement(jsonObj.get("sharing"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CheckIntoAnItemRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CheckIntoAnItemRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CheckIntoAnItemRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CheckIntoAnItemRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<CheckIntoAnItemRequest>() {
           @Override
           public void write(JsonWriter out, CheckIntoAnItemRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CheckIntoAnItemRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CheckIntoAnItemRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CheckIntoAnItemRequest
   * @throws IOException if the JSON string is invalid with respect to CheckIntoAnItemRequest
   */
  public static CheckIntoAnItemRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CheckIntoAnItemRequest.class);
  }

  /**
   * Convert an instance of CheckIntoAnItemRequest to an JSON string
   *
   * @return JSON string
   */
