...
public class GenerateNewDeviceCodesRequest {
  public static final String SERIALIZED_NAME_CLIENT_ID = "client_id";
  @SerializedName(SERIALIZED_NAME_CLIENT_ID)
  private String clientId;

  public GenerateNewDeviceCodesRequest() {
  }

  public GenerateNewDeviceCodesRequest clientId(String clientId) {
  ...
  public boolean equals(Object o) {
    ...
    GenerateNewDeviceCodesRequest generateNewDeviceCodesRequest = (GenerateNewDeviceCodesRequest) o;
    return Objects.equals(this.clientId, generateNewDeviceCodesRequest.clientId);
  }
  ...
  public String toString() {
    ...
    sb.append("class GenerateNewDeviceCodesRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GenerateNewDeviceCodesRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GenerateNewDeviceCodesRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GenerateNewDeviceCodesRequest is not found in the empty JSON string", GenerateNewDeviceCodesRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GenerateNewDeviceCodesRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GenerateNewDeviceCodesRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GenerateNewDeviceCodesRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GenerateNewDeviceCodesRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GenerateNewDeviceCodesRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GenerateNewDeviceCodesRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<GenerateNewDeviceCodesRequest>() {
           @Override
           public void write(JsonWriter out, GenerateNewDeviceCodesRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GenerateNewDeviceCodesRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GenerateNewDeviceCodesRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GenerateNewDeviceCodesRequest
   * @throws IOException if the JSON string is invalid with respect to GenerateNewDeviceCodesRequest
   */
  public static GenerateNewDeviceCodesRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GenerateNewDeviceCodesRequest.class);
  }

  /**
   * Convert an instance of GenerateNewDeviceCodesRequest to an JSON string
   *
   * @return JSON string
   */
