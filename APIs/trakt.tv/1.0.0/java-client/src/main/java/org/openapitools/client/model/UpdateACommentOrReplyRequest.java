...
public class UpdateACommentOrReplyRequest {
  ...
  public UpdateACommentOrReplyRequest() {
  }

  public UpdateACommentOrReplyRequest comment(String comment) {
  ...
  public UpdateACommentOrReplyRequest spoiler(Boolean spoiler) {
  ...
  public boolean equals(Object o) {
    ...
    UpdateACommentOrReplyRequest updateACommentOrReplyRequest = (UpdateACommentOrReplyRequest) o;
    return Objects.equals(this.comment, updateACommentOrReplyRequest.comment) &&
        Objects.equals(this.spoiler, updateACommentOrReplyRequest.spoiler);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdateACommentOrReplyRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateACommentOrReplyRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateACommentOrReplyRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateACommentOrReplyRequest is not found in the empty JSON string", UpdateACommentOrReplyRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateACommentOrReplyRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateACommentOrReplyRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateACommentOrReplyRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateACommentOrReplyRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateACommentOrReplyRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateACommentOrReplyRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateACommentOrReplyRequest>() {
           @Override
           public void write(JsonWriter out, UpdateACommentOrReplyRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateACommentOrReplyRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateACommentOrReplyRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateACommentOrReplyRequest
   * @throws IOException if the JSON string is invalid with respect to UpdateACommentOrReplyRequest
   */
  public static UpdateACommentOrReplyRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateACommentOrReplyRequest.class);
  }

  /**
   * Convert an instance of UpdateACommentOrReplyRequest to an JSON string
   *
   * @return JSON string
   */
