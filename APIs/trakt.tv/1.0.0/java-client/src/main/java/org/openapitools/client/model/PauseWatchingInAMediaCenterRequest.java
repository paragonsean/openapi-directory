...
import org.openapitools.client.model.CheckIntoAnItemRequestMovie;
...
public class PauseWatchingInAMediaCenterRequest {
  public static final String SERIALIZED_NAME_APP_DATE = "app_date";
  @SerializedName(SERIALIZED_NAME_APP_DATE)
  ...
  private CheckIntoAnItemRequestMovie movie;

  public static final String SERIALIZED_NAME_PROGRESS = "progress";
  @SerializedName(SERIALIZED_NAME_PROGRESS)
  private BigDecimal progress;

  public PauseWatchingInAMediaCenterRequest() {
  }

  public PauseWatchingInAMediaCenterRequest appDate(String appDate) {
  ...
  public PauseWatchingInAMediaCenterRequest appVersion(String appVersion) {
  ...
  public PauseWatchingInAMediaCenterRequest movie(CheckIntoAnItemRequestMovie movie) {
    this.movie = movie;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public CheckIntoAnItemRequestMovie getMovie() {
    return movie;
  }

  public void setMovie(CheckIntoAnItemRequestMovie movie) {
    this.movie = movie;
  }


  public PauseWatchingInAMediaCenterRequest progress(BigDecimal progress) {
  ...
  public boolean equals(Object o) {
    ...
    PauseWatchingInAMediaCenterRequest pauseWatchingInAMediaCenterRequest = (PauseWatchingInAMediaCenterRequest) o;
    return Objects.equals(this.appDate, pauseWatchingInAMediaCenterRequest.appDate) &&
        Objects.equals(this.appVersion, pauseWatchingInAMediaCenterRequest.appVersion) &&
        Objects.equals(this.movie, pauseWatchingInAMediaCenterRequest.movie) &&
        Objects.equals(this.progress, pauseWatchingInAMediaCenterRequest.progress);
  }

  @Override
  public int hashCode() {
    return Objects.hash(appDate, appVersion, movie, progress);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class PauseWatchingInAMediaCenterRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PauseWatchingInAMediaCenterRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PauseWatchingInAMediaCenterRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PauseWatchingInAMediaCenterRequest is not found in the empty JSON string", PauseWatchingInAMediaCenterRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PauseWatchingInAMediaCenterRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PauseWatchingInAMediaCenterRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      if ((jsonObj.get("app_date") != null && !jsonObj.get("app_date").isJsonNull()) && !jsonObj.get("app_date").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `app_date` to be a primitive type in the JSON string but got `%s`", jsonObj.get("app_date").toString()));
      }
      ...
      if (jsonObj.get("movie") != null && !jsonObj.get("movie").isJsonNull()) {
        CheckIntoAnItemRequestMovie.validateJsonElement(jsonObj.get("movie"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PauseWatchingInAMediaCenterRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PauseWatchingInAMediaCenterRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PauseWatchingInAMediaCenterRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PauseWatchingInAMediaCenterRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<PauseWatchingInAMediaCenterRequest>() {
           @Override
           public void write(JsonWriter out, PauseWatchingInAMediaCenterRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PauseWatchingInAMediaCenterRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PauseWatchingInAMediaCenterRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PauseWatchingInAMediaCenterRequest
   * @throws IOException if the JSON string is invalid with respect to PauseWatchingInAMediaCenterRequest
   */
  public static PauseWatchingInAMediaCenterRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PauseWatchingInAMediaCenterRequest.class);
  }

  /**
   * Convert an instance of PauseWatchingInAMediaCenterRequest to an JSON string
   *
   * @return JSON string
   */
