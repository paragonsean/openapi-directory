...
public class RemoveItemsFromCollectionRequest {
  ...
  public RemoveItemsFromCollectionRequest() {
  }

  public RemoveItemsFromCollectionRequest episodes(List<AddItemsToCollectionRequestEpisodesInner> episodes) {
    this.episodes = episodes;
    return this;
  }

  public RemoveItemsFromCollectionRequest addEpisodesItem(AddItemsToCollectionRequestEpisodesInner episodesItem) {
  ...
  public RemoveItemsFromCollectionRequest movies(List<RemoveItemsFromCollectionRequestMoviesInner> movies) {
    this.movies = movies;
    return this;
  }

  public RemoveItemsFromCollectionRequest addMoviesItem(RemoveItemsFromCollectionRequestMoviesInner moviesItem) {
    if (this.movies == null) {
  ...
  public RemoveItemsFromCollectionRequest seasons(List<AddItemsToCollectionRequestSeasonsInner> seasons) {
    this.seasons = seasons;
    return this;
  }

  public RemoveItemsFromCollectionRequest addSeasonsItem(AddItemsToCollectionRequestSeasonsInner seasonsItem) {
  ...
  public RemoveItemsFromCollectionRequest shows(List<RemoveItemsFromCollectionRequestShowsInner> shows) {
    this.shows = shows;
    return this;
  }

  public RemoveItemsFromCollectionRequest addShowsItem(RemoveItemsFromCollectionRequestShowsInner showsItem) {
    if (this.shows == null) {
  ...
  public boolean equals(Object o) {
    ...
    RemoveItemsFromCollectionRequest removeItemsFromCollectionRequest = (RemoveItemsFromCollectionRequest) o;
    return Objects.equals(this.episodes, removeItemsFromCollectionRequest.episodes) &&
        Objects.equals(this.movies, removeItemsFromCollectionRequest.movies) &&
        Objects.equals(this.seasons, removeItemsFromCollectionRequest.seasons) &&
        Objects.equals(this.shows, removeItemsFromCollectionRequest.shows);
  }
  ...
  public String toString() {
    ...
    sb.append("class RemoveItemsFromCollectionRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to RemoveItemsFromCollectionRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RemoveItemsFromCollectionRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in RemoveItemsFromCollectionRequest is not found in the empty JSON string", RemoveItemsFromCollectionRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RemoveItemsFromCollectionRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `RemoveItemsFromCollectionRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RemoveItemsFromCollectionRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RemoveItemsFromCollectionRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RemoveItemsFromCollectionRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RemoveItemsFromCollectionRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<RemoveItemsFromCollectionRequest>() {
           @Override
           public void write(JsonWriter out, RemoveItemsFromCollectionRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public RemoveItemsFromCollectionRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of RemoveItemsFromCollectionRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of RemoveItemsFromCollectionRequest
   * @throws IOException if the JSON string is invalid with respect to RemoveItemsFromCollectionRequest
   */
  public static RemoveItemsFromCollectionRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RemoveItemsFromCollectionRequest.class);
  }

  /**
   * Convert an instance of RemoveItemsFromCollectionRequest to an JSON string
   *
   * @return JSON string
   */
