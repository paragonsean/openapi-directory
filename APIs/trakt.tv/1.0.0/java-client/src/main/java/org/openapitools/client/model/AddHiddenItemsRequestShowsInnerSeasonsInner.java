...
public class AddHiddenItemsRequestShowsInnerSeasonsInner {
  public static final String SERIALIZED_NAME_NUMBER = "number";
  @SerializedName(SERIALIZED_NAME_NUMBER)
  private BigDecimal number;

  public AddHiddenItemsRequestShowsInnerSeasonsInner() {
  }

  public AddHiddenItemsRequestShowsInnerSeasonsInner number(BigDecimal number) {
    this.number = number;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    AddHiddenItemsRequestShowsInnerSeasonsInner addHiddenItemsRequestShowsInnerSeasonsInner = (AddHiddenItemsRequestShowsInnerSeasonsInner) o;
    return Objects.equals(this.number, addHiddenItemsRequestShowsInnerSeasonsInner.number);
  }
  ...
  public String toString() {
    ...
    sb.append("class AddHiddenItemsRequestShowsInnerSeasonsInner {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AddHiddenItemsRequestShowsInnerSeasonsInner
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AddHiddenItemsRequestShowsInnerSeasonsInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AddHiddenItemsRequestShowsInnerSeasonsInner is not found in the empty JSON string", AddHiddenItemsRequestShowsInnerSeasonsInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AddHiddenItemsRequestShowsInnerSeasonsInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AddHiddenItemsRequestShowsInnerSeasonsInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AddHiddenItemsRequestShowsInnerSeasonsInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AddHiddenItemsRequestShowsInnerSeasonsInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AddHiddenItemsRequestShowsInnerSeasonsInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AddHiddenItemsRequestShowsInnerSeasonsInner.class));

       return (TypeAdapter<T>) new TypeAdapter<AddHiddenItemsRequestShowsInnerSeasonsInner>() {
           @Override
           public void write(JsonWriter out, AddHiddenItemsRequestShowsInnerSeasonsInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AddHiddenItemsRequestShowsInnerSeasonsInner read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AddHiddenItemsRequestShowsInnerSeasonsInner given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AddHiddenItemsRequestShowsInnerSeasonsInner
   * @throws IOException if the JSON string is invalid with respect to AddHiddenItemsRequestShowsInnerSeasonsInner
   */
  public static AddHiddenItemsRequestShowsInnerSeasonsInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AddHiddenItemsRequestShowsInnerSeasonsInner.class);
  }

  /**
   * Convert an instance of AddHiddenItemsRequestShowsInnerSeasonsInner to an JSON string
   *
   * @return JSON string
   */
