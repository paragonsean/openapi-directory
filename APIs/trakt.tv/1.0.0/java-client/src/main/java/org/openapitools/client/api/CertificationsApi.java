...
public class CertificationsApi {
     ...
     */
    public okhttp3.Call getCertificationsCall(String type, String traktApiVersion, String traktApiKey, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/certifications/{type}"
    ...
    private okhttp3.Call getCertificationsValidateBeforeCall(String type, String traktApiVersion, String traktApiKey, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'type' is set
        if (type == null) {
            throw new ApiException("Missing the required parameter 'type' when calling getCertifications(Async)");
        }

        return getCertificationsCall(type, traktApiVersion, traktApiKey, _callback);
     ...
     */
    public void getCertifications(String type, String traktApiVersion, String traktApiKey) throws ApiException {
        getCertificationsWithHttpInfo(type, traktApiVersion, traktApiKey);
    }
     ...
     */
    public ApiResponse<Void> getCertificationsWithHttpInfo(String type, String traktApiVersion, String traktApiKey) throws ApiException {
        okhttp3.Call localVarCall = getCertificationsValidateBeforeCall(type, traktApiVersion, traktApiKey, null);
        return localVarApiClient.execute(localVarCall);
    }

    /**
     * Get certifications (asynchronously)
     * Get a list of all certifications, including names, slugs, and descriptions.
     * @param type  (required)
     * @param traktApiVersion e.g. 2 (optional)
     * @param traktApiKey e.g. [client_id] (optional)
     ...
     */
    public okhttp3.Call getCertificationsAsync(String type, String traktApiVersion, String traktApiKey, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = getCertificationsValidateBeforeCall(type, traktApiVersion, traktApiKey, _callback);
