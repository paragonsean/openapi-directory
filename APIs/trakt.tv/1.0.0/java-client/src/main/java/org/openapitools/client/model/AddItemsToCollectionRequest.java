...
import org.openapitools.client.model.AddItemsToCollectionRequestMoviesInner;
import org.openapitools.client.model.AddItemsToCollectionRequestSeasonsInner;
import org.openapitools.client.model.AddItemsToCollectionRequestShowsInner;
...
public class AddItemsToCollectionRequest {
  ...
  private List<AddItemsToCollectionRequestMoviesInner> movies = new ArrayList<>();
  ...
  private List<AddItemsToCollectionRequestShowsInner> shows = new ArrayList<>();

  public AddItemsToCollectionRequest() {
  }

  public AddItemsToCollectionRequest episodes(List<AddItemsToCollectionRequestEpisodesInner> episodes) {
    this.episodes = episodes;
    return this;
  }

  public AddItemsToCollectionRequest addEpisodesItem(AddItemsToCollectionRequestEpisodesInner episodesItem) {
  ...
  public AddItemsToCollectionRequest movies(List<AddItemsToCollectionRequestMoviesInner> movies) {
    this.movies = movies;
    return this;
  }

  public AddItemsToCollectionRequest addMoviesItem(AddItemsToCollectionRequestMoviesInner moviesItem) {
    if (this.movies == null) {
   ...
   */
  @javax.annotation.Nullable
  public List<AddItemsToCollectionRequestMoviesInner> getMovies() {
    return movies;
  }

  public void setMovies(List<AddItemsToCollectionRequestMoviesInner> movies) {
    this.movies = movies;
  }


  public AddItemsToCollectionRequest seasons(List<AddItemsToCollectionRequestSeasonsInner> seasons) {
    this.seasons = seasons;
    return this;
  }

  public AddItemsToCollectionRequest addSeasonsItem(AddItemsToCollectionRequestSeasonsInner seasonsItem) {
  ...
  public AddItemsToCollectionRequest shows(List<AddItemsToCollectionRequestShowsInner> shows) {
    this.shows = shows;
    return this;
  }

  public AddItemsToCollectionRequest addShowsItem(AddItemsToCollectionRequestShowsInner showsItem) {
    if (this.shows == null) {
   ...
   */
  @javax.annotation.Nullable
  public List<AddItemsToCollectionRequestShowsInner> getShows() {
    return shows;
  }

  public void setShows(List<AddItemsToCollectionRequestShowsInner> shows) {
    this.shows = shows;
  }
  ...
  public boolean equals(Object o) {
    ...
    AddItemsToCollectionRequest addItemsToCollectionRequest = (AddItemsToCollectionRequest) o;
    return Objects.equals(this.episodes, addItemsToCollectionRequest.episodes) &&
        Objects.equals(this.movies, addItemsToCollectionRequest.movies) &&
        Objects.equals(this.seasons, addItemsToCollectionRequest.seasons) &&
        Objects.equals(this.shows, addItemsToCollectionRequest.shows);
  }
  ...
  public String toString() {
    ...
    sb.append("class AddItemsToCollectionRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AddItemsToCollectionRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AddItemsToCollectionRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AddItemsToCollectionRequest is not found in the empty JSON string", AddItemsToCollectionRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AddItemsToCollectionRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AddItemsToCollectionRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("movies") != null && !jsonObj.get("movies").isJsonNull()) {
        ...
        if (jsonArraymovies != null) {
          ...
          for (int i = 0; i < jsonArraymovies.size(); i++) {
            AddItemsToCollectionRequestMoviesInner.validateJsonElement(jsonArraymovies.get(i));
          };
        }
      }
      ...
      if (jsonObj.get("shows") != null && !jsonObj.get("shows").isJsonNull()) {
        ...
        if (jsonArrayshows != null) {
          ...
          for (int i = 0; i < jsonArrayshows.size(); i++) {
            AddItemsToCollectionRequestShowsInner.validateJsonElement(jsonArrayshows.get(i));
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AddItemsToCollectionRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AddItemsToCollectionRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AddItemsToCollectionRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AddItemsToCollectionRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<AddItemsToCollectionRequest>() {
           @Override
           public void write(JsonWriter out, AddItemsToCollectionRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AddItemsToCollectionRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AddItemsToCollectionRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AddItemsToCollectionRequest
   * @throws IOException if the JSON string is invalid with respect to AddItemsToCollectionRequest
   */
  public static AddItemsToCollectionRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AddItemsToCollectionRequest.class);
  }

  /**
   * Convert an instance of AddItemsToCollectionRequest to an JSON string
   *
   * @return JSON string
   */
