...
import org.openapitools.client.model.PauseWatchingInAMediaCenterRequest;
import org.openapitools.client.model.StartWatchingInAMediaCenterRequest;
import org.openapitools.client.model.StopOrFinishWatchingInAMediaCenterRequest;
...
public class ScrobbleApi {
    ...
    public ScrobbleApi(ApiClient apiClient) {
    ...
    /**
     * Build call for pauseWatchingInAMediaCenter
     * @param traktApiVersion e.g. 2 (optional)
     * @param traktApiKey e.g. [client_id] (optional)
     * @param pauseWatchingInAMediaCenterRequest  (optional)
     ...
     */
    public okhttp3.Call pauseWatchingInAMediaCenterCall(String traktApiVersion, String traktApiKey, PauseWatchingInAMediaCenterRequest pauseWatchingInAMediaCenterRequest, final ApiCallback _callback) throws ApiException {
        ...
        Object localVarPostBody = pauseWatchingInAMediaCenterRequest;

        // create path and map variables
        String localVarPath = "/scrobble/pause";
    ...
    private okhttp3.Call pauseWatchingInAMediaCenterValidateBeforeCall(String traktApiVersion, String traktApiKey, PauseWatchingInAMediaCenterRequest pauseWatchingInAMediaCenterRequest, final ApiCallback _callback) throws ApiException {
        return pauseWatchingInAMediaCenterCall(traktApiVersion, traktApiKey, pauseWatchingInAMediaCenterRequest, _callback);
     ...
     */
    public void pauseWatchingInAMediaCenter(String traktApiVersion, String traktApiKey, PauseWatchingInAMediaCenterRequest pauseWatchingInAMediaCenterRequest) throws ApiException {
        pauseWatchingInAMediaCenterWithHttpInfo(traktApiVersion, traktApiKey, pauseWatchingInAMediaCenterRequest);
    }
     ...
     */
    public ApiResponse<Void> pauseWatchingInAMediaCenterWithHttpInfo(String traktApiVersion, String traktApiKey, PauseWatchingInAMediaCenterRequest pauseWatchingInAMediaCenterRequest) throws ApiException {
        okhttp3.Call localVarCall = pauseWatchingInAMediaCenterValidateBeforeCall(traktApiVersion, traktApiKey, pauseWatchingInAMediaCenterRequest, null);
        return localVarApiClient.execute(localVarCall);
    }

    /**
     * Pause watching in a media center (asynchronously)
     * #### &amp;#128274; OAuth Required  Use this method when the video is paused. The playback progress will be saved and [**_/sync/playback**](/reference/sync/playback/) can be used to resume the video from this exact position. Unpause a video by calling the [**_/scrobble/start**](/reference/scrobble/start/) method again.  #### JSON POST Data  | Key | Type | Value | |---|---|---| | item &lt;span style&#x3D;\&quot;color:red;\&quot;&gt;*&lt;/a&gt; | object | &#x60;movie&#x60; or &#x60;episode&#x60; object. (see examples &amp;#8594;) | | &#x60;progress&#x60; &lt;span style&#x3D;\&quot;color:red;\&quot;&gt;*&lt;/a&gt; | float | Progress percentage between 0 and 100. | | &#x60;app_version&#x60; | string | Version number of the app. | | &#x60;app_date&#x60; | string | Build date of the app. |
     * @param traktApiVersion e.g. 2 (optional)
     * @param traktApiKey e.g. [client_id] (optional)
     * @param pauseWatchingInAMediaCenterRequest  (optional)
     ...
     */
    public okhttp3.Call pauseWatchingInAMediaCenterAsync(String traktApiVersion, String traktApiKey, PauseWatchingInAMediaCenterRequest pauseWatchingInAMediaCenterRequest, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = pauseWatchingInAMediaCenterValidateBeforeCall(traktApiVersion, traktApiKey, pauseWatchingInAMediaCenterRequest, _callback);
        localVarApiClient.executeAsync(localVarCall, _callback);
        return localVarCall;
    }
    /**
     * Build call for startWatchingInAMediaCenter
     * @param traktApiVersion e.g. 2 (optional)
     * @param traktApiKey e.g. [client_id] (optional)
     * @param startWatchingInAMediaCenterRequest  (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     */
    public okhttp3.Call startWatchingInAMediaCenterCall(String traktApiVersion, String traktApiKey, StartWatchingInAMediaCenterRequest startWatchingInAMediaCenterRequest, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        Object localVarPostBody = startWatchingInAMediaCenterRequest;

        // create path and map variables
        String localVarPath = "/scrobble/start";
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call startWatchingInAMediaCenterValidateBeforeCall(String traktApiVersion, String traktApiKey, StartWatchingInAMediaCenterRequest startWatchingInAMediaCenterRequest, final ApiCallback _callback) throws ApiException {
        return startWatchingInAMediaCenterCall(traktApiVersion, traktApiKey, startWatchingInAMediaCenterRequest, _callback);
     ...
     */
    public void startWatchingInAMediaCenter(String traktApiVersion, String traktApiKey, StartWatchingInAMediaCenterRequest startWatchingInAMediaCenterRequest) throws ApiException {
        startWatchingInAMediaCenterWithHttpInfo(traktApiVersion, traktApiKey, startWatchingInAMediaCenterRequest);
    }
     ...
     */
    public ApiResponse<Void> startWatchingInAMediaCenterWithHttpInfo(String traktApiVersion, String traktApiKey, StartWatchingInAMediaCenterRequest startWatchingInAMediaCenterRequest) throws ApiException {
        okhttp3.Call localVarCall = startWatchingInAMediaCenterValidateBeforeCall(traktApiVersion, traktApiKey, startWatchingInAMediaCenterRequest, null);
        return localVarApiClient.execute(localVarCall);
    }

    /**
     * Start watching in a media center (asynchronously)
     * #### &amp;#128274; OAuth Required  Use this method when the video initially starts playing or is unpaused. This will remove any playback progress if it exists.  **Note:** A watching status will auto expire after the remaining runtime has elapsed. There is no need to call this method again while continuing to watch the same item.  #### JSON POST Data  | Key | Type | Value | |---|---|---| | item &lt;span style&#x3D;\&quot;color:red;\&quot;&gt;*&lt;/a&gt; | object | &#x60;movie&#x60; or &#x60;episode&#x60; object. (see examples &amp;#8594;) | | &#x60;progress&#x60; &lt;span style&#x3D;\&quot;color:red;\&quot;&gt;*&lt;/a&gt; | float | Progress percentage between 0 and 100. | | &#x60;app_version&#x60; | string | Version number of the app. | | &#x60;app_date&#x60; | string | Build date of the app. |
     * @param traktApiVersion e.g. 2 (optional)
     * @param traktApiKey e.g. [client_id] (optional)
     * @param startWatchingInAMediaCenterRequest  (optional)
     ...
     */
    public okhttp3.Call startWatchingInAMediaCenterAsync(String traktApiVersion, String traktApiKey, StartWatchingInAMediaCenterRequest startWatchingInAMediaCenterRequest, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = startWatchingInAMediaCenterValidateBeforeCall(traktApiVersion, traktApiKey, startWatchingInAMediaCenterRequest, _callback);
        localVarApiClient.executeAsync(localVarCall, _callback);
        return localVarCall;
    }
    /**
     * Build call for stopOrFinishWatchingInAMediaCenter
     * @param traktApiVersion e.g. 2 (optional)
     * @param traktApiKey e.g. [client_id] (optional)
     * @param stopOrFinishWatchingInAMediaCenterRequest  (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 201 </td><td> Created </td><td>  -  </td></tr>
        <tr><td> 409 </td><td> The same item was recently scrobbled. </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call stopOrFinishWatchingInAMediaCenterCall(String traktApiVersion, String traktApiKey, StopOrFinishWatchingInAMediaCenterRequest stopOrFinishWatchingInAMediaCenterRequest, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        Object localVarPostBody = stopOrFinishWatchingInAMediaCenterRequest;

        // create path and map variables
        String localVarPath = "/scrobble/stop";
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call stopOrFinishWatchingInAMediaCenterValidateBeforeCall(String traktApiVersion, String traktApiKey, StopOrFinishWatchingInAMediaCenterRequest stopOrFinishWatchingInAMediaCenterRequest, final ApiCallback _callback) throws ApiException {
        return stopOrFinishWatchingInAMediaCenterCall(traktApiVersion, traktApiKey, stopOrFinishWatchingInAMediaCenterRequest, _callback);
     ...
     */
    public void stopOrFinishWatchingInAMediaCenter(String traktApiVersion, String traktApiKey, StopOrFinishWatchingInAMediaCenterRequest stopOrFinishWatchingInAMediaCenterRequest) throws ApiException {
        stopOrFinishWatchingInAMediaCenterWithHttpInfo(traktApiVersion, traktApiKey, stopOrFinishWatchingInAMediaCenterRequest);
    }
     ...
     */
    public ApiResponse<Void> stopOrFinishWatchingInAMediaCenterWithHttpInfo(String traktApiVersion, String traktApiKey, StopOrFinishWatchingInAMediaCenterRequest stopOrFinishWatchingInAMediaCenterRequest) throws ApiException {
        okhttp3.Call localVarCall = stopOrFinishWatchingInAMediaCenterValidateBeforeCall(traktApiVersion, traktApiKey, stopOrFinishWatchingInAMediaCenterRequest, null);
        return localVarApiClient.execute(localVarCall);
    }

    /**
     * Stop or finish watching in a media center (asynchronously)
     * #### &amp;#128274; OAuth Required  Use this method when the video is stopped or finishes playing on its own. If the progress is above 80%, the video will be scrobbled and the &#x60;action&#x60; will be set to **scrobble**. A unique history &#x60;id&#x60; (64-bit integer) will be returned and can be used to reference this &#x60;scrobble&#x60; directly.  If the progress is less than 80%, it will be treated as a *pause* and the &#x60;action&#x60; will be set to **pause**. The playback progress will be saved and [**_/sync/playback**](/reference/sync/playback/) can be used to resume the video from this exact position.  **Note:** If you prefer to use a threshold higher than 80%, you should use [**_/scrobble/pause**](/reference/scrobble/pause/) yourself so it doesn&#39;t create duplicate scrobbles.  #### JSON POST Data  | Key | Type | Value | |---|---|---| | item &lt;span style&#x3D;\&quot;color:red;\&quot;&gt;*&lt;/a&gt; | object | &#x60;movie&#x60; or &#x60;episode&#x60; object. (see examples &amp;#8594;) | | &#x60;progress&#x60; &lt;span style&#x3D;\&quot;color:red;\&quot;&gt;*&lt;/a&gt; | flloat | Progress percentage between 0 and 100. | | &#x60;app_version&#x60; | string | Version number of the app. | | &#x60;app_date&#x60; | string | Build date of the app. |  **Note:** If the same item was just scrobbled, a &#x60;409&#x60; HTTP status code will returned to avoid scrobbling a duplicate. The response will contain a &#x60;watched_at&#x60; timestamp when the item was last scrobbled and a &#x60;expires_at&#x60; timestamp when the item can be scrobbled again.
     * @param traktApiVersion e.g. 2 (optional)
     * @param traktApiKey e.g. [client_id] (optional)
     * @param stopOrFinishWatchingInAMediaCenterRequest  (optional)
     ...
     */
    public okhttp3.Call stopOrFinishWatchingInAMediaCenterAsync(String traktApiVersion, String traktApiKey, StopOrFinishWatchingInAMediaCenterRequest stopOrFinishWatchingInAMediaCenterRequest, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = stopOrFinishWatchingInAMediaCenterValidateBeforeCall(traktApiVersion, traktApiKey, stopOrFinishWatchingInAMediaCenterRequest, _callback);
        localVarApiClient.executeAsync(localVarCall, _callback);
        return localVarCall;
    }
}
