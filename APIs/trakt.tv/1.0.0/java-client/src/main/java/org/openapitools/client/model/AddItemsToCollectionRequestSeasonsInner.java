...
public class AddItemsToCollectionRequestSeasonsInner {
  public static final String SERIALIZED_NAME_IDS = "ids";
  @SerializedName(SERIALIZED_NAME_IDS)
  private AddItemsToCollectionRequestSeasonsInnerIds ids;

  public AddItemsToCollectionRequestSeasonsInner() {
  }

  public AddItemsToCollectionRequestSeasonsInner ids(AddItemsToCollectionRequestSeasonsInnerIds ids) {
    this.ids = ids;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    AddItemsToCollectionRequestSeasonsInner addItemsToCollectionRequestSeasonsInner = (AddItemsToCollectionRequestSeasonsInner) o;
    return Objects.equals(this.ids, addItemsToCollectionRequestSeasonsInner.ids);
  }
  ...
  public String toString() {
    ...
    sb.append("class AddItemsToCollectionRequestSeasonsInner {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AddItemsToCollectionRequestSeasonsInner
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AddItemsToCollectionRequestSeasonsInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AddItemsToCollectionRequestSeasonsInner is not found in the empty JSON string", AddItemsToCollectionRequestSeasonsInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AddItemsToCollectionRequestSeasonsInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AddItemsToCollectionRequestSeasonsInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AddItemsToCollectionRequestSeasonsInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AddItemsToCollectionRequestSeasonsInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AddItemsToCollectionRequestSeasonsInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AddItemsToCollectionRequestSeasonsInner.class));

       return (TypeAdapter<T>) new TypeAdapter<AddItemsToCollectionRequestSeasonsInner>() {
           @Override
           public void write(JsonWriter out, AddItemsToCollectionRequestSeasonsInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AddItemsToCollectionRequestSeasonsInner read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AddItemsToCollectionRequestSeasonsInner given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AddItemsToCollectionRequestSeasonsInner
   * @throws IOException if the JSON string is invalid with respect to AddItemsToCollectionRequestSeasonsInner
   */
  public static AddItemsToCollectionRequestSeasonsInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AddItemsToCollectionRequestSeasonsInner.class);
  }

  /**
   * Convert an instance of AddItemsToCollectionRequestSeasonsInner to an JSON string
   *
   * @return JSON string
   */
