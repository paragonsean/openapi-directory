...
public class CheckIntoAnItemRequestSharing {
  ...
  public CheckIntoAnItemRequestSharing() {
  }

  public CheckIntoAnItemRequestSharing mastodon(Boolean mastodon) {
  ...
  public Boolean getMastodon() {
    return mastodon;
  }

  public void setMastodon(Boolean mastodon) {
    this.mastodon = mastodon;
  }


  public CheckIntoAnItemRequestSharing tumblr(Boolean tumblr) {
    this.tumblr = tumblr;
    return this;
  }
  ...
  public CheckIntoAnItemRequestSharing twitter(Boolean twitter) {
  ...
  public boolean equals(Object o) {
    ...
    CheckIntoAnItemRequestSharing checkIntoAnItemRequestSharing = (CheckIntoAnItemRequestSharing) o;
    return Objects.equals(this.mastodon, checkIntoAnItemRequestSharing.mastodon) &&
        Objects.equals(this.tumblr, checkIntoAnItemRequestSharing.tumblr) &&
        Objects.equals(this.twitter, checkIntoAnItemRequestSharing.twitter);
  }

  @Override
  public int hashCode() {
    return Objects.hash(mastodon, tumblr, twitter);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CheckIntoAnItemRequestSharing {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CheckIntoAnItemRequestSharing
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CheckIntoAnItemRequestSharing.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CheckIntoAnItemRequestSharing is not found in the empty JSON string", CheckIntoAnItemRequestSharing.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CheckIntoAnItemRequestSharing.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CheckIntoAnItemRequestSharing` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CheckIntoAnItemRequestSharing.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CheckIntoAnItemRequestSharing' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CheckIntoAnItemRequestSharing> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CheckIntoAnItemRequestSharing.class));

       return (TypeAdapter<T>) new TypeAdapter<CheckIntoAnItemRequestSharing>() {
           @Override
           public void write(JsonWriter out, CheckIntoAnItemRequestSharing value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CheckIntoAnItemRequestSharing read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CheckIntoAnItemRequestSharing given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CheckIntoAnItemRequestSharing
   * @throws IOException if the JSON string is invalid with respect to CheckIntoAnItemRequestSharing
   */
  public static CheckIntoAnItemRequestSharing fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CheckIntoAnItemRequestSharing.class);
  }

  /**
   * Convert an instance of CheckIntoAnItemRequestSharing to an JSON string
   *
   * @return JSON string
   */
