...
import org.openapitools.client.model.PostACommentRequestSharing;
...
public class PostACommentRequest {
  ...
  private PostACommentRequestSharing sharing;

  public static final String SERIALIZED_NAME_SPOILER = "spoiler";
  @SerializedName(SERIALIZED_NAME_SPOILER)
  private Boolean spoiler;

  public PostACommentRequest() {
  }

  public PostACommentRequest comment(String comment) {
  ...
  public PostACommentRequest movie(CheckIntoAnItemRequestMovie movie) {
    this.movie = movie;
    return this;
  }
  ...
  public PostACommentRequest sharing(PostACommentRequestSharing sharing) {
   ...
   */
  @javax.annotation.Nullable
  public PostACommentRequestSharing getSharing() {
    return sharing;
  }

  public void setSharing(PostACommentRequestSharing sharing) {
    this.sharing = sharing;
  }


  public PostACommentRequest spoiler(Boolean spoiler) {
  ...
  public boolean equals(Object o) {
    ...
    PostACommentRequest postACommentRequest = (PostACommentRequest) o;
    return Objects.equals(this.comment, postACommentRequest.comment) &&
        Objects.equals(this.movie, postACommentRequest.movie) &&
        Objects.equals(this.sharing, postACommentRequest.sharing) &&
        Objects.equals(this.spoiler, postACommentRequest.spoiler);
  }

  @Override
  public int hashCode() {
    return Objects.hash(comment, movie, sharing, spoiler);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class PostACommentRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PostACommentRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PostACommentRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PostACommentRequest is not found in the empty JSON string", PostACommentRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PostACommentRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PostACommentRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("sharing") != null && !jsonObj.get("sharing").isJsonNull()) {
        PostACommentRequestSharing.validateJsonElement(jsonObj.get("sharing"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PostACommentRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PostACommentRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PostACommentRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PostACommentRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<PostACommentRequest>() {
           @Override
           public void write(JsonWriter out, PostACommentRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PostACommentRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PostACommentRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PostACommentRequest
   * @throws IOException if the JSON string is invalid with respect to PostACommentRequest
   */
  public static PostACommentRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PostACommentRequest.class);
  }

  /**
   * Convert an instance of PostACommentRequest to an JSON string
   *
   * @return JSON string
   */
