...
public class AddItemsToPersonalRecommendationsRequestShowsInner {
  ...
  public AddItemsToPersonalRecommendationsRequestShowsInner() {
  }

  public AddItemsToPersonalRecommendationsRequestShowsInner ids(AddItemsToCollectionRequestShowsInnerIds ids) {
    this.ids = ids;
    return this;
  }
  ...
  public AddItemsToPersonalRecommendationsRequestShowsInner notes(String notes) {
    this.notes = notes;
    return this;
  }
  ...
  public AddItemsToPersonalRecommendationsRequestShowsInner title(String title) {
    this.title = title;
    return this;
  }
  ...
  public AddItemsToPersonalRecommendationsRequestShowsInner year(BigDecimal year) {
    this.year = year;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    AddItemsToPersonalRecommendationsRequestShowsInner addItemsToPersonalRecommendationsRequestShowsInner = (AddItemsToPersonalRecommendationsRequestShowsInner) o;
    return Objects.equals(this.ids, addItemsToPersonalRecommendationsRequestShowsInner.ids) &&
        Objects.equals(this.notes, addItemsToPersonalRecommendationsRequestShowsInner.notes) &&
        Objects.equals(this.title, addItemsToPersonalRecommendationsRequestShowsInner.title) &&
        Objects.equals(this.year, addItemsToPersonalRecommendationsRequestShowsInner.year);
  }
  ...
  public String toString() {
    ...
    sb.append("class AddItemsToPersonalRecommendationsRequestShowsInner {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AddItemsToPersonalRecommendationsRequestShowsInner
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AddItemsToPersonalRecommendationsRequestShowsInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AddItemsToPersonalRecommendationsRequestShowsInner is not found in the empty JSON string", AddItemsToPersonalRecommendationsRequestShowsInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AddItemsToPersonalRecommendationsRequestShowsInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AddItemsToPersonalRecommendationsRequestShowsInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AddItemsToPersonalRecommendationsRequestShowsInner.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AddItemsToPersonalRecommendationsRequestShowsInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AddItemsToPersonalRecommendationsRequestShowsInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AddItemsToPersonalRecommendationsRequestShowsInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AddItemsToPersonalRecommendationsRequestShowsInner.class));

       return (TypeAdapter<T>) new TypeAdapter<AddItemsToPersonalRecommendationsRequestShowsInner>() {
           @Override
           public void write(JsonWriter out, AddItemsToPersonalRecommendationsRequestShowsInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AddItemsToPersonalRecommendationsRequestShowsInner read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AddItemsToPersonalRecommendationsRequestShowsInner given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AddItemsToPersonalRecommendationsRequestShowsInner
   * @throws IOException if the JSON string is invalid with respect to AddItemsToPersonalRecommendationsRequestShowsInner
   */
  public static AddItemsToPersonalRecommendationsRequestShowsInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AddItemsToPersonalRecommendationsRequestShowsInner.class);
  }

  /**
   * Convert an instance of AddItemsToPersonalRecommendationsRequestShowsInner to an JSON string
   *
   * @return JSON string
   */
