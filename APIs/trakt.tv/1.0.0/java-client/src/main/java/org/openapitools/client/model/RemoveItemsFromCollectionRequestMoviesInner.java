...
public class RemoveItemsFromCollectionRequestMoviesInner {
  ...
  public RemoveItemsFromCollectionRequestMoviesInner() {
  }

  public RemoveItemsFromCollectionRequestMoviesInner ids(CheckIntoAnItemRequestMovieIds ids) {
    this.ids = ids;
    return this;
  }
  ...
  public RemoveItemsFromCollectionRequestMoviesInner title(String title) {
    this.title = title;
    return this;
  }
  ...
  public RemoveItemsFromCollectionRequestMoviesInner year(BigDecimal year) {
    this.year = year;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    RemoveItemsFromCollectionRequestMoviesInner removeItemsFromCollectionRequestMoviesInner = (RemoveItemsFromCollectionRequestMoviesInner) o;
    return Objects.equals(this.ids, removeItemsFromCollectionRequestMoviesInner.ids) &&
        Objects.equals(this.title, removeItemsFromCollectionRequestMoviesInner.title) &&
        Objects.equals(this.year, removeItemsFromCollectionRequestMoviesInner.year);
  }
  ...
  public String toString() {
    ...
    sb.append("class RemoveItemsFromCollectionRequestMoviesInner {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to RemoveItemsFromCollectionRequestMoviesInner
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RemoveItemsFromCollectionRequestMoviesInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in RemoveItemsFromCollectionRequestMoviesInner is not found in the empty JSON string", RemoveItemsFromCollectionRequestMoviesInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RemoveItemsFromCollectionRequestMoviesInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `RemoveItemsFromCollectionRequestMoviesInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : RemoveItemsFromCollectionRequestMoviesInner.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RemoveItemsFromCollectionRequestMoviesInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RemoveItemsFromCollectionRequestMoviesInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RemoveItemsFromCollectionRequestMoviesInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RemoveItemsFromCollectionRequestMoviesInner.class));

       return (TypeAdapter<T>) new TypeAdapter<RemoveItemsFromCollectionRequestMoviesInner>() {
           @Override
           public void write(JsonWriter out, RemoveItemsFromCollectionRequestMoviesInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public RemoveItemsFromCollectionRequestMoviesInner read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of RemoveItemsFromCollectionRequestMoviesInner given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of RemoveItemsFromCollectionRequestMoviesInner
   * @throws IOException if the JSON string is invalid with respect to RemoveItemsFromCollectionRequestMoviesInner
   */
  public static RemoveItemsFromCollectionRequestMoviesInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RemoveItemsFromCollectionRequestMoviesInner.class);
  }

  /**
   * Convert an instance of RemoveItemsFromCollectionRequestMoviesInner to an JSON string
   *
   * @return JSON string
   */
