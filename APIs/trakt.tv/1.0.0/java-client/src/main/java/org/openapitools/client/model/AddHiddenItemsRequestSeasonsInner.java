...
public class AddHiddenItemsRequestSeasonsInner {
  public static final String SERIALIZED_NAME_IDS = "ids";
  @SerializedName(SERIALIZED_NAME_IDS)
  private AddHiddenItemsRequestSeasonsInnerIds ids;

  public AddHiddenItemsRequestSeasonsInner() {
  }

  public AddHiddenItemsRequestSeasonsInner ids(AddHiddenItemsRequestSeasonsInnerIds ids) {
    this.ids = ids;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    AddHiddenItemsRequestSeasonsInner addHiddenItemsRequestSeasonsInner = (AddHiddenItemsRequestSeasonsInner) o;
    return Objects.equals(this.ids, addHiddenItemsRequestSeasonsInner.ids);
  }
  ...
  public String toString() {
    ...
    sb.append("class AddHiddenItemsRequestSeasonsInner {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AddHiddenItemsRequestSeasonsInner
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AddHiddenItemsRequestSeasonsInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AddHiddenItemsRequestSeasonsInner is not found in the empty JSON string", AddHiddenItemsRequestSeasonsInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AddHiddenItemsRequestSeasonsInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AddHiddenItemsRequestSeasonsInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AddHiddenItemsRequestSeasonsInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AddHiddenItemsRequestSeasonsInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AddHiddenItemsRequestSeasonsInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AddHiddenItemsRequestSeasonsInner.class));

       return (TypeAdapter<T>) new TypeAdapter<AddHiddenItemsRequestSeasonsInner>() {
           @Override
           public void write(JsonWriter out, AddHiddenItemsRequestSeasonsInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AddHiddenItemsRequestSeasonsInner read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AddHiddenItemsRequestSeasonsInner given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AddHiddenItemsRequestSeasonsInner
   * @throws IOException if the JSON string is invalid with respect to AddHiddenItemsRequestSeasonsInner
   */
  public static AddHiddenItemsRequestSeasonsInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AddHiddenItemsRequestSeasonsInner.class);
  }

  /**
   * Convert an instance of AddHiddenItemsRequestSeasonsInner to an JSON string
   *
   * @return JSON string
   */
