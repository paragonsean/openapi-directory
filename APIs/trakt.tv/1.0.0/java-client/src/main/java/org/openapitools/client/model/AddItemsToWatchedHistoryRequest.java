...
import org.openapitools.client.model.AddItemsToWatchedHistoryRequestEpisodesInner;
import org.openapitools.client.model.AddItemsToWatchedHistoryRequestMoviesInner;
import org.openapitools.client.model.AddItemsToWatchedHistoryRequestSeasonsInner;
import org.openapitools.client.model.AddItemsToWatchedHistoryRequestShowsInner;
 ...
 */
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-10-12T12:41:35.899060-04:00[America/New_York]", comments = "Generator version: 7.9.0")
public class AddItemsToWatchedHistoryRequest {
  public static final String SERIALIZED_NAME_EPISODES = "episodes";
  @SerializedName(SERIALIZED_NAME_EPISODES)
  private List<AddItemsToWatchedHistoryRequestEpisodesInner> episodes = new ArrayList<>();

  public static final String SERIALIZED_NAME_MOVIES = "movies";
  @SerializedName(SERIALIZED_NAME_MOVIES)
  private List<AddItemsToWatchedHistoryRequestMoviesInner> movies = new ArrayList<>();

  public static final String SERIALIZED_NAME_SEASONS = "seasons";
  @SerializedName(SERIALIZED_NAME_SEASONS)
  private List<AddItemsToWatchedHistoryRequestSeasonsInner> seasons = new ArrayList<>();

  public static final String SERIALIZED_NAME_SHOWS = "shows";
  @SerializedName(SERIALIZED_NAME_SHOWS)
  private List<AddItemsToWatchedHistoryRequestShowsInner> shows = new ArrayList<>();

  public AddItemsToWatchedHistoryRequest() {
  }

  public AddItemsToWatchedHistoryRequest episodes(List<AddItemsToWatchedHistoryRequestEpisodesInner> episodes) {
    this.episodes = episodes;
    return this;
  }

  public AddItemsToWatchedHistoryRequest addEpisodesItem(AddItemsToWatchedHistoryRequestEpisodesInner episodesItem) {
  ...
  public List<AddItemsToWatchedHistoryRequestEpisodesInner> getEpisodes() {
    return episodes;
  }

  public void setEpisodes(List<AddItemsToWatchedHistoryRequestEpisodesInner> episodes) {
    this.episodes = episodes;
  }


  public AddItemsToWatchedHistoryRequest movies(List<AddItemsToWatchedHistoryRequestMoviesInner> movies) {
    this.movies = movies;
    return this;
  }

  public AddItemsToWatchedHistoryRequest addMoviesItem(AddItemsToWatchedHistoryRequestMoviesInner moviesItem) {
    if (this.movies == null) {
   ...
   */
  @javax.annotation.Nullable
  public List<AddItemsToWatchedHistoryRequestMoviesInner> getMovies() {
    return movies;
  }

  public void setMovies(List<AddItemsToWatchedHistoryRequestMoviesInner> movies) {
    this.movies = movies;
  }


  public AddItemsToWatchedHistoryRequest seasons(List<AddItemsToWatchedHistoryRequestSeasonsInner> seasons) {
    this.seasons = seasons;
    return this;
  }

  public AddItemsToWatchedHistoryRequest addSeasonsItem(AddItemsToWatchedHistoryRequestSeasonsInner seasonsItem) {
   ...
   */
  @javax.annotation.Nullable
  public List<AddItemsToWatchedHistoryRequestSeasonsInner> getSeasons() {
    return seasons;
  }

  public void setSeasons(List<AddItemsToWatchedHistoryRequestSeasonsInner> seasons) {
    this.seasons = seasons;
  }


  public AddItemsToWatchedHistoryRequest shows(List<AddItemsToWatchedHistoryRequestShowsInner> shows) {
    this.shows = shows;
    return this;
  }

  public AddItemsToWatchedHistoryRequest addShowsItem(AddItemsToWatchedHistoryRequestShowsInner showsItem) {
    if (this.shows == null) {
   ...
   */
  @javax.annotation.Nullable
  public List<AddItemsToWatchedHistoryRequestShowsInner> getShows() {
    return shows;
  }

  public void setShows(List<AddItemsToWatchedHistoryRequestShowsInner> shows) {
    this.shows = shows;
  }
  ...
  public boolean equals(Object o) {
    ...
    AddItemsToWatchedHistoryRequest addItemsToWatchedHistoryRequest = (AddItemsToWatchedHistoryRequest) o;
    return Objects.equals(this.episodes, addItemsToWatchedHistoryRequest.episodes) &&
        Objects.equals(this.movies, addItemsToWatchedHistoryRequest.movies) &&
        Objects.equals(this.seasons, addItemsToWatchedHistoryRequest.seasons) &&
        Objects.equals(this.shows, addItemsToWatchedHistoryRequest.shows);
  }

  @Override
  public int hashCode() {
    return Objects.hash(episodes, movies, seasons, shows);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AddItemsToWatchedHistoryRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AddItemsToWatchedHistoryRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AddItemsToWatchedHistoryRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AddItemsToWatchedHistoryRequest is not found in the empty JSON string", AddItemsToWatchedHistoryRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AddItemsToWatchedHistoryRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AddItemsToWatchedHistoryRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("episodes") != null && !jsonObj.get("episodes").isJsonNull()) {
        ...
        if (jsonArrayepisodes != null) {
          ...
          for (int i = 0; i < jsonArrayepisodes.size(); i++) {
            AddItemsToWatchedHistoryRequestEpisodesInner.validateJsonElement(jsonArrayepisodes.get(i));
          };
        }
      }
      if (jsonObj.get("movies") != null && !jsonObj.get("movies").isJsonNull()) {
        ...
        if (jsonArraymovies != null) {
          ...
          for (int i = 0; i < jsonArraymovies.size(); i++) {
            AddItemsToWatchedHistoryRequestMoviesInner.validateJsonElement(jsonArraymovies.get(i));
          };
        }
      }
      if (jsonObj.get("seasons") != null && !jsonObj.get("seasons").isJsonNull()) {
        ...
        if (jsonArrayseasons != null) {
          ...
          for (int i = 0; i < jsonArrayseasons.size(); i++) {
            AddItemsToWatchedHistoryRequestSeasonsInner.validateJsonElement(jsonArrayseasons.get(i));
          };
        }
      }
      if (jsonObj.get("shows") != null && !jsonObj.get("shows").isJsonNull()) {
        ...
        if (jsonArrayshows != null) {
          ...
          for (int i = 0; i < jsonArrayshows.size(); i++) {
            AddItemsToWatchedHistoryRequestShowsInner.validateJsonElement(jsonArrayshows.get(i));
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AddItemsToWatchedHistoryRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AddItemsToWatchedHistoryRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AddItemsToWatchedHistoryRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AddItemsToWatchedHistoryRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<AddItemsToWatchedHistoryRequest>() {
           @Override
           public void write(JsonWriter out, AddItemsToWatchedHistoryRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AddItemsToWatchedHistoryRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AddItemsToWatchedHistoryRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AddItemsToWatchedHistoryRequest
   * @throws IOException if the JSON string is invalid with respect to AddItemsToWatchedHistoryRequest
   */
  public static AddItemsToWatchedHistoryRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AddItemsToWatchedHistoryRequest.class);
  }

  /**
   * Convert an instance of AddItemsToWatchedHistoryRequest to an JSON string
   *
   * @return JSON string
   */
