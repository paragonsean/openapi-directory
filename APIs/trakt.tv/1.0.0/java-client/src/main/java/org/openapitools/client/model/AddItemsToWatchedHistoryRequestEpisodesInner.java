...
public class AddItemsToWatchedHistoryRequestEpisodesInner {
  ...
  public AddItemsToWatchedHistoryRequestEpisodesInner() {
  }

  public AddItemsToWatchedHistoryRequestEpisodesInner ids(AddItemsToCollectionRequestEpisodesInnerIds ids) {
    this.ids = ids;
    return this;
  }
  ...
  public AddItemsToWatchedHistoryRequestEpisodesInner watchedAt(String watchedAt) {
  ...
  public boolean equals(Object o) {
    ...
    AddItemsToWatchedHistoryRequestEpisodesInner addItemsToWatchedHistoryRequestEpisodesInner = (AddItemsToWatchedHistoryRequestEpisodesInner) o;
    return Objects.equals(this.ids, addItemsToWatchedHistoryRequestEpisodesInner.ids) &&
        Objects.equals(this.watchedAt, addItemsToWatchedHistoryRequestEpisodesInner.watchedAt);
  }
  ...
  public String toString() {
    ...
    sb.append("class AddItemsToWatchedHistoryRequestEpisodesInner {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AddItemsToWatchedHistoryRequestEpisodesInner
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AddItemsToWatchedHistoryRequestEpisodesInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AddItemsToWatchedHistoryRequestEpisodesInner is not found in the empty JSON string", AddItemsToWatchedHistoryRequestEpisodesInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AddItemsToWatchedHistoryRequestEpisodesInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AddItemsToWatchedHistoryRequestEpisodesInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AddItemsToWatchedHistoryRequestEpisodesInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AddItemsToWatchedHistoryRequestEpisodesInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AddItemsToWatchedHistoryRequestEpisodesInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AddItemsToWatchedHistoryRequestEpisodesInner.class));

       return (TypeAdapter<T>) new TypeAdapter<AddItemsToWatchedHistoryRequestEpisodesInner>() {
           @Override
           public void write(JsonWriter out, AddItemsToWatchedHistoryRequestEpisodesInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AddItemsToWatchedHistoryRequestEpisodesInner read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AddItemsToWatchedHistoryRequestEpisodesInner given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AddItemsToWatchedHistoryRequestEpisodesInner
   * @throws IOException if the JSON string is invalid with respect to AddItemsToWatchedHistoryRequestEpisodesInner
   */
  public static AddItemsToWatchedHistoryRequestEpisodesInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AddItemsToWatchedHistoryRequestEpisodesInner.class);
  }

  /**
   * Convert an instance of AddItemsToWatchedHistoryRequestEpisodesInner to an JSON string
   *
   * @return JSON string
   */
