...
public class SearchApi {
    ...
    /**
     * Build call for getIDLookupResults
     * @param idType Type of ID to lookup. (required)
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        ...
        <tr><td> 200 </td><td> &#x60;&#x60;&#x60; /search/trakt/12601?type&#x3D;movie /search/imdb/tt1104001 &#x60;&#x60;&#x60; </td><td>  * X-Pagination-Item-Count -  <br>  * X-Pagination-Limit -  <br>  * X-Pagination-Page -  <br>  * X-Pagination-Page-Count -  <br>  </td></tr>
     </table>
     */
    public okhttp3.Call getIDLookupResultsCall(String idType, String id, String type, String traktApiVersion, String traktApiKey, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/search/{id_type}/{id}"
            .replace("{" + "id_type" + "}", localVarApiClient.escapeString(idType.toString()))
    ...
    private okhttp3.Call getIDLookupResultsValidateBeforeCall(String idType, String id, String type, String traktApiVersion, String traktApiKey, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'idType' is set
        if (idType == null) {
            throw new ApiException("Missing the required parameter 'idType' when calling getIDLookupResults(Async)");
        }

        // verify the required parameter 'id' is set
        if (id == null) {
            throw new ApiException("Missing the required parameter 'id' when calling getIDLookupResults(Async)");
        }

        return getIDLookupResultsCall(idType, id, type, traktApiVersion, traktApiKey, _callback);
     ...
     */
    public void getIDLookupResults(String idType, String id, String type, String traktApiVersion, String traktApiKey) throws ApiException {
        getIDLookupResultsWithHttpInfo(idType, id, type, traktApiVersion, traktApiKey);
    }
     ...
     */
    public ApiResponse<Void> getIDLookupResultsWithHttpInfo(String idType, String id, String type, String traktApiVersion, String traktApiKey) throws ApiException {
        okhttp3.Call localVarCall = getIDLookupResultsValidateBeforeCall(idType, id, type, traktApiVersion, traktApiKey, null);
        return localVarApiClient.execute(localVarCall);
    }

    /**
     * Get ID lookup results (asynchronously)
     * #### &amp;#128196; Pagination &amp;#10024; Extended Info  Lookup items by their Trakt, IMDB, TMDB, or TVDB ID. If you use the search url without a &#x60;type&#x60; it might return multiple items if the &#x60;id_type&#x60; is not globally unique. Specify the &#x60;type&#x60; of results by sending a single value or a comma delimited string for multiple types.  | Type | URL | |---|---| | &#x60;trakt&#x60; | &#x60;/search/trakt/:id&#x60; | |  | &#x60;/search/trakt/:id?type&#x3D;movie&#x60; | |  | &#x60;/search/trakt/:id?type&#x3D;show&#x60; | |  | &#x60;/search/trakt/:id?type&#x3D;episode&#x60; | |  | &#x60;/search/trakt/:id?type&#x3D;person&#x60; | | &#x60;imdb&#x60; | &#x60;/search/imdb/:id&#x60; | | &#x60;tmdb&#x60; | &#x60;/search/tmdb/:id&#x60; | |  | &#x60;/search/tmdb/:id?type&#x3D;movie&#x60; | |  | &#x60;/search/tmdb/:id?type&#x3D;show&#x60; | |  | &#x60;/search/tmdb/:id?type&#x3D;episode&#x60; | |  | &#x60;/search/tmdb/:id?type&#x3D;person&#x60; | | &#x60;tvdb&#x60; | &#x60;/search/tvdb/:id&#x60; | |  | &#x60;/search/tvdb/:id?type&#x3D;show&#x60; | |  | &#x60;/search/tvdb/:id?type&#x3D;episode&#x60; |
     * @param idType Type of ID to lookup. (required)
     * @param id ID that matches with the type. (required)
     * @param type Search type. (optional)
     ...
     */
    public okhttp3.Call getIDLookupResultsAsync(String idType, String id, String type, String traktApiVersion, String traktApiKey, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = getIDLookupResultsValidateBeforeCall(idType, id, type, traktApiVersion, traktApiKey, _callback);
        localVarApiClient.executeAsync(localVarCall, _callback);
        return localVarCall;
    }
    /**
     * Build call for getTextQueryResults
     * @param type Search type. (required)
     * @param query Search all text based fields. (required)
     * @param traktApiVersion e.g. 2 (optional)
     * @param traktApiKey e.g. [client_id] (optional)
     * @param body Specific text fields. (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> &#x60;&#x60;&#x60; /search/movie,show,episode,person,list?query&#x3D;tron &#x60;&#x60;&#x60; </td><td>  * X-Pagination-Item-Count -  <br>  * X-Pagination-Limit -  <br>  * X-Pagination-Page -  <br>  * X-Pagination-Page-Count -  <br>  </td></tr>
     </table>
     */
    public okhttp3.Call getTextQueryResultsCall(String type, String query, String traktApiVersion, String traktApiKey, String body, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/search/{type}"
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getTextQueryResultsValidateBeforeCall(String type, String query, String traktApiVersion, String traktApiKey, String body, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'type' is set
        if (type == null) {
            throw new ApiException("Missing the required parameter 'type' when calling getTextQueryResults(Async)");
        }

        // verify the required parameter 'query' is set
        if (query == null) {
            throw new ApiException("Missing the required parameter 'query' when calling getTextQueryResults(Async)");
        }

        return getTextQueryResultsCall(type, query, traktApiVersion, traktApiKey, body, _callback);
     ...
     */
    public void getTextQueryResults(String type, String query, String traktApiVersion, String traktApiKey, String body) throws ApiException {
        getTextQueryResultsWithHttpInfo(type, query, traktApiVersion, traktApiKey, body);
    }
     ...
     */
    public ApiResponse<Void> getTextQueryResultsWithHttpInfo(String type, String query, String traktApiVersion, String traktApiKey, String body) throws ApiException {
        okhttp3.Call localVarCall = getTextQueryResultsValidateBeforeCall(type, query, traktApiVersion, traktApiKey, body, null);
        return localVarApiClient.execute(localVarCall);
    }

    /**
     * Get text query results (asynchronously)
     * #### &amp;#128196; Pagination &amp;#10024; Extended Info &amp;#127898; Filters  Search all text fields that a media object contains (i.e. title, overview, etc). Results are ordered by the most relevant score. Specify the &#x60;type&#x60; of results by sending a single value or a comma delimited string for multiple types.  #### Special Characters  Our search engine (Solr) gives the following characters special meaning when they appear in a query:  &#x60;+ - &amp;&amp; || ! ( ) { } [ ] ^ \&quot; ~ * ? : /&#x60;  To interpret any of these characters literally (and not as a special character), precede the character with a backslash &#x60;\\&#x60; character.  #### Search Fields  By default, all text fields are used to search for the &#x60;query&#x60;. You can optionally specify the &#x60;fields&#x60; parameter with a single value or comma delimited string for multiple fields. Each &#x60;type&#x60; has specific &#x60;fields&#x60; that can be specified. This can be useful if you want to support more strict searches (i.e. title only).  | Type | Field | |---|---| | &#x60;movie&#x60; | &#x60;title&#x60; | |  | &#x60;tagline&#x60; | |  | &#x60;overview&#x60; | |  | &#x60;people&#x60; | |  | &#x60;translations&#x60; | |  | &#x60;aliases&#x60; | | &#x60;show&#x60; | &#x60;title&#x60; | |  | &#x60;overview&#x60; | |  | &#x60;people&#x60; | |  | &#x60;translations&#x60; | |  | &#x60;aliases&#x60; | | &#x60;episode&#x60; | &#x60;title&#x60; | |  | &#x60;overview&#x60; | | &#x60;person&#x60; | &#x60;name&#x60; | |  | &#x60;biography&#x60; | | &#x60;list&#x60; | &#x60;name&#x60; | |  | &#x60;description&#x60; |
     * @param type Search type. (required)
     * @param query Search all text based fields. (required)
     * @param traktApiVersion e.g. 2 (optional)
     ...
     */
    public okhttp3.Call getTextQueryResultsAsync(String type, String query, String traktApiVersion, String traktApiKey, String body, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = getTextQueryResultsValidateBeforeCall(type, query, traktApiVersion, traktApiKey, body, _callback);
        localVarApiClient.executeAsync(localVarCall, _callback);
        return localVarCall;
    }
}
