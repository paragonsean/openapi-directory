...
public class AddItemsToCollectionRequestEpisodesInner {
  public static final String SERIALIZED_NAME_IDS = "ids";
  @SerializedName(SERIALIZED_NAME_IDS)
  private AddItemsToCollectionRequestEpisodesInnerIds ids;

  public AddItemsToCollectionRequestEpisodesInner() {
  }

  public AddItemsToCollectionRequestEpisodesInner ids(AddItemsToCollectionRequestEpisodesInnerIds ids) {
    this.ids = ids;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    AddItemsToCollectionRequestEpisodesInner addItemsToCollectionRequestEpisodesInner = (AddItemsToCollectionRequestEpisodesInner) o;
    return Objects.equals(this.ids, addItemsToCollectionRequestEpisodesInner.ids);
  }
  ...
  public String toString() {
    ...
    sb.append("class AddItemsToCollectionRequestEpisodesInner {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AddItemsToCollectionRequestEpisodesInner
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AddItemsToCollectionRequestEpisodesInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AddItemsToCollectionRequestEpisodesInner is not found in the empty JSON string", AddItemsToCollectionRequestEpisodesInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AddItemsToCollectionRequestEpisodesInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AddItemsToCollectionRequestEpisodesInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AddItemsToCollectionRequestEpisodesInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AddItemsToCollectionRequestEpisodesInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AddItemsToCollectionRequestEpisodesInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AddItemsToCollectionRequestEpisodesInner.class));

       return (TypeAdapter<T>) new TypeAdapter<AddItemsToCollectionRequestEpisodesInner>() {
           @Override
           public void write(JsonWriter out, AddItemsToCollectionRequestEpisodesInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AddItemsToCollectionRequestEpisodesInner read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AddItemsToCollectionRequestEpisodesInner given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AddItemsToCollectionRequestEpisodesInner
   * @throws IOException if the JSON string is invalid with respect to AddItemsToCollectionRequestEpisodesInner
   */
  public static AddItemsToCollectionRequestEpisodesInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AddItemsToCollectionRequestEpisodesInner.class);
  }

  /**
   * Convert an instance of AddItemsToCollectionRequestEpisodesInner to an JSON string
   *
   * @return JSON string
   */
