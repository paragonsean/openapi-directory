...
public class AddItemsToWatchedHistoryRequestMoviesInner {
  ...
  public AddItemsToWatchedHistoryRequestMoviesInner() {
  }

  public AddItemsToWatchedHistoryRequestMoviesInner ids(CheckIntoAnItemRequestMovieIds ids) {
    this.ids = ids;
    return this;
  }
  ...
  public AddItemsToWatchedHistoryRequestMoviesInner title(String title) {
    this.title = title;
    return this;
  }
  ...
  public AddItemsToWatchedHistoryRequestMoviesInner watchedAt(String watchedAt) {
  ...
  public AddItemsToWatchedHistoryRequestMoviesInner year(BigDecimal year) {
    this.year = year;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    AddItemsToWatchedHistoryRequestMoviesInner addItemsToWatchedHistoryRequestMoviesInner = (AddItemsToWatchedHistoryRequestMoviesInner) o;
    return Objects.equals(this.ids, addItemsToWatchedHistoryRequestMoviesInner.ids) &&
        Objects.equals(this.title, addItemsToWatchedHistoryRequestMoviesInner.title) &&
        Objects.equals(this.watchedAt, addItemsToWatchedHistoryRequestMoviesInner.watchedAt) &&
        Objects.equals(this.year, addItemsToWatchedHistoryRequestMoviesInner.year);
  }

  @Override
  public int hashCode() {
    return Objects.hash(ids, title, watchedAt, year);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AddItemsToWatchedHistoryRequestMoviesInner {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AddItemsToWatchedHistoryRequestMoviesInner
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AddItemsToWatchedHistoryRequestMoviesInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AddItemsToWatchedHistoryRequestMoviesInner is not found in the empty JSON string", AddItemsToWatchedHistoryRequestMoviesInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AddItemsToWatchedHistoryRequestMoviesInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AddItemsToWatchedHistoryRequestMoviesInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AddItemsToWatchedHistoryRequestMoviesInner.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AddItemsToWatchedHistoryRequestMoviesInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AddItemsToWatchedHistoryRequestMoviesInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AddItemsToWatchedHistoryRequestMoviesInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AddItemsToWatchedHistoryRequestMoviesInner.class));

       return (TypeAdapter<T>) new TypeAdapter<AddItemsToWatchedHistoryRequestMoviesInner>() {
           @Override
           public void write(JsonWriter out, AddItemsToWatchedHistoryRequestMoviesInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AddItemsToWatchedHistoryRequestMoviesInner read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AddItemsToWatchedHistoryRequestMoviesInner given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AddItemsToWatchedHistoryRequestMoviesInner
   * @throws IOException if the JSON string is invalid with respect to AddItemsToWatchedHistoryRequestMoviesInner
   */
  public static AddItemsToWatchedHistoryRequestMoviesInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AddItemsToWatchedHistoryRequestMoviesInner.class);
  }

  /**
   * Convert an instance of AddItemsToWatchedHistoryRequestMoviesInner to an JSON string
   *
   * @return JSON string
   */
