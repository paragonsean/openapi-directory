...
import org.openapitools.client.model.AddHiddenItemsRequestSeasonsInner;
import org.openapitools.client.model.AddHiddenItemsRequestShowsInner;
...
public class AddHiddenItemsRequest {
  ...
  private List<AddHiddenItemsRequestSeasonsInner> seasons = new ArrayList<>();

  public static final String SERIALIZED_NAME_SHOWS = "shows";
  @SerializedName(SERIALIZED_NAME_SHOWS)
  private List<AddHiddenItemsRequestShowsInner> shows = new ArrayList<>();

  public AddHiddenItemsRequest() {
  }

  public AddHiddenItemsRequest movies(List<RemoveItemsFromCollectionRequestMoviesInner> movies) {
    this.movies = movies;
    return this;
  }

  public AddHiddenItemsRequest addMoviesItem(RemoveItemsFromCollectionRequestMoviesInner moviesItem) {
    if (this.movies == null) {
  ...
  public AddHiddenItemsRequest seasons(List<AddHiddenItemsRequestSeasonsInner> seasons) {
    this.seasons = seasons;
    return this;
  }

  public AddHiddenItemsRequest addSeasonsItem(AddHiddenItemsRequestSeasonsInner seasonsItem) {
   ...
   */
  @javax.annotation.Nullable
  public List<AddHiddenItemsRequestSeasonsInner> getSeasons() {
    return seasons;
  }

  public void setSeasons(List<AddHiddenItemsRequestSeasonsInner> seasons) {
    this.seasons = seasons;
  }


  public AddHiddenItemsRequest shows(List<AddHiddenItemsRequestShowsInner> shows) {
    this.shows = shows;
    return this;
  }

  public AddHiddenItemsRequest addShowsItem(AddHiddenItemsRequestShowsInner showsItem) {
    if (this.shows == null) {
   ...
   */
  @javax.annotation.Nullable
  public List<AddHiddenItemsRequestShowsInner> getShows() {
    return shows;
  }

  public void setShows(List<AddHiddenItemsRequestShowsInner> shows) {
    this.shows = shows;
  }
  ...
  public boolean equals(Object o) {
    ...
    AddHiddenItemsRequest addHiddenItemsRequest = (AddHiddenItemsRequest) o;
    return Objects.equals(this.movies, addHiddenItemsRequest.movies) &&
        Objects.equals(this.seasons, addHiddenItemsRequest.seasons) &&
        Objects.equals(this.shows, addHiddenItemsRequest.shows);
  }

  @Override
  public int hashCode() {
    return Objects.hash(movies, seasons, shows);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AddHiddenItemsRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AddHiddenItemsRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AddHiddenItemsRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AddHiddenItemsRequest is not found in the empty JSON string", AddHiddenItemsRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AddHiddenItemsRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AddHiddenItemsRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("seasons") != null && !jsonObj.get("seasons").isJsonNull()) {
        ...
        if (jsonArrayseasons != null) {
          ...
          for (int i = 0; i < jsonArrayseasons.size(); i++) {
            AddHiddenItemsRequestSeasonsInner.validateJsonElement(jsonArrayseasons.get(i));
          };
        }
      }
      if (jsonObj.get("shows") != null && !jsonObj.get("shows").isJsonNull()) {
        ...
        if (jsonArrayshows != null) {
          ...
          for (int i = 0; i < jsonArrayshows.size(); i++) {
            AddHiddenItemsRequestShowsInner.validateJsonElement(jsonArrayshows.get(i));
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AddHiddenItemsRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AddHiddenItemsRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AddHiddenItemsRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AddHiddenItemsRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<AddHiddenItemsRequest>() {
           @Override
           public void write(JsonWriter out, AddHiddenItemsRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AddHiddenItemsRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AddHiddenItemsRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AddHiddenItemsRequest
   * @throws IOException if the JSON string is invalid with respect to AddHiddenItemsRequest
   */
  public static AddHiddenItemsRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AddHiddenItemsRequest.class);
  }

  /**
   * Convert an instance of AddHiddenItemsRequest to an JSON string
   *
   * @return JSON string
   */
