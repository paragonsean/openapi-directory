...
public class PollForTheAccessTokenRequest {
  ...
  public PollForTheAccessTokenRequest() {
  }

  public PollForTheAccessTokenRequest clientId(String clientId) {
  ...
  public PollForTheAccessTokenRequest clientSecret(String clientSecret) {
  ...
  public PollForTheAccessTokenRequest code(String code) {
    this.code = code;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    PollForTheAccessTokenRequest pollForTheAccessTokenRequest = (PollForTheAccessTokenRequest) o;
    return Objects.equals(this.clientId, pollForTheAccessTokenRequest.clientId) &&
        Objects.equals(this.clientSecret, pollForTheAccessTokenRequest.clientSecret) &&
        Objects.equals(this.code, pollForTheAccessTokenRequest.code);
  }

  @Override
  public int hashCode() {
    return Objects.hash(clientId, clientSecret, code);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class PollForTheAccessTokenRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PollForTheAccessTokenRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PollForTheAccessTokenRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PollForTheAccessTokenRequest is not found in the empty JSON string", PollForTheAccessTokenRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PollForTheAccessTokenRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PollForTheAccessTokenRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PollForTheAccessTokenRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PollForTheAccessTokenRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PollForTheAccessTokenRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PollForTheAccessTokenRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<PollForTheAccessTokenRequest>() {
           @Override
           public void write(JsonWriter out, PollForTheAccessTokenRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PollForTheAccessTokenRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PollForTheAccessTokenRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PollForTheAccessTokenRequest
   * @throws IOException if the JSON string is invalid with respect to PollForTheAccessTokenRequest
   */
  public static PollForTheAccessTokenRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PollForTheAccessTokenRequest.class);
  }

  /**
   * Convert an instance of PollForTheAccessTokenRequest to an JSON string
   *
   * @return JSON string
   */
