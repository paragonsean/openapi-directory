...
import org.openapitools.client.model.AddHiddenItemsRequestSeasonsInnerIds;
import org.openapitools.client.model.RemoveItemsFromCollectionRequestShowsInnerSeasonsInner;
...
public class RemoveItemsFromPersonalListRequestShowsInner {
  public static final String SERIALIZED_NAME_IDS = "ids";
  @SerializedName(SERIALIZED_NAME_IDS)
  private AddHiddenItemsRequestSeasonsInnerIds ids;

  public static final String SERIALIZED_NAME_SEASONS = "seasons";
  @SerializedName(SERIALIZED_NAME_SEASONS)
  private List<RemoveItemsFromCollectionRequestShowsInnerSeasonsInner> seasons = new ArrayList<>();

  public RemoveItemsFromPersonalListRequestShowsInner() {
  }

  public RemoveItemsFromPersonalListRequestShowsInner ids(AddHiddenItemsRequestSeasonsInnerIds ids) {
    this.ids = ids;
    return this;
  }
  ...
  public AddHiddenItemsRequestSeasonsInnerIds getIds() {
    return ids;
  }

  public void setIds(AddHiddenItemsRequestSeasonsInnerIds ids) {
    this.ids = ids;
  }


  public RemoveItemsFromPersonalListRequestShowsInner seasons(List<RemoveItemsFromCollectionRequestShowsInnerSeasonsInner> seasons) {
    this.seasons = seasons;
    return this;
  }

  public RemoveItemsFromPersonalListRequestShowsInner addSeasonsItem(RemoveItemsFromCollectionRequestShowsInnerSeasonsInner seasonsItem) {
   ...
   */
  @javax.annotation.Nonnull
  public List<RemoveItemsFromCollectionRequestShowsInnerSeasonsInner> getSeasons() {
    return seasons;
  }

  public void setSeasons(List<RemoveItemsFromCollectionRequestShowsInnerSeasonsInner> seasons) {
    this.seasons = seasons;
  }
  ...
  public boolean equals(Object o) {
    ...
    RemoveItemsFromPersonalListRequestShowsInner removeItemsFromPersonalListRequestShowsInner = (RemoveItemsFromPersonalListRequestShowsInner) o;
    return Objects.equals(this.ids, removeItemsFromPersonalListRequestShowsInner.ids) &&
        Objects.equals(this.seasons, removeItemsFromPersonalListRequestShowsInner.seasons);
  }

  @Override
  public int hashCode() {
    return Objects.hash(ids, seasons);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class RemoveItemsFromPersonalListRequestShowsInner {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to RemoveItemsFromPersonalListRequestShowsInner
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RemoveItemsFromPersonalListRequestShowsInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in RemoveItemsFromPersonalListRequestShowsInner is not found in the empty JSON string", RemoveItemsFromPersonalListRequestShowsInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RemoveItemsFromPersonalListRequestShowsInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `RemoveItemsFromPersonalListRequestShowsInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : RemoveItemsFromPersonalListRequestShowsInner.openapiRequiredFields) {
      ...
      AddHiddenItemsRequestSeasonsInnerIds.validateJsonElement(jsonObj.get("ids"));
      ...
      // validate the required field `seasons` (array)
      for (int i = 0; i < jsonArrayseasons.size(); i++) {
        RemoveItemsFromCollectionRequestShowsInnerSeasonsInner.validateJsonElement(jsonArrayseasons.get(i));
      };
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RemoveItemsFromPersonalListRequestShowsInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RemoveItemsFromPersonalListRequestShowsInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RemoveItemsFromPersonalListRequestShowsInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RemoveItemsFromPersonalListRequestShowsInner.class));

       return (TypeAdapter<T>) new TypeAdapter<RemoveItemsFromPersonalListRequestShowsInner>() {
           @Override
           public void write(JsonWriter out, RemoveItemsFromPersonalListRequestShowsInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public RemoveItemsFromPersonalListRequestShowsInner read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of RemoveItemsFromPersonalListRequestShowsInner given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of RemoveItemsFromPersonalListRequestShowsInner
   * @throws IOException if the JSON string is invalid with respect to RemoveItemsFromPersonalListRequestShowsInner
   */
  public static RemoveItemsFromPersonalListRequestShowsInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RemoveItemsFromPersonalListRequestShowsInner.class);
  }

  /**
   * Convert an instance of RemoveItemsFromPersonalListRequestShowsInner to an JSON string
   *
   * @return JSON string
   */
