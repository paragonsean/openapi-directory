...
public class AddItemsToPersonalListRequestShowsInner {
  ...
  public AddItemsToPersonalListRequestShowsInner() {
  }

  public AddItemsToPersonalListRequestShowsInner ids(AddHiddenItemsRequestSeasonsInnerIds ids) {
    this.ids = ids;
    return this;
  }
  ...
  public AddItemsToPersonalListRequestShowsInner notes(String notes) {
    this.notes = notes;
    return this;
  }
  ...
  public AddItemsToPersonalListRequestShowsInner seasons(List<RemoveItemsFromCollectionRequestShowsInnerSeasonsInner> seasons) {
    this.seasons = seasons;
    return this;
  }

  public AddItemsToPersonalListRequestShowsInner addSeasonsItem(RemoveItemsFromCollectionRequestShowsInnerSeasonsInner seasonsItem) {
  ...
  public boolean equals(Object o) {
    ...
    AddItemsToPersonalListRequestShowsInner addItemsToPersonalListRequestShowsInner = (AddItemsToPersonalListRequestShowsInner) o;
    return Objects.equals(this.ids, addItemsToPersonalListRequestShowsInner.ids) &&
        Objects.equals(this.notes, addItemsToPersonalListRequestShowsInner.notes) &&
        Objects.equals(this.seasons, addItemsToPersonalListRequestShowsInner.seasons);
  }

  @Override
  public int hashCode() {
    return Objects.hash(ids, notes, seasons);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AddItemsToPersonalListRequestShowsInner {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AddItemsToPersonalListRequestShowsInner
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AddItemsToPersonalListRequestShowsInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AddItemsToPersonalListRequestShowsInner is not found in the empty JSON string", AddItemsToPersonalListRequestShowsInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AddItemsToPersonalListRequestShowsInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AddItemsToPersonalListRequestShowsInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AddItemsToPersonalListRequestShowsInner.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AddItemsToPersonalListRequestShowsInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AddItemsToPersonalListRequestShowsInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AddItemsToPersonalListRequestShowsInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AddItemsToPersonalListRequestShowsInner.class));

       return (TypeAdapter<T>) new TypeAdapter<AddItemsToPersonalListRequestShowsInner>() {
           @Override
           public void write(JsonWriter out, AddItemsToPersonalListRequestShowsInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AddItemsToPersonalListRequestShowsInner read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AddItemsToPersonalListRequestShowsInner given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AddItemsToPersonalListRequestShowsInner
   * @throws IOException if the JSON string is invalid with respect to AddItemsToPersonalListRequestShowsInner
   */
  public static AddItemsToPersonalListRequestShowsInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AddItemsToPersonalListRequestShowsInner.class);
  }

  /**
   * Convert an instance of AddItemsToPersonalListRequestShowsInner to an JSON string
   *
   * @return JSON string
   */
