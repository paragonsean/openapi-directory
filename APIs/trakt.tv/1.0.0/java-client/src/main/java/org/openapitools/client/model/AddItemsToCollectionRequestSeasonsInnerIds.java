...
public class AddItemsToCollectionRequestSeasonsInnerIds {
  ...
  public AddItemsToCollectionRequestSeasonsInnerIds() {
  }

  public AddItemsToCollectionRequestSeasonsInnerIds tmdb(BigDecimal tmdb) {
    this.tmdb = tmdb;
    return this;
  }
  ...
  public AddItemsToCollectionRequestSeasonsInnerIds trakt(BigDecimal trakt) {
    this.trakt = trakt;
    return this;
  }
  ...
  public AddItemsToCollectionRequestSeasonsInnerIds tvdb(BigDecimal tvdb) {
    this.tvdb = tvdb;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    AddItemsToCollectionRequestSeasonsInnerIds addItemsToCollectionRequestSeasonsInnerIds = (AddItemsToCollectionRequestSeasonsInnerIds) o;
    return Objects.equals(this.tmdb, addItemsToCollectionRequestSeasonsInnerIds.tmdb) &&
        Objects.equals(this.trakt, addItemsToCollectionRequestSeasonsInnerIds.trakt) &&
        Objects.equals(this.tvdb, addItemsToCollectionRequestSeasonsInnerIds.tvdb);
  }

  @Override
  public int hashCode() {
    return Objects.hash(tmdb, trakt, tvdb);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AddItemsToCollectionRequestSeasonsInnerIds {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AddItemsToCollectionRequestSeasonsInnerIds
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AddItemsToCollectionRequestSeasonsInnerIds.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AddItemsToCollectionRequestSeasonsInnerIds is not found in the empty JSON string", AddItemsToCollectionRequestSeasonsInnerIds.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AddItemsToCollectionRequestSeasonsInnerIds.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AddItemsToCollectionRequestSeasonsInnerIds` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AddItemsToCollectionRequestSeasonsInnerIds.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AddItemsToCollectionRequestSeasonsInnerIds' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AddItemsToCollectionRequestSeasonsInnerIds> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AddItemsToCollectionRequestSeasonsInnerIds.class));

       return (TypeAdapter<T>) new TypeAdapter<AddItemsToCollectionRequestSeasonsInnerIds>() {
           @Override
           public void write(JsonWriter out, AddItemsToCollectionRequestSeasonsInnerIds value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AddItemsToCollectionRequestSeasonsInnerIds read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AddItemsToCollectionRequestSeasonsInnerIds given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AddItemsToCollectionRequestSeasonsInnerIds
   * @throws IOException if the JSON string is invalid with respect to AddItemsToCollectionRequestSeasonsInnerIds
   */
  public static AddItemsToCollectionRequestSeasonsInnerIds fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AddItemsToCollectionRequestSeasonsInnerIds.class);
  }

  /**
   * Convert an instance of AddItemsToCollectionRequestSeasonsInnerIds to an JSON string
   *
   * @return JSON string
   */
