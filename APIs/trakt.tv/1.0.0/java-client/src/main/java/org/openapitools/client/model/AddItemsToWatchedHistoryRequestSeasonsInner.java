...
import org.openapitools.client.model.AddItemsToCollectionRequestSeasonsInnerIds;
...
public class AddItemsToWatchedHistoryRequestSeasonsInner {
  public static final String SERIALIZED_NAME_IDS = "ids";
  @SerializedName(SERIALIZED_NAME_IDS)
  private AddItemsToCollectionRequestSeasonsInnerIds ids;

  public static final String SERIALIZED_NAME_WATCHED_AT = "watched_at";
  @SerializedName(SERIALIZED_NAME_WATCHED_AT)
  private String watchedAt;

  public AddItemsToWatchedHistoryRequestSeasonsInner() {
  }

  public AddItemsToWatchedHistoryRequestSeasonsInner ids(AddItemsToCollectionRequestSeasonsInnerIds ids) {
    this.ids = ids;
    return this;
  }
  ...
  public AddItemsToCollectionRequestSeasonsInnerIds getIds() {
    return ids;
  }

  public void setIds(AddItemsToCollectionRequestSeasonsInnerIds ids) {
    this.ids = ids;
  }


  public AddItemsToWatchedHistoryRequestSeasonsInner watchedAt(String watchedAt) {
  ...
  public boolean equals(Object o) {
    ...
    AddItemsToWatchedHistoryRequestSeasonsInner addItemsToWatchedHistoryRequestSeasonsInner = (AddItemsToWatchedHistoryRequestSeasonsInner) o;
    return Objects.equals(this.ids, addItemsToWatchedHistoryRequestSeasonsInner.ids) &&
        Objects.equals(this.watchedAt, addItemsToWatchedHistoryRequestSeasonsInner.watchedAt);
  }

  @Override
  public int hashCode() {
    return Objects.hash(ids, watchedAt);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AddItemsToWatchedHistoryRequestSeasonsInner {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AddItemsToWatchedHistoryRequestSeasonsInner
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AddItemsToWatchedHistoryRequestSeasonsInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AddItemsToWatchedHistoryRequestSeasonsInner is not found in the empty JSON string", AddItemsToWatchedHistoryRequestSeasonsInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AddItemsToWatchedHistoryRequestSeasonsInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AddItemsToWatchedHistoryRequestSeasonsInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `ids`
      if (jsonObj.get("ids") != null && !jsonObj.get("ids").isJsonNull()) {
        AddItemsToCollectionRequestSeasonsInnerIds.validateJsonElement(jsonObj.get("ids"));
      }
      if ((jsonObj.get("watched_at") != null && !jsonObj.get("watched_at").isJsonNull()) && !jsonObj.get("watched_at").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `watched_at` to be a primitive type in the JSON string but got `%s`", jsonObj.get("watched_at").toString()));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AddItemsToWatchedHistoryRequestSeasonsInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AddItemsToWatchedHistoryRequestSeasonsInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AddItemsToWatchedHistoryRequestSeasonsInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AddItemsToWatchedHistoryRequestSeasonsInner.class));

       return (TypeAdapter<T>) new TypeAdapter<AddItemsToWatchedHistoryRequestSeasonsInner>() {
           @Override
           public void write(JsonWriter out, AddItemsToWatchedHistoryRequestSeasonsInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AddItemsToWatchedHistoryRequestSeasonsInner read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AddItemsToWatchedHistoryRequestSeasonsInner given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AddItemsToWatchedHistoryRequestSeasonsInner
   * @throws IOException if the JSON string is invalid with respect to AddItemsToWatchedHistoryRequestSeasonsInner
   */
  public static AddItemsToWatchedHistoryRequestSeasonsInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AddItemsToWatchedHistoryRequestSeasonsInner.class);
  }

  /**
   * Convert an instance of AddItemsToWatchedHistoryRequestSeasonsInner to an JSON string
   *
   * @return JSON string
   */
