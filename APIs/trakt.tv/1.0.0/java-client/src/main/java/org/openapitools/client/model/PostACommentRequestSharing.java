...
public class PostACommentRequestSharing {
  ...
  public PostACommentRequestSharing() {
  }

  public PostACommentRequestSharing medium(Boolean medium) {
    this.medium = medium;
    return this;
  }
  ...
  public PostACommentRequestSharing tumblr(Boolean tumblr) {
    this.tumblr = tumblr;
    return this;
  }
  ...
  public PostACommentRequestSharing twitter(Boolean twitter) {
  ...
  public boolean equals(Object o) {
    ...
    PostACommentRequestSharing postACommentRequestSharing = (PostACommentRequestSharing) o;
    return Objects.equals(this.medium, postACommentRequestSharing.medium) &&
        Objects.equals(this.tumblr, postACommentRequestSharing.tumblr) &&
        Objects.equals(this.twitter, postACommentRequestSharing.twitter);
  }

  @Override
  public int hashCode() {
    return Objects.hash(medium, tumblr, twitter);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class PostACommentRequestSharing {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PostACommentRequestSharing
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PostACommentRequestSharing.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PostACommentRequestSharing is not found in the empty JSON string", PostACommentRequestSharing.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PostACommentRequestSharing.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PostACommentRequestSharing` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PostACommentRequestSharing.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PostACommentRequestSharing' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PostACommentRequestSharing> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PostACommentRequestSharing.class));

       return (TypeAdapter<T>) new TypeAdapter<PostACommentRequestSharing>() {
           @Override
           public void write(JsonWriter out, PostACommentRequestSharing value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PostACommentRequestSharing read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PostACommentRequestSharing given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PostACommentRequestSharing
   * @throws IOException if the JSON string is invalid with respect to PostACommentRequestSharing
   */
  public static PostACommentRequestSharing fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PostACommentRequestSharing.class);
  }

  /**
   * Convert an instance of PostACommentRequestSharing to an JSON string
   *
   * @return JSON string
   */
