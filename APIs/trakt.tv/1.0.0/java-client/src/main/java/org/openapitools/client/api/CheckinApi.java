...
import org.openapitools.client.model.CheckIntoAnItemRequest;
...
public class CheckinApi {
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        ...
        <tr><td> 409 </td><td> There is already a checkin in progress. </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call checkIntoAnItemCall(String traktApiVersion, String traktApiKey, CheckIntoAnItemRequest checkIntoAnItemRequest, final ApiCallback _callback) throws ApiException {
        ...
        Object localVarPostBody = checkIntoAnItemRequest;

        // create path and map variables
        String localVarPath = "/checkin";
    ...
    private okhttp3.Call checkIntoAnItemValidateBeforeCall(String traktApiVersion, String traktApiKey, CheckIntoAnItemRequest checkIntoAnItemRequest, final ApiCallback _callback) throws ApiException {
        return checkIntoAnItemCall(traktApiVersion, traktApiKey, checkIntoAnItemRequest, _callback);
     ...
     */
    public void checkIntoAnItem(String traktApiVersion, String traktApiKey, CheckIntoAnItemRequest checkIntoAnItemRequest) throws ApiException {
        checkIntoAnItemWithHttpInfo(traktApiVersion, traktApiKey, checkIntoAnItemRequest);
    }
     ...
     */
    public ApiResponse<Void> checkIntoAnItemWithHttpInfo(String traktApiVersion, String traktApiKey, CheckIntoAnItemRequest checkIntoAnItemRequest) throws ApiException {
        okhttp3.Call localVarCall = checkIntoAnItemValidateBeforeCall(traktApiVersion, traktApiKey, checkIntoAnItemRequest, null);
        return localVarApiClient.execute(localVarCall);
    }

    /**
     * Check into an item (asynchronously)
     * #### &amp;#128274; OAuth Required  Check into a movie or episode. This should be tied to a user action to manually indicate they are watching something. The item will display as *watching* on the site, then automatically switch to *watched* status once the duration has elapsed. A unique history &#x60;id&#x60; (64-bit integer) will be returned and can be used to reference this checkin directly.  #### JSON POST Data  | Key | Type | Value | |---|---|---| | item &lt;span style&#x3D;\&quot;color:red;\&quot;&gt;*&lt;/a&gt; | object | &#x60;movie&#x60; or &#x60;episode&#x60; object. (see examples &amp;#8594;) | | &#x60;sharing&#x60;  | object | Control sharing to any connected social networks. (see below &amp;#8595;) | | &#x60;message&#x60;  | string | Message used for sharing. If not sent, it will use the watching string in the user settings. | | &#x60;venue_id&#x60; | string | Foursquare venue ID. | | &#x60;venue_name&#x60; | string | Foursquare venue name. | | &#x60;app_version&#x60; | string | Version number of the app. | | &#x60;app_date&#x60; | string | Build date of the app. |  #### Sharing  The &#x60;sharing&#x60; object is optional and will apply the user&#39;s settings if not sent. If &#x60;sharing&#x60; is sent, each key will override the user&#39;s setting for that social network. Send &#x60;true&#x60; to post or &#x60;false&#x60; to not post on the indicated social network. You can see which social networks a user has connected with the [**_/users/settings**](/reference/users/settings) method.  | Key | Type | |---|---| | &#x60;twitter&#x60; | boolean | | &#x60;mastodon&#x60; | boolean | | &#x60;tumblr&#x60; | boolean |  **Note:** If a checkin is already in progress, a &#x60;409&#x60; HTTP status code will returned. The response will contain an &#x60;expires_at&#x60; timestamp which is when the user can check in again.
     * @param traktApiVersion e.g. 2 (optional)
     * @param traktApiKey e.g. [client_id] (optional)
     * @param checkIntoAnItemRequest  (optional)
     ...
     */
    public okhttp3.Call checkIntoAnItemAsync(String traktApiVersion, String traktApiKey, CheckIntoAnItemRequest checkIntoAnItemRequest, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = checkIntoAnItemValidateBeforeCall(traktApiVersion, traktApiKey, checkIntoAnItemRequest, _callback);
        localVarApiClient.executeAsync(localVarCall, _callback);
        return localVarCall;
    }
    /**
     * Build call for deleteAnyActiveCheckins
     * @param traktApiVersion e.g. 2 (optional)
     * @param traktApiKey e.g. [client_id] (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     ...
     */
    public okhttp3.Call deleteAnyActiveCheckinsCall(String traktApiVersion, String traktApiKey, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call deleteAnyActiveCheckinsValidateBeforeCall(String traktApiVersion, String traktApiKey, final ApiCallback _callback) throws ApiException {
        return deleteAnyActiveCheckinsCall(traktApiVersion, traktApiKey, _callback);
     ...
     */
    public void deleteAnyActiveCheckins(String traktApiVersion, String traktApiKey) throws ApiException {
        deleteAnyActiveCheckinsWithHttpInfo(traktApiVersion, traktApiKey);
    }
     ...
     */
    public ApiResponse<Void> deleteAnyActiveCheckinsWithHttpInfo(String traktApiVersion, String traktApiKey) throws ApiException {
        okhttp3.Call localVarCall = deleteAnyActiveCheckinsValidateBeforeCall(traktApiVersion, traktApiKey, null);
        return localVarApiClient.execute(localVarCall);
    }

    /**
     * Delete any active checkins (asynchronously)
     * #### &amp;#128274; OAuth Required  Removes any active checkins, no need to provide a specific item.
     * @param traktApiVersion e.g. 2 (optional)
     * @param traktApiKey e.g. [client_id] (optional)
     * @param _callback The callback to be executed when the API call finishes
     ...
     */
    public okhttp3.Call deleteAnyActiveCheckinsAsync(String traktApiVersion, String traktApiKey, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = deleteAnyActiveCheckinsValidateBeforeCall(traktApiVersion, traktApiKey, _callback);
        localVarApiClient.executeAsync(localVarCall, _callback);
        return localVarCall;
    }
}
