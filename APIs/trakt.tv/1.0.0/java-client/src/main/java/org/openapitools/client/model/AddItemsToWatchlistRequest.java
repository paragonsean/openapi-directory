...
import org.openapitools.client.model.AddItemsToPersonalRecommendationsRequestMoviesInner;
import org.openapitools.client.model.AddItemsToWatchlistRequestShowsInner;
...
public class AddItemsToWatchlistRequest {
  ...
  private List<AddItemsToPersonalRecommendationsRequestMoviesInner> movies = new ArrayList<>();
  ...
  private List<AddItemsToWatchlistRequestShowsInner> shows = new ArrayList<>();

  public AddItemsToWatchlistRequest() {
  }

  public AddItemsToWatchlistRequest episodes(List<AddItemsToCollectionRequestEpisodesInner> episodes) {
    this.episodes = episodes;
    return this;
  }

  public AddItemsToWatchlistRequest addEpisodesItem(AddItemsToCollectionRequestEpisodesInner episodesItem) {
  ...
  public AddItemsToWatchlistRequest movies(List<AddItemsToPersonalRecommendationsRequestMoviesInner> movies) {
    this.movies = movies;
    return this;
  }

  public AddItemsToWatchlistRequest addMoviesItem(AddItemsToPersonalRecommendationsRequestMoviesInner moviesItem) {
    if (this.movies == null) {
   ...
   */
  @javax.annotation.Nullable
  public List<AddItemsToPersonalRecommendationsRequestMoviesInner> getMovies() {
    return movies;
  }

  public void setMovies(List<AddItemsToPersonalRecommendationsRequestMoviesInner> movies) {
    this.movies = movies;
  }


  public AddItemsToWatchlistRequest seasons(List<AddItemsToCollectionRequestSeasonsInner> seasons) {
    this.seasons = seasons;
    return this;
  }

  public AddItemsToWatchlistRequest addSeasonsItem(AddItemsToCollectionRequestSeasonsInner seasonsItem) {
  ...
  public AddItemsToWatchlistRequest shows(List<AddItemsToWatchlistRequestShowsInner> shows) {
    this.shows = shows;
    return this;
  }

  public AddItemsToWatchlistRequest addShowsItem(AddItemsToWatchlistRequestShowsInner showsItem) {
    if (this.shows == null) {
   ...
   */
  @javax.annotation.Nullable
  public List<AddItemsToWatchlistRequestShowsInner> getShows() {
    return shows;
  }

  public void setShows(List<AddItemsToWatchlistRequestShowsInner> shows) {
    this.shows = shows;
  }
  ...
  public boolean equals(Object o) {
    ...
    AddItemsToWatchlistRequest addItemsToWatchlistRequest = (AddItemsToWatchlistRequest) o;
    return Objects.equals(this.episodes, addItemsToWatchlistRequest.episodes) &&
        Objects.equals(this.movies, addItemsToWatchlistRequest.movies) &&
        Objects.equals(this.seasons, addItemsToWatchlistRequest.seasons) &&
        Objects.equals(this.shows, addItemsToWatchlistRequest.shows);
  }
  ...
  public String toString() {
    ...
    sb.append("class AddItemsToWatchlistRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AddItemsToWatchlistRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AddItemsToWatchlistRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AddItemsToWatchlistRequest is not found in the empty JSON string", AddItemsToWatchlistRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AddItemsToWatchlistRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AddItemsToWatchlistRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("movies") != null && !jsonObj.get("movies").isJsonNull()) {
        ...
        if (jsonArraymovies != null) {
          ...
          for (int i = 0; i < jsonArraymovies.size(); i++) {
            AddItemsToPersonalRecommendationsRequestMoviesInner.validateJsonElement(jsonArraymovies.get(i));
          };
        }
      }
      ...
      if (jsonObj.get("shows") != null && !jsonObj.get("shows").isJsonNull()) {
        ...
        if (jsonArrayshows != null) {
          ...
          for (int i = 0; i < jsonArrayshows.size(); i++) {
            AddItemsToWatchlistRequestShowsInner.validateJsonElement(jsonArrayshows.get(i));
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AddItemsToWatchlistRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AddItemsToWatchlistRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AddItemsToWatchlistRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AddItemsToWatchlistRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<AddItemsToWatchlistRequest>() {
           @Override
           public void write(JsonWriter out, AddItemsToWatchlistRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AddItemsToWatchlistRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AddItemsToWatchlistRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AddItemsToWatchlistRequest
   * @throws IOException if the JSON string is invalid with respect to AddItemsToWatchlistRequest
   */
  public static AddItemsToWatchlistRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AddItemsToWatchlistRequest.class);
  }

  /**
   * Convert an instance of AddItemsToWatchlistRequest to an JSON string
   *
   * @return JSON string
   */
