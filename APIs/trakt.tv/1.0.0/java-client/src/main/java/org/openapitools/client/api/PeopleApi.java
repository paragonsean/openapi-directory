...
public class PeopleApi {
    ...
    /**
     * Build call for getASinglePerson
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        ...
        <tr><td> 200 </td><td> &#x60;&#x60;&#x60; /people/bryan-cranston?extended&#x3D;full &#x60;&#x60;&#x60; </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call getASinglePersonCall(String id, String traktApiVersion, String traktApiKey, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call getASinglePersonValidateBeforeCall(String id, String traktApiVersion, String traktApiKey, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new ApiException("Missing the required parameter 'id' when calling getASinglePerson(Async)");
        }

        return getASinglePersonCall(id, traktApiVersion, traktApiKey, _callback);
     ...
     */
    public void getASinglePerson(String id, String traktApiVersion, String traktApiKey) throws ApiException {
        getASinglePersonWithHttpInfo(id, traktApiVersion, traktApiKey);
    }
     ...
     */
    public ApiResponse<Void> getASinglePersonWithHttpInfo(String id, String traktApiVersion, String traktApiKey) throws ApiException {
        okhttp3.Call localVarCall = getASinglePersonValidateBeforeCall(id, traktApiVersion, traktApiKey, null);
        return localVarApiClient.execute(localVarCall);
    }

    /**
     * Get a single person (asynchronously)
     * #### &amp;#10024; Extended Info  Returns a single person&#39;s details.  #### Gender  If available, the &#x60;gender&#x60; property will be set to &#x60;male&#x60;, &#x60;female&#x60;, or &#x60;non_binary&#x60;.  #### Known For Department  If available, the &#x60;known_for_department&#x60; property will be set to &#x60;production&#x60;, &#x60;art&#x60;, &#x60;crew&#x60;, &#x60;costume &amp; make-up&#x60;, &#x60;directing&#x60;, &#x60;writing&#x60;, &#x60;sound&#x60;, &#x60;camera&#x60;, &#x60;visual effects&#x60;, &#x60;lighting&#x60;, or &#x60;editing&#x60;. Many people have credits across departments, &#x60;known_for&#x60; allows you to select their default credits more accurately.
     * @param id Trakt ID, Trakt slug, or IMDB ID (required)
     * @param traktApiVersion e.g. 2 (optional)
     * @param traktApiKey e.g. [client_id] (optional)
     ...
     */
    public okhttp3.Call getASinglePersonAsync(String id, String traktApiVersion, String traktApiKey, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = getASinglePersonValidateBeforeCall(id, traktApiVersion, traktApiKey, _callback);
        localVarApiClient.executeAsync(localVarCall, _callback);
        return localVarCall;
    }
    /**
     * Build call for getListsContainingThisPerson
     * @param id Trakt ID, Trakt slug, or IMDB ID (required)
     ...
     */
    public okhttp3.Call getListsContainingThisPersonCall(String id, String type, String sort, String traktApiVersion, String traktApiKey, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/people/{id}/lists/{type}/{sort}"
            .replace("{" + "id" + "}", localVarApiClient.escapeString(id.toString()))
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getListsContainingThisPersonValidateBeforeCall(String id, String type, String sort, String traktApiVersion, String traktApiKey, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new ApiException("Missing the required parameter 'id' when calling getListsContainingThisPerson(Async)");
        }

        // verify the required parameter 'type' is set
        if (type == null) {
            throw new ApiException("Missing the required parameter 'type' when calling getListsContainingThisPerson(Async)");
        }

        // verify the required parameter 'sort' is set
        if (sort == null) {
            throw new ApiException("Missing the required parameter 'sort' when calling getListsContainingThisPerson(Async)");
        }

        return getListsContainingThisPersonCall(id, type, sort, traktApiVersion, traktApiKey, _callback);
     ...
     */
    public void getListsContainingThisPerson(String id, String type, String sort, String traktApiVersion, String traktApiKey) throws ApiException {
        getListsContainingThisPersonWithHttpInfo(id, type, sort, traktApiVersion, traktApiKey);
    }
     ...
     */
    public ApiResponse<Void> getListsContainingThisPersonWithHttpInfo(String id, String type, String sort, String traktApiVersion, String traktApiKey) throws ApiException {
        okhttp3.Call localVarCall = getListsContainingThisPersonValidateBeforeCall(id, type, sort, traktApiVersion, traktApiKey, null);
        return localVarApiClient.execute(localVarCall);
    }

    /**
     * Get lists containing this person (asynchronously)
     * #### &amp;#128196; Pagination &amp;#128513; Emojis  Returns all lists that contain this person. By default, &#x60;personal&#x60; lists are returned sorted by the most &#x60;popular&#x60;.
     * @param id Trakt ID, Trakt slug, or IMDB ID (required)
     * @param type Filter for a specific list type (required)
     * @param sort How to sort (required)
     ...
     */
    public okhttp3.Call getListsContainingThisPersonAsync(String id, String type, String sort, String traktApiVersion, String traktApiKey, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = getListsContainingThisPersonValidateBeforeCall(id, type, sort, traktApiVersion, traktApiKey, _callback);
        localVarApiClient.executeAsync(localVarCall, _callback);
        return localVarCall;
    }
    /**
     * Build call for getMovieCredits
     * @param id Trakt ID, Trakt slug, or IMDB ID (required)
     * @param traktApiVersion e.g. 2 (optional)
     * @param traktApiKey e.g. [client_id] (optional)
     * @param _callback Callback for upload/download progress
     ...
     */
    public okhttp3.Call getMovieCreditsCall(String id, String traktApiVersion, String traktApiKey, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/people/{id}/movies"
            .replace("{" + "id" + "}", localVarApiClient.escapeString(id.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getMovieCreditsValidateBeforeCall(String id, String traktApiVersion, String traktApiKey, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new ApiException("Missing the required parameter 'id' when calling getMovieCredits(Async)");
        }

        return getMovieCreditsCall(id, traktApiVersion, traktApiKey, _callback);
     ...
     */
    public void getMovieCredits(String id, String traktApiVersion, String traktApiKey) throws ApiException {
        getMovieCreditsWithHttpInfo(id, traktApiVersion, traktApiKey);
    }
     ...
     */
    public ApiResponse<Void> getMovieCreditsWithHttpInfo(String id, String traktApiVersion, String traktApiKey) throws ApiException {
        okhttp3.Call localVarCall = getMovieCreditsValidateBeforeCall(id, traktApiVersion, traktApiKey, null);
        return localVarApiClient.execute(localVarCall);
    }
     ...
     */
    public okhttp3.Call getMovieCreditsAsync(String id, String traktApiVersion, String traktApiKey, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = getMovieCreditsValidateBeforeCall(id, traktApiVersion, traktApiKey, _callback);
        localVarApiClient.executeAsync(localVarCall, _callback);
        return localVarCall;
    }
    /**
     * Build call for getRecentlyUpdatedPeople
     ...
     */
    public okhttp3.Call getRecentlyUpdatedPeopleCall(String startDate, String traktApiVersion, String traktApiKey, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/people/updates/{start_date}"
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getRecentlyUpdatedPeopleValidateBeforeCall(String startDate, String traktApiVersion, String traktApiKey, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'startDate' is set
        if (startDate == null) {
            throw new ApiException("Missing the required parameter 'startDate' when calling getRecentlyUpdatedPeople(Async)");
        }

        return getRecentlyUpdatedPeopleCall(startDate, traktApiVersion, traktApiKey, _callback);
     ...
     */
    public void getRecentlyUpdatedPeople(String startDate, String traktApiVersion, String traktApiKey) throws ApiException {
        getRecentlyUpdatedPeopleWithHttpInfo(startDate, traktApiVersion, traktApiKey);
    }
     ...
     */
    public ApiResponse<Void> getRecentlyUpdatedPeopleWithHttpInfo(String startDate, String traktApiVersion, String traktApiKey) throws ApiException {
        okhttp3.Call localVarCall = getRecentlyUpdatedPeopleValidateBeforeCall(startDate, traktApiVersion, traktApiKey, null);
        return localVarApiClient.execute(localVarCall);
    }

    /**
     * Get recently updated people (asynchronously)
     * #### &amp;#128196; Pagination &amp;#10024; Extended Info  Returns all people updated since the specified UTC date and time. We recommended storing the &#x60;X-Start-Date&#x60; header you can be efficient using this method moving forward. By default, &#x60;10&#x60; results are returned. You can send a &#x60;limit&#x60; to get up to &#x60;100&#x60; results per page.  **Important!** The &#x60;start_date&#x60; is only accurate to the hour, for caching purposes. Please drop the minutes and seconds from your timestamp to help optimize our cached data. For example, use &#x60;2021-07-17T12:00:00Z&#x60; and not &#x60;2021-07-17T12:23:34Z&#x60;.  **Note:** The &#x60;start_date&#x60; can only be a maximum of 30 days in the past.
     * @param startDate Updated since this date and time. (required)
     * @param traktApiVersion e.g. 2 (optional)
     * @param traktApiKey e.g. [client_id] (optional)
     ...
     */
    public okhttp3.Call getRecentlyUpdatedPeopleAsync(String startDate, String traktApiVersion, String traktApiKey, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = getRecentlyUpdatedPeopleValidateBeforeCall(startDate, traktApiVersion, traktApiKey, _callback);
        localVarApiClient.executeAsync(localVarCall, _callback);
        return localVarCall;
    }
    /**
     * Build call for getRecentlyUpdatedPeopleTraktIDs
     * @param startDate Updated since this date and time. (required)
     * @param traktApiVersion e.g. 2 (optional)
     * @param traktApiKey e.g. [client_id] (optional)
     * @param _callback Callback for upload/download progress
     ...
     */
    public okhttp3.Call getRecentlyUpdatedPeopleTraktIDsCall(String startDate, String traktApiVersion, String traktApiKey, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/people/updates/id/{start_date}"
            .replace("{" + "start_date" + "}", localVarApiClient.escapeString(startDate.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getRecentlyUpdatedPeopleTraktIDsValidateBeforeCall(String startDate, String traktApiVersion, String traktApiKey, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'startDate' is set
        if (startDate == null) {
            throw new ApiException("Missing the required parameter 'startDate' when calling getRecentlyUpdatedPeopleTraktIDs(Async)");
        }

        return getRecentlyUpdatedPeopleTraktIDsCall(startDate, traktApiVersion, traktApiKey, _callback);
     ...
     */
    public void getRecentlyUpdatedPeopleTraktIDs(String startDate, String traktApiVersion, String traktApiKey) throws ApiException {
        getRecentlyUpdatedPeopleTraktIDsWithHttpInfo(startDate, traktApiVersion, traktApiKey);
    }
     ...
     */
    public ApiResponse<Void> getRecentlyUpdatedPeopleTraktIDsWithHttpInfo(String startDate, String traktApiVersion, String traktApiKey) throws ApiException {
        okhttp3.Call localVarCall = getRecentlyUpdatedPeopleTraktIDsValidateBeforeCall(startDate, traktApiVersion, traktApiKey, null);
        return localVarApiClient.execute(localVarCall);
    }

    /**
     * Get recently updated people Trakt IDs (asynchronously)
     * #### &amp;#128196; Pagination  Returns all people Trakt IDs updated since the specified UTC date and time. We recommended storing the &#x60;X-Start-Date&#x60; header you can be efficient using this method moving forward. By default, &#x60;10&#x60; results are returned. You can send a &#x60;limit&#x60; to get up to &#x60;100&#x60; results per page.  **Important!** The &#x60;start_date&#x60; is only accurate to the hour, for caching purposes. Please drop the minutes and seconds from your timestamp to help optimize our cached data. For example, use &#x60;2021-07-17T12:00:00Z&#x60; and not &#x60;2021-07-17T12:23:34Z&#x60;.  **Note:** The &#x60;start_date&#x60; can only be a maximum of 30 days in the past.
     * @param startDate Updated since this date and time. (required)
     * @param traktApiVersion e.g. 2 (optional)
     * @param traktApiKey e.g. [client_id] (optional)
     ...
     */
    public okhttp3.Call getRecentlyUpdatedPeopleTraktIDsAsync(String startDate, String traktApiVersion, String traktApiKey, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = getRecentlyUpdatedPeopleTraktIDsValidateBeforeCall(startDate, traktApiVersion, traktApiKey, _callback);
        localVarApiClient.executeAsync(localVarCall, _callback);
        return localVarCall;
    }
    /**
     * Build call for getShowCredits
     * @param id Trakt ID, Trakt slug, or IMDB ID (required)
     * @param traktApiVersion e.g. 2 (optional)
     * @param traktApiKey e.g. [client_id] (optional)
     * @param _callback Callback for upload/download progress
     ...
     */
    public okhttp3.Call getShowCreditsCall(String id, String traktApiVersion, String traktApiKey, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/people/{id}/shows"
            .replace("{" + "id" + "}", localVarApiClient.escapeString(id.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getShowCreditsValidateBeforeCall(String id, String traktApiVersion, String traktApiKey, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new ApiException("Missing the required parameter 'id' when calling getShowCredits(Async)");
        }

        return getShowCreditsCall(id, traktApiVersion, traktApiKey, _callback);
     ...
     */
    public void getShowCredits(String id, String traktApiVersion, String traktApiKey) throws ApiException {
        getShowCreditsWithHttpInfo(id, traktApiVersion, traktApiKey);
    }
     ...
     */
    public ApiResponse<Void> getShowCreditsWithHttpInfo(String id, String traktApiVersion, String traktApiKey) throws ApiException {
        okhttp3.Call localVarCall = getShowCreditsValidateBeforeCall(id, traktApiVersion, traktApiKey, null);
        return localVarApiClient.execute(localVarCall);
    }

    /**
     * Get show credits (asynchronously)
     * #### &amp;#10024; Extended Info  Returns all shows where this person is in the &#x60;cast&#x60; or &#x60;crew&#x60;, including the &#x60;episode_count&#x60; for which they appear. Each &#x60;cast&#x60; object will have a &#x60;characters&#x60; array and a standard &#x60;show&#x60; object. If &#x60;series_regular&#x60; is &#x60;true&#x60;, this person is a series regular and not simply a guest star.  The &#x60;crew&#x60; object will be broken up by department into &#x60;production&#x60;, &#x60;art&#x60;, &#x60;crew&#x60;, &#x60;costume &amp; make-up&#x60;, &#x60;directing&#x60;, &#x60;writing&#x60;, &#x60;sound&#x60;, &#x60;camera&#x60;, &#x60;visual effects&#x60;, &#x60;lighting&#x60;, &#x60;editing&#x60;, and &#x60;created  by&#x60; (if there are people for those crew positions). Each of those members will have a &#x60;jobs&#x60; array and a standard &#x60;show&#x60; object.
     * @param id Trakt ID, Trakt slug, or IMDB ID (required)
     * @param traktApiVersion e.g. 2 (optional)
     * @param traktApiKey e.g. [client_id] (optional)
     ...
     */
    public okhttp3.Call getShowCreditsAsync(String id, String traktApiVersion, String traktApiKey, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = getShowCreditsValidateBeforeCall(id, traktApiVersion, traktApiKey, _callback);
        localVarApiClient.executeAsync(localVarCall, _callback);
        return localVarCall;
    }
}
