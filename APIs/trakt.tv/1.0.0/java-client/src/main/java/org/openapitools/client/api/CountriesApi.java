...
public class CountriesApi {
     ...
     */
    public okhttp3.Call getCountriesCall(String type, String traktApiVersion, String traktApiKey, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/countries/{type}"
    ...
    private okhttp3.Call getCountriesValidateBeforeCall(String type, String traktApiVersion, String traktApiKey, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'type' is set
        if (type == null) {
            throw new ApiException("Missing the required parameter 'type' when calling getCountries(Async)");
        }

        return getCountriesCall(type, traktApiVersion, traktApiKey, _callback);
     ...
     */
    public void getCountries(String type, String traktApiVersion, String traktApiKey) throws ApiException {
        getCountriesWithHttpInfo(type, traktApiVersion, traktApiKey);
    }
     ...
     */
    public ApiResponse<Void> getCountriesWithHttpInfo(String type, String traktApiVersion, String traktApiKey) throws ApiException {
        okhttp3.Call localVarCall = getCountriesValidateBeforeCall(type, traktApiVersion, traktApiKey, null);
     ...
     */
    public okhttp3.Call getCountriesAsync(String type, String traktApiVersion, String traktApiKey, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = getCountriesValidateBeforeCall(type, traktApiVersion, traktApiKey, _callback);
