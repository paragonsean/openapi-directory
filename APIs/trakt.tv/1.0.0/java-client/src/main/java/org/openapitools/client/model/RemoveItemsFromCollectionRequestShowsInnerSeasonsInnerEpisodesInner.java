...
public class RemoveItemsFromCollectionRequestShowsInnerSeasonsInnerEpisodesInner {
  public static final String SERIALIZED_NAME_NUMBER = "number";
  @SerializedName(SERIALIZED_NAME_NUMBER)
  private BigDecimal number;

  public RemoveItemsFromCollectionRequestShowsInnerSeasonsInnerEpisodesInner() {
  }

  public RemoveItemsFromCollectionRequestShowsInnerSeasonsInnerEpisodesInner number(BigDecimal number) {
    this.number = number;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    RemoveItemsFromCollectionRequestShowsInnerSeasonsInnerEpisodesInner removeItemsFromCollectionRequestShowsInnerSeasonsInnerEpisodesInner = (RemoveItemsFromCollectionRequestShowsInnerSeasonsInnerEpisodesInner) o;
    return Objects.equals(this.number, removeItemsFromCollectionRequestShowsInnerSeasonsInnerEpisodesInner.number);
  }
  ...
  public String toString() {
    ...
    sb.append("class RemoveItemsFromCollectionRequestShowsInnerSeasonsInnerEpisodesInner {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to RemoveItemsFromCollectionRequestShowsInnerSeasonsInnerEpisodesInner
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RemoveItemsFromCollectionRequestShowsInnerSeasonsInnerEpisodesInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in RemoveItemsFromCollectionRequestShowsInnerSeasonsInnerEpisodesInner is not found in the empty JSON string", RemoveItemsFromCollectionRequestShowsInnerSeasonsInnerEpisodesInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RemoveItemsFromCollectionRequestShowsInnerSeasonsInnerEpisodesInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `RemoveItemsFromCollectionRequestShowsInnerSeasonsInnerEpisodesInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : RemoveItemsFromCollectionRequestShowsInnerSeasonsInnerEpisodesInner.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RemoveItemsFromCollectionRequestShowsInnerSeasonsInnerEpisodesInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RemoveItemsFromCollectionRequestShowsInnerSeasonsInnerEpisodesInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RemoveItemsFromCollectionRequestShowsInnerSeasonsInnerEpisodesInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RemoveItemsFromCollectionRequestShowsInnerSeasonsInnerEpisodesInner.class));

       return (TypeAdapter<T>) new TypeAdapter<RemoveItemsFromCollectionRequestShowsInnerSeasonsInnerEpisodesInner>() {
           @Override
           public void write(JsonWriter out, RemoveItemsFromCollectionRequestShowsInnerSeasonsInnerEpisodesInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public RemoveItemsFromCollectionRequestShowsInnerSeasonsInnerEpisodesInner read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of RemoveItemsFromCollectionRequestShowsInnerSeasonsInnerEpisodesInner given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of RemoveItemsFromCollectionRequestShowsInnerSeasonsInnerEpisodesInner
   * @throws IOException if the JSON string is invalid with respect to RemoveItemsFromCollectionRequestShowsInnerSeasonsInnerEpisodesInner
   */
  public static RemoveItemsFromCollectionRequestShowsInnerSeasonsInnerEpisodesInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RemoveItemsFromCollectionRequestShowsInnerSeasonsInnerEpisodesInner.class);
  }

  /**
   * Convert an instance of RemoveItemsFromCollectionRequestShowsInnerSeasonsInnerEpisodesInner to an JSON string
   *
   * @return JSON string
   */
