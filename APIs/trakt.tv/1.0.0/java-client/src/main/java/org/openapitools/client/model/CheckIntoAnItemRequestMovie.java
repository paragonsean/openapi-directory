...
public class CheckIntoAnItemRequestMovie {
  ...
  public CheckIntoAnItemRequestMovie() {
  }

  public CheckIntoAnItemRequestMovie ids(CheckIntoAnItemRequestMovieIds ids) {
    this.ids = ids;
    return this;
  }
  ...
  public CheckIntoAnItemRequestMovie title(String title) {
    this.title = title;
    return this;
  }
  ...
  public CheckIntoAnItemRequestMovie year(BigDecimal year) {
    this.year = year;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    CheckIntoAnItemRequestMovie checkIntoAnItemRequestMovie = (CheckIntoAnItemRequestMovie) o;
    return Objects.equals(this.ids, checkIntoAnItemRequestMovie.ids) &&
        Objects.equals(this.title, checkIntoAnItemRequestMovie.title) &&
        Objects.equals(this.year, checkIntoAnItemRequestMovie.year);
  }

  @Override
  public int hashCode() {
    return Objects.hash(ids, title, year);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CheckIntoAnItemRequestMovie {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CheckIntoAnItemRequestMovie
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CheckIntoAnItemRequestMovie.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CheckIntoAnItemRequestMovie is not found in the empty JSON string", CheckIntoAnItemRequestMovie.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CheckIntoAnItemRequestMovie.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CheckIntoAnItemRequestMovie` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CheckIntoAnItemRequestMovie.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CheckIntoAnItemRequestMovie' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CheckIntoAnItemRequestMovie> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CheckIntoAnItemRequestMovie.class));

       return (TypeAdapter<T>) new TypeAdapter<CheckIntoAnItemRequestMovie>() {
           @Override
           public void write(JsonWriter out, CheckIntoAnItemRequestMovie value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CheckIntoAnItemRequestMovie read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CheckIntoAnItemRequestMovie given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CheckIntoAnItemRequestMovie
   * @throws IOException if the JSON string is invalid with respect to CheckIntoAnItemRequestMovie
   */
  public static CheckIntoAnItemRequestMovie fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CheckIntoAnItemRequestMovie.class);
  }

  /**
   * Convert an instance of CheckIntoAnItemRequestMovie to an JSON string
   *
   * @return JSON string
   */
