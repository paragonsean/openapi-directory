...
public class RemoveItemsFromPersonalRecommendationsRequestShowsInner {
  ...
  public RemoveItemsFromPersonalRecommendationsRequestShowsInner() {
  }

  public RemoveItemsFromPersonalRecommendationsRequestShowsInner ids(AddItemsToCollectionRequestShowsInnerIds ids) {
    this.ids = ids;
    return this;
  }
  ...
  public RemoveItemsFromPersonalRecommendationsRequestShowsInner title(String title) {
    this.title = title;
    return this;
  }
  ...
  public RemoveItemsFromPersonalRecommendationsRequestShowsInner year(BigDecimal year) {
    this.year = year;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    RemoveItemsFromPersonalRecommendationsRequestShowsInner removeItemsFromPersonalRecommendationsRequestShowsInner = (RemoveItemsFromPersonalRecommendationsRequestShowsInner) o;
    return Objects.equals(this.ids, removeItemsFromPersonalRecommendationsRequestShowsInner.ids) &&
        Objects.equals(this.title, removeItemsFromPersonalRecommendationsRequestShowsInner.title) &&
        Objects.equals(this.year, removeItemsFromPersonalRecommendationsRequestShowsInner.year);
  }
  ...
  public String toString() {
    ...
    sb.append("class RemoveItemsFromPersonalRecommendationsRequestShowsInner {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to RemoveItemsFromPersonalRecommendationsRequestShowsInner
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RemoveItemsFromPersonalRecommendationsRequestShowsInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in RemoveItemsFromPersonalRecommendationsRequestShowsInner is not found in the empty JSON string", RemoveItemsFromPersonalRecommendationsRequestShowsInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RemoveItemsFromPersonalRecommendationsRequestShowsInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `RemoveItemsFromPersonalRecommendationsRequestShowsInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RemoveItemsFromPersonalRecommendationsRequestShowsInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RemoveItemsFromPersonalRecommendationsRequestShowsInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RemoveItemsFromPersonalRecommendationsRequestShowsInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RemoveItemsFromPersonalRecommendationsRequestShowsInner.class));

       return (TypeAdapter<T>) new TypeAdapter<RemoveItemsFromPersonalRecommendationsRequestShowsInner>() {
           @Override
           public void write(JsonWriter out, RemoveItemsFromPersonalRecommendationsRequestShowsInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public RemoveItemsFromPersonalRecommendationsRequestShowsInner read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of RemoveItemsFromPersonalRecommendationsRequestShowsInner given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of RemoveItemsFromPersonalRecommendationsRequestShowsInner
   * @throws IOException if the JSON string is invalid with respect to RemoveItemsFromPersonalRecommendationsRequestShowsInner
   */
  public static RemoveItemsFromPersonalRecommendationsRequestShowsInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RemoveItemsFromPersonalRecommendationsRequestShowsInner.class);
  }

  /**
   * Convert an instance of RemoveItemsFromPersonalRecommendationsRequestShowsInner to an JSON string
   *
   * @return JSON string
   */
