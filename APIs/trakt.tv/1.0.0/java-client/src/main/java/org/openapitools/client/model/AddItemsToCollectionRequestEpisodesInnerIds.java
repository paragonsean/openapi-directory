...
public class AddItemsToCollectionRequestEpisodesInnerIds {
  public static final String SERIALIZED_NAME_IMDB = "imdb";
  @SerializedName(SERIALIZED_NAME_IMDB)
  private String imdb;

  public static final String SERIALIZED_NAME_TMDB = "tmdb";
  @SerializedName(SERIALIZED_NAME_TMDB)
  private BigDecimal tmdb;

  public static final String SERIALIZED_NAME_TRAKT = "trakt";
  @SerializedName(SERIALIZED_NAME_TRAKT)
  private BigDecimal trakt;

  public static final String SERIALIZED_NAME_TVDB = "tvdb";
  @SerializedName(SERIALIZED_NAME_TVDB)
  private BigDecimal tvdb;

  public AddItemsToCollectionRequestEpisodesInnerIds() {
  }

  public AddItemsToCollectionRequestEpisodesInnerIds imdb(String imdb) {
    this.imdb = imdb;
    return this;
  }
  ...
  public AddItemsToCollectionRequestEpisodesInnerIds tmdb(BigDecimal tmdb) {
    this.tmdb = tmdb;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public BigDecimal getTmdb() {
    return tmdb;
  }

  public void setTmdb(BigDecimal tmdb) {
    this.tmdb = tmdb;
  }


  public AddItemsToCollectionRequestEpisodesInnerIds trakt(BigDecimal trakt) {
    this.trakt = trakt;
    return this;
  }
  ...
  public AddItemsToCollectionRequestEpisodesInnerIds tvdb(BigDecimal tvdb) {
    this.tvdb = tvdb;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public BigDecimal getTvdb() {
    return tvdb;
  }

  public void setTvdb(BigDecimal tvdb) {
    this.tvdb = tvdb;
  }
  ...
  public boolean equals(Object o) {
    ...
    AddItemsToCollectionRequestEpisodesInnerIds addItemsToCollectionRequestEpisodesInnerIds = (AddItemsToCollectionRequestEpisodesInnerIds) o;
    return Objects.equals(this.imdb, addItemsToCollectionRequestEpisodesInnerIds.imdb) &&
        Objects.equals(this.tmdb, addItemsToCollectionRequestEpisodesInnerIds.tmdb) &&
        Objects.equals(this.trakt, addItemsToCollectionRequestEpisodesInnerIds.trakt) &&
        Objects.equals(this.tvdb, addItemsToCollectionRequestEpisodesInnerIds.tvdb);
  }

  @Override
  public int hashCode() {
    return Objects.hash(imdb, tmdb, trakt, tvdb);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AddItemsToCollectionRequestEpisodesInnerIds {\n");
    sb.append("    imdb: ").append(toIndentedString(imdb)).append("\n");
    sb.append("    tmdb: ").append(toIndentedString(tmdb)).append("\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AddItemsToCollectionRequestEpisodesInnerIds
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AddItemsToCollectionRequestEpisodesInnerIds.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AddItemsToCollectionRequestEpisodesInnerIds is not found in the empty JSON string", AddItemsToCollectionRequestEpisodesInnerIds.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AddItemsToCollectionRequestEpisodesInnerIds.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AddItemsToCollectionRequestEpisodesInnerIds` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AddItemsToCollectionRequestEpisodesInnerIds.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AddItemsToCollectionRequestEpisodesInnerIds' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AddItemsToCollectionRequestEpisodesInnerIds> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AddItemsToCollectionRequestEpisodesInnerIds.class));

       return (TypeAdapter<T>) new TypeAdapter<AddItemsToCollectionRequestEpisodesInnerIds>() {
           @Override
           public void write(JsonWriter out, AddItemsToCollectionRequestEpisodesInnerIds value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AddItemsToCollectionRequestEpisodesInnerIds read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AddItemsToCollectionRequestEpisodesInnerIds given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AddItemsToCollectionRequestEpisodesInnerIds
   * @throws IOException if the JSON string is invalid with respect to AddItemsToCollectionRequestEpisodesInnerIds
   */
  public static AddItemsToCollectionRequestEpisodesInnerIds fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AddItemsToCollectionRequestEpisodesInnerIds.class);
  }

  /**
   * Convert an instance of AddItemsToCollectionRequestEpisodesInnerIds to an JSON string
   *
   * @return JSON string
   */
