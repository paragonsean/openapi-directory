...
import org.openapitools.client.model.AddItemsToCollectionRequestEpisodesInnerIds;
...
public class AddNewRatingsRequestEpisodesInner {
  public static final String SERIALIZED_NAME_IDS = "ids";
  @SerializedName(SERIALIZED_NAME_IDS)
  private AddItemsToCollectionRequestEpisodesInnerIds ids;

  public static final String SERIALIZED_NAME_RATING = "rating";
  @SerializedName(SERIALIZED_NAME_RATING)
  private BigDecimal rating;

  public AddNewRatingsRequestEpisodesInner() {
  }

  public AddNewRatingsRequestEpisodesInner ids(AddItemsToCollectionRequestEpisodesInnerIds ids) {
    this.ids = ids;
    return this;
  }
  ...
  public AddItemsToCollectionRequestEpisodesInnerIds getIds() {
    return ids;
  }

  public void setIds(AddItemsToCollectionRequestEpisodesInnerIds ids) {
    this.ids = ids;
  }


  public AddNewRatingsRequestEpisodesInner rating(BigDecimal rating) {
    this.rating = rating;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    AddNewRatingsRequestEpisodesInner addNewRatingsRequestEpisodesInner = (AddNewRatingsRequestEpisodesInner) o;
    return Objects.equals(this.ids, addNewRatingsRequestEpisodesInner.ids) &&
        Objects.equals(this.rating, addNewRatingsRequestEpisodesInner.rating);
  }

  @Override
  public int hashCode() {
    return Objects.hash(ids, rating);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AddNewRatingsRequestEpisodesInner {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AddNewRatingsRequestEpisodesInner
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AddNewRatingsRequestEpisodesInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AddNewRatingsRequestEpisodesInner is not found in the empty JSON string", AddNewRatingsRequestEpisodesInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AddNewRatingsRequestEpisodesInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AddNewRatingsRequestEpisodesInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `ids`
      if (jsonObj.get("ids") != null && !jsonObj.get("ids").isJsonNull()) {
        AddItemsToCollectionRequestEpisodesInnerIds.validateJsonElement(jsonObj.get("ids"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AddNewRatingsRequestEpisodesInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AddNewRatingsRequestEpisodesInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AddNewRatingsRequestEpisodesInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AddNewRatingsRequestEpisodesInner.class));

       return (TypeAdapter<T>) new TypeAdapter<AddNewRatingsRequestEpisodesInner>() {
           @Override
           public void write(JsonWriter out, AddNewRatingsRequestEpisodesInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AddNewRatingsRequestEpisodesInner read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AddNewRatingsRequestEpisodesInner given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AddNewRatingsRequestEpisodesInner
   * @throws IOException if the JSON string is invalid with respect to AddNewRatingsRequestEpisodesInner
   */
  public static AddNewRatingsRequestEpisodesInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AddNewRatingsRequestEpisodesInner.class);
  }

  /**
   * Convert an instance of AddNewRatingsRequestEpisodesInner to an JSON string
   *
   * @return JSON string
   */
