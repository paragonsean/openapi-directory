...
export default class EpisodesApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the getASingleEpisodeForAShow operation.
     * @callback module:api/EpisodesApi~getASingleEpisodeForAShowCallback
     ...
     * @param {module:api/EpisodesApi~getASingleEpisodeForAShowCallback} callback The callback function, accepting three arguments: error, data, response
     */
    getASingleEpisodeForAShow(id, season, episode, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling getASingleEpisodeForAShow");
      }
      // verify the required parameter 'season' is set
      if (season === undefined || season === null) {
        throw new Error("Missing the required parameter 'season' when calling getASingleEpisodeForAShow");
      }
      // verify the required parameter 'episode' is set
      if (episode === undefined || episode === null) {
        throw new Error("Missing the required parameter 'episode' when calling getASingleEpisodeForAShow");
      }
      ...
      return this.apiClient.callApi(
        '/shows/{id}/seasons/{season}/episodes/{episode}', 'GET',
    ...
    /**
     * Callback function to receive the result of the getAllEpisodeComments operation.
     * @callback module:api/EpisodesApi~getAllEpisodeCommentsCallback
     * @param {String} error Error message, if any.
     * @param data This operation does not return a value.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} [traktApiVersion] e.g. 2
     * @param {String} [traktApiKey] e.g. [client_id]
     * @param {module:api/EpisodesApi~getAllEpisodeCommentsCallback} callback The callback function, accepting three arguments: error, data, response
     */
    getAllEpisodeComments(id, season, episode, sort, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling getAllEpisodeComments");
      }
      // verify the required parameter 'season' is set
      if (season === undefined || season === null) {
        throw new Error("Missing the required parameter 'season' when calling getAllEpisodeComments");
      }
      // verify the required parameter 'episode' is set
      if (episode === undefined || episode === null) {
        throw new Error("Missing the required parameter 'episode' when calling getAllEpisodeComments");
      }
      // verify the required parameter 'sort' is set
      if (sort === undefined || sort === null) {
        throw new Error("Missing the required parameter 'sort' when calling getAllEpisodeComments");
      }
      ...
      let returnType = null;
      return this.apiClient.callApi(
        '/shows/{id}/seasons/{season}/episodes/{episode}/comments/{sort}', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
    ...
    /**
     * Callback function to receive the result of the getAllEpisodeTranslations operation.
     * @callback module:api/EpisodesApi~getAllEpisodeTranslationsCallback
     * @param {String} error Error message, if any.
     * @param data This operation does not return a value.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} [traktApiVersion] e.g. 2
     * @param {String} [traktApiKey] e.g. [client_id]
     * @param {module:api/EpisodesApi~getAllEpisodeTranslationsCallback} callback The callback function, accepting three arguments: error, data, response
     */
    getAllEpisodeTranslations(id, season, episode, language, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling getAllEpisodeTranslations");
      }
      // verify the required parameter 'season' is set
      if (season === undefined || season === null) {
        throw new Error("Missing the required parameter 'season' when calling getAllEpisodeTranslations");
      }
      // verify the required parameter 'episode' is set
      if (episode === undefined || episode === null) {
        throw new Error("Missing the required parameter 'episode' when calling getAllEpisodeTranslations");
      }
      // verify the required parameter 'language' is set
      if (language === undefined || language === null) {
        throw new Error("Missing the required parameter 'language' when calling getAllEpisodeTranslations");
      }
      ...
      let returnType = null;
      return this.apiClient.callApi(
        '/shows/{id}/seasons/{season}/episodes/{episode}/translations/{language}', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
    ...
    /**
     * Callback function to receive the result of the getAllPeopleForAnEpisode operation.
     * @callback module:api/EpisodesApi~getAllPeopleForAnEpisodeCallback
     * @param {String} error Error message, if any.
     * @param data This operation does not return a value.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} [traktApiVersion] e.g. 2
     * @param {String} [traktApiKey] e.g. [client_id]
     * @param {module:api/EpisodesApi~getAllPeopleForAnEpisodeCallback} callback The callback function, accepting three arguments: error, data, response
     */
    getAllPeopleForAnEpisode(id, season, episode, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling getAllPeopleForAnEpisode");
      }
      // verify the required parameter 'season' is set
      if (season === undefined || season === null) {
        throw new Error("Missing the required parameter 'season' when calling getAllPeopleForAnEpisode");
      }
      // verify the required parameter 'episode' is set
      if (episode === undefined || episode === null) {
        throw new Error("Missing the required parameter 'episode' when calling getAllPeopleForAnEpisode");
      }
    ...
    /**
     * Callback function to receive the result of the getEpisodeRatings operation.
     * @callback module:api/EpisodesApi~getEpisodeRatingsCallback
     * @param {String} error Error message, if any.
     * @param data This operation does not return a value.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} [traktApiVersion] e.g. 2
     * @param {String} [traktApiKey] e.g. [client_id]
     * @param {module:api/EpisodesApi~getEpisodeRatingsCallback} callback The callback function, accepting three arguments: error, data, response
     */
    getEpisodeRatings(id, season, episode, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling getEpisodeRatings");
      }
      // verify the required parameter 'season' is set
      if (season === undefined || season === null) {
        throw new Error("Missing the required parameter 'season' when calling getEpisodeRatings");
      }
      // verify the required parameter 'episode' is set
      if (episode === undefined || episode === null) {
        throw new Error("Missing the required parameter 'episode' when calling getEpisodeRatings");
      }
    ...
    /**
     * Callback function to receive the result of the getEpisodeStats operation.
     * @callback module:api/EpisodesApi~getEpisodeStatsCallback
     * @param {String} error Error message, if any.
     * @param data This operation does not return a value.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} [traktApiVersion] e.g. 2
     * @param {String} [traktApiKey] e.g. [client_id]
     * @param {module:api/EpisodesApi~getEpisodeStatsCallback} callback The callback function, accepting three arguments: error, data, response
     */
    getEpisodeStats(id, season, episode, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling getEpisodeStats");
      }
      // verify the required parameter 'season' is set
      if (season === undefined || season === null) {
        throw new Error("Missing the required parameter 'season' when calling getEpisodeStats");
      }
      // verify the required parameter 'episode' is set
      if (episode === undefined || episode === null) {
        throw new Error("Missing the required parameter 'episode' when calling getEpisodeStats");
      }
    ...
    /**
     * Callback function to receive the result of the getListsContainingThisEpisode operation.
     * @callback module:api/EpisodesApi~getListsContainingThisEpisodeCallback
     * @param {String} error Error message, if any.
     * @param data This operation does not return a value.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} [traktApiVersion] e.g. 2
     * @param {String} [traktApiKey] e.g. [client_id]
     * @param {module:api/EpisodesApi~getListsContainingThisEpisodeCallback} callback The callback function, accepting three arguments: error, data, response
     */
    getListsContainingThisEpisode(id, season, episode, type, sort, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling getListsContainingThisEpisode");
      }
      // verify the required parameter 'season' is set
      if (season === undefined || season === null) {
        throw new Error("Missing the required parameter 'season' when calling getListsContainingThisEpisode");
      }
      // verify the required parameter 'episode' is set
      if (episode === undefined || episode === null) {
        throw new Error("Missing the required parameter 'episode' when calling getListsContainingThisEpisode");
      }
      // verify the required parameter 'type' is set
      if (type === undefined || type === null) {
        throw new Error("Missing the required parameter 'type' when calling getListsContainingThisEpisode");
      }
      // verify the required parameter 'sort' is set
      if (sort === undefined || sort === null) {
        throw new Error("Missing the required parameter 'sort' when calling getListsContainingThisEpisode");
      }
      ...
      let returnType = null;
      return this.apiClient.callApi(
        '/shows/{id}/seasons/{season}/episodes/{episode}/lists/{type}/{sort}', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
    ...
    /**
     * Callback function to receive the result of the showsIdSeasonsSeasonEpisodesEpisodeWatchingGet operation.
     * @callback module:api/EpisodesApi~showsIdSeasonsSeasonEpisodesEpisodeWatchingGetCallback
     * @param {String} error Error message, if any.
     * @param data This operation does not return a value.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} [traktApiVersion] e.g. 2
     * @param {String} [traktApiKey] e.g. [client_id]
     * @param {module:api/EpisodesApi~showsIdSeasonsSeasonEpisodesEpisodeWatchingGetCallback} callback The callback function, accepting three arguments: error, data, response
     */
    showsIdSeasonsSeasonEpisodesEpisodeWatchingGet(id, season, episode, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling showsIdSeasonsSeasonEpisodesEpisodeWatchingGet");
      }
      // verify the required parameter 'season' is set
      if (season === undefined || season === null) {
        throw new Error("Missing the required parameter 'season' when calling showsIdSeasonsSeasonEpisodesEpisodeWatchingGet");
      }
      // verify the required parameter 'episode' is set
      if (episode === undefined || episode === null) {
        throw new Error("Missing the required parameter 'episode' when calling showsIdSeasonsSeasonEpisodesEpisodeWatchingGet");
      }
