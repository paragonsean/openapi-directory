...
/**
* Scrobble service.
* @module api/ScrobbleApi
* @version 1.0.0
*/
export default class ScrobbleApi {

    /**
    * Constructs a new ScrobbleApi. 
    * @alias module:api/ScrobbleApi
    * @class
    ...
    */
    ...
    /**
     * Callback function to receive the result of the pauseWatchingInAMediaCenter operation.
     * @callback module:api/ScrobbleApi~pauseWatchingInAMediaCenterCallback
     ...
     * @param {module:model/PauseWatchingInAMediaCenterRequest} [pauseWatchingInAMediaCenterRequest] 
     * @param {module:api/ScrobbleApi~pauseWatchingInAMediaCenterCallback} callback The callback function, accepting three arguments: error, data, response
     */
    pauseWatchingInAMediaCenter(opts, callback) {
      opts = opts || {};
      let postBody = opts['pauseWatchingInAMediaCenterRequest'];
    ...
    /**
     * Callback function to receive the result of the startWatchingInAMediaCenter operation.
     * @callback module:api/ScrobbleApi~startWatchingInAMediaCenterCallback
     * @param {String} error Error message, if any.
     * @param data This operation does not return a value.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} [traktApiVersion] e.g. 2
     * @param {String} [traktApiKey] e.g. [client_id]
     * @param {module:model/StartWatchingInAMediaCenterRequest} [startWatchingInAMediaCenterRequest] 
     * @param {module:api/ScrobbleApi~startWatchingInAMediaCenterCallback} callback The callback function, accepting three arguments: error, data, response
     */
    startWatchingInAMediaCenter(opts, callback) {
      opts = opts || {};
      let postBody = opts['startWatchingInAMediaCenterRequest'];
    ...
    /**
     * Callback function to receive the result of the stopOrFinishWatchingInAMediaCenter operation.
     * @callback module:api/ScrobbleApi~stopOrFinishWatchingInAMediaCenterCallback
     * @param {String} error Error message, if any.
     * @param data This operation does not return a value.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} [traktApiVersion] e.g. 2
     * @param {String} [traktApiKey] e.g. [client_id]
     * @param {module:model/StopOrFinishWatchingInAMediaCenterRequest} [stopOrFinishWatchingInAMediaCenterRequest] 
     * @param {module:api/ScrobbleApi~stopOrFinishWatchingInAMediaCenterCallback} callback The callback function, accepting three arguments: error, data, response
     */
    stopOrFinishWatchingInAMediaCenter(opts, callback) {
      opts = opts || {};
      let postBody = opts['stopOrFinishWatchingInAMediaCenterRequest'];
