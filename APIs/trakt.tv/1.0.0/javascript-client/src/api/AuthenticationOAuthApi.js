...
/**
* AuthenticationOAuth service.
* @module api/AuthenticationOAuthApi
* @version 1.0.0
*/
export default class AuthenticationOAuthApi {

    /**
    * Constructs a new AuthenticationOAuthApi. 
    * @alias module:api/AuthenticationOAuthApi
    * @class
    ...
    */
    ...
    /**
     * Callback function to receive the result of the authorizeApplication operation.
     * @callback module:api/AuthenticationOAuthApi~authorizeApplicationCallback
     ...
     * @param {String} responseType Must be set to code.
     * @param {String} clientId Get this from your app settings.
     * @param {String} redirectUri URI specified in your app settings.
     * @param {Object} opts Optional parameters
     * @param {String} [state] State variable for CSRF purposes.
     * @param {String} [body] Default to the sign up page.
     * @param {module:api/AuthenticationOAuthApi~authorizeApplicationCallback} callback The callback function, accepting three arguments: error, data, response
     */
    authorizeApplication(responseType, clientId, redirectUri, opts, callback) {
      opts = opts || {};
      let postBody = opts['body'];
      // verify the required parameter 'responseType' is set
      if (responseType === undefined || responseType === null) {
        throw new Error("Missing the required parameter 'responseType' when calling authorizeApplication");
      }
      // verify the required parameter 'clientId' is set
      if (clientId === undefined || clientId === null) {
        throw new Error("Missing the required parameter 'clientId' when calling authorizeApplication");
      }
      // verify the required parameter 'redirectUri' is set
      if (redirectUri === undefined || redirectUri === null) {
        throw new Error("Missing the required parameter 'redirectUri' when calling authorizeApplication");
      }
    ...
    /**
     * Callback function to receive the result of the exchangeRefreshTokenForAccessToken operation.
     * @callback module:api/AuthenticationOAuthApi~exchangeRefreshTokenForAccessTokenCallback
     * @param {String} error Error message, if any.
     * @param data This operation does not return a value.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Object} opts Optional parameters
     * @param {module:model/ExchangeRefreshTokenForAccessTokenRequest} [exchangeRefreshTokenForAccessTokenRequest] 
     * @param {module:api/AuthenticationOAuthApi~exchangeRefreshTokenForAccessTokenCallback} callback The callback function, accepting three arguments: error, data, response
     */
    exchangeRefreshTokenForAccessToken(opts, callback) {
      opts = opts || {};
      let postBody = opts['exchangeRefreshTokenForAccessTokenRequest'];
    ...
    /**
     * Callback function to receive the result of the revokeAnAccessToken operation.
     * @callback module:api/AuthenticationOAuthApi~revokeAnAccessTokenCallback
     * @param {String} error Error message, if any.
     * @param data This operation does not return a value.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Object} opts Optional parameters
     * @param {module:model/RevokeAnAccessTokenRequest} [revokeAnAccessTokenRequest] 
     * @param {module:api/AuthenticationOAuthApi~revokeAnAccessTokenCallback} callback The callback function, accepting three arguments: error, data, response
     */
    revokeAnAccessToken(opts, callback) {
      opts = opts || {};
      let postBody = opts['revokeAnAccessTokenRequest'];
