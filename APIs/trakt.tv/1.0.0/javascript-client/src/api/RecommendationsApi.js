...
export default class RecommendationsApi {
    ...
    */
     ...
     * @callback module:api/RecommendationsApi~getMovieRecommendationsCallback
     ...
     * @param {module:model/String} [ignoreCollected] filter out collected movies
     * @param {module:model/String} [ignoreWatchlisted] filter out watchlisted movies
     * @param {String} [traktApiVersion] e.g. 2
     * @param {String} [traktApiKey] e.g. [client_id]
     * @param {module:api/RecommendationsApi~getMovieRecommendationsCallback} callback The callback function, accepting three arguments: error, data, response
     */
    getMovieRecommendations(opts, callback) {
      ...
      let queryParams = {
        'ignore_collected': opts['ignoreCollected'],
        'ignore_watchlisted': opts['ignoreWatchlisted']
      };
      let headerParams = {
    ...
    /**
     * Callback function to receive the result of the getShowRecommendations operation.
     * @callback module:api/RecommendationsApi~getShowRecommendationsCallback
     * @param {String} error Error message, if any.
     * @param data This operation does not return a value.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Object} opts Optional parameters
     * @param {module:model/String} [ignoreCollected] filter out collected shows
     * @param {module:model/String} [ignoreWatchlisted] filter out watchlisted movies
     * @param {String} [traktApiVersion] e.g. 2
     * @param {String} [traktApiKey] e.g. [client_id]
     * @param {module:api/RecommendationsApi~getShowRecommendationsCallback} callback The callback function, accepting three arguments: error, data, response
     */
    getShowRecommendations(opts, callback) {
      opts = opts || {};
      let postBody = null;
    ...
    /**
     * Callback function to receive the result of the hideAMovieRecommendation operation.
     * @callback module:api/RecommendationsApi~hideAMovieRecommendationCallback
     * @param {String} error Error message, if any.
     * @param data This operation does not return a value.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} [traktApiVersion] e.g. 2
     * @param {String} [traktApiKey] e.g. [client_id]
     * @param {module:api/RecommendationsApi~hideAMovieRecommendationCallback} callback The callback function, accepting three arguments: error, data, response
     */
    hideAMovieRecommendation(id, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling hideAMovieRecommendation");
      }
    ...
    /**
     * Callback function to receive the result of the hideAShowRecommendation operation.
     * @callback module:api/RecommendationsApi~hideAShowRecommendationCallback
     * @param {String} error Error message, if any.
     * @param data This operation does not return a value.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} [traktApiVersion] e.g. 2
     * @param {String} [traktApiKey] e.g. [client_id]
     * @param {module:api/RecommendationsApi~hideAShowRecommendationCallback} callback The callback function, accepting three arguments: error, data, response
     */
    hideAShowRecommendation(id, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling hideAShowRecommendation");
      }
