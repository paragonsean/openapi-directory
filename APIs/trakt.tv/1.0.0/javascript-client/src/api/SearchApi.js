...
export default class SearchApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the getIDLookupResults operation.
     * @callback module:api/SearchApi~getIDLookupResultsCallback
     ...
     * @param {module:model/String} idType Type of ID to lookup.
     * @param {String} id ID that matches with the type.
     * @param {Object} opts Optional parameters
     * @param {module:model/String} [type] Search type.
     * @param {String} [traktApiVersion] e.g. 2
     * @param {String} [traktApiKey] e.g. [client_id]
     * @param {module:api/SearchApi~getIDLookupResultsCallback} callback The callback function, accepting three arguments: error, data, response
     */
    getIDLookupResults(idType, id, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'idType' is set
      if (idType === undefined || idType === null) {
        throw new Error("Missing the required parameter 'idType' when calling getIDLookupResults");
      }
      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling getIDLookupResults");
      }
    ...
    /**
     * Callback function to receive the result of the getTextQueryResults operation.
     * @callback module:api/SearchApi~getTextQueryResultsCallback
     * @param {String} error Error message, if any.
     * @param data This operation does not return a value.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} [traktApiVersion] e.g. 2
     * @param {String} [traktApiKey] e.g. [client_id]
     * @param {String} [body] Specific text fields.
     * @param {module:api/SearchApi~getTextQueryResultsCallback} callback The callback function, accepting three arguments: error, data, response
     */
    getTextQueryResults(type, query, opts, callback) {
      opts = opts || {};
      let postBody = opts['body'];
      // verify the required parameter 'type' is set
      if (type === undefined || type === null) {
        throw new Error("Missing the required parameter 'type' when calling getTextQueryResults");
      }
      // verify the required parameter 'query' is set
      if (query === undefined || query === null) {
        throw new Error("Missing the required parameter 'query' when calling getTextQueryResults");
      }
