...
/**
* Checkin service.
* @module api/CheckinApi
* @version 1.0.0
*/
export default class CheckinApi {

    /**
    * Constructs a new CheckinApi. 
    * @alias module:api/CheckinApi
    * @class
    ...
    */
    ...
    /**
     * Callback function to receive the result of the checkIntoAnItem operation.
     * @callback module:api/CheckinApi~checkIntoAnItemCallback
     ...
     * @param {module:model/CheckIntoAnItemRequest} [checkIntoAnItemRequest] 
     * @param {module:api/CheckinApi~checkIntoAnItemCallback} callback The callback function, accepting three arguments: error, data, response
     */
    checkIntoAnItem(opts, callback) {
      opts = opts || {};
      let postBody = opts['checkIntoAnItemRequest'];
    ...
    /**
     * Callback function to receive the result of the deleteAnyActiveCheckins operation.
     * @callback module:api/CheckinApi~deleteAnyActiveCheckinsCallback
     * @param {String} error Error message, if any.
     * @param data This operation does not return a value.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} [traktApiVersion] e.g. 2
     * @param {String} [traktApiKey] e.g. [client_id]
     * @param {module:api/CheckinApi~deleteAnyActiveCheckinsCallback} callback The callback function, accepting three arguments: error, data, response
     */
    deleteAnyActiveCheckins(opts, callback) {
      opts = opts || {};
      let postBody = null;
