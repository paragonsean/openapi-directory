...
import CheckIntoAnItemRequestMovie from './CheckIntoAnItemRequestMovie';

/**
 * The PauseWatchingInAMediaCenterRequest model module.
 * @module model/PauseWatchingInAMediaCenterRequest
 * @version 1.0.0
 */
class PauseWatchingInAMediaCenterRequest {
    /**
     * Constructs a new <code>PauseWatchingInAMediaCenterRequest</code>.
     * @alias module:model/PauseWatchingInAMediaCenterRequest
     */
    constructor() { 
        
        PauseWatchingInAMediaCenterRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PauseWatchingInAMediaCenterRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PauseWatchingInAMediaCenterRequest} obj Optional instance to populate.
     * @return {module:model/PauseWatchingInAMediaCenterRequest} The populated <code>PauseWatchingInAMediaCenterRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PauseWatchingInAMediaCenterRequest();

            if (data.hasOwnProperty('app_date')) {
                obj['app_date'] = ApiClient.convertToType(data['app_date'], 'String');
            }
            ...
            if (data.hasOwnProperty('movie')) {
                obj['movie'] = CheckIntoAnItemRequestMovie.constructFromObject(data['movie']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>PauseWatchingInAMediaCenterRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PauseWatchingInAMediaCenterRequest</code>.
     */
    static validateJSON(data) {
        // ensure the json data is a string
        if (data['app_date'] && !(typeof data['app_date'] === 'string' || data['app_date'] instanceof String)) {
            throw new Error("Expected the field `app_date` to be a primitive type in the JSON string but got " + data['app_date']);
        }
        // ensure the json data is a string
        ...
        // validate the optional field `movie`
        if (data['movie']) { // data not null
          CheckIntoAnItemRequestMovie.validateJSON(data['movie']);
        }
 ...
 */
PauseWatchingInAMediaCenterRequest.prototype['app_date'] = undefined;

/**
 * @member {String} app_version
 */
PauseWatchingInAMediaCenterRequest.prototype['app_version'] = undefined;

/**
 * @member {module:model/CheckIntoAnItemRequestMovie} movie
 */
PauseWatchingInAMediaCenterRequest.prototype['movie'] = undefined;

/**
 * @member {Number} progress
 */
PauseWatchingInAMediaCenterRequest.prototype['progress'] = undefined;
...
export default PauseWatchingInAMediaCenterRequest;
