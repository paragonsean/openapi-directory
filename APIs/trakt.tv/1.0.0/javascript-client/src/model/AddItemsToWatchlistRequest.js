...
import AddItemsToWatchlistRequestShowsInner from './AddItemsToWatchlistRequestShowsInner';

/**
 * The AddItemsToWatchlistRequest model module.
 * @module model/AddItemsToWatchlistRequest
 * @version 1.0.0
 */
class AddItemsToWatchlistRequest {
    /**
     * Constructs a new <code>AddItemsToWatchlistRequest</code>.
     * @alias module:model/AddItemsToWatchlistRequest
     */
    constructor() { 
        
        AddItemsToWatchlistRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>AddItemsToWatchlistRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AddItemsToWatchlistRequest} obj Optional instance to populate.
     * @return {module:model/AddItemsToWatchlistRequest} The populated <code>AddItemsToWatchlistRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AddItemsToWatchlistRequest();
            ...
            if (data.hasOwnProperty('shows')) {
                obj['shows'] = ApiClient.convertToType(data['shows'], [AddItemsToWatchlistRequestShowsInner]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>AddItemsToWatchlistRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AddItemsToWatchlistRequest</code>.
     */
    static validateJSON(data) {
        ...
        if (data['shows']) { // data not null
            ...
            for (const item of data['shows']) {
                AddItemsToWatchlistRequestShowsInner.validateJSON(item);
            };
        }
 ...
 */
AddItemsToWatchlistRequest.prototype['episodes'] = undefined;

/**
 * @member {Array.<module:model/AddItemsToPersonalRecommendationsRequestMoviesInner>} movies
 */
AddItemsToWatchlistRequest.prototype['movies'] = undefined;

/**
 * @member {Array.<module:model/AddItemsToCollectionRequestSeasonsInner>} seasons
 */
AddItemsToWatchlistRequest.prototype['seasons'] = undefined;

/**
 * @member {Array.<module:model/AddItemsToWatchlistRequestShowsInner>} shows
 */
AddItemsToWatchlistRequest.prototype['shows'] = undefined;
...
export default AddItemsToWatchlistRequest;
