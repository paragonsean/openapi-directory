...
import AddItemsToPersonalRecommendationsRequestMoviesInner from './AddItemsToPersonalRecommendationsRequestMoviesInner';
import AddItemsToPersonalRecommendationsRequestShowsInner from './AddItemsToPersonalRecommendationsRequestShowsInner';

/**
 * The AddItemsToPersonalRecommendationsRequest model module.
 * @module model/AddItemsToPersonalRecommendationsRequest
 * @version 1.0.0
 */
class AddItemsToPersonalRecommendationsRequest {
    /**
     * Constructs a new <code>AddItemsToPersonalRecommendationsRequest</code>.
     * @alias module:model/AddItemsToPersonalRecommendationsRequest
     */
    constructor() { 
        
        AddItemsToPersonalRecommendationsRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>AddItemsToPersonalRecommendationsRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AddItemsToPersonalRecommendationsRequest} obj Optional instance to populate.
     * @return {module:model/AddItemsToPersonalRecommendationsRequest} The populated <code>AddItemsToPersonalRecommendationsRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AddItemsToPersonalRecommendationsRequest();

            if (data.hasOwnProperty('movies')) {
                obj['movies'] = ApiClient.convertToType(data['movies'], [AddItemsToPersonalRecommendationsRequestMoviesInner]);
            }
            if (data.hasOwnProperty('shows')) {
                obj['shows'] = ApiClient.convertToType(data['shows'], [AddItemsToPersonalRecommendationsRequestShowsInner]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>AddItemsToPersonalRecommendationsRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AddItemsToPersonalRecommendationsRequest</code>.
     */
    static validateJSON(data) {
        if (data['movies']) { // data not null
            ...
            for (const item of data['movies']) {
                AddItemsToPersonalRecommendationsRequestMoviesInner.validateJSON(item);
            };
        }
        if (data['shows']) { // data not null
            ...
            for (const item of data['shows']) {
                AddItemsToPersonalRecommendationsRequestShowsInner.validateJSON(item);
            };
        }
...
/**
 * @member {Array.<module:model/AddItemsToPersonalRecommendationsRequestMoviesInner>} movies
 */
AddItemsToPersonalRecommendationsRequest.prototype['movies'] = undefined;

/**
 * @member {Array.<module:model/AddItemsToPersonalRecommendationsRequestShowsInner>} shows
 */
AddItemsToPersonalRecommendationsRequest.prototype['shows'] = undefined;
...
export default AddItemsToPersonalRecommendationsRequest;
