...
/**
 * The AddItemsToWatchedHistoryRequestMoviesInner model module.
 * @module model/AddItemsToWatchedHistoryRequestMoviesInner
 * @version 1.0.0
 */
class AddItemsToWatchedHistoryRequestMoviesInner {
    /**
     * Constructs a new <code>AddItemsToWatchedHistoryRequestMoviesInner</code>.
     * @alias module:model/AddItemsToWatchedHistoryRequestMoviesInner
     * @param ids {module:model/CheckIntoAnItemRequestMovieIds} 
     */
    constructor(ids) { 
        
        AddItemsToWatchedHistoryRequestMoviesInner.initialize(this, ids);
    }
    ...
    /**
     * Constructs a <code>AddItemsToWatchedHistoryRequestMoviesInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AddItemsToWatchedHistoryRequestMoviesInner} obj Optional instance to populate.
     * @return {module:model/AddItemsToWatchedHistoryRequestMoviesInner} The populated <code>AddItemsToWatchedHistoryRequestMoviesInner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AddItemsToWatchedHistoryRequestMoviesInner();
    ...
    /**
     * Validates the JSON data with respect to <code>AddItemsToWatchedHistoryRequestMoviesInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AddItemsToWatchedHistoryRequestMoviesInner</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of AddItemsToWatchedHistoryRequestMoviesInner.RequiredProperties) {
...
AddItemsToWatchedHistoryRequestMoviesInner.RequiredProperties = ["ids"];

/**
 * @member {module:model/CheckIntoAnItemRequestMovieIds} ids
 */
AddItemsToWatchedHistoryRequestMoviesInner.prototype['ids'] = undefined;

/**
 * @member {String} title
 */
AddItemsToWatchedHistoryRequestMoviesInner.prototype['title'] = undefined;

/**
 * @member {String} watched_at
 */
AddItemsToWatchedHistoryRequestMoviesInner.prototype['watched_at'] = undefined;

/**
 * @member {Number} year
 */
AddItemsToWatchedHistoryRequestMoviesInner.prototype['year'] = undefined;
...
export default AddItemsToWatchedHistoryRequestMoviesInner;
