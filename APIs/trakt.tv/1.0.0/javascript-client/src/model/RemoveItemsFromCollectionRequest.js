...
import RemoveItemsFromCollectionRequestShowsInner from './RemoveItemsFromCollectionRequestShowsInner';

/**
 * The RemoveItemsFromCollectionRequest model module.
 * @module model/RemoveItemsFromCollectionRequest
 * @version 1.0.0
 */
class RemoveItemsFromCollectionRequest {
    /**
     * Constructs a new <code>RemoveItemsFromCollectionRequest</code>.
     * @alias module:model/RemoveItemsFromCollectionRequest
     */
    constructor() { 
        
        RemoveItemsFromCollectionRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>RemoveItemsFromCollectionRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/RemoveItemsFromCollectionRequest} obj Optional instance to populate.
     * @return {module:model/RemoveItemsFromCollectionRequest} The populated <code>RemoveItemsFromCollectionRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RemoveItemsFromCollectionRequest();
            ...
            if (data.hasOwnProperty('shows')) {
                obj['shows'] = ApiClient.convertToType(data['shows'], [RemoveItemsFromCollectionRequestShowsInner]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>RemoveItemsFromCollectionRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RemoveItemsFromCollectionRequest</code>.
     */
    static validateJSON(data) {
        ...
        if (data['shows']) { // data not null
            ...
            for (const item of data['shows']) {
                RemoveItemsFromCollectionRequestShowsInner.validateJSON(item);
            };
        }
 ...
 */
RemoveItemsFromCollectionRequest.prototype['episodes'] = undefined;

/**
 * @member {Array.<module:model/RemoveItemsFromCollectionRequestMoviesInner>} movies
 */
RemoveItemsFromCollectionRequest.prototype['movies'] = undefined;

/**
 * @member {Array.<module:model/AddItemsToCollectionRequestSeasonsInner>} seasons
 */
RemoveItemsFromCollectionRequest.prototype['seasons'] = undefined;

/**
 * @member {Array.<module:model/RemoveItemsFromCollectionRequestShowsInner>} shows
 */
RemoveItemsFromCollectionRequest.prototype['shows'] = undefined;
...
export default RemoveItemsFromCollectionRequest;
