...
/**
 * The AddItemsToCollectionRequestShowsInnerIds model module.
 * @module model/AddItemsToCollectionRequestShowsInnerIds
 * @version 1.0.0
 */
class AddItemsToCollectionRequestShowsInnerIds {
    /**
     * Constructs a new <code>AddItemsToCollectionRequestShowsInnerIds</code>.
     * @alias module:model/AddItemsToCollectionRequestShowsInnerIds
     */
    constructor() { 
        
        AddItemsToCollectionRequestShowsInnerIds.initialize(this);
    }
    ...
    /**
     * Constructs a <code>AddItemsToCollectionRequestShowsInnerIds</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AddItemsToCollectionRequestShowsInnerIds} obj Optional instance to populate.
     * @return {module:model/AddItemsToCollectionRequestShowsInnerIds} The populated <code>AddItemsToCollectionRequestShowsInnerIds</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AddItemsToCollectionRequestShowsInnerIds();
    ...
    /**
     * Validates the JSON data with respect to <code>AddItemsToCollectionRequestShowsInnerIds</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AddItemsToCollectionRequestShowsInnerIds</code>.
     */
 ...
 * @member {String} imdb
 */
AddItemsToCollectionRequestShowsInnerIds.prototype['imdb'] = undefined;

/**
 * @member {String} slug
 */
AddItemsToCollectionRequestShowsInnerIds.prototype['slug'] = undefined;

/**
 * @member {Number} tmdb
 */
AddItemsToCollectionRequestShowsInnerIds.prototype['tmdb'] = undefined;

/**
 * @member {Number} trakt
 */
AddItemsToCollectionRequestShowsInnerIds.prototype['trakt'] = undefined;

/**
 * @member {Number} tvdb
 */
AddItemsToCollectionRequestShowsInnerIds.prototype['tvdb'] = undefined;
...
export default AddItemsToCollectionRequestShowsInnerIds;
