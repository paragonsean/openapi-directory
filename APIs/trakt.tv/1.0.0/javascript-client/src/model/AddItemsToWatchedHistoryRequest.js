...
import AddItemsToWatchedHistoryRequestEpisodesInner from './AddItemsToWatchedHistoryRequestEpisodesInner';
import AddItemsToWatchedHistoryRequestMoviesInner from './AddItemsToWatchedHistoryRequestMoviesInner';
import AddItemsToWatchedHistoryRequestSeasonsInner from './AddItemsToWatchedHistoryRequestSeasonsInner';
import AddItemsToWatchedHistoryRequestShowsInner from './AddItemsToWatchedHistoryRequestShowsInner';

/**
 * The AddItemsToWatchedHistoryRequest model module.
 * @module model/AddItemsToWatchedHistoryRequest
 * @version 1.0.0
 */
class AddItemsToWatchedHistoryRequest {
    /**
     * Constructs a new <code>AddItemsToWatchedHistoryRequest</code>.
     * @alias module:model/AddItemsToWatchedHistoryRequest
     */
    constructor() { 
        
        AddItemsToWatchedHistoryRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>AddItemsToWatchedHistoryRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AddItemsToWatchedHistoryRequest} obj Optional instance to populate.
     * @return {module:model/AddItemsToWatchedHistoryRequest} The populated <code>AddItemsToWatchedHistoryRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AddItemsToWatchedHistoryRequest();

            if (data.hasOwnProperty('episodes')) {
                obj['episodes'] = ApiClient.convertToType(data['episodes'], [AddItemsToWatchedHistoryRequestEpisodesInner]);
            }
            if (data.hasOwnProperty('movies')) {
                obj['movies'] = ApiClient.convertToType(data['movies'], [AddItemsToWatchedHistoryRequestMoviesInner]);
            }
            if (data.hasOwnProperty('seasons')) {
                obj['seasons'] = ApiClient.convertToType(data['seasons'], [AddItemsToWatchedHistoryRequestSeasonsInner]);
            }
            if (data.hasOwnProperty('shows')) {
                obj['shows'] = ApiClient.convertToType(data['shows'], [AddItemsToWatchedHistoryRequestShowsInner]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>AddItemsToWatchedHistoryRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AddItemsToWatchedHistoryRequest</code>.
     */
    static validateJSON(data) {
        if (data['episodes']) { // data not null
            ...
            for (const item of data['episodes']) {
                AddItemsToWatchedHistoryRequestEpisodesInner.validateJSON(item);
            };
        }
        if (data['movies']) { // data not null
            ...
            for (const item of data['movies']) {
                AddItemsToWatchedHistoryRequestMoviesInner.validateJSON(item);
            };
        }
        if (data['seasons']) { // data not null
            ...
            for (const item of data['seasons']) {
                AddItemsToWatchedHistoryRequestSeasonsInner.validateJSON(item);
            };
        }
        if (data['shows']) { // data not null
            ...
            for (const item of data['shows']) {
                AddItemsToWatchedHistoryRequestShowsInner.validateJSON(item);
            };
        }
...
/**
 * @member {Array.<module:model/AddItemsToWatchedHistoryRequestEpisodesInner>} episodes
 */
AddItemsToWatchedHistoryRequest.prototype['episodes'] = undefined;

/**
 * @member {Array.<module:model/AddItemsToWatchedHistoryRequestMoviesInner>} movies
 */
AddItemsToWatchedHistoryRequest.prototype['movies'] = undefined;

/**
 * @member {Array.<module:model/AddItemsToWatchedHistoryRequestSeasonsInner>} seasons
 */
AddItemsToWatchedHistoryRequest.prototype['seasons'] = undefined;

/**
 * @member {Array.<module:model/AddItemsToWatchedHistoryRequestShowsInner>} shows
 */
AddItemsToWatchedHistoryRequest.prototype['shows'] = undefined;
...
export default AddItemsToWatchedHistoryRequest;
