...
/**
 * The RemoveItemsFromHistoryRequest model module.
 * @module model/RemoveItemsFromHistoryRequest
 * @version 1.0.0
 */
class RemoveItemsFromHistoryRequest {
    /**
     * Constructs a new <code>RemoveItemsFromHistoryRequest</code>.
     * @alias module:model/RemoveItemsFromHistoryRequest
     */
    constructor() { 
        
        RemoveItemsFromHistoryRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>RemoveItemsFromHistoryRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/RemoveItemsFromHistoryRequest} obj Optional instance to populate.
     * @return {module:model/RemoveItemsFromHistoryRequest} The populated <code>RemoveItemsFromHistoryRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RemoveItemsFromHistoryRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>RemoveItemsFromHistoryRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RemoveItemsFromHistoryRequest</code>.
     */
 ...
 */
RemoveItemsFromHistoryRequest.prototype['episodes'] = undefined;

/**
 * @member {Array.<Number>} ids
 */
RemoveItemsFromHistoryRequest.prototype['ids'] = undefined;

/**
 * @member {Array.<module:model/RemoveItemsFromCollectionRequestMoviesInner>} movies
 */
RemoveItemsFromHistoryRequest.prototype['movies'] = undefined;

/**
 * @member {Array.<module:model/AddItemsToCollectionRequestSeasonsInner>} seasons
 */
RemoveItemsFromHistoryRequest.prototype['seasons'] = undefined;

/**
 * @member {Array.<module:model/RemoveItemsFromCollectionRequestShowsInner>} shows
 */
RemoveItemsFromHistoryRequest.prototype['shows'] = undefined;
...
export default RemoveItemsFromHistoryRequest;
