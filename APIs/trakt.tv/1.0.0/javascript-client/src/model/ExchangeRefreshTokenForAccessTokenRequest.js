...
/**
 * The ExchangeRefreshTokenForAccessTokenRequest model module.
 * @module model/ExchangeRefreshTokenForAccessTokenRequest
 * @version 1.0.0
 */
class ExchangeRefreshTokenForAccessTokenRequest {
    /**
     * Constructs a new <code>ExchangeRefreshTokenForAccessTokenRequest</code>.
     * @alias module:model/ExchangeRefreshTokenForAccessTokenRequest
     */
    constructor() { 
        
        ExchangeRefreshTokenForAccessTokenRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ExchangeRefreshTokenForAccessTokenRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ExchangeRefreshTokenForAccessTokenRequest} obj Optional instance to populate.
     * @return {module:model/ExchangeRefreshTokenForAccessTokenRequest} The populated <code>ExchangeRefreshTokenForAccessTokenRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ExchangeRefreshTokenForAccessTokenRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>ExchangeRefreshTokenForAccessTokenRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ExchangeRefreshTokenForAccessTokenRequest</code>.
     */
 ...
 */
ExchangeRefreshTokenForAccessTokenRequest.prototype['client_id'] = undefined;

/**
 * @member {String} client_secret
 */
ExchangeRefreshTokenForAccessTokenRequest.prototype['client_secret'] = undefined;

/**
 * @member {String} grant_type
 */
ExchangeRefreshTokenForAccessTokenRequest.prototype['grant_type'] = undefined;

/**
 * @member {String} redirect_uri
 */
ExchangeRefreshTokenForAccessTokenRequest.prototype['redirect_uri'] = undefined;

/**
 * @member {String} refresh_token
 */
ExchangeRefreshTokenForAccessTokenRequest.prototype['refresh_token'] = undefined;
...
export default ExchangeRefreshTokenForAccessTokenRequest;
