...
/**
 * The AddItemsToWatchlistRequestShowsInner model module.
 * @module model/AddItemsToWatchlistRequestShowsInner
 * @version 1.0.0
 */
class AddItemsToWatchlistRequestShowsInner {
    /**
     * Constructs a new <code>AddItemsToWatchlistRequestShowsInner</code>.
     * @alias module:model/AddItemsToWatchlistRequestShowsInner
    ...
    constructor(ids, seasons, title, year) { 
        ...
        AddItemsToWatchlistRequestShowsInner.initialize(this, ids, seasons, title, year);
    }
    ...
    /**
     * Constructs a <code>AddItemsToWatchlistRequestShowsInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AddItemsToWatchlistRequestShowsInner} obj Optional instance to populate.
     * @return {module:model/AddItemsToWatchlistRequestShowsInner} The populated <code>AddItemsToWatchlistRequestShowsInner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AddItemsToWatchlistRequestShowsInner();
    ...
    /**
     * Validates the JSON data with respect to <code>AddItemsToWatchlistRequestShowsInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AddItemsToWatchlistRequestShowsInner</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of AddItemsToWatchlistRequestShowsInner.RequiredProperties) {
...
AddItemsToWatchlistRequestShowsInner.RequiredProperties = ["ids", "seasons", "title", "year"];

/**
 * @member {module:model/AddItemsToCollectionRequestShowsInnerIds} ids
 */
AddItemsToWatchlistRequestShowsInner.prototype['ids'] = undefined;

/**
 * @member {String} notes
 */
AddItemsToWatchlistRequestShowsInner.prototype['notes'] = undefined;

/**
 * @member {Array.<module:model/RemoveItemsFromCollectionRequestShowsInnerSeasonsInner>} seasons
 */
AddItemsToWatchlistRequestShowsInner.prototype['seasons'] = undefined;

/**
 * @member {String} title
 */
AddItemsToWatchlistRequestShowsInner.prototype['title'] = undefined;

/**
 * @member {Number} year
 */
AddItemsToWatchlistRequestShowsInner.prototype['year'] = undefined;
...
export default AddItemsToWatchlistRequestShowsInner;
