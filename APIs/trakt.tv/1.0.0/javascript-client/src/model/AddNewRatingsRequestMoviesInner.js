...
import CheckIntoAnItemRequestMovieIds from './CheckIntoAnItemRequestMovieIds';

/**
 * The AddNewRatingsRequestMoviesInner model module.
 * @module model/AddNewRatingsRequestMoviesInner
 * @version 1.0.0
 */
class AddNewRatingsRequestMoviesInner {
    /**
     * Constructs a new <code>AddNewRatingsRequestMoviesInner</code>.
     * @alias module:model/AddNewRatingsRequestMoviesInner
     * @param ids {module:model/CheckIntoAnItemRequestMovieIds} 
     * @param rating {Number} 
     */
    constructor(ids, rating) { 
        
        AddNewRatingsRequestMoviesInner.initialize(this, ids, rating);
    }
     ...
     */
    static initialize(obj, ids, rating) { 
        obj['ids'] = ids;
        obj['rating'] = rating;
    }

    /**
     * Constructs a <code>AddNewRatingsRequestMoviesInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AddNewRatingsRequestMoviesInner} obj Optional instance to populate.
     * @return {module:model/AddNewRatingsRequestMoviesInner} The populated <code>AddNewRatingsRequestMoviesInner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AddNewRatingsRequestMoviesInner();

            if (data.hasOwnProperty('ids')) {
                obj['ids'] = CheckIntoAnItemRequestMovieIds.constructFromObject(data['ids']);
            }
            if (data.hasOwnProperty('rated_at')) {
                obj['rated_at'] = ApiClient.convertToType(data['rated_at'], 'String');
            }
    ...
    /**
     * Validates the JSON data with respect to <code>AddNewRatingsRequestMoviesInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AddNewRatingsRequestMoviesInner</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of AddNewRatingsRequestMoviesInner.RequiredProperties) {
        ...
        if (data['ids']) { // data not null
          CheckIntoAnItemRequestMovieIds.validateJSON(data['ids']);
        }
        // ensure the json data is a string
        if (data['rated_at'] && !(typeof data['rated_at'] === 'string' || data['rated_at'] instanceof String)) {
            throw new Error("Expected the field `rated_at` to be a primitive type in the JSON string but got " + data['rated_at']);
        }
        // ensure the json data is a string
...
AddNewRatingsRequestMoviesInner.RequiredProperties = ["ids", "rating"];

/**
 * @member {module:model/CheckIntoAnItemRequestMovieIds} ids
 */
AddNewRatingsRequestMoviesInner.prototype['ids'] = undefined;

/**
 * @member {String} rated_at
 */
AddNewRatingsRequestMoviesInner.prototype['rated_at'] = undefined;

/**
 * @member {Number} rating
 */
AddNewRatingsRequestMoviesInner.prototype['rating'] = undefined;

/**
 * @member {String} title
 */
AddNewRatingsRequestMoviesInner.prototype['title'] = undefined;

/**
 * @member {Number} year
 */
AddNewRatingsRequestMoviesInner.prototype['year'] = undefined;
...
export default AddNewRatingsRequestMoviesInner;
