...
import AddItemsToCollectionRequestShowsInnerIds from './AddItemsToCollectionRequestShowsInnerIds';
import RemoveItemsFromCollectionRequestShowsInnerSeasonsInner from './RemoveItemsFromCollectionRequestShowsInnerSeasonsInner';

/**
 * The RemoveItemsFromCollectionRequestShowsInner model module.
 * @module model/RemoveItemsFromCollectionRequestShowsInner
 * @version 1.0.0
 */
class RemoveItemsFromCollectionRequestShowsInner {
    /**
     * Constructs a new <code>RemoveItemsFromCollectionRequestShowsInner</code>.
     * @alias module:model/RemoveItemsFromCollectionRequestShowsInner
     * @param ids {module:model/AddItemsToCollectionRequestShowsInnerIds} 
     * @param seasons {Array.<module:model/RemoveItemsFromCollectionRequestShowsInnerSeasonsInner>} 
     * @param title {String} 
     * @param year {Number} 
     */
    constructor(ids, seasons, title, year) { 
        
        RemoveItemsFromCollectionRequestShowsInner.initialize(this, ids, seasons, title, year);
    }
     ...
     */
    static initialize(obj, ids, seasons, title, year) { 
        obj['ids'] = ids;
        obj['seasons'] = seasons;
        obj['title'] = title;
        obj['year'] = year;
    ...
    /**
     * Constructs a <code>RemoveItemsFromCollectionRequestShowsInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/RemoveItemsFromCollectionRequestShowsInner} obj Optional instance to populate.
     * @return {module:model/RemoveItemsFromCollectionRequestShowsInner} The populated <code>RemoveItemsFromCollectionRequestShowsInner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RemoveItemsFromCollectionRequestShowsInner();

            if (data.hasOwnProperty('ids')) {
                obj['ids'] = AddItemsToCollectionRequestShowsInnerIds.constructFromObject(data['ids']);
            }
            if (data.hasOwnProperty('seasons')) {
                obj['seasons'] = ApiClient.convertToType(data['seasons'], [RemoveItemsFromCollectionRequestShowsInnerSeasonsInner]);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>RemoveItemsFromCollectionRequestShowsInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RemoveItemsFromCollectionRequestShowsInner</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of RemoveItemsFromCollectionRequestShowsInner.RequiredProperties) {
        ...
        if (data['ids']) { // data not null
          AddItemsToCollectionRequestShowsInnerIds.validateJSON(data['ids']);
        }
        if (data['seasons']) { // data not null
            ...
            for (const item of data['seasons']) {
                RemoveItemsFromCollectionRequestShowsInnerSeasonsInner.validateJSON(item);
            };
        }
...
RemoveItemsFromCollectionRequestShowsInner.RequiredProperties = ["ids", "seasons", "title", "year"];

/**
 * @member {module:model/AddItemsToCollectionRequestShowsInnerIds} ids
 */
RemoveItemsFromCollectionRequestShowsInner.prototype['ids'] = undefined;

/**
 * @member {Array.<module:model/RemoveItemsFromCollectionRequestShowsInnerSeasonsInner>} seasons
 */
RemoveItemsFromCollectionRequestShowsInner.prototype['seasons'] = undefined;

/**
 * @member {String} title
 */
RemoveItemsFromCollectionRequestShowsInner.prototype['title'] = undefined;

/**
 * @member {Number} year
 */
RemoveItemsFromCollectionRequestShowsInner.prototype['year'] = undefined;
...
export default RemoveItemsFromCollectionRequestShowsInner;
