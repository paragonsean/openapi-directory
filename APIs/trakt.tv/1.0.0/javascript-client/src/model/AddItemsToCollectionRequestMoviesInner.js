...
/**
 * The AddItemsToCollectionRequestMoviesInner model module.
 * @module model/AddItemsToCollectionRequestMoviesInner
 * @version 1.0.0
 */
class AddItemsToCollectionRequestMoviesInner {
    /**
     * Constructs a new <code>AddItemsToCollectionRequestMoviesInner</code>.
     * @alias module:model/AddItemsToCollectionRequestMoviesInner
     * @param ids {module:model/CheckIntoAnItemRequestMovieIds} 
     */
    constructor(ids) { 
        
        AddItemsToCollectionRequestMoviesInner.initialize(this, ids);
    }
    ...
    /**
     * Constructs a <code>AddItemsToCollectionRequestMoviesInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AddItemsToCollectionRequestMoviesInner} obj Optional instance to populate.
     * @return {module:model/AddItemsToCollectionRequestMoviesInner} The populated <code>AddItemsToCollectionRequestMoviesInner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AddItemsToCollectionRequestMoviesInner();
            ...
            if (data.hasOwnProperty('collected_at')) {
                obj['collected_at'] = ApiClient.convertToType(data['collected_at'], 'String');
            }
            if (data.hasOwnProperty('hdr')) {
                obj['hdr'] = ApiClient.convertToType(data['hdr'], 'String');
            }
    ...
    /**
     * Validates the JSON data with respect to <code>AddItemsToCollectionRequestMoviesInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AddItemsToCollectionRequestMoviesInner</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of AddItemsToCollectionRequestMoviesInner.RequiredProperties) {
        ...
        // ensure the json data is a string
        if (data['collected_at'] && !(typeof data['collected_at'] === 'string' || data['collected_at'] instanceof String)) {
            throw new Error("Expected the field `collected_at` to be a primitive type in the JSON string but got " + data['collected_at']);
        }
        // ensure the json data is a string
        if (data['hdr'] && !(typeof data['hdr'] === 'string' || data['hdr'] instanceof String)) {
            throw new Error("Expected the field `hdr` to be a primitive type in the JSON string but got " + data['hdr']);
        }
...
AddItemsToCollectionRequestMoviesInner.RequiredProperties = ["ids"];

/**
 * @member {String} audio
 */
AddItemsToCollectionRequestMoviesInner.prototype['audio'] = undefined;

/**
 * @member {String} audio_channels
 */
AddItemsToCollectionRequestMoviesInner.prototype['audio_channels'] = undefined;

/**
 * @member {String} collected_at
 */
AddItemsToCollectionRequestMoviesInner.prototype['collected_at'] = undefined;

/**
 * @member {String} hdr
 */
AddItemsToCollectionRequestMoviesInner.prototype['hdr'] = undefined;

/**
 * @member {module:model/CheckIntoAnItemRequestMovieIds} ids
 */
AddItemsToCollectionRequestMoviesInner.prototype['ids'] = undefined;

/**
 * @member {String} media_type
 */
AddItemsToCollectionRequestMoviesInner.prototype['media_type'] = undefined;

/**
 * @member {String} resolution
 */
AddItemsToCollectionRequestMoviesInner.prototype['resolution'] = undefined;

/**
 * @member {String} title
 */
AddItemsToCollectionRequestMoviesInner.prototype['title'] = undefined;

/**
 * @member {Number} year
 */
AddItemsToCollectionRequestMoviesInner.prototype['year'] = undefined;
...
export default AddItemsToCollectionRequestMoviesInner;
