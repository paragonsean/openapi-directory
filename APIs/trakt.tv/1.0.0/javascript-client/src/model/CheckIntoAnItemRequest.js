...
import CheckIntoAnItemRequestSharing from './CheckIntoAnItemRequestSharing';

/**
 * The CheckIntoAnItemRequest model module.
 * @module model/CheckIntoAnItemRequest
 * @version 1.0.0
 */
class CheckIntoAnItemRequest {
    /**
     * Constructs a new <code>CheckIntoAnItemRequest</code>.
     * @alias module:model/CheckIntoAnItemRequest
     */
    constructor() { 
        
        CheckIntoAnItemRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CheckIntoAnItemRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CheckIntoAnItemRequest} obj Optional instance to populate.
     * @return {module:model/CheckIntoAnItemRequest} The populated <code>CheckIntoAnItemRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CheckIntoAnItemRequest();
            ...
            if (data.hasOwnProperty('sharing')) {
                obj['sharing'] = CheckIntoAnItemRequestSharing.constructFromObject(data['sharing']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>CheckIntoAnItemRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CheckIntoAnItemRequest</code>.
     */
    static validateJSON(data) {
        ...
        if (data['sharing']) { // data not null
          CheckIntoAnItemRequestSharing.validateJSON(data['sharing']);
        }
 ...
 */
CheckIntoAnItemRequest.prototype['app_date'] = undefined;

/**
 * @member {String} app_version
 */
CheckIntoAnItemRequest.prototype['app_version'] = undefined;

/**
 * @member {String} message
 */
CheckIntoAnItemRequest.prototype['message'] = undefined;

/**
 * @member {module:model/CheckIntoAnItemRequestMovie} movie
 */
CheckIntoAnItemRequest.prototype['movie'] = undefined;

/**
 * @member {module:model/CheckIntoAnItemRequestSharing} sharing
 */
CheckIntoAnItemRequest.prototype['sharing'] = undefined;
...
export default CheckIntoAnItemRequest;
