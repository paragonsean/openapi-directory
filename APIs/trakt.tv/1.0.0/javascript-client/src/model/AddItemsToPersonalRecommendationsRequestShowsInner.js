...
/**
 * The AddItemsToPersonalRecommendationsRequestShowsInner model module.
 * @module model/AddItemsToPersonalRecommendationsRequestShowsInner
 * @version 1.0.0
 */
class AddItemsToPersonalRecommendationsRequestShowsInner {
    /**
     * Constructs a new <code>AddItemsToPersonalRecommendationsRequestShowsInner</code>.
     * @alias module:model/AddItemsToPersonalRecommendationsRequestShowsInner
     * @param ids {module:model/AddItemsToCollectionRequestShowsInnerIds} 
     * @param title {String} 
     * @param year {Number} 
     */
    constructor(ids, title, year) { 
        
        AddItemsToPersonalRecommendationsRequestShowsInner.initialize(this, ids, title, year);
    }
     ...
     */
    static initialize(obj, ids, title, year) { 
        obj['ids'] = ids;
        obj['title'] = title;
        obj['year'] = year;
    }
    ...
    /**
     * Constructs a <code>AddItemsToPersonalRecommendationsRequestShowsInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AddItemsToPersonalRecommendationsRequestShowsInner} obj Optional instance to populate.
     * @return {module:model/AddItemsToPersonalRecommendationsRequestShowsInner} The populated <code>AddItemsToPersonalRecommendationsRequestShowsInner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AddItemsToPersonalRecommendationsRequestShowsInner();
    ...
    /**
     * Validates the JSON data with respect to <code>AddItemsToPersonalRecommendationsRequestShowsInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AddItemsToPersonalRecommendationsRequestShowsInner</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of AddItemsToPersonalRecommendationsRequestShowsInner.RequiredProperties) {
...
AddItemsToPersonalRecommendationsRequestShowsInner.RequiredProperties = ["ids", "title", "year"];

/**
 * @member {module:model/AddItemsToCollectionRequestShowsInnerIds} ids
 */
AddItemsToPersonalRecommendationsRequestShowsInner.prototype['ids'] = undefined;

/**
 * @member {String} notes
 */
AddItemsToPersonalRecommendationsRequestShowsInner.prototype['notes'] = undefined;

/**
 * @member {String} title
 */
AddItemsToPersonalRecommendationsRequestShowsInner.prototype['title'] = undefined;

/**
 * @member {Number} year
 */
AddItemsToPersonalRecommendationsRequestShowsInner.prototype['year'] = undefined;
...
export default AddItemsToPersonalRecommendationsRequestShowsInner;
