...
/**
 * The PollForTheAccessTokenRequest model module.
 * @module model/PollForTheAccessTokenRequest
 * @version 1.0.0
 */
class PollForTheAccessTokenRequest {
    /**
     * Constructs a new <code>PollForTheAccessTokenRequest</code>.
     * @alias module:model/PollForTheAccessTokenRequest
     */
    constructor() { 
        
        PollForTheAccessTokenRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PollForTheAccessTokenRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PollForTheAccessTokenRequest} obj Optional instance to populate.
     * @return {module:model/PollForTheAccessTokenRequest} The populated <code>PollForTheAccessTokenRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PollForTheAccessTokenRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>PollForTheAccessTokenRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PollForTheAccessTokenRequest</code>.
     */
 ...
 */
PollForTheAccessTokenRequest.prototype['client_id'] = undefined;

/**
 * @member {String} client_secret
 */
PollForTheAccessTokenRequest.prototype['client_secret'] = undefined;

/**
 * @member {String} code
 */
PollForTheAccessTokenRequest.prototype['code'] = undefined;
...
export default PollForTheAccessTokenRequest;
