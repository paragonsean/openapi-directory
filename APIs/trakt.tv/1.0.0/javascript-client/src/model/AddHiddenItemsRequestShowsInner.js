...
import AddHiddenItemsRequestShowsInnerSeasonsInner from './AddHiddenItemsRequestShowsInnerSeasonsInner';
import AddItemsToCollectionRequestShowsInnerIds from './AddItemsToCollectionRequestShowsInnerIds';

/**
 * The AddHiddenItemsRequestShowsInner model module.
 * @module model/AddHiddenItemsRequestShowsInner
 * @version 1.0.0
 */
class AddHiddenItemsRequestShowsInner {
    /**
     * Constructs a new <code>AddHiddenItemsRequestShowsInner</code>.
     * @alias module:model/AddHiddenItemsRequestShowsInner
    ...
    constructor(ids, title, year) { 
        ...
        AddHiddenItemsRequestShowsInner.initialize(this, ids, title, year);
    }
    ...
    /**
     * Constructs a <code>AddHiddenItemsRequestShowsInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AddHiddenItemsRequestShowsInner} obj Optional instance to populate.
     * @return {module:model/AddHiddenItemsRequestShowsInner} The populated <code>AddHiddenItemsRequestShowsInner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AddHiddenItemsRequestShowsInner();

            if (data.hasOwnProperty('ids')) {
                obj['ids'] = AddItemsToCollectionRequestShowsInnerIds.constructFromObject(data['ids']);
            }
            if (data.hasOwnProperty('seasons')) {
                obj['seasons'] = ApiClient.convertToType(data['seasons'], [AddHiddenItemsRequestShowsInnerSeasonsInner]);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>AddHiddenItemsRequestShowsInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AddHiddenItemsRequestShowsInner</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of AddHiddenItemsRequestShowsInner.RequiredProperties) {
        ...
        if (data['seasons']) { // data not null
            ...
            for (const item of data['seasons']) {
                AddHiddenItemsRequestShowsInnerSeasonsInner.validateJSON(item);
            };
        }
...
AddHiddenItemsRequestShowsInner.RequiredProperties = ["ids", "title", "year"];

/**
 * @member {module:model/AddItemsToCollectionRequestShowsInnerIds} ids
 */
AddHiddenItemsRequestShowsInner.prototype['ids'] = undefined;

/**
 * @member {Array.<module:model/AddHiddenItemsRequestShowsInnerSeasonsInner>} seasons
 */
AddHiddenItemsRequestShowsInner.prototype['seasons'] = undefined;

/**
 * @member {String} title
 */
AddHiddenItemsRequestShowsInner.prototype['title'] = undefined;

/**
 * @member {Number} year
 */
AddHiddenItemsRequestShowsInner.prototype['year'] = undefined;
...
export default AddHiddenItemsRequestShowsInner;
