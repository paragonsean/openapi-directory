...
/**
 * The UpdatePersonalListRequest model module.
 * @module model/UpdatePersonalListRequest
 * @version 1.0.0
 */
class UpdatePersonalListRequest {
    /**
     * Constructs a new <code>UpdatePersonalListRequest</code>.
     * @alias module:model/UpdatePersonalListRequest
     */
    constructor() { 
        
        UpdatePersonalListRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>UpdatePersonalListRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdatePersonalListRequest} obj Optional instance to populate.
     * @return {module:model/UpdatePersonalListRequest} The populated <code>UpdatePersonalListRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdatePersonalListRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>UpdatePersonalListRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdatePersonalListRequest</code>.
     */
 ...
 */
UpdatePersonalListRequest.prototype['display_numbers'] = undefined;

/**
 * @member {String} name
 */
UpdatePersonalListRequest.prototype['name'] = undefined;

/**
 * @member {String} privacy
 */
UpdatePersonalListRequest.prototype['privacy'] = undefined;

/**
 * @member {String} sort_by
 */
UpdatePersonalListRequest.prototype['sort_by'] = undefined;

/**
 * @member {String} sort_how
 */
UpdatePersonalListRequest.prototype['sort_how'] = undefined;
...
export default UpdatePersonalListRequest;
