...
import PostACommentRequestSharing from './PostACommentRequestSharing';

/**
 * The PostACommentRequest model module.
 * @module model/PostACommentRequest
 * @version 1.0.0
 */
class PostACommentRequest {
    /**
     * Constructs a new <code>PostACommentRequest</code>.
     * @alias module:model/PostACommentRequest
     */
    constructor() { 
        
        PostACommentRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PostACommentRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PostACommentRequest} obj Optional instance to populate.
     * @return {module:model/PostACommentRequest} The populated <code>PostACommentRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PostACommentRequest();
            ...
            if (data.hasOwnProperty('sharing')) {
                obj['sharing'] = PostACommentRequestSharing.constructFromObject(data['sharing']);
            }
            if (data.hasOwnProperty('spoiler')) {
                obj['spoiler'] = ApiClient.convertToType(data['spoiler'], 'Boolean');
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>PostACommentRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PostACommentRequest</code>.
     */
    static validateJSON(data) {
        ...
        if (data['sharing']) { // data not null
          PostACommentRequestSharing.validateJSON(data['sharing']);
        }
 ...
 */
PostACommentRequest.prototype['comment'] = undefined;

/**
 * @member {module:model/CheckIntoAnItemRequestMovie} movie
 */
PostACommentRequest.prototype['movie'] = undefined;

/**
 * @member {module:model/PostACommentRequestSharing} sharing
 */
PostACommentRequest.prototype['sharing'] = undefined;

/**
 * @member {Boolean} spoiler
 */
PostACommentRequest.prototype['spoiler'] = undefined;
...
export default PostACommentRequest;
