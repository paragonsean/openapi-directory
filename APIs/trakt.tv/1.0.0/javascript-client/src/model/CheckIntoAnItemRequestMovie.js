...
/**
 * The CheckIntoAnItemRequestMovie model module.
 * @module model/CheckIntoAnItemRequestMovie
 * @version 1.0.0
 */
class CheckIntoAnItemRequestMovie {
    /**
     * Constructs a new <code>CheckIntoAnItemRequestMovie</code>.
     * @alias module:model/CheckIntoAnItemRequestMovie
     */
    constructor() { 
        
        CheckIntoAnItemRequestMovie.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CheckIntoAnItemRequestMovie</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CheckIntoAnItemRequestMovie} obj Optional instance to populate.
     * @return {module:model/CheckIntoAnItemRequestMovie} The populated <code>CheckIntoAnItemRequestMovie</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CheckIntoAnItemRequestMovie();
    ...
    /**
     * Validates the JSON data with respect to <code>CheckIntoAnItemRequestMovie</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CheckIntoAnItemRequestMovie</code>.
     */
 ...
 */
CheckIntoAnItemRequestMovie.prototype['ids'] = undefined;

/**
 * @member {String} title
 */
CheckIntoAnItemRequestMovie.prototype['title'] = undefined;

/**
 * @member {Number} year
 */
CheckIntoAnItemRequestMovie.prototype['year'] = undefined;
...
export default CheckIntoAnItemRequestMovie;
