...
/**
 * The AddItemsToCollectionRequestEpisodesInnerIds model module.
 * @module model/AddItemsToCollectionRequestEpisodesInnerIds
 * @version 1.0.0
 */
class AddItemsToCollectionRequestEpisodesInnerIds {
    /**
     * Constructs a new <code>AddItemsToCollectionRequestEpisodesInnerIds</code>.
     * @alias module:model/AddItemsToCollectionRequestEpisodesInnerIds
     */
    constructor() { 
        
        AddItemsToCollectionRequestEpisodesInnerIds.initialize(this);
    }
    ...
    /**
     * Constructs a <code>AddItemsToCollectionRequestEpisodesInnerIds</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AddItemsToCollectionRequestEpisodesInnerIds} obj Optional instance to populate.
     * @return {module:model/AddItemsToCollectionRequestEpisodesInnerIds} The populated <code>AddItemsToCollectionRequestEpisodesInnerIds</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AddItemsToCollectionRequestEpisodesInnerIds();

            if (data.hasOwnProperty('imdb')) {
                obj['imdb'] = ApiClient.convertToType(data['imdb'], 'String');
            }
            if (data.hasOwnProperty('tmdb')) {
                obj['tmdb'] = ApiClient.convertToType(data['tmdb'], 'Number');
            }
            if (data.hasOwnProperty('trakt')) {
                obj['trakt'] = ApiClient.convertToType(data['trakt'], 'Number');
            }
            if (data.hasOwnProperty('tvdb')) {
                obj['tvdb'] = ApiClient.convertToType(data['tvdb'], 'Number');
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>AddItemsToCollectionRequestEpisodesInnerIds</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AddItemsToCollectionRequestEpisodesInnerIds</code>.
     */
 ...
 * @member {String} imdb
 */
AddItemsToCollectionRequestEpisodesInnerIds.prototype['imdb'] = undefined;

/**
 * @member {Number} tmdb
 */
AddItemsToCollectionRequestEpisodesInnerIds.prototype['tmdb'] = undefined;

/**
 * @member {Number} trakt
 */
AddItemsToCollectionRequestEpisodesInnerIds.prototype['trakt'] = undefined;

/**
 * @member {Number} tvdb
 */
AddItemsToCollectionRequestEpisodesInnerIds.prototype['tvdb'] = undefined;
...
export default AddItemsToCollectionRequestEpisodesInnerIds;
