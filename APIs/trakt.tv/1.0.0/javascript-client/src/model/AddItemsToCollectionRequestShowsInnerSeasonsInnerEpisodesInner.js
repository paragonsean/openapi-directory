...
/**
 * The AddItemsToCollectionRequestShowsInnerSeasonsInnerEpisodesInner model module.
 * @module model/AddItemsToCollectionRequestShowsInnerSeasonsInnerEpisodesInner
 * @version 1.0.0
 */
class AddItemsToCollectionRequestShowsInnerSeasonsInnerEpisodesInner {
    /**
     * Constructs a new <code>AddItemsToCollectionRequestShowsInnerSeasonsInnerEpisodesInner</code>.
     * @alias module:model/AddItemsToCollectionRequestShowsInnerSeasonsInnerEpisodesInner
     * @param number {Number} 
     */
    constructor(number) { 
        
        AddItemsToCollectionRequestShowsInnerSeasonsInnerEpisodesInner.initialize(this, number);
    }
    ...
    /**
     * Constructs a <code>AddItemsToCollectionRequestShowsInnerSeasonsInnerEpisodesInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AddItemsToCollectionRequestShowsInnerSeasonsInnerEpisodesInner} obj Optional instance to populate.
     * @return {module:model/AddItemsToCollectionRequestShowsInnerSeasonsInnerEpisodesInner} The populated <code>AddItemsToCollectionRequestShowsInnerSeasonsInnerEpisodesInner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AddItemsToCollectionRequestShowsInnerSeasonsInnerEpisodesInner();

            if (data.hasOwnProperty('audio')) {
                obj['audio'] = ApiClient.convertToType(data['audio'], 'String');
            }
            if (data.hasOwnProperty('audio_channels')) {
                obj['audio_channels'] = ApiClient.convertToType(data['audio_channels'], 'String');
            }
    ...
    /**
     * Validates the JSON data with respect to <code>AddItemsToCollectionRequestShowsInnerSeasonsInnerEpisodesInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AddItemsToCollectionRequestShowsInnerSeasonsInnerEpisodesInner</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of AddItemsToCollectionRequestShowsInnerSeasonsInnerEpisodesInner.RequiredProperties) {
        ...
        // ensure the json data is a string
        if (data['audio_channels'] && !(typeof data['audio_channels'] === 'string' || data['audio_channels'] instanceof String)) {
            throw new Error("Expected the field `audio_channels` to be a primitive type in the JSON string but got " + data['audio_channels']);
        }
        // ensure the json data is a string
...
AddItemsToCollectionRequestShowsInnerSeasonsInnerEpisodesInner.RequiredProperties = ["number"];

/**
 * @member {String} audio
 */
AddItemsToCollectionRequestShowsInnerSeasonsInnerEpisodesInner.prototype['audio'] = undefined;

/**
 * @member {String} audio_channels
 */
AddItemsToCollectionRequestShowsInnerSeasonsInnerEpisodesInner.prototype['audio_channels'] = undefined;

/**
 * @member {String} media_type
 */
AddItemsToCollectionRequestShowsInnerSeasonsInnerEpisodesInner.prototype['media_type'] = undefined;

/**
 * @member {Number} number
 */
AddItemsToCollectionRequestShowsInnerSeasonsInnerEpisodesInner.prototype['number'] = undefined;

/**
 * @member {String} resolution
 */
AddItemsToCollectionRequestShowsInnerSeasonsInnerEpisodesInner.prototype['resolution'] = undefined;
...
export default AddItemsToCollectionRequestShowsInnerSeasonsInnerEpisodesInner;
