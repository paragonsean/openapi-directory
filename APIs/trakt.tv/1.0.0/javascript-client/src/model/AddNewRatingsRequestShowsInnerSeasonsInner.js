...
import AddNewRatingsRequestShowsInnerSeasonsInnerEpisodesInner from './AddNewRatingsRequestShowsInnerSeasonsInnerEpisodesInner';

/**
 * The AddNewRatingsRequestShowsInnerSeasonsInner model module.
 * @module model/AddNewRatingsRequestShowsInnerSeasonsInner
 * @version 1.0.0
 */
class AddNewRatingsRequestShowsInnerSeasonsInner {
    /**
     * Constructs a new <code>AddNewRatingsRequestShowsInnerSeasonsInner</code>.
     * @alias module:model/AddNewRatingsRequestShowsInnerSeasonsInner
     * @param number {Number} 
     */
    constructor(number) { 
        
        AddNewRatingsRequestShowsInnerSeasonsInner.initialize(this, number);
    }
    ...
    /**
     * Constructs a <code>AddNewRatingsRequestShowsInnerSeasonsInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AddNewRatingsRequestShowsInnerSeasonsInner} obj Optional instance to populate.
     * @return {module:model/AddNewRatingsRequestShowsInnerSeasonsInner} The populated <code>AddNewRatingsRequestShowsInnerSeasonsInner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AddNewRatingsRequestShowsInnerSeasonsInner();

            if (data.hasOwnProperty('episodes')) {
                obj['episodes'] = ApiClient.convertToType(data['episodes'], [AddNewRatingsRequestShowsInnerSeasonsInnerEpisodesInner]);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>AddNewRatingsRequestShowsInnerSeasonsInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AddNewRatingsRequestShowsInnerSeasonsInner</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of AddNewRatingsRequestShowsInnerSeasonsInner.RequiredProperties) {
        ...
        if (data['episodes']) { // data not null
            ...
            for (const item of data['episodes']) {
                AddNewRatingsRequestShowsInnerSeasonsInnerEpisodesInner.validateJSON(item);
            };
        }
...
AddNewRatingsRequestShowsInnerSeasonsInner.RequiredProperties = ["number"];

/**
 * @member {Array.<module:model/AddNewRatingsRequestShowsInnerSeasonsInnerEpisodesInner>} episodes
 */
AddNewRatingsRequestShowsInnerSeasonsInner.prototype['episodes'] = undefined;

/**
 * @member {Number} number
 */
AddNewRatingsRequestShowsInnerSeasonsInner.prototype['number'] = undefined;

/**
 * @member {Number} rating
 */
AddNewRatingsRequestShowsInnerSeasonsInner.prototype['rating'] = undefined;
...
export default AddNewRatingsRequestShowsInnerSeasonsInner;
