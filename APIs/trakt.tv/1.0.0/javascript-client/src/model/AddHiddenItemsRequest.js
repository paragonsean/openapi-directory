...
import AddHiddenItemsRequestSeasonsInner from './AddHiddenItemsRequestSeasonsInner';
import AddHiddenItemsRequestShowsInner from './AddHiddenItemsRequestShowsInner';
import RemoveItemsFromCollectionRequestMoviesInner from './RemoveItemsFromCollectionRequestMoviesInner';

/**
 * The AddHiddenItemsRequest model module.
 * @module model/AddHiddenItemsRequest
 * @version 1.0.0
 */
class AddHiddenItemsRequest {
    /**
     * Constructs a new <code>AddHiddenItemsRequest</code>.
     * @alias module:model/AddHiddenItemsRequest
     */
    constructor() { 
        
        AddHiddenItemsRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>AddHiddenItemsRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AddHiddenItemsRequest} obj Optional instance to populate.
     * @return {module:model/AddHiddenItemsRequest} The populated <code>AddHiddenItemsRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AddHiddenItemsRequest();

            if (data.hasOwnProperty('movies')) {
                obj['movies'] = ApiClient.convertToType(data['movies'], [RemoveItemsFromCollectionRequestMoviesInner]);
            }
            if (data.hasOwnProperty('seasons')) {
                obj['seasons'] = ApiClient.convertToType(data['seasons'], [AddHiddenItemsRequestSeasonsInner]);
            }
            if (data.hasOwnProperty('shows')) {
                obj['shows'] = ApiClient.convertToType(data['shows'], [AddHiddenItemsRequestShowsInner]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>AddHiddenItemsRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AddHiddenItemsRequest</code>.
     */
    static validateJSON(data) {
        if (data['movies']) { // data not null
            ...
            for (const item of data['movies']) {
                RemoveItemsFromCollectionRequestMoviesInner.validateJSON(item);
            };
        }
        if (data['seasons']) { // data not null
            ...
            for (const item of data['seasons']) {
                AddHiddenItemsRequestSeasonsInner.validateJSON(item);
            };
        }
        if (data['shows']) { // data not null
            ...
            for (const item of data['shows']) {
                AddHiddenItemsRequestShowsInner.validateJSON(item);
            };
        }
...
/**
 * @member {Array.<module:model/RemoveItemsFromCollectionRequestMoviesInner>} movies
 */
AddHiddenItemsRequest.prototype['movies'] = undefined;

/**
 * @member {Array.<module:model/AddHiddenItemsRequestSeasonsInner>} seasons
 */
AddHiddenItemsRequest.prototype['seasons'] = undefined;

/**
 * @member {Array.<module:model/AddHiddenItemsRequestShowsInner>} shows
 */
AddHiddenItemsRequest.prototype['shows'] = undefined;
...
export default AddHiddenItemsRequest;
