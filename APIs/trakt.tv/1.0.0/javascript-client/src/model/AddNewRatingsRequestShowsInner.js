...
import AddNewRatingsRequestShowsInnerSeasonsInner from './AddNewRatingsRequestShowsInnerSeasonsInner';

/**
 * The AddNewRatingsRequestShowsInner model module.
 * @module model/AddNewRatingsRequestShowsInner
 * @version 1.0.0
 */
class AddNewRatingsRequestShowsInner {
    /**
     * Constructs a new <code>AddNewRatingsRequestShowsInner</code>.
     * @alias module:model/AddNewRatingsRequestShowsInner
     * @param ids {module:model/AddItemsToCollectionRequestShowsInnerIds} 
     * @param seasons {Array.<module:model/AddNewRatingsRequestShowsInnerSeasonsInner>} 
     * @param title {String} 
     * @param year {Number} 
     */
    constructor(ids, seasons, title, year) { 
        
        AddNewRatingsRequestShowsInner.initialize(this, ids, seasons, title, year);
    }
    ...
    /**
     * Constructs a <code>AddNewRatingsRequestShowsInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AddNewRatingsRequestShowsInner} obj Optional instance to populate.
     * @return {module:model/AddNewRatingsRequestShowsInner} The populated <code>AddNewRatingsRequestShowsInner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AddNewRatingsRequestShowsInner();
            ...
            if (data.hasOwnProperty('seasons')) {
                obj['seasons'] = ApiClient.convertToType(data['seasons'], [AddNewRatingsRequestShowsInnerSeasonsInner]);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>AddNewRatingsRequestShowsInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AddNewRatingsRequestShowsInner</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of AddNewRatingsRequestShowsInner.RequiredProperties) {
        ...
        if (data['seasons']) { // data not null
            ...
            for (const item of data['seasons']) {
                AddNewRatingsRequestShowsInnerSeasonsInner.validateJSON(item);
            };
        }
...
AddNewRatingsRequestShowsInner.RequiredProperties = ["ids", "seasons", "title", "year"];

/**
 * @member {module:model/AddItemsToCollectionRequestShowsInnerIds} ids
 */
AddNewRatingsRequestShowsInner.prototype['ids'] = undefined;

/**
 * @member {Number} rating
 */
AddNewRatingsRequestShowsInner.prototype['rating'] = undefined;

/**
 * @member {Array.<module:model/AddNewRatingsRequestShowsInnerSeasonsInner>} seasons
 */
AddNewRatingsRequestShowsInner.prototype['seasons'] = undefined;

/**
 * @member {String} title
 */
AddNewRatingsRequestShowsInner.prototype['title'] = undefined;

/**
 * @member {Number} year
 */
AddNewRatingsRequestShowsInner.prototype['year'] = undefined;
...
export default AddNewRatingsRequestShowsInner;
