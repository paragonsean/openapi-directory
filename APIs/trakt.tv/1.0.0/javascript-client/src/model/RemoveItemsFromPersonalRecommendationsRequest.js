...
import RemoveItemsFromPersonalRecommendationsRequestShowsInner from './RemoveItemsFromPersonalRecommendationsRequestShowsInner';

/**
 * The RemoveItemsFromPersonalRecommendationsRequest model module.
 * @module model/RemoveItemsFromPersonalRecommendationsRequest
 * @version 1.0.0
 */
class RemoveItemsFromPersonalRecommendationsRequest {
    /**
     * Constructs a new <code>RemoveItemsFromPersonalRecommendationsRequest</code>.
     * @alias module:model/RemoveItemsFromPersonalRecommendationsRequest
     */
    constructor() { 
        
        RemoveItemsFromPersonalRecommendationsRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>RemoveItemsFromPersonalRecommendationsRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/RemoveItemsFromPersonalRecommendationsRequest} obj Optional instance to populate.
     * @return {module:model/RemoveItemsFromPersonalRecommendationsRequest} The populated <code>RemoveItemsFromPersonalRecommendationsRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RemoveItemsFromPersonalRecommendationsRequest();
            ...
            if (data.hasOwnProperty('shows')) {
                obj['shows'] = ApiClient.convertToType(data['shows'], [RemoveItemsFromPersonalRecommendationsRequestShowsInner]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>RemoveItemsFromPersonalRecommendationsRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RemoveItemsFromPersonalRecommendationsRequest</code>.
     */
    static validateJSON(data) {
        ...
        if (data['shows']) { // data not null
            ...
            for (const item of data['shows']) {
                RemoveItemsFromPersonalRecommendationsRequestShowsInner.validateJSON(item);
            };
        }
 ...
 */
RemoveItemsFromPersonalRecommendationsRequest.prototype['movies'] = undefined;

/**
 * @member {Array.<module:model/RemoveItemsFromPersonalRecommendationsRequestShowsInner>} shows
 */
RemoveItemsFromPersonalRecommendationsRequest.prototype['shows'] = undefined;
...
export default RemoveItemsFromPersonalRecommendationsRequest;
