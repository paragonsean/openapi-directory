...
import RemoveItemsFromPersonalListRequestMoviesInner from './RemoveItemsFromPersonalListRequestMoviesInner';
import RemoveItemsFromPersonalListRequestShowsInner from './RemoveItemsFromPersonalListRequestShowsInner';

/**
 * The RemoveItemsFromPersonalListRequest model module.
 * @module model/RemoveItemsFromPersonalListRequest
 * @version 1.0.0
 */
class RemoveItemsFromPersonalListRequest {
    /**
     * Constructs a new <code>RemoveItemsFromPersonalListRequest</code>.
     * @alias module:model/RemoveItemsFromPersonalListRequest
     */
    constructor() { 
        
        RemoveItemsFromPersonalListRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>RemoveItemsFromPersonalListRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/RemoveItemsFromPersonalListRequest} obj Optional instance to populate.
     * @return {module:model/RemoveItemsFromPersonalListRequest} The populated <code>RemoveItemsFromPersonalListRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RemoveItemsFromPersonalListRequest();
            ...
            if (data.hasOwnProperty('movies')) {
                obj['movies'] = ApiClient.convertToType(data['movies'], [RemoveItemsFromPersonalListRequestMoviesInner]);
            }
            ...
            if (data.hasOwnProperty('shows')) {
                obj['shows'] = ApiClient.convertToType(data['shows'], [RemoveItemsFromPersonalListRequestShowsInner]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>RemoveItemsFromPersonalListRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RemoveItemsFromPersonalListRequest</code>.
     */
    static validateJSON(data) {
        ...
        if (data['movies']) { // data not null
            ...
            for (const item of data['movies']) {
                RemoveItemsFromPersonalListRequestMoviesInner.validateJSON(item);
            };
        }
        ...
        if (data['shows']) { // data not null
            ...
            for (const item of data['shows']) {
                RemoveItemsFromPersonalListRequestShowsInner.validateJSON(item);
            };
        }
 ...
 */
RemoveItemsFromPersonalListRequest.prototype['episodes'] = undefined;

/**
 * @member {Array.<module:model/RemoveItemsFromPersonalListRequestMoviesInner>} movies
 */
RemoveItemsFromPersonalListRequest.prototype['movies'] = undefined;

/**
 * @member {Array.<module:model/AddItemsToPersonalListRequestPeopleInner>} people
 */
RemoveItemsFromPersonalListRequest.prototype['people'] = undefined;

/**
 * @member {Array.<module:model/AddItemsToCollectionRequestSeasonsInner>} seasons
 */
RemoveItemsFromPersonalListRequest.prototype['seasons'] = undefined;

/**
 * @member {Array.<module:model/RemoveItemsFromPersonalListRequestShowsInner>} shows
 */
RemoveItemsFromPersonalListRequest.prototype['shows'] = undefined;
...
export default RemoveItemsFromPersonalListRequest;
