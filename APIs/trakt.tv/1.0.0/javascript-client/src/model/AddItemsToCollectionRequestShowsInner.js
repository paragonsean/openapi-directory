...
import AddItemsToCollectionRequestShowsInnerSeasonsInner from './AddItemsToCollectionRequestShowsInnerSeasonsInner';

/**
 * The AddItemsToCollectionRequestShowsInner model module.
 * @module model/AddItemsToCollectionRequestShowsInner
 * @version 1.0.0
 */
class AddItemsToCollectionRequestShowsInner {
    /**
     * Constructs a new <code>AddItemsToCollectionRequestShowsInner</code>.
     * @alias module:model/AddItemsToCollectionRequestShowsInner
     * @param ids {module:model/AddItemsToCollectionRequestShowsInnerIds} 
     * @param seasons {Array.<module:model/AddItemsToCollectionRequestShowsInnerSeasonsInner>} 
     * @param title {String} 
     * @param year {Number} 
     */
    constructor(ids, seasons, title, year) { 
        
        AddItemsToCollectionRequestShowsInner.initialize(this, ids, seasons, title, year);
    }
    ...
    /**
     * Constructs a <code>AddItemsToCollectionRequestShowsInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AddItemsToCollectionRequestShowsInner} obj Optional instance to populate.
     * @return {module:model/AddItemsToCollectionRequestShowsInner} The populated <code>AddItemsToCollectionRequestShowsInner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AddItemsToCollectionRequestShowsInner();

            if (data.hasOwnProperty('ids')) {
                obj['ids'] = AddItemsToCollectionRequestShowsInnerIds.constructFromObject(data['ids']);
            }
            if (data.hasOwnProperty('seasons')) {
                obj['seasons'] = ApiClient.convertToType(data['seasons'], [AddItemsToCollectionRequestShowsInnerSeasonsInner]);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>AddItemsToCollectionRequestShowsInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AddItemsToCollectionRequestShowsInner</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of AddItemsToCollectionRequestShowsInner.RequiredProperties) {
        ...
        if (data['seasons']) { // data not null
            ...
            for (const item of data['seasons']) {
                AddItemsToCollectionRequestShowsInnerSeasonsInner.validateJSON(item);
            };
        }
...
AddItemsToCollectionRequestShowsInner.RequiredProperties = ["ids", "seasons", "title", "year"];

/**
 * @member {module:model/AddItemsToCollectionRequestShowsInnerIds} ids
 */
AddItemsToCollectionRequestShowsInner.prototype['ids'] = undefined;

/**
 * @member {Array.<module:model/AddItemsToCollectionRequestShowsInnerSeasonsInner>} seasons
 */
AddItemsToCollectionRequestShowsInner.prototype['seasons'] = undefined;

/**
 * @member {String} title
 */
AddItemsToCollectionRequestShowsInner.prototype['title'] = undefined;

/**
 * @member {Number} year
 */
AddItemsToCollectionRequestShowsInner.prototype['year'] = undefined;
...
export default AddItemsToCollectionRequestShowsInner;
