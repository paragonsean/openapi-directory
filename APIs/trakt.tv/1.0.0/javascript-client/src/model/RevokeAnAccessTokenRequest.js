...
/**
 * The RevokeAnAccessTokenRequest model module.
 * @module model/RevokeAnAccessTokenRequest
 * @version 1.0.0
 */
class RevokeAnAccessTokenRequest {
    /**
     * Constructs a new <code>RevokeAnAccessTokenRequest</code>.
     * @alias module:model/RevokeAnAccessTokenRequest
     */
    constructor() { 
        
        RevokeAnAccessTokenRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>RevokeAnAccessTokenRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/RevokeAnAccessTokenRequest} obj Optional instance to populate.
     * @return {module:model/RevokeAnAccessTokenRequest} The populated <code>RevokeAnAccessTokenRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RevokeAnAccessTokenRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>RevokeAnAccessTokenRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RevokeAnAccessTokenRequest</code>.
     */
 ...
 */
RevokeAnAccessTokenRequest.prototype['client_id'] = undefined;

/**
 * @member {String} client_secret
 */
RevokeAnAccessTokenRequest.prototype['client_secret'] = undefined;

/**
 * @member {String} token
 */
RevokeAnAccessTokenRequest.prototype['token'] = undefined;
...
export default RevokeAnAccessTokenRequest;
