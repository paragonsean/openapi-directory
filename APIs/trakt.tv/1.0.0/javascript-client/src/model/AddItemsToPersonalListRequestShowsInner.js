...
import AddHiddenItemsRequestSeasonsInnerIds from './AddHiddenItemsRequestSeasonsInnerIds';
...
/**
 * The AddItemsToPersonalListRequestShowsInner model module.
 * @module model/AddItemsToPersonalListRequestShowsInner
 * @version 1.0.0
 */
class AddItemsToPersonalListRequestShowsInner {
    /**
     * Constructs a new <code>AddItemsToPersonalListRequestShowsInner</code>.
     * @alias module:model/AddItemsToPersonalListRequestShowsInner
     * @param ids {module:model/AddHiddenItemsRequestSeasonsInnerIds} 
     * @param seasons {Array.<module:model/RemoveItemsFromCollectionRequestShowsInnerSeasonsInner>} 
     */
    constructor(ids, seasons) { 
        
        AddItemsToPersonalListRequestShowsInner.initialize(this, ids, seasons);
    }
     ...
     */
    static initialize(obj, ids, seasons) { 
        obj['ids'] = ids;
        obj['seasons'] = seasons;
    }

    /**
     * Constructs a <code>AddItemsToPersonalListRequestShowsInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AddItemsToPersonalListRequestShowsInner} obj Optional instance to populate.
     * @return {module:model/AddItemsToPersonalListRequestShowsInner} The populated <code>AddItemsToPersonalListRequestShowsInner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AddItemsToPersonalListRequestShowsInner();

            if (data.hasOwnProperty('ids')) {
                obj['ids'] = AddHiddenItemsRequestSeasonsInnerIds.constructFromObject(data['ids']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>AddItemsToPersonalListRequestShowsInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AddItemsToPersonalListRequestShowsInner</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of AddItemsToPersonalListRequestShowsInner.RequiredProperties) {
        ...
        if (data['ids']) { // data not null
          AddHiddenItemsRequestSeasonsInnerIds.validateJSON(data['ids']);
        }
...
AddItemsToPersonalListRequestShowsInner.RequiredProperties = ["ids", "seasons"];

/**
 * @member {module:model/AddHiddenItemsRequestSeasonsInnerIds} ids
 */
AddItemsToPersonalListRequestShowsInner.prototype['ids'] = undefined;

/**
 * @member {String} notes
 */
AddItemsToPersonalListRequestShowsInner.prototype['notes'] = undefined;

/**
 * @member {Array.<module:model/RemoveItemsFromCollectionRequestShowsInnerSeasonsInner>} seasons
 */
AddItemsToPersonalListRequestShowsInner.prototype['seasons'] = undefined;
...
export default AddItemsToPersonalListRequestShowsInner;
