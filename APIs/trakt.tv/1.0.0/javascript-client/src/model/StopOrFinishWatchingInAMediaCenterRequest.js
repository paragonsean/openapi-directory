...
/**
 * The StopOrFinishWatchingInAMediaCenterRequest model module.
 * @module model/StopOrFinishWatchingInAMediaCenterRequest
 * @version 1.0.0
 */
class StopOrFinishWatchingInAMediaCenterRequest {
    /**
     * Constructs a new <code>StopOrFinishWatchingInAMediaCenterRequest</code>.
     * @alias module:model/StopOrFinishWatchingInAMediaCenterRequest
     */
    constructor() { 
        
        StopOrFinishWatchingInAMediaCenterRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>StopOrFinishWatchingInAMediaCenterRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/StopOrFinishWatchingInAMediaCenterRequest} obj Optional instance to populate.
     * @return {module:model/StopOrFinishWatchingInAMediaCenterRequest} The populated <code>StopOrFinishWatchingInAMediaCenterRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new StopOrFinishWatchingInAMediaCenterRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>StopOrFinishWatchingInAMediaCenterRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>StopOrFinishWatchingInAMediaCenterRequest</code>.
     */
 ...
 */
StopOrFinishWatchingInAMediaCenterRequest.prototype['app_date'] = undefined;

/**
 * @member {String} app_version
 */
StopOrFinishWatchingInAMediaCenterRequest.prototype['app_version'] = undefined;

/**
 * @member {module:model/CheckIntoAnItemRequestMovie} movie
 */
StopOrFinishWatchingInAMediaCenterRequest.prototype['movie'] = undefined;

/**
 * @member {Number} progress
 */
StopOrFinishWatchingInAMediaCenterRequest.prototype['progress'] = undefined;
...
export default StopOrFinishWatchingInAMediaCenterRequest;
