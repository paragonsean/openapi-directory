...
import AddItemsToWatchedHistoryRequestShowsInnerSeasonsInner from './AddItemsToWatchedHistoryRequestShowsInnerSeasonsInner';

/**
 * The AddItemsToWatchedHistoryRequestShowsInner model module.
 * @module model/AddItemsToWatchedHistoryRequestShowsInner
 * @version 1.0.0
 */
class AddItemsToWatchedHistoryRequestShowsInner {
    /**
     * Constructs a new <code>AddItemsToWatchedHistoryRequestShowsInner</code>.
     * @alias module:model/AddItemsToWatchedHistoryRequestShowsInner
     * @param ids {module:model/AddItemsToCollectionRequestShowsInnerIds} 
     * @param seasons {Array.<module:model/AddItemsToWatchedHistoryRequestShowsInnerSeasonsInner>} 
     * @param title {String} 
     * @param year {Number} 
     */
    constructor(ids, seasons, title, year) { 
        
        AddItemsToWatchedHistoryRequestShowsInner.initialize(this, ids, seasons, title, year);
    }
    ...
    /**
     * Constructs a <code>AddItemsToWatchedHistoryRequestShowsInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AddItemsToWatchedHistoryRequestShowsInner} obj Optional instance to populate.
     * @return {module:model/AddItemsToWatchedHistoryRequestShowsInner} The populated <code>AddItemsToWatchedHistoryRequestShowsInner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AddItemsToWatchedHistoryRequestShowsInner();

            if (data.hasOwnProperty('ids')) {
                obj['ids'] = AddItemsToCollectionRequestShowsInnerIds.constructFromObject(data['ids']);
            }
            if (data.hasOwnProperty('seasons')) {
                obj['seasons'] = ApiClient.convertToType(data['seasons'], [AddItemsToWatchedHistoryRequestShowsInnerSeasonsInner]);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>AddItemsToWatchedHistoryRequestShowsInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AddItemsToWatchedHistoryRequestShowsInner</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of AddItemsToWatchedHistoryRequestShowsInner.RequiredProperties) {
        ...
        if (data['seasons']) { // data not null
            ...
            for (const item of data['seasons']) {
                AddItemsToWatchedHistoryRequestShowsInnerSeasonsInner.validateJSON(item);
            };
        }
...
AddItemsToWatchedHistoryRequestShowsInner.RequiredProperties = ["ids", "seasons", "title", "year"];

/**
 * @member {module:model/AddItemsToCollectionRequestShowsInnerIds} ids
 */
AddItemsToWatchedHistoryRequestShowsInner.prototype['ids'] = undefined;

/**
 * @member {Array.<module:model/AddItemsToWatchedHistoryRequestShowsInnerSeasonsInner>} seasons
 */
AddItemsToWatchedHistoryRequestShowsInner.prototype['seasons'] = undefined;

/**
 * @member {String} title
 */
AddItemsToWatchedHistoryRequestShowsInner.prototype['title'] = undefined;

/**
 * @member {Number} year
 */
AddItemsToWatchedHistoryRequestShowsInner.prototype['year'] = undefined;
...
export default AddItemsToWatchedHistoryRequestShowsInner;
