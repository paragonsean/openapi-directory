...
/**
 * The RemoveItemsFromPersonalListRequestShowsInner model module.
 * @module model/RemoveItemsFromPersonalListRequestShowsInner
 * @version 1.0.0
 */
class RemoveItemsFromPersonalListRequestShowsInner {
    /**
     * Constructs a new <code>RemoveItemsFromPersonalListRequestShowsInner</code>.
     * @alias module:model/RemoveItemsFromPersonalListRequestShowsInner
    ...
    constructor(ids, seasons) { 
        ...
        RemoveItemsFromPersonalListRequestShowsInner.initialize(this, ids, seasons);
    }
    ...
    /**
     * Constructs a <code>RemoveItemsFromPersonalListRequestShowsInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/RemoveItemsFromPersonalListRequestShowsInner} obj Optional instance to populate.
     * @return {module:model/RemoveItemsFromPersonalListRequestShowsInner} The populated <code>RemoveItemsFromPersonalListRequestShowsInner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RemoveItemsFromPersonalListRequestShowsInner();
    ...
    /**
     * Validates the JSON data with respect to <code>RemoveItemsFromPersonalListRequestShowsInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RemoveItemsFromPersonalListRequestShowsInner</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of RemoveItemsFromPersonalListRequestShowsInner.RequiredProperties) {
...
RemoveItemsFromPersonalListRequestShowsInner.RequiredProperties = ["ids", "seasons"];

/**
 * @member {module:model/AddHiddenItemsRequestSeasonsInnerIds} ids
 */
RemoveItemsFromPersonalListRequestShowsInner.prototype['ids'] = undefined;

/**
 * @member {Array.<module:model/RemoveItemsFromCollectionRequestShowsInnerSeasonsInner>} seasons
 */
RemoveItemsFromPersonalListRequestShowsInner.prototype['seasons'] = undefined;
...
export default RemoveItemsFromPersonalListRequestShowsInner;
