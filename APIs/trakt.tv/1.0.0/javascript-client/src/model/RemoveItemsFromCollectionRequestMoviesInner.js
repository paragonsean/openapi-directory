...
/**
 * The RemoveItemsFromCollectionRequestMoviesInner model module.
 * @module model/RemoveItemsFromCollectionRequestMoviesInner
 * @version 1.0.0
 */
class RemoveItemsFromCollectionRequestMoviesInner {
    /**
     * Constructs a new <code>RemoveItemsFromCollectionRequestMoviesInner</code>.
     * @alias module:model/RemoveItemsFromCollectionRequestMoviesInner
     * @param ids {module:model/CheckIntoAnItemRequestMovieIds} 
     */
    constructor(ids) { 
        
        RemoveItemsFromCollectionRequestMoviesInner.initialize(this, ids);
    }
    ...
    /**
     * Constructs a <code>RemoveItemsFromCollectionRequestMoviesInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/RemoveItemsFromCollectionRequestMoviesInner} obj Optional instance to populate.
     * @return {module:model/RemoveItemsFromCollectionRequestMoviesInner} The populated <code>RemoveItemsFromCollectionRequestMoviesInner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RemoveItemsFromCollectionRequestMoviesInner();
    ...
    /**
     * Validates the JSON data with respect to <code>RemoveItemsFromCollectionRequestMoviesInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RemoveItemsFromCollectionRequestMoviesInner</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of RemoveItemsFromCollectionRequestMoviesInner.RequiredProperties) {
...
RemoveItemsFromCollectionRequestMoviesInner.RequiredProperties = ["ids"];

/**
 * @member {module:model/CheckIntoAnItemRequestMovieIds} ids
 */
RemoveItemsFromCollectionRequestMoviesInner.prototype['ids'] = undefined;

/**
 * @member {String} title
 */
RemoveItemsFromCollectionRequestMoviesInner.prototype['title'] = undefined;

/**
 * @member {Number} year
 */
RemoveItemsFromCollectionRequestMoviesInner.prototype['year'] = undefined;
...
export default RemoveItemsFromCollectionRequestMoviesInner;
