...
import AddNewRatingsRequestEpisodesInner from './AddNewRatingsRequestEpisodesInner';
import AddNewRatingsRequestMoviesInner from './AddNewRatingsRequestMoviesInner';
import AddNewRatingsRequestSeasonsInner from './AddNewRatingsRequestSeasonsInner';
import AddNewRatingsRequestShowsInner from './AddNewRatingsRequestShowsInner';

/**
 * The AddNewRatingsRequest model module.
 * @module model/AddNewRatingsRequest
 * @version 1.0.0
 */
class AddNewRatingsRequest {
    /**
     * Constructs a new <code>AddNewRatingsRequest</code>.
     * @alias module:model/AddNewRatingsRequest
     */
    constructor() { 
        
        AddNewRatingsRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>AddNewRatingsRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AddNewRatingsRequest} obj Optional instance to populate.
     * @return {module:model/AddNewRatingsRequest} The populated <code>AddNewRatingsRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AddNewRatingsRequest();

            if (data.hasOwnProperty('episodes')) {
                obj['episodes'] = ApiClient.convertToType(data['episodes'], [AddNewRatingsRequestEpisodesInner]);
            }
            if (data.hasOwnProperty('movies')) {
                obj['movies'] = ApiClient.convertToType(data['movies'], [AddNewRatingsRequestMoviesInner]);
            }
            if (data.hasOwnProperty('seasons')) {
                obj['seasons'] = ApiClient.convertToType(data['seasons'], [AddNewRatingsRequestSeasonsInner]);
            }
            if (data.hasOwnProperty('shows')) {
                obj['shows'] = ApiClient.convertToType(data['shows'], [AddNewRatingsRequestShowsInner]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>AddNewRatingsRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AddNewRatingsRequest</code>.
     */
    static validateJSON(data) {
        if (data['episodes']) { // data not null
            ...
            for (const item of data['episodes']) {
                AddNewRatingsRequestEpisodesInner.validateJSON(item);
            };
        }
        if (data['movies']) { // data not null
            ...
            for (const item of data['movies']) {
                AddNewRatingsRequestMoviesInner.validateJSON(item);
            };
        }
        if (data['seasons']) { // data not null
            ...
            for (const item of data['seasons']) {
                AddNewRatingsRequestSeasonsInner.validateJSON(item);
            };
        }
        if (data['shows']) { // data not null
            ...
            for (const item of data['shows']) {
                AddNewRatingsRequestShowsInner.validateJSON(item);
            };
        }
...
/**
 * @member {Array.<module:model/AddNewRatingsRequestEpisodesInner>} episodes
 */
AddNewRatingsRequest.prototype['episodes'] = undefined;

/**
 * @member {Array.<module:model/AddNewRatingsRequestMoviesInner>} movies
 */
AddNewRatingsRequest.prototype['movies'] = undefined;

/**
 * @member {Array.<module:model/AddNewRatingsRequestSeasonsInner>} seasons
 */
AddNewRatingsRequest.prototype['seasons'] = undefined;

/**
 * @member {Array.<module:model/AddNewRatingsRequestShowsInner>} shows
 */
AddNewRatingsRequest.prototype['shows'] = undefined;
...
export default AddNewRatingsRequest;
