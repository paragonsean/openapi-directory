...
import AddItemsToWatchedHistoryRequestShowsInnerSeasonsInnerEpisodesInner from './AddItemsToWatchedHistoryRequestShowsInnerSeasonsInnerEpisodesInner';

/**
 * The AddItemsToWatchedHistoryRequestShowsInnerSeasonsInner model module.
 * @module model/AddItemsToWatchedHistoryRequestShowsInnerSeasonsInner
 * @version 1.0.0
 */
class AddItemsToWatchedHistoryRequestShowsInnerSeasonsInner {
    /**
     * Constructs a new <code>AddItemsToWatchedHistoryRequestShowsInnerSeasonsInner</code>.
     * @alias module:model/AddItemsToWatchedHistoryRequestShowsInnerSeasonsInner
     * @param number {Number} 
     */
    constructor(number) { 
        
        AddItemsToWatchedHistoryRequestShowsInnerSeasonsInner.initialize(this, number);
    }
    ...
    /**
     * Constructs a <code>AddItemsToWatchedHistoryRequestShowsInnerSeasonsInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AddItemsToWatchedHistoryRequestShowsInnerSeasonsInner} obj Optional instance to populate.
     * @return {module:model/AddItemsToWatchedHistoryRequestShowsInnerSeasonsInner} The populated <code>AddItemsToWatchedHistoryRequestShowsInnerSeasonsInner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AddItemsToWatchedHistoryRequestShowsInnerSeasonsInner();

            if (data.hasOwnProperty('episodes')) {
                obj['episodes'] = ApiClient.convertToType(data['episodes'], [AddItemsToWatchedHistoryRequestShowsInnerSeasonsInnerEpisodesInner]);
            }
            if (data.hasOwnProperty('number')) {
                obj['number'] = ApiClient.convertToType(data['number'], 'Number');
            }
            if (data.hasOwnProperty('watched_at')) {
                obj['watched_at'] = ApiClient.convertToType(data['watched_at'], 'String');
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>AddItemsToWatchedHistoryRequestShowsInnerSeasonsInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AddItemsToWatchedHistoryRequestShowsInnerSeasonsInner</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of AddItemsToWatchedHistoryRequestShowsInnerSeasonsInner.RequiredProperties) {
        ...
        if (data['episodes']) { // data not null
            ...
            for (const item of data['episodes']) {
                AddItemsToWatchedHistoryRequestShowsInnerSeasonsInnerEpisodesInner.validateJSON(item);
            };
        }
        // ensure the json data is a string
        if (data['watched_at'] && !(typeof data['watched_at'] === 'string' || data['watched_at'] instanceof String)) {
            throw new Error("Expected the field `watched_at` to be a primitive type in the JSON string but got " + data['watched_at']);
        }
...
AddItemsToWatchedHistoryRequestShowsInnerSeasonsInner.RequiredProperties = ["number"];

/**
 * @member {Array.<module:model/AddItemsToWatchedHistoryRequestShowsInnerSeasonsInnerEpisodesInner>} episodes
 */
AddItemsToWatchedHistoryRequestShowsInnerSeasonsInner.prototype['episodes'] = undefined;

/**
 * @member {Number} number
 */
AddItemsToWatchedHistoryRequestShowsInnerSeasonsInner.prototype['number'] = undefined;

/**
 * @member {String} watched_at
 */
AddItemsToWatchedHistoryRequestShowsInnerSeasonsInner.prototype['watched_at'] = undefined;
...
export default AddItemsToWatchedHistoryRequestShowsInnerSeasonsInner;
