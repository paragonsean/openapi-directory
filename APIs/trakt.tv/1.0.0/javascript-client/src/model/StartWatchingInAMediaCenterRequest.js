...
/**
 * The StartWatchingInAMediaCenterRequest model module.
 * @module model/StartWatchingInAMediaCenterRequest
 * @version 1.0.0
 */
class StartWatchingInAMediaCenterRequest {
    /**
     * Constructs a new <code>StartWatchingInAMediaCenterRequest</code>.
     * @alias module:model/StartWatchingInAMediaCenterRequest
     */
    constructor() { 
        
        StartWatchingInAMediaCenterRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>StartWatchingInAMediaCenterRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/StartWatchingInAMediaCenterRequest} obj Optional instance to populate.
     * @return {module:model/StartWatchingInAMediaCenterRequest} The populated <code>StartWatchingInAMediaCenterRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new StartWatchingInAMediaCenterRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>StartWatchingInAMediaCenterRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>StartWatchingInAMediaCenterRequest</code>.
     */
 ...
 */
StartWatchingInAMediaCenterRequest.prototype['app_date'] = undefined;

/**
 * @member {String} app_version
 */
StartWatchingInAMediaCenterRequest.prototype['app_version'] = undefined;

/**
 * @member {module:model/CheckIntoAnItemRequestMovie} movie
 */
StartWatchingInAMediaCenterRequest.prototype['movie'] = undefined;

/**
 * @member {Number} progress
 */
StartWatchingInAMediaCenterRequest.prototype['progress'] = undefined;
...
export default StartWatchingInAMediaCenterRequest;
