...
/**
 * The CheckIntoAnItemRequestMovieIds model module.
 * @module model/CheckIntoAnItemRequestMovieIds
 * @version 1.0.0
 */
class CheckIntoAnItemRequestMovieIds {
    /**
     * Constructs a new <code>CheckIntoAnItemRequestMovieIds</code>.
     * @alias module:model/CheckIntoAnItemRequestMovieIds
     */
    constructor() { 
        
        CheckIntoAnItemRequestMovieIds.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CheckIntoAnItemRequestMovieIds</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CheckIntoAnItemRequestMovieIds} obj Optional instance to populate.
     * @return {module:model/CheckIntoAnItemRequestMovieIds} The populated <code>CheckIntoAnItemRequestMovieIds</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CheckIntoAnItemRequestMovieIds();
    ...
    /**
     * Validates the JSON data with respect to <code>CheckIntoAnItemRequestMovieIds</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CheckIntoAnItemRequestMovieIds</code>.
     */
 ...
 * @member {String} imdb
 */
CheckIntoAnItemRequestMovieIds.prototype['imdb'] = undefined;

/**
 * @member {String} slug
 */
CheckIntoAnItemRequestMovieIds.prototype['slug'] = undefined;

/**
 * @member {Number} tmdb
 */
CheckIntoAnItemRequestMovieIds.prototype['tmdb'] = undefined;

/**
 * @member {Number} trakt
 */
CheckIntoAnItemRequestMovieIds.prototype['trakt'] = undefined;
...
export default CheckIntoAnItemRequestMovieIds;
