...
/**
 * The AddItemsToPersonalRecommendationsRequestMoviesInner model module.
 * @module model/AddItemsToPersonalRecommendationsRequestMoviesInner
 * @version 1.0.0
 */
class AddItemsToPersonalRecommendationsRequestMoviesInner {
    /**
     * Constructs a new <code>AddItemsToPersonalRecommendationsRequestMoviesInner</code>.
     * @alias module:model/AddItemsToPersonalRecommendationsRequestMoviesInner
     * @param ids {module:model/CheckIntoAnItemRequestMovieIds} 
     */
    constructor(ids) { 
        
        AddItemsToPersonalRecommendationsRequestMoviesInner.initialize(this, ids);
    }
    ...
    /**
     * Constructs a <code>AddItemsToPersonalRecommendationsRequestMoviesInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AddItemsToPersonalRecommendationsRequestMoviesInner} obj Optional instance to populate.
     * @return {module:model/AddItemsToPersonalRecommendationsRequestMoviesInner} The populated <code>AddItemsToPersonalRecommendationsRequestMoviesInner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AddItemsToPersonalRecommendationsRequestMoviesInner();
    ...
    /**
     * Validates the JSON data with respect to <code>AddItemsToPersonalRecommendationsRequestMoviesInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AddItemsToPersonalRecommendationsRequestMoviesInner</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of AddItemsToPersonalRecommendationsRequestMoviesInner.RequiredProperties) {
...
AddItemsToPersonalRecommendationsRequestMoviesInner.RequiredProperties = ["ids"];

/**
 * @member {module:model/CheckIntoAnItemRequestMovieIds} ids
 */
AddItemsToPersonalRecommendationsRequestMoviesInner.prototype['ids'] = undefined;

/**
 * @member {String} notes
 */
AddItemsToPersonalRecommendationsRequestMoviesInner.prototype['notes'] = undefined;

/**
 * @member {String} title
 */
AddItemsToPersonalRecommendationsRequestMoviesInner.prototype['title'] = undefined;

/**
 * @member {Number} year
 */
AddItemsToPersonalRecommendationsRequestMoviesInner.prototype['year'] = undefined;
...
export default AddItemsToPersonalRecommendationsRequestMoviesInner;
