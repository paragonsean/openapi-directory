...
import AddItemsToCollectionRequestMoviesInner from './AddItemsToCollectionRequestMoviesInner';
import AddItemsToCollectionRequestSeasonsInner from './AddItemsToCollectionRequestSeasonsInner';
import AddItemsToCollectionRequestShowsInner from './AddItemsToCollectionRequestShowsInner';

/**
 * The AddItemsToCollectionRequest model module.
 * @module model/AddItemsToCollectionRequest
 * @version 1.0.0
 */
class AddItemsToCollectionRequest {
    /**
     * Constructs a new <code>AddItemsToCollectionRequest</code>.
     * @alias module:model/AddItemsToCollectionRequest
     */
    constructor() { 
        
        AddItemsToCollectionRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>AddItemsToCollectionRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AddItemsToCollectionRequest} obj Optional instance to populate.
     * @return {module:model/AddItemsToCollectionRequest} The populated <code>AddItemsToCollectionRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AddItemsToCollectionRequest();
            ...
            if (data.hasOwnProperty('movies')) {
                obj['movies'] = ApiClient.convertToType(data['movies'], [AddItemsToCollectionRequestMoviesInner]);
            }
            ...
            if (data.hasOwnProperty('shows')) {
                obj['shows'] = ApiClient.convertToType(data['shows'], [AddItemsToCollectionRequestShowsInner]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>AddItemsToCollectionRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AddItemsToCollectionRequest</code>.
     */
    static validateJSON(data) {
        ...
        if (data['movies']) { // data not null
            ...
            for (const item of data['movies']) {
                AddItemsToCollectionRequestMoviesInner.validateJSON(item);
            };
        }
        ...
        if (data['shows']) { // data not null
            ...
            for (const item of data['shows']) {
                AddItemsToCollectionRequestShowsInner.validateJSON(item);
            };
        }
 ...
 */
AddItemsToCollectionRequest.prototype['episodes'] = undefined;

/**
 * @member {Array.<module:model/AddItemsToCollectionRequestMoviesInner>} movies
 */
AddItemsToCollectionRequest.prototype['movies'] = undefined;

/**
 * @member {Array.<module:model/AddItemsToCollectionRequestSeasonsInner>} seasons
 */
AddItemsToCollectionRequest.prototype['seasons'] = undefined;

/**
 * @member {Array.<module:model/AddItemsToCollectionRequestShowsInner>} shows
 */
AddItemsToCollectionRequest.prototype['shows'] = undefined;
...
export default AddItemsToCollectionRequest;
