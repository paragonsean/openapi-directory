...
import AddItemsToCollectionRequestEpisodesInner from './AddItemsToCollectionRequestEpisodesInner';
import AddItemsToCollectionRequestSeasonsInner from './AddItemsToCollectionRequestSeasonsInner';
import AddItemsToPersonalListRequestMoviesInner from './AddItemsToPersonalListRequestMoviesInner';
import AddItemsToPersonalListRequestPeopleInner from './AddItemsToPersonalListRequestPeopleInner';
import AddItemsToPersonalListRequestShowsInner from './AddItemsToPersonalListRequestShowsInner';

/**
 * The AddItemsToPersonalListRequest model module.
 * @module model/AddItemsToPersonalListRequest
 * @version 1.0.0
 */
class AddItemsToPersonalListRequest {
    /**
     * Constructs a new <code>AddItemsToPersonalListRequest</code>.
     * @alias module:model/AddItemsToPersonalListRequest
     */
    constructor() { 
        
        AddItemsToPersonalListRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>AddItemsToPersonalListRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AddItemsToPersonalListRequest} obj Optional instance to populate.
     * @return {module:model/AddItemsToPersonalListRequest} The populated <code>AddItemsToPersonalListRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AddItemsToPersonalListRequest();

            if (data.hasOwnProperty('episodes')) {
                obj['episodes'] = ApiClient.convertToType(data['episodes'], [AddItemsToCollectionRequestEpisodesInner]);
            }
            if (data.hasOwnProperty('movies')) {
                obj['movies'] = ApiClient.convertToType(data['movies'], [AddItemsToPersonalListRequestMoviesInner]);
            }
            if (data.hasOwnProperty('people')) {
                obj['people'] = ApiClient.convertToType(data['people'], [AddItemsToPersonalListRequestPeopleInner]);
            }
            if (data.hasOwnProperty('seasons')) {
                obj['seasons'] = ApiClient.convertToType(data['seasons'], [AddItemsToCollectionRequestSeasonsInner]);
            }
            if (data.hasOwnProperty('shows')) {
                obj['shows'] = ApiClient.convertToType(data['shows'], [AddItemsToPersonalListRequestShowsInner]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>AddItemsToPersonalListRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AddItemsToPersonalListRequest</code>.
     */
    static validateJSON(data) {
        if (data['episodes']) { // data not null
            ...
            for (const item of data['episodes']) {
                AddItemsToCollectionRequestEpisodesInner.validateJSON(item);
            };
        }
        if (data['movies']) { // data not null
            // ensure the json data is an array
            if (!Array.isArray(data['movies'])) {
                throw new Error("Expected the field `movies` to be an array in the JSON data but got " + data['movies']);
            }
            // validate the optional field `movies` (array)
            for (const item of data['movies']) {
                AddItemsToPersonalListRequestMoviesInner.validateJSON(item);
            };
        }
        if (data['people']) { // data not null
            ...
            for (const item of data['people']) {
                AddItemsToPersonalListRequestPeopleInner.validateJSON(item);
            };
        }
        if (data['seasons']) { // data not null
            ...
            for (const item of data['seasons']) {
                AddItemsToCollectionRequestSeasonsInner.validateJSON(item);
            };
        }
        if (data['shows']) { // data not null
            ...
            for (const item of data['shows']) {
                AddItemsToPersonalListRequestShowsInner.validateJSON(item);
            };
        }
...
/**
 * @member {Array.<module:model/AddItemsToCollectionRequestEpisodesInner>} episodes
 */
AddItemsToPersonalListRequest.prototype['episodes'] = undefined;

/**
 * @member {Array.<module:model/AddItemsToPersonalListRequestMoviesInner>} movies
 */
AddItemsToPersonalListRequest.prototype['movies'] = undefined;

/**
 * @member {Array.<module:model/AddItemsToPersonalListRequestPeopleInner>} people
 */
AddItemsToPersonalListRequest.prototype['people'] = undefined;

/**
 * @member {Array.<module:model/AddItemsToCollectionRequestSeasonsInner>} seasons
 */
AddItemsToPersonalListRequest.prototype['seasons'] = undefined;

/**
 * @member {Array.<module:model/AddItemsToPersonalListRequestShowsInner>} shows
 */
AddItemsToPersonalListRequest.prototype['shows'] = undefined;
...
export default AddItemsToPersonalListRequest;
