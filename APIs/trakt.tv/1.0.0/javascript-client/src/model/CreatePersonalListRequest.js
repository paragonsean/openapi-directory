...
/**
 * The CreatePersonalListRequest model module.
 * @module model/CreatePersonalListRequest
 * @version 1.0.0
 */
class CreatePersonalListRequest {
    /**
     * Constructs a new <code>CreatePersonalListRequest</code>.
     * @alias module:model/CreatePersonalListRequest
     */
    constructor() { 
        
        CreatePersonalListRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CreatePersonalListRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreatePersonalListRequest} obj Optional instance to populate.
     * @return {module:model/CreatePersonalListRequest} The populated <code>CreatePersonalListRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreatePersonalListRequest();

            if (data.hasOwnProperty('allow_comments')) {
                obj['allow_comments'] = ApiClient.convertToType(data['allow_comments'], 'Boolean');
            }
            if (data.hasOwnProperty('description')) {
                obj['description'] = ApiClient.convertToType(data['description'], 'String');
            }
            if (data.hasOwnProperty('display_numbers')) {
                obj['display_numbers'] = ApiClient.convertToType(data['display_numbers'], 'Boolean');
            }
            ...
            if (data.hasOwnProperty('sort_how')) {
                obj['sort_how'] = ApiClient.convertToType(data['sort_how'], 'String');
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>CreatePersonalListRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreatePersonalListRequest</code>.
     */
    static validateJSON(data) {
        ...
        // ensure the json data is a string
        if (data['sort_how'] && !(typeof data['sort_how'] === 'string' || data['sort_how'] instanceof String)) {
            throw new Error("Expected the field `sort_how` to be a primitive type in the JSON string but got " + data['sort_how']);
        }
 ...
 */
CreatePersonalListRequest.prototype['allow_comments'] = undefined;

/**
 * @member {String} description
 */
CreatePersonalListRequest.prototype['description'] = undefined;

/**
 * @member {Boolean} display_numbers
 */
CreatePersonalListRequest.prototype['display_numbers'] = undefined;

/**
 * @member {String} name
 */
CreatePersonalListRequest.prototype['name'] = undefined;

/**
 * @member {String} privacy
 */
CreatePersonalListRequest.prototype['privacy'] = undefined;

/**
 * @member {String} sort_by
 */
CreatePersonalListRequest.prototype['sort_by'] = undefined;

/**
 * @member {String} sort_how
 */
CreatePersonalListRequest.prototype['sort_how'] = undefined;
...
export default CreatePersonalListRequest;
