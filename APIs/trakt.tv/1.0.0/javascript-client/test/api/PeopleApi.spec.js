...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TraktApi.PeopleApi();
  });
  ...
  describe('PeopleApi', function() {
    describe('getASinglePerson', function() {
      it('should call getASinglePerson successfully', function(done) {
        //uncomment below and update the code to test getASinglePerson
        //instance.getASinglePerson(function(error) {
    ...
    describe('getListsContainingThisPerson', function() {
      it('should call getListsContainingThisPerson successfully', function(done) {
        //uncomment below and update the code to test getListsContainingThisPerson
        //instance.getListsContainingThisPerson(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('getMovieCredits', function() {
      it('should call getMovieCredits successfully', function(done) {
        //uncomment below and update the code to test getMovieCredits
        //instance.getMovieCredits(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('getRecentlyUpdatedPeople', function() {
      it('should call getRecentlyUpdatedPeople successfully', function(done) {
        //uncomment below and update the code to test getRecentlyUpdatedPeople
        //instance.getRecentlyUpdatedPeople(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('getRecentlyUpdatedPeopleTraktIDs', function() {
      it('should call getRecentlyUpdatedPeopleTraktIDs successfully', function(done) {
        //uncomment below and update the code to test getRecentlyUpdatedPeopleTraktIDs
        //instance.getRecentlyUpdatedPeopleTraktIDs(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('getShowCredits', function() {
      it('should call getShowCredits successfully', function(done) {
        //uncomment below and update the code to test getShowCredits
        //instance.getShowCredits(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
