...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TraktApi.SeasonsApi();
  });
  ...
  describe('SeasonsApi', function() {
    describe('getAllPeopleForASeason', function() {
      it('should call getAllPeopleForASeason successfully', function(done) {
        //uncomment below and update the code to test getAllPeopleForASeason
        //instance.getAllPeopleForASeason(function(error) {
    ...
    describe('getAllSeasonComments', function() {
      it('should call getAllSeasonComments successfully', function(done) {
        //uncomment below and update the code to test getAllSeasonComments
        //instance.getAllSeasonComments(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('getAllSeasonTranslations', function() {
      it('should call getAllSeasonTranslations successfully', function(done) {
        //uncomment below and update the code to test getAllSeasonTranslations
        //instance.getAllSeasonTranslations(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('getAllSeasonsForAShow', function() {
      it('should call getAllSeasonsForAShow successfully', function(done) {
        //uncomment below and update the code to test getAllSeasonsForAShow
        //instance.getAllSeasonsForAShow(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('getListsContainingThisSeason', function() {
      it('should call getListsContainingThisSeason successfully', function(done) {
        //uncomment below and update the code to test getListsContainingThisSeason
        //instance.getListsContainingThisSeason(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('getSeasonRatings', function() {
      it('should call getSeasonRatings successfully', function(done) {
        //uncomment below and update the code to test getSeasonRatings
        //instance.getSeasonRatings(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('getSeasonStats', function() {
      it('should call getSeasonStats successfully', function(done) {
        //uncomment below and update the code to test getSeasonStats
        //instance.getSeasonStats(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('getSingleSeasonForAShow', function() {
      it('should call getSingleSeasonForAShow successfully', function(done) {
        //uncomment below and update the code to test getSingleSeasonForAShow
        //instance.getSingleSeasonForAShow(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('showsIdSeasonsSeasonWatchingGet', function() {
      it('should call showsIdSeasonsSeasonWatchingGet successfully', function(done) {
        //uncomment below and update the code to test showsIdSeasonsSeasonWatchingGet
        //instance.showsIdSeasonsSeasonWatchingGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
