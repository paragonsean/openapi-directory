...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TraktApi.EpisodesApi();
  });
  ...
  describe('EpisodesApi', function() {
    describe('getASingleEpisodeForAShow', function() {
      it('should call getASingleEpisodeForAShow successfully', function(done) {
        //uncomment below and update the code to test getASingleEpisodeForAShow
        //instance.getASingleEpisodeForAShow(function(error) {
    ...
    describe('getAllEpisodeComments', function() {
      it('should call getAllEpisodeComments successfully', function(done) {
        //uncomment below and update the code to test getAllEpisodeComments
        //instance.getAllEpisodeComments(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('getAllEpisodeTranslations', function() {
      it('should call getAllEpisodeTranslations successfully', function(done) {
        //uncomment below and update the code to test getAllEpisodeTranslations
        //instance.getAllEpisodeTranslations(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('getAllPeopleForAnEpisode', function() {
      it('should call getAllPeopleForAnEpisode successfully', function(done) {
        //uncomment below and update the code to test getAllPeopleForAnEpisode
        //instance.getAllPeopleForAnEpisode(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('getEpisodeRatings', function() {
      it('should call getEpisodeRatings successfully', function(done) {
        //uncomment below and update the code to test getEpisodeRatings
        //instance.getEpisodeRatings(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('getEpisodeStats', function() {
      it('should call getEpisodeStats successfully', function(done) {
        //uncomment below and update the code to test getEpisodeStats
        //instance.getEpisodeStats(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('getListsContainingThisEpisode', function() {
      it('should call getListsContainingThisEpisode successfully', function(done) {
        //uncomment below and update the code to test getListsContainingThisEpisode
        //instance.getListsContainingThisEpisode(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('showsIdSeasonsSeasonEpisodesEpisodeWatchingGet', function() {
      it('should call showsIdSeasonsSeasonEpisodesEpisodeWatchingGet successfully', function(done) {
        //uncomment below and update the code to test showsIdSeasonsSeasonEpisodesEpisodeWatchingGet
        //instance.showsIdSeasonsSeasonEpisodesEpisodeWatchingGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
