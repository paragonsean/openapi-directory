...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TraktApi.ListsApi();
  });
  ...
  describe('ListsApi', function() {
    describe('getAllListComments', function() {
      it('should call getAllListComments successfully', function(done) {
        //uncomment below and update the code to test getAllListComments
        //instance.getAllListComments(function(error) {
    ...
    describe('getAllUsersWhoLikedAList', function() {
      it('should call getAllUsersWhoLikedAList successfully', function(done) {
        //uncomment below and update the code to test getAllUsersWhoLikedAList
        //instance.getAllUsersWhoLikedAList(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('getItemsOnAList', function() {
      it('should call getItemsOnAList successfully', function(done) {
        //uncomment below and update the code to test getItemsOnAList
        //instance.getItemsOnAList(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('getPopularLists', function() {
      it('should call getPopularLists successfully', function(done) {
        //uncomment below and update the code to test getPopularLists
        //instance.getPopularLists(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('getTrendingLists', function() {
      it('should call getTrendingLists successfully', function(done) {
        //uncomment below and update the code to test getTrendingLists
        //instance.getTrendingLists(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
