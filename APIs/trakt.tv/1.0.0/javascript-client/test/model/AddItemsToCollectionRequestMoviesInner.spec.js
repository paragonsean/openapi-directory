...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TraktApi.AddItemsToCollectionRequestMoviesInner();
  });
  ...
  describe('AddItemsToCollectionRequestMoviesInner', function() {
    it('should create an instance of AddItemsToCollectionRequestMoviesInner', function() {
      // uncomment below and update the code to test AddItemsToCollectionRequestMoviesInner
      //var instance = new TraktApi.AddItemsToCollectionRequestMoviesInner();
      //expect(instance).to.be.a(TraktApi.AddItemsToCollectionRequestMoviesInner);
    });
    ...
    it('should have the property audioChannels (base name: "audio_channels")', function() {
      // uncomment below and update the code to test the property audioChannels
      //var instance = new TraktApi.AddItemsToCollectionRequestMoviesInner();
      //expect(instance).to.be();
    });

    it('should have the property collectedAt (base name: "collected_at")', function() {
      // uncomment below and update the code to test the property collectedAt
      //var instance = new TraktApi.AddItemsToCollectionRequestMoviesInner();
      //expect(instance).to.be();
    });
