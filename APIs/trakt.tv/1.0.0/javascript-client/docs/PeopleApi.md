...
let apiInstance = new TraktApi.PeopleApi();
let id = "bryan-cranston"; // String | Trakt ID, Trakt slug, or IMDB ID
let opts = {
  'traktApiVersion': "2", // String | e.g. 2
  'traktApiKey': "[client_id]" // String | e.g. [client_id]
};
apiInstance.getASinglePerson(id, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
> getListsContainingThisPerson(id, type, sort, opts)
...
apiInstance.getListsContainingThisPerson(id, type, sort, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully.');
...
apiInstance.getMovieCredits(id, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully.');
...
> getRecentlyUpdatedPeople(startDate, opts)
...
apiInstance.getRecentlyUpdatedPeople(startDate, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully.');
...
> getRecentlyUpdatedPeopleTraktIDs(startDate, opts)
...
apiInstance.getRecentlyUpdatedPeopleTraktIDs(startDate, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully.');
...
apiInstance.getShowCredits(id, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully.');
