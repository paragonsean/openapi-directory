# TraktApi.AuthenticationDevicesApi
...
let apiInstance = new TraktApi.AuthenticationDevicesApi();
let opts = {
  'generateNewDeviceCodesRequest': new TraktApi.GenerateNewDeviceCodesRequest() // GenerateNewDeviceCodesRequest | 
};
apiInstance.generateNewDeviceCodes(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
let apiInstance = new TraktApi.AuthenticationDevicesApi();
let opts = {
  'pollForTheAccessTokenRequest': new TraktApi.PollForTheAccessTokenRequest() // PollForTheAccessTokenRequest | 
};
apiInstance.pollForTheAccessToken(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully.');
