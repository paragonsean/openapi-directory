...
#include <iostream>
#include "../client/OAIAuthenticationDevicesApi.h"

using namespace test_namespace;

class Example : public QObject {
    Q_OBJECT
    OAIGenerate_new_device_codes_request create();
public Q_SLOTS:
...
OAIGenerate_new_device_codes_request Example::create(){
    OAIGenerate_new_device_codes_request obj;
 return obj;
}

void Example::exampleFunction1(){
     OAIAuthenticationDevicesApi apiInstance;
     
      QEventLoop loop;
      connect(&apiInstance, &OAIAuthenticationDevicesApi::generate_new_device_codesSignal, [&]() {
          loop.quit();
      });
      connect(&apiInstance, &OAIAuthenticationDevicesApi::generate_new_device_codesSignalE, [&](QNetworkReply::NetworkError, QString error_str) {
          qDebug() << "Error happened while issuing request : " << error_str;
          loop.quit();
      });

      OAIGenerate_new_device_codes_request oai_generate_new_device_codes_request = create(); // OAIGenerate_new_device_codes_request | 
      apiInstance.generate_new_device_codes(oai_generate_new_device_codes_request);
