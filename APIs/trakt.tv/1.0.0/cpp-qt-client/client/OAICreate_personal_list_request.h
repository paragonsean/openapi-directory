...
/*
 * OAICreate_personal_list_request.h
 *
 * 
 */

#ifndef OAICreate_personal_list_request_H
#define OAICreate_personal_list_request_H
...
class OAICreate_personal_list_request : public OAIObject {
public:
    OAICreate_personal_list_request();
    OAICreate_personal_list_request(QString json);
    ~OAICreate_personal_list_request() override;
    ...
    bool isDisplayNumbers() const;
    void setDisplayNumbers(const bool &display_numbers);
    bool is_display_numbers_Set() const;
    bool is_display_numbers_Valid() const;
    ...
    QString getSortHow() const;
    void setSortHow(const QString &sort_how);
    bool is_sort_how_Set() const;
    bool is_sort_how_Valid() const;
...
private:
    ...
    bool m_display_numbers;
    bool m_display_numbers_isSet;
    bool m_display_numbers_isValid;
    ...
    QString m_sort_how;
    bool m_sort_how_isSet;
    bool m_sort_how_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAICreate_personal_list_request)

#endif // OAICreate_personal_list_request_H
