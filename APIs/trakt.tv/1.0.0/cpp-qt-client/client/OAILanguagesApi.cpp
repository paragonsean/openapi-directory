...
void OAILanguagesApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("get_languages", defaultConf);
    _serverIndices.insert("get_languages", 0);
}
...
void OAILanguagesApi::get_languages(const QString &type, const ::OpenAPI::OptionalParam<QString> &trakt_api_version, const ::OpenAPI::OptionalParam<QString> &trakt_api_key) {
    QString fullPath = QString(_serverConfigs["get_languages"][_serverIndices.value("get_languages")].URL()+"/languages/{type}");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAILanguagesApi::get_languagesCallback);
...
void OAILanguagesApi::get_languagesCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT get_languagesSignal();
        Q_EMIT get_languagesSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT get_languagesSignalE(error_type, error_str);
        Q_EMIT get_languagesSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT get_languagesSignalError(error_type, error_str);
        Q_EMIT get_languagesSignalErrorFull(worker, error_type, error_str);
    }
}
