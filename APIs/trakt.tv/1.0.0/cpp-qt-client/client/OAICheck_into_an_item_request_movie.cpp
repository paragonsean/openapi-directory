...
#include "OAICheck_into_an_item_request_movie.h"
...
OAICheck_into_an_item_request_movie::OAICheck_into_an_item_request_movie(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICheck_into_an_item_request_movie::OAICheck_into_an_item_request_movie() {
    this->initializeModel();
}

OAICheck_into_an_item_request_movie::~OAICheck_into_an_item_request_movie() {}

void OAICheck_into_an_item_request_movie::initializeModel() {
...
void OAICheck_into_an_item_request_movie::fromJson(QString jsonString) {
...
void OAICheck_into_an_item_request_movie::fromJsonObject(QJsonObject json) {
...
QString OAICheck_into_an_item_request_movie::asJson() const {
...
QJsonObject OAICheck_into_an_item_request_movie::asJsonObject() const {
    QJsonObject obj;
    if (m_ids.isSet()) {
...
OAICheck_into_an_item_request_movie_ids OAICheck_into_an_item_request_movie::getIds() const {
    return m_ids;
}
void OAICheck_into_an_item_request_movie::setIds(const OAICheck_into_an_item_request_movie_ids &ids) {
    m_ids = ids;
    m_ids_isSet = true;
}

bool OAICheck_into_an_item_request_movie::is_ids_Set() const{
    return m_ids_isSet;
}

bool OAICheck_into_an_item_request_movie::is_ids_Valid() const{
    return m_ids_isValid;
}

QString OAICheck_into_an_item_request_movie::getTitle() const {
    return m_title;
}
void OAICheck_into_an_item_request_movie::setTitle(const QString &title) {
    m_title = title;
    m_title_isSet = true;
}

bool OAICheck_into_an_item_request_movie::is_title_Set() const{
    return m_title_isSet;
}

bool OAICheck_into_an_item_request_movie::is_title_Valid() const{
    return m_title_isValid;
}

double OAICheck_into_an_item_request_movie::getYear() const {
    return m_year;
}
void OAICheck_into_an_item_request_movie::setYear(const double &year) {
    m_year = year;
    m_year_isSet = true;
}

bool OAICheck_into_an_item_request_movie::is_year_Set() const{
    return m_year_isSet;
}

bool OAICheck_into_an_item_request_movie::is_year_Valid() const{
    return m_year_isValid;
}

bool OAICheck_into_an_item_request_movie::isSet() const {
...
bool OAICheck_into_an_item_request_movie::isValid() const {
