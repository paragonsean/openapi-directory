...
#include "OAIAdd_items_to_personal_list_request_shows_inner.h"
...
OAIAdd_items_to_personal_list_request_shows_inner::OAIAdd_items_to_personal_list_request_shows_inner(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAdd_items_to_personal_list_request_shows_inner::OAIAdd_items_to_personal_list_request_shows_inner() {
    this->initializeModel();
}

OAIAdd_items_to_personal_list_request_shows_inner::~OAIAdd_items_to_personal_list_request_shows_inner() {}

void OAIAdd_items_to_personal_list_request_shows_inner::initializeModel() {
...
void OAIAdd_items_to_personal_list_request_shows_inner::fromJson(QString jsonString) {
...
void OAIAdd_items_to_personal_list_request_shows_inner::fromJsonObject(QJsonObject json) {
...
QString OAIAdd_items_to_personal_list_request_shows_inner::asJson() const {
...
QJsonObject OAIAdd_items_to_personal_list_request_shows_inner::asJsonObject() const {
    QJsonObject obj;
    if (m_ids.isSet()) {
...
OAIAdd_hidden_items_request_seasons_inner_ids OAIAdd_items_to_personal_list_request_shows_inner::getIds() const {
    return m_ids;
}
void OAIAdd_items_to_personal_list_request_shows_inner::setIds(const OAIAdd_hidden_items_request_seasons_inner_ids &ids) {
    m_ids = ids;
    m_ids_isSet = true;
}

bool OAIAdd_items_to_personal_list_request_shows_inner::is_ids_Set() const{
    return m_ids_isSet;
}

bool OAIAdd_items_to_personal_list_request_shows_inner::is_ids_Valid() const{
    return m_ids_isValid;
}

QString OAIAdd_items_to_personal_list_request_shows_inner::getNotes() const {
    return m_notes;
}
void OAIAdd_items_to_personal_list_request_shows_inner::setNotes(const QString &notes) {
    m_notes = notes;
    m_notes_isSet = true;
}

bool OAIAdd_items_to_personal_list_request_shows_inner::is_notes_Set() const{
    return m_notes_isSet;
}

bool OAIAdd_items_to_personal_list_request_shows_inner::is_notes_Valid() const{
    return m_notes_isValid;
}

QList<OAIRemove_items_from_collection_request_shows_inner_seasons_inner> OAIAdd_items_to_personal_list_request_shows_inner::getSeasons() const {
    return m_seasons;
}
void OAIAdd_items_to_personal_list_request_shows_inner::setSeasons(const QList<OAIRemove_items_from_collection_request_shows_inner_seasons_inner> &seasons) {
    m_seasons = seasons;
    m_seasons_isSet = true;
}

bool OAIAdd_items_to_personal_list_request_shows_inner::is_seasons_Set() const{
    return m_seasons_isSet;
}

bool OAIAdd_items_to_personal_list_request_shows_inner::is_seasons_Valid() const{
    return m_seasons_isValid;
}

bool OAIAdd_items_to_personal_list_request_shows_inner::isSet() const {
...
bool OAIAdd_items_to_personal_list_request_shows_inner::isValid() const {
