...
OAISeasonsApi::OAISeasonsApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAISeasonsApi::~OAISeasonsApi() {
}

void OAISeasonsApi::initializeServerConfigs() {
    //Default server
    ...
    _serverConfigs.insert("get_all_people_for_a_season", defaultConf);
    _serverIndices.insert("get_all_people_for_a_season", 0);
    _serverConfigs.insert("get_all_season_comments", defaultConf);
    _serverIndices.insert("get_all_season_comments", 0);
    _serverConfigs.insert("get_all_season_translations", defaultConf);
    _serverIndices.insert("get_all_season_translations", 0);
    _serverConfigs.insert("get_all_seasons_for_a_show", defaultConf);
    _serverIndices.insert("get_all_seasons_for_a_show", 0);
    _serverConfigs.insert("get_lists_containing_this_season", defaultConf);
    _serverIndices.insert("get_lists_containing_this_season", 0);
    _serverConfigs.insert("get_season_ratings", defaultConf);
    _serverIndices.insert("get_season_ratings", 0);
    _serverConfigs.insert("get_season_stats", defaultConf);
    _serverIndices.insert("get_season_stats", 0);
    _serverConfigs.insert("get_single_season_for_a_show", defaultConf);
    _serverIndices.insert("get_single_season_for_a_show", 0);
    _serverConfigs.insert("showsIdSeasonsSeasonWatchingGet", defaultConf);
    _serverIndices.insert("showsIdSeasonsSeasonWatchingGet", 0);
}
...
*/
int OAISeasonsApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAISeasonsApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAISeasonsApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAISeasonsApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAISeasonsApi::setUsername(const QString &username) {
    _username = username;
}

void OAISeasonsApi::setPassword(const QString &password) {
    _password = password;
}


void OAISeasonsApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAISeasonsApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAISeasonsApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAISeasonsApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAISeasonsApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAISeasonsApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAISeasonsApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAISeasonsApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAISeasonsApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAISeasonsApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAISeasonsApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAISeasonsApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAISeasonsApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAISeasonsApi::get_all_people_for_a_season(const QString &id, const qint32 &season, const ::OpenAPI::OptionalParam<QString> &trakt_api_version, const ::OpenAPI::OptionalParam<QString> &trakt_api_key) {
    QString fullPath = QString(_serverConfigs["get_all_people_for_a_season"][_serverIndices.value("get_all_people_for_a_season")].URL()+"/shows/{id}/seasons/{season}/people");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAISeasonsApi::get_all_people_for_a_seasonCallback);
    connect(this, &OAISeasonsApi::abortRequestsSignal, worker, &QObject::deleteLater);
...
void OAISeasonsApi::get_all_people_for_a_seasonCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT get_all_people_for_a_seasonSignal();
        Q_EMIT get_all_people_for_a_seasonSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT get_all_people_for_a_seasonSignalE(error_type, error_str);
        Q_EMIT get_all_people_for_a_seasonSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT get_all_people_for_a_seasonSignalError(error_type, error_str);
        Q_EMIT get_all_people_for_a_seasonSignalErrorFull(worker, error_type, error_str);
    }
}

void OAISeasonsApi::get_all_season_comments(const QString &id, const qint32 &season, const QString &sort, const ::OpenAPI::OptionalParam<QString> &trakt_api_version, const ::OpenAPI::OptionalParam<QString> &trakt_api_key) {
    QString fullPath = QString(_serverConfigs["get_all_season_comments"][_serverIndices.value("get_all_season_comments")].URL()+"/shows/{id}/seasons/{season}/comments/{sort}");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAISeasonsApi::get_all_season_commentsCallback);
    connect(this, &OAISeasonsApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAISeasonsApi::get_all_season_commentsCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT get_all_season_commentsSignal();
        Q_EMIT get_all_season_commentsSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT get_all_season_commentsSignalE(error_type, error_str);
        Q_EMIT get_all_season_commentsSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT get_all_season_commentsSignalError(error_type, error_str);
        Q_EMIT get_all_season_commentsSignalErrorFull(worker, error_type, error_str);
    }
}

void OAISeasonsApi::get_all_season_translations(const QString &id, const qint32 &season, const QString &language, const ::OpenAPI::OptionalParam<QString> &trakt_api_version, const ::OpenAPI::OptionalParam<QString> &trakt_api_key) {
    QString fullPath = QString(_serverConfigs["get_all_season_translations"][_serverIndices.value("get_all_season_translations")].URL()+"/shows/{id}/seasons/{season}/translations/{language}");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAISeasonsApi::get_all_season_translationsCallback);
    connect(this, &OAISeasonsApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAISeasonsApi::get_all_season_translationsCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT get_all_season_translationsSignal();
        Q_EMIT get_all_season_translationsSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT get_all_season_translationsSignalE(error_type, error_str);
        Q_EMIT get_all_season_translationsSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT get_all_season_translationsSignalError(error_type, error_str);
        Q_EMIT get_all_season_translationsSignalErrorFull(worker, error_type, error_str);
    }
}

void OAISeasonsApi::get_all_seasons_for_a_show(const QString &id, const ::OpenAPI::OptionalParam<QString> &trakt_api_version, const ::OpenAPI::OptionalParam<QString> &trakt_api_key) {
    QString fullPath = QString(_serverConfigs["get_all_seasons_for_a_show"][_serverIndices.value("get_all_seasons_for_a_show")].URL()+"/shows/{id}/seasons");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAISeasonsApi::get_all_seasons_for_a_showCallback);
    connect(this, &OAISeasonsApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAISeasonsApi::get_all_seasons_for_a_showCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT get_all_seasons_for_a_showSignal();
        Q_EMIT get_all_seasons_for_a_showSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT get_all_seasons_for_a_showSignalE(error_type, error_str);
        Q_EMIT get_all_seasons_for_a_showSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT get_all_seasons_for_a_showSignalError(error_type, error_str);
        Q_EMIT get_all_seasons_for_a_showSignalErrorFull(worker, error_type, error_str);
    }
}

void OAISeasonsApi::get_lists_containing_this_season(const QString &id, const qint32 &season, const QString &type, const QString &sort, const ::OpenAPI::OptionalParam<QString> &trakt_api_version, const ::OpenAPI::OptionalParam<QString> &trakt_api_key) {
    QString fullPath = QString(_serverConfigs["get_lists_containing_this_season"][_serverIndices.value("get_lists_containing_this_season")].URL()+"/shows/{id}/seasons/{season}/lists/{type}/{sort}");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAISeasonsApi::get_lists_containing_this_seasonCallback);
    connect(this, &OAISeasonsApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAISeasonsApi::get_lists_containing_this_seasonCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT get_lists_containing_this_seasonSignal();
        Q_EMIT get_lists_containing_this_seasonSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT get_lists_containing_this_seasonSignalE(error_type, error_str);
        Q_EMIT get_lists_containing_this_seasonSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT get_lists_containing_this_seasonSignalError(error_type, error_str);
        Q_EMIT get_lists_containing_this_seasonSignalErrorFull(worker, error_type, error_str);
    }
}

void OAISeasonsApi::get_season_ratings(const QString &id, const qint32 &season, const ::OpenAPI::OptionalParam<QString> &trakt_api_version, const ::OpenAPI::OptionalParam<QString> &trakt_api_key) {
    QString fullPath = QString(_serverConfigs["get_season_ratings"][_serverIndices.value("get_season_ratings")].URL()+"/shows/{id}/seasons/{season}/ratings");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAISeasonsApi::get_season_ratingsCallback);
    connect(this, &OAISeasonsApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAISeasonsApi::get_season_ratingsCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT get_season_ratingsSignal();
        Q_EMIT get_season_ratingsSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT get_season_ratingsSignalE(error_type, error_str);
        Q_EMIT get_season_ratingsSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT get_season_ratingsSignalError(error_type, error_str);
        Q_EMIT get_season_ratingsSignalErrorFull(worker, error_type, error_str);
    }
}

void OAISeasonsApi::get_season_stats(const QString &id, const qint32 &season, const ::OpenAPI::OptionalParam<QString> &trakt_api_version, const ::OpenAPI::OptionalParam<QString> &trakt_api_key) {
    QString fullPath = QString(_serverConfigs["get_season_stats"][_serverIndices.value("get_season_stats")].URL()+"/shows/{id}/seasons/{season}/stats");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAISeasonsApi::get_season_statsCallback);
    connect(this, &OAISeasonsApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAISeasonsApi::get_season_statsCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT get_season_statsSignal();
        Q_EMIT get_season_statsSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT get_season_statsSignalE(error_type, error_str);
        Q_EMIT get_season_statsSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT get_season_statsSignalError(error_type, error_str);
        Q_EMIT get_season_statsSignalErrorFull(worker, error_type, error_str);
    }
}

void OAISeasonsApi::get_single_season_for_a_show(const QString &id, const qint32 &season, const ::OpenAPI::OptionalParam<QString> &translations, const ::OpenAPI::OptionalParam<QString> &trakt_api_version, const ::OpenAPI::OptionalParam<QString> &trakt_api_key) {
    QString fullPath = QString(_serverConfigs["get_single_season_for_a_show"][_serverIndices.value("get_single_season_for_a_show")].URL()+"/shows/{id}/seasons/{season}");
    ...
    if (translations.hasValue())
    {
        ...
        queryDelimiter = getParamStyleDelimiter(queryStyle, "translations", true);
        if (fullPath.indexOf("?") > 0)
            fullPath.append(queryPrefix);
        else
            fullPath.append("?");

        fullPath.append(QUrl::toPercentEncoding("translations")).append(querySuffix).append(QUrl::toPercentEncoding(translations.stringValue()));
    }
    OAIHttpRequestWorker *worker = new OAIHttpRequestWorker(this, _manager);
    worker->setTimeOut(_timeOut);
    worker->setWorkingDirectory(_workingDirectory);
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAISeasonsApi::get_single_season_for_a_showCallback);
    connect(this, &OAISeasonsApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAISeasonsApi::get_single_season_for_a_showCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT get_single_season_for_a_showSignal();
        Q_EMIT get_single_season_for_a_showSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT get_single_season_for_a_showSignalE(error_type, error_str);
        Q_EMIT get_single_season_for_a_showSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT get_single_season_for_a_showSignalError(error_type, error_str);
        Q_EMIT get_single_season_for_a_showSignalErrorFull(worker, error_type, error_str);
    }
}

void OAISeasonsApi::showsIdSeasonsSeasonWatchingGet(const QString &id, const qint32 &season, const ::OpenAPI::OptionalParam<QString> &trakt_api_version, const ::OpenAPI::OptionalParam<QString> &trakt_api_key) {
    QString fullPath = QString(_serverConfigs["showsIdSeasonsSeasonWatchingGet"][_serverIndices.value("showsIdSeasonsSeasonWatchingGet")].URL()+"/shows/{id}/seasons/{season}/watching");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAISeasonsApi::showsIdSeasonsSeasonWatchingGetCallback);
    connect(this, &OAISeasonsApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAISeasonsApi::showsIdSeasonsSeasonWatchingGetCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT showsIdSeasonsSeasonWatchingGetSignal();
        Q_EMIT showsIdSeasonsSeasonWatchingGetSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT showsIdSeasonsSeasonWatchingGetSignalE(error_type, error_str);
        Q_EMIT showsIdSeasonsSeasonWatchingGetSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT showsIdSeasonsSeasonWatchingGetSignalError(error_type, error_str);
        Q_EMIT showsIdSeasonsSeasonWatchingGetSignalErrorFull(worker, error_type, error_str);
    }
}

void OAISeasonsApi::tokenAvailable(){
