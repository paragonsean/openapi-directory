...
void OAINetworksApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("get_networks", defaultConf);
    _serverIndices.insert("get_networks", 0);
}
...
void OAINetworksApi::get_networks(const ::OpenAPI::OptionalParam<QString> &trakt_api_version, const ::OpenAPI::OptionalParam<QString> &trakt_api_key) {
    QString fullPath = QString(_serverConfigs["get_networks"][_serverIndices.value("get_networks")].URL()+"/networks");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAINetworksApi::get_networksCallback);
...
void OAINetworksApi::get_networksCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT get_networksSignal();
        Q_EMIT get_networksSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT get_networksSignalE(error_type, error_str);
        Q_EMIT get_networksSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT get_networksSignalError(error_type, error_str);
        Q_EMIT get_networksSignalErrorFull(worker, error_type, error_str);
    }
}
