...
/*
 * OAIAdd_items_to_collection_request_movies_inner.h
 *
 * 
 */

#ifndef OAIAdd_items_to_collection_request_movies_inner_H
#define OAIAdd_items_to_collection_request_movies_inner_H
...
namespace OpenAPI {
class OAICheck_into_an_item_request_movie_ids;

class OAIAdd_items_to_collection_request_movies_inner : public OAIObject {
public:
    OAIAdd_items_to_collection_request_movies_inner();
    OAIAdd_items_to_collection_request_movies_inner(QString json);
    ~OAIAdd_items_to_collection_request_movies_inner() override;
    ...
    QString getAudioChannels() const;
    void setAudioChannels(const QString &audio_channels);
    bool is_audio_channels_Set() const;
    bool is_audio_channels_Valid() const;

    QString getCollectedAt() const;
    void setCollectedAt(const QString &collected_at);
    bool is_collected_at_Set() const;
    bool is_collected_at_Valid() const;

    QString getHdr() const;
    void setHdr(const QString &hdr);
    bool is_hdr_Set() const;
    bool is_hdr_Valid() const;

    OAICheck_into_an_item_request_movie_ids getIds() const;
    void setIds(const OAICheck_into_an_item_request_movie_ids &ids);
...
private:
    ...
    QString m_audio_channels;
    bool m_audio_channels_isSet;
    bool m_audio_channels_isValid;

    QString m_collected_at;
    bool m_collected_at_isSet;
    bool m_collected_at_isValid;

    QString m_hdr;
    bool m_hdr_isSet;
    bool m_hdr_isValid;

    OAICheck_into_an_item_request_movie_ids m_ids;
    bool m_ids_isSet;
    bool m_ids_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAdd_items_to_collection_request_movies_inner)

#endif // OAIAdd_items_to_collection_request_movies_inner_H
