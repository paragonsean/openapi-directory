...
#include "OAIPost_a_comment_request.h"
...
OAIPost_a_comment_request::OAIPost_a_comment_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPost_a_comment_request::OAIPost_a_comment_request() {
    this->initializeModel();
}

OAIPost_a_comment_request::~OAIPost_a_comment_request() {}

void OAIPost_a_comment_request::initializeModel() {
...
void OAIPost_a_comment_request::fromJson(QString jsonString) {
...
void OAIPost_a_comment_request::fromJsonObject(QJsonObject json) {
    ...
    m_spoiler_isValid = ::OpenAPI::fromJsonValue(m_spoiler, json[QString("spoiler")]);
    m_spoiler_isSet = !json[QString("spoiler")].isNull() && m_spoiler_isValid;
}

QString OAIPost_a_comment_request::asJson() const {
...
QJsonObject OAIPost_a_comment_request::asJsonObject() const {
    QJsonObject obj;
    if (m_comment_isSet) {
    ...
    if (m_spoiler_isSet) {
        obj.insert(QString("spoiler"), ::OpenAPI::toJsonValue(m_spoiler));
    }
    return obj;
}

QString OAIPost_a_comment_request::getComment() const {
    return m_comment;
}
void OAIPost_a_comment_request::setComment(const QString &comment) {
    m_comment = comment;
    m_comment_isSet = true;
}

bool OAIPost_a_comment_request::is_comment_Set() const{
    return m_comment_isSet;
}

bool OAIPost_a_comment_request::is_comment_Valid() const{
    return m_comment_isValid;
}

OAICheck_into_an_item_request_movie OAIPost_a_comment_request::getMovie() const {
    return m_movie;
}
void OAIPost_a_comment_request::setMovie(const OAICheck_into_an_item_request_movie &movie) {
    m_movie = movie;
    m_movie_isSet = true;
}

bool OAIPost_a_comment_request::is_movie_Set() const{
    return m_movie_isSet;
}

bool OAIPost_a_comment_request::is_movie_Valid() const{
    return m_movie_isValid;
}

OAIPost_a_comment_request_sharing OAIPost_a_comment_request::getSharing() const {
    return m_sharing;
}
void OAIPost_a_comment_request::setSharing(const OAIPost_a_comment_request_sharing &sharing) {
    m_sharing = sharing;
    m_sharing_isSet = true;
}

bool OAIPost_a_comment_request::is_sharing_Set() const{
    return m_sharing_isSet;
}

bool OAIPost_a_comment_request::is_sharing_Valid() const{
    return m_sharing_isValid;
}

bool OAIPost_a_comment_request::isSpoiler() const {
    return m_spoiler;
}
void OAIPost_a_comment_request::setSpoiler(const bool &spoiler) {
    m_spoiler = spoiler;
    m_spoiler_isSet = true;
}

bool OAIPost_a_comment_request::is_spoiler_Set() const{
    return m_spoiler_isSet;
}

bool OAIPost_a_comment_request::is_spoiler_Valid() const{
    return m_spoiler_isValid;
}

bool OAIPost_a_comment_request::isSet() const {
...
bool OAIPost_a_comment_request::isValid() const {
