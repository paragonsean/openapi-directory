...
void OAISearchApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("get_ID_lookup_results", defaultConf);
    _serverIndices.insert("get_ID_lookup_results", 0);
    _serverConfigs.insert("get_text_query_results", defaultConf);
    _serverIndices.insert("get_text_query_results", 0);
}
...
void OAISearchApi::get_ID_lookup_results(const QString &id_type, const QString &id, const ::OpenAPI::OptionalParam<QString> &type, const ::OpenAPI::OptionalParam<QString> &trakt_api_version, const ::OpenAPI::OptionalParam<QString> &trakt_api_key) {
    QString fullPath = QString(_serverConfigs["get_ID_lookup_results"][_serverIndices.value("get_ID_lookup_results")].URL()+"/search/{id_type}/{id}");
    
    
    {
        QString id_typePathParam("{");
        id_typePathParam.append("id_type").append("}");
        ...
        pathDelimiter = getParamStyleDelimiter(pathStyle, "id_type", false);
        QString paramString = (pathStyle == "matrix") ? pathPrefix+"id_type"+pathSuffix : pathPrefix;
        fullPath.replace(id_typePathParam, paramString+QUrl::toPercentEncoding(::OpenAPI::toStringValue(id_type)));
    }
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAISearchApi::get_ID_lookup_resultsCallback);
...
void OAISearchApi::get_ID_lookup_resultsCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT get_ID_lookup_resultsSignal();
        Q_EMIT get_ID_lookup_resultsSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT get_ID_lookup_resultsSignalE(error_type, error_str);
        Q_EMIT get_ID_lookup_resultsSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT get_ID_lookup_resultsSignalError(error_type, error_str);
        Q_EMIT get_ID_lookup_resultsSignalErrorFull(worker, error_type, error_str);
    }
}

void OAISearchApi::get_text_query_results(const QString &type, const QString &query, const ::OpenAPI::OptionalParam<QString> &trakt_api_version, const ::OpenAPI::OptionalParam<QString> &trakt_api_key, const ::OpenAPI::OptionalParam<QString> &body) {
    QString fullPath = QString(_serverConfigs["get_text_query_results"][_serverIndices.value("get_text_query_results")].URL()+"/search/{type}");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAISearchApi::get_text_query_resultsCallback);
    connect(this, &OAISearchApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAISearchApi::get_text_query_resultsCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT get_text_query_resultsSignal();
        Q_EMIT get_text_query_resultsSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT get_text_query_resultsSignalE(error_type, error_str);
        Q_EMIT get_text_query_resultsSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT get_text_query_resultsSignalError(error_type, error_str);
        Q_EMIT get_text_query_resultsSignalErrorFull(worker, error_type, error_str);
    }
}
