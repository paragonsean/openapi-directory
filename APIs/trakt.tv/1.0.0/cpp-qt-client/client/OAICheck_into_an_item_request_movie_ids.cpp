...
#include "OAICheck_into_an_item_request_movie_ids.h"
...
OAICheck_into_an_item_request_movie_ids::OAICheck_into_an_item_request_movie_ids(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICheck_into_an_item_request_movie_ids::OAICheck_into_an_item_request_movie_ids() {
    this->initializeModel();
}

OAICheck_into_an_item_request_movie_ids::~OAICheck_into_an_item_request_movie_ids() {}

void OAICheck_into_an_item_request_movie_ids::initializeModel() {
...
void OAICheck_into_an_item_request_movie_ids::fromJson(QString jsonString) {
...
void OAICheck_into_an_item_request_movie_ids::fromJsonObject(QJsonObject json) {
...
QString OAICheck_into_an_item_request_movie_ids::asJson() const {
...
QJsonObject OAICheck_into_an_item_request_movie_ids::asJsonObject() const {
    QJsonObject obj;
    if (m_imdb_isSet) {
...
QString OAICheck_into_an_item_request_movie_ids::getImdb() const {
    return m_imdb;
}
void OAICheck_into_an_item_request_movie_ids::setImdb(const QString &imdb) {
    m_imdb = imdb;
    m_imdb_isSet = true;
}

bool OAICheck_into_an_item_request_movie_ids::is_imdb_Set() const{
    return m_imdb_isSet;
}

bool OAICheck_into_an_item_request_movie_ids::is_imdb_Valid() const{
    return m_imdb_isValid;
}

QString OAICheck_into_an_item_request_movie_ids::getSlug() const {
    return m_slug;
}
void OAICheck_into_an_item_request_movie_ids::setSlug(const QString &slug) {
    m_slug = slug;
    m_slug_isSet = true;
}

bool OAICheck_into_an_item_request_movie_ids::is_slug_Set() const{
    return m_slug_isSet;
}

bool OAICheck_into_an_item_request_movie_ids::is_slug_Valid() const{
    return m_slug_isValid;
}

double OAICheck_into_an_item_request_movie_ids::getTmdb() const {
    return m_tmdb;
}
void OAICheck_into_an_item_request_movie_ids::setTmdb(const double &tmdb) {
    m_tmdb = tmdb;
    m_tmdb_isSet = true;
}

bool OAICheck_into_an_item_request_movie_ids::is_tmdb_Set() const{
    return m_tmdb_isSet;
}

bool OAICheck_into_an_item_request_movie_ids::is_tmdb_Valid() const{
    return m_tmdb_isValid;
}

double OAICheck_into_an_item_request_movie_ids::getTrakt() const {
    return m_trakt;
}
void OAICheck_into_an_item_request_movie_ids::setTrakt(const double &trakt) {
    m_trakt = trakt;
    m_trakt_isSet = true;
}

bool OAICheck_into_an_item_request_movie_ids::is_trakt_Set() const{
    return m_trakt_isSet;
}

bool OAICheck_into_an_item_request_movie_ids::is_trakt_Valid() const{
    return m_trakt_isValid;
}

bool OAICheck_into_an_item_request_movie_ids::isSet() const {
...
bool OAICheck_into_an_item_request_movie_ids::isValid() const {
