...
public:
    ...
    */
    virtual void get_genres(const QString &type, const ::OpenAPI::OptionalParam<QString> &trakt_api_version = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &trakt_api_key = ::OpenAPI::OptionalParam<QString>());
...
private:
    ...
    void get_genresCallback(OAIHttpRequestWorker *worker);

Q_SIGNALS:

    void get_genresSignal();


    void get_genresSignalFull(OAIHttpRequestWorker *worker);

    Q_DECL_DEPRECATED_X("Use get_genresSignalError() instead")
    void get_genresSignalE(QNetworkReply::NetworkError error_type, QString error_str);
    void get_genresSignalError(QNetworkReply::NetworkError error_type, const QString &error_str);

    Q_DECL_DEPRECATED_X("Use get_genresSignalErrorFull() instead")
    void get_genresSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void get_genresSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
