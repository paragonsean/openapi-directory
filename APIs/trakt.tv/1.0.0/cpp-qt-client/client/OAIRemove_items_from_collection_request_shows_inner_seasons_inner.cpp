...
#include "OAIRemove_items_from_collection_request_shows_inner_seasons_inner.h"
...
OAIRemove_items_from_collection_request_shows_inner_seasons_inner::OAIRemove_items_from_collection_request_shows_inner_seasons_inner(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIRemove_items_from_collection_request_shows_inner_seasons_inner::OAIRemove_items_from_collection_request_shows_inner_seasons_inner() {
    this->initializeModel();
}

OAIRemove_items_from_collection_request_shows_inner_seasons_inner::~OAIRemove_items_from_collection_request_shows_inner_seasons_inner() {}

void OAIRemove_items_from_collection_request_shows_inner_seasons_inner::initializeModel() {
...
void OAIRemove_items_from_collection_request_shows_inner_seasons_inner::fromJson(QString jsonString) {
...
void OAIRemove_items_from_collection_request_shows_inner_seasons_inner::fromJsonObject(QJsonObject json) {
...
QString OAIRemove_items_from_collection_request_shows_inner_seasons_inner::asJson() const {
...
QJsonObject OAIRemove_items_from_collection_request_shows_inner_seasons_inner::asJsonObject() const {
    QJsonObject obj;
...
QList<OAIRemove_items_from_collection_request_shows_inner_seasons_inner_episodes_inner> OAIRemove_items_from_collection_request_shows_inner_seasons_inner::getEpisodes() const {
    return m_episodes;
}
void OAIRemove_items_from_collection_request_shows_inner_seasons_inner::setEpisodes(const QList<OAIRemove_items_from_collection_request_shows_inner_seasons_inner_episodes_inner> &episodes) {
    m_episodes = episodes;
    m_episodes_isSet = true;
}

bool OAIRemove_items_from_collection_request_shows_inner_seasons_inner::is_episodes_Set() const{
    return m_episodes_isSet;
}

bool OAIRemove_items_from_collection_request_shows_inner_seasons_inner::is_episodes_Valid() const{
    return m_episodes_isValid;
}

double OAIRemove_items_from_collection_request_shows_inner_seasons_inner::getNumber() const {
    return m_number;
}
void OAIRemove_items_from_collection_request_shows_inner_seasons_inner::setNumber(const double &number) {
    m_number = number;
    m_number_isSet = true;
}

bool OAIRemove_items_from_collection_request_shows_inner_seasons_inner::is_number_Set() const{
    return m_number_isSet;
}

bool OAIRemove_items_from_collection_request_shows_inner_seasons_inner::is_number_Valid() const{
    return m_number_isValid;
}

bool OAIRemove_items_from_collection_request_shows_inner_seasons_inner::isSet() const {
...
bool OAIRemove_items_from_collection_request_shows_inner_seasons_inner::isValid() const {
