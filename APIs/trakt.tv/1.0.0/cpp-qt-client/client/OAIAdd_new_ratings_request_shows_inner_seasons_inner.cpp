...
#include "OAIAdd_new_ratings_request_shows_inner_seasons_inner.h"
...
OAIAdd_new_ratings_request_shows_inner_seasons_inner::OAIAdd_new_ratings_request_shows_inner_seasons_inner(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAdd_new_ratings_request_shows_inner_seasons_inner::OAIAdd_new_ratings_request_shows_inner_seasons_inner() {
    this->initializeModel();
}

OAIAdd_new_ratings_request_shows_inner_seasons_inner::~OAIAdd_new_ratings_request_shows_inner_seasons_inner() {}

void OAIAdd_new_ratings_request_shows_inner_seasons_inner::initializeModel() {
...
void OAIAdd_new_ratings_request_shows_inner_seasons_inner::fromJson(QString jsonString) {
...
void OAIAdd_new_ratings_request_shows_inner_seasons_inner::fromJsonObject(QJsonObject json) {
...
QString OAIAdd_new_ratings_request_shows_inner_seasons_inner::asJson() const {
...
QJsonObject OAIAdd_new_ratings_request_shows_inner_seasons_inner::asJsonObject() const {
    QJsonObject obj;
...
QList<OAIAdd_new_ratings_request_shows_inner_seasons_inner_episodes_inner> OAIAdd_new_ratings_request_shows_inner_seasons_inner::getEpisodes() const {
    return m_episodes;
}
void OAIAdd_new_ratings_request_shows_inner_seasons_inner::setEpisodes(const QList<OAIAdd_new_ratings_request_shows_inner_seasons_inner_episodes_inner> &episodes) {
    m_episodes = episodes;
    m_episodes_isSet = true;
}

bool OAIAdd_new_ratings_request_shows_inner_seasons_inner::is_episodes_Set() const{
    return m_episodes_isSet;
}

bool OAIAdd_new_ratings_request_shows_inner_seasons_inner::is_episodes_Valid() const{
    return m_episodes_isValid;
}

double OAIAdd_new_ratings_request_shows_inner_seasons_inner::getNumber() const {
    return m_number;
}
void OAIAdd_new_ratings_request_shows_inner_seasons_inner::setNumber(const double &number) {
    m_number = number;
    m_number_isSet = true;
}

bool OAIAdd_new_ratings_request_shows_inner_seasons_inner::is_number_Set() const{
    return m_number_isSet;
}

bool OAIAdd_new_ratings_request_shows_inner_seasons_inner::is_number_Valid() const{
    return m_number_isValid;
}

double OAIAdd_new_ratings_request_shows_inner_seasons_inner::getRating() const {
    return m_rating;
}
void OAIAdd_new_ratings_request_shows_inner_seasons_inner::setRating(const double &rating) {
    m_rating = rating;
    m_rating_isSet = true;
}

bool OAIAdd_new_ratings_request_shows_inner_seasons_inner::is_rating_Set() const{
    return m_rating_isSet;
}

bool OAIAdd_new_ratings_request_shows_inner_seasons_inner::is_rating_Valid() const{
    return m_rating_isValid;
}

bool OAIAdd_new_ratings_request_shows_inner_seasons_inner::isSet() const {
...
bool OAIAdd_new_ratings_request_shows_inner_seasons_inner::isValid() const {
