...
#ifndef OAI_OAISeasonsApi_H
#define OAI_OAISeasonsApi_H
...
class OAISeasonsApi : public QObject {
    Q_OBJECT

public:
    OAISeasonsApi(const int timeOut = 0);
    ~OAISeasonsApi();
    ...
    * @param[in]  season qint32 [required]
    * @param[in]  trakt_api_version QString [optional]
    * @param[in]  trakt_api_key QString [optional]
    */
    virtual void get_all_people_for_a_season(const QString &id, const qint32 &season, const ::OpenAPI::OptionalParam<QString> &trakt_api_version = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &trakt_api_key = ::OpenAPI::OptionalParam<QString>());
    ...
    * @param[in]  trakt_api_key QString [optional]
    */
    virtual void get_all_season_comments(const QString &id, const qint32 &season, const QString &sort, const ::OpenAPI::OptionalParam<QString> &trakt_api_version = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &trakt_api_key = ::OpenAPI::OptionalParam<QString>());
    ...
    * @param[in]  trakt_api_key QString [optional]
    */
    virtual void get_all_season_translations(const QString &id, const qint32 &season, const QString &language, const ::OpenAPI::OptionalParam<QString> &trakt_api_version = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &trakt_api_key = ::OpenAPI::OptionalParam<QString>());
    ...
    * @param[in]  trakt_api_key QString [optional]
    */
    virtual void get_all_seasons_for_a_show(const QString &id, const ::OpenAPI::OptionalParam<QString> &trakt_api_version = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &trakt_api_key = ::OpenAPI::OptionalParam<QString>());
    ...
    * @param[in]  trakt_api_key QString [optional]
    */
    virtual void get_lists_containing_this_season(const QString &id, const qint32 &season, const QString &type, const QString &sort, const ::OpenAPI::OptionalParam<QString> &trakt_api_version = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &trakt_api_key = ::OpenAPI::OptionalParam<QString>());
    ...
    * @param[in]  trakt_api_key QString [optional]
    */
    virtual void get_season_ratings(const QString &id, const qint32 &season, const ::OpenAPI::OptionalParam<QString> &trakt_api_version = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &trakt_api_key = ::OpenAPI::OptionalParam<QString>());
    ...
    * @param[in]  trakt_api_key QString [optional]
    */
    virtual void get_season_stats(const QString &id, const qint32 &season, const ::OpenAPI::OptionalParam<QString> &trakt_api_version = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &trakt_api_key = ::OpenAPI::OptionalParam<QString>());

    /**
    * @param[in]  id QString [required]
    * @param[in]  season qint32 [required]
    * @param[in]  translations QString [optional]
    * @param[in]  trakt_api_version QString [optional]
    * @param[in]  trakt_api_key QString [optional]
    */
    virtual void get_single_season_for_a_show(const QString &id, const qint32 &season, const ::OpenAPI::OptionalParam<QString> &translations = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &trakt_api_version = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &trakt_api_key = ::OpenAPI::OptionalParam<QString>());
    ...
    * @param[in]  trakt_api_key QString [optional]
    */
    virtual void showsIdSeasonsSeasonWatchingGet(const QString &id, const qint32 &season, const ::OpenAPI::OptionalParam<QString> &trakt_api_version = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &trakt_api_key = ::OpenAPI::OptionalParam<QString>());
...
private:
    ...
    void get_all_people_for_a_seasonCallback(OAIHttpRequestWorker *worker);
    void get_all_season_commentsCallback(OAIHttpRequestWorker *worker);
    void get_all_season_translationsCallback(OAIHttpRequestWorker *worker);
    void get_all_seasons_for_a_showCallback(OAIHttpRequestWorker *worker);
    void get_lists_containing_this_seasonCallback(OAIHttpRequestWorker *worker);
    void get_season_ratingsCallback(OAIHttpRequestWorker *worker);
    void get_season_statsCallback(OAIHttpRequestWorker *worker);
    void get_single_season_for_a_showCallback(OAIHttpRequestWorker *worker);
    void showsIdSeasonsSeasonWatchingGetCallback(OAIHttpRequestWorker *worker);

Q_SIGNALS:

    void get_all_people_for_a_seasonSignal();
    void get_all_season_commentsSignal();
    void get_all_season_translationsSignal();
    void get_all_seasons_for_a_showSignal();
    void get_lists_containing_this_seasonSignal();
    void get_season_ratingsSignal();
    void get_season_statsSignal();
    void get_single_season_for_a_showSignal();
    void showsIdSeasonsSeasonWatchingGetSignal();


    void get_all_people_for_a_seasonSignalFull(OAIHttpRequestWorker *worker);
    void get_all_season_commentsSignalFull(OAIHttpRequestWorker *worker);
    void get_all_season_translationsSignalFull(OAIHttpRequestWorker *worker);
    void get_all_seasons_for_a_showSignalFull(OAIHttpRequestWorker *worker);
    void get_lists_containing_this_seasonSignalFull(OAIHttpRequestWorker *worker);
    void get_season_ratingsSignalFull(OAIHttpRequestWorker *worker);
    void get_season_statsSignalFull(OAIHttpRequestWorker *worker);
    void get_single_season_for_a_showSignalFull(OAIHttpRequestWorker *worker);
    void showsIdSeasonsSeasonWatchingGetSignalFull(OAIHttpRequestWorker *worker);

    Q_DECL_DEPRECATED_X("Use get_all_people_for_a_seasonSignalError() instead")
    void get_all_people_for_a_seasonSignalE(QNetworkReply::NetworkError error_type, QString error_str);
    void get_all_people_for_a_seasonSignalError(QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use get_all_season_commentsSignalError() instead")
    void get_all_season_commentsSignalE(QNetworkReply::NetworkError error_type, QString error_str);
    void get_all_season_commentsSignalError(QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use get_all_season_translationsSignalError() instead")
    void get_all_season_translationsSignalE(QNetworkReply::NetworkError error_type, QString error_str);
    void get_all_season_translationsSignalError(QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use get_all_seasons_for_a_showSignalError() instead")
    void get_all_seasons_for_a_showSignalE(QNetworkReply::NetworkError error_type, QString error_str);
    void get_all_seasons_for_a_showSignalError(QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use get_lists_containing_this_seasonSignalError() instead")
    void get_lists_containing_this_seasonSignalE(QNetworkReply::NetworkError error_type, QString error_str);
    void get_lists_containing_this_seasonSignalError(QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use get_season_ratingsSignalError() instead")
    void get_season_ratingsSignalE(QNetworkReply::NetworkError error_type, QString error_str);
    void get_season_ratingsSignalError(QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use get_season_statsSignalError() instead")
    void get_season_statsSignalE(QNetworkReply::NetworkError error_type, QString error_str);
    void get_season_statsSignalError(QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use get_single_season_for_a_showSignalError() instead")
    void get_single_season_for_a_showSignalE(QNetworkReply::NetworkError error_type, QString error_str);
    void get_single_season_for_a_showSignalError(QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use showsIdSeasonsSeasonWatchingGetSignalError() instead")
    void showsIdSeasonsSeasonWatchingGetSignalE(QNetworkReply::NetworkError error_type, QString error_str);
    void showsIdSeasonsSeasonWatchingGetSignalError(QNetworkReply::NetworkError error_type, const QString &error_str);

    Q_DECL_DEPRECATED_X("Use get_all_people_for_a_seasonSignalErrorFull() instead")
    void get_all_people_for_a_seasonSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void get_all_people_for_a_seasonSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use get_all_season_commentsSignalErrorFull() instead")
    void get_all_season_commentsSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void get_all_season_commentsSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use get_all_season_translationsSignalErrorFull() instead")
    void get_all_season_translationsSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void get_all_season_translationsSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use get_all_seasons_for_a_showSignalErrorFull() instead")
    void get_all_seasons_for_a_showSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void get_all_seasons_for_a_showSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use get_lists_containing_this_seasonSignalErrorFull() instead")
    void get_lists_containing_this_seasonSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void get_lists_containing_this_seasonSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use get_season_ratingsSignalErrorFull() instead")
    void get_season_ratingsSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void get_season_ratingsSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use get_season_statsSignalErrorFull() instead")
    void get_season_statsSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void get_season_statsSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use get_single_season_for_a_showSignalErrorFull() instead")
    void get_single_season_for_a_showSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void get_single_season_for_a_showSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use showsIdSeasonsSeasonWatchingGetSignalErrorFull() instead")
    void showsIdSeasonsSeasonWatchingGetSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void showsIdSeasonsSeasonWatchingGetSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
