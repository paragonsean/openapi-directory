...
#include "OAIRemove_items_from_personal_recommendations_request_shows_inner.h"
...
OAIRemove_items_from_personal_recommendations_request_shows_inner::OAIRemove_items_from_personal_recommendations_request_shows_inner(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIRemove_items_from_personal_recommendations_request_shows_inner::OAIRemove_items_from_personal_recommendations_request_shows_inner() {
    this->initializeModel();
}

OAIRemove_items_from_personal_recommendations_request_shows_inner::~OAIRemove_items_from_personal_recommendations_request_shows_inner() {}

void OAIRemove_items_from_personal_recommendations_request_shows_inner::initializeModel() {
...
void OAIRemove_items_from_personal_recommendations_request_shows_inner::fromJson(QString jsonString) {
...
void OAIRemove_items_from_personal_recommendations_request_shows_inner::fromJsonObject(QJsonObject json) {
...
QString OAIRemove_items_from_personal_recommendations_request_shows_inner::asJson() const {
...
QJsonObject OAIRemove_items_from_personal_recommendations_request_shows_inner::asJsonObject() const {
    QJsonObject obj;
    if (m_ids.isSet()) {
...
OAIAdd_items_to_collection_request_shows_inner_ids OAIRemove_items_from_personal_recommendations_request_shows_inner::getIds() const {
    return m_ids;
}
void OAIRemove_items_from_personal_recommendations_request_shows_inner::setIds(const OAIAdd_items_to_collection_request_shows_inner_ids &ids) {
    m_ids = ids;
    m_ids_isSet = true;
}

bool OAIRemove_items_from_personal_recommendations_request_shows_inner::is_ids_Set() const{
    return m_ids_isSet;
}

bool OAIRemove_items_from_personal_recommendations_request_shows_inner::is_ids_Valid() const{
    return m_ids_isValid;
}

QString OAIRemove_items_from_personal_recommendations_request_shows_inner::getTitle() const {
    return m_title;
}
void OAIRemove_items_from_personal_recommendations_request_shows_inner::setTitle(const QString &title) {
    m_title = title;
    m_title_isSet = true;
}

bool OAIRemove_items_from_personal_recommendations_request_shows_inner::is_title_Set() const{
    return m_title_isSet;
}

bool OAIRemove_items_from_personal_recommendations_request_shows_inner::is_title_Valid() const{
    return m_title_isValid;
}

double OAIRemove_items_from_personal_recommendations_request_shows_inner::getYear() const {
    return m_year;
}
void OAIRemove_items_from_personal_recommendations_request_shows_inner::setYear(const double &year) {
    m_year = year;
    m_year_isSet = true;
}

bool OAIRemove_items_from_personal_recommendations_request_shows_inner::is_year_Set() const{
    return m_year_isSet;
}

bool OAIRemove_items_from_personal_recommendations_request_shows_inner::is_year_Valid() const{
    return m_year_isValid;
}

bool OAIRemove_items_from_personal_recommendations_request_shows_inner::isSet() const {
...
bool OAIRemove_items_from_personal_recommendations_request_shows_inner::isValid() const {
