...
void OAIPeopleApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("get_a_single_person", defaultConf);
    _serverIndices.insert("get_a_single_person", 0);
    _serverConfigs.insert("get_lists_containing_this_person", defaultConf);
    _serverIndices.insert("get_lists_containing_this_person", 0);
    _serverConfigs.insert("get_movie_credits", defaultConf);
    _serverIndices.insert("get_movie_credits", 0);
    _serverConfigs.insert("get_recently_updated_people", defaultConf);
    _serverIndices.insert("get_recently_updated_people", 0);
    _serverConfigs.insert("get_recently_updated_people_Trakt_IDs", defaultConf);
    _serverIndices.insert("get_recently_updated_people_Trakt_IDs", 0);
    _serverConfigs.insert("get_show_credits", defaultConf);
    _serverIndices.insert("get_show_credits", 0);
}
...
void OAIPeopleApi::get_a_single_person(const QString &id, const ::OpenAPI::OptionalParam<QString> &trakt_api_version, const ::OpenAPI::OptionalParam<QString> &trakt_api_key) {
    QString fullPath = QString(_serverConfigs["get_a_single_person"][_serverIndices.value("get_a_single_person")].URL()+"/people/{id}");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIPeopleApi::get_a_single_personCallback);
...
void OAIPeopleApi::get_a_single_personCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT get_a_single_personSignal();
        Q_EMIT get_a_single_personSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT get_a_single_personSignalE(error_type, error_str);
        Q_EMIT get_a_single_personSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT get_a_single_personSignalError(error_type, error_str);
        Q_EMIT get_a_single_personSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIPeopleApi::get_lists_containing_this_person(const QString &id, const QString &type, const QString &sort, const ::OpenAPI::OptionalParam<QString> &trakt_api_version, const ::OpenAPI::OptionalParam<QString> &trakt_api_key) {
    QString fullPath = QString(_serverConfigs["get_lists_containing_this_person"][_serverIndices.value("get_lists_containing_this_person")].URL()+"/people/{id}/lists/{type}/{sort}");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIPeopleApi::get_lists_containing_this_personCallback);
    connect(this, &OAIPeopleApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIPeopleApi::get_lists_containing_this_personCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT get_lists_containing_this_personSignal();
        Q_EMIT get_lists_containing_this_personSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT get_lists_containing_this_personSignalE(error_type, error_str);
        Q_EMIT get_lists_containing_this_personSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT get_lists_containing_this_personSignalError(error_type, error_str);
        Q_EMIT get_lists_containing_this_personSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIPeopleApi::get_movie_credits(const QString &id, const ::OpenAPI::OptionalParam<QString> &trakt_api_version, const ::OpenAPI::OptionalParam<QString> &trakt_api_key) {
    QString fullPath = QString(_serverConfigs["get_movie_credits"][_serverIndices.value("get_movie_credits")].URL()+"/people/{id}/movies");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIPeopleApi::get_movie_creditsCallback);
    connect(this, &OAIPeopleApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIPeopleApi::get_movie_creditsCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT get_movie_creditsSignal();
        Q_EMIT get_movie_creditsSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT get_movie_creditsSignalE(error_type, error_str);
        Q_EMIT get_movie_creditsSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT get_movie_creditsSignalError(error_type, error_str);
        Q_EMIT get_movie_creditsSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIPeopleApi::get_recently_updated_people(const QString &start_date, const ::OpenAPI::OptionalParam<QString> &trakt_api_version, const ::OpenAPI::OptionalParam<QString> &trakt_api_key) {
    QString fullPath = QString(_serverConfigs["get_recently_updated_people"][_serverIndices.value("get_recently_updated_people")].URL()+"/people/updates/{start_date}");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIPeopleApi::get_recently_updated_peopleCallback);
    connect(this, &OAIPeopleApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIPeopleApi::get_recently_updated_peopleCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT get_recently_updated_peopleSignal();
        Q_EMIT get_recently_updated_peopleSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT get_recently_updated_peopleSignalE(error_type, error_str);
        Q_EMIT get_recently_updated_peopleSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT get_recently_updated_peopleSignalError(error_type, error_str);
        Q_EMIT get_recently_updated_peopleSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIPeopleApi::get_recently_updated_people_Trakt_IDs(const QString &start_date, const ::OpenAPI::OptionalParam<QString> &trakt_api_version, const ::OpenAPI::OptionalParam<QString> &trakt_api_key) {
    QString fullPath = QString(_serverConfigs["get_recently_updated_people_Trakt_IDs"][_serverIndices.value("get_recently_updated_people_Trakt_IDs")].URL()+"/people/updates/id/{start_date}");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIPeopleApi::get_recently_updated_people_Trakt_IDsCallback);
    connect(this, &OAIPeopleApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIPeopleApi::get_recently_updated_people_Trakt_IDsCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT get_recently_updated_people_Trakt_IDsSignal();
        Q_EMIT get_recently_updated_people_Trakt_IDsSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT get_recently_updated_people_Trakt_IDsSignalE(error_type, error_str);
        Q_EMIT get_recently_updated_people_Trakt_IDsSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT get_recently_updated_people_Trakt_IDsSignalError(error_type, error_str);
        Q_EMIT get_recently_updated_people_Trakt_IDsSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIPeopleApi::get_show_credits(const QString &id, const ::OpenAPI::OptionalParam<QString> &trakt_api_version, const ::OpenAPI::OptionalParam<QString> &trakt_api_key) {
    QString fullPath = QString(_serverConfigs["get_show_credits"][_serverIndices.value("get_show_credits")].URL()+"/people/{id}/shows");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIPeopleApi::get_show_creditsCallback);
    connect(this, &OAIPeopleApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIPeopleApi::get_show_creditsCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT get_show_creditsSignal();
        Q_EMIT get_show_creditsSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT get_show_creditsSignalE(error_type, error_str);
        Q_EMIT get_show_creditsSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT get_show_creditsSignalError(error_type, error_str);
        Q_EMIT get_show_creditsSignalErrorFull(worker, error_type, error_str);
    }
}
