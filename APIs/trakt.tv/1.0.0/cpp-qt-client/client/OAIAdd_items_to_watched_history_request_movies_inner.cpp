...
#include "OAIAdd_items_to_watched_history_request_movies_inner.h"
...
OAIAdd_items_to_watched_history_request_movies_inner::OAIAdd_items_to_watched_history_request_movies_inner(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAdd_items_to_watched_history_request_movies_inner::OAIAdd_items_to_watched_history_request_movies_inner() {
    this->initializeModel();
}

OAIAdd_items_to_watched_history_request_movies_inner::~OAIAdd_items_to_watched_history_request_movies_inner() {}

void OAIAdd_items_to_watched_history_request_movies_inner::initializeModel() {
...
void OAIAdd_items_to_watched_history_request_movies_inner::fromJson(QString jsonString) {
...
void OAIAdd_items_to_watched_history_request_movies_inner::fromJsonObject(QJsonObject json) {
...
QString OAIAdd_items_to_watched_history_request_movies_inner::asJson() const {
...
QJsonObject OAIAdd_items_to_watched_history_request_movies_inner::asJsonObject() const {
    QJsonObject obj;
    if (m_ids.isSet()) {
...
OAICheck_into_an_item_request_movie_ids OAIAdd_items_to_watched_history_request_movies_inner::getIds() const {
    return m_ids;
}
void OAIAdd_items_to_watched_history_request_movies_inner::setIds(const OAICheck_into_an_item_request_movie_ids &ids) {
    m_ids = ids;
    m_ids_isSet = true;
}

bool OAIAdd_items_to_watched_history_request_movies_inner::is_ids_Set() const{
    return m_ids_isSet;
}

bool OAIAdd_items_to_watched_history_request_movies_inner::is_ids_Valid() const{
    return m_ids_isValid;
}

QString OAIAdd_items_to_watched_history_request_movies_inner::getTitle() const {
    return m_title;
}
void OAIAdd_items_to_watched_history_request_movies_inner::setTitle(const QString &title) {
    m_title = title;
    m_title_isSet = true;
}

bool OAIAdd_items_to_watched_history_request_movies_inner::is_title_Set() const{
    return m_title_isSet;
}

bool OAIAdd_items_to_watched_history_request_movies_inner::is_title_Valid() const{
    return m_title_isValid;
}

QString OAIAdd_items_to_watched_history_request_movies_inner::getWatchedAt() const {
    return m_watched_at;
}
void OAIAdd_items_to_watched_history_request_movies_inner::setWatchedAt(const QString &watched_at) {
    m_watched_at = watched_at;
    m_watched_at_isSet = true;
}

bool OAIAdd_items_to_watched_history_request_movies_inner::is_watched_at_Set() const{
    return m_watched_at_isSet;
}

bool OAIAdd_items_to_watched_history_request_movies_inner::is_watched_at_Valid() const{
    return m_watched_at_isValid;
}

double OAIAdd_items_to_watched_history_request_movies_inner::getYear() const {
    return m_year;
}
void OAIAdd_items_to_watched_history_request_movies_inner::setYear(const double &year) {
    m_year = year;
    m_year_isSet = true;
}

bool OAIAdd_items_to_watched_history_request_movies_inner::is_year_Set() const{
    return m_year_isSet;
}

bool OAIAdd_items_to_watched_history_request_movies_inner::is_year_Valid() const{
    return m_year_isValid;
}

bool OAIAdd_items_to_watched_history_request_movies_inner::isSet() const {
...
bool OAIAdd_items_to_watched_history_request_movies_inner::isValid() const {
