...
#include "OAIRemove_items_from_collection_request_movies_inner.h"
...
OAIRemove_items_from_collection_request_movies_inner::OAIRemove_items_from_collection_request_movies_inner(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIRemove_items_from_collection_request_movies_inner::OAIRemove_items_from_collection_request_movies_inner() {
    this->initializeModel();
}

OAIRemove_items_from_collection_request_movies_inner::~OAIRemove_items_from_collection_request_movies_inner() {}

void OAIRemove_items_from_collection_request_movies_inner::initializeModel() {
...
void OAIRemove_items_from_collection_request_movies_inner::fromJson(QString jsonString) {
...
void OAIRemove_items_from_collection_request_movies_inner::fromJsonObject(QJsonObject json) {
...
QString OAIRemove_items_from_collection_request_movies_inner::asJson() const {
...
QJsonObject OAIRemove_items_from_collection_request_movies_inner::asJsonObject() const {
    QJsonObject obj;
    if (m_ids.isSet()) {
...
OAICheck_into_an_item_request_movie_ids OAIRemove_items_from_collection_request_movies_inner::getIds() const {
    return m_ids;
}
void OAIRemove_items_from_collection_request_movies_inner::setIds(const OAICheck_into_an_item_request_movie_ids &ids) {
    m_ids = ids;
    m_ids_isSet = true;
}

bool OAIRemove_items_from_collection_request_movies_inner::is_ids_Set() const{
    return m_ids_isSet;
}

bool OAIRemove_items_from_collection_request_movies_inner::is_ids_Valid() const{
    return m_ids_isValid;
}

QString OAIRemove_items_from_collection_request_movies_inner::getTitle() const {
    return m_title;
}
void OAIRemove_items_from_collection_request_movies_inner::setTitle(const QString &title) {
    m_title = title;
    m_title_isSet = true;
}

bool OAIRemove_items_from_collection_request_movies_inner::is_title_Set() const{
    return m_title_isSet;
}

bool OAIRemove_items_from_collection_request_movies_inner::is_title_Valid() const{
    return m_title_isValid;
}

double OAIRemove_items_from_collection_request_movies_inner::getYear() const {
    return m_year;
}
void OAIRemove_items_from_collection_request_movies_inner::setYear(const double &year) {
    m_year = year;
    m_year_isSet = true;
}

bool OAIRemove_items_from_collection_request_movies_inner::is_year_Set() const{
    return m_year_isSet;
}

bool OAIRemove_items_from_collection_request_movies_inner::is_year_Valid() const{
    return m_year_isValid;
}

bool OAIRemove_items_from_collection_request_movies_inner::isSet() const {
...
bool OAIRemove_items_from_collection_request_movies_inner::isValid() const {
