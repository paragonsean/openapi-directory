...
#ifndef OAI_OAIAuthenticationOAuthApi_H
#define OAI_OAIAuthenticationOAuthApi_H
...
#include "OAIExchange_refresh_token_for_access_token_request.h"
#include "OAIRevoke_an_access_token_request.h"
#include <QString>
...
class OAIAuthenticationOAuthApi : public QObject {
    Q_OBJECT

public:
    OAIAuthenticationOAuthApi(const int timeOut = 0);
    ~OAIAuthenticationOAuthApi();
    ...
    */
    virtual void authorize_Application(const QString &response_type, const QString &client_id, const QString &redirect_uri, const ::OpenAPI::OptionalParam<QString> &state = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &body = ::OpenAPI::OptionalParam<QString>());

    /**
    * @param[in]  oai_exchange_refresh_token_for_access_token_request OAIExchange_refresh_token_for_access_token_request [optional]
    */
    virtual void exchange_refreshToken_for_accessToken(const ::OpenAPI::OptionalParam<OAIExchange_refresh_token_for_access_token_request> &oai_exchange_refresh_token_for_access_token_request = ::OpenAPI::OptionalParam<OAIExchange_refresh_token_for_access_token_request>());

    /**
    * @param[in]  oai_revoke_an_access_token_request OAIRevoke_an_access_token_request [optional]
    */
    virtual void revoke_an_accessToken(const ::OpenAPI::OptionalParam<OAIRevoke_an_access_token_request> &oai_revoke_an_access_token_request = ::OpenAPI::OptionalParam<OAIRevoke_an_access_token_request>());
...
private:
    ...
    void authorize_ApplicationCallback(OAIHttpRequestWorker *worker);
    void exchange_refreshToken_for_accessTokenCallback(OAIHttpRequestWorker *worker);
    void revoke_an_accessTokenCallback(OAIHttpRequestWorker *worker);

Q_SIGNALS:

    void authorize_ApplicationSignal();
    void exchange_refreshToken_for_accessTokenSignal();
    void revoke_an_accessTokenSignal();


    void authorize_ApplicationSignalFull(OAIHttpRequestWorker *worker);
    void exchange_refreshToken_for_accessTokenSignalFull(OAIHttpRequestWorker *worker);
    void revoke_an_accessTokenSignalFull(OAIHttpRequestWorker *worker);

    Q_DECL_DEPRECATED_X("Use authorize_ApplicationSignalError() instead")
    void authorize_ApplicationSignalE(QNetworkReply::NetworkError error_type, QString error_str);
    void authorize_ApplicationSignalError(QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use exchange_refreshToken_for_accessTokenSignalError() instead")
    void exchange_refreshToken_for_accessTokenSignalE(QNetworkReply::NetworkError error_type, QString error_str);
    void exchange_refreshToken_for_accessTokenSignalError(QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use revoke_an_accessTokenSignalError() instead")
    void revoke_an_accessTokenSignalE(QNetworkReply::NetworkError error_type, QString error_str);
    void revoke_an_accessTokenSignalError(QNetworkReply::NetworkError error_type, const QString &error_str);

    Q_DECL_DEPRECATED_X("Use authorize_ApplicationSignalErrorFull() instead")
    void authorize_ApplicationSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void authorize_ApplicationSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use exchange_refreshToken_for_accessTokenSignalErrorFull() instead")
    void exchange_refreshToken_for_accessTokenSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void exchange_refreshToken_for_accessTokenSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use revoke_an_accessTokenSignalErrorFull() instead")
    void revoke_an_accessTokenSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void revoke_an_accessTokenSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
