...
OAIAdd_new_ratings_request::OAIAdd_new_ratings_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAdd_new_ratings_request::OAIAdd_new_ratings_request() {
    this->initializeModel();
}

OAIAdd_new_ratings_request::~OAIAdd_new_ratings_request() {}

void OAIAdd_new_ratings_request::initializeModel() {
...
void OAIAdd_new_ratings_request::fromJson(QString jsonString) {
...
void OAIAdd_new_ratings_request::fromJsonObject(QJsonObject json) {
...
QString OAIAdd_new_ratings_request::asJson() const {
...
QJsonObject OAIAdd_new_ratings_request::asJsonObject() const {
    QJsonObject obj;
...
QList<OAIAdd_new_ratings_request_episodes_inner> OAIAdd_new_ratings_request::getEpisodes() const {
    return m_episodes;
}
void OAIAdd_new_ratings_request::setEpisodes(const QList<OAIAdd_new_ratings_request_episodes_inner> &episodes) {
    m_episodes = episodes;
    m_episodes_isSet = true;
}

bool OAIAdd_new_ratings_request::is_episodes_Set() const{
    return m_episodes_isSet;
}

bool OAIAdd_new_ratings_request::is_episodes_Valid() const{
    return m_episodes_isValid;
}

QList<OAIAdd_new_ratings_request_movies_inner> OAIAdd_new_ratings_request::getMovies() const {
    return m_movies;
}
void OAIAdd_new_ratings_request::setMovies(const QList<OAIAdd_new_ratings_request_movies_inner> &movies) {
    m_movies = movies;
    m_movies_isSet = true;
}

bool OAIAdd_new_ratings_request::is_movies_Set() const{
    return m_movies_isSet;
}

bool OAIAdd_new_ratings_request::is_movies_Valid() const{
    return m_movies_isValid;
}

QList<OAIAdd_new_ratings_request_seasons_inner> OAIAdd_new_ratings_request::getSeasons() const {
    return m_seasons;
}
void OAIAdd_new_ratings_request::setSeasons(const QList<OAIAdd_new_ratings_request_seasons_inner> &seasons) {
    m_seasons = seasons;
    m_seasons_isSet = true;
}

bool OAIAdd_new_ratings_request::is_seasons_Set() const{
    return m_seasons_isSet;
}

bool OAIAdd_new_ratings_request::is_seasons_Valid() const{
    return m_seasons_isValid;
}

QList<OAIAdd_new_ratings_request_shows_inner> OAIAdd_new_ratings_request::getShows() const {
    return m_shows;
}
void OAIAdd_new_ratings_request::setShows(const QList<OAIAdd_new_ratings_request_shows_inner> &shows) {
    m_shows = shows;
    m_shows_isSet = true;
}

bool OAIAdd_new_ratings_request::is_shows_Set() const{
    return m_shows_isSet;
}

bool OAIAdd_new_ratings_request::is_shows_Valid() const{
    return m_shows_isValid;
}

bool OAIAdd_new_ratings_request::isSet() const {
...
bool OAIAdd_new_ratings_request::isValid() const {
