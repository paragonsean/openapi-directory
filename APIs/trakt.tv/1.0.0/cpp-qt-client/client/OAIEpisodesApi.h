...
public:
    ...
    * @param[in]  episode qint32 [required]
    * @param[in]  trakt_api_version QString [optional]
    * @param[in]  trakt_api_key QString [optional]
    */
    virtual void get_a_single_episode_for_a_show(const QString &id, const qint32 &season, const qint32 &episode, const ::OpenAPI::OptionalParam<QString> &trakt_api_version = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &trakt_api_key = ::OpenAPI::OptionalParam<QString>());
    ...
    * @param[in]  trakt_api_key QString [optional]
    */
    virtual void get_all_episode_comments(const QString &id, const qint32 &season, const qint32 &episode, const QString &sort, const ::OpenAPI::OptionalParam<QString> &trakt_api_version = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &trakt_api_key = ::OpenAPI::OptionalParam<QString>());
    ...
    * @param[in]  trakt_api_key QString [optional]
    */
    virtual void get_all_episode_translations(const QString &id, const qint32 &season, const qint32 &episode, const QString &language, const ::OpenAPI::OptionalParam<QString> &trakt_api_version = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &trakt_api_key = ::OpenAPI::OptionalParam<QString>());
    ...
    * @param[in]  trakt_api_key QString [optional]
    */
    virtual void get_all_people_for_an_episode(const QString &id, const qint32 &season, const qint32 &episode, const ::OpenAPI::OptionalParam<QString> &trakt_api_version = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &trakt_api_key = ::OpenAPI::OptionalParam<QString>());
    ...
    * @param[in]  trakt_api_key QString [optional]
    */
    virtual void get_episode_ratings(const QString &id, const qint32 &season, const qint32 &episode, const ::OpenAPI::OptionalParam<QString> &trakt_api_version = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &trakt_api_key = ::OpenAPI::OptionalParam<QString>());
    ...
    * @param[in]  trakt_api_key QString [optional]
    */
    virtual void get_episode_stats(const QString &id, const qint32 &season, const qint32 &episode, const ::OpenAPI::OptionalParam<QString> &trakt_api_version = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &trakt_api_key = ::OpenAPI::OptionalParam<QString>());
    ...
    * @param[in]  trakt_api_key QString [optional]
    */
    virtual void get_lists_containing_this_episode(const QString &id, const qint32 &season, const qint32 &episode, const QString &type, const QString &sort, const ::OpenAPI::OptionalParam<QString> &trakt_api_version = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &trakt_api_key = ::OpenAPI::OptionalParam<QString>());
    ...
    * @param[in]  trakt_api_key QString [optional]
    */
    virtual void showsIdSeasonsSeasonEpisodesEpisodeWatchingGet(const QString &id, const qint32 &season, const qint32 &episode, const ::OpenAPI::OptionalParam<QString> &trakt_api_version = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &trakt_api_key = ::OpenAPI::OptionalParam<QString>());
...
private:
    ...
    void get_a_single_episode_for_a_showCallback(OAIHttpRequestWorker *worker);
    void get_all_episode_commentsCallback(OAIHttpRequestWorker *worker);
    void get_all_episode_translationsCallback(OAIHttpRequestWorker *worker);
    void get_all_people_for_an_episodeCallback(OAIHttpRequestWorker *worker);
    void get_episode_ratingsCallback(OAIHttpRequestWorker *worker);
    void get_episode_statsCallback(OAIHttpRequestWorker *worker);
    void get_lists_containing_this_episodeCallback(OAIHttpRequestWorker *worker);
    void showsIdSeasonsSeasonEpisodesEpisodeWatchingGetCallback(OAIHttpRequestWorker *worker);

Q_SIGNALS:

    void get_a_single_episode_for_a_showSignal();
    void get_all_episode_commentsSignal();
    void get_all_episode_translationsSignal();
    void get_all_people_for_an_episodeSignal();
    void get_episode_ratingsSignal();
    void get_episode_statsSignal();
    void get_lists_containing_this_episodeSignal();
    void showsIdSeasonsSeasonEpisodesEpisodeWatchingGetSignal();


    void get_a_single_episode_for_a_showSignalFull(OAIHttpRequestWorker *worker);
    void get_all_episode_commentsSignalFull(OAIHttpRequestWorker *worker);
    void get_all_episode_translationsSignalFull(OAIHttpRequestWorker *worker);
    void get_all_people_for_an_episodeSignalFull(OAIHttpRequestWorker *worker);
    void get_episode_ratingsSignalFull(OAIHttpRequestWorker *worker);
    void get_episode_statsSignalFull(OAIHttpRequestWorker *worker);
    void get_lists_containing_this_episodeSignalFull(OAIHttpRequestWorker *worker);
    void showsIdSeasonsSeasonEpisodesEpisodeWatchingGetSignalFull(OAIHttpRequestWorker *worker);

    Q_DECL_DEPRECATED_X("Use get_a_single_episode_for_a_showSignalError() instead")
    void get_a_single_episode_for_a_showSignalE(QNetworkReply::NetworkError error_type, QString error_str);
    void get_a_single_episode_for_a_showSignalError(QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use get_all_episode_commentsSignalError() instead")
    void get_all_episode_commentsSignalE(QNetworkReply::NetworkError error_type, QString error_str);
    void get_all_episode_commentsSignalError(QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use get_all_episode_translationsSignalError() instead")
    void get_all_episode_translationsSignalE(QNetworkReply::NetworkError error_type, QString error_str);
    void get_all_episode_translationsSignalError(QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use get_all_people_for_an_episodeSignalError() instead")
    void get_all_people_for_an_episodeSignalE(QNetworkReply::NetworkError error_type, QString error_str);
    void get_all_people_for_an_episodeSignalError(QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use get_episode_ratingsSignalError() instead")
    void get_episode_ratingsSignalE(QNetworkReply::NetworkError error_type, QString error_str);
    void get_episode_ratingsSignalError(QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use get_episode_statsSignalError() instead")
    void get_episode_statsSignalE(QNetworkReply::NetworkError error_type, QString error_str);
    void get_episode_statsSignalError(QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use get_lists_containing_this_episodeSignalError() instead")
    void get_lists_containing_this_episodeSignalE(QNetworkReply::NetworkError error_type, QString error_str);
    void get_lists_containing_this_episodeSignalError(QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use showsIdSeasonsSeasonEpisodesEpisodeWatchingGetSignalError() instead")
    void showsIdSeasonsSeasonEpisodesEpisodeWatchingGetSignalE(QNetworkReply::NetworkError error_type, QString error_str);
    void showsIdSeasonsSeasonEpisodesEpisodeWatchingGetSignalError(QNetworkReply::NetworkError error_type, const QString &error_str);

    Q_DECL_DEPRECATED_X("Use get_a_single_episode_for_a_showSignalErrorFull() instead")
    void get_a_single_episode_for_a_showSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void get_a_single_episode_for_a_showSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use get_all_episode_commentsSignalErrorFull() instead")
    void get_all_episode_commentsSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void get_all_episode_commentsSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use get_all_episode_translationsSignalErrorFull() instead")
    void get_all_episode_translationsSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void get_all_episode_translationsSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use get_all_people_for_an_episodeSignalErrorFull() instead")
    void get_all_people_for_an_episodeSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void get_all_people_for_an_episodeSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use get_episode_ratingsSignalErrorFull() instead")
    void get_episode_ratingsSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void get_episode_ratingsSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use get_episode_statsSignalErrorFull() instead")
    void get_episode_statsSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void get_episode_statsSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use get_lists_containing_this_episodeSignalErrorFull() instead")
    void get_lists_containing_this_episodeSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void get_lists_containing_this_episodeSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use showsIdSeasonsSeasonEpisodesEpisodeWatchingGetSignalErrorFull() instead")
    void showsIdSeasonsSeasonEpisodesEpisodeWatchingGetSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void showsIdSeasonsSeasonEpisodesEpisodeWatchingGetSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
