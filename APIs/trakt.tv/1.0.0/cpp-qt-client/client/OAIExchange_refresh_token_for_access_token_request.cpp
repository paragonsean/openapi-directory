...
OAIExchange_refresh_token_for_access_token_request::OAIExchange_refresh_token_for_access_token_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIExchange_refresh_token_for_access_token_request::OAIExchange_refresh_token_for_access_token_request() {
    this->initializeModel();
}

OAIExchange_refresh_token_for_access_token_request::~OAIExchange_refresh_token_for_access_token_request() {}

void OAIExchange_refresh_token_for_access_token_request::initializeModel() {
...
void OAIExchange_refresh_token_for_access_token_request::fromJson(QString jsonString) {
...
void OAIExchange_refresh_token_for_access_token_request::fromJsonObject(QJsonObject json) {
...
QString OAIExchange_refresh_token_for_access_token_request::asJson() const {
...
QJsonObject OAIExchange_refresh_token_for_access_token_request::asJsonObject() const {
    QJsonObject obj;
...
QString OAIExchange_refresh_token_for_access_token_request::getClientId() const {
    return m_client_id;
}
void OAIExchange_refresh_token_for_access_token_request::setClientId(const QString &client_id) {
    m_client_id = client_id;
    m_client_id_isSet = true;
}

bool OAIExchange_refresh_token_for_access_token_request::is_client_id_Set() const{
    return m_client_id_isSet;
}

bool OAIExchange_refresh_token_for_access_token_request::is_client_id_Valid() const{
    return m_client_id_isValid;
}

QString OAIExchange_refresh_token_for_access_token_request::getClientSecret() const {
    return m_client_secret;
}
void OAIExchange_refresh_token_for_access_token_request::setClientSecret(const QString &client_secret) {
    m_client_secret = client_secret;
    m_client_secret_isSet = true;
}

bool OAIExchange_refresh_token_for_access_token_request::is_client_secret_Set() const{
    return m_client_secret_isSet;
}

bool OAIExchange_refresh_token_for_access_token_request::is_client_secret_Valid() const{
    return m_client_secret_isValid;
}

QString OAIExchange_refresh_token_for_access_token_request::getGrantType() const {
    return m_grant_type;
}
void OAIExchange_refresh_token_for_access_token_request::setGrantType(const QString &grant_type) {
    m_grant_type = grant_type;
    m_grant_type_isSet = true;
}

bool OAIExchange_refresh_token_for_access_token_request::is_grant_type_Set() const{
    return m_grant_type_isSet;
}

bool OAIExchange_refresh_token_for_access_token_request::is_grant_type_Valid() const{
    return m_grant_type_isValid;
}

QString OAIExchange_refresh_token_for_access_token_request::getRedirectUri() const {
    return m_redirect_uri;
}
void OAIExchange_refresh_token_for_access_token_request::setRedirectUri(const QString &redirect_uri) {
    m_redirect_uri = redirect_uri;
    m_redirect_uri_isSet = true;
}

bool OAIExchange_refresh_token_for_access_token_request::is_redirect_uri_Set() const{
    return m_redirect_uri_isSet;
}

bool OAIExchange_refresh_token_for_access_token_request::is_redirect_uri_Valid() const{
    return m_redirect_uri_isValid;
}

QString OAIExchange_refresh_token_for_access_token_request::getRefreshToken() const {
    return m_refresh_token;
}
void OAIExchange_refresh_token_for_access_token_request::setRefreshToken(const QString &refresh_token) {
    m_refresh_token = refresh_token;
    m_refresh_token_isSet = true;
}

bool OAIExchange_refresh_token_for_access_token_request::is_refresh_token_Set() const{
    return m_refresh_token_isSet;
}

bool OAIExchange_refresh_token_for_access_token_request::is_refresh_token_Valid() const{
    return m_refresh_token_isValid;
}

bool OAIExchange_refresh_token_for_access_token_request::isSet() const {
...
bool OAIExchange_refresh_token_for_access_token_request::isValid() const {
