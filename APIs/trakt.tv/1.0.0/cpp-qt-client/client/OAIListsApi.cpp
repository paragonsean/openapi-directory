...
void OAIListsApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("get_all_list_comments", defaultConf);
    _serverIndices.insert("get_all_list_comments", 0);
    _serverConfigs.insert("get_all_users_who_liked_a_list", defaultConf);
    _serverIndices.insert("get_all_users_who_liked_a_list", 0);
    _serverConfigs.insert("get_items_on_a_list", defaultConf);
    _serverIndices.insert("get_items_on_a_list", 0);
    _serverConfigs.insert("get_list", defaultConf);
    _serverIndices.insert("get_list", 0);
    _serverConfigs.insert("get_popular_lists", defaultConf);
    _serverIndices.insert("get_popular_lists", 0);
    _serverConfigs.insert("get_trending_lists", defaultConf);
    _serverIndices.insert("get_trending_lists", 0);
}
...
void OAIListsApi::get_all_list_comments(const qint32 &id, const QString &sort, const ::OpenAPI::OptionalParam<QString> &trakt_api_version, const ::OpenAPI::OptionalParam<QString> &trakt_api_key) {
    QString fullPath = QString(_serverConfigs["get_all_list_comments"][_serverIndices.value("get_all_list_comments")].URL()+"/lists/{id}/comments/{sort}");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIListsApi::get_all_list_commentsCallback);
...
void OAIListsApi::get_all_list_commentsCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT get_all_list_commentsSignal();
        Q_EMIT get_all_list_commentsSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT get_all_list_commentsSignalE(error_type, error_str);
        Q_EMIT get_all_list_commentsSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT get_all_list_commentsSignalError(error_type, error_str);
        Q_EMIT get_all_list_commentsSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIListsApi::get_all_users_who_liked_a_list(const QString &id, const ::OpenAPI::OptionalParam<QString> &trakt_api_version, const ::OpenAPI::OptionalParam<QString> &trakt_api_key) {
    QString fullPath = QString(_serverConfigs["get_all_users_who_liked_a_list"][_serverIndices.value("get_all_users_who_liked_a_list")].URL()+"/lists/{id}/likes");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIListsApi::get_all_users_who_liked_a_listCallback);
    connect(this, &OAIListsApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIListsApi::get_all_users_who_liked_a_listCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT get_all_users_who_liked_a_listSignal();
        Q_EMIT get_all_users_who_liked_a_listSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT get_all_users_who_liked_a_listSignalE(error_type, error_str);
        Q_EMIT get_all_users_who_liked_a_listSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT get_all_users_who_liked_a_listSignalError(error_type, error_str);
        Q_EMIT get_all_users_who_liked_a_listSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIListsApi::get_items_on_a_list(const QString &id, const QString &type, const ::OpenAPI::OptionalParam<QString> &trakt_api_version, const ::OpenAPI::OptionalParam<QString> &trakt_api_key) {
    QString fullPath = QString(_serverConfigs["get_items_on_a_list"][_serverIndices.value("get_items_on_a_list")].URL()+"/lists/{id}/items/{type}");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIListsApi::get_items_on_a_listCallback);
    connect(this, &OAIListsApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIListsApi::get_items_on_a_listCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT get_items_on_a_listSignal();
        Q_EMIT get_items_on_a_listSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT get_items_on_a_listSignalE(error_type, error_str);
        Q_EMIT get_items_on_a_listSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT get_items_on_a_listSignalError(error_type, error_str);
        Q_EMIT get_items_on_a_listSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIListsApi::get_list(const qint32 &id, const ::OpenAPI::OptionalParam<QString> &trakt_api_version, const ::OpenAPI::OptionalParam<QString> &trakt_api_key) {
    QString fullPath = QString(_serverConfigs["get_list"][_serverIndices.value("get_list")].URL()+"/lists/{id}");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIListsApi::get_listCallback);
    connect(this, &OAIListsApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIListsApi::get_listCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT get_listSignal();
        Q_EMIT get_listSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT get_listSignalE(error_type, error_str);
        Q_EMIT get_listSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT get_listSignalError(error_type, error_str);
        Q_EMIT get_listSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIListsApi::get_popular_lists(const ::OpenAPI::OptionalParam<QString> &trakt_api_version, const ::OpenAPI::OptionalParam<QString> &trakt_api_key) {
    QString fullPath = QString(_serverConfigs["get_popular_lists"][_serverIndices.value("get_popular_lists")].URL()+"/lists/popular");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIListsApi::get_popular_listsCallback);
    connect(this, &OAIListsApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIListsApi::get_popular_listsCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT get_popular_listsSignal();
        Q_EMIT get_popular_listsSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT get_popular_listsSignalE(error_type, error_str);
        Q_EMIT get_popular_listsSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT get_popular_listsSignalError(error_type, error_str);
        Q_EMIT get_popular_listsSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIListsApi::get_trending_lists(const ::OpenAPI::OptionalParam<QString> &trakt_api_version, const ::OpenAPI::OptionalParam<QString> &trakt_api_key) {
    QString fullPath = QString(_serverConfigs["get_trending_lists"][_serverIndices.value("get_trending_lists")].URL()+"/lists/trending");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIListsApi::get_trending_listsCallback);
    connect(this, &OAIListsApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIListsApi::get_trending_listsCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT get_trending_listsSignal();
        Q_EMIT get_trending_listsSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT get_trending_listsSignalE(error_type, error_str);
        Q_EMIT get_trending_listsSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT get_trending_listsSignalError(error_type, error_str);
        Q_EMIT get_trending_listsSignalErrorFull(worker, error_type, error_str);
    }
}
