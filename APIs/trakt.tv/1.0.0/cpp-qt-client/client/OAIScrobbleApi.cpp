...
OAIScrobbleApi::OAIScrobbleApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAIScrobbleApi::~OAIScrobbleApi() {
}

void OAIScrobbleApi::initializeServerConfigs() {
    //Default server
    ...
    _serverConfigs.insert("pause_watching_in_a_media_center", defaultConf);
    _serverIndices.insert("pause_watching_in_a_media_center", 0);
    _serverConfigs.insert("start_watching_in_a_media_center", defaultConf);
    _serverIndices.insert("start_watching_in_a_media_center", 0);
    _serverConfigs.insert("stop_or_finish_watching_in_a_media_center", defaultConf);
    _serverIndices.insert("stop_or_finish_watching_in_a_media_center", 0);
}
...
*/
int OAIScrobbleApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAIScrobbleApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAIScrobbleApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAIScrobbleApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAIScrobbleApi::setUsername(const QString &username) {
    _username = username;
}

void OAIScrobbleApi::setPassword(const QString &password) {
    _password = password;
}


void OAIScrobbleApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAIScrobbleApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAIScrobbleApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAIScrobbleApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAIScrobbleApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAIScrobbleApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAIScrobbleApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAIScrobbleApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAIScrobbleApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAIScrobbleApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAIScrobbleApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAIScrobbleApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAIScrobbleApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAIScrobbleApi::pause_watching_in_a_media_center(const ::OpenAPI::OptionalParam<QString> &trakt_api_version, const ::OpenAPI::OptionalParam<QString> &trakt_api_key, const ::OpenAPI::OptionalParam<OAIPause_watching_in_a_media_center_request> &oai_pause_watching_in_a_media_center_request) {
    QString fullPath = QString(_serverConfigs["pause_watching_in_a_media_center"][_serverIndices.value("pause_watching_in_a_media_center")].URL()+"/scrobble/pause");
    ...
    if (oai_pause_watching_in_a_media_center_request.hasValue()){

        
        QByteArray output = oai_pause_watching_in_a_media_center_request.value().asJson().toUtf8();
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIScrobbleApi::pause_watching_in_a_media_centerCallback);
    connect(this, &OAIScrobbleApi::abortRequestsSignal, worker, &QObject::deleteLater);
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIScrobbleApi::pause_watching_in_a_media_centerCallback);
    connect(this, &OAIScrobbleApi::abortRequestsSignal, _latestWorker, &QObject::deleteLater);
...
void OAIScrobbleApi::pause_watching_in_a_media_centerCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT pause_watching_in_a_media_centerSignal();
        Q_EMIT pause_watching_in_a_media_centerSignalFull(worker);
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT pause_watching_in_a_media_centerSignalE(error_type, error_str);
        Q_EMIT pause_watching_in_a_media_centerSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT pause_watching_in_a_media_centerSignalError(error_type, error_str);
        Q_EMIT pause_watching_in_a_media_centerSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIScrobbleApi::start_watching_in_a_media_center(const ::OpenAPI::OptionalParam<QString> &trakt_api_version, const ::OpenAPI::OptionalParam<QString> &trakt_api_key, const ::OpenAPI::OptionalParam<OAIStart_watching_in_a_media_center_request> &oai_start_watching_in_a_media_center_request) {
    QString fullPath = QString(_serverConfigs["start_watching_in_a_media_center"][_serverIndices.value("start_watching_in_a_media_center")].URL()+"/scrobble/start");
    ...
    if (oai_start_watching_in_a_media_center_request.hasValue()){

        
        QByteArray output = oai_start_watching_in_a_media_center_request.value().asJson().toUtf8();
        input.request_body.append(output);
    }
    if (trakt_api_version.hasValue())
    {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIScrobbleApi::start_watching_in_a_media_centerCallback);
    connect(this, &OAIScrobbleApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIScrobbleApi::start_watching_in_a_media_centerCallback);
    connect(this, &OAIScrobbleApi::abortRequestsSignal, _latestWorker, &QObject::deleteLater);
    connect(_latestWorker, &QObject::destroyed, [this](){
        if(findChildren<OAIHttpRequestWorker*>().count() == 0){
            Q_EMIT allPendingRequestsCompleted();
...
void OAIScrobbleApi::start_watching_in_a_media_centerCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT start_watching_in_a_media_centerSignal();
        Q_EMIT start_watching_in_a_media_centerSignalFull(worker);
    } else if(worker->error_type == QNetworkReply::AuthenticationRequiredError){
        connect(&_authFlow, SIGNAL(tokenReceived()), this, SLOT(tokenAvailable()));
        QStringList scope;
        QString scopeStr = scope.join(" ");
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT start_watching_in_a_media_centerSignalE(error_type, error_str);
        Q_EMIT start_watching_in_a_media_centerSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT start_watching_in_a_media_centerSignalError(error_type, error_str);
        Q_EMIT start_watching_in_a_media_centerSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIScrobbleApi::stop_or_finish_watching_in_a_media_center(const ::OpenAPI::OptionalParam<QString> &trakt_api_version, const ::OpenAPI::OptionalParam<QString> &trakt_api_key, const ::OpenAPI::OptionalParam<OAIStop_or_finish_watching_in_a_media_center_request> &oai_stop_or_finish_watching_in_a_media_center_request) {
    QString fullPath = QString(_serverConfigs["stop_or_finish_watching_in_a_media_center"][_serverIndices.value("stop_or_finish_watching_in_a_media_center")].URL()+"/scrobble/stop");
    ...
    if (oai_stop_or_finish_watching_in_a_media_center_request.hasValue()){

        
        QByteArray output = oai_stop_or_finish_watching_in_a_media_center_request.value().asJson().toUtf8();
        input.request_body.append(output);
    }
    if (trakt_api_version.hasValue())
    {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIScrobbleApi::stop_or_finish_watching_in_a_media_centerCallback);
    connect(this, &OAIScrobbleApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIScrobbleApi::stop_or_finish_watching_in_a_media_centerCallback);
    connect(this, &OAIScrobbleApi::abortRequestsSignal, _latestWorker, &QObject::deleteLater);
    connect(_latestWorker, &QObject::destroyed, [this](){
        if(findChildren<OAIHttpRequestWorker*>().count() == 0){
            Q_EMIT allPendingRequestsCompleted();
...
void OAIScrobbleApi::stop_or_finish_watching_in_a_media_centerCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT stop_or_finish_watching_in_a_media_centerSignal();
        Q_EMIT stop_or_finish_watching_in_a_media_centerSignalFull(worker);
    } else if(worker->error_type == QNetworkReply::AuthenticationRequiredError){
        connect(&_authFlow, SIGNAL(tokenReceived()), this, SLOT(tokenAvailable()));
        QStringList scope;
        QString scopeStr = scope.join(" ");
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT stop_or_finish_watching_in_a_media_centerSignalE(error_type, error_str);
        Q_EMIT stop_or_finish_watching_in_a_media_centerSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT stop_or_finish_watching_in_a_media_centerSignalError(error_type, error_str);
        Q_EMIT stop_or_finish_watching_in_a_media_centerSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIScrobbleApi::tokenAvailable(){
