...
void OAIRecommendationsApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("get_movie_recommendations", defaultConf);
    _serverIndices.insert("get_movie_recommendations", 0);
    _serverConfigs.insert("get_show_recommendations", defaultConf);
    _serverIndices.insert("get_show_recommendations", 0);
    _serverConfigs.insert("hide_a_movie_recommendation", defaultConf);
    _serverIndices.insert("hide_a_movie_recommendation", 0);
    _serverConfigs.insert("hide_a_show_recommendation", defaultConf);
    _serverIndices.insert("hide_a_show_recommendation", 0);
}
...
void OAIRecommendationsApi::get_movie_recommendations(const ::OpenAPI::OptionalParam<QString> &ignore_collected, const ::OpenAPI::OptionalParam<QString> &ignore_watchlisted, const ::OpenAPI::OptionalParam<QString> &trakt_api_version, const ::OpenAPI::OptionalParam<QString> &trakt_api_key) {
    QString fullPath = QString(_serverConfigs["get_movie_recommendations"][_serverIndices.value("get_movie_recommendations")].URL()+"/recommendations/movies");
    
    QString queryPrefix, querySuffix, queryDelimiter, queryStyle;
    if (ignore_collected.hasValue())
    {
        queryStyle = "form";
        if (queryStyle == "")
            queryStyle = "form";
        ...
        queryDelimiter = getParamStyleDelimiter(queryStyle, "ignore_collected", true);
        if (fullPath.indexOf("?") > 0)
            fullPath.append(queryPrefix);
        else
            fullPath.append("?");

        fullPath.append(QUrl::toPercentEncoding("ignore_collected")).append(querySuffix).append(QUrl::toPercentEncoding(ignore_collected.stringValue()));
    }
    if (ignore_watchlisted.hasValue())
    {
        queryStyle = "form";
        if (queryStyle == "")
            queryStyle = "form";
        queryPrefix = getParamStylePrefix(queryStyle);
        querySuffix = getParamStyleSuffix(queryStyle);
        queryDelimiter = getParamStyleDelimiter(queryStyle, "ignore_watchlisted", true);
        if (fullPath.indexOf("?") > 0)
            fullPath.append(queryPrefix);
        else
            fullPath.append("?");

        fullPath.append(QUrl::toPercentEncoding("ignore_watchlisted")).append(querySuffix).append(QUrl::toPercentEncoding(ignore_watchlisted.stringValue()));
    }
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIRecommendationsApi::get_movie_recommendationsCallback);
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIRecommendationsApi::get_movie_recommendationsCallback);
...
void OAIRecommendationsApi::get_movie_recommendationsCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT get_movie_recommendationsSignal();
        Q_EMIT get_movie_recommendationsSignalFull(worker);
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT get_movie_recommendationsSignalE(error_type, error_str);
        Q_EMIT get_movie_recommendationsSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT get_movie_recommendationsSignalError(error_type, error_str);
        Q_EMIT get_movie_recommendationsSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIRecommendationsApi::get_show_recommendations(const ::OpenAPI::OptionalParam<QString> &ignore_collected, const ::OpenAPI::OptionalParam<QString> &ignore_watchlisted, const ::OpenAPI::OptionalParam<QString> &trakt_api_version, const ::OpenAPI::OptionalParam<QString> &trakt_api_key) {
    QString fullPath = QString(_serverConfigs["get_show_recommendations"][_serverIndices.value("get_show_recommendations")].URL()+"/recommendations/shows");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIRecommendationsApi::get_show_recommendationsCallback);
    connect(this, &OAIRecommendationsApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIRecommendationsApi::get_show_recommendationsCallback);
    connect(this, &OAIRecommendationsApi::abortRequestsSignal, _latestWorker, &QObject::deleteLater);
    connect(_latestWorker, &QObject::destroyed, [this](){
        if(findChildren<OAIHttpRequestWorker*>().count() == 0){
            Q_EMIT allPendingRequestsCompleted();
...
void OAIRecommendationsApi::get_show_recommendationsCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT get_show_recommendationsSignal();
        Q_EMIT get_show_recommendationsSignalFull(worker);
    } else if(worker->error_type == QNetworkReply::AuthenticationRequiredError){
        connect(&_authFlow, SIGNAL(tokenReceived()), this, SLOT(tokenAvailable()));
        QStringList scope;
        QString scopeStr = scope.join(" ");
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT get_show_recommendationsSignalE(error_type, error_str);
        Q_EMIT get_show_recommendationsSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT get_show_recommendationsSignalError(error_type, error_str);
        Q_EMIT get_show_recommendationsSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIRecommendationsApi::hide_a_movie_recommendation(const QString &id, const ::OpenAPI::OptionalParam<QString> &trakt_api_version, const ::OpenAPI::OptionalParam<QString> &trakt_api_key) {
    QString fullPath = QString(_serverConfigs["hide_a_movie_recommendation"][_serverIndices.value("hide_a_movie_recommendation")].URL()+"/recommendations/movies/{id}");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIRecommendationsApi::hide_a_movie_recommendationCallback);
    connect(this, &OAIRecommendationsApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIRecommendationsApi::hide_a_movie_recommendationCallback);
    connect(this, &OAIRecommendationsApi::abortRequestsSignal, _latestWorker, &QObject::deleteLater);
    connect(_latestWorker, &QObject::destroyed, [this](){
        if(findChildren<OAIHttpRequestWorker*>().count() == 0){
            Q_EMIT allPendingRequestsCompleted();
...
void OAIRecommendationsApi::hide_a_movie_recommendationCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT hide_a_movie_recommendationSignal();
        Q_EMIT hide_a_movie_recommendationSignalFull(worker);
    } else if(worker->error_type == QNetworkReply::AuthenticationRequiredError){
        connect(&_authFlow, SIGNAL(tokenReceived()), this, SLOT(tokenAvailable()));
        QStringList scope;
        QString scopeStr = scope.join(" ");
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT hide_a_movie_recommendationSignalE(error_type, error_str);
        Q_EMIT hide_a_movie_recommendationSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT hide_a_movie_recommendationSignalError(error_type, error_str);
        Q_EMIT hide_a_movie_recommendationSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIRecommendationsApi::hide_a_show_recommendation(const QString &id, const ::OpenAPI::OptionalParam<QString> &trakt_api_version, const ::OpenAPI::OptionalParam<QString> &trakt_api_key) {
    QString fullPath = QString(_serverConfigs["hide_a_show_recommendation"][_serverIndices.value("hide_a_show_recommendation")].URL()+"/recommendations/shows/{id}");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIRecommendationsApi::hide_a_show_recommendationCallback);
    connect(this, &OAIRecommendationsApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIRecommendationsApi::hide_a_show_recommendationCallback);
    connect(this, &OAIRecommendationsApi::abortRequestsSignal, _latestWorker, &QObject::deleteLater);
    connect(_latestWorker, &QObject::destroyed, [this](){
        if(findChildren<OAIHttpRequestWorker*>().count() == 0){
            Q_EMIT allPendingRequestsCompleted();
...
void OAIRecommendationsApi::hide_a_show_recommendationCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT hide_a_show_recommendationSignal();
        Q_EMIT hide_a_show_recommendationSignalFull(worker);
    } else if(worker->error_type == QNetworkReply::AuthenticationRequiredError){
        connect(&_authFlow, SIGNAL(tokenReceived()), this, SLOT(tokenAvailable()));
        QStringList scope;
        QString scopeStr = scope.join(" ");
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT hide_a_show_recommendationSignalE(error_type, error_str);
        Q_EMIT hide_a_show_recommendationSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT hide_a_show_recommendationSignalError(error_type, error_str);
        Q_EMIT hide_a_show_recommendationSignalErrorFull(worker, error_type, error_str);
    }
}
