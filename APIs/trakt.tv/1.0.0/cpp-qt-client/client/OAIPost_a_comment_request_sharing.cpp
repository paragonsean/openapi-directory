...
#include "OAIPost_a_comment_request_sharing.h"
...
OAIPost_a_comment_request_sharing::OAIPost_a_comment_request_sharing(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPost_a_comment_request_sharing::OAIPost_a_comment_request_sharing() {
    this->initializeModel();
}

OAIPost_a_comment_request_sharing::~OAIPost_a_comment_request_sharing() {}

void OAIPost_a_comment_request_sharing::initializeModel() {
...
void OAIPost_a_comment_request_sharing::fromJson(QString jsonString) {
...
void OAIPost_a_comment_request_sharing::fromJsonObject(QJsonObject json) {
...
QString OAIPost_a_comment_request_sharing::asJson() const {
...
QJsonObject OAIPost_a_comment_request_sharing::asJsonObject() const {
    QJsonObject obj;
    if (m_medium_isSet) {
...
bool OAIPost_a_comment_request_sharing::isMedium() const {
    return m_medium;
}
void OAIPost_a_comment_request_sharing::setMedium(const bool &medium) {
    m_medium = medium;
    m_medium_isSet = true;
}

bool OAIPost_a_comment_request_sharing::is_medium_Set() const{
    return m_medium_isSet;
}

bool OAIPost_a_comment_request_sharing::is_medium_Valid() const{
    return m_medium_isValid;
}

bool OAIPost_a_comment_request_sharing::isTumblr() const {
    return m_tumblr;
}
void OAIPost_a_comment_request_sharing::setTumblr(const bool &tumblr) {
    m_tumblr = tumblr;
    m_tumblr_isSet = true;
}

bool OAIPost_a_comment_request_sharing::is_tumblr_Set() const{
    return m_tumblr_isSet;
}

bool OAIPost_a_comment_request_sharing::is_tumblr_Valid() const{
    return m_tumblr_isValid;
}

bool OAIPost_a_comment_request_sharing::isTwitter() const {
    return m_twitter;
}
void OAIPost_a_comment_request_sharing::setTwitter(const bool &twitter) {
    m_twitter = twitter;
    m_twitter_isSet = true;
}

bool OAIPost_a_comment_request_sharing::is_twitter_Set() const{
    return m_twitter_isSet;
}

bool OAIPost_a_comment_request_sharing::is_twitter_Valid() const{
    return m_twitter_isValid;
}

bool OAIPost_a_comment_request_sharing::isSet() const {
...
bool OAIPost_a_comment_request_sharing::isValid() const {
