...
#include "OAIAdd_items_to_collection_request_movies_inner.h"
...
OAIAdd_items_to_collection_request_movies_inner::OAIAdd_items_to_collection_request_movies_inner(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAdd_items_to_collection_request_movies_inner::OAIAdd_items_to_collection_request_movies_inner() {
    this->initializeModel();
}

OAIAdd_items_to_collection_request_movies_inner::~OAIAdd_items_to_collection_request_movies_inner() {}

void OAIAdd_items_to_collection_request_movies_inner::initializeModel() {
    ...
    m_collected_at_isSet = false;
    m_collected_at_isValid = false;
...
void OAIAdd_items_to_collection_request_movies_inner::fromJson(QString jsonString) {
...
void OAIAdd_items_to_collection_request_movies_inner::fromJsonObject(QJsonObject json) {
    ...
    m_collected_at_isValid = ::OpenAPI::fromJsonValue(m_collected_at, json[QString("collected_at")]);
    m_collected_at_isSet = !json[QString("collected_at")].isNull() && m_collected_at_isValid;
...
QString OAIAdd_items_to_collection_request_movies_inner::asJson() const {
...
QJsonObject OAIAdd_items_to_collection_request_movies_inner::asJsonObject() const {
    QJsonObject obj;
    if (m_audio_isSet) {
    ...
    if (m_collected_at_isSet) {
        obj.insert(QString("collected_at"), ::OpenAPI::toJsonValue(m_collected_at));
    }
    if (m_hdr_isSet) {
...
QString OAIAdd_items_to_collection_request_movies_inner::getAudio() const {
    return m_audio;
}
void OAIAdd_items_to_collection_request_movies_inner::setAudio(const QString &audio) {
    m_audio = audio;
    m_audio_isSet = true;
}

bool OAIAdd_items_to_collection_request_movies_inner::is_audio_Set() const{
    return m_audio_isSet;
}

bool OAIAdd_items_to_collection_request_movies_inner::is_audio_Valid() const{
    return m_audio_isValid;
}

QString OAIAdd_items_to_collection_request_movies_inner::getAudioChannels() const {
    return m_audio_channels;
}
void OAIAdd_items_to_collection_request_movies_inner::setAudioChannels(const QString &audio_channels) {
    m_audio_channels = audio_channels;
    m_audio_channels_isSet = true;
}

bool OAIAdd_items_to_collection_request_movies_inner::is_audio_channels_Set() const{
    return m_audio_channels_isSet;
}

bool OAIAdd_items_to_collection_request_movies_inner::is_audio_channels_Valid() const{
    return m_audio_channels_isValid;
}

QString OAIAdd_items_to_collection_request_movies_inner::getCollectedAt() const {
    return m_collected_at;
}
void OAIAdd_items_to_collection_request_movies_inner::setCollectedAt(const QString &collected_at) {
    m_collected_at = collected_at;
    m_collected_at_isSet = true;
}

bool OAIAdd_items_to_collection_request_movies_inner::is_collected_at_Set() const{
    return m_collected_at_isSet;
}

bool OAIAdd_items_to_collection_request_movies_inner::is_collected_at_Valid() const{
    return m_collected_at_isValid;
}

QString OAIAdd_items_to_collection_request_movies_inner::getHdr() const {
    return m_hdr;
}
void OAIAdd_items_to_collection_request_movies_inner::setHdr(const QString &hdr) {
    m_hdr = hdr;
    m_hdr_isSet = true;
}

bool OAIAdd_items_to_collection_request_movies_inner::is_hdr_Set() const{
    return m_hdr_isSet;
}

bool OAIAdd_items_to_collection_request_movies_inner::is_hdr_Valid() const{
    return m_hdr_isValid;
}

OAICheck_into_an_item_request_movie_ids OAIAdd_items_to_collection_request_movies_inner::getIds() const {
    return m_ids;
}
void OAIAdd_items_to_collection_request_movies_inner::setIds(const OAICheck_into_an_item_request_movie_ids &ids) {
    m_ids = ids;
    m_ids_isSet = true;
}

bool OAIAdd_items_to_collection_request_movies_inner::is_ids_Set() const{
    return m_ids_isSet;
}

bool OAIAdd_items_to_collection_request_movies_inner::is_ids_Valid() const{
    return m_ids_isValid;
}

QString OAIAdd_items_to_collection_request_movies_inner::getMediaType() const {
    return m_media_type;
}
void OAIAdd_items_to_collection_request_movies_inner::setMediaType(const QString &media_type) {
    m_media_type = media_type;
    m_media_type_isSet = true;
}

bool OAIAdd_items_to_collection_request_movies_inner::is_media_type_Set() const{
    return m_media_type_isSet;
}

bool OAIAdd_items_to_collection_request_movies_inner::is_media_type_Valid() const{
    return m_media_type_isValid;
}

QString OAIAdd_items_to_collection_request_movies_inner::getResolution() const {
    return m_resolution;
}
void OAIAdd_items_to_collection_request_movies_inner::setResolution(const QString &resolution) {
    m_resolution = resolution;
    m_resolution_isSet = true;
}

bool OAIAdd_items_to_collection_request_movies_inner::is_resolution_Set() const{
    return m_resolution_isSet;
}

bool OAIAdd_items_to_collection_request_movies_inner::is_resolution_Valid() const{
    return m_resolution_isValid;
}

QString OAIAdd_items_to_collection_request_movies_inner::getTitle() const {
    return m_title;
}
void OAIAdd_items_to_collection_request_movies_inner::setTitle(const QString &title) {
    m_title = title;
    m_title_isSet = true;
}

bool OAIAdd_items_to_collection_request_movies_inner::is_title_Set() const{
    return m_title_isSet;
}

bool OAIAdd_items_to_collection_request_movies_inner::is_title_Valid() const{
    return m_title_isValid;
}

double OAIAdd_items_to_collection_request_movies_inner::getYear() const {
    return m_year;
}
void OAIAdd_items_to_collection_request_movies_inner::setYear(const double &year) {
    m_year = year;
    m_year_isSet = true;
}

bool OAIAdd_items_to_collection_request_movies_inner::is_year_Set() const{
    return m_year_isSet;
}

bool OAIAdd_items_to_collection_request_movies_inner::is_year_Valid() const{
    return m_year_isValid;
}

bool OAIAdd_items_to_collection_request_movies_inner::isSet() const {
...
bool OAIAdd_items_to_collection_request_movies_inner::isValid() const {
