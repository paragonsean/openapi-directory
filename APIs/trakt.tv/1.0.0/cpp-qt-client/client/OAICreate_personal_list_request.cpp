...
OAICreate_personal_list_request::OAICreate_personal_list_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreate_personal_list_request::OAICreate_personal_list_request() {
    this->initializeModel();
}

OAICreate_personal_list_request::~OAICreate_personal_list_request() {}

void OAICreate_personal_list_request::initializeModel() {
    ...
    m_display_numbers_isSet = false;
    m_display_numbers_isValid = false;
    ...
    m_sort_how_isSet = false;
    m_sort_how_isValid = false;
}

void OAICreate_personal_list_request::fromJson(QString jsonString) {
...
void OAICreate_personal_list_request::fromJsonObject(QJsonObject json) {

    m_allow_comments_isValid = ::OpenAPI::fromJsonValue(m_allow_comments, json[QString("allow_comments")]);
    m_allow_comments_isSet = !json[QString("allow_comments")].isNull() && m_allow_comments_isValid;

    m_description_isValid = ::OpenAPI::fromJsonValue(m_description, json[QString("description")]);
    m_description_isSet = !json[QString("description")].isNull() && m_description_isValid;

    m_display_numbers_isValid = ::OpenAPI::fromJsonValue(m_display_numbers, json[QString("display_numbers")]);
    m_display_numbers_isSet = !json[QString("display_numbers")].isNull() && m_display_numbers_isValid;
    ...
    m_sort_how_isValid = ::OpenAPI::fromJsonValue(m_sort_how, json[QString("sort_how")]);
    m_sort_how_isSet = !json[QString("sort_how")].isNull() && m_sort_how_isValid;
}

QString OAICreate_personal_list_request::asJson() const {
...
QJsonObject OAICreate_personal_list_request::asJsonObject() const {
    QJsonObject obj;
    if (m_allow_comments_isSet) {
        obj.insert(QString("allow_comments"), ::OpenAPI::toJsonValue(m_allow_comments));
    }
    if (m_description_isSet) {
        obj.insert(QString("description"), ::OpenAPI::toJsonValue(m_description));
    }
    if (m_display_numbers_isSet) {
        obj.insert(QString("display_numbers"), ::OpenAPI::toJsonValue(m_display_numbers));
    }
    if (m_name_isSet) {
    ...
    if (m_sort_how_isSet) {
        obj.insert(QString("sort_how"), ::OpenAPI::toJsonValue(m_sort_how));
    }
    return obj;
}

bool OAICreate_personal_list_request::isAllowComments() const {
    return m_allow_comments;
}
void OAICreate_personal_list_request::setAllowComments(const bool &allow_comments) {
    m_allow_comments = allow_comments;
    m_allow_comments_isSet = true;
}

bool OAICreate_personal_list_request::is_allow_comments_Set() const{
    return m_allow_comments_isSet;
}

bool OAICreate_personal_list_request::is_allow_comments_Valid() const{
    return m_allow_comments_isValid;
}

QString OAICreate_personal_list_request::getDescription() const {
    return m_description;
}
void OAICreate_personal_list_request::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAICreate_personal_list_request::is_description_Set() const{
    return m_description_isSet;
}

bool OAICreate_personal_list_request::is_description_Valid() const{
    return m_description_isValid;
}

bool OAICreate_personal_list_request::isDisplayNumbers() const {
    return m_display_numbers;
}
void OAICreate_personal_list_request::setDisplayNumbers(const bool &display_numbers) {
    m_display_numbers = display_numbers;
    m_display_numbers_isSet = true;
}

bool OAICreate_personal_list_request::is_display_numbers_Set() const{
    return m_display_numbers_isSet;
}

bool OAICreate_personal_list_request::is_display_numbers_Valid() const{
    return m_display_numbers_isValid;
}

QString OAICreate_personal_list_request::getName() const {
    return m_name;
}
void OAICreate_personal_list_request::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAICreate_personal_list_request::is_name_Set() const{
    return m_name_isSet;
}

bool OAICreate_personal_list_request::is_name_Valid() const{
    return m_name_isValid;
}

QString OAICreate_personal_list_request::getPrivacy() const {
    return m_privacy;
}
void OAICreate_personal_list_request::setPrivacy(const QString &privacy) {
    m_privacy = privacy;
    m_privacy_isSet = true;
}

bool OAICreate_personal_list_request::is_privacy_Set() const{
    return m_privacy_isSet;
}

bool OAICreate_personal_list_request::is_privacy_Valid() const{
    return m_privacy_isValid;
}

QString OAICreate_personal_list_request::getSortBy() const {
    return m_sort_by;
}
void OAICreate_personal_list_request::setSortBy(const QString &sort_by) {
    m_sort_by = sort_by;
    m_sort_by_isSet = true;
}

bool OAICreate_personal_list_request::is_sort_by_Set() const{
    return m_sort_by_isSet;
}

bool OAICreate_personal_list_request::is_sort_by_Valid() const{
    return m_sort_by_isValid;
}

QString OAICreate_personal_list_request::getSortHow() const {
    return m_sort_how;
}
void OAICreate_personal_list_request::setSortHow(const QString &sort_how) {
    m_sort_how = sort_how;
    m_sort_how_isSet = true;
}

bool OAICreate_personal_list_request::is_sort_how_Set() const{
    return m_sort_how_isSet;
}

bool OAICreate_personal_list_request::is_sort_how_Valid() const{
    return m_sort_how_isValid;
}

bool OAICreate_personal_list_request::isSet() const {
...
bool OAICreate_personal_list_request::isValid() const {
