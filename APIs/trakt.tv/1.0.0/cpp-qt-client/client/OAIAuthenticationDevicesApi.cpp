...
#include "OAIAuthenticationDevicesApi.h"
...
OAIAuthenticationDevicesApi::OAIAuthenticationDevicesApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAIAuthenticationDevicesApi::~OAIAuthenticationDevicesApi() {
}

void OAIAuthenticationDevicesApi::initializeServerConfigs() {
    //Default server
    ...
    _serverConfigs.insert("generate_new_device_codes", defaultConf);
    _serverIndices.insert("generate_new_device_codes", 0);
    _serverConfigs.insert("poll_for_the_accessToken", defaultConf);
    _serverIndices.insert("poll_for_the_accessToken", 0);
}
...
*/
int OAIAuthenticationDevicesApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAIAuthenticationDevicesApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAIAuthenticationDevicesApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAIAuthenticationDevicesApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAIAuthenticationDevicesApi::setUsername(const QString &username) {
    _username = username;
}

void OAIAuthenticationDevicesApi::setPassword(const QString &password) {
    _password = password;
}


void OAIAuthenticationDevicesApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAIAuthenticationDevicesApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAIAuthenticationDevicesApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAIAuthenticationDevicesApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAIAuthenticationDevicesApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAIAuthenticationDevicesApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAIAuthenticationDevicesApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAIAuthenticationDevicesApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAIAuthenticationDevicesApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAIAuthenticationDevicesApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAIAuthenticationDevicesApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAIAuthenticationDevicesApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAIAuthenticationDevicesApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAIAuthenticationDevicesApi::generate_new_device_codes(const ::OpenAPI::OptionalParam<OAIGenerate_new_device_codes_request> &oai_generate_new_device_codes_request) {
    QString fullPath = QString(_serverConfigs["generate_new_device_codes"][_serverIndices.value("generate_new_device_codes")].URL()+"/oauth/device/code");
    ...
    if (oai_generate_new_device_codes_request.hasValue()){

        
        QByteArray output = oai_generate_new_device_codes_request.value().asJson().toUtf8();
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIAuthenticationDevicesApi::generate_new_device_codesCallback);
    connect(this, &OAIAuthenticationDevicesApi::abortRequestsSignal, worker, &QObject::deleteLater);
...
void OAIAuthenticationDevicesApi::generate_new_device_codesCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT generate_new_device_codesSignal();
        Q_EMIT generate_new_device_codesSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT generate_new_device_codesSignalE(error_type, error_str);
        Q_EMIT generate_new_device_codesSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT generate_new_device_codesSignalError(error_type, error_str);
        Q_EMIT generate_new_device_codesSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIAuthenticationDevicesApi::poll_for_the_accessToken(const ::OpenAPI::OptionalParam<OAIPoll_for_the_access_token_request> &oai_poll_for_the_access_token_request) {
    QString fullPath = QString(_serverConfigs["poll_for_the_accessToken"][_serverIndices.value("poll_for_the_accessToken")].URL()+"/oauth/device/token");
    ...
    if (oai_poll_for_the_access_token_request.hasValue()){

        
        QByteArray output = oai_poll_for_the_access_token_request.value().asJson().toUtf8();
        input.request_body.append(output);
    }
    for (auto keyValueIt = _defaultHeaders.keyValueBegin(); keyValueIt != _defaultHeaders.keyValueEnd(); keyValueIt++) {
        input.headers.insert(keyValueIt->first, keyValueIt->second);
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIAuthenticationDevicesApi::poll_for_the_accessTokenCallback);
    connect(this, &OAIAuthenticationDevicesApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIAuthenticationDevicesApi::poll_for_the_accessTokenCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT poll_for_the_accessTokenSignal();
        Q_EMIT poll_for_the_accessTokenSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT poll_for_the_accessTokenSignalE(error_type, error_str);
        Q_EMIT poll_for_the_accessTokenSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT poll_for_the_accessTokenSignalError(error_type, error_str);
        Q_EMIT poll_for_the_accessTokenSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIAuthenticationDevicesApi::tokenAvailable(){
