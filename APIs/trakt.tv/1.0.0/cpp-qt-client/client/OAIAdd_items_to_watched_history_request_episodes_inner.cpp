...
#include "OAIAdd_items_to_watched_history_request_episodes_inner.h"
...
OAIAdd_items_to_watched_history_request_episodes_inner::OAIAdd_items_to_watched_history_request_episodes_inner(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAdd_items_to_watched_history_request_episodes_inner::OAIAdd_items_to_watched_history_request_episodes_inner() {
    this->initializeModel();
}

OAIAdd_items_to_watched_history_request_episodes_inner::~OAIAdd_items_to_watched_history_request_episodes_inner() {}

void OAIAdd_items_to_watched_history_request_episodes_inner::initializeModel() {
...
void OAIAdd_items_to_watched_history_request_episodes_inner::fromJson(QString jsonString) {
...
void OAIAdd_items_to_watched_history_request_episodes_inner::fromJsonObject(QJsonObject json) {
...
QString OAIAdd_items_to_watched_history_request_episodes_inner::asJson() const {
...
QJsonObject OAIAdd_items_to_watched_history_request_episodes_inner::asJsonObject() const {
    QJsonObject obj;
    if (m_ids.isSet()) {
...
OAIAdd_items_to_collection_request_episodes_inner_ids OAIAdd_items_to_watched_history_request_episodes_inner::getIds() const {
    return m_ids;
}
void OAIAdd_items_to_watched_history_request_episodes_inner::setIds(const OAIAdd_items_to_collection_request_episodes_inner_ids &ids) {
    m_ids = ids;
    m_ids_isSet = true;
}

bool OAIAdd_items_to_watched_history_request_episodes_inner::is_ids_Set() const{
    return m_ids_isSet;
}

bool OAIAdd_items_to_watched_history_request_episodes_inner::is_ids_Valid() const{
    return m_ids_isValid;
}

QString OAIAdd_items_to_watched_history_request_episodes_inner::getWatchedAt() const {
    return m_watched_at;
}
void OAIAdd_items_to_watched_history_request_episodes_inner::setWatchedAt(const QString &watched_at) {
    m_watched_at = watched_at;
    m_watched_at_isSet = true;
}

bool OAIAdd_items_to_watched_history_request_episodes_inner::is_watched_at_Set() const{
    return m_watched_at_isSet;
}

bool OAIAdd_items_to_watched_history_request_episodes_inner::is_watched_at_Valid() const{
    return m_watched_at_isValid;
}

bool OAIAdd_items_to_watched_history_request_episodes_inner::isSet() const {
...
bool OAIAdd_items_to_watched_history_request_episodes_inner::isValid() const {
