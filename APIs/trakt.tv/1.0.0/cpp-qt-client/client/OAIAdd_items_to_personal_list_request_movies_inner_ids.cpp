...
#include "OAIAdd_items_to_personal_list_request_movies_inner_ids.h"
...
OAIAdd_items_to_personal_list_request_movies_inner_ids::OAIAdd_items_to_personal_list_request_movies_inner_ids(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAdd_items_to_personal_list_request_movies_inner_ids::OAIAdd_items_to_personal_list_request_movies_inner_ids() {
    this->initializeModel();
}

OAIAdd_items_to_personal_list_request_movies_inner_ids::~OAIAdd_items_to_personal_list_request_movies_inner_ids() {}

void OAIAdd_items_to_personal_list_request_movies_inner_ids::initializeModel() {
...
void OAIAdd_items_to_personal_list_request_movies_inner_ids::fromJson(QString jsonString) {
...
void OAIAdd_items_to_personal_list_request_movies_inner_ids::fromJsonObject(QJsonObject json) {
...
QString OAIAdd_items_to_personal_list_request_movies_inner_ids::asJson() const {
...
QJsonObject OAIAdd_items_to_personal_list_request_movies_inner_ids::asJsonObject() const {
    QJsonObject obj;
    if (m_imdb_isSet) {
...
QString OAIAdd_items_to_personal_list_request_movies_inner_ids::getImdb() const {
    return m_imdb;
}
void OAIAdd_items_to_personal_list_request_movies_inner_ids::setImdb(const QString &imdb) {
    m_imdb = imdb;
    m_imdb_isSet = true;
}

bool OAIAdd_items_to_personal_list_request_movies_inner_ids::is_imdb_Set() const{
    return m_imdb_isSet;
}

bool OAIAdd_items_to_personal_list_request_movies_inner_ids::is_imdb_Valid() const{
    return m_imdb_isValid;
}

double OAIAdd_items_to_personal_list_request_movies_inner_ids::getTrakt() const {
    return m_trakt;
}
void OAIAdd_items_to_personal_list_request_movies_inner_ids::setTrakt(const double &trakt) {
    m_trakt = trakt;
    m_trakt_isSet = true;
}

bool OAIAdd_items_to_personal_list_request_movies_inner_ids::is_trakt_Set() const{
    return m_trakt_isSet;
}

bool OAIAdd_items_to_personal_list_request_movies_inner_ids::is_trakt_Valid() const{
    return m_trakt_isValid;
}

bool OAIAdd_items_to_personal_list_request_movies_inner_ids::isSet() const {
...
bool OAIAdd_items_to_personal_list_request_movies_inner_ids::isValid() const {
