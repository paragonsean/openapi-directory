...
#ifndef OAI_OAICertificationsApi_H
#define OAI_OAICertificationsApi_H
...
class OAICertificationsApi : public QObject {
    Q_OBJECT

public:
    OAICertificationsApi(const int timeOut = 0);
    ~OAICertificationsApi();
    ...
    */
    virtual void get_certifications(const QString &type, const ::OpenAPI::OptionalParam<QString> &trakt_api_version = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &trakt_api_key = ::OpenAPI::OptionalParam<QString>());
...
private:
    ...
    void get_certificationsCallback(OAIHttpRequestWorker *worker);

Q_SIGNALS:

    void get_certificationsSignal();


    void get_certificationsSignalFull(OAIHttpRequestWorker *worker);

    Q_DECL_DEPRECATED_X("Use get_certificationsSignalError() instead")
    void get_certificationsSignalE(QNetworkReply::NetworkError error_type, QString error_str);
    void get_certificationsSignalError(QNetworkReply::NetworkError error_type, const QString &error_str);

    Q_DECL_DEPRECATED_X("Use get_certificationsSignalErrorFull() instead")
    void get_certificationsSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void get_certificationsSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
