...
#include "OAIStop_or_finish_watching_in_a_media_center_request.h"
...
OAIStop_or_finish_watching_in_a_media_center_request::OAIStop_or_finish_watching_in_a_media_center_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIStop_or_finish_watching_in_a_media_center_request::OAIStop_or_finish_watching_in_a_media_center_request() {
    this->initializeModel();
}

OAIStop_or_finish_watching_in_a_media_center_request::~OAIStop_or_finish_watching_in_a_media_center_request() {}

void OAIStop_or_finish_watching_in_a_media_center_request::initializeModel() {

    m_app_date_isSet = false;
    m_app_date_isValid = false;

    m_app_version_isSet = false;
    m_app_version_isValid = false;

    m_movie_isSet = false;
    m_movie_isValid = false;

    m_progress_isSet = false;
    m_progress_isValid = false;
}

void OAIStop_or_finish_watching_in_a_media_center_request::fromJson(QString jsonString) {
...
void OAIStop_or_finish_watching_in_a_media_center_request::fromJsonObject(QJsonObject json) {

    m_app_date_isValid = ::OpenAPI::fromJsonValue(m_app_date, json[QString("app_date")]);
    m_app_date_isSet = !json[QString("app_date")].isNull() && m_app_date_isValid;
    ...
    m_movie_isValid = ::OpenAPI::fromJsonValue(m_movie, json[QString("movie")]);
    m_movie_isSet = !json[QString("movie")].isNull() && m_movie_isValid;
...
QString OAIStop_or_finish_watching_in_a_media_center_request::asJson() const {
...
QJsonObject OAIStop_or_finish_watching_in_a_media_center_request::asJsonObject() const {
    QJsonObject obj;
    if (m_app_date_isSet) {
        obj.insert(QString("app_date"), ::OpenAPI::toJsonValue(m_app_date));
    }
    if (m_app_version_isSet) {
        obj.insert(QString("app_version"), ::OpenAPI::toJsonValue(m_app_version));
    }
    if (m_movie.isSet()) {
        obj.insert(QString("movie"), ::OpenAPI::toJsonValue(m_movie));
    }
    if (m_progress_isSet) {
...
QString OAIStop_or_finish_watching_in_a_media_center_request::getAppDate() const {
    return m_app_date;
}
void OAIStop_or_finish_watching_in_a_media_center_request::setAppDate(const QString &app_date) {
    m_app_date = app_date;
    m_app_date_isSet = true;
}

bool OAIStop_or_finish_watching_in_a_media_center_request::is_app_date_Set() const{
    return m_app_date_isSet;
}

bool OAIStop_or_finish_watching_in_a_media_center_request::is_app_date_Valid() const{
    return m_app_date_isValid;
}

QString OAIStop_or_finish_watching_in_a_media_center_request::getAppVersion() const {
    return m_app_version;
}
void OAIStop_or_finish_watching_in_a_media_center_request::setAppVersion(const QString &app_version) {
    m_app_version = app_version;
    m_app_version_isSet = true;
}

bool OAIStop_or_finish_watching_in_a_media_center_request::is_app_version_Set() const{
    return m_app_version_isSet;
}

bool OAIStop_or_finish_watching_in_a_media_center_request::is_app_version_Valid() const{
    return m_app_version_isValid;
}

OAICheck_into_an_item_request_movie OAIStop_or_finish_watching_in_a_media_center_request::getMovie() const {
    return m_movie;
}
void OAIStop_or_finish_watching_in_a_media_center_request::setMovie(const OAICheck_into_an_item_request_movie &movie) {
    m_movie = movie;
    m_movie_isSet = true;
}

bool OAIStop_or_finish_watching_in_a_media_center_request::is_movie_Set() const{
    return m_movie_isSet;
}

bool OAIStop_or_finish_watching_in_a_media_center_request::is_movie_Valid() const{
    return m_movie_isValid;
}

double OAIStop_or_finish_watching_in_a_media_center_request::getProgress() const {
    return m_progress;
}
void OAIStop_or_finish_watching_in_a_media_center_request::setProgress(const double &progress) {
    m_progress = progress;
    m_progress_isSet = true;
}

bool OAIStop_or_finish_watching_in_a_media_center_request::is_progress_Set() const{
    return m_progress_isSet;
}

bool OAIStop_or_finish_watching_in_a_media_center_request::is_progress_Valid() const{
    return m_progress_isValid;
}

bool OAIStop_or_finish_watching_in_a_media_center_request::isSet() const {
...
bool OAIStop_or_finish_watching_in_a_media_center_request::isValid() const {
