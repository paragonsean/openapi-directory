...
#include "OAICheck_into_an_item_request_sharing.h"
...
OAICheck_into_an_item_request_sharing::OAICheck_into_an_item_request_sharing(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICheck_into_an_item_request_sharing::OAICheck_into_an_item_request_sharing() {
    this->initializeModel();
}

OAICheck_into_an_item_request_sharing::~OAICheck_into_an_item_request_sharing() {}

void OAICheck_into_an_item_request_sharing::initializeModel() {

    m_mastodon_isSet = false;
    m_mastodon_isValid = false;
...
void OAICheck_into_an_item_request_sharing::fromJson(QString jsonString) {
...
void OAICheck_into_an_item_request_sharing::fromJsonObject(QJsonObject json) {

    m_mastodon_isValid = ::OpenAPI::fromJsonValue(m_mastodon, json[QString("mastodon")]);
    m_mastodon_isSet = !json[QString("mastodon")].isNull() && m_mastodon_isValid;
...
QString OAICheck_into_an_item_request_sharing::asJson() const {
...
QJsonObject OAICheck_into_an_item_request_sharing::asJsonObject() const {
    QJsonObject obj;
    if (m_mastodon_isSet) {
        obj.insert(QString("mastodon"), ::OpenAPI::toJsonValue(m_mastodon));
    }
    if (m_tumblr_isSet) {
...
bool OAICheck_into_an_item_request_sharing::isMastodon() const {
    return m_mastodon;
}
void OAICheck_into_an_item_request_sharing::setMastodon(const bool &mastodon) {
    m_mastodon = mastodon;
    m_mastodon_isSet = true;
}

bool OAICheck_into_an_item_request_sharing::is_mastodon_Set() const{
    return m_mastodon_isSet;
}

bool OAICheck_into_an_item_request_sharing::is_mastodon_Valid() const{
    return m_mastodon_isValid;
}

bool OAICheck_into_an_item_request_sharing::isTumblr() const {
    return m_tumblr;
}
void OAICheck_into_an_item_request_sharing::setTumblr(const bool &tumblr) {
    m_tumblr = tumblr;
    m_tumblr_isSet = true;
}

bool OAICheck_into_an_item_request_sharing::is_tumblr_Set() const{
    return m_tumblr_isSet;
}

bool OAICheck_into_an_item_request_sharing::is_tumblr_Valid() const{
    return m_tumblr_isValid;
}

bool OAICheck_into_an_item_request_sharing::isTwitter() const {
    return m_twitter;
}
void OAICheck_into_an_item_request_sharing::setTwitter(const bool &twitter) {
    m_twitter = twitter;
    m_twitter_isSet = true;
}

bool OAICheck_into_an_item_request_sharing::is_twitter_Set() const{
    return m_twitter_isSet;
}

bool OAICheck_into_an_item_request_sharing::is_twitter_Valid() const{
    return m_twitter_isValid;
}

bool OAICheck_into_an_item_request_sharing::isSet() const {
...
bool OAICheck_into_an_item_request_sharing::isValid() const {
