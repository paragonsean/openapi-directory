...
#include "OAIAuthenticationOAuthApi.h"
...
OAIAuthenticationOAuthApi::OAIAuthenticationOAuthApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAIAuthenticationOAuthApi::~OAIAuthenticationOAuthApi() {
}

void OAIAuthenticationOAuthApi::initializeServerConfigs() {
    //Default server
    ...
    _serverConfigs.insert("authorize_Application", defaultConf);
    _serverIndices.insert("authorize_Application", 0);
    _serverConfigs.insert("exchange_refreshToken_for_accessToken", defaultConf);
    _serverIndices.insert("exchange_refreshToken_for_accessToken", 0);
    _serverConfigs.insert("revoke_an_accessToken", defaultConf);
    _serverIndices.insert("revoke_an_accessToken", 0);
}
...
*/
int OAIAuthenticationOAuthApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAIAuthenticationOAuthApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAIAuthenticationOAuthApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAIAuthenticationOAuthApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAIAuthenticationOAuthApi::setUsername(const QString &username) {
    _username = username;
}

void OAIAuthenticationOAuthApi::setPassword(const QString &password) {
    _password = password;
}


void OAIAuthenticationOAuthApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAIAuthenticationOAuthApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAIAuthenticationOAuthApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAIAuthenticationOAuthApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAIAuthenticationOAuthApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAIAuthenticationOAuthApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAIAuthenticationOAuthApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAIAuthenticationOAuthApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAIAuthenticationOAuthApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAIAuthenticationOAuthApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAIAuthenticationOAuthApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAIAuthenticationOAuthApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAIAuthenticationOAuthApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAIAuthenticationOAuthApi::authorize_Application(const QString &response_type, const QString &client_id, const QString &redirect_uri, const ::OpenAPI::OptionalParam<QString> &state, const ::OpenAPI::OptionalParam<QString> &body) {
    QString fullPath = QString(_serverConfigs["authorize_Application"][_serverIndices.value("authorize_Application")].URL()+"/oauth/authorize");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIAuthenticationOAuthApi::authorize_ApplicationCallback);
    connect(this, &OAIAuthenticationOAuthApi::abortRequestsSignal, worker, &QObject::deleteLater);
...
void OAIAuthenticationOAuthApi::authorize_ApplicationCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT authorize_ApplicationSignal();
        Q_EMIT authorize_ApplicationSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT authorize_ApplicationSignalE(error_type, error_str);
        Q_EMIT authorize_ApplicationSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT authorize_ApplicationSignalError(error_type, error_str);
        Q_EMIT authorize_ApplicationSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIAuthenticationOAuthApi::exchange_refreshToken_for_accessToken(const ::OpenAPI::OptionalParam<OAIExchange_refresh_token_for_access_token_request> &oai_exchange_refresh_token_for_access_token_request) {
    QString fullPath = QString(_serverConfigs["exchange_refreshToken_for_accessToken"][_serverIndices.value("exchange_refreshToken_for_accessToken")].URL()+"/oauth/token");
    ...
    if (oai_exchange_refresh_token_for_access_token_request.hasValue()){

        
        QByteArray output = oai_exchange_refresh_token_for_access_token_request.value().asJson().toUtf8();
        input.request_body.append(output);
    }
    for (auto keyValueIt = _defaultHeaders.keyValueBegin(); keyValueIt != _defaultHeaders.keyValueEnd(); keyValueIt++) {
        input.headers.insert(keyValueIt->first, keyValueIt->second);
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIAuthenticationOAuthApi::exchange_refreshToken_for_accessTokenCallback);
    connect(this, &OAIAuthenticationOAuthApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIAuthenticationOAuthApi::exchange_refreshToken_for_accessTokenCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT exchange_refreshToken_for_accessTokenSignal();
        Q_EMIT exchange_refreshToken_for_accessTokenSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT exchange_refreshToken_for_accessTokenSignalE(error_type, error_str);
        Q_EMIT exchange_refreshToken_for_accessTokenSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT exchange_refreshToken_for_accessTokenSignalError(error_type, error_str);
        Q_EMIT exchange_refreshToken_for_accessTokenSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIAuthenticationOAuthApi::revoke_an_accessToken(const ::OpenAPI::OptionalParam<OAIRevoke_an_access_token_request> &oai_revoke_an_access_token_request) {
    QString fullPath = QString(_serverConfigs["revoke_an_accessToken"][_serverIndices.value("revoke_an_accessToken")].URL()+"/oauth/revoke");
    ...
    if (oai_revoke_an_access_token_request.hasValue()){

        
        QByteArray output = oai_revoke_an_access_token_request.value().asJson().toUtf8();
        input.request_body.append(output);
    }
    for (auto keyValueIt = _defaultHeaders.keyValueBegin(); keyValueIt != _defaultHeaders.keyValueEnd(); keyValueIt++) {
        input.headers.insert(keyValueIt->first, keyValueIt->second);
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIAuthenticationOAuthApi::revoke_an_accessTokenCallback);
    connect(this, &OAIAuthenticationOAuthApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIAuthenticationOAuthApi::revoke_an_accessTokenCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT revoke_an_accessTokenSignal();
        Q_EMIT revoke_an_accessTokenSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT revoke_an_accessTokenSignalE(error_type, error_str);
        Q_EMIT revoke_an_accessTokenSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT revoke_an_accessTokenSignalError(error_type, error_str);
        Q_EMIT revoke_an_accessTokenSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIAuthenticationOAuthApi::tokenAvailable(){
