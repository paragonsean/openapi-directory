...
public:
    ...
    /**
    * @param[in]  ignore_collected QString [optional]
    * @param[in]  ignore_watchlisted QString [optional]
    * @param[in]  trakt_api_version QString [optional]
    * @param[in]  trakt_api_key QString [optional]
    */
    virtual void get_movie_recommendations(const ::OpenAPI::OptionalParam<QString> &ignore_collected = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &ignore_watchlisted = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &trakt_api_version = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &trakt_api_key = ::OpenAPI::OptionalParam<QString>());
    ...
    * @param[in]  trakt_api_key QString [optional]
    */
    virtual void get_show_recommendations(const ::OpenAPI::OptionalParam<QString> &ignore_collected = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &ignore_watchlisted = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &trakt_api_version = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &trakt_api_key = ::OpenAPI::OptionalParam<QString>());
    ...
    * @param[in]  trakt_api_key QString [optional]
    */
    virtual void hide_a_movie_recommendation(const QString &id, const ::OpenAPI::OptionalParam<QString> &trakt_api_version = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &trakt_api_key = ::OpenAPI::OptionalParam<QString>());
    ...
    * @param[in]  trakt_api_key QString [optional]
    */
    virtual void hide_a_show_recommendation(const QString &id, const ::OpenAPI::OptionalParam<QString> &trakt_api_version = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &trakt_api_key = ::OpenAPI::OptionalParam<QString>());
...
private:
    ...
    void get_movie_recommendationsCallback(OAIHttpRequestWorker *worker);
    void get_show_recommendationsCallback(OAIHttpRequestWorker *worker);
    void hide_a_movie_recommendationCallback(OAIHttpRequestWorker *worker);
    void hide_a_show_recommendationCallback(OAIHttpRequestWorker *worker);

Q_SIGNALS:

    void get_movie_recommendationsSignal();
    void get_show_recommendationsSignal();
    void hide_a_movie_recommendationSignal();
    void hide_a_show_recommendationSignal();


    void get_movie_recommendationsSignalFull(OAIHttpRequestWorker *worker);
    void get_show_recommendationsSignalFull(OAIHttpRequestWorker *worker);
    void hide_a_movie_recommendationSignalFull(OAIHttpRequestWorker *worker);
    void hide_a_show_recommendationSignalFull(OAIHttpRequestWorker *worker);

    Q_DECL_DEPRECATED_X("Use get_movie_recommendationsSignalError() instead")
    void get_movie_recommendationsSignalE(QNetworkReply::NetworkError error_type, QString error_str);
    void get_movie_recommendationsSignalError(QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use get_show_recommendationsSignalError() instead")
    void get_show_recommendationsSignalE(QNetworkReply::NetworkError error_type, QString error_str);
    void get_show_recommendationsSignalError(QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use hide_a_movie_recommendationSignalError() instead")
    void hide_a_movie_recommendationSignalE(QNetworkReply::NetworkError error_type, QString error_str);
    void hide_a_movie_recommendationSignalError(QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use hide_a_show_recommendationSignalError() instead")
    void hide_a_show_recommendationSignalE(QNetworkReply::NetworkError error_type, QString error_str);
    void hide_a_show_recommendationSignalError(QNetworkReply::NetworkError error_type, const QString &error_str);

    Q_DECL_DEPRECATED_X("Use get_movie_recommendationsSignalErrorFull() instead")
    void get_movie_recommendationsSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void get_movie_recommendationsSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use get_show_recommendationsSignalErrorFull() instead")
    void get_show_recommendationsSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void get_show_recommendationsSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use hide_a_movie_recommendationSignalErrorFull() instead")
    void hide_a_movie_recommendationSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void hide_a_movie_recommendationSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use hide_a_show_recommendationSignalErrorFull() instead")
    void hide_a_show_recommendationSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void hide_a_show_recommendationSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
