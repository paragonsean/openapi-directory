...
#ifndef OAI_OAIAuthenticationDevicesApi_H
#define OAI_OAIAuthenticationDevicesApi_H
...
#include "OAIGenerate_new_device_codes_request.h"
...
class OAIAuthenticationDevicesApi : public QObject {
    Q_OBJECT

public:
    OAIAuthenticationDevicesApi(const int timeOut = 0);
    ~OAIAuthenticationDevicesApi();
    ...
    /**
    * @param[in]  oai_generate_new_device_codes_request OAIGenerate_new_device_codes_request [optional]
    */
    virtual void generate_new_device_codes(const ::OpenAPI::OptionalParam<OAIGenerate_new_device_codes_request> &oai_generate_new_device_codes_request = ::OpenAPI::OptionalParam<OAIGenerate_new_device_codes_request>());

    /**
    * @param[in]  oai_poll_for_the_access_token_request OAIPoll_for_the_access_token_request [optional]
    */
    virtual void poll_for_the_accessToken(const ::OpenAPI::OptionalParam<OAIPoll_for_the_access_token_request> &oai_poll_for_the_access_token_request = ::OpenAPI::OptionalParam<OAIPoll_for_the_access_token_request>());
...
private:
    ...
    void generate_new_device_codesCallback(OAIHttpRequestWorker *worker);
    void poll_for_the_accessTokenCallback(OAIHttpRequestWorker *worker);

Q_SIGNALS:

    void generate_new_device_codesSignal();
    void poll_for_the_accessTokenSignal();


    void generate_new_device_codesSignalFull(OAIHttpRequestWorker *worker);
    void poll_for_the_accessTokenSignalFull(OAIHttpRequestWorker *worker);

    Q_DECL_DEPRECATED_X("Use generate_new_device_codesSignalError() instead")
    void generate_new_device_codesSignalE(QNetworkReply::NetworkError error_type, QString error_str);
    void generate_new_device_codesSignalError(QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use poll_for_the_accessTokenSignalError() instead")
    void poll_for_the_accessTokenSignalE(QNetworkReply::NetworkError error_type, QString error_str);
    void poll_for_the_accessTokenSignalError(QNetworkReply::NetworkError error_type, const QString &error_str);

    Q_DECL_DEPRECATED_X("Use generate_new_device_codesSignalErrorFull() instead")
    void generate_new_device_codesSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void generate_new_device_codesSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use poll_for_the_accessTokenSignalErrorFull() instead")
    void poll_for_the_accessTokenSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void poll_for_the_accessTokenSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
