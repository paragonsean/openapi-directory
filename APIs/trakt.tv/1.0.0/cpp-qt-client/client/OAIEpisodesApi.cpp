...
void OAIEpisodesApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("get_a_single_episode_for_a_show", defaultConf);
    _serverIndices.insert("get_a_single_episode_for_a_show", 0);
    _serverConfigs.insert("get_all_episode_comments", defaultConf);
    _serverIndices.insert("get_all_episode_comments", 0);
    _serverConfigs.insert("get_all_episode_translations", defaultConf);
    _serverIndices.insert("get_all_episode_translations", 0);
    _serverConfigs.insert("get_all_people_for_an_episode", defaultConf);
    _serverIndices.insert("get_all_people_for_an_episode", 0);
    _serverConfigs.insert("get_episode_ratings", defaultConf);
    _serverIndices.insert("get_episode_ratings", 0);
    _serverConfigs.insert("get_episode_stats", defaultConf);
    _serverIndices.insert("get_episode_stats", 0);
    _serverConfigs.insert("get_lists_containing_this_episode", defaultConf);
    _serverIndices.insert("get_lists_containing_this_episode", 0);
    _serverConfigs.insert("showsIdSeasonsSeasonEpisodesEpisodeWatchingGet", defaultConf);
    _serverIndices.insert("showsIdSeasonsSeasonEpisodesEpisodeWatchingGet", 0);
}
...
void OAIEpisodesApi::get_a_single_episode_for_a_show(const QString &id, const qint32 &season, const qint32 &episode, const ::OpenAPI::OptionalParam<QString> &trakt_api_version, const ::OpenAPI::OptionalParam<QString> &trakt_api_key) {
    QString fullPath = QString(_serverConfigs["get_a_single_episode_for_a_show"][_serverIndices.value("get_a_single_episode_for_a_show")].URL()+"/shows/{id}/seasons/{season}/episodes/{episode}");
    ...
    {
        QString episodePathParam("{");
        episodePathParam.append("episode").append("}");
        QString pathPrefix, pathSuffix, pathDelimiter;
        QString pathStyle = "simple";
        if (pathStyle == "")
            pathStyle = "simple";
        pathPrefix = getParamStylePrefix(pathStyle);
        pathSuffix = getParamStyleSuffix(pathStyle);
        pathDelimiter = getParamStyleDelimiter(pathStyle, "episode", false);
        QString paramString = (pathStyle == "matrix") ? pathPrefix+"episode"+pathSuffix : pathPrefix;
        fullPath.replace(episodePathParam, paramString+QUrl::toPercentEncoding(::OpenAPI::toStringValue(episode)));
    }
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIEpisodesApi::get_a_single_episode_for_a_showCallback);
...
void OAIEpisodesApi::get_a_single_episode_for_a_showCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT get_a_single_episode_for_a_showSignal();
        Q_EMIT get_a_single_episode_for_a_showSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT get_a_single_episode_for_a_showSignalE(error_type, error_str);
        Q_EMIT get_a_single_episode_for_a_showSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT get_a_single_episode_for_a_showSignalError(error_type, error_str);
        Q_EMIT get_a_single_episode_for_a_showSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIEpisodesApi::get_all_episode_comments(const QString &id, const qint32 &season, const qint32 &episode, const QString &sort, const ::OpenAPI::OptionalParam<QString> &trakt_api_version, const ::OpenAPI::OptionalParam<QString> &trakt_api_key) {
    QString fullPath = QString(_serverConfigs["get_all_episode_comments"][_serverIndices.value("get_all_episode_comments")].URL()+"/shows/{id}/seasons/{season}/episodes/{episode}/comments/{sort}");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIEpisodesApi::get_all_episode_commentsCallback);
    connect(this, &OAIEpisodesApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIEpisodesApi::get_all_episode_commentsCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT get_all_episode_commentsSignal();
        Q_EMIT get_all_episode_commentsSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT get_all_episode_commentsSignalE(error_type, error_str);
        Q_EMIT get_all_episode_commentsSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT get_all_episode_commentsSignalError(error_type, error_str);
        Q_EMIT get_all_episode_commentsSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIEpisodesApi::get_all_episode_translations(const QString &id, const qint32 &season, const qint32 &episode, const QString &language, const ::OpenAPI::OptionalParam<QString> &trakt_api_version, const ::OpenAPI::OptionalParam<QString> &trakt_api_key) {
    QString fullPath = QString(_serverConfigs["get_all_episode_translations"][_serverIndices.value("get_all_episode_translations")].URL()+"/shows/{id}/seasons/{season}/episodes/{episode}/translations/{language}");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIEpisodesApi::get_all_episode_translationsCallback);
    connect(this, &OAIEpisodesApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIEpisodesApi::get_all_episode_translationsCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT get_all_episode_translationsSignal();
        Q_EMIT get_all_episode_translationsSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT get_all_episode_translationsSignalE(error_type, error_str);
        Q_EMIT get_all_episode_translationsSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT get_all_episode_translationsSignalError(error_type, error_str);
        Q_EMIT get_all_episode_translationsSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIEpisodesApi::get_all_people_for_an_episode(const QString &id, const qint32 &season, const qint32 &episode, const ::OpenAPI::OptionalParam<QString> &trakt_api_version, const ::OpenAPI::OptionalParam<QString> &trakt_api_key) {
    QString fullPath = QString(_serverConfigs["get_all_people_for_an_episode"][_serverIndices.value("get_all_people_for_an_episode")].URL()+"/shows/{id}/seasons/{season}/episodes/{episode}/people");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIEpisodesApi::get_all_people_for_an_episodeCallback);
    connect(this, &OAIEpisodesApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIEpisodesApi::get_all_people_for_an_episodeCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT get_all_people_for_an_episodeSignal();
        Q_EMIT get_all_people_for_an_episodeSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT get_all_people_for_an_episodeSignalE(error_type, error_str);
        Q_EMIT get_all_people_for_an_episodeSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT get_all_people_for_an_episodeSignalError(error_type, error_str);
        Q_EMIT get_all_people_for_an_episodeSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIEpisodesApi::get_episode_ratings(const QString &id, const qint32 &season, const qint32 &episode, const ::OpenAPI::OptionalParam<QString> &trakt_api_version, const ::OpenAPI::OptionalParam<QString> &trakt_api_key) {
    QString fullPath = QString(_serverConfigs["get_episode_ratings"][_serverIndices.value("get_episode_ratings")].URL()+"/shows/{id}/seasons/{season}/episodes/{episode}/ratings");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIEpisodesApi::get_episode_ratingsCallback);
    connect(this, &OAIEpisodesApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIEpisodesApi::get_episode_ratingsCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT get_episode_ratingsSignal();
        Q_EMIT get_episode_ratingsSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT get_episode_ratingsSignalE(error_type, error_str);
        Q_EMIT get_episode_ratingsSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT get_episode_ratingsSignalError(error_type, error_str);
        Q_EMIT get_episode_ratingsSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIEpisodesApi::get_episode_stats(const QString &id, const qint32 &season, const qint32 &episode, const ::OpenAPI::OptionalParam<QString> &trakt_api_version, const ::OpenAPI::OptionalParam<QString> &trakt_api_key) {
    QString fullPath = QString(_serverConfigs["get_episode_stats"][_serverIndices.value("get_episode_stats")].URL()+"/shows/{id}/seasons/{season}/episodes/{episode}/stats");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIEpisodesApi::get_episode_statsCallback);
    connect(this, &OAIEpisodesApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIEpisodesApi::get_episode_statsCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT get_episode_statsSignal();
        Q_EMIT get_episode_statsSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT get_episode_statsSignalE(error_type, error_str);
        Q_EMIT get_episode_statsSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT get_episode_statsSignalError(error_type, error_str);
        Q_EMIT get_episode_statsSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIEpisodesApi::get_lists_containing_this_episode(const QString &id, const qint32 &season, const qint32 &episode, const QString &type, const QString &sort, const ::OpenAPI::OptionalParam<QString> &trakt_api_version, const ::OpenAPI::OptionalParam<QString> &trakt_api_key) {
    QString fullPath = QString(_serverConfigs["get_lists_containing_this_episode"][_serverIndices.value("get_lists_containing_this_episode")].URL()+"/shows/{id}/seasons/{season}/episodes/{episode}/lists/{type}/{sort}");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIEpisodesApi::get_lists_containing_this_episodeCallback);
    connect(this, &OAIEpisodesApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIEpisodesApi::get_lists_containing_this_episodeCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT get_lists_containing_this_episodeSignal();
        Q_EMIT get_lists_containing_this_episodeSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT get_lists_containing_this_episodeSignalE(error_type, error_str);
        Q_EMIT get_lists_containing_this_episodeSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT get_lists_containing_this_episodeSignalError(error_type, error_str);
        Q_EMIT get_lists_containing_this_episodeSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIEpisodesApi::showsIdSeasonsSeasonEpisodesEpisodeWatchingGet(const QString &id, const qint32 &season, const qint32 &episode, const ::OpenAPI::OptionalParam<QString> &trakt_api_version, const ::OpenAPI::OptionalParam<QString> &trakt_api_key) {
    QString fullPath = QString(_serverConfigs["showsIdSeasonsSeasonEpisodesEpisodeWatchingGet"][_serverIndices.value("showsIdSeasonsSeasonEpisodesEpisodeWatchingGet")].URL()+"/shows/{id}/seasons/{season}/episodes/{episode}/watching");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIEpisodesApi::showsIdSeasonsSeasonEpisodesEpisodeWatchingGetCallback);
    connect(this, &OAIEpisodesApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIEpisodesApi::showsIdSeasonsSeasonEpisodesEpisodeWatchingGetCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT showsIdSeasonsSeasonEpisodesEpisodeWatchingGetSignal();
        Q_EMIT showsIdSeasonsSeasonEpisodesEpisodeWatchingGetSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT showsIdSeasonsSeasonEpisodesEpisodeWatchingGetSignalE(error_type, error_str);
        Q_EMIT showsIdSeasonsSeasonEpisodesEpisodeWatchingGetSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT showsIdSeasonsSeasonEpisodesEpisodeWatchingGetSignalError(error_type, error_str);
        Q_EMIT showsIdSeasonsSeasonEpisodesEpisodeWatchingGetSignalErrorFull(worker, error_type, error_str);
    }
}
