...
public:
    ...
    */
    virtual void get_languages(const QString &type, const ::OpenAPI::OptionalParam<QString> &trakt_api_version = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &trakt_api_key = ::OpenAPI::OptionalParam<QString>());
...
private:
    ...
    void get_languagesCallback(OAIHttpRequestWorker *worker);

Q_SIGNALS:

    void get_languagesSignal();


    void get_languagesSignalFull(OAIHttpRequestWorker *worker);

    Q_DECL_DEPRECATED_X("Use get_languagesSignalError() instead")
    void get_languagesSignalE(QNetworkReply::NetworkError error_type, QString error_str);
    void get_languagesSignalError(QNetworkReply::NetworkError error_type, const QString &error_str);

    Q_DECL_DEPRECATED_X("Use get_languagesSignalErrorFull() instead")
    void get_languagesSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void get_languagesSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
