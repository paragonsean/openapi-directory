...
OAIRevoke_an_access_token_request::OAIRevoke_an_access_token_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIRevoke_an_access_token_request::OAIRevoke_an_access_token_request() {
    this->initializeModel();
}

OAIRevoke_an_access_token_request::~OAIRevoke_an_access_token_request() {}

void OAIRevoke_an_access_token_request::initializeModel() {
...
void OAIRevoke_an_access_token_request::fromJson(QString jsonString) {
...
void OAIRevoke_an_access_token_request::fromJsonObject(QJsonObject json) {
...
QString OAIRevoke_an_access_token_request::asJson() const {
...
QJsonObject OAIRevoke_an_access_token_request::asJsonObject() const {
    QJsonObject obj;
...
QString OAIRevoke_an_access_token_request::getClientId() const {
    return m_client_id;
}
void OAIRevoke_an_access_token_request::setClientId(const QString &client_id) {
    m_client_id = client_id;
    m_client_id_isSet = true;
}

bool OAIRevoke_an_access_token_request::is_client_id_Set() const{
    return m_client_id_isSet;
}

bool OAIRevoke_an_access_token_request::is_client_id_Valid() const{
    return m_client_id_isValid;
}

QString OAIRevoke_an_access_token_request::getClientSecret() const {
    return m_client_secret;
}
void OAIRevoke_an_access_token_request::setClientSecret(const QString &client_secret) {
    m_client_secret = client_secret;
    m_client_secret_isSet = true;
}

bool OAIRevoke_an_access_token_request::is_client_secret_Set() const{
    return m_client_secret_isSet;
}

bool OAIRevoke_an_access_token_request::is_client_secret_Valid() const{
    return m_client_secret_isValid;
}

QString OAIRevoke_an_access_token_request::getToken() const {
    return m_token;
}
void OAIRevoke_an_access_token_request::setToken(const QString &token) {
    m_token = token;
    m_token_isSet = true;
}

bool OAIRevoke_an_access_token_request::is_token_Set() const{
    return m_token_isSet;
}

bool OAIRevoke_an_access_token_request::is_token_Valid() const{
    return m_token_isValid;
}

bool OAIRevoke_an_access_token_request::isSet() const {
...
bool OAIRevoke_an_access_token_request::isValid() const {
