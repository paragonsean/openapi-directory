...
#include "OAIRemove_items_from_personal_recommendations_request.h"
...
OAIRemove_items_from_personal_recommendations_request::OAIRemove_items_from_personal_recommendations_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIRemove_items_from_personal_recommendations_request::OAIRemove_items_from_personal_recommendations_request() {
    this->initializeModel();
}

OAIRemove_items_from_personal_recommendations_request::~OAIRemove_items_from_personal_recommendations_request() {}

void OAIRemove_items_from_personal_recommendations_request::initializeModel() {
...
void OAIRemove_items_from_personal_recommendations_request::fromJson(QString jsonString) {
...
void OAIRemove_items_from_personal_recommendations_request::fromJsonObject(QJsonObject json) {
...
QString OAIRemove_items_from_personal_recommendations_request::asJson() const {
...
QJsonObject OAIRemove_items_from_personal_recommendations_request::asJsonObject() const {
    QJsonObject obj;
    if (m_movies.size() > 0) {
...
QList<OAIRemove_items_from_collection_request_movies_inner> OAIRemove_items_from_personal_recommendations_request::getMovies() const {
    return m_movies;
}
void OAIRemove_items_from_personal_recommendations_request::setMovies(const QList<OAIRemove_items_from_collection_request_movies_inner> &movies) {
    m_movies = movies;
    m_movies_isSet = true;
}

bool OAIRemove_items_from_personal_recommendations_request::is_movies_Set() const{
    return m_movies_isSet;
}

bool OAIRemove_items_from_personal_recommendations_request::is_movies_Valid() const{
    return m_movies_isValid;
}

QList<OAIRemove_items_from_personal_recommendations_request_shows_inner> OAIRemove_items_from_personal_recommendations_request::getShows() const {
    return m_shows;
}
void OAIRemove_items_from_personal_recommendations_request::setShows(const QList<OAIRemove_items_from_personal_recommendations_request_shows_inner> &shows) {
    m_shows = shows;
    m_shows_isSet = true;
}

bool OAIRemove_items_from_personal_recommendations_request::is_shows_Set() const{
    return m_shows_isSet;
}

bool OAIRemove_items_from_personal_recommendations_request::is_shows_Valid() const{
    return m_shows_isValid;
}

bool OAIRemove_items_from_personal_recommendations_request::isSet() const {
...
bool OAIRemove_items_from_personal_recommendations_request::isValid() const {
