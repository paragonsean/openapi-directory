...
#ifndef OAI_OAICheckinApi_H
#define OAI_OAICheckinApi_H
...
class OAICheckinApi : public QObject {
    Q_OBJECT

public:
    OAICheckinApi(const int timeOut = 0);
    ~OAICheckinApi();
    ...
    * @param[in]  oai_check_into_an_item_request OAICheck_into_an_item_request [optional]
    */
    virtual void check_into_an_item(const ::OpenAPI::OptionalParam<QString> &trakt_api_version = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &trakt_api_key = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<OAICheck_into_an_item_request> &oai_check_into_an_item_request = ::OpenAPI::OptionalParam<OAICheck_into_an_item_request>());

    /**
    * @param[in]  trakt_api_version QString [optional]
    * @param[in]  trakt_api_key QString [optional]
    */
    virtual void delete_any_active_checkins(const ::OpenAPI::OptionalParam<QString> &trakt_api_version = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &trakt_api_key = ::OpenAPI::OptionalParam<QString>());
...
private:
    ...
    void check_into_an_itemCallback(OAIHttpRequestWorker *worker);
    void delete_any_active_checkinsCallback(OAIHttpRequestWorker *worker);

Q_SIGNALS:

    void check_into_an_itemSignal();
    void delete_any_active_checkinsSignal();


    void check_into_an_itemSignalFull(OAIHttpRequestWorker *worker);
    void delete_any_active_checkinsSignalFull(OAIHttpRequestWorker *worker);

    Q_DECL_DEPRECATED_X("Use check_into_an_itemSignalError() instead")
    void check_into_an_itemSignalE(QNetworkReply::NetworkError error_type, QString error_str);
    void check_into_an_itemSignalError(QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use delete_any_active_checkinsSignalError() instead")
    void delete_any_active_checkinsSignalE(QNetworkReply::NetworkError error_type, QString error_str);
    void delete_any_active_checkinsSignalError(QNetworkReply::NetworkError error_type, const QString &error_str);

    Q_DECL_DEPRECATED_X("Use check_into_an_itemSignalErrorFull() instead")
    void check_into_an_itemSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void check_into_an_itemSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use delete_any_active_checkinsSignalErrorFull() instead")
    void delete_any_active_checkinsSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void delete_any_active_checkinsSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
