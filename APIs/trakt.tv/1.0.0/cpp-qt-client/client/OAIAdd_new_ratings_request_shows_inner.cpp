...
#include "OAIAdd_new_ratings_request_shows_inner.h"
...
OAIAdd_new_ratings_request_shows_inner::OAIAdd_new_ratings_request_shows_inner(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAdd_new_ratings_request_shows_inner::OAIAdd_new_ratings_request_shows_inner() {
    this->initializeModel();
}

OAIAdd_new_ratings_request_shows_inner::~OAIAdd_new_ratings_request_shows_inner() {}

void OAIAdd_new_ratings_request_shows_inner::initializeModel() {
...
void OAIAdd_new_ratings_request_shows_inner::fromJson(QString jsonString) {
...
void OAIAdd_new_ratings_request_shows_inner::fromJsonObject(QJsonObject json) {
...
QString OAIAdd_new_ratings_request_shows_inner::asJson() const {
...
QJsonObject OAIAdd_new_ratings_request_shows_inner::asJsonObject() const {
    QJsonObject obj;
    if (m_ids.isSet()) {
...
OAIAdd_items_to_collection_request_shows_inner_ids OAIAdd_new_ratings_request_shows_inner::getIds() const {
    return m_ids;
}
void OAIAdd_new_ratings_request_shows_inner::setIds(const OAIAdd_items_to_collection_request_shows_inner_ids &ids) {
    m_ids = ids;
    m_ids_isSet = true;
}

bool OAIAdd_new_ratings_request_shows_inner::is_ids_Set() const{
    return m_ids_isSet;
}

bool OAIAdd_new_ratings_request_shows_inner::is_ids_Valid() const{
    return m_ids_isValid;
}

double OAIAdd_new_ratings_request_shows_inner::getRating() const {
    return m_rating;
}
void OAIAdd_new_ratings_request_shows_inner::setRating(const double &rating) {
    m_rating = rating;
    m_rating_isSet = true;
}

bool OAIAdd_new_ratings_request_shows_inner::is_rating_Set() const{
    return m_rating_isSet;
}

bool OAIAdd_new_ratings_request_shows_inner::is_rating_Valid() const{
    return m_rating_isValid;
}

QList<OAIAdd_new_ratings_request_shows_inner_seasons_inner> OAIAdd_new_ratings_request_shows_inner::getSeasons() const {
    return m_seasons;
}
void OAIAdd_new_ratings_request_shows_inner::setSeasons(const QList<OAIAdd_new_ratings_request_shows_inner_seasons_inner> &seasons) {
    m_seasons = seasons;
    m_seasons_isSet = true;
}

bool OAIAdd_new_ratings_request_shows_inner::is_seasons_Set() const{
    return m_seasons_isSet;
}

bool OAIAdd_new_ratings_request_shows_inner::is_seasons_Valid() const{
    return m_seasons_isValid;
}

QString OAIAdd_new_ratings_request_shows_inner::getTitle() const {
    return m_title;
}
void OAIAdd_new_ratings_request_shows_inner::setTitle(const QString &title) {
    m_title = title;
    m_title_isSet = true;
}

bool OAIAdd_new_ratings_request_shows_inner::is_title_Set() const{
    return m_title_isSet;
}

bool OAIAdd_new_ratings_request_shows_inner::is_title_Valid() const{
    return m_title_isValid;
}

double OAIAdd_new_ratings_request_shows_inner::getYear() const {
    return m_year;
}
void OAIAdd_new_ratings_request_shows_inner::setYear(const double &year) {
    m_year = year;
    m_year_isSet = true;
}

bool OAIAdd_new_ratings_request_shows_inner::is_year_Set() const{
    return m_year_isSet;
}

bool OAIAdd_new_ratings_request_shows_inner::is_year_Valid() const{
    return m_year_isValid;
}

bool OAIAdd_new_ratings_request_shows_inner::isSet() const {
...
bool OAIAdd_new_ratings_request_shows_inner::isValid() const {
