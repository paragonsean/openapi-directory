...
#include "OAIAdd_new_ratings_request_episodes_inner.h"
...
OAIAdd_new_ratings_request_episodes_inner::OAIAdd_new_ratings_request_episodes_inner(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAdd_new_ratings_request_episodes_inner::OAIAdd_new_ratings_request_episodes_inner() {
    this->initializeModel();
}

OAIAdd_new_ratings_request_episodes_inner::~OAIAdd_new_ratings_request_episodes_inner() {}

void OAIAdd_new_ratings_request_episodes_inner::initializeModel() {
...
void OAIAdd_new_ratings_request_episodes_inner::fromJson(QString jsonString) {
...
void OAIAdd_new_ratings_request_episodes_inner::fromJsonObject(QJsonObject json) {
...
QString OAIAdd_new_ratings_request_episodes_inner::asJson() const {
...
QJsonObject OAIAdd_new_ratings_request_episodes_inner::asJsonObject() const {
    QJsonObject obj;
    if (m_ids.isSet()) {
...
OAIAdd_items_to_collection_request_episodes_inner_ids OAIAdd_new_ratings_request_episodes_inner::getIds() const {
    return m_ids;
}
void OAIAdd_new_ratings_request_episodes_inner::setIds(const OAIAdd_items_to_collection_request_episodes_inner_ids &ids) {
    m_ids = ids;
    m_ids_isSet = true;
}

bool OAIAdd_new_ratings_request_episodes_inner::is_ids_Set() const{
    return m_ids_isSet;
}

bool OAIAdd_new_ratings_request_episodes_inner::is_ids_Valid() const{
    return m_ids_isValid;
}

double OAIAdd_new_ratings_request_episodes_inner::getRating() const {
    return m_rating;
}
void OAIAdd_new_ratings_request_episodes_inner::setRating(const double &rating) {
    m_rating = rating;
    m_rating_isSet = true;
}

bool OAIAdd_new_ratings_request_episodes_inner::is_rating_Set() const{
    return m_rating_isSet;
}

bool OAIAdd_new_ratings_request_episodes_inner::is_rating_Valid() const{
    return m_rating_isValid;
}

bool OAIAdd_new_ratings_request_episodes_inner::isSet() const {
...
bool OAIAdd_new_ratings_request_episodes_inner::isValid() const {
