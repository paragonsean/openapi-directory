...
public:
    ...
    */
    virtual void get_all_list_comments(const qint32 &id, const QString &sort, const ::OpenAPI::OptionalParam<QString> &trakt_api_version = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &trakt_api_key = ::OpenAPI::OptionalParam<QString>());
    ...
    * @param[in]  trakt_api_key QString [optional]
    */
    virtual void get_all_users_who_liked_a_list(const QString &id, const ::OpenAPI::OptionalParam<QString> &trakt_api_version = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &trakt_api_key = ::OpenAPI::OptionalParam<QString>());
    ...
    * @param[in]  trakt_api_key QString [optional]
    */
    virtual void get_items_on_a_list(const QString &id, const QString &type, const ::OpenAPI::OptionalParam<QString> &trakt_api_version = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &trakt_api_key = ::OpenAPI::OptionalParam<QString>());
    ...
    * @param[in]  trakt_api_key QString [optional]
    */
    virtual void get_list(const qint32 &id, const ::OpenAPI::OptionalParam<QString> &trakt_api_version = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &trakt_api_key = ::OpenAPI::OptionalParam<QString>());

    /**
    * @param[in]  trakt_api_version QString [optional]
    * @param[in]  trakt_api_key QString [optional]
    */
    virtual void get_popular_lists(const ::OpenAPI::OptionalParam<QString> &trakt_api_version = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &trakt_api_key = ::OpenAPI::OptionalParam<QString>());

    /**
    * @param[in]  trakt_api_version QString [optional]
    * @param[in]  trakt_api_key QString [optional]
    */
    virtual void get_trending_lists(const ::OpenAPI::OptionalParam<QString> &trakt_api_version = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &trakt_api_key = ::OpenAPI::OptionalParam<QString>());
...
private:
    ...
    void get_all_list_commentsCallback(OAIHttpRequestWorker *worker);
    void get_all_users_who_liked_a_listCallback(OAIHttpRequestWorker *worker);
    void get_items_on_a_listCallback(OAIHttpRequestWorker *worker);
    void get_listCallback(OAIHttpRequestWorker *worker);
    void get_popular_listsCallback(OAIHttpRequestWorker *worker);
    void get_trending_listsCallback(OAIHttpRequestWorker *worker);

Q_SIGNALS:

    void get_all_list_commentsSignal();
    void get_all_users_who_liked_a_listSignal();
    void get_items_on_a_listSignal();
    void get_listSignal();
    void get_popular_listsSignal();
    void get_trending_listsSignal();


    void get_all_list_commentsSignalFull(OAIHttpRequestWorker *worker);
    void get_all_users_who_liked_a_listSignalFull(OAIHttpRequestWorker *worker);
    void get_items_on_a_listSignalFull(OAIHttpRequestWorker *worker);
    void get_listSignalFull(OAIHttpRequestWorker *worker);
    void get_popular_listsSignalFull(OAIHttpRequestWorker *worker);
    void get_trending_listsSignalFull(OAIHttpRequestWorker *worker);

    Q_DECL_DEPRECATED_X("Use get_all_list_commentsSignalError() instead")
    void get_all_list_commentsSignalE(QNetworkReply::NetworkError error_type, QString error_str);
    void get_all_list_commentsSignalError(QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use get_all_users_who_liked_a_listSignalError() instead")
    void get_all_users_who_liked_a_listSignalE(QNetworkReply::NetworkError error_type, QString error_str);
    void get_all_users_who_liked_a_listSignalError(QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use get_items_on_a_listSignalError() instead")
    void get_items_on_a_listSignalE(QNetworkReply::NetworkError error_type, QString error_str);
    void get_items_on_a_listSignalError(QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use get_listSignalError() instead")
    void get_listSignalE(QNetworkReply::NetworkError error_type, QString error_str);
    void get_listSignalError(QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use get_popular_listsSignalError() instead")
    void get_popular_listsSignalE(QNetworkReply::NetworkError error_type, QString error_str);
    void get_popular_listsSignalError(QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use get_trending_listsSignalError() instead")
    void get_trending_listsSignalE(QNetworkReply::NetworkError error_type, QString error_str);
    void get_trending_listsSignalError(QNetworkReply::NetworkError error_type, const QString &error_str);

    Q_DECL_DEPRECATED_X("Use get_all_list_commentsSignalErrorFull() instead")
    void get_all_list_commentsSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void get_all_list_commentsSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use get_all_users_who_liked_a_listSignalErrorFull() instead")
    void get_all_users_who_liked_a_listSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void get_all_users_who_liked_a_listSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use get_items_on_a_listSignalErrorFull() instead")
    void get_items_on_a_listSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void get_items_on_a_listSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use get_listSignalErrorFull() instead")
    void get_listSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void get_listSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use get_popular_listsSignalErrorFull() instead")
    void get_popular_listsSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void get_popular_listsSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use get_trending_listsSignalErrorFull() instead")
    void get_trending_listsSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void get_trending_listsSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
