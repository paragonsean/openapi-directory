...
public:
    ...
    */
    virtual void get_countries(const QString &type, const ::OpenAPI::OptionalParam<QString> &trakt_api_version = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &trakt_api_key = ::OpenAPI::OptionalParam<QString>());
...
private:
    ...
    void get_countriesCallback(OAIHttpRequestWorker *worker);

Q_SIGNALS:

    void get_countriesSignal();


    void get_countriesSignalFull(OAIHttpRequestWorker *worker);

    Q_DECL_DEPRECATED_X("Use get_countriesSignalError() instead")
    void get_countriesSignalE(QNetworkReply::NetworkError error_type, QString error_str);
    void get_countriesSignalError(QNetworkReply::NetworkError error_type, const QString &error_str);

    Q_DECL_DEPRECATED_X("Use get_countriesSignalErrorFull() instead")
    void get_countriesSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void get_countriesSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
