...
public:
    ...
    */
    virtual void get_a_single_person(const QString &id, const ::OpenAPI::OptionalParam<QString> &trakt_api_version = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &trakt_api_key = ::OpenAPI::OptionalParam<QString>());
    ...
    * @param[in]  trakt_api_key QString [optional]
    */
    virtual void get_lists_containing_this_person(const QString &id, const QString &type, const QString &sort, const ::OpenAPI::OptionalParam<QString> &trakt_api_version = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &trakt_api_key = ::OpenAPI::OptionalParam<QString>());
    ...
    * @param[in]  trakt_api_key QString [optional]
    */
    virtual void get_movie_credits(const QString &id, const ::OpenAPI::OptionalParam<QString> &trakt_api_version = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &trakt_api_key = ::OpenAPI::OptionalParam<QString>());
    ...
    * @param[in]  trakt_api_key QString [optional]
    */
    virtual void get_recently_updated_people(const QString &start_date, const ::OpenAPI::OptionalParam<QString> &trakt_api_version = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &trakt_api_key = ::OpenAPI::OptionalParam<QString>());
    ...
    * @param[in]  trakt_api_key QString [optional]
    */
    virtual void get_recently_updated_people_Trakt_IDs(const QString &start_date, const ::OpenAPI::OptionalParam<QString> &trakt_api_version = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &trakt_api_key = ::OpenAPI::OptionalParam<QString>());
    ...
    * @param[in]  trakt_api_key QString [optional]
    */
    virtual void get_show_credits(const QString &id, const ::OpenAPI::OptionalParam<QString> &trakt_api_version = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &trakt_api_key = ::OpenAPI::OptionalParam<QString>());
...
private:
    ...
    void get_a_single_personCallback(OAIHttpRequestWorker *worker);
    void get_lists_containing_this_personCallback(OAIHttpRequestWorker *worker);
    void get_movie_creditsCallback(OAIHttpRequestWorker *worker);
    void get_recently_updated_peopleCallback(OAIHttpRequestWorker *worker);
    void get_recently_updated_people_Trakt_IDsCallback(OAIHttpRequestWorker *worker);
    void get_show_creditsCallback(OAIHttpRequestWorker *worker);

Q_SIGNALS:

    void get_a_single_personSignal();
    void get_lists_containing_this_personSignal();
    void get_movie_creditsSignal();
    void get_recently_updated_peopleSignal();
    void get_recently_updated_people_Trakt_IDsSignal();
    void get_show_creditsSignal();


    void get_a_single_personSignalFull(OAIHttpRequestWorker *worker);
    void get_lists_containing_this_personSignalFull(OAIHttpRequestWorker *worker);
    void get_movie_creditsSignalFull(OAIHttpRequestWorker *worker);
    void get_recently_updated_peopleSignalFull(OAIHttpRequestWorker *worker);
    void get_recently_updated_people_Trakt_IDsSignalFull(OAIHttpRequestWorker *worker);
    void get_show_creditsSignalFull(OAIHttpRequestWorker *worker);

    Q_DECL_DEPRECATED_X("Use get_a_single_personSignalError() instead")
    void get_a_single_personSignalE(QNetworkReply::NetworkError error_type, QString error_str);
    void get_a_single_personSignalError(QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use get_lists_containing_this_personSignalError() instead")
    void get_lists_containing_this_personSignalE(QNetworkReply::NetworkError error_type, QString error_str);
    void get_lists_containing_this_personSignalError(QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use get_movie_creditsSignalError() instead")
    void get_movie_creditsSignalE(QNetworkReply::NetworkError error_type, QString error_str);
    void get_movie_creditsSignalError(QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use get_recently_updated_peopleSignalError() instead")
    void get_recently_updated_peopleSignalE(QNetworkReply::NetworkError error_type, QString error_str);
    void get_recently_updated_peopleSignalError(QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use get_recently_updated_people_Trakt_IDsSignalError() instead")
    void get_recently_updated_people_Trakt_IDsSignalE(QNetworkReply::NetworkError error_type, QString error_str);
    void get_recently_updated_people_Trakt_IDsSignalError(QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use get_show_creditsSignalError() instead")
    void get_show_creditsSignalE(QNetworkReply::NetworkError error_type, QString error_str);
    void get_show_creditsSignalError(QNetworkReply::NetworkError error_type, const QString &error_str);

    Q_DECL_DEPRECATED_X("Use get_a_single_personSignalErrorFull() instead")
    void get_a_single_personSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void get_a_single_personSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use get_lists_containing_this_personSignalErrorFull() instead")
    void get_lists_containing_this_personSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void get_lists_containing_this_personSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use get_movie_creditsSignalErrorFull() instead")
    void get_movie_creditsSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void get_movie_creditsSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use get_recently_updated_peopleSignalErrorFull() instead")
    void get_recently_updated_peopleSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void get_recently_updated_peopleSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use get_recently_updated_people_Trakt_IDsSignalErrorFull() instead")
    void get_recently_updated_people_Trakt_IDsSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void get_recently_updated_people_Trakt_IDsSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use get_show_creditsSignalErrorFull() instead")
    void get_show_creditsSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void get_show_creditsSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
