...
void OAICalendarsApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("calendarsAllDvdStartDateDaysGet", defaultConf);
    _serverIndices.insert("calendarsAllDvdStartDateDaysGet", 0);
    _serverConfigs.insert("calendarsAllMoviesStartDateDaysGet", defaultConf);
    _serverIndices.insert("calendarsAllMoviesStartDateDaysGet", 0);
    _serverConfigs.insert("calendarsAllShowsNewStartDateDaysGet", defaultConf);
    _serverIndices.insert("calendarsAllShowsNewStartDateDaysGet", 0);
    _serverConfigs.insert("calendarsAllShowsPremieresStartDateDaysGet", defaultConf);
    _serverIndices.insert("calendarsAllShowsPremieresStartDateDaysGet", 0);
    _serverConfigs.insert("calendarsAllShowsStartDateDaysGet", defaultConf);
    _serverIndices.insert("calendarsAllShowsStartDateDaysGet", 0);
    _serverConfigs.insert("get_DVD_releases", defaultConf);
    _serverIndices.insert("get_DVD_releases", 0);
    _serverConfigs.insert("get_movies", defaultConf);
    _serverIndices.insert("get_movies", 0);
    _serverConfigs.insert("get_new_shows", defaultConf);
    _serverIndices.insert("get_new_shows", 0);
    _serverConfigs.insert("get_season_premieres", defaultConf);
    _serverIndices.insert("get_season_premieres", 0);
    _serverConfigs.insert("get_shows", defaultConf);
    _serverIndices.insert("get_shows", 0);
}
...
void OAICalendarsApi::calendarsAllDvdStartDateDaysGet(const QString &start_date, const qint32 &days, const ::OpenAPI::OptionalParam<QString> &trakt_api_version, const ::OpenAPI::OptionalParam<QString> &trakt_api_key) {
    QString fullPath = QString(_serverConfigs["calendarsAllDvdStartDateDaysGet"][_serverIndices.value("calendarsAllDvdStartDateDaysGet")].URL()+"/calendars/all/dvd/{start_date}/{days}");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAICalendarsApi::calendarsAllDvdStartDateDaysGetCallback);
...
void OAICalendarsApi::calendarsAllDvdStartDateDaysGetCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT calendarsAllDvdStartDateDaysGetSignal();
        Q_EMIT calendarsAllDvdStartDateDaysGetSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT calendarsAllDvdStartDateDaysGetSignalE(error_type, error_str);
        Q_EMIT calendarsAllDvdStartDateDaysGetSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT calendarsAllDvdStartDateDaysGetSignalError(error_type, error_str);
        Q_EMIT calendarsAllDvdStartDateDaysGetSignalErrorFull(worker, error_type, error_str);
    }
}

void OAICalendarsApi::calendarsAllMoviesStartDateDaysGet(const QString &start_date, const qint32 &days, const ::OpenAPI::OptionalParam<QString> &trakt_api_version, const ::OpenAPI::OptionalParam<QString> &trakt_api_key) {
    QString fullPath = QString(_serverConfigs["calendarsAllMoviesStartDateDaysGet"][_serverIndices.value("calendarsAllMoviesStartDateDaysGet")].URL()+"/calendars/all/movies/{start_date}/{days}");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAICalendarsApi::calendarsAllMoviesStartDateDaysGetCallback);
    connect(this, &OAICalendarsApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAICalendarsApi::calendarsAllMoviesStartDateDaysGetCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT calendarsAllMoviesStartDateDaysGetSignal();
        Q_EMIT calendarsAllMoviesStartDateDaysGetSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT calendarsAllMoviesStartDateDaysGetSignalE(error_type, error_str);
        Q_EMIT calendarsAllMoviesStartDateDaysGetSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT calendarsAllMoviesStartDateDaysGetSignalError(error_type, error_str);
        Q_EMIT calendarsAllMoviesStartDateDaysGetSignalErrorFull(worker, error_type, error_str);
    }
}

void OAICalendarsApi::calendarsAllShowsNewStartDateDaysGet(const QString &start_date, const qint32 &days, const ::OpenAPI::OptionalParam<QString> &trakt_api_version, const ::OpenAPI::OptionalParam<QString> &trakt_api_key) {
    QString fullPath = QString(_serverConfigs["calendarsAllShowsNewStartDateDaysGet"][_serverIndices.value("calendarsAllShowsNewStartDateDaysGet")].URL()+"/calendars/all/shows/new/{start_date}/{days}");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAICalendarsApi::calendarsAllShowsNewStartDateDaysGetCallback);
    connect(this, &OAICalendarsApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAICalendarsApi::calendarsAllShowsNewStartDateDaysGetCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT calendarsAllShowsNewStartDateDaysGetSignal();
        Q_EMIT calendarsAllShowsNewStartDateDaysGetSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT calendarsAllShowsNewStartDateDaysGetSignalE(error_type, error_str);
        Q_EMIT calendarsAllShowsNewStartDateDaysGetSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT calendarsAllShowsNewStartDateDaysGetSignalError(error_type, error_str);
        Q_EMIT calendarsAllShowsNewStartDateDaysGetSignalErrorFull(worker, error_type, error_str);
    }
}

void OAICalendarsApi::calendarsAllShowsPremieresStartDateDaysGet(const QString &start_date, const qint32 &days, const ::OpenAPI::OptionalParam<QString> &trakt_api_version, const ::OpenAPI::OptionalParam<QString> &trakt_api_key) {
    QString fullPath = QString(_serverConfigs["calendarsAllShowsPremieresStartDateDaysGet"][_serverIndices.value("calendarsAllShowsPremieresStartDateDaysGet")].URL()+"/calendars/all/shows/premieres/{start_date}/{days}");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAICalendarsApi::calendarsAllShowsPremieresStartDateDaysGetCallback);
    connect(this, &OAICalendarsApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAICalendarsApi::calendarsAllShowsPremieresStartDateDaysGetCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT calendarsAllShowsPremieresStartDateDaysGetSignal();
        Q_EMIT calendarsAllShowsPremieresStartDateDaysGetSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT calendarsAllShowsPremieresStartDateDaysGetSignalE(error_type, error_str);
        Q_EMIT calendarsAllShowsPremieresStartDateDaysGetSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT calendarsAllShowsPremieresStartDateDaysGetSignalError(error_type, error_str);
        Q_EMIT calendarsAllShowsPremieresStartDateDaysGetSignalErrorFull(worker, error_type, error_str);
    }
}

void OAICalendarsApi::calendarsAllShowsStartDateDaysGet(const QString &start_date, const qint32 &days, const ::OpenAPI::OptionalParam<QString> &trakt_api_version, const ::OpenAPI::OptionalParam<QString> &trakt_api_key) {
    QString fullPath = QString(_serverConfigs["calendarsAllShowsStartDateDaysGet"][_serverIndices.value("calendarsAllShowsStartDateDaysGet")].URL()+"/calendars/all/shows/{start_date}/{days}");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAICalendarsApi::calendarsAllShowsStartDateDaysGetCallback);
    connect(this, &OAICalendarsApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAICalendarsApi::calendarsAllShowsStartDateDaysGetCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT calendarsAllShowsStartDateDaysGetSignal();
        Q_EMIT calendarsAllShowsStartDateDaysGetSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT calendarsAllShowsStartDateDaysGetSignalE(error_type, error_str);
        Q_EMIT calendarsAllShowsStartDateDaysGetSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT calendarsAllShowsStartDateDaysGetSignalError(error_type, error_str);
        Q_EMIT calendarsAllShowsStartDateDaysGetSignalErrorFull(worker, error_type, error_str);
    }
}

void OAICalendarsApi::get_DVD_releases(const QString &start_date, const qint32 &days, const ::OpenAPI::OptionalParam<QString> &trakt_api_version, const ::OpenAPI::OptionalParam<QString> &trakt_api_key) {
    QString fullPath = QString(_serverConfigs["get_DVD_releases"][_serverIndices.value("get_DVD_releases")].URL()+"/calendars/my/dvd/{start_date}/{days}");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAICalendarsApi::get_DVD_releasesCallback);
    connect(this, &OAICalendarsApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAICalendarsApi::get_DVD_releasesCallback);
...
void OAICalendarsApi::get_DVD_releasesCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT get_DVD_releasesSignal();
        Q_EMIT get_DVD_releasesSignalFull(worker);
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT get_DVD_releasesSignalE(error_type, error_str);
        Q_EMIT get_DVD_releasesSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT get_DVD_releasesSignalError(error_type, error_str);
        Q_EMIT get_DVD_releasesSignalErrorFull(worker, error_type, error_str);
    }
}

void OAICalendarsApi::get_movies(const QString &start_date, const qint32 &days, const ::OpenAPI::OptionalParam<QString> &trakt_api_version, const ::OpenAPI::OptionalParam<QString> &trakt_api_key) {
    QString fullPath = QString(_serverConfigs["get_movies"][_serverIndices.value("get_movies")].URL()+"/calendars/my/movies/{start_date}/{days}");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAICalendarsApi::get_moviesCallback);
    connect(this, &OAICalendarsApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAICalendarsApi::get_moviesCallback);
    connect(this, &OAICalendarsApi::abortRequestsSignal, _latestWorker, &QObject::deleteLater);
    connect(_latestWorker, &QObject::destroyed, [this](){
        if(findChildren<OAIHttpRequestWorker*>().count() == 0){
            Q_EMIT allPendingRequestsCompleted();
...
void OAICalendarsApi::get_moviesCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT get_moviesSignal();
        Q_EMIT get_moviesSignalFull(worker);
    } else if(worker->error_type == QNetworkReply::AuthenticationRequiredError){
        connect(&_authFlow, SIGNAL(tokenReceived()), this, SLOT(tokenAvailable()));
        QStringList scope;
        QString scopeStr = scope.join(" ");
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT get_moviesSignalE(error_type, error_str);
        Q_EMIT get_moviesSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT get_moviesSignalError(error_type, error_str);
        Q_EMIT get_moviesSignalErrorFull(worker, error_type, error_str);
    }
}

void OAICalendarsApi::get_new_shows(const QString &start_date, const qint32 &days, const ::OpenAPI::OptionalParam<QString> &trakt_api_version, const ::OpenAPI::OptionalParam<QString> &trakt_api_key) {
    QString fullPath = QString(_serverConfigs["get_new_shows"][_serverIndices.value("get_new_shows")].URL()+"/calendars/my/shows/new/{start_date}/{days}");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAICalendarsApi::get_new_showsCallback);
    connect(this, &OAICalendarsApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAICalendarsApi::get_new_showsCallback);
    connect(this, &OAICalendarsApi::abortRequestsSignal, _latestWorker, &QObject::deleteLater);
    connect(_latestWorker, &QObject::destroyed, [this](){
        if(findChildren<OAIHttpRequestWorker*>().count() == 0){
            Q_EMIT allPendingRequestsCompleted();
...
void OAICalendarsApi::get_new_showsCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT get_new_showsSignal();
        Q_EMIT get_new_showsSignalFull(worker);
    } else if(worker->error_type == QNetworkReply::AuthenticationRequiredError){
        connect(&_authFlow, SIGNAL(tokenReceived()), this, SLOT(tokenAvailable()));
        QStringList scope;
        QString scopeStr = scope.join(" ");
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT get_new_showsSignalE(error_type, error_str);
        Q_EMIT get_new_showsSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT get_new_showsSignalError(error_type, error_str);
        Q_EMIT get_new_showsSignalErrorFull(worker, error_type, error_str);
    }
}

void OAICalendarsApi::get_season_premieres(const QString &start_date, const qint32 &days, const ::OpenAPI::OptionalParam<QString> &trakt_api_version, const ::OpenAPI::OptionalParam<QString> &trakt_api_key) {
    QString fullPath = QString(_serverConfigs["get_season_premieres"][_serverIndices.value("get_season_premieres")].URL()+"/calendars/my/shows/premieres/{start_date}/{days}");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAICalendarsApi::get_season_premieresCallback);
    connect(this, &OAICalendarsApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAICalendarsApi::get_season_premieresCallback);
    connect(this, &OAICalendarsApi::abortRequestsSignal, _latestWorker, &QObject::deleteLater);
    connect(_latestWorker, &QObject::destroyed, [this](){
        if(findChildren<OAIHttpRequestWorker*>().count() == 0){
            Q_EMIT allPendingRequestsCompleted();
...
void OAICalendarsApi::get_season_premieresCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT get_season_premieresSignal();
        Q_EMIT get_season_premieresSignalFull(worker);
    } else if(worker->error_type == QNetworkReply::AuthenticationRequiredError){
        connect(&_authFlow, SIGNAL(tokenReceived()), this, SLOT(tokenAvailable()));
        QStringList scope;
        QString scopeStr = scope.join(" ");
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT get_season_premieresSignalE(error_type, error_str);
        Q_EMIT get_season_premieresSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT get_season_premieresSignalError(error_type, error_str);
        Q_EMIT get_season_premieresSignalErrorFull(worker, error_type, error_str);
    }
}

void OAICalendarsApi::get_shows(const QString &start_date, const qint32 &days, const ::OpenAPI::OptionalParam<QString> &trakt_api_version, const ::OpenAPI::OptionalParam<QString> &trakt_api_key) {
    QString fullPath = QString(_serverConfigs["get_shows"][_serverIndices.value("get_shows")].URL()+"/calendars/my/shows/{start_date}/{days}");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAICalendarsApi::get_showsCallback);
    connect(this, &OAICalendarsApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAICalendarsApi::get_showsCallback);
    connect(this, &OAICalendarsApi::abortRequestsSignal, _latestWorker, &QObject::deleteLater);
    connect(_latestWorker, &QObject::destroyed, [this](){
        if(findChildren<OAIHttpRequestWorker*>().count() == 0){
            Q_EMIT allPendingRequestsCompleted();
...
void OAICalendarsApi::get_showsCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT get_showsSignal();
        Q_EMIT get_showsSignalFull(worker);
    } else if(worker->error_type == QNetworkReply::AuthenticationRequiredError){
        connect(&_authFlow, SIGNAL(tokenReceived()), this, SLOT(tokenAvailable()));
        QStringList scope;
        QString scopeStr = scope.join(" ");
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT get_showsSignalE(error_type, error_str);
        Q_EMIT get_showsSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT get_showsSignalError(error_type, error_str);
        Q_EMIT get_showsSignalErrorFull(worker, error_type, error_str);
    }
}
