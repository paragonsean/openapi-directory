...
OAIPause_watching_in_a_media_center_request::OAIPause_watching_in_a_media_center_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPause_watching_in_a_media_center_request::OAIPause_watching_in_a_media_center_request() {
    this->initializeModel();
}

OAIPause_watching_in_a_media_center_request::~OAIPause_watching_in_a_media_center_request() {}

void OAIPause_watching_in_a_media_center_request::initializeModel() {
...
void OAIPause_watching_in_a_media_center_request::fromJson(QString jsonString) {
...
void OAIPause_watching_in_a_media_center_request::fromJsonObject(QJsonObject json) {
...
QString OAIPause_watching_in_a_media_center_request::asJson() const {
...
QJsonObject OAIPause_watching_in_a_media_center_request::asJsonObject() const {
    QJsonObject obj;
    if (m_app_date_isSet) {
...
QString OAIPause_watching_in_a_media_center_request::getAppDate() const {
    return m_app_date;
}
void OAIPause_watching_in_a_media_center_request::setAppDate(const QString &app_date) {
    m_app_date = app_date;
    m_app_date_isSet = true;
}

bool OAIPause_watching_in_a_media_center_request::is_app_date_Set() const{
    return m_app_date_isSet;
}

bool OAIPause_watching_in_a_media_center_request::is_app_date_Valid() const{
    return m_app_date_isValid;
}

QString OAIPause_watching_in_a_media_center_request::getAppVersion() const {
    return m_app_version;
}
void OAIPause_watching_in_a_media_center_request::setAppVersion(const QString &app_version) {
    m_app_version = app_version;
    m_app_version_isSet = true;
}

bool OAIPause_watching_in_a_media_center_request::is_app_version_Set() const{
    return m_app_version_isSet;
}

bool OAIPause_watching_in_a_media_center_request::is_app_version_Valid() const{
    return m_app_version_isValid;
}

OAICheck_into_an_item_request_movie OAIPause_watching_in_a_media_center_request::getMovie() const {
    return m_movie;
}
void OAIPause_watching_in_a_media_center_request::setMovie(const OAICheck_into_an_item_request_movie &movie) {
    m_movie = movie;
    m_movie_isSet = true;
}

bool OAIPause_watching_in_a_media_center_request::is_movie_Set() const{
    return m_movie_isSet;
}

bool OAIPause_watching_in_a_media_center_request::is_movie_Valid() const{
    return m_movie_isValid;
}

double OAIPause_watching_in_a_media_center_request::getProgress() const {
    return m_progress;
}
void OAIPause_watching_in_a_media_center_request::setProgress(const double &progress) {
    m_progress = progress;
    m_progress_isSet = true;
}

bool OAIPause_watching_in_a_media_center_request::is_progress_Set() const{
    return m_progress_isSet;
}

bool OAIPause_watching_in_a_media_center_request::is_progress_Valid() const{
    return m_progress_isValid;
}

bool OAIPause_watching_in_a_media_center_request::isSet() const {
...
bool OAIPause_watching_in_a_media_center_request::isValid() const {
