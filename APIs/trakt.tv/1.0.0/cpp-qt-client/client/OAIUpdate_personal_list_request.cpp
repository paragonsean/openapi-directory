...
OAIUpdate_personal_list_request::OAIUpdate_personal_list_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdate_personal_list_request::OAIUpdate_personal_list_request() {
    this->initializeModel();
}

OAIUpdate_personal_list_request::~OAIUpdate_personal_list_request() {}

void OAIUpdate_personal_list_request::initializeModel() {
...
void OAIUpdate_personal_list_request::fromJson(QString jsonString) {
...
void OAIUpdate_personal_list_request::fromJsonObject(QJsonObject json) {
...
QString OAIUpdate_personal_list_request::asJson() const {
...
QJsonObject OAIUpdate_personal_list_request::asJsonObject() const {
    QJsonObject obj;
...
bool OAIUpdate_personal_list_request::isDisplayNumbers() const {
    return m_display_numbers;
}
void OAIUpdate_personal_list_request::setDisplayNumbers(const bool &display_numbers) {
    m_display_numbers = display_numbers;
    m_display_numbers_isSet = true;
}

bool OAIUpdate_personal_list_request::is_display_numbers_Set() const{
    return m_display_numbers_isSet;
}

bool OAIUpdate_personal_list_request::is_display_numbers_Valid() const{
    return m_display_numbers_isValid;
}

QString OAIUpdate_personal_list_request::getName() const {
    return m_name;
}
void OAIUpdate_personal_list_request::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIUpdate_personal_list_request::is_name_Set() const{
    return m_name_isSet;
}

bool OAIUpdate_personal_list_request::is_name_Valid() const{
    return m_name_isValid;
}

QString OAIUpdate_personal_list_request::getPrivacy() const {
    return m_privacy;
}
void OAIUpdate_personal_list_request::setPrivacy(const QString &privacy) {
    m_privacy = privacy;
    m_privacy_isSet = true;
}

bool OAIUpdate_personal_list_request::is_privacy_Set() const{
    return m_privacy_isSet;
}

bool OAIUpdate_personal_list_request::is_privacy_Valid() const{
    return m_privacy_isValid;
}

QString OAIUpdate_personal_list_request::getSortBy() const {
    return m_sort_by;
}
void OAIUpdate_personal_list_request::setSortBy(const QString &sort_by) {
    m_sort_by = sort_by;
    m_sort_by_isSet = true;
}

bool OAIUpdate_personal_list_request::is_sort_by_Set() const{
    return m_sort_by_isSet;
}

bool OAIUpdate_personal_list_request::is_sort_by_Valid() const{
    return m_sort_by_isValid;
}

QString OAIUpdate_personal_list_request::getSortHow() const {
    return m_sort_how;
}
void OAIUpdate_personal_list_request::setSortHow(const QString &sort_how) {
    m_sort_how = sort_how;
    m_sort_how_isSet = true;
}

bool OAIUpdate_personal_list_request::is_sort_how_Set() const{
    return m_sort_how_isSet;
}

bool OAIUpdate_personal_list_request::is_sort_how_Valid() const{
    return m_sort_how_isValid;
}

bool OAIUpdate_personal_list_request::isSet() const {
...
bool OAIUpdate_personal_list_request::isValid() const {
