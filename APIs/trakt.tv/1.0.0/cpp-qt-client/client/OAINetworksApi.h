...
public:
    ...
    */
    virtual void get_networks(const ::OpenAPI::OptionalParam<QString> &trakt_api_version = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &trakt_api_key = ::OpenAPI::OptionalParam<QString>());
...
private:
    ...
    void get_networksCallback(OAIHttpRequestWorker *worker);

Q_SIGNALS:

    void get_networksSignal();


    void get_networksSignalFull(OAIHttpRequestWorker *worker);

    Q_DECL_DEPRECATED_X("Use get_networksSignalError() instead")
    void get_networksSignalE(QNetworkReply::NetworkError error_type, QString error_str);
    void get_networksSignalError(QNetworkReply::NetworkError error_type, const QString &error_str);

    Q_DECL_DEPRECATED_X("Use get_networksSignalErrorFull() instead")
    void get_networksSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void get_networksSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
