...
#include "OAIAdd_items_to_collection_request_seasons_inner_ids.h"
...
OAIAdd_items_to_collection_request_seasons_inner_ids::OAIAdd_items_to_collection_request_seasons_inner_ids(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAdd_items_to_collection_request_seasons_inner_ids::OAIAdd_items_to_collection_request_seasons_inner_ids() {
    this->initializeModel();
}

OAIAdd_items_to_collection_request_seasons_inner_ids::~OAIAdd_items_to_collection_request_seasons_inner_ids() {}

void OAIAdd_items_to_collection_request_seasons_inner_ids::initializeModel() {
...
void OAIAdd_items_to_collection_request_seasons_inner_ids::fromJson(QString jsonString) {
...
void OAIAdd_items_to_collection_request_seasons_inner_ids::fromJsonObject(QJsonObject json) {
...
QString OAIAdd_items_to_collection_request_seasons_inner_ids::asJson() const {
...
QJsonObject OAIAdd_items_to_collection_request_seasons_inner_ids::asJsonObject() const {
    QJsonObject obj;
    if (m_tmdb_isSet) {
...
double OAIAdd_items_to_collection_request_seasons_inner_ids::getTmdb() const {
    return m_tmdb;
}
void OAIAdd_items_to_collection_request_seasons_inner_ids::setTmdb(const double &tmdb) {
    m_tmdb = tmdb;
    m_tmdb_isSet = true;
}

bool OAIAdd_items_to_collection_request_seasons_inner_ids::is_tmdb_Set() const{
    return m_tmdb_isSet;
}

bool OAIAdd_items_to_collection_request_seasons_inner_ids::is_tmdb_Valid() const{
    return m_tmdb_isValid;
}

double OAIAdd_items_to_collection_request_seasons_inner_ids::getTrakt() const {
    return m_trakt;
}
void OAIAdd_items_to_collection_request_seasons_inner_ids::setTrakt(const double &trakt) {
    m_trakt = trakt;
    m_trakt_isSet = true;
}

bool OAIAdd_items_to_collection_request_seasons_inner_ids::is_trakt_Set() const{
    return m_trakt_isSet;
}

bool OAIAdd_items_to_collection_request_seasons_inner_ids::is_trakt_Valid() const{
    return m_trakt_isValid;
}

double OAIAdd_items_to_collection_request_seasons_inner_ids::getTvdb() const {
    return m_tvdb;
}
void OAIAdd_items_to_collection_request_seasons_inner_ids::setTvdb(const double &tvdb) {
    m_tvdb = tvdb;
    m_tvdb_isSet = true;
}

bool OAIAdd_items_to_collection_request_seasons_inner_ids::is_tvdb_Set() const{
    return m_tvdb_isSet;
}

bool OAIAdd_items_to_collection_request_seasons_inner_ids::is_tvdb_Valid() const{
    return m_tvdb_isValid;
}

bool OAIAdd_items_to_collection_request_seasons_inner_ids::isSet() const {
...
bool OAIAdd_items_to_collection_request_seasons_inner_ids::isValid() const {
