...
#include "OAIAdd_items_to_personal_list_request_movies_inner.h"
...
OAIAdd_items_to_personal_list_request_movies_inner::OAIAdd_items_to_personal_list_request_movies_inner(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAdd_items_to_personal_list_request_movies_inner::OAIAdd_items_to_personal_list_request_movies_inner() {
    this->initializeModel();
}

OAIAdd_items_to_personal_list_request_movies_inner::~OAIAdd_items_to_personal_list_request_movies_inner() {}

void OAIAdd_items_to_personal_list_request_movies_inner::initializeModel() {
...
void OAIAdd_items_to_personal_list_request_movies_inner::fromJson(QString jsonString) {
...
void OAIAdd_items_to_personal_list_request_movies_inner::fromJsonObject(QJsonObject json) {
...
QString OAIAdd_items_to_personal_list_request_movies_inner::asJson() const {
...
QJsonObject OAIAdd_items_to_personal_list_request_movies_inner::asJsonObject() const {
    QJsonObject obj;
    if (m_ids.isSet()) {
...
OAIAdd_items_to_personal_list_request_movies_inner_ids OAIAdd_items_to_personal_list_request_movies_inner::getIds() const {
    return m_ids;
}
void OAIAdd_items_to_personal_list_request_movies_inner::setIds(const OAIAdd_items_to_personal_list_request_movies_inner_ids &ids) {
    m_ids = ids;
    m_ids_isSet = true;
}

bool OAIAdd_items_to_personal_list_request_movies_inner::is_ids_Set() const{
    return m_ids_isSet;
}

bool OAIAdd_items_to_personal_list_request_movies_inner::is_ids_Valid() const{
    return m_ids_isValid;
}

QString OAIAdd_items_to_personal_list_request_movies_inner::getNotes() const {
    return m_notes;
}
void OAIAdd_items_to_personal_list_request_movies_inner::setNotes(const QString &notes) {
    m_notes = notes;
    m_notes_isSet = true;
}

bool OAIAdd_items_to_personal_list_request_movies_inner::is_notes_Set() const{
    return m_notes_isSet;
}

bool OAIAdd_items_to_personal_list_request_movies_inner::is_notes_Valid() const{
    return m_notes_isValid;
}

bool OAIAdd_items_to_personal_list_request_movies_inner::isSet() const {
...
bool OAIAdd_items_to_personal_list_request_movies_inner::isValid() const {
