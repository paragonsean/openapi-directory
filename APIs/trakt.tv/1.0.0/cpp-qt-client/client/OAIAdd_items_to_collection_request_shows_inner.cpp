...
#include "OAIAdd_items_to_collection_request_shows_inner.h"
...
OAIAdd_items_to_collection_request_shows_inner::OAIAdd_items_to_collection_request_shows_inner(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAdd_items_to_collection_request_shows_inner::OAIAdd_items_to_collection_request_shows_inner() {
    this->initializeModel();
}

OAIAdd_items_to_collection_request_shows_inner::~OAIAdd_items_to_collection_request_shows_inner() {}

void OAIAdd_items_to_collection_request_shows_inner::initializeModel() {
...
void OAIAdd_items_to_collection_request_shows_inner::fromJson(QString jsonString) {
...
void OAIAdd_items_to_collection_request_shows_inner::fromJsonObject(QJsonObject json) {
...
QString OAIAdd_items_to_collection_request_shows_inner::asJson() const {
...
QJsonObject OAIAdd_items_to_collection_request_shows_inner::asJsonObject() const {
    QJsonObject obj;
    if (m_ids.isSet()) {
...
OAIAdd_items_to_collection_request_shows_inner_ids OAIAdd_items_to_collection_request_shows_inner::getIds() const {
    return m_ids;
}
void OAIAdd_items_to_collection_request_shows_inner::setIds(const OAIAdd_items_to_collection_request_shows_inner_ids &ids) {
    m_ids = ids;
    m_ids_isSet = true;
}

bool OAIAdd_items_to_collection_request_shows_inner::is_ids_Set() const{
    return m_ids_isSet;
}

bool OAIAdd_items_to_collection_request_shows_inner::is_ids_Valid() const{
    return m_ids_isValid;
}

QList<OAIAdd_items_to_collection_request_shows_inner_seasons_inner> OAIAdd_items_to_collection_request_shows_inner::getSeasons() const {
    return m_seasons;
}
void OAIAdd_items_to_collection_request_shows_inner::setSeasons(const QList<OAIAdd_items_to_collection_request_shows_inner_seasons_inner> &seasons) {
    m_seasons = seasons;
    m_seasons_isSet = true;
}

bool OAIAdd_items_to_collection_request_shows_inner::is_seasons_Set() const{
    return m_seasons_isSet;
}

bool OAIAdd_items_to_collection_request_shows_inner::is_seasons_Valid() const{
    return m_seasons_isValid;
}

QString OAIAdd_items_to_collection_request_shows_inner::getTitle() const {
    return m_title;
}
void OAIAdd_items_to_collection_request_shows_inner::setTitle(const QString &title) {
    m_title = title;
    m_title_isSet = true;
}

bool OAIAdd_items_to_collection_request_shows_inner::is_title_Set() const{
    return m_title_isSet;
}

bool OAIAdd_items_to_collection_request_shows_inner::is_title_Valid() const{
    return m_title_isValid;
}

double OAIAdd_items_to_collection_request_shows_inner::getYear() const {
    return m_year;
}
void OAIAdd_items_to_collection_request_shows_inner::setYear(const double &year) {
    m_year = year;
    m_year_isSet = true;
}

bool OAIAdd_items_to_collection_request_shows_inner::is_year_Set() const{
    return m_year_isSet;
}

bool OAIAdd_items_to_collection_request_shows_inner::is_year_Valid() const{
    return m_year_isValid;
}

bool OAIAdd_items_to_collection_request_shows_inner::isSet() const {
...
bool OAIAdd_items_to_collection_request_shows_inner::isValid() const {
