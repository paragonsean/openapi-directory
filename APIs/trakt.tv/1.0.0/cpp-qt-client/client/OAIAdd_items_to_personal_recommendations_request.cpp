...
OAIAdd_items_to_personal_recommendations_request::OAIAdd_items_to_personal_recommendations_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAdd_items_to_personal_recommendations_request::OAIAdd_items_to_personal_recommendations_request() {
    this->initializeModel();
}

OAIAdd_items_to_personal_recommendations_request::~OAIAdd_items_to_personal_recommendations_request() {}

void OAIAdd_items_to_personal_recommendations_request::initializeModel() {
...
void OAIAdd_items_to_personal_recommendations_request::fromJson(QString jsonString) {
...
void OAIAdd_items_to_personal_recommendations_request::fromJsonObject(QJsonObject json) {
...
QString OAIAdd_items_to_personal_recommendations_request::asJson() const {
...
QJsonObject OAIAdd_items_to_personal_recommendations_request::asJsonObject() const {
    QJsonObject obj;
    if (m_movies.size() > 0) {
...
QList<OAIAdd_items_to_personal_recommendations_request_movies_inner> OAIAdd_items_to_personal_recommendations_request::getMovies() const {
    return m_movies;
}
void OAIAdd_items_to_personal_recommendations_request::setMovies(const QList<OAIAdd_items_to_personal_recommendations_request_movies_inner> &movies) {
    m_movies = movies;
    m_movies_isSet = true;
}

bool OAIAdd_items_to_personal_recommendations_request::is_movies_Set() const{
    return m_movies_isSet;
}

bool OAIAdd_items_to_personal_recommendations_request::is_movies_Valid() const{
    return m_movies_isValid;
}

QList<OAIAdd_items_to_personal_recommendations_request_shows_inner> OAIAdd_items_to_personal_recommendations_request::getShows() const {
    return m_shows;
}
void OAIAdd_items_to_personal_recommendations_request::setShows(const QList<OAIAdd_items_to_personal_recommendations_request_shows_inner> &shows) {
    m_shows = shows;
    m_shows_isSet = true;
}

bool OAIAdd_items_to_personal_recommendations_request::is_shows_Set() const{
    return m_shows_isSet;
}

bool OAIAdd_items_to_personal_recommendations_request::is_shows_Valid() const{
    return m_shows_isValid;
}

bool OAIAdd_items_to_personal_recommendations_request::isSet() const {
...
bool OAIAdd_items_to_personal_recommendations_request::isValid() const {
