...
#include "OAIAdd_items_to_watched_history_request_shows_inner_seasons_inner.h"
...
OAIAdd_items_to_watched_history_request_shows_inner_seasons_inner::OAIAdd_items_to_watched_history_request_shows_inner_seasons_inner(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAdd_items_to_watched_history_request_shows_inner_seasons_inner::OAIAdd_items_to_watched_history_request_shows_inner_seasons_inner() {
    this->initializeModel();
}

OAIAdd_items_to_watched_history_request_shows_inner_seasons_inner::~OAIAdd_items_to_watched_history_request_shows_inner_seasons_inner() {}

void OAIAdd_items_to_watched_history_request_shows_inner_seasons_inner::initializeModel() {
    ...
    m_watched_at_isSet = false;
    m_watched_at_isValid = false;
}

void OAIAdd_items_to_watched_history_request_shows_inner_seasons_inner::fromJson(QString jsonString) {
...
void OAIAdd_items_to_watched_history_request_shows_inner_seasons_inner::fromJsonObject(QJsonObject json) {
    ...
    m_watched_at_isValid = ::OpenAPI::fromJsonValue(m_watched_at, json[QString("watched_at")]);
    m_watched_at_isSet = !json[QString("watched_at")].isNull() && m_watched_at_isValid;
}

QString OAIAdd_items_to_watched_history_request_shows_inner_seasons_inner::asJson() const {
...
QJsonObject OAIAdd_items_to_watched_history_request_shows_inner_seasons_inner::asJsonObject() const {
    QJsonObject obj;
    ...
    if (m_watched_at_isSet) {
        obj.insert(QString("watched_at"), ::OpenAPI::toJsonValue(m_watched_at));
    }
    return obj;
}

QList<OAIAdd_items_to_watched_history_request_shows_inner_seasons_inner_episodes_inner> OAIAdd_items_to_watched_history_request_shows_inner_seasons_inner::getEpisodes() const {
    return m_episodes;
}
void OAIAdd_items_to_watched_history_request_shows_inner_seasons_inner::setEpisodes(const QList<OAIAdd_items_to_watched_history_request_shows_inner_seasons_inner_episodes_inner> &episodes) {
    m_episodes = episodes;
    m_episodes_isSet = true;
}

bool OAIAdd_items_to_watched_history_request_shows_inner_seasons_inner::is_episodes_Set() const{
    return m_episodes_isSet;
}

bool OAIAdd_items_to_watched_history_request_shows_inner_seasons_inner::is_episodes_Valid() const{
    return m_episodes_isValid;
}

double OAIAdd_items_to_watched_history_request_shows_inner_seasons_inner::getNumber() const {
    return m_number;
}
void OAIAdd_items_to_watched_history_request_shows_inner_seasons_inner::setNumber(const double &number) {
    m_number = number;
    m_number_isSet = true;
}

bool OAIAdd_items_to_watched_history_request_shows_inner_seasons_inner::is_number_Set() const{
    return m_number_isSet;
}

bool OAIAdd_items_to_watched_history_request_shows_inner_seasons_inner::is_number_Valid() const{
    return m_number_isValid;
}

QString OAIAdd_items_to_watched_history_request_shows_inner_seasons_inner::getWatchedAt() const {
    return m_watched_at;
}
void OAIAdd_items_to_watched_history_request_shows_inner_seasons_inner::setWatchedAt(const QString &watched_at) {
    m_watched_at = watched_at;
    m_watched_at_isSet = true;
}

bool OAIAdd_items_to_watched_history_request_shows_inner_seasons_inner::is_watched_at_Set() const{
    return m_watched_at_isSet;
}

bool OAIAdd_items_to_watched_history_request_shows_inner_seasons_inner::is_watched_at_Valid() const{
    return m_watched_at_isValid;
}

bool OAIAdd_items_to_watched_history_request_shows_inner_seasons_inner::isSet() const {
...
bool OAIAdd_items_to_watched_history_request_shows_inner_seasons_inner::isValid() const {
