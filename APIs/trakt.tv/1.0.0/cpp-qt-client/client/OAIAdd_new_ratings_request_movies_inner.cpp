...
#include "OAIAdd_new_ratings_request_movies_inner.h"
...
OAIAdd_new_ratings_request_movies_inner::OAIAdd_new_ratings_request_movies_inner(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAdd_new_ratings_request_movies_inner::OAIAdd_new_ratings_request_movies_inner() {
    this->initializeModel();
}

OAIAdd_new_ratings_request_movies_inner::~OAIAdd_new_ratings_request_movies_inner() {}

void OAIAdd_new_ratings_request_movies_inner::initializeModel() {

    m_ids_isSet = false;
    m_ids_isValid = false;

    m_rated_at_isSet = false;
    m_rated_at_isValid = false;
...
void OAIAdd_new_ratings_request_movies_inner::fromJson(QString jsonString) {
...
void OAIAdd_new_ratings_request_movies_inner::fromJsonObject(QJsonObject json) {

    m_ids_isValid = ::OpenAPI::fromJsonValue(m_ids, json[QString("ids")]);
    m_ids_isSet = !json[QString("ids")].isNull() && m_ids_isValid;

    m_rated_at_isValid = ::OpenAPI::fromJsonValue(m_rated_at, json[QString("rated_at")]);
    m_rated_at_isSet = !json[QString("rated_at")].isNull() && m_rated_at_isValid;
...
QString OAIAdd_new_ratings_request_movies_inner::asJson() const {
...
QJsonObject OAIAdd_new_ratings_request_movies_inner::asJsonObject() const {
    QJsonObject obj;
    if (m_ids.isSet()) {
        obj.insert(QString("ids"), ::OpenAPI::toJsonValue(m_ids));
    }
    if (m_rated_at_isSet) {
        obj.insert(QString("rated_at"), ::OpenAPI::toJsonValue(m_rated_at));
    }
    if (m_rating_isSet) {
...
OAICheck_into_an_item_request_movie_ids OAIAdd_new_ratings_request_movies_inner::getIds() const {
    return m_ids;
}
void OAIAdd_new_ratings_request_movies_inner::setIds(const OAICheck_into_an_item_request_movie_ids &ids) {
    m_ids = ids;
    m_ids_isSet = true;
}

bool OAIAdd_new_ratings_request_movies_inner::is_ids_Set() const{
    return m_ids_isSet;
}

bool OAIAdd_new_ratings_request_movies_inner::is_ids_Valid() const{
    return m_ids_isValid;
}

QString OAIAdd_new_ratings_request_movies_inner::getRatedAt() const {
    return m_rated_at;
}
void OAIAdd_new_ratings_request_movies_inner::setRatedAt(const QString &rated_at) {
    m_rated_at = rated_at;
    m_rated_at_isSet = true;
}

bool OAIAdd_new_ratings_request_movies_inner::is_rated_at_Set() const{
    return m_rated_at_isSet;
}

bool OAIAdd_new_ratings_request_movies_inner::is_rated_at_Valid() const{
    return m_rated_at_isValid;
}

double OAIAdd_new_ratings_request_movies_inner::getRating() const {
    return m_rating;
}
void OAIAdd_new_ratings_request_movies_inner::setRating(const double &rating) {
    m_rating = rating;
    m_rating_isSet = true;
}

bool OAIAdd_new_ratings_request_movies_inner::is_rating_Set() const{
    return m_rating_isSet;
}

bool OAIAdd_new_ratings_request_movies_inner::is_rating_Valid() const{
    return m_rating_isValid;
}

QString OAIAdd_new_ratings_request_movies_inner::getTitle() const {
    return m_title;
}
void OAIAdd_new_ratings_request_movies_inner::setTitle(const QString &title) {
    m_title = title;
    m_title_isSet = true;
}

bool OAIAdd_new_ratings_request_movies_inner::is_title_Set() const{
    return m_title_isSet;
}

bool OAIAdd_new_ratings_request_movies_inner::is_title_Valid() const{
    return m_title_isValid;
}

double OAIAdd_new_ratings_request_movies_inner::getYear() const {
    return m_year;
}
void OAIAdd_new_ratings_request_movies_inner::setYear(const double &year) {
    m_year = year;
    m_year_isSet = true;
}

bool OAIAdd_new_ratings_request_movies_inner::is_year_Set() const{
    return m_year_isSet;
}

bool OAIAdd_new_ratings_request_movies_inner::is_year_Valid() const{
    return m_year_isValid;
}

bool OAIAdd_new_ratings_request_movies_inner::isSet() const {
...
bool OAIAdd_new_ratings_request_movies_inner::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_ids_isValid && m_rating_isValid && true;
}
