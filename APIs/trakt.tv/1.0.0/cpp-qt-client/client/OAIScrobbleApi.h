...
#ifndef OAI_OAIScrobbleApi_H
#define OAI_OAIScrobbleApi_H
...
#include "OAIPause_watching_in_a_media_center_request.h"
#include "OAIStart_watching_in_a_media_center_request.h"
...
class OAIScrobbleApi : public QObject {
    Q_OBJECT

public:
    OAIScrobbleApi(const int timeOut = 0);
    ~OAIScrobbleApi();
    ...
    * @param[in]  oai_pause_watching_in_a_media_center_request OAIPause_watching_in_a_media_center_request [optional]
    */
    virtual void pause_watching_in_a_media_center(const ::OpenAPI::OptionalParam<QString> &trakt_api_version = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &trakt_api_key = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<OAIPause_watching_in_a_media_center_request> &oai_pause_watching_in_a_media_center_request = ::OpenAPI::OptionalParam<OAIPause_watching_in_a_media_center_request>());

    /**
    * @param[in]  trakt_api_version QString [optional]
    * @param[in]  trakt_api_key QString [optional]
    * @param[in]  oai_start_watching_in_a_media_center_request OAIStart_watching_in_a_media_center_request [optional]
    */
    virtual void start_watching_in_a_media_center(const ::OpenAPI::OptionalParam<QString> &trakt_api_version = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &trakt_api_key = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<OAIStart_watching_in_a_media_center_request> &oai_start_watching_in_a_media_center_request = ::OpenAPI::OptionalParam<OAIStart_watching_in_a_media_center_request>());

    /**
    * @param[in]  trakt_api_version QString [optional]
    * @param[in]  trakt_api_key QString [optional]
    * @param[in]  oai_stop_or_finish_watching_in_a_media_center_request OAIStop_or_finish_watching_in_a_media_center_request [optional]
    */
    virtual void stop_or_finish_watching_in_a_media_center(const ::OpenAPI::OptionalParam<QString> &trakt_api_version = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &trakt_api_key = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<OAIStop_or_finish_watching_in_a_media_center_request> &oai_stop_or_finish_watching_in_a_media_center_request = ::OpenAPI::OptionalParam<OAIStop_or_finish_watching_in_a_media_center_request>());
...
private:
    ...
    void pause_watching_in_a_media_centerCallback(OAIHttpRequestWorker *worker);
    void start_watching_in_a_media_centerCallback(OAIHttpRequestWorker *worker);
    void stop_or_finish_watching_in_a_media_centerCallback(OAIHttpRequestWorker *worker);

Q_SIGNALS:

    void pause_watching_in_a_media_centerSignal();
    void start_watching_in_a_media_centerSignal();
    void stop_or_finish_watching_in_a_media_centerSignal();


    void pause_watching_in_a_media_centerSignalFull(OAIHttpRequestWorker *worker);
    void start_watching_in_a_media_centerSignalFull(OAIHttpRequestWorker *worker);
    void stop_or_finish_watching_in_a_media_centerSignalFull(OAIHttpRequestWorker *worker);

    Q_DECL_DEPRECATED_X("Use pause_watching_in_a_media_centerSignalError() instead")
    void pause_watching_in_a_media_centerSignalE(QNetworkReply::NetworkError error_type, QString error_str);
    void pause_watching_in_a_media_centerSignalError(QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use start_watching_in_a_media_centerSignalError() instead")
    void start_watching_in_a_media_centerSignalE(QNetworkReply::NetworkError error_type, QString error_str);
    void start_watching_in_a_media_centerSignalError(QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use stop_or_finish_watching_in_a_media_centerSignalError() instead")
    void stop_or_finish_watching_in_a_media_centerSignalE(QNetworkReply::NetworkError error_type, QString error_str);
    void stop_or_finish_watching_in_a_media_centerSignalError(QNetworkReply::NetworkError error_type, const QString &error_str);

    Q_DECL_DEPRECATED_X("Use pause_watching_in_a_media_centerSignalErrorFull() instead")
    void pause_watching_in_a_media_centerSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void pause_watching_in_a_media_centerSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use start_watching_in_a_media_centerSignalErrorFull() instead")
    void start_watching_in_a_media_centerSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void start_watching_in_a_media_centerSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use stop_or_finish_watching_in_a_media_centerSignalErrorFull() instead")
    void stop_or_finish_watching_in_a_media_centerSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void stop_or_finish_watching_in_a_media_centerSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
