...
#include "OAIAdd_items_to_personal_list_request_people_inner.h"
...
OAIAdd_items_to_personal_list_request_people_inner::OAIAdd_items_to_personal_list_request_people_inner(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAdd_items_to_personal_list_request_people_inner::OAIAdd_items_to_personal_list_request_people_inner() {
    this->initializeModel();
}

OAIAdd_items_to_personal_list_request_people_inner::~OAIAdd_items_to_personal_list_request_people_inner() {}

void OAIAdd_items_to_personal_list_request_people_inner::initializeModel() {
...
void OAIAdd_items_to_personal_list_request_people_inner::fromJson(QString jsonString) {
...
void OAIAdd_items_to_personal_list_request_people_inner::fromJsonObject(QJsonObject json) {
...
QString OAIAdd_items_to_personal_list_request_people_inner::asJson() const {
...
QJsonObject OAIAdd_items_to_personal_list_request_people_inner::asJsonObject() const {
    QJsonObject obj;
    if (m_ids.isSet()) {
...
OAICheck_into_an_item_request_movie_ids OAIAdd_items_to_personal_list_request_people_inner::getIds() const {
    return m_ids;
}
void OAIAdd_items_to_personal_list_request_people_inner::setIds(const OAICheck_into_an_item_request_movie_ids &ids) {
    m_ids = ids;
    m_ids_isSet = true;
}

bool OAIAdd_items_to_personal_list_request_people_inner::is_ids_Set() const{
    return m_ids_isSet;
}

bool OAIAdd_items_to_personal_list_request_people_inner::is_ids_Valid() const{
    return m_ids_isValid;
}

QString OAIAdd_items_to_personal_list_request_people_inner::getName() const {
    return m_name;
}
void OAIAdd_items_to_personal_list_request_people_inner::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIAdd_items_to_personal_list_request_people_inner::is_name_Set() const{
    return m_name_isSet;
}

bool OAIAdd_items_to_personal_list_request_people_inner::is_name_Valid() const{
    return m_name_isValid;
}

bool OAIAdd_items_to_personal_list_request_people_inner::isSet() const {
...
bool OAIAdd_items_to_personal_list_request_people_inner::isValid() const {
