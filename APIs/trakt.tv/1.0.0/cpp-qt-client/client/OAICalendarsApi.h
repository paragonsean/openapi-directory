...
public:
    ...
    */
    virtual void calendarsAllDvdStartDateDaysGet(const QString &start_date, const qint32 &days, const ::OpenAPI::OptionalParam<QString> &trakt_api_version = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &trakt_api_key = ::OpenAPI::OptionalParam<QString>());
    ...
    * @param[in]  trakt_api_key QString [optional]
    */
    virtual void calendarsAllMoviesStartDateDaysGet(const QString &start_date, const qint32 &days, const ::OpenAPI::OptionalParam<QString> &trakt_api_version = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &trakt_api_key = ::OpenAPI::OptionalParam<QString>());
    ...
    * @param[in]  trakt_api_key QString [optional]
    */
    virtual void calendarsAllShowsNewStartDateDaysGet(const QString &start_date, const qint32 &days, const ::OpenAPI::OptionalParam<QString> &trakt_api_version = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &trakt_api_key = ::OpenAPI::OptionalParam<QString>());
    ...
    * @param[in]  trakt_api_key QString [optional]
    */
    virtual void calendarsAllShowsPremieresStartDateDaysGet(const QString &start_date, const qint32 &days, const ::OpenAPI::OptionalParam<QString> &trakt_api_version = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &trakt_api_key = ::OpenAPI::OptionalParam<QString>());
    ...
    * @param[in]  trakt_api_key QString [optional]
    */
    virtual void calendarsAllShowsStartDateDaysGet(const QString &start_date, const qint32 &days, const ::OpenAPI::OptionalParam<QString> &trakt_api_version = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &trakt_api_key = ::OpenAPI::OptionalParam<QString>());
    ...
    * @param[in]  trakt_api_key QString [optional]
    */
    virtual void get_DVD_releases(const QString &start_date, const qint32 &days, const ::OpenAPI::OptionalParam<QString> &trakt_api_version = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &trakt_api_key = ::OpenAPI::OptionalParam<QString>());
    ...
    * @param[in]  trakt_api_key QString [optional]
    */
    virtual void get_movies(const QString &start_date, const qint32 &days, const ::OpenAPI::OptionalParam<QString> &trakt_api_version = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &trakt_api_key = ::OpenAPI::OptionalParam<QString>());
    ...
    * @param[in]  trakt_api_key QString [optional]
    */
    virtual void get_new_shows(const QString &start_date, const qint32 &days, const ::OpenAPI::OptionalParam<QString> &trakt_api_version = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &trakt_api_key = ::OpenAPI::OptionalParam<QString>());
    ...
    * @param[in]  trakt_api_key QString [optional]
    */
    virtual void get_season_premieres(const QString &start_date, const qint32 &days, const ::OpenAPI::OptionalParam<QString> &trakt_api_version = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &trakt_api_key = ::OpenAPI::OptionalParam<QString>());
    ...
    * @param[in]  trakt_api_key QString [optional]
    */
    virtual void get_shows(const QString &start_date, const qint32 &days, const ::OpenAPI::OptionalParam<QString> &trakt_api_version = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &trakt_api_key = ::OpenAPI::OptionalParam<QString>());
...
private:
    ...
    void calendarsAllDvdStartDateDaysGetCallback(OAIHttpRequestWorker *worker);
    void calendarsAllMoviesStartDateDaysGetCallback(OAIHttpRequestWorker *worker);
    void calendarsAllShowsNewStartDateDaysGetCallback(OAIHttpRequestWorker *worker);
    void calendarsAllShowsPremieresStartDateDaysGetCallback(OAIHttpRequestWorker *worker);
    void calendarsAllShowsStartDateDaysGetCallback(OAIHttpRequestWorker *worker);
    void get_DVD_releasesCallback(OAIHttpRequestWorker *worker);
    void get_moviesCallback(OAIHttpRequestWorker *worker);
    void get_new_showsCallback(OAIHttpRequestWorker *worker);
    void get_season_premieresCallback(OAIHttpRequestWorker *worker);
    void get_showsCallback(OAIHttpRequestWorker *worker);

Q_SIGNALS:

    void calendarsAllDvdStartDateDaysGetSignal();
    void calendarsAllMoviesStartDateDaysGetSignal();
    void calendarsAllShowsNewStartDateDaysGetSignal();
    void calendarsAllShowsPremieresStartDateDaysGetSignal();
    void calendarsAllShowsStartDateDaysGetSignal();
    void get_DVD_releasesSignal();
    void get_moviesSignal();
    void get_new_showsSignal();
    void get_season_premieresSignal();
    void get_showsSignal();


    void calendarsAllDvdStartDateDaysGetSignalFull(OAIHttpRequestWorker *worker);
    void calendarsAllMoviesStartDateDaysGetSignalFull(OAIHttpRequestWorker *worker);
    void calendarsAllShowsNewStartDateDaysGetSignalFull(OAIHttpRequestWorker *worker);
    void calendarsAllShowsPremieresStartDateDaysGetSignalFull(OAIHttpRequestWorker *worker);
    void calendarsAllShowsStartDateDaysGetSignalFull(OAIHttpRequestWorker *worker);
    void get_DVD_releasesSignalFull(OAIHttpRequestWorker *worker);
    void get_moviesSignalFull(OAIHttpRequestWorker *worker);
    void get_new_showsSignalFull(OAIHttpRequestWorker *worker);
    void get_season_premieresSignalFull(OAIHttpRequestWorker *worker);
    void get_showsSignalFull(OAIHttpRequestWorker *worker);

    Q_DECL_DEPRECATED_X("Use calendarsAllDvdStartDateDaysGetSignalError() instead")
    void calendarsAllDvdStartDateDaysGetSignalE(QNetworkReply::NetworkError error_type, QString error_str);
    void calendarsAllDvdStartDateDaysGetSignalError(QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use calendarsAllMoviesStartDateDaysGetSignalError() instead")
    void calendarsAllMoviesStartDateDaysGetSignalE(QNetworkReply::NetworkError error_type, QString error_str);
    void calendarsAllMoviesStartDateDaysGetSignalError(QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use calendarsAllShowsNewStartDateDaysGetSignalError() instead")
    void calendarsAllShowsNewStartDateDaysGetSignalE(QNetworkReply::NetworkError error_type, QString error_str);
    void calendarsAllShowsNewStartDateDaysGetSignalError(QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use calendarsAllShowsPremieresStartDateDaysGetSignalError() instead")
    void calendarsAllShowsPremieresStartDateDaysGetSignalE(QNetworkReply::NetworkError error_type, QString error_str);
    void calendarsAllShowsPremieresStartDateDaysGetSignalError(QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use calendarsAllShowsStartDateDaysGetSignalError() instead")
    void calendarsAllShowsStartDateDaysGetSignalE(QNetworkReply::NetworkError error_type, QString error_str);
    void calendarsAllShowsStartDateDaysGetSignalError(QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use get_DVD_releasesSignalError() instead")
    void get_DVD_releasesSignalE(QNetworkReply::NetworkError error_type, QString error_str);
    void get_DVD_releasesSignalError(QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use get_moviesSignalError() instead")
    void get_moviesSignalE(QNetworkReply::NetworkError error_type, QString error_str);
    void get_moviesSignalError(QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use get_new_showsSignalError() instead")
    void get_new_showsSignalE(QNetworkReply::NetworkError error_type, QString error_str);
    void get_new_showsSignalError(QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use get_season_premieresSignalError() instead")
    void get_season_premieresSignalE(QNetworkReply::NetworkError error_type, QString error_str);
    void get_season_premieresSignalError(QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use get_showsSignalError() instead")
    void get_showsSignalE(QNetworkReply::NetworkError error_type, QString error_str);
    void get_showsSignalError(QNetworkReply::NetworkError error_type, const QString &error_str);

    Q_DECL_DEPRECATED_X("Use calendarsAllDvdStartDateDaysGetSignalErrorFull() instead")
    void calendarsAllDvdStartDateDaysGetSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void calendarsAllDvdStartDateDaysGetSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use calendarsAllMoviesStartDateDaysGetSignalErrorFull() instead")
    void calendarsAllMoviesStartDateDaysGetSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void calendarsAllMoviesStartDateDaysGetSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use calendarsAllShowsNewStartDateDaysGetSignalErrorFull() instead")
    void calendarsAllShowsNewStartDateDaysGetSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void calendarsAllShowsNewStartDateDaysGetSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use calendarsAllShowsPremieresStartDateDaysGetSignalErrorFull() instead")
    void calendarsAllShowsPremieresStartDateDaysGetSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void calendarsAllShowsPremieresStartDateDaysGetSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use calendarsAllShowsStartDateDaysGetSignalErrorFull() instead")
    void calendarsAllShowsStartDateDaysGetSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void calendarsAllShowsStartDateDaysGetSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use get_DVD_releasesSignalErrorFull() instead")
    void get_DVD_releasesSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void get_DVD_releasesSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use get_moviesSignalErrorFull() instead")
    void get_moviesSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void get_moviesSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use get_new_showsSignalErrorFull() instead")
    void get_new_showsSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void get_new_showsSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use get_season_premieresSignalErrorFull() instead")
    void get_season_premieresSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void get_season_premieresSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use get_showsSignalErrorFull() instead")
    void get_showsSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void get_showsSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
