...
OAICheckinApi::OAICheckinApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAICheckinApi::~OAICheckinApi() {
}

void OAICheckinApi::initializeServerConfigs() {
    //Default server
    ...
    _serverConfigs.insert("check_into_an_item", defaultConf);
    _serverIndices.insert("check_into_an_item", 0);
    _serverConfigs.insert("delete_any_active_checkins", defaultConf);
    _serverIndices.insert("delete_any_active_checkins", 0);
}
...
*/
int OAICheckinApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAICheckinApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAICheckinApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAICheckinApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAICheckinApi::setUsername(const QString &username) {
    _username = username;
}

void OAICheckinApi::setPassword(const QString &password) {
    _password = password;
}


void OAICheckinApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAICheckinApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAICheckinApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAICheckinApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAICheckinApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAICheckinApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAICheckinApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAICheckinApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAICheckinApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAICheckinApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAICheckinApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAICheckinApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAICheckinApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAICheckinApi::check_into_an_item(const ::OpenAPI::OptionalParam<QString> &trakt_api_version, const ::OpenAPI::OptionalParam<QString> &trakt_api_key, const ::OpenAPI::OptionalParam<OAICheck_into_an_item_request> &oai_check_into_an_item_request) {
    QString fullPath = QString(_serverConfigs["check_into_an_item"][_serverIndices.value("check_into_an_item")].URL()+"/checkin");
    ...
    if (oai_check_into_an_item_request.hasValue()){

        
        QByteArray output = oai_check_into_an_item_request.value().asJson().toUtf8();
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAICheckinApi::check_into_an_itemCallback);
    connect(this, &OAICheckinApi::abortRequestsSignal, worker, &QObject::deleteLater);
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAICheckinApi::check_into_an_itemCallback);
    connect(this, &OAICheckinApi::abortRequestsSignal, _latestWorker, &QObject::deleteLater);
...
void OAICheckinApi::check_into_an_itemCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT check_into_an_itemSignal();
        Q_EMIT check_into_an_itemSignalFull(worker);
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT check_into_an_itemSignalE(error_type, error_str);
        Q_EMIT check_into_an_itemSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT check_into_an_itemSignalError(error_type, error_str);
        Q_EMIT check_into_an_itemSignalErrorFull(worker, error_type, error_str);
    }
}

void OAICheckinApi::delete_any_active_checkins(const ::OpenAPI::OptionalParam<QString> &trakt_api_version, const ::OpenAPI::OptionalParam<QString> &trakt_api_key) {
    QString fullPath = QString(_serverConfigs["delete_any_active_checkins"][_serverIndices.value("delete_any_active_checkins")].URL()+"/checkin");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAICheckinApi::delete_any_active_checkinsCallback);
    connect(this, &OAICheckinApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAICheckinApi::delete_any_active_checkinsCallback);
    connect(this, &OAICheckinApi::abortRequestsSignal, _latestWorker, &QObject::deleteLater);
    connect(_latestWorker, &QObject::destroyed, [this](){
        if(findChildren<OAIHttpRequestWorker*>().count() == 0){
            Q_EMIT allPendingRequestsCompleted();
...
void OAICheckinApi::delete_any_active_checkinsCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT delete_any_active_checkinsSignal();
        Q_EMIT delete_any_active_checkinsSignalFull(worker);
    } else if(worker->error_type == QNetworkReply::AuthenticationRequiredError){
        connect(&_authFlow, SIGNAL(tokenReceived()), this, SLOT(tokenAvailable()));
        QStringList scope;
        QString scopeStr = scope.join(" ");
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT delete_any_active_checkinsSignalE(error_type, error_str);
        Q_EMIT delete_any_active_checkinsSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT delete_any_active_checkinsSignalError(error_type, error_str);
        Q_EMIT delete_any_active_checkinsSignalErrorFull(worker, error_type, error_str);
    }
}

void OAICheckinApi::tokenAvailable(){
