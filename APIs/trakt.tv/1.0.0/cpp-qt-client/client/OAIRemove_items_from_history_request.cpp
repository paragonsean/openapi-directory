...
#include "OAIRemove_items_from_history_request.h"
...
OAIRemove_items_from_history_request::OAIRemove_items_from_history_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIRemove_items_from_history_request::OAIRemove_items_from_history_request() {
    this->initializeModel();
}

OAIRemove_items_from_history_request::~OAIRemove_items_from_history_request() {}

void OAIRemove_items_from_history_request::initializeModel() {
...
void OAIRemove_items_from_history_request::fromJson(QString jsonString) {
...
void OAIRemove_items_from_history_request::fromJsonObject(QJsonObject json) {
...
QString OAIRemove_items_from_history_request::asJson() const {
...
QJsonObject OAIRemove_items_from_history_request::asJsonObject() const {
    QJsonObject obj;
...
QList<OAIAdd_items_to_collection_request_episodes_inner> OAIRemove_items_from_history_request::getEpisodes() const {
    return m_episodes;
}
void OAIRemove_items_from_history_request::setEpisodes(const QList<OAIAdd_items_to_collection_request_episodes_inner> &episodes) {
    m_episodes = episodes;
    m_episodes_isSet = true;
}

bool OAIRemove_items_from_history_request::is_episodes_Set() const{
    return m_episodes_isSet;
}

bool OAIRemove_items_from_history_request::is_episodes_Valid() const{
    return m_episodes_isValid;
}

QList<double> OAIRemove_items_from_history_request::getIds() const {
    return m_ids;
}
void OAIRemove_items_from_history_request::setIds(const QList<double> &ids) {
    m_ids = ids;
    m_ids_isSet = true;
}

bool OAIRemove_items_from_history_request::is_ids_Set() const{
    return m_ids_isSet;
}

bool OAIRemove_items_from_history_request::is_ids_Valid() const{
    return m_ids_isValid;
}

QList<OAIRemove_items_from_collection_request_movies_inner> OAIRemove_items_from_history_request::getMovies() const {
    return m_movies;
}
void OAIRemove_items_from_history_request::setMovies(const QList<OAIRemove_items_from_collection_request_movies_inner> &movies) {
    m_movies = movies;
    m_movies_isSet = true;
}

bool OAIRemove_items_from_history_request::is_movies_Set() const{
    return m_movies_isSet;
}

bool OAIRemove_items_from_history_request::is_movies_Valid() const{
    return m_movies_isValid;
}

QList<OAIAdd_items_to_collection_request_seasons_inner> OAIRemove_items_from_history_request::getSeasons() const {
    return m_seasons;
}
void OAIRemove_items_from_history_request::setSeasons(const QList<OAIAdd_items_to_collection_request_seasons_inner> &seasons) {
    m_seasons = seasons;
    m_seasons_isSet = true;
}

bool OAIRemove_items_from_history_request::is_seasons_Set() const{
    return m_seasons_isSet;
}

bool OAIRemove_items_from_history_request::is_seasons_Valid() const{
    return m_seasons_isValid;
}

QList<OAIRemove_items_from_collection_request_shows_inner> OAIRemove_items_from_history_request::getShows() const {
    return m_shows;
}
void OAIRemove_items_from_history_request::setShows(const QList<OAIRemove_items_from_collection_request_shows_inner> &shows) {
    m_shows = shows;
    m_shows_isSet = true;
}

bool OAIRemove_items_from_history_request::is_shows_Set() const{
    return m_shows_isSet;
}

bool OAIRemove_items_from_history_request::is_shows_Valid() const{
    return m_shows_isValid;
}

bool OAIRemove_items_from_history_request::isSet() const {
...
bool OAIRemove_items_from_history_request::isValid() const {
