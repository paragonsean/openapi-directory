...
OAIAdd_hidden_items_request::OAIAdd_hidden_items_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAdd_hidden_items_request::OAIAdd_hidden_items_request() {
    this->initializeModel();
}

OAIAdd_hidden_items_request::~OAIAdd_hidden_items_request() {}

void OAIAdd_hidden_items_request::initializeModel() {
...
void OAIAdd_hidden_items_request::fromJson(QString jsonString) {
...
void OAIAdd_hidden_items_request::fromJsonObject(QJsonObject json) {
...
QString OAIAdd_hidden_items_request::asJson() const {
...
QJsonObject OAIAdd_hidden_items_request::asJsonObject() const {
    QJsonObject obj;
    if (m_movies.size() > 0) {
...
QList<OAIRemove_items_from_collection_request_movies_inner> OAIAdd_hidden_items_request::getMovies() const {
    return m_movies;
}
void OAIAdd_hidden_items_request::setMovies(const QList<OAIRemove_items_from_collection_request_movies_inner> &movies) {
    m_movies = movies;
    m_movies_isSet = true;
}

bool OAIAdd_hidden_items_request::is_movies_Set() const{
    return m_movies_isSet;
}

bool OAIAdd_hidden_items_request::is_movies_Valid() const{
    return m_movies_isValid;
}

QList<OAIAdd_hidden_items_request_seasons_inner> OAIAdd_hidden_items_request::getSeasons() const {
    return m_seasons;
}
void OAIAdd_hidden_items_request::setSeasons(const QList<OAIAdd_hidden_items_request_seasons_inner> &seasons) {
    m_seasons = seasons;
    m_seasons_isSet = true;
}

bool OAIAdd_hidden_items_request::is_seasons_Set() const{
    return m_seasons_isSet;
}

bool OAIAdd_hidden_items_request::is_seasons_Valid() const{
    return m_seasons_isValid;
}

QList<OAIAdd_hidden_items_request_shows_inner> OAIAdd_hidden_items_request::getShows() const {
    return m_shows;
}
void OAIAdd_hidden_items_request::setShows(const QList<OAIAdd_hidden_items_request_shows_inner> &shows) {
    m_shows = shows;
    m_shows_isSet = true;
}

bool OAIAdd_hidden_items_request::is_shows_Set() const{
    return m_shows_isSet;
}

bool OAIAdd_hidden_items_request::is_shows_Valid() const{
    return m_shows_isValid;
}

bool OAIAdd_hidden_items_request::isSet() const {
...
bool OAIAdd_hidden_items_request::isValid() const {
