...
#include "OAICertificationsApi.h"
...
OAICertificationsApi::OAICertificationsApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAICertificationsApi::~OAICertificationsApi() {
}

void OAICertificationsApi::initializeServerConfigs() {
    //Default server
    ...
    _serverConfigs.insert("get_certifications", defaultConf);
    _serverIndices.insert("get_certifications", 0);
}
...
*/
int OAICertificationsApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAICertificationsApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAICertificationsApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAICertificationsApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAICertificationsApi::setUsername(const QString &username) {
    _username = username;
}

void OAICertificationsApi::setPassword(const QString &password) {
    _password = password;
}


void OAICertificationsApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAICertificationsApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAICertificationsApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAICertificationsApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAICertificationsApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAICertificationsApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAICertificationsApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAICertificationsApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAICertificationsApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAICertificationsApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAICertificationsApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAICertificationsApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAICertificationsApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAICertificationsApi::get_certifications(const QString &type, const ::OpenAPI::OptionalParam<QString> &trakt_api_version, const ::OpenAPI::OptionalParam<QString> &trakt_api_key) {
    QString fullPath = QString(_serverConfigs["get_certifications"][_serverIndices.value("get_certifications")].URL()+"/certifications/{type}");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAICertificationsApi::get_certificationsCallback);
    connect(this, &OAICertificationsApi::abortRequestsSignal, worker, &QObject::deleteLater);
...
void OAICertificationsApi::get_certificationsCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT get_certificationsSignal();
        Q_EMIT get_certificationsSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT get_certificationsSignalE(error_type, error_str);
        Q_EMIT get_certificationsSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT get_certificationsSignalError(error_type, error_str);
        Q_EMIT get_certificationsSignalErrorFull(worker, error_type, error_str);
    }
}

void OAICertificationsApi::tokenAvailable(){
