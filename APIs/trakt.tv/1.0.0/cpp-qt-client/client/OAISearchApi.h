...
public:
    ...
    /**
    * @param[in]  id_type QString [required]
    * @param[in]  id QString [required]
    * @param[in]  type QString [optional]
    * @param[in]  trakt_api_version QString [optional]
    * @param[in]  trakt_api_key QString [optional]
    */
    virtual void get_ID_lookup_results(const QString &id_type, const QString &id, const ::OpenAPI::OptionalParam<QString> &type = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &trakt_api_version = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &trakt_api_key = ::OpenAPI::OptionalParam<QString>());
    ...
    */
    virtual void get_text_query_results(const QString &type, const QString &query, const ::OpenAPI::OptionalParam<QString> &trakt_api_version = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &trakt_api_key = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &body = ::OpenAPI::OptionalParam<QString>());
...
private:
    ...
    void get_ID_lookup_resultsCallback(OAIHttpRequestWorker *worker);
    void get_text_query_resultsCallback(OAIHttpRequestWorker *worker);

Q_SIGNALS:

    void get_ID_lookup_resultsSignal();
    void get_text_query_resultsSignal();


    void get_ID_lookup_resultsSignalFull(OAIHttpRequestWorker *worker);
    void get_text_query_resultsSignalFull(OAIHttpRequestWorker *worker);

    Q_DECL_DEPRECATED_X("Use get_ID_lookup_resultsSignalError() instead")
    void get_ID_lookup_resultsSignalE(QNetworkReply::NetworkError error_type, QString error_str);
    void get_ID_lookup_resultsSignalError(QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use get_text_query_resultsSignalError() instead")
    void get_text_query_resultsSignalE(QNetworkReply::NetworkError error_type, QString error_str);
    void get_text_query_resultsSignalError(QNetworkReply::NetworkError error_type, const QString &error_str);

    Q_DECL_DEPRECATED_X("Use get_ID_lookup_resultsSignalErrorFull() instead")
    void get_ID_lookup_resultsSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void get_ID_lookup_resultsSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use get_text_query_resultsSignalErrorFull() instead")
    void get_text_query_resultsSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void get_text_query_resultsSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
