...
#include "OAIAdd_items_to_collection_request_shows_inner_seasons_inner_episodes_inner.h"
...
OAIAdd_items_to_collection_request_shows_inner_seasons_inner_episodes_inner::OAIAdd_items_to_collection_request_shows_inner_seasons_inner_episodes_inner(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAdd_items_to_collection_request_shows_inner_seasons_inner_episodes_inner::OAIAdd_items_to_collection_request_shows_inner_seasons_inner_episodes_inner() {
    this->initializeModel();
}

OAIAdd_items_to_collection_request_shows_inner_seasons_inner_episodes_inner::~OAIAdd_items_to_collection_request_shows_inner_seasons_inner_episodes_inner() {}

void OAIAdd_items_to_collection_request_shows_inner_seasons_inner_episodes_inner::initializeModel() {
...
void OAIAdd_items_to_collection_request_shows_inner_seasons_inner_episodes_inner::fromJson(QString jsonString) {
...
void OAIAdd_items_to_collection_request_shows_inner_seasons_inner_episodes_inner::fromJsonObject(QJsonObject json) {

    m_audio_isValid = ::OpenAPI::fromJsonValue(m_audio, json[QString("audio")]);
    m_audio_isSet = !json[QString("audio")].isNull() && m_audio_isValid;

    m_audio_channels_isValid = ::OpenAPI::fromJsonValue(m_audio_channels, json[QString("audio_channels")]);
    m_audio_channels_isSet = !json[QString("audio_channels")].isNull() && m_audio_channels_isValid;
...
QString OAIAdd_items_to_collection_request_shows_inner_seasons_inner_episodes_inner::asJson() const {
...
QJsonObject OAIAdd_items_to_collection_request_shows_inner_seasons_inner_episodes_inner::asJsonObject() const {
    QJsonObject obj;
    if (m_audio_isSet) {
        obj.insert(QString("audio"), ::OpenAPI::toJsonValue(m_audio));
    }
    if (m_audio_channels_isSet) {
        obj.insert(QString("audio_channels"), ::OpenAPI::toJsonValue(m_audio_channels));
    }
...
QString OAIAdd_items_to_collection_request_shows_inner_seasons_inner_episodes_inner::getAudio() const {
    return m_audio;
}
void OAIAdd_items_to_collection_request_shows_inner_seasons_inner_episodes_inner::setAudio(const QString &audio) {
    m_audio = audio;
    m_audio_isSet = true;
}

bool OAIAdd_items_to_collection_request_shows_inner_seasons_inner_episodes_inner::is_audio_Set() const{
    return m_audio_isSet;
}

bool OAIAdd_items_to_collection_request_shows_inner_seasons_inner_episodes_inner::is_audio_Valid() const{
    return m_audio_isValid;
}

QString OAIAdd_items_to_collection_request_shows_inner_seasons_inner_episodes_inner::getAudioChannels() const {
    return m_audio_channels;
}
void OAIAdd_items_to_collection_request_shows_inner_seasons_inner_episodes_inner::setAudioChannels(const QString &audio_channels) {
    m_audio_channels = audio_channels;
    m_audio_channels_isSet = true;
}

bool OAIAdd_items_to_collection_request_shows_inner_seasons_inner_episodes_inner::is_audio_channels_Set() const{
    return m_audio_channels_isSet;
}

bool OAIAdd_items_to_collection_request_shows_inner_seasons_inner_episodes_inner::is_audio_channels_Valid() const{
    return m_audio_channels_isValid;
}

QString OAIAdd_items_to_collection_request_shows_inner_seasons_inner_episodes_inner::getMediaType() const {
    return m_media_type;
}
void OAIAdd_items_to_collection_request_shows_inner_seasons_inner_episodes_inner::setMediaType(const QString &media_type) {
    m_media_type = media_type;
    m_media_type_isSet = true;
}

bool OAIAdd_items_to_collection_request_shows_inner_seasons_inner_episodes_inner::is_media_type_Set() const{
    return m_media_type_isSet;
}

bool OAIAdd_items_to_collection_request_shows_inner_seasons_inner_episodes_inner::is_media_type_Valid() const{
    return m_media_type_isValid;
}

double OAIAdd_items_to_collection_request_shows_inner_seasons_inner_episodes_inner::getNumber() const {
    return m_number;
}
void OAIAdd_items_to_collection_request_shows_inner_seasons_inner_episodes_inner::setNumber(const double &number) {
    m_number = number;
    m_number_isSet = true;
}

bool OAIAdd_items_to_collection_request_shows_inner_seasons_inner_episodes_inner::is_number_Set() const{
    return m_number_isSet;
}

bool OAIAdd_items_to_collection_request_shows_inner_seasons_inner_episodes_inner::is_number_Valid() const{
    return m_number_isValid;
}

QString OAIAdd_items_to_collection_request_shows_inner_seasons_inner_episodes_inner::getResolution() const {
    return m_resolution;
}
void OAIAdd_items_to_collection_request_shows_inner_seasons_inner_episodes_inner::setResolution(const QString &resolution) {
    m_resolution = resolution;
    m_resolution_isSet = true;
}

bool OAIAdd_items_to_collection_request_shows_inner_seasons_inner_episodes_inner::is_resolution_Set() const{
    return m_resolution_isSet;
}

bool OAIAdd_items_to_collection_request_shows_inner_seasons_inner_episodes_inner::is_resolution_Valid() const{
    return m_resolution_isValid;
}

bool OAIAdd_items_to_collection_request_shows_inner_seasons_inner_episodes_inner::isSet() const {
...
bool OAIAdd_items_to_collection_request_shows_inner_seasons_inner_episodes_inner::isValid() const {
