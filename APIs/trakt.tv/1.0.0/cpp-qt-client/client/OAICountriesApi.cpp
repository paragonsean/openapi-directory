...
void OAICountriesApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("get_countries", defaultConf);
    _serverIndices.insert("get_countries", 0);
}
...
void OAICountriesApi::get_countries(const QString &type, const ::OpenAPI::OptionalParam<QString> &trakt_api_version, const ::OpenAPI::OptionalParam<QString> &trakt_api_key) {
    QString fullPath = QString(_serverConfigs["get_countries"][_serverIndices.value("get_countries")].URL()+"/countries/{type}");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAICountriesApi::get_countriesCallback);
...
void OAICountriesApi::get_countriesCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT get_countriesSignal();
        Q_EMIT get_countriesSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT get_countriesSignalE(error_type, error_str);
        Q_EMIT get_countriesSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT get_countriesSignalError(error_type, error_str);
        Q_EMIT get_countriesSignalErrorFull(worker, error_type, error_str);
    }
}
