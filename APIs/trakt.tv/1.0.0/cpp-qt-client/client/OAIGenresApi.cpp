...
void OAIGenresApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("get_genres", defaultConf);
    _serverIndices.insert("get_genres", 0);
}
...
void OAIGenresApi::get_genres(const QString &type, const ::OpenAPI::OptionalParam<QString> &trakt_api_version, const ::OpenAPI::OptionalParam<QString> &trakt_api_key) {
    QString fullPath = QString(_serverConfigs["get_genres"][_serverIndices.value("get_genres")].URL()+"/genres/{type}");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIGenresApi::get_genresCallback);
...
void OAIGenresApi::get_genresCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT get_genresSignal();
        Q_EMIT get_genresSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT get_genresSignalE(error_type, error_str);
        Q_EMIT get_genresSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT get_genresSignalError(error_type, error_str);
        Q_EMIT get_genresSignalErrorFull(worker, error_type, error_str);
    }
}
