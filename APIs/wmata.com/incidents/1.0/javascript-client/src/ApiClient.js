...
class ApiClient {
     ...
     */
    constructor(basePath = 'http://api.wmata.com/Incidents.svc') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default http://api.wmata.com/Incidents.svc
         */
  ...
  /**
    ...
    */
    hostSettings() {
        return [
            {
              'url': "http://api.wmata.com/Incidents.svc",
              'description': "No description provided",
            },
            {
              'url': "https://api.wmata.com/Incidents.svc",
              'description': "No description provided",
            }
      ];
    }
