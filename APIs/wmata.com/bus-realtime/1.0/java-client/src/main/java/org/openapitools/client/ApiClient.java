...
public class ApiClient {
    ...
    private String basePath = "http://api.wmata.com/NextBusService.svc";
    ...
    public ApiClient() {
        ...
        authentications.put("apiKeyHeader", new ApiKeyAuth("header", "api_key"));
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g http://api.wmata.com/NextBusService.svc
