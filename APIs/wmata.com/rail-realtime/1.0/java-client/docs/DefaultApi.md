...
<a id="call547636a6f918230da855363f"></a>
...
|------------- | ------------- | ------------- | -------------|
| **stationCodes** | **String**| Comma-separated list of station codes.  For all predictions, use \&quot;All\&quot;. | [default to B03] [enum: B03, All] |
...
<a id="call547636a6f918230da8553640"></a>
...
public class Example {
  public static void main(String[] args) {
    ...
    String stationCodes = "B03"; // String | Comma-separated list of station codes.  For all predictions, use \"All\".
    try {
      apiInstance.call547636a6f918230da8553640(stationCodes);
    } catch (ApiException e) {
      System.err.println("Exception when calling DefaultApi#call547636a6f918230da8553640");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
