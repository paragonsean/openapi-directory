# BusRouteAndStopMethods.DefaultApi
...
> call5476362a281d830c946a3d68(opts)
...
```javascript
import BusRouteAndStopMethods from 'bus_route_and_stop_methods';
let defaultClient = BusRouteAndStopMethods.ApiClient.instance;
...
let apiInstance = new BusRouteAndStopMethods.DefaultApi();
let opts = {
...
apiInstance.call5476362a281d830c946a3d68(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
------------- | ------------- | ------------- | -------------
 **routeID** | **String**| Base bus route, e.g.: 70, 10A. | [optional] [default to &#39;70&#39;]
 **lat** | **Number**| Center point Latitude, required if Longitude and Radius are specified. | [optional] 
 **lon** | **Number**| Center point Longitude, required if Latitude and Radius are specified. | [optional] 
 **radius** | **Number**| Radius (meters) to include in the search area, required if Latitude and Longitude are specified. | [optional] 
...
> call5476362a281d830c946a3d69(routeID, opts)
...
let apiInstance = new BusRouteAndStopMethods.DefaultApi();
let routeID = "'70'"; // String | Bus route variant, e.g.: 70, 10A, 10Av1.
let opts = {
  'date': "date_example" // String | Date in YYYY-MM-DD format for which to retrieve route and stop information.  Defaults to today's date unless specified.
};
apiInstance.call5476362a281d830c946a3d69(routeID, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully.');
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **routeID** | **String**| Bus route variant, e.g.: 70, 10A, 10Av1. | [default to &#39;70&#39;]
...
let apiInstance = new BusRouteAndStopMethods.DefaultApi();
apiInstance.call5476362a281d830c946a3d6a((error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully.');
...
> call5476362a281d830c946a3d6b(routeID, opts)
...
let apiInstance = new BusRouteAndStopMethods.DefaultApi();
let routeID = "'70'"; // String | Bus route variant, e.g.: 70, 10A, 10Av1, etc.
let opts = {
  'date': "date_example", // String | Date in YYYY-MM-DD format for which to retrieve schedule.  Defaults to today's date unless specified.
  'includingVariations': false // Boolean | Whether or not to include variations if a base route is specified in RouteID.  For example, if B30 is specified and IncludingVariations is set to true, data for all variations of B30 such as B30v1, B30v2, etc. will be returned.
};
apiInstance.call5476362a281d830c946a3d6b(routeID, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully.');
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **routeID** | **String**| Bus route variant, e.g.: 70, 10A, 10Av1, etc. | [default to &#39;70&#39;]
...
> call5476362a281d830c946a3d6c(stopID, opts)
...
apiInstance.call5476362a281d830c946a3d6c(stopID, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully.');
...
> call5476362a281d830c946a3d6d(opts)
...
apiInstance.call5476362a281d830c946a3d6d(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully.');
...
> call5476362a281d830c946a3d6e(opts)
...
let apiInstance = new BusRouteAndStopMethods.DefaultApi();
let opts = {
  'routeID': "'70'", // String | Bus route, e.g.: 70, 10A.
  'lat': "lat_example", // String | Center point Latitude, required if Longitude and Radius are specified.
  'lon': "lon_example", // String | Center point Longitude, required if Latitude and Radius are specified.
  'radius': "radius_example" // String | Radius (meters) to include in the search area, required if Latitude and Longitude are specified.
};
apiInstance.call5476362a281d830c946a3d6e(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully.');
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **routeID** | **String**| Bus route, e.g.: 70, 10A. | [optional] [default to &#39;70&#39;]
...
> call5476362a281d830c946a3d6f(routeID, opts)
...
apiInstance.call5476362a281d830c946a3d6f(routeID, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully.');
...
let apiInstance = new BusRouteAndStopMethods.DefaultApi();
apiInstance.call5476362a281d830c946a3d70((error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully.');
...
> call5476362a281d830c946a3d71(routeID, opts)
...
let opts = {
  'date': "date_example", // String | Date in YYYY-MM-DD format for which to retrieve schedule.  Defaults to today's date unless specified.
  'includingVariations': false // Boolean | Whether or not to include variations.  For example, if B30 is specified, include all variations such as B30v1, B30v2, etc.
};
apiInstance.call5476362a281d830c946a3d71(routeID, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully.');
...
> call5476362a281d830c946a3d72(stopID, opts)
...
apiInstance.call5476362a281d830c946a3d72(stopID, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully.');
...
> call5476362a281d830c946a3d73(opts)
...
let opts = {
  'lat': "lat_example", // String | Center point Latitude, required if Longitude and Radius are specified.
  'lon': "lon_example", // String | Center point Longitude, required if Latitude and Radius are specified.
  'radius': "radius_example" // String | Radius (feet) to include in the search area, required if Latitude and Longitude are specified.
};
apiInstance.call5476362a281d830c946a3d73(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully.');
 ...
 **lat** | **String**| Center point Latitude, required if Longitude and Radius are specified. | [optional] 
 **lon** | **String**| Center point Longitude, required if Latitude and Radius are specified. | [optional] 
 **radius** | **String**| Radius (feet) to include in the search area, required if Latitude and Longitude are specified. | [optional] 
