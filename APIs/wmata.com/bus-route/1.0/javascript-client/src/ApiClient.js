...
class ApiClient {
     ...
     */
    constructor(basePath = 'http://api.wmata.com/Bus.svc') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default http://api.wmata.com/Bus.svc
         */
        ...
        this.authentications = {
            'apiKeyHeader': {type: 'apiKey', 'in': 'header', name: 'api_key'},
  ...
  /**
    ...
    */
    hostSettings() {
        return [
            {
              'url': "http://api.wmata.com/Bus.svc",
              'description': "No description provided",
            },
            {
              'url': "https://api.wmata.com/Bus.svc",
              'description': "No description provided",
            }
      ];
    }
