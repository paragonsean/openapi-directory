...
export default class DefaultApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the call5476362a281d830c946a3d68 operation.
     * @callback module:api/DefaultApi~call5476362a281d830c946a3d68Callback
     ...
     * @param {module:model/String} [routeID = '70')] Base bus route, e.g.: 70, 10A.
     * @param {Number} [lat] Center point Latitude, required if Longitude and Radius are specified.
     * @param {Number} [lon] Center point Longitude, required if Latitude and Radius are specified.
     * @param {Number} [radius] Radius (meters) to include in the search area, required if Latitude and Longitude are specified.
     * @param {module:api/DefaultApi~call5476362a281d830c946a3d68Callback} callback The callback function, accepting three arguments: error, data, response
     */
    call5476362a281d830c946a3d68(opts, callback) {
      opts = opts || {};
      let postBody = null;
    ...
    /**
     * Callback function to receive the result of the call5476362a281d830c946a3d69 operation.
     * @callback module:api/DefaultApi~call5476362a281d830c946a3d69Callback
     * @param {String} error Error message, if any.
     * @param data This operation does not return a value.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:model/String} routeID Bus route variant, e.g.: 70, 10A, 10Av1.
     * @param {Object} opts Optional parameters
     * @param {String} [date] Date in YYYY-MM-DD format for which to retrieve route and stop information.  Defaults to today's date unless specified.
     * @param {module:api/DefaultApi~call5476362a281d830c946a3d69Callback} callback The callback function, accepting three arguments: error, data, response
     */
    call5476362a281d830c946a3d69(routeID, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'routeID' is set
      if (routeID === undefined || routeID === null) {
        throw new Error("Missing the required parameter 'routeID' when calling call5476362a281d830c946a3d69");
      }
    ...
    /**
     * Callback function to receive the result of the call5476362a281d830c946a3d6a operation.
     * @callback module:api/DefaultApi~call5476362a281d830c946a3d6aCallback
     * @param {String} error Error message, if any.
     * @param data This operation does not return a value.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:api/DefaultApi~call5476362a281d830c946a3d6aCallback} callback The callback function, accepting three arguments: error, data, response
     */
    call5476362a281d830c946a3d6a(callback) {
      let postBody = null;
    ...
    /**
     * Callback function to receive the result of the call5476362a281d830c946a3d6b operation.
     * @callback module:api/DefaultApi~call5476362a281d830c946a3d6bCallback
     * @param {String} error Error message, if any.
     * @param data This operation does not return a value.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:model/String} routeID Bus route variant, e.g.: 70, 10A, 10Av1, etc.
     * @param {Object} opts Optional parameters
     * @param {String} [date] Date in YYYY-MM-DD format for which to retrieve schedule.  Defaults to today's date unless specified.
     * @param {Boolean} [includingVariations = false)] Whether or not to include variations if a base route is specified in RouteID.  For example, if B30 is specified and IncludingVariations is set to true, data for all variations of B30 such as B30v1, B30v2, etc. will be returned.
     * @param {module:api/DefaultApi~call5476362a281d830c946a3d6bCallback} callback The callback function, accepting three arguments: error, data, response
     */
    call5476362a281d830c946a3d6b(routeID, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'routeID' is set
      if (routeID === undefined || routeID === null) {
        throw new Error("Missing the required parameter 'routeID' when calling call5476362a281d830c946a3d6b");
      }
      ...
      let queryParams = {
        'RouteID': routeID,
        'Date': opts['date'],
        'IncludingVariations': opts['includingVariations']
      };
      let headerParams = {
      };
      let formParams = {
    ...
    /**
     * Callback function to receive the result of the call5476362a281d830c946a3d6c operation.
     * @callback module:api/DefaultApi~call5476362a281d830c946a3d6cCallback
     * @param {String} error Error message, if any.
     * @param data This operation does not return a value.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Object} opts Optional parameters
     * @param {String} [date] Date in YYYY-MM-DD format for which to retrieve schedule.  Defaults to today's date unless specified.
     * @param {module:api/DefaultApi~call5476362a281d830c946a3d6cCallback} callback The callback function, accepting three arguments: error, data, response
     */
    call5476362a281d830c946a3d6c(stopID, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'stopID' is set
      if (stopID === undefined || stopID === null) {
        throw new Error("Missing the required parameter 'stopID' when calling call5476362a281d830c946a3d6c");
      }
    ...
    /**
     * Callback function to receive the result of the call5476362a281d830c946a3d6d operation.
     * @callback module:api/DefaultApi~call5476362a281d830c946a3d6dCallback
     * @param {String} error Error message, if any.
     * @param data This operation does not return a value.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Object} opts Optional parameters
     * @param {module:model/Number} [lat] Center point Latitude, required if Longitude and Radius are specified.
     * @param {module:model/Number} [lon] Center point Longitude, required if Latitude and Radius are specified.
     * @param {module:model/Number} [radius] Radius (meters) to include in the search area, required if Latitude and Longitude are specified.
     * @param {module:api/DefaultApi~call5476362a281d830c946a3d6dCallback} callback The callback function, accepting three arguments: error, data, response
     */
    call5476362a281d830c946a3d6d(opts, callback) {
      opts = opts || {};
      let postBody = null;
    ...
    /**
     * Callback function to receive the result of the call5476362a281d830c946a3d6e operation.
     * @callback module:api/DefaultApi~call5476362a281d830c946a3d6eCallback
     * @param {String} error Error message, if any.
     * @param data This operation does not return a value.
     * @param {String} response The complete HTTP response.
     */
     ...
     * <h4 class=\"text-primary\">Description</h4>  <p>Returns bus positions for the given route, with an optional search radius. If no parameters are specified, all bus positions are returned.</p>  <p>Note that the RouteID parameter accepts only base route names and no variations, i.e.: use 10A instead of 10Av1 or 10Av2.</p>  <p>Bus positions are refreshed approximately every <span style=\"text-decoration: line-through\">20 to 30</span> 7 to 10 seconds.</p>  <h4 class=\"text-primary\">Response Elements</h4>  <table class=\"table table-condensed table-hover\"> <thead> <tr> <th class=\"col-md-3\">Element</th>  <th>Description</th> </tr> </thead>  <tbody> <tr> <td>BusPositions</td>  <td> Array containing bus position information (<a href= \"#BusPosition\">BusPositions</a>). </td> </tr>  <tr> <td colspan=\"2\"> <div class=\"text-primary\" style=\"margin-top: 1em\"> <a id=\"BusPosition\" name=\"BusPosition\">BusPosition Elements</a> </div> </td> </tr>  <tr> <td>DateTime</td>  <td>Date and time (Eastern Standard Time) of last position update. Will be in YYYY-MM-DDTHH:mm:ss format (e.g.: 2014-10-27T13:23:40).</td> </tr>  <tr> <td>Deviation</td>  <td>Deviation, in minutes, from schedule. Positive values indicate that the bus is running late while negative ones are for buses running ahead of schedule.</td> </tr>  <tr> <td style=\"text-decoration: line-through\">DirectionNum</td>  <td><span class=\"text-danger\">Deprecated.</span> Use the DirectionText for a customer-friendly description of direction.</td> </tr>  <tr> <td>DirectionText</td>  <td>General direction of the trip, not the bus itself (e.g.: NORTH, SOUTH, EAST, WEST).</td> </tr>  <tr> <td>Lat</td>  <td>Last reported Latitude of the bus.</td> </tr>  <tr> <td>Lon</td>  <td>Last reported Longitude of the bus.</td> </tr>  <tr> <td>RouteID</td>  <td>Base route name as shown on the bus. Note that the base route name could also refer to any variant, so a RouteID of 10A could refer to 10A, 10Av1, 10Av2, etc.</td> </tr>  <tr> <td>TripEndTime</td>  <td>Scheduled end date and time (Eastern Standard Time) of the bus's current trip. Will be in YYYY-MM-DDTHH:mm:ss format (e.g.: 2014-10-27T13:17:00).</td> </tr>  <tr> <td>TripHeadsign</td>  <td>Destination of the bus.</td> </tr>  <tr> <td>TripID</td>  <td>Unique trip ID. This can be correlated with the data returned from the schedule-related methods.</td> </tr>  <tr> <td>TripStartTime</td>  <td>Scheduled start date and time (Eastern Standard Time) of the bus's current trip. Will be in YYYY-MM-DDTHH:mm:ss format (e.g.: 2014-10-27T12:40:00).</td> </tr>  <tr> <td>VehicleID</td>  <td>Unique identifier for the bus. This is usually visible on the bus itself.</td> </tr> </tbody> </table>
     * @param {Object} opts Optional parameters
     * @param {module:model/String} [routeID = '70')] Bus route, e.g.: 70, 10A.
     * @param {String} [lat] Center point Latitude, required if Longitude and Radius are specified.
     * @param {String} [lon] Center point Longitude, required if Latitude and Radius are specified.
     * @param {String} [radius] Radius (meters) to include in the search area, required if Latitude and Longitude are specified.
     * @param {module:api/DefaultApi~call5476362a281d830c946a3d6eCallback} callback The callback function, accepting three arguments: error, data, response
     */
    call5476362a281d830c946a3d6e(opts, callback) {
      opts = opts || {};
      let postBody = null;
    ...
    /**
     * Callback function to receive the result of the call5476362a281d830c946a3d6f operation.
     * @callback module:api/DefaultApi~call5476362a281d830c946a3d6fCallback
     * @param {String} error Error message, if any.
     * @param data This operation does not return a value.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Object} opts Optional parameters
     * @param {String} [date] Date in YYYY-MM-DD format for which to retrieve route and stop information.  Defaults to today's date unless specified.
     * @param {module:api/DefaultApi~call5476362a281d830c946a3d6fCallback} callback The callback function, accepting three arguments: error, data, response
     */
    call5476362a281d830c946a3d6f(routeID, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'routeID' is set
      if (routeID === undefined || routeID === null) {
        throw new Error("Missing the required parameter 'routeID' when calling call5476362a281d830c946a3d6f");
      }
    ...
    /**
     * Callback function to receive the result of the call5476362a281d830c946a3d70 operation.
     * @callback module:api/DefaultApi~call5476362a281d830c946a3d70Callback
     * @param {String} error Error message, if any.
     * @param data This operation does not return a value.
     * @param {String} response The complete HTTP response.
     */
     ...
     * XML - Routes
     * <h4 class=\"text-primary\">Description</h4>    <p>Returns a list of all bus route variants (patterns). For example, the 10A  and 10Av1 are the same route, but may stop at slightly different locations.</p>    <h4 class=\"text-primary\">Response Elements</h4>    <table class=\"table table-condensed table-hover\">  <thead>  <tr>  <th class=\"col-md-3\">Element</th>    <th>Description</th>  </tr>  </thead>    <tbody>  <tr>  <td>Routes</td>    <td>  Array containing route variant information (<a href=  \"#Route\">Route</a>).  </td>  </tr>    <tr>  <td colspan=\"2\">  <div class=\"text-primary\" style=\"margin-top: 1em\">  <a id=\"Route\" name=\"Route\">Route Elements</a>  </div>  </td>  </tr>    <tr>  <td>Name</td>    <td>Descriptive name of the route variant.</td>  </tr>    <tr>  <td>RouteID</td>    <td>Unique identifier for a given route variant. Can be used in  various other bus-related methods.</td>  </tr>      <tr>  <td>LineDescription</td>    <td>Denotes the route variant’s grouping – lines are a combination of routes which lie in the same corridor and which have significant portions of their paths along the same roadways.</td>  </tr>   </tbody>  </table>
     * @param {module:api/DefaultApi~call5476362a281d830c946a3d70Callback} callback The callback function, accepting three arguments: error, data, response
     */
    call5476362a281d830c946a3d70(callback) {
      let postBody = null;
    ...
    /**
     * Callback function to receive the result of the call5476362a281d830c946a3d71 operation.
     * @callback module:api/DefaultApi~call5476362a281d830c946a3d71Callback
     * @param {String} error Error message, if any.
     * @param data This operation does not return a value.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Object} opts Optional parameters
     * @param {String} [date] Date in YYYY-MM-DD format for which to retrieve schedule.  Defaults to today's date unless specified.
     * @param {Boolean} [includingVariations = false)] Whether or not to include variations.  For example, if B30 is specified, include all variations such as B30v1, B30v2, etc.
     * @param {module:api/DefaultApi~call5476362a281d830c946a3d71Callback} callback The callback function, accepting three arguments: error, data, response
     */
    call5476362a281d830c946a3d71(routeID, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'routeID' is set
      if (routeID === undefined || routeID === null) {
        throw new Error("Missing the required parameter 'routeID' when calling call5476362a281d830c946a3d71");
      }
    ...
    /**
     * Callback function to receive the result of the call5476362a281d830c946a3d72 operation.
     * @callback module:api/DefaultApi~call5476362a281d830c946a3d72Callback
     * @param {String} error Error message, if any.
     * @param data This operation does not return a value.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Object} opts Optional parameters
     * @param {String} [date] Date in YYYY-MM-DD format for which to retrieve schedule.  Defaults to today's date unless specified.
     * @param {module:api/DefaultApi~call5476362a281d830c946a3d72Callback} callback The callback function, accepting three arguments: error, data, response
     */
    call5476362a281d830c946a3d72(stopID, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'stopID' is set
      if (stopID === undefined || stopID === null) {
        throw new Error("Missing the required parameter 'stopID' when calling call5476362a281d830c946a3d72");
      }
    ...
    /**
     * Callback function to receive the result of the call5476362a281d830c946a3d73 operation.
     * @callback module:api/DefaultApi~call5476362a281d830c946a3d73Callback
     * @param {String} error Error message, if any.
     * @param data This operation does not return a value.
     * @param {String} response The complete HTTP response.
     */
     ...
     * <h4 class=\"text-primary\">Description</h4>    <p>Returns a list of nearby bus stops based on latitude, longitude, and radius.  Omit all parameters to retrieve a list of all stops.</p>    <h4 class=\"text-primary\">Response Elements</h4>    <table class=\"table table-condensed table-hover\">  <thead>  <tr>  <th class=\"col-md-3\">Element</th>    <th>Description</th>  </tr>  </thead>    <tbody>  <tr>  <td>Stops</td>    <td>  Array containing stop information (<a href=\"#Stop\">Stop</a>).  </td>  </tr>    <tr>  <td colspan=\"2\">  <div class=\"text-primary\" style=\"margin-top: 1em\">  <a id=\"Stop\" name=\"Stop\">Stop Elements</a>  </div>  </td>  </tr>    <tr>  <td>Lat</td>    <td>Latitude.</td>  </tr>    <tr>  <td>Lon</td>    <td>Longitude.</td>  </tr>    <tr>  <td>Name</td>    <td>Stop name. May be slightly different from what is spoken or  displayed in the bus.</td>  </tr>    <tr>  <td>Routes</td>    <td>String array of route variants which provide service at this  stop. Note that these are not date-specific; any route variant  which stops at this stop on any day will be listed.</td>  </tr>    <tr>  <td>StopID</td>    <td>7-digit regional ID which can be used in various bus-related  methods. If unavailable, the StopID will be 0 or NULL.</td>  </tr>  </tbody>  </table>
     * @param {Object} opts Optional parameters
     * @param {module:model/String} [lat] Center point Latitude, required if Longitude and Radius are specified.
     * @param {module:model/String} [lon] Center point Longitude, required if Latitude and Radius are specified.
     * @param {module:model/String} [radius] Radius (feet) to include in the search area, required if Latitude and Longitude are specified.
     * @param {module:api/DefaultApi~call5476362a281d830c946a3d73Callback} callback The callback function, accepting three arguments: error, data, response
     */
    call5476362a281d830c946a3d73(opts, callback) {
      opts = opts || {};
      let postBody = null;
