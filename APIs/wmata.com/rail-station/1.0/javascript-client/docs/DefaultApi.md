# RailStationInformation.DefaultApi
...
```javascript
import RailStationInformation from 'rail_station_information';
let defaultClient = RailStationInformation.ApiClient.instance;
...
let apiInstance = new RailStationInformation.DefaultApi();
apiInstance.call5476364f031f5909e4fe330c((error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
> call5476364f031f5909e4fe330d(opts)
...
apiInstance.call5476364f031f5909e4fe330d(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully.');
...
let apiInstance = new RailStationInformation.DefaultApi();
let fromStationCode = "'N06'"; // String | Station code for the origin station.  Use the Station List method to return a list of all station codes.
let toStationCode = "'G05'"; // String | Station code for the destination station.  Use the Station List method to return a list of all station codes.
apiInstance.call5476364f031f5909e4fe330e(fromStationCode, toStationCode, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully.');
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **fromStationCode** | **String**| Station code for the origin station.  Use the Station List method to return a list of all station codes. | [default to &#39;N06&#39;]
 **toStationCode** | **String**| Station code for the destination station.  Use the Station List method to return a list of all station codes. | [default to &#39;G05&#39;]
...
> call5476364f031f5909e4fe330f(opts)
...
let apiInstance = new RailStationInformation.DefaultApi();
let opts = {
  'lat': 38.8978168, // Number | Center point Latitude, required if Longitude and Radius are specified.
  'lon': -77.0404246, // Number | Center point Longitude, required if Latitude and Radius are specified.
  'radius': 500.0 // Number | Radius (meters) to include in the search area, required if Latitude and Longitude are specified.
};
apiInstance.call5476364f031f5909e4fe330f(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully.');
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **lat** | **Number**| Center point Latitude, required if Longitude and Radius are specified. | [optional] [default to 38.8978168]
 **lon** | **Number**| Center point Longitude, required if Latitude and Radius are specified. | [optional] [default to -77.0404246]
 **radius** | **Number**| Radius (meters) to include in the search area, required if Latitude and Longitude are specified. | [optional] [default to 500.0]
...
let apiInstance = new RailStationInformation.DefaultApi();
let stationCode = "'A01'"; // String | Station code.  Use the Station List method to return a list of all station codes.
apiInstance.call5476364f031f5909e4fe3310(stationCode, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully.');
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **stationCode** | **String**| Station code.  Use the Station List method to return a list of all station codes. | [default to &#39;A01&#39;]
...
> call5476364f031f5909e4fe3311(opts)
...
let apiInstance = new RailStationInformation.DefaultApi();
let opts = {
  'lineCode': "lineCode_example" // String | Two-letter line code abbreviation:  <ul> <li>RD - Red</li> <li>YL - Yellow</li> <li>GR - Green</li> <li>BL - Blue</li> <li>OR - Orange</li> <li>SV - Silver</li> </ul>
};
apiInstance.call5476364f031f5909e4fe3311(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully.');
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **lineCode** | **String**| Two-letter line code abbreviation:  &lt;ul&gt; &lt;li&gt;RD - Red&lt;/li&gt; &lt;li&gt;YL - Yellow&lt;/li&gt; &lt;li&gt;GR - Green&lt;/li&gt; &lt;li&gt;BL - Blue&lt;/li&gt; &lt;li&gt;OR - Orange&lt;/li&gt; &lt;li&gt;SV - Silver&lt;/li&gt; &lt;/ul&gt; | [optional] 
...
> call5476364f031f5909e4fe3312(opts)
...
let apiInstance = new RailStationInformation.DefaultApi();
let opts = {
  'stationCode': "'E10'" // String | Station code.  Use the Station List method to return a list of all station codes.
};
apiInstance.call5476364f031f5909e4fe3312(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully.');
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **stationCode** | **String**| Station code.  Use the Station List method to return a list of all station codes. | [optional] [default to &#39;E10&#39;]
...
> call5476364f031f5909e4fe3313(opts)
...
let apiInstance = new RailStationInformation.DefaultApi();
let opts = {
  'fromStationCode': "'E10'", // String | Station code for the origin station.  Use the Station List method to return a list of all station codes.
  'toStationCode': "'J03'" // String | Station code for the destination station.  Use the Station List method to return a list of all station codes.
};
apiInstance.call5476364f031f5909e4fe3313(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully.');
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **fromStationCode** | **String**| Station code for the origin station.  Use the Station List method to return a list of all station codes. | [optional] [default to &#39;E10&#39;]
 **toStationCode** | **String**| Station code for the destination station.  Use the Station List method to return a list of all station codes. | [optional] [default to &#39;J03&#39;]
...
let apiInstance = new RailStationInformation.DefaultApi();
apiInstance.call5476364f031f5909e4fe3314((error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully.');
...
> call5476364f031f5909e4fe3315(opts)
...
apiInstance.call5476364f031f5909e4fe3315(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully.');
...
let apiInstance = new RailStationInformation.DefaultApi();
let fromStationCode = "'N06'"; // String | Station code for the origin station.  Use the Station List method to return a list of all station codes.
let toStationCode = "'G05'"; // String | Station code for the origin station.  Use the Station List method to return a list of all station codes.
apiInstance.call5476364f031f5909e4fe3316(fromStationCode, toStationCode, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully.');
...
------------- | ------------- | ------------- | -------------
 **fromStationCode** | **String**| Station code for the origin station.  Use the Station List method to return a list of all station codes. | [default to &#39;N06&#39;]
 **toStationCode** | **String**| Station code for the origin station.  Use the Station List method to return a list of all station codes. | [default to &#39;G05&#39;]
...
> call5476364f031f5909e4fe3317(opts)
...
apiInstance.call5476364f031f5909e4fe3317(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully.');
...
let apiInstance = new RailStationInformation.DefaultApi();
let stationCode = "'A01'"; // String | Station code.  Use the Station List method to return a list of all station codes.
apiInstance.call5476364f031f5909e4fe3318(stationCode, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully.');
...
> call5476364f031f5909e4fe3319(opts)
...
apiInstance.call5476364f031f5909e4fe3319(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully.');
...
> call5476364f031f5909e4fe331a(opts)
...
apiInstance.call5476364f031f5909e4fe331a(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully.');
...
> call5476364f031f5909e4fe331b(opts)
...
apiInstance.call5476364f031f5909e4fe331b(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully.');
