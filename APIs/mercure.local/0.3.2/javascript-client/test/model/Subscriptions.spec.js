...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheMercureProtocol.Subscriptions();
  });
  ...
  describe('Subscriptions', function() {
    it('should create an instance of Subscriptions', function() {
      ...
      //var instance = new TheMercureProtocol.Subscriptions();
      //expect(instance).to.be.a(TheMercureProtocol.Subscriptions);
    });
