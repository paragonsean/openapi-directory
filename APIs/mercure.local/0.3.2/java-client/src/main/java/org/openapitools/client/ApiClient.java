...
public class ApiClient {
    ...
    private String basePath = "http://mercure.local";
    ...
    public ApiClient() {
        ...
        authentications.put("Cookie", new ApiKeyAuth("cookie", "mercureAuthorization"));
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g http://mercure.local
