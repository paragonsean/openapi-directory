...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ElmahIoApi.UptimeCheck();
  });
  ...
  describe('UptimeCheck', function() {
    it('should create an instance of UptimeCheck', function() {
      // uncomment below and update the code to test UptimeCheck
      //var instance = new ElmahIoApi.UptimeCheck();
      //expect(instance).to.be.a(ElmahIoApi.UptimeCheck);
    });
