...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ElmahIoApi.Breadcrumb();
  });
  ...
  describe('Breadcrumb', function() {
    it('should create an instance of Breadcrumb', function() {
      // uncomment below and update the code to test Breadcrumb
      //var instance = new ElmahIoApi.Breadcrumb();
      //expect(instance).to.be.a(ElmahIoApi.Breadcrumb);
    });
