...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ElmahIoApi.CreateDeployment();
  });
  ...
  describe('CreateDeployment', function() {
    it('should create an instance of CreateDeployment', function() {
      // uncomment below and update the code to test CreateDeployment
      //var instance = new ElmahIoApi.CreateDeployment();
      //expect(instance).to.be.a(ElmahIoApi.CreateDeployment);
    });
