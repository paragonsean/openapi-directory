...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ElmahIoApi.CreateMessage();
  });
  ...
  describe('CreateMessage', function() {
    it('should create an instance of CreateMessage', function() {
      // uncomment below and update the code to test CreateMessage
      //var instance = new ElmahIoApi.CreateMessage();
      //expect(instance).to.be.a(ElmahIoApi.CreateMessage);
    });
