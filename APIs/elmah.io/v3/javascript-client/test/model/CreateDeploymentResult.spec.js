...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ElmahIoApi.CreateDeploymentResult();
  });
  ...
  describe('CreateDeploymentResult', function() {
    it('should create an instance of CreateDeploymentResult', function() {
      // uncomment below and update the code to test CreateDeploymentResult
      //var instance = new ElmahIoApi.CreateDeploymentResult();
      //expect(instance).to.be.a(ElmahIoApi.CreateDeploymentResult);
    });
