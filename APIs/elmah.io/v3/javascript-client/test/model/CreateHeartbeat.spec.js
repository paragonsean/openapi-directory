...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ElmahIoApi.CreateHeartbeat();
  });
  ...
  describe('CreateHeartbeat', function() {
    it('should create an instance of CreateHeartbeat', function() {
      // uncomment below and update the code to test CreateHeartbeat
      //var instance = new ElmahIoApi.CreateHeartbeat();
      //expect(instance).to.be.a(ElmahIoApi.CreateHeartbeat);
    });
