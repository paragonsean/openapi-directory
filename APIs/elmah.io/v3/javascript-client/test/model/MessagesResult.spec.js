...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ElmahIoApi.MessagesResult();
  });
  ...
  describe('MessagesResult', function() {
    it('should create an instance of MessagesResult', function() {
      // uncomment below and update the code to test MessagesResult
      //var instance = new ElmahIoApi.MessagesResult();
      //expect(instance).to.be.a(ElmahIoApi.MessagesResult);
    });
