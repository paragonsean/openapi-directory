...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ElmahIoApi.CreateMessageResult();
  });
  ...
  describe('CreateMessageResult', function() {
    it('should create an instance of CreateMessageResult', function() {
      // uncomment below and update the code to test CreateMessageResult
      //var instance = new ElmahIoApi.CreateMessageResult();
      //expect(instance).to.be.a(ElmahIoApi.CreateMessageResult);
    });
