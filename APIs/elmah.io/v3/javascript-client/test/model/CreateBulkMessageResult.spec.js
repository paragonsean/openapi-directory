...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ElmahIoApi.CreateBulkMessageResult();
  });
  ...
  describe('CreateBulkMessageResult', function() {
    it('should create an instance of CreateBulkMessageResult', function() {
      // uncomment below and update the code to test CreateBulkMessageResult
      //var instance = new ElmahIoApi.CreateBulkMessageResult();
      //expect(instance).to.be.a(ElmahIoApi.CreateBulkMessageResult);
    });
