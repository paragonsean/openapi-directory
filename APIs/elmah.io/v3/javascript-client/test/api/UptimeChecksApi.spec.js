...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ElmahIoApi.UptimeChecksApi();
  });
  ...
  describe('UptimeChecksApi', function() {
    describe('uptimeChecksGetAll', function() {
      it('should call uptimeChecksGetAll successfully', function(done) {
        //uncomment below and update the code to test uptimeChecksGetAll
        //instance.uptimeChecksGetAll(function(error) {
