...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ElmahIoApi.HeartbeatsApi();
  });
  ...
  describe('HeartbeatsApi', function() {
    describe('heartbeatsCreate', function() {
      it('should call heartbeatsCreate successfully', function(done) {
        //uncomment below and update the code to test heartbeatsCreate
        //instance.heartbeatsCreate(function(error) {
