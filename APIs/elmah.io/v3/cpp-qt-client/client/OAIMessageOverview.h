...
/*
 * OAIMessageOverview.h
 *
 * 
 */

#ifndef OAIMessageOverview_H
#define OAIMessageOverview_H
...
class OAIMessageOverview : public OAIObject {
public:
    OAIMessageOverview();
    OAIMessageOverview(QString json);
    ~OAIMessageOverview() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMessageOverview)

#endif // OAIMessageOverview_H
