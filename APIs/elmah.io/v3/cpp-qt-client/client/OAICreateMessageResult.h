...
/*
 * OAICreateMessageResult.h
 *
 * 
 */

#ifndef OAICreateMessageResult_H
#define OAICreateMessageResult_H
...
class OAICreateMessageResult : public OAIObject {
public:
    OAICreateMessageResult();
    OAICreateMessageResult(QString json);
    ~OAICreateMessageResult() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateMessageResult)

#endif // OAICreateMessageResult_H
