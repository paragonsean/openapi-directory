...
/*
 * OAICreateLogResult.h
 *
 * 
 */

#ifndef OAICreateLogResult_H
#define OAICreateLogResult_H
...
class OAICreateLogResult : public OAIObject {
public:
    OAICreateLogResult();
    OAICreateLogResult(QString json);
    ~OAICreateLogResult() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateLogResult)

#endif // OAICreateLogResult_H
