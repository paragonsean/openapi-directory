...
/**
 * Model tests for CreateMessageResult
 */
public class CreateMessageResultTest {
    private final CreateMessageResult model = new CreateMessageResult();
