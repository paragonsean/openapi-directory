...
public class CreateMessage {
  ...
  public CreateMessage application(String application) {
  ...
  public CreateMessage breadcrumbs(List<Breadcrumb> breadcrumbs) {
    this.breadcrumbs = breadcrumbs;
    return this;
  }

  public CreateMessage addBreadcrumbsItem(Breadcrumb breadcrumbsItem) {
  ...
  public CreateMessage category(String category) {
  ...
  public CreateMessage code(String code) {
    this.code = code;
    return this;
  }
  ...
  public CreateMessage cookies(List<Item> cookies) {
    this.cookies = cookies;
    return this;
  }

  public CreateMessage addCookiesItem(Item cookiesItem) {
  ...
  public CreateMessage correlationId(String correlationId) {
  ...
  public CreateMessage data(List<Item> data) {
    this.data = data;
    return this;
  }

  public CreateMessage addDataItem(Item dataItem) {
    if (this.data == null) {
  ...
  public CreateMessage dateTime(OffsetDateTime dateTime) {
  ...
  public CreateMessage detail(String detail) {
    this.detail = detail;
    return this;
  }
  ...
  public CreateMessage form(List<Item> form) {
    this.form = form;
    return this;
  }

  public CreateMessage addFormItem(Item formItem) {
    if (this.form == null) {
  ...
  public CreateMessage hostname(String hostname) {
  ...
  public CreateMessage method(String method) {
    this.method = method;
    return this;
  }
  ...
  public CreateMessage queryString(List<Item> queryString) {
    this.queryString = queryString;
    return this;
  }

  public CreateMessage addQueryStringItem(Item queryStringItem) {
  ...
  public CreateMessage serverVariables(List<Item> serverVariables) {
    this.serverVariables = serverVariables;
    return this;
  }

  public CreateMessage addServerVariablesItem(Item serverVariablesItem) {
  ...
  public CreateMessage severity(String severity) {
  ...
  public CreateMessage source(String source) {
    this.source = source;
    return this;
  }
  ...
  public CreateMessage statusCode(Integer statusCode) {
  ...
  public CreateMessage title(String title) {
    this.title = title;
    return this;
  }
  ...
  public CreateMessage titleTemplate(String titleTemplate) {
  ...
  public CreateMessage type(String type) {
    this.type = type;
    return this;
  }
  ...
  public CreateMessage url(String url) {
    this.url = url;
    return this;
  }
  ...
  public CreateMessage user(String user) {
    this.user = user;
    return this;
  }
  ...
  public CreateMessage version(String version) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.application, createMessage.application) &&
        Objects.equals(this.breadcrumbs, createMessage.breadcrumbs) &&
        Objects.equals(this.category, createMessage.category) &&
        Objects.equals(this.code, createMessage.code) &&
        Objects.equals(this.cookies, createMessage.cookies) &&
        Objects.equals(this.correlationId, createMessage.correlationId) &&
        Objects.equals(this.data, createMessage.data) &&
        Objects.equals(this.dateTime, createMessage.dateTime) &&
        Objects.equals(this.detail, createMessage.detail) &&
        Objects.equals(this.form, createMessage.form) &&
        Objects.equals(this.hostname, createMessage.hostname) &&
        Objects.equals(this.method, createMessage.method) &&
        Objects.equals(this.queryString, createMessage.queryString) &&
        Objects.equals(this.serverVariables, createMessage.serverVariables) &&
        Objects.equals(this.severity, createMessage.severity) &&
        Objects.equals(this.source, createMessage.source) &&
        Objects.equals(this.statusCode, createMessage.statusCode) &&
        Objects.equals(this.title, createMessage.title) &&
        Objects.equals(this.titleTemplate, createMessage.titleTemplate) &&
        Objects.equals(this.type, createMessage.type) &&
        Objects.equals(this.url, createMessage.url) &&
        Objects.equals(this.user, createMessage.user) &&
        Objects.equals(this.version, createMessage.version);
  }

  @Override
  public int hashCode() {
    return Objects.hash(application, breadcrumbs, category, code, cookies, correlationId, data, dateTime, detail, form, hostname, method, queryString, serverVariables, severity, source, statusCode, title, titleTemplate, type, url, user, version);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateMessage
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateMessage.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateMessage is not found in the empty JSON string", CreateMessage.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateMessage.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateMessage` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateMessage.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateMessage' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateMessage> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateMessage.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateMessage>() {
           @Override
           public void write(JsonWriter out, CreateMessage value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateMessage read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateMessage given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateMessage
   * @throws IOException if the JSON string is invalid with respect to CreateMessage
   */
  public static CreateMessage fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateMessage.class);
  }

  /**
   * Convert an instance of CreateMessage to an JSON string
   *
   * @return JSON string
   */
