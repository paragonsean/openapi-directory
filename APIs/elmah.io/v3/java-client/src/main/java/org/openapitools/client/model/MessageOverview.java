...
public class MessageOverview {
  ...
  public MessageOverview application(String application) {
  ...
  public MessageOverview breadcrumbs(List<Breadcrumb> breadcrumbs) {
    this.breadcrumbs = breadcrumbs;
    return this;
  }

  public MessageOverview addBreadcrumbsItem(Breadcrumb breadcrumbsItem) {
  ...
  public MessageOverview category(String category) {
  ...
  public MessageOverview code(String code) {
    this.code = code;
    return this;
  }
  ...
  public MessageOverview cookies(List<Item> cookies) {
    this.cookies = cookies;
    return this;
  }

  public MessageOverview addCookiesItem(Item cookiesItem) {
  ...
  public MessageOverview correlationId(String correlationId) {
  ...
  public MessageOverview data(List<Item> data) {
    this.data = data;
    return this;
  }

  public MessageOverview addDataItem(Item dataItem) {
    if (this.data == null) {
  ...
  public MessageOverview dateTime(OffsetDateTime dateTime) {
  ...
  public MessageOverview detail(String detail) {
    this.detail = detail;
    return this;
  }
  ...
  public MessageOverview form(List<Item> form) {
    this.form = form;
    return this;
  }

  public MessageOverview addFormItem(Item formItem) {
    if (this.form == null) {
  ...
  public MessageOverview hostname(String hostname) {
  ...
  public MessageOverview id(String id) {
    this.id = id;
    return this;
  }
  ...
  public MessageOverview method(String method) {
    this.method = method;
    return this;
  }
  ...
  public MessageOverview queryString(List<Item> queryString) {
    this.queryString = queryString;
    return this;
  }

  public MessageOverview addQueryStringItem(Item queryStringItem) {
  ...
  public MessageOverview serverVariables(List<Item> serverVariables) {
    this.serverVariables = serverVariables;
    return this;
  }

  public MessageOverview addServerVariablesItem(Item serverVariablesItem) {
  ...
  public MessageOverview severity(String severity) {
  ...
  public MessageOverview source(String source) {
    this.source = source;
    return this;
  }
  ...
  public MessageOverview statusCode(Integer statusCode) {
  ...
  public MessageOverview title(String title) {
    this.title = title;
    return this;
  }
  ...
  public MessageOverview titleTemplate(String titleTemplate) {
  ...
  public MessageOverview type(String type) {
    this.type = type;
    return this;
  }
  ...
  public MessageOverview url(String url) {
    this.url = url;
    return this;
  }
  ...
  public MessageOverview user(String user) {
    this.user = user;
    return this;
  }
  ...
  public MessageOverview version(String version) {
  ...
  public boolean equals(Object o) {
    ...
    MessageOverview messageOverview = (MessageOverview) o;
    return Objects.equals(this.application, messageOverview.application) &&
        Objects.equals(this.breadcrumbs, messageOverview.breadcrumbs) &&
        Objects.equals(this.category, messageOverview.category) &&
        Objects.equals(this.code, messageOverview.code) &&
        Objects.equals(this.cookies, messageOverview.cookies) &&
        Objects.equals(this.correlationId, messageOverview.correlationId) &&
        Objects.equals(this.data, messageOverview.data) &&
        Objects.equals(this.dateTime, messageOverview.dateTime) &&
        Objects.equals(this.detail, messageOverview.detail) &&
        Objects.equals(this.form, messageOverview.form) &&
        Objects.equals(this.hostname, messageOverview.hostname) &&
        Objects.equals(this.id, messageOverview.id) &&
        Objects.equals(this.method, messageOverview.method) &&
        Objects.equals(this.queryString, messageOverview.queryString) &&
        Objects.equals(this.serverVariables, messageOverview.serverVariables) &&
        Objects.equals(this.severity, messageOverview.severity) &&
        Objects.equals(this.source, messageOverview.source) &&
        Objects.equals(this.statusCode, messageOverview.statusCode) &&
        Objects.equals(this.title, messageOverview.title) &&
        Objects.equals(this.titleTemplate, messageOverview.titleTemplate) &&
        Objects.equals(this.type, messageOverview.type) &&
        Objects.equals(this.url, messageOverview.url) &&
        Objects.equals(this.user, messageOverview.user) &&
        Objects.equals(this.version, messageOverview.version);
  }
  ...
  public String toString() {
    ...
    sb.append("class MessageOverview {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to MessageOverview
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MessageOverview.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MessageOverview is not found in the empty JSON string", MessageOverview.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MessageOverview.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `MessageOverview` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MessageOverview.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MessageOverview' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MessageOverview> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MessageOverview.class));

       return (TypeAdapter<T>) new TypeAdapter<MessageOverview>() {
           @Override
           public void write(JsonWriter out, MessageOverview value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public MessageOverview read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of MessageOverview given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of MessageOverview
   * @throws IOException if the JSON string is invalid with respect to MessageOverview
   */
  public static MessageOverview fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MessageOverview.class);
  }

  /**
   * Convert an instance of MessageOverview to an JSON string
   *
   * @return JSON string
   */
