...
public class UserProfile {
  ...
  public static final String SERIALIZED_NAME_IS_DOCTOR = "is_doctor";
  @SerializedName(SERIALIZED_NAME_IS_DOCTOR)
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.doctor, userProfile.doctor) &&
        Objects.equals(this.id, userProfile.id) &&
        Objects.equals(this.isDoctor, userProfile.isDoctor) &&
        Objects.equals(this.isStaff, userProfile.isStaff) &&
        Objects.equals(this.permissions, userProfile.permissions) &&
        Objects.equals(this.practiceGroup, userProfile.practiceGroup) &&
        Objects.equals(this.username, userProfile.username);
  }

  @Override
  public int hashCode() {
    return Objects.hash(doctor, id, isDoctor, isStaff, permissions, practiceGroup, username);
  }
  ...
  public String toString() {
    ...
    sb.append("    isDoctor: ").append(toIndentedString(isDoctor)).append("\n");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if ((jsonObj.get("is_doctor") != null && !jsonObj.get("is_doctor").isJsonNull()) && !jsonObj.get("is_doctor").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `is_doctor` to be a primitive type in the JSON string but got `%s`", jsonObj.get("is_doctor").toString()));
      }
      if ((jsonObj.get("is_staff") != null && !jsonObj.get("is_staff").isJsonNull()) && !jsonObj.get("is_staff").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `is_staff` to be a primitive type in the JSON string but got `%s`", jsonObj.get("is_staff").toString()));
      }
