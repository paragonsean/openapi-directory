...
import org.openapitools.client.model.CptCodesInner;
import org.openapitools.client.model.CustomProcedureCodesInner;
import org.openapitools.client.model.HcpcsCodesInner;
...
public class BillingProfile {
  ...
  public static final String SERIALIZED_NAME_CPT_CODES = "cpt_codes";
  @SerializedName(SERIALIZED_NAME_CPT_CODES)
  private List<CptCodesInner> cptCodes = new ArrayList<>();

  public static final String SERIALIZED_NAME_CREATED_AT = "created_at";
  @SerializedName(SERIALIZED_NAME_CREATED_AT)
  private String createdAt;

  public static final String SERIALIZED_NAME_CUSTOM_PROCEDURE_CODES = "custom_procedure_codes";
  @SerializedName(SERIALIZED_NAME_CUSTOM_PROCEDURE_CODES)
  private List<CustomProcedureCodesInner> customProcedureCodes = new ArrayList<>();

  public static final String SERIALIZED_NAME_DOCTOR = "doctor";
  @SerializedName(SERIALIZED_NAME_DOCTOR)
  private String doctor;

  public static final String SERIALIZED_NAME_HCPCS_CODES = "hcpcs_codes";
  @SerializedName(SERIALIZED_NAME_HCPCS_CODES)
  private List<HcpcsCodesInner> hcpcsCodes = new ArrayList<>();
  ...
  public BillingProfile(
     Boolean archived, 
     List<CptCodesInner> cptCodes, 
     String createdAt, 
     List<CustomProcedureCodesInner> customProcedureCodes, 
     String doctor, 
     List<HcpcsCodesInner> hcpcsCodes, 
     List<String> icd10Codes, 
     List<String> icd9Codes, 
     Integer id, 
     String updatedAt
  ) {
    this();
   ...
   */
  @javax.annotation.Nullable
  public List<CptCodesInner> getCptCodes() {
    return cptCodes;
  }
   ...
   * @return customProcedureCodes
   */
  @javax.annotation.Nullable
  public List<CustomProcedureCodesInner> getCustomProcedureCodes() {
    return customProcedureCodes;
  }
   ...
   */
  @javax.annotation.Nullable
  public List<HcpcsCodesInner> getHcpcsCodes() {
    return hcpcsCodes;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.archived, billingProfile.archived) &&
        Objects.equals(this.cptCodes, billingProfile.cptCodes) &&
        Objects.equals(this.createdAt, billingProfile.createdAt) &&
        Objects.equals(this.customProcedureCodes, billingProfile.customProcedureCodes) &&
        Objects.equals(this.doctor, billingProfile.doctor) &&
        Objects.equals(this.hcpcsCodes, billingProfile.hcpcsCodes) &&
        Objects.equals(this.icd10Codes, billingProfile.icd10Codes) &&
        Objects.equals(this.icd9Codes, billingProfile.icd9Codes) &&
        Objects.equals(this.id, billingProfile.id) &&
        Objects.equals(this.name, billingProfile.name) &&
        Objects.equals(this.updatedAt, billingProfile.updatedAt);
  }

  @Override
  public int hashCode() {
    return Objects.hash(archived, cptCodes, createdAt, customProcedureCodes, doctor, hcpcsCodes, icd10Codes, icd9Codes, id, name, updatedAt);
  }
  ...
  public String toString() {
    ...
    sb.append("    customProcedureCodes: ").append(toIndentedString(customProcedureCodes)).append("\n");
    sb.append("    doctor: ").append(toIndentedString(doctor)).append("\n");
    sb.append("    hcpcsCodes: ").append(toIndentedString(hcpcsCodes)).append("\n");
  ...
  static {
    ...
    openapiFields.add("cpt_codes");
    openapiFields.add("created_at");
    openapiFields.add("custom_procedure_codes");
    openapiFields.add("doctor");
    openapiFields.add("hcpcs_codes");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("cpt_codes") != null && !jsonObj.get("cpt_codes").isJsonNull()) {
        JsonArray jsonArraycptCodes = jsonObj.getAsJsonArray("cpt_codes");
        if (jsonArraycptCodes != null) {
          // ensure the json data is an array
          if (!jsonObj.get("cpt_codes").isJsonArray()) {
            throw new IllegalArgumentException(String.format("Expected the field `cpt_codes` to be an array in the JSON string but got `%s`", jsonObj.get("cpt_codes").toString()));
          }

          // validate the optional field `cpt_codes` (array)
          for (int i = 0; i < jsonArraycptCodes.size(); i++) {
            CptCodesInner.validateJsonElement(jsonArraycptCodes.get(i));
          };
        }
      }
      ...
      if (jsonObj.get("custom_procedure_codes") != null && !jsonObj.get("custom_procedure_codes").isJsonNull()) {
        JsonArray jsonArraycustomProcedureCodes = jsonObj.getAsJsonArray("custom_procedure_codes");
        if (jsonArraycustomProcedureCodes != null) {
          // ensure the json data is an array
          if (!jsonObj.get("custom_procedure_codes").isJsonArray()) {
            throw new IllegalArgumentException(String.format("Expected the field `custom_procedure_codes` to be an array in the JSON string but got `%s`", jsonObj.get("custom_procedure_codes").toString()));
          }

          // validate the optional field `custom_procedure_codes` (array)
          for (int i = 0; i < jsonArraycustomProcedureCodes.size(); i++) {
            CustomProcedureCodesInner.validateJsonElement(jsonArraycustomProcedureCodes.get(i));
          };
        }
      }
      ...
      if (jsonObj.get("hcpcs_codes") != null && !jsonObj.get("hcpcs_codes").isJsonNull()) {
        JsonArray jsonArrayhcpcsCodes = jsonObj.getAsJsonArray("hcpcs_codes");
        if (jsonArrayhcpcsCodes != null) {
          // ensure the json data is an array
          if (!jsonObj.get("hcpcs_codes").isJsonArray()) {
            throw new IllegalArgumentException(String.format("Expected the field `hcpcs_codes` to be an array in the JSON string but got `%s`", jsonObj.get("hcpcs_codes").toString()));
          }

          // validate the optional field `hcpcs_codes` (array)
          for (int i = 0; i < jsonArrayhcpcsCodes.size(); i++) {
            HcpcsCodesInner.validateJsonElement(jsonArrayhcpcsCodes.get(i));
          };
        }
      }
