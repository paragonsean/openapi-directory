...
public class CarePlan {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.appointment, carePlan.appointment) &&
        Objects.equals(this.code, carePlan.code) &&
        Objects.equals(this.codeSystem, carePlan.codeSystem) &&
        Objects.equals(this.createdAt, carePlan.createdAt) &&
        Objects.equals(this.description, carePlan.description) &&
        Objects.equals(this.id, carePlan.id) &&
        Objects.equals(this.instructions, carePlan.instructions) &&
        Objects.equals(this.patient, carePlan.patient) &&
        Objects.equals(this.planType, carePlan.planType) &&
        Objects.equals(this.scheduledDate, carePlan.scheduledDate) &&
        Objects.equals(this.title, carePlan.title) &&
        Objects.equals(this.updatedAt, carePlan.updatedAt);
  }

  @Override
  public int hashCode() {
    return Objects.hash(appointment, code, codeSystem, createdAt, description, id, instructions, patient, planType, scheduledDate, title, updatedAt);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to CarePlan
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CarePlan.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CarePlan is not found in the empty JSON string", CarePlan.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CarePlan.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CarePlan` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("plan_type") != null && !jsonObj.get("plan_type").isJsonNull()) {
        PlanTypeEnum.validateJsonElement(jsonObj.get("plan_type"));
      }
      if ((jsonObj.get("scheduled_date") != null && !jsonObj.get("scheduled_date").isJsonNull()) && !jsonObj.get("scheduled_date").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `scheduled_date` to be a primitive type in the JSON string but got `%s`", jsonObj.get("scheduled_date").toString()));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CarePlan.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CarePlan' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CarePlan> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CarePlan.class));

       return (TypeAdapter<T>) new TypeAdapter<CarePlan>() {
           @Override
           public void write(JsonWriter out, CarePlan value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CarePlan read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CarePlan given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CarePlan
   * @throws IOException if the JSON string is invalid with respect to CarePlan
   */
  public static CarePlan fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CarePlan.class);
  }

  /**
   * Convert an instance of CarePlan to an JSON string
   *
   * @return JSON string
   */
