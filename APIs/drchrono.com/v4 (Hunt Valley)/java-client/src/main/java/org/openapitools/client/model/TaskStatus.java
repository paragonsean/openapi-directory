...
public class TaskStatus {
  ...
  public static final String SERIALIZED_NAME_STATUS_CATEGORY = "status_category";
  ...
  public TaskStatus archived(Boolean archived) {
  ...
  public TaskStatus practiceGroup(Integer practiceGroup) {
  ...
  public TaskStatus statusCategory(StatusCategoryEnum statusCategory) {
  ...
  public TaskStatus taskCategory(Integer taskCategory) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.archived, taskStatus.archived) &&
        Objects.equals(this.createdAt, taskStatus.createdAt) &&
        Objects.equals(this.id, taskStatus.id) &&
        Objects.equals(this.name, taskStatus.name) &&
        Objects.equals(this.practiceGroup, taskStatus.practiceGroup) &&
        Objects.equals(this.statusCategory, taskStatus.statusCategory) &&
        Objects.equals(this.taskCategory, taskStatus.taskCategory) &&
        Objects.equals(this.updatedAt, taskStatus.updatedAt);
  }

  @Override
  public int hashCode() {
    return Objects.hash(archived, createdAt, id, name, practiceGroup, statusCategory, taskCategory, updatedAt);
  }
  ...
  static {
    ...
    openapiFields.add("status_category");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if ((jsonObj.get("status_category") != null && !jsonObj.get("status_category").isJsonNull()) && !jsonObj.get("status_category").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `status_category` to be a primitive type in the JSON string but got `%s`", jsonObj.get("status_category").toString()));
      }
      // validate the optional field `status_category`
      if (jsonObj.get("status_category") != null && !jsonObj.get("status_category").isJsonNull()) {
        StatusCategoryEnum.validateJsonElement(jsonObj.get("status_category"));
      }
