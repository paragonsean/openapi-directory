...
public class PatientCommunication {
  ...
  public PatientCommunication code(String code) {
    this.code = code;
    return this;
  }
  ...
  public PatientCommunication codeSystem(String codeSystem) {
  ...
  public PatientCommunication doctor(Integer doctor) {
    this.doctor = doctor;
    return this;
  }
  ...
  public PatientCommunication effectiveTime(String effectiveTime) {
  ...
  public PatientCommunication patient(Integer patient) {
  ...
  public PatientCommunication valueCode(String valueCode) {
  ...
  public PatientCommunication valueCodeSystem(String valueCodeSystem) {
  ...
  public boolean equals(Object o) {
    ...
    PatientCommunication patientCommunication = (PatientCommunication) o;
    return Objects.equals(this.code, patientCommunication.code) &&
        Objects.equals(this.codeSystem, patientCommunication.codeSystem) &&
        Objects.equals(this.createdAt, patientCommunication.createdAt) &&
        Objects.equals(this.doctor, patientCommunication.doctor) &&
        Objects.equals(this.effectiveTime, patientCommunication.effectiveTime) &&
        Objects.equals(this.id, patientCommunication.id) &&
        Objects.equals(this.name, patientCommunication.name) &&
        Objects.equals(this.patient, patientCommunication.patient) &&
        Objects.equals(this.valueCode, patientCommunication.valueCode) &&
        Objects.equals(this.valueCodeSystem, patientCommunication.valueCodeSystem) &&
        Objects.equals(this.valueName, patientCommunication.valueName);
  }
  ...
  public String toString() {
    ...
    sb.append("class PatientCommunication {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PatientCommunication
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PatientCommunication.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PatientCommunication is not found in the empty JSON string", PatientCommunication.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PatientCommunication.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PatientCommunication` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PatientCommunication.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PatientCommunication.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PatientCommunication' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PatientCommunication> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PatientCommunication.class));

       return (TypeAdapter<T>) new TypeAdapter<PatientCommunication>() {
           @Override
           public void write(JsonWriter out, PatientCommunication value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PatientCommunication read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PatientCommunication given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PatientCommunication
   * @throws IOException if the JSON string is invalid with respect to PatientCommunication
   */
  public static PatientCommunication fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PatientCommunication.class);
  }

  /**
   * Convert an instance of PatientCommunication to an JSON string
   *
   * @return JSON string
   */
