...
public class PatientPhysicalExam {
  ...
  public PatientPhysicalExam code(String code) {
    this.code = code;
    return this;
  }
  ...
  public PatientPhysicalExam codeSystem(String codeSystem) {
  ...
  public PatientPhysicalExam doctor(Integer doctor) {
    this.doctor = doctor;
    return this;
  }
  ...
  public PatientPhysicalExam effectiveTime(String effectiveTime) {
  ...
  public PatientPhysicalExam patient(Integer patient) {
  ...
  public PatientPhysicalExam valueCode(String valueCode) {
  ...
  public PatientPhysicalExam valueCodeSystem(String valueCodeSystem) {
  ...
  public boolean equals(Object o) {
    ...
    PatientPhysicalExam patientPhysicalExam = (PatientPhysicalExam) o;
    return Objects.equals(this.code, patientPhysicalExam.code) &&
        Objects.equals(this.codeSystem, patientPhysicalExam.codeSystem) &&
        Objects.equals(this.createdAt, patientPhysicalExam.createdAt) &&
        Objects.equals(this.doctor, patientPhysicalExam.doctor) &&
        Objects.equals(this.effectiveTime, patientPhysicalExam.effectiveTime) &&
        Objects.equals(this.id, patientPhysicalExam.id) &&
        Objects.equals(this.name, patientPhysicalExam.name) &&
        Objects.equals(this.patient, patientPhysicalExam.patient) &&
        Objects.equals(this.valueCode, patientPhysicalExam.valueCode) &&
        Objects.equals(this.valueCodeSystem, patientPhysicalExam.valueCodeSystem) &&
        Objects.equals(this.valueName, patientPhysicalExam.valueName);
  }
  ...
  public String toString() {
    ...
    sb.append("class PatientPhysicalExam {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PatientPhysicalExam
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PatientPhysicalExam.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PatientPhysicalExam is not found in the empty JSON string", PatientPhysicalExam.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PatientPhysicalExam.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PatientPhysicalExam` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PatientPhysicalExam.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PatientPhysicalExam.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PatientPhysicalExam' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PatientPhysicalExam> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PatientPhysicalExam.class));

       return (TypeAdapter<T>) new TypeAdapter<PatientPhysicalExam>() {
           @Override
           public void write(JsonWriter out, PatientPhysicalExam value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PatientPhysicalExam read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PatientPhysicalExam given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PatientPhysicalExam
   * @throws IOException if the JSON string is invalid with respect to PatientPhysicalExam
   */
  public static PatientPhysicalExam fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PatientPhysicalExam.class);
  }

  /**
   * Convert an instance of PatientPhysicalExam to an JSON string
   *
   * @return JSON string
   */
