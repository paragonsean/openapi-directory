...
public class PatientIntervention {
  ...
  public PatientIntervention code(String code) {
    this.code = code;
    return this;
  }
  ...
  public PatientIntervention codeSystem(String codeSystem) {
  ...
  public PatientIntervention doctor(Integer doctor) {
    this.doctor = doctor;
    return this;
  }
  ...
  public PatientIntervention effectiveTime(String effectiveTime) {
  ...
  public PatientIntervention patient(Integer patient) {
  ...
  public PatientIntervention valueCode(String valueCode) {
  ...
  public PatientIntervention valueCodeSystem(String valueCodeSystem) {
  ...
  public boolean equals(Object o) {
    ...
    PatientIntervention patientIntervention = (PatientIntervention) o;
    return Objects.equals(this.code, patientIntervention.code) &&
        Objects.equals(this.codeSystem, patientIntervention.codeSystem) &&
        Objects.equals(this.createdAt, patientIntervention.createdAt) &&
        Objects.equals(this.doctor, patientIntervention.doctor) &&
        Objects.equals(this.effectiveTime, patientIntervention.effectiveTime) &&
        Objects.equals(this.id, patientIntervention.id) &&
        Objects.equals(this.name, patientIntervention.name) &&
        Objects.equals(this.patient, patientIntervention.patient) &&
        Objects.equals(this.valueCode, patientIntervention.valueCode) &&
        Objects.equals(this.valueCodeSystem, patientIntervention.valueCodeSystem) &&
        Objects.equals(this.valueName, patientIntervention.valueName);
  }
  ...
  public String toString() {
    ...
    sb.append("class PatientIntervention {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PatientIntervention
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PatientIntervention.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PatientIntervention is not found in the empty JSON string", PatientIntervention.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PatientIntervention.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PatientIntervention` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PatientIntervention.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PatientIntervention.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PatientIntervention' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PatientIntervention> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PatientIntervention.class));

       return (TypeAdapter<T>) new TypeAdapter<PatientIntervention>() {
           @Override
           public void write(JsonWriter out, PatientIntervention value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PatientIntervention read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PatientIntervention given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PatientIntervention
   * @throws IOException if the JSON string is invalid with respect to PatientIntervention
   */
  public static PatientIntervention fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PatientIntervention.class);
  }

  /**
   * Convert an instance of PatientIntervention to an JSON string
   *
   * @return JSON string
   */
