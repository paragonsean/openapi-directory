...
public class Value {
  public static final String SERIALIZED_NAME_CLINICAL_NOTE_FIELD = "clinical_note_field";
  @SerializedName(SERIALIZED_NAME_CLINICAL_NOTE_FIELD)
  private Integer clinicalNoteField;
  ...
  public Value clinicalNoteField(Integer clinicalNoteField) {
  ...
  /**
   * 
   * @return clinicalNoteField
   */
  @javax.annotation.Nullable
  public Integer getClinicalNoteField() {
    return clinicalNoteField;
  }

  public void setClinicalNoteField(Integer clinicalNoteField) {
    this.clinicalNoteField = clinicalNoteField;
  }
  ...
  public boolean equals(Object o) {
    ...
    Value value = (Value) o;
    return Objects.equals(this.clinicalNoteField, value.clinicalNoteField) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(clinicalNoteField, id, value);
  }
  ...
  public String toString() {
    ...
    sb.append("    clinicalNoteField: ").append(toIndentedString(clinicalNoteField)).append("\n");
  ...
  static {
    ...
    openapiFields.add("clinical_note_field");
