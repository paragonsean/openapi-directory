...
public class Insurance {
  ...
  public Insurance payerId(String payerId) {
  ...
  public Insurance payerName(String payerName) {
  ...
  public Insurance state(String state) {
    this.state = state;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.payerId, insurance.payerId) &&
        Objects.equals(this.payerName, insurance.payerName) &&
        Objects.equals(this.state, insurance.state);
  }

  @Override
  public int hashCode() {
    return Objects.hash(payerId, payerName, state);
  }
