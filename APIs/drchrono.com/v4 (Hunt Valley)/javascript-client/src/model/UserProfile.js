...
class UserProfile {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('is_doctor')) {
                obj['is_doctor'] = ApiClient.convertToType(data['is_doctor'], 'String');
            }
            if (data.hasOwnProperty('is_staff')) {
                obj['is_staff'] = ApiClient.convertToType(data['is_staff'], 'String');
            }
    ...
    static validateJSON(data) {
        ...
        // ensure the json data is a string
        if (data['is_doctor'] && !(typeof data['is_doctor'] === 'string' || data['is_doctor'] instanceof String)) {
            throw new Error("Expected the field `is_doctor` to be a primitive type in the JSON string but got " + data['is_doctor']);
        }
        // ensure the json data is a string
        if (data['is_staff'] && !(typeof data['is_staff'] === 'string' || data['is_staff'] instanceof String)) {
            throw new Error("Expected the field `is_staff` to be a primitive type in the JSON string but got " + data['is_staff']);
        }
        // ensure the json data is a string
 ...
 */
UserProfile.prototype['doctor'] = undefined;
 ...
 * @member {String} is_doctor
 */
UserProfile.prototype['is_doctor'] = undefined;

/**
 * Mutually exclusive with `is_doctor`
 * @member {String} is_staff
 */
UserProfile.prototype['is_staff'] = undefined;
 ...
 */
UserProfile.prototype['practice_group'] = undefined;
