...
/**
 * The TertiaryInsurance model module.
 * @module model/TertiaryInsurance
 * @version v4 (Hunt Valley)
 */
class TertiaryInsurance {
    /**
     * Constructs a new <code>TertiaryInsurance</code>.
     ...
     * @alias module:model/TertiaryInsurance
     */
    constructor() { 
        
        TertiaryInsurance.initialize(this);
    }
    ...
    /**
     * Constructs a <code>TertiaryInsurance</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/TertiaryInsurance} obj Optional instance to populate.
     * @return {module:model/TertiaryInsurance} The populated <code>TertiaryInsurance</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new TertiaryInsurance();
    ...
    /**
     * Validates the JSON data with respect to <code>TertiaryInsurance</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TertiaryInsurance</code>.
     */
 ...
 */
TertiaryInsurance.prototype['insurance_claim_office_number'] = undefined;

/**
 * 
 * @member {String} insurance_company
 */
TertiaryInsurance.prototype['insurance_company'] = undefined;

/**
 * 
 * @member {String} insurance_group_name
 */
TertiaryInsurance.prototype['insurance_group_name'] = undefined;

/**
 * 
 * @member {String} insurance_group_number
 */
TertiaryInsurance.prototype['insurance_group_number'] = undefined;

/**
 * 
 * @member {String} insurance_id_number
 */
TertiaryInsurance.prototype['insurance_id_number'] = undefined;

/**
 * 
 * @member {String} insurance_payer_id
 */
TertiaryInsurance.prototype['insurance_payer_id'] = undefined;

/**
 * Name of insurance plan.
 * @member {String} insurance_plan_name
 */
TertiaryInsurance.prototype['insurance_plan_name'] = undefined;

/**
 * 
 * @member {module:model/TertiaryInsurance.InsurancePlanTypeEnum} insurance_plan_type
 */
TertiaryInsurance.prototype['insurance_plan_type'] = undefined;

/**
 * True if the insurance policy is under patient's own name. Defaults to true
 * @member {Boolean} is_subscriber_the_patient
 */
TertiaryInsurance.prototype['is_subscriber_the_patient'] = undefined;

/**
 * HCFA/1500 individual relationship code
 * @member {module:model/TertiaryInsurance.PatientRelationshipToSubscriberEnum} patient_relationship_to_subscriber
 */
TertiaryInsurance.prototype['patient_relationship_to_subscriber'] = undefined;

/**
 * Photo of back of insurance card
 * @member {String} photo_back
 */
TertiaryInsurance.prototype['photo_back'] = undefined;

/**
 * Photo of front of insurance card
 * @member {String} photo_front
 */
TertiaryInsurance.prototype['photo_front'] = undefined;

/**
 * 
 * @member {String} subscriber_address
 */
TertiaryInsurance.prototype['subscriber_address'] = undefined;

/**
 * 
 * @member {String} subscriber_city
 */
TertiaryInsurance.prototype['subscriber_city'] = undefined;

/**
 * Two-letter country code
 * @member {module:model/TertiaryInsurance.SubscriberCountryEnum} subscriber_country
 */
TertiaryInsurance.prototype['subscriber_country'] = undefined;

/**
 * 
 * @member {String} subscriber_date_of_birth
 */
TertiaryInsurance.prototype['subscriber_date_of_birth'] = undefined;

/**
 * 
 * @member {String} subscriber_first_name
 */
TertiaryInsurance.prototype['subscriber_first_name'] = undefined;

/**
 * One of `\"Male\"` or `\"Female\"`
 * @member {module:model/TertiaryInsurance.SubscriberGenderEnum} subscriber_gender
 */
TertiaryInsurance.prototype['subscriber_gender'] = undefined;

/**
 * 
 * @member {String} subscriber_last_name
 */
TertiaryInsurance.prototype['subscriber_last_name'] = undefined;

/**
 * 
 * @member {String} subscriber_middle_name
 */
TertiaryInsurance.prototype['subscriber_middle_name'] = undefined;

/**
 * 
 * @member {String} subscriber_social_security
 */
TertiaryInsurance.prototype['subscriber_social_security'] = undefined;

/**
 * Two-letter state code
 * @member {module:model/TertiaryInsurance.SubscriberStateEnum} subscriber_state
 */
TertiaryInsurance.prototype['subscriber_state'] = undefined;

/**
 * E.g. `\"II\"` or `\"III\"`
 * @member {String} subscriber_suffix
 */
TertiaryInsurance.prototype['subscriber_suffix'] = undefined;

/**
 * 
 * @member {String} subscriber_zip_code
 */
TertiaryInsurance.prototype['subscriber_zip_code'] = undefined;
 ...
 * @readonly
 */
TertiaryInsurance['InsurancePlanTypeEnum'] = {
 ...
 * @readonly
 */
TertiaryInsurance['PatientRelationshipToSubscriberEnum'] = {
 ...
 * @readonly
 */
TertiaryInsurance['SubscriberCountryEnum'] = {
 ...
 * @readonly
 */
TertiaryInsurance['SubscriberGenderEnum'] = {
 ...
 * @readonly
 */
TertiaryInsurance['SubscriberStateEnum'] = {
...
export default TertiaryInsurance;
