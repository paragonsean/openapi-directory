...
/**
 * The LabOrder model module.
 * @module model/LabOrder
 * @version v4 (Hunt Valley)
 */
class LabOrder {
    /**
     * Constructs a new <code>LabOrder</code>.
     * @alias module:model/LabOrder
     * @param doctor {Number} 
     * @param patient {Number} 
     * @param sublab {Number} 
     */
    constructor(doctor, patient, sublab) { 
        
        LabOrder.initialize(this, doctor, patient, sublab);
    }
     ...
     */
    static initialize(obj, doctor, patient, sublab) { 
        obj['doctor'] = doctor;
        obj['patient'] = patient;
        obj['sublab'] = sublab;
    }
    ...
    /**
     * Constructs a <code>LabOrder</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/LabOrder} obj Optional instance to populate.
     * @return {module:model/LabOrder} The populated <code>LabOrder</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new LabOrder();
            ...
            if (data.hasOwnProperty('icd10_codes')) {
                obj['icd10_codes'] = ApiClient.convertToType(data['icd10_codes'], [ICD10Code]);
            }
            ...
            if (data.hasOwnProperty('sublab')) {
                obj['sublab'] = ApiClient.convertToType(data['sublab'], 'Number');
            }
    ...
    /**
     * Validates the JSON data with respect to <code>LabOrder</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>LabOrder</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of LabOrder.RequiredProperties) {
        ...
        if (data['icd10_codes']) { // data not null
            // ensure the json data is an array
            ...
            for (const item of data['icd10_codes']) {
                ICD10Code.validateJSON(item);
            };
        }
        // ensure the json data is a string
...
LabOrder.RequiredProperties = ["doctor", "patient", "sublab"];

/**
 * For external use only
 * @member {String} accession_number
 */
LabOrder.prototype['accession_number'] = undefined;

/**
 * 
 * @member {Number} doctor
 */
LabOrder.prototype['doctor'] = undefined;

/**
 * Associated `/lab_documents` objects
 * @member {Array.<String>} documents
 */
LabOrder.prototype['documents'] = undefined;

/**
 * ICD-10 codes of the conditions which the tests concerns.
 * @member {Array.<module:model/ICD10Code>} icd10_codes
 */
LabOrder.prototype['icd10_codes'] = undefined;

/**
 * 
 * @member {Number} id
 */
LabOrder.prototype['id'] = undefined;

/**
 * 
 * @member {String} notes
 */
LabOrder.prototype['notes'] = undefined;

/**
 * 
 * @member {Number} patient
 */
LabOrder.prototype['patient'] = undefined;

/**
 * `\"Normal\"` or `\"STAT\"`. Default `\"Normal\"`
 * @member {module:model/LabOrder.PriorityEnum} priority
 */
LabOrder.prototype['priority'] = undefined;

/**
 * The ID printed on the requisition PDF. Generally the same as id.
 * @member {String} requisition_id
 */
LabOrder.prototype['requisition_id'] = undefined;
 ...
 */
LabOrder.prototype['status'] = undefined;

/**
 * 
 * @member {Number} sublab
 */
LabOrder.prototype['sublab'] = undefined;

/**
 * Time at which the order was submitted. Defaults to now
 * @member {String} timestamp
 */
LabOrder.prototype['timestamp'] = undefined;
