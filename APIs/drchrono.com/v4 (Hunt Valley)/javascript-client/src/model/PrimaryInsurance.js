...
/**
 * The PrimaryInsurance model module.
 * @module model/PrimaryInsurance
 * @version v4 (Hunt Valley)
 */
class PrimaryInsurance {
    /**
     * Constructs a new <code>PrimaryInsurance</code>.
     ...
     * @alias module:model/PrimaryInsurance
     */
    constructor() { 
        
        PrimaryInsurance.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PrimaryInsurance</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PrimaryInsurance} obj Optional instance to populate.
     * @return {module:model/PrimaryInsurance} The populated <code>PrimaryInsurance</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PrimaryInsurance();
    ...
    /**
     * Validates the JSON data with respect to <code>PrimaryInsurance</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PrimaryInsurance</code>.
     */
 ...
 */
PrimaryInsurance.prototype['insurance_claim_office_number'] = undefined;

/**
 * 
 * @member {String} insurance_company
 */
PrimaryInsurance.prototype['insurance_company'] = undefined;

/**
 * 
 * @member {String} insurance_group_name
 */
PrimaryInsurance.prototype['insurance_group_name'] = undefined;

/**
 * 
 * @member {String} insurance_group_number
 */
PrimaryInsurance.prototype['insurance_group_number'] = undefined;

/**
 * 
 * @member {String} insurance_id_number
 */
PrimaryInsurance.prototype['insurance_id_number'] = undefined;

/**
 * 
 * @member {String} insurance_payer_id
 */
PrimaryInsurance.prototype['insurance_payer_id'] = undefined;

/**
 * Name of insurance plan.
 * @member {String} insurance_plan_name
 */
PrimaryInsurance.prototype['insurance_plan_name'] = undefined;

/**
 * 
 * @member {module:model/PrimaryInsurance.InsurancePlanTypeEnum} insurance_plan_type
 */
PrimaryInsurance.prototype['insurance_plan_type'] = undefined;

/**
 * True if the insurance policy is under patient's own name. Defaults to true
 * @member {Boolean} is_subscriber_the_patient
 */
PrimaryInsurance.prototype['is_subscriber_the_patient'] = undefined;

/**
 * HCFA/1500 individual relationship code
 * @member {module:model/PrimaryInsurance.PatientRelationshipToSubscriberEnum} patient_relationship_to_subscriber
 */
PrimaryInsurance.prototype['patient_relationship_to_subscriber'] = undefined;

/**
 * Photo of back of insurance card
 * @member {String} photo_back
 */
PrimaryInsurance.prototype['photo_back'] = undefined;

/**
 * Photo of front of insurance card
 * @member {String} photo_front
 */
PrimaryInsurance.prototype['photo_front'] = undefined;

/**
 * 
 * @member {String} subscriber_address
 */
PrimaryInsurance.prototype['subscriber_address'] = undefined;

/**
 * 
 * @member {String} subscriber_city
 */
PrimaryInsurance.prototype['subscriber_city'] = undefined;

/**
 * Two-letter country code
 * @member {module:model/PrimaryInsurance.SubscriberCountryEnum} subscriber_country
 */
PrimaryInsurance.prototype['subscriber_country'] = undefined;

/**
 * 
 * @member {String} subscriber_date_of_birth
 */
PrimaryInsurance.prototype['subscriber_date_of_birth'] = undefined;

/**
 * 
 * @member {String} subscriber_first_name
 */
PrimaryInsurance.prototype['subscriber_first_name'] = undefined;

/**
 * One of `\"Male\"` or `\"Female\"`
 * @member {module:model/PrimaryInsurance.SubscriberGenderEnum} subscriber_gender
 */
PrimaryInsurance.prototype['subscriber_gender'] = undefined;

/**
 * 
 * @member {String} subscriber_last_name
 */
PrimaryInsurance.prototype['subscriber_last_name'] = undefined;

/**
 * 
 * @member {String} subscriber_middle_name
 */
PrimaryInsurance.prototype['subscriber_middle_name'] = undefined;

/**
 * 
 * @member {String} subscriber_social_security
 */
PrimaryInsurance.prototype['subscriber_social_security'] = undefined;

/**
 * Two-letter state code
 * @member {module:model/PrimaryInsurance.SubscriberStateEnum} subscriber_state
 */
PrimaryInsurance.prototype['subscriber_state'] = undefined;

/**
 * E.g. `\"II\"` or `\"III\"`
 * @member {String} subscriber_suffix
 */
PrimaryInsurance.prototype['subscriber_suffix'] = undefined;

/**
 * 
 * @member {String} subscriber_zip_code
 */
PrimaryInsurance.prototype['subscriber_zip_code'] = undefined;
 ...
 * @readonly
 */
PrimaryInsurance['InsurancePlanTypeEnum'] = {
 ...
 * @readonly
 */
PrimaryInsurance['PatientRelationshipToSubscriberEnum'] = {
 ...
 * @readonly
 */
PrimaryInsurance['SubscriberCountryEnum'] = {
 ...
 * @readonly
 */
PrimaryInsurance['SubscriberGenderEnum'] = {
 ...
 * @readonly
 */
PrimaryInsurance['SubscriberStateEnum'] = {
