...
class Insurance {
    ...
    /**
     * Validates the JSON data with respect to <code>Insurance</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Insurance</code>.
     */
 ...
 */
Insurance.prototype['payer_id'] = undefined;

/**
 * 
 * @member {String} payer_name
 */
Insurance.prototype['payer_name'] = undefined;

/**
 * 
 * @member {String} state
 */
Insurance.prototype['state'] = undefined;
