...
class ApiClient {
     ...
     */
    constructor(basePath = 'https://app.drchrono.com') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default https://app.drchrono.com
         */
         ...
         */
        this.defaultHeaders = {
            'User-Agent': 'OpenAPI-Generator/v4 (Hunt Valley)/Javascript'
        };
