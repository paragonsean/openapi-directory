# OpenapiJsClient.SoapNoteLineItemFieldValue

## Properties

Name | Type | Description | Notes
------------ | ------------- | ------------- | -------------
**appointment** | **Number** | ID of appointment that the value applies to | 
**clinicalNoteField** | **Number** | ID of &#x60;/api/clinical_note_field_types&#x60; object that indicates type of the value | 
