# OpenapiJsClient.ClinicalNoteField
...
**archived** | **Boolean** | Indicates that the field has been soft-deleted by the doctor | [optional] 
**clinicalNoteTemplate** | **Number** |  | [optional] 
