# OpenapiJsClient.SoapNoteLineItemFieldType

## Properties

Name | Type | Description | Notes
------------ | ------------- | ------------- | -------------
**allowedValues** | **[String]** | Value options the field type relies on if applicable, otherwise it will be an empty array | [optional] 
