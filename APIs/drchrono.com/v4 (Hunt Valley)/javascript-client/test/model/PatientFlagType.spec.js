...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenapiJsClient.PatientFlagType();
  });
  ...
  describe('PatientFlagType', function() {
    it('should create an instance of PatientFlagType', function() {
      // uncomment below and update the code to test PatientFlagType
      //var instance = new OpenapiJsClient.PatientFlagType();
      //expect(instance).to.be.a(OpenapiJsClient.PatientFlagType);
    });
