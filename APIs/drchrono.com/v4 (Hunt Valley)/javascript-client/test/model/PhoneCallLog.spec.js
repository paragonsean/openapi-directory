...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenapiJsClient.PhoneCallLog();
  });
  ...
  describe('PhoneCallLog', function() {
    it('should create an instance of PhoneCallLog', function() {
      // uncomment below and update the code to test PhoneCallLog
      //var instance = new OpenapiJsClient.PhoneCallLog();
      //expect(instance).to.be.a(OpenapiJsClient.PhoneCallLog);
    });
    ...
    it('should have the property cashCharged (base name: "cash_charged")', function() {
      // uncomment below and update the code to test the property cashCharged
      //var instance = new OpenapiJsClient.PhoneCallLog();
      //expect(instance).to.be();
    });
