...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenapiJsClient.TaskNote1();
  });
  ...
  describe('TaskNote1', function() {
    it('should create an instance of TaskNote1', function() {
      // uncomment below and update the code to test TaskNote1
      //var instance = new OpenapiJsClient.TaskNote1();
      //expect(instance).to.be.a(OpenapiJsClient.TaskNote1);
    });
