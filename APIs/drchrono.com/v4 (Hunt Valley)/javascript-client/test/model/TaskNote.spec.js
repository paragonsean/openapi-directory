...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenapiJsClient.TaskNote();
  });
  ...
  describe('TaskNote', function() {
    it('should create an instance of TaskNote', function() {
      // uncomment below and update the code to test TaskNote
      //var instance = new OpenapiJsClient.TaskNote();
      //expect(instance).to.be.a(OpenapiJsClient.TaskNote);
    });
