...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenapiJsClient.PatientFlagType1();
  });
  ...
  describe('PatientFlagType1', function() {
    it('should create an instance of PatientFlagType1', function() {
      // uncomment below and update the code to test PatientFlagType1
      //var instance = new OpenapiJsClient.PatientFlagType1();
      //expect(instance).to.be.a(OpenapiJsClient.PatientFlagType1);
    });
