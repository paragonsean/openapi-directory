...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenapiJsClient.PrescriptionMessage();
  });
  ...
  describe('PrescriptionMessage', function() {
    it('should create an instance of PrescriptionMessage', function() {
      // uncomment below and update the code to test PrescriptionMessage
      //var instance = new OpenapiJsClient.PrescriptionMessage();
      //expect(instance).to.be.a(OpenapiJsClient.PrescriptionMessage);
    });
    ...
    it('should have the property messageDirection (base name: "message_direction")', function() {
      // uncomment below and update the code to test the property messageDirection
      //var instance = new OpenapiJsClient.PrescriptionMessage();
      //expect(instance).to.be();
    });

    it('should have the property messageStatus (base name: "message_status")', function() {
