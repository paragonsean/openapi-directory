...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenapiJsClient.CashPaymentLog();
  });
  ...
  describe('CashPaymentLog', function() {
    it('should create an instance of CashPaymentLog', function() {
      // uncomment below and update the code to test CashPaymentLog
      //var instance = new OpenapiJsClient.CashPaymentLog();
      //expect(instance).to.be.a(OpenapiJsClient.CashPaymentLog);
    });
