...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenapiJsClient.ScannedClinicalDocument();
  });
  ...
  describe('ScannedClinicalDocument', function() {
    it('should create an instance of ScannedClinicalDocument', function() {
      // uncomment below and update the code to test ScannedClinicalDocument
      //var instance = new OpenapiJsClient.ScannedClinicalDocument();
      //expect(instance).to.be.a(OpenapiJsClient.ScannedClinicalDocument);
    });
