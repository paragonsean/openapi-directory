...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenapiJsClient.PatientMessage();
  });
  ...
  describe('PatientMessage', function() {
    it('should create an instance of PatientMessage', function() {
      // uncomment below and update the code to test PatientMessage
      //var instance = new OpenapiJsClient.PatientMessage();
      //expect(instance).to.be.a(OpenapiJsClient.PatientMessage);
    });
