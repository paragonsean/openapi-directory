...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenapiJsClient.CustomPatientFieldType();
  });
  ...
  describe('CustomPatientFieldType', function() {
    it('should create an instance of CustomPatientFieldType', function() {
      // uncomment below and update the code to test CustomPatientFieldType
      //var instance = new OpenapiJsClient.CustomPatientFieldType();
      //expect(instance).to.be.a(OpenapiJsClient.CustomPatientFieldType);
    });
