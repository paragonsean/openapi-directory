...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenapiJsClient.ConsentForm();
  });
  ...
  describe('ConsentForm', function() {
    it('should create an instance of ConsentForm', function() {
      // uncomment below and update the code to test ConsentForm
      //var instance = new OpenapiJsClient.ConsentForm();
      //expect(instance).to.be.a(OpenapiJsClient.ConsentForm);
    });
    ...
    it('should have the property assignByDefault (base name: "assign_by_default")', function() {
      // uncomment below and update the code to test the property assignByDefault
      //var instance = new OpenapiJsClient.ConsentForm();
      //expect(instance).to.be();
    });
