...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenapiJsClient.AppointmentTemplate();
  });
  ...
  describe('AppointmentTemplate', function() {
    it('should create an instance of AppointmentTemplate', function() {
      // uncomment below and update the code to test AppointmentTemplate
      //var instance = new OpenapiJsClient.AppointmentTemplate();
      //expect(instance).to.be.a(OpenapiJsClient.AppointmentTemplate);
    });
    ...
    it('should have the property examRoom (base name: "exam_room")', function() {
      // uncomment below and update the code to test the property examRoom
      //var instance = new OpenapiJsClient.AppointmentTemplate();
      //expect(instance).to.be();
    });
