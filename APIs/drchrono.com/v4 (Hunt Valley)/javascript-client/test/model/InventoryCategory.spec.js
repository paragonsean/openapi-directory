...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenapiJsClient.InventoryCategory();
  });
  ...
  describe('InventoryCategory', function() {
    it('should create an instance of InventoryCategory', function() {
      // uncomment below and update the code to test InventoryCategory
      //var instance = new OpenapiJsClient.InventoryCategory();
      //expect(instance).to.be.a(OpenapiJsClient.InventoryCategory);
    });
