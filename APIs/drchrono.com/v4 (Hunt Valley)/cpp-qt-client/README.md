...
#include <iostream>
#include "../client/OAIAdministrativeApi.h"
...
void Example::exampleFunction1(){
     OAIAdministrativeApi apiInstance;
     
      //OAuth Authentication supported right now

      QEventLoop loop;
      connect(&apiInstance, &OAIAdministrativeApi::doctorsListSignal, [&]() {
          loop.quit();
      });
      connect(&apiInstance, &OAIAdministrativeApi::doctorsListSignalE, [&](QNetworkReply::NetworkError, QString error_str) {
          qDebug() << "Error happened while issuing request : " << error_str;
          loop.quit();
      });

      QString cursor = create(); // QString | 
      ...
      qint32 doctor = create(); // qint32 | 
      apiInstance.doctorsList(cursorpage_sizedoctor);
