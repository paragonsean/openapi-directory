...
/*
 * OAIInventoryCategory.h
 *
 * 
 */

#ifndef OAIInventoryCategory_H
#define OAIInventoryCategory_H
...
class OAIInventoryCategory : public OAIObject {
public:
    OAIInventoryCategory();
    OAIInventoryCategory(QString json);
    ~OAIInventoryCategory() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIInventoryCategory)

#endif // OAIInventoryCategory_H
