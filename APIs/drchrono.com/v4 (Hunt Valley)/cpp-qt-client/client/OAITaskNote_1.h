...
#ifndef OAITaskNote_1_H
#define OAITaskNote_1_H
...
class OAITaskNote_1 : public OAIObject {
public:
    OAITaskNote_1();
    OAITaskNote_1(QString json);
    ~OAITaskNote_1() override;
    ...
    qint32 getTask() const;
    void setTask(const qint32 &task);
...
Q_DECLARE_METATYPE(OpenAPI::OAITaskNote_1)

#endif // OAITaskNote_1_H
