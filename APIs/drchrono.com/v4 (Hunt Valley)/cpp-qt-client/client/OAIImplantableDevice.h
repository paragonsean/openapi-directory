...
/*
 * OAIImplantableDevice.h
 *
 * 
 */

#ifndef OAIImplantableDevice_H
#define OAIImplantableDevice_H
...
class OAIImplantableDevice : public OAIObject {
public:
    OAIImplantableDevice();
    OAIImplantableDevice(QString json);
    ~OAIImplantableDevice() override;
    ...
    QString getGmdnPtName() const;
    void setGmdnPtName(const QString &gmdn_pt_name);
    bool is_gmdn_pt_name_Set() const;
    bool is_gmdn_pt_name_Valid() const;
    ...
    QString getManufacturingDate() const;
    void setManufacturingDate(const QString &manufacturing_date);
    bool is_manufacturing_date_Set() const;
    bool is_manufacturing_date_Valid() const;
    ...
    QString getVersionOrModel() const;
    void setVersionOrModel(const QString &version_or_model);
    bool is_version_or_model_Set() const;
    bool is_version_or_model_Valid() const;
...
private:
    ...
    QString m_gmdn_pt_name;
    bool m_gmdn_pt_name_isSet;
    bool m_gmdn_pt_name_isValid;

    qint32 m_id;
    bool m_id_isSet;
    bool m_id_isValid;

    QString m_manufacturing_date;
    bool m_manufacturing_date_isSet;
    bool m_manufacturing_date_isValid;
    ...
    QString m_version_or_model;
    bool m_version_or_model_isSet;
    bool m_version_or_model_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIImplantableDevice)

#endif // OAIImplantableDevice_H
