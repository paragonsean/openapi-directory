...
/*
 * OAICustomPatientFieldType.h
 *
 * 
 */

#ifndef OAICustomPatientFieldType_H
#define OAICustomPatientFieldType_H
...
class OAICustomPatientFieldType : public OAIObject {
public:
    OAICustomPatientFieldType();
    OAICustomPatientFieldType(QString json);
    ~OAICustomPatientFieldType() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICustomPatientFieldType)

#endif // OAICustomPatientFieldType_H
