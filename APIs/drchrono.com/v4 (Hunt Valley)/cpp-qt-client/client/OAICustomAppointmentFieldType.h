...
/*
 * OAICustomAppointmentFieldType.h
 *
 * 
 */

#ifndef OAICustomAppointmentFieldType_H
#define OAICustomAppointmentFieldType_H
...
class OAICustomAppointmentFieldType : public OAIObject {
public:
    OAICustomAppointmentFieldType();
    OAICustomAppointmentFieldType(QString json);
    ~OAICustomAppointmentFieldType() override;
    ...
    QString getFieldDesc() const;
    void setFieldDesc(const QString &field_desc);
    bool is_field_desc_Set() const;
    bool is_field_desc_Valid() const;
...
private:
    ...
    QString m_field_desc;
    bool m_field_desc_isSet;
    bool m_field_desc_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAICustomAppointmentFieldType)

#endif // OAICustomAppointmentFieldType_H
