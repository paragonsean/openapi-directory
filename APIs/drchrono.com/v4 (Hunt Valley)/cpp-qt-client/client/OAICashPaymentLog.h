...
#ifndef OAICashPaymentLog_H
#define OAICashPaymentLog_H
...
class OAICashPaymentLog : public OAIObject {
public:
    OAICashPaymentLog();
    OAICashPaymentLog(QString json);
    ~OAICashPaymentLog() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICashPaymentLog)

#endif // OAICashPaymentLog_H
