...
#ifndef OAICarePlan_H
#define OAICarePlan_H
...
class OAICarePlan : public OAIObject {
public:
    OAICarePlan();
    OAICarePlan(QString json);
    ~OAICarePlan() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICarePlan)
