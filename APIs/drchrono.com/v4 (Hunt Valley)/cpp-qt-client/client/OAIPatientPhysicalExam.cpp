...
OAIPatientPhysicalExam::OAIPatientPhysicalExam(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPatientPhysicalExam::OAIPatientPhysicalExam() {
    this->initializeModel();
}

OAIPatientPhysicalExam::~OAIPatientPhysicalExam() {}

void OAIPatientPhysicalExam::initializeModel() {
...
void OAIPatientPhysicalExam::fromJson(QString jsonString) {
...
void OAIPatientPhysicalExam::fromJsonObject(QJsonObject json) {
...
QString OAIPatientPhysicalExam::asJson() const {
...
QJsonObject OAIPatientPhysicalExam::asJsonObject() const {
    QJsonObject obj;
    if (m_code_isSet) {
...
QString OAIPatientPhysicalExam::getCode() const {
    return m_code;
}
void OAIPatientPhysicalExam::setCode(const QString &code) {
    m_code = code;
    m_code_isSet = true;
}

bool OAIPatientPhysicalExam::is_code_Set() const{
    return m_code_isSet;
}

bool OAIPatientPhysicalExam::is_code_Valid() const{
    return m_code_isValid;
}

QString OAIPatientPhysicalExam::getCodeSystem() const {
    return m_code_system;
}
void OAIPatientPhysicalExam::setCodeSystem(const QString &code_system) {
    m_code_system = code_system;
    m_code_system_isSet = true;
}

bool OAIPatientPhysicalExam::is_code_system_Set() const{
    return m_code_system_isSet;
}

bool OAIPatientPhysicalExam::is_code_system_Valid() const{
    return m_code_system_isValid;
}

QString OAIPatientPhysicalExam::getCreatedAt() const {
    return m_created_at;
}
void OAIPatientPhysicalExam::setCreatedAt(const QString &created_at) {
    m_created_at = created_at;
    m_created_at_isSet = true;
}

bool OAIPatientPhysicalExam::is_created_at_Set() const{
    return m_created_at_isSet;
}

bool OAIPatientPhysicalExam::is_created_at_Valid() const{
    return m_created_at_isValid;
}

qint32 OAIPatientPhysicalExam::getDoctor() const {
    return m_doctor;
}
void OAIPatientPhysicalExam::setDoctor(const qint32 &doctor) {
    m_doctor = doctor;
    m_doctor_isSet = true;
}

bool OAIPatientPhysicalExam::is_doctor_Set() const{
    return m_doctor_isSet;
}

bool OAIPatientPhysicalExam::is_doctor_Valid() const{
    return m_doctor_isValid;
}

QString OAIPatientPhysicalExam::getEffectiveTime() const {
    return m_effective_time;
}
void OAIPatientPhysicalExam::setEffectiveTime(const QString &effective_time) {
    m_effective_time = effective_time;
    m_effective_time_isSet = true;
}

bool OAIPatientPhysicalExam::is_effective_time_Set() const{
    return m_effective_time_isSet;
}

bool OAIPatientPhysicalExam::is_effective_time_Valid() const{
    return m_effective_time_isValid;
}

qint32 OAIPatientPhysicalExam::getId() const {
    return m_id;
}
void OAIPatientPhysicalExam::setId(const qint32 &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIPatientPhysicalExam::is_id_Set() const{
    return m_id_isSet;
}

bool OAIPatientPhysicalExam::is_id_Valid() const{
    return m_id_isValid;
}

QString OAIPatientPhysicalExam::getName() const {
    return m_name;
}
void OAIPatientPhysicalExam::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIPatientPhysicalExam::is_name_Set() const{
    return m_name_isSet;
}

bool OAIPatientPhysicalExam::is_name_Valid() const{
    return m_name_isValid;
}

qint32 OAIPatientPhysicalExam::getPatient() const {
    return m_patient;
}
void OAIPatientPhysicalExam::setPatient(const qint32 &patient) {
    m_patient = patient;
    m_patient_isSet = true;
}

bool OAIPatientPhysicalExam::is_patient_Set() const{
    return m_patient_isSet;
}

bool OAIPatientPhysicalExam::is_patient_Valid() const{
    return m_patient_isValid;
}

QString OAIPatientPhysicalExam::getValueCode() const {
    return m_value_code;
}
void OAIPatientPhysicalExam::setValueCode(const QString &value_code) {
    m_value_code = value_code;
    m_value_code_isSet = true;
}

bool OAIPatientPhysicalExam::is_value_code_Set() const{
    return m_value_code_isSet;
}

bool OAIPatientPhysicalExam::is_value_code_Valid() const{
    return m_value_code_isValid;
}

QString OAIPatientPhysicalExam::getValueCodeSystem() const {
    return m_value_code_system;
}
void OAIPatientPhysicalExam::setValueCodeSystem(const QString &value_code_system) {
    m_value_code_system = value_code_system;
    m_value_code_system_isSet = true;
}

bool OAIPatientPhysicalExam::is_value_code_system_Set() const{
    return m_value_code_system_isSet;
}

bool OAIPatientPhysicalExam::is_value_code_system_Valid() const{
    return m_value_code_system_isValid;
}

QString OAIPatientPhysicalExam::getValueName() const {
    return m_value_name;
}
void OAIPatientPhysicalExam::setValueName(const QString &value_name) {
    m_value_name = value_name;
    m_value_name_isSet = true;
}

bool OAIPatientPhysicalExam::is_value_name_Set() const{
    return m_value_name_isSet;
}

bool OAIPatientPhysicalExam::is_value_name_Valid() const{
    return m_value_name_isValid;
}

bool OAIPatientPhysicalExam::isSet() const {
...
bool OAIPatientPhysicalExam::isValid() const {
