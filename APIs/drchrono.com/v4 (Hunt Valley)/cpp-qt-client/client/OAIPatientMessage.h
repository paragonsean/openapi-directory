...
#ifndef OAIPatientMessage_H
#define OAIPatientMessage_H
...
namespace OpenAPI {
class OAIPatientMessageAttachment;

class OAIPatientMessage : public OAIObject {
public:
    OAIPatientMessage();
    OAIPatientMessage(QString json);
    ~OAIPatientMessage() override;
    ...
    QList<OAIPatientMessageAttachment> getAttachments() const;
    void setAttachments(const QList<OAIPatientMessageAttachment> &attachments);
...
private:
    ...
    QList<OAIPatientMessageAttachment> m_attachments;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPatientMessage)

#endif // OAIPatientMessage_H
