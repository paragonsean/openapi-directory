...
/*
 * OAIClinical_Note_Field.h
 *
 * Array of field objects
 */

#ifndef OAIClinical_Note_Field_H
#define OAIClinical_Note_Field_H
...
class OAIClinical_Note_Field : public OAIObject {
public:
    OAIClinical_Note_Field();
    OAIClinical_Note_Field(QString json);
    ~OAIClinical_Note_Field() override;
    ...
    qint32 getClinicalNoteTemplate() const;
    void setClinicalNoteTemplate(const qint32 &clinical_note_template);
...
private:
    ...
    qint32 m_clinical_note_template;
...
Q_DECLARE_METATYPE(OpenAPI::OAIClinical_Note_Field)

#endif // OAIClinical_Note_Field_H
