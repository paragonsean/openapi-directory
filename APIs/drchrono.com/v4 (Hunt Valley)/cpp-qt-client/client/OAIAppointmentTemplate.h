...
#ifndef OAIAppointmentTemplate_H
#define OAIAppointmentTemplate_H

#include <QJsonObject>

#include "OAIOpen_Slot.h"
#include <QList>
#include <QString>
...
class OAIAppointmentTemplate : public OAIObject {
public:
    OAIAppointmentTemplate();
    OAIAppointmentTemplate(QString json);
    ~OAIAppointmentTemplate() override;
    ...
    QList<OAIOpen_Slot> getOpenSlots() const;
    void setOpenSlots(const QList<OAIOpen_Slot> &open_slots);
    ...
    QList<qint32> getWeekDays() const;
    void setWeekDays(const QList<qint32> &week_days);
...
private:
    ...
    QList<OAIOpen_Slot> m_open_slots;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAppointmentTemplate)

#endif // OAIAppointmentTemplate_H
