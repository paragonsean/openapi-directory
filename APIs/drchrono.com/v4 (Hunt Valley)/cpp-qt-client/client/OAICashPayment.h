...
#ifndef OAICashPayment_H
#define OAICashPayment_H
...
class OAICashPayment : public OAIObject {
public:
    OAICashPayment();
    OAICashPayment(QString json);
    ~OAICashPayment() override;
    ...
    QString getPaymentTransactionType() const;
    void setPaymentTransactionType(const QString &payment_transaction_type);
    bool is_payment_transaction_type_Set() const;
    bool is_payment_transaction_type_Valid() const;
    ...
    QString getReceivedDate() const;
    void setReceivedDate(const QString &received_date);
...
private:
    ...
    QString m_payment_transaction_type;
    bool m_payment_transaction_type_isSet;
    bool m_payment_transaction_type_isValid;

    QString m_posted_date;
    bool m_posted_date_isSet;
    bool m_posted_date_isValid;

    QString m_received_date;
...
Q_DECLARE_METATYPE(OpenAPI::OAICashPayment)

#endif // OAICashPayment_H
