...
/*
 * OAIScannedClinicalDocument.h
 *
 * 
 */

#ifndef OAIScannedClinicalDocument_H
#define OAIScannedClinicalDocument_H
...
class OAIScannedClinicalDocument : public OAIObject {
public:
    OAIScannedClinicalDocument();
    OAIScannedClinicalDocument(QString json);
    ~OAIScannedClinicalDocument() override;
    ...
    QString getMetatags() const;
    void setMetatags(const QString &metatags);
...
Q_DECLARE_METATYPE(OpenAPI::OAIScannedClinicalDocument)

#endif // OAIScannedClinicalDocument_H
