...
#ifndef OAITaskNote_H
#define OAITaskNote_H
...
class OAITaskNote : public OAIObject {
public:
    OAITaskNote();
    OAITaskNote(QString json);
    ~OAITaskNote() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITaskNote)
