...
/*
 * OAIPatientFlagType.h
 *
 * 
 */

#ifndef OAIPatientFlagType_H
#define OAIPatientFlagType_H
...
class OAIPatientFlagType : public OAIObject {
public:
    OAIPatientFlagType();
    OAIPatientFlagType(QString json);
    ~OAIPatientFlagType() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPatientFlagType)

#endif // OAIPatientFlagType_H
