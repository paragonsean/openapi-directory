...
#ifndef OAIPhoneCallLog_H
#define OAIPhoneCallLog_H
...
class OAIPhoneCallLog : public OAIObject {
public:
    OAIPhoneCallLog();
    OAIPhoneCallLog(QString json);
    ~OAIPhoneCallLog() override;
    ...
    double getCashCharged() const;
    void setCashCharged(const double &cash_charged);
    bool is_cash_charged_Set() const;
    bool is_cash_charged_Valid() const;
...
private:
    ...
    double m_cash_charged;
    bool m_cash_charged_isSet;
    bool m_cash_charged_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPhoneCallLog)

#endif // OAIPhoneCallLog_H
