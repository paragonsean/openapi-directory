...
#ifndef OAIConsentForm_H
#define OAIConsentForm_H
...
class OAIConsentForm : public OAIObject {
public:
    OAIConsentForm();
    OAIConsentForm(QString json);
    ~OAIConsentForm() override;
    ...
    bool isAssignByDefault() const;
    void setAssignByDefault(const bool &assign_by_default);
    bool is_assign_by_default_Set() const;
    bool is_assign_by_default_Valid() const;
...
private:
    ...
    bool m_assign_by_default;
    bool m_assign_by_default_isSet;
    bool m_assign_by_default_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIConsentForm)

#endif // OAIConsentForm_H
