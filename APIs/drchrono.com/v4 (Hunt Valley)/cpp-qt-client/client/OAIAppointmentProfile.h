...
#ifndef OAIAppointmentProfile_H
#define OAIAppointmentProfile_H
...
class OAIAppointmentProfile : public OAIObject {
public:
    OAIAppointmentProfile();
    OAIAppointmentProfile(QString json);
    ~OAIAppointmentProfile() override;
    ...
    bool isOnlineScheduling() const;
    void setOnlineScheduling(const bool &online_scheduling);
    bool is_online_scheduling_Set() const;
    bool is_online_scheduling_Valid() const;
...
private:
    ...
    bool m_online_scheduling;
    bool m_online_scheduling_isSet;
    bool m_online_scheduling_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAppointmentProfile)

#endif // OAIAppointmentProfile_H
