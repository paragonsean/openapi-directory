...
#include <iostream>
#include "../client/OAILanguageModelDirectAccessApi.h"
...
void Example::exampleFunction1(){
     OAILanguageModelDirectAccessApi apiInstance;
     
      QEventLoop loop;
      connect(&apiInstance, &OAILanguageModelDirectAccessApi::getFamilyDetailsSignal, [&]() {
          loop.quit();
      });
      connect(&apiInstance, &OAILanguageModelDirectAccessApi::getFamilyDetailsSignalE, [&](QNetworkReply::NetworkError, QString error_str) {
          qDebug() << "Error happened while issuing request : " << error_str;
          loop.quit();
      });

      QString id = create(); // QString | (Required) a numeric identifier of the family
      ...
      QString ocp_apim_subscription_key = create(); // QString | {{apiKeyDescription}}
      apiInstance.getFamilyDetails(idocp_apim_subscription_key);
