...
#include "OAIGetFamilyDetails_200_response.h"
...
OAIGetFamilyDetails_200_response::OAIGetFamilyDetails_200_response(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetFamilyDetails_200_response::OAIGetFamilyDetails_200_response() {
    this->initializeModel();
}

OAIGetFamilyDetails_200_response::~OAIGetFamilyDetails_200_response() {}

void OAIGetFamilyDetails_200_response::initializeModel() {
    ...
    m_hypernyms_isSet = false;
    m_hypernyms_isValid = false;
    ...
    m_wikidata_isSet = false;
    m_wikidata_isValid = false;

    m_wordnet30_isSet = false;
    m_wordnet30_isValid = false;
}

void OAIGetFamilyDetails_200_response::fromJson(QString jsonString) {
...
void OAIGetFamilyDetails_200_response::fromJsonObject(QJsonObject json) {
    ...
    if(json["hypernyms"].isArray()){
        auto arr = json["hypernyms"].toArray();
        m_hypernyms_isValid = true;
        if(arr.count() > 0) {
            for (const QJsonValue jval : arr) {
                QList<double> item;
                m_hypernyms_isValid &= ::OpenAPI::fromJsonValue(item, jval);
                m_hypernyms_isSet = !jval.isNull() && m_hypernyms_isValid;
                m_hypernyms.push_back(item);
            }
        }
    }
    ...
    m_wikidata_isValid = ::OpenAPI::fromJsonValue(m_wikidata, json[QString("wikidata")]);
    m_wikidata_isSet = !json[QString("wikidata")].isNull() && m_wikidata_isValid;

    m_wordnet30_isValid = ::OpenAPI::fromJsonValue(m_wordnet30, json[QString("wordnet30")]);
    m_wordnet30_isSet = !json[QString("wordnet30")].isNull() && m_wordnet30_isValid;
}

QString OAIGetFamilyDetails_200_response::asJson() const {
...
QJsonObject OAIGetFamilyDetails_200_response::asJsonObject() const {
    QJsonObject obj;
    ...
    if (m_hypernyms.size() > 0) {
        
        obj.insert(QString("hypernyms"), toJsonValue(m_hypernyms));
    }
    if (m_perm_id_isSet) {
    ...
    if (m_wikidata_isSet) {
        obj.insert(QString("wikidata"), ::OpenAPI::toJsonValue(m_wikidata));
    }
    if (m_wordnet30_isSet) {
        obj.insert(QString("wordnet30"), ::OpenAPI::toJsonValue(m_wordnet30));
    }
    return obj;
}

QString OAIGetFamilyDetails_200_response::getDefinition() const {
    return m_definition;
}
void OAIGetFamilyDetails_200_response::setDefinition(const QString &definition) {
    m_definition = definition;
    m_definition_isSet = true;
}

bool OAIGetFamilyDetails_200_response::is_definition_Set() const{
    return m_definition_isSet;
}

bool OAIGetFamilyDetails_200_response::is_definition_Valid() const{
    return m_definition_isValid;
}

QString OAIGetFamilyDetails_200_response::getDescription() const {
    return m_description;
}
void OAIGetFamilyDetails_200_response::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAIGetFamilyDetails_200_response::is_description_Set() const{
    return m_description_isSet;
}

bool OAIGetFamilyDetails_200_response::is_description_Valid() const{
    return m_description_isValid;
}

QList<QList<double>> OAIGetFamilyDetails_200_response::getHypernyms() const {
    return m_hypernyms;
}
void OAIGetFamilyDetails_200_response::setHypernyms(const QList<QList<double>> &hypernyms) {
    m_hypernyms = hypernyms;
    m_hypernyms_isSet = true;
}

bool OAIGetFamilyDetails_200_response::is_hypernyms_Set() const{
    return m_hypernyms_isSet;
}

bool OAIGetFamilyDetails_200_response::is_hypernyms_Valid() const{
    return m_hypernyms_isValid;
}

QString OAIGetFamilyDetails_200_response::getPermId() const {
    return m_perm_id;
}
void OAIGetFamilyDetails_200_response::setPermId(const QString &perm_id) {
    m_perm_id = perm_id;
    m_perm_id_isSet = true;
}

bool OAIGetFamilyDetails_200_response::is_perm_id_Set() const{
    return m_perm_id_isSet;
}

bool OAIGetFamilyDetails_200_response::is_perm_id_Valid() const{
    return m_perm_id_isValid;
}

QString OAIGetFamilyDetails_200_response::getRequestId() const {
    return m_request_id;
}
void OAIGetFamilyDetails_200_response::setRequestId(const QString &request_id) {
    m_request_id = request_id;
    m_request_id_isSet = true;
}

bool OAIGetFamilyDetails_200_response::is_request_id_Set() const{
    return m_request_id_isSet;
}

bool OAIGetFamilyDetails_200_response::is_request_id_Valid() const{
    return m_request_id_isValid;
}

QString OAIGetFamilyDetails_200_response::getWikidata() const {
    return m_wikidata;
}
void OAIGetFamilyDetails_200_response::setWikidata(const QString &wikidata) {
    m_wikidata = wikidata;
    m_wikidata_isSet = true;
}

bool OAIGetFamilyDetails_200_response::is_wikidata_Set() const{
    return m_wikidata_isSet;
}

bool OAIGetFamilyDetails_200_response::is_wikidata_Valid() const{
    return m_wikidata_isValid;
}

QString OAIGetFamilyDetails_200_response::getWordnet30() const {
    return m_wordnet30;
}
void OAIGetFamilyDetails_200_response::setWordnet30(const QString &wordnet30) {
    m_wordnet30 = wordnet30;
    m_wordnet30_isSet = true;
}

bool OAIGetFamilyDetails_200_response::is_wordnet30_Set() const{
    return m_wordnet30_isSet;
}

bool OAIGetFamilyDetails_200_response::is_wordnet30_Valid() const{
    return m_wordnet30_isValid;
}

bool OAIGetFamilyDetails_200_response::isSet() const {
...
bool OAIGetFamilyDetails_200_response::isValid() const {
