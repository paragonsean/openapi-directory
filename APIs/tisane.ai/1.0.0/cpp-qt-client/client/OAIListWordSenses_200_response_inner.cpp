...
#include "OAIListWordSenses_200_response_inner.h"
...
OAIListWordSenses_200_response_inner::OAIListWordSenses_200_response_inner(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListWordSenses_200_response_inner::OAIListWordSenses_200_response_inner() {
    this->initializeModel();
}

OAIListWordSenses_200_response_inner::~OAIListWordSenses_200_response_inner() {}

void OAIListWordSenses_200_response_inner::initializeModel() {
    ...
    m_is_lemma_isSet = false;
    m_is_lemma_isValid = false;

    m_legacy_map_id_isSet = false;
    m_legacy_map_id_isValid = false;

    m_lemma_isSet = false;
    m_lemma_isValid = false;

    m_lexeme_id_isSet = false;
    m_lexeme_id_isValid = false;
}

void OAIListWordSenses_200_response_inner::fromJson(QString jsonString) {
...
void OAIListWordSenses_200_response_inner::fromJsonObject(QJsonObject json) {
    ...
    m_is_lemma_isValid = ::OpenAPI::fromJsonValue(m_is_lemma, json[QString("isLemma")]);
    m_is_lemma_isSet = !json[QString("isLemma")].isNull() && m_is_lemma_isValid;

    m_legacy_map_id_isValid = ::OpenAPI::fromJsonValue(m_legacy_map_id, json[QString("legacyMapId")]);
    m_legacy_map_id_isSet = !json[QString("legacyMapId")].isNull() && m_legacy_map_id_isValid;

    m_lemma_isValid = ::OpenAPI::fromJsonValue(m_lemma, json[QString("lemma")]);
    m_lemma_isSet = !json[QString("lemma")].isNull() && m_lemma_isValid;

    m_lexeme_id_isValid = ::OpenAPI::fromJsonValue(m_lexeme_id, json[QString("lexemeId")]);
    m_lexeme_id_isSet = !json[QString("lexemeId")].isNull() && m_lexeme_id_isValid;
}

QString OAIListWordSenses_200_response_inner::asJson() const {
...
QJsonObject OAIListWordSenses_200_response_inner::asJsonObject() const {
    QJsonObject obj;
    ...
    if (m_is_lemma_isSet) {
        obj.insert(QString("isLemma"), ::OpenAPI::toJsonValue(m_is_lemma));
    }
    if (m_legacy_map_id_isSet) {
        obj.insert(QString("legacyMapId"), ::OpenAPI::toJsonValue(m_legacy_map_id));
    }
    if (m_lemma_isSet) {
        obj.insert(QString("lemma"), ::OpenAPI::toJsonValue(m_lemma));
    }
    if (m_lexeme_id_isSet) {
        obj.insert(QString("lexemeId"), ::OpenAPI::toJsonValue(m_lexeme_id));
    }
    return obj;
}

QList<OAIListWordSenses_200_response_inner_families_inner> OAIListWordSenses_200_response_inner::getFamilies() const {
    return m_families;
}
void OAIListWordSenses_200_response_inner::setFamilies(const QList<OAIListWordSenses_200_response_inner_families_inner> &families) {
    m_families = families;
    m_families_isSet = true;
}

bool OAIListWordSenses_200_response_inner::is_families_Set() const{
    return m_families_isSet;
}

bool OAIListWordSenses_200_response_inner::is_families_Valid() const{
    return m_families_isValid;
}

QList<OAIListWordSenses_200_response_inner_features_inner> OAIListWordSenses_200_response_inner::getFeatures() const {
    return m_features;
}
void OAIListWordSenses_200_response_inner::setFeatures(const QList<OAIListWordSenses_200_response_inner_features_inner> &features) {
    m_features = features;
    m_features_isSet = true;
}

bool OAIListWordSenses_200_response_inner::is_features_Set() const{
    return m_features_isSet;
}

bool OAIListWordSenses_200_response_inner::is_features_Valid() const{
    return m_features_isValid;
}

double OAIListWordSenses_200_response_inner::getFrequency() const {
    return m_frequency;
}
void OAIListWordSenses_200_response_inner::setFrequency(const double &frequency) {
    m_frequency = frequency;
    m_frequency_isSet = true;
}

bool OAIListWordSenses_200_response_inner::is_frequency_Set() const{
    return m_frequency_isSet;
}

bool OAIListWordSenses_200_response_inner::is_frequency_Valid() const{
    return m_frequency_isValid;
}

bool OAIListWordSenses_200_response_inner::isIsLemma() const {
    return m_is_lemma;
}
void OAIListWordSenses_200_response_inner::setIsLemma(const bool &is_lemma) {
    m_is_lemma = is_lemma;
    m_is_lemma_isSet = true;
}

bool OAIListWordSenses_200_response_inner::is_is_lemma_Set() const{
    return m_is_lemma_isSet;
}

bool OAIListWordSenses_200_response_inner::is_is_lemma_Valid() const{
    return m_is_lemma_isValid;
}

double OAIListWordSenses_200_response_inner::getLegacyMapId() const {
    return m_legacy_map_id;
}
void OAIListWordSenses_200_response_inner::setLegacyMapId(const double &legacy_map_id) {
    m_legacy_map_id = legacy_map_id;
    m_legacy_map_id_isSet = true;
}

bool OAIListWordSenses_200_response_inner::is_legacy_map_id_Set() const{
    return m_legacy_map_id_isSet;
}

bool OAIListWordSenses_200_response_inner::is_legacy_map_id_Valid() const{
    return m_legacy_map_id_isValid;
}

QString OAIListWordSenses_200_response_inner::getLemma() const {
    return m_lemma;
}
void OAIListWordSenses_200_response_inner::setLemma(const QString &lemma) {
    m_lemma = lemma;
    m_lemma_isSet = true;
}

bool OAIListWordSenses_200_response_inner::is_lemma_Set() const{
    return m_lemma_isSet;
}

bool OAIListWordSenses_200_response_inner::is_lemma_Valid() const{
    return m_lemma_isValid;
}

double OAIListWordSenses_200_response_inner::getLexemeId() const {
    return m_lexeme_id;
}
void OAIListWordSenses_200_response_inner::setLexemeId(const double &lexeme_id) {
    m_lexeme_id = lexeme_id;
    m_lexeme_id_isSet = true;
}

bool OAIListWordSenses_200_response_inner::is_lexeme_id_Set() const{
    return m_lexeme_id_isSet;
}

bool OAIListWordSenses_200_response_inner::is_lexeme_id_Valid() const{
    return m_lexeme_id_isValid;
}

bool OAIListWordSenses_200_response_inner::isSet() const {
...
bool OAIListWordSenses_200_response_inner::isValid() const {
