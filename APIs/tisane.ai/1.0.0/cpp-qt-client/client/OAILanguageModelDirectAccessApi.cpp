...
#include "OAILanguageModelDirectAccessApi.h"
...
OAILanguageModelDirectAccessApi::OAILanguageModelDirectAccessApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAILanguageModelDirectAccessApi::~OAILanguageModelDirectAccessApi() {
}

void OAILanguageModelDirectAccessApi::initializeServerConfigs() {
    //Default server
    QList<OAIServerConfiguration> defaultConf = QList<OAIServerConfiguration>();
    //varying endpoint server
    defaultConf.append(OAIServerConfiguration(
    QUrl("https://api.tisane.ai"),
    "No description provided",
    QMap<QString, OAIServerVariable>()));
    _serverConfigs.insert("getFamilyDetails", defaultConf);
    _serverIndices.insert("getFamilyDetails", 0);
    _serverConfigs.insert("listFeatureValues", defaultConf);
    _serverIndices.insert("listFeatureValues", 0);
    _serverConfigs.insert("listHypernyms", defaultConf);
    _serverIndices.insert("listHypernyms", 0);
    _serverConfigs.insert("listHyponyms", defaultConf);
    _serverIndices.insert("listHyponyms", 0);
    _serverConfigs.insert("listInflectedForms", defaultConf);
    _serverIndices.insert("listInflectedForms", 0);
    _serverConfigs.insert("listWordSenses", defaultConf);
    _serverIndices.insert("listWordSenses", 0);
}
...
*/
int OAILanguageModelDirectAccessApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAILanguageModelDirectAccessApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAILanguageModelDirectAccessApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAILanguageModelDirectAccessApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAILanguageModelDirectAccessApi::setUsername(const QString &username) {
    _username = username;
}

void OAILanguageModelDirectAccessApi::setPassword(const QString &password) {
    _password = password;
}


void OAILanguageModelDirectAccessApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAILanguageModelDirectAccessApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAILanguageModelDirectAccessApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAILanguageModelDirectAccessApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAILanguageModelDirectAccessApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAILanguageModelDirectAccessApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAILanguageModelDirectAccessApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAILanguageModelDirectAccessApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAILanguageModelDirectAccessApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAILanguageModelDirectAccessApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAILanguageModelDirectAccessApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAILanguageModelDirectAccessApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAILanguageModelDirectAccessApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAILanguageModelDirectAccessApi::getFamilyDetails(const ::OpenAPI::OptionalParam<QString> &id, const ::OpenAPI::OptionalParam<QString> &ocp_apim_subscription_key) {
    QString fullPath = QString(_serverConfigs["getFamilyDetails"][_serverIndices.value("getFamilyDetails")].URL()+"/lm/family");
    ...
    if (ocp_apim_subscription_key.hasValue())
    {
        if (!::OpenAPI::toStringValue(ocp_apim_subscription_key.value()).isEmpty()) {
            input.headers.insert("Ocp-Apim-Subscription-Key", ::OpenAPI::toStringValue(ocp_apim_subscription_key.value()));
        }
        }
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAILanguageModelDirectAccessApi::getFamilyDetailsCallback);
    connect(this, &OAILanguageModelDirectAccessApi::abortRequestsSignal, worker, &QObject::deleteLater);
...
void OAILanguageModelDirectAccessApi::getFamilyDetailsCallback(OAIHttpRequestWorker *worker) {
    ...
    OAIGetFamilyDetails_200_response output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT getFamilyDetailsSignal(output);
        Q_EMIT getFamilyDetailsSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT getFamilyDetailsSignalE(output, error_type, error_str);
        Q_EMIT getFamilyDetailsSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT getFamilyDetailsSignalError(output, error_type, error_str);
        Q_EMIT getFamilyDetailsSignalErrorFull(worker, error_type, error_str);
    }
}

void OAILanguageModelDirectAccessApi::listFeatureValues(const ::OpenAPI::OptionalParam<QString> &language, const ::OpenAPI::OptionalParam<QString> &type, const ::OpenAPI::OptionalParam<QString> &description, const ::OpenAPI::OptionalParam<QString> &ocp_apim_subscription_key) {
    QString fullPath = QString(_serverConfigs["listFeatureValues"][_serverIndices.value("listFeatureValues")].URL()+"/values");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAILanguageModelDirectAccessApi::listFeatureValuesCallback);
    connect(this, &OAILanguageModelDirectAccessApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAILanguageModelDirectAccessApi::listFeatureValuesCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT listFeatureValuesSignal(output);
        Q_EMIT listFeatureValuesSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT listFeatureValuesSignalE(output, error_type, error_str);
        Q_EMIT listFeatureValuesSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT listFeatureValuesSignalError(output, error_type, error_str);
        Q_EMIT listFeatureValuesSignalErrorFull(worker, error_type, error_str);
    }
}

void OAILanguageModelDirectAccessApi::listHypernyms(const ::OpenAPI::OptionalParam<QString> &family, const ::OpenAPI::OptionalParam<QString> &max_level, const ::OpenAPI::OptionalParam<QString> &ocp_apim_subscription_key) {
    QString fullPath = QString(_serverConfigs["listHypernyms"][_serverIndices.value("listHypernyms")].URL()+"/hypernyms");
    ...
    if (max_level.hasValue())
    {
        ...
        queryPrefix = getParamStylePrefix(queryStyle);
        querySuffix = getParamStyleSuffix(queryStyle);
        queryDelimiter = getParamStyleDelimiter(queryStyle, "maxLevel", true);
        if (fullPath.indexOf("?") > 0)
            fullPath.append(queryPrefix);
        else
            fullPath.append("?");

        fullPath.append(QUrl::toPercentEncoding("maxLevel")).append(querySuffix).append(QUrl::toPercentEncoding(max_level.stringValue()));
    }
    OAIHttpRequestWorker *worker = new OAIHttpRequestWorker(this, _manager);
    worker->setTimeOut(_timeOut);
    worker->setWorkingDirectory(_workingDirectory);
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAILanguageModelDirectAccessApi::listHypernymsCallback);
    connect(this, &OAILanguageModelDirectAccessApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAILanguageModelDirectAccessApi::listHypernymsCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    QList<QList<OAIListHypernyms_200_response_inner_inner>> output;
    QString json(worker->response);
    QByteArray array(json.toStdString().c_str());
    QJsonDocument doc = QJsonDocument::fromJson(array);
    QJsonArray jsonArray = doc.array();
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT listHypernymsSignal(output);
        Q_EMIT listHypernymsSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT listHypernymsSignalE(output, error_type, error_str);
        Q_EMIT listHypernymsSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT listHypernymsSignalError(output, error_type, error_str);
        Q_EMIT listHypernymsSignalErrorFull(worker, error_type, error_str);
    }
}

void OAILanguageModelDirectAccessApi::listHyponyms(const ::OpenAPI::OptionalParam<QString> &family, const ::OpenAPI::OptionalParam<QString> &max_level, const ::OpenAPI::OptionalParam<QString> &ocp_apim_subscription_key) {
    QString fullPath = QString(_serverConfigs["listHyponyms"][_serverIndices.value("listHyponyms")].URL()+"/hyponyms");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAILanguageModelDirectAccessApi::listHyponymsCallback);
    connect(this, &OAILanguageModelDirectAccessApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAILanguageModelDirectAccessApi::listHyponymsCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT listHyponymsSignal();
        Q_EMIT listHyponymsSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT listHyponymsSignalE(error_type, error_str);
        Q_EMIT listHyponymsSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT listHyponymsSignalError(error_type, error_str);
        Q_EMIT listHyponymsSignalErrorFull(worker, error_type, error_str);
    }
}

void OAILanguageModelDirectAccessApi::listInflectedForms(const ::OpenAPI::OptionalParam<QString> &language, const ::OpenAPI::OptionalParam<QString> &lexeme, const ::OpenAPI::OptionalParam<QString> &family, const ::OpenAPI::OptionalParam<QString> &ocp_apim_subscription_key) {
    QString fullPath = QString(_serverConfigs["listInflectedForms"][_serverIndices.value("listInflectedForms")].URL()+"/inflections");
    ...
    if (lexeme.hasValue())
    {
        ...
        queryPrefix = getParamStylePrefix(queryStyle);
        querySuffix = getParamStyleSuffix(queryStyle);
        queryDelimiter = getParamStyleDelimiter(queryStyle, "lexeme", true);
        if (fullPath.indexOf("?") > 0)
            fullPath.append(queryPrefix);
        else
            fullPath.append("?");

        fullPath.append(QUrl::toPercentEncoding("lexeme")).append(querySuffix).append(QUrl::toPercentEncoding(lexeme.stringValue()));
    }
    if (family.hasValue())
    {
        queryStyle = "form";
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAILanguageModelDirectAccessApi::listInflectedFormsCallback);
    connect(this, &OAILanguageModelDirectAccessApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAILanguageModelDirectAccessApi::listInflectedFormsCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    QList<OAIListInflectedForms_200_response_inner> output;
    QString json(worker->response);
    QByteArray array(json.toStdString().c_str());
    QJsonDocument doc = QJsonDocument::fromJson(array);
    QJsonArray jsonArray = doc.array();
    for (QJsonValue obj : jsonArray) {
        OAIListInflectedForms_200_response_inner val;
        ::OpenAPI::fromJsonValue(val, obj);
        output.append(val);
    }
    worker->deleteLater();
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT listInflectedFormsSignal(output);
        Q_EMIT listInflectedFormsSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT listInflectedFormsSignalE(output, error_type, error_str);
        Q_EMIT listInflectedFormsSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT listInflectedFormsSignalError(output, error_type, error_str);
        Q_EMIT listInflectedFormsSignalErrorFull(worker, error_type, error_str);
    }
}

void OAILanguageModelDirectAccessApi::listWordSenses(const ::OpenAPI::OptionalParam<QString> &language, const ::OpenAPI::OptionalParam<QString> &word, const ::OpenAPI::OptionalParam<QString> &ocp_apim_subscription_key) {
    QString fullPath = QString(_serverConfigs["listWordSenses"][_serverIndices.value("listWordSenses")].URL()+"/senses");
    ...
    if (word.hasValue())
    {
        ...
        fullPath.append(QUrl::toPercentEncoding("word")).append(querySuffix).append(QUrl::toPercentEncoding(word.stringValue()));
    }
    OAIHttpRequestWorker *worker = new OAIHttpRequestWorker(this, _manager);
    worker->setTimeOut(_timeOut);
    worker->setWorkingDirectory(_workingDirectory);
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAILanguageModelDirectAccessApi::listWordSensesCallback);
    connect(this, &OAILanguageModelDirectAccessApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAILanguageModelDirectAccessApi::listWordSensesCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    QList<OAIListWordSenses_200_response_inner> output;
    QString json(worker->response);
    QByteArray array(json.toStdString().c_str());
    QJsonDocument doc = QJsonDocument::fromJson(array);
    QJsonArray jsonArray = doc.array();
    for (QJsonValue obj : jsonArray) {
        OAIListWordSenses_200_response_inner val;
        ::OpenAPI::fromJsonValue(val, obj);
        output.append(val);
    }
    worker->deleteLater();
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT listWordSensesSignal(output);
        Q_EMIT listWordSensesSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT listWordSensesSignalE(output, error_type, error_str);
        Q_EMIT listWordSensesSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT listWordSensesSignalError(output, error_type, error_str);
        Q_EMIT listWordSensesSignalErrorFull(worker, error_type, error_str);
    }
}

void OAILanguageModelDirectAccessApi::tokenAvailable(){
