...
/**
 * ListWordSenses200ResponseInnerFeaturesInner
 */
...
public class ListWordSenses200ResponseInnerFeaturesInner {
  ...
  public ListWordSenses200ResponseInnerFeaturesInner() {
  }

  public ListWordSenses200ResponseInnerFeaturesInner index(BigDecimal index) {
    this.index = index;
    return this;
  }
  ...
  public ListWordSenses200ResponseInnerFeaturesInner type(String type) {
    this.type = type;
    return this;
  }
  ...
  public ListWordSenses200ResponseInnerFeaturesInner value(String value) {
    this.value = value;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    ListWordSenses200ResponseInnerFeaturesInner listWordSenses200ResponseInnerFeaturesInner = (ListWordSenses200ResponseInnerFeaturesInner) o;
    return Objects.equals(this.index, listWordSenses200ResponseInnerFeaturesInner.index) &&
        Objects.equals(this.type, listWordSenses200ResponseInnerFeaturesInner.type) &&
        Objects.equals(this.value, listWordSenses200ResponseInnerFeaturesInner.value);
  }
  ...
  public String toString() {
    ...
    sb.append("class ListWordSenses200ResponseInnerFeaturesInner {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ListWordSenses200ResponseInnerFeaturesInner
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListWordSenses200ResponseInnerFeaturesInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListWordSenses200ResponseInnerFeaturesInner is not found in the empty JSON string", ListWordSenses200ResponseInnerFeaturesInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListWordSenses200ResponseInnerFeaturesInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListWordSenses200ResponseInnerFeaturesInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListWordSenses200ResponseInnerFeaturesInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListWordSenses200ResponseInnerFeaturesInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListWordSenses200ResponseInnerFeaturesInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListWordSenses200ResponseInnerFeaturesInner.class));

       return (TypeAdapter<T>) new TypeAdapter<ListWordSenses200ResponseInnerFeaturesInner>() {
           @Override
           public void write(JsonWriter out, ListWordSenses200ResponseInnerFeaturesInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListWordSenses200ResponseInnerFeaturesInner read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListWordSenses200ResponseInnerFeaturesInner given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListWordSenses200ResponseInnerFeaturesInner
   * @throws IOException if the JSON string is invalid with respect to ListWordSenses200ResponseInnerFeaturesInner
   */
  public static ListWordSenses200ResponseInnerFeaturesInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListWordSenses200ResponseInnerFeaturesInner.class);
  }

  /**
   * Convert an instance of ListWordSenses200ResponseInnerFeaturesInner to an JSON string
   *
   * @return JSON string
   */
