...
public class ListHypernyms200ResponseInnerInner extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(ListHypernyms200ResponseInnerInner.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!ListHypernyms200ResponseInnerInner.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'ListHypernyms200ResponseInnerInner' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<ListHypernyms200ResponseInnerInner>() {
                @Override
                public void write(JsonWriter out, ListHypernyms200ResponseInnerInner value) throws IOException {
                ...
                @Override
                public ListHypernyms200ResponseInnerInner read(JsonReader in) throws IOException {
                    ...
                    try {
                        ...
                        ListHypernyms200ResponseInnerInner ret = new ListHypernyms200ResponseInnerInner();
                    ...
                    throw new IOException(String.format("Failed deserialization for ListHypernyms200ResponseInnerInner: no class matches result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public ListHypernyms200ResponseInnerInner() {
        super("anyOf", Boolean.FALSE);
    }

    public ListHypernyms200ResponseInnerInner(Object o) {
        super("anyOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, Class<?>> getSchemas() {
        return ListHypernyms200ResponseInnerInner.schemas;
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to ListHypernyms200ResponseInnerInner
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        throw new IOException(String.format("The JSON string is invalid for ListHypernyms200ResponseInnerInner with anyOf schemas: BigDecimal, String. no class match the result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
    }

    /**
     * Create an instance of ListHypernyms200ResponseInnerInner given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of ListHypernyms200ResponseInnerInner
     * @throws IOException if the JSON string is invalid with respect to ListHypernyms200ResponseInnerInner
     */
    public static ListHypernyms200ResponseInnerInner fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, ListHypernyms200ResponseInnerInner.class);
    }

    /**
     * Convert an instance of ListHypernyms200ResponseInnerInner to an JSON string
     *
     * @return JSON string
     */
