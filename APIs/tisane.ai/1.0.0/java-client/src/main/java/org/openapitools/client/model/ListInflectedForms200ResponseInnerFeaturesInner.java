...
public class ListInflectedForms200ResponseInnerFeaturesInner {
  ...
  public ListInflectedForms200ResponseInnerFeaturesInner() {
  }

  public ListInflectedForms200ResponseInnerFeaturesInner index(BigDecimal index) {
    this.index = index;
    return this;
  }
  ...
  public ListInflectedForms200ResponseInnerFeaturesInner value(String value) {
    this.value = value;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    ListInflectedForms200ResponseInnerFeaturesInner listInflectedForms200ResponseInnerFeaturesInner = (ListInflectedForms200ResponseInnerFeaturesInner) o;
    return Objects.equals(this.index, listInflectedForms200ResponseInnerFeaturesInner.index) &&
        Objects.equals(this.value, listInflectedForms200ResponseInnerFeaturesInner.value);
  }
  ...
  public String toString() {
    ...
    sb.append("class ListInflectedForms200ResponseInnerFeaturesInner {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ListInflectedForms200ResponseInnerFeaturesInner
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListInflectedForms200ResponseInnerFeaturesInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListInflectedForms200ResponseInnerFeaturesInner is not found in the empty JSON string", ListInflectedForms200ResponseInnerFeaturesInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListInflectedForms200ResponseInnerFeaturesInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListInflectedForms200ResponseInnerFeaturesInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListInflectedForms200ResponseInnerFeaturesInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListInflectedForms200ResponseInnerFeaturesInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListInflectedForms200ResponseInnerFeaturesInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListInflectedForms200ResponseInnerFeaturesInner.class));

       return (TypeAdapter<T>) new TypeAdapter<ListInflectedForms200ResponseInnerFeaturesInner>() {
           @Override
           public void write(JsonWriter out, ListInflectedForms200ResponseInnerFeaturesInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListInflectedForms200ResponseInnerFeaturesInner read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListInflectedForms200ResponseInnerFeaturesInner given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListInflectedForms200ResponseInnerFeaturesInner
   * @throws IOException if the JSON string is invalid with respect to ListInflectedForms200ResponseInnerFeaturesInner
   */
  public static ListInflectedForms200ResponseInnerFeaturesInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListInflectedForms200ResponseInnerFeaturesInner.class);
  }

  /**
   * Convert an instance of ListInflectedForms200ResponseInnerFeaturesInner to an JSON string
   *
   * @return JSON string
   */
