...
/**
 * ListWordSenses200ResponseInnerFamiliesInner
 */
...
public class ListWordSenses200ResponseInnerFamiliesInner {
  ...
  public ListWordSenses200ResponseInnerFamiliesInner() {
  }

  public ListWordSenses200ResponseInnerFamiliesInner key(BigDecimal key) {
    this.key = key;
    return this;
  }
  ...
  public ListWordSenses200ResponseInnerFamiliesInner value(Object value) {
    this.value = value;
    return this;
  }
  ...
  public ListWordSenses200ResponseInnerFamiliesInner definition(String definition) {
  ...
  public boolean equals(Object o) {
    ...
    ListWordSenses200ResponseInnerFamiliesInner listWordSenses200ResponseInnerFamiliesInner = (ListWordSenses200ResponseInnerFamiliesInner) o;
    return Objects.equals(this.key, listWordSenses200ResponseInnerFamiliesInner.key) &&
        Objects.equals(this.value, listWordSenses200ResponseInnerFamiliesInner.value) &&
        Objects.equals(this.definition, listWordSenses200ResponseInnerFamiliesInner.definition);
  }
  ...
  public String toString() {
    ...
    sb.append("class ListWordSenses200ResponseInnerFamiliesInner {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ListWordSenses200ResponseInnerFamiliesInner
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListWordSenses200ResponseInnerFamiliesInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListWordSenses200ResponseInnerFamiliesInner is not found in the empty JSON string", ListWordSenses200ResponseInnerFamiliesInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListWordSenses200ResponseInnerFamiliesInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListWordSenses200ResponseInnerFamiliesInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListWordSenses200ResponseInnerFamiliesInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListWordSenses200ResponseInnerFamiliesInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListWordSenses200ResponseInnerFamiliesInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListWordSenses200ResponseInnerFamiliesInner.class));

       return (TypeAdapter<T>) new TypeAdapter<ListWordSenses200ResponseInnerFamiliesInner>() {
           @Override
           public void write(JsonWriter out, ListWordSenses200ResponseInnerFamiliesInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListWordSenses200ResponseInnerFamiliesInner read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListWordSenses200ResponseInnerFamiliesInner given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListWordSenses200ResponseInnerFamiliesInner
   * @throws IOException if the JSON string is invalid with respect to ListWordSenses200ResponseInnerFamiliesInner
   */
  public static ListWordSenses200ResponseInnerFamiliesInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListWordSenses200ResponseInnerFamiliesInner.class);
  }

  /**
   * Convert an instance of ListWordSenses200ResponseInnerFamiliesInner to an JSON string
   *
   * @return JSON string
   */
