...
import org.openapitools.client.model.ListInflectedForms200ResponseInnerFeaturesInner;
 ...
 */
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-10-12T11:18:07.599200-04:00[America/New_York]", comments = "Generator version: 7.9.0")
public class ListInflectedForms200ResponseInner {
  public static final String SERIALIZED_NAME_FEATURES = "features";
  @SerializedName(SERIALIZED_NAME_FEATURES)
  private List<ListInflectedForms200ResponseInnerFeaturesInner> features = new ArrayList<>();

  public static final String SERIALIZED_NAME_IS_LEMMA = "isLemma";
  @SerializedName(SERIALIZED_NAME_IS_LEMMA)
  ...
  public ListInflectedForms200ResponseInner() {
  }

  public ListInflectedForms200ResponseInner features(List<ListInflectedForms200ResponseInnerFeaturesInner> features) {
    this.features = features;
    return this;
  }

  public ListInflectedForms200ResponseInner addFeaturesItem(ListInflectedForms200ResponseInnerFeaturesInner featuresItem) {
  ...
  public List<ListInflectedForms200ResponseInnerFeaturesInner> getFeatures() {
    return features;
  }

  public void setFeatures(List<ListInflectedForms200ResponseInnerFeaturesInner> features) {
    this.features = features;
  }


  public ListInflectedForms200ResponseInner isLemma(Boolean isLemma) {
  ...
  public ListInflectedForms200ResponseInner text(String text) {
    this.text = text;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    ListInflectedForms200ResponseInner listInflectedForms200ResponseInner = (ListInflectedForms200ResponseInner) o;
    return Objects.equals(this.features, listInflectedForms200ResponseInner.features) &&
        Objects.equals(this.isLemma, listInflectedForms200ResponseInner.isLemma) &&
        Objects.equals(this.text, listInflectedForms200ResponseInner.text);
  }

  @Override
  public int hashCode() {
    return Objects.hash(features, isLemma, text);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ListInflectedForms200ResponseInner {\n");
    sb.append("    features: ").append(toIndentedString(features)).append("\n");
    sb.append("    isLemma: ").append(toIndentedString(isLemma)).append("\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ListInflectedForms200ResponseInner
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListInflectedForms200ResponseInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListInflectedForms200ResponseInner is not found in the empty JSON string", ListInflectedForms200ResponseInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListInflectedForms200ResponseInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListInflectedForms200ResponseInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("features") != null && !jsonObj.get("features").isJsonNull()) {
        ...
        if (jsonArrayfeatures != null) {
          ...
          for (int i = 0; i < jsonArrayfeatures.size(); i++) {
            ListInflectedForms200ResponseInnerFeaturesInner.validateJsonElement(jsonArrayfeatures.get(i));
          };
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListInflectedForms200ResponseInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListInflectedForms200ResponseInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListInflectedForms200ResponseInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListInflectedForms200ResponseInner.class));

       return (TypeAdapter<T>) new TypeAdapter<ListInflectedForms200ResponseInner>() {
           @Override
           public void write(JsonWriter out, ListInflectedForms200ResponseInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListInflectedForms200ResponseInner read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListInflectedForms200ResponseInner given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListInflectedForms200ResponseInner
   * @throws IOException if the JSON string is invalid with respect to ListInflectedForms200ResponseInner
   */
  public static ListInflectedForms200ResponseInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListInflectedForms200ResponseInner.class);
  }

  /**
   * Convert an instance of ListInflectedForms200ResponseInner to an JSON string
   *
   * @return JSON string
   */
