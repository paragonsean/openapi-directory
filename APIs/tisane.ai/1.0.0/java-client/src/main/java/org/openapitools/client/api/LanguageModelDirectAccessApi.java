...
import org.openapitools.client.model.GetFamilyDetails200Response;
import org.openapitools.client.model.ListHypernyms200ResponseInnerInner;
import org.openapitools.client.model.ListInflectedForms200ResponseInner;
import org.openapitools.client.model.ListWordSenses200ResponseInner;
...
public class LanguageModelDirectAccessApi {
    private ApiClient localVarApiClient;
    private int localHostIndex;
    private String localCustomBaseUrl;

    public LanguageModelDirectAccessApi() {
        this(Configuration.getDefaultApiClient());
    }

    public LanguageModelDirectAccessApi(ApiClient apiClient) {
    ...
    /**
     * Build call for getFamilyDetails
     * @param id (Required) a numeric identifier of the family (optional)
     * @param ocpApimSubscriptionKey {{apiKeyDescription}} (optional)
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        ...
        <tr><td> 200 </td><td> Details of the family for &#39;plot twist&#39; </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call getFamilyDetailsCall(String id, String ocpApimSubscriptionKey, final ApiCallback _callback) throws ApiException {
        ...
        if (ocpApimSubscriptionKey != null) {
            localVarHeaderParams.put("Ocp-Apim-Subscription-Key", localVarApiClient.parameterToString(ocpApimSubscriptionKey));
        }
    ...
    private okhttp3.Call getFamilyDetailsValidateBeforeCall(String id, String ocpApimSubscriptionKey, final ApiCallback _callback) throws ApiException {
        return getFamilyDetailsCall(id, ocpApimSubscriptionKey, _callback);
     ...
     * @param id (Required) a numeric identifier of the family (optional)
     * @param ocpApimSubscriptionKey {{apiKeyDescription}} (optional)
     * @return GetFamilyDetails200Response
     ...
     */
    public GetFamilyDetails200Response getFamilyDetails(String id, String ocpApimSubscriptionKey) throws ApiException {
        ApiResponse<GetFamilyDetails200Response> localVarResp = getFamilyDetailsWithHttpInfo(id, ocpApimSubscriptionKey);
     ...
     * @param id (Required) a numeric identifier of the family (optional)
     * @param ocpApimSubscriptionKey {{apiKeyDescription}} (optional)
     * @return ApiResponse&lt;GetFamilyDetails200Response&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<GetFamilyDetails200Response> getFamilyDetailsWithHttpInfo(String id, String ocpApimSubscriptionKey) throws ApiException {
        okhttp3.Call localVarCall = getFamilyDetailsValidateBeforeCall(id, ocpApimSubscriptionKey, null);
        Type localVarReturnType = new TypeToken<GetFamilyDetails200Response>(){}.getType();
     ...
     */
    public okhttp3.Call getFamilyDetailsAsync(String id, String ocpApimSubscriptionKey, final ApiCallback<GetFamilyDetails200Response> _callback) throws ApiException {

        okhttp3.Call localVarCall = getFamilyDetailsValidateBeforeCall(id, ocpApimSubscriptionKey, _callback);
        Type localVarReturnType = new TypeToken<GetFamilyDetails200Response>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for listFeatureValues
     * @param language (Required) Language code (optional)
     * @param type (Required) Feature type (optional)
     * @param description (Required) Feature list name (localized) (optional)
     * @param ocpApimSubscriptionKey {{apiKeyDescription}} (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> List entity subtypes </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call listFeatureValuesCall(String language, String type, String description, String ocpApimSubscriptionKey, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call listFeatureValuesValidateBeforeCall(String language, String type, String description, String ocpApimSubscriptionKey, final ApiCallback _callback) throws ApiException {
        return listFeatureValuesCall(language, type, description, ocpApimSubscriptionKey, _callback);
     ...
     */
    public List<String> listFeatureValues(String language, String type, String description, String ocpApimSubscriptionKey) throws ApiException {
        ApiResponse<List<String>> localVarResp = listFeatureValuesWithHttpInfo(language, type, description, ocpApimSubscriptionKey);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<List<String>> listFeatureValuesWithHttpInfo(String language, String type, String description, String ocpApimSubscriptionKey) throws ApiException {
        okhttp3.Call localVarCall = listFeatureValuesValidateBeforeCall(language, type, description, ocpApimSubscriptionKey, null);
        Type localVarReturnType = new TypeToken<List<String>>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * List feature values (asynchronously)
     * Lists feature values for a particular category of features. This allows obtaining all the values such as entity types, subtypes, abuse types and tags, and more.  Returns the values as a JSON array of strings.
     * @param language (Required) Language code (optional)
     * @param type (Required) Feature type (optional)
     * @param description (Required) Feature list name (localized) (optional)
     ...
     */
    public okhttp3.Call listFeatureValuesAsync(String language, String type, String description, String ocpApimSubscriptionKey, final ApiCallback<List<String>> _callback) throws ApiException {

        okhttp3.Call localVarCall = listFeatureValuesValidateBeforeCall(language, type, description, ocpApimSubscriptionKey, _callback);
        Type localVarReturnType = new TypeToken<List<String>>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for listHypernyms
     * @param family (Required) a numeric identifier of the family (optional)
     * @param maxLevel (Required) maximum distance from the family (optional)
     * @param ocpApimSubscriptionKey {{apiKeyDescription}} (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> Hypernyms of Darth Vader </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call listHypernymsCall(String family, String maxLevel, String ocpApimSubscriptionKey, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call listHypernymsValidateBeforeCall(String family, String maxLevel, String ocpApimSubscriptionKey, final ApiCallback _callback) throws ApiException {
        return listHypernymsCall(family, maxLevel, ocpApimSubscriptionKey, _callback);
     ...
     * @param maxLevel (Required) maximum distance from the family (optional)
     * @param ocpApimSubscriptionKey {{apiKeyDescription}} (optional)
     * @return List&lt;List&lt;ListHypernyms200ResponseInnerInner&gt;&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public List<List<ListHypernyms200ResponseInnerInner>> listHypernyms(String family, String maxLevel, String ocpApimSubscriptionKey) throws ApiException {
        ApiResponse<List<List<ListHypernyms200ResponseInnerInner>>> localVarResp = listHypernymsWithHttpInfo(family, maxLevel, ocpApimSubscriptionKey);
        return localVarResp.getData();
    }
     ...
     * @param maxLevel (Required) maximum distance from the family (optional)
     * @param ocpApimSubscriptionKey {{apiKeyDescription}} (optional)
     * @return ApiResponse&lt;List&lt;List&lt;ListHypernyms200ResponseInnerInner&gt;&gt;&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<List<List<ListHypernyms200ResponseInnerInner>>> listHypernymsWithHttpInfo(String family, String maxLevel, String ocpApimSubscriptionKey) throws ApiException {
        okhttp3.Call localVarCall = listHypernymsValidateBeforeCall(family, maxLevel, ocpApimSubscriptionKey, null);
        Type localVarReturnType = new TypeToken<List<List<ListHypernyms200ResponseInnerInner>>>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * List hypernyms (asynchronously)
     * Lists all hypernyms related to a family. A hypernym is a parent concent. E.g. \&quot;vehicle\&quot; is a hypernym of \&quot;truck\&quot;.
     * @param family (Required) a numeric identifier of the family (optional)
     * @param maxLevel (Required) maximum distance from the family (optional)
     * @param ocpApimSubscriptionKey {{apiKeyDescription}} (optional)
     ...
     */
    public okhttp3.Call listHypernymsAsync(String family, String maxLevel, String ocpApimSubscriptionKey, final ApiCallback<List<List<ListHypernyms200ResponseInnerInner>>> _callback) throws ApiException {

        okhttp3.Call localVarCall = listHypernymsValidateBeforeCall(family, maxLevel, ocpApimSubscriptionKey, _callback);
        Type localVarReturnType = new TypeToken<List<List<ListHypernyms200ResponseInnerInner>>>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for listHyponyms
     * @param family (Required) a numeric identifier of the family (optional)
     * @param maxLevel (Required) maximum distance from the family (optional)
     * @param ocpApimSubscriptionKey {{apiKeyDescription}} (optional)
     * @param _callback Callback for upload/download progress
     ...
     */
    public okhttp3.Call listHyponymsCall(String family, String maxLevel, String ocpApimSubscriptionKey, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call listHyponymsValidateBeforeCall(String family, String maxLevel, String ocpApimSubscriptionKey, final ApiCallback _callback) throws ApiException {
        return listHyponymsCall(family, maxLevel, ocpApimSubscriptionKey, _callback);
     ...
     */
    public void listHyponyms(String family, String maxLevel, String ocpApimSubscriptionKey) throws ApiException {
        listHyponymsWithHttpInfo(family, maxLevel, ocpApimSubscriptionKey);
    }
     ...
     */
    public ApiResponse<Void> listHyponymsWithHttpInfo(String family, String maxLevel, String ocpApimSubscriptionKey) throws ApiException {
        okhttp3.Call localVarCall = listHyponymsValidateBeforeCall(family, maxLevel, ocpApimSubscriptionKey, null);
        return localVarApiClient.execute(localVarCall);
    }

    /**
     * List hyponyms (asynchronously)
     * Lists all hyponyms related to a family. A hyponym is a child concent. E.g. \&quot;truck\&quot; is a hypernym of \&quot;vehicle\&quot;.
     * @param family (Required) a numeric identifier of the family (optional)
     * @param maxLevel (Required) maximum distance from the family (optional)
     * @param ocpApimSubscriptionKey {{apiKeyDescription}} (optional)
     ...
     */
    public okhttp3.Call listHyponymsAsync(String family, String maxLevel, String ocpApimSubscriptionKey, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = listHyponymsValidateBeforeCall(family, maxLevel, ocpApimSubscriptionKey, _callback);
        localVarApiClient.executeAsync(localVarCall, _callback);
        return localVarCall;
    }
    /**
     * Build call for listInflectedForms
     * @param language (Required) The language code (optional)
     * @param lexeme (Required) The lexeme to inspect (optional)
     * @param family (Required) The family to inspect (optional)
     * @param ocpApimSubscriptionKey {{apiKeyDescription}} (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> Inflected forms of \&quot;United States\&quot; in Russian </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call listInflectedFormsCall(String language, String lexeme, String family, String ocpApimSubscriptionKey, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/inflections";
        ...
        if (lexeme != null) {
            localVarQueryParams.addAll(localVarApiClient.parameterToPair("lexeme", lexeme));
        }
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call listInflectedFormsValidateBeforeCall(String language, String lexeme, String family, String ocpApimSubscriptionKey, final ApiCallback _callback) throws ApiException {
        return listInflectedFormsCall(language, lexeme, family, ocpApimSubscriptionKey, _callback);
     ...
     * @param family (Required) The family to inspect (optional)
     * @param ocpApimSubscriptionKey {{apiKeyDescription}} (optional)
     * @return List&lt;ListInflectedForms200ResponseInner&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public List<ListInflectedForms200ResponseInner> listInflectedForms(String language, String lexeme, String family, String ocpApimSubscriptionKey) throws ApiException {
        ApiResponse<List<ListInflectedForms200ResponseInner>> localVarResp = listInflectedFormsWithHttpInfo(language, lexeme, family, ocpApimSubscriptionKey);
        return localVarResp.getData();
    }
     ...
     * @param family (Required) The family to inspect (optional)
     * @param ocpApimSubscriptionKey {{apiKeyDescription}} (optional)
     * @return ApiResponse&lt;List&lt;ListInflectedForms200ResponseInner&gt;&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<List<ListInflectedForms200ResponseInner>> listInflectedFormsWithHttpInfo(String language, String lexeme, String family, String ocpApimSubscriptionKey) throws ApiException {
        okhttp3.Call localVarCall = listInflectedFormsValidateBeforeCall(language, lexeme, family, ocpApimSubscriptionKey, null);
        Type localVarReturnType = new TypeToken<List<ListInflectedForms200ResponseInner>>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * List inflected forms (asynchronously)
     * List inflected forms
     * @param language (Required) The language code (optional)
     * @param lexeme (Required) The lexeme to inspect (optional)
     * @param family (Required) The family to inspect (optional)
     ...
     */
    public okhttp3.Call listInflectedFormsAsync(String language, String lexeme, String family, String ocpApimSubscriptionKey, final ApiCallback<List<ListInflectedForms200ResponseInner>> _callback) throws ApiException {

        okhttp3.Call localVarCall = listInflectedFormsValidateBeforeCall(language, lexeme, family, ocpApimSubscriptionKey, _callback);
        Type localVarReturnType = new TypeToken<List<ListInflectedForms200ResponseInner>>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for listWordSenses
     * @param language (Required) a standard culture code (ISO-639 language code with an optional country extension) (optional)
     * @param word (Required) the word to inspect (optional)
     * @param ocpApimSubscriptionKey {{apiKeyDescription}} (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> Interpretations of \&quot;couscous\&quot; </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call listWordSensesCall(String language, String word, String ocpApimSubscriptionKey, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call listWordSensesValidateBeforeCall(String language, String word, String ocpApimSubscriptionKey, final ApiCallback _callback) throws ApiException {
        return listWordSensesCall(language, word, ocpApimSubscriptionKey, _callback);
     ...
     * @param word (Required) the word to inspect (optional)
     * @param ocpApimSubscriptionKey {{apiKeyDescription}} (optional)
     * @return List&lt;ListWordSenses200ResponseInner&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public List<ListWordSenses200ResponseInner> listWordSenses(String language, String word, String ocpApimSubscriptionKey) throws ApiException {
        ApiResponse<List<ListWordSenses200ResponseInner>> localVarResp = listWordSensesWithHttpInfo(language, word, ocpApimSubscriptionKey);
        return localVarResp.getData();
    }
     ...
     * @param word (Required) the word to inspect (optional)
     * @param ocpApimSubscriptionKey {{apiKeyDescription}} (optional)
     * @return ApiResponse&lt;List&lt;ListWordSenses200ResponseInner&gt;&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<List<ListWordSenses200ResponseInner>> listWordSensesWithHttpInfo(String language, String word, String ocpApimSubscriptionKey) throws ApiException {
        okhttp3.Call localVarCall = listWordSensesValidateBeforeCall(language, word, ocpApimSubscriptionKey, null);
        Type localVarReturnType = new TypeToken<List<ListWordSenses200ResponseInner>>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * List word senses (asynchronously)
     * Fetches and outputs all senses related to a word.
     * @param language (Required) a standard culture code (ISO-639 language code with an optional country extension) (optional)
     * @param word (Required) the word to inspect (optional)
     * @param ocpApimSubscriptionKey {{apiKeyDescription}} (optional)
     ...
     */
    public okhttp3.Call listWordSensesAsync(String language, String word, String ocpApimSubscriptionKey, final ApiCallback<List<ListWordSenses200ResponseInner>> _callback) throws ApiException {

        okhttp3.Call localVarCall = listWordSensesValidateBeforeCall(language, word, ocpApimSubscriptionKey, _callback);
        Type localVarReturnType = new TypeToken<List<ListWordSenses200ResponseInner>>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
