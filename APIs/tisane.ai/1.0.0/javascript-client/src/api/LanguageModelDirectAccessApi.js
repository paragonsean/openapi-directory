...
import GetFamilyDetails200Response from '../model/GetFamilyDetails200Response';
import ListHypernyms200ResponseInnerInner from '../model/ListHypernyms200ResponseInnerInner';
import ListInflectedForms200ResponseInner from '../model/ListInflectedForms200ResponseInner';
import ListWordSenses200ResponseInner from '../model/ListWordSenses200ResponseInner';

/**
* LanguageModelDirectAccess service.
* @module api/LanguageModelDirectAccessApi
* @version 1.0.0
*/
export default class LanguageModelDirectAccessApi {

    /**
    * Constructs a new LanguageModelDirectAccessApi. 
    * @alias module:api/LanguageModelDirectAccessApi
    * @class
    ...
    */
    ...
    /**
     * Callback function to receive the result of the getFamilyDetails operation.
     * @callback module:api/LanguageModelDirectAccessApi~getFamilyDetailsCallback
     * @param {String} error Error message, if any.
     * @param {module:model/GetFamilyDetails200Response} data The data returned by the service call.
     ...
     * @param {String} [ocpApimSubscriptionKey] {{apiKeyDescription}}
     * @param {module:api/LanguageModelDirectAccessApi~getFamilyDetailsCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/GetFamilyDetails200Response}
     */
    getFamilyDetails(opts, callback) {
      opts = opts || {};
      let postBody = null;
      ...
      let returnType = GetFamilyDetails200Response;
    ...
    /**
     * Callback function to receive the result of the listFeatureValues operation.
     * @callback module:api/LanguageModelDirectAccessApi~listFeatureValuesCallback
     * @param {String} error Error message, if any.
     ...
     * @param {String} [ocpApimSubscriptionKey] {{apiKeyDescription}}
     * @param {module:api/LanguageModelDirectAccessApi~listFeatureValuesCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Array.<String>}
     */
    listFeatureValues(opts, callback) {
      opts = opts || {};
      let postBody = null;
    ...
    /**
     * Callback function to receive the result of the listHypernyms operation.
     * @callback module:api/LanguageModelDirectAccessApi~listHypernymsCallback
     * @param {String} error Error message, if any.
     * @param {Array.<[ListHypernyms200ResponseInnerInner]>} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} [ocpApimSubscriptionKey] {{apiKeyDescription}}
     * @param {module:api/LanguageModelDirectAccessApi~listHypernymsCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Array.<[ListHypernyms200ResponseInnerInner]>}
     */
    listHypernyms(opts, callback) {
      opts = opts || {};
      let postBody = null;
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = [[ListHypernyms200ResponseInnerInner]];
      return this.apiClient.callApi(
        '/hypernyms', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
    ...
    /**
     * Callback function to receive the result of the listHyponyms operation.
     * @callback module:api/LanguageModelDirectAccessApi~listHyponymsCallback
     * @param {String} error Error message, if any.
     ...
     * @param {String} [maxLevel] (Required) maximum distance from the family
     * @param {String} [ocpApimSubscriptionKey] {{apiKeyDescription}}
     * @param {module:api/LanguageModelDirectAccessApi~listHyponymsCallback} callback The callback function, accepting three arguments: error, data, response
     */
    listHyponyms(opts, callback) {
      opts = opts || {};
      let postBody = null;
    ...
    /**
     * Callback function to receive the result of the listInflectedForms operation.
     * @callback module:api/LanguageModelDirectAccessApi~listInflectedFormsCallback
     * @param {String} error Error message, if any.
     * @param {Array.<module:model/ListInflectedForms200ResponseInner>} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} [ocpApimSubscriptionKey] {{apiKeyDescription}}
     * @param {module:api/LanguageModelDirectAccessApi~listInflectedFormsCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Array.<module:model/ListInflectedForms200ResponseInner>}
     */
    listInflectedForms(opts, callback) {
      opts = opts || {};
      let postBody = null;
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = [ListInflectedForms200ResponseInner];
      return this.apiClient.callApi(
        '/inflections', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
    ...
    /**
     * Callback function to receive the result of the listWordSenses operation.
     * @callback module:api/LanguageModelDirectAccessApi~listWordSensesCallback
     * @param {String} error Error message, if any.
     * @param {Array.<module:model/ListWordSenses200ResponseInner>} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} [ocpApimSubscriptionKey] {{apiKeyDescription}}
     * @param {module:api/LanguageModelDirectAccessApi~listWordSensesCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Array.<module:model/ListWordSenses200ResponseInner>}
     */
    listWordSenses(opts, callback) {
      opts = opts || {};
      let postBody = null;
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = [ListWordSenses200ResponseInner];
      return this.apiClient.callApi(
        '/senses', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
