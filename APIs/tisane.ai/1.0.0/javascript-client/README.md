# tisane_api_documentation

TisaneApiDocumentation - JavaScript client for tisane_api_documentation
...
```shell
npm install tisane_api_documentation --save
```
...
To use the link you just defined in your project, switch to the directory you want to use your tisane_api_documentation from, and run:
...
```javascript
var TisaneApiDocumentation = require('tisane_api_documentation');


var api = new TisaneApiDocumentation.LanguageModelDirectAccessApi()
var opts = {
...
api.getFamilyDetails(opts, callback);
...
------------ | ------------- | ------------- | -------------
*TisaneApiDocumentation.LanguageModelDirectAccessApi* | [**getFamilyDetails**](docs/LanguageModelDirectAccessApi.md#getFamilyDetails) | **GET** /lm/family | Get family details
*TisaneApiDocumentation.LanguageModelDirectAccessApi* | [**listFeatureValues**](docs/LanguageModelDirectAccessApi.md#listFeatureValues) | **GET** /values | List feature values
*TisaneApiDocumentation.LanguageModelDirectAccessApi* | [**listHypernyms**](docs/LanguageModelDirectAccessApi.md#listHypernyms) | **GET** /hypernyms | List hypernyms
*TisaneApiDocumentation.LanguageModelDirectAccessApi* | [**listHyponyms**](docs/LanguageModelDirectAccessApi.md#listHyponyms) | **GET** /hyponyms | List hyponyms
*TisaneApiDocumentation.LanguageModelDirectAccessApi* | [**listInflectedForms**](docs/LanguageModelDirectAccessApi.md#listInflectedForms) | **GET** /inflections | List inflected forms
*TisaneApiDocumentation.LanguageModelDirectAccessApi* | [**listWordSenses**](docs/LanguageModelDirectAccessApi.md#listWordSenses) | **GET** /senses | List word senses


## Documentation for Models

 - [TisaneApiDocumentation.GetFamilyDetails200Response](docs/GetFamilyDetails200Response.md)
 - [TisaneApiDocumentation.ListHypernyms200ResponseInnerInner](docs/ListHypernyms200ResponseInnerInner.md)
 - [TisaneApiDocumentation.ListInflectedForms200ResponseInner](docs/ListInflectedForms200ResponseInner.md)
 - [TisaneApiDocumentation.ListInflectedForms200ResponseInnerFeaturesInner](docs/ListInflectedForms200ResponseInnerFeaturesInner.md)
 - [TisaneApiDocumentation.ListWordSenses200ResponseInner](docs/ListWordSenses200ResponseInner.md)
 - [TisaneApiDocumentation.ListWordSenses200ResponseInnerFamiliesInner](docs/ListWordSenses200ResponseInnerFamiliesInner.md)
 - [TisaneApiDocumentation.ListWordSenses200ResponseInnerFeaturesInner](docs/ListWordSenses200ResponseInnerFeaturesInner.md)
