...
#ifndef OAILocaleList_H
#define OAILocaleList_H
...
class OAILocaleList : public OAIObject {
public:
    OAILocaleList();
    OAILocaleList(QString json);
    ~OAILocaleList() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILocaleList)

#endif // OAILocaleList_H
