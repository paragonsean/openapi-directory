...
#ifndef OAIAssetItemList_H
#define OAIAssetItemList_H
...
class OAIAssetItemList : public OAIObject {
public:
    OAIAssetItemList();
    OAIAssetItemList(QString json);
    ~OAIAssetItemList() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAssetItemList)

#endif // OAIAssetItemList_H
