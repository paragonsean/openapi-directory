...
OAIPAM_Asset_Categories_allOf__links OAICategories::getLinks() const {
    return m__links;
}
void OAICategories::setLinks(const OAIPAM_Asset_Categories_allOf__links &_links) {
    m__links = _links;
    m__links_isSet = true;
}

bool OAICategories::is__links_Set() const{
    return m__links_isSet;
}

bool OAICategories::is__links_Valid() const{
    return m__links_isValid;
}

qint32 OAICategories::getCurrentPage() const {
    return m_current_page;
}
void OAICategories::setCurrentPage(const qint32 &current_page) {
    m_current_page = current_page;
    m_current_page_isSet = true;
}

bool OAICategories::is_current_page_Set() const{
    return m_current_page_isSet;
}

bool OAICategories::is_current_page_Valid() const{
    return m_current_page_isValid;
}

OAICategories_allOf__embedded OAICategories::getEmbedded() const {
    return m__embedded;
}
void OAICategories::setEmbedded(const OAICategories_allOf__embedded &_embedded) {
    m__embedded = _embedded;
    m__embedded_isSet = true;
}

bool OAICategories::is__embedded_Set() const{
    return m__embedded_isSet;
}

bool OAICategories::is__embedded_Valid() const{
