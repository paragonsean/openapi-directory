...
/*
 * OAIPatch_attributes_request.h
 *
 * 
 */

#ifndef OAIPatch_attributes_request_H
#define OAIPatch_attributes_request_H
...
class OAIPatch_attributes_request : public OAIObject {
public:
    OAIPatch_attributes_request();
    OAIPatch_attributes_request(QString json);
    ~OAIPatch_attributes_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPatch_attributes_request)

#endif // OAIPatch_attributes_request_H
