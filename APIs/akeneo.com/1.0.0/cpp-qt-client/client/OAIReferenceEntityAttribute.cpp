...
#include "OAIReferenceEntityAttribute.h"
...
OAIReferenceEntityAttribute::OAIReferenceEntityAttribute(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIReferenceEntityAttribute::OAIReferenceEntityAttribute() {
    this->initializeModel();
}

OAIReferenceEntityAttribute::~OAIReferenceEntityAttribute() {}

void OAIReferenceEntityAttribute::initializeModel() {
...
void OAIReferenceEntityAttribute::fromJson(QString jsonString) {
...
void OAIReferenceEntityAttribute::fromJsonObject(QJsonObject json) {
...
QString OAIReferenceEntityAttribute::asJson() const {
...
QJsonObject OAIReferenceEntityAttribute::asJsonObject() const {
    QJsonObject obj;
...
QList<QString> OAIReferenceEntityAttribute::getAllowedExtensions() const {
    return m_allowed_extensions;
}
void OAIReferenceEntityAttribute::setAllowedExtensions(const QList<QString> &allowed_extensions) {
    m_allowed_extensions = allowed_extensions;
    m_allowed_extensions_isSet = true;
}

bool OAIReferenceEntityAttribute::is_allowed_extensions_Set() const{
    return m_allowed_extensions_isSet;
}

bool OAIReferenceEntityAttribute::is_allowed_extensions_Valid() const{
    return m_allowed_extensions_isValid;
}

QString OAIReferenceEntityAttribute::getCode() const {
    return m_code;
}
void OAIReferenceEntityAttribute::setCode(const QString &code) {
    m_code = code;
    m_code_isSet = true;
}

bool OAIReferenceEntityAttribute::is_code_Set() const{
    return m_code_isSet;
}

bool OAIReferenceEntityAttribute::is_code_Valid() const{
    return m_code_isValid;
}

bool OAIReferenceEntityAttribute::isDecimalsAllowed() const {
    return m_decimals_allowed;
}
void OAIReferenceEntityAttribute::setDecimalsAllowed(const bool &decimals_allowed) {
    m_decimals_allowed = decimals_allowed;
    m_decimals_allowed_isSet = true;
}

bool OAIReferenceEntityAttribute::is_decimals_allowed_Set() const{
    return m_decimals_allowed_isSet;
}

bool OAIReferenceEntityAttribute::is_decimals_allowed_Valid() const{
    return m_decimals_allowed_isValid;
}

bool OAIReferenceEntityAttribute::isIsRequiredForCompleteness() const {
    return m_is_required_for_completeness;
}
void OAIReferenceEntityAttribute::setIsRequiredForCompleteness(const bool &is_required_for_completeness) {
    m_is_required_for_completeness = is_required_for_completeness;
    m_is_required_for_completeness_isSet = true;
}

bool OAIReferenceEntityAttribute::is_is_required_for_completeness_Set() const{
    return m_is_required_for_completeness_isSet;
}

bool OAIReferenceEntityAttribute::is_is_required_for_completeness_Valid() const{
    return m_is_required_for_completeness_isValid;
}

bool OAIReferenceEntityAttribute::isIsRichTextEditor() const {
    return m_is_rich_text_editor;
}
void OAIReferenceEntityAttribute::setIsRichTextEditor(const bool &is_rich_text_editor) {
    m_is_rich_text_editor = is_rich_text_editor;
    m_is_rich_text_editor_isSet = true;
}

bool OAIReferenceEntityAttribute::is_is_rich_text_editor_Set() const{
    return m_is_rich_text_editor_isSet;
}

bool OAIReferenceEntityAttribute::is_is_rich_text_editor_Valid() const{
    return m_is_rich_text_editor_isValid;
}

bool OAIReferenceEntityAttribute::isIsTextarea() const {
    return m_is_textarea;
}
void OAIReferenceEntityAttribute::setIsTextarea(const bool &is_textarea) {
    m_is_textarea = is_textarea;
    m_is_textarea_isSet = true;
}

bool OAIReferenceEntityAttribute::is_is_textarea_Set() const{
    return m_is_textarea_isSet;
}

bool OAIReferenceEntityAttribute::is_is_textarea_Valid() const{
    return m_is_textarea_isValid;
}

OAIGet_asset_families__code__attributes_200_response_inner_labels OAIReferenceEntityAttribute::getLabels() const {
    return m_labels;
}
void OAIReferenceEntityAttribute::setLabels(const OAIGet_asset_families__code__attributes_200_response_inner_labels &labels) {
    m_labels = labels;
    m_labels_isSet = true;
}

bool OAIReferenceEntityAttribute::is_labels_Set() const{
    return m_labels_isSet;
}

bool OAIReferenceEntityAttribute::is_labels_Valid() const{
    return m_labels_isValid;
}

qint32 OAIReferenceEntityAttribute::getMaxCharacters() const {
    return m_max_characters;
}
void OAIReferenceEntityAttribute::setMaxCharacters(const qint32 &max_characters) {
    m_max_characters = max_characters;
    m_max_characters_isSet = true;
}

bool OAIReferenceEntityAttribute::is_max_characters_Set() const{
    return m_max_characters_isSet;
}

bool OAIReferenceEntityAttribute::is_max_characters_Valid() const{
    return m_max_characters_isValid;
}

QString OAIReferenceEntityAttribute::getMaxFileSize() const {
    return m_max_file_size;
}
void OAIReferenceEntityAttribute::setMaxFileSize(const QString &max_file_size) {
    m_max_file_size = max_file_size;
    m_max_file_size_isSet = true;
}

bool OAIReferenceEntityAttribute::is_max_file_size_Set() const{
    return m_max_file_size_isSet;
}

bool OAIReferenceEntityAttribute::is_max_file_size_Valid() const{
    return m_max_file_size_isValid;
}

QString OAIReferenceEntityAttribute::getMaxValue() const {
    return m_max_value;
}
void OAIReferenceEntityAttribute::setMaxValue(const QString &max_value) {
    m_max_value = max_value;
    m_max_value_isSet = true;
}

bool OAIReferenceEntityAttribute::is_max_value_Set() const{
    return m_max_value_isSet;
}

bool OAIReferenceEntityAttribute::is_max_value_Valid() const{
    return m_max_value_isValid;
}

QString OAIReferenceEntityAttribute::getMinValue() const {
    return m_min_value;
}
void OAIReferenceEntityAttribute::setMinValue(const QString &min_value) {
    m_min_value = min_value;
    m_min_value_isSet = true;
}

bool OAIReferenceEntityAttribute::is_min_value_Set() const{
    return m_min_value_isSet;
}

bool OAIReferenceEntityAttribute::is_min_value_Valid() const{
    return m_min_value_isValid;
}

QString OAIReferenceEntityAttribute::getReferenceEntityCode() const {
    return m_reference_entity_code;
}
void OAIReferenceEntityAttribute::setReferenceEntityCode(const QString &reference_entity_code) {
    m_reference_entity_code = reference_entity_code;
    m_reference_entity_code_isSet = true;
}

bool OAIReferenceEntityAttribute::is_reference_entity_code_Set() const{
    return m_reference_entity_code_isSet;
}

bool OAIReferenceEntityAttribute::is_reference_entity_code_Valid() const{
    return m_reference_entity_code_isValid;
}

QString OAIReferenceEntityAttribute::getType() const {
    return m_type;
}
void OAIReferenceEntityAttribute::setType(const QString &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAIReferenceEntityAttribute::is_type_Set() const{
    return m_type_isSet;
}

bool OAIReferenceEntityAttribute::is_type_Valid() const{
    return m_type_isValid;
}

QString OAIReferenceEntityAttribute::getValidationRegexp() const {
    return m_validation_regexp;
}
void OAIReferenceEntityAttribute::setValidationRegexp(const QString &validation_regexp) {
    m_validation_regexp = validation_regexp;
    m_validation_regexp_isSet = true;
}

bool OAIReferenceEntityAttribute::is_validation_regexp_Set() const{
    return m_validation_regexp_isSet;
}

bool OAIReferenceEntityAttribute::is_validation_regexp_Valid() const{
    return m_validation_regexp_isValid;
}

QString OAIReferenceEntityAttribute::getValidationRule() const {
    return m_validation_rule;
}
void OAIReferenceEntityAttribute::setValidationRule(const QString &validation_rule) {
    m_validation_rule = validation_rule;
    m_validation_rule_isSet = true;
}

bool OAIReferenceEntityAttribute::is_validation_rule_Set() const{
    return m_validation_rule_isSet;
}

bool OAIReferenceEntityAttribute::is_validation_rule_Valid() const{
    return m_validation_rule_isValid;
}

bool OAIReferenceEntityAttribute::isValuePerChannel() const {
    return m_value_per_channel;
}
void OAIReferenceEntityAttribute::setValuePerChannel(const bool &value_per_channel) {
    m_value_per_channel = value_per_channel;
    m_value_per_channel_isSet = true;
}

bool OAIReferenceEntityAttribute::is_value_per_channel_Set() const{
    return m_value_per_channel_isSet;
}

bool OAIReferenceEntityAttribute::is_value_per_channel_Valid() const{
    return m_value_per_channel_isValid;
}

bool OAIReferenceEntityAttribute::isValuePerLocale() const {
    return m_value_per_locale;
}
void OAIReferenceEntityAttribute::setValuePerLocale(const bool &value_per_locale) {
    m_value_per_locale = value_per_locale;
    m_value_per_locale_isSet = true;
}

bool OAIReferenceEntityAttribute::is_value_per_locale_Set() const{
    return m_value_per_locale_isSet;
}

bool OAIReferenceEntityAttribute::is_value_per_locale_Valid() const{
    return m_value_per_locale_isValid;
}

bool OAIReferenceEntityAttribute::isSet() const {
...
bool OAIReferenceEntityAttribute::isValid() const {
