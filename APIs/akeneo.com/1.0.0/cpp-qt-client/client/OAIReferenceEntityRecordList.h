...
/*
 * OAIReferenceEntityRecordList.h
 *
 * 
 */

#ifndef OAIReferenceEntityRecordList_H
#define OAIReferenceEntityRecordList_H
...
class OAIReferenceEntityRecordList_allOf_values;

class OAIReferenceEntityRecordList : public OAIObject {
public:
    OAIReferenceEntityRecordList();
    OAIReferenceEntityRecordList(QString json);
    ~OAIReferenceEntityRecordList() override;
    ...
    OAIReferenceEntityRecordList_allOf_values getValues() const;
    void setValues(const OAIReferenceEntityRecordList_allOf_values &values);
...
private:
    ...
    OAIReferenceEntityRecordList_allOf_values m_values;
    bool m_values_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIReferenceEntityRecordList)

#endif // OAIReferenceEntityRecordList_H
