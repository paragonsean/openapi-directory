...
/*
 * OAIPublishedProductList.h
 *
 * 
 */

#ifndef OAIPublishedProductList_H
#define OAIPublishedProductList_H

#include <QJsonObject>

#include "OAIObject.h"
#include "OAIPAM_Asset_Categories_allOf__embedded_items_inner_allOf__links.h"
#include "OAIPublishedProductList_allOf_values.h"
...
class OAIPublishedProductList_allOf_values;

class OAIPublishedProductList : public OAIObject {
public:
    OAIPublishedProductList();
    OAIPublishedProductList(QString json);
    ~OAIPublishedProductList() override;
    ...
    OAIPublishedProductList_allOf_values getValues() const;
    void setValues(const OAIPublishedProductList_allOf_values &values);
...
private:
    ...
    OAIPublishedProductList_allOf_values m_values;
    bool m_values_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPublishedProductList)

#endif // OAIPublishedProductList_H
