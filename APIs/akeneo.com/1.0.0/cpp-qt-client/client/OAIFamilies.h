...
class OAIFamilies_allOf__embedded;
...
public:
    ...
    OAIFamilies_allOf__embedded getEmbedded() const;
    void setEmbedded(const OAIFamilies_allOf__embedded &_embedded);
...
private:
    ...
    OAIFamilies_allOf__embedded m__embedded;
