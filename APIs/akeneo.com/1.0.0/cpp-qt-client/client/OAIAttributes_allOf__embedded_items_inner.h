...
/*
 * OAIAttributes_allOf__embedded_items_inner.h
 *
 * 
 */

#ifndef OAIAttributes_allOf__embedded_items_inner_H
#define OAIAttributes_allOf__embedded_items_inner_H
...
class OAIAttributes_allOf__embedded_items_inner : public OAIObject {
public:
    OAIAttributes_allOf__embedded_items_inner();
    OAIAttributes_allOf__embedded_items_inner(QString json);
    ~OAIAttributes_allOf__embedded_items_inner() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAttributes_allOf__embedded_items_inner)

#endif // OAIAttributes_allOf__embedded_items_inner_H
