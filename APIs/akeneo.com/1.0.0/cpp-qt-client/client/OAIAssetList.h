...
#include "OAIAssetList_allOf_values.h"
...
class OAIAssetList_allOf_values;
...
public:
    ...
    OAIAssetList_allOf_values getValues() const;
    void setValues(const OAIAssetList_allOf_values &values);
...
private:
    ...
    OAIAssetList_allOf_values m_values;
    bool m_values_isSet;
