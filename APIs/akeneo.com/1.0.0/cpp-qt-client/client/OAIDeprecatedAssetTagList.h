...
/*
 * OAIDeprecatedAssetTagList.h
 *
 * 
 */

#ifndef OAIDeprecatedAssetTagList_H
#define OAIDeprecatedAssetTagList_H
...
class OAIDeprecatedAssetTagList : public OAIObject {
public:
    OAIDeprecatedAssetTagList();
    OAIDeprecatedAssetTagList(QString json);
    ~OAIDeprecatedAssetTagList() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeprecatedAssetTagList)

#endif // OAIDeprecatedAssetTagList_H
