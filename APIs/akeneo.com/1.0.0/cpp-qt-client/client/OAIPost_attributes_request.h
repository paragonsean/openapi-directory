...
/*
 * OAIPost_attributes_request.h
 *
 * 
 */

#ifndef OAIPost_attributes_request_H
#define OAIPost_attributes_request_H
...
class OAIPost_attributes_request : public OAIObject {
public:
    OAIPost_attributes_request();
    OAIPost_attributes_request(QString json);
    ~OAIPost_attributes_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPost_attributes_request)

#endif // OAIPost_attributes_request_H
