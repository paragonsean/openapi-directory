...
/*
 * OAIAssetFamilyList_allOf_naming_convention.h
 *
...
#ifndef OAIAssetFamilyList_allOf_naming_convention_H
#define OAIAssetFamilyList_allOf_naming_convention_H
...
class OAIAssetFamilyList_allOf_naming_convention : public OAIObject {
public:
    OAIAssetFamilyList_allOf_naming_convention();
    OAIAssetFamilyList_allOf_naming_convention(QString json);
    ~OAIAssetFamilyList_allOf_naming_convention() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAssetFamilyList_allOf_naming_convention)

#endif // OAIAssetFamilyList_allOf_naming_convention_H
