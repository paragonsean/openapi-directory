...
#ifndef OAIErrorByLine_H
#define OAIErrorByLine_H
...
class OAIErrorByLine : public OAIObject {
public:
    OAIErrorByLine();
    OAIErrorByLine(QString json);
    ~OAIErrorByLine() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIErrorByLine)

#endif // OAIErrorByLine_H
