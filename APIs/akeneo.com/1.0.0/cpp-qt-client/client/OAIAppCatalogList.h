...
#ifndef OAIAppCatalogList_H
#define OAIAppCatalogList_H
...
class OAIAppCatalogList : public OAIObject {
public:
    OAIAppCatalogList();
    OAIAppCatalogList(QString json);
    ~OAIAppCatalogList() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAppCatalogList)

#endif // OAIAppCatalogList_H
