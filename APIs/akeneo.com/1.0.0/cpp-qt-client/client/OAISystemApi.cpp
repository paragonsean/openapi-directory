...
void OAISystemApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("getSystemInformation", defaultConf);
    _serverIndices.insert("getSystemInformation", 0);
}
...
void OAISystemApi::getSystemInformation() {
    QString fullPath = QString(_serverConfigs["getSystemInformation"][_serverIndices.value("getSystemInformation")].URL()+"/api/rest/v1/system-information");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAISystemApi::getSystemInformationCallback);
...
void OAISystemApi::getSystemInformationCallback(OAIHttpRequestWorker *worker) {
    ...
    OAIGet_system_information_200_response output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT getSystemInformationSignal(output);
        Q_EMIT getSystemInformationSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT getSystemInformationSignalE(output, error_type, error_str);
        Q_EMIT getSystemInformationSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT getSystemInformationSignalError(output, error_type, error_str);
        Q_EMIT getSystemInformationSignalErrorFull(worker, error_type, error_str);
    }
}
