...
class OAIAttributes_allOf__embedded;
...
public:
    ...
    OAIAttributes_allOf__embedded getEmbedded() const;
    void setEmbedded(const OAIAttributes_allOf__embedded &_embedded);
...
private:
    ...
    OAIAttributes_allOf__embedded m__embedded;
