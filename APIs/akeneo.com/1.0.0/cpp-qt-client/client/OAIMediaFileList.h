...
#ifndef OAIMediaFileList_H
#define OAIMediaFileList_H
...
class OAIMediaFileList : public OAIObject {
public:
    OAIMediaFileList();
    OAIMediaFileList(QString json);
    ~OAIMediaFileList() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMediaFileList)

#endif // OAIMediaFileList_H
