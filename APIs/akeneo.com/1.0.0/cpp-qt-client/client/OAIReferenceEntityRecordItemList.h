...
/*
 * OAIReferenceEntityRecordItemList.h
 *
 * 
 */

#ifndef OAIReferenceEntityRecordItemList_H
#define OAIReferenceEntityRecordItemList_H
...
class OAIReferenceEntityRecordItemList : public OAIObject {
public:
    OAIReferenceEntityRecordItemList();
    OAIReferenceEntityRecordItemList(QString json);
    ~OAIReferenceEntityRecordItemList() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIReferenceEntityRecordItemList)

#endif // OAIReferenceEntityRecordItemList_H
