...
/*
 * OAIAttributeGroupList.h
 *
 * 
 */

#ifndef OAIAttributeGroupList_H
#define OAIAttributeGroupList_H
...
class OAIAttributeGroupList : public OAIObject {
public:
    OAIAttributeGroupList();
    OAIAttributeGroupList(QString json);
    ~OAIAttributeGroupList() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAttributeGroupList)

#endif // OAIAttributeGroupList_H
