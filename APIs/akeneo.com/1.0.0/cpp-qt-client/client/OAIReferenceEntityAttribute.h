...
/*
 * OAIReferenceEntityAttribute.h
 *
 * 
 */

#ifndef OAIReferenceEntityAttribute_H
#define OAIReferenceEntityAttribute_H
...
class OAIReferenceEntityAttribute : public OAIObject {
public:
    OAIReferenceEntityAttribute();
    OAIReferenceEntityAttribute(QString json);
    ~OAIReferenceEntityAttribute() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIReferenceEntityAttribute)

#endif // OAIReferenceEntityAttribute_H
