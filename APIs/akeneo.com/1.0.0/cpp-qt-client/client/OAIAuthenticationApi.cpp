...
void OAIAuthenticationApi::postToken(const QString &content_type, const QString &authorization, const ::OpenAPI::OptionalParam<OAIPost_token_request> &body) {
    QString fullPath = QString(_serverConfigs["postToken"][_serverIndices.value("postToken")].URL()+"/api/oauth/v1/token");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIAuthenticationApi::postTokenCallback);
...
void OAIAuthenticationApi::postTokenCallback(OAIHttpRequestWorker *worker) {
    ...
    OAIPost_token_200_response output(QString(worker->response));
    worker->deleteLater();
