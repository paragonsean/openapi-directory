...
async def test_get_reference_entity_media_files_code(client):
    ...
    response = await client.request(
        method='GET',
        path='/api/rest/v1/reference-entities-media-files/{code}'.format(code='code_example'),
        headers=headers,
        )
...
async def test_post_reference_entity_media_files(client):
