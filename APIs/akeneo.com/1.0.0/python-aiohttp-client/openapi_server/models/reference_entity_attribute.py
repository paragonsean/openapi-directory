...
class ReferenceEntityAttribute(Model):
    ...
    def __init__(self, allowed_extensions: List[str]=None, code: str=None, decimals_allowed: bool=False, is_required_for_completeness: bool=False, is_rich_text_editor: bool=None, is_textarea: bool=False, labels: GetAssetFamiliesCodeAttributes200ResponseInnerLabels=None, max_characters: int=None, max_file_size: str=None, max_value: str=None, min_value: str=None, reference_entity_code: str=None, type: str=None, validation_regexp: str=None, validation_rule: str='none', value_per_channel: bool=False, value_per_locale: bool=False):
        """ReferenceEntityAttribute - a model defined in OpenAPI

        :param allowed_extensions: The allowed_extensions of this ReferenceEntityAttribute.
        :param code: The code of this ReferenceEntityAttribute.
        :param decimals_allowed: The decimals_allowed of this ReferenceEntityAttribute.
        :param is_required_for_completeness: The is_required_for_completeness of this ReferenceEntityAttribute.
        :param is_rich_text_editor: The is_rich_text_editor of this ReferenceEntityAttribute.
        :param is_textarea: The is_textarea of this ReferenceEntityAttribute.
        :param labels: The labels of this ReferenceEntityAttribute.
        :param max_characters: The max_characters of this ReferenceEntityAttribute.
        :param max_file_size: The max_file_size of this ReferenceEntityAttribute.
        :param max_value: The max_value of this ReferenceEntityAttribute.
        :param min_value: The min_value of this ReferenceEntityAttribute.
        :param reference_entity_code: The reference_entity_code of this ReferenceEntityAttribute.
        :param type: The type of this ReferenceEntityAttribute.
        :param validation_regexp: The validation_regexp of this ReferenceEntityAttribute.
        :param validation_rule: The validation_rule of this ReferenceEntityAttribute.
        :param value_per_channel: The value_per_channel of this ReferenceEntityAttribute.
        :param value_per_locale: The value_per_locale of this ReferenceEntityAttribute.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'ReferenceEntityAttribute':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The ReferenceEntityAttribute of this ReferenceEntityAttribute.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def allowed_extensions(self):
        """Gets the allowed_extensions of this ReferenceEntityAttribute.

        Extensions allowed when the attribute type is `image`

        :return: The allowed_extensions of this ReferenceEntityAttribute.
        :rtype: List[str]
        """
    ...
    def allowed_extensions(self, allowed_extensions):
        """Sets the allowed_extensions of this ReferenceEntityAttribute.
    ...
    @property
    def code(self):
        """Gets the code of this ReferenceEntityAttribute.

        Attribute code

        :return: The code of this ReferenceEntityAttribute.
        :rtype: str
        """
        return self._code
    ...
    @code.setter
    def code(self, code):
        """Sets the code of this ReferenceEntityAttribute.
    ...
    def decimals_allowed(self):
        """Gets the decimals_allowed of this ReferenceEntityAttribute.

        Whether decimals are allowed when the attribute type is `number`

        :return: The decimals_allowed of this ReferenceEntityAttribute.
        :rtype: bool
        """
    ...
    def decimals_allowed(self, decimals_allowed):
        """Sets the decimals_allowed of this ReferenceEntityAttribute.
    ...
    def is_required_for_completeness(self):
        """Gets the is_required_for_completeness of this ReferenceEntityAttribute.

        Whether the attribute should be part of the record's completeness calculation

        :return: The is_required_for_completeness of this ReferenceEntityAttribute.
        :rtype: bool
        """
    ...
    def is_required_for_completeness(self, is_required_for_completeness):
        """Sets the is_required_for_completeness of this ReferenceEntityAttribute.
    ...
    def is_rich_text_editor(self):
        """Gets the is_rich_text_editor of this ReferenceEntityAttribute.

        Whether the UI should display a rich text editor instead of a simple text area when the attribute type is `text`

        :return: The is_rich_text_editor of this ReferenceEntityAttribute.
        :rtype: bool
        """
    ...
    def is_rich_text_editor(self, is_rich_text_editor):
        """Sets the is_rich_text_editor of this ReferenceEntityAttribute.
    ...
    def is_textarea(self):
        """Gets the is_textarea of this ReferenceEntityAttribute.

        Whether the UI should display a text area instead of a simple field when the attribute type is `text`

        :return: The is_textarea of this ReferenceEntityAttribute.
        :rtype: bool
        """
    ...
    def is_textarea(self, is_textarea):
        """Sets the is_textarea of this ReferenceEntityAttribute.
    ...
    @property
    def labels(self):
        """Gets the labels of this ReferenceEntityAttribute.


        :return: The labels of this ReferenceEntityAttribute.
    ...
    def labels(self, labels):
        """Sets the labels of this ReferenceEntityAttribute.
    ...
    def max_characters(self):
        """Gets the max_characters of this ReferenceEntityAttribute.

        Maximum number of characters allowed for the value of the attribute when the attribute type is `text`

        :return: The max_characters of this ReferenceEntityAttribute.
        :rtype: int
        """
    ...
    def max_characters(self, max_characters):
        """Sets the max_characters of this ReferenceEntityAttribute.
    ...
    def max_file_size(self):
        """Gets the max_file_size of this ReferenceEntityAttribute.

        Max file size in MB when the attribute type is `image`

        :return: The max_file_size of this ReferenceEntityAttribute.
        :rtype: str
        """
    ...
    def max_file_size(self, max_file_size):
        """Sets the max_file_size of this ReferenceEntityAttribute.
    ...
    @property
    def max_value(self):
        """Gets the max_value of this ReferenceEntityAttribute.

        Maximum value allowed when the attribute type is `number`

        :return: The max_value of this ReferenceEntityAttribute.
        :rtype: str
        """
    ...
    def max_value(self, max_value):
        """Sets the max_value of this ReferenceEntityAttribute.
    ...
    @property
    def min_value(self):
        """Gets the min_value of this ReferenceEntityAttribute.

        Minimum value allowed when the attribute type is `number`

        :return: The min_value of this ReferenceEntityAttribute.
        :rtype: str
        """
    ...
    def min_value(self, min_value):
        """Sets the min_value of this ReferenceEntityAttribute.
    ...
    def reference_entity_code(self):
        """Gets the reference_entity_code of this ReferenceEntityAttribute.
        ...
        :return: The reference_entity_code of this ReferenceEntityAttribute.
        :rtype: str
        """
    ...
    def reference_entity_code(self, reference_entity_code):
        """Sets the reference_entity_code of this ReferenceEntityAttribute.
    ...
    @type.setter
    def type(self, type):
        """Sets the type of this ReferenceEntityAttribute.
    ...
    def validation_regexp(self):
        """Gets the validation_regexp of this ReferenceEntityAttribute.

        Regexp expression used to validate the attribute value when the attribute type is `text`

        :return: The validation_regexp of this ReferenceEntityAttribute.
        :rtype: str
        """
    ...
    def validation_regexp(self, validation_regexp):
        """Sets the validation_regexp of this ReferenceEntityAttribute.
    ...
    def validation_rule(self):
        """Gets the validation_rule of this ReferenceEntityAttribute.

        Validation rule type used to validate the attribute value when the attribute type is `text`

        :return: The validation_rule of this ReferenceEntityAttribute.
        :rtype: str
        """
    ...
    def validation_rule(self, validation_rule):
        """Sets the validation_rule of this ReferenceEntityAttribute.
    ...
    def value_per_channel(self):
        """Gets the value_per_channel of this ReferenceEntityAttribute.

        Whether the attribute is scopable, i.e. can have one value by channel

        :return: The value_per_channel of this ReferenceEntityAttribute.
        :rtype: bool
        """
    ...
    def value_per_channel(self, value_per_channel):
        """Sets the value_per_channel of this ReferenceEntityAttribute.
    ...
    def value_per_locale(self):
        """Gets the value_per_locale of this ReferenceEntityAttribute.

        Whether the attribute is localizable, i.e. can have one value by locale

        :return: The value_per_locale of this ReferenceEntityAttribute.
        :rtype: bool
        """
    ...
    def value_per_locale(self, value_per_locale):
        """Sets the value_per_locale of this ReferenceEntityAttribute.
