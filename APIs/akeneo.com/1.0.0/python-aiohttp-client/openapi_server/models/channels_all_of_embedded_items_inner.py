...
class ChannelsAllOfEmbeddedItemsInner(Model):
    ...
    def __init__(self, links: PAMAssetCategoriesAllOfEmbeddedItemsInnerAllOfLinks=None, category_tree: str=None, code: str=None, conversion_units: ChannelsAllOfEmbeddedItemsInnerAllOfConversionUnits=None, currencies: List[str]=None, labels: ChannelsAllOfEmbeddedItemsInnerAllOfLabels=None, locales: List[str]=None):
        """ChannelsAllOfEmbeddedItemsInner - a model defined in OpenAPI

        :param links: The links of this ChannelsAllOfEmbeddedItemsInner.
        :param category_tree: The category_tree of this ChannelsAllOfEmbeddedItemsInner.
        :param code: The code of this ChannelsAllOfEmbeddedItemsInner.
        :param conversion_units: The conversion_units of this ChannelsAllOfEmbeddedItemsInner.
        :param currencies: The currencies of this ChannelsAllOfEmbeddedItemsInner.
        :param labels: The labels of this ChannelsAllOfEmbeddedItemsInner.
        :param locales: The locales of this ChannelsAllOfEmbeddedItemsInner.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'ChannelsAllOfEmbeddedItemsInner':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The Channels_allOf__embedded_items_inner of this ChannelsAllOfEmbeddedItemsInner.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def links(self):
        """Gets the links of this ChannelsAllOfEmbeddedItemsInner.


        :return: The links of this ChannelsAllOfEmbeddedItemsInner.
    ...
    def links(self, links):
        """Sets the links of this ChannelsAllOfEmbeddedItemsInner.
    ...
    def category_tree(self):
        """Gets the category_tree of this ChannelsAllOfEmbeddedItemsInner.

        Code of the category tree linked to the channel

        :return: The category_tree of this ChannelsAllOfEmbeddedItemsInner.
        :rtype: str
        """
    ...
    def category_tree(self, category_tree):
        """Sets the category_tree of this ChannelsAllOfEmbeddedItemsInner.
    ...
    @property
    def code(self):
        """Gets the code of this ChannelsAllOfEmbeddedItemsInner.

        Channel code

        :return: The code of this ChannelsAllOfEmbeddedItemsInner.
        :rtype: str
        """
        return self._code
    ...
    @code.setter
    def code(self, code):
        """Sets the code of this ChannelsAllOfEmbeddedItemsInner.
    ...
    def conversion_units(self):
        """Gets the conversion_units of this ChannelsAllOfEmbeddedItemsInner.


        :return: The conversion_units of this ChannelsAllOfEmbeddedItemsInner.
    ...
    def conversion_units(self, conversion_units):
        """Sets the conversion_units of this ChannelsAllOfEmbeddedItemsInner.
    ...
    @property
    def currencies(self):
        """Gets the currencies of this ChannelsAllOfEmbeddedItemsInner.

        Codes of activated currencies for the channel

        :return: The currencies of this ChannelsAllOfEmbeddedItemsInner.
        :rtype: List[str]
        """
    ...
    def currencies(self, currencies):
        """Sets the currencies of this ChannelsAllOfEmbeddedItemsInner.
    ...
    @property
    def labels(self):
        """Gets the labels of this ChannelsAllOfEmbeddedItemsInner.


        :return: The labels of this ChannelsAllOfEmbeddedItemsInner.
    ...
    def labels(self, labels):
        """Sets the labels of this ChannelsAllOfEmbeddedItemsInner.
    ...
    @property
    def locales(self):
        """Gets the locales of this ChannelsAllOfEmbeddedItemsInner.

        Codes of activated locales for the channel

        :return: The locales of this ChannelsAllOfEmbeddedItemsInner.
        :rtype: List[str]
        """
    ...
    def locales(self, locales):
        """Sets the locales of this ChannelsAllOfEmbeddedItemsInner.
