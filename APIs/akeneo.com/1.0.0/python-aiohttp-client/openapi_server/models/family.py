...
class Family(Model):
    ...
    def __init__(self, attribute_as_image: str='null', attribute_as_label: str=None, attribute_requirements: FamiliesAllOfEmbeddedItemsInnerAllOfAttributeRequirements=None, attributes: List[str]=None, code: str=None, labels: FamiliesAllOfEmbeddedItemsInnerAllOfLabels=None):
        ...
        :param attribute_as_image: The attribute_as_image of this Family.
        :param attribute_as_label: The attribute_as_label of this Family.
        :param attribute_requirements: The attribute_requirements of this Family.
        :param attributes: The attributes of this Family.
        :param code: The code of this Family.
        :param labels: The labels of this Family.
        """
        self.openapi_types = {
    ...
    def attribute_as_image(self):
        """Gets the attribute_as_image of this Family.

        Attribute code used as the main picture in the user interface (only since v2.0)

        :return: The attribute_as_image of this Family.
        :rtype: str
        """
    ...
    def attribute_as_label(self):
        """Gets the attribute_as_label of this Family.

        Attribute code used as label

        :return: The attribute_as_label of this Family.
        :rtype: str
        """
    ...
    def attribute_requirements(self):
        """Gets the attribute_requirements of this Family.


        :return: The attribute_requirements of this Family.
    ...
    @property
    def attributes(self):
        """Gets the attributes of this Family.

        Attributes codes that compose the family

        :return: The attributes of this Family.
        :rtype: List[str]
        """
    ...
    @property
    def code(self):
        """Gets the code of this Family.

        Family code

        :return: The code of this Family.
        :rtype: str
        """
        return self._code
    ...
    @property
    def labels(self):
        """Gets the labels of this Family.


        :return: The labels of this Family.
