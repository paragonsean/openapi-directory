...
class ProductUuidList(Model):
    ...
    def __init__(self, links: PAMAssetCategoriesAllOfEmbeddedItemsInnerAllOfLinks=None, associations: Products2AllOfEmbeddedItemsInnerAllOfAssociations=None, categories: List[str]=None, completenesses: List[Products1AllOfEmbeddedItemsInnerAllOfCompletenessesInner]=None, created: str=None, enabled: bool=True, family: str='null only in the case of a non variant product', groups: List[str]=None, metadata: Products1AllOfEmbeddedItemsInnerAllOfMetadata=None, parent: str='null', quality_scores: object=None, quantified_associations: Products2AllOfEmbeddedItemsInnerAllOfQuantifiedAssociations=None, updated: str=None, uuid: str=None, values: ProductListAllOfValues=None):
        """ProductUuidList - a model defined in OpenAPI

        :param links: The links of this ProductUuidList.
        :param associations: The associations of this ProductUuidList.
        :param categories: The categories of this ProductUuidList.
        :param completenesses: The completenesses of this ProductUuidList.
        :param created: The created of this ProductUuidList.
        :param enabled: The enabled of this ProductUuidList.
        :param family: The family of this ProductUuidList.
        :param groups: The groups of this ProductUuidList.
        :param metadata: The metadata of this ProductUuidList.
        :param parent: The parent of this ProductUuidList.
        :param quality_scores: The quality_scores of this ProductUuidList.
        :param quantified_associations: The quantified_associations of this ProductUuidList.
        :param updated: The updated of this ProductUuidList.
        :param uuid: The uuid of this ProductUuidList.
        :param values: The values of this ProductUuidList.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'ProductUuidList':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The ProductUuidList of this ProductUuidList.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def links(self):
        """Gets the links of this ProductUuidList.


        :return: The links of this ProductUuidList.
    ...
    def links(self, links):
        """Sets the links of this ProductUuidList.
    ...
    def associations(self):
        """Gets the associations of this ProductUuidList.


        :return: The associations of this ProductUuidList.
    ...
    def associations(self, associations):
        """Sets the associations of this ProductUuidList.
    ...
    def categories(self, categories):
        """Sets the categories of this ProductUuidList.
    ...
    def completenesses(self):
        """Gets the completenesses of this ProductUuidList.
        ...
        :return: The completenesses of this ProductUuidList.
    ...
    def completenesses(self, completenesses):
        """Sets the completenesses of this ProductUuidList.
    ...
    @property
    def created(self):
        """Gets the created of this ProductUuidList.

        Date of creation

        :return: The created of this ProductUuidList.
        :rtype: str
        """
    ...
    def created(self, created):
        """Sets the created of this ProductUuidList.
    ...
    @property
    def enabled(self):
        """Gets the enabled of this ProductUuidList.

        Whether the product is enabled

        :return: The enabled of this ProductUuidList.
        :rtype: bool
        """
    ...
    def enabled(self, enabled):
        """Sets the enabled of this ProductUuidList.
    ...
    @property
    def family(self):
        """Gets the family of this ProductUuidList.
        ...
        :return: The family of this ProductUuidList.
        :rtype: str
        """
        return self._family
    ...
    def family(self, family):
        """Sets the family of this ProductUuidList.
    ...
    @property
    def groups(self):
        """Gets the groups of this ProductUuidList.

        Codes of the groups to which the product belong

        :return: The groups of this ProductUuidList.
        :rtype: List[str]
        """
        return self._groups
    ...
    def groups(self, groups):
        """Sets the groups of this ProductUuidList.
    ...
    @property
    def metadata(self):
        """Gets the metadata of this ProductUuidList.


        :return: The metadata of this ProductUuidList.
    ...
    def metadata(self, metadata):
        """Sets the metadata of this ProductUuidList.
    ...
    @property
    def parent(self):
        """Gets the parent of this ProductUuidList.
        ...
        :return: The parent of this ProductUuidList.
        :rtype: str
        """
        return self._parent
    ...
    def parent(self, parent):
        """Sets the parent of this ProductUuidList.
    ...
    def quality_scores(self):
        """Gets the quality_scores of this ProductUuidList.
        ...
        :return: The quality_scores of this ProductUuidList.
        :rtype: object
        """
    ...
    def quality_scores(self, quality_scores):
        """Sets the quality_scores of this ProductUuidList.
    ...
    def quantified_associations(self):
        """Gets the quantified_associations of this ProductUuidList.


        :return: The quantified_associations of this ProductUuidList.
    ...
    def quantified_associations(self, quantified_associations):
        """Sets the quantified_associations of this ProductUuidList.
    ...
    @property
    def updated(self):
        """Gets the updated of this ProductUuidList.

        Date of the last update

        :return: The updated of this ProductUuidList.
        :rtype: str
        """
    ...
    def updated(self, updated):
        """Sets the updated of this ProductUuidList.
    ...
    @property
    def uuid(self):
        """Gets the uuid of this ProductUuidList.

        Product uuid

        :return: The uuid of this ProductUuidList.
        :rtype: str
        """
        return self._uuid
    ...
    @uuid.setter
    def uuid(self, uuid):
        """Sets the uuid of this ProductUuidList.
    ...
    @property
    def values(self):
        """Gets the values of this ProductUuidList.


        :return: The values of this ProductUuidList.
    ...
    def values(self, values):
        """Sets the values of this ProductUuidList.
