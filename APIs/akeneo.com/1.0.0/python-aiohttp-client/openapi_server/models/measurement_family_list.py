...
class MeasurementFamilyList(Model):
    ...
    def __init__(self, code: str=None, labels: MeasurementFamiliesGetList200ResponseLabels=None, standard_unit_code: str=None, units: MeasurementFamiliesGetList200ResponseUnits=None):
        """MeasurementFamilyList - a model defined in OpenAPI

        :param code: The code of this MeasurementFamilyList.
        :param labels: The labels of this MeasurementFamilyList.
        :param standard_unit_code: The standard_unit_code of this MeasurementFamilyList.
        :param units: The units of this MeasurementFamilyList.
        """
        self.openapi_types = {
            'code': str,
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'MeasurementFamilyList':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The MeasurementFamilyList of this MeasurementFamilyList.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def code(self):
        """Gets the code of this MeasurementFamilyList.

        Measurement family code

        :return: The code of this MeasurementFamilyList.
        :rtype: str
        """
        return self._code
    ...
    @code.setter
    def code(self, code):
        """Sets the code of this MeasurementFamilyList.
    ...
    @property
    def labels(self):
        """Gets the labels of this MeasurementFamilyList.


        :return: The labels of this MeasurementFamilyList.
    ...
    def labels(self, labels):
        """Sets the labels of this MeasurementFamilyList.
    ...
    def standard_unit_code(self):
        """Gets the standard_unit_code of this MeasurementFamilyList.

        Unit code used as the standard unit for this measurement family

        :return: The standard_unit_code of this MeasurementFamilyList.
        :rtype: str
        """
    ...
    def standard_unit_code(self, standard_unit_code):
        """Sets the standard_unit_code of this MeasurementFamilyList.
    ...
    @property
    def units(self):
        """Gets the units of this MeasurementFamilyList.


        :return: The units of this MeasurementFamilyList.
    ...
    def units(self, units):
        """Sets the units of this MeasurementFamilyList.
