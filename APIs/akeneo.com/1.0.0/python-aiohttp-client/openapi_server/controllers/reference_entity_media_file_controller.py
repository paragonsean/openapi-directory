...
async def get_reference_entity_media_files_code(request: web.Request, code) -> web.Response:
...
async def post_reference_entity_media_files(request: web.Request, content_type, body=None) -> web.Response:
