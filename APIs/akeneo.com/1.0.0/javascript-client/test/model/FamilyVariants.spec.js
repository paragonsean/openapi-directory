...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AkeneoPimRestApi.FamilyVariants();
  });
  ...
  describe('FamilyVariants', function() {
    it('should create an instance of FamilyVariants', function() {
      // uncomment below and update the code to test FamilyVariants
      //var instance = new AkeneoPimRestApi.FamilyVariants();
      //expect(instance).to.be.a(AkeneoPimRestApi.FamilyVariants);
    });
