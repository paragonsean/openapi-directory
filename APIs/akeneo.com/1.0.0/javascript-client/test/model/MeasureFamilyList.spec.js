...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AkeneoPimRestApi.MeasureFamilyList();
  });
  ...
  describe('MeasureFamilyList', function() {
    it('should create an instance of MeasureFamilyList', function() {
      // uncomment below and update the code to test MeasureFamilyList
      //var instance = new AkeneoPimRestApi.MeasureFamilyList();
      //expect(instance).to.be.a(AkeneoPimRestApi.MeasureFamilyList);
    });
