...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AkeneoPimRestApi.PAMAssetCategories();
  });
  ...
  describe('PAMAssetCategories', function() {
    it('should create an instance of PAMAssetCategories', function() {
      // uncomment below and update the code to test PAMAssetCategories
      //var instance = new AkeneoPimRestApi.PAMAssetCategories();
      //expect(instance).to.be.a(AkeneoPimRestApi.PAMAssetCategories);
    });
