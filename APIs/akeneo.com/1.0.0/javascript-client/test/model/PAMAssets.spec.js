...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AkeneoPimRestApi.PAMAssets();
  });
  ...
  describe('PAMAssets', function() {
    it('should create an instance of PAMAssets', function() {
      // uncomment below and update the code to test PAMAssets
      //var instance = new AkeneoPimRestApi.PAMAssets();
      //expect(instance).to.be.a(AkeneoPimRestApi.PAMAssets);
    });
