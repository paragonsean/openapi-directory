...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AkeneoPimRestApi.MeasureFamilies();
  });
  ...
  describe('MeasureFamilies', function() {
    it('should create an instance of MeasureFamilies', function() {
      // uncomment below and update the code to test MeasureFamilies
      //var instance = new AkeneoPimRestApi.MeasureFamilies();
      //expect(instance).to.be.a(AkeneoPimRestApi.MeasureFamilies);
    });
