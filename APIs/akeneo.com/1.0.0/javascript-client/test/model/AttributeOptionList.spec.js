...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AkeneoPimRestApi.AttributeOptionList();
  });
  ...
  describe('AttributeOptionList', function() {
    it('should create an instance of AttributeOptionList', function() {
      // uncomment below and update the code to test AttributeOptionList
      //var instance = new AkeneoPimRestApi.AttributeOptionList();
      //expect(instance).to.be.a(AkeneoPimRestApi.AttributeOptionList);
    });
