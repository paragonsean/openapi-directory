...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AkeneoPimRestApi.PublishedProducts();
  });
  ...
  describe('PublishedProducts', function() {
    it('should create an instance of PublishedProducts', function() {
      // uncomment below and update the code to test PublishedProducts
      //var instance = new AkeneoPimRestApi.PublishedProducts();
      //expect(instance).to.be.a(AkeneoPimRestApi.PublishedProducts);
    });
