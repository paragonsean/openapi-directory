...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AkeneoPimRestApi.MediaFilesAllOfEmbeddedItemsInner();
  });
  ...
  describe('MediaFilesAllOfEmbeddedItemsInner', function() {
    it('should create an instance of MediaFilesAllOfEmbeddedItemsInner', function() {
      // uncomment below and update the code to test MediaFilesAllOfEmbeddedItemsInner
      //var instance = new AkeneoPimRestApi.MediaFilesAllOfEmbeddedItemsInner();
      //expect(instance).to.be.a(AkeneoPimRestApi.MediaFilesAllOfEmbeddedItemsInner);
    });
