...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AkeneoPimRestApi.ProductModels();
  });
  ...
  describe('ProductModels', function() {
    it('should create an instance of ProductModels', function() {
      // uncomment below and update the code to test ProductModels
      //var instance = new AkeneoPimRestApi.ProductModels();
      //expect(instance).to.be.a(AkeneoPimRestApi.ProductModels);
    });
