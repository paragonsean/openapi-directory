...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AkeneoPimRestApi.MeasureFamily();
  });
  ...
  describe('MeasureFamily', function() {
    it('should create an instance of MeasureFamily', function() {
      // uncomment below and update the code to test MeasureFamily
      //var instance = new AkeneoPimRestApi.MeasureFamily();
      //expect(instance).to.be.a(AkeneoPimRestApi.MeasureFamily);
    });
