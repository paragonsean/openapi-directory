...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AkeneoPimRestApi.GetReferenceEntitiesCodeAttributes200ResponseInner();
  });
  ...
  describe('GetReferenceEntitiesCodeAttributes200ResponseInner', function() {
    it('should create an instance of GetReferenceEntitiesCodeAttributes200ResponseInner', function() {
      // uncomment below and update the code to test GetReferenceEntitiesCodeAttributes200ResponseInner
      //var instance = new AkeneoPimRestApi.GetReferenceEntitiesCodeAttributes200ResponseInner();
      //expect(instance).to.be.a(AkeneoPimRestApi.GetReferenceEntitiesCodeAttributes200ResponseInner);
    });
