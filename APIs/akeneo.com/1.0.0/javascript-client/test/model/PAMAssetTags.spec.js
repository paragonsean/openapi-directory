...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AkeneoPimRestApi.PAMAssetTags();
  });
  ...
  describe('PAMAssetTags', function() {
    it('should create an instance of PAMAssetTags', function() {
      // uncomment below and update the code to test PAMAssetTags
      //var instance = new AkeneoPimRestApi.PAMAssetTags();
      //expect(instance).to.be.a(AkeneoPimRestApi.PAMAssetTags);
    });
