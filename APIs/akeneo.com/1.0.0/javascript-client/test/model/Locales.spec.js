...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AkeneoPimRestApi.Locales();
  });
  ...
  describe('Locales', function() {
    it('should create an instance of Locales', function() {
      // uncomment below and update the code to test Locales
      //var instance = new AkeneoPimRestApi.Locales();
      //expect(instance).to.be.a(AkeneoPimRestApi.Locales);
    });
