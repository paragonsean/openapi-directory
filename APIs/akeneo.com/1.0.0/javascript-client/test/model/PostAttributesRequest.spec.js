...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AkeneoPimRestApi.PostAttributesRequest();
  });
  ...
  describe('PostAttributesRequest', function() {
    it('should create an instance of PostAttributesRequest', function() {
      // uncomment below and update the code to test PostAttributesRequest
      //var instance = new AkeneoPimRestApi.PostAttributesRequest();
      //expect(instance).to.be.a(AkeneoPimRestApi.PostAttributesRequest);
    });
