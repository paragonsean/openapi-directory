...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AkeneoPimRestApi.AttributeOptions();
  });
  ...
  describe('AttributeOptions', function() {
    it('should create an instance of AttributeOptions', function() {
      // uncomment below and update the code to test AttributeOptions
      //var instance = new AkeneoPimRestApi.AttributeOptions();
      //expect(instance).to.be.a(AkeneoPimRestApi.AttributeOptions);
    });
