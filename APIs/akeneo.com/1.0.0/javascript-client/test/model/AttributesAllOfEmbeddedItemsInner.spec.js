...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AkeneoPimRestApi.AttributesAllOfEmbeddedItemsInner();
  });
  ...
  describe('AttributesAllOfEmbeddedItemsInner', function() {
    it('should create an instance of AttributesAllOfEmbeddedItemsInner', function() {
      // uncomment below and update the code to test AttributesAllOfEmbeddedItemsInner
      //var instance = new AkeneoPimRestApi.AttributesAllOfEmbeddedItemsInner();
      //expect(instance).to.be.a(AkeneoPimRestApi.AttributesAllOfEmbeddedItemsInner);
    });
