...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AkeneoPimRestApi.GetMediaFilesCode200Response();
  });
  ...
  describe('GetMediaFilesCode200Response', function() {
    it('should create an instance of GetMediaFilesCode200Response', function() {
      // uncomment below and update the code to test GetMediaFilesCode200Response
      //var instance = new AkeneoPimRestApi.GetMediaFilesCode200Response();
      //expect(instance).to.be.a(AkeneoPimRestApi.GetMediaFilesCode200Response);
    });
