...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AkeneoPimRestApi.AttributeOption();
  });
  ...
  describe('AttributeOption', function() {
    it('should create an instance of AttributeOption', function() {
      // uncomment below and update the code to test AttributeOption
      //var instance = new AkeneoPimRestApi.AttributeOption();
      //expect(instance).to.be.a(AkeneoPimRestApi.AttributeOption);
    });
