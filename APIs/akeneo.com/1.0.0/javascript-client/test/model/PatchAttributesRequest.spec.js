...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AkeneoPimRestApi.PatchAttributesRequest();
  });
  ...
  describe('PatchAttributesRequest', function() {
    it('should create an instance of PatchAttributesRequest', function() {
      // uncomment below and update the code to test PatchAttributesRequest
      //var instance = new AkeneoPimRestApi.PatchAttributesRequest();
      //expect(instance).to.be.a(AkeneoPimRestApi.PatchAttributesRequest);
    });
