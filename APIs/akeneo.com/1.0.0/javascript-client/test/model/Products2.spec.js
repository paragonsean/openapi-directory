...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AkeneoPimRestApi.Products2();
  });
  ...
  describe('Products2', function() {
    it('should create an instance of Products2', function() {
      // uncomment below and update the code to test Products2
      //var instance = new AkeneoPimRestApi.Products2();
      //expect(instance).to.be.a(AkeneoPimRestApi.Products2);
    });
