...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AkeneoPimRestApi.AttributeGroups();
  });
  ...
  describe('AttributeGroups', function() {
    it('should create an instance of AttributeGroups', function() {
      // uncomment below and update the code to test AttributeGroups
      //var instance = new AkeneoPimRestApi.AttributeGroups();
      //expect(instance).to.be.a(AkeneoPimRestApi.AttributeGroups);
    });
