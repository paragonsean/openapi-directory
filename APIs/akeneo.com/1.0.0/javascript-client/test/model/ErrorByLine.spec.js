...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AkeneoPimRestApi.ErrorByLine();
  });
  ...
  describe('ErrorByLine', function() {
    it('should create an instance of ErrorByLine', function() {
      // uncomment below and update the code to test ErrorByLine
      //var instance = new AkeneoPimRestApi.ErrorByLine();
      //expect(instance).to.be.a(AkeneoPimRestApi.ErrorByLine);
    });
