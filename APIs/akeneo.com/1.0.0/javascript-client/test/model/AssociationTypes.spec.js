...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AkeneoPimRestApi.AssociationTypes();
  });
  ...
  describe('AssociationTypes', function() {
    it('should create an instance of AssociationTypes', function() {
      // uncomment below and update the code to test AssociationTypes
      //var instance = new AkeneoPimRestApi.AssociationTypes();
      //expect(instance).to.be.a(AkeneoPimRestApi.AssociationTypes);
    });
