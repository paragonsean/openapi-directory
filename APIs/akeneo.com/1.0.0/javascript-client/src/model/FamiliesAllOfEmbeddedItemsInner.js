...
/**
 * The FamiliesAllOfEmbeddedItemsInner model module.
 * @module model/FamiliesAllOfEmbeddedItemsInner
 * @version 1.0.0
 */
class FamiliesAllOfEmbeddedItemsInner {
    /**
     * Constructs a new <code>FamiliesAllOfEmbeddedItemsInner</code>.
     * @alias module:model/FamiliesAllOfEmbeddedItemsInner
     * @param attributeAsLabel {String} Attribute code used as label
     * @param code {String} Family code
     */
    constructor(attributeAsLabel, code) { 
        
        FamiliesAllOfEmbeddedItemsInner.initialize(this, attributeAsLabel, code);
    }
    ...
    /**
     * Constructs a <code>FamiliesAllOfEmbeddedItemsInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/FamiliesAllOfEmbeddedItemsInner} obj Optional instance to populate.
     * @return {module:model/FamiliesAllOfEmbeddedItemsInner} The populated <code>FamiliesAllOfEmbeddedItemsInner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new FamiliesAllOfEmbeddedItemsInner();
    ...
    /**
     * Validates the JSON data with respect to <code>FamiliesAllOfEmbeddedItemsInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>FamiliesAllOfEmbeddedItemsInner</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of FamiliesAllOfEmbeddedItemsInner.RequiredProperties) {
...
FamiliesAllOfEmbeddedItemsInner.RequiredProperties = ["attribute_as_label", "code"];

/**
 * @member {module:model/PAMAssetCategoriesAllOfEmbeddedItemsInnerAllOfLinks} _links
 */
FamiliesAllOfEmbeddedItemsInner.prototype['_links'] = undefined;
 ...
 * @default 'null'
 */
FamiliesAllOfEmbeddedItemsInner.prototype['attribute_as_image'] = 'null';

/**
 * Attribute code used as label
 * @member {String} attribute_as_label
 */
FamiliesAllOfEmbeddedItemsInner.prototype['attribute_as_label'] = undefined;

/**
 * @member {module:model/FamiliesAllOfEmbeddedItemsInnerAllOfAttributeRequirements} attribute_requirements
 */
FamiliesAllOfEmbeddedItemsInner.prototype['attribute_requirements'] = undefined;

/**
 * Attributes codes that compose the family
 * @member {Array.<String>} attributes
 */
FamiliesAllOfEmbeddedItemsInner.prototype['attributes'] = undefined;

/**
 * Family code
 * @member {String} code
 */
FamiliesAllOfEmbeddedItemsInner.prototype['code'] = undefined;

/**
 * @member {module:model/FamiliesAllOfEmbeddedItemsInnerAllOfLabels} labels
 */
FamiliesAllOfEmbeddedItemsInner.prototype['labels'] = undefined;
...
export default FamiliesAllOfEmbeddedItemsInner;
