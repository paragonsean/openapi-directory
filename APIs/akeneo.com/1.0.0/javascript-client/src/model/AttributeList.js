...
/**
 * The AttributeList model module.
 * @module model/AttributeList
 * @version 1.0.0
 */
class AttributeList {
    /**
     * Constructs a new <code>AttributeList</code>.
     * @alias module:model/AttributeList
     * @param code {String} Attribute code
     * @param group {String} Attribute group
     * @param type {module:model/AttributeList.TypeEnum} Attribute type. See <a href='/concepts/catalog-structure.html#attribute'>type</a> section for more details.
     */
    constructor(code, group, type) { 
        
        AttributeList.initialize(this, code, group, type);
    }
    ...
    /**
     * Constructs a <code>AttributeList</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AttributeList} obj Optional instance to populate.
     * @return {module:model/AttributeList} The populated <code>AttributeList</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AttributeList();
    ...
    /**
     * Validates the JSON data with respect to <code>AttributeList</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AttributeList</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of AttributeList.RequiredProperties) {
...
AttributeList.RequiredProperties = ["code", "group", "type"];

/**
 * @member {module:model/PAMAssetCategoriesAllOfEmbeddedItemsInnerAllOfLinks} _links
 */
AttributeList.prototype['_links'] = undefined;
 ...
 */
AttributeList.prototype['decimals_allowed'] = undefined;

/**
 * Default metric unit when the attribute type is `pim_catalog_metric`
 * @member {String} default_metric_unit
 */
AttributeList.prototype['default_metric_unit'] = undefined;
 ...
 */
AttributeList.prototype['default_value'] = undefined;

/**
 * Attribute group
 * @member {String} group
 */
AttributeList.prototype['group'] = undefined;

/**
 * @member {module:model/AttributesAllOfEmbeddedItemsInnerAllOfGroupLabels} group_labels
 */
AttributeList.prototype['group_labels'] = undefined;

/**
 * @member {module:model/GetAssetFamiliesCodeAttributes200ResponseInnerLabels} labels
 */
AttributeList.prototype['labels'] = undefined;
 ...
 * @default false
 */
AttributeList.prototype['localizable'] = false;
 ...
 */
AttributeList.prototype['negative_allowed'] = undefined;
 ...
 */
AttributeList.prototype['number_max'] = undefined;
 ...
 */
AttributeList.prototype['number_min'] = undefined;
 ...
 */
AttributeList.prototype['reference_data_name'] = undefined;
 ...
 * @default false
 */
AttributeList.prototype['scopable'] = false;

/**
 * Order of the attribute in its group
 * @member {Number} sort_order
 */
AttributeList.prototype['sort_order'] = undefined;
 ...
 */
AttributeList.prototype['table_configuration'] = undefined;

/**
 * Attribute type. See <a href='/concepts/catalog-structure.html#attribute'>type</a> section for more details.
 * @member {module:model/AttributeList.TypeEnum} type
 */
AttributeList.prototype['type'] = undefined;

/**
 * Whether two values for the attribute cannot be the same
 * @member {Boolean} unique
 */
AttributeList.prototype['unique'] = undefined;
 ...
 */
AttributeList.prototype['useable_as_grid_filter'] = undefined;
 ...
 */
AttributeList.prototype['validation_regexp'] = undefined;
