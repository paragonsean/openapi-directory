...
/**
 * The GetReferenceEntitiesCodeAttributes200ResponseInner model module.
 * @module model/GetReferenceEntitiesCodeAttributes200ResponseInner
 * @version 1.0.0
 */
class GetReferenceEntitiesCodeAttributes200ResponseInner {
    /**
     * Constructs a new <code>GetReferenceEntitiesCodeAttributes200ResponseInner</code>.
     * @alias module:model/GetReferenceEntitiesCodeAttributes200ResponseInner
     * @param code {String} Attribute code
     * @param type {module:model/GetReferenceEntitiesCodeAttributes200ResponseInner.TypeEnum} Attribute type. See <a href='/concepts/reference-entities.html#reference-entity-attribute'>type</a> section for more details.
     */
    constructor(code, type) { 
        
        GetReferenceEntitiesCodeAttributes200ResponseInner.initialize(this, code, type);
    }
    ...
    /**
     * Constructs a <code>GetReferenceEntitiesCodeAttributes200ResponseInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetReferenceEntitiesCodeAttributes200ResponseInner} obj Optional instance to populate.
     * @return {module:model/GetReferenceEntitiesCodeAttributes200ResponseInner} The populated <code>GetReferenceEntitiesCodeAttributes200ResponseInner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetReferenceEntitiesCodeAttributes200ResponseInner();
    ...
    /**
     * Validates the JSON data with respect to <code>GetReferenceEntitiesCodeAttributes200ResponseInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetReferenceEntitiesCodeAttributes200ResponseInner</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of GetReferenceEntitiesCodeAttributes200ResponseInner.RequiredProperties) {
...
GetReferenceEntitiesCodeAttributes200ResponseInner.RequiredProperties = ["code", "type"];

/**
 * Extensions allowed when the attribute type is `image`
 * @member {Array.<String>} allowed_extensions
 */
GetReferenceEntitiesCodeAttributes200ResponseInner.prototype['allowed_extensions'] = undefined;

/**
 * Attribute code
 * @member {String} code
 */
GetReferenceEntitiesCodeAttributes200ResponseInner.prototype['code'] = undefined;
 ...
 * @default false
 */
GetReferenceEntitiesCodeAttributes200ResponseInner.prototype['decimals_allowed'] = false;
 ...
 * @default false
 */
GetReferenceEntitiesCodeAttributes200ResponseInner.prototype['is_required_for_completeness'] = false;
 ...
 */
GetReferenceEntitiesCodeAttributes200ResponseInner.prototype['is_rich_text_editor'] = undefined;
 ...
 * @default false
 */
GetReferenceEntitiesCodeAttributes200ResponseInner.prototype['is_textarea'] = false;

/**
 * @member {module:model/GetAssetFamiliesCodeAttributes200ResponseInnerLabels} labels
 */
GetReferenceEntitiesCodeAttributes200ResponseInner.prototype['labels'] = undefined;
 ...
 */
GetReferenceEntitiesCodeAttributes200ResponseInner.prototype['max_characters'] = undefined;

/**
 * Max file size in MB when the attribute type is `image`
 * @member {String} max_file_size
 */
GetReferenceEntitiesCodeAttributes200ResponseInner.prototype['max_file_size'] = undefined;

/**
 * Maximum value allowed when the attribute type is `number`
 * @member {String} max_value
 */
GetReferenceEntitiesCodeAttributes200ResponseInner.prototype['max_value'] = undefined;

/**
 * Minimum value allowed when the attribute type is `number`
 * @member {String} min_value
 */
GetReferenceEntitiesCodeAttributes200ResponseInner.prototype['min_value'] = undefined;
 ...
 */
GetReferenceEntitiesCodeAttributes200ResponseInner.prototype['reference_entity_code'] = undefined;

/**
 * Attribute type. See <a href='/concepts/reference-entities.html#reference-entity-attribute'>type</a> section for more details.
 * @member {module:model/GetReferenceEntitiesCodeAttributes200ResponseInner.TypeEnum} type
 */
GetReferenceEntitiesCodeAttributes200ResponseInner.prototype['type'] = undefined;

/**
 * Regexp expression used to validate the attribute value when the attribute type is `text`
 * @member {String} validation_regexp
 */
GetReferenceEntitiesCodeAttributes200ResponseInner.prototype['validation_regexp'] = undefined;

/**
 * Validation rule type used to validate the attribute value when the attribute type is `text`
 * @member {module:model/GetReferenceEntitiesCodeAttributes200ResponseInner.ValidationRuleEnum} validation_rule
 * @default 'none'
 */
GetReferenceEntitiesCodeAttributes200ResponseInner.prototype['validation_rule'] = 'none';
 ...
 * @default false
 */
GetReferenceEntitiesCodeAttributes200ResponseInner.prototype['value_per_channel'] = false;
 ...
 * @default false
 */
GetReferenceEntitiesCodeAttributes200ResponseInner.prototype['value_per_locale'] = false;
 ...
 * @readonly
 */
GetReferenceEntitiesCodeAttributes200ResponseInner['TypeEnum'] = {
 ...
 * @readonly
 */
GetReferenceEntitiesCodeAttributes200ResponseInner['ValidationRuleEnum'] = {
...
export default GetReferenceEntitiesCodeAttributes200ResponseInner;
