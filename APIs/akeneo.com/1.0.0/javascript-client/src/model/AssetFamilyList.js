...
import AssetFamilyListAllOfNamingConvention from './AssetFamilyListAllOfNamingConvention';
import PAMAssetCategoriesAllOfEmbeddedItemsInnerAllOfLinks from './PAMAssetCategoriesAllOfEmbeddedItemsInnerAllOfLinks';

/**
 * The AssetFamilyList model module.
 * @module model/AssetFamilyList
 * @version 1.0.0
 */
class AssetFamilyList {
    /**
     * Constructs a new <code>AssetFamilyList</code>.
     * @alias module:model/AssetFamilyList
     * @param code {String} Asset family code
     */
    constructor(code) { 
        
        AssetFamilyList.initialize(this, code);
    }
    ...
    /**
     * Constructs a <code>AssetFamilyList</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AssetFamilyList} obj Optional instance to populate.
     * @return {module:model/AssetFamilyList} The populated <code>AssetFamilyList</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AssetFamilyList();
            ...
            if (data.hasOwnProperty('naming_convention')) {
                obj['naming_convention'] = AssetFamilyListAllOfNamingConvention.constructFromObject(data['naming_convention']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>AssetFamilyList</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AssetFamilyList</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of AssetFamilyList.RequiredProperties) {
        ...
        if (data['naming_convention']) { // data not null
          AssetFamilyListAllOfNamingConvention.validateJSON(data['naming_convention']);
        }
...
AssetFamilyList.RequiredProperties = ["code"];

/**
 * @member {module:model/PAMAssetCategoriesAllOfEmbeddedItemsInnerAllOfLinks} _links
 */
AssetFamilyList.prototype['_links'] = undefined;
 ...
 */
AssetFamilyList.prototype['attribute_as_main_media'] = 'First media file or media link attribute that was created';

/**
 * Asset family code
 * @member {String} code
 */
AssetFamilyList.prototype['code'] = undefined;

/**
 * @member {module:model/AssetFamiliesAllOfEmbeddedItemsInnerAllOfLabels} labels
 */
AssetFamilyList.prototype['labels'] = undefined;

/**
 * @member {module:model/AssetFamilyListAllOfNamingConvention} naming_convention
 */
AssetFamilyList.prototype['naming_convention'] = undefined;
 ...
 */
AssetFamilyList.prototype['product_link_rules'] = undefined;
 ...
 */
AssetFamilyList.prototype['transformations'] = undefined;
...
export default AssetFamilyList;
