...
import ProductListAllOfValues from './ProductListAllOfValues';
...
/**
 * The ProductUuidList model module.
 * @module model/ProductUuidList
 * @version 1.0.0
 */
class ProductUuidList {
    /**
     * Constructs a new <code>ProductUuidList</code>.
     * @alias module:model/ProductUuidList
     */
    constructor() { 
        
        ProductUuidList.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ProductUuidList</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ProductUuidList} obj Optional instance to populate.
     * @return {module:model/ProductUuidList} The populated <code>ProductUuidList</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ProductUuidList();
            ...
            if (data.hasOwnProperty('values')) {
                obj['values'] = ProductListAllOfValues.constructFromObject(data['values']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ProductUuidList</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ProductUuidList</code>.
     */
    static validateJSON(data) {
        ...
        if (data['values']) { // data not null
          ProductListAllOfValues.validateJSON(data['values']);
        }
 ...
 */
ProductUuidList.prototype['completenesses'] = undefined;

/**
 * Date of creation
 * @member {String} created
 */
ProductUuidList.prototype['created'] = undefined;
 ...
 * @default true
 */
ProductUuidList.prototype['enabled'] = true;
 ...
 */
ProductUuidList.prototype['family'] = 'null only in the case of a non variant product';

/**
 * Codes of the groups to which the product belong
 * @member {Array.<String>} groups
 */
ProductUuidList.prototype['groups'] = undefined;

/**
 * @member {module:model/Products1AllOfEmbeddedItemsInnerAllOfMetadata} metadata
 */
ProductUuidList.prototype['metadata'] = undefined;
 ...
 * @default 'null'
 */
ProductUuidList.prototype['parent'] = 'null';
 ...
 */
ProductUuidList.prototype['quality_scores'] = undefined;

/**
 * @member {module:model/Products2AllOfEmbeddedItemsInnerAllOfQuantifiedAssociations} quantified_associations
 */
ProductUuidList.prototype['quantified_associations'] = undefined;

/**
 * Date of the last update
 * @member {String} updated
 */
ProductUuidList.prototype['updated'] = undefined;

/**
 * Product uuid
 * @member {String} uuid
 */
ProductUuidList.prototype['uuid'] = undefined;

/**
 * @member {module:model/ProductListAllOfValues} values
 */
ProductUuidList.prototype['values'] = undefined;
...
export default ProductUuidList;
