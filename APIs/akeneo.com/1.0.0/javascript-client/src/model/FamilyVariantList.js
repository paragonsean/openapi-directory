...
/**
 * The FamilyVariantList model module.
 * @module model/FamilyVariantList
 * @version 1.0.0
 */
class FamilyVariantList {
    /**
     * Constructs a new <code>FamilyVariantList</code>.
     * @alias module:model/FamilyVariantList
    ...
    constructor(code, variantAttributeSets) { 
        ...
        FamilyVariantList.initialize(this, code, variantAttributeSets);
    }
    ...
    /**
     * Constructs a <code>FamilyVariantList</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/FamilyVariantList} obj Optional instance to populate.
     * @return {module:model/FamilyVariantList} The populated <code>FamilyVariantList</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new FamilyVariantList();
    ...
    /**
     * Validates the JSON data with respect to <code>FamilyVariantList</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>FamilyVariantList</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of FamilyVariantList.RequiredProperties) {
...
FamilyVariantList.RequiredProperties = ["code", "variant_attribute_sets"];

/**
 * @member {module:model/PAMAssetCategoriesAllOfEmbeddedItemsInnerAllOfLinks} _links
 */
FamilyVariantList.prototype['_links'] = undefined;

/**
 * Family variant code
 * @member {String} code
 */
FamilyVariantList.prototype['code'] = undefined;

/**
 * @member {module:model/FamilyVariantsAllOfEmbeddedItemsInnerAllOfLabels} labels
 */
FamilyVariantList.prototype['labels'] = undefined;
 ...
 */
FamilyVariantList.prototype['variant_attribute_sets'] = undefined;
