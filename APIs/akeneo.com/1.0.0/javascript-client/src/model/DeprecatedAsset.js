...
/**
 * The DeprecatedAsset model module.
 * @module model/DeprecatedAsset
 * @version 1.0.0
 */
class DeprecatedAsset {
    /**
     * Constructs a new <code>DeprecatedAsset</code>.
     * @alias module:model/DeprecatedAsset
     * @param code {String} PAM asset code
     */
    constructor(code) { 
        
        DeprecatedAsset.initialize(this, code);
    }
    ...
    /**
     * Constructs a <code>DeprecatedAsset</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DeprecatedAsset} obj Optional instance to populate.
     * @return {module:model/DeprecatedAsset} The populated <code>DeprecatedAsset</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DeprecatedAsset();
    ...
    /**
     * Validates the JSON data with respect to <code>DeprecatedAsset</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DeprecatedAsset</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DeprecatedAsset.RequiredProperties) {
...
DeprecatedAsset.RequiredProperties = ["code"];

/**
 * Codes of the PAM asset categories in which the asset is classified
 * @member {Array.<String>} categories
 */
DeprecatedAsset.prototype['categories'] = undefined;

/**
 * PAM asset code
 * @member {String} code
 */
DeprecatedAsset.prototype['code'] = undefined;

/**
 * Description of the PAM asset
 * @member {String} description
 */
DeprecatedAsset.prototype['description'] = undefined;

/**
 * Date on which the PAM asset expire
 * @member {String} end_of_use
 */
DeprecatedAsset.prototype['end_of_use'] = undefined;
 ...
 * @default false
 */
DeprecatedAsset.prototype['localizable'] = false;
 ...
 */
DeprecatedAsset.prototype['reference_files'] = undefined;

/**
 * Tags of the PAM asset
 * @member {Array.<String>} tags
 */
DeprecatedAsset.prototype['tags'] = undefined;
 ...
 */
DeprecatedAsset.prototype['variation_files'] = undefined;
...
export default DeprecatedAsset;
