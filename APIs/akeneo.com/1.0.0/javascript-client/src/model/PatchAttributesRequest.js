...
/**
 * The PatchAttributesRequest model module.
 * @module model/PatchAttributesRequest
 * @version 1.0.0
 */
class PatchAttributesRequest {
    /**
     * Constructs a new <code>PatchAttributesRequest</code>.
     * @alias module:model/PatchAttributesRequest
     * @param code {String} Attribute code
     * @param group {String} Attribute group
     * @param type {module:model/PatchAttributesRequest.TypeEnum} Attribute type. See <a href='/concepts/catalog-structure.html#attribute'>type</a> section for more details.
     */
    constructor(code, group, type) { 
        
        PatchAttributesRequest.initialize(this, code, group, type);
    }
    ...
    /**
     * Constructs a <code>PatchAttributesRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PatchAttributesRequest} obj Optional instance to populate.
     * @return {module:model/PatchAttributesRequest} The populated <code>PatchAttributesRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PatchAttributesRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>PatchAttributesRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PatchAttributesRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of PatchAttributesRequest.RequiredProperties) {
...
PatchAttributesRequest.RequiredProperties = ["code", "group", "type"];
 ...
 */
PatchAttributesRequest.prototype['decimals_allowed'] = undefined;

/**
 * Default metric unit when the attribute type is `pim_catalog_metric`
 * @member {String} default_metric_unit
 */
PatchAttributesRequest.prototype['default_metric_unit'] = undefined;
 ...
 */
PatchAttributesRequest.prototype['default_value'] = undefined;

/**
 * Attribute group
 * @member {String} group
 */
PatchAttributesRequest.prototype['group'] = undefined;

/**
 * @member {module:model/AttributesAllOfEmbeddedItemsInnerAllOfGroupLabels} group_labels
 */
PatchAttributesRequest.prototype['group_labels'] = undefined;

/**
 * @member {module:model/GetAssetFamiliesCodeAttributes200ResponseInnerLabels} labels
 */
PatchAttributesRequest.prototype['labels'] = undefined;
 ...
 * @default false
 */
PatchAttributesRequest.prototype['localizable'] = false;
 ...
 */
PatchAttributesRequest.prototype['negative_allowed'] = undefined;
 ...
 */
PatchAttributesRequest.prototype['number_max'] = undefined;
 ...
 */
PatchAttributesRequest.prototype['number_min'] = undefined;
 ...
 */
PatchAttributesRequest.prototype['reference_data_name'] = undefined;
 ...
 * @default false
 */
PatchAttributesRequest.prototype['scopable'] = false;

/**
 * Order of the attribute in its group
 * @member {Number} sort_order
 */
PatchAttributesRequest.prototype['sort_order'] = undefined;
 ...
 */
PatchAttributesRequest.prototype['table_configuration'] = undefined;

/**
 * Attribute type. See <a href='/concepts/catalog-structure.html#attribute'>type</a> section for more details.
 * @member {module:model/PatchAttributesRequest.TypeEnum} type
 */
PatchAttributesRequest.prototype['type'] = undefined;

/**
 * Whether two values for the attribute cannot be the same
 * @member {Boolean} unique
 */
PatchAttributesRequest.prototype['unique'] = undefined;
 ...
 */
PatchAttributesRequest.prototype['useable_as_grid_filter'] = undefined;
 ...
 */
PatchAttributesRequest.prototype['validation_regexp'] = undefined;
 ...
 */
PatchAttributesRequest.prototype['validation_rule'] = undefined;

/**
 * Whether the WYSIWYG interface is shown when the attribute type is `pim_catalog_textarea`
 * @member {Boolean} wysiwyg_enabled
 */
PatchAttributesRequest.prototype['wysiwyg_enabled'] = undefined;
 ...
 * @readonly
 */
PatchAttributesRequest['TypeEnum'] = {
...
export default PatchAttributesRequest;
