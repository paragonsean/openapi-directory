...
/**
 * The PatchFamiliesRequest model module.
 * @module model/PatchFamiliesRequest
 * @version 1.0.0
 */
class PatchFamiliesRequest {
    /**
     * Constructs a new <code>PatchFamiliesRequest</code>.
     * @alias module:model/PatchFamiliesRequest
     * @param attributeAsLabel {String} Attribute code used as label
     * @param code {String} Family code
     */
    constructor(attributeAsLabel, code) { 
        
        PatchFamiliesRequest.initialize(this, attributeAsLabel, code);
    }
    ...
    /**
     * Constructs a <code>PatchFamiliesRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PatchFamiliesRequest} obj Optional instance to populate.
     * @return {module:model/PatchFamiliesRequest} The populated <code>PatchFamiliesRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PatchFamiliesRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>PatchFamiliesRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PatchFamiliesRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of PatchFamiliesRequest.RequiredProperties) {
...
PatchFamiliesRequest.RequiredProperties = ["attribute_as_label", "code"];
 ...
 * @default 'null'
 */
PatchFamiliesRequest.prototype['attribute_as_image'] = 'null';

/**
 * Attribute code used as label
 * @member {String} attribute_as_label
 */
PatchFamiliesRequest.prototype['attribute_as_label'] = undefined;

/**
 * @member {module:model/FamiliesAllOfEmbeddedItemsInnerAllOfAttributeRequirements} attribute_requirements
 */
PatchFamiliesRequest.prototype['attribute_requirements'] = undefined;

/**
 * Attributes codes that compose the family
 * @member {Array.<String>} attributes
 */
PatchFamiliesRequest.prototype['attributes'] = undefined;

/**
 * Family code
 * @member {String} code
 */
PatchFamiliesRequest.prototype['code'] = undefined;

/**
 * @member {module:model/FamiliesAllOfEmbeddedItemsInnerAllOfLabels} labels
 */
PatchFamiliesRequest.prototype['labels'] = undefined;
...
export default PatchFamiliesRequest;
