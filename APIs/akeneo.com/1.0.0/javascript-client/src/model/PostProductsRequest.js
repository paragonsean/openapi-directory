...
/**
 * The PostProductsRequest model module.
 * @module model/PostProductsRequest
 * @version 1.0.0
 */
class PostProductsRequest {
    /**
     * Constructs a new <code>PostProductsRequest</code>.
     * @alias module:model/PostProductsRequest
     * @param identifier {String} Product identifier, i.e. the value of the only `pim_catalog_identifier` attribute
     */
    constructor(identifier) { 
        
        PostProductsRequest.initialize(this, identifier);
    }
    ...
    /**
     * Constructs a <code>PostProductsRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PostProductsRequest} obj Optional instance to populate.
     * @return {module:model/PostProductsRequest} The populated <code>PostProductsRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PostProductsRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>PostProductsRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PostProductsRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of PostProductsRequest.RequiredProperties) {
 ...
 */
PostProductsRequest.prototype['completenesses'] = undefined;

/**
 * Date of creation
 * @member {String} created
 */
PostProductsRequest.prototype['created'] = undefined;
 ...
 * @default true
 */
PostProductsRequest.prototype['enabled'] = true;
 ...
 */
PostProductsRequest.prototype['family'] = 'null only in the case of a non variant product';

/**
 * Codes of the groups to which the product belong
 * @member {Array.<String>} groups
 */
PostProductsRequest.prototype['groups'] = undefined;

/**
 * Product identifier, i.e. the value of the only `pim_catalog_identifier` attribute
 * @member {String} identifier
 */
PostProductsRequest.prototype['identifier'] = undefined;

/**
 * @member {module:model/Products1AllOfEmbeddedItemsInnerAllOfMetadata} metadata
 */
PostProductsRequest.prototype['metadata'] = undefined;
 ...
 * @default 'null'
 */
PostProductsRequest.prototype['parent'] = 'null';
 ...
 */
PostProductsRequest.prototype['quality_scores'] = undefined;

/**
 * @member {module:model/Products1AllOfEmbeddedItemsInnerAllOfQuantifiedAssociations} quantified_associations
 */
PostProductsRequest.prototype['quantified_associations'] = undefined;

/**
 * Date of the last update
 * @member {String} updated
 */
PostProductsRequest.prototype['updated'] = undefined;

/**
 * Product UUID
 * @member {String} uuid
 */
PostProductsRequest.prototype['uuid'] = undefined;

/**
 * @member {module:model/Products1AllOfEmbeddedItemsInnerAllOfValues} values
 */
PostProductsRequest.prototype['values'] = undefined;
...
export default PostProductsRequest;
