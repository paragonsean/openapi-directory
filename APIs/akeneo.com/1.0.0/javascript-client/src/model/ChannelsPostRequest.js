...
/**
 * The ChannelsPostRequest model module.
 * @module model/ChannelsPostRequest
 * @version 1.0.0
 */
class ChannelsPostRequest {
    /**
     * Constructs a new <code>ChannelsPostRequest</code>.
     * @alias module:model/ChannelsPostRequest
    ...
    constructor(categoryTree, code, currencies, locales) { 
        ...
        ChannelsPostRequest.initialize(this, categoryTree, code, currencies, locales);
    }
    ...
    /**
     * Constructs a <code>ChannelsPostRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ChannelsPostRequest} obj Optional instance to populate.
     * @return {module:model/ChannelsPostRequest} The populated <code>ChannelsPostRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ChannelsPostRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>ChannelsPostRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ChannelsPostRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ChannelsPostRequest.RequiredProperties) {
...
export default ChannelsPostRequest;
