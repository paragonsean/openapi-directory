...
/**
 * The PatchPamAssetsRequest model module.
 * @module model/PatchPamAssetsRequest
 * @version 1.0.0
 */
class PatchPamAssetsRequest {
    /**
     * Constructs a new <code>PatchPamAssetsRequest</code>.
     * @alias module:model/PatchPamAssetsRequest
     * @param code {String} PAM asset code
     */
    constructor(code) { 
        
        PatchPamAssetsRequest.initialize(this, code);
    }
    ...
    /**
     * Constructs a <code>PatchPamAssetsRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PatchPamAssetsRequest} obj Optional instance to populate.
     * @return {module:model/PatchPamAssetsRequest} The populated <code>PatchPamAssetsRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PatchPamAssetsRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>PatchPamAssetsRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PatchPamAssetsRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of PatchPamAssetsRequest.RequiredProperties) {
...
PatchPamAssetsRequest.RequiredProperties = ["code"];

/**
 * Codes of the PAM asset categories in which the asset is classified
 * @member {Array.<String>} categories
 */
PatchPamAssetsRequest.prototype['categories'] = undefined;

/**
 * PAM asset code
 * @member {String} code
 */
PatchPamAssetsRequest.prototype['code'] = undefined;

/**
 * Description of the PAM asset
 * @member {String} description
 */
PatchPamAssetsRequest.prototype['description'] = undefined;

/**
 * Date on which the PAM asset expire
 * @member {String} end_of_use
 */
PatchPamAssetsRequest.prototype['end_of_use'] = undefined;
 ...
 * @default false
 */
PatchPamAssetsRequest.prototype['localizable'] = false;
 ...
 */
PatchPamAssetsRequest.prototype['reference_files'] = undefined;

/**
 * Tags of the PAM asset
 * @member {Array.<String>} tags
 */
PatchPamAssetsRequest.prototype['tags'] = undefined;
 ...
 */
PatchPamAssetsRequest.prototype['variation_files'] = undefined;
...
export default PatchPamAssetsRequest;
