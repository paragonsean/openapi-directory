...
/**
 * The MeasurementFamilyList model module.
 * @module model/MeasurementFamilyList
 * @version 1.0.0
 */
class MeasurementFamilyList {
    /**
     * Constructs a new <code>MeasurementFamilyList</code>.
     * @alias module:model/MeasurementFamilyList
    ...
    constructor(code, standardUnitCode, units) { 
        ...
        MeasurementFamilyList.initialize(this, code, standardUnitCode, units);
    }
    ...
    /**
     * Constructs a <code>MeasurementFamilyList</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/MeasurementFamilyList} obj Optional instance to populate.
     * @return {module:model/MeasurementFamilyList} The populated <code>MeasurementFamilyList</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new MeasurementFamilyList();
    ...
    /**
     * Validates the JSON data with respect to <code>MeasurementFamilyList</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>MeasurementFamilyList</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of MeasurementFamilyList.RequiredProperties) {
...
MeasurementFamilyList.RequiredProperties = ["code", "standard_unit_code", "units"];

/**
 * Measurement family code
 * @member {String} code
 */
MeasurementFamilyList.prototype['code'] = undefined;

/**
 * @member {module:model/MeasurementFamiliesGetList200ResponseLabels} labels
 */
MeasurementFamilyList.prototype['labels'] = undefined;

/**
 * Unit code used as the standard unit for this measurement family
 * @member {String} standard_unit_code
 */
MeasurementFamilyList.prototype['standard_unit_code'] = undefined;

/**
 * @member {module:model/MeasurementFamiliesGetList200ResponseUnits} units
 */
MeasurementFamilyList.prototype['units'] = undefined;
...
export default MeasurementFamilyList;
