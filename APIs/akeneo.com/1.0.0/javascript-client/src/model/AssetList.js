...
import AssetListAllOfValues from './AssetListAllOfValues';
...
class AssetList {
    ...
    constructor(code) { 
        ...
        AssetList.initialize(this, code);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('values')) {
                obj['values'] = AssetListAllOfValues.constructFromObject(data['values']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>AssetList</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AssetList</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of AssetList.RequiredProperties) {
        ...
        if (data['values']) { // data not null
          AssetListAllOfValues.validateJSON(data['values']);
        }
...
AssetList.RequiredProperties = ["code"];

/**
 * @member {module:model/PAMAssetCategoriesAllOfEmbeddedItemsInnerAllOfLinks} _links
 */
AssetList.prototype['_links'] = undefined;

/**
 * Code of the asset
 * @member {String} code
 */
AssetList.prototype['code'] = undefined;

/**
 * Date of creation
 * @member {String} created
 */
AssetList.prototype['created'] = undefined;

/**
 * Date of the last update
 * @member {String} updated
 */
AssetList.prototype['updated'] = undefined;

/**
 * @member {module:model/AssetListAllOfValues} values
 */
AssetList.prototype['values'] = undefined;
