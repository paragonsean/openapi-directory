...
/**
 * The PublishedProduct model module.
 * @module model/PublishedProduct
 * @version 1.0.0
 */
class PublishedProduct {
    /**
     * Constructs a new <code>PublishedProduct</code>.
     * @alias module:model/PublishedProduct
     * @param identifier {String} Published product identifier, i.e. the value of the only `pim_catalog_identifier` attribute
     */
    constructor(identifier) { 
        
        PublishedProduct.initialize(this, identifier);
    }
    ...
    /**
     * Constructs a <code>PublishedProduct</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PublishedProduct} obj Optional instance to populate.
     * @return {module:model/PublishedProduct} The populated <code>PublishedProduct</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PublishedProduct();
    ...
    /**
     * Validates the JSON data with respect to <code>PublishedProduct</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PublishedProduct</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of PublishedProduct.RequiredProperties) {
 ...
 * @default true
 */
PublishedProduct.prototype['enabled'] = true;
 ...
 */
PublishedProduct.prototype['quantified_associations'] = undefined;

/**
 * Date of the last update
 * @member {String} updated
 */
PublishedProduct.prototype['updated'] = undefined;

/**
 * @member {module:model/PublishedProductsAllOfEmbeddedItemsInnerAllOfValues} values
 */
PublishedProduct.prototype['values'] = undefined;
