...
class AssociationType {
    ...
    constructor(code) { 
        ...
        AssociationType.initialize(this, code);
    }
    ...
    /**
     * Validates the JSON data with respect to <code>AssociationType</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AssociationType</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of AssociationType.RequiredProperties) {
...
AssociationType.RequiredProperties = ["code"];

/**
 * Association type code
 * @member {String} code
 */
AssociationType.prototype['code'] = undefined;
 ...
 * @default false
 */
AssociationType.prototype['is_quantified'] = false;
 ...
 * @default false
 */
AssociationType.prototype['is_two_way'] = false;

/**
 * @member {module:model/AssociationTypesAllOfEmbeddedItemsInnerAllOfLabels} labels
 */
AssociationType.prototype['labels'] = undefined;
