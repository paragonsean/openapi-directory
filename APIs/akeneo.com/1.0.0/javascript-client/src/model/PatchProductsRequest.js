...
/**
 * The PatchProductsRequest model module.
 * @module model/PatchProductsRequest
 * @version 1.0.0
 */
class PatchProductsRequest {
    /**
     * Constructs a new <code>PatchProductsRequest</code>.
     * @alias module:model/PatchProductsRequest
     * @param identifier {String} Product identifier, i.e. the value of the only `pim_catalog_identifier` attribute
     */
    constructor(identifier) { 
        
        PatchProductsRequest.initialize(this, identifier);
    }
    ...
    /**
     * Constructs a <code>PatchProductsRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PatchProductsRequest} obj Optional instance to populate.
     * @return {module:model/PatchProductsRequest} The populated <code>PatchProductsRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PatchProductsRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>PatchProductsRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PatchProductsRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of PatchProductsRequest.RequiredProperties) {
 ...
 */
PatchProductsRequest.prototype['completenesses'] = undefined;

/**
 * Date of creation
 * @member {String} created
 */
PatchProductsRequest.prototype['created'] = undefined;
 ...
 * @default true
 */
PatchProductsRequest.prototype['enabled'] = true;
 ...
 */
PatchProductsRequest.prototype['family'] = 'null only in the case of a non variant product';

/**
 * Codes of the groups to which the product belong
 * @member {Array.<String>} groups
 */
PatchProductsRequest.prototype['groups'] = undefined;

/**
 * Product identifier, i.e. the value of the only `pim_catalog_identifier` attribute
 * @member {String} identifier
 */
PatchProductsRequest.prototype['identifier'] = undefined;

/**
 * @member {module:model/Products1AllOfEmbeddedItemsInnerAllOfMetadata} metadata
 */
PatchProductsRequest.prototype['metadata'] = undefined;
 ...
 * @default 'null'
 */
PatchProductsRequest.prototype['parent'] = 'null';
 ...
 */
PatchProductsRequest.prototype['quality_scores'] = undefined;

/**
 * @member {module:model/Products1AllOfEmbeddedItemsInnerAllOfQuantifiedAssociations} quantified_associations
 */
PatchProductsRequest.prototype['quantified_associations'] = undefined;

/**
 * Date of the last update
 * @member {String} updated
 */
PatchProductsRequest.prototype['updated'] = undefined;

/**
 * Product UUID
 * @member {String} uuid
 */
PatchProductsRequest.prototype['uuid'] = undefined;

/**
 * @member {module:model/Products1AllOfEmbeddedItemsInnerAllOfValues} values
 */
PatchProductsRequest.prototype['values'] = undefined;
...
export default PatchProductsRequest;
