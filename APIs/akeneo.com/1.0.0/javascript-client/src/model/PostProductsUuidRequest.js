...
/**
 * The PostProductsUuidRequest model module.
 * @module model/PostProductsUuidRequest
 * @version 1.0.0
 */
class PostProductsUuidRequest {
    /**
     * Constructs a new <code>PostProductsUuidRequest</code>.
     * @alias module:model/PostProductsUuidRequest
     */
    constructor() { 
        
        PostProductsUuidRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PostProductsUuidRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PostProductsUuidRequest} obj Optional instance to populate.
     * @return {module:model/PostProductsUuidRequest} The populated <code>PostProductsUuidRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PostProductsUuidRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>PostProductsUuidRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PostProductsUuidRequest</code>.
     */
 ...
 */
PostProductsUuidRequest.prototype['associations'] = undefined;

/**
 * Codes of the <a href='api-reference.html#Category'>categories</a> in which the product is classified
 * @member {Array.<String>} categories
 */
PostProductsUuidRequest.prototype['categories'] = undefined;
 ...
 */
PostProductsUuidRequest.prototype['completenesses'] = undefined;

/**
 * Date of creation
 * @member {String} created
 */
PostProductsUuidRequest.prototype['created'] = undefined;
 ...
 * @default true
 */
PostProductsUuidRequest.prototype['enabled'] = true;
 ...
 */
PostProductsUuidRequest.prototype['family'] = 'null only in the case of a non variant product';

/**
 * Codes of the groups to which the product belong
 * @member {Array.<String>} groups
 */
PostProductsUuidRequest.prototype['groups'] = undefined;

/**
 * @member {module:model/Products1AllOfEmbeddedItemsInnerAllOfMetadata} metadata
 */
PostProductsUuidRequest.prototype['metadata'] = undefined;
 ...
 * @default 'null'
 */
PostProductsUuidRequest.prototype['parent'] = 'null';
 ...
 */
PostProductsUuidRequest.prototype['quality_scores'] = undefined;

/**
 * @member {module:model/Products2AllOfEmbeddedItemsInnerAllOfQuantifiedAssociations} quantified_associations
 */
PostProductsUuidRequest.prototype['quantified_associations'] = undefined;

/**
 * Date of the last update
 * @member {String} updated
 */
PostProductsUuidRequest.prototype['updated'] = undefined;

/**
 * Product uuid
 * @member {String} uuid
 */
PostProductsUuidRequest.prototype['uuid'] = undefined;

/**
 * @member {module:model/Products1AllOfEmbeddedItemsInnerAllOfValues} values
 */
PostProductsUuidRequest.prototype['values'] = undefined;
...
export default PostProductsUuidRequest;
