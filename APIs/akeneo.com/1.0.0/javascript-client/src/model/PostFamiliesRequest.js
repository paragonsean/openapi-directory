...
/**
 * The PostFamiliesRequest model module.
 * @module model/PostFamiliesRequest
 * @version 1.0.0
 */
class PostFamiliesRequest {
    /**
     * Constructs a new <code>PostFamiliesRequest</code>.
     * @alias module:model/PostFamiliesRequest
     * @param attributeAsLabel {String} Attribute code used as label
     * @param code {String} Family code
     */
    constructor(attributeAsLabel, code) { 
        
        PostFamiliesRequest.initialize(this, attributeAsLabel, code);
    }
    ...
    /**
     * Constructs a <code>PostFamiliesRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PostFamiliesRequest} obj Optional instance to populate.
     * @return {module:model/PostFamiliesRequest} The populated <code>PostFamiliesRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PostFamiliesRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>PostFamiliesRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PostFamiliesRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of PostFamiliesRequest.RequiredProperties) {
...
PostFamiliesRequest.RequiredProperties = ["attribute_as_label", "code"];
 ...
 * @default 'null'
 */
PostFamiliesRequest.prototype['attribute_as_image'] = 'null';

/**
 * Attribute code used as label
 * @member {String} attribute_as_label
 */
PostFamiliesRequest.prototype['attribute_as_label'] = undefined;

/**
 * @member {module:model/FamiliesAllOfEmbeddedItemsInnerAllOfAttributeRequirements} attribute_requirements
 */
PostFamiliesRequest.prototype['attribute_requirements'] = undefined;

/**
 * Attributes codes that compose the family
 * @member {Array.<String>} attributes
 */
PostFamiliesRequest.prototype['attributes'] = undefined;

/**
 * Family code
 * @member {String} code
 */
PostFamiliesRequest.prototype['code'] = undefined;

/**
 * @member {module:model/FamiliesAllOfEmbeddedItemsInnerAllOfLabels} labels
 */
PostFamiliesRequest.prototype['labels'] = undefined;
...
export default PostFamiliesRequest;
