...
/**
 * The PostPamAssetsRequest model module.
 * @module model/PostPamAssetsRequest
 * @version 1.0.0
 */
class PostPamAssetsRequest {
    /**
     * Constructs a new <code>PostPamAssetsRequest</code>.
     * @alias module:model/PostPamAssetsRequest
     * @param code {String} PAM asset code
     */
    constructor(code) { 
        
        PostPamAssetsRequest.initialize(this, code);
    }
    ...
    /**
     * Constructs a <code>PostPamAssetsRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PostPamAssetsRequest} obj Optional instance to populate.
     * @return {module:model/PostPamAssetsRequest} The populated <code>PostPamAssetsRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PostPamAssetsRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>PostPamAssetsRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PostPamAssetsRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of PostPamAssetsRequest.RequiredProperties) {
...
PostPamAssetsRequest.RequiredProperties = ["code"];

/**
 * Codes of the PAM asset categories in which the asset is classified
 * @member {Array.<String>} categories
 */
PostPamAssetsRequest.prototype['categories'] = undefined;

/**
 * PAM asset code
 * @member {String} code
 */
PostPamAssetsRequest.prototype['code'] = undefined;

/**
 * Description of the PAM asset
 * @member {String} description
 */
PostPamAssetsRequest.prototype['description'] = undefined;

/**
 * Date on which the PAM asset expire
 * @member {String} end_of_use
 */
PostPamAssetsRequest.prototype['end_of_use'] = undefined;
 ...
 * @default false
 */
PostPamAssetsRequest.prototype['localizable'] = false;
 ...
 */
PostPamAssetsRequest.prototype['reference_files'] = undefined;

/**
 * Tags of the PAM asset
 * @member {Array.<String>} tags
 */
PostPamAssetsRequest.prototype['tags'] = undefined;
 ...
 */
PostPamAssetsRequest.prototype['variation_files'] = undefined;
...
export default PostPamAssetsRequest;
