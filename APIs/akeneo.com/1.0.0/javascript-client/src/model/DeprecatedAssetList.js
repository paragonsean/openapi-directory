...
/**
 * The DeprecatedAssetList model module.
 * @module model/DeprecatedAssetList
 * @version 1.0.0
 */
class DeprecatedAssetList {
    /**
     * Constructs a new <code>DeprecatedAssetList</code>.
     * @alias module:model/DeprecatedAssetList
     * @param code {String} PAM asset code
     */
    constructor(code) { 
        
        DeprecatedAssetList.initialize(this, code);
    }
    ...
    /**
     * Constructs a <code>DeprecatedAssetList</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DeprecatedAssetList} obj Optional instance to populate.
     * @return {module:model/DeprecatedAssetList} The populated <code>DeprecatedAssetList</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DeprecatedAssetList();
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DeprecatedAssetList</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DeprecatedAssetList.RequiredProperties) {
...
DeprecatedAssetList.RequiredProperties = ["code"];

/**
 * @member {module:model/PAMAssetCategoriesAllOfEmbeddedItemsInnerAllOfLinks} _links
 */
DeprecatedAssetList.prototype['_links'] = undefined;

/**
 * Codes of the PAM asset categories in which the asset is classified
 * @member {Array.<String>} categories
 */
DeprecatedAssetList.prototype['categories'] = undefined;

/**
 * PAM asset code
 * @member {String} code
 */
DeprecatedAssetList.prototype['code'] = undefined;

/**
 * Description of the PAM asset
 * @member {String} description
 */
DeprecatedAssetList.prototype['description'] = undefined;

/**
 * Date on which the PAM asset expire
 * @member {String} end_of_use
 */
DeprecatedAssetList.prototype['end_of_use'] = undefined;
 ...
 * @default false
 */
DeprecatedAssetList.prototype['localizable'] = false;
 ...
 */
DeprecatedAssetList.prototype['reference_files'] = undefined;

/**
 * Tags of the PAM asset
 * @member {Array.<String>} tags
 */
DeprecatedAssetList.prototype['tags'] = undefined;
 ...
 */
DeprecatedAssetList.prototype['variation_files'] = undefined;
...
export default DeprecatedAssetList;
