...
import MediaFilesAllOfEmbedded from './MediaFilesAllOfEmbedded';
...
class MediaFiles {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('_embedded')) {
                obj['_embedded'] = MediaFilesAllOfEmbedded.constructFromObject(data['_embedded']);
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        if (data['_embedded']) { // data not null
          MediaFilesAllOfEmbedded.validateJSON(data['_embedded']);
        }
 ...
 */
MediaFiles.prototype['_links'] = undefined;

/**
 * Current page number
 * @member {Number} current_page
 */
MediaFiles.prototype['current_page'] = undefined;

/**
 * @member {module:model/MediaFilesAllOfEmbedded} _embedded
 */
MediaFiles.prototype['_embedded'] = undefined;
