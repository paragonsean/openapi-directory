...
import AttributesAllOfEmbedded from './AttributesAllOfEmbedded';
...
class Attributes {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('_embedded')) {
                obj['_embedded'] = AttributesAllOfEmbedded.constructFromObject(data['_embedded']);
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        if (data['_embedded']) { // data not null
          AttributesAllOfEmbedded.validateJSON(data['_embedded']);
        }
 ...
 */
Attributes.prototype['_links'] = undefined;

/**
 * Current page number
 * @member {Number} current_page
 */
Attributes.prototype['current_page'] = undefined;

/**
 * @member {module:model/AttributesAllOfEmbedded} _embedded
 */
Attributes.prototype['_embedded'] = undefined;
