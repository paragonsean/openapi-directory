...
/**
 * The PostAttributesRequest model module.
 * @module model/PostAttributesRequest
 * @version 1.0.0
 */
class PostAttributesRequest {
    /**
     * Constructs a new <code>PostAttributesRequest</code>.
     * @alias module:model/PostAttributesRequest
     * @param code {String} Attribute code
     * @param group {String} Attribute group
     * @param type {module:model/PostAttributesRequest.TypeEnum} Attribute type. See <a href='/concepts/catalog-structure.html#attribute'>type</a> section for more details.
     */
    constructor(code, group, type) { 
        
        PostAttributesRequest.initialize(this, code, group, type);
    }
    ...
    /**
     * Constructs a <code>PostAttributesRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PostAttributesRequest} obj Optional instance to populate.
     * @return {module:model/PostAttributesRequest} The populated <code>PostAttributesRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PostAttributesRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>PostAttributesRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PostAttributesRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of PostAttributesRequest.RequiredProperties) {
...
PostAttributesRequest.RequiredProperties = ["code", "group", "type"];
 ...
 */
PostAttributesRequest.prototype['decimals_allowed'] = undefined;

/**
 * Default metric unit when the attribute type is `pim_catalog_metric`
 * @member {String} default_metric_unit
 */
PostAttributesRequest.prototype['default_metric_unit'] = undefined;
 ...
 */
PostAttributesRequest.prototype['default_value'] = undefined;

/**
 * Attribute group
 * @member {String} group
 */
PostAttributesRequest.prototype['group'] = undefined;

/**
 * @member {module:model/AttributesAllOfEmbeddedItemsInnerAllOfGroupLabels} group_labels
 */
PostAttributesRequest.prototype['group_labels'] = undefined;

/**
 * @member {module:model/GetAssetFamiliesCodeAttributes200ResponseInnerLabels} labels
 */
PostAttributesRequest.prototype['labels'] = undefined;
 ...
 * @default false
 */
PostAttributesRequest.prototype['localizable'] = false;
 ...
 */
PostAttributesRequest.prototype['negative_allowed'] = undefined;
 ...
 */
PostAttributesRequest.prototype['number_max'] = undefined;
 ...
 */
PostAttributesRequest.prototype['number_min'] = undefined;
 ...
 */
PostAttributesRequest.prototype['reference_data_name'] = undefined;
 ...
 * @default false
 */
PostAttributesRequest.prototype['scopable'] = false;

/**
 * Order of the attribute in its group
 * @member {Number} sort_order
 */
PostAttributesRequest.prototype['sort_order'] = undefined;
 ...
 */
PostAttributesRequest.prototype['table_configuration'] = undefined;

/**
 * Attribute type. See <a href='/concepts/catalog-structure.html#attribute'>type</a> section for more details.
 * @member {module:model/PostAttributesRequest.TypeEnum} type
 */
PostAttributesRequest.prototype['type'] = undefined;

/**
 * Whether two values for the attribute cannot be the same
 * @member {Boolean} unique
 */
PostAttributesRequest.prototype['unique'] = undefined;
 ...
 */
PostAttributesRequest.prototype['useable_as_grid_filter'] = undefined;
 ...
 */
PostAttributesRequest.prototype['validation_regexp'] = undefined;
 ...
 * @readonly
 */
PostAttributesRequest['TypeEnum'] = {
...
export default PostAttributesRequest;
