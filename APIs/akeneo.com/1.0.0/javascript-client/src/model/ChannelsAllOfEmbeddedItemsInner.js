...
/**
 * The ChannelsAllOfEmbeddedItemsInner model module.
 * @module model/ChannelsAllOfEmbeddedItemsInner
 * @version 1.0.0
 */
class ChannelsAllOfEmbeddedItemsInner {
    /**
     * Constructs a new <code>ChannelsAllOfEmbeddedItemsInner</code>.
     * @alias module:model/ChannelsAllOfEmbeddedItemsInner
    ...
    constructor(categoryTree, code, currencies, locales) { 
        ...
        ChannelsAllOfEmbeddedItemsInner.initialize(this, categoryTree, code, currencies, locales);
    }
    ...
    /**
     * Constructs a <code>ChannelsAllOfEmbeddedItemsInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ChannelsAllOfEmbeddedItemsInner} obj Optional instance to populate.
     * @return {module:model/ChannelsAllOfEmbeddedItemsInner} The populated <code>ChannelsAllOfEmbeddedItemsInner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ChannelsAllOfEmbeddedItemsInner();
    ...
    /**
     * Validates the JSON data with respect to <code>ChannelsAllOfEmbeddedItemsInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ChannelsAllOfEmbeddedItemsInner</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ChannelsAllOfEmbeddedItemsInner.RequiredProperties) {
...
ChannelsAllOfEmbeddedItemsInner.RequiredProperties = ["category_tree", "code", "currencies", "locales"];

/**
 * @member {module:model/PAMAssetCategoriesAllOfEmbeddedItemsInnerAllOfLinks} _links
 */
ChannelsAllOfEmbeddedItemsInner.prototype['_links'] = undefined;

/**
 * Code of the category tree linked to the channel
 * @member {String} category_tree
 */
ChannelsAllOfEmbeddedItemsInner.prototype['category_tree'] = undefined;

/**
 * Channel code
 * @member {String} code
 */
ChannelsAllOfEmbeddedItemsInner.prototype['code'] = undefined;

/**
 * @member {module:model/ChannelsAllOfEmbeddedItemsInnerAllOfConversionUnits} conversion_units
 */
ChannelsAllOfEmbeddedItemsInner.prototype['conversion_units'] = undefined;

/**
 * Codes of activated currencies for the channel
 * @member {Array.<String>} currencies
 */
ChannelsAllOfEmbeddedItemsInner.prototype['currencies'] = undefined;

/**
 * @member {module:model/ChannelsAllOfEmbeddedItemsInnerAllOfLabels} labels
 */
ChannelsAllOfEmbeddedItemsInner.prototype['labels'] = undefined;

/**
 * Codes of activated locales for the channel
 * @member {Array.<String>} locales
 */
ChannelsAllOfEmbeddedItemsInner.prototype['locales'] = undefined;
...
export default ChannelsAllOfEmbeddedItemsInner;
