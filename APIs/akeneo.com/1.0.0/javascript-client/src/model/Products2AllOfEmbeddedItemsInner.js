...
/**
 * The Products2AllOfEmbeddedItemsInner model module.
 * @module model/Products2AllOfEmbeddedItemsInner
 * @version 1.0.0
 */
class Products2AllOfEmbeddedItemsInner {
    /**
     * Constructs a new <code>Products2AllOfEmbeddedItemsInner</code>.
     * @alias module:model/Products2AllOfEmbeddedItemsInner
     */
    constructor() { 
        
        Products2AllOfEmbeddedItemsInner.initialize(this);
    }
    ...
    /**
     * Constructs a <code>Products2AllOfEmbeddedItemsInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Products2AllOfEmbeddedItemsInner} obj Optional instance to populate.
     * @return {module:model/Products2AllOfEmbeddedItemsInner} The populated <code>Products2AllOfEmbeddedItemsInner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new Products2AllOfEmbeddedItemsInner();
    ...
    /**
     * Validates the JSON data with respect to <code>Products2AllOfEmbeddedItemsInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Products2AllOfEmbeddedItemsInner</code>.
     */
 ...
 */
Products2AllOfEmbeddedItemsInner.prototype['_links'] = undefined;

/**
 * @member {module:model/Products2AllOfEmbeddedItemsInnerAllOfAssociations} associations
 */
Products2AllOfEmbeddedItemsInner.prototype['associations'] = undefined;

/**
 * Codes of the <a href='api-reference.html#Category'>categories</a> in which the product is classified
 * @member {Array.<String>} categories
 */
Products2AllOfEmbeddedItemsInner.prototype['categories'] = undefined;
 ...
 */
Products2AllOfEmbeddedItemsInner.prototype['completenesses'] = undefined;

/**
 * Date of creation
 * @member {String} created
 */
Products2AllOfEmbeddedItemsInner.prototype['created'] = undefined;
 ...
 * @default true
 */
Products2AllOfEmbeddedItemsInner.prototype['enabled'] = true;
 ...
 */
Products2AllOfEmbeddedItemsInner.prototype['family'] = 'null only in the case of a non variant product';

/**
 * Codes of the groups to which the product belong
 * @member {Array.<String>} groups
 */
Products2AllOfEmbeddedItemsInner.prototype['groups'] = undefined;

/**
 * @member {module:model/Products1AllOfEmbeddedItemsInnerAllOfMetadata} metadata
 */
Products2AllOfEmbeddedItemsInner.prototype['metadata'] = undefined;
 ...
 * @default 'null'
 */
Products2AllOfEmbeddedItemsInner.prototype['parent'] = 'null';
 ...
 */
Products2AllOfEmbeddedItemsInner.prototype['quality_scores'] = undefined;

/**
 * @member {module:model/Products2AllOfEmbeddedItemsInnerAllOfQuantifiedAssociations} quantified_associations
 */
Products2AllOfEmbeddedItemsInner.prototype['quantified_associations'] = undefined;

/**
 * Date of the last update
 * @member {String} updated
 */
Products2AllOfEmbeddedItemsInner.prototype['updated'] = undefined;

/**
 * Product uuid
 * @member {String} uuid
 */
Products2AllOfEmbeddedItemsInner.prototype['uuid'] = undefined;

/**
 * @member {module:model/Products1AllOfEmbeddedItemsInnerAllOfValues} values
 */
Products2AllOfEmbeddedItemsInner.prototype['values'] = undefined;
...
export default Products2AllOfEmbeddedItemsInner;
