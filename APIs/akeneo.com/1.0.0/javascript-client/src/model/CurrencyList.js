...
class CurrencyList {
    ...
    constructor(code) { 
        ...
        CurrencyList.initialize(this, code);
    }
...
CurrencyList.RequiredProperties = ["code"];

/**
 * @member {module:model/PAMAssetCategoriesAllOfEmbeddedItemsInnerAllOfLinks} _links
 */
CurrencyList.prototype['_links'] = undefined;

/**
 * Currency code
 * @member {String} code
 */
CurrencyList.prototype['code'] = undefined;

/**
 * Whether the currency is enabled
 * @member {Boolean} enabled
 */
CurrencyList.prototype['enabled'] = undefined;
