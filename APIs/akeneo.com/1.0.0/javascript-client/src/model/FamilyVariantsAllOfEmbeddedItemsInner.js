...
/**
 * The FamilyVariantsAllOfEmbeddedItemsInner model module.
 * @module model/FamilyVariantsAllOfEmbeddedItemsInner
 * @version 1.0.0
 */
class FamilyVariantsAllOfEmbeddedItemsInner {
    /**
     * Constructs a new <code>FamilyVariantsAllOfEmbeddedItemsInner</code>.
     * @alias module:model/FamilyVariantsAllOfEmbeddedItemsInner
    ...
    constructor(code, variantAttributeSets) { 
        ...
        FamilyVariantsAllOfEmbeddedItemsInner.initialize(this, code, variantAttributeSets);
    }
    ...
    /**
     * Constructs a <code>FamilyVariantsAllOfEmbeddedItemsInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/FamilyVariantsAllOfEmbeddedItemsInner} obj Optional instance to populate.
     * @return {module:model/FamilyVariantsAllOfEmbeddedItemsInner} The populated <code>FamilyVariantsAllOfEmbeddedItemsInner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new FamilyVariantsAllOfEmbeddedItemsInner();
    ...
    /**
     * Validates the JSON data with respect to <code>FamilyVariantsAllOfEmbeddedItemsInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>FamilyVariantsAllOfEmbeddedItemsInner</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of FamilyVariantsAllOfEmbeddedItemsInner.RequiredProperties) {
...
FamilyVariantsAllOfEmbeddedItemsInner.RequiredProperties = ["code", "variant_attribute_sets"];

/**
 * @member {module:model/PAMAssetCategoriesAllOfEmbeddedItemsInnerAllOfLinks} _links
 */
FamilyVariantsAllOfEmbeddedItemsInner.prototype['_links'] = undefined;

/**
 * Family variant code
 * @member {String} code
 */
FamilyVariantsAllOfEmbeddedItemsInner.prototype['code'] = undefined;

/**
 * @member {module:model/FamilyVariantsAllOfEmbeddedItemsInnerAllOfLabels} labels
 */
FamilyVariantsAllOfEmbeddedItemsInner.prototype['labels'] = undefined;
 ...
 */
FamilyVariantsAllOfEmbeddedItemsInner.prototype['variant_attribute_sets'] = undefined;
...
export default FamilyVariantsAllOfEmbeddedItemsInner;
