...
|------------ | ------------- | ------------- | -------------|
|**attributeAsImage** | **String** | Attribute code used as the main picture in the user interface (only since v2.0) |  [optional] |
...
|**attributes** | **List&lt;String&gt;** | Attributes codes that compose the family |  [optional] |
