...
import org.openapitools.client.api.ProductIdentifierApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    ProductIdentifierApi apiInstance = new ProductIdentifierApi(defaultClient);
    String code = "code_example"; // String | Code of the resource
    try {
      apiInstance.deleteProductsCode(code);
    } catch (ApiException e) {
      System.err.println("Exception when calling ProductIdentifierApi#deleteProductsCode");
...
public class Example {
  public static void main(String[] args) {
    ...
    String code = "code_example"; // String | Code of the resource
    try {
      PostProductsRequest result = apiInstance.getDraftCode(code);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling ProductIdentifierApi#getDraftCode");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="getProducts"></a>
# **getProducts**
> Products1 getProducts(search, scope, locales, attributes, paginationType, page, searchAfter, limit, withCount, withAttributeOptions, withQualityScores, withCompletenesses)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      Products1 result = apiInstance.getProducts(search, scope, locales, attributes, paginationType, page, searchAfter, limit, withCount, withAttributeOptions, withQualityScores, withCompletenesses);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling ProductIdentifierApi#getProducts");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="getProductsCode"></a>
# **getProductsCode**
> PostProductsRequest getProductsCode(code, withAttributeOptions, withQualityScores, withCompletenesses)
...
public class Example {
  public static void main(String[] args) {
    ...
    Boolean withCompletenesses = false; // Boolean | Return product completenesses in the response. (Only available since the 6.0 version)
    try {
      PostProductsRequest result = apiInstance.getProductsCode(code, withAttributeOptions, withQualityScores, withCompletenesses);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling ProductIdentifierApi#getProductsCode");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="patchProducts"></a>
# **patchProducts**
> PatchAssetCategories200Response patchProducts(body)
...
public class Example {
  public static void main(String[] args) {
    ...
    ProductIdentifierApi apiInstance = new ProductIdentifierApi(defaultClient);
    PatchProductsRequest body = new PatchProductsRequest(); // PatchProductsRequest | 
    try {
      PatchAssetCategories200Response result = apiInstance.patchProducts(body);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling ProductIdentifierApi#patchProducts");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
public class Example {
  public static void main(String[] args) {
    ...
    ProductIdentifierApi apiInstance = new ProductIdentifierApi(defaultClient);
    String code = "code_example"; // String | Code of the resource
    PostProductsRequest body = new PostProductsRequest(); // PostProductsRequest | 
    try {
      apiInstance.patchProductsCode(code, body);
    } catch (ApiException e) {
      System.err.println("Exception when calling ProductIdentifierApi#patchProductsCode");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ...
      System.err.println("Exception when calling ProductIdentifierApi#postProducts");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ...
      System.err.println("Exception when calling ProductIdentifierApi#postProposal");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
