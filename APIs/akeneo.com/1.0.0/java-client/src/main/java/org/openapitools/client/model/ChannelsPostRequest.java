...
public class ChannelsPostRequest {
  ...
  public ChannelsPostRequest() {
  }

  public ChannelsPostRequest categoryTree(String categoryTree) {
  ...
  public ChannelsPostRequest code(String code) {
    this.code = code;
    return this;
  }
  ...
  public ChannelsPostRequest conversionUnits(ChannelsAllOfEmbeddedItemsInnerAllOfConversionUnits conversionUnits) {
  ...
  public ChannelsPostRequest currencies(List<String> currencies) {
    this.currencies = currencies;
    return this;
  }

  public ChannelsPostRequest addCurrenciesItem(String currenciesItem) {
  ...
  public ChannelsPostRequest labels(ChannelsAllOfEmbeddedItemsInnerAllOfLabels labels) {
    this.labels = labels;
    return this;
  }
  ...
  public ChannelsPostRequest locales(List<String> locales) {
    this.locales = locales;
    return this;
  }

  public ChannelsPostRequest addLocalesItem(String localesItem) {
  ...
  public boolean equals(Object o) {
    ...
    ChannelsPostRequest channelsPostRequest = (ChannelsPostRequest) o;
    return Objects.equals(this.categoryTree, channelsPostRequest.categoryTree) &&
        Objects.equals(this.code, channelsPostRequest.code) &&
        Objects.equals(this.conversionUnits, channelsPostRequest.conversionUnits) &&
        Objects.equals(this.currencies, channelsPostRequest.currencies) &&
        Objects.equals(this.labels, channelsPostRequest.labels) &&
        Objects.equals(this.locales, channelsPostRequest.locales);
  }
  ...
  public String toString() {
    ...
    sb.append("class ChannelsPostRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ChannelsPostRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ChannelsPostRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ChannelsPostRequest is not found in the empty JSON string", ChannelsPostRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ChannelsPostRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ChannelsPostRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ChannelsPostRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ChannelsPostRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ChannelsPostRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ChannelsPostRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ChannelsPostRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<ChannelsPostRequest>() {
           @Override
           public void write(JsonWriter out, ChannelsPostRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ChannelsPostRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ChannelsPostRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ChannelsPostRequest
   * @throws IOException if the JSON string is invalid with respect to ChannelsPostRequest
   */
  public static ChannelsPostRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ChannelsPostRequest.class);
  }

  /**
   * Convert an instance of ChannelsPostRequest to an JSON string
   *
   * @return JSON string
   */
