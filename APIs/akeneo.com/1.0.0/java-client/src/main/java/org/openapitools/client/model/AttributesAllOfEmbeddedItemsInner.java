...
public class AttributesAllOfEmbeddedItemsInner {
  ...
  public AttributesAllOfEmbeddedItemsInner() {
  }

  public AttributesAllOfEmbeddedItemsInner links(PAMAssetCategoriesAllOfEmbeddedItemsInnerAllOfLinks links) {
    this.links = links;
    return this;
  }
  ...
  public AttributesAllOfEmbeddedItemsInner allowedExtensions(List<String> allowedExtensions) {
    this.allowedExtensions = allowedExtensions;
    return this;
  }

  public AttributesAllOfEmbeddedItemsInner addAllowedExtensionsItem(String allowedExtensionsItem) {
  ...
  public AttributesAllOfEmbeddedItemsInner availableLocales(List<String> availableLocales) {
    this.availableLocales = availableLocales;
    return this;
  }

  public AttributesAllOfEmbeddedItemsInner addAvailableLocalesItem(String availableLocalesItem) {
  ...
  public AttributesAllOfEmbeddedItemsInner code(String code) {
    this.code = code;
    return this;
  }
  ...
  public AttributesAllOfEmbeddedItemsInner dateMax(OffsetDateTime dateMax) {
  ...
  public AttributesAllOfEmbeddedItemsInner dateMin(OffsetDateTime dateMin) {
  ...
  public AttributesAllOfEmbeddedItemsInner decimalsAllowed(Boolean decimalsAllowed) {
  ...
  public AttributesAllOfEmbeddedItemsInner defaultMetricUnit(String defaultMetricUnit) {
  ...
  public AttributesAllOfEmbeddedItemsInner defaultValue(Boolean defaultValue) {
  ...
  public AttributesAllOfEmbeddedItemsInner group(String group) {
    this.group = group;
    return this;
  }
  ...
  public AttributesAllOfEmbeddedItemsInner groupLabels(AttributesAllOfEmbeddedItemsInnerAllOfGroupLabels groupLabels) {
  ...
  public AttributesAllOfEmbeddedItemsInner labels(GetAssetFamiliesCodeAttributes200ResponseInnerLabels labels) {
    this.labels = labels;
    return this;
  }
  ...
  public AttributesAllOfEmbeddedItemsInner localizable(Boolean localizable) {
  ...
  public AttributesAllOfEmbeddedItemsInner maxCharacters(Integer maxCharacters) {
  ...
  public AttributesAllOfEmbeddedItemsInner maxFileSize(String maxFileSize) {
  ...
  public AttributesAllOfEmbeddedItemsInner metricFamily(String metricFamily) {
  ...
  public AttributesAllOfEmbeddedItemsInner negativeAllowed(Boolean negativeAllowed) {
  ...
  public AttributesAllOfEmbeddedItemsInner numberMax(String numberMax) {
  ...
  public AttributesAllOfEmbeddedItemsInner numberMin(String numberMin) {
  ...
  public AttributesAllOfEmbeddedItemsInner referenceDataName(String referenceDataName) {
  ...
  public AttributesAllOfEmbeddedItemsInner scopable(Boolean scopable) {
  ...
  public AttributesAllOfEmbeddedItemsInner sortOrder(Integer sortOrder) {
  ...
  public AttributesAllOfEmbeddedItemsInner tableConfiguration(List<AttributesAllOfEmbeddedItemsInnerAllOfTableConfigurationInner> tableConfiguration) {
    this.tableConfiguration = tableConfiguration;
    return this;
  }

  public AttributesAllOfEmbeddedItemsInner addTableConfigurationItem(AttributesAllOfEmbeddedItemsInnerAllOfTableConfigurationInner tableConfigurationItem) {
  ...
  public AttributesAllOfEmbeddedItemsInner type(TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  public AttributesAllOfEmbeddedItemsInner unique(Boolean unique) {
    this.unique = unique;
    return this;
  }
  ...
  public AttributesAllOfEmbeddedItemsInner useableAsGridFilter(Boolean useableAsGridFilter) {
  ...
  public AttributesAllOfEmbeddedItemsInner validationRegexp(String validationRegexp) {
  ...
  public AttributesAllOfEmbeddedItemsInner validationRule(String validationRule) {
  ...
  public AttributesAllOfEmbeddedItemsInner wysiwygEnabled(Boolean wysiwygEnabled) {
  ...
  public boolean equals(Object o) {
    ...
    AttributesAllOfEmbeddedItemsInner attributesAllOfEmbeddedItemsInner = (AttributesAllOfEmbeddedItemsInner) o;
    return Objects.equals(this.links, attributesAllOfEmbeddedItemsInner.links) &&
        Objects.equals(this.allowedExtensions, attributesAllOfEmbeddedItemsInner.allowedExtensions) &&
        Objects.equals(this.availableLocales, attributesAllOfEmbeddedItemsInner.availableLocales) &&
        Objects.equals(this.code, attributesAllOfEmbeddedItemsInner.code) &&
        Objects.equals(this.dateMax, attributesAllOfEmbeddedItemsInner.dateMax) &&
        Objects.equals(this.dateMin, attributesAllOfEmbeddedItemsInner.dateMin) &&
        Objects.equals(this.decimalsAllowed, attributesAllOfEmbeddedItemsInner.decimalsAllowed) &&
        Objects.equals(this.defaultMetricUnit, attributesAllOfEmbeddedItemsInner.defaultMetricUnit) &&
        Objects.equals(this.defaultValue, attributesAllOfEmbeddedItemsInner.defaultValue) &&
        Objects.equals(this.group, attributesAllOfEmbeddedItemsInner.group) &&
        Objects.equals(this.groupLabels, attributesAllOfEmbeddedItemsInner.groupLabels) &&
        Objects.equals(this.labels, attributesAllOfEmbeddedItemsInner.labels) &&
        Objects.equals(this.localizable, attributesAllOfEmbeddedItemsInner.localizable) &&
        Objects.equals(this.maxCharacters, attributesAllOfEmbeddedItemsInner.maxCharacters) &&
        Objects.equals(this.maxFileSize, attributesAllOfEmbeddedItemsInner.maxFileSize) &&
        Objects.equals(this.metricFamily, attributesAllOfEmbeddedItemsInner.metricFamily) &&
        Objects.equals(this.negativeAllowed, attributesAllOfEmbeddedItemsInner.negativeAllowed) &&
        Objects.equals(this.numberMax, attributesAllOfEmbeddedItemsInner.numberMax) &&
        Objects.equals(this.numberMin, attributesAllOfEmbeddedItemsInner.numberMin) &&
        Objects.equals(this.referenceDataName, attributesAllOfEmbeddedItemsInner.referenceDataName) &&
        Objects.equals(this.scopable, attributesAllOfEmbeddedItemsInner.scopable) &&
        Objects.equals(this.sortOrder, attributesAllOfEmbeddedItemsInner.sortOrder) &&
        Objects.equals(this.tableConfiguration, attributesAllOfEmbeddedItemsInner.tableConfiguration) &&
        Objects.equals(this.type, attributesAllOfEmbeddedItemsInner.type) &&
        Objects.equals(this.unique, attributesAllOfEmbeddedItemsInner.unique) &&
        Objects.equals(this.useableAsGridFilter, attributesAllOfEmbeddedItemsInner.useableAsGridFilter) &&
        Objects.equals(this.validationRegexp, attributesAllOfEmbeddedItemsInner.validationRegexp) &&
        Objects.equals(this.validationRule, attributesAllOfEmbeddedItemsInner.validationRule) &&
        Objects.equals(this.wysiwygEnabled, attributesAllOfEmbeddedItemsInner.wysiwygEnabled);
  }
  ...
  public String toString() {
    ...
    sb.append("class AttributesAllOfEmbeddedItemsInner {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AttributesAllOfEmbeddedItemsInner
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AttributesAllOfEmbeddedItemsInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AttributesAllOfEmbeddedItemsInner is not found in the empty JSON string", AttributesAllOfEmbeddedItemsInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AttributesAllOfEmbeddedItemsInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AttributesAllOfEmbeddedItemsInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AttributesAllOfEmbeddedItemsInner.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AttributesAllOfEmbeddedItemsInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AttributesAllOfEmbeddedItemsInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AttributesAllOfEmbeddedItemsInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AttributesAllOfEmbeddedItemsInner.class));

       return (TypeAdapter<T>) new TypeAdapter<AttributesAllOfEmbeddedItemsInner>() {
           @Override
           public void write(JsonWriter out, AttributesAllOfEmbeddedItemsInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AttributesAllOfEmbeddedItemsInner read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AttributesAllOfEmbeddedItemsInner given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AttributesAllOfEmbeddedItemsInner
   * @throws IOException if the JSON string is invalid with respect to AttributesAllOfEmbeddedItemsInner
   */
  public static AttributesAllOfEmbeddedItemsInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AttributesAllOfEmbeddedItemsInner.class);
  }

  /**
   * Convert an instance of AttributesAllOfEmbeddedItemsInner to an JSON string
   *
   * @return JSON string
   */
