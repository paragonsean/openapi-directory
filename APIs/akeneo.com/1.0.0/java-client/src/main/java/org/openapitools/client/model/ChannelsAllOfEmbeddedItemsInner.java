...
public class ChannelsAllOfEmbeddedItemsInner {
  ...
  public ChannelsAllOfEmbeddedItemsInner() {
  }

  public ChannelsAllOfEmbeddedItemsInner links(PAMAssetCategoriesAllOfEmbeddedItemsInnerAllOfLinks links) {
    this.links = links;
    return this;
  }
  ...
  public ChannelsAllOfEmbeddedItemsInner categoryTree(String categoryTree) {
  ...
  public ChannelsAllOfEmbeddedItemsInner code(String code) {
    this.code = code;
    return this;
  }
  ...
  public ChannelsAllOfEmbeddedItemsInner conversionUnits(ChannelsAllOfEmbeddedItemsInnerAllOfConversionUnits conversionUnits) {
  ...
  public ChannelsAllOfEmbeddedItemsInner currencies(List<String> currencies) {
    this.currencies = currencies;
    return this;
  }

  public ChannelsAllOfEmbeddedItemsInner addCurrenciesItem(String currenciesItem) {
  ...
  public ChannelsAllOfEmbeddedItemsInner labels(ChannelsAllOfEmbeddedItemsInnerAllOfLabels labels) {
    this.labels = labels;
    return this;
  }
  ...
  public ChannelsAllOfEmbeddedItemsInner locales(List<String> locales) {
    this.locales = locales;
    return this;
  }

  public ChannelsAllOfEmbeddedItemsInner addLocalesItem(String localesItem) {
  ...
  public boolean equals(Object o) {
    ...
    ChannelsAllOfEmbeddedItemsInner channelsAllOfEmbeddedItemsInner = (ChannelsAllOfEmbeddedItemsInner) o;
    return Objects.equals(this.links, channelsAllOfEmbeddedItemsInner.links) &&
        Objects.equals(this.categoryTree, channelsAllOfEmbeddedItemsInner.categoryTree) &&
        Objects.equals(this.code, channelsAllOfEmbeddedItemsInner.code) &&
        Objects.equals(this.conversionUnits, channelsAllOfEmbeddedItemsInner.conversionUnits) &&
        Objects.equals(this.currencies, channelsAllOfEmbeddedItemsInner.currencies) &&
        Objects.equals(this.labels, channelsAllOfEmbeddedItemsInner.labels) &&
        Objects.equals(this.locales, channelsAllOfEmbeddedItemsInner.locales);
  }
  ...
  public String toString() {
    ...
    sb.append("class ChannelsAllOfEmbeddedItemsInner {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ChannelsAllOfEmbeddedItemsInner
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ChannelsAllOfEmbeddedItemsInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ChannelsAllOfEmbeddedItemsInner is not found in the empty JSON string", ChannelsAllOfEmbeddedItemsInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ChannelsAllOfEmbeddedItemsInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ChannelsAllOfEmbeddedItemsInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ChannelsAllOfEmbeddedItemsInner.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ChannelsAllOfEmbeddedItemsInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ChannelsAllOfEmbeddedItemsInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ChannelsAllOfEmbeddedItemsInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ChannelsAllOfEmbeddedItemsInner.class));

       return (TypeAdapter<T>) new TypeAdapter<ChannelsAllOfEmbeddedItemsInner>() {
           @Override
           public void write(JsonWriter out, ChannelsAllOfEmbeddedItemsInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ChannelsAllOfEmbeddedItemsInner read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ChannelsAllOfEmbeddedItemsInner given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ChannelsAllOfEmbeddedItemsInner
   * @throws IOException if the JSON string is invalid with respect to ChannelsAllOfEmbeddedItemsInner
   */
  public static ChannelsAllOfEmbeddedItemsInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ChannelsAllOfEmbeddedItemsInner.class);
  }

  /**
   * Convert an instance of ChannelsAllOfEmbeddedItemsInner to an JSON string
   *
   * @return JSON string
   */
