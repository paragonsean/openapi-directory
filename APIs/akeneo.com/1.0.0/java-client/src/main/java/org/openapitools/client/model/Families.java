...
public class Families {
  ...
  private FamiliesAllOfEmbedded embedded;

  public Families() {
  }

  public Families links(PAMAssetCategoriesAllOfLinks links) {
    this.links = links;
    return this;
  }
  ...
  public Families currentPage(Integer currentPage) {
  ...
  public Families embedded(FamiliesAllOfEmbedded embedded) {
   ...
   */
  @javax.annotation.Nullable
  public FamiliesAllOfEmbedded getEmbedded() {
    return embedded;
  }

  public void setEmbedded(FamiliesAllOfEmbedded embedded) {
    this.embedded = embedded;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.links, families.links) &&
        Objects.equals(this.currentPage, families.currentPage) &&
        Objects.equals(this.embedded, families.embedded);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("_embedded") != null && !jsonObj.get("_embedded").isJsonNull()) {
        FamiliesAllOfEmbedded.validateJsonElement(jsonObj.get("_embedded"));
      }
  }
