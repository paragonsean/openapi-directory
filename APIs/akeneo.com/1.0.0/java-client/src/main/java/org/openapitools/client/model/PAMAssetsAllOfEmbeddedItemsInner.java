...
public class PAMAssetsAllOfEmbeddedItemsInner {
  ...
  public PAMAssetsAllOfEmbeddedItemsInner() {
  }

  public PAMAssetsAllOfEmbeddedItemsInner links(PAMAssetCategoriesAllOfEmbeddedItemsInnerAllOfLinks links) {
    this.links = links;
    return this;
  }
  ...
  public PAMAssetsAllOfEmbeddedItemsInner categories(List<String> categories) {
    this.categories = categories;
    return this;
  }

  public PAMAssetsAllOfEmbeddedItemsInner addCategoriesItem(String categoriesItem) {
  ...
  public PAMAssetsAllOfEmbeddedItemsInner code(String code) {
    this.code = code;
    return this;
  }
  ...
  public PAMAssetsAllOfEmbeddedItemsInner description(String description) {
  ...
  public PAMAssetsAllOfEmbeddedItemsInner endOfUse(String endOfUse) {
  ...
  public PAMAssetsAllOfEmbeddedItemsInner localizable(Boolean localizable) {
  ...
  public PAMAssetsAllOfEmbeddedItemsInner referenceFiles(List<PAMAssetsAllOfEmbeddedItemsInnerAllOfReferenceFilesInner> referenceFiles) {
    this.referenceFiles = referenceFiles;
    return this;
  }

  public PAMAssetsAllOfEmbeddedItemsInner addReferenceFilesItem(PAMAssetsAllOfEmbeddedItemsInnerAllOfReferenceFilesInner referenceFilesItem) {
  ...
  public PAMAssetsAllOfEmbeddedItemsInner tags(List<String> tags) {
    this.tags = tags;
    return this;
  }

  public PAMAssetsAllOfEmbeddedItemsInner addTagsItem(String tagsItem) {
    if (this.tags == null) {
  ...
  public PAMAssetsAllOfEmbeddedItemsInner variationFiles(List<PAMAssetsAllOfEmbeddedItemsInnerAllOfVariationFilesInner> variationFiles) {
    this.variationFiles = variationFiles;
    return this;
  }

  public PAMAssetsAllOfEmbeddedItemsInner addVariationFilesItem(PAMAssetsAllOfEmbeddedItemsInnerAllOfVariationFilesInner variationFilesItem) {
  ...
  public boolean equals(Object o) {
    ...
    PAMAssetsAllOfEmbeddedItemsInner paMAssetsAllOfEmbeddedItemsInner = (PAMAssetsAllOfEmbeddedItemsInner) o;
    return Objects.equals(this.links, paMAssetsAllOfEmbeddedItemsInner.links) &&
        Objects.equals(this.categories, paMAssetsAllOfEmbeddedItemsInner.categories) &&
        Objects.equals(this.code, paMAssetsAllOfEmbeddedItemsInner.code) &&
        Objects.equals(this.description, paMAssetsAllOfEmbeddedItemsInner.description) &&
        Objects.equals(this.endOfUse, paMAssetsAllOfEmbeddedItemsInner.endOfUse) &&
        Objects.equals(this.localizable, paMAssetsAllOfEmbeddedItemsInner.localizable) &&
        Objects.equals(this.referenceFiles, paMAssetsAllOfEmbeddedItemsInner.referenceFiles) &&
        Objects.equals(this.tags, paMAssetsAllOfEmbeddedItemsInner.tags) &&
        Objects.equals(this.variationFiles, paMAssetsAllOfEmbeddedItemsInner.variationFiles);
  }
  ...
  public String toString() {
    ...
    sb.append("class PAMAssetsAllOfEmbeddedItemsInner {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PAMAssetsAllOfEmbeddedItemsInner
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PAMAssetsAllOfEmbeddedItemsInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PAMAssetsAllOfEmbeddedItemsInner is not found in the empty JSON string", PAMAssetsAllOfEmbeddedItemsInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PAMAssetsAllOfEmbeddedItemsInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PAMAssetsAllOfEmbeddedItemsInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PAMAssetsAllOfEmbeddedItemsInner.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PAMAssetsAllOfEmbeddedItemsInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PAMAssetsAllOfEmbeddedItemsInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PAMAssetsAllOfEmbeddedItemsInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PAMAssetsAllOfEmbeddedItemsInner.class));

       return (TypeAdapter<T>) new TypeAdapter<PAMAssetsAllOfEmbeddedItemsInner>() {
           @Override
           public void write(JsonWriter out, PAMAssetsAllOfEmbeddedItemsInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PAMAssetsAllOfEmbeddedItemsInner read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PAMAssetsAllOfEmbeddedItemsInner given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PAMAssetsAllOfEmbeddedItemsInner
   * @throws IOException if the JSON string is invalid with respect to PAMAssetsAllOfEmbeddedItemsInner
   */
  public static PAMAssetsAllOfEmbeddedItemsInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PAMAssetsAllOfEmbeddedItemsInner.class);
  }

  /**
   * Convert an instance of PAMAssetsAllOfEmbeddedItemsInner to an JSON string
   *
   * @return JSON string
   */
