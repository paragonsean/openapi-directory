...
public class FamilyVariantList {
  ...
  public FamilyVariantList() {
  }

  public FamilyVariantList links(PAMAssetCategoriesAllOfEmbeddedItemsInnerAllOfLinks links) {
    this.links = links;
    return this;
  }
  ...
  public FamilyVariantList code(String code) {
    this.code = code;
    return this;
  }
  ...
  public FamilyVariantList labels(FamilyVariantsAllOfEmbeddedItemsInnerAllOfLabels labels) {
    this.labels = labels;
    return this;
  }
  ...
  public FamilyVariantList variantAttributeSets(List<FamilyVariantsAllOfEmbeddedItemsInnerAllOfVariantAttributeSetsInner> variantAttributeSets) {
    this.variantAttributeSets = variantAttributeSets;
    return this;
  }

  public FamilyVariantList addVariantAttributeSetsItem(FamilyVariantsAllOfEmbeddedItemsInnerAllOfVariantAttributeSetsInner variantAttributeSetsItem) {
  ...
  public boolean equals(Object o) {
    ...
    FamilyVariantList familyVariantList = (FamilyVariantList) o;
    return Objects.equals(this.links, familyVariantList.links) &&
        Objects.equals(this.code, familyVariantList.code) &&
        Objects.equals(this.labels, familyVariantList.labels) &&
        Objects.equals(this.variantAttributeSets, familyVariantList.variantAttributeSets);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to FamilyVariantList
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!FamilyVariantList.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FamilyVariantList is not found in the empty JSON string", FamilyVariantList.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!FamilyVariantList.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `FamilyVariantList` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : FamilyVariantList.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FamilyVariantList.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FamilyVariantList' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FamilyVariantList> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FamilyVariantList.class));

       return (TypeAdapter<T>) new TypeAdapter<FamilyVariantList>() {
           @Override
           public void write(JsonWriter out, FamilyVariantList value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public FamilyVariantList read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of FamilyVariantList given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of FamilyVariantList
   * @throws IOException if the JSON string is invalid with respect to FamilyVariantList
   */
  public static FamilyVariantList fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FamilyVariantList.class);
  }

  /**
   * Convert an instance of FamilyVariantList to an JSON string
   *
   * @return JSON string
   */
