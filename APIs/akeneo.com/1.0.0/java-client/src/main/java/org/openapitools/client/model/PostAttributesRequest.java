...
public class PostAttributesRequest {
  ...
  public PostAttributesRequest() {
  }

  public PostAttributesRequest allowedExtensions(List<String> allowedExtensions) {
    this.allowedExtensions = allowedExtensions;
    return this;
  }

  public PostAttributesRequest addAllowedExtensionsItem(String allowedExtensionsItem) {
  ...
  public PostAttributesRequest availableLocales(List<String> availableLocales) {
    this.availableLocales = availableLocales;
    return this;
  }

  public PostAttributesRequest addAvailableLocalesItem(String availableLocalesItem) {
  ...
  public PostAttributesRequest code(String code) {
    this.code = code;
    return this;
  }
  ...
  public PostAttributesRequest dateMax(OffsetDateTime dateMax) {
  ...
  public PostAttributesRequest dateMin(OffsetDateTime dateMin) {
  ...
  public PostAttributesRequest decimalsAllowed(Boolean decimalsAllowed) {
  ...
  public PostAttributesRequest defaultMetricUnit(String defaultMetricUnit) {
  ...
  public PostAttributesRequest defaultValue(Boolean defaultValue) {
  ...
  public PostAttributesRequest group(String group) {
    this.group = group;
    return this;
  }
  ...
  public PostAttributesRequest groupLabels(AttributesAllOfEmbeddedItemsInnerAllOfGroupLabels groupLabels) {
  ...
  public PostAttributesRequest labels(GetAssetFamiliesCodeAttributes200ResponseInnerLabels labels) {
    this.labels = labels;
    return this;
  }
  ...
  public PostAttributesRequest localizable(Boolean localizable) {
  ...
  public PostAttributesRequest maxCharacters(Integer maxCharacters) {
  ...
  public PostAttributesRequest maxFileSize(String maxFileSize) {
  ...
  public PostAttributesRequest metricFamily(String metricFamily) {
  ...
  public PostAttributesRequest negativeAllowed(Boolean negativeAllowed) {
  ...
  public PostAttributesRequest numberMax(String numberMax) {
  ...
  public PostAttributesRequest numberMin(String numberMin) {
  ...
  public PostAttributesRequest referenceDataName(String referenceDataName) {
  ...
  public PostAttributesRequest scopable(Boolean scopable) {
  ...
  public PostAttributesRequest sortOrder(Integer sortOrder) {
  ...
  public PostAttributesRequest tableConfiguration(List<AttributesAllOfEmbeddedItemsInnerAllOfTableConfigurationInner> tableConfiguration) {
    this.tableConfiguration = tableConfiguration;
    return this;
  }

  public PostAttributesRequest addTableConfigurationItem(AttributesAllOfEmbeddedItemsInnerAllOfTableConfigurationInner tableConfigurationItem) {
  ...
  public PostAttributesRequest type(TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  public PostAttributesRequest unique(Boolean unique) {
    this.unique = unique;
    return this;
  }
  ...
  public PostAttributesRequest useableAsGridFilter(Boolean useableAsGridFilter) {
  ...
  public PostAttributesRequest validationRegexp(String validationRegexp) {
  ...
  public PostAttributesRequest validationRule(String validationRule) {
  ...
  public PostAttributesRequest wysiwygEnabled(Boolean wysiwygEnabled) {
  ...
  public boolean equals(Object o) {
    ...
    PostAttributesRequest postAttributesRequest = (PostAttributesRequest) o;
    return Objects.equals(this.allowedExtensions, postAttributesRequest.allowedExtensions) &&
        Objects.equals(this.availableLocales, postAttributesRequest.availableLocales) &&
        Objects.equals(this.code, postAttributesRequest.code) &&
        Objects.equals(this.dateMax, postAttributesRequest.dateMax) &&
        Objects.equals(this.dateMin, postAttributesRequest.dateMin) &&
        Objects.equals(this.decimalsAllowed, postAttributesRequest.decimalsAllowed) &&
        Objects.equals(this.defaultMetricUnit, postAttributesRequest.defaultMetricUnit) &&
        Objects.equals(this.defaultValue, postAttributesRequest.defaultValue) &&
        Objects.equals(this.group, postAttributesRequest.group) &&
        Objects.equals(this.groupLabels, postAttributesRequest.groupLabels) &&
        Objects.equals(this.labels, postAttributesRequest.labels) &&
        Objects.equals(this.localizable, postAttributesRequest.localizable) &&
        Objects.equals(this.maxCharacters, postAttributesRequest.maxCharacters) &&
        Objects.equals(this.maxFileSize, postAttributesRequest.maxFileSize) &&
        Objects.equals(this.metricFamily, postAttributesRequest.metricFamily) &&
        Objects.equals(this.negativeAllowed, postAttributesRequest.negativeAllowed) &&
        Objects.equals(this.numberMax, postAttributesRequest.numberMax) &&
        Objects.equals(this.numberMin, postAttributesRequest.numberMin) &&
        Objects.equals(this.referenceDataName, postAttributesRequest.referenceDataName) &&
        Objects.equals(this.scopable, postAttributesRequest.scopable) &&
        Objects.equals(this.sortOrder, postAttributesRequest.sortOrder) &&
        Objects.equals(this.tableConfiguration, postAttributesRequest.tableConfiguration) &&
        Objects.equals(this.type, postAttributesRequest.type) &&
        Objects.equals(this.unique, postAttributesRequest.unique) &&
        Objects.equals(this.useableAsGridFilter, postAttributesRequest.useableAsGridFilter) &&
        Objects.equals(this.validationRegexp, postAttributesRequest.validationRegexp) &&
        Objects.equals(this.validationRule, postAttributesRequest.validationRule) &&
        Objects.equals(this.wysiwygEnabled, postAttributesRequest.wysiwygEnabled);
  }

  @Override
  public int hashCode() {
    return Objects.hash(allowedExtensions, availableLocales, code, dateMax, dateMin, decimalsAllowed, defaultMetricUnit, defaultValue, group, groupLabels, labels, localizable, maxCharacters, maxFileSize, metricFamily, negativeAllowed, numberMax, numberMin, referenceDataName, scopable, sortOrder, tableConfiguration, type, unique, useableAsGridFilter, validationRegexp, validationRule, wysiwygEnabled);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class PostAttributesRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PostAttributesRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PostAttributesRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PostAttributesRequest is not found in the empty JSON string", PostAttributesRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PostAttributesRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PostAttributesRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PostAttributesRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PostAttributesRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PostAttributesRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PostAttributesRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PostAttributesRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<PostAttributesRequest>() {
           @Override
           public void write(JsonWriter out, PostAttributesRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PostAttributesRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PostAttributesRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PostAttributesRequest
   * @throws IOException if the JSON string is invalid with respect to PostAttributesRequest
   */
  public static PostAttributesRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PostAttributesRequest.class);
  }

  /**
   * Convert an instance of PostAttributesRequest to an JSON string
   *
   * @return JSON string
   */
