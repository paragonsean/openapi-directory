...
public class FamilyList {
  ...
  public FamilyList links(PAMAssetCategoriesAllOfEmbeddedItemsInnerAllOfLinks links) {
    this.links = links;
    return this;
  }
  ...
  public FamilyList attributeAsImage(String attributeAsImage) {
  ...
  public FamilyList attributeAsLabel(String attributeAsLabel) {
  ...
  public FamilyList attributeRequirements(FamiliesAllOfEmbeddedItemsInnerAllOfAttributeRequirements attributeRequirements) {
  ...
  public FamilyList attributes(List<String> attributes) {
    this.attributes = attributes;
    return this;
  }

  public FamilyList addAttributesItem(String attributesItem) {
  ...
  public FamilyList code(String code) {
    this.code = code;
    return this;
  }
  ...
  public FamilyList labels(FamiliesAllOfEmbeddedItemsInnerAllOfLabels labels) {
    this.labels = labels;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.links, familyList.links) &&
        Objects.equals(this.attributeAsImage, familyList.attributeAsImage) &&
        Objects.equals(this.attributeAsLabel, familyList.attributeAsLabel) &&
        Objects.equals(this.attributeRequirements, familyList.attributeRequirements) &&
        Objects.equals(this.attributes, familyList.attributes) &&
        Objects.equals(this.code, familyList.code) &&
        Objects.equals(this.labels, familyList.labels);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to FamilyList
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!FamilyList.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FamilyList is not found in the empty JSON string", FamilyList.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!FamilyList.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `FamilyList` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : FamilyList.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FamilyList.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FamilyList' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FamilyList> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FamilyList.class));

       return (TypeAdapter<T>) new TypeAdapter<FamilyList>() {
           @Override
           public void write(JsonWriter out, FamilyList value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public FamilyList read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of FamilyList given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of FamilyList
   * @throws IOException if the JSON string is invalid with respect to FamilyList
   */
  public static FamilyList fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FamilyList.class);
  }

  /**
   * Convert an instance of FamilyList to an JSON string
   *
   * @return JSON string
   */
