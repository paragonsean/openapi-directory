...
import org.openapitools.client.model.AssetFamilyListAllOfNamingConvention;
...
public class AssetFamilyList {
  ...
  private AssetFamilyListAllOfNamingConvention namingConvention;
  ...
  public AssetFamilyList() {
  }

  public AssetFamilyList links(PAMAssetCategoriesAllOfEmbeddedItemsInnerAllOfLinks links) {
    this.links = links;
    return this;
  }
  ...
  public AssetFamilyList attributeAsMainMedia(String attributeAsMainMedia) {
  ...
  public AssetFamilyList code(String code) {
    this.code = code;
    return this;
  }
  ...
  public AssetFamilyList labels(AssetFamiliesAllOfEmbeddedItemsInnerAllOfLabels labels) {
    this.labels = labels;
    return this;
  }
  ...
  public AssetFamilyList namingConvention(AssetFamilyListAllOfNamingConvention namingConvention) {
   ...
   */
  @javax.annotation.Nullable
  public AssetFamilyListAllOfNamingConvention getNamingConvention() {
    return namingConvention;
  }

  public void setNamingConvention(AssetFamilyListAllOfNamingConvention namingConvention) {
    this.namingConvention = namingConvention;
  }


  public AssetFamilyList productLinkRules(List<AssetFamiliesAllOfEmbeddedItemsInnerAllOfProductLinkRulesInner> productLinkRules) {
    this.productLinkRules = productLinkRules;
    return this;
  }

  public AssetFamilyList addProductLinkRulesItem(AssetFamiliesAllOfEmbeddedItemsInnerAllOfProductLinkRulesInner productLinkRulesItem) {
  ...
  public AssetFamilyList transformations(List<AssetFamiliesAllOfEmbeddedItemsInnerAllOfTransformationsInner> transformations) {
    this.transformations = transformations;
    return this;
  }

  public AssetFamilyList addTransformationsItem(AssetFamiliesAllOfEmbeddedItemsInnerAllOfTransformationsInner transformationsItem) {
  ...
  public boolean equals(Object o) {
    ...
    AssetFamilyList assetFamilyList = (AssetFamilyList) o;
    return Objects.equals(this.links, assetFamilyList.links) &&
        Objects.equals(this.attributeAsMainMedia, assetFamilyList.attributeAsMainMedia) &&
        Objects.equals(this.code, assetFamilyList.code) &&
        Objects.equals(this.labels, assetFamilyList.labels) &&
        Objects.equals(this.namingConvention, assetFamilyList.namingConvention) &&
        Objects.equals(this.productLinkRules, assetFamilyList.productLinkRules) &&
        Objects.equals(this.transformations, assetFamilyList.transformations);
  }
  ...
  public String toString() {
    ...
    sb.append("class AssetFamilyList {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AssetFamilyList
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AssetFamilyList.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AssetFamilyList is not found in the empty JSON string", AssetFamilyList.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AssetFamilyList.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AssetFamilyList` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AssetFamilyList.openapiRequiredFields) {
      ...
      if (jsonObj.get("naming_convention") != null && !jsonObj.get("naming_convention").isJsonNull()) {
        AssetFamilyListAllOfNamingConvention.validateJsonElement(jsonObj.get("naming_convention"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AssetFamilyList.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AssetFamilyList' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AssetFamilyList> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AssetFamilyList.class));

       return (TypeAdapter<T>) new TypeAdapter<AssetFamilyList>() {
           @Override
           public void write(JsonWriter out, AssetFamilyList value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AssetFamilyList read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AssetFamilyList given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AssetFamilyList
   * @throws IOException if the JSON string is invalid with respect to AssetFamilyList
   */
  public static AssetFamilyList fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AssetFamilyList.class);
  }

  /**
   * Convert an instance of AssetFamilyList to an JSON string
   *
   * @return JSON string
   */
