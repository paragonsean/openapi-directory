...
public class PostPamAssetsRequest {
  ...
  public PostPamAssetsRequest() {
  }

  public PostPamAssetsRequest categories(List<String> categories) {
    this.categories = categories;
    return this;
  }

  public PostPamAssetsRequest addCategoriesItem(String categoriesItem) {
  ...
  public PostPamAssetsRequest code(String code) {
    this.code = code;
    return this;
  }
  ...
  public PostPamAssetsRequest description(String description) {
  ...
  public PostPamAssetsRequest endOfUse(String endOfUse) {
  ...
  public PostPamAssetsRequest localizable(Boolean localizable) {
  ...
  public PostPamAssetsRequest referenceFiles(List<PAMAssetsAllOfEmbeddedItemsInnerAllOfReferenceFilesInner> referenceFiles) {
    this.referenceFiles = referenceFiles;
    return this;
  }

  public PostPamAssetsRequest addReferenceFilesItem(PAMAssetsAllOfEmbeddedItemsInnerAllOfReferenceFilesInner referenceFilesItem) {
  ...
  public PostPamAssetsRequest tags(List<String> tags) {
    this.tags = tags;
    return this;
  }

  public PostPamAssetsRequest addTagsItem(String tagsItem) {
    if (this.tags == null) {
  ...
  public PostPamAssetsRequest variationFiles(List<PAMAssetsAllOfEmbeddedItemsInnerAllOfVariationFilesInner> variationFiles) {
    this.variationFiles = variationFiles;
    return this;
  }

  public PostPamAssetsRequest addVariationFilesItem(PAMAssetsAllOfEmbeddedItemsInnerAllOfVariationFilesInner variationFilesItem) {
  ...
  public boolean equals(Object o) {
    ...
    PostPamAssetsRequest postPamAssetsRequest = (PostPamAssetsRequest) o;
    return Objects.equals(this.categories, postPamAssetsRequest.categories) &&
        Objects.equals(this.code, postPamAssetsRequest.code) &&
        Objects.equals(this.description, postPamAssetsRequest.description) &&
        Objects.equals(this.endOfUse, postPamAssetsRequest.endOfUse) &&
        Objects.equals(this.localizable, postPamAssetsRequest.localizable) &&
        Objects.equals(this.referenceFiles, postPamAssetsRequest.referenceFiles) &&
        Objects.equals(this.tags, postPamAssetsRequest.tags) &&
        Objects.equals(this.variationFiles, postPamAssetsRequest.variationFiles);
  }
  ...
  public String toString() {
    ...
    sb.append("class PostPamAssetsRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PostPamAssetsRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PostPamAssetsRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PostPamAssetsRequest is not found in the empty JSON string", PostPamAssetsRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PostPamAssetsRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PostPamAssetsRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PostPamAssetsRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PostPamAssetsRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PostPamAssetsRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PostPamAssetsRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PostPamAssetsRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<PostPamAssetsRequest>() {
           @Override
           public void write(JsonWriter out, PostPamAssetsRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PostPamAssetsRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PostPamAssetsRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PostPamAssetsRequest
   * @throws IOException if the JSON string is invalid with respect to PostPamAssetsRequest
   */
  public static PostPamAssetsRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PostPamAssetsRequest.class);
  }

  /**
   * Convert an instance of PostPamAssetsRequest to an JSON string
   *
   * @return JSON string
   */
