...
public class AssociationType {
  ...
  public AssociationType code(String code) {
    this.code = code;
    return this;
  }
  ...
  public AssociationType isQuantified(Boolean isQuantified) {
  ...
  public AssociationType isTwoWay(Boolean isTwoWay) {
  ...
  public AssociationType labels(AssociationTypesAllOfEmbeddedItemsInnerAllOfLabels labels) {
    this.labels = labels;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.code, associationType.code) &&
        Objects.equals(this.isQuantified, associationType.isQuantified) &&
        Objects.equals(this.isTwoWay, associationType.isTwoWay) &&
        Objects.equals(this.labels, associationType.labels);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to AssociationType
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AssociationType.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AssociationType.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AssociationType` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AssociationType.openapiRequiredFields) {
