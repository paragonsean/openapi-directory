...
public class PatchAttributesRequest {
  ...
  public PatchAttributesRequest() {
  }

  public PatchAttributesRequest allowedExtensions(List<String> allowedExtensions) {
    this.allowedExtensions = allowedExtensions;
    return this;
  }

  public PatchAttributesRequest addAllowedExtensionsItem(String allowedExtensionsItem) {
  ...
  public PatchAttributesRequest availableLocales(List<String> availableLocales) {
    this.availableLocales = availableLocales;
    return this;
  }

  public PatchAttributesRequest addAvailableLocalesItem(String availableLocalesItem) {
  ...
  public PatchAttributesRequest code(String code) {
    this.code = code;
    return this;
  }
  ...
  public PatchAttributesRequest dateMax(OffsetDateTime dateMax) {
  ...
  public PatchAttributesRequest dateMin(OffsetDateTime dateMin) {
  ...
  public PatchAttributesRequest decimalsAllowed(Boolean decimalsAllowed) {
  ...
  public PatchAttributesRequest defaultMetricUnit(String defaultMetricUnit) {
  ...
  public PatchAttributesRequest defaultValue(Boolean defaultValue) {
  ...
  public PatchAttributesRequest group(String group) {
    this.group = group;
    return this;
  }
  ...
  public PatchAttributesRequest groupLabels(AttributesAllOfEmbeddedItemsInnerAllOfGroupLabels groupLabels) {
  ...
  public PatchAttributesRequest labels(GetAssetFamiliesCodeAttributes200ResponseInnerLabels labels) {
    this.labels = labels;
    return this;
  }
  ...
  public PatchAttributesRequest localizable(Boolean localizable) {
  ...
  public PatchAttributesRequest maxCharacters(Integer maxCharacters) {
  ...
  public PatchAttributesRequest maxFileSize(String maxFileSize) {
  ...
  public PatchAttributesRequest metricFamily(String metricFamily) {
  ...
  public PatchAttributesRequest negativeAllowed(Boolean negativeAllowed) {
  ...
  public PatchAttributesRequest numberMax(String numberMax) {
  ...
  public PatchAttributesRequest numberMin(String numberMin) {
  ...
  public PatchAttributesRequest referenceDataName(String referenceDataName) {
  ...
  public PatchAttributesRequest scopable(Boolean scopable) {
  ...
  public PatchAttributesRequest sortOrder(Integer sortOrder) {
  ...
  public PatchAttributesRequest tableConfiguration(List<AttributesAllOfEmbeddedItemsInnerAllOfTableConfigurationInner> tableConfiguration) {
    this.tableConfiguration = tableConfiguration;
    return this;
  }

  public PatchAttributesRequest addTableConfigurationItem(AttributesAllOfEmbeddedItemsInnerAllOfTableConfigurationInner tableConfigurationItem) {
  ...
  public PatchAttributesRequest type(TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  public PatchAttributesRequest unique(Boolean unique) {
    this.unique = unique;
    return this;
  }
  ...
  public PatchAttributesRequest useableAsGridFilter(Boolean useableAsGridFilter) {
  ...
  public PatchAttributesRequest validationRegexp(String validationRegexp) {
  ...
  public PatchAttributesRequest validationRule(String validationRule) {
  ...
  public PatchAttributesRequest wysiwygEnabled(Boolean wysiwygEnabled) {
  ...
  public boolean equals(Object o) {
    ...
    PatchAttributesRequest patchAttributesRequest = (PatchAttributesRequest) o;
    return Objects.equals(this.allowedExtensions, patchAttributesRequest.allowedExtensions) &&
        Objects.equals(this.availableLocales, patchAttributesRequest.availableLocales) &&
        Objects.equals(this.code, patchAttributesRequest.code) &&
        Objects.equals(this.dateMax, patchAttributesRequest.dateMax) &&
        Objects.equals(this.dateMin, patchAttributesRequest.dateMin) &&
        Objects.equals(this.decimalsAllowed, patchAttributesRequest.decimalsAllowed) &&
        Objects.equals(this.defaultMetricUnit, patchAttributesRequest.defaultMetricUnit) &&
        Objects.equals(this.defaultValue, patchAttributesRequest.defaultValue) &&
        Objects.equals(this.group, patchAttributesRequest.group) &&
        Objects.equals(this.groupLabels, patchAttributesRequest.groupLabels) &&
        Objects.equals(this.labels, patchAttributesRequest.labels) &&
        Objects.equals(this.localizable, patchAttributesRequest.localizable) &&
        Objects.equals(this.maxCharacters, patchAttributesRequest.maxCharacters) &&
        Objects.equals(this.maxFileSize, patchAttributesRequest.maxFileSize) &&
        Objects.equals(this.metricFamily, patchAttributesRequest.metricFamily) &&
        Objects.equals(this.negativeAllowed, patchAttributesRequest.negativeAllowed) &&
        Objects.equals(this.numberMax, patchAttributesRequest.numberMax) &&
        Objects.equals(this.numberMin, patchAttributesRequest.numberMin) &&
        Objects.equals(this.referenceDataName, patchAttributesRequest.referenceDataName) &&
        Objects.equals(this.scopable, patchAttributesRequest.scopable) &&
        Objects.equals(this.sortOrder, patchAttributesRequest.sortOrder) &&
        Objects.equals(this.tableConfiguration, patchAttributesRequest.tableConfiguration) &&
        Objects.equals(this.type, patchAttributesRequest.type) &&
        Objects.equals(this.unique, patchAttributesRequest.unique) &&
        Objects.equals(this.useableAsGridFilter, patchAttributesRequest.useableAsGridFilter) &&
        Objects.equals(this.validationRegexp, patchAttributesRequest.validationRegexp) &&
        Objects.equals(this.validationRule, patchAttributesRequest.validationRule) &&
        Objects.equals(this.wysiwygEnabled, patchAttributesRequest.wysiwygEnabled);
  }
  ...
  public String toString() {
    ...
    sb.append("class PatchAttributesRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PatchAttributesRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PatchAttributesRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PatchAttributesRequest is not found in the empty JSON string", PatchAttributesRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PatchAttributesRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PatchAttributesRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PatchAttributesRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PatchAttributesRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PatchAttributesRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PatchAttributesRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PatchAttributesRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<PatchAttributesRequest>() {
           @Override
           public void write(JsonWriter out, PatchAttributesRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PatchAttributesRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PatchAttributesRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PatchAttributesRequest
   * @throws IOException if the JSON string is invalid with respect to PatchAttributesRequest
   */
  public static PatchAttributesRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PatchAttributesRequest.class);
  }

  /**
   * Convert an instance of PatchAttributesRequest to an JSON string
   *
   * @return JSON string
   */
