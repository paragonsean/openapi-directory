...
public class Family {
  ...
  public Family attributeAsImage(String attributeAsImage) {
  ...
  public Family attributeAsLabel(String attributeAsLabel) {
  ...
  public Family attributeRequirements(FamiliesAllOfEmbeddedItemsInnerAllOfAttributeRequirements attributeRequirements) {
  ...
  public Family attributes(List<String> attributes) {
    this.attributes = attributes;
    return this;
  }

  public Family addAttributesItem(String attributesItem) {
  ...
  public Family labels(FamiliesAllOfEmbeddedItemsInnerAllOfLabels labels) {
    this.labels = labels;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.attributeAsImage, family.attributeAsImage) &&
        Objects.equals(this.attributeAsLabel, family.attributeAsLabel) &&
        Objects.equals(this.attributeRequirements, family.attributeRequirements) &&
        Objects.equals(this.attributes, family.attributes) &&
        Objects.equals(this.code, family.code) &&
        Objects.equals(this.labels, family.labels);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to Family
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Family.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Family.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Family` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       final TypeAdapter<Family> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Family.class));
