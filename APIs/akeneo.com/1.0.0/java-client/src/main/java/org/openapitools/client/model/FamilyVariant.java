...
public class FamilyVariant {
  ...
  public FamilyVariant code(String code) {
    this.code = code;
    return this;
  }
  ...
  public FamilyVariant labels(FamilyVariantsAllOfEmbeddedItemsInnerAllOfLabels labels) {
    this.labels = labels;
    return this;
  }
  ...
  public FamilyVariant variantAttributeSets(List<FamilyVariantsAllOfEmbeddedItemsInnerAllOfVariantAttributeSetsInner> variantAttributeSets) {
    this.variantAttributeSets = variantAttributeSets;
    return this;
  }

  public FamilyVariant addVariantAttributeSetsItem(FamilyVariantsAllOfEmbeddedItemsInnerAllOfVariantAttributeSetsInner variantAttributeSetsItem) {
  ...
  public boolean equals(Object o) {
    ...
    FamilyVariant familyVariant = (FamilyVariant) o;
    return Objects.equals(this.code, familyVariant.code) &&
        Objects.equals(this.labels, familyVariant.labels) &&
        Objects.equals(this.variantAttributeSets, familyVariant.variantAttributeSets);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to FamilyVariant
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!FamilyVariant.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FamilyVariant is not found in the empty JSON string", FamilyVariant.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!FamilyVariant.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `FamilyVariant` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : FamilyVariant.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FamilyVariant.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FamilyVariant' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FamilyVariant> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FamilyVariant.class));

       return (TypeAdapter<T>) new TypeAdapter<FamilyVariant>() {
           @Override
           public void write(JsonWriter out, FamilyVariant value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public FamilyVariant read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of FamilyVariant given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of FamilyVariant
   * @throws IOException if the JSON string is invalid with respect to FamilyVariant
   */
  public static FamilyVariant fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FamilyVariant.class);
  }

  /**
   * Convert an instance of FamilyVariant to an JSON string
   *
   * @return JSON string
   */
