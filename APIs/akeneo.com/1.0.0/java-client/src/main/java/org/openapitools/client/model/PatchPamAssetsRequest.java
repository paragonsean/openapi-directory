...
public class PatchPamAssetsRequest {
  ...
  public PatchPamAssetsRequest() {
  }

  public PatchPamAssetsRequest categories(List<String> categories) {
    this.categories = categories;
    return this;
  }

  public PatchPamAssetsRequest addCategoriesItem(String categoriesItem) {
  ...
  public PatchPamAssetsRequest code(String code) {
    this.code = code;
    return this;
  }
  ...
  public PatchPamAssetsRequest description(String description) {
  ...
  public PatchPamAssetsRequest endOfUse(String endOfUse) {
  ...
  public PatchPamAssetsRequest localizable(Boolean localizable) {
  ...
  public PatchPamAssetsRequest referenceFiles(List<PAMAssetsAllOfEmbeddedItemsInnerAllOfReferenceFilesInner> referenceFiles) {
    this.referenceFiles = referenceFiles;
    return this;
  }

  public PatchPamAssetsRequest addReferenceFilesItem(PAMAssetsAllOfEmbeddedItemsInnerAllOfReferenceFilesInner referenceFilesItem) {
  ...
  public PatchPamAssetsRequest tags(List<String> tags) {
    this.tags = tags;
    return this;
  }

  public PatchPamAssetsRequest addTagsItem(String tagsItem) {
    if (this.tags == null) {
  ...
  public PatchPamAssetsRequest variationFiles(List<PAMAssetsAllOfEmbeddedItemsInnerAllOfVariationFilesInner> variationFiles) {
    this.variationFiles = variationFiles;
    return this;
  }

  public PatchPamAssetsRequest addVariationFilesItem(PAMAssetsAllOfEmbeddedItemsInnerAllOfVariationFilesInner variationFilesItem) {
  ...
  public boolean equals(Object o) {
    ...
    PatchPamAssetsRequest patchPamAssetsRequest = (PatchPamAssetsRequest) o;
    return Objects.equals(this.categories, patchPamAssetsRequest.categories) &&
        Objects.equals(this.code, patchPamAssetsRequest.code) &&
        Objects.equals(this.description, patchPamAssetsRequest.description) &&
        Objects.equals(this.endOfUse, patchPamAssetsRequest.endOfUse) &&
        Objects.equals(this.localizable, patchPamAssetsRequest.localizable) &&
        Objects.equals(this.referenceFiles, patchPamAssetsRequest.referenceFiles) &&
        Objects.equals(this.tags, patchPamAssetsRequest.tags) &&
        Objects.equals(this.variationFiles, patchPamAssetsRequest.variationFiles);
  }
  ...
  public String toString() {
    ...
    sb.append("class PatchPamAssetsRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PatchPamAssetsRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PatchPamAssetsRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PatchPamAssetsRequest is not found in the empty JSON string", PatchPamAssetsRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PatchPamAssetsRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PatchPamAssetsRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PatchPamAssetsRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PatchPamAssetsRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PatchPamAssetsRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PatchPamAssetsRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PatchPamAssetsRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<PatchPamAssetsRequest>() {
           @Override
           public void write(JsonWriter out, PatchPamAssetsRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PatchPamAssetsRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PatchPamAssetsRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PatchPamAssetsRequest
   * @throws IOException if the JSON string is invalid with respect to PatchPamAssetsRequest
   */
  public static PatchPamAssetsRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PatchPamAssetsRequest.class);
  }

  /**
   * Convert an instance of PatchPamAssetsRequest to an JSON string
   *
   * @return JSON string
   */
