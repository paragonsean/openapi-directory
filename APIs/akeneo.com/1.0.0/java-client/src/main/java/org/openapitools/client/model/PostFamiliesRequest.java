...
public class PostFamiliesRequest {
  ...
  public PostFamiliesRequest() {
  }

  public PostFamiliesRequest attributeAsImage(String attributeAsImage) {
  ...
  public PostFamiliesRequest attributeAsLabel(String attributeAsLabel) {
  ...
  public PostFamiliesRequest attributeRequirements(FamiliesAllOfEmbeddedItemsInnerAllOfAttributeRequirements attributeRequirements) {
  ...
  public PostFamiliesRequest attributes(List<String> attributes) {
    this.attributes = attributes;
    return this;
  }

  public PostFamiliesRequest addAttributesItem(String attributesItem) {
  ...
  public PostFamiliesRequest code(String code) {
    this.code = code;
    return this;
  }
  ...
  public PostFamiliesRequest labels(FamiliesAllOfEmbeddedItemsInnerAllOfLabels labels) {
    this.labels = labels;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    PostFamiliesRequest postFamiliesRequest = (PostFamiliesRequest) o;
    return Objects.equals(this.attributeAsImage, postFamiliesRequest.attributeAsImage) &&
        Objects.equals(this.attributeAsLabel, postFamiliesRequest.attributeAsLabel) &&
        Objects.equals(this.attributeRequirements, postFamiliesRequest.attributeRequirements) &&
        Objects.equals(this.attributes, postFamiliesRequest.attributes) &&
        Objects.equals(this.code, postFamiliesRequest.code) &&
        Objects.equals(this.labels, postFamiliesRequest.labels);
  }
  ...
  public String toString() {
    ...
    sb.append("class PostFamiliesRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PostFamiliesRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PostFamiliesRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PostFamiliesRequest is not found in the empty JSON string", PostFamiliesRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PostFamiliesRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PostFamiliesRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PostFamiliesRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PostFamiliesRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PostFamiliesRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PostFamiliesRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PostFamiliesRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<PostFamiliesRequest>() {
           @Override
           public void write(JsonWriter out, PostFamiliesRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PostFamiliesRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PostFamiliesRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PostFamiliesRequest
   * @throws IOException if the JSON string is invalid with respect to PostFamiliesRequest
   */
  public static PostFamiliesRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PostFamiliesRequest.class);
  }

  /**
   * Convert an instance of PostFamiliesRequest to an JSON string
   *
   * @return JSON string
   */
