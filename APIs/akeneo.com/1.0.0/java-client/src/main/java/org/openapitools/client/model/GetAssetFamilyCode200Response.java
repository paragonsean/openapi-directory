...
public class GetAssetFamilyCode200Response {
  ...
  public GetAssetFamilyCode200Response() {
  }

  public GetAssetFamilyCode200Response attributeAsMainMedia(String attributeAsMainMedia) {
  ...
  public GetAssetFamilyCode200Response code(String code) {
    this.code = code;
    return this;
  }
  ...
  public GetAssetFamilyCode200Response labels(AssetFamiliesAllOfEmbeddedItemsInnerAllOfLabels labels) {
    this.labels = labels;
    return this;
  }
  ...
  public GetAssetFamilyCode200Response namingConvention(AssetFamiliesAllOfEmbeddedItemsInnerAllOfNamingConvention namingConvention) {
  ...
  public GetAssetFamilyCode200Response productLinkRules(List<AssetFamiliesAllOfEmbeddedItemsInnerAllOfProductLinkRulesInner> productLinkRules) {
    this.productLinkRules = productLinkRules;
    return this;
  }

  public GetAssetFamilyCode200Response addProductLinkRulesItem(AssetFamiliesAllOfEmbeddedItemsInnerAllOfProductLinkRulesInner productLinkRulesItem) {
  ...
  public GetAssetFamilyCode200Response transformations(List<AssetFamiliesAllOfEmbeddedItemsInnerAllOfTransformationsInner> transformations) {
    this.transformations = transformations;
    return this;
  }

  public GetAssetFamilyCode200Response addTransformationsItem(AssetFamiliesAllOfEmbeddedItemsInnerAllOfTransformationsInner transformationsItem) {
  ...
  public boolean equals(Object o) {
    ...
    GetAssetFamilyCode200Response getAssetFamilyCode200Response = (GetAssetFamilyCode200Response) o;
    return Objects.equals(this.attributeAsMainMedia, getAssetFamilyCode200Response.attributeAsMainMedia) &&
        Objects.equals(this.code, getAssetFamilyCode200Response.code) &&
        Objects.equals(this.labels, getAssetFamilyCode200Response.labels) &&
        Objects.equals(this.namingConvention, getAssetFamilyCode200Response.namingConvention) &&
        Objects.equals(this.productLinkRules, getAssetFamilyCode200Response.productLinkRules) &&
        Objects.equals(this.transformations, getAssetFamilyCode200Response.transformations);
  }

  @Override
  public int hashCode() {
    return Objects.hash(attributeAsMainMedia, code, labels, namingConvention, productLinkRules, transformations);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class GetAssetFamilyCode200Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetAssetFamilyCode200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetAssetFamilyCode200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetAssetFamilyCode200Response is not found in the empty JSON string", GetAssetFamilyCode200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetAssetFamilyCode200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetAssetFamilyCode200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GetAssetFamilyCode200Response.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetAssetFamilyCode200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetAssetFamilyCode200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetAssetFamilyCode200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetAssetFamilyCode200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<GetAssetFamilyCode200Response>() {
           @Override
           public void write(JsonWriter out, GetAssetFamilyCode200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetAssetFamilyCode200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetAssetFamilyCode200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetAssetFamilyCode200Response
   * @throws IOException if the JSON string is invalid with respect to GetAssetFamilyCode200Response
   */
  public static GetAssetFamilyCode200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetAssetFamilyCode200Response.class);
  }

  /**
   * Convert an instance of GetAssetFamilyCode200Response to an JSON string
   *
   * @return JSON string
   */
