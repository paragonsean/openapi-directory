...
public class FamiliesAllOfEmbeddedItemsInner {
  ...
  public FamiliesAllOfEmbeddedItemsInner() {
  }

  public FamiliesAllOfEmbeddedItemsInner links(PAMAssetCategoriesAllOfEmbeddedItemsInnerAllOfLinks links) {
    this.links = links;
    return this;
  }
  ...
  public FamiliesAllOfEmbeddedItemsInner attributeAsImage(String attributeAsImage) {
  ...
  public FamiliesAllOfEmbeddedItemsInner attributeAsLabel(String attributeAsLabel) {
  ...
  public FamiliesAllOfEmbeddedItemsInner attributeRequirements(FamiliesAllOfEmbeddedItemsInnerAllOfAttributeRequirements attributeRequirements) {
  ...
  public FamiliesAllOfEmbeddedItemsInner attributes(List<String> attributes) {
    this.attributes = attributes;
    return this;
  }

  public FamiliesAllOfEmbeddedItemsInner addAttributesItem(String attributesItem) {
  ...
  public FamiliesAllOfEmbeddedItemsInner code(String code) {
    this.code = code;
    return this;
  }
  ...
  public FamiliesAllOfEmbeddedItemsInner labels(FamiliesAllOfEmbeddedItemsInnerAllOfLabels labels) {
    this.labels = labels;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    FamiliesAllOfEmbeddedItemsInner familiesAllOfEmbeddedItemsInner = (FamiliesAllOfEmbeddedItemsInner) o;
    return Objects.equals(this.links, familiesAllOfEmbeddedItemsInner.links) &&
        Objects.equals(this.attributeAsImage, familiesAllOfEmbeddedItemsInner.attributeAsImage) &&
        Objects.equals(this.attributeAsLabel, familiesAllOfEmbeddedItemsInner.attributeAsLabel) &&
        Objects.equals(this.attributeRequirements, familiesAllOfEmbeddedItemsInner.attributeRequirements) &&
        Objects.equals(this.attributes, familiesAllOfEmbeddedItemsInner.attributes) &&
        Objects.equals(this.code, familiesAllOfEmbeddedItemsInner.code) &&
        Objects.equals(this.labels, familiesAllOfEmbeddedItemsInner.labels);
  }

  @Override
  public int hashCode() {
    return Objects.hash(links, attributeAsImage, attributeAsLabel, attributeRequirements, attributes, code, labels);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class FamiliesAllOfEmbeddedItemsInner {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to FamiliesAllOfEmbeddedItemsInner
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!FamiliesAllOfEmbeddedItemsInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FamiliesAllOfEmbeddedItemsInner is not found in the empty JSON string", FamiliesAllOfEmbeddedItemsInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!FamiliesAllOfEmbeddedItemsInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `FamiliesAllOfEmbeddedItemsInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : FamiliesAllOfEmbeddedItemsInner.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FamiliesAllOfEmbeddedItemsInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FamiliesAllOfEmbeddedItemsInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FamiliesAllOfEmbeddedItemsInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FamiliesAllOfEmbeddedItemsInner.class));

       return (TypeAdapter<T>) new TypeAdapter<FamiliesAllOfEmbeddedItemsInner>() {
           @Override
           public void write(JsonWriter out, FamiliesAllOfEmbeddedItemsInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public FamiliesAllOfEmbeddedItemsInner read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of FamiliesAllOfEmbeddedItemsInner given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of FamiliesAllOfEmbeddedItemsInner
   * @throws IOException if the JSON string is invalid with respect to FamiliesAllOfEmbeddedItemsInner
   */
  public static FamiliesAllOfEmbeddedItemsInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FamiliesAllOfEmbeddedItemsInner.class);
  }

  /**
   * Convert an instance of FamiliesAllOfEmbeddedItemsInner to an JSON string
   *
   * @return JSON string
   */
