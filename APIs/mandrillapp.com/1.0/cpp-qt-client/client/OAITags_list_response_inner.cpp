...
OAITags_list_response_inner::OAITags_list_response_inner(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAITags_list_response_inner::OAITags_list_response_inner() {
    this->initializeModel();
}

OAITags_list_response_inner::~OAITags_list_response_inner() {}

void OAITags_list_response_inner::initializeModel() {
...
void OAITags_list_response_inner::fromJson(QString jsonString) {
...
void OAITags_list_response_inner::fromJsonObject(QJsonObject json) {
...
QString OAITags_list_response_inner::asJson() const {
...
QJsonObject OAITags_list_response_inner::asJsonObject() const {
    QJsonObject obj;
    if (m_clicks_isSet) {
...
qint32 OAITags_list_response_inner::getClicks() const {
    return m_clicks;
}
void OAITags_list_response_inner::setClicks(const qint32 &clicks) {
    m_clicks = clicks;
    m_clicks_isSet = true;
}

bool OAITags_list_response_inner::is_clicks_Set() const{
    return m_clicks_isSet;
}

bool OAITags_list_response_inner::is_clicks_Valid() const{
    return m_clicks_isValid;
}

qint32 OAITags_list_response_inner::getComplaints() const {
    return m_complaints;
}
void OAITags_list_response_inner::setComplaints(const qint32 &complaints) {
    m_complaints = complaints;
    m_complaints_isSet = true;
}

bool OAITags_list_response_inner::is_complaints_Set() const{
    return m_complaints_isSet;
}

bool OAITags_list_response_inner::is_complaints_Valid() const{
    return m_complaints_isValid;
}

qint32 OAITags_list_response_inner::getHardBounces() const {
    return m_hard_bounces;
}
void OAITags_list_response_inner::setHardBounces(const qint32 &hard_bounces) {
    m_hard_bounces = hard_bounces;
    m_hard_bounces_isSet = true;
}

bool OAITags_list_response_inner::is_hard_bounces_Set() const{
    return m_hard_bounces_isSet;
}

bool OAITags_list_response_inner::is_hard_bounces_Valid() const{
    return m_hard_bounces_isValid;
}

qint32 OAITags_list_response_inner::getOpens() const {
    return m_opens;
}
void OAITags_list_response_inner::setOpens(const qint32 &opens) {
    m_opens = opens;
    m_opens_isSet = true;
}

bool OAITags_list_response_inner::is_opens_Set() const{
    return m_opens_isSet;
}

bool OAITags_list_response_inner::is_opens_Valid() const{
    return m_opens_isValid;
}

qint32 OAITags_list_response_inner::getRejects() const {
    return m_rejects;
}
void OAITags_list_response_inner::setRejects(const qint32 &rejects) {
    m_rejects = rejects;
    m_rejects_isSet = true;
}

bool OAITags_list_response_inner::is_rejects_Set() const{
    return m_rejects_isSet;
}

bool OAITags_list_response_inner::is_rejects_Valid() const{
    return m_rejects_isValid;
}

qint32 OAITags_list_response_inner::getReputation() const {
    return m_reputation;
}
void OAITags_list_response_inner::setReputation(const qint32 &reputation) {
    m_reputation = reputation;
    m_reputation_isSet = true;
}

bool OAITags_list_response_inner::is_reputation_Set() const{
    return m_reputation_isSet;
}

bool OAITags_list_response_inner::is_reputation_Valid() const{
    return m_reputation_isValid;
}

qint32 OAITags_list_response_inner::getSent() const {
    return m_sent;
}
void OAITags_list_response_inner::setSent(const qint32 &sent) {
    m_sent = sent;
    m_sent_isSet = true;
}

bool OAITags_list_response_inner::is_sent_Set() const{
    return m_sent_isSet;
}

bool OAITags_list_response_inner::is_sent_Valid() const{
    return m_sent_isValid;
}

qint32 OAITags_list_response_inner::getSoftBounces() const {
    return m_soft_bounces;
}
void OAITags_list_response_inner::setSoftBounces(const qint32 &soft_bounces) {
    m_soft_bounces = soft_bounces;
    m_soft_bounces_isSet = true;
}

bool OAITags_list_response_inner::is_soft_bounces_Set() const{
    return m_soft_bounces_isSet;
}

bool OAITags_list_response_inner::is_soft_bounces_Valid() const{
    return m_soft_bounces_isValid;
}

QString OAITags_list_response_inner::getTag() const {
    return m_tag;
}
void OAITags_list_response_inner::setTag(const QString &tag) {
    m_tag = tag;
    m_tag_isSet = true;
}

bool OAITags_list_response_inner::is_tag_Set() const{
    return m_tag_isSet;
}

bool OAITags_list_response_inner::is_tag_Valid() const{
    return m_tag_isValid;
}

qint32 OAITags_list_response_inner::getUniqueClicks() const {
    return m_unique_clicks;
}
void OAITags_list_response_inner::setUniqueClicks(const qint32 &unique_clicks) {
    m_unique_clicks = unique_clicks;
    m_unique_clicks_isSet = true;
}

bool OAITags_list_response_inner::is_unique_clicks_Set() const{
    return m_unique_clicks_isSet;
}

bool OAITags_list_response_inner::is_unique_clicks_Valid() const{
    return m_unique_clicks_isValid;
}

qint32 OAITags_list_response_inner::getUniqueOpens() const {
    return m_unique_opens;
}
void OAITags_list_response_inner::setUniqueOpens(const qint32 &unique_opens) {
    m_unique_opens = unique_opens;
    m_unique_opens_isSet = true;
}

bool OAITags_list_response_inner::is_unique_opens_Set() const{
    return m_unique_opens_isSet;
}

bool OAITags_list_response_inner::is_unique_opens_Valid() const{
    return m_unique_opens_isValid;
}

qint32 OAITags_list_response_inner::getUnsubs() const {
    return m_unsubs;
}
void OAITags_list_response_inner::setUnsubs(const qint32 &unsubs) {
    m_unsubs = unsubs;
    m_unsubs_isSet = true;
}

bool OAITags_list_response_inner::is_unsubs_Set() const{
    return m_unsubs_isSet;
}

bool OAITags_list_response_inner::is_unsubs_Valid() const{
    return m_unsubs_isValid;
}

bool OAITags_list_response_inner::isSet() const {
...
bool OAITags_list_response_inner::isValid() const {
