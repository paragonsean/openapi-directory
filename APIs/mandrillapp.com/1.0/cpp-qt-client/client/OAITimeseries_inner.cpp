...
OAITimeseries_inner::OAITimeseries_inner(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAITimeseries_inner::OAITimeseries_inner() {
    this->initializeModel();
}

OAITimeseries_inner::~OAITimeseries_inner() {}

void OAITimeseries_inner::initializeModel() {
...
void OAITimeseries_inner::fromJson(QString jsonString) {
...
void OAITimeseries_inner::fromJsonObject(QJsonObject json) {
...
QString OAITimeseries_inner::asJson() const {
...
QJsonObject OAITimeseries_inner::asJsonObject() const {
    QJsonObject obj;
    if (m_clicks_isSet) {
...
qint32 OAITimeseries_inner::getClicks() const {
    return m_clicks;
}
void OAITimeseries_inner::setClicks(const qint32 &clicks) {
    m_clicks = clicks;
    m_clicks_isSet = true;
}

bool OAITimeseries_inner::is_clicks_Set() const{
    return m_clicks_isSet;
}

bool OAITimeseries_inner::is_clicks_Valid() const{
    return m_clicks_isValid;
}

qint32 OAITimeseries_inner::getComplaints() const {
    return m_complaints;
}
void OAITimeseries_inner::setComplaints(const qint32 &complaints) {
    m_complaints = complaints;
    m_complaints_isSet = true;
}

bool OAITimeseries_inner::is_complaints_Set() const{
    return m_complaints_isSet;
}

bool OAITimeseries_inner::is_complaints_Valid() const{
    return m_complaints_isValid;
}

qint32 OAITimeseries_inner::getHardBounces() const {
    return m_hard_bounces;
}
void OAITimeseries_inner::setHardBounces(const qint32 &hard_bounces) {
    m_hard_bounces = hard_bounces;
    m_hard_bounces_isSet = true;
}

bool OAITimeseries_inner::is_hard_bounces_Set() const{
    return m_hard_bounces_isSet;
}

bool OAITimeseries_inner::is_hard_bounces_Valid() const{
    return m_hard_bounces_isValid;
}

qint32 OAITimeseries_inner::getOpens() const {
    return m_opens;
}
void OAITimeseries_inner::setOpens(const qint32 &opens) {
    m_opens = opens;
    m_opens_isSet = true;
}

bool OAITimeseries_inner::is_opens_Set() const{
    return m_opens_isSet;
}

bool OAITimeseries_inner::is_opens_Valid() const{
    return m_opens_isValid;
}

qint32 OAITimeseries_inner::getRejects() const {
    return m_rejects;
}
void OAITimeseries_inner::setRejects(const qint32 &rejects) {
    m_rejects = rejects;
    m_rejects_isSet = true;
}

bool OAITimeseries_inner::is_rejects_Set() const{
    return m_rejects_isSet;
}

bool OAITimeseries_inner::is_rejects_Valid() const{
    return m_rejects_isValid;
}

qint32 OAITimeseries_inner::getSent() const {
    return m_sent;
}
void OAITimeseries_inner::setSent(const qint32 &sent) {
    m_sent = sent;
    m_sent_isSet = true;
}

bool OAITimeseries_inner::is_sent_Set() const{
    return m_sent_isSet;
}

bool OAITimeseries_inner::is_sent_Valid() const{
    return m_sent_isValid;
}

qint32 OAITimeseries_inner::getSoftBounces() const {
    return m_soft_bounces;
}
void OAITimeseries_inner::setSoftBounces(const qint32 &soft_bounces) {
    m_soft_bounces = soft_bounces;
    m_soft_bounces_isSet = true;
}

bool OAITimeseries_inner::is_soft_bounces_Set() const{
    return m_soft_bounces_isSet;
}

bool OAITimeseries_inner::is_soft_bounces_Valid() const{
    return m_soft_bounces_isValid;
}

QString OAITimeseries_inner::getTime() const {
    return m_time;
}
void OAITimeseries_inner::setTime(const QString &time) {
    m_time = time;
    m_time_isSet = true;
}

bool OAITimeseries_inner::is_time_Set() const{
    return m_time_isSet;
}

bool OAITimeseries_inner::is_time_Valid() const{
    return m_time_isValid;
}

qint32 OAITimeseries_inner::getUniqueClicks() const {
    return m_unique_clicks;
}
void OAITimeseries_inner::setUniqueClicks(const qint32 &unique_clicks) {
    m_unique_clicks = unique_clicks;
    m_unique_clicks_isSet = true;
}

bool OAITimeseries_inner::is_unique_clicks_Set() const{
    return m_unique_clicks_isSet;
}

bool OAITimeseries_inner::is_unique_clicks_Valid() const{
    return m_unique_clicks_isValid;
}

qint32 OAITimeseries_inner::getUniqueOpens() const {
    return m_unique_opens;
}
void OAITimeseries_inner::setUniqueOpens(const qint32 &unique_opens) {
    m_unique_opens = unique_opens;
    m_unique_opens_isSet = true;
}

bool OAITimeseries_inner::is_unique_opens_Set() const{
    return m_unique_opens_isSet;
}

bool OAITimeseries_inner::is_unique_opens_Valid() const{
    return m_unique_opens_isValid;
}

qint32 OAITimeseries_inner::getUnsubs() const {
    return m_unsubs;
}
void OAITimeseries_inner::setUnsubs(const qint32 &unsubs) {
    m_unsubs = unsubs;
    m_unsubs_isSet = true;
}

bool OAITimeseries_inner::is_unsubs_Set() const{
    return m_unsubs_isSet;
}

bool OAITimeseries_inner::is_unsubs_Valid() const{
    return m_unsubs_isValid;
}

bool OAITimeseries_inner::isSet() const {
...
bool OAITimeseries_inner::isValid() const {
