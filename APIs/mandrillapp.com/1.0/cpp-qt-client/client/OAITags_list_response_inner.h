...
/*
 * OAITags_list_response_inner.h
 *
 * 
 */

#ifndef OAITags_list_response_inner_H
#define OAITags_list_response_inner_H
...
class OAITags_list_response_inner : public OAIObject {
public:
    OAITags_list_response_inner();
    OAITags_list_response_inner(QString json);
    ~OAITags_list_response_inner() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITags_list_response_inner)

#endif // OAITags_list_response_inner_H
