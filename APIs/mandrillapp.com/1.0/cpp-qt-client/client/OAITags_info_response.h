...
/*
 * OAITags_info_response.h
 *
 * 
 */

#ifndef OAITags_info_response_H
#define OAITags_info_response_H
...
class OAITags_info_response : public OAIObject {
public:
    OAITags_info_response();
    OAITags_info_response(QString json);
    ~OAITags_info_response() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITags_info_response)

#endif // OAITags_info_response_H
