...
/*
 * OAITimeseries_inner.h
 *
 * 
 */

#ifndef OAITimeseries_inner_H
#define OAITimeseries_inner_H
...
class OAITimeseries_inner : public OAIObject {
public:
    OAITimeseries_inner();
    OAITimeseries_inner(QString json);
    ~OAITimeseries_inner() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITimeseries_inner)

#endif // OAITimeseries_inner_H
