...
/*
 * OAIMessages_search_response_inner.h
 *
 * 
 */

#ifndef OAIMessages_search_response_inner_H
#define OAIMessages_search_response_inner_H
...
class OAIMessages_search_response_inner : public OAIObject {
public:
    OAIMessages_search_response_inner();
    OAIMessages_search_response_inner(QString json);
    ~OAIMessages_search_response_inner() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMessages_search_response_inner)

#endif // OAIMessages_search_response_inner_H
