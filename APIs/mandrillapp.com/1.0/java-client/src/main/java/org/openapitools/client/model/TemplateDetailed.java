...
public class TemplateDetailed {
  ...
  public TemplateDetailed code(String code) {
    this.code = code;
    return this;
  }
  ...
  public TemplateDetailed createdAt(String createdAt) {
  ...
  public TemplateDetailed fromEmail(String fromEmail) {
  ...
  public TemplateDetailed fromName(String fromName) {
  ...
  public TemplateDetailed labels(List<String> labels) {
    this.labels = labels;
    return this;
  }

  public TemplateDetailed addLabelsItem(String labelsItem) {
    if (this.labels == null) {
  ...
  public TemplateDetailed name(String name) {
    this.name = name;
    return this;
  }
  ...
  public TemplateDetailed publishCode(String publishCode) {
  ...
  public TemplateDetailed publishFromEmail(String publishFromEmail) {
  ...
  public TemplateDetailed publishFromName(String publishFromName) {
  ...
  public TemplateDetailed publishName(String publishName) {
  ...
  public TemplateDetailed publishSubject(String publishSubject) {
  ...
  public TemplateDetailed publishText(String publishText) {
  ...
  public TemplateDetailed publishedAt(String publishedAt) {
  ...
  public TemplateDetailed slug(String slug) {
    this.slug = slug;
    return this;
  }
  ...
  public TemplateDetailed subject(String subject) {
  ...
  public TemplateDetailed text(String text) {
    this.text = text;
    return this;
  }
  ...
  public TemplateDetailed updatedAt(String updatedAt) {
  ...
  public boolean equals(Object o) {
    ...
    TemplateDetailed templateDetailed = (TemplateDetailed) o;
    return Objects.equals(this.code, templateDetailed.code) &&
        Objects.equals(this.createdAt, templateDetailed.createdAt) &&
        Objects.equals(this.fromEmail, templateDetailed.fromEmail) &&
        Objects.equals(this.fromName, templateDetailed.fromName) &&
        Objects.equals(this.labels, templateDetailed.labels) &&
        Objects.equals(this.name, templateDetailed.name) &&
        Objects.equals(this.publishCode, templateDetailed.publishCode) &&
        Objects.equals(this.publishFromEmail, templateDetailed.publishFromEmail) &&
        Objects.equals(this.publishFromName, templateDetailed.publishFromName) &&
        Objects.equals(this.publishName, templateDetailed.publishName) &&
        Objects.equals(this.publishSubject, templateDetailed.publishSubject) &&
        Objects.equals(this.publishText, templateDetailed.publishText) &&
        Objects.equals(this.publishedAt, templateDetailed.publishedAt) &&
        Objects.equals(this.slug, templateDetailed.slug) &&
        Objects.equals(this.subject, templateDetailed.subject) &&
        Objects.equals(this.text, templateDetailed.text) &&
        Objects.equals(this.updatedAt, templateDetailed.updatedAt);
  }
  ...
  public String toString() {
    ...
    sb.append("class TemplateDetailed {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to TemplateDetailed
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TemplateDetailed.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TemplateDetailed is not found in the empty JSON string", TemplateDetailed.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TemplateDetailed.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TemplateDetailed` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TemplateDetailed.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TemplateDetailed' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TemplateDetailed> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TemplateDetailed.class));

       return (TypeAdapter<T>) new TypeAdapter<TemplateDetailed>() {
           @Override
           public void write(JsonWriter out, TemplateDetailed value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TemplateDetailed read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of TemplateDetailed given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of TemplateDetailed
   * @throws IOException if the JSON string is invalid with respect to TemplateDetailed
   */
  public static TemplateDetailed fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TemplateDetailed.class);
  }

  /**
   * Convert an instance of TemplateDetailed to an JSON string
   *
   * @return JSON string
   */
