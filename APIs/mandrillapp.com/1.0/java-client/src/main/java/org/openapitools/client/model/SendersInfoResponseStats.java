...
public class SendersInfoResponseStats {
  ...
  public SendersInfoResponseStats() {
  }

  public SendersInfoResponseStats last30Days(SendersInfoResponseStatsLast30Days last30Days) {
  ...
  public SendersInfoResponseStats last60Days(SendersInfoResponseStatsLast30Days last60Days) {
  ...
  public SendersInfoResponseStats last7Days(SendersInfoResponseStatsLast30Days last7Days) {
  ...
  public SendersInfoResponseStats last90Days(SendersInfoResponseStatsLast30Days last90Days) {
  ...
  public SendersInfoResponseStats today(SendersInfoResponseStatsLast30Days today) {
    this.today = today;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    SendersInfoResponseStats sendersInfoResponseStats = (SendersInfoResponseStats) o;
    return Objects.equals(this.last30Days, sendersInfoResponseStats.last30Days) &&
        Objects.equals(this.last60Days, sendersInfoResponseStats.last60Days) &&
        Objects.equals(this.last7Days, sendersInfoResponseStats.last7Days) &&
        Objects.equals(this.last90Days, sendersInfoResponseStats.last90Days) &&
        Objects.equals(this.today, sendersInfoResponseStats.today);
  }

  @Override
  public int hashCode() {
    return Objects.hash(last30Days, last60Days, last7Days, last90Days, today);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class SendersInfoResponseStats {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to SendersInfoResponseStats
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SendersInfoResponseStats.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SendersInfoResponseStats is not found in the empty JSON string", SendersInfoResponseStats.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SendersInfoResponseStats.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SendersInfoResponseStats` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SendersInfoResponseStats.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SendersInfoResponseStats' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SendersInfoResponseStats> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SendersInfoResponseStats.class));

       return (TypeAdapter<T>) new TypeAdapter<SendersInfoResponseStats>() {
           @Override
           public void write(JsonWriter out, SendersInfoResponseStats value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SendersInfoResponseStats read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SendersInfoResponseStats given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SendersInfoResponseStats
   * @throws IOException if the JSON string is invalid with respect to SendersInfoResponseStats
   */
  public static SendersInfoResponseStats fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SendersInfoResponseStats.class);
  }

  /**
   * Convert an instance of SendersInfoResponseStats to an JSON string
   *
   * @return JSON string
   */
