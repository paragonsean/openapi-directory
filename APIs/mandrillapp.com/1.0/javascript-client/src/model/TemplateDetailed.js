...
/**
 * The TemplateDetailed model module.
 * @module model/TemplateDetailed
 * @version 1.0
 */
class TemplateDetailed {
    /**
     * Constructs a new <code>TemplateDetailed</code>.
     * @alias module:model/TemplateDetailed
     */
    constructor() { 
        
        TemplateDetailed.initialize(this);
    }
    ...
    /**
     * Constructs a <code>TemplateDetailed</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/TemplateDetailed} obj Optional instance to populate.
     * @return {module:model/TemplateDetailed} The populated <code>TemplateDetailed</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new TemplateDetailed();
    ...
    /**
     * Validates the JSON data with respect to <code>TemplateDetailed</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TemplateDetailed</code>.
     */
 ...
 * @member {String} code
 */
TemplateDetailed.prototype['code'] = undefined;

/**
 * @member {String} created_at
 */
TemplateDetailed.prototype['created_at'] = undefined;

/**
 * @member {String} from_email
 */
TemplateDetailed.prototype['from_email'] = undefined;

/**
 * @member {String} from_name
 */
TemplateDetailed.prototype['from_name'] = undefined;

/**
 * @member {Array.<String>} labels
 */
TemplateDetailed.prototype['labels'] = undefined;

/**
 * @member {String} name
 */
TemplateDetailed.prototype['name'] = undefined;

/**
 * @member {String} publish_code
 */
TemplateDetailed.prototype['publish_code'] = undefined;

/**
 * @member {String} publish_from_email
 */
TemplateDetailed.prototype['publish_from_email'] = undefined;

/**
 * @member {String} publish_from_name
 */
TemplateDetailed.prototype['publish_from_name'] = undefined;

/**
 * @member {String} publish_name
 */
TemplateDetailed.prototype['publish_name'] = undefined;

/**
 * @member {String} publish_subject
 */
TemplateDetailed.prototype['publish_subject'] = undefined;

/**
 * @member {String} publish_text
 */
TemplateDetailed.prototype['publish_text'] = undefined;

/**
 * @member {String} published_at
 */
TemplateDetailed.prototype['published_at'] = undefined;

/**
 * @member {String} slug
 */
TemplateDetailed.prototype['slug'] = undefined;

/**
 * @member {String} subject
 */
TemplateDetailed.prototype['subject'] = undefined;

/**
 * @member {String} text
 */
TemplateDetailed.prototype['text'] = undefined;

/**
 * @member {String} updated_at
 */
TemplateDetailed.prototype['updated_at'] = undefined;
...
export default TemplateDetailed;
