...
/**
 * The MessagesSearch model module.
 * @module model/MessagesSearch
 * @version 1.0
 */
class MessagesSearch {
    /**
     * Constructs a new <code>MessagesSearch</code>.
     * @alias module:model/MessagesSearch
     */
    constructor() { 
        
        MessagesSearch.initialize(this);
    }
    ...
    /**
     * Constructs a <code>MessagesSearch</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/MessagesSearch} obj Optional instance to populate.
     * @return {module:model/MessagesSearch} The populated <code>MessagesSearch</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new MessagesSearch();
    ...
    /**
     * Validates the JSON data with respect to <code>MessagesSearch</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>MessagesSearch</code>.
     */
 ...
 */
MessagesSearch.prototype['api_keys'] = undefined;

/**
 * @member {String} date_from
 */
MessagesSearch.prototype['date_from'] = undefined;

/**
 * @member {String} date_to
 */
MessagesSearch.prototype['date_to'] = undefined;

/**
 * @member {String} key
 */
MessagesSearch.prototype['key'] = undefined;

/**
 * @member {Number} limit
 */
MessagesSearch.prototype['limit'] = undefined;

/**
 * @member {String} query
 */
MessagesSearch.prototype['query'] = undefined;

/**
 * @member {Array.<String>} senders
 */
MessagesSearch.prototype['senders'] = undefined;

/**
 * @member {Array.<String>} tags
 */
MessagesSearch.prototype['tags'] = undefined;
