...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Mandrill.TagsInfoResponse();
  });
  ...
  describe('TagsInfoResponse', function() {
    it('should create an instance of TagsInfoResponse', function() {
      // uncomment below and update the code to test TagsInfoResponse
      //var instance = new Mandrill.TagsInfoResponse();
      //expect(instance).to.be.a(Mandrill.TagsInfoResponse);
    });
