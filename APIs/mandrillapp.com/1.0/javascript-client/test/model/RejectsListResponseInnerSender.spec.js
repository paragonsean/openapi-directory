...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Mandrill.RejectsListResponseInnerSender();
  });
  ...
  describe('RejectsListResponseInnerSender', function() {
    it('should create an instance of RejectsListResponseInnerSender', function() {
      // uncomment below and update the code to test RejectsListResponseInnerSender
      //var instance = new Mandrill.RejectsListResponseInnerSender();
      //expect(instance).to.be.a(Mandrill.RejectsListResponseInnerSender);
    });
