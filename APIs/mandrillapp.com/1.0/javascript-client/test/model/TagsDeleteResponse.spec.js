...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Mandrill.TagsDeleteResponse();
  });
  ...
  describe('TagsDeleteResponse', function() {
    it('should create an instance of TagsDeleteResponse', function() {
      // uncomment below and update the code to test TagsDeleteResponse
      //var instance = new Mandrill.TagsDeleteResponse();
      //expect(instance).to.be.a(Mandrill.TagsDeleteResponse);
    });
