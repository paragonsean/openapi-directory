...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Mandrill.MessagesSearchTimeSeries();
  });
  ...
  describe('MessagesSearchTimeSeries', function() {
    it('should create an instance of MessagesSearchTimeSeries', function() {
      // uncomment below and update the code to test MessagesSearchTimeSeries
      //var instance = new Mandrill.MessagesSearchTimeSeries();
      //expect(instance).to.be.a(Mandrill.MessagesSearchTimeSeries);
    });
