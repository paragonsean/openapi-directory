...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Mandrill.RejectsList();
  });
  ...
  describe('RejectsList', function() {
    it('should create an instance of RejectsList', function() {
      // uncomment below and update the code to test RejectsList
      //var instance = new Mandrill.RejectsList();
      //expect(instance).to.be.a(Mandrill.RejectsList);
    });
