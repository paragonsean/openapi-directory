...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Mandrill.MessagesSearch();
  });
  ...
  describe('MessagesSearch', function() {
    it('should create an instance of MessagesSearch', function() {
      // uncomment below and update the code to test MessagesSearch
      //var instance = new Mandrill.MessagesSearch();
      //expect(instance).to.be.a(Mandrill.MessagesSearch);
    });
