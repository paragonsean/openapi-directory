...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Mandrill.SendersInfoResponseStatsLast30Days();
  });
  ...
  describe('SendersInfoResponseStatsLast30Days', function() {
    it('should create an instance of SendersInfoResponseStatsLast30Days', function() {
      // uncomment below and update the code to test SendersInfoResponseStatsLast30Days
      //var instance = new Mandrill.SendersInfoResponseStatsLast30Days();
      //expect(instance).to.be.a(Mandrill.SendersInfoResponseStatsLast30Days);
    });
