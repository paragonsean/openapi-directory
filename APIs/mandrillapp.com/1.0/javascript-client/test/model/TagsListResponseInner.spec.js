...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Mandrill.TagsListResponseInner();
  });
  ...
  describe('TagsListResponseInner', function() {
    it('should create an instance of TagsListResponseInner', function() {
      // uncomment below and update the code to test TagsListResponseInner
      //var instance = new Mandrill.TagsListResponseInner();
      //expect(instance).to.be.a(Mandrill.TagsListResponseInner);
    });
