...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Mandrill.SchedulingchangeInfo();
  });
  ...
  describe('SchedulingchangeInfo', function() {
    it('should create an instance of SchedulingchangeInfo', function() {
      // uncomment below and update the code to test SchedulingchangeInfo
      //var instance = new Mandrill.SchedulingchangeInfo();
      //expect(instance).to.be.a(Mandrill.SchedulingchangeInfo);
    });
