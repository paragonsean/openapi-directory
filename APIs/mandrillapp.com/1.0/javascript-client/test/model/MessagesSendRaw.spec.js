...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Mandrill.MessagesSendRaw();
  });
  ...
  describe('MessagesSendRaw', function() {
    it('should create an instance of MessagesSendRaw', function() {
      // uncomment below and update the code to test MessagesSendRaw
      //var instance = new Mandrill.MessagesSendRaw();
      //expect(instance).to.be.a(Mandrill.MessagesSendRaw);
    });
