...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PdfBrokerIoApi.ColorDto();
  });
  ...
  describe('ColorDto', function() {
    it('should create an instance of ColorDto', function() {
      // uncomment below and update the code to test ColorDto
      //var instance = new PdfBrokerIoApi.ColorDto();
      //expect(instance).to.be.a(PdfBrokerIoApi.ColorDto);
    });
