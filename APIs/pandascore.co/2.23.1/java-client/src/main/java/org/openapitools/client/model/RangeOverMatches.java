...
public class RangeOverMatches {
  ...
  public RangeOverMatches() {
  }

  public RangeOverMatches beginAt(List<OffsetDateTime> beginAt) {
    this.beginAt = beginAt;
    return this;
  }

  public RangeOverMatches addBeginAtItem(OffsetDateTime beginAtItem) {
  ...
  public RangeOverMatches detailedStats(List<Boolean> detailedStats) {
    this.detailedStats = detailedStats;
    return this;
  }

  public RangeOverMatches addDetailedStatsItem(Boolean detailedStatsItem) {
  ...
  public RangeOverMatches draw(List<Boolean> draw) {
    this.draw = draw;
    return this;
  }

  public RangeOverMatches addDrawItem(Boolean drawItem) {
    if (this.draw == null) {
  ...
  public RangeOverMatches endAt(List<OffsetDateTime> endAt) {
    this.endAt = endAt;
    return this;
  }

  public RangeOverMatches addEndAtItem(OffsetDateTime endAtItem) {
    if (this.endAt == null) {
  ...
  public RangeOverMatches forfeit(List<Boolean> forfeit) {
    this.forfeit = forfeit;
    return this;
  }

  public RangeOverMatches addForfeitItem(Boolean forfeitItem) {
  ...
  public RangeOverMatches id(List<Integer> id) {
    this.id = id;
    return this;
  }

  public RangeOverMatches addIdItem(Integer idItem) {
    if (this.id == null) {
  ...
  public RangeOverMatches matchType(List<MatchType> matchType) {
    this.matchType = matchType;
    return this;
  }

  public RangeOverMatches addMatchTypeItem(MatchType matchTypeItem) {
  ...
  public RangeOverMatches modifiedAt(List<OffsetDateTime> modifiedAt) {
    this.modifiedAt = modifiedAt;
    return this;
  }

  public RangeOverMatches addModifiedAtItem(OffsetDateTime modifiedAtItem) {
  ...
  public RangeOverMatches name(List<String> name) {
    this.name = name;
    return this;
  }

  public RangeOverMatches addNameItem(String nameItem) {
    if (this.name == null) {
  ...
  public RangeOverMatches numberOfGames(List<Integer> numberOfGames) {
    this.numberOfGames = numberOfGames;
    return this;
  }

  public RangeOverMatches addNumberOfGamesItem(Integer numberOfGamesItem) {
  ...
  public RangeOverMatches scheduledAt(List<OffsetDateTime> scheduledAt) {
    this.scheduledAt = scheduledAt;
    return this;
  }

  public RangeOverMatches addScheduledAtItem(OffsetDateTime scheduledAtItem) {
  ...
  public RangeOverMatches slug(List<String> slug) {
    this.slug = slug;
    return this;
  }

  public RangeOverMatches addSlugItem(String slugItem) {
    if (this.slug == null) {
  ...
  public RangeOverMatches status(List<MatchStatus> status) {
    this.status = status;
    return this;
  }

  public RangeOverMatches addStatusItem(MatchStatus statusItem) {
    if (this.status == null) {
  ...
  public RangeOverMatches tournamentId(List<Integer> tournamentId) {
    this.tournamentId = tournamentId;
    return this;
  }

  public RangeOverMatches addTournamentIdItem(Integer tournamentIdItem) {
  ...
  public RangeOverMatches winnerId(List<OpponentID> winnerId) {
    this.winnerId = winnerId;
    return this;
  }

  public RangeOverMatches addWinnerIdItem(OpponentID winnerIdItem) {
  ...
  public boolean equals(Object o) {
    ...
    RangeOverMatches rangeOverMatches = (RangeOverMatches) o;
    return Objects.equals(this.beginAt, rangeOverMatches.beginAt) &&
        Objects.equals(this.detailedStats, rangeOverMatches.detailedStats) &&
        Objects.equals(this.draw, rangeOverMatches.draw) &&
        Objects.equals(this.endAt, rangeOverMatches.endAt) &&
        Objects.equals(this.forfeit, rangeOverMatches.forfeit) &&
        Objects.equals(this.id, rangeOverMatches.id) &&
        Objects.equals(this.matchType, rangeOverMatches.matchType) &&
        Objects.equals(this.modifiedAt, rangeOverMatches.modifiedAt) &&
        Objects.equals(this.name, rangeOverMatches.name) &&
        Objects.equals(this.numberOfGames, rangeOverMatches.numberOfGames) &&
        Objects.equals(this.scheduledAt, rangeOverMatches.scheduledAt) &&
        Objects.equals(this.slug, rangeOverMatches.slug) &&
        Objects.equals(this.status, rangeOverMatches.status) &&
        Objects.equals(this.tournamentId, rangeOverMatches.tournamentId) &&
        Objects.equals(this.winnerId, rangeOverMatches.winnerId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(beginAt, detailedStats, draw, endAt, forfeit, id, matchType, modifiedAt, name, numberOfGames, scheduledAt, slug, status, tournamentId, winnerId);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class RangeOverMatches {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to RangeOverMatches
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RangeOverMatches.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in RangeOverMatches is not found in the empty JSON string", RangeOverMatches.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RangeOverMatches.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `RangeOverMatches` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RangeOverMatches.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RangeOverMatches' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RangeOverMatches> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RangeOverMatches.class));

       return (TypeAdapter<T>) new TypeAdapter<RangeOverMatches>() {
           @Override
           public void write(JsonWriter out, RangeOverMatches value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public RangeOverMatches read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of RangeOverMatches given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of RangeOverMatches
   * @throws IOException if the JSON string is invalid with respect to RangeOverMatches
   */
  public static RangeOverMatches fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RangeOverMatches.class);
  }

  /**
   * Convert an instance of RangeOverMatches to an JSON string
   *
   * @return JSON string
   */
