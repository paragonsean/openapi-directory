...
import org.openapitools.client.model.StreamLanguage;
...
public class Stream {
  ...
  private StreamLanguage language;
  ...
  public Stream embedUrl(Object embedUrl) {
  ...
  public Stream language(StreamLanguage language) {
   ...
   */
  @javax.annotation.Nonnull
  public StreamLanguage getLanguage() {
    return language;
  }

  public void setLanguage(StreamLanguage language) {
    this.language = language;
  }


  public Stream main(Boolean main) {
    this.main = main;
    return this;
  }
  ...
  public Stream official(Boolean official) {
  ...
  public Stream rawUrl(URI rawUrl) {
    this.rawUrl = rawUrl;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.embedUrl, stream.embedUrl) &&
        Objects.equals(this.language, stream.language) &&
        Objects.equals(this.main, stream.main) &&
        Objects.equals(this.official, stream.official) &&
        Objects.equals(this.rawUrl, stream.rawUrl);
  }

  @Override
  public int hashCode() {
    return Objects.hash(embedUrl, language, main, official, rawUrl);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (String requiredField : Stream.openapiRequiredFields) {
      ...
      StreamLanguage.validateJsonElement(jsonObj.get("language"));
