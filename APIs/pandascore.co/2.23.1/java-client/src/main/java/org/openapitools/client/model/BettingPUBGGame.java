...
public class BettingPUBGGame {
  ...
  public BettingPUBGGame() {
  }

  public BettingPUBGGame beginAt(Object beginAt) {
  ...
  public BettingPUBGGame complete(Boolean complete) {
  ...
  public BettingPUBGGame detailedStats(Boolean detailedStats) {
  ...
  public BettingPUBGGame endAt(Object endAt) {
    this.endAt = endAt;
    return this;
  }
  ...
  public BettingPUBGGame finished(Boolean finished) {
  ...
  public BettingPUBGGame forfeit(Boolean forfeit) {
  ...
  public BettingPUBGGame id(Integer id) {
    this.id = id;
    return this;
  }
  ...
  public BettingPUBGGame length(Object length) {
    this.length = length;
    return this;
  }
  ...
  public BettingPUBGGame matchId(Integer matchId) {
  ...
  public BettingPUBGGame position(Integer position) {
  ...
  public BettingPUBGGame status(GameStatus status) {
    this.status = status;
    return this;
  }
  ...
  public BettingPUBGGame videoUrl(Object videoUrl) {
  ...
  public BettingPUBGGame winner(GameWinner winner) {
    this.winner = winner;
    return this;
  }
  ...
  public BettingPUBGGame winnerType(Object winnerType) {
  ...
  public boolean equals(Object o) {
    ...
    BettingPUBGGame bettingPUBGGame = (BettingPUBGGame) o;
    return Objects.equals(this.beginAt, bettingPUBGGame.beginAt) &&
        Objects.equals(this.complete, bettingPUBGGame.complete) &&
        Objects.equals(this.detailedStats, bettingPUBGGame.detailedStats) &&
        Objects.equals(this.endAt, bettingPUBGGame.endAt) &&
        Objects.equals(this.finished, bettingPUBGGame.finished) &&
        Objects.equals(this.forfeit, bettingPUBGGame.forfeit) &&
        Objects.equals(this.id, bettingPUBGGame.id) &&
        Objects.equals(this.length, bettingPUBGGame.length) &&
        Objects.equals(this.matchId, bettingPUBGGame.matchId) &&
        Objects.equals(this.position, bettingPUBGGame.position) &&
        Objects.equals(this.status, bettingPUBGGame.status) &&
        Objects.equals(this.videoUrl, bettingPUBGGame.videoUrl) &&
        Objects.equals(this.winner, bettingPUBGGame.winner) &&
        Objects.equals(this.winnerType, bettingPUBGGame.winnerType);
  }
  ...
  public String toString() {
    ...
    sb.append("class BettingPUBGGame {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to BettingPUBGGame
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!BettingPUBGGame.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in BettingPUBGGame is not found in the empty JSON string", BettingPUBGGame.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!BettingPUBGGame.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `BettingPUBGGame` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : BettingPUBGGame.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!BettingPUBGGame.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'BettingPUBGGame' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<BettingPUBGGame> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(BettingPUBGGame.class));

       return (TypeAdapter<T>) new TypeAdapter<BettingPUBGGame>() {
           @Override
           public void write(JsonWriter out, BettingPUBGGame value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public BettingPUBGGame read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of BettingPUBGGame given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of BettingPUBGGame
   * @throws IOException if the JSON string is invalid with respect to BettingPUBGGame
   */
  public static BettingPUBGGame fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, BettingPUBGGame.class);
  }

  /**
   * Convert an instance of BettingPUBGGame to an JSON string
   *
   * @return JSON string
   */
