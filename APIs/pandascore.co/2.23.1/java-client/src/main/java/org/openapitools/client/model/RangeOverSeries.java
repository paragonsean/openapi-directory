...
public class RangeOverSeries {
  ...
  public RangeOverSeries() {
  }

  public RangeOverSeries beginAt(List<OffsetDateTime> beginAt) {
    this.beginAt = beginAt;
    return this;
  }

  public RangeOverSeries addBeginAtItem(OffsetDateTime beginAtItem) {
  ...
  public RangeOverSeries description(List<String> description) {
    this.description = description;
    return this;
  }

  public RangeOverSeries addDescriptionItem(String descriptionItem) {
  ...
  public RangeOverSeries endAt(List<OffsetDateTime> endAt) {
    this.endAt = endAt;
    return this;
  }

  public RangeOverSeries addEndAtItem(OffsetDateTime endAtItem) {
    if (this.endAt == null) {
  ...
  public RangeOverSeries id(List<Integer> id) {
    this.id = id;
    return this;
  }

  public RangeOverSeries addIdItem(Integer idItem) {
    if (this.id == null) {
  ...
  public RangeOverSeries leagueId(List<Integer> leagueId) {
    this.leagueId = leagueId;
    return this;
  }

  public RangeOverSeries addLeagueIdItem(Integer leagueIdItem) {
  ...
  public RangeOverSeries modifiedAt(List<OffsetDateTime> modifiedAt) {
    this.modifiedAt = modifiedAt;
    return this;
  }

  public RangeOverSeries addModifiedAtItem(OffsetDateTime modifiedAtItem) {
  ...
  public RangeOverSeries name(List<String> name) {
    this.name = name;
    return this;
  }

  public RangeOverSeries addNameItem(String nameItem) {
    if (this.name == null) {
  ...
  public RangeOverSeries season(List<String> season) {
    this.season = season;
    return this;
  }

  public RangeOverSeries addSeasonItem(String seasonItem) {
    if (this.season == null) {
  ...
  public RangeOverSeries slug(List<String> slug) {
    this.slug = slug;
    return this;
  }

  public RangeOverSeries addSlugItem(String slugItem) {
    if (this.slug == null) {
  ...
  public RangeOverSeries tier(List<String> tier) {
    this.tier = tier;
    return this;
  }

  public RangeOverSeries addTierItem(String tierItem) {
    if (this.tier == null) {
  ...
  public RangeOverSeries winnerId(List<OpponentID> winnerId) {
    this.winnerId = winnerId;
    return this;
  }

  public RangeOverSeries addWinnerIdItem(OpponentID winnerIdItem) {
  ...
  public RangeOverSeries winnerType(List<OpponentType> winnerType) {
    this.winnerType = winnerType;
    return this;
  }

  public RangeOverSeries addWinnerTypeItem(OpponentType winnerTypeItem) {
  ...
  public RangeOverSeries year(List<Integer> year) {
    this.year = year;
    return this;
  }

  public RangeOverSeries addYearItem(Integer yearItem) {
    if (this.year == null) {
  ...
  public boolean equals(Object o) {
    ...
    RangeOverSeries rangeOverSeries = (RangeOverSeries) o;
    return Objects.equals(this.beginAt, rangeOverSeries.beginAt) &&
        Objects.equals(this.description, rangeOverSeries.description) &&
        Objects.equals(this.endAt, rangeOverSeries.endAt) &&
        Objects.equals(this.id, rangeOverSeries.id) &&
        Objects.equals(this.leagueId, rangeOverSeries.leagueId) &&
        Objects.equals(this.modifiedAt, rangeOverSeries.modifiedAt) &&
        Objects.equals(this.name, rangeOverSeries.name) &&
        Objects.equals(this.season, rangeOverSeries.season) &&
        Objects.equals(this.slug, rangeOverSeries.slug) &&
        Objects.equals(this.tier, rangeOverSeries.tier) &&
        Objects.equals(this.winnerId, rangeOverSeries.winnerId) &&
        Objects.equals(this.winnerType, rangeOverSeries.winnerType) &&
        Objects.equals(this.year, rangeOverSeries.year);
  }
  ...
  public String toString() {
    ...
    sb.append("class RangeOverSeries {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to RangeOverSeries
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RangeOverSeries.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in RangeOverSeries is not found in the empty JSON string", RangeOverSeries.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RangeOverSeries.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `RangeOverSeries` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RangeOverSeries.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RangeOverSeries' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RangeOverSeries> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RangeOverSeries.class));

       return (TypeAdapter<T>) new TypeAdapter<RangeOverSeries>() {
           @Override
           public void write(JsonWriter out, RangeOverSeries value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public RangeOverSeries read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of RangeOverSeries given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of RangeOverSeries
   * @throws IOException if the JSON string is invalid with respect to RangeOverSeries
   */
  public static RangeOverSeries fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RangeOverSeries.class);
  }

  /**
   * Convert an instance of RangeOverSeries to an JSON string
   *
   * @return JSON string
   */
