...
public class Bracket {
  ...
  public static final String SERIALIZED_NAME_PREVIOUS_MATCHES = "previous_matches";
  @SerializedName(SERIALIZED_NAME_PREVIOUS_MATCHES)
  ...
  public Bracket beginAt(Object beginAt) {
  ...
  public Bracket detailedStats(Boolean detailedStats) {
  ...
  public Bracket draw(Boolean draw) {
    this.draw = draw;
    return this;
  }
  ...
  public Bracket endAt(Object endAt) {
    this.endAt = endAt;
    return this;
  }
  ...
  public Bracket forfeit(Boolean forfeit) {
  ...
  public Bracket gameAdvantage(OpponentID1 gameAdvantage) {
  ...
  public Bracket games(List<Game> games) {
    this.games = games;
    return this;
  }

  public Bracket addGamesItem(Game gamesItem) {
    if (this.games == null) {
  ...
  public Bracket live(MatchLive live) {
    this.live = live;
    return this;
  }
  ...
  @Deprecated
  public Bracket liveEmbedUrl(Object liveEmbedUrl) {
  ...
  public Bracket matchType(MatchType matchType) {
  ...
  public Bracket modifiedAt(OffsetDateTime modifiedAt) {
  ...
  public Bracket name(String name) {
    this.name = name;
    return this;
  }
  ...
  public Bracket numberOfGames(Integer numberOfGames) {
  ...
  @Deprecated
  public Bracket officialStreamUrl(Object officialStreamUrl) {
  ...
  public Bracket opponents(List<Opponent> opponents) {
    this.opponents = opponents;
    return this;
  }

  public Bracket addOpponentsItem(Opponent opponentsItem) {
  ...
  public Bracket originalScheduledAt(Object originalScheduledAt) {
  ...
  public Bracket previousMatches(List<PreviousMatch> previousMatches) {
    this.previousMatches = previousMatches;
    return this;
  }

  public Bracket addPreviousMatchesItem(PreviousMatch previousMatchesItem) {
    if (this.previousMatches == null) {
      this.previousMatches = new ArrayList<>();
    }
    this.previousMatches.add(previousMatchesItem);
    return this;
  }
  ...
  public void setPreviousMatches(List<PreviousMatch> previousMatches) {
    this.previousMatches = previousMatches;
  }


  public Bracket scheduledAt(Object scheduledAt) {
  ...
  public Bracket slug(Object slug) {
    this.slug = slug;
    return this;
  }
  ...
  public Bracket status(MatchStatus status) {
    this.status = status;
    return this;
  }
  ...
  @Deprecated
  public Bracket streams(MatchLocalizedStreams streams) {
  ...
  public Bracket streamsList(List<Stream> streamsList) {
    this.streamsList = streamsList;
    return this;
  }

  public Bracket addStreamsListItem(Stream streamsListItem) {
  ...
  public Bracket tournamentId(Integer tournamentId) {
  ...
  public Bracket winnerId(OpponentID1 winnerId) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.beginAt, bracket.beginAt) &&
        Objects.equals(this.detailedStats, bracket.detailedStats) &&
        Objects.equals(this.draw, bracket.draw) &&
        Objects.equals(this.endAt, bracket.endAt) &&
        Objects.equals(this.forfeit, bracket.forfeit) &&
        Objects.equals(this.gameAdvantage, bracket.gameAdvantage) &&
        Objects.equals(this.games, bracket.games) &&
        Objects.equals(this.id, bracket.id) &&
        Objects.equals(this.live, bracket.live) &&
        Objects.equals(this.liveEmbedUrl, bracket.liveEmbedUrl) &&
        Objects.equals(this.matchType, bracket.matchType) &&
        Objects.equals(this.modifiedAt, bracket.modifiedAt) &&
        Objects.equals(this.name, bracket.name) &&
        Objects.equals(this.numberOfGames, bracket.numberOfGames) &&
        Objects.equals(this.officialStreamUrl, bracket.officialStreamUrl) &&
        Objects.equals(this.opponents, bracket.opponents) &&
        Objects.equals(this.originalScheduledAt, bracket.originalScheduledAt) &&
        Objects.equals(this.previousMatches, bracket.previousMatches) &&
        Objects.equals(this.scheduledAt, bracket.scheduledAt) &&
        Objects.equals(this.slug, bracket.slug) &&
        Objects.equals(this.status, bracket.status) &&
        Objects.equals(this.streams, bracket.streams) &&
        Objects.equals(this.streamsList, bracket.streamsList) &&
        Objects.equals(this.tournamentId, bracket.tournamentId) &&
        Objects.equals(this.winnerId, bracket.winnerId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(beginAt, detailedStats, draw, endAt, forfeit, gameAdvantage, games, id, live, liveEmbedUrl, matchType, modifiedAt, name, numberOfGames, officialStreamUrl, opponents, originalScheduledAt, previousMatches, scheduledAt, slug, status, streams, streamsList, tournamentId, winnerId);
  }
  ...
  public String toString() {
    ...
    sb.append("    previousMatches: ").append(toIndentedString(previousMatches)).append("\n");
  ...
  static {
    ...
    openapiFields.add("previous_matches");
    ...
    openapiRequiredFields.add("previous_matches");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Bracket
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Bracket.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Bracket is not found in the empty JSON string", Bracket.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Bracket.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Bracket` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Bracket.openapiRequiredFields) {
      ...
      // ensure the json data is an array
      if (!jsonObj.get("previous_matches").isJsonArray()) {
        throw new IllegalArgumentException(String.format("Expected the field `previous_matches` to be an array in the JSON string but got `%s`", jsonObj.get("previous_matches").toString()));
      }

      JsonArray jsonArraypreviousMatches = jsonObj.getAsJsonArray("previous_matches");
      // validate the required field `previous_matches` (array)
      for (int i = 0; i < jsonArraypreviousMatches.size(); i++) {
        PreviousMatch.validateJsonElement(jsonArraypreviousMatches.get(i));
      };
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Bracket.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Bracket' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Bracket> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Bracket.class));

       return (TypeAdapter<T>) new TypeAdapter<Bracket>() {
           @Override
           public void write(JsonWriter out, Bracket value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Bracket read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Bracket given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Bracket
   * @throws IOException if the JSON string is invalid with respect to Bracket
   */
  public static Bracket fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Bracket.class);
  }

  /**
   * Convert an instance of Bracket to an JSON string
   *
   * @return JSON string
   */
