...
public class ApiClient {
    ...
    private String basePath = "https://api.pandascore.co";
    ...
    public ApiClient() {
        ...
        authentications.put("QueryToken", new ApiKeyAuth("query", "token"));
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://api.pandascore.co
