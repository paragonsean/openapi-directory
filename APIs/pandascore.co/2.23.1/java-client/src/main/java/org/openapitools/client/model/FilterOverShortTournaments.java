...
public class FilterOverShortTournaments {
  ...
  public FilterOverShortTournaments() {
  }

  public FilterOverShortTournaments beginAt(List<OffsetDateTime> beginAt) {
    this.beginAt = beginAt;
    return this;
  }

  public FilterOverShortTournaments addBeginAtItem(OffsetDateTime beginAtItem) {
  ...
  public FilterOverShortTournaments endAt(List<OffsetDateTime> endAt) {
    this.endAt = endAt;
    return this;
  }

  public FilterOverShortTournaments addEndAtItem(OffsetDateTime endAtItem) {
    if (this.endAt == null) {
  ...
  public FilterOverShortTournaments id(List<Integer> id) {
    this.id = id;
    return this;
  }

  public FilterOverShortTournaments addIdItem(Integer idItem) {
    if (this.id == null) {
  ...
  public FilterOverShortTournaments liveSupported(Boolean liveSupported) {
  ...
  public FilterOverShortTournaments modifiedAt(List<OffsetDateTime> modifiedAt) {
    this.modifiedAt = modifiedAt;
    return this;
  }

  public FilterOverShortTournaments addModifiedAtItem(OffsetDateTime modifiedAtItem) {
  ...
  public FilterOverShortTournaments name(List<String> name) {
    this.name = name;
    return this;
  }

  public FilterOverShortTournaments addNameItem(String nameItem) {
    if (this.name == null) {
  ...
  public FilterOverShortTournaments prizepool(List<String> prizepool) {
    this.prizepool = prizepool;
    return this;
  }

  public FilterOverShortTournaments addPrizepoolItem(String prizepoolItem) {
  ...
  public FilterOverShortTournaments serieId(List<Integer> serieId) {
    this.serieId = serieId;
    return this;
  }

  public FilterOverShortTournaments addSerieIdItem(Integer serieIdItem) {
  ...
  public FilterOverShortTournaments slug(List<String> slug) {
    this.slug = slug;
    return this;
  }

  public FilterOverShortTournaments addSlugItem(String slugItem) {
    if (this.slug == null) {
  ...
  public FilterOverShortTournaments winnerId(List<OpponentID> winnerId) {
    this.winnerId = winnerId;
    return this;
  }

  public FilterOverShortTournaments addWinnerIdItem(OpponentID winnerIdItem) {
  ...
  public FilterOverShortTournaments winnerType(List<OpponentType> winnerType) {
    this.winnerType = winnerType;
    return this;
  }

  public FilterOverShortTournaments addWinnerTypeItem(OpponentType winnerTypeItem) {
  ...
  public boolean equals(Object o) {
    ...
    FilterOverShortTournaments filterOverShortTournaments = (FilterOverShortTournaments) o;
    return Objects.equals(this.beginAt, filterOverShortTournaments.beginAt) &&
        Objects.equals(this.endAt, filterOverShortTournaments.endAt) &&
        Objects.equals(this.id, filterOverShortTournaments.id) &&
        Objects.equals(this.liveSupported, filterOverShortTournaments.liveSupported) &&
        Objects.equals(this.modifiedAt, filterOverShortTournaments.modifiedAt) &&
        Objects.equals(this.name, filterOverShortTournaments.name) &&
        Objects.equals(this.prizepool, filterOverShortTournaments.prizepool) &&
        Objects.equals(this.serieId, filterOverShortTournaments.serieId) &&
        Objects.equals(this.slug, filterOverShortTournaments.slug) &&
        Objects.equals(this.winnerId, filterOverShortTournaments.winnerId) &&
        Objects.equals(this.winnerType, filterOverShortTournaments.winnerType);
  }

  @Override
  public int hashCode() {
    return Objects.hash(beginAt, endAt, id, liveSupported, modifiedAt, name, prizepool, serieId, slug, winnerId, winnerType);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class FilterOverShortTournaments {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to FilterOverShortTournaments
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!FilterOverShortTournaments.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FilterOverShortTournaments is not found in the empty JSON string", FilterOverShortTournaments.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!FilterOverShortTournaments.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `FilterOverShortTournaments` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FilterOverShortTournaments.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FilterOverShortTournaments' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FilterOverShortTournaments> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FilterOverShortTournaments.class));

       return (TypeAdapter<T>) new TypeAdapter<FilterOverShortTournaments>() {
           @Override
           public void write(JsonWriter out, FilterOverShortTournaments value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public FilterOverShortTournaments read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of FilterOverShortTournaments given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of FilterOverShortTournaments
   * @throws IOException if the JSON string is invalid with respect to FilterOverShortTournaments
   */
  public static FilterOverShortTournaments fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FilterOverShortTournaments.class);
  }

  /**
   * Convert an instance of FilterOverShortTournaments to an JSON string
   *
   * @return JSON string
   */
