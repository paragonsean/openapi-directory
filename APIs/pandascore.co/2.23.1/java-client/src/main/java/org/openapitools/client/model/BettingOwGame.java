...
public class BettingOwGame {
  ...
  public BettingOwGame() {
  }

  public BettingOwGame beginAt(Object beginAt) {
  ...
  public BettingOwGame complete(Boolean complete) {
  ...
  public BettingOwGame detailedStats(Boolean detailedStats) {
  ...
  public BettingOwGame endAt(Object endAt) {
    this.endAt = endAt;
    return this;
  }
  ...
  public BettingOwGame finished(Boolean finished) {
  ...
  public BettingOwGame forfeit(Boolean forfeit) {
  ...
  public BettingOwGame id(Integer id) {
    this.id = id;
    return this;
  }
  ...
  public BettingOwGame length(Object length) {
    this.length = length;
    return this;
  }
  ...
  public BettingOwGame matchId(Integer matchId) {
  ...
  public BettingOwGame position(Integer position) {
  ...
  public BettingOwGame status(GameStatus status) {
    this.status = status;
    return this;
  }
  ...
  public BettingOwGame videoUrl(Object videoUrl) {
  ...
  public BettingOwGame winner(GameWinner winner) {
    this.winner = winner;
    return this;
  }
  ...
  public BettingOwGame winnerType(Object winnerType) {
  ...
  public boolean equals(Object o) {
    ...
    BettingOwGame bettingOwGame = (BettingOwGame) o;
    return Objects.equals(this.beginAt, bettingOwGame.beginAt) &&
        Objects.equals(this.complete, bettingOwGame.complete) &&
        Objects.equals(this.detailedStats, bettingOwGame.detailedStats) &&
        Objects.equals(this.endAt, bettingOwGame.endAt) &&
        Objects.equals(this.finished, bettingOwGame.finished) &&
        Objects.equals(this.forfeit, bettingOwGame.forfeit) &&
        Objects.equals(this.id, bettingOwGame.id) &&
        Objects.equals(this.length, bettingOwGame.length) &&
        Objects.equals(this.matchId, bettingOwGame.matchId) &&
        Objects.equals(this.position, bettingOwGame.position) &&
        Objects.equals(this.status, bettingOwGame.status) &&
        Objects.equals(this.videoUrl, bettingOwGame.videoUrl) &&
        Objects.equals(this.winner, bettingOwGame.winner) &&
        Objects.equals(this.winnerType, bettingOwGame.winnerType);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to BettingOwGame
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!BettingOwGame.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in BettingOwGame is not found in the empty JSON string", BettingOwGame.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!BettingOwGame.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `BettingOwGame` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : BettingOwGame.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!BettingOwGame.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'BettingOwGame' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<BettingOwGame> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(BettingOwGame.class));

       return (TypeAdapter<T>) new TypeAdapter<BettingOwGame>() {
           @Override
           public void write(JsonWriter out, BettingOwGame value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public BettingOwGame read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of BettingOwGame given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of BettingOwGame
   * @throws IOException if the JSON string is invalid with respect to BettingOwGame
   */
  public static BettingOwGame fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, BettingOwGame.class);
  }

  /**
   * Convert an instance of BettingOwGame to an JSON string
   *
   * @return JSON string
   */
