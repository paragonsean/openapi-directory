...
public class BaseTournament {
  ...
  public BaseTournament beginAt(Object beginAt) {
  ...
  public BaseTournament endAt(Object endAt) {
    this.endAt = endAt;
    return this;
  }
  ...
  public BaseTournament id(Integer id) {
    this.id = id;
    return this;
  }
  ...
  public BaseTournament leagueId(Integer leagueId) {
  ...
  public BaseTournament liveSupported(Boolean liveSupported) {
  ...
  public BaseTournament modifiedAt(OffsetDateTime modifiedAt) {
  ...
  public BaseTournament name(String name) {
    this.name = name;
    return this;
  }
  ...
  public BaseTournament prizepool(Object prizepool) {
  ...
  public BaseTournament serieId(Integer serieId) {
  ...
  public BaseTournament slug(String slug) {
    this.slug = slug;
    return this;
  }
  ...
  public BaseTournament winnerId(OpponentID1 winnerId) {
  ...
  public BaseTournament winnerType(Object winnerType) {
  ...
  public boolean equals(Object o) {
    ...
    BaseTournament baseTournament = (BaseTournament) o;
    return Objects.equals(this.beginAt, baseTournament.beginAt) &&
        Objects.equals(this.endAt, baseTournament.endAt) &&
        Objects.equals(this.id, baseTournament.id) &&
        Objects.equals(this.leagueId, baseTournament.leagueId) &&
        Objects.equals(this.liveSupported, baseTournament.liveSupported) &&
        Objects.equals(this.modifiedAt, baseTournament.modifiedAt) &&
        Objects.equals(this.name, baseTournament.name) &&
        Objects.equals(this.prizepool, baseTournament.prizepool) &&
        Objects.equals(this.serieId, baseTournament.serieId) &&
        Objects.equals(this.slug, baseTournament.slug) &&
        Objects.equals(this.winnerId, baseTournament.winnerId) &&
        Objects.equals(this.winnerType, baseTournament.winnerType);
  }

  @Override
  public int hashCode() {
    return Objects.hash(beginAt, endAt, id, leagueId, liveSupported, modifiedAt, name, prizepool, serieId, slug, winnerId, winnerType);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class BaseTournament {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to BaseTournament
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!BaseTournament.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in BaseTournament is not found in the empty JSON string", BaseTournament.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!BaseTournament.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `BaseTournament` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : BaseTournament.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!BaseTournament.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'BaseTournament' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<BaseTournament> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(BaseTournament.class));

       return (TypeAdapter<T>) new TypeAdapter<BaseTournament>() {
           @Override
           public void write(JsonWriter out, BaseTournament value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public BaseTournament read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of BaseTournament given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of BaseTournament
   * @throws IOException if the JSON string is invalid with respect to BaseTournament
   */
  public static BaseTournament fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, BaseTournament.class);
  }

  /**
   * Convert an instance of BaseTournament to an JSON string
   *
   * @return JSON string
   */
