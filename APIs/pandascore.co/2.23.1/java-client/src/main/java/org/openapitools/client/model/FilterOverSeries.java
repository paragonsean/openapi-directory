...
public class FilterOverSeries {
  ...
  public FilterOverSeries() {
  }

  public FilterOverSeries beginAt(List<OffsetDateTime> beginAt) {
    this.beginAt = beginAt;
    return this;
  }

  public FilterOverSeries addBeginAtItem(OffsetDateTime beginAtItem) {
  ...
  public FilterOverSeries description(List<String> description) {
    this.description = description;
    return this;
  }

  public FilterOverSeries addDescriptionItem(String descriptionItem) {
  ...
  public FilterOverSeries endAt(List<OffsetDateTime> endAt) {
    this.endAt = endAt;
    return this;
  }

  public FilterOverSeries addEndAtItem(OffsetDateTime endAtItem) {
    if (this.endAt == null) {
  ...
  public FilterOverSeries id(List<Integer> id) {
    this.id = id;
    return this;
  }

  public FilterOverSeries addIdItem(Integer idItem) {
    if (this.id == null) {
  ...
  public FilterOverSeries leagueId(List<Integer> leagueId) {
    this.leagueId = leagueId;
    return this;
  }

  public FilterOverSeries addLeagueIdItem(Integer leagueIdItem) {
  ...
  public FilterOverSeries modifiedAt(List<OffsetDateTime> modifiedAt) {
    this.modifiedAt = modifiedAt;
    return this;
  }

  public FilterOverSeries addModifiedAtItem(OffsetDateTime modifiedAtItem) {
  ...
  public FilterOverSeries name(List<String> name) {
    this.name = name;
    return this;
  }

  public FilterOverSeries addNameItem(String nameItem) {
    if (this.name == null) {
  ...
  public FilterOverSeries season(List<String> season) {
    this.season = season;
    return this;
  }

  public FilterOverSeries addSeasonItem(String seasonItem) {
    if (this.season == null) {
  ...
  public FilterOverSeries slug(List<String> slug) {
    this.slug = slug;
    return this;
  }

  public FilterOverSeries addSlugItem(String slugItem) {
    if (this.slug == null) {
  ...
  public FilterOverSeries tier(List<String> tier) {
    this.tier = tier;
    return this;
  }

  public FilterOverSeries addTierItem(String tierItem) {
    if (this.tier == null) {
  ...
  public FilterOverSeries winnerId(List<OpponentID> winnerId) {
    this.winnerId = winnerId;
    return this;
  }

  public FilterOverSeries addWinnerIdItem(OpponentID winnerIdItem) {
  ...
  public FilterOverSeries winnerType(List<OpponentType> winnerType) {
    this.winnerType = winnerType;
    return this;
  }

  public FilterOverSeries addWinnerTypeItem(OpponentType winnerTypeItem) {
  ...
  public FilterOverSeries year(List<Integer> year) {
    this.year = year;
    return this;
  }

  public FilterOverSeries addYearItem(Integer yearItem) {
    if (this.year == null) {
  ...
  public boolean equals(Object o) {
    ...
    FilterOverSeries filterOverSeries = (FilterOverSeries) o;
    return Objects.equals(this.beginAt, filterOverSeries.beginAt) &&
        Objects.equals(this.description, filterOverSeries.description) &&
        Objects.equals(this.endAt, filterOverSeries.endAt) &&
        Objects.equals(this.id, filterOverSeries.id) &&
        Objects.equals(this.leagueId, filterOverSeries.leagueId) &&
        Objects.equals(this.modifiedAt, filterOverSeries.modifiedAt) &&
        Objects.equals(this.name, filterOverSeries.name) &&
        Objects.equals(this.season, filterOverSeries.season) &&
        Objects.equals(this.slug, filterOverSeries.slug) &&
        Objects.equals(this.tier, filterOverSeries.tier) &&
        Objects.equals(this.winnerId, filterOverSeries.winnerId) &&
        Objects.equals(this.winnerType, filterOverSeries.winnerType) &&
        Objects.equals(this.year, filterOverSeries.year);
  }

  @Override
  public int hashCode() {
    return Objects.hash(beginAt, description, endAt, id, leagueId, modifiedAt, name, season, slug, tier, winnerId, winnerType, year);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class FilterOverSeries {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to FilterOverSeries
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!FilterOverSeries.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FilterOverSeries is not found in the empty JSON string", FilterOverSeries.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!FilterOverSeries.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `FilterOverSeries` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      // ensure the optional json data is an array if present
      if (jsonObj.get("season") != null && !jsonObj.get("season").isJsonNull() && !jsonObj.get("season").isJsonArray()) {
        throw new IllegalArgumentException(String.format("Expected the field `season` to be an array in the JSON string but got `%s`", jsonObj.get("season").toString()));
      }
      // ensure the optional json data is an array if present
      ...
      // ensure the optional json data is an array if present
      if (jsonObj.get("tier") != null && !jsonObj.get("tier").isJsonNull() && !jsonObj.get("tier").isJsonArray()) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FilterOverSeries.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FilterOverSeries' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FilterOverSeries> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FilterOverSeries.class));

       return (TypeAdapter<T>) new TypeAdapter<FilterOverSeries>() {
           @Override
           public void write(JsonWriter out, FilterOverSeries value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public FilterOverSeries read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of FilterOverSeries given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of FilterOverSeries
   * @throws IOException if the JSON string is invalid with respect to FilterOverSeries
   */
  public static FilterOverSeries fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FilterOverSeries.class);
  }

  /**
   * Convert an instance of FilterOverSeries to an JSON string
   *
   * @return JSON string
   */
