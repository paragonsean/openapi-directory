...
public class BettingSerie1 {
  ...
  public BettingSerie1() {
  }

  public BettingSerie1 beginAt(Object beginAt) {
  ...
  public BettingSerie1 description(Object description) {
  ...
  public BettingSerie1 endAt(Object endAt) {
    this.endAt = endAt;
    return this;
  }
  ...
  public BettingSerie1 fullName(String fullName) {
  ...
  public BettingSerie1 id(Integer id) {
    this.id = id;
    return this;
  }
  ...
  public BettingSerie1 leagueId(Integer leagueId) {
  ...
  public BettingSerie1 leagueImageUrl(Object leagueImageUrl) {
  ...
  public BettingSerie1 leagueName(String leagueName) {
  ...
  public BettingSerie1 modifiedAt(OffsetDateTime modifiedAt) {
  ...
  public BettingSerie1 name(Object name) {
    this.name = name;
    return this;
  }
  ...
  public BettingSerie1 season(Object season) {
    this.season = season;
    return this;
  }
  ...
  public BettingSerie1 slug(String slug) {
    this.slug = slug;
    return this;
  }
  ...
  public BettingSerie1 tier(Object tier) {
    this.tier = tier;
    return this;
  }
  ...
  public BettingSerie1 videogame(CurrentVideogame videogame) {
  ...
  public BettingSerie1 winnerId(OpponentID1 winnerId) {
  ...
  public BettingSerie1 winnerType(Object winnerType) {
  ...
  public BettingSerie1 year(Integer year) {
    this.year = year;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    BettingSerie1 bettingSerie1 = (BettingSerie1) o;
    return Objects.equals(this.beginAt, bettingSerie1.beginAt) &&
        Objects.equals(this.description, bettingSerie1.description) &&
        Objects.equals(this.endAt, bettingSerie1.endAt) &&
        Objects.equals(this.fullName, bettingSerie1.fullName) &&
        Objects.equals(this.id, bettingSerie1.id) &&
        Objects.equals(this.leagueId, bettingSerie1.leagueId) &&
        Objects.equals(this.leagueImageUrl, bettingSerie1.leagueImageUrl) &&
        Objects.equals(this.leagueName, bettingSerie1.leagueName) &&
        Objects.equals(this.modifiedAt, bettingSerie1.modifiedAt) &&
        Objects.equals(this.name, bettingSerie1.name) &&
        Objects.equals(this.season, bettingSerie1.season) &&
        Objects.equals(this.slug, bettingSerie1.slug) &&
        Objects.equals(this.tier, bettingSerie1.tier) &&
        Objects.equals(this.videogame, bettingSerie1.videogame) &&
        Objects.equals(this.winnerId, bettingSerie1.winnerId) &&
        Objects.equals(this.winnerType, bettingSerie1.winnerType) &&
        Objects.equals(this.year, bettingSerie1.year);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to BettingSerie1
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!BettingSerie1.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in BettingSerie1 is not found in the empty JSON string", BettingSerie1.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!BettingSerie1.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `BettingSerie1` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : BettingSerie1.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!BettingSerie1.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'BettingSerie1' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<BettingSerie1> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(BettingSerie1.class));

       return (TypeAdapter<T>) new TypeAdapter<BettingSerie1>() {
           @Override
           public void write(JsonWriter out, BettingSerie1 value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public BettingSerie1 read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of BettingSerie1 given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of BettingSerie1
   * @throws IOException if the JSON string is invalid with respect to BettingSerie1
   */
  public static BettingSerie1 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, BettingSerie1.class);
  }

  /**
   * Convert an instance of BettingSerie1 to an JSON string
   *
   * @return JSON string
   */
