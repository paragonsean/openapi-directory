...
import org.openapitools.client.model.LeagueVideogameFortnite;
...
public class BettingLeagueVideogame extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(BettingLeagueVideogame.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!BettingLeagueVideogame.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'BettingLeagueVideogame' and its subtypes
            }
            ...
            final TypeAdapter<LeagueVideogameFortnite> adapterLeagueVideogameFortnite = gson.getDelegateAdapter(this, TypeToken.get(LeagueVideogameFortnite.class));
            ...
            return (TypeAdapter<T>) new TypeAdapter<BettingLeagueVideogame>() {
                @Override
                public void write(JsonWriter out, BettingLeagueVideogame value) throws IOException {
                    ...
                    // check if the actual instance is of the type `LeagueVideogameFortnite`
                    if (value.getActualInstance() instanceof LeagueVideogameFortnite) {
                        JsonElement element = adapterLeagueVideogameFortnite.toJsonTree((LeagueVideogameFortnite)value.getActualInstance());
                        elementAdapter.write(out, element);
                        return;
                    }
                    ...
                    throw new IOException("Failed to serialize as the type doesn't match oneOf schemas: LeagueVideogameCSGO, LeagueVideogameCodmw, LeagueVideogameDota2, LeagueVideogameFifa, LeagueVideogameFortnite, LeagueVideogameLoL, LeagueVideogameOverwatch, LeagueVideogamePUBG, LeagueVideogameR6siege, LeagueVideogameRocketLeague, LeagueVideogameValorant");
                }

                @Override
                public BettingLeagueVideogame read(JsonReader in) throws IOException {
                    ...
                    // deserialize LeagueVideogameFortnite
                    try {
                        // validate the JSON object to see if any exception is thrown
                        LeagueVideogameFortnite.validateJsonElement(jsonElement);
                        actualAdapter = adapterLeagueVideogameFortnite;
                        match++;
                        log.log(Level.FINER, "Input data matches schema 'LeagueVideogameFortnite'");
                    } catch (Exception e) {
                        // deserialization failed, continue
                        errorMessages.add(String.format("Deserialization for LeagueVideogameFortnite failed with `%s`.", e.getMessage()));
                        log.log(Level.FINER, "Input data does not match schema 'LeagueVideogameFortnite'", e);
                    }
                    ...
                    if (match == 1) {
                        BettingLeagueVideogame ret = new BettingLeagueVideogame();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonElement));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for BettingLeagueVideogame: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public BettingLeagueVideogame() {
        super("oneOf", Boolean.FALSE);
    }

    public BettingLeagueVideogame(Object o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    static {
        ...
        schemas.put("LeagueVideogameFortnite", LeagueVideogameFortnite.class);
    ...
    public Map<String, Class<?>> getSchemas() {
        return BettingLeagueVideogame.schemas;
    }

    /**
     * Set the instance that matches the oneOf child schema, check
     * the instance parameter is valid against the oneOf child schemas:
     * LeagueVideogameCSGO, LeagueVideogameCodmw, LeagueVideogameDota2, LeagueVideogameFifa, LeagueVideogameFortnite, LeagueVideogameLoL, LeagueVideogameOverwatch, LeagueVideogamePUBG, LeagueVideogameR6siege, LeagueVideogameRocketLeague, LeagueVideogameValorant
     *
    ...
    public void setActualInstance(Object instance) {
        ...
        if (instance instanceof LeagueVideogameFortnite) {
            super.setActualInstance(instance);
            return;
        }
        ...
        throw new RuntimeException("Invalid instance type. Must be LeagueVideogameCSGO, LeagueVideogameCodmw, LeagueVideogameDota2, LeagueVideogameFifa, LeagueVideogameFortnite, LeagueVideogameLoL, LeagueVideogameOverwatch, LeagueVideogamePUBG, LeagueVideogameR6siege, LeagueVideogameRocketLeague, LeagueVideogameValorant");
    }
     ...
     * LeagueVideogameCSGO, LeagueVideogameCodmw, LeagueVideogameDota2, LeagueVideogameFifa, LeagueVideogameFortnite, LeagueVideogameLoL, LeagueVideogameOverwatch, LeagueVideogamePUBG, LeagueVideogameR6siege, LeagueVideogameRocketLeague, LeagueVideogameValorant
     *
     * @return The actual instance (LeagueVideogameCSGO, LeagueVideogameCodmw, LeagueVideogameDota2, LeagueVideogameFifa, LeagueVideogameFortnite, LeagueVideogameLoL, LeagueVideogameOverwatch, LeagueVideogamePUBG, LeagueVideogameR6siege, LeagueVideogameRocketLeague, LeagueVideogameValorant)
     */
    @SuppressWarnings("unchecked")
    @Override
    ...
    /**
     * Get the actual instance of `LeagueVideogameFortnite`. If the actual instance is not `LeagueVideogameFortnite`,
     * the ClassCastException will be thrown.
     *
     * @return The actual instance of `LeagueVideogameFortnite`
     * @throws ClassCastException if the instance is not `LeagueVideogameFortnite`
     */
    public LeagueVideogameFortnite getLeagueVideogameFortnite() throws ClassCastException {
        return (LeagueVideogameFortnite)super.getActualInstance();
    }
    /**
     ...
     * @throws IOException if the JSON Element is invalid with respect to BettingLeagueVideogame
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        // validate the json string with LeagueVideogameFortnite
        try {
            LeagueVideogameFortnite.validateJsonElement(jsonElement);
            validCount++;
        } catch (Exception e) {
        ...
        if (validCount != 1) {
            throw new IOException(String.format("The JSON string is invalid for BettingLeagueVideogame with oneOf schemas: LeagueVideogameCSGO, LeagueVideogameCodmw, LeagueVideogameDota2, LeagueVideogameFifa, LeagueVideogameFortnite, LeagueVideogameLoL, LeagueVideogameOverwatch, LeagueVideogamePUBG, LeagueVideogameR6siege, LeagueVideogameRocketLeague, LeagueVideogameValorant. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonElement.toString()));
        }
    }

    /**
     * Create an instance of BettingLeagueVideogame given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of BettingLeagueVideogame
     * @throws IOException if the JSON string is invalid with respect to BettingLeagueVideogame
     */
    public static BettingLeagueVideogame fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, BettingLeagueVideogame.class);
    }

    /**
     * Convert an instance of BettingLeagueVideogame to an JSON string
     *
     * @return JSON string
     */
