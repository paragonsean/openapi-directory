...
public class BettingTournament {
  ...
  public BettingTournament() {
  }

  public BettingTournament beginAt(Object beginAt) {
  ...
  public BettingTournament endAt(Object endAt) {
    this.endAt = endAt;
    return this;
  }
  ...
  public BettingTournament id(Integer id) {
    this.id = id;
    return this;
  }
  ...
  public BettingTournament liveSupported(Boolean liveSupported) {
  ...
  public BettingTournament modifiedAt(OffsetDateTime modifiedAt) {
  ...
  public BettingTournament name(String name) {
    this.name = name;
    return this;
  }
  ...
  public BettingTournament prizepool(Object prizepool) {
  ...
  public BettingTournament serieId(Integer serieId) {
  ...
  public BettingTournament slug(String slug) {
    this.slug = slug;
    return this;
  }
  ...
  public BettingTournament videogame(CurrentVideogame videogame) {
  ...
  public BettingTournament winnerId(OpponentID1 winnerId) {
  ...
  public BettingTournament winnerType(Object winnerType) {
  ...
  public boolean equals(Object o) {
    ...
    BettingTournament bettingTournament = (BettingTournament) o;
    return Objects.equals(this.beginAt, bettingTournament.beginAt) &&
        Objects.equals(this.endAt, bettingTournament.endAt) &&
        Objects.equals(this.id, bettingTournament.id) &&
        Objects.equals(this.liveSupported, bettingTournament.liveSupported) &&
        Objects.equals(this.modifiedAt, bettingTournament.modifiedAt) &&
        Objects.equals(this.name, bettingTournament.name) &&
        Objects.equals(this.prizepool, bettingTournament.prizepool) &&
        Objects.equals(this.serieId, bettingTournament.serieId) &&
        Objects.equals(this.slug, bettingTournament.slug) &&
        Objects.equals(this.videogame, bettingTournament.videogame) &&
        Objects.equals(this.winnerId, bettingTournament.winnerId) &&
        Objects.equals(this.winnerType, bettingTournament.winnerType);
  }

  @Override
  public int hashCode() {
    return Objects.hash(beginAt, endAt, id, liveSupported, modifiedAt, name, prizepool, serieId, slug, videogame, winnerId, winnerType);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class BettingTournament {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to BettingTournament
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!BettingTournament.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in BettingTournament is not found in the empty JSON string", BettingTournament.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!BettingTournament.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `BettingTournament` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : BettingTournament.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!BettingTournament.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'BettingTournament' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<BettingTournament> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(BettingTournament.class));

       return (TypeAdapter<T>) new TypeAdapter<BettingTournament>() {
           @Override
           public void write(JsonWriter out, BettingTournament value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public BettingTournament read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of BettingTournament given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of BettingTournament
   * @throws IOException if the JSON string is invalid with respect to BettingTournament
   */
  public static BettingTournament fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, BettingTournament.class);
  }

  /**
   * Convert an instance of BettingTournament to an JSON string
   *
   * @return JSON string
   */
