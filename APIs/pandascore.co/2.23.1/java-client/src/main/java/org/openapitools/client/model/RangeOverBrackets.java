...
public class RangeOverBrackets {
  ...
  private List<Boolean> detailedStats = new ArrayList<>();
  ...
  private List<Boolean> forfeit = new ArrayList<>();
  ...
  public RangeOverBrackets() {
  }

  public RangeOverBrackets beginAt(List<OffsetDateTime> beginAt) {
    this.beginAt = beginAt;
    return this;
  }

  public RangeOverBrackets addBeginAtItem(OffsetDateTime beginAtItem) {
  ...
  public RangeOverBrackets detailedStats(List<Boolean> detailedStats) {
    this.detailedStats = detailedStats;
    return this;
  }

  public RangeOverBrackets addDetailedStatsItem(Boolean detailedStatsItem) {
    if (this.detailedStats == null) {
      this.detailedStats = new ArrayList<>();
    }
    this.detailedStats.add(detailedStatsItem);
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public List<Boolean> getDetailedStats() {
    return detailedStats;
  }

  public void setDetailedStats(List<Boolean> detailedStats) {
    this.detailedStats = detailedStats;
  }


  public RangeOverBrackets draw(List<Boolean> draw) {
    this.draw = draw;
    return this;
  }

  public RangeOverBrackets addDrawItem(Boolean drawItem) {
    if (this.draw == null) {
      this.draw = new ArrayList<>();
    }
    this.draw.add(drawItem);
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public List<Boolean> getDraw() {
    return draw;
  }

  public void setDraw(List<Boolean> draw) {
    this.draw = draw;
  }


  public RangeOverBrackets endAt(List<OffsetDateTime> endAt) {
    this.endAt = endAt;
    return this;
  }

  public RangeOverBrackets addEndAtItem(OffsetDateTime endAtItem) {
    if (this.endAt == null) {
  ...
  public RangeOverBrackets forfeit(List<Boolean> forfeit) {
    this.forfeit = forfeit;
    return this;
  }

  public RangeOverBrackets addForfeitItem(Boolean forfeitItem) {
    if (this.forfeit == null) {
      this.forfeit = new ArrayList<>();
    }
    this.forfeit.add(forfeitItem);
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public List<Boolean> getForfeit() {
    return forfeit;
  }

  public void setForfeit(List<Boolean> forfeit) {
    this.forfeit = forfeit;
  }


  public RangeOverBrackets gameAdvantage(List<OpponentID> gameAdvantage) {
    this.gameAdvantage = gameAdvantage;
    return this;
  }

  public RangeOverBrackets addGameAdvantageItem(OpponentID gameAdvantageItem) {
  ...
  public RangeOverBrackets id(List<Integer> id) {
    this.id = id;
    return this;
  }

  public RangeOverBrackets addIdItem(Integer idItem) {
    if (this.id == null) {
  ...
  public RangeOverBrackets liveEmbedUrl(List<URI> liveEmbedUrl) {
    this.liveEmbedUrl = liveEmbedUrl;
    return this;
  }

  public RangeOverBrackets addLiveEmbedUrlItem(URI liveEmbedUrlItem) {
  ...
  public RangeOverBrackets matchType(List<MatchType> matchType) {
    this.matchType = matchType;
    return this;
  }

  public RangeOverBrackets addMatchTypeItem(MatchType matchTypeItem) {
  ...
  public RangeOverBrackets modifiedAt(List<OffsetDateTime> modifiedAt) {
    this.modifiedAt = modifiedAt;
    return this;
  }

  public RangeOverBrackets addModifiedAtItem(OffsetDateTime modifiedAtItem) {
  ...
  public RangeOverBrackets name(List<String> name) {
    this.name = name;
    return this;
  }

  public RangeOverBrackets addNameItem(String nameItem) {
    if (this.name == null) {
  ...
  public RangeOverBrackets numberOfGames(List<Integer> numberOfGames) {
    this.numberOfGames = numberOfGames;
    return this;
  }

  public RangeOverBrackets addNumberOfGamesItem(Integer numberOfGamesItem) {
  ...
  public RangeOverBrackets officialStreamUrl(List<URI> officialStreamUrl) {
    this.officialStreamUrl = officialStreamUrl;
    return this;
  }

  public RangeOverBrackets addOfficialStreamUrlItem(URI officialStreamUrlItem) {
  ...
  public RangeOverBrackets originalScheduledAt(List<OffsetDateTime> originalScheduledAt) {
    this.originalScheduledAt = originalScheduledAt;
    return this;
  }

  public RangeOverBrackets addOriginalScheduledAtItem(OffsetDateTime originalScheduledAtItem) {
  ...
  public RangeOverBrackets scheduledAt(List<OffsetDateTime> scheduledAt) {
    this.scheduledAt = scheduledAt;
    return this;
  }

  public RangeOverBrackets addScheduledAtItem(OffsetDateTime scheduledAtItem) {
  ...
  public RangeOverBrackets slug(List<String> slug) {
    this.slug = slug;
    return this;
  }

  public RangeOverBrackets addSlugItem(String slugItem) {
    if (this.slug == null) {
  ...
  public RangeOverBrackets status(List<MatchStatus> status) {
    this.status = status;
    return this;
  }

  public RangeOverBrackets addStatusItem(MatchStatus statusItem) {
    if (this.status == null) {
  ...
  public RangeOverBrackets tournamentId(List<Integer> tournamentId) {
    this.tournamentId = tournamentId;
    return this;
  }

  public RangeOverBrackets addTournamentIdItem(Integer tournamentIdItem) {
  ...
  public RangeOverBrackets winnerId(List<OpponentID> winnerId) {
    this.winnerId = winnerId;
    return this;
  }

  public RangeOverBrackets addWinnerIdItem(OpponentID winnerIdItem) {
  ...
  public boolean equals(Object o) {
    ...
    RangeOverBrackets rangeOverBrackets = (RangeOverBrackets) o;
    return Objects.equals(this.beginAt, rangeOverBrackets.beginAt) &&
        Objects.equals(this.detailedStats, rangeOverBrackets.detailedStats) &&
        Objects.equals(this.draw, rangeOverBrackets.draw) &&
        Objects.equals(this.endAt, rangeOverBrackets.endAt) &&
        Objects.equals(this.forfeit, rangeOverBrackets.forfeit) &&
        Objects.equals(this.gameAdvantage, rangeOverBrackets.gameAdvantage) &&
        Objects.equals(this.id, rangeOverBrackets.id) &&
        Objects.equals(this.liveEmbedUrl, rangeOverBrackets.liveEmbedUrl) &&
        Objects.equals(this.matchType, rangeOverBrackets.matchType) &&
        Objects.equals(this.modifiedAt, rangeOverBrackets.modifiedAt) &&
        Objects.equals(this.name, rangeOverBrackets.name) &&
        Objects.equals(this.numberOfGames, rangeOverBrackets.numberOfGames) &&
        Objects.equals(this.officialStreamUrl, rangeOverBrackets.officialStreamUrl) &&
        Objects.equals(this.originalScheduledAt, rangeOverBrackets.originalScheduledAt) &&
        Objects.equals(this.scheduledAt, rangeOverBrackets.scheduledAt) &&
        Objects.equals(this.slug, rangeOverBrackets.slug) &&
        Objects.equals(this.status, rangeOverBrackets.status) &&
        Objects.equals(this.tournamentId, rangeOverBrackets.tournamentId) &&
        Objects.equals(this.winnerId, rangeOverBrackets.winnerId);
  }
  ...
  public String toString() {
    ...
    sb.append("class RangeOverBrackets {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to RangeOverBrackets
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RangeOverBrackets.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in RangeOverBrackets is not found in the empty JSON string", RangeOverBrackets.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RangeOverBrackets.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `RangeOverBrackets` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      // ensure the optional json data is an array if present
      if (jsonObj.get("detailed_stats") != null && !jsonObj.get("detailed_stats").isJsonNull() && !jsonObj.get("detailed_stats").isJsonArray()) {
        throw new IllegalArgumentException(String.format("Expected the field `detailed_stats` to be an array in the JSON string but got `%s`", jsonObj.get("detailed_stats").toString()));
      }
      // ensure the optional json data is an array if present
      if (jsonObj.get("draw") != null && !jsonObj.get("draw").isJsonNull() && !jsonObj.get("draw").isJsonArray()) {
        throw new IllegalArgumentException(String.format("Expected the field `draw` to be an array in the JSON string but got `%s`", jsonObj.get("draw").toString()));
      }
      // ensure the optional json data is an array if present
      ...
      // ensure the optional json data is an array if present
      if (jsonObj.get("forfeit") != null && !jsonObj.get("forfeit").isJsonNull() && !jsonObj.get("forfeit").isJsonArray()) {
        throw new IllegalArgumentException(String.format("Expected the field `forfeit` to be an array in the JSON string but got `%s`", jsonObj.get("forfeit").toString()));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RangeOverBrackets.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RangeOverBrackets' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RangeOverBrackets> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RangeOverBrackets.class));

       return (TypeAdapter<T>) new TypeAdapter<RangeOverBrackets>() {
           @Override
           public void write(JsonWriter out, RangeOverBrackets value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public RangeOverBrackets read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of RangeOverBrackets given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of RangeOverBrackets
   * @throws IOException if the JSON string is invalid with respect to RangeOverBrackets
   */
  public static RangeOverBrackets fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RangeOverBrackets.class);
  }

  /**
   * Convert an instance of RangeOverBrackets to an JSON string
   *
   * @return JSON string
   */
