...
public class ShortTournament {
  ...
  public ShortTournament beginAt(Object beginAt) {
  ...
  public ShortTournament endAt(Object endAt) {
    this.endAt = endAt;
    return this;
  }
  ...
  public ShortTournament id(Integer id) {
    this.id = id;
    return this;
  }
  ...
  public ShortTournament league(BaseLeague league) {
    this.league = league;
    return this;
  }
  ...
  public ShortTournament leagueId(Integer leagueId) {
  ...
  public ShortTournament liveSupported(Boolean liveSupported) {
  ...
  public ShortTournament matches(List<BaseMatch> matches) {
    this.matches = matches;
    return this;
  }

  public ShortTournament addMatchesItem(BaseMatch matchesItem) {
  ...
  public ShortTournament modifiedAt(OffsetDateTime modifiedAt) {
  ...
  public ShortTournament name(String name) {
    this.name = name;
    return this;
  }
  ...
  public ShortTournament prizepool(Object prizepool) {
  ...
  public ShortTournament serie(BaseSerie serie) {
    this.serie = serie;
    return this;
  }
  ...
  public ShortTournament serieId(Integer serieId) {
  ...
  public ShortTournament slug(String slug) {
    this.slug = slug;
    return this;
  }
  ...
  public ShortTournament teams(List<BaseTeam> teams) {
    this.teams = teams;
    return this;
  }

  public ShortTournament addTeamsItem(BaseTeam teamsItem) {
    if (this.teams == null) {
  ...
  public ShortTournament videogame(CurrentVideogame videogame) {
  ...
  public ShortTournament winnerId(OpponentID1 winnerId) {
  ...
  public ShortTournament winnerType(Object winnerType) {
  ...
  public boolean equals(Object o) {
    ...
    ShortTournament shortTournament = (ShortTournament) o;
    return Objects.equals(this.beginAt, shortTournament.beginAt) &&
        Objects.equals(this.endAt, shortTournament.endAt) &&
        Objects.equals(this.id, shortTournament.id) &&
        Objects.equals(this.league, shortTournament.league) &&
        Objects.equals(this.leagueId, shortTournament.leagueId) &&
        Objects.equals(this.liveSupported, shortTournament.liveSupported) &&
        Objects.equals(this.matches, shortTournament.matches) &&
        Objects.equals(this.modifiedAt, shortTournament.modifiedAt) &&
        Objects.equals(this.name, shortTournament.name) &&
        Objects.equals(this.prizepool, shortTournament.prizepool) &&
        Objects.equals(this.serie, shortTournament.serie) &&
        Objects.equals(this.serieId, shortTournament.serieId) &&
        Objects.equals(this.slug, shortTournament.slug) &&
        Objects.equals(this.teams, shortTournament.teams) &&
        Objects.equals(this.videogame, shortTournament.videogame) &&
        Objects.equals(this.winnerId, shortTournament.winnerId) &&
        Objects.equals(this.winnerType, shortTournament.winnerType);
  }

  @Override
  public int hashCode() {
    return Objects.hash(beginAt, endAt, id, league, leagueId, liveSupported, matches, modifiedAt, name, prizepool, serie, serieId, slug, teams, videogame, winnerId, winnerType);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ShortTournament {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ShortTournament
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ShortTournament.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ShortTournament is not found in the empty JSON string", ShortTournament.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ShortTournament.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ShortTournament` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ShortTournament.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ShortTournament.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ShortTournament' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ShortTournament> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ShortTournament.class));

       return (TypeAdapter<T>) new TypeAdapter<ShortTournament>() {
           @Override
           public void write(JsonWriter out, ShortTournament value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ShortTournament read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ShortTournament given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ShortTournament
   * @throws IOException if the JSON string is invalid with respect to ShortTournament
   */
  public static ShortTournament fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ShortTournament.class);
  }

  /**
   * Convert an instance of ShortTournament to an JSON string
   *
   * @return JSON string
   */
