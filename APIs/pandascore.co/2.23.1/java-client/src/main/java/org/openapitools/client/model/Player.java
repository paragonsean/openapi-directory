...
import org.openapitools.client.model.BaseTeam1;
...
public class Player {
  ...
  public static final String SERIALIZED_NAME_CURRENT_TEAM = "current_team";
  @SerializedName(SERIALIZED_NAME_CURRENT_TEAM)
  private BaseTeam1 currentTeam;
  ...
  private Object currentVideogame;
  ...
  public Player birthYear(Object birthYear) {
  ...
  public Player birthday(Object birthday) {
  ...
  public Player currentTeam(BaseTeam1 currentTeam) {
  ...
  public BaseTeam1 getCurrentTeam() {
    return currentTeam;
  }

  public void setCurrentTeam(BaseTeam1 currentTeam) {
    this.currentTeam = currentTeam;
  }


  public Player currentVideogame(Object currentVideogame) {
   ...
   */
  @javax.annotation.Nonnull
  public Object getCurrentVideogame() {
    return currentVideogame;
  }

  public void setCurrentVideogame(Object currentVideogame) {
    this.currentVideogame = currentVideogame;
  }


  public Player firstName(Object firstName) {
  ...
  public Player hometown(Object hometown) {
  ...
  public Player imageUrl(Object imageUrl) {
  ...
  public Player lastName(Object lastName) {
  ...
  public Player nationality(Object nationality) {
  ...
  public Player role(Object role) {
    this.role = role;
    return this;
  }
  ...
  public Player slug(Object slug) {
    this.slug = slug;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.birthYear, player.birthYear) &&
        Objects.equals(this.birthday, player.birthday) &&
        Objects.equals(this.currentTeam, player.currentTeam) &&
        Objects.equals(this.currentVideogame, player.currentVideogame) &&
        Objects.equals(this.firstName, player.firstName) &&
        Objects.equals(this.hometown, player.hometown) &&
        Objects.equals(this.id, player.id) &&
        Objects.equals(this.imageUrl, player.imageUrl) &&
        ...
        Objects.equals(this.slug, player.slug);
  }

  @Override
  public int hashCode() {
    return Objects.hash(birthYear, birthday, currentTeam, currentVideogame, firstName, hometown, id, imageUrl, lastName, name, nationality, role, slug);
  }
  ...
  static {
    ...
    openapiFields.add("current_team");
    ...
    openapiRequiredFields.add("current_team");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      // validate the required field `current_team`
      BaseTeam1.validateJsonElement(jsonObj.get("current_team"));
      // validate the required field `current_videogame`
      Object.validateJsonElement(jsonObj.get("current_videogame"));
