...
/**
 * API tests for LivesApi
 */
@Disabled
public class LivesApiTest {

    private final LivesApi api = new LivesApi();
     ...
     */
    @Test
    public void getLives_0Test() throws ApiException {
        GetAdditionsPageParameter page = null;
        Integer perPage = null;
        List<Live> response = api.getLives_0(page, perPage);
