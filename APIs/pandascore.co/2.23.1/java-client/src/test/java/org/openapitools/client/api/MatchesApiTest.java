...
public class MatchesApiTest {
     ...
     */
    @Test
    public void getLivesTest() throws ApiException {
        GetAdditionsPageParameter page = null;
        Integer perPage = null;
        List<Live> response = api.getLives(page, perPage);
    ...
    public void getMatchesTest() throws ApiException {
        ...
        GetAdditionsPageParameter page = null;
        Integer perPage = null;
        List<Match> response = api.getMatches(filter, search, sort, range, page, perPage);
        // TODO: test validations
    }
     ...
     */
    @Test
    public void getMatchesMatchIdOrSlugTest() throws ApiException {
        MatchIDOrSlug matchIdOrSlug = null;
        Match response = api.getMatchesMatchIdOrSlug(matchIdOrSlug);
        // TODO: test validations
    }
     ...
     */
    @Test
    public void getMatchesMatchIdOrSlugOpponentsTest() throws ApiException {
        MatchIDOrSlug matchIdOrSlug = null;
        MatchOpponentsObject response = api.getMatchesMatchIdOrSlugOpponents(matchIdOrSlug);
        // TODO: test validations
    }
     ...
     */
    @Test
    public void getMatchesPastTest() throws ApiException {
        FilterOverMatches filter = null;
        SearchOverMatches search = null;
        List<String> sort = null;
        RangeOverMatches range = null;
        GetAdditionsPageParameter page = null;
        Integer perPage = null;
        List<Match> response = api.getMatchesPast(filter, search, sort, range, page, perPage);
        // TODO: test validations
    }
     ...
     */
    @Test
    public void getMatchesRunningTest() throws ApiException {
        FilterOverMatches filter = null;
        SearchOverMatches search = null;
        List<String> sort = null;
        RangeOverMatches range = null;
        GetAdditionsPageParameter page = null;
        Integer perPage = null;
        List<Match> response = api.getMatchesRunning(filter, search, sort, range, page, perPage);
        // TODO: test validations
    }
     ...
     */
    @Test
    public void getMatchesUpcomingTest() throws ApiException {
        FilterOverMatches filter = null;
        SearchOverMatches search = null;
        List<String> sort = null;
        RangeOverMatches range = null;
        GetAdditionsPageParameter page = null;
        Integer perPage = null;
        List<Match> response = api.getMatchesUpcoming(filter, search, sort, range, page, perPage);
        // TODO: test validations
    }
