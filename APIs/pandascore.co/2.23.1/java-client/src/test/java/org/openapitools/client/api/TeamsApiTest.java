...
public class TeamsApiTest {
    ...
    public void getTeamsTest() throws ApiException {
        ...
        List<Team> response = api.getTeams(filter, search, sort, range, page, perPage);
     ...
     */
    @Test
    public void getTeamsTeamIdOrSlugTest() throws ApiException {
        TeamIDOrSlug teamIdOrSlug = null;
        Team response = api.getTeamsTeamIdOrSlug(teamIdOrSlug);
        // TODO: test validations
    }
     ...
     */
    @Test
    public void getTeamsTeamIdOrSlugLeaguesTest() throws ApiException {
        TeamIDOrSlug teamIdOrSlug = null;
        SearchOverLeagues search = null;
        List<String> sort = null;
        RangeOverLeagues range = null;
        FilterOverLeagues filter = null;
        GetAdditionsPageParameter page = null;
        Integer perPage = null;
        List<League> response = api.getTeamsTeamIdOrSlugLeagues(teamIdOrSlug, search, sort, range, filter, page, perPage);
        // TODO: test validations
    }
     ...
     */
    @Test
    public void getTeamsTeamIdOrSlugMatchesTest() throws ApiException {
        TeamIDOrSlug teamIdOrSlug = null;
        ...
        GetAdditionsPageParameter page = null;
        Integer perPage = null;
        List<Match> response = api.getTeamsTeamIdOrSlugMatches(teamIdOrSlug, filter, search, sort, range, page, perPage);
        // TODO: test validations
    }
     ...
     */
    @Test
    public void getTeamsTeamIdOrSlugSeriesTest() throws ApiException {
        TeamIDOrSlug teamIdOrSlug = null;
        ...
        GetAdditionsPageParameter page = null;
        Integer perPage = null;
        List<Serie> response = api.getTeamsTeamIdOrSlugSeries(teamIdOrSlug, filter, search, sort, range, page, perPage);
        // TODO: test validations
    }
     ...
     */
    @Test
    public void getTeamsTeamIdOrSlugTournamentsTest() throws ApiException {
        TeamIDOrSlug teamIdOrSlug = null;
        ...
        GetAdditionsPageParameter page = null;
        Integer perPage = null;
        List<ShortTournament> response = api.getTeamsTeamIdOrSlugTournaments(teamIdOrSlug, filter, search, sort, range, page, perPage);
        // TODO: test validations
    }
