...
/**
 * API tests for VideogamesApi
 */
@Disabled
public class VideogamesApiTest {

    private final VideogamesApi api = new VideogamesApi();
     ...
     */
    @Test
    public void getVideogamesTest() throws ApiException {
        GetAdditionsPageParameter page = null;
        Integer perPage = null;
        List<Videogame> response = api.getVideogames(page, perPage);
     ...
     */
    @Test
    public void getVideogamesVideogameIdOrSlugTest() throws ApiException {
        VideogameIDOrSlug videogameIdOrSlug = null;
        Videogame response = api.getVideogamesVideogameIdOrSlug(videogameIdOrSlug);
        // TODO: test validations
    }
     ...
     */
    @Test
    public void getVideogamesVideogameIdOrSlugLeaguesTest() throws ApiException {
        VideogameIDOrSlug videogameIdOrSlug = null;
        ...
        GetAdditionsPageParameter page = null;
        Integer perPage = null;
        List<League> response = api.getVideogamesVideogameIdOrSlugLeagues(videogameIdOrSlug, search, sort, range, filter, page, perPage);
        // TODO: test validations
    }
     ...
     */
    @Test
    public void getVideogamesVideogameIdOrSlugSeriesTest() throws ApiException {
        VideogameIDOrSlug videogameIdOrSlug = null;
        ...
        GetAdditionsPageParameter page = null;
        Integer perPage = null;
        List<Serie> response = api.getVideogamesVideogameIdOrSlugSeries(videogameIdOrSlug, filter, search, sort, range, page, perPage);
        // TODO: test validations
    }
     ...
     */
    @Test
    public void getVideogamesVideogameIdOrSlugTournamentsTest() throws ApiException {
        VideogameIDOrSlug videogameIdOrSlug = null;
        ...
        GetAdditionsPageParameter page = null;
        Integer perPage = null;
        List<ShortTournament> response = api.getVideogamesVideogameIdOrSlugTournaments(videogameIdOrSlug, filter, range, sort, search, page, perPage);
        // TODO: test validations
    }
     ...
     */
    @Test
    public void getVideogamesVideogameIdOrSlugVersionsTest() throws ApiException {
        VideogameIDOrSlug videogameIdOrSlug = null;
        FilterOverShortVideogameVersions filter = null;
        RangeOverShortVideogameVersions range = null;
        List<String> sort = null;
        SearchOverShortVideogameVersions search = null;
        GetAdditionsPageParameter page = null;
        Integer perPage = null;
        List<ShortVideogameVersion> response = api.getVideogamesVideogameIdOrSlugVersions(videogameIdOrSlug, filter, range, sort, search, page, perPage);
        // TODO: test validations
    }
