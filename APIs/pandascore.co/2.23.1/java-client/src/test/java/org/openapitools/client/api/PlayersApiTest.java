...
public class PlayersApiTest {
    ...
    public void getPlayersTest() throws ApiException {
        ...
        List<Player> response = api.getPlayers(filter, search, sort, range, page, perPage);
     ...
     */
    @Test
    public void getPlayersPlayerIdOrSlugTest() throws ApiException {
        PlayerIDOrSlug playerIdOrSlug = null;
        Player response = api.getPlayersPlayerIdOrSlug(playerIdOrSlug);
        // TODO: test validations
    }
     ...
     */
    @Test
    public void getPlayersPlayerIdOrSlugMatchesTest() throws ApiException {
        PlayerIDOrSlug playerIdOrSlug = null;
        ...
        GetAdditionsPageParameter page = null;
        Integer perPage = null;
        List<Match> response = api.getPlayersPlayerIdOrSlugMatches(playerIdOrSlug, filter, search, sort, range, page, perPage);
        // TODO: test validations
    }
