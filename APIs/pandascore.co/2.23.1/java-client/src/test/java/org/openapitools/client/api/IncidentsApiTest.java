...
public class IncidentsApiTest {
     ...
     */
    @Test
    public void getAdditionsTest() throws ApiException {
        GetAdditionsPageParameter page = null;
        Integer perPage = null;
        List<String> type = null;
        OffsetDateTime since = null;
        List<VideogameIDOrSlug> videogame = null;
        List<NonDeletionIncident> response = api.getAdditions(page, perPage, type, since, videogame);
    ...
    public void getChangesTest() throws ApiException {
        ...
        OffsetDateTime since = null;
        List<VideogameIDOrSlug> videogame = null;
        List<Incident> response = api.getChanges(page, perPage, type, since, videogame);
        // TODO: test validations
    }
    ...
    public void getDeletionsTest() throws ApiException {
        ...
        OffsetDateTime since = null;
        List<VideogameIDOrSlug> videogame = null;
        List<DeletionIncident> response = api.getDeletions(page, perPage, type, since, videogame);
        // TODO: test validations
    }
    ...
    public void getIncidentsTest() throws ApiException {
        ...
        OffsetDateTime since = null;
        List<VideogameIDOrSlug> videogame = null;
        List<Incident> response = api.getIncidents(page, perPage, type, since, videogame);
        // TODO: test validations
    }
