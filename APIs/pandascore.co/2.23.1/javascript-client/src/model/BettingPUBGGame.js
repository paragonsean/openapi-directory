...
/**
 * The BettingPUBGGame model module.
 * @module model/BettingPUBGGame
 * @version 2.23.1
 */
class BettingPUBGGame {
    /**
     * Constructs a new <code>BettingPUBGGame</code>.
     * @alias module:model/BettingPUBGGame
    ...
    constructor(beginAt, complete, detailedStats, endAt, finished, forfeit, id, length, matchId, position, status, videoUrl, winner, winnerType) { 
        ...
        BettingPUBGGame.initialize(this, beginAt, complete, detailedStats, endAt, finished, forfeit, id, length, matchId, position, status, videoUrl, winner, winnerType);
    }
    ...
    /**
     * Constructs a <code>BettingPUBGGame</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/BettingPUBGGame} obj Optional instance to populate.
     * @return {module:model/BettingPUBGGame} The populated <code>BettingPUBGGame</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new BettingPUBGGame();
    ...
    /**
     * Validates the JSON data with respect to <code>BettingPUBGGame</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>BettingPUBGGame</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of BettingPUBGGame.RequiredProperties) {
...
BettingPUBGGame.RequiredProperties = ["begin_at", "complete", "detailed_stats", "end_at", "finished", "forfeit", "id", "length", "match_id", "position", "status", "video_url", "winner", "winner_type"];

/**
 * @member {Object} begin_at
 */
BettingPUBGGame.prototype['begin_at'] = undefined;

/**
 * Whether game data are complete and won't change
 * @member {Boolean} complete
 */
BettingPUBGGame.prototype['complete'] = undefined;

/**
 * Whether the game offers full stats
 * @member {Boolean} detailed_stats
 */
BettingPUBGGame.prototype['detailed_stats'] = undefined;

/**
 * @member {Object} end_at
 */
BettingPUBGGame.prototype['end_at'] = undefined;

/**
 * Whether game is finished
 * @member {Boolean} finished
 */
BettingPUBGGame.prototype['finished'] = undefined;

/**
 * Whether game is forfeit
 * @member {Boolean} forfeit
 */
BettingPUBGGame.prototype['forfeit'] = undefined;

/**
 * @member {Number} id
 */
BettingPUBGGame.prototype['id'] = undefined;

/**
 * @member {Object} length
 */
BettingPUBGGame.prototype['length'] = undefined;

/**
 * @member {Number} match_id
 */
BettingPUBGGame.prototype['match_id'] = undefined;

/**
 * @member {Number} position
 */
BettingPUBGGame.prototype['position'] = undefined;

/**
 * @member {module:model/GameStatus} status
 */
BettingPUBGGame.prototype['status'] = undefined;

/**
 * @member {Object} video_url
 */
BettingPUBGGame.prototype['video_url'] = undefined;

/**
 * @member {module:model/GameWinner} winner
 */
BettingPUBGGame.prototype['winner'] = undefined;

/**
 * @member {Object} winner_type
 */
BettingPUBGGame.prototype['winner_type'] = undefined;
...
export default BettingPUBGGame;
