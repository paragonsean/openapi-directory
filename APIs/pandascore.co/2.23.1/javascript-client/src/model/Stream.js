...
class Stream {
     ...
     * @param embedUrl {Object} 
     * @param language {module:model/StreamLanguage} 
     * @param main {Boolean} Whether it is the main stream. Main stream is always official.
     * @param official {Boolean} Whether it is an official broadcast.
     * @param rawUrl {String} URL to the stream on host website.
     */
    constructor(embedUrl, language, main, official, rawUrl) { 
        
        Stream.initialize(this, embedUrl, language, main, official, rawUrl);
    }
     ...
     */
    static initialize(obj, embedUrl, language, main, official, rawUrl) { 
        obj['embed_url'] = embedUrl;
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('embed_url')) {
                obj['embed_url'] = ApiClient.convertToType(data['embed_url'], Object);
            }
            if (data.hasOwnProperty('language')) {
                obj['language'] = StreamLanguage.constructFromObject(data['language']);
            }
    ...
    static validateJSON(data) {
        ...
        // validate the optional field `embed_url`
        if (data['embed_url']) { // data not null
          Object.validateJSON(data['embed_url']);
        }
...
Stream.RequiredProperties = ["embed_url", "language", "main", "official", "raw_url"];

/**
 * @member {Object} embed_url
 */
Stream.prototype['embed_url'] = undefined;

/**
 * @member {module:model/StreamLanguage} language
 */
Stream.prototype['language'] = undefined;

/**
 * Whether it is the main stream. Main stream is always official.
 * @member {Boolean} main
 */
Stream.prototype['main'] = undefined;

/**
 * Whether it is an official broadcast.
 * @member {Boolean} official
 */
Stream.prototype['official'] = undefined;

/**
 * URL to the stream on host website.
 * @member {String} raw_url
 */
Stream.prototype['raw_url'] = undefined;
