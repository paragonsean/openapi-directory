...
class Opponent {
     ...
     * @param opponent {module:model/BaseOpponent} 
     * @param type {module:model/OpponentType} 
     */
    constructor(opponent, type) { 
        
        Opponent.initialize(this, opponent, type);
    }
     ...
     */
    static initialize(obj, opponent, type) { 
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('opponent')) {
                obj['opponent'] = BaseOpponent.constructFromObject(data['opponent']);
            }
            if (data.hasOwnProperty('type')) {
                obj['type'] = OpponentType.constructFromObject(data['type']);
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        for (const property of Opponent.RequiredProperties) {
        ...
        if (data['opponent']) { // data not null
          BaseOpponent.validateJSON(data['opponent']);
        }
...
Opponent.RequiredProperties = ["opponent", "type"];

/**
 * @member {module:model/BaseOpponent} opponent
 */
Opponent.prototype['opponent'] = undefined;

/**
 * @member {module:model/OpponentType} type
 */
Opponent.prototype['type'] = undefined;
