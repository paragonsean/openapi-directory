...
/**
 * The RangeOverBrackets model module.
 * @module model/RangeOverBrackets
 * @version 2.23.1
 */
class RangeOverBrackets {
    /**
     * Constructs a new <code>RangeOverBrackets</code>.
     * @alias module:model/RangeOverBrackets
     */
    constructor() { 
        
        RangeOverBrackets.initialize(this);
    }
    ...
    /**
     * Constructs a <code>RangeOverBrackets</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/RangeOverBrackets} obj Optional instance to populate.
     * @return {module:model/RangeOverBrackets} The populated <code>RangeOverBrackets</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RangeOverBrackets();
    ...
    /**
     * Validates the JSON data with respect to <code>RangeOverBrackets</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RangeOverBrackets</code>.
     */
    static validateJSON(data) {
        ...
        // ensure the json data is an array
        if (!Array.isArray(data['detailed_stats'])) {
            throw new Error("Expected the field `detailed_stats` to be an array in the JSON data but got " + data['detailed_stats']);
        }
        // ensure the json data is an array
        if (!Array.isArray(data['draw'])) {
            throw new Error("Expected the field `draw` to be an array in the JSON data but got " + data['draw']);
        }
        // ensure the json data is an array
        ...
        // ensure the json data is an array
        if (!Array.isArray(data['forfeit'])) {
            throw new Error("Expected the field `forfeit` to be an array in the JSON data but got " + data['forfeit']);
        }
 ...
 */
RangeOverBrackets.prototype['begin_at'] = undefined;

/**
 * @member {Array.<Boolean>} detailed_stats
 */
RangeOverBrackets.prototype['detailed_stats'] = undefined;

/**
 * @member {Array.<Boolean>} draw
 */
RangeOverBrackets.prototype['draw'] = undefined;

/**
 * @member {Array.<Date>} end_at
 */
RangeOverBrackets.prototype['end_at'] = undefined;

/**
 * @member {Array.<Boolean>} forfeit
 */
RangeOverBrackets.prototype['forfeit'] = undefined;

/**
 * @member {Array.<module:model/OpponentID>} game_advantage
 */
RangeOverBrackets.prototype['game_advantage'] = undefined;

/**
 * @member {Array.<Number>} id
 */
RangeOverBrackets.prototype['id'] = undefined;

/**
 * @member {Array.<String>} live_embed_url
 */
RangeOverBrackets.prototype['live_embed_url'] = undefined;

/**
 * @member {Array.<module:model/MatchType>} match_type
 */
RangeOverBrackets.prototype['match_type'] = undefined;

/**
 * @member {Array.<Date>} modified_at
 */
RangeOverBrackets.prototype['modified_at'] = undefined;

/**
 * @member {Array.<String>} name
 */
RangeOverBrackets.prototype['name'] = undefined;

/**
 * @member {Array.<Number>} number_of_games
 */
RangeOverBrackets.prototype['number_of_games'] = undefined;

/**
 * @member {Array.<String>} official_stream_url
 */
RangeOverBrackets.prototype['official_stream_url'] = undefined;

/**
 * @member {Array.<Date>} original_scheduled_at
 */
RangeOverBrackets.prototype['original_scheduled_at'] = undefined;

/**
 * @member {Array.<Date>} scheduled_at
 */
RangeOverBrackets.prototype['scheduled_at'] = undefined;

/**
 * @member {Array.<String>} slug
 */
RangeOverBrackets.prototype['slug'] = undefined;

/**
 * @member {Array.<module:model/MatchStatus>} status
 */
RangeOverBrackets.prototype['status'] = undefined;

/**
 * @member {Array.<Number>} tournament_id
 */
RangeOverBrackets.prototype['tournament_id'] = undefined;

/**
 * @member {Array.<module:model/OpponentID>} winner_id
 */
RangeOverBrackets.prototype['winner_id'] = undefined;
...
export default RangeOverBrackets;
