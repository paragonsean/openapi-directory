...
/**
 * The BaseTournament model module.
 * @module model/BaseTournament
 * @version 2.23.1
 */
class BaseTournament {
    /**
     * Constructs a new <code>BaseTournament</code>.
     * @alias module:model/BaseTournament
     ...
     */
    constructor(beginAt, endAt, id, leagueId, liveSupported, modifiedAt, name, prizepool, serieId, slug, winnerId, winnerType) { 
        
        BaseTournament.initialize(this, beginAt, endAt, id, leagueId, liveSupported, modifiedAt, name, prizepool, serieId, slug, winnerId, winnerType);
    }
     ...
     */
    static initialize(obj, beginAt, endAt, id, leagueId, liveSupported, modifiedAt, name, prizepool, serieId, slug, winnerId, winnerType) { 
    ...
    /**
     * Constructs a <code>BaseTournament</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/BaseTournament} obj Optional instance to populate.
     * @return {module:model/BaseTournament} The populated <code>BaseTournament</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new BaseTournament();
    ...
    /**
     * Validates the JSON data with respect to <code>BaseTournament</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>BaseTournament</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of BaseTournament.RequiredProperties) {
...
BaseTournament.RequiredProperties = ["begin_at", "end_at", "id", "league_id", "live_supported", "modified_at", "name", "prizepool", "serie_id", "slug", "winner_id", "winner_type"];

/**
 * @member {Object} begin_at
 */
BaseTournament.prototype['begin_at'] = undefined;

/**
 * @member {Object} end_at
 */
BaseTournament.prototype['end_at'] = undefined;

/**
 * @member {Number} id
 */
BaseTournament.prototype['id'] = undefined;

/**
 * @member {Number} league_id
 */
BaseTournament.prototype['league_id'] = undefined;

/**
 * Whether live is supported
 * @member {Boolean} live_supported
 */
BaseTournament.prototype['live_supported'] = undefined;

/**
 * @member {Date} modified_at
 */
BaseTournament.prototype['modified_at'] = undefined;

/**
 * @member {String} name
 */
BaseTournament.prototype['name'] = undefined;

/**
 * @member {Object} prizepool
 */
BaseTournament.prototype['prizepool'] = undefined;

/**
 * @member {Number} serie_id
 */
BaseTournament.prototype['serie_id'] = undefined;

/**
 * @member {String} slug
 */
BaseTournament.prototype['slug'] = undefined;

/**
 * @member {module:model/OpponentID1} winner_id
 */
BaseTournament.prototype['winner_id'] = undefined;

/**
 * @member {Object} winner_type
 */
BaseTournament.prototype['winner_type'] = undefined;
