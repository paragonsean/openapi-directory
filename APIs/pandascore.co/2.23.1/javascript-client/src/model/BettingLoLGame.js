...
import BettingGameTeams1 from './BettingGameTeams1';
import GameStatus from './GameStatus';
import GameWinner from './GameWinner';

/**
 * The BettingLoLGame model module.
 * @module model/BettingLoLGame
 * @version 2.23.1
 */
class BettingLoLGame {
    /**
     * Constructs a new <code>BettingLoLGame</code>.
     * @alias module:model/BettingLoLGame
     ...
     * @param gameTeams {module:model/BettingGameTeams1} 
     * @param id {Number} 
     * @param length {Object} 
     ...
     */
    constructor(beginAt, complete, detailedStats, endAt, finished, forfeit, gameTeams, id, length, matchId, position, status, videoUrl, winner, winnerType) { 
        
        BettingLoLGame.initialize(this, beginAt, complete, detailedStats, endAt, finished, forfeit, gameTeams, id, length, matchId, position, status, videoUrl, winner, winnerType);
    }
     ...
     */
    static initialize(obj, beginAt, complete, detailedStats, endAt, finished, forfeit, gameTeams, id, length, matchId, position, status, videoUrl, winner, winnerType) { 
    ...
    /**
     * Constructs a <code>BettingLoLGame</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/BettingLoLGame} obj Optional instance to populate.
     * @return {module:model/BettingLoLGame} The populated <code>BettingLoLGame</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new BettingLoLGame();
            ...
            if (data.hasOwnProperty('game_teams')) {
                obj['game_teams'] = BettingGameTeams1.constructFromObject(data['game_teams']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>BettingLoLGame</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>BettingLoLGame</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of BettingLoLGame.RequiredProperties) {
        ...
        // validate the optional field `game_teams`
        if (data['game_teams']) { // data not null
          BettingGameTeams1.validateJSON(data['game_teams']);
        }
...
BettingLoLGame.RequiredProperties = ["begin_at", "complete", "detailed_stats", "end_at", "finished", "forfeit", "game_teams", "id", "length", "match_id", "position", "status", "video_url", "winner", "winner_type"];

/**
 * @member {Object} begin_at
 */
BettingLoLGame.prototype['begin_at'] = undefined;

/**
 * Whether game data are complete and won't change
 * @member {Boolean} complete
 */
BettingLoLGame.prototype['complete'] = undefined;

/**
 * Whether the game offers full stats
 * @member {Boolean} detailed_stats
 */
BettingLoLGame.prototype['detailed_stats'] = undefined;

/**
 * @member {Object} end_at
 */
BettingLoLGame.prototype['end_at'] = undefined;

/**
 * Whether game is finished
 * @member {Boolean} finished
 */
BettingLoLGame.prototype['finished'] = undefined;

/**
 * Whether game is forfeit
 * @member {Boolean} forfeit
 */
BettingLoLGame.prototype['forfeit'] = undefined;

/**
 * @member {module:model/BettingGameTeams1} game_teams
 */
BettingLoLGame.prototype['game_teams'] = undefined;

/**
 * @member {Number} id
 */
BettingLoLGame.prototype['id'] = undefined;

/**
 * @member {Object} length
 */
BettingLoLGame.prototype['length'] = undefined;

/**
 * @member {Number} match_id
 */
BettingLoLGame.prototype['match_id'] = undefined;

/**
 * @member {Number} position
 */
BettingLoLGame.prototype['position'] = undefined;

/**
 * @member {module:model/GameStatus} status
 */
BettingLoLGame.prototype['status'] = undefined;

/**
 * @member {Object} video_url
 */
BettingLoLGame.prototype['video_url'] = undefined;

/**
 * @member {module:model/GameWinner} winner
 */
BettingLoLGame.prototype['winner'] = undefined;

/**
 * @member {Object} winner_type
 */
BettingLoLGame.prototype['winner_type'] = undefined;
