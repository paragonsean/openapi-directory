...
/**
 * The BettingDota2Game model module.
 * @module model/BettingDota2Game
 * @version 2.23.1
 */
class BettingDota2Game {
    /**
     * Constructs a new <code>BettingDota2Game</code>.
     * @alias module:model/BettingDota2Game
    ...
    constructor(beginAt, complete, detailedStats, endAt, finished, forfeit, id, length, matchId, position, status, videoUrl, winner, winnerType) { 
        ...
        BettingDota2Game.initialize(this, beginAt, complete, detailedStats, endAt, finished, forfeit, id, length, matchId, position, status, videoUrl, winner, winnerType);
    }
    ...
    /**
     * Constructs a <code>BettingDota2Game</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/BettingDota2Game} obj Optional instance to populate.
     * @return {module:model/BettingDota2Game} The populated <code>BettingDota2Game</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new BettingDota2Game();
    ...
    /**
     * Validates the JSON data with respect to <code>BettingDota2Game</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>BettingDota2Game</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of BettingDota2Game.RequiredProperties) {
...
BettingDota2Game.RequiredProperties = ["begin_at", "complete", "detailed_stats", "end_at", "finished", "forfeit", "id", "length", "match_id", "position", "status", "video_url", "winner", "winner_type"];

/**
 * @member {Object} begin_at
 */
BettingDota2Game.prototype['begin_at'] = undefined;

/**
 * Whether game data are complete and won't change
 * @member {Boolean} complete
 */
BettingDota2Game.prototype['complete'] = undefined;

/**
 * Whether the game offers full stats
 * @member {Boolean} detailed_stats
 */
BettingDota2Game.prototype['detailed_stats'] = undefined;

/**
 * @member {Object} end_at
 */
BettingDota2Game.prototype['end_at'] = undefined;

/**
 * Whether game is finished
 * @member {Boolean} finished
 */
BettingDota2Game.prototype['finished'] = undefined;

/**
 * Whether game is forfeit
 * @member {Boolean} forfeit
 */
BettingDota2Game.prototype['forfeit'] = undefined;

/**
 * @member {Number} id
 */
BettingDota2Game.prototype['id'] = undefined;

/**
 * @member {Object} length
 */
BettingDota2Game.prototype['length'] = undefined;

/**
 * @member {Number} match_id
 */
BettingDota2Game.prototype['match_id'] = undefined;

/**
 * @member {Number} position
 */
BettingDota2Game.prototype['position'] = undefined;

/**
 * @member {module:model/GameStatus} status
 */
BettingDota2Game.prototype['status'] = undefined;

/**
 * @member {Object} video_url
 */
BettingDota2Game.prototype['video_url'] = undefined;

/**
 * @member {module:model/GameWinner} winner
 */
BettingDota2Game.prototype['winner'] = undefined;

/**
 * @member {Object} winner_type
 */
BettingDota2Game.prototype['winner_type'] = undefined;
...
export default BettingDota2Game;
