...
/**
 * The BettingOwGame model module.
 * @module model/BettingOwGame
 * @version 2.23.1
 */
class BettingOwGame {
    /**
     * Constructs a new <code>BettingOwGame</code>.
     * @alias module:model/BettingOwGame
    ...
    constructor(beginAt, complete, detailedStats, endAt, finished, forfeit, id, length, matchId, position, status, videoUrl, winner, winnerType) { 
        ...
        BettingOwGame.initialize(this, beginAt, complete, detailedStats, endAt, finished, forfeit, id, length, matchId, position, status, videoUrl, winner, winnerType);
    }
    ...
    /**
     * Constructs a <code>BettingOwGame</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/BettingOwGame} obj Optional instance to populate.
     * @return {module:model/BettingOwGame} The populated <code>BettingOwGame</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new BettingOwGame();
    ...
    /**
     * Validates the JSON data with respect to <code>BettingOwGame</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>BettingOwGame</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of BettingOwGame.RequiredProperties) {
...
BettingOwGame.RequiredProperties = ["begin_at", "complete", "detailed_stats", "end_at", "finished", "forfeit", "id", "length", "match_id", "position", "status", "video_url", "winner", "winner_type"];

/**
 * @member {Object} begin_at
 */
BettingOwGame.prototype['begin_at'] = undefined;

/**
 * Whether game data are complete and won't change
 * @member {Boolean} complete
 */
BettingOwGame.prototype['complete'] = undefined;

/**
 * Whether the game offers full stats
 * @member {Boolean} detailed_stats
 */
BettingOwGame.prototype['detailed_stats'] = undefined;

/**
 * @member {Object} end_at
 */
BettingOwGame.prototype['end_at'] = undefined;

/**
 * Whether game is finished
 * @member {Boolean} finished
 */
BettingOwGame.prototype['finished'] = undefined;

/**
 * Whether game is forfeit
 * @member {Boolean} forfeit
 */
BettingOwGame.prototype['forfeit'] = undefined;

/**
 * @member {Number} id
 */
BettingOwGame.prototype['id'] = undefined;

/**
 * @member {Object} length
 */
BettingOwGame.prototype['length'] = undefined;

/**
 * @member {Number} match_id
 */
BettingOwGame.prototype['match_id'] = undefined;

/**
 * @member {Number} position
 */
BettingOwGame.prototype['position'] = undefined;

/**
 * @member {module:model/GameStatus} status
 */
BettingOwGame.prototype['status'] = undefined;

/**
 * @member {Object} video_url
 */
BettingOwGame.prototype['video_url'] = undefined;

/**
 * @member {module:model/GameWinner} winner
 */
BettingOwGame.prototype['winner'] = undefined;

/**
 * @member {Object} winner_type
 */
BettingOwGame.prototype['winner_type'] = undefined;
