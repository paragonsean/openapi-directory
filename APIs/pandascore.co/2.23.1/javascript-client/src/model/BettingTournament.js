...
/**
 * The BettingTournament model module.
 * @module model/BettingTournament
 * @version 2.23.1
 */
class BettingTournament {
    /**
     * Constructs a new <code>BettingTournament</code>.
     * @alias module:model/BettingTournament
     ...
     */
    constructor(beginAt, endAt, id, liveSupported, modifiedAt, name, prizepool, serieId, slug, videogame, winnerId, winnerType) { 
        
        BettingTournament.initialize(this, beginAt, endAt, id, liveSupported, modifiedAt, name, prizepool, serieId, slug, videogame, winnerId, winnerType);
    }
     ...
     */
    static initialize(obj, beginAt, endAt, id, liveSupported, modifiedAt, name, prizepool, serieId, slug, videogame, winnerId, winnerType) { 
    ...
    /**
     * Constructs a <code>BettingTournament</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/BettingTournament} obj Optional instance to populate.
     * @return {module:model/BettingTournament} The populated <code>BettingTournament</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new BettingTournament();
    ...
    /**
     * Validates the JSON data with respect to <code>BettingTournament</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>BettingTournament</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of BettingTournament.RequiredProperties) {
...
BettingTournament.RequiredProperties = ["begin_at", "end_at", "id", "live_supported", "modified_at", "name", "prizepool", "serie_id", "slug", "videogame", "winner_id", "winner_type"];

/**
 * @member {Object} begin_at
 */
BettingTournament.prototype['begin_at'] = undefined;

/**
 * @member {Object} end_at
 */
BettingTournament.prototype['end_at'] = undefined;

/**
 * @member {Number} id
 */
BettingTournament.prototype['id'] = undefined;

/**
 * Whether live is supported
 * @member {Boolean} live_supported
 */
BettingTournament.prototype['live_supported'] = undefined;

/**
 * @member {Date} modified_at
 */
BettingTournament.prototype['modified_at'] = undefined;

/**
 * @member {String} name
 */
BettingTournament.prototype['name'] = undefined;

/**
 * @member {Object} prizepool
 */
BettingTournament.prototype['prizepool'] = undefined;

/**
 * @member {Number} serie_id
 */
BettingTournament.prototype['serie_id'] = undefined;

/**
 * @member {String} slug
 */
BettingTournament.prototype['slug'] = undefined;

/**
 * @member {module:model/CurrentVideogame} videogame
 */
BettingTournament.prototype['videogame'] = undefined;

/**
 * @member {module:model/OpponentID1} winner_id
 */
BettingTournament.prototype['winner_id'] = undefined;

/**
 * @member {Object} winner_type
 */
BettingTournament.prototype['winner_type'] = undefined;
...
export default BettingTournament;
