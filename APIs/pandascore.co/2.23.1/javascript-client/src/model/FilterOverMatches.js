...
import TeamIDOrSlug from './TeamIDOrSlug';
import VideogameIDOrSlug from './VideogameIDOrSlug';

/**
 * The FilterOverMatches model module.
 * @module model/FilterOverMatches
 * @version 2.23.1
 */
class FilterOverMatches {
    /**
     * Constructs a new <code>FilterOverMatches</code>.
     * @alias module:model/FilterOverMatches
     */
    constructor() { 
        
        FilterOverMatches.initialize(this);
    }
    ...
    /**
     * Constructs a <code>FilterOverMatches</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/FilterOverMatches} obj Optional instance to populate.
     * @return {module:model/FilterOverMatches} The populated <code>FilterOverMatches</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new FilterOverMatches();
            ...
            if (data.hasOwnProperty('not_started')) {
                obj['not_started'] = ApiClient.convertToType(data['not_started'], 'Boolean');
            }
            if (data.hasOwnProperty('number_of_games')) {
                obj['number_of_games'] = ApiClient.convertToType(data['number_of_games'], ['Number']);
            }
            if (data.hasOwnProperty('opponent_id')) {
                obj['opponent_id'] = ApiClient.convertToType(data['opponent_id'], [TeamIDOrSlug]);
            }
            ...
            if (data.hasOwnProperty('unscheduled')) {
                obj['unscheduled'] = ApiClient.convertToType(data['unscheduled'], 'Boolean');
            }
            if (data.hasOwnProperty('videogame')) {
                obj['videogame'] = ApiClient.convertToType(data['videogame'], [VideogameIDOrSlug]);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>FilterOverMatches</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>FilterOverMatches</code>.
     */
    static validateJSON(data) {
        ...
        if (data['opponent_id']) { // data not null
            // ensure the json data is an array
            if (!Array.isArray(data['opponent_id'])) {
                throw new Error("Expected the field `opponent_id` to be an array in the JSON data but got " + data['opponent_id']);
            }
            // validate the optional field `opponent_id` (array)
            for (const item of data['opponent_id']) {
                TeamIDOrSlug.validateJSON(item);
            };
        }
        // ensure the json data is an array
        ...
        // ensure the json data is an array
        if (!Array.isArray(data['serie_id'])) {
            throw new Error("Expected the field `serie_id` to be an array in the JSON data but got " + data['serie_id']);
        }
        // ensure the json data is an array
        ...
        if (data['videogame']) { // data not null
            // ensure the json data is an array
            if (!Array.isArray(data['videogame'])) {
                throw new Error("Expected the field `videogame` to be an array in the JSON data but got " + data['videogame']);
            }
            // validate the optional field `videogame` (array)
            for (const item of data['videogame']) {
                VideogameIDOrSlug.validateJSON(item);
            };
        }
 ...
 */
FilterOverMatches.prototype['begin_at'] = undefined;

/**
 * Whether the match offers full stats
 * @member {Boolean} detailed_stats
 */
FilterOverMatches.prototype['detailed_stats'] = undefined;

/**
 * Whether result of the match is a draw
 * @member {Boolean} draw
 */
FilterOverMatches.prototype['draw'] = undefined;

/**
 * @member {Array.<Date>} end_at
 */
FilterOverMatches.prototype['end_at'] = undefined;

/**
 * @member {Boolean} finished
 */
FilterOverMatches.prototype['finished'] = undefined;

/**
 * Whether match was forfeited
 * @member {Boolean} forfeit
 */
FilterOverMatches.prototype['forfeit'] = undefined;

/**
 * @member {Boolean} future
 */
FilterOverMatches.prototype['future'] = undefined;

/**
 * @member {Array.<Number>} id
 */
FilterOverMatches.prototype['id'] = undefined;

/**
 * @member {Array.<Number>} league_id
 */
FilterOverMatches.prototype['league_id'] = undefined;

/**
 * @member {Array.<module:model/MatchType>} match_type
 */
FilterOverMatches.prototype['match_type'] = undefined;

/**
 * @member {Array.<Date>} modified_at
 */
FilterOverMatches.prototype['modified_at'] = undefined;

/**
 * @member {Array.<String>} name
 */
FilterOverMatches.prototype['name'] = undefined;

/**
 * @member {Boolean} not_started
 */
FilterOverMatches.prototype['not_started'] = undefined;

/**
 * @member {Array.<Number>} number_of_games
 */
FilterOverMatches.prototype['number_of_games'] = undefined;

/**
 * @member {Array.<module:model/TeamIDOrSlug>} opponent_id
 */
FilterOverMatches.prototype['opponent_id'] = undefined;

/**
 * @member {Boolean} past
 */
FilterOverMatches.prototype['past'] = undefined;

/**
 * @member {Boolean} running
 */
FilterOverMatches.prototype['running'] = undefined;

/**
 * @member {Array.<Date>} scheduled_at
 */
FilterOverMatches.prototype['scheduled_at'] = undefined;

/**
 * @member {Array.<Number>} serie_id
 */
FilterOverMatches.prototype['serie_id'] = undefined;

/**
 * @member {Array.<String>} slug
 */
FilterOverMatches.prototype['slug'] = undefined;

/**
 * @member {Array.<module:model/MatchStatus>} status
 */
FilterOverMatches.prototype['status'] = undefined;

/**
 * @member {Array.<Number>} tournament_id
 */
FilterOverMatches.prototype['tournament_id'] = undefined;

/**
 * @member {Boolean} unscheduled
 */
FilterOverMatches.prototype['unscheduled'] = undefined;

/**
 * @member {Array.<module:model/VideogameIDOrSlug>} videogame
 */
FilterOverMatches.prototype['videogame'] = undefined;

/**
 * @member {Array.<module:model/OpponentID>} winner_id
 */
FilterOverMatches.prototype['winner_id'] = undefined;
...
export default FilterOverMatches;
