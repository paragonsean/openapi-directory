...
/**
 * The RangeOverSeries model module.
 * @module model/RangeOverSeries
 * @version 2.23.1
 */
class RangeOverSeries {
    /**
     * Constructs a new <code>RangeOverSeries</code>.
     * @alias module:model/RangeOverSeries
     */
    constructor() { 
        
        RangeOverSeries.initialize(this);
    }
    ...
    /**
     * Constructs a <code>RangeOverSeries</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/RangeOverSeries} obj Optional instance to populate.
     * @return {module:model/RangeOverSeries} The populated <code>RangeOverSeries</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RangeOverSeries();
    ...
    /**
     * Validates the JSON data with respect to <code>RangeOverSeries</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RangeOverSeries</code>.
     */
 ...
 */
RangeOverSeries.prototype['begin_at'] = undefined;

/**
 * @member {Array.<String>} description
 */
RangeOverSeries.prototype['description'] = undefined;

/**
 * @member {Array.<Date>} end_at
 */
RangeOverSeries.prototype['end_at'] = undefined;

/**
 * @member {Array.<Number>} id
 */
RangeOverSeries.prototype['id'] = undefined;

/**
 * @member {Array.<Number>} league_id
 */
RangeOverSeries.prototype['league_id'] = undefined;

/**
 * @member {Array.<Date>} modified_at
 */
RangeOverSeries.prototype['modified_at'] = undefined;

/**
 * @member {Array.<String>} name
 */
RangeOverSeries.prototype['name'] = undefined;

/**
 * @member {Array.<String>} season
 */
RangeOverSeries.prototype['season'] = undefined;

/**
 * @member {Array.<String>} slug
 */
RangeOverSeries.prototype['slug'] = undefined;

/**
 * @member {Array.<String>} tier
 */
RangeOverSeries.prototype['tier'] = undefined;

/**
 * @member {Array.<module:model/OpponentID>} winner_id
 */
RangeOverSeries.prototype['winner_id'] = undefined;

/**
 * @member {Array.<module:model/OpponentType>} winner_type
 */
RangeOverSeries.prototype['winner_type'] = undefined;

/**
 * @member {Array.<Number>} year
 */
RangeOverSeries.prototype['year'] = undefined;
...
export default RangeOverSeries;
