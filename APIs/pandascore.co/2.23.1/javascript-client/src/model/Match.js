...
class Match {
     ...
     * @param tournament {module:model/BaseTournament} 
     ...
     */
    static initialize(obj, beginAt, detailedStats, draw, endAt, forfeit, gameAdvantage, games, id, league, leagueId, live, liveEmbedUrl, matchType, modifiedAt, name, numberOfGames, officialStreamUrl, opponents, originalScheduledAt, rescheduled, results, scheduledAt, serie, serieId, slug, status, streams, streamsList, tournament, tournamentId, videogame, videogameVersion, winner, winnerId) { 
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('tournament')) {
                obj['tournament'] = BaseTournament.constructFromObject(data['tournament']);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['tournament']) { // data not null
          BaseTournament.validateJSON(data['tournament']);
        }
 ...
 */
Match.prototype['league'] = undefined;

/**
 * @member {Number} league_id
 */
Match.prototype['league_id'] = undefined;

/**
 * @member {module:model/MatchLive} live
 */
Match.prototype['live'] = undefined;

/**
 * @member {Object} live_embed_url
 */
Match.prototype['live_embed_url'] = undefined;

/**
 * @member {module:model/MatchType} match_type
 */
Match.prototype['match_type'] = undefined;

/**
 * @member {Date} modified_at
 */
Match.prototype['modified_at'] = undefined;
 ...
 */
Match.prototype['number_of_games'] = undefined;

/**
 * @member {Object} official_stream_url
 */
Match.prototype['official_stream_url'] = undefined;

/**
 * @member {Array.<module:model/Opponent>} opponents
 */
Match.prototype['opponents'] = undefined;

/**
 * @member {Object} original_scheduled_at
 */
Match.prototype['original_scheduled_at'] = undefined;

/**
 * @member {Object} rescheduled
 */
Match.prototype['rescheduled'] = undefined;

/**
 * @member {Array.<module:model/MatchResult>} results
 */
Match.prototype['results'] = undefined;

/**
 * @member {Object} scheduled_at
 */
Match.prototype['scheduled_at'] = undefined;

/**
 * @member {module:model/BaseSerie} serie
 */
Match.prototype['serie'] = undefined;

/**
 * @member {Number} serie_id
 */
Match.prototype['serie_id'] = undefined;

/**
 * @member {Object} slug
 */
Match.prototype['slug'] = undefined;

/**
 * @member {module:model/MatchStatus} status
 */
Match.prototype['status'] = undefined;

/**
 * @member {module:model/MatchLocalizedStreams} streams
 */
Match.prototype['streams'] = undefined;

/**
 * @member {Array.<module:model/Stream>} streams_list
 */
Match.prototype['streams_list'] = undefined;

/**
 * @member {module:model/BaseTournament} tournament
 */
Match.prototype['tournament'] = undefined;

/**
 * @member {Number} tournament_id
 */
Match.prototype['tournament_id'] = undefined;

/**
 * @member {module:model/CurrentVideogame} videogame
 */
Match.prototype['videogame'] = undefined;

/**
 * @member {module:model/ShortVideogameVersion1} videogame_version
 */
Match.prototype['videogame_version'] = undefined;

/**
 * @member {module:model/BaseOpponent1} winner
 */
Match.prototype['winner'] = undefined;

/**
 * @member {module:model/OpponentID1} winner_id
 */
Match.prototype['winner_id'] = undefined;
