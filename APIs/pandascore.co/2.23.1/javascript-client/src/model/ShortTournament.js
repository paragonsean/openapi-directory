...
/**
 * The ShortTournament model module.
 * @module model/ShortTournament
 * @version 2.23.1
 */
class ShortTournament {
    /**
     * Constructs a new <code>ShortTournament</code>.
     * @alias module:model/ShortTournament
     ...
     */
    constructor(beginAt, endAt, id, league, leagueId, liveSupported, matches, modifiedAt, name, prizepool, serie, serieId, slug, teams, videogame, winnerId, winnerType) { 
        
        ShortTournament.initialize(this, beginAt, endAt, id, league, leagueId, liveSupported, matches, modifiedAt, name, prizepool, serie, serieId, slug, teams, videogame, winnerId, winnerType);
    }
     ...
     */
    static initialize(obj, beginAt, endAt, id, league, leagueId, liveSupported, matches, modifiedAt, name, prizepool, serie, serieId, slug, teams, videogame, winnerId, winnerType) { 
    ...
    /**
     * Constructs a <code>ShortTournament</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ShortTournament} obj Optional instance to populate.
     * @return {module:model/ShortTournament} The populated <code>ShortTournament</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ShortTournament();
    ...
    /**
     * Validates the JSON data with respect to <code>ShortTournament</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ShortTournament</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ShortTournament.RequiredProperties) {
...
ShortTournament.RequiredProperties = ["begin_at", "end_at", "id", "league", "league_id", "live_supported", "matches", "modified_at", "name", "prizepool", "serie", "serie_id", "slug", "teams", "videogame", "winner_id", "winner_type"];

/**
 * @member {Object} begin_at
 */
ShortTournament.prototype['begin_at'] = undefined;

/**
 * @member {Object} end_at
 */
ShortTournament.prototype['end_at'] = undefined;

/**
 * @member {Number} id
 */
ShortTournament.prototype['id'] = undefined;

/**
 * @member {module:model/BaseLeague} league
 */
ShortTournament.prototype['league'] = undefined;

/**
 * @member {Number} league_id
 */
ShortTournament.prototype['league_id'] = undefined;

/**
 * Whether live is supported
 * @member {Boolean} live_supported
 */
ShortTournament.prototype['live_supported'] = undefined;

/**
 * @member {Array.<module:model/BaseMatch>} matches
 */
ShortTournament.prototype['matches'] = undefined;

/**
 * @member {Date} modified_at
 */
ShortTournament.prototype['modified_at'] = undefined;

/**
 * @member {String} name
 */
ShortTournament.prototype['name'] = undefined;

/**
 * @member {Object} prizepool
 */
ShortTournament.prototype['prizepool'] = undefined;

/**
 * @member {module:model/BaseSerie} serie
 */
ShortTournament.prototype['serie'] = undefined;

/**
 * @member {Number} serie_id
 */
ShortTournament.prototype['serie_id'] = undefined;

/**
 * @member {String} slug
 */
ShortTournament.prototype['slug'] = undefined;

/**
 * @member {Array.<module:model/BaseTeam>} teams
 */
ShortTournament.prototype['teams'] = undefined;

/**
 * @member {module:model/CurrentVideogame} videogame
 */
ShortTournament.prototype['videogame'] = undefined;

/**
 * @member {module:model/OpponentID1} winner_id
 */
ShortTournament.prototype['winner_id'] = undefined;

/**
 * @member {Object} winner_type
 */
ShortTournament.prototype['winner_type'] = undefined;
...
export default ShortTournament;
