...
/**
 * The LeagueVideogame model module.
 * @module model/LeagueVideogame
 * @version 2.23.1
 */
class LeagueVideogame {
    /**
     * Constructs a new <code>LeagueVideogame</code>.
     * @alias module:model/LeagueVideogame
     * @param {(module:model/LeagueVideogameCSGO|module:model/LeagueVideogameCodmw|module:model/LeagueVideogameDota2|module:model/LeagueVideogameFifa|module:model/LeagueVideogameLoL|module:model/LeagueVideogameOverwatch|module:model/LeagueVideogamePUBG|module:model/LeagueVideogameR6siege|module:model/LeagueVideogameRocketLeague|module:model/LeagueVideogameValorant)} instance The actual instance to initialize LeagueVideogame.
     */
    constructor(instance = null) {
        ...
        if (match > 1) {
            throw new Error("Multiple matches found constructing `LeagueVideogame` with oneOf schemas LeagueVideogameCSGO, LeagueVideogameCodmw, LeagueVideogameDota2, LeagueVideogameFifa, LeagueVideogameLoL, LeagueVideogameOverwatch, LeagueVideogamePUBG, LeagueVideogameR6siege, LeagueVideogameRocketLeague, LeagueVideogameValorant. Input: " + JSON.stringify(instance));
        } else if (match === 0) {
            this.actualInstance = null; // clear the actual instance in case there are multiple matches
            throw new Error("No match found constructing `LeagueVideogame` with oneOf schemas LeagueVideogameCSGO, LeagueVideogameCodmw, LeagueVideogameDota2, LeagueVideogameFifa, LeagueVideogameLoL, LeagueVideogameOverwatch, LeagueVideogamePUBG, LeagueVideogameR6siege, LeagueVideogameRocketLeague, LeagueVideogameValorant. Details: " +
                            errorMessages.join(", "));
        } else { // only 1 match
            // the input is valid
        }
    ...
    /**
     * Constructs a <code>LeagueVideogame</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/LeagueVideogame} obj Optional instance to populate.
     * @return {module:model/LeagueVideogame} The populated <code>LeagueVideogame</code> instance.
     */
    static constructFromObject(data, obj) {
        return new LeagueVideogame(data);
    }
     ...
     * @return {(module:model/LeagueVideogameCSGO|module:model/LeagueVideogameCodmw|module:model/LeagueVideogameDota2|module:model/LeagueVideogameFifa|module:model/LeagueVideogameLoL|module:model/LeagueVideogameOverwatch|module:model/LeagueVideogamePUBG|module:model/LeagueVideogameR6siege|module:model/LeagueVideogameRocketLeague|module:model/LeagueVideogameValorant)} The actual instance.
     */
    getActualInstance() {
    ...
    setActualInstance(obj) {
       this.actualInstance = LeagueVideogame.constructFromObject(obj).getActualInstance();
    }
    ...
    /**
     * Create an instance of LeagueVideogame from a JSON string.
     * @param {string} json_string JSON string.
     * @return {module:model/LeagueVideogame} An instance of LeagueVideogame.
     */
    static fromJSON = function(json_string){
        return LeagueVideogame.constructFromObject(JSON.parse(json_string));
    }
}
 ...
 */
LeagueVideogame.prototype['current_version'] = undefined;

/**
 * @member {module:model/LeagueVideogame.IdEnum} id
 */
LeagueVideogame.prototype['id'] = undefined;

/**
 * @member {module:model/LeagueVideogame.NameEnum} name
 */
LeagueVideogame.prototype['name'] = undefined;

/**
 * @member {module:model/LeagueVideogame.SlugEnum} slug
 */
LeagueVideogame.prototype['slug'] = undefined;


LeagueVideogame.OneOf = ["LeagueVideogameCSGO", "LeagueVideogameCodmw", "LeagueVideogameDota2", "LeagueVideogameFifa", "LeagueVideogameLoL", "LeagueVideogameOverwatch", "LeagueVideogamePUBG", "LeagueVideogameR6siege", "LeagueVideogameRocketLeague", "LeagueVideogameValorant"];

export default LeagueVideogame;
