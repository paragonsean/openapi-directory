...
import BaseTeam1 from './BaseTeam1';
...
class Player {
     ...
     * @param currentTeam {module:model/BaseTeam1} 
     * @param currentVideogame {Object} 
     ...
     * @param slug {Object} 
     */
    constructor(currentTeam, currentVideogame, firstName, hometown, id, imageUrl, lastName, name, nationality, role, slug) { 
        
        Player.initialize(this, currentTeam, currentVideogame, firstName, hometown, id, imageUrl, lastName, name, nationality, role, slug);
    }
     ...
     */
    static initialize(obj, currentTeam, currentVideogame, firstName, hometown, id, imageUrl, lastName, name, nationality, role, slug) { 
        obj['current_team'] = currentTeam;
        obj['current_videogame'] = currentVideogame;
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('current_team')) {
                obj['current_team'] = BaseTeam1.constructFromObject(data['current_team']);
            }
            if (data.hasOwnProperty('current_videogame')) {
                obj['current_videogame'] = ApiClient.convertToType(data['current_videogame'], Object);
            }
    ...
    static validateJSON(data) {
        ...
        // validate the optional field `current_team`
        if (data['current_team']) { // data not null
          BaseTeam1.validateJSON(data['current_team']);
        }
        // validate the optional field `current_videogame`
        if (data['current_videogame']) { // data not null
          Object.validateJSON(data['current_videogame']);
        }
...
Player.RequiredProperties = ["current_team", "current_videogame", "first_name", "hometown", "id", "image_url", "last_name", "name", "nationality", "role", "slug"];

/**
 * @member {Object} birth_year
 */
Player.prototype['birth_year'] = undefined;

/**
 * @member {Object} birthday
 */
Player.prototype['birthday'] = undefined;

/**
 * @member {module:model/BaseTeam1} current_team
 */
Player.prototype['current_team'] = undefined;

/**
 * @member {Object} current_videogame
 */
Player.prototype['current_videogame'] = undefined;
 ...
 */
Player.prototype['hometown'] = undefined;
 ...
 */
Player.prototype['image_url'] = undefined;
 ...
 * @member {Object} slug
 */
Player.prototype['slug'] = undefined;
