...
/**
 * The RangeOverShortTournaments model module.
 * @module model/RangeOverShortTournaments
 * @version 2.23.1
 */
class RangeOverShortTournaments {
    /**
     * Constructs a new <code>RangeOverShortTournaments</code>.
     * @alias module:model/RangeOverShortTournaments
     */
    constructor() { 
        
        RangeOverShortTournaments.initialize(this);
    }
    ...
    /**
     * Constructs a <code>RangeOverShortTournaments</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/RangeOverShortTournaments} obj Optional instance to populate.
     * @return {module:model/RangeOverShortTournaments} The populated <code>RangeOverShortTournaments</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RangeOverShortTournaments();
            ...
            if (data.hasOwnProperty('prizepool')) {
                obj['prizepool'] = ApiClient.convertToType(data['prizepool'], ['String']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>RangeOverShortTournaments</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RangeOverShortTournaments</code>.
     */
    static validateJSON(data) {
        ...
        // ensure the json data is an array
        if (!Array.isArray(data['prizepool'])) {
            throw new Error("Expected the field `prizepool` to be an array in the JSON data but got " + data['prizepool']);
        }
        // ensure the json data is an array
 ...
 */
RangeOverShortTournaments.prototype['begin_at'] = undefined;

/**
 * @member {Array.<Date>} end_at
 */
RangeOverShortTournaments.prototype['end_at'] = undefined;

/**
 * @member {Array.<Number>} id
 */
RangeOverShortTournaments.prototype['id'] = undefined;

/**
 * @member {Array.<Date>} modified_at
 */
RangeOverShortTournaments.prototype['modified_at'] = undefined;

/**
 * @member {Array.<String>} name
 */
RangeOverShortTournaments.prototype['name'] = undefined;

/**
 * @member {Array.<String>} prizepool
 */
RangeOverShortTournaments.prototype['prizepool'] = undefined;

/**
 * @member {Array.<Number>} serie_id
 */
RangeOverShortTournaments.prototype['serie_id'] = undefined;

/**
 * @member {Array.<String>} slug
 */
RangeOverShortTournaments.prototype['slug'] = undefined;

/**
 * @member {Array.<module:model/OpponentID>} winner_id
 */
RangeOverShortTournaments.prototype['winner_id'] = undefined;

/**
 * @member {Array.<module:model/OpponentType>} winner_type
 */
RangeOverShortTournaments.prototype['winner_type'] = undefined;
...
export default RangeOverShortTournaments;
