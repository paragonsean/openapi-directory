...
/**
 * The FilterOverShortTournaments model module.
 * @module model/FilterOverShortTournaments
 * @version 2.23.1
 */
class FilterOverShortTournaments {
    /**
     * Constructs a new <code>FilterOverShortTournaments</code>.
     * @alias module:model/FilterOverShortTournaments
     */
    constructor() { 
        
        FilterOverShortTournaments.initialize(this);
    }
    ...
    /**
     * Constructs a <code>FilterOverShortTournaments</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/FilterOverShortTournaments} obj Optional instance to populate.
     * @return {module:model/FilterOverShortTournaments} The populated <code>FilterOverShortTournaments</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new FilterOverShortTournaments();
    ...
    /**
     * Validates the JSON data with respect to <code>FilterOverShortTournaments</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>FilterOverShortTournaments</code>.
     */
 ...
 */
FilterOverShortTournaments.prototype['begin_at'] = undefined;

/**
 * @member {Array.<Date>} end_at
 */
FilterOverShortTournaments.prototype['end_at'] = undefined;

/**
 * @member {Array.<Number>} id
 */
FilterOverShortTournaments.prototype['id'] = undefined;

/**
 * Whether live is supported
 * @member {Boolean} live_supported
 */
FilterOverShortTournaments.prototype['live_supported'] = undefined;

/**
 * @member {Array.<Date>} modified_at
 */
FilterOverShortTournaments.prototype['modified_at'] = undefined;

/**
 * @member {Array.<String>} name
 */
FilterOverShortTournaments.prototype['name'] = undefined;

/**
 * @member {Array.<String>} prizepool
 */
FilterOverShortTournaments.prototype['prizepool'] = undefined;

/**
 * @member {Array.<Number>} serie_id
 */
FilterOverShortTournaments.prototype['serie_id'] = undefined;

/**
 * @member {Array.<String>} slug
 */
FilterOverShortTournaments.prototype['slug'] = undefined;

/**
 * @member {Array.<module:model/OpponentID>} winner_id
 */
FilterOverShortTournaments.prototype['winner_id'] = undefined;

/**
 * @member {Array.<module:model/OpponentType>} winner_type
 */
FilterOverShortTournaments.prototype['winner_type'] = undefined;
...
export default FilterOverShortTournaments;
