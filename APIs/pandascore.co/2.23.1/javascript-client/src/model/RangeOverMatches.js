...
/**
 * The RangeOverMatches model module.
 * @module model/RangeOverMatches
 * @version 2.23.1
 */
class RangeOverMatches {
    /**
     * Constructs a new <code>RangeOverMatches</code>.
     * @alias module:model/RangeOverMatches
     */
    constructor() { 
        
        RangeOverMatches.initialize(this);
    }
    ...
    /**
     * Constructs a <code>RangeOverMatches</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/RangeOverMatches} obj Optional instance to populate.
     * @return {module:model/RangeOverMatches} The populated <code>RangeOverMatches</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RangeOverMatches();
    ...
    /**
     * Validates the JSON data with respect to <code>RangeOverMatches</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RangeOverMatches</code>.
     */
 ...
 */
RangeOverMatches.prototype['begin_at'] = undefined;

/**
 * @member {Array.<Boolean>} detailed_stats
 */
RangeOverMatches.prototype['detailed_stats'] = undefined;

/**
 * @member {Array.<Boolean>} draw
 */
RangeOverMatches.prototype['draw'] = undefined;

/**
 * @member {Array.<Date>} end_at
 */
RangeOverMatches.prototype['end_at'] = undefined;

/**
 * @member {Array.<Boolean>} forfeit
 */
RangeOverMatches.prototype['forfeit'] = undefined;

/**
 * @member {Array.<Number>} id
 */
RangeOverMatches.prototype['id'] = undefined;

/**
 * @member {Array.<module:model/MatchType>} match_type
 */
RangeOverMatches.prototype['match_type'] = undefined;

/**
 * @member {Array.<Date>} modified_at
 */
RangeOverMatches.prototype['modified_at'] = undefined;

/**
 * @member {Array.<String>} name
 */
RangeOverMatches.prototype['name'] = undefined;

/**
 * @member {Array.<Number>} number_of_games
 */
RangeOverMatches.prototype['number_of_games'] = undefined;

/**
 * @member {Array.<Date>} scheduled_at
 */
RangeOverMatches.prototype['scheduled_at'] = undefined;

/**
 * @member {Array.<String>} slug
 */
RangeOverMatches.prototype['slug'] = undefined;

/**
 * @member {Array.<module:model/MatchStatus>} status
 */
RangeOverMatches.prototype['status'] = undefined;

/**
 * @member {Array.<Number>} tournament_id
 */
RangeOverMatches.prototype['tournament_id'] = undefined;

/**
 * @member {Array.<module:model/OpponentID>} winner_id
 */
RangeOverMatches.prototype['winner_id'] = undefined;
...
export default RangeOverMatches;
