...
class Team {
     ...
     * @param slug {Object} 
     */
    constructor(acronym, currentVideogame, id, imageUrl, location, modifiedAt, name, players, slug) { 
        
        Team.initialize(this, acronym, currentVideogame, id, imageUrl, location, modifiedAt, name, players, slug);
    }
     ...
     */
    static initialize(obj, acronym, currentVideogame, id, imageUrl, location, modifiedAt, name, players, slug) { 
        obj['acronym'] = acronym;
...
Team.RequiredProperties = ["acronym", "current_videogame", "id", "image_url", "location", "modified_at", "name", "players", "slug"];

/**
 * @member {Object} acronym
 */
Team.prototype['acronym'] = undefined;

/**
 * @member {Object} current_videogame
 */
Team.prototype['current_videogame'] = undefined;
 ...
 */
Team.prototype['image_url'] = undefined;
 ...
 */
Team.prototype['modified_at'] = undefined;
 ...
 */
Team.prototype['players'] = undefined;
