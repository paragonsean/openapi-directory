...
/**
 * The BaseSerie model module.
 * @module model/BaseSerie
 * @version 2.23.1
 */
class BaseSerie {
    /**
     * Constructs a new <code>BaseSerie</code>.
     * @alias module:model/BaseSerie
     ...
     * @param year {Number} 
     */
    constructor(beginAt, description, endAt, fullName, id, leagueId, modifiedAt, name, season, slug, tier, winnerId, winnerType, year) { 
        
        BaseSerie.initialize(this, beginAt, description, endAt, fullName, id, leagueId, modifiedAt, name, season, slug, tier, winnerId, winnerType, year);
    }
     ...
     */
    static initialize(obj, beginAt, description, endAt, fullName, id, leagueId, modifiedAt, name, season, slug, tier, winnerId, winnerType, year) { 
    ...
    /**
     * Constructs a <code>BaseSerie</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/BaseSerie} obj Optional instance to populate.
     * @return {module:model/BaseSerie} The populated <code>BaseSerie</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new BaseSerie();
    ...
    /**
     * Validates the JSON data with respect to <code>BaseSerie</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>BaseSerie</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of BaseSerie.RequiredProperties) {
...
BaseSerie.RequiredProperties = ["begin_at", "description", "end_at", "full_name", "id", "league_id", "modified_at", "name", "season", "slug", "tier", "winner_id", "winner_type", "year"];

/**
 * @member {Object} begin_at
 */
BaseSerie.prototype['begin_at'] = undefined;

/**
 * @member {Object} description
 */
BaseSerie.prototype['description'] = undefined;

/**
 * @member {Object} end_at
 */
BaseSerie.prototype['end_at'] = undefined;

/**
 * @member {String} full_name
 */
BaseSerie.prototype['full_name'] = undefined;

/**
 * @member {Number} id
 */
BaseSerie.prototype['id'] = undefined;

/**
 * @member {Number} league_id
 */
BaseSerie.prototype['league_id'] = undefined;

/**
 * @member {Date} modified_at
 */
BaseSerie.prototype['modified_at'] = undefined;

/**
 * @member {Object} name
 */
BaseSerie.prototype['name'] = undefined;

/**
 * @member {Object} season
 */
BaseSerie.prototype['season'] = undefined;

/**
 * @member {String} slug
 */
BaseSerie.prototype['slug'] = undefined;

/**
 * @member {Object} tier
 */
BaseSerie.prototype['tier'] = undefined;

/**
 * @member {module:model/OpponentID1} winner_id
 */
BaseSerie.prototype['winner_id'] = undefined;

/**
 * @member {Object} winner_type
 */
BaseSerie.prototype['winner_type'] = undefined;

/**
 * @member {Number} year
 */
BaseSerie.prototype['year'] = undefined;
