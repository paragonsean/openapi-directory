...
class Bracket {
     ...
     * @param previousMatches {Array.<module:model/PreviousMatch>} 
     ...
     */
    constructor(beginAt, detailedStats, draw, endAt, forfeit, gameAdvantage, games, id, live, liveEmbedUrl, matchType, modifiedAt, name, numberOfGames, officialStreamUrl, opponents, originalScheduledAt, previousMatches, scheduledAt, slug, status, streams, streamsList, tournamentId, winnerId) { 
        
        Bracket.initialize(this, beginAt, detailedStats, draw, endAt, forfeit, gameAdvantage, games, id, live, liveEmbedUrl, matchType, modifiedAt, name, numberOfGames, officialStreamUrl, opponents, originalScheduledAt, previousMatches, scheduledAt, slug, status, streams, streamsList, tournamentId, winnerId);
    }
     ...
     */
    static initialize(obj, beginAt, detailedStats, draw, endAt, forfeit, gameAdvantage, games, id, live, liveEmbedUrl, matchType, modifiedAt, name, numberOfGames, officialStreamUrl, opponents, originalScheduledAt, previousMatches, scheduledAt, slug, status, streams, streamsList, tournamentId, winnerId) { 
        ...
        obj['previous_matches'] = previousMatches;
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('previous_matches')) {
                obj['previous_matches'] = ApiClient.convertToType(data['previous_matches'], [PreviousMatch]);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>Bracket</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Bracket</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of Bracket.RequiredProperties) {
        ...
        if (data['previous_matches']) { // data not null
            // ensure the json data is an array
            if (!Array.isArray(data['previous_matches'])) {
                throw new Error("Expected the field `previous_matches` to be an array in the JSON data but got " + data['previous_matches']);
            }
            // validate the optional field `previous_matches` (array)
            for (const item of data['previous_matches']) {
                PreviousMatch.validateJSON(item);
            };
        }
...
Bracket.RequiredProperties = ["begin_at", "detailed_stats", "draw", "end_at", "forfeit", "game_advantage", "games", "id", "live", "live_embed_url", "match_type", "modified_at", "name", "number_of_games", "official_stream_url", "opponents", "original_scheduled_at", "previous_matches", "scheduled_at", "slug", "status", "streams", "streams_list", "tournament_id", "winner_id"];

/**
 * @member {Object} begin_at
 */
Bracket.prototype['begin_at'] = undefined;

/**
 * Whether the match offers full stats
 * @member {Boolean} detailed_stats
 */
Bracket.prototype['detailed_stats'] = undefined;

/**
 * Whether result of the match is a draw
 * @member {Boolean} draw
 */
Bracket.prototype['draw'] = undefined;

/**
 * @member {Object} end_at
 */
Bracket.prototype['end_at'] = undefined;

/**
 * Whether match was forfeited
 * @member {Boolean} forfeit
 */
Bracket.prototype['forfeit'] = undefined;

/**
 * @member {module:model/OpponentID1} game_advantage
 */
Bracket.prototype['game_advantage'] = undefined;

/**
 * @member {Array.<module:model/Game>} games
 */
Bracket.prototype['games'] = undefined;

/**
 * @member {Number} id
 */
Bracket.prototype['id'] = undefined;

/**
 * @member {module:model/MatchLive} live
 */
Bracket.prototype['live'] = undefined;

/**
 * @member {Object} live_embed_url
 */
Bracket.prototype['live_embed_url'] = undefined;

/**
 * @member {module:model/MatchType} match_type
 */
Bracket.prototype['match_type'] = undefined;

/**
 * @member {Date} modified_at
 */
Bracket.prototype['modified_at'] = undefined;

/**
 * @member {String} name
 */
Bracket.prototype['name'] = undefined;

/**
 * Number of games
 * @member {Number} number_of_games
 */
Bracket.prototype['number_of_games'] = undefined;

/**
 * @member {Object} official_stream_url
 */
Bracket.prototype['official_stream_url'] = undefined;

/**
 * @member {Array.<module:model/Opponent>} opponents
 */
Bracket.prototype['opponents'] = undefined;

/**
 * @member {Object} original_scheduled_at
 */
Bracket.prototype['original_scheduled_at'] = undefined;

/**
 * @member {Array.<module:model/PreviousMatch>} previous_matches
 */
Bracket.prototype['previous_matches'] = undefined;

/**
 * @member {Object} scheduled_at
 */
Bracket.prototype['scheduled_at'] = undefined;

/**
 * @member {Object} slug
 */
Bracket.prototype['slug'] = undefined;

/**
 * @member {module:model/MatchStatus} status
 */
Bracket.prototype['status'] = undefined;

/**
 * @member {module:model/MatchLocalizedStreams} streams
 */
Bracket.prototype['streams'] = undefined;

/**
 * @member {Array.<module:model/Stream>} streams_list
 */
Bracket.prototype['streams_list'] = undefined;

/**
 * @member {Number} tournament_id
 */
Bracket.prototype['tournament_id'] = undefined;

/**
 * @member {module:model/OpponentID1} winner_id
 */
Bracket.prototype['winner_id'] = undefined;
