...
/**
 * The BettingBaseTournament model module.
 * @module model/BettingBaseTournament
 * @version 2.23.1
 */
class BettingBaseTournament {
    /**
     * Constructs a new <code>BettingBaseTournament</code>.
     * @alias module:model/BettingBaseTournament
     ...
     */
    constructor(beginAt, endAt, id, leagueId, liveSupported, modifiedAt, name, prizepool, slug, winnerId, winnerType) { 
        
        BettingBaseTournament.initialize(this, beginAt, endAt, id, leagueId, liveSupported, modifiedAt, name, prizepool, slug, winnerId, winnerType);
    }
     ...
     */
    static initialize(obj, beginAt, endAt, id, leagueId, liveSupported, modifiedAt, name, prizepool, slug, winnerId, winnerType) { 
    ...
    /**
     * Constructs a <code>BettingBaseTournament</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/BettingBaseTournament} obj Optional instance to populate.
     * @return {module:model/BettingBaseTournament} The populated <code>BettingBaseTournament</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new BettingBaseTournament();
    ...
    /**
     * Validates the JSON data with respect to <code>BettingBaseTournament</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>BettingBaseTournament</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of BettingBaseTournament.RequiredProperties) {
...
BettingBaseTournament.RequiredProperties = ["begin_at", "end_at", "id", "league_id", "live_supported", "modified_at", "name", "prizepool", "slug", "winner_id", "winner_type"];

/**
 * @member {Object} begin_at
 */
BettingBaseTournament.prototype['begin_at'] = undefined;

/**
 * @member {Object} end_at
 */
BettingBaseTournament.prototype['end_at'] = undefined;

/**
 * @member {Number} id
 */
BettingBaseTournament.prototype['id'] = undefined;

/**
 * @member {Number} league_id
 */
BettingBaseTournament.prototype['league_id'] = undefined;

/**
 * Whether live is supported
 * @member {Boolean} live_supported
 */
BettingBaseTournament.prototype['live_supported'] = undefined;

/**
 * @member {Date} modified_at
 */
BettingBaseTournament.prototype['modified_at'] = undefined;

/**
 * @member {String} name
 */
BettingBaseTournament.prototype['name'] = undefined;

/**
 * @member {Object} prizepool
 */
BettingBaseTournament.prototype['prizepool'] = undefined;

/**
 * @member {String} slug
 */
BettingBaseTournament.prototype['slug'] = undefined;

/**
 * @member {module:model/OpponentID1} winner_id
 */
BettingBaseTournament.prototype['winner_id'] = undefined;

/**
 * @member {Object} winner_type
 */
BettingBaseTournament.prototype['winner_type'] = undefined;
...
export default BettingBaseTournament;
