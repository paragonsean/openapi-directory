...
export default class LivesApi {
    ...
    /**
    * Constructs a new LivesApi. 
    * @alias module:api/LivesApi
    * @class
    ...
    */
    ...
    /**
     * Callback function to receive the result of the getLives_0 operation.
     * @callback module:api/LivesApi~getLives_0Callback
     ...
     * @param {module:api/LivesApi~getLives_0Callback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Array.<module:model/Live>}
     */
    getLives_0(opts, callback) {
      opts = opts || {};
      let postBody = null;
