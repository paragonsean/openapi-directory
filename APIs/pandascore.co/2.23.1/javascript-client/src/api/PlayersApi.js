...
export default class PlayersApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the getPlayersPlayerIdOrSlug operation.
     * @callback module:api/PlayersApi~getPlayersPlayerIdOrSlugCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:model/PlayerIDOrSlug} playerIdOrSlug A player ID or slug
     * @param {module:api/PlayersApi~getPlayersPlayerIdOrSlugCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/Player}
     */
    getPlayersPlayerIdOrSlug(playerIdOrSlug, callback) {
      let postBody = null;
      // verify the required parameter 'playerIdOrSlug' is set
      if (playerIdOrSlug === undefined || playerIdOrSlug === null) {
        throw new Error("Missing the required parameter 'playerIdOrSlug' when calling getPlayersPlayerIdOrSlug");
      }
    ...
    /**
     * Callback function to receive the result of the getPlayersPlayerIdOrSlugMatches operation.
     * @callback module:api/PlayersApi~getPlayersPlayerIdOrSlugMatchesCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:model/GetAdditionsPageParameter} [page] Pagination in the form of `page=2` or `page[size]=30&amp;page[number]=2`
     * @param {Number} [perPage = 50)] Equivalent to `page[size]`
     * @param {module:api/PlayersApi~getPlayersPlayerIdOrSlugMatchesCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Array.<module:model/Match>}
     */
    getPlayersPlayerIdOrSlugMatches(playerIdOrSlug, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'playerIdOrSlug' is set
      if (playerIdOrSlug === undefined || playerIdOrSlug === null) {
        throw new Error("Missing the required parameter 'playerIdOrSlug' when calling getPlayersPlayerIdOrSlugMatches");
      }
      ...
      return this.apiClient.callApi(
        '/players/{player_id_or_slug}/matches', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
