...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PandaScoreRestApiForAllVideogames.IncidentsApi();
  });
  ...
  describe('IncidentsApi', function() {
    describe('getAdditions', function() {
      it('should call getAdditions successfully', function(done) {
        //uncomment below and update the code to test getAdditions
        //instance.getAdditions(function(error) {
    ...
    describe('getDeletions', function() {
      it('should call getDeletions successfully', function(done) {
        //uncomment below and update the code to test getDeletions
        //instance.getDeletions(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
