...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PandaScoreRestApiForAllVideogames.BettingCSGOGame();
  });
  ...
  describe('BettingCSGOGame', function() {
    it('should create an instance of BettingCSGOGame', function() {
      // uncomment below and update the code to test BettingCSGOGame
      //var instance = new PandaScoreRestApiForAllVideogames.BettingCSGOGame();
      //expect(instance).to.be.a(PandaScoreRestApiForAllVideogames.BettingCSGOGame);
    });
    ...
    it('should have the property gameRoundTeams (base name: "game_round_teams")', function() {
      // uncomment below and update the code to test the property gameRoundTeams
      //var instance = new PandaScoreRestApiForAllVideogames.BettingCSGOGame();
      //expect(instance).to.be();
    });
    ...
    it('should have the property numberOfRounds (base name: "number_of_rounds")', function() {
