...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PandaScoreRestApiForAllVideogames.BettingSerie();
  });
  ...
  describe('BettingSerie', function() {
    it('should create an instance of BettingSerie', function() {
      // uncomment below and update the code to test BettingSerie
      //var instance = new PandaScoreRestApiForAllVideogames.BettingSerie();
      //expect(instance).to.be.a(PandaScoreRestApiForAllVideogames.BettingSerie);
    });
    ...
    it('should have the property leagueImageUrl (base name: "league_image_url")', function() {
      // uncomment below and update the code to test the property leagueImageUrl
      //var instance = new PandaScoreRestApiForAllVideogames.BettingSerie();
      //expect(instance).to.be();
    });

    it('should have the property leagueName (base name: "league_name")', function() {
      // uncomment below and update the code to test the property leagueName
      //var instance = new PandaScoreRestApiForAllVideogames.BettingSerie();
      //expect(instance).to.be();
    });
