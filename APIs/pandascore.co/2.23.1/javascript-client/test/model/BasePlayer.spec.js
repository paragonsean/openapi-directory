...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PandaScoreRestApiForAllVideogames.BasePlayer();
  });
  ...
  describe('BasePlayer', function() {
    it('should create an instance of BasePlayer', function() {
      // uncomment below and update the code to test BasePlayer
      //var instance = new PandaScoreRestApiForAllVideogames.BasePlayer();
      //expect(instance).to.be.a(PandaScoreRestApiForAllVideogames.BasePlayer);
    });
