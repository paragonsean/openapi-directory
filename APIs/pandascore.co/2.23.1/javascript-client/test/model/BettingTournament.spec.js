...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PandaScoreRestApiForAllVideogames.BettingTournament();
  });
  ...
  describe('BettingTournament', function() {
    it('should create an instance of BettingTournament', function() {
      // uncomment below and update the code to test BettingTournament
      //var instance = new PandaScoreRestApiForAllVideogames.BettingTournament();
      //expect(instance).to.be.a(PandaScoreRestApiForAllVideogames.BettingTournament);
    });
    ...
    it('should have the property liveSupported (base name: "live_supported")', function() {
      // uncomment below and update the code to test the property liveSupported
      //var instance = new PandaScoreRestApiForAllVideogames.BettingTournament();
      //expect(instance).to.be();
    });
    ...
    it('should have the property prizepool (base name: "prizepool")', function() {
      // uncomment below and update the code to test the property prizepool
      //var instance = new PandaScoreRestApiForAllVideogames.BettingTournament();
      //expect(instance).to.be();
    });
    ...
    it('should have the property winnerType (base name: "winner_type")', function() {
      // uncomment below and update the code to test the property winnerType
      //var instance = new PandaScoreRestApiForAllVideogames.BettingTournament();
      //expect(instance).to.be();
    });
