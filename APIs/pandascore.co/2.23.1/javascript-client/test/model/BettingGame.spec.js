...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PandaScoreRestApiForAllVideogames.BettingGame();
  });
  ...
  describe('BettingGame', function() {
    it('should create an instance of BettingGame', function() {
      // uncomment below and update the code to test BettingGame
      //var instance = new PandaScoreRestApiForAllVideogames.BettingGame();
      //expect(instance).to.be.a(PandaScoreRestApiForAllVideogames.BettingGame);
    });
