...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PandaScoreRestApiForAllVideogames.BettingLoLGame();
  });
  ...
  describe('BettingLoLGame', function() {
    it('should create an instance of BettingLoLGame', function() {
      // uncomment below and update the code to test BettingLoLGame
      //var instance = new PandaScoreRestApiForAllVideogames.BettingLoLGame();
      //expect(instance).to.be.a(PandaScoreRestApiForAllVideogames.BettingLoLGame);
    });
    ...
    it('should have the property gameTeams (base name: "game_teams")', function() {
      // uncomment below and update the code to test the property gameTeams
      //var instance = new PandaScoreRestApiForAllVideogames.BettingLoLGame();
      //expect(instance).to.be();
    });
