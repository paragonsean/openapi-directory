...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PandaScoreRestApiForAllVideogames.FilterOverSeries();
  });
  ...
  describe('FilterOverSeries', function() {
    it('should create an instance of FilterOverSeries', function() {
      // uncomment below and update the code to test FilterOverSeries
      //var instance = new PandaScoreRestApiForAllVideogames.FilterOverSeries();
      //expect(instance).to.be.a(PandaScoreRestApiForAllVideogames.FilterOverSeries);
    });
