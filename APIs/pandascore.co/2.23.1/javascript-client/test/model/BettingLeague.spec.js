...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PandaScoreRestApiForAllVideogames.BettingLeague();
  });
  ...
  describe('BettingLeague', function() {
    it('should create an instance of BettingLeague', function() {
      // uncomment below and update the code to test BettingLeague
      //var instance = new PandaScoreRestApiForAllVideogames.BettingLeague();
      //expect(instance).to.be.a(PandaScoreRestApiForAllVideogames.BettingLeague);
    });
