...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PandaScoreRestApiForAllVideogames.BettingLeague1();
  });
  ...
  describe('BettingLeague1', function() {
    it('should create an instance of BettingLeague1', function() {
      // uncomment below and update the code to test BettingLeague1
      //var instance = new PandaScoreRestApiForAllVideogames.BettingLeague1();
      //expect(instance).to.be.a(PandaScoreRestApiForAllVideogames.BettingLeague1);
    });
