...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PandaScoreRestApiForAllVideogames.DeletionIncident();
  });
  ...
  describe('DeletionIncident', function() {
    it('should create an instance of DeletionIncident', function() {
      // uncomment below and update the code to test DeletionIncident
      //var instance = new PandaScoreRestApiForAllVideogames.DeletionIncident();
      //expect(instance).to.be.a(PandaScoreRestApiForAllVideogames.DeletionIncident);
    });
