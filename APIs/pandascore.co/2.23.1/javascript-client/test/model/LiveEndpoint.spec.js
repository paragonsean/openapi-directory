...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PandaScoreRestApiForAllVideogames.LiveEndpoint();
  });
  ...
  describe('LiveEndpoint', function() {
    it('should create an instance of LiveEndpoint', function() {
      // uncomment below and update the code to test LiveEndpoint
      //var instance = new PandaScoreRestApiForAllVideogames.LiveEndpoint();
      //expect(instance).to.be.a(PandaScoreRestApiForAllVideogames.LiveEndpoint);
    });
    ...
    it('should have the property expectedBeginAt (base name: "expected_begin_at")', function() {
      // uncomment below and update the code to test the property expectedBeginAt
      //var instance = new PandaScoreRestApiForAllVideogames.LiveEndpoint();
      //expect(instance).to.be();
    });
