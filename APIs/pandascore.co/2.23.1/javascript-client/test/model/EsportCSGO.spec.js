...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PandaScoreRestApiForAllVideogames.EsportCSGO();
  });
  ...
  describe('EsportCSGO', function() {
    it('should create an instance of EsportCSGO', function() {
      // uncomment below and update the code to test EsportCSGO
      //var instance = new PandaScoreRestApiForAllVideogames.EsportCSGO();
      //expect(instance).to.be.a(PandaScoreRestApiForAllVideogames.EsportCSGO);
    });
