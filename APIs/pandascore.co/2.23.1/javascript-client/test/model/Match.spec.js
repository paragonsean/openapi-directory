...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PandaScoreRestApiForAllVideogames.Match();
  });
  ...
  describe('Match', function() {
    it('should create an instance of Match', function() {
      ...
      //var instance = new PandaScoreRestApiForAllVideogames.Match();
      //expect(instance).to.be.a(PandaScoreRestApiForAllVideogames.Match);
    });
