...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PandaScoreRestApiForAllVideogames.RangeOverMatches();
  });
  ...
  describe('RangeOverMatches', function() {
    it('should create an instance of RangeOverMatches', function() {
      // uncomment below and update the code to test RangeOverMatches
      //var instance = new PandaScoreRestApiForAllVideogames.RangeOverMatches();
      //expect(instance).to.be.a(PandaScoreRestApiForAllVideogames.RangeOverMatches);
    });
