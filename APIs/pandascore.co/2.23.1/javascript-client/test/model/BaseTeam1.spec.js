...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PandaScoreRestApiForAllVideogames.BaseTeam1();
  });
  ...
  describe('BaseTeam1', function() {
    it('should create an instance of BaseTeam1', function() {
      // uncomment below and update the code to test BaseTeam1
      //var instance = new PandaScoreRestApiForAllVideogames.BaseTeam1();
      //expect(instance).to.be.a(PandaScoreRestApiForAllVideogames.BaseTeam1);
    });
