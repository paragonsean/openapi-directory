...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PandaScoreRestApiForAllVideogames.EsportOverwatch();
  });
  ...
  describe('EsportOverwatch', function() {
    it('should create an instance of EsportOverwatch', function() {
      // uncomment below and update the code to test EsportOverwatch
      //var instance = new PandaScoreRestApiForAllVideogames.EsportOverwatch();
      //expect(instance).to.be.a(PandaScoreRestApiForAllVideogames.EsportOverwatch);
    });
