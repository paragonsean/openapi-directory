...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PandaScoreRestApiForAllVideogames.SearchOverBrackets();
  });
  ...
  describe('SearchOverBrackets', function() {
    it('should create an instance of SearchOverBrackets', function() {
      // uncomment below and update the code to test SearchOverBrackets
      //var instance = new PandaScoreRestApiForAllVideogames.SearchOverBrackets();
      //expect(instance).to.be.a(PandaScoreRestApiForAllVideogames.SearchOverBrackets);
    });
