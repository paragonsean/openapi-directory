...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PandaScoreRestApiForAllVideogames.MatchMarkets();
  });
  ...
  describe('MatchMarkets', function() {
    it('should create an instance of MatchMarkets', function() {
      // uncomment below and update the code to test MatchMarkets
      //var instance = new PandaScoreRestApiForAllVideogames.MatchMarkets();
      //expect(instance).to.be.a(PandaScoreRestApiForAllVideogames.MatchMarkets);
    });
