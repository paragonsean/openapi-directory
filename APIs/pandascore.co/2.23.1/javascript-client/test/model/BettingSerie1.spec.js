...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PandaScoreRestApiForAllVideogames.BettingSerie1();
  });
  ...
  describe('BettingSerie1', function() {
    it('should create an instance of BettingSerie1', function() {
      // uncomment below and update the code to test BettingSerie1
      //var instance = new PandaScoreRestApiForAllVideogames.BettingSerie1();
      //expect(instance).to.be.a(PandaScoreRestApiForAllVideogames.BettingSerie1);
    });
