...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PandaScoreRestApiForAllVideogames.Standing();
  });
  ...
  describe('Standing', function() {
    it('should create an instance of Standing', function() {
      ...
      //var instance = new PandaScoreRestApiForAllVideogames.Standing();
      //expect(instance).to.be.a(PandaScoreRestApiForAllVideogames.Standing);
    });
