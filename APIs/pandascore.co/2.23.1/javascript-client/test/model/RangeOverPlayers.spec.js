...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PandaScoreRestApiForAllVideogames.RangeOverPlayers();
  });
  ...
  describe('RangeOverPlayers', function() {
    it('should create an instance of RangeOverPlayers', function() {
      // uncomment below and update the code to test RangeOverPlayers
      //var instance = new PandaScoreRestApiForAllVideogames.RangeOverPlayers();
      //expect(instance).to.be.a(PandaScoreRestApiForAllVideogames.RangeOverPlayers);
    });
