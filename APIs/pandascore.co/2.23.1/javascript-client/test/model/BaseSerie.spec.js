...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PandaScoreRestApiForAllVideogames.BaseSerie();
  });
  ...
  describe('BaseSerie', function() {
    it('should create an instance of BaseSerie', function() {
      // uncomment below and update the code to test BaseSerie
      //var instance = new PandaScoreRestApiForAllVideogames.BaseSerie();
      //expect(instance).to.be.a(PandaScoreRestApiForAllVideogames.BaseSerie);
    });
