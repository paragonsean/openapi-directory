...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PandaScoreRestApiForAllVideogames.EsportRocketLeague();
  });
  ...
  describe('EsportRocketLeague', function() {
    it('should create an instance of EsportRocketLeague', function() {
      // uncomment below and update the code to test EsportRocketLeague
      //var instance = new PandaScoreRestApiForAllVideogames.EsportRocketLeague();
      //expect(instance).to.be.a(PandaScoreRestApiForAllVideogames.EsportRocketLeague);
    });
