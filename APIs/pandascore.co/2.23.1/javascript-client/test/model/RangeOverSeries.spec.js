...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PandaScoreRestApiForAllVideogames.RangeOverSeries();
  });
  ...
  describe('RangeOverSeries', function() {
    it('should create an instance of RangeOverSeries', function() {
      // uncomment below and update the code to test RangeOverSeries
      //var instance = new PandaScoreRestApiForAllVideogames.RangeOverSeries();
      //expect(instance).to.be.a(PandaScoreRestApiForAllVideogames.RangeOverSeries);
    });
