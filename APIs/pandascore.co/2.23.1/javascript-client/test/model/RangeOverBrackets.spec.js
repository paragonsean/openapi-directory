...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PandaScoreRestApiForAllVideogames.RangeOverBrackets();
  });
  ...
  describe('RangeOverBrackets', function() {
    it('should create an instance of RangeOverBrackets', function() {
      // uncomment below and update the code to test RangeOverBrackets
      //var instance = new PandaScoreRestApiForAllVideogames.RangeOverBrackets();
      //expect(instance).to.be.a(PandaScoreRestApiForAllVideogames.RangeOverBrackets);
    });
