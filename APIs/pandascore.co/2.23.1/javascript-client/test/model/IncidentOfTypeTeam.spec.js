...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PandaScoreRestApiForAllVideogames.IncidentOfTypeTeam();
  });
  ...
  describe('IncidentOfTypeTeam', function() {
    it('should create an instance of IncidentOfTypeTeam', function() {
      // uncomment below and update the code to test IncidentOfTypeTeam
      //var instance = new PandaScoreRestApiForAllVideogames.IncidentOfTypeTeam();
      //expect(instance).to.be.a(PandaScoreRestApiForAllVideogames.IncidentOfTypeTeam);
    });
