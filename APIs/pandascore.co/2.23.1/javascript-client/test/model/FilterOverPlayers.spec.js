...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PandaScoreRestApiForAllVideogames.FilterOverPlayers();
  });
  ...
  describe('FilterOverPlayers', function() {
    it('should create an instance of FilterOverPlayers', function() {
      // uncomment below and update the code to test FilterOverPlayers
      //var instance = new PandaScoreRestApiForAllVideogames.FilterOverPlayers();
      //expect(instance).to.be.a(PandaScoreRestApiForAllVideogames.FilterOverPlayers);
    });
