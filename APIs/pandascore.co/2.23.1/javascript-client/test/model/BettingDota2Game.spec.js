...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PandaScoreRestApiForAllVideogames.BettingDota2Game();
  });
  ...
  describe('BettingDota2Game', function() {
    it('should create an instance of BettingDota2Game', function() {
      // uncomment below and update the code to test BettingDota2Game
      //var instance = new PandaScoreRestApiForAllVideogames.BettingDota2Game();
      //expect(instance).to.be.a(PandaScoreRestApiForAllVideogames.BettingDota2Game);
    });
