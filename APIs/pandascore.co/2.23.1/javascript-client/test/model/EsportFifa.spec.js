...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PandaScoreRestApiForAllVideogames.EsportFifa();
  });
  ...
  describe('EsportFifa', function() {
    it('should create an instance of EsportFifa', function() {
      // uncomment below and update the code to test EsportFifa
      //var instance = new PandaScoreRestApiForAllVideogames.EsportFifa();
      //expect(instance).to.be.a(PandaScoreRestApiForAllVideogames.EsportFifa);
    });
