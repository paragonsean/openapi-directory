...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PandaScoreRestApiForAllVideogames.EsportLoL();
  });
  ...
  describe('EsportLoL', function() {
    it('should create an instance of EsportLoL', function() {
      // uncomment below and update the code to test EsportLoL
      //var instance = new PandaScoreRestApiForAllVideogames.EsportLoL();
      //expect(instance).to.be.a(PandaScoreRestApiForAllVideogames.EsportLoL);
    });
