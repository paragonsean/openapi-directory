...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PandaScoreRestApiForAllVideogames.LiveEvent();
  });
  ...
  describe('LiveEvent', function() {
    it('should create an instance of LiveEvent', function() {
      // uncomment below and update the code to test LiveEvent
      //var instance = new PandaScoreRestApiForAllVideogames.LiveEvent();
      //expect(instance).to.be.a(PandaScoreRestApiForAllVideogames.LiveEvent);
    });
