...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PandaScoreRestApiForAllVideogames.Stream();
  });
  ...
  describe('Stream', function() {
    it('should create an instance of Stream', function() {
      ...
      //var instance = new PandaScoreRestApiForAllVideogames.Stream();
      //expect(instance).to.be.a(PandaScoreRestApiForAllVideogames.Stream);
    });
