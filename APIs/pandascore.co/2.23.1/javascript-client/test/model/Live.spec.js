...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PandaScoreRestApiForAllVideogames.Live();
  });
  ...
  describe('Live', function() {
    it('should create an instance of Live', function() {
      // uncomment below and update the code to test Live
      //var instance = new PandaScoreRestApiForAllVideogames.Live();
      //expect(instance).to.be.a(PandaScoreRestApiForAllVideogames.Live);
    });
