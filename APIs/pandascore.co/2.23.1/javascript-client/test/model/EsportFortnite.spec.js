...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PandaScoreRestApiForAllVideogames.EsportFortnite();
  });
  ...
  describe('EsportFortnite', function() {
    it('should create an instance of EsportFortnite', function() {
      // uncomment below and update the code to test EsportFortnite
      //var instance = new PandaScoreRestApiForAllVideogames.EsportFortnite();
      //expect(instance).to.be.a(PandaScoreRestApiForAllVideogames.EsportFortnite);
    });
