...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PandaScoreRestApiForAllVideogames.EsportR6siege();
  });
  ...
  describe('EsportR6siege', function() {
    it('should create an instance of EsportR6siege', function() {
      // uncomment below and update the code to test EsportR6siege
      //var instance = new PandaScoreRestApiForAllVideogames.EsportR6siege();
      //expect(instance).to.be.a(PandaScoreRestApiForAllVideogames.EsportR6siege);
    });
