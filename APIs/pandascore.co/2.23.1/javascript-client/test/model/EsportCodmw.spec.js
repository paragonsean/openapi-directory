...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PandaScoreRestApiForAllVideogames.EsportCodmw();
  });
  ...
  describe('EsportCodmw', function() {
    it('should create an instance of EsportCodmw', function() {
      // uncomment below and update the code to test EsportCodmw
      //var instance = new PandaScoreRestApiForAllVideogames.EsportCodmw();
      //expect(instance).to.be.a(PandaScoreRestApiForAllVideogames.EsportCodmw);
    });
