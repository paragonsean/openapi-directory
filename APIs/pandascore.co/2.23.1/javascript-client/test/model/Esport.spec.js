...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PandaScoreRestApiForAllVideogames.Esport();
  });
  ...
  describe('Esport', function() {
    it('should create an instance of Esport', function() {
      // uncomment below and update the code to test Esport
      //var instance = new PandaScoreRestApiForAllVideogames.Esport();
      //expect(instance).to.be.a(PandaScoreRestApiForAllVideogames.Esport);
    });
