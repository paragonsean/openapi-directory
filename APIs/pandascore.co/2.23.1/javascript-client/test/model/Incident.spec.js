...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PandaScoreRestApiForAllVideogames.Incident();
  });
  ...
  describe('Incident', function() {
    it('should create an instance of Incident', function() {
      ...
      //var instance = new PandaScoreRestApiForAllVideogames.Incident();
      //expect(instance).to.be.a(PandaScoreRestApiForAllVideogames.Incident);
    });
