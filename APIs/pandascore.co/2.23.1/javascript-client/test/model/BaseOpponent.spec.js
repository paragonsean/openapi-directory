...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PandaScoreRestApiForAllVideogames.BaseOpponent();
  });
  ...
  describe('BaseOpponent', function() {
    it('should create an instance of BaseOpponent', function() {
      // uncomment below and update the code to test BaseOpponent
      //var instance = new PandaScoreRestApiForAllVideogames.BaseOpponent();
      //expect(instance).to.be.a(PandaScoreRestApiForAllVideogames.BaseOpponent);
    });
