...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PandaScoreRestApiForAllVideogames.EsportPUBG();
  });
  ...
  describe('EsportPUBG', function() {
    it('should create an instance of EsportPUBG', function() {
      // uncomment below and update the code to test EsportPUBG
      //var instance = new PandaScoreRestApiForAllVideogames.EsportPUBG();
      //expect(instance).to.be.a(PandaScoreRestApiForAllVideogames.EsportPUBG);
    });
