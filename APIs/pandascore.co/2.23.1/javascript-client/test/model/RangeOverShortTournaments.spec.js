...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PandaScoreRestApiForAllVideogames.RangeOverShortTournaments();
  });
  ...
  describe('RangeOverShortTournaments', function() {
    it('should create an instance of RangeOverShortTournaments', function() {
      // uncomment below and update the code to test RangeOverShortTournaments
      //var instance = new PandaScoreRestApiForAllVideogames.RangeOverShortTournaments();
      //expect(instance).to.be.a(PandaScoreRestApiForAllVideogames.RangeOverShortTournaments);
    });
