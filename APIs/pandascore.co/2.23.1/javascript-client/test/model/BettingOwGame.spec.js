...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PandaScoreRestApiForAllVideogames.BettingOwGame();
  });
  ...
  describe('BettingOwGame', function() {
    it('should create an instance of BettingOwGame', function() {
      // uncomment below and update the code to test BettingOwGame
      //var instance = new PandaScoreRestApiForAllVideogames.BettingOwGame();
      //expect(instance).to.be.a(PandaScoreRestApiForAllVideogames.BettingOwGame);
    });
