...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PandaScoreRestApiForAllVideogames.Bracket();
  });
  ...
  describe('Bracket', function() {
    it('should create an instance of Bracket', function() {
      ...
      //var instance = new PandaScoreRestApiForAllVideogames.Bracket();
      //expect(instance).to.be.a(PandaScoreRestApiForAllVideogames.Bracket);
    });
    ...
    it('should have the property previousMatches (base name: "previous_matches")', function() {
      // uncomment below and update the code to test the property previousMatches
      //var instance = new PandaScoreRestApiForAllVideogames.Bracket();
      //expect(instance).to.be();
    });
