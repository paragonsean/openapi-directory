...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PandaScoreRestApiForAllVideogames.EsportDota2();
  });
  ...
  describe('EsportDota2', function() {
    it('should create an instance of EsportDota2', function() {
      // uncomment below and update the code to test EsportDota2
      //var instance = new PandaScoreRestApiForAllVideogames.EsportDota2();
      //expect(instance).to.be.a(PandaScoreRestApiForAllVideogames.EsportDota2);
    });
