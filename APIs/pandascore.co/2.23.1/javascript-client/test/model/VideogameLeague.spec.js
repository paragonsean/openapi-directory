...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PandaScoreRestApiForAllVideogames.VideogameLeague();
  });
  ...
  describe('VideogameLeague', function() {
    it('should create an instance of VideogameLeague', function() {
      // uncomment below and update the code to test VideogameLeague
      //var instance = new PandaScoreRestApiForAllVideogames.VideogameLeague();
      //expect(instance).to.be.a(PandaScoreRestApiForAllVideogames.VideogameLeague);
    });
