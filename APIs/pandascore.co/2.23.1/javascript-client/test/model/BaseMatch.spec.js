...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PandaScoreRestApiForAllVideogames.BaseMatch();
  });
  ...
  describe('BaseMatch', function() {
    it('should create an instance of BaseMatch', function() {
      // uncomment below and update the code to test BaseMatch
      //var instance = new PandaScoreRestApiForAllVideogames.BaseMatch();
      //expect(instance).to.be.a(PandaScoreRestApiForAllVideogames.BaseMatch);
    });
