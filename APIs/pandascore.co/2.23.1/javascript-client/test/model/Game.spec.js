...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PandaScoreRestApiForAllVideogames.Game();
  });
  ...
  describe('Game', function() {
    it('should create an instance of Game', function() {
      ...
      //var instance = new PandaScoreRestApiForAllVideogames.Game();
      //expect(instance).to.be.a(PandaScoreRestApiForAllVideogames.Game);
    });
