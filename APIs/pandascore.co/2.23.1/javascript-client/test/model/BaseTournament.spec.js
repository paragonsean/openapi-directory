...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PandaScoreRestApiForAllVideogames.BaseTournament();
  });
  ...
  describe('BaseTournament', function() {
    it('should create an instance of BaseTournament', function() {
      // uncomment below and update the code to test BaseTournament
      //var instance = new PandaScoreRestApiForAllVideogames.BaseTournament();
      //expect(instance).to.be.a(PandaScoreRestApiForAllVideogames.BaseTournament);
    });
