...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PandaScoreRestApiForAllVideogames.ShortTournament();
  });
  ...
  describe('ShortTournament', function() {
    it('should create an instance of ShortTournament', function() {
      // uncomment below and update the code to test ShortTournament
      //var instance = new PandaScoreRestApiForAllVideogames.ShortTournament();
      //expect(instance).to.be.a(PandaScoreRestApiForAllVideogames.ShortTournament);
    });
