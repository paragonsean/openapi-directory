...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PandaScoreRestApiForAllVideogames.MatchOpponentBasePlayer();
  });
  ...
  describe('MatchOpponentBasePlayer', function() {
    it('should create an instance of MatchOpponentBasePlayer', function() {
      // uncomment below and update the code to test MatchOpponentBasePlayer
      //var instance = new PandaScoreRestApiForAllVideogames.MatchOpponentBasePlayer();
      //expect(instance).to.be.a(PandaScoreRestApiForAllVideogames.MatchOpponentBasePlayer);
    });
