...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PandaScoreRestApiForAllVideogames.GroupStanding();
  });
  ...
  describe('GroupStanding', function() {
    it('should create an instance of GroupStanding', function() {
      // uncomment below and update the code to test GroupStanding
      //var instance = new PandaScoreRestApiForAllVideogames.GroupStanding();
      //expect(instance).to.be.a(PandaScoreRestApiForAllVideogames.GroupStanding);
    });
