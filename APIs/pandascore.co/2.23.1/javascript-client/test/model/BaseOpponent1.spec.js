...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PandaScoreRestApiForAllVideogames.BaseOpponent1();
  });
  ...
  describe('BaseOpponent1', function() {
    it('should create an instance of BaseOpponent1', function() {
      // uncomment below and update the code to test BaseOpponent1
      //var instance = new PandaScoreRestApiForAllVideogames.BaseOpponent1();
      //expect(instance).to.be.a(PandaScoreRestApiForAllVideogames.BaseOpponent1);
    });
