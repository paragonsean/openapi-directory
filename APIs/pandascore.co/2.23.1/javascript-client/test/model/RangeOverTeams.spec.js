...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PandaScoreRestApiForAllVideogames.RangeOverTeams();
  });
  ...
  describe('RangeOverTeams', function() {
    it('should create an instance of RangeOverTeams', function() {
      // uncomment below and update the code to test RangeOverTeams
      //var instance = new PandaScoreRestApiForAllVideogames.RangeOverTeams();
      //expect(instance).to.be.a(PandaScoreRestApiForAllVideogames.RangeOverTeams);
    });
