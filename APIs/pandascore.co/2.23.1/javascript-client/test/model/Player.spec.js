...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PandaScoreRestApiForAllVideogames.Player();
  });
  ...
  describe('Player', function() {
    it('should create an instance of Player', function() {
      ...
      //var instance = new PandaScoreRestApiForAllVideogames.Player();
      //expect(instance).to.be.a(PandaScoreRestApiForAllVideogames.Player);
    });
    ...
    it('should have the property currentTeam (base name: "current_team")', function() {
      // uncomment below and update the code to test the property currentTeam
      //var instance = new PandaScoreRestApiForAllVideogames.Player();
      //expect(instance).to.be();
    });

    it('should have the property currentVideogame (base name: "current_videogame")', function() {
      // uncomment below and update the code to test the property currentVideogame
      //var instance = new PandaScoreRestApiForAllVideogames.Player();
      //expect(instance).to.be();
    });
