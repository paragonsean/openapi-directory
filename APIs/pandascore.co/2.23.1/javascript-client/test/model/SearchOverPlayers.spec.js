...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PandaScoreRestApiForAllVideogames.SearchOverPlayers();
  });
  ...
  describe('SearchOverPlayers', function() {
    it('should create an instance of SearchOverPlayers', function() {
      // uncomment below and update the code to test SearchOverPlayers
      //var instance = new PandaScoreRestApiForAllVideogames.SearchOverPlayers();
      //expect(instance).to.be.a(PandaScoreRestApiForAllVideogames.SearchOverPlayers);
    });
