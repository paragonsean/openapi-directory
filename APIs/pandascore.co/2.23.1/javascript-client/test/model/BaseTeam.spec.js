...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PandaScoreRestApiForAllVideogames.BaseTeam();
  });
  ...
  describe('BaseTeam', function() {
    it('should create an instance of BaseTeam', function() {
      // uncomment below and update the code to test BaseTeam
      //var instance = new PandaScoreRestApiForAllVideogames.BaseTeam();
      //expect(instance).to.be.a(PandaScoreRestApiForAllVideogames.BaseTeam);
    });
