...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PandaScoreRestApiForAllVideogames.LiveEvent1();
  });
  ...
  describe('LiveEvent1', function() {
    it('should create an instance of LiveEvent1', function() {
      // uncomment below and update the code to test LiveEvent1
      //var instance = new PandaScoreRestApiForAllVideogames.LiveEvent1();
      //expect(instance).to.be.a(PandaScoreRestApiForAllVideogames.LiveEvent1);
    });
