...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PandaScoreRestApiForAllVideogames.BettingCSGOGameRoundTeam();
  });
  ...
  describe('BettingCSGOGameRoundTeam', function() {
    it('should create an instance of BettingCSGOGameRoundTeam', function() {
      // uncomment below and update the code to test BettingCSGOGameRoundTeam
      //var instance = new PandaScoreRestApiForAllVideogames.BettingCSGOGameRoundTeam();
      //expect(instance).to.be.a(PandaScoreRestApiForAllVideogames.BettingCSGOGameRoundTeam);
    });
    ...
    it('should have the property terrorist (base name: "terrorist")', function() {
      // uncomment below and update the code to test the property terrorist
      //var instance = new PandaScoreRestApiForAllVideogames.BettingCSGOGameRoundTeam();
      //expect(instance).to.be();
    });
