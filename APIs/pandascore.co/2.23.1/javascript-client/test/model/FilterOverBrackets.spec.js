...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PandaScoreRestApiForAllVideogames.FilterOverBrackets();
  });
  ...
  describe('FilterOverBrackets', function() {
    it('should create an instance of FilterOverBrackets', function() {
      // uncomment below and update the code to test FilterOverBrackets
      //var instance = new PandaScoreRestApiForAllVideogames.FilterOverBrackets();
      //expect(instance).to.be.a(PandaScoreRestApiForAllVideogames.FilterOverBrackets);
    });
