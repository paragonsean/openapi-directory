...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PandaScoreRestApiForAllVideogames.League();
  });
  ...
  describe('League', function() {
    it('should create an instance of League', function() {
      // uncomment below and update the code to test League
      //var instance = new PandaScoreRestApiForAllVideogames.League();
      //expect(instance).to.be.a(PandaScoreRestApiForAllVideogames.League);
    });
