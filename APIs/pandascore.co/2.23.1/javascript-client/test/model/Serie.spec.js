...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PandaScoreRestApiForAllVideogames.Serie();
  });
  ...
  describe('Serie', function() {
    it('should create an instance of Serie', function() {
      ...
      //var instance = new PandaScoreRestApiForAllVideogames.Serie();
      //expect(instance).to.be.a(PandaScoreRestApiForAllVideogames.Serie);
    });
    ...
    it('should have the property videogameTitle (base name: "videogame_title")', function() {
      // uncomment below and update the code to test the property videogameTitle
      //var instance = new PandaScoreRestApiForAllVideogames.Serie();
      //expect(instance).to.be();
    });
