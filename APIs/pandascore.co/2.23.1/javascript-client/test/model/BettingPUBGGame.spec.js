...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PandaScoreRestApiForAllVideogames.BettingPUBGGame();
  });
  ...
  describe('BettingPUBGGame', function() {
    it('should create an instance of BettingPUBGGame', function() {
      // uncomment below and update the code to test BettingPUBGGame
      //var instance = new PandaScoreRestApiForAllVideogames.BettingPUBGGame();
      //expect(instance).to.be.a(PandaScoreRestApiForAllVideogames.BettingPUBGGame);
    });
