...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PandaScoreRestApiForAllVideogames.MatchResult();
  });
  ...
  describe('MatchResult', function() {
    it('should create an instance of MatchResult', function() {
      ...
      //var instance = new PandaScoreRestApiForAllVideogames.MatchResult();
      //expect(instance).to.be.a(PandaScoreRestApiForAllVideogames.MatchResult);
    });
