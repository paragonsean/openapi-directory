...
OAIBettingOwGame::OAIBettingOwGame(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIBettingOwGame::OAIBettingOwGame() {
    this->initializeModel();
}

OAIBettingOwGame::~OAIBettingOwGame() {}

void OAIBettingOwGame::initializeModel() {
...
void OAIBettingOwGame::fromJson(QString jsonString) {
...
void OAIBettingOwGame::fromJsonObject(QJsonObject json) {
...
QString OAIBettingOwGame::asJson() const {
...
QJsonObject OAIBettingOwGame::asJsonObject() const {
    QJsonObject obj;
    if (m_begin_at.isSet()) {
...
QJsonValue OAIBettingOwGame::getBeginAt() const {
    return m_begin_at;
}
void OAIBettingOwGame::setBeginAt(const QJsonValue &begin_at) {
    m_begin_at = begin_at;
    m_begin_at_isSet = true;
}

bool OAIBettingOwGame::is_begin_at_Set() const{
    return m_begin_at_isSet;
}

bool OAIBettingOwGame::is_begin_at_Valid() const{
    return m_begin_at_isValid;
}

bool OAIBettingOwGame::isComplete() const {
    return m_complete;
}
void OAIBettingOwGame::setComplete(const bool &complete) {
    m_complete = complete;
    m_complete_isSet = true;
}

bool OAIBettingOwGame::is_complete_Set() const{
    return m_complete_isSet;
}

bool OAIBettingOwGame::is_complete_Valid() const{
    return m_complete_isValid;
}

bool OAIBettingOwGame::isDetailedStats() const {
    return m_detailed_stats;
}
void OAIBettingOwGame::setDetailedStats(const bool &detailed_stats) {
    m_detailed_stats = detailed_stats;
    m_detailed_stats_isSet = true;
}

bool OAIBettingOwGame::is_detailed_stats_Set() const{
    return m_detailed_stats_isSet;
}

bool OAIBettingOwGame::is_detailed_stats_Valid() const{
    return m_detailed_stats_isValid;
}

QJsonValue OAIBettingOwGame::getEndAt() const {
    return m_end_at;
}
void OAIBettingOwGame::setEndAt(const QJsonValue &end_at) {
    m_end_at = end_at;
    m_end_at_isSet = true;
}

bool OAIBettingOwGame::is_end_at_Set() const{
    return m_end_at_isSet;
}

bool OAIBettingOwGame::is_end_at_Valid() const{
    return m_end_at_isValid;
}

bool OAIBettingOwGame::isFinished() const {
    return m_finished;
}
void OAIBettingOwGame::setFinished(const bool &finished) {
    m_finished = finished;
    m_finished_isSet = true;
}

bool OAIBettingOwGame::is_finished_Set() const{
    return m_finished_isSet;
}

bool OAIBettingOwGame::is_finished_Valid() const{
    return m_finished_isValid;
}

bool OAIBettingOwGame::isForfeit() const {
    return m_forfeit;
}
void OAIBettingOwGame::setForfeit(const bool &forfeit) {
    m_forfeit = forfeit;
    m_forfeit_isSet = true;
}

bool OAIBettingOwGame::is_forfeit_Set() const{
    return m_forfeit_isSet;
}

bool OAIBettingOwGame::is_forfeit_Valid() const{
    return m_forfeit_isValid;
}

qint32 OAIBettingOwGame::getId() const {
    return m_id;
}
void OAIBettingOwGame::setId(const qint32 &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIBettingOwGame::is_id_Set() const{
    return m_id_isSet;
}

bool OAIBettingOwGame::is_id_Valid() const{
    return m_id_isValid;
}

QJsonValue OAIBettingOwGame::getLength() const {
    return m_length;
}
void OAIBettingOwGame::setLength(const QJsonValue &length) {
    m_length = length;
    m_length_isSet = true;
}

bool OAIBettingOwGame::is_length_Set() const{
    return m_length_isSet;
}

bool OAIBettingOwGame::is_length_Valid() const{
    return m_length_isValid;
}

qint32 OAIBettingOwGame::getMatchId() const {
    return m_match_id;
}
void OAIBettingOwGame::setMatchId(const qint32 &match_id) {
    m_match_id = match_id;
    m_match_id_isSet = true;
}

bool OAIBettingOwGame::is_match_id_Set() const{
    return m_match_id_isSet;
}

bool OAIBettingOwGame::is_match_id_Valid() const{
    return m_match_id_isValid;
}

qint32 OAIBettingOwGame::getPosition() const {
    return m_position;
}
void OAIBettingOwGame::setPosition(const qint32 &position) {
    m_position = position;
    m_position_isSet = true;
}

bool OAIBettingOwGame::is_position_Set() const{
    return m_position_isSet;
}

bool OAIBettingOwGame::is_position_Valid() const{
    return m_position_isValid;
}

OAIGameStatus OAIBettingOwGame::getStatus() const {
    return m_status;
}
void OAIBettingOwGame::setStatus(const OAIGameStatus &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIBettingOwGame::is_status_Set() const{
    return m_status_isSet;
}

bool OAIBettingOwGame::is_status_Valid() const{
    return m_status_isValid;
}

QJsonValue OAIBettingOwGame::getVideoUrl() const {
    return m_video_url;
}
void OAIBettingOwGame::setVideoUrl(const QJsonValue &video_url) {
    m_video_url = video_url;
    m_video_url_isSet = true;
}

bool OAIBettingOwGame::is_video_url_Set() const{
    return m_video_url_isSet;
}

bool OAIBettingOwGame::is_video_url_Valid() const{
    return m_video_url_isValid;
}

OAIGameWinner OAIBettingOwGame::getWinner() const {
    return m_winner;
}
void OAIBettingOwGame::setWinner(const OAIGameWinner &winner) {
    m_winner = winner;
    m_winner_isSet = true;
}

bool OAIBettingOwGame::is_winner_Set() const{
    return m_winner_isSet;
}

bool OAIBettingOwGame::is_winner_Valid() const{
    return m_winner_isValid;
}

QJsonValue OAIBettingOwGame::getWinnerType() const {
    return m_winner_type;
}
void OAIBettingOwGame::setWinnerType(const QJsonValue &winner_type) {
    m_winner_type = winner_type;
    m_winner_type_isSet = true;
}

bool OAIBettingOwGame::is_winner_type_Set() const{
    return m_winner_type_isSet;
}

bool OAIBettingOwGame::is_winner_type_Valid() const{
    return m_winner_type_isValid;
}

bool OAIBettingOwGame::isSet() const {
...
bool OAIBettingOwGame::isValid() const {
