...
OAIBaseMatch OAIStanding::getLastMatch() const {
    return m_last_match;
}
void OAIStanding::setLastMatch(const OAIBaseMatch &last_match) {
    m_last_match = last_match;
    m_last_match_isSet = true;
}

bool OAIStanding::is_last_match_Set() const{
    return m_last_match_isSet;
}

bool OAIStanding::is_last_match_Valid() const{
    return m_last_match_isValid;
}

qint32 OAIStanding::getRank() const {
    return m_rank;
}
void OAIStanding::setRank(const qint32 &rank) {
    m_rank = rank;
    m_rank_isSet = true;
}

bool OAIStanding::is_rank_Set() const{
    return m_rank_isSet;
}

bool OAIStanding::is_rank_Valid() const{
    return m_rank_isValid;
}

OAIBaseTeam OAIStanding::getTeam() const {
    return m_team;
}
void OAIStanding::setTeam(const OAIBaseTeam &team) {
    m_team = team;
    m_team_isSet = true;
}
...
qint32 OAIStanding::getTotal() const {
    return m_total;
}
void OAIStanding::setTotal(const qint32 &total) {
    m_total = total;
    m_total_isSet = true;
}

bool OAIStanding::is_total_Set() const{
    return m_total_isSet;
}

bool OAIStanding::is_total_Valid() const{
...
bool OAIStanding::isValid() const {
    ...
    return m_last_match_isValid && m_rank_isValid && m_team_isValid && m_losses_isValid && m_total_isValid && m_wins_isValid && true;
}
