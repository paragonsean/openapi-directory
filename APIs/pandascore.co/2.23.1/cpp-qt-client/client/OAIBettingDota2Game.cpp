...
OAIBettingDota2Game::OAIBettingDota2Game(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIBettingDota2Game::OAIBettingDota2Game() {
    this->initializeModel();
}

OAIBettingDota2Game::~OAIBettingDota2Game() {}

void OAIBettingDota2Game::initializeModel() {
...
void OAIBettingDota2Game::fromJson(QString jsonString) {
...
void OAIBettingDota2Game::fromJsonObject(QJsonObject json) {
...
QString OAIBettingDota2Game::asJson() const {
...
QJsonObject OAIBettingDota2Game::asJsonObject() const {
    QJsonObject obj;
    if (m_begin_at.isSet()) {
...
QJsonValue OAIBettingDota2Game::getBeginAt() const {
    return m_begin_at;
}
void OAIBettingDota2Game::setBeginAt(const QJsonValue &begin_at) {
    m_begin_at = begin_at;
    m_begin_at_isSet = true;
}

bool OAIBettingDota2Game::is_begin_at_Set() const{
    return m_begin_at_isSet;
}

bool OAIBettingDota2Game::is_begin_at_Valid() const{
    return m_begin_at_isValid;
}

bool OAIBettingDota2Game::isComplete() const {
    return m_complete;
}
void OAIBettingDota2Game::setComplete(const bool &complete) {
    m_complete = complete;
    m_complete_isSet = true;
}

bool OAIBettingDota2Game::is_complete_Set() const{
    return m_complete_isSet;
}

bool OAIBettingDota2Game::is_complete_Valid() const{
    return m_complete_isValid;
}

bool OAIBettingDota2Game::isDetailedStats() const {
    return m_detailed_stats;
}
void OAIBettingDota2Game::setDetailedStats(const bool &detailed_stats) {
    m_detailed_stats = detailed_stats;
    m_detailed_stats_isSet = true;
}

bool OAIBettingDota2Game::is_detailed_stats_Set() const{
    return m_detailed_stats_isSet;
}

bool OAIBettingDota2Game::is_detailed_stats_Valid() const{
    return m_detailed_stats_isValid;
}

QJsonValue OAIBettingDota2Game::getEndAt() const {
    return m_end_at;
}
void OAIBettingDota2Game::setEndAt(const QJsonValue &end_at) {
    m_end_at = end_at;
    m_end_at_isSet = true;
}

bool OAIBettingDota2Game::is_end_at_Set() const{
    return m_end_at_isSet;
}

bool OAIBettingDota2Game::is_end_at_Valid() const{
    return m_end_at_isValid;
}

bool OAIBettingDota2Game::isFinished() const {
    return m_finished;
}
void OAIBettingDota2Game::setFinished(const bool &finished) {
    m_finished = finished;
    m_finished_isSet = true;
}

bool OAIBettingDota2Game::is_finished_Set() const{
    return m_finished_isSet;
}

bool OAIBettingDota2Game::is_finished_Valid() const{
    return m_finished_isValid;
}

bool OAIBettingDota2Game::isForfeit() const {
    return m_forfeit;
}
void OAIBettingDota2Game::setForfeit(const bool &forfeit) {
    m_forfeit = forfeit;
    m_forfeit_isSet = true;
}

bool OAIBettingDota2Game::is_forfeit_Set() const{
    return m_forfeit_isSet;
}

bool OAIBettingDota2Game::is_forfeit_Valid() const{
    return m_forfeit_isValid;
}

qint32 OAIBettingDota2Game::getId() const {
    return m_id;
}
void OAIBettingDota2Game::setId(const qint32 &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIBettingDota2Game::is_id_Set() const{
    return m_id_isSet;
}

bool OAIBettingDota2Game::is_id_Valid() const{
    return m_id_isValid;
}

QJsonValue OAIBettingDota2Game::getLength() const {
    return m_length;
}
void OAIBettingDota2Game::setLength(const QJsonValue &length) {
    m_length = length;
    m_length_isSet = true;
}

bool OAIBettingDota2Game::is_length_Set() const{
    return m_length_isSet;
}

bool OAIBettingDota2Game::is_length_Valid() const{
    return m_length_isValid;
}

qint32 OAIBettingDota2Game::getMatchId() const {
    return m_match_id;
}
void OAIBettingDota2Game::setMatchId(const qint32 &match_id) {
    m_match_id = match_id;
    m_match_id_isSet = true;
}

bool OAIBettingDota2Game::is_match_id_Set() const{
    return m_match_id_isSet;
}

bool OAIBettingDota2Game::is_match_id_Valid() const{
    return m_match_id_isValid;
}

qint32 OAIBettingDota2Game::getPosition() const {
    return m_position;
}
void OAIBettingDota2Game::setPosition(const qint32 &position) {
    m_position = position;
    m_position_isSet = true;
}

bool OAIBettingDota2Game::is_position_Set() const{
    return m_position_isSet;
}

bool OAIBettingDota2Game::is_position_Valid() const{
    return m_position_isValid;
}

OAIGameStatus OAIBettingDota2Game::getStatus() const {
    return m_status;
}
void OAIBettingDota2Game::setStatus(const OAIGameStatus &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIBettingDota2Game::is_status_Set() const{
    return m_status_isSet;
}

bool OAIBettingDota2Game::is_status_Valid() const{
    return m_status_isValid;
}

QJsonValue OAIBettingDota2Game::getVideoUrl() const {
    return m_video_url;
}
void OAIBettingDota2Game::setVideoUrl(const QJsonValue &video_url) {
    m_video_url = video_url;
    m_video_url_isSet = true;
}

bool OAIBettingDota2Game::is_video_url_Set() const{
    return m_video_url_isSet;
}

bool OAIBettingDota2Game::is_video_url_Valid() const{
    return m_video_url_isValid;
}

OAIGameWinner OAIBettingDota2Game::getWinner() const {
    return m_winner;
}
void OAIBettingDota2Game::setWinner(const OAIGameWinner &winner) {
    m_winner = winner;
    m_winner_isSet = true;
}

bool OAIBettingDota2Game::is_winner_Set() const{
    return m_winner_isSet;
}

bool OAIBettingDota2Game::is_winner_Valid() const{
    return m_winner_isValid;
}

QJsonValue OAIBettingDota2Game::getWinnerType() const {
    return m_winner_type;
}
void OAIBettingDota2Game::setWinnerType(const QJsonValue &winner_type) {
    m_winner_type = winner_type;
    m_winner_type_isSet = true;
}

bool OAIBettingDota2Game::is_winner_type_Set() const{
    return m_winner_type_isSet;
}

bool OAIBettingDota2Game::is_winner_type_Valid() const{
    return m_winner_type_isValid;
}

bool OAIBettingDota2Game::isSet() const {
...
bool OAIBettingDota2Game::isValid() const {
