...
/*
 * OAIMatchPlayerResult.h
 *
 * 
 */

#ifndef OAIMatchPlayerResult_H
#define OAIMatchPlayerResult_H
...
class OAIMatchPlayerResult : public OAIObject {
public:
    OAIMatchPlayerResult();
    OAIMatchPlayerResult(QString json);
    ~OAIMatchPlayerResult() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMatchPlayerResult)

#endif // OAIMatchPlayerResult_H
