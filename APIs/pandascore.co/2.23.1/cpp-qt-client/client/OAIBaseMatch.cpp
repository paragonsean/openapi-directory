...
OAIBaseMatch::OAIBaseMatch(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIBaseMatch::OAIBaseMatch() {
    this->initializeModel();
}

OAIBaseMatch::~OAIBaseMatch() {}

void OAIBaseMatch::initializeModel() {
...
void OAIBaseMatch::fromJson(QString jsonString) {
...
void OAIBaseMatch::fromJsonObject(QJsonObject json) {
...
QString OAIBaseMatch::asJson() const {
...
QJsonObject OAIBaseMatch::asJsonObject() const {
    QJsonObject obj;
    if (m_begin_at.isSet()) {
...
QJsonValue OAIBaseMatch::getBeginAt() const {
    return m_begin_at;
}
void OAIBaseMatch::setBeginAt(const QJsonValue &begin_at) {
    m_begin_at = begin_at;
    m_begin_at_isSet = true;
}

bool OAIBaseMatch::is_begin_at_Set() const{
    return m_begin_at_isSet;
}

bool OAIBaseMatch::is_begin_at_Valid() const{
    return m_begin_at_isValid;
}

bool OAIBaseMatch::isDetailedStats() const {
    return m_detailed_stats;
}
void OAIBaseMatch::setDetailedStats(const bool &detailed_stats) {
    m_detailed_stats = detailed_stats;
    m_detailed_stats_isSet = true;
}

bool OAIBaseMatch::is_detailed_stats_Set() const{
    return m_detailed_stats_isSet;
}

bool OAIBaseMatch::is_detailed_stats_Valid() const{
    return m_detailed_stats_isValid;
}

bool OAIBaseMatch::isDraw() const {
    return m_draw;
}
void OAIBaseMatch::setDraw(const bool &draw) {
    m_draw = draw;
    m_draw_isSet = true;
}

bool OAIBaseMatch::is_draw_Set() const{
    return m_draw_isSet;
}

bool OAIBaseMatch::is_draw_Valid() const{
    return m_draw_isValid;
}

QJsonValue OAIBaseMatch::getEndAt() const {
    return m_end_at;
}
void OAIBaseMatch::setEndAt(const QJsonValue &end_at) {
    m_end_at = end_at;
    m_end_at_isSet = true;
}

bool OAIBaseMatch::is_end_at_Set() const{
    return m_end_at_isSet;
}

bool OAIBaseMatch::is_end_at_Valid() const{
    return m_end_at_isValid;
}

bool OAIBaseMatch::isForfeit() const {
    return m_forfeit;
}
void OAIBaseMatch::setForfeit(const bool &forfeit) {
    m_forfeit = forfeit;
    m_forfeit_isSet = true;
}

bool OAIBaseMatch::is_forfeit_Set() const{
    return m_forfeit_isSet;
}

bool OAIBaseMatch::is_forfeit_Valid() const{
    return m_forfeit_isValid;
}

OAIOpponentID_1 OAIBaseMatch::getGameAdvantage() const {
    return m_game_advantage;
}
void OAIBaseMatch::setGameAdvantage(const OAIOpponentID_1 &game_advantage) {
    m_game_advantage = game_advantage;
    m_game_advantage_isSet = true;
}

bool OAIBaseMatch::is_game_advantage_Set() const{
    return m_game_advantage_isSet;
}

bool OAIBaseMatch::is_game_advantage_Valid() const{
    return m_game_advantage_isValid;
}

qint32 OAIBaseMatch::getId() const {
    return m_id;
}
void OAIBaseMatch::setId(const qint32 &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIBaseMatch::is_id_Set() const{
    return m_id_isSet;
}

bool OAIBaseMatch::is_id_Valid() const{
    return m_id_isValid;
}

OAIMatchLive OAIBaseMatch::getLive() const {
    return m_live;
}
void OAIBaseMatch::setLive(const OAIMatchLive &live) {
    m_live = live;
    m_live_isSet = true;
}

bool OAIBaseMatch::is_live_Set() const{
    return m_live_isSet;
}

bool OAIBaseMatch::is_live_Valid() const{
    return m_live_isValid;
}

QJsonValue OAIBaseMatch::getLiveEmbedUrl() const {
    return m_live_embed_url;
}
void OAIBaseMatch::setLiveEmbedUrl(const QJsonValue &live_embed_url) {
    m_live_embed_url = live_embed_url;
    m_live_embed_url_isSet = true;
}

bool OAIBaseMatch::is_live_embed_url_Set() const{
    return m_live_embed_url_isSet;
}

bool OAIBaseMatch::is_live_embed_url_Valid() const{
    return m_live_embed_url_isValid;
}

OAIMatchType OAIBaseMatch::getMatchType() const {
    return m_match_type;
}
void OAIBaseMatch::setMatchType(const OAIMatchType &match_type) {
    m_match_type = match_type;
    m_match_type_isSet = true;
}

bool OAIBaseMatch::is_match_type_Set() const{
    return m_match_type_isSet;
}

bool OAIBaseMatch::is_match_type_Valid() const{
    return m_match_type_isValid;
}

QDateTime OAIBaseMatch::getModifiedAt() const {
    return m_modified_at;
}
void OAIBaseMatch::setModifiedAt(const QDateTime &modified_at) {
    m_modified_at = modified_at;
    m_modified_at_isSet = true;
}

bool OAIBaseMatch::is_modified_at_Set() const{
    return m_modified_at_isSet;
}

bool OAIBaseMatch::is_modified_at_Valid() const{
    return m_modified_at_isValid;
}

QString OAIBaseMatch::getName() const {
    return m_name;
}
void OAIBaseMatch::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIBaseMatch::is_name_Set() const{
    return m_name_isSet;
}

bool OAIBaseMatch::is_name_Valid() const{
    return m_name_isValid;
}

qint32 OAIBaseMatch::getNumberOfGames() const {
    return m_number_of_games;
}
void OAIBaseMatch::setNumberOfGames(const qint32 &number_of_games) {
    m_number_of_games = number_of_games;
    m_number_of_games_isSet = true;
}

bool OAIBaseMatch::is_number_of_games_Set() const{
    return m_number_of_games_isSet;
}

bool OAIBaseMatch::is_number_of_games_Valid() const{
    return m_number_of_games_isValid;
}

QJsonValue OAIBaseMatch::getOfficialStreamUrl() const {
    return m_official_stream_url;
}
void OAIBaseMatch::setOfficialStreamUrl(const QJsonValue &official_stream_url) {
    m_official_stream_url = official_stream_url;
    m_official_stream_url_isSet = true;
}

bool OAIBaseMatch::is_official_stream_url_Set() const{
    return m_official_stream_url_isSet;
}

bool OAIBaseMatch::is_official_stream_url_Valid() const{
    return m_official_stream_url_isValid;
}

QJsonValue OAIBaseMatch::getOriginalScheduledAt() const {
    return m_original_scheduled_at;
}
void OAIBaseMatch::setOriginalScheduledAt(const QJsonValue &original_scheduled_at) {
    m_original_scheduled_at = original_scheduled_at;
    m_original_scheduled_at_isSet = true;
}

bool OAIBaseMatch::is_original_scheduled_at_Set() const{
    return m_original_scheduled_at_isSet;
}

bool OAIBaseMatch::is_original_scheduled_at_Valid() const{
    return m_original_scheduled_at_isValid;
}

QJsonValue OAIBaseMatch::getRescheduled() const {
    return m_rescheduled;
}
void OAIBaseMatch::setRescheduled(const QJsonValue &rescheduled) {
    m_rescheduled = rescheduled;
    m_rescheduled_isSet = true;
}

bool OAIBaseMatch::is_rescheduled_Set() const{
    return m_rescheduled_isSet;
}

bool OAIBaseMatch::is_rescheduled_Valid() const{
    return m_rescheduled_isValid;
}

QJsonValue OAIBaseMatch::getScheduledAt() const {
    return m_scheduled_at;
}
void OAIBaseMatch::setScheduledAt(const QJsonValue &scheduled_at) {
    m_scheduled_at = scheduled_at;
    m_scheduled_at_isSet = true;
}

bool OAIBaseMatch::is_scheduled_at_Set() const{
    return m_scheduled_at_isSet;
}

bool OAIBaseMatch::is_scheduled_at_Valid() const{
    return m_scheduled_at_isValid;
}

QJsonValue OAIBaseMatch::getSlug() const {
    return m_slug;
}
void OAIBaseMatch::setSlug(const QJsonValue &slug) {
    m_slug = slug;
    m_slug_isSet = true;
}

bool OAIBaseMatch::is_slug_Set() const{
    return m_slug_isSet;
}

bool OAIBaseMatch::is_slug_Valid() const{
    return m_slug_isValid;
}

OAIMatchStatus OAIBaseMatch::getStatus() const {
    return m_status;
}
void OAIBaseMatch::setStatus(const OAIMatchStatus &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIBaseMatch::is_status_Set() const{
    return m_status_isSet;
}

bool OAIBaseMatch::is_status_Valid() const{
    return m_status_isValid;
}

OAIMatchLocalizedStreams OAIBaseMatch::getStreams() const {
    return m_streams;
}
void OAIBaseMatch::setStreams(const OAIMatchLocalizedStreams &streams) {
    m_streams = streams;
    m_streams_isSet = true;
}

bool OAIBaseMatch::is_streams_Set() const{
    return m_streams_isSet;
}

bool OAIBaseMatch::is_streams_Valid() const{
    return m_streams_isValid;
}

QList<OAIStream> OAIBaseMatch::getStreamsList() const {
    return m_streams_list;
}
void OAIBaseMatch::setStreamsList(const QList<OAIStream> &streams_list) {
    m_streams_list = streams_list;
    m_streams_list_isSet = true;
}

bool OAIBaseMatch::is_streams_list_Set() const{
    return m_streams_list_isSet;
}

bool OAIBaseMatch::is_streams_list_Valid() const{
    return m_streams_list_isValid;
}

qint32 OAIBaseMatch::getTournamentId() const {
    return m_tournament_id;
}
void OAIBaseMatch::setTournamentId(const qint32 &tournament_id) {
    m_tournament_id = tournament_id;
    m_tournament_id_isSet = true;
}

bool OAIBaseMatch::is_tournament_id_Set() const{
    return m_tournament_id_isSet;
}

bool OAIBaseMatch::is_tournament_id_Valid() const{
    return m_tournament_id_isValid;
}

OAIOpponentID_1 OAIBaseMatch::getWinnerId() const {
    return m_winner_id;
}
void OAIBaseMatch::setWinnerId(const OAIOpponentID_1 &winner_id) {
    m_winner_id = winner_id;
    m_winner_id_isSet = true;
}

bool OAIBaseMatch::is_winner_id_Set() const{
    return m_winner_id_isSet;
}

bool OAIBaseMatch::is_winner_id_Valid() const{
    return m_winner_id_isValid;
}

bool OAIBaseMatch::isSet() const {
...
bool OAIBaseMatch::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_begin_at_isValid && m_detailed_stats_isValid && m_draw_isValid && m_end_at_isValid && m_forfeit_isValid && m_game_advantage_isValid && m_id_isValid && m_live_isValid && m_live_embed_url_isValid && m_match_type_isValid && m_modified_at_isValid && m_name_isValid && m_number_of_games_isValid && m_official_stream_url_isValid && m_original_scheduled_at_isValid && m_rescheduled_isValid && m_scheduled_at_isValid && m_slug_isValid && m_status_isValid && m_streams_isValid && m_streams_list_isValid && m_tournament_id_isValid && m_winner_id_isValid && true;
}
