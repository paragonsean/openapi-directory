...
OAILiveEvent_1::OAILiveEvent_1(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAILiveEvent_1::OAILiveEvent_1() {
    this->initializeModel();
}

OAILiveEvent_1::~OAILiveEvent_1() {}

void OAILiveEvent_1::initializeModel() {
...
void OAILiveEvent_1::fromJson(QString jsonString) {
...
void OAILiveEvent_1::fromJsonObject(QJsonObject json) {
...
QString OAILiveEvent_1::asJson() const {
...
QJsonObject OAILiveEvent_1::asJsonObject() const {
    QJsonObject obj;
    if (m_begin_at.isSet()) {
...
OAIObject OAILiveEvent_1::getBeginAt() const {
    return m_begin_at;
}
void OAILiveEvent_1::setBeginAt(const OAIObject &begin_at) {
    m_begin_at = begin_at;
    m_begin_at_isSet = true;
}

bool OAILiveEvent_1::is_begin_at_Set() const{
    return m_begin_at_isSet;
}

bool OAILiveEvent_1::is_begin_at_Valid() const{
    return m_begin_at_isValid;
}

OAIObject OAILiveEvent_1::getEndAt() const {
    return m_end_at;
}
void OAILiveEvent_1::setEndAt(const OAIObject &end_at) {
    m_end_at = end_at;
    m_end_at_isSet = true;
}

bool OAILiveEvent_1::is_end_at_Set() const{
    return m_end_at_isSet;
}

bool OAILiveEvent_1::is_end_at_Valid() const{
    return m_end_at_isValid;
}

OAIVideogameSlug OAILiveEvent_1::getGame() const {
    return m_game;
}
void OAILiveEvent_1::setGame(const OAIVideogameSlug &game) {
    m_game = game;
    m_game_isSet = true;
}

bool OAILiveEvent_1::is_game_Set() const{
    return m_game_isSet;
}

bool OAILiveEvent_1::is_game_Valid() const{
    return m_game_isValid;
}

qint32 OAILiveEvent_1::getId() const {
    return m_id;
}
void OAILiveEvent_1::setId(const qint32 &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAILiveEvent_1::is_id_Set() const{
    return m_id_isSet;
}

bool OAILiveEvent_1::is_id_Valid() const{
    return m_id_isValid;
}

bool OAILiveEvent_1::isIsActive() const {
    return m_is_active;
}
void OAILiveEvent_1::setIsActive(const bool &is_active) {
    m_is_active = is_active;
    m_is_active_isSet = true;
}

bool OAILiveEvent_1::is_is_active_Set() const{
    return m_is_active_isSet;
}

bool OAILiveEvent_1::is_is_active_Valid() const{
    return m_is_active_isValid;
}

OAIObject OAILiveEvent_1::getStreamUrl() const {
    return m_stream_url;
}
void OAILiveEvent_1::setStreamUrl(const OAIObject &stream_url) {
    m_stream_url = stream_url;
    m_stream_url_isSet = true;
}

bool OAILiveEvent_1::is_stream_url_Set() const{
    return m_stream_url_isSet;
}

bool OAILiveEvent_1::is_stream_url_Valid() const{
    return m_stream_url_isValid;
}

qint32 OAILiveEvent_1::getTournamentId() const {
    return m_tournament_id;
}
void OAILiveEvent_1::setTournamentId(const qint32 &tournament_id) {
    m_tournament_id = tournament_id;
    m_tournament_id_isSet = true;
}

bool OAILiveEvent_1::is_tournament_id_Set() const{
    return m_tournament_id_isSet;
}

bool OAILiveEvent_1::is_tournament_id_Valid() const{
    return m_tournament_id_isValid;
}

bool OAILiveEvent_1::isSet() const {
...
bool OAILiveEvent_1::isValid() const {
