...
OAIBettingLoLGame::OAIBettingLoLGame(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIBettingLoLGame::OAIBettingLoLGame() {
    this->initializeModel();
}

OAIBettingLoLGame::~OAIBettingLoLGame() {}

void OAIBettingLoLGame::initializeModel() {
...
void OAIBettingLoLGame::fromJson(QString jsonString) {
...
void OAIBettingLoLGame::fromJsonObject(QJsonObject json) {
...
QString OAIBettingLoLGame::asJson() const {
...
QJsonObject OAIBettingLoLGame::asJsonObject() const {
    QJsonObject obj;
    if (m_begin_at.isSet()) {
...
QJsonValue OAIBettingLoLGame::getBeginAt() const {
    return m_begin_at;
}
void OAIBettingLoLGame::setBeginAt(const QJsonValue &begin_at) {
    m_begin_at = begin_at;
    m_begin_at_isSet = true;
}

bool OAIBettingLoLGame::is_begin_at_Set() const{
    return m_begin_at_isSet;
}

bool OAIBettingLoLGame::is_begin_at_Valid() const{
    return m_begin_at_isValid;
}

bool OAIBettingLoLGame::isComplete() const {
    return m_complete;
}
void OAIBettingLoLGame::setComplete(const bool &complete) {
    m_complete = complete;
    m_complete_isSet = true;
}

bool OAIBettingLoLGame::is_complete_Set() const{
    return m_complete_isSet;
}

bool OAIBettingLoLGame::is_complete_Valid() const{
    return m_complete_isValid;
}

bool OAIBettingLoLGame::isDetailedStats() const {
    return m_detailed_stats;
}
void OAIBettingLoLGame::setDetailedStats(const bool &detailed_stats) {
    m_detailed_stats = detailed_stats;
    m_detailed_stats_isSet = true;
}

bool OAIBettingLoLGame::is_detailed_stats_Set() const{
    return m_detailed_stats_isSet;
}

bool OAIBettingLoLGame::is_detailed_stats_Valid() const{
    return m_detailed_stats_isValid;
}

QJsonValue OAIBettingLoLGame::getEndAt() const {
    return m_end_at;
}
void OAIBettingLoLGame::setEndAt(const QJsonValue &end_at) {
    m_end_at = end_at;
    m_end_at_isSet = true;
}

bool OAIBettingLoLGame::is_end_at_Set() const{
    return m_end_at_isSet;
}

bool OAIBettingLoLGame::is_end_at_Valid() const{
    return m_end_at_isValid;
}

bool OAIBettingLoLGame::isFinished() const {
    return m_finished;
}
void OAIBettingLoLGame::setFinished(const bool &finished) {
    m_finished = finished;
    m_finished_isSet = true;
}

bool OAIBettingLoLGame::is_finished_Set() const{
    return m_finished_isSet;
}

bool OAIBettingLoLGame::is_finished_Valid() const{
    return m_finished_isValid;
}

bool OAIBettingLoLGame::isForfeit() const {
    return m_forfeit;
}
void OAIBettingLoLGame::setForfeit(const bool &forfeit) {
    m_forfeit = forfeit;
    m_forfeit_isSet = true;
}

bool OAIBettingLoLGame::is_forfeit_Set() const{
    return m_forfeit_isSet;
}

bool OAIBettingLoLGame::is_forfeit_Valid() const{
    return m_forfeit_isValid;
}

OAIBettingGameTeams_1 OAIBettingLoLGame::getGameTeams() const {
    return m_game_teams;
}
void OAIBettingLoLGame::setGameTeams(const OAIBettingGameTeams_1 &game_teams) {
    m_game_teams = game_teams;
    m_game_teams_isSet = true;
}

bool OAIBettingLoLGame::is_game_teams_Set() const{
    return m_game_teams_isSet;
}

bool OAIBettingLoLGame::is_game_teams_Valid() const{
    return m_game_teams_isValid;
}

qint32 OAIBettingLoLGame::getId() const {
    return m_id;
}
void OAIBettingLoLGame::setId(const qint32 &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIBettingLoLGame::is_id_Set() const{
    return m_id_isSet;
}

bool OAIBettingLoLGame::is_id_Valid() const{
    return m_id_isValid;
}

QJsonValue OAIBettingLoLGame::getLength() const {
    return m_length;
}
void OAIBettingLoLGame::setLength(const QJsonValue &length) {
    m_length = length;
    m_length_isSet = true;
}

bool OAIBettingLoLGame::is_length_Set() const{
    return m_length_isSet;
}

bool OAIBettingLoLGame::is_length_Valid() const{
    return m_length_isValid;
}

qint32 OAIBettingLoLGame::getMatchId() const {
    return m_match_id;
}
void OAIBettingLoLGame::setMatchId(const qint32 &match_id) {
    m_match_id = match_id;
    m_match_id_isSet = true;
}

bool OAIBettingLoLGame::is_match_id_Set() const{
    return m_match_id_isSet;
}

bool OAIBettingLoLGame::is_match_id_Valid() const{
    return m_match_id_isValid;
}

qint32 OAIBettingLoLGame::getPosition() const {
    return m_position;
}
void OAIBettingLoLGame::setPosition(const qint32 &position) {
    m_position = position;
    m_position_isSet = true;
}

bool OAIBettingLoLGame::is_position_Set() const{
    return m_position_isSet;
}

bool OAIBettingLoLGame::is_position_Valid() const{
    return m_position_isValid;
}

OAIGameStatus OAIBettingLoLGame::getStatus() const {
    return m_status;
}
void OAIBettingLoLGame::setStatus(const OAIGameStatus &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIBettingLoLGame::is_status_Set() const{
    return m_status_isSet;
}

bool OAIBettingLoLGame::is_status_Valid() const{
    return m_status_isValid;
}

QJsonValue OAIBettingLoLGame::getVideoUrl() const {
    return m_video_url;
}
void OAIBettingLoLGame::setVideoUrl(const QJsonValue &video_url) {
    m_video_url = video_url;
    m_video_url_isSet = true;
}

bool OAIBettingLoLGame::is_video_url_Set() const{
    return m_video_url_isSet;
}

bool OAIBettingLoLGame::is_video_url_Valid() const{
    return m_video_url_isValid;
}

OAIGameWinner OAIBettingLoLGame::getWinner() const {
    return m_winner;
}
void OAIBettingLoLGame::setWinner(const OAIGameWinner &winner) {
    m_winner = winner;
    m_winner_isSet = true;
}

bool OAIBettingLoLGame::is_winner_Set() const{
    return m_winner_isSet;
}

bool OAIBettingLoLGame::is_winner_Valid() const{
    return m_winner_isValid;
}

QJsonValue OAIBettingLoLGame::getWinnerType() const {
    return m_winner_type;
}
void OAIBettingLoLGame::setWinnerType(const QJsonValue &winner_type) {
    m_winner_type = winner_type;
    m_winner_type_isSet = true;
}

bool OAIBettingLoLGame::is_winner_type_Set() const{
    return m_winner_type_isSet;
}

bool OAIBettingLoLGame::is_winner_type_Valid() const{
    return m_winner_type_isValid;
}

bool OAIBettingLoLGame::isSet() const {
...
bool OAIBettingLoLGame::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_begin_at_isValid && m_complete_isValid && m_detailed_stats_isValid && m_end_at_isValid && m_finished_isValid && m_forfeit_isValid && m_game_teams_isValid && m_id_isValid && m_length_isValid && m_match_id_isValid && m_position_isValid && m_status_isValid && m_video_url_isValid && m_winner_isValid && m_winner_type_isValid && true;
}
