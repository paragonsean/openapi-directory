...
OAIDeletionIncidentChangeType OAIIncident::getChangeType() const {
    return m_change_type;
}
void OAIIncident::setChangeType(const OAIDeletionIncidentChangeType &change_type) {
    m_change_type = change_type;
    m_change_type_isSet = true;
}

bool OAIIncident::is_change_type_Set() const{
    return m_change_type_isSet;
}

bool OAIIncident::is_change_type_Valid() const{
    return m_change_type_isValid;
}

OAIIncidentID OAIIncident::getId() const {
    return m_id;
}
void OAIIncident::setId(const OAIIncidentID &id) {
    m_id = id;
    m_id_isSet = true;
}
...
QDateTime OAIIncident::getModifiedAt() const {
    return m_modified_at;
}
void OAIIncident::setModifiedAt(const QDateTime &modified_at) {
    m_modified_at = modified_at;
    m_modified_at_isSet = true;
}

bool OAIIncident::is_modified_at_Set() const{
    return m_modified_at_isSet;
}

bool OAIIncident::is_modified_at_Valid() const{
    return m_modified_at_isValid;
}

OAIDeletionObject OAIIncident::getObject() const {
    return m_object;
}
void OAIIncident::setObject(const OAIDeletionObject &object) {
    m_object = object;
    m_object_isSet = true;
}

bool OAIIncident::is_object_Set() const{
    return m_object_isSet;
}

bool OAIIncident::is_object_Valid() const{
    return m_object_isValid;
}

OAIIncidentType OAIIncident::getType() const {
    return m_type;
}
void OAIIncident::setType(const OAIIncidentType &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAIIncident::is_type_Set() const{
    return m_type_isSet;
}

bool OAIIncident::is_type_Valid() const{
