...
/*
 * OAIBettingBaseTournament.h
 *
 * 
 */

#ifndef OAIBettingBaseTournament_H
#define OAIBettingBaseTournament_H
...
class OAIBettingBaseTournament : public OAIObject {
public:
    OAIBettingBaseTournament();
    OAIBettingBaseTournament(QString json);
    ~OAIBettingBaseTournament() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBettingBaseTournament)

#endif // OAIBettingBaseTournament_H
