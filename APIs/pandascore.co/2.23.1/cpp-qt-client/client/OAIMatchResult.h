...
#ifndef OAIMatchResult_H
#define OAIMatchResult_H
...
class OAIMatchResult : public OAIObject {
public:
    OAIMatchResult();
    OAIMatchResult(QString json);
    ~OAIMatchResult() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMatchResult)

#endif // OAIMatchResult_H
