...
#ifndef OAIBaseTeam_H
#define OAIBaseTeam_H
...
class OAIBaseTeam : public OAIObject {
public:
    OAIBaseTeam();
    OAIBaseTeam(QString json);
    ~OAIBaseTeam() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBaseTeam)
