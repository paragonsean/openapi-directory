...
/*
 * OAIBettingCSGOGame.h
 *
 * 
 */

#ifndef OAIBettingCSGOGame_H
#define OAIBettingCSGOGame_H

#include <QJsonObject>

#include "OAIBettingGameRoundTeams_1.h"
#include "OAICSGOMap_1.h"
...
class OAIBettingCSGOGame : public OAIObject {
public:
    OAIBettingCSGOGame();
    OAIBettingCSGOGame(QString json);
    ~OAIBettingCSGOGame() override;
    ...
    OAIBettingGameRoundTeams_1 getGameRoundTeams() const;
    void setGameRoundTeams(const OAIBettingGameRoundTeams_1 &game_round_teams);
    bool is_game_round_teams_Set() const;
    bool is_game_round_teams_Valid() const;
    ...
    OAICSGOMap_1 getMap() const;
    void setMap(const OAICSGOMap_1 &map);
    ...
    QJsonValue getNumberOfRounds() const;
    void setNumberOfRounds(const QJsonValue &number_of_rounds);
    bool is_number_of_rounds_Set() const;
    bool is_number_of_rounds_Valid() const;
...
private:
    ...
    OAIBettingGameRoundTeams_1 m_game_round_teams;
    bool m_game_round_teams_isSet;
    bool m_game_round_teams_isValid;
    ...
    QJsonValue m_number_of_rounds;
    bool m_number_of_rounds_isSet;
    bool m_number_of_rounds_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBettingCSGOGame)

#endif // OAIBettingCSGOGame_H
