...
OAIBaseTournament::OAIBaseTournament(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIBaseTournament::OAIBaseTournament() {
    this->initializeModel();
}

OAIBaseTournament::~OAIBaseTournament() {}

void OAIBaseTournament::initializeModel() {
...
void OAIBaseTournament::fromJson(QString jsonString) {
...
void OAIBaseTournament::fromJsonObject(QJsonObject json) {
...
QString OAIBaseTournament::asJson() const {
...
QJsonObject OAIBaseTournament::asJsonObject() const {
    QJsonObject obj;
    if (m_begin_at.isSet()) {
...
QJsonValue OAIBaseTournament::getBeginAt() const {
    return m_begin_at;
}
void OAIBaseTournament::setBeginAt(const QJsonValue &begin_at) {
    m_begin_at = begin_at;
    m_begin_at_isSet = true;
}

bool OAIBaseTournament::is_begin_at_Set() const{
    return m_begin_at_isSet;
}

bool OAIBaseTournament::is_begin_at_Valid() const{
    return m_begin_at_isValid;
}

QJsonValue OAIBaseTournament::getEndAt() const {
    return m_end_at;
}
void OAIBaseTournament::setEndAt(const QJsonValue &end_at) {
    m_end_at = end_at;
    m_end_at_isSet = true;
}

bool OAIBaseTournament::is_end_at_Set() const{
    return m_end_at_isSet;
}

bool OAIBaseTournament::is_end_at_Valid() const{
    return m_end_at_isValid;
}

qint32 OAIBaseTournament::getId() const {
    return m_id;
}
void OAIBaseTournament::setId(const qint32 &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIBaseTournament::is_id_Set() const{
    return m_id_isSet;
}

bool OAIBaseTournament::is_id_Valid() const{
    return m_id_isValid;
}

qint32 OAIBaseTournament::getLeagueId() const {
    return m_league_id;
}
void OAIBaseTournament::setLeagueId(const qint32 &league_id) {
    m_league_id = league_id;
    m_league_id_isSet = true;
}

bool OAIBaseTournament::is_league_id_Set() const{
    return m_league_id_isSet;
}

bool OAIBaseTournament::is_league_id_Valid() const{
    return m_league_id_isValid;
}

bool OAIBaseTournament::isLiveSupported() const {
    return m_live_supported;
}
void OAIBaseTournament::setLiveSupported(const bool &live_supported) {
    m_live_supported = live_supported;
    m_live_supported_isSet = true;
}

bool OAIBaseTournament::is_live_supported_Set() const{
    return m_live_supported_isSet;
}

bool OAIBaseTournament::is_live_supported_Valid() const{
    return m_live_supported_isValid;
}

QDateTime OAIBaseTournament::getModifiedAt() const {
    return m_modified_at;
}
void OAIBaseTournament::setModifiedAt(const QDateTime &modified_at) {
    m_modified_at = modified_at;
    m_modified_at_isSet = true;
}

bool OAIBaseTournament::is_modified_at_Set() const{
    return m_modified_at_isSet;
}

bool OAIBaseTournament::is_modified_at_Valid() const{
    return m_modified_at_isValid;
}

QString OAIBaseTournament::getName() const {
    return m_name;
}
void OAIBaseTournament::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIBaseTournament::is_name_Set() const{
    return m_name_isSet;
}

bool OAIBaseTournament::is_name_Valid() const{
    return m_name_isValid;
}

QJsonValue OAIBaseTournament::getPrizepool() const {
    return m_prizepool;
}
void OAIBaseTournament::setPrizepool(const QJsonValue &prizepool) {
    m_prizepool = prizepool;
    m_prizepool_isSet = true;
}

bool OAIBaseTournament::is_prizepool_Set() const{
    return m_prizepool_isSet;
}

bool OAIBaseTournament::is_prizepool_Valid() const{
    return m_prizepool_isValid;
}

qint32 OAIBaseTournament::getSerieId() const {
    return m_serie_id;
}
void OAIBaseTournament::setSerieId(const qint32 &serie_id) {
    m_serie_id = serie_id;
    m_serie_id_isSet = true;
}

bool OAIBaseTournament::is_serie_id_Set() const{
    return m_serie_id_isSet;
}

bool OAIBaseTournament::is_serie_id_Valid() const{
    return m_serie_id_isValid;
}

QString OAIBaseTournament::getSlug() const {
    return m_slug;
}
void OAIBaseTournament::setSlug(const QString &slug) {
    m_slug = slug;
    m_slug_isSet = true;
}

bool OAIBaseTournament::is_slug_Set() const{
    return m_slug_isSet;
}

bool OAIBaseTournament::is_slug_Valid() const{
    return m_slug_isValid;
}

OAIOpponentID_1 OAIBaseTournament::getWinnerId() const {
    return m_winner_id;
}
void OAIBaseTournament::setWinnerId(const OAIOpponentID_1 &winner_id) {
    m_winner_id = winner_id;
    m_winner_id_isSet = true;
}

bool OAIBaseTournament::is_winner_id_Set() const{
    return m_winner_id_isSet;
}

bool OAIBaseTournament::is_winner_id_Valid() const{
    return m_winner_id_isValid;
}

QJsonValue OAIBaseTournament::getWinnerType() const {
    return m_winner_type;
}
void OAIBaseTournament::setWinnerType(const QJsonValue &winner_type) {
    m_winner_type = winner_type;
    m_winner_type_isSet = true;
}

bool OAIBaseTournament::is_winner_type_Set() const{
    return m_winner_type_isSet;
}

bool OAIBaseTournament::is_winner_type_Valid() const{
    return m_winner_type_isValid;
}

bool OAIBaseTournament::isSet() const {
...
bool OAIBaseTournament::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_begin_at_isValid && m_end_at_isValid && m_id_isValid && m_league_id_isValid && m_live_supported_isValid && m_modified_at_isValid && m_name_isValid && m_prizepool_isValid && m_serie_id_isValid && m_slug_isValid && m_winner_id_isValid && m_winner_type_isValid && true;
}
