...
QJsonValue OAIMatch::getBeginAt() const {
    return m_begin_at;
}
void OAIMatch::setBeginAt(const QJsonValue &begin_at) {
    m_begin_at = begin_at;
    m_begin_at_isSet = true;
}

bool OAIMatch::is_begin_at_Set() const{
    return m_begin_at_isSet;
}

bool OAIMatch::is_begin_at_Valid() const{
    return m_begin_at_isValid;
}

bool OAIMatch::isDetailedStats() const {
    return m_detailed_stats;
}
void OAIMatch::setDetailedStats(const bool &detailed_stats) {
    m_detailed_stats = detailed_stats;
    m_detailed_stats_isSet = true;
}

bool OAIMatch::is_detailed_stats_Set() const{
    return m_detailed_stats_isSet;
}

bool OAIMatch::is_detailed_stats_Valid() const{
    return m_detailed_stats_isValid;
}

bool OAIMatch::isDraw() const {
    return m_draw;
}
void OAIMatch::setDraw(const bool &draw) {
    m_draw = draw;
    m_draw_isSet = true;
}

bool OAIMatch::is_draw_Set() const{
    return m_draw_isSet;
}

bool OAIMatch::is_draw_Valid() const{
    return m_draw_isValid;
}

QJsonValue OAIMatch::getEndAt() const {
    return m_end_at;
}
void OAIMatch::setEndAt(const QJsonValue &end_at) {
    m_end_at = end_at;
    m_end_at_isSet = true;
}

bool OAIMatch::is_end_at_Set() const{
    return m_end_at_isSet;
}

bool OAIMatch::is_end_at_Valid() const{
    return m_end_at_isValid;
}

bool OAIMatch::isForfeit() const {
    return m_forfeit;
}
void OAIMatch::setForfeit(const bool &forfeit) {
    m_forfeit = forfeit;
    m_forfeit_isSet = true;
}

bool OAIMatch::is_forfeit_Set() const{
    return m_forfeit_isSet;
}

bool OAIMatch::is_forfeit_Valid() const{
    return m_forfeit_isValid;
}

OAIOpponentID_1 OAIMatch::getGameAdvantage() const {
    return m_game_advantage;
}
void OAIMatch::setGameAdvantage(const OAIOpponentID_1 &game_advantage) {
    m_game_advantage = game_advantage;
    m_game_advantage_isSet = true;
}

bool OAIMatch::is_game_advantage_Set() const{
    return m_game_advantage_isSet;
}

bool OAIMatch::is_game_advantage_Valid() const{
    return m_game_advantage_isValid;
}

QList<OAIGame> OAIMatch::getGames() const {
    return m_games;
}
void OAIMatch::setGames(const QList<OAIGame> &games) {
    m_games = games;
    m_games_isSet = true;
}

bool OAIMatch::is_games_Set() const{
    return m_games_isSet;
}

bool OAIMatch::is_games_Valid() const{
    return m_games_isValid;
}

qint32 OAIMatch::getId() const {
    return m_id;
}
void OAIMatch::setId(const qint32 &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIMatch::is_id_Set() const{
    return m_id_isSet;
}

bool OAIMatch::is_id_Valid() const{
    return m_id_isValid;
}

OAIBaseLeague OAIMatch::getLeague() const {
    return m_league;
}
void OAIMatch::setLeague(const OAIBaseLeague &league) {
    m_league = league;
    m_league_isSet = true;
}

bool OAIMatch::is_league_Set() const{
    return m_league_isSet;
}

bool OAIMatch::is_league_Valid() const{
    return m_league_isValid;
}

qint32 OAIMatch::getLeagueId() const {
    return m_league_id;
}
void OAIMatch::setLeagueId(const qint32 &league_id) {
    m_league_id = league_id;
    m_league_id_isSet = true;
}

bool OAIMatch::is_league_id_Set() const{
    return m_league_id_isSet;
}

bool OAIMatch::is_league_id_Valid() const{
    return m_league_id_isValid;
}

OAIMatchLive OAIMatch::getLive() const {
    return m_live;
}
void OAIMatch::setLive(const OAIMatchLive &live) {
    m_live = live;
    m_live_isSet = true;
}

bool OAIMatch::is_live_Set() const{
    return m_live_isSet;
}

bool OAIMatch::is_live_Valid() const{
    return m_live_isValid;
}

QJsonValue OAIMatch::getLiveEmbedUrl() const {
    return m_live_embed_url;
}
void OAIMatch::setLiveEmbedUrl(const QJsonValue &live_embed_url) {
    m_live_embed_url = live_embed_url;
    m_live_embed_url_isSet = true;
}

bool OAIMatch::is_live_embed_url_Set() const{
    return m_live_embed_url_isSet;
}

bool OAIMatch::is_live_embed_url_Valid() const{
    return m_live_embed_url_isValid;
}

OAIMatchType OAIMatch::getMatchType() const {
    return m_match_type;
}
void OAIMatch::setMatchType(const OAIMatchType &match_type) {
    m_match_type = match_type;
    m_match_type_isSet = true;
}

bool OAIMatch::is_match_type_Set() const{
    return m_match_type_isSet;
}

bool OAIMatch::is_match_type_Valid() const{
    return m_match_type_isValid;
}

QDateTime OAIMatch::getModifiedAt() const {
    return m_modified_at;
}
void OAIMatch::setModifiedAt(const QDateTime &modified_at) {
    m_modified_at = modified_at;
    m_modified_at_isSet = true;
}

bool OAIMatch::is_modified_at_Set() const{
    return m_modified_at_isSet;
}

bool OAIMatch::is_modified_at_Valid() const{
    return m_modified_at_isValid;
}

QString OAIMatch::getName() const {
    return m_name;
}
void OAIMatch::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIMatch::is_name_Set() const{
    return m_name_isSet;
}

bool OAIMatch::is_name_Valid() const{
    return m_name_isValid;
}

qint32 OAIMatch::getNumberOfGames() const {
    return m_number_of_games;
}
void OAIMatch::setNumberOfGames(const qint32 &number_of_games) {
    m_number_of_games = number_of_games;
    m_number_of_games_isSet = true;
}

bool OAIMatch::is_number_of_games_Set() const{
    return m_number_of_games_isSet;
}

bool OAIMatch::is_number_of_games_Valid() const{
    return m_number_of_games_isValid;
}

QJsonValue OAIMatch::getOfficialStreamUrl() const {
    return m_official_stream_url;
}
void OAIMatch::setOfficialStreamUrl(const QJsonValue &official_stream_url) {
    m_official_stream_url = official_stream_url;
    m_official_stream_url_isSet = true;
}

bool OAIMatch::is_official_stream_url_Set() const{
    return m_official_stream_url_isSet;
}

bool OAIMatch::is_official_stream_url_Valid() const{
    return m_official_stream_url_isValid;
}

QList<OAIOpponent> OAIMatch::getOpponents() const {
    return m_opponents;
}
void OAIMatch::setOpponents(const QList<OAIOpponent> &opponents) {
    m_opponents = opponents;
    m_opponents_isSet = true;
}

bool OAIMatch::is_opponents_Set() const{
    return m_opponents_isSet;
}

bool OAIMatch::is_opponents_Valid() const{
    return m_opponents_isValid;
}

QJsonValue OAIMatch::getOriginalScheduledAt() const {
    return m_original_scheduled_at;
}
void OAIMatch::setOriginalScheduledAt(const QJsonValue &original_scheduled_at) {
    m_original_scheduled_at = original_scheduled_at;
    m_original_scheduled_at_isSet = true;
}

bool OAIMatch::is_original_scheduled_at_Set() const{
    return m_original_scheduled_at_isSet;
}

bool OAIMatch::is_original_scheduled_at_Valid() const{
    return m_original_scheduled_at_isValid;
}

QJsonValue OAIMatch::getRescheduled() const {
    return m_rescheduled;
}
void OAIMatch::setRescheduled(const QJsonValue &rescheduled) {
    m_rescheduled = rescheduled;
    m_rescheduled_isSet = true;
}

bool OAIMatch::is_rescheduled_Set() const{
    return m_rescheduled_isSet;
}

bool OAIMatch::is_rescheduled_Valid() const{
    return m_rescheduled_isValid;
}

QList<OAIMatchResult> OAIMatch::getResults() const {
    return m_results;
}
void OAIMatch::setResults(const QList<OAIMatchResult> &results) {
    m_results = results;
    m_results_isSet = true;
}

bool OAIMatch::is_results_Set() const{
    return m_results_isSet;
}

bool OAIMatch::is_results_Valid() const{
    return m_results_isValid;
}

QJsonValue OAIMatch::getScheduledAt() const {
    return m_scheduled_at;
}
void OAIMatch::setScheduledAt(const QJsonValue &scheduled_at) {
    m_scheduled_at = scheduled_at;
    m_scheduled_at_isSet = true;
}

bool OAIMatch::is_scheduled_at_Set() const{
    return m_scheduled_at_isSet;
}

bool OAIMatch::is_scheduled_at_Valid() const{
    return m_scheduled_at_isValid;
}

OAIBaseSerie OAIMatch::getSerie() const {
    return m_serie;
}
void OAIMatch::setSerie(const OAIBaseSerie &serie) {
    m_serie = serie;
    m_serie_isSet = true;
}

bool OAIMatch::is_serie_Set() const{
    return m_serie_isSet;
}

bool OAIMatch::is_serie_Valid() const{
    return m_serie_isValid;
}

qint32 OAIMatch::getSerieId() const {
    return m_serie_id;
}
void OAIMatch::setSerieId(const qint32 &serie_id) {
    m_serie_id = serie_id;
    m_serie_id_isSet = true;
}

bool OAIMatch::is_serie_id_Set() const{
    return m_serie_id_isSet;
}

bool OAIMatch::is_serie_id_Valid() const{
    return m_serie_id_isValid;
}

QJsonValue OAIMatch::getSlug() const {
    return m_slug;
}
void OAIMatch::setSlug(const QJsonValue &slug) {
    m_slug = slug;
    m_slug_isSet = true;
}

bool OAIMatch::is_slug_Set() const{
    return m_slug_isSet;
}

bool OAIMatch::is_slug_Valid() const{
    return m_slug_isValid;
}

OAIMatchStatus OAIMatch::getStatus() const {
    return m_status;
}
void OAIMatch::setStatus(const OAIMatchStatus &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIMatch::is_status_Set() const{
    return m_status_isSet;
}

bool OAIMatch::is_status_Valid() const{
    return m_status_isValid;
}

OAIMatchLocalizedStreams OAIMatch::getStreams() const {
    return m_streams;
}
void OAIMatch::setStreams(const OAIMatchLocalizedStreams &streams) {
    m_streams = streams;
    m_streams_isSet = true;
}

bool OAIMatch::is_streams_Set() const{
    return m_streams_isSet;
}

bool OAIMatch::is_streams_Valid() const{
    return m_streams_isValid;
}

QList<OAIStream> OAIMatch::getStreamsList() const {
    return m_streams_list;
}
void OAIMatch::setStreamsList(const QList<OAIStream> &streams_list) {
    m_streams_list = streams_list;
    m_streams_list_isSet = true;
}

bool OAIMatch::is_streams_list_Set() const{
    return m_streams_list_isSet;
}

bool OAIMatch::is_streams_list_Valid() const{
    return m_streams_list_isValid;
}

OAIBaseTournament OAIMatch::getTournament() const {
    return m_tournament;
}
void OAIMatch::setTournament(const OAIBaseTournament &tournament) {
    m_tournament = tournament;
    m_tournament_isSet = true;
}

bool OAIMatch::is_tournament_Set() const{
    return m_tournament_isSet;
}

bool OAIMatch::is_tournament_Valid() const{
    return m_tournament_isValid;
}

qint32 OAIMatch::getTournamentId() const {
    return m_tournament_id;
}
void OAIMatch::setTournamentId(const qint32 &tournament_id) {
    m_tournament_id = tournament_id;
    m_tournament_id_isSet = true;
}

bool OAIMatch::is_tournament_id_Set() const{
    return m_tournament_id_isSet;
}

bool OAIMatch::is_tournament_id_Valid() const{
    return m_tournament_id_isValid;
}

OAICurrentVideogame OAIMatch::getVideogame() const {
    return m_videogame;
}
void OAIMatch::setVideogame(const OAICurrentVideogame &videogame) {
    m_videogame = videogame;
    m_videogame_isSet = true;
}

bool OAIMatch::is_videogame_Set() const{
    return m_videogame_isSet;
}

bool OAIMatch::is_videogame_Valid() const{
    return m_videogame_isValid;
}

OAIShortVideogameVersion_1 OAIMatch::getVideogameVersion() const {
    return m_videogame_version;
}
void OAIMatch::setVideogameVersion(const OAIShortVideogameVersion_1 &videogame_version) {
    m_videogame_version = videogame_version;
    m_videogame_version_isSet = true;
}

bool OAIMatch::is_videogame_version_Set() const{
    return m_videogame_version_isSet;
}

bool OAIMatch::is_videogame_version_Valid() const{
    return m_videogame_version_isValid;
}

OAIBaseOpponent_1 OAIMatch::getWinner() const {
    return m_winner;
}
void OAIMatch::setWinner(const OAIBaseOpponent_1 &winner) {
    m_winner = winner;
    m_winner_isSet = true;
}

bool OAIMatch::is_winner_Set() const{
    return m_winner_isSet;
}

bool OAIMatch::is_winner_Valid() const{
    return m_winner_isValid;
}

OAIOpponentID_1 OAIMatch::getWinnerId() const {
    return m_winner_id;
}
void OAIMatch::setWinnerId(const OAIOpponentID_1 &winner_id) {
    m_winner_id = winner_id;
    m_winner_id_isSet = true;
}

bool OAIMatch::is_winner_id_Set() const{
    return m_winner_id_isSet;
}

bool OAIMatch::is_winner_id_Valid() const{
