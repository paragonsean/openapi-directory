...
/*
 * OAIBracketStanding.h
 *
 * 
 */

#ifndef OAIBracketStanding_H
#define OAIBracketStanding_H
...
class OAIBracketStanding : public OAIObject {
public:
    OAIBracketStanding();
    OAIBracketStanding(QString json);
    ~OAIBracketStanding() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBracketStanding)

#endif // OAIBracketStanding_H
