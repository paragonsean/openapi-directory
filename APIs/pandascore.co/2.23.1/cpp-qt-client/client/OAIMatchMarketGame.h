...
/*
 * OAIMatchMarketGame.h
 *
 * 
 */

#ifndef OAIMatchMarketGame_H
#define OAIMatchMarketGame_H
...
class OAIMatchMarketGame : public OAIObject {
public:
    OAIMatchMarketGame();
    OAIMatchMarketGame(QString json);
    ~OAIMatchMarketGame() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMatchMarketGame)

#endif // OAIMatchMarketGame_H
