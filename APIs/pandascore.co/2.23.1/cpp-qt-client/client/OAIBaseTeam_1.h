...
#ifndef OAIBaseTeam_1_H
#define OAIBaseTeam_1_H
...
class OAIBaseTeam_1 : public OAIObject {
public:
    OAIBaseTeam_1();
    OAIBaseTeam_1(QString json);
    ~OAIBaseTeam_1() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBaseTeam_1)

#endif // OAIBaseTeam_1_H
