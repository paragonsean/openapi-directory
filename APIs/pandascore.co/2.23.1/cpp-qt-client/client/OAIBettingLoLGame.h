...
#ifndef OAIBettingLoLGame_H
#define OAIBettingLoLGame_H
...
class OAIBettingLoLGame : public OAIObject {
public:
    OAIBettingLoLGame();
    OAIBettingLoLGame(QString json);
    ~OAIBettingLoLGame() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBettingLoLGame)

#endif // OAIBettingLoLGame_H
