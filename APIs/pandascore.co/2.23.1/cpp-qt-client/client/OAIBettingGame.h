...
#ifndef OAIBettingGame_H
#define OAIBettingGame_H

#include <QJsonObject>

#include "OAIBettingCSGOGame.h"
#include "OAIBettingDota2Game.h"
#include "OAIBettingGameRoundTeams_1.h"
#include "OAIBettingGameTeams_1.h"
#include "OAIBettingLoLGame.h"
...
class OAIBettingGame : public OAIObject {
public:
    OAIBettingGame();
    OAIBettingGame(QString json);
    ~OAIBettingGame() override;
    ...
    OAIObject getLength() const;
    void setLength(const OAIObject &length);
    ...
    OAIObject getNumberOfRounds() const;
    void setNumberOfRounds(const OAIObject &number_of_rounds);
    ...
    OAIObject getVideoUrl() const;
    void setVideoUrl(const OAIObject &video_url);
    ...
    OAIBettingGameTeams_1 getGameTeams() const;
    void setGameTeams(const OAIBettingGameTeams_1 &game_teams);
    bool is_game_teams_Set() const;
    bool is_game_teams_Valid() const;
...
private:
    ...
    OAIBettingGameTeams_1 m_game_teams;
    bool m_game_teams_isSet;
    bool m_game_teams_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIBettingGame)

#endif // OAIBettingGame_H
