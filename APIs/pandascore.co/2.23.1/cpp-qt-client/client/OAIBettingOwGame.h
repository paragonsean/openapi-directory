...
#ifndef OAIBettingOwGame_H
#define OAIBettingOwGame_H
...
class OAIBettingOwGame : public OAIObject {
public:
    OAIBettingOwGame();
    OAIBettingOwGame(QString json);
    ~OAIBettingOwGame() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBettingOwGame)

#endif // OAIBettingOwGame_H
