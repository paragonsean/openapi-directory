...
public:
    ...
    QList<OAITournamentRosterItem> getExpectedRoster() const;
    void setExpectedRoster(const QList<OAITournamentRosterItem> &expected_roster);
    bool is_expected_roster_Set() const;
    bool is_expected_roster_Valid() const;
...
private:
    ...
    QList<OAITournamentRosterItem> m_expected_roster;
    bool m_expected_roster_isSet;
    bool m_expected_roster_isValid;
