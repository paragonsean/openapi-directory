...
OAIBettingCSGOGame::OAIBettingCSGOGame(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIBettingCSGOGame::OAIBettingCSGOGame() {
    this->initializeModel();
}

OAIBettingCSGOGame::~OAIBettingCSGOGame() {}

void OAIBettingCSGOGame::initializeModel() {
...
void OAIBettingCSGOGame::fromJson(QString jsonString) {
...
void OAIBettingCSGOGame::fromJsonObject(QJsonObject json) {
...
QString OAIBettingCSGOGame::asJson() const {
...
QJsonObject OAIBettingCSGOGame::asJsonObject() const {
    QJsonObject obj;
    if (m_begin_at.isSet()) {
...
QJsonValue OAIBettingCSGOGame::getBeginAt() const {
    return m_begin_at;
}
void OAIBettingCSGOGame::setBeginAt(const QJsonValue &begin_at) {
    m_begin_at = begin_at;
    m_begin_at_isSet = true;
}

bool OAIBettingCSGOGame::is_begin_at_Set() const{
    return m_begin_at_isSet;
}

bool OAIBettingCSGOGame::is_begin_at_Valid() const{
    return m_begin_at_isValid;
}

bool OAIBettingCSGOGame::isComplete() const {
    return m_complete;
}
void OAIBettingCSGOGame::setComplete(const bool &complete) {
    m_complete = complete;
    m_complete_isSet = true;
}

bool OAIBettingCSGOGame::is_complete_Set() const{
    return m_complete_isSet;
}

bool OAIBettingCSGOGame::is_complete_Valid() const{
    return m_complete_isValid;
}

bool OAIBettingCSGOGame::isDetailedStats() const {
    return m_detailed_stats;
}
void OAIBettingCSGOGame::setDetailedStats(const bool &detailed_stats) {
    m_detailed_stats = detailed_stats;
    m_detailed_stats_isSet = true;
}

bool OAIBettingCSGOGame::is_detailed_stats_Set() const{
    return m_detailed_stats_isSet;
}

bool OAIBettingCSGOGame::is_detailed_stats_Valid() const{
    return m_detailed_stats_isValid;
}

QJsonValue OAIBettingCSGOGame::getEndAt() const {
    return m_end_at;
}
void OAIBettingCSGOGame::setEndAt(const QJsonValue &end_at) {
    m_end_at = end_at;
    m_end_at_isSet = true;
}

bool OAIBettingCSGOGame::is_end_at_Set() const{
    return m_end_at_isSet;
}

bool OAIBettingCSGOGame::is_end_at_Valid() const{
    return m_end_at_isValid;
}

bool OAIBettingCSGOGame::isFinished() const {
    return m_finished;
}
void OAIBettingCSGOGame::setFinished(const bool &finished) {
    m_finished = finished;
    m_finished_isSet = true;
}

bool OAIBettingCSGOGame::is_finished_Set() const{
    return m_finished_isSet;
}

bool OAIBettingCSGOGame::is_finished_Valid() const{
    return m_finished_isValid;
}

bool OAIBettingCSGOGame::isForfeit() const {
    return m_forfeit;
}
void OAIBettingCSGOGame::setForfeit(const bool &forfeit) {
    m_forfeit = forfeit;
    m_forfeit_isSet = true;
}

bool OAIBettingCSGOGame::is_forfeit_Set() const{
    return m_forfeit_isSet;
}

bool OAIBettingCSGOGame::is_forfeit_Valid() const{
    return m_forfeit_isValid;
}

OAIBettingGameRoundTeams_1 OAIBettingCSGOGame::getGameRoundTeams() const {
    return m_game_round_teams;
}
void OAIBettingCSGOGame::setGameRoundTeams(const OAIBettingGameRoundTeams_1 &game_round_teams) {
    m_game_round_teams = game_round_teams;
    m_game_round_teams_isSet = true;
}

bool OAIBettingCSGOGame::is_game_round_teams_Set() const{
    return m_game_round_teams_isSet;
}

bool OAIBettingCSGOGame::is_game_round_teams_Valid() const{
    return m_game_round_teams_isValid;
}

qint32 OAIBettingCSGOGame::getId() const {
    return m_id;
}
void OAIBettingCSGOGame::setId(const qint32 &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIBettingCSGOGame::is_id_Set() const{
    return m_id_isSet;
}

bool OAIBettingCSGOGame::is_id_Valid() const{
    return m_id_isValid;
}

QJsonValue OAIBettingCSGOGame::getLength() const {
    return m_length;
}
void OAIBettingCSGOGame::setLength(const QJsonValue &length) {
    m_length = length;
    m_length_isSet = true;
}

bool OAIBettingCSGOGame::is_length_Set() const{
    return m_length_isSet;
}

bool OAIBettingCSGOGame::is_length_Valid() const{
    return m_length_isValid;
}

OAICSGOMap_1 OAIBettingCSGOGame::getMap() const {
    return m_map;
}
void OAIBettingCSGOGame::setMap(const OAICSGOMap_1 &map) {
    m_map = map;
    m_map_isSet = true;
}

bool OAIBettingCSGOGame::is_map_Set() const{
    return m_map_isSet;
}

bool OAIBettingCSGOGame::is_map_Valid() const{
    return m_map_isValid;
}

qint32 OAIBettingCSGOGame::getMatchId() const {
    return m_match_id;
}
void OAIBettingCSGOGame::setMatchId(const qint32 &match_id) {
    m_match_id = match_id;
    m_match_id_isSet = true;
}

bool OAIBettingCSGOGame::is_match_id_Set() const{
    return m_match_id_isSet;
}

bool OAIBettingCSGOGame::is_match_id_Valid() const{
    return m_match_id_isValid;
}

QJsonValue OAIBettingCSGOGame::getNumberOfRounds() const {
    return m_number_of_rounds;
}
void OAIBettingCSGOGame::setNumberOfRounds(const QJsonValue &number_of_rounds) {
    m_number_of_rounds = number_of_rounds;
    m_number_of_rounds_isSet = true;
}

bool OAIBettingCSGOGame::is_number_of_rounds_Set() const{
    return m_number_of_rounds_isSet;
}

bool OAIBettingCSGOGame::is_number_of_rounds_Valid() const{
    return m_number_of_rounds_isValid;
}

qint32 OAIBettingCSGOGame::getPosition() const {
    return m_position;
}
void OAIBettingCSGOGame::setPosition(const qint32 &position) {
    m_position = position;
    m_position_isSet = true;
}

bool OAIBettingCSGOGame::is_position_Set() const{
    return m_position_isSet;
}

bool OAIBettingCSGOGame::is_position_Valid() const{
    return m_position_isValid;
}

OAIGameStatus OAIBettingCSGOGame::getStatus() const {
    return m_status;
}
void OAIBettingCSGOGame::setStatus(const OAIGameStatus &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIBettingCSGOGame::is_status_Set() const{
    return m_status_isSet;
}

bool OAIBettingCSGOGame::is_status_Valid() const{
    return m_status_isValid;
}

QJsonValue OAIBettingCSGOGame::getVideoUrl() const {
    return m_video_url;
}
void OAIBettingCSGOGame::setVideoUrl(const QJsonValue &video_url) {
    m_video_url = video_url;
    m_video_url_isSet = true;
}

bool OAIBettingCSGOGame::is_video_url_Set() const{
    return m_video_url_isSet;
}

bool OAIBettingCSGOGame::is_video_url_Valid() const{
    return m_video_url_isValid;
}

OAIGameWinner OAIBettingCSGOGame::getWinner() const {
    return m_winner;
}
void OAIBettingCSGOGame::setWinner(const OAIGameWinner &winner) {
    m_winner = winner;
    m_winner_isSet = true;
}

bool OAIBettingCSGOGame::is_winner_Set() const{
    return m_winner_isSet;
}

bool OAIBettingCSGOGame::is_winner_Valid() const{
    return m_winner_isValid;
}

QJsonValue OAIBettingCSGOGame::getWinnerType() const {
    return m_winner_type;
}
void OAIBettingCSGOGame::setWinnerType(const QJsonValue &winner_type) {
    m_winner_type = winner_type;
    m_winner_type_isSet = true;
}

bool OAIBettingCSGOGame::is_winner_type_Set() const{
    return m_winner_type_isSet;
}

bool OAIBettingCSGOGame::is_winner_type_Valid() const{
    return m_winner_type_isValid;
}

bool OAIBettingCSGOGame::isSet() const {
...
bool OAIBettingCSGOGame::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_begin_at_isValid && m_complete_isValid && m_detailed_stats_isValid && m_end_at_isValid && m_finished_isValid && m_forfeit_isValid && m_game_round_teams_isValid && m_id_isValid && m_length_isValid && m_map_isValid && m_match_id_isValid && m_number_of_rounds_isValid && m_position_isValid && m_status_isValid && m_video_url_isValid && m_winner_isValid && m_winner_type_isValid && true;
}
