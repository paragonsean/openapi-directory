...
QJsonValue OAILiveEvent::getBeginAt() const {
    return m_begin_at;
}
void OAILiveEvent::setBeginAt(const QJsonValue &begin_at) {
    m_begin_at = begin_at;
    m_begin_at_isSet = true;
}

bool OAILiveEvent::is_begin_at_Set() const{
    return m_begin_at_isSet;
}

bool OAILiveEvent::is_begin_at_Valid() const{
    return m_begin_at_isValid;
}

QJsonValue OAILiveEvent::getEndAt() const {
    return m_end_at;
}
void OAILiveEvent::setEndAt(const QJsonValue &end_at) {
    m_end_at = end_at;
    m_end_at_isSet = true;
}

bool OAILiveEvent::is_end_at_Set() const{
    return m_end_at_isSet;
}

bool OAILiveEvent::is_end_at_Valid() const{
    return m_end_at_isValid;
}

OAIVideogameSlug OAILiveEvent::getGame() const {
    return m_game;
}
void OAILiveEvent::setGame(const OAIVideogameSlug &game) {
    m_game = game;
    m_game_isSet = true;
}

bool OAILiveEvent::is_game_Set() const{
    return m_game_isSet;
}

bool OAILiveEvent::is_game_Valid() const{
    return m_game_isValid;
}

qint32 OAILiveEvent::getId() const {
    return m_id;
}
void OAILiveEvent::setId(const qint32 &id) {
    m_id = id;
    m_id_isSet = true;
}
...
bool OAILiveEvent::isIsActive() const {
    return m_is_active;
}
void OAILiveEvent::setIsActive(const bool &is_active) {
    m_is_active = is_active;
    m_is_active_isSet = true;
}

bool OAILiveEvent::is_is_active_Set() const{
    return m_is_active_isSet;
}

bool OAILiveEvent::is_is_active_Valid() const{
    return m_is_active_isValid;
}

QJsonValue OAILiveEvent::getStreamUrl() const {
    return m_stream_url;
}
void OAILiveEvent::setStreamUrl(const QJsonValue &stream_url) {
    m_stream_url = stream_url;
    m_stream_url_isSet = true;
}

bool OAILiveEvent::is_stream_url_Set() const{
    return m_stream_url_isSet;
}

bool OAILiveEvent::is_stream_url_Valid() const{
    return m_stream_url_isValid;
}

qint32 OAILiveEvent::getTournamentId() const {
    return m_tournament_id;
}
void OAILiveEvent::setTournamentId(const qint32 &tournament_id) {
    m_tournament_id = tournament_id;
    m_tournament_id_isSet = true;
}

bool OAILiveEvent::is_tournament_id_Set() const{
    return m_tournament_id_isSet;
}

bool OAILiveEvent::is_tournament_id_Valid() const{
...
bool OAILiveEvent::isValid() const {
    ...
    return m_begin_at_isValid && m_end_at_isValid && m_game_isValid && m_id_isValid && m_is_active_isValid && m_stream_url_isValid && m_tournament_id_isValid && true;
}
