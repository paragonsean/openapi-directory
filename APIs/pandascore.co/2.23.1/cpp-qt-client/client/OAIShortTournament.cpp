...
OAIShortTournament::OAIShortTournament(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIShortTournament::OAIShortTournament() {
    this->initializeModel();
}

OAIShortTournament::~OAIShortTournament() {}

void OAIShortTournament::initializeModel() {
...
void OAIShortTournament::fromJson(QString jsonString) {
...
void OAIShortTournament::fromJsonObject(QJsonObject json) {
...
QString OAIShortTournament::asJson() const {
...
QJsonObject OAIShortTournament::asJsonObject() const {
    QJsonObject obj;
    if (m_begin_at.isSet()) {
...
QJsonValue OAIShortTournament::getBeginAt() const {
    return m_begin_at;
}
void OAIShortTournament::setBeginAt(const QJsonValue &begin_at) {
    m_begin_at = begin_at;
    m_begin_at_isSet = true;
}

bool OAIShortTournament::is_begin_at_Set() const{
    return m_begin_at_isSet;
}

bool OAIShortTournament::is_begin_at_Valid() const{
    return m_begin_at_isValid;
}

QJsonValue OAIShortTournament::getEndAt() const {
    return m_end_at;
}
void OAIShortTournament::setEndAt(const QJsonValue &end_at) {
    m_end_at = end_at;
    m_end_at_isSet = true;
}

bool OAIShortTournament::is_end_at_Set() const{
    return m_end_at_isSet;
}

bool OAIShortTournament::is_end_at_Valid() const{
    return m_end_at_isValid;
}

qint32 OAIShortTournament::getId() const {
    return m_id;
}
void OAIShortTournament::setId(const qint32 &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIShortTournament::is_id_Set() const{
    return m_id_isSet;
}

bool OAIShortTournament::is_id_Valid() const{
    return m_id_isValid;
}

OAIBaseLeague OAIShortTournament::getLeague() const {
    return m_league;
}
void OAIShortTournament::setLeague(const OAIBaseLeague &league) {
    m_league = league;
    m_league_isSet = true;
}

bool OAIShortTournament::is_league_Set() const{
    return m_league_isSet;
}

bool OAIShortTournament::is_league_Valid() const{
    return m_league_isValid;
}

qint32 OAIShortTournament::getLeagueId() const {
    return m_league_id;
}
void OAIShortTournament::setLeagueId(const qint32 &league_id) {
    m_league_id = league_id;
    m_league_id_isSet = true;
}

bool OAIShortTournament::is_league_id_Set() const{
    return m_league_id_isSet;
}

bool OAIShortTournament::is_league_id_Valid() const{
    return m_league_id_isValid;
}

bool OAIShortTournament::isLiveSupported() const {
    return m_live_supported;
}
void OAIShortTournament::setLiveSupported(const bool &live_supported) {
    m_live_supported = live_supported;
    m_live_supported_isSet = true;
}

bool OAIShortTournament::is_live_supported_Set() const{
    return m_live_supported_isSet;
}

bool OAIShortTournament::is_live_supported_Valid() const{
    return m_live_supported_isValid;
}

QList<OAIBaseMatch> OAIShortTournament::getMatches() const {
    return m_matches;
}
void OAIShortTournament::setMatches(const QList<OAIBaseMatch> &matches) {
    m_matches = matches;
    m_matches_isSet = true;
}

bool OAIShortTournament::is_matches_Set() const{
    return m_matches_isSet;
}

bool OAIShortTournament::is_matches_Valid() const{
    return m_matches_isValid;
}

QDateTime OAIShortTournament::getModifiedAt() const {
    return m_modified_at;
}
void OAIShortTournament::setModifiedAt(const QDateTime &modified_at) {
    m_modified_at = modified_at;
    m_modified_at_isSet = true;
}

bool OAIShortTournament::is_modified_at_Set() const{
    return m_modified_at_isSet;
}

bool OAIShortTournament::is_modified_at_Valid() const{
    return m_modified_at_isValid;
}

QString OAIShortTournament::getName() const {
    return m_name;
}
void OAIShortTournament::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIShortTournament::is_name_Set() const{
    return m_name_isSet;
}

bool OAIShortTournament::is_name_Valid() const{
    return m_name_isValid;
}

QJsonValue OAIShortTournament::getPrizepool() const {
    return m_prizepool;
}
void OAIShortTournament::setPrizepool(const QJsonValue &prizepool) {
    m_prizepool = prizepool;
    m_prizepool_isSet = true;
}

bool OAIShortTournament::is_prizepool_Set() const{
    return m_prizepool_isSet;
}

bool OAIShortTournament::is_prizepool_Valid() const{
    return m_prizepool_isValid;
}

OAIBaseSerie OAIShortTournament::getSerie() const {
    return m_serie;
}
void OAIShortTournament::setSerie(const OAIBaseSerie &serie) {
    m_serie = serie;
    m_serie_isSet = true;
}

bool OAIShortTournament::is_serie_Set() const{
    return m_serie_isSet;
}

bool OAIShortTournament::is_serie_Valid() const{
    return m_serie_isValid;
}

qint32 OAIShortTournament::getSerieId() const {
    return m_serie_id;
}
void OAIShortTournament::setSerieId(const qint32 &serie_id) {
    m_serie_id = serie_id;
    m_serie_id_isSet = true;
}

bool OAIShortTournament::is_serie_id_Set() const{
    return m_serie_id_isSet;
}

bool OAIShortTournament::is_serie_id_Valid() const{
    return m_serie_id_isValid;
}

QString OAIShortTournament::getSlug() const {
    return m_slug;
}
void OAIShortTournament::setSlug(const QString &slug) {
    m_slug = slug;
    m_slug_isSet = true;
}

bool OAIShortTournament::is_slug_Set() const{
    return m_slug_isSet;
}

bool OAIShortTournament::is_slug_Valid() const{
    return m_slug_isValid;
}

QList<OAIBaseTeam> OAIShortTournament::getTeams() const {
    return m_teams;
}
void OAIShortTournament::setTeams(const QList<OAIBaseTeam> &teams) {
    m_teams = teams;
    m_teams_isSet = true;
}

bool OAIShortTournament::is_teams_Set() const{
    return m_teams_isSet;
}

bool OAIShortTournament::is_teams_Valid() const{
    return m_teams_isValid;
}

OAICurrentVideogame OAIShortTournament::getVideogame() const {
    return m_videogame;
}
void OAIShortTournament::setVideogame(const OAICurrentVideogame &videogame) {
    m_videogame = videogame;
    m_videogame_isSet = true;
}

bool OAIShortTournament::is_videogame_Set() const{
    return m_videogame_isSet;
}

bool OAIShortTournament::is_videogame_Valid() const{
    return m_videogame_isValid;
}

OAIOpponentID_1 OAIShortTournament::getWinnerId() const {
    return m_winner_id;
}
void OAIShortTournament::setWinnerId(const OAIOpponentID_1 &winner_id) {
    m_winner_id = winner_id;
    m_winner_id_isSet = true;
}

bool OAIShortTournament::is_winner_id_Set() const{
    return m_winner_id_isSet;
}

bool OAIShortTournament::is_winner_id_Valid() const{
    return m_winner_id_isValid;
}

QJsonValue OAIShortTournament::getWinnerType() const {
    return m_winner_type;
}
void OAIShortTournament::setWinnerType(const QJsonValue &winner_type) {
    m_winner_type = winner_type;
    m_winner_type_isSet = true;
}

bool OAIShortTournament::is_winner_type_Set() const{
    return m_winner_type_isSet;
}

bool OAIShortTournament::is_winner_type_Valid() const{
    return m_winner_type_isValid;
}

bool OAIShortTournament::isSet() const {
...
bool OAIShortTournament::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_begin_at_isValid && m_end_at_isValid && m_id_isValid && m_league_isValid && m_league_id_isValid && m_live_supported_isValid && m_matches_isValid && m_modified_at_isValid && m_name_isValid && m_prizepool_isValid && m_serie_isValid && m_serie_id_isValid && m_slug_isValid && m_teams_isValid && m_videogame_isValid && m_winner_id_isValid && m_winner_type_isValid && true;
}
