...
/*
 * OAIBettingDota2Game.h
 *
 * 
 */

#ifndef OAIBettingDota2Game_H
#define OAIBettingDota2Game_H
...
class OAIBettingDota2Game : public OAIObject {
public:
    OAIBettingDota2Game();
    OAIBettingDota2Game(QString json);
    ~OAIBettingDota2Game() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBettingDota2Game)

#endif // OAIBettingDota2Game_H
