...
#ifndef OAIBaseLeague_H
#define OAIBaseLeague_H
...
class OAIBaseLeague : public OAIObject {
public:
    OAIBaseLeague();
    OAIBaseLeague(QString json);
    ~OAIBaseLeague() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBaseLeague)

#endif // OAIBaseLeague_H
