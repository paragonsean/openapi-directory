...
#ifndef OAIBettingSerie_H
#define OAIBettingSerie_H
...
class OAIBettingSerie : public OAIObject {
public:
    OAIBettingSerie();
    OAIBettingSerie(QString json);
    ~OAIBettingSerie() override;
    ...
    QJsonValue getLeagueImageUrl() const;
    void setLeagueImageUrl(const QJsonValue &league_image_url);
...
Q_DECLARE_METATYPE(OpenAPI::OAIBettingSerie)

#endif // OAIBettingSerie_H
