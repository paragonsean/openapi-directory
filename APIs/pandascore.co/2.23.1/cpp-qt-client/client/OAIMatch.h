...
public:
    ...
    OAIBaseLeague getLeague() const;
    void setLeague(const OAIBaseLeague &league);
    ...
    OAIBaseSerie getSerie() const;
    void setSerie(const OAIBaseSerie &serie);
    ...
    OAIBaseTournament getTournament() const;
    void setTournament(const OAIBaseTournament &tournament);
...
private:
    ...
    OAIBaseTournament m_tournament;
