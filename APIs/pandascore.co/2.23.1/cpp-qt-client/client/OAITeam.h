...
public:
    ...
    QJsonValue getAcronym() const;
    void setAcronym(const QJsonValue &acronym);
    ...
    QJsonValue getLocation() const;
    void setLocation(const QJsonValue &location);
