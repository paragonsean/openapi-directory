...
#ifndef OAIBettingSerie_1_H
#define OAIBettingSerie_1_H

#include <QJsonObject>

#include "OAICurrentVideogame.h"
#include "OAIObject.h"
...
class OAIBettingSerie_1 : public OAIObject {
public:
    OAIBettingSerie_1();
    OAIBettingSerie_1(QString json);
    ~OAIBettingSerie_1() override;
    ...
    OAIObject getBeginAt() const;
    void setBeginAt(const OAIObject &begin_at);
    ...
    OAIObject getEndAt() const;
    void setEndAt(const OAIObject &end_at);
    ...
    OAIObject getLeagueImageUrl() const;
    void setLeagueImageUrl(const OAIObject &league_image_url);
    bool is_league_image_url_Set() const;
    bool is_league_image_url_Valid() const;

    QString getLeagueName() const;
    void setLeagueName(const QString &league_name);
    bool is_league_name_Set() const;
    bool is_league_name_Valid() const;
    ...
    OAIObject getName() const;
    void setName(const OAIObject &name);
    bool is_name_Set() const;
    bool is_name_Valid() const;

    OAIObject getSeason() const;
    void setSeason(const OAIObject &season);
    ...
    OAIObject getTier() const;
    void setTier(const OAIObject &tier);
    bool is_tier_Set() const;
    bool is_tier_Valid() const;

    OAICurrentVideogame getVideogame() const;
    void setVideogame(const OAICurrentVideogame &videogame);
    bool is_videogame_Set() const;
    bool is_videogame_Valid() const;
    ...
    OAIObject getWinnerType() const;
    void setWinnerType(const OAIObject &winner_type);
...
private:
    ...
    OAIObject m_league_image_url;
    bool m_league_image_url_isSet;
    bool m_league_image_url_isValid;

    QString m_league_name;
    bool m_league_name_isSet;
    bool m_league_name_isValid;
    ...
    OAICurrentVideogame m_videogame;
    bool m_videogame_isSet;
    bool m_videogame_isValid;

    OAIOpponentID_1 m_winner_id;
    bool m_winner_id_isSet;
    bool m_winner_id_isValid;

    OAIObject m_winner_type;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBettingSerie_1)

#endif // OAIBettingSerie_1_H
