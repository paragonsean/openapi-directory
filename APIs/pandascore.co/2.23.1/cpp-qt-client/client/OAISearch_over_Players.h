...
/*
 * OAISearch_over_Players.h
 *
 * 
 */

#ifndef OAISearch_over_Players_H
#define OAISearch_over_Players_H
...
class OAISearch_over_Players : public OAIObject {
public:
    OAISearch_over_Players();
    OAISearch_over_Players(QString json);
    ~OAISearch_over_Players() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISearch_over_Players)

#endif // OAISearch_over_Players_H
