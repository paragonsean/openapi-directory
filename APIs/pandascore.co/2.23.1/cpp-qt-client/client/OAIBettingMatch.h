...
#ifndef OAIBettingMatch_H
#define OAIBettingMatch_H

#include <QJsonObject>

#include "OAIBaseOpponent_1.h"
#include "OAIBettingBaseTournament.h"
#include "OAIBettingGame.h"
#include "OAIBettingLeague_1.h"
#include "OAIBettingMatchStatus.h"
...
namespace OpenAPI {
class OAIBettingMetadata;
class OAIBettingGame;
class OAIBettingLeague_1;
class OAIMatchLive;
class OAIOpponent;
class OAIMatchResult;
class OAIBettingSerie_1;
class OAIMatchLocalizedStreams;
class OAIStream;
class OAIBettingBaseTournament;
class OAIShortVideogameVersion_1;
class OAIBaseOpponent_1;

class OAIBettingMatch : public OAIObject {
public:
    OAIBettingMatch();
    OAIBettingMatch(QString json);
    ~OAIBettingMatch() override;
    ...
    OAIBettingMetadata getBettingMetadata() const;
    void setBettingMetadata(const OAIBettingMetadata &betting_metadata);
    bool is_betting_metadata_Set() const;
    bool is_betting_metadata_Valid() const;
    ...
    QList<OAIBettingGame> getGames() const;
    void setGames(const QList<OAIBettingGame> &games);
    ...
    OAIBettingLeague_1 getLeague() const;
    void setLeague(const OAIBettingLeague_1 &league);
    ...
    QJsonValue getRescheduled() const;
    void setRescheduled(const QJsonValue &rescheduled);
    bool is_rescheduled_Set() const;
    bool is_rescheduled_Valid() const;

    QList<OAIMatchResult> getResults() const;
    void setResults(const QList<OAIMatchResult> &results);
    ...
    OAIBettingSerie_1 getSerie() const;
    void setSerie(const OAIBettingSerie_1 &serie);
    ...
    OAIBettingMatchStatus getStatus() const;
    void setStatus(const OAIBettingMatchStatus &status);
    ...
    OAIBettingBaseTournament getTournament() const;
    void setTournament(const OAIBettingBaseTournament &tournament);
    ...
    OAIShortVideogameVersion_1 getVideogameVersion() const;
    void setVideogameVersion(const OAIShortVideogameVersion_1 &videogame_version);
    bool is_videogame_version_Set() const;
    bool is_videogame_version_Valid() const;

    OAIBaseOpponent_1 getWinner() const;
    void setWinner(const OAIBaseOpponent_1 &winner);
...
private:
    ...
    OAIBettingMetadata m_betting_metadata;
    bool m_betting_metadata_isSet;
    bool m_betting_metadata_isValid;
    ...
    QJsonValue m_rescheduled;
    bool m_rescheduled_isSet;
    bool m_rescheduled_isValid;

    QList<OAIMatchResult> m_results;
    ...
    OAIBettingMatchStatus m_status;
    bool m_status_isSet;
    ...
    OAIBettingBaseTournament m_tournament;
    ...
    OAIShortVideogameVersion_1 m_videogame_version;
    bool m_videogame_version_isSet;
    bool m_videogame_version_isValid;

    OAIBaseOpponent_1 m_winner;
    bool m_winner_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBettingMatch)

#endif // OAIBettingMatch_H
