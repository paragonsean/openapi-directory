...
QJsonValue OAIMarket::getLine() const {
    return m_line;
}
void OAIMarket::setLine(const QJsonValue &line) {
    m_line = line;
    m_line_isSet = true;
}

bool OAIMarket::is_line_Set() const{
    return m_line_isSet;
}

bool OAIMarket::is_line_Valid() const{
    return m_line_isValid;
}

double OAIMarket::getMargin() const {
    return m_margin;
}
void OAIMarket::setMargin(const double &margin) {
    m_margin = margin;
    m_margin_isSet = true;
}

bool OAIMarket::is_margin_Set() const{
    return m_margin_isSet;
}

bool OAIMarket::is_margin_Valid() const{
...
OAIOpponentID_1 OAIMarket::getParticipantId() const {
    return m_participant_id;
}
void OAIMarket::setParticipantId(const OAIOpponentID_1 &participant_id) {
    m_participant_id = participant_id;
    m_participant_id_isSet = true;
}

bool OAIMarket::is_participant_id_Set() const{
    return m_participant_id_isSet;
}

bool OAIMarket::is_participant_id_Valid() const{
    return m_participant_id_isValid;
}

QJsonValue OAIMarket::getParticipantType() const {
    return m_participant_type;
}
void OAIMarket::setParticipantType(const QJsonValue &participant_type) {
    m_participant_type = participant_type;
    m_participant_type_isSet = true;
}

bool OAIMarket::is_participant_type_Set() const{
    return m_participant_type_isSet;
}

bool OAIMarket::is_participant_type_Valid() const{
    return m_participant_type_isValid;
}

QList<OAIMarketSelection> OAIMarket::getSelections() const {
    return m_selections;
}
void OAIMarket::setSelections(const QList<OAIMarketSelection> &selections) {
...
OAIMarketStatus OAIMarket::getStatus() const {
    return m_status;
}
void OAIMarket::setStatus(const OAIMarketStatus &status) {
    m_status = status;
    m_status_isSet = true;
}
...
QString OAIMarket::getRTemplate() const {
    return m_r_template;
}
void OAIMarket::setRTemplate(const QString &r_template) {
    m_r_template = r_template;
    m_r_template_isSet = true;
}

bool OAIMarket::is_r_template_Set() const{
    return m_r_template_isSet;
}

bool OAIMarket::is_r_template_Valid() const{
...
bool OAIMarket::isValid() const {
    ...
    return m_id_isValid && m_line_isValid && m_margin_isValid && m_name_isValid && m_participant_id_isValid && m_participant_type_isValid && m_selections_isValid && m_status_isValid && m_r_template_isValid && true;
}
