...
#ifndef OAIBaseSerie_H
#define OAIBaseSerie_H
...
class OAIBaseSerie : public OAIObject {
public:
    OAIBaseSerie();
    OAIBaseSerie(QString json);
    ~OAIBaseSerie() override;
    ...
    QJsonValue getSeason() const;
    void setSeason(const QJsonValue &season);
    ...
    QJsonValue getTier() const;
    void setTier(const QJsonValue &tier);
...
Q_DECLARE_METATYPE(OpenAPI::OAIBaseSerie)

#endif // OAIBaseSerie_H
