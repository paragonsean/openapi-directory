...
/*
 * OAIBettingPUBGGame.h
 *
 * 
 */

#ifndef OAIBettingPUBGGame_H
#define OAIBettingPUBGGame_H
...
class OAIBettingPUBGGame : public OAIObject {
public:
    OAIBettingPUBGGame();
    OAIBettingPUBGGame(QString json);
    ~OAIBettingPUBGGame() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBettingPUBGGame)

#endif // OAIBettingPUBGGame_H
