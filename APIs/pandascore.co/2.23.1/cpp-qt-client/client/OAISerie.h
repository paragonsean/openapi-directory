...
public:
    ...
    QList<OAIBaseTournament> getTournaments() const;
    void setTournaments(const QList<OAIBaseTournament> &tournaments);
    bool is_tournaments_Set() const;
    bool is_tournaments_Valid() const;
    ...
    OAIVideogameTitle_1 getVideogameTitle() const;
    void setVideogameTitle(const OAIVideogameTitle_1 &videogame_title);
    bool is_videogame_title_Set() const;
    bool is_videogame_title_Valid() const;
...
private:
    ...
    QList<OAIBaseTournament> m_tournaments;
    bool m_tournaments_isSet;
    bool m_tournaments_isValid;

    OAICurrentVideogame m_videogame;
    bool m_videogame_isSet;
    bool m_videogame_isValid;

    OAIVideogameTitle_1 m_videogame_title;
    bool m_videogame_title_isSet;
    bool m_videogame_title_isValid;
