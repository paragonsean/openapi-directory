...
#ifndef OAIBaseTournament_H
#define OAIBaseTournament_H
...
class OAIBaseTournament : public OAIObject {
public:
    OAIBaseTournament();
    OAIBaseTournament(QString json);
    ~OAIBaseTournament() override;
    ...
    QJsonValue getPrizepool() const;
    void setPrizepool(const QJsonValue &prizepool);
    bool is_prizepool_Set() const;
    bool is_prizepool_Valid() const;

    qint32 getSerieId() const;
    void setSerieId(const qint32 &serie_id);
...
Q_DECLARE_METATYPE(OpenAPI::OAIBaseTournament)

#endif // OAIBaseTournament_H
