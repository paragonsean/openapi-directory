...
QJsonValue OAIStream::getEmbedUrl() const {
    return m_embed_url;
}
void OAIStream::setEmbedUrl(const QJsonValue &embed_url) {
    m_embed_url = embed_url;
    m_embed_url_isSet = true;
}

bool OAIStream::is_embed_url_Set() const{
    return m_embed_url_isSet;
}

bool OAIStream::is_embed_url_Valid() const{
    return m_embed_url_isValid;
}

OAIStreamLanguage OAIStream::getLanguage() const {
    return m_language;
}
void OAIStream::setLanguage(const OAIStreamLanguage &language) {
    m_language = language;
    m_language_isSet = true;
}

bool OAIStream::is_language_Set() const{
    return m_language_isSet;
}

bool OAIStream::is_language_Valid() const{
    return m_language_isValid;
}

bool OAIStream::isMain() const {
    return m_main;
}
void OAIStream::setMain(const bool &main) {
    m_main = main;
    m_main_isSet = true;
}

bool OAIStream::is_main_Set() const{
    return m_main_isSet;
}

bool OAIStream::is_main_Valid() const{
    return m_main_isValid;
}

bool OAIStream::isOfficial() const {
    return m_official;
}
void OAIStream::setOfficial(const bool &official) {
    m_official = official;
    m_official_isSet = true;
}

bool OAIStream::is_official_Set() const{
    return m_official_isSet;
}

bool OAIStream::is_official_Valid() const{
    return m_official_isValid;
}

QString OAIStream::getRawUrl() const {
    return m_raw_url;
}
void OAIStream::setRawUrl(const QString &raw_url) {
    m_raw_url = raw_url;
    m_raw_url_isSet = true;
}

bool OAIStream::is_raw_url_Set() const{
    return m_raw_url_isSet;
}

bool OAIStream::is_raw_url_Valid() const{
...
bool OAIStream::isValid() const {
    ...
    return m_embed_url_isValid && m_language_isValid && m_main_isValid && m_official_isValid && m_raw_url_isValid && true;
}
