...
#ifndef OAIGroupStanding_H
#define OAIGroupStanding_H
...
class OAIGroupStanding : public OAIObject {
public:
    OAIGroupStanding();
    OAIGroupStanding(QString json);
    ~OAIGroupStanding() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGroupStanding)

#endif // OAIGroupStanding_H
