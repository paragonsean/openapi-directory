...
QJsonValue OAIGame::getBeginAt() const {
    return m_begin_at;
}
void OAIGame::setBeginAt(const QJsonValue &begin_at) {
    m_begin_at = begin_at;
    m_begin_at_isSet = true;
}

bool OAIGame::is_begin_at_Set() const{
    return m_begin_at_isSet;
}

bool OAIGame::is_begin_at_Valid() const{
    return m_begin_at_isValid;
}

bool OAIGame::isComplete() const {
    return m_complete;
}
void OAIGame::setComplete(const bool &complete) {
    m_complete = complete;
    m_complete_isSet = true;
}

bool OAIGame::is_complete_Set() const{
    return m_complete_isSet;
}

bool OAIGame::is_complete_Valid() const{
    return m_complete_isValid;
}

bool OAIGame::isDetailedStats() const {
    return m_detailed_stats;
}
void OAIGame::setDetailedStats(const bool &detailed_stats) {
    m_detailed_stats = detailed_stats;
    m_detailed_stats_isSet = true;
}

bool OAIGame::is_detailed_stats_Set() const{
    return m_detailed_stats_isSet;
}

bool OAIGame::is_detailed_stats_Valid() const{
    return m_detailed_stats_isValid;
}

QJsonValue OAIGame::getEndAt() const {
    return m_end_at;
}
void OAIGame::setEndAt(const QJsonValue &end_at) {
    m_end_at = end_at;
    m_end_at_isSet = true;
}

bool OAIGame::is_end_at_Set() const{
    return m_end_at_isSet;
}

bool OAIGame::is_end_at_Valid() const{
    return m_end_at_isValid;
}

bool OAIGame::isFinished() const {
    return m_finished;
}
void OAIGame::setFinished(const bool &finished) {
    m_finished = finished;
    m_finished_isSet = true;
}

bool OAIGame::is_finished_Set() const{
    return m_finished_isSet;
}

bool OAIGame::is_finished_Valid() const{
    return m_finished_isValid;
}

bool OAIGame::isForfeit() const {
    return m_forfeit;
}
void OAIGame::setForfeit(const bool &forfeit) {
    m_forfeit = forfeit;
    m_forfeit_isSet = true;
}

bool OAIGame::is_forfeit_Set() const{
    return m_forfeit_isSet;
}

bool OAIGame::is_forfeit_Valid() const{
    return m_forfeit_isValid;
}

OAIGameID OAIGame::getId() const {
    return m_id;
}
void OAIGame::setId(const OAIGameID &id) {
    m_id = id;
    m_id_isSet = true;
}
...
QJsonValue OAIGame::getLength() const {
    return m_length;
}
void OAIGame::setLength(const QJsonValue &length) {
    m_length = length;
    m_length_isSet = true;
}

bool OAIGame::is_length_Set() const{
    return m_length_isSet;
}

bool OAIGame::is_length_Valid() const{
    return m_length_isValid;
}

qint32 OAIGame::getMatchId() const {
    return m_match_id;
}
void OAIGame::setMatchId(const qint32 &match_id) {
    m_match_id = match_id;
    m_match_id_isSet = true;
}

bool OAIGame::is_match_id_Set() const{
    return m_match_id_isSet;
}

bool OAIGame::is_match_id_Valid() const{
    return m_match_id_isValid;
}

qint32 OAIGame::getPosition() const {
    return m_position;
}
void OAIGame::setPosition(const qint32 &position) {
    m_position = position;
    m_position_isSet = true;
}

bool OAIGame::is_position_Set() const{
    return m_position_isSet;
}

bool OAIGame::is_position_Valid() const{
    return m_position_isValid;
}

OAIGameStatus OAIGame::getStatus() const {
    return m_status;
}
void OAIGame::setStatus(const OAIGameStatus &status) {
    m_status = status;
    m_status_isSet = true;
}
...
QJsonValue OAIGame::getVideoUrl() const {
    return m_video_url;
}
void OAIGame::setVideoUrl(const QJsonValue &video_url) {
    m_video_url = video_url;
    m_video_url_isSet = true;
}

bool OAIGame::is_video_url_Set() const{
    return m_video_url_isSet;
}

bool OAIGame::is_video_url_Valid() const{
    return m_video_url_isValid;
}

OAIGameWinner OAIGame::getWinner() const {
    return m_winner;
}
void OAIGame::setWinner(const OAIGameWinner &winner) {
    m_winner = winner;
    m_winner_isSet = true;
}
...
QJsonValue OAIGame::getWinnerType() const {
    return m_winner_type;
}
void OAIGame::setWinnerType(const QJsonValue &winner_type) {
    m_winner_type = winner_type;
    m_winner_type_isSet = true;
}

bool OAIGame::is_winner_type_Set() const{
    return m_winner_type_isSet;
}

bool OAIGame::is_winner_type_Valid() const{
