...
/*
 * OAIMatchTeamResult.h
 *
 * 
 */

#ifndef OAIMatchTeamResult_H
#define OAIMatchTeamResult_H
...
class OAIMatchTeamResult : public OAIObject {
public:
    OAIMatchTeamResult();
    OAIMatchTeamResult(QString json);
    ~OAIMatchTeamResult() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMatchTeamResult)

#endif // OAIMatchTeamResult_H
