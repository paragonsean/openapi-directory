...
/*
 * OAIVideogameLeague.h
 *
 * 
 */

#ifndef OAIVideogameLeague_H
#define OAIVideogameLeague_H
...
class OAIVideogameLeague : public OAIObject {
public:
    OAIVideogameLeague();
    OAIVideogameLeague(QString json);
    ~OAIVideogameLeague() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIVideogameLeague)

#endif // OAIVideogameLeague_H
