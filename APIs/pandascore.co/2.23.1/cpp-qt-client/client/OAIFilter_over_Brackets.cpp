...
OAIFilter_over_Brackets::OAIFilter_over_Brackets(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIFilter_over_Brackets::OAIFilter_over_Brackets() {
    this->initializeModel();
}

OAIFilter_over_Brackets::~OAIFilter_over_Brackets() {}

void OAIFilter_over_Brackets::initializeModel() {
...
void OAIFilter_over_Brackets::fromJson(QString jsonString) {
...
void OAIFilter_over_Brackets::fromJsonObject(QJsonObject json) {
...
QString OAIFilter_over_Brackets::asJson() const {
...
QJsonObject OAIFilter_over_Brackets::asJsonObject() const {
    QJsonObject obj;
...
QList<QDateTime> OAIFilter_over_Brackets::getBeginAt() const {
    return m_begin_at;
}
void OAIFilter_over_Brackets::setBeginAt(const QList<QDateTime> &begin_at) {
    m_begin_at = begin_at;
    m_begin_at_isSet = true;
}

bool OAIFilter_over_Brackets::is_begin_at_Set() const{
    return m_begin_at_isSet;
}

bool OAIFilter_over_Brackets::is_begin_at_Valid() const{
    return m_begin_at_isValid;
}

bool OAIFilter_over_Brackets::isDetailedStats() const {
    return m_detailed_stats;
}
void OAIFilter_over_Brackets::setDetailedStats(const bool &detailed_stats) {
    m_detailed_stats = detailed_stats;
    m_detailed_stats_isSet = true;
}

bool OAIFilter_over_Brackets::is_detailed_stats_Set() const{
    return m_detailed_stats_isSet;
}

bool OAIFilter_over_Brackets::is_detailed_stats_Valid() const{
    return m_detailed_stats_isValid;
}

bool OAIFilter_over_Brackets::isDraw() const {
    return m_draw;
}
void OAIFilter_over_Brackets::setDraw(const bool &draw) {
    m_draw = draw;
    m_draw_isSet = true;
}

bool OAIFilter_over_Brackets::is_draw_Set() const{
    return m_draw_isSet;
}

bool OAIFilter_over_Brackets::is_draw_Valid() const{
    return m_draw_isValid;
}

QList<QDateTime> OAIFilter_over_Brackets::getEndAt() const {
    return m_end_at;
}
void OAIFilter_over_Brackets::setEndAt(const QList<QDateTime> &end_at) {
    m_end_at = end_at;
    m_end_at_isSet = true;
}

bool OAIFilter_over_Brackets::is_end_at_Set() const{
    return m_end_at_isSet;
}

bool OAIFilter_over_Brackets::is_end_at_Valid() const{
    return m_end_at_isValid;
}

bool OAIFilter_over_Brackets::isForfeit() const {
    return m_forfeit;
}
void OAIFilter_over_Brackets::setForfeit(const bool &forfeit) {
    m_forfeit = forfeit;
    m_forfeit_isSet = true;
}

bool OAIFilter_over_Brackets::is_forfeit_Set() const{
    return m_forfeit_isSet;
}

bool OAIFilter_over_Brackets::is_forfeit_Valid() const{
    return m_forfeit_isValid;
}

QList<OAIOpponentID> OAIFilter_over_Brackets::getGameAdvantage() const {
    return m_game_advantage;
}
void OAIFilter_over_Brackets::setGameAdvantage(const QList<OAIOpponentID> &game_advantage) {
    m_game_advantage = game_advantage;
    m_game_advantage_isSet = true;
}

bool OAIFilter_over_Brackets::is_game_advantage_Set() const{
    return m_game_advantage_isSet;
}

bool OAIFilter_over_Brackets::is_game_advantage_Valid() const{
    return m_game_advantage_isValid;
}

QList<qint32> OAIFilter_over_Brackets::getId() const {
    return m_id;
}
void OAIFilter_over_Brackets::setId(const QList<qint32> &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIFilter_over_Brackets::is_id_Set() const{
    return m_id_isSet;
}

bool OAIFilter_over_Brackets::is_id_Valid() const{
    return m_id_isValid;
}

QList<QString> OAIFilter_over_Brackets::getLiveEmbedUrl() const {
    return m_live_embed_url;
}
void OAIFilter_over_Brackets::setLiveEmbedUrl(const QList<QString> &live_embed_url) {
    m_live_embed_url = live_embed_url;
    m_live_embed_url_isSet = true;
}

bool OAIFilter_over_Brackets::is_live_embed_url_Set() const{
    return m_live_embed_url_isSet;
}

bool OAIFilter_over_Brackets::is_live_embed_url_Valid() const{
    return m_live_embed_url_isValid;
}

QList<OAIMatchType> OAIFilter_over_Brackets::getMatchType() const {
    return m_match_type;
}
void OAIFilter_over_Brackets::setMatchType(const QList<OAIMatchType> &match_type) {
    m_match_type = match_type;
    m_match_type_isSet = true;
}

bool OAIFilter_over_Brackets::is_match_type_Set() const{
    return m_match_type_isSet;
}

bool OAIFilter_over_Brackets::is_match_type_Valid() const{
    return m_match_type_isValid;
}

QList<QDateTime> OAIFilter_over_Brackets::getModifiedAt() const {
    return m_modified_at;
}
void OAIFilter_over_Brackets::setModifiedAt(const QList<QDateTime> &modified_at) {
    m_modified_at = modified_at;
    m_modified_at_isSet = true;
}

bool OAIFilter_over_Brackets::is_modified_at_Set() const{
    return m_modified_at_isSet;
}

bool OAIFilter_over_Brackets::is_modified_at_Valid() const{
    return m_modified_at_isValid;
}

QList<QString> OAIFilter_over_Brackets::getName() const {
    return m_name;
}
void OAIFilter_over_Brackets::setName(const QList<QString> &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIFilter_over_Brackets::is_name_Set() const{
    return m_name_isSet;
}

bool OAIFilter_over_Brackets::is_name_Valid() const{
    return m_name_isValid;
}

QList<qint32> OAIFilter_over_Brackets::getNumberOfGames() const {
    return m_number_of_games;
}
void OAIFilter_over_Brackets::setNumberOfGames(const QList<qint32> &number_of_games) {
    m_number_of_games = number_of_games;
    m_number_of_games_isSet = true;
}

bool OAIFilter_over_Brackets::is_number_of_games_Set() const{
    return m_number_of_games_isSet;
}

bool OAIFilter_over_Brackets::is_number_of_games_Valid() const{
    return m_number_of_games_isValid;
}

QList<QString> OAIFilter_over_Brackets::getOfficialStreamUrl() const {
    return m_official_stream_url;
}
void OAIFilter_over_Brackets::setOfficialStreamUrl(const QList<QString> &official_stream_url) {
    m_official_stream_url = official_stream_url;
    m_official_stream_url_isSet = true;
}

bool OAIFilter_over_Brackets::is_official_stream_url_Set() const{
    return m_official_stream_url_isSet;
}

bool OAIFilter_over_Brackets::is_official_stream_url_Valid() const{
    return m_official_stream_url_isValid;
}

QList<QDateTime> OAIFilter_over_Brackets::getOriginalScheduledAt() const {
    return m_original_scheduled_at;
}
void OAIFilter_over_Brackets::setOriginalScheduledAt(const QList<QDateTime> &original_scheduled_at) {
    m_original_scheduled_at = original_scheduled_at;
    m_original_scheduled_at_isSet = true;
}

bool OAIFilter_over_Brackets::is_original_scheduled_at_Set() const{
    return m_original_scheduled_at_isSet;
}

bool OAIFilter_over_Brackets::is_original_scheduled_at_Valid() const{
    return m_original_scheduled_at_isValid;
}

QList<QDateTime> OAIFilter_over_Brackets::getScheduledAt() const {
    return m_scheduled_at;
}
void OAIFilter_over_Brackets::setScheduledAt(const QList<QDateTime> &scheduled_at) {
    m_scheduled_at = scheduled_at;
    m_scheduled_at_isSet = true;
}

bool OAIFilter_over_Brackets::is_scheduled_at_Set() const{
    return m_scheduled_at_isSet;
}

bool OAIFilter_over_Brackets::is_scheduled_at_Valid() const{
    return m_scheduled_at_isValid;
}

QList<QString> OAIFilter_over_Brackets::getSlug() const {
    return m_slug;
}
void OAIFilter_over_Brackets::setSlug(const QList<QString> &slug) {
    m_slug = slug;
    m_slug_isSet = true;
}

bool OAIFilter_over_Brackets::is_slug_Set() const{
    return m_slug_isSet;
}

bool OAIFilter_over_Brackets::is_slug_Valid() const{
    return m_slug_isValid;
}

QList<OAIMatchStatus> OAIFilter_over_Brackets::getStatus() const {
    return m_status;
}
void OAIFilter_over_Brackets::setStatus(const QList<OAIMatchStatus> &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIFilter_over_Brackets::is_status_Set() const{
    return m_status_isSet;
}

bool OAIFilter_over_Brackets::is_status_Valid() const{
    return m_status_isValid;
}

QList<qint32> OAIFilter_over_Brackets::getTournamentId() const {
    return m_tournament_id;
}
void OAIFilter_over_Brackets::setTournamentId(const QList<qint32> &tournament_id) {
    m_tournament_id = tournament_id;
    m_tournament_id_isSet = true;
}

bool OAIFilter_over_Brackets::is_tournament_id_Set() const{
    return m_tournament_id_isSet;
}

bool OAIFilter_over_Brackets::is_tournament_id_Valid() const{
    return m_tournament_id_isValid;
}

QList<OAIOpponentID> OAIFilter_over_Brackets::getWinnerId() const {
    return m_winner_id;
}
void OAIFilter_over_Brackets::setWinnerId(const QList<OAIOpponentID> &winner_id) {
    m_winner_id = winner_id;
    m_winner_id_isSet = true;
}

bool OAIFilter_over_Brackets::is_winner_id_Set() const{
    return m_winner_id_isSet;
}

bool OAIFilter_over_Brackets::is_winner_id_Valid() const{
    return m_winner_id_isValid;
}

bool OAIFilter_over_Brackets::isSet() const {
...
bool OAIFilter_over_Brackets::isValid() const {
