...
#ifndef OAIBaseMatch_H
#define OAIBaseMatch_H
...
class OAIBaseMatch : public OAIObject {
public:
    OAIBaseMatch();
    OAIBaseMatch(QString json);
    ~OAIBaseMatch() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBaseMatch)

#endif // OAIBaseMatch_H
