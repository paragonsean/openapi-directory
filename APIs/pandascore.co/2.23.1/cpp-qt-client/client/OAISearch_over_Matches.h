...
/*
 * OAISearch_over_Matches.h
 *
 * 
 */

#ifndef OAISearch_over_Matches_H
#define OAISearch_over_Matches_H
...
class OAISearch_over_Matches : public OAIObject {
public:
    OAISearch_over_Matches();
    OAISearch_over_Matches(QString json);
    ~OAISearch_over_Matches() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISearch_over_Matches)

#endif // OAISearch_over_Matches_H
