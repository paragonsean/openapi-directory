...
<a id="v1CharitybasicPost"></a>
# **v1CharitybasicPost**
> v1CharitybasicPost(ein)
...
import org.openapitools.client.api.DetailsApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      apiInstance.v1CharitybasicPost(ein);
    } catch (ApiException e) {
      System.err.println("Exception when calling DetailsApi#v1CharitybasicPost");
