...
<a id="v1CharitygeolocationPost"></a>
# **v1CharitygeolocationPost**
> v1CharitygeolocationPost(ein)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      apiInstance.v1CharitygeolocationPost(ein);
    } catch (ApiException e) {
      System.err.println("Exception when calling GeoLocationApi#v1CharitygeolocationPost");
