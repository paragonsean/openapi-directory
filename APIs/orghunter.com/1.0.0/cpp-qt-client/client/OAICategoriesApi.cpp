...
void OAICategoriesApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("get_categories", defaultConf);
    _serverIndices.insert("get_categories", 0);
}
...
void OAICategoriesApi::get_categories() {
    QString fullPath = QString(_serverConfigs["get_categories"][_serverIndices.value("get_categories")].URL()+"/v1/categories");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAICategoriesApi::get_categoriesCallback);
...
void OAICategoriesApi::get_categoriesCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT get_categoriesSignal();
        Q_EMIT get_categoriesSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT get_categoriesSignalE(error_type, error_str);
        Q_EMIT get_categoriesSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT get_categoriesSignalError(error_type, error_str);
        Q_EMIT get_categoriesSignalErrorFull(worker, error_type, error_str);
    }
}
