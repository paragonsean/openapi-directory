...
void OAIGeneralApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("connectionDetailsPost", defaultConf);
    _serverIndices.insert("connectionDetailsPost", 0);
    _serverConfigs.insert("isAlivePost", defaultConf);
    _serverIndices.insert("isAlivePost", 0);
}
...
void OAIGeneralApi::connectionDetailsPost(const OAIConnectionDetailsRequest &body) {
    QString fullPath = QString(_serverConfigs["connectionDetailsPost"][_serverIndices.value("connectionDetailsPost")].URL()+"/ConnectionDetails");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIGeneralApi::connectionDetailsPostCallback);
...
void OAIGeneralApi::connectionDetailsPostCallback(OAIHttpRequestWorker *worker) {
    ...
    OAIConnectionDetailsResult output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT connectionDetailsPostSignal(output);
        Q_EMIT connectionDetailsPostSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT connectionDetailsPostSignalE(output, error_type, error_str);
        Q_EMIT connectionDetailsPostSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT connectionDetailsPostSignalError(output, error_type, error_str);
        Q_EMIT connectionDetailsPostSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIGeneralApi::isAlivePost(const OAIIsAliveRequest &body) {
    QString fullPath = QString(_serverConfigs["isAlivePost"][_serverIndices.value("isAlivePost")].URL()+"/IsAlive");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIGeneralApi::isAlivePostCallback);
    connect(this, &OAIGeneralApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIGeneralApi::isAlivePostCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    OAIIsAliveResult output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT isAlivePostSignal(output);
        Q_EMIT isAlivePostSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT isAlivePostSignalE(output, error_type, error_str);
        Q_EMIT isAlivePostSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT isAlivePostSignalError(output, error_type, error_str);
        Q_EMIT isAlivePostSignalErrorFull(worker, error_type, error_str);
    }
}
