...
#ifndef OAIIsAliveRequest_H
#define OAIIsAliveRequest_H
...
class OAIIsAliveRequest : public OAIObject {
public:
    OAIIsAliveRequest();
    OAIIsAliveRequest(QString json);
    ~OAIIsAliveRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIIsAliveRequest)

#endif // OAIIsAliveRequest_H
