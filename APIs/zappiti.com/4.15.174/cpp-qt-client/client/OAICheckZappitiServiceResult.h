...
/*
 * OAICheckZappitiServiceResult.h
 *
 * 
 */

#ifndef OAICheckZappitiServiceResult_H
#define OAICheckZappitiServiceResult_H
...
class OAICheckZappitiServiceResult : public OAIObject {
public:
    OAICheckZappitiServiceResult();
    OAICheckZappitiServiceResult(QString json);
    ~OAICheckZappitiServiceResult() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICheckZappitiServiceResult)

#endif // OAICheckZappitiServiceResult_H
