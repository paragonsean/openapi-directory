...
/*
 * OAIStartVideoResult.h
 *
 * 
 */

#ifndef OAIStartVideoResult_H
#define OAIStartVideoResult_H
...
class OAIStartVideoResult : public OAIObject {
public:
    OAIStartVideoResult();
    OAIStartVideoResult(QString json);
    ~OAIStartVideoResult() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStartVideoResult)

#endif // OAIStartVideoResult_H
