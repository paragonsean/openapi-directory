...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ZappitiPlayerApi.StartVideoRequest();
  });
  ...
  describe('StartVideoRequest', function() {
    it('should create an instance of StartVideoRequest', function() {
      // uncomment below and update the code to test StartVideoRequest
      //var instance = new ZappitiPlayerApi.StartVideoRequest();
      //expect(instance).to.be.a(ZappitiPlayerApi.StartVideoRequest);
    });
