...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EuBonUtis.UtisControllerApi();
  });
  ...
  describe('UtisControllerApi', function() {
    describe('capabilities', function() {
      it('should call capabilities successfully', function(done) {
        //uncomment below and update the code to test capabilities
        //instance.capabilities(function(error) {
