...
/**
 * API tests for PlatformDatasetsApi
 */
@Disabled
public class PlatformDatasetsApiTest {

    private final PlatformDatasetsApi api = new PlatformDatasetsApi();
     ...
     */
    @Test
    public void queryDatatasetInformationOfAllTheResourceTypesV1DatasetIpGetTest() throws ApiException {
        DatasetTypeCollectionOutput response = api.queryDatatasetInformationOfAllTheResourceTypesV1DatasetIpGet();
     ...
     */
    @Test
    public void queryDatatasetInformationOfTheResourceTypeV1DatasetIpNameGetTest() throws ApiException {
        String name = null;
        DatasetTypeOutput response = api.queryDatatasetInformationOfTheResourceTypeV1DatasetIpNameGet(name);
        // TODO: test validations
    }
