...
<a id="changeStatusOfTheDenylistV1DenylistPublicDenylistIdPut"></a>
...
import org.openapitools.client.api.DenylistDataQueryAndManagementApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    DenylistDataQueryAndManagementApi apiInstance = new DenylistDataQueryAndManagementApi(defaultClient);
    UUID denylistId = UUID.randomUUID(); // UUID | 
    BodyChangeStatusOfTheDenylistV1DenylistPublicDenylistIdPut bodyChangeStatusOfTheDenylistV1DenylistPublicDenylistIdPut = new BodyChangeStatusOfTheDenylistV1DenylistPublicDenylistIdPut(); // BodyChangeStatusOfTheDenylistV1DenylistPublicDenylistIdPut | 
    try {
      Object result = apiInstance.changeStatusOfTheDenylistV1DenylistPublicDenylistIdPut(denylistId, bodyChangeStatusOfTheDenylistV1DenylistPublicDenylistIdPut);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling DenylistDataQueryAndManagementApi#changeStatusOfTheDenylistV1DenylistPublicDenylistIdPut");
...
<a id="changeStatusOfTheOriginDenylistV1DenylistPrivateDenylistIdOriginPut"></a>
...
public class Example {
  public static void main(String[] args) {
    ...
    DenylistDataQueryAndManagementApi apiInstance = new DenylistDataQueryAndManagementApi(defaultClient);
    UUID denylistId = UUID.randomUUID(); // UUID | 
    BodyChangeStatusOfTheOriginDenylistV1DenylistPrivateDenylistIdOriginPut bodyChangeStatusOfTheOriginDenylistV1DenylistPrivateDenylistIdOriginPut = new BodyChangeStatusOfTheOriginDenylistV1DenylistPrivateDenylistIdOriginPut(); // BodyChangeStatusOfTheOriginDenylistV1DenylistPrivateDenylistIdOriginPut | 
    try {
      Object result = apiInstance.changeStatusOfTheOriginDenylistV1DenylistPrivateDenylistIdOriginPut(denylistId, bodyChangeStatusOfTheOriginDenylistV1DenylistPrivateDenylistIdOriginPut);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling DenylistDataQueryAndManagementApi#changeStatusOfTheOriginDenylistV1DenylistPrivateDenylistIdOriginPut");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="changeStatusOfTheOriginDenylistV1DenylistPublicDenylistIdOriginPut"></a>
...
public class Example {
  public static void main(String[] args) {
    ...
    DenylistDataQueryAndManagementApi apiInstance = new DenylistDataQueryAndManagementApi(defaultClient);
    UUID denylistId = UUID.randomUUID(); // UUID | 
    BodyChangeStatusOfTheOriginDenylistV1DenylistPublicDenylistIdOriginPut bodyChangeStatusOfTheOriginDenylistV1DenylistPublicDenylistIdOriginPut = new BodyChangeStatusOfTheOriginDenylistV1DenylistPublicDenylistIdOriginPut(); // BodyChangeStatusOfTheOriginDenylistV1DenylistPublicDenylistIdOriginPut | 
    try {
      Object result = apiInstance.changeStatusOfTheOriginDenylistV1DenylistPublicDenylistIdOriginPut(denylistId, bodyChangeStatusOfTheOriginDenylistV1DenylistPublicDenylistIdOriginPut);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling DenylistDataQueryAndManagementApi#changeStatusOfTheOriginDenylistV1DenylistPublicDenylistIdOriginPut");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="createPrivateDenylistOfTheUserV1DenylistPrivatePost"></a>
# **createPrivateDenylistOfTheUserV1DenylistPrivatePost**
> UUID createPrivateDenylistOfTheUserV1DenylistPrivatePost(bodyCreatePrivateDenylistOfTheUserV1DenylistPrivatePost)
...
public class Example {
  public static void main(String[] args) {
    ...
    DenylistDataQueryAndManagementApi apiInstance = new DenylistDataQueryAndManagementApi(defaultClient);
    BodyCreatePrivateDenylistOfTheUserV1DenylistPrivatePost bodyCreatePrivateDenylistOfTheUserV1DenylistPrivatePost = new BodyCreatePrivateDenylistOfTheUserV1DenylistPrivatePost(); // BodyCreatePrivateDenylistOfTheUserV1DenylistPrivatePost | 
    try {
      UUID result = apiInstance.createPrivateDenylistOfTheUserV1DenylistPrivatePost(bodyCreatePrivateDenylistOfTheUserV1DenylistPrivatePost);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling DenylistDataQueryAndManagementApi#createPrivateDenylistOfTheUserV1DenylistPrivatePost");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="deleteAllIpAddressesReportedByTheUserV1DenylistReportedIpAllDelete"></a>
...
public class Example {
  public static void main(String[] args) {
    ...
    DenylistDataQueryAndManagementApi apiInstance = new DenylistDataQueryAndManagementApi(defaultClient);
    try {
      Object result = apiInstance.deleteAllIpAddressesReportedByTheUserV1DenylistReportedIpAllDelete();
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling DenylistDataQueryAndManagementApi#deleteAllIpAddressesReportedByTheUserV1DenylistReportedIpAllDelete");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="deleteAnIpAddressReportedByTheUserV1DenylistReportedIpIpAddressDelete"></a>
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      Object result = apiInstance.deleteAnIpAddressReportedByTheUserV1DenylistReportedIpIpAddressDelete(ipAddress);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling DenylistDataQueryAndManagementApi#deleteAnIpAddressReportedByTheUserV1DenylistReportedIpIpAddressDelete");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="deleteTheDenylistContentV1DenylistPrivateDenylistIdContentDelete"></a>
...
public class Example {
  public static void main(String[] args) {
    ...
    UUID denylistId = UUID.randomUUID(); // UUID | 
    try {
      Object result = apiInstance.deleteTheDenylistContentV1DenylistPrivateDenylistIdContentDelete(denylistId);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling DenylistDataQueryAndManagementApi#deleteTheDenylistContentV1DenylistPrivateDenylistIdContentDelete");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="deleteTheDenylistV1DenylistPrivateDenylistIdDelete"></a>
...
public class Example {
  public static void main(String[] args) {
    ...
    UUID denylistId = UUID.randomUUID(); // UUID | 
    try {
      Object result = apiInstance.deleteTheDenylistV1DenylistPrivateDenylistIdDelete(denylistId);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling DenylistDataQueryAndManagementApi#deleteTheDenylistV1DenylistPrivateDenylistIdDelete");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="deleteTheDenylistV1DenylistPublicDenylistIdDelete"></a>
...
public class Example {
  public static void main(String[] args) {
    ...
    UUID denylistId = UUID.randomUUID(); // UUID | 
    try {
      Object result = apiInstance.deleteTheDenylistV1DenylistPublicDenylistIdDelete(denylistId);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling DenylistDataQueryAndManagementApi#deleteTheDenylistV1DenylistPublicDenylistIdDelete");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="getAllOwnedDenylistsByResourceTypeV1DenylistPublicOwnedResourceTypeGet"></a>
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      PublicAclGroupListCollectionOutput result = apiInstance.getAllOwnedDenylistsByResourceTypeV1DenylistPublicOwnedResourceTypeGet(resourceType);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling DenylistDataQueryAndManagementApi#getAllOwnedDenylistsByResourceTypeV1DenylistPublicOwnedResourceTypeGet");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="getAllPrivateDenylistsByResourceTypeV1DenylistPrivateAllResourceTypeGet"></a>
...
public class Example {
  public static void main(String[] args) {
    ...
    String resourceType = "cidr"; // String | 
    try {
      PrivateAclGroupListCollectionOutput result = apiInstance.getAllPrivateDenylistsByResourceTypeV1DenylistPrivateAllResourceTypeGet(resourceType);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling DenylistDataQueryAndManagementApi#getAllPrivateDenylistsByResourceTypeV1DenylistPrivateAllResourceTypeGet");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="getAllPrivateDenylistsV1DenylistPrivateAllGet"></a>
...
public class Example {
  public static void main(String[] args) {
    ...
    DenylistDataQueryAndManagementApi apiInstance = new DenylistDataQueryAndManagementApi(defaultClient);
    try {
      PrivateAclGroupListCollectionOutput result = apiInstance.getAllPrivateDenylistsV1DenylistPrivateAllGet();
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling DenylistDataQueryAndManagementApi#getAllPrivateDenylistsV1DenylistPrivateAllGet");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="getAllPublicDenylistsByResourceTypeV1DenylistPublicAllResourceTypeGet"></a>
...
public class Example {
  public static void main(String[] args) {
    ...
    String resourceType = "cidr"; // String | 
    try {
      PublicAclGroupListCollectionOutput result = apiInstance.getAllPublicDenylistsByResourceTypeV1DenylistPublicAllResourceTypeGet(resourceType);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling DenylistDataQueryAndManagementApi#getAllPublicDenylistsByResourceTypeV1DenylistPublicAllResourceTypeGet");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="getAllPublicDenylistsV1DenylistPublicAllGet"></a>
...
public class Example {
  public static void main(String[] args) {
    ...
    DenylistDataQueryAndManagementApi apiInstance = new DenylistDataQueryAndManagementApi(defaultClient);
    try {
      PublicAclGroupListCollectionOutput result = apiInstance.getAllPublicDenylistsV1DenylistPublicAllGet();
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling DenylistDataQueryAndManagementApi#getAllPublicDenylistsV1DenylistPublicAllGet");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="getDenylistContentV1DenylistPrivateDenylistIdContentGet"></a>
# **getDenylistContentV1DenylistPrivateDenylistIdContentGet**
> PrivateAclListCollectionOutput getDenylistContentV1DenylistPrivateDenylistIdContentGet(denylistId, page, pageSize)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      PrivateAclListCollectionOutput result = apiInstance.getDenylistContentV1DenylistPrivateDenylistIdContentGet(denylistId, page, pageSize);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling DenylistDataQueryAndManagementApi#getDenylistContentV1DenylistPrivateDenylistIdContentGet");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="getPublicDenylistsOwnedByTheUserV1DenylistPublicOwnedGet"></a>
...
public class Example {
  public static void main(String[] args) {
    ...
    DenylistDataQueryAndManagementApi apiInstance = new DenylistDataQueryAndManagementApi(defaultClient);
    try {
      PublicAclGroupListCollectionOutput result = apiInstance.getPublicDenylistsOwnedByTheUserV1DenylistPublicOwnedGet();
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling DenylistDataQueryAndManagementApi#getPublicDenylistsOwnedByTheUserV1DenylistPublicOwnedGet");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="getSingleDenylistV1DenylistPrivateDenylistIdGet"></a>
...
public class Example {
  public static void main(String[] args) {
    ...
    UUID denylistId = UUID.randomUUID(); // UUID | 
    try {
      PrivateAclGroupListOutput result = apiInstance.getSingleDenylistV1DenylistPrivateDenylistIdGet(denylistId);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling DenylistDataQueryAndManagementApi#getSingleDenylistV1DenylistPrivateDenylistIdGet");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="getSingleDenylistV1DenylistPublicDenylistIdGet"></a>
...
public class Example {
  public static void main(String[] args) {
    ...
    UUID denylistId = UUID.randomUUID(); // UUID | 
    try {
      PublicAclGroupListOutput result = apiInstance.getSingleDenylistV1DenylistPublicDenylistIdGet(denylistId);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling DenylistDataQueryAndManagementApi#getSingleDenylistV1DenylistPublicDenylistIdGet");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="queryAllTheIpAddressesReportedByTheUserV1DenylistReportedIpGet"></a>
# **queryAllTheIpAddressesReportedByTheUserV1DenylistReportedIpGet**
> IPListCollectionOutput queryAllTheIpAddressesReportedByTheUserV1DenylistReportedIpGet(dataset, reportedBefore, reportedAfter, expiresBefore, expiresAfter, greaterThan, lessThan, ipProtocolVersion, outputFormat)
...
public class Example {
  public static void main(String[] args) {
    ...
    DenylistDataQueryAndManagementApi apiInstance = new DenylistDataQueryAndManagementApi(defaultClient);
    String dataset = "dataset_example"; // String | The dataset list type to filter for. Must be uppercase, numbers and underscore
    Integer reportedBefore = 56; // Integer | Restricts the result displaying only the IP addresses reported before `reported_before`. It must be a UNIX timestamp in seconds.
    Integer reportedAfter = 56; // Integer | Restricts the result displaying only the IP addresses reported after `reported_after`. It must be a UNIX timestamp in seconds.
    Integer expiresBefore = 56; // Integer | Restricts the result displaying only the IP addresses that will expire before `expires_before`. It must be a UNIX timestamp in seconds greater than the current UNIX timestamp.
    Integer expiresAfter = 56; // Integer | Restricts the result displaying only the IP addresses that will expire after `expires_after`. It must be a UNIX timestamp in seconds greater than the current UNIX timestamp.
    Integer greaterThan = 56; // Integer | Restricts the result displaying only the IP addresses reported more times than `greater_than`. It must be an integer greater than 0.
    Integer lessThan = 56; // Integer | Restricts the result displaying only the IP addresses reported less times than `less_than`. It must be an integer greater than 1.
    String ipProtocolVersion = "ALL"; // String | Restrict the result displaying the IP protocol version requested (IPV4 or IPV6) or both (ALL). Some output formats MUST filter by IP protocol version first.
    String outputFormat = "JSON"; // String | The output format of the datasets.
    try {
      IPListCollectionOutput result = apiInstance.queryAllTheIpAddressesReportedByTheUserV1DenylistReportedIpGet(dataset, reportedBefore, reportedAfter, expiresBefore, expiresAfter, greaterThan, lessThan, ipProtocolVersion, outputFormat);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling DenylistDataQueryAndManagementApi#queryAllTheIpAddressesReportedByTheUserV1DenylistReportedIpGet");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
| **reportedBefore** | **Integer**| Restricts the result displaying only the IP addresses reported before &#x60;reported_before&#x60;. It must be a UNIX timestamp in seconds. | [optional] |
| **reportedAfter** | **Integer**| Restricts the result displaying only the IP addresses reported after &#x60;reported_after&#x60;. It must be a UNIX timestamp in seconds. | [optional] |
| **expiresBefore** | **Integer**| Restricts the result displaying only the IP addresses that will expire before &#x60;expires_before&#x60;. It must be a UNIX timestamp in seconds greater than the current UNIX timestamp. | [optional] |
| **expiresAfter** | **Integer**| Restricts the result displaying only the IP addresses that will expire after &#x60;expires_after&#x60;. It must be a UNIX timestamp in seconds greater than the current UNIX timestamp. | [optional] |
| **greaterThan** | **Integer**| Restricts the result displaying only the IP addresses reported more times than &#x60;greater_than&#x60;. It must be an integer greater than 0. | [optional] |
| **lessThan** | **Integer**| Restricts the result displaying only the IP addresses reported less times than &#x60;less_than&#x60;. It must be an integer greater than 1. | [optional] |
| **ipProtocolVersion** | **String**| Restrict the result displaying the IP protocol version requested (IPV4 or IPV6) or both (ALL). Some output formats MUST filter by IP protocol version first. | [optional] [default to ALL] [enum: ALL, IPV4, IPV6] |
| **outputFormat** | **String**| The output format of the datasets. | [optional] [default to JSON] [enum: JSON, CSV, AWS-WAF] |
...
<a id="queryAnIpAddressesReportedByTheUserV1DenylistReportedIpIpAddressGet"></a>
...
public class Example {
  public static void main(String[] args) {
    ...
    String ipAddress = "ipAddress_example"; // String | 
    try {
      IPListOutput result = apiInstance.queryAnIpAddressesReportedByTheUserV1DenylistReportedIpIpAddressGet(ipAddress);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling DenylistDataQueryAndManagementApi#queryAnIpAddressesReportedByTheUserV1DenylistReportedIpIpAddressGet");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="queryResourceDenylistsV1DenylistPrivateIpAddressGet"></a>
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      AclListCollectionOutput result = apiInstance.queryResourceDenylistsV1DenylistPrivateIpAddressGet(address);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling DenylistDataQueryAndManagementApi#queryResourceDenylistsV1DenylistPrivateIpAddressGet");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="queryResourceDenylistsV1DenylistPublicIpAddressGet"></a>
...
public class Example {
  public static void main(String[] args) {
    ...
    Address address = new Address(); // Address | 
    try {
      AclListCollectionOutput result = apiInstance.queryResourceDenylistsV1DenylistPublicIpAddressGet(address);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling DenylistDataQueryAndManagementApi#queryResourceDenylistsV1DenylistPublicIpAddressGet");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="updatePrivateContentOfTheDenylistOfTheUserV1DenylistPrivateDenylistIdContentPut"></a>
# **updatePrivateContentOfTheDenylistOfTheUserV1DenylistPrivateDenylistIdContentPut**
> Object updatePrivateContentOfTheDenylistOfTheUserV1DenylistPrivateDenylistIdContentPut(denylistId, bodyUpdatePrivateContentOfTheDenylistOfTheUserV1DenylistPrivateDenylistIdContentPut)
...
public class Example {
  public static void main(String[] args) {
    ...
    DenylistDataQueryAndManagementApi apiInstance = new DenylistDataQueryAndManagementApi(defaultClient);
    UUID denylistId = UUID.randomUUID(); // UUID | 
    BodyUpdatePrivateContentOfTheDenylistOfTheUserV1DenylistPrivateDenylistIdContentPut bodyUpdatePrivateContentOfTheDenylistOfTheUserV1DenylistPrivateDenylistIdContentPut = new BodyUpdatePrivateContentOfTheDenylistOfTheUserV1DenylistPrivateDenylistIdContentPut(); // BodyUpdatePrivateContentOfTheDenylistOfTheUserV1DenylistPrivateDenylistIdContentPut | 
    try {
      Object result = apiInstance.updatePrivateContentOfTheDenylistOfTheUserV1DenylistPrivateDenylistIdContentPut(denylistId, bodyUpdatePrivateContentOfTheDenylistOfTheUserV1DenylistPrivateDenylistIdContentPut);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling DenylistDataQueryAndManagementApi#updatePrivateContentOfTheDenylistOfTheUserV1DenylistPrivateDenylistIdContentPut");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="updatePrivateDenylistOfTheUserV1DenylistPrivateDenylistIdPut"></a>
# **updatePrivateDenylistOfTheUserV1DenylistPrivateDenylistIdPut**
> Object updatePrivateDenylistOfTheUserV1DenylistPrivateDenylistIdPut(denylistId, bodyUpdatePrivateDenylistOfTheUserV1DenylistPrivateDenylistIdPut)
...
public class Example {
  public static void main(String[] args) {
    ...
    DenylistDataQueryAndManagementApi apiInstance = new DenylistDataQueryAndManagementApi(defaultClient);
    UUID denylistId = UUID.randomUUID(); // UUID | 
    BodyUpdatePrivateDenylistOfTheUserV1DenylistPrivateDenylistIdPut bodyUpdatePrivateDenylistOfTheUserV1DenylistPrivateDenylistIdPut = new BodyUpdatePrivateDenylistOfTheUserV1DenylistPrivateDenylistIdPut(); // BodyUpdatePrivateDenylistOfTheUserV1DenylistPrivateDenylistIdPut | 
    try {
      Object result = apiInstance.updatePrivateDenylistOfTheUserV1DenylistPrivateDenylistIdPut(denylistId, bodyUpdatePrivateDenylistOfTheUserV1DenylistPrivateDenylistIdPut);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling DenylistDataQueryAndManagementApi#updatePrivateDenylistOfTheUserV1DenylistPrivateDenylistIdPut");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
