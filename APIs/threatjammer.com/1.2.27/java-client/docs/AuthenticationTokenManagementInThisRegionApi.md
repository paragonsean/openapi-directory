...
<a id="queryTokenActivityV1TokenActivityGet"></a>
# **queryTokenActivityV1TokenActivityGet**
> ActivityCollectionOutput queryTokenActivityV1TokenActivityGet(page, pageSize)
...
import org.openapitools.client.api.AuthenticationTokenManagementInThisRegionApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    AuthenticationTokenManagementInThisRegionApi apiInstance = new AuthenticationTokenManagementInThisRegionApi(defaultClient);
    Integer page = 1; // Integer | The page to be returned
    Integer pageSize = 20; // Integer | The number of items per page
    try {
      ActivityCollectionOutput result = apiInstance.queryTokenActivityV1TokenActivityGet(page, pageSize);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling AuthenticationTokenManagementInThisRegionApi#queryTokenActivityV1TokenActivityGet");
...
<a id="queryTokenInfoV1TokenGet"></a>
...
public class Example {
  public static void main(String[] args) {
    ...
    AuthenticationTokenManagementInThisRegionApi apiInstance = new AuthenticationTokenManagementInThisRegionApi(defaultClient);
    try {
      TokenOutput result = apiInstance.queryTokenInfoV1TokenGet();
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling AuthenticationTokenManagementInThisRegionApi#queryTokenInfoV1TokenGet");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
