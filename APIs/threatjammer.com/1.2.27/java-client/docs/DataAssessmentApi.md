...
<a id="assessIpSetCsvV1AssessIpCsvPost"></a>
# **assessIpSetCsvV1AssessIpCsvPost**
> IPAssessmentCollectionOutput assessIpSetCsvV1AssessIpCsvPost(csvFile, strictParse)
...
import org.openapitools.client.api.DataAssessmentApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    DataAssessmentApi apiInstance = new DataAssessmentApi(defaultClient);
    ...
    try {
      IPAssessmentCollectionOutput result = apiInstance.assessIpSetCsvV1AssessIpCsvPost(csvFile, strictParse);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling DataAssessmentApi#assessIpSetCsvV1AssessIpCsvPost");
...
<a id="assessIpSetV1AssessIpPost"></a>
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      IPAssessmentCollectionOutput result = apiInstance.assessIpSetV1AssessIpPost(requestBody);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling DataAssessmentApi#assessIpSetV1AssessIpPost");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="assessIpV1AssessIpIpAddressGet"></a>
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      IPAssessmentOutput result = apiInstance.assessIpV1AssessIpIpAddressGet(ipAddress);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling DataAssessmentApi#assessIpV1AssessIpIpAddressGet");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
