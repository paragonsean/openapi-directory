...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ThreatJammerComUserApi.OSOutput();
  });
  ...
  describe('OSOutput', function() {
    it('should create an instance of OSOutput', function() {
      // uncomment below and update the code to test OSOutput
      //var instance = new ThreatJammerComUserApi.OSOutput();
      //expect(instance).to.be.a(ThreatJammerComUserApi.OSOutput);
    });
