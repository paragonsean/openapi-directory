...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ThreatJammerComUserApi.OriginTokenOutput();
  });
  ...
  describe('OriginTokenOutput', function() {
    it('should create an instance of OriginTokenOutput', function() {
      // uncomment below and update the code to test OriginTokenOutput
      //var instance = new ThreatJammerComUserApi.OriginTokenOutput();
      //expect(instance).to.be.a(ThreatJammerComUserApi.OriginTokenOutput);
    });
