...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ThreatJammerComUserApi.OriginOutput();
  });
  ...
  describe('OriginOutput', function() {
    it('should create an instance of OriginOutput', function() {
      // uncomment below and update the code to test OriginOutput
      //var instance = new ThreatJammerComUserApi.OriginOutput();
      //expect(instance).to.be.a(ThreatJammerComUserApi.OriginOutput);
    });
