...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ThreatJammerComUserApi.PublicAclGroupListOutput();
  });
  ...
  describe('PublicAclGroupListOutput', function() {
    it('should create an instance of PublicAclGroupListOutput', function() {
      // uncomment below and update the code to test PublicAclGroupListOutput
      //var instance = new ThreatJammerComUserApi.PublicAclGroupListOutput();
      //expect(instance).to.be.a(ThreatJammerComUserApi.PublicAclGroupListOutput);
    });
