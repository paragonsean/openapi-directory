...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ThreatJammerComUserApi.DatacenterPrefixOutput();
  });
  ...
  describe('DatacenterPrefixOutput', function() {
    it('should create an instance of DatacenterPrefixOutput', function() {
      // uncomment below and update the code to test DatacenterPrefixOutput
      //var instance = new ThreatJammerComUserApi.DatacenterPrefixOutput();
      //expect(instance).to.be.a(ThreatJammerComUserApi.DatacenterPrefixOutput);
    });
    ...
    it('should have the property ipAbuseTotal (base name: "ip_abuse_total")', function() {
      // uncomment below and update the code to test the property ipAbuseTotal
      //var instance = new ThreatJammerComUserApi.DatacenterPrefixOutput();
      //expect(instance).to.be();
    });
