...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ThreatJammerComUserApi.DatacenterOutput();
  });
  ...
  describe('DatacenterOutput', function() {
    it('should create an instance of DatacenterOutput', function() {
      // uncomment below and update the code to test DatacenterOutput
      //var instance = new ThreatJammerComUserApi.DatacenterOutput();
      //expect(instance).to.be.a(ThreatJammerComUserApi.DatacenterOutput);
    });
