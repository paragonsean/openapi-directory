...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ThreatJammerComUserApi.ValidationError();
  });
  ...
  describe('ValidationError', function() {
    it('should create an instance of ValidationError', function() {
      ...
      //var instance = new ThreatJammerComUserApi.ValidationError();
      //expect(instance).to.be.a(ThreatJammerComUserApi.ValidationError);
    });
