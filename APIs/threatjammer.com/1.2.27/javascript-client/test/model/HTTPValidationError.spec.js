...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ThreatJammerComUserApi.HTTPValidationError();
  });
  ...
  describe('HTTPValidationError', function() {
    it('should create an instance of HTTPValidationError', function() {
      ...
      //var instance = new ThreatJammerComUserApi.HTTPValidationError();
      //expect(instance).to.be.a(ThreatJammerComUserApi.HTTPValidationError);
    });
