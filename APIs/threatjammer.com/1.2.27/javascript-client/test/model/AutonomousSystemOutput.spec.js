...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ThreatJammerComUserApi.AutonomousSystemOutput();
  });
  ...
  describe('AutonomousSystemOutput', function() {
    it('should create an instance of AutonomousSystemOutput', function() {
      // uncomment below and update the code to test AutonomousSystemOutput
      //var instance = new ThreatJammerComUserApi.AutonomousSystemOutput();
      //expect(instance).to.be.a(ThreatJammerComUserApi.AutonomousSystemOutput);
    });
