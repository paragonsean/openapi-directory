...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ThreatJammerComUserApi.IPAddress();
  });
  ...
  describe('IPAddress', function() {
    it('should create an instance of IPAddress', function() {
      ...
      //var instance = new ThreatJammerComUserApi.IPAddress();
      //expect(instance).to.be.a(ThreatJammerComUserApi.IPAddress);
    });
