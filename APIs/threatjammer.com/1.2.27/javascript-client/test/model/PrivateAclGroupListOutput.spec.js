...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ThreatJammerComUserApi.PrivateAclGroupListOutput();
  });
  ...
  describe('PrivateAclGroupListOutput', function() {
    it('should create an instance of PrivateAclGroupListOutput', function() {
      // uncomment below and update the code to test PrivateAclGroupListOutput
      //var instance = new ThreatJammerComUserApi.PrivateAclGroupListOutput();
      //expect(instance).to.be.a(ThreatJammerComUserApi.PrivateAclGroupListOutput);
    });
