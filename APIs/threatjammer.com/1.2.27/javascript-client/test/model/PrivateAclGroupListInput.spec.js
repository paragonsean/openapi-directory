...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ThreatJammerComUserApi.PrivateAclGroupListInput();
  });
  ...
  describe('PrivateAclGroupListInput', function() {
    it('should create an instance of PrivateAclGroupListInput', function() {
      // uncomment below and update the code to test PrivateAclGroupListInput
      //var instance = new ThreatJammerComUserApi.PrivateAclGroupListInput();
      //expect(instance).to.be.a(ThreatJammerComUserApi.PrivateAclGroupListInput);
    });
