...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ThreatJammerComUserApi.IPLogOutput();
  });
  ...
  describe('IPLogOutput', function() {
    it('should create an instance of IPLogOutput', function() {
      // uncomment below and update the code to test IPLogOutput
      //var instance = new ThreatJammerComUserApi.IPLogOutput();
      //expect(instance).to.be.a(ThreatJammerComUserApi.IPLogOutput);
    });
    ...
    it('should have the property lapse (base name: "lapse")', function() {
      // uncomment below and update the code to test the property lapse
      //var instance = new ThreatJammerComUserApi.IPLogOutput();
      //expect(instance).to.be();
    });
