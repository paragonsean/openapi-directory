# ThreatJammerComUserApi.OriginManagementInThisRegionApi
...
let apiInstance = new ThreatJammerComUserApi.OriginManagementInThisRegionApi();
apiInstance.queryAllOriginInformationV1OriginAllGet((error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
> OriginAddressStatusCollectionOutput queryOriginAddressStatusInformationV1OriginAddressesGet(query, opts)
...
let apiInstance = new ThreatJammerComUserApi.OriginManagementInThisRegionApi();
let query = "query_example"; // String | The origin site to query
let opts = {
  'page': 1, // Number | The page to be returned
  'pageSize': 20 // Number | The number of items per page
};
apiInstance.queryOriginAddressStatusInformationV1OriginAddressesGet(query, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> OriginCookieIdStatusCollectionOutput queryOriginCookieIdStatusInformationV1OriginCookiesGet(query, opts)
...
apiInstance.queryOriginCookieIdStatusInformationV1OriginCookiesGet(query, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
let apiInstance = new ThreatJammerComUserApi.OriginManagementInThisRegionApi();
let query = "query_example"; // String | The origin site to query
apiInstance.queryOriginInformationV1OriginGet(query, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
let apiInstance = new ThreatJammerComUserApi.OriginManagementInThisRegionApi();
let query = "query_example"; // String | The origin site to query
apiInstance.queryOriginScriptsV1OriginScriptsGet(query, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
let apiInstance = new ThreatJammerComUserApi.OriginManagementInThisRegionApi();
let statusId = "statusId_example"; // String | The status id to query the details
apiInstance.queryOriginStatusDetailV1OriginStatusDetailStatusIdGet(statusId, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **statusId** | **String**| The status id to query the details | 
...
let apiInstance = new ThreatJammerComUserApi.OriginManagementInThisRegionApi();
apiInstance.queryOriginStatusDetailsV1OriginStatusDetailsGet((error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> OriginStatusOutput queryOriginStatusV1OriginStatusPost(query, opts)
...
let query = "query_example"; // String | The origin site to query
let opts = {
  'bodyQueryOriginStatusV1OriginStatusPost': new ThreatJammerComUserApi.BodyQueryOriginStatusV1OriginStatusPost() // BodyQueryOriginStatusV1OriginStatusPost | 
};
apiInstance.queryOriginStatusV1OriginStatusPost(query, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> OriginTrafficAnalysisCollectionOutput queryOriginTrafficAnalysisV1OriginTrafficAnalysisGet(query, interval, fromTimestamp, opts)
...
let apiInstance = new ThreatJammerComUserApi.OriginManagementInThisRegionApi();
let query = "query_example"; // String | The origin site to query
let interval = "interval_example"; // String | The data inteval to aggregate the result dataset
let fromTimestamp = 56; // Number | A UNIX timestamp in milliseconds to restrict the results of the query to entries logged after or equal to this value.
let opts = {
  'toTimestamp': 56 // Number | A UNIX timestamp in milliseconds to restrict the results of the query to entries logged before this value.
};
apiInstance.queryOriginTrafficAnalysisV1OriginTrafficAnalysisGet(query, interval, fromTimestamp, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
------------- | ------------- | ------------- | -------------
 **query** | **String**| The origin site to query | 
 **interval** | **String**| The data inteval to aggregate the result dataset | 
 **fromTimestamp** | **Number**| A UNIX timestamp in milliseconds to restrict the results of the query to entries logged after or equal to this value. | 
 **toTimestamp** | **Number**| A UNIX timestamp in milliseconds to restrict the results of the query to entries logged before this value. | [optional] 
...
> OriginClientAnalysisCollectionOutput queryOriginTrafficClientV1OriginClientAnalysisGet(query, interval, fromTimestamp, opts)
...
apiInstance.queryOriginTrafficClientV1OriginClientAnalysisGet(query, interval, fromTimestamp, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
let apiInstance = new ThreatJammerComUserApi.OriginManagementInThisRegionApi();
let bodyUpdateConfigurationOriginV1OriginPut = new ThreatJammerComUserApi.BodyUpdateConfigurationOriginV1OriginPut(); // BodyUpdateConfigurationOriginV1OriginPut | 
apiInstance.updateConfigurationOriginV1OriginPut(bodyUpdateConfigurationOriginV1OriginPut, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> Object updateOriginStatusV1OriginStatusPut(query, opts)
...
let query = "query_example"; // String | The origin site to query
let opts = {
  'bodyUpdateOriginStatusV1OriginStatusPut': new ThreatJammerComUserApi.BodyUpdateOriginStatusV1OriginStatusPut() // BodyUpdateOriginStatusV1OriginStatusPut | 
};
apiInstance.updateOriginStatusV1OriginStatusPut(query, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
