...
/*
 * OAIPrivateAclGroupListInput.h
 *
 * 
 */

#ifndef OAIPrivateAclGroupListInput_H
#define OAIPrivateAclGroupListInput_H
...
class OAIPrivateAclGroupListInput : public OAIObject {
public:
    OAIPrivateAclGroupListInput();
    OAIPrivateAclGroupListInput(QString json);
    ~OAIPrivateAclGroupListInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPrivateAclGroupListInput)

#endif // OAIPrivateAclGroupListInput_H
