...
/*
 * OAIAutonomousSystemOutput.h
 *
 * 
 */

#ifndef OAIAutonomousSystemOutput_H
#define OAIAutonomousSystemOutput_H
...
class OAIAutonomousSystemOutput : public OAIObject {
public:
    OAIAutonomousSystemOutput();
    OAIAutonomousSystemOutput(QString json);
    ~OAIAutonomousSystemOutput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAutonomousSystemOutput)

#endif // OAIAutonomousSystemOutput_H
