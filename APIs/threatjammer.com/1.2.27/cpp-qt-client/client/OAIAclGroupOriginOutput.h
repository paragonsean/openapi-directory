...
/*
 * OAIAclGroupOriginOutput.h
 *
 * 
 */

#ifndef OAIAclGroupOriginOutput_H
#define OAIAclGroupOriginOutput_H
...
class OAIAclGroupOriginOutput : public OAIObject {
public:
    OAIAclGroupOriginOutput();
    OAIAclGroupOriginOutput(QString json);
    ~OAIAclGroupOriginOutput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAclGroupOriginOutput)

#endif // OAIAclGroupOriginOutput_H
