...
/*
 * OAIActivityCollectionOutput.h
 *
 * 
 */

#ifndef OAIActivityCollectionOutput_H
#define OAIActivityCollectionOutput_H
...
namespace OpenAPI {
class OAIActivityOutput;

class OAIActivityCollectionOutput : public OAIObject {
public:
    OAIActivityCollectionOutput();
    OAIActivityCollectionOutput(QString json);
    ~OAIActivityCollectionOutput() override;
    ...
    QList<OAIActivityOutput> getActivities() const;
    void setActivities(const QList<OAIActivityOutput> &activities);
...
private:
    ...
    QList<OAIActivityOutput> m_activities;
...
Q_DECLARE_METATYPE(OpenAPI::OAIActivityCollectionOutput)

#endif // OAIActivityCollectionOutput_H
