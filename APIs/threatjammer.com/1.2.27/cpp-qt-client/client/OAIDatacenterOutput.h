...
/*
 * OAIDatacenterOutput.h
 *
 * 
 */

#ifndef OAIDatacenterOutput_H
#define OAIDatacenterOutput_H
...
class OAIDatacenterOutput : public OAIObject {
public:
    OAIDatacenterOutput();
    OAIDatacenterOutput(QString json);
    ~OAIDatacenterOutput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDatacenterOutput)

#endif // OAIDatacenterOutput_H
