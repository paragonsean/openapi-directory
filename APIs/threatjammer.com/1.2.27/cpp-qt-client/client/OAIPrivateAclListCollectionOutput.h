...
/*
 * OAIPrivateAclListCollectionOutput.h
 *
 * 
 */

#ifndef OAIPrivateAclListCollectionOutput_H
#define OAIPrivateAclListCollectionOutput_H

#include <QJsonObject>

#include "OAICidrs_inner.h"
#include <QList>
#include <QString>
...
class OAIPrivateAclListCollectionOutput : public OAIObject {
public:
    OAIPrivateAclListCollectionOutput();
    OAIPrivateAclListCollectionOutput(QString json);
    ~OAIPrivateAclListCollectionOutput() override;
    ...
    QList<qint32> getAsns() const;
    void setAsns(const QList<qint32> &asns);
    bool is_asns_Set() const;
    bool is_asns_Valid() const;

    QList<OAICidrs_inner> getCidrs() const;
    void setCidrs(const QList<OAICidrs_inner> &cidrs);
...
Q_DECLARE_METATYPE(OpenAPI::OAIPrivateAclListCollectionOutput)

#endif // OAIPrivateAclListCollectionOutput_H
