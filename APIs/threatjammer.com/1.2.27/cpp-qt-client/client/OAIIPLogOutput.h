...
#ifndef OAIIPLogOutput_H
#define OAIIPLogOutput_H
...
class OAIIPLogOutput : public OAIObject {
public:
    OAIIPLogOutput();
    OAIIPLogOutput(QString json);
    ~OAIIPLogOutput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIIPLogOutput)

#endif // OAIIPLogOutput_H
