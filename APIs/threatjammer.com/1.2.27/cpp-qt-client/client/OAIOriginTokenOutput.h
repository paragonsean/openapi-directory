...
/*
 * OAIOriginTokenOutput.h
 *
 * 
 */

#ifndef OAIOriginTokenOutput_H
#define OAIOriginTokenOutput_H
...
class OAIOriginTokenOutput : public OAIObject {
public:
    OAIOriginTokenOutput();
    OAIOriginTokenOutput(QString json);
    ~OAIOriginTokenOutput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIOriginTokenOutput)

#endif // OAIOriginTokenOutput_H
