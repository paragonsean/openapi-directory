...
#ifndef OAIOSOutput_H
#define OAIOSOutput_H
...
class OAIOSOutput : public OAIObject {
public:
    OAIOSOutput();
    OAIOSOutput(QString json);
    ~OAIOSOutput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIOSOutput)
