...
public class ApiClient {
    ...
    private String basePath = "http://1password.local";
    ...
    public ApiClient() {
        ...
        authentications.put("ConnectToken", new HttpBearerAuth("bearer"));
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/1.5.7/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g http://1password.local
