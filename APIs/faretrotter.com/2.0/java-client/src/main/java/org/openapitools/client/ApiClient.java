...
public class ApiClient {
    ...
    private String basePath = "https://api.faretrotter.com/v2.0";
    ...
    public ApiClient() {
        ...
        authentications.put("ApiKeyAuth", new ApiKeyAuth("header", "ApiKeyAuth"));
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://api.faretrotter.com/v2.0
