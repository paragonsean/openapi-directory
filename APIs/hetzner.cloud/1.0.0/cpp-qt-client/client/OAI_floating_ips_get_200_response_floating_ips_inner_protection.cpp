...
OAI_floating_ips_get_200_response_floating_ips_inner_protection::OAI_floating_ips_get_200_response_floating_ips_inner_protection(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAI_floating_ips_get_200_response_floating_ips_inner_protection::OAI_floating_ips_get_200_response_floating_ips_inner_protection() {
    this->initializeModel();
}

OAI_floating_ips_get_200_response_floating_ips_inner_protection::~OAI_floating_ips_get_200_response_floating_ips_inner_protection() {}

void OAI_floating_ips_get_200_response_floating_ips_inner_protection::initializeModel() {

    m_r_delete_isSet = false;
    m_r_delete_isValid = false;
}

void OAI_floating_ips_get_200_response_floating_ips_inner_protection::fromJson(QString jsonString) {
...
void OAI_floating_ips_get_200_response_floating_ips_inner_protection::fromJsonObject(QJsonObject json) {
...
QString OAI_floating_ips_get_200_response_floating_ips_inner_protection::asJson() const {
...
QJsonObject OAI_floating_ips_get_200_response_floating_ips_inner_protection::asJsonObject() const {
    QJsonObject obj;
    if (m_r_delete_isSet) {
...
bool OAI_floating_ips_get_200_response_floating_ips_inner_protection::isRDelete() const {
    return m_r_delete;
}
void OAI_floating_ips_get_200_response_floating_ips_inner_protection::setRDelete(const bool &r_delete) {
    m_r_delete = r_delete;
    m_r_delete_isSet = true;
}

bool OAI_floating_ips_get_200_response_floating_ips_inner_protection::is_r_delete_Set() const{
    return m_r_delete_isSet;
}

bool OAI_floating_ips_get_200_response_floating_ips_inner_protection::is_r_delete_Valid() const{
    return m_r_delete_isValid;
}

bool OAI_floating_ips_get_200_response_floating_ips_inner_protection::isSet() const {
...
bool OAI_floating_ips_get_200_response_floating_ips_inner_protection::isValid() const {
