...
public:
    ...
    */
    virtual void actionsGet(const ::OpenAPI::OptionalParam<qint32> &id = ::OpenAPI::OptionalParam<qint32>(), const ::OpenAPI::OptionalParam<QString> &sort = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &status = ::OpenAPI::OptionalParam<QString>());

    /**
    * @param[in]  id qint32 [required]
    */
    virtual void actionsIdGet(const qint32 &id);
...
private:
    ...
    void actionsGetCallback(OAIHttpRequestWorker *worker);
    void actionsIdGetCallback(OAIHttpRequestWorker *worker);

Q_SIGNALS:

    void actionsGetSignal(OAIActionsResponse summary);
    void actionsIdGetSignal(OAIActionResponse summary);


    void actionsGetSignalFull(OAIHttpRequestWorker *worker, OAIActionsResponse summary);
    void actionsIdGetSignalFull(OAIHttpRequestWorker *worker, OAIActionResponse summary);

    Q_DECL_DEPRECATED_X("Use actionsGetSignalError() instead")
    void actionsGetSignalE(OAIActionsResponse summary, QNetworkReply::NetworkError error_type, QString error_str);
    void actionsGetSignalError(OAIActionsResponse summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use actionsIdGetSignalError() instead")
    void actionsIdGetSignalE(OAIActionResponse summary, QNetworkReply::NetworkError error_type, QString error_str);
    void actionsIdGetSignalError(OAIActionResponse summary, QNetworkReply::NetworkError error_type, const QString &error_str);

    Q_DECL_DEPRECATED_X("Use actionsGetSignalErrorFull() instead")
    void actionsGetSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void actionsGetSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use actionsIdGetSignalErrorFull() instead")
    void actionsIdGetSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void actionsIdGetSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
