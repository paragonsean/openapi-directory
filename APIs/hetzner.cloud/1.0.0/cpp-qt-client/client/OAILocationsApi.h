...
#include "OAI_locations__id__get_200_response.h"
#include "OAI_locations_get_200_response.h"
#include <QString>
...
public:
    ...
    */
    virtual void locationsGet(const ::OpenAPI::OptionalParam<QString> &name = ::OpenAPI::OptionalParam<QString>());
...
Q_SIGNALS:
    ...
    void locationsGetSignal(OAI_locations_get_200_response summary);
    void locationsIdGetSignal(OAI_locations__id__get_200_response summary);


    void locationsGetSignalFull(OAIHttpRequestWorker *worker, OAI_locations_get_200_response summary);
    void locationsIdGetSignalFull(OAIHttpRequestWorker *worker, OAI_locations__id__get_200_response summary);

    Q_DECL_DEPRECATED_X("Use locationsGetSignalError() instead")
    void locationsGetSignalE(OAI_locations_get_200_response summary, QNetworkReply::NetworkError error_type, QString error_str);
    void locationsGetSignalError(OAI_locations_get_200_response summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use locationsIdGetSignalError() instead")
    void locationsIdGetSignalE(OAI_locations__id__get_200_response summary, QNetworkReply::NetworkError error_type, QString error_str);
    void locationsIdGetSignalError(OAI_locations__id__get_200_response summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use locationsIdGetSignalErrorFull() instead")
    void locationsIdGetSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
