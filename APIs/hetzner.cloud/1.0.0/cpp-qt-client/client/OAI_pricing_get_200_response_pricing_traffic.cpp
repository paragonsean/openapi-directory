...
OAI_pricing_get_200_response_pricing_traffic::OAI_pricing_get_200_response_pricing_traffic(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAI_pricing_get_200_response_pricing_traffic::OAI_pricing_get_200_response_pricing_traffic() {
    this->initializeModel();
}

OAI_pricing_get_200_response_pricing_traffic::~OAI_pricing_get_200_response_pricing_traffic() {}

void OAI_pricing_get_200_response_pricing_traffic::initializeModel() {

    m_price_per_tb_isSet = false;
    m_price_per_tb_isValid = false;
}

void OAI_pricing_get_200_response_pricing_traffic::fromJson(QString jsonString) {
...
void OAI_pricing_get_200_response_pricing_traffic::fromJsonObject(QJsonObject json) {

    m_price_per_tb_isValid = ::OpenAPI::fromJsonValue(m_price_per_tb, json[QString("price_per_tb")]);
    m_price_per_tb_isSet = !json[QString("price_per_tb")].isNull() && m_price_per_tb_isValid;
}

QString OAI_pricing_get_200_response_pricing_traffic::asJson() const {
...
QJsonObject OAI_pricing_get_200_response_pricing_traffic::asJsonObject() const {
    QJsonObject obj;
    if (m_price_per_tb.isSet()) {
        obj.insert(QString("price_per_tb"), ::OpenAPI::toJsonValue(m_price_per_tb));
    }
    return obj;
}

OAI_pricing_get_200_response_pricing_floating_ip_price_monthly OAI_pricing_get_200_response_pricing_traffic::getPricePerTb() const {
    return m_price_per_tb;
}
void OAI_pricing_get_200_response_pricing_traffic::setPricePerTb(const OAI_pricing_get_200_response_pricing_floating_ip_price_monthly &price_per_tb) {
    m_price_per_tb = price_per_tb;
    m_price_per_tb_isSet = true;
}

bool OAI_pricing_get_200_response_pricing_traffic::is_price_per_tb_Set() const{
    return m_price_per_tb_isSet;
}

bool OAI_pricing_get_200_response_pricing_traffic::is_price_per_tb_Valid() const{
    return m_price_per_tb_isValid;
}

bool OAI_pricing_get_200_response_pricing_traffic::isSet() const {
...
bool OAI_pricing_get_200_response_pricing_traffic::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_price_per_tb_isValid && true;
}
