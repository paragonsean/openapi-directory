...
OAIApplyToResourcesRequest::OAIApplyToResourcesRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIApplyToResourcesRequest::OAIApplyToResourcesRequest() {
    this->initializeModel();
}

OAIApplyToResourcesRequest::~OAIApplyToResourcesRequest() {}

void OAIApplyToResourcesRequest::initializeModel() {

    m_apply_to_isSet = false;
    m_apply_to_isValid = false;
}

void OAIApplyToResourcesRequest::fromJson(QString jsonString) {
...
void OAIApplyToResourcesRequest::fromJsonObject(QJsonObject json) {
...
QString OAIApplyToResourcesRequest::asJson() const {
...
QJsonObject OAIApplyToResourcesRequest::asJsonObject() const {
    QJsonObject obj;
...
QList<OAIFirewallApplyToResources> OAIApplyToResourcesRequest::getApplyTo() const {
    return m_apply_to;
}
void OAIApplyToResourcesRequest::setApplyTo(const QList<OAIFirewallApplyToResources> &apply_to) {
    m_apply_to = apply_to;
    m_apply_to_isSet = true;
}

bool OAIApplyToResourcesRequest::is_apply_to_Set() const{
    return m_apply_to_isSet;
}

bool OAIApplyToResourcesRequest::is_apply_to_Valid() const{
    return m_apply_to_isValid;
}

bool OAIApplyToResourcesRequest::isSet() const {
...
bool OAIApplyToResourcesRequest::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_apply_to_isValid && true;
}
