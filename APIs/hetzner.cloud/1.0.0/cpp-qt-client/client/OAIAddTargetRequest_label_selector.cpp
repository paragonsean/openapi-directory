...
#include "OAIAddTargetRequest_label_selector.h"
...
OAIAddTargetRequest_label_selector::OAIAddTargetRequest_label_selector(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAddTargetRequest_label_selector::OAIAddTargetRequest_label_selector() {
    this->initializeModel();
}

OAIAddTargetRequest_label_selector::~OAIAddTargetRequest_label_selector() {}

void OAIAddTargetRequest_label_selector::initializeModel() {

    m_selector_isSet = false;
    m_selector_isValid = false;
}

void OAIAddTargetRequest_label_selector::fromJson(QString jsonString) {
...
void OAIAddTargetRequest_label_selector::fromJsonObject(QJsonObject json) {
...
QString OAIAddTargetRequest_label_selector::asJson() const {
...
QJsonObject OAIAddTargetRequest_label_selector::asJsonObject() const {
    QJsonObject obj;
    if (m_selector_isSet) {
...
QString OAIAddTargetRequest_label_selector::getSelector() const {
    return m_selector;
}
void OAIAddTargetRequest_label_selector::setSelector(const QString &selector) {
    m_selector = selector;
    m_selector_isSet = true;
}

bool OAIAddTargetRequest_label_selector::is_selector_Set() const{
    return m_selector_isSet;
}

bool OAIAddTargetRequest_label_selector::is_selector_Valid() const{
    return m_selector_isValid;
}

bool OAIAddTargetRequest_label_selector::isSet() const {
...
bool OAIAddTargetRequest_label_selector::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_selector_isValid && true;
}
