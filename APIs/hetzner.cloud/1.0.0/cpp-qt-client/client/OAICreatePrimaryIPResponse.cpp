...
#include "OAICreatePrimaryIPResponse.h"
...
OAICreatePrimaryIPResponse::OAICreatePrimaryIPResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreatePrimaryIPResponse::OAICreatePrimaryIPResponse() {
    this->initializeModel();
}

OAICreatePrimaryIPResponse::~OAICreatePrimaryIPResponse() {}

void OAICreatePrimaryIPResponse::initializeModel() {
...
void OAICreatePrimaryIPResponse::fromJson(QString jsonString) {
...
void OAICreatePrimaryIPResponse::fromJsonObject(QJsonObject json) {
...
QString OAICreatePrimaryIPResponse::asJson() const {
...
QJsonObject OAICreatePrimaryIPResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_action.isSet()) {
...
OAIAction OAICreatePrimaryIPResponse::getAction() const {
    return m_action;
}
void OAICreatePrimaryIPResponse::setAction(const OAIAction &action) {
    m_action = action;
    m_action_isSet = true;
}

bool OAICreatePrimaryIPResponse::is_action_Set() const{
    return m_action_isSet;
}

bool OAICreatePrimaryIPResponse::is_action_Valid() const{
    return m_action_isValid;
}

OAIPrimaryIP OAICreatePrimaryIPResponse::getPrimaryIp() const {
    return m_primary_ip;
}
void OAICreatePrimaryIPResponse::setPrimaryIp(const OAIPrimaryIP &primary_ip) {
    m_primary_ip = primary_ip;
    m_primary_ip_isSet = true;
}

bool OAICreatePrimaryIPResponse::is_primary_ip_Set() const{
    return m_primary_ip_isSet;
}

bool OAICreatePrimaryIPResponse::is_primary_ip_Valid() const{
    return m_primary_ip_isValid;
}

bool OAICreatePrimaryIPResponse::isSet() const {
...
bool OAICreatePrimaryIPResponse::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_primary_ip_isValid && true;
}
