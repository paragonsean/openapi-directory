...
public:
    ...
    QList<QString> getDestinationIps() const;
    void setDestinationIps(const QList<QString> &destination_ips);
    bool is_destination_ips_Set() const;
    bool is_destination_ips_Valid() const;
    ...
    QList<QString> getSourceIps() const;
    void setSourceIps(const QList<QString> &source_ips);
    bool is_source_ips_Set() const;
    bool is_source_ips_Valid() const;
...
private:
    ...
    QList<QString> m_destination_ips;
    bool m_destination_ips_isSet;
    bool m_destination_ips_isValid;
    ...
    QList<QString> m_source_ips;
    bool m_source_ips_isSet;
    bool m_source_ips_isValid;
};
