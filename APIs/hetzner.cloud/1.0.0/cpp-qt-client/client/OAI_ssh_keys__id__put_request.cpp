...
#include "OAI_ssh_keys__id__put_request.h"
...
OAI_ssh_keys__id__put_request::OAI_ssh_keys__id__put_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAI_ssh_keys__id__put_request::OAI_ssh_keys__id__put_request() {
    this->initializeModel();
}

OAI_ssh_keys__id__put_request::~OAI_ssh_keys__id__put_request() {}

void OAI_ssh_keys__id__put_request::initializeModel() {
...
void OAI_ssh_keys__id__put_request::fromJson(QString jsonString) {
...
void OAI_ssh_keys__id__put_request::fromJsonObject(QJsonObject json) {
...
QString OAI_ssh_keys__id__put_request::asJson() const {
...
QJsonObject OAI_ssh_keys__id__put_request::asJsonObject() const {
    QJsonObject obj;
    if (m_labels_isSet) {
...
OAIObject OAI_ssh_keys__id__put_request::getLabels() const {
    return m_labels;
}
void OAI_ssh_keys__id__put_request::setLabels(const OAIObject &labels) {
    m_labels = labels;
    m_labels_isSet = true;
}

bool OAI_ssh_keys__id__put_request::is_labels_Set() const{
    return m_labels_isSet;
}

bool OAI_ssh_keys__id__put_request::is_labels_Valid() const{
    return m_labels_isValid;
}

QString OAI_ssh_keys__id__put_request::getName() const {
    return m_name;
}
void OAI_ssh_keys__id__put_request::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAI_ssh_keys__id__put_request::is_name_Set() const{
    return m_name_isSet;
}

bool OAI_ssh_keys__id__put_request::is_name_Valid() const{
    return m_name_isValid;
}

bool OAI_ssh_keys__id__put_request::isSet() const {
...
bool OAI_ssh_keys__id__put_request::isValid() const {
