...
OAILoadBalancerServiceHealthCheck::OAILoadBalancerServiceHealthCheck(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAILoadBalancerServiceHealthCheck::OAILoadBalancerServiceHealthCheck() {
    this->initializeModel();
}

OAILoadBalancerServiceHealthCheck::~OAILoadBalancerServiceHealthCheck() {}

void OAILoadBalancerServiceHealthCheck::initializeModel() {
...
void OAILoadBalancerServiceHealthCheck::fromJson(QString jsonString) {
...
void OAILoadBalancerServiceHealthCheck::fromJsonObject(QJsonObject json) {
...
QString OAILoadBalancerServiceHealthCheck::asJson() const {
...
QJsonObject OAILoadBalancerServiceHealthCheck::asJsonObject() const {
    QJsonObject obj;
    if (m_http.isSet()) {
...
OAILoadBalancerServiceHealthCheck_http OAILoadBalancerServiceHealthCheck::getHttp() const {
    return m_http;
}
void OAILoadBalancerServiceHealthCheck::setHttp(const OAILoadBalancerServiceHealthCheck_http &http) {
    m_http = http;
    m_http_isSet = true;
}

bool OAILoadBalancerServiceHealthCheck::is_http_Set() const{
    return m_http_isSet;
}

bool OAILoadBalancerServiceHealthCheck::is_http_Valid() const{
    return m_http_isValid;
}

qint32 OAILoadBalancerServiceHealthCheck::getInterval() const {
    return m_interval;
}
void OAILoadBalancerServiceHealthCheck::setInterval(const qint32 &interval) {
    m_interval = interval;
    m_interval_isSet = true;
}

bool OAILoadBalancerServiceHealthCheck::is_interval_Set() const{
    return m_interval_isSet;
}

bool OAILoadBalancerServiceHealthCheck::is_interval_Valid() const{
    return m_interval_isValid;
}

qint32 OAILoadBalancerServiceHealthCheck::getPort() const {
    return m_port;
}
void OAILoadBalancerServiceHealthCheck::setPort(const qint32 &port) {
    m_port = port;
    m_port_isSet = true;
}

bool OAILoadBalancerServiceHealthCheck::is_port_Set() const{
    return m_port_isSet;
}

bool OAILoadBalancerServiceHealthCheck::is_port_Valid() const{
    return m_port_isValid;
}

QString OAILoadBalancerServiceHealthCheck::getProtocol() const {
    return m_protocol;
}
void OAILoadBalancerServiceHealthCheck::setProtocol(const QString &protocol) {
    m_protocol = protocol;
    m_protocol_isSet = true;
}

bool OAILoadBalancerServiceHealthCheck::is_protocol_Set() const{
    return m_protocol_isSet;
}

bool OAILoadBalancerServiceHealthCheck::is_protocol_Valid() const{
    return m_protocol_isValid;
}

qint32 OAILoadBalancerServiceHealthCheck::getRetries() const {
    return m_retries;
}
void OAILoadBalancerServiceHealthCheck::setRetries(const qint32 &retries) {
    m_retries = retries;
    m_retries_isSet = true;
}

bool OAILoadBalancerServiceHealthCheck::is_retries_Set() const{
    return m_retries_isSet;
}

bool OAILoadBalancerServiceHealthCheck::is_retries_Valid() const{
    return m_retries_isValid;
}

qint32 OAILoadBalancerServiceHealthCheck::getTimeout() const {
    return m_timeout;
}
void OAILoadBalancerServiceHealthCheck::setTimeout(const qint32 &timeout) {
    m_timeout = timeout;
    m_timeout_isSet = true;
}

bool OAILoadBalancerServiceHealthCheck::is_timeout_Set() const{
    return m_timeout_isSet;
}

bool OAILoadBalancerServiceHealthCheck::is_timeout_Valid() const{
    return m_timeout_isValid;
}

bool OAILoadBalancerServiceHealthCheck::isSet() const {
...
bool OAILoadBalancerServiceHealthCheck::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_interval_isValid && m_port_isValid && m_protocol_isValid && m_retries_isValid && m_timeout_isValid && true;
}
