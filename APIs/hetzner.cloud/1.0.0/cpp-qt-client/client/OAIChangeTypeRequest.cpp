...
OAIChangeTypeRequest::OAIChangeTypeRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIChangeTypeRequest::OAIChangeTypeRequest() {
    this->initializeModel();
}

OAIChangeTypeRequest::~OAIChangeTypeRequest() {}

void OAIChangeTypeRequest::initializeModel() {

    m_load_balancer_type_isSet = false;
    m_load_balancer_type_isValid = false;
}

void OAIChangeTypeRequest::fromJson(QString jsonString) {
...
void OAIChangeTypeRequest::fromJsonObject(QJsonObject json) {
...
QString OAIChangeTypeRequest::asJson() const {
...
QJsonObject OAIChangeTypeRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIChangeTypeRequest::getLoadBalancerType() const {
    return m_load_balancer_type;
}
void OAIChangeTypeRequest::setLoadBalancerType(const QString &load_balancer_type) {
    m_load_balancer_type = load_balancer_type;
    m_load_balancer_type_isSet = true;
}

bool OAIChangeTypeRequest::is_load_balancer_type_Set() const{
    return m_load_balancer_type_isSet;
}

bool OAIChangeTypeRequest::is_load_balancer_type_Valid() const{
    return m_load_balancer_type_isValid;
}

bool OAIChangeTypeRequest::isSet() const {
...
bool OAIChangeTypeRequest::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_load_balancer_type_isValid && true;
}
