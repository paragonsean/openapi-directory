...
OAI_images_get_200_response::OAI_images_get_200_response(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAI_images_get_200_response::OAI_images_get_200_response() {
    this->initializeModel();
}

OAI_images_get_200_response::~OAI_images_get_200_response() {}

void OAI_images_get_200_response::initializeModel() {
...
void OAI_images_get_200_response::fromJson(QString jsonString) {
...
void OAI_images_get_200_response::fromJsonObject(QJsonObject json) {
...
QString OAI_images_get_200_response::asJson() const {
...
QJsonObject OAI_images_get_200_response::asJsonObject() const {
    QJsonObject obj;
    if (m_images.size() > 0) {
...
QList<OAI_images_get_200_response_images_inner> OAI_images_get_200_response::getImages() const {
    return m_images;
}
void OAI_images_get_200_response::setImages(const QList<OAI_images_get_200_response_images_inner> &images) {
    m_images = images;
    m_images_isSet = true;
}

bool OAI_images_get_200_response::is_images_Set() const{
    return m_images_isSet;
}

bool OAI_images_get_200_response::is_images_Valid() const{
    return m_images_isValid;
}

OAIActionsResponse_meta OAI_images_get_200_response::getMeta() const {
    return m_meta;
}
void OAI_images_get_200_response::setMeta(const OAIActionsResponse_meta &meta) {
    m_meta = meta;
    m_meta_isSet = true;
}

bool OAI_images_get_200_response::is_meta_Set() const{
    return m_meta_isSet;
}

bool OAI_images_get_200_response::is_meta_Valid() const{
    return m_meta_isValid;
}

bool OAI_images_get_200_response::isSet() const {
...
bool OAI_images_get_200_response::isValid() const {
