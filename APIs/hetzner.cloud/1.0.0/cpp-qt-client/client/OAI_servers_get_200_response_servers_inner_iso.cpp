...
#include "OAI_servers_get_200_response_servers_inner_iso.h"
...
OAI_servers_get_200_response_servers_inner_iso::OAI_servers_get_200_response_servers_inner_iso(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAI_servers_get_200_response_servers_inner_iso::OAI_servers_get_200_response_servers_inner_iso() {
    this->initializeModel();
}

OAI_servers_get_200_response_servers_inner_iso::~OAI_servers_get_200_response_servers_inner_iso() {}

void OAI_servers_get_200_response_servers_inner_iso::initializeModel() {
...
void OAI_servers_get_200_response_servers_inner_iso::fromJson(QString jsonString) {
...
void OAI_servers_get_200_response_servers_inner_iso::fromJsonObject(QJsonObject json) {
...
QString OAI_servers_get_200_response_servers_inner_iso::asJson() const {
...
QJsonObject OAI_servers_get_200_response_servers_inner_iso::asJsonObject() const {
    QJsonObject obj;
...
QString OAI_servers_get_200_response_servers_inner_iso::getArchitecture() const {
    return m_architecture;
}
void OAI_servers_get_200_response_servers_inner_iso::setArchitecture(const QString &architecture) {
    m_architecture = architecture;
    m_architecture_isSet = true;
}

bool OAI_servers_get_200_response_servers_inner_iso::is_architecture_Set() const{
    return m_architecture_isSet;
}

bool OAI_servers_get_200_response_servers_inner_iso::is_architecture_Valid() const{
    return m_architecture_isValid;
}

QString OAI_servers_get_200_response_servers_inner_iso::getDeprecated() const {
    return m_deprecated;
}
void OAI_servers_get_200_response_servers_inner_iso::setDeprecated(const QString &deprecated) {
    m_deprecated = deprecated;
    m_deprecated_isSet = true;
}

bool OAI_servers_get_200_response_servers_inner_iso::is_deprecated_Set() const{
    return m_deprecated_isSet;
}

bool OAI_servers_get_200_response_servers_inner_iso::is_deprecated_Valid() const{
    return m_deprecated_isValid;
}

QString OAI_servers_get_200_response_servers_inner_iso::getDescription() const {
    return m_description;
}
void OAI_servers_get_200_response_servers_inner_iso::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAI_servers_get_200_response_servers_inner_iso::is_description_Set() const{
    return m_description_isSet;
}

bool OAI_servers_get_200_response_servers_inner_iso::is_description_Valid() const{
    return m_description_isValid;
}

qint32 OAI_servers_get_200_response_servers_inner_iso::getId() const {
    return m_id;
}
void OAI_servers_get_200_response_servers_inner_iso::setId(const qint32 &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAI_servers_get_200_response_servers_inner_iso::is_id_Set() const{
    return m_id_isSet;
}

bool OAI_servers_get_200_response_servers_inner_iso::is_id_Valid() const{
    return m_id_isValid;
}

QString OAI_servers_get_200_response_servers_inner_iso::getName() const {
    return m_name;
}
void OAI_servers_get_200_response_servers_inner_iso::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAI_servers_get_200_response_servers_inner_iso::is_name_Set() const{
    return m_name_isSet;
}

bool OAI_servers_get_200_response_servers_inner_iso::is_name_Valid() const{
    return m_name_isValid;
}

QString OAI_servers_get_200_response_servers_inner_iso::getType() const {
    return m_type;
}
void OAI_servers_get_200_response_servers_inner_iso::setType(const QString &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAI_servers_get_200_response_servers_inner_iso::is_type_Set() const{
    return m_type_isSet;
}

bool OAI_servers_get_200_response_servers_inner_iso::is_type_Valid() const{
    return m_type_isValid;
}

bool OAI_servers_get_200_response_servers_inner_iso::isSet() const {
...
bool OAI_servers_get_200_response_servers_inner_iso::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_architecture_isValid && m_deprecated_isValid && m_description_isValid && m_id_isValid && m_name_isValid && m_type_isValid && true;
}
