...
#include "OAI_load_balancers_get_200_response.h"
...
OAI_load_balancers_get_200_response::OAI_load_balancers_get_200_response(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAI_load_balancers_get_200_response::OAI_load_balancers_get_200_response() {
    this->initializeModel();
}

OAI_load_balancers_get_200_response::~OAI_load_balancers_get_200_response() {}

void OAI_load_balancers_get_200_response::initializeModel() {
...
void OAI_load_balancers_get_200_response::fromJson(QString jsonString) {
...
void OAI_load_balancers_get_200_response::fromJsonObject(QJsonObject json) {
...
QString OAI_load_balancers_get_200_response::asJson() const {
...
QJsonObject OAI_load_balancers_get_200_response::asJsonObject() const {
    QJsonObject obj;
...
QList<OAI_load_balancers_get_200_response_load_balancers_inner> OAI_load_balancers_get_200_response::getLoadBalancers() const {
    return m_load_balancers;
}
void OAI_load_balancers_get_200_response::setLoadBalancers(const QList<OAI_load_balancers_get_200_response_load_balancers_inner> &load_balancers) {
    m_load_balancers = load_balancers;
    m_load_balancers_isSet = true;
}

bool OAI_load_balancers_get_200_response::is_load_balancers_Set() const{
    return m_load_balancers_isSet;
}

bool OAI_load_balancers_get_200_response::is_load_balancers_Valid() const{
    return m_load_balancers_isValid;
}

OAIActionsResponse_meta OAI_load_balancers_get_200_response::getMeta() const {
    return m_meta;
}
void OAI_load_balancers_get_200_response::setMeta(const OAIActionsResponse_meta &meta) {
    m_meta = meta;
    m_meta_isSet = true;
}

bool OAI_load_balancers_get_200_response::is_meta_Set() const{
    return m_meta_isSet;
}

bool OAI_load_balancers_get_200_response::is_meta_Valid() const{
    return m_meta_isValid;
}

bool OAI_load_balancers_get_200_response::isSet() const {
...
bool OAI_load_balancers_get_200_response::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_load_balancers_isValid && true;
}
