...
/*
 * OAIPlacementGroupNullable.h
 *
 * 
 */

#ifndef OAIPlacementGroupNullable_H
#define OAIPlacementGroupNullable_H
...
class OAIPlacementGroupNullable : public OAIObject {
public:
    OAIPlacementGroupNullable();
    OAIPlacementGroupNullable(QString json);
    ~OAIPlacementGroupNullable() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPlacementGroupNullable)

#endif // OAIPlacementGroupNullable_H
