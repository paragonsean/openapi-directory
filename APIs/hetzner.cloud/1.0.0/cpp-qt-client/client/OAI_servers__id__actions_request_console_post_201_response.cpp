...
OAI_servers__id__actions_request_console_post_201_response::OAI_servers__id__actions_request_console_post_201_response(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAI_servers__id__actions_request_console_post_201_response::OAI_servers__id__actions_request_console_post_201_response() {
    this->initializeModel();
}

OAI_servers__id__actions_request_console_post_201_response::~OAI_servers__id__actions_request_console_post_201_response() {}

void OAI_servers__id__actions_request_console_post_201_response::initializeModel() {
    ...
    m_wss_url_isSet = false;
    m_wss_url_isValid = false;
}

void OAI_servers__id__actions_request_console_post_201_response::fromJson(QString jsonString) {
...
void OAI_servers__id__actions_request_console_post_201_response::fromJsonObject(QJsonObject json) {
    ...
    m_wss_url_isValid = ::OpenAPI::fromJsonValue(m_wss_url, json[QString("wss_url")]);
    m_wss_url_isSet = !json[QString("wss_url")].isNull() && m_wss_url_isValid;
}

QString OAI_servers__id__actions_request_console_post_201_response::asJson() const {
...
QJsonObject OAI_servers__id__actions_request_console_post_201_response::asJsonObject() const {
    QJsonObject obj;
    if (m_action.isSet()) {
    ...
    if (m_wss_url_isSet) {
        obj.insert(QString("wss_url"), ::OpenAPI::toJsonValue(m_wss_url));
    }
    return obj;
}

OAIAction OAI_servers__id__actions_request_console_post_201_response::getAction() const {
    return m_action;
}
void OAI_servers__id__actions_request_console_post_201_response::setAction(const OAIAction &action) {
    m_action = action;
    m_action_isSet = true;
}

bool OAI_servers__id__actions_request_console_post_201_response::is_action_Set() const{
    return m_action_isSet;
}

bool OAI_servers__id__actions_request_console_post_201_response::is_action_Valid() const{
    return m_action_isValid;
}

QString OAI_servers__id__actions_request_console_post_201_response::getPassword() const {
    return m_password;
}
void OAI_servers__id__actions_request_console_post_201_response::setPassword(const QString &password) {
    m_password = password;
    m_password_isSet = true;
}

bool OAI_servers__id__actions_request_console_post_201_response::is_password_Set() const{
    return m_password_isSet;
}

bool OAI_servers__id__actions_request_console_post_201_response::is_password_Valid() const{
    return m_password_isValid;
}

QString OAI_servers__id__actions_request_console_post_201_response::getWssUrl() const {
    return m_wss_url;
}
void OAI_servers__id__actions_request_console_post_201_response::setWssUrl(const QString &wss_url) {
    m_wss_url = wss_url;
    m_wss_url_isSet = true;
}

bool OAI_servers__id__actions_request_console_post_201_response::is_wss_url_Set() const{
    return m_wss_url_isSet;
}

bool OAI_servers__id__actions_request_console_post_201_response::is_wss_url_Valid() const{
    return m_wss_url_isValid;
}

bool OAI_servers__id__actions_request_console_post_201_response::isSet() const {
...
bool OAI_servers__id__actions_request_console_post_201_response::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_action_isValid && m_password_isValid && m_wss_url_isValid && true;
}
