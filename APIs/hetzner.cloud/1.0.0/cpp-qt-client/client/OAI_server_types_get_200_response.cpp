...
OAI_server_types_get_200_response::OAI_server_types_get_200_response(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAI_server_types_get_200_response::OAI_server_types_get_200_response() {
    this->initializeModel();
}

OAI_server_types_get_200_response::~OAI_server_types_get_200_response() {}

void OAI_server_types_get_200_response::initializeModel() {

    m_server_types_isSet = false;
    m_server_types_isValid = false;
}

void OAI_server_types_get_200_response::fromJson(QString jsonString) {
...
void OAI_server_types_get_200_response::fromJsonObject(QJsonObject json) {
...
QString OAI_server_types_get_200_response::asJson() const {
...
QJsonObject OAI_server_types_get_200_response::asJsonObject() const {
    QJsonObject obj;
...
QList<OAI_server_types_get_200_response_server_types_inner> OAI_server_types_get_200_response::getServerTypes() const {
    return m_server_types;
}
void OAI_server_types_get_200_response::setServerTypes(const QList<OAI_server_types_get_200_response_server_types_inner> &server_types) {
    m_server_types = server_types;
    m_server_types_isSet = true;
}

bool OAI_server_types_get_200_response::is_server_types_Set() const{
    return m_server_types_isSet;
}

bool OAI_server_types_get_200_response::is_server_types_Valid() const{
    return m_server_types_isValid;
}

bool OAI_server_types_get_200_response::isSet() const {
...
bool OAI_server_types_get_200_response::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_server_types_isValid && true;
}
