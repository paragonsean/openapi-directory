...
OAI_load_balancers__id__metrics_get_200_response::OAI_load_balancers__id__metrics_get_200_response(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAI_load_balancers__id__metrics_get_200_response::OAI_load_balancers__id__metrics_get_200_response() {
    this->initializeModel();
}

OAI_load_balancers__id__metrics_get_200_response::~OAI_load_balancers__id__metrics_get_200_response() {}

void OAI_load_balancers__id__metrics_get_200_response::initializeModel() {

    m_metrics_isSet = false;
    m_metrics_isValid = false;
}

void OAI_load_balancers__id__metrics_get_200_response::fromJson(QString jsonString) {
...
void OAI_load_balancers__id__metrics_get_200_response::fromJsonObject(QJsonObject json) {

    m_metrics_isValid = ::OpenAPI::fromJsonValue(m_metrics, json[QString("metrics")]);
    m_metrics_isSet = !json[QString("metrics")].isNull() && m_metrics_isValid;
}

QString OAI_load_balancers__id__metrics_get_200_response::asJson() const {
...
QJsonObject OAI_load_balancers__id__metrics_get_200_response::asJsonObject() const {
    QJsonObject obj;
    if (m_metrics.isSet()) {
...
OAI_load_balancers__id__metrics_get_200_response_metrics OAI_load_balancers__id__metrics_get_200_response::getMetrics() const {
    return m_metrics;
}
void OAI_load_balancers__id__metrics_get_200_response::setMetrics(const OAI_load_balancers__id__metrics_get_200_response_metrics &metrics) {
    m_metrics = metrics;
    m_metrics_isSet = true;
}

bool OAI_load_balancers__id__metrics_get_200_response::is_metrics_Set() const{
    return m_metrics_isSet;
}

bool OAI_load_balancers__id__metrics_get_200_response::is_metrics_Valid() const{
    return m_metrics_isValid;
}

bool OAI_load_balancers__id__metrics_get_200_response::isSet() const {
...
bool OAI_load_balancers__id__metrics_get_200_response::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_metrics_isValid && true;
}
