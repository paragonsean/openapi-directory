...
OAILoadBalancerTarget::OAILoadBalancerTarget(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAILoadBalancerTarget::OAILoadBalancerTarget() {
    this->initializeModel();
}

OAILoadBalancerTarget::~OAILoadBalancerTarget() {}

void OAILoadBalancerTarget::initializeModel() {
...
void OAILoadBalancerTarget::fromJson(QString jsonString) {
...
void OAILoadBalancerTarget::fromJsonObject(QJsonObject json) {
...
QString OAILoadBalancerTarget::asJson() const {
...
QJsonObject OAILoadBalancerTarget::asJsonObject() const {
    QJsonObject obj;
    if (m_health_status.size() > 0) {
...
QList<OAILoadBalancerTargetHealthStatus_inner> OAILoadBalancerTarget::getHealthStatus() const {
    return m_health_status;
}
void OAILoadBalancerTarget::setHealthStatus(const QList<OAILoadBalancerTargetHealthStatus_inner> &health_status) {
    m_health_status = health_status;
    m_health_status_isSet = true;
}

bool OAILoadBalancerTarget::is_health_status_Set() const{
    return m_health_status_isSet;
}

bool OAILoadBalancerTarget::is_health_status_Valid() const{
    return m_health_status_isValid;
}

OAILoadBalancerTargetIP OAILoadBalancerTarget::getIp() const {
    return m_ip;
}
void OAILoadBalancerTarget::setIp(const OAILoadBalancerTargetIP &ip) {
    m_ip = ip;
    m_ip_isSet = true;
}

bool OAILoadBalancerTarget::is_ip_Set() const{
    return m_ip_isSet;
}

bool OAILoadBalancerTarget::is_ip_Valid() const{
    return m_ip_isValid;
}

OAILoadBalancerTargetLabelSelector OAILoadBalancerTarget::getLabelSelector() const {
    return m_label_selector;
}
void OAILoadBalancerTarget::setLabelSelector(const OAILoadBalancerTargetLabelSelector &label_selector) {
    m_label_selector = label_selector;
    m_label_selector_isSet = true;
}

bool OAILoadBalancerTarget::is_label_selector_Set() const{
    return m_label_selector_isSet;
}

bool OAILoadBalancerTarget::is_label_selector_Valid() const{
    return m_label_selector_isValid;
}

OAILoadBalancerTargetServer OAILoadBalancerTarget::getServer() const {
    return m_server;
}
void OAILoadBalancerTarget::setServer(const OAILoadBalancerTargetServer &server) {
    m_server = server;
    m_server_isSet = true;
}

bool OAILoadBalancerTarget::is_server_Set() const{
    return m_server_isSet;
}

bool OAILoadBalancerTarget::is_server_Valid() const{
    return m_server_isValid;
}

QList<OAILoadBalancerTargetTarget> OAILoadBalancerTarget::getTargets() const {
    return m_targets;
}
void OAILoadBalancerTarget::setTargets(const QList<OAILoadBalancerTargetTarget> &targets) {
    m_targets = targets;
    m_targets_isSet = true;
}

bool OAILoadBalancerTarget::is_targets_Set() const{
    return m_targets_isSet;
}

bool OAILoadBalancerTarget::is_targets_Valid() const{
    return m_targets_isValid;
}

QString OAILoadBalancerTarget::getType() const {
    return m_type;
}
void OAILoadBalancerTarget::setType(const QString &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAILoadBalancerTarget::is_type_Set() const{
    return m_type_isSet;
}

bool OAILoadBalancerTarget::is_type_Valid() const{
    return m_type_isValid;
}

bool OAILoadBalancerTarget::isUsePrivateIp() const {
    return m_use_private_ip;
}
void OAILoadBalancerTarget::setUsePrivateIp(const bool &use_private_ip) {
    m_use_private_ip = use_private_ip;
    m_use_private_ip_isSet = true;
}

bool OAILoadBalancerTarget::is_use_private_ip_Set() const{
    return m_use_private_ip_isSet;
}

bool OAILoadBalancerTarget::is_use_private_ip_Valid() const{
    return m_use_private_ip_isValid;
}

bool OAILoadBalancerTarget::isSet() const {
...
bool OAILoadBalancerTarget::isValid() const {
