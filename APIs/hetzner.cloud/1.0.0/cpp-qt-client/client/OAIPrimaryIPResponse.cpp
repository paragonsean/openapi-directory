...
OAIPrimaryIPResponse::OAIPrimaryIPResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPrimaryIPResponse::OAIPrimaryIPResponse() {
    this->initializeModel();
}

OAIPrimaryIPResponse::~OAIPrimaryIPResponse() {}

void OAIPrimaryIPResponse::initializeModel() {

    m_primary_ip_isSet = false;
    m_primary_ip_isValid = false;
}

void OAIPrimaryIPResponse::fromJson(QString jsonString) {
...
void OAIPrimaryIPResponse::fromJsonObject(QJsonObject json) {
...
QString OAIPrimaryIPResponse::asJson() const {
...
QJsonObject OAIPrimaryIPResponse::asJsonObject() const {
    QJsonObject obj;
...
OAIPrimaryIP OAIPrimaryIPResponse::getPrimaryIp() const {
    return m_primary_ip;
}
void OAIPrimaryIPResponse::setPrimaryIp(const OAIPrimaryIP &primary_ip) {
    m_primary_ip = primary_ip;
    m_primary_ip_isSet = true;
}

bool OAIPrimaryIPResponse::is_primary_ip_Set() const{
    return m_primary_ip_isSet;
}

bool OAIPrimaryIPResponse::is_primary_ip_Valid() const{
    return m_primary_ip_isValid;
}

bool OAIPrimaryIPResponse::isSet() const {
...
bool OAIPrimaryIPResponse::isValid() const {
