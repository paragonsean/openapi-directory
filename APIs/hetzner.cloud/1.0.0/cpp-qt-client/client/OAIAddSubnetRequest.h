...
/*
 * OAIAddSubnetRequest.h
 *
 * 
 */

#ifndef OAIAddSubnetRequest_H
#define OAIAddSubnetRequest_H
...
class OAIAddSubnetRequest : public OAIObject {
public:
    OAIAddSubnetRequest();
    OAIAddSubnetRequest(QString json);
    ~OAIAddSubnetRequest() override;
    ...
    qint32 getVswitchId() const;
    void setVswitchId(const qint32 &vswitch_id);
    bool is_vswitch_id_Set() const;
    bool is_vswitch_id_Valid() const;
...
private:
    ...
    qint32 m_vswitch_id;
    bool m_vswitch_id_isSet;
    bool m_vswitch_id_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIAddSubnetRequest)

#endif // OAIAddSubnetRequest_H
