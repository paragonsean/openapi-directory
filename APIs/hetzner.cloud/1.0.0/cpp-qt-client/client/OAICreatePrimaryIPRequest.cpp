...
OAICreatePrimaryIPRequest::OAICreatePrimaryIPRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreatePrimaryIPRequest::OAICreatePrimaryIPRequest() {
    this->initializeModel();
}

OAICreatePrimaryIPRequest::~OAICreatePrimaryIPRequest() {}

void OAICreatePrimaryIPRequest::initializeModel() {
...
void OAICreatePrimaryIPRequest::fromJson(QString jsonString) {
...
void OAICreatePrimaryIPRequest::fromJsonObject(QJsonObject json) {
...
QString OAICreatePrimaryIPRequest::asJson() const {
...
QJsonObject OAICreatePrimaryIPRequest::asJsonObject() const {
    QJsonObject obj;
...
qint32 OAICreatePrimaryIPRequest::getAssigneeId() const {
    return m_assignee_id;
}
void OAICreatePrimaryIPRequest::setAssigneeId(const qint32 &assignee_id) {
    m_assignee_id = assignee_id;
    m_assignee_id_isSet = true;
}

bool OAICreatePrimaryIPRequest::is_assignee_id_Set() const{
    return m_assignee_id_isSet;
}

bool OAICreatePrimaryIPRequest::is_assignee_id_Valid() const{
    return m_assignee_id_isValid;
}

QString OAICreatePrimaryIPRequest::getAssigneeType() const {
    return m_assignee_type;
}
void OAICreatePrimaryIPRequest::setAssigneeType(const QString &assignee_type) {
    m_assignee_type = assignee_type;
    m_assignee_type_isSet = true;
}

bool OAICreatePrimaryIPRequest::is_assignee_type_Set() const{
    return m_assignee_type_isSet;
}

bool OAICreatePrimaryIPRequest::is_assignee_type_Valid() const{
    return m_assignee_type_isValid;
}

bool OAICreatePrimaryIPRequest::isAutoDelete() const {
    return m_auto_delete;
}
void OAICreatePrimaryIPRequest::setAutoDelete(const bool &auto_delete) {
    m_auto_delete = auto_delete;
    m_auto_delete_isSet = true;
}

bool OAICreatePrimaryIPRequest::is_auto_delete_Set() const{
    return m_auto_delete_isSet;
}

bool OAICreatePrimaryIPRequest::is_auto_delete_Valid() const{
    return m_auto_delete_isValid;
}

QString OAICreatePrimaryIPRequest::getDatacenter() const {
    return m_datacenter;
}
void OAICreatePrimaryIPRequest::setDatacenter(const QString &datacenter) {
    m_datacenter = datacenter;
    m_datacenter_isSet = true;
}

bool OAICreatePrimaryIPRequest::is_datacenter_Set() const{
    return m_datacenter_isSet;
}

bool OAICreatePrimaryIPRequest::is_datacenter_Valid() const{
    return m_datacenter_isValid;
}

OAIObject OAICreatePrimaryIPRequest::getLabels() const {
    return m_labels;
}
void OAICreatePrimaryIPRequest::setLabels(const OAIObject &labels) {
    m_labels = labels;
    m_labels_isSet = true;
}

bool OAICreatePrimaryIPRequest::is_labels_Set() const{
    return m_labels_isSet;
}

bool OAICreatePrimaryIPRequest::is_labels_Valid() const{
    return m_labels_isValid;
}

QString OAICreatePrimaryIPRequest::getName() const {
    return m_name;
}
void OAICreatePrimaryIPRequest::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAICreatePrimaryIPRequest::is_name_Set() const{
    return m_name_isSet;
}

bool OAICreatePrimaryIPRequest::is_name_Valid() const{
    return m_name_isValid;
}

QString OAICreatePrimaryIPRequest::getType() const {
    return m_type;
}
void OAICreatePrimaryIPRequest::setType(const QString &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAICreatePrimaryIPRequest::is_type_Set() const{
    return m_type_isSet;
}

bool OAICreatePrimaryIPRequest::is_type_Valid() const{
    return m_type_isValid;
}

bool OAICreatePrimaryIPRequest::isSet() const {
...
bool OAICreatePrimaryIPRequest::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_assignee_type_isValid && m_name_isValid && m_type_isValid && true;
}
