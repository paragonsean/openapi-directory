...
#include "OAIChangeProtectionRequest_2.h"
...
OAIChangeProtectionRequest_2::OAIChangeProtectionRequest_2(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIChangeProtectionRequest_2::OAIChangeProtectionRequest_2() {
    this->initializeModel();
}

OAIChangeProtectionRequest_2::~OAIChangeProtectionRequest_2() {}

void OAIChangeProtectionRequest_2::initializeModel() {

    m_r_delete_isSet = false;
    m_r_delete_isValid = false;
}

void OAIChangeProtectionRequest_2::fromJson(QString jsonString) {
...
void OAIChangeProtectionRequest_2::fromJsonObject(QJsonObject json) {
...
QString OAIChangeProtectionRequest_2::asJson() const {
...
QJsonObject OAIChangeProtectionRequest_2::asJsonObject() const {
    QJsonObject obj;
    if (m_r_delete_isSet) {
...
bool OAIChangeProtectionRequest_2::isRDelete() const {
    return m_r_delete;
}
void OAIChangeProtectionRequest_2::setRDelete(const bool &r_delete) {
    m_r_delete = r_delete;
    m_r_delete_isSet = true;
}

bool OAIChangeProtectionRequest_2::is_r_delete_Set() const{
    return m_r_delete_isSet;
}

bool OAIChangeProtectionRequest_2::is_r_delete_Valid() const{
    return m_r_delete_isValid;
}

bool OAIChangeProtectionRequest_2::isSet() const {
...
bool OAIChangeProtectionRequest_2::isValid() const {
