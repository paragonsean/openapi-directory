...
QString OAICreateNetworkRequest::getIpRange() const {
    return m_ip_range;
}
void OAICreateNetworkRequest::setIpRange(const QString &ip_range) {
    m_ip_range = ip_range;
    m_ip_range_isSet = true;
}

bool OAICreateNetworkRequest::is_ip_range_Set() const{
    return m_ip_range_isSet;
}

bool OAICreateNetworkRequest::is_ip_range_Valid() const{
    return m_ip_range_isValid;
}

OAICreateLoadBalancerRequest_labels OAICreateNetworkRequest::getLabels() const {
    return m_labels;
}
void OAICreateNetworkRequest::setLabels(const OAICreateLoadBalancerRequest_labels &labels) {
    m_labels = labels;
    m_labels_isSet = true;
}

bool OAICreateNetworkRequest::is_labels_Set() const{
    return m_labels_isSet;
}

bool OAICreateNetworkRequest::is_labels_Valid() const{
    return m_labels_isValid;
}

QString OAICreateNetworkRequest::getName() const {
    return m_name;
}
void OAICreateNetworkRequest::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAICreateNetworkRequest::is_name_Set() const{
    return m_name_isSet;
}

bool OAICreateNetworkRequest::is_name_Valid() const{
    return m_name_isValid;
}

QList<OAI_networks_get_200_response_networks_inner_routes_inner> OAICreateNetworkRequest::getRoutes() const {
    return m_routes;
}
void OAICreateNetworkRequest::setRoutes(const QList<OAI_networks_get_200_response_networks_inner_routes_inner> &routes) {
    m_routes = routes;
    m_routes_isSet = true;
}

bool OAICreateNetworkRequest::is_routes_Set() const{
    return m_routes_isSet;
}

bool OAICreateNetworkRequest::is_routes_Valid() const{
    return m_routes_isValid;
}

QList<OAICreateNetworkRequest_subnets_inner> OAICreateNetworkRequest::getSubnets() const {
    return m_subnets;
}
void OAICreateNetworkRequest::setSubnets(const QList<OAICreateNetworkRequest_subnets_inner> &subnets) {
    m_subnets = subnets;
    m_subnets_isSet = true;
}

bool OAICreateNetworkRequest::is_subnets_Set() const{
    return m_subnets_isSet;
}

bool OAICreateNetworkRequest::is_subnets_Valid() const{
...
bool OAICreateNetworkRequest::isValid() const {
    ...
    return m_ip_range_isValid && m_name_isValid && true;
}
