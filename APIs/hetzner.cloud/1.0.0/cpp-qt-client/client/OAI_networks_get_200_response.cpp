...
OAI_networks_get_200_response::OAI_networks_get_200_response(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAI_networks_get_200_response::OAI_networks_get_200_response() {
    this->initializeModel();
}

OAI_networks_get_200_response::~OAI_networks_get_200_response() {}

void OAI_networks_get_200_response::initializeModel() {
...
void OAI_networks_get_200_response::fromJson(QString jsonString) {
...
void OAI_networks_get_200_response::fromJsonObject(QJsonObject json) {
...
QString OAI_networks_get_200_response::asJson() const {
...
QJsonObject OAI_networks_get_200_response::asJsonObject() const {
    QJsonObject obj;
    if (m_meta.isSet()) {
...
OAIActionsResponse_meta OAI_networks_get_200_response::getMeta() const {
    return m_meta;
}
void OAI_networks_get_200_response::setMeta(const OAIActionsResponse_meta &meta) {
    m_meta = meta;
    m_meta_isSet = true;
}

bool OAI_networks_get_200_response::is_meta_Set() const{
    return m_meta_isSet;
}

bool OAI_networks_get_200_response::is_meta_Valid() const{
    return m_meta_isValid;
}

QList<OAI_networks_get_200_response_networks_inner> OAI_networks_get_200_response::getNetworks() const {
    return m_networks;
}
void OAI_networks_get_200_response::setNetworks(const QList<OAI_networks_get_200_response_networks_inner> &networks) {
    m_networks = networks;
    m_networks_isSet = true;
}

bool OAI_networks_get_200_response::is_networks_Set() const{
    return m_networks_isSet;
}

bool OAI_networks_get_200_response::is_networks_Valid() const{
    return m_networks_isValid;
}

bool OAI_networks_get_200_response::isSet() const {
...
bool OAI_networks_get_200_response::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_networks_isValid && true;
}
