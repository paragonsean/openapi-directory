...
OAI_locations__id__get_200_response::OAI_locations__id__get_200_response(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAI_locations__id__get_200_response::OAI_locations__id__get_200_response() {
    this->initializeModel();
}

OAI_locations__id__get_200_response::~OAI_locations__id__get_200_response() {}

void OAI_locations__id__get_200_response::initializeModel() {

    m_location_isSet = false;
    m_location_isValid = false;
}

void OAI_locations__id__get_200_response::fromJson(QString jsonString) {
...
void OAI_locations__id__get_200_response::fromJsonObject(QJsonObject json) {

    m_location_isValid = ::OpenAPI::fromJsonValue(m_location, json[QString("location")]);
    m_location_isSet = !json[QString("location")].isNull() && m_location_isValid;
}

QString OAI_locations__id__get_200_response::asJson() const {
...
QJsonObject OAI_locations__id__get_200_response::asJsonObject() const {
    QJsonObject obj;
    if (m_location.isSet()) {
...
OAI_datacenters_get_200_response_datacenters_inner_location OAI_locations__id__get_200_response::getLocation() const {
    return m_location;
}
void OAI_locations__id__get_200_response::setLocation(const OAI_datacenters_get_200_response_datacenters_inner_location &location) {
    m_location = location;
    m_location_isSet = true;
}

bool OAI_locations__id__get_200_response::is_location_Set() const{
    return m_location_isSet;
}

bool OAI_locations__id__get_200_response::is_location_Valid() const{
    return m_location_isValid;
}

bool OAI_locations__id__get_200_response::isSet() const {
...
bool OAI_locations__id__get_200_response::isValid() const {
