...
OAI_servers_get_200_response_servers_inner_public_net_ipv4::OAI_servers_get_200_response_servers_inner_public_net_ipv4(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAI_servers_get_200_response_servers_inner_public_net_ipv4::OAI_servers_get_200_response_servers_inner_public_net_ipv4() {
    this->initializeModel();
}

OAI_servers_get_200_response_servers_inner_public_net_ipv4::~OAI_servers_get_200_response_servers_inner_public_net_ipv4() {}

void OAI_servers_get_200_response_servers_inner_public_net_ipv4::initializeModel() {
...
void OAI_servers_get_200_response_servers_inner_public_net_ipv4::fromJson(QString jsonString) {
...
void OAI_servers_get_200_response_servers_inner_public_net_ipv4::fromJsonObject(QJsonObject json) {
...
QString OAI_servers_get_200_response_servers_inner_public_net_ipv4::asJson() const {
...
QJsonObject OAI_servers_get_200_response_servers_inner_public_net_ipv4::asJsonObject() const {
    QJsonObject obj;
    if (m_blocked_isSet) {
...
bool OAI_servers_get_200_response_servers_inner_public_net_ipv4::isBlocked() const {
    return m_blocked;
}
void OAI_servers_get_200_response_servers_inner_public_net_ipv4::setBlocked(const bool &blocked) {
    m_blocked = blocked;
    m_blocked_isSet = true;
}

bool OAI_servers_get_200_response_servers_inner_public_net_ipv4::is_blocked_Set() const{
    return m_blocked_isSet;
}

bool OAI_servers_get_200_response_servers_inner_public_net_ipv4::is_blocked_Valid() const{
    return m_blocked_isValid;
}

QString OAI_servers_get_200_response_servers_inner_public_net_ipv4::getDnsPtr() const {
    return m_dns_ptr;
}
void OAI_servers_get_200_response_servers_inner_public_net_ipv4::setDnsPtr(const QString &dns_ptr) {
    m_dns_ptr = dns_ptr;
    m_dns_ptr_isSet = true;
}

bool OAI_servers_get_200_response_servers_inner_public_net_ipv4::is_dns_ptr_Set() const{
    return m_dns_ptr_isSet;
}

bool OAI_servers_get_200_response_servers_inner_public_net_ipv4::is_dns_ptr_Valid() const{
    return m_dns_ptr_isValid;
}

qint32 OAI_servers_get_200_response_servers_inner_public_net_ipv4::getId() const {
    return m_id;
}
void OAI_servers_get_200_response_servers_inner_public_net_ipv4::setId(const qint32 &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAI_servers_get_200_response_servers_inner_public_net_ipv4::is_id_Set() const{
    return m_id_isSet;
}

bool OAI_servers_get_200_response_servers_inner_public_net_ipv4::is_id_Valid() const{
    return m_id_isValid;
}

QString OAI_servers_get_200_response_servers_inner_public_net_ipv4::getIp() const {
    return m_ip;
}
void OAI_servers_get_200_response_servers_inner_public_net_ipv4::setIp(const QString &ip) {
    m_ip = ip;
    m_ip_isSet = true;
}

bool OAI_servers_get_200_response_servers_inner_public_net_ipv4::is_ip_Set() const{
    return m_ip_isSet;
}

bool OAI_servers_get_200_response_servers_inner_public_net_ipv4::is_ip_Valid() const{
    return m_ip_isValid;
}

bool OAI_servers_get_200_response_servers_inner_public_net_ipv4::isSet() const {
...
bool OAI_servers_get_200_response_servers_inner_public_net_ipv4::isValid() const {
