...
#include "OAICertificate_used_by_inner.h"
...
OAICertificate_used_by_inner::OAICertificate_used_by_inner(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICertificate_used_by_inner::OAICertificate_used_by_inner() {
    this->initializeModel();
}

OAICertificate_used_by_inner::~OAICertificate_used_by_inner() {}

void OAICertificate_used_by_inner::initializeModel() {
...
void OAICertificate_used_by_inner::fromJson(QString jsonString) {
...
void OAICertificate_used_by_inner::fromJsonObject(QJsonObject json) {
...
QString OAICertificate_used_by_inner::asJson() const {
...
QJsonObject OAICertificate_used_by_inner::asJsonObject() const {
    QJsonObject obj;
    if (m_id_isSet) {
...
qint32 OAICertificate_used_by_inner::getId() const {
    return m_id;
}
void OAICertificate_used_by_inner::setId(const qint32 &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAICertificate_used_by_inner::is_id_Set() const{
    return m_id_isSet;
}

bool OAICertificate_used_by_inner::is_id_Valid() const{
    return m_id_isValid;
}

QString OAICertificate_used_by_inner::getType() const {
    return m_type;
}
void OAICertificate_used_by_inner::setType(const QString &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAICertificate_used_by_inner::is_type_Set() const{
    return m_type_isSet;
}

bool OAICertificate_used_by_inner::is_type_Valid() const{
    return m_type_isValid;
}

bool OAICertificate_used_by_inner::isSet() const {
...
bool OAICertificate_used_by_inner::isValid() const {
