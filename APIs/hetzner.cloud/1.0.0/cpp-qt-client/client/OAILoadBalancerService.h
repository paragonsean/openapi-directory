...
/*
 * OAILoadBalancerService.h
 *
 * 
 */

#ifndef OAILoadBalancerService_H
#define OAILoadBalancerService_H

#include <QJsonObject>

#include "OAILoadBalancerServiceHTTP.h"
#include "OAILoadBalancerServiceHealthCheck.h"
#include <QString>
...
namespace OpenAPI {
class OAILoadBalancerServiceHealthCheck;
class OAILoadBalancerServiceHTTP;

class OAILoadBalancerService : public OAIObject {
public:
    OAILoadBalancerService();
    OAILoadBalancerService(QString json);
    ~OAILoadBalancerService() override;
    ...
    OAILoadBalancerServiceHealthCheck getHealthCheck() const;
    void setHealthCheck(const OAILoadBalancerServiceHealthCheck &health_check);
    bool is_health_check_Set() const;
    bool is_health_check_Valid() const;

    OAILoadBalancerServiceHTTP getHttp() const;
    void setHttp(const OAILoadBalancerServiceHTTP &http);
    bool is_http_Set() const;
    bool is_http_Valid() const;

    qint32 getListenPort() const;
    void setListenPort(const qint32 &listen_port);
    bool is_listen_port_Set() const;
    bool is_listen_port_Valid() const;
    ...
    bool isProxyprotocol() const;
    void setProxyprotocol(const bool &proxyprotocol);
    bool is_proxyprotocol_Set() const;
    bool is_proxyprotocol_Valid() const;
...
private:
    ...
    OAILoadBalancerServiceHealthCheck m_health_check;
    bool m_health_check_isSet;
    bool m_health_check_isValid;

    OAILoadBalancerServiceHTTP m_http;
    bool m_http_isSet;
    bool m_http_isValid;

    qint32 m_listen_port;
    ...
    bool m_proxyprotocol_isSet;
    bool m_proxyprotocol_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAILoadBalancerService)

#endif // OAILoadBalancerService_H
