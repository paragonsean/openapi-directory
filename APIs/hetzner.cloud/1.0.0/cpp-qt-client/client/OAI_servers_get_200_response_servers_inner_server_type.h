...
/*
 * OAI_servers_get_200_response_servers_inner_server_type.h
 *
 * Type of Server - determines how much ram, disk and cpu a Server has
 */

#ifndef OAI_servers_get_200_response_servers_inner_server_type_H
#define OAI_servers_get_200_response_servers_inner_server_type_H

#include <QJsonObject>

#include "OAI_pricing_get_200_response_pricing_server_types_inner_prices_inner.h"
#include <QList>
#include <QString>
...
namespace OpenAPI {
class OAI_pricing_get_200_response_pricing_server_types_inner_prices_inner;

class OAI_servers_get_200_response_servers_inner_server_type : public OAIObject {
public:
    OAI_servers_get_200_response_servers_inner_server_type();
    OAI_servers_get_200_response_servers_inner_server_type(QString json);
    ~OAI_servers_get_200_response_servers_inner_server_type() override;
    ...
    double getCores() const;
    void setCores(const double &cores);
    bool is_cores_Set() const;
    bool is_cores_Valid() const;

    QString getCpuType() const;
    void setCpuType(const QString &cpu_type);
    bool is_cpu_type_Set() const;
    bool is_cpu_type_Valid() const;
    ...
    void setDisk(const double &disk);
    ...
    QList<OAI_pricing_get_200_response_pricing_server_types_inner_prices_inner> getPrices() const;
    void setPrices(const QList<OAI_pricing_get_200_response_pricing_server_types_inner_prices_inner> &prices);
...
private:
    ...
    QString m_cpu_type;
    bool m_cpu_type_isSet;
    bool m_cpu_type_isValid;
    ...
    QList<OAI_pricing_get_200_response_pricing_server_types_inner_prices_inner> m_prices;
    bool m_prices_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAI_servers_get_200_response_servers_inner_server_type)

#endif // OAI_servers_get_200_response_servers_inner_server_type_H
