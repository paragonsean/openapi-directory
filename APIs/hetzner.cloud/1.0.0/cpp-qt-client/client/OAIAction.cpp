...
QString OAIAction::getCommand() const {
    return m_command;
}
void OAIAction::setCommand(const QString &command) {
    m_command = command;
    m_command_isSet = true;
}

bool OAIAction::is_command_Set() const{
    return m_command_isSet;
}

bool OAIAction::is_command_Valid() const{
    return m_command_isValid;
}

OAIAction_error OAIAction::getError() const {
    return m_error;
}
void OAIAction::setError(const OAIAction_error &error) {
    m_error = error;
    m_error_isSet = true;
}

bool OAIAction::is_error_Set() const{
    return m_error_isSet;
}

bool OAIAction::is_error_Valid() const{
    return m_error_isValid;
}

QString OAIAction::getFinished() const {
    return m_finished;
}
void OAIAction::setFinished(const QString &finished) {
    m_finished = finished;
    m_finished_isSet = true;
}

bool OAIAction::is_finished_Set() const{
    return m_finished_isSet;
}

bool OAIAction::is_finished_Valid() const{
...
double OAIAction::getProgress() const {
    return m_progress;
}
void OAIAction::setProgress(const double &progress) {
    m_progress = progress;
    m_progress_isSet = true;
}

bool OAIAction::is_progress_Set() const{
    return m_progress_isSet;
}

bool OAIAction::is_progress_Valid() const{
    return m_progress_isValid;
}

QList<OAIAction_resources_inner> OAIAction::getResources() const {
    return m_resources;
}
void OAIAction::setResources(const QList<OAIAction_resources_inner> &resources) {
    m_resources = resources;
    m_resources_isSet = true;
}

bool OAIAction::is_resources_Set() const{
    return m_resources_isSet;
}

bool OAIAction::is_resources_Valid() const{
    return m_resources_isValid;
}

QString OAIAction::getStarted() const {
    return m_started;
}
void OAIAction::setStarted(const QString &started) {
    m_started = started;
    m_started_isSet = true;
}

bool OAIAction::is_started_Set() const{
    return m_started_isSet;
}

bool OAIAction::is_started_Valid() const{
...
bool OAIAction::isValid() const {
    ...
    return m_command_isValid && m_error_isValid && m_finished_isValid && m_id_isValid && m_progress_isValid && m_resources_isValid && m_started_isValid && m_status_isValid && true;
}
