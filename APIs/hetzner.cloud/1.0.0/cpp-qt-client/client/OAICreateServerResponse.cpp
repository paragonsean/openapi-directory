...
OAIAction OAICreateServerResponse::getAction() const {
    return m_action;
}
void OAICreateServerResponse::setAction(const OAIAction &action) {
    m_action = action;
    m_action_isSet = true;
}

bool OAICreateServerResponse::is_action_Set() const{
    return m_action_isSet;
}

bool OAICreateServerResponse::is_action_Valid() const{
    return m_action_isValid;
}

QList<OAIAction> OAICreateServerResponse::getNextActions() const {
    return m_next_actions;
}
void OAICreateServerResponse::setNextActions(const QList<OAIAction> &next_actions) {
    m_next_actions = next_actions;
    m_next_actions_isSet = true;
}

bool OAICreateServerResponse::is_next_actions_Set() const{
    return m_next_actions_isSet;
}

bool OAICreateServerResponse::is_next_actions_Valid() const{
    return m_next_actions_isValid;
}

QString OAICreateServerResponse::getRootPassword() const {
    return m_root_password;
}
void OAICreateServerResponse::setRootPassword(const QString &root_password) {
    m_root_password = root_password;
    m_root_password_isSet = true;
}

bool OAICreateServerResponse::is_root_password_Set() const{
    return m_root_password_isSet;
}

bool OAICreateServerResponse::is_root_password_Valid() const{
    return m_root_password_isValid;
}

OAI_servers_get_200_response_servers_inner OAICreateServerResponse::getServer() const {
    return m_server;
}
void OAICreateServerResponse::setServer(const OAI_servers_get_200_response_servers_inner &server) {
    m_server = server;
    m_server_isSet = true;
}
...
bool OAICreateServerResponse::isValid() const {
    ...
    return m_action_isValid && m_next_actions_isValid && m_root_password_isValid && m_server_isValid && true;
}
