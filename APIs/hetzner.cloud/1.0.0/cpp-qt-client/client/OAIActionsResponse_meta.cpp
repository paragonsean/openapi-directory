...
#include "OAIActionsResponse_meta.h"
...
OAIActionsResponse_meta::OAIActionsResponse_meta(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIActionsResponse_meta::OAIActionsResponse_meta() {
    this->initializeModel();
}

OAIActionsResponse_meta::~OAIActionsResponse_meta() {}

void OAIActionsResponse_meta::initializeModel() {

    m_pagination_isSet = false;
    m_pagination_isValid = false;
}

void OAIActionsResponse_meta::fromJson(QString jsonString) {
...
void OAIActionsResponse_meta::fromJsonObject(QJsonObject json) {
...
QString OAIActionsResponse_meta::asJson() const {
...
QJsonObject OAIActionsResponse_meta::asJsonObject() const {
    QJsonObject obj;
...
OAIActionsResponse_meta_pagination OAIActionsResponse_meta::getPagination() const {
    return m_pagination;
}
void OAIActionsResponse_meta::setPagination(const OAIActionsResponse_meta_pagination &pagination) {
    m_pagination = pagination;
    m_pagination_isSet = true;
}

bool OAIActionsResponse_meta::is_pagination_Set() const{
    return m_pagination_isSet;
}

bool OAIActionsResponse_meta::is_pagination_Valid() const{
    return m_pagination_isValid;
}

bool OAIActionsResponse_meta::isSet() const {
...
bool OAIActionsResponse_meta::isValid() const {
