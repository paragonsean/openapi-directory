...
OAIServerPublicNetFirewall::OAIServerPublicNetFirewall(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIServerPublicNetFirewall::OAIServerPublicNetFirewall() {
    this->initializeModel();
}

OAIServerPublicNetFirewall::~OAIServerPublicNetFirewall() {}

void OAIServerPublicNetFirewall::initializeModel() {
...
void OAIServerPublicNetFirewall::fromJson(QString jsonString) {
...
void OAIServerPublicNetFirewall::fromJsonObject(QJsonObject json) {
...
QString OAIServerPublicNetFirewall::asJson() const {
...
QJsonObject OAIServerPublicNetFirewall::asJsonObject() const {
    QJsonObject obj;
    if (m_id_isSet) {
...
qint32 OAIServerPublicNetFirewall::getId() const {
    return m_id;
}
void OAIServerPublicNetFirewall::setId(const qint32 &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIServerPublicNetFirewall::is_id_Set() const{
    return m_id_isSet;
}

bool OAIServerPublicNetFirewall::is_id_Valid() const{
    return m_id_isValid;
}

QString OAIServerPublicNetFirewall::getStatus() const {
    return m_status;
}
void OAIServerPublicNetFirewall::setStatus(const QString &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIServerPublicNetFirewall::is_status_Set() const{
    return m_status_isSet;
}

bool OAIServerPublicNetFirewall::is_status_Valid() const{
    return m_status_isValid;
}

bool OAIServerPublicNetFirewall::isSet() const {
...
bool OAIServerPublicNetFirewall::isValid() const {
