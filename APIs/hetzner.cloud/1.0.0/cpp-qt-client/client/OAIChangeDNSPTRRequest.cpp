...
OAIChangeDNSPTRRequest::OAIChangeDNSPTRRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIChangeDNSPTRRequest::OAIChangeDNSPTRRequest() {
    this->initializeModel();
}

OAIChangeDNSPTRRequest::~OAIChangeDNSPTRRequest() {}

void OAIChangeDNSPTRRequest::initializeModel() {
...
void OAIChangeDNSPTRRequest::fromJson(QString jsonString) {
...
void OAIChangeDNSPTRRequest::fromJsonObject(QJsonObject json) {
...
QString OAIChangeDNSPTRRequest::asJson() const {
...
QJsonObject OAIChangeDNSPTRRequest::asJsonObject() const {
    QJsonObject obj;
    if (m_dns_ptr_isSet) {
...
QString OAIChangeDNSPTRRequest::getDnsPtr() const {
    return m_dns_ptr;
}
void OAIChangeDNSPTRRequest::setDnsPtr(const QString &dns_ptr) {
    m_dns_ptr = dns_ptr;
    m_dns_ptr_isSet = true;
}

bool OAIChangeDNSPTRRequest::is_dns_ptr_Set() const{
    return m_dns_ptr_isSet;
}

bool OAIChangeDNSPTRRequest::is_dns_ptr_Valid() const{
    return m_dns_ptr_isValid;
}

QString OAIChangeDNSPTRRequest::getIp() const {
    return m_ip;
}
void OAIChangeDNSPTRRequest::setIp(const QString &ip) {
    m_ip = ip;
    m_ip_isSet = true;
}

bool OAIChangeDNSPTRRequest::is_ip_Set() const{
    return m_ip_isSet;
}

bool OAIChangeDNSPTRRequest::is_ip_Valid() const{
    return m_ip_isValid;
}

bool OAIChangeDNSPTRRequest::isSet() const {
...
bool OAIChangeDNSPTRRequest::isValid() const {
