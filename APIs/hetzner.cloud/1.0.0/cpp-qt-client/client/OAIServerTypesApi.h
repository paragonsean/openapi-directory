...
#ifndef OAI_OAIServerTypesApi_H
#define OAI_OAIServerTypesApi_H
...
#include "OAI_server_types__id__get_200_response.h"
#include "OAI_server_types_get_200_response.h"
#include <QString>
...
class OAIServerTypesApi : public QObject {
    Q_OBJECT

public:
    OAIServerTypesApi(const int timeOut = 0);
    ~OAIServerTypesApi();
    ...
    */
    virtual void serverTypesGet(const ::OpenAPI::OptionalParam<QString> &name = ::OpenAPI::OptionalParam<QString>());

    /**
    * @param[in]  id qint32 [required]
    */
    virtual void serverTypesIdGet(const qint32 &id);
...
private:
    ...
    void serverTypesGetCallback(OAIHttpRequestWorker *worker);
    void serverTypesIdGetCallback(OAIHttpRequestWorker *worker);

Q_SIGNALS:

    void serverTypesGetSignal(OAI_server_types_get_200_response summary);
    void serverTypesIdGetSignal(OAI_server_types__id__get_200_response summary);


    void serverTypesGetSignalFull(OAIHttpRequestWorker *worker, OAI_server_types_get_200_response summary);
    void serverTypesIdGetSignalFull(OAIHttpRequestWorker *worker, OAI_server_types__id__get_200_response summary);

    Q_DECL_DEPRECATED_X("Use serverTypesGetSignalError() instead")
    void serverTypesGetSignalE(OAI_server_types_get_200_response summary, QNetworkReply::NetworkError error_type, QString error_str);
    void serverTypesGetSignalError(OAI_server_types_get_200_response summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use serverTypesIdGetSignalError() instead")
    void serverTypesIdGetSignalE(OAI_server_types__id__get_200_response summary, QNetworkReply::NetworkError error_type, QString error_str);
    void serverTypesIdGetSignalError(OAI_server_types__id__get_200_response summary, QNetworkReply::NetworkError error_type, const QString &error_str);

    Q_DECL_DEPRECATED_X("Use serverTypesGetSignalErrorFull() instead")
    void serverTypesGetSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void serverTypesGetSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use serverTypesIdGetSignalErrorFull() instead")
    void serverTypesIdGetSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void serverTypesIdGetSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
