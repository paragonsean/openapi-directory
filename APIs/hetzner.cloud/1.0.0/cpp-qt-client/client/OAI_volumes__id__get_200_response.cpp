...
OAI_volumes__id__get_200_response::OAI_volumes__id__get_200_response(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAI_volumes__id__get_200_response::OAI_volumes__id__get_200_response() {
    this->initializeModel();
}

OAI_volumes__id__get_200_response::~OAI_volumes__id__get_200_response() {}

void OAI_volumes__id__get_200_response::initializeModel() {

    m_volume_isSet = false;
    m_volume_isValid = false;
}

void OAI_volumes__id__get_200_response::fromJson(QString jsonString) {
...
void OAI_volumes__id__get_200_response::fromJsonObject(QJsonObject json) {
...
QString OAI_volumes__id__get_200_response::asJson() const {
...
QJsonObject OAI_volumes__id__get_200_response::asJsonObject() const {
    QJsonObject obj;
    if (m_volume.isSet()) {
...
OAI_volumes_get_200_response_volumes_inner OAI_volumes__id__get_200_response::getVolume() const {
    return m_volume;
}
void OAI_volumes__id__get_200_response::setVolume(const OAI_volumes_get_200_response_volumes_inner &volume) {
    m_volume = volume;
    m_volume_isSet = true;
}

bool OAI_volumes__id__get_200_response::is_volume_Set() const{
    return m_volume_isSet;
}

bool OAI_volumes__id__get_200_response::is_volume_Valid() const{
    return m_volume_isValid;
}

bool OAI_volumes__id__get_200_response::isSet() const {
...
bool OAI_volumes__id__get_200_response::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_volume_isValid && true;
}
