...
#include "OAICreateCertificateResponse.h"
...
OAICreateCertificateResponse::OAICreateCertificateResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateCertificateResponse::OAICreateCertificateResponse() {
    this->initializeModel();
}

OAICreateCertificateResponse::~OAICreateCertificateResponse() {}

void OAICreateCertificateResponse::initializeModel() {
...
void OAICreateCertificateResponse::fromJson(QString jsonString) {
...
void OAICreateCertificateResponse::fromJsonObject(QJsonObject json) {
...
QString OAICreateCertificateResponse::asJson() const {
...
QJsonObject OAICreateCertificateResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_action.isSet()) {
...
OAINullableAction OAICreateCertificateResponse::getAction() const {
    return m_action;
}
void OAICreateCertificateResponse::setAction(const OAINullableAction &action) {
    m_action = action;
    m_action_isSet = true;
}

bool OAICreateCertificateResponse::is_action_Set() const{
    return m_action_isSet;
}

bool OAICreateCertificateResponse::is_action_Valid() const{
    return m_action_isValid;
}

OAICertificate OAICreateCertificateResponse::getCertificate() const {
    return m_certificate;
}
void OAICreateCertificateResponse::setCertificate(const OAICertificate &certificate) {
    m_certificate = certificate;
    m_certificate_isSet = true;
}

bool OAICreateCertificateResponse::is_certificate_Set() const{
    return m_certificate_isSet;
}

bool OAICreateCertificateResponse::is_certificate_Valid() const{
    return m_certificate_isValid;
}

bool OAICreateCertificateResponse::isSet() const {
...
bool OAICreateCertificateResponse::isValid() const {
