...
OAIFirewallResponse::OAIFirewallResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIFirewallResponse::OAIFirewallResponse() {
    this->initializeModel();
}

OAIFirewallResponse::~OAIFirewallResponse() {}

void OAIFirewallResponse::initializeModel() {

    m_firewall_isSet = false;
    m_firewall_isValid = false;
}

void OAIFirewallResponse::fromJson(QString jsonString) {
...
void OAIFirewallResponse::fromJsonObject(QJsonObject json) {
...
QString OAIFirewallResponse::asJson() const {
...
QJsonObject OAIFirewallResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_firewall.isSet()) {
...
OAIFirewall OAIFirewallResponse::getFirewall() const {
    return m_firewall;
}
void OAIFirewallResponse::setFirewall(const OAIFirewall &firewall) {
    m_firewall = firewall;
    m_firewall_isSet = true;
}

bool OAIFirewallResponse::is_firewall_Set() const{
    return m_firewall_isSet;
}

bool OAIFirewallResponse::is_firewall_Valid() const{
    return m_firewall_isValid;
}

bool OAIFirewallResponse::isSet() const {
...
bool OAIFirewallResponse::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_firewall_isValid && true;
}
