...
OAIObject OAIUpdateServerRequest::getLabels() const {
    return m_labels;
}
void OAIUpdateServerRequest::setLabels(const OAIObject &labels) {
    m_labels = labels;
    m_labels_isSet = true;
}

bool OAIUpdateServerRequest::is_labels_Set() const{
    return m_labels_isSet;
}

bool OAIUpdateServerRequest::is_labels_Valid() const{
    return m_labels_isValid;
}

QString OAIUpdateServerRequest::getName() const {
    return m_name;
}
void OAIUpdateServerRequest::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIUpdateServerRequest::is_name_Set() const{
    return m_name_isSet;
}

bool OAIUpdateServerRequest::is_name_Valid() const{
