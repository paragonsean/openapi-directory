...
OAIAttachToNetworkRequest::OAIAttachToNetworkRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAttachToNetworkRequest::OAIAttachToNetworkRequest() {
    this->initializeModel();
}

OAIAttachToNetworkRequest::~OAIAttachToNetworkRequest() {}

void OAIAttachToNetworkRequest::initializeModel() {

    m_alias_ips_isSet = false;
    m_alias_ips_isValid = false;
...
void OAIAttachToNetworkRequest::fromJson(QString jsonString) {
...
void OAIAttachToNetworkRequest::fromJsonObject(QJsonObject json) {

    m_alias_ips_isValid = ::OpenAPI::fromJsonValue(m_alias_ips, json[QString("alias_ips")]);
    m_alias_ips_isSet = !json[QString("alias_ips")].isNull() && m_alias_ips_isValid;
...
QString OAIAttachToNetworkRequest::asJson() const {
...
QJsonObject OAIAttachToNetworkRequest::asJsonObject() const {
    QJsonObject obj;
    if (m_alias_ips.size() > 0) {
        obj.insert(QString("alias_ips"), ::OpenAPI::toJsonValue(m_alias_ips));
    }
    if (m_ip_isSet) {
...
QList<QString> OAIAttachToNetworkRequest::getAliasIps() const {
    return m_alias_ips;
}
void OAIAttachToNetworkRequest::setAliasIps(const QList<QString> &alias_ips) {
    m_alias_ips = alias_ips;
    m_alias_ips_isSet = true;
}

bool OAIAttachToNetworkRequest::is_alias_ips_Set() const{
    return m_alias_ips_isSet;
}

bool OAIAttachToNetworkRequest::is_alias_ips_Valid() const{
    return m_alias_ips_isValid;
}

QString OAIAttachToNetworkRequest::getIp() const {
    return m_ip;
}
void OAIAttachToNetworkRequest::setIp(const QString &ip) {
    m_ip = ip;
    m_ip_isSet = true;
}

bool OAIAttachToNetworkRequest::is_ip_Set() const{
    return m_ip_isSet;
}

bool OAIAttachToNetworkRequest::is_ip_Valid() const{
    return m_ip_isValid;
}

qint32 OAIAttachToNetworkRequest::getNetwork() const {
    return m_network;
}
void OAIAttachToNetworkRequest::setNetwork(const qint32 &network) {
    m_network = network;
    m_network_isSet = true;
}

bool OAIAttachToNetworkRequest::is_network_Set() const{
    return m_network_isSet;
}

bool OAIAttachToNetworkRequest::is_network_Valid() const{
    return m_network_isValid;
}

bool OAIAttachToNetworkRequest::isSet() const {
...
bool OAIAttachToNetworkRequest::isValid() const {
