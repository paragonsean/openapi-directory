...
/*
 * OAICreateNetworkRequest_subnets_inner.h
 *
 * 
 */

#ifndef OAICreateNetworkRequest_subnets_inner_H
#define OAICreateNetworkRequest_subnets_inner_H
...
class OAICreateNetworkRequest_subnets_inner : public OAIObject {
public:
    OAICreateNetworkRequest_subnets_inner();
    OAICreateNetworkRequest_subnets_inner(QString json);
    ~OAICreateNetworkRequest_subnets_inner() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateNetworkRequest_subnets_inner)

#endif // OAICreateNetworkRequest_subnets_inner_H
