...
#include "OAIFirewall_applied_to_inner_label_selector.h"
...
OAIFirewall_applied_to_inner_label_selector::OAIFirewall_applied_to_inner_label_selector(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIFirewall_applied_to_inner_label_selector::OAIFirewall_applied_to_inner_label_selector() {
    this->initializeModel();
}

OAIFirewall_applied_to_inner_label_selector::~OAIFirewall_applied_to_inner_label_selector() {}

void OAIFirewall_applied_to_inner_label_selector::initializeModel() {

    m_selector_isSet = false;
    m_selector_isValid = false;
}

void OAIFirewall_applied_to_inner_label_selector::fromJson(QString jsonString) {
...
void OAIFirewall_applied_to_inner_label_selector::fromJsonObject(QJsonObject json) {
...
QString OAIFirewall_applied_to_inner_label_selector::asJson() const {
...
QJsonObject OAIFirewall_applied_to_inner_label_selector::asJsonObject() const {
    QJsonObject obj;
    if (m_selector_isSet) {
...
QString OAIFirewall_applied_to_inner_label_selector::getSelector() const {
    return m_selector;
}
void OAIFirewall_applied_to_inner_label_selector::setSelector(const QString &selector) {
    m_selector = selector;
    m_selector_isSet = true;
}

bool OAIFirewall_applied_to_inner_label_selector::is_selector_Set() const{
    return m_selector_isSet;
}

bool OAIFirewall_applied_to_inner_label_selector::is_selector_Valid() const{
    return m_selector_isValid;
}

bool OAIFirewall_applied_to_inner_label_selector::isSet() const {
...
bool OAIFirewall_applied_to_inner_label_selector::isValid() const {
