...
void OAIRule::initializeModel() {
    ...
    m_destination_ips_isSet = false;
    m_destination_ips_isValid = false;
    ...
    m_source_ips_isSet = false;
    m_source_ips_isValid = false;
}
...
void OAIRule::fromJsonObject(QJsonObject json) {
    ...
    m_destination_ips_isValid = ::OpenAPI::fromJsonValue(m_destination_ips, json[QString("destination_ips")]);
    m_destination_ips_isSet = !json[QString("destination_ips")].isNull() && m_destination_ips_isValid;
    ...
    m_source_ips_isValid = ::OpenAPI::fromJsonValue(m_source_ips, json[QString("source_ips")]);
    m_source_ips_isSet = !json[QString("source_ips")].isNull() && m_source_ips_isValid;
}
...
QJsonObject OAIRule::asJsonObject() const {
    ...
    if (m_destination_ips.size() > 0) {
        obj.insert(QString("destination_ips"), ::OpenAPI::toJsonValue(m_destination_ips));
    }
    ...
    if (m_source_ips.size() > 0) {
        obj.insert(QString("source_ips"), ::OpenAPI::toJsonValue(m_source_ips));
    }
    return obj;
}
...
QList<QString> OAIRule::getDestinationIps() const {
    return m_destination_ips;
}
void OAIRule::setDestinationIps(const QList<QString> &destination_ips) {
    m_destination_ips = destination_ips;
    m_destination_ips_isSet = true;
}

bool OAIRule::is_destination_ips_Set() const{
    return m_destination_ips_isSet;
}

bool OAIRule::is_destination_ips_Valid() const{
    return m_destination_ips_isValid;
}

QString OAIRule::getDirection() const {
    return m_direction;
}
void OAIRule::setDirection(const QString &direction) {
    m_direction = direction;
    m_direction_isSet = true;
}

bool OAIRule::is_direction_Set() const{
    return m_direction_isSet;
}

bool OAIRule::is_direction_Valid() const{
    return m_direction_isValid;
}

QString OAIRule::getPort() const {
    return m_port;
}
void OAIRule::setPort(const QString &port) {
    m_port = port;
    m_port_isSet = true;
}

bool OAIRule::is_port_Set() const{
    return m_port_isSet;
}

bool OAIRule::is_port_Valid() const{
    return m_port_isValid;
}

QString OAIRule::getProtocol() const {
    return m_protocol;
}
void OAIRule::setProtocol(const QString &protocol) {
    m_protocol = protocol;
    m_protocol_isSet = true;
}

bool OAIRule::is_protocol_Set() const{
    return m_protocol_isSet;
}

bool OAIRule::is_protocol_Valid() const{
    return m_protocol_isValid;
}

QList<QString> OAIRule::getSourceIps() const {
    return m_source_ips;
}
void OAIRule::setSourceIps(const QList<QString> &source_ips) {
    m_source_ips = source_ips;
    m_source_ips_isSet = true;
}

bool OAIRule::is_source_ips_Set() const{
    return m_source_ips_isSet;
}

bool OAIRule::is_source_ips_Valid() const{
    return m_source_ips_isValid;
}
...
bool OAIRule::isValid() const {
    ...
    return m_direction_isValid && m_protocol_isValid && true;
}
