...
#include "OAI_load_balancers__id__metrics_get_200_response_metrics.h"
...
OAI_load_balancers__id__metrics_get_200_response_metrics::OAI_load_balancers__id__metrics_get_200_response_metrics(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAI_load_balancers__id__metrics_get_200_response_metrics::OAI_load_balancers__id__metrics_get_200_response_metrics() {
    this->initializeModel();
}

OAI_load_balancers__id__metrics_get_200_response_metrics::~OAI_load_balancers__id__metrics_get_200_response_metrics() {}

void OAI_load_balancers__id__metrics_get_200_response_metrics::initializeModel() {
...
void OAI_load_balancers__id__metrics_get_200_response_metrics::fromJson(QString jsonString) {
...
void OAI_load_balancers__id__metrics_get_200_response_metrics::fromJsonObject(QJsonObject json) {
...
QString OAI_load_balancers__id__metrics_get_200_response_metrics::asJson() const {
...
QJsonObject OAI_load_balancers__id__metrics_get_200_response_metrics::asJsonObject() const {
    QJsonObject obj;
    if (m_end_isSet) {
...
QString OAI_load_balancers__id__metrics_get_200_response_metrics::getEnd() const {
    return m_end;
}
void OAI_load_balancers__id__metrics_get_200_response_metrics::setEnd(const QString &end) {
    m_end = end;
    m_end_isSet = true;
}

bool OAI_load_balancers__id__metrics_get_200_response_metrics::is_end_Set() const{
    return m_end_isSet;
}

bool OAI_load_balancers__id__metrics_get_200_response_metrics::is_end_Valid() const{
    return m_end_isValid;
}

QString OAI_load_balancers__id__metrics_get_200_response_metrics::getStart() const {
    return m_start;
}
void OAI_load_balancers__id__metrics_get_200_response_metrics::setStart(const QString &start) {
    m_start = start;
    m_start_isSet = true;
}

bool OAI_load_balancers__id__metrics_get_200_response_metrics::is_start_Set() const{
    return m_start_isSet;
}

bool OAI_load_balancers__id__metrics_get_200_response_metrics::is_start_Valid() const{
    return m_start_isValid;
}

double OAI_load_balancers__id__metrics_get_200_response_metrics::getStep() const {
    return m_step;
}
void OAI_load_balancers__id__metrics_get_200_response_metrics::setStep(const double &step) {
    m_step = step;
    m_step_isSet = true;
}

bool OAI_load_balancers__id__metrics_get_200_response_metrics::is_step_Set() const{
    return m_step_isSet;
}

bool OAI_load_balancers__id__metrics_get_200_response_metrics::is_step_Valid() const{
    return m_step_isValid;
}

QMap<QString, OAI_load_balancers__id__metrics_get_200_response_metrics_time_series_value> OAI_load_balancers__id__metrics_get_200_response_metrics::getTimeSeries() const {
    return m_time_series;
}
void OAI_load_balancers__id__metrics_get_200_response_metrics::setTimeSeries(const QMap<QString, OAI_load_balancers__id__metrics_get_200_response_metrics_time_series_value> &time_series) {
    m_time_series = time_series;
    m_time_series_isSet = true;
}

bool OAI_load_balancers__id__metrics_get_200_response_metrics::is_time_series_Set() const{
    return m_time_series_isSet;
}

bool OAI_load_balancers__id__metrics_get_200_response_metrics::is_time_series_Valid() const{
    return m_time_series_isValid;
}

bool OAI_load_balancers__id__metrics_get_200_response_metrics::isSet() const {
...
bool OAI_load_balancers__id__metrics_get_200_response_metrics::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_end_isValid && m_start_isValid && m_step_isValid && m_time_series_isValid && true;
}
