...
OAI_pricing_get_200_response_pricing_server_types_inner::OAI_pricing_get_200_response_pricing_server_types_inner(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAI_pricing_get_200_response_pricing_server_types_inner::OAI_pricing_get_200_response_pricing_server_types_inner() {
    this->initializeModel();
}

OAI_pricing_get_200_response_pricing_server_types_inner::~OAI_pricing_get_200_response_pricing_server_types_inner() {}

void OAI_pricing_get_200_response_pricing_server_types_inner::initializeModel() {
...
void OAI_pricing_get_200_response_pricing_server_types_inner::fromJson(QString jsonString) {
...
void OAI_pricing_get_200_response_pricing_server_types_inner::fromJsonObject(QJsonObject json) {
...
QString OAI_pricing_get_200_response_pricing_server_types_inner::asJson() const {
...
QJsonObject OAI_pricing_get_200_response_pricing_server_types_inner::asJsonObject() const {
    QJsonObject obj;
    if (m_id_isSet) {
...
double OAI_pricing_get_200_response_pricing_server_types_inner::getId() const {
    return m_id;
}
void OAI_pricing_get_200_response_pricing_server_types_inner::setId(const double &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAI_pricing_get_200_response_pricing_server_types_inner::is_id_Set() const{
    return m_id_isSet;
}

bool OAI_pricing_get_200_response_pricing_server_types_inner::is_id_Valid() const{
    return m_id_isValid;
}

QString OAI_pricing_get_200_response_pricing_server_types_inner::getName() const {
    return m_name;
}
void OAI_pricing_get_200_response_pricing_server_types_inner::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAI_pricing_get_200_response_pricing_server_types_inner::is_name_Set() const{
    return m_name_isSet;
}

bool OAI_pricing_get_200_response_pricing_server_types_inner::is_name_Valid() const{
    return m_name_isValid;
}

QList<OAI_pricing_get_200_response_pricing_server_types_inner_prices_inner> OAI_pricing_get_200_response_pricing_server_types_inner::getPrices() const {
    return m_prices;
}
void OAI_pricing_get_200_response_pricing_server_types_inner::setPrices(const QList<OAI_pricing_get_200_response_pricing_server_types_inner_prices_inner> &prices) {
    m_prices = prices;
    m_prices_isSet = true;
}

bool OAI_pricing_get_200_response_pricing_server_types_inner::is_prices_Set() const{
    return m_prices_isSet;
}

bool OAI_pricing_get_200_response_pricing_server_types_inner::is_prices_Valid() const{
    return m_prices_isValid;
}

bool OAI_pricing_get_200_response_pricing_server_types_inner::isSet() const {
...
bool OAI_pricing_get_200_response_pricing_server_types_inner::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_id_isValid && m_name_isValid && m_prices_isValid && true;
}
