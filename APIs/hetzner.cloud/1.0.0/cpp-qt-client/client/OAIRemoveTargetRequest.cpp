...
OAIRemoveTargetRequest::OAIRemoveTargetRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIRemoveTargetRequest::OAIRemoveTargetRequest() {
    this->initializeModel();
}

OAIRemoveTargetRequest::~OAIRemoveTargetRequest() {}

void OAIRemoveTargetRequest::initializeModel() {
...
void OAIRemoveTargetRequest::fromJson(QString jsonString) {
...
void OAIRemoveTargetRequest::fromJsonObject(QJsonObject json) {
...
QString OAIRemoveTargetRequest::asJson() const {
...
QJsonObject OAIRemoveTargetRequest::asJsonObject() const {
    QJsonObject obj;
    if (m_ip.isSet()) {
...
OAILoadBalancerTargetIP OAIRemoveTargetRequest::getIp() const {
    return m_ip;
}
void OAIRemoveTargetRequest::setIp(const OAILoadBalancerTargetIP &ip) {
    m_ip = ip;
    m_ip_isSet = true;
}

bool OAIRemoveTargetRequest::is_ip_Set() const{
    return m_ip_isSet;
}

bool OAIRemoveTargetRequest::is_ip_Valid() const{
    return m_ip_isValid;
}

OAIAddTargetRequest_label_selector OAIRemoveTargetRequest::getLabelSelector() const {
    return m_label_selector;
}
void OAIRemoveTargetRequest::setLabelSelector(const OAIAddTargetRequest_label_selector &label_selector) {
    m_label_selector = label_selector;
    m_label_selector_isSet = true;
}

bool OAIRemoveTargetRequest::is_label_selector_Set() const{
    return m_label_selector_isSet;
}

bool OAIRemoveTargetRequest::is_label_selector_Valid() const{
    return m_label_selector_isValid;
}

OAIAddTargetRequest_server OAIRemoveTargetRequest::getServer() const {
    return m_server;
}
void OAIRemoveTargetRequest::setServer(const OAIAddTargetRequest_server &server) {
    m_server = server;
    m_server_isSet = true;
}

bool OAIRemoveTargetRequest::is_server_Set() const{
    return m_server_isSet;
}

bool OAIRemoveTargetRequest::is_server_Valid() const{
    return m_server_isValid;
}

QString OAIRemoveTargetRequest::getType() const {
    return m_type;
}
void OAIRemoveTargetRequest::setType(const QString &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAIRemoveTargetRequest::is_type_Set() const{
    return m_type_isSet;
}

bool OAIRemoveTargetRequest::is_type_Valid() const{
    return m_type_isValid;
}

bool OAIRemoveTargetRequest::isSet() const {
...
bool OAIRemoveTargetRequest::isValid() const {
