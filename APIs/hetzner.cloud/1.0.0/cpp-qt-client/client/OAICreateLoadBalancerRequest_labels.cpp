...
OAICreateLoadBalancerRequest_labels::OAICreateLoadBalancerRequest_labels(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateLoadBalancerRequest_labels::OAICreateLoadBalancerRequest_labels() {
    this->initializeModel();
}

OAICreateLoadBalancerRequest_labels::~OAICreateLoadBalancerRequest_labels() {}

void OAICreateLoadBalancerRequest_labels::initializeModel() {

    m_labelkey_isSet = false;
    m_labelkey_isValid = false;
}

void OAICreateLoadBalancerRequest_labels::fromJson(QString jsonString) {
...
void OAICreateLoadBalancerRequest_labels::fromJsonObject(QJsonObject json) {
...
QString OAICreateLoadBalancerRequest_labels::asJson() const {
...
QJsonObject OAICreateLoadBalancerRequest_labels::asJsonObject() const {
    QJsonObject obj;
    if (m_labelkey_isSet) {
...
QString OAICreateLoadBalancerRequest_labels::getLabelkey() const {
    return m_labelkey;
}
void OAICreateLoadBalancerRequest_labels::setLabelkey(const QString &labelkey) {
    m_labelkey = labelkey;
    m_labelkey_isSet = true;
}

bool OAICreateLoadBalancerRequest_labels::is_labelkey_Set() const{
    return m_labelkey_isSet;
}

bool OAICreateLoadBalancerRequest_labels::is_labelkey_Valid() const{
    return m_labelkey_isValid;
}

bool OAICreateLoadBalancerRequest_labels::isSet() const {
...
bool OAICreateLoadBalancerRequest_labels::isValid() const {
