...
/*
 * OAICreateFloatingIPRequest.h
 *
 * 
 */

#ifndef OAICreateFloatingIPRequest_H
#define OAICreateFloatingIPRequest_H
...
class OAICreateFloatingIPRequest : public OAIObject {
public:
    OAICreateFloatingIPRequest();
    OAICreateFloatingIPRequest(QString json);
    ~OAICreateFloatingIPRequest() override;
    ...
    QString getHomeLocation() const;
    void setHomeLocation(const QString &home_location);
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateFloatingIPRequest)

#endif // OAICreateFloatingIPRequest_H
