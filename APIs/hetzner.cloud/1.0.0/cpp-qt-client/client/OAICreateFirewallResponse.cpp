...
OAICreateFirewallResponse::OAICreateFirewallResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateFirewallResponse::OAICreateFirewallResponse() {
    this->initializeModel();
}

OAICreateFirewallResponse::~OAICreateFirewallResponse() {}

void OAICreateFirewallResponse::initializeModel() {
...
void OAICreateFirewallResponse::fromJson(QString jsonString) {
...
void OAICreateFirewallResponse::fromJsonObject(QJsonObject json) {
...
QString OAICreateFirewallResponse::asJson() const {
...
QJsonObject OAICreateFirewallResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_actions.size() > 0) {
...
QList<OAIAction> OAICreateFirewallResponse::getActions() const {
    return m_actions;
}
void OAICreateFirewallResponse::setActions(const QList<OAIAction> &actions) {
    m_actions = actions;
    m_actions_isSet = true;
}

bool OAICreateFirewallResponse::is_actions_Set() const{
    return m_actions_isSet;
}

bool OAICreateFirewallResponse::is_actions_Valid() const{
    return m_actions_isValid;
}

OAIFirewall OAICreateFirewallResponse::getFirewall() const {
    return m_firewall;
}
void OAICreateFirewallResponse::setFirewall(const OAIFirewall &firewall) {
    m_firewall = firewall;
    m_firewall_isSet = true;
}

bool OAICreateFirewallResponse::is_firewall_Set() const{
    return m_firewall_isSet;
}

bool OAICreateFirewallResponse::is_firewall_Valid() const{
    return m_firewall_isValid;
}

bool OAICreateFirewallResponse::isSet() const {
...
bool OAICreateFirewallResponse::isValid() const {
