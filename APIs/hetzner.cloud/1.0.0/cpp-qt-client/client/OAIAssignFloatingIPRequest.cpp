...
OAIAssignFloatingIPRequest::OAIAssignFloatingIPRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAssignFloatingIPRequest::OAIAssignFloatingIPRequest() {
    this->initializeModel();
}

OAIAssignFloatingIPRequest::~OAIAssignFloatingIPRequest() {}

void OAIAssignFloatingIPRequest::initializeModel() {

    m_server_isSet = false;
    m_server_isValid = false;
}

void OAIAssignFloatingIPRequest::fromJson(QString jsonString) {
...
void OAIAssignFloatingIPRequest::fromJsonObject(QJsonObject json) {
...
QString OAIAssignFloatingIPRequest::asJson() const {
...
QJsonObject OAIAssignFloatingIPRequest::asJsonObject() const {
    QJsonObject obj;
    if (m_server_isSet) {
...
qint32 OAIAssignFloatingIPRequest::getServer() const {
    return m_server;
}
void OAIAssignFloatingIPRequest::setServer(const qint32 &server) {
    m_server = server;
    m_server_isSet = true;
}

bool OAIAssignFloatingIPRequest::is_server_Set() const{
    return m_server_isSet;
}

bool OAIAssignFloatingIPRequest::is_server_Valid() const{
    return m_server_isValid;
}

bool OAIAssignFloatingIPRequest::isSet() const {
...
bool OAIAssignFloatingIPRequest::isValid() const {
