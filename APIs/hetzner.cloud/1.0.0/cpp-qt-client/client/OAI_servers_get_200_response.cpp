...
OAI_servers_get_200_response::OAI_servers_get_200_response(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAI_servers_get_200_response::OAI_servers_get_200_response() {
    this->initializeModel();
}

OAI_servers_get_200_response::~OAI_servers_get_200_response() {}

void OAI_servers_get_200_response::initializeModel() {
...
void OAI_servers_get_200_response::fromJson(QString jsonString) {
...
void OAI_servers_get_200_response::fromJsonObject(QJsonObject json) {
...
QString OAI_servers_get_200_response::asJson() const {
...
QJsonObject OAI_servers_get_200_response::asJsonObject() const {
    QJsonObject obj;
    if (m_meta.isSet()) {
...
OAIActionsResponse_meta OAI_servers_get_200_response::getMeta() const {
    return m_meta;
}
void OAI_servers_get_200_response::setMeta(const OAIActionsResponse_meta &meta) {
    m_meta = meta;
    m_meta_isSet = true;
}

bool OAI_servers_get_200_response::is_meta_Set() const{
    return m_meta_isSet;
}

bool OAI_servers_get_200_response::is_meta_Valid() const{
    return m_meta_isValid;
}

QList<OAI_servers_get_200_response_servers_inner> OAI_servers_get_200_response::getServers() const {
    return m_servers;
}
void OAI_servers_get_200_response::setServers(const QList<OAI_servers_get_200_response_servers_inner> &servers) {
    m_servers = servers;
    m_servers_isSet = true;
}

bool OAI_servers_get_200_response::is_servers_Set() const{
    return m_servers_isSet;
}

bool OAI_servers_get_200_response::is_servers_Valid() const{
    return m_servers_isValid;
}

bool OAI_servers_get_200_response::isSet() const {
...
bool OAI_servers_get_200_response::isValid() const {
