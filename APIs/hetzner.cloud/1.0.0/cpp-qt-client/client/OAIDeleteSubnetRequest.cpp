...
OAIDeleteSubnetRequest::OAIDeleteSubnetRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDeleteSubnetRequest::OAIDeleteSubnetRequest() {
    this->initializeModel();
}

OAIDeleteSubnetRequest::~OAIDeleteSubnetRequest() {}

void OAIDeleteSubnetRequest::initializeModel() {

    m_ip_range_isSet = false;
    m_ip_range_isValid = false;
}

void OAIDeleteSubnetRequest::fromJson(QString jsonString) {
...
void OAIDeleteSubnetRequest::fromJsonObject(QJsonObject json) {
...
QString OAIDeleteSubnetRequest::asJson() const {
...
QJsonObject OAIDeleteSubnetRequest::asJsonObject() const {
    QJsonObject obj;
    if (m_ip_range_isSet) {
...
QString OAIDeleteSubnetRequest::getIpRange() const {
    return m_ip_range;
}
void OAIDeleteSubnetRequest::setIpRange(const QString &ip_range) {
    m_ip_range = ip_range;
    m_ip_range_isSet = true;
}

bool OAIDeleteSubnetRequest::is_ip_range_Set() const{
    return m_ip_range_isSet;
}

bool OAIDeleteSubnetRequest::is_ip_range_Valid() const{
    return m_ip_range_isValid;
}

bool OAIDeleteSubnetRequest::isSet() const {
...
bool OAIDeleteSubnetRequest::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_ip_range_isValid && true;
}
