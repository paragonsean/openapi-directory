...
OAI_load_balancers__id__actions_delete_service_post_request::OAI_load_balancers__id__actions_delete_service_post_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAI_load_balancers__id__actions_delete_service_post_request::OAI_load_balancers__id__actions_delete_service_post_request() {
    this->initializeModel();
}

OAI_load_balancers__id__actions_delete_service_post_request::~OAI_load_balancers__id__actions_delete_service_post_request() {}

void OAI_load_balancers__id__actions_delete_service_post_request::initializeModel() {

    m_listen_port_isSet = false;
    m_listen_port_isValid = false;
}

void OAI_load_balancers__id__actions_delete_service_post_request::fromJson(QString jsonString) {
...
void OAI_load_balancers__id__actions_delete_service_post_request::fromJsonObject(QJsonObject json) {
...
QString OAI_load_balancers__id__actions_delete_service_post_request::asJson() const {
...
QJsonObject OAI_load_balancers__id__actions_delete_service_post_request::asJsonObject() const {
    QJsonObject obj;
...
double OAI_load_balancers__id__actions_delete_service_post_request::getListenPort() const {
    return m_listen_port;
}
void OAI_load_balancers__id__actions_delete_service_post_request::setListenPort(const double &listen_port) {
    m_listen_port = listen_port;
    m_listen_port_isSet = true;
}

bool OAI_load_balancers__id__actions_delete_service_post_request::is_listen_port_Set() const{
    return m_listen_port_isSet;
}

bool OAI_load_balancers__id__actions_delete_service_post_request::is_listen_port_Valid() const{
    return m_listen_port_isValid;
}

bool OAI_load_balancers__id__actions_delete_service_post_request::isSet() const {
...
bool OAI_load_balancers__id__actions_delete_service_post_request::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_listen_port_isValid && true;
}
