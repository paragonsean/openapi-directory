...
/*
 * OAILoadBalancerServiceHTTP.h
 *
 * Configuration option for protocols http and https
 */

#ifndef OAILoadBalancerServiceHTTP_H
#define OAILoadBalancerServiceHTTP_H
...
class OAILoadBalancerServiceHTTP : public OAIObject {
public:
    OAILoadBalancerServiceHTTP();
    OAILoadBalancerServiceHTTP(QString json);
    ~OAILoadBalancerServiceHTTP() override;
    ...
    QList<qint32> getCertificates() const;
    void setCertificates(const QList<qint32> &certificates);
    bool is_certificates_Set() const;
    bool is_certificates_Valid() const;

    qint32 getCookieLifetime() const;
    void setCookieLifetime(const qint32 &cookie_lifetime);
    bool is_cookie_lifetime_Set() const;
    bool is_cookie_lifetime_Valid() const;

    QString getCookieName() const;
    void setCookieName(const QString &cookie_name);
    bool is_cookie_name_Set() const;
    bool is_cookie_name_Valid() const;

    bool isRedirectHttp() const;
    void setRedirectHttp(const bool &redirect_http);
    bool is_redirect_http_Set() const;
    bool is_redirect_http_Valid() const;
...
private:
    ...
    QList<qint32> m_certificates;
    bool m_certificates_isSet;
    bool m_certificates_isValid;

    qint32 m_cookie_lifetime;
    bool m_cookie_lifetime_isSet;
    bool m_cookie_lifetime_isValid;

    QString m_cookie_name;
    bool m_cookie_name_isSet;
    bool m_cookie_name_isValid;

    bool m_redirect_http;
    bool m_redirect_http_isSet;
    bool m_redirect_http_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAILoadBalancerServiceHTTP)

#endif // OAILoadBalancerServiceHTTP_H
