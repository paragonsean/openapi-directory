...
#include "OAIFirewallRemoveFromResources.h"
...
OAIFirewallRemoveFromResources::OAIFirewallRemoveFromResources(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIFirewallRemoveFromResources::OAIFirewallRemoveFromResources() {
    this->initializeModel();
}

OAIFirewallRemoveFromResources::~OAIFirewallRemoveFromResources() {}

void OAIFirewallRemoveFromResources::initializeModel() {
...
void OAIFirewallRemoveFromResources::fromJson(QString jsonString) {
...
void OAIFirewallRemoveFromResources::fromJsonObject(QJsonObject json) {
...
QString OAIFirewallRemoveFromResources::asJson() const {
...
QJsonObject OAIFirewallRemoveFromResources::asJsonObject() const {
    QJsonObject obj;
...
OAIFirewallApplyToResources_label_selector OAIFirewallRemoveFromResources::getLabelSelector() const {
    return m_label_selector;
}
void OAIFirewallRemoveFromResources::setLabelSelector(const OAIFirewallApplyToResources_label_selector &label_selector) {
    m_label_selector = label_selector;
    m_label_selector_isSet = true;
}

bool OAIFirewallRemoveFromResources::is_label_selector_Set() const{
    return m_label_selector_isSet;
}

bool OAIFirewallRemoveFromResources::is_label_selector_Valid() const{
    return m_label_selector_isValid;
}

OAIFirewallApplyToResources_server OAIFirewallRemoveFromResources::getServer() const {
    return m_server;
}
void OAIFirewallRemoveFromResources::setServer(const OAIFirewallApplyToResources_server &server) {
    m_server = server;
    m_server_isSet = true;
}

bool OAIFirewallRemoveFromResources::is_server_Set() const{
    return m_server_isSet;
}

bool OAIFirewallRemoveFromResources::is_server_Valid() const{
    return m_server_isValid;
}

QString OAIFirewallRemoveFromResources::getType() const {
    return m_type;
}
void OAIFirewallRemoveFromResources::setType(const QString &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAIFirewallRemoveFromResources::is_type_Set() const{
    return m_type_isSet;
}

bool OAIFirewallRemoveFromResources::is_type_Valid() const{
    return m_type_isValid;
}

bool OAIFirewallRemoveFromResources::isSet() const {
...
bool OAIFirewallRemoveFromResources::isValid() const {
