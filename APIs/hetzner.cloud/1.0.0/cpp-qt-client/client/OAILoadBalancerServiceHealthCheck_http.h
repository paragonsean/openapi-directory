...
/*
 * OAILoadBalancerServiceHealthCheck_http.h
 *
 * Additional configuration for protocol http
 */

#ifndef OAILoadBalancerServiceHealthCheck_http_H
#define OAILoadBalancerServiceHealthCheck_http_H
...
class OAILoadBalancerServiceHealthCheck_http : public OAIObject {
public:
    OAILoadBalancerServiceHealthCheck_http();
    OAILoadBalancerServiceHealthCheck_http(QString json);
    ~OAILoadBalancerServiceHealthCheck_http() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILoadBalancerServiceHealthCheck_http)

#endif // OAILoadBalancerServiceHealthCheck_http_H
