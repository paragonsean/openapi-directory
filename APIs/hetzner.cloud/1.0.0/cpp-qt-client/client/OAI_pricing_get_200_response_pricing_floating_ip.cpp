...
OAI_pricing_get_200_response_pricing_floating_ip::OAI_pricing_get_200_response_pricing_floating_ip(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAI_pricing_get_200_response_pricing_floating_ip::OAI_pricing_get_200_response_pricing_floating_ip() {
    this->initializeModel();
}

OAI_pricing_get_200_response_pricing_floating_ip::~OAI_pricing_get_200_response_pricing_floating_ip() {}

void OAI_pricing_get_200_response_pricing_floating_ip::initializeModel() {

    m_price_monthly_isSet = false;
    m_price_monthly_isValid = false;
}

void OAI_pricing_get_200_response_pricing_floating_ip::fromJson(QString jsonString) {
...
void OAI_pricing_get_200_response_pricing_floating_ip::fromJsonObject(QJsonObject json) {
...
QString OAI_pricing_get_200_response_pricing_floating_ip::asJson() const {
...
QJsonObject OAI_pricing_get_200_response_pricing_floating_ip::asJsonObject() const {
    QJsonObject obj;
...
OAI_pricing_get_200_response_pricing_floating_ip_price_monthly OAI_pricing_get_200_response_pricing_floating_ip::getPriceMonthly() const {
    return m_price_monthly;
}
void OAI_pricing_get_200_response_pricing_floating_ip::setPriceMonthly(const OAI_pricing_get_200_response_pricing_floating_ip_price_monthly &price_monthly) {
    m_price_monthly = price_monthly;
    m_price_monthly_isSet = true;
}

bool OAI_pricing_get_200_response_pricing_floating_ip::is_price_monthly_Set() const{
    return m_price_monthly_isSet;
}

bool OAI_pricing_get_200_response_pricing_floating_ip::is_price_monthly_Valid() const{
    return m_price_monthly_isValid;
}

bool OAI_pricing_get_200_response_pricing_floating_ip::isSet() const {
...
bool OAI_pricing_get_200_response_pricing_floating_ip::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_price_monthly_isValid && true;
}
