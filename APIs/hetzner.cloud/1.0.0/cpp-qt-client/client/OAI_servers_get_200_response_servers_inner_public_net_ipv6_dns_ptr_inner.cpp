...
OAI_servers_get_200_response_servers_inner_public_net_ipv6_dns_ptr_inner::OAI_servers_get_200_response_servers_inner_public_net_ipv6_dns_ptr_inner(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAI_servers_get_200_response_servers_inner_public_net_ipv6_dns_ptr_inner::OAI_servers_get_200_response_servers_inner_public_net_ipv6_dns_ptr_inner() {
    this->initializeModel();
}

OAI_servers_get_200_response_servers_inner_public_net_ipv6_dns_ptr_inner::~OAI_servers_get_200_response_servers_inner_public_net_ipv6_dns_ptr_inner() {}

void OAI_servers_get_200_response_servers_inner_public_net_ipv6_dns_ptr_inner::initializeModel() {
...
void OAI_servers_get_200_response_servers_inner_public_net_ipv6_dns_ptr_inner::fromJson(QString jsonString) {
...
void OAI_servers_get_200_response_servers_inner_public_net_ipv6_dns_ptr_inner::fromJsonObject(QJsonObject json) {
...
QString OAI_servers_get_200_response_servers_inner_public_net_ipv6_dns_ptr_inner::asJson() const {
...
QJsonObject OAI_servers_get_200_response_servers_inner_public_net_ipv6_dns_ptr_inner::asJsonObject() const {
    QJsonObject obj;
    if (m_dns_ptr_isSet) {
...
QString OAI_servers_get_200_response_servers_inner_public_net_ipv6_dns_ptr_inner::getDnsPtr() const {
    return m_dns_ptr;
}
void OAI_servers_get_200_response_servers_inner_public_net_ipv6_dns_ptr_inner::setDnsPtr(const QString &dns_ptr) {
    m_dns_ptr = dns_ptr;
    m_dns_ptr_isSet = true;
}

bool OAI_servers_get_200_response_servers_inner_public_net_ipv6_dns_ptr_inner::is_dns_ptr_Set() const{
    return m_dns_ptr_isSet;
}

bool OAI_servers_get_200_response_servers_inner_public_net_ipv6_dns_ptr_inner::is_dns_ptr_Valid() const{
    return m_dns_ptr_isValid;
}

QString OAI_servers_get_200_response_servers_inner_public_net_ipv6_dns_ptr_inner::getIp() const {
    return m_ip;
}
void OAI_servers_get_200_response_servers_inner_public_net_ipv6_dns_ptr_inner::setIp(const QString &ip) {
    m_ip = ip;
    m_ip_isSet = true;
}

bool OAI_servers_get_200_response_servers_inner_public_net_ipv6_dns_ptr_inner::is_ip_Set() const{
    return m_ip_isSet;
}

bool OAI_servers_get_200_response_servers_inner_public_net_ipv6_dns_ptr_inner::is_ip_Valid() const{
    return m_ip_isValid;
}

bool OAI_servers_get_200_response_servers_inner_public_net_ipv6_dns_ptr_inner::isSet() const {
...
bool OAI_servers_get_200_response_servers_inner_public_net_ipv6_dns_ptr_inner::isValid() const {
