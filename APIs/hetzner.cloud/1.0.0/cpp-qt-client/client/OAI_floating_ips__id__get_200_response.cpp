...
#include "OAI_floating_ips__id__get_200_response.h"
...
OAI_floating_ips__id__get_200_response::OAI_floating_ips__id__get_200_response(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAI_floating_ips__id__get_200_response::OAI_floating_ips__id__get_200_response() {
    this->initializeModel();
}

OAI_floating_ips__id__get_200_response::~OAI_floating_ips__id__get_200_response() {}

void OAI_floating_ips__id__get_200_response::initializeModel() {

    m_floating_ip_isSet = false;
    m_floating_ip_isValid = false;
}

void OAI_floating_ips__id__get_200_response::fromJson(QString jsonString) {
...
void OAI_floating_ips__id__get_200_response::fromJsonObject(QJsonObject json) {
...
QString OAI_floating_ips__id__get_200_response::asJson() const {
...
QJsonObject OAI_floating_ips__id__get_200_response::asJsonObject() const {
    QJsonObject obj;
...
OAI_floating_ips_get_200_response_floating_ips_inner OAI_floating_ips__id__get_200_response::getFloatingIp() const {
    return m_floating_ip;
}
void OAI_floating_ips__id__get_200_response::setFloatingIp(const OAI_floating_ips_get_200_response_floating_ips_inner &floating_ip) {
    m_floating_ip = floating_ip;
    m_floating_ip_isSet = true;
}

bool OAI_floating_ips__id__get_200_response::is_floating_ip_Set() const{
    return m_floating_ip_isSet;
}

bool OAI_floating_ips__id__get_200_response::is_floating_ip_Valid() const{
    return m_floating_ip_isValid;
}

bool OAI_floating_ips__id__get_200_response::isSet() const {
...
bool OAI_floating_ips__id__get_200_response::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_floating_ip_isValid && true;
}
