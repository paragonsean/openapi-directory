...
#include "OAI_servers_get_200_response_servers_inner_public_net.h"
...
OAI_servers_get_200_response_servers_inner_public_net::OAI_servers_get_200_response_servers_inner_public_net(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAI_servers_get_200_response_servers_inner_public_net::OAI_servers_get_200_response_servers_inner_public_net() {
    this->initializeModel();
}

OAI_servers_get_200_response_servers_inner_public_net::~OAI_servers_get_200_response_servers_inner_public_net() {}

void OAI_servers_get_200_response_servers_inner_public_net::initializeModel() {
...
void OAI_servers_get_200_response_servers_inner_public_net::fromJson(QString jsonString) {
...
void OAI_servers_get_200_response_servers_inner_public_net::fromJsonObject(QJsonObject json) {
...
QString OAI_servers_get_200_response_servers_inner_public_net::asJson() const {
...
QJsonObject OAI_servers_get_200_response_servers_inner_public_net::asJsonObject() const {
    QJsonObject obj;
...
QList<OAIServerPublicNetFirewall> OAI_servers_get_200_response_servers_inner_public_net::getFirewalls() const {
    return m_firewalls;
}
void OAI_servers_get_200_response_servers_inner_public_net::setFirewalls(const QList<OAIServerPublicNetFirewall> &firewalls) {
    m_firewalls = firewalls;
    m_firewalls_isSet = true;
}

bool OAI_servers_get_200_response_servers_inner_public_net::is_firewalls_Set() const{
    return m_firewalls_isSet;
}

bool OAI_servers_get_200_response_servers_inner_public_net::is_firewalls_Valid() const{
    return m_firewalls_isValid;
}

QList<qint32> OAI_servers_get_200_response_servers_inner_public_net::getFloatingIps() const {
    return m_floating_ips;
}
void OAI_servers_get_200_response_servers_inner_public_net::setFloatingIps(const QList<qint32> &floating_ips) {
    m_floating_ips = floating_ips;
    m_floating_ips_isSet = true;
}

bool OAI_servers_get_200_response_servers_inner_public_net::is_floating_ips_Set() const{
    return m_floating_ips_isSet;
}

bool OAI_servers_get_200_response_servers_inner_public_net::is_floating_ips_Valid() const{
    return m_floating_ips_isValid;
}

OAI_servers_get_200_response_servers_inner_public_net_ipv4 OAI_servers_get_200_response_servers_inner_public_net::getIpv4() const {
    return m_ipv4;
}
void OAI_servers_get_200_response_servers_inner_public_net::setIpv4(const OAI_servers_get_200_response_servers_inner_public_net_ipv4 &ipv4) {
    m_ipv4 = ipv4;
    m_ipv4_isSet = true;
}

bool OAI_servers_get_200_response_servers_inner_public_net::is_ipv4_Set() const{
    return m_ipv4_isSet;
}

bool OAI_servers_get_200_response_servers_inner_public_net::is_ipv4_Valid() const{
    return m_ipv4_isValid;
}

OAI_servers_get_200_response_servers_inner_public_net_ipv6 OAI_servers_get_200_response_servers_inner_public_net::getIpv6() const {
    return m_ipv6;
}
void OAI_servers_get_200_response_servers_inner_public_net::setIpv6(const OAI_servers_get_200_response_servers_inner_public_net_ipv6 &ipv6) {
    m_ipv6 = ipv6;
    m_ipv6_isSet = true;
}

bool OAI_servers_get_200_response_servers_inner_public_net::is_ipv6_Set() const{
    return m_ipv6_isSet;
}

bool OAI_servers_get_200_response_servers_inner_public_net::is_ipv6_Valid() const{
    return m_ipv6_isValid;
}

bool OAI_servers_get_200_response_servers_inner_public_net::isSet() const {
...
bool OAI_servers_get_200_response_servers_inner_public_net::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_floating_ips_isValid && m_ipv4_isValid && m_ipv6_isValid && true;
}
