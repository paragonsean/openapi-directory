...
/*
 * OAICreateCertificateRequest.h
 *
 * 
 */

#ifndef OAICreateCertificateRequest_H
#define OAICreateCertificateRequest_H
...
class OAICreateCertificateRequest : public OAIObject {
public:
    OAICreateCertificateRequest();
    OAICreateCertificateRequest(QString json);
    ~OAICreateCertificateRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateCertificateRequest)

#endif // OAICreateCertificateRequest_H
