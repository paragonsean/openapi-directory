...
QString OAIPlacementGroup::getCreated() const {
    return m_created;
}
void OAIPlacementGroup::setCreated(const QString &created) {
    m_created = created;
    m_created_isSet = true;
}

bool OAIPlacementGroup::is_created_Set() const{
    return m_created_isSet;
}

bool OAIPlacementGroup::is_created_Valid() const{
    return m_created_isValid;
}

qint32 OAIPlacementGroup::getId() const {
    return m_id;
}
void OAIPlacementGroup::setId(const qint32 &id) {
    m_id = id;
    m_id_isSet = true;
}
...
QMap<QString, QString> OAIPlacementGroup::getLabels() const {
    return m_labels;
}
void OAIPlacementGroup::setLabels(const QMap<QString, QString> &labels) {
    m_labels = labels;
    m_labels_isSet = true;
}

bool OAIPlacementGroup::is_labels_Set() const{
    return m_labels_isSet;
}

bool OAIPlacementGroup::is_labels_Valid() const{
...
QList<qint32> OAIPlacementGroup::getServers() const {
    return m_servers;
}
void OAIPlacementGroup::setServers(const QList<qint32> &servers) {
    m_servers = servers;
    m_servers_isSet = true;
}

bool OAIPlacementGroup::is_servers_Set() const{
    return m_servers_isSet;
}

bool OAIPlacementGroup::is_servers_Valid() const{
    return m_servers_isValid;
}

QString OAIPlacementGroup::getType() const {
    return m_type;
}
void OAIPlacementGroup::setType(const QString &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAIPlacementGroup::is_type_Set() const{
    return m_type_isSet;
}

bool OAIPlacementGroup::is_type_Valid() const{
