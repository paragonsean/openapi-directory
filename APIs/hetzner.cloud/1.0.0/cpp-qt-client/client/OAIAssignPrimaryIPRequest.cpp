...
OAIAssignPrimaryIPRequest::OAIAssignPrimaryIPRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAssignPrimaryIPRequest::OAIAssignPrimaryIPRequest() {
    this->initializeModel();
}

OAIAssignPrimaryIPRequest::~OAIAssignPrimaryIPRequest() {}

void OAIAssignPrimaryIPRequest::initializeModel() {
...
void OAIAssignPrimaryIPRequest::fromJson(QString jsonString) {
...
void OAIAssignPrimaryIPRequest::fromJsonObject(QJsonObject json) {
...
QString OAIAssignPrimaryIPRequest::asJson() const {
...
QJsonObject OAIAssignPrimaryIPRequest::asJsonObject() const {
    QJsonObject obj;
...
qint32 OAIAssignPrimaryIPRequest::getAssigneeId() const {
    return m_assignee_id;
}
void OAIAssignPrimaryIPRequest::setAssigneeId(const qint32 &assignee_id) {
    m_assignee_id = assignee_id;
    m_assignee_id_isSet = true;
}

bool OAIAssignPrimaryIPRequest::is_assignee_id_Set() const{
    return m_assignee_id_isSet;
}

bool OAIAssignPrimaryIPRequest::is_assignee_id_Valid() const{
    return m_assignee_id_isValid;
}

QString OAIAssignPrimaryIPRequest::getAssigneeType() const {
    return m_assignee_type;
}
void OAIAssignPrimaryIPRequest::setAssigneeType(const QString &assignee_type) {
    m_assignee_type = assignee_type;
    m_assignee_type_isSet = true;
}

bool OAIAssignPrimaryIPRequest::is_assignee_type_Set() const{
    return m_assignee_type_isSet;
}

bool OAIAssignPrimaryIPRequest::is_assignee_type_Valid() const{
    return m_assignee_type_isValid;
}

bool OAIAssignPrimaryIPRequest::isSet() const {
...
bool OAIAssignPrimaryIPRequest::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_assignee_id_isValid && m_assignee_type_isValid && true;
}
