...
#include "OAI_datacenters_get_200_response.h"
...
OAI_datacenters_get_200_response::OAI_datacenters_get_200_response(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAI_datacenters_get_200_response::OAI_datacenters_get_200_response() {
    this->initializeModel();
}

OAI_datacenters_get_200_response::~OAI_datacenters_get_200_response() {}

void OAI_datacenters_get_200_response::initializeModel() {
...
void OAI_datacenters_get_200_response::fromJson(QString jsonString) {
...
void OAI_datacenters_get_200_response::fromJsonObject(QJsonObject json) {
...
QString OAI_datacenters_get_200_response::asJson() const {
...
QJsonObject OAI_datacenters_get_200_response::asJsonObject() const {
    QJsonObject obj;
...
QList<OAI_datacenters_get_200_response_datacenters_inner> OAI_datacenters_get_200_response::getDatacenters() const {
    return m_datacenters;
}
void OAI_datacenters_get_200_response::setDatacenters(const QList<OAI_datacenters_get_200_response_datacenters_inner> &datacenters) {
    m_datacenters = datacenters;
    m_datacenters_isSet = true;
}

bool OAI_datacenters_get_200_response::is_datacenters_Set() const{
    return m_datacenters_isSet;
}

bool OAI_datacenters_get_200_response::is_datacenters_Valid() const{
    return m_datacenters_isValid;
}

double OAI_datacenters_get_200_response::getRecommendation() const {
    return m_recommendation;
}
void OAI_datacenters_get_200_response::setRecommendation(const double &recommendation) {
    m_recommendation = recommendation;
    m_recommendation_isSet = true;
}

bool OAI_datacenters_get_200_response::is_recommendation_Set() const{
    return m_recommendation_isSet;
}

bool OAI_datacenters_get_200_response::is_recommendation_Valid() const{
    return m_recommendation_isValid;
}

bool OAI_datacenters_get_200_response::isSet() const {
...
bool OAI_datacenters_get_200_response::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_datacenters_isValid && m_recommendation_isValid && true;
}
