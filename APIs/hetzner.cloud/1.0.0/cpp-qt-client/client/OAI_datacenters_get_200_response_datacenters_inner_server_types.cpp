...
#include "OAI_datacenters_get_200_response_datacenters_inner_server_types.h"
...
OAI_datacenters_get_200_response_datacenters_inner_server_types::OAI_datacenters_get_200_response_datacenters_inner_server_types(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAI_datacenters_get_200_response_datacenters_inner_server_types::OAI_datacenters_get_200_response_datacenters_inner_server_types() {
    this->initializeModel();
}

OAI_datacenters_get_200_response_datacenters_inner_server_types::~OAI_datacenters_get_200_response_datacenters_inner_server_types() {}

void OAI_datacenters_get_200_response_datacenters_inner_server_types::initializeModel() {

    m_available_isSet = false;
    m_available_isValid = false;

    m_available_for_migration_isSet = false;
    m_available_for_migration_isValid = false;

    m_supported_isSet = false;
    m_supported_isValid = false;
}

void OAI_datacenters_get_200_response_datacenters_inner_server_types::fromJson(QString jsonString) {
...
void OAI_datacenters_get_200_response_datacenters_inner_server_types::fromJsonObject(QJsonObject json) {
    ...
    m_available_for_migration_isValid = ::OpenAPI::fromJsonValue(m_available_for_migration, json[QString("available_for_migration")]);
    m_available_for_migration_isSet = !json[QString("available_for_migration")].isNull() && m_available_for_migration_isValid;
...
QString OAI_datacenters_get_200_response_datacenters_inner_server_types::asJson() const {
...
QJsonObject OAI_datacenters_get_200_response_datacenters_inner_server_types::asJsonObject() const {
    QJsonObject obj;
    if (m_available.size() > 0) {
        obj.insert(QString("available"), ::OpenAPI::toJsonValue(m_available));
    }
    if (m_available_for_migration.size() > 0) {
        obj.insert(QString("available_for_migration"), ::OpenAPI::toJsonValue(m_available_for_migration));
    }
...
QList<double> OAI_datacenters_get_200_response_datacenters_inner_server_types::getAvailable() const {
    return m_available;
}
void OAI_datacenters_get_200_response_datacenters_inner_server_types::setAvailable(const QList<double> &available) {
    m_available = available;
    m_available_isSet = true;
}

bool OAI_datacenters_get_200_response_datacenters_inner_server_types::is_available_Set() const{
    return m_available_isSet;
}

bool OAI_datacenters_get_200_response_datacenters_inner_server_types::is_available_Valid() const{
    return m_available_isValid;
}

QList<double> OAI_datacenters_get_200_response_datacenters_inner_server_types::getAvailableForMigration() const {
    return m_available_for_migration;
}
void OAI_datacenters_get_200_response_datacenters_inner_server_types::setAvailableForMigration(const QList<double> &available_for_migration) {
    m_available_for_migration = available_for_migration;
    m_available_for_migration_isSet = true;
}

bool OAI_datacenters_get_200_response_datacenters_inner_server_types::is_available_for_migration_Set() const{
    return m_available_for_migration_isSet;
}

bool OAI_datacenters_get_200_response_datacenters_inner_server_types::is_available_for_migration_Valid() const{
    return m_available_for_migration_isValid;
}

QList<double> OAI_datacenters_get_200_response_datacenters_inner_server_types::getSupported() const {
    return m_supported;
}
void OAI_datacenters_get_200_response_datacenters_inner_server_types::setSupported(const QList<double> &supported) {
    m_supported = supported;
    m_supported_isSet = true;
}

bool OAI_datacenters_get_200_response_datacenters_inner_server_types::is_supported_Set() const{
    return m_supported_isSet;
}

bool OAI_datacenters_get_200_response_datacenters_inner_server_types::is_supported_Valid() const{
    return m_supported_isValid;
}

bool OAI_datacenters_get_200_response_datacenters_inner_server_types::isSet() const {
...
bool OAI_datacenters_get_200_response_datacenters_inner_server_types::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_available_isValid && m_available_for_migration_isValid && m_supported_isValid && true;
}
