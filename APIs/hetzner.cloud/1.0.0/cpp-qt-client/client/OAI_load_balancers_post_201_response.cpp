...
#include "OAI_load_balancers_post_201_response.h"
...
OAI_load_balancers_post_201_response::OAI_load_balancers_post_201_response(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAI_load_balancers_post_201_response::OAI_load_balancers_post_201_response() {
    this->initializeModel();
}

OAI_load_balancers_post_201_response::~OAI_load_balancers_post_201_response() {}

void OAI_load_balancers_post_201_response::initializeModel() {
...
void OAI_load_balancers_post_201_response::fromJson(QString jsonString) {
...
void OAI_load_balancers_post_201_response::fromJsonObject(QJsonObject json) {
...
QString OAI_load_balancers_post_201_response::asJson() const {
...
QJsonObject OAI_load_balancers_post_201_response::asJsonObject() const {
    QJsonObject obj;
    if (m_action.isSet()) {
...
OAIAction OAI_load_balancers_post_201_response::getAction() const {
    return m_action;
}
void OAI_load_balancers_post_201_response::setAction(const OAIAction &action) {
    m_action = action;
    m_action_isSet = true;
}

bool OAI_load_balancers_post_201_response::is_action_Set() const{
    return m_action_isSet;
}

bool OAI_load_balancers_post_201_response::is_action_Valid() const{
    return m_action_isValid;
}

OAI_load_balancers_get_200_response_load_balancers_inner OAI_load_balancers_post_201_response::getLoadBalancer() const {
    return m_load_balancer;
}
void OAI_load_balancers_post_201_response::setLoadBalancer(const OAI_load_balancers_get_200_response_load_balancers_inner &load_balancer) {
    m_load_balancer = load_balancer;
    m_load_balancer_isSet = true;
}

bool OAI_load_balancers_post_201_response::is_load_balancer_Set() const{
    return m_load_balancer_isSet;
}

bool OAI_load_balancers_post_201_response::is_load_balancer_Valid() const{
    return m_load_balancer_isValid;
}

bool OAI_load_balancers_post_201_response::isSet() const {
...
bool OAI_load_balancers_post_201_response::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_action_isValid && m_load_balancer_isValid && true;
}
