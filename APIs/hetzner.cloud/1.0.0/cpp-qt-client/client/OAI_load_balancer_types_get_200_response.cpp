...
OAI_load_balancer_types_get_200_response::OAI_load_balancer_types_get_200_response(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAI_load_balancer_types_get_200_response::OAI_load_balancer_types_get_200_response() {
    this->initializeModel();
}

OAI_load_balancer_types_get_200_response::~OAI_load_balancer_types_get_200_response() {}

void OAI_load_balancer_types_get_200_response::initializeModel() {

    m_load_balancer_types_isSet = false;
    m_load_balancer_types_isValid = false;
}

void OAI_load_balancer_types_get_200_response::fromJson(QString jsonString) {
...
void OAI_load_balancer_types_get_200_response::fromJsonObject(QJsonObject json) {
...
QString OAI_load_balancer_types_get_200_response::asJson() const {
...
QJsonObject OAI_load_balancer_types_get_200_response::asJsonObject() const {
    QJsonObject obj;
...
QList<OAI_load_balancer_types_get_200_response_load_balancer_types_inner> OAI_load_balancer_types_get_200_response::getLoadBalancerTypes() const {
    return m_load_balancer_types;
}
void OAI_load_balancer_types_get_200_response::setLoadBalancerTypes(const QList<OAI_load_balancer_types_get_200_response_load_balancer_types_inner> &load_balancer_types) {
    m_load_balancer_types = load_balancer_types;
    m_load_balancer_types_isSet = true;
}

bool OAI_load_balancer_types_get_200_response::is_load_balancer_types_Set() const{
    return m_load_balancer_types_isSet;
}

bool OAI_load_balancer_types_get_200_response::is_load_balancer_types_Valid() const{
    return m_load_balancer_types_isValid;
}

bool OAI_load_balancer_types_get_200_response::isSet() const {
...
bool OAI_load_balancer_types_get_200_response::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_load_balancer_types_isValid && true;
}
