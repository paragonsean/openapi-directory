...
#include "OAIPlacementGroupsResponse.h"
...
OAIPlacementGroupsResponse::OAIPlacementGroupsResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPlacementGroupsResponse::OAIPlacementGroupsResponse() {
    this->initializeModel();
}

OAIPlacementGroupsResponse::~OAIPlacementGroupsResponse() {}

void OAIPlacementGroupsResponse::initializeModel() {
...
void OAIPlacementGroupsResponse::fromJson(QString jsonString) {
...
void OAIPlacementGroupsResponse::fromJsonObject(QJsonObject json) {

    m_meta_isValid = ::OpenAPI::fromJsonValue(m_meta, json[QString("meta")]);
    m_meta_isSet = !json[QString("meta")].isNull() && m_meta_isValid;

    m_placement_groups_isValid = ::OpenAPI::fromJsonValue(m_placement_groups, json[QString("placement_groups")]);
    m_placement_groups_isSet = !json[QString("placement_groups")].isNull() && m_placement_groups_isValid;
}

QString OAIPlacementGroupsResponse::asJson() const {
...
QJsonObject OAIPlacementGroupsResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_meta.isSet()) {
        obj.insert(QString("meta"), ::OpenAPI::toJsonValue(m_meta));
    }
    if (m_placement_groups.size() > 0) {
        obj.insert(QString("placement_groups"), ::OpenAPI::toJsonValue(m_placement_groups));
    }
    return obj;
}

OAIActionsResponse_meta OAIPlacementGroupsResponse::getMeta() const {
    return m_meta;
}
void OAIPlacementGroupsResponse::setMeta(const OAIActionsResponse_meta &meta) {
    m_meta = meta;
    m_meta_isSet = true;
}

bool OAIPlacementGroupsResponse::is_meta_Set() const{
    return m_meta_isSet;
}

bool OAIPlacementGroupsResponse::is_meta_Valid() const{
    return m_meta_isValid;
}

QList<OAIPlacementGroup> OAIPlacementGroupsResponse::getPlacementGroups() const {
    return m_placement_groups;
}
void OAIPlacementGroupsResponse::setPlacementGroups(const QList<OAIPlacementGroup> &placement_groups) {
    m_placement_groups = placement_groups;
    m_placement_groups_isSet = true;
}

bool OAIPlacementGroupsResponse::is_placement_groups_Set() const{
    return m_placement_groups_isSet;
}

bool OAIPlacementGroupsResponse::is_placement_groups_Valid() const{
    return m_placement_groups_isValid;
}

bool OAIPlacementGroupsResponse::isSet() const {
...
bool OAIPlacementGroupsResponse::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_placement_groups_isValid && true;
}
