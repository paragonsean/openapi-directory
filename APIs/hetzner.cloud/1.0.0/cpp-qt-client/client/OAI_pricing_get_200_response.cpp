...
OAI_pricing_get_200_response::OAI_pricing_get_200_response(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAI_pricing_get_200_response::OAI_pricing_get_200_response() {
    this->initializeModel();
}

OAI_pricing_get_200_response::~OAI_pricing_get_200_response() {}

void OAI_pricing_get_200_response::initializeModel() {

    m_pricing_isSet = false;
    m_pricing_isValid = false;
}

void OAI_pricing_get_200_response::fromJson(QString jsonString) {
...
void OAI_pricing_get_200_response::fromJsonObject(QJsonObject json) {
...
QString OAI_pricing_get_200_response::asJson() const {
...
QJsonObject OAI_pricing_get_200_response::asJsonObject() const {
    QJsonObject obj;
    if (m_pricing.isSet()) {
...
OAI_pricing_get_200_response_pricing OAI_pricing_get_200_response::getPricing() const {
    return m_pricing;
}
void OAI_pricing_get_200_response::setPricing(const OAI_pricing_get_200_response_pricing &pricing) {
    m_pricing = pricing;
    m_pricing_isSet = true;
}

bool OAI_pricing_get_200_response::is_pricing_Set() const{
    return m_pricing_isSet;
}

bool OAI_pricing_get_200_response::is_pricing_Valid() const{
    return m_pricing_isValid;
}

bool OAI_pricing_get_200_response::isSet() const {
...
bool OAI_pricing_get_200_response::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_pricing_isValid && true;
}
