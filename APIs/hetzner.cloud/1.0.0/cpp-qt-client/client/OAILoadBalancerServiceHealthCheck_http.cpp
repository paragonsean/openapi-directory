...
#include "OAILoadBalancerServiceHealthCheck_http.h"
...
OAILoadBalancerServiceHealthCheck_http::OAILoadBalancerServiceHealthCheck_http(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAILoadBalancerServiceHealthCheck_http::OAILoadBalancerServiceHealthCheck_http() {
    this->initializeModel();
}

OAILoadBalancerServiceHealthCheck_http::~OAILoadBalancerServiceHealthCheck_http() {}

void OAILoadBalancerServiceHealthCheck_http::initializeModel() {
...
void OAILoadBalancerServiceHealthCheck_http::fromJson(QString jsonString) {
...
void OAILoadBalancerServiceHealthCheck_http::fromJsonObject(QJsonObject json) {
    ...
    m_status_codes_isValid = ::OpenAPI::fromJsonValue(m_status_codes, json[QString("status_codes")]);
    m_status_codes_isSet = !json[QString("status_codes")].isNull() && m_status_codes_isValid;

    m_tls_isValid = ::OpenAPI::fromJsonValue(m_tls, json[QString("tls")]);
    m_tls_isSet = !json[QString("tls")].isNull() && m_tls_isValid;
}

QString OAILoadBalancerServiceHealthCheck_http::asJson() const {
...
QJsonObject OAILoadBalancerServiceHealthCheck_http::asJsonObject() const {
    QJsonObject obj;
    if (m_domain_isSet) {
    ...
    if (m_status_codes.size() > 0) {
        obj.insert(QString("status_codes"), ::OpenAPI::toJsonValue(m_status_codes));
    }
    if (m_tls_isSet) {
...
QString OAILoadBalancerServiceHealthCheck_http::getDomain() const {
    return m_domain;
}
void OAILoadBalancerServiceHealthCheck_http::setDomain(const QString &domain) {
    m_domain = domain;
    m_domain_isSet = true;
}

bool OAILoadBalancerServiceHealthCheck_http::is_domain_Set() const{
    return m_domain_isSet;
}

bool OAILoadBalancerServiceHealthCheck_http::is_domain_Valid() const{
    return m_domain_isValid;
}

QString OAILoadBalancerServiceHealthCheck_http::getPath() const {
    return m_path;
}
void OAILoadBalancerServiceHealthCheck_http::setPath(const QString &path) {
    m_path = path;
    m_path_isSet = true;
}

bool OAILoadBalancerServiceHealthCheck_http::is_path_Set() const{
    return m_path_isSet;
}

bool OAILoadBalancerServiceHealthCheck_http::is_path_Valid() const{
    return m_path_isValid;
}

QString OAILoadBalancerServiceHealthCheck_http::getResponse() const {
    return m_response;
}
void OAILoadBalancerServiceHealthCheck_http::setResponse(const QString &response) {
    m_response = response;
    m_response_isSet = true;
}

bool OAILoadBalancerServiceHealthCheck_http::is_response_Set() const{
    return m_response_isSet;
}

bool OAILoadBalancerServiceHealthCheck_http::is_response_Valid() const{
    return m_response_isValid;
}

QList<QString> OAILoadBalancerServiceHealthCheck_http::getStatusCodes() const {
    return m_status_codes;
}
void OAILoadBalancerServiceHealthCheck_http::setStatusCodes(const QList<QString> &status_codes) {
    m_status_codes = status_codes;
    m_status_codes_isSet = true;
}

bool OAILoadBalancerServiceHealthCheck_http::is_status_codes_Set() const{
    return m_status_codes_isSet;
}

bool OAILoadBalancerServiceHealthCheck_http::is_status_codes_Valid() const{
    return m_status_codes_isValid;
}

bool OAILoadBalancerServiceHealthCheck_http::isTls() const {
    return m_tls;
}
void OAILoadBalancerServiceHealthCheck_http::setTls(const bool &tls) {
    m_tls = tls;
    m_tls_isSet = true;
}

bool OAILoadBalancerServiceHealthCheck_http::is_tls_Set() const{
    return m_tls_isSet;
}

bool OAILoadBalancerServiceHealthCheck_http::is_tls_Valid() const{
    return m_tls_isValid;
}

bool OAILoadBalancerServiceHealthCheck_http::isSet() const {
...
bool OAILoadBalancerServiceHealthCheck_http::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_domain_isValid && m_path_isValid && true;
}
