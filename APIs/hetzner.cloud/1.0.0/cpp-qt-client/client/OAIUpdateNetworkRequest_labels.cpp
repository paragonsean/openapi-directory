...
#include "OAIUpdateNetworkRequest_labels.h"
...
OAIUpdateNetworkRequest_labels::OAIUpdateNetworkRequest_labels(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateNetworkRequest_labels::OAIUpdateNetworkRequest_labels() {
    this->initializeModel();
}

OAIUpdateNetworkRequest_labels::~OAIUpdateNetworkRequest_labels() {}

void OAIUpdateNetworkRequest_labels::initializeModel() {

    m_labelkey_isSet = false;
    m_labelkey_isValid = false;
}

void OAIUpdateNetworkRequest_labels::fromJson(QString jsonString) {
...
void OAIUpdateNetworkRequest_labels::fromJsonObject(QJsonObject json) {

    m_labelkey_isValid = ::OpenAPI::fromJsonValue(m_labelkey, json[QString("labelkey")]);
    m_labelkey_isSet = !json[QString("labelkey")].isNull() && m_labelkey_isValid;
}

QString OAIUpdateNetworkRequest_labels::asJson() const {
...
QJsonObject OAIUpdateNetworkRequest_labels::asJsonObject() const {
    QJsonObject obj;
    if (m_labelkey_isSet) {
        obj.insert(QString("labelkey"), ::OpenAPI::toJsonValue(m_labelkey));
    }
    return obj;
}

QString OAIUpdateNetworkRequest_labels::getLabelkey() const {
    return m_labelkey;
}
void OAIUpdateNetworkRequest_labels::setLabelkey(const QString &labelkey) {
    m_labelkey = labelkey;
    m_labelkey_isSet = true;
}

bool OAIUpdateNetworkRequest_labels::is_labelkey_Set() const{
    return m_labelkey_isSet;
}

bool OAIUpdateNetworkRequest_labels::is_labelkey_Valid() const{
    return m_labelkey_isValid;
}

bool OAIUpdateNetworkRequest_labels::isSet() const {
...
bool OAIUpdateNetworkRequest_labels::isValid() const {
