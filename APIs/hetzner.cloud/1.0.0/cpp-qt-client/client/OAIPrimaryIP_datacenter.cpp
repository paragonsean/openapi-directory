...
#include "OAIPrimaryIP_datacenter.h"
...
OAIPrimaryIP_datacenter::OAIPrimaryIP_datacenter(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPrimaryIP_datacenter::OAIPrimaryIP_datacenter() {
    this->initializeModel();
}

OAIPrimaryIP_datacenter::~OAIPrimaryIP_datacenter() {}

void OAIPrimaryIP_datacenter::initializeModel() {
...
void OAIPrimaryIP_datacenter::fromJson(QString jsonString) {
...
void OAIPrimaryIP_datacenter::fromJsonObject(QJsonObject json) {
...
QString OAIPrimaryIP_datacenter::asJson() const {
...
QJsonObject OAIPrimaryIP_datacenter::asJsonObject() const {
    QJsonObject obj;
...
QString OAIPrimaryIP_datacenter::getDescription() const {
    return m_description;
}
void OAIPrimaryIP_datacenter::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAIPrimaryIP_datacenter::is_description_Set() const{
    return m_description_isSet;
}

bool OAIPrimaryIP_datacenter::is_description_Valid() const{
    return m_description_isValid;
}

qint32 OAIPrimaryIP_datacenter::getId() const {
    return m_id;
}
void OAIPrimaryIP_datacenter::setId(const qint32 &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIPrimaryIP_datacenter::is_id_Set() const{
    return m_id_isSet;
}

bool OAIPrimaryIP_datacenter::is_id_Valid() const{
    return m_id_isValid;
}

OAI_datacenters_get_200_response_datacenters_inner_location OAIPrimaryIP_datacenter::getLocation() const {
    return m_location;
}
void OAIPrimaryIP_datacenter::setLocation(const OAI_datacenters_get_200_response_datacenters_inner_location &location) {
    m_location = location;
    m_location_isSet = true;
}

bool OAIPrimaryIP_datacenter::is_location_Set() const{
    return m_location_isSet;
}

bool OAIPrimaryIP_datacenter::is_location_Valid() const{
    return m_location_isValid;
}

QString OAIPrimaryIP_datacenter::getName() const {
    return m_name;
}
void OAIPrimaryIP_datacenter::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIPrimaryIP_datacenter::is_name_Set() const{
    return m_name_isSet;
}

bool OAIPrimaryIP_datacenter::is_name_Valid() const{
    return m_name_isValid;
}

OAI_datacenters_get_200_response_datacenters_inner_server_types OAIPrimaryIP_datacenter::getServerTypes() const {
    return m_server_types;
}
void OAIPrimaryIP_datacenter::setServerTypes(const OAI_datacenters_get_200_response_datacenters_inner_server_types &server_types) {
    m_server_types = server_types;
    m_server_types_isSet = true;
}

bool OAIPrimaryIP_datacenter::is_server_types_Set() const{
    return m_server_types_isSet;
}

bool OAIPrimaryIP_datacenter::is_server_types_Valid() const{
    return m_server_types_isValid;
}

bool OAIPrimaryIP_datacenter::isSet() const {
...
bool OAIPrimaryIP_datacenter::isValid() const {
