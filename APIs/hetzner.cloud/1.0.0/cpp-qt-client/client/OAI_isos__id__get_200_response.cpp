...
OAI_isos__id__get_200_response::OAI_isos__id__get_200_response(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAI_isos__id__get_200_response::OAI_isos__id__get_200_response() {
    this->initializeModel();
}

OAI_isos__id__get_200_response::~OAI_isos__id__get_200_response() {}

void OAI_isos__id__get_200_response::initializeModel() {

    m_iso_isSet = false;
    m_iso_isValid = false;
}

void OAI_isos__id__get_200_response::fromJson(QString jsonString) {
...
void OAI_isos__id__get_200_response::fromJsonObject(QJsonObject json) {

    m_iso_isValid = ::OpenAPI::fromJsonValue(m_iso, json[QString("iso")]);
    m_iso_isSet = !json[QString("iso")].isNull() && m_iso_isValid;
}

QString OAI_isos__id__get_200_response::asJson() const {
...
QJsonObject OAI_isos__id__get_200_response::asJsonObject() const {
    QJsonObject obj;
    if (m_iso.isSet()) {
...
OAI_isos_get_200_response_isos_inner OAI_isos__id__get_200_response::getIso() const {
    return m_iso;
}
void OAI_isos__id__get_200_response::setIso(const OAI_isos_get_200_response_isos_inner &iso) {
    m_iso = iso;
    m_iso_isSet = true;
}

bool OAI_isos__id__get_200_response::is_iso_Set() const{
    return m_iso_isSet;
}

bool OAI_isos__id__get_200_response::is_iso_Valid() const{
    return m_iso_isValid;
}

bool OAI_isos__id__get_200_response::isSet() const {
...
bool OAI_isos__id__get_200_response::isValid() const {
