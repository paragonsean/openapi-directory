...
#include "OAI_images_get_200_response_images_inner_created_from.h"
...
OAI_images_get_200_response_images_inner_created_from::OAI_images_get_200_response_images_inner_created_from(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAI_images_get_200_response_images_inner_created_from::OAI_images_get_200_response_images_inner_created_from() {
    this->initializeModel();
}

OAI_images_get_200_response_images_inner_created_from::~OAI_images_get_200_response_images_inner_created_from() {}

void OAI_images_get_200_response_images_inner_created_from::initializeModel() {
...
void OAI_images_get_200_response_images_inner_created_from::fromJson(QString jsonString) {
...
void OAI_images_get_200_response_images_inner_created_from::fromJsonObject(QJsonObject json) {
...
QString OAI_images_get_200_response_images_inner_created_from::asJson() const {
...
QJsonObject OAI_images_get_200_response_images_inner_created_from::asJsonObject() const {
    QJsonObject obj;
    if (m_id_isSet) {
...
qint32 OAI_images_get_200_response_images_inner_created_from::getId() const {
    return m_id;
}
void OAI_images_get_200_response_images_inner_created_from::setId(const qint32 &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAI_images_get_200_response_images_inner_created_from::is_id_Set() const{
    return m_id_isSet;
}

bool OAI_images_get_200_response_images_inner_created_from::is_id_Valid() const{
    return m_id_isValid;
}

QString OAI_images_get_200_response_images_inner_created_from::getName() const {
    return m_name;
}
void OAI_images_get_200_response_images_inner_created_from::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAI_images_get_200_response_images_inner_created_from::is_name_Set() const{
    return m_name_isSet;
}

bool OAI_images_get_200_response_images_inner_created_from::is_name_Valid() const{
    return m_name_isValid;
}

bool OAI_images_get_200_response_images_inner_created_from::isSet() const {
...
bool OAI_images_get_200_response_images_inner_created_from::isValid() const {
