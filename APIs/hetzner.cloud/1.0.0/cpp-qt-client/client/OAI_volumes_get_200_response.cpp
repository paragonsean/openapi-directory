...
OAI_volumes_get_200_response::OAI_volumes_get_200_response(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAI_volumes_get_200_response::OAI_volumes_get_200_response() {
    this->initializeModel();
}

OAI_volumes_get_200_response::~OAI_volumes_get_200_response() {}

void OAI_volumes_get_200_response::initializeModel() {
...
void OAI_volumes_get_200_response::fromJson(QString jsonString) {
...
void OAI_volumes_get_200_response::fromJsonObject(QJsonObject json) {
...
QString OAI_volumes_get_200_response::asJson() const {
...
QJsonObject OAI_volumes_get_200_response::asJsonObject() const {
    QJsonObject obj;
    if (m_meta.isSet()) {
...
OAIActionsResponse_meta OAI_volumes_get_200_response::getMeta() const {
    return m_meta;
}
void OAI_volumes_get_200_response::setMeta(const OAIActionsResponse_meta &meta) {
    m_meta = meta;
    m_meta_isSet = true;
}

bool OAI_volumes_get_200_response::is_meta_Set() const{
    return m_meta_isSet;
}

bool OAI_volumes_get_200_response::is_meta_Valid() const{
    return m_meta_isValid;
}

QList<OAI_volumes_get_200_response_volumes_inner> OAI_volumes_get_200_response::getVolumes() const {
    return m_volumes;
}
void OAI_volumes_get_200_response::setVolumes(const QList<OAI_volumes_get_200_response_volumes_inner> &volumes) {
    m_volumes = volumes;
    m_volumes_isSet = true;
}

bool OAI_volumes_get_200_response::is_volumes_Set() const{
    return m_volumes_isSet;
}

bool OAI_volumes_get_200_response::is_volumes_Valid() const{
    return m_volumes_isValid;
}

bool OAI_volumes_get_200_response::isSet() const {
...
bool OAI_volumes_get_200_response::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_volumes_isValid && true;
}
