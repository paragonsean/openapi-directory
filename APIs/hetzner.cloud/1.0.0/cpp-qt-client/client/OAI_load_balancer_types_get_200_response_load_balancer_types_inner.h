...
/*
 * OAI_load_balancer_types_get_200_response_load_balancer_types_inner.h
 *
 * 
 */

#ifndef OAI_load_balancer_types_get_200_response_load_balancer_types_inner_H
#define OAI_load_balancer_types_get_200_response_load_balancer_types_inner_H

#include <QJsonObject>

#include "OAI_load_balancer_types_get_200_response_load_balancer_types_inner_prices_inner.h"
#include <QList>
#include <QString>
...
namespace OpenAPI {
class OAI_load_balancer_types_get_200_response_load_balancer_types_inner_prices_inner;

class OAI_load_balancer_types_get_200_response_load_balancer_types_inner : public OAIObject {
public:
    OAI_load_balancer_types_get_200_response_load_balancer_types_inner();
    OAI_load_balancer_types_get_200_response_load_balancer_types_inner(QString json);
    ~OAI_load_balancer_types_get_200_response_load_balancer_types_inner() override;
    ...
    double getMaxAssignedCertificates() const;
    void setMaxAssignedCertificates(const double &max_assigned_certificates);
    bool is_max_assigned_certificates_Set() const;
    bool is_max_assigned_certificates_Valid() const;

    double getMaxConnections() const;
    void setMaxConnections(const double &max_connections);
    bool is_max_connections_Set() const;
    bool is_max_connections_Valid() const;

    double getMaxServices() const;
    void setMaxServices(const double &max_services);
    bool is_max_services_Set() const;
    bool is_max_services_Valid() const;

    double getMaxTargets() const;
    void setMaxTargets(const double &max_targets);
    bool is_max_targets_Set() const;
    bool is_max_targets_Valid() const;
    ...
    QList<OAI_load_balancer_types_get_200_response_load_balancer_types_inner_prices_inner> getPrices() const;
    void setPrices(const QList<OAI_load_balancer_types_get_200_response_load_balancer_types_inner_prices_inner> &prices);
...
private:
    ...
    double m_max_assigned_certificates;
    bool m_max_assigned_certificates_isSet;
    bool m_max_assigned_certificates_isValid;

    double m_max_connections;
    bool m_max_connections_isSet;
    bool m_max_connections_isValid;

    double m_max_services;
    bool m_max_services_isSet;
    bool m_max_services_isValid;

    double m_max_targets;
    bool m_max_targets_isSet;
    bool m_max_targets_isValid;

    QString m_name;
    bool m_name_isSet;
    bool m_name_isValid;

    QList<OAI_load_balancer_types_get_200_response_load_balancer_types_inner_prices_inner> m_prices;
    bool m_prices_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAI_load_balancer_types_get_200_response_load_balancer_types_inner)

#endif // OAI_load_balancer_types_get_200_response_load_balancer_types_inner_H
