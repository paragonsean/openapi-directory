...
OAILoadBalancerService::OAILoadBalancerService(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAILoadBalancerService::OAILoadBalancerService() {
    this->initializeModel();
}

OAILoadBalancerService::~OAILoadBalancerService() {}

void OAILoadBalancerService::initializeModel() {
    ...
    m_proxyprotocol_isSet = false;
    m_proxyprotocol_isValid = false;
}

void OAILoadBalancerService::fromJson(QString jsonString) {
...
void OAILoadBalancerService::fromJsonObject(QJsonObject json) {
    ...
    m_health_check_isValid = ::OpenAPI::fromJsonValue(m_health_check, json[QString("health_check")]);
    m_health_check_isSet = !json[QString("health_check")].isNull() && m_health_check_isValid;

    m_http_isValid = ::OpenAPI::fromJsonValue(m_http, json[QString("http")]);
    m_http_isSet = !json[QString("http")].isNull() && m_http_isValid;

    m_listen_port_isValid = ::OpenAPI::fromJsonValue(m_listen_port, json[QString("listen_port")]);
    m_listen_port_isSet = !json[QString("listen_port")].isNull() && m_listen_port_isValid;

    m_protocol_isValid = ::OpenAPI::fromJsonValue(m_protocol, json[QString("protocol")]);
    m_protocol_isSet = !json[QString("protocol")].isNull() && m_protocol_isValid;

    m_proxyprotocol_isValid = ::OpenAPI::fromJsonValue(m_proxyprotocol, json[QString("proxyprotocol")]);
    m_proxyprotocol_isSet = !json[QString("proxyprotocol")].isNull() && m_proxyprotocol_isValid;
}

QString OAILoadBalancerService::asJson() const {
...
QJsonObject OAILoadBalancerService::asJsonObject() const {
    QJsonObject obj;
    ...
    if (m_health_check.isSet()) {
        obj.insert(QString("health_check"), ::OpenAPI::toJsonValue(m_health_check));
    }
    if (m_http.isSet()) {
        obj.insert(QString("http"), ::OpenAPI::toJsonValue(m_http));
    }
    if (m_listen_port_isSet) {
        obj.insert(QString("listen_port"), ::OpenAPI::toJsonValue(m_listen_port));
    }
    if (m_protocol_isSet) {
        obj.insert(QString("protocol"), ::OpenAPI::toJsonValue(m_protocol));
    }
    if (m_proxyprotocol_isSet) {
        obj.insert(QString("proxyprotocol"), ::OpenAPI::toJsonValue(m_proxyprotocol));
    }
    return obj;
}

qint32 OAILoadBalancerService::getDestinationPort() const {
    return m_destination_port;
}
void OAILoadBalancerService::setDestinationPort(const qint32 &destination_port) {
    m_destination_port = destination_port;
    m_destination_port_isSet = true;
}

bool OAILoadBalancerService::is_destination_port_Set() const{
    return m_destination_port_isSet;
}

bool OAILoadBalancerService::is_destination_port_Valid() const{
    return m_destination_port_isValid;
}

OAILoadBalancerServiceHealthCheck OAILoadBalancerService::getHealthCheck() const {
    return m_health_check;
}
void OAILoadBalancerService::setHealthCheck(const OAILoadBalancerServiceHealthCheck &health_check) {
    m_health_check = health_check;
    m_health_check_isSet = true;
}

bool OAILoadBalancerService::is_health_check_Set() const{
    return m_health_check_isSet;
}

bool OAILoadBalancerService::is_health_check_Valid() const{
    return m_health_check_isValid;
}

OAILoadBalancerServiceHTTP OAILoadBalancerService::getHttp() const {
    return m_http;
}
void OAILoadBalancerService::setHttp(const OAILoadBalancerServiceHTTP &http) {
    m_http = http;
    m_http_isSet = true;
}

bool OAILoadBalancerService::is_http_Set() const{
    return m_http_isSet;
}

bool OAILoadBalancerService::is_http_Valid() const{
    return m_http_isValid;
}

qint32 OAILoadBalancerService::getListenPort() const {
    return m_listen_port;
}
void OAILoadBalancerService::setListenPort(const qint32 &listen_port) {
    m_listen_port = listen_port;
    m_listen_port_isSet = true;
}

bool OAILoadBalancerService::is_listen_port_Set() const{
    return m_listen_port_isSet;
}

bool OAILoadBalancerService::is_listen_port_Valid() const{
    return m_listen_port_isValid;
}

QString OAILoadBalancerService::getProtocol() const {
    return m_protocol;
}
void OAILoadBalancerService::setProtocol(const QString &protocol) {
    m_protocol = protocol;
    m_protocol_isSet = true;
}

bool OAILoadBalancerService::is_protocol_Set() const{
    return m_protocol_isSet;
}

bool OAILoadBalancerService::is_protocol_Valid() const{
    return m_protocol_isValid;
}

bool OAILoadBalancerService::isProxyprotocol() const {
    return m_proxyprotocol;
}
void OAILoadBalancerService::setProxyprotocol(const bool &proxyprotocol) {
    m_proxyprotocol = proxyprotocol;
    m_proxyprotocol_isSet = true;
}

bool OAILoadBalancerService::is_proxyprotocol_Set() const{
    return m_proxyprotocol_isSet;
}

bool OAILoadBalancerService::is_proxyprotocol_Valid() const{
    return m_proxyprotocol_isValid;
}

bool OAILoadBalancerService::isSet() const {
...
bool OAILoadBalancerService::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_destination_port_isValid && m_health_check_isValid && m_listen_port_isValid && m_protocol_isValid && m_proxyprotocol_isValid && true;
}
