...
OAIAction OAIActionResponse::getAction() const {
    return m_action;
}
void OAIActionResponse::setAction(const OAIAction &action) {
    m_action = action;
    m_action_isSet = true;
}

bool OAIActionResponse::is_action_Set() const{
    return m_action_isSet;
}

bool OAIActionResponse::is_action_Valid() const{
