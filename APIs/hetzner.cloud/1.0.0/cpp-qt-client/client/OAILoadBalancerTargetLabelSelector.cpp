...
#include "OAILoadBalancerTargetLabelSelector.h"
...
OAILoadBalancerTargetLabelSelector::OAILoadBalancerTargetLabelSelector(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAILoadBalancerTargetLabelSelector::OAILoadBalancerTargetLabelSelector() {
    this->initializeModel();
}

OAILoadBalancerTargetLabelSelector::~OAILoadBalancerTargetLabelSelector() {}

void OAILoadBalancerTargetLabelSelector::initializeModel() {

    m_selector_isSet = false;
    m_selector_isValid = false;
}

void OAILoadBalancerTargetLabelSelector::fromJson(QString jsonString) {
...
void OAILoadBalancerTargetLabelSelector::fromJsonObject(QJsonObject json) {
...
QString OAILoadBalancerTargetLabelSelector::asJson() const {
...
QJsonObject OAILoadBalancerTargetLabelSelector::asJsonObject() const {
    QJsonObject obj;
    if (m_selector_isSet) {
...
QString OAILoadBalancerTargetLabelSelector::getSelector() const {
    return m_selector;
}
void OAILoadBalancerTargetLabelSelector::setSelector(const QString &selector) {
    m_selector = selector;
    m_selector_isSet = true;
}

bool OAILoadBalancerTargetLabelSelector::is_selector_Set() const{
    return m_selector_isSet;
}

bool OAILoadBalancerTargetLabelSelector::is_selector_Valid() const{
    return m_selector_isValid;
}

bool OAILoadBalancerTargetLabelSelector::isSet() const {
...
bool OAILoadBalancerTargetLabelSelector::isValid() const {
