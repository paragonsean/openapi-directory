...
OAIAddToPlacementGroupRequest::OAIAddToPlacementGroupRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAddToPlacementGroupRequest::OAIAddToPlacementGroupRequest() {
    this->initializeModel();
}

OAIAddToPlacementGroupRequest::~OAIAddToPlacementGroupRequest() {}

void OAIAddToPlacementGroupRequest::initializeModel() {

    m_placement_group_isSet = false;
    m_placement_group_isValid = false;
}

void OAIAddToPlacementGroupRequest::fromJson(QString jsonString) {
...
void OAIAddToPlacementGroupRequest::fromJsonObject(QJsonObject json) {
...
QString OAIAddToPlacementGroupRequest::asJson() const {
...
QJsonObject OAIAddToPlacementGroupRequest::asJsonObject() const {
    QJsonObject obj;
...
qint32 OAIAddToPlacementGroupRequest::getPlacementGroup() const {
    return m_placement_group;
}
void OAIAddToPlacementGroupRequest::setPlacementGroup(const qint32 &placement_group) {
    m_placement_group = placement_group;
    m_placement_group_isSet = true;
}

bool OAIAddToPlacementGroupRequest::is_placement_group_Set() const{
    return m_placement_group_isSet;
}

bool OAIAddToPlacementGroupRequest::is_placement_group_Valid() const{
    return m_placement_group_isValid;
}

bool OAIAddToPlacementGroupRequest::isSet() const {
...
bool OAIAddToPlacementGroupRequest::isValid() const {
