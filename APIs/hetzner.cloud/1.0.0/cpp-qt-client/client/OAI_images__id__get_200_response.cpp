...
OAI_images__id__get_200_response::OAI_images__id__get_200_response(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAI_images__id__get_200_response::OAI_images__id__get_200_response() {
    this->initializeModel();
}

OAI_images__id__get_200_response::~OAI_images__id__get_200_response() {}

void OAI_images__id__get_200_response::initializeModel() {

    m_image_isSet = false;
    m_image_isValid = false;
}

void OAI_images__id__get_200_response::fromJson(QString jsonString) {
...
void OAI_images__id__get_200_response::fromJsonObject(QJsonObject json) {

    m_image_isValid = ::OpenAPI::fromJsonValue(m_image, json[QString("image")]);
    m_image_isSet = !json[QString("image")].isNull() && m_image_isValid;
}

QString OAI_images__id__get_200_response::asJson() const {
...
QJsonObject OAI_images__id__get_200_response::asJsonObject() const {
    QJsonObject obj;
    if (m_image.isSet()) {
...
OAI_images_get_200_response_images_inner OAI_images__id__get_200_response::getImage() const {
    return m_image;
}
void OAI_images__id__get_200_response::setImage(const OAI_images_get_200_response_images_inner &image) {
    m_image = image;
    m_image_isSet = true;
}

bool OAI_images__id__get_200_response::is_image_Set() const{
    return m_image_isSet;
}

bool OAI_images__id__get_200_response::is_image_Valid() const{
    return m_image_isValid;
}

bool OAI_images__id__get_200_response::isSet() const {
...
bool OAI_images__id__get_200_response::isValid() const {
