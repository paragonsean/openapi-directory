...
#include "OAI_ssh_keys_get_200_response.h"
...
OAI_ssh_keys_get_200_response::OAI_ssh_keys_get_200_response(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAI_ssh_keys_get_200_response::OAI_ssh_keys_get_200_response() {
    this->initializeModel();
}

OAI_ssh_keys_get_200_response::~OAI_ssh_keys_get_200_response() {}

void OAI_ssh_keys_get_200_response::initializeModel() {
...
void OAI_ssh_keys_get_200_response::fromJson(QString jsonString) {
...
void OAI_ssh_keys_get_200_response::fromJsonObject(QJsonObject json) {
...
QString OAI_ssh_keys_get_200_response::asJson() const {
...
QJsonObject OAI_ssh_keys_get_200_response::asJsonObject() const {
    QJsonObject obj;
    if (m_meta.isSet()) {
...
OAIActionsResponse_meta OAI_ssh_keys_get_200_response::getMeta() const {
    return m_meta;
}
void OAI_ssh_keys_get_200_response::setMeta(const OAIActionsResponse_meta &meta) {
    m_meta = meta;
    m_meta_isSet = true;
}

bool OAI_ssh_keys_get_200_response::is_meta_Set() const{
    return m_meta_isSet;
}

bool OAI_ssh_keys_get_200_response::is_meta_Valid() const{
    return m_meta_isValid;
}

QList<OAI_ssh_keys_get_200_response_ssh_keys_inner> OAI_ssh_keys_get_200_response::getSshKeys() const {
    return m_ssh_keys;
}
void OAI_ssh_keys_get_200_response::setSshKeys(const QList<OAI_ssh_keys_get_200_response_ssh_keys_inner> &ssh_keys) {
    m_ssh_keys = ssh_keys;
    m_ssh_keys_isSet = true;
}

bool OAI_ssh_keys_get_200_response::is_ssh_keys_Set() const{
    return m_ssh_keys_isSet;
}

bool OAI_ssh_keys_get_200_response::is_ssh_keys_Valid() const{
    return m_ssh_keys_isValid;
}

bool OAI_ssh_keys_get_200_response::isSet() const {
...
bool OAI_ssh_keys_get_200_response::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_ssh_keys_isValid && true;
}
