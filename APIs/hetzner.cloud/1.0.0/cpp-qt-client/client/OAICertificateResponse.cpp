...
OAICertificate OAICertificateResponse::getCertificate() const {
    return m_certificate;
}
void OAICertificateResponse::setCertificate(const OAICertificate &certificate) {
    m_certificate = certificate;
    m_certificate_isSet = true;
}

bool OAICertificateResponse::is_certificate_Set() const{
    return m_certificate_isSet;
}

bool OAICertificateResponse::is_certificate_Valid() const{
