...
#include "OAIUpdateFirewallRequest.h"
...
OAIUpdateFirewallRequest::OAIUpdateFirewallRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateFirewallRequest::OAIUpdateFirewallRequest() {
    this->initializeModel();
}

OAIUpdateFirewallRequest::~OAIUpdateFirewallRequest() {}

void OAIUpdateFirewallRequest::initializeModel() {
...
void OAIUpdateFirewallRequest::fromJson(QString jsonString) {
...
void OAIUpdateFirewallRequest::fromJsonObject(QJsonObject json) {
...
QString OAIUpdateFirewallRequest::asJson() const {
...
QJsonObject OAIUpdateFirewallRequest::asJsonObject() const {
    QJsonObject obj;
    if (m_labels_isSet) {
...
OAIObject OAIUpdateFirewallRequest::getLabels() const {
    return m_labels;
}
void OAIUpdateFirewallRequest::setLabels(const OAIObject &labels) {
    m_labels = labels;
    m_labels_isSet = true;
}

bool OAIUpdateFirewallRequest::is_labels_Set() const{
    return m_labels_isSet;
}

bool OAIUpdateFirewallRequest::is_labels_Valid() const{
    return m_labels_isValid;
}

QString OAIUpdateFirewallRequest::getName() const {
    return m_name;
}
void OAIUpdateFirewallRequest::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIUpdateFirewallRequest::is_name_Set() const{
    return m_name_isSet;
}

bool OAIUpdateFirewallRequest::is_name_Valid() const{
    return m_name_isValid;
}

bool OAIUpdateFirewallRequest::isSet() const {
...
bool OAIUpdateFirewallRequest::isValid() const {
