...
OAICreateLoadBalancerRequest_labels OAICreateImageRequest::getLabels() const {
    return m_labels;
}
void OAICreateImageRequest::setLabels(const OAICreateLoadBalancerRequest_labels &labels) {
    m_labels = labels;
    m_labels_isSet = true;
}

bool OAICreateImageRequest::is_labels_Set() const{
    return m_labels_isSet;
}

bool OAICreateImageRequest::is_labels_Valid() const{
    return m_labels_isValid;
}

QString OAICreateImageRequest::getType() const {
    return m_type;
}
void OAICreateImageRequest::setType(const QString &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAICreateImageRequest::is_type_Set() const{
    return m_type_isSet;
}

bool OAICreateImageRequest::is_type_Valid() const{
