...
OAIUpdateNetworkRequest::OAIUpdateNetworkRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateNetworkRequest::OAIUpdateNetworkRequest() {
    this->initializeModel();
}

OAIUpdateNetworkRequest::~OAIUpdateNetworkRequest() {}

void OAIUpdateNetworkRequest::initializeModel() {
...
void OAIUpdateNetworkRequest::fromJson(QString jsonString) {
...
void OAIUpdateNetworkRequest::fromJsonObject(QJsonObject json) {
...
QString OAIUpdateNetworkRequest::asJson() const {
...
QJsonObject OAIUpdateNetworkRequest::asJsonObject() const {
    QJsonObject obj;
    if (m_labels.isSet()) {
...
OAIUpdateNetworkRequest_labels OAIUpdateNetworkRequest::getLabels() const {
    return m_labels;
}
void OAIUpdateNetworkRequest::setLabels(const OAIUpdateNetworkRequest_labels &labels) {
    m_labels = labels;
    m_labels_isSet = true;
}

bool OAIUpdateNetworkRequest::is_labels_Set() const{
    return m_labels_isSet;
}

bool OAIUpdateNetworkRequest::is_labels_Valid() const{
    return m_labels_isValid;
}

QString OAIUpdateNetworkRequest::getName() const {
    return m_name;
}
void OAIUpdateNetworkRequest::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIUpdateNetworkRequest::is_name_Set() const{
    return m_name_isSet;
}

bool OAIUpdateNetworkRequest::is_name_Valid() const{
    return m_name_isValid;
}

bool OAIUpdateNetworkRequest::isSet() const {
...
bool OAIUpdateNetworkRequest::isValid() const {
