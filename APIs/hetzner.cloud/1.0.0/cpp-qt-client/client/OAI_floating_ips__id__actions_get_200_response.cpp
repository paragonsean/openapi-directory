...
OAI_floating_ips__id__actions_get_200_response::OAI_floating_ips__id__actions_get_200_response(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAI_floating_ips__id__actions_get_200_response::OAI_floating_ips__id__actions_get_200_response() {
    this->initializeModel();
}

OAI_floating_ips__id__actions_get_200_response::~OAI_floating_ips__id__actions_get_200_response() {}

void OAI_floating_ips__id__actions_get_200_response::initializeModel() {

    m_actions_isSet = false;
    m_actions_isValid = false;
}

void OAI_floating_ips__id__actions_get_200_response::fromJson(QString jsonString) {
...
void OAI_floating_ips__id__actions_get_200_response::fromJsonObject(QJsonObject json) {

    m_actions_isValid = ::OpenAPI::fromJsonValue(m_actions, json[QString("actions")]);
    m_actions_isSet = !json[QString("actions")].isNull() && m_actions_isValid;
}

QString OAI_floating_ips__id__actions_get_200_response::asJson() const {
...
QJsonObject OAI_floating_ips__id__actions_get_200_response::asJsonObject() const {
    QJsonObject obj;
    if (m_actions.size() > 0) {
...
QList<OAIAction> OAI_floating_ips__id__actions_get_200_response::getActions() const {
    return m_actions;
}
void OAI_floating_ips__id__actions_get_200_response::setActions(const QList<OAIAction> &actions) {
    m_actions = actions;
    m_actions_isSet = true;
}

bool OAI_floating_ips__id__actions_get_200_response::is_actions_Set() const{
    return m_actions_isSet;
}

bool OAI_floating_ips__id__actions_get_200_response::is_actions_Valid() const{
    return m_actions_isValid;
}

bool OAI_floating_ips__id__actions_get_200_response::isSet() const {
...
bool OAI_floating_ips__id__actions_get_200_response::isValid() const {
