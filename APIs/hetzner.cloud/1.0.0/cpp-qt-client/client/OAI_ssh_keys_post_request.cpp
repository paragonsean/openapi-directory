...
#include "OAI_ssh_keys_post_request.h"
...
OAI_ssh_keys_post_request::OAI_ssh_keys_post_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAI_ssh_keys_post_request::OAI_ssh_keys_post_request() {
    this->initializeModel();
}

OAI_ssh_keys_post_request::~OAI_ssh_keys_post_request() {}

void OAI_ssh_keys_post_request::initializeModel() {
...
void OAI_ssh_keys_post_request::fromJson(QString jsonString) {
...
void OAI_ssh_keys_post_request::fromJsonObject(QJsonObject json) {
...
QString OAI_ssh_keys_post_request::asJson() const {
...
QJsonObject OAI_ssh_keys_post_request::asJsonObject() const {
    QJsonObject obj;
    if (m_labels_isSet) {
...
OAIObject OAI_ssh_keys_post_request::getLabels() const {
    return m_labels;
}
void OAI_ssh_keys_post_request::setLabels(const OAIObject &labels) {
    m_labels = labels;
    m_labels_isSet = true;
}

bool OAI_ssh_keys_post_request::is_labels_Set() const{
    return m_labels_isSet;
}

bool OAI_ssh_keys_post_request::is_labels_Valid() const{
    return m_labels_isValid;
}

QString OAI_ssh_keys_post_request::getName() const {
    return m_name;
}
void OAI_ssh_keys_post_request::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAI_ssh_keys_post_request::is_name_Set() const{
    return m_name_isSet;
}

bool OAI_ssh_keys_post_request::is_name_Valid() const{
    return m_name_isValid;
}

QString OAI_ssh_keys_post_request::getPublicKey() const {
    return m_public_key;
}
void OAI_ssh_keys_post_request::setPublicKey(const QString &public_key) {
    m_public_key = public_key;
    m_public_key_isSet = true;
}

bool OAI_ssh_keys_post_request::is_public_key_Set() const{
    return m_public_key_isSet;
}

bool OAI_ssh_keys_post_request::is_public_key_Valid() const{
    return m_public_key_isValid;
}

bool OAI_ssh_keys_post_request::isSet() const {
...
bool OAI_ssh_keys_post_request::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_name_isValid && m_public_key_isValid && true;
}
