...
#include "OAI_networks_get_200_response_networks_inner_subnets_inner.h"
...
OAI_networks_get_200_response_networks_inner_subnets_inner::OAI_networks_get_200_response_networks_inner_subnets_inner(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAI_networks_get_200_response_networks_inner_subnets_inner::OAI_networks_get_200_response_networks_inner_subnets_inner() {
    this->initializeModel();
}

OAI_networks_get_200_response_networks_inner_subnets_inner::~OAI_networks_get_200_response_networks_inner_subnets_inner() {}

void OAI_networks_get_200_response_networks_inner_subnets_inner::initializeModel() {
...
void OAI_networks_get_200_response_networks_inner_subnets_inner::fromJson(QString jsonString) {
...
void OAI_networks_get_200_response_networks_inner_subnets_inner::fromJsonObject(QJsonObject json) {
...
QString OAI_networks_get_200_response_networks_inner_subnets_inner::asJson() const {
...
QJsonObject OAI_networks_get_200_response_networks_inner_subnets_inner::asJsonObject() const {
    QJsonObject obj;
    if (m_gateway_isSet) {
...
QString OAI_networks_get_200_response_networks_inner_subnets_inner::getGateway() const {
    return m_gateway;
}
void OAI_networks_get_200_response_networks_inner_subnets_inner::setGateway(const QString &gateway) {
    m_gateway = gateway;
    m_gateway_isSet = true;
}

bool OAI_networks_get_200_response_networks_inner_subnets_inner::is_gateway_Set() const{
    return m_gateway_isSet;
}

bool OAI_networks_get_200_response_networks_inner_subnets_inner::is_gateway_Valid() const{
    return m_gateway_isValid;
}

QString OAI_networks_get_200_response_networks_inner_subnets_inner::getIpRange() const {
    return m_ip_range;
}
void OAI_networks_get_200_response_networks_inner_subnets_inner::setIpRange(const QString &ip_range) {
    m_ip_range = ip_range;
    m_ip_range_isSet = true;
}

bool OAI_networks_get_200_response_networks_inner_subnets_inner::is_ip_range_Set() const{
    return m_ip_range_isSet;
}

bool OAI_networks_get_200_response_networks_inner_subnets_inner::is_ip_range_Valid() const{
    return m_ip_range_isValid;
}

QString OAI_networks_get_200_response_networks_inner_subnets_inner::getNetworkZone() const {
    return m_network_zone;
}
void OAI_networks_get_200_response_networks_inner_subnets_inner::setNetworkZone(const QString &network_zone) {
    m_network_zone = network_zone;
    m_network_zone_isSet = true;
}

bool OAI_networks_get_200_response_networks_inner_subnets_inner::is_network_zone_Set() const{
    return m_network_zone_isSet;
}

bool OAI_networks_get_200_response_networks_inner_subnets_inner::is_network_zone_Valid() const{
    return m_network_zone_isValid;
}

QString OAI_networks_get_200_response_networks_inner_subnets_inner::getType() const {
    return m_type;
}
void OAI_networks_get_200_response_networks_inner_subnets_inner::setType(const QString &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAI_networks_get_200_response_networks_inner_subnets_inner::is_type_Set() const{
    return m_type_isSet;
}

bool OAI_networks_get_200_response_networks_inner_subnets_inner::is_type_Valid() const{
    return m_type_isValid;
}

bool OAI_networks_get_200_response_networks_inner_subnets_inner::isSet() const {
...
bool OAI_networks_get_200_response_networks_inner_subnets_inner::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_gateway_isValid && m_network_zone_isValid && m_type_isValid && true;
}
