...
OAI_load_balancers__id__actions_change_protection_post_request::OAI_load_balancers__id__actions_change_protection_post_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAI_load_balancers__id__actions_change_protection_post_request::OAI_load_balancers__id__actions_change_protection_post_request() {
    this->initializeModel();
}

OAI_load_balancers__id__actions_change_protection_post_request::~OAI_load_balancers__id__actions_change_protection_post_request() {}

void OAI_load_balancers__id__actions_change_protection_post_request::initializeModel() {

    m_r_delete_isSet = false;
    m_r_delete_isValid = false;
}

void OAI_load_balancers__id__actions_change_protection_post_request::fromJson(QString jsonString) {
...
void OAI_load_balancers__id__actions_change_protection_post_request::fromJsonObject(QJsonObject json) {
...
QString OAI_load_balancers__id__actions_change_protection_post_request::asJson() const {
...
QJsonObject OAI_load_balancers__id__actions_change_protection_post_request::asJsonObject() const {
    QJsonObject obj;
    if (m_r_delete_isSet) {
...
bool OAI_load_balancers__id__actions_change_protection_post_request::isRDelete() const {
    return m_r_delete;
}
void OAI_load_balancers__id__actions_change_protection_post_request::setRDelete(const bool &r_delete) {
    m_r_delete = r_delete;
    m_r_delete_isSet = true;
}

bool OAI_load_balancers__id__actions_change_protection_post_request::is_r_delete_Set() const{
    return m_r_delete_isSet;
}

bool OAI_load_balancers__id__actions_change_protection_post_request::is_r_delete_Valid() const{
    return m_r_delete_isValid;
}

bool OAI_load_balancers__id__actions_change_protection_post_request::isSet() const {
...
bool OAI_load_balancers__id__actions_change_protection_post_request::isValid() const {
