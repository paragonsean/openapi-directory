...
OAI_servers__id__delete_200_response::OAI_servers__id__delete_200_response(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAI_servers__id__delete_200_response::OAI_servers__id__delete_200_response() {
    this->initializeModel();
}

OAI_servers__id__delete_200_response::~OAI_servers__id__delete_200_response() {}

void OAI_servers__id__delete_200_response::initializeModel() {

    m_action_isSet = false;
    m_action_isValid = false;
}

void OAI_servers__id__delete_200_response::fromJson(QString jsonString) {
...
void OAI_servers__id__delete_200_response::fromJsonObject(QJsonObject json) {

    m_action_isValid = ::OpenAPI::fromJsonValue(m_action, json[QString("action")]);
    m_action_isSet = !json[QString("action")].isNull() && m_action_isValid;
}

QString OAI_servers__id__delete_200_response::asJson() const {
...
QJsonObject OAI_servers__id__delete_200_response::asJsonObject() const {
    QJsonObject obj;
    if (m_action.isSet()) {
...
OAIAction OAI_servers__id__delete_200_response::getAction() const {
    return m_action;
}
void OAI_servers__id__delete_200_response::setAction(const OAIAction &action) {
    m_action = action;
    m_action_isSet = true;
}

bool OAI_servers__id__delete_200_response::is_action_Set() const{
    return m_action_isSet;
}

bool OAI_servers__id__delete_200_response::is_action_Valid() const{
    return m_action_isValid;
}

bool OAI_servers__id__delete_200_response::isSet() const {
...
bool OAI_servers__id__delete_200_response::isValid() const {
