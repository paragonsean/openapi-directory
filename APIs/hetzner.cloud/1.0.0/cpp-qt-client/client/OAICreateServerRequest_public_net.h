...
/*
 * OAICreateServerRequest_public_net.h
 *
 * Public Network options
 */

#ifndef OAICreateServerRequest_public_net_H
#define OAICreateServerRequest_public_net_H
...
class OAICreateServerRequest_public_net : public OAIObject {
public:
    OAICreateServerRequest_public_net();
    OAICreateServerRequest_public_net(QString json);
    ~OAICreateServerRequest_public_net() override;
    ...
    void setEnableIpv6(const bool &enable_ipv6);
    bool is_enable_ipv6_Set() const;
    bool is_enable_ipv6_Valid() const;

    qint32 getIpv4() const;
    void setIpv4(const qint32 &ipv4);
    bool is_ipv4_Set() const;
    bool is_ipv4_Valid() const;

    qint32 getIpv6() const;
    void setIpv6(const qint32 &ipv6);
...
private:
    ...
    bool m_enable_ipv6;
    bool m_enable_ipv6_isSet;
    bool m_enable_ipv6_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateServerRequest_public_net)

#endif // OAICreateServerRequest_public_net_H
