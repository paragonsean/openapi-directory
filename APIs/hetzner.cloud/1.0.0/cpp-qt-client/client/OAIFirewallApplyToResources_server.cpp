...
#include "OAIFirewallApplyToResources_server.h"
...
OAIFirewallApplyToResources_server::OAIFirewallApplyToResources_server(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIFirewallApplyToResources_server::OAIFirewallApplyToResources_server() {
    this->initializeModel();
}

OAIFirewallApplyToResources_server::~OAIFirewallApplyToResources_server() {}

void OAIFirewallApplyToResources_server::initializeModel() {

    m_id_isSet = false;
    m_id_isValid = false;
}

void OAIFirewallApplyToResources_server::fromJson(QString jsonString) {
...
void OAIFirewallApplyToResources_server::fromJsonObject(QJsonObject json) {

    m_id_isValid = ::OpenAPI::fromJsonValue(m_id, json[QString("id")]);
    m_id_isSet = !json[QString("id")].isNull() && m_id_isValid;
}

QString OAIFirewallApplyToResources_server::asJson() const {
...
QJsonObject OAIFirewallApplyToResources_server::asJsonObject() const {
    QJsonObject obj;
    if (m_id_isSet) {
...
qint32 OAIFirewallApplyToResources_server::getId() const {
    return m_id;
}
void OAIFirewallApplyToResources_server::setId(const qint32 &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIFirewallApplyToResources_server::is_id_Set() const{
    return m_id_isSet;
}

bool OAIFirewallApplyToResources_server::is_id_Valid() const{
    return m_id_isValid;
}

bool OAIFirewallApplyToResources_server::isSet() const {
...
bool OAIFirewallApplyToResources_server::isValid() const {
