...
#include "OAICreateFirewallRequest_apply_to_inner_server.h"
...
OAICreateFirewallRequest_apply_to_inner_server::OAICreateFirewallRequest_apply_to_inner_server(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateFirewallRequest_apply_to_inner_server::OAICreateFirewallRequest_apply_to_inner_server() {
    this->initializeModel();
}

OAICreateFirewallRequest_apply_to_inner_server::~OAICreateFirewallRequest_apply_to_inner_server() {}

void OAICreateFirewallRequest_apply_to_inner_server::initializeModel() {

    m_id_isSet = false;
    m_id_isValid = false;
}

void OAICreateFirewallRequest_apply_to_inner_server::fromJson(QString jsonString) {
...
void OAICreateFirewallRequest_apply_to_inner_server::fromJsonObject(QJsonObject json) {

    m_id_isValid = ::OpenAPI::fromJsonValue(m_id, json[QString("id")]);
    m_id_isSet = !json[QString("id")].isNull() && m_id_isValid;
}

QString OAICreateFirewallRequest_apply_to_inner_server::asJson() const {
...
QJsonObject OAICreateFirewallRequest_apply_to_inner_server::asJsonObject() const {
    QJsonObject obj;
    if (m_id_isSet) {
...
qint32 OAICreateFirewallRequest_apply_to_inner_server::getId() const {
    return m_id;
}
void OAICreateFirewallRequest_apply_to_inner_server::setId(const qint32 &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAICreateFirewallRequest_apply_to_inner_server::is_id_Set() const{
    return m_id_isSet;
}

bool OAICreateFirewallRequest_apply_to_inner_server::is_id_Valid() const{
    return m_id_isValid;
}

bool OAICreateFirewallRequest_apply_to_inner_server::isSet() const {
...
bool OAICreateFirewallRequest_apply_to_inner_server::isValid() const {
