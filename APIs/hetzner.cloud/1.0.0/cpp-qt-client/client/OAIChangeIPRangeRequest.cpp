...
OAIChangeIPRangeRequest::OAIChangeIPRangeRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIChangeIPRangeRequest::OAIChangeIPRangeRequest() {
    this->initializeModel();
}

OAIChangeIPRangeRequest::~OAIChangeIPRangeRequest() {}

void OAIChangeIPRangeRequest::initializeModel() {

    m_ip_range_isSet = false;
    m_ip_range_isValid = false;
}

void OAIChangeIPRangeRequest::fromJson(QString jsonString) {
...
void OAIChangeIPRangeRequest::fromJsonObject(QJsonObject json) {
...
QString OAIChangeIPRangeRequest::asJson() const {
...
QJsonObject OAIChangeIPRangeRequest::asJsonObject() const {
    QJsonObject obj;
    if (m_ip_range_isSet) {
...
QString OAIChangeIPRangeRequest::getIpRange() const {
    return m_ip_range;
}
void OAIChangeIPRangeRequest::setIpRange(const QString &ip_range) {
    m_ip_range = ip_range;
    m_ip_range_isSet = true;
}

bool OAIChangeIPRangeRequest::is_ip_range_Set() const{
    return m_ip_range_isSet;
}

bool OAIChangeIPRangeRequest::is_ip_range_Valid() const{
    return m_ip_range_isValid;
}

bool OAIChangeIPRangeRequest::isSet() const {
...
bool OAIChangeIPRangeRequest::isValid() const {
