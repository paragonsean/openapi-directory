...
OAILoadBalancerTargetServer::OAILoadBalancerTargetServer(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAILoadBalancerTargetServer::OAILoadBalancerTargetServer() {
    this->initializeModel();
}

OAILoadBalancerTargetServer::~OAILoadBalancerTargetServer() {}

void OAILoadBalancerTargetServer::initializeModel() {

    m_id_isSet = false;
    m_id_isValid = false;
}

void OAILoadBalancerTargetServer::fromJson(QString jsonString) {
...
void OAILoadBalancerTargetServer::fromJsonObject(QJsonObject json) {

    m_id_isValid = ::OpenAPI::fromJsonValue(m_id, json[QString("id")]);
    m_id_isSet = !json[QString("id")].isNull() && m_id_isValid;
}

QString OAILoadBalancerTargetServer::asJson() const {
...
QJsonObject OAILoadBalancerTargetServer::asJsonObject() const {
    QJsonObject obj;
    if (m_id_isSet) {
...
qint32 OAILoadBalancerTargetServer::getId() const {
    return m_id;
}
void OAILoadBalancerTargetServer::setId(const qint32 &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAILoadBalancerTargetServer::is_id_Set() const{
    return m_id_isSet;
}

bool OAILoadBalancerTargetServer::is_id_Valid() const{
    return m_id_isValid;
}

bool OAILoadBalancerTargetServer::isSet() const {
...
bool OAILoadBalancerTargetServer::isValid() const {
