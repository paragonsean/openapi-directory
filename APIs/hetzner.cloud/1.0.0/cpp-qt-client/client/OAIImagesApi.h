...
#include "OAI_images__id__get_200_response.h"
#include "OAI_images_get_200_response.h"
#include <QString>
...
public:
    ...
    * @param[in]  bound_to QString [optional]
    * @param[in]  include_deprecated bool [optional]
    * @param[in]  name QString [optional]
    * @param[in]  label_selector QString [optional]
    * @param[in]  architecture QString [optional]
    */
    virtual void imagesGet(const ::OpenAPI::OptionalParam<QString> &sort = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &type = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &status = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &bound_to = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<bool> &include_deprecated = ::OpenAPI::OptionalParam<bool>(), const ::OpenAPI::OptionalParam<QString> &name = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &label_selector = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &architecture = ::OpenAPI::OptionalParam<QString>());

    /**
    * @param[in]  id qint32 [required]
    */
    virtual void imagesIdDelete(const qint32 &id);

    /**
    * @param[in]  id qint32 [required]
    */
    virtual void imagesIdGet(const qint32 &id);

    /**
    * @param[in]  id qint32 [required]
    * @param[in]  oai_update_image_request OAIUpdateImageRequest [optional]
    */
    virtual void imagesIdPut(const qint32 &id, const ::OpenAPI::OptionalParam<OAIUpdateImageRequest> &oai_update_image_request = ::OpenAPI::OptionalParam<OAIUpdateImageRequest>());
...
private:
    ...
    void imagesIdPutCallback(OAIHttpRequestWorker *worker);

Q_SIGNALS:

    void imagesGetSignal(OAI_images_get_200_response summary);
    void imagesIdDeleteSignal();
    void imagesIdGetSignal(OAI_images__id__get_200_response summary);
    void imagesIdPutSignal(OAI_images__id__get_200_response summary);


    void imagesGetSignalFull(OAIHttpRequestWorker *worker, OAI_images_get_200_response summary);
    void imagesIdDeleteSignalFull(OAIHttpRequestWorker *worker);
    void imagesIdGetSignalFull(OAIHttpRequestWorker *worker, OAI_images__id__get_200_response summary);
    void imagesIdPutSignalFull(OAIHttpRequestWorker *worker, OAI_images__id__get_200_response summary);

    Q_DECL_DEPRECATED_X("Use imagesGetSignalError() instead")
    void imagesGetSignalE(OAI_images_get_200_response summary, QNetworkReply::NetworkError error_type, QString error_str);
    void imagesGetSignalError(OAI_images_get_200_response summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    void imagesIdGetSignalE(OAI_images__id__get_200_response summary, QNetworkReply::NetworkError error_type, QString error_str);
    void imagesIdGetSignalError(OAI_images__id__get_200_response summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use imagesIdPutSignalError() instead")
    void imagesIdPutSignalE(OAI_images__id__get_200_response summary, QNetworkReply::NetworkError error_type, QString error_str);
    void imagesIdPutSignalError(OAI_images__id__get_200_response summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use imagesIdPutSignalErrorFull() instead")
    void imagesIdPutSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void imagesIdPutSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
