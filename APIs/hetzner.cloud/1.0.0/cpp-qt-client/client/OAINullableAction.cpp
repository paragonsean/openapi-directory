...
OAINullableAction::OAINullableAction(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAINullableAction::OAINullableAction() {
    this->initializeModel();
}

OAINullableAction::~OAINullableAction() {}

void OAINullableAction::initializeModel() {
...
void OAINullableAction::fromJson(QString jsonString) {
...
void OAINullableAction::fromJsonObject(QJsonObject json) {
...
QString OAINullableAction::asJson() const {
...
QJsonObject OAINullableAction::asJsonObject() const {
    QJsonObject obj;
    if (m_command_isSet) {
...
QString OAINullableAction::getCommand() const {
    return m_command;
}
void OAINullableAction::setCommand(const QString &command) {
    m_command = command;
    m_command_isSet = true;
}

bool OAINullableAction::is_command_Set() const{
    return m_command_isSet;
}

bool OAINullableAction::is_command_Valid() const{
    return m_command_isValid;
}

OAIAction_error OAINullableAction::getError() const {
    return m_error;
}
void OAINullableAction::setError(const OAIAction_error &error) {
    m_error = error;
    m_error_isSet = true;
}

bool OAINullableAction::is_error_Set() const{
    return m_error_isSet;
}

bool OAINullableAction::is_error_Valid() const{
    return m_error_isValid;
}

QString OAINullableAction::getFinished() const {
    return m_finished;
}
void OAINullableAction::setFinished(const QString &finished) {
    m_finished = finished;
    m_finished_isSet = true;
}

bool OAINullableAction::is_finished_Set() const{
    return m_finished_isSet;
}

bool OAINullableAction::is_finished_Valid() const{
    return m_finished_isValid;
}

qint32 OAINullableAction::getId() const {
    return m_id;
}
void OAINullableAction::setId(const qint32 &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAINullableAction::is_id_Set() const{
    return m_id_isSet;
}

bool OAINullableAction::is_id_Valid() const{
    return m_id_isValid;
}

double OAINullableAction::getProgress() const {
    return m_progress;
}
void OAINullableAction::setProgress(const double &progress) {
    m_progress = progress;
    m_progress_isSet = true;
}

bool OAINullableAction::is_progress_Set() const{
    return m_progress_isSet;
}

bool OAINullableAction::is_progress_Valid() const{
    return m_progress_isValid;
}

QList<OAIAction_resources_inner> OAINullableAction::getResources() const {
    return m_resources;
}
void OAINullableAction::setResources(const QList<OAIAction_resources_inner> &resources) {
    m_resources = resources;
    m_resources_isSet = true;
}

bool OAINullableAction::is_resources_Set() const{
    return m_resources_isSet;
}

bool OAINullableAction::is_resources_Valid() const{
    return m_resources_isValid;
}

QString OAINullableAction::getStarted() const {
    return m_started;
}
void OAINullableAction::setStarted(const QString &started) {
    m_started = started;
    m_started_isSet = true;
}

bool OAINullableAction::is_started_Set() const{
    return m_started_isSet;
}

bool OAINullableAction::is_started_Valid() const{
    return m_started_isValid;
}

QString OAINullableAction::getStatus() const {
    return m_status;
}
void OAINullableAction::setStatus(const QString &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAINullableAction::is_status_Set() const{
    return m_status_isSet;
}

bool OAINullableAction::is_status_Valid() const{
    return m_status_isValid;
}

bool OAINullableAction::isSet() const {
...
bool OAINullableAction::isValid() const {
