...
/*
 * OAIAddTargetRequest.h
 *
 * 
 */

#ifndef OAIAddTargetRequest_H
#define OAIAddTargetRequest_H
...
class OAIAddTargetRequest_label_selector;
class OAIAddTargetRequest_server;

class OAIAddTargetRequest : public OAIObject {
public:
    OAIAddTargetRequest();
    OAIAddTargetRequest(QString json);
    ~OAIAddTargetRequest() override;
    ...
    OAIAddTargetRequest_label_selector getLabelSelector() const;
    void setLabelSelector(const OAIAddTargetRequest_label_selector &label_selector);
    bool is_label_selector_Set() const;
    bool is_label_selector_Valid() const;

    OAIAddTargetRequest_server getServer() const;
    void setServer(const OAIAddTargetRequest_server &server);
...
private:
    ...
    OAIAddTargetRequest_label_selector m_label_selector;
    bool m_label_selector_isSet;
    bool m_label_selector_isValid;

    OAIAddTargetRequest_server m_server;
    bool m_server_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAddTargetRequest)

#endif // OAIAddTargetRequest_H
