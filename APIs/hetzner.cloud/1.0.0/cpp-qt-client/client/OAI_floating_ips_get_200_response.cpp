...
#include "OAI_floating_ips_get_200_response.h"
...
OAI_floating_ips_get_200_response::OAI_floating_ips_get_200_response(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAI_floating_ips_get_200_response::OAI_floating_ips_get_200_response() {
    this->initializeModel();
}

OAI_floating_ips_get_200_response::~OAI_floating_ips_get_200_response() {}

void OAI_floating_ips_get_200_response::initializeModel() {
...
void OAI_floating_ips_get_200_response::fromJson(QString jsonString) {
...
void OAI_floating_ips_get_200_response::fromJsonObject(QJsonObject json) {
...
QString OAI_floating_ips_get_200_response::asJson() const {
...
QJsonObject OAI_floating_ips_get_200_response::asJsonObject() const {
    QJsonObject obj;
...
QList<OAI_floating_ips_get_200_response_floating_ips_inner> OAI_floating_ips_get_200_response::getFloatingIps() const {
    return m_floating_ips;
}
void OAI_floating_ips_get_200_response::setFloatingIps(const QList<OAI_floating_ips_get_200_response_floating_ips_inner> &floating_ips) {
    m_floating_ips = floating_ips;
    m_floating_ips_isSet = true;
}

bool OAI_floating_ips_get_200_response::is_floating_ips_Set() const{
    return m_floating_ips_isSet;
}

bool OAI_floating_ips_get_200_response::is_floating_ips_Valid() const{
    return m_floating_ips_isValid;
}

OAIActionsResponse_meta OAI_floating_ips_get_200_response::getMeta() const {
    return m_meta;
}
void OAI_floating_ips_get_200_response::setMeta(const OAIActionsResponse_meta &meta) {
    m_meta = meta;
    m_meta_isSet = true;
}

bool OAI_floating_ips_get_200_response::is_meta_Set() const{
    return m_meta_isSet;
}

bool OAI_floating_ips_get_200_response::is_meta_Valid() const{
    return m_meta_isValid;
}

bool OAI_floating_ips_get_200_response::isSet() const {
...
bool OAI_floating_ips_get_200_response::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_floating_ips_isValid && true;
}
