...
OAIObject OAIUpdateImageRequest::getLabels() const {
    return m_labels;
}
void OAIUpdateImageRequest::setLabels(const OAIObject &labels) {
    m_labels = labels;
    m_labels_isSet = true;
}

bool OAIUpdateImageRequest::is_labels_Set() const{
    return m_labels_isSet;
}

bool OAIUpdateImageRequest::is_labels_Valid() const{
    return m_labels_isValid;
}

QString OAIUpdateImageRequest::getType() const {
    return m_type;
}
void OAIUpdateImageRequest::setType(const QString &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAIUpdateImageRequest::is_type_Set() const{
    return m_type_isSet;
}

bool OAIUpdateImageRequest::is_type_Valid() const{
