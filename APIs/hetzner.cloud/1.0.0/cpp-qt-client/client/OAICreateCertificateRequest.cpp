...
#include "OAICreateCertificateRequest.h"
...
OAICreateCertificateRequest::OAICreateCertificateRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateCertificateRequest::OAICreateCertificateRequest() {
    this->initializeModel();
}

OAICreateCertificateRequest::~OAICreateCertificateRequest() {}

void OAICreateCertificateRequest::initializeModel() {
...
void OAICreateCertificateRequest::fromJson(QString jsonString) {
...
void OAICreateCertificateRequest::fromJsonObject(QJsonObject json) {
    ...
    m_domain_names_isValid = ::OpenAPI::fromJsonValue(m_domain_names, json[QString("domain_names")]);
    m_domain_names_isSet = !json[QString("domain_names")].isNull() && m_domain_names_isValid;
...
QString OAICreateCertificateRequest::asJson() const {
...
QJsonObject OAICreateCertificateRequest::asJsonObject() const {
    QJsonObject obj;
    if (m_certificate_isSet) {
        obj.insert(QString("certificate"), ::OpenAPI::toJsonValue(m_certificate));
    }
    if (m_domain_names.size() > 0) {
        obj.insert(QString("domain_names"), ::OpenAPI::toJsonValue(m_domain_names));
    }
    if (m_labels_isSet) {
...
QString OAICreateCertificateRequest::getCertificate() const {
    return m_certificate;
}
void OAICreateCertificateRequest::setCertificate(const QString &certificate) {
    m_certificate = certificate;
    m_certificate_isSet = true;
}

bool OAICreateCertificateRequest::is_certificate_Set() const{
    return m_certificate_isSet;
}

bool OAICreateCertificateRequest::is_certificate_Valid() const{
    return m_certificate_isValid;
}

QList<QString> OAICreateCertificateRequest::getDomainNames() const {
    return m_domain_names;
}
void OAICreateCertificateRequest::setDomainNames(const QList<QString> &domain_names) {
    m_domain_names = domain_names;
    m_domain_names_isSet = true;
}

bool OAICreateCertificateRequest::is_domain_names_Set() const{
    return m_domain_names_isSet;
}

bool OAICreateCertificateRequest::is_domain_names_Valid() const{
    return m_domain_names_isValid;
}

OAIObject OAICreateCertificateRequest::getLabels() const {
    return m_labels;
}
void OAICreateCertificateRequest::setLabels(const OAIObject &labels) {
    m_labels = labels;
    m_labels_isSet = true;
}

bool OAICreateCertificateRequest::is_labels_Set() const{
    return m_labels_isSet;
}

bool OAICreateCertificateRequest::is_labels_Valid() const{
    return m_labels_isValid;
}

QString OAICreateCertificateRequest::getName() const {
    return m_name;
}
void OAICreateCertificateRequest::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAICreateCertificateRequest::is_name_Set() const{
    return m_name_isSet;
}

bool OAICreateCertificateRequest::is_name_Valid() const{
    return m_name_isValid;
}

QString OAICreateCertificateRequest::getPrivateKey() const {
    return m_private_key;
}
void OAICreateCertificateRequest::setPrivateKey(const QString &private_key) {
    m_private_key = private_key;
    m_private_key_isSet = true;
}

bool OAICreateCertificateRequest::is_private_key_Set() const{
    return m_private_key_isSet;
}

bool OAICreateCertificateRequest::is_private_key_Valid() const{
    return m_private_key_isValid;
}

QString OAICreateCertificateRequest::getType() const {
    return m_type;
}
void OAICreateCertificateRequest::setType(const QString &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAICreateCertificateRequest::is_type_Set() const{
    return m_type_isSet;
}

bool OAICreateCertificateRequest::is_type_Valid() const{
    return m_type_isValid;
}

bool OAICreateCertificateRequest::isSet() const {
...
bool OAICreateCertificateRequest::isValid() const {
