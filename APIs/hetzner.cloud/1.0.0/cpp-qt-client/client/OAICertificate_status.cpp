...
#include "OAICertificate_status.h"
...
OAICertificate_status::OAICertificate_status(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICertificate_status::OAICertificate_status() {
    this->initializeModel();
}

OAICertificate_status::~OAICertificate_status() {}

void OAICertificate_status::initializeModel() {

    m_error_isSet = false;
    m_error_isValid = false;

    m_issuance_isSet = false;
    m_issuance_isValid = false;

    m_renewal_isSet = false;
    m_renewal_isValid = false;
}

void OAICertificate_status::fromJson(QString jsonString) {
...
void OAICertificate_status::fromJsonObject(QJsonObject json) {

    m_error_isValid = ::OpenAPI::fromJsonValue(m_error, json[QString("error")]);
    m_error_isSet = !json[QString("error")].isNull() && m_error_isValid;

    m_issuance_isValid = ::OpenAPI::fromJsonValue(m_issuance, json[QString("issuance")]);
    m_issuance_isSet = !json[QString("issuance")].isNull() && m_issuance_isValid;
...
QString OAICertificate_status::asJson() const {
...
QJsonObject OAICertificate_status::asJsonObject() const {
    QJsonObject obj;
    if (m_error.isSet()) {
        obj.insert(QString("error"), ::OpenAPI::toJsonValue(m_error));
    }
    if (m_issuance_isSet) {
        obj.insert(QString("issuance"), ::OpenAPI::toJsonValue(m_issuance));
    }
    if (m_renewal_isSet) {
...
OAICertificate_status_error OAICertificate_status::getError() const {
    return m_error;
}
void OAICertificate_status::setError(const OAICertificate_status_error &error) {
    m_error = error;
    m_error_isSet = true;
}

bool OAICertificate_status::is_error_Set() const{
    return m_error_isSet;
}

bool OAICertificate_status::is_error_Valid() const{
    return m_error_isValid;
}

QString OAICertificate_status::getIssuance() const {
    return m_issuance;
}
void OAICertificate_status::setIssuance(const QString &issuance) {
    m_issuance = issuance;
    m_issuance_isSet = true;
}

bool OAICertificate_status::is_issuance_Set() const{
    return m_issuance_isSet;
}

bool OAICertificate_status::is_issuance_Valid() const{
    return m_issuance_isValid;
}

QString OAICertificate_status::getRenewal() const {
    return m_renewal;
}
void OAICertificate_status::setRenewal(const QString &renewal) {
    m_renewal = renewal;
    m_renewal_isSet = true;
}

bool OAICertificate_status::is_renewal_Set() const{
    return m_renewal_isSet;
}

bool OAICertificate_status::is_renewal_Valid() const{
    return m_renewal_isValid;
}

bool OAICertificate_status::isSet() const {
...
bool OAICertificate_status::isValid() const {
