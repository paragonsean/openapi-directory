...
#include "OAICreateServerRequest_firewalls_inner.h"
...
OAICreateServerRequest_firewalls_inner::OAICreateServerRequest_firewalls_inner(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateServerRequest_firewalls_inner::OAICreateServerRequest_firewalls_inner() {
    this->initializeModel();
}

OAICreateServerRequest_firewalls_inner::~OAICreateServerRequest_firewalls_inner() {}

void OAICreateServerRequest_firewalls_inner::initializeModel() {

    m_firewall_isSet = false;
    m_firewall_isValid = false;
}

void OAICreateServerRequest_firewalls_inner::fromJson(QString jsonString) {
...
void OAICreateServerRequest_firewalls_inner::fromJsonObject(QJsonObject json) {
...
QString OAICreateServerRequest_firewalls_inner::asJson() const {
...
QJsonObject OAICreateServerRequest_firewalls_inner::asJsonObject() const {
    QJsonObject obj;
    if (m_firewall_isSet) {
...
qint32 OAICreateServerRequest_firewalls_inner::getFirewall() const {
    return m_firewall;
}
void OAICreateServerRequest_firewalls_inner::setFirewall(const qint32 &firewall) {
    m_firewall = firewall;
    m_firewall_isSet = true;
}

bool OAICreateServerRequest_firewalls_inner::is_firewall_Set() const{
    return m_firewall_isSet;
}

bool OAICreateServerRequest_firewalls_inner::is_firewall_Valid() const{
    return m_firewall_isValid;
}

bool OAICreateServerRequest_firewalls_inner::isSet() const {
...
bool OAICreateServerRequest_firewalls_inner::isValid() const {
