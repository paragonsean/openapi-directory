...
OAIPrimaryIP::OAIPrimaryIP(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPrimaryIP::OAIPrimaryIP() {
    this->initializeModel();
}

OAIPrimaryIP::~OAIPrimaryIP() {}

void OAIPrimaryIP::initializeModel() {
    ...
    m_dns_ptr_isSet = false;
    m_dns_ptr_isValid = false;
...
void OAIPrimaryIP::fromJson(QString jsonString) {
...
void OAIPrimaryIP::fromJsonObject(QJsonObject json) {
    ...
    m_assignee_type_isValid = ::OpenAPI::fromJsonValue(m_assignee_type, json[QString("assignee_type")]);
    m_assignee_type_isSet = !json[QString("assignee_type")].isNull() && m_assignee_type_isValid;

    m_auto_delete_isValid = ::OpenAPI::fromJsonValue(m_auto_delete, json[QString("auto_delete")]);
    m_auto_delete_isSet = !json[QString("auto_delete")].isNull() && m_auto_delete_isValid;
    ...
    m_dns_ptr_isValid = ::OpenAPI::fromJsonValue(m_dns_ptr, json[QString("dns_ptr")]);
    m_dns_ptr_isSet = !json[QString("dns_ptr")].isNull() && m_dns_ptr_isValid;
...
QString OAIPrimaryIP::asJson() const {
...
QJsonObject OAIPrimaryIP::asJsonObject() const {
    QJsonObject obj;
    if (m_assignee_id_isSet) {
        obj.insert(QString("assignee_id"), ::OpenAPI::toJsonValue(m_assignee_id));
    }
    if (m_assignee_type_isSet) {
        obj.insert(QString("assignee_type"), ::OpenAPI::toJsonValue(m_assignee_type));
    }
    if (m_auto_delete_isSet) {
        obj.insert(QString("auto_delete"), ::OpenAPI::toJsonValue(m_auto_delete));
    }
    if (m_blocked_isSet) {
    ...
    if (m_dns_ptr.size() > 0) {
        obj.insert(QString("dns_ptr"), ::OpenAPI::toJsonValue(m_dns_ptr));
    }
    if (m_id_isSet) {
...
qint32 OAIPrimaryIP::getAssigneeId() const {
    return m_assignee_id;
}
void OAIPrimaryIP::setAssigneeId(const qint32 &assignee_id) {
    m_assignee_id = assignee_id;
    m_assignee_id_isSet = true;
}

bool OAIPrimaryIP::is_assignee_id_Set() const{
    return m_assignee_id_isSet;
}

bool OAIPrimaryIP::is_assignee_id_Valid() const{
    return m_assignee_id_isValid;
}

QString OAIPrimaryIP::getAssigneeType() const {
    return m_assignee_type;
}
void OAIPrimaryIP::setAssigneeType(const QString &assignee_type) {
    m_assignee_type = assignee_type;
    m_assignee_type_isSet = true;
}

bool OAIPrimaryIP::is_assignee_type_Set() const{
    return m_assignee_type_isSet;
}

bool OAIPrimaryIP::is_assignee_type_Valid() const{
    return m_assignee_type_isValid;
}

bool OAIPrimaryIP::isAutoDelete() const {
    return m_auto_delete;
}
void OAIPrimaryIP::setAutoDelete(const bool &auto_delete) {
    m_auto_delete = auto_delete;
    m_auto_delete_isSet = true;
}

bool OAIPrimaryIP::is_auto_delete_Set() const{
    return m_auto_delete_isSet;
}

bool OAIPrimaryIP::is_auto_delete_Valid() const{
    return m_auto_delete_isValid;
}

bool OAIPrimaryIP::isBlocked() const {
    return m_blocked;
}
void OAIPrimaryIP::setBlocked(const bool &blocked) {
    m_blocked = blocked;
    m_blocked_isSet = true;
}

bool OAIPrimaryIP::is_blocked_Set() const{
    return m_blocked_isSet;
}

bool OAIPrimaryIP::is_blocked_Valid() const{
    return m_blocked_isValid;
}

QString OAIPrimaryIP::getCreated() const {
    return m_created;
}
void OAIPrimaryIP::setCreated(const QString &created) {
    m_created = created;
    m_created_isSet = true;
}

bool OAIPrimaryIP::is_created_Set() const{
    return m_created_isSet;
}

bool OAIPrimaryIP::is_created_Valid() const{
    return m_created_isValid;
}

OAIPrimaryIP_datacenter OAIPrimaryIP::getDatacenter() const {
    return m_datacenter;
}
void OAIPrimaryIP::setDatacenter(const OAIPrimaryIP_datacenter &datacenter) {
    m_datacenter = datacenter;
    m_datacenter_isSet = true;
}

bool OAIPrimaryIP::is_datacenter_Set() const{
    return m_datacenter_isSet;
}

bool OAIPrimaryIP::is_datacenter_Valid() const{
    return m_datacenter_isValid;
}

QList<OAIPrimaryIP_dns_ptr_inner> OAIPrimaryIP::getDnsPtr() const {
    return m_dns_ptr;
}
void OAIPrimaryIP::setDnsPtr(const QList<OAIPrimaryIP_dns_ptr_inner> &dns_ptr) {
    m_dns_ptr = dns_ptr;
    m_dns_ptr_isSet = true;
}

bool OAIPrimaryIP::is_dns_ptr_Set() const{
    return m_dns_ptr_isSet;
}

bool OAIPrimaryIP::is_dns_ptr_Valid() const{
    return m_dns_ptr_isValid;
}

qint32 OAIPrimaryIP::getId() const {
    return m_id;
}
void OAIPrimaryIP::setId(const qint32 &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIPrimaryIP::is_id_Set() const{
    return m_id_isSet;
}

bool OAIPrimaryIP::is_id_Valid() const{
    return m_id_isValid;
}

QString OAIPrimaryIP::getIp() const {
    return m_ip;
}
void OAIPrimaryIP::setIp(const QString &ip) {
    m_ip = ip;
    m_ip_isSet = true;
}

bool OAIPrimaryIP::is_ip_Set() const{
    return m_ip_isSet;
}

bool OAIPrimaryIP::is_ip_Valid() const{
    return m_ip_isValid;
}

QMap<QString, QString> OAIPrimaryIP::getLabels() const {
    return m_labels;
}
void OAIPrimaryIP::setLabels(const QMap<QString, QString> &labels) {
    m_labels = labels;
    m_labels_isSet = true;
}

bool OAIPrimaryIP::is_labels_Set() const{
    return m_labels_isSet;
}

bool OAIPrimaryIP::is_labels_Valid() const{
    return m_labels_isValid;
}

QString OAIPrimaryIP::getName() const {
    return m_name;
}
void OAIPrimaryIP::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIPrimaryIP::is_name_Set() const{
    return m_name_isSet;
}

bool OAIPrimaryIP::is_name_Valid() const{
    return m_name_isValid;
}

OAI_floating_ips_get_200_response_floating_ips_inner_protection OAIPrimaryIP::getProtection() const {
    return m_protection;
}
void OAIPrimaryIP::setProtection(const OAI_floating_ips_get_200_response_floating_ips_inner_protection &protection) {
    m_protection = protection;
    m_protection_isSet = true;
}

bool OAIPrimaryIP::is_protection_Set() const{
    return m_protection_isSet;
}

bool OAIPrimaryIP::is_protection_Valid() const{
    return m_protection_isValid;
}

QString OAIPrimaryIP::getType() const {
    return m_type;
}
void OAIPrimaryIP::setType(const QString &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAIPrimaryIP::is_type_Set() const{
    return m_type_isSet;
}

bool OAIPrimaryIP::is_type_Valid() const{
    return m_type_isValid;
}

bool OAIPrimaryIP::isSet() const {
...
bool OAIPrimaryIP::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_assignee_id_isValid && m_assignee_type_isValid && m_auto_delete_isValid && m_blocked_isValid && m_created_isValid && m_datacenter_isValid && m_dns_ptr_isValid && m_id_isValid && m_ip_isValid && m_labels_isValid && m_name_isValid && m_protection_isValid && m_type_isValid && true;
}
