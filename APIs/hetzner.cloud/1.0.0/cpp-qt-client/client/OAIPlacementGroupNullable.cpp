...
#include "OAIPlacementGroupNullable.h"
...
OAIPlacementGroupNullable::OAIPlacementGroupNullable(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPlacementGroupNullable::OAIPlacementGroupNullable() {
    this->initializeModel();
}

OAIPlacementGroupNullable::~OAIPlacementGroupNullable() {}

void OAIPlacementGroupNullable::initializeModel() {
...
void OAIPlacementGroupNullable::fromJson(QString jsonString) {
...
void OAIPlacementGroupNullable::fromJsonObject(QJsonObject json) {
...
QString OAIPlacementGroupNullable::asJson() const {
...
QJsonObject OAIPlacementGroupNullable::asJsonObject() const {
    QJsonObject obj;
    if (m_created_isSet) {
...
QString OAIPlacementGroupNullable::getCreated() const {
    return m_created;
}
void OAIPlacementGroupNullable::setCreated(const QString &created) {
    m_created = created;
    m_created_isSet = true;
}

bool OAIPlacementGroupNullable::is_created_Set() const{
    return m_created_isSet;
}

bool OAIPlacementGroupNullable::is_created_Valid() const{
    return m_created_isValid;
}

qint32 OAIPlacementGroupNullable::getId() const {
    return m_id;
}
void OAIPlacementGroupNullable::setId(const qint32 &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIPlacementGroupNullable::is_id_Set() const{
    return m_id_isSet;
}

bool OAIPlacementGroupNullable::is_id_Valid() const{
    return m_id_isValid;
}

QMap<QString, QString> OAIPlacementGroupNullable::getLabels() const {
    return m_labels;
}
void OAIPlacementGroupNullable::setLabels(const QMap<QString, QString> &labels) {
    m_labels = labels;
    m_labels_isSet = true;
}

bool OAIPlacementGroupNullable::is_labels_Set() const{
    return m_labels_isSet;
}

bool OAIPlacementGroupNullable::is_labels_Valid() const{
    return m_labels_isValid;
}

QString OAIPlacementGroupNullable::getName() const {
    return m_name;
}
void OAIPlacementGroupNullable::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIPlacementGroupNullable::is_name_Set() const{
    return m_name_isSet;
}

bool OAIPlacementGroupNullable::is_name_Valid() const{
    return m_name_isValid;
}

QList<qint32> OAIPlacementGroupNullable::getServers() const {
    return m_servers;
}
void OAIPlacementGroupNullable::setServers(const QList<qint32> &servers) {
    m_servers = servers;
    m_servers_isSet = true;
}

bool OAIPlacementGroupNullable::is_servers_Set() const{
    return m_servers_isSet;
}

bool OAIPlacementGroupNullable::is_servers_Valid() const{
    return m_servers_isValid;
}

QString OAIPlacementGroupNullable::getType() const {
    return m_type;
}
void OAIPlacementGroupNullable::setType(const QString &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAIPlacementGroupNullable::is_type_Set() const{
    return m_type_isSet;
}

bool OAIPlacementGroupNullable::is_type_Valid() const{
    return m_type_isValid;
}

bool OAIPlacementGroupNullable::isSet() const {
...
bool OAIPlacementGroupNullable::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_created_isValid && m_id_isValid && m_labels_isValid && m_name_isValid && m_servers_isValid && m_type_isValid && true;
}
