...
OAI_servers__id__actions_enable_rescue_post_request::OAI_servers__id__actions_enable_rescue_post_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAI_servers__id__actions_enable_rescue_post_request::OAI_servers__id__actions_enable_rescue_post_request() {
    this->initializeModel();
}

OAI_servers__id__actions_enable_rescue_post_request::~OAI_servers__id__actions_enable_rescue_post_request() {}

void OAI_servers__id__actions_enable_rescue_post_request::initializeModel() {
...
void OAI_servers__id__actions_enable_rescue_post_request::fromJson(QString jsonString) {
...
void OAI_servers__id__actions_enable_rescue_post_request::fromJsonObject(QJsonObject json) {
...
QString OAI_servers__id__actions_enable_rescue_post_request::asJson() const {
...
QJsonObject OAI_servers__id__actions_enable_rescue_post_request::asJsonObject() const {
    QJsonObject obj;
...
QList<qint32> OAI_servers__id__actions_enable_rescue_post_request::getSshKeys() const {
    return m_ssh_keys;
}
void OAI_servers__id__actions_enable_rescue_post_request::setSshKeys(const QList<qint32> &ssh_keys) {
    m_ssh_keys = ssh_keys;
    m_ssh_keys_isSet = true;
}

bool OAI_servers__id__actions_enable_rescue_post_request::is_ssh_keys_Set() const{
    return m_ssh_keys_isSet;
}

bool OAI_servers__id__actions_enable_rescue_post_request::is_ssh_keys_Valid() const{
    return m_ssh_keys_isValid;
}

QString OAI_servers__id__actions_enable_rescue_post_request::getType() const {
    return m_type;
}
void OAI_servers__id__actions_enable_rescue_post_request::setType(const QString &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAI_servers__id__actions_enable_rescue_post_request::is_type_Set() const{
    return m_type_isSet;
}

bool OAI_servers__id__actions_enable_rescue_post_request::is_type_Valid() const{
    return m_type_isValid;
}

bool OAI_servers__id__actions_enable_rescue_post_request::isSet() const {
...
bool OAI_servers__id__actions_enable_rescue_post_request::isValid() const {
