...
OAIChangeLoadbalancerDnsPtrRequest::OAIChangeLoadbalancerDnsPtrRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIChangeLoadbalancerDnsPtrRequest::OAIChangeLoadbalancerDnsPtrRequest() {
    this->initializeModel();
}

OAIChangeLoadbalancerDnsPtrRequest::~OAIChangeLoadbalancerDnsPtrRequest() {}

void OAIChangeLoadbalancerDnsPtrRequest::initializeModel() {
...
void OAIChangeLoadbalancerDnsPtrRequest::fromJson(QString jsonString) {
...
void OAIChangeLoadbalancerDnsPtrRequest::fromJsonObject(QJsonObject json) {
...
QString OAIChangeLoadbalancerDnsPtrRequest::asJson() const {
...
QJsonObject OAIChangeLoadbalancerDnsPtrRequest::asJsonObject() const {
    QJsonObject obj;
    if (m_dns_ptr_isSet) {
...
QString OAIChangeLoadbalancerDnsPtrRequest::getDnsPtr() const {
    return m_dns_ptr;
}
void OAIChangeLoadbalancerDnsPtrRequest::setDnsPtr(const QString &dns_ptr) {
    m_dns_ptr = dns_ptr;
    m_dns_ptr_isSet = true;
}

bool OAIChangeLoadbalancerDnsPtrRequest::is_dns_ptr_Set() const{
    return m_dns_ptr_isSet;
}

bool OAIChangeLoadbalancerDnsPtrRequest::is_dns_ptr_Valid() const{
    return m_dns_ptr_isValid;
}

QString OAIChangeLoadbalancerDnsPtrRequest::getIp() const {
    return m_ip;
}
void OAIChangeLoadbalancerDnsPtrRequest::setIp(const QString &ip) {
    m_ip = ip;
    m_ip_isSet = true;
}

bool OAIChangeLoadbalancerDnsPtrRequest::is_ip_Set() const{
    return m_ip_isSet;
}

bool OAIChangeLoadbalancerDnsPtrRequest::is_ip_Valid() const{
    return m_ip_isValid;
}

bool OAIChangeLoadbalancerDnsPtrRequest::isSet() const {
...
bool OAIChangeLoadbalancerDnsPtrRequest::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_dns_ptr_isValid && m_ip_isValid && true;
}
