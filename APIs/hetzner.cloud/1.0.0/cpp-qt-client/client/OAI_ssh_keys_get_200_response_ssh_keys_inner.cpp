...
#include "OAI_ssh_keys_get_200_response_ssh_keys_inner.h"
...
OAI_ssh_keys_get_200_response_ssh_keys_inner::OAI_ssh_keys_get_200_response_ssh_keys_inner(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAI_ssh_keys_get_200_response_ssh_keys_inner::OAI_ssh_keys_get_200_response_ssh_keys_inner() {
    this->initializeModel();
}

OAI_ssh_keys_get_200_response_ssh_keys_inner::~OAI_ssh_keys_get_200_response_ssh_keys_inner() {}

void OAI_ssh_keys_get_200_response_ssh_keys_inner::initializeModel() {
...
void OAI_ssh_keys_get_200_response_ssh_keys_inner::fromJson(QString jsonString) {
...
void OAI_ssh_keys_get_200_response_ssh_keys_inner::fromJsonObject(QJsonObject json) {
...
QString OAI_ssh_keys_get_200_response_ssh_keys_inner::asJson() const {
...
QJsonObject OAI_ssh_keys_get_200_response_ssh_keys_inner::asJsonObject() const {
    QJsonObject obj;
    if (m_created_isSet) {
...
QString OAI_ssh_keys_get_200_response_ssh_keys_inner::getCreated() const {
    return m_created;
}
void OAI_ssh_keys_get_200_response_ssh_keys_inner::setCreated(const QString &created) {
    m_created = created;
    m_created_isSet = true;
}

bool OAI_ssh_keys_get_200_response_ssh_keys_inner::is_created_Set() const{
    return m_created_isSet;
}

bool OAI_ssh_keys_get_200_response_ssh_keys_inner::is_created_Valid() const{
    return m_created_isValid;
}

QString OAI_ssh_keys_get_200_response_ssh_keys_inner::getFingerprint() const {
    return m_fingerprint;
}
void OAI_ssh_keys_get_200_response_ssh_keys_inner::setFingerprint(const QString &fingerprint) {
    m_fingerprint = fingerprint;
    m_fingerprint_isSet = true;
}

bool OAI_ssh_keys_get_200_response_ssh_keys_inner::is_fingerprint_Set() const{
    return m_fingerprint_isSet;
}

bool OAI_ssh_keys_get_200_response_ssh_keys_inner::is_fingerprint_Valid() const{
    return m_fingerprint_isValid;
}

qint32 OAI_ssh_keys_get_200_response_ssh_keys_inner::getId() const {
    return m_id;
}
void OAI_ssh_keys_get_200_response_ssh_keys_inner::setId(const qint32 &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAI_ssh_keys_get_200_response_ssh_keys_inner::is_id_Set() const{
    return m_id_isSet;
}

bool OAI_ssh_keys_get_200_response_ssh_keys_inner::is_id_Valid() const{
    return m_id_isValid;
}

QMap<QString, QString> OAI_ssh_keys_get_200_response_ssh_keys_inner::getLabels() const {
    return m_labels;
}
void OAI_ssh_keys_get_200_response_ssh_keys_inner::setLabels(const QMap<QString, QString> &labels) {
    m_labels = labels;
    m_labels_isSet = true;
}

bool OAI_ssh_keys_get_200_response_ssh_keys_inner::is_labels_Set() const{
    return m_labels_isSet;
}

bool OAI_ssh_keys_get_200_response_ssh_keys_inner::is_labels_Valid() const{
    return m_labels_isValid;
}

QString OAI_ssh_keys_get_200_response_ssh_keys_inner::getName() const {
    return m_name;
}
void OAI_ssh_keys_get_200_response_ssh_keys_inner::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAI_ssh_keys_get_200_response_ssh_keys_inner::is_name_Set() const{
    return m_name_isSet;
}

bool OAI_ssh_keys_get_200_response_ssh_keys_inner::is_name_Valid() const{
    return m_name_isValid;
}

QString OAI_ssh_keys_get_200_response_ssh_keys_inner::getPublicKey() const {
    return m_public_key;
}
void OAI_ssh_keys_get_200_response_ssh_keys_inner::setPublicKey(const QString &public_key) {
    m_public_key = public_key;
    m_public_key_isSet = true;
}

bool OAI_ssh_keys_get_200_response_ssh_keys_inner::is_public_key_Set() const{
    return m_public_key_isSet;
}

bool OAI_ssh_keys_get_200_response_ssh_keys_inner::is_public_key_Valid() const{
    return m_public_key_isValid;
}

bool OAI_ssh_keys_get_200_response_ssh_keys_inner::isSet() const {
...
bool OAI_ssh_keys_get_200_response_ssh_keys_inner::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_created_isValid && m_fingerprint_isValid && m_id_isValid && m_labels_isValid && m_name_isValid && m_public_key_isValid && true;
}
