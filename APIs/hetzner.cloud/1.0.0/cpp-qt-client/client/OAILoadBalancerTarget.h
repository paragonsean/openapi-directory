...
/*
 * OAILoadBalancerTarget.h
 *
 * 
 */

#ifndef OAILoadBalancerTarget_H
#define OAILoadBalancerTarget_H

#include <QJsonObject>

#include "OAILoadBalancerTargetHealthStatus_inner.h"
#include "OAILoadBalancerTargetIP.h"
#include "OAILoadBalancerTargetLabelSelector.h"
#include "OAILoadBalancerTargetServer.h"
#include "OAILoadBalancerTargetTarget.h"
#include <QList>
#include <QString>
...
namespace OpenAPI {
class OAILoadBalancerTargetHealthStatus_inner;
class OAILoadBalancerTargetIP;
class OAILoadBalancerTargetLabelSelector;
class OAILoadBalancerTargetServer;
class OAILoadBalancerTargetTarget;

class OAILoadBalancerTarget : public OAIObject {
public:
    OAILoadBalancerTarget();
    OAILoadBalancerTarget(QString json);
    ~OAILoadBalancerTarget() override;
    ...
    QList<OAILoadBalancerTargetHealthStatus_inner> getHealthStatus() const;
    void setHealthStatus(const QList<OAILoadBalancerTargetHealthStatus_inner> &health_status);
    bool is_health_status_Set() const;
    bool is_health_status_Valid() const;

    OAILoadBalancerTargetIP getIp() const;
    void setIp(const OAILoadBalancerTargetIP &ip);
    bool is_ip_Set() const;
    bool is_ip_Valid() const;

    OAILoadBalancerTargetLabelSelector getLabelSelector() const;
    void setLabelSelector(const OAILoadBalancerTargetLabelSelector &label_selector);
    bool is_label_selector_Set() const;
    bool is_label_selector_Valid() const;

    OAILoadBalancerTargetServer getServer() const;
    void setServer(const OAILoadBalancerTargetServer &server);
    bool is_server_Set() const;
    bool is_server_Valid() const;

    QList<OAILoadBalancerTargetTarget> getTargets() const;
    void setTargets(const QList<OAILoadBalancerTargetTarget> &targets);
    ...
    bool isUsePrivateIp() const;
    void setUsePrivateIp(const bool &use_private_ip);
    bool is_use_private_ip_Set() const;
    bool is_use_private_ip_Valid() const;
...
private:
    ...
    QList<OAILoadBalancerTargetHealthStatus_inner> m_health_status;
    bool m_health_status_isSet;
    bool m_health_status_isValid;

    OAILoadBalancerTargetIP m_ip;
    bool m_ip_isSet;
    bool m_ip_isValid;

    OAILoadBalancerTargetLabelSelector m_label_selector;
    bool m_label_selector_isSet;
    bool m_label_selector_isValid;

    OAILoadBalancerTargetServer m_server;
    bool m_server_isSet;
    bool m_server_isValid;

    QList<OAILoadBalancerTargetTarget> m_targets;
    ...
    bool m_use_private_ip;
    bool m_use_private_ip_isSet;
    bool m_use_private_ip_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAILoadBalancerTarget)

#endif // OAILoadBalancerTarget_H
