...
/*
 * OAI_servers_get_200_response_servers_inner_public_net.h
 *
 * Public network information. The Server&#39;s IPv4 address can be found in &#x60;public_net-&gt;ipv4-&gt;ip&#x60;
 */

#ifndef OAI_servers_get_200_response_servers_inner_public_net_H
#define OAI_servers_get_200_response_servers_inner_public_net_H

#include <QJsonObject>

#include "OAIServerPublicNetFirewall.h"
#include "OAI_servers_get_200_response_servers_inner_public_net_ipv4.h"
#include "OAI_servers_get_200_response_servers_inner_public_net_ipv6.h"
#include <QList>
...
namespace OpenAPI {
class OAIServerPublicNetFirewall;
class OAI_servers_get_200_response_servers_inner_public_net_ipv4;
class OAI_servers_get_200_response_servers_inner_public_net_ipv6;

class OAI_servers_get_200_response_servers_inner_public_net : public OAIObject {
public:
    OAI_servers_get_200_response_servers_inner_public_net();
    OAI_servers_get_200_response_servers_inner_public_net(QString json);
    ~OAI_servers_get_200_response_servers_inner_public_net() override;
    ...
    QList<OAIServerPublicNetFirewall> getFirewalls() const;
    void setFirewalls(const QList<OAIServerPublicNetFirewall> &firewalls);
    bool is_firewalls_Set() const;
    bool is_firewalls_Valid() const;

    QList<qint32> getFloatingIps() const;
    void setFloatingIps(const QList<qint32> &floating_ips);
    bool is_floating_ips_Set() const;
    bool is_floating_ips_Valid() const;

    OAI_servers_get_200_response_servers_inner_public_net_ipv4 getIpv4() const;
    void setIpv4(const OAI_servers_get_200_response_servers_inner_public_net_ipv4 &ipv4);
    bool is_ipv4_Set() const;
    bool is_ipv4_Valid() const;

    OAI_servers_get_200_response_servers_inner_public_net_ipv6 getIpv6() const;
    void setIpv6(const OAI_servers_get_200_response_servers_inner_public_net_ipv6 &ipv6);
...
private:
    ...
    QList<OAIServerPublicNetFirewall> m_firewalls;
    bool m_firewalls_isSet;
    bool m_firewalls_isValid;

    QList<qint32> m_floating_ips;
    bool m_floating_ips_isSet;
    bool m_floating_ips_isValid;

    OAI_servers_get_200_response_servers_inner_public_net_ipv4 m_ipv4;
    bool m_ipv4_isSet;
    bool m_ipv4_isValid;

    OAI_servers_get_200_response_servers_inner_public_net_ipv6 m_ipv6;
    bool m_ipv6_isSet;
    bool m_ipv6_isValid;
};
...
Q_DECLARE_METATYPE(OpenAPI::OAI_servers_get_200_response_servers_inner_public_net)

#endif // OAI_servers_get_200_response_servers_inner_public_net_H
