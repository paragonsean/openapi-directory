...
#include "OAIAddTargetRequest_server.h"
...
OAIAddTargetRequest_server::OAIAddTargetRequest_server(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAddTargetRequest_server::OAIAddTargetRequest_server() {
    this->initializeModel();
}

OAIAddTargetRequest_server::~OAIAddTargetRequest_server() {}

void OAIAddTargetRequest_server::initializeModel() {

    m_id_isSet = false;
    m_id_isValid = false;
}

void OAIAddTargetRequest_server::fromJson(QString jsonString) {
...
void OAIAddTargetRequest_server::fromJsonObject(QJsonObject json) {

    m_id_isValid = ::OpenAPI::fromJsonValue(m_id, json[QString("id")]);
    m_id_isSet = !json[QString("id")].isNull() && m_id_isValid;
}

QString OAIAddTargetRequest_server::asJson() const {
...
QJsonObject OAIAddTargetRequest_server::asJsonObject() const {
    QJsonObject obj;
    if (m_id_isSet) {
...
double OAIAddTargetRequest_server::getId() const {
    return m_id;
}
void OAIAddTargetRequest_server::setId(const double &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIAddTargetRequest_server::is_id_Set() const{
    return m_id_isSet;
}

bool OAIAddTargetRequest_server::is_id_Valid() const{
    return m_id_isValid;
}

bool OAIAddTargetRequest_server::isSet() const {
...
bool OAIAddTargetRequest_server::isValid() const {
