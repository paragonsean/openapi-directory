...
OAI_pricing_get_200_response_pricing_primary_ips_inner::OAI_pricing_get_200_response_pricing_primary_ips_inner(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAI_pricing_get_200_response_pricing_primary_ips_inner::OAI_pricing_get_200_response_pricing_primary_ips_inner() {
    this->initializeModel();
}

OAI_pricing_get_200_response_pricing_primary_ips_inner::~OAI_pricing_get_200_response_pricing_primary_ips_inner() {}

void OAI_pricing_get_200_response_pricing_primary_ips_inner::initializeModel() {
...
void OAI_pricing_get_200_response_pricing_primary_ips_inner::fromJson(QString jsonString) {
...
void OAI_pricing_get_200_response_pricing_primary_ips_inner::fromJsonObject(QJsonObject json) {
...
QString OAI_pricing_get_200_response_pricing_primary_ips_inner::asJson() const {
...
QJsonObject OAI_pricing_get_200_response_pricing_primary_ips_inner::asJsonObject() const {
    QJsonObject obj;
    if (m_prices.size() > 0) {
...
QList<OAI_pricing_get_200_response_pricing_primary_ips_inner_prices_inner> OAI_pricing_get_200_response_pricing_primary_ips_inner::getPrices() const {
    return m_prices;
}
void OAI_pricing_get_200_response_pricing_primary_ips_inner::setPrices(const QList<OAI_pricing_get_200_response_pricing_primary_ips_inner_prices_inner> &prices) {
    m_prices = prices;
    m_prices_isSet = true;
}

bool OAI_pricing_get_200_response_pricing_primary_ips_inner::is_prices_Set() const{
    return m_prices_isSet;
}

bool OAI_pricing_get_200_response_pricing_primary_ips_inner::is_prices_Valid() const{
    return m_prices_isValid;
}

QString OAI_pricing_get_200_response_pricing_primary_ips_inner::getType() const {
    return m_type;
}
void OAI_pricing_get_200_response_pricing_primary_ips_inner::setType(const QString &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAI_pricing_get_200_response_pricing_primary_ips_inner::is_type_Set() const{
    return m_type_isSet;
}

bool OAI_pricing_get_200_response_pricing_primary_ips_inner::is_type_Valid() const{
    return m_type_isValid;
}

bool OAI_pricing_get_200_response_pricing_primary_ips_inner::isSet() const {
...
bool OAI_pricing_get_200_response_pricing_primary_ips_inner::isValid() const {
