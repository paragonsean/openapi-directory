...
OAIAddDeleteRouteRequest::OAIAddDeleteRouteRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAddDeleteRouteRequest::OAIAddDeleteRouteRequest() {
    this->initializeModel();
}

OAIAddDeleteRouteRequest::~OAIAddDeleteRouteRequest() {}

void OAIAddDeleteRouteRequest::initializeModel() {
...
void OAIAddDeleteRouteRequest::fromJson(QString jsonString) {
...
void OAIAddDeleteRouteRequest::fromJsonObject(QJsonObject json) {
...
QString OAIAddDeleteRouteRequest::asJson() const {
...
QJsonObject OAIAddDeleteRouteRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIAddDeleteRouteRequest::getDestination() const {
    return m_destination;
}
void OAIAddDeleteRouteRequest::setDestination(const QString &destination) {
    m_destination = destination;
    m_destination_isSet = true;
}

bool OAIAddDeleteRouteRequest::is_destination_Set() const{
    return m_destination_isSet;
}

bool OAIAddDeleteRouteRequest::is_destination_Valid() const{
    return m_destination_isValid;
}

QString OAIAddDeleteRouteRequest::getGateway() const {
    return m_gateway;
}
void OAIAddDeleteRouteRequest::setGateway(const QString &gateway) {
    m_gateway = gateway;
    m_gateway_isSet = true;
}

bool OAIAddDeleteRouteRequest::is_gateway_Set() const{
    return m_gateway_isSet;
}

bool OAIAddDeleteRouteRequest::is_gateway_Valid() const{
    return m_gateway_isValid;
}

bool OAIAddDeleteRouteRequest::isSet() const {
...
bool OAIAddDeleteRouteRequest::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_destination_isValid && m_gateway_isValid && true;
}
