...
/*
 * OAI_datacenters_get_200_response_datacenters_inner_location.h
 *
 * 
 */

#ifndef OAI_datacenters_get_200_response_datacenters_inner_location_H
#define OAI_datacenters_get_200_response_datacenters_inner_location_H
...
class OAI_datacenters_get_200_response_datacenters_inner_location : public OAIObject {
public:
    OAI_datacenters_get_200_response_datacenters_inner_location();
    OAI_datacenters_get_200_response_datacenters_inner_location(QString json);
    ~OAI_datacenters_get_200_response_datacenters_inner_location() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAI_datacenters_get_200_response_datacenters_inner_location)

#endif // OAI_datacenters_get_200_response_datacenters_inner_location_H
