...
#include "OAICreateFirewallRequest_apply_to_inner_label_selector.h"
...
OAICreateFirewallRequest_apply_to_inner_label_selector::OAICreateFirewallRequest_apply_to_inner_label_selector(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateFirewallRequest_apply_to_inner_label_selector::OAICreateFirewallRequest_apply_to_inner_label_selector() {
    this->initializeModel();
}

OAICreateFirewallRequest_apply_to_inner_label_selector::~OAICreateFirewallRequest_apply_to_inner_label_selector() {}

void OAICreateFirewallRequest_apply_to_inner_label_selector::initializeModel() {

    m_selector_isSet = false;
    m_selector_isValid = false;
}

void OAICreateFirewallRequest_apply_to_inner_label_selector::fromJson(QString jsonString) {
...
void OAICreateFirewallRequest_apply_to_inner_label_selector::fromJsonObject(QJsonObject json) {
...
QString OAICreateFirewallRequest_apply_to_inner_label_selector::asJson() const {
...
QJsonObject OAICreateFirewallRequest_apply_to_inner_label_selector::asJsonObject() const {
    QJsonObject obj;
    if (m_selector_isSet) {
...
QString OAICreateFirewallRequest_apply_to_inner_label_selector::getSelector() const {
    return m_selector;
}
void OAICreateFirewallRequest_apply_to_inner_label_selector::setSelector(const QString &selector) {
    m_selector = selector;
    m_selector_isSet = true;
}

bool OAICreateFirewallRequest_apply_to_inner_label_selector::is_selector_Set() const{
    return m_selector_isSet;
}

bool OAICreateFirewallRequest_apply_to_inner_label_selector::is_selector_Valid() const{
    return m_selector_isValid;
}

bool OAICreateFirewallRequest_apply_to_inner_label_selector::isSet() const {
...
bool OAICreateFirewallRequest_apply_to_inner_label_selector::isValid() const {
