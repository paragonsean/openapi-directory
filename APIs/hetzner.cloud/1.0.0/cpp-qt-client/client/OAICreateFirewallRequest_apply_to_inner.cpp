...
OAICreateFirewallRequest_apply_to_inner::OAICreateFirewallRequest_apply_to_inner(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateFirewallRequest_apply_to_inner::OAICreateFirewallRequest_apply_to_inner() {
    this->initializeModel();
}

OAICreateFirewallRequest_apply_to_inner::~OAICreateFirewallRequest_apply_to_inner() {}

void OAICreateFirewallRequest_apply_to_inner::initializeModel() {
...
void OAICreateFirewallRequest_apply_to_inner::fromJson(QString jsonString) {
...
void OAICreateFirewallRequest_apply_to_inner::fromJsonObject(QJsonObject json) {
...
QString OAICreateFirewallRequest_apply_to_inner::asJson() const {
...
QJsonObject OAICreateFirewallRequest_apply_to_inner::asJsonObject() const {
    QJsonObject obj;
...
OAICreateFirewallRequest_apply_to_inner_label_selector OAICreateFirewallRequest_apply_to_inner::getLabelSelector() const {
    return m_label_selector;
}
void OAICreateFirewallRequest_apply_to_inner::setLabelSelector(const OAICreateFirewallRequest_apply_to_inner_label_selector &label_selector) {
    m_label_selector = label_selector;
    m_label_selector_isSet = true;
}

bool OAICreateFirewallRequest_apply_to_inner::is_label_selector_Set() const{
    return m_label_selector_isSet;
}

bool OAICreateFirewallRequest_apply_to_inner::is_label_selector_Valid() const{
    return m_label_selector_isValid;
}

OAICreateFirewallRequest_apply_to_inner_server OAICreateFirewallRequest_apply_to_inner::getServer() const {
    return m_server;
}
void OAICreateFirewallRequest_apply_to_inner::setServer(const OAICreateFirewallRequest_apply_to_inner_server &server) {
    m_server = server;
    m_server_isSet = true;
}

bool OAICreateFirewallRequest_apply_to_inner::is_server_Set() const{
    return m_server_isSet;
}

bool OAICreateFirewallRequest_apply_to_inner::is_server_Valid() const{
    return m_server_isValid;
}

QString OAICreateFirewallRequest_apply_to_inner::getType() const {
    return m_type;
}
void OAICreateFirewallRequest_apply_to_inner::setType(const QString &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAICreateFirewallRequest_apply_to_inner::is_type_Set() const{
    return m_type_isSet;
}

bool OAICreateFirewallRequest_apply_to_inner::is_type_Valid() const{
    return m_type_isValid;
}

bool OAICreateFirewallRequest_apply_to_inner::isSet() const {
...
bool OAICreateFirewallRequest_apply_to_inner::isValid() const {
