...
#include "OAI_pricing_get_200_response.h"
#include <QString>
...
private:
    ...
    void pricingGetCallback(OAIHttpRequestWorker *worker);

Q_SIGNALS:

    void pricingGetSignal(OAI_pricing_get_200_response summary);


    void pricingGetSignalFull(OAIHttpRequestWorker *worker, OAI_pricing_get_200_response summary);

    Q_DECL_DEPRECATED_X("Use pricingGetSignalError() instead")
    void pricingGetSignalE(OAI_pricing_get_200_response summary, QNetworkReply::NetworkError error_type, QString error_str);
    void pricingGetSignalError(OAI_pricing_get_200_response summary, QNetworkReply::NetworkError error_type, const QString &error_str);

    Q_DECL_DEPRECATED_X("Use pricingGetSignalErrorFull() instead")
    void pricingGetSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void pricingGetSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
