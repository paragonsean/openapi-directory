...
#ifndef OAINullableAction_H
#define OAINullableAction_H
...
namespace OpenAPI {
class OAIAction_error;
class OAIAction_resources_inner;

class OAINullableAction : public OAIObject {
public:
    OAINullableAction();
    OAINullableAction(QString json);
    ~OAINullableAction() override;
    ...
    OAIAction_error getError() const;
    void setError(const OAIAction_error &error);
    ...
    QList<OAIAction_resources_inner> getResources() const;
    void setResources(const QList<OAIAction_resources_inner> &resources);
...
private:
    ...
    QList<OAIAction_resources_inner> m_resources;
...
Q_DECLARE_METATYPE(OpenAPI::OAINullableAction)

#endif // OAINullableAction_H
