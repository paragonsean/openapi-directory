...
/*
 * OAI_networks_get_200_response_networks_inner.h
 *
 * 
 */

#ifndef OAI_networks_get_200_response_networks_inner_H
#define OAI_networks_get_200_response_networks_inner_H
...
namespace OpenAPI {
class OAI_networks_get_200_response_networks_inner_protection;
class OAI_networks_get_200_response_networks_inner_routes_inner;
class OAI_networks_get_200_response_networks_inner_subnets_inner;

class OAI_networks_get_200_response_networks_inner : public OAIObject {
public:
    OAI_networks_get_200_response_networks_inner();
    OAI_networks_get_200_response_networks_inner(QString json);
    ~OAI_networks_get_200_response_networks_inner() override;
    ...
    OAI_networks_get_200_response_networks_inner_protection getProtection() const;
    void setProtection(const OAI_networks_get_200_response_networks_inner_protection &protection);
    ...
    QList<OAI_networks_get_200_response_networks_inner_subnets_inner> getSubnets() const;
    void setSubnets(const QList<OAI_networks_get_200_response_networks_inner_subnets_inner> &subnets);
...
private:
    ...
    OAI_networks_get_200_response_networks_inner_protection m_protection;
    ...
    QList<OAI_networks_get_200_response_networks_inner_subnets_inner> m_subnets;
...
Q_DECLARE_METATYPE(OpenAPI::OAI_networks_get_200_response_networks_inner)

#endif // OAI_networks_get_200_response_networks_inner_H
