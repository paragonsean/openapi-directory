...
OAIChangeProtectionRequest_1::OAIChangeProtectionRequest_1(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIChangeProtectionRequest_1::OAIChangeProtectionRequest_1() {
    this->initializeModel();
}

OAIChangeProtectionRequest_1::~OAIChangeProtectionRequest_1() {}

void OAIChangeProtectionRequest_1::initializeModel() {

    m_r_delete_isSet = false;
    m_r_delete_isValid = false;
}

void OAIChangeProtectionRequest_1::fromJson(QString jsonString) {
...
void OAIChangeProtectionRequest_1::fromJsonObject(QJsonObject json) {
...
QString OAIChangeProtectionRequest_1::asJson() const {
...
QJsonObject OAIChangeProtectionRequest_1::asJsonObject() const {
    QJsonObject obj;
    if (m_r_delete_isSet) {
...
bool OAIChangeProtectionRequest_1::isRDelete() const {
    return m_r_delete;
}
void OAIChangeProtectionRequest_1::setRDelete(const bool &r_delete) {
    m_r_delete = r_delete;
    m_r_delete_isSet = true;
}

bool OAIChangeProtectionRequest_1::is_r_delete_Set() const{
    return m_r_delete_isSet;
}

bool OAIChangeProtectionRequest_1::is_r_delete_Valid() const{
    return m_r_delete_isValid;
}

bool OAIChangeProtectionRequest_1::isSet() const {
...
bool OAIChangeProtectionRequest_1::isValid() const {
