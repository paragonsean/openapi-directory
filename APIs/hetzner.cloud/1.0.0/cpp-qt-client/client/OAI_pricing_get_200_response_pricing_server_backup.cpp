...
OAI_pricing_get_200_response_pricing_server_backup::OAI_pricing_get_200_response_pricing_server_backup(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAI_pricing_get_200_response_pricing_server_backup::OAI_pricing_get_200_response_pricing_server_backup() {
    this->initializeModel();
}

OAI_pricing_get_200_response_pricing_server_backup::~OAI_pricing_get_200_response_pricing_server_backup() {}

void OAI_pricing_get_200_response_pricing_server_backup::initializeModel() {

    m_percentage_isSet = false;
    m_percentage_isValid = false;
}

void OAI_pricing_get_200_response_pricing_server_backup::fromJson(QString jsonString) {
...
void OAI_pricing_get_200_response_pricing_server_backup::fromJsonObject(QJsonObject json) {
...
QString OAI_pricing_get_200_response_pricing_server_backup::asJson() const {
...
QJsonObject OAI_pricing_get_200_response_pricing_server_backup::asJsonObject() const {
    QJsonObject obj;
...
QString OAI_pricing_get_200_response_pricing_server_backup::getPercentage() const {
    return m_percentage;
}
void OAI_pricing_get_200_response_pricing_server_backup::setPercentage(const QString &percentage) {
    m_percentage = percentage;
    m_percentage_isSet = true;
}

bool OAI_pricing_get_200_response_pricing_server_backup::is_percentage_Set() const{
    return m_percentage_isSet;
}

bool OAI_pricing_get_200_response_pricing_server_backup::is_percentage_Valid() const{
    return m_percentage_isValid;
}

bool OAI_pricing_get_200_response_pricing_server_backup::isSet() const {
...
bool OAI_pricing_get_200_response_pricing_server_backup::isValid() const {
