...
#include "OAICreateFloatingIPRequest.h"
...
OAICreateFloatingIPRequest::OAICreateFloatingIPRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateFloatingIPRequest::OAICreateFloatingIPRequest() {
    this->initializeModel();
}

OAICreateFloatingIPRequest::~OAICreateFloatingIPRequest() {}

void OAICreateFloatingIPRequest::initializeModel() {
...
void OAICreateFloatingIPRequest::fromJson(QString jsonString) {
...
void OAICreateFloatingIPRequest::fromJsonObject(QJsonObject json) {
...
QString OAICreateFloatingIPRequest::asJson() const {
...
QJsonObject OAICreateFloatingIPRequest::asJsonObject() const {
    QJsonObject obj;
    if (m_description_isSet) {
        obj.insert(QString("description"), ::OpenAPI::toJsonValue(m_description));
    }
    if (m_home_location_isSet) {
...
QString OAICreateFloatingIPRequest::getDescription() const {
    return m_description;
}
void OAICreateFloatingIPRequest::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAICreateFloatingIPRequest::is_description_Set() const{
    return m_description_isSet;
}

bool OAICreateFloatingIPRequest::is_description_Valid() const{
    return m_description_isValid;
}

QString OAICreateFloatingIPRequest::getHomeLocation() const {
    return m_home_location;
}
void OAICreateFloatingIPRequest::setHomeLocation(const QString &home_location) {
    m_home_location = home_location;
    m_home_location_isSet = true;
}

bool OAICreateFloatingIPRequest::is_home_location_Set() const{
    return m_home_location_isSet;
}

bool OAICreateFloatingIPRequest::is_home_location_Valid() const{
    return m_home_location_isValid;
}

OAIObject OAICreateFloatingIPRequest::getLabels() const {
    return m_labels;
}
void OAICreateFloatingIPRequest::setLabels(const OAIObject &labels) {
    m_labels = labels;
    m_labels_isSet = true;
}

bool OAICreateFloatingIPRequest::is_labels_Set() const{
    return m_labels_isSet;
}

bool OAICreateFloatingIPRequest::is_labels_Valid() const{
    return m_labels_isValid;
}

QString OAICreateFloatingIPRequest::getName() const {
    return m_name;
}
void OAICreateFloatingIPRequest::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAICreateFloatingIPRequest::is_name_Set() const{
    return m_name_isSet;
}

bool OAICreateFloatingIPRequest::is_name_Valid() const{
    return m_name_isValid;
}

qint32 OAICreateFloatingIPRequest::getServer() const {
    return m_server;
}
void OAICreateFloatingIPRequest::setServer(const qint32 &server) {
    m_server = server;
    m_server_isSet = true;
}

bool OAICreateFloatingIPRequest::is_server_Set() const{
    return m_server_isSet;
}

bool OAICreateFloatingIPRequest::is_server_Valid() const{
    return m_server_isValid;
}

QString OAICreateFloatingIPRequest::getType() const {
    return m_type;
}
void OAICreateFloatingIPRequest::setType(const QString &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAICreateFloatingIPRequest::is_type_Set() const{
    return m_type_isSet;
}

bool OAICreateFloatingIPRequest::is_type_Valid() const{
    return m_type_isValid;
}

bool OAICreateFloatingIPRequest::isSet() const {
...
bool OAICreateFloatingIPRequest::isValid() const {
