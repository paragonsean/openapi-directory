...
#include "OAI_servers_get_200_response_servers_inner_datacenter.h"
...
OAI_servers_get_200_response_servers_inner_datacenter::OAI_servers_get_200_response_servers_inner_datacenter(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAI_servers_get_200_response_servers_inner_datacenter::OAI_servers_get_200_response_servers_inner_datacenter() {
    this->initializeModel();
}

OAI_servers_get_200_response_servers_inner_datacenter::~OAI_servers_get_200_response_servers_inner_datacenter() {}

void OAI_servers_get_200_response_servers_inner_datacenter::initializeModel() {
...
void OAI_servers_get_200_response_servers_inner_datacenter::fromJson(QString jsonString) {
...
void OAI_servers_get_200_response_servers_inner_datacenter::fromJsonObject(QJsonObject json) {
...
QString OAI_servers_get_200_response_servers_inner_datacenter::asJson() const {
...
QJsonObject OAI_servers_get_200_response_servers_inner_datacenter::asJsonObject() const {
    QJsonObject obj;
    ...
    if (m_server_types.isSet()) {
        obj.insert(QString("server_types"), ::OpenAPI::toJsonValue(m_server_types));
    }
    return obj;
}

QString OAI_servers_get_200_response_servers_inner_datacenter::getDescription() const {
    return m_description;
}
void OAI_servers_get_200_response_servers_inner_datacenter::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAI_servers_get_200_response_servers_inner_datacenter::is_description_Set() const{
    return m_description_isSet;
}

bool OAI_servers_get_200_response_servers_inner_datacenter::is_description_Valid() const{
    return m_description_isValid;
}

qint32 OAI_servers_get_200_response_servers_inner_datacenter::getId() const {
    return m_id;
}
void OAI_servers_get_200_response_servers_inner_datacenter::setId(const qint32 &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAI_servers_get_200_response_servers_inner_datacenter::is_id_Set() const{
    return m_id_isSet;
}

bool OAI_servers_get_200_response_servers_inner_datacenter::is_id_Valid() const{
    return m_id_isValid;
}

OAI_datacenters_get_200_response_datacenters_inner_location OAI_servers_get_200_response_servers_inner_datacenter::getLocation() const {
    return m_location;
}
void OAI_servers_get_200_response_servers_inner_datacenter::setLocation(const OAI_datacenters_get_200_response_datacenters_inner_location &location) {
    m_location = location;
    m_location_isSet = true;
}

bool OAI_servers_get_200_response_servers_inner_datacenter::is_location_Set() const{
    return m_location_isSet;
}

bool OAI_servers_get_200_response_servers_inner_datacenter::is_location_Valid() const{
    return m_location_isValid;
}

QString OAI_servers_get_200_response_servers_inner_datacenter::getName() const {
    return m_name;
}
void OAI_servers_get_200_response_servers_inner_datacenter::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAI_servers_get_200_response_servers_inner_datacenter::is_name_Set() const{
    return m_name_isSet;
}

bool OAI_servers_get_200_response_servers_inner_datacenter::is_name_Valid() const{
    return m_name_isValid;
}

OAI_datacenters_get_200_response_datacenters_inner_server_types OAI_servers_get_200_response_servers_inner_datacenter::getServerTypes() const {
    return m_server_types;
}
void OAI_servers_get_200_response_servers_inner_datacenter::setServerTypes(const OAI_datacenters_get_200_response_datacenters_inner_server_types &server_types) {
    m_server_types = server_types;
    m_server_types_isSet = true;
}

bool OAI_servers_get_200_response_servers_inner_datacenter::is_server_types_Set() const{
    return m_server_types_isSet;
}

bool OAI_servers_get_200_response_servers_inner_datacenter::is_server_types_Valid() const{
    return m_server_types_isValid;
}

bool OAI_servers_get_200_response_servers_inner_datacenter::isSet() const {
...
bool OAI_servers_get_200_response_servers_inner_datacenter::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_description_isValid && m_id_isValid && m_location_isValid && m_name_isValid && m_server_types_isValid && true;
}
