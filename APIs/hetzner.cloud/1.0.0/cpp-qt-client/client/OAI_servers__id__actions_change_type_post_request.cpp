...
OAI_servers__id__actions_change_type_post_request::OAI_servers__id__actions_change_type_post_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAI_servers__id__actions_change_type_post_request::OAI_servers__id__actions_change_type_post_request() {
    this->initializeModel();
}

OAI_servers__id__actions_change_type_post_request::~OAI_servers__id__actions_change_type_post_request() {}

void OAI_servers__id__actions_change_type_post_request::initializeModel() {

    m_server_type_isSet = false;
    m_server_type_isValid = false;

    m_upgrade_disk_isSet = false;
    m_upgrade_disk_isValid = false;
}

void OAI_servers__id__actions_change_type_post_request::fromJson(QString jsonString) {
...
void OAI_servers__id__actions_change_type_post_request::fromJsonObject(QJsonObject json) {
    ...
    m_upgrade_disk_isValid = ::OpenAPI::fromJsonValue(m_upgrade_disk, json[QString("upgrade_disk")]);
    m_upgrade_disk_isSet = !json[QString("upgrade_disk")].isNull() && m_upgrade_disk_isValid;
}

QString OAI_servers__id__actions_change_type_post_request::asJson() const {
...
QJsonObject OAI_servers__id__actions_change_type_post_request::asJsonObject() const {
    QJsonObject obj;
    if (m_server_type_isSet) {
        obj.insert(QString("server_type"), ::OpenAPI::toJsonValue(m_server_type));
    }
    if (m_upgrade_disk_isSet) {
        obj.insert(QString("upgrade_disk"), ::OpenAPI::toJsonValue(m_upgrade_disk));
    }
    return obj;
}

QString OAI_servers__id__actions_change_type_post_request::getServerType() const {
    return m_server_type;
}
void OAI_servers__id__actions_change_type_post_request::setServerType(const QString &server_type) {
    m_server_type = server_type;
    m_server_type_isSet = true;
}

bool OAI_servers__id__actions_change_type_post_request::is_server_type_Set() const{
    return m_server_type_isSet;
}

bool OAI_servers__id__actions_change_type_post_request::is_server_type_Valid() const{
    return m_server_type_isValid;
}

bool OAI_servers__id__actions_change_type_post_request::isUpgradeDisk() const {
    return m_upgrade_disk;
}
void OAI_servers__id__actions_change_type_post_request::setUpgradeDisk(const bool &upgrade_disk) {
    m_upgrade_disk = upgrade_disk;
    m_upgrade_disk_isSet = true;
}

bool OAI_servers__id__actions_change_type_post_request::is_upgrade_disk_Set() const{
    return m_upgrade_disk_isSet;
}

bool OAI_servers__id__actions_change_type_post_request::is_upgrade_disk_Valid() const{
    return m_upgrade_disk_isValid;
}

bool OAI_servers__id__actions_change_type_post_request::isSet() const {
...
bool OAI_servers__id__actions_change_type_post_request::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_server_type_isValid && m_upgrade_disk_isValid && true;
}
