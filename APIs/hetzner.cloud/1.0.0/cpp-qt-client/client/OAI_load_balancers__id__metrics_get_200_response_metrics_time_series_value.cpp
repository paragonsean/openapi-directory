...
OAI_load_balancers__id__metrics_get_200_response_metrics_time_series_value::OAI_load_balancers__id__metrics_get_200_response_metrics_time_series_value(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAI_load_balancers__id__metrics_get_200_response_metrics_time_series_value::OAI_load_balancers__id__metrics_get_200_response_metrics_time_series_value() {
    this->initializeModel();
}

OAI_load_balancers__id__metrics_get_200_response_metrics_time_series_value::~OAI_load_balancers__id__metrics_get_200_response_metrics_time_series_value() {}

void OAI_load_balancers__id__metrics_get_200_response_metrics_time_series_value::initializeModel() {

    m_values_isSet = false;
    m_values_isValid = false;
}

void OAI_load_balancers__id__metrics_get_200_response_metrics_time_series_value::fromJson(QString jsonString) {
...
void OAI_load_balancers__id__metrics_get_200_response_metrics_time_series_value::fromJsonObject(QJsonObject json) {
    ...
    if(json["values"].isArray()){
        ...
        if(arr.count() > 0) {
            for (const QJsonValue jval : arr) {
                QList<OAI_load_balancers__id__metrics_get_200_response_metrics_time_series_value_values_inner_inner> item;
...
QString OAI_load_balancers__id__metrics_get_200_response_metrics_time_series_value::asJson() const {
...
QJsonObject OAI_load_balancers__id__metrics_get_200_response_metrics_time_series_value::asJsonObject() const {
    QJsonObject obj;
    if (m_values.size() > 0) {
...
QList<QList<OAI_load_balancers__id__metrics_get_200_response_metrics_time_series_value_values_inner_inner>> OAI_load_balancers__id__metrics_get_200_response_metrics_time_series_value::getValues() const {
    return m_values;
}
void OAI_load_balancers__id__metrics_get_200_response_metrics_time_series_value::setValues(const QList<QList<OAI_load_balancers__id__metrics_get_200_response_metrics_time_series_value_values_inner_inner>> &values) {
    m_values = values;
    m_values_isSet = true;
}

bool OAI_load_balancers__id__metrics_get_200_response_metrics_time_series_value::is_values_Set() const{
    return m_values_isSet;
}

bool OAI_load_balancers__id__metrics_get_200_response_metrics_time_series_value::is_values_Valid() const{
    return m_values_isValid;
}

bool OAI_load_balancers__id__metrics_get_200_response_metrics_time_series_value::isSet() const {
...
bool OAI_load_balancers__id__metrics_get_200_response_metrics_time_series_value::isValid() const {
