...
#ifndef OAI_OAILoadBalancerTypesApi_H
#define OAI_OAILoadBalancerTypesApi_H
...
#include "OAI_load_balancer_types__id__get_200_response.h"
#include "OAI_load_balancer_types_get_200_response.h"
#include <QString>
...
class OAILoadBalancerTypesApi : public QObject {
    Q_OBJECT

public:
    OAILoadBalancerTypesApi(const int timeOut = 0);
    ~OAILoadBalancerTypesApi();
    ...
    */
    virtual void loadBalancerTypesGet(const ::OpenAPI::OptionalParam<QString> &name = ::OpenAPI::OptionalParam<QString>());

    /**
    * @param[in]  id qint32 [required]
    */
    virtual void loadBalancerTypesIdGet(const qint32 &id);
...
private:
    ...
    void loadBalancerTypesGetCallback(OAIHttpRequestWorker *worker);
    void loadBalancerTypesIdGetCallback(OAIHttpRequestWorker *worker);

Q_SIGNALS:

    void loadBalancerTypesGetSignal(OAI_load_balancer_types_get_200_response summary);
    void loadBalancerTypesIdGetSignal(OAI_load_balancer_types__id__get_200_response summary);


    void loadBalancerTypesGetSignalFull(OAIHttpRequestWorker *worker, OAI_load_balancer_types_get_200_response summary);
    void loadBalancerTypesIdGetSignalFull(OAIHttpRequestWorker *worker, OAI_load_balancer_types__id__get_200_response summary);

    Q_DECL_DEPRECATED_X("Use loadBalancerTypesGetSignalError() instead")
    void loadBalancerTypesGetSignalE(OAI_load_balancer_types_get_200_response summary, QNetworkReply::NetworkError error_type, QString error_str);
    void loadBalancerTypesGetSignalError(OAI_load_balancer_types_get_200_response summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use loadBalancerTypesIdGetSignalError() instead")
    void loadBalancerTypesIdGetSignalE(OAI_load_balancer_types__id__get_200_response summary, QNetworkReply::NetworkError error_type, QString error_str);
    void loadBalancerTypesIdGetSignalError(OAI_load_balancer_types__id__get_200_response summary, QNetworkReply::NetworkError error_type, const QString &error_str);

    Q_DECL_DEPRECATED_X("Use loadBalancerTypesGetSignalErrorFull() instead")
    void loadBalancerTypesGetSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void loadBalancerTypesGetSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use loadBalancerTypesIdGetSignalErrorFull() instead")
    void loadBalancerTypesIdGetSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void loadBalancerTypesIdGetSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
