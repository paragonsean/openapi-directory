...
OAIAddTargetRequest::OAIAddTargetRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAddTargetRequest::OAIAddTargetRequest() {
    this->initializeModel();
}

OAIAddTargetRequest::~OAIAddTargetRequest() {}

void OAIAddTargetRequest::initializeModel() {

    m_ip_isSet = false;
    m_ip_isValid = false;

    m_label_selector_isSet = false;
    m_label_selector_isValid = false;
    ...
    m_use_private_ip_isSet = false;
    m_use_private_ip_isValid = false;
}

void OAIAddTargetRequest::fromJson(QString jsonString) {
...
void OAIAddTargetRequest::fromJsonObject(QJsonObject json) {

    m_ip_isValid = ::OpenAPI::fromJsonValue(m_ip, json[QString("ip")]);
    m_ip_isSet = !json[QString("ip")].isNull() && m_ip_isValid;

    m_label_selector_isValid = ::OpenAPI::fromJsonValue(m_label_selector, json[QString("label_selector")]);
    m_label_selector_isSet = !json[QString("label_selector")].isNull() && m_label_selector_isValid;
    ...
    m_use_private_ip_isValid = ::OpenAPI::fromJsonValue(m_use_private_ip, json[QString("use_private_ip")]);
    m_use_private_ip_isSet = !json[QString("use_private_ip")].isNull() && m_use_private_ip_isValid;
}

QString OAIAddTargetRequest::asJson() const {
...
QJsonObject OAIAddTargetRequest::asJsonObject() const {
    QJsonObject obj;
    if (m_ip.isSet()) {
        obj.insert(QString("ip"), ::OpenAPI::toJsonValue(m_ip));
    }
    if (m_label_selector.isSet()) {
        obj.insert(QString("label_selector"), ::OpenAPI::toJsonValue(m_label_selector));
    }
    if (m_server.isSet()) {
    ...
    if (m_use_private_ip_isSet) {
        obj.insert(QString("use_private_ip"), ::OpenAPI::toJsonValue(m_use_private_ip));
    }
    return obj;
}

OAILoadBalancerTargetIP OAIAddTargetRequest::getIp() const {
    return m_ip;
}
void OAIAddTargetRequest::setIp(const OAILoadBalancerTargetIP &ip) {
    m_ip = ip;
    m_ip_isSet = true;
}

bool OAIAddTargetRequest::is_ip_Set() const{
    return m_ip_isSet;
}

bool OAIAddTargetRequest::is_ip_Valid() const{
    return m_ip_isValid;
}

OAIAddTargetRequest_label_selector OAIAddTargetRequest::getLabelSelector() const {
    return m_label_selector;
}
void OAIAddTargetRequest::setLabelSelector(const OAIAddTargetRequest_label_selector &label_selector) {
    m_label_selector = label_selector;
    m_label_selector_isSet = true;
}

bool OAIAddTargetRequest::is_label_selector_Set() const{
    return m_label_selector_isSet;
}

bool OAIAddTargetRequest::is_label_selector_Valid() const{
    return m_label_selector_isValid;
}

OAIAddTargetRequest_server OAIAddTargetRequest::getServer() const {
    return m_server;
}
void OAIAddTargetRequest::setServer(const OAIAddTargetRequest_server &server) {
    m_server = server;
    m_server_isSet = true;
}

bool OAIAddTargetRequest::is_server_Set() const{
    return m_server_isSet;
}

bool OAIAddTargetRequest::is_server_Valid() const{
    return m_server_isValid;
}

QString OAIAddTargetRequest::getType() const {
    return m_type;
}
void OAIAddTargetRequest::setType(const QString &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAIAddTargetRequest::is_type_Set() const{
    return m_type_isSet;
}

bool OAIAddTargetRequest::is_type_Valid() const{
    return m_type_isValid;
}

bool OAIAddTargetRequest::isUsePrivateIp() const {
    return m_use_private_ip;
}
void OAIAddTargetRequest::setUsePrivateIp(const bool &use_private_ip) {
    m_use_private_ip = use_private_ip;
    m_use_private_ip_isSet = true;
}

bool OAIAddTargetRequest::is_use_private_ip_Set() const{
    return m_use_private_ip_isSet;
}

bool OAIAddTargetRequest::is_use_private_ip_Valid() const{
    return m_use_private_ip_isValid;
}

bool OAIAddTargetRequest::isSet() const {
...
bool OAIAddTargetRequest::isValid() const {
