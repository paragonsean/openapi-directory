...
OAI_load_balancer_types__id__get_200_response::OAI_load_balancer_types__id__get_200_response(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAI_load_balancer_types__id__get_200_response::OAI_load_balancer_types__id__get_200_response() {
    this->initializeModel();
}

OAI_load_balancer_types__id__get_200_response::~OAI_load_balancer_types__id__get_200_response() {}

void OAI_load_balancer_types__id__get_200_response::initializeModel() {

    m_load_balancer_type_isSet = false;
    m_load_balancer_type_isValid = false;
}

void OAI_load_balancer_types__id__get_200_response::fromJson(QString jsonString) {
...
void OAI_load_balancer_types__id__get_200_response::fromJsonObject(QJsonObject json) {

    m_load_balancer_type_isValid = ::OpenAPI::fromJsonValue(m_load_balancer_type, json[QString("load_balancer_type")]);
    m_load_balancer_type_isSet = !json[QString("load_balancer_type")].isNull() && m_load_balancer_type_isValid;
}

QString OAI_load_balancer_types__id__get_200_response::asJson() const {
...
QJsonObject OAI_load_balancer_types__id__get_200_response::asJsonObject() const {
    QJsonObject obj;
    if (m_load_balancer_type.isSet()) {
        obj.insert(QString("load_balancer_type"), ::OpenAPI::toJsonValue(m_load_balancer_type));
    }
    return obj;
}

OAI_load_balancer_types_get_200_response_load_balancer_types_inner OAI_load_balancer_types__id__get_200_response::getLoadBalancerType() const {
    return m_load_balancer_type;
}
void OAI_load_balancer_types__id__get_200_response::setLoadBalancerType(const OAI_load_balancer_types_get_200_response_load_balancer_types_inner &load_balancer_type) {
    m_load_balancer_type = load_balancer_type;
    m_load_balancer_type_isSet = true;
}

bool OAI_load_balancer_types__id__get_200_response::is_load_balancer_type_Set() const{
    return m_load_balancer_type_isSet;
}

bool OAI_load_balancer_types__id__get_200_response::is_load_balancer_type_Valid() const{
    return m_load_balancer_type_isValid;
}

bool OAI_load_balancer_types__id__get_200_response::isSet() const {
...
bool OAI_load_balancer_types__id__get_200_response::isValid() const {
