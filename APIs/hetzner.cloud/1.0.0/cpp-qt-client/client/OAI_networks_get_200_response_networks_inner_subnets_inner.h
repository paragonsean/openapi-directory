...
/*
 * OAI_networks_get_200_response_networks_inner_subnets_inner.h
 *
 * 
 */

#ifndef OAI_networks_get_200_response_networks_inner_subnets_inner_H
#define OAI_networks_get_200_response_networks_inner_subnets_inner_H
...
class OAI_networks_get_200_response_networks_inner_subnets_inner : public OAIObject {
public:
    OAI_networks_get_200_response_networks_inner_subnets_inner();
    OAI_networks_get_200_response_networks_inner_subnets_inner(QString json);
    ~OAI_networks_get_200_response_networks_inner_subnets_inner() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAI_networks_get_200_response_networks_inner_subnets_inner)

#endif // OAI_networks_get_200_response_networks_inner_subnets_inner_H
