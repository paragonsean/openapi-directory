...
/*
 * OAILoadBalancerTargetTarget.h
 *
 * 
 */

#ifndef OAILoadBalancerTargetTarget_H
#define OAILoadBalancerTargetTarget_H
...
class OAILoadBalancerTargetTarget : public OAIObject {
public:
    OAILoadBalancerTargetTarget();
    OAILoadBalancerTargetTarget(QString json);
    ~OAILoadBalancerTargetTarget() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILoadBalancerTargetTarget)

#endif // OAILoadBalancerTargetTarget_H
