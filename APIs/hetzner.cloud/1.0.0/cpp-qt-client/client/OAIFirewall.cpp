...
QList<OAIFirewall_applied_to_inner> OAIFirewall::getAppliedTo() const {
    return m_applied_to;
}
void OAIFirewall::setAppliedTo(const QList<OAIFirewall_applied_to_inner> &applied_to) {
    m_applied_to = applied_to;
    m_applied_to_isSet = true;
}

bool OAIFirewall::is_applied_to_Set() const{
    return m_applied_to_isSet;
}

bool OAIFirewall::is_applied_to_Valid() const{
    return m_applied_to_isValid;
}

QString OAIFirewall::getCreated() const {
    return m_created;
}
void OAIFirewall::setCreated(const QString &created) {
    m_created = created;
...
QMap<QString, QString> OAIFirewall::getLabels() const {
    return m_labels;
}
void OAIFirewall::setLabels(const QMap<QString, QString> &labels) {
    m_labels = labels;
    m_labels_isSet = true;
}

bool OAIFirewall::is_labels_Set() const{
    return m_labels_isSet;
}

bool OAIFirewall::is_labels_Valid() const{
    return m_labels_isValid;
}

QString OAIFirewall::getName() const {
    return m_name;
}
void OAIFirewall::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIFirewall::is_name_Set() const{
    return m_name_isSet;
}

bool OAIFirewall::is_name_Valid() const{
    return m_name_isValid;
}

QList<OAIRule> OAIFirewall::getRules() const {
    return m_rules;
}
void OAIFirewall::setRules(const QList<OAIRule> &rules) {
    m_rules = rules;
    m_rules_isSet = true;
}
...
bool OAIFirewall::isValid() const {
    ...
    return m_applied_to_isValid && m_created_isValid && m_id_isValid && m_name_isValid && m_rules_isValid && true;
}
