...
OAI_servers__id__actions_change_alias_ips_post_request::OAI_servers__id__actions_change_alias_ips_post_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAI_servers__id__actions_change_alias_ips_post_request::OAI_servers__id__actions_change_alias_ips_post_request() {
    this->initializeModel();
}

OAI_servers__id__actions_change_alias_ips_post_request::~OAI_servers__id__actions_change_alias_ips_post_request() {}

void OAI_servers__id__actions_change_alias_ips_post_request::initializeModel() {
...
void OAI_servers__id__actions_change_alias_ips_post_request::fromJson(QString jsonString) {
...
void OAI_servers__id__actions_change_alias_ips_post_request::fromJsonObject(QJsonObject json) {
...
QString OAI_servers__id__actions_change_alias_ips_post_request::asJson() const {
...
QJsonObject OAI_servers__id__actions_change_alias_ips_post_request::asJsonObject() const {
    QJsonObject obj;
...
QList<QString> OAI_servers__id__actions_change_alias_ips_post_request::getAliasIps() const {
    return m_alias_ips;
}
void OAI_servers__id__actions_change_alias_ips_post_request::setAliasIps(const QList<QString> &alias_ips) {
    m_alias_ips = alias_ips;
    m_alias_ips_isSet = true;
}

bool OAI_servers__id__actions_change_alias_ips_post_request::is_alias_ips_Set() const{
    return m_alias_ips_isSet;
}

bool OAI_servers__id__actions_change_alias_ips_post_request::is_alias_ips_Valid() const{
    return m_alias_ips_isValid;
}

qint32 OAI_servers__id__actions_change_alias_ips_post_request::getNetwork() const {
    return m_network;
}
void OAI_servers__id__actions_change_alias_ips_post_request::setNetwork(const qint32 &network) {
    m_network = network;
    m_network_isSet = true;
}

bool OAI_servers__id__actions_change_alias_ips_post_request::is_network_Set() const{
    return m_network_isSet;
}

bool OAI_servers__id__actions_change_alias_ips_post_request::is_network_Valid() const{
    return m_network_isValid;
}

bool OAI_servers__id__actions_change_alias_ips_post_request::isSet() const {
...
bool OAI_servers__id__actions_change_alias_ips_post_request::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_alias_ips_isValid && m_network_isValid && true;
}
