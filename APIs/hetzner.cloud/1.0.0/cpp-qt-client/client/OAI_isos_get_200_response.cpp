...
#include "OAI_isos_get_200_response.h"
...
OAI_isos_get_200_response::OAI_isos_get_200_response(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAI_isos_get_200_response::OAI_isos_get_200_response() {
    this->initializeModel();
}

OAI_isos_get_200_response::~OAI_isos_get_200_response() {}

void OAI_isos_get_200_response::initializeModel() {

    m_isos_isSet = false;
    m_isos_isValid = false;

    m_meta_isSet = false;
    m_meta_isValid = false;
}

void OAI_isos_get_200_response::fromJson(QString jsonString) {
...
void OAI_isos_get_200_response::fromJsonObject(QJsonObject json) {

    m_isos_isValid = ::OpenAPI::fromJsonValue(m_isos, json[QString("isos")]);
    m_isos_isSet = !json[QString("isos")].isNull() && m_isos_isValid;

    m_meta_isValid = ::OpenAPI::fromJsonValue(m_meta, json[QString("meta")]);
    m_meta_isSet = !json[QString("meta")].isNull() && m_meta_isValid;
}

QString OAI_isos_get_200_response::asJson() const {
...
QJsonObject OAI_isos_get_200_response::asJsonObject() const {
    QJsonObject obj;
    if (m_isos.size() > 0) {
        obj.insert(QString("isos"), ::OpenAPI::toJsonValue(m_isos));
    }
    if (m_meta.isSet()) {
...
QList<OAI_isos_get_200_response_isos_inner> OAI_isos_get_200_response::getIsos() const {
    return m_isos;
}
void OAI_isos_get_200_response::setIsos(const QList<OAI_isos_get_200_response_isos_inner> &isos) {
    m_isos = isos;
    m_isos_isSet = true;
}

bool OAI_isos_get_200_response::is_isos_Set() const{
    return m_isos_isSet;
}

bool OAI_isos_get_200_response::is_isos_Valid() const{
    return m_isos_isValid;
}

OAIActionsResponse_meta OAI_isos_get_200_response::getMeta() const {
    return m_meta;
}
void OAI_isos_get_200_response::setMeta(const OAIActionsResponse_meta &meta) {
    m_meta = meta;
    m_meta_isSet = true;
}

bool OAI_isos_get_200_response::is_meta_Set() const{
    return m_meta_isSet;
}

bool OAI_isos_get_200_response::is_meta_Valid() const{
    return m_meta_isValid;
}

bool OAI_isos_get_200_response::isSet() const {
...
bool OAI_isos_get_200_response::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_isos_isValid && true;
}
