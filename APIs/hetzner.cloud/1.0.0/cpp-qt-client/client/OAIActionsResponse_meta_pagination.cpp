...
#include "OAIActionsResponse_meta_pagination.h"
...
OAIActionsResponse_meta_pagination::OAIActionsResponse_meta_pagination(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIActionsResponse_meta_pagination::OAIActionsResponse_meta_pagination() {
    this->initializeModel();
}

OAIActionsResponse_meta_pagination::~OAIActionsResponse_meta_pagination() {}

void OAIActionsResponse_meta_pagination::initializeModel() {
...
void OAIActionsResponse_meta_pagination::fromJson(QString jsonString) {
...
void OAIActionsResponse_meta_pagination::fromJsonObject(QJsonObject json) {
    ...
    m_previous_page_isValid = ::OpenAPI::fromJsonValue(m_previous_page, json[QString("previous_page")]);
    m_previous_page_isSet = !json[QString("previous_page")].isNull() && m_previous_page_isValid;
...
QString OAIActionsResponse_meta_pagination::asJson() const {
...
QJsonObject OAIActionsResponse_meta_pagination::asJsonObject() const {
    QJsonObject obj;
    ...
    if (m_previous_page_isSet) {
        obj.insert(QString("previous_page"), ::OpenAPI::toJsonValue(m_previous_page));
    }
...
double OAIActionsResponse_meta_pagination::getLastPage() const {
    return m_last_page;
}
void OAIActionsResponse_meta_pagination::setLastPage(const double &last_page) {
    m_last_page = last_page;
    m_last_page_isSet = true;
}

bool OAIActionsResponse_meta_pagination::is_last_page_Set() const{
    return m_last_page_isSet;
}

bool OAIActionsResponse_meta_pagination::is_last_page_Valid() const{
    return m_last_page_isValid;
}

double OAIActionsResponse_meta_pagination::getNextPage() const {
    return m_next_page;
}
void OAIActionsResponse_meta_pagination::setNextPage(const double &next_page) {
    m_next_page = next_page;
    m_next_page_isSet = true;
}

bool OAIActionsResponse_meta_pagination::is_next_page_Set() const{
    return m_next_page_isSet;
}

bool OAIActionsResponse_meta_pagination::is_next_page_Valid() const{
    return m_next_page_isValid;
}

double OAIActionsResponse_meta_pagination::getPage() const {
    return m_page;
}
void OAIActionsResponse_meta_pagination::setPage(const double &page) {
    m_page = page;
    m_page_isSet = true;
}

bool OAIActionsResponse_meta_pagination::is_page_Set() const{
    return m_page_isSet;
}

bool OAIActionsResponse_meta_pagination::is_page_Valid() const{
    return m_page_isValid;
}

double OAIActionsResponse_meta_pagination::getPerPage() const {
    return m_per_page;
}
void OAIActionsResponse_meta_pagination::setPerPage(const double &per_page) {
    m_per_page = per_page;
    m_per_page_isSet = true;
}

bool OAIActionsResponse_meta_pagination::is_per_page_Set() const{
    return m_per_page_isSet;
}

bool OAIActionsResponse_meta_pagination::is_per_page_Valid() const{
    return m_per_page_isValid;
}

double OAIActionsResponse_meta_pagination::getPreviousPage() const {
    return m_previous_page;
}
void OAIActionsResponse_meta_pagination::setPreviousPage(const double &previous_page) {
    m_previous_page = previous_page;
    m_previous_page_isSet = true;
}

bool OAIActionsResponse_meta_pagination::is_previous_page_Set() const{
    return m_previous_page_isSet;
}

bool OAIActionsResponse_meta_pagination::is_previous_page_Valid() const{
    return m_previous_page_isValid;
}

double OAIActionsResponse_meta_pagination::getTotalEntries() const {
    return m_total_entries;
}
void OAIActionsResponse_meta_pagination::setTotalEntries(const double &total_entries) {
    m_total_entries = total_entries;
    m_total_entries_isSet = true;
}

bool OAIActionsResponse_meta_pagination::is_total_entries_Set() const{
    return m_total_entries_isSet;
}

bool OAIActionsResponse_meta_pagination::is_total_entries_Valid() const{
    return m_total_entries_isValid;
}

bool OAIActionsResponse_meta_pagination::isSet() const {
...
bool OAIActionsResponse_meta_pagination::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_last_page_isValid && m_next_page_isValid && m_page_isValid && m_per_page_isValid && m_previous_page_isValid && m_total_entries_isValid && true;
}
