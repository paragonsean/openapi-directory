...
#include "OAIFirewall_applied_to_inner_applied_to_resources_inner_server.h"
...
OAIFirewall_applied_to_inner_applied_to_resources_inner_server::OAIFirewall_applied_to_inner_applied_to_resources_inner_server(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIFirewall_applied_to_inner_applied_to_resources_inner_server::OAIFirewall_applied_to_inner_applied_to_resources_inner_server() {
    this->initializeModel();
}

OAIFirewall_applied_to_inner_applied_to_resources_inner_server::~OAIFirewall_applied_to_inner_applied_to_resources_inner_server() {}

void OAIFirewall_applied_to_inner_applied_to_resources_inner_server::initializeModel() {

    m_id_isSet = false;
    m_id_isValid = false;
}

void OAIFirewall_applied_to_inner_applied_to_resources_inner_server::fromJson(QString jsonString) {
...
void OAIFirewall_applied_to_inner_applied_to_resources_inner_server::fromJsonObject(QJsonObject json) {

    m_id_isValid = ::OpenAPI::fromJsonValue(m_id, json[QString("id")]);
    m_id_isSet = !json[QString("id")].isNull() && m_id_isValid;
}

QString OAIFirewall_applied_to_inner_applied_to_resources_inner_server::asJson() const {
...
QJsonObject OAIFirewall_applied_to_inner_applied_to_resources_inner_server::asJsonObject() const {
    QJsonObject obj;
    if (m_id_isSet) {
...
qint32 OAIFirewall_applied_to_inner_applied_to_resources_inner_server::getId() const {
    return m_id;
}
void OAIFirewall_applied_to_inner_applied_to_resources_inner_server::setId(const qint32 &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIFirewall_applied_to_inner_applied_to_resources_inner_server::is_id_Set() const{
    return m_id_isSet;
}

bool OAIFirewall_applied_to_inner_applied_to_resources_inner_server::is_id_Valid() const{
    return m_id_isValid;
}

bool OAIFirewall_applied_to_inner_applied_to_resources_inner_server::isSet() const {
...
bool OAIFirewall_applied_to_inner_applied_to_resources_inner_server::isValid() const {
