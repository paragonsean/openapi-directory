...
void OAICertificate::initializeModel() {
    ...
    m_used_by_isSet = false;
    m_used_by_isValid = false;
}
...
void OAICertificate::fromJsonObject(QJsonObject json) {
    ...
    m_not_valid_after_isValid = ::OpenAPI::fromJsonValue(m_not_valid_after, json[QString("not_valid_after")]);
    m_not_valid_after_isSet = !json[QString("not_valid_after")].isNull() && m_not_valid_after_isValid;

    m_not_valid_before_isValid = ::OpenAPI::fromJsonValue(m_not_valid_before, json[QString("not_valid_before")]);
    m_not_valid_before_isSet = !json[QString("not_valid_before")].isNull() && m_not_valid_before_isValid;
    ...
    m_used_by_isValid = ::OpenAPI::fromJsonValue(m_used_by, json[QString("used_by")]);
    m_used_by_isSet = !json[QString("used_by")].isNull() && m_used_by_isValid;
}
...
QJsonObject OAICertificate::asJsonObject() const {
    ...
    if (m_not_valid_after_isSet) {
        obj.insert(QString("not_valid_after"), ::OpenAPI::toJsonValue(m_not_valid_after));
    }
    if (m_not_valid_before_isSet) {
        obj.insert(QString("not_valid_before"), ::OpenAPI::toJsonValue(m_not_valid_before));
    }
    if (m_status.isSet()) {
    ...
    if (m_used_by.size() > 0) {
        obj.insert(QString("used_by"), ::OpenAPI::toJsonValue(m_used_by));
    }
    return obj;
}

QString OAICertificate::getCertificate() const {
    return m_certificate;
}
void OAICertificate::setCertificate(const QString &certificate) {
    m_certificate = certificate;
    m_certificate_isSet = true;
}

bool OAICertificate::is_certificate_Set() const{
    return m_certificate_isSet;
}

bool OAICertificate::is_certificate_Valid() const{
    return m_certificate_isValid;
}

QString OAICertificate::getCreated() const {
    return m_created;
}
void OAICertificate::setCreated(const QString &created) {
    m_created = created;
    m_created_isSet = true;
}

bool OAICertificate::is_created_Set() const{
    return m_created_isSet;
}

bool OAICertificate::is_created_Valid() const{
    return m_created_isValid;
}

QList<QString> OAICertificate::getDomainNames() const {
    return m_domain_names;
}
void OAICertificate::setDomainNames(const QList<QString> &domain_names) {
    m_domain_names = domain_names;
    m_domain_names_isSet = true;
}

bool OAICertificate::is_domain_names_Set() const{
    return m_domain_names_isSet;
}

bool OAICertificate::is_domain_names_Valid() const{
    return m_domain_names_isValid;
}

QString OAICertificate::getFingerprint() const {
    return m_fingerprint;
}
void OAICertificate::setFingerprint(const QString &fingerprint) {
    m_fingerprint = fingerprint;
    m_fingerprint_isSet = true;
}

bool OAICertificate::is_fingerprint_Set() const{
    return m_fingerprint_isSet;
}

bool OAICertificate::is_fingerprint_Valid() const{
    return m_fingerprint_isValid;
}

qint32 OAICertificate::getId() const {
    return m_id;
}
void OAICertificate::setId(const qint32 &id) {
    m_id = id;
    m_id_isSet = true;
}
...
QString OAICertificate::getNotValidAfter() const {
    return m_not_valid_after;
}
void OAICertificate::setNotValidAfter(const QString &not_valid_after) {
    m_not_valid_after = not_valid_after;
    m_not_valid_after_isSet = true;
}

bool OAICertificate::is_not_valid_after_Set() const{
    return m_not_valid_after_isSet;
}

bool OAICertificate::is_not_valid_after_Valid() const{
    return m_not_valid_after_isValid;
}

QString OAICertificate::getNotValidBefore() const {
    return m_not_valid_before;
}
void OAICertificate::setNotValidBefore(const QString &not_valid_before) {
    m_not_valid_before = not_valid_before;
    m_not_valid_before_isSet = true;
}

bool OAICertificate::is_not_valid_before_Set() const{
    return m_not_valid_before_isSet;
}

bool OAICertificate::is_not_valid_before_Valid() const{
    return m_not_valid_before_isValid;
}

OAICertificate_status OAICertificate::getStatus() const {
    return m_status;
}
void OAICertificate::setStatus(const OAICertificate_status &status) {
    m_status = status;
    m_status_isSet = true;
}
...
QList<OAICertificate_used_by_inner> OAICertificate::getUsedBy() const {
    return m_used_by;
}
void OAICertificate::setUsedBy(const QList<OAICertificate_used_by_inner> &used_by) {
    m_used_by = used_by;
    m_used_by_isSet = true;
}

bool OAICertificate::is_used_by_Set() const{
    return m_used_by_isSet;
}

bool OAICertificate::is_used_by_Valid() const{
    return m_used_by_isValid;
}
...
bool OAICertificate::isValid() const {
    ...
    return m_certificate_isValid && m_created_isValid && m_domain_names_isValid && m_fingerprint_isValid && m_id_isValid && m_labels_isValid && m_name_isValid && m_not_valid_after_isValid && m_not_valid_before_isValid && m_used_by_isValid && true;
}
