...
/*
 * OAICreateLoadBalancerRequest.h
 *
 * 
 */

#ifndef OAICreateLoadBalancerRequest_H
#define OAICreateLoadBalancerRequest_H

#include <QJsonObject>

#include "OAICreateLoadBalancerRequest_labels.h"
...
namespace OpenAPI {
class OAILoadBalancerAlgorithm;
class OAICreateLoadBalancerRequest_labels;
class OAILoadBalancerService;
class OAILoadBalancerTarget;

class OAICreateLoadBalancerRequest : public OAIObject {
public:
    OAICreateLoadBalancerRequest();
    OAICreateLoadBalancerRequest(QString json);
    ~OAICreateLoadBalancerRequest() override;
    ...
    OAILoadBalancerAlgorithm getAlgorithm() const;
    void setAlgorithm(const OAILoadBalancerAlgorithm &algorithm);
    bool is_algorithm_Set() const;
    bool is_algorithm_Valid() const;

    OAICreateLoadBalancerRequest_labels getLabels() const;
    void setLabels(const OAICreateLoadBalancerRequest_labels &labels);
    ...
    qint32 getNetwork() const;
    void setNetwork(const qint32 &network);
    ...
    void setPublicInterface(const bool &public_interface);
    bool is_public_interface_Set() const;
    bool is_public_interface_Valid() const;
...
private:
    ...
    OAILoadBalancerAlgorithm m_algorithm;
    bool m_algorithm_isSet;
    bool m_algorithm_isValid;

    OAICreateLoadBalancerRequest_labels m_labels;
    bool m_labels_isSet;
    ...
    bool m_public_interface;
    bool m_public_interface_isSet;
    bool m_public_interface_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateLoadBalancerRequest)

#endif // OAICreateLoadBalancerRequest_H
