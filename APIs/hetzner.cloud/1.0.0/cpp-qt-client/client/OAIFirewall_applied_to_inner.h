...
/*
 * OAIFirewall_applied_to_inner.h
 *
 * 
 */

#ifndef OAIFirewall_applied_to_inner_H
#define OAIFirewall_applied_to_inner_H
...
namespace OpenAPI {
class OAIFirewall_applied_to_inner_applied_to_resources_inner;
class OAIFirewall_applied_to_inner_label_selector;
class OAIFirewall_applied_to_inner_applied_to_resources_inner_server;

class OAIFirewall_applied_to_inner : public OAIObject {
public:
    OAIFirewall_applied_to_inner();
    OAIFirewall_applied_to_inner(QString json);
    ~OAIFirewall_applied_to_inner() override;
    ...
    QList<OAIFirewall_applied_to_inner_applied_to_resources_inner> getAppliedToResources() const;
    void setAppliedToResources(const QList<OAIFirewall_applied_to_inner_applied_to_resources_inner> &applied_to_resources);
    bool is_applied_to_resources_Set() const;
    bool is_applied_to_resources_Valid() const;

    OAIFirewall_applied_to_inner_label_selector getLabelSelector() const;
    void setLabelSelector(const OAIFirewall_applied_to_inner_label_selector &label_selector);
    bool is_label_selector_Set() const;
    bool is_label_selector_Valid() const;

    OAIFirewall_applied_to_inner_applied_to_resources_inner_server getServer() const;
    void setServer(const OAIFirewall_applied_to_inner_applied_to_resources_inner_server &server);
...
private:
    ...
    QList<OAIFirewall_applied_to_inner_applied_to_resources_inner> m_applied_to_resources;
    bool m_applied_to_resources_isSet;
    bool m_applied_to_resources_isValid;

    OAIFirewall_applied_to_inner_label_selector m_label_selector;
    bool m_label_selector_isSet;
    bool m_label_selector_isValid;

    OAIFirewall_applied_to_inner_applied_to_resources_inner_server m_server;
    bool m_server_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFirewall_applied_to_inner)

#endif // OAIFirewall_applied_to_inner_H
