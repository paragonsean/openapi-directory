...
OAI_pricing_get_200_response_pricing_image::OAI_pricing_get_200_response_pricing_image(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAI_pricing_get_200_response_pricing_image::OAI_pricing_get_200_response_pricing_image() {
    this->initializeModel();
}

OAI_pricing_get_200_response_pricing_image::~OAI_pricing_get_200_response_pricing_image() {}

void OAI_pricing_get_200_response_pricing_image::initializeModel() {

    m_price_per_gb_month_isSet = false;
    m_price_per_gb_month_isValid = false;
}

void OAI_pricing_get_200_response_pricing_image::fromJson(QString jsonString) {
...
void OAI_pricing_get_200_response_pricing_image::fromJsonObject(QJsonObject json) {
...
QString OAI_pricing_get_200_response_pricing_image::asJson() const {
...
QJsonObject OAI_pricing_get_200_response_pricing_image::asJsonObject() const {
    QJsonObject obj;
...
OAI_pricing_get_200_response_pricing_floating_ip_price_monthly OAI_pricing_get_200_response_pricing_image::getPricePerGbMonth() const {
    return m_price_per_gb_month;
}
void OAI_pricing_get_200_response_pricing_image::setPricePerGbMonth(const OAI_pricing_get_200_response_pricing_floating_ip_price_monthly &price_per_gb_month) {
    m_price_per_gb_month = price_per_gb_month;
    m_price_per_gb_month_isSet = true;
}

bool OAI_pricing_get_200_response_pricing_image::is_price_per_gb_month_Set() const{
    return m_price_per_gb_month_isSet;
}

bool OAI_pricing_get_200_response_pricing_image::is_price_per_gb_month_Valid() const{
    return m_price_per_gb_month_isValid;
}

bool OAI_pricing_get_200_response_pricing_image::isSet() const {
...
bool OAI_pricing_get_200_response_pricing_image::isValid() const {
