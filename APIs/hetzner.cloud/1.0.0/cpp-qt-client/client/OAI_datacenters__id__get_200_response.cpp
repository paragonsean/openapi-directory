...
#include "OAI_datacenters__id__get_200_response.h"
...
OAI_datacenters__id__get_200_response::OAI_datacenters__id__get_200_response(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAI_datacenters__id__get_200_response::OAI_datacenters__id__get_200_response() {
    this->initializeModel();
}

OAI_datacenters__id__get_200_response::~OAI_datacenters__id__get_200_response() {}

void OAI_datacenters__id__get_200_response::initializeModel() {

    m_datacenter_isSet = false;
    m_datacenter_isValid = false;
}

void OAI_datacenters__id__get_200_response::fromJson(QString jsonString) {
...
void OAI_datacenters__id__get_200_response::fromJsonObject(QJsonObject json) {
...
QString OAI_datacenters__id__get_200_response::asJson() const {
...
QJsonObject OAI_datacenters__id__get_200_response::asJsonObject() const {
    QJsonObject obj;
...
OAI_datacenters_get_200_response_datacenters_inner OAI_datacenters__id__get_200_response::getDatacenter() const {
    return m_datacenter;
}
void OAI_datacenters__id__get_200_response::setDatacenter(const OAI_datacenters_get_200_response_datacenters_inner &datacenter) {
    m_datacenter = datacenter;
    m_datacenter_isSet = true;
}

bool OAI_datacenters__id__get_200_response::is_datacenter_Set() const{
    return m_datacenter_isSet;
}

bool OAI_datacenters__id__get_200_response::is_datacenter_Valid() const{
    return m_datacenter_isValid;
}

bool OAI_datacenters__id__get_200_response::isSet() const {
...
bool OAI_datacenters__id__get_200_response::isValid() const {
