...
/*
 * OAI_datacenters_get_200_response_datacenters_inner.h
 *
 * 
 */

#ifndef OAI_datacenters_get_200_response_datacenters_inner_H
#define OAI_datacenters_get_200_response_datacenters_inner_H
...
class OAI_datacenters_get_200_response_datacenters_inner : public OAIObject {
public:
    OAI_datacenters_get_200_response_datacenters_inner();
    OAI_datacenters_get_200_response_datacenters_inner(QString json);
    ~OAI_datacenters_get_200_response_datacenters_inner() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAI_datacenters_get_200_response_datacenters_inner)

#endif // OAI_datacenters_get_200_response_datacenters_inner_H
