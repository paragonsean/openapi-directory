...
OAI_volumes_post_201_response::OAI_volumes_post_201_response(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAI_volumes_post_201_response::OAI_volumes_post_201_response() {
    this->initializeModel();
}

OAI_volumes_post_201_response::~OAI_volumes_post_201_response() {}

void OAI_volumes_post_201_response::initializeModel() {

    m_action_isSet = false;
    m_action_isValid = false;

    m_next_actions_isSet = false;
    m_next_actions_isValid = false;

    m_volume_isSet = false;
    m_volume_isValid = false;
}

void OAI_volumes_post_201_response::fromJson(QString jsonString) {
...
void OAI_volumes_post_201_response::fromJsonObject(QJsonObject json) {

    m_action_isValid = ::OpenAPI::fromJsonValue(m_action, json[QString("action")]);
    m_action_isSet = !json[QString("action")].isNull() && m_action_isValid;

    m_next_actions_isValid = ::OpenAPI::fromJsonValue(m_next_actions, json[QString("next_actions")]);
    m_next_actions_isSet = !json[QString("next_actions")].isNull() && m_next_actions_isValid;
...
QString OAI_volumes_post_201_response::asJson() const {
...
QJsonObject OAI_volumes_post_201_response::asJsonObject() const {
    QJsonObject obj;
    if (m_action.isSet()) {
        obj.insert(QString("action"), ::OpenAPI::toJsonValue(m_action));
    }
    if (m_next_actions.size() > 0) {
        obj.insert(QString("next_actions"), ::OpenAPI::toJsonValue(m_next_actions));
    }
    if (m_volume.isSet()) {
...
OAIAction OAI_volumes_post_201_response::getAction() const {
    return m_action;
}
void OAI_volumes_post_201_response::setAction(const OAIAction &action) {
    m_action = action;
    m_action_isSet = true;
}

bool OAI_volumes_post_201_response::is_action_Set() const{
    return m_action_isSet;
}

bool OAI_volumes_post_201_response::is_action_Valid() const{
    return m_action_isValid;
}

QList<OAIAction> OAI_volumes_post_201_response::getNextActions() const {
    return m_next_actions;
}
void OAI_volumes_post_201_response::setNextActions(const QList<OAIAction> &next_actions) {
    m_next_actions = next_actions;
    m_next_actions_isSet = true;
}

bool OAI_volumes_post_201_response::is_next_actions_Set() const{
    return m_next_actions_isSet;
}

bool OAI_volumes_post_201_response::is_next_actions_Valid() const{
    return m_next_actions_isValid;
}

OAI_volumes_get_200_response_volumes_inner OAI_volumes_post_201_response::getVolume() const {
    return m_volume;
}
void OAI_volumes_post_201_response::setVolume(const OAI_volumes_get_200_response_volumes_inner &volume) {
    m_volume = volume;
    m_volume_isSet = true;
}

bool OAI_volumes_post_201_response::is_volume_Set() const{
    return m_volume_isSet;
}

bool OAI_volumes_post_201_response::is_volume_Valid() const{
    return m_volume_isValid;
}

bool OAI_volumes_post_201_response::isSet() const {
...
bool OAI_volumes_post_201_response::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_action_isValid && m_next_actions_isValid && m_volume_isValid && true;
}
