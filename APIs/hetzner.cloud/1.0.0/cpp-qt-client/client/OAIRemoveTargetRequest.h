...
/*
 * OAIRemoveTargetRequest.h
 *
 * 
 */

#ifndef OAIRemoveTargetRequest_H
#define OAIRemoveTargetRequest_H
...
class OAIRemoveTargetRequest : public OAIObject {
public:
    OAIRemoveTargetRequest();
    OAIRemoveTargetRequest(QString json);
    ~OAIRemoveTargetRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRemoveTargetRequest)

#endif // OAIRemoveTargetRequest_H
