...
OAIPrimaryIP_dns_ptr_inner::OAIPrimaryIP_dns_ptr_inner(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPrimaryIP_dns_ptr_inner::OAIPrimaryIP_dns_ptr_inner() {
    this->initializeModel();
}

OAIPrimaryIP_dns_ptr_inner::~OAIPrimaryIP_dns_ptr_inner() {}

void OAIPrimaryIP_dns_ptr_inner::initializeModel() {
...
void OAIPrimaryIP_dns_ptr_inner::fromJson(QString jsonString) {
...
void OAIPrimaryIP_dns_ptr_inner::fromJsonObject(QJsonObject json) {
...
QString OAIPrimaryIP_dns_ptr_inner::asJson() const {
...
QJsonObject OAIPrimaryIP_dns_ptr_inner::asJsonObject() const {
    QJsonObject obj;
    if (m_dns_ptr_isSet) {
...
QString OAIPrimaryIP_dns_ptr_inner::getDnsPtr() const {
    return m_dns_ptr;
}
void OAIPrimaryIP_dns_ptr_inner::setDnsPtr(const QString &dns_ptr) {
    m_dns_ptr = dns_ptr;
    m_dns_ptr_isSet = true;
}

bool OAIPrimaryIP_dns_ptr_inner::is_dns_ptr_Set() const{
    return m_dns_ptr_isSet;
}

bool OAIPrimaryIP_dns_ptr_inner::is_dns_ptr_Valid() const{
    return m_dns_ptr_isValid;
}

QString OAIPrimaryIP_dns_ptr_inner::getIp() const {
    return m_ip;
}
void OAIPrimaryIP_dns_ptr_inner::setIp(const QString &ip) {
    m_ip = ip;
    m_ip_isSet = true;
}

bool OAIPrimaryIP_dns_ptr_inner::is_ip_Set() const{
    return m_ip_isSet;
}

bool OAIPrimaryIP_dns_ptr_inner::is_ip_Valid() const{
    return m_ip_isValid;
}

bool OAIPrimaryIP_dns_ptr_inner::isSet() const {
...
bool OAIPrimaryIP_dns_ptr_inner::isValid() const {
