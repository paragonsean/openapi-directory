...
#include "OAI_load_balancers_get_200_response_load_balancers_inner_public_net_ipv4.h"
...
OAI_load_balancers_get_200_response_load_balancers_inner_public_net_ipv4::OAI_load_balancers_get_200_response_load_balancers_inner_public_net_ipv4(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAI_load_balancers_get_200_response_load_balancers_inner_public_net_ipv4::OAI_load_balancers_get_200_response_load_balancers_inner_public_net_ipv4() {
    this->initializeModel();
}

OAI_load_balancers_get_200_response_load_balancers_inner_public_net_ipv4::~OAI_load_balancers_get_200_response_load_balancers_inner_public_net_ipv4() {}

void OAI_load_balancers_get_200_response_load_balancers_inner_public_net_ipv4::initializeModel() {
...
void OAI_load_balancers_get_200_response_load_balancers_inner_public_net_ipv4::fromJson(QString jsonString) {
...
void OAI_load_balancers_get_200_response_load_balancers_inner_public_net_ipv4::fromJsonObject(QJsonObject json) {
...
QString OAI_load_balancers_get_200_response_load_balancers_inner_public_net_ipv4::asJson() const {
...
QJsonObject OAI_load_balancers_get_200_response_load_balancers_inner_public_net_ipv4::asJsonObject() const {
    QJsonObject obj;
    if (m_dns_ptr_isSet) {
...
QString OAI_load_balancers_get_200_response_load_balancers_inner_public_net_ipv4::getDnsPtr() const {
    return m_dns_ptr;
}
void OAI_load_balancers_get_200_response_load_balancers_inner_public_net_ipv4::setDnsPtr(const QString &dns_ptr) {
    m_dns_ptr = dns_ptr;
    m_dns_ptr_isSet = true;
}

bool OAI_load_balancers_get_200_response_load_balancers_inner_public_net_ipv4::is_dns_ptr_Set() const{
    return m_dns_ptr_isSet;
}

bool OAI_load_balancers_get_200_response_load_balancers_inner_public_net_ipv4::is_dns_ptr_Valid() const{
    return m_dns_ptr_isValid;
}

QString OAI_load_balancers_get_200_response_load_balancers_inner_public_net_ipv4::getIp() const {
    return m_ip;
}
void OAI_load_balancers_get_200_response_load_balancers_inner_public_net_ipv4::setIp(const QString &ip) {
    m_ip = ip;
    m_ip_isSet = true;
}

bool OAI_load_balancers_get_200_response_load_balancers_inner_public_net_ipv4::is_ip_Set() const{
    return m_ip_isSet;
}

bool OAI_load_balancers_get_200_response_load_balancers_inner_public_net_ipv4::is_ip_Valid() const{
    return m_ip_isValid;
}

bool OAI_load_balancers_get_200_response_load_balancers_inner_public_net_ipv4::isSet() const {
...
bool OAI_load_balancers_get_200_response_load_balancers_inner_public_net_ipv4::isValid() const {
