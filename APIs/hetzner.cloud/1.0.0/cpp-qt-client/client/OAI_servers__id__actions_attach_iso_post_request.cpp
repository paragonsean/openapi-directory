...
OAI_servers__id__actions_attach_iso_post_request::OAI_servers__id__actions_attach_iso_post_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAI_servers__id__actions_attach_iso_post_request::OAI_servers__id__actions_attach_iso_post_request() {
    this->initializeModel();
}

OAI_servers__id__actions_attach_iso_post_request::~OAI_servers__id__actions_attach_iso_post_request() {}

void OAI_servers__id__actions_attach_iso_post_request::initializeModel() {

    m_iso_isSet = false;
    m_iso_isValid = false;
}

void OAI_servers__id__actions_attach_iso_post_request::fromJson(QString jsonString) {
...
void OAI_servers__id__actions_attach_iso_post_request::fromJsonObject(QJsonObject json) {

    m_iso_isValid = ::OpenAPI::fromJsonValue(m_iso, json[QString("iso")]);
    m_iso_isSet = !json[QString("iso")].isNull() && m_iso_isValid;
}

QString OAI_servers__id__actions_attach_iso_post_request::asJson() const {
...
QJsonObject OAI_servers__id__actions_attach_iso_post_request::asJsonObject() const {
    QJsonObject obj;
    if (m_iso_isSet) {
...
QString OAI_servers__id__actions_attach_iso_post_request::getIso() const {
    return m_iso;
}
void OAI_servers__id__actions_attach_iso_post_request::setIso(const QString &iso) {
    m_iso = iso;
    m_iso_isSet = true;
}

bool OAI_servers__id__actions_attach_iso_post_request::is_iso_Set() const{
    return m_iso_isSet;
}

bool OAI_servers__id__actions_attach_iso_post_request::is_iso_Valid() const{
    return m_iso_isValid;
}

bool OAI_servers__id__actions_attach_iso_post_request::isSet() const {
...
bool OAI_servers__id__actions_attach_iso_post_request::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_iso_isValid && true;
}
