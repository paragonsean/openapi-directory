...
QList<OAICreateFirewallRequest_apply_to_inner> OAICreateFirewallRequest::getApplyTo() const {
    return m_apply_to;
}
void OAICreateFirewallRequest::setApplyTo(const QList<OAICreateFirewallRequest_apply_to_inner> &apply_to) {
    m_apply_to = apply_to;
    m_apply_to_isSet = true;
}

bool OAICreateFirewallRequest::is_apply_to_Set() const{
    return m_apply_to_isSet;
}

bool OAICreateFirewallRequest::is_apply_to_Valid() const{
    return m_apply_to_isValid;
}

OAIObject OAICreateFirewallRequest::getLabels() const {
    return m_labels;
}
void OAICreateFirewallRequest::setLabels(const OAIObject &labels) {
    m_labels = labels;
    m_labels_isSet = true;
}

bool OAICreateFirewallRequest::is_labels_Set() const{
    return m_labels_isSet;
}

bool OAICreateFirewallRequest::is_labels_Valid() const{
    return m_labels_isValid;
}

QString OAICreateFirewallRequest::getName() const {
    return m_name;
}
void OAICreateFirewallRequest::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAICreateFirewallRequest::is_name_Set() const{
    return m_name_isSet;
}

bool OAICreateFirewallRequest::is_name_Valid() const{
    return m_name_isValid;
}

QList<OAIRule> OAICreateFirewallRequest::getRules() const {
    return m_rules;
}
void OAICreateFirewallRequest::setRules(const QList<OAIRule> &rules) {
    m_rules = rules;
    m_rules_isSet = true;
}

bool OAICreateFirewallRequest::is_rules_Set() const{
    return m_rules_isSet;
}

bool OAICreateFirewallRequest::is_rules_Valid() const{
