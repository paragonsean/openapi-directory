...
void OAIPricingApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("pricingGet", defaultConf);
    _serverIndices.insert("pricingGet", 0);
}
...
void OAIPricingApi::pricingGet() {
    QString fullPath = QString(_serverConfigs["pricingGet"][_serverIndices.value("pricingGet")].URL()+"/pricing");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIPricingApi::pricingGetCallback);
...
void OAIPricingApi::pricingGetCallback(OAIHttpRequestWorker *worker) {
    ...
    OAI_pricing_get_200_response output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT pricingGetSignal(output);
        Q_EMIT pricingGetSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT pricingGetSignalE(output, error_type, error_str);
        Q_EMIT pricingGetSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT pricingGetSignalError(output, error_type, error_str);
        Q_EMIT pricingGetSignalErrorFull(worker, error_type, error_str);
    }
}
