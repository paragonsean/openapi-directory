...
/*
 * OAI_floating_ips_get_200_response_floating_ips_inner.h
 *
 * 
 */

#ifndef OAI_floating_ips_get_200_response_floating_ips_inner_H
#define OAI_floating_ips_get_200_response_floating_ips_inner_H

#include <QJsonObject>

#include "OAI_floating_ips_get_200_response_floating_ips_inner_dns_ptr_inner.h"
#include "OAI_floating_ips_get_200_response_floating_ips_inner_home_location.h"
#include "OAI_floating_ips_get_200_response_floating_ips_inner_protection.h"
#include <QList>
#include <QMap>
#include <QString>
...
namespace OpenAPI {
class OAI_floating_ips_get_200_response_floating_ips_inner_dns_ptr_inner;
class OAI_floating_ips_get_200_response_floating_ips_inner_home_location;
class OAI_floating_ips_get_200_response_floating_ips_inner_protection;

class OAI_floating_ips_get_200_response_floating_ips_inner : public OAIObject {
public:
    OAI_floating_ips_get_200_response_floating_ips_inner();
    OAI_floating_ips_get_200_response_floating_ips_inner(QString json);
    ~OAI_floating_ips_get_200_response_floating_ips_inner() override;
    ...
    QList<OAI_floating_ips_get_200_response_floating_ips_inner_dns_ptr_inner> getDnsPtr() const;
    void setDnsPtr(const QList<OAI_floating_ips_get_200_response_floating_ips_inner_dns_ptr_inner> &dns_ptr);
    bool is_dns_ptr_Set() const;
    bool is_dns_ptr_Valid() const;

    OAI_floating_ips_get_200_response_floating_ips_inner_home_location getHomeLocation() const;
    void setHomeLocation(const OAI_floating_ips_get_200_response_floating_ips_inner_home_location &home_location);
    ...
    OAI_floating_ips_get_200_response_floating_ips_inner_protection getProtection() const;
    void setProtection(const OAI_floating_ips_get_200_response_floating_ips_inner_protection &protection);
...
private:
    ...
    QList<OAI_floating_ips_get_200_response_floating_ips_inner_dns_ptr_inner> m_dns_ptr;
    bool m_dns_ptr_isSet;
    bool m_dns_ptr_isValid;

    OAI_floating_ips_get_200_response_floating_ips_inner_home_location m_home_location;
    ...
    OAI_floating_ips_get_200_response_floating_ips_inner_protection m_protection;
...
Q_DECLARE_METATYPE(OpenAPI::OAI_floating_ips_get_200_response_floating_ips_inner)

#endif // OAI_floating_ips_get_200_response_floating_ips_inner_H
