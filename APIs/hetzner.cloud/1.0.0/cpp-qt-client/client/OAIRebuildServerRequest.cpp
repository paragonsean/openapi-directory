...
OAIRebuildServerRequest::OAIRebuildServerRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIRebuildServerRequest::OAIRebuildServerRequest() {
    this->initializeModel();
}

OAIRebuildServerRequest::~OAIRebuildServerRequest() {}

void OAIRebuildServerRequest::initializeModel() {

    m_image_isSet = false;
    m_image_isValid = false;
}

void OAIRebuildServerRequest::fromJson(QString jsonString) {
...
void OAIRebuildServerRequest::fromJsonObject(QJsonObject json) {

    m_image_isValid = ::OpenAPI::fromJsonValue(m_image, json[QString("image")]);
    m_image_isSet = !json[QString("image")].isNull() && m_image_isValid;
}

QString OAIRebuildServerRequest::asJson() const {
...
QJsonObject OAIRebuildServerRequest::asJsonObject() const {
    QJsonObject obj;
    if (m_image_isSet) {
...
QString OAIRebuildServerRequest::getImage() const {
    return m_image;
}
void OAIRebuildServerRequest::setImage(const QString &image) {
    m_image = image;
    m_image_isSet = true;
}

bool OAIRebuildServerRequest::is_image_Set() const{
    return m_image_isSet;
}

bool OAIRebuildServerRequest::is_image_Valid() const{
    return m_image_isValid;
}

bool OAIRebuildServerRequest::isSet() const {
...
bool OAIRebuildServerRequest::isValid() const {
