...
OAI_servers__id__actions_change_protection_post_request::OAI_servers__id__actions_change_protection_post_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAI_servers__id__actions_change_protection_post_request::OAI_servers__id__actions_change_protection_post_request() {
    this->initializeModel();
}

OAI_servers__id__actions_change_protection_post_request::~OAI_servers__id__actions_change_protection_post_request() {}

void OAI_servers__id__actions_change_protection_post_request::initializeModel() {

    m_r_delete_isSet = false;
    m_r_delete_isValid = false;

    m_rebuild_isSet = false;
    m_rebuild_isValid = false;
}

void OAI_servers__id__actions_change_protection_post_request::fromJson(QString jsonString) {
...
void OAI_servers__id__actions_change_protection_post_request::fromJsonObject(QJsonObject json) {
    ...
    m_rebuild_isValid = ::OpenAPI::fromJsonValue(m_rebuild, json[QString("rebuild")]);
    m_rebuild_isSet = !json[QString("rebuild")].isNull() && m_rebuild_isValid;
}

QString OAI_servers__id__actions_change_protection_post_request::asJson() const {
...
QJsonObject OAI_servers__id__actions_change_protection_post_request::asJsonObject() const {
    QJsonObject obj;
    if (m_r_delete_isSet) {
        obj.insert(QString("delete"), ::OpenAPI::toJsonValue(m_r_delete));
    }
    if (m_rebuild_isSet) {
        obj.insert(QString("rebuild"), ::OpenAPI::toJsonValue(m_rebuild));
    }
    return obj;
}

bool OAI_servers__id__actions_change_protection_post_request::isRDelete() const {
    return m_r_delete;
}
void OAI_servers__id__actions_change_protection_post_request::setRDelete(const bool &r_delete) {
    m_r_delete = r_delete;
    m_r_delete_isSet = true;
}

bool OAI_servers__id__actions_change_protection_post_request::is_r_delete_Set() const{
    return m_r_delete_isSet;
}

bool OAI_servers__id__actions_change_protection_post_request::is_r_delete_Valid() const{
    return m_r_delete_isValid;
}

bool OAI_servers__id__actions_change_protection_post_request::isRebuild() const {
    return m_rebuild;
}
void OAI_servers__id__actions_change_protection_post_request::setRebuild(const bool &rebuild) {
    m_rebuild = rebuild;
    m_rebuild_isSet = true;
}

bool OAI_servers__id__actions_change_protection_post_request::is_rebuild_Set() const{
    return m_rebuild_isSet;
}

bool OAI_servers__id__actions_change_protection_post_request::is_rebuild_Valid() const{
    return m_rebuild_isValid;
}

bool OAI_servers__id__actions_change_protection_post_request::isSet() const {
...
bool OAI_servers__id__actions_change_protection_post_request::isValid() const {
