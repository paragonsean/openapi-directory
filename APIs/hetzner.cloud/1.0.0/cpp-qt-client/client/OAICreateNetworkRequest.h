...
class OAI_networks_get_200_response_networks_inner_routes_inner;
class OAICreateNetworkRequest_subnets_inner;
...
public:
    ...
    QList<OAI_networks_get_200_response_networks_inner_routes_inner> getRoutes() const;
    void setRoutes(const QList<OAI_networks_get_200_response_networks_inner_routes_inner> &routes);
    bool is_routes_Set() const;
    bool is_routes_Valid() const;

    QList<OAICreateNetworkRequest_subnets_inner> getSubnets() const;
    void setSubnets(const QList<OAICreateNetworkRequest_subnets_inner> &subnets);
...
private:
    ...
    QList<OAI_networks_get_200_response_networks_inner_routes_inner> m_routes;
    bool m_routes_isSet;
    bool m_routes_isValid;

    QList<OAICreateNetworkRequest_subnets_inner> m_subnets;
