...
OAI_load_balancers__id__actions_attach_to_network_post_request::OAI_load_balancers__id__actions_attach_to_network_post_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAI_load_balancers__id__actions_attach_to_network_post_request::OAI_load_balancers__id__actions_attach_to_network_post_request() {
    this->initializeModel();
}

OAI_load_balancers__id__actions_attach_to_network_post_request::~OAI_load_balancers__id__actions_attach_to_network_post_request() {}

void OAI_load_balancers__id__actions_attach_to_network_post_request::initializeModel() {
...
void OAI_load_balancers__id__actions_attach_to_network_post_request::fromJson(QString jsonString) {
...
void OAI_load_balancers__id__actions_attach_to_network_post_request::fromJsonObject(QJsonObject json) {
...
QString OAI_load_balancers__id__actions_attach_to_network_post_request::asJson() const {
...
QJsonObject OAI_load_balancers__id__actions_attach_to_network_post_request::asJsonObject() const {
    QJsonObject obj;
    if (m_ip_isSet) {
...
QString OAI_load_balancers__id__actions_attach_to_network_post_request::getIp() const {
    return m_ip;
}
void OAI_load_balancers__id__actions_attach_to_network_post_request::setIp(const QString &ip) {
    m_ip = ip;
    m_ip_isSet = true;
}

bool OAI_load_balancers__id__actions_attach_to_network_post_request::is_ip_Set() const{
    return m_ip_isSet;
}

bool OAI_load_balancers__id__actions_attach_to_network_post_request::is_ip_Valid() const{
    return m_ip_isValid;
}

double OAI_load_balancers__id__actions_attach_to_network_post_request::getNetwork() const {
    return m_network;
}
void OAI_load_balancers__id__actions_attach_to_network_post_request::setNetwork(const double &network) {
    m_network = network;
    m_network_isSet = true;
}

bool OAI_load_balancers__id__actions_attach_to_network_post_request::is_network_Set() const{
    return m_network_isSet;
}

bool OAI_load_balancers__id__actions_attach_to_network_post_request::is_network_Valid() const{
    return m_network_isValid;
}

bool OAI_load_balancers__id__actions_attach_to_network_post_request::isSet() const {
...
bool OAI_load_balancers__id__actions_attach_to_network_post_request::isValid() const {
