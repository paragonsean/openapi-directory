...
/*
 * OAI_volumes_get_200_response_volumes_inner_location.h
 *
 * Location of the Volume. Volume can only be attached to Servers in the same Location.
 */

#ifndef OAI_volumes_get_200_response_volumes_inner_location_H
#define OAI_volumes_get_200_response_volumes_inner_location_H
...
class OAI_volumes_get_200_response_volumes_inner_location : public OAIObject {
public:
    OAI_volumes_get_200_response_volumes_inner_location();
    OAI_volumes_get_200_response_volumes_inner_location(QString json);
    ~OAI_volumes_get_200_response_volumes_inner_location() override;
    ...
    QString getNetworkZone() const;
    void setNetworkZone(const QString &network_zone);
    bool is_network_zone_Set() const;
    bool is_network_zone_Valid() const;
...
private:
    ...
    QString m_network_zone;
    bool m_network_zone_isSet;
    bool m_network_zone_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAI_volumes_get_200_response_volumes_inner_location)

#endif // OAI_volumes_get_200_response_volumes_inner_location_H
