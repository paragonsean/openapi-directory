...
OAIPrimaryIPsResponse::OAIPrimaryIPsResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPrimaryIPsResponse::OAIPrimaryIPsResponse() {
    this->initializeModel();
}

OAIPrimaryIPsResponse::~OAIPrimaryIPsResponse() {}

void OAIPrimaryIPsResponse::initializeModel() {
...
void OAIPrimaryIPsResponse::fromJson(QString jsonString) {
...
void OAIPrimaryIPsResponse::fromJsonObject(QJsonObject json) {
...
QString OAIPrimaryIPsResponse::asJson() const {
...
QJsonObject OAIPrimaryIPsResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_meta.isSet()) {
...
OAIActionsResponse_meta OAIPrimaryIPsResponse::getMeta() const {
    return m_meta;
}
void OAIPrimaryIPsResponse::setMeta(const OAIActionsResponse_meta &meta) {
    m_meta = meta;
    m_meta_isSet = true;
}

bool OAIPrimaryIPsResponse::is_meta_Set() const{
    return m_meta_isSet;
}

bool OAIPrimaryIPsResponse::is_meta_Valid() const{
    return m_meta_isValid;
}

QList<OAIPrimaryIP> OAIPrimaryIPsResponse::getPrimaryIps() const {
    return m_primary_ips;
}
void OAIPrimaryIPsResponse::setPrimaryIps(const QList<OAIPrimaryIP> &primary_ips) {
    m_primary_ips = primary_ips;
    m_primary_ips_isSet = true;
}

bool OAIPrimaryIPsResponse::is_primary_ips_Set() const{
    return m_primary_ips_isSet;
}

bool OAIPrimaryIPsResponse::is_primary_ips_Valid() const{
    return m_primary_ips_isValid;
}

bool OAIPrimaryIPsResponse::isSet() const {
...
bool OAIPrimaryIPsResponse::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_primary_ips_isValid && true;
}
