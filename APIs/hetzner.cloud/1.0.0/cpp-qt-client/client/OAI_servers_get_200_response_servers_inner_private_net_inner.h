...
/*
 * OAI_servers_get_200_response_servers_inner_private_net_inner.h
 *
 * 
 */

#ifndef OAI_servers_get_200_response_servers_inner_private_net_inner_H
#define OAI_servers_get_200_response_servers_inner_private_net_inner_H
...
class OAI_servers_get_200_response_servers_inner_private_net_inner : public OAIObject {
public:
    OAI_servers_get_200_response_servers_inner_private_net_inner();
    OAI_servers_get_200_response_servers_inner_private_net_inner(QString json);
    ~OAI_servers_get_200_response_servers_inner_private_net_inner() override;
    ...
    QList<QString> getAliasIps() const;
    void setAliasIps(const QList<QString> &alias_ips);
    bool is_alias_ips_Set() const;
    bool is_alias_ips_Valid() const;
...
private:
    ...
    QList<QString> m_alias_ips;
    bool m_alias_ips_isSet;
    bool m_alias_ips_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAI_servers_get_200_response_servers_inner_private_net_inner)

#endif // OAI_servers_get_200_response_servers_inner_private_net_inner_H
