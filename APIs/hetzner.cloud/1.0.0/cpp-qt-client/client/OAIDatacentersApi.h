...
#ifndef OAI_OAIDatacentersApi_H
#define OAI_OAIDatacentersApi_H
...
class OAIDatacentersApi : public QObject {
    Q_OBJECT

public:
    OAIDatacentersApi(const int timeOut = 0);
    ~OAIDatacentersApi();
    ...
    */
    virtual void datacentersGet(const ::OpenAPI::OptionalParam<QString> &name = ::OpenAPI::OptionalParam<QString>());

    /**
    * @param[in]  id qint32 [required]
    */
    virtual void datacentersIdGet(const qint32 &id);
...
private:
    ...
    void datacentersGetCallback(OAIHttpRequestWorker *worker);
    void datacentersIdGetCallback(OAIHttpRequestWorker *worker);

Q_SIGNALS:

    void datacentersGetSignal(OAI_datacenters_get_200_response summary);
    void datacentersIdGetSignal(OAI_datacenters__id__get_200_response summary);


    void datacentersGetSignalFull(OAIHttpRequestWorker *worker, OAI_datacenters_get_200_response summary);
    void datacentersIdGetSignalFull(OAIHttpRequestWorker *worker, OAI_datacenters__id__get_200_response summary);

    Q_DECL_DEPRECATED_X("Use datacentersGetSignalError() instead")
    void datacentersGetSignalE(OAI_datacenters_get_200_response summary, QNetworkReply::NetworkError error_type, QString error_str);
    void datacentersGetSignalError(OAI_datacenters_get_200_response summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use datacentersIdGetSignalError() instead")
    void datacentersIdGetSignalE(OAI_datacenters__id__get_200_response summary, QNetworkReply::NetworkError error_type, QString error_str);
    void datacentersIdGetSignalError(OAI_datacenters__id__get_200_response summary, QNetworkReply::NetworkError error_type, const QString &error_str);

    Q_DECL_DEPRECATED_X("Use datacentersGetSignalErrorFull() instead")
    void datacentersGetSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void datacentersGetSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use datacentersIdGetSignalErrorFull() instead")
    void datacentersIdGetSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void datacentersIdGetSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
