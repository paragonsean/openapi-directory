...
OAI_pricing_get_200_response_pricing_volume::OAI_pricing_get_200_response_pricing_volume(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAI_pricing_get_200_response_pricing_volume::OAI_pricing_get_200_response_pricing_volume() {
    this->initializeModel();
}

OAI_pricing_get_200_response_pricing_volume::~OAI_pricing_get_200_response_pricing_volume() {}

void OAI_pricing_get_200_response_pricing_volume::initializeModel() {

    m_price_per_gb_month_isSet = false;
    m_price_per_gb_month_isValid = false;
}

void OAI_pricing_get_200_response_pricing_volume::fromJson(QString jsonString) {
...
void OAI_pricing_get_200_response_pricing_volume::fromJsonObject(QJsonObject json) {

    m_price_per_gb_month_isValid = ::OpenAPI::fromJsonValue(m_price_per_gb_month, json[QString("price_per_gb_month")]);
    m_price_per_gb_month_isSet = !json[QString("price_per_gb_month")].isNull() && m_price_per_gb_month_isValid;
}

QString OAI_pricing_get_200_response_pricing_volume::asJson() const {
...
QJsonObject OAI_pricing_get_200_response_pricing_volume::asJsonObject() const {
    QJsonObject obj;
    if (m_price_per_gb_month.isSet()) {
        obj.insert(QString("price_per_gb_month"), ::OpenAPI::toJsonValue(m_price_per_gb_month));
    }
    return obj;
}

OAI_pricing_get_200_response_pricing_floating_ip_price_monthly OAI_pricing_get_200_response_pricing_volume::getPricePerGbMonth() const {
    return m_price_per_gb_month;
}
void OAI_pricing_get_200_response_pricing_volume::setPricePerGbMonth(const OAI_pricing_get_200_response_pricing_floating_ip_price_monthly &price_per_gb_month) {
    m_price_per_gb_month = price_per_gb_month;
    m_price_per_gb_month_isSet = true;
}

bool OAI_pricing_get_200_response_pricing_volume::is_price_per_gb_month_Set() const{
    return m_price_per_gb_month_isSet;
}

bool OAI_pricing_get_200_response_pricing_volume::is_price_per_gb_month_Valid() const{
    return m_price_per_gb_month_isValid;
}

bool OAI_pricing_get_200_response_pricing_volume::isSet() const {
...
bool OAI_pricing_get_200_response_pricing_volume::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_price_per_gb_month_isValid && true;
}
