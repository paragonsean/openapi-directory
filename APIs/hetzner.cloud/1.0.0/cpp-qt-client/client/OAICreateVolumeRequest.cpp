...
bool OAICreateVolumeRequest::isAutomount() const {
    return m_automount;
}
void OAICreateVolumeRequest::setAutomount(const bool &automount) {
    m_automount = automount;
    m_automount_isSet = true;
}

bool OAICreateVolumeRequest::is_automount_Set() const{
    return m_automount_isSet;
}

bool OAICreateVolumeRequest::is_automount_Valid() const{
    return m_automount_isValid;
}

QString OAICreateVolumeRequest::getFormat() const {
    return m_format;
}
void OAICreateVolumeRequest::setFormat(const QString &format) {
    m_format = format;
    m_format_isSet = true;
}

bool OAICreateVolumeRequest::is_format_Set() const{
    return m_format_isSet;
}

bool OAICreateVolumeRequest::is_format_Valid() const{
    return m_format_isValid;
}

OAIObject OAICreateVolumeRequest::getLabels() const {
    return m_labels;
}
void OAICreateVolumeRequest::setLabels(const OAIObject &labels) {
    m_labels = labels;
    m_labels_isSet = true;
}

bool OAICreateVolumeRequest::is_labels_Set() const{
    return m_labels_isSet;
}

bool OAICreateVolumeRequest::is_labels_Valid() const{
    return m_labels_isValid;
}

QString OAICreateVolumeRequest::getLocation() const {
    return m_location;
}
void OAICreateVolumeRequest::setLocation(const QString &location) {
    m_location = location;
    m_location_isSet = true;
}

bool OAICreateVolumeRequest::is_location_Set() const{
    return m_location_isSet;
}

bool OAICreateVolumeRequest::is_location_Valid() const{
...
qint32 OAICreateVolumeRequest::getServer() const {
    return m_server;
}
void OAICreateVolumeRequest::setServer(const qint32 &server) {
    m_server = server;
    m_server_isSet = true;
}

bool OAICreateVolumeRequest::is_server_Set() const{
    return m_server_isSet;
}

bool OAICreateVolumeRequest::is_server_Valid() const{
    return m_server_isValid;
}

qint32 OAICreateVolumeRequest::getSize() const {
    return m_size;
}
void OAICreateVolumeRequest::setSize(const qint32 &size) {
    m_size = size;
    m_size_isSet = true;
}

bool OAICreateVolumeRequest::is_size_Set() const{
    return m_size_isSet;
}

bool OAICreateVolumeRequest::is_size_Valid() const{
