...
#include "OAICreateNetworkRequest_subnets_inner.h"
...
OAICreateNetworkRequest_subnets_inner::OAICreateNetworkRequest_subnets_inner(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateNetworkRequest_subnets_inner::OAICreateNetworkRequest_subnets_inner() {
    this->initializeModel();
}

OAICreateNetworkRequest_subnets_inner::~OAICreateNetworkRequest_subnets_inner() {}

void OAICreateNetworkRequest_subnets_inner::initializeModel() {
    ...
    m_vswitch_id_isSet = false;
    m_vswitch_id_isValid = false;
}

void OAICreateNetworkRequest_subnets_inner::fromJson(QString jsonString) {
...
void OAICreateNetworkRequest_subnets_inner::fromJsonObject(QJsonObject json) {
    ...
    m_vswitch_id_isValid = ::OpenAPI::fromJsonValue(m_vswitch_id, json[QString("vswitch_id")]);
    m_vswitch_id_isSet = !json[QString("vswitch_id")].isNull() && m_vswitch_id_isValid;
}

QString OAICreateNetworkRequest_subnets_inner::asJson() const {
...
QJsonObject OAICreateNetworkRequest_subnets_inner::asJsonObject() const {
    QJsonObject obj;
    if (m_ip_range_isSet) {
    ...
    if (m_vswitch_id_isSet) {
        obj.insert(QString("vswitch_id"), ::OpenAPI::toJsonValue(m_vswitch_id));
    }
    return obj;
}

QString OAICreateNetworkRequest_subnets_inner::getIpRange() const {
    return m_ip_range;
}
void OAICreateNetworkRequest_subnets_inner::setIpRange(const QString &ip_range) {
    m_ip_range = ip_range;
    m_ip_range_isSet = true;
}

bool OAICreateNetworkRequest_subnets_inner::is_ip_range_Set() const{
    return m_ip_range_isSet;
}

bool OAICreateNetworkRequest_subnets_inner::is_ip_range_Valid() const{
    return m_ip_range_isValid;
}

QString OAICreateNetworkRequest_subnets_inner::getNetworkZone() const {
    return m_network_zone;
}
void OAICreateNetworkRequest_subnets_inner::setNetworkZone(const QString &network_zone) {
    m_network_zone = network_zone;
    m_network_zone_isSet = true;
}

bool OAICreateNetworkRequest_subnets_inner::is_network_zone_Set() const{
    return m_network_zone_isSet;
}

bool OAICreateNetworkRequest_subnets_inner::is_network_zone_Valid() const{
    return m_network_zone_isValid;
}

QString OAICreateNetworkRequest_subnets_inner::getType() const {
    return m_type;
}
void OAICreateNetworkRequest_subnets_inner::setType(const QString &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAICreateNetworkRequest_subnets_inner::is_type_Set() const{
    return m_type_isSet;
}

bool OAICreateNetworkRequest_subnets_inner::is_type_Valid() const{
    return m_type_isValid;
}

qint32 OAICreateNetworkRequest_subnets_inner::getVswitchId() const {
    return m_vswitch_id;
}
void OAICreateNetworkRequest_subnets_inner::setVswitchId(const qint32 &vswitch_id) {
    m_vswitch_id = vswitch_id;
    m_vswitch_id_isSet = true;
}

bool OAICreateNetworkRequest_subnets_inner::is_vswitch_id_Set() const{
    return m_vswitch_id_isSet;
}

bool OAICreateNetworkRequest_subnets_inner::is_vswitch_id_Valid() const{
    return m_vswitch_id_isValid;
}

bool OAICreateNetworkRequest_subnets_inner::isSet() const {
...
bool OAICreateNetworkRequest_subnets_inner::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_network_zone_isValid && m_type_isValid && true;
}
