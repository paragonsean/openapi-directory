...
OAI_networks_post_201_response::OAI_networks_post_201_response(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAI_networks_post_201_response::OAI_networks_post_201_response() {
    this->initializeModel();
}

OAI_networks_post_201_response::~OAI_networks_post_201_response() {}

void OAI_networks_post_201_response::initializeModel() {

    m_network_isSet = false;
    m_network_isValid = false;
}

void OAI_networks_post_201_response::fromJson(QString jsonString) {
...
void OAI_networks_post_201_response::fromJsonObject(QJsonObject json) {

    m_network_isValid = ::OpenAPI::fromJsonValue(m_network, json[QString("network")]);
    m_network_isSet = !json[QString("network")].isNull() && m_network_isValid;
}

QString OAI_networks_post_201_response::asJson() const {
...
QJsonObject OAI_networks_post_201_response::asJsonObject() const {
    QJsonObject obj;
    if (m_network.isSet()) {
...
OAI_networks_get_200_response_networks_inner OAI_networks_post_201_response::getNetwork() const {
    return m_network;
}
void OAI_networks_post_201_response::setNetwork(const OAI_networks_get_200_response_networks_inner &network) {
    m_network = network;
    m_network_isSet = true;
}

bool OAI_networks_post_201_response::is_network_Set() const{
    return m_network_isSet;
}

bool OAI_networks_post_201_response::is_network_Valid() const{
    return m_network_isValid;
}

bool OAI_networks_post_201_response::isSet() const {
...
bool OAI_networks_post_201_response::isValid() const {
