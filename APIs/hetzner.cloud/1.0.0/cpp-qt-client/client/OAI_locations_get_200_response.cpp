...
OAI_locations_get_200_response::OAI_locations_get_200_response(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAI_locations_get_200_response::OAI_locations_get_200_response() {
    this->initializeModel();
}

OAI_locations_get_200_response::~OAI_locations_get_200_response() {}

void OAI_locations_get_200_response::initializeModel() {

    m_locations_isSet = false;
    m_locations_isValid = false;
}

void OAI_locations_get_200_response::fromJson(QString jsonString) {
...
void OAI_locations_get_200_response::fromJsonObject(QJsonObject json) {

    m_locations_isValid = ::OpenAPI::fromJsonValue(m_locations, json[QString("locations")]);
    m_locations_isSet = !json[QString("locations")].isNull() && m_locations_isValid;
}

QString OAI_locations_get_200_response::asJson() const {
...
QJsonObject OAI_locations_get_200_response::asJsonObject() const {
    QJsonObject obj;
...
QList<OAI_datacenters_get_200_response_datacenters_inner_location> OAI_locations_get_200_response::getLocations() const {
    return m_locations;
}
void OAI_locations_get_200_response::setLocations(const QList<OAI_datacenters_get_200_response_datacenters_inner_location> &locations) {
    m_locations = locations;
    m_locations_isSet = true;
}

bool OAI_locations_get_200_response::is_locations_Set() const{
    return m_locations_isSet;
}

bool OAI_locations_get_200_response::is_locations_Valid() const{
    return m_locations_isValid;
}

bool OAI_locations_get_200_response::isSet() const {
...
bool OAI_locations_get_200_response::isValid() const {
