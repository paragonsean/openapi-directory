...
OAIDetachFromNetworkRequest::OAIDetachFromNetworkRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDetachFromNetworkRequest::OAIDetachFromNetworkRequest() {
    this->initializeModel();
}

OAIDetachFromNetworkRequest::~OAIDetachFromNetworkRequest() {}

void OAIDetachFromNetworkRequest::initializeModel() {

    m_network_isSet = false;
    m_network_isValid = false;
}

void OAIDetachFromNetworkRequest::fromJson(QString jsonString) {
...
void OAIDetachFromNetworkRequest::fromJsonObject(QJsonObject json) {

    m_network_isValid = ::OpenAPI::fromJsonValue(m_network, json[QString("network")]);
    m_network_isSet = !json[QString("network")].isNull() && m_network_isValid;
}

QString OAIDetachFromNetworkRequest::asJson() const {
...
QJsonObject OAIDetachFromNetworkRequest::asJsonObject() const {
    QJsonObject obj;
    if (m_network_isSet) {
...
qint32 OAIDetachFromNetworkRequest::getNetwork() const {
    return m_network;
}
void OAIDetachFromNetworkRequest::setNetwork(const qint32 &network) {
    m_network = network;
    m_network_isSet = true;
}

bool OAIDetachFromNetworkRequest::is_network_Set() const{
    return m_network_isSet;
}

bool OAIDetachFromNetworkRequest::is_network_Valid() const{
    return m_network_isValid;
}

bool OAIDetachFromNetworkRequest::isSet() const {
...
bool OAIDetachFromNetworkRequest::isValid() const {
