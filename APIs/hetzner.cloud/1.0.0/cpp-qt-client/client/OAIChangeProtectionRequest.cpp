...
OAIChangeProtectionRequest::OAIChangeProtectionRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIChangeProtectionRequest::OAIChangeProtectionRequest() {
    this->initializeModel();
}

OAIChangeProtectionRequest::~OAIChangeProtectionRequest() {}

void OAIChangeProtectionRequest::initializeModel() {

    m_r_delete_isSet = false;
    m_r_delete_isValid = false;
}

void OAIChangeProtectionRequest::fromJson(QString jsonString) {
...
void OAIChangeProtectionRequest::fromJsonObject(QJsonObject json) {
...
QString OAIChangeProtectionRequest::asJson() const {
...
QJsonObject OAIChangeProtectionRequest::asJsonObject() const {
    QJsonObject obj;
    if (m_r_delete_isSet) {
...
bool OAIChangeProtectionRequest::isRDelete() const {
    return m_r_delete;
}
void OAIChangeProtectionRequest::setRDelete(const bool &r_delete) {
    m_r_delete = r_delete;
    m_r_delete_isSet = true;
}

bool OAIChangeProtectionRequest::is_r_delete_Set() const{
    return m_r_delete_isSet;
}

bool OAIChangeProtectionRequest::is_r_delete_Valid() const{
    return m_r_delete_isValid;
}

bool OAIChangeProtectionRequest::isSet() const {
...
bool OAIChangeProtectionRequest::isValid() const {
