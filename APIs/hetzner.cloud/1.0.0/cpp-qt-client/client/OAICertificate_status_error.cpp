...
#include "OAICertificate_status_error.h"
...
OAICertificate_status_error::OAICertificate_status_error(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICertificate_status_error::OAICertificate_status_error() {
    this->initializeModel();
}

OAICertificate_status_error::~OAICertificate_status_error() {}

void OAICertificate_status_error::initializeModel() {
...
void OAICertificate_status_error::fromJson(QString jsonString) {
...
void OAICertificate_status_error::fromJsonObject(QJsonObject json) {
...
QString OAICertificate_status_error::asJson() const {
...
QJsonObject OAICertificate_status_error::asJsonObject() const {
    QJsonObject obj;
    if (m_code_isSet) {
...
QString OAICertificate_status_error::getCode() const {
    return m_code;
}
void OAICertificate_status_error::setCode(const QString &code) {
    m_code = code;
    m_code_isSet = true;
}

bool OAICertificate_status_error::is_code_Set() const{
    return m_code_isSet;
}

bool OAICertificate_status_error::is_code_Valid() const{
    return m_code_isValid;
}

QString OAICertificate_status_error::getMessage() const {
    return m_message;
}
void OAICertificate_status_error::setMessage(const QString &message) {
    m_message = message;
    m_message_isSet = true;
}

bool OAICertificate_status_error::is_message_Set() const{
    return m_message_isSet;
}

bool OAICertificate_status_error::is_message_Valid() const{
    return m_message_isValid;
}

bool OAICertificate_status_error::isSet() const {
...
bool OAICertificate_status_error::isValid() const {
