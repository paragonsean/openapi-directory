...
OAI_server_types__id__get_200_response::OAI_server_types__id__get_200_response(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAI_server_types__id__get_200_response::OAI_server_types__id__get_200_response() {
    this->initializeModel();
}

OAI_server_types__id__get_200_response::~OAI_server_types__id__get_200_response() {}

void OAI_server_types__id__get_200_response::initializeModel() {

    m_server_type_isSet = false;
    m_server_type_isValid = false;
}

void OAI_server_types__id__get_200_response::fromJson(QString jsonString) {
...
void OAI_server_types__id__get_200_response::fromJsonObject(QJsonObject json) {
...
QString OAI_server_types__id__get_200_response::asJson() const {
...
QJsonObject OAI_server_types__id__get_200_response::asJsonObject() const {
    QJsonObject obj;
...
OAI_server_types_get_200_response_server_types_inner OAI_server_types__id__get_200_response::getServerType() const {
    return m_server_type;
}
void OAI_server_types__id__get_200_response::setServerType(const OAI_server_types_get_200_response_server_types_inner &server_type) {
    m_server_type = server_type;
    m_server_type_isSet = true;
}

bool OAI_server_types__id__get_200_response::is_server_type_Set() const{
    return m_server_type_isSet;
}

bool OAI_server_types__id__get_200_response::is_server_type_Valid() const{
    return m_server_type_isValid;
}

bool OAI_server_types__id__get_200_response::isSet() const {
...
bool OAI_server_types__id__get_200_response::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_server_type_isValid && true;
}
