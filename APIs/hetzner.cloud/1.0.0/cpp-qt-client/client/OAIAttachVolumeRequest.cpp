...
OAIAttachVolumeRequest::OAIAttachVolumeRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAttachVolumeRequest::OAIAttachVolumeRequest() {
    this->initializeModel();
}

OAIAttachVolumeRequest::~OAIAttachVolumeRequest() {}

void OAIAttachVolumeRequest::initializeModel() {
...
void OAIAttachVolumeRequest::fromJson(QString jsonString) {
...
void OAIAttachVolumeRequest::fromJsonObject(QJsonObject json) {
...
QString OAIAttachVolumeRequest::asJson() const {
...
QJsonObject OAIAttachVolumeRequest::asJsonObject() const {
    QJsonObject obj;
...
bool OAIAttachVolumeRequest::isAutomount() const {
    return m_automount;
}
void OAIAttachVolumeRequest::setAutomount(const bool &automount) {
    m_automount = automount;
    m_automount_isSet = true;
}

bool OAIAttachVolumeRequest::is_automount_Set() const{
    return m_automount_isSet;
}

bool OAIAttachVolumeRequest::is_automount_Valid() const{
    return m_automount_isValid;
}

qint32 OAIAttachVolumeRequest::getServer() const {
    return m_server;
}
void OAIAttachVolumeRequest::setServer(const qint32 &server) {
    m_server = server;
    m_server_isSet = true;
}

bool OAIAttachVolumeRequest::is_server_Set() const{
    return m_server_isSet;
}

bool OAIAttachVolumeRequest::is_server_Valid() const{
    return m_server_isValid;
}

bool OAIAttachVolumeRequest::isSet() const {
...
bool OAIAttachVolumeRequest::isValid() const {
