...
#ifndef OAIPrimaryIP_H
#define OAIPrimaryIP_H

#include <QJsonObject>

#include "OAIPrimaryIP_datacenter.h"
#include "OAIPrimaryIP_dns_ptr_inner.h"
...
namespace OpenAPI {
class OAIPrimaryIP_datacenter;
class OAIPrimaryIP_dns_ptr_inner;
class OAI_floating_ips_get_200_response_floating_ips_inner_protection;

class OAIPrimaryIP : public OAIObject {
public:
    OAIPrimaryIP();
    OAIPrimaryIP(QString json);
    ~OAIPrimaryIP() override;
    ...
    OAIPrimaryIP_datacenter getDatacenter() const;
    void setDatacenter(const OAIPrimaryIP_datacenter &datacenter);
    bool is_datacenter_Set() const;
    bool is_datacenter_Valid() const;

    QList<OAIPrimaryIP_dns_ptr_inner> getDnsPtr() const;
    void setDnsPtr(const QList<OAIPrimaryIP_dns_ptr_inner> &dns_ptr);
...
private:
    ...
    OAIPrimaryIP_datacenter m_datacenter;
    bool m_datacenter_isSet;
    bool m_datacenter_isValid;

    QList<OAIPrimaryIP_dns_ptr_inner> m_dns_ptr;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPrimaryIP)

#endif // OAIPrimaryIP_H
