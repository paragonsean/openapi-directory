...
namespace OpenAPI {
class OAIAction;
class OAI_servers_get_200_response_servers_inner;
...
public:
    ...
    QList<OAIAction> getNextActions() const;
    void setNextActions(const QList<OAIAction> &next_actions);
    bool is_next_actions_Set() const;
    bool is_next_actions_Valid() const;
    ...
    OAI_servers_get_200_response_servers_inner getServer() const;
    void setServer(const OAI_servers_get_200_response_servers_inner &server);
...
private:
    ...
    QList<OAIAction> m_next_actions;
    bool m_next_actions_isSet;
    bool m_next_actions_isValid;

    QString m_root_password;
    bool m_root_password_isSet;
    bool m_root_password_isValid;

    OAI_servers_get_200_response_servers_inner m_server;
    bool m_server_isSet;
