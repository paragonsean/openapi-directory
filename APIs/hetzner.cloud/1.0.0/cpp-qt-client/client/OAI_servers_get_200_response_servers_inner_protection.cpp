...
OAI_servers_get_200_response_servers_inner_protection::OAI_servers_get_200_response_servers_inner_protection(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAI_servers_get_200_response_servers_inner_protection::OAI_servers_get_200_response_servers_inner_protection() {
    this->initializeModel();
}

OAI_servers_get_200_response_servers_inner_protection::~OAI_servers_get_200_response_servers_inner_protection() {}

void OAI_servers_get_200_response_servers_inner_protection::initializeModel() {
...
void OAI_servers_get_200_response_servers_inner_protection::fromJson(QString jsonString) {
...
void OAI_servers_get_200_response_servers_inner_protection::fromJsonObject(QJsonObject json) {
...
QString OAI_servers_get_200_response_servers_inner_protection::asJson() const {
...
QJsonObject OAI_servers_get_200_response_servers_inner_protection::asJsonObject() const {
    QJsonObject obj;
    if (m_r_delete_isSet) {
...
bool OAI_servers_get_200_response_servers_inner_protection::isRDelete() const {
    return m_r_delete;
}
void OAI_servers_get_200_response_servers_inner_protection::setRDelete(const bool &r_delete) {
    m_r_delete = r_delete;
    m_r_delete_isSet = true;
}

bool OAI_servers_get_200_response_servers_inner_protection::is_r_delete_Set() const{
    return m_r_delete_isSet;
}

bool OAI_servers_get_200_response_servers_inner_protection::is_r_delete_Valid() const{
    return m_r_delete_isValid;
}

bool OAI_servers_get_200_response_servers_inner_protection::isRebuild() const {
    return m_rebuild;
}
void OAI_servers_get_200_response_servers_inner_protection::setRebuild(const bool &rebuild) {
    m_rebuild = rebuild;
    m_rebuild_isSet = true;
}

bool OAI_servers_get_200_response_servers_inner_protection::is_rebuild_Set() const{
    return m_rebuild_isSet;
}

bool OAI_servers_get_200_response_servers_inner_protection::is_rebuild_Valid() const{
    return m_rebuild_isValid;
}

bool OAI_servers_get_200_response_servers_inner_protection::isSet() const {
...
bool OAI_servers_get_200_response_servers_inner_protection::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_r_delete_isValid && m_rebuild_isValid && true;
}
