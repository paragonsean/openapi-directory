...
#include "OAICreateServerRequest_public_net.h"
#include "OAIObject.h"
#include <QList>
#include <QString>
...
namespace OpenAPI {
class OAICreateServerRequest_firewalls_inner;
class OAICreateServerRequest_public_net;
...
public:
    ...
    QList<OAICreateServerRequest_firewalls_inner> getFirewalls() const;
    void setFirewalls(const QList<OAICreateServerRequest_firewalls_inner> &firewalls);
    ...
    QList<qint32> getNetworks() const;
    void setNetworks(const QList<qint32> &networks);
    bool is_networks_Set() const;
    bool is_networks_Valid() const;

    qint32 getPlacementGroup() const;
    void setPlacementGroup(const qint32 &placement_group);
    bool is_placement_group_Set() const;
    bool is_placement_group_Valid() const;

    OAICreateServerRequest_public_net getPublicNet() const;
    void setPublicNet(const OAICreateServerRequest_public_net &public_net);
    ...
    bool isStartAfterCreate() const;
    void setStartAfterCreate(const bool &start_after_create);
    bool is_start_after_create_Set() const;
    bool is_start_after_create_Valid() const;
...
private:
    ...
    QList<OAICreateServerRequest_firewalls_inner> m_firewalls;
    ...
    bool m_start_after_create;
    bool m_start_after_create_isSet;
    bool m_start_after_create_isValid;
