...
OAI_servers__id__actions_rebuild_post_201_response::OAI_servers__id__actions_rebuild_post_201_response(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAI_servers__id__actions_rebuild_post_201_response::OAI_servers__id__actions_rebuild_post_201_response() {
    this->initializeModel();
}

OAI_servers__id__actions_rebuild_post_201_response::~OAI_servers__id__actions_rebuild_post_201_response() {}

void OAI_servers__id__actions_rebuild_post_201_response::initializeModel() {
...
void OAI_servers__id__actions_rebuild_post_201_response::fromJson(QString jsonString) {
...
void OAI_servers__id__actions_rebuild_post_201_response::fromJsonObject(QJsonObject json) {
...
QString OAI_servers__id__actions_rebuild_post_201_response::asJson() const {
...
QJsonObject OAI_servers__id__actions_rebuild_post_201_response::asJsonObject() const {
    QJsonObject obj;
    if (m_action.isSet()) {
...
OAIAction OAI_servers__id__actions_rebuild_post_201_response::getAction() const {
    return m_action;
}
void OAI_servers__id__actions_rebuild_post_201_response::setAction(const OAIAction &action) {
    m_action = action;
    m_action_isSet = true;
}

bool OAI_servers__id__actions_rebuild_post_201_response::is_action_Set() const{
    return m_action_isSet;
}

bool OAI_servers__id__actions_rebuild_post_201_response::is_action_Valid() const{
    return m_action_isValid;
}

QString OAI_servers__id__actions_rebuild_post_201_response::getRootPassword() const {
    return m_root_password;
}
void OAI_servers__id__actions_rebuild_post_201_response::setRootPassword(const QString &root_password) {
    m_root_password = root_password;
    m_root_password_isSet = true;
}

bool OAI_servers__id__actions_rebuild_post_201_response::is_root_password_Set() const{
    return m_root_password_isSet;
}

bool OAI_servers__id__actions_rebuild_post_201_response::is_root_password_Valid() const{
    return m_root_password_isValid;
}

bool OAI_servers__id__actions_rebuild_post_201_response::isSet() const {
...
bool OAI_servers__id__actions_rebuild_post_201_response::isValid() const {
