...
OAIUpdateNetworkRequest_labels OAIUpdateVolumeRequest::getLabels() const {
    return m_labels;
}
void OAIUpdateVolumeRequest::setLabels(const OAIUpdateNetworkRequest_labels &labels) {
    m_labels = labels;
    m_labels_isSet = true;
}

bool OAIUpdateVolumeRequest::is_labels_Set() const{
    return m_labels_isSet;
}

bool OAIUpdateVolumeRequest::is_labels_Valid() const{
