...
/*
 * OAI_servers_get_200_response_servers_inner_image.h
 *
 * 
 */

#ifndef OAI_servers_get_200_response_servers_inner_image_H
#define OAI_servers_get_200_response_servers_inner_image_H
...
namespace OpenAPI {
class OAI_images_get_200_response_images_inner_created_from;
class OAI_floating_ips_get_200_response_floating_ips_inner_protection;

class OAI_servers_get_200_response_servers_inner_image : public OAIObject {
public:
    OAI_servers_get_200_response_servers_inner_image();
    OAI_servers_get_200_response_servers_inner_image(QString json);
    ~OAI_servers_get_200_response_servers_inner_image() override;
    ...
    qint32 getBoundTo() const;
    void setBoundTo(const qint32 &bound_to);
    bool is_bound_to_Set() const;
    bool is_bound_to_Valid() const;
    ...
    OAI_images_get_200_response_images_inner_created_from getCreatedFrom() const;
    void setCreatedFrom(const OAI_images_get_200_response_images_inner_created_from &created_from);
    bool is_created_from_Set() const;
    bool is_created_from_Valid() const;
    ...
    void setDiskSize(const double &disk_size);
    ...
    double getImageSize() const;
    void setImageSize(const double &image_size);
    ...
    QString getOsFlavor() const;
    void setOsFlavor(const QString &os_flavor);
    bool is_os_flavor_Set() const;
    bool is_os_flavor_Valid() const;
    ...
    bool isRapidDeploy() const;
    void setRapidDeploy(const bool &rapid_deploy);
    bool is_rapid_deploy_Set() const;
    bool is_rapid_deploy_Valid() const;
...
private:
    ...
    qint32 m_bound_to;
    bool m_bound_to_isSet;
    bool m_bound_to_isValid;

    QString m_created;
    bool m_created_isSet;
    bool m_created_isValid;

    OAI_images_get_200_response_images_inner_created_from m_created_from;
    bool m_created_from_isSet;
    bool m_created_from_isValid;
    ...
    QString m_os_flavor;
    bool m_os_flavor_isSet;
    bool m_os_flavor_isValid;
    ...
    bool m_rapid_deploy;
    bool m_rapid_deploy_isSet;
    bool m_rapid_deploy_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAI_servers_get_200_response_servers_inner_image)

#endif // OAI_servers_get_200_response_servers_inner_image_H
