...
OAIActionsResponse::OAIActionsResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIActionsResponse::OAIActionsResponse() {
    this->initializeModel();
}

OAIActionsResponse::~OAIActionsResponse() {}

void OAIActionsResponse::initializeModel() {
...
void OAIActionsResponse::fromJson(QString jsonString) {
...
void OAIActionsResponse::fromJsonObject(QJsonObject json) {
...
QString OAIActionsResponse::asJson() const {
...
QJsonObject OAIActionsResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_actions.size() > 0) {
...
QList<OAIAction> OAIActionsResponse::getActions() const {
    return m_actions;
}
void OAIActionsResponse::setActions(const QList<OAIAction> &actions) {
    m_actions = actions;
    m_actions_isSet = true;
}

bool OAIActionsResponse::is_actions_Set() const{
    return m_actions_isSet;
}

bool OAIActionsResponse::is_actions_Valid() const{
    return m_actions_isValid;
}

OAIActionsResponse_meta OAIActionsResponse::getMeta() const {
    return m_meta;
}
void OAIActionsResponse::setMeta(const OAIActionsResponse_meta &meta) {
    m_meta = meta;
    m_meta_isSet = true;
}

bool OAIActionsResponse::is_meta_Set() const{
    return m_meta_isSet;
}

bool OAIActionsResponse::is_meta_Valid() const{
    return m_meta_isValid;
}

bool OAIActionsResponse::isSet() const {
...
bool OAIActionsResponse::isValid() const {
