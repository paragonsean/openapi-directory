...
#include "OAI_load_balancers__id__get_200_response.h"
...
OAI_load_balancers__id__get_200_response::OAI_load_balancers__id__get_200_response(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAI_load_balancers__id__get_200_response::OAI_load_balancers__id__get_200_response() {
    this->initializeModel();
}

OAI_load_balancers__id__get_200_response::~OAI_load_balancers__id__get_200_response() {}

void OAI_load_balancers__id__get_200_response::initializeModel() {

    m_load_balancer_isSet = false;
    m_load_balancer_isValid = false;
}

void OAI_load_balancers__id__get_200_response::fromJson(QString jsonString) {
...
void OAI_load_balancers__id__get_200_response::fromJsonObject(QJsonObject json) {
...
QString OAI_load_balancers__id__get_200_response::asJson() const {
...
QJsonObject OAI_load_balancers__id__get_200_response::asJsonObject() const {
    QJsonObject obj;
...
OAI_load_balancers_get_200_response_load_balancers_inner OAI_load_balancers__id__get_200_response::getLoadBalancer() const {
    return m_load_balancer;
}
void OAI_load_balancers__id__get_200_response::setLoadBalancer(const OAI_load_balancers_get_200_response_load_balancers_inner &load_balancer) {
    m_load_balancer = load_balancer;
    m_load_balancer_isSet = true;
}

bool OAI_load_balancers__id__get_200_response::is_load_balancer_Set() const{
    return m_load_balancer_isSet;
}

bool OAI_load_balancers__id__get_200_response::is_load_balancer_Valid() const{
    return m_load_balancer_isValid;
}

bool OAI_load_balancers__id__get_200_response::isSet() const {
...
bool OAI_load_balancers__id__get_200_response::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_load_balancer_isValid && true;
}
