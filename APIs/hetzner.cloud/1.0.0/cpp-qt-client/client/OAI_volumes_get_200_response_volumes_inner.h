...
/*
 * OAI_volumes_get_200_response_volumes_inner.h
 *
 * 
 */

#ifndef OAI_volumes_get_200_response_volumes_inner_H
#define OAI_volumes_get_200_response_volumes_inner_H

#include <QJsonObject>

#include "OAI_floating_ips_get_200_response_floating_ips_inner_protection.h"
#include "OAI_volumes_get_200_response_volumes_inner_location.h"
#include <QMap>
#include <QString>
...
namespace OpenAPI {
class OAI_volumes_get_200_response_volumes_inner_location;
class OAI_floating_ips_get_200_response_floating_ips_inner_protection;

class OAI_volumes_get_200_response_volumes_inner : public OAIObject {
public:
    OAI_volumes_get_200_response_volumes_inner();
    OAI_volumes_get_200_response_volumes_inner(QString json);
    ~OAI_volumes_get_200_response_volumes_inner() override;
    ...
    QString getLinuxDevice() const;
    void setLinuxDevice(const QString &linux_device);
    bool is_linux_device_Set() const;
    bool is_linux_device_Valid() const;

    OAI_volumes_get_200_response_volumes_inner_location getLocation() const;
    void setLocation(const OAI_volumes_get_200_response_volumes_inner_location &location);
...
private:
    ...
    QString m_linux_device;
    bool m_linux_device_isSet;
    bool m_linux_device_isValid;

    OAI_volumes_get_200_response_volumes_inner_location m_location;
...
Q_DECLARE_METATYPE(OpenAPI::OAI_volumes_get_200_response_volumes_inner)

#endif // OAI_volumes_get_200_response_volumes_inner_H
