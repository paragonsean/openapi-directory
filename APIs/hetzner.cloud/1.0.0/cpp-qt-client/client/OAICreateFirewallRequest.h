...
#include "OAICreateFirewallRequest_apply_to_inner.h"
#include "OAIObject.h"
#include "OAIRule.h"
#include <QList>
#include <QString>
...
namespace OpenAPI {
class OAICreateFirewallRequest_apply_to_inner;
class OAIRule;
...
public:
    ...
    QList<OAICreateFirewallRequest_apply_to_inner> getApplyTo() const;
    void setApplyTo(const QList<OAICreateFirewallRequest_apply_to_inner> &apply_to);
...
private:
    ...
    QList<OAICreateFirewallRequest_apply_to_inner> m_apply_to;
