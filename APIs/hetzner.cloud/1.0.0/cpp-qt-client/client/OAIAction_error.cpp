...
OAIAction_error::OAIAction_error(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAction_error::OAIAction_error() {
    this->initializeModel();
}

OAIAction_error::~OAIAction_error() {}

void OAIAction_error::initializeModel() {
...
void OAIAction_error::fromJson(QString jsonString) {
...
void OAIAction_error::fromJsonObject(QJsonObject json) {
...
QString OAIAction_error::asJson() const {
...
QJsonObject OAIAction_error::asJsonObject() const {
    QJsonObject obj;
    if (m_code_isSet) {
...
QString OAIAction_error::getCode() const {
    return m_code;
}
void OAIAction_error::setCode(const QString &code) {
    m_code = code;
    m_code_isSet = true;
}

bool OAIAction_error::is_code_Set() const{
    return m_code_isSet;
}

bool OAIAction_error::is_code_Valid() const{
    return m_code_isValid;
}

QString OAIAction_error::getMessage() const {
    return m_message;
}
void OAIAction_error::setMessage(const QString &message) {
    m_message = message;
    m_message_isSet = true;
}

bool OAIAction_error::is_message_Set() const{
    return m_message_isSet;
}

bool OAIAction_error::is_message_Valid() const{
    return m_message_isValid;
}

bool OAIAction_error::isSet() const {
...
bool OAIAction_error::isValid() const {
