...
OAILoadBalancerTargetHealthStatus_inner::OAILoadBalancerTargetHealthStatus_inner(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAILoadBalancerTargetHealthStatus_inner::OAILoadBalancerTargetHealthStatus_inner() {
    this->initializeModel();
}

OAILoadBalancerTargetHealthStatus_inner::~OAILoadBalancerTargetHealthStatus_inner() {}

void OAILoadBalancerTargetHealthStatus_inner::initializeModel() {
...
void OAILoadBalancerTargetHealthStatus_inner::fromJson(QString jsonString) {
...
void OAILoadBalancerTargetHealthStatus_inner::fromJsonObject(QJsonObject json) {
...
QString OAILoadBalancerTargetHealthStatus_inner::asJson() const {
...
QJsonObject OAILoadBalancerTargetHealthStatus_inner::asJsonObject() const {
    QJsonObject obj;
...
qint32 OAILoadBalancerTargetHealthStatus_inner::getListenPort() const {
    return m_listen_port;
}
void OAILoadBalancerTargetHealthStatus_inner::setListenPort(const qint32 &listen_port) {
    m_listen_port = listen_port;
    m_listen_port_isSet = true;
}

bool OAILoadBalancerTargetHealthStatus_inner::is_listen_port_Set() const{
    return m_listen_port_isSet;
}

bool OAILoadBalancerTargetHealthStatus_inner::is_listen_port_Valid() const{
    return m_listen_port_isValid;
}

QString OAILoadBalancerTargetHealthStatus_inner::getStatus() const {
    return m_status;
}
void OAILoadBalancerTargetHealthStatus_inner::setStatus(const QString &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAILoadBalancerTargetHealthStatus_inner::is_status_Set() const{
    return m_status_isSet;
}

bool OAILoadBalancerTargetHealthStatus_inner::is_status_Valid() const{
    return m_status_isValid;
}

bool OAILoadBalancerTargetHealthStatus_inner::isSet() const {
...
bool OAILoadBalancerTargetHealthStatus_inner::isValid() const {
