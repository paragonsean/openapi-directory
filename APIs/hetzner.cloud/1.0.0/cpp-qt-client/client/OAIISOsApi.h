...
#ifndef OAI_OAIISOsApi_H
#define OAI_OAIISOsApi_H
...
#include "OAI_isos__id__get_200_response.h"
...
class OAIISOsApi : public QObject {
    Q_OBJECT

public:
    OAIISOsApi(const int timeOut = 0);
    ~OAIISOsApi();
    ...
    * @param[in]  include_architecture_wildcard bool [optional]
    */
    virtual void isosGet(const ::OpenAPI::OptionalParam<QString> &name = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &architecture = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<bool> &include_architecture_wildcard = ::OpenAPI::OptionalParam<bool>());

    /**
    * @param[in]  id qint32 [required]
    */
    virtual void isosIdGet(const qint32 &id);
...
private:
    ...
    void isosGetCallback(OAIHttpRequestWorker *worker);
    void isosIdGetCallback(OAIHttpRequestWorker *worker);

Q_SIGNALS:

    void isosGetSignal(OAI_isos_get_200_response summary);
    void isosIdGetSignal(OAI_isos__id__get_200_response summary);


    void isosGetSignalFull(OAIHttpRequestWorker *worker, OAI_isos_get_200_response summary);
    void isosIdGetSignalFull(OAIHttpRequestWorker *worker, OAI_isos__id__get_200_response summary);

    Q_DECL_DEPRECATED_X("Use isosGetSignalError() instead")
    void isosGetSignalE(OAI_isos_get_200_response summary, QNetworkReply::NetworkError error_type, QString error_str);
    void isosGetSignalError(OAI_isos_get_200_response summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use isosIdGetSignalError() instead")
    void isosIdGetSignalE(OAI_isos__id__get_200_response summary, QNetworkReply::NetworkError error_type, QString error_str);
    void isosIdGetSignalError(OAI_isos__id__get_200_response summary, QNetworkReply::NetworkError error_type, const QString &error_str);

    Q_DECL_DEPRECATED_X("Use isosGetSignalErrorFull() instead")
    void isosGetSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void isosGetSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use isosIdGetSignalErrorFull() instead")
    void isosIdGetSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void isosIdGetSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
