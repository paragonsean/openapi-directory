...
OAI_servers__id__actions_change_dns_ptr_post_request::OAI_servers__id__actions_change_dns_ptr_post_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAI_servers__id__actions_change_dns_ptr_post_request::OAI_servers__id__actions_change_dns_ptr_post_request() {
    this->initializeModel();
}

OAI_servers__id__actions_change_dns_ptr_post_request::~OAI_servers__id__actions_change_dns_ptr_post_request() {}

void OAI_servers__id__actions_change_dns_ptr_post_request::initializeModel() {
...
void OAI_servers__id__actions_change_dns_ptr_post_request::fromJson(QString jsonString) {
...
void OAI_servers__id__actions_change_dns_ptr_post_request::fromJsonObject(QJsonObject json) {
...
QString OAI_servers__id__actions_change_dns_ptr_post_request::asJson() const {
...
QJsonObject OAI_servers__id__actions_change_dns_ptr_post_request::asJsonObject() const {
    QJsonObject obj;
    if (m_dns_ptr_isSet) {
...
QString OAI_servers__id__actions_change_dns_ptr_post_request::getDnsPtr() const {
    return m_dns_ptr;
}
void OAI_servers__id__actions_change_dns_ptr_post_request::setDnsPtr(const QString &dns_ptr) {
    m_dns_ptr = dns_ptr;
    m_dns_ptr_isSet = true;
}

bool OAI_servers__id__actions_change_dns_ptr_post_request::is_dns_ptr_Set() const{
    return m_dns_ptr_isSet;
}

bool OAI_servers__id__actions_change_dns_ptr_post_request::is_dns_ptr_Valid() const{
    return m_dns_ptr_isValid;
}

QString OAI_servers__id__actions_change_dns_ptr_post_request::getIp() const {
    return m_ip;
}
void OAI_servers__id__actions_change_dns_ptr_post_request::setIp(const QString &ip) {
    m_ip = ip;
    m_ip_isSet = true;
}

bool OAI_servers__id__actions_change_dns_ptr_post_request::is_ip_Set() const{
    return m_ip_isSet;
}

bool OAI_servers__id__actions_change_dns_ptr_post_request::is_ip_Valid() const{
    return m_ip_isValid;
}

bool OAI_servers__id__actions_change_dns_ptr_post_request::isSet() const {
...
bool OAI_servers__id__actions_change_dns_ptr_post_request::isValid() const {
