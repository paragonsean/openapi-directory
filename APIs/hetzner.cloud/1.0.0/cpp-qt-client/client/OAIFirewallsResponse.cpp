...
#include "OAIFirewallsResponse.h"
...
OAIFirewallsResponse::OAIFirewallsResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIFirewallsResponse::OAIFirewallsResponse() {
    this->initializeModel();
}

OAIFirewallsResponse::~OAIFirewallsResponse() {}

void OAIFirewallsResponse::initializeModel() {
...
void OAIFirewallsResponse::fromJson(QString jsonString) {
...
void OAIFirewallsResponse::fromJsonObject(QJsonObject json) {
...
QString OAIFirewallsResponse::asJson() const {
...
QJsonObject OAIFirewallsResponse::asJsonObject() const {
    QJsonObject obj;
...
QList<OAIFirewall> OAIFirewallsResponse::getFirewalls() const {
    return m_firewalls;
}
void OAIFirewallsResponse::setFirewalls(const QList<OAIFirewall> &firewalls) {
    m_firewalls = firewalls;
    m_firewalls_isSet = true;
}

bool OAIFirewallsResponse::is_firewalls_Set() const{
    return m_firewalls_isSet;
}

bool OAIFirewallsResponse::is_firewalls_Valid() const{
    return m_firewalls_isValid;
}

OAIActionsResponse_meta OAIFirewallsResponse::getMeta() const {
    return m_meta;
}
void OAIFirewallsResponse::setMeta(const OAIActionsResponse_meta &meta) {
    m_meta = meta;
    m_meta_isSet = true;
}

bool OAIFirewallsResponse::is_meta_Set() const{
    return m_meta_isSet;
}

bool OAIFirewallsResponse::is_meta_Valid() const{
    return m_meta_isValid;
}

bool OAIFirewallsResponse::isSet() const {
...
bool OAIFirewallsResponse::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_firewalls_isValid && true;
}
