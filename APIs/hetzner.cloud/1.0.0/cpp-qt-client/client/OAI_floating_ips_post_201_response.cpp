...
#include "OAI_floating_ips_post_201_response.h"
...
OAI_floating_ips_post_201_response::OAI_floating_ips_post_201_response(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAI_floating_ips_post_201_response::OAI_floating_ips_post_201_response() {
    this->initializeModel();
}

OAI_floating_ips_post_201_response::~OAI_floating_ips_post_201_response() {}

void OAI_floating_ips_post_201_response::initializeModel() {
...
void OAI_floating_ips_post_201_response::fromJson(QString jsonString) {
...
void OAI_floating_ips_post_201_response::fromJsonObject(QJsonObject json) {
...
QString OAI_floating_ips_post_201_response::asJson() const {
...
QJsonObject OAI_floating_ips_post_201_response::asJsonObject() const {
    QJsonObject obj;
    if (m_action.isSet()) {
...
OAIAction OAI_floating_ips_post_201_response::getAction() const {
    return m_action;
}
void OAI_floating_ips_post_201_response::setAction(const OAIAction &action) {
    m_action = action;
    m_action_isSet = true;
}

bool OAI_floating_ips_post_201_response::is_action_Set() const{
    return m_action_isSet;
}

bool OAI_floating_ips_post_201_response::is_action_Valid() const{
    return m_action_isValid;
}

OAI_floating_ips_get_200_response_floating_ips_inner OAI_floating_ips_post_201_response::getFloatingIp() const {
    return m_floating_ip;
}
void OAI_floating_ips_post_201_response::setFloatingIp(const OAI_floating_ips_get_200_response_floating_ips_inner &floating_ip) {
    m_floating_ip = floating_ip;
    m_floating_ip_isSet = true;
}

bool OAI_floating_ips_post_201_response::is_floating_ip_Set() const{
    return m_floating_ip_isSet;
}

bool OAI_floating_ips_post_201_response::is_floating_ip_Valid() const{
    return m_floating_ip_isValid;
}

bool OAI_floating_ips_post_201_response::isSet() const {
...
bool OAI_floating_ips_post_201_response::isValid() const {
