...
/*
 * OAI_servers_get_200_response_servers_inner_datacenter.h
 *
 * Datacenter this Resource is located at
 */

#ifndef OAI_servers_get_200_response_servers_inner_datacenter_H
#define OAI_servers_get_200_response_servers_inner_datacenter_H
...
class OAI_datacenters_get_200_response_datacenters_inner_server_types;

class OAI_servers_get_200_response_servers_inner_datacenter : public OAIObject {
public:
    OAI_servers_get_200_response_servers_inner_datacenter();
    OAI_servers_get_200_response_servers_inner_datacenter(QString json);
    ~OAI_servers_get_200_response_servers_inner_datacenter() override;
    ...
    OAI_datacenters_get_200_response_datacenters_inner_server_types getServerTypes() const;
    void setServerTypes(const OAI_datacenters_get_200_response_datacenters_inner_server_types &server_types);
...
private:
    ...
    OAI_datacenters_get_200_response_datacenters_inner_server_types m_server_types;
...
Q_DECLARE_METATYPE(OpenAPI::OAI_servers_get_200_response_servers_inner_datacenter)

#endif // OAI_servers_get_200_response_servers_inner_datacenter_H
