...
OAIAddSubnetRequest::OAIAddSubnetRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAddSubnetRequest::OAIAddSubnetRequest() {
    this->initializeModel();
}

OAIAddSubnetRequest::~OAIAddSubnetRequest() {}

void OAIAddSubnetRequest::initializeModel() {
...
void OAIAddSubnetRequest::fromJson(QString jsonString) {
...
void OAIAddSubnetRequest::fromJsonObject(QJsonObject json) {
...
QString OAIAddSubnetRequest::asJson() const {
...
QJsonObject OAIAddSubnetRequest::asJsonObject() const {
    QJsonObject obj;
    if (m_ip_range_isSet) {
...
QString OAIAddSubnetRequest::getIpRange() const {
    return m_ip_range;
}
void OAIAddSubnetRequest::setIpRange(const QString &ip_range) {
    m_ip_range = ip_range;
    m_ip_range_isSet = true;
}

bool OAIAddSubnetRequest::is_ip_range_Set() const{
    return m_ip_range_isSet;
}

bool OAIAddSubnetRequest::is_ip_range_Valid() const{
    return m_ip_range_isValid;
}

QString OAIAddSubnetRequest::getNetworkZone() const {
    return m_network_zone;
}
void OAIAddSubnetRequest::setNetworkZone(const QString &network_zone) {
    m_network_zone = network_zone;
    m_network_zone_isSet = true;
}

bool OAIAddSubnetRequest::is_network_zone_Set() const{
    return m_network_zone_isSet;
}

bool OAIAddSubnetRequest::is_network_zone_Valid() const{
    return m_network_zone_isValid;
}

QString OAIAddSubnetRequest::getType() const {
    return m_type;
}
void OAIAddSubnetRequest::setType(const QString &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAIAddSubnetRequest::is_type_Set() const{
    return m_type_isSet;
}

bool OAIAddSubnetRequest::is_type_Valid() const{
    return m_type_isValid;
}

qint32 OAIAddSubnetRequest::getVswitchId() const {
    return m_vswitch_id;
}
void OAIAddSubnetRequest::setVswitchId(const qint32 &vswitch_id) {
    m_vswitch_id = vswitch_id;
    m_vswitch_id_isSet = true;
}

bool OAIAddSubnetRequest::is_vswitch_id_Set() const{
    return m_vswitch_id_isSet;
}

bool OAIAddSubnetRequest::is_vswitch_id_Valid() const{
    return m_vswitch_id_isValid;
}

bool OAIAddSubnetRequest::isSet() const {
...
bool OAIAddSubnetRequest::isValid() const {
