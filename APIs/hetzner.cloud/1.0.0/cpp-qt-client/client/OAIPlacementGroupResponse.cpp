...
#include "OAIPlacementGroupResponse.h"
...
OAIPlacementGroupResponse::OAIPlacementGroupResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPlacementGroupResponse::OAIPlacementGroupResponse() {
    this->initializeModel();
}

OAIPlacementGroupResponse::~OAIPlacementGroupResponse() {}

void OAIPlacementGroupResponse::initializeModel() {

    m_placement_group_isSet = false;
    m_placement_group_isValid = false;
}

void OAIPlacementGroupResponse::fromJson(QString jsonString) {
...
void OAIPlacementGroupResponse::fromJsonObject(QJsonObject json) {
...
QString OAIPlacementGroupResponse::asJson() const {
...
QJsonObject OAIPlacementGroupResponse::asJsonObject() const {
    QJsonObject obj;
...
OAIPlacementGroup OAIPlacementGroupResponse::getPlacementGroup() const {
    return m_placement_group;
}
void OAIPlacementGroupResponse::setPlacementGroup(const OAIPlacementGroup &placement_group) {
    m_placement_group = placement_group;
    m_placement_group_isSet = true;
}

bool OAIPlacementGroupResponse::is_placement_group_Set() const{
    return m_placement_group_isSet;
}

bool OAIPlacementGroupResponse::is_placement_group_Valid() const{
    return m_placement_group_isValid;
}

bool OAIPlacementGroupResponse::isSet() const {
...
bool OAIPlacementGroupResponse::isValid() const {
