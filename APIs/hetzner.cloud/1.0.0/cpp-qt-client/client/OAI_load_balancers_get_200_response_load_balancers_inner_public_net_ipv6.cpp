...
#include "OAI_load_balancers_get_200_response_load_balancers_inner_public_net_ipv6.h"
...
OAI_load_balancers_get_200_response_load_balancers_inner_public_net_ipv6::OAI_load_balancers_get_200_response_load_balancers_inner_public_net_ipv6(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAI_load_balancers_get_200_response_load_balancers_inner_public_net_ipv6::OAI_load_balancers_get_200_response_load_balancers_inner_public_net_ipv6() {
    this->initializeModel();
}

OAI_load_balancers_get_200_response_load_balancers_inner_public_net_ipv6::~OAI_load_balancers_get_200_response_load_balancers_inner_public_net_ipv6() {}

void OAI_load_balancers_get_200_response_load_balancers_inner_public_net_ipv6::initializeModel() {
...
void OAI_load_balancers_get_200_response_load_balancers_inner_public_net_ipv6::fromJson(QString jsonString) {
...
void OAI_load_balancers_get_200_response_load_balancers_inner_public_net_ipv6::fromJsonObject(QJsonObject json) {
...
QString OAI_load_balancers_get_200_response_load_balancers_inner_public_net_ipv6::asJson() const {
...
QJsonObject OAI_load_balancers_get_200_response_load_balancers_inner_public_net_ipv6::asJsonObject() const {
    QJsonObject obj;
    if (m_dns_ptr_isSet) {
...
QString OAI_load_balancers_get_200_response_load_balancers_inner_public_net_ipv6::getDnsPtr() const {
    return m_dns_ptr;
}
void OAI_load_balancers_get_200_response_load_balancers_inner_public_net_ipv6::setDnsPtr(const QString &dns_ptr) {
    m_dns_ptr = dns_ptr;
    m_dns_ptr_isSet = true;
}

bool OAI_load_balancers_get_200_response_load_balancers_inner_public_net_ipv6::is_dns_ptr_Set() const{
    return m_dns_ptr_isSet;
}

bool OAI_load_balancers_get_200_response_load_balancers_inner_public_net_ipv6::is_dns_ptr_Valid() const{
    return m_dns_ptr_isValid;
}

QString OAI_load_balancers_get_200_response_load_balancers_inner_public_net_ipv6::getIp() const {
    return m_ip;
}
void OAI_load_balancers_get_200_response_load_balancers_inner_public_net_ipv6::setIp(const QString &ip) {
    m_ip = ip;
    m_ip_isSet = true;
}

bool OAI_load_balancers_get_200_response_load_balancers_inner_public_net_ipv6::is_ip_Set() const{
    return m_ip_isSet;
}

bool OAI_load_balancers_get_200_response_load_balancers_inner_public_net_ipv6::is_ip_Valid() const{
    return m_ip_isValid;
}

bool OAI_load_balancers_get_200_response_load_balancers_inner_public_net_ipv6::isSet() const {
...
bool OAI_load_balancers_get_200_response_load_balancers_inner_public_net_ipv6::isValid() const {
