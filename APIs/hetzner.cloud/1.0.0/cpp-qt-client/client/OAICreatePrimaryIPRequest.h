...
/*
 * OAICreatePrimaryIPRequest.h
 *
 * 
 */

#ifndef OAICreatePrimaryIPRequest_H
#define OAICreatePrimaryIPRequest_H
...
class OAICreatePrimaryIPRequest : public OAIObject {
public:
    OAICreatePrimaryIPRequest();
    OAICreatePrimaryIPRequest(QString json);
    ~OAICreatePrimaryIPRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreatePrimaryIPRequest)

#endif // OAICreatePrimaryIPRequest_H
