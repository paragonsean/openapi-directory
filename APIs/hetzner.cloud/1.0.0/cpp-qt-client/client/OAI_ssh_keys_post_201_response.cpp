...
#include "OAI_ssh_keys_post_201_response.h"
...
OAI_ssh_keys_post_201_response::OAI_ssh_keys_post_201_response(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAI_ssh_keys_post_201_response::OAI_ssh_keys_post_201_response() {
    this->initializeModel();
}

OAI_ssh_keys_post_201_response::~OAI_ssh_keys_post_201_response() {}

void OAI_ssh_keys_post_201_response::initializeModel() {

    m_ssh_key_isSet = false;
    m_ssh_key_isValid = false;
}

void OAI_ssh_keys_post_201_response::fromJson(QString jsonString) {
...
void OAI_ssh_keys_post_201_response::fromJsonObject(QJsonObject json) {
...
QString OAI_ssh_keys_post_201_response::asJson() const {
...
QJsonObject OAI_ssh_keys_post_201_response::asJsonObject() const {
    QJsonObject obj;
    if (m_ssh_key.isSet()) {
...
OAI_ssh_keys_get_200_response_ssh_keys_inner OAI_ssh_keys_post_201_response::getSshKey() const {
    return m_ssh_key;
}
void OAI_ssh_keys_post_201_response::setSshKey(const OAI_ssh_keys_get_200_response_ssh_keys_inner &ssh_key) {
    m_ssh_key = ssh_key;
    m_ssh_key_isSet = true;
}

bool OAI_ssh_keys_post_201_response::is_ssh_key_Set() const{
    return m_ssh_key_isSet;
}

bool OAI_ssh_keys_post_201_response::is_ssh_key_Valid() const{
    return m_ssh_key_isValid;
}

bool OAI_ssh_keys_post_201_response::isSet() const {
...
bool OAI_ssh_keys_post_201_response::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_ssh_key_isValid && true;
}
