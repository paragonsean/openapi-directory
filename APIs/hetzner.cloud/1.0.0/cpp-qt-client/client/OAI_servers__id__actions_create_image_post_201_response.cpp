...
OAI_servers__id__actions_create_image_post_201_response::OAI_servers__id__actions_create_image_post_201_response(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAI_servers__id__actions_create_image_post_201_response::OAI_servers__id__actions_create_image_post_201_response() {
    this->initializeModel();
}

OAI_servers__id__actions_create_image_post_201_response::~OAI_servers__id__actions_create_image_post_201_response() {}

void OAI_servers__id__actions_create_image_post_201_response::initializeModel() {
...
void OAI_servers__id__actions_create_image_post_201_response::fromJson(QString jsonString) {
...
void OAI_servers__id__actions_create_image_post_201_response::fromJsonObject(QJsonObject json) {
...
QString OAI_servers__id__actions_create_image_post_201_response::asJson() const {
...
QJsonObject OAI_servers__id__actions_create_image_post_201_response::asJsonObject() const {
    QJsonObject obj;
    if (m_action.isSet()) {
...
OAIAction OAI_servers__id__actions_create_image_post_201_response::getAction() const {
    return m_action;
}
void OAI_servers__id__actions_create_image_post_201_response::setAction(const OAIAction &action) {
    m_action = action;
    m_action_isSet = true;
}

bool OAI_servers__id__actions_create_image_post_201_response::is_action_Set() const{
    return m_action_isSet;
}

bool OAI_servers__id__actions_create_image_post_201_response::is_action_Valid() const{
    return m_action_isValid;
}

OAI_images_get_200_response_images_inner OAI_servers__id__actions_create_image_post_201_response::getImage() const {
    return m_image;
}
void OAI_servers__id__actions_create_image_post_201_response::setImage(const OAI_images_get_200_response_images_inner &image) {
    m_image = image;
    m_image_isSet = true;
}

bool OAI_servers__id__actions_create_image_post_201_response::is_image_Set() const{
    return m_image_isSet;
}

bool OAI_servers__id__actions_create_image_post_201_response::is_image_Valid() const{
    return m_image_isValid;
}

bool OAI_servers__id__actions_create_image_post_201_response::isSet() const {
...
bool OAI_servers__id__actions_create_image_post_201_response::isValid() const {
