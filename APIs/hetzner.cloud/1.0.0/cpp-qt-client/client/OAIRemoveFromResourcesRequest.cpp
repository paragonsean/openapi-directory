...
OAIRemoveFromResourcesRequest::OAIRemoveFromResourcesRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIRemoveFromResourcesRequest::OAIRemoveFromResourcesRequest() {
    this->initializeModel();
}

OAIRemoveFromResourcesRequest::~OAIRemoveFromResourcesRequest() {}

void OAIRemoveFromResourcesRequest::initializeModel() {

    m_remove_from_isSet = false;
    m_remove_from_isValid = false;
}

void OAIRemoveFromResourcesRequest::fromJson(QString jsonString) {
...
void OAIRemoveFromResourcesRequest::fromJsonObject(QJsonObject json) {

    m_remove_from_isValid = ::OpenAPI::fromJsonValue(m_remove_from, json[QString("remove_from")]);
    m_remove_from_isSet = !json[QString("remove_from")].isNull() && m_remove_from_isValid;
}

QString OAIRemoveFromResourcesRequest::asJson() const {
...
QJsonObject OAIRemoveFromResourcesRequest::asJsonObject() const {
    QJsonObject obj;
    if (m_remove_from.size() > 0) {
        obj.insert(QString("remove_from"), ::OpenAPI::toJsonValue(m_remove_from));
    }
    return obj;
}

QList<OAIFirewallRemoveFromResources> OAIRemoveFromResourcesRequest::getRemoveFrom() const {
    return m_remove_from;
}
void OAIRemoveFromResourcesRequest::setRemoveFrom(const QList<OAIFirewallRemoveFromResources> &remove_from) {
    m_remove_from = remove_from;
    m_remove_from_isSet = true;
}

bool OAIRemoveFromResourcesRequest::is_remove_from_Set() const{
    return m_remove_from_isSet;
}

bool OAIRemoveFromResourcesRequest::is_remove_from_Valid() const{
    return m_remove_from_isValid;
}

bool OAIRemoveFromResourcesRequest::isSet() const {
...
bool OAIRemoveFromResourcesRequest::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_remove_from_isValid && true;
}
