...
namespace OpenAPI {
class OAICertificate_status;
class OAICertificate_used_by_inner;
...
public:
    ...
    OAICertificate_status getStatus() const;
    void setStatus(const OAICertificate_status &status);
    ...
    QList<OAICertificate_used_by_inner> getUsedBy() const;
    void setUsedBy(const QList<OAICertificate_used_by_inner> &used_by);
...
private:
    ...
    OAICertificate_status m_status;
    bool m_status_isSet;
    ...
    QList<OAICertificate_used_by_inner> m_used_by;
