...
/*
 * OAILoadBalancerServiceHealthCheck.h
 *
 * Service health check
 */

#ifndef OAILoadBalancerServiceHealthCheck_H
#define OAILoadBalancerServiceHealthCheck_H
...
namespace OpenAPI {
class OAILoadBalancerServiceHealthCheck_http;

class OAILoadBalancerServiceHealthCheck : public OAIObject {
public:
    OAILoadBalancerServiceHealthCheck();
    OAILoadBalancerServiceHealthCheck(QString json);
    ~OAILoadBalancerServiceHealthCheck() override;
    ...
    OAILoadBalancerServiceHealthCheck_http getHttp() const;
    void setHttp(const OAILoadBalancerServiceHealthCheck_http &http);
...
private:
    ...
    OAILoadBalancerServiceHealthCheck_http m_http;
    bool m_http_isSet;
    bool m_http_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAILoadBalancerServiceHealthCheck)

#endif // OAILoadBalancerServiceHealthCheck_H
