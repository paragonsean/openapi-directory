...
OAI_load_balancers_get_200_response_load_balancers_inner_algorithm::OAI_load_balancers_get_200_response_load_balancers_inner_algorithm(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAI_load_balancers_get_200_response_load_balancers_inner_algorithm::OAI_load_balancers_get_200_response_load_balancers_inner_algorithm() {
    this->initializeModel();
}

OAI_load_balancers_get_200_response_load_balancers_inner_algorithm::~OAI_load_balancers_get_200_response_load_balancers_inner_algorithm() {}

void OAI_load_balancers_get_200_response_load_balancers_inner_algorithm::initializeModel() {

    m_type_isSet = false;
    m_type_isValid = false;
}

void OAI_load_balancers_get_200_response_load_balancers_inner_algorithm::fromJson(QString jsonString) {
...
void OAI_load_balancers_get_200_response_load_balancers_inner_algorithm::fromJsonObject(QJsonObject json) {

    m_type_isValid = ::OpenAPI::fromJsonValue(m_type, json[QString("type")]);
    m_type_isSet = !json[QString("type")].isNull() && m_type_isValid;
}

QString OAI_load_balancers_get_200_response_load_balancers_inner_algorithm::asJson() const {
...
QJsonObject OAI_load_balancers_get_200_response_load_balancers_inner_algorithm::asJsonObject() const {
    QJsonObject obj;
    if (m_type_isSet) {
...
QString OAI_load_balancers_get_200_response_load_balancers_inner_algorithm::getType() const {
    return m_type;
}
void OAI_load_balancers_get_200_response_load_balancers_inner_algorithm::setType(const QString &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAI_load_balancers_get_200_response_load_balancers_inner_algorithm::is_type_Set() const{
    return m_type_isSet;
}

bool OAI_load_balancers_get_200_response_load_balancers_inner_algorithm::is_type_Valid() const{
    return m_type_isValid;
}

bool OAI_load_balancers_get_200_response_load_balancers_inner_algorithm::isSet() const {
...
bool OAI_load_balancers_get_200_response_load_balancers_inner_algorithm::isValid() const {
