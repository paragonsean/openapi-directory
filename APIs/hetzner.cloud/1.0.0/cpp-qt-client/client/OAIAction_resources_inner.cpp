...
#include "OAIAction_resources_inner.h"
...
OAIAction_resources_inner::OAIAction_resources_inner(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAction_resources_inner::OAIAction_resources_inner() {
    this->initializeModel();
}

OAIAction_resources_inner::~OAIAction_resources_inner() {}

void OAIAction_resources_inner::initializeModel() {
...
void OAIAction_resources_inner::fromJson(QString jsonString) {
...
void OAIAction_resources_inner::fromJsonObject(QJsonObject json) {
...
QString OAIAction_resources_inner::asJson() const {
...
QJsonObject OAIAction_resources_inner::asJsonObject() const {
    QJsonObject obj;
    if (m_id_isSet) {
...
qint32 OAIAction_resources_inner::getId() const {
    return m_id;
}
void OAIAction_resources_inner::setId(const qint32 &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIAction_resources_inner::is_id_Set() const{
    return m_id_isSet;
}

bool OAIAction_resources_inner::is_id_Valid() const{
    return m_id_isValid;
}

QString OAIAction_resources_inner::getType() const {
    return m_type;
}
void OAIAction_resources_inner::setType(const QString &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAIAction_resources_inner::is_type_Set() const{
    return m_type_isSet;
}

bool OAIAction_resources_inner::is_type_Valid() const{
    return m_type_isValid;
}

bool OAIAction_resources_inner::isSet() const {
...
bool OAIAction_resources_inner::isValid() const {
