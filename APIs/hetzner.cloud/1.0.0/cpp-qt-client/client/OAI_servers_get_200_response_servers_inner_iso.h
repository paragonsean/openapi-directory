...
/*
 * OAI_servers_get_200_response_servers_inner_iso.h
 *
 * ISO Image that is attached to this Server. Null if no ISO is attached.
 */

#ifndef OAI_servers_get_200_response_servers_inner_iso_H
#define OAI_servers_get_200_response_servers_inner_iso_H
...
class OAI_servers_get_200_response_servers_inner_iso : public OAIObject {
public:
    OAI_servers_get_200_response_servers_inner_iso();
    OAI_servers_get_200_response_servers_inner_iso(QString json);
    ~OAI_servers_get_200_response_servers_inner_iso() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAI_servers_get_200_response_servers_inner_iso)

#endif // OAI_servers_get_200_response_servers_inner_iso_H
