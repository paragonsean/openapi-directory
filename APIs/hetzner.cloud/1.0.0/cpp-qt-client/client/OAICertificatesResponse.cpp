...
OAICertificatesResponse::OAICertificatesResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICertificatesResponse::OAICertificatesResponse() {
    this->initializeModel();
}

OAICertificatesResponse::~OAICertificatesResponse() {}

void OAICertificatesResponse::initializeModel() {
...
void OAICertificatesResponse::fromJson(QString jsonString) {
...
void OAICertificatesResponse::fromJsonObject(QJsonObject json) {
...
QString OAICertificatesResponse::asJson() const {
...
QJsonObject OAICertificatesResponse::asJsonObject() const {
    QJsonObject obj;
...
QList<OAICertificate> OAICertificatesResponse::getCertificates() const {
    return m_certificates;
}
void OAICertificatesResponse::setCertificates(const QList<OAICertificate> &certificates) {
    m_certificates = certificates;
    m_certificates_isSet = true;
}

bool OAICertificatesResponse::is_certificates_Set() const{
    return m_certificates_isSet;
}

bool OAICertificatesResponse::is_certificates_Valid() const{
    return m_certificates_isValid;
}

OAIActionsResponse_meta OAICertificatesResponse::getMeta() const {
    return m_meta;
}
void OAICertificatesResponse::setMeta(const OAIActionsResponse_meta &meta) {
    m_meta = meta;
    m_meta_isSet = true;
}

bool OAICertificatesResponse::is_meta_Set() const{
    return m_meta_isSet;
}

bool OAICertificatesResponse::is_meta_Valid() const{
    return m_meta_isValid;
}

bool OAICertificatesResponse::isSet() const {
...
bool OAICertificatesResponse::isValid() const {
