...
OAISetRulesRequest::OAISetRulesRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISetRulesRequest::OAISetRulesRequest() {
    this->initializeModel();
}

OAISetRulesRequest::~OAISetRulesRequest() {}

void OAISetRulesRequest::initializeModel() {

    m_rules_isSet = false;
    m_rules_isValid = false;
}

void OAISetRulesRequest::fromJson(QString jsonString) {
...
QJsonObject OAISetRulesRequest::asJsonObject() const {
    QJsonObject obj;
    if (m_rules.size() > 0) {
...
QList<OAIRule> OAISetRulesRequest::getRules() const {
    return m_rules;
}
void OAISetRulesRequest::setRules(const QList<OAIRule> &rules) {
    m_rules = rules;
    m_rules_isSet = true;
}

bool OAISetRulesRequest::is_rules_Set() const{
    return m_rules_isSet;
}

bool OAISetRulesRequest::is_rules_Valid() const{
    return m_rules_isValid;
}

bool OAISetRulesRequest::isSet() const {
...
bool OAISetRulesRequest::isValid() const {
