...
OAIObject OAIUpdateCertificateRequest::getLabels() const {
    return m_labels;
}
void OAIUpdateCertificateRequest::setLabels(const OAIObject &labels) {
    m_labels = labels;
    m_labels_isSet = true;
}

bool OAIUpdateCertificateRequest::is_labels_Set() const{
    return m_labels_isSet;
}

bool OAIUpdateCertificateRequest::is_labels_Valid() const{
    return m_labels_isValid;
}

QString OAIUpdateCertificateRequest::getName() const {
    return m_name;
}
void OAIUpdateCertificateRequest::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIUpdateCertificateRequest::is_name_Set() const{
    return m_name_isSet;
}

bool OAIUpdateCertificateRequest::is_name_Valid() const{
