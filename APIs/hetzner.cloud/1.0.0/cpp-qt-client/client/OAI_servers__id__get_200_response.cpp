...
OAI_servers__id__get_200_response::OAI_servers__id__get_200_response(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAI_servers__id__get_200_response::OAI_servers__id__get_200_response() {
    this->initializeModel();
}

OAI_servers__id__get_200_response::~OAI_servers__id__get_200_response() {}

void OAI_servers__id__get_200_response::initializeModel() {

    m_server_isSet = false;
    m_server_isValid = false;
}

void OAI_servers__id__get_200_response::fromJson(QString jsonString) {
...
void OAI_servers__id__get_200_response::fromJsonObject(QJsonObject json) {
...
QString OAI_servers__id__get_200_response::asJson() const {
...
QJsonObject OAI_servers__id__get_200_response::asJsonObject() const {
    QJsonObject obj;
    if (m_server.isSet()) {
...
OAI_servers_get_200_response_servers_inner OAI_servers__id__get_200_response::getServer() const {
    return m_server;
}
void OAI_servers__id__get_200_response::setServer(const OAI_servers_get_200_response_servers_inner &server) {
    m_server = server;
    m_server_isSet = true;
}

bool OAI_servers__id__get_200_response::is_server_Set() const{
    return m_server_isSet;
}

bool OAI_servers__id__get_200_response::is_server_Valid() const{
    return m_server_isValid;
}

bool OAI_servers__id__get_200_response::isSet() const {
...
bool OAI_servers__id__get_200_response::isValid() const {
