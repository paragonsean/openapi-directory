...
/*
 * OAIPrimaryIP_datacenter.h
 *
 * Datacenter this Primary IP is located at
 */

#ifndef OAIPrimaryIP_datacenter_H
#define OAIPrimaryIP_datacenter_H
...
class OAIPrimaryIP_datacenter : public OAIObject {
public:
    OAIPrimaryIP_datacenter();
    OAIPrimaryIP_datacenter(QString json);
    ~OAIPrimaryIP_datacenter() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPrimaryIP_datacenter)

#endif // OAIPrimaryIP_datacenter_H
