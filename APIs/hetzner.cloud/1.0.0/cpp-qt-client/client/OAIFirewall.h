...
#ifndef OAIFirewall_H
#define OAIFirewall_H

#include <QJsonObject>

#include "OAIFirewall_applied_to_inner.h"
#include "OAIRule.h"
#include <QList>
#include <QMap>
#include <QString>
...
namespace OpenAPI {
class OAIFirewall_applied_to_inner;
class OAIRule;

class OAIFirewall : public OAIObject {
public:
    OAIFirewall();
    OAIFirewall(QString json);
    ~OAIFirewall() override;
    ...
    QList<OAIFirewall_applied_to_inner> getAppliedTo() const;
    void setAppliedTo(const QList<OAIFirewall_applied_to_inner> &applied_to);
...
private:
    ...
    QList<OAIFirewall_applied_to_inner> m_applied_to;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFirewall)
