...
/*
 * OAIActionsResponse_meta_pagination.h
 *
 * 
 */

#ifndef OAIActionsResponse_meta_pagination_H
#define OAIActionsResponse_meta_pagination_H
...
class OAIActionsResponse_meta_pagination : public OAIObject {
public:
    OAIActionsResponse_meta_pagination();
    OAIActionsResponse_meta_pagination(QString json);
    ~OAIActionsResponse_meta_pagination() override;
    ...
    double getLastPage() const;
    void setLastPage(const double &last_page);
    bool is_last_page_Set() const;
    bool is_last_page_Valid() const;

    double getNextPage() const;
    void setNextPage(const double &next_page);
    ...
    double getPreviousPage() const;
    void setPreviousPage(const double &previous_page);
    bool is_previous_page_Set() const;
    bool is_previous_page_Valid() const;

    double getTotalEntries() const;
    void setTotalEntries(const double &total_entries);
...
Q_DECLARE_METATYPE(OpenAPI::OAIActionsResponse_meta_pagination)

#endif // OAIActionsResponse_meta_pagination_H
