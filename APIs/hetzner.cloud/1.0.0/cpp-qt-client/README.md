...
void Example::exampleFunction1(){
     OAIActionsApi apiInstance;
      ...
      QEventLoop loop;
      connect(&apiInstance, &OAIActionsApi::actionsGetSignal, [&]() {
          loop.quit();
      });
      connect(&apiInstance, &OAIActionsApi::actionsGetSignalE, [&](QNetworkReply::NetworkError, QString error_str) {
          qDebug() << "Error happened while issuing request : " << error_str;
          loop.quit();
      });

      qint32 id = create(); // qint32 | Can be used multiple times, the response will contain only Actions with specified IDs
      ...
      QString sort = create(); // QString | Can be used multiple times.
      ...
      QString status = create(); // QString | Can be used multiple times, the response will contain only Actions with specified statuses
      apiInstance.actionsGet(idsortstatus);
