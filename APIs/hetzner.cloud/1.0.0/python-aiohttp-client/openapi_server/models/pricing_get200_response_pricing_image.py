...
class PricingGet200ResponsePricingImage(Model):
    ...
    def __init__(self, price_per_gb_month: PricingGet200ResponsePricingFloatingIpPriceMonthly=None):
        """PricingGet200ResponsePricingImage - a model defined in OpenAPI

        :param price_per_gb_month: The price_per_gb_month of this PricingGet200ResponsePricingImage.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'PricingGet200ResponsePricingImage':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The _pricing_get_200_response_pricing_image of this PricingGet200ResponsePricingImage.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def price_per_gb_month(self):
        """Gets the price_per_gb_month of this PricingGet200ResponsePricingImage.


        :return: The price_per_gb_month of this PricingGet200ResponsePricingImage.
    ...
    def price_per_gb_month(self, price_per_gb_month):
        """Sets the price_per_gb_month of this PricingGet200ResponsePricingImage.
