...
class Action(Model):
    ...
    def __init__(self, command: str=None, error: ActionError=None, finished: str=None, id: int=None, progress: float=None, resources: List[ActionResourcesInner]=None, started: str=None, status: str=None):
        ...
        :param error: The error of this Action.
        :param finished: The finished of this Action.
        :param id: The id of this Action.
        :param progress: The progress of this Action.
        :param resources: The resources of this Action.
        :param started: The started of this Action.
    ...
    @property
    def error(self):
        """Gets the error of this Action.


        :return: The error of this Action.
        :rtype: ActionError
        """
        return self._error
    ...
    @property
    def finished(self):
        """Gets the finished of this Action.

        Point in time when the Action was finished (in ISO-8601 format). Only set if the Action is finished otherwise null.

        :return: The finished of this Action.
        :rtype: str
        """
    ...
    def finished(self, finished):
        """Sets the finished of this Action.
    ...
    @property
    def progress(self):
        """Gets the progress of this Action.

        Progress of Action in percent

        :return: The progress of this Action.
        :rtype: float
        """
    ...
    @property
    def started(self):
        """Gets the started of this Action.

        Point in time when the Action was started (in ISO-8601 format)

        :return: The started of this Action.
        :rtype: str
        """
    ...
    def started(self, started):
        """Sets the started of this Action.
