...
public class ImagesApiTest {
    ...
    public void imagesGetTest() throws ApiException {
        ...
        ImagesGet200Response response = api.imagesGet(sort, type, status, boundTo, includeDeprecated, name, labelSelector, architecture);
    ...
    public void imagesIdGetTest() throws ApiException {
        Integer id = null;
        ImagesIdGet200Response response = api.imagesIdGet(id);
        // TODO: test validations
    }
     ...
     */
    @Test
    public void imagesIdPutTest() throws ApiException {
        Integer id = null;
        UpdateImageRequest updateImageRequest = null;
        ImagesIdGet200Response response = api.imagesIdPut(id, updateImageRequest);
        // TODO: test validations
    }
