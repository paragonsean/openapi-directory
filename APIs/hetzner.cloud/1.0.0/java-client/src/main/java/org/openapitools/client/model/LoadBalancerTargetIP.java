...
public class LoadBalancerTargetIP {
  ...
  public LoadBalancerTargetIP() {
  }

  public LoadBalancerTargetIP ip(String ip) {
    this.ip = ip;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    LoadBalancerTargetIP loadBalancerTargetIP = (LoadBalancerTargetIP) o;
    return Objects.equals(this.ip, loadBalancerTargetIP.ip);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to LoadBalancerTargetIP
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LoadBalancerTargetIP.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LoadBalancerTargetIP is not found in the empty JSON string", LoadBalancerTargetIP.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LoadBalancerTargetIP.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LoadBalancerTargetIP` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LoadBalancerTargetIP.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LoadBalancerTargetIP.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LoadBalancerTargetIP' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LoadBalancerTargetIP> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LoadBalancerTargetIP.class));

       return (TypeAdapter<T>) new TypeAdapter<LoadBalancerTargetIP>() {
           @Override
           public void write(JsonWriter out, LoadBalancerTargetIP value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LoadBalancerTargetIP read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LoadBalancerTargetIP given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LoadBalancerTargetIP
   * @throws IOException if the JSON string is invalid with respect to LoadBalancerTargetIP
   */
  public static LoadBalancerTargetIP fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LoadBalancerTargetIP.class);
  }

  /**
   * Convert an instance of LoadBalancerTargetIP to an JSON string
   *
   * @return JSON string
   */
