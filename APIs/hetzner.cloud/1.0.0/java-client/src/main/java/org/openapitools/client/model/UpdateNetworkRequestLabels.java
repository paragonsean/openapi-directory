...
public class UpdateNetworkRequestLabels {
  public static final String SERIALIZED_NAME_LABELKEY = "labelkey";
  @SerializedName(SERIALIZED_NAME_LABELKEY)
  private String labelkey;

  public UpdateNetworkRequestLabels() {
  }

  public UpdateNetworkRequestLabels labelkey(String labelkey) {
  ...
  public boolean equals(Object o) {
    ...
    UpdateNetworkRequestLabels updateNetworkRequestLabels = (UpdateNetworkRequestLabels) o;
    return Objects.equals(this.labelkey, updateNetworkRequestLabels.labelkey);
  }

  @Override
  public int hashCode() {
    return Objects.hash(labelkey);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class UpdateNetworkRequestLabels {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateNetworkRequestLabels
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateNetworkRequestLabels.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateNetworkRequestLabels is not found in the empty JSON string", UpdateNetworkRequestLabels.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateNetworkRequestLabels.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateNetworkRequestLabels` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateNetworkRequestLabels.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateNetworkRequestLabels' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateNetworkRequestLabels> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateNetworkRequestLabels.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateNetworkRequestLabels>() {
           @Override
           public void write(JsonWriter out, UpdateNetworkRequestLabels value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateNetworkRequestLabels read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateNetworkRequestLabels given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateNetworkRequestLabels
   * @throws IOException if the JSON string is invalid with respect to UpdateNetworkRequestLabels
   */
  public static UpdateNetworkRequestLabels fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateNetworkRequestLabels.class);
  }

  /**
   * Convert an instance of UpdateNetworkRequestLabels to an JSON string
   *
   * @return JSON string
   */
