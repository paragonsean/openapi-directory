...
import org.openapitools.client.model.SshKeysGet200ResponseSshKeysInner;
...
public class SshKeysPost201Response {
  public static final String SERIALIZED_NAME_SSH_KEY = "ssh_key";
  @SerializedName(SERIALIZED_NAME_SSH_KEY)
  private SshKeysGet200ResponseSshKeysInner sshKey;

  public SshKeysPost201Response() {
  }

  public SshKeysPost201Response sshKey(SshKeysGet200ResponseSshKeysInner sshKey) {
    this.sshKey = sshKey;
    return this;
  }
  ...
  public SshKeysGet200ResponseSshKeysInner getSshKey() {
    return sshKey;
  }

  public void setSshKey(SshKeysGet200ResponseSshKeysInner sshKey) {
    this.sshKey = sshKey;
  }
  ...
  public boolean equals(Object o) {
    ...
    SshKeysPost201Response sshKeysPost201Response = (SshKeysPost201Response) o;
    return Objects.equals(this.sshKey, sshKeysPost201Response.sshKey);
  }
  ...
  public String toString() {
    ...
    sb.append("class SshKeysPost201Response {\n");
  ...
  static {
    ...
    openapiFields.add("ssh_key");

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>();
    openapiRequiredFields.add("ssh_key");
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to SshKeysPost201Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SshKeysPost201Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SshKeysPost201Response is not found in the empty JSON string", SshKeysPost201Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SshKeysPost201Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SshKeysPost201Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : SshKeysPost201Response.openapiRequiredFields) {
        if (jsonElement.getAsJsonObject().get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the required field `ssh_key`
      SshKeysGet200ResponseSshKeysInner.validateJsonElement(jsonObj.get("ssh_key"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SshKeysPost201Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SshKeysPost201Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SshKeysPost201Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SshKeysPost201Response.class));

       return (TypeAdapter<T>) new TypeAdapter<SshKeysPost201Response>() {
           @Override
           public void write(JsonWriter out, SshKeysPost201Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SshKeysPost201Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SshKeysPost201Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SshKeysPost201Response
   * @throws IOException if the JSON string is invalid with respect to SshKeysPost201Response
   */
  public static SshKeysPost201Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SshKeysPost201Response.class);
  }

  /**
   * Convert an instance of SshKeysPost201Response to an JSON string
   *
   * @return JSON string
   */
