...
public class PrimaryIPsResponse {
  ...
  private List<PrimaryIP> primaryIps = new ArrayList<>();

  public PrimaryIPsResponse() {
  }

  public PrimaryIPsResponse meta(ActionsResponseMeta meta) {
    this.meta = meta;
    return this;
  }
  ...
  public PrimaryIPsResponse primaryIps(List<PrimaryIP> primaryIps) {
    this.primaryIps = primaryIps;
    return this;
  }

  public PrimaryIPsResponse addPrimaryIpsItem(PrimaryIP primaryIpsItem) {
  ...
  public void setPrimaryIps(List<PrimaryIP> primaryIps) {
    this.primaryIps = primaryIps;
  }
  ...
  public boolean equals(Object o) {
    ...
    PrimaryIPsResponse primaryIPsResponse = (PrimaryIPsResponse) o;
    return Objects.equals(this.meta, primaryIPsResponse.meta) &&
        Objects.equals(this.primaryIps, primaryIPsResponse.primaryIps);
  }

  @Override
  public int hashCode() {
    return Objects.hash(meta, primaryIps);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to PrimaryIPsResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PrimaryIPsResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PrimaryIPsResponse is not found in the empty JSON string", PrimaryIPsResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PrimaryIPsResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PrimaryIPsResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PrimaryIPsResponse.openapiRequiredFields) {
      ...
      for (int i = 0; i < jsonArrayprimaryIps.size(); i++) {
        PrimaryIP.validateJsonElement(jsonArrayprimaryIps.get(i));
      };
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PrimaryIPsResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PrimaryIPsResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PrimaryIPsResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PrimaryIPsResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<PrimaryIPsResponse>() {
           @Override
           public void write(JsonWriter out, PrimaryIPsResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PrimaryIPsResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PrimaryIPsResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PrimaryIPsResponse
   * @throws IOException if the JSON string is invalid with respect to PrimaryIPsResponse
   */
  public static PrimaryIPsResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PrimaryIPsResponse.class);
  }

  /**
   * Convert an instance of PrimaryIPsResponse to an JSON string
   *
   * @return JSON string
   */
