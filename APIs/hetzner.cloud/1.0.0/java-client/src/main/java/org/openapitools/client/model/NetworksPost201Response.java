...
public class NetworksPost201Response {
  public static final String SERIALIZED_NAME_NETWORK = "network";
  @SerializedName(SERIALIZED_NAME_NETWORK)
  private NetworksGet200ResponseNetworksInner network;

  public NetworksPost201Response() {
  }

  public NetworksPost201Response network(NetworksGet200ResponseNetworksInner network) {
  ...
  public NetworksGet200ResponseNetworksInner getNetwork() {
    return network;
  }

  public void setNetwork(NetworksGet200ResponseNetworksInner network) {
    this.network = network;
  }
  ...
  public boolean equals(Object o) {
    ...
    NetworksPost201Response networksPost201Response = (NetworksPost201Response) o;
    return Objects.equals(this.network, networksPost201Response.network);
  }
  ...
  public String toString() {
    ...
    sb.append("class NetworksPost201Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to NetworksPost201Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!NetworksPost201Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in NetworksPost201Response is not found in the empty JSON string", NetworksPost201Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!NetworksPost201Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `NetworksPost201Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `network`
      if (jsonObj.get("network") != null && !jsonObj.get("network").isJsonNull()) {
        NetworksGet200ResponseNetworksInner.validateJsonElement(jsonObj.get("network"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!NetworksPost201Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'NetworksPost201Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<NetworksPost201Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(NetworksPost201Response.class));

       return (TypeAdapter<T>) new TypeAdapter<NetworksPost201Response>() {
           @Override
           public void write(JsonWriter out, NetworksPost201Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public NetworksPost201Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of NetworksPost201Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of NetworksPost201Response
   * @throws IOException if the JSON string is invalid with respect to NetworksPost201Response
   */
  public static NetworksPost201Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, NetworksPost201Response.class);
  }

  /**
   * Convert an instance of NetworksPost201Response to an JSON string
   *
   * @return JSON string
   */
