...
public class ChangeProtectionRequest1 {
  public static final String SERIALIZED_NAME_DELETE = "delete";
  @SerializedName(SERIALIZED_NAME_DELETE)
  private Boolean delete;

  public ChangeProtectionRequest1() {
  }

  public ChangeProtectionRequest1 delete(Boolean delete) {
    this.delete = delete;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    ChangeProtectionRequest1 changeProtectionRequest1 = (ChangeProtectionRequest1) o;
    return Objects.equals(this.delete, changeProtectionRequest1.delete);
  }
  ...
  public String toString() {
    ...
    sb.append("class ChangeProtectionRequest1 {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ChangeProtectionRequest1
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ChangeProtectionRequest1.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ChangeProtectionRequest1 is not found in the empty JSON string", ChangeProtectionRequest1.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ChangeProtectionRequest1.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ChangeProtectionRequest1` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ChangeProtectionRequest1.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ChangeProtectionRequest1' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ChangeProtectionRequest1> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ChangeProtectionRequest1.class));

       return (TypeAdapter<T>) new TypeAdapter<ChangeProtectionRequest1>() {
           @Override
           public void write(JsonWriter out, ChangeProtectionRequest1 value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ChangeProtectionRequest1 read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ChangeProtectionRequest1 given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ChangeProtectionRequest1
   * @throws IOException if the JSON string is invalid with respect to ChangeProtectionRequest1
   */
  public static ChangeProtectionRequest1 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ChangeProtectionRequest1.class);
  }

  /**
   * Convert an instance of ChangeProtectionRequest1 to an JSON string
   *
   * @return JSON string
   */
