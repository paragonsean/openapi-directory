...
import org.openapitools.client.model.VolumesGet200ResponseVolumesInner;
...
public class VolumesPost201Response {
  ...
  private VolumesGet200ResponseVolumesInner volume;

  public VolumesPost201Response() {
  }

  public VolumesPost201Response action(Action action) {
    this.action = action;
    return this;
  }
  ...
  public VolumesPost201Response nextActions(List<Action> nextActions) {
    this.nextActions = nextActions;
    return this;
  }

  public VolumesPost201Response addNextActionsItem(Action nextActionsItem) {
  ...
  public VolumesPost201Response volume(VolumesGet200ResponseVolumesInner volume) {
    this.volume = volume;
    return this;
  }
   ...
   */
  @javax.annotation.Nonnull
  public VolumesGet200ResponseVolumesInner getVolume() {
    return volume;
  }

  public void setVolume(VolumesGet200ResponseVolumesInner volume) {
    this.volume = volume;
  }
  ...
  public boolean equals(Object o) {
    ...
    VolumesPost201Response volumesPost201Response = (VolumesPost201Response) o;
    return Objects.equals(this.action, volumesPost201Response.action) &&
        Objects.equals(this.nextActions, volumesPost201Response.nextActions) &&
        Objects.equals(this.volume, volumesPost201Response.volume);
  }

  @Override
  public int hashCode() {
    return Objects.hash(action, nextActions, volume);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class VolumesPost201Response {\n");
  ...
  static {
    ...
    openapiRequiredFields.add("next_actions");
   ...
   * @throws IOException if the JSON Element is invalid with respect to VolumesPost201Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!VolumesPost201Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in VolumesPost201Response is not found in the empty JSON string", VolumesPost201Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!VolumesPost201Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `VolumesPost201Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : VolumesPost201Response.openapiRequiredFields) {
      ...
      // validate the required field `next_actions` (array)
      for (int i = 0; i < jsonArraynextActions.size(); i++) {
        Action.validateJsonElement(jsonArraynextActions.get(i));
      };
      // validate the required field `volume`
      VolumesGet200ResponseVolumesInner.validateJsonElement(jsonObj.get("volume"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!VolumesPost201Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'VolumesPost201Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<VolumesPost201Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(VolumesPost201Response.class));

       return (TypeAdapter<T>) new TypeAdapter<VolumesPost201Response>() {
           @Override
           public void write(JsonWriter out, VolumesPost201Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public VolumesPost201Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of VolumesPost201Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of VolumesPost201Response
   * @throws IOException if the JSON string is invalid with respect to VolumesPost201Response
   */
  public static VolumesPost201Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, VolumesPost201Response.class);
  }

  /**
   * Convert an instance of VolumesPost201Response to an JSON string
   *
   * @return JSON string
   */
