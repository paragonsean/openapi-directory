...
public class ServersIdActionsChangeTypePostRequest {
  public static final String SERIALIZED_NAME_SERVER_TYPE = "server_type";
  @SerializedName(SERIALIZED_NAME_SERVER_TYPE)
  private String serverType;

  public static final String SERIALIZED_NAME_UPGRADE_DISK = "upgrade_disk";
  @SerializedName(SERIALIZED_NAME_UPGRADE_DISK)
  private Boolean upgradeDisk;

  public ServersIdActionsChangeTypePostRequest() {
  }

  public ServersIdActionsChangeTypePostRequest serverType(String serverType) {
  ...
  public ServersIdActionsChangeTypePostRequest upgradeDisk(Boolean upgradeDisk) {
  ...
  public boolean equals(Object o) {
    ...
    ServersIdActionsChangeTypePostRequest serversIdActionsChangeTypePostRequest = (ServersIdActionsChangeTypePostRequest) o;
    return Objects.equals(this.serverType, serversIdActionsChangeTypePostRequest.serverType) &&
        Objects.equals(this.upgradeDisk, serversIdActionsChangeTypePostRequest.upgradeDisk);
  }

  @Override
  public int hashCode() {
    return Objects.hash(serverType, upgradeDisk);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ServersIdActionsChangeTypePostRequest {\n");
    sb.append("    serverType: ").append(toIndentedString(serverType)).append("\n");
    sb.append("    upgradeDisk: ").append(toIndentedString(upgradeDisk)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("upgrade_disk");

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>();
    openapiRequiredFields.add("server_type");
    openapiRequiredFields.add("upgrade_disk");
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ServersIdActionsChangeTypePostRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ServersIdActionsChangeTypePostRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ServersIdActionsChangeTypePostRequest is not found in the empty JSON string", ServersIdActionsChangeTypePostRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ServersIdActionsChangeTypePostRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ServersIdActionsChangeTypePostRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ServersIdActionsChangeTypePostRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ServersIdActionsChangeTypePostRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ServersIdActionsChangeTypePostRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ServersIdActionsChangeTypePostRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ServersIdActionsChangeTypePostRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<ServersIdActionsChangeTypePostRequest>() {
           @Override
           public void write(JsonWriter out, ServersIdActionsChangeTypePostRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ServersIdActionsChangeTypePostRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ServersIdActionsChangeTypePostRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ServersIdActionsChangeTypePostRequest
   * @throws IOException if the JSON string is invalid with respect to ServersIdActionsChangeTypePostRequest
   */
  public static ServersIdActionsChangeTypePostRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ServersIdActionsChangeTypePostRequest.class);
  }

  /**
   * Convert an instance of ServersIdActionsChangeTypePostRequest to an JSON string
   *
   * @return JSON string
   */
