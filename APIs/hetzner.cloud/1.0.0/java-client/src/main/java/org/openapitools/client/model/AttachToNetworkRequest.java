...
public class AttachToNetworkRequest {
  ...
  public AttachToNetworkRequest() {
  }

  public AttachToNetworkRequest aliasIps(List<String> aliasIps) {
    this.aliasIps = aliasIps;
    return this;
  }

  public AttachToNetworkRequest addAliasIpsItem(String aliasIpsItem) {
  ...
  public AttachToNetworkRequest ip(String ip) {
    this.ip = ip;
    return this;
  }
  ...
  public AttachToNetworkRequest network(Integer network) {
  ...
  public boolean equals(Object o) {
    ...
    AttachToNetworkRequest attachToNetworkRequest = (AttachToNetworkRequest) o;
    return Objects.equals(this.aliasIps, attachToNetworkRequest.aliasIps) &&
        Objects.equals(this.ip, attachToNetworkRequest.ip) &&
        Objects.equals(this.network, attachToNetworkRequest.network);
  }

  @Override
  public int hashCode() {
    return Objects.hash(aliasIps, ip, network);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to AttachToNetworkRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AttachToNetworkRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AttachToNetworkRequest is not found in the empty JSON string", AttachToNetworkRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AttachToNetworkRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AttachToNetworkRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AttachToNetworkRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AttachToNetworkRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AttachToNetworkRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AttachToNetworkRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AttachToNetworkRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<AttachToNetworkRequest>() {
           @Override
           public void write(JsonWriter out, AttachToNetworkRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AttachToNetworkRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AttachToNetworkRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AttachToNetworkRequest
   * @throws IOException if the JSON string is invalid with respect to AttachToNetworkRequest
   */
  public static AttachToNetworkRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AttachToNetworkRequest.class);
  }

  /**
   * Convert an instance of AttachToNetworkRequest to an JSON string
   *
   * @return JSON string
   */
