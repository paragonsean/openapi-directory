...
public class ImagesGet200ResponseImagesInnerCreatedFrom {
  ...
  public ImagesGet200ResponseImagesInnerCreatedFrom() {
  }

  public ImagesGet200ResponseImagesInnerCreatedFrom id(Integer id) {
    this.id = id;
    return this;
  }
  ...
  public ImagesGet200ResponseImagesInnerCreatedFrom name(String name) {
    this.name = name;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    ImagesGet200ResponseImagesInnerCreatedFrom imagesGet200ResponseImagesInnerCreatedFrom = (ImagesGet200ResponseImagesInnerCreatedFrom) o;
    return Objects.equals(this.id, imagesGet200ResponseImagesInnerCreatedFrom.id) &&
        Objects.equals(this.name, imagesGet200ResponseImagesInnerCreatedFrom.name);
  }
  ...
  public String toString() {
    ...
    sb.append("class ImagesGet200ResponseImagesInnerCreatedFrom {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ImagesGet200ResponseImagesInnerCreatedFrom
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ImagesGet200ResponseImagesInnerCreatedFrom.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ImagesGet200ResponseImagesInnerCreatedFrom is not found in the empty JSON string", ImagesGet200ResponseImagesInnerCreatedFrom.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ImagesGet200ResponseImagesInnerCreatedFrom.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ImagesGet200ResponseImagesInnerCreatedFrom` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ImagesGet200ResponseImagesInnerCreatedFrom.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ImagesGet200ResponseImagesInnerCreatedFrom.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ImagesGet200ResponseImagesInnerCreatedFrom' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ImagesGet200ResponseImagesInnerCreatedFrom> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ImagesGet200ResponseImagesInnerCreatedFrom.class));

       return (TypeAdapter<T>) new TypeAdapter<ImagesGet200ResponseImagesInnerCreatedFrom>() {
           @Override
           public void write(JsonWriter out, ImagesGet200ResponseImagesInnerCreatedFrom value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ImagesGet200ResponseImagesInnerCreatedFrom read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ImagesGet200ResponseImagesInnerCreatedFrom given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ImagesGet200ResponseImagesInnerCreatedFrom
   * @throws IOException if the JSON string is invalid with respect to ImagesGet200ResponseImagesInnerCreatedFrom
   */
  public static ImagesGet200ResponseImagesInnerCreatedFrom fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ImagesGet200ResponseImagesInnerCreatedFrom.class);
  }

  /**
   * Convert an instance of ImagesGet200ResponseImagesInnerCreatedFrom to an JSON string
   *
   * @return JSON string
   */
