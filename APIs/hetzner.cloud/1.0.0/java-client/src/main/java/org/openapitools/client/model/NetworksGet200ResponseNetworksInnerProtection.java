...
public class NetworksGet200ResponseNetworksInnerProtection {
  public static final String SERIALIZED_NAME_DELETE = "delete";
  @SerializedName(SERIALIZED_NAME_DELETE)
  private Boolean delete;

  public NetworksGet200ResponseNetworksInnerProtection() {
  }

  public NetworksGet200ResponseNetworksInnerProtection delete(Boolean delete) {
    this.delete = delete;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    NetworksGet200ResponseNetworksInnerProtection networksGet200ResponseNetworksInnerProtection = (NetworksGet200ResponseNetworksInnerProtection) o;
    return Objects.equals(this.delete, networksGet200ResponseNetworksInnerProtection.delete);
  }
  ...
  public String toString() {
    ...
    sb.append("class NetworksGet200ResponseNetworksInnerProtection {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to NetworksGet200ResponseNetworksInnerProtection
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!NetworksGet200ResponseNetworksInnerProtection.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in NetworksGet200ResponseNetworksInnerProtection is not found in the empty JSON string", NetworksGet200ResponseNetworksInnerProtection.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!NetworksGet200ResponseNetworksInnerProtection.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `NetworksGet200ResponseNetworksInnerProtection` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : NetworksGet200ResponseNetworksInnerProtection.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!NetworksGet200ResponseNetworksInnerProtection.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'NetworksGet200ResponseNetworksInnerProtection' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<NetworksGet200ResponseNetworksInnerProtection> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(NetworksGet200ResponseNetworksInnerProtection.class));

       return (TypeAdapter<T>) new TypeAdapter<NetworksGet200ResponseNetworksInnerProtection>() {
           @Override
           public void write(JsonWriter out, NetworksGet200ResponseNetworksInnerProtection value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public NetworksGet200ResponseNetworksInnerProtection read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of NetworksGet200ResponseNetworksInnerProtection given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of NetworksGet200ResponseNetworksInnerProtection
   * @throws IOException if the JSON string is invalid with respect to NetworksGet200ResponseNetworksInnerProtection
   */
  public static NetworksGet200ResponseNetworksInnerProtection fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, NetworksGet200ResponseNetworksInnerProtection.class);
  }

  /**
   * Convert an instance of NetworksGet200ResponseNetworksInnerProtection to an JSON string
   *
   * @return JSON string
   */
