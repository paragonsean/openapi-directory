...
public class ImagesGet200Response {
  public static final String SERIALIZED_NAME_IMAGES = "images";
  @SerializedName(SERIALIZED_NAME_IMAGES)
  private List<ImagesGet200ResponseImagesInner> images = new ArrayList<>();

  public static final String SERIALIZED_NAME_META = "meta";
  @SerializedName(SERIALIZED_NAME_META)
  private ActionsResponseMeta meta;

  public ImagesGet200Response() {
  }

  public ImagesGet200Response images(List<ImagesGet200ResponseImagesInner> images) {
    this.images = images;
    return this;
  }

  public ImagesGet200Response addImagesItem(ImagesGet200ResponseImagesInner imagesItem) {
    if (this.images == null) {
  ...
  public List<ImagesGet200ResponseImagesInner> getImages() {
    return images;
  }

  public void setImages(List<ImagesGet200ResponseImagesInner> images) {
    this.images = images;
  }


  public ImagesGet200Response meta(ActionsResponseMeta meta) {
    this.meta = meta;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    ImagesGet200Response imagesGet200Response = (ImagesGet200Response) o;
    return Objects.equals(this.images, imagesGet200Response.images) &&
        Objects.equals(this.meta, imagesGet200Response.meta);
  }

  @Override
  public int hashCode() {
    return Objects.hash(images, meta);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ImagesGet200Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ImagesGet200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ImagesGet200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ImagesGet200Response is not found in the empty JSON string", ImagesGet200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ImagesGet200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ImagesGet200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ImagesGet200Response.openapiRequiredFields) {
      ...
      for (int i = 0; i < jsonArrayimages.size(); i++) {
        ImagesGet200ResponseImagesInner.validateJsonElement(jsonArrayimages.get(i));
      };
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ImagesGet200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ImagesGet200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ImagesGet200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ImagesGet200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<ImagesGet200Response>() {
           @Override
           public void write(JsonWriter out, ImagesGet200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ImagesGet200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ImagesGet200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ImagesGet200Response
   * @throws IOException if the JSON string is invalid with respect to ImagesGet200Response
   */
  public static ImagesGet200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ImagesGet200Response.class);
  }

  /**
   * Convert an instance of ImagesGet200Response to an JSON string
   *
   * @return JSON string
   */
