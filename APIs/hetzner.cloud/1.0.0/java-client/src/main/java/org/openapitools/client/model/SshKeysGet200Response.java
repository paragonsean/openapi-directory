...
public class SshKeysGet200Response {
  ...
  private List<SshKeysGet200ResponseSshKeysInner> sshKeys = new ArrayList<>();

  public SshKeysGet200Response() {
  }

  public SshKeysGet200Response meta(ActionsResponseMeta meta) {
    this.meta = meta;
    return this;
  }
  ...
  public SshKeysGet200Response sshKeys(List<SshKeysGet200ResponseSshKeysInner> sshKeys) {
    this.sshKeys = sshKeys;
    return this;
  }

  public SshKeysGet200Response addSshKeysItem(SshKeysGet200ResponseSshKeysInner sshKeysItem) {
  ...
  public List<SshKeysGet200ResponseSshKeysInner> getSshKeys() {
    return sshKeys;
  }

  public void setSshKeys(List<SshKeysGet200ResponseSshKeysInner> sshKeys) {
    this.sshKeys = sshKeys;
  }
  ...
  public boolean equals(Object o) {
    ...
    SshKeysGet200Response sshKeysGet200Response = (SshKeysGet200Response) o;
    return Objects.equals(this.meta, sshKeysGet200Response.meta) &&
        Objects.equals(this.sshKeys, sshKeysGet200Response.sshKeys);
  }

  @Override
  public int hashCode() {
    return Objects.hash(meta, sshKeys);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class SshKeysGet200Response {\n");
  ...
  static {
    ...
    openapiRequiredFields.add("ssh_keys");
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to SshKeysGet200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SshKeysGet200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SshKeysGet200Response is not found in the empty JSON string", SshKeysGet200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SshKeysGet200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SshKeysGet200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : SshKeysGet200Response.openapiRequiredFields) {
      ...
      // validate the required field `ssh_keys` (array)
      for (int i = 0; i < jsonArraysshKeys.size(); i++) {
        SshKeysGet200ResponseSshKeysInner.validateJsonElement(jsonArraysshKeys.get(i));
      };
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SshKeysGet200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SshKeysGet200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SshKeysGet200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SshKeysGet200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<SshKeysGet200Response>() {
           @Override
           public void write(JsonWriter out, SshKeysGet200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SshKeysGet200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SshKeysGet200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SshKeysGet200Response
   * @throws IOException if the JSON string is invalid with respect to SshKeysGet200Response
   */
  public static SshKeysGet200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SshKeysGet200Response.class);
  }

  /**
   * Convert an instance of SshKeysGet200Response to an JSON string
   *
   * @return JSON string
   */
