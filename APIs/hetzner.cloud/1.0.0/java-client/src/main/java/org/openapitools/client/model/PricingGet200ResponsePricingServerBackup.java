...
public class PricingGet200ResponsePricingServerBackup {
  public static final String SERIALIZED_NAME_PERCENTAGE = "percentage";
  @SerializedName(SERIALIZED_NAME_PERCENTAGE)
  private String percentage;

  public PricingGet200ResponsePricingServerBackup() {
  }

  public PricingGet200ResponsePricingServerBackup percentage(String percentage) {
  ...
  public boolean equals(Object o) {
    ...
    PricingGet200ResponsePricingServerBackup pricingGet200ResponsePricingServerBackup = (PricingGet200ResponsePricingServerBackup) o;
    return Objects.equals(this.percentage, pricingGet200ResponsePricingServerBackup.percentage);
  }
  ...
  public String toString() {
    ...
    sb.append("class PricingGet200ResponsePricingServerBackup {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PricingGet200ResponsePricingServerBackup
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PricingGet200ResponsePricingServerBackup.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PricingGet200ResponsePricingServerBackup is not found in the empty JSON string", PricingGet200ResponsePricingServerBackup.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PricingGet200ResponsePricingServerBackup.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PricingGet200ResponsePricingServerBackup` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PricingGet200ResponsePricingServerBackup.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PricingGet200ResponsePricingServerBackup.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PricingGet200ResponsePricingServerBackup' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PricingGet200ResponsePricingServerBackup> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PricingGet200ResponsePricingServerBackup.class));

       return (TypeAdapter<T>) new TypeAdapter<PricingGet200ResponsePricingServerBackup>() {
           @Override
           public void write(JsonWriter out, PricingGet200ResponsePricingServerBackup value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PricingGet200ResponsePricingServerBackup read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PricingGet200ResponsePricingServerBackup given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PricingGet200ResponsePricingServerBackup
   * @throws IOException if the JSON string is invalid with respect to PricingGet200ResponsePricingServerBackup
   */
  public static PricingGet200ResponsePricingServerBackup fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PricingGet200ResponsePricingServerBackup.class);
  }

  /**
   * Convert an instance of PricingGet200ResponsePricingServerBackup to an JSON string
   *
   * @return JSON string
   */
