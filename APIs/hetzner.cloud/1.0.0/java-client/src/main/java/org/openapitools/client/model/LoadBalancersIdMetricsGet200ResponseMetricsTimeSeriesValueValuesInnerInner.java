...
public class LoadBalancersIdMetricsGet200ResponseMetricsTimeSeriesValueValuesInnerInner extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(LoadBalancersIdMetricsGet200ResponseMetricsTimeSeriesValueValuesInnerInner.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!LoadBalancersIdMetricsGet200ResponseMetricsTimeSeriesValueValuesInnerInner.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'LoadBalancersIdMetricsGet200ResponseMetricsTimeSeriesValueValuesInnerInner' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<LoadBalancersIdMetricsGet200ResponseMetricsTimeSeriesValueValuesInnerInner>() {
                @Override
                public void write(JsonWriter out, LoadBalancersIdMetricsGet200ResponseMetricsTimeSeriesValueValuesInnerInner value) throws IOException {
                ...
                @Override
                public LoadBalancersIdMetricsGet200ResponseMetricsTimeSeriesValueValuesInnerInner read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        LoadBalancersIdMetricsGet200ResponseMetricsTimeSeriesValueValuesInnerInner ret = new LoadBalancersIdMetricsGet200ResponseMetricsTimeSeriesValueValuesInnerInner();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonElement));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for LoadBalancersIdMetricsGet200ResponseMetricsTimeSeriesValueValuesInnerInner: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public LoadBalancersIdMetricsGet200ResponseMetricsTimeSeriesValueValuesInnerInner() {
        super("oneOf", Boolean.FALSE);
    }

    public LoadBalancersIdMetricsGet200ResponseMetricsTimeSeriesValueValuesInnerInner(Object o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, Class<?>> getSchemas() {
        return LoadBalancersIdMetricsGet200ResponseMetricsTimeSeriesValueValuesInnerInner.schemas;
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to LoadBalancersIdMetricsGet200ResponseMetricsTimeSeriesValueValuesInnerInner
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        if (validCount != 1) {
            throw new IOException(String.format("The JSON string is invalid for LoadBalancersIdMetricsGet200ResponseMetricsTimeSeriesValueValuesInnerInner with oneOf schemas: BigDecimal, String. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonElement.toString()));
        }
    }

    /**
     * Create an instance of LoadBalancersIdMetricsGet200ResponseMetricsTimeSeriesValueValuesInnerInner given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of LoadBalancersIdMetricsGet200ResponseMetricsTimeSeriesValueValuesInnerInner
     * @throws IOException if the JSON string is invalid with respect to LoadBalancersIdMetricsGet200ResponseMetricsTimeSeriesValueValuesInnerInner
     */
    public static LoadBalancersIdMetricsGet200ResponseMetricsTimeSeriesValueValuesInnerInner fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, LoadBalancersIdMetricsGet200ResponseMetricsTimeSeriesValueValuesInnerInner.class);
    }

    /**
     * Convert an instance of LoadBalancersIdMetricsGet200ResponseMetricsTimeSeriesValueValuesInnerInner to an JSON string
     *
     * @return JSON string
     */
