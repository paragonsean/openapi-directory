...
public class PrimaryIPDnsPtrInner {
  ...
  public PrimaryIPDnsPtrInner() {
  }

  public PrimaryIPDnsPtrInner dnsPtr(String dnsPtr) {
    this.dnsPtr = dnsPtr;
    return this;
  }
  ...
  public PrimaryIPDnsPtrInner ip(String ip) {
    this.ip = ip;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    PrimaryIPDnsPtrInner primaryIPDnsPtrInner = (PrimaryIPDnsPtrInner) o;
    return Objects.equals(this.dnsPtr, primaryIPDnsPtrInner.dnsPtr) &&
        Objects.equals(this.ip, primaryIPDnsPtrInner.ip);
  }
  ...
  public String toString() {
    ...
    sb.append("class PrimaryIPDnsPtrInner {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PrimaryIPDnsPtrInner
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PrimaryIPDnsPtrInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PrimaryIPDnsPtrInner is not found in the empty JSON string", PrimaryIPDnsPtrInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PrimaryIPDnsPtrInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PrimaryIPDnsPtrInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PrimaryIPDnsPtrInner.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PrimaryIPDnsPtrInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PrimaryIPDnsPtrInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PrimaryIPDnsPtrInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PrimaryIPDnsPtrInner.class));

       return (TypeAdapter<T>) new TypeAdapter<PrimaryIPDnsPtrInner>() {
           @Override
           public void write(JsonWriter out, PrimaryIPDnsPtrInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PrimaryIPDnsPtrInner read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PrimaryIPDnsPtrInner given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PrimaryIPDnsPtrInner
   * @throws IOException if the JSON string is invalid with respect to PrimaryIPDnsPtrInner
   */
  public static PrimaryIPDnsPtrInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PrimaryIPDnsPtrInner.class);
  }

  /**
   * Convert an instance of PrimaryIPDnsPtrInner to an JSON string
   *
   * @return JSON string
   */
