...
public class AssignFloatingIPRequest {
  ...
  public AssignFloatingIPRequest() {
  }

  public AssignFloatingIPRequest server(Integer server) {
    this.server = server;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    AssignFloatingIPRequest assignFloatingIPRequest = (AssignFloatingIPRequest) o;
    return Objects.equals(this.server, assignFloatingIPRequest.server);
  }
  ...
  public String toString() {
    ...
    sb.append("class AssignFloatingIPRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AssignFloatingIPRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AssignFloatingIPRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AssignFloatingIPRequest is not found in the empty JSON string", AssignFloatingIPRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AssignFloatingIPRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AssignFloatingIPRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AssignFloatingIPRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AssignFloatingIPRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AssignFloatingIPRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AssignFloatingIPRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AssignFloatingIPRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<AssignFloatingIPRequest>() {
           @Override
           public void write(JsonWriter out, AssignFloatingIPRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AssignFloatingIPRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AssignFloatingIPRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AssignFloatingIPRequest
   * @throws IOException if the JSON string is invalid with respect to AssignFloatingIPRequest
   */
  public static AssignFloatingIPRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AssignFloatingIPRequest.class);
  }

  /**
   * Convert an instance of AssignFloatingIPRequest to an JSON string
   *
   * @return JSON string
   */
