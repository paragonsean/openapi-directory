...
public class FloatingIpsIdActionsGet200Response {
  public static final String SERIALIZED_NAME_ACTIONS = "actions";
  @SerializedName(SERIALIZED_NAME_ACTIONS)
  private List<Action> actions = new ArrayList<>();

  public FloatingIpsIdActionsGet200Response() {
  }

  public FloatingIpsIdActionsGet200Response actions(List<Action> actions) {
    this.actions = actions;
    return this;
  }

  public FloatingIpsIdActionsGet200Response addActionsItem(Action actionsItem) {
  ...
  public boolean equals(Object o) {
    ...
    FloatingIpsIdActionsGet200Response floatingIpsIdActionsGet200Response = (FloatingIpsIdActionsGet200Response) o;
    return Objects.equals(this.actions, floatingIpsIdActionsGet200Response.actions);
  }
  ...
  public String toString() {
    ...
    sb.append("class FloatingIpsIdActionsGet200Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to FloatingIpsIdActionsGet200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!FloatingIpsIdActionsGet200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FloatingIpsIdActionsGet200Response is not found in the empty JSON string", FloatingIpsIdActionsGet200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!FloatingIpsIdActionsGet200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `FloatingIpsIdActionsGet200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : FloatingIpsIdActionsGet200Response.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FloatingIpsIdActionsGet200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FloatingIpsIdActionsGet200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FloatingIpsIdActionsGet200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FloatingIpsIdActionsGet200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<FloatingIpsIdActionsGet200Response>() {
           @Override
           public void write(JsonWriter out, FloatingIpsIdActionsGet200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public FloatingIpsIdActionsGet200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of FloatingIpsIdActionsGet200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of FloatingIpsIdActionsGet200Response
   * @throws IOException if the JSON string is invalid with respect to FloatingIpsIdActionsGet200Response
   */
  public static FloatingIpsIdActionsGet200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FloatingIpsIdActionsGet200Response.class);
  }

  /**
   * Convert an instance of FloatingIpsIdActionsGet200Response to an JSON string
   *
   * @return JSON string
   */
