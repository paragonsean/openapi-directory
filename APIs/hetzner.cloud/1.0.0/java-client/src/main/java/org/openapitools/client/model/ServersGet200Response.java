...
public class ServersGet200Response {
  ...
  private List<ServersGet200ResponseServersInner> servers = new ArrayList<>();

  public ServersGet200Response() {
  }

  public ServersGet200Response meta(ActionsResponseMeta meta) {
    this.meta = meta;
    return this;
  }
  ...
  public ServersGet200Response servers(List<ServersGet200ResponseServersInner> servers) {
    this.servers = servers;
    return this;
  }

  public ServersGet200Response addServersItem(ServersGet200ResponseServersInner serversItem) {
  ...
  public List<ServersGet200ResponseServersInner> getServers() {
    return servers;
  }

  public void setServers(List<ServersGet200ResponseServersInner> servers) {
    this.servers = servers;
  }
  ...
  public boolean equals(Object o) {
    ...
    ServersGet200Response serversGet200Response = (ServersGet200Response) o;
    return Objects.equals(this.meta, serversGet200Response.meta) &&
        Objects.equals(this.servers, serversGet200Response.servers);
  }

  @Override
  public int hashCode() {
    return Objects.hash(meta, servers);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ServersGet200Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ServersGet200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ServersGet200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ServersGet200Response is not found in the empty JSON string", ServersGet200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ServersGet200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ServersGet200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ServersGet200Response.openapiRequiredFields) {
      ...
      for (int i = 0; i < jsonArrayservers.size(); i++) {
        ServersGet200ResponseServersInner.validateJsonElement(jsonArrayservers.get(i));
      };
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ServersGet200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ServersGet200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ServersGet200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ServersGet200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<ServersGet200Response>() {
           @Override
           public void write(JsonWriter out, ServersGet200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ServersGet200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ServersGet200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ServersGet200Response
   * @throws IOException if the JSON string is invalid with respect to ServersGet200Response
   */
  public static ServersGet200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ServersGet200Response.class);
  }

  /**
   * Convert an instance of ServersGet200Response to an JSON string
   *
   * @return JSON string
   */
