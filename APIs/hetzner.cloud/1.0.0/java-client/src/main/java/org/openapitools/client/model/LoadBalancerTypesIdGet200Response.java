...
public class LoadBalancerTypesIdGet200Response {
  ...
  public LoadBalancerTypesIdGet200Response() {
  }

  public LoadBalancerTypesIdGet200Response loadBalancerType(LoadBalancerTypesGet200ResponseLoadBalancerTypesInner loadBalancerType) {
  ...
  public boolean equals(Object o) {
    ...
    LoadBalancerTypesIdGet200Response loadBalancerTypesIdGet200Response = (LoadBalancerTypesIdGet200Response) o;
    return Objects.equals(this.loadBalancerType, loadBalancerTypesIdGet200Response.loadBalancerType);
  }
  ...
  public String toString() {
    ...
    sb.append("class LoadBalancerTypesIdGet200Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to LoadBalancerTypesIdGet200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LoadBalancerTypesIdGet200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LoadBalancerTypesIdGet200Response is not found in the empty JSON string", LoadBalancerTypesIdGet200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LoadBalancerTypesIdGet200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LoadBalancerTypesIdGet200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `load_balancer_type`
      if (jsonObj.get("load_balancer_type") != null && !jsonObj.get("load_balancer_type").isJsonNull()) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LoadBalancerTypesIdGet200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LoadBalancerTypesIdGet200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LoadBalancerTypesIdGet200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LoadBalancerTypesIdGet200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<LoadBalancerTypesIdGet200Response>() {
           @Override
           public void write(JsonWriter out, LoadBalancerTypesIdGet200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LoadBalancerTypesIdGet200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LoadBalancerTypesIdGet200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LoadBalancerTypesIdGet200Response
   * @throws IOException if the JSON string is invalid with respect to LoadBalancerTypesIdGet200Response
   */
  public static LoadBalancerTypesIdGet200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LoadBalancerTypesIdGet200Response.class);
  }

  /**
   * Convert an instance of LoadBalancerTypesIdGet200Response to an JSON string
   *
   * @return JSON string
   */
