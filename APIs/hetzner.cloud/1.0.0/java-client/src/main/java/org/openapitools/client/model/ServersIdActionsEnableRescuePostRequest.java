...
public class ServersIdActionsEnableRescuePostRequest {
  ...
  public ServersIdActionsEnableRescuePostRequest() {
  }

  public ServersIdActionsEnableRescuePostRequest sshKeys(List<Integer> sshKeys) {
    this.sshKeys = sshKeys;
    return this;
  }

  public ServersIdActionsEnableRescuePostRequest addSshKeysItem(Integer sshKeysItem) {
  ...
  public ServersIdActionsEnableRescuePostRequest type(TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    ServersIdActionsEnableRescuePostRequest serversIdActionsEnableRescuePostRequest = (ServersIdActionsEnableRescuePostRequest) o;
    return Objects.equals(this.sshKeys, serversIdActionsEnableRescuePostRequest.sshKeys) &&
        Objects.equals(this.type, serversIdActionsEnableRescuePostRequest.type);
  }

  @Override
  public int hashCode() {
    return Objects.hash(sshKeys, type);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ServersIdActionsEnableRescuePostRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ServersIdActionsEnableRescuePostRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ServersIdActionsEnableRescuePostRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ServersIdActionsEnableRescuePostRequest is not found in the empty JSON string", ServersIdActionsEnableRescuePostRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ServersIdActionsEnableRescuePostRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ServersIdActionsEnableRescuePostRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ServersIdActionsEnableRescuePostRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ServersIdActionsEnableRescuePostRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ServersIdActionsEnableRescuePostRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ServersIdActionsEnableRescuePostRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<ServersIdActionsEnableRescuePostRequest>() {
           @Override
           public void write(JsonWriter out, ServersIdActionsEnableRescuePostRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ServersIdActionsEnableRescuePostRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ServersIdActionsEnableRescuePostRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ServersIdActionsEnableRescuePostRequest
   * @throws IOException if the JSON string is invalid with respect to ServersIdActionsEnableRescuePostRequest
   */
  public static ServersIdActionsEnableRescuePostRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ServersIdActionsEnableRescuePostRequest.class);
  }

  /**
   * Convert an instance of ServersIdActionsEnableRescuePostRequest to an JSON string
   *
   * @return JSON string
   */
