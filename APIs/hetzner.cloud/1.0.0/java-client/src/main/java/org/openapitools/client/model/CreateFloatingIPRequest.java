...
public class CreateFloatingIPRequest {
  ...
  public CreateFloatingIPRequest description(String description) {
  ...
  public CreateFloatingIPRequest homeLocation(String homeLocation) {
  ...
  public CreateFloatingIPRequest labels(Object labels) {
    this.labels = labels;
    return this;
  }
  ...
  public CreateFloatingIPRequest name(String name) {
    this.name = name;
    return this;
  }
  ...
  public CreateFloatingIPRequest server(Integer server) {
    this.server = server;
    return this;
  }
  ...
  public CreateFloatingIPRequest type(TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    CreateFloatingIPRequest createFloatingIPRequest = (CreateFloatingIPRequest) o;
    return Objects.equals(this.description, createFloatingIPRequest.description) &&
        Objects.equals(this.homeLocation, createFloatingIPRequest.homeLocation) &&
        Objects.equals(this.labels, createFloatingIPRequest.labels) &&
        Objects.equals(this.name, createFloatingIPRequest.name) &&
        Objects.equals(this.server, createFloatingIPRequest.server) &&
        Objects.equals(this.type, createFloatingIPRequest.type);
  }

  @Override
  public int hashCode() {
    return Objects.hash(description, homeLocation, labels, name, server, type);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateFloatingIPRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateFloatingIPRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateFloatingIPRequest is not found in the empty JSON string", CreateFloatingIPRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateFloatingIPRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateFloatingIPRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CreateFloatingIPRequest.openapiRequiredFields) {
      ...
      if ((jsonObj.get("home_location") != null && !jsonObj.get("home_location").isJsonNull()) && !jsonObj.get("home_location").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `home_location` to be a primitive type in the JSON string but got `%s`", jsonObj.get("home_location").toString()));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateFloatingIPRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateFloatingIPRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateFloatingIPRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateFloatingIPRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateFloatingIPRequest>() {
           @Override
           public void write(JsonWriter out, CreateFloatingIPRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateFloatingIPRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateFloatingIPRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateFloatingIPRequest
   * @throws IOException if the JSON string is invalid with respect to CreateFloatingIPRequest
   */
  public static CreateFloatingIPRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateFloatingIPRequest.class);
  }

  /**
   * Convert an instance of CreateFloatingIPRequest to an JSON string
   *
   * @return JSON string
   */
