...
public class ActionResourcesInner {
  ...
  public ActionResourcesInner() {
  }

  public ActionResourcesInner id(Integer id) {
    this.id = id;
    return this;
  }
  ...
  public ActionResourcesInner type(String type) {
    this.type = type;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    ActionResourcesInner actionResourcesInner = (ActionResourcesInner) o;
    return Objects.equals(this.id, actionResourcesInner.id) &&
        Objects.equals(this.type, actionResourcesInner.type);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ActionResourcesInner
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ActionResourcesInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionResourcesInner is not found in the empty JSON string", ActionResourcesInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ActionResourcesInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ActionResourcesInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionResourcesInner.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionResourcesInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionResourcesInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionResourcesInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionResourcesInner.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionResourcesInner>() {
           @Override
           public void write(JsonWriter out, ActionResourcesInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ActionResourcesInner read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ActionResourcesInner given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ActionResourcesInner
   * @throws IOException if the JSON string is invalid with respect to ActionResourcesInner
   */
  public static ActionResourcesInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionResourcesInner.class);
  }

  /**
   * Convert an instance of ActionResourcesInner to an JSON string
   *
   * @return JSON string
   */
