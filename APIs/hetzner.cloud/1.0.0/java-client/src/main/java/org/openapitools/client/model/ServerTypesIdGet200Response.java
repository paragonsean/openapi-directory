...
public class ServerTypesIdGet200Response {
  public static final String SERIALIZED_NAME_SERVER_TYPE = "server_type";
  @SerializedName(SERIALIZED_NAME_SERVER_TYPE)
  private ServerTypesGet200ResponseServerTypesInner serverType;

  public ServerTypesIdGet200Response() {
  }

  public ServerTypesIdGet200Response serverType(ServerTypesGet200ResponseServerTypesInner serverType) {
  ...
  public ServerTypesGet200ResponseServerTypesInner getServerType() {
    return serverType;
  }

  public void setServerType(ServerTypesGet200ResponseServerTypesInner serverType) {
    this.serverType = serverType;
  }
  ...
  public boolean equals(Object o) {
    ...
    ServerTypesIdGet200Response serverTypesIdGet200Response = (ServerTypesIdGet200Response) o;
    return Objects.equals(this.serverType, serverTypesIdGet200Response.serverType);
  }
  ...
  public String toString() {
    ...
    sb.append("class ServerTypesIdGet200Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ServerTypesIdGet200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ServerTypesIdGet200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ServerTypesIdGet200Response is not found in the empty JSON string", ServerTypesIdGet200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ServerTypesIdGet200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ServerTypesIdGet200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ServerTypesIdGet200Response.openapiRequiredFields) {
      ...
      ServerTypesGet200ResponseServerTypesInner.validateJsonElement(jsonObj.get("server_type"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ServerTypesIdGet200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ServerTypesIdGet200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ServerTypesIdGet200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ServerTypesIdGet200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<ServerTypesIdGet200Response>() {
           @Override
           public void write(JsonWriter out, ServerTypesIdGet200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ServerTypesIdGet200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ServerTypesIdGet200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ServerTypesIdGet200Response
   * @throws IOException if the JSON string is invalid with respect to ServerTypesIdGet200Response
   */
  public static ServerTypesIdGet200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ServerTypesIdGet200Response.class);
  }

  /**
   * Convert an instance of ServerTypesIdGet200Response to an JSON string
   *
   * @return JSON string
   */
