...
public class AddSubnetRequest {
  ...
  public static final String SERIALIZED_NAME_VSWITCH_ID = "vswitch_id";
  @SerializedName(SERIALIZED_NAME_VSWITCH_ID)
  private Integer vswitchId;

  public AddSubnetRequest() {
  }

  public AddSubnetRequest ipRange(String ipRange) {
  ...
  public AddSubnetRequest networkZone(String networkZone) {
  ...
  public AddSubnetRequest type(TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  public AddSubnetRequest vswitchId(Integer vswitchId) {
  ...
  public boolean equals(Object o) {
    ...
    AddSubnetRequest addSubnetRequest = (AddSubnetRequest) o;
    return Objects.equals(this.ipRange, addSubnetRequest.ipRange) &&
        Objects.equals(this.networkZone, addSubnetRequest.networkZone) &&
        Objects.equals(this.type, addSubnetRequest.type) &&
        Objects.equals(this.vswitchId, addSubnetRequest.vswitchId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(ipRange, networkZone, type, vswitchId);
  }
  ...
  public String toString() {
    ...
    sb.append("    vswitchId: ").append(toIndentedString(vswitchId)).append("\n");
    sb.append("}");
    return sb.toString();
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to AddSubnetRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AddSubnetRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AddSubnetRequest is not found in the empty JSON string", AddSubnetRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AddSubnetRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AddSubnetRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AddSubnetRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AddSubnetRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AddSubnetRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AddSubnetRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AddSubnetRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<AddSubnetRequest>() {
           @Override
           public void write(JsonWriter out, AddSubnetRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AddSubnetRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AddSubnetRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AddSubnetRequest
   * @throws IOException if the JSON string is invalid with respect to AddSubnetRequest
   */
  public static AddSubnetRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AddSubnetRequest.class);
  }

  /**
   * Convert an instance of AddSubnetRequest to an JSON string
   *
   * @return JSON string
   */
