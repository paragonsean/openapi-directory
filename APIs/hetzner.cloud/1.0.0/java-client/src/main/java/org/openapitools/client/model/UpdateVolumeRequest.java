...
import org.openapitools.client.model.UpdateNetworkRequestLabels;
...
public class UpdateVolumeRequest {
  ...
  private UpdateNetworkRequestLabels labels;
  ...
  public UpdateVolumeRequest labels(UpdateNetworkRequestLabels labels) {
    this.labels = labels;
    return this;
  }
  ...
  public UpdateNetworkRequestLabels getLabels() {
    return labels;
  }

  public void setLabels(UpdateNetworkRequestLabels labels) {
    this.labels = labels;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.labels, updateVolumeRequest.labels) &&
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("labels") != null && !jsonObj.get("labels").isJsonNull()) {
        UpdateNetworkRequestLabels.validateJsonElement(jsonObj.get("labels"));
      }
