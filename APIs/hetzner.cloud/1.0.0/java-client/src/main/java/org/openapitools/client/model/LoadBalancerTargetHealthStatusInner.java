...
public class LoadBalancerTargetHealthStatusInner {
  ...
  public LoadBalancerTargetHealthStatusInner() {
  }

  public LoadBalancerTargetHealthStatusInner listenPort(Integer listenPort) {
  ...
  public LoadBalancerTargetHealthStatusInner status(StatusEnum status) {
    this.status = status;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    LoadBalancerTargetHealthStatusInner loadBalancerTargetHealthStatusInner = (LoadBalancerTargetHealthStatusInner) o;
    return Objects.equals(this.listenPort, loadBalancerTargetHealthStatusInner.listenPort) &&
        Objects.equals(this.status, loadBalancerTargetHealthStatusInner.status);
  }

  @Override
  public int hashCode() {
    return Objects.hash(listenPort, status);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to LoadBalancerTargetHealthStatusInner
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LoadBalancerTargetHealthStatusInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LoadBalancerTargetHealthStatusInner is not found in the empty JSON string", LoadBalancerTargetHealthStatusInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LoadBalancerTargetHealthStatusInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LoadBalancerTargetHealthStatusInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LoadBalancerTargetHealthStatusInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LoadBalancerTargetHealthStatusInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LoadBalancerTargetHealthStatusInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LoadBalancerTargetHealthStatusInner.class));

       return (TypeAdapter<T>) new TypeAdapter<LoadBalancerTargetHealthStatusInner>() {
           @Override
           public void write(JsonWriter out, LoadBalancerTargetHealthStatusInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LoadBalancerTargetHealthStatusInner read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LoadBalancerTargetHealthStatusInner given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LoadBalancerTargetHealthStatusInner
   * @throws IOException if the JSON string is invalid with respect to LoadBalancerTargetHealthStatusInner
   */
  public static LoadBalancerTargetHealthStatusInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LoadBalancerTargetHealthStatusInner.class);
  }

  /**
   * Convert an instance of LoadBalancerTargetHealthStatusInner to an JSON string
   *
   * @return JSON string
   */
