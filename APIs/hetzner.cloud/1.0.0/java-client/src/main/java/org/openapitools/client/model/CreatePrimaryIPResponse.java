...
import org.openapitools.client.model.PrimaryIP;
...
public class CreatePrimaryIPResponse {
  ...
  public CreatePrimaryIPResponse() {
  }

  public CreatePrimaryIPResponse action(Action action) {
    this.action = action;
    return this;
  }
  ...
  public CreatePrimaryIPResponse primaryIp(PrimaryIP primaryIp) {
  ...
  public boolean equals(Object o) {
    ...
    CreatePrimaryIPResponse createPrimaryIPResponse = (CreatePrimaryIPResponse) o;
    return Objects.equals(this.action, createPrimaryIPResponse.action) &&
        Objects.equals(this.primaryIp, createPrimaryIPResponse.primaryIp);
  }

  @Override
  public int hashCode() {
    return Objects.hash(action, primaryIp);
  }
  ...
  static {
    ...
    openapiRequiredFields.add("primary_ip");
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreatePrimaryIPResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreatePrimaryIPResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreatePrimaryIPResponse is not found in the empty JSON string", CreatePrimaryIPResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreatePrimaryIPResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreatePrimaryIPResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CreatePrimaryIPResponse.openapiRequiredFields) {
      ...
      // validate the required field `primary_ip`
      PrimaryIP.validateJsonElement(jsonObj.get("primary_ip"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreatePrimaryIPResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreatePrimaryIPResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreatePrimaryIPResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreatePrimaryIPResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<CreatePrimaryIPResponse>() {
           @Override
           public void write(JsonWriter out, CreatePrimaryIPResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreatePrimaryIPResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreatePrimaryIPResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreatePrimaryIPResponse
   * @throws IOException if the JSON string is invalid with respect to CreatePrimaryIPResponse
   */
  public static CreatePrimaryIPResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreatePrimaryIPResponse.class);
  }

  /**
   * Convert an instance of CreatePrimaryIPResponse to an JSON string
   *
   * @return JSON string
   */
