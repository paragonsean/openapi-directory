...
public class CertificatesResponse {
  ...
  public CertificatesResponse certificates(List<Certificate> certificates) {
    this.certificates = certificates;
    return this;
  }

  public CertificatesResponse addCertificatesItem(Certificate certificatesItem) {
  ...
  public CertificatesResponse meta(ActionsResponseMeta meta) {
    this.meta = meta;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.certificates, certificatesResponse.certificates) &&
        Objects.equals(this.meta, certificatesResponse.meta);
  }

  @Override
  public int hashCode() {
    return Objects.hash(certificates, meta);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to CertificatesResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CertificatesResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CertificatesResponse is not found in the empty JSON string", CertificatesResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CertificatesResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CertificatesResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CertificatesResponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CertificatesResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CertificatesResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CertificatesResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CertificatesResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<CertificatesResponse>() {
           @Override
           public void write(JsonWriter out, CertificatesResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CertificatesResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CertificatesResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CertificatesResponse
   * @throws IOException if the JSON string is invalid with respect to CertificatesResponse
   */
  public static CertificatesResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CertificatesResponse.class);
  }

  /**
   * Convert an instance of CertificatesResponse to an JSON string
   *
   * @return JSON string
   */
