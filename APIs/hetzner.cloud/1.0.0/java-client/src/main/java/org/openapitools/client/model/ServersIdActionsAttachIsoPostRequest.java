...
public class ServersIdActionsAttachIsoPostRequest {
  public static final String SERIALIZED_NAME_ISO = "iso";
  @SerializedName(SERIALIZED_NAME_ISO)
  private String iso;

  public ServersIdActionsAttachIsoPostRequest() {
  }

  public ServersIdActionsAttachIsoPostRequest iso(String iso) {
    this.iso = iso;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    ServersIdActionsAttachIsoPostRequest serversIdActionsAttachIsoPostRequest = (ServersIdActionsAttachIsoPostRequest) o;
    return Objects.equals(this.iso, serversIdActionsAttachIsoPostRequest.iso);
  }
  ...
  public String toString() {
    ...
    sb.append("class ServersIdActionsAttachIsoPostRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ServersIdActionsAttachIsoPostRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ServersIdActionsAttachIsoPostRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ServersIdActionsAttachIsoPostRequest is not found in the empty JSON string", ServersIdActionsAttachIsoPostRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ServersIdActionsAttachIsoPostRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ServersIdActionsAttachIsoPostRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ServersIdActionsAttachIsoPostRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ServersIdActionsAttachIsoPostRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ServersIdActionsAttachIsoPostRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ServersIdActionsAttachIsoPostRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ServersIdActionsAttachIsoPostRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<ServersIdActionsAttachIsoPostRequest>() {
           @Override
           public void write(JsonWriter out, ServersIdActionsAttachIsoPostRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ServersIdActionsAttachIsoPostRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ServersIdActionsAttachIsoPostRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ServersIdActionsAttachIsoPostRequest
   * @throws IOException if the JSON string is invalid with respect to ServersIdActionsAttachIsoPostRequest
   */
  public static ServersIdActionsAttachIsoPostRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ServersIdActionsAttachIsoPostRequest.class);
  }

  /**
   * Convert an instance of ServersIdActionsAttachIsoPostRequest to an JSON string
   *
   * @return JSON string
   */
