...
public class IsosIdGet200Response {
  public static final String SERIALIZED_NAME_ISO = "iso";
  @SerializedName(SERIALIZED_NAME_ISO)
  private IsosGet200ResponseIsosInner iso;

  public IsosIdGet200Response() {
  }

  public IsosIdGet200Response iso(IsosGet200ResponseIsosInner iso) {
    this.iso = iso;
    return this;
  }
  ...
  public IsosGet200ResponseIsosInner getIso() {
    return iso;
  }

  public void setIso(IsosGet200ResponseIsosInner iso) {
    this.iso = iso;
  }
  ...
  public boolean equals(Object o) {
    ...
    IsosIdGet200Response isosIdGet200Response = (IsosIdGet200Response) o;
    return Objects.equals(this.iso, isosIdGet200Response.iso);
  }
  ...
  public String toString() {
    ...
    sb.append("class IsosIdGet200Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to IsosIdGet200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!IsosIdGet200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in IsosIdGet200Response is not found in the empty JSON string", IsosIdGet200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!IsosIdGet200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `IsosIdGet200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : IsosIdGet200Response.openapiRequiredFields) {
      ...
      IsosGet200ResponseIsosInner.validateJsonElement(jsonObj.get("iso"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!IsosIdGet200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'IsosIdGet200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<IsosIdGet200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(IsosIdGet200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<IsosIdGet200Response>() {
           @Override
           public void write(JsonWriter out, IsosIdGet200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public IsosIdGet200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of IsosIdGet200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of IsosIdGet200Response
   * @throws IOException if the JSON string is invalid with respect to IsosIdGet200Response
   */
  public static IsosIdGet200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, IsosIdGet200Response.class);
  }

  /**
   * Convert an instance of IsosIdGet200Response to an JSON string
   *
   * @return JSON string
   */
