...
public class ServersIdActionsEnableRescuePost201Response {
  ...
  public ServersIdActionsEnableRescuePost201Response() {
  }

  public ServersIdActionsEnableRescuePost201Response action(Action action) {
    this.action = action;
    return this;
  }
  ...
  public ServersIdActionsEnableRescuePost201Response rootPassword(String rootPassword) {
  ...
  public boolean equals(Object o) {
    ...
    ServersIdActionsEnableRescuePost201Response serversIdActionsEnableRescuePost201Response = (ServersIdActionsEnableRescuePost201Response) o;
    return Objects.equals(this.action, serversIdActionsEnableRescuePost201Response.action) &&
        Objects.equals(this.rootPassword, serversIdActionsEnableRescuePost201Response.rootPassword);
  }

  @Override
  public int hashCode() {
    return Objects.hash(action, rootPassword);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ServersIdActionsEnableRescuePost201Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ServersIdActionsEnableRescuePost201Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ServersIdActionsEnableRescuePost201Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ServersIdActionsEnableRescuePost201Response is not found in the empty JSON string", ServersIdActionsEnableRescuePost201Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ServersIdActionsEnableRescuePost201Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ServersIdActionsEnableRescuePost201Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ServersIdActionsEnableRescuePost201Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ServersIdActionsEnableRescuePost201Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ServersIdActionsEnableRescuePost201Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ServersIdActionsEnableRescuePost201Response.class));

       return (TypeAdapter<T>) new TypeAdapter<ServersIdActionsEnableRescuePost201Response>() {
           @Override
           public void write(JsonWriter out, ServersIdActionsEnableRescuePost201Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ServersIdActionsEnableRescuePost201Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ServersIdActionsEnableRescuePost201Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ServersIdActionsEnableRescuePost201Response
   * @throws IOException if the JSON string is invalid with respect to ServersIdActionsEnableRescuePost201Response
   */
  public static ServersIdActionsEnableRescuePost201Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ServersIdActionsEnableRescuePost201Response.class);
  }

  /**
   * Convert an instance of ServersIdActionsEnableRescuePost201Response to an JSON string
   *
   * @return JSON string
   */
