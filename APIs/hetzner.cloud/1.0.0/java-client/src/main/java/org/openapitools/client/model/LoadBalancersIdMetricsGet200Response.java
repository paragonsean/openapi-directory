...
import org.openapitools.client.model.LoadBalancersIdMetricsGet200ResponseMetrics;
...
public class LoadBalancersIdMetricsGet200Response {
  public static final String SERIALIZED_NAME_METRICS = "metrics";
  @SerializedName(SERIALIZED_NAME_METRICS)
  private LoadBalancersIdMetricsGet200ResponseMetrics metrics;

  public LoadBalancersIdMetricsGet200Response() {
  }

  public LoadBalancersIdMetricsGet200Response metrics(LoadBalancersIdMetricsGet200ResponseMetrics metrics) {
  ...
  public LoadBalancersIdMetricsGet200ResponseMetrics getMetrics() {
    return metrics;
  }

  public void setMetrics(LoadBalancersIdMetricsGet200ResponseMetrics metrics) {
    this.metrics = metrics;
  }
  ...
  public boolean equals(Object o) {
    ...
    LoadBalancersIdMetricsGet200Response loadBalancersIdMetricsGet200Response = (LoadBalancersIdMetricsGet200Response) o;
    return Objects.equals(this.metrics, loadBalancersIdMetricsGet200Response.metrics);
  }
  ...
  public String toString() {
    ...
    sb.append("class LoadBalancersIdMetricsGet200Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to LoadBalancersIdMetricsGet200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LoadBalancersIdMetricsGet200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LoadBalancersIdMetricsGet200Response is not found in the empty JSON string", LoadBalancersIdMetricsGet200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LoadBalancersIdMetricsGet200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LoadBalancersIdMetricsGet200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LoadBalancersIdMetricsGet200Response.openapiRequiredFields) {
      ...
      LoadBalancersIdMetricsGet200ResponseMetrics.validateJsonElement(jsonObj.get("metrics"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LoadBalancersIdMetricsGet200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LoadBalancersIdMetricsGet200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LoadBalancersIdMetricsGet200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LoadBalancersIdMetricsGet200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<LoadBalancersIdMetricsGet200Response>() {
           @Override
           public void write(JsonWriter out, LoadBalancersIdMetricsGet200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LoadBalancersIdMetricsGet200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LoadBalancersIdMetricsGet200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LoadBalancersIdMetricsGet200Response
   * @throws IOException if the JSON string is invalid with respect to LoadBalancersIdMetricsGet200Response
   */
  public static LoadBalancersIdMetricsGet200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LoadBalancersIdMetricsGet200Response.class);
  }

  /**
   * Convert an instance of LoadBalancersIdMetricsGet200Response to an JSON string
   *
   * @return JSON string
   */
