...
import org.openapitools.client.model.NullableAction;
...
public class CreatePlacementGroupResponse {
  ...
  public CreatePlacementGroupResponse() {
  }

  public CreatePlacementGroupResponse action(NullableAction action) {
    this.action = action;
    return this;
  }
  ...
  public void setAction(NullableAction action) {
    this.action = action;
  }


  public CreatePlacementGroupResponse placementGroup(PlacementGroup placementGroup) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.action, createPlacementGroupResponse.action) &&
        Objects.equals(this.placementGroup, createPlacementGroupResponse.placementGroup);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(action, placementGroup);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreatePlacementGroupResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreatePlacementGroupResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreatePlacementGroupResponse is not found in the empty JSON string", CreatePlacementGroupResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreatePlacementGroupResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreatePlacementGroupResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CreatePlacementGroupResponse.openapiRequiredFields) {
      ...
      if (jsonObj.get("action") != null && !jsonObj.get("action").isJsonNull()) {
        NullableAction.validateJsonElement(jsonObj.get("action"));
      }
      // validate the required field `placement_group`
      PlacementGroup.validateJsonElement(jsonObj.get("placement_group"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreatePlacementGroupResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreatePlacementGroupResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreatePlacementGroupResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreatePlacementGroupResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<CreatePlacementGroupResponse>() {
           @Override
           public void write(JsonWriter out, CreatePlacementGroupResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreatePlacementGroupResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreatePlacementGroupResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreatePlacementGroupResponse
   * @throws IOException if the JSON string is invalid with respect to CreatePlacementGroupResponse
   */
  public static CreatePlacementGroupResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreatePlacementGroupResponse.class);
  }

  /**
   * Convert an instance of CreatePlacementGroupResponse to an JSON string
   *
   * @return JSON string
   */
