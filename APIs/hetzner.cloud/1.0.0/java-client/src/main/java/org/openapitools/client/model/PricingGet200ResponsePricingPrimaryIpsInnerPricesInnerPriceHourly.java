...
public class PricingGet200ResponsePricingPrimaryIpsInnerPricesInnerPriceHourly {
  ...
  public PricingGet200ResponsePricingPrimaryIpsInnerPricesInnerPriceHourly() {
  }

  public PricingGet200ResponsePricingPrimaryIpsInnerPricesInnerPriceHourly gross(String gross) {
    this.gross = gross;
    return this;
  }
  ...
  public PricingGet200ResponsePricingPrimaryIpsInnerPricesInnerPriceHourly net(String net) {
    this.net = net;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    PricingGet200ResponsePricingPrimaryIpsInnerPricesInnerPriceHourly pricingGet200ResponsePricingPrimaryIpsInnerPricesInnerPriceHourly = (PricingGet200ResponsePricingPrimaryIpsInnerPricesInnerPriceHourly) o;
    return Objects.equals(this.gross, pricingGet200ResponsePricingPrimaryIpsInnerPricesInnerPriceHourly.gross) &&
        Objects.equals(this.net, pricingGet200ResponsePricingPrimaryIpsInnerPricesInnerPriceHourly.net);
  }
  ...
  public String toString() {
    ...
    sb.append("class PricingGet200ResponsePricingPrimaryIpsInnerPricesInnerPriceHourly {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PricingGet200ResponsePricingPrimaryIpsInnerPricesInnerPriceHourly
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PricingGet200ResponsePricingPrimaryIpsInnerPricesInnerPriceHourly.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PricingGet200ResponsePricingPrimaryIpsInnerPricesInnerPriceHourly is not found in the empty JSON string", PricingGet200ResponsePricingPrimaryIpsInnerPricesInnerPriceHourly.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PricingGet200ResponsePricingPrimaryIpsInnerPricesInnerPriceHourly.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PricingGet200ResponsePricingPrimaryIpsInnerPricesInnerPriceHourly` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PricingGet200ResponsePricingPrimaryIpsInnerPricesInnerPriceHourly.openapiRequiredFields) {
        if (jsonElement.getAsJsonObject().get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      if (!jsonObj.get("gross").isJsonPrimitive()) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PricingGet200ResponsePricingPrimaryIpsInnerPricesInnerPriceHourly.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PricingGet200ResponsePricingPrimaryIpsInnerPricesInnerPriceHourly' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PricingGet200ResponsePricingPrimaryIpsInnerPricesInnerPriceHourly> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PricingGet200ResponsePricingPrimaryIpsInnerPricesInnerPriceHourly.class));

       return (TypeAdapter<T>) new TypeAdapter<PricingGet200ResponsePricingPrimaryIpsInnerPricesInnerPriceHourly>() {
           @Override
           public void write(JsonWriter out, PricingGet200ResponsePricingPrimaryIpsInnerPricesInnerPriceHourly value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PricingGet200ResponsePricingPrimaryIpsInnerPricesInnerPriceHourly read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PricingGet200ResponsePricingPrimaryIpsInnerPricesInnerPriceHourly given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PricingGet200ResponsePricingPrimaryIpsInnerPricesInnerPriceHourly
   * @throws IOException if the JSON string is invalid with respect to PricingGet200ResponsePricingPrimaryIpsInnerPricesInnerPriceHourly
   */
  public static PricingGet200ResponsePricingPrimaryIpsInnerPricesInnerPriceHourly fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PricingGet200ResponsePricingPrimaryIpsInnerPricesInnerPriceHourly.class);
  }

  /**
   * Convert an instance of PricingGet200ResponsePricingPrimaryIpsInnerPricesInnerPriceHourly to an JSON string
   *
   * @return JSON string
   */
