...
public class VolumesIdActionsChangeProtectionPostRequest {
  public static final String SERIALIZED_NAME_DELETE = "delete";
  @SerializedName(SERIALIZED_NAME_DELETE)
  private Boolean delete;

  public VolumesIdActionsChangeProtectionPostRequest() {
  }

  public VolumesIdActionsChangeProtectionPostRequest delete(Boolean delete) {
    this.delete = delete;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    VolumesIdActionsChangeProtectionPostRequest volumesIdActionsChangeProtectionPostRequest = (VolumesIdActionsChangeProtectionPostRequest) o;
    return Objects.equals(this.delete, volumesIdActionsChangeProtectionPostRequest.delete);
  }
  ...
  public String toString() {
    ...
    sb.append("class VolumesIdActionsChangeProtectionPostRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to VolumesIdActionsChangeProtectionPostRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!VolumesIdActionsChangeProtectionPostRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in VolumesIdActionsChangeProtectionPostRequest is not found in the empty JSON string", VolumesIdActionsChangeProtectionPostRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!VolumesIdActionsChangeProtectionPostRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `VolumesIdActionsChangeProtectionPostRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!VolumesIdActionsChangeProtectionPostRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'VolumesIdActionsChangeProtectionPostRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<VolumesIdActionsChangeProtectionPostRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(VolumesIdActionsChangeProtectionPostRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<VolumesIdActionsChangeProtectionPostRequest>() {
           @Override
           public void write(JsonWriter out, VolumesIdActionsChangeProtectionPostRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public VolumesIdActionsChangeProtectionPostRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of VolumesIdActionsChangeProtectionPostRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of VolumesIdActionsChangeProtectionPostRequest
   * @throws IOException if the JSON string is invalid with respect to VolumesIdActionsChangeProtectionPostRequest
   */
  public static VolumesIdActionsChangeProtectionPostRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, VolumesIdActionsChangeProtectionPostRequest.class);
  }

  /**
   * Convert an instance of VolumesIdActionsChangeProtectionPostRequest to an JSON string
   *
   * @return JSON string
   */
