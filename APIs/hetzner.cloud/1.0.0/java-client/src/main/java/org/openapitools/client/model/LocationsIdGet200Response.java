...
public class LocationsIdGet200Response {
  public static final String SERIALIZED_NAME_LOCATION = "location";
  @SerializedName(SERIALIZED_NAME_LOCATION)
  private DatacentersGet200ResponseDatacentersInnerLocation location;

  public LocationsIdGet200Response() {
  }

  public LocationsIdGet200Response location(DatacentersGet200ResponseDatacentersInnerLocation location) {
  ...
  public boolean equals(Object o) {
    ...
    LocationsIdGet200Response locationsIdGet200Response = (LocationsIdGet200Response) o;
    return Objects.equals(this.location, locationsIdGet200Response.location);
  }
  ...
  public String toString() {
    ...
    sb.append("class LocationsIdGet200Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to LocationsIdGet200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LocationsIdGet200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LocationsIdGet200Response is not found in the empty JSON string", LocationsIdGet200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LocationsIdGet200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LocationsIdGet200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LocationsIdGet200Response.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LocationsIdGet200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LocationsIdGet200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LocationsIdGet200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LocationsIdGet200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<LocationsIdGet200Response>() {
           @Override
           public void write(JsonWriter out, LocationsIdGet200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LocationsIdGet200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LocationsIdGet200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LocationsIdGet200Response
   * @throws IOException if the JSON string is invalid with respect to LocationsIdGet200Response
   */
  public static LocationsIdGet200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LocationsIdGet200Response.class);
  }

  /**
   * Convert an instance of LocationsIdGet200Response to an JSON string
   *
   * @return JSON string
   */
