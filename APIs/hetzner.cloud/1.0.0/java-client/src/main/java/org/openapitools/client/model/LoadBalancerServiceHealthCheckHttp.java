...
public class LoadBalancerServiceHealthCheckHttp {
  ...
  public static final String SERIALIZED_NAME_STATUS_CODES = "status_codes";
  ...
  public LoadBalancerServiceHealthCheckHttp() {
  }

  public LoadBalancerServiceHealthCheckHttp domain(String domain) {
    this.domain = domain;
    return this;
  }
  ...
  public LoadBalancerServiceHealthCheckHttp path(String path) {
    this.path = path;
    return this;
  }
  ...
  public LoadBalancerServiceHealthCheckHttp response(String response) {
  ...
  public LoadBalancerServiceHealthCheckHttp statusCodes(List<String> statusCodes) {
    this.statusCodes = statusCodes;
    return this;
  }

  public LoadBalancerServiceHealthCheckHttp addStatusCodesItem(String statusCodesItem) {
  ...
  public LoadBalancerServiceHealthCheckHttp tls(Boolean tls) {
    this.tls = tls;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    LoadBalancerServiceHealthCheckHttp loadBalancerServiceHealthCheckHttp = (LoadBalancerServiceHealthCheckHttp) o;
    return Objects.equals(this.domain, loadBalancerServiceHealthCheckHttp.domain) &&
        Objects.equals(this.path, loadBalancerServiceHealthCheckHttp.path) &&
        Objects.equals(this.response, loadBalancerServiceHealthCheckHttp.response) &&
        Objects.equals(this.statusCodes, loadBalancerServiceHealthCheckHttp.statusCodes) &&
        Objects.equals(this.tls, loadBalancerServiceHealthCheckHttp.tls);
  }

  @Override
  public int hashCode() {
    return Objects.hash(domain, path, response, statusCodes, tls);
  }
  ...
  static {
    ...
    openapiFields.add("status_codes");
   ...
   * @throws IOException if the JSON Element is invalid with respect to LoadBalancerServiceHealthCheckHttp
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LoadBalancerServiceHealthCheckHttp.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LoadBalancerServiceHealthCheckHttp is not found in the empty JSON string", LoadBalancerServiceHealthCheckHttp.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LoadBalancerServiceHealthCheckHttp.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LoadBalancerServiceHealthCheckHttp` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LoadBalancerServiceHealthCheckHttp.openapiRequiredFields) {
      ...
      if (jsonObj.get("status_codes") != null && !jsonObj.get("status_codes").isJsonNull() && !jsonObj.get("status_codes").isJsonArray()) {
        throw new IllegalArgumentException(String.format("Expected the field `status_codes` to be an array in the JSON string but got `%s`", jsonObj.get("status_codes").toString()));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LoadBalancerServiceHealthCheckHttp.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LoadBalancerServiceHealthCheckHttp' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LoadBalancerServiceHealthCheckHttp> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LoadBalancerServiceHealthCheckHttp.class));

       return (TypeAdapter<T>) new TypeAdapter<LoadBalancerServiceHealthCheckHttp>() {
           @Override
           public void write(JsonWriter out, LoadBalancerServiceHealthCheckHttp value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LoadBalancerServiceHealthCheckHttp read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LoadBalancerServiceHealthCheckHttp given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LoadBalancerServiceHealthCheckHttp
   * @throws IOException if the JSON string is invalid with respect to LoadBalancerServiceHealthCheckHttp
   */
  public static LoadBalancerServiceHealthCheckHttp fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LoadBalancerServiceHealthCheckHttp.class);
  }

  /**
   * Convert an instance of LoadBalancerServiceHealthCheckHttp to an JSON string
   *
   * @return JSON string
   */
