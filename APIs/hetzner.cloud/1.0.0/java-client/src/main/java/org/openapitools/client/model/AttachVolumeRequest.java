...
public class AttachVolumeRequest {
  ...
  public AttachVolumeRequest automount(Boolean automount) {
  ...
  public AttachVolumeRequest server(Integer server) {
    this.server = server;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.automount, attachVolumeRequest.automount) &&
        Objects.equals(this.server, attachVolumeRequest.server);
  }

  @Override
  public int hashCode() {
    return Objects.hash(automount, server);
  }
