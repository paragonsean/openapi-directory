...
public class LocationsGet200Response {
  ...
  private List<DatacentersGet200ResponseDatacentersInnerLocation> locations = new ArrayList<>();

  public LocationsGet200Response() {
  }

  public LocationsGet200Response locations(List<DatacentersGet200ResponseDatacentersInnerLocation> locations) {
    this.locations = locations;
    return this;
  }

  public LocationsGet200Response addLocationsItem(DatacentersGet200ResponseDatacentersInnerLocation locationsItem) {
  ...
  public List<DatacentersGet200ResponseDatacentersInnerLocation> getLocations() {
    return locations;
  }

  public void setLocations(List<DatacentersGet200ResponseDatacentersInnerLocation> locations) {
    this.locations = locations;
  }
  ...
  public boolean equals(Object o) {
    ...
    LocationsGet200Response locationsGet200Response = (LocationsGet200Response) o;
    return Objects.equals(this.locations, locationsGet200Response.locations);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to LocationsGet200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LocationsGet200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LocationsGet200Response is not found in the empty JSON string", LocationsGet200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LocationsGet200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LocationsGet200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LocationsGet200Response.openapiRequiredFields) {
      ...
      for (int i = 0; i < jsonArraylocations.size(); i++) {
        DatacentersGet200ResponseDatacentersInnerLocation.validateJsonElement(jsonArraylocations.get(i));
      };
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LocationsGet200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LocationsGet200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LocationsGet200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LocationsGet200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<LocationsGet200Response>() {
           @Override
           public void write(JsonWriter out, LocationsGet200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LocationsGet200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LocationsGet200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LocationsGet200Response
   * @throws IOException if the JSON string is invalid with respect to LocationsGet200Response
   */
  public static LocationsGet200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LocationsGet200Response.class);
  }

  /**
   * Convert an instance of LocationsGet200Response to an JSON string
   *
   * @return JSON string
   */
