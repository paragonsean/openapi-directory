...
public class ActionsResponse {
  ...
  public ActionsResponse actions(List<Action> actions) {
    this.actions = actions;
    return this;
  }

  public ActionsResponse addActionsItem(Action actionsItem) {
  ...
  public ActionsResponse meta(ActionsResponseMeta meta) {
    this.meta = meta;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    ActionsResponse actionsResponse = (ActionsResponse) o;
    return Objects.equals(this.actions, actionsResponse.actions) &&
        Objects.equals(this.meta, actionsResponse.meta);
  }

  @Override
  public int hashCode() {
    return Objects.hash(actions, meta);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ActionsResponse {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ActionsResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ActionsResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionsResponse is not found in the empty JSON string", ActionsResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ActionsResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ActionsResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionsResponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionsResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionsResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionsResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionsResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionsResponse>() {
           @Override
           public void write(JsonWriter out, ActionsResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ActionsResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ActionsResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ActionsResponse
   * @throws IOException if the JSON string is invalid with respect to ActionsResponse
   */
  public static ActionsResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionsResponse.class);
  }

  /**
   * Convert an instance of ActionsResponse to an JSON string
   *
   * @return JSON string
   */
