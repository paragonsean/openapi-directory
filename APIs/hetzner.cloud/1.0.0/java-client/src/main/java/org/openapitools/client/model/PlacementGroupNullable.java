...
public class PlacementGroupNullable {
  ...
  public PlacementGroupNullable() {
  }

  public PlacementGroupNullable created(String created) {
  ...
  public PlacementGroupNullable id(Integer id) {
    this.id = id;
    return this;
  }
  ...
  public PlacementGroupNullable labels(Map<String, String> labels) {
    this.labels = labels;
    return this;
  }

  public PlacementGroupNullable putLabelsItem(String key, String labelsItem) {
    if (this.labels == null) {
  ...
  public PlacementGroupNullable name(String name) {
    this.name = name;
    return this;
  }
  ...
  public PlacementGroupNullable servers(List<Integer> servers) {
    this.servers = servers;
    return this;
  }

  public PlacementGroupNullable addServersItem(Integer serversItem) {
  ...
  public PlacementGroupNullable type(TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    PlacementGroupNullable placementGroupNullable = (PlacementGroupNullable) o;
    return Objects.equals(this.created, placementGroupNullable.created) &&
        Objects.equals(this.id, placementGroupNullable.id) &&
        Objects.equals(this.labels, placementGroupNullable.labels) &&
        Objects.equals(this.name, placementGroupNullable.name) &&
        Objects.equals(this.servers, placementGroupNullable.servers) &&
        Objects.equals(this.type, placementGroupNullable.type);
  }

  @Override
  public int hashCode() {
    return Objects.hash(created, id, labels, name, servers, type);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to PlacementGroupNullable
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PlacementGroupNullable.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PlacementGroupNullable is not found in the empty JSON string", PlacementGroupNullable.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PlacementGroupNullable.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PlacementGroupNullable` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PlacementGroupNullable.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PlacementGroupNullable.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PlacementGroupNullable' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PlacementGroupNullable> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PlacementGroupNullable.class));

       return (TypeAdapter<T>) new TypeAdapter<PlacementGroupNullable>() {
           @Override
           public void write(JsonWriter out, PlacementGroupNullable value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PlacementGroupNullable read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PlacementGroupNullable given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PlacementGroupNullable
   * @throws IOException if the JSON string is invalid with respect to PlacementGroupNullable
   */
  public static PlacementGroupNullable fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PlacementGroupNullable.class);
  }

  /**
   * Convert an instance of PlacementGroupNullable to an JSON string
   *
   * @return JSON string
   */
