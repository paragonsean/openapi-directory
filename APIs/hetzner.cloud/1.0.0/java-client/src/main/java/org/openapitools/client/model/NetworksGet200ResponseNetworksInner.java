...
public class NetworksGet200ResponseNetworksInner {
  ...
  private NetworksGet200ResponseNetworksInnerProtection protection;
  ...
  private List<NetworksGet200ResponseNetworksInnerSubnetsInner> subnets = new ArrayList<>();

  public NetworksGet200ResponseNetworksInner() {
  }

  public NetworksGet200ResponseNetworksInner created(String created) {
  ...
  public NetworksGet200ResponseNetworksInner id(Integer id) {
    this.id = id;
    return this;
  }
  ...
  public NetworksGet200ResponseNetworksInner ipRange(String ipRange) {
  ...
  public NetworksGet200ResponseNetworksInner labels(Object labels) {
    this.labels = labels;
    return this;
  }
  ...
  public NetworksGet200ResponseNetworksInner loadBalancers(List<Integer> loadBalancers) {
    this.loadBalancers = loadBalancers;
    return this;
  }

  public NetworksGet200ResponseNetworksInner addLoadBalancersItem(Integer loadBalancersItem) {
  ...
  public NetworksGet200ResponseNetworksInner name(String name) {
    this.name = name;
    return this;
  }
  ...
  public NetworksGet200ResponseNetworksInner protection(NetworksGet200ResponseNetworksInnerProtection protection) {
   ...
   */
  @javax.annotation.Nonnull
  public NetworksGet200ResponseNetworksInnerProtection getProtection() {
    return protection;
  }

  public void setProtection(NetworksGet200ResponseNetworksInnerProtection protection) {
    this.protection = protection;
  }


  public NetworksGet200ResponseNetworksInner routes(List<NetworksGet200ResponseNetworksInnerRoutesInner> routes) {
    this.routes = routes;
    return this;
  }

  public NetworksGet200ResponseNetworksInner addRoutesItem(NetworksGet200ResponseNetworksInnerRoutesInner routesItem) {
    if (this.routes == null) {
  ...
  public NetworksGet200ResponseNetworksInner servers(List<Integer> servers) {
    this.servers = servers;
    return this;
  }

  public NetworksGet200ResponseNetworksInner addServersItem(Integer serversItem) {
  ...
  public NetworksGet200ResponseNetworksInner subnets(List<NetworksGet200ResponseNetworksInnerSubnetsInner> subnets) {
    this.subnets = subnets;
    return this;
  }

  public NetworksGet200ResponseNetworksInner addSubnetsItem(NetworksGet200ResponseNetworksInnerSubnetsInner subnetsItem) {
   ...
   */
  @javax.annotation.Nonnull
  public List<NetworksGet200ResponseNetworksInnerSubnetsInner> getSubnets() {
    return subnets;
  }

  public void setSubnets(List<NetworksGet200ResponseNetworksInnerSubnetsInner> subnets) {
    this.subnets = subnets;
  }
  ...
  public boolean equals(Object o) {
    ...
    NetworksGet200ResponseNetworksInner networksGet200ResponseNetworksInner = (NetworksGet200ResponseNetworksInner) o;
    return Objects.equals(this.created, networksGet200ResponseNetworksInner.created) &&
        Objects.equals(this.id, networksGet200ResponseNetworksInner.id) &&
        Objects.equals(this.ipRange, networksGet200ResponseNetworksInner.ipRange) &&
        Objects.equals(this.labels, networksGet200ResponseNetworksInner.labels) &&
        Objects.equals(this.loadBalancers, networksGet200ResponseNetworksInner.loadBalancers) &&
        Objects.equals(this.name, networksGet200ResponseNetworksInner.name) &&
        Objects.equals(this.protection, networksGet200ResponseNetworksInner.protection) &&
        Objects.equals(this.routes, networksGet200ResponseNetworksInner.routes) &&
        Objects.equals(this.servers, networksGet200ResponseNetworksInner.servers) &&
        Objects.equals(this.subnets, networksGet200ResponseNetworksInner.subnets);
  }

  @Override
  public int hashCode() {
    return Objects.hash(created, id, ipRange, labels, loadBalancers, name, protection, routes, servers, subnets);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class NetworksGet200ResponseNetworksInner {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to NetworksGet200ResponseNetworksInner
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!NetworksGet200ResponseNetworksInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in NetworksGet200ResponseNetworksInner is not found in the empty JSON string", NetworksGet200ResponseNetworksInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!NetworksGet200ResponseNetworksInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `NetworksGet200ResponseNetworksInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : NetworksGet200ResponseNetworksInner.openapiRequiredFields) {
      ...
      NetworksGet200ResponseNetworksInnerProtection.validateJsonElement(jsonObj.get("protection"));
      ...
      for (int i = 0; i < jsonArraysubnets.size(); i++) {
        NetworksGet200ResponseNetworksInnerSubnetsInner.validateJsonElement(jsonArraysubnets.get(i));
      };
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!NetworksGet200ResponseNetworksInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'NetworksGet200ResponseNetworksInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<NetworksGet200ResponseNetworksInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(NetworksGet200ResponseNetworksInner.class));

       return (TypeAdapter<T>) new TypeAdapter<NetworksGet200ResponseNetworksInner>() {
           @Override
           public void write(JsonWriter out, NetworksGet200ResponseNetworksInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public NetworksGet200ResponseNetworksInner read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of NetworksGet200ResponseNetworksInner given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of NetworksGet200ResponseNetworksInner
   * @throws IOException if the JSON string is invalid with respect to NetworksGet200ResponseNetworksInner
   */
  public static NetworksGet200ResponseNetworksInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, NetworksGet200ResponseNetworksInner.class);
  }

  /**
   * Convert an instance of NetworksGet200ResponseNetworksInner to an JSON string
   *
   * @return JSON string
   */
