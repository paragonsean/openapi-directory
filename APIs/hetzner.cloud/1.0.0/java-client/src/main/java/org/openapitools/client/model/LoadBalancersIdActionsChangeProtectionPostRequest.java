...
public class LoadBalancersIdActionsChangeProtectionPostRequest {
  public static final String SERIALIZED_NAME_DELETE = "delete";
  @SerializedName(SERIALIZED_NAME_DELETE)
  private Boolean delete;

  public LoadBalancersIdActionsChangeProtectionPostRequest() {
  }

  public LoadBalancersIdActionsChangeProtectionPostRequest delete(Boolean delete) {
    this.delete = delete;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    LoadBalancersIdActionsChangeProtectionPostRequest loadBalancersIdActionsChangeProtectionPostRequest = (LoadBalancersIdActionsChangeProtectionPostRequest) o;
    return Objects.equals(this.delete, loadBalancersIdActionsChangeProtectionPostRequest.delete);
  }
  ...
  public String toString() {
    ...
    sb.append("class LoadBalancersIdActionsChangeProtectionPostRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to LoadBalancersIdActionsChangeProtectionPostRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LoadBalancersIdActionsChangeProtectionPostRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LoadBalancersIdActionsChangeProtectionPostRequest is not found in the empty JSON string", LoadBalancersIdActionsChangeProtectionPostRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LoadBalancersIdActionsChangeProtectionPostRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LoadBalancersIdActionsChangeProtectionPostRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LoadBalancersIdActionsChangeProtectionPostRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LoadBalancersIdActionsChangeProtectionPostRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LoadBalancersIdActionsChangeProtectionPostRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LoadBalancersIdActionsChangeProtectionPostRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<LoadBalancersIdActionsChangeProtectionPostRequest>() {
           @Override
           public void write(JsonWriter out, LoadBalancersIdActionsChangeProtectionPostRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LoadBalancersIdActionsChangeProtectionPostRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LoadBalancersIdActionsChangeProtectionPostRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LoadBalancersIdActionsChangeProtectionPostRequest
   * @throws IOException if the JSON string is invalid with respect to LoadBalancersIdActionsChangeProtectionPostRequest
   */
  public static LoadBalancersIdActionsChangeProtectionPostRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LoadBalancersIdActionsChangeProtectionPostRequest.class);
  }

  /**
   * Convert an instance of LoadBalancersIdActionsChangeProtectionPostRequest to an JSON string
   *
   * @return JSON string
   */
