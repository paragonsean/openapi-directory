...
public class ChangeDNSPTRRequest {
  ...
  public ChangeDNSPTRRequest() {
  }

  public ChangeDNSPTRRequest dnsPtr(String dnsPtr) {
    this.dnsPtr = dnsPtr;
    return this;
  }
  ...
  public ChangeDNSPTRRequest ip(String ip) {
    this.ip = ip;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    ChangeDNSPTRRequest changeDNSPTRRequest = (ChangeDNSPTRRequest) o;
    return Objects.equals(this.dnsPtr, changeDNSPTRRequest.dnsPtr) &&
        Objects.equals(this.ip, changeDNSPTRRequest.ip);
  }
  ...
  public String toString() {
    ...
    sb.append("class ChangeDNSPTRRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ChangeDNSPTRRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ChangeDNSPTRRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ChangeDNSPTRRequest is not found in the empty JSON string", ChangeDNSPTRRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ChangeDNSPTRRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ChangeDNSPTRRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ChangeDNSPTRRequest.openapiRequiredFields) {
        if (jsonElement.getAsJsonObject().get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      if ((jsonObj.get("dns_ptr") != null && !jsonObj.get("dns_ptr").isJsonNull()) && !jsonObj.get("dns_ptr").isJsonPrimitive()) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ChangeDNSPTRRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ChangeDNSPTRRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ChangeDNSPTRRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ChangeDNSPTRRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<ChangeDNSPTRRequest>() {
           @Override
           public void write(JsonWriter out, ChangeDNSPTRRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ChangeDNSPTRRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ChangeDNSPTRRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ChangeDNSPTRRequest
   * @throws IOException if the JSON string is invalid with respect to ChangeDNSPTRRequest
   */
  public static ChangeDNSPTRRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ChangeDNSPTRRequest.class);
  }

  /**
   * Convert an instance of ChangeDNSPTRRequest to an JSON string
   *
   * @return JSON string
   */
