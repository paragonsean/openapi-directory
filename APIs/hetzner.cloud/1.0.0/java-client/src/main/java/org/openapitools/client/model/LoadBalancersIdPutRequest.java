...
public class LoadBalancersIdPutRequest {
  ...
  public LoadBalancersIdPutRequest() {
  }

  public LoadBalancersIdPutRequest labels(Object labels) {
    this.labels = labels;
    return this;
  }
  ...
  public LoadBalancersIdPutRequest name(String name) {
    this.name = name;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    LoadBalancersIdPutRequest loadBalancersIdPutRequest = (LoadBalancersIdPutRequest) o;
    return Objects.equals(this.labels, loadBalancersIdPutRequest.labels) &&
        Objects.equals(this.name, loadBalancersIdPutRequest.name);
  }
  ...
  public String toString() {
    ...
    sb.append("class LoadBalancersIdPutRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to LoadBalancersIdPutRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LoadBalancersIdPutRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LoadBalancersIdPutRequest is not found in the empty JSON string", LoadBalancersIdPutRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LoadBalancersIdPutRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LoadBalancersIdPutRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LoadBalancersIdPutRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LoadBalancersIdPutRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LoadBalancersIdPutRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LoadBalancersIdPutRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<LoadBalancersIdPutRequest>() {
           @Override
           public void write(JsonWriter out, LoadBalancersIdPutRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LoadBalancersIdPutRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LoadBalancersIdPutRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LoadBalancersIdPutRequest
   * @throws IOException if the JSON string is invalid with respect to LoadBalancersIdPutRequest
   */
  public static LoadBalancersIdPutRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LoadBalancersIdPutRequest.class);
  }

  /**
   * Convert an instance of LoadBalancersIdPutRequest to an JSON string
   *
   * @return JSON string
   */
