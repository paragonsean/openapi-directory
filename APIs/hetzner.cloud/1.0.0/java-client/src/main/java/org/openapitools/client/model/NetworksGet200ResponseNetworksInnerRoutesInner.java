...
public class NetworksGet200ResponseNetworksInnerRoutesInner {
  ...
  public NetworksGet200ResponseNetworksInnerRoutesInner() {
  }

  public NetworksGet200ResponseNetworksInnerRoutesInner destination(String destination) {
  ...
  public NetworksGet200ResponseNetworksInnerRoutesInner gateway(String gateway) {
  ...
  public boolean equals(Object o) {
    ...
    NetworksGet200ResponseNetworksInnerRoutesInner networksGet200ResponseNetworksInnerRoutesInner = (NetworksGet200ResponseNetworksInnerRoutesInner) o;
    return Objects.equals(this.destination, networksGet200ResponseNetworksInnerRoutesInner.destination) &&
        Objects.equals(this.gateway, networksGet200ResponseNetworksInnerRoutesInner.gateway);
  }
  ...
  public String toString() {
    ...
    sb.append("class NetworksGet200ResponseNetworksInnerRoutesInner {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to NetworksGet200ResponseNetworksInnerRoutesInner
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!NetworksGet200ResponseNetworksInnerRoutesInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in NetworksGet200ResponseNetworksInnerRoutesInner is not found in the empty JSON string", NetworksGet200ResponseNetworksInnerRoutesInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!NetworksGet200ResponseNetworksInnerRoutesInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `NetworksGet200ResponseNetworksInnerRoutesInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : NetworksGet200ResponseNetworksInnerRoutesInner.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!NetworksGet200ResponseNetworksInnerRoutesInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'NetworksGet200ResponseNetworksInnerRoutesInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<NetworksGet200ResponseNetworksInnerRoutesInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(NetworksGet200ResponseNetworksInnerRoutesInner.class));

       return (TypeAdapter<T>) new TypeAdapter<NetworksGet200ResponseNetworksInnerRoutesInner>() {
           @Override
           public void write(JsonWriter out, NetworksGet200ResponseNetworksInnerRoutesInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public NetworksGet200ResponseNetworksInnerRoutesInner read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of NetworksGet200ResponseNetworksInnerRoutesInner given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of NetworksGet200ResponseNetworksInnerRoutesInner
   * @throws IOException if the JSON string is invalid with respect to NetworksGet200ResponseNetworksInnerRoutesInner
   */
  public static NetworksGet200ResponseNetworksInnerRoutesInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, NetworksGet200ResponseNetworksInnerRoutesInner.class);
  }

  /**
   * Convert an instance of NetworksGet200ResponseNetworksInnerRoutesInner to an JSON string
   *
   * @return JSON string
   */
