...
public class LoadBalancersIdActionsDeleteServicePostRequest {
  public static final String SERIALIZED_NAME_LISTEN_PORT = "listen_port";
  @SerializedName(SERIALIZED_NAME_LISTEN_PORT)
  private BigDecimal listenPort;

  public LoadBalancersIdActionsDeleteServicePostRequest() {
  }

  public LoadBalancersIdActionsDeleteServicePostRequest listenPort(BigDecimal listenPort) {
  ...
  public BigDecimal getListenPort() {
    return listenPort;
  }

  public void setListenPort(BigDecimal listenPort) {
    this.listenPort = listenPort;
  }
  ...
  public boolean equals(Object o) {
    ...
    LoadBalancersIdActionsDeleteServicePostRequest loadBalancersIdActionsDeleteServicePostRequest = (LoadBalancersIdActionsDeleteServicePostRequest) o;
    return Objects.equals(this.listenPort, loadBalancersIdActionsDeleteServicePostRequest.listenPort);
  }
  ...
  public String toString() {
    ...
    sb.append("class LoadBalancersIdActionsDeleteServicePostRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to LoadBalancersIdActionsDeleteServicePostRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LoadBalancersIdActionsDeleteServicePostRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LoadBalancersIdActionsDeleteServicePostRequest is not found in the empty JSON string", LoadBalancersIdActionsDeleteServicePostRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LoadBalancersIdActionsDeleteServicePostRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LoadBalancersIdActionsDeleteServicePostRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LoadBalancersIdActionsDeleteServicePostRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LoadBalancersIdActionsDeleteServicePostRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LoadBalancersIdActionsDeleteServicePostRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LoadBalancersIdActionsDeleteServicePostRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LoadBalancersIdActionsDeleteServicePostRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<LoadBalancersIdActionsDeleteServicePostRequest>() {
           @Override
           public void write(JsonWriter out, LoadBalancersIdActionsDeleteServicePostRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LoadBalancersIdActionsDeleteServicePostRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LoadBalancersIdActionsDeleteServicePostRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LoadBalancersIdActionsDeleteServicePostRequest
   * @throws IOException if the JSON string is invalid with respect to LoadBalancersIdActionsDeleteServicePostRequest
   */
  public static LoadBalancersIdActionsDeleteServicePostRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LoadBalancersIdActionsDeleteServicePostRequest.class);
  }

  /**
   * Convert an instance of LoadBalancersIdActionsDeleteServicePostRequest to an JSON string
   *
   * @return JSON string
   */
