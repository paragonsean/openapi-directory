...
import org.openapitools.client.model.ServersGet200ResponseServersInner;
...
public class CreateServerResponse {
  ...
  private ServersGet200ResponseServersInner server;

  public CreateServerResponse() {
  }

  public CreateServerResponse action(Action action) {
    this.action = action;
    return this;
  }
  ...
  public CreateServerResponse nextActions(List<Action> nextActions) {
    this.nextActions = nextActions;
    return this;
  }

  public CreateServerResponse addNextActionsItem(Action nextActionsItem) {
  ...
  public CreateServerResponse rootPassword(String rootPassword) {
  ...
  public CreateServerResponse server(ServersGet200ResponseServersInner server) {
    this.server = server;
    return this;
  }
   ...
   */
  @javax.annotation.Nonnull
  public ServersGet200ResponseServersInner getServer() {
    return server;
  }

  public void setServer(ServersGet200ResponseServersInner server) {
    this.server = server;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.action, createServerResponse.action) &&
        Objects.equals(this.nextActions, createServerResponse.nextActions) &&
        Objects.equals(this.rootPassword, createServerResponse.rootPassword) &&
        Objects.equals(this.server, createServerResponse.server);
  }

  @Override
  public int hashCode() {
    return Objects.hash(action, nextActions, rootPassword, server);
  }
  ...
  static {
    ...
    openapiRequiredFields.add("root_password");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (String requiredField : CreateServerResponse.openapiRequiredFields) {
      ...
      ServersGet200ResponseServersInner.validateJsonElement(jsonObj.get("server"));
  }
