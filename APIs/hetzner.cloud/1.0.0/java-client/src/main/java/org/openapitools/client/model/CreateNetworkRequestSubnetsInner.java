...
public class CreateNetworkRequestSubnetsInner {
  ...
  public CreateNetworkRequestSubnetsInner() {
  }

  public CreateNetworkRequestSubnetsInner ipRange(String ipRange) {
  ...
  public CreateNetworkRequestSubnetsInner networkZone(String networkZone) {
  ...
  public CreateNetworkRequestSubnetsInner type(TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  public CreateNetworkRequestSubnetsInner vswitchId(Integer vswitchId) {
  ...
  public boolean equals(Object o) {
    ...
    CreateNetworkRequestSubnetsInner createNetworkRequestSubnetsInner = (CreateNetworkRequestSubnetsInner) o;
    return Objects.equals(this.ipRange, createNetworkRequestSubnetsInner.ipRange) &&
        Objects.equals(this.networkZone, createNetworkRequestSubnetsInner.networkZone) &&
        Objects.equals(this.type, createNetworkRequestSubnetsInner.type) &&
        Objects.equals(this.vswitchId, createNetworkRequestSubnetsInner.vswitchId);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateNetworkRequestSubnetsInner {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateNetworkRequestSubnetsInner
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateNetworkRequestSubnetsInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateNetworkRequestSubnetsInner is not found in the empty JSON string", CreateNetworkRequestSubnetsInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateNetworkRequestSubnetsInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateNetworkRequestSubnetsInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CreateNetworkRequestSubnetsInner.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateNetworkRequestSubnetsInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateNetworkRequestSubnetsInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateNetworkRequestSubnetsInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateNetworkRequestSubnetsInner.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateNetworkRequestSubnetsInner>() {
           @Override
           public void write(JsonWriter out, CreateNetworkRequestSubnetsInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateNetworkRequestSubnetsInner read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateNetworkRequestSubnetsInner given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateNetworkRequestSubnetsInner
   * @throws IOException if the JSON string is invalid with respect to CreateNetworkRequestSubnetsInner
   */
  public static CreateNetworkRequestSubnetsInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateNetworkRequestSubnetsInner.class);
  }

  /**
   * Convert an instance of CreateNetworkRequestSubnetsInner to an JSON string
   *
   * @return JSON string
   */
