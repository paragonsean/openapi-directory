...
public class PrimaryIPDatacenter {
  ...
  public PrimaryIPDatacenter() {
  }

  public PrimaryIPDatacenter description(String description) {
  ...
  public PrimaryIPDatacenter id(Integer id) {
    this.id = id;
    return this;
  }
  ...
  public PrimaryIPDatacenter location(DatacentersGet200ResponseDatacentersInnerLocation location) {
  ...
  public PrimaryIPDatacenter name(String name) {
    this.name = name;
    return this;
  }
  ...
  public PrimaryIPDatacenter serverTypes(DatacentersGet200ResponseDatacentersInnerServerTypes serverTypes) {
  ...
  public boolean equals(Object o) {
    ...
    PrimaryIPDatacenter primaryIPDatacenter = (PrimaryIPDatacenter) o;
    return Objects.equals(this.description, primaryIPDatacenter.description) &&
        Objects.equals(this.id, primaryIPDatacenter.id) &&
        Objects.equals(this.location, primaryIPDatacenter.location) &&
        Objects.equals(this.name, primaryIPDatacenter.name) &&
        Objects.equals(this.serverTypes, primaryIPDatacenter.serverTypes);
  }
  ...
  public String toString() {
    ...
    sb.append("class PrimaryIPDatacenter {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PrimaryIPDatacenter
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PrimaryIPDatacenter.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PrimaryIPDatacenter is not found in the empty JSON string", PrimaryIPDatacenter.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PrimaryIPDatacenter.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PrimaryIPDatacenter` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PrimaryIPDatacenter.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PrimaryIPDatacenter.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PrimaryIPDatacenter' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PrimaryIPDatacenter> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PrimaryIPDatacenter.class));

       return (TypeAdapter<T>) new TypeAdapter<PrimaryIPDatacenter>() {
           @Override
           public void write(JsonWriter out, PrimaryIPDatacenter value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PrimaryIPDatacenter read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PrimaryIPDatacenter given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PrimaryIPDatacenter
   * @throws IOException if the JSON string is invalid with respect to PrimaryIPDatacenter
   */
  public static PrimaryIPDatacenter fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PrimaryIPDatacenter.class);
  }

  /**
   * Convert an instance of PrimaryIPDatacenter to an JSON string
   *
   * @return JSON string
   */
