...
public class CreateFirewallRequestApplyToInnerServer {
  public static final String SERIALIZED_NAME_ID = "id";
  @SerializedName(SERIALIZED_NAME_ID)
  private Integer id;

  public CreateFirewallRequestApplyToInnerServer() {
  }

  public CreateFirewallRequestApplyToInnerServer id(Integer id) {
    this.id = id;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    CreateFirewallRequestApplyToInnerServer createFirewallRequestApplyToInnerServer = (CreateFirewallRequestApplyToInnerServer) o;
    return Objects.equals(this.id, createFirewallRequestApplyToInnerServer.id);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateFirewallRequestApplyToInnerServer {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateFirewallRequestApplyToInnerServer
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateFirewallRequestApplyToInnerServer.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateFirewallRequestApplyToInnerServer is not found in the empty JSON string", CreateFirewallRequestApplyToInnerServer.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateFirewallRequestApplyToInnerServer.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateFirewallRequestApplyToInnerServer` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CreateFirewallRequestApplyToInnerServer.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateFirewallRequestApplyToInnerServer.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateFirewallRequestApplyToInnerServer' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateFirewallRequestApplyToInnerServer> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateFirewallRequestApplyToInnerServer.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateFirewallRequestApplyToInnerServer>() {
           @Override
           public void write(JsonWriter out, CreateFirewallRequestApplyToInnerServer value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateFirewallRequestApplyToInnerServer read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateFirewallRequestApplyToInnerServer given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateFirewallRequestApplyToInnerServer
   * @throws IOException if the JSON string is invalid with respect to CreateFirewallRequestApplyToInnerServer
   */
  public static CreateFirewallRequestApplyToInnerServer fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateFirewallRequestApplyToInnerServer.class);
  }

  /**
   * Convert an instance of CreateFirewallRequestApplyToInnerServer to an JSON string
   *
   * @return JSON string
   */
