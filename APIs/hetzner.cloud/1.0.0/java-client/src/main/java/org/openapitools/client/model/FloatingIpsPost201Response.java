...
public class FloatingIpsPost201Response {
  ...
  public FloatingIpsPost201Response() {
  }

  public FloatingIpsPost201Response action(Action action) {
    this.action = action;
    return this;
  }
  ...
  public FloatingIpsPost201Response floatingIp(FloatingIpsGet200ResponseFloatingIpsInner floatingIp) {
  ...
  public boolean equals(Object o) {
    ...
    FloatingIpsPost201Response floatingIpsPost201Response = (FloatingIpsPost201Response) o;
    return Objects.equals(this.action, floatingIpsPost201Response.action) &&
        Objects.equals(this.floatingIp, floatingIpsPost201Response.floatingIp);
  }

  @Override
  public int hashCode() {
    return Objects.hash(action, floatingIp);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class FloatingIpsPost201Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to FloatingIpsPost201Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!FloatingIpsPost201Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FloatingIpsPost201Response is not found in the empty JSON string", FloatingIpsPost201Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!FloatingIpsPost201Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `FloatingIpsPost201Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : FloatingIpsPost201Response.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FloatingIpsPost201Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FloatingIpsPost201Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FloatingIpsPost201Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FloatingIpsPost201Response.class));

       return (TypeAdapter<T>) new TypeAdapter<FloatingIpsPost201Response>() {
           @Override
           public void write(JsonWriter out, FloatingIpsPost201Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public FloatingIpsPost201Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of FloatingIpsPost201Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of FloatingIpsPost201Response
   * @throws IOException if the JSON string is invalid with respect to FloatingIpsPost201Response
   */
  public static FloatingIpsPost201Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FloatingIpsPost201Response.class);
  }

  /**
   * Convert an instance of FloatingIpsPost201Response to an JSON string
   *
   * @return JSON string
   */
