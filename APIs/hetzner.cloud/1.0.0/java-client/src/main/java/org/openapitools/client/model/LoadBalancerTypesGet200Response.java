...
public class LoadBalancerTypesGet200Response {
  ...
  private List<LoadBalancerTypesGet200ResponseLoadBalancerTypesInner> loadBalancerTypes = new ArrayList<>();

  public LoadBalancerTypesGet200Response() {
  }

  public LoadBalancerTypesGet200Response loadBalancerTypes(List<LoadBalancerTypesGet200ResponseLoadBalancerTypesInner> loadBalancerTypes) {
    this.loadBalancerTypes = loadBalancerTypes;
    return this;
  }

  public LoadBalancerTypesGet200Response addLoadBalancerTypesItem(LoadBalancerTypesGet200ResponseLoadBalancerTypesInner loadBalancerTypesItem) {
  ...
  /**
   * Get loadBalancerTypes
   * @return loadBalancerTypes
   */
  @javax.annotation.Nonnull
  public List<LoadBalancerTypesGet200ResponseLoadBalancerTypesInner> getLoadBalancerTypes() {
    return loadBalancerTypes;
  }

  public void setLoadBalancerTypes(List<LoadBalancerTypesGet200ResponseLoadBalancerTypesInner> loadBalancerTypes) {
    this.loadBalancerTypes = loadBalancerTypes;
  }
  ...
  public boolean equals(Object o) {
    ...
    LoadBalancerTypesGet200Response loadBalancerTypesGet200Response = (LoadBalancerTypesGet200Response) o;
    return Objects.equals(this.loadBalancerTypes, loadBalancerTypesGet200Response.loadBalancerTypes);
  }

  @Override
  public int hashCode() {
    return Objects.hash(loadBalancerTypes);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class LoadBalancerTypesGet200Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to LoadBalancerTypesGet200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LoadBalancerTypesGet200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LoadBalancerTypesGet200Response is not found in the empty JSON string", LoadBalancerTypesGet200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LoadBalancerTypesGet200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LoadBalancerTypesGet200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LoadBalancerTypesGet200Response.openapiRequiredFields) {
      ...
      for (int i = 0; i < jsonArrayloadBalancerTypes.size(); i++) {
        LoadBalancerTypesGet200ResponseLoadBalancerTypesInner.validateJsonElement(jsonArrayloadBalancerTypes.get(i));
      };
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LoadBalancerTypesGet200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LoadBalancerTypesGet200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LoadBalancerTypesGet200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LoadBalancerTypesGet200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<LoadBalancerTypesGet200Response>() {
           @Override
           public void write(JsonWriter out, LoadBalancerTypesGet200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LoadBalancerTypesGet200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LoadBalancerTypesGet200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LoadBalancerTypesGet200Response
   * @throws IOException if the JSON string is invalid with respect to LoadBalancerTypesGet200Response
   */
  public static LoadBalancerTypesGet200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LoadBalancerTypesGet200Response.class);
  }

  /**
   * Convert an instance of LoadBalancerTypesGet200Response to an JSON string
   *
   * @return JSON string
   */
