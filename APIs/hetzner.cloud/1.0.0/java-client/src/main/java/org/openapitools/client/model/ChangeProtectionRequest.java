...
public class ChangeProtectionRequest {
  ...
  public ChangeProtectionRequest() {
  }

  public ChangeProtectionRequest delete(Boolean delete) {
    this.delete = delete;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    ChangeProtectionRequest changeProtectionRequest = (ChangeProtectionRequest) o;
    return Objects.equals(this.delete, changeProtectionRequest.delete);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ChangeProtectionRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ChangeProtectionRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ChangeProtectionRequest is not found in the empty JSON string", ChangeProtectionRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ChangeProtectionRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ChangeProtectionRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ChangeProtectionRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ChangeProtectionRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ChangeProtectionRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ChangeProtectionRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<ChangeProtectionRequest>() {
           @Override
           public void write(JsonWriter out, ChangeProtectionRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ChangeProtectionRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ChangeProtectionRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ChangeProtectionRequest
   * @throws IOException if the JSON string is invalid with respect to ChangeProtectionRequest
   */
  public static ChangeProtectionRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ChangeProtectionRequest.class);
  }

  /**
   * Convert an instance of ChangeProtectionRequest to an JSON string
   *
   * @return JSON string
   */
