...
public class AddToPlacementGroupRequest {
  ...
  public AddToPlacementGroupRequest() {
  }

  public AddToPlacementGroupRequest placementGroup(Integer placementGroup) {
  ...
  public boolean equals(Object o) {
    ...
    AddToPlacementGroupRequest addToPlacementGroupRequest = (AddToPlacementGroupRequest) o;
    return Objects.equals(this.placementGroup, addToPlacementGroupRequest.placementGroup);
  }

  @Override
  public int hashCode() {
    return Objects.hash(placementGroup);
  }
  ...
  static {
    ...
    openapiRequiredFields.add("placement_group");
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to AddToPlacementGroupRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AddToPlacementGroupRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AddToPlacementGroupRequest is not found in the empty JSON string", AddToPlacementGroupRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AddToPlacementGroupRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AddToPlacementGroupRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AddToPlacementGroupRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AddToPlacementGroupRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AddToPlacementGroupRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AddToPlacementGroupRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AddToPlacementGroupRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<AddToPlacementGroupRequest>() {
           @Override
           public void write(JsonWriter out, AddToPlacementGroupRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AddToPlacementGroupRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AddToPlacementGroupRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AddToPlacementGroupRequest
   * @throws IOException if the JSON string is invalid with respect to AddToPlacementGroupRequest
   */
  public static AddToPlacementGroupRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AddToPlacementGroupRequest.class);
  }

  /**
   * Convert an instance of AddToPlacementGroupRequest to an JSON string
   *
   * @return JSON string
   */
