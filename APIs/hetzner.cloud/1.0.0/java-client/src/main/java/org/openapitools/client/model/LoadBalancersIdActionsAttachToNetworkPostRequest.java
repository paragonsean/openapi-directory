...
public class LoadBalancersIdActionsAttachToNetworkPostRequest {
  ...
  public LoadBalancersIdActionsAttachToNetworkPostRequest() {
  }

  public LoadBalancersIdActionsAttachToNetworkPostRequest ip(String ip) {
    this.ip = ip;
    return this;
  }
  ...
  public LoadBalancersIdActionsAttachToNetworkPostRequest network(BigDecimal network) {
  ...
  public boolean equals(Object o) {
    ...
    LoadBalancersIdActionsAttachToNetworkPostRequest loadBalancersIdActionsAttachToNetworkPostRequest = (LoadBalancersIdActionsAttachToNetworkPostRequest) o;
    return Objects.equals(this.ip, loadBalancersIdActionsAttachToNetworkPostRequest.ip) &&
        Objects.equals(this.network, loadBalancersIdActionsAttachToNetworkPostRequest.network);
  }
  ...
  public String toString() {
    ...
    sb.append("class LoadBalancersIdActionsAttachToNetworkPostRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to LoadBalancersIdActionsAttachToNetworkPostRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LoadBalancersIdActionsAttachToNetworkPostRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LoadBalancersIdActionsAttachToNetworkPostRequest is not found in the empty JSON string", LoadBalancersIdActionsAttachToNetworkPostRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LoadBalancersIdActionsAttachToNetworkPostRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LoadBalancersIdActionsAttachToNetworkPostRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LoadBalancersIdActionsAttachToNetworkPostRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LoadBalancersIdActionsAttachToNetworkPostRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LoadBalancersIdActionsAttachToNetworkPostRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LoadBalancersIdActionsAttachToNetworkPostRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LoadBalancersIdActionsAttachToNetworkPostRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<LoadBalancersIdActionsAttachToNetworkPostRequest>() {
           @Override
           public void write(JsonWriter out, LoadBalancersIdActionsAttachToNetworkPostRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LoadBalancersIdActionsAttachToNetworkPostRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LoadBalancersIdActionsAttachToNetworkPostRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LoadBalancersIdActionsAttachToNetworkPostRequest
   * @throws IOException if the JSON string is invalid with respect to LoadBalancersIdActionsAttachToNetworkPostRequest
   */
  public static LoadBalancersIdActionsAttachToNetworkPostRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LoadBalancersIdActionsAttachToNetworkPostRequest.class);
  }

  /**
   * Convert an instance of LoadBalancersIdActionsAttachToNetworkPostRequest to an JSON string
   *
   * @return JSON string
   */
