...
public class PlacementGroupResponse {
  ...
  public PlacementGroupResponse() {
  }

  public PlacementGroupResponse placementGroup(PlacementGroup placementGroup) {
  ...
  public boolean equals(Object o) {
    ...
    PlacementGroupResponse placementGroupResponse = (PlacementGroupResponse) o;
    return Objects.equals(this.placementGroup, placementGroupResponse.placementGroup);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to PlacementGroupResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PlacementGroupResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PlacementGroupResponse is not found in the empty JSON string", PlacementGroupResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PlacementGroupResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PlacementGroupResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PlacementGroupResponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PlacementGroupResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PlacementGroupResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PlacementGroupResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PlacementGroupResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<PlacementGroupResponse>() {
           @Override
           public void write(JsonWriter out, PlacementGroupResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PlacementGroupResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PlacementGroupResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PlacementGroupResponse
   * @throws IOException if the JSON string is invalid with respect to PlacementGroupResponse
   */
  public static PlacementGroupResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PlacementGroupResponse.class);
  }

  /**
   * Convert an instance of PlacementGroupResponse to an JSON string
   *
   * @return JSON string
   */
