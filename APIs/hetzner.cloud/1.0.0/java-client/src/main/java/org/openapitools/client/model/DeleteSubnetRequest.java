...
public class DeleteSubnetRequest {
  ...
  public DeleteSubnetRequest ipRange(String ipRange) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.ipRange, deleteSubnetRequest.ipRange);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to DeleteSubnetRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DeleteSubnetRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DeleteSubnetRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DeleteSubnetRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
