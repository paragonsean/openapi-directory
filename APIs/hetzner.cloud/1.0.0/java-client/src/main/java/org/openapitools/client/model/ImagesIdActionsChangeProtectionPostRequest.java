...
public class ImagesIdActionsChangeProtectionPostRequest {
  public static final String SERIALIZED_NAME_DELETE = "delete";
  @SerializedName(SERIALIZED_NAME_DELETE)
  private Boolean delete;

  public ImagesIdActionsChangeProtectionPostRequest() {
  }

  public ImagesIdActionsChangeProtectionPostRequest delete(Boolean delete) {
    this.delete = delete;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    ImagesIdActionsChangeProtectionPostRequest imagesIdActionsChangeProtectionPostRequest = (ImagesIdActionsChangeProtectionPostRequest) o;
    return Objects.equals(this.delete, imagesIdActionsChangeProtectionPostRequest.delete);
  }
  ...
  public String toString() {
    ...
    sb.append("class ImagesIdActionsChangeProtectionPostRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ImagesIdActionsChangeProtectionPostRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ImagesIdActionsChangeProtectionPostRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ImagesIdActionsChangeProtectionPostRequest is not found in the empty JSON string", ImagesIdActionsChangeProtectionPostRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ImagesIdActionsChangeProtectionPostRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ImagesIdActionsChangeProtectionPostRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ImagesIdActionsChangeProtectionPostRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ImagesIdActionsChangeProtectionPostRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ImagesIdActionsChangeProtectionPostRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ImagesIdActionsChangeProtectionPostRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<ImagesIdActionsChangeProtectionPostRequest>() {
           @Override
           public void write(JsonWriter out, ImagesIdActionsChangeProtectionPostRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ImagesIdActionsChangeProtectionPostRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ImagesIdActionsChangeProtectionPostRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ImagesIdActionsChangeProtectionPostRequest
   * @throws IOException if the JSON string is invalid with respect to ImagesIdActionsChangeProtectionPostRequest
   */
  public static ImagesIdActionsChangeProtectionPostRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ImagesIdActionsChangeProtectionPostRequest.class);
  }

  /**
   * Convert an instance of ImagesIdActionsChangeProtectionPostRequest to an JSON string
   *
   * @return JSON string
   */
