...
public class ChangeTypeRequest {
  ...
  public ChangeTypeRequest loadBalancerType(String loadBalancerType) {
  ...
  public boolean equals(Object o) {
    ...
    ChangeTypeRequest changeTypeRequest = (ChangeTypeRequest) o;
    return Objects.equals(this.loadBalancerType, changeTypeRequest.loadBalancerType);
  }

  @Override
  public int hashCode() {
    return Objects.hash(loadBalancerType);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ChangeTypeRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ChangeTypeRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ChangeTypeRequest is not found in the empty JSON string", ChangeTypeRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ChangeTypeRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ChangeTypeRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ChangeTypeRequest.openapiRequiredFields) {
        if (jsonElement.getAsJsonObject().get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      if (!jsonObj.get("load_balancer_type").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `load_balancer_type` to be a primitive type in the JSON string but got `%s`", jsonObj.get("load_balancer_type").toString()));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ChangeTypeRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ChangeTypeRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ChangeTypeRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ChangeTypeRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<ChangeTypeRequest>() {
           @Override
           public void write(JsonWriter out, ChangeTypeRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ChangeTypeRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ChangeTypeRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ChangeTypeRequest
   * @throws IOException if the JSON string is invalid with respect to ChangeTypeRequest
   */
  public static ChangeTypeRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ChangeTypeRequest.class);
  }

  /**
   * Convert an instance of ChangeTypeRequest to an JSON string
   *
   * @return JSON string
   */
