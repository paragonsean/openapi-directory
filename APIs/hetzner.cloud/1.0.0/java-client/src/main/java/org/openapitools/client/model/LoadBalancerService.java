...
public class LoadBalancerService {
  ...
  private LoadBalancerServiceHTTP http;
  ...
  public static final String SERIALIZED_NAME_PROXYPROTOCOL = "proxyprotocol";
  @SerializedName(SERIALIZED_NAME_PROXYPROTOCOL)
  private Boolean proxyprotocol;

  public LoadBalancerService() {
  }

  public LoadBalancerService destinationPort(Integer destinationPort) {
  ...
  public LoadBalancerService http(LoadBalancerServiceHTTP http) {
    this.http = http;
    return this;
  }
  ...
  public LoadBalancerServiceHTTP getHttp() {
    return http;
  }

  public void setHttp(LoadBalancerServiceHTTP http) {
    this.http = http;
  }


  public LoadBalancerService listenPort(Integer listenPort) {
  ...
  public LoadBalancerService proxyprotocol(Boolean proxyprotocol) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.destinationPort, loadBalancerService.destinationPort) &&
        Objects.equals(this.healthCheck, loadBalancerService.healthCheck) &&
        Objects.equals(this.http, loadBalancerService.http) &&
        Objects.equals(this.listenPort, loadBalancerService.listenPort) &&
        Objects.equals(this.protocol, loadBalancerService.protocol) &&
        Objects.equals(this.proxyprotocol, loadBalancerService.proxyprotocol);
  }

  @Override
  public int hashCode() {
    return Objects.hash(destinationPort, healthCheck, http, listenPort, protocol, proxyprotocol);
  }
  ...
  static {
    ...
    openapiFields.add("proxyprotocol");

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>();
    openapiRequiredFields.add("destination_port");
    openapiRequiredFields.add("health_check");
    openapiRequiredFields.add("listen_port");
    openapiRequiredFields.add("protocol");
    openapiRequiredFields.add("proxyprotocol");
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (String requiredField : LoadBalancerService.openapiRequiredFields) {
        if (jsonElement.getAsJsonObject().get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the required field `health_check`
      LoadBalancerServiceHealthCheck.validateJsonElement(jsonObj.get("health_check"));
      // validate the optional field `http`
      if (jsonObj.get("http") != null && !jsonObj.get("http").isJsonNull()) {
        LoadBalancerServiceHTTP.validateJsonElement(jsonObj.get("http"));
      }
