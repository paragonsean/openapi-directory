...
public class ServersIdDelete200Response {
  public static final String SERIALIZED_NAME_ACTION = "action";
  @SerializedName(SERIALIZED_NAME_ACTION)
  private Action action;

  public ServersIdDelete200Response() {
  }

  public ServersIdDelete200Response action(Action action) {
    this.action = action;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    ServersIdDelete200Response serversIdDelete200Response = (ServersIdDelete200Response) o;
    return Objects.equals(this.action, serversIdDelete200Response.action);
  }
  ...
  public String toString() {
    ...
    sb.append("class ServersIdDelete200Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ServersIdDelete200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ServersIdDelete200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ServersIdDelete200Response is not found in the empty JSON string", ServersIdDelete200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ServersIdDelete200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ServersIdDelete200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ServersIdDelete200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ServersIdDelete200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ServersIdDelete200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ServersIdDelete200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<ServersIdDelete200Response>() {
           @Override
           public void write(JsonWriter out, ServersIdDelete200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ServersIdDelete200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ServersIdDelete200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ServersIdDelete200Response
   * @throws IOException if the JSON string is invalid with respect to ServersIdDelete200Response
   */
  public static ServersIdDelete200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ServersIdDelete200Response.class);
  }

  /**
   * Convert an instance of ServersIdDelete200Response to an JSON string
   *
   * @return JSON string
   */
