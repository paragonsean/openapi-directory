...
public class CreateServerRequestFirewallsInner {
  ...
  public CreateServerRequestFirewallsInner() {
  }

  public CreateServerRequestFirewallsInner firewall(Integer firewall) {
  ...
  public boolean equals(Object o) {
    ...
    CreateServerRequestFirewallsInner createServerRequestFirewallsInner = (CreateServerRequestFirewallsInner) o;
    return Objects.equals(this.firewall, createServerRequestFirewallsInner.firewall);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateServerRequestFirewallsInner
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateServerRequestFirewallsInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateServerRequestFirewallsInner is not found in the empty JSON string", CreateServerRequestFirewallsInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateServerRequestFirewallsInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateServerRequestFirewallsInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateServerRequestFirewallsInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateServerRequestFirewallsInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateServerRequestFirewallsInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateServerRequestFirewallsInner.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateServerRequestFirewallsInner>() {
           @Override
           public void write(JsonWriter out, CreateServerRequestFirewallsInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateServerRequestFirewallsInner read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateServerRequestFirewallsInner given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateServerRequestFirewallsInner
   * @throws IOException if the JSON string is invalid with respect to CreateServerRequestFirewallsInner
   */
  public static CreateServerRequestFirewallsInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateServerRequestFirewallsInner.class);
  }

  /**
   * Convert an instance of CreateServerRequestFirewallsInner to an JSON string
   *
   * @return JSON string
   */
