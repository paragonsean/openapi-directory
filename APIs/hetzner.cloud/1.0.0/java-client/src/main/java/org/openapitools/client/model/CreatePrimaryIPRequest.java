...
public class CreatePrimaryIPRequest {
  ...
  public CreatePrimaryIPRequest assigneeId(Integer assigneeId) {
  ...
  public CreatePrimaryIPRequest assigneeType(AssigneeTypeEnum assigneeType) {
  ...
  public CreatePrimaryIPRequest autoDelete(Boolean autoDelete) {
  ...
  public CreatePrimaryIPRequest datacenter(String datacenter) {
  ...
  public CreatePrimaryIPRequest labels(Object labels) {
    this.labels = labels;
    return this;
  }
  ...
  public CreatePrimaryIPRequest name(String name) {
    this.name = name;
    return this;
  }
  ...
  public CreatePrimaryIPRequest type(TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    CreatePrimaryIPRequest createPrimaryIPRequest = (CreatePrimaryIPRequest) o;
    return Objects.equals(this.assigneeId, createPrimaryIPRequest.assigneeId) &&
        Objects.equals(this.assigneeType, createPrimaryIPRequest.assigneeType) &&
        Objects.equals(this.autoDelete, createPrimaryIPRequest.autoDelete) &&
        Objects.equals(this.datacenter, createPrimaryIPRequest.datacenter) &&
        Objects.equals(this.labels, createPrimaryIPRequest.labels) &&
        Objects.equals(this.name, createPrimaryIPRequest.name) &&
        Objects.equals(this.type, createPrimaryIPRequest.type);
  }

  @Override
  public int hashCode() {
    return Objects.hash(assigneeId, assigneeType, autoDelete, datacenter, labels, name, type);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreatePrimaryIPRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreatePrimaryIPRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreatePrimaryIPRequest is not found in the empty JSON string", CreatePrimaryIPRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreatePrimaryIPRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreatePrimaryIPRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CreatePrimaryIPRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreatePrimaryIPRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreatePrimaryIPRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreatePrimaryIPRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreatePrimaryIPRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<CreatePrimaryIPRequest>() {
           @Override
           public void write(JsonWriter out, CreatePrimaryIPRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreatePrimaryIPRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreatePrimaryIPRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreatePrimaryIPRequest
   * @throws IOException if the JSON string is invalid with respect to CreatePrimaryIPRequest
   */
  public static CreatePrimaryIPRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreatePrimaryIPRequest.class);
  }

  /**
   * Convert an instance of CreatePrimaryIPRequest to an JSON string
   *
   * @return JSON string
   */
