...
public class NetworksGet200ResponseNetworksInnerSubnetsInner {
  ...
  public NetworksGet200ResponseNetworksInnerSubnetsInner() {
  }

  public NetworksGet200ResponseNetworksInnerSubnetsInner gateway(String gateway) {
  ...
  public NetworksGet200ResponseNetworksInnerSubnetsInner ipRange(String ipRange) {
  ...
  public NetworksGet200ResponseNetworksInnerSubnetsInner networkZone(String networkZone) {
  ...
  public NetworksGet200ResponseNetworksInnerSubnetsInner type(TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    NetworksGet200ResponseNetworksInnerSubnetsInner networksGet200ResponseNetworksInnerSubnetsInner = (NetworksGet200ResponseNetworksInnerSubnetsInner) o;
    return Objects.equals(this.gateway, networksGet200ResponseNetworksInnerSubnetsInner.gateway) &&
        Objects.equals(this.ipRange, networksGet200ResponseNetworksInnerSubnetsInner.ipRange) &&
        Objects.equals(this.networkZone, networksGet200ResponseNetworksInnerSubnetsInner.networkZone) &&
        Objects.equals(this.type, networksGet200ResponseNetworksInnerSubnetsInner.type);
  }

  @Override
  public int hashCode() {
    return Objects.hash(gateway, ipRange, networkZone, type);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class NetworksGet200ResponseNetworksInnerSubnetsInner {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to NetworksGet200ResponseNetworksInnerSubnetsInner
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!NetworksGet200ResponseNetworksInnerSubnetsInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in NetworksGet200ResponseNetworksInnerSubnetsInner is not found in the empty JSON string", NetworksGet200ResponseNetworksInnerSubnetsInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!NetworksGet200ResponseNetworksInnerSubnetsInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `NetworksGet200ResponseNetworksInnerSubnetsInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : NetworksGet200ResponseNetworksInnerSubnetsInner.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!NetworksGet200ResponseNetworksInnerSubnetsInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'NetworksGet200ResponseNetworksInnerSubnetsInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<NetworksGet200ResponseNetworksInnerSubnetsInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(NetworksGet200ResponseNetworksInnerSubnetsInner.class));

       return (TypeAdapter<T>) new TypeAdapter<NetworksGet200ResponseNetworksInnerSubnetsInner>() {
           @Override
           public void write(JsonWriter out, NetworksGet200ResponseNetworksInnerSubnetsInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public NetworksGet200ResponseNetworksInnerSubnetsInner read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of NetworksGet200ResponseNetworksInnerSubnetsInner given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of NetworksGet200ResponseNetworksInnerSubnetsInner
   * @throws IOException if the JSON string is invalid with respect to NetworksGet200ResponseNetworksInnerSubnetsInner
   */
  public static NetworksGet200ResponseNetworksInnerSubnetsInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, NetworksGet200ResponseNetworksInnerSubnetsInner.class);
  }

  /**
   * Convert an instance of NetworksGet200ResponseNetworksInnerSubnetsInner to an JSON string
   *
   * @return JSON string
   */
