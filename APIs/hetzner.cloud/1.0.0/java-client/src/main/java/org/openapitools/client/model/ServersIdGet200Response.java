...
public class ServersIdGet200Response {
  public static final String SERIALIZED_NAME_SERVER = "server";
  @SerializedName(SERIALIZED_NAME_SERVER)
  private ServersGet200ResponseServersInner server;

  public ServersIdGet200Response() {
  }

  public ServersIdGet200Response server(ServersGet200ResponseServersInner server) {
    this.server = server;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    ServersIdGet200Response serversIdGet200Response = (ServersIdGet200Response) o;
    return Objects.equals(this.server, serversIdGet200Response.server);
  }
  ...
  public String toString() {
    ...
    sb.append("class ServersIdGet200Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ServersIdGet200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ServersIdGet200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ServersIdGet200Response is not found in the empty JSON string", ServersIdGet200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ServersIdGet200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ServersIdGet200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ServersIdGet200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ServersIdGet200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ServersIdGet200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ServersIdGet200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<ServersIdGet200Response>() {
           @Override
           public void write(JsonWriter out, ServersIdGet200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ServersIdGet200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ServersIdGet200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ServersIdGet200Response
   * @throws IOException if the JSON string is invalid with respect to ServersIdGet200Response
   */
  public static ServersIdGet200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ServersIdGet200Response.class);
  }

  /**
   * Convert an instance of ServersIdGet200Response to an JSON string
   *
   * @return JSON string
   */
