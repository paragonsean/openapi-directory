...
import org.openapitools.client.model.ImagesGet200ResponseImagesInner;
...
public class ImagesIdGet200Response {
  public static final String SERIALIZED_NAME_IMAGE = "image";
  @SerializedName(SERIALIZED_NAME_IMAGE)
  private ImagesGet200ResponseImagesInner image;

  public ImagesIdGet200Response() {
  }

  public ImagesIdGet200Response image(ImagesGet200ResponseImagesInner image) {
    this.image = image;
    return this;
  }
  ...
  public ImagesGet200ResponseImagesInner getImage() {
    return image;
  }

  public void setImage(ImagesGet200ResponseImagesInner image) {
    this.image = image;
  }
  ...
  public boolean equals(Object o) {
    ...
    ImagesIdGet200Response imagesIdGet200Response = (ImagesIdGet200Response) o;
    return Objects.equals(this.image, imagesIdGet200Response.image);
  }
  ...
  public String toString() {
    ...
    sb.append("class ImagesIdGet200Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ImagesIdGet200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ImagesIdGet200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ImagesIdGet200Response is not found in the empty JSON string", ImagesIdGet200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ImagesIdGet200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ImagesIdGet200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `image`
      if (jsonObj.get("image") != null && !jsonObj.get("image").isJsonNull()) {
        ImagesGet200ResponseImagesInner.validateJsonElement(jsonObj.get("image"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ImagesIdGet200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ImagesIdGet200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ImagesIdGet200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ImagesIdGet200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<ImagesIdGet200Response>() {
           @Override
           public void write(JsonWriter out, ImagesIdGet200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ImagesIdGet200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ImagesIdGet200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ImagesIdGet200Response
   * @throws IOException if the JSON string is invalid with respect to ImagesIdGet200Response
   */
  public static ImagesIdGet200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ImagesIdGet200Response.class);
  }

  /**
   * Convert an instance of ImagesIdGet200Response to an JSON string
   *
   * @return JSON string
   */
