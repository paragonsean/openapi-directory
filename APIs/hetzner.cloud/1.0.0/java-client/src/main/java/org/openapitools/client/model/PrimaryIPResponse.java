...
public class PrimaryIPResponse {
  ...
  public PrimaryIPResponse() {
  }

  public PrimaryIPResponse primaryIp(PrimaryIP primaryIp) {
  ...
  public boolean equals(Object o) {
    ...
    PrimaryIPResponse primaryIPResponse = (PrimaryIPResponse) o;
    return Objects.equals(this.primaryIp, primaryIPResponse.primaryIp);
  }

  @Override
  public int hashCode() {
    return Objects.hash(primaryIp);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to PrimaryIPResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PrimaryIPResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PrimaryIPResponse is not found in the empty JSON string", PrimaryIPResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PrimaryIPResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PrimaryIPResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PrimaryIPResponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PrimaryIPResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PrimaryIPResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PrimaryIPResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PrimaryIPResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<PrimaryIPResponse>() {
           @Override
           public void write(JsonWriter out, PrimaryIPResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PrimaryIPResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PrimaryIPResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PrimaryIPResponse
   * @throws IOException if the JSON string is invalid with respect to PrimaryIPResponse
   */
  public static PrimaryIPResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PrimaryIPResponse.class);
  }

  /**
   * Convert an instance of PrimaryIPResponse to an JSON string
   *
   * @return JSON string
   */
