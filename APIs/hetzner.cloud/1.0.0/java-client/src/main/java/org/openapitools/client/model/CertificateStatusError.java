...
public class CertificateStatusError {
  ...
  public CertificateStatusError() {
  }

  public CertificateStatusError code(String code) {
    this.code = code;
    return this;
  }
  ...
  public CertificateStatusError message(String message) {
  ...
  public boolean equals(Object o) {
    ...
    CertificateStatusError certificateStatusError = (CertificateStatusError) o;
    return Objects.equals(this.code, certificateStatusError.code) &&
        Objects.equals(this.message, certificateStatusError.message);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to CertificateStatusError
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CertificateStatusError.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CertificateStatusError is not found in the empty JSON string", CertificateStatusError.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CertificateStatusError.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CertificateStatusError` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CertificateStatusError.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CertificateStatusError' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CertificateStatusError> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CertificateStatusError.class));

       return (TypeAdapter<T>) new TypeAdapter<CertificateStatusError>() {
           @Override
           public void write(JsonWriter out, CertificateStatusError value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CertificateStatusError read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CertificateStatusError given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CertificateStatusError
   * @throws IOException if the JSON string is invalid with respect to CertificateStatusError
   */
  public static CertificateStatusError fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CertificateStatusError.class);
  }

  /**
   * Convert an instance of CertificateStatusError to an JSON string
   *
   * @return JSON string
   */
