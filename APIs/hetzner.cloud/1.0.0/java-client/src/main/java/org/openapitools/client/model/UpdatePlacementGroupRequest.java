...
public class UpdatePlacementGroupRequest {
  ...
  public UpdatePlacementGroupRequest labels(Object labels) {
    this.labels = labels;
    return this;
  }
  ...
  public UpdatePlacementGroupRequest name(String name) {
    this.name = name;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    UpdatePlacementGroupRequest updatePlacementGroupRequest = (UpdatePlacementGroupRequest) o;
    return Objects.equals(this.labels, updatePlacementGroupRequest.labels) &&
        Objects.equals(this.name, updatePlacementGroupRequest.name);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdatePlacementGroupRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdatePlacementGroupRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdatePlacementGroupRequest is not found in the empty JSON string", UpdatePlacementGroupRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdatePlacementGroupRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdatePlacementGroupRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdatePlacementGroupRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdatePlacementGroupRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdatePlacementGroupRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdatePlacementGroupRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdatePlacementGroupRequest>() {
           @Override
           public void write(JsonWriter out, UpdatePlacementGroupRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdatePlacementGroupRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdatePlacementGroupRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdatePlacementGroupRequest
   * @throws IOException if the JSON string is invalid with respect to UpdatePlacementGroupRequest
   */
  public static UpdatePlacementGroupRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdatePlacementGroupRequest.class);
  }

  /**
   * Convert an instance of UpdatePlacementGroupRequest to an JSON string
   *
   * @return JSON string
   */
