...
import org.openapitools.client.model.LoadBalancersGet200ResponseLoadBalancersInner;
...
public class LoadBalancersPost201Response {
  ...
  private LoadBalancersGet200ResponseLoadBalancersInner loadBalancer;

  public LoadBalancersPost201Response() {
  }

  public LoadBalancersPost201Response action(Action action) {
    this.action = action;
    return this;
  }
  ...
  public LoadBalancersPost201Response loadBalancer(LoadBalancersGet200ResponseLoadBalancersInner loadBalancer) {
   ...
   */
  @javax.annotation.Nonnull
  public LoadBalancersGet200ResponseLoadBalancersInner getLoadBalancer() {
    return loadBalancer;
  }

  public void setLoadBalancer(LoadBalancersGet200ResponseLoadBalancersInner loadBalancer) {
    this.loadBalancer = loadBalancer;
  }
  ...
  public boolean equals(Object o) {
    ...
    LoadBalancersPost201Response loadBalancersPost201Response = (LoadBalancersPost201Response) o;
    return Objects.equals(this.action, loadBalancersPost201Response.action) &&
        Objects.equals(this.loadBalancer, loadBalancersPost201Response.loadBalancer);
  }

  @Override
  public int hashCode() {
    return Objects.hash(action, loadBalancer);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class LoadBalancersPost201Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to LoadBalancersPost201Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LoadBalancersPost201Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LoadBalancersPost201Response is not found in the empty JSON string", LoadBalancersPost201Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LoadBalancersPost201Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LoadBalancersPost201Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LoadBalancersPost201Response.openapiRequiredFields) {
      ...
      // validate the required field `load_balancer`
      LoadBalancersGet200ResponseLoadBalancersInner.validateJsonElement(jsonObj.get("load_balancer"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LoadBalancersPost201Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LoadBalancersPost201Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LoadBalancersPost201Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LoadBalancersPost201Response.class));

       return (TypeAdapter<T>) new TypeAdapter<LoadBalancersPost201Response>() {
           @Override
           public void write(JsonWriter out, LoadBalancersPost201Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LoadBalancersPost201Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LoadBalancersPost201Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LoadBalancersPost201Response
   * @throws IOException if the JSON string is invalid with respect to LoadBalancersPost201Response
   */
  public static LoadBalancersPost201Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LoadBalancersPost201Response.class);
  }

  /**
   * Convert an instance of LoadBalancersPost201Response to an JSON string
   *
   * @return JSON string
   */
