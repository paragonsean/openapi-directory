...
public class CreateServerRequestPublicNet {
  ...
  public CreateServerRequestPublicNet() {
  }

  public CreateServerRequestPublicNet enableIpv4(Boolean enableIpv4) {
  ...
  public CreateServerRequestPublicNet enableIpv6(Boolean enableIpv6) {
  ...
  public CreateServerRequestPublicNet ipv4(Integer ipv4) {
    this.ipv4 = ipv4;
    return this;
  }
  ...
  public CreateServerRequestPublicNet ipv6(Integer ipv6) {
    this.ipv6 = ipv6;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    CreateServerRequestPublicNet createServerRequestPublicNet = (CreateServerRequestPublicNet) o;
    return Objects.equals(this.enableIpv4, createServerRequestPublicNet.enableIpv4) &&
        Objects.equals(this.enableIpv6, createServerRequestPublicNet.enableIpv6) &&
        Objects.equals(this.ipv4, createServerRequestPublicNet.ipv4) &&
        Objects.equals(this.ipv6, createServerRequestPublicNet.ipv6);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(enableIpv4, enableIpv6, ipv4, ipv6);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateServerRequestPublicNet
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateServerRequestPublicNet.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateServerRequestPublicNet is not found in the empty JSON string", CreateServerRequestPublicNet.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateServerRequestPublicNet.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateServerRequestPublicNet` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateServerRequestPublicNet.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateServerRequestPublicNet' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateServerRequestPublicNet> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateServerRequestPublicNet.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateServerRequestPublicNet>() {
           @Override
           public void write(JsonWriter out, CreateServerRequestPublicNet value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateServerRequestPublicNet read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateServerRequestPublicNet given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateServerRequestPublicNet
   * @throws IOException if the JSON string is invalid with respect to CreateServerRequestPublicNet
   */
  public static CreateServerRequestPublicNet fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateServerRequestPublicNet.class);
  }

  /**
   * Convert an instance of CreateServerRequestPublicNet to an JSON string
   *
   * @return JSON string
   */
