...
public class ServerPublicNetFirewall {
  ...
  public ServerPublicNetFirewall() {
  }

  public ServerPublicNetFirewall id(Integer id) {
    this.id = id;
    return this;
  }
  ...
  public ServerPublicNetFirewall status(StatusEnum status) {
    this.status = status;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    ServerPublicNetFirewall serverPublicNetFirewall = (ServerPublicNetFirewall) o;
    return Objects.equals(this.id, serverPublicNetFirewall.id) &&
        Objects.equals(this.status, serverPublicNetFirewall.status);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ServerPublicNetFirewall
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ServerPublicNetFirewall.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ServerPublicNetFirewall is not found in the empty JSON string", ServerPublicNetFirewall.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ServerPublicNetFirewall.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ServerPublicNetFirewall` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ServerPublicNetFirewall.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ServerPublicNetFirewall' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ServerPublicNetFirewall> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ServerPublicNetFirewall.class));

       return (TypeAdapter<T>) new TypeAdapter<ServerPublicNetFirewall>() {
           @Override
           public void write(JsonWriter out, ServerPublicNetFirewall value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ServerPublicNetFirewall read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ServerPublicNetFirewall given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ServerPublicNetFirewall
   * @throws IOException if the JSON string is invalid with respect to ServerPublicNetFirewall
   */
  public static ServerPublicNetFirewall fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ServerPublicNetFirewall.class);
  }

  /**
   * Convert an instance of ServerPublicNetFirewall to an JSON string
   *
   * @return JSON string
   */
