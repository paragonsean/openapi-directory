...
public class FirewallAppliedToInnerAppliedToResourcesInnerServer {
  public static final String SERIALIZED_NAME_ID = "id";
  @SerializedName(SERIALIZED_NAME_ID)
  private Integer id;

  public FirewallAppliedToInnerAppliedToResourcesInnerServer() {
  }

  public FirewallAppliedToInnerAppliedToResourcesInnerServer id(Integer id) {
    this.id = id;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    FirewallAppliedToInnerAppliedToResourcesInnerServer firewallAppliedToInnerAppliedToResourcesInnerServer = (FirewallAppliedToInnerAppliedToResourcesInnerServer) o;
    return Objects.equals(this.id, firewallAppliedToInnerAppliedToResourcesInnerServer.id);
  }
  ...
  public String toString() {
    ...
    sb.append("class FirewallAppliedToInnerAppliedToResourcesInnerServer {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to FirewallAppliedToInnerAppliedToResourcesInnerServer
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!FirewallAppliedToInnerAppliedToResourcesInnerServer.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FirewallAppliedToInnerAppliedToResourcesInnerServer is not found in the empty JSON string", FirewallAppliedToInnerAppliedToResourcesInnerServer.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!FirewallAppliedToInnerAppliedToResourcesInnerServer.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `FirewallAppliedToInnerAppliedToResourcesInnerServer` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : FirewallAppliedToInnerAppliedToResourcesInnerServer.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FirewallAppliedToInnerAppliedToResourcesInnerServer.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FirewallAppliedToInnerAppliedToResourcesInnerServer' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FirewallAppliedToInnerAppliedToResourcesInnerServer> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FirewallAppliedToInnerAppliedToResourcesInnerServer.class));

       return (TypeAdapter<T>) new TypeAdapter<FirewallAppliedToInnerAppliedToResourcesInnerServer>() {
           @Override
           public void write(JsonWriter out, FirewallAppliedToInnerAppliedToResourcesInnerServer value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public FirewallAppliedToInnerAppliedToResourcesInnerServer read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of FirewallAppliedToInnerAppliedToResourcesInnerServer given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of FirewallAppliedToInnerAppliedToResourcesInnerServer
   * @throws IOException if the JSON string is invalid with respect to FirewallAppliedToInnerAppliedToResourcesInnerServer
   */
  public static FirewallAppliedToInnerAppliedToResourcesInnerServer fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FirewallAppliedToInnerAppliedToResourcesInnerServer.class);
  }

  /**
   * Convert an instance of FirewallAppliedToInnerAppliedToResourcesInnerServer to an JSON string
   *
   * @return JSON string
   */
