...
public class CreateFirewallResponse {
  ...
  public CreateFirewallResponse actions(List<Action> actions) {
    this.actions = actions;
    return this;
  }

  public CreateFirewallResponse addActionsItem(Action actionsItem) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.actions, createFirewallResponse.actions) &&
        Objects.equals(this.firewall, createFirewallResponse.firewall);
  }

  @Override
  public int hashCode() {
    return Objects.hash(actions, firewall);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateFirewallResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateFirewallResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateFirewallResponse is not found in the empty JSON string", CreateFirewallResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateFirewallResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateFirewallResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateFirewallResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateFirewallResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateFirewallResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateFirewallResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateFirewallResponse>() {
           @Override
           public void write(JsonWriter out, CreateFirewallResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateFirewallResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateFirewallResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateFirewallResponse
   * @throws IOException if the JSON string is invalid with respect to CreateFirewallResponse
   */
  public static CreateFirewallResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateFirewallResponse.class);
  }

  /**
   * Convert an instance of CreateFirewallResponse to an JSON string
   *
   * @return JSON string
   */
