...
public class ChangeIPRangeRequest {
  ...
  public ChangeIPRangeRequest() {
  }

  public ChangeIPRangeRequest ipRange(String ipRange) {
  ...
  public boolean equals(Object o) {
    ...
    ChangeIPRangeRequest changeIPRangeRequest = (ChangeIPRangeRequest) o;
    return Objects.equals(this.ipRange, changeIPRangeRequest.ipRange);
  }
  ...
  public String toString() {
    ...
    sb.append("class ChangeIPRangeRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ChangeIPRangeRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ChangeIPRangeRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ChangeIPRangeRequest is not found in the empty JSON string", ChangeIPRangeRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ChangeIPRangeRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ChangeIPRangeRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ChangeIPRangeRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ChangeIPRangeRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ChangeIPRangeRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ChangeIPRangeRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ChangeIPRangeRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<ChangeIPRangeRequest>() {
           @Override
           public void write(JsonWriter out, ChangeIPRangeRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ChangeIPRangeRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ChangeIPRangeRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ChangeIPRangeRequest
   * @throws IOException if the JSON string is invalid with respect to ChangeIPRangeRequest
   */
  public static ChangeIPRangeRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ChangeIPRangeRequest.class);
  }

  /**
   * Convert an instance of ChangeIPRangeRequest to an JSON string
   *
   * @return JSON string
   */
