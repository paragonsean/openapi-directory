...
public class FloatingIpsGet200ResponseFloatingIpsInnerProtection {
  public static final String SERIALIZED_NAME_DELETE = "delete";
  @SerializedName(SERIALIZED_NAME_DELETE)
  private Boolean delete;

  public FloatingIpsGet200ResponseFloatingIpsInnerProtection() {
  }

  public FloatingIpsGet200ResponseFloatingIpsInnerProtection delete(Boolean delete) {
    this.delete = delete;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    FloatingIpsGet200ResponseFloatingIpsInnerProtection floatingIpsGet200ResponseFloatingIpsInnerProtection = (FloatingIpsGet200ResponseFloatingIpsInnerProtection) o;
    return Objects.equals(this.delete, floatingIpsGet200ResponseFloatingIpsInnerProtection.delete);
  }
  ...
  public String toString() {
    ...
    sb.append("class FloatingIpsGet200ResponseFloatingIpsInnerProtection {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to FloatingIpsGet200ResponseFloatingIpsInnerProtection
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!FloatingIpsGet200ResponseFloatingIpsInnerProtection.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FloatingIpsGet200ResponseFloatingIpsInnerProtection is not found in the empty JSON string", FloatingIpsGet200ResponseFloatingIpsInnerProtection.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!FloatingIpsGet200ResponseFloatingIpsInnerProtection.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `FloatingIpsGet200ResponseFloatingIpsInnerProtection` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : FloatingIpsGet200ResponseFloatingIpsInnerProtection.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FloatingIpsGet200ResponseFloatingIpsInnerProtection.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FloatingIpsGet200ResponseFloatingIpsInnerProtection' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FloatingIpsGet200ResponseFloatingIpsInnerProtection> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FloatingIpsGet200ResponseFloatingIpsInnerProtection.class));

       return (TypeAdapter<T>) new TypeAdapter<FloatingIpsGet200ResponseFloatingIpsInnerProtection>() {
           @Override
           public void write(JsonWriter out, FloatingIpsGet200ResponseFloatingIpsInnerProtection value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public FloatingIpsGet200ResponseFloatingIpsInnerProtection read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of FloatingIpsGet200ResponseFloatingIpsInnerProtection given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of FloatingIpsGet200ResponseFloatingIpsInnerProtection
   * @throws IOException if the JSON string is invalid with respect to FloatingIpsGet200ResponseFloatingIpsInnerProtection
   */
  public static FloatingIpsGet200ResponseFloatingIpsInnerProtection fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FloatingIpsGet200ResponseFloatingIpsInnerProtection.class);
  }

  /**
   * Convert an instance of FloatingIpsGet200ResponseFloatingIpsInnerProtection to an JSON string
   *
   * @return JSON string
   */
