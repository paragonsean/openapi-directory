...
public class ImagesGet200ResponseImagesInner {
  ...
  public ImagesGet200ResponseImagesInner() {
  }

  public ImagesGet200ResponseImagesInner boundTo(Integer boundTo) {
  ...
  public ImagesGet200ResponseImagesInner created(String created) {
  ...
  public ImagesGet200ResponseImagesInner createdFrom(ImagesGet200ResponseImagesInnerCreatedFrom createdFrom) {
  ...
  public ImagesGet200ResponseImagesInner deleted(String deleted) {
  ...
  public ImagesGet200ResponseImagesInner deprecated(String deprecated) {
  ...
  public ImagesGet200ResponseImagesInner description(String description) {
  ...
  public ImagesGet200ResponseImagesInner diskSize(BigDecimal diskSize) {
  ...
  public ImagesGet200ResponseImagesInner id(Integer id) {
    this.id = id;
    return this;
  }
  ...
  public ImagesGet200ResponseImagesInner imageSize(BigDecimal imageSize) {
  ...
  public ImagesGet200ResponseImagesInner labels(Map<String, String> labels) {
    this.labels = labels;
    return this;
  }

  public ImagesGet200ResponseImagesInner putLabelsItem(String key, String labelsItem) {
    if (this.labels == null) {
  ...
  public ImagesGet200ResponseImagesInner name(String name) {
    this.name = name;
    return this;
  }
  ...
  public ImagesGet200ResponseImagesInner osFlavor(OsFlavorEnum osFlavor) {
  ...
  public ImagesGet200ResponseImagesInner osVersion(String osVersion) {
  ...
  public ImagesGet200ResponseImagesInner protection(FloatingIpsGet200ResponseFloatingIpsInnerProtection protection) {
  ...
  public ImagesGet200ResponseImagesInner rapidDeploy(Boolean rapidDeploy) {
  ...
  public ImagesGet200ResponseImagesInner status(StatusEnum status) {
    this.status = status;
    return this;
  }
  ...
  public ImagesGet200ResponseImagesInner type(TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    ImagesGet200ResponseImagesInner imagesGet200ResponseImagesInner = (ImagesGet200ResponseImagesInner) o;
    return Objects.equals(this.boundTo, imagesGet200ResponseImagesInner.boundTo) &&
        Objects.equals(this.created, imagesGet200ResponseImagesInner.created) &&
        Objects.equals(this.createdFrom, imagesGet200ResponseImagesInner.createdFrom) &&
        Objects.equals(this.deleted, imagesGet200ResponseImagesInner.deleted) &&
        Objects.equals(this.deprecated, imagesGet200ResponseImagesInner.deprecated) &&
        Objects.equals(this.description, imagesGet200ResponseImagesInner.description) &&
        Objects.equals(this.diskSize, imagesGet200ResponseImagesInner.diskSize) &&
        Objects.equals(this.id, imagesGet200ResponseImagesInner.id) &&
        Objects.equals(this.imageSize, imagesGet200ResponseImagesInner.imageSize) &&
        Objects.equals(this.labels, imagesGet200ResponseImagesInner.labels) &&
        Objects.equals(this.name, imagesGet200ResponseImagesInner.name) &&
        Objects.equals(this.osFlavor, imagesGet200ResponseImagesInner.osFlavor) &&
        Objects.equals(this.osVersion, imagesGet200ResponseImagesInner.osVersion) &&
        Objects.equals(this.protection, imagesGet200ResponseImagesInner.protection) &&
        Objects.equals(this.rapidDeploy, imagesGet200ResponseImagesInner.rapidDeploy) &&
        Objects.equals(this.status, imagesGet200ResponseImagesInner.status) &&
        Objects.equals(this.type, imagesGet200ResponseImagesInner.type);
  }
  ...
  public String toString() {
    ...
    sb.append("class ImagesGet200ResponseImagesInner {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ImagesGet200ResponseImagesInner
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ImagesGet200ResponseImagesInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ImagesGet200ResponseImagesInner is not found in the empty JSON string", ImagesGet200ResponseImagesInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ImagesGet200ResponseImagesInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ImagesGet200ResponseImagesInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ImagesGet200ResponseImagesInner.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ImagesGet200ResponseImagesInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ImagesGet200ResponseImagesInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ImagesGet200ResponseImagesInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ImagesGet200ResponseImagesInner.class));

       return (TypeAdapter<T>) new TypeAdapter<ImagesGet200ResponseImagesInner>() {
           @Override
           public void write(JsonWriter out, ImagesGet200ResponseImagesInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ImagesGet200ResponseImagesInner read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ImagesGet200ResponseImagesInner given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ImagesGet200ResponseImagesInner
   * @throws IOException if the JSON string is invalid with respect to ImagesGet200ResponseImagesInner
   */
  public static ImagesGet200ResponseImagesInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ImagesGet200ResponseImagesInner.class);
  }

  /**
   * Convert an instance of ImagesGet200ResponseImagesInner to an JSON string
   *
   * @return JSON string
   */
