...
public class SshKeysGet200ResponseSshKeysInner {
  ...
  public SshKeysGet200ResponseSshKeysInner() {
  }

  public SshKeysGet200ResponseSshKeysInner created(String created) {
  ...
  public SshKeysGet200ResponseSshKeysInner fingerprint(String fingerprint) {
  ...
  public SshKeysGet200ResponseSshKeysInner id(Integer id) {
    this.id = id;
    return this;
  }
  ...
  public SshKeysGet200ResponseSshKeysInner labels(Map<String, String> labels) {
    this.labels = labels;
    return this;
  }

  public SshKeysGet200ResponseSshKeysInner putLabelsItem(String key, String labelsItem) {
    if (this.labels == null) {
  ...
  public SshKeysGet200ResponseSshKeysInner name(String name) {
    this.name = name;
    return this;
  }
  ...
  public SshKeysGet200ResponseSshKeysInner publicKey(String publicKey) {
  ...
  public boolean equals(Object o) {
    ...
    SshKeysGet200ResponseSshKeysInner sshKeysGet200ResponseSshKeysInner = (SshKeysGet200ResponseSshKeysInner) o;
    return Objects.equals(this.created, sshKeysGet200ResponseSshKeysInner.created) &&
        Objects.equals(this.fingerprint, sshKeysGet200ResponseSshKeysInner.fingerprint) &&
        Objects.equals(this.id, sshKeysGet200ResponseSshKeysInner.id) &&
        Objects.equals(this.labels, sshKeysGet200ResponseSshKeysInner.labels) &&
        Objects.equals(this.name, sshKeysGet200ResponseSshKeysInner.name) &&
        Objects.equals(this.publicKey, sshKeysGet200ResponseSshKeysInner.publicKey);
  }

  @Override
  public int hashCode() {
    return Objects.hash(created, fingerprint, id, labels, name, publicKey);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class SshKeysGet200ResponseSshKeysInner {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to SshKeysGet200ResponseSshKeysInner
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SshKeysGet200ResponseSshKeysInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SshKeysGet200ResponseSshKeysInner is not found in the empty JSON string", SshKeysGet200ResponseSshKeysInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SshKeysGet200ResponseSshKeysInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SshKeysGet200ResponseSshKeysInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : SshKeysGet200ResponseSshKeysInner.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SshKeysGet200ResponseSshKeysInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SshKeysGet200ResponseSshKeysInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SshKeysGet200ResponseSshKeysInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SshKeysGet200ResponseSshKeysInner.class));

       return (TypeAdapter<T>) new TypeAdapter<SshKeysGet200ResponseSshKeysInner>() {
           @Override
           public void write(JsonWriter out, SshKeysGet200ResponseSshKeysInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SshKeysGet200ResponseSshKeysInner read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SshKeysGet200ResponseSshKeysInner given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SshKeysGet200ResponseSshKeysInner
   * @throws IOException if the JSON string is invalid with respect to SshKeysGet200ResponseSshKeysInner
   */
  public static SshKeysGet200ResponseSshKeysInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SshKeysGet200ResponseSshKeysInner.class);
  }

  /**
   * Convert an instance of SshKeysGet200ResponseSshKeysInner to an JSON string
   *
   * @return JSON string
   */
