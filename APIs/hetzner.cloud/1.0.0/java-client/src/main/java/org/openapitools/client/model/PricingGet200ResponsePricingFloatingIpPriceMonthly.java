...
public class PricingGet200ResponsePricingFloatingIpPriceMonthly {
  ...
  public PricingGet200ResponsePricingFloatingIpPriceMonthly() {
  }

  public PricingGet200ResponsePricingFloatingIpPriceMonthly gross(String gross) {
    this.gross = gross;
    return this;
  }
  ...
  public PricingGet200ResponsePricingFloatingIpPriceMonthly net(String net) {
    this.net = net;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    PricingGet200ResponsePricingFloatingIpPriceMonthly pricingGet200ResponsePricingFloatingIpPriceMonthly = (PricingGet200ResponsePricingFloatingIpPriceMonthly) o;
    return Objects.equals(this.gross, pricingGet200ResponsePricingFloatingIpPriceMonthly.gross) &&
        Objects.equals(this.net, pricingGet200ResponsePricingFloatingIpPriceMonthly.net);
  }
  ...
  public String toString() {
    ...
    sb.append("class PricingGet200ResponsePricingFloatingIpPriceMonthly {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PricingGet200ResponsePricingFloatingIpPriceMonthly
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PricingGet200ResponsePricingFloatingIpPriceMonthly.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PricingGet200ResponsePricingFloatingIpPriceMonthly is not found in the empty JSON string", PricingGet200ResponsePricingFloatingIpPriceMonthly.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PricingGet200ResponsePricingFloatingIpPriceMonthly.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PricingGet200ResponsePricingFloatingIpPriceMonthly` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PricingGet200ResponsePricingFloatingIpPriceMonthly.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PricingGet200ResponsePricingFloatingIpPriceMonthly.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PricingGet200ResponsePricingFloatingIpPriceMonthly' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PricingGet200ResponsePricingFloatingIpPriceMonthly> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PricingGet200ResponsePricingFloatingIpPriceMonthly.class));

       return (TypeAdapter<T>) new TypeAdapter<PricingGet200ResponsePricingFloatingIpPriceMonthly>() {
           @Override
           public void write(JsonWriter out, PricingGet200ResponsePricingFloatingIpPriceMonthly value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PricingGet200ResponsePricingFloatingIpPriceMonthly read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PricingGet200ResponsePricingFloatingIpPriceMonthly given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PricingGet200ResponsePricingFloatingIpPriceMonthly
   * @throws IOException if the JSON string is invalid with respect to PricingGet200ResponsePricingFloatingIpPriceMonthly
   */
  public static PricingGet200ResponsePricingFloatingIpPriceMonthly fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PricingGet200ResponsePricingFloatingIpPriceMonthly.class);
  }

  /**
   * Convert an instance of PricingGet200ResponsePricingFloatingIpPriceMonthly to an JSON string
   *
   * @return JSON string
   */
