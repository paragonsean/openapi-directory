...
public class VolumesIdGet200Response {
  public static final String SERIALIZED_NAME_VOLUME = "volume";
  @SerializedName(SERIALIZED_NAME_VOLUME)
  private VolumesGet200ResponseVolumesInner volume;

  public VolumesIdGet200Response() {
  }

  public VolumesIdGet200Response volume(VolumesGet200ResponseVolumesInner volume) {
    this.volume = volume;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    VolumesIdGet200Response volumesIdGet200Response = (VolumesIdGet200Response) o;
    return Objects.equals(this.volume, volumesIdGet200Response.volume);
  }
  ...
  public String toString() {
    ...
    sb.append("class VolumesIdGet200Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to VolumesIdGet200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!VolumesIdGet200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in VolumesIdGet200Response is not found in the empty JSON string", VolumesIdGet200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!VolumesIdGet200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `VolumesIdGet200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : VolumesIdGet200Response.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!VolumesIdGet200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'VolumesIdGet200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<VolumesIdGet200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(VolumesIdGet200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<VolumesIdGet200Response>() {
           @Override
           public void write(JsonWriter out, VolumesIdGet200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public VolumesIdGet200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of VolumesIdGet200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of VolumesIdGet200Response
   * @throws IOException if the JSON string is invalid with respect to VolumesIdGet200Response
   */
  public static VolumesIdGet200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, VolumesIdGet200Response.class);
  }

  /**
   * Convert an instance of VolumesIdGet200Response to an JSON string
   *
   * @return JSON string
   */
