...
public class CertificateActionsApi {
    private ApiClient localVarApiClient;
    private int localHostIndex;
    private String localCustomBaseUrl;

    public CertificateActionsApi() {
        this(Configuration.getDefaultApiClient());
    }

    public CertificateActionsApi(ApiClient apiClient) {
    ...
    /**
     * Build call for certificatesIdActionsActionIdGet
     ...
     */
    public okhttp3.Call certificatesIdActionsActionIdGetCall(Integer id, Integer actionId, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call certificatesIdActionsActionIdGetValidateBeforeCall(Integer id, Integer actionId, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new ApiException("Missing the required parameter 'id' when calling certificatesIdActionsActionIdGet(Async)");
        }

        // verify the required parameter 'actionId' is set
        if (actionId == null) {
            throw new ApiException("Missing the required parameter 'actionId' when calling certificatesIdActionsActionIdGet(Async)");
        }

        return certificatesIdActionsActionIdGetCall(id, actionId, _callback);
     ...
     */
    public ActionResponse certificatesIdActionsActionIdGet(Integer id, Integer actionId) throws ApiException {
        ApiResponse<ActionResponse> localVarResp = certificatesIdActionsActionIdGetWithHttpInfo(id, actionId);
     ...
     */
    public ApiResponse<ActionResponse> certificatesIdActionsActionIdGetWithHttpInfo(Integer id, Integer actionId) throws ApiException {
        okhttp3.Call localVarCall = certificatesIdActionsActionIdGetValidateBeforeCall(id, actionId, null);
        Type localVarReturnType = new TypeToken<ActionResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Get an Action for a Certificate (asynchronously)
     * Returns a specific Action for a Certificate. Only type &#x60;managed&#x60; Certificates have Actions.
     * @param id ID of the Certificate (required)
     * @param actionId ID of the Action (required)
     ...
     */
    public okhttp3.Call certificatesIdActionsActionIdGetAsync(Integer id, Integer actionId, final ApiCallback<ActionResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = certificatesIdActionsActionIdGetValidateBeforeCall(id, actionId, _callback);
        Type localVarReturnType = new TypeToken<ActionResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for certificatesIdActionsGet
     ...
     */
    public okhttp3.Call certificatesIdActionsGetCall(Integer id, String sort, String status, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call certificatesIdActionsGetValidateBeforeCall(Integer id, String sort, String status, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new ApiException("Missing the required parameter 'id' when calling certificatesIdActionsGet(Async)");
        }

        return certificatesIdActionsGetCall(id, sort, status, _callback);
     ...
     */
    public ActionsResponse certificatesIdActionsGet(Integer id, String sort, String status) throws ApiException {
        ApiResponse<ActionsResponse> localVarResp = certificatesIdActionsGetWithHttpInfo(id, sort, status);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<ActionsResponse> certificatesIdActionsGetWithHttpInfo(Integer id, String sort, String status) throws ApiException {
        okhttp3.Call localVarCall = certificatesIdActionsGetValidateBeforeCall(id, sort, status, null);
        Type localVarReturnType = new TypeToken<ActionsResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Get all Actions for a Certificate (asynchronously)
     * Returns all Action objects for a Certificate. You can sort the results by using the &#x60;sort&#x60; URI parameter, and filter them with the &#x60;status&#x60; parameter.  Only type &#x60;managed&#x60; Certificates can have Actions. For type &#x60;uploaded&#x60; Certificates the &#x60;actions&#x60; key will always contain an empty array. 
     * @param id ID of the Resource (required)
     * @param sort Can be used multiple times. (optional)
     * @param status Can be used multiple times, the response will contain only Actions with specified statuses (optional)
     ...
     */
    public okhttp3.Call certificatesIdActionsGetAsync(Integer id, String sort, String status, final ApiCallback<ActionsResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = certificatesIdActionsGetValidateBeforeCall(id, sort, status, _callback);
        Type localVarReturnType = new TypeToken<ActionsResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for certificatesIdActionsRetryPost
     * @param id ID of the Certificate (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    public okhttp3.Call certificatesIdActionsRetryPostCall(Integer id, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call certificatesIdActionsRetryPostValidateBeforeCall(Integer id, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new ApiException("Missing the required parameter 'id' when calling certificatesIdActionsRetryPost(Async)");
        }

        return certificatesIdActionsRetryPostCall(id, _callback);
     ...
     */
    public ActionResponse certificatesIdActionsRetryPost(Integer id) throws ApiException {
        ApiResponse<ActionResponse> localVarResp = certificatesIdActionsRetryPostWithHttpInfo(id);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<ActionResponse> certificatesIdActionsRetryPostWithHttpInfo(Integer id) throws ApiException {
        okhttp3.Call localVarCall = certificatesIdActionsRetryPostValidateBeforeCall(id, null);
        Type localVarReturnType = new TypeToken<ActionResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Retry Issuance or Renewal (asynchronously)
     * Retry a failed Certificate issuance or renewal.  Only applicable if the type of the Certificate is &#x60;managed&#x60; and the issuance or renewal status is &#x60;failed&#x60;.  #### Call specific error codes  | Code                                                    | Description                                                               | |---------------------------------------------------------|---------------------------------------------------------------------------| | &#x60;caa_record_does_not_allow_ca&#x60;                          | CAA record does not allow certificate authority                           | | &#x60;ca_dns_validation_failed&#x60;                              | Certificate Authority: DNS validation failed                              | | &#x60;ca_too_many_authorizations_failed_recently&#x60;            | Certificate Authority: Too many authorizations failed recently            | | &#x60;ca_too_many_certificates_issued_for_registered_domain&#x60; | Certificate Authority: Too many certificates issued for registered domain | | &#x60;ca_too_many_duplicate_certificates&#x60;                    | Certificate Authority: Too many duplicate certificates                    | | &#x60;could_not_verify_domain_delegated_to_zone&#x60;             | Could not verify domain delegated to zone                                 | | &#x60;dns_zone_not_found&#x60;                                    | DNS zone not found                                                        | | &#x60;dns_zone_is_secondary_zone&#x60;                            | DNS zone is a secondary zone                                              | 
     * @param id ID of the Certificate (required)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
     ...
     */
    public okhttp3.Call certificatesIdActionsRetryPostAsync(Integer id, final ApiCallback<ActionResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = certificatesIdActionsRetryPostValidateBeforeCall(id, _callback);
        Type localVarReturnType = new TypeToken<ActionResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
