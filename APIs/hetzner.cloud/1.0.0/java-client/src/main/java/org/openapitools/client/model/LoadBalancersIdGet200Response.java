...
public class LoadBalancersIdGet200Response {
  ...
  public LoadBalancersIdGet200Response() {
  }

  public LoadBalancersIdGet200Response loadBalancer(LoadBalancersGet200ResponseLoadBalancersInner loadBalancer) {
  ...
  public boolean equals(Object o) {
    ...
    LoadBalancersIdGet200Response loadBalancersIdGet200Response = (LoadBalancersIdGet200Response) o;
    return Objects.equals(this.loadBalancer, loadBalancersIdGet200Response.loadBalancer);
  }
  ...
  public String toString() {
    ...
    sb.append("class LoadBalancersIdGet200Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to LoadBalancersIdGet200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LoadBalancersIdGet200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LoadBalancersIdGet200Response is not found in the empty JSON string", LoadBalancersIdGet200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LoadBalancersIdGet200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LoadBalancersIdGet200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LoadBalancersIdGet200Response.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LoadBalancersIdGet200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LoadBalancersIdGet200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LoadBalancersIdGet200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LoadBalancersIdGet200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<LoadBalancersIdGet200Response>() {
           @Override
           public void write(JsonWriter out, LoadBalancersIdGet200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LoadBalancersIdGet200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LoadBalancersIdGet200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LoadBalancersIdGet200Response
   * @throws IOException if the JSON string is invalid with respect to LoadBalancersIdGet200Response
   */
  public static LoadBalancersIdGet200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LoadBalancersIdGet200Response.class);
  }

  /**
   * Convert an instance of LoadBalancersIdGet200Response to an JSON string
   *
   * @return JSON string
   */
