...
public class SshKeysIdPutRequest {
  ...
  public SshKeysIdPutRequest() {
  }

  public SshKeysIdPutRequest labels(Object labels) {
    this.labels = labels;
    return this;
  }
  ...
  public SshKeysIdPutRequest name(String name) {
    this.name = name;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    SshKeysIdPutRequest sshKeysIdPutRequest = (SshKeysIdPutRequest) o;
    return Objects.equals(this.labels, sshKeysIdPutRequest.labels) &&
        Objects.equals(this.name, sshKeysIdPutRequest.name);
  }
  ...
  public String toString() {
    ...
    sb.append("class SshKeysIdPutRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to SshKeysIdPutRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SshKeysIdPutRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SshKeysIdPutRequest is not found in the empty JSON string", SshKeysIdPutRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SshKeysIdPutRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SshKeysIdPutRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SshKeysIdPutRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SshKeysIdPutRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SshKeysIdPutRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SshKeysIdPutRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<SshKeysIdPutRequest>() {
           @Override
           public void write(JsonWriter out, SshKeysIdPutRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SshKeysIdPutRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SshKeysIdPutRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SshKeysIdPutRequest
   * @throws IOException if the JSON string is invalid with respect to SshKeysIdPutRequest
   */
  public static SshKeysIdPutRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SshKeysIdPutRequest.class);
  }

  /**
   * Convert an instance of SshKeysIdPutRequest to an JSON string
   *
   * @return JSON string
   */
