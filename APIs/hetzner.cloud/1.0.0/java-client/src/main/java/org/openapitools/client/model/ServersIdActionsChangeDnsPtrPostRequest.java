...
public class ServersIdActionsChangeDnsPtrPostRequest {
  ...
  public ServersIdActionsChangeDnsPtrPostRequest() {
  }

  public ServersIdActionsChangeDnsPtrPostRequest dnsPtr(String dnsPtr) {
    this.dnsPtr = dnsPtr;
    return this;
  }
  ...
  public ServersIdActionsChangeDnsPtrPostRequest ip(String ip) {
    this.ip = ip;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    ServersIdActionsChangeDnsPtrPostRequest serversIdActionsChangeDnsPtrPostRequest = (ServersIdActionsChangeDnsPtrPostRequest) o;
    return Objects.equals(this.dnsPtr, serversIdActionsChangeDnsPtrPostRequest.dnsPtr) &&
        Objects.equals(this.ip, serversIdActionsChangeDnsPtrPostRequest.ip);
  }
  ...
  public String toString() {
    ...
    sb.append("class ServersIdActionsChangeDnsPtrPostRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ServersIdActionsChangeDnsPtrPostRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ServersIdActionsChangeDnsPtrPostRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ServersIdActionsChangeDnsPtrPostRequest is not found in the empty JSON string", ServersIdActionsChangeDnsPtrPostRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ServersIdActionsChangeDnsPtrPostRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ServersIdActionsChangeDnsPtrPostRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ServersIdActionsChangeDnsPtrPostRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ServersIdActionsChangeDnsPtrPostRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ServersIdActionsChangeDnsPtrPostRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ServersIdActionsChangeDnsPtrPostRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ServersIdActionsChangeDnsPtrPostRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<ServersIdActionsChangeDnsPtrPostRequest>() {
           @Override
           public void write(JsonWriter out, ServersIdActionsChangeDnsPtrPostRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ServersIdActionsChangeDnsPtrPostRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ServersIdActionsChangeDnsPtrPostRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ServersIdActionsChangeDnsPtrPostRequest
   * @throws IOException if the JSON string is invalid with respect to ServersIdActionsChangeDnsPtrPostRequest
   */
  public static ServersIdActionsChangeDnsPtrPostRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ServersIdActionsChangeDnsPtrPostRequest.class);
  }

  /**
   * Convert an instance of ServersIdActionsChangeDnsPtrPostRequest to an JSON string
   *
   * @return JSON string
   */
