...
import org.openapitools.client.model.LocationsIdGet200Response;
...
public class LocationsApi {
     ...
     * @param name Can be used to filter Locations by their name. The response will only contain the Location matching the specified name. (optional)
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        ...
        <tr><td> 200 </td><td> The &#x60;locations&#x60; key in the reply contains an array of Location objects with this structure </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call locationsGetCall(String name, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call locationsGetValidateBeforeCall(String name, final ApiCallback _callback) throws ApiException {
        return locationsGetCall(name, _callback);
     ...
     */
    public LocationsGet200Response locationsGet(String name) throws ApiException {
        ApiResponse<LocationsGet200Response> localVarResp = locationsGetWithHttpInfo(name);
     ...
     */
    public ApiResponse<LocationsGet200Response> locationsGetWithHttpInfo(String name) throws ApiException {
        okhttp3.Call localVarCall = locationsGetValidateBeforeCall(name, null);
     ...
     */
    public okhttp3.Call locationsGetAsync(String name, final ApiCallback<LocationsGet200Response> _callback) throws ApiException {

        okhttp3.Call localVarCall = locationsGetValidateBeforeCall(name, _callback);
        Type localVarReturnType = new TypeToken<LocationsGet200Response>(){}.getType();
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> The &#x60;location&#x60; key in the reply contains a Location object with this structure </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call locationsIdGetCall(Integer id, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call locationsIdGetValidateBeforeCall(Integer id, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new ApiException("Missing the required parameter 'id' when calling locationsIdGet(Async)");
        }

        return locationsIdGetCall(id, _callback);
     ...
     * @param id ID of Location (required)
     * @return LocationsIdGet200Response
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public LocationsIdGet200Response locationsIdGet(Integer id) throws ApiException {
        ApiResponse<LocationsIdGet200Response> localVarResp = locationsIdGetWithHttpInfo(id);
        return localVarResp.getData();
    }
     ...
     * Returns a specific Location object.
     * @param id ID of Location (required)
     * @return ApiResponse&lt;LocationsIdGet200Response&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<LocationsIdGet200Response> locationsIdGetWithHttpInfo(Integer id) throws ApiException {
        okhttp3.Call localVarCall = locationsIdGetValidateBeforeCall(id, null);
        Type localVarReturnType = new TypeToken<LocationsIdGet200Response>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Get a Location (asynchronously)
     * Returns a specific Location object.
     * @param id ID of Location (required)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
     ...
     */
    public okhttp3.Call locationsIdGetAsync(Integer id, final ApiCallback<LocationsIdGet200Response> _callback) throws ApiException {

        okhttp3.Call localVarCall = locationsIdGetValidateBeforeCall(id, _callback);
        Type localVarReturnType = new TypeToken<LocationsIdGet200Response>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
