...
public class ServersIdActionsRebuildPost201Response {
  ...
  public ServersIdActionsRebuildPost201Response() {
  }

  public ServersIdActionsRebuildPost201Response action(Action action) {
    this.action = action;
    return this;
  }
  ...
  public ServersIdActionsRebuildPost201Response rootPassword(String rootPassword) {
  ...
  public boolean equals(Object o) {
    ...
    ServersIdActionsRebuildPost201Response serversIdActionsRebuildPost201Response = (ServersIdActionsRebuildPost201Response) o;
    return Objects.equals(this.action, serversIdActionsRebuildPost201Response.action) &&
        Objects.equals(this.rootPassword, serversIdActionsRebuildPost201Response.rootPassword);
  }
  ...
  public String toString() {
    ...
    sb.append("class ServersIdActionsRebuildPost201Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ServersIdActionsRebuildPost201Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ServersIdActionsRebuildPost201Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ServersIdActionsRebuildPost201Response is not found in the empty JSON string", ServersIdActionsRebuildPost201Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ServersIdActionsRebuildPost201Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ServersIdActionsRebuildPost201Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ServersIdActionsRebuildPost201Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ServersIdActionsRebuildPost201Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ServersIdActionsRebuildPost201Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ServersIdActionsRebuildPost201Response.class));

       return (TypeAdapter<T>) new TypeAdapter<ServersIdActionsRebuildPost201Response>() {
           @Override
           public void write(JsonWriter out, ServersIdActionsRebuildPost201Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ServersIdActionsRebuildPost201Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ServersIdActionsRebuildPost201Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ServersIdActionsRebuildPost201Response
   * @throws IOException if the JSON string is invalid with respect to ServersIdActionsRebuildPost201Response
   */
  public static ServersIdActionsRebuildPost201Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ServersIdActionsRebuildPost201Response.class);
  }

  /**
   * Convert an instance of ServersIdActionsRebuildPost201Response to an JSON string
   *
   * @return JSON string
   */
