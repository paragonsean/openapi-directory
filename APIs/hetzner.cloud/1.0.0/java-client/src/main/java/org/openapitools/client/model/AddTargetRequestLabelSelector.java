...
public class AddTargetRequestLabelSelector {
  public static final String SERIALIZED_NAME_SELECTOR = "selector";
  @SerializedName(SERIALIZED_NAME_SELECTOR)
  private String selector;

  public AddTargetRequestLabelSelector() {
  }

  public AddTargetRequestLabelSelector selector(String selector) {
  ...
  public boolean equals(Object o) {
    ...
    AddTargetRequestLabelSelector addTargetRequestLabelSelector = (AddTargetRequestLabelSelector) o;
    return Objects.equals(this.selector, addTargetRequestLabelSelector.selector);
  }
  ...
  public String toString() {
    ...
    sb.append("class AddTargetRequestLabelSelector {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AddTargetRequestLabelSelector
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AddTargetRequestLabelSelector.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AddTargetRequestLabelSelector is not found in the empty JSON string", AddTargetRequestLabelSelector.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AddTargetRequestLabelSelector.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AddTargetRequestLabelSelector` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AddTargetRequestLabelSelector.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AddTargetRequestLabelSelector.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AddTargetRequestLabelSelector' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AddTargetRequestLabelSelector> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AddTargetRequestLabelSelector.class));

       return (TypeAdapter<T>) new TypeAdapter<AddTargetRequestLabelSelector>() {
           @Override
           public void write(JsonWriter out, AddTargetRequestLabelSelector value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AddTargetRequestLabelSelector read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AddTargetRequestLabelSelector given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AddTargetRequestLabelSelector
   * @throws IOException if the JSON string is invalid with respect to AddTargetRequestLabelSelector
   */
  public static AddTargetRequestLabelSelector fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AddTargetRequestLabelSelector.class);
  }

  /**
   * Convert an instance of AddTargetRequestLabelSelector to an JSON string
   *
   * @return JSON string
   */
