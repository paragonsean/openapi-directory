...
public class PlacementGroupsResponse {
  ...
  public PlacementGroupsResponse meta(ActionsResponseMeta meta) {
    this.meta = meta;
    return this;
  }
  ...
  public PlacementGroupsResponse placementGroups(List<PlacementGroup> placementGroups) {
    this.placementGroups = placementGroups;
    return this;
  }

  public PlacementGroupsResponse addPlacementGroupsItem(PlacementGroup placementGroupsItem) {
  ...
  public boolean equals(Object o) {
    ...
    PlacementGroupsResponse placementGroupsResponse = (PlacementGroupsResponse) o;
    return Objects.equals(this.meta, placementGroupsResponse.meta) &&
        Objects.equals(this.placementGroups, placementGroupsResponse.placementGroups);
  }

  @Override
  public int hashCode() {
    return Objects.hash(meta, placementGroups);
  }
  ...
  static {
    ...
    openapiFields.add("placement_groups");

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>();
    openapiRequiredFields.add("placement_groups");
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to PlacementGroupsResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PlacementGroupsResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PlacementGroupsResponse is not found in the empty JSON string", PlacementGroupsResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PlacementGroupsResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PlacementGroupsResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PlacementGroupsResponse.openapiRequiredFields) {
      ...
      if (!jsonObj.get("placement_groups").isJsonArray()) {
        throw new IllegalArgumentException(String.format("Expected the field `placement_groups` to be an array in the JSON string but got `%s`", jsonObj.get("placement_groups").toString()));
      }

      JsonArray jsonArrayplacementGroups = jsonObj.getAsJsonArray("placement_groups");
      // validate the required field `placement_groups` (array)
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PlacementGroupsResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PlacementGroupsResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PlacementGroupsResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PlacementGroupsResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<PlacementGroupsResponse>() {
           @Override
           public void write(JsonWriter out, PlacementGroupsResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PlacementGroupsResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PlacementGroupsResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PlacementGroupsResponse
   * @throws IOException if the JSON string is invalid with respect to PlacementGroupsResponse
   */
  public static PlacementGroupsResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PlacementGroupsResponse.class);
  }

  /**
   * Convert an instance of PlacementGroupsResponse to an JSON string
   *
   * @return JSON string
   */
