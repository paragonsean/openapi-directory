...
public class FirewallResponse {
  ...
  public FirewallResponse firewall(Firewall firewall) {
  ...
  public boolean equals(Object o) {
    ...
    FirewallResponse firewallResponse = (FirewallResponse) o;
    return Objects.equals(this.firewall, firewallResponse.firewall);
  }
  ...
  static {
    ...
    openapiRequiredFields.add("firewall");
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to FirewallResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!FirewallResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FirewallResponse is not found in the empty JSON string", FirewallResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!FirewallResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `FirewallResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : FirewallResponse.openapiRequiredFields) {
        if (jsonElement.getAsJsonObject().get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the required field `firewall`
      Firewall.validateJsonElement(jsonObj.get("firewall"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FirewallResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FirewallResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FirewallResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FirewallResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<FirewallResponse>() {
           @Override
           public void write(JsonWriter out, FirewallResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public FirewallResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of FirewallResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of FirewallResponse
   * @throws IOException if the JSON string is invalid with respect to FirewallResponse
   */
  public static FirewallResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FirewallResponse.class);
  }

  /**
   * Convert an instance of FirewallResponse to an JSON string
   *
   * @return JSON string
   */
