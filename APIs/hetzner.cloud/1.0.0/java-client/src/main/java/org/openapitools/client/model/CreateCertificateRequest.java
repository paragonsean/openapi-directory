...
public class CreateCertificateRequest {
  ...
  public CreateCertificateRequest domainNames(List<String> domainNames) {
    this.domainNames = domainNames;
    return this;
  }

  public CreateCertificateRequest addDomainNamesItem(String domainNamesItem) {
  ...
  public CreateCertificateRequest labels(Object labels) {
    this.labels = labels;
    return this;
  }
  ...
  public CreateCertificateRequest type(TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.certificate, createCertificateRequest.certificate) &&
        Objects.equals(this.domainNames, createCertificateRequest.domainNames) &&
        Objects.equals(this.labels, createCertificateRequest.labels) &&
        Objects.equals(this.name, createCertificateRequest.name) &&
        Objects.equals(this.privateKey, createCertificateRequest.privateKey) &&
        Objects.equals(this.type, createCertificateRequest.type);
  }

  @Override
  public int hashCode() {
    return Objects.hash(certificate, domainNames, labels, name, privateKey, type);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateCertificateRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateCertificateRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateCertificateRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateCertificateRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("domain_names") != null && !jsonObj.get("domain_names").isJsonNull() && !jsonObj.get("domain_names").isJsonArray()) {
