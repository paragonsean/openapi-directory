...
public class FirewallApplyToResourcesServer {
  public static final String SERIALIZED_NAME_ID = "id";
  @SerializedName(SERIALIZED_NAME_ID)
  private Integer id;

  public FirewallApplyToResourcesServer() {
  }

  public FirewallApplyToResourcesServer id(Integer id) {
    this.id = id;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    FirewallApplyToResourcesServer firewallApplyToResourcesServer = (FirewallApplyToResourcesServer) o;
    return Objects.equals(this.id, firewallApplyToResourcesServer.id);
  }
  ...
  public String toString() {
    ...
    sb.append("class FirewallApplyToResourcesServer {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to FirewallApplyToResourcesServer
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!FirewallApplyToResourcesServer.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FirewallApplyToResourcesServer is not found in the empty JSON string", FirewallApplyToResourcesServer.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!FirewallApplyToResourcesServer.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `FirewallApplyToResourcesServer` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : FirewallApplyToResourcesServer.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FirewallApplyToResourcesServer.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FirewallApplyToResourcesServer' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FirewallApplyToResourcesServer> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FirewallApplyToResourcesServer.class));

       return (TypeAdapter<T>) new TypeAdapter<FirewallApplyToResourcesServer>() {
           @Override
           public void write(JsonWriter out, FirewallApplyToResourcesServer value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public FirewallApplyToResourcesServer read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of FirewallApplyToResourcesServer given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of FirewallApplyToResourcesServer
   * @throws IOException if the JSON string is invalid with respect to FirewallApplyToResourcesServer
   */
  public static FirewallApplyToResourcesServer fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FirewallApplyToResourcesServer.class);
  }

  /**
   * Convert an instance of FirewallApplyToResourcesServer to an JSON string
   *
   * @return JSON string
   */
