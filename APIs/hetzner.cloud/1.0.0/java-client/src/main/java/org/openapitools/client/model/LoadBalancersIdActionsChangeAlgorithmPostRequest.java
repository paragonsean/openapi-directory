...
public class LoadBalancersIdActionsChangeAlgorithmPostRequest {
  /**
  ...
  public LoadBalancersIdActionsChangeAlgorithmPostRequest() {
  }

  public LoadBalancersIdActionsChangeAlgorithmPostRequest type(TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    LoadBalancersIdActionsChangeAlgorithmPostRequest loadBalancersIdActionsChangeAlgorithmPostRequest = (LoadBalancersIdActionsChangeAlgorithmPostRequest) o;
    return Objects.equals(this.type, loadBalancersIdActionsChangeAlgorithmPostRequest.type);
  }
  ...
  public String toString() {
    ...
    sb.append("class LoadBalancersIdActionsChangeAlgorithmPostRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to LoadBalancersIdActionsChangeAlgorithmPostRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LoadBalancersIdActionsChangeAlgorithmPostRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LoadBalancersIdActionsChangeAlgorithmPostRequest is not found in the empty JSON string", LoadBalancersIdActionsChangeAlgorithmPostRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LoadBalancersIdActionsChangeAlgorithmPostRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LoadBalancersIdActionsChangeAlgorithmPostRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LoadBalancersIdActionsChangeAlgorithmPostRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LoadBalancersIdActionsChangeAlgorithmPostRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LoadBalancersIdActionsChangeAlgorithmPostRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LoadBalancersIdActionsChangeAlgorithmPostRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LoadBalancersIdActionsChangeAlgorithmPostRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<LoadBalancersIdActionsChangeAlgorithmPostRequest>() {
           @Override
           public void write(JsonWriter out, LoadBalancersIdActionsChangeAlgorithmPostRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LoadBalancersIdActionsChangeAlgorithmPostRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LoadBalancersIdActionsChangeAlgorithmPostRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LoadBalancersIdActionsChangeAlgorithmPostRequest
   * @throws IOException if the JSON string is invalid with respect to LoadBalancersIdActionsChangeAlgorithmPostRequest
   */
  public static LoadBalancersIdActionsChangeAlgorithmPostRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LoadBalancersIdActionsChangeAlgorithmPostRequest.class);
  }

  /**
   * Convert an instance of LoadBalancersIdActionsChangeAlgorithmPostRequest to an JSON string
   *
   * @return JSON string
   */
