...
public class AddTargetRequestServer {
  public static final String SERIALIZED_NAME_ID = "id";
  @SerializedName(SERIALIZED_NAME_ID)
  private BigDecimal id;

  public AddTargetRequestServer() {
  }

  public AddTargetRequestServer id(BigDecimal id) {
    this.id = id;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    AddTargetRequestServer addTargetRequestServer = (AddTargetRequestServer) o;
    return Objects.equals(this.id, addTargetRequestServer.id);
  }
  ...
  public String toString() {
    ...
    sb.append("class AddTargetRequestServer {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AddTargetRequestServer
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AddTargetRequestServer.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AddTargetRequestServer is not found in the empty JSON string", AddTargetRequestServer.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AddTargetRequestServer.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AddTargetRequestServer` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AddTargetRequestServer.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AddTargetRequestServer.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AddTargetRequestServer' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AddTargetRequestServer> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AddTargetRequestServer.class));

       return (TypeAdapter<T>) new TypeAdapter<AddTargetRequestServer>() {
           @Override
           public void write(JsonWriter out, AddTargetRequestServer value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AddTargetRequestServer read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AddTargetRequestServer given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AddTargetRequestServer
   * @throws IOException if the JSON string is invalid with respect to AddTargetRequestServer
   */
  public static AddTargetRequestServer fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AddTargetRequestServer.class);
  }

  /**
   * Convert an instance of AddTargetRequestServer to an JSON string
   *
   * @return JSON string
   */
