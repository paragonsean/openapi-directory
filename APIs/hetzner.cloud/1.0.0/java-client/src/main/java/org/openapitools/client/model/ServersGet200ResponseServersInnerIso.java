...
public class ServersGet200ResponseServersInnerIso {
  /**
  ...
  public ServersGet200ResponseServersInnerIso() {
  }

  public ServersGet200ResponseServersInnerIso architecture(ArchitectureEnum architecture) {
  ...
  public ServersGet200ResponseServersInnerIso deprecated(String deprecated) {
  ...
  public ServersGet200ResponseServersInnerIso description(String description) {
  ...
  public ServersGet200ResponseServersInnerIso id(Integer id) {
    this.id = id;
    return this;
  }
  ...
  public ServersGet200ResponseServersInnerIso name(String name) {
    this.name = name;
    return this;
  }
  ...
  public ServersGet200ResponseServersInnerIso type(TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    ServersGet200ResponseServersInnerIso serversGet200ResponseServersInnerIso = (ServersGet200ResponseServersInnerIso) o;
    return Objects.equals(this.architecture, serversGet200ResponseServersInnerIso.architecture) &&
        Objects.equals(this.deprecated, serversGet200ResponseServersInnerIso.deprecated) &&
        Objects.equals(this.description, serversGet200ResponseServersInnerIso.description) &&
        Objects.equals(this.id, serversGet200ResponseServersInnerIso.id) &&
        Objects.equals(this.name, serversGet200ResponseServersInnerIso.name) &&
        Objects.equals(this.type, serversGet200ResponseServersInnerIso.type);
  }
  ...
  public String toString() {
    ...
    sb.append("class ServersGet200ResponseServersInnerIso {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ServersGet200ResponseServersInnerIso
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ServersGet200ResponseServersInnerIso.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ServersGet200ResponseServersInnerIso is not found in the empty JSON string", ServersGet200ResponseServersInnerIso.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ServersGet200ResponseServersInnerIso.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ServersGet200ResponseServersInnerIso` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ServersGet200ResponseServersInnerIso.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ServersGet200ResponseServersInnerIso.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ServersGet200ResponseServersInnerIso' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ServersGet200ResponseServersInnerIso> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ServersGet200ResponseServersInnerIso.class));

       return (TypeAdapter<T>) new TypeAdapter<ServersGet200ResponseServersInnerIso>() {
           @Override
           public void write(JsonWriter out, ServersGet200ResponseServersInnerIso value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ServersGet200ResponseServersInnerIso read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ServersGet200ResponseServersInnerIso given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ServersGet200ResponseServersInnerIso
   * @throws IOException if the JSON string is invalid with respect to ServersGet200ResponseServersInnerIso
   */
  public static ServersGet200ResponseServersInnerIso fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ServersGet200ResponseServersInnerIso.class);
  }

  /**
   * Convert an instance of ServersGet200ResponseServersInnerIso to an JSON string
   *
   * @return JSON string
   */
