...
public class UpdateFloatingIPRequest {
  ...
  public UpdateFloatingIPRequest() {
  }

  public UpdateFloatingIPRequest description(String description) {
  ...
  public UpdateFloatingIPRequest labels(Object labels) {
    this.labels = labels;
    return this;
  }
  ...
  public UpdateFloatingIPRequest name(String name) {
    this.name = name;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    UpdateFloatingIPRequest updateFloatingIPRequest = (UpdateFloatingIPRequest) o;
    return Objects.equals(this.description, updateFloatingIPRequest.description) &&
        Objects.equals(this.labels, updateFloatingIPRequest.labels) &&
        Objects.equals(this.name, updateFloatingIPRequest.name);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdateFloatingIPRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateFloatingIPRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateFloatingIPRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateFloatingIPRequest is not found in the empty JSON string", UpdateFloatingIPRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateFloatingIPRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateFloatingIPRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateFloatingIPRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateFloatingIPRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateFloatingIPRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateFloatingIPRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateFloatingIPRequest>() {
           @Override
           public void write(JsonWriter out, UpdateFloatingIPRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateFloatingIPRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateFloatingIPRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateFloatingIPRequest
   * @throws IOException if the JSON string is invalid with respect to UpdateFloatingIPRequest
   */
  public static UpdateFloatingIPRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateFloatingIPRequest.class);
  }

  /**
   * Convert an instance of UpdateFloatingIPRequest to an JSON string
   *
   * @return JSON string
   */
