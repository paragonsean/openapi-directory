...
public class RebuildServerRequest {
  ...
  public RebuildServerRequest image(String image) {
    this.image = image;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    RebuildServerRequest rebuildServerRequest = (RebuildServerRequest) o;
    return Objects.equals(this.image, rebuildServerRequest.image);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to RebuildServerRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RebuildServerRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in RebuildServerRequest is not found in the empty JSON string", RebuildServerRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RebuildServerRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `RebuildServerRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : RebuildServerRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RebuildServerRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RebuildServerRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RebuildServerRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RebuildServerRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<RebuildServerRequest>() {
           @Override
           public void write(JsonWriter out, RebuildServerRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public RebuildServerRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of RebuildServerRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of RebuildServerRequest
   * @throws IOException if the JSON string is invalid with respect to RebuildServerRequest
   */
  public static RebuildServerRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RebuildServerRequest.class);
  }

  /**
   * Convert an instance of RebuildServerRequest to an JSON string
   *
   * @return JSON string
   */
