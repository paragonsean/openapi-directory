...
public class ActionsApi {
    ...
    /**
     * Build call for actionsGet
     * @param id Can be used multiple times, the response will contain only Actions with specified IDs (optional)
     ...
     */
    public okhttp3.Call actionsGetCall(Integer id, String sort, String status, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call actionsGetValidateBeforeCall(Integer id, String sort, String status, final ApiCallback _callback) throws ApiException {
        return actionsGetCall(id, sort, status, _callback);
     ...
     */
    public ActionsResponse actionsGet(Integer id, String sort, String status) throws ApiException {
        ApiResponse<ActionsResponse> localVarResp = actionsGetWithHttpInfo(id, sort, status);
     ...
     */
    public ApiResponse<ActionsResponse> actionsGetWithHttpInfo(Integer id, String sort, String status) throws ApiException {
        okhttp3.Call localVarCall = actionsGetValidateBeforeCall(id, sort, status, null);
     ...
     */
    public okhttp3.Call actionsGetAsync(Integer id, String sort, String status, final ApiCallback<ActionsResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = actionsGetValidateBeforeCall(id, sort, status, _callback);
        Type localVarReturnType = new TypeToken<ActionsResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for actionsIdGet
     ...
     */
    public okhttp3.Call actionsIdGetCall(Integer id, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call actionsIdGetValidateBeforeCall(Integer id, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new ApiException("Missing the required parameter 'id' when calling actionsIdGet(Async)");
        }

        return actionsIdGetCall(id, _callback);
     ...
     */
    public ActionResponse actionsIdGet(Integer id) throws ApiException {
        ApiResponse<ActionResponse> localVarResp = actionsIdGetWithHttpInfo(id);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<ActionResponse> actionsIdGetWithHttpInfo(Integer id) throws ApiException {
        okhttp3.Call localVarCall = actionsIdGetValidateBeforeCall(id, null);
     ...
     */
    public okhttp3.Call actionsIdGetAsync(Integer id, final ApiCallback<ActionResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = actionsIdGetValidateBeforeCall(id, _callback);
        Type localVarReturnType = new TypeToken<ActionResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
