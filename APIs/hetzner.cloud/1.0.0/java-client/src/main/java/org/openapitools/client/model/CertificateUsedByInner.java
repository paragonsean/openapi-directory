...
public class CertificateUsedByInner {
  ...
  public CertificateUsedByInner() {
  }

  public CertificateUsedByInner id(Integer id) {
    this.id = id;
    return this;
  }
  ...
  public CertificateUsedByInner type(String type) {
    this.type = type;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    CertificateUsedByInner certificateUsedByInner = (CertificateUsedByInner) o;
    return Objects.equals(this.id, certificateUsedByInner.id) &&
        Objects.equals(this.type, certificateUsedByInner.type);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to CertificateUsedByInner
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CertificateUsedByInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CertificateUsedByInner is not found in the empty JSON string", CertificateUsedByInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CertificateUsedByInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CertificateUsedByInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CertificateUsedByInner.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CertificateUsedByInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CertificateUsedByInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CertificateUsedByInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CertificateUsedByInner.class));

       return (TypeAdapter<T>) new TypeAdapter<CertificateUsedByInner>() {
           @Override
           public void write(JsonWriter out, CertificateUsedByInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CertificateUsedByInner read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CertificateUsedByInner given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CertificateUsedByInner
   * @throws IOException if the JSON string is invalid with respect to CertificateUsedByInner
   */
  public static CertificateUsedByInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CertificateUsedByInner.class);
  }

  /**
   * Convert an instance of CertificateUsedByInner to an JSON string
   *
   * @return JSON string
   */
