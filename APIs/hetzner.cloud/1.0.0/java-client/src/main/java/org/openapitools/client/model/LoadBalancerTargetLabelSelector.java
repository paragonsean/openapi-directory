...
public class LoadBalancerTargetLabelSelector {
  public static final String SERIALIZED_NAME_SELECTOR = "selector";
  @SerializedName(SERIALIZED_NAME_SELECTOR)
  private String selector;

  public LoadBalancerTargetLabelSelector() {
  }

  public LoadBalancerTargetLabelSelector selector(String selector) {
  ...
  public boolean equals(Object o) {
    ...
    LoadBalancerTargetLabelSelector loadBalancerTargetLabelSelector = (LoadBalancerTargetLabelSelector) o;
    return Objects.equals(this.selector, loadBalancerTargetLabelSelector.selector);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to LoadBalancerTargetLabelSelector
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LoadBalancerTargetLabelSelector.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LoadBalancerTargetLabelSelector is not found in the empty JSON string", LoadBalancerTargetLabelSelector.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LoadBalancerTargetLabelSelector.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LoadBalancerTargetLabelSelector` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LoadBalancerTargetLabelSelector.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LoadBalancerTargetLabelSelector.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LoadBalancerTargetLabelSelector' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LoadBalancerTargetLabelSelector> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LoadBalancerTargetLabelSelector.class));

       return (TypeAdapter<T>) new TypeAdapter<LoadBalancerTargetLabelSelector>() {
           @Override
           public void write(JsonWriter out, LoadBalancerTargetLabelSelector value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LoadBalancerTargetLabelSelector read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LoadBalancerTargetLabelSelector given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LoadBalancerTargetLabelSelector
   * @throws IOException if the JSON string is invalid with respect to LoadBalancerTargetLabelSelector
   */
  public static LoadBalancerTargetLabelSelector fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LoadBalancerTargetLabelSelector.class);
  }

  /**
   * Convert an instance of LoadBalancerTargetLabelSelector to an JSON string
   *
   * @return JSON string
   */
