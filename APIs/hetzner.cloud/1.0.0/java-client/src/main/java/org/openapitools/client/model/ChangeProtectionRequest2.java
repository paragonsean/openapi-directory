...
public class ChangeProtectionRequest2 {
  public static final String SERIALIZED_NAME_DELETE = "delete";
  @SerializedName(SERIALIZED_NAME_DELETE)
  private Boolean delete;

  public ChangeProtectionRequest2() {
  }

  public ChangeProtectionRequest2 delete(Boolean delete) {
    this.delete = delete;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    ChangeProtectionRequest2 changeProtectionRequest2 = (ChangeProtectionRequest2) o;
    return Objects.equals(this.delete, changeProtectionRequest2.delete);
  }
  ...
  public String toString() {
    ...
    sb.append("class ChangeProtectionRequest2 {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ChangeProtectionRequest2
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ChangeProtectionRequest2.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ChangeProtectionRequest2 is not found in the empty JSON string", ChangeProtectionRequest2.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ChangeProtectionRequest2.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ChangeProtectionRequest2` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ChangeProtectionRequest2.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ChangeProtectionRequest2' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ChangeProtectionRequest2> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ChangeProtectionRequest2.class));

       return (TypeAdapter<T>) new TypeAdapter<ChangeProtectionRequest2>() {
           @Override
           public void write(JsonWriter out, ChangeProtectionRequest2 value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ChangeProtectionRequest2 read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ChangeProtectionRequest2 given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ChangeProtectionRequest2
   * @throws IOException if the JSON string is invalid with respect to ChangeProtectionRequest2
   */
  public static ChangeProtectionRequest2 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ChangeProtectionRequest2.class);
  }

  /**
   * Convert an instance of ChangeProtectionRequest2 to an JSON string
   *
   * @return JSON string
   */
