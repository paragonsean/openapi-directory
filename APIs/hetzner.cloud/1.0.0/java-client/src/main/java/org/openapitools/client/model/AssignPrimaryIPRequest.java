...
public class AssignPrimaryIPRequest {
  ...
  public AssignPrimaryIPRequest() {
  }

  public AssignPrimaryIPRequest assigneeId(Integer assigneeId) {
  ...
  public AssignPrimaryIPRequest assigneeType(AssigneeTypeEnum assigneeType) {
  ...
  public boolean equals(Object o) {
    ...
    AssignPrimaryIPRequest assignPrimaryIPRequest = (AssignPrimaryIPRequest) o;
    return Objects.equals(this.assigneeId, assignPrimaryIPRequest.assigneeId) &&
        Objects.equals(this.assigneeType, assignPrimaryIPRequest.assigneeType);
  }

  @Override
  public int hashCode() {
    return Objects.hash(assigneeId, assigneeType);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AssignPrimaryIPRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AssignPrimaryIPRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AssignPrimaryIPRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AssignPrimaryIPRequest is not found in the empty JSON string", AssignPrimaryIPRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AssignPrimaryIPRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AssignPrimaryIPRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AssignPrimaryIPRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AssignPrimaryIPRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AssignPrimaryIPRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AssignPrimaryIPRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AssignPrimaryIPRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<AssignPrimaryIPRequest>() {
           @Override
           public void write(JsonWriter out, AssignPrimaryIPRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AssignPrimaryIPRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AssignPrimaryIPRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AssignPrimaryIPRequest
   * @throws IOException if the JSON string is invalid with respect to AssignPrimaryIPRequest
   */
  public static AssignPrimaryIPRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AssignPrimaryIPRequest.class);
  }

  /**
   * Convert an instance of AssignPrimaryIPRequest to an JSON string
   *
   * @return JSON string
   */
