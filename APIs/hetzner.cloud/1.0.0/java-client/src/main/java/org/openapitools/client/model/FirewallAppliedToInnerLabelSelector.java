...
public class FirewallAppliedToInnerLabelSelector {
  public static final String SERIALIZED_NAME_SELECTOR = "selector";
  @SerializedName(SERIALIZED_NAME_SELECTOR)
  private String selector;

  public FirewallAppliedToInnerLabelSelector() {
  }

  public FirewallAppliedToInnerLabelSelector selector(String selector) {
  ...
  public boolean equals(Object o) {
    ...
    FirewallAppliedToInnerLabelSelector firewallAppliedToInnerLabelSelector = (FirewallAppliedToInnerLabelSelector) o;
    return Objects.equals(this.selector, firewallAppliedToInnerLabelSelector.selector);
  }
  ...
  public String toString() {
    ...
    sb.append("class FirewallAppliedToInnerLabelSelector {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to FirewallAppliedToInnerLabelSelector
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!FirewallAppliedToInnerLabelSelector.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FirewallAppliedToInnerLabelSelector is not found in the empty JSON string", FirewallAppliedToInnerLabelSelector.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!FirewallAppliedToInnerLabelSelector.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `FirewallAppliedToInnerLabelSelector` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : FirewallAppliedToInnerLabelSelector.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FirewallAppliedToInnerLabelSelector.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FirewallAppliedToInnerLabelSelector' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FirewallAppliedToInnerLabelSelector> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FirewallAppliedToInnerLabelSelector.class));

       return (TypeAdapter<T>) new TypeAdapter<FirewallAppliedToInnerLabelSelector>() {
           @Override
           public void write(JsonWriter out, FirewallAppliedToInnerLabelSelector value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public FirewallAppliedToInnerLabelSelector read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of FirewallAppliedToInnerLabelSelector given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of FirewallAppliedToInnerLabelSelector
   * @throws IOException if the JSON string is invalid with respect to FirewallAppliedToInnerLabelSelector
   */
  public static FirewallAppliedToInnerLabelSelector fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FirewallAppliedToInnerLabelSelector.class);
  }

  /**
   * Convert an instance of FirewallAppliedToInnerLabelSelector to an JSON string
   *
   * @return JSON string
   */
