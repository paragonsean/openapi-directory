...
public class ActionsResponseMetaPagination {
  ...
  private BigDecimal previousPage;
  ...
  public ActionsResponseMetaPagination() {
  }

  public ActionsResponseMetaPagination lastPage(BigDecimal lastPage) {
  ...
  public ActionsResponseMetaPagination nextPage(BigDecimal nextPage) {
  ...
  public ActionsResponseMetaPagination page(BigDecimal page) {
    this.page = page;
    return this;
  }
  ...
  public ActionsResponseMetaPagination perPage(BigDecimal perPage) {
  ...
  public ActionsResponseMetaPagination previousPage(BigDecimal previousPage) {
   ...
   */
  @javax.annotation.Nullable
  public BigDecimal getPreviousPage() {
    return previousPage;
  }

  public void setPreviousPage(BigDecimal previousPage) {
    this.previousPage = previousPage;
  }


  public ActionsResponseMetaPagination totalEntries(BigDecimal totalEntries) {
  ...
  public boolean equals(Object o) {
    ...
    ActionsResponseMetaPagination actionsResponseMetaPagination = (ActionsResponseMetaPagination) o;
    return Objects.equals(this.lastPage, actionsResponseMetaPagination.lastPage) &&
        Objects.equals(this.nextPage, actionsResponseMetaPagination.nextPage) &&
        Objects.equals(this.page, actionsResponseMetaPagination.page) &&
        Objects.equals(this.perPage, actionsResponseMetaPagination.perPage) &&
        Objects.equals(this.previousPage, actionsResponseMetaPagination.previousPage) &&
        Objects.equals(this.totalEntries, actionsResponseMetaPagination.totalEntries);
  }

  @Override
  public int hashCode() {
    return Objects.hash(lastPage, nextPage, page, perPage, previousPage, totalEntries);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ActionsResponseMetaPagination {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ActionsResponseMetaPagination
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ActionsResponseMetaPagination.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionsResponseMetaPagination is not found in the empty JSON string", ActionsResponseMetaPagination.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ActionsResponseMetaPagination.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ActionsResponseMetaPagination` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionsResponseMetaPagination.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionsResponseMetaPagination.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionsResponseMetaPagination' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionsResponseMetaPagination> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionsResponseMetaPagination.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionsResponseMetaPagination>() {
           @Override
           public void write(JsonWriter out, ActionsResponseMetaPagination value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ActionsResponseMetaPagination read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ActionsResponseMetaPagination given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ActionsResponseMetaPagination
   * @throws IOException if the JSON string is invalid with respect to ActionsResponseMetaPagination
   */
  public static ActionsResponseMetaPagination fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionsResponseMetaPagination.class);
  }

  /**
   * Convert an instance of ActionsResponseMetaPagination to an JSON string
   *
   * @return JSON string
   */
