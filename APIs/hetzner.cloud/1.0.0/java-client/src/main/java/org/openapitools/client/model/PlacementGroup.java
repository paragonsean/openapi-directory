...
public class PlacementGroup {
  ...
  public PlacementGroup created(String created) {
  ...
  public PlacementGroup id(Integer id) {
    this.id = id;
    return this;
  }
  ...
  public PlacementGroup labels(Map<String, String> labels) {
    this.labels = labels;
    return this;
  }

  public PlacementGroup putLabelsItem(String key, String labelsItem) {
    if (this.labels == null) {
  ...
  public PlacementGroup servers(List<Integer> servers) {
    this.servers = servers;
    return this;
  }

  public PlacementGroup addServersItem(Integer serversItem) {
  ...
  public PlacementGroup type(TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.created, placementGroup.created) &&
        Objects.equals(this.id, placementGroup.id) &&
        Objects.equals(this.labels, placementGroup.labels) &&
        Objects.equals(this.name, placementGroup.name) &&
        Objects.equals(this.servers, placementGroup.servers) &&
        Objects.equals(this.type, placementGroup.type);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (String requiredField : PlacementGroup.openapiRequiredFields) {
