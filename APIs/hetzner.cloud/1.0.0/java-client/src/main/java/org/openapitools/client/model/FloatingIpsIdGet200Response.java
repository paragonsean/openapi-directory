...
public class FloatingIpsIdGet200Response {
  public static final String SERIALIZED_NAME_FLOATING_IP = "floating_ip";
  @SerializedName(SERIALIZED_NAME_FLOATING_IP)
  private FloatingIpsGet200ResponseFloatingIpsInner floatingIp;

  public FloatingIpsIdGet200Response() {
  }

  public FloatingIpsIdGet200Response floatingIp(FloatingIpsGet200ResponseFloatingIpsInner floatingIp) {
  ...
  public FloatingIpsGet200ResponseFloatingIpsInner getFloatingIp() {
    return floatingIp;
  }

  public void setFloatingIp(FloatingIpsGet200ResponseFloatingIpsInner floatingIp) {
    this.floatingIp = floatingIp;
  }
  ...
  public boolean equals(Object o) {
    ...
    FloatingIpsIdGet200Response floatingIpsIdGet200Response = (FloatingIpsIdGet200Response) o;
    return Objects.equals(this.floatingIp, floatingIpsIdGet200Response.floatingIp);
  }
  ...
  public String toString() {
    ...
    sb.append("class FloatingIpsIdGet200Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to FloatingIpsIdGet200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!FloatingIpsIdGet200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FloatingIpsIdGet200Response is not found in the empty JSON string", FloatingIpsIdGet200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!FloatingIpsIdGet200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `FloatingIpsIdGet200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : FloatingIpsIdGet200Response.openapiRequiredFields) {
      ...
      FloatingIpsGet200ResponseFloatingIpsInner.validateJsonElement(jsonObj.get("floating_ip"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FloatingIpsIdGet200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FloatingIpsIdGet200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FloatingIpsIdGet200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FloatingIpsIdGet200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<FloatingIpsIdGet200Response>() {
           @Override
           public void write(JsonWriter out, FloatingIpsIdGet200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public FloatingIpsIdGet200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of FloatingIpsIdGet200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of FloatingIpsIdGet200Response
   * @throws IOException if the JSON string is invalid with respect to FloatingIpsIdGet200Response
   */
  public static FloatingIpsIdGet200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FloatingIpsIdGet200Response.class);
  }

  /**
   * Convert an instance of FloatingIpsIdGet200Response to an JSON string
   *
   * @return JSON string
   */
