...
import org.openapitools.client.model.DatacentersGet200ResponseDatacentersInner;
...
public class DatacentersIdGet200Response {
  public static final String SERIALIZED_NAME_DATACENTER = "datacenter";
  @SerializedName(SERIALIZED_NAME_DATACENTER)
  private DatacentersGet200ResponseDatacentersInner datacenter;

  public DatacentersIdGet200Response() {
  }

  public DatacentersIdGet200Response datacenter(DatacentersGet200ResponseDatacentersInner datacenter) {
  ...
  public DatacentersGet200ResponseDatacentersInner getDatacenter() {
    return datacenter;
  }

  public void setDatacenter(DatacentersGet200ResponseDatacentersInner datacenter) {
    this.datacenter = datacenter;
  }
  ...
  public boolean equals(Object o) {
    ...
    DatacentersIdGet200Response datacentersIdGet200Response = (DatacentersIdGet200Response) o;
    return Objects.equals(this.datacenter, datacentersIdGet200Response.datacenter);
  }
  ...
  public String toString() {
    ...
    sb.append("class DatacentersIdGet200Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DatacentersIdGet200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DatacentersIdGet200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DatacentersIdGet200Response is not found in the empty JSON string", DatacentersIdGet200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DatacentersIdGet200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DatacentersIdGet200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DatacentersIdGet200Response.openapiRequiredFields) {
      ...
      DatacentersGet200ResponseDatacentersInner.validateJsonElement(jsonObj.get("datacenter"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DatacentersIdGet200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DatacentersIdGet200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DatacentersIdGet200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DatacentersIdGet200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<DatacentersIdGet200Response>() {
           @Override
           public void write(JsonWriter out, DatacentersIdGet200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DatacentersIdGet200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DatacentersIdGet200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DatacentersIdGet200Response
   * @throws IOException if the JSON string is invalid with respect to DatacentersIdGet200Response
   */
  public static DatacentersIdGet200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DatacentersIdGet200Response.class);
  }

  /**
   * Convert an instance of DatacentersIdGet200Response to an JSON string
   *
   * @return JSON string
   */
