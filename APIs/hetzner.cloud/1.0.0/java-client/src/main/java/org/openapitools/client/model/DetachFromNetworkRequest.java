...
public class DetachFromNetworkRequest {
  ...
  public DetachFromNetworkRequest() {
  }

  public DetachFromNetworkRequest network(Integer network) {
  ...
  public boolean equals(Object o) {
    ...
    DetachFromNetworkRequest detachFromNetworkRequest = (DetachFromNetworkRequest) o;
    return Objects.equals(this.network, detachFromNetworkRequest.network);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to DetachFromNetworkRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DetachFromNetworkRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DetachFromNetworkRequest is not found in the empty JSON string", DetachFromNetworkRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DetachFromNetworkRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DetachFromNetworkRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DetachFromNetworkRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DetachFromNetworkRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DetachFromNetworkRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DetachFromNetworkRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DetachFromNetworkRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<DetachFromNetworkRequest>() {
           @Override
           public void write(JsonWriter out, DetachFromNetworkRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DetachFromNetworkRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DetachFromNetworkRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DetachFromNetworkRequest
   * @throws IOException if the JSON string is invalid with respect to DetachFromNetworkRequest
   */
  public static DetachFromNetworkRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DetachFromNetworkRequest.class);
  }

  /**
   * Convert an instance of DetachFromNetworkRequest to an JSON string
   *
   * @return JSON string
   */
