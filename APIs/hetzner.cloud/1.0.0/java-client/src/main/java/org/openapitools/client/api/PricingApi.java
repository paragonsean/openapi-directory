...
import org.openapitools.client.model.PricingGet200Response;
...
public class PricingApi {
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        ...
        <tr><td> 200 </td><td> The &#x60;pricing&#x60; key in the reply contains an pricing object with this structure </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call pricingGetCall(final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call pricingGetValidateBeforeCall(final ApiCallback _callback) throws ApiException {
        return pricingGetCall(_callback);
     ...
     */
    public PricingGet200Response pricingGet() throws ApiException {
        ApiResponse<PricingGet200Response> localVarResp = pricingGetWithHttpInfo();
     ...
     * Get all prices
     * Returns prices for all resources available on the platform. VAT and currency of the Project owner are used for calculations.  Both net and gross prices are included in the response. 
     * @return ApiResponse&lt;PricingGet200Response&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<PricingGet200Response> pricingGetWithHttpInfo() throws ApiException {
        okhttp3.Call localVarCall = pricingGetValidateBeforeCall(null);
        Type localVarReturnType = new TypeToken<PricingGet200Response>(){}.getType();
     ...
     */
    public okhttp3.Call pricingGetAsync(final ApiCallback<PricingGet200Response> _callback) throws ApiException {

        okhttp3.Call localVarCall = pricingGetValidateBeforeCall(_callback);
        Type localVarReturnType = new TypeToken<PricingGet200Response>(){}.getType();
