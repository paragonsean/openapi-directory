...
import org.openapitools.client.model.ActionsResponseMetaPagination;
...
public class ActionsResponseMeta {
  public static final String SERIALIZED_NAME_PAGINATION = "pagination";
  @SerializedName(SERIALIZED_NAME_PAGINATION)
  private ActionsResponseMetaPagination pagination;

  public ActionsResponseMeta() {
  }

  public ActionsResponseMeta pagination(ActionsResponseMetaPagination pagination) {
  ...
  public ActionsResponseMetaPagination getPagination() {
    return pagination;
  }

  public void setPagination(ActionsResponseMetaPagination pagination) {
    this.pagination = pagination;
  }
  ...
  public boolean equals(Object o) {
    ...
    ActionsResponseMeta actionsResponseMeta = (ActionsResponseMeta) o;
    return Objects.equals(this.pagination, actionsResponseMeta.pagination);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionsResponseMeta {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ActionsResponseMeta
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ActionsResponseMeta.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionsResponseMeta is not found in the empty JSON string", ActionsResponseMeta.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ActionsResponseMeta.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ActionsResponseMeta` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionsResponseMeta.openapiRequiredFields) {
      ...
      ActionsResponseMetaPagination.validateJsonElement(jsonObj.get("pagination"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionsResponseMeta.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionsResponseMeta' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionsResponseMeta> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionsResponseMeta.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionsResponseMeta>() {
           @Override
           public void write(JsonWriter out, ActionsResponseMeta value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ActionsResponseMeta read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ActionsResponseMeta given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ActionsResponseMeta
   * @throws IOException if the JSON string is invalid with respect to ActionsResponseMeta
   */
  public static ActionsResponseMeta fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionsResponseMeta.class);
  }

  /**
   * Convert an instance of ActionsResponseMeta to an JSON string
   *
   * @return JSON string
   */
