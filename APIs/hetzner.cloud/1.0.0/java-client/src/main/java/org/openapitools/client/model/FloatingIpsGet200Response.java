...
import org.openapitools.client.model.FloatingIpsGet200ResponseFloatingIpsInner;
...
public class FloatingIpsGet200Response {
  public static final String SERIALIZED_NAME_FLOATING_IPS = "floating_ips";
  @SerializedName(SERIALIZED_NAME_FLOATING_IPS)
  private List<FloatingIpsGet200ResponseFloatingIpsInner> floatingIps = new ArrayList<>();

  public static final String SERIALIZED_NAME_META = "meta";
  @SerializedName(SERIALIZED_NAME_META)
  private ActionsResponseMeta meta;

  public FloatingIpsGet200Response() {
  }

  public FloatingIpsGet200Response floatingIps(List<FloatingIpsGet200ResponseFloatingIpsInner> floatingIps) {
    this.floatingIps = floatingIps;
    return this;
  }

  public FloatingIpsGet200Response addFloatingIpsItem(FloatingIpsGet200ResponseFloatingIpsInner floatingIpsItem) {
  ...
  public List<FloatingIpsGet200ResponseFloatingIpsInner> getFloatingIps() {
    return floatingIps;
  }

  public void setFloatingIps(List<FloatingIpsGet200ResponseFloatingIpsInner> floatingIps) {
    this.floatingIps = floatingIps;
  }


  public FloatingIpsGet200Response meta(ActionsResponseMeta meta) {
    this.meta = meta;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    FloatingIpsGet200Response floatingIpsGet200Response = (FloatingIpsGet200Response) o;
    return Objects.equals(this.floatingIps, floatingIpsGet200Response.floatingIps) &&
        Objects.equals(this.meta, floatingIpsGet200Response.meta);
  }

  @Override
  public int hashCode() {
    return Objects.hash(floatingIps, meta);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class FloatingIpsGet200Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to FloatingIpsGet200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!FloatingIpsGet200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FloatingIpsGet200Response is not found in the empty JSON string", FloatingIpsGet200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!FloatingIpsGet200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `FloatingIpsGet200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : FloatingIpsGet200Response.openapiRequiredFields) {
      ...
      for (int i = 0; i < jsonArrayfloatingIps.size(); i++) {
        FloatingIpsGet200ResponseFloatingIpsInner.validateJsonElement(jsonArrayfloatingIps.get(i));
      };
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FloatingIpsGet200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FloatingIpsGet200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FloatingIpsGet200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FloatingIpsGet200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<FloatingIpsGet200Response>() {
           @Override
           public void write(JsonWriter out, FloatingIpsGet200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public FloatingIpsGet200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of FloatingIpsGet200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of FloatingIpsGet200Response
   * @throws IOException if the JSON string is invalid with respect to FloatingIpsGet200Response
   */
  public static FloatingIpsGet200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FloatingIpsGet200Response.class);
  }

  /**
   * Convert an instance of FloatingIpsGet200Response to an JSON string
   *
   * @return JSON string
   */
