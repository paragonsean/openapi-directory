...
public class AddDeleteRouteRequest {
  ...
  public AddDeleteRouteRequest() {
  }

  public AddDeleteRouteRequest destination(String destination) {
  ...
  public AddDeleteRouteRequest gateway(String gateway) {
  ...
  public boolean equals(Object o) {
    ...
    AddDeleteRouteRequest addDeleteRouteRequest = (AddDeleteRouteRequest) o;
    return Objects.equals(this.destination, addDeleteRouteRequest.destination) &&
        Objects.equals(this.gateway, addDeleteRouteRequest.gateway);
  }

  @Override
  public int hashCode() {
    return Objects.hash(destination, gateway);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AddDeleteRouteRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AddDeleteRouteRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AddDeleteRouteRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AddDeleteRouteRequest is not found in the empty JSON string", AddDeleteRouteRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AddDeleteRouteRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AddDeleteRouteRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AddDeleteRouteRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AddDeleteRouteRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AddDeleteRouteRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AddDeleteRouteRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AddDeleteRouteRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<AddDeleteRouteRequest>() {
           @Override
           public void write(JsonWriter out, AddDeleteRouteRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AddDeleteRouteRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AddDeleteRouteRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AddDeleteRouteRequest
   * @throws IOException if the JSON string is invalid with respect to AddDeleteRouteRequest
   */
  public static AddDeleteRouteRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AddDeleteRouteRequest.class);
  }

  /**
   * Convert an instance of AddDeleteRouteRequest to an JSON string
   *
   * @return JSON string
   */
