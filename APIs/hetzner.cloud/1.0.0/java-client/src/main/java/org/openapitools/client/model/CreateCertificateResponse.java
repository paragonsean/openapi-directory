...
public class CreateCertificateResponse {
  ...
  public CreateCertificateResponse action(NullableAction action) {
    this.action = action;
    return this;
  }
  ...
  public CreateCertificateResponse certificate(Certificate certificate) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.action, createCertificateResponse.action) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(action, certificate);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateCertificateResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateCertificateResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateCertificateResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateCertificateResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CreateCertificateResponse.openapiRequiredFields) {
