...
public class ServersIdActionsChangeProtectionPostRequest {
  ...
  public ServersIdActionsChangeProtectionPostRequest() {
  }

  public ServersIdActionsChangeProtectionPostRequest delete(Boolean delete) {
    this.delete = delete;
    return this;
  }
  ...
  public ServersIdActionsChangeProtectionPostRequest rebuild(Boolean rebuild) {
  ...
  public boolean equals(Object o) {
    ...
    ServersIdActionsChangeProtectionPostRequest serversIdActionsChangeProtectionPostRequest = (ServersIdActionsChangeProtectionPostRequest) o;
    return Objects.equals(this.delete, serversIdActionsChangeProtectionPostRequest.delete) &&
        Objects.equals(this.rebuild, serversIdActionsChangeProtectionPostRequest.rebuild);
  }
  ...
  public String toString() {
    ...
    sb.append("class ServersIdActionsChangeProtectionPostRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ServersIdActionsChangeProtectionPostRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ServersIdActionsChangeProtectionPostRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ServersIdActionsChangeProtectionPostRequest is not found in the empty JSON string", ServersIdActionsChangeProtectionPostRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ServersIdActionsChangeProtectionPostRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ServersIdActionsChangeProtectionPostRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ServersIdActionsChangeProtectionPostRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ServersIdActionsChangeProtectionPostRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ServersIdActionsChangeProtectionPostRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ServersIdActionsChangeProtectionPostRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<ServersIdActionsChangeProtectionPostRequest>() {
           @Override
           public void write(JsonWriter out, ServersIdActionsChangeProtectionPostRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ServersIdActionsChangeProtectionPostRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ServersIdActionsChangeProtectionPostRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ServersIdActionsChangeProtectionPostRequest
   * @throws IOException if the JSON string is invalid with respect to ServersIdActionsChangeProtectionPostRequest
   */
  public static ServersIdActionsChangeProtectionPostRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ServersIdActionsChangeProtectionPostRequest.class);
  }

  /**
   * Convert an instance of ServersIdActionsChangeProtectionPostRequest to an JSON string
   *
   * @return JSON string
   */
