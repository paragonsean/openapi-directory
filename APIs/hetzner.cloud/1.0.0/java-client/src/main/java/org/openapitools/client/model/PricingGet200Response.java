...
import org.openapitools.client.model.PricingGet200ResponsePricing;
...
public class PricingGet200Response {
  public static final String SERIALIZED_NAME_PRICING = "pricing";
  @SerializedName(SERIALIZED_NAME_PRICING)
  private PricingGet200ResponsePricing pricing;

  public PricingGet200Response() {
  }

  public PricingGet200Response pricing(PricingGet200ResponsePricing pricing) {
  ...
  public PricingGet200ResponsePricing getPricing() {
    return pricing;
  }

  public void setPricing(PricingGet200ResponsePricing pricing) {
    this.pricing = pricing;
  }
  ...
  public boolean equals(Object o) {
    ...
    PricingGet200Response pricingGet200Response = (PricingGet200Response) o;
    return Objects.equals(this.pricing, pricingGet200Response.pricing);
  }
  ...
  public String toString() {
    ...
    sb.append("class PricingGet200Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PricingGet200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PricingGet200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PricingGet200Response is not found in the empty JSON string", PricingGet200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PricingGet200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PricingGet200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PricingGet200Response.openapiRequiredFields) {
      ...
      PricingGet200ResponsePricing.validateJsonElement(jsonObj.get("pricing"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PricingGet200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PricingGet200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PricingGet200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PricingGet200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<PricingGet200Response>() {
           @Override
           public void write(JsonWriter out, PricingGet200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PricingGet200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PricingGet200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PricingGet200Response
   * @throws IOException if the JSON string is invalid with respect to PricingGet200Response
   */
  public static PricingGet200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PricingGet200Response.class);
  }

  /**
   * Convert an instance of PricingGet200Response to an JSON string
   *
   * @return JSON string
   */
