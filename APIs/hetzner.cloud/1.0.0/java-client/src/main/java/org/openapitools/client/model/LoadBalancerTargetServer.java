...
public class LoadBalancerTargetServer {
  ...
  public LoadBalancerTargetServer() {
  }

  public LoadBalancerTargetServer id(Integer id) {
    this.id = id;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    LoadBalancerTargetServer loadBalancerTargetServer = (LoadBalancerTargetServer) o;
    return Objects.equals(this.id, loadBalancerTargetServer.id);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to LoadBalancerTargetServer
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LoadBalancerTargetServer.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LoadBalancerTargetServer is not found in the empty JSON string", LoadBalancerTargetServer.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LoadBalancerTargetServer.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LoadBalancerTargetServer` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LoadBalancerTargetServer.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LoadBalancerTargetServer.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LoadBalancerTargetServer' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LoadBalancerTargetServer> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LoadBalancerTargetServer.class));

       return (TypeAdapter<T>) new TypeAdapter<LoadBalancerTargetServer>() {
           @Override
           public void write(JsonWriter out, LoadBalancerTargetServer value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LoadBalancerTargetServer read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LoadBalancerTargetServer given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LoadBalancerTargetServer
   * @throws IOException if the JSON string is invalid with respect to LoadBalancerTargetServer
   */
  public static LoadBalancerTargetServer fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LoadBalancerTargetServer.class);
  }

  /**
   * Convert an instance of LoadBalancerTargetServer to an JSON string
   *
   * @return JSON string
   */
