...
public class UpdatePrimaryIPRequest {
  ...
  public UpdatePrimaryIPRequest() {
  }

  public UpdatePrimaryIPRequest autoDelete(Boolean autoDelete) {
  ...
  public UpdatePrimaryIPRequest labels(Object labels) {
    this.labels = labels;
    return this;
  }
  ...
  public UpdatePrimaryIPRequest name(String name) {
    this.name = name;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    UpdatePrimaryIPRequest updatePrimaryIPRequest = (UpdatePrimaryIPRequest) o;
    return Objects.equals(this.autoDelete, updatePrimaryIPRequest.autoDelete) &&
        Objects.equals(this.labels, updatePrimaryIPRequest.labels) &&
        Objects.equals(this.name, updatePrimaryIPRequest.name);
  }

  @Override
  public int hashCode() {
    return Objects.hash(autoDelete, labels, name);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class UpdatePrimaryIPRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdatePrimaryIPRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdatePrimaryIPRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdatePrimaryIPRequest is not found in the empty JSON string", UpdatePrimaryIPRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdatePrimaryIPRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdatePrimaryIPRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdatePrimaryIPRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdatePrimaryIPRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdatePrimaryIPRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdatePrimaryIPRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdatePrimaryIPRequest>() {
           @Override
           public void write(JsonWriter out, UpdatePrimaryIPRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdatePrimaryIPRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdatePrimaryIPRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdatePrimaryIPRequest
   * @throws IOException if the JSON string is invalid with respect to UpdatePrimaryIPRequest
   */
  public static UpdatePrimaryIPRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdatePrimaryIPRequest.class);
  }

  /**
   * Convert an instance of UpdatePrimaryIPRequest to an JSON string
   *
   * @return JSON string
   */
