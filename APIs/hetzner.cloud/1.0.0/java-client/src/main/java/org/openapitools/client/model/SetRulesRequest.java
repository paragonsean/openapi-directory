...
public class SetRulesRequest {
  ...
  public SetRulesRequest rules(List<Rule> rules) {
    this.rules = rules;
    return this;
  }

  public SetRulesRequest addRulesItem(Rule rulesItem) {
    if (this.rules == null) {
  ...
  public boolean equals(Object o) {
    ...
    SetRulesRequest setRulesRequest = (SetRulesRequest) o;
    return Objects.equals(this.rules, setRulesRequest.rules);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to SetRulesRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SetRulesRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SetRulesRequest is not found in the empty JSON string", SetRulesRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SetRulesRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SetRulesRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : SetRulesRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SetRulesRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SetRulesRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SetRulesRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SetRulesRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<SetRulesRequest>() {
           @Override
           public void write(JsonWriter out, SetRulesRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SetRulesRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SetRulesRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SetRulesRequest
   * @throws IOException if the JSON string is invalid with respect to SetRulesRequest
   */
  public static SetRulesRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SetRulesRequest.class);
  }

  /**
   * Convert an instance of SetRulesRequest to an JSON string
   *
   * @return JSON string
   */
