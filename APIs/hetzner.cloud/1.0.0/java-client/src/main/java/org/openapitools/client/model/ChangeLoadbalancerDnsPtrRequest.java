...
public class ChangeLoadbalancerDnsPtrRequest {
  ...
  public ChangeLoadbalancerDnsPtrRequest() {
  }

  public ChangeLoadbalancerDnsPtrRequest dnsPtr(String dnsPtr) {
    this.dnsPtr = dnsPtr;
    return this;
  }
  ...
  public ChangeLoadbalancerDnsPtrRequest ip(String ip) {
    this.ip = ip;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    ChangeLoadbalancerDnsPtrRequest changeLoadbalancerDnsPtrRequest = (ChangeLoadbalancerDnsPtrRequest) o;
    return Objects.equals(this.dnsPtr, changeLoadbalancerDnsPtrRequest.dnsPtr) &&
        Objects.equals(this.ip, changeLoadbalancerDnsPtrRequest.ip);
  }
  ...
  public String toString() {
    ...
    sb.append("class ChangeLoadbalancerDnsPtrRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ChangeLoadbalancerDnsPtrRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ChangeLoadbalancerDnsPtrRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ChangeLoadbalancerDnsPtrRequest is not found in the empty JSON string", ChangeLoadbalancerDnsPtrRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ChangeLoadbalancerDnsPtrRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ChangeLoadbalancerDnsPtrRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ChangeLoadbalancerDnsPtrRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ChangeLoadbalancerDnsPtrRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ChangeLoadbalancerDnsPtrRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ChangeLoadbalancerDnsPtrRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ChangeLoadbalancerDnsPtrRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<ChangeLoadbalancerDnsPtrRequest>() {
           @Override
           public void write(JsonWriter out, ChangeLoadbalancerDnsPtrRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ChangeLoadbalancerDnsPtrRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ChangeLoadbalancerDnsPtrRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ChangeLoadbalancerDnsPtrRequest
   * @throws IOException if the JSON string is invalid with respect to ChangeLoadbalancerDnsPtrRequest
   */
  public static ChangeLoadbalancerDnsPtrRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ChangeLoadbalancerDnsPtrRequest.class);
  }

  /**
   * Convert an instance of ChangeLoadbalancerDnsPtrRequest to an JSON string
   *
   * @return JSON string
   */
