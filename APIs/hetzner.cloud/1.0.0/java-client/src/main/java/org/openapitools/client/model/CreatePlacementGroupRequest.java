...
public class CreatePlacementGroupRequest {
  ...
  public CreatePlacementGroupRequest labels(Object labels) {
    this.labels = labels;
    return this;
  }
  ...
  public CreatePlacementGroupRequest type(TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.labels, createPlacementGroupRequest.labels) &&
        Objects.equals(this.name, createPlacementGroupRequest.name) &&
        Objects.equals(this.type, createPlacementGroupRequest.type);
  }

  @Override
  public int hashCode() {
    return Objects.hash(labels, name, type);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreatePlacementGroupRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreatePlacementGroupRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreatePlacementGroupRequest is not found in the empty JSON string", CreatePlacementGroupRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreatePlacementGroupRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreatePlacementGroupRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CreatePlacementGroupRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreatePlacementGroupRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreatePlacementGroupRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreatePlacementGroupRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreatePlacementGroupRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<CreatePlacementGroupRequest>() {
           @Override
           public void write(JsonWriter out, CreatePlacementGroupRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreatePlacementGroupRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreatePlacementGroupRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreatePlacementGroupRequest
   * @throws IOException if the JSON string is invalid with respect to CreatePlacementGroupRequest
   */
  public static CreatePlacementGroupRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreatePlacementGroupRequest.class);
  }

  /**
   * Convert an instance of CreatePlacementGroupRequest to an JSON string
   *
   * @return JSON string
   */
