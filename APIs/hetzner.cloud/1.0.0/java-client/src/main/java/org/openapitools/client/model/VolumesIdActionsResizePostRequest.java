...
public class VolumesIdActionsResizePostRequest {
  public static final String SERIALIZED_NAME_SIZE = "size";
  @SerializedName(SERIALIZED_NAME_SIZE)
  private BigDecimal size;

  public VolumesIdActionsResizePostRequest() {
  }

  public VolumesIdActionsResizePostRequest size(BigDecimal size) {
    this.size = size;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    VolumesIdActionsResizePostRequest volumesIdActionsResizePostRequest = (VolumesIdActionsResizePostRequest) o;
    return Objects.equals(this.size, volumesIdActionsResizePostRequest.size);
  }
  ...
  public String toString() {
    ...
    sb.append("class VolumesIdActionsResizePostRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to VolumesIdActionsResizePostRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!VolumesIdActionsResizePostRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in VolumesIdActionsResizePostRequest is not found in the empty JSON string", VolumesIdActionsResizePostRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!VolumesIdActionsResizePostRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `VolumesIdActionsResizePostRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : VolumesIdActionsResizePostRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!VolumesIdActionsResizePostRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'VolumesIdActionsResizePostRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<VolumesIdActionsResizePostRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(VolumesIdActionsResizePostRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<VolumesIdActionsResizePostRequest>() {
           @Override
           public void write(JsonWriter out, VolumesIdActionsResizePostRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public VolumesIdActionsResizePostRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of VolumesIdActionsResizePostRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of VolumesIdActionsResizePostRequest
   * @throws IOException if the JSON string is invalid with respect to VolumesIdActionsResizePostRequest
   */
  public static VolumesIdActionsResizePostRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, VolumesIdActionsResizePostRequest.class);
  }

  /**
   * Convert an instance of VolumesIdActionsResizePostRequest to an JSON string
   *
   * @return JSON string
   */
