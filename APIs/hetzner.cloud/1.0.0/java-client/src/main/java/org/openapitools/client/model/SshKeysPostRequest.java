...
public class SshKeysPostRequest {
  ...
  public SshKeysPostRequest() {
  }

  public SshKeysPostRequest labels(Object labels) {
    this.labels = labels;
    return this;
  }
  ...
  public SshKeysPostRequest name(String name) {
    this.name = name;
    return this;
  }
  ...
  public SshKeysPostRequest publicKey(String publicKey) {
  ...
  public boolean equals(Object o) {
    ...
    SshKeysPostRequest sshKeysPostRequest = (SshKeysPostRequest) o;
    return Objects.equals(this.labels, sshKeysPostRequest.labels) &&
        Objects.equals(this.name, sshKeysPostRequest.name) &&
        Objects.equals(this.publicKey, sshKeysPostRequest.publicKey);
  }

  @Override
  public int hashCode() {
    return Objects.hash(labels, name, publicKey);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class SshKeysPostRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to SshKeysPostRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SshKeysPostRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SshKeysPostRequest is not found in the empty JSON string", SshKeysPostRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SshKeysPostRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SshKeysPostRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : SshKeysPostRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SshKeysPostRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SshKeysPostRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SshKeysPostRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SshKeysPostRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<SshKeysPostRequest>() {
           @Override
           public void write(JsonWriter out, SshKeysPostRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SshKeysPostRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SshKeysPostRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SshKeysPostRequest
   * @throws IOException if the JSON string is invalid with respect to SshKeysPostRequest
   */
  public static SshKeysPostRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SshKeysPostRequest.class);
  }

  /**
   * Convert an instance of SshKeysPostRequest to an JSON string
   *
   * @return JSON string
   */
