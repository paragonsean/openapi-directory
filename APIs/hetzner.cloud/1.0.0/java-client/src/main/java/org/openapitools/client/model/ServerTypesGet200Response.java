...
import org.openapitools.client.model.ServerTypesGet200ResponseServerTypesInner;
...
public class ServerTypesGet200Response {
  public static final String SERIALIZED_NAME_SERVER_TYPES = "server_types";
  @SerializedName(SERIALIZED_NAME_SERVER_TYPES)
  private List<ServerTypesGet200ResponseServerTypesInner> serverTypes = new ArrayList<>();

  public ServerTypesGet200Response() {
  }

  public ServerTypesGet200Response serverTypes(List<ServerTypesGet200ResponseServerTypesInner> serverTypes) {
    this.serverTypes = serverTypes;
    return this;
  }

  public ServerTypesGet200Response addServerTypesItem(ServerTypesGet200ResponseServerTypesInner serverTypesItem) {
  ...
  public List<ServerTypesGet200ResponseServerTypesInner> getServerTypes() {
    return serverTypes;
  }

  public void setServerTypes(List<ServerTypesGet200ResponseServerTypesInner> serverTypes) {
    this.serverTypes = serverTypes;
  }
  ...
  public boolean equals(Object o) {
    ...
    ServerTypesGet200Response serverTypesGet200Response = (ServerTypesGet200Response) o;
    return Objects.equals(this.serverTypes, serverTypesGet200Response.serverTypes);
  }

  @Override
  public int hashCode() {
    return Objects.hash(serverTypes);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ServerTypesGet200Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ServerTypesGet200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ServerTypesGet200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ServerTypesGet200Response is not found in the empty JSON string", ServerTypesGet200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ServerTypesGet200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ServerTypesGet200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ServerTypesGet200Response.openapiRequiredFields) {
      ...
      for (int i = 0; i < jsonArrayserverTypes.size(); i++) {
        ServerTypesGet200ResponseServerTypesInner.validateJsonElement(jsonArrayserverTypes.get(i));
      };
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ServerTypesGet200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ServerTypesGet200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ServerTypesGet200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ServerTypesGet200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<ServerTypesGet200Response>() {
           @Override
           public void write(JsonWriter out, ServerTypesGet200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ServerTypesGet200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ServerTypesGet200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ServerTypesGet200Response
   * @throws IOException if the JSON string is invalid with respect to ServerTypesGet200Response
   */
  public static ServerTypesGet200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ServerTypesGet200Response.class);
  }

  /**
   * Convert an instance of ServerTypesGet200Response to an JSON string
   *
   * @return JSON string
   */
