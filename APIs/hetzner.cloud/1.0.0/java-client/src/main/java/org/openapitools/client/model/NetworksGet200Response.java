...
import org.openapitools.client.model.NetworksGet200ResponseNetworksInner;
...
public class NetworksGet200Response {
  ...
  private List<NetworksGet200ResponseNetworksInner> networks = new ArrayList<>();

  public NetworksGet200Response() {
  }

  public NetworksGet200Response meta(ActionsResponseMeta meta) {
    this.meta = meta;
    return this;
  }
  ...
  public NetworksGet200Response networks(List<NetworksGet200ResponseNetworksInner> networks) {
    this.networks = networks;
    return this;
  }

  public NetworksGet200Response addNetworksItem(NetworksGet200ResponseNetworksInner networksItem) {
  ...
  public List<NetworksGet200ResponseNetworksInner> getNetworks() {
    return networks;
  }

  public void setNetworks(List<NetworksGet200ResponseNetworksInner> networks) {
    this.networks = networks;
  }
  ...
  public boolean equals(Object o) {
    ...
    NetworksGet200Response networksGet200Response = (NetworksGet200Response) o;
    return Objects.equals(this.meta, networksGet200Response.meta) &&
        Objects.equals(this.networks, networksGet200Response.networks);
  }
  ...
  public String toString() {
    ...
    sb.append("class NetworksGet200Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to NetworksGet200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!NetworksGet200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in NetworksGet200Response is not found in the empty JSON string", NetworksGet200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!NetworksGet200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `NetworksGet200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : NetworksGet200Response.openapiRequiredFields) {
      ...
      for (int i = 0; i < jsonArraynetworks.size(); i++) {
        NetworksGet200ResponseNetworksInner.validateJsonElement(jsonArraynetworks.get(i));
      };
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!NetworksGet200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'NetworksGet200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<NetworksGet200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(NetworksGet200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<NetworksGet200Response>() {
           @Override
           public void write(JsonWriter out, NetworksGet200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public NetworksGet200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of NetworksGet200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of NetworksGet200Response
   * @throws IOException if the JSON string is invalid with respect to NetworksGet200Response
   */
  public static NetworksGet200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, NetworksGet200Response.class);
  }

  /**
   * Convert an instance of NetworksGet200Response to an JSON string
   *
   * @return JSON string
   */
