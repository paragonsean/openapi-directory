...
import org.openapitools.client.model.LoadBalancerServiceHealthCheckHttp;
...
public class LoadBalancerServiceHealthCheck {
  ...
  private LoadBalancerServiceHealthCheckHttp http;
  ...
  public LoadBalancerServiceHealthCheck http(LoadBalancerServiceHealthCheckHttp http) {
    this.http = http;
    return this;
  }
  ...
  public LoadBalancerServiceHealthCheckHttp getHttp() {
    return http;
  }

  public void setHttp(LoadBalancerServiceHealthCheckHttp http) {
    this.http = http;
  }


  public LoadBalancerServiceHealthCheck interval(Integer interval) {
  ...
  public LoadBalancerServiceHealthCheck port(Integer port) {
    this.port = port;
    return this;
  }
  ...
  public LoadBalancerServiceHealthCheck protocol(ProtocolEnum protocol) {
  ...
  public LoadBalancerServiceHealthCheck retries(Integer retries) {
  ...
  public LoadBalancerServiceHealthCheck timeout(Integer timeout) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.http, loadBalancerServiceHealthCheck.http) &&
        ...
        Objects.equals(this.protocol, loadBalancerServiceHealthCheck.protocol) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(http, interval, port, protocol, retries, timeout);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (String requiredField : LoadBalancerServiceHealthCheck.openapiRequiredFields) {
      ...
      if (jsonObj.get("http") != null && !jsonObj.get("http").isJsonNull()) {
        LoadBalancerServiceHealthCheckHttp.validateJsonElement(jsonObj.get("http"));
      }
