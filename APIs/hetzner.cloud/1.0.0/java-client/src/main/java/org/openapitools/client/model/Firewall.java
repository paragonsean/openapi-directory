...
public class Firewall {
  ...
  private List<FirewallAppliedToInner> appliedTo = new ArrayList<>();
  ...
  public Firewall appliedTo(List<FirewallAppliedToInner> appliedTo) {
    this.appliedTo = appliedTo;
    return this;
  }

  public Firewall addAppliedToItem(FirewallAppliedToInner appliedToItem) {
  ...
  public List<FirewallAppliedToInner> getAppliedTo() {
    return appliedTo;
  }

  public void setAppliedTo(List<FirewallAppliedToInner> appliedTo) {
    this.appliedTo = appliedTo;
  }


  public Firewall created(String created) {
  ...
  public Firewall labels(Map<String, String> labels) {
    this.labels = labels;
    return this;
  }

  public Firewall putLabelsItem(String key, String labelsItem) {
    if (this.labels == null) {
  ...
  public Firewall rules(List<Rule> rules) {
    this.rules = rules;
    return this;
  }

  public Firewall addRulesItem(Rule rulesItem) {
    if (this.rules == null) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.appliedTo, firewall.appliedTo) &&
        Objects.equals(this.created, firewall.created) &&
        Objects.equals(this.id, firewall.id) &&
        Objects.equals(this.labels, firewall.labels) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(appliedTo, created, id, labels, name, rules);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (int i = 0; i < jsonArrayappliedTo.size(); i++) {
        FirewallAppliedToInner.validateJsonElement(jsonArrayappliedTo.get(i));
      };
