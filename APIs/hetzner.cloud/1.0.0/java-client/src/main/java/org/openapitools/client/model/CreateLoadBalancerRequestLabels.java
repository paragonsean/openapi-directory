...
public class CreateLoadBalancerRequestLabels {
  public static final String SERIALIZED_NAME_LABELKEY = "labelkey";
  @SerializedName(SERIALIZED_NAME_LABELKEY)
  private String labelkey;

  public CreateLoadBalancerRequestLabels() {
  }

  public CreateLoadBalancerRequestLabels labelkey(String labelkey) {
  ...
  public boolean equals(Object o) {
    ...
    CreateLoadBalancerRequestLabels createLoadBalancerRequestLabels = (CreateLoadBalancerRequestLabels) o;
    return Objects.equals(this.labelkey, createLoadBalancerRequestLabels.labelkey);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateLoadBalancerRequestLabels {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateLoadBalancerRequestLabels
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateLoadBalancerRequestLabels.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateLoadBalancerRequestLabels is not found in the empty JSON string", CreateLoadBalancerRequestLabels.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateLoadBalancerRequestLabels.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateLoadBalancerRequestLabels` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateLoadBalancerRequestLabels.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateLoadBalancerRequestLabels' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateLoadBalancerRequestLabels> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateLoadBalancerRequestLabels.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateLoadBalancerRequestLabels>() {
           @Override
           public void write(JsonWriter out, CreateLoadBalancerRequestLabels value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateLoadBalancerRequestLabels read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateLoadBalancerRequestLabels given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateLoadBalancerRequestLabels
   * @throws IOException if the JSON string is invalid with respect to CreateLoadBalancerRequestLabels
   */
  public static CreateLoadBalancerRequestLabels fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateLoadBalancerRequestLabels.class);
  }

  /**
   * Convert an instance of CreateLoadBalancerRequestLabels to an JSON string
   *
   * @return JSON string
   */
