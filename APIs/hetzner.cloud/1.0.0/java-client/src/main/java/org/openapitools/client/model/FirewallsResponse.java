...
public class FirewallsResponse {
  ...
  public FirewallsResponse() {
  }

  public FirewallsResponse firewalls(List<Firewall> firewalls) {
    this.firewalls = firewalls;
    return this;
  }

  public FirewallsResponse addFirewallsItem(Firewall firewallsItem) {
  ...
  public FirewallsResponse meta(ActionsResponseMeta meta) {
    this.meta = meta;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    FirewallsResponse firewallsResponse = (FirewallsResponse) o;
    return Objects.equals(this.firewalls, firewallsResponse.firewalls) &&
        Objects.equals(this.meta, firewallsResponse.meta);
  }

  @Override
  public int hashCode() {
    return Objects.hash(firewalls, meta);
  }
  ...
  static {
    ...
    openapiRequiredFields.add("firewalls");
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to FirewallsResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!FirewallsResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FirewallsResponse is not found in the empty JSON string", FirewallsResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!FirewallsResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `FirewallsResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : FirewallsResponse.openapiRequiredFields) {
      ...
      // validate the required field `firewalls` (array)
      for (int i = 0; i < jsonArrayfirewalls.size(); i++) {
        Firewall.validateJsonElement(jsonArrayfirewalls.get(i));
      };
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FirewallsResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FirewallsResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FirewallsResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FirewallsResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<FirewallsResponse>() {
           @Override
           public void write(JsonWriter out, FirewallsResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public FirewallsResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of FirewallsResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of FirewallsResponse
   * @throws IOException if the JSON string is invalid with respect to FirewallsResponse
   */
  public static FirewallsResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FirewallsResponse.class);
  }

  /**
   * Convert an instance of FirewallsResponse to an JSON string
   *
   * @return JSON string
   */
