...
import org.openapitools.client.model.CreateFirewallRequestApplyToInner;
...
public class CreateFirewallRequest {
  ...
  private List<CreateFirewallRequestApplyToInner> applyTo = new ArrayList<>();
  ...
  public CreateFirewallRequest applyTo(List<CreateFirewallRequestApplyToInner> applyTo) {
    this.applyTo = applyTo;
    return this;
  }

  public CreateFirewallRequest addApplyToItem(CreateFirewallRequestApplyToInner applyToItem) {
  ...
  public List<CreateFirewallRequestApplyToInner> getApplyTo() {
    return applyTo;
  }

  public void setApplyTo(List<CreateFirewallRequestApplyToInner> applyTo) {
    this.applyTo = applyTo;
  }


  public CreateFirewallRequest labels(Object labels) {
    this.labels = labels;
    return this;
  }
  ...
  public CreateFirewallRequest rules(List<Rule> rules) {
    this.rules = rules;
    return this;
  }

  public CreateFirewallRequest addRulesItem(Rule rulesItem) {
    if (this.rules == null) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.applyTo, createFirewallRequest.applyTo) &&
        Objects.equals(this.labels, createFirewallRequest.labels) &&
        Objects.equals(this.name, createFirewallRequest.name) &&
        Objects.equals(this.rules, createFirewallRequest.rules);
  }

  @Override
  public int hashCode() {
    return Objects.hash(applyTo, labels, name, rules);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("apply_to") != null && !jsonObj.get("apply_to").isJsonNull()) {
        JsonArray jsonArrayapplyTo = jsonObj.getAsJsonArray("apply_to");
        if (jsonArrayapplyTo != null) {
          ...
          for (int i = 0; i < jsonArrayapplyTo.size(); i++) {
            CreateFirewallRequestApplyToInner.validateJsonElement(jsonArrayapplyTo.get(i));
          };
        }
      }
