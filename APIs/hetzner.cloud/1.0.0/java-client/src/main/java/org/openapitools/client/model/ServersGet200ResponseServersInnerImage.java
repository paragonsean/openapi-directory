...
public class ServersGet200ResponseServersInnerImage {
  ...
  private ImagesGet200ResponseImagesInnerCreatedFrom createdFrom;
  ...
  public ServersGet200ResponseServersInnerImage() {
  }

  public ServersGet200ResponseServersInnerImage boundTo(Integer boundTo) {
  ...
  public void setBoundTo(Integer boundTo) {
    this.boundTo = boundTo;
  }


  public ServersGet200ResponseServersInnerImage created(String created) {
  ...
  public ServersGet200ResponseServersInnerImage createdFrom(ImagesGet200ResponseImagesInnerCreatedFrom createdFrom) {
   ...
   */
  @javax.annotation.Nullable
  public ImagesGet200ResponseImagesInnerCreatedFrom getCreatedFrom() {
    return createdFrom;
  }

  public void setCreatedFrom(ImagesGet200ResponseImagesInnerCreatedFrom createdFrom) {
    this.createdFrom = createdFrom;
  }


  public ServersGet200ResponseServersInnerImage deleted(String deleted) {
  ...
  public ServersGet200ResponseServersInnerImage deprecated(String deprecated) {
  ...
  public ServersGet200ResponseServersInnerImage description(String description) {
  ...
  public ServersGet200ResponseServersInnerImage diskSize(BigDecimal diskSize) {
  ...
  public ServersGet200ResponseServersInnerImage id(Integer id) {
    this.id = id;
    return this;
  }
  ...
  public ServersGet200ResponseServersInnerImage imageSize(BigDecimal imageSize) {
  ...
  public ServersGet200ResponseServersInnerImage labels(Map<String, String> labels) {
    this.labels = labels;
    return this;
  }

  public ServersGet200ResponseServersInnerImage putLabelsItem(String key, String labelsItem) {
    if (this.labels == null) {
  ...
  public ServersGet200ResponseServersInnerImage name(String name) {
    this.name = name;
    return this;
  }
  ...
  public ServersGet200ResponseServersInnerImage osFlavor(OsFlavorEnum osFlavor) {
  ...
  public ServersGet200ResponseServersInnerImage osVersion(String osVersion) {
  ...
  public ServersGet200ResponseServersInnerImage protection(FloatingIpsGet200ResponseFloatingIpsInnerProtection protection) {
  ...
  public ServersGet200ResponseServersInnerImage rapidDeploy(Boolean rapidDeploy) {
  ...
  public ServersGet200ResponseServersInnerImage status(StatusEnum status) {
    this.status = status;
    return this;
  }
  ...
  public ServersGet200ResponseServersInnerImage type(TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    ServersGet200ResponseServersInnerImage serversGet200ResponseServersInnerImage = (ServersGet200ResponseServersInnerImage) o;
    return Objects.equals(this.boundTo, serversGet200ResponseServersInnerImage.boundTo) &&
        Objects.equals(this.created, serversGet200ResponseServersInnerImage.created) &&
        Objects.equals(this.createdFrom, serversGet200ResponseServersInnerImage.createdFrom) &&
        Objects.equals(this.deleted, serversGet200ResponseServersInnerImage.deleted) &&
        Objects.equals(this.deprecated, serversGet200ResponseServersInnerImage.deprecated) &&
        Objects.equals(this.description, serversGet200ResponseServersInnerImage.description) &&
        Objects.equals(this.diskSize, serversGet200ResponseServersInnerImage.diskSize) &&
        Objects.equals(this.id, serversGet200ResponseServersInnerImage.id) &&
        Objects.equals(this.imageSize, serversGet200ResponseServersInnerImage.imageSize) &&
        Objects.equals(this.labels, serversGet200ResponseServersInnerImage.labels) &&
        Objects.equals(this.name, serversGet200ResponseServersInnerImage.name) &&
        Objects.equals(this.osFlavor, serversGet200ResponseServersInnerImage.osFlavor) &&
        Objects.equals(this.osVersion, serversGet200ResponseServersInnerImage.osVersion) &&
        Objects.equals(this.protection, serversGet200ResponseServersInnerImage.protection) &&
        Objects.equals(this.rapidDeploy, serversGet200ResponseServersInnerImage.rapidDeploy) &&
        Objects.equals(this.status, serversGet200ResponseServersInnerImage.status) &&
        Objects.equals(this.type, serversGet200ResponseServersInnerImage.type);
  }

  @Override
  public int hashCode() {
    return Objects.hash(boundTo, created, createdFrom, deleted, deprecated, description, diskSize, id, imageSize, labels, name, osFlavor, osVersion, protection, rapidDeploy, status, type);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ServersGet200ResponseServersInnerImage {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ServersGet200ResponseServersInnerImage
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ServersGet200ResponseServersInnerImage.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ServersGet200ResponseServersInnerImage is not found in the empty JSON string", ServersGet200ResponseServersInnerImage.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ServersGet200ResponseServersInnerImage.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ServersGet200ResponseServersInnerImage` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ServersGet200ResponseServersInnerImage.openapiRequiredFields) {
      ...
      ImagesGet200ResponseImagesInnerCreatedFrom.validateJsonElement(jsonObj.get("created_from"));
      ...
      // validate the required field `os_flavor`
      OsFlavorEnum.validateJsonElement(jsonObj.get("os_flavor"));
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ServersGet200ResponseServersInnerImage.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ServersGet200ResponseServersInnerImage' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ServersGet200ResponseServersInnerImage> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ServersGet200ResponseServersInnerImage.class));

       return (TypeAdapter<T>) new TypeAdapter<ServersGet200ResponseServersInnerImage>() {
           @Override
           public void write(JsonWriter out, ServersGet200ResponseServersInnerImage value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ServersGet200ResponseServersInnerImage read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ServersGet200ResponseServersInnerImage given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ServersGet200ResponseServersInnerImage
   * @throws IOException if the JSON string is invalid with respect to ServersGet200ResponseServersInnerImage
   */
  public static ServersGet200ResponseServersInnerImage fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ServersGet200ResponseServersInnerImage.class);
  }

  /**
   * Convert an instance of ServersGet200ResponseServersInnerImage to an JSON string
   *
   * @return JSON string
   */
