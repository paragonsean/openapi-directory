...
public class LoadBalancersIdActionsDetachFromNetworkPostRequest {
  public static final String SERIALIZED_NAME_NETWORK = "network";
  @SerializedName(SERIALIZED_NAME_NETWORK)
  private BigDecimal network;

  public LoadBalancersIdActionsDetachFromNetworkPostRequest() {
  }

  public LoadBalancersIdActionsDetachFromNetworkPostRequest network(BigDecimal network) {
  ...
  public boolean equals(Object o) {
    ...
    LoadBalancersIdActionsDetachFromNetworkPostRequest loadBalancersIdActionsDetachFromNetworkPostRequest = (LoadBalancersIdActionsDetachFromNetworkPostRequest) o;
    return Objects.equals(this.network, loadBalancersIdActionsDetachFromNetworkPostRequest.network);
  }
  ...
  public String toString() {
    ...
    sb.append("class LoadBalancersIdActionsDetachFromNetworkPostRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to LoadBalancersIdActionsDetachFromNetworkPostRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LoadBalancersIdActionsDetachFromNetworkPostRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LoadBalancersIdActionsDetachFromNetworkPostRequest is not found in the empty JSON string", LoadBalancersIdActionsDetachFromNetworkPostRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LoadBalancersIdActionsDetachFromNetworkPostRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LoadBalancersIdActionsDetachFromNetworkPostRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LoadBalancersIdActionsDetachFromNetworkPostRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LoadBalancersIdActionsDetachFromNetworkPostRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LoadBalancersIdActionsDetachFromNetworkPostRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LoadBalancersIdActionsDetachFromNetworkPostRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LoadBalancersIdActionsDetachFromNetworkPostRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<LoadBalancersIdActionsDetachFromNetworkPostRequest>() {
           @Override
           public void write(JsonWriter out, LoadBalancersIdActionsDetachFromNetworkPostRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LoadBalancersIdActionsDetachFromNetworkPostRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LoadBalancersIdActionsDetachFromNetworkPostRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LoadBalancersIdActionsDetachFromNetworkPostRequest
   * @throws IOException if the JSON string is invalid with respect to LoadBalancersIdActionsDetachFromNetworkPostRequest
   */
  public static LoadBalancersIdActionsDetachFromNetworkPostRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LoadBalancersIdActionsDetachFromNetworkPostRequest.class);
  }

  /**
   * Convert an instance of LoadBalancersIdActionsDetachFromNetworkPostRequest to an JSON string
   *
   * @return JSON string
   */
