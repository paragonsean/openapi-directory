...
public class FirewallApplyToResourcesLabelSelector {
  public static final String SERIALIZED_NAME_SELECTOR = "selector";
  @SerializedName(SERIALIZED_NAME_SELECTOR)
  private String selector;

  public FirewallApplyToResourcesLabelSelector() {
  }

  public FirewallApplyToResourcesLabelSelector selector(String selector) {
  ...
  public boolean equals(Object o) {
    ...
    FirewallApplyToResourcesLabelSelector firewallApplyToResourcesLabelSelector = (FirewallApplyToResourcesLabelSelector) o;
    return Objects.equals(this.selector, firewallApplyToResourcesLabelSelector.selector);
  }
  ...
  public String toString() {
    ...
    sb.append("class FirewallApplyToResourcesLabelSelector {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to FirewallApplyToResourcesLabelSelector
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!FirewallApplyToResourcesLabelSelector.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FirewallApplyToResourcesLabelSelector is not found in the empty JSON string", FirewallApplyToResourcesLabelSelector.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!FirewallApplyToResourcesLabelSelector.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `FirewallApplyToResourcesLabelSelector` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : FirewallApplyToResourcesLabelSelector.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FirewallApplyToResourcesLabelSelector.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FirewallApplyToResourcesLabelSelector' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FirewallApplyToResourcesLabelSelector> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FirewallApplyToResourcesLabelSelector.class));

       return (TypeAdapter<T>) new TypeAdapter<FirewallApplyToResourcesLabelSelector>() {
           @Override
           public void write(JsonWriter out, FirewallApplyToResourcesLabelSelector value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public FirewallApplyToResourcesLabelSelector read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of FirewallApplyToResourcesLabelSelector given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of FirewallApplyToResourcesLabelSelector
   * @throws IOException if the JSON string is invalid with respect to FirewallApplyToResourcesLabelSelector
   */
  public static FirewallApplyToResourcesLabelSelector fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FirewallApplyToResourcesLabelSelector.class);
  }

  /**
   * Convert an instance of FirewallApplyToResourcesLabelSelector to an JSON string
   *
   * @return JSON string
   */
