...
public class VolumesGet200Response {
  ...
  private List<VolumesGet200ResponseVolumesInner> volumes = new ArrayList<>();

  public VolumesGet200Response() {
  }

  public VolumesGet200Response meta(ActionsResponseMeta meta) {
    this.meta = meta;
    return this;
  }
  ...
  public VolumesGet200Response volumes(List<VolumesGet200ResponseVolumesInner> volumes) {
    this.volumes = volumes;
    return this;
  }

  public VolumesGet200Response addVolumesItem(VolumesGet200ResponseVolumesInner volumesItem) {
  ...
  public List<VolumesGet200ResponseVolumesInner> getVolumes() {
    return volumes;
  }

  public void setVolumes(List<VolumesGet200ResponseVolumesInner> volumes) {
    this.volumes = volumes;
  }
  ...
  public boolean equals(Object o) {
    ...
    VolumesGet200Response volumesGet200Response = (VolumesGet200Response) o;
    return Objects.equals(this.meta, volumesGet200Response.meta) &&
        Objects.equals(this.volumes, volumesGet200Response.volumes);
  }

  @Override
  public int hashCode() {
    return Objects.hash(meta, volumes);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class VolumesGet200Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to VolumesGet200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!VolumesGet200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in VolumesGet200Response is not found in the empty JSON string", VolumesGet200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!VolumesGet200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `VolumesGet200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : VolumesGet200Response.openapiRequiredFields) {
      ...
      for (int i = 0; i < jsonArrayvolumes.size(); i++) {
        VolumesGet200ResponseVolumesInner.validateJsonElement(jsonArrayvolumes.get(i));
      };
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!VolumesGet200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'VolumesGet200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<VolumesGet200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(VolumesGet200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<VolumesGet200Response>() {
           @Override
           public void write(JsonWriter out, VolumesGet200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public VolumesGet200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of VolumesGet200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of VolumesGet200Response
   * @throws IOException if the JSON string is invalid with respect to VolumesGet200Response
   */
  public static VolumesGet200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, VolumesGet200Response.class);
  }

  /**
   * Convert an instance of VolumesGet200Response to an JSON string
   *
   * @return JSON string
   */
