...
import org.openapitools.client.model.CreateLoadBalancerRequestLabels;
import org.openapitools.client.model.CreateNetworkRequestSubnetsInner;
...
public class CreateNetworkRequest {
  ...
  private CreateLoadBalancerRequestLabels labels;
  ...
  private List<NetworksGet200ResponseNetworksInnerRoutesInner> routes = new ArrayList<>();

  public static final String SERIALIZED_NAME_SUBNETS = "subnets";
  @SerializedName(SERIALIZED_NAME_SUBNETS)
  private List<CreateNetworkRequestSubnetsInner> subnets = new ArrayList<>();

  public CreateNetworkRequest() {
  }

  public CreateNetworkRequest ipRange(String ipRange) {
  ...
  public CreateNetworkRequest labels(CreateLoadBalancerRequestLabels labels) {
    this.labels = labels;
    return this;
  }
  ...
  public CreateLoadBalancerRequestLabels getLabels() {
    return labels;
  }

  public void setLabels(CreateLoadBalancerRequestLabels labels) {
    this.labels = labels;
  }
  ...
  public CreateNetworkRequest routes(List<NetworksGet200ResponseNetworksInnerRoutesInner> routes) {
    this.routes = routes;
    return this;
  }

  public CreateNetworkRequest addRoutesItem(NetworksGet200ResponseNetworksInnerRoutesInner routesItem) {
    if (this.routes == null) {
   ...
   */
  @javax.annotation.Nullable
  public List<NetworksGet200ResponseNetworksInnerRoutesInner> getRoutes() {
    return routes;
  }

  public void setRoutes(List<NetworksGet200ResponseNetworksInnerRoutesInner> routes) {
    this.routes = routes;
  }


  public CreateNetworkRequest subnets(List<CreateNetworkRequestSubnetsInner> subnets) {
    this.subnets = subnets;
    return this;
  }

  public CreateNetworkRequest addSubnetsItem(CreateNetworkRequestSubnetsInner subnetsItem) {
   ...
   */
  @javax.annotation.Nullable
  public List<CreateNetworkRequestSubnetsInner> getSubnets() {
    return subnets;
  }

  public void setSubnets(List<CreateNetworkRequestSubnetsInner> subnets) {
    this.subnets = subnets;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.ipRange, createNetworkRequest.ipRange) &&
        Objects.equals(this.labels, createNetworkRequest.labels) &&
        Objects.equals(this.name, createNetworkRequest.name) &&
        Objects.equals(this.routes, createNetworkRequest.routes) &&
        Objects.equals(this.subnets, createNetworkRequest.subnets);
  }

  @Override
  public int hashCode() {
    return Objects.hash(ipRange, labels, name, routes, subnets);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("labels") != null && !jsonObj.get("labels").isJsonNull()) {
        CreateLoadBalancerRequestLabels.validateJsonElement(jsonObj.get("labels"));
      }
      ...
      if (jsonObj.get("routes") != null && !jsonObj.get("routes").isJsonNull()) {
        ...
        if (jsonArrayroutes != null) {
          ...
          for (int i = 0; i < jsonArrayroutes.size(); i++) {
            NetworksGet200ResponseNetworksInnerRoutesInner.validateJsonElement(jsonArrayroutes.get(i));
          };
        }
      }
      if (jsonObj.get("subnets") != null && !jsonObj.get("subnets").isJsonNull()) {
        ...
        if (jsonArraysubnets != null) {
          ...
          for (int i = 0; i < jsonArraysubnets.size(); i++) {
            CreateNetworkRequestSubnetsInner.validateJsonElement(jsonArraysubnets.get(i));
          };
        }
      }
  }
