...
public class CreateFirewallRequestApplyToInnerLabelSelector {
  public static final String SERIALIZED_NAME_SELECTOR = "selector";
  @SerializedName(SERIALIZED_NAME_SELECTOR)
  private String selector;

  public CreateFirewallRequestApplyToInnerLabelSelector() {
  }

  public CreateFirewallRequestApplyToInnerLabelSelector selector(String selector) {
  ...
  public boolean equals(Object o) {
    ...
    CreateFirewallRequestApplyToInnerLabelSelector createFirewallRequestApplyToInnerLabelSelector = (CreateFirewallRequestApplyToInnerLabelSelector) o;
    return Objects.equals(this.selector, createFirewallRequestApplyToInnerLabelSelector.selector);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateFirewallRequestApplyToInnerLabelSelector {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateFirewallRequestApplyToInnerLabelSelector
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateFirewallRequestApplyToInnerLabelSelector.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateFirewallRequestApplyToInnerLabelSelector is not found in the empty JSON string", CreateFirewallRequestApplyToInnerLabelSelector.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateFirewallRequestApplyToInnerLabelSelector.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateFirewallRequestApplyToInnerLabelSelector` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CreateFirewallRequestApplyToInnerLabelSelector.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateFirewallRequestApplyToInnerLabelSelector.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateFirewallRequestApplyToInnerLabelSelector' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateFirewallRequestApplyToInnerLabelSelector> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateFirewallRequestApplyToInnerLabelSelector.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateFirewallRequestApplyToInnerLabelSelector>() {
           @Override
           public void write(JsonWriter out, CreateFirewallRequestApplyToInnerLabelSelector value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateFirewallRequestApplyToInnerLabelSelector read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateFirewallRequestApplyToInnerLabelSelector given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateFirewallRequestApplyToInnerLabelSelector
   * @throws IOException if the JSON string is invalid with respect to CreateFirewallRequestApplyToInnerLabelSelector
   */
  public static CreateFirewallRequestApplyToInnerLabelSelector fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateFirewallRequestApplyToInnerLabelSelector.class);
  }

  /**
   * Convert an instance of CreateFirewallRequestApplyToInnerLabelSelector to an JSON string
   *
   * @return JSON string
   */
