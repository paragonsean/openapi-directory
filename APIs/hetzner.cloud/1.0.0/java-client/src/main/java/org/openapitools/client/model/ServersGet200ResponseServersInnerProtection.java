...
public class ServersGet200ResponseServersInnerProtection {
  ...
  public ServersGet200ResponseServersInnerProtection() {
  }

  public ServersGet200ResponseServersInnerProtection delete(Boolean delete) {
    this.delete = delete;
    return this;
  }
  ...
  public ServersGet200ResponseServersInnerProtection rebuild(Boolean rebuild) {
  ...
  public boolean equals(Object o) {
    ...
    ServersGet200ResponseServersInnerProtection serversGet200ResponseServersInnerProtection = (ServersGet200ResponseServersInnerProtection) o;
    return Objects.equals(this.delete, serversGet200ResponseServersInnerProtection.delete) &&
        Objects.equals(this.rebuild, serversGet200ResponseServersInnerProtection.rebuild);
  }

  @Override
  public int hashCode() {
    return Objects.hash(delete, rebuild);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ServersGet200ResponseServersInnerProtection {\n");
  ...
  static {
    ...
    openapiFields.add("rebuild");

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>();
    openapiRequiredFields.add("delete");
    openapiRequiredFields.add("rebuild");
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ServersGet200ResponseServersInnerProtection
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ServersGet200ResponseServersInnerProtection.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ServersGet200ResponseServersInnerProtection is not found in the empty JSON string", ServersGet200ResponseServersInnerProtection.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ServersGet200ResponseServersInnerProtection.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ServersGet200ResponseServersInnerProtection` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ServersGet200ResponseServersInnerProtection.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ServersGet200ResponseServersInnerProtection.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ServersGet200ResponseServersInnerProtection' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ServersGet200ResponseServersInnerProtection> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ServersGet200ResponseServersInnerProtection.class));

       return (TypeAdapter<T>) new TypeAdapter<ServersGet200ResponseServersInnerProtection>() {
           @Override
           public void write(JsonWriter out, ServersGet200ResponseServersInnerProtection value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ServersGet200ResponseServersInnerProtection read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ServersGet200ResponseServersInnerProtection given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ServersGet200ResponseServersInnerProtection
   * @throws IOException if the JSON string is invalid with respect to ServersGet200ResponseServersInnerProtection
   */
  public static ServersGet200ResponseServersInnerProtection fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ServersGet200ResponseServersInnerProtection.class);
  }

  /**
   * Convert an instance of ServersGet200ResponseServersInnerProtection to an JSON string
   *
   * @return JSON string
   */
