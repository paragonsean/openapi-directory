...
|**id** | **BigDecimal** | ID of the Location |  |
|**latitude** | **BigDecimal** | Latitude of the city closest to the Location |  |
|**longitude** | **BigDecimal** | Longitude of the city closest to the Location |  |
