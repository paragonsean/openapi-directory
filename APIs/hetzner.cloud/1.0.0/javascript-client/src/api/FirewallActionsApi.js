...
/**
* FirewallActions service.
* @module api/FirewallActionsApi
* @version 1.0.0
*/
export default class FirewallActionsApi {

    /**
    * Constructs a new FirewallActionsApi. 
    * @alias module:api/FirewallActionsApi
    * @class
    ...
    */
    ...
    /**
     * Callback function to receive the result of the firewallsIdActionsActionIdGet operation.
     * @callback module:api/FirewallActionsApi~firewallsIdActionsActionIdGetCallback
     ...
     * @param {module:api/FirewallActionsApi~firewallsIdActionsActionIdGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/ActionResponse}
     */
    firewallsIdActionsActionIdGet(id, actionId, callback) {
      let postBody = null;
      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling firewallsIdActionsActionIdGet");
      }
      // verify the required parameter 'actionId' is set
      if (actionId === undefined || actionId === null) {
        throw new Error("Missing the required parameter 'actionId' when calling firewallsIdActionsActionIdGet");
      }
    ...
    /**
     * Callback function to receive the result of the firewallsIdActionsApplyToResourcesPost operation.
     * @callback module:api/FirewallActionsApi~firewallsIdActionsApplyToResourcesPostCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:model/ApplyToResourcesRequest} [applyToResourcesRequest] 
     * @param {module:api/FirewallActionsApi~firewallsIdActionsApplyToResourcesPostCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/ActionsResponse}
     */
    firewallsIdActionsApplyToResourcesPost(id, opts, callback) {
      opts = opts || {};
      let postBody = opts['applyToResourcesRequest'];
      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling firewallsIdActionsApplyToResourcesPost");
      }
    ...
    /**
     * Callback function to receive the result of the firewallsIdActionsGet operation.
     * @callback module:api/FirewallActionsApi~firewallsIdActionsGetCallback
     * @param {String} error Error message, if any.
     * @param {module:model/ActionsResponse} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:api/FirewallActionsApi~firewallsIdActionsGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/ActionsResponse}
     */
    firewallsIdActionsGet(id, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling firewallsIdActionsGet");
      }
    ...
    /**
     * Callback function to receive the result of the firewallsIdActionsRemoveFromResourcesPost operation.
     * @callback module:api/FirewallActionsApi~firewallsIdActionsRemoveFromResourcesPostCallback
     * @param {String} error Error message, if any.
     * @param {module:model/ActionsResponse} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Number} id ID of the Firewall
     * @param {Object} opts Optional parameters
     * @param {module:model/RemoveFromResourcesRequest} [removeFromResourcesRequest] 
     * @param {module:api/FirewallActionsApi~firewallsIdActionsRemoveFromResourcesPostCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/ActionsResponse}
     */
    firewallsIdActionsRemoveFromResourcesPost(id, opts, callback) {
      opts = opts || {};
      let postBody = opts['removeFromResourcesRequest'];
      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling firewallsIdActionsRemoveFromResourcesPost");
      }
    ...
    /**
     * Callback function to receive the result of the firewallsIdActionsSetRulesPost operation.
     * @callback module:api/FirewallActionsApi~firewallsIdActionsSetRulesPostCallback
     * @param {String} error Error message, if any.
     * @param {module:model/ActionsResponse} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Number} id ID of the Firewall
     * @param {Object} opts Optional parameters
     * @param {module:model/SetRulesRequest} [setRulesRequest] 
     * @param {module:api/FirewallActionsApi~firewallsIdActionsSetRulesPostCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/ActionsResponse}
     */
    firewallsIdActionsSetRulesPost(id, opts, callback) {
      opts = opts || {};
      let postBody = opts['setRulesRequest'];
      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling firewallsIdActionsSetRulesPost");
      }
