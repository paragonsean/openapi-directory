...
* @module api/VolumeActionsApi
* @version 1.0.0
*/
export default class VolumeActionsApi {

    /**
    * Constructs a new VolumeActionsApi. 
    * @alias module:api/VolumeActionsApi
    * @class
    ...
    */
    ...
    /**
     * Callback function to receive the result of the volumesIdActionsActionIdGet operation.
     * @callback module:api/VolumeActionsApi~volumesIdActionsActionIdGetCallback
     ...
     * @param {module:api/VolumeActionsApi~volumesIdActionsActionIdGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/ActionResponse}
     */
    volumesIdActionsActionIdGet(id, actionId, callback) {
      let postBody = null;
      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling volumesIdActionsActionIdGet");
      }
      // verify the required parameter 'actionId' is set
      if (actionId === undefined || actionId === null) {
        throw new Error("Missing the required parameter 'actionId' when calling volumesIdActionsActionIdGet");
      }
    ...
    /**
     * Callback function to receive the result of the volumesIdActionsAttachPost operation.
     * @callback module:api/VolumeActionsApi~volumesIdActionsAttachPostCallback
     * @param {String} error Error message, if any.
     * @param {module:model/ActionResponse} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:model/AttachVolumeRequest} [attachVolumeRequest] 
     * @param {module:api/VolumeActionsApi~volumesIdActionsAttachPostCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/ActionResponse}
     */
    volumesIdActionsAttachPost(id, opts, callback) {
      opts = opts || {};
      let postBody = opts['attachVolumeRequest'];
      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling volumesIdActionsAttachPost");
      }
    ...
    /**
     * Callback function to receive the result of the volumesIdActionsChangeProtectionPost operation.
     * @callback module:api/VolumeActionsApi~volumesIdActionsChangeProtectionPostCallback
     * @param {String} error Error message, if any.
     * @param {module:model/ActionResponse} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Number} id ID of the Volume
     * @param {Object} opts Optional parameters
     * @param {module:model/VolumesIdActionsChangeProtectionPostRequest} [volumesIdActionsChangeProtectionPostRequest] 
     * @param {module:api/VolumeActionsApi~volumesIdActionsChangeProtectionPostCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/ActionResponse}
     */
    volumesIdActionsChangeProtectionPost(id, opts, callback) {
      opts = opts || {};
      let postBody = opts['volumesIdActionsChangeProtectionPostRequest'];
      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling volumesIdActionsChangeProtectionPost");
      }
    ...
    /**
     * Callback function to receive the result of the volumesIdActionsDetachPost operation.
     * @callback module:api/VolumeActionsApi~volumesIdActionsDetachPostCallback
     * @param {String} error Error message, if any.
     * @param {module:model/ActionResponse} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Number} id ID of the Volume
     * @param {module:api/VolumeActionsApi~volumesIdActionsDetachPostCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/ActionResponse}
     */
    volumesIdActionsDetachPost(id, callback) {
      let postBody = null;
      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling volumesIdActionsDetachPost");
      }
    ...
    /**
     * Callback function to receive the result of the volumesIdActionsGet operation.
     * @callback module:api/VolumeActionsApi~volumesIdActionsGetCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:api/VolumeActionsApi~volumesIdActionsGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/ActionsResponse}
     */
    volumesIdActionsGet(id, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling volumesIdActionsGet");
      }
    ...
    /**
     * Callback function to receive the result of the volumesIdActionsResizePost operation.
     * @callback module:api/VolumeActionsApi~volumesIdActionsResizePostCallback
     * @param {String} error Error message, if any.
     * @param {module:model/ActionResponse} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Number} id ID of the Volume
     * @param {Object} opts Optional parameters
     * @param {module:model/VolumesIdActionsResizePostRequest} [volumesIdActionsResizePostRequest] 
     * @param {module:api/VolumeActionsApi~volumesIdActionsResizePostCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/ActionResponse}
     */
    volumesIdActionsResizePost(id, opts, callback) {
      opts = opts || {};
      let postBody = opts['volumesIdActionsResizePostRequest'];
      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling volumesIdActionsResizePost");
      }
