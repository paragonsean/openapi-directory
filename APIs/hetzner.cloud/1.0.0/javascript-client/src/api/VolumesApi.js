...
export default class VolumesApi {
    ...
    */
     ...
     * @param {module:model/VolumesGet200Response} data The data returned by the service call.
     ...
     * @param {module:model/String} [status] Can be used multiple times. The response will only contain Volumes matching the status.
     ...
     * data is of type: {@link module:model/VolumesGet200Response}
     */
    volumesGet(opts, callback) {
      opts = opts || {};
      let postBody = null;
      ...
      let returnType = VolumesGet200Response;
    ...
    /**
     * Callback function to receive the result of the volumesIdDelete operation.
     * @callback module:api/VolumesApi~volumesIdDeleteCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:api/VolumesApi~volumesIdDeleteCallback} callback The callback function, accepting three arguments: error, data, response
     */
    volumesIdDelete(id, callback) {
      let postBody = null;
      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling volumesIdDelete");
      }
    ...
    /**
     * Callback function to receive the result of the volumesIdGet operation.
     * @callback module:api/VolumesApi~volumesIdGetCallback
     * @param {String} error Error message, if any.
     * @param {module:model/VolumesIdGet200Response} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:api/VolumesApi~volumesIdGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/VolumesIdGet200Response}
     */
    volumesIdGet(id, callback) {
      let postBody = null;
      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling volumesIdGet");
      }
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = VolumesIdGet200Response;
      return this.apiClient.callApi(
        '/volumes/{id}', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
    ...
    /**
     * Callback function to receive the result of the volumesIdPut operation.
     * @callback module:api/VolumesApi~volumesIdPutCallback
     * @param {String} error Error message, if any.
     * @param {module:model/VolumesIdGet200Response} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:api/VolumesApi~volumesIdPutCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/VolumesIdGet200Response}
     */
    volumesIdPut(id, opts, callback) {
      opts = opts || {};
      let postBody = opts['updateVolumeRequest'];
      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling volumesIdPut");
      }
    ...
    /**
     * Callback function to receive the result of the volumesPost operation.
     * @callback module:api/VolumesApi~volumesPostCallback
     * @param {String} error Error message, if any.
     * @param {module:model/VolumesPost201Response} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:api/VolumesApi~volumesPostCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/VolumesPost201Response}
     */
    volumesPost(opts, callback) {
      opts = opts || {};
      let postBody = opts['createVolumeRequest'];
      ...
      let contentTypes = ['application/json'];
      let accepts = ['application/json'];
      let returnType = VolumesPost201Response;
      return this.apiClient.callApi(
        '/volumes', 'POST',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
