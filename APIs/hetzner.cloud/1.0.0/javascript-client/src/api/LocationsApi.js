...
export default class LocationsApi {
    ...
    */
     ...
     * @param {module:model/LocationsGet200Response} data The data returned by the service call.
     ...
     * data is of type: {@link module:model/LocationsGet200Response}
     */
    locationsGet(opts, callback) {
      opts = opts || {};
      let postBody = null;
      ...
      let returnType = LocationsGet200Response;
    ...
    /**
     * Callback function to receive the result of the locationsIdGet operation.
     * @callback module:api/LocationsApi~locationsIdGetCallback
     * @param {String} error Error message, if any.
     * @param {module:model/LocationsIdGet200Response} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:api/LocationsApi~locationsIdGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/LocationsIdGet200Response}
     */
    locationsIdGet(id, callback) {
      let postBody = null;
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = LocationsIdGet200Response;
      return this.apiClient.callApi(
        '/locations/{id}', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
