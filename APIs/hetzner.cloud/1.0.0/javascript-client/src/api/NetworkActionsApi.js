...
/**
* NetworkActions service.
* @module api/NetworkActionsApi
* @version 1.0.0
*/
export default class NetworkActionsApi {

    /**
    * Constructs a new NetworkActionsApi. 
    * @alias module:api/NetworkActionsApi
    * @class
    ...
    */
    ...
    /**
     * Callback function to receive the result of the networksIdActionsActionIdGet operation.
     * @callback module:api/NetworkActionsApi~networksIdActionsActionIdGetCallback
     ...
     * @param {module:api/NetworkActionsApi~networksIdActionsActionIdGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/ActionResponse}
     */
    networksIdActionsActionIdGet(id, actionId, callback) {
      let postBody = null;
      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling networksIdActionsActionIdGet");
      }
      // verify the required parameter 'actionId' is set
      if (actionId === undefined || actionId === null) {
        throw new Error("Missing the required parameter 'actionId' when calling networksIdActionsActionIdGet");
      }
    ...
    /**
     * Callback function to receive the result of the networksIdActionsAddRoutePost operation.
     * @callback module:api/NetworkActionsApi~networksIdActionsAddRoutePostCallback
     * @param {String} error Error message, if any.
     * @param {module:model/ActionResponse} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:model/AddDeleteRouteRequest} [addDeleteRouteRequest] 
     * @param {module:api/NetworkActionsApi~networksIdActionsAddRoutePostCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/ActionResponse}
     */
    networksIdActionsAddRoutePost(id, opts, callback) {
      opts = opts || {};
      let postBody = opts['addDeleteRouteRequest'];
      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling networksIdActionsAddRoutePost");
      }
    ...
    /**
     * Callback function to receive the result of the networksIdActionsAddSubnetPost operation.
     * @callback module:api/NetworkActionsApi~networksIdActionsAddSubnetPostCallback
     * @param {String} error Error message, if any.
     * @param {module:model/ActionResponse} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Number} id ID of the Network
     * @param {Object} opts Optional parameters
     * @param {module:model/AddSubnetRequest} [addSubnetRequest] 
     * @param {module:api/NetworkActionsApi~networksIdActionsAddSubnetPostCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/ActionResponse}
     */
    networksIdActionsAddSubnetPost(id, opts, callback) {
      opts = opts || {};
      let postBody = opts['addSubnetRequest'];
      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling networksIdActionsAddSubnetPost");
      }
    ...
    /**
     * Callback function to receive the result of the networksIdActionsChangeIpRangePost operation.
     * @callback module:api/NetworkActionsApi~networksIdActionsChangeIpRangePostCallback
     * @param {String} error Error message, if any.
     * @param {module:model/ActionResponse} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Number} id ID of the Network
     * @param {Object} opts Optional parameters
     * @param {module:model/ChangeIPRangeRequest} [changeIPRangeRequest] 
     * @param {module:api/NetworkActionsApi~networksIdActionsChangeIpRangePostCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/ActionResponse}
     */
    networksIdActionsChangeIpRangePost(id, opts, callback) {
      opts = opts || {};
      let postBody = opts['changeIPRangeRequest'];
      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling networksIdActionsChangeIpRangePost");
      }
    ...
    /**
     * Callback function to receive the result of the networksIdActionsChangeProtectionPost operation.
     * @callback module:api/NetworkActionsApi~networksIdActionsChangeProtectionPostCallback
     * @param {String} error Error message, if any.
     * @param {module:model/ActionResponse} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Number} id ID of the Network
     * @param {Object} opts Optional parameters
     * @param {module:model/ChangeProtectionRequest1} [changeProtectionRequest1] 
     * @param {module:api/NetworkActionsApi~networksIdActionsChangeProtectionPostCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/ActionResponse}
     */
    networksIdActionsChangeProtectionPost(id, opts, callback) {
      opts = opts || {};
      let postBody = opts['changeProtectionRequest1'];
      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling networksIdActionsChangeProtectionPost");
      }
    ...
    /**
     * Callback function to receive the result of the networksIdActionsDeleteRoutePost operation.
     * @callback module:api/NetworkActionsApi~networksIdActionsDeleteRoutePostCallback
     * @param {String} error Error message, if any.
     * @param {module:model/ActionResponse} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Object} opts Optional parameters
     * @param {module:model/AddDeleteRouteRequest} [addDeleteRouteRequest] 
     * @param {module:api/NetworkActionsApi~networksIdActionsDeleteRoutePostCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/ActionResponse}
     */
    networksIdActionsDeleteRoutePost(id, opts, callback) {
      opts = opts || {};
      let postBody = opts['addDeleteRouteRequest'];
      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling networksIdActionsDeleteRoutePost");
      }
    ...
    /**
     * Callback function to receive the result of the networksIdActionsDeleteSubnetPost operation.
     * @callback module:api/NetworkActionsApi~networksIdActionsDeleteSubnetPostCallback
     * @param {String} error Error message, if any.
     * @param {module:model/ActionResponse} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Number} id ID of the Network
     * @param {Object} opts Optional parameters
     * @param {module:model/DeleteSubnetRequest} [deleteSubnetRequest] 
     * @param {module:api/NetworkActionsApi~networksIdActionsDeleteSubnetPostCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/ActionResponse}
     */
    networksIdActionsDeleteSubnetPost(id, opts, callback) {
      opts = opts || {};
      let postBody = opts['deleteSubnetRequest'];
      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling networksIdActionsDeleteSubnetPost");
      }
    ...
    /**
     * Callback function to receive the result of the networksIdActionsGet operation.
     * @callback module:api/NetworkActionsApi~networksIdActionsGetCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:api/NetworkActionsApi~networksIdActionsGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/ActionsResponse}
     */
    networksIdActionsGet(id, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling networksIdActionsGet");
      }
