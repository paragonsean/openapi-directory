...
export default class ActionsApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the actionsIdGet operation.
     * @callback module:api/ActionsApi~actionsIdGetCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:api/ActionsApi~actionsIdGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/ActionResponse}
     */
    actionsIdGet(id, callback) {
      let postBody = null;
      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling actionsIdGet");
      }
