...
/**
* Datacenters service.
* @module api/DatacentersApi
* @version 1.0.0
*/
export default class DatacentersApi {

    /**
    * Constructs a new DatacentersApi. 
    * @alias module:api/DatacentersApi
    * @class
    ...
    */
    ...
    /**
     * Callback function to receive the result of the datacentersGet operation.
     * @callback module:api/DatacentersApi~datacentersGetCallback
     * @param {String} error Error message, if any.
     * @param {module:model/DatacentersGet200Response} data The data returned by the service call.
     ...
     * @param {module:api/DatacentersApi~datacentersGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/DatacentersGet200Response}
     */
    datacentersGet(opts, callback) {
      opts = opts || {};
      let postBody = null;
      ...
      let returnType = DatacentersGet200Response;
    ...
    /**
     * Callback function to receive the result of the datacentersIdGet operation.
     * @callback module:api/DatacentersApi~datacentersIdGetCallback
     * @param {String} error Error message, if any.
     * @param {module:model/DatacentersIdGet200Response} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:api/DatacentersApi~datacentersIdGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/DatacentersIdGet200Response}
     */
    datacentersIdGet(id, callback) {
      let postBody = null;
      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling datacentersIdGet");
      }
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = DatacentersIdGet200Response;
      return this.apiClient.callApi(
        '/datacenters/{id}', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
