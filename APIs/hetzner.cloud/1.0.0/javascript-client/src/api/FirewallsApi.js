...
export default class FirewallsApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the firewallsGet operation.
     * @callback module:api/FirewallsApi~firewallsGetCallback
     * @param {String} error Error message, if any.
     * @param {module:model/FirewallsResponse} data The data returned by the service call.
     ...
     * @param {module:api/FirewallsApi~firewallsGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/FirewallsResponse}
     */
    firewallsGet(opts, callback) {
      opts = opts || {};
      let postBody = null;
      ...
      let returnType = FirewallsResponse;
    ...
    /**
     * Callback function to receive the result of the firewallsIdDelete operation.
     * @callback module:api/FirewallsApi~firewallsIdDeleteCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:api/FirewallsApi~firewallsIdDeleteCallback} callback The callback function, accepting three arguments: error, data, response
     */
    firewallsIdDelete(id, callback) {
      let postBody = null;
      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling firewallsIdDelete");
      }
    ...
    /**
     * Callback function to receive the result of the firewallsIdGet operation.
     * @callback module:api/FirewallsApi~firewallsIdGetCallback
     * @param {String} error Error message, if any.
     * @param {module:model/FirewallResponse} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Number} id ID of the resource
     * @param {module:api/FirewallsApi~firewallsIdGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/FirewallResponse}
     */
    firewallsIdGet(id, callback) {
      let postBody = null;
      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling firewallsIdGet");
      }
    ...
    /**
     * Callback function to receive the result of the firewallsIdPut operation.
     * @callback module:api/FirewallsApi~firewallsIdPutCallback
     * @param {String} error Error message, if any.
     * @param {module:model/FirewallResponse} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Number} id ID of the resource
     * @param {Object} opts Optional parameters
     * @param {module:model/UpdateFirewallRequest} [updateFirewallRequest] 
     * @param {module:api/FirewallsApi~firewallsIdPutCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/FirewallResponse}
     */
    firewallsIdPut(id, opts, callback) {
      opts = opts || {};
      let postBody = opts['updateFirewallRequest'];
      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling firewallsIdPut");
      }
    ...
    /**
     * Callback function to receive the result of the firewallsPost operation.
     * @callback module:api/FirewallsApi~firewallsPostCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:api/FirewallsApi~firewallsPostCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/CreateFirewallResponse}
     */
    firewallsPost(opts, callback) {
      opts = opts || {};
      let postBody = opts['createFirewallRequest'];
