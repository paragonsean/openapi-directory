...
/**
* PlacementGroups service.
* @module api/PlacementGroupsApi
* @version 1.0.0
*/
export default class PlacementGroupsApi {

    /**
    * Constructs a new PlacementGroupsApi. 
    * @alias module:api/PlacementGroupsApi
    * @class
    ...
    */
    ...
    /**
     * Callback function to receive the result of the placementGroupsGet operation.
     * @callback module:api/PlacementGroupsApi~placementGroupsGetCallback
     * @param {String} error Error message, if any.
     * @param {module:model/PlacementGroupsResponse} data The data returned by the service call.
     ...
     * @param {module:model/String} [type] Can be used multiple times. The response will only contain PlacementGroups matching the type.
     * @param {module:api/PlacementGroupsApi~placementGroupsGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/PlacementGroupsResponse}
     */
    placementGroupsGet(opts, callback) {
      opts = opts || {};
      let postBody = null;
      ...
      let returnType = PlacementGroupsResponse;
    ...
    /**
     * Callback function to receive the result of the placementGroupsIdDelete operation.
     * @callback module:api/PlacementGroupsApi~placementGroupsIdDeleteCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:api/PlacementGroupsApi~placementGroupsIdDeleteCallback} callback The callback function, accepting three arguments: error, data, response
     */
    placementGroupsIdDelete(id, callback) {
      let postBody = null;
      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling placementGroupsIdDelete");
      }
    ...
    /**
     * Callback function to receive the result of the placementGroupsIdGet operation.
     * @callback module:api/PlacementGroupsApi~placementGroupsIdGetCallback
     * @param {String} error Error message, if any.
     * @param {module:model/PlacementGroupResponse} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Number} id ID of the resource
     * @param {module:api/PlacementGroupsApi~placementGroupsIdGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/PlacementGroupResponse}
     */
    placementGroupsIdGet(id, callback) {
      let postBody = null;
      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling placementGroupsIdGet");
      }
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = PlacementGroupResponse;
      return this.apiClient.callApi(
    ...
    /**
     * Callback function to receive the result of the placementGroupsIdPut operation.
     * @callback module:api/PlacementGroupsApi~placementGroupsIdPutCallback
     * @param {String} error Error message, if any.
     * @param {module:model/PlacementGroupResponse} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Number} id ID of the resource
     * @param {Object} opts Optional parameters
     * @param {module:model/UpdatePlacementGroupRequest} [updatePlacementGroupRequest] 
     * @param {module:api/PlacementGroupsApi~placementGroupsIdPutCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/PlacementGroupResponse}
     */
    placementGroupsIdPut(id, opts, callback) {
      opts = opts || {};
      let postBody = opts['updatePlacementGroupRequest'];
      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling placementGroupsIdPut");
      }
    ...
    /**
     * Callback function to receive the result of the placementGroupsPost operation.
     * @callback module:api/PlacementGroupsApi~placementGroupsPostCallback
     * @param {String} error Error message, if any.
     ...
     * @param {Object} opts Optional parameters
     * @param {module:model/CreatePlacementGroupRequest} [createPlacementGroupRequest] 
     * @param {module:api/PlacementGroupsApi~placementGroupsPostCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/CreatePlacementGroupResponse}
     */
    placementGroupsPost(opts, callback) {
      opts = opts || {};
      let postBody = opts['createPlacementGroupRequest'];
      ...
      let contentTypes = ['application/json'];
      let accepts = ['application/json'];
      let returnType = CreatePlacementGroupResponse;
      return this.apiClient.callApi(
