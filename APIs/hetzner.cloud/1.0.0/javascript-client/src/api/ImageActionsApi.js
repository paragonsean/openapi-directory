...
* @version 1.0.0
*/
export default class ImageActionsApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the imagesIdActionsActionIdGet operation.
     * @callback module:api/ImageActionsApi~imagesIdActionsActionIdGetCallback
     ...
     * @param {module:api/ImageActionsApi~imagesIdActionsActionIdGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/ActionResponse}
     */
    imagesIdActionsActionIdGet(id, actionId, callback) {
      let postBody = null;
      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling imagesIdActionsActionIdGet");
      }
      // verify the required parameter 'actionId' is set
      if (actionId === undefined || actionId === null) {
        throw new Error("Missing the required parameter 'actionId' when calling imagesIdActionsActionIdGet");
      }
    ...
    /**
     * Callback function to receive the result of the imagesIdActionsChangeProtectionPost operation.
     * @callback module:api/ImageActionsApi~imagesIdActionsChangeProtectionPostCallback
     * @param {String} error Error message, if any.
     * @param {module:model/ActionResponse} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:model/ImagesIdActionsChangeProtectionPostRequest} [imagesIdActionsChangeProtectionPostRequest] 
     * @param {module:api/ImageActionsApi~imagesIdActionsChangeProtectionPostCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/ActionResponse}
     */
    imagesIdActionsChangeProtectionPost(id, opts, callback) {
      opts = opts || {};
      let postBody = opts['imagesIdActionsChangeProtectionPostRequest'];
      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling imagesIdActionsChangeProtectionPost");
      }
    ...
    /**
     * Callback function to receive the result of the imagesIdActionsGet operation.
     * @callback module:api/ImageActionsApi~imagesIdActionsGetCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:api/ImageActionsApi~imagesIdActionsGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/ActionsResponse}
     */
    imagesIdActionsGet(id, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling imagesIdActionsGet");
      }
