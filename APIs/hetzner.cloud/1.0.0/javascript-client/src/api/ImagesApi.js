...
export default class ImagesApi {
    ...
    */
     ...
     * @param {module:model/ImagesGet200Response} data The data returned by the service call.
     ...
     * @param {module:model/String} [type] Can be used multiple times.
     * @param {module:model/String} [status] Can be used multiple times. The response will only contain Images matching the status.
     * @param {String} [boundTo] Can be used multiple times. Server ID linked to the Image. Only available for Images of type `backup`
     * @param {Boolean} [includeDeprecated] Can be used multiple times.
     ...
     * data is of type: {@link module:model/ImagesGet200Response}
     */
    imagesGet(opts, callback) {
      opts = opts || {};
      let postBody = null;
      ...
      let returnType = ImagesGet200Response;
     ...
     * @param {String} error Error message, if any.
     * @param {module:model/ImagesIdGet200Response} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * data is of type: {@link module:model/ImagesIdGet200Response}
     */
    imagesIdGet(id, callback) {
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = ImagesIdGet200Response;
      return this.apiClient.callApi(
        '/images/{id}', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
    ...
    /**
     * Callback function to receive the result of the imagesIdPut operation.
     * @callback module:api/ImagesApi~imagesIdPutCallback
     * @param {String} error Error message, if any.
     * @param {module:model/ImagesIdGet200Response} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:api/ImagesApi~imagesIdPutCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/ImagesIdGet200Response}
     */
    imagesIdPut(id, opts, callback) {
      opts = opts || {};
      let postBody = opts['updateImageRequest'];
      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling imagesIdPut");
      }
