...
/**
* LoadBalancerTypes service.
* @module api/LoadBalancerTypesApi
* @version 1.0.0
*/
export default class LoadBalancerTypesApi {

    /**
    * Constructs a new LoadBalancerTypesApi. 
    * @alias module:api/LoadBalancerTypesApi
    * @class
    ...
    */
    ...
    /**
     * Callback function to receive the result of the loadBalancerTypesGet operation.
     * @callback module:api/LoadBalancerTypesApi~loadBalancerTypesGetCallback
     * @param {String} error Error message, if any.
     * @param {module:model/LoadBalancerTypesGet200Response} data The data returned by the service call.
     ...
     * @param {module:api/LoadBalancerTypesApi~loadBalancerTypesGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/LoadBalancerTypesGet200Response}
     */
    loadBalancerTypesGet(opts, callback) {
      opts = opts || {};
      let postBody = null;
      ...
      let returnType = LoadBalancerTypesGet200Response;
    ...
    /**
     * Callback function to receive the result of the loadBalancerTypesIdGet operation.
     * @callback module:api/LoadBalancerTypesApi~loadBalancerTypesIdGetCallback
     * @param {String} error Error message, if any.
     * @param {module:model/LoadBalancerTypesIdGet200Response} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:api/LoadBalancerTypesApi~loadBalancerTypesIdGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/LoadBalancerTypesIdGet200Response}
     */
    loadBalancerTypesIdGet(id, callback) {
      let postBody = null;
      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling loadBalancerTypesIdGet");
      }
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = LoadBalancerTypesIdGet200Response;
      return this.apiClient.callApi(
