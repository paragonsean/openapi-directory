...
/**
* PrimaryIPActions service.
* @module api/PrimaryIPActionsApi
* @version 1.0.0
*/
export default class PrimaryIPActionsApi {

    /**
    * Constructs a new PrimaryIPActionsApi. 
    * @alias module:api/PrimaryIPActionsApi
    * @class
    ...
    */
    ...
    /**
     * Callback function to receive the result of the primaryIpsIdActionsAssignPost operation.
     * @callback module:api/PrimaryIPActionsApi~primaryIpsIdActionsAssignPostCallback
     ...
     * @param {module:model/AssignPrimaryIPRequest} [assignPrimaryIPRequest] 
     * @param {module:api/PrimaryIPActionsApi~primaryIpsIdActionsAssignPostCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/ActionResponse}
     */
    primaryIpsIdActionsAssignPost(id, opts, callback) {
      opts = opts || {};
      let postBody = opts['assignPrimaryIPRequest'];
      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling primaryIpsIdActionsAssignPost");
      }
    ...
    /**
     * Callback function to receive the result of the primaryIpsIdActionsChangeDnsPtrPost operation.
     * @callback module:api/PrimaryIPActionsApi~primaryIpsIdActionsChangeDnsPtrPostCallback
     * @param {String} error Error message, if any.
     * @param {module:model/ActionResponse} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Number} id ID of the Primary IP
     * @param {Object} opts Optional parameters
     * @param {module:model/ChangeDNSPTRRequest} [changeDNSPTRRequest] Select the IP address for which to change the DNS entry by passing `ip`. For a Primary IP of type `ipv4` this must exactly match the IP address of the Primary IP. For a Primary IP of type `ipv6` this must be a single IP within the IPv6 /64 range that belongs to this Primary IP. You can add up to 100 IPv6 reverse DNS entries.  The target hostname is set by passing `dns_ptr`. 
     * @param {module:api/PrimaryIPActionsApi~primaryIpsIdActionsChangeDnsPtrPostCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/ActionResponse}
     */
    primaryIpsIdActionsChangeDnsPtrPost(id, opts, callback) {
      opts = opts || {};
      let postBody = opts['changeDNSPTRRequest'];
      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling primaryIpsIdActionsChangeDnsPtrPost");
      }
    ...
    /**
     * Callback function to receive the result of the primaryIpsIdActionsChangeProtectionPost operation.
     * @callback module:api/PrimaryIPActionsApi~primaryIpsIdActionsChangeProtectionPostCallback
     * @param {String} error Error message, if any.
     * @param {module:model/ActionResponse} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Number} id ID of the Primary IP
     * @param {Object} opts Optional parameters
     * @param {module:model/ChangeProtectionRequest2} [changeProtectionRequest2] 
     * @param {module:api/PrimaryIPActionsApi~primaryIpsIdActionsChangeProtectionPostCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/ActionResponse}
     */
    primaryIpsIdActionsChangeProtectionPost(id, opts, callback) {
      opts = opts || {};
      let postBody = opts['changeProtectionRequest2'];
      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling primaryIpsIdActionsChangeProtectionPost");
      }
    ...
    /**
     * Callback function to receive the result of the primaryIpsIdActionsUnassignPost operation.
     * @callback module:api/PrimaryIPActionsApi~primaryIpsIdActionsUnassignPostCallback
     * @param {String} error Error message, if any.
     * @param {module:model/ActionResponse} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Number} id ID of the Primary IP
     * @param {module:api/PrimaryIPActionsApi~primaryIpsIdActionsUnassignPostCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/ActionResponse}
     */
    primaryIpsIdActionsUnassignPost(id, callback) {
      let postBody = null;
      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling primaryIpsIdActionsUnassignPost");
      }
