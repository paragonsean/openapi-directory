...
* @version 1.0.0
*/
export default class FloatingIPActionsApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the floatingIpsIdActionsActionIdGet operation.
     * @callback module:api/FloatingIPActionsApi~floatingIpsIdActionsActionIdGetCallback
     ...
     * @param {module:api/FloatingIPActionsApi~floatingIpsIdActionsActionIdGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/ActionResponse}
     */
    floatingIpsIdActionsActionIdGet(id, actionId, callback) {
      let postBody = null;
      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling floatingIpsIdActionsActionIdGet");
      }
      // verify the required parameter 'actionId' is set
      if (actionId === undefined || actionId === null) {
        throw new Error("Missing the required parameter 'actionId' when calling floatingIpsIdActionsActionIdGet");
      }
    ...
    /**
     * Callback function to receive the result of the floatingIpsIdActionsAssignPost operation.
     * @callback module:api/FloatingIPActionsApi~floatingIpsIdActionsAssignPostCallback
     * @param {String} error Error message, if any.
     * @param {module:model/ActionResponse} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:model/AssignFloatingIPRequest} [assignFloatingIPRequest] 
     * @param {module:api/FloatingIPActionsApi~floatingIpsIdActionsAssignPostCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/ActionResponse}
     */
    floatingIpsIdActionsAssignPost(id, opts, callback) {
      opts = opts || {};
      let postBody = opts['assignFloatingIPRequest'];
      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling floatingIpsIdActionsAssignPost");
      }
    ...
    /**
     * Callback function to receive the result of the floatingIpsIdActionsChangeDnsPtrPost operation.
     * @callback module:api/FloatingIPActionsApi~floatingIpsIdActionsChangeDnsPtrPostCallback
     * @param {String} error Error message, if any.
     * @param {module:model/ActionResponse} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Number} id ID of the Floating IP
     * @param {Object} opts Optional parameters
     * @param {module:model/ChangeDNSPTRRequest} [changeDNSPTRRequest] Select the IP address for which to change the DNS entry by passing `ip`. For a Floating IP of type `ipv4` this must exactly match the IP address of the Floating IP. For a Floating IP of type `ipv6` this must be a single IP within the IPv6 /64 range that belongs to this Floating IP. You can add up to 100 IPv6 reverse DNS entries.  The target hostname is set by passing `dns_ptr`. 
     * @param {module:api/FloatingIPActionsApi~floatingIpsIdActionsChangeDnsPtrPostCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/ActionResponse}
     */
    floatingIpsIdActionsChangeDnsPtrPost(id, opts, callback) {
      opts = opts || {};
      let postBody = opts['changeDNSPTRRequest'];
      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling floatingIpsIdActionsChangeDnsPtrPost");
      }
    ...
    /**
     * Callback function to receive the result of the floatingIpsIdActionsChangeProtectionPost operation.
     * @callback module:api/FloatingIPActionsApi~floatingIpsIdActionsChangeProtectionPostCallback
     * @param {String} error Error message, if any.
     * @param {module:model/ActionResponse} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Number} id ID of the Floating IP
     * @param {Object} opts Optional parameters
     * @param {module:model/ChangeProtectionRequest} [changeProtectionRequest] 
     * @param {module:api/FloatingIPActionsApi~floatingIpsIdActionsChangeProtectionPostCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/ActionResponse}
     */
    floatingIpsIdActionsChangeProtectionPost(id, opts, callback) {
      opts = opts || {};
      let postBody = opts['changeProtectionRequest'];
      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling floatingIpsIdActionsChangeProtectionPost");
      }
    ...
    /**
     * Callback function to receive the result of the floatingIpsIdActionsGet operation.
     * @callback module:api/FloatingIPActionsApi~floatingIpsIdActionsGetCallback
     * @param {String} error Error message, if any.
     * @param {module:model/FloatingIpsIdActionsGet200Response} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:api/FloatingIPActionsApi~floatingIpsIdActionsGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/FloatingIpsIdActionsGet200Response}
     */
    floatingIpsIdActionsGet(id, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling floatingIpsIdActionsGet");
      }
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = FloatingIpsIdActionsGet200Response;
      return this.apiClient.callApi(
    ...
    /**
     * Callback function to receive the result of the floatingIpsIdActionsUnassignPost operation.
     * @callback module:api/FloatingIPActionsApi~floatingIpsIdActionsUnassignPostCallback
     * @param {String} error Error message, if any.
     * @param {module:model/ActionResponse} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Number} id ID of the Floating IP
     * @param {module:api/FloatingIPActionsApi~floatingIpsIdActionsUnassignPostCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/ActionResponse}
     */
    floatingIpsIdActionsUnassignPost(id, callback) {
      let postBody = null;
      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling floatingIpsIdActionsUnassignPost");
      }
