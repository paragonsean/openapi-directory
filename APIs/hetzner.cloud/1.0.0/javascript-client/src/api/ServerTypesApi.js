...
/**
* ServerTypes service.
* @module api/ServerTypesApi
* @version 1.0.0
*/
export default class ServerTypesApi {

    /**
    * Constructs a new ServerTypesApi. 
    * @alias module:api/ServerTypesApi
    * @class
    ...
    */
    ...
    /**
     * Callback function to receive the result of the serverTypesGet operation.
     * @callback module:api/ServerTypesApi~serverTypesGetCallback
     * @param {String} error Error message, if any.
     * @param {module:model/ServerTypesGet200Response} data The data returned by the service call.
     ...
     * @param {module:api/ServerTypesApi~serverTypesGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/ServerTypesGet200Response}
     */
    serverTypesGet(opts, callback) {
      opts = opts || {};
      let postBody = null;
      ...
      let returnType = ServerTypesGet200Response;
    ...
    /**
     * Callback function to receive the result of the serverTypesIdGet operation.
     * @callback module:api/ServerTypesApi~serverTypesIdGetCallback
     * @param {String} error Error message, if any.
     * @param {module:model/ServerTypesIdGet200Response} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:api/ServerTypesApi~serverTypesIdGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/ServerTypesIdGet200Response}
     */
    serverTypesIdGet(id, callback) {
      let postBody = null;
      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling serverTypesIdGet");
      }
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = ServerTypesIdGet200Response;
      return this.apiClient.callApi(
        '/server_types/{id}', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
