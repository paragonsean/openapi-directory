...
export default class NetworksApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the networksGet operation.
     * @callback module:api/NetworksApi~networksGetCallback
     * @param {String} error Error message, if any.
     * @param {module:model/NetworksGet200Response} data The data returned by the service call.
     ...
     * @param {String} [labelSelector] Can be used to filter networks by labels. The response will only contain networks with a matching label selector pattern.
     * @param {module:api/NetworksApi~networksGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/NetworksGet200Response}
     */
    networksGet(opts, callback) {
      opts = opts || {};
      let postBody = null;
      ...
      let returnType = NetworksGet200Response;
    ...
    /**
     * Callback function to receive the result of the networksIdDelete operation.
     * @callback module:api/NetworksApi~networksIdDeleteCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:api/NetworksApi~networksIdDeleteCallback} callback The callback function, accepting three arguments: error, data, response
     */
    networksIdDelete(id, callback) {
      let postBody = null;
      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling networksIdDelete");
      }
    ...
    /**
     * Callback function to receive the result of the networksIdGet operation.
     * @callback module:api/NetworksApi~networksIdGetCallback
     * @param {String} error Error message, if any.
     * @param {module:model/NetworksPost201Response} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Number} id ID of the network
     * @param {module:api/NetworksApi~networksIdGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/NetworksPost201Response}
     */
    networksIdGet(id, callback) {
      let postBody = null;
      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling networksIdGet");
      }
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = NetworksPost201Response;
      return this.apiClient.callApi(
        '/networks/{id}', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
    ...
    /**
     * Callback function to receive the result of the networksIdPut operation.
     * @callback module:api/NetworksApi~networksIdPutCallback
     * @param {String} error Error message, if any.
     * @param {module:model/NetworksPost201Response} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:api/NetworksApi~networksIdPutCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/NetworksPost201Response}
     */
    networksIdPut(id, opts, callback) {
      opts = opts || {};
      let postBody = opts['updateNetworkRequest'];
      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling networksIdPut");
      }
    ...
    /**
     * Callback function to receive the result of the networksPost operation.
     * @callback module:api/NetworksApi~networksPostCallback
     * @param {String} error Error message, if any.
     * @param {module:model/NetworksPost201Response} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:api/NetworksApi~networksPostCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/NetworksPost201Response}
     */
    networksPost(opts, callback) {
      opts = opts || {};
      let postBody = opts['createNetworkRequest'];
