...
/**
* PrimaryIPs service.
* @module api/PrimaryIPsApi
* @version 1.0.0
*/
export default class PrimaryIPsApi {

    /**
    * Constructs a new PrimaryIPsApi. 
    * @alias module:api/PrimaryIPsApi
    * @class
    ...
    */
    ...
    /**
     * Callback function to receive the result of the primaryIpsGet operation.
     * @callback module:api/PrimaryIPsApi~primaryIpsGetCallback
     * @param {String} error Error message, if any.
     * @param {module:model/PrimaryIPsResponse} data The data returned by the service call.
     ...
     * @param {module:api/PrimaryIPsApi~primaryIpsGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/PrimaryIPsResponse}
     */
    primaryIpsGet(opts, callback) {
      opts = opts || {};
      let postBody = null;
      ...
      let returnType = PrimaryIPsResponse;
    ...
    /**
     * Callback function to receive the result of the primaryIpsIdDelete operation.
     * @callback module:api/PrimaryIPsApi~primaryIpsIdDeleteCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:api/PrimaryIPsApi~primaryIpsIdDeleteCallback} callback The callback function, accepting three arguments: error, data, response
     */
    primaryIpsIdDelete(id, callback) {
      let postBody = null;
      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling primaryIpsIdDelete");
      }
    ...
    /**
     * Callback function to receive the result of the primaryIpsIdGet operation.
     * @callback module:api/PrimaryIPsApi~primaryIpsIdGetCallback
     * @param {String} error Error message, if any.
     * @param {module:model/PrimaryIPResponse} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Number} id ID of the resource
     * @param {module:api/PrimaryIPsApi~primaryIpsIdGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/PrimaryIPResponse}
     */
    primaryIpsIdGet(id, callback) {
      let postBody = null;
      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling primaryIpsIdGet");
      }
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = PrimaryIPResponse;
      return this.apiClient.callApi(
        '/primary_ips/{id}', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
    ...
    /**
     * Callback function to receive the result of the primaryIpsIdPut operation.
     * @callback module:api/PrimaryIPsApi~primaryIpsIdPutCallback
     * @param {String} error Error message, if any.
     * @param {module:model/PrimaryIPResponse} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Number} id ID of the resource
     * @param {Object} opts Optional parameters
     * @param {module:model/UpdatePrimaryIPRequest} [updatePrimaryIPRequest] 
     * @param {module:api/PrimaryIPsApi~primaryIpsIdPutCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/PrimaryIPResponse}
     */
    primaryIpsIdPut(id, opts, callback) {
      opts = opts || {};
      let postBody = opts['updatePrimaryIPRequest'];
      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling primaryIpsIdPut");
      }
    ...
    /**
     * Callback function to receive the result of the primaryIpsPost operation.
     * @callback module:api/PrimaryIPsApi~primaryIpsPostCallback
     * @param {String} error Error message, if any.
     * @param {module:model/CreatePrimaryIPResponse} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Object} opts Optional parameters
     * @param {module:model/CreatePrimaryIPRequest} [createPrimaryIPRequest] The `type` argument is required while `datacenter` and `assignee_id` are mutually exclusive.
     * @param {module:api/PrimaryIPsApi~primaryIpsPostCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/CreatePrimaryIPResponse}
     */
    primaryIpsPost(opts, callback) {
      opts = opts || {};
      let postBody = opts['createPrimaryIPRequest'];
      ...
      let contentTypes = ['application/json'];
      let accepts = ['application/json'];
      let returnType = CreatePrimaryIPResponse;
      return this.apiClient.callApi(
        '/primary_ips', 'POST',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
