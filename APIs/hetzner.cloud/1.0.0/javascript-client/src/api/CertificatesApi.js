...
export default class CertificatesApi {
    ...
    */
     ...
     * @param {module:model/String} [type] Can be used multiple times. The response will only contain Certificates matching the type.
    ...
    /**
     * Callback function to receive the result of the certificatesIdDelete operation.
     * @callback module:api/CertificatesApi~certificatesIdDeleteCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:api/CertificatesApi~certificatesIdDeleteCallback} callback The callback function, accepting three arguments: error, data, response
     */
    certificatesIdDelete(id, callback) {
      let postBody = null;
      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling certificatesIdDelete");
      }
     ...
     * @callback module:api/CertificatesApi~certificatesIdGetCallback
     * @param {String} error Error message, if any.
     ...
     * @param {Number} id ID of the resource
     * @param {module:api/CertificatesApi~certificatesIdGetCallback} callback The callback function, accepting three arguments: error, data, response
    ...
    /**
     * Callback function to receive the result of the certificatesIdPut operation.
     * @callback module:api/CertificatesApi~certificatesIdPutCallback
     * @param {String} error Error message, if any.
     * @param {module:model/CertificateResponse} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:api/CertificatesApi~certificatesIdPutCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/CertificateResponse}
     */
    certificatesIdPut(id, opts, callback) {
      opts = opts || {};
      let postBody = opts['updateCertificateRequest'];
      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling certificatesIdPut");
      }
    ...
    /**
     * Callback function to receive the result of the certificatesPost operation.
     * @callback module:api/CertificatesApi~certificatesPostCallback
     * @param {String} error Error message, if any.
     * @param {module:model/CreateCertificateResponse} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:api/CertificatesApi~certificatesPostCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/CreateCertificateResponse}
     */
    certificatesPost(opts, callback) {
      opts = opts || {};
      let postBody = opts['createCertificateRequest'];
      ...
      let contentTypes = ['application/json'];
      let accepts = ['application/json'];
      let returnType = CreateCertificateResponse;
      return this.apiClient.callApi(
        '/certificates', 'POST',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
