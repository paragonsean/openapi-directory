...
* @version 1.0.0
*/
export default class ISOsApi {

    /**
    * Constructs a new ISOsApi. 
    * @alias module:api/ISOsApi
    * @class
    ...
    */
    ...
    /**
     * Callback function to receive the result of the isosGet operation.
     * @callback module:api/ISOsApi~isosGetCallback
     * @param {String} error Error message, if any.
     * @param {module:model/IsosGet200Response} data The data returned by the service call.
     ...
     * @param {Boolean} [includeArchitectureWildcard] Include Images with wildcard architecture (architecture is null). Works only if architecture filter is specified.
     * @param {module:api/ISOsApi~isosGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/IsosGet200Response}
     */
    isosGet(opts, callback) {
      opts = opts || {};
      let postBody = null;
      ...
      let queryParams = {
        ...
        'include_architecture_wildcard': opts['includeArchitectureWildcard']
      };
      let headerParams = {
      };
      let formParams = {
      ...
      let returnType = IsosGet200Response;
    ...
    /**
     * Callback function to receive the result of the isosIdGet operation.
     * @callback module:api/ISOsApi~isosIdGetCallback
     * @param {String} error Error message, if any.
     * @param {module:model/IsosIdGet200Response} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:api/ISOsApi~isosIdGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/IsosIdGet200Response}
     */
    isosIdGet(id, callback) {
      let postBody = null;
      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling isosIdGet");
      }
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = IsosIdGet200Response;
      return this.apiClient.callApi(
        '/isos/{id}', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
