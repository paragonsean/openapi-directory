...
export default class FloatingIPsApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the floatingIpsGet operation.
     * @callback module:api/FloatingIPsApi~floatingIpsGetCallback
     * @param {String} error Error message, if any.
     * @param {module:model/FloatingIpsGet200Response} data The data returned by the service call.
     ...
     * @param {String} [labelSelector] Can be used to filter Floating IPs by labels. The response will only contain Floating IPs matching the label selector.
     * @param {module:model/String} [sort] Can be used multiple times. Choices id id:asc id:desc created created:asc created:desc
     * @param {module:api/FloatingIPsApi~floatingIpsGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/FloatingIpsGet200Response}
     */
    floatingIpsGet(opts, callback) {
      opts = opts || {};
      let postBody = null;
      ...
      let returnType = FloatingIpsGet200Response;
    ...
    /**
     * Callback function to receive the result of the floatingIpsIdDelete operation.
     * @callback module:api/FloatingIPsApi~floatingIpsIdDeleteCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:api/FloatingIPsApi~floatingIpsIdDeleteCallback} callback The callback function, accepting three arguments: error, data, response
     */
    floatingIpsIdDelete(id, callback) {
      let postBody = null;
      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling floatingIpsIdDelete");
      }
    ...
    /**
     * Callback function to receive the result of the floatingIpsIdGet operation.
     * @callback module:api/FloatingIPsApi~floatingIpsIdGetCallback
     * @param {String} error Error message, if any.
     * @param {module:model/FloatingIpsIdGet200Response} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Number} id ID of the Floating IP
     * @param {module:api/FloatingIPsApi~floatingIpsIdGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/FloatingIpsIdGet200Response}
     */
    floatingIpsIdGet(id, callback) {
      let postBody = null;
      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling floatingIpsIdGet");
      }
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = FloatingIpsIdGet200Response;
      return this.apiClient.callApi(
        '/floating_ips/{id}', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
    ...
    /**
     * Callback function to receive the result of the floatingIpsIdPut operation.
     * @callback module:api/FloatingIPsApi~floatingIpsIdPutCallback
     * @param {String} error Error message, if any.
     * @param {module:model/FloatingIpsIdGet200Response} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Number} id ID of the Floating IP
     * @param {Object} opts Optional parameters
     * @param {module:model/UpdateFloatingIPRequest} [updateFloatingIPRequest] 
     * @param {module:api/FloatingIPsApi~floatingIpsIdPutCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/FloatingIpsIdGet200Response}
     */
    floatingIpsIdPut(id, opts, callback) {
      opts = opts || {};
      let postBody = opts['updateFloatingIPRequest'];
      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling floatingIpsIdPut");
      }
    ...
    /**
     * Callback function to receive the result of the floatingIpsPost operation.
     * @callback module:api/FloatingIPsApi~floatingIpsPostCallback
     * @param {String} error Error message, if any.
     * @param {module:model/FloatingIpsPost201Response} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Object} opts Optional parameters
     * @param {module:model/CreateFloatingIPRequest} [createFloatingIPRequest] The `type` argument is required while `home_location` and `server` are mutually exclusive.
     * @param {module:api/FloatingIPsApi~floatingIpsPostCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/FloatingIpsPost201Response}
     */
    floatingIpsPost(opts, callback) {
      opts = opts || {};
      let postBody = opts['createFloatingIPRequest'];
      ...
      let contentTypes = ['application/json'];
      let accepts = ['application/json'];
      let returnType = FloatingIpsPost201Response;
      return this.apiClient.callApi(
        '/floating_ips', 'POST',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
