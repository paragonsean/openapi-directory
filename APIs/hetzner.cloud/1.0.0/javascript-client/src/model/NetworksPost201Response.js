...
/**
 * The NetworksPost201Response model module.
 * @module model/NetworksPost201Response
 * @version 1.0.0
 */
class NetworksPost201Response {
    /**
     * Constructs a new <code>NetworksPost201Response</code>.
     * @alias module:model/NetworksPost201Response
     */
    constructor() { 
        
        NetworksPost201Response.initialize(this);
    }
    ...
    /**
     * Constructs a <code>NetworksPost201Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/NetworksPost201Response} obj Optional instance to populate.
     * @return {module:model/NetworksPost201Response} The populated <code>NetworksPost201Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new NetworksPost201Response();

            if (data.hasOwnProperty('network')) {
                obj['network'] = NetworksGet200ResponseNetworksInner.constructFromObject(data['network']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>NetworksPost201Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>NetworksPost201Response</code>.
     */
    static validateJSON(data) {
        // validate the optional field `network`
        if (data['network']) { // data not null
          NetworksGet200ResponseNetworksInner.validateJSON(data['network']);
        }
...
/**
 * @member {module:model/NetworksGet200ResponseNetworksInner} network
 */
NetworksPost201Response.prototype['network'] = undefined;
...
export default NetworksPost201Response;
