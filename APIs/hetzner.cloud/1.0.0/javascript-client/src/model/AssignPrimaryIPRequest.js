...
/**
 * The AssignPrimaryIPRequest model module.
 * @module model/AssignPrimaryIPRequest
 * @version 1.0.0
 */
class AssignPrimaryIPRequest {
    /**
     * Constructs a new <code>AssignPrimaryIPRequest</code>.
     * @alias module:model/AssignPrimaryIPRequest
     * @param assigneeId {Number} ID of a resource of type `assignee_type`
     * @param assigneeType {module:model/AssignPrimaryIPRequest.AssigneeTypeEnum} Type of resource assigning the Primary IP to
     */
    constructor(assigneeId, assigneeType) { 
        
        AssignPrimaryIPRequest.initialize(this, assigneeId, assigneeType);
    }
     ...
     */
    static initialize(obj, assigneeId, assigneeType) { 
        obj['assignee_id'] = assigneeId;
        obj['assignee_type'] = assigneeType;
    }

    /**
     * Constructs a <code>AssignPrimaryIPRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AssignPrimaryIPRequest} obj Optional instance to populate.
     * @return {module:model/AssignPrimaryIPRequest} The populated <code>AssignPrimaryIPRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AssignPrimaryIPRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>AssignPrimaryIPRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AssignPrimaryIPRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of AssignPrimaryIPRequest.RequiredProperties) {
...
AssignPrimaryIPRequest.RequiredProperties = ["assignee_id", "assignee_type"];

/**
 * ID of a resource of type `assignee_type`
 * @member {Number} assignee_id
 */
AssignPrimaryIPRequest.prototype['assignee_id'] = undefined;

/**
 * Type of resource assigning the Primary IP to
 * @member {module:model/AssignPrimaryIPRequest.AssigneeTypeEnum} assignee_type
 */
AssignPrimaryIPRequest.prototype['assignee_type'] = undefined;
 ...
 * @readonly
 */
AssignPrimaryIPRequest['AssigneeTypeEnum'] = {
...
export default AssignPrimaryIPRequest;
