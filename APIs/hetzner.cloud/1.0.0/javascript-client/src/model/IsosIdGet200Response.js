...
/**
 * The IsosIdGet200Response model module.
 * @module model/IsosIdGet200Response
 * @version 1.0.0
 */
class IsosIdGet200Response {
    /**
     * Constructs a new <code>IsosIdGet200Response</code>.
     * @alias module:model/IsosIdGet200Response
     * @param iso {module:model/IsosGet200ResponseIsosInner} 
     */
    constructor(iso) { 
        
        IsosIdGet200Response.initialize(this, iso);
    }
    ...
    /**
     * Constructs a <code>IsosIdGet200Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/IsosIdGet200Response} obj Optional instance to populate.
     * @return {module:model/IsosIdGet200Response} The populated <code>IsosIdGet200Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new IsosIdGet200Response();

            if (data.hasOwnProperty('iso')) {
                obj['iso'] = IsosGet200ResponseIsosInner.constructFromObject(data['iso']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>IsosIdGet200Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>IsosIdGet200Response</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of IsosIdGet200Response.RequiredProperties) {
        ...
        if (data['iso']) { // data not null
          IsosGet200ResponseIsosInner.validateJSON(data['iso']);
        }
...
IsosIdGet200Response.RequiredProperties = ["iso"];

/**
 * @member {module:model/IsosGet200ResponseIsosInner} iso
 */
IsosIdGet200Response.prototype['iso'] = undefined;
...
export default IsosIdGet200Response;
