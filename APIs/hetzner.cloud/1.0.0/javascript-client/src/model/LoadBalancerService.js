...
import LoadBalancerServiceHTTP from './LoadBalancerServiceHTTP';
import LoadBalancerServiceHealthCheck from './LoadBalancerServiceHealthCheck';

/**
 * The LoadBalancerService model module.
 * @module model/LoadBalancerService
 * @version 1.0.0
 */
class LoadBalancerService {
    /**
     * Constructs a new <code>LoadBalancerService</code>.
     * @alias module:model/LoadBalancerService
     * @param destinationPort {Number} Port the Load Balancer will balance to
     * @param healthCheck {module:model/LoadBalancerServiceHealthCheck} 
     * @param listenPort {Number} Port the Load Balancer listens on
     * @param protocol {module:model/LoadBalancerService.ProtocolEnum} Protocol of the Load Balancer
     * @param proxyprotocol {Boolean} Is Proxyprotocol enabled or not
     */
    constructor(destinationPort, healthCheck, listenPort, protocol, proxyprotocol) { 
        
        LoadBalancerService.initialize(this, destinationPort, healthCheck, listenPort, protocol, proxyprotocol);
    }
     ...
     */
    static initialize(obj, destinationPort, healthCheck, listenPort, protocol, proxyprotocol) { 
        obj['destination_port'] = destinationPort;
        obj['health_check'] = healthCheck;
        obj['listen_port'] = listenPort;
        obj['protocol'] = protocol;
        obj['proxyprotocol'] = proxyprotocol;
    }

    /**
     * Constructs a <code>LoadBalancerService</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/LoadBalancerService} obj Optional instance to populate.
     * @return {module:model/LoadBalancerService} The populated <code>LoadBalancerService</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new LoadBalancerService();
            ...
            if (data.hasOwnProperty('health_check')) {
                obj['health_check'] = LoadBalancerServiceHealthCheck.constructFromObject(data['health_check']);
            }
            if (data.hasOwnProperty('http')) {
                obj['http'] = LoadBalancerServiceHTTP.constructFromObject(data['http']);
            }
            if (data.hasOwnProperty('listen_port')) {
                obj['listen_port'] = ApiClient.convertToType(data['listen_port'], 'Number');
            }
            if (data.hasOwnProperty('protocol')) {
                obj['protocol'] = ApiClient.convertToType(data['protocol'], 'String');
            }
            if (data.hasOwnProperty('proxyprotocol')) {
                obj['proxyprotocol'] = ApiClient.convertToType(data['proxyprotocol'], 'Boolean');
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>LoadBalancerService</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>LoadBalancerService</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of LoadBalancerService.RequiredProperties) {
            if (!data.hasOwnProperty(property)) {
                throw new Error("The required field `" + property + "` is not found in the JSON data: " + JSON.stringify(data));
            }
        }
        // validate the optional field `health_check`
        if (data['health_check']) { // data not null
          LoadBalancerServiceHealthCheck.validateJSON(data['health_check']);
        }
        // validate the optional field `http`
        if (data['http']) { // data not null
          LoadBalancerServiceHTTP.validateJSON(data['http']);
        }
...
LoadBalancerService.RequiredProperties = ["destination_port", "health_check", "listen_port", "protocol", "proxyprotocol"];

/**
 * Port the Load Balancer will balance to
 * @member {Number} destination_port
 */
LoadBalancerService.prototype['destination_port'] = undefined;

/**
 * @member {module:model/LoadBalancerServiceHealthCheck} health_check
 */
LoadBalancerService.prototype['health_check'] = undefined;

/**
 * @member {module:model/LoadBalancerServiceHTTP} http
 */
LoadBalancerService.prototype['http'] = undefined;

/**
 * Port the Load Balancer listens on
 * @member {Number} listen_port
 */
LoadBalancerService.prototype['listen_port'] = undefined;

/**
 * Protocol of the Load Balancer
 * @member {module:model/LoadBalancerService.ProtocolEnum} protocol
 */
LoadBalancerService.prototype['protocol'] = undefined;

/**
 * Is Proxyprotocol enabled or not
 * @member {Boolean} proxyprotocol
 */
LoadBalancerService.prototype['proxyprotocol'] = undefined;
