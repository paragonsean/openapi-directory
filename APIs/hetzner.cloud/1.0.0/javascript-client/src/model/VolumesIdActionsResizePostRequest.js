...
/**
 * The VolumesIdActionsResizePostRequest model module.
 * @module model/VolumesIdActionsResizePostRequest
 * @version 1.0.0
 */
class VolumesIdActionsResizePostRequest {
    /**
     * Constructs a new <code>VolumesIdActionsResizePostRequest</code>.
     * @alias module:model/VolumesIdActionsResizePostRequest
     * @param size {Number} New Volume size in GB (must be greater than current size)
     */
    constructor(size) { 
        
        VolumesIdActionsResizePostRequest.initialize(this, size);
    }
    ...
    /**
     * Constructs a <code>VolumesIdActionsResizePostRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/VolumesIdActionsResizePostRequest} obj Optional instance to populate.
     * @return {module:model/VolumesIdActionsResizePostRequest} The populated <code>VolumesIdActionsResizePostRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new VolumesIdActionsResizePostRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>VolumesIdActionsResizePostRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>VolumesIdActionsResizePostRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of VolumesIdActionsResizePostRequest.RequiredProperties) {
...
VolumesIdActionsResizePostRequest.RequiredProperties = ["size"];

/**
 * New Volume size in GB (must be greater than current size)
 * @member {Number} size
 */
VolumesIdActionsResizePostRequest.prototype['size'] = undefined;
...
export default VolumesIdActionsResizePostRequest;
