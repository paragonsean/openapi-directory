...
/**
 * The AddDeleteRouteRequest model module.
 * @module model/AddDeleteRouteRequest
 * @version 1.0.0
 */
class AddDeleteRouteRequest {
    /**
     * Constructs a new <code>AddDeleteRouteRequest</code>.
     * @alias module:model/AddDeleteRouteRequest
     ...
     * @param gateway {String} Gateway for the route. Cannot be the first IP of the networks ip_range, an IP behind a vSwitch or 172.31.1.1, as this IP is being used as a gateway for the public network interface of Servers.
     */
    constructor(destination, gateway) { 
        
        AddDeleteRouteRequest.initialize(this, destination, gateway);
    }
    ...
    /**
     * Constructs a <code>AddDeleteRouteRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AddDeleteRouteRequest} obj Optional instance to populate.
     * @return {module:model/AddDeleteRouteRequest} The populated <code>AddDeleteRouteRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AddDeleteRouteRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>AddDeleteRouteRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AddDeleteRouteRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of AddDeleteRouteRequest.RequiredProperties) {
...
AddDeleteRouteRequest.RequiredProperties = ["destination", "gateway"];
 ...
 */
AddDeleteRouteRequest.prototype['destination'] = undefined;
 ...
 */
AddDeleteRouteRequest.prototype['gateway'] = undefined;
...
export default AddDeleteRouteRequest;
