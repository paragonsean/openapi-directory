...
import ActionResourcesInner from './ActionResourcesInner';
...
class Action {
     ...
     * @param command {String} Command executed in the Action
     * @param error {module:model/ActionError} 
     * @param finished {String} Point in time when the Action was finished (in ISO-8601 format). Only set if the Action is finished otherwise null.
     * @param id {Number} ID of the Resource
     * @param progress {Number} Progress of Action in percent
     * @param resources {Array.<module:model/ActionResourcesInner>} Resources the Action relates to
     * @param started {String} Point in time when the Action was started (in ISO-8601 format)
     * @param status {module:model/Action.StatusEnum} Status of the Action
     */
    constructor(command, error, finished, id, progress, resources, started, status) { 
        
        Action.initialize(this, command, error, finished, id, progress, resources, started, status);
    }
     ...
     */
    static initialize(obj, command, error, finished, id, progress, resources, started, status) { 
        obj['command'] = command;
        obj['error'] = error;
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('error')) {
                obj['error'] = ActionError.constructFromObject(data['error']);
            }
            ...
            if (data.hasOwnProperty('resources')) {
                obj['resources'] = ApiClient.convertToType(data['resources'], [ActionResourcesInner]);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['error']) { // data not null
          ActionError.validateJSON(data['error']);
        }
        // ensure the json data is a string
        ...
        if (data['resources']) { // data not null
            ...
            for (const item of data['resources']) {
                ActionResourcesInner.validateJSON(item);
            };
        }
        // ensure the json data is a string
...
Action.RequiredProperties = ["command", "error", "finished", "id", "progress", "resources", "started", "status"];

/**
 * Command executed in the Action
 * @member {String} command
 */
Action.prototype['command'] = undefined;

/**
 * @member {module:model/ActionError} error
 */
Action.prototype['error'] = undefined;

/**
 * Point in time when the Action was finished (in ISO-8601 format). Only set if the Action is finished otherwise null.
 * @member {String} finished
 */
Action.prototype['finished'] = undefined;
 ...
 */
Action.prototype['progress'] = undefined;

/**
 * Resources the Action relates to
 * @member {Array.<module:model/ActionResourcesInner>} resources
 */
Action.prototype['resources'] = undefined;

/**
 * Point in time when the Action was started (in ISO-8601 format)
 * @member {String} started
 */
Action.prototype['started'] = undefined;
