...
class FirewallResponse {
    /**
     * Constructs a new <code>FirewallResponse</code>.
     * @alias module:model/FirewallResponse
     * @param firewall {module:model/Firewall} 
     */
    constructor(firewall) { 
        
        FirewallResponse.initialize(this, firewall);
    }
    ...
    /**
     * Constructs a <code>FirewallResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/FirewallResponse} obj Optional instance to populate.
     * @return {module:model/FirewallResponse} The populated <code>FirewallResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new FirewallResponse();

            if (data.hasOwnProperty('firewall')) {
                obj['firewall'] = Firewall.constructFromObject(data['firewall']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>FirewallResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>FirewallResponse</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of FirewallResponse.RequiredProperties) {
        ...
        if (data['firewall']) { // data not null
          Firewall.validateJSON(data['firewall']);
        }
...
FirewallResponse.RequiredProperties = ["firewall"];

/**
 * @member {module:model/Firewall} firewall
 */
FirewallResponse.prototype['firewall'] = undefined;
...
export default FirewallResponse;
