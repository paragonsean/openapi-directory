...
/**
 * The FirewallApplyToResourcesServer model module.
 * @module model/FirewallApplyToResourcesServer
 * @version 1.0.0
 */
class FirewallApplyToResourcesServer {
    /**
     * Constructs a new <code>FirewallApplyToResourcesServer</code>.
     * Configuration for type server, required if type is &#x60;server&#x60;
     * @alias module:model/FirewallApplyToResourcesServer
     * @param id {Number} ID of the Server
     */
    constructor(id) { 
        
        FirewallApplyToResourcesServer.initialize(this, id);
    }
    ...
    /**
     * Constructs a <code>FirewallApplyToResourcesServer</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/FirewallApplyToResourcesServer} obj Optional instance to populate.
     * @return {module:model/FirewallApplyToResourcesServer} The populated <code>FirewallApplyToResourcesServer</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new FirewallApplyToResourcesServer();
    ...
    /**
     * Validates the JSON data with respect to <code>FirewallApplyToResourcesServer</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>FirewallApplyToResourcesServer</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of FirewallApplyToResourcesServer.RequiredProperties) {
...
FirewallApplyToResourcesServer.RequiredProperties = ["id"];

/**
 * ID of the Server
 * @member {Number} id
 */
FirewallApplyToResourcesServer.prototype['id'] = undefined;
...
export default FirewallApplyToResourcesServer;
