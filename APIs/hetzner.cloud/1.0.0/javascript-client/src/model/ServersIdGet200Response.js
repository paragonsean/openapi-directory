...
/**
 * The ServersIdGet200Response model module.
 * @module model/ServersIdGet200Response
 * @version 1.0.0
 */
class ServersIdGet200Response {
    /**
     * Constructs a new <code>ServersIdGet200Response</code>.
     * @alias module:model/ServersIdGet200Response
     */
    constructor() { 
        
        ServersIdGet200Response.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ServersIdGet200Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ServersIdGet200Response} obj Optional instance to populate.
     * @return {module:model/ServersIdGet200Response} The populated <code>ServersIdGet200Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ServersIdGet200Response();
    ...
    /**
     * Validates the JSON data with respect to <code>ServersIdGet200Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ServersIdGet200Response</code>.
     */
 ...
 */
ServersIdGet200Response.prototype['server'] = undefined;
...
export default ServersIdGet200Response;
