...
import ActionsResponseMeta from './ActionsResponseMeta';
import LoadBalancersGet200ResponseLoadBalancersInner from './LoadBalancersGet200ResponseLoadBalancersInner';

/**
 * The LoadBalancersGet200Response model module.
 * @module model/LoadBalancersGet200Response
 * @version 1.0.0
 */
class LoadBalancersGet200Response {
    /**
     * Constructs a new <code>LoadBalancersGet200Response</code>.
     * @alias module:model/LoadBalancersGet200Response
     * @param loadBalancers {Array.<module:model/LoadBalancersGet200ResponseLoadBalancersInner>} 
     */
    constructor(loadBalancers) { 
        
        LoadBalancersGet200Response.initialize(this, loadBalancers);
    }
     ...
     */
    static initialize(obj, loadBalancers) { 
        obj['load_balancers'] = loadBalancers;
    }

    /**
     * Constructs a <code>LoadBalancersGet200Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/LoadBalancersGet200Response} obj Optional instance to populate.
     * @return {module:model/LoadBalancersGet200Response} The populated <code>LoadBalancersGet200Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new LoadBalancersGet200Response();

            if (data.hasOwnProperty('load_balancers')) {
                obj['load_balancers'] = ApiClient.convertToType(data['load_balancers'], [LoadBalancersGet200ResponseLoadBalancersInner]);
            }
            if (data.hasOwnProperty('meta')) {
                obj['meta'] = ActionsResponseMeta.constructFromObject(data['meta']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>LoadBalancersGet200Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>LoadBalancersGet200Response</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of LoadBalancersGet200Response.RequiredProperties) {
            if (!data.hasOwnProperty(property)) {
                throw new Error("The required field `" + property + "` is not found in the JSON data: " + JSON.stringify(data));
            }
        }
        if (data['load_balancers']) { // data not null
            ...
            // validate the optional field `load_balancers` (array)
            for (const item of data['load_balancers']) {
                LoadBalancersGet200ResponseLoadBalancersInner.validateJSON(item);
            };
        }
        // validate the optional field `meta`
        if (data['meta']) { // data not null
          ActionsResponseMeta.validateJSON(data['meta']);
        }
...
LoadBalancersGet200Response.RequiredProperties = ["load_balancers"];

/**
 * @member {Array.<module:model/LoadBalancersGet200ResponseLoadBalancersInner>} load_balancers
 */
LoadBalancersGet200Response.prototype['load_balancers'] = undefined;

/**
 * @member {module:model/ActionsResponseMeta} meta
 */
LoadBalancersGet200Response.prototype['meta'] = undefined;
...
export default LoadBalancersGet200Response;
