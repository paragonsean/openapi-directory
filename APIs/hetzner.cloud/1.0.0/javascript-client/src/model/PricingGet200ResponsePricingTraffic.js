...
import PricingGet200ResponsePricingFloatingIpPriceMonthly from './PricingGet200ResponsePricingFloatingIpPriceMonthly';

/**
 * The PricingGet200ResponsePricingTraffic model module.
 * @module model/PricingGet200ResponsePricingTraffic
 * @version 1.0.0
 */
class PricingGet200ResponsePricingTraffic {
    /**
     * Constructs a new <code>PricingGet200ResponsePricingTraffic</code>.
     * The cost of additional traffic per TB
     * @alias module:model/PricingGet200ResponsePricingTraffic
     * @param pricePerTb {module:model/PricingGet200ResponsePricingFloatingIpPriceMonthly} 
     */
    constructor(pricePerTb) { 
        
        PricingGet200ResponsePricingTraffic.initialize(this, pricePerTb);
    }
     ...
     */
    static initialize(obj, pricePerTb) { 
        obj['price_per_tb'] = pricePerTb;
    }

    /**
     * Constructs a <code>PricingGet200ResponsePricingTraffic</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PricingGet200ResponsePricingTraffic} obj Optional instance to populate.
     * @return {module:model/PricingGet200ResponsePricingTraffic} The populated <code>PricingGet200ResponsePricingTraffic</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PricingGet200ResponsePricingTraffic();

            if (data.hasOwnProperty('price_per_tb')) {
                obj['price_per_tb'] = PricingGet200ResponsePricingFloatingIpPriceMonthly.constructFromObject(data['price_per_tb']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>PricingGet200ResponsePricingTraffic</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PricingGet200ResponsePricingTraffic</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of PricingGet200ResponsePricingTraffic.RequiredProperties) {
            if (!data.hasOwnProperty(property)) {
                throw new Error("The required field `" + property + "` is not found in the JSON data: " + JSON.stringify(data));
            }
        }
        // validate the optional field `price_per_tb`
        if (data['price_per_tb']) { // data not null
          PricingGet200ResponsePricingFloatingIpPriceMonthly.validateJSON(data['price_per_tb']);
        }
...
PricingGet200ResponsePricingTraffic.RequiredProperties = ["price_per_tb"];

/**
 * @member {module:model/PricingGet200ResponsePricingFloatingIpPriceMonthly} price_per_tb
 */
PricingGet200ResponsePricingTraffic.prototype['price_per_tb'] = undefined;
...
export default PricingGet200ResponsePricingTraffic;
