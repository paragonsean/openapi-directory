...
/**
 * The LoadBalancersGet200ResponseLoadBalancersInnerPublicNetIpv6 model module.
 * @module model/LoadBalancersGet200ResponseLoadBalancersInnerPublicNetIpv6
 * @version 1.0.0
 */
class LoadBalancersGet200ResponseLoadBalancersInnerPublicNetIpv6 {
    /**
     * Constructs a new <code>LoadBalancersGet200ResponseLoadBalancersInnerPublicNetIpv6</code>.
     * IP address (v6)
     * @alias module:model/LoadBalancersGet200ResponseLoadBalancersInnerPublicNetIpv6
     */
    constructor() { 
        
        LoadBalancersGet200ResponseLoadBalancersInnerPublicNetIpv6.initialize(this);
    }
    ...
    /**
     * Constructs a <code>LoadBalancersGet200ResponseLoadBalancersInnerPublicNetIpv6</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/LoadBalancersGet200ResponseLoadBalancersInnerPublicNetIpv6} obj Optional instance to populate.
     * @return {module:model/LoadBalancersGet200ResponseLoadBalancersInnerPublicNetIpv6} The populated <code>LoadBalancersGet200ResponseLoadBalancersInnerPublicNetIpv6</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new LoadBalancersGet200ResponseLoadBalancersInnerPublicNetIpv6();
    ...
    /**
     * Validates the JSON data with respect to <code>LoadBalancersGet200ResponseLoadBalancersInnerPublicNetIpv6</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>LoadBalancersGet200ResponseLoadBalancersInnerPublicNetIpv6</code>.
     */
 ...
 */
LoadBalancersGet200ResponseLoadBalancersInnerPublicNetIpv6.prototype['dns_ptr'] = undefined;

/**
 * IP address (v6) of this Load Balancer
 * @member {String} ip
 */
LoadBalancersGet200ResponseLoadBalancersInnerPublicNetIpv6.prototype['ip'] = undefined;
...
export default LoadBalancersGet200ResponseLoadBalancersInnerPublicNetIpv6;
