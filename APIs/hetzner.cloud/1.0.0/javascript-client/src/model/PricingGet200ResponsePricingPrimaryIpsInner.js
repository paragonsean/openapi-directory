...
import PricingGet200ResponsePricingPrimaryIpsInnerPricesInner from './PricingGet200ResponsePricingPrimaryIpsInnerPricesInner';

/**
 * The PricingGet200ResponsePricingPrimaryIpsInner model module.
 * @module model/PricingGet200ResponsePricingPrimaryIpsInner
 * @version 1.0.0
 */
class PricingGet200ResponsePricingPrimaryIpsInner {
    /**
     * Constructs a new <code>PricingGet200ResponsePricingPrimaryIpsInner</code>.
     * @alias module:model/PricingGet200ResponsePricingPrimaryIpsInner
     * @param prices {Array.<module:model/PricingGet200ResponsePricingPrimaryIpsInnerPricesInner>} Primary IP type costs per Location
     * @param type {module:model/PricingGet200ResponsePricingPrimaryIpsInner.TypeEnum} The type of the Primary IP
     */
    constructor(prices, type) { 
        
        PricingGet200ResponsePricingPrimaryIpsInner.initialize(this, prices, type);
    }
    ...
    /**
     * Constructs a <code>PricingGet200ResponsePricingPrimaryIpsInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PricingGet200ResponsePricingPrimaryIpsInner} obj Optional instance to populate.
     * @return {module:model/PricingGet200ResponsePricingPrimaryIpsInner} The populated <code>PricingGet200ResponsePricingPrimaryIpsInner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PricingGet200ResponsePricingPrimaryIpsInner();

            if (data.hasOwnProperty('prices')) {
                obj['prices'] = ApiClient.convertToType(data['prices'], [PricingGet200ResponsePricingPrimaryIpsInnerPricesInner]);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>PricingGet200ResponsePricingPrimaryIpsInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PricingGet200ResponsePricingPrimaryIpsInner</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of PricingGet200ResponsePricingPrimaryIpsInner.RequiredProperties) {
        ...
        if (data['prices']) { // data not null
            ...
            for (const item of data['prices']) {
                PricingGet200ResponsePricingPrimaryIpsInnerPricesInner.validateJSON(item);
            };
        }
...
PricingGet200ResponsePricingPrimaryIpsInner.RequiredProperties = ["prices", "type"];

/**
 * Primary IP type costs per Location
 * @member {Array.<module:model/PricingGet200ResponsePricingPrimaryIpsInnerPricesInner>} prices
 */
PricingGet200ResponsePricingPrimaryIpsInner.prototype['prices'] = undefined;

/**
 * The type of the Primary IP
 * @member {module:model/PricingGet200ResponsePricingPrimaryIpsInner.TypeEnum} type
 */
PricingGet200ResponsePricingPrimaryIpsInner.prototype['type'] = undefined;
 ...
 * @readonly
 */
PricingGet200ResponsePricingPrimaryIpsInner['TypeEnum'] = {
...
export default PricingGet200ResponsePricingPrimaryIpsInner;
