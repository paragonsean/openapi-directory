...
/**
 * The ServersIdActionsChangeDnsPtrPostRequest model module.
 * @module model/ServersIdActionsChangeDnsPtrPostRequest
 * @version 1.0.0
 */
class ServersIdActionsChangeDnsPtrPostRequest {
    /**
     * Constructs a new <code>ServersIdActionsChangeDnsPtrPostRequest</code>.
     * @alias module:model/ServersIdActionsChangeDnsPtrPostRequest
     * @param dnsPtr {String} Hostname to set as a reverse DNS PTR entry, reset to original value if `null`
     * @param ip {String} Primary IP address for which the reverse DNS entry should be set
     */
    constructor(dnsPtr, ip) { 
        
        ServersIdActionsChangeDnsPtrPostRequest.initialize(this, dnsPtr, ip);
    }
    ...
    /**
     * Constructs a <code>ServersIdActionsChangeDnsPtrPostRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ServersIdActionsChangeDnsPtrPostRequest} obj Optional instance to populate.
     * @return {module:model/ServersIdActionsChangeDnsPtrPostRequest} The populated <code>ServersIdActionsChangeDnsPtrPostRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ServersIdActionsChangeDnsPtrPostRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>ServersIdActionsChangeDnsPtrPostRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ServersIdActionsChangeDnsPtrPostRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ServersIdActionsChangeDnsPtrPostRequest.RequiredProperties) {
...
ServersIdActionsChangeDnsPtrPostRequest.RequiredProperties = ["dns_ptr", "ip"];

/**
 * Hostname to set as a reverse DNS PTR entry, reset to original value if `null`
 * @member {String} dns_ptr
 */
ServersIdActionsChangeDnsPtrPostRequest.prototype['dns_ptr'] = undefined;

/**
 * Primary IP address for which the reverse DNS entry should be set
 * @member {String} ip
 */
ServersIdActionsChangeDnsPtrPostRequest.prototype['ip'] = undefined;
...
export default ServersIdActionsChangeDnsPtrPostRequest;
