...
/**
 * The DetachFromNetworkRequest model module.
 * @module model/DetachFromNetworkRequest
 * @version 1.0.0
 */
class DetachFromNetworkRequest {
    /**
     * Constructs a new <code>DetachFromNetworkRequest</code>.
     * @alias module:model/DetachFromNetworkRequest
     * @param network {Number} ID of an existing network to detach the Server from
     */
    constructor(network) { 
        
        DetachFromNetworkRequest.initialize(this, network);
    }
    ...
    /**
     * Constructs a <code>DetachFromNetworkRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DetachFromNetworkRequest} obj Optional instance to populate.
     * @return {module:model/DetachFromNetworkRequest} The populated <code>DetachFromNetworkRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DetachFromNetworkRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>DetachFromNetworkRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DetachFromNetworkRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DetachFromNetworkRequest.RequiredProperties) {
...
DetachFromNetworkRequest.RequiredProperties = ["network"];

/**
 * ID of an existing network to detach the Server from
 * @member {Number} network
 */
DetachFromNetworkRequest.prototype['network'] = undefined;
...
export default DetachFromNetworkRequest;
