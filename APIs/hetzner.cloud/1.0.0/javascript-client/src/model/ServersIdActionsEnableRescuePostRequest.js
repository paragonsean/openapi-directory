...
/**
 * The ServersIdActionsEnableRescuePostRequest model module.
 * @module model/ServersIdActionsEnableRescuePostRequest
 * @version 1.0.0
 */
class ServersIdActionsEnableRescuePostRequest {
    /**
     * Constructs a new <code>ServersIdActionsEnableRescuePostRequest</code>.
     * @alias module:model/ServersIdActionsEnableRescuePostRequest
     */
    constructor() { 
        
        ServersIdActionsEnableRescuePostRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ServersIdActionsEnableRescuePostRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ServersIdActionsEnableRescuePostRequest} obj Optional instance to populate.
     * @return {module:model/ServersIdActionsEnableRescuePostRequest} The populated <code>ServersIdActionsEnableRescuePostRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ServersIdActionsEnableRescuePostRequest();

            if (data.hasOwnProperty('ssh_keys')) {
                obj['ssh_keys'] = ApiClient.convertToType(data['ssh_keys'], ['Number']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>ServersIdActionsEnableRescuePostRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ServersIdActionsEnableRescuePostRequest</code>.
     */
 ...
 * @member {Array.<Number>} ssh_keys
 */
ServersIdActionsEnableRescuePostRequest.prototype['ssh_keys'] = undefined;

/**
 * Type of rescue system to boot (default: `linux64`)
 * @member {module:model/ServersIdActionsEnableRescuePostRequest.TypeEnum} type
 */
ServersIdActionsEnableRescuePostRequest.prototype['type'] = undefined;
 ...
 * @readonly
 */
ServersIdActionsEnableRescuePostRequest['TypeEnum'] = {
...
export default ServersIdActionsEnableRescuePostRequest;
