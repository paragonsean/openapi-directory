...
/**
 * The AddTargetRequestLabelSelector model module.
 * @module model/AddTargetRequestLabelSelector
 * @version 1.0.0
 */
class AddTargetRequestLabelSelector {
    /**
     * Constructs a new <code>AddTargetRequestLabelSelector</code>.
     * Configuration for label selector targets, required if type is &#x60;label_selector&#x60;
     * @alias module:model/AddTargetRequestLabelSelector
     * @param selector {String} Label selector
     */
    constructor(selector) { 
        
        AddTargetRequestLabelSelector.initialize(this, selector);
    }
    ...
    /**
     * Constructs a <code>AddTargetRequestLabelSelector</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AddTargetRequestLabelSelector} obj Optional instance to populate.
     * @return {module:model/AddTargetRequestLabelSelector} The populated <code>AddTargetRequestLabelSelector</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AddTargetRequestLabelSelector();
    ...
    /**
     * Validates the JSON data with respect to <code>AddTargetRequestLabelSelector</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AddTargetRequestLabelSelector</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of AddTargetRequestLabelSelector.RequiredProperties) {
...
AddTargetRequestLabelSelector.RequiredProperties = ["selector"];

/**
 * Label selector
 * @member {String} selector
 */
AddTargetRequestLabelSelector.prototype['selector'] = undefined;
...
export default AddTargetRequestLabelSelector;
