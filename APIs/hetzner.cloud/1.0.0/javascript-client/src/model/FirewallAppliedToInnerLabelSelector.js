...
/**
 * The FirewallAppliedToInnerLabelSelector model module.
 * @module model/FirewallAppliedToInnerLabelSelector
 * @version 1.0.0
 */
class FirewallAppliedToInnerLabelSelector {
    /**
     * Constructs a new <code>FirewallAppliedToInnerLabelSelector</code>.
     * @alias module:model/FirewallAppliedToInnerLabelSelector
     * @param selector {String} Label selector
     */
    constructor(selector) { 
        
        FirewallAppliedToInnerLabelSelector.initialize(this, selector);
    }
    ...
    /**
     * Constructs a <code>FirewallAppliedToInnerLabelSelector</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/FirewallAppliedToInnerLabelSelector} obj Optional instance to populate.
     * @return {module:model/FirewallAppliedToInnerLabelSelector} The populated <code>FirewallAppliedToInnerLabelSelector</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new FirewallAppliedToInnerLabelSelector();
    ...
    /**
     * Validates the JSON data with respect to <code>FirewallAppliedToInnerLabelSelector</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>FirewallAppliedToInnerLabelSelector</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of FirewallAppliedToInnerLabelSelector.RequiredProperties) {
...
FirewallAppliedToInnerLabelSelector.RequiredProperties = ["selector"];

/**
 * Label selector
 * @member {String} selector
 */
FirewallAppliedToInnerLabelSelector.prototype['selector'] = undefined;
...
export default FirewallAppliedToInnerLabelSelector;
