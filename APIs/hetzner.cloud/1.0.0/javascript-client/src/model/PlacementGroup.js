...
class PlacementGroup {
     ...
     * @param type {module:model/PlacementGroup.TypeEnum} Type of the Placement Group
     */
    constructor(created, id, labels, name, servers, type) { 
        
        PlacementGroup.initialize(this, created, id, labels, name, servers, type);
    }
    ...
    static validateJSON(data) {
        ...
        for (const property of PlacementGroup.RequiredProperties) {
...
PlacementGroup.RequiredProperties = ["created", "id", "labels", "name", "servers", "type"];

/**
 * Point in time when the Resource was created (in ISO-8601 format)
 * @member {String} created
 */
PlacementGroup.prototype['created'] = undefined;
 ...
 */
PlacementGroup.prototype['labels'] = undefined;
 ...
 */
PlacementGroup.prototype['servers'] = undefined;

/**
 * Type of the Placement Group
 * @member {module:model/PlacementGroup.TypeEnum} type
 */
PlacementGroup.prototype['type'] = undefined;
