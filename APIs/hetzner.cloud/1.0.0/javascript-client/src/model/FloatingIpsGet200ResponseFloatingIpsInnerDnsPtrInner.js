...
/**
 * The FloatingIpsGet200ResponseFloatingIpsInnerDnsPtrInner model module.
 * @module model/FloatingIpsGet200ResponseFloatingIpsInnerDnsPtrInner
 * @version 1.0.0
 */
class FloatingIpsGet200ResponseFloatingIpsInnerDnsPtrInner {
    /**
     * Constructs a new <code>FloatingIpsGet200ResponseFloatingIpsInnerDnsPtrInner</code>.
     * @alias module:model/FloatingIpsGet200ResponseFloatingIpsInnerDnsPtrInner
     * @param dnsPtr {String} DNS pointer for the specific IP address
     * @param ip {String} Single IPv4 or IPv6 address
     */
    constructor(dnsPtr, ip) { 
        
        FloatingIpsGet200ResponseFloatingIpsInnerDnsPtrInner.initialize(this, dnsPtr, ip);
    }
    ...
    /**
     * Constructs a <code>FloatingIpsGet200ResponseFloatingIpsInnerDnsPtrInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/FloatingIpsGet200ResponseFloatingIpsInnerDnsPtrInner} obj Optional instance to populate.
     * @return {module:model/FloatingIpsGet200ResponseFloatingIpsInnerDnsPtrInner} The populated <code>FloatingIpsGet200ResponseFloatingIpsInnerDnsPtrInner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new FloatingIpsGet200ResponseFloatingIpsInnerDnsPtrInner();
    ...
    /**
     * Validates the JSON data with respect to <code>FloatingIpsGet200ResponseFloatingIpsInnerDnsPtrInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>FloatingIpsGet200ResponseFloatingIpsInnerDnsPtrInner</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of FloatingIpsGet200ResponseFloatingIpsInnerDnsPtrInner.RequiredProperties) {
...
FloatingIpsGet200ResponseFloatingIpsInnerDnsPtrInner.RequiredProperties = ["dns_ptr", "ip"];

/**
 * DNS pointer for the specific IP address
 * @member {String} dns_ptr
 */
FloatingIpsGet200ResponseFloatingIpsInnerDnsPtrInner.prototype['dns_ptr'] = undefined;

/**
 * Single IPv4 or IPv6 address
 * @member {String} ip
 */
FloatingIpsGet200ResponseFloatingIpsInnerDnsPtrInner.prototype['ip'] = undefined;
...
export default FloatingIpsGet200ResponseFloatingIpsInnerDnsPtrInner;
