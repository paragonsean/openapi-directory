...
/**
 * The UpdatePrimaryIPRequest model module.
 * @module model/UpdatePrimaryIPRequest
 * @version 1.0.0
 */
class UpdatePrimaryIPRequest {
    /**
     * Constructs a new <code>UpdatePrimaryIPRequest</code>.
     * @alias module:model/UpdatePrimaryIPRequest
     */
    constructor() { 
        
        UpdatePrimaryIPRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>UpdatePrimaryIPRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdatePrimaryIPRequest} obj Optional instance to populate.
     * @return {module:model/UpdatePrimaryIPRequest} The populated <code>UpdatePrimaryIPRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdatePrimaryIPRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>UpdatePrimaryIPRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdatePrimaryIPRequest</code>.
     */
 ...
 */
UpdatePrimaryIPRequest.prototype['auto_delete'] = undefined;

/**
 * User-defined labels (key-value pairs)
 * @member {Object} labels
 */
UpdatePrimaryIPRequest.prototype['labels'] = undefined;

/**
 * New unique name to set
 * @member {String} name
 */
UpdatePrimaryIPRequest.prototype['name'] = undefined;
...
export default UpdatePrimaryIPRequest;
