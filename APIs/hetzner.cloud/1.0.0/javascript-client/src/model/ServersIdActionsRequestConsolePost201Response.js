...
/**
 * The ServersIdActionsRequestConsolePost201Response model module.
 * @module model/ServersIdActionsRequestConsolePost201Response
 * @version 1.0.0
 */
class ServersIdActionsRequestConsolePost201Response {
    /**
     * Constructs a new <code>ServersIdActionsRequestConsolePost201Response</code>.
     * @alias module:model/ServersIdActionsRequestConsolePost201Response
     * @param action {module:model/Action} 
     * @param password {String} VNC password to use for this connection (this password only works in combination with a wss_url with valid token)
     * @param wssUrl {String} URL of websocket proxy to use; this includes a token which is valid for a limited time only
     */
    constructor(action, password, wssUrl) { 
        
        ServersIdActionsRequestConsolePost201Response.initialize(this, action, password, wssUrl);
    }
     ...
     */
    static initialize(obj, action, password, wssUrl) { 
        obj['action'] = action;
    ...
    /**
     * Constructs a <code>ServersIdActionsRequestConsolePost201Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ServersIdActionsRequestConsolePost201Response} obj Optional instance to populate.
     * @return {module:model/ServersIdActionsRequestConsolePost201Response} The populated <code>ServersIdActionsRequestConsolePost201Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ServersIdActionsRequestConsolePost201Response();
            ...
            if (data.hasOwnProperty('wss_url')) {
                obj['wss_url'] = ApiClient.convertToType(data['wss_url'], 'String');
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ServersIdActionsRequestConsolePost201Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ServersIdActionsRequestConsolePost201Response</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ServersIdActionsRequestConsolePost201Response.RequiredProperties) {
        ...
        // ensure the json data is a string
        if (data['wss_url'] && !(typeof data['wss_url'] === 'string' || data['wss_url'] instanceof String)) {
            throw new Error("Expected the field `wss_url` to be a primitive type in the JSON string but got " + data['wss_url']);
        }
...
ServersIdActionsRequestConsolePost201Response.RequiredProperties = ["action", "password", "wss_url"];

/**
 * @member {module:model/Action} action
 */
ServersIdActionsRequestConsolePost201Response.prototype['action'] = undefined;

/**
 * VNC password to use for this connection (this password only works in combination with a wss_url with valid token)
 * @member {String} password
 */
ServersIdActionsRequestConsolePost201Response.prototype['password'] = undefined;

/**
 * URL of websocket proxy to use; this includes a token which is valid for a limited time only
 * @member {String} wss_url
 */
ServersIdActionsRequestConsolePost201Response.prototype['wss_url'] = undefined;
...
export default ServersIdActionsRequestConsolePost201Response;
