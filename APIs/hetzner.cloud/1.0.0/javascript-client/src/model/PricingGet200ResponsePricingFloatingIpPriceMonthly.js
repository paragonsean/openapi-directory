...
/**
 * The PricingGet200ResponsePricingFloatingIpPriceMonthly model module.
 * @module model/PricingGet200ResponsePricingFloatingIpPriceMonthly
 * @version 1.0.0
 */
class PricingGet200ResponsePricingFloatingIpPriceMonthly {
    /**
     * Constructs a new <code>PricingGet200ResponsePricingFloatingIpPriceMonthly</code>.
     * @alias module:model/PricingGet200ResponsePricingFloatingIpPriceMonthly
     * @param gross {String} Price with VAT added
     * @param net {String} Price without VAT
     */
    constructor(gross, net) { 
        
        PricingGet200ResponsePricingFloatingIpPriceMonthly.initialize(this, gross, net);
    }
    ...
    /**
     * Constructs a <code>PricingGet200ResponsePricingFloatingIpPriceMonthly</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PricingGet200ResponsePricingFloatingIpPriceMonthly} obj Optional instance to populate.
     * @return {module:model/PricingGet200ResponsePricingFloatingIpPriceMonthly} The populated <code>PricingGet200ResponsePricingFloatingIpPriceMonthly</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PricingGet200ResponsePricingFloatingIpPriceMonthly();
    ...
    /**
     * Validates the JSON data with respect to <code>PricingGet200ResponsePricingFloatingIpPriceMonthly</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PricingGet200ResponsePricingFloatingIpPriceMonthly</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of PricingGet200ResponsePricingFloatingIpPriceMonthly.RequiredProperties) {
...
PricingGet200ResponsePricingFloatingIpPriceMonthly.RequiredProperties = ["gross", "net"];

/**
 * Price with VAT added
 * @member {String} gross
 */
PricingGet200ResponsePricingFloatingIpPriceMonthly.prototype['gross'] = undefined;

/**
 * Price without VAT
 * @member {String} net
 */
PricingGet200ResponsePricingFloatingIpPriceMonthly.prototype['net'] = undefined;
...
export default PricingGet200ResponsePricingFloatingIpPriceMonthly;
