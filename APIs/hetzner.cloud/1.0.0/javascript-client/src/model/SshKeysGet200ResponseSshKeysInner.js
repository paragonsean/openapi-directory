...
/**
 * The SshKeysGet200ResponseSshKeysInner model module.
 * @module model/SshKeysGet200ResponseSshKeysInner
 * @version 1.0.0
 */
class SshKeysGet200ResponseSshKeysInner {
    /**
     * Constructs a new <code>SshKeysGet200ResponseSshKeysInner</code>.
     * @alias module:model/SshKeysGet200ResponseSshKeysInner
     * @param created {String} Point in time when the Resource was created (in ISO-8601 format)
     * @param fingerprint {String} Fingerprint of public key
     ...
     */
    constructor(created, fingerprint, id, labels, name, publicKey) { 
        
        SshKeysGet200ResponseSshKeysInner.initialize(this, created, fingerprint, id, labels, name, publicKey);
    }
     ...
     */
    static initialize(obj, created, fingerprint, id, labels, name, publicKey) { 
        obj['created'] = created;
    ...
    /**
     * Constructs a <code>SshKeysGet200ResponseSshKeysInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SshKeysGet200ResponseSshKeysInner} obj Optional instance to populate.
     * @return {module:model/SshKeysGet200ResponseSshKeysInner} The populated <code>SshKeysGet200ResponseSshKeysInner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SshKeysGet200ResponseSshKeysInner();
    ...
    /**
     * Validates the JSON data with respect to <code>SshKeysGet200ResponseSshKeysInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SshKeysGet200ResponseSshKeysInner</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of SshKeysGet200ResponseSshKeysInner.RequiredProperties) {
...
SshKeysGet200ResponseSshKeysInner.RequiredProperties = ["created", "fingerprint", "id", "labels", "name", "public_key"];

/**
 * Point in time when the Resource was created (in ISO-8601 format)
 * @member {String} created
 */
SshKeysGet200ResponseSshKeysInner.prototype['created'] = undefined;

/**
 * Fingerprint of public key
 * @member {String} fingerprint
 */
SshKeysGet200ResponseSshKeysInner.prototype['fingerprint'] = undefined;

/**
 * ID of the Resource
 * @member {Number} id
 */
SshKeysGet200ResponseSshKeysInner.prototype['id'] = undefined;

/**
 * User-defined labels (key-value pairs)
 * @member {Object.<String, String>} labels
 */
SshKeysGet200ResponseSshKeysInner.prototype['labels'] = undefined;

/**
 * Name of the Resource. Must be unique per Project.
 * @member {String} name
 */
SshKeysGet200ResponseSshKeysInner.prototype['name'] = undefined;

/**
 * Public key
 * @member {String} public_key
 */
SshKeysGet200ResponseSshKeysInner.prototype['public_key'] = undefined;
...
export default SshKeysGet200ResponseSshKeysInner;
