...
/**
 * The UpdateFloatingIPRequest model module.
 * @module model/UpdateFloatingIPRequest
 * @version 1.0.0
 */
class UpdateFloatingIPRequest {
    /**
     * Constructs a new <code>UpdateFloatingIPRequest</code>.
     * @alias module:model/UpdateFloatingIPRequest
     */
    constructor() { 
        
        UpdateFloatingIPRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>UpdateFloatingIPRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateFloatingIPRequest} obj Optional instance to populate.
     * @return {module:model/UpdateFloatingIPRequest} The populated <code>UpdateFloatingIPRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateFloatingIPRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateFloatingIPRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateFloatingIPRequest</code>.
     */
 ...
 */
UpdateFloatingIPRequest.prototype['description'] = undefined;

/**
 * User-defined labels (key-value pairs)
 * @member {Object} labels
 */
UpdateFloatingIPRequest.prototype['labels'] = undefined;

/**
 * New unique name to set
 * @member {String} name
 */
UpdateFloatingIPRequest.prototype['name'] = undefined;
...
export default UpdateFloatingIPRequest;
