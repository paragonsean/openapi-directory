...
/**
 * The LoadBalancersGet200ResponseLoadBalancersInnerAlgorithm model module.
 * @module model/LoadBalancersGet200ResponseLoadBalancersInnerAlgorithm
 * @version 1.0.0
 */
class LoadBalancersGet200ResponseLoadBalancersInnerAlgorithm {
    /**
     * Constructs a new <code>LoadBalancersGet200ResponseLoadBalancersInnerAlgorithm</code>.
     * Algorithm of the Load Balancer
     * @alias module:model/LoadBalancersGet200ResponseLoadBalancersInnerAlgorithm
     * @param type {module:model/LoadBalancersGet200ResponseLoadBalancersInnerAlgorithm.TypeEnum} Type of the algorithm
     */
    constructor(type) { 
        
        LoadBalancersGet200ResponseLoadBalancersInnerAlgorithm.initialize(this, type);
    }
    ...
    /**
     * Constructs a <code>LoadBalancersGet200ResponseLoadBalancersInnerAlgorithm</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/LoadBalancersGet200ResponseLoadBalancersInnerAlgorithm} obj Optional instance to populate.
     * @return {module:model/LoadBalancersGet200ResponseLoadBalancersInnerAlgorithm} The populated <code>LoadBalancersGet200ResponseLoadBalancersInnerAlgorithm</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new LoadBalancersGet200ResponseLoadBalancersInnerAlgorithm();
    ...
    /**
     * Validates the JSON data with respect to <code>LoadBalancersGet200ResponseLoadBalancersInnerAlgorithm</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>LoadBalancersGet200ResponseLoadBalancersInnerAlgorithm</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of LoadBalancersGet200ResponseLoadBalancersInnerAlgorithm.RequiredProperties) {
...
LoadBalancersGet200ResponseLoadBalancersInnerAlgorithm.RequiredProperties = ["type"];

/**
 * Type of the algorithm
 * @member {module:model/LoadBalancersGet200ResponseLoadBalancersInnerAlgorithm.TypeEnum} type
 */
LoadBalancersGet200ResponseLoadBalancersInnerAlgorithm.prototype['type'] = undefined;
 ...
 * @readonly
 */
LoadBalancersGet200ResponseLoadBalancersInnerAlgorithm['TypeEnum'] = {
...
export default LoadBalancersGet200ResponseLoadBalancersInnerAlgorithm;
