...
/**
 * The PricingGet200ResponsePricingServerTypesInnerPricesInnerPriceHourly model module.
 * @module model/PricingGet200ResponsePricingServerTypesInnerPricesInnerPriceHourly
 * @version 1.0.0
 */
class PricingGet200ResponsePricingServerTypesInnerPricesInnerPriceHourly {
    /**
     * Constructs a new <code>PricingGet200ResponsePricingServerTypesInnerPricesInnerPriceHourly</code>.
     * Hourly costs for a Server type in this Location
     * @alias module:model/PricingGet200ResponsePricingServerTypesInnerPricesInnerPriceHourly
     * @param gross {String} Price with VAT added
     * @param net {String} Price without VAT
     */
    constructor(gross, net) { 
        
        PricingGet200ResponsePricingServerTypesInnerPricesInnerPriceHourly.initialize(this, gross, net);
    }
    ...
    /**
     * Constructs a <code>PricingGet200ResponsePricingServerTypesInnerPricesInnerPriceHourly</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PricingGet200ResponsePricingServerTypesInnerPricesInnerPriceHourly} obj Optional instance to populate.
     * @return {module:model/PricingGet200ResponsePricingServerTypesInnerPricesInnerPriceHourly} The populated <code>PricingGet200ResponsePricingServerTypesInnerPricesInnerPriceHourly</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PricingGet200ResponsePricingServerTypesInnerPricesInnerPriceHourly();
    ...
    /**
     * Validates the JSON data with respect to <code>PricingGet200ResponsePricingServerTypesInnerPricesInnerPriceHourly</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PricingGet200ResponsePricingServerTypesInnerPricesInnerPriceHourly</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of PricingGet200ResponsePricingServerTypesInnerPricesInnerPriceHourly.RequiredProperties) {
...
PricingGet200ResponsePricingServerTypesInnerPricesInnerPriceHourly.RequiredProperties = ["gross", "net"];

/**
 * Price with VAT added
 * @member {String} gross
 */
PricingGet200ResponsePricingServerTypesInnerPricesInnerPriceHourly.prototype['gross'] = undefined;

/**
 * Price without VAT
 * @member {String} net
 */
PricingGet200ResponsePricingServerTypesInnerPricesInnerPriceHourly.prototype['net'] = undefined;
...
export default PricingGet200ResponsePricingServerTypesInnerPricesInnerPriceHourly;
