...
/**
 * The ChangeLoadbalancerDnsPtrRequest model module.
 * @module model/ChangeLoadbalancerDnsPtrRequest
 * @version 1.0.0
 */
class ChangeLoadbalancerDnsPtrRequest {
    /**
     * Constructs a new <code>ChangeLoadbalancerDnsPtrRequest</code>.
     * @alias module:model/ChangeLoadbalancerDnsPtrRequest
     * @param dnsPtr {String} Hostname to set as a reverse DNS PTR entry
     * @param ip {String} Public IP address for which the reverse DNS entry should be set
     */
    constructor(dnsPtr, ip) { 
        
        ChangeLoadbalancerDnsPtrRequest.initialize(this, dnsPtr, ip);
    }
    ...
    /**
     * Constructs a <code>ChangeLoadbalancerDnsPtrRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ChangeLoadbalancerDnsPtrRequest} obj Optional instance to populate.
     * @return {module:model/ChangeLoadbalancerDnsPtrRequest} The populated <code>ChangeLoadbalancerDnsPtrRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ChangeLoadbalancerDnsPtrRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>ChangeLoadbalancerDnsPtrRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ChangeLoadbalancerDnsPtrRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ChangeLoadbalancerDnsPtrRequest.RequiredProperties) {
...
ChangeLoadbalancerDnsPtrRequest.RequiredProperties = ["dns_ptr", "ip"];

/**
 * Hostname to set as a reverse DNS PTR entry
 * @member {String} dns_ptr
 */
ChangeLoadbalancerDnsPtrRequest.prototype['dns_ptr'] = undefined;

/**
 * Public IP address for which the reverse DNS entry should be set
 * @member {String} ip
 */
ChangeLoadbalancerDnsPtrRequest.prototype['ip'] = undefined;
...
export default ChangeLoadbalancerDnsPtrRequest;
