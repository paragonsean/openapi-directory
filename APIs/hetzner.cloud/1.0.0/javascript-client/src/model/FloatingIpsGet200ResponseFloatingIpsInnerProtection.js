...
/**
 * The FloatingIpsGet200ResponseFloatingIpsInnerProtection model module.
 * @module model/FloatingIpsGet200ResponseFloatingIpsInnerProtection
 * @version 1.0.0
 */
class FloatingIpsGet200ResponseFloatingIpsInnerProtection {
    /**
     * Constructs a new <code>FloatingIpsGet200ResponseFloatingIpsInnerProtection</code>.
     * Protection configuration for the Resource
     * @alias module:model/FloatingIpsGet200ResponseFloatingIpsInnerProtection
     * @param _delete {Boolean} If true, prevents the Resource from being deleted
     */
    constructor(_delete) { 
        
        FloatingIpsGet200ResponseFloatingIpsInnerProtection.initialize(this, _delete);
    }
    ...
    /**
     * Constructs a <code>FloatingIpsGet200ResponseFloatingIpsInnerProtection</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/FloatingIpsGet200ResponseFloatingIpsInnerProtection} obj Optional instance to populate.
     * @return {module:model/FloatingIpsGet200ResponseFloatingIpsInnerProtection} The populated <code>FloatingIpsGet200ResponseFloatingIpsInnerProtection</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new FloatingIpsGet200ResponseFloatingIpsInnerProtection();
    ...
    /**
     * Validates the JSON data with respect to <code>FloatingIpsGet200ResponseFloatingIpsInnerProtection</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>FloatingIpsGet200ResponseFloatingIpsInnerProtection</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of FloatingIpsGet200ResponseFloatingIpsInnerProtection.RequiredProperties) {
...
FloatingIpsGet200ResponseFloatingIpsInnerProtection.RequiredProperties = ["delete"];

/**
 * If true, prevents the Resource from being deleted
 * @member {Boolean} delete
 */
FloatingIpsGet200ResponseFloatingIpsInnerProtection.prototype['delete'] = undefined;
...
export default FloatingIpsGet200ResponseFloatingIpsInnerProtection;
