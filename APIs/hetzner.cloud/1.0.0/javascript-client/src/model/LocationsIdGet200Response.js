...
/**
 * The LocationsIdGet200Response model module.
 * @module model/LocationsIdGet200Response
 * @version 1.0.0
 */
class LocationsIdGet200Response {
    /**
     * Constructs a new <code>LocationsIdGet200Response</code>.
     * @alias module:model/LocationsIdGet200Response
     * @param location {module:model/DatacentersGet200ResponseDatacentersInnerLocation} 
     */
    constructor(location) { 
        
        LocationsIdGet200Response.initialize(this, location);
    }
    ...
    /**
     * Constructs a <code>LocationsIdGet200Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/LocationsIdGet200Response} obj Optional instance to populate.
     * @return {module:model/LocationsIdGet200Response} The populated <code>LocationsIdGet200Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new LocationsIdGet200Response();
    ...
    /**
     * Validates the JSON data with respect to <code>LocationsIdGet200Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>LocationsIdGet200Response</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of LocationsIdGet200Response.RequiredProperties) {
...
LocationsIdGet200Response.RequiredProperties = ["location"];

/**
 * @member {module:model/DatacentersGet200ResponseDatacentersInnerLocation} location
 */
LocationsIdGet200Response.prototype['location'] = undefined;
...
export default LocationsIdGet200Response;
