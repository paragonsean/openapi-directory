...
/**
 * The LoadBalancersGet200ResponseLoadBalancersInnerPrivateNetInner model module.
 * @module model/LoadBalancersGet200ResponseLoadBalancersInnerPrivateNetInner
 * @version 1.0.0
 */
class LoadBalancersGet200ResponseLoadBalancersInnerPrivateNetInner {
    /**
     * Constructs a new <code>LoadBalancersGet200ResponseLoadBalancersInnerPrivateNetInner</code>.
     * @alias module:model/LoadBalancersGet200ResponseLoadBalancersInnerPrivateNetInner
     */
    constructor() { 
        
        LoadBalancersGet200ResponseLoadBalancersInnerPrivateNetInner.initialize(this);
    }
    ...
    /**
     * Constructs a <code>LoadBalancersGet200ResponseLoadBalancersInnerPrivateNetInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/LoadBalancersGet200ResponseLoadBalancersInnerPrivateNetInner} obj Optional instance to populate.
     * @return {module:model/LoadBalancersGet200ResponseLoadBalancersInnerPrivateNetInner} The populated <code>LoadBalancersGet200ResponseLoadBalancersInnerPrivateNetInner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new LoadBalancersGet200ResponseLoadBalancersInnerPrivateNetInner();
    ...
    /**
     * Validates the JSON data with respect to <code>LoadBalancersGet200ResponseLoadBalancersInnerPrivateNetInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>LoadBalancersGet200ResponseLoadBalancersInnerPrivateNetInner</code>.
     */
 ...
 * @member {String} ip
 */
LoadBalancersGet200ResponseLoadBalancersInnerPrivateNetInner.prototype['ip'] = undefined;

/**
 * @member {Number} network
 */
LoadBalancersGet200ResponseLoadBalancersInnerPrivateNetInner.prototype['network'] = undefined;
...
export default LoadBalancersGet200ResponseLoadBalancersInnerPrivateNetInner;
