...
import ActionsResponseMetaPagination from './ActionsResponseMetaPagination';

/**
 * The ActionsResponseMeta model module.
 * @module model/ActionsResponseMeta
 * @version 1.0.0
 */
class ActionsResponseMeta {
    /**
     * Constructs a new <code>ActionsResponseMeta</code>.
     * @alias module:model/ActionsResponseMeta
     * @param pagination {module:model/ActionsResponseMetaPagination} 
     */
    constructor(pagination) { 
        
        ActionsResponseMeta.initialize(this, pagination);
    }
    ...
    /**
     * Constructs a <code>ActionsResponseMeta</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ActionsResponseMeta} obj Optional instance to populate.
     * @return {module:model/ActionsResponseMeta} The populated <code>ActionsResponseMeta</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ActionsResponseMeta();

            if (data.hasOwnProperty('pagination')) {
                obj['pagination'] = ActionsResponseMetaPagination.constructFromObject(data['pagination']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ActionsResponseMeta</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ActionsResponseMeta</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ActionsResponseMeta.RequiredProperties) {
        ...
        if (data['pagination']) { // data not null
          ActionsResponseMetaPagination.validateJSON(data['pagination']);
        }
...
ActionsResponseMeta.RequiredProperties = ["pagination"];

/**
 * @member {module:model/ActionsResponseMetaPagination} pagination
 */
ActionsResponseMeta.prototype['pagination'] = undefined;
...
export default ActionsResponseMeta;
