...
import AddTargetRequestLabelSelector from './AddTargetRequestLabelSelector';
import AddTargetRequestServer from './AddTargetRequestServer';
import LoadBalancerTargetIP from './LoadBalancerTargetIP';

/**
 * The AddTargetRequest model module.
 * @module model/AddTargetRequest
 * @version 1.0.0
 */
class AddTargetRequest {
    /**
     * Constructs a new <code>AddTargetRequest</code>.
     * @alias module:model/AddTargetRequest
     * @param type {module:model/AddTargetRequest.TypeEnum} Type of the resource
     */
    constructor(type) { 
        
        AddTargetRequest.initialize(this, type);
    }
    ...
    /**
     * Constructs a <code>AddTargetRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AddTargetRequest} obj Optional instance to populate.
     * @return {module:model/AddTargetRequest} The populated <code>AddTargetRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AddTargetRequest();

            if (data.hasOwnProperty('ip')) {
                obj['ip'] = LoadBalancerTargetIP.constructFromObject(data['ip']);
            }
            if (data.hasOwnProperty('label_selector')) {
                obj['label_selector'] = AddTargetRequestLabelSelector.constructFromObject(data['label_selector']);
            }
            if (data.hasOwnProperty('server')) {
                obj['server'] = AddTargetRequestServer.constructFromObject(data['server']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>AddTargetRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AddTargetRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of AddTargetRequest.RequiredProperties) {
        ...
        if (data['label_selector']) { // data not null
          AddTargetRequestLabelSelector.validateJSON(data['label_selector']);
        }
        // validate the optional field `server`
        if (data['server']) { // data not null
          AddTargetRequestServer.validateJSON(data['server']);
        }
...
AddTargetRequest.RequiredProperties = ["type"];

/**
 * @member {module:model/LoadBalancerTargetIP} ip
 */
AddTargetRequest.prototype['ip'] = undefined;

/**
 * @member {module:model/AddTargetRequestLabelSelector} label_selector
 */
AddTargetRequest.prototype['label_selector'] = undefined;

/**
 * @member {module:model/AddTargetRequestServer} server
 */
AddTargetRequest.prototype['server'] = undefined;

/**
 * Type of the resource
 * @member {module:model/AddTargetRequest.TypeEnum} type
 */
AddTargetRequest.prototype['type'] = undefined;
 ...
 */
AddTargetRequest.prototype['use_private_ip'] = undefined;
...
export default AddTargetRequest;
