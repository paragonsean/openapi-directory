...
import ImagesGet200ResponseImagesInner from './ImagesGet200ResponseImagesInner';

/**
 * The ImagesIdGet200Response model module.
 * @module model/ImagesIdGet200Response
 * @version 1.0.0
 */
class ImagesIdGet200Response {
    /**
     * Constructs a new <code>ImagesIdGet200Response</code>.
     * @alias module:model/ImagesIdGet200Response
     */
    constructor() { 
        
        ImagesIdGet200Response.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ImagesIdGet200Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ImagesIdGet200Response} obj Optional instance to populate.
     * @return {module:model/ImagesIdGet200Response} The populated <code>ImagesIdGet200Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ImagesIdGet200Response();

            if (data.hasOwnProperty('image')) {
                obj['image'] = ImagesGet200ResponseImagesInner.constructFromObject(data['image']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ImagesIdGet200Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ImagesIdGet200Response</code>.
     */
    static validateJSON(data) {
        // validate the optional field `image`
        if (data['image']) { // data not null
          ImagesGet200ResponseImagesInner.validateJSON(data['image']);
        }
...
/**
 * @member {module:model/ImagesGet200ResponseImagesInner} image
 */
ImagesIdGet200Response.prototype['image'] = undefined;
...
export default ImagesIdGet200Response;
