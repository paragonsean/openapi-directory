...
class CreatePlacementGroupResponse {
     ...
     * @param placementGroup {module:model/PlacementGroup} 
     */
    constructor(placementGroup) { 
        
        CreatePlacementGroupResponse.initialize(this, placementGroup);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreatePlacementGroupResponse();

            if (data.hasOwnProperty('action')) {
                obj['action'] = NullableAction.constructFromObject(data['action']);
            }
            if (data.hasOwnProperty('placement_group')) {
                obj['placement_group'] = PlacementGroup.constructFromObject(data['placement_group']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>CreatePlacementGroupResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreatePlacementGroupResponse</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CreatePlacementGroupResponse.RequiredProperties) {
        ...
        if (data['placement_group']) { // data not null
          PlacementGroup.validateJSON(data['placement_group']);
        }
...
CreatePlacementGroupResponse.RequiredProperties = ["placement_group"];

/**
 * @member {module:model/NullableAction} action
 */
CreatePlacementGroupResponse.prototype['action'] = undefined;

/**
 * @member {module:model/PlacementGroup} placement_group
 */
CreatePlacementGroupResponse.prototype['placement_group'] = undefined;
...
export default CreatePlacementGroupResponse;
