...
/**
 * The LoadBalancerTargetLabelSelector model module.
 * @module model/LoadBalancerTargetLabelSelector
 * @version 1.0.0
 */
class LoadBalancerTargetLabelSelector {
    /**
     * Constructs a new <code>LoadBalancerTargetLabelSelector</code>.
     * Label selector used to determine targets. Only present for target type \&quot;label_selector\&quot;.
     * @alias module:model/LoadBalancerTargetLabelSelector
     * @param selector {String} Label selector
     */
    constructor(selector) { 
        
        LoadBalancerTargetLabelSelector.initialize(this, selector);
    }
    ...
    /**
     * Constructs a <code>LoadBalancerTargetLabelSelector</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/LoadBalancerTargetLabelSelector} obj Optional instance to populate.
     * @return {module:model/LoadBalancerTargetLabelSelector} The populated <code>LoadBalancerTargetLabelSelector</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new LoadBalancerTargetLabelSelector();
    ...
    /**
     * Validates the JSON data with respect to <code>LoadBalancerTargetLabelSelector</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>LoadBalancerTargetLabelSelector</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of LoadBalancerTargetLabelSelector.RequiredProperties) {
...
LoadBalancerTargetLabelSelector.RequiredProperties = ["selector"];

/**
 * Label selector
 * @member {String} selector
 */
LoadBalancerTargetLabelSelector.prototype['selector'] = undefined;
...
export default LoadBalancerTargetLabelSelector;
