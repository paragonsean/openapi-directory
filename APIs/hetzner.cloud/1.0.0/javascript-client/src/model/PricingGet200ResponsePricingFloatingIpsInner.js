...
import PricingGet200ResponsePricingFloatingIpsInnerPricesInner from './PricingGet200ResponsePricingFloatingIpsInnerPricesInner';

/**
 * The PricingGet200ResponsePricingFloatingIpsInner model module.
 * @module model/PricingGet200ResponsePricingFloatingIpsInner
 * @version 1.0.0
 */
class PricingGet200ResponsePricingFloatingIpsInner {
    /**
     * Constructs a new <code>PricingGet200ResponsePricingFloatingIpsInner</code>.
     * @alias module:model/PricingGet200ResponsePricingFloatingIpsInner
     * @param prices {Array.<module:model/PricingGet200ResponsePricingFloatingIpsInnerPricesInner>} Floating IP type costs per Location
     * @param type {module:model/PricingGet200ResponsePricingFloatingIpsInner.TypeEnum} The type of the Floating IP
     */
    constructor(prices, type) { 
        
        PricingGet200ResponsePricingFloatingIpsInner.initialize(this, prices, type);
    }
     ...
     */
    static initialize(obj, prices, type) { 
        obj['prices'] = prices;
        obj['type'] = type;
    }

    /**
     * Constructs a <code>PricingGet200ResponsePricingFloatingIpsInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PricingGet200ResponsePricingFloatingIpsInner} obj Optional instance to populate.
     * @return {module:model/PricingGet200ResponsePricingFloatingIpsInner} The populated <code>PricingGet200ResponsePricingFloatingIpsInner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PricingGet200ResponsePricingFloatingIpsInner();

            if (data.hasOwnProperty('prices')) {
                obj['prices'] = ApiClient.convertToType(data['prices'], [PricingGet200ResponsePricingFloatingIpsInnerPricesInner]);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>PricingGet200ResponsePricingFloatingIpsInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PricingGet200ResponsePricingFloatingIpsInner</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of PricingGet200ResponsePricingFloatingIpsInner.RequiredProperties) {
        ...
        if (data['prices']) { // data not null
            ...
            for (const item of data['prices']) {
                PricingGet200ResponsePricingFloatingIpsInnerPricesInner.validateJSON(item);
            };
        }
...
PricingGet200ResponsePricingFloatingIpsInner.RequiredProperties = ["prices", "type"];

/**
 * Floating IP type costs per Location
 * @member {Array.<module:model/PricingGet200ResponsePricingFloatingIpsInnerPricesInner>} prices
 */
PricingGet200ResponsePricingFloatingIpsInner.prototype['prices'] = undefined;

/**
 * The type of the Floating IP
 * @member {module:model/PricingGet200ResponsePricingFloatingIpsInner.TypeEnum} type
 */
PricingGet200ResponsePricingFloatingIpsInner.prototype['type'] = undefined;
 ...
 * @readonly
 */
PricingGet200ResponsePricingFloatingIpsInner['TypeEnum'] = {
...
export default PricingGet200ResponsePricingFloatingIpsInner;
