...
/**
 * The ServersGet200ResponseServersInnerIso model module.
 * @module model/ServersGet200ResponseServersInnerIso
 * @version 1.0.0
 */
class ServersGet200ResponseServersInnerIso {
    /**
     * Constructs a new <code>ServersGet200ResponseServersInnerIso</code>.
     * ISO Image that is attached to this Server. Null if no ISO is attached.
     * @alias module:model/ServersGet200ResponseServersInnerIso
     * @param architecture {module:model/ServersGet200ResponseServersInnerIso.ArchitectureEnum} Type of cpu architecture this iso is compatible with. Null indicates no restriction on the architecture (wildcard).
     ...
     * @param type {module:model/ServersGet200ResponseServersInnerIso.TypeEnum} Type of the ISO
     */
    constructor(architecture, deprecated, description, id, name, type) { 
        
        ServersGet200ResponseServersInnerIso.initialize(this, architecture, deprecated, description, id, name, type);
    }
    ...
    /**
     * Constructs a <code>ServersGet200ResponseServersInnerIso</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ServersGet200ResponseServersInnerIso} obj Optional instance to populate.
     * @return {module:model/ServersGet200ResponseServersInnerIso} The populated <code>ServersGet200ResponseServersInnerIso</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ServersGet200ResponseServersInnerIso();
    ...
    /**
     * Validates the JSON data with respect to <code>ServersGet200ResponseServersInnerIso</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ServersGet200ResponseServersInnerIso</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ServersGet200ResponseServersInnerIso.RequiredProperties) {
...
ServersGet200ResponseServersInnerIso.RequiredProperties = ["architecture", "deprecated", "description", "id", "name", "type"];

/**
 * Type of cpu architecture this iso is compatible with. Null indicates no restriction on the architecture (wildcard).
 * @member {module:model/ServersGet200ResponseServersInnerIso.ArchitectureEnum} architecture
 */
ServersGet200ResponseServersInnerIso.prototype['architecture'] = undefined;
 ...
 */
ServersGet200ResponseServersInnerIso.prototype['deprecated'] = undefined;

/**
 * Description of the ISO
 * @member {String} description
 */
ServersGet200ResponseServersInnerIso.prototype['description'] = undefined;

/**
 * ID of the Resource
 * @member {Number} id
 */
ServersGet200ResponseServersInnerIso.prototype['id'] = undefined;

/**
 * Unique identifier of the ISO. Only set for public ISOs
 * @member {String} name
 */
ServersGet200ResponseServersInnerIso.prototype['name'] = undefined;

/**
 * Type of the ISO
 * @member {module:model/ServersGet200ResponseServersInnerIso.TypeEnum} type
 */
ServersGet200ResponseServersInnerIso.prototype['type'] = undefined;
 ...
 * @readonly
 */
ServersGet200ResponseServersInnerIso['TypeEnum'] = {
...
export default ServersGet200ResponseServersInnerIso;
