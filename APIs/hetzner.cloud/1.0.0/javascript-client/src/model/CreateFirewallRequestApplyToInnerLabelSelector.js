...
/**
 * The CreateFirewallRequestApplyToInnerLabelSelector model module.
 * @module model/CreateFirewallRequestApplyToInnerLabelSelector
 * @version 1.0.0
 */
class CreateFirewallRequestApplyToInnerLabelSelector {
    /**
     * Constructs a new <code>CreateFirewallRequestApplyToInnerLabelSelector</code>.
     * Configuration for type LabelSelector, required if type is &#x60;label_selector&#x60;
     * @alias module:model/CreateFirewallRequestApplyToInnerLabelSelector
     * @param selector {String} Label selector
     */
    constructor(selector) { 
        
        CreateFirewallRequestApplyToInnerLabelSelector.initialize(this, selector);
    }
    ...
    /**
     * Constructs a <code>CreateFirewallRequestApplyToInnerLabelSelector</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateFirewallRequestApplyToInnerLabelSelector} obj Optional instance to populate.
     * @return {module:model/CreateFirewallRequestApplyToInnerLabelSelector} The populated <code>CreateFirewallRequestApplyToInnerLabelSelector</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateFirewallRequestApplyToInnerLabelSelector();
    ...
    /**
     * Validates the JSON data with respect to <code>CreateFirewallRequestApplyToInnerLabelSelector</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateFirewallRequestApplyToInnerLabelSelector</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CreateFirewallRequestApplyToInnerLabelSelector.RequiredProperties) {
...
CreateFirewallRequestApplyToInnerLabelSelector.RequiredProperties = ["selector"];

/**
 * Label selector
 * @member {String} selector
 */
CreateFirewallRequestApplyToInnerLabelSelector.prototype['selector'] = undefined;
...
export default CreateFirewallRequestApplyToInnerLabelSelector;
