...
/**
 * The ServersIdActionsChangeProtectionPostRequest model module.
 * @module model/ServersIdActionsChangeProtectionPostRequest
 * @version 1.0.0
 */
class ServersIdActionsChangeProtectionPostRequest {
    /**
     * Constructs a new <code>ServersIdActionsChangeProtectionPostRequest</code>.
     * @alias module:model/ServersIdActionsChangeProtectionPostRequest
     */
    constructor() { 
        
        ServersIdActionsChangeProtectionPostRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ServersIdActionsChangeProtectionPostRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ServersIdActionsChangeProtectionPostRequest} obj Optional instance to populate.
     * @return {module:model/ServersIdActionsChangeProtectionPostRequest} The populated <code>ServersIdActionsChangeProtectionPostRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ServersIdActionsChangeProtectionPostRequest();

            if (data.hasOwnProperty('delete')) {
                obj['delete'] = ApiClient.convertToType(data['delete'], 'Boolean');
            }
            if (data.hasOwnProperty('rebuild')) {
                obj['rebuild'] = ApiClient.convertToType(data['rebuild'], 'Boolean');
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ServersIdActionsChangeProtectionPostRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ServersIdActionsChangeProtectionPostRequest</code>.
     */
 ...
 */
ServersIdActionsChangeProtectionPostRequest.prototype['delete'] = undefined;

/**
 * If true, prevents the Server from being rebuilt (currently delete and rebuild attribute needs to have the same value)
 * @member {Boolean} rebuild
 */
ServersIdActionsChangeProtectionPostRequest.prototype['rebuild'] = undefined;
...
export default ServersIdActionsChangeProtectionPostRequest;
