...
/**
 * The CreateFloatingIPRequest model module.
 * @module model/CreateFloatingIPRequest
 * @version 1.0.0
 */
class CreateFloatingIPRequest {
    /**
     * Constructs a new <code>CreateFloatingIPRequest</code>.
     * @alias module:model/CreateFloatingIPRequest
     * @param type {module:model/CreateFloatingIPRequest.TypeEnum} Floating IP type
     */
    constructor(type) { 
        
        CreateFloatingIPRequest.initialize(this, type);
    }
    ...
    /**
     * Constructs a <code>CreateFloatingIPRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateFloatingIPRequest} obj Optional instance to populate.
     * @return {module:model/CreateFloatingIPRequest} The populated <code>CreateFloatingIPRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateFloatingIPRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>CreateFloatingIPRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateFloatingIPRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CreateFloatingIPRequest.RequiredProperties) {
        ...
        // ensure the json data is a string
        if (data['home_location'] && !(typeof data['home_location'] === 'string' || data['home_location'] instanceof String)) {
            throw new Error("Expected the field `home_location` to be a primitive type in the JSON string but got " + data['home_location']);
        }
        // ensure the json data is a string
...
CreateFloatingIPRequest.RequiredProperties = ["type"];

/**
 * @member {String} description
 */
CreateFloatingIPRequest.prototype['description'] = undefined;
 ...
 */
CreateFloatingIPRequest.prototype['home_location'] = undefined;

/**
 * User-defined labels (key-value pairs)
 * @member {Object} labels
 */
CreateFloatingIPRequest.prototype['labels'] = undefined;

/**
 * @member {String} name
 */
CreateFloatingIPRequest.prototype['name'] = undefined;

/**
 * Server to assign the Floating IP to
 * @member {Number} server
 */
CreateFloatingIPRequest.prototype['server'] = undefined;

/**
 * Floating IP type
 * @member {module:model/CreateFloatingIPRequest.TypeEnum} type
 */
CreateFloatingIPRequest.prototype['type'] = undefined;
 ...
 * @readonly
 */
CreateFloatingIPRequest['TypeEnum'] = {
...
export default CreateFloatingIPRequest;
