...
class CreateCertificateRequest {
    ...
    constructor(name) { 
        ...
        CreateCertificateRequest.initialize(this, name);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('domain_names')) {
                obj['domain_names'] = ApiClient.convertToType(data['domain_names'], ['String']);
            }
    ...
    static validateJSON(data) {
        ...
        if (!Array.isArray(data['domain_names'])) {
            throw new Error("Expected the field `domain_names` to be an array in the JSON data but got " + data['domain_names']);
        }
        // ensure the json data is a string
...
CreateCertificateRequest.RequiredProperties = ["name"];
 ...
 * @member {Array.<String>} domain_names
 */
CreateCertificateRequest.prototype['domain_names'] = undefined;

/**
 * User-defined labels (key-value pairs)
 * @member {Object} labels
 */
CreateCertificateRequest.prototype['labels'] = undefined;
 ...
 * @member {module:model/CreateCertificateRequest.TypeEnum} type
 */
CreateCertificateRequest.prototype['type'] = undefined;
 ...
 * @readonly
 */
CreateCertificateRequest['TypeEnum'] = {
