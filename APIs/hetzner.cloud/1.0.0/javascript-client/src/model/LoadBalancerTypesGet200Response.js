...
/**
 * The LoadBalancerTypesGet200Response model module.
 * @module model/LoadBalancerTypesGet200Response
 * @version 1.0.0
 */
class LoadBalancerTypesGet200Response {
    /**
     * Constructs a new <code>LoadBalancerTypesGet200Response</code>.
     * @alias module:model/LoadBalancerTypesGet200Response
     * @param loadBalancerTypes {Array.<module:model/LoadBalancerTypesGet200ResponseLoadBalancerTypesInner>} 
     */
    constructor(loadBalancerTypes) { 
        
        LoadBalancerTypesGet200Response.initialize(this, loadBalancerTypes);
    }
     ...
     */
    static initialize(obj, loadBalancerTypes) { 
        obj['load_balancer_types'] = loadBalancerTypes;
    }

    /**
     * Constructs a <code>LoadBalancerTypesGet200Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/LoadBalancerTypesGet200Response} obj Optional instance to populate.
     * @return {module:model/LoadBalancerTypesGet200Response} The populated <code>LoadBalancerTypesGet200Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new LoadBalancerTypesGet200Response();

            if (data.hasOwnProperty('load_balancer_types')) {
                obj['load_balancer_types'] = ApiClient.convertToType(data['load_balancer_types'], [LoadBalancerTypesGet200ResponseLoadBalancerTypesInner]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>LoadBalancerTypesGet200Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>LoadBalancerTypesGet200Response</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of LoadBalancerTypesGet200Response.RequiredProperties) {
        ...
        if (data['load_balancer_types']) { // data not null
            ...
            for (const item of data['load_balancer_types']) {
                LoadBalancerTypesGet200ResponseLoadBalancerTypesInner.validateJSON(item);
            };
        }
...
LoadBalancerTypesGet200Response.RequiredProperties = ["load_balancer_types"];

/**
 * @member {Array.<module:model/LoadBalancerTypesGet200ResponseLoadBalancerTypesInner>} load_balancer_types
 */
LoadBalancerTypesGet200Response.prototype['load_balancer_types'] = undefined;
...
export default LoadBalancerTypesGet200Response;
