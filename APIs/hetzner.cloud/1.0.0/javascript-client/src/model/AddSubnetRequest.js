...
/**
 * The AddSubnetRequest model module.
 * @module model/AddSubnetRequest
 * @version 1.0.0
 */
class AddSubnetRequest {
    /**
     * Constructs a new <code>AddSubnetRequest</code>.
     * @alias module:model/AddSubnetRequest
     ...
     * @param type {module:model/AddSubnetRequest.TypeEnum} Type of Subnetwork
     */
    constructor(networkZone, type) { 
        
        AddSubnetRequest.initialize(this, networkZone, type);
    }
    ...
    /**
     * Constructs a <code>AddSubnetRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AddSubnetRequest} obj Optional instance to populate.
     * @return {module:model/AddSubnetRequest} The populated <code>AddSubnetRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AddSubnetRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>AddSubnetRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AddSubnetRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of AddSubnetRequest.RequiredProperties) {
...
AddSubnetRequest.RequiredProperties = ["network_zone", "type"];
 ...
 */
AddSubnetRequest.prototype['ip_range'] = undefined;
 ...
 */
AddSubnetRequest.prototype['network_zone'] = undefined;

/**
 * Type of Subnetwork
 * @member {module:model/AddSubnetRequest.TypeEnum} type
 */
AddSubnetRequest.prototype['type'] = undefined;

/**
 * ID of the robot vSwitch. Must be supplied if the subnet is of type vswitch.
 * @member {Number} vswitch_id
 */
AddSubnetRequest.prototype['vswitch_id'] = undefined;
...
export default AddSubnetRequest;
