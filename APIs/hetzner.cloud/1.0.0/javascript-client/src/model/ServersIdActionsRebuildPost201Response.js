...
/**
 * The ServersIdActionsRebuildPost201Response model module.
 * @module model/ServersIdActionsRebuildPost201Response
 * @version 1.0.0
 */
class ServersIdActionsRebuildPost201Response {
    /**
     * Constructs a new <code>ServersIdActionsRebuildPost201Response</code>.
     * @alias module:model/ServersIdActionsRebuildPost201Response
     */
    constructor() { 
        
        ServersIdActionsRebuildPost201Response.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ServersIdActionsRebuildPost201Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ServersIdActionsRebuildPost201Response} obj Optional instance to populate.
     * @return {module:model/ServersIdActionsRebuildPost201Response} The populated <code>ServersIdActionsRebuildPost201Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ServersIdActionsRebuildPost201Response();
    ...
    /**
     * Validates the JSON data with respect to <code>ServersIdActionsRebuildPost201Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ServersIdActionsRebuildPost201Response</code>.
     */
 ...
 */
ServersIdActionsRebuildPost201Response.prototype['action'] = undefined;

/**
 * New root password when not using SSH keys
 * @member {String} root_password
 */
ServersIdActionsRebuildPost201Response.prototype['root_password'] = undefined;
...
export default ServersIdActionsRebuildPost201Response;
