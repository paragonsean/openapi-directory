...
/**
 * The ImagesGet200ResponseImagesInnerCreatedFrom model module.
 * @module model/ImagesGet200ResponseImagesInnerCreatedFrom
 * @version 1.0.0
 */
class ImagesGet200ResponseImagesInnerCreatedFrom {
    /**
     * Constructs a new <code>ImagesGet200ResponseImagesInnerCreatedFrom</code>.
     * Information about the Server the Image was created from
     * @alias module:model/ImagesGet200ResponseImagesInnerCreatedFrom
     * @param id {Number} ID of the Server the Image was created from
     * @param name {String} Server name at the time the Image was created
     */
    constructor(id, name) { 
        
        ImagesGet200ResponseImagesInnerCreatedFrom.initialize(this, id, name);
    }
    ...
    /**
     * Constructs a <code>ImagesGet200ResponseImagesInnerCreatedFrom</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ImagesGet200ResponseImagesInnerCreatedFrom} obj Optional instance to populate.
     * @return {module:model/ImagesGet200ResponseImagesInnerCreatedFrom} The populated <code>ImagesGet200ResponseImagesInnerCreatedFrom</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ImagesGet200ResponseImagesInnerCreatedFrom();
    ...
    /**
     * Validates the JSON data with respect to <code>ImagesGet200ResponseImagesInnerCreatedFrom</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ImagesGet200ResponseImagesInnerCreatedFrom</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ImagesGet200ResponseImagesInnerCreatedFrom.RequiredProperties) {
...
ImagesGet200ResponseImagesInnerCreatedFrom.RequiredProperties = ["id", "name"];

/**
 * ID of the Server the Image was created from
 * @member {Number} id
 */
ImagesGet200ResponseImagesInnerCreatedFrom.prototype['id'] = undefined;

/**
 * Server name at the time the Image was created
 * @member {String} name
 */
ImagesGet200ResponseImagesInnerCreatedFrom.prototype['name'] = undefined;
...
export default ImagesGet200ResponseImagesInnerCreatedFrom;
