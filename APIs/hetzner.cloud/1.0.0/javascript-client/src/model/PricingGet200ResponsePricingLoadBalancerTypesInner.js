...
import PricingGet200ResponsePricingLoadBalancerTypesInnerPricesInner from './PricingGet200ResponsePricingLoadBalancerTypesInnerPricesInner';

/**
 * The PricingGet200ResponsePricingLoadBalancerTypesInner model module.
 * @module model/PricingGet200ResponsePricingLoadBalancerTypesInner
 * @version 1.0.0
 */
class PricingGet200ResponsePricingLoadBalancerTypesInner {
    /**
     * Constructs a new <code>PricingGet200ResponsePricingLoadBalancerTypesInner</code>.
     * @alias module:model/PricingGet200ResponsePricingLoadBalancerTypesInner
     * @param id {Number} ID of the Load Balancer type the price is for
     * @param name {String} Name of the Load Balancer type the price is for
     * @param prices {Array.<module:model/PricingGet200ResponsePricingLoadBalancerTypesInnerPricesInner>} Load Balancer type costs per Location
     */
    constructor(id, name, prices) { 
        
        PricingGet200ResponsePricingLoadBalancerTypesInner.initialize(this, id, name, prices);
    }
     ...
     */
    static initialize(obj, id, name, prices) { 
        obj['id'] = id;
        obj['name'] = name;
        obj['prices'] = prices;
    }
    ...
    /**
     * Constructs a <code>PricingGet200ResponsePricingLoadBalancerTypesInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PricingGet200ResponsePricingLoadBalancerTypesInner} obj Optional instance to populate.
     * @return {module:model/PricingGet200ResponsePricingLoadBalancerTypesInner} The populated <code>PricingGet200ResponsePricingLoadBalancerTypesInner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PricingGet200ResponsePricingLoadBalancerTypesInner();
            ...
            if (data.hasOwnProperty('prices')) {
                obj['prices'] = ApiClient.convertToType(data['prices'], [PricingGet200ResponsePricingLoadBalancerTypesInnerPricesInner]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>PricingGet200ResponsePricingLoadBalancerTypesInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PricingGet200ResponsePricingLoadBalancerTypesInner</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of PricingGet200ResponsePricingLoadBalancerTypesInner.RequiredProperties) {
        ...
        if (data['prices']) { // data not null
            ...
            for (const item of data['prices']) {
                PricingGet200ResponsePricingLoadBalancerTypesInnerPricesInner.validateJSON(item);
            };
        }
...
PricingGet200ResponsePricingLoadBalancerTypesInner.RequiredProperties = ["id", "name", "prices"];

/**
 * ID of the Load Balancer type the price is for
 * @member {Number} id
 */
PricingGet200ResponsePricingLoadBalancerTypesInner.prototype['id'] = undefined;

/**
 * Name of the Load Balancer type the price is for
 * @member {String} name
 */
PricingGet200ResponsePricingLoadBalancerTypesInner.prototype['name'] = undefined;

/**
 * Load Balancer type costs per Location
 * @member {Array.<module:model/PricingGet200ResponsePricingLoadBalancerTypesInnerPricesInner>} prices
 */
PricingGet200ResponsePricingLoadBalancerTypesInner.prototype['prices'] = undefined;
...
export default PricingGet200ResponsePricingLoadBalancerTypesInner;
