...
/**
 * The PlacementGroupResponse model module.
 * @module model/PlacementGroupResponse
 * @version 1.0.0
 */
class PlacementGroupResponse {
    /**
     * Constructs a new <code>PlacementGroupResponse</code>.
     * @alias module:model/PlacementGroupResponse
     * @param placementGroup {module:model/PlacementGroup} 
     */
    constructor(placementGroup) { 
        
        PlacementGroupResponse.initialize(this, placementGroup);
    }
    ...
    /**
     * Constructs a <code>PlacementGroupResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PlacementGroupResponse} obj Optional instance to populate.
     * @return {module:model/PlacementGroupResponse} The populated <code>PlacementGroupResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PlacementGroupResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>PlacementGroupResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PlacementGroupResponse</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of PlacementGroupResponse.RequiredProperties) {
...
PlacementGroupResponse.RequiredProperties = ["placement_group"];

/**
 * @member {module:model/PlacementGroup} placement_group
 */
PlacementGroupResponse.prototype['placement_group'] = undefined;
...
export default PlacementGroupResponse;
