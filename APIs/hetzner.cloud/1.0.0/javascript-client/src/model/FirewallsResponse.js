...
/**
 * The FirewallsResponse model module.
 * @module model/FirewallsResponse
 * @version 1.0.0
 */
class FirewallsResponse {
    /**
     * Constructs a new <code>FirewallsResponse</code>.
     * @alias module:model/FirewallsResponse
     * @param firewalls {Array.<module:model/Firewall>} 
     */
    constructor(firewalls) { 
        
        FirewallsResponse.initialize(this, firewalls);
    }
    ...
    /**
     * Constructs a <code>FirewallsResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/FirewallsResponse} obj Optional instance to populate.
     * @return {module:model/FirewallsResponse} The populated <code>FirewallsResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new FirewallsResponse();

            if (data.hasOwnProperty('firewalls')) {
                obj['firewalls'] = ApiClient.convertToType(data['firewalls'], [Firewall]);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>FirewallsResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>FirewallsResponse</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of FirewallsResponse.RequiredProperties) {
...
FirewallsResponse.RequiredProperties = ["firewalls"];

/**
 * @member {Array.<module:model/Firewall>} firewalls
 */
FirewallsResponse.prototype['firewalls'] = undefined;

/**
 * @member {module:model/ActionsResponseMeta} meta
 */
FirewallsResponse.prototype['meta'] = undefined;
...
export default FirewallsResponse;
