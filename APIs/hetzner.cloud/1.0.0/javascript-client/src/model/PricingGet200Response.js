...
import PricingGet200ResponsePricing from './PricingGet200ResponsePricing';

/**
 * The PricingGet200Response model module.
 * @module model/PricingGet200Response
 * @version 1.0.0
 */
class PricingGet200Response {
    /**
     * Constructs a new <code>PricingGet200Response</code>.
     * @alias module:model/PricingGet200Response
     * @param pricing {module:model/PricingGet200ResponsePricing} 
     */
    constructor(pricing) { 
        
        PricingGet200Response.initialize(this, pricing);
    }
     ...
     */
    static initialize(obj, pricing) { 
        obj['pricing'] = pricing;
    }

    /**
     * Constructs a <code>PricingGet200Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PricingGet200Response} obj Optional instance to populate.
     * @return {module:model/PricingGet200Response} The populated <code>PricingGet200Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PricingGet200Response();

            if (data.hasOwnProperty('pricing')) {
                obj['pricing'] = PricingGet200ResponsePricing.constructFromObject(data['pricing']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>PricingGet200Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PricingGet200Response</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of PricingGet200Response.RequiredProperties) {
        ...
        if (data['pricing']) { // data not null
          PricingGet200ResponsePricing.validateJSON(data['pricing']);
        }
...
PricingGet200Response.RequiredProperties = ["pricing"];

/**
 * @member {module:model/PricingGet200ResponsePricing} pricing
 */
PricingGet200Response.prototype['pricing'] = undefined;
...
export default PricingGet200Response;
