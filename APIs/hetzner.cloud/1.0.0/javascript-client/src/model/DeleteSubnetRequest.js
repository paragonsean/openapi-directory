...
class DeleteSubnetRequest {
     ...
     * @param ipRange {String} IP range of subnet to delete
     */
    constructor(ipRange) { 
        
        DeleteSubnetRequest.initialize(this, ipRange);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DeleteSubnetRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>DeleteSubnetRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DeleteSubnetRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DeleteSubnetRequest.RequiredProperties) {
...
DeleteSubnetRequest.RequiredProperties = ["ip_range"];

/**
 * IP range of subnet to delete
 * @member {String} ip_range
 */
DeleteSubnetRequest.prototype['ip_range'] = undefined;
...
export default DeleteSubnetRequest;
