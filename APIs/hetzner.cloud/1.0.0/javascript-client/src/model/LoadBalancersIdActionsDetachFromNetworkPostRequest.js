...
/**
 * The LoadBalancersIdActionsDetachFromNetworkPostRequest model module.
 * @module model/LoadBalancersIdActionsDetachFromNetworkPostRequest
 * @version 1.0.0
 */
class LoadBalancersIdActionsDetachFromNetworkPostRequest {
    /**
     * Constructs a new <code>LoadBalancersIdActionsDetachFromNetworkPostRequest</code>.
     * @alias module:model/LoadBalancersIdActionsDetachFromNetworkPostRequest
     * @param network {Number} ID of an existing network to detach the Load Balancer from
     */
    constructor(network) { 
        
        LoadBalancersIdActionsDetachFromNetworkPostRequest.initialize(this, network);
    }
    ...
    /**
     * Constructs a <code>LoadBalancersIdActionsDetachFromNetworkPostRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/LoadBalancersIdActionsDetachFromNetworkPostRequest} obj Optional instance to populate.
     * @return {module:model/LoadBalancersIdActionsDetachFromNetworkPostRequest} The populated <code>LoadBalancersIdActionsDetachFromNetworkPostRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new LoadBalancersIdActionsDetachFromNetworkPostRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>LoadBalancersIdActionsDetachFromNetworkPostRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>LoadBalancersIdActionsDetachFromNetworkPostRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of LoadBalancersIdActionsDetachFromNetworkPostRequest.RequiredProperties) {
...
LoadBalancersIdActionsDetachFromNetworkPostRequest.RequiredProperties = ["network"];

/**
 * ID of an existing network to detach the Load Balancer from
 * @member {Number} network
 */
LoadBalancersIdActionsDetachFromNetworkPostRequest.prototype['network'] = undefined;
...
export default LoadBalancersIdActionsDetachFromNetworkPostRequest;
