...
/**
 * The PlacementGroupsResponse model module.
 * @module model/PlacementGroupsResponse
 * @version 1.0.0
 */
class PlacementGroupsResponse {
    /**
     * Constructs a new <code>PlacementGroupsResponse</code>.
     * @alias module:model/PlacementGroupsResponse
     * @param placementGroups {Array.<module:model/PlacementGroup>} 
     */
    constructor(placementGroups) { 
        
        PlacementGroupsResponse.initialize(this, placementGroups);
    }
     ...
     */
    static initialize(obj, placementGroups) { 
        obj['placement_groups'] = placementGroups;
    }

    /**
     * Constructs a <code>PlacementGroupsResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PlacementGroupsResponse} obj Optional instance to populate.
     * @return {module:model/PlacementGroupsResponse} The populated <code>PlacementGroupsResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PlacementGroupsResponse();

            if (data.hasOwnProperty('meta')) {
                obj['meta'] = ActionsResponseMeta.constructFromObject(data['meta']);
            }
            if (data.hasOwnProperty('placement_groups')) {
                obj['placement_groups'] = ApiClient.convertToType(data['placement_groups'], [PlacementGroup]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>PlacementGroupsResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PlacementGroupsResponse</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of PlacementGroupsResponse.RequiredProperties) {
        ...
        if (data['placement_groups']) { // data not null
            // ensure the json data is an array
            if (!Array.isArray(data['placement_groups'])) {
                throw new Error("Expected the field `placement_groups` to be an array in the JSON data but got " + data['placement_groups']);
            }
            // validate the optional field `placement_groups` (array)
            for (const item of data['placement_groups']) {
...
PlacementGroupsResponse.RequiredProperties = ["placement_groups"];

/**
 * @member {module:model/ActionsResponseMeta} meta
 */
PlacementGroupsResponse.prototype['meta'] = undefined;

/**
 * @member {Array.<module:model/PlacementGroup>} placement_groups
 */
PlacementGroupsResponse.prototype['placement_groups'] = undefined;
...
export default PlacementGroupsResponse;
