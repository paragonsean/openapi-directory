...
import ServersGet200ResponseServersInner from './ServersGet200ResponseServersInner';

/**
 * The ServersGet200Response model module.
 * @module model/ServersGet200Response
 * @version 1.0.0
 */
class ServersGet200Response {
    /**
     * Constructs a new <code>ServersGet200Response</code>.
     * @alias module:model/ServersGet200Response
     * @param servers {Array.<module:model/ServersGet200ResponseServersInner>} 
     */
    constructor(servers) { 
        
        ServersGet200Response.initialize(this, servers);
    }
    ...
    /**
     * Constructs a <code>ServersGet200Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ServersGet200Response} obj Optional instance to populate.
     * @return {module:model/ServersGet200Response} The populated <code>ServersGet200Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ServersGet200Response();

            if (data.hasOwnProperty('meta')) {
                obj['meta'] = ActionsResponseMeta.constructFromObject(data['meta']);
            }
            if (data.hasOwnProperty('servers')) {
                obj['servers'] = ApiClient.convertToType(data['servers'], [ServersGet200ResponseServersInner]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ServersGet200Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ServersGet200Response</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ServersGet200Response.RequiredProperties) {
        ...
        if (data['servers']) { // data not null
            ...
            for (const item of data['servers']) {
                ServersGet200ResponseServersInner.validateJSON(item);
            };
        }
...
ServersGet200Response.RequiredProperties = ["servers"];

/**
 * @member {module:model/ActionsResponseMeta} meta
 */
ServersGet200Response.prototype['meta'] = undefined;

/**
 * @member {Array.<module:model/ServersGet200ResponseServersInner>} servers
 */
ServersGet200Response.prototype['servers'] = undefined;
...
export default ServersGet200Response;
