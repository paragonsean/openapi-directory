...
/**
 * The PricingGet200ResponsePricingPrimaryIpsInnerPricesInnerPriceHourly model module.
 * @module model/PricingGet200ResponsePricingPrimaryIpsInnerPricesInnerPriceHourly
 * @version 1.0.0
 */
class PricingGet200ResponsePricingPrimaryIpsInnerPricesInnerPriceHourly {
    /**
     * Constructs a new <code>PricingGet200ResponsePricingPrimaryIpsInnerPricesInnerPriceHourly</code>.
     * Hourly costs for a Primary IP type in this Location
     * @alias module:model/PricingGet200ResponsePricingPrimaryIpsInnerPricesInnerPriceHourly
     * @param gross {String} Price with VAT added
     * @param net {String} Price without VAT
     */
    constructor(gross, net) { 
        
        PricingGet200ResponsePricingPrimaryIpsInnerPricesInnerPriceHourly.initialize(this, gross, net);
    }
    ...
    /**
     * Constructs a <code>PricingGet200ResponsePricingPrimaryIpsInnerPricesInnerPriceHourly</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PricingGet200ResponsePricingPrimaryIpsInnerPricesInnerPriceHourly} obj Optional instance to populate.
     * @return {module:model/PricingGet200ResponsePricingPrimaryIpsInnerPricesInnerPriceHourly} The populated <code>PricingGet200ResponsePricingPrimaryIpsInnerPricesInnerPriceHourly</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PricingGet200ResponsePricingPrimaryIpsInnerPricesInnerPriceHourly();
    ...
    /**
     * Validates the JSON data with respect to <code>PricingGet200ResponsePricingPrimaryIpsInnerPricesInnerPriceHourly</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PricingGet200ResponsePricingPrimaryIpsInnerPricesInnerPriceHourly</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of PricingGet200ResponsePricingPrimaryIpsInnerPricesInnerPriceHourly.RequiredProperties) {
...
PricingGet200ResponsePricingPrimaryIpsInnerPricesInnerPriceHourly.RequiredProperties = ["gross", "net"];

/**
 * Price with VAT added
 * @member {String} gross
 */
PricingGet200ResponsePricingPrimaryIpsInnerPricesInnerPriceHourly.prototype['gross'] = undefined;

/**
 * Price without VAT
 * @member {String} net
 */
PricingGet200ResponsePricingPrimaryIpsInnerPricesInnerPriceHourly.prototype['net'] = undefined;
...
export default PricingGet200ResponsePricingPrimaryIpsInnerPricesInnerPriceHourly;
