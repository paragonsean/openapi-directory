...
import CreateServerRequestFirewallsInner from './CreateServerRequestFirewallsInner';
import CreateServerRequestPublicNet from './CreateServerRequestPublicNet';
...
class CreateServerRequest {
     ...
     * @param image {String} ID or name of the Image the Server is created from
     * @param name {String} Name of the Server to create (must be unique per Project and a valid hostname as per RFC 1123)
     * @param serverType {String} ID or name of the Server type this Server should be created with
     */
    constructor(image, name, serverType) { 
        
        CreateServerRequest.initialize(this, image, name, serverType);
    }
     ...
     */
    static initialize(obj, image, name, serverType) { 
        obj['image'] = image;
        obj['name'] = name;
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('automount')) {
                obj['automount'] = ApiClient.convertToType(data['automount'], 'Boolean');
            }
            ...
            if (data.hasOwnProperty('firewalls')) {
                obj['firewalls'] = ApiClient.convertToType(data['firewalls'], [CreateServerRequestFirewallsInner]);
            }
            ...
            if (data.hasOwnProperty('placement_group')) {
                obj['placement_group'] = ApiClient.convertToType(data['placement_group'], 'Number');
            }
            if (data.hasOwnProperty('public_net')) {
                obj['public_net'] = CreateServerRequestPublicNet.constructFromObject(data['public_net']);
            }
            ...
            if (data.hasOwnProperty('start_after_create')) {
                obj['start_after_create'] = ApiClient.convertToType(data['start_after_create'], 'Boolean');
            }
    ...
    static validateJSON(data) {
        ...
        if (data['firewalls']) { // data not null
            ...
            for (const item of data['firewalls']) {
                CreateServerRequestFirewallsInner.validateJSON(item);
            };
        }
        // ensure the json data is a string
        ...
        if (data['public_net']) { // data not null
          CreateServerRequestPublicNet.validateJSON(data['public_net']);
        }
        // ensure the json data is a string
...
CreateServerRequest.RequiredProperties = ["image", "name", "server_type"];

/**
 * Auto-mount Volumes after attach
 * @member {Boolean} automount
 */
CreateServerRequest.prototype['automount'] = undefined;

/**
 * ID or name of Datacenter to create Server in (must not be used together with location)
 * @member {String} datacenter
 */
CreateServerRequest.prototype['datacenter'] = undefined;

/**
 * Firewalls which should be applied on the Server's public network interface at creation time
 * @member {Array.<module:model/CreateServerRequestFirewallsInner>} firewalls
 */
CreateServerRequest.prototype['firewalls'] = undefined;

/**
 * ID or name of the Image the Server is created from
 * @member {String} image
 */
CreateServerRequest.prototype['image'] = undefined;

/**
 * User-defined labels (key-value pairs)
 * @member {Object} labels
 */
CreateServerRequest.prototype['labels'] = undefined;

/**
 * ID or name of Location to create Server in (must not be used together with datacenter)
 * @member {String} location
 */
CreateServerRequest.prototype['location'] = undefined;

/**
 * Name of the Server to create (must be unique per Project and a valid hostname as per RFC 1123)
 * @member {String} name
 */
CreateServerRequest.prototype['name'] = undefined;

/**
 * Network IDs which should be attached to the Server private network interface at the creation time
 * @member {Array.<Number>} networks
 */
CreateServerRequest.prototype['networks'] = undefined;

/**
 * ID of the Placement Group the server should be in
 * @member {Number} placement_group
 */
CreateServerRequest.prototype['placement_group'] = undefined;

/**
 * @member {module:model/CreateServerRequestPublicNet} public_net
 */
CreateServerRequest.prototype['public_net'] = undefined;

/**
 * ID or name of the Server type this Server should be created with
 * @member {String} server_type
 */
CreateServerRequest.prototype['server_type'] = undefined;

/**
 * SSH key IDs (`integer`) or names (`string`) which should be injected into the Server at creation time
 * @member {Array.<String>} ssh_keys
 */
CreateServerRequest.prototype['ssh_keys'] = undefined;

/**
 * Start Server right after creation. Defaults to true.
 * @member {Boolean} start_after_create
 */
CreateServerRequest.prototype['start_after_create'] = undefined;

/**
 * Cloud-Init user data to use during Server creation. This field is limited to 32KiB.
 * @member {String} user_data
 */
CreateServerRequest.prototype['user_data'] = undefined;
 ...
 */
CreateServerRequest.prototype['volumes'] = undefined;
