...
/**
 * The NetworksGet200Response model module.
 * @module model/NetworksGet200Response
 * @version 1.0.0
 */
class NetworksGet200Response {
    /**
     * Constructs a new <code>NetworksGet200Response</code>.
     * @alias module:model/NetworksGet200Response
     * @param networks {Array.<module:model/NetworksGet200ResponseNetworksInner>} 
     */
    constructor(networks) { 
        
        NetworksGet200Response.initialize(this, networks);
    }
     ...
     */
    static initialize(obj, networks) { 
        obj['networks'] = networks;
    }

    /**
     * Constructs a <code>NetworksGet200Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/NetworksGet200Response} obj Optional instance to populate.
     * @return {module:model/NetworksGet200Response} The populated <code>NetworksGet200Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new NetworksGet200Response();

            if (data.hasOwnProperty('meta')) {
                obj['meta'] = ActionsResponseMeta.constructFromObject(data['meta']);
            }
            if (data.hasOwnProperty('networks')) {
                obj['networks'] = ApiClient.convertToType(data['networks'], [NetworksGet200ResponseNetworksInner]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>NetworksGet200Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>NetworksGet200Response</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of NetworksGet200Response.RequiredProperties) {
        ...
        if (data['networks']) { // data not null
            ...
            for (const item of data['networks']) {
                NetworksGet200ResponseNetworksInner.validateJSON(item);
            };
        }
...
NetworksGet200Response.RequiredProperties = ["networks"];

/**
 * @member {module:model/ActionsResponseMeta} meta
 */
NetworksGet200Response.prototype['meta'] = undefined;

/**
 * @member {Array.<module:model/NetworksGet200ResponseNetworksInner>} networks
 */
NetworksGet200Response.prototype['networks'] = undefined;
...
export default NetworksGet200Response;
