...
/**
 * The NetworksGet200ResponseNetworksInnerSubnetsInner model module.
 * @module model/NetworksGet200ResponseNetworksInnerSubnetsInner
 * @version 1.0.0
 */
class NetworksGet200ResponseNetworksInnerSubnetsInner {
    /**
     * Constructs a new <code>NetworksGet200ResponseNetworksInnerSubnetsInner</code>.
     * @alias module:model/NetworksGet200ResponseNetworksInnerSubnetsInner
     * @param gateway {String} Gateway for Servers attached to this subnet. For subnets of type Server this is always the first IP of the network IP range.
     ...
     * @param type {module:model/NetworksGet200ResponseNetworksInnerSubnetsInner.TypeEnum} Type of Subnetwork
     */
    constructor(gateway, networkZone, type) { 
        
        NetworksGet200ResponseNetworksInnerSubnetsInner.initialize(this, gateway, networkZone, type);
    }
     ...
     */
    static initialize(obj, gateway, networkZone, type) { 
        obj['gateway'] = gateway;
    ...
    /**
     * Constructs a <code>NetworksGet200ResponseNetworksInnerSubnetsInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/NetworksGet200ResponseNetworksInnerSubnetsInner} obj Optional instance to populate.
     * @return {module:model/NetworksGet200ResponseNetworksInnerSubnetsInner} The populated <code>NetworksGet200ResponseNetworksInnerSubnetsInner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new NetworksGet200ResponseNetworksInnerSubnetsInner();
    ...
    /**
     * Validates the JSON data with respect to <code>NetworksGet200ResponseNetworksInnerSubnetsInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>NetworksGet200ResponseNetworksInnerSubnetsInner</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of NetworksGet200ResponseNetworksInnerSubnetsInner.RequiredProperties) {
...
NetworksGet200ResponseNetworksInnerSubnetsInner.RequiredProperties = ["gateway", "network_zone", "type"];
 ...
 */
NetworksGet200ResponseNetworksInnerSubnetsInner.prototype['gateway'] = undefined;
 ...
 */
NetworksGet200ResponseNetworksInnerSubnetsInner.prototype['ip_range'] = undefined;
 ...
 */
NetworksGet200ResponseNetworksInnerSubnetsInner.prototype['network_zone'] = undefined;

/**
 * Type of Subnetwork
 * @member {module:model/NetworksGet200ResponseNetworksInnerSubnetsInner.TypeEnum} type
 */
NetworksGet200ResponseNetworksInnerSubnetsInner.prototype['type'] = undefined;
 ...
 * @readonly
 */
NetworksGet200ResponseNetworksInnerSubnetsInner['TypeEnum'] = {
...
export default NetworksGet200ResponseNetworksInnerSubnetsInner;
