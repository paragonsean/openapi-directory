...
class AttachVolumeRequest {
     ...
     * @param server {Number} ID of the Server the Volume will be attached to
     */
    constructor(server) { 
        
        AttachVolumeRequest.initialize(this, server);
    }
    ...
    /**
     * Validates the JSON data with respect to <code>AttachVolumeRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AttachVolumeRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of AttachVolumeRequest.RequiredProperties) {
...
AttachVolumeRequest.RequiredProperties = ["server"];

/**
 * Auto-mount the Volume after attaching it
 * @member {Boolean} automount
 */
AttachVolumeRequest.prototype['automount'] = undefined;

/**
 * ID of the Server the Volume will be attached to
 * @member {Number} server
 */
AttachVolumeRequest.prototype['server'] = undefined;
...
export default AttachVolumeRequest;
