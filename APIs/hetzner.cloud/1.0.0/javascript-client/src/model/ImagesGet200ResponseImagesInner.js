...
/**
 * The ImagesGet200ResponseImagesInner model module.
 * @module model/ImagesGet200ResponseImagesInner
 * @version 1.0.0
 */
class ImagesGet200ResponseImagesInner {
    /**
     * Constructs a new <code>ImagesGet200ResponseImagesInner</code>.
     * @alias module:model/ImagesGet200ResponseImagesInner
     ...
     * @param osFlavor {module:model/ImagesGet200ResponseImagesInner.OsFlavorEnum} Flavor of operating system contained in the Image
     ...
     * @param status {module:model/ImagesGet200ResponseImagesInner.StatusEnum} Whether the Image can be used or if it's still being created or unavailable
     * @param type {module:model/ImagesGet200ResponseImagesInner.TypeEnum} Type of the Image
     */
    constructor(boundTo, created, createdFrom, deleted, deprecated, description, diskSize, id, imageSize, labels, name, osFlavor, osVersion, protection, status, type) { 
        ...
        ImagesGet200ResponseImagesInner.initialize(this, boundTo, created, createdFrom, deleted, deprecated, description, diskSize, id, imageSize, labels, name, osFlavor, osVersion, protection, status, type);
    }
    ...
    /**
     * Constructs a <code>ImagesGet200ResponseImagesInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ImagesGet200ResponseImagesInner} obj Optional instance to populate.
     * @return {module:model/ImagesGet200ResponseImagesInner} The populated <code>ImagesGet200ResponseImagesInner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ImagesGet200ResponseImagesInner();
    ...
    /**
     * Validates the JSON data with respect to <code>ImagesGet200ResponseImagesInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ImagesGet200ResponseImagesInner</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ImagesGet200ResponseImagesInner.RequiredProperties) {
...
ImagesGet200ResponseImagesInner.RequiredProperties = ["bound_to", "created", "created_from", "deleted", "deprecated", "description", "disk_size", "id", "image_size", "labels", "name", "os_flavor", "os_version", "protection", "status", "type"];

/**
 * ID of Server the Image is bound to. Only set for Images of type `backup`.
 * @member {Number} bound_to
 */
ImagesGet200ResponseImagesInner.prototype['bound_to'] = undefined;

/**
 * Point in time when the Resource was created (in ISO-8601 format)
 * @member {String} created
 */
ImagesGet200ResponseImagesInner.prototype['created'] = undefined;

/**
 * @member {module:model/ImagesGet200ResponseImagesInnerCreatedFrom} created_from
 */
ImagesGet200ResponseImagesInner.prototype['created_from'] = undefined;

/**
 * Point in time where the Image was deleted (in ISO-8601 format)
 * @member {String} deleted
 */
ImagesGet200ResponseImagesInner.prototype['deleted'] = undefined;

/**
 * Point in time when the Image is considered to be deprecated (in ISO-8601 format)
 * @member {String} deprecated
 */
ImagesGet200ResponseImagesInner.prototype['deprecated'] = undefined;

/**
 * Description of the Image
 * @member {String} description
 */
ImagesGet200ResponseImagesInner.prototype['description'] = undefined;

/**
 * Size of the disk contained in the Image in GB
 * @member {Number} disk_size
 */
ImagesGet200ResponseImagesInner.prototype['disk_size'] = undefined;

/**
 * ID of the Resource
 * @member {Number} id
 */
ImagesGet200ResponseImagesInner.prototype['id'] = undefined;

/**
 * Size of the Image file in our storage in GB. For snapshot Images this is the value relevant for calculating costs for the Image.
 * @member {Number} image_size
 */
ImagesGet200ResponseImagesInner.prototype['image_size'] = undefined;

/**
 * User-defined labels (key-value pairs)
 * @member {Object.<String, String>} labels
 */
ImagesGet200ResponseImagesInner.prototype['labels'] = undefined;

/**
 * Unique identifier of the Image. This value is only set for system Images.
 * @member {String} name
 */
ImagesGet200ResponseImagesInner.prototype['name'] = undefined;

/**
 * Flavor of operating system contained in the Image
 * @member {module:model/ImagesGet200ResponseImagesInner.OsFlavorEnum} os_flavor
 */
ImagesGet200ResponseImagesInner.prototype['os_flavor'] = undefined;

/**
 * Operating system version
 * @member {String} os_version
 */
ImagesGet200ResponseImagesInner.prototype['os_version'] = undefined;

/**
 * @member {module:model/FloatingIpsGet200ResponseFloatingIpsInnerProtection} protection
 */
ImagesGet200ResponseImagesInner.prototype['protection'] = undefined;

/**
 * Indicates that rapid deploy of the Image is available
 * @member {Boolean} rapid_deploy
 */
ImagesGet200ResponseImagesInner.prototype['rapid_deploy'] = undefined;

/**
 * Whether the Image can be used or if it's still being created or unavailable
 * @member {module:model/ImagesGet200ResponseImagesInner.StatusEnum} status
 */
ImagesGet200ResponseImagesInner.prototype['status'] = undefined;

/**
 * Type of the Image
 * @member {module:model/ImagesGet200ResponseImagesInner.TypeEnum} type
 */
ImagesGet200ResponseImagesInner.prototype['type'] = undefined;
 ...
 * @readonly
 */
ImagesGet200ResponseImagesInner['StatusEnum'] = {
 ...
 * @readonly
 */
ImagesGet200ResponseImagesInner['TypeEnum'] = {
...
export default ImagesGet200ResponseImagesInner;
