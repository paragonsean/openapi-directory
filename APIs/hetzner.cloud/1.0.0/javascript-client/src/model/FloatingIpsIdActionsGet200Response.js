...
/**
 * The FloatingIpsIdActionsGet200Response model module.
 * @module model/FloatingIpsIdActionsGet200Response
 * @version 1.0.0
 */
class FloatingIpsIdActionsGet200Response {
    /**
     * Constructs a new <code>FloatingIpsIdActionsGet200Response</code>.
     * @alias module:model/FloatingIpsIdActionsGet200Response
     * @param actions {Array.<module:model/Action>} 
     */
    constructor(actions) { 
        
        FloatingIpsIdActionsGet200Response.initialize(this, actions);
    }
    ...
    /**
     * Constructs a <code>FloatingIpsIdActionsGet200Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/FloatingIpsIdActionsGet200Response} obj Optional instance to populate.
     * @return {module:model/FloatingIpsIdActionsGet200Response} The populated <code>FloatingIpsIdActionsGet200Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new FloatingIpsIdActionsGet200Response();
    ...
    /**
     * Validates the JSON data with respect to <code>FloatingIpsIdActionsGet200Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>FloatingIpsIdActionsGet200Response</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of FloatingIpsIdActionsGet200Response.RequiredProperties) {
...
FloatingIpsIdActionsGet200Response.RequiredProperties = ["actions"];

/**
 * @member {Array.<module:model/Action>} actions
 */
FloatingIpsIdActionsGet200Response.prototype['actions'] = undefined;
...
export default FloatingIpsIdActionsGet200Response;
