...
/**
 * The UpdateNetworkRequestLabels model module.
 * @module model/UpdateNetworkRequestLabels
 * @version 1.0.0
 */
class UpdateNetworkRequestLabels {
    /**
     * Constructs a new <code>UpdateNetworkRequestLabels</code>.
     * User-defined labels (key-value pairs)
     * @alias module:model/UpdateNetworkRequestLabels
     */
    constructor() { 
        
        UpdateNetworkRequestLabels.initialize(this);
    }
    ...
    /**
     * Constructs a <code>UpdateNetworkRequestLabels</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateNetworkRequestLabels} obj Optional instance to populate.
     * @return {module:model/UpdateNetworkRequestLabels} The populated <code>UpdateNetworkRequestLabels</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateNetworkRequestLabels();
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateNetworkRequestLabels</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateNetworkRequestLabels</code>.
     */
 ...
 */
UpdateNetworkRequestLabels.prototype['labelkey'] = undefined;
...
export default UpdateNetworkRequestLabels;
