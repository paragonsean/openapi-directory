...
/**
 * The PricingGet200ResponsePricingImage model module.
 * @module model/PricingGet200ResponsePricingImage
 * @version 1.0.0
 */
class PricingGet200ResponsePricingImage {
    /**
     * Constructs a new <code>PricingGet200ResponsePricingImage</code>.
     * The cost of Image per GB/month
     * @alias module:model/PricingGet200ResponsePricingImage
     * @param pricePerGbMonth {module:model/PricingGet200ResponsePricingFloatingIpPriceMonthly} 
     */
    constructor(pricePerGbMonth) { 
        
        PricingGet200ResponsePricingImage.initialize(this, pricePerGbMonth);
    }
    ...
    /**
     * Constructs a <code>PricingGet200ResponsePricingImage</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PricingGet200ResponsePricingImage} obj Optional instance to populate.
     * @return {module:model/PricingGet200ResponsePricingImage} The populated <code>PricingGet200ResponsePricingImage</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PricingGet200ResponsePricingImage();
    ...
    /**
     * Validates the JSON data with respect to <code>PricingGet200ResponsePricingImage</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PricingGet200ResponsePricingImage</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of PricingGet200ResponsePricingImage.RequiredProperties) {
...
PricingGet200ResponsePricingImage.RequiredProperties = ["price_per_gb_month"];

/**
 * @member {module:model/PricingGet200ResponsePricingFloatingIpPriceMonthly} price_per_gb_month
 */
PricingGet200ResponsePricingImage.prototype['price_per_gb_month'] = undefined;
...
export default PricingGet200ResponsePricingImage;
