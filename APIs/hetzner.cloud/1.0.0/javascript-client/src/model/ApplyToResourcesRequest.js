...
import FirewallApplyToResources from './FirewallApplyToResources';

/**
 * The ApplyToResourcesRequest model module.
 * @module model/ApplyToResourcesRequest
 * @version 1.0.0
 */
class ApplyToResourcesRequest {
    /**
     * Constructs a new <code>ApplyToResourcesRequest</code>.
     * @alias module:model/ApplyToResourcesRequest
     * @param applyTo {Array.<module:model/FirewallApplyToResources>} Resources the Firewall should be applied to
     */
    constructor(applyTo) { 
        
        ApplyToResourcesRequest.initialize(this, applyTo);
    }
     ...
     */
    static initialize(obj, applyTo) { 
        obj['apply_to'] = applyTo;
    }

    /**
     * Constructs a <code>ApplyToResourcesRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ApplyToResourcesRequest} obj Optional instance to populate.
     * @return {module:model/ApplyToResourcesRequest} The populated <code>ApplyToResourcesRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ApplyToResourcesRequest();

            if (data.hasOwnProperty('apply_to')) {
                obj['apply_to'] = ApiClient.convertToType(data['apply_to'], [FirewallApplyToResources]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ApplyToResourcesRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ApplyToResourcesRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ApplyToResourcesRequest.RequiredProperties) {
            if (!data.hasOwnProperty(property)) {
                throw new Error("The required field `" + property + "` is not found in the JSON data: " + JSON.stringify(data));
            }
        }
        if (data['apply_to']) { // data not null
            ...
            // validate the optional field `apply_to` (array)
            for (const item of data['apply_to']) {
                FirewallApplyToResources.validateJSON(item);
            };
        }
...
ApplyToResourcesRequest.RequiredProperties = ["apply_to"];

/**
 * Resources the Firewall should be applied to
 * @member {Array.<module:model/FirewallApplyToResources>} apply_to
 */
ApplyToResourcesRequest.prototype['apply_to'] = undefined;
...
export default ApplyToResourcesRequest;
