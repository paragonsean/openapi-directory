...
class LocationsGet200Response {
     ...
     * @param locations {Array.<module:model/DatacentersGet200ResponseDatacentersInnerLocation>} 
     */
    constructor(locations) { 
        
        LocationsGet200Response.initialize(this, locations);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('locations')) {
                obj['locations'] = ApiClient.convertToType(data['locations'], [DatacentersGet200ResponseDatacentersInnerLocation]);
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        for (const property of LocationsGet200Response.RequiredProperties) {
        ...
        if (data['locations']) { // data not null
            ...
            for (const item of data['locations']) {
                DatacentersGet200ResponseDatacentersInnerLocation.validateJSON(item);
            };
        }
...
LocationsGet200Response.RequiredProperties = ["locations"];

/**
 * @member {Array.<module:model/DatacentersGet200ResponseDatacentersInnerLocation>} locations
 */
LocationsGet200Response.prototype['locations'] = undefined;
