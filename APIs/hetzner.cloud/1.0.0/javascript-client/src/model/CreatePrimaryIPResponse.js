...
/**
 * The CreatePrimaryIPResponse model module.
 * @module model/CreatePrimaryIPResponse
 * @version 1.0.0
 */
class CreatePrimaryIPResponse {
    /**
     * Constructs a new <code>CreatePrimaryIPResponse</code>.
     * @alias module:model/CreatePrimaryIPResponse
     * @param primaryIp {module:model/PrimaryIP} 
     */
    constructor(primaryIp) { 
        
        CreatePrimaryIPResponse.initialize(this, primaryIp);
    }
     ...
     */
    static initialize(obj, primaryIp) { 
        obj['primary_ip'] = primaryIp;
    }

    /**
     * Constructs a <code>CreatePrimaryIPResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreatePrimaryIPResponse} obj Optional instance to populate.
     * @return {module:model/CreatePrimaryIPResponse} The populated <code>CreatePrimaryIPResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreatePrimaryIPResponse();

            if (data.hasOwnProperty('action')) {
                obj['action'] = Action.constructFromObject(data['action']);
            }
            if (data.hasOwnProperty('primary_ip')) {
                obj['primary_ip'] = PrimaryIP.constructFromObject(data['primary_ip']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>CreatePrimaryIPResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreatePrimaryIPResponse</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CreatePrimaryIPResponse.RequiredProperties) {
        ...
        if (data['primary_ip']) { // data not null
          PrimaryIP.validateJSON(data['primary_ip']);
        }
...
CreatePrimaryIPResponse.RequiredProperties = ["primary_ip"];

/**
 * @member {module:model/Action} action
 */
CreatePrimaryIPResponse.prototype['action'] = undefined;

/**
 * @member {module:model/PrimaryIP} primary_ip
 */
CreatePrimaryIPResponse.prototype['primary_ip'] = undefined;
...
export default CreatePrimaryIPResponse;
