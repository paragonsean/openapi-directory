...
import FirewallAppliedToInner from './FirewallAppliedToInner';
...
class Firewall {
     ...
     * @param appliedTo {Array.<module:model/FirewallAppliedToInner>} 
     ...
     */
    constructor(appliedTo, created, id, name, rules) { 
        
        Firewall.initialize(this, appliedTo, created, id, name, rules);
    }
     ...
     */
    static initialize(obj, appliedTo, created, id, name, rules) { 
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('applied_to')) {
                obj['applied_to'] = ApiClient.convertToType(data['applied_to'], [FirewallAppliedToInner]);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>Firewall</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Firewall</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of Firewall.RequiredProperties) {
        ...
        if (data['applied_to']) { // data not null
            ...
            for (const item of data['applied_to']) {
                FirewallAppliedToInner.validateJSON(item);
            };
        }
...
Firewall.RequiredProperties = ["applied_to", "created", "id", "name", "rules"];

/**
 * @member {Array.<module:model/FirewallAppliedToInner>} applied_to
 */
Firewall.prototype['applied_to'] = undefined;
 ...
 */
Firewall.prototype['labels'] = undefined;
