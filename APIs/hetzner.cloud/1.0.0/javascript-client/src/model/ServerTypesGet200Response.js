...
/**
 * The ServerTypesGet200Response model module.
 * @module model/ServerTypesGet200Response
 * @version 1.0.0
 */
class ServerTypesGet200Response {
    /**
     * Constructs a new <code>ServerTypesGet200Response</code>.
     * @alias module:model/ServerTypesGet200Response
     * @param serverTypes {Array.<module:model/ServerTypesGet200ResponseServerTypesInner>} 
     */
    constructor(serverTypes) { 
        
        ServerTypesGet200Response.initialize(this, serverTypes);
    }
     ...
     */
    static initialize(obj, serverTypes) { 
        obj['server_types'] = serverTypes;
    }

    /**
     * Constructs a <code>ServerTypesGet200Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ServerTypesGet200Response} obj Optional instance to populate.
     * @return {module:model/ServerTypesGet200Response} The populated <code>ServerTypesGet200Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ServerTypesGet200Response();

            if (data.hasOwnProperty('server_types')) {
                obj['server_types'] = ApiClient.convertToType(data['server_types'], [ServerTypesGet200ResponseServerTypesInner]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ServerTypesGet200Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ServerTypesGet200Response</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ServerTypesGet200Response.RequiredProperties) {
        ...
        if (data['server_types']) { // data not null
            ...
            for (const item of data['server_types']) {
                ServerTypesGet200ResponseServerTypesInner.validateJSON(item);
            };
        }
...
ServerTypesGet200Response.RequiredProperties = ["server_types"];

/**
 * @member {Array.<module:model/ServerTypesGet200ResponseServerTypesInner>} server_types
 */
ServerTypesGet200Response.prototype['server_types'] = undefined;
...
export default ServerTypesGet200Response;
