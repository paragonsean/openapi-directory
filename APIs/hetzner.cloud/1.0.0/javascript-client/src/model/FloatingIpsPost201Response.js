...
import FloatingIpsGet200ResponseFloatingIpsInner from './FloatingIpsGet200ResponseFloatingIpsInner';

/**
 * The FloatingIpsPost201Response model module.
 * @module model/FloatingIpsPost201Response
 * @version 1.0.0
 */
class FloatingIpsPost201Response {
    /**
     * Constructs a new <code>FloatingIpsPost201Response</code>.
     * @alias module:model/FloatingIpsPost201Response
     * @param floatingIp {module:model/FloatingIpsGet200ResponseFloatingIpsInner} 
     */
    constructor(floatingIp) { 
        
        FloatingIpsPost201Response.initialize(this, floatingIp);
    }
     ...
     */
    static initialize(obj, floatingIp) { 
        obj['floating_ip'] = floatingIp;
    }

    /**
     * Constructs a <code>FloatingIpsPost201Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/FloatingIpsPost201Response} obj Optional instance to populate.
     * @return {module:model/FloatingIpsPost201Response} The populated <code>FloatingIpsPost201Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new FloatingIpsPost201Response();

            if (data.hasOwnProperty('action')) {
                obj['action'] = Action.constructFromObject(data['action']);
            }
            if (data.hasOwnProperty('floating_ip')) {
                obj['floating_ip'] = FloatingIpsGet200ResponseFloatingIpsInner.constructFromObject(data['floating_ip']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>FloatingIpsPost201Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>FloatingIpsPost201Response</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of FloatingIpsPost201Response.RequiredProperties) {
        ...
        if (data['floating_ip']) { // data not null
          FloatingIpsGet200ResponseFloatingIpsInner.validateJSON(data['floating_ip']);
        }
...
FloatingIpsPost201Response.RequiredProperties = ["floating_ip"];

/**
 * @member {module:model/Action} action
 */
FloatingIpsPost201Response.prototype['action'] = undefined;

/**
 * @member {module:model/FloatingIpsGet200ResponseFloatingIpsInner} floating_ip
 */
FloatingIpsPost201Response.prototype['floating_ip'] = undefined;
...
export default FloatingIpsPost201Response;
