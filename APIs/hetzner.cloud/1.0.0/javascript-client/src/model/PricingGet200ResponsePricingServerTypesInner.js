...
import PricingGet200ResponsePricingServerTypesInnerPricesInner from './PricingGet200ResponsePricingServerTypesInnerPricesInner';

/**
 * The PricingGet200ResponsePricingServerTypesInner model module.
 * @module model/PricingGet200ResponsePricingServerTypesInner
 * @version 1.0.0
 */
class PricingGet200ResponsePricingServerTypesInner {
    /**
     * Constructs a new <code>PricingGet200ResponsePricingServerTypesInner</code>.
     * @alias module:model/PricingGet200ResponsePricingServerTypesInner
     * @param id {Number} ID of the Server type the price is for
     * @param name {String} Name of the Server type the price is for
     * @param prices {Array.<module:model/PricingGet200ResponsePricingServerTypesInnerPricesInner>} Server type costs per Location
     */
    constructor(id, name, prices) { 
        
        PricingGet200ResponsePricingServerTypesInner.initialize(this, id, name, prices);
    }
    ...
    /**
     * Constructs a <code>PricingGet200ResponsePricingServerTypesInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PricingGet200ResponsePricingServerTypesInner} obj Optional instance to populate.
     * @return {module:model/PricingGet200ResponsePricingServerTypesInner} The populated <code>PricingGet200ResponsePricingServerTypesInner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PricingGet200ResponsePricingServerTypesInner();
            ...
            if (data.hasOwnProperty('prices')) {
                obj['prices'] = ApiClient.convertToType(data['prices'], [PricingGet200ResponsePricingServerTypesInnerPricesInner]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>PricingGet200ResponsePricingServerTypesInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PricingGet200ResponsePricingServerTypesInner</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of PricingGet200ResponsePricingServerTypesInner.RequiredProperties) {
        ...
        if (data['prices']) { // data not null
            ...
            for (const item of data['prices']) {
                PricingGet200ResponsePricingServerTypesInnerPricesInner.validateJSON(item);
            };
        }
...
PricingGet200ResponsePricingServerTypesInner.RequiredProperties = ["id", "name", "prices"];

/**
 * ID of the Server type the price is for
 * @member {Number} id
 */
PricingGet200ResponsePricingServerTypesInner.prototype['id'] = undefined;

/**
 * Name of the Server type the price is for
 * @member {String} name
 */
PricingGet200ResponsePricingServerTypesInner.prototype['name'] = undefined;

/**
 * Server type costs per Location
 * @member {Array.<module:model/PricingGet200ResponsePricingServerTypesInnerPricesInner>} prices
 */
PricingGet200ResponsePricingServerTypesInner.prototype['prices'] = undefined;
...
export default PricingGet200ResponsePricingServerTypesInner;
