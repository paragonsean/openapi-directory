...
import LoadBalancerServiceHealthCheckHttp from './LoadBalancerServiceHealthCheckHttp';

/**
 * The LoadBalancerServiceHealthCheck model module.
 * @module model/LoadBalancerServiceHealthCheck
 * @version 1.0.0
 */
class LoadBalancerServiceHealthCheck {
    /**
     * Constructs a new <code>LoadBalancerServiceHealthCheck</code>.
     * Service health check
     * @alias module:model/LoadBalancerServiceHealthCheck
     * @param interval {Number} Time interval in seconds health checks are performed
     * @param port {Number} Port the health check will be performed on
     * @param protocol {module:model/LoadBalancerServiceHealthCheck.ProtocolEnum} Type of the health check
     * @param retries {Number} Unsuccessful retries needed until a target is considered unhealthy; an unhealthy target needs the same number of successful retries to become healthy again
     * @param timeout {Number} Time in seconds after an attempt is considered a timeout
     */
    constructor(interval, port, protocol, retries, timeout) { 
        
        LoadBalancerServiceHealthCheck.initialize(this, interval, port, protocol, retries, timeout);
    }
     ...
     */
    static initialize(obj, interval, port, protocol, retries, timeout) { 
    ...
    /**
     * Constructs a <code>LoadBalancerServiceHealthCheck</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/LoadBalancerServiceHealthCheck} obj Optional instance to populate.
     * @return {module:model/LoadBalancerServiceHealthCheck} The populated <code>LoadBalancerServiceHealthCheck</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new LoadBalancerServiceHealthCheck();

            if (data.hasOwnProperty('http')) {
                obj['http'] = LoadBalancerServiceHealthCheckHttp.constructFromObject(data['http']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>LoadBalancerServiceHealthCheck</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>LoadBalancerServiceHealthCheck</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of LoadBalancerServiceHealthCheck.RequiredProperties) {
        ...
        if (data['http']) { // data not null
          LoadBalancerServiceHealthCheckHttp.validateJSON(data['http']);
        }
...
LoadBalancerServiceHealthCheck.RequiredProperties = ["interval", "port", "protocol", "retries", "timeout"];

/**
 * @member {module:model/LoadBalancerServiceHealthCheckHttp} http
 */
LoadBalancerServiceHealthCheck.prototype['http'] = undefined;

/**
 * Time interval in seconds health checks are performed
 * @member {Number} interval
 */
LoadBalancerServiceHealthCheck.prototype['interval'] = undefined;

/**
 * Port the health check will be performed on
 * @member {Number} port
 */
LoadBalancerServiceHealthCheck.prototype['port'] = undefined;

/**
 * Type of the health check
 * @member {module:model/LoadBalancerServiceHealthCheck.ProtocolEnum} protocol
 */
LoadBalancerServiceHealthCheck.prototype['protocol'] = undefined;
 ...
 */
LoadBalancerServiceHealthCheck.prototype['retries'] = undefined;

/**
 * Time in seconds after an attempt is considered a timeout
 * @member {Number} timeout
 */
LoadBalancerServiceHealthCheck.prototype['timeout'] = undefined;
 ...
 * @readonly
 */
LoadBalancerServiceHealthCheck['ProtocolEnum'] = {
...
export default LoadBalancerServiceHealthCheck;
