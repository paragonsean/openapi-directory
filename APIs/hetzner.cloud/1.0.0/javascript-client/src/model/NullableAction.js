...
/**
 * The NullableAction model module.
 * @module model/NullableAction
 * @version 1.0.0
 */
class NullableAction {
    /**
     * Constructs a new <code>NullableAction</code>.
     * @alias module:model/NullableAction
     ...
     * @param status {module:model/NullableAction.StatusEnum} Status of the Action
     */
    constructor(command, error, finished, id, progress, resources, started, status) { 
        
        NullableAction.initialize(this, command, error, finished, id, progress, resources, started, status);
    }
    ...
    /**
     * Constructs a <code>NullableAction</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/NullableAction} obj Optional instance to populate.
     * @return {module:model/NullableAction} The populated <code>NullableAction</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new NullableAction();
    ...
    /**
     * Validates the JSON data with respect to <code>NullableAction</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>NullableAction</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of NullableAction.RequiredProperties) {
...
NullableAction.RequiredProperties = ["command", "error", "finished", "id", "progress", "resources", "started", "status"];

/**
 * Command executed in the Action
 * @member {String} command
 */
NullableAction.prototype['command'] = undefined;

/**
 * @member {module:model/ActionError} error
 */
NullableAction.prototype['error'] = undefined;

/**
 * Point in time when the Action was finished (in ISO-8601 format). Only set if the Action is finished otherwise null.
 * @member {String} finished
 */
NullableAction.prototype['finished'] = undefined;

/**
 * ID of the Resource
 * @member {Number} id
 */
NullableAction.prototype['id'] = undefined;

/**
 * Progress of Action in percent
 * @member {Number} progress
 */
NullableAction.prototype['progress'] = undefined;

/**
 * Resources the Action relates to
 * @member {Array.<module:model/ActionResourcesInner>} resources
 */
NullableAction.prototype['resources'] = undefined;

/**
 * Point in time when the Action was started (in ISO-8601 format)
 * @member {String} started
 */
NullableAction.prototype['started'] = undefined;

/**
 * Status of the Action
 * @member {module:model/NullableAction.StatusEnum} status
 */
NullableAction.prototype['status'] = undefined;
