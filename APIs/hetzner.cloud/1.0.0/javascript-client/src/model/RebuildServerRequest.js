...
/**
 * The RebuildServerRequest model module.
 * @module model/RebuildServerRequest
 * @version 1.0.0
 */
class RebuildServerRequest {
    /**
     * Constructs a new <code>RebuildServerRequest</code>.
     * @alias module:model/RebuildServerRequest
     * @param image {String} ID or name of Image to rebuilt from.
     */
    constructor(image) { 
        
        RebuildServerRequest.initialize(this, image);
    }
    ...
    /**
     * Constructs a <code>RebuildServerRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/RebuildServerRequest} obj Optional instance to populate.
     * @return {module:model/RebuildServerRequest} The populated <code>RebuildServerRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RebuildServerRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>RebuildServerRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RebuildServerRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of RebuildServerRequest.RequiredProperties) {
...
RebuildServerRequest.RequiredProperties = ["image"];

/**
 * ID or name of Image to rebuilt from.
 * @member {String} image
 */
RebuildServerRequest.prototype['image'] = undefined;
...
export default RebuildServerRequest;
