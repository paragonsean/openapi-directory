...
/**
 * The LoadBalancersIdActionsDeleteServicePostRequest model module.
 * @module model/LoadBalancersIdActionsDeleteServicePostRequest
 * @version 1.0.0
 */
class LoadBalancersIdActionsDeleteServicePostRequest {
    /**
     * Constructs a new <code>LoadBalancersIdActionsDeleteServicePostRequest</code>.
     * @alias module:model/LoadBalancersIdActionsDeleteServicePostRequest
     * @param listenPort {Number} The listen port of the service you want to delete
     */
    constructor(listenPort) { 
        
        LoadBalancersIdActionsDeleteServicePostRequest.initialize(this, listenPort);
    }
     ...
     */
    static initialize(obj, listenPort) { 
        obj['listen_port'] = listenPort;
    }

    /**
     * Constructs a <code>LoadBalancersIdActionsDeleteServicePostRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/LoadBalancersIdActionsDeleteServicePostRequest} obj Optional instance to populate.
     * @return {module:model/LoadBalancersIdActionsDeleteServicePostRequest} The populated <code>LoadBalancersIdActionsDeleteServicePostRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new LoadBalancersIdActionsDeleteServicePostRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>LoadBalancersIdActionsDeleteServicePostRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>LoadBalancersIdActionsDeleteServicePostRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of LoadBalancersIdActionsDeleteServicePostRequest.RequiredProperties) {
...
LoadBalancersIdActionsDeleteServicePostRequest.RequiredProperties = ["listen_port"];

/**
 * The listen port of the service you want to delete
 * @member {Number} listen_port
 */
LoadBalancersIdActionsDeleteServicePostRequest.prototype['listen_port'] = undefined;
...
export default LoadBalancersIdActionsDeleteServicePostRequest;
