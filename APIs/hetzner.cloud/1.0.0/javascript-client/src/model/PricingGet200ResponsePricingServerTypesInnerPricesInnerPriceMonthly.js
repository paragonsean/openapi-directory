...
/**
 * The PricingGet200ResponsePricingServerTypesInnerPricesInnerPriceMonthly model module.
 * @module model/PricingGet200ResponsePricingServerTypesInnerPricesInnerPriceMonthly
 * @version 1.0.0
 */
class PricingGet200ResponsePricingServerTypesInnerPricesInnerPriceMonthly {
    /**
     * Constructs a new <code>PricingGet200ResponsePricingServerTypesInnerPricesInnerPriceMonthly</code>.
     * Monthly costs for a Server type in this Location
     * @alias module:model/PricingGet200ResponsePricingServerTypesInnerPricesInnerPriceMonthly
     * @param gross {String} Price with VAT added
     * @param net {String} Price without VAT
     */
    constructor(gross, net) { 
        
        PricingGet200ResponsePricingServerTypesInnerPricesInnerPriceMonthly.initialize(this, gross, net);
    }
    ...
    /**
     * Constructs a <code>PricingGet200ResponsePricingServerTypesInnerPricesInnerPriceMonthly</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PricingGet200ResponsePricingServerTypesInnerPricesInnerPriceMonthly} obj Optional instance to populate.
     * @return {module:model/PricingGet200ResponsePricingServerTypesInnerPricesInnerPriceMonthly} The populated <code>PricingGet200ResponsePricingServerTypesInnerPricesInnerPriceMonthly</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PricingGet200ResponsePricingServerTypesInnerPricesInnerPriceMonthly();
    ...
    /**
     * Validates the JSON data with respect to <code>PricingGet200ResponsePricingServerTypesInnerPricesInnerPriceMonthly</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PricingGet200ResponsePricingServerTypesInnerPricesInnerPriceMonthly</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of PricingGet200ResponsePricingServerTypesInnerPricesInnerPriceMonthly.RequiredProperties) {
...
PricingGet200ResponsePricingServerTypesInnerPricesInnerPriceMonthly.RequiredProperties = ["gross", "net"];

/**
 * Price with VAT added
 * @member {String} gross
 */
PricingGet200ResponsePricingServerTypesInnerPricesInnerPriceMonthly.prototype['gross'] = undefined;

/**
 * Price without VAT
 * @member {String} net
 */
PricingGet200ResponsePricingServerTypesInnerPricesInnerPriceMonthly.prototype['net'] = undefined;
...
export default PricingGet200ResponsePricingServerTypesInnerPricesInnerPriceMonthly;
