...
/**
 * The UpdatePlacementGroupRequest model module.
 * @module model/UpdatePlacementGroupRequest
 * @version 1.0.0
 */
class UpdatePlacementGroupRequest {
    /**
     * Constructs a new <code>UpdatePlacementGroupRequest</code>.
     * @alias module:model/UpdatePlacementGroupRequest
     */
    constructor() { 
        
        UpdatePlacementGroupRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>UpdatePlacementGroupRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdatePlacementGroupRequest} obj Optional instance to populate.
     * @return {module:model/UpdatePlacementGroupRequest} The populated <code>UpdatePlacementGroupRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdatePlacementGroupRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>UpdatePlacementGroupRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdatePlacementGroupRequest</code>.
     */
 ...
 */
UpdatePlacementGroupRequest.prototype['labels'] = undefined;

/**
 * New PlacementGroup name
 * @member {String} name
 */
UpdatePlacementGroupRequest.prototype['name'] = undefined;
...
export default UpdatePlacementGroupRequest;
