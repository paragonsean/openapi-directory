...
/**
 * The LoadBalancersIdMetricsGet200ResponseMetricsTimeSeriesValueValuesInnerInner model module.
 * @module model/LoadBalancersIdMetricsGet200ResponseMetricsTimeSeriesValueValuesInnerInner
 * @version 1.0.0
 */
class LoadBalancersIdMetricsGet200ResponseMetricsTimeSeriesValueValuesInnerInner {
    /**
     * Constructs a new <code>LoadBalancersIdMetricsGet200ResponseMetricsTimeSeriesValueValuesInnerInner</code>.
     * @alias module:model/LoadBalancersIdMetricsGet200ResponseMetricsTimeSeriesValueValuesInnerInner
     * @param {(module:model/Number|module:model/String)} instance The actual instance to initialize LoadBalancersIdMetricsGet200ResponseMetricsTimeSeriesValueValuesInnerInner.
     */
    constructor(instance = null) {
        ...
        if (match > 1) {
            throw new Error("Multiple matches found constructing `LoadBalancersIdMetricsGet200ResponseMetricsTimeSeriesValueValuesInnerInner` with oneOf schemas Number, String. Input: " + JSON.stringify(instance));
        } else if (match === 0) {
            this.actualInstance = null; // clear the actual instance in case there are multiple matches
            throw new Error("No match found constructing `LoadBalancersIdMetricsGet200ResponseMetricsTimeSeriesValueValuesInnerInner` with oneOf schemas Number, String. Details: " +
                            errorMessages.join(", "));
        } else { // only 1 match
            // the input is valid
        }
    ...
    /**
     * Constructs a <code>LoadBalancersIdMetricsGet200ResponseMetricsTimeSeriesValueValuesInnerInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/LoadBalancersIdMetricsGet200ResponseMetricsTimeSeriesValueValuesInnerInner} obj Optional instance to populate.
     * @return {module:model/LoadBalancersIdMetricsGet200ResponseMetricsTimeSeriesValueValuesInnerInner} The populated <code>LoadBalancersIdMetricsGet200ResponseMetricsTimeSeriesValueValuesInnerInner</code> instance.
     */
    static constructFromObject(data, obj) {
        return new LoadBalancersIdMetricsGet200ResponseMetricsTimeSeriesValueValuesInnerInner(data);
    }
    ...
    setActualInstance(obj) {
       this.actualInstance = LoadBalancersIdMetricsGet200ResponseMetricsTimeSeriesValueValuesInnerInner.constructFromObject(obj).getActualInstance();
    }
    ...
    /**
     * Create an instance of LoadBalancersIdMetricsGet200ResponseMetricsTimeSeriesValueValuesInnerInner from a JSON string.
     * @param {string} json_string JSON string.
     * @return {module:model/LoadBalancersIdMetricsGet200ResponseMetricsTimeSeriesValueValuesInnerInner} An instance of LoadBalancersIdMetricsGet200ResponseMetricsTimeSeriesValueValuesInnerInner.
     */
    static fromJSON = function(json_string){
        return LoadBalancersIdMetricsGet200ResponseMetricsTimeSeriesValueValuesInnerInner.constructFromObject(JSON.parse(json_string));
    }
}


LoadBalancersIdMetricsGet200ResponseMetricsTimeSeriesValueValuesInnerInner.OneOf = ["Number", "String"];

export default LoadBalancersIdMetricsGet200ResponseMetricsTimeSeriesValueValuesInnerInner;
