...
/**
 * The ServersIdActionsEnableRescuePost201Response model module.
 * @module model/ServersIdActionsEnableRescuePost201Response
 * @version 1.0.0
 */
class ServersIdActionsEnableRescuePost201Response {
    /**
     * Constructs a new <code>ServersIdActionsEnableRescuePost201Response</code>.
     * @alias module:model/ServersIdActionsEnableRescuePost201Response
     */
    constructor() { 
        
        ServersIdActionsEnableRescuePost201Response.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ServersIdActionsEnableRescuePost201Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ServersIdActionsEnableRescuePost201Response} obj Optional instance to populate.
     * @return {module:model/ServersIdActionsEnableRescuePost201Response} The populated <code>ServersIdActionsEnableRescuePost201Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ServersIdActionsEnableRescuePost201Response();
    ...
    /**
     * Validates the JSON data with respect to <code>ServersIdActionsEnableRescuePost201Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ServersIdActionsEnableRescuePost201Response</code>.
     */
 ...
 */
ServersIdActionsEnableRescuePost201Response.prototype['action'] = undefined;

/**
 * Password that will be set for this Server once the Action succeeds
 * @member {String} root_password
 */
ServersIdActionsEnableRescuePost201Response.prototype['root_password'] = undefined;
...
export default ServersIdActionsEnableRescuePost201Response;
