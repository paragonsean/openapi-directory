...
class Rule {
     ...
     * @param direction {module:model/Rule.DirectionEnum} Select traffic direction on which rule should be applied. Use `source_ips` for direction `in` and `destination_ips` for direction `out`.
     * @param protocol {module:model/Rule.ProtocolEnum} Type of traffic to allow
     */
    constructor(direction, protocol) { 
        
        Rule.initialize(this, direction, protocol);
    }
     ...
     */
    static initialize(obj, direction, protocol) { 
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('destination_ips')) {
                obj['destination_ips'] = ApiClient.convertToType(data['destination_ips'], ['String']);
            }
            ...
            if (data.hasOwnProperty('source_ips')) {
                obj['source_ips'] = ApiClient.convertToType(data['source_ips'], ['String']);
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        if (!Array.isArray(data['destination_ips'])) {
            throw new Error("Expected the field `destination_ips` to be an array in the JSON data but got " + data['destination_ips']);
        }
        // ensure the json data is a string
        ...
        // ensure the json data is an array
        if (!Array.isArray(data['source_ips'])) {
            throw new Error("Expected the field `source_ips` to be an array in the JSON data but got " + data['source_ips']);
        }
...
Rule.RequiredProperties = ["direction", "protocol"];
 ...
 * @member {Array.<String>} destination_ips
 */
Rule.prototype['destination_ips'] = undefined;

/**
 * Select traffic direction on which rule should be applied. Use `source_ips` for direction `in` and `destination_ips` for direction `out`.
 * @member {module:model/Rule.DirectionEnum} direction
 */
Rule.prototype['direction'] = undefined;
 ...
 * @member {String} port
 */
Rule.prototype['port'] = undefined;

/**
 * Type of traffic to allow
 * @member {module:model/Rule.ProtocolEnum} protocol
 */
Rule.prototype['protocol'] = undefined;

/**
 * List of permitted IPv4/IPv6 addresses in CIDR notation. Use `0.0.0.0/0` to allow all IPv4 addresses and `::/0` to allow all IPv6 addresses. You can specify 100 CIDRs at most.
 * @member {Array.<String>} source_ips
 */
Rule.prototype['source_ips'] = undefined;
