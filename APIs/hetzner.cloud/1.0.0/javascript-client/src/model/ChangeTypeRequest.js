...
/**
 * The ChangeTypeRequest model module.
 * @module model/ChangeTypeRequest
 * @version 1.0.0
 */
class ChangeTypeRequest {
    /**
     * Constructs a new <code>ChangeTypeRequest</code>.
     * @alias module:model/ChangeTypeRequest
     * @param loadBalancerType {String} ID or name of Load Balancer type the Load Balancer should migrate to
     */
    constructor(loadBalancerType) { 
        
        ChangeTypeRequest.initialize(this, loadBalancerType);
    }
     ...
     */
    static initialize(obj, loadBalancerType) { 
        obj['load_balancer_type'] = loadBalancerType;
    }

    /**
     * Constructs a <code>ChangeTypeRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ChangeTypeRequest} obj Optional instance to populate.
     * @return {module:model/ChangeTypeRequest} The populated <code>ChangeTypeRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ChangeTypeRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>ChangeTypeRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ChangeTypeRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ChangeTypeRequest.RequiredProperties) {
...
ChangeTypeRequest.RequiredProperties = ["load_balancer_type"];

/**
 * ID or name of Load Balancer type the Load Balancer should migrate to
 * @member {String} load_balancer_type
 */
ChangeTypeRequest.prototype['load_balancer_type'] = undefined;
...
export default ChangeTypeRequest;
