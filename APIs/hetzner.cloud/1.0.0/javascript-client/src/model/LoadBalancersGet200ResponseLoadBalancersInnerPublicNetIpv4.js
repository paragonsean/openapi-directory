...
/**
 * The LoadBalancersGet200ResponseLoadBalancersInnerPublicNetIpv4 model module.
 * @module model/LoadBalancersGet200ResponseLoadBalancersInnerPublicNetIpv4
 * @version 1.0.0
 */
class LoadBalancersGet200ResponseLoadBalancersInnerPublicNetIpv4 {
    /**
     * Constructs a new <code>LoadBalancersGet200ResponseLoadBalancersInnerPublicNetIpv4</code>.
     * IP address (v4)
     * @alias module:model/LoadBalancersGet200ResponseLoadBalancersInnerPublicNetIpv4
     */
    constructor() { 
        
        LoadBalancersGet200ResponseLoadBalancersInnerPublicNetIpv4.initialize(this);
    }
    ...
    /**
     * Constructs a <code>LoadBalancersGet200ResponseLoadBalancersInnerPublicNetIpv4</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/LoadBalancersGet200ResponseLoadBalancersInnerPublicNetIpv4} obj Optional instance to populate.
     * @return {module:model/LoadBalancersGet200ResponseLoadBalancersInnerPublicNetIpv4} The populated <code>LoadBalancersGet200ResponseLoadBalancersInnerPublicNetIpv4</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new LoadBalancersGet200ResponseLoadBalancersInnerPublicNetIpv4();

            if (data.hasOwnProperty('dns_ptr')) {
                obj['dns_ptr'] = ApiClient.convertToType(data['dns_ptr'], 'String');
            }
    ...
    /**
     * Validates the JSON data with respect to <code>LoadBalancersGet200ResponseLoadBalancersInnerPublicNetIpv4</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>LoadBalancersGet200ResponseLoadBalancersInnerPublicNetIpv4</code>.
     */
    static validateJSON(data) {
        // ensure the json data is a string
        if (data['dns_ptr'] && !(typeof data['dns_ptr'] === 'string' || data['dns_ptr'] instanceof String)) {
            throw new Error("Expected the field `dns_ptr` to be a primitive type in the JSON string but got " + data['dns_ptr']);
        }
        // ensure the json data is a string
 ...
 * @member {String} dns_ptr
 */
LoadBalancersGet200ResponseLoadBalancersInnerPublicNetIpv4.prototype['dns_ptr'] = undefined;

/**
 * IP address (v4) of this Load Balancer
 * @member {String} ip
 */
LoadBalancersGet200ResponseLoadBalancersInnerPublicNetIpv4.prototype['ip'] = undefined;
...
export default LoadBalancersGet200ResponseLoadBalancersInnerPublicNetIpv4;
