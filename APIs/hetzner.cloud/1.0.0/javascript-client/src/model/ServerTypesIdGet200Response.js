...
import ServerTypesGet200ResponseServerTypesInner from './ServerTypesGet200ResponseServerTypesInner';

/**
 * The ServerTypesIdGet200Response model module.
 * @module model/ServerTypesIdGet200Response
 * @version 1.0.0
 */
class ServerTypesIdGet200Response {
    /**
     * Constructs a new <code>ServerTypesIdGet200Response</code>.
     * @alias module:model/ServerTypesIdGet200Response
     * @param serverType {module:model/ServerTypesGet200ResponseServerTypesInner} 
     */
    constructor(serverType) { 
        
        ServerTypesIdGet200Response.initialize(this, serverType);
    }
     ...
     */
    static initialize(obj, serverType) { 
        obj['server_type'] = serverType;
    }

    /**
     * Constructs a <code>ServerTypesIdGet200Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ServerTypesIdGet200Response} obj Optional instance to populate.
     * @return {module:model/ServerTypesIdGet200Response} The populated <code>ServerTypesIdGet200Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ServerTypesIdGet200Response();

            if (data.hasOwnProperty('server_type')) {
                obj['server_type'] = ServerTypesGet200ResponseServerTypesInner.constructFromObject(data['server_type']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ServerTypesIdGet200Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ServerTypesIdGet200Response</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ServerTypesIdGet200Response.RequiredProperties) {
        ...
        if (data['server_type']) { // data not null
          ServerTypesGet200ResponseServerTypesInner.validateJSON(data['server_type']);
        }
...
ServerTypesIdGet200Response.RequiredProperties = ["server_type"];

/**
 * @member {module:model/ServerTypesGet200ResponseServerTypesInner} server_type
 */
ServerTypesIdGet200Response.prototype['server_type'] = undefined;
...
export default ServerTypesIdGet200Response;
