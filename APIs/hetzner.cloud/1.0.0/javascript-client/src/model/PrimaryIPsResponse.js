...
/**
 * The PrimaryIPsResponse model module.
 * @module model/PrimaryIPsResponse
 * @version 1.0.0
 */
class PrimaryIPsResponse {
    /**
     * Constructs a new <code>PrimaryIPsResponse</code>.
     * @alias module:model/PrimaryIPsResponse
     * @param primaryIps {Array.<module:model/PrimaryIP>} 
     */
    constructor(primaryIps) { 
        
        PrimaryIPsResponse.initialize(this, primaryIps);
    }
     ...
     */
    static initialize(obj, primaryIps) { 
        obj['primary_ips'] = primaryIps;
    }

    /**
     * Constructs a <code>PrimaryIPsResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PrimaryIPsResponse} obj Optional instance to populate.
     * @return {module:model/PrimaryIPsResponse} The populated <code>PrimaryIPsResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PrimaryIPsResponse();

            if (data.hasOwnProperty('meta')) {
                obj['meta'] = ActionsResponseMeta.constructFromObject(data['meta']);
            }
            if (data.hasOwnProperty('primary_ips')) {
                obj['primary_ips'] = ApiClient.convertToType(data['primary_ips'], [PrimaryIP]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>PrimaryIPsResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PrimaryIPsResponse</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of PrimaryIPsResponse.RequiredProperties) {
...
PrimaryIPsResponse.RequiredProperties = ["primary_ips"];

/**
 * @member {module:model/ActionsResponseMeta} meta
 */
PrimaryIPsResponse.prototype['meta'] = undefined;

/**
 * @member {Array.<module:model/PrimaryIP>} primary_ips
 */
PrimaryIPsResponse.prototype['primary_ips'] = undefined;
...
export default PrimaryIPsResponse;
