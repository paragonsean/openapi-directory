...
/**
 * The ServersIdActionsChangeTypePostRequest model module.
 * @module model/ServersIdActionsChangeTypePostRequest
 * @version 1.0.0
 */
class ServersIdActionsChangeTypePostRequest {
    /**
     * Constructs a new <code>ServersIdActionsChangeTypePostRequest</code>.
     * @alias module:model/ServersIdActionsChangeTypePostRequest
     * @param serverType {String} ID or name of Server type the Server should migrate to
     * @param upgradeDisk {Boolean} If false, do not upgrade the disk (this allows downgrading the Server type later)
     */
    constructor(serverType, upgradeDisk) { 
        
        ServersIdActionsChangeTypePostRequest.initialize(this, serverType, upgradeDisk);
    }
     ...
     */
    static initialize(obj, serverType, upgradeDisk) { 
        obj['server_type'] = serverType;
        obj['upgrade_disk'] = upgradeDisk;
    }

    /**
     * Constructs a <code>ServersIdActionsChangeTypePostRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ServersIdActionsChangeTypePostRequest} obj Optional instance to populate.
     * @return {module:model/ServersIdActionsChangeTypePostRequest} The populated <code>ServersIdActionsChangeTypePostRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ServersIdActionsChangeTypePostRequest();

            if (data.hasOwnProperty('server_type')) {
                obj['server_type'] = ApiClient.convertToType(data['server_type'], 'String');
            }
            if (data.hasOwnProperty('upgrade_disk')) {
                obj['upgrade_disk'] = ApiClient.convertToType(data['upgrade_disk'], 'Boolean');
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ServersIdActionsChangeTypePostRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ServersIdActionsChangeTypePostRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ServersIdActionsChangeTypePostRequest.RequiredProperties) {
...
ServersIdActionsChangeTypePostRequest.RequiredProperties = ["server_type", "upgrade_disk"];

/**
 * ID or name of Server type the Server should migrate to
 * @member {String} server_type
 */
ServersIdActionsChangeTypePostRequest.prototype['server_type'] = undefined;

/**
 * If false, do not upgrade the disk (this allows downgrading the Server type later)
 * @member {Boolean} upgrade_disk
 */
ServersIdActionsChangeTypePostRequest.prototype['upgrade_disk'] = undefined;
...
export default ServersIdActionsChangeTypePostRequest;
