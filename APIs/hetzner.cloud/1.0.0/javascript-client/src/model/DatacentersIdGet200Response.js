...
/**
 * The DatacentersIdGet200Response model module.
 * @module model/DatacentersIdGet200Response
 * @version 1.0.0
 */
class DatacentersIdGet200Response {
    /**
     * Constructs a new <code>DatacentersIdGet200Response</code>.
     * @alias module:model/DatacentersIdGet200Response
     * @param datacenter {module:model/DatacentersGet200ResponseDatacentersInner} 
     */
    constructor(datacenter) { 
        
        DatacentersIdGet200Response.initialize(this, datacenter);
    }
    ...
    /**
     * Constructs a <code>DatacentersIdGet200Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DatacentersIdGet200Response} obj Optional instance to populate.
     * @return {module:model/DatacentersIdGet200Response} The populated <code>DatacentersIdGet200Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DatacentersIdGet200Response();

            if (data.hasOwnProperty('datacenter')) {
                obj['datacenter'] = DatacentersGet200ResponseDatacentersInner.constructFromObject(data['datacenter']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>DatacentersIdGet200Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DatacentersIdGet200Response</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DatacentersIdGet200Response.RequiredProperties) {
        ...
        if (data['datacenter']) { // data not null
          DatacentersGet200ResponseDatacentersInner.validateJSON(data['datacenter']);
        }
...
DatacentersIdGet200Response.RequiredProperties = ["datacenter"];

/**
 * @member {module:model/DatacentersGet200ResponseDatacentersInner} datacenter
 */
DatacentersIdGet200Response.prototype['datacenter'] = undefined;
...
export default DatacentersIdGet200Response;
