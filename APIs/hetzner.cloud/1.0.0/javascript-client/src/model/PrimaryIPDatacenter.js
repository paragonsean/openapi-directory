...
import DatacentersGet200ResponseDatacentersInnerLocation from './DatacentersGet200ResponseDatacentersInnerLocation';
import DatacentersGet200ResponseDatacentersInnerServerTypes from './DatacentersGet200ResponseDatacentersInnerServerTypes';

/**
 * The PrimaryIPDatacenter model module.
 * @module model/PrimaryIPDatacenter
 * @version 1.0.0
 */
class PrimaryIPDatacenter {
    /**
     * Constructs a new <code>PrimaryIPDatacenter</code>.
     * Datacenter this Primary IP is located at
     * @alias module:model/PrimaryIPDatacenter
     * @param description {String} Description of the Datacenter
     * @param id {Number} ID of the Resource
     * @param location {module:model/DatacentersGet200ResponseDatacentersInnerLocation} 
     * @param name {String} Unique identifier of the Datacenter
     * @param serverTypes {module:model/DatacentersGet200ResponseDatacentersInnerServerTypes} 
     */
    constructor(description, id, location, name, serverTypes) { 
        
        PrimaryIPDatacenter.initialize(this, description, id, location, name, serverTypes);
    }
     ...
     */
    static initialize(obj, description, id, location, name, serverTypes) { 
    ...
    /**
     * Constructs a <code>PrimaryIPDatacenter</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PrimaryIPDatacenter} obj Optional instance to populate.
     * @return {module:model/PrimaryIPDatacenter} The populated <code>PrimaryIPDatacenter</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PrimaryIPDatacenter();
            ...
            if (data.hasOwnProperty('location')) {
                obj['location'] = DatacentersGet200ResponseDatacentersInnerLocation.constructFromObject(data['location']);
            }
            if (data.hasOwnProperty('name')) {
                obj['name'] = ApiClient.convertToType(data['name'], 'String');
            }
            if (data.hasOwnProperty('server_types')) {
                obj['server_types'] = DatacentersGet200ResponseDatacentersInnerServerTypes.constructFromObject(data['server_types']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>PrimaryIPDatacenter</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PrimaryIPDatacenter</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of PrimaryIPDatacenter.RequiredProperties) {
        ...
        if (data['location']) { // data not null
          DatacentersGet200ResponseDatacentersInnerLocation.validateJSON(data['location']);
        }
        // ensure the json data is a string
        if (data['name'] && !(typeof data['name'] === 'string' || data['name'] instanceof String)) {
            throw new Error("Expected the field `name` to be a primitive type in the JSON string but got " + data['name']);
        }
        // validate the optional field `server_types`
        if (data['server_types']) { // data not null
          DatacentersGet200ResponseDatacentersInnerServerTypes.validateJSON(data['server_types']);
        }
...
PrimaryIPDatacenter.RequiredProperties = ["description", "id", "location", "name", "server_types"];

/**
 * Description of the Datacenter
 * @member {String} description
 */
PrimaryIPDatacenter.prototype['description'] = undefined;

/**
 * ID of the Resource
 * @member {Number} id
 */
PrimaryIPDatacenter.prototype['id'] = undefined;

/**
 * @member {module:model/DatacentersGet200ResponseDatacentersInnerLocation} location
 */
PrimaryIPDatacenter.prototype['location'] = undefined;

/**
 * Unique identifier of the Datacenter
 * @member {String} name
 */
PrimaryIPDatacenter.prototype['name'] = undefined;

/**
 * @member {module:model/DatacentersGet200ResponseDatacentersInnerServerTypes} server_types
 */
PrimaryIPDatacenter.prototype['server_types'] = undefined;
...
export default PrimaryIPDatacenter;
