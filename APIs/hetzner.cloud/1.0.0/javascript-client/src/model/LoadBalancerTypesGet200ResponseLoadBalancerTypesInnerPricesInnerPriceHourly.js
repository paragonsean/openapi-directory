...
/**
 * The LoadBalancerTypesGet200ResponseLoadBalancerTypesInnerPricesInnerPriceHourly model module.
 * @module model/LoadBalancerTypesGet200ResponseLoadBalancerTypesInnerPricesInnerPriceHourly
 * @version 1.0.0
 */
class LoadBalancerTypesGet200ResponseLoadBalancerTypesInnerPricesInnerPriceHourly {
    /**
     * Constructs a new <code>LoadBalancerTypesGet200ResponseLoadBalancerTypesInnerPricesInnerPriceHourly</code>.
     * Hourly costs for a Resource in this Location
     * @alias module:model/LoadBalancerTypesGet200ResponseLoadBalancerTypesInnerPricesInnerPriceHourly
     * @param gross {String} Price with VAT added
     * @param net {String} Price without VAT
     */
    constructor(gross, net) { 
        
        LoadBalancerTypesGet200ResponseLoadBalancerTypesInnerPricesInnerPriceHourly.initialize(this, gross, net);
    }
    ...
    /**
     * Constructs a <code>LoadBalancerTypesGet200ResponseLoadBalancerTypesInnerPricesInnerPriceHourly</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/LoadBalancerTypesGet200ResponseLoadBalancerTypesInnerPricesInnerPriceHourly} obj Optional instance to populate.
     * @return {module:model/LoadBalancerTypesGet200ResponseLoadBalancerTypesInnerPricesInnerPriceHourly} The populated <code>LoadBalancerTypesGet200ResponseLoadBalancerTypesInnerPricesInnerPriceHourly</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new LoadBalancerTypesGet200ResponseLoadBalancerTypesInnerPricesInnerPriceHourly();
    ...
    /**
     * Validates the JSON data with respect to <code>LoadBalancerTypesGet200ResponseLoadBalancerTypesInnerPricesInnerPriceHourly</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>LoadBalancerTypesGet200ResponseLoadBalancerTypesInnerPricesInnerPriceHourly</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of LoadBalancerTypesGet200ResponseLoadBalancerTypesInnerPricesInnerPriceHourly.RequiredProperties) {
...
LoadBalancerTypesGet200ResponseLoadBalancerTypesInnerPricesInnerPriceHourly.RequiredProperties = ["gross", "net"];

/**
 * Price with VAT added
 * @member {String} gross
 */
LoadBalancerTypesGet200ResponseLoadBalancerTypesInnerPricesInnerPriceHourly.prototype['gross'] = undefined;

/**
 * Price without VAT
 * @member {String} net
 */
LoadBalancerTypesGet200ResponseLoadBalancerTypesInnerPricesInnerPriceHourly.prototype['net'] = undefined;
...
export default LoadBalancerTypesGet200ResponseLoadBalancerTypesInnerPricesInnerPriceHourly;
