...
import FirewallAppliedToInnerAppliedToResourcesInnerServer from './FirewallAppliedToInnerAppliedToResourcesInnerServer';

/**
 * The FirewallAppliedToInnerAppliedToResourcesInner model module.
 * @module model/FirewallAppliedToInnerAppliedToResourcesInner
 * @version 1.0.0
 */
class FirewallAppliedToInnerAppliedToResourcesInner {
    /**
     * Constructs a new <code>FirewallAppliedToInnerAppliedToResourcesInner</code>.
     * @alias module:model/FirewallAppliedToInnerAppliedToResourcesInner
     */
    constructor() { 
        
        FirewallAppliedToInnerAppliedToResourcesInner.initialize(this);
    }
    ...
    /**
     * Constructs a <code>FirewallAppliedToInnerAppliedToResourcesInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/FirewallAppliedToInnerAppliedToResourcesInner} obj Optional instance to populate.
     * @return {module:model/FirewallAppliedToInnerAppliedToResourcesInner} The populated <code>FirewallAppliedToInnerAppliedToResourcesInner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new FirewallAppliedToInnerAppliedToResourcesInner();

            if (data.hasOwnProperty('server')) {
                obj['server'] = FirewallAppliedToInnerAppliedToResourcesInnerServer.constructFromObject(data['server']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>FirewallAppliedToInnerAppliedToResourcesInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>FirewallAppliedToInnerAppliedToResourcesInner</code>.
     */
    static validateJSON(data) {
        // validate the optional field `server`
        if (data['server']) { // data not null
          FirewallAppliedToInnerAppliedToResourcesInnerServer.validateJSON(data['server']);
        }
...
/**
 * @member {module:model/FirewallAppliedToInnerAppliedToResourcesInnerServer} server
 */
FirewallAppliedToInnerAppliedToResourcesInner.prototype['server'] = undefined;

/**
 * Type of resource referenced
 * @member {module:model/FirewallAppliedToInnerAppliedToResourcesInner.TypeEnum} type
 */
FirewallAppliedToInnerAppliedToResourcesInner.prototype['type'] = undefined;
 ...
 * @readonly
 */
FirewallAppliedToInnerAppliedToResourcesInner['TypeEnum'] = {
...
export default FirewallAppliedToInnerAppliedToResourcesInner;
