...
/**
 * The ChangeDNSPTRRequest model module.
 * @module model/ChangeDNSPTRRequest
 * @version 1.0.0
 */
class ChangeDNSPTRRequest {
    /**
     * Constructs a new <code>ChangeDNSPTRRequest</code>.
     * @alias module:model/ChangeDNSPTRRequest
     * @param dnsPtr {String} Hostname to set as a reverse DNS PTR entry, will reset to original default value if `null`
     * @param ip {String} IP address for which to set the reverse DNS entry
     */
    constructor(dnsPtr, ip) { 
        
        ChangeDNSPTRRequest.initialize(this, dnsPtr, ip);
    }
    ...
    /**
     * Constructs a <code>ChangeDNSPTRRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ChangeDNSPTRRequest} obj Optional instance to populate.
     * @return {module:model/ChangeDNSPTRRequest} The populated <code>ChangeDNSPTRRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ChangeDNSPTRRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>ChangeDNSPTRRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ChangeDNSPTRRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ChangeDNSPTRRequest.RequiredProperties) {
...
export default ChangeDNSPTRRequest;
