...
import UpdateNetworkRequestLabels from './UpdateNetworkRequestLabels';
...
class UpdateVolumeRequest {
     ...
     * @param name {String} New Volume name
     */
    constructor(name) { 
        
        UpdateVolumeRequest.initialize(this, name);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('labels')) {
                obj['labels'] = UpdateNetworkRequestLabels.constructFromObject(data['labels']);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['labels']) { // data not null
          UpdateNetworkRequestLabels.validateJSON(data['labels']);
        }
...
UpdateVolumeRequest.RequiredProperties = ["name"];

/**
 * @member {module:model/UpdateNetworkRequestLabels} labels
 */
UpdateVolumeRequest.prototype['labels'] = undefined;
