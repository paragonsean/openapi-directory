...
/**
 * The ActionsResponseMetaPagination model module.
 * @module model/ActionsResponseMetaPagination
 * @version 1.0.0
 */
class ActionsResponseMetaPagination {
    /**
     * Constructs a new <code>ActionsResponseMetaPagination</code>.
     * @alias module:model/ActionsResponseMetaPagination
     * @param lastPage {Number} ID of the last page available. Can be null if the current page is the last one.
     * @param nextPage {Number} ID of the next page. Can be null if the current page is the last one.
     * @param page {Number} Current page number
     * @param perPage {Number} Maximum number of items shown per page in the response
     * @param previousPage {Number} ID of the previous page. Can be null if the current page is the first one.
     * @param totalEntries {Number} The total number of entries that exist in the database for this query. Nullable if unknown.
     */
    constructor(lastPage, nextPage, page, perPage, previousPage, totalEntries) { 
        
        ActionsResponseMetaPagination.initialize(this, lastPage, nextPage, page, perPage, previousPage, totalEntries);
    }
     ...
     */
    static initialize(obj, lastPage, nextPage, page, perPage, previousPage, totalEntries) { 
    ...
    /**
     * Constructs a <code>ActionsResponseMetaPagination</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ActionsResponseMetaPagination} obj Optional instance to populate.
     * @return {module:model/ActionsResponseMetaPagination} The populated <code>ActionsResponseMetaPagination</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ActionsResponseMetaPagination();
    ...
    /**
     * Validates the JSON data with respect to <code>ActionsResponseMetaPagination</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ActionsResponseMetaPagination</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ActionsResponseMetaPagination.RequiredProperties) {
...
ActionsResponseMetaPagination.RequiredProperties = ["last_page", "next_page", "page", "per_page", "previous_page", "total_entries"];

/**
 * ID of the last page available. Can be null if the current page is the last one.
 * @member {Number} last_page
 */
ActionsResponseMetaPagination.prototype['last_page'] = undefined;

/**
 * ID of the next page. Can be null if the current page is the last one.
 * @member {Number} next_page
 */
ActionsResponseMetaPagination.prototype['next_page'] = undefined;

/**
 * Current page number
 * @member {Number} page
 */
ActionsResponseMetaPagination.prototype['page'] = undefined;

/**
 * Maximum number of items shown per page in the response
 * @member {Number} per_page
 */
ActionsResponseMetaPagination.prototype['per_page'] = undefined;

/**
 * ID of the previous page. Can be null if the current page is the first one.
 * @member {Number} previous_page
 */
ActionsResponseMetaPagination.prototype['previous_page'] = undefined;

/**
 * The total number of entries that exist in the database for this query. Nullable if unknown.
 * @member {Number} total_entries
 */
ActionsResponseMetaPagination.prototype['total_entries'] = undefined;
...
export default ActionsResponseMetaPagination;
