...
/**
 * The FloatingIpsGet200Response model module.
 * @module model/FloatingIpsGet200Response
 * @version 1.0.0
 */
class FloatingIpsGet200Response {
    /**
     * Constructs a new <code>FloatingIpsGet200Response</code>.
     * @alias module:model/FloatingIpsGet200Response
     * @param floatingIps {Array.<module:model/FloatingIpsGet200ResponseFloatingIpsInner>} 
     */
    constructor(floatingIps) { 
        
        FloatingIpsGet200Response.initialize(this, floatingIps);
    }
     ...
     */
    static initialize(obj, floatingIps) { 
        obj['floating_ips'] = floatingIps;
    }

    /**
     * Constructs a <code>FloatingIpsGet200Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/FloatingIpsGet200Response} obj Optional instance to populate.
     * @return {module:model/FloatingIpsGet200Response} The populated <code>FloatingIpsGet200Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new FloatingIpsGet200Response();

            if (data.hasOwnProperty('floating_ips')) {
                obj['floating_ips'] = ApiClient.convertToType(data['floating_ips'], [FloatingIpsGet200ResponseFloatingIpsInner]);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>FloatingIpsGet200Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>FloatingIpsGet200Response</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of FloatingIpsGet200Response.RequiredProperties) {
        ...
        if (data['floating_ips']) { // data not null
            ...
            for (const item of data['floating_ips']) {
                FloatingIpsGet200ResponseFloatingIpsInner.validateJSON(item);
            };
        }
...
FloatingIpsGet200Response.RequiredProperties = ["floating_ips"];

/**
 * @member {Array.<module:model/FloatingIpsGet200ResponseFloatingIpsInner>} floating_ips
 */
FloatingIpsGet200Response.prototype['floating_ips'] = undefined;

/**
 * @member {module:model/ActionsResponseMeta} meta
 */
FloatingIpsGet200Response.prototype['meta'] = undefined;
...
export default FloatingIpsGet200Response;
