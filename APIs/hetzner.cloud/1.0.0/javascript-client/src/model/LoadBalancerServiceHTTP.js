...
/**
 * The LoadBalancerServiceHTTP model module.
 * @module model/LoadBalancerServiceHTTP
 * @version 1.0.0
 */
class LoadBalancerServiceHTTP {
    /**
     * Constructs a new <code>LoadBalancerServiceHTTP</code>.
     * Configuration option for protocols http and https
     * @alias module:model/LoadBalancerServiceHTTP
     */
    constructor() { 
        
        LoadBalancerServiceHTTP.initialize(this);
    }
    ...
    /**
     * Constructs a <code>LoadBalancerServiceHTTP</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/LoadBalancerServiceHTTP} obj Optional instance to populate.
     * @return {module:model/LoadBalancerServiceHTTP} The populated <code>LoadBalancerServiceHTTP</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new LoadBalancerServiceHTTP();

            if (data.hasOwnProperty('certificates')) {
                obj['certificates'] = ApiClient.convertToType(data['certificates'], ['Number']);
            }
            if (data.hasOwnProperty('cookie_lifetime')) {
                obj['cookie_lifetime'] = ApiClient.convertToType(data['cookie_lifetime'], 'Number');
            }
            if (data.hasOwnProperty('cookie_name')) {
                obj['cookie_name'] = ApiClient.convertToType(data['cookie_name'], 'String');
            }
            if (data.hasOwnProperty('redirect_http')) {
                obj['redirect_http'] = ApiClient.convertToType(data['redirect_http'], 'Boolean');
            }
            if (data.hasOwnProperty('sticky_sessions')) {
                obj['sticky_sessions'] = ApiClient.convertToType(data['sticky_sessions'], 'Boolean');
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>LoadBalancerServiceHTTP</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>LoadBalancerServiceHTTP</code>.
     */
    static validateJSON(data) {
        ...
        if (data['cookie_name'] && !(typeof data['cookie_name'] === 'string' || data['cookie_name'] instanceof String)) {
            throw new Error("Expected the field `cookie_name` to be a primitive type in the JSON string but got " + data['cookie_name']);
        }
 ...
 * @member {Array.<Number>} certificates
 */
LoadBalancerServiceHTTP.prototype['certificates'] = undefined;

/**
 * Lifetime of the cookie used for sticky sessions
 * @member {Number} cookie_lifetime
 */
LoadBalancerServiceHTTP.prototype['cookie_lifetime'] = undefined;

/**
 * Name of the cookie used for sticky sessions
 * @member {String} cookie_name
 */
LoadBalancerServiceHTTP.prototype['cookie_name'] = undefined;

/**
 * Redirect HTTP requests to HTTPS. Only available if protocol is \"https\". Default `false`
 * @member {Boolean} redirect_http
 */
LoadBalancerServiceHTTP.prototype['redirect_http'] = undefined;

/**
 * Use sticky sessions. Only available if protocol is \"http\" or \"https\". Default `false`
 * @member {Boolean} sticky_sessions
 */
LoadBalancerServiceHTTP.prototype['sticky_sessions'] = undefined;
...
export default LoadBalancerServiceHTTP;
