...
/**
 * The PricingGet200ResponsePricingVolume model module.
 * @module model/PricingGet200ResponsePricingVolume
 * @version 1.0.0
 */
class PricingGet200ResponsePricingVolume {
    /**
     * Constructs a new <code>PricingGet200ResponsePricingVolume</code>.
     * The cost of Volume per GB/month
     * @alias module:model/PricingGet200ResponsePricingVolume
     * @param pricePerGbMonth {module:model/PricingGet200ResponsePricingFloatingIpPriceMonthly} 
     */
    constructor(pricePerGbMonth) { 
        
        PricingGet200ResponsePricingVolume.initialize(this, pricePerGbMonth);
    }
     ...
     */
    static initialize(obj, pricePerGbMonth) { 
        obj['price_per_gb_month'] = pricePerGbMonth;
    }

    /**
     * Constructs a <code>PricingGet200ResponsePricingVolume</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PricingGet200ResponsePricingVolume} obj Optional instance to populate.
     * @return {module:model/PricingGet200ResponsePricingVolume} The populated <code>PricingGet200ResponsePricingVolume</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PricingGet200ResponsePricingVolume();

            if (data.hasOwnProperty('price_per_gb_month')) {
                obj['price_per_gb_month'] = PricingGet200ResponsePricingFloatingIpPriceMonthly.constructFromObject(data['price_per_gb_month']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>PricingGet200ResponsePricingVolume</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PricingGet200ResponsePricingVolume</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of PricingGet200ResponsePricingVolume.RequiredProperties) {
            if (!data.hasOwnProperty(property)) {
                throw new Error("The required field `" + property + "` is not found in the JSON data: " + JSON.stringify(data));
            }
        }
        // validate the optional field `price_per_gb_month`
        if (data['price_per_gb_month']) { // data not null
          PricingGet200ResponsePricingFloatingIpPriceMonthly.validateJSON(data['price_per_gb_month']);
        }
...
PricingGet200ResponsePricingVolume.RequiredProperties = ["price_per_gb_month"];

/**
 * @member {module:model/PricingGet200ResponsePricingFloatingIpPriceMonthly} price_per_gb_month
 */
PricingGet200ResponsePricingVolume.prototype['price_per_gb_month'] = undefined;
...
export default PricingGet200ResponsePricingVolume;
