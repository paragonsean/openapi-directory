...
class ActionResponse {
    ...
    constructor(action) { 
        ...
        ActionResponse.initialize(this, action);
    }
    ...
    static validateJSON(data) {
        ...
        for (const property of ActionResponse.RequiredProperties) {
...
ActionResponse.RequiredProperties = ["action"];

/**
 * @member {module:model/Action} action
 */
ActionResponse.prototype['action'] = undefined;
