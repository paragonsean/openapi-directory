...
/**
 * The ServersGet200ResponseServersInnerProtection model module.
 * @module model/ServersGet200ResponseServersInnerProtection
 * @version 1.0.0
 */
class ServersGet200ResponseServersInnerProtection {
    /**
     * Constructs a new <code>ServersGet200ResponseServersInnerProtection</code>.
     * Protection configuration for the Server
     * @alias module:model/ServersGet200ResponseServersInnerProtection
     * @param _delete {Boolean} If true, prevents the Server from being deleted
     * @param rebuild {Boolean} If true, prevents the Server from being rebuilt
     */
    constructor(_delete, rebuild) { 
        
        ServersGet200ResponseServersInnerProtection.initialize(this, _delete, rebuild);
    }
     ...
     */
    static initialize(obj, _delete, rebuild) { 
        obj['delete'] = _delete;
        obj['rebuild'] = rebuild;
    }

    /**
     * Constructs a <code>ServersGet200ResponseServersInnerProtection</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ServersGet200ResponseServersInnerProtection} obj Optional instance to populate.
     * @return {module:model/ServersGet200ResponseServersInnerProtection} The populated <code>ServersGet200ResponseServersInnerProtection</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ServersGet200ResponseServersInnerProtection();
    ...
    /**
     * Validates the JSON data with respect to <code>ServersGet200ResponseServersInnerProtection</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ServersGet200ResponseServersInnerProtection</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ServersGet200ResponseServersInnerProtection.RequiredProperties) {
...
ServersGet200ResponseServersInnerProtection.RequiredProperties = ["delete", "rebuild"];

/**
 * If true, prevents the Server from being deleted
 * @member {Boolean} delete
 */
ServersGet200ResponseServersInnerProtection.prototype['delete'] = undefined;

/**
 * If true, prevents the Server from being rebuilt
 * @member {Boolean} rebuild
 */
ServersGet200ResponseServersInnerProtection.prototype['rebuild'] = undefined;
...
export default ServersGet200ResponseServersInnerProtection;
