...
/**
 * The PricingGet200ResponsePricingPrimaryIpsInnerPricesInnerPriceMonthly model module.
 * @module model/PricingGet200ResponsePricingPrimaryIpsInnerPricesInnerPriceMonthly
 * @version 1.0.0
 */
class PricingGet200ResponsePricingPrimaryIpsInnerPricesInnerPriceMonthly {
    /**
     * Constructs a new <code>PricingGet200ResponsePricingPrimaryIpsInnerPricesInnerPriceMonthly</code>.
     * Monthly costs for a Primary IP type in this Location
     * @alias module:model/PricingGet200ResponsePricingPrimaryIpsInnerPricesInnerPriceMonthly
     * @param gross {String} Price with VAT added
     * @param net {String} Price without VAT
     */
    constructor(gross, net) { 
        
        PricingGet200ResponsePricingPrimaryIpsInnerPricesInnerPriceMonthly.initialize(this, gross, net);
    }
    ...
    /**
     * Constructs a <code>PricingGet200ResponsePricingPrimaryIpsInnerPricesInnerPriceMonthly</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PricingGet200ResponsePricingPrimaryIpsInnerPricesInnerPriceMonthly} obj Optional instance to populate.
     * @return {module:model/PricingGet200ResponsePricingPrimaryIpsInnerPricesInnerPriceMonthly} The populated <code>PricingGet200ResponsePricingPrimaryIpsInnerPricesInnerPriceMonthly</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PricingGet200ResponsePricingPrimaryIpsInnerPricesInnerPriceMonthly();
    ...
    /**
     * Validates the JSON data with respect to <code>PricingGet200ResponsePricingPrimaryIpsInnerPricesInnerPriceMonthly</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PricingGet200ResponsePricingPrimaryIpsInnerPricesInnerPriceMonthly</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of PricingGet200ResponsePricingPrimaryIpsInnerPricesInnerPriceMonthly.RequiredProperties) {
...
PricingGet200ResponsePricingPrimaryIpsInnerPricesInnerPriceMonthly.RequiredProperties = ["gross", "net"];

/**
 * Price with VAT added
 * @member {String} gross
 */
PricingGet200ResponsePricingPrimaryIpsInnerPricesInnerPriceMonthly.prototype['gross'] = undefined;

/**
 * Price without VAT
 * @member {String} net
 */
PricingGet200ResponsePricingPrimaryIpsInnerPricesInnerPriceMonthly.prototype['net'] = undefined;
...
export default PricingGet200ResponsePricingPrimaryIpsInnerPricesInnerPriceMonthly;
