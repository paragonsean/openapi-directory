...
/**
 * The ServersGet200ResponseServersInnerPrivateNetInner model module.
 * @module model/ServersGet200ResponseServersInnerPrivateNetInner
 * @version 1.0.0
 */
class ServersGet200ResponseServersInnerPrivateNetInner {
    /**
     * Constructs a new <code>ServersGet200ResponseServersInnerPrivateNetInner</code>.
     * @alias module:model/ServersGet200ResponseServersInnerPrivateNetInner
     */
    constructor() { 
        
        ServersGet200ResponseServersInnerPrivateNetInner.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ServersGet200ResponseServersInnerPrivateNetInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ServersGet200ResponseServersInnerPrivateNetInner} obj Optional instance to populate.
     * @return {module:model/ServersGet200ResponseServersInnerPrivateNetInner} The populated <code>ServersGet200ResponseServersInnerPrivateNetInner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ServersGet200ResponseServersInnerPrivateNetInner();
    ...
    /**
     * Validates the JSON data with respect to <code>ServersGet200ResponseServersInnerPrivateNetInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ServersGet200ResponseServersInnerPrivateNetInner</code>.
     */
 ...
 */
ServersGet200ResponseServersInnerPrivateNetInner.prototype['alias_ips'] = undefined;

/**
 * @member {String} ip
 */
ServersGet200ResponseServersInnerPrivateNetInner.prototype['ip'] = undefined;

/**
 * @member {String} mac_address
 */
ServersGet200ResponseServersInnerPrivateNetInner.prototype['mac_address'] = undefined;

/**
 * @member {Number} network
 */
ServersGet200ResponseServersInnerPrivateNetInner.prototype['network'] = undefined;
...
export default ServersGet200ResponseServersInnerPrivateNetInner;
