...
/**
 * The VolumesIdGet200Response model module.
 * @module model/VolumesIdGet200Response
 * @version 1.0.0
 */
class VolumesIdGet200Response {
    /**
     * Constructs a new <code>VolumesIdGet200Response</code>.
     * @alias module:model/VolumesIdGet200Response
     * @param volume {module:model/VolumesGet200ResponseVolumesInner} 
     */
    constructor(volume) { 
        
        VolumesIdGet200Response.initialize(this, volume);
    }
    ...
    /**
     * Constructs a <code>VolumesIdGet200Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/VolumesIdGet200Response} obj Optional instance to populate.
     * @return {module:model/VolumesIdGet200Response} The populated <code>VolumesIdGet200Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new VolumesIdGet200Response();
    ...
    /**
     * Validates the JSON data with respect to <code>VolumesIdGet200Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>VolumesIdGet200Response</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of VolumesIdGet200Response.RequiredProperties) {
...
VolumesIdGet200Response.RequiredProperties = ["volume"];

/**
 * @member {module:model/VolumesGet200ResponseVolumesInner} volume
 */
VolumesIdGet200Response.prototype['volume'] = undefined;
...
export default VolumesIdGet200Response;
