...
import LoadBalancersIdMetricsGet200ResponseMetricsTimeSeriesValue from './LoadBalancersIdMetricsGet200ResponseMetricsTimeSeriesValue';

/**
 * The LoadBalancersIdMetricsGet200ResponseMetrics model module.
 * @module model/LoadBalancersIdMetricsGet200ResponseMetrics
 * @version 1.0.0
 */
class LoadBalancersIdMetricsGet200ResponseMetrics {
    /**
     * Constructs a new <code>LoadBalancersIdMetricsGet200ResponseMetrics</code>.
     * @alias module:model/LoadBalancersIdMetricsGet200ResponseMetrics
     * @param end {String} End of period of metrics reported (in ISO-8601 format)
     * @param start {String} Start of period of metrics reported (in ISO-8601 format)
     * @param step {Number} Resolution of results in seconds.
     * @param timeSeries {Object.<String, module:model/LoadBalancersIdMetricsGet200ResponseMetricsTimeSeriesValue>} Hash with timeseries information, containing the name of timeseries as key
     */
    constructor(end, start, step, timeSeries) { 
        
        LoadBalancersIdMetricsGet200ResponseMetrics.initialize(this, end, start, step, timeSeries);
    }
     ...
     */
    static initialize(obj, end, start, step, timeSeries) { 
        obj['end'] = end;
        obj['start'] = start;
        obj['step'] = step;
    ...
    /**
     * Constructs a <code>LoadBalancersIdMetricsGet200ResponseMetrics</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/LoadBalancersIdMetricsGet200ResponseMetrics} obj Optional instance to populate.
     * @return {module:model/LoadBalancersIdMetricsGet200ResponseMetrics} The populated <code>LoadBalancersIdMetricsGet200ResponseMetrics</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new LoadBalancersIdMetricsGet200ResponseMetrics();
            ...
            if (data.hasOwnProperty('time_series')) {
                obj['time_series'] = ApiClient.convertToType(data['time_series'], {'String': LoadBalancersIdMetricsGet200ResponseMetricsTimeSeriesValue});
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>LoadBalancersIdMetricsGet200ResponseMetrics</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>LoadBalancersIdMetricsGet200ResponseMetrics</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of LoadBalancersIdMetricsGet200ResponseMetrics.RequiredProperties) {
...
LoadBalancersIdMetricsGet200ResponseMetrics.RequiredProperties = ["end", "start", "step", "time_series"];

/**
 * End of period of metrics reported (in ISO-8601 format)
 * @member {String} end
 */
LoadBalancersIdMetricsGet200ResponseMetrics.prototype['end'] = undefined;

/**
 * Start of period of metrics reported (in ISO-8601 format)
 * @member {String} start
 */
LoadBalancersIdMetricsGet200ResponseMetrics.prototype['start'] = undefined;

/**
 * Resolution of results in seconds.
 * @member {Number} step
 */
LoadBalancersIdMetricsGet200ResponseMetrics.prototype['step'] = undefined;

/**
 * Hash with timeseries information, containing the name of timeseries as key
 * @member {Object.<String, module:model/LoadBalancersIdMetricsGet200ResponseMetricsTimeSeriesValue>} time_series
 */
LoadBalancersIdMetricsGet200ResponseMetrics.prototype['time_series'] = undefined;
...
export default LoadBalancersIdMetricsGet200ResponseMetrics;
