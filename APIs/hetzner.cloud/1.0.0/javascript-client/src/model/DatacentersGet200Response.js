...
import DatacentersGet200ResponseDatacentersInner from './DatacentersGet200ResponseDatacentersInner';

/**
 * The DatacentersGet200Response model module.
 * @module model/DatacentersGet200Response
 * @version 1.0.0
 */
class DatacentersGet200Response {
    /**
     * Constructs a new <code>DatacentersGet200Response</code>.
     * @alias module:model/DatacentersGet200Response
     * @param datacenters {Array.<module:model/DatacentersGet200ResponseDatacentersInner>} 
     * @param recommendation {Number} The Datacenter which is recommended to be used to create new Servers.
     */
    constructor(datacenters, recommendation) { 
        
        DatacentersGet200Response.initialize(this, datacenters, recommendation);
    }
     ...
     */
    static initialize(obj, datacenters, recommendation) { 
        obj['datacenters'] = datacenters;
        obj['recommendation'] = recommendation;
    }

    /**
     * Constructs a <code>DatacentersGet200Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DatacentersGet200Response} obj Optional instance to populate.
     * @return {module:model/DatacentersGet200Response} The populated <code>DatacentersGet200Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DatacentersGet200Response();

            if (data.hasOwnProperty('datacenters')) {
                obj['datacenters'] = ApiClient.convertToType(data['datacenters'], [DatacentersGet200ResponseDatacentersInner]);
            }
            if (data.hasOwnProperty('recommendation')) {
                obj['recommendation'] = ApiClient.convertToType(data['recommendation'], 'Number');
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>DatacentersGet200Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DatacentersGet200Response</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DatacentersGet200Response.RequiredProperties) {
        ...
        if (data['datacenters']) { // data not null
            ...
            for (const item of data['datacenters']) {
                DatacentersGet200ResponseDatacentersInner.validateJSON(item);
            };
        }
...
DatacentersGet200Response.RequiredProperties = ["datacenters", "recommendation"];

/**
 * @member {Array.<module:model/DatacentersGet200ResponseDatacentersInner>} datacenters
 */
DatacentersGet200Response.prototype['datacenters'] = undefined;

/**
 * The Datacenter which is recommended to be used to create new Servers.
 * @member {Number} recommendation
 */
DatacentersGet200Response.prototype['recommendation'] = undefined;
...
export default DatacentersGet200Response;
