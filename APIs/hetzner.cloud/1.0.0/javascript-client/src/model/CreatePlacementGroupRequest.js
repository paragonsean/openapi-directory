...
class CreatePlacementGroupRequest {
     ...
     * @param name {String} Name of the PlacementGroup
     * @param type {module:model/CreatePlacementGroupRequest.TypeEnum} Define the Placement Group Type.
     */
    constructor(name, type) { 
        
        CreatePlacementGroupRequest.initialize(this, name, type);
    }
    ...
    /**
     * Validates the JSON data with respect to <code>CreatePlacementGroupRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreatePlacementGroupRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CreatePlacementGroupRequest.RequiredProperties) {
...
CreatePlacementGroupRequest.RequiredProperties = ["name", "type"];

/**
 * User-defined labels (key-value pairs)
 * @member {Object} labels
 */
CreatePlacementGroupRequest.prototype['labels'] = undefined;

/**
 * Name of the PlacementGroup
 * @member {String} name
 */
CreatePlacementGroupRequest.prototype['name'] = undefined;

/**
 * Define the Placement Group Type.
 * @member {module:model/CreatePlacementGroupRequest.TypeEnum} type
 */
CreatePlacementGroupRequest.prototype['type'] = undefined;
 ...
 * @readonly
 */
CreatePlacementGroupRequest['TypeEnum'] = {
