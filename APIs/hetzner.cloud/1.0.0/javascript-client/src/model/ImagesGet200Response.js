...
/**
 * The ImagesGet200Response model module.
 * @module model/ImagesGet200Response
 * @version 1.0.0
 */
class ImagesGet200Response {
    /**
     * Constructs a new <code>ImagesGet200Response</code>.
     * @alias module:model/ImagesGet200Response
     * @param images {Array.<module:model/ImagesGet200ResponseImagesInner>} 
     */
    constructor(images) { 
        
        ImagesGet200Response.initialize(this, images);
    }
    ...
    /**
     * Constructs a <code>ImagesGet200Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ImagesGet200Response} obj Optional instance to populate.
     * @return {module:model/ImagesGet200Response} The populated <code>ImagesGet200Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ImagesGet200Response();

            if (data.hasOwnProperty('images')) {
                obj['images'] = ApiClient.convertToType(data['images'], [ImagesGet200ResponseImagesInner]);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>ImagesGet200Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ImagesGet200Response</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ImagesGet200Response.RequiredProperties) {
        ...
        if (data['images']) { // data not null
            ...
            for (const item of data['images']) {
                ImagesGet200ResponseImagesInner.validateJSON(item);
            };
        }
...
ImagesGet200Response.RequiredProperties = ["images"];

/**
 * @member {Array.<module:model/ImagesGet200ResponseImagesInner>} images
 */
ImagesGet200Response.prototype['images'] = undefined;

/**
 * @member {module:model/ActionsResponseMeta} meta
 */
ImagesGet200Response.prototype['meta'] = undefined;
...
export default ImagesGet200Response;
