...
/**
 * The LoadBalancerServiceHealthCheckHttp model module.
 * @module model/LoadBalancerServiceHealthCheckHttp
 * @version 1.0.0
 */
class LoadBalancerServiceHealthCheckHttp {
    /**
     * Constructs a new <code>LoadBalancerServiceHealthCheckHttp</code>.
     * Additional configuration for protocol http
     * @alias module:model/LoadBalancerServiceHealthCheckHttp
     * @param domain {String} Host header to send in the HTTP request. May not contain spaces, percent or backslash symbols. Can be null, in that case no host header is sent.
     * @param path {String} HTTP path to use for health checks. May not contain literal spaces, use percent-encoding instead.
     */
    constructor(domain, path) { 
        
        LoadBalancerServiceHealthCheckHttp.initialize(this, domain, path);
    }
     ...
     */
    static initialize(obj, domain, path) { 
        obj['domain'] = domain;
        obj['path'] = path;
    }

    /**
     * Constructs a <code>LoadBalancerServiceHealthCheckHttp</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/LoadBalancerServiceHealthCheckHttp} obj Optional instance to populate.
     * @return {module:model/LoadBalancerServiceHealthCheckHttp} The populated <code>LoadBalancerServiceHealthCheckHttp</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new LoadBalancerServiceHealthCheckHttp();
            ...
            if (data.hasOwnProperty('status_codes')) {
                obj['status_codes'] = ApiClient.convertToType(data['status_codes'], ['String']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>LoadBalancerServiceHealthCheckHttp</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>LoadBalancerServiceHealthCheckHttp</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of LoadBalancerServiceHealthCheckHttp.RequiredProperties) {
        ...
        if (!Array.isArray(data['status_codes'])) {
            throw new Error("Expected the field `status_codes` to be an array in the JSON data but got " + data['status_codes']);
        }
...
LoadBalancerServiceHealthCheckHttp.RequiredProperties = ["domain", "path"];
 ...
 */
LoadBalancerServiceHealthCheckHttp.prototype['domain'] = undefined;

/**
 * HTTP path to use for health checks. May not contain literal spaces, use percent-encoding instead.
 * @member {String} path
 */
LoadBalancerServiceHealthCheckHttp.prototype['path'] = undefined;

/**
 * String that must be contained in HTTP response in order to pass the health check
 * @member {String} response
 */
LoadBalancerServiceHealthCheckHttp.prototype['response'] = undefined;
 ...
 * @member {Array.<String>} status_codes
 */
LoadBalancerServiceHealthCheckHttp.prototype['status_codes'] = undefined;

/**
 * Use HTTPS for health check
 * @member {Boolean} tls
 */
LoadBalancerServiceHealthCheckHttp.prototype['tls'] = undefined;
...
export default LoadBalancerServiceHealthCheckHttp;
