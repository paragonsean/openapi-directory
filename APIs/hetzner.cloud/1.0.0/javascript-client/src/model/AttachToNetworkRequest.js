...
/**
 * The AttachToNetworkRequest model module.
 * @module model/AttachToNetworkRequest
 * @version 1.0.0
 */
class AttachToNetworkRequest {
    /**
     * Constructs a new <code>AttachToNetworkRequest</code>.
     * @alias module:model/AttachToNetworkRequest
     * @param network {Number} ID of an existing network to attach the Server to
     */
    constructor(network) { 
        
        AttachToNetworkRequest.initialize(this, network);
    }
    ...
    /**
     * Constructs a <code>AttachToNetworkRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AttachToNetworkRequest} obj Optional instance to populate.
     * @return {module:model/AttachToNetworkRequest} The populated <code>AttachToNetworkRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AttachToNetworkRequest();

            if (data.hasOwnProperty('alias_ips')) {
                obj['alias_ips'] = ApiClient.convertToType(data['alias_ips'], ['String']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>AttachToNetworkRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AttachToNetworkRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of AttachToNetworkRequest.RequiredProperties) {
            if (!data.hasOwnProperty(property)) {
                throw new Error("The required field `" + property + "` is not found in the JSON data: " + JSON.stringify(data));
            }
        }
        // ensure the json data is an array
        if (!Array.isArray(data['alias_ips'])) {
            throw new Error("Expected the field `alias_ips` to be an array in the JSON data but got " + data['alias_ips']);
        }
...
export default AttachToNetworkRequest;
