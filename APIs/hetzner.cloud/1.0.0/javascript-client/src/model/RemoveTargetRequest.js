...
/**
 * The RemoveTargetRequest model module.
 * @module model/RemoveTargetRequest
 * @version 1.0.0
 */
class RemoveTargetRequest {
    /**
     * Constructs a new <code>RemoveTargetRequest</code>.
     * @alias module:model/RemoveTargetRequest
     * @param type {module:model/RemoveTargetRequest.TypeEnum} Type of the resource
     */
    constructor(type) { 
        
        RemoveTargetRequest.initialize(this, type);
    }
    ...
    /**
     * Constructs a <code>RemoveTargetRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/RemoveTargetRequest} obj Optional instance to populate.
     * @return {module:model/RemoveTargetRequest} The populated <code>RemoveTargetRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RemoveTargetRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>RemoveTargetRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RemoveTargetRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of RemoveTargetRequest.RequiredProperties) {
...
RemoveTargetRequest.RequiredProperties = ["type"];

/**
 * @member {module:model/LoadBalancerTargetIP} ip
 */
RemoveTargetRequest.prototype['ip'] = undefined;

/**
 * @member {module:model/AddTargetRequestLabelSelector} label_selector
 */
RemoveTargetRequest.prototype['label_selector'] = undefined;

/**
 * @member {module:model/AddTargetRequestServer} server
 */
RemoveTargetRequest.prototype['server'] = undefined;

/**
 * Type of the resource
 * @member {module:model/RemoveTargetRequest.TypeEnum} type
 */
RemoveTargetRequest.prototype['type'] = undefined;
...
export default RemoveTargetRequest;
