...
/**
 * The ServersGet200ResponseServersInnerPublicNetIpv6DnsPtrInner model module.
 * @module model/ServersGet200ResponseServersInnerPublicNetIpv6DnsPtrInner
 * @version 1.0.0
 */
class ServersGet200ResponseServersInnerPublicNetIpv6DnsPtrInner {
    /**
     * Constructs a new <code>ServersGet200ResponseServersInnerPublicNetIpv6DnsPtrInner</code>.
     * @alias module:model/ServersGet200ResponseServersInnerPublicNetIpv6DnsPtrInner
     * @param dnsPtr {String} DNS pointer for the specific IP address
     * @param ip {String} Single IPv6 address of this Server for which the reverse DNS entry has been set up
     */
    constructor(dnsPtr, ip) { 
        
        ServersGet200ResponseServersInnerPublicNetIpv6DnsPtrInner.initialize(this, dnsPtr, ip);
    }
     ...
     */
    static initialize(obj, dnsPtr, ip) { 
        obj['dns_ptr'] = dnsPtr;
        obj['ip'] = ip;
    }

    /**
     * Constructs a <code>ServersGet200ResponseServersInnerPublicNetIpv6DnsPtrInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ServersGet200ResponseServersInnerPublicNetIpv6DnsPtrInner} obj Optional instance to populate.
     * @return {module:model/ServersGet200ResponseServersInnerPublicNetIpv6DnsPtrInner} The populated <code>ServersGet200ResponseServersInnerPublicNetIpv6DnsPtrInner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ServersGet200ResponseServersInnerPublicNetIpv6DnsPtrInner();
    ...
    /**
     * Validates the JSON data with respect to <code>ServersGet200ResponseServersInnerPublicNetIpv6DnsPtrInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ServersGet200ResponseServersInnerPublicNetIpv6DnsPtrInner</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ServersGet200ResponseServersInnerPublicNetIpv6DnsPtrInner.RequiredProperties) {
...
ServersGet200ResponseServersInnerPublicNetIpv6DnsPtrInner.RequiredProperties = ["dns_ptr", "ip"];

/**
 * DNS pointer for the specific IP address
 * @member {String} dns_ptr
 */
ServersGet200ResponseServersInnerPublicNetIpv6DnsPtrInner.prototype['dns_ptr'] = undefined;

/**
 * Single IPv6 address of this Server for which the reverse DNS entry has been set up
 * @member {String} ip
 */
ServersGet200ResponseServersInnerPublicNetIpv6DnsPtrInner.prototype['ip'] = undefined;
...
export default ServersGet200ResponseServersInnerPublicNetIpv6DnsPtrInner;
