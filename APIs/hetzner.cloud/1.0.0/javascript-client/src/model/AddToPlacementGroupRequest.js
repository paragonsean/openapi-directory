...
/**
 * The AddToPlacementGroupRequest model module.
 * @module model/AddToPlacementGroupRequest
 * @version 1.0.0
 */
class AddToPlacementGroupRequest {
    /**
     * Constructs a new <code>AddToPlacementGroupRequest</code>.
     * @alias module:model/AddToPlacementGroupRequest
     * @param placementGroup {Number} ID of Placement Group the Server should be added to
     */
    constructor(placementGroup) { 
        
        AddToPlacementGroupRequest.initialize(this, placementGroup);
    }
     ...
     */
    static initialize(obj, placementGroup) { 
        obj['placement_group'] = placementGroup;
    }

    /**
     * Constructs a <code>AddToPlacementGroupRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AddToPlacementGroupRequest} obj Optional instance to populate.
     * @return {module:model/AddToPlacementGroupRequest} The populated <code>AddToPlacementGroupRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AddToPlacementGroupRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>AddToPlacementGroupRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AddToPlacementGroupRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of AddToPlacementGroupRequest.RequiredProperties) {
...
AddToPlacementGroupRequest.RequiredProperties = ["placement_group"];

/**
 * ID of Placement Group the Server should be added to
 * @member {Number} placement_group
 */
AddToPlacementGroupRequest.prototype['placement_group'] = undefined;
...
export default AddToPlacementGroupRequest;
