...
/**
 * The PricingGet200ResponsePricingFloatingIp model module.
 * @module model/PricingGet200ResponsePricingFloatingIp
 * @version 1.0.0
 */
class PricingGet200ResponsePricingFloatingIp {
    /**
     * Constructs a new <code>PricingGet200ResponsePricingFloatingIp</code>.
     * The cost of one Floating IP per month
     * @alias module:model/PricingGet200ResponsePricingFloatingIp
     * @param priceMonthly {module:model/PricingGet200ResponsePricingFloatingIpPriceMonthly} 
     */
    constructor(priceMonthly) { 
        
        PricingGet200ResponsePricingFloatingIp.initialize(this, priceMonthly);
    }
     ...
     */
    static initialize(obj, priceMonthly) { 
        obj['price_monthly'] = priceMonthly;
    }

    /**
     * Constructs a <code>PricingGet200ResponsePricingFloatingIp</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PricingGet200ResponsePricingFloatingIp} obj Optional instance to populate.
     * @return {module:model/PricingGet200ResponsePricingFloatingIp} The populated <code>PricingGet200ResponsePricingFloatingIp</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PricingGet200ResponsePricingFloatingIp();

            if (data.hasOwnProperty('price_monthly')) {
                obj['price_monthly'] = PricingGet200ResponsePricingFloatingIpPriceMonthly.constructFromObject(data['price_monthly']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>PricingGet200ResponsePricingFloatingIp</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PricingGet200ResponsePricingFloatingIp</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of PricingGet200ResponsePricingFloatingIp.RequiredProperties) {
        ...
        if (data['price_monthly']) { // data not null
          PricingGet200ResponsePricingFloatingIpPriceMonthly.validateJSON(data['price_monthly']);
        }
...
PricingGet200ResponsePricingFloatingIp.RequiredProperties = ["price_monthly"];

/**
 * @member {module:model/PricingGet200ResponsePricingFloatingIpPriceMonthly} price_monthly
 */
PricingGet200ResponsePricingFloatingIp.prototype['price_monthly'] = undefined;
...
export default PricingGet200ResponsePricingFloatingIp;
