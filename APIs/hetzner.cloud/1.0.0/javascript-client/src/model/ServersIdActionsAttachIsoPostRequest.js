...
/**
 * The ServersIdActionsAttachIsoPostRequest model module.
 * @module model/ServersIdActionsAttachIsoPostRequest
 * @version 1.0.0
 */
class ServersIdActionsAttachIsoPostRequest {
    /**
     * Constructs a new <code>ServersIdActionsAttachIsoPostRequest</code>.
     * @alias module:model/ServersIdActionsAttachIsoPostRequest
     * @param iso {String} ID or name of ISO to attach to the Server as listed in GET `/isos`
     */
    constructor(iso) { 
        
        ServersIdActionsAttachIsoPostRequest.initialize(this, iso);
    }
    ...
    /**
     * Constructs a <code>ServersIdActionsAttachIsoPostRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ServersIdActionsAttachIsoPostRequest} obj Optional instance to populate.
     * @return {module:model/ServersIdActionsAttachIsoPostRequest} The populated <code>ServersIdActionsAttachIsoPostRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ServersIdActionsAttachIsoPostRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>ServersIdActionsAttachIsoPostRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ServersIdActionsAttachIsoPostRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ServersIdActionsAttachIsoPostRequest.RequiredProperties) {
...
ServersIdActionsAttachIsoPostRequest.RequiredProperties = ["iso"];

/**
 * ID or name of ISO to attach to the Server as listed in GET `/isos`
 * @member {String} iso
 */
ServersIdActionsAttachIsoPostRequest.prototype['iso'] = undefined;
...
export default ServersIdActionsAttachIsoPostRequest;
