...
/**
 * The ActionsResponse model module.
 * @module model/ActionsResponse
 * @version 1.0.0
 */
class ActionsResponse {
    /**
     * Constructs a new <code>ActionsResponse</code>.
     * @alias module:model/ActionsResponse
     * @param actions {Array.<module:model/Action>} 
     */
    constructor(actions) { 
        
        ActionsResponse.initialize(this, actions);
    }
    ...
    /**
     * Constructs a <code>ActionsResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ActionsResponse} obj Optional instance to populate.
     * @return {module:model/ActionsResponse} The populated <code>ActionsResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ActionsResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>ActionsResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ActionsResponse</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ActionsResponse.RequiredProperties) {
...
ActionsResponse.RequiredProperties = ["actions"];

/**
 * @member {Array.<module:model/Action>} actions
 */
ActionsResponse.prototype['actions'] = undefined;

/**
 * @member {module:model/ActionsResponseMeta} meta
 */
ActionsResponse.prototype['meta'] = undefined;
