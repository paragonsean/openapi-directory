...
import IsosGet200ResponseIsosInner from './IsosGet200ResponseIsosInner';

/**
 * The IsosGet200Response model module.
 * @module model/IsosGet200Response
 * @version 1.0.0
 */
class IsosGet200Response {
    /**
     * Constructs a new <code>IsosGet200Response</code>.
     * @alias module:model/IsosGet200Response
     * @param isos {Array.<module:model/IsosGet200ResponseIsosInner>} 
     */
    constructor(isos) { 
        
        IsosGet200Response.initialize(this, isos);
    }
     ...
     */
    static initialize(obj, isos) { 
        obj['isos'] = isos;
    }

    /**
     * Constructs a <code>IsosGet200Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/IsosGet200Response} obj Optional instance to populate.
     * @return {module:model/IsosGet200Response} The populated <code>IsosGet200Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new IsosGet200Response();

            if (data.hasOwnProperty('isos')) {
                obj['isos'] = ApiClient.convertToType(data['isos'], [IsosGet200ResponseIsosInner]);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>IsosGet200Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>IsosGet200Response</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of IsosGet200Response.RequiredProperties) {
            if (!data.hasOwnProperty(property)) {
                throw new Error("The required field `" + property + "` is not found in the JSON data: " + JSON.stringify(data));
            }
        }
        if (data['isos']) { // data not null
            // ensure the json data is an array
            if (!Array.isArray(data['isos'])) {
                throw new Error("Expected the field `isos` to be an array in the JSON data but got " + data['isos']);
            }
            // validate the optional field `isos` (array)
            for (const item of data['isos']) {
                IsosGet200ResponseIsosInner.validateJSON(item);
            };
        }
...
IsosGet200Response.RequiredProperties = ["isos"];

/**
 * @member {Array.<module:model/IsosGet200ResponseIsosInner>} isos
 */
IsosGet200Response.prototype['isos'] = undefined;

/**
 * @member {module:model/ActionsResponseMeta} meta
 */
IsosGet200Response.prototype['meta'] = undefined;
...
export default IsosGet200Response;
