...
/**
 * The CertificateStatusError model module.
 * @module model/CertificateStatusError
 * @version 1.0.0
 */
class CertificateStatusError {
    /**
     * Constructs a new <code>CertificateStatusError</code>.
     * If issuance or renewal reports &#x60;failed&#x60;, this property contains information about what happened
     * @alias module:model/CertificateStatusError
     */
    constructor() { 
        
        CertificateStatusError.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CertificateStatusError</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CertificateStatusError} obj Optional instance to populate.
     * @return {module:model/CertificateStatusError} The populated <code>CertificateStatusError</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CertificateStatusError();
    ...
    /**
     * Validates the JSON data with respect to <code>CertificateStatusError</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CertificateStatusError</code>.
     */
 ...
 * @member {String} code
 */
CertificateStatusError.prototype['code'] = undefined;

/**
 * @member {String} message
 */
CertificateStatusError.prototype['message'] = undefined;
...
export default CertificateStatusError;
