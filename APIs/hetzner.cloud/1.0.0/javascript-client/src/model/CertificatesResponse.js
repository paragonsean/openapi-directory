...
/**
 * The CertificatesResponse model module.
 * @module model/CertificatesResponse
 * @version 1.0.0
 */
class CertificatesResponse {
    /**
     * Constructs a new <code>CertificatesResponse</code>.
     * @alias module:model/CertificatesResponse
     * @param certificates {Array.<module:model/Certificate>} 
     */
    constructor(certificates) { 
        
        CertificatesResponse.initialize(this, certificates);
    }
    ...
    /**
     * Constructs a <code>CertificatesResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CertificatesResponse} obj Optional instance to populate.
     * @return {module:model/CertificatesResponse} The populated <code>CertificatesResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CertificatesResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>CertificatesResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CertificatesResponse</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CertificatesResponse.RequiredProperties) {
...
CertificatesResponse.RequiredProperties = ["certificates"];

/**
 * @member {Array.<module:model/Certificate>} certificates
 */
CertificatesResponse.prototype['certificates'] = undefined;

/**
 * @member {module:model/ActionsResponseMeta} meta
 */
CertificatesResponse.prototype['meta'] = undefined;
...
export default CertificatesResponse;
