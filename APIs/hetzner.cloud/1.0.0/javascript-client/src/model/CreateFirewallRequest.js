...
import CreateFirewallRequestApplyToInner from './CreateFirewallRequestApplyToInner';
...
class CreateFirewallRequest {
    ...
    constructor(name) { 
        ...
        CreateFirewallRequest.initialize(this, name);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('apply_to')) {
                obj['apply_to'] = ApiClient.convertToType(data['apply_to'], [CreateFirewallRequestApplyToInner]);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['apply_to']) { // data not null
            ...
            for (const item of data['apply_to']) {
                CreateFirewallRequestApplyToInner.validateJSON(item);
            };
        }
...
CreateFirewallRequest.RequiredProperties = ["name"];

/**
 * Resources the Firewall should be applied to after creation
 * @member {Array.<module:model/CreateFirewallRequestApplyToInner>} apply_to
 */
CreateFirewallRequest.prototype['apply_to'] = undefined;

/**
 * User-defined labels (key-value pairs)
 * @member {Object} labels
 */
CreateFirewallRequest.prototype['labels'] = undefined;

/**
 * Name of the Firewall
 * @member {String} name
 */
CreateFirewallRequest.prototype['name'] = undefined;

/**
 * Array of rules
 * @member {Array.<module:model/Rule>} rules
 */
CreateFirewallRequest.prototype['rules'] = undefined;
