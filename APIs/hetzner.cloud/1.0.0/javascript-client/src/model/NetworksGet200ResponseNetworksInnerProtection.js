...
/**
 * The NetworksGet200ResponseNetworksInnerProtection model module.
 * @module model/NetworksGet200ResponseNetworksInnerProtection
 * @version 1.0.0
 */
class NetworksGet200ResponseNetworksInnerProtection {
    /**
     * Constructs a new <code>NetworksGet200ResponseNetworksInnerProtection</code>.
     * Protection configuration for the Network
     * @alias module:model/NetworksGet200ResponseNetworksInnerProtection
     * @param _delete {Boolean} If true, prevents the Network from being deleted
     */
    constructor(_delete) { 
        
        NetworksGet200ResponseNetworksInnerProtection.initialize(this, _delete);
    }
    ...
    /**
     * Constructs a <code>NetworksGet200ResponseNetworksInnerProtection</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/NetworksGet200ResponseNetworksInnerProtection} obj Optional instance to populate.
     * @return {module:model/NetworksGet200ResponseNetworksInnerProtection} The populated <code>NetworksGet200ResponseNetworksInnerProtection</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new NetworksGet200ResponseNetworksInnerProtection();
    ...
    /**
     * Validates the JSON data with respect to <code>NetworksGet200ResponseNetworksInnerProtection</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>NetworksGet200ResponseNetworksInnerProtection</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of NetworksGet200ResponseNetworksInnerProtection.RequiredProperties) {
...
NetworksGet200ResponseNetworksInnerProtection.RequiredProperties = ["delete"];

/**
 * If true, prevents the Network from being deleted
 * @member {Boolean} delete
 */
NetworksGet200ResponseNetworksInnerProtection.prototype['delete'] = undefined;
...
export default NetworksGet200ResponseNetworksInnerProtection;
