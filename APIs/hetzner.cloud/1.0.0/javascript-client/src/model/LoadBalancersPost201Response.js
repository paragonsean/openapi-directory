...
/**
 * The LoadBalancersPost201Response model module.
 * @module model/LoadBalancersPost201Response
 * @version 1.0.0
 */
class LoadBalancersPost201Response {
    /**
     * Constructs a new <code>LoadBalancersPost201Response</code>.
     * @alias module:model/LoadBalancersPost201Response
     * @param action {module:model/Action} 
     * @param loadBalancer {module:model/LoadBalancersGet200ResponseLoadBalancersInner} 
     */
    constructor(action, loadBalancer) { 
        
        LoadBalancersPost201Response.initialize(this, action, loadBalancer);
    }
     ...
     */
    static initialize(obj, action, loadBalancer) { 
        obj['action'] = action;
        obj['load_balancer'] = loadBalancer;
    }

    /**
     * Constructs a <code>LoadBalancersPost201Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/LoadBalancersPost201Response} obj Optional instance to populate.
     * @return {module:model/LoadBalancersPost201Response} The populated <code>LoadBalancersPost201Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new LoadBalancersPost201Response();
    ...
    /**
     * Validates the JSON data with respect to <code>LoadBalancersPost201Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>LoadBalancersPost201Response</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of LoadBalancersPost201Response.RequiredProperties) {
...
LoadBalancersPost201Response.RequiredProperties = ["action", "load_balancer"];

/**
 * @member {module:model/Action} action
 */
LoadBalancersPost201Response.prototype['action'] = undefined;

/**
 * @member {module:model/LoadBalancersGet200ResponseLoadBalancersInner} load_balancer
 */
LoadBalancersPost201Response.prototype['load_balancer'] = undefined;
...
export default LoadBalancersPost201Response;
