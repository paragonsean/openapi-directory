...
/**
 * The CertificateUsedByInner model module.
 * @module model/CertificateUsedByInner
 * @version 1.0.0
 */
class CertificateUsedByInner {
    /**
     * Constructs a new <code>CertificateUsedByInner</code>.
     * @alias module:model/CertificateUsedByInner
     * @param id {Number} ID of resource referenced
     * @param type {String} Type of resource referenced
     */
    constructor(id, type) { 
        
        CertificateUsedByInner.initialize(this, id, type);
    }
    ...
    /**
     * Constructs a <code>CertificateUsedByInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CertificateUsedByInner} obj Optional instance to populate.
     * @return {module:model/CertificateUsedByInner} The populated <code>CertificateUsedByInner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CertificateUsedByInner();
    ...
    /**
     * Validates the JSON data with respect to <code>CertificateUsedByInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CertificateUsedByInner</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CertificateUsedByInner.RequiredProperties) {
...
CertificateUsedByInner.RequiredProperties = ["id", "type"];

/**
 * ID of resource referenced
 * @member {Number} id
 */
CertificateUsedByInner.prototype['id'] = undefined;

/**
 * Type of resource referenced
 * @member {String} type
 */
CertificateUsedByInner.prototype['type'] = undefined;
...
export default CertificateUsedByInner;
