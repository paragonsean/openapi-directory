...
/**
 * The CreateFirewallRequestApplyToInnerServer model module.
 * @module model/CreateFirewallRequestApplyToInnerServer
 * @version 1.0.0
 */
class CreateFirewallRequestApplyToInnerServer {
    /**
     * Constructs a new <code>CreateFirewallRequestApplyToInnerServer</code>.
     * Configuration for type Server, required if type is &#x60;server&#x60;
     * @alias module:model/CreateFirewallRequestApplyToInnerServer
     * @param id {Number} ID of the Server
     */
    constructor(id) { 
        
        CreateFirewallRequestApplyToInnerServer.initialize(this, id);
    }
    ...
    /**
     * Constructs a <code>CreateFirewallRequestApplyToInnerServer</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateFirewallRequestApplyToInnerServer} obj Optional instance to populate.
     * @return {module:model/CreateFirewallRequestApplyToInnerServer} The populated <code>CreateFirewallRequestApplyToInnerServer</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateFirewallRequestApplyToInnerServer();
    ...
    /**
     * Validates the JSON data with respect to <code>CreateFirewallRequestApplyToInnerServer</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateFirewallRequestApplyToInnerServer</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CreateFirewallRequestApplyToInnerServer.RequiredProperties) {
...
CreateFirewallRequestApplyToInnerServer.RequiredProperties = ["id"];

/**
 * ID of the Server
 * @member {Number} id
 */
CreateFirewallRequestApplyToInnerServer.prototype['id'] = undefined;
...
export default CreateFirewallRequestApplyToInnerServer;
