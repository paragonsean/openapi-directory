...
class CreateVolumeRequest {
    ...
    constructor(name, size) { 
        ...
        CreateVolumeRequest.initialize(this, name, size);
    }
...
CreateVolumeRequest.RequiredProperties = ["name", "size"];

/**
 * Auto-mount Volume after attach. `server` must be provided.
 * @member {Boolean} automount
 */
CreateVolumeRequest.prototype['automount'] = undefined;

/**
 * Format Volume after creation. One of: `xfs`, `ext4`
 * @member {String} format
 */
CreateVolumeRequest.prototype['format'] = undefined;

/**
 * User-defined labels (key-value pairs)
 * @member {Object} labels
 */
CreateVolumeRequest.prototype['labels'] = undefined;

/**
 * Location to create the Volume in (can be omitted if Server is specified)
 * @member {String} location
 */
CreateVolumeRequest.prototype['location'] = undefined;
 ...
 */
CreateVolumeRequest.prototype['server'] = undefined;
