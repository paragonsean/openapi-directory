...
/**
 * The VolumesGet200Response model module.
 * @module model/VolumesGet200Response
 * @version 1.0.0
 */
class VolumesGet200Response {
    /**
     * Constructs a new <code>VolumesGet200Response</code>.
     * @alias module:model/VolumesGet200Response
     * @param volumes {Array.<module:model/VolumesGet200ResponseVolumesInner>} 
     */
    constructor(volumes) { 
        
        VolumesGet200Response.initialize(this, volumes);
    }
     ...
     */
    static initialize(obj, volumes) { 
        obj['volumes'] = volumes;
    }

    /**
     * Constructs a <code>VolumesGet200Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/VolumesGet200Response} obj Optional instance to populate.
     * @return {module:model/VolumesGet200Response} The populated <code>VolumesGet200Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new VolumesGet200Response();

            if (data.hasOwnProperty('meta')) {
                obj['meta'] = ActionsResponseMeta.constructFromObject(data['meta']);
            }
            if (data.hasOwnProperty('volumes')) {
                obj['volumes'] = ApiClient.convertToType(data['volumes'], [VolumesGet200ResponseVolumesInner]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>VolumesGet200Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>VolumesGet200Response</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of VolumesGet200Response.RequiredProperties) {
        ...
        if (data['volumes']) { // data not null
            ...
            for (const item of data['volumes']) {
                VolumesGet200ResponseVolumesInner.validateJSON(item);
            };
        }
...
VolumesGet200Response.RequiredProperties = ["volumes"];

/**
 * @member {module:model/ActionsResponseMeta} meta
 */
VolumesGet200Response.prototype['meta'] = undefined;

/**
 * @member {Array.<module:model/VolumesGet200ResponseVolumesInner>} volumes
 */
VolumesGet200Response.prototype['volumes'] = undefined;
...
export default VolumesGet200Response;
