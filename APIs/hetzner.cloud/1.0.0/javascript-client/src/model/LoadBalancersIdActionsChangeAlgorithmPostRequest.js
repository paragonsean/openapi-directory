...
/**
 * The LoadBalancersIdActionsChangeAlgorithmPostRequest model module.
 * @module model/LoadBalancersIdActionsChangeAlgorithmPostRequest
 * @version 1.0.0
 */
class LoadBalancersIdActionsChangeAlgorithmPostRequest {
    /**
     * Constructs a new <code>LoadBalancersIdActionsChangeAlgorithmPostRequest</code>.
     * @alias module:model/LoadBalancersIdActionsChangeAlgorithmPostRequest
     * @param type {module:model/LoadBalancersIdActionsChangeAlgorithmPostRequest.TypeEnum} Algorithm of the Load Balancer
     */
    constructor(type) { 
        
        LoadBalancersIdActionsChangeAlgorithmPostRequest.initialize(this, type);
    }
    ...
    /**
     * Constructs a <code>LoadBalancersIdActionsChangeAlgorithmPostRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/LoadBalancersIdActionsChangeAlgorithmPostRequest} obj Optional instance to populate.
     * @return {module:model/LoadBalancersIdActionsChangeAlgorithmPostRequest} The populated <code>LoadBalancersIdActionsChangeAlgorithmPostRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new LoadBalancersIdActionsChangeAlgorithmPostRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>LoadBalancersIdActionsChangeAlgorithmPostRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>LoadBalancersIdActionsChangeAlgorithmPostRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of LoadBalancersIdActionsChangeAlgorithmPostRequest.RequiredProperties) {
...
LoadBalancersIdActionsChangeAlgorithmPostRequest.RequiredProperties = ["type"];

/**
 * Algorithm of the Load Balancer
 * @member {module:model/LoadBalancersIdActionsChangeAlgorithmPostRequest.TypeEnum} type
 */
LoadBalancersIdActionsChangeAlgorithmPostRequest.prototype['type'] = undefined;
 ...
 * @readonly
 */
LoadBalancersIdActionsChangeAlgorithmPostRequest['TypeEnum'] = {
...
export default LoadBalancersIdActionsChangeAlgorithmPostRequest;
