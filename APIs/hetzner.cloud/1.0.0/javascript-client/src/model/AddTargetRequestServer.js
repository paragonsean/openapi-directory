...
/**
 * The AddTargetRequestServer model module.
 * @module model/AddTargetRequestServer
 * @version 1.0.0
 */
class AddTargetRequestServer {
    /**
     * Constructs a new <code>AddTargetRequestServer</code>.
     * Configuration for type Server, required if type is &#x60;server&#x60;
     * @alias module:model/AddTargetRequestServer
     * @param id {Number} ID of the Server
     */
    constructor(id) { 
        
        AddTargetRequestServer.initialize(this, id);
    }
    ...
    /**
     * Constructs a <code>AddTargetRequestServer</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AddTargetRequestServer} obj Optional instance to populate.
     * @return {module:model/AddTargetRequestServer} The populated <code>AddTargetRequestServer</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AddTargetRequestServer();
    ...
    /**
     * Validates the JSON data with respect to <code>AddTargetRequestServer</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AddTargetRequestServer</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of AddTargetRequestServer.RequiredProperties) {
...
AddTargetRequestServer.RequiredProperties = ["id"];

/**
 * ID of the Server
 * @member {Number} id
 */
AddTargetRequestServer.prototype['id'] = undefined;
...
export default AddTargetRequestServer;
