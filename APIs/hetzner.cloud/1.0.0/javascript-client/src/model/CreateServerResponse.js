...
class CreateServerResponse {
     ...
     * @param rootPassword {String} Root password when no SSH keys have been specified
     * @param server {module:model/ServersGet200ResponseServersInner} 
     */
    constructor(action, nextActions, rootPassword, server) { 
        
        CreateServerResponse.initialize(this, action, nextActions, rootPassword, server);
    }
     ...
     */
    static initialize(obj, action, nextActions, rootPassword, server) { 
        obj['action'] = action;
        obj['next_actions'] = nextActions;
        obj['root_password'] = rootPassword;
        obj['server'] = server;
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('server')) {
                obj['server'] = ServersGet200ResponseServersInner.constructFromObject(data['server']);
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        if (data['server']) { // data not null
          ServersGet200ResponseServersInner.validateJSON(data['server']);
        }
...
CreateServerResponse.RequiredProperties = ["action", "next_actions", "root_password", "server"];

/**
 * @member {module:model/Action} action
 */
CreateServerResponse.prototype['action'] = undefined;

/**
 * @member {Array.<module:model/Action>} next_actions
 */
CreateServerResponse.prototype['next_actions'] = undefined;

/**
 * Root password when no SSH keys have been specified
 * @member {String} root_password
 */
CreateServerResponse.prototype['root_password'] = undefined;

/**
 * @member {module:model/ServersGet200ResponseServersInner} server
 */
CreateServerResponse.prototype['server'] = undefined;
