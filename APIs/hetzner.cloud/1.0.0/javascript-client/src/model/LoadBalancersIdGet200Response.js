...
/**
 * The LoadBalancersIdGet200Response model module.
 * @module model/LoadBalancersIdGet200Response
 * @version 1.0.0
 */
class LoadBalancersIdGet200Response {
    /**
     * Constructs a new <code>LoadBalancersIdGet200Response</code>.
     * @alias module:model/LoadBalancersIdGet200Response
     * @param loadBalancer {module:model/LoadBalancersGet200ResponseLoadBalancersInner} 
     */
    constructor(loadBalancer) { 
        
        LoadBalancersIdGet200Response.initialize(this, loadBalancer);
    }
     ...
     */
    static initialize(obj, loadBalancer) { 
        obj['load_balancer'] = loadBalancer;
    }

    /**
     * Constructs a <code>LoadBalancersIdGet200Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/LoadBalancersIdGet200Response} obj Optional instance to populate.
     * @return {module:model/LoadBalancersIdGet200Response} The populated <code>LoadBalancersIdGet200Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new LoadBalancersIdGet200Response();

            if (data.hasOwnProperty('load_balancer')) {
                obj['load_balancer'] = LoadBalancersGet200ResponseLoadBalancersInner.constructFromObject(data['load_balancer']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>LoadBalancersIdGet200Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>LoadBalancersIdGet200Response</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of LoadBalancersIdGet200Response.RequiredProperties) {
            if (!data.hasOwnProperty(property)) {
                throw new Error("The required field `" + property + "` is not found in the JSON data: " + JSON.stringify(data));
            }
        }
        // validate the optional field `load_balancer`
        if (data['load_balancer']) { // data not null
          LoadBalancersGet200ResponseLoadBalancersInner.validateJSON(data['load_balancer']);
        }
...
LoadBalancersIdGet200Response.RequiredProperties = ["load_balancer"];

/**
 * @member {module:model/LoadBalancersGet200ResponseLoadBalancersInner} load_balancer
 */
LoadBalancersIdGet200Response.prototype['load_balancer'] = undefined;
...
export default LoadBalancersIdGet200Response;
