...
/**
 * The LoadBalancerTargetIP model module.
 * @module model/LoadBalancerTargetIP
 * @version 1.0.0
 */
class LoadBalancerTargetIP {
    /**
     * Constructs a new <code>LoadBalancerTargetIP</code>.
     ...
     * @alias module:model/LoadBalancerTargetIP
     * @param ip {String} IP of a server that belongs to the same customer (public IPv4/IPv6) or private IP in a Subnetwork type vswitch.
     */
    constructor(ip) { 
        
        LoadBalancerTargetIP.initialize(this, ip);
    }
    ...
    /**
     * Constructs a <code>LoadBalancerTargetIP</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/LoadBalancerTargetIP} obj Optional instance to populate.
     * @return {module:model/LoadBalancerTargetIP} The populated <code>LoadBalancerTargetIP</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new LoadBalancerTargetIP();
    ...
    /**
     * Validates the JSON data with respect to <code>LoadBalancerTargetIP</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>LoadBalancerTargetIP</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of LoadBalancerTargetIP.RequiredProperties) {
...
export default LoadBalancerTargetIP;
