...
/**
 * The NetworksGet200ResponseNetworksInnerRoutesInner model module.
 * @module model/NetworksGet200ResponseNetworksInnerRoutesInner
 * @version 1.0.0
 */
class NetworksGet200ResponseNetworksInnerRoutesInner {
    /**
     * Constructs a new <code>NetworksGet200ResponseNetworksInnerRoutesInner</code>.
     * @alias module:model/NetworksGet200ResponseNetworksInnerRoutesInner
     * @param destination {String} Destination network or host of this route. Must not overlap with an existing ip_range in any subnets or with any destinations in other routes or with the first IP of the networks ip_range or with 172.31.1.1. Must be one of the private IPv4 ranges of RFC1918.
     * @param gateway {String} Gateway for the route. Cannot be the first IP of the networks ip_range and also cannot be 172.31.1.1 as this IP is being used as a gateway for the public network interface of Servers.
     */
    constructor(destination, gateway) { 
        
        NetworksGet200ResponseNetworksInnerRoutesInner.initialize(this, destination, gateway);
    }
     ...
     */
    static initialize(obj, destination, gateway) { 
        obj['destination'] = destination;
        obj['gateway'] = gateway;
    }

    /**
     * Constructs a <code>NetworksGet200ResponseNetworksInnerRoutesInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/NetworksGet200ResponseNetworksInnerRoutesInner} obj Optional instance to populate.
     * @return {module:model/NetworksGet200ResponseNetworksInnerRoutesInner} The populated <code>NetworksGet200ResponseNetworksInnerRoutesInner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new NetworksGet200ResponseNetworksInnerRoutesInner();
    ...
    /**
     * Validates the JSON data with respect to <code>NetworksGet200ResponseNetworksInnerRoutesInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>NetworksGet200ResponseNetworksInnerRoutesInner</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of NetworksGet200ResponseNetworksInnerRoutesInner.RequiredProperties) {
...
NetworksGet200ResponseNetworksInnerRoutesInner.RequiredProperties = ["destination", "gateway"];
 ...
 */
NetworksGet200ResponseNetworksInnerRoutesInner.prototype['destination'] = undefined;
 ...
 */
NetworksGet200ResponseNetworksInnerRoutesInner.prototype['gateway'] = undefined;
...
export default NetworksGet200ResponseNetworksInnerRoutesInner;
