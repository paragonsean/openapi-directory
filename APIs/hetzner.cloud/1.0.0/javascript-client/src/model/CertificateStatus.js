...
import CertificateStatusError from './CertificateStatusError';

/**
 * The CertificateStatus model module.
 * @module model/CertificateStatus
 * @version 1.0.0
 */
class CertificateStatus {
    /**
     * Constructs a new <code>CertificateStatus</code>.
     * Current status of a type &#x60;managed&#x60; Certificate, always *null* for type &#x60;uploaded&#x60; Certificates
     * @alias module:model/CertificateStatus
     */
    constructor() { 
        
        CertificateStatus.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CertificateStatus</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CertificateStatus} obj Optional instance to populate.
     * @return {module:model/CertificateStatus} The populated <code>CertificateStatus</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CertificateStatus();

            if (data.hasOwnProperty('error')) {
                obj['error'] = CertificateStatusError.constructFromObject(data['error']);
            }
            if (data.hasOwnProperty('issuance')) {
                obj['issuance'] = ApiClient.convertToType(data['issuance'], 'String');
            }
    ...
    /**
     * Validates the JSON data with respect to <code>CertificateStatus</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CertificateStatus</code>.
     */
    static validateJSON(data) {
        // validate the optional field `error`
        if (data['error']) { // data not null
          CertificateStatusError.validateJSON(data['error']);
        }
        // ensure the json data is a string
        if (data['issuance'] && !(typeof data['issuance'] === 'string' || data['issuance'] instanceof String)) {
            throw new Error("Expected the field `issuance` to be a primitive type in the JSON string but got " + data['issuance']);
        }
        // ensure the json data is a string
...
/**
 * @member {module:model/CertificateStatusError} error
 */
CertificateStatus.prototype['error'] = undefined;

/**
 * Status of the issuance process of the Certificate
 * @member {module:model/CertificateStatus.IssuanceEnum} issuance
 */
CertificateStatus.prototype['issuance'] = undefined;

/**
 * Status of the renewal process of the Certificate.
 * @member {module:model/CertificateStatus.RenewalEnum} renewal
 */
CertificateStatus.prototype['renewal'] = undefined;
...
/**
 * Allowed values for the <code>issuance</code> property.
 * @enum {String}
 * @readonly
 */
CertificateStatus['IssuanceEnum'] = {
...
/**
 * Allowed values for the <code>renewal</code> property.
 * @enum {String}
 * @readonly
 */
CertificateStatus['RenewalEnum'] = {
