...
/**
 * The LoadBalancersIdMetricsGet200Response model module.
 * @module model/LoadBalancersIdMetricsGet200Response
 * @version 1.0.0
 */
class LoadBalancersIdMetricsGet200Response {
    /**
     * Constructs a new <code>LoadBalancersIdMetricsGet200Response</code>.
     * @alias module:model/LoadBalancersIdMetricsGet200Response
     * @param metrics {module:model/LoadBalancersIdMetricsGet200ResponseMetrics} 
     */
    constructor(metrics) { 
        
        LoadBalancersIdMetricsGet200Response.initialize(this, metrics);
    }
    ...
    /**
     * Constructs a <code>LoadBalancersIdMetricsGet200Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/LoadBalancersIdMetricsGet200Response} obj Optional instance to populate.
     * @return {module:model/LoadBalancersIdMetricsGet200Response} The populated <code>LoadBalancersIdMetricsGet200Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new LoadBalancersIdMetricsGet200Response();

            if (data.hasOwnProperty('metrics')) {
                obj['metrics'] = LoadBalancersIdMetricsGet200ResponseMetrics.constructFromObject(data['metrics']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>LoadBalancersIdMetricsGet200Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>LoadBalancersIdMetricsGet200Response</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of LoadBalancersIdMetricsGet200Response.RequiredProperties) {
        ...
        if (data['metrics']) { // data not null
          LoadBalancersIdMetricsGet200ResponseMetrics.validateJSON(data['metrics']);
        }
...
LoadBalancersIdMetricsGet200Response.RequiredProperties = ["metrics"];

/**
 * @member {module:model/LoadBalancersIdMetricsGet200ResponseMetrics} metrics
 */
LoadBalancersIdMetricsGet200Response.prototype['metrics'] = undefined;
...
export default LoadBalancersIdMetricsGet200Response;
