...
/**
 * The LoadBalancersIdActionsAttachToNetworkPostRequest model module.
 * @module model/LoadBalancersIdActionsAttachToNetworkPostRequest
 * @version 1.0.0
 */
class LoadBalancersIdActionsAttachToNetworkPostRequest {
    /**
     * Constructs a new <code>LoadBalancersIdActionsAttachToNetworkPostRequest</code>.
     * @alias module:model/LoadBalancersIdActionsAttachToNetworkPostRequest
     * @param network {Number} ID of an existing network to attach the Load Balancer to
     */
    constructor(network) { 
        
        LoadBalancersIdActionsAttachToNetworkPostRequest.initialize(this, network);
    }
    ...
    /**
     * Constructs a <code>LoadBalancersIdActionsAttachToNetworkPostRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/LoadBalancersIdActionsAttachToNetworkPostRequest} obj Optional instance to populate.
     * @return {module:model/LoadBalancersIdActionsAttachToNetworkPostRequest} The populated <code>LoadBalancersIdActionsAttachToNetworkPostRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new LoadBalancersIdActionsAttachToNetworkPostRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>LoadBalancersIdActionsAttachToNetworkPostRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>LoadBalancersIdActionsAttachToNetworkPostRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of LoadBalancersIdActionsAttachToNetworkPostRequest.RequiredProperties) {
...
LoadBalancersIdActionsAttachToNetworkPostRequest.RequiredProperties = ["network"];
 ...
 * @member {String} ip
 */
LoadBalancersIdActionsAttachToNetworkPostRequest.prototype['ip'] = undefined;

/**
 * ID of an existing network to attach the Load Balancer to
 * @member {Number} network
 */
LoadBalancersIdActionsAttachToNetworkPostRequest.prototype['network'] = undefined;
...
export default LoadBalancersIdActionsAttachToNetworkPostRequest;
