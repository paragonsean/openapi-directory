...
/**
 * The ServersGet200ResponseServersInnerPublicNetIpv6 model module.
 * @module model/ServersGet200ResponseServersInnerPublicNetIpv6
 * @version 1.0.0
 */
class ServersGet200ResponseServersInnerPublicNetIpv6 {
    /**
     * Constructs a new <code>ServersGet200ResponseServersInnerPublicNetIpv6</code>.
     * IPv6 network assigned to this Server and its reverse DNS entry
     * @alias module:model/ServersGet200ResponseServersInnerPublicNetIpv6
     * @param blocked {Boolean} If the IP is blocked by our anti abuse dept
     * @param dnsPtr {Array.<module:model/ServersGet200ResponseServersInnerPublicNetIpv6DnsPtrInner>} Reverse DNS PTR entries for the IPv6 addresses of this Server, `null` by default
     * @param ip {String} IP address (v6) of this Server
     */
    constructor(blocked, dnsPtr, ip) { 
        
        ServersGet200ResponseServersInnerPublicNetIpv6.initialize(this, blocked, dnsPtr, ip);
    }
     ...
     */
    static initialize(obj, blocked, dnsPtr, ip) { 
        obj['blocked'] = blocked;
        obj['dns_ptr'] = dnsPtr;
        obj['ip'] = ip;
    }
    ...
    /**
     * Constructs a <code>ServersGet200ResponseServersInnerPublicNetIpv6</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ServersGet200ResponseServersInnerPublicNetIpv6} obj Optional instance to populate.
     * @return {module:model/ServersGet200ResponseServersInnerPublicNetIpv6} The populated <code>ServersGet200ResponseServersInnerPublicNetIpv6</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ServersGet200ResponseServersInnerPublicNetIpv6();

            if (data.hasOwnProperty('blocked')) {
                obj['blocked'] = ApiClient.convertToType(data['blocked'], 'Boolean');
            }
            if (data.hasOwnProperty('dns_ptr')) {
                obj['dns_ptr'] = ApiClient.convertToType(data['dns_ptr'], [ServersGet200ResponseServersInnerPublicNetIpv6DnsPtrInner]);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>ServersGet200ResponseServersInnerPublicNetIpv6</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ServersGet200ResponseServersInnerPublicNetIpv6</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ServersGet200ResponseServersInnerPublicNetIpv6.RequiredProperties) {
            if (!data.hasOwnProperty(property)) {
                throw new Error("The required field `" + property + "` is not found in the JSON data: " + JSON.stringify(data));
            }
        }
        if (data['dns_ptr']) { // data not null
            // ensure the json data is an array
            if (!Array.isArray(data['dns_ptr'])) {
                throw new Error("Expected the field `dns_ptr` to be an array in the JSON data but got " + data['dns_ptr']);
            }
            // validate the optional field `dns_ptr` (array)
            for (const item of data['dns_ptr']) {
                ServersGet200ResponseServersInnerPublicNetIpv6DnsPtrInner.validateJSON(item);
            };
        }
...
ServersGet200ResponseServersInnerPublicNetIpv6.RequiredProperties = ["blocked", "dns_ptr", "ip"];

/**
 * If the IP is blocked by our anti abuse dept
 * @member {Boolean} blocked
 */
ServersGet200ResponseServersInnerPublicNetIpv6.prototype['blocked'] = undefined;

/**
 * Reverse DNS PTR entries for the IPv6 addresses of this Server, `null` by default
 * @member {Array.<module:model/ServersGet200ResponseServersInnerPublicNetIpv6DnsPtrInner>} dns_ptr
 */
ServersGet200ResponseServersInnerPublicNetIpv6.prototype['dns_ptr'] = undefined;

/**
 * ID of the Resource
 * @member {Number} id
 */
ServersGet200ResponseServersInnerPublicNetIpv6.prototype['id'] = undefined;

/**
 * IP address (v6) of this Server
 * @member {String} ip
 */
ServersGet200ResponseServersInnerPublicNetIpv6.prototype['ip'] = undefined;
...
export default ServersGet200ResponseServersInnerPublicNetIpv6;
