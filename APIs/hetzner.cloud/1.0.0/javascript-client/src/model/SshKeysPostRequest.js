...
/**
 * The SshKeysPostRequest model module.
 * @module model/SshKeysPostRequest
 * @version 1.0.0
 */
class SshKeysPostRequest {
    /**
     * Constructs a new <code>SshKeysPostRequest</code>.
     * @alias module:model/SshKeysPostRequest
     * @param name {String} Name of the SSH key
     * @param publicKey {String} Public key
     */
    constructor(name, publicKey) { 
        
        SshKeysPostRequest.initialize(this, name, publicKey);
    }
    ...
    /**
     * Constructs a <code>SshKeysPostRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SshKeysPostRequest} obj Optional instance to populate.
     * @return {module:model/SshKeysPostRequest} The populated <code>SshKeysPostRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SshKeysPostRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>SshKeysPostRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SshKeysPostRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of SshKeysPostRequest.RequiredProperties) {
...
SshKeysPostRequest.RequiredProperties = ["name", "public_key"];

/**
 * User-defined labels (key-value pairs)
 * @member {Object} labels
 */
SshKeysPostRequest.prototype['labels'] = undefined;

/**
 * Name of the SSH key
 * @member {String} name
 */
SshKeysPostRequest.prototype['name'] = undefined;

/**
 * Public key
 * @member {String} public_key
 */
SshKeysPostRequest.prototype['public_key'] = undefined;
...
export default SshKeysPostRequest;
