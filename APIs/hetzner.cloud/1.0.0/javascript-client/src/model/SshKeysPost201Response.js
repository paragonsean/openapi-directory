...
/**
 * The SshKeysPost201Response model module.
 * @module model/SshKeysPost201Response
 * @version 1.0.0
 */
class SshKeysPost201Response {
    /**
     * Constructs a new <code>SshKeysPost201Response</code>.
     * @alias module:model/SshKeysPost201Response
     * @param sshKey {module:model/SshKeysGet200ResponseSshKeysInner} 
     */
    constructor(sshKey) { 
        
        SshKeysPost201Response.initialize(this, sshKey);
    }
    ...
    /**
     * Constructs a <code>SshKeysPost201Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SshKeysPost201Response} obj Optional instance to populate.
     * @return {module:model/SshKeysPost201Response} The populated <code>SshKeysPost201Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SshKeysPost201Response();

            if (data.hasOwnProperty('ssh_key')) {
                obj['ssh_key'] = SshKeysGet200ResponseSshKeysInner.constructFromObject(data['ssh_key']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>SshKeysPost201Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SshKeysPost201Response</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of SshKeysPost201Response.RequiredProperties) {
            if (!data.hasOwnProperty(property)) {
                throw new Error("The required field `" + property + "` is not found in the JSON data: " + JSON.stringify(data));
            }
        }
        // validate the optional field `ssh_key`
        if (data['ssh_key']) { // data not null
          SshKeysGet200ResponseSshKeysInner.validateJSON(data['ssh_key']);
        }
...
SshKeysPost201Response.RequiredProperties = ["ssh_key"];

/**
 * @member {module:model/SshKeysGet200ResponseSshKeysInner} ssh_key
 */
SshKeysPost201Response.prototype['ssh_key'] = undefined;
...
export default SshKeysPost201Response;
