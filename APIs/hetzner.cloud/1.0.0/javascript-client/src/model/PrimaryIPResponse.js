...
/**
 * The PrimaryIPResponse model module.
 * @module model/PrimaryIPResponse
 * @version 1.0.0
 */
class PrimaryIPResponse {
    /**
     * Constructs a new <code>PrimaryIPResponse</code>.
     * @alias module:model/PrimaryIPResponse
     * @param primaryIp {module:model/PrimaryIP} 
     */
    constructor(primaryIp) { 
        
        PrimaryIPResponse.initialize(this, primaryIp);
    }
    ...
    /**
     * Constructs a <code>PrimaryIPResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PrimaryIPResponse} obj Optional instance to populate.
     * @return {module:model/PrimaryIPResponse} The populated <code>PrimaryIPResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PrimaryIPResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>PrimaryIPResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PrimaryIPResponse</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of PrimaryIPResponse.RequiredProperties) {
...
PrimaryIPResponse.RequiredProperties = ["primary_ip"];

/**
 * @member {module:model/PrimaryIP} primary_ip
 */
PrimaryIPResponse.prototype['primary_ip'] = undefined;
...
export default PrimaryIPResponse;
