...
/**
 * The ActionResourcesInner model module.
 * @module model/ActionResourcesInner
 * @version 1.0.0
 */
class ActionResourcesInner {
    /**
     * Constructs a new <code>ActionResourcesInner</code>.
     * @alias module:model/ActionResourcesInner
     * @param id {Number} ID of the Resource
     * @param type {String} Type of resource referenced
     */
    constructor(id, type) { 
        
        ActionResourcesInner.initialize(this, id, type);
    }
    ...
    /**
     * Constructs a <code>ActionResourcesInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ActionResourcesInner} obj Optional instance to populate.
     * @return {module:model/ActionResourcesInner} The populated <code>ActionResourcesInner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ActionResourcesInner();
    ...
    /**
     * Validates the JSON data with respect to <code>ActionResourcesInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ActionResourcesInner</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ActionResourcesInner.RequiredProperties) {
...
ActionResourcesInner.RequiredProperties = ["id", "type"];

/**
 * ID of the Resource
 * @member {Number} id
 */
ActionResourcesInner.prototype['id'] = undefined;

/**
 * Type of resource referenced
 * @member {String} type
 */
ActionResourcesInner.prototype['type'] = undefined;
...
export default ActionResourcesInner;
