...
/**
 * The DatacentersGet200ResponseDatacentersInnerServerTypes model module.
 * @module model/DatacentersGet200ResponseDatacentersInnerServerTypes
 * @version 1.0.0
 */
class DatacentersGet200ResponseDatacentersInnerServerTypes {
    /**
     * Constructs a new <code>DatacentersGet200ResponseDatacentersInnerServerTypes</code>.
     * The Server types the Datacenter can handle
     * @alias module:model/DatacentersGet200ResponseDatacentersInnerServerTypes
     * @param available {Array.<Number>} IDs of Server types that are supported and for which the Datacenter has enough resources left
     * @param availableForMigration {Array.<Number>} IDs of Server types that are supported and for which the Datacenter has enough resources left
     * @param supported {Array.<Number>} IDs of Server types that are supported in the Datacenter
     */
    constructor(available, availableForMigration, supported) { 
        
        DatacentersGet200ResponseDatacentersInnerServerTypes.initialize(this, available, availableForMigration, supported);
    }
     ...
     */
    static initialize(obj, available, availableForMigration, supported) { 
        obj['available'] = available;
        obj['available_for_migration'] = availableForMigration;
        obj['supported'] = supported;
    }

    /**
     * Constructs a <code>DatacentersGet200ResponseDatacentersInnerServerTypes</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DatacentersGet200ResponseDatacentersInnerServerTypes} obj Optional instance to populate.
     * @return {module:model/DatacentersGet200ResponseDatacentersInnerServerTypes} The populated <code>DatacentersGet200ResponseDatacentersInnerServerTypes</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DatacentersGet200ResponseDatacentersInnerServerTypes();

            if (data.hasOwnProperty('available')) {
                obj['available'] = ApiClient.convertToType(data['available'], ['Number']);
            }
            if (data.hasOwnProperty('available_for_migration')) {
                obj['available_for_migration'] = ApiClient.convertToType(data['available_for_migration'], ['Number']);
            }
            if (data.hasOwnProperty('supported')) {
                obj['supported'] = ApiClient.convertToType(data['supported'], ['Number']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>DatacentersGet200ResponseDatacentersInnerServerTypes</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DatacentersGet200ResponseDatacentersInnerServerTypes</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DatacentersGet200ResponseDatacentersInnerServerTypes.RequiredProperties) {
        ...
        // ensure the json data is an array
        if (!Array.isArray(data['available_for_migration'])) {
            throw new Error("Expected the field `available_for_migration` to be an array in the JSON data but got " + data['available_for_migration']);
        }
        // ensure the json data is an array
        if (!Array.isArray(data['supported'])) {
            throw new Error("Expected the field `supported` to be an array in the JSON data but got " + data['supported']);
        }
...
DatacentersGet200ResponseDatacentersInnerServerTypes.RequiredProperties = ["available", "available_for_migration", "supported"];

/**
 * IDs of Server types that are supported and for which the Datacenter has enough resources left
 * @member {Array.<Number>} available
 */
DatacentersGet200ResponseDatacentersInnerServerTypes.prototype['available'] = undefined;

/**
 * IDs of Server types that are supported and for which the Datacenter has enough resources left
 * @member {Array.<Number>} available_for_migration
 */
DatacentersGet200ResponseDatacentersInnerServerTypes.prototype['available_for_migration'] = undefined;

/**
 * IDs of Server types that are supported in the Datacenter
 * @member {Array.<Number>} supported
 */
DatacentersGet200ResponseDatacentersInnerServerTypes.prototype['supported'] = undefined;
...
export default DatacentersGet200ResponseDatacentersInnerServerTypes;
