...
import LoadBalancersIdMetricsGet200ResponseMetricsTimeSeriesValueValuesInnerInner from './LoadBalancersIdMetricsGet200ResponseMetricsTimeSeriesValueValuesInnerInner';

/**
 * The LoadBalancersIdMetricsGet200ResponseMetricsTimeSeriesValue model module.
 * @module model/LoadBalancersIdMetricsGet200ResponseMetricsTimeSeriesValue
 * @version 1.0.0
 */
class LoadBalancersIdMetricsGet200ResponseMetricsTimeSeriesValue {
    /**
     * Constructs a new <code>LoadBalancersIdMetricsGet200ResponseMetricsTimeSeriesValue</code>.
     * @alias module:model/LoadBalancersIdMetricsGet200ResponseMetricsTimeSeriesValue
     * @param values {Array.<Array.<module:model/LoadBalancersIdMetricsGet200ResponseMetricsTimeSeriesValueValuesInnerInner>>} Metrics Timestamps with values
     */
    constructor(values) { 
        
        LoadBalancersIdMetricsGet200ResponseMetricsTimeSeriesValue.initialize(this, values);
    }
    ...
    /**
     * Constructs a <code>LoadBalancersIdMetricsGet200ResponseMetricsTimeSeriesValue</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/LoadBalancersIdMetricsGet200ResponseMetricsTimeSeriesValue} obj Optional instance to populate.
     * @return {module:model/LoadBalancersIdMetricsGet200ResponseMetricsTimeSeriesValue} The populated <code>LoadBalancersIdMetricsGet200ResponseMetricsTimeSeriesValue</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new LoadBalancersIdMetricsGet200ResponseMetricsTimeSeriesValue();

            if (data.hasOwnProperty('values')) {
                obj['values'] = ApiClient.convertToType(data['values'], [[LoadBalancersIdMetricsGet200ResponseMetricsTimeSeriesValueValuesInnerInner]]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>LoadBalancersIdMetricsGet200ResponseMetricsTimeSeriesValue</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>LoadBalancersIdMetricsGet200ResponseMetricsTimeSeriesValue</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of LoadBalancersIdMetricsGet200ResponseMetricsTimeSeriesValue.RequiredProperties) {
...
LoadBalancersIdMetricsGet200ResponseMetricsTimeSeriesValue.RequiredProperties = ["values"];

/**
 * Metrics Timestamps with values
 * @member {Array.<Array.<module:model/LoadBalancersIdMetricsGet200ResponseMetricsTimeSeriesValueValuesInnerInner>>} values
 */
LoadBalancersIdMetricsGet200ResponseMetricsTimeSeriesValue.prototype['values'] = undefined;
...
export default LoadBalancersIdMetricsGet200ResponseMetricsTimeSeriesValue;
