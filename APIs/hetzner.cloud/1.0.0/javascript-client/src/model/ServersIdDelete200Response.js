...
/**
 * The ServersIdDelete200Response model module.
 * @module model/ServersIdDelete200Response
 * @version 1.0.0
 */
class ServersIdDelete200Response {
    /**
     * Constructs a new <code>ServersIdDelete200Response</code>.
     * @alias module:model/ServersIdDelete200Response
     */
    constructor() { 
        
        ServersIdDelete200Response.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ServersIdDelete200Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ServersIdDelete200Response} obj Optional instance to populate.
     * @return {module:model/ServersIdDelete200Response} The populated <code>ServersIdDelete200Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ServersIdDelete200Response();
    ...
    /**
     * Validates the JSON data with respect to <code>ServersIdDelete200Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ServersIdDelete200Response</code>.
     */
 ...
 */
ServersIdDelete200Response.prototype['action'] = undefined;
...
export default ServersIdDelete200Response;
