...
/**
 * The PlacementGroupNullable model module.
 * @module model/PlacementGroupNullable
 * @version 1.0.0
 */
class PlacementGroupNullable {
    /**
     * Constructs a new <code>PlacementGroupNullable</code>.
     * @alias module:model/PlacementGroupNullable
     ...
     * @param servers {Array.<Number>} Array of IDs of Servers that are part of this Placement Group
     * @param type {module:model/PlacementGroupNullable.TypeEnum} Type of the Placement Group
     */
    constructor(created, id, labels, name, servers, type) { 
        
        PlacementGroupNullable.initialize(this, created, id, labels, name, servers, type);
    }
     ...
     */
    static initialize(obj, created, id, labels, name, servers, type) { 
        obj['created'] = created;
        obj['id'] = id;
        obj['labels'] = labels;
        obj['name'] = name;
    ...
    /**
     * Constructs a <code>PlacementGroupNullable</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PlacementGroupNullable} obj Optional instance to populate.
     * @return {module:model/PlacementGroupNullable} The populated <code>PlacementGroupNullable</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PlacementGroupNullable();
    ...
    /**
     * Validates the JSON data with respect to <code>PlacementGroupNullable</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PlacementGroupNullable</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of PlacementGroupNullable.RequiredProperties) {
...
PlacementGroupNullable.RequiredProperties = ["created", "id", "labels", "name", "servers", "type"];

/**
 * Point in time when the Resource was created (in ISO-8601 format)
 * @member {String} created
 */
PlacementGroupNullable.prototype['created'] = undefined;

/**
 * ID of the Resource
 * @member {Number} id
 */
PlacementGroupNullable.prototype['id'] = undefined;

/**
 * User-defined labels (key-value pairs)
 * @member {Object.<String, String>} labels
 */
PlacementGroupNullable.prototype['labels'] = undefined;

/**
 * Name of the Resource. Must be unique per Project.
 * @member {String} name
 */
PlacementGroupNullable.prototype['name'] = undefined;

/**
 * Array of IDs of Servers that are part of this Placement Group
 * @member {Array.<Number>} servers
 */
PlacementGroupNullable.prototype['servers'] = undefined;

/**
 * Type of the Placement Group
 * @member {module:model/PlacementGroupNullable.TypeEnum} type
 */
PlacementGroupNullable.prototype['type'] = undefined;
 ...
 * @readonly
 */
PlacementGroupNullable['TypeEnum'] = {
...
export default PlacementGroupNullable;
