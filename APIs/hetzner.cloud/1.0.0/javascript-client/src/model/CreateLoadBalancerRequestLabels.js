...
/**
 * The CreateLoadBalancerRequestLabels model module.
 * @module model/CreateLoadBalancerRequestLabels
 * @version 1.0.0
 */
class CreateLoadBalancerRequestLabels {
    /**
     * Constructs a new <code>CreateLoadBalancerRequestLabels</code>.
     * User-defined labels (key-value pairs)
     * @alias module:model/CreateLoadBalancerRequestLabels
     */
    constructor() { 
        
        CreateLoadBalancerRequestLabels.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CreateLoadBalancerRequestLabels</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateLoadBalancerRequestLabels} obj Optional instance to populate.
     * @return {module:model/CreateLoadBalancerRequestLabels} The populated <code>CreateLoadBalancerRequestLabels</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateLoadBalancerRequestLabels();
    ...
    /**
     * Validates the JSON data with respect to <code>CreateLoadBalancerRequestLabels</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateLoadBalancerRequestLabels</code>.
     */
 ...
 */
CreateLoadBalancerRequestLabels.prototype['labelkey'] = undefined;
...
export default CreateLoadBalancerRequestLabels;
