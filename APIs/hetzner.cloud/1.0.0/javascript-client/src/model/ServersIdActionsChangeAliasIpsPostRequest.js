...
/**
 * The ServersIdActionsChangeAliasIpsPostRequest model module.
 * @module model/ServersIdActionsChangeAliasIpsPostRequest
 * @version 1.0.0
 */
class ServersIdActionsChangeAliasIpsPostRequest {
    /**
     * Constructs a new <code>ServersIdActionsChangeAliasIpsPostRequest</code>.
     * @alias module:model/ServersIdActionsChangeAliasIpsPostRequest
     * @param aliasIps {Array.<String>} New alias IPs to set for this Server
     * @param network {Number} ID of an existing Network already attached to the Server
     */
    constructor(aliasIps, network) { 
        
        ServersIdActionsChangeAliasIpsPostRequest.initialize(this, aliasIps, network);
    }
     ...
     */
    static initialize(obj, aliasIps, network) { 
        obj['alias_ips'] = aliasIps;
        obj['network'] = network;
    }

    /**
     * Constructs a <code>ServersIdActionsChangeAliasIpsPostRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ServersIdActionsChangeAliasIpsPostRequest} obj Optional instance to populate.
     * @return {module:model/ServersIdActionsChangeAliasIpsPostRequest} The populated <code>ServersIdActionsChangeAliasIpsPostRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ServersIdActionsChangeAliasIpsPostRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>ServersIdActionsChangeAliasIpsPostRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ServersIdActionsChangeAliasIpsPostRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ServersIdActionsChangeAliasIpsPostRequest.RequiredProperties) {
...
ServersIdActionsChangeAliasIpsPostRequest.RequiredProperties = ["alias_ips", "network"];

/**
 * New alias IPs to set for this Server
 * @member {Array.<String>} alias_ips
 */
ServersIdActionsChangeAliasIpsPostRequest.prototype['alias_ips'] = undefined;

/**
 * ID of an existing Network already attached to the Server
 * @member {Number} network
 */
ServersIdActionsChangeAliasIpsPostRequest.prototype['network'] = undefined;
...
export default ServersIdActionsChangeAliasIpsPostRequest;
