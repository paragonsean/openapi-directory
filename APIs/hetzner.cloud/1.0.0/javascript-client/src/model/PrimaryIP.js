...
import PrimaryIPDnsPtrInner from './PrimaryIPDnsPtrInner';

/**
 * The PrimaryIP model module.
 * @module model/PrimaryIP
 * @version 1.0.0
 */
class PrimaryIP {
    /**
     * Constructs a new <code>PrimaryIP</code>.
     * @alias module:model/PrimaryIP
     * @param assigneeId {Number} ID of the resource the Primary IP is assigned to, null if it is not assigned at all
     * @param assigneeType {module:model/PrimaryIP.AssigneeTypeEnum} Resource type the Primary IP can be assigned to
     * @param autoDelete {Boolean} Delete this Primary IP when the resource it is assigned to is deleted
     ...
     * @param datacenter {module:model/PrimaryIPDatacenter} 
     * @param dnsPtr {Array.<module:model/PrimaryIPDnsPtrInner>} Array of reverse DNS entries
     ...
     * @param type {module:model/PrimaryIP.TypeEnum} Type of the Primary IP
     */
    constructor(assigneeId, assigneeType, autoDelete, blocked, created, datacenter, dnsPtr, id, ip, labels, name, protection, type) { 
        
        PrimaryIP.initialize(this, assigneeId, assigneeType, autoDelete, blocked, created, datacenter, dnsPtr, id, ip, labels, name, protection, type);
    }
     ...
     */
    static initialize(obj, assigneeId, assigneeType, autoDelete, blocked, created, datacenter, dnsPtr, id, ip, labels, name, protection, type) { 
        obj['assignee_id'] = assigneeId;
        obj['assignee_type'] = assigneeType;
        obj['auto_delete'] = autoDelete;
        obj['blocked'] = blocked;
        obj['created'] = created;
    ...
    /**
     * Constructs a <code>PrimaryIP</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PrimaryIP} obj Optional instance to populate.
     * @return {module:model/PrimaryIP} The populated <code>PrimaryIP</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PrimaryIP();
            ...
            if (data.hasOwnProperty('datacenter')) {
                obj['datacenter'] = PrimaryIPDatacenter.constructFromObject(data['datacenter']);
            }
            if (data.hasOwnProperty('dns_ptr')) {
                obj['dns_ptr'] = ApiClient.convertToType(data['dns_ptr'], [PrimaryIPDnsPtrInner]);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>PrimaryIP</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PrimaryIP</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of PrimaryIP.RequiredProperties) {
        ...
        if (data['datacenter']) { // data not null
          PrimaryIPDatacenter.validateJSON(data['datacenter']);
        }
        if (data['dns_ptr']) { // data not null
            ...
            for (const item of data['dns_ptr']) {
                PrimaryIPDnsPtrInner.validateJSON(item);
            };
        }
        // ensure the json data is a string
...
PrimaryIP.RequiredProperties = ["assignee_id", "assignee_type", "auto_delete", "blocked", "created", "datacenter", "dns_ptr", "id", "ip", "labels", "name", "protection", "type"];

/**
 * ID of the resource the Primary IP is assigned to, null if it is not assigned at all
 * @member {Number} assignee_id
 */
PrimaryIP.prototype['assignee_id'] = undefined;

/**
 * Resource type the Primary IP can be assigned to
 * @member {module:model/PrimaryIP.AssigneeTypeEnum} assignee_type
 */
PrimaryIP.prototype['assignee_type'] = undefined;

/**
 * Delete this Primary IP when the resource it is assigned to is deleted
 * @member {Boolean} auto_delete
 */
PrimaryIP.prototype['auto_delete'] = undefined;

/**
 * Whether the IP is blocked
 * @member {Boolean} blocked
 */
PrimaryIP.prototype['blocked'] = undefined;

/**
 * Point in time when the Resource was created (in ISO-8601 format)
 * @member {String} created
 */
PrimaryIP.prototype['created'] = undefined;

/**
 * @member {module:model/PrimaryIPDatacenter} datacenter
 */
PrimaryIP.prototype['datacenter'] = undefined;

/**
 * Array of reverse DNS entries
 * @member {Array.<module:model/PrimaryIPDnsPtrInner>} dns_ptr
 */
PrimaryIP.prototype['dns_ptr'] = undefined;

/**
 * ID of the Resource
 * @member {Number} id
 */
PrimaryIP.prototype['id'] = undefined;

/**
 * IP address
 * @member {String} ip
 */
PrimaryIP.prototype['ip'] = undefined;

/**
 * User-defined labels (key-value pairs)
 * @member {Object.<String, String>} labels
 */
PrimaryIP.prototype['labels'] = undefined;

/**
 * Name of the Resource. Must be unique per Project.
 * @member {String} name
 */
PrimaryIP.prototype['name'] = undefined;

/**
 * @member {module:model/FloatingIpsGet200ResponseFloatingIpsInnerProtection} protection
 */
PrimaryIP.prototype['protection'] = undefined;

/**
 * Type of the Primary IP
 * @member {module:model/PrimaryIP.TypeEnum} type
 */
PrimaryIP.prototype['type'] = undefined;
