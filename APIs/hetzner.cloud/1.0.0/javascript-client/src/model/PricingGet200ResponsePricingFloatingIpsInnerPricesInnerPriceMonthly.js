...
/**
 * The PricingGet200ResponsePricingFloatingIpsInnerPricesInnerPriceMonthly model module.
 * @module model/PricingGet200ResponsePricingFloatingIpsInnerPricesInnerPriceMonthly
 * @version 1.0.0
 */
class PricingGet200ResponsePricingFloatingIpsInnerPricesInnerPriceMonthly {
    /**
     * Constructs a new <code>PricingGet200ResponsePricingFloatingIpsInnerPricesInnerPriceMonthly</code>.
     * Monthly costs for a Floating IP type in this Location
     * @alias module:model/PricingGet200ResponsePricingFloatingIpsInnerPricesInnerPriceMonthly
     * @param gross {String} Price with VAT added
     * @param net {String} Price without VAT
     */
    constructor(gross, net) { 
        
        PricingGet200ResponsePricingFloatingIpsInnerPricesInnerPriceMonthly.initialize(this, gross, net);
    }
    ...
    /**
     * Constructs a <code>PricingGet200ResponsePricingFloatingIpsInnerPricesInnerPriceMonthly</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PricingGet200ResponsePricingFloatingIpsInnerPricesInnerPriceMonthly} obj Optional instance to populate.
     * @return {module:model/PricingGet200ResponsePricingFloatingIpsInnerPricesInnerPriceMonthly} The populated <code>PricingGet200ResponsePricingFloatingIpsInnerPricesInnerPriceMonthly</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PricingGet200ResponsePricingFloatingIpsInnerPricesInnerPriceMonthly();
    ...
    /**
     * Validates the JSON data with respect to <code>PricingGet200ResponsePricingFloatingIpsInnerPricesInnerPriceMonthly</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PricingGet200ResponsePricingFloatingIpsInnerPricesInnerPriceMonthly</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of PricingGet200ResponsePricingFloatingIpsInnerPricesInnerPriceMonthly.RequiredProperties) {
...
PricingGet200ResponsePricingFloatingIpsInnerPricesInnerPriceMonthly.RequiredProperties = ["gross", "net"];

/**
 * Price with VAT added
 * @member {String} gross
 */
PricingGet200ResponsePricingFloatingIpsInnerPricesInnerPriceMonthly.prototype['gross'] = undefined;

/**
 * Price without VAT
 * @member {String} net
 */
PricingGet200ResponsePricingFloatingIpsInnerPricesInnerPriceMonthly.prototype['net'] = undefined;
...
export default PricingGet200ResponsePricingFloatingIpsInnerPricesInnerPriceMonthly;
