...
/**
 * The CreatePrimaryIPRequest model module.
 * @module model/CreatePrimaryIPRequest
 * @version 1.0.0
 */
class CreatePrimaryIPRequest {
    /**
     * Constructs a new <code>CreatePrimaryIPRequest</code>.
     * @alias module:model/CreatePrimaryIPRequest
     * @param assigneeType {module:model/CreatePrimaryIPRequest.AssigneeTypeEnum} Resource type the Primary IP can be assigned to
     * @param name {String} 
     * @param type {module:model/CreatePrimaryIPRequest.TypeEnum} Primary IP type
     */
    constructor(assigneeType, name, type) { 
        
        CreatePrimaryIPRequest.initialize(this, assigneeType, name, type);
    }
     ...
     */
    static initialize(obj, assigneeType, name, type) { 
        obj['assignee_type'] = assigneeType;
        obj['name'] = name;
        obj['type'] = type;
    }

    /**
     * Constructs a <code>CreatePrimaryIPRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreatePrimaryIPRequest} obj Optional instance to populate.
     * @return {module:model/CreatePrimaryIPRequest} The populated <code>CreatePrimaryIPRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreatePrimaryIPRequest();

            if (data.hasOwnProperty('assignee_id')) {
                obj['assignee_id'] = ApiClient.convertToType(data['assignee_id'], 'Number');
            }
            if (data.hasOwnProperty('assignee_type')) {
                obj['assignee_type'] = ApiClient.convertToType(data['assignee_type'], 'String');
            }
    ...
    /**
     * Validates the JSON data with respect to <code>CreatePrimaryIPRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreatePrimaryIPRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CreatePrimaryIPRequest.RequiredProperties) {
            if (!data.hasOwnProperty(property)) {
                throw new Error("The required field `" + property + "` is not found in the JSON data: " + JSON.stringify(data));
            }
        }
        // ensure the json data is a string
        if (data['assignee_type'] && !(typeof data['assignee_type'] === 'string' || data['assignee_type'] instanceof String)) {
            throw new Error("Expected the field `assignee_type` to be a primitive type in the JSON string but got " + data['assignee_type']);
        }
        // ensure the json data is a string
...
CreatePrimaryIPRequest.RequiredProperties = ["assignee_type", "name", "type"];

/**
 * ID of the resource the Primary IP should be assigned to. Omitted if it should not be assigned.
 * @member {Number} assignee_id
 */
CreatePrimaryIPRequest.prototype['assignee_id'] = undefined;

/**
 * Resource type the Primary IP can be assigned to
 * @member {module:model/CreatePrimaryIPRequest.AssigneeTypeEnum} assignee_type
 */
CreatePrimaryIPRequest.prototype['assignee_type'] = undefined;
 ...
 */
CreatePrimaryIPRequest.prototype['auto_delete'] = undefined;
 ...
 */
CreatePrimaryIPRequest.prototype['datacenter'] = undefined;

/**
 * User-defined labels (key-value pairs)
 * @member {Object} labels
 */
CreatePrimaryIPRequest.prototype['labels'] = undefined;

/**
 * @member {String} name
 */
CreatePrimaryIPRequest.prototype['name'] = undefined;

/**
 * Primary IP type
 * @member {module:model/CreatePrimaryIPRequest.TypeEnum} type
 */
CreatePrimaryIPRequest.prototype['type'] = undefined;
...
/**
 * Allowed values for the <code>assignee_type</code> property.
 * @enum {String}
 * @readonly
 */
CreatePrimaryIPRequest['AssigneeTypeEnum'] = {
 ...
 * @readonly
 */
CreatePrimaryIPRequest['TypeEnum'] = {
...
export default CreatePrimaryIPRequest;
