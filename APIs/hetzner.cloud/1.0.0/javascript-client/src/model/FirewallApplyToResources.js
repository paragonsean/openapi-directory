...
/**
 * The FirewallApplyToResources model module.
 * @module model/FirewallApplyToResources
 * @version 1.0.0
 */
class FirewallApplyToResources {
    /**
     * Constructs a new <code>FirewallApplyToResources</code>.
     * @alias module:model/FirewallApplyToResources
     */
    constructor() { 
        
        FirewallApplyToResources.initialize(this);
    }
    ...
    /**
     * Constructs a <code>FirewallApplyToResources</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/FirewallApplyToResources} obj Optional instance to populate.
     * @return {module:model/FirewallApplyToResources} The populated <code>FirewallApplyToResources</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new FirewallApplyToResources();
    ...
    /**
     * Validates the JSON data with respect to <code>FirewallApplyToResources</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>FirewallApplyToResources</code>.
     */
 ...
 */
FirewallApplyToResources.prototype['label_selector'] = undefined;

/**
 * @member {module:model/FirewallApplyToResourcesServer} server
 */
FirewallApplyToResources.prototype['server'] = undefined;

/**
 * Type of the resource
 * @member {module:model/FirewallApplyToResources.TypeEnum} type
 */
FirewallApplyToResources.prototype['type'] = undefined;
 ...
 * @readonly
 */
FirewallApplyToResources['TypeEnum'] = {
...
export default FirewallApplyToResources;
