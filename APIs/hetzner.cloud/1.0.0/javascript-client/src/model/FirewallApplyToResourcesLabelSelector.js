...
/**
 * The FirewallApplyToResourcesLabelSelector model module.
 * @module model/FirewallApplyToResourcesLabelSelector
 * @version 1.0.0
 */
class FirewallApplyToResourcesLabelSelector {
    /**
     * Constructs a new <code>FirewallApplyToResourcesLabelSelector</code>.
     * Configuration for type label_selector, required if type is &#x60;label_selector&#x60;
     * @alias module:model/FirewallApplyToResourcesLabelSelector
     * @param selector {String} Label selector
     */
    constructor(selector) { 
        
        FirewallApplyToResourcesLabelSelector.initialize(this, selector);
    }
    ...
    /**
     * Constructs a <code>FirewallApplyToResourcesLabelSelector</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/FirewallApplyToResourcesLabelSelector} obj Optional instance to populate.
     * @return {module:model/FirewallApplyToResourcesLabelSelector} The populated <code>FirewallApplyToResourcesLabelSelector</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new FirewallApplyToResourcesLabelSelector();
    ...
    /**
     * Validates the JSON data with respect to <code>FirewallApplyToResourcesLabelSelector</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>FirewallApplyToResourcesLabelSelector</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of FirewallApplyToResourcesLabelSelector.RequiredProperties) {
...
FirewallApplyToResourcesLabelSelector.RequiredProperties = ["selector"];

/**
 * Label selector
 * @member {String} selector
 */
FirewallApplyToResourcesLabelSelector.prototype['selector'] = undefined;
...
export default FirewallApplyToResourcesLabelSelector;
