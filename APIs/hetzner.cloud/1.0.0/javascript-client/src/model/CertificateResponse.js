...
class CertificateResponse {
     ...
     * @param certificate {module:model/Certificate} 
     */
    constructor(certificate) { 
        
        CertificateResponse.initialize(this, certificate);
    }
    ...
    static validateJSON(data) {
        ...
        if (data['certificate']) { // data not null
          Certificate.validateJSON(data['certificate']);
        }
...
CertificateResponse.RequiredProperties = ["certificate"];

/**
 * @member {module:model/Certificate} certificate
 */
CertificateResponse.prototype['certificate'] = undefined;
