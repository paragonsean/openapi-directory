...
/**
 * The PrimaryIPDnsPtrInner model module.
 * @module model/PrimaryIPDnsPtrInner
 * @version 1.0.0
 */
class PrimaryIPDnsPtrInner {
    /**
     * Constructs a new <code>PrimaryIPDnsPtrInner</code>.
     * @alias module:model/PrimaryIPDnsPtrInner
    ...
    constructor(dnsPtr, ip) { 
        ...
        PrimaryIPDnsPtrInner.initialize(this, dnsPtr, ip);
    }
    ...
    /**
     * Constructs a <code>PrimaryIPDnsPtrInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PrimaryIPDnsPtrInner} obj Optional instance to populate.
     * @return {module:model/PrimaryIPDnsPtrInner} The populated <code>PrimaryIPDnsPtrInner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PrimaryIPDnsPtrInner();
    ...
    /**
     * Validates the JSON data with respect to <code>PrimaryIPDnsPtrInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PrimaryIPDnsPtrInner</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of PrimaryIPDnsPtrInner.RequiredProperties) {
...
PrimaryIPDnsPtrInner.RequiredProperties = ["dns_ptr", "ip"];

/**
 * DNS pointer for the specific IP address
 * @member {String} dns_ptr
 */
PrimaryIPDnsPtrInner.prototype['dns_ptr'] = undefined;

/**
 * Single IPv4 or IPv6 address
 * @member {String} ip
 */
PrimaryIPDnsPtrInner.prototype['ip'] = undefined;
...
export default PrimaryIPDnsPtrInner;
