...
import VolumesGet200ResponseVolumesInner from './VolumesGet200ResponseVolumesInner';

/**
 * The VolumesPost201Response model module.
 * @module model/VolumesPost201Response
 * @version 1.0.0
 */
class VolumesPost201Response {
    /**
     * Constructs a new <code>VolumesPost201Response</code>.
     * @alias module:model/VolumesPost201Response
     * @param action {module:model/Action} 
     * @param nextActions {Array.<module:model/Action>} 
     * @param volume {module:model/VolumesGet200ResponseVolumesInner} 
     */
    constructor(action, nextActions, volume) { 
        
        VolumesPost201Response.initialize(this, action, nextActions, volume);
    }
     ...
     */
    static initialize(obj, action, nextActions, volume) { 
        obj['action'] = action;
        obj['next_actions'] = nextActions;
        obj['volume'] = volume;
    }

    /**
     * Constructs a <code>VolumesPost201Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/VolumesPost201Response} obj Optional instance to populate.
     * @return {module:model/VolumesPost201Response} The populated <code>VolumesPost201Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new VolumesPost201Response();

            if (data.hasOwnProperty('action')) {
                obj['action'] = Action.constructFromObject(data['action']);
            }
            if (data.hasOwnProperty('next_actions')) {
                obj['next_actions'] = ApiClient.convertToType(data['next_actions'], [Action]);
            }
            if (data.hasOwnProperty('volume')) {
                obj['volume'] = VolumesGet200ResponseVolumesInner.constructFromObject(data['volume']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>VolumesPost201Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>VolumesPost201Response</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of VolumesPost201Response.RequiredProperties) {
        ...
        if (data['next_actions']) { // data not null
            // ensure the json data is an array
            if (!Array.isArray(data['next_actions'])) {
                throw new Error("Expected the field `next_actions` to be an array in the JSON data but got " + data['next_actions']);
            }
        ...
        if (data['volume']) { // data not null
          VolumesGet200ResponseVolumesInner.validateJSON(data['volume']);
        }
...
VolumesPost201Response.RequiredProperties = ["action", "next_actions", "volume"];

/**
 * @member {module:model/Action} action
 */
VolumesPost201Response.prototype['action'] = undefined;

/**
 * @member {Array.<module:model/Action>} next_actions
 */
VolumesPost201Response.prototype['next_actions'] = undefined;

/**
 * @member {module:model/VolumesGet200ResponseVolumesInner} volume
 */
VolumesPost201Response.prototype['volume'] = undefined;
...
export default VolumesPost201Response;
