...
/**
 * The LoadBalancerTypesGet200ResponseLoadBalancerTypesInnerPricesInnerPriceMonthly model module.
 * @module model/LoadBalancerTypesGet200ResponseLoadBalancerTypesInnerPricesInnerPriceMonthly
 * @version 1.0.0
 */
class LoadBalancerTypesGet200ResponseLoadBalancerTypesInnerPricesInnerPriceMonthly {
    /**
     * Constructs a new <code>LoadBalancerTypesGet200ResponseLoadBalancerTypesInnerPricesInnerPriceMonthly</code>.
     * Monthly costs for a Resource in this Location
     * @alias module:model/LoadBalancerTypesGet200ResponseLoadBalancerTypesInnerPricesInnerPriceMonthly
     * @param gross {String} Price with VAT added
     * @param net {String} Price without VAT
     */
    constructor(gross, net) { 
        
        LoadBalancerTypesGet200ResponseLoadBalancerTypesInnerPricesInnerPriceMonthly.initialize(this, gross, net);
    }
     ...
     */
    static initialize(obj, gross, net) { 
        obj['gross'] = gross;
        obj['net'] = net;
    }

    /**
     * Constructs a <code>LoadBalancerTypesGet200ResponseLoadBalancerTypesInnerPricesInnerPriceMonthly</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/LoadBalancerTypesGet200ResponseLoadBalancerTypesInnerPricesInnerPriceMonthly} obj Optional instance to populate.
     * @return {module:model/LoadBalancerTypesGet200ResponseLoadBalancerTypesInnerPricesInnerPriceMonthly} The populated <code>LoadBalancerTypesGet200ResponseLoadBalancerTypesInnerPricesInnerPriceMonthly</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new LoadBalancerTypesGet200ResponseLoadBalancerTypesInnerPricesInnerPriceMonthly();
    ...
    /**
     * Validates the JSON data with respect to <code>LoadBalancerTypesGet200ResponseLoadBalancerTypesInnerPricesInnerPriceMonthly</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>LoadBalancerTypesGet200ResponseLoadBalancerTypesInnerPricesInnerPriceMonthly</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of LoadBalancerTypesGet200ResponseLoadBalancerTypesInnerPricesInnerPriceMonthly.RequiredProperties) {
...
LoadBalancerTypesGet200ResponseLoadBalancerTypesInnerPricesInnerPriceMonthly.RequiredProperties = ["gross", "net"];

/**
 * Price with VAT added
 * @member {String} gross
 */
LoadBalancerTypesGet200ResponseLoadBalancerTypesInnerPricesInnerPriceMonthly.prototype['gross'] = undefined;

/**
 * Price without VAT
 * @member {String} net
 */
LoadBalancerTypesGet200ResponseLoadBalancerTypesInnerPricesInnerPriceMonthly.prototype['net'] = undefined;
...
export default LoadBalancerTypesGet200ResponseLoadBalancerTypesInnerPricesInnerPriceMonthly;
