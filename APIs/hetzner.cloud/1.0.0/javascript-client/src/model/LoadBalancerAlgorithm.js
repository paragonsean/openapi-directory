...
/**
 * The LoadBalancerAlgorithm model module.
 * @module model/LoadBalancerAlgorithm
 * @version 1.0.0
 */
class LoadBalancerAlgorithm {
    /**
     * Constructs a new <code>LoadBalancerAlgorithm</code>.
     * Algorithm of the Load Balancer
     * @alias module:model/LoadBalancerAlgorithm
     * @param type {module:model/LoadBalancerAlgorithm.TypeEnum} Type of the algorithm
     */
    constructor(type) { 
        
        LoadBalancerAlgorithm.initialize(this, type);
    }
    ...
    /**
     * Constructs a <code>LoadBalancerAlgorithm</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/LoadBalancerAlgorithm} obj Optional instance to populate.
     * @return {module:model/LoadBalancerAlgorithm} The populated <code>LoadBalancerAlgorithm</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new LoadBalancerAlgorithm();
    ...
    /**
     * Validates the JSON data with respect to <code>LoadBalancerAlgorithm</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>LoadBalancerAlgorithm</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of LoadBalancerAlgorithm.RequiredProperties) {
...
LoadBalancerAlgorithm.RequiredProperties = ["type"];

/**
 * Type of the algorithm
 * @member {module:model/LoadBalancerAlgorithm.TypeEnum} type
 */
LoadBalancerAlgorithm.prototype['type'] = undefined;
 ...
 * @readonly
 */
LoadBalancerAlgorithm['TypeEnum'] = {
...
export default LoadBalancerAlgorithm;
