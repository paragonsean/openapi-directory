...
import FirewallApplyToResourcesLabelSelector from './FirewallApplyToResourcesLabelSelector';
import FirewallApplyToResourcesServer from './FirewallApplyToResourcesServer';

/**
 * The FirewallRemoveFromResources model module.
 * @module model/FirewallRemoveFromResources
 * @version 1.0.0
 */
class FirewallRemoveFromResources {
    /**
     * Constructs a new <code>FirewallRemoveFromResources</code>.
     * @alias module:model/FirewallRemoveFromResources
     */
    constructor() { 
        
        FirewallRemoveFromResources.initialize(this);
    }
    ...
    /**
     * Constructs a <code>FirewallRemoveFromResources</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/FirewallRemoveFromResources} obj Optional instance to populate.
     * @return {module:model/FirewallRemoveFromResources} The populated <code>FirewallRemoveFromResources</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new FirewallRemoveFromResources();

            if (data.hasOwnProperty('label_selector')) {
                obj['label_selector'] = FirewallApplyToResourcesLabelSelector.constructFromObject(data['label_selector']);
            }
            if (data.hasOwnProperty('server')) {
                obj['server'] = FirewallApplyToResourcesServer.constructFromObject(data['server']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>FirewallRemoveFromResources</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>FirewallRemoveFromResources</code>.
     */
    static validateJSON(data) {
        // validate the optional field `label_selector`
        if (data['label_selector']) { // data not null
          FirewallApplyToResourcesLabelSelector.validateJSON(data['label_selector']);
        }
        // validate the optional field `server`
        if (data['server']) { // data not null
          FirewallApplyToResourcesServer.validateJSON(data['server']);
        }
...
/**
 * @member {module:model/FirewallApplyToResourcesLabelSelector} label_selector
 */
FirewallRemoveFromResources.prototype['label_selector'] = undefined;

/**
 * @member {module:model/FirewallApplyToResourcesServer} server
 */
FirewallRemoveFromResources.prototype['server'] = undefined;

/**
 * Type of the resource
 * @member {module:model/FirewallRemoveFromResources.TypeEnum} type
 */
FirewallRemoveFromResources.prototype['type'] = undefined;
 ...
 * @readonly
 */
FirewallRemoveFromResources['TypeEnum'] = {
...
export default FirewallRemoveFromResources;
