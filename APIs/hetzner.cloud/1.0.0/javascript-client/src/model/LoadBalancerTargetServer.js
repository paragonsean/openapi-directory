...
/**
 * The LoadBalancerTargetServer model module.
 * @module model/LoadBalancerTargetServer
 * @version 1.0.0
 */
class LoadBalancerTargetServer {
    /**
     * Constructs a new <code>LoadBalancerTargetServer</code>.
     * Server where the traffic should be routed to. Only present for target type \&quot;server\&quot;.
     * @alias module:model/LoadBalancerTargetServer
     * @param id {Number} ID of the Server
     */
    constructor(id) { 
        
        LoadBalancerTargetServer.initialize(this, id);
    }
    ...
    /**
     * Constructs a <code>LoadBalancerTargetServer</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/LoadBalancerTargetServer} obj Optional instance to populate.
     * @return {module:model/LoadBalancerTargetServer} The populated <code>LoadBalancerTargetServer</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new LoadBalancerTargetServer();
    ...
    /**
     * Validates the JSON data with respect to <code>LoadBalancerTargetServer</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>LoadBalancerTargetServer</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of LoadBalancerTargetServer.RequiredProperties) {
...
LoadBalancerTargetServer.RequiredProperties = ["id"];

/**
 * ID of the Server
 * @member {Number} id
 */
LoadBalancerTargetServer.prototype['id'] = undefined;
...
export default LoadBalancerTargetServer;
