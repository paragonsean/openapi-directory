...
import SshKeysGet200ResponseSshKeysInner from './SshKeysGet200ResponseSshKeysInner';

/**
 * The SshKeysGet200Response model module.
 * @module model/SshKeysGet200Response
 * @version 1.0.0
 */
class SshKeysGet200Response {
    /**
     * Constructs a new <code>SshKeysGet200Response</code>.
     * @alias module:model/SshKeysGet200Response
     * @param sshKeys {Array.<module:model/SshKeysGet200ResponseSshKeysInner>} 
     */
    constructor(sshKeys) { 
        
        SshKeysGet200Response.initialize(this, sshKeys);
    }
    ...
    /**
     * Constructs a <code>SshKeysGet200Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SshKeysGet200Response} obj Optional instance to populate.
     * @return {module:model/SshKeysGet200Response} The populated <code>SshKeysGet200Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SshKeysGet200Response();

            if (data.hasOwnProperty('meta')) {
                obj['meta'] = ActionsResponseMeta.constructFromObject(data['meta']);
            }
            if (data.hasOwnProperty('ssh_keys')) {
                obj['ssh_keys'] = ApiClient.convertToType(data['ssh_keys'], [SshKeysGet200ResponseSshKeysInner]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>SshKeysGet200Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SshKeysGet200Response</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of SshKeysGet200Response.RequiredProperties) {
        ...
        if (data['ssh_keys']) { // data not null
            ...
            for (const item of data['ssh_keys']) {
                SshKeysGet200ResponseSshKeysInner.validateJSON(item);
            };
        }
...
SshKeysGet200Response.RequiredProperties = ["ssh_keys"];

/**
 * @member {module:model/ActionsResponseMeta} meta
 */
SshKeysGet200Response.prototype['meta'] = undefined;

/**
 * @member {Array.<module:model/SshKeysGet200ResponseSshKeysInner>} ssh_keys
 */
SshKeysGet200Response.prototype['ssh_keys'] = undefined;
...
export default SshKeysGet200Response;
