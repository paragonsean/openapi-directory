...
class ActionError {
     ...
     * @param code {String} Fixed machine readable code
     * @param message {String} Humanized error message
     */
    constructor(code, message) { 
        
        ActionError.initialize(this, code, message);
    }
    ...
    static validateJSON(data) {
        ...
        for (const property of ActionError.RequiredProperties) {
...
ActionError.RequiredProperties = ["code", "message"];

/**
 * Fixed machine readable code
 * @member {String} code
 */
ActionError.prototype['code'] = undefined;
