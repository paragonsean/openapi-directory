...
import NullableAction from './NullableAction';

/**
 * The CreateCertificateResponse model module.
 * @module model/CreateCertificateResponse
 * @version 1.0.0
 */
class CreateCertificateResponse {
    /**
     * Constructs a new <code>CreateCertificateResponse</code>.
     * @alias module:model/CreateCertificateResponse
     * @param certificate {module:model/Certificate} 
     */
    constructor(certificate) { 
        
        CreateCertificateResponse.initialize(this, certificate);
    }
    ...
    /**
     * Constructs a <code>CreateCertificateResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateCertificateResponse} obj Optional instance to populate.
     * @return {module:model/CreateCertificateResponse} The populated <code>CreateCertificateResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateCertificateResponse();

            if (data.hasOwnProperty('action')) {
                obj['action'] = NullableAction.constructFromObject(data['action']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>CreateCertificateResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateCertificateResponse</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CreateCertificateResponse.RequiredProperties) {
        ...
        if (data['action']) { // data not null
          NullableAction.validateJSON(data['action']);
        }
...
CreateCertificateResponse.RequiredProperties = ["certificate"];

/**
 * @member {module:model/NullableAction} action
 */
CreateCertificateResponse.prototype['action'] = undefined;

/**
 * @member {module:model/Certificate} certificate
 */
CreateCertificateResponse.prototype['certificate'] = undefined;
...
export default CreateCertificateResponse;
