...
/**
 * The IsosGet200ResponseIsosInner model module.
 * @module model/IsosGet200ResponseIsosInner
 * @version 1.0.0
 */
class IsosGet200ResponseIsosInner {
    /**
     * Constructs a new <code>IsosGet200ResponseIsosInner</code>.
     * @alias module:model/IsosGet200ResponseIsosInner
     * @param architecture {module:model/IsosGet200ResponseIsosInner.ArchitectureEnum} Type of cpu architecture this iso is compatible with. Null indicates no restriction on the architecture (wildcard).
     * @param deprecated {String} ISO 8601 timestamp of deprecation, null if ISO is still available. After the deprecation time it will no longer be possible to attach the ISO to Servers.
     * @param description {String} Description of the ISO
     * @param id {Number} ID of the Resource
     * @param name {String} Unique identifier of the ISO. Only set for public ISOs
     * @param type {module:model/IsosGet200ResponseIsosInner.TypeEnum} Type of the ISO
     */
    constructor(architecture, deprecated, description, id, name, type) { 
        
        IsosGet200ResponseIsosInner.initialize(this, architecture, deprecated, description, id, name, type);
    }
     ...
     */
    static initialize(obj, architecture, deprecated, description, id, name, type) { 
    ...
    /**
     * Constructs a <code>IsosGet200ResponseIsosInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/IsosGet200ResponseIsosInner} obj Optional instance to populate.
     * @return {module:model/IsosGet200ResponseIsosInner} The populated <code>IsosGet200ResponseIsosInner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new IsosGet200ResponseIsosInner();
    ...
    /**
     * Validates the JSON data with respect to <code>IsosGet200ResponseIsosInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>IsosGet200ResponseIsosInner</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of IsosGet200ResponseIsosInner.RequiredProperties) {
...
IsosGet200ResponseIsosInner.RequiredProperties = ["architecture", "deprecated", "description", "id", "name", "type"];

/**
 * Type of cpu architecture this iso is compatible with. Null indicates no restriction on the architecture (wildcard).
 * @member {module:model/IsosGet200ResponseIsosInner.ArchitectureEnum} architecture
 */
IsosGet200ResponseIsosInner.prototype['architecture'] = undefined;
 ...
 */
IsosGet200ResponseIsosInner.prototype['deprecated'] = undefined;

/**
 * Description of the ISO
 * @member {String} description
 */
IsosGet200ResponseIsosInner.prototype['description'] = undefined;

/**
 * ID of the Resource
 * @member {Number} id
 */
IsosGet200ResponseIsosInner.prototype['id'] = undefined;

/**
 * Unique identifier of the ISO. Only set for public ISOs
 * @member {String} name
 */
IsosGet200ResponseIsosInner.prototype['name'] = undefined;

/**
 * Type of the ISO
 * @member {module:model/IsosGet200ResponseIsosInner.TypeEnum} type
 */
IsosGet200ResponseIsosInner.prototype['type'] = undefined;
 ...
 * @readonly
 */
IsosGet200ResponseIsosInner['ArchitectureEnum'] = {
...
export default IsosGet200ResponseIsosInner;
