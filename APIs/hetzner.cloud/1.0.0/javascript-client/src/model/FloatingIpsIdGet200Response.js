...
/**
 * The FloatingIpsIdGet200Response model module.
 * @module model/FloatingIpsIdGet200Response
 * @version 1.0.0
 */
class FloatingIpsIdGet200Response {
    /**
     * Constructs a new <code>FloatingIpsIdGet200Response</code>.
     * @alias module:model/FloatingIpsIdGet200Response
     * @param floatingIp {module:model/FloatingIpsGet200ResponseFloatingIpsInner} 
     */
    constructor(floatingIp) { 
        
        FloatingIpsIdGet200Response.initialize(this, floatingIp);
    }
    ...
    /**
     * Constructs a <code>FloatingIpsIdGet200Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/FloatingIpsIdGet200Response} obj Optional instance to populate.
     * @return {module:model/FloatingIpsIdGet200Response} The populated <code>FloatingIpsIdGet200Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new FloatingIpsIdGet200Response();
    ...
    /**
     * Validates the JSON data with respect to <code>FloatingIpsIdGet200Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>FloatingIpsIdGet200Response</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of FloatingIpsIdGet200Response.RequiredProperties) {
...
FloatingIpsIdGet200Response.RequiredProperties = ["floating_ip"];

/**
 * @member {module:model/FloatingIpsGet200ResponseFloatingIpsInner} floating_ip
 */
FloatingIpsIdGet200Response.prototype['floating_ip'] = undefined;
...
export default FloatingIpsIdGet200Response;
