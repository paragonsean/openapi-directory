...
import CreateFirewallRequestApplyToInnerLabelSelector from './CreateFirewallRequestApplyToInnerLabelSelector';
import CreateFirewallRequestApplyToInnerServer from './CreateFirewallRequestApplyToInnerServer';

/**
 * The CreateFirewallRequestApplyToInner model module.
 * @module model/CreateFirewallRequestApplyToInner
 * @version 1.0.0
 */
class CreateFirewallRequestApplyToInner {
    /**
     * Constructs a new <code>CreateFirewallRequestApplyToInner</code>.
     * @alias module:model/CreateFirewallRequestApplyToInner
     * @param type {module:model/CreateFirewallRequestApplyToInner.TypeEnum} Type of the resource
     */
    constructor(type) { 
        
        CreateFirewallRequestApplyToInner.initialize(this, type);
    }
    ...
    /**
     * Constructs a <code>CreateFirewallRequestApplyToInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateFirewallRequestApplyToInner} obj Optional instance to populate.
     * @return {module:model/CreateFirewallRequestApplyToInner} The populated <code>CreateFirewallRequestApplyToInner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateFirewallRequestApplyToInner();

            if (data.hasOwnProperty('label_selector')) {
                obj['label_selector'] = CreateFirewallRequestApplyToInnerLabelSelector.constructFromObject(data['label_selector']);
            }
            if (data.hasOwnProperty('server')) {
                obj['server'] = CreateFirewallRequestApplyToInnerServer.constructFromObject(data['server']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>CreateFirewallRequestApplyToInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateFirewallRequestApplyToInner</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CreateFirewallRequestApplyToInner.RequiredProperties) {
        ...
        if (data['label_selector']) { // data not null
          CreateFirewallRequestApplyToInnerLabelSelector.validateJSON(data['label_selector']);
        }
        // validate the optional field `server`
        if (data['server']) { // data not null
          CreateFirewallRequestApplyToInnerServer.validateJSON(data['server']);
        }
...
CreateFirewallRequestApplyToInner.RequiredProperties = ["type"];

/**
 * @member {module:model/CreateFirewallRequestApplyToInnerLabelSelector} label_selector
 */
CreateFirewallRequestApplyToInner.prototype['label_selector'] = undefined;

/**
 * @member {module:model/CreateFirewallRequestApplyToInnerServer} server
 */
CreateFirewallRequestApplyToInner.prototype['server'] = undefined;

/**
 * Type of the resource
 * @member {module:model/CreateFirewallRequestApplyToInner.TypeEnum} type
 */
CreateFirewallRequestApplyToInner.prototype['type'] = undefined;
 ...
 * @readonly
 */
CreateFirewallRequestApplyToInner['TypeEnum'] = {
...
export default CreateFirewallRequestApplyToInner;
