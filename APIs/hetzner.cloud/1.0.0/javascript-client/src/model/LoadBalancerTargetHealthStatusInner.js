...
/**
 * The LoadBalancerTargetHealthStatusInner model module.
 * @module model/LoadBalancerTargetHealthStatusInner
 * @version 1.0.0
 */
class LoadBalancerTargetHealthStatusInner {
    /**
     * Constructs a new <code>LoadBalancerTargetHealthStatusInner</code>.
     * @alias module:model/LoadBalancerTargetHealthStatusInner
     */
    constructor() { 
        
        LoadBalancerTargetHealthStatusInner.initialize(this);
    }
    ...
    /**
     * Constructs a <code>LoadBalancerTargetHealthStatusInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/LoadBalancerTargetHealthStatusInner} obj Optional instance to populate.
     * @return {module:model/LoadBalancerTargetHealthStatusInner} The populated <code>LoadBalancerTargetHealthStatusInner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new LoadBalancerTargetHealthStatusInner();
    ...
    /**
     * Validates the JSON data with respect to <code>LoadBalancerTargetHealthStatusInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>LoadBalancerTargetHealthStatusInner</code>.
     */
 ...
 */
LoadBalancerTargetHealthStatusInner.prototype['listen_port'] = undefined;

/**
 * @member {module:model/LoadBalancerTargetHealthStatusInner.StatusEnum} status
 */
LoadBalancerTargetHealthStatusInner.prototype['status'] = undefined;
 ...
 * @readonly
 */
LoadBalancerTargetHealthStatusInner['StatusEnum'] = {
...
export default LoadBalancerTargetHealthStatusInner;
