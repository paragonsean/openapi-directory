...
/**
 * The FirewallAppliedToInnerAppliedToResourcesInnerServer model module.
 * @module model/FirewallAppliedToInnerAppliedToResourcesInnerServer
 * @version 1.0.0
 */
class FirewallAppliedToInnerAppliedToResourcesInnerServer {
    /**
     * Constructs a new <code>FirewallAppliedToInnerAppliedToResourcesInnerServer</code>.
     * @alias module:model/FirewallAppliedToInnerAppliedToResourcesInnerServer
     * @param id {Number} ID of the Resource
     */
    constructor(id) { 
        
        FirewallAppliedToInnerAppliedToResourcesInnerServer.initialize(this, id);
    }
    ...
    /**
     * Constructs a <code>FirewallAppliedToInnerAppliedToResourcesInnerServer</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/FirewallAppliedToInnerAppliedToResourcesInnerServer} obj Optional instance to populate.
     * @return {module:model/FirewallAppliedToInnerAppliedToResourcesInnerServer} The populated <code>FirewallAppliedToInnerAppliedToResourcesInnerServer</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new FirewallAppliedToInnerAppliedToResourcesInnerServer();
    ...
    /**
     * Validates the JSON data with respect to <code>FirewallAppliedToInnerAppliedToResourcesInnerServer</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>FirewallAppliedToInnerAppliedToResourcesInnerServer</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of FirewallAppliedToInnerAppliedToResourcesInnerServer.RequiredProperties) {
...
FirewallAppliedToInnerAppliedToResourcesInnerServer.RequiredProperties = ["id"];

/**
 * ID of the Resource
 * @member {Number} id
 */
FirewallAppliedToInnerAppliedToResourcesInnerServer.prototype['id'] = undefined;
...
export default FirewallAppliedToInnerAppliedToResourcesInnerServer;
