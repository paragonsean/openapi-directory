...
/**
 * The UpdateFirewallRequest model module.
 * @module model/UpdateFirewallRequest
 * @version 1.0.0
 */
class UpdateFirewallRequest {
    /**
     * Constructs a new <code>UpdateFirewallRequest</code>.
     * @alias module:model/UpdateFirewallRequest
     */
    constructor() { 
        
        UpdateFirewallRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>UpdateFirewallRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateFirewallRequest} obj Optional instance to populate.
     * @return {module:model/UpdateFirewallRequest} The populated <code>UpdateFirewallRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateFirewallRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateFirewallRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateFirewallRequest</code>.
     */
 ...
 */
UpdateFirewallRequest.prototype['labels'] = undefined;

/**
 * New Firewall name
 * @member {String} name
 */
UpdateFirewallRequest.prototype['name'] = undefined;
...
export default UpdateFirewallRequest;
