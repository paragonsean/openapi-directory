...
import CreateNetworkRequestSubnetsInner from './CreateNetworkRequestSubnetsInner';
...
class CreateNetworkRequest {
     ...
     * @param ipRange {String} IP range of the whole network which must span all included subnets. Must be one of the private IPv4 ranges of RFC1918. Minimum network size is /24. We highly recommend that you pick a larger network with a /16 netmask.
     * @param name {String} Name of the network
     */
    constructor(ipRange, name) { 
        
        CreateNetworkRequest.initialize(this, ipRange, name);
    }
     ...
     */
    static initialize(obj, ipRange, name) { 
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('subnets')) {
                obj['subnets'] = ApiClient.convertToType(data['subnets'], [CreateNetworkRequestSubnetsInner]);
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        if (data['subnets']) { // data not null
            ...
            for (const item of data['subnets']) {
                CreateNetworkRequestSubnetsInner.validateJSON(item);
            };
        }
...
CreateNetworkRequest.RequiredProperties = ["ip_range", "name"];
 ...
 */
CreateNetworkRequest.prototype['ip_range'] = undefined;

/**
 * @member {module:model/CreateLoadBalancerRequestLabels} labels
 */
CreateNetworkRequest.prototype['labels'] = undefined;

/**
 * Name of the network
 * @member {String} name
 */
CreateNetworkRequest.prototype['name'] = undefined;
 ...
 */
CreateNetworkRequest.prototype['routes'] = undefined;

/**
 * Array of subnets allocated.
 * @member {Array.<module:model/CreateNetworkRequestSubnetsInner>} subnets
 */
CreateNetworkRequest.prototype['subnets'] = undefined;
