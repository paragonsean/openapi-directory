...
import FirewallRemoveFromResources from './FirewallRemoveFromResources';

/**
 * The RemoveFromResourcesRequest model module.
 * @module model/RemoveFromResourcesRequest
 * @version 1.0.0
 */
class RemoveFromResourcesRequest {
    /**
     * Constructs a new <code>RemoveFromResourcesRequest</code>.
     * @alias module:model/RemoveFromResourcesRequest
     * @param removeFrom {Array.<module:model/FirewallRemoveFromResources>} Resources the Firewall should be removed from
     */
    constructor(removeFrom) { 
        
        RemoveFromResourcesRequest.initialize(this, removeFrom);
    }
     ...
     */
    static initialize(obj, removeFrom) { 
        obj['remove_from'] = removeFrom;
    }

    /**
     * Constructs a <code>RemoveFromResourcesRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/RemoveFromResourcesRequest} obj Optional instance to populate.
     * @return {module:model/RemoveFromResourcesRequest} The populated <code>RemoveFromResourcesRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RemoveFromResourcesRequest();

            if (data.hasOwnProperty('remove_from')) {
                obj['remove_from'] = ApiClient.convertToType(data['remove_from'], [FirewallRemoveFromResources]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>RemoveFromResourcesRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RemoveFromResourcesRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of RemoveFromResourcesRequest.RequiredProperties) {
            if (!data.hasOwnProperty(property)) {
                throw new Error("The required field `" + property + "` is not found in the JSON data: " + JSON.stringify(data));
            }
        }
        if (data['remove_from']) { // data not null
            // ensure the json data is an array
            if (!Array.isArray(data['remove_from'])) {
                throw new Error("Expected the field `remove_from` to be an array in the JSON data but got " + data['remove_from']);
            }
            // validate the optional field `remove_from` (array)
            for (const item of data['remove_from']) {
                FirewallRemoveFromResources.validateJSON(item);
            };
        }
...
RemoveFromResourcesRequest.RequiredProperties = ["remove_from"];

/**
 * Resources the Firewall should be removed from
 * @member {Array.<module:model/FirewallRemoveFromResources>} remove_from
 */
RemoveFromResourcesRequest.prototype['remove_from'] = undefined;
...
export default RemoveFromResourcesRequest;
