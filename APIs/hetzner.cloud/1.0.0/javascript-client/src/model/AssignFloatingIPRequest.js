...
/**
 * The AssignFloatingIPRequest model module.
 * @module model/AssignFloatingIPRequest
 * @version 1.0.0
 */
class AssignFloatingIPRequest {
    /**
     * Constructs a new <code>AssignFloatingIPRequest</code>.
     * #### Call specific error codes  | Code                          | Description                                                   | |------------------------------ |-------------------------------------------------------------- | | &#x60;floating_ip_assigned&#x60;        | The floating IP is already assigned                           | 
     * @alias module:model/AssignFloatingIPRequest
     * @param server {Number} ID of the Server the Floating IP shall be assigned to
     */
    constructor(server) { 
        
        AssignFloatingIPRequest.initialize(this, server);
    }
    ...
    /**
     * Constructs a <code>AssignFloatingIPRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AssignFloatingIPRequest} obj Optional instance to populate.
     * @return {module:model/AssignFloatingIPRequest} The populated <code>AssignFloatingIPRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AssignFloatingIPRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>AssignFloatingIPRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AssignFloatingIPRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of AssignFloatingIPRequest.RequiredProperties) {
...
AssignFloatingIPRequest.RequiredProperties = ["server"];

/**
 * ID of the Server the Floating IP shall be assigned to
 * @member {Number} server
 */
AssignFloatingIPRequest.prototype['server'] = undefined;
...
export default AssignFloatingIPRequest;
