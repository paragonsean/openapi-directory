...
import LoadBalancerTargetHealthStatusInner from './LoadBalancerTargetHealthStatusInner';
import LoadBalancerTargetIP from './LoadBalancerTargetIP';
import LoadBalancerTargetLabelSelector from './LoadBalancerTargetLabelSelector';
import LoadBalancerTargetServer from './LoadBalancerTargetServer';
import LoadBalancerTargetTarget from './LoadBalancerTargetTarget';

/**
 * The LoadBalancerTarget model module.
 * @module model/LoadBalancerTarget
 * @version 1.0.0
 */
class LoadBalancerTarget {
    /**
     * Constructs a new <code>LoadBalancerTarget</code>.
     * @alias module:model/LoadBalancerTarget
     * @param type {module:model/LoadBalancerTarget.TypeEnum} Type of the resource
     */
    constructor(type) { 
        
        LoadBalancerTarget.initialize(this, type);
    }
    ...
    /**
     * Constructs a <code>LoadBalancerTarget</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/LoadBalancerTarget} obj Optional instance to populate.
     * @return {module:model/LoadBalancerTarget} The populated <code>LoadBalancerTarget</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new LoadBalancerTarget();

            if (data.hasOwnProperty('health_status')) {
                obj['health_status'] = ApiClient.convertToType(data['health_status'], [LoadBalancerTargetHealthStatusInner]);
            }
            if (data.hasOwnProperty('ip')) {
                obj['ip'] = LoadBalancerTargetIP.constructFromObject(data['ip']);
            }
            if (data.hasOwnProperty('label_selector')) {
                obj['label_selector'] = LoadBalancerTargetLabelSelector.constructFromObject(data['label_selector']);
            }
            if (data.hasOwnProperty('server')) {
                obj['server'] = LoadBalancerTargetServer.constructFromObject(data['server']);
            }
            if (data.hasOwnProperty('targets')) {
                obj['targets'] = ApiClient.convertToType(data['targets'], [LoadBalancerTargetTarget]);
            }
            if (data.hasOwnProperty('type')) {
                obj['type'] = ApiClient.convertToType(data['type'], 'String');
            }
            if (data.hasOwnProperty('use_private_ip')) {
                obj['use_private_ip'] = ApiClient.convertToType(data['use_private_ip'], 'Boolean');
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>LoadBalancerTarget</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>LoadBalancerTarget</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of LoadBalancerTarget.RequiredProperties) {
            if (!data.hasOwnProperty(property)) {
                throw new Error("The required field `" + property + "` is not found in the JSON data: " + JSON.stringify(data));
            }
        }
        if (data['health_status']) { // data not null
            // ensure the json data is an array
            if (!Array.isArray(data['health_status'])) {
                throw new Error("Expected the field `health_status` to be an array in the JSON data but got " + data['health_status']);
            }
            // validate the optional field `health_status` (array)
            for (const item of data['health_status']) {
                LoadBalancerTargetHealthStatusInner.validateJSON(item);
            };
        }
        // validate the optional field `ip`
        if (data['ip']) { // data not null
          LoadBalancerTargetIP.validateJSON(data['ip']);
        }
        // validate the optional field `label_selector`
        if (data['label_selector']) { // data not null
          LoadBalancerTargetLabelSelector.validateJSON(data['label_selector']);
        }
        // validate the optional field `server`
        if (data['server']) { // data not null
          LoadBalancerTargetServer.validateJSON(data['server']);
        }
        if (data['targets']) { // data not null
            ...
            for (const item of data['targets']) {
                LoadBalancerTargetTarget.validateJSON(item);
            };
        }
...
LoadBalancerTarget.RequiredProperties = ["type"];

/**
 * List of health statuses of the services on this target. Only present for target types \"server\" and \"ip\".
 * @member {Array.<module:model/LoadBalancerTargetHealthStatusInner>} health_status
 */
LoadBalancerTarget.prototype['health_status'] = undefined;

/**
 * @member {module:model/LoadBalancerTargetIP} ip
 */
LoadBalancerTarget.prototype['ip'] = undefined;

/**
 * @member {module:model/LoadBalancerTargetLabelSelector} label_selector
 */
LoadBalancerTarget.prototype['label_selector'] = undefined;

/**
 * @member {module:model/LoadBalancerTargetServer} server
 */
LoadBalancerTarget.prototype['server'] = undefined;

/**
 * List of resolved label selector target Servers. Only present for type \"label_selector\".
 * @member {Array.<module:model/LoadBalancerTargetTarget>} targets
 */
LoadBalancerTarget.prototype['targets'] = undefined;

/**
 * Type of the resource
 * @member {module:model/LoadBalancerTarget.TypeEnum} type
 */
LoadBalancerTarget.prototype['type'] = undefined;
 ...
 * @member {Boolean} use_private_ip
 */
LoadBalancerTarget.prototype['use_private_ip'] = undefined;
