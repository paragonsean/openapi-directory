...
/**
 * The CreateServerRequestPublicNet model module.
 * @module model/CreateServerRequestPublicNet
 * @version 1.0.0
 */
class CreateServerRequestPublicNet {
    /**
     * Constructs a new <code>CreateServerRequestPublicNet</code>.
     * Public Network options
     * @alias module:model/CreateServerRequestPublicNet
     */
    constructor() { 
        
        CreateServerRequestPublicNet.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CreateServerRequestPublicNet</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateServerRequestPublicNet} obj Optional instance to populate.
     * @return {module:model/CreateServerRequestPublicNet} The populated <code>CreateServerRequestPublicNet</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateServerRequestPublicNet();

            if (data.hasOwnProperty('enable_ipv4')) {
                obj['enable_ipv4'] = ApiClient.convertToType(data['enable_ipv4'], 'Boolean');
            }
            if (data.hasOwnProperty('enable_ipv6')) {
                obj['enable_ipv6'] = ApiClient.convertToType(data['enable_ipv6'], 'Boolean');
            }
            if (data.hasOwnProperty('ipv4')) {
                obj['ipv4'] = ApiClient.convertToType(data['ipv4'], 'Number');
            }
    ...
    /**
     * Validates the JSON data with respect to <code>CreateServerRequestPublicNet</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateServerRequestPublicNet</code>.
     */
 ...
 * @member {Boolean} enable_ipv4
 */
CreateServerRequestPublicNet.prototype['enable_ipv4'] = undefined;

/**
 * Attach an IPv6 on the public NIC. If false, no IPv6 address will be attached. Defaults to true.
 * @member {Boolean} enable_ipv6
 */
CreateServerRequestPublicNet.prototype['enable_ipv6'] = undefined;

/**
 * ID of the ipv4 Primary IP to use. If omitted and enable_ipv4 is true, a new ipv4 Primary IP will automatically be created.
 * @member {Number} ipv4
 */
CreateServerRequestPublicNet.prototype['ipv4'] = undefined;

/**
 * ID of the ipv6 Primary IP to use. If omitted and enable_ipv6 is true, a new ipv6 Primary IP will automatically be created.
 * @member {Number} ipv6
 */
CreateServerRequestPublicNet.prototype['ipv6'] = undefined;
...
export default CreateServerRequestPublicNet;
