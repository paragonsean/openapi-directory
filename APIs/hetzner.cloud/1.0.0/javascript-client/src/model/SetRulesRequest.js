...
/**
 * The SetRulesRequest model module.
 * @module model/SetRulesRequest
 * @version 1.0.0
 */
class SetRulesRequest {
    /**
     * Constructs a new <code>SetRulesRequest</code>.
     * @alias module:model/SetRulesRequest
     * @param rules {Array.<module:model/Rule>} Array of rules
     */
    constructor(rules) { 
        
        SetRulesRequest.initialize(this, rules);
    }
    ...
    /**
     * Constructs a <code>SetRulesRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SetRulesRequest} obj Optional instance to populate.
     * @return {module:model/SetRulesRequest} The populated <code>SetRulesRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SetRulesRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>SetRulesRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SetRulesRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of SetRulesRequest.RequiredProperties) {
...
SetRulesRequest.RequiredProperties = ["rules"];

/**
 * Array of rules
 * @member {Array.<module:model/Rule>} rules
 */
SetRulesRequest.prototype['rules'] = undefined;
...
export default SetRulesRequest;
