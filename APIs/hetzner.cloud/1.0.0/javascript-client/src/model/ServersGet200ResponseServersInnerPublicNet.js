...
import ServerPublicNetFirewall from './ServerPublicNetFirewall';
import ServersGet200ResponseServersInnerPublicNetIpv4 from './ServersGet200ResponseServersInnerPublicNetIpv4';
import ServersGet200ResponseServersInnerPublicNetIpv6 from './ServersGet200ResponseServersInnerPublicNetIpv6';

/**
 * The ServersGet200ResponseServersInnerPublicNet model module.
 * @module model/ServersGet200ResponseServersInnerPublicNet
 * @version 1.0.0
 */
class ServersGet200ResponseServersInnerPublicNet {
    /**
     * Constructs a new <code>ServersGet200ResponseServersInnerPublicNet</code>.
     * Public network information. The Server&#39;s IPv4 address can be found in &#x60;public_net-&gt;ipv4-&gt;ip&#x60;
     * @alias module:model/ServersGet200ResponseServersInnerPublicNet
     * @param floatingIps {Array.<Number>} IDs of Floating IPs assigned to this Server
     * @param ipv4 {module:model/ServersGet200ResponseServersInnerPublicNetIpv4} 
     * @param ipv6 {module:model/ServersGet200ResponseServersInnerPublicNetIpv6} 
     */
    constructor(floatingIps, ipv4, ipv6) { 
        
        ServersGet200ResponseServersInnerPublicNet.initialize(this, floatingIps, ipv4, ipv6);
    }
     ...
     */
    static initialize(obj, floatingIps, ipv4, ipv6) { 
    ...
    /**
     * Constructs a <code>ServersGet200ResponseServersInnerPublicNet</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ServersGet200ResponseServersInnerPublicNet} obj Optional instance to populate.
     * @return {module:model/ServersGet200ResponseServersInnerPublicNet} The populated <code>ServersGet200ResponseServersInnerPublicNet</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ServersGet200ResponseServersInnerPublicNet();

            if (data.hasOwnProperty('firewalls')) {
                obj['firewalls'] = ApiClient.convertToType(data['firewalls'], [ServerPublicNetFirewall]);
            }
            ...
            if (data.hasOwnProperty('ipv4')) {
                obj['ipv4'] = ServersGet200ResponseServersInnerPublicNetIpv4.constructFromObject(data['ipv4']);
            }
            if (data.hasOwnProperty('ipv6')) {
                obj['ipv6'] = ServersGet200ResponseServersInnerPublicNetIpv6.constructFromObject(data['ipv6']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ServersGet200ResponseServersInnerPublicNet</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ServersGet200ResponseServersInnerPublicNet</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ServersGet200ResponseServersInnerPublicNet.RequiredProperties) {
        ...
        if (data['firewalls']) { // data not null
            ...
            for (const item of data['firewalls']) {
                ServerPublicNetFirewall.validateJSON(item);
            };
        }
        // ensure the json data is an array
        ...
        if (data['ipv4']) { // data not null
          ServersGet200ResponseServersInnerPublicNetIpv4.validateJSON(data['ipv4']);
        }
        // validate the optional field `ipv6`
        if (data['ipv6']) { // data not null
          ServersGet200ResponseServersInnerPublicNetIpv6.validateJSON(data['ipv6']);
        }
...
ServersGet200ResponseServersInnerPublicNet.RequiredProperties = ["floating_ips", "ipv4", "ipv6"];

/**
 * Firewalls applied to the public network interface of this Server
 * @member {Array.<module:model/ServerPublicNetFirewall>} firewalls
 */
ServersGet200ResponseServersInnerPublicNet.prototype['firewalls'] = undefined;

/**
 * IDs of Floating IPs assigned to this Server
 * @member {Array.<Number>} floating_ips
 */
ServersGet200ResponseServersInnerPublicNet.prototype['floating_ips'] = undefined;

/**
 * @member {module:model/ServersGet200ResponseServersInnerPublicNetIpv4} ipv4
 */
ServersGet200ResponseServersInnerPublicNet.prototype['ipv4'] = undefined;

/**
 * @member {module:model/ServersGet200ResponseServersInnerPublicNetIpv6} ipv6
 */
ServersGet200ResponseServersInnerPublicNet.prototype['ipv6'] = undefined;
...
export default ServersGet200ResponseServersInnerPublicNet;
