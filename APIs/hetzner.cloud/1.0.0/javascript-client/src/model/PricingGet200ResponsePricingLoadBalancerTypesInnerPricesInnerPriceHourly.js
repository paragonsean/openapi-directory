...
/**
 * The PricingGet200ResponsePricingLoadBalancerTypesInnerPricesInnerPriceHourly model module.
 * @module model/PricingGet200ResponsePricingLoadBalancerTypesInnerPricesInnerPriceHourly
 * @version 1.0.0
 */
class PricingGet200ResponsePricingLoadBalancerTypesInnerPricesInnerPriceHourly {
    /**
     * Constructs a new <code>PricingGet200ResponsePricingLoadBalancerTypesInnerPricesInnerPriceHourly</code>.
     * Hourly costs for a Load Balancer type in this network zone
     * @alias module:model/PricingGet200ResponsePricingLoadBalancerTypesInnerPricesInnerPriceHourly
     * @param gross {String} Price with VAT added
     * @param net {String} Price without VAT
     */
    constructor(gross, net) { 
        
        PricingGet200ResponsePricingLoadBalancerTypesInnerPricesInnerPriceHourly.initialize(this, gross, net);
    }
    ...
    /**
     * Constructs a <code>PricingGet200ResponsePricingLoadBalancerTypesInnerPricesInnerPriceHourly</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PricingGet200ResponsePricingLoadBalancerTypesInnerPricesInnerPriceHourly} obj Optional instance to populate.
     * @return {module:model/PricingGet200ResponsePricingLoadBalancerTypesInnerPricesInnerPriceHourly} The populated <code>PricingGet200ResponsePricingLoadBalancerTypesInnerPricesInnerPriceHourly</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PricingGet200ResponsePricingLoadBalancerTypesInnerPricesInnerPriceHourly();
    ...
    /**
     * Validates the JSON data with respect to <code>PricingGet200ResponsePricingLoadBalancerTypesInnerPricesInnerPriceHourly</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PricingGet200ResponsePricingLoadBalancerTypesInnerPricesInnerPriceHourly</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of PricingGet200ResponsePricingLoadBalancerTypesInnerPricesInnerPriceHourly.RequiredProperties) {
...
PricingGet200ResponsePricingLoadBalancerTypesInnerPricesInnerPriceHourly.RequiredProperties = ["gross", "net"];

/**
 * Price with VAT added
 * @member {String} gross
 */
PricingGet200ResponsePricingLoadBalancerTypesInnerPricesInnerPriceHourly.prototype['gross'] = undefined;

/**
 * Price without VAT
 * @member {String} net
 */
PricingGet200ResponsePricingLoadBalancerTypesInnerPricesInnerPriceHourly.prototype['net'] = undefined;
...
export default PricingGet200ResponsePricingLoadBalancerTypesInnerPricesInnerPriceHourly;
