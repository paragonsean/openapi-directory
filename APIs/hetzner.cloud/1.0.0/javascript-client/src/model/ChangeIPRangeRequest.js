...
/**
 * The ChangeIPRangeRequest model module.
 * @module model/ChangeIPRangeRequest
 * @version 1.0.0
 */
class ChangeIPRangeRequest {
    /**
     * Constructs a new <code>ChangeIPRangeRequest</code>.
     * @alias module:model/ChangeIPRangeRequest
     * @param ipRange {String} The new prefix for the whole Network
     */
    constructor(ipRange) { 
        
        ChangeIPRangeRequest.initialize(this, ipRange);
    }
     ...
     */
    static initialize(obj, ipRange) { 
        obj['ip_range'] = ipRange;
    }

    /**
     * Constructs a <code>ChangeIPRangeRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ChangeIPRangeRequest} obj Optional instance to populate.
     * @return {module:model/ChangeIPRangeRequest} The populated <code>ChangeIPRangeRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ChangeIPRangeRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>ChangeIPRangeRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ChangeIPRangeRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ChangeIPRangeRequest.RequiredProperties) {
...
ChangeIPRangeRequest.RequiredProperties = ["ip_range"];

/**
 * The new prefix for the whole Network
 * @member {String} ip_range
 */
ChangeIPRangeRequest.prototype['ip_range'] = undefined;
...
export default ChangeIPRangeRequest;
