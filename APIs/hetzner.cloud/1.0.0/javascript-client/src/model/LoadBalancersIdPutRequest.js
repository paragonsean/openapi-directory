...
/**
 * The LoadBalancersIdPutRequest model module.
 * @module model/LoadBalancersIdPutRequest
 * @version 1.0.0
 */
class LoadBalancersIdPutRequest {
    /**
     * Constructs a new <code>LoadBalancersIdPutRequest</code>.
     * @alias module:model/LoadBalancersIdPutRequest
     */
    constructor() { 
        
        LoadBalancersIdPutRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>LoadBalancersIdPutRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/LoadBalancersIdPutRequest} obj Optional instance to populate.
     * @return {module:model/LoadBalancersIdPutRequest} The populated <code>LoadBalancersIdPutRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new LoadBalancersIdPutRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>LoadBalancersIdPutRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>LoadBalancersIdPutRequest</code>.
     */
 ...
 */
LoadBalancersIdPutRequest.prototype['labels'] = undefined;

/**
 * New Load Balancer name
 * @member {String} name
 */
LoadBalancersIdPutRequest.prototype['name'] = undefined;
...
export default LoadBalancersIdPutRequest;
