...
/**
 * The PricingGet200ResponsePricingServerBackup model module.
 * @module model/PricingGet200ResponsePricingServerBackup
 * @version 1.0.0
 */
class PricingGet200ResponsePricingServerBackup {
    /**
     * Constructs a new <code>PricingGet200ResponsePricingServerBackup</code>.
     * Will increase base Server costs by specific percentage
     * @alias module:model/PricingGet200ResponsePricingServerBackup
     * @param percentage {String} Percentage by how much the base price will increase
     */
    constructor(percentage) { 
        
        PricingGet200ResponsePricingServerBackup.initialize(this, percentage);
    }
    ...
    /**
     * Constructs a <code>PricingGet200ResponsePricingServerBackup</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PricingGet200ResponsePricingServerBackup} obj Optional instance to populate.
     * @return {module:model/PricingGet200ResponsePricingServerBackup} The populated <code>PricingGet200ResponsePricingServerBackup</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PricingGet200ResponsePricingServerBackup();
    ...
    /**
     * Validates the JSON data with respect to <code>PricingGet200ResponsePricingServerBackup</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PricingGet200ResponsePricingServerBackup</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of PricingGet200ResponsePricingServerBackup.RequiredProperties) {
...
PricingGet200ResponsePricingServerBackup.RequiredProperties = ["percentage"];

/**
 * Percentage by how much the base price will increase
 * @member {String} percentage
 */
PricingGet200ResponsePricingServerBackup.prototype['percentage'] = undefined;
...
export default PricingGet200ResponsePricingServerBackup;
