...
/**
 * The CreateNetworkRequestSubnetsInner model module.
 * @module model/CreateNetworkRequestSubnetsInner
 * @version 1.0.0
 */
class CreateNetworkRequestSubnetsInner {
    /**
     * Constructs a new <code>CreateNetworkRequestSubnetsInner</code>.
     * @alias module:model/CreateNetworkRequestSubnetsInner
     * @param networkZone {String} Name of Network zone. The Location object contains the `network_zone` property each Location belongs to.
     * @param type {module:model/CreateNetworkRequestSubnetsInner.TypeEnum} Type of Subnetwork
     */
    constructor(networkZone, type) { 
        
        CreateNetworkRequestSubnetsInner.initialize(this, networkZone, type);
    }
     ...
     */
    static initialize(obj, networkZone, type) { 
        obj['network_zone'] = networkZone;
        obj['type'] = type;
    }

    /**
     * Constructs a <code>CreateNetworkRequestSubnetsInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateNetworkRequestSubnetsInner} obj Optional instance to populate.
     * @return {module:model/CreateNetworkRequestSubnetsInner} The populated <code>CreateNetworkRequestSubnetsInner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateNetworkRequestSubnetsInner();
            ...
            if (data.hasOwnProperty('vswitch_id')) {
                obj['vswitch_id'] = ApiClient.convertToType(data['vswitch_id'], 'Number');
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>CreateNetworkRequestSubnetsInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateNetworkRequestSubnetsInner</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CreateNetworkRequestSubnetsInner.RequiredProperties) {
...
CreateNetworkRequestSubnetsInner.RequiredProperties = ["network_zone", "type"];
 ...
 */
CreateNetworkRequestSubnetsInner.prototype['ip_range'] = undefined;
 ...
 */
CreateNetworkRequestSubnetsInner.prototype['network_zone'] = undefined;

/**
 * Type of Subnetwork
 * @member {module:model/CreateNetworkRequestSubnetsInner.TypeEnum} type
 */
CreateNetworkRequestSubnetsInner.prototype['type'] = undefined;

/**
 * ID of the robot vSwitch. Must be supplied if the subnet is of type vswitch.
 * @member {Number} vswitch_id
 */
CreateNetworkRequestSubnetsInner.prototype['vswitch_id'] = undefined;
 ...
 * @readonly
 */
CreateNetworkRequestSubnetsInner['TypeEnum'] = {
...
export default CreateNetworkRequestSubnetsInner;
