# HetznerCloudApi.VolumesGet200ResponseVolumesInner
...
**server** | **Number** | ID of the Server the Volume is attached to, null if it is not attached at all | 
**size** | **Number** | Size in GB of the Volume | 
