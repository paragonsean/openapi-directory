...
**domainNames** | **[String]** | Domains and subdomains covered by the Certificate | 
...
**usedBy** | [**[CertificateUsedByInner]**](CertificateUsedByInner.md) | Resources currently using the Certificate | 
