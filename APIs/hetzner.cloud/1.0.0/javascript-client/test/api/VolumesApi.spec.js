...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HetznerCloudApi.VolumesApi();
  });
  ...
  describe('VolumesApi', function() {
    ...
    describe('volumesIdDelete', function() {
      it('should call volumesIdDelete successfully', function(done) {
        //uncomment below and update the code to test volumesIdDelete
        //instance.volumesIdDelete(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('volumesIdGet', function() {
      it('should call volumesIdGet successfully', function(done) {
        //uncomment below and update the code to test volumesIdGet
        //instance.volumesIdGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('volumesIdPut', function() {
      it('should call volumesIdPut successfully', function(done) {
        //uncomment below and update the code to test volumesIdPut
        //instance.volumesIdPut(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('volumesPost', function() {
      it('should call volumesPost successfully', function(done) {
        //uncomment below and update the code to test volumesPost
        //instance.volumesPost(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
