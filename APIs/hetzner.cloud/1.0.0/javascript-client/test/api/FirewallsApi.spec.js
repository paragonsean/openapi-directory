...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HetznerCloudApi.FirewallsApi();
  });
  ...
  describe('FirewallsApi', function() {
    describe('firewallsGet', function() {
      it('should call firewallsGet successfully', function(done) {
        //uncomment below and update the code to test firewallsGet
        //instance.firewallsGet(function(error) {
    ...
    describe('firewallsIdDelete', function() {
      it('should call firewallsIdDelete successfully', function(done) {
        //uncomment below and update the code to test firewallsIdDelete
        //instance.firewallsIdDelete(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('firewallsIdGet', function() {
      it('should call firewallsIdGet successfully', function(done) {
        //uncomment below and update the code to test firewallsIdGet
        //instance.firewallsIdGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('firewallsIdPut', function() {
      it('should call firewallsIdPut successfully', function(done) {
        //uncomment below and update the code to test firewallsIdPut
        //instance.firewallsIdPut(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('firewallsPost', function() {
      it('should call firewallsPost successfully', function(done) {
        //uncomment below and update the code to test firewallsPost
        //instance.firewallsPost(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
