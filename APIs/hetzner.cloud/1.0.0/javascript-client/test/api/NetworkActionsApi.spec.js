...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HetznerCloudApi.NetworkActionsApi();
  });
  ...
  describe('NetworkActionsApi', function() {
    describe('networksIdActionsActionIdGet', function() {
      it('should call networksIdActionsActionIdGet successfully', function(done) {
        //uncomment below and update the code to test networksIdActionsActionIdGet
        //instance.networksIdActionsActionIdGet(function(error) {
    ...
    describe('networksIdActionsAddRoutePost', function() {
      it('should call networksIdActionsAddRoutePost successfully', function(done) {
        //uncomment below and update the code to test networksIdActionsAddRoutePost
        //instance.networksIdActionsAddRoutePost(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('networksIdActionsAddSubnetPost', function() {
      it('should call networksIdActionsAddSubnetPost successfully', function(done) {
        //uncomment below and update the code to test networksIdActionsAddSubnetPost
        //instance.networksIdActionsAddSubnetPost(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('networksIdActionsChangeIpRangePost', function() {
      it('should call networksIdActionsChangeIpRangePost successfully', function(done) {
        //uncomment below and update the code to test networksIdActionsChangeIpRangePost
        //instance.networksIdActionsChangeIpRangePost(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('networksIdActionsChangeProtectionPost', function() {
      it('should call networksIdActionsChangeProtectionPost successfully', function(done) {
        //uncomment below and update the code to test networksIdActionsChangeProtectionPost
        //instance.networksIdActionsChangeProtectionPost(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('networksIdActionsDeleteRoutePost', function() {
      it('should call networksIdActionsDeleteRoutePost successfully', function(done) {
        //uncomment below and update the code to test networksIdActionsDeleteRoutePost
        //instance.networksIdActionsDeleteRoutePost(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('networksIdActionsDeleteSubnetPost', function() {
      it('should call networksIdActionsDeleteSubnetPost successfully', function(done) {
        //uncomment below and update the code to test networksIdActionsDeleteSubnetPost
        //instance.networksIdActionsDeleteSubnetPost(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('networksIdActionsGet', function() {
      it('should call networksIdActionsGet successfully', function(done) {
        //uncomment below and update the code to test networksIdActionsGet
        //instance.networksIdActionsGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
