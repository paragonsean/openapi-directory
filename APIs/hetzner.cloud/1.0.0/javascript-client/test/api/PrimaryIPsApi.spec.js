...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HetznerCloudApi.PrimaryIPsApi();
  });
  ...
  describe('PrimaryIPsApi', function() {
    describe('primaryIpsGet', function() {
      it('should call primaryIpsGet successfully', function(done) {
        //uncomment below and update the code to test primaryIpsGet
        //instance.primaryIpsGet(function(error) {
    ...
    describe('primaryIpsIdDelete', function() {
      it('should call primaryIpsIdDelete successfully', function(done) {
        //uncomment below and update the code to test primaryIpsIdDelete
        //instance.primaryIpsIdDelete(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('primaryIpsIdGet', function() {
      it('should call primaryIpsIdGet successfully', function(done) {
        //uncomment below and update the code to test primaryIpsIdGet
        //instance.primaryIpsIdGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('primaryIpsIdPut', function() {
      it('should call primaryIpsIdPut successfully', function(done) {
        //uncomment below and update the code to test primaryIpsIdPut
        //instance.primaryIpsIdPut(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('primaryIpsPost', function() {
      it('should call primaryIpsPost successfully', function(done) {
        //uncomment below and update the code to test primaryIpsPost
        //instance.primaryIpsPost(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
