...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HetznerCloudApi.VolumeActionsApi();
  });
  ...
  describe('VolumeActionsApi', function() {
    describe('volumesIdActionsActionIdGet', function() {
      it('should call volumesIdActionsActionIdGet successfully', function(done) {
        //uncomment below and update the code to test volumesIdActionsActionIdGet
        //instance.volumesIdActionsActionIdGet(function(error) {
    ...
    describe('volumesIdActionsAttachPost', function() {
      it('should call volumesIdActionsAttachPost successfully', function(done) {
        //uncomment below and update the code to test volumesIdActionsAttachPost
        //instance.volumesIdActionsAttachPost(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('volumesIdActionsChangeProtectionPost', function() {
      it('should call volumesIdActionsChangeProtectionPost successfully', function(done) {
        //uncomment below and update the code to test volumesIdActionsChangeProtectionPost
        //instance.volumesIdActionsChangeProtectionPost(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('volumesIdActionsDetachPost', function() {
      it('should call volumesIdActionsDetachPost successfully', function(done) {
        //uncomment below and update the code to test volumesIdActionsDetachPost
        //instance.volumesIdActionsDetachPost(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('volumesIdActionsGet', function() {
      it('should call volumesIdActionsGet successfully', function(done) {
        //uncomment below and update the code to test volumesIdActionsGet
        //instance.volumesIdActionsGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('volumesIdActionsResizePost', function() {
      it('should call volumesIdActionsResizePost successfully', function(done) {
        //uncomment below and update the code to test volumesIdActionsResizePost
        //instance.volumesIdActionsResizePost(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
