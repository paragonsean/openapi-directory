...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HetznerCloudApi.LoadBalancersApi();
  });
  ...
  describe('LoadBalancersApi', function() {
    ...
    describe('loadBalancersIdDelete', function() {
      it('should call loadBalancersIdDelete successfully', function(done) {
        //uncomment below and update the code to test loadBalancersIdDelete
        //instance.loadBalancersIdDelete(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('loadBalancersIdGet', function() {
      it('should call loadBalancersIdGet successfully', function(done) {
        //uncomment below and update the code to test loadBalancersIdGet
        //instance.loadBalancersIdGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('loadBalancersIdMetricsGet', function() {
      it('should call loadBalancersIdMetricsGet successfully', function(done) {
        //uncomment below and update the code to test loadBalancersIdMetricsGet
        //instance.loadBalancersIdMetricsGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('loadBalancersIdPut', function() {
      it('should call loadBalancersIdPut successfully', function(done) {
        //uncomment below and update the code to test loadBalancersIdPut
        //instance.loadBalancersIdPut(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('loadBalancersPost', function() {
      it('should call loadBalancersPost successfully', function(done) {
        //uncomment below and update the code to test loadBalancersPost
        //instance.loadBalancersPost(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
