...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HetznerCloudApi.CertificatesApi();
  });
  ...
  describe('CertificatesApi', function() {
    ...
    describe('certificatesIdDelete', function() {
      it('should call certificatesIdDelete successfully', function(done) {
        //uncomment below and update the code to test certificatesIdDelete
        //instance.certificatesIdDelete(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('certificatesIdPut', function() {
      it('should call certificatesIdPut successfully', function(done) {
        //uncomment below and update the code to test certificatesIdPut
        //instance.certificatesIdPut(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('certificatesPost', function() {
      it('should call certificatesPost successfully', function(done) {
        //uncomment below and update the code to test certificatesPost
        //instance.certificatesPost(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
