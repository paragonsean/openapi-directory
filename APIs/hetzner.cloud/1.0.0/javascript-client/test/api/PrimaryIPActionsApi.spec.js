...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HetznerCloudApi.PrimaryIPActionsApi();
  });
  ...
  describe('PrimaryIPActionsApi', function() {
    describe('primaryIpsIdActionsAssignPost', function() {
      it('should call primaryIpsIdActionsAssignPost successfully', function(done) {
        //uncomment below and update the code to test primaryIpsIdActionsAssignPost
        //instance.primaryIpsIdActionsAssignPost(function(error) {
    ...
    describe('primaryIpsIdActionsChangeDnsPtrPost', function() {
      it('should call primaryIpsIdActionsChangeDnsPtrPost successfully', function(done) {
        //uncomment below and update the code to test primaryIpsIdActionsChangeDnsPtrPost
        //instance.primaryIpsIdActionsChangeDnsPtrPost(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('primaryIpsIdActionsChangeProtectionPost', function() {
      it('should call primaryIpsIdActionsChangeProtectionPost successfully', function(done) {
        //uncomment below and update the code to test primaryIpsIdActionsChangeProtectionPost
        //instance.primaryIpsIdActionsChangeProtectionPost(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('primaryIpsIdActionsUnassignPost', function() {
      it('should call primaryIpsIdActionsUnassignPost successfully', function(done) {
        //uncomment below and update the code to test primaryIpsIdActionsUnassignPost
        //instance.primaryIpsIdActionsUnassignPost(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
