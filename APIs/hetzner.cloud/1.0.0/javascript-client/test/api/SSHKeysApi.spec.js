...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HetznerCloudApi.SSHKeysApi();
  });
  ...
  describe('SSHKeysApi', function() {
    describe('sshKeysGet', function() {
      it('should call sshKeysGet successfully', function(done) {
        //uncomment below and update the code to test sshKeysGet
        //instance.sshKeysGet(function(error) {
    ...
    describe('sshKeysIdDelete', function() {
      it('should call sshKeysIdDelete successfully', function(done) {
        //uncomment below and update the code to test sshKeysIdDelete
        //instance.sshKeysIdDelete(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('sshKeysIdGet', function() {
      it('should call sshKeysIdGet successfully', function(done) {
        //uncomment below and update the code to test sshKeysIdGet
        //instance.sshKeysIdGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('sshKeysIdPut', function() {
      it('should call sshKeysIdPut successfully', function(done) {
        //uncomment below and update the code to test sshKeysIdPut
        //instance.sshKeysIdPut(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('sshKeysPost', function() {
      it('should call sshKeysPost successfully', function(done) {
        //uncomment below and update the code to test sshKeysPost
        //instance.sshKeysPost(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
