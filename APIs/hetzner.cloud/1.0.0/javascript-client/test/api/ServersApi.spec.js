...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HetznerCloudApi.ServersApi();
  });
  ...
  describe('ServersApi', function() {
    ...
    describe('serversIdDelete', function() {
      it('should call serversIdDelete successfully', function(done) {
        //uncomment below and update the code to test serversIdDelete
        //instance.serversIdDelete(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('serversIdGet', function() {
      it('should call serversIdGet successfully', function(done) {
        //uncomment below and update the code to test serversIdGet
        //instance.serversIdGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('serversIdMetricsGet', function() {
      it('should call serversIdMetricsGet successfully', function(done) {
        //uncomment below and update the code to test serversIdMetricsGet
        //instance.serversIdMetricsGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('serversIdPut', function() {
      it('should call serversIdPut successfully', function(done) {
        //uncomment below and update the code to test serversIdPut
        //instance.serversIdPut(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('serversPost', function() {
      it('should call serversPost successfully', function(done) {
        //uncomment below and update the code to test serversPost
        //instance.serversPost(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
