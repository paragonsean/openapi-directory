...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HetznerCloudApi.ImagesApi();
  });
  ...
  describe('ImagesApi', function() {
    ...
    describe('imagesIdPut', function() {
      it('should call imagesIdPut successfully', function(done) {
        //uncomment below and update the code to test imagesIdPut
        //instance.imagesIdPut(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
