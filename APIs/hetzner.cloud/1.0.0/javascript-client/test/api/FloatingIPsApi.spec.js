...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HetznerCloudApi.FloatingIPsApi();
  });
  ...
  describe('FloatingIPsApi', function() {
    describe('floatingIpsGet', function() {
      it('should call floatingIpsGet successfully', function(done) {
        //uncomment below and update the code to test floatingIpsGet
        //instance.floatingIpsGet(function(error) {
    ...
    describe('floatingIpsIdDelete', function() {
      it('should call floatingIpsIdDelete successfully', function(done) {
        //uncomment below and update the code to test floatingIpsIdDelete
        //instance.floatingIpsIdDelete(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('floatingIpsIdGet', function() {
      it('should call floatingIpsIdGet successfully', function(done) {
        //uncomment below and update the code to test floatingIpsIdGet
        //instance.floatingIpsIdGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('floatingIpsIdPut', function() {
      it('should call floatingIpsIdPut successfully', function(done) {
        //uncomment below and update the code to test floatingIpsIdPut
        //instance.floatingIpsIdPut(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('floatingIpsPost', function() {
      it('should call floatingIpsPost successfully', function(done) {
        //uncomment below and update the code to test floatingIpsPost
        //instance.floatingIpsPost(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
