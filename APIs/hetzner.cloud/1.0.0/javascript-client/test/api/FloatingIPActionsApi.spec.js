...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HetznerCloudApi.FloatingIPActionsApi();
  });
  ...
  describe('FloatingIPActionsApi', function() {
    describe('floatingIpsIdActionsActionIdGet', function() {
      it('should call floatingIpsIdActionsActionIdGet successfully', function(done) {
        //uncomment below and update the code to test floatingIpsIdActionsActionIdGet
        //instance.floatingIpsIdActionsActionIdGet(function(error) {
    ...
    describe('floatingIpsIdActionsAssignPost', function() {
      it('should call floatingIpsIdActionsAssignPost successfully', function(done) {
        //uncomment below and update the code to test floatingIpsIdActionsAssignPost
        //instance.floatingIpsIdActionsAssignPost(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('floatingIpsIdActionsChangeDnsPtrPost', function() {
      it('should call floatingIpsIdActionsChangeDnsPtrPost successfully', function(done) {
        //uncomment below and update the code to test floatingIpsIdActionsChangeDnsPtrPost
        //instance.floatingIpsIdActionsChangeDnsPtrPost(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('floatingIpsIdActionsChangeProtectionPost', function() {
      it('should call floatingIpsIdActionsChangeProtectionPost successfully', function(done) {
        //uncomment below and update the code to test floatingIpsIdActionsChangeProtectionPost
        //instance.floatingIpsIdActionsChangeProtectionPost(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('floatingIpsIdActionsGet', function() {
      it('should call floatingIpsIdActionsGet successfully', function(done) {
        //uncomment below and update the code to test floatingIpsIdActionsGet
        //instance.floatingIpsIdActionsGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('floatingIpsIdActionsUnassignPost', function() {
      it('should call floatingIpsIdActionsUnassignPost successfully', function(done) {
        //uncomment below and update the code to test floatingIpsIdActionsUnassignPost
        //instance.floatingIpsIdActionsUnassignPost(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
