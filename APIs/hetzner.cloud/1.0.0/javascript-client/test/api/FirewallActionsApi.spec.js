...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HetznerCloudApi.FirewallActionsApi();
  });
  ...
  describe('FirewallActionsApi', function() {
    describe('firewallsIdActionsActionIdGet', function() {
      it('should call firewallsIdActionsActionIdGet successfully', function(done) {
        //uncomment below and update the code to test firewallsIdActionsActionIdGet
        //instance.firewallsIdActionsActionIdGet(function(error) {
    ...
    describe('firewallsIdActionsApplyToResourcesPost', function() {
      it('should call firewallsIdActionsApplyToResourcesPost successfully', function(done) {
        //uncomment below and update the code to test firewallsIdActionsApplyToResourcesPost
        //instance.firewallsIdActionsApplyToResourcesPost(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('firewallsIdActionsGet', function() {
      it('should call firewallsIdActionsGet successfully', function(done) {
        //uncomment below and update the code to test firewallsIdActionsGet
        //instance.firewallsIdActionsGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('firewallsIdActionsRemoveFromResourcesPost', function() {
      it('should call firewallsIdActionsRemoveFromResourcesPost successfully', function(done) {
        //uncomment below and update the code to test firewallsIdActionsRemoveFromResourcesPost
        //instance.firewallsIdActionsRemoveFromResourcesPost(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('firewallsIdActionsSetRulesPost', function() {
      it('should call firewallsIdActionsSetRulesPost successfully', function(done) {
        //uncomment below and update the code to test firewallsIdActionsSetRulesPost
        //instance.firewallsIdActionsSetRulesPost(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
