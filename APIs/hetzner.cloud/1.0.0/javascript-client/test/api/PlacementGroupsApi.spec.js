...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HetznerCloudApi.PlacementGroupsApi();
  });
  ...
  describe('PlacementGroupsApi', function() {
    describe('placementGroupsGet', function() {
      it('should call placementGroupsGet successfully', function(done) {
        //uncomment below and update the code to test placementGroupsGet
        //instance.placementGroupsGet(function(error) {
    ...
    describe('placementGroupsIdDelete', function() {
      it('should call placementGroupsIdDelete successfully', function(done) {
        //uncomment below and update the code to test placementGroupsIdDelete
        //instance.placementGroupsIdDelete(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('placementGroupsIdGet', function() {
      it('should call placementGroupsIdGet successfully', function(done) {
        //uncomment below and update the code to test placementGroupsIdGet
        //instance.placementGroupsIdGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('placementGroupsIdPut', function() {
      it('should call placementGroupsIdPut successfully', function(done) {
        //uncomment below and update the code to test placementGroupsIdPut
        //instance.placementGroupsIdPut(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('placementGroupsPost', function() {
      it('should call placementGroupsPost successfully', function(done) {
        //uncomment below and update the code to test placementGroupsPost
        //instance.placementGroupsPost(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
