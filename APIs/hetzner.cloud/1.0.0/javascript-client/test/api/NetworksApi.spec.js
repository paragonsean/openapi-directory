...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HetznerCloudApi.NetworksApi();
  });
  ...
  describe('NetworksApi', function() {
    describe('networksGet', function() {
      it('should call networksGet successfully', function(done) {
        //uncomment below and update the code to test networksGet
        //instance.networksGet(function(error) {
    ...
    describe('networksIdDelete', function() {
      it('should call networksIdDelete successfully', function(done) {
        //uncomment below and update the code to test networksIdDelete
        //instance.networksIdDelete(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('networksIdGet', function() {
      it('should call networksIdGet successfully', function(done) {
        //uncomment below and update the code to test networksIdGet
        //instance.networksIdGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('networksIdPut', function() {
      it('should call networksIdPut successfully', function(done) {
        //uncomment below and update the code to test networksIdPut
        //instance.networksIdPut(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('networksPost', function() {
      it('should call networksPost successfully', function(done) {
        //uncomment below and update the code to test networksPost
        //instance.networksPost(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
