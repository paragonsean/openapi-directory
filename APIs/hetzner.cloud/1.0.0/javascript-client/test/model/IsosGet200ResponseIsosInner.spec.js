...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HetznerCloudApi.IsosGet200ResponseIsosInner();
  });
  ...
  describe('IsosGet200ResponseIsosInner', function() {
    it('should create an instance of IsosGet200ResponseIsosInner', function() {
      // uncomment below and update the code to test IsosGet200ResponseIsosInner
      //var instance = new HetznerCloudApi.IsosGet200ResponseIsosInner();
      //expect(instance).to.be.a(HetznerCloudApi.IsosGet200ResponseIsosInner);
    });
