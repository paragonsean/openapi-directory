...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HetznerCloudApi.NullableAction();
  });
  ...
  describe('NullableAction', function() {
    it('should create an instance of NullableAction', function() {
      // uncomment below and update the code to test NullableAction
      //var instance = new HetznerCloudApi.NullableAction();
      //expect(instance).to.be.a(HetznerCloudApi.NullableAction);
    });
