...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HetznerCloudApi.DatacentersGet200ResponseDatacentersInnerLocation();
  });
  ...
  describe('DatacentersGet200ResponseDatacentersInnerLocation', function() {
    it('should create an instance of DatacentersGet200ResponseDatacentersInnerLocation', function() {
      // uncomment below and update the code to test DatacentersGet200ResponseDatacentersInnerLocation
      //var instance = new HetznerCloudApi.DatacentersGet200ResponseDatacentersInnerLocation();
      //expect(instance).to.be.a(HetznerCloudApi.DatacentersGet200ResponseDatacentersInnerLocation);
    });
