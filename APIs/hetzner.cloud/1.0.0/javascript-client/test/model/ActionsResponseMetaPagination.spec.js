...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HetznerCloudApi.ActionsResponseMetaPagination();
  });
  ...
  describe('ActionsResponseMetaPagination', function() {
    it('should create an instance of ActionsResponseMetaPagination', function() {
      // uncomment below and update the code to test ActionsResponseMetaPagination
      //var instance = new HetznerCloudApi.ActionsResponseMetaPagination();
      //expect(instance).to.be.a(HetznerCloudApi.ActionsResponseMetaPagination);
    });
