...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HetznerCloudApi.CreateFloatingIPRequest();
  });
  ...
  describe('CreateFloatingIPRequest', function() {
    it('should create an instance of CreateFloatingIPRequest', function() {
      // uncomment below and update the code to test CreateFloatingIPRequest
      //var instance = new HetznerCloudApi.CreateFloatingIPRequest();
      //expect(instance).to.be.a(HetznerCloudApi.CreateFloatingIPRequest);
    });
