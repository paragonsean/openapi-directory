...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HetznerCloudApi.CreateVolumeRequest();
  });
  ...
  describe('CreateVolumeRequest', function() {
    it('should create an instance of CreateVolumeRequest', function() {
      ...
      //var instance = new HetznerCloudApi.CreateVolumeRequest();
      //expect(instance).to.be.a(HetznerCloudApi.CreateVolumeRequest);
    });
