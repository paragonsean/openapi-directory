...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HetznerCloudApi.LoadBalancerTypesGet200ResponseLoadBalancerTypesInner();
  });
  ...
  describe('LoadBalancerTypesGet200ResponseLoadBalancerTypesInner', function() {
    it('should create an instance of LoadBalancerTypesGet200ResponseLoadBalancerTypesInner', function() {
      // uncomment below and update the code to test LoadBalancerTypesGet200ResponseLoadBalancerTypesInner
      //var instance = new HetznerCloudApi.LoadBalancerTypesGet200ResponseLoadBalancerTypesInner();
      //expect(instance).to.be.a(HetznerCloudApi.LoadBalancerTypesGet200ResponseLoadBalancerTypesInner);
    });
    ...
    it('should have the property maxAssignedCertificates (base name: "max_assigned_certificates")', function() {
      // uncomment below and update the code to test the property maxAssignedCertificates
      //var instance = new HetznerCloudApi.LoadBalancerTypesGet200ResponseLoadBalancerTypesInner();
      //expect(instance).to.be();
    });
    ...
    it('should have the property maxServices (base name: "max_services")', function() {
      // uncomment below and update the code to test the property maxServices
      //var instance = new HetznerCloudApi.LoadBalancerTypesGet200ResponseLoadBalancerTypesInner();
      //expect(instance).to.be();
    });

    it('should have the property maxTargets (base name: "max_targets")', function() {
      // uncomment below and update the code to test the property maxTargets
      //var instance = new HetznerCloudApi.LoadBalancerTypesGet200ResponseLoadBalancerTypesInner();
      //expect(instance).to.be();
    });
