...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HetznerCloudApi.VolumesGet200ResponseVolumesInner();
  });
  ...
  describe('VolumesGet200ResponseVolumesInner', function() {
    it('should create an instance of VolumesGet200ResponseVolumesInner', function() {
      // uncomment below and update the code to test VolumesGet200ResponseVolumesInner
      //var instance = new HetznerCloudApi.VolumesGet200ResponseVolumesInner();
      //expect(instance).to.be.a(HetznerCloudApi.VolumesGet200ResponseVolumesInner);
    });
    ...
    it('should have the property linuxDevice (base name: "linux_device")', function() {
      // uncomment below and update the code to test the property linuxDevice
      //var instance = new HetznerCloudApi.VolumesGet200ResponseVolumesInner();
      //expect(instance).to.be();
    });
