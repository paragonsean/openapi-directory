...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HetznerCloudApi.LoadBalancerTarget();
  });
  ...
  describe('LoadBalancerTarget', function() {
    it('should create an instance of LoadBalancerTarget', function() {
      // uncomment below and update the code to test LoadBalancerTarget
      //var instance = new HetznerCloudApi.LoadBalancerTarget();
      //expect(instance).to.be.a(HetznerCloudApi.LoadBalancerTarget);
    });
    ...
    it('should have the property labelSelector (base name: "label_selector")', function() {
    ...
    it('should have the property usePrivateIp (base name: "use_private_ip")', function() {
      // uncomment below and update the code to test the property usePrivateIp
      //var instance = new HetznerCloudApi.LoadBalancerTarget();
      //expect(instance).to.be();
    });
