...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HetznerCloudApi.PricingGet200ResponsePricing();
  });
  ...
  describe('PricingGet200ResponsePricing', function() {
    it('should create an instance of PricingGet200ResponsePricing', function() {
      // uncomment below and update the code to test PricingGet200ResponsePricing
      //var instance = new HetznerCloudApi.PricingGet200ResponsePricing();
      //expect(instance).to.be.a(HetznerCloudApi.PricingGet200ResponsePricing);
    });
    ...
    it('should have the property floatingIps (base name: "floating_ips")', function() {
      // uncomment below and update the code to test the property floatingIps
      //var instance = new HetznerCloudApi.PricingGet200ResponsePricing();
      //expect(instance).to.be();
    });
    ...
    it('should have the property loadBalancerTypes (base name: "load_balancer_types")', function() {
      // uncomment below and update the code to test the property loadBalancerTypes
      //var instance = new HetznerCloudApi.PricingGet200ResponsePricing();
      //expect(instance).to.be();
    });

    it('should have the property primaryIps (base name: "primary_ips")', function() {
      // uncomment below and update the code to test the property primaryIps
      //var instance = new HetznerCloudApi.PricingGet200ResponsePricing();
      //expect(instance).to.be();
    });

    it('should have the property serverBackup (base name: "server_backup")', function() {
      // uncomment below and update the code to test the property serverBackup
      //var instance = new HetznerCloudApi.PricingGet200ResponsePricing();
      //expect(instance).to.be();
    });

    it('should have the property serverTypes (base name: "server_types")', function() {
