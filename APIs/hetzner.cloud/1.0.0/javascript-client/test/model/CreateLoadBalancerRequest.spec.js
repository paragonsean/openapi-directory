...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HetznerCloudApi.CreateLoadBalancerRequest();
  });
  ...
  describe('CreateLoadBalancerRequest', function() {
    it('should create an instance of CreateLoadBalancerRequest', function() {
      // uncomment below and update the code to test CreateLoadBalancerRequest
      //var instance = new HetznerCloudApi.CreateLoadBalancerRequest();
      //expect(instance).to.be.a(HetznerCloudApi.CreateLoadBalancerRequest);
    });
    ...
    it('should have the property networkZone (base name: "network_zone")', function() {
      // uncomment below and update the code to test the property networkZone
      //var instance = new HetznerCloudApi.CreateLoadBalancerRequest();
      //expect(instance).to.be();
    });

    it('should have the property publicInterface (base name: "public_interface")', function() {
      // uncomment below and update the code to test the property publicInterface
      //var instance = new HetznerCloudApi.CreateLoadBalancerRequest();
      //expect(instance).to.be();
    });
