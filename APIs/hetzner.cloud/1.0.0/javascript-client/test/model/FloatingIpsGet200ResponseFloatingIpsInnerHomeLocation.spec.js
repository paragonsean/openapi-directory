...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HetznerCloudApi.FloatingIpsGet200ResponseFloatingIpsInnerHomeLocation();
  });
  ...
  describe('FloatingIpsGet200ResponseFloatingIpsInnerHomeLocation', function() {
    it('should create an instance of FloatingIpsGet200ResponseFloatingIpsInnerHomeLocation', function() {
      // uncomment below and update the code to test FloatingIpsGet200ResponseFloatingIpsInnerHomeLocation
      //var instance = new HetznerCloudApi.FloatingIpsGet200ResponseFloatingIpsInnerHomeLocation();
      //expect(instance).to.be.a(HetznerCloudApi.FloatingIpsGet200ResponseFloatingIpsInnerHomeLocation);
    });
