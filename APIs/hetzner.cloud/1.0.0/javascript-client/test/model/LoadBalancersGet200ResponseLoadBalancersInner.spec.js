...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HetznerCloudApi.LoadBalancersGet200ResponseLoadBalancersInner();
  });
  ...
  describe('LoadBalancersGet200ResponseLoadBalancersInner', function() {
    it('should create an instance of LoadBalancersGet200ResponseLoadBalancersInner', function() {
      // uncomment below and update the code to test LoadBalancersGet200ResponseLoadBalancersInner
      //var instance = new HetznerCloudApi.LoadBalancersGet200ResponseLoadBalancersInner();
      //expect(instance).to.be.a(HetznerCloudApi.LoadBalancersGet200ResponseLoadBalancersInner);
    });
    ...
    it('should have the property loadBalancerType (base name: "load_balancer_type")', function() {
