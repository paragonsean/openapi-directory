...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HetznerCloudApi.CreateServerRequest();
  });
  ...
  describe('CreateServerRequest', function() {
    it('should create an instance of CreateServerRequest', function() {
      ...
      //var instance = new HetznerCloudApi.CreateServerRequest();
      //expect(instance).to.be.a(HetznerCloudApi.CreateServerRequest);
    });

    it('should have the property automount (base name: "automount")', function() {
      // uncomment below and update the code to test the property automount
      //var instance = new HetznerCloudApi.CreateServerRequest();
    ...
    it('should have the property startAfterCreate (base name: "start_after_create")', function() {
      // uncomment below and update the code to test the property startAfterCreate
      //var instance = new HetznerCloudApi.CreateServerRequest();
      //expect(instance).to.be();
    });
