...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HetznerCloudApi.CreatePrimaryIPRequest();
  });
  ...
  describe('CreatePrimaryIPRequest', function() {
    it('should create an instance of CreatePrimaryIPRequest', function() {
      // uncomment below and update the code to test CreatePrimaryIPRequest
      //var instance = new HetznerCloudApi.CreatePrimaryIPRequest();
      //expect(instance).to.be.a(HetznerCloudApi.CreatePrimaryIPRequest);
    });
    ...
    it('should have the property assigneeType (base name: "assignee_type")', function() {
