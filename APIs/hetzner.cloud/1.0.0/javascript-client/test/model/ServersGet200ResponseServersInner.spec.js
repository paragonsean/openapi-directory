...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    factory(root.expect, root.HetznerCloudApi);
  }
}(this, function(expect, HetznerCloudApi) {
  'use strict';

  var instance;

  beforeEach(function() {
    instance = new HetznerCloudApi.ServersGet200ResponseServersInner();
  });
  ...
  describe('ServersGet200ResponseServersInner', function() {
    it('should create an instance of ServersGet200ResponseServersInner', function() {
      // uncomment below and update the code to test ServersGet200ResponseServersInner
      //var instance = new HetznerCloudApi.ServersGet200ResponseServersInner();
      //expect(instance).to.be.a(HetznerCloudApi.ServersGet200ResponseServersInner);
    });

    it('should have the property backupWindow (base name: "backup_window")', function() {
    ...
    it('should have the property includedTraffic (base name: "included_traffic")', function() {
      // uncomment below and update the code to test the property includedTraffic
      //var instance = new HetznerCloudApi.ServersGet200ResponseServersInner();
      //expect(instance).to.be();
    });

    it('should have the property ingoingTraffic (base name: "ingoing_traffic")', function() {
      // uncomment below and update the code to test the property ingoingTraffic
      //var instance = new HetznerCloudApi.ServersGet200ResponseServersInner();
      //expect(instance).to.be();
    });
    ...
    it('should have the property loadBalancers (base name: "load_balancers")', function() {
    ...
    it('should have the property outgoingTraffic (base name: "outgoing_traffic")', function() {
      // uncomment below and update the code to test the property outgoingTraffic
      //var instance = new HetznerCloudApi.ServersGet200ResponseServersInner();
      //expect(instance).to.be();
    });
    ...
    it('should have the property primaryDiskSize (base name: "primary_disk_size")', function() {
      // uncomment below and update the code to test the property primaryDiskSize
      //var instance = new HetznerCloudApi.ServersGet200ResponseServersInner();
      //expect(instance).to.be();
    });

    it('should have the property privateNet (base name: "private_net")', function() {
      // uncomment below and update the code to test the property privateNet
      //var instance = new HetznerCloudApi.ServersGet200ResponseServersInner();
      //expect(instance).to.be();
    });
    ...
    it('should have the property publicNet (base name: "public_net")', function() {
      // uncomment below and update the code to test the property publicNet
      //var instance = new HetznerCloudApi.ServersGet200ResponseServersInner();
      //expect(instance).to.be();
    });

    it('should have the property rescueEnabled (base name: "rescue_enabled")', function() {
      // uncomment below and update the code to test the property rescueEnabled
      //var instance = new HetznerCloudApi.ServersGet200ResponseServersInner();
      //expect(instance).to.be();
    });
