...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HetznerCloudApi.LoadBalancerService();
  });
  ...
  describe('LoadBalancerService', function() {
    it('should create an instance of LoadBalancerService', function() {
      // uncomment below and update the code to test LoadBalancerService
      //var instance = new HetznerCloudApi.LoadBalancerService();
      //expect(instance).to.be.a(HetznerCloudApi.LoadBalancerService);
    });
    ...
    it('should have the property listenPort (base name: "listen_port")', function() {
      // uncomment below and update the code to test the property listenPort
      //var instance = new HetznerCloudApi.LoadBalancerService();
      //expect(instance).to.be();
    });
