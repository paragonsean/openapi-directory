...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HetznerCloudApi.ServersGet200ResponseServersInnerServerType();
  });
  ...
  describe('ServersGet200ResponseServersInnerServerType', function() {
    it('should create an instance of ServersGet200ResponseServersInnerServerType', function() {
      // uncomment below and update the code to test ServersGet200ResponseServersInnerServerType
      //var instance = new HetznerCloudApi.ServersGet200ResponseServersInnerServerType();
      //expect(instance).to.be.a(HetznerCloudApi.ServersGet200ResponseServersInnerServerType);
    });
