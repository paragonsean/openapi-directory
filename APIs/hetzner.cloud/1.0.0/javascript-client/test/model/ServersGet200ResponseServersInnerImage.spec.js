...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HetznerCloudApi.ServersGet200ResponseServersInnerImage();
  });
  ...
  describe('ServersGet200ResponseServersInnerImage', function() {
    it('should create an instance of ServersGet200ResponseServersInnerImage', function() {
      // uncomment below and update the code to test ServersGet200ResponseServersInnerImage
      //var instance = new HetznerCloudApi.ServersGet200ResponseServersInnerImage();
      //expect(instance).to.be.a(HetznerCloudApi.ServersGet200ResponseServersInnerImage);
    });

    it('should have the property boundTo (base name: "bound_to")', function() {
      // uncomment below and update the code to test the property boundTo
      //var instance = new HetznerCloudApi.ServersGet200ResponseServersInnerImage();
    ...
    it('should have the property createdFrom (base name: "created_from")', function() {
    ...
    it('should have the property imageSize (base name: "image_size")', function() {
    ...
    it('should have the property osFlavor (base name: "os_flavor")', function() {
      // uncomment below and update the code to test the property osFlavor
      //var instance = new HetznerCloudApi.ServersGet200ResponseServersInnerImage();
      //expect(instance).to.be();
    });
    ...
    it('should have the property rapidDeploy (base name: "rapid_deploy")', function() {
      // uncomment below and update the code to test the property rapidDeploy
      //var instance = new HetznerCloudApi.ServersGet200ResponseServersInnerImage();
      //expect(instance).to.be();
    });
