...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HetznerCloudApi.PlacementGroupNullable();
  });
  ...
  describe('PlacementGroupNullable', function() {
    it('should create an instance of PlacementGroupNullable', function() {
      // uncomment below and update the code to test PlacementGroupNullable
      //var instance = new HetznerCloudApi.PlacementGroupNullable();
      //expect(instance).to.be.a(HetznerCloudApi.PlacementGroupNullable);
    });
