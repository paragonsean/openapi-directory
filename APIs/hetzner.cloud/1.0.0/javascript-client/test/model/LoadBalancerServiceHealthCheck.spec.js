...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HetznerCloudApi.LoadBalancerServiceHealthCheck();
  });
  ...
  describe('LoadBalancerServiceHealthCheck', function() {
    it('should create an instance of LoadBalancerServiceHealthCheck', function() {
      // uncomment below and update the code to test LoadBalancerServiceHealthCheck
      //var instance = new HetznerCloudApi.LoadBalancerServiceHealthCheck();
      //expect(instance).to.be.a(HetznerCloudApi.LoadBalancerServiceHealthCheck);
    });
