...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HetznerCloudApi.PrimaryIP();
  });
  ...
  describe('PrimaryIP', function() {
    it('should create an instance of PrimaryIP', function() {
      // uncomment below and update the code to test PrimaryIP
      //var instance = new HetznerCloudApi.PrimaryIP();
      //expect(instance).to.be.a(HetznerCloudApi.PrimaryIP);
    });
    ...
    it('should have the property dnsPtr (base name: "dns_ptr")', function() {
      // uncomment below and update the code to test the property dnsPtr
      //var instance = new HetznerCloudApi.PrimaryIP();
      //expect(instance).to.be();
    });
