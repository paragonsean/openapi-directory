...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HetznerCloudApi.ServersGet200ResponseServersInnerIso();
  });
  ...
  describe('ServersGet200ResponseServersInnerIso', function() {
    it('should create an instance of ServersGet200ResponseServersInnerIso', function() {
      // uncomment below and update the code to test ServersGet200ResponseServersInnerIso
      //var instance = new HetznerCloudApi.ServersGet200ResponseServersInnerIso();
      //expect(instance).to.be.a(HetznerCloudApi.ServersGet200ResponseServersInnerIso);
    });
