...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HetznerCloudApi.CreateCertificateRequest();
  });
  ...
  describe('CreateCertificateRequest', function() {
    it('should create an instance of CreateCertificateRequest', function() {
      ...
      //var instance = new HetznerCloudApi.CreateCertificateRequest();
      //expect(instance).to.be.a(HetznerCloudApi.CreateCertificateRequest);
    });
