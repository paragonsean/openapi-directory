...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ObonoRksvApi.Belegformat();
  });
  ...
  describe('Belegformat', function() {
    it('should create an instance of Belegformat', function() {
      // uncomment below and update the code to test Belegformat
      //var instance = new ObonoRksvApi.Belegformat();
      //expect(instance).to.be.a(ObonoRksvApi.Belegformat);
    });
