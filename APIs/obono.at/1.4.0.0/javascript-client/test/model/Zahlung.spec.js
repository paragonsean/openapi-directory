...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ObonoRksvApi.Zahlung();
  });
  ...
  describe('Zahlung', function() {
    it('should create an instance of Zahlung', function() {
      // uncomment below and update the code to test Zahlung
      //var instance = new ObonoRksvApi.Zahlung();
      //expect(instance).to.be.a(ObonoRksvApi.Zahlung);
    });
    ...
    it('should have the property referenz (base name: "Referenz")', function() {
      // uncomment below and update the code to test the property referenz
      //var instance = new ObonoRksvApi.Zahlung();
      //expect(instance).to.be();
    });
