...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ObonoRksvApi.Rabatt();
  });
  ...
  describe('Rabatt', function() {
    it('should create an instance of Rabatt', function() {
      // uncomment below and update the code to test Rabatt
      //var instance = new ObonoRksvApi.Rabatt();
      //expect(instance).to.be.a(ObonoRksvApi.Rabatt);
    });
