...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ObonoRksvApi.MonatsbelegeApi();
  });
  ...
  describe('MonatsbelegeApi', function() {
    describe('getMonatsbelege', function() {
      it('should call getMonatsbelege successfully', function(done) {
        //uncomment below and update the code to test getMonatsbelege
        //instance.getMonatsbelege(function(error) {
