...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ObonoRksvApi.RegistrierkasseApi();
  });
  ...
  describe('RegistrierkasseApi', function() {
    describe('getDEP', function() {
      it('should call getDEP successfully', function(done) {
        //uncomment below and update the code to test getDEP
        //instance.getDEP(function(error) {
    ...
    describe('getRegistrierkasse', function() {
      it('should call getRegistrierkasse successfully', function(done) {
        //uncomment below and update the code to test getRegistrierkasse
        //instance.getRegistrierkasse(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
