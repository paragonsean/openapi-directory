...
void OAIAuthApi::authGet() {
    QString fullPath = QString(_serverConfigs["authGet"][_serverIndices.value("authGet")].URL()+"/auth");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIAuthApi::authGetCallback);
...
void OAIAuthApi::authGetCallback(OAIHttpRequestWorker *worker) {
    ...
    OAIAuthResult output(QString(worker->response));
    worker->deleteLater();
