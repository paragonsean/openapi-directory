...
public class ApiClient {
    ...
    private String basePath = "http://api.openapi-generator.tech";
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/6.5.0/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g http://api.openapi-generator.tech
