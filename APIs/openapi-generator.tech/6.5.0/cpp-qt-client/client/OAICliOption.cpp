...
void OAICliOption::initializeModel() {
    ...
    m_opt_value_isSet = false;
    m_opt_value_isValid = false;
...
void OAICliOption::fromJsonObject(QJsonObject json) {
    ...
    m_opt_value_isValid = ::OpenAPI::fromJsonValue(m_opt_value, json[QString("optValue")]);
    m_opt_value_isSet = !json[QString("optValue")].isNull() && m_opt_value_isValid;
...
QJsonObject OAICliOption::asJsonObject() const {
    ...
    if (m_opt_value_isSet) {
        obj.insert(QString("optValue"), ::OpenAPI::toJsonValue(m_opt_value));
    }
    if (m_type_isSet) {
...
QString OAICliOption::getOpt() const {
    return m_opt;
}
void OAICliOption::setOpt(const QString &opt) {
    m_opt = opt;
    m_opt_isSet = true;
}

bool OAICliOption::is_opt_Set() const{
    return m_opt_isSet;
}

bool OAICliOption::is_opt_Valid() const{
    return m_opt_isValid;
}

QString OAICliOption::getOptValue() const {
    return m_opt_value;
}
void OAICliOption::setOptValue(const QString &opt_value) {
    m_opt_value = opt_value;
    m_opt_value_isSet = true;
}

bool OAICliOption::is_opt_value_Set() const{
    return m_opt_value_isSet;
}

bool OAICliOption::is_opt_value_Valid() const{
    return m_opt_value_isValid;
}
