...
OAICreateAccount Example::create(){
    OAICreateAccount obj;
 return obj;
}
...
void Example::exampleFunction1(){
     OAIAccountsApi apiInstance;
      ...
      OAICreateAccount oai_create_account = create(); // OAICreateAccount | 
      apiInstance.createAccount(oai_create_account);
