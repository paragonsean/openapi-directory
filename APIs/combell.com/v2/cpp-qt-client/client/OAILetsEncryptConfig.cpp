...
#include "OAILetsEncryptConfig.h"
...
OAILetsEncryptConfig::OAILetsEncryptConfig(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAILetsEncryptConfig::OAILetsEncryptConfig() {
    this->initializeModel();
}

OAILetsEncryptConfig::~OAILetsEncryptConfig() {}

void OAILetsEncryptConfig::initializeModel() {

    m_enabled_isSet = false;
    m_enabled_isValid = false;
}

void OAILetsEncryptConfig::fromJson(QString jsonString) {
...
void OAILetsEncryptConfig::fromJsonObject(QJsonObject json) {

    m_enabled_isValid = ::OpenAPI::fromJsonValue(m_enabled, json[QString("enabled")]);
    m_enabled_isSet = !json[QString("enabled")].isNull() && m_enabled_isValid;
}

QString OAILetsEncryptConfig::asJson() const {
...
QJsonObject OAILetsEncryptConfig::asJsonObject() const {
    QJsonObject obj;
    if (m_enabled_isSet) {
...
bool OAILetsEncryptConfig::isEnabled() const {
    return m_enabled;
}
void OAILetsEncryptConfig::setEnabled(const bool &enabled) {
    m_enabled = enabled;
    m_enabled_isSet = true;
}

bool OAILetsEncryptConfig::is_enabled_Set() const{
    return m_enabled_isSet;
}

bool OAILetsEncryptConfig::is_enabled_Valid() const{
    return m_enabled_isValid;
}

bool OAILetsEncryptConfig::isSet() const {
...
bool OAILetsEncryptConfig::isValid() const {
