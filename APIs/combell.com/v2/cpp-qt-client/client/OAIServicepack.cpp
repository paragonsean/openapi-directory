...
OAIServicepack::OAIServicepack(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIServicepack::OAIServicepack() {
    this->initializeModel();
}

OAIServicepack::~OAIServicepack() {}

void OAIServicepack::initializeModel() {
...
void OAIServicepack::fromJson(QString jsonString) {
...
void OAIServicepack::fromJsonObject(QJsonObject json) {
...
QString OAIServicepack::asJson() const {
...
QJsonObject OAIServicepack::asJsonObject() const {
    QJsonObject obj;
    if (m_id_isSet) {
...
qint32 OAIServicepack::getId() const {
    return m_id;
}
void OAIServicepack::setId(const qint32 &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIServicepack::is_id_Set() const{
    return m_id_isSet;
}

bool OAIServicepack::is_id_Valid() const{
    return m_id_isValid;
}

QString OAIServicepack::getName() const {
    return m_name;
}
void OAIServicepack::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIServicepack::is_name_Set() const{
    return m_name_isSet;
}

bool OAIServicepack::is_name_Valid() const{
    return m_name_isValid;
}

bool OAIServicepack::isSet() const {
...
bool OAIServicepack::isValid() const {
