...
/*
 * OAIAdditionalValidationAttribute.h
 *
 * 
 */

#ifndef OAIAdditionalValidationAttribute_H
#define OAIAdditionalValidationAttribute_H
...
class OAIAdditionalValidationAttribute : public OAIObject {
public:
    OAIAdditionalValidationAttribute();
    OAIAdditionalValidationAttribute(QString json);
    ~OAIAdditionalValidationAttribute() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAdditionalValidationAttribute)

#endif // OAIAdditionalValidationAttribute_H
