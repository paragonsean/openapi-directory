...
/*
 * OAIUpdatePhpAPcuRequest.h
 *
 * 
 */

#ifndef OAIUpdatePhpAPcuRequest_H
#define OAIUpdatePhpAPcuRequest_H
...
class OAIUpdatePhpAPcuRequest : public OAIObject {
public:
    OAIUpdatePhpAPcuRequest();
    OAIUpdatePhpAPcuRequest(QString json);
    ~OAIUpdatePhpAPcuRequest() override;
    ...
    qint32 getApcuSize() const;
    void setApcuSize(const qint32 &apcu_size);
    bool is_apcu_size_Set() const;
    bool is_apcu_size_Valid() const;
...
private:
    ...
    qint32 m_apcu_size;
    bool m_apcu_size_isSet;
    bool m_apcu_size_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdatePhpAPcuRequest)

#endif // OAIUpdatePhpAPcuRequest_H
