...
#ifndef OAIWindowsSite_H
#define OAIWindowsSite_H

#include <QJsonObject>

#include "OAISiteBinding.h"
#include <QList>
#include <QString>
...
namespace OpenAPI {
class OAISiteBinding;

class OAIWindowsSite : public OAIObject {
public:
    OAIWindowsSite();
    OAIWindowsSite(QString json);
    ~OAIWindowsSite() override;
    ...
    QList<OAISiteBinding> getBindings() const;
    void setBindings(const QList<OAISiteBinding> &bindings);
...
private:
    ...
    QList<OAISiteBinding> m_bindings;
...
Q_DECLARE_METATYPE(OpenAPI::OAIWindowsSite)

#endif // OAIWindowsSite_H
