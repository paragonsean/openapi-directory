...
public:
    ...
    */
    virtual void getAllSshKeys(const ::OpenAPI::OptionalParam<qint32> &skip = ::OpenAPI::OptionalParam<qint32>(), const ::OpenAPI::OptionalParam<qint32> &take = ::OpenAPI::OptionalParam<qint32>());
...
private:
    ...
    void getAllSshKeysCallback(OAIHttpRequestWorker *worker);

Q_SIGNALS:

    void getAllSshKeysSignal(QList<OAISshKeyDetail> summary);


    void getAllSshKeysSignalFull(OAIHttpRequestWorker *worker, QList<OAISshKeyDetail> summary);

    Q_DECL_DEPRECATED_X("Use getAllSshKeysSignalError() instead")
    void getAllSshKeysSignalE(QList<OAISshKeyDetail> summary, QNetworkReply::NetworkError error_type, QString error_str);
    void getAllSshKeysSignalError(QList<OAISshKeyDetail> summary, QNetworkReply::NetworkError error_type, const QString &error_str);

    Q_DECL_DEPRECATED_X("Use getAllSshKeysSignalErrorFull() instead")
    void getAllSshKeysSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void getAllSshKeysSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
