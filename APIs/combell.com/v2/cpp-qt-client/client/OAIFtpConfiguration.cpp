...
OAIFtpConfiguration::OAIFtpConfiguration(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIFtpConfiguration::OAIFtpConfiguration() {
    this->initializeModel();
}

OAIFtpConfiguration::~OAIFtpConfiguration() {}

void OAIFtpConfiguration::initializeModel() {

    m_enabled_isSet = false;
    m_enabled_isValid = false;
}

void OAIFtpConfiguration::fromJson(QString jsonString) {
...
void OAIFtpConfiguration::fromJsonObject(QJsonObject json) {

    m_enabled_isValid = ::OpenAPI::fromJsonValue(m_enabled, json[QString("enabled")]);
    m_enabled_isSet = !json[QString("enabled")].isNull() && m_enabled_isValid;
}

QString OAIFtpConfiguration::asJson() const {
...
QJsonObject OAIFtpConfiguration::asJsonObject() const {
    QJsonObject obj;
    if (m_enabled_isSet) {
...
bool OAIFtpConfiguration::isEnabled() const {
    return m_enabled;
}
void OAIFtpConfiguration::setEnabled(const bool &enabled) {
    m_enabled = enabled;
    m_enabled_isSet = true;
}

bool OAIFtpConfiguration::is_enabled_Set() const{
    return m_enabled_isSet;
}

bool OAIFtpConfiguration::is_enabled_Valid() const{
    return m_enabled_isValid;
}

bool OAIFtpConfiguration::isSet() const {
...
bool OAIFtpConfiguration::isValid() const {
