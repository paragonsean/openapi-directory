...
#include "OAISslCertificateRequestDetail.h"
...
OAISslCertificateRequestDetail::OAISslCertificateRequestDetail(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISslCertificateRequestDetail::OAISslCertificateRequestDetail() {
    this->initializeModel();
}

OAISslCertificateRequestDetail::~OAISslCertificateRequestDetail() {}

void OAISslCertificateRequestDetail::initializeModel() {
    ...
    m_subject_alt_names_isSet = false;
    m_subject_alt_names_isValid = false;
...
void OAISslCertificateRequestDetail::fromJson(QString jsonString) {
...
void OAISslCertificateRequestDetail::fromJsonObject(QJsonObject json) {
    ...
    m_subject_alt_names_isValid = ::OpenAPI::fromJsonValue(m_subject_alt_names, json[QString("subject_alt_names")]);
    m_subject_alt_names_isSet = !json[QString("subject_alt_names")].isNull() && m_subject_alt_names_isValid;
...
QString OAISslCertificateRequestDetail::asJson() const {
...
QJsonObject OAISslCertificateRequestDetail::asJsonObject() const {
    QJsonObject obj;
    ...
    if (m_subject_alt_names.size() > 0) {
        obj.insert(QString("subject_alt_names"), ::OpenAPI::toJsonValue(m_subject_alt_names));
    }
...
OAISslCertificateType OAISslCertificateRequestDetail::getCertificateType() const {
    return m_certificate_type;
}
void OAISslCertificateRequestDetail::setCertificateType(const OAISslCertificateType &certificate_type) {
    m_certificate_type = certificate_type;
    m_certificate_type_isSet = true;
}

bool OAISslCertificateRequestDetail::is_certificate_type_Set() const{
    return m_certificate_type_isSet;
}

bool OAISslCertificateRequestDetail::is_certificate_type_Valid() const{
    return m_certificate_type_isValid;
}

QString OAISslCertificateRequestDetail::getCommonName() const {
    return m_common_name;
}
void OAISslCertificateRequestDetail::setCommonName(const QString &common_name) {
    m_common_name = common_name;
    m_common_name_isSet = true;
}

bool OAISslCertificateRequestDetail::is_common_name_Set() const{
    return m_common_name_isSet;
}

bool OAISslCertificateRequestDetail::is_common_name_Valid() const{
    return m_common_name_isValid;
}

qint32 OAISslCertificateRequestDetail::getId() const {
    return m_id;
}
void OAISslCertificateRequestDetail::setId(const qint32 &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAISslCertificateRequestDetail::is_id_Set() const{
    return m_id_isSet;
}

bool OAISslCertificateRequestDetail::is_id_Valid() const{
    return m_id_isValid;
}

QString OAISslCertificateRequestDetail::getOrderCode() const {
    return m_order_code;
}
void OAISslCertificateRequestDetail::setOrderCode(const QString &order_code) {
    m_order_code = order_code;
    m_order_code_isSet = true;
}

bool OAISslCertificateRequestDetail::is_order_code_Set() const{
    return m_order_code_isSet;
}

bool OAISslCertificateRequestDetail::is_order_code_Valid() const{
    return m_order_code_isValid;
}

QList<OAISslSubjectAltName> OAISslCertificateRequestDetail::getSubjectAltNames() const {
    return m_subject_alt_names;
}
void OAISslCertificateRequestDetail::setSubjectAltNames(const QList<OAISslSubjectAltName> &subject_alt_names) {
    m_subject_alt_names = subject_alt_names;
    m_subject_alt_names_isSet = true;
}

bool OAISslCertificateRequestDetail::is_subject_alt_names_Set() const{
    return m_subject_alt_names_isSet;
}

bool OAISslCertificateRequestDetail::is_subject_alt_names_Valid() const{
    return m_subject_alt_names_isValid;
}

OAISslCertificateValidationLevel OAISslCertificateRequestDetail::getValidationLevel() const {
    return m_validation_level;
}
void OAISslCertificateRequestDetail::setValidationLevel(const OAISslCertificateValidationLevel &validation_level) {
    m_validation_level = validation_level;
    m_validation_level_isSet = true;
}

bool OAISslCertificateRequestDetail::is_validation_level_Set() const{
    return m_validation_level_isSet;
}

bool OAISslCertificateRequestDetail::is_validation_level_Valid() const{
    return m_validation_level_isValid;
}

QList<OAISslCertificateRequestValidation> OAISslCertificateRequestDetail::getValidations() const {
    return m_validations;
}
void OAISslCertificateRequestDetail::setValidations(const QList<OAISslCertificateRequestValidation> &validations) {
    m_validations = validations;
    m_validations_isSet = true;
}

bool OAISslCertificateRequestDetail::is_validations_Set() const{
    return m_validations_isSet;
}

bool OAISslCertificateRequestDetail::is_validations_Valid() const{
    return m_validations_isValid;
}

OAISslCertificateVendor OAISslCertificateRequestDetail::getVendor() const {
    return m_vendor;
}
void OAISslCertificateRequestDetail::setVendor(const OAISslCertificateVendor &vendor) {
    m_vendor = vendor;
    m_vendor_isSet = true;
}

bool OAISslCertificateRequestDetail::is_vendor_Set() const{
    return m_vendor_isSet;
}

bool OAISslCertificateRequestDetail::is_vendor_Valid() const{
    return m_vendor_isValid;
}

bool OAISslCertificateRequestDetail::isSet() const {
...
bool OAISslCertificateRequestDetail::isValid() const {
