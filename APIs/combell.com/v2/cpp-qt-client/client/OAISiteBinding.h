...
#ifndef OAISiteBinding_H
#define OAISiteBinding_H
...
class OAISiteBinding : public OAIObject {
public:
    OAISiteBinding();
    OAISiteBinding(QString json);
    ~OAISiteBinding() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISiteBinding)

#endif // OAISiteBinding_H
