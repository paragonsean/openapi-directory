...
#ifndef OAIMailZone_H
#define OAIMailZone_H

#include <QJsonObject>

#include "OAIAlias.h"
#include "OAIAntiSpam.h"
#include "OAICatchAll.h"
#include "OAIMailZoneAccount.h"
#include "OAISmtpDomain.h"
#include <QList>
#include <QString>
...
class OAIAlias;
class OAIAntiSpam;
class OAIMailZoneAccount;
class OAICatchAll;
class OAISmtpDomain;

class OAIMailZone : public OAIObject {
public:
    OAIMailZone();
    OAIMailZone(QString json);
    ~OAIMailZone() override;
    ...
    OAIAntiSpam getAntiSpam() const;
    void setAntiSpam(const OAIAntiSpam &anti_spam);
    bool is_anti_spam_Set() const;
    bool is_anti_spam_Valid() const;

    QList<OAIMailZoneAccount> getAvailableAccounts() const;
    void setAvailableAccounts(const QList<OAIMailZoneAccount> &available_accounts);
    bool is_available_accounts_Set() const;
    bool is_available_accounts_Valid() const;

    OAICatchAll getCatchAll() const;
    void setCatchAll(const OAICatchAll &catch_all);
    ...
    QList<OAISmtpDomain> getSmtpDomains() const;
    void setSmtpDomains(const QList<OAISmtpDomain> &smtp_domains);
    bool is_smtp_domains_Set() const;
    bool is_smtp_domains_Valid() const;
...
private:
    ...
    OAIAntiSpam m_anti_spam;
    bool m_anti_spam_isSet;
    bool m_anti_spam_isValid;

    QList<OAIMailZoneAccount> m_available_accounts;
    bool m_available_accounts_isSet;
    bool m_available_accounts_isValid;

    OAICatchAll m_catch_all;
    ...
    QList<OAISmtpDomain> m_smtp_domains;
    bool m_smtp_domains_isSet;
    bool m_smtp_domains_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIMailZone)
