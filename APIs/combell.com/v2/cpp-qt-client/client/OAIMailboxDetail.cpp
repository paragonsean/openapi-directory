...
OAIMailboxDetail::OAIMailboxDetail(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIMailboxDetail::OAIMailboxDetail() {
    this->initializeModel();
}

OAIMailboxDetail::~OAIMailboxDetail() {}

void OAIMailboxDetail::initializeModel() {

    m_actual_size_isSet = false;
    m_actual_size_isValid = false;

    m_auto_forward_isSet = false;
    m_auto_forward_isValid = false;

    m_auto_reply_isSet = false;
    m_auto_reply_isValid = false;
...
void OAIMailboxDetail::fromJson(QString jsonString) {
...
void OAIMailboxDetail::fromJsonObject(QJsonObject json) {
    ...
    m_auto_forward_isValid = ::OpenAPI::fromJsonValue(m_auto_forward, json[QString("auto_forward")]);
    m_auto_forward_isSet = !json[QString("auto_forward")].isNull() && m_auto_forward_isValid;

    m_auto_reply_isValid = ::OpenAPI::fromJsonValue(m_auto_reply, json[QString("auto_reply")]);
    m_auto_reply_isSet = !json[QString("auto_reply")].isNull() && m_auto_reply_isValid;
...
QString OAIMailboxDetail::asJson() const {
...
QJsonObject OAIMailboxDetail::asJsonObject() const {
    QJsonObject obj;
    if (m_actual_size_isSet) {
        obj.insert(QString("actual_size"), ::OpenAPI::toJsonValue(m_actual_size));
    }
    if (m_auto_forward.isSet()) {
        obj.insert(QString("auto_forward"), ::OpenAPI::toJsonValue(m_auto_forward));
    }
    if (m_auto_reply.isSet()) {
        obj.insert(QString("auto_reply"), ::OpenAPI::toJsonValue(m_auto_reply));
    }
    if (m_login_isSet) {
...
qint32 OAIMailboxDetail::getActualSize() const {
    return m_actual_size;
}
void OAIMailboxDetail::setActualSize(const qint32 &actual_size) {
    m_actual_size = actual_size;
    m_actual_size_isSet = true;
}

bool OAIMailboxDetail::is_actual_size_Set() const{
    return m_actual_size_isSet;
}

bool OAIMailboxDetail::is_actual_size_Valid() const{
    return m_actual_size_isValid;
}

OAIAutoForward OAIMailboxDetail::getAutoForward() const {
    return m_auto_forward;
}
void OAIMailboxDetail::setAutoForward(const OAIAutoForward &auto_forward) {
    m_auto_forward = auto_forward;
    m_auto_forward_isSet = true;
}

bool OAIMailboxDetail::is_auto_forward_Set() const{
    return m_auto_forward_isSet;
}

bool OAIMailboxDetail::is_auto_forward_Valid() const{
    return m_auto_forward_isValid;
}

OAIAutoReply OAIMailboxDetail::getAutoReply() const {
    return m_auto_reply;
}
void OAIMailboxDetail::setAutoReply(const OAIAutoReply &auto_reply) {
    m_auto_reply = auto_reply;
    m_auto_reply_isSet = true;
}

bool OAIMailboxDetail::is_auto_reply_Set() const{
    return m_auto_reply_isSet;
}

bool OAIMailboxDetail::is_auto_reply_Valid() const{
    return m_auto_reply_isValid;
}

QString OAIMailboxDetail::getLogin() const {
    return m_login;
}
void OAIMailboxDetail::setLogin(const QString &login) {
    m_login = login;
    m_login_isSet = true;
}

bool OAIMailboxDetail::is_login_Set() const{
    return m_login_isSet;
}

bool OAIMailboxDetail::is_login_Valid() const{
    return m_login_isValid;
}

qint32 OAIMailboxDetail::getMaxSize() const {
    return m_max_size;
}
void OAIMailboxDetail::setMaxSize(const qint32 &max_size) {
    m_max_size = max_size;
    m_max_size_isSet = true;
}

bool OAIMailboxDetail::is_max_size_Set() const{
    return m_max_size_isSet;
}

bool OAIMailboxDetail::is_max_size_Valid() const{
    return m_max_size_isValid;
}

QString OAIMailboxDetail::getName() const {
    return m_name;
}
void OAIMailboxDetail::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIMailboxDetail::is_name_Set() const{
    return m_name_isSet;
}

bool OAIMailboxDetail::is_name_Valid() const{
    return m_name_isValid;
}

bool OAIMailboxDetail::isSet() const {
...
bool OAIMailboxDetail::isValid() const {
