...
OAIUpdateUserPasswordRequest::OAIUpdateUserPasswordRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateUserPasswordRequest::OAIUpdateUserPasswordRequest() {
    this->initializeModel();
}

OAIUpdateUserPasswordRequest::~OAIUpdateUserPasswordRequest() {}

void OAIUpdateUserPasswordRequest::initializeModel() {

    m_password_isSet = false;
    m_password_isValid = false;
}

void OAIUpdateUserPasswordRequest::fromJson(QString jsonString) {
...
void OAIUpdateUserPasswordRequest::fromJsonObject(QJsonObject json) {

    m_password_isValid = ::OpenAPI::fromJsonValue(m_password, json[QString("password")]);
    m_password_isSet = !json[QString("password")].isNull() && m_password_isValid;
}

QString OAIUpdateUserPasswordRequest::asJson() const {
...
QJsonObject OAIUpdateUserPasswordRequest::asJsonObject() const {
    QJsonObject obj;
    if (m_password_isSet) {
...
QString OAIUpdateUserPasswordRequest::getPassword() const {
    return m_password;
}
void OAIUpdateUserPasswordRequest::setPassword(const QString &password) {
    m_password = password;
    m_password_isSet = true;
}

bool OAIUpdateUserPasswordRequest::is_password_Set() const{
    return m_password_isSet;
}

bool OAIUpdateUserPasswordRequest::is_password_Valid() const{
    return m_password_isValid;
}

bool OAIUpdateUserPasswordRequest::isSet() const {
...
bool OAIUpdateUserPasswordRequest::isValid() const {
