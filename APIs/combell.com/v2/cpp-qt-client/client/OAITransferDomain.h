...
#ifndef OAITransferDomain_H
#define OAITransferDomain_H
...
namespace OpenAPI {
class OAIRegistrantInput;

class OAITransferDomain : public OAIObject {
public:
    OAITransferDomain();
    OAITransferDomain(QString json);
    ~OAITransferDomain() override;
    ...
    OAIRegistrantInput getRegistrant() const;
    void setRegistrant(const OAIRegistrantInput &registrant);
    bool is_registrant_Set() const;
    bool is_registrant_Valid() const;
...
private:
    ...
    OAIRegistrantInput m_registrant;
    bool m_registrant_isSet;
    bool m_registrant_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAITransferDomain)

#endif // OAITransferDomain_H
