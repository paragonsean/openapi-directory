...
#ifndef OAIAntiSpam_H
#define OAIAntiSpam_H
...
class OAIAntiSpam : public OAIObject {
public:
    OAIAntiSpam();
    OAIAntiSpam(QString json);
    ~OAIAntiSpam() override;
    ...
    QList<OAIAntiSpamTypes> getAllowedTypes() const;
    void setAllowedTypes(const QList<OAIAntiSpamTypes> &allowed_types);
    bool is_allowed_types_Set() const;
    bool is_allowed_types_Valid() const;

    OAIAntiSpamTypes getType() const;
    void setType(const OAIAntiSpamTypes &type);
...
private:
    ...
    QList<OAIAntiSpamTypes> m_allowed_types;
    bool m_allowed_types_isSet;
    bool m_allowed_types_isValid;

    OAIAntiSpamTypes m_type;
    bool m_type_isSet;
    bool m_type_isValid;
};
...
Q_DECLARE_METATYPE(OpenAPI::OAIAntiSpam)
