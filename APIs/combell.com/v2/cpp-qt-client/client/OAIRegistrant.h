...
public:
    ...
    QString getEnterpriseNumber() const;
    void setEnterpriseNumber(const QString &enterprise_number);
    bool is_enterprise_number_Set() const;
    bool is_enterprise_number_Valid() const;
...
private:
    ...
    QString m_enterprise_number;
    bool m_enterprise_number_isSet;
    bool m_enterprise_number_isValid;
