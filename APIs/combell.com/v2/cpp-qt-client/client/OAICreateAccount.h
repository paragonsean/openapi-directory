...
#ifndef OAICreateAccount_H
#define OAICreateAccount_H
...
class OAICreateAccount : public OAIObject {
public:
    OAICreateAccount();
    OAICreateAccount(QString json);
    ~OAICreateAccount() override;
    ...
    qint32 getServicepackId() const;
    void setServicepackId(const qint32 &servicepack_id);
    bool is_servicepack_id_Set() const;
    bool is_servicepack_id_Valid() const;
...
private:
    ...
    qint32 m_servicepack_id;
    bool m_servicepack_id_isSet;
    bool m_servicepack_id_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAICreateAccount)

#endif // OAICreateAccount_H
