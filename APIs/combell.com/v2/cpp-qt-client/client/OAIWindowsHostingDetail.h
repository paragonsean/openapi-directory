...
/*
 * OAIWindowsHostingDetail.h
 *
 * 
 */

#ifndef OAIWindowsHostingDetail_H
#define OAIWindowsHostingDetail_H

#include <QJsonObject>

#include "OAIApplicationPool.h"
#include "OAIWindowsIpType.h"
...
namespace OpenAPI {
class OAIApplicationPool;
class OAIWindowsSite;

class OAIWindowsHostingDetail : public OAIObject {
public:
    OAIWindowsHostingDetail();
    OAIWindowsHostingDetail(QString json);
    ~OAIWindowsHostingDetail() override;
    ...
    qint32 getActualSize() const;
    void setActualSize(const qint32 &actual_size);
    bool is_actual_size_Set() const;
    bool is_actual_size_Valid() const;

    OAIApplicationPool getApplicationPool() const;
    void setApplicationPool(const OAIApplicationPool &application_pool);
    bool is_application_pool_Set() const;
    bool is_application_pool_Valid() const;
    ...
    OAIWindowsIpType getIpType() const;
    void setIpType(const OAIWindowsIpType &ip_type);
    ...
    QList<QString> getMssqlDatabaseNames() const;
    void setMssqlDatabaseNames(const QList<QString> &mssql_database_names);
    bool is_mssql_database_names_Set() const;
    bool is_mssql_database_names_Valid() const;
    ...
    QList<OAIWindowsSite> getSites() const;
    void setSites(const QList<OAIWindowsSite> &sites);
...
private:
    ...
    qint32 m_actual_size;
    bool m_actual_size_isSet;
    bool m_actual_size_isValid;

    OAIApplicationPool m_application_pool;
    bool m_application_pool_isSet;
    bool m_application_pool_isValid;
    ...
    QList<QString> m_mssql_database_names;
    bool m_mssql_database_names_isSet;
    bool m_mssql_database_names_isValid;

    qint32 m_servicepack_id;
    bool m_servicepack_id_isSet;
    bool m_servicepack_id_isValid;

    QList<OAIWindowsSite> m_sites;
    bool m_sites_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIWindowsHostingDetail)

#endif // OAIWindowsHostingDetail_H
