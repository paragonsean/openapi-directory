...
OAIEditDomainWillRenewRequest::OAIEditDomainWillRenewRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIEditDomainWillRenewRequest::OAIEditDomainWillRenewRequest() {
    this->initializeModel();
}

OAIEditDomainWillRenewRequest::~OAIEditDomainWillRenewRequest() {}

void OAIEditDomainWillRenewRequest::initializeModel() {

    m_will_renew_isSet = false;
    m_will_renew_isValid = false;
}

void OAIEditDomainWillRenewRequest::fromJson(QString jsonString) {
...
void OAIEditDomainWillRenewRequest::fromJsonObject(QJsonObject json) {
...
QString OAIEditDomainWillRenewRequest::asJson() const {
...
QJsonObject OAIEditDomainWillRenewRequest::asJsonObject() const {
    QJsonObject obj;
...
bool OAIEditDomainWillRenewRequest::isWillRenew() const {
    return m_will_renew;
}
void OAIEditDomainWillRenewRequest::setWillRenew(const bool &will_renew) {
    m_will_renew = will_renew;
    m_will_renew_isSet = true;
}

bool OAIEditDomainWillRenewRequest::is_will_renew_Set() const{
    return m_will_renew_isSet;
}

bool OAIEditDomainWillRenewRequest::is_will_renew_Valid() const{
    return m_will_renew_isValid;
}

bool OAIEditDomainWillRenewRequest::isSet() const {
...
bool OAIEditDomainWillRenewRequest::isValid() const {
