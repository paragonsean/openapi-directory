...
/*
 * OAIEditNameServers.h
 *
 * 
 */

#ifndef OAIEditNameServers_H
#define OAIEditNameServers_H
...
class OAIEditNameServers : public OAIObject {
public:
    OAIEditNameServers();
    OAIEditNameServers(QString json);
    ~OAIEditNameServers() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEditNameServers)

#endif // OAIEditNameServers_H
