...
#ifndef OAIAutoForward_H
#define OAIAutoForward_H
...
class OAIAutoForward : public OAIObject {
public:
    OAIAutoForward();
    OAIAutoForward(QString json);
    ~OAIAutoForward() override;
    ...
    bool isCopyToMyself() const;
    void setCopyToMyself(const bool &copy_to_myself);
    bool is_copy_to_myself_Set() const;
    bool is_copy_to_myself_Valid() const;
...
private:
    ...
    bool m_copy_to_myself;
    bool m_copy_to_myself_isSet;
    bool m_copy_to_myself_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAutoForward)

#endif // OAIAutoForward_H
