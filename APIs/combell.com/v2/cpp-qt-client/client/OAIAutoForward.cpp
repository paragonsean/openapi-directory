...
OAIAutoForward::OAIAutoForward(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAutoForward::OAIAutoForward() {
    this->initializeModel();
}

OAIAutoForward::~OAIAutoForward() {}

void OAIAutoForward::initializeModel() {

    m_copy_to_myself_isSet = false;
    m_copy_to_myself_isValid = false;
...
void OAIAutoForward::fromJson(QString jsonString) {
...
void OAIAutoForward::fromJsonObject(QJsonObject json) {

    m_copy_to_myself_isValid = ::OpenAPI::fromJsonValue(m_copy_to_myself, json[QString("copy_to_myself")]);
    m_copy_to_myself_isSet = !json[QString("copy_to_myself")].isNull() && m_copy_to_myself_isValid;
...
QString OAIAutoForward::asJson() const {
...
QJsonObject OAIAutoForward::asJsonObject() const {
    QJsonObject obj;
    if (m_copy_to_myself_isSet) {
        obj.insert(QString("copy_to_myself"), ::OpenAPI::toJsonValue(m_copy_to_myself));
    }
...
bool OAIAutoForward::isCopyToMyself() const {
    return m_copy_to_myself;
}
void OAIAutoForward::setCopyToMyself(const bool &copy_to_myself) {
    m_copy_to_myself = copy_to_myself;
    m_copy_to_myself_isSet = true;
}

bool OAIAutoForward::is_copy_to_myself_Set() const{
    return m_copy_to_myself_isSet;
}

bool OAIAutoForward::is_copy_to_myself_Valid() const{
    return m_copy_to_myself_isValid;
}

QList<QString> OAIAutoForward::getEmailAddresses() const {
    return m_email_addresses;
}
void OAIAutoForward::setEmailAddresses(const QList<QString> &email_addresses) {
    m_email_addresses = email_addresses;
    m_email_addresses_isSet = true;
}

bool OAIAutoForward::is_email_addresses_Set() const{
    return m_email_addresses_isSet;
}

bool OAIAutoForward::is_email_addresses_Valid() const{
    return m_email_addresses_isValid;
}

bool OAIAutoForward::isEnabled() const {
    return m_enabled;
}
void OAIAutoForward::setEnabled(const bool &enabled) {
    m_enabled = enabled;
    m_enabled_isSet = true;
}

bool OAIAutoForward::is_enabled_Set() const{
    return m_enabled_isSet;
}

bool OAIAutoForward::is_enabled_Valid() const{
    return m_enabled_isValid;
}

bool OAIAutoForward::isSet() const {
...
bool OAIAutoForward::isValid() const {
