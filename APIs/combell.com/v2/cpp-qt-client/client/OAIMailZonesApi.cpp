...
OAIMailZonesApi::OAIMailZonesApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAIMailZonesApi::~OAIMailZonesApi() {
}

void OAIMailZonesApi::initializeServerConfigs() {
    //Default server
    ...
    _serverConfigs.insert("configureAlias", defaultConf);
    _serverIndices.insert("configureAlias", 0);
    _serverConfigs.insert("configureAntiSpam", defaultConf);
    _serverIndices.insert("configureAntiSpam", 0);
    _serverConfigs.insert("configureSmtpDomain", defaultConf);
    _serverIndices.insert("configureSmtpDomain", 0);
    _serverConfigs.insert("createAlias", defaultConf);
    _serverIndices.insert("createAlias", 0);
    _serverConfigs.insert("createCatchAll", defaultConf);
    _serverIndices.insert("createCatchAll", 0);
    _serverConfigs.insert("createSmtpDomain", defaultConf);
    _serverIndices.insert("createSmtpDomain", 0);
    _serverConfigs.insert("deleteAlias", defaultConf);
    _serverIndices.insert("deleteAlias", 0);
    _serverConfigs.insert("deleteCatchAll", defaultConf);
    _serverIndices.insert("deleteCatchAll", 0);
    _serverConfigs.insert("deleteSmtpDomain", defaultConf);
    _serverIndices.insert("deleteSmtpDomain", 0);
    _serverConfigs.insert("getMailZone", defaultConf);
    _serverIndices.insert("getMailZone", 0);
}
...
*/
int OAIMailZonesApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAIMailZonesApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAIMailZonesApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAIMailZonesApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAIMailZonesApi::setUsername(const QString &username) {
    _username = username;
}

void OAIMailZonesApi::setPassword(const QString &password) {
    _password = password;
}


void OAIMailZonesApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAIMailZonesApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAIMailZonesApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAIMailZonesApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAIMailZonesApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAIMailZonesApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAIMailZonesApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAIMailZonesApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAIMailZonesApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAIMailZonesApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAIMailZonesApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAIMailZonesApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAIMailZonesApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAIMailZonesApi::configureAlias(const QString &domain_name, const QString &email_address, const QString &domain_name2, const QString &email_address2, const ::OpenAPI::OptionalParam<OAIUpdateAliasRequest> &oai_update_alias_request) {
    QString fullPath = QString(_serverConfigs["configureAlias"][_serverIndices.value("configureAlias")].URL()+"/mailzones/{domainName}/aliases/{emailAddress}");
    ...
    {
        QString email_address2PathParam("{");
        email_address2PathParam.append("emailAddress").append("}");
        QString pathPrefix, pathSuffix, pathDelimiter;
        QString pathStyle = "simple";
        if (pathStyle == "")
            pathStyle = "simple";
        ...
        fullPath.replace(email_address2PathParam, paramString+QUrl::toPercentEncoding(::OpenAPI::toStringValue(email_address2)));
    }
    ...
    
    {
        ...
        fullPath.append(QUrl::toPercentEncoding("email_address")).append(querySuffix).append(QUrl::toPercentEncoding(email_address));
    }
    ...
    if (oai_update_alias_request.hasValue()){

        
        QByteArray output = oai_update_alias_request.value().asJson().toUtf8();
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIMailZonesApi::configureAliasCallback);
    connect(this, &OAIMailZonesApi::abortRequestsSignal, worker, &QObject::deleteLater);
...
void OAIMailZonesApi::configureAliasCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT configureAliasSignal();
        Q_EMIT configureAliasSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT configureAliasSignalE(error_type, error_str);
        Q_EMIT configureAliasSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT configureAliasSignalError(error_type, error_str);
        Q_EMIT configureAliasSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIMailZonesApi::configureAntiSpam(const QString &domain_name, const QString &domain_name2, const ::OpenAPI::OptionalParam<OAIUpdateAntiSpamRequest> &oai_update_anti_spam_request) {
    QString fullPath = QString(_serverConfigs["configureAntiSpam"][_serverIndices.value("configureAntiSpam")].URL()+"/mailzones/{domainName}/antispam");
    ...
    if (oai_update_anti_spam_request.hasValue()){

        
        QByteArray output = oai_update_anti_spam_request.value().asJson().toUtf8();
        input.request_body.append(output);
    }
    for (auto keyValueIt = _defaultHeaders.keyValueBegin(); keyValueIt != _defaultHeaders.keyValueEnd(); keyValueIt++) {
        input.headers.insert(keyValueIt->first, keyValueIt->second);
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIMailZonesApi::configureAntiSpamCallback);
    connect(this, &OAIMailZonesApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIMailZonesApi::configureAntiSpamCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT configureAntiSpamSignal();
        Q_EMIT configureAntiSpamSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT configureAntiSpamSignalE(error_type, error_str);
        Q_EMIT configureAntiSpamSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT configureAntiSpamSignalError(error_type, error_str);
        Q_EMIT configureAntiSpamSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIMailZonesApi::configureSmtpDomain(const QString &domain_name, const QString &hostname, const QString &domain_name2, const ::OpenAPI::OptionalParam<OAIUpdateSmtpDomainRequest> &oai_update_smtp_domain_request) {
    QString fullPath = QString(_serverConfigs["configureSmtpDomain"][_serverIndices.value("configureSmtpDomain")].URL()+"/mailzones/{domainName}/smtpdomains/{hostname}");
    ...
    if (oai_update_smtp_domain_request.hasValue()){

        
        QByteArray output = oai_update_smtp_domain_request.value().asJson().toUtf8();
        input.request_body.append(output);
    }
    for (auto keyValueIt = _defaultHeaders.keyValueBegin(); keyValueIt != _defaultHeaders.keyValueEnd(); keyValueIt++) {
        input.headers.insert(keyValueIt->first, keyValueIt->second);
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIMailZonesApi::configureSmtpDomainCallback);
    connect(this, &OAIMailZonesApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIMailZonesApi::configureSmtpDomainCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT configureSmtpDomainSignal();
        Q_EMIT configureSmtpDomainSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT configureSmtpDomainSignalE(error_type, error_str);
        Q_EMIT configureSmtpDomainSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT configureSmtpDomainSignalError(error_type, error_str);
        Q_EMIT configureSmtpDomainSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIMailZonesApi::createAlias(const QString &domain_name, const QString &domain_name2, const ::OpenAPI::OptionalParam<OAICreateAliasRequest> &oai_create_alias_request) {
    QString fullPath = QString(_serverConfigs["createAlias"][_serverIndices.value("createAlias")].URL()+"/mailzones/{domainName}/aliases");
    ...
    if (oai_create_alias_request.hasValue()){

        
        QByteArray output = oai_create_alias_request.value().asJson().toUtf8();
        input.request_body.append(output);
    }
    for (auto keyValueIt = _defaultHeaders.keyValueBegin(); keyValueIt != _defaultHeaders.keyValueEnd(); keyValueIt++) {
        input.headers.insert(keyValueIt->first, keyValueIt->second);
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIMailZonesApi::createAliasCallback);
    connect(this, &OAIMailZonesApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIMailZonesApi::createAliasCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
...
void OAIMailZonesApi::createCatchAll(const QString &domain_name, const QString &domain_name2, const ::OpenAPI::OptionalParam<OAICreateCatchAllRequest> &oai_create_catch_all_request) {
    QString fullPath = QString(_serverConfigs["createCatchAll"][_serverIndices.value("createCatchAll")].URL()+"/mailzones/{domainName}/catchall");
    ...
    if (oai_create_catch_all_request.hasValue()){

        
        QByteArray output = oai_create_catch_all_request.value().asJson().toUtf8();
        input.request_body.append(output);
    }
    for (auto keyValueIt = _defaultHeaders.keyValueBegin(); keyValueIt != _defaultHeaders.keyValueEnd(); keyValueIt++) {
        input.headers.insert(keyValueIt->first, keyValueIt->second);
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIMailZonesApi::createCatchAllCallback);
    connect(this, &OAIMailZonesApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIMailZonesApi::createCatchAllCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT createCatchAllSignal();
        Q_EMIT createCatchAllSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT createCatchAllSignalE(error_type, error_str);
        Q_EMIT createCatchAllSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT createCatchAllSignalError(error_type, error_str);
        Q_EMIT createCatchAllSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIMailZonesApi::createSmtpDomain(const QString &domain_name, const QString &domain_name2, const ::OpenAPI::OptionalParam<OAICreateSmtpDomainRequest> &oai_create_smtp_domain_request) {
    QString fullPath = QString(_serverConfigs["createSmtpDomain"][_serverIndices.value("createSmtpDomain")].URL()+"/mailzones/{domainName}/smtpdomains");
    ...
    if (oai_create_smtp_domain_request.hasValue()){

        
        QByteArray output = oai_create_smtp_domain_request.value().asJson().toUtf8();
        input.request_body.append(output);
    }
    for (auto keyValueIt = _defaultHeaders.keyValueBegin(); keyValueIt != _defaultHeaders.keyValueEnd(); keyValueIt++) {
        input.headers.insert(keyValueIt->first, keyValueIt->second);
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIMailZonesApi::createSmtpDomainCallback);
    connect(this, &OAIMailZonesApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIMailZonesApi::createSmtpDomainCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT createSmtpDomainSignal();
        Q_EMIT createSmtpDomainSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT createSmtpDomainSignalE(error_type, error_str);
        Q_EMIT createSmtpDomainSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT createSmtpDomainSignalError(error_type, error_str);
        Q_EMIT createSmtpDomainSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIMailZonesApi::deleteAlias(const QString &domain_name, const QString &email_address, const QString &domain_name2, const QString &email_address2) {
    QString fullPath = QString(_serverConfigs["deleteAlias"][_serverIndices.value("deleteAlias")].URL()+"/mailzones/{domainName}/aliases/{emailAddress}");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIMailZonesApi::deleteAliasCallback);
    connect(this, &OAIMailZonesApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIMailZonesApi::deleteAliasCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
...
void OAIMailZonesApi::deleteCatchAll(const QString &domain_name, const QString &email_address, const QString &domain_name2, const QString &email_address2) {
    QString fullPath = QString(_serverConfigs["deleteCatchAll"][_serverIndices.value("deleteCatchAll")].URL()+"/mailzones/{domainName}/catchall/{emailAddress}");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIMailZonesApi::deleteCatchAllCallback);
    connect(this, &OAIMailZonesApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIMailZonesApi::deleteCatchAllCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT deleteCatchAllSignal();
        Q_EMIT deleteCatchAllSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT deleteCatchAllSignalE(error_type, error_str);
        Q_EMIT deleteCatchAllSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT deleteCatchAllSignalError(error_type, error_str);
        Q_EMIT deleteCatchAllSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIMailZonesApi::deleteSmtpDomain(const QString &domain_name, const QString &hostname, const QString &domain_name2) {
    QString fullPath = QString(_serverConfigs["deleteSmtpDomain"][_serverIndices.value("deleteSmtpDomain")].URL()+"/mailzones/{domainName}/smtpdomains/{hostname}");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIMailZonesApi::deleteSmtpDomainCallback);
    connect(this, &OAIMailZonesApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIMailZonesApi::deleteSmtpDomainCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT deleteSmtpDomainSignal();
        Q_EMIT deleteSmtpDomainSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT deleteSmtpDomainSignalE(error_type, error_str);
        Q_EMIT deleteSmtpDomainSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT deleteSmtpDomainSignalError(error_type, error_str);
        Q_EMIT deleteSmtpDomainSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIMailZonesApi::getMailZone(const QString &domain_name, const QString &domain_name2) {
    QString fullPath = QString(_serverConfigs["getMailZone"][_serverIndices.value("getMailZone")].URL()+"/mailzones/{domainName}");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIMailZonesApi::getMailZoneCallback);
    connect(this, &OAIMailZonesApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIMailZonesApi::getMailZoneCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    OAIMailZone output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT getMailZoneSignal(output);
        Q_EMIT getMailZoneSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT getMailZoneSignalE(output, error_type, error_str);
        Q_EMIT getMailZoneSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT getMailZoneSignalError(output, error_type, error_str);
        Q_EMIT getMailZoneSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIMailZonesApi::tokenAvailable(){
