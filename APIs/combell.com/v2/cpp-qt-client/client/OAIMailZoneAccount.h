...
/*
 * OAIMailZoneAccount.h
 *
 * 
 */

#ifndef OAIMailZoneAccount_H
#define OAIMailZoneAccount_H
...
class OAIMailZoneAccount : public OAIObject {
public:
    OAIMailZoneAccount();
    OAIMailZoneAccount(QString json);
    ~OAIMailZoneAccount() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMailZoneAccount)

#endif // OAIMailZoneAccount_H
