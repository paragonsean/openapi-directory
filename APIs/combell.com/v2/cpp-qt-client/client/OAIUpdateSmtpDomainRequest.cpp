...
OAIUpdateSmtpDomainRequest::OAIUpdateSmtpDomainRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateSmtpDomainRequest::OAIUpdateSmtpDomainRequest() {
    this->initializeModel();
}

OAIUpdateSmtpDomainRequest::~OAIUpdateSmtpDomainRequest() {}

void OAIUpdateSmtpDomainRequest::initializeModel() {

    m_enabled_isSet = false;
    m_enabled_isValid = false;
}

void OAIUpdateSmtpDomainRequest::fromJson(QString jsonString) {
...
void OAIUpdateSmtpDomainRequest::fromJsonObject(QJsonObject json) {

    m_enabled_isValid = ::OpenAPI::fromJsonValue(m_enabled, json[QString("enabled")]);
    m_enabled_isSet = !json[QString("enabled")].isNull() && m_enabled_isValid;
}

QString OAIUpdateSmtpDomainRequest::asJson() const {
...
QJsonObject OAIUpdateSmtpDomainRequest::asJsonObject() const {
    QJsonObject obj;
    if (m_enabled_isSet) {
...
bool OAIUpdateSmtpDomainRequest::isEnabled() const {
    return m_enabled;
}
void OAIUpdateSmtpDomainRequest::setEnabled(const bool &enabled) {
    m_enabled = enabled;
    m_enabled_isSet = true;
}

bool OAIUpdateSmtpDomainRequest::is_enabled_Set() const{
    return m_enabled_isSet;
}

bool OAIUpdateSmtpDomainRequest::is_enabled_Valid() const{
    return m_enabled_isValid;
}

bool OAIUpdateSmtpDomainRequest::isSet() const {
...
bool OAIUpdateSmtpDomainRequest::isValid() const {
