...
QList<OAIValidationErrorMessage> OAIBadRequestResponse::getValidationErrors() const {
    return m_validation_errors;
}
void OAIBadRequestResponse::setValidationErrors(const QList<OAIValidationErrorMessage> &validation_errors) {
    m_validation_errors = validation_errors;
    m_validation_errors_isSet = true;
}

bool OAIBadRequestResponse::is_validation_errors_Set() const{
    return m_validation_errors_isSet;
}

bool OAIBadRequestResponse::is_validation_errors_Valid() const{
