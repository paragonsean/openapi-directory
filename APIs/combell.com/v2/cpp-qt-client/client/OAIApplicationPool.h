...
/*
 * OAIApplicationPool.h
 *
 * The application pool for the hosting account.
 */

#ifndef OAIApplicationPool_H
#define OAIApplicationPool_H
...
class OAIApplicationPool : public OAIObject {
public:
    OAIApplicationPool();
    OAIApplicationPool(QString json);
    ~OAIApplicationPool() override;
    ...
    QList<QString> getInstalledNetCoreRuntimes() const;
    void setInstalledNetCoreRuntimes(const QList<QString> &installed_net_core_runtimes);
    bool is_installed_net_core_runtimes_Set() const;
    bool is_installed_net_core_runtimes_Valid() const;

    QString getPipelineMode() const;
    void setPipelineMode(const QString &pipeline_mode);
    bool is_pipeline_mode_Set() const;
    bool is_pipeline_mode_Valid() const;
...
private:
    ...
    QList<QString> m_installed_net_core_runtimes;
    bool m_installed_net_core_runtimes_isSet;
    bool m_installed_net_core_runtimes_isValid;

    QString m_pipeline_mode;
    bool m_pipeline_mode_isSet;
    bool m_pipeline_mode_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIApplicationPool)

#endif // OAIApplicationPool_H
