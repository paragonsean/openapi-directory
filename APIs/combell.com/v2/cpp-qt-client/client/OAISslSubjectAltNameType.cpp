...
#include "OAISslSubjectAltNameType.h"
...
OAISslSubjectAltNameType::OAISslSubjectAltNameType(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISslSubjectAltNameType::OAISslSubjectAltNameType() {
    this->initializeModel();
}

OAISslSubjectAltNameType::~OAISslSubjectAltNameType() {}

void OAISslSubjectAltNameType::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAISslSubjectAltNameType::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAISslSubjectAltNameType::fromJson(QString jsonString) {
    
    if ( jsonString.compare("dns", Qt::CaseInsensitive) == 0) {
        m_value = eOAISslSubjectAltNameType::DNS;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("ip", Qt::CaseInsensitive) == 0) {
        m_value = eOAISslSubjectAltNameType::IP;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAISslSubjectAltNameType::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAISslSubjectAltNameType::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAISslSubjectAltNameType::DNS:
            val = "dns";
            break;
        case eOAISslSubjectAltNameType::IP:
            val = "ip";
            break;
        default:
            break;
...
QJsonValue OAISslSubjectAltNameType::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAISslSubjectAltNameType::eOAISslSubjectAltNameType OAISslSubjectAltNameType::getValue() const {
    return m_value;
}

void OAISslSubjectAltNameType::setValue(const OAISslSubjectAltNameType::eOAISslSubjectAltNameType& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAISslSubjectAltNameType::isSet() const {
    
    return m_value_isSet;
}

bool OAISslSubjectAltNameType::isValid() const {
