...
OAIWindowsSite::OAIWindowsSite(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIWindowsSite::OAIWindowsSite() {
    this->initializeModel();
}

OAIWindowsSite::~OAIWindowsSite() {}

void OAIWindowsSite::initializeModel() {
...
void OAIWindowsSite::fromJson(QString jsonString) {
...
void OAIWindowsSite::fromJsonObject(QJsonObject json) {
...
QString OAIWindowsSite::asJson() const {
...
QJsonObject OAIWindowsSite::asJsonObject() const {
    QJsonObject obj;
...
QList<OAISiteBinding> OAIWindowsSite::getBindings() const {
    return m_bindings;
}
void OAIWindowsSite::setBindings(const QList<OAISiteBinding> &bindings) {
    m_bindings = bindings;
    m_bindings_isSet = true;
}

bool OAIWindowsSite::is_bindings_Set() const{
    return m_bindings_isSet;
}

bool OAIWindowsSite::is_bindings_Valid() const{
    return m_bindings_isValid;
}

QString OAIWindowsSite::getName() const {
    return m_name;
}
void OAIWindowsSite::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIWindowsSite::is_name_Set() const{
    return m_name_isSet;
}

bool OAIWindowsSite::is_name_Valid() const{
    return m_name_isValid;
}

QString OAIWindowsSite::getPath() const {
    return m_path;
}
void OAIWindowsSite::setPath(const QString &path) {
    m_path = path;
    m_path_isSet = true;
}

bool OAIWindowsSite::is_path_Set() const{
    return m_path_isSet;
}

bool OAIWindowsSite::is_path_Valid() const{
    return m_path_isValid;
}

bool OAIWindowsSite::isSet() const {
...
bool OAIWindowsSite::isValid() const {
