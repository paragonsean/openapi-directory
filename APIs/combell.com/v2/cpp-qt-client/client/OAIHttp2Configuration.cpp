...
#include "OAIHttp2Configuration.h"
...
OAIHttp2Configuration::OAIHttp2Configuration(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIHttp2Configuration::OAIHttp2Configuration() {
    this->initializeModel();
}

OAIHttp2Configuration::~OAIHttp2Configuration() {}

void OAIHttp2Configuration::initializeModel() {

    m_enabled_isSet = false;
    m_enabled_isValid = false;
}

void OAIHttp2Configuration::fromJson(QString jsonString) {
...
void OAIHttp2Configuration::fromJsonObject(QJsonObject json) {

    m_enabled_isValid = ::OpenAPI::fromJsonValue(m_enabled, json[QString("enabled")]);
    m_enabled_isSet = !json[QString("enabled")].isNull() && m_enabled_isValid;
}

QString OAIHttp2Configuration::asJson() const {
...
QJsonObject OAIHttp2Configuration::asJsonObject() const {
    QJsonObject obj;
    if (m_enabled_isSet) {
...
bool OAIHttp2Configuration::isEnabled() const {
    return m_enabled;
}
void OAIHttp2Configuration::setEnabled(const bool &enabled) {
    m_enabled = enabled;
    m_enabled_isSet = true;
}

bool OAIHttp2Configuration::is_enabled_Set() const{
    return m_enabled_isSet;
}

bool OAIHttp2Configuration::is_enabled_Valid() const{
    return m_enabled_isValid;
}

bool OAIHttp2Configuration::isSet() const {
...
bool OAIHttp2Configuration::isValid() const {
