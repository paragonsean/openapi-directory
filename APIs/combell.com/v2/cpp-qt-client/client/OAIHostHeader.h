...
#ifndef OAIHostHeader_H
#define OAIHostHeader_H
...
class OAIHostHeader : public OAIObject {
public:
    OAIHostHeader();
    OAIHostHeader(QString json);
    ~OAIHostHeader() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIHostHeader)

#endif // OAIHostHeader_H
