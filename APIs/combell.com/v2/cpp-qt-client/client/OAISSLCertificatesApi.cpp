...
void OAISSLCertificatesApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("downloadCertificate", defaultConf);
    _serverIndices.insert("downloadCertificate", 0);
    _serverConfigs.insert("getSslCertificate", defaultConf);
    _serverIndices.insert("getSslCertificate", 0);
    _serverConfigs.insert("getSslCertificates", defaultConf);
    _serverIndices.insert("getSslCertificates", 0);
}
...
void OAISSLCertificatesApi::downloadCertificate(const QString &sha1_fingerprint, const OAISslCertificateFileFormat &file_format, const QString &password, const QString &sha1_fingerprint2) {
    QString fullPath = QString(_serverConfigs["downloadCertificate"][_serverIndices.value("downloadCertificate")].URL()+"/sslcertificates/{sha1Fingerprint}/download");
    
    
    {
        QString sha1_fingerprint2PathParam("{");
        sha1_fingerprint2PathParam.append("sha1Fingerprint").append("}");
        ...
        pathDelimiter = getParamStyleDelimiter(pathStyle, "sha1Fingerprint", false);
        QString paramString = (pathStyle == "matrix") ? pathPrefix+"sha1Fingerprint"+pathSuffix : pathPrefix;
        fullPath.replace(sha1_fingerprint2PathParam, paramString+QUrl::toPercentEncoding(::OpenAPI::toStringValue(sha1_fingerprint2)));
    }
    ...
    
    {
        ...
        queryDelimiter = getParamStyleDelimiter(queryStyle, "sha1_fingerprint", true);
        if (fullPath.indexOf("?") > 0)
            fullPath.append(queryPrefix);
        else
            fullPath.append("?");

        fullPath.append(QUrl::toPercentEncoding("sha1_fingerprint")).append(querySuffix).append(QUrl::toPercentEncoding(sha1_fingerprint));
    }
    
    {
        ...
        queryPrefix = getParamStylePrefix(queryStyle);
        querySuffix = getParamStyleSuffix(queryStyle);
        queryDelimiter = getParamStyleDelimiter(queryStyle, "file_format", true);
        if (fullPath.indexOf("?") > 0)
            fullPath.append(queryPrefix);
        else
            fullPath.append("?");
        QString paramString = (queryStyle == "form" && true) ? "" : (queryStyle == "form" && !(true)) ? "file_format"+querySuffix : "";
        QJsonObject parameter = file_format.asJsonObject();
        qint32 count = 0;
        for(const QString& key : parameter.keys()) {
            ...
            switch(parameter.value(key).type()) {
                ...
                {
                    paramString.append(((queryStyle == "form") ? key : QString("file_format").append("[").append(key).append("]"))+assignOperator+parameter.value(key).toString());
                    break;
                }
                case QJsonValue::Double:
                {
                    paramString.append(((queryStyle == "form") ? key : QString("file_format").append("[").append(key).append("]"))+assignOperator+QString::number(parameter.value(key).toDouble()));
                    break;
                }
                case QJsonValue::Bool:
                {
                    paramString.append(((queryStyle == "form") ? key : QString("file_format").append("[").append(key).append("]"))+assignOperator+QVariant(parameter.value(key).toBool()).toString());
                    break;
                }
                case QJsonValue::Array:
                {
                    paramString.append(((queryStyle == "form") ? key : QString("file_format").append("[").append(key).append("]"))+assignOperator+QVariant(parameter.value(key).toArray()).toString());
                    break;
                }
                case QJsonValue::Object:
                {
                    paramString.append(((queryStyle == "form") ? key : QString("file_format").append("[").append(key).append("]"))+assignOperator+QVariant(parameter.value(key).toObject()).toString());
                    break;
                }
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAISSLCertificatesApi::downloadCertificateCallback);
...
void OAISSLCertificatesApi::downloadCertificateCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT downloadCertificateSignal(output);
        Q_EMIT downloadCertificateSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT downloadCertificateSignalE(output, error_type, error_str);
        Q_EMIT downloadCertificateSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT downloadCertificateSignalError(output, error_type, error_str);
        Q_EMIT downloadCertificateSignalErrorFull(worker, error_type, error_str);
    }
}

void OAISSLCertificatesApi::getSslCertificate(const QString &sha1_fingerprint, const QString &sha1_fingerprint2) {
    QString fullPath = QString(_serverConfigs["getSslCertificate"][_serverIndices.value("getSslCertificate")].URL()+"/sslcertificates/{sha1Fingerprint}");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAISSLCertificatesApi::getSslCertificateCallback);
    connect(this, &OAISSLCertificatesApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAISSLCertificatesApi::getSslCertificateCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    OAISslCertificateDetail output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT getSslCertificateSignal(output);
        Q_EMIT getSslCertificateSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT getSslCertificateSignalE(output, error_type, error_str);
        Q_EMIT getSslCertificateSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT getSslCertificateSignalError(output, error_type, error_str);
        Q_EMIT getSslCertificateSignalErrorFull(worker, error_type, error_str);
    }
}

void OAISSLCertificatesApi::getSslCertificates(const ::OpenAPI::OptionalParam<qint32> &skip, const ::OpenAPI::OptionalParam<qint32> &take) {
    QString fullPath = QString(_serverConfigs["getSslCertificates"][_serverIndices.value("getSslCertificates")].URL()+"/sslcertificates");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAISSLCertificatesApi::getSslCertificatesCallback);
    connect(this, &OAISSLCertificatesApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAISSLCertificatesApi::getSslCertificatesCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    QList<OAISslCertificate> output;
    QString json(worker->response);
    QByteArray array(json.toStdString().c_str());
    QJsonDocument doc = QJsonDocument::fromJson(array);
    QJsonArray jsonArray = doc.array();
    for (QJsonValue obj : jsonArray) {
        OAISslCertificate val;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT getSslCertificatesSignal(output);
        Q_EMIT getSslCertificatesSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT getSslCertificatesSignalE(output, error_type, error_str);
        Q_EMIT getSslCertificatesSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT getSslCertificatesSignalError(output, error_type, error_str);
        Q_EMIT getSslCertificatesSignalErrorFull(worker, error_type, error_str);
    }
}
