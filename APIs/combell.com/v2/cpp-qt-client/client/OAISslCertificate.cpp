...
OAISslCertificate::OAISslCertificate(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISslCertificate::OAISslCertificate() {
    this->initializeModel();
}

OAISslCertificate::~OAISslCertificate() {}

void OAISslCertificate::initializeModel() {
...
void OAISslCertificate::fromJson(QString jsonString) {
...
void OAISslCertificate::fromJsonObject(QJsonObject json) {
...
QString OAISslCertificate::asJson() const {
...
QJsonObject OAISslCertificate::asJsonObject() const {
    QJsonObject obj;
...
QString OAISslCertificate::getCommonName() const {
    return m_common_name;
}
void OAISslCertificate::setCommonName(const QString &common_name) {
    m_common_name = common_name;
    m_common_name_isSet = true;
}

bool OAISslCertificate::is_common_name_Set() const{
    return m_common_name_isSet;
}

bool OAISslCertificate::is_common_name_Valid() const{
    return m_common_name_isValid;
}

QDateTime OAISslCertificate::getExpiresAfter() const {
    return m_expires_after;
}
void OAISslCertificate::setExpiresAfter(const QDateTime &expires_after) {
    m_expires_after = expires_after;
    m_expires_after_isSet = true;
}

bool OAISslCertificate::is_expires_after_Set() const{
    return m_expires_after_isSet;
}

bool OAISslCertificate::is_expires_after_Valid() const{
    return m_expires_after_isValid;
}

QString OAISslCertificate::getSha1Fingerprint() const {
    return m_sha1_fingerprint;
}
void OAISslCertificate::setSha1Fingerprint(const QString &sha1_fingerprint) {
    m_sha1_fingerprint = sha1_fingerprint;
    m_sha1_fingerprint_isSet = true;
}

bool OAISslCertificate::is_sha1_fingerprint_Set() const{
    return m_sha1_fingerprint_isSet;
}

bool OAISslCertificate::is_sha1_fingerprint_Valid() const{
    return m_sha1_fingerprint_isValid;
}

OAISslCertificateType OAISslCertificate::getType() const {
    return m_type;
}
void OAISslCertificate::setType(const OAISslCertificateType &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAISslCertificate::is_type_Set() const{
    return m_type_isSet;
}

bool OAISslCertificate::is_type_Valid() const{
    return m_type_isValid;
}

OAISslCertificateValidationLevel OAISslCertificate::getValidationLevel() const {
    return m_validation_level;
}
void OAISslCertificate::setValidationLevel(const OAISslCertificateValidationLevel &validation_level) {
    m_validation_level = validation_level;
    m_validation_level_isSet = true;
}

bool OAISslCertificate::is_validation_level_Set() const{
    return m_validation_level_isSet;
}

bool OAISslCertificate::is_validation_level_Valid() const{
    return m_validation_level_isValid;
}

bool OAISslCertificate::isSet() const {
...
bool OAISslCertificate::isValid() const {
