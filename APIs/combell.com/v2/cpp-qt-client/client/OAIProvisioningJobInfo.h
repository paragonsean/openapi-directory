...
/*
 * OAIProvisioningJobInfo.h
 *
 * 
 */

#ifndef OAIProvisioningJobInfo_H
#define OAIProvisioningJobInfo_H

#include <QJsonObject>

#include "OAICompletionEstimation.h"
#include "OAIProvisioningJobStatus.h"
#include <QString>
...
namespace OpenAPI {
class OAICompletionEstimation;

class OAIProvisioningJobInfo : public OAIObject {
public:
    OAIProvisioningJobInfo();
    OAIProvisioningJobInfo(QString json);
    ~OAIProvisioningJobInfo() override;
    ...
    OAICompletionEstimation getCompletion() const;
    void setCompletion(const OAICompletionEstimation &completion);
    ...
    OAIProvisioningJobStatus getStatus() const;
    void setStatus(const OAIProvisioningJobStatus &status);
...
private:
    ...
    OAICompletionEstimation m_completion;
    ...
    OAIProvisioningJobStatus m_status;
    bool m_status_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIProvisioningJobInfo)

#endif // OAIProvisioningJobInfo_H
