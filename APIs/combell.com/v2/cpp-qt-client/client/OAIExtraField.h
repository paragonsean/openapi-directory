...
#ifndef OAIExtraField_H
#define OAIExtraField_H
...
class OAIExtraField : public OAIObject {
public:
    OAIExtraField();
    OAIExtraField(QString json);
    ~OAIExtraField() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIExtraField)

#endif // OAIExtraField_H
