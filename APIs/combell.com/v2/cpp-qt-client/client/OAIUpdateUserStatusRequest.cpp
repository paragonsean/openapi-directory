...
OAIUpdateUserStatusRequest::OAIUpdateUserStatusRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateUserStatusRequest::OAIUpdateUserStatusRequest() {
    this->initializeModel();
}

OAIUpdateUserStatusRequest::~OAIUpdateUserStatusRequest() {}

void OAIUpdateUserStatusRequest::initializeModel() {

    m_enabled_isSet = false;
    m_enabled_isValid = false;
}

void OAIUpdateUserStatusRequest::fromJson(QString jsonString) {
...
void OAIUpdateUserStatusRequest::fromJsonObject(QJsonObject json) {

    m_enabled_isValid = ::OpenAPI::fromJsonValue(m_enabled, json[QString("enabled")]);
    m_enabled_isSet = !json[QString("enabled")].isNull() && m_enabled_isValid;
}

QString OAIUpdateUserStatusRequest::asJson() const {
...
QJsonObject OAIUpdateUserStatusRequest::asJsonObject() const {
    QJsonObject obj;
    if (m_enabled_isSet) {
...
bool OAIUpdateUserStatusRequest::isEnabled() const {
    return m_enabled;
}
void OAIUpdateUserStatusRequest::setEnabled(const bool &enabled) {
    m_enabled = enabled;
    m_enabled_isSet = true;
}

bool OAIUpdateUserStatusRequest::is_enabled_Set() const{
    return m_enabled_isSet;
}

bool OAIUpdateUserStatusRequest::is_enabled_Valid() const{
    return m_enabled_isValid;
}

bool OAIUpdateUserStatusRequest::isSet() const {
...
bool OAIUpdateUserStatusRequest::isValid() const {
