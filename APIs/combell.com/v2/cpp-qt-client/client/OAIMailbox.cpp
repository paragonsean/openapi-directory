...
OAIMailbox::OAIMailbox(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIMailbox::OAIMailbox() {
    this->initializeModel();
}

OAIMailbox::~OAIMailbox() {}

void OAIMailbox::initializeModel() {
...
void OAIMailbox::fromJson(QString jsonString) {
...
void OAIMailbox::fromJsonObject(QJsonObject json) {
...
QString OAIMailbox::asJson() const {
...
QJsonObject OAIMailbox::asJsonObject() const {
    QJsonObject obj;
...
qint32 OAIMailbox::getActualSize() const {
    return m_actual_size;
}
void OAIMailbox::setActualSize(const qint32 &actual_size) {
    m_actual_size = actual_size;
    m_actual_size_isSet = true;
}

bool OAIMailbox::is_actual_size_Set() const{
    return m_actual_size_isSet;
}

bool OAIMailbox::is_actual_size_Valid() const{
    return m_actual_size_isValid;
}

qint32 OAIMailbox::getMaxSize() const {
    return m_max_size;
}
void OAIMailbox::setMaxSize(const qint32 &max_size) {
    m_max_size = max_size;
    m_max_size_isSet = true;
}

bool OAIMailbox::is_max_size_Set() const{
    return m_max_size_isSet;
}

bool OAIMailbox::is_max_size_Valid() const{
    return m_max_size_isValid;
}

QString OAIMailbox::getName() const {
    return m_name;
}
void OAIMailbox::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIMailbox::is_name_Set() const{
    return m_name_isSet;
}

bool OAIMailbox::is_name_Valid() const{
    return m_name_isValid;
}

bool OAIMailbox::isSet() const {
