...
void OAIDomainsApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("configureDomain", defaultConf);
    _serverIndices.insert("configureDomain", 0);
    _serverConfigs.insert("editNameServers", defaultConf);
    _serverIndices.insert("editNameServers", 0);
...
void OAIDomainsApi::configureDomain(const QString &domain_name, const QString &domain_name2, const ::OpenAPI::OptionalParam<OAIEditDomainWillRenewRequest> &oai_edit_domain_will_renew_request) {
    QString fullPath = QString(_serverConfigs["configureDomain"][_serverIndices.value("configureDomain")].URL()+"/domains/{domainName}/renew");
    ...
    if (oai_edit_domain_will_renew_request.hasValue()){

        
        QByteArray output = oai_edit_domain_will_renew_request.value().asJson().toUtf8();
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIDomainsApi::configureDomainCallback);
...
void OAIDomainsApi::configureDomainCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT configureDomainSignal();
        Q_EMIT configureDomainSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT configureDomainSignalE(error_type, error_str);
        Q_EMIT configureDomainSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT configureDomainSignalError(error_type, error_str);
        Q_EMIT configureDomainSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIDomainsApi::editNameServers(const QString &domain_name, const QString &domain_name2, const ::OpenAPI::OptionalParam<OAIEditNameServers> &oai_edit_name_servers) {
    QString fullPath = QString(_serverConfigs["editNameServers"][_serverIndices.value("editNameServers")].URL()+"/domains/{domainName}/nameservers");
    ...
    if (oai_edit_name_servers.hasValue()){

        
        QByteArray output = oai_edit_name_servers.value().asJson().toUtf8();
        input.request_body.append(output);
    }
    for (auto keyValueIt = _defaultHeaders.keyValueBegin(); keyValueIt != _defaultHeaders.keyValueEnd(); keyValueIt++) {
        input.headers.insert(keyValueIt->first, keyValueIt->second);
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIDomainsApi::editNameServersCallback);
    connect(this, &OAIDomainsApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIDomainsApi::editNameServersCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT editNameServersSignal();
        Q_EMIT editNameServersSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT editNameServersSignalE(error_type, error_str);
        Q_EMIT editNameServersSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT editNameServersSignalError(error_type, error_str);
        Q_EMIT editNameServersSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIDomainsApi::getDomain(const QString &domain_name, const QString &domain_name2) {
...
void OAIDomainsApi::getDomains(const ::OpenAPI::OptionalParam<qint32> &skip, const ::OpenAPI::OptionalParam<qint32> &take) {
...
void OAIDomainsApi::r_register(const ::OpenAPI::OptionalParam<OAIRegisterDomain> &oai_register_domain) {
    QString fullPath = QString(_serverConfigs["r_register"][_serverIndices.value("r_register")].URL()+"/domains/registrations");
    ...
    if (oai_register_domain.hasValue()){

        
        QByteArray output = oai_register_domain.value().asJson().toUtf8();
        input.request_body.append(output);
    }
    for (auto keyValueIt = _defaultHeaders.keyValueBegin(); keyValueIt != _defaultHeaders.keyValueEnd(); keyValueIt++) {
        input.headers.insert(keyValueIt->first, keyValueIt->second);
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIDomainsApi::r_registerCallback);
    connect(this, &OAIDomainsApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIDomainsApi::r_registerCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
...
void OAIDomainsApi::transfer(const ::OpenAPI::OptionalParam<OAITransferDomain> &oai_transfer_domain) {
    QString fullPath = QString(_serverConfigs["transfer"][_serverIndices.value("transfer")].URL()+"/domains/transfers");
    ...
    if (oai_transfer_domain.hasValue()){

        
        QByteArray output = oai_transfer_domain.value().asJson().toUtf8();
        input.request_body.append(output);
    }
    for (auto keyValueIt = _defaultHeaders.keyValueBegin(); keyValueIt != _defaultHeaders.keyValueEnd(); keyValueIt++) {
        input.headers.insert(keyValueIt->first, keyValueIt->second);
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIDomainsApi::transferCallback);
    connect(this, &OAIDomainsApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIDomainsApi::transferCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT transferSignal();
        Q_EMIT transferSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT transferSignalE(error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT transferSignalError(error_type, error_str);
