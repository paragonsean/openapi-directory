...
#include "OAIWindowsHostingsApi.h"
...
OAIWindowsHostingsApi::OAIWindowsHostingsApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAIWindowsHostingsApi::~OAIWindowsHostingsApi() {
}

void OAIWindowsHostingsApi::initializeServerConfigs() {
    //Default server
    ...
    _serverConfigs.insert("getWindowsHosting", defaultConf);
    _serverIndices.insert("getWindowsHosting", 0);
    _serverConfigs.insert("getWindowsHostings", defaultConf);
    _serverIndices.insert("getWindowsHostings", 0);
}
...
*/
int OAIWindowsHostingsApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAIWindowsHostingsApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAIWindowsHostingsApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAIWindowsHostingsApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAIWindowsHostingsApi::setUsername(const QString &username) {
    _username = username;
}

void OAIWindowsHostingsApi::setPassword(const QString &password) {
    _password = password;
}


void OAIWindowsHostingsApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAIWindowsHostingsApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAIWindowsHostingsApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAIWindowsHostingsApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAIWindowsHostingsApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAIWindowsHostingsApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAIWindowsHostingsApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAIWindowsHostingsApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAIWindowsHostingsApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAIWindowsHostingsApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAIWindowsHostingsApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAIWindowsHostingsApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAIWindowsHostingsApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAIWindowsHostingsApi::getWindowsHosting(const QString &domain_name, const QString &domain_name2) {
    QString fullPath = QString(_serverConfigs["getWindowsHosting"][_serverIndices.value("getWindowsHosting")].URL()+"/windowshostings/{domainName}");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIWindowsHostingsApi::getWindowsHostingCallback);
    connect(this, &OAIWindowsHostingsApi::abortRequestsSignal, worker, &QObject::deleteLater);
...
void OAIWindowsHostingsApi::getWindowsHostingCallback(OAIHttpRequestWorker *worker) {
    ...
    OAIWindowsHostingDetail output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT getWindowsHostingSignal(output);
        Q_EMIT getWindowsHostingSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT getWindowsHostingSignalE(output, error_type, error_str);
        Q_EMIT getWindowsHostingSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT getWindowsHostingSignalError(output, error_type, error_str);
        Q_EMIT getWindowsHostingSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIWindowsHostingsApi::getWindowsHostings(const ::OpenAPI::OptionalParam<qint32> &skip, const ::OpenAPI::OptionalParam<qint32> &take) {
    QString fullPath = QString(_serverConfigs["getWindowsHostings"][_serverIndices.value("getWindowsHostings")].URL()+"/windowshostings");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIWindowsHostingsApi::getWindowsHostingsCallback);
    connect(this, &OAIWindowsHostingsApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIWindowsHostingsApi::getWindowsHostingsCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    QList<OAIWindowsHosting> output;
    QString json(worker->response);
    QByteArray array(json.toStdString().c_str());
    QJsonDocument doc = QJsonDocument::fromJson(array);
    QJsonArray jsonArray = doc.array();
    for (QJsonValue obj : jsonArray) {
        OAIWindowsHosting val;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT getWindowsHostingsSignal(output);
        Q_EMIT getWindowsHostingsSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT getWindowsHostingsSignalE(output, error_type, error_str);
        Q_EMIT getWindowsHostingsSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT getWindowsHostingsSignalError(output, error_type, error_str);
        Q_EMIT getWindowsHostingsSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIWindowsHostingsApi::tokenAvailable(){
