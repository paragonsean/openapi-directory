...
/*
 * OAILinuxHostingDetail.h
 *
 * 
 */

#ifndef OAILinuxHostingDetail_H
#define OAILinuxHostingDetail_H
...
class OAILinuxHostingDetail : public OAIObject {
public:
    OAILinuxHostingDetail();
    OAILinuxHostingDetail(QString json);
    ~OAILinuxHostingDetail() override;
    ...
    OAILinuxIpType getIpType() const;
    void setIpType(const OAILinuxIpType &ip_type);
    ...
    Q_DECL_DEPRECATED qint32 getMaxWebspaceSize() const;
    Q_DECL_DEPRECATED void setMaxWebspaceSize(const qint32 &max_webspace_size);
    Q_DECL_DEPRECATED bool is_max_webspace_size_Set() const;
    Q_DECL_DEPRECATED bool is_max_webspace_size_Valid() const;

    QList<QString> getMysqlDatabaseNames() const;
    void setMysqlDatabaseNames(const QList<QString> &mysql_database_names);
    bool is_mysql_database_names_Set() const;
    bool is_mysql_database_names_Valid() const;
    ...
    QList<OAILinuxSite> getSites() const;
    void setSites(const QList<OAILinuxSite> &sites);
    ...
    Q_DECL_DEPRECATED qint32 getWebspaceUsage() const;
    Q_DECL_DEPRECATED void setWebspaceUsage(const qint32 &webspace_usage);
    Q_DECL_DEPRECATED bool is_webspace_usage_Set() const;
    Q_DECL_DEPRECATED bool is_webspace_usage_Valid() const;
...
private:
    ...
    qint32 m_max_webspace_size;
    bool m_max_webspace_size_isSet;
    bool m_max_webspace_size_isValid;

    QList<QString> m_mysql_database_names;
    bool m_mysql_database_names_isSet;
    bool m_mysql_database_names_isValid;
    ...
    qint32 m_webspace_usage;
    bool m_webspace_usage_isSet;
    bool m_webspace_usage_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAILinuxHostingDetail)

#endif // OAILinuxHostingDetail_H
