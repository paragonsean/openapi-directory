...
#ifndef OAISshKeyDetail_H
#define OAISshKeyDetail_H
...
class OAISshKeyDetail : public OAIObject {
public:
    OAISshKeyDetail();
    OAISshKeyDetail(QString json);
    ~OAISshKeyDetail() override;
    ...
    QList<QString> getLinuxHostings() const;
    void setLinuxHostings(const QList<QString> &linux_hostings);
    bool is_linux_hostings_Set() const;
    bool is_linux_hostings_Valid() const;
...
private:
    ...
    QList<QString> m_linux_hostings;
    bool m_linux_hostings_isSet;
    bool m_linux_hostings_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAISshKeyDetail)

#endif // OAISshKeyDetail_H
