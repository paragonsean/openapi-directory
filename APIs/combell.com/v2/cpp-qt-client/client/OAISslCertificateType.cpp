...
OAISslCertificateType::OAISslCertificateType(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISslCertificateType::OAISslCertificateType() {
    this->initializeModel();
}

OAISslCertificateType::~OAISslCertificateType() {}

void OAISslCertificateType::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAISslCertificateType::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAISslCertificateType::fromJson(QString jsonString) {
    
    if ( jsonString.compare("standard", Qt::CaseInsensitive) == 0) {
        m_value = eOAISslCertificateType::STANDARD;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("multi_domain", Qt::CaseInsensitive) == 0) {
        m_value = eOAISslCertificateType::MULTI_DOMAIN;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("wildcard", Qt::CaseInsensitive) == 0) {
        m_value = eOAISslCertificateType::WILDCARD;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAISslCertificateType::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAISslCertificateType::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAISslCertificateType::STANDARD:
            val = "standard";
            break;
        case eOAISslCertificateType::MULTI_DOMAIN:
            val = "multi_domain";
            break;
        case eOAISslCertificateType::WILDCARD:
            val = "wildcard";
            break;
        default:
            break;
...
QJsonValue OAISslCertificateType::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAISslCertificateType::eOAISslCertificateType OAISslCertificateType::getValue() const {
    return m_value;
}

void OAISslCertificateType::setValue(const OAISslCertificateType::eOAISslCertificateType& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAISslCertificateType::isSet() const {
    
    return m_value_isSet;
}

bool OAISslCertificateType::isValid() const {
