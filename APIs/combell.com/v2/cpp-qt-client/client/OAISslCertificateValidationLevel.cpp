...
#include "OAISslCertificateValidationLevel.h"
...
OAISslCertificateValidationLevel::OAISslCertificateValidationLevel(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISslCertificateValidationLevel::OAISslCertificateValidationLevel() {
    this->initializeModel();
}

OAISslCertificateValidationLevel::~OAISslCertificateValidationLevel() {}

void OAISslCertificateValidationLevel::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAISslCertificateValidationLevel::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAISslCertificateValidationLevel::fromJson(QString jsonString) {
    
    if ( jsonString.compare("domain_validated", Qt::CaseInsensitive) == 0) {
        m_value = eOAISslCertificateValidationLevel::DOMAIN_VALIDATED;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("organization_validated", Qt::CaseInsensitive) == 0) {
        m_value = eOAISslCertificateValidationLevel::ORGANIZATION_VALIDATED;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("extended_validated", Qt::CaseInsensitive) == 0) {
        m_value = eOAISslCertificateValidationLevel::EXTENDED_VALIDATED;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAISslCertificateValidationLevel::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAISslCertificateValidationLevel::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAISslCertificateValidationLevel::DOMAIN_VALIDATED:
            val = "domain_validated";
            break;
        case eOAISslCertificateValidationLevel::ORGANIZATION_VALIDATED:
            val = "organization_validated";
            break;
        case eOAISslCertificateValidationLevel::EXTENDED_VALIDATED:
            val = "extended_validated";
            break;
        default:
            break;
    }
...
QJsonValue OAISslCertificateValidationLevel::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAISslCertificateValidationLevel::eOAISslCertificateValidationLevel OAISslCertificateValidationLevel::getValue() const {
    return m_value;
}

void OAISslCertificateValidationLevel::setValue(const OAISslCertificateValidationLevel::eOAISslCertificateValidationLevel& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAISslCertificateValidationLevel::isSet() const {
    
    return m_value_isSet;
}

bool OAISslCertificateValidationLevel::isValid() const {
