...
#include "OAIValidationErrorMessage.h"
...
OAIValidationErrorMessage::OAIValidationErrorMessage(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIValidationErrorMessage::OAIValidationErrorMessage() {
    this->initializeModel();
}

OAIValidationErrorMessage::~OAIValidationErrorMessage() {}

void OAIValidationErrorMessage::initializeModel() {
...
void OAIValidationErrorMessage::fromJson(QString jsonString) {
...
void OAIValidationErrorMessage::fromJsonObject(QJsonObject json) {
...
QString OAIValidationErrorMessage::asJson() const {
...
QJsonObject OAIValidationErrorMessage::asJsonObject() const {
    QJsonObject obj;
...
QString OAIValidationErrorMessage::getErrorCode() const {
    return m_error_code;
}
void OAIValidationErrorMessage::setErrorCode(const QString &error_code) {
    m_error_code = error_code;
    m_error_code_isSet = true;
}

bool OAIValidationErrorMessage::is_error_code_Set() const{
    return m_error_code_isSet;
}

bool OAIValidationErrorMessage::is_error_code_Valid() const{
    return m_error_code_isValid;
}

QString OAIValidationErrorMessage::getErrorText() const {
    return m_error_text;
}
void OAIValidationErrorMessage::setErrorText(const QString &error_text) {
    m_error_text = error_text;
    m_error_text_isSet = true;
}

bool OAIValidationErrorMessage::is_error_text_Set() const{
    return m_error_text_isSet;
}

bool OAIValidationErrorMessage::is_error_text_Valid() const{
    return m_error_text_isValid;
}

bool OAIValidationErrorMessage::isSet() const {
...
bool OAIValidationErrorMessage::isValid() const {
