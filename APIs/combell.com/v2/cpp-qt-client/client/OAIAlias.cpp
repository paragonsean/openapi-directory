...
QList<QString> OAIAlias::getDestinations() const {
    return m_destinations;
}
void OAIAlias::setDestinations(const QList<QString> &destinations) {
    m_destinations = destinations;
    m_destinations_isSet = true;
}

bool OAIAlias::is_destinations_Set() const{
    return m_destinations_isSet;
}

bool OAIAlias::is_destinations_Valid() const{
    return m_destinations_isValid;
}

QString OAIAlias::getEmailAddress() const {
    return m_email_address;
}
void OAIAlias::setEmailAddress(const QString &email_address) {
    m_email_address = email_address;
    m_email_address_isSet = true;
}

bool OAIAlias::is_email_address_Set() const{
    return m_email_address_isSet;
}

bool OAIAlias::is_email_address_Valid() const{
