...
OAIAutoRedirectConfig::OAIAutoRedirectConfig(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAutoRedirectConfig::OAIAutoRedirectConfig() {
    this->initializeModel();
}

OAIAutoRedirectConfig::~OAIAutoRedirectConfig() {}

void OAIAutoRedirectConfig::initializeModel() {

    m_enabled_isSet = false;
    m_enabled_isValid = false;
}

void OAIAutoRedirectConfig::fromJson(QString jsonString) {
...
void OAIAutoRedirectConfig::fromJsonObject(QJsonObject json) {

    m_enabled_isValid = ::OpenAPI::fromJsonValue(m_enabled, json[QString("enabled")]);
    m_enabled_isSet = !json[QString("enabled")].isNull() && m_enabled_isValid;
}

QString OAIAutoRedirectConfig::asJson() const {
...
QJsonObject OAIAutoRedirectConfig::asJsonObject() const {
    QJsonObject obj;
    if (m_enabled_isSet) {
...
bool OAIAutoRedirectConfig::isEnabled() const {
    return m_enabled;
}
void OAIAutoRedirectConfig::setEnabled(const bool &enabled) {
    m_enabled = enabled;
    m_enabled_isSet = true;
}

bool OAIAutoRedirectConfig::is_enabled_Set() const{
    return m_enabled_isSet;
}

bool OAIAutoRedirectConfig::is_enabled_Valid() const{
    return m_enabled_isValid;
}

bool OAIAutoRedirectConfig::isSet() const {
...
bool OAIAutoRedirectConfig::isValid() const {
