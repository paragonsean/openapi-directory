...
OAISshKeyDetail::OAISshKeyDetail(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISshKeyDetail::OAISshKeyDetail() {
    this->initializeModel();
}

OAISshKeyDetail::~OAISshKeyDetail() {}

void OAISshKeyDetail::initializeModel() {

    m_fingerprint_isSet = false;
    m_fingerprint_isValid = false;

    m_linux_hostings_isSet = false;
    m_linux_hostings_isValid = false;

    m_public_key_isSet = false;
    m_public_key_isValid = false;
}

void OAISshKeyDetail::fromJson(QString jsonString) {
...
void OAISshKeyDetail::fromJsonObject(QJsonObject json) {
    ...
    m_linux_hostings_isValid = ::OpenAPI::fromJsonValue(m_linux_hostings, json[QString("linux_hostings")]);
    m_linux_hostings_isSet = !json[QString("linux_hostings")].isNull() && m_linux_hostings_isValid;
...
QString OAISshKeyDetail::asJson() const {
...
QJsonObject OAISshKeyDetail::asJsonObject() const {
    QJsonObject obj;
    if (m_fingerprint_isSet) {
        obj.insert(QString("fingerprint"), ::OpenAPI::toJsonValue(m_fingerprint));
    }
    if (m_linux_hostings.size() > 0) {
        obj.insert(QString("linux_hostings"), ::OpenAPI::toJsonValue(m_linux_hostings));
    }
...
QString OAISshKeyDetail::getFingerprint() const {
    return m_fingerprint;
}
void OAISshKeyDetail::setFingerprint(const QString &fingerprint) {
    m_fingerprint = fingerprint;
    m_fingerprint_isSet = true;
}

bool OAISshKeyDetail::is_fingerprint_Set() const{
    return m_fingerprint_isSet;
}

bool OAISshKeyDetail::is_fingerprint_Valid() const{
    return m_fingerprint_isValid;
}

QList<QString> OAISshKeyDetail::getLinuxHostings() const {
    return m_linux_hostings;
}
void OAISshKeyDetail::setLinuxHostings(const QList<QString> &linux_hostings) {
    m_linux_hostings = linux_hostings;
    m_linux_hostings_isSet = true;
}

bool OAISshKeyDetail::is_linux_hostings_Set() const{
    return m_linux_hostings_isSet;
}

bool OAISshKeyDetail::is_linux_hostings_Valid() const{
    return m_linux_hostings_isValid;
}

QString OAISshKeyDetail::getPublicKey() const {
    return m_public_key;
}
void OAISshKeyDetail::setPublicKey(const QString &public_key) {
    m_public_key = public_key;
    m_public_key_isSet = true;
}

bool OAISshKeyDetail::is_public_key_Set() const{
    return m_public_key_isSet;
}

bool OAISshKeyDetail::is_public_key_Valid() const{
    return m_public_key_isValid;
}

bool OAISshKeyDetail::isSet() const {
...
bool OAISshKeyDetail::isValid() const {
