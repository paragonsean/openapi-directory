...
OAIWindowsHostingDetail::OAIWindowsHostingDetail(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIWindowsHostingDetail::OAIWindowsHostingDetail() {
    this->initializeModel();
}

OAIWindowsHostingDetail::~OAIWindowsHostingDetail() {}

void OAIWindowsHostingDetail::initializeModel() {

    m_actual_size_isSet = false;
    m_actual_size_isValid = false;

    m_application_pool_isSet = false;
    m_application_pool_isValid = false;
    ...
    m_mssql_database_names_isSet = false;
    m_mssql_database_names_isValid = false;
...
void OAIWindowsHostingDetail::fromJson(QString jsonString) {
...
void OAIWindowsHostingDetail::fromJsonObject(QJsonObject json) {
    ...
    m_application_pool_isValid = ::OpenAPI::fromJsonValue(m_application_pool, json[QString("application_pool")]);
    m_application_pool_isSet = !json[QString("application_pool")].isNull() && m_application_pool_isValid;
    ...
    m_mssql_database_names_isValid = ::OpenAPI::fromJsonValue(m_mssql_database_names, json[QString("mssql_database_names")]);
    m_mssql_database_names_isSet = !json[QString("mssql_database_names")].isNull() && m_mssql_database_names_isValid;
...
QString OAIWindowsHostingDetail::asJson() const {
...
QJsonObject OAIWindowsHostingDetail::asJsonObject() const {
    QJsonObject obj;
    if (m_actual_size_isSet) {
        obj.insert(QString("actual_size"), ::OpenAPI::toJsonValue(m_actual_size));
    }
    if (m_application_pool.isSet()) {
        obj.insert(QString("application_pool"), ::OpenAPI::toJsonValue(m_application_pool));
    }
    ...
    if (m_mssql_database_names.size() > 0) {
        obj.insert(QString("mssql_database_names"), ::OpenAPI::toJsonValue(m_mssql_database_names));
    }
...
qint32 OAIWindowsHostingDetail::getActualSize() const {
    return m_actual_size;
}
void OAIWindowsHostingDetail::setActualSize(const qint32 &actual_size) {
    m_actual_size = actual_size;
    m_actual_size_isSet = true;
}

bool OAIWindowsHostingDetail::is_actual_size_Set() const{
    return m_actual_size_isSet;
}

bool OAIWindowsHostingDetail::is_actual_size_Valid() const{
    return m_actual_size_isValid;
}

OAIApplicationPool OAIWindowsHostingDetail::getApplicationPool() const {
    return m_application_pool;
}
void OAIWindowsHostingDetail::setApplicationPool(const OAIApplicationPool &application_pool) {
    m_application_pool = application_pool;
    m_application_pool_isSet = true;
}

bool OAIWindowsHostingDetail::is_application_pool_Set() const{
    return m_application_pool_isSet;
}

bool OAIWindowsHostingDetail::is_application_pool_Valid() const{
    return m_application_pool_isValid;
}

QString OAIWindowsHostingDetail::getDomainName() const {
    return m_domain_name;
}
void OAIWindowsHostingDetail::setDomainName(const QString &domain_name) {
    m_domain_name = domain_name;
    m_domain_name_isSet = true;
}

bool OAIWindowsHostingDetail::is_domain_name_Set() const{
    return m_domain_name_isSet;
}

bool OAIWindowsHostingDetail::is_domain_name_Valid() const{
    return m_domain_name_isValid;
}

QString OAIWindowsHostingDetail::getFtpUsername() const {
    return m_ftp_username;
}
void OAIWindowsHostingDetail::setFtpUsername(const QString &ftp_username) {
    m_ftp_username = ftp_username;
    m_ftp_username_isSet = true;
}

bool OAIWindowsHostingDetail::is_ftp_username_Set() const{
    return m_ftp_username_isSet;
}

bool OAIWindowsHostingDetail::is_ftp_username_Valid() const{
    return m_ftp_username_isValid;
}

QString OAIWindowsHostingDetail::getIp() const {
    return m_ip;
}
void OAIWindowsHostingDetail::setIp(const QString &ip) {
    m_ip = ip;
    m_ip_isSet = true;
}

bool OAIWindowsHostingDetail::is_ip_Set() const{
    return m_ip_isSet;
}

bool OAIWindowsHostingDetail::is_ip_Valid() const{
    return m_ip_isValid;
}

OAIWindowsIpType OAIWindowsHostingDetail::getIpType() const {
    return m_ip_type;
}
void OAIWindowsHostingDetail::setIpType(const OAIWindowsIpType &ip_type) {
    m_ip_type = ip_type;
    m_ip_type_isSet = true;
}

bool OAIWindowsHostingDetail::is_ip_type_Set() const{
    return m_ip_type_isSet;
}

bool OAIWindowsHostingDetail::is_ip_type_Valid() const{
    return m_ip_type_isValid;
}

qint32 OAIWindowsHostingDetail::getMaxSize() const {
    return m_max_size;
}
void OAIWindowsHostingDetail::setMaxSize(const qint32 &max_size) {
    m_max_size = max_size;
    m_max_size_isSet = true;
}

bool OAIWindowsHostingDetail::is_max_size_Set() const{
    return m_max_size_isSet;
}

bool OAIWindowsHostingDetail::is_max_size_Valid() const{
    return m_max_size_isValid;
}

QList<QString> OAIWindowsHostingDetail::getMssqlDatabaseNames() const {
    return m_mssql_database_names;
}
void OAIWindowsHostingDetail::setMssqlDatabaseNames(const QList<QString> &mssql_database_names) {
    m_mssql_database_names = mssql_database_names;
    m_mssql_database_names_isSet = true;
}

bool OAIWindowsHostingDetail::is_mssql_database_names_Set() const{
    return m_mssql_database_names_isSet;
}

bool OAIWindowsHostingDetail::is_mssql_database_names_Valid() const{
    return m_mssql_database_names_isValid;
}

qint32 OAIWindowsHostingDetail::getServicepackId() const {
    return m_servicepack_id;
}
void OAIWindowsHostingDetail::setServicepackId(const qint32 &servicepack_id) {
    m_servicepack_id = servicepack_id;
    m_servicepack_id_isSet = true;
}

bool OAIWindowsHostingDetail::is_servicepack_id_Set() const{
    return m_servicepack_id_isSet;
}

bool OAIWindowsHostingDetail::is_servicepack_id_Valid() const{
    return m_servicepack_id_isValid;
}

QList<OAIWindowsSite> OAIWindowsHostingDetail::getSites() const {
    return m_sites;
}
void OAIWindowsHostingDetail::setSites(const QList<OAIWindowsSite> &sites) {
    m_sites = sites;
    m_sites_isSet = true;
}

bool OAIWindowsHostingDetail::is_sites_Set() const{
    return m_sites_isSet;
}

bool OAIWindowsHostingDetail::is_sites_Valid() const{
    return m_sites_isValid;
}

bool OAIWindowsHostingDetail::isSet() const {
...
bool OAIWindowsHostingDetail::isValid() const {
