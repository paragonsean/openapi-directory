...
/*
 * OAISslCertificateRequestValidation.h
 *
 * 
 */

#ifndef OAISslCertificateRequestValidation_H
#define OAISslCertificateRequestValidation_H

#include <QJsonObject>

#include "OAISslCertificateRequestValidationType.h"
#include <QList>
#include <QString>
...
class OAISslCertificateRequestValidation : public OAIObject {
public:
    OAISslCertificateRequestValidation();
    OAISslCertificateRequestValidation(QString json);
    ~OAISslCertificateRequestValidation() override;
    ...
    bool isAutoValidated() const;
    void setAutoValidated(const bool &auto_validated);
    bool is_auto_validated_Set() const;
    bool is_auto_validated_Valid() const;

    QString getCnameValidationContent() const;
    void setCnameValidationContent(const QString &cname_validation_content);
    bool is_cname_validation_content_Set() const;
    bool is_cname_validation_content_Valid() const;

    QString getCnameValidationName() const;
    void setCnameValidationName(const QString &cname_validation_name);
    bool is_cname_validation_name_Set() const;
    bool is_cname_validation_name_Valid() const;
    ...
    QList<QString> getFileValidationContent() const;
    void setFileValidationContent(const QList<QString> &file_validation_content);
    bool is_file_validation_content_Set() const;
    bool is_file_validation_content_Valid() const;

    QString getFileValidationUrlHttp() const;
    void setFileValidationUrlHttp(const QString &file_validation_url_http);
    bool is_file_validation_url_http_Set() const;
    bool is_file_validation_url_http_Valid() const;

    QString getFileValidationUrlHttps() const;
    void setFileValidationUrlHttps(const QString &file_validation_url_https);
    bool is_file_validation_url_https_Set() const;
    bool is_file_validation_url_https_Valid() const;

    OAISslCertificateRequestValidationType getType() const;
    void setType(const OAISslCertificateRequestValidationType &type);
...
private:
    ...
    bool m_auto_validated;
    bool m_auto_validated_isSet;
    bool m_auto_validated_isValid;

    QString m_cname_validation_content;
    bool m_cname_validation_content_isSet;
    bool m_cname_validation_content_isValid;

    QString m_cname_validation_name;
    bool m_cname_validation_name_isSet;
    bool m_cname_validation_name_isValid;
    ...
    QList<QString> m_file_validation_content;
    bool m_file_validation_content_isSet;
    bool m_file_validation_content_isValid;

    QString m_file_validation_url_http;
    bool m_file_validation_url_http_isSet;
    bool m_file_validation_url_http_isValid;

    QString m_file_validation_url_https;
    bool m_file_validation_url_https_isSet;
    bool m_file_validation_url_https_isValid;

    OAISslCertificateRequestValidationType m_type;
    bool m_type_isSet;
    bool m_type_isValid;
};
...
Q_DECLARE_METATYPE(OpenAPI::OAISslCertificateRequestValidation)

#endif // OAISslCertificateRequestValidation_H
