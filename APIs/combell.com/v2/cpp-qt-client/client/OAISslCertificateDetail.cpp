...
OAISslCertificateDetail::OAISslCertificateDetail(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISslCertificateDetail::OAISslCertificateDetail() {
    this->initializeModel();
}

OAISslCertificateDetail::~OAISslCertificateDetail() {}

void OAISslCertificateDetail::initializeModel() {
...
void OAISslCertificateDetail::fromJson(QString jsonString) {
...
void OAISslCertificateDetail::fromJsonObject(QJsonObject json) {
    ...
    m_sha1_fingerprint_isValid = ::OpenAPI::fromJsonValue(m_sha1_fingerprint, json[QString("sha1_fingerprint")]);
    m_sha1_fingerprint_isSet = !json[QString("sha1_fingerprint")].isNull() && m_sha1_fingerprint_isValid;
...
QString OAISslCertificateDetail::asJson() const {
...
QJsonObject OAISslCertificateDetail::asJsonObject() const {
    QJsonObject obj;
    ...
    if (m_sha1_fingerprint_isSet) {
        obj.insert(QString("sha1_fingerprint"), ::OpenAPI::toJsonValue(m_sha1_fingerprint));
    }
...
QString OAISslCertificateDetail::getCommonName() const {
    return m_common_name;
}
void OAISslCertificateDetail::setCommonName(const QString &common_name) {
    m_common_name = common_name;
    m_common_name_isSet = true;
}

bool OAISslCertificateDetail::is_common_name_Set() const{
    return m_common_name_isSet;
}

bool OAISslCertificateDetail::is_common_name_Valid() const{
    return m_common_name_isValid;
}

QDateTime OAISslCertificateDetail::getExpiresAfter() const {
    return m_expires_after;
}
void OAISslCertificateDetail::setExpiresAfter(const QDateTime &expires_after) {
    m_expires_after = expires_after;
    m_expires_after_isSet = true;
}

bool OAISslCertificateDetail::is_expires_after_Set() const{
    return m_expires_after_isSet;
}

bool OAISslCertificateDetail::is_expires_after_Valid() const{
    return m_expires_after_isValid;
}

QString OAISslCertificateDetail::getSha1Fingerprint() const {
    return m_sha1_fingerprint;
}
void OAISslCertificateDetail::setSha1Fingerprint(const QString &sha1_fingerprint) {
    m_sha1_fingerprint = sha1_fingerprint;
    m_sha1_fingerprint_isSet = true;
}

bool OAISslCertificateDetail::is_sha1_fingerprint_Set() const{
    return m_sha1_fingerprint_isSet;
}

bool OAISslCertificateDetail::is_sha1_fingerprint_Valid() const{
    return m_sha1_fingerprint_isValid;
}

QList<OAISslSubjectAltName> OAISslCertificateDetail::getSubjectAltNames() const {
    return m_subject_alt_names;
}
void OAISslCertificateDetail::setSubjectAltNames(const QList<OAISslSubjectAltName> &subject_alt_names) {
    m_subject_alt_names = subject_alt_names;
    m_subject_alt_names_isSet = true;
}

bool OAISslCertificateDetail::is_subject_alt_names_Set() const{
    return m_subject_alt_names_isSet;
}

bool OAISslCertificateDetail::is_subject_alt_names_Valid() const{
    return m_subject_alt_names_isValid;
}

OAISslCertificateType OAISslCertificateDetail::getType() const {
    return m_type;
}
void OAISslCertificateDetail::setType(const OAISslCertificateType &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAISslCertificateDetail::is_type_Set() const{
    return m_type_isSet;
}

bool OAISslCertificateDetail::is_type_Valid() const{
    return m_type_isValid;
}

OAISslCertificateValidationLevel OAISslCertificateDetail::getValidationLevel() const {
    return m_validation_level;
}
void OAISslCertificateDetail::setValidationLevel(const OAISslCertificateValidationLevel &validation_level) {
    m_validation_level = validation_level;
    m_validation_level_isSet = true;
}

bool OAISslCertificateDetail::is_validation_level_Set() const{
    return m_validation_level_isSet;
}

bool OAISslCertificateDetail::is_validation_level_Valid() const{
    return m_validation_level_isValid;
}

bool OAISslCertificateDetail::isSet() const {
...
bool OAISslCertificateDetail::isValid() const {
