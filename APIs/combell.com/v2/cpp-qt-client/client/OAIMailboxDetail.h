...
#ifndef OAIMailboxDetail_H
#define OAIMailboxDetail_H

#include <QJsonObject>

#include "OAIAutoForward.h"
#include "OAIAutoReply.h"
#include <QString>
...
namespace OpenAPI {
class OAIAutoForward;
class OAIAutoReply;

class OAIMailboxDetail : public OAIObject {
public:
    OAIMailboxDetail();
    OAIMailboxDetail(QString json);
    ~OAIMailboxDetail() override;
    ...
    OAIAutoForward getAutoForward() const;
    void setAutoForward(const OAIAutoForward &auto_forward);
    bool is_auto_forward_Set() const;
    bool is_auto_forward_Valid() const;

    OAIAutoReply getAutoReply() const;
    void setAutoReply(const OAIAutoReply &auto_reply);
    bool is_auto_reply_Set() const;
    bool is_auto_reply_Valid() const;
...
private:
    ...
    OAIAutoForward m_auto_forward;
    bool m_auto_forward_isSet;
    bool m_auto_forward_isValid;

    OAIAutoReply m_auto_reply;
    bool m_auto_reply_isSet;
    bool m_auto_reply_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMailboxDetail)

#endif // OAIMailboxDetail_H
