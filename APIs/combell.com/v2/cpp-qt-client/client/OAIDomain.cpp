...
QDateTime OAIDomain::getExpirationDate() const {
    return m_expiration_date;
}
void OAIDomain::setExpirationDate(const QDateTime &expiration_date) {
    m_expiration_date = expiration_date;
    m_expiration_date_isSet = true;
}

bool OAIDomain::is_expiration_date_Set() const{
    return m_expiration_date_isSet;
}

bool OAIDomain::is_expiration_date_Valid() const{
    return m_expiration_date_isValid;
}

bool OAIDomain::isWillRenew() const {
    return m_will_renew;
}
void OAIDomain::setWillRenew(const bool &will_renew) {
    m_will_renew = will_renew;
    m_will_renew_isSet = true;
}

bool OAIDomain::is_will_renew_Set() const{
    return m_will_renew_isSet;
}

bool OAIDomain::is_will_renew_Valid() const{
