...
void OAIAccountDetail::initializeModel() {
    ...
    m_servicepack_isSet = false;
    m_servicepack_isValid = false;
}
...
void OAIAccountDetail::fromJsonObject(QJsonObject json) {
    ...
    m_servicepack_isValid = ::OpenAPI::fromJsonValue(m_servicepack, json[QString("servicepack")]);
    m_servicepack_isSet = !json[QString("servicepack")].isNull() && m_servicepack_isValid;
}
...
QJsonObject OAIAccountDetail::asJsonObject() const {
    ...
    if (m_servicepack.isSet()) {
        obj.insert(QString("servicepack"), ::OpenAPI::toJsonValue(m_servicepack));
    }
    return obj;
}

QList<OAIAddon> OAIAccountDetail::getAddons() const {
    return m_addons;
}
void OAIAccountDetail::setAddons(const QList<OAIAddon> &addons) {
    m_addons = addons;
    m_addons_isSet = true;
}

bool OAIAccountDetail::is_addons_Set() const{
    return m_addons_isSet;
}

bool OAIAccountDetail::is_addons_Valid() const{
    return m_addons_isValid;
}

qint32 OAIAccountDetail::getId() const {
    return m_id;
}
void OAIAccountDetail::setId(const qint32 &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIAccountDetail::is_id_Set() const{
    return m_id_isSet;
}

bool OAIAccountDetail::is_id_Valid() const{
    return m_id_isValid;
}

QString OAIAccountDetail::getIdentifier() const {
    return m_identifier;
}
void OAIAccountDetail::setIdentifier(const QString &identifier) {
    m_identifier = identifier;
    m_identifier_isSet = true;
}

bool OAIAccountDetail::is_identifier_Set() const{
    return m_identifier_isSet;
}

bool OAIAccountDetail::is_identifier_Valid() const{
    return m_identifier_isValid;
}

OAIServicepack OAIAccountDetail::getServicepack() const {
    return m_servicepack;
}
void OAIAccountDetail::setServicepack(const OAIServicepack &servicepack) {
    m_servicepack = servicepack;
    m_servicepack_isSet = true;
}

bool OAIAccountDetail::is_servicepack_Set() const{
    return m_servicepack_isSet;
}

bool OAIAccountDetail::is_servicepack_Valid() const{
    return m_servicepack_isValid;
}
