...
OAIEditNameServers::OAIEditNameServers(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIEditNameServers::OAIEditNameServers() {
    this->initializeModel();
}

OAIEditNameServers::~OAIEditNameServers() {}

void OAIEditNameServers::initializeModel() {
...
void OAIEditNameServers::fromJson(QString jsonString) {
...
void OAIEditNameServers::fromJsonObject(QJsonObject json) {
...
QString OAIEditNameServers::asJson() const {
...
QJsonObject OAIEditNameServers::asJsonObject() const {
    QJsonObject obj;
...
QString OAIEditNameServers::getDomainName() const {
    return m_domain_name;
}
void OAIEditNameServers::setDomainName(const QString &domain_name) {
    m_domain_name = domain_name;
    m_domain_name_isSet = true;
}

bool OAIEditNameServers::is_domain_name_Set() const{
    return m_domain_name_isSet;
}

bool OAIEditNameServers::is_domain_name_Valid() const{
    return m_domain_name_isValid;
}

QList<QString> OAIEditNameServers::getNameServers() const {
    return m_name_servers;
}
void OAIEditNameServers::setNameServers(const QList<QString> &name_servers) {
    m_name_servers = name_servers;
    m_name_servers_isSet = true;
}

bool OAIEditNameServers::is_name_servers_Set() const{
    return m_name_servers_isSet;
}

bool OAIEditNameServers::is_name_servers_Valid() const{
    return m_name_servers_isValid;
}

bool OAIEditNameServers::isSet() const {
...
bool OAIEditNameServers::isValid() const {
