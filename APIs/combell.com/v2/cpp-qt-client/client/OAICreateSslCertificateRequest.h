...
/*
 * OAICreateSslCertificateRequest.h
 *
 * 
 */

#ifndef OAICreateSslCertificateRequest_H
#define OAICreateSslCertificateRequest_H

#include <QJsonObject>

#include "OAIAdditionalValidationAttribute.h"
...
namespace OpenAPI {
class OAIAdditionalValidationAttribute;

class OAICreateSslCertificateRequest : public OAIObject {
public:
    OAICreateSslCertificateRequest();
    OAICreateSslCertificateRequest(QString json);
    ~OAICreateSslCertificateRequest() override;
    ...
    QList<OAIAdditionalValidationAttribute> getAdditionalValidationAttributes() const;
    void setAdditionalValidationAttributes(const QList<OAIAdditionalValidationAttribute> &additional_validation_attributes);
    bool is_additional_validation_attributes_Set() const;
    bool is_additional_validation_attributes_Valid() const;
...
private:
    ...
    QList<OAIAdditionalValidationAttribute> m_additional_validation_attributes;
    bool m_additional_validation_attributes_isSet;
    bool m_additional_validation_attributes_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateSslCertificateRequest)

#endif // OAICreateSslCertificateRequest_H
