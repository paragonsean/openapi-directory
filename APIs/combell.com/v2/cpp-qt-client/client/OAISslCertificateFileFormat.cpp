...
OAISslCertificateFileFormat::OAISslCertificateFileFormat(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISslCertificateFileFormat::OAISslCertificateFileFormat() {
    this->initializeModel();
}

OAISslCertificateFileFormat::~OAISslCertificateFileFormat() {}

void OAISslCertificateFileFormat::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAISslCertificateFileFormat::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAISslCertificateFileFormat::fromJson(QString jsonString) {
    
    if ( jsonString.compare("pfx", Qt::CaseInsensitive) == 0) {
        m_value = eOAISslCertificateFileFormat::PFX;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAISslCertificateFileFormat::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAISslCertificateFileFormat::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAISslCertificateFileFormat::PFX:
            val = "pfx";
            break;
        default:
            break;
...
QJsonValue OAISslCertificateFileFormat::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAISslCertificateFileFormat::eOAISslCertificateFileFormat OAISslCertificateFileFormat::getValue() const {
    return m_value;
}

void OAISslCertificateFileFormat::setValue(const OAISslCertificateFileFormat::eOAISslCertificateFileFormat& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAISslCertificateFileFormat::isSet() const {
    
    return m_value_isSet;
}

bool OAISslCertificateFileFormat::isValid() const {
