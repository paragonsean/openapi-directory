...
OAICreateCatchAllRequest::OAICreateCatchAllRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateCatchAllRequest::OAICreateCatchAllRequest() {
    this->initializeModel();
}

OAICreateCatchAllRequest::~OAICreateCatchAllRequest() {}

void OAICreateCatchAllRequest::initializeModel() {

    m_email_address_isSet = false;
    m_email_address_isValid = false;
}

void OAICreateCatchAllRequest::fromJson(QString jsonString) {
...
void OAICreateCatchAllRequest::fromJsonObject(QJsonObject json) {
...
QString OAICreateCatchAllRequest::asJson() const {
...
QJsonObject OAICreateCatchAllRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAICreateCatchAllRequest::getEmailAddress() const {
    return m_email_address;
}
void OAICreateCatchAllRequest::setEmailAddress(const QString &email_address) {
    m_email_address = email_address;
    m_email_address_isSet = true;
}

bool OAICreateCatchAllRequest::is_email_address_Set() const{
    return m_email_address_isSet;
}

bool OAICreateCatchAllRequest::is_email_address_Valid() const{
    return m_email_address_isValid;
}

bool OAICreateCatchAllRequest::isSet() const {
...
bool OAICreateCatchAllRequest::isValid() const {
