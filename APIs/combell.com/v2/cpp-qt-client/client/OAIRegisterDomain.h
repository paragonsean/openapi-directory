...
#ifndef OAIRegisterDomain_H
#define OAIRegisterDomain_H
...
class OAIRegisterDomain : public OAIObject {
public:
    OAIRegisterDomain();
    OAIRegisterDomain(QString json);
    ~OAIRegisterDomain() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRegisterDomain)

#endif // OAIRegisterDomain_H
