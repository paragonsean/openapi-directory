...
OAICreateMailboxRequest::OAICreateMailboxRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateMailboxRequest::OAICreateMailboxRequest() {
    this->initializeModel();
}

OAICreateMailboxRequest::~OAICreateMailboxRequest() {}

void OAICreateMailboxRequest::initializeModel() {
...
void OAICreateMailboxRequest::fromJson(QString jsonString) {
...
void OAICreateMailboxRequest::fromJsonObject(QJsonObject json) {
...
QString OAICreateMailboxRequest::asJson() const {
...
QJsonObject OAICreateMailboxRequest::asJsonObject() const {
    QJsonObject obj;
...
qint32 OAICreateMailboxRequest::getAccountId() const {
    return m_account_id;
}
void OAICreateMailboxRequest::setAccountId(const qint32 &account_id) {
    m_account_id = account_id;
    m_account_id_isSet = true;
}

bool OAICreateMailboxRequest::is_account_id_Set() const{
    return m_account_id_isSet;
}

bool OAICreateMailboxRequest::is_account_id_Valid() const{
    return m_account_id_isValid;
}

QString OAICreateMailboxRequest::getEmailAddress() const {
    return m_email_address;
}
void OAICreateMailboxRequest::setEmailAddress(const QString &email_address) {
    m_email_address = email_address;
    m_email_address_isSet = true;
}

bool OAICreateMailboxRequest::is_email_address_Set() const{
    return m_email_address_isSet;
}

bool OAICreateMailboxRequest::is_email_address_Valid() const{
    return m_email_address_isValid;
}

QString OAICreateMailboxRequest::getPassword() const {
    return m_password;
}
void OAICreateMailboxRequest::setPassword(const QString &password) {
    m_password = password;
    m_password_isSet = true;
}

bool OAICreateMailboxRequest::is_password_Set() const{
    return m_password_isSet;
}

bool OAICreateMailboxRequest::is_password_Valid() const{
    return m_password_isValid;
}

bool OAICreateMailboxRequest::isSet() const {
...
bool OAICreateMailboxRequest::isValid() const {
