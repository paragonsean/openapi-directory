...
void OAIDomainDetail::initializeModel() {
    ...
    m_can_toggle_renew_isSet = false;
    m_can_toggle_renew_isValid = false;
    ...
    m_registrant_isSet = false;
    m_registrant_isValid = false;

    m_will_renew_isSet = false;
    m_will_renew_isValid = false;
}
...
void OAIDomainDetail::fromJsonObject(QJsonObject json) {
    ...
    m_can_toggle_renew_isValid = ::OpenAPI::fromJsonValue(m_can_toggle_renew, json[QString("can_toggle_renew")]);
    m_can_toggle_renew_isSet = !json[QString("can_toggle_renew")].isNull() && m_can_toggle_renew_isValid;
    ...
    m_name_servers_isValid = ::OpenAPI::fromJsonValue(m_name_servers, json[QString("name_servers")]);
    m_name_servers_isSet = !json[QString("name_servers")].isNull() && m_name_servers_isValid;

    m_registrant_isValid = ::OpenAPI::fromJsonValue(m_registrant, json[QString("registrant")]);
    m_registrant_isSet = !json[QString("registrant")].isNull() && m_registrant_isValid;

    m_will_renew_isValid = ::OpenAPI::fromJsonValue(m_will_renew, json[QString("will_renew")]);
    m_will_renew_isSet = !json[QString("will_renew")].isNull() && m_will_renew_isValid;
}
...
QJsonObject OAIDomainDetail::asJsonObject() const {
    QJsonObject obj;
    if (m_can_toggle_renew_isSet) {
        obj.insert(QString("can_toggle_renew"), ::OpenAPI::toJsonValue(m_can_toggle_renew));
    }
    ...
    if (m_name_servers.size() > 0) {
        obj.insert(QString("name_servers"), ::OpenAPI::toJsonValue(m_name_servers));
    }
    if (m_registrant.isSet()) {
        obj.insert(QString("registrant"), ::OpenAPI::toJsonValue(m_registrant));
    }
    if (m_will_renew_isSet) {
        obj.insert(QString("will_renew"), ::OpenAPI::toJsonValue(m_will_renew));
    }
    return obj;
}

bool OAIDomainDetail::isCanToggleRenew() const {
    return m_can_toggle_renew;
}
void OAIDomainDetail::setCanToggleRenew(const bool &can_toggle_renew) {
    m_can_toggle_renew = can_toggle_renew;
    m_can_toggle_renew_isSet = true;
}

bool OAIDomainDetail::is_can_toggle_renew_Set() const{
    return m_can_toggle_renew_isSet;
}

bool OAIDomainDetail::is_can_toggle_renew_Valid() const{
    return m_can_toggle_renew_isValid;
}

QString OAIDomainDetail::getDomainName() const {
    return m_domain_name;
}
void OAIDomainDetail::setDomainName(const QString &domain_name) {
    m_domain_name = domain_name;
    m_domain_name_isSet = true;
}

bool OAIDomainDetail::is_domain_name_Set() const{
    return m_domain_name_isSet;
}

bool OAIDomainDetail::is_domain_name_Valid() const{
    return m_domain_name_isValid;
}

QDateTime OAIDomainDetail::getExpirationDate() const {
    return m_expiration_date;
}
void OAIDomainDetail::setExpirationDate(const QDateTime &expiration_date) {
    m_expiration_date = expiration_date;
    m_expiration_date_isSet = true;
}

bool OAIDomainDetail::is_expiration_date_Set() const{
    return m_expiration_date_isSet;
}

bool OAIDomainDetail::is_expiration_date_Valid() const{
    return m_expiration_date_isValid;
}

QList<OAINameServer> OAIDomainDetail::getNameServers() const {
    return m_name_servers;
}
void OAIDomainDetail::setNameServers(const QList<OAINameServer> &name_servers) {
    m_name_servers = name_servers;
    m_name_servers_isSet = true;
}

bool OAIDomainDetail::is_name_servers_Set() const{
    return m_name_servers_isSet;
}

bool OAIDomainDetail::is_name_servers_Valid() const{
    return m_name_servers_isValid;
}

OAIRegistrant OAIDomainDetail::getRegistrant() const {
    return m_registrant;
}
void OAIDomainDetail::setRegistrant(const OAIRegistrant &registrant) {
    m_registrant = registrant;
    m_registrant_isSet = true;
}

bool OAIDomainDetail::is_registrant_Set() const{
    return m_registrant_isSet;
}

bool OAIDomainDetail::is_registrant_Valid() const{
    return m_registrant_isValid;
}

bool OAIDomainDetail::isWillRenew() const {
    return m_will_renew;
}
void OAIDomainDetail::setWillRenew(const bool &will_renew) {
    m_will_renew = will_renew;
    m_will_renew_isSet = true;
}

bool OAIDomainDetail::is_will_renew_Set() const{
    return m_will_renew_isSet;
}

bool OAIDomainDetail::is_will_renew_Valid() const{
    return m_will_renew_isValid;
}
