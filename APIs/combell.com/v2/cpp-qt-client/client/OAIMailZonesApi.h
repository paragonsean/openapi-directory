...
#ifndef OAI_OAIMailZonesApi_H
#define OAI_OAIMailZonesApi_H
...
#include "OAICreateCatchAllRequest.h"
#include "OAICreateSmtpDomainRequest.h"
#include "OAIMailZone.h"
#include "OAIUpdateAliasRequest.h"
#include "OAIUpdateAntiSpamRequest.h"
#include "OAIUpdateSmtpDomainRequest.h"
#include <QString>
...
class OAIMailZonesApi : public QObject {
    Q_OBJECT

public:
    OAIMailZonesApi(const int timeOut = 0);
    ~OAIMailZonesApi();
    ...
    * @param[in]  domain_name2 QString [required]
    * @param[in]  email_address2 QString [required]
    * @param[in]  oai_update_alias_request OAIUpdateAliasRequest [optional]
    */
    virtual void configureAlias(const QString &domain_name, const QString &email_address, const QString &domain_name2, const QString &email_address2, const ::OpenAPI::OptionalParam<OAIUpdateAliasRequest> &oai_update_alias_request = ::OpenAPI::OptionalParam<OAIUpdateAliasRequest>());

    /**
    * @param[in]  domain_name QString [required]
    * @param[in]  domain_name2 QString [required]
    * @param[in]  oai_update_anti_spam_request OAIUpdateAntiSpamRequest [optional]
    */
    virtual void configureAntiSpam(const QString &domain_name, const QString &domain_name2, const ::OpenAPI::OptionalParam<OAIUpdateAntiSpamRequest> &oai_update_anti_spam_request = ::OpenAPI::OptionalParam<OAIUpdateAntiSpamRequest>());

    /**
    * @param[in]  domain_name QString [required]
    * @param[in]  hostname QString [required]
    * @param[in]  domain_name2 QString [required]
    * @param[in]  oai_update_smtp_domain_request OAIUpdateSmtpDomainRequest [optional]
    */
    virtual void configureSmtpDomain(const QString &domain_name, const QString &hostname, const QString &domain_name2, const ::OpenAPI::OptionalParam<OAIUpdateSmtpDomainRequest> &oai_update_smtp_domain_request = ::OpenAPI::OptionalParam<OAIUpdateSmtpDomainRequest>());

    /**
    * @param[in]  domain_name QString [required]
    * @param[in]  domain_name2 QString [required]
    * @param[in]  oai_create_alias_request OAICreateAliasRequest [optional]
    */
    virtual void createAlias(const QString &domain_name, const QString &domain_name2, const ::OpenAPI::OptionalParam<OAICreateAliasRequest> &oai_create_alias_request = ::OpenAPI::OptionalParam<OAICreateAliasRequest>());

    /**
    * @param[in]  domain_name QString [required]
    * @param[in]  domain_name2 QString [required]
    * @param[in]  oai_create_catch_all_request OAICreateCatchAllRequest [optional]
    */
    virtual void createCatchAll(const QString &domain_name, const QString &domain_name2, const ::OpenAPI::OptionalParam<OAICreateCatchAllRequest> &oai_create_catch_all_request = ::OpenAPI::OptionalParam<OAICreateCatchAllRequest>());

    /**
    * @param[in]  domain_name QString [required]
    * @param[in]  domain_name2 QString [required]
    * @param[in]  oai_create_smtp_domain_request OAICreateSmtpDomainRequest [optional]
    */
    virtual void createSmtpDomain(const QString &domain_name, const QString &domain_name2, const ::OpenAPI::OptionalParam<OAICreateSmtpDomainRequest> &oai_create_smtp_domain_request = ::OpenAPI::OptionalParam<OAICreateSmtpDomainRequest>());
    ...
    * @param[in]  email_address2 QString [required]
    */
    virtual void deleteAlias(const QString &domain_name, const QString &email_address, const QString &domain_name2, const QString &email_address2);
    ...
    * @param[in]  email_address2 QString [required]
    */
    virtual void deleteCatchAll(const QString &domain_name, const QString &email_address, const QString &domain_name2, const QString &email_address2);
    ...
    * @param[in]  domain_name2 QString [required]
    */
    virtual void deleteSmtpDomain(const QString &domain_name, const QString &hostname, const QString &domain_name2);

    /**
    * @param[in]  domain_name QString [required]
    * @param[in]  domain_name2 QString [required]
    */
    virtual void getMailZone(const QString &domain_name, const QString &domain_name2);
...
private:
    ...
    void configureAliasCallback(OAIHttpRequestWorker *worker);
    void configureAntiSpamCallback(OAIHttpRequestWorker *worker);
    void configureSmtpDomainCallback(OAIHttpRequestWorker *worker);
    void createAliasCallback(OAIHttpRequestWorker *worker);
    void createCatchAllCallback(OAIHttpRequestWorker *worker);
    void createSmtpDomainCallback(OAIHttpRequestWorker *worker);
    void deleteAliasCallback(OAIHttpRequestWorker *worker);
    void deleteCatchAllCallback(OAIHttpRequestWorker *worker);
    void deleteSmtpDomainCallback(OAIHttpRequestWorker *worker);
    void getMailZoneCallback(OAIHttpRequestWorker *worker);

Q_SIGNALS:

    void configureAliasSignal();
    void configureAntiSpamSignal();
    void configureSmtpDomainSignal();
    void createAliasSignal();
    void createCatchAllSignal();
    void createSmtpDomainSignal();
    void deleteAliasSignal();
    void deleteCatchAllSignal();
    void deleteSmtpDomainSignal();
    void getMailZoneSignal(OAIMailZone summary);


    void configureAliasSignalFull(OAIHttpRequestWorker *worker);
    void configureAntiSpamSignalFull(OAIHttpRequestWorker *worker);
    void configureSmtpDomainSignalFull(OAIHttpRequestWorker *worker);
    void createAliasSignalFull(OAIHttpRequestWorker *worker);
    void createCatchAllSignalFull(OAIHttpRequestWorker *worker);
    void createSmtpDomainSignalFull(OAIHttpRequestWorker *worker);
    void deleteAliasSignalFull(OAIHttpRequestWorker *worker);
    void deleteCatchAllSignalFull(OAIHttpRequestWorker *worker);
    void deleteSmtpDomainSignalFull(OAIHttpRequestWorker *worker);
    void getMailZoneSignalFull(OAIHttpRequestWorker *worker, OAIMailZone summary);

    Q_DECL_DEPRECATED_X("Use configureAliasSignalError() instead")
    void configureAliasSignalE(QNetworkReply::NetworkError error_type, QString error_str);
    void configureAliasSignalError(QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use configureAntiSpamSignalError() instead")
    void configureAntiSpamSignalE(QNetworkReply::NetworkError error_type, QString error_str);
    void configureAntiSpamSignalError(QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use configureSmtpDomainSignalError() instead")
    void configureSmtpDomainSignalE(QNetworkReply::NetworkError error_type, QString error_str);
    void configureSmtpDomainSignalError(QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use createCatchAllSignalError() instead")
    void createCatchAllSignalE(QNetworkReply::NetworkError error_type, QString error_str);
    void createCatchAllSignalError(QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use createSmtpDomainSignalError() instead")
    void createSmtpDomainSignalE(QNetworkReply::NetworkError error_type, QString error_str);
    void createSmtpDomainSignalError(QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use deleteCatchAllSignalError() instead")
    void deleteCatchAllSignalE(QNetworkReply::NetworkError error_type, QString error_str);
    void deleteCatchAllSignalError(QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use deleteSmtpDomainSignalError() instead")
    void deleteSmtpDomainSignalE(QNetworkReply::NetworkError error_type, QString error_str);
    void deleteSmtpDomainSignalError(QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use getMailZoneSignalError() instead")
    void getMailZoneSignalE(OAIMailZone summary, QNetworkReply::NetworkError error_type, QString error_str);
    void getMailZoneSignalError(OAIMailZone summary, QNetworkReply::NetworkError error_type, const QString &error_str);

    Q_DECL_DEPRECATED_X("Use configureAliasSignalErrorFull() instead")
    void configureAliasSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void configureAliasSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use configureAntiSpamSignalErrorFull() instead")
    void configureAntiSpamSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void configureAntiSpamSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use configureSmtpDomainSignalErrorFull() instead")
    void configureSmtpDomainSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void configureSmtpDomainSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use createCatchAllSignalErrorFull() instead")
    void createCatchAllSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void createCatchAllSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use createSmtpDomainSignalErrorFull() instead")
    void createSmtpDomainSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void createSmtpDomainSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use deleteCatchAllSignalErrorFull() instead")
    void deleteCatchAllSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void deleteCatchAllSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use deleteSmtpDomainSignalErrorFull() instead")
    void deleteSmtpDomainSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void deleteSmtpDomainSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use getMailZoneSignalErrorFull() instead")
    void getMailZoneSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void getMailZoneSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
