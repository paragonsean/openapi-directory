...
#ifndef OAIWindowsHosting_H
#define OAIWindowsHosting_H
...
class OAIWindowsHosting : public OAIObject {
public:
    OAIWindowsHosting();
    OAIWindowsHosting(QString json);
    ~OAIWindowsHosting() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIWindowsHosting)

#endif // OAIWindowsHosting_H
