...
#include "OAIProvisioningJobCompletion.h"
...
OAIProvisioningJobCompletion::OAIProvisioningJobCompletion(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIProvisioningJobCompletion::OAIProvisioningJobCompletion() {
    this->initializeModel();
}

OAIProvisioningJobCompletion::~OAIProvisioningJobCompletion() {}

void OAIProvisioningJobCompletion::initializeModel() {
...
void OAIProvisioningJobCompletion::fromJson(QString jsonString) {
...
void OAIProvisioningJobCompletion::fromJsonObject(QJsonObject json) {
...
QString OAIProvisioningJobCompletion::asJson() const {
...
QJsonObject OAIProvisioningJobCompletion::asJsonObject() const {
    QJsonObject obj;
    if (m_id_isSet) {
        obj.insert(QString("id"), ::OpenAPI::toJsonValue(m_id));
    }
    if (m_resource_links.size() > 0) {
        obj.insert(QString("resource_links"), ::OpenAPI::toJsonValue(m_resource_links));
    }
    return obj;
}

QString OAIProvisioningJobCompletion::getId() const {
    return m_id;
}
void OAIProvisioningJobCompletion::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIProvisioningJobCompletion::is_id_Set() const{
    return m_id_isSet;
}

bool OAIProvisioningJobCompletion::is_id_Valid() const{
    return m_id_isValid;
}

QList<QString> OAIProvisioningJobCompletion::getResourceLinks() const {
    return m_resource_links;
}
void OAIProvisioningJobCompletion::setResourceLinks(const QList<QString> &resource_links) {
    m_resource_links = resource_links;
    m_resource_links_isSet = true;
}

bool OAIProvisioningJobCompletion::is_resource_links_Set() const{
    return m_resource_links_isSet;
}

bool OAIProvisioningJobCompletion::is_resource_links_Valid() const{
    return m_resource_links_isValid;
}

bool OAIProvisioningJobCompletion::isSet() const {
...
bool OAIProvisioningJobCompletion::isValid() const {
