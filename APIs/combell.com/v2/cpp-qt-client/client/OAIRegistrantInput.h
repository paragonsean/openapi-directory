...
/*
 * OAIRegistrantInput.h
 *
 * 
 */

#ifndef OAIRegistrantInput_H
#define OAIRegistrantInput_H

#include <QJsonObject>

#include "OAIExtraField.h"
#include <QList>
#include <QString>
...
class OAIRegistrantInput : public OAIObject {
public:
    OAIRegistrantInput();
    OAIRegistrantInput(QString json);
    ~OAIRegistrantInput() override;
    ...
    QList<OAIExtraField> getExtraFields() const;
    void setExtraFields(const QList<OAIExtraField> &extra_fields);
    bool is_extra_fields_Set() const;
    bool is_extra_fields_Valid() const;
...
private:
    ...
    QList<OAIExtraField> m_extra_fields;
    bool m_extra_fields_isSet;
    bool m_extra_fields_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRegistrantInput)

#endif // OAIRegistrantInput_H
