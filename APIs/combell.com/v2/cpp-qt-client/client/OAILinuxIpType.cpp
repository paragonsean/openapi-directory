...
OAILinuxIpType::OAILinuxIpType(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAILinuxIpType::OAILinuxIpType() {
    this->initializeModel();
}

OAILinuxIpType::~OAILinuxIpType() {}

void OAILinuxIpType::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAILinuxIpType::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAILinuxIpType::fromJson(QString jsonString) {
    
    if ( jsonString.compare("dedicated", Qt::CaseInsensitive) == 0) {
        m_value = eOAILinuxIpType::DEDICATED;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("shared", Qt::CaseInsensitive) == 0) {
        m_value = eOAILinuxIpType::SHARED;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAILinuxIpType::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAILinuxIpType::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAILinuxIpType::DEDICATED:
            val = "dedicated";
            break;
        case eOAILinuxIpType::SHARED:
            val = "shared";
            break;
        default:
            break;
...
QJsonValue OAILinuxIpType::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAILinuxIpType::eOAILinuxIpType OAILinuxIpType::getValue() const {
    return m_value;
}

void OAILinuxIpType::setValue(const OAILinuxIpType::eOAILinuxIpType& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAILinuxIpType::isSet() const {
    
    return m_value_isSet;
}

bool OAILinuxIpType::isValid() const {
