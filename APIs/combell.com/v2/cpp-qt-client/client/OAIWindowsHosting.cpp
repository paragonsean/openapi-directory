...
OAIWindowsHosting::OAIWindowsHosting(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIWindowsHosting::OAIWindowsHosting() {
    this->initializeModel();
}

OAIWindowsHosting::~OAIWindowsHosting() {}

void OAIWindowsHosting::initializeModel() {
...
void OAIWindowsHosting::fromJson(QString jsonString) {
...
void OAIWindowsHosting::fromJsonObject(QJsonObject json) {
...
QString OAIWindowsHosting::asJson() const {
...
QJsonObject OAIWindowsHosting::asJsonObject() const {
    QJsonObject obj;
...
QString OAIWindowsHosting::getDomainName() const {
    return m_domain_name;
}
void OAIWindowsHosting::setDomainName(const QString &domain_name) {
    m_domain_name = domain_name;
    m_domain_name_isSet = true;
}

bool OAIWindowsHosting::is_domain_name_Set() const{
    return m_domain_name_isSet;
}

bool OAIWindowsHosting::is_domain_name_Valid() const{
    return m_domain_name_isValid;
}

qint32 OAIWindowsHosting::getServicepackId() const {
    return m_servicepack_id;
}
void OAIWindowsHosting::setServicepackId(const qint32 &servicepack_id) {
    m_servicepack_id = servicepack_id;
    m_servicepack_id_isSet = true;
}

bool OAIWindowsHosting::is_servicepack_id_Set() const{
    return m_servicepack_id_isSet;
}

bool OAIWindowsHosting::is_servicepack_id_Valid() const{
    return m_servicepack_id_isValid;
}

bool OAIWindowsHosting::isSet() const {
...
bool OAIWindowsHosting::isValid() const {
