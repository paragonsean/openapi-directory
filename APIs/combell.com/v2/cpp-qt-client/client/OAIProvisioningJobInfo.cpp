...
OAIProvisioningJobInfo::OAIProvisioningJobInfo(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIProvisioningJobInfo::OAIProvisioningJobInfo() {
    this->initializeModel();
}

OAIProvisioningJobInfo::~OAIProvisioningJobInfo() {}

void OAIProvisioningJobInfo::initializeModel() {
...
void OAIProvisioningJobInfo::fromJson(QString jsonString) {
...
void OAIProvisioningJobInfo::fromJsonObject(QJsonObject json) {
...
QString OAIProvisioningJobInfo::asJson() const {
...
QJsonObject OAIProvisioningJobInfo::asJsonObject() const {
    QJsonObject obj;
    if (m_completion.isSet()) {
...
OAICompletionEstimation OAIProvisioningJobInfo::getCompletion() const {
    return m_completion;
}
void OAIProvisioningJobInfo::setCompletion(const OAICompletionEstimation &completion) {
    m_completion = completion;
    m_completion_isSet = true;
}

bool OAIProvisioningJobInfo::is_completion_Set() const{
    return m_completion_isSet;
}

bool OAIProvisioningJobInfo::is_completion_Valid() const{
    return m_completion_isValid;
}

QString OAIProvisioningJobInfo::getId() const {
    return m_id;
}
void OAIProvisioningJobInfo::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIProvisioningJobInfo::is_id_Set() const{
    return m_id_isSet;
}

bool OAIProvisioningJobInfo::is_id_Valid() const{
    return m_id_isValid;
}

OAIProvisioningJobStatus OAIProvisioningJobInfo::getStatus() const {
    return m_status;
}
void OAIProvisioningJobInfo::setStatus(const OAIProvisioningJobStatus &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIProvisioningJobInfo::is_status_Set() const{
    return m_status_isSet;
}

bool OAIProvisioningJobInfo::is_status_Valid() const{
    return m_status_isValid;
}

bool OAIProvisioningJobInfo::isSet() const {
...
bool OAIProvisioningJobInfo::isValid() const {
