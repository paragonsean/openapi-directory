...
#include "OAISslCertificateRequestValidation.h"
...
OAISslCertificateRequestValidation::OAISslCertificateRequestValidation(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISslCertificateRequestValidation::OAISslCertificateRequestValidation() {
    this->initializeModel();
}

OAISslCertificateRequestValidation::~OAISslCertificateRequestValidation() {}

void OAISslCertificateRequestValidation::initializeModel() {

    m_auto_validated_isSet = false;
    m_auto_validated_isValid = false;

    m_cname_validation_content_isSet = false;
    m_cname_validation_content_isValid = false;

    m_cname_validation_name_isSet = false;
    m_cname_validation_name_isValid = false;
    ...
    m_file_validation_content_isSet = false;
    m_file_validation_content_isValid = false;

    m_file_validation_url_http_isSet = false;
    m_file_validation_url_http_isValid = false;

    m_file_validation_url_https_isSet = false;
    m_file_validation_url_https_isValid = false;

    m_type_isSet = false;
    m_type_isValid = false;
}

void OAISslCertificateRequestValidation::fromJson(QString jsonString) {
...
void OAISslCertificateRequestValidation::fromJsonObject(QJsonObject json) {

    m_auto_validated_isValid = ::OpenAPI::fromJsonValue(m_auto_validated, json[QString("auto_validated")]);
    m_auto_validated_isSet = !json[QString("auto_validated")].isNull() && m_auto_validated_isValid;

    m_cname_validation_content_isValid = ::OpenAPI::fromJsonValue(m_cname_validation_content, json[QString("cname_validation_content")]);
    m_cname_validation_content_isSet = !json[QString("cname_validation_content")].isNull() && m_cname_validation_content_isValid;

    m_cname_validation_name_isValid = ::OpenAPI::fromJsonValue(m_cname_validation_name, json[QString("cname_validation_name")]);
    m_cname_validation_name_isSet = !json[QString("cname_validation_name")].isNull() && m_cname_validation_name_isValid;
    ...
    m_file_validation_content_isValid = ::OpenAPI::fromJsonValue(m_file_validation_content, json[QString("file_validation_content")]);
    m_file_validation_content_isSet = !json[QString("file_validation_content")].isNull() && m_file_validation_content_isValid;

    m_file_validation_url_http_isValid = ::OpenAPI::fromJsonValue(m_file_validation_url_http, json[QString("file_validation_url_http")]);
    m_file_validation_url_http_isSet = !json[QString("file_validation_url_http")].isNull() && m_file_validation_url_http_isValid;

    m_file_validation_url_https_isValid = ::OpenAPI::fromJsonValue(m_file_validation_url_https, json[QString("file_validation_url_https")]);
    m_file_validation_url_https_isSet = !json[QString("file_validation_url_https")].isNull() && m_file_validation_url_https_isValid;

    m_type_isValid = ::OpenAPI::fromJsonValue(m_type, json[QString("type")]);
    m_type_isSet = !json[QString("type")].isNull() && m_type_isValid;
}

QString OAISslCertificateRequestValidation::asJson() const {
...
QJsonObject OAISslCertificateRequestValidation::asJsonObject() const {
    QJsonObject obj;
    if (m_auto_validated_isSet) {
        obj.insert(QString("auto_validated"), ::OpenAPI::toJsonValue(m_auto_validated));
    }
    if (m_cname_validation_content_isSet) {
        obj.insert(QString("cname_validation_content"), ::OpenAPI::toJsonValue(m_cname_validation_content));
    }
    if (m_cname_validation_name_isSet) {
        obj.insert(QString("cname_validation_name"), ::OpenAPI::toJsonValue(m_cname_validation_name));
    }
    if (m_dns_name_isSet) {
    ...
    if (m_file_validation_content.size() > 0) {
        obj.insert(QString("file_validation_content"), ::OpenAPI::toJsonValue(m_file_validation_content));
    }
    if (m_file_validation_url_http_isSet) {
        obj.insert(QString("file_validation_url_http"), ::OpenAPI::toJsonValue(m_file_validation_url_http));
    }
    if (m_file_validation_url_https_isSet) {
        obj.insert(QString("file_validation_url_https"), ::OpenAPI::toJsonValue(m_file_validation_url_https));
    }
    if (m_type.isSet()) {
...
bool OAISslCertificateRequestValidation::isAutoValidated() const {
    return m_auto_validated;
}
void OAISslCertificateRequestValidation::setAutoValidated(const bool &auto_validated) {
    m_auto_validated = auto_validated;
    m_auto_validated_isSet = true;
}

bool OAISslCertificateRequestValidation::is_auto_validated_Set() const{
    return m_auto_validated_isSet;
}

bool OAISslCertificateRequestValidation::is_auto_validated_Valid() const{
    return m_auto_validated_isValid;
}

QString OAISslCertificateRequestValidation::getCnameValidationContent() const {
    return m_cname_validation_content;
}
void OAISslCertificateRequestValidation::setCnameValidationContent(const QString &cname_validation_content) {
    m_cname_validation_content = cname_validation_content;
    m_cname_validation_content_isSet = true;
}

bool OAISslCertificateRequestValidation::is_cname_validation_content_Set() const{
    return m_cname_validation_content_isSet;
}

bool OAISslCertificateRequestValidation::is_cname_validation_content_Valid() const{
    return m_cname_validation_content_isValid;
}

QString OAISslCertificateRequestValidation::getCnameValidationName() const {
    return m_cname_validation_name;
}
void OAISslCertificateRequestValidation::setCnameValidationName(const QString &cname_validation_name) {
    m_cname_validation_name = cname_validation_name;
    m_cname_validation_name_isSet = true;
}

bool OAISslCertificateRequestValidation::is_cname_validation_name_Set() const{
    return m_cname_validation_name_isSet;
}

bool OAISslCertificateRequestValidation::is_cname_validation_name_Valid() const{
    return m_cname_validation_name_isValid;
}

QString OAISslCertificateRequestValidation::getDnsName() const {
    return m_dns_name;
}
void OAISslCertificateRequestValidation::setDnsName(const QString &dns_name) {
    m_dns_name = dns_name;
    m_dns_name_isSet = true;
}

bool OAISslCertificateRequestValidation::is_dns_name_Set() const{
    return m_dns_name_isSet;
}

bool OAISslCertificateRequestValidation::is_dns_name_Valid() const{
    return m_dns_name_isValid;
}

QList<QString> OAISslCertificateRequestValidation::getEmailAddresses() const {
    return m_email_addresses;
}
void OAISslCertificateRequestValidation::setEmailAddresses(const QList<QString> &email_addresses) {
    m_email_addresses = email_addresses;
    m_email_addresses_isSet = true;
}

bool OAISslCertificateRequestValidation::is_email_addresses_Set() const{
    return m_email_addresses_isSet;
}

bool OAISslCertificateRequestValidation::is_email_addresses_Valid() const{
    return m_email_addresses_isValid;
}

QList<QString> OAISslCertificateRequestValidation::getFileValidationContent() const {
    return m_file_validation_content;
}
void OAISslCertificateRequestValidation::setFileValidationContent(const QList<QString> &file_validation_content) {
    m_file_validation_content = file_validation_content;
    m_file_validation_content_isSet = true;
}

bool OAISslCertificateRequestValidation::is_file_validation_content_Set() const{
    return m_file_validation_content_isSet;
}

bool OAISslCertificateRequestValidation::is_file_validation_content_Valid() const{
    return m_file_validation_content_isValid;
}

QString OAISslCertificateRequestValidation::getFileValidationUrlHttp() const {
    return m_file_validation_url_http;
}
void OAISslCertificateRequestValidation::setFileValidationUrlHttp(const QString &file_validation_url_http) {
    m_file_validation_url_http = file_validation_url_http;
    m_file_validation_url_http_isSet = true;
}

bool OAISslCertificateRequestValidation::is_file_validation_url_http_Set() const{
    return m_file_validation_url_http_isSet;
}

bool OAISslCertificateRequestValidation::is_file_validation_url_http_Valid() const{
    return m_file_validation_url_http_isValid;
}

QString OAISslCertificateRequestValidation::getFileValidationUrlHttps() const {
    return m_file_validation_url_https;
}
void OAISslCertificateRequestValidation::setFileValidationUrlHttps(const QString &file_validation_url_https) {
    m_file_validation_url_https = file_validation_url_https;
    m_file_validation_url_https_isSet = true;
}

bool OAISslCertificateRequestValidation::is_file_validation_url_https_Set() const{
    return m_file_validation_url_https_isSet;
}

bool OAISslCertificateRequestValidation::is_file_validation_url_https_Valid() const{
    return m_file_validation_url_https_isValid;
}

OAISslCertificateRequestValidationType OAISslCertificateRequestValidation::getType() const {
    return m_type;
}
void OAISslCertificateRequestValidation::setType(const OAISslCertificateRequestValidationType &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAISslCertificateRequestValidation::is_type_Set() const{
    return m_type_isSet;
}

bool OAISslCertificateRequestValidation::is_type_Valid() const{
    return m_type_isValid;
}

bool OAISslCertificateRequestValidation::isSet() const {
...
bool OAISslCertificateRequestValidation::isValid() const {
