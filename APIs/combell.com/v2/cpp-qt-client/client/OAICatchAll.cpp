...
OAICatchAll::OAICatchAll(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICatchAll::OAICatchAll() {
    this->initializeModel();
}

OAICatchAll::~OAICatchAll() {}

void OAICatchAll::initializeModel() {

    m_email_addresses_isSet = false;
    m_email_addresses_isValid = false;
}

void OAICatchAll::fromJson(QString jsonString) {
...
void OAICatchAll::fromJsonObject(QJsonObject json) {
...
QString OAICatchAll::asJson() const {
...
QJsonObject OAICatchAll::asJsonObject() const {
    QJsonObject obj;
...
QList<QString> OAICatchAll::getEmailAddresses() const {
    return m_email_addresses;
}
void OAICatchAll::setEmailAddresses(const QList<QString> &email_addresses) {
    m_email_addresses = email_addresses;
    m_email_addresses_isSet = true;
}

bool OAICatchAll::is_email_addresses_Set() const{
    return m_email_addresses_isSet;
}

bool OAICatchAll::is_email_addresses_Valid() const{
    return m_email_addresses_isValid;
}

bool OAICatchAll::isSet() const {
...
bool OAICatchAll::isValid() const {
