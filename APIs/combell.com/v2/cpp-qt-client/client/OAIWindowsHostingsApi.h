...
#ifndef OAI_OAIWindowsHostingsApi_H
#define OAI_OAIWindowsHostingsApi_H
...
#include "OAIWindowsHosting.h"
#include "OAIWindowsHostingDetail.h"
#include <QString>
...
class OAIWindowsHostingsApi : public QObject {
    Q_OBJECT

public:
    OAIWindowsHostingsApi(const int timeOut = 0);
    ~OAIWindowsHostingsApi();
    ...
    */
    virtual void getWindowsHosting(const QString &domain_name, const QString &domain_name2);

    /**
    * @param[in]  skip qint32 [optional]
    * @param[in]  take qint32 [optional]
    */
    virtual void getWindowsHostings(const ::OpenAPI::OptionalParam<qint32> &skip = ::OpenAPI::OptionalParam<qint32>(), const ::OpenAPI::OptionalParam<qint32> &take = ::OpenAPI::OptionalParam<qint32>());
...
private:
    ...
    void getWindowsHostingCallback(OAIHttpRequestWorker *worker);
    void getWindowsHostingsCallback(OAIHttpRequestWorker *worker);

Q_SIGNALS:

    void getWindowsHostingSignal(OAIWindowsHostingDetail summary);
    void getWindowsHostingsSignal(QList<OAIWindowsHosting> summary);


    void getWindowsHostingSignalFull(OAIHttpRequestWorker *worker, OAIWindowsHostingDetail summary);
    void getWindowsHostingsSignalFull(OAIHttpRequestWorker *worker, QList<OAIWindowsHosting> summary);

    Q_DECL_DEPRECATED_X("Use getWindowsHostingSignalError() instead")
    void getWindowsHostingSignalE(OAIWindowsHostingDetail summary, QNetworkReply::NetworkError error_type, QString error_str);
    void getWindowsHostingSignalError(OAIWindowsHostingDetail summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use getWindowsHostingsSignalError() instead")
    void getWindowsHostingsSignalE(QList<OAIWindowsHosting> summary, QNetworkReply::NetworkError error_type, QString error_str);
    void getWindowsHostingsSignalError(QList<OAIWindowsHosting> summary, QNetworkReply::NetworkError error_type, const QString &error_str);

    Q_DECL_DEPRECATED_X("Use getWindowsHostingSignalErrorFull() instead")
    void getWindowsHostingSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void getWindowsHostingSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use getWindowsHostingsSignalErrorFull() instead")
    void getWindowsHostingsSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void getWindowsHostingsSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
