...
#ifndef OAISmtpDomain_H
#define OAISmtpDomain_H
...
class OAISmtpDomain : public OAIObject {
public:
    OAISmtpDomain();
    OAISmtpDomain(QString json);
    ~OAISmtpDomain() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISmtpDomain)

#endif // OAISmtpDomain_H
