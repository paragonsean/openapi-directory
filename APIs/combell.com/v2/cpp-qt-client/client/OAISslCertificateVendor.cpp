...
OAISslCertificateVendor::OAISslCertificateVendor(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISslCertificateVendor::OAISslCertificateVendor() {
    this->initializeModel();
}

OAISslCertificateVendor::~OAISslCertificateVendor() {}

void OAISslCertificateVendor::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAISslCertificateVendor::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAISslCertificateVendor::fromJson(QString jsonString) {
    
    if ( jsonString.compare("sectigo", Qt::CaseInsensitive) == 0) {
        m_value = eOAISslCertificateVendor::SECTIGO;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAISslCertificateVendor::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAISslCertificateVendor::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAISslCertificateVendor::SECTIGO:
            val = "sectigo";
            break;
        default:
            break;
...
QJsonValue OAISslCertificateVendor::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAISslCertificateVendor::eOAISslCertificateVendor OAISslCertificateVendor::getValue() const {
    return m_value;
}

void OAISslCertificateVendor::setValue(const OAISslCertificateVendor::eOAISslCertificateVendor& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAISslCertificateVendor::isSet() const {
    
    return m_value_isSet;
}

bool OAISslCertificateVendor::isValid() const {
