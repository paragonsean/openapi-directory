...
OAIMySqlUser::OAIMySqlUser(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIMySqlUser::OAIMySqlUser() {
    this->initializeModel();
}

OAIMySqlUser::~OAIMySqlUser() {}

void OAIMySqlUser::initializeModel() {
...
void OAIMySqlUser::fromJson(QString jsonString) {
...
void OAIMySqlUser::fromJsonObject(QJsonObject json) {
...
QString OAIMySqlUser::asJson() const {
...
QJsonObject OAIMySqlUser::asJsonObject() const {
    QJsonObject obj;
    if (m_enabled_isSet) {
...
bool OAIMySqlUser::isEnabled() const {
    return m_enabled;
}
void OAIMySqlUser::setEnabled(const bool &enabled) {
    m_enabled = enabled;
    m_enabled_isSet = true;
}

bool OAIMySqlUser::is_enabled_Set() const{
    return m_enabled_isSet;
}

bool OAIMySqlUser::is_enabled_Valid() const{
    return m_enabled_isValid;
}

QString OAIMySqlUser::getName() const {
    return m_name;
}
void OAIMySqlUser::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIMySqlUser::is_name_Set() const{
    return m_name_isSet;
}

bool OAIMySqlUser::is_name_Valid() const{
    return m_name_isValid;
}

OAIUserRights OAIMySqlUser::getRights() const {
    return m_rights;
}
void OAIMySqlUser::setRights(const OAIUserRights &rights) {
    m_rights = rights;
    m_rights_isSet = true;
}

bool OAIMySqlUser::is_rights_Set() const{
    return m_rights_isSet;
}

bool OAIMySqlUser::is_rights_Valid() const{
    return m_rights_isValid;
}

bool OAIMySqlUser::isSet() const {
...
bool OAIMySqlUser::isValid() const {
