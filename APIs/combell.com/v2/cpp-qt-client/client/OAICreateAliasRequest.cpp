...
QList<QString> OAICreateAliasRequest::getDestinations() const {
    return m_destinations;
}
void OAICreateAliasRequest::setDestinations(const QList<QString> &destinations) {
    m_destinations = destinations;
    m_destinations_isSet = true;
}

bool OAICreateAliasRequest::is_destinations_Set() const{
    return m_destinations_isSet;
}

bool OAICreateAliasRequest::is_destinations_Valid() const{
    return m_destinations_isValid;
}

QString OAICreateAliasRequest::getEmailAddress() const {
    return m_email_address;
}
void OAICreateAliasRequest::setEmailAddress(const QString &email_address) {
    m_email_address = email_address;
    m_email_address_isSet = true;
}

bool OAICreateAliasRequest::is_email_address_Set() const{
    return m_email_address_isSet;
}

bool OAICreateAliasRequest::is_email_address_Valid() const{
