...
OAIAddSshKeyRequest::OAIAddSshKeyRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAddSshKeyRequest::OAIAddSshKeyRequest() {
    this->initializeModel();
}

OAIAddSshKeyRequest::~OAIAddSshKeyRequest() {}

void OAIAddSshKeyRequest::initializeModel() {

    m_public_key_isSet = false;
    m_public_key_isValid = false;
}

void OAIAddSshKeyRequest::fromJson(QString jsonString) {
...
void OAIAddSshKeyRequest::fromJsonObject(QJsonObject json) {
...
QString OAIAddSshKeyRequest::asJson() const {
...
QJsonObject OAIAddSshKeyRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIAddSshKeyRequest::getPublicKey() const {
    return m_public_key;
}
void OAIAddSshKeyRequest::setPublicKey(const QString &public_key) {
    m_public_key = public_key;
    m_public_key_isSet = true;
}

bool OAIAddSshKeyRequest::is_public_key_Set() const{
    return m_public_key_isSet;
}

bool OAIAddSshKeyRequest::is_public_key_Valid() const{
    return m_public_key_isValid;
}

bool OAIAddSshKeyRequest::isSet() const {
...
bool OAIAddSshKeyRequest::isValid() const {
