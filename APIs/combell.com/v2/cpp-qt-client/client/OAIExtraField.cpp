...
OAIExtraField::OAIExtraField(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIExtraField::OAIExtraField() {
    this->initializeModel();
}

OAIExtraField::~OAIExtraField() {}

void OAIExtraField::initializeModel() {
...
void OAIExtraField::fromJson(QString jsonString) {
...
void OAIExtraField::fromJsonObject(QJsonObject json) {
...
QString OAIExtraField::asJson() const {
...
QJsonObject OAIExtraField::asJsonObject() const {
    QJsonObject obj;
    if (m_name_isSet) {
...
QString OAIExtraField::getName() const {
    return m_name;
}
void OAIExtraField::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIExtraField::is_name_Set() const{
    return m_name_isSet;
}

bool OAIExtraField::is_name_Valid() const{
    return m_name_isValid;
}

QString OAIExtraField::getValue() const {
    return m_value;
}
void OAIExtraField::setValue(const QString &value) {
    m_value = value;
    m_value_isSet = true;
}

bool OAIExtraField::is_value_Set() const{
    return m_value_isSet;
}

bool OAIExtraField::is_value_Valid() const{
    return m_value_isValid;
}

bool OAIExtraField::isSet() const {
...
bool OAIExtraField::isValid() const {
