...
public:
    ...
    /**
    * @param[in]  oai_create_account OAICreateAccount [optional]
    */
    virtual void createAccount(const ::OpenAPI::OptionalParam<OAICreateAccount> &oai_create_account = ::OpenAPI::OptionalParam<OAICreateAccount>());

    /**
    * @param[in]  account_id qint32 [required]
    * @param[in]  account_id2 QString [required]
    */
    virtual void getAccount(const qint32 &account_id, const QString &account_id2);

    /**
    * @param[in]  skip qint32 [optional]
    * @param[in]  take qint32 [optional]
    * @param[in]  asset_type OAIAssetType [optional]
    * @param[in]  identifier QString [optional]
    */
    virtual void getAccounts(const ::OpenAPI::OptionalParam<qint32> &skip = ::OpenAPI::OptionalParam<qint32>(), const ::OpenAPI::OptionalParam<qint32> &take = ::OpenAPI::OptionalParam<qint32>(), const ::OpenAPI::OptionalParam<OAIAssetType> &asset_type = ::OpenAPI::OptionalParam<OAIAssetType>(), const ::OpenAPI::OptionalParam<QString> &identifier = ::OpenAPI::OptionalParam<QString>());
...
Q_SIGNALS:
    ...
    void getAccountSignal(OAIAccountDetail summary);
    void getAccountsSignal(QList<OAIAccount> summary);


    void createAccountSignalFull(OAIHttpRequestWorker *worker);
    void getAccountSignalFull(OAIHttpRequestWorker *worker, OAIAccountDetail summary);
    ...
    void createAccountSignalE(QNetworkReply::NetworkError error_type, QString error_str);
    void createAccountSignalError(QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use getAccountSignalError() instead")
    void getAccountSignalE(OAIAccountDetail summary, QNetworkReply::NetworkError error_type, QString error_str);
    void getAccountSignalError(OAIAccountDetail summary, QNetworkReply::NetworkError error_type, const QString &error_str);
