...
void OAISSHApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("getAllSshKeys", defaultConf);
    _serverIndices.insert("getAllSshKeys", 0);
}
...
void OAISSHApi::getAllSshKeys(const ::OpenAPI::OptionalParam<qint32> &skip, const ::OpenAPI::OptionalParam<qint32> &take) {
    QString fullPath = QString(_serverConfigs["getAllSshKeys"][_serverIndices.value("getAllSshKeys")].URL()+"/ssh");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAISSHApi::getAllSshKeysCallback);
...
void OAISSHApi::getAllSshKeysCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT getAllSshKeysSignal(output);
        Q_EMIT getAllSshKeysSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT getAllSshKeysSignalE(output, error_type, error_str);
        Q_EMIT getAllSshKeysSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT getAllSshKeysSignalError(output, error_type, error_str);
        Q_EMIT getAllSshKeysSignalErrorFull(worker, error_type, error_str);
    }
}
