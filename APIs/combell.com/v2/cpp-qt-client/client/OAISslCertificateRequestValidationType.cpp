...
OAISslCertificateRequestValidationType::OAISslCertificateRequestValidationType(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISslCertificateRequestValidationType::OAISslCertificateRequestValidationType() {
    this->initializeModel();
}

OAISslCertificateRequestValidationType::~OAISslCertificateRequestValidationType() {}

void OAISslCertificateRequestValidationType::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAISslCertificateRequestValidationType::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAISslCertificateRequestValidationType::fromJson(QString jsonString) {
    
    if ( jsonString.compare("dns", Qt::CaseInsensitive) == 0) {
        m_value = eOAISslCertificateRequestValidationType::DNS;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("file", Qt::CaseInsensitive) == 0) {
        m_value = eOAISslCertificateRequestValidationType::FILE;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("email", Qt::CaseInsensitive) == 0) {
        m_value = eOAISslCertificateRequestValidationType::EMAIL;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAISslCertificateRequestValidationType::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAISslCertificateRequestValidationType::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAISslCertificateRequestValidationType::DNS:
            val = "dns";
            break;
        case eOAISslCertificateRequestValidationType::FILE:
            val = "file";
            break;
        case eOAISslCertificateRequestValidationType::EMAIL:
            val = "email";
            break;
        default:
            break;
...
QJsonValue OAISslCertificateRequestValidationType::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAISslCertificateRequestValidationType::eOAISslCertificateRequestValidationType OAISslCertificateRequestValidationType::getValue() const {
    return m_value;
}

void OAISslCertificateRequestValidationType::setValue(const OAISslCertificateRequestValidationType::eOAISslCertificateRequestValidationType& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAISslCertificateRequestValidationType::isSet() const {
    
    return m_value_isSet;
}

bool OAISslCertificateRequestValidationType::isValid() const {
