...
#include "OAICreateSslCertificateRequest.h"
...
OAICreateSslCertificateRequest::OAICreateSslCertificateRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateSslCertificateRequest::OAICreateSslCertificateRequest() {
    this->initializeModel();
}

OAICreateSslCertificateRequest::~OAICreateSslCertificateRequest() {}

void OAICreateSslCertificateRequest::initializeModel() {

    m_additional_validation_attributes_isSet = false;
    m_additional_validation_attributes_isValid = false;
...
void OAICreateSslCertificateRequest::fromJson(QString jsonString) {
...
void OAICreateSslCertificateRequest::fromJsonObject(QJsonObject json) {

    m_additional_validation_attributes_isValid = ::OpenAPI::fromJsonValue(m_additional_validation_attributes, json[QString("additional_validation_attributes")]);
    m_additional_validation_attributes_isSet = !json[QString("additional_validation_attributes")].isNull() && m_additional_validation_attributes_isValid;
...
QString OAICreateSslCertificateRequest::asJson() const {
...
QJsonObject OAICreateSslCertificateRequest::asJsonObject() const {
    QJsonObject obj;
    if (m_additional_validation_attributes.size() > 0) {
        obj.insert(QString("additional_validation_attributes"), ::OpenAPI::toJsonValue(m_additional_validation_attributes));
    }
...
QList<OAIAdditionalValidationAttribute> OAICreateSslCertificateRequest::getAdditionalValidationAttributes() const {
    return m_additional_validation_attributes;
}
void OAICreateSslCertificateRequest::setAdditionalValidationAttributes(const QList<OAIAdditionalValidationAttribute> &additional_validation_attributes) {
    m_additional_validation_attributes = additional_validation_attributes;
    m_additional_validation_attributes_isSet = true;
}

bool OAICreateSslCertificateRequest::is_additional_validation_attributes_Set() const{
    return m_additional_validation_attributes_isSet;
}

bool OAICreateSslCertificateRequest::is_additional_validation_attributes_Valid() const{
    return m_additional_validation_attributes_isValid;
}

OAISslCertificateType OAICreateSslCertificateRequest::getCertificateType() const {
    return m_certificate_type;
}
void OAICreateSslCertificateRequest::setCertificateType(const OAISslCertificateType &certificate_type) {
    m_certificate_type = certificate_type;
    m_certificate_type_isSet = true;
}

bool OAICreateSslCertificateRequest::is_certificate_type_Set() const{
    return m_certificate_type_isSet;
}

bool OAICreateSslCertificateRequest::is_certificate_type_Valid() const{
    return m_certificate_type_isValid;
}

QString OAICreateSslCertificateRequest::getCsr() const {
    return m_csr;
}
void OAICreateSslCertificateRequest::setCsr(const QString &csr) {
    m_csr = csr;
    m_csr_isSet = true;
}

bool OAICreateSslCertificateRequest::is_csr_Set() const{
    return m_csr_isSet;
}

bool OAICreateSslCertificateRequest::is_csr_Valid() const{
    return m_csr_isValid;
}

OAISslCertificateValidationLevel OAICreateSslCertificateRequest::getValidationLevel() const {
    return m_validation_level;
}
void OAICreateSslCertificateRequest::setValidationLevel(const OAISslCertificateValidationLevel &validation_level) {
    m_validation_level = validation_level;
    m_validation_level_isSet = true;
}

bool OAICreateSslCertificateRequest::is_validation_level_Set() const{
    return m_validation_level_isSet;
}

bool OAICreateSslCertificateRequest::is_validation_level_Valid() const{
    return m_validation_level_isValid;
}

bool OAICreateSslCertificateRequest::isSet() const {
...
bool OAICreateSslCertificateRequest::isValid() const {
