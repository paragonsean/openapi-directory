...
#include "OAIUpdatePhpMemoryLimitRequest.h"
...
OAIUpdatePhpMemoryLimitRequest::OAIUpdatePhpMemoryLimitRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdatePhpMemoryLimitRequest::OAIUpdatePhpMemoryLimitRequest() {
    this->initializeModel();
}

OAIUpdatePhpMemoryLimitRequest::~OAIUpdatePhpMemoryLimitRequest() {}

void OAIUpdatePhpMemoryLimitRequest::initializeModel() {

    m_memory_limit_isSet = false;
    m_memory_limit_isValid = false;
}

void OAIUpdatePhpMemoryLimitRequest::fromJson(QString jsonString) {
...
void OAIUpdatePhpMemoryLimitRequest::fromJsonObject(QJsonObject json) {
...
QString OAIUpdatePhpMemoryLimitRequest::asJson() const {
...
QJsonObject OAIUpdatePhpMemoryLimitRequest::asJsonObject() const {
    QJsonObject obj;
...
qint32 OAIUpdatePhpMemoryLimitRequest::getMemoryLimit() const {
    return m_memory_limit;
}
void OAIUpdatePhpMemoryLimitRequest::setMemoryLimit(const qint32 &memory_limit) {
    m_memory_limit = memory_limit;
    m_memory_limit_isSet = true;
}

bool OAIUpdatePhpMemoryLimitRequest::is_memory_limit_Set() const{
    return m_memory_limit_isSet;
}

bool OAIUpdatePhpMemoryLimitRequest::is_memory_limit_Valid() const{
    return m_memory_limit_isValid;
}

bool OAIUpdatePhpMemoryLimitRequest::isSet() const {
...
bool OAIUpdatePhpMemoryLimitRequest::isValid() const {
