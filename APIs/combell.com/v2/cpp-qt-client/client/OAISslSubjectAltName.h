...
/*
 * OAISslSubjectAltName.h
 *
 * 
 */

#ifndef OAISslSubjectAltName_H
#define OAISslSubjectAltName_H
...
class OAISslSubjectAltName : public OAIObject {
public:
    OAISslSubjectAltName();
    OAISslSubjectAltName(QString json);
    ~OAISslSubjectAltName() override;
    ...
    OAISslSubjectAltNameType getType() const;
    void setType(const OAISslSubjectAltNameType &type);
...
private:
    ...
    OAISslSubjectAltNameType m_type;
    bool m_type_isSet;
    bool m_type_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAISslSubjectAltName)

#endif // OAISslSubjectAltName_H
