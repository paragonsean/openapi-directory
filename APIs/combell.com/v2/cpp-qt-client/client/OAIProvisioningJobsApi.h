...
#ifndef OAI_OAIProvisioningJobsApi_H
#define OAI_OAIProvisioningJobsApi_H
...
#include "OAIProvisioningJobInfo.h"
#include <QString>
...
class OAIProvisioningJobsApi : public QObject {
    Q_OBJECT

public:
    OAIProvisioningJobsApi(const int timeOut = 0);
    ~OAIProvisioningJobsApi();
    ...
    * @param[in]  job_id2 QString [required]
    */
    virtual void provisioningjobsJobIdGet(const QString &job_id, const QString &job_id2);
...
private:
    ...
    void provisioningjobsJobIdGetCallback(OAIHttpRequestWorker *worker);

Q_SIGNALS:

    void provisioningjobsJobIdGetSignal(OAIProvisioningJobInfo summary);


    void provisioningjobsJobIdGetSignalFull(OAIHttpRequestWorker *worker, OAIProvisioningJobInfo summary);

    Q_DECL_DEPRECATED_X("Use provisioningjobsJobIdGetSignalError() instead")
    void provisioningjobsJobIdGetSignalE(OAIProvisioningJobInfo summary, QNetworkReply::NetworkError error_type, QString error_str);
    void provisioningjobsJobIdGetSignalError(OAIProvisioningJobInfo summary, QNetworkReply::NetworkError error_type, const QString &error_str);

    Q_DECL_DEPRECATED_X("Use provisioningjobsJobIdGetSignalErrorFull() instead")
    void provisioningjobsJobIdGetSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void provisioningjobsJobIdGetSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
