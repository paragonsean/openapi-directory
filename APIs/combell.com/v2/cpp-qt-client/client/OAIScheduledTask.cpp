...
OAIScheduledTask::OAIScheduledTask(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIScheduledTask::OAIScheduledTask() {
    this->initializeModel();
}

OAIScheduledTask::~OAIScheduledTask() {}

void OAIScheduledTask::initializeModel() {
...
void OAIScheduledTask::fromJson(QString jsonString) {
...
void OAIScheduledTask::fromJsonObject(QJsonObject json) {
    ...
    m_script_location_isValid = ::OpenAPI::fromJsonValue(m_script_location, json[QString("script_location")]);
    m_script_location_isSet = !json[QString("script_location")].isNull() && m_script_location_isValid;
}

QString OAIScheduledTask::asJson() const {
...
QJsonObject OAIScheduledTask::asJsonObject() const {
    QJsonObject obj;
    ...
    if (m_script_location_isSet) {
        obj.insert(QString("script_location"), ::OpenAPI::toJsonValue(m_script_location));
    }
    return obj;
}

QString OAIScheduledTask::getCronExpression() const {
    return m_cron_expression;
}
void OAIScheduledTask::setCronExpression(const QString &cron_expression) {
    m_cron_expression = cron_expression;
    m_cron_expression_isSet = true;
}

bool OAIScheduledTask::is_cron_expression_Set() const{
    return m_cron_expression_isSet;
}

bool OAIScheduledTask::is_cron_expression_Valid() const{
    return m_cron_expression_isValid;
}

bool OAIScheduledTask::isEnabled() const {
    return m_enabled;
}
void OAIScheduledTask::setEnabled(const bool &enabled) {
    m_enabled = enabled;
    m_enabled_isSet = true;
}

bool OAIScheduledTask::is_enabled_Set() const{
    return m_enabled_isSet;
}

bool OAIScheduledTask::is_enabled_Valid() const{
    return m_enabled_isValid;
}

QString OAIScheduledTask::getId() const {
    return m_id;
}
void OAIScheduledTask::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIScheduledTask::is_id_Set() const{
    return m_id_isSet;
}

bool OAIScheduledTask::is_id_Valid() const{
    return m_id_isValid;
}

QString OAIScheduledTask::getScriptLocation() const {
    return m_script_location;
}
void OAIScheduledTask::setScriptLocation(const QString &script_location) {
    m_script_location = script_location;
    m_script_location_isSet = true;
}

bool OAIScheduledTask::is_script_location_Set() const{
    return m_script_location_isSet;
}

bool OAIScheduledTask::is_script_location_Valid() const{
    return m_script_location_isValid;
}

bool OAIScheduledTask::isSet() const {
...
bool OAIScheduledTask::isValid() const {
