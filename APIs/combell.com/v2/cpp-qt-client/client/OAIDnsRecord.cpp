...
void OAIDnsRecord::fromJsonObject(QJsonObject json) {
    ...
    m_record_name_isValid = ::OpenAPI::fromJsonValue(m_record_name, json[QString("record_name")]);
    m_record_name_isSet = !json[QString("record_name")].isNull() && m_record_name_isValid;
...
QJsonObject OAIDnsRecord::asJsonObject() const {
    ...
    if (m_record_name_isSet) {
        obj.insert(QString("record_name"), ::OpenAPI::toJsonValue(m_record_name));
    }
    if (m_service_isSet) {
...
qint32 OAIDnsRecord::getPort() const {
    return m_port;
}
void OAIDnsRecord::setPort(const qint32 &port) {
    m_port = port;
    m_port_isSet = true;
}

bool OAIDnsRecord::is_port_Set() const{
    return m_port_isSet;
}

bool OAIDnsRecord::is_port_Valid() const{
    return m_port_isValid;
}

qint32 OAIDnsRecord::getPriority() const {
    return m_priority;
}
void OAIDnsRecord::setPriority(const qint32 &priority) {
    m_priority = priority;
...
QString OAIDnsRecord::getProtocol() const {
    return m_protocol;
}
void OAIDnsRecord::setProtocol(const QString &protocol) {
    m_protocol = protocol;
    m_protocol_isSet = true;
}

bool OAIDnsRecord::is_protocol_Set() const{
    return m_protocol_isSet;
}

bool OAIDnsRecord::is_protocol_Valid() const{
    return m_protocol_isValid;
}

QString OAIDnsRecord::getRecordName() const {
    return m_record_name;
}
void OAIDnsRecord::setRecordName(const QString &record_name) {
    m_record_name = record_name;
    m_record_name_isSet = true;
}

bool OAIDnsRecord::is_record_name_Set() const{
    return m_record_name_isSet;
}

bool OAIDnsRecord::is_record_name_Valid() const{
    return m_record_name_isValid;
}

QString OAIDnsRecord::getService() const {
    return m_service;
}
void OAIDnsRecord::setService(const QString &service) {
    m_service = service;
    m_service_isSet = true;
}

bool OAIDnsRecord::is_service_Set() const{
    return m_service_isSet;
}

bool OAIDnsRecord::is_service_Valid() const{
    return m_service_isValid;
}

QString OAIDnsRecord::getTarget() const {
    return m_target;
}
void OAIDnsRecord::setTarget(const QString &target) {
    m_target = target;
    m_target_isSet = true;
}

bool OAIDnsRecord::is_target_Set() const{
    return m_target_isSet;
}

bool OAIDnsRecord::is_target_Valid() const{
...
qint32 OAIDnsRecord::getWeight() const {
    return m_weight;
}
void OAIDnsRecord::setWeight(const qint32 &weight) {
    m_weight = weight;
    m_weight_isSet = true;
}

bool OAIDnsRecord::is_weight_Set() const{
    return m_weight_isSet;
}

bool OAIDnsRecord::is_weight_Valid() const{
