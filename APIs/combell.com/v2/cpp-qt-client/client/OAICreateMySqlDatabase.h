...
/*
 * OAICreateMySqlDatabase.h
 *
 * 
 */

#ifndef OAICreateMySqlDatabase_H
#define OAICreateMySqlDatabase_H
...
class OAICreateMySqlDatabase : public OAIObject {
public:
    OAICreateMySqlDatabase();
    OAICreateMySqlDatabase(QString json);
    ~OAICreateMySqlDatabase() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateMySqlDatabase)

#endif // OAICreateMySqlDatabase_H
