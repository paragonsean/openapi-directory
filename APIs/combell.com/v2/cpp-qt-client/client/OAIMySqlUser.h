...
#ifndef OAIMySqlUser_H
#define OAIMySqlUser_H

#include <QJsonObject>

#include "OAIUserRights.h"
#include <QString>
...
class OAIMySqlUser : public OAIObject {
public:
    OAIMySqlUser();
    OAIMySqlUser(QString json);
    ~OAIMySqlUser() override;
    ...
    OAIUserRights getRights() const;
    void setRights(const OAIUserRights &rights);
...
Q_DECLARE_METATYPE(OpenAPI::OAIMySqlUser)

#endif // OAIMySqlUser_H
