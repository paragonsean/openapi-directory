...
OAISiteBinding::OAISiteBinding(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISiteBinding::OAISiteBinding() {
    this->initializeModel();
}

OAISiteBinding::~OAISiteBinding() {}

void OAISiteBinding::initializeModel() {
...
void OAISiteBinding::fromJson(QString jsonString) {
...
void OAISiteBinding::fromJsonObject(QJsonObject json) {

    m_cert_thumbprint_isValid = ::OpenAPI::fromJsonValue(m_cert_thumbprint, json[QString("cert_thumbprint")]);
    m_cert_thumbprint_isSet = !json[QString("cert_thumbprint")].isNull() && m_cert_thumbprint_isValid;

    m_host_name_isValid = ::OpenAPI::fromJsonValue(m_host_name, json[QString("host_name")]);
    m_host_name_isSet = !json[QString("host_name")].isNull() && m_host_name_isValid;
...
QString OAISiteBinding::asJson() const {
...
QJsonObject OAISiteBinding::asJsonObject() const {
    QJsonObject obj;
    if (m_cert_thumbprint_isSet) {
        obj.insert(QString("cert_thumbprint"), ::OpenAPI::toJsonValue(m_cert_thumbprint));
    }
    if (m_host_name_isSet) {
        obj.insert(QString("host_name"), ::OpenAPI::toJsonValue(m_host_name));
    }
...
QString OAISiteBinding::getCertThumbprint() const {
    return m_cert_thumbprint;
}
void OAISiteBinding::setCertThumbprint(const QString &cert_thumbprint) {
    m_cert_thumbprint = cert_thumbprint;
    m_cert_thumbprint_isSet = true;
}

bool OAISiteBinding::is_cert_thumbprint_Set() const{
    return m_cert_thumbprint_isSet;
}

bool OAISiteBinding::is_cert_thumbprint_Valid() const{
    return m_cert_thumbprint_isValid;
}

QString OAISiteBinding::getHostName() const {
    return m_host_name;
}
void OAISiteBinding::setHostName(const QString &host_name) {
    m_host_name = host_name;
    m_host_name_isSet = true;
}

bool OAISiteBinding::is_host_name_Set() const{
    return m_host_name_isSet;
}

bool OAISiteBinding::is_host_name_Valid() const{
    return m_host_name_isValid;
}

QString OAISiteBinding::getIpAddress() const {
    return m_ip_address;
}
void OAISiteBinding::setIpAddress(const QString &ip_address) {
    m_ip_address = ip_address;
    m_ip_address_isSet = true;
}

bool OAISiteBinding::is_ip_address_Set() const{
    return m_ip_address_isSet;
}

bool OAISiteBinding::is_ip_address_Valid() const{
    return m_ip_address_isValid;
}

qint32 OAISiteBinding::getPort() const {
    return m_port;
}
void OAISiteBinding::setPort(const qint32 &port) {
    m_port = port;
    m_port_isSet = true;
}

bool OAISiteBinding::is_port_Set() const{
    return m_port_isSet;
}

bool OAISiteBinding::is_port_Valid() const{
    return m_port_isValid;
}

QString OAISiteBinding::getProtocol() const {
    return m_protocol;
}
void OAISiteBinding::setProtocol(const QString &protocol) {
    m_protocol = protocol;
    m_protocol_isSet = true;
}

bool OAISiteBinding::is_protocol_Set() const{
    return m_protocol_isSet;
}

bool OAISiteBinding::is_protocol_Valid() const{
    return m_protocol_isValid;
}

bool OAISiteBinding::isSslEnabled() const {
    return m_ssl_enabled;
}
void OAISiteBinding::setSslEnabled(const bool &ssl_enabled) {
    m_ssl_enabled = ssl_enabled;
    m_ssl_enabled_isSet = true;
}

bool OAISiteBinding::is_ssl_enabled_Set() const{
    return m_ssl_enabled_isSet;
}

bool OAISiteBinding::is_ssl_enabled_Valid() const{
    return m_ssl_enabled_isValid;
}

bool OAISiteBinding::isSet() const {
...
bool OAISiteBinding::isValid() const {
