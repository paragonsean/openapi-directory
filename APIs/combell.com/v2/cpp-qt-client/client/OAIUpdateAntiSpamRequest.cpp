...
OAIUpdateAntiSpamRequest::OAIUpdateAntiSpamRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateAntiSpamRequest::OAIUpdateAntiSpamRequest() {
    this->initializeModel();
}

OAIUpdateAntiSpamRequest::~OAIUpdateAntiSpamRequest() {}

void OAIUpdateAntiSpamRequest::initializeModel() {

    m_type_isSet = false;
    m_type_isValid = false;
}

void OAIUpdateAntiSpamRequest::fromJson(QString jsonString) {
...
void OAIUpdateAntiSpamRequest::fromJsonObject(QJsonObject json) {

    m_type_isValid = ::OpenAPI::fromJsonValue(m_type, json[QString("type")]);
    m_type_isSet = !json[QString("type")].isNull() && m_type_isValid;
}

QString OAIUpdateAntiSpamRequest::asJson() const {
...
QJsonObject OAIUpdateAntiSpamRequest::asJsonObject() const {
    QJsonObject obj;
    if (m_type.isSet()) {
...
OAIAntiSpamTypes OAIUpdateAntiSpamRequest::getType() const {
    return m_type;
}
void OAIUpdateAntiSpamRequest::setType(const OAIAntiSpamTypes &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAIUpdateAntiSpamRequest::is_type_Set() const{
    return m_type_isSet;
}

bool OAIUpdateAntiSpamRequest::is_type_Valid() const{
    return m_type_isValid;
}

bool OAIUpdateAntiSpamRequest::isSet() const {
...
bool OAIUpdateAntiSpamRequest::isValid() const {
