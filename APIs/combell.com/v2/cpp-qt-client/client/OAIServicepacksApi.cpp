...
OAIServicepacksApi::OAIServicepacksApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAIServicepacksApi::~OAIServicepacksApi() {
}

void OAIServicepacksApi::initializeServerConfigs() {
    //Default server
    ...
    _serverConfigs.insert("servicepacks", defaultConf);
    _serverIndices.insert("servicepacks", 0);
}
...
*/
int OAIServicepacksApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAIServicepacksApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAIServicepacksApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAIServicepacksApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAIServicepacksApi::setUsername(const QString &username) {
    _username = username;
}

void OAIServicepacksApi::setPassword(const QString &password) {
    _password = password;
}


void OAIServicepacksApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAIServicepacksApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAIServicepacksApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAIServicepacksApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAIServicepacksApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAIServicepacksApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAIServicepacksApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAIServicepacksApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAIServicepacksApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAIServicepacksApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAIServicepacksApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAIServicepacksApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAIServicepacksApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAIServicepacksApi::servicepacks() {
    QString fullPath = QString(_serverConfigs["servicepacks"][_serverIndices.value("servicepacks")].URL()+"/servicepacks");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIServicepacksApi::servicepacksCallback);
    connect(this, &OAIServicepacksApi::abortRequestsSignal, worker, &QObject::deleteLater);
...
void OAIServicepacksApi::servicepacksCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT servicepacksSignal(output);
        Q_EMIT servicepacksSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT servicepacksSignalE(output, error_type, error_str);
        Q_EMIT servicepacksSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT servicepacksSignalError(output, error_type, error_str);
        Q_EMIT servicepacksSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIServicepacksApi::tokenAvailable(){
