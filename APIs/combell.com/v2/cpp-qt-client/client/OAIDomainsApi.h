...
#include "OAIEditDomainWillRenewRequest.h"
#include "OAIEditNameServers.h"
#include "OAIRegisterDomain.h"
...
public:
    ...
    * @param[in]  oai_edit_domain_will_renew_request OAIEditDomainWillRenewRequest [optional]
    */
    virtual void configureDomain(const QString &domain_name, const QString &domain_name2, const ::OpenAPI::OptionalParam<OAIEditDomainWillRenewRequest> &oai_edit_domain_will_renew_request = ::OpenAPI::OptionalParam<OAIEditDomainWillRenewRequest>());

    /**
    * @param[in]  domain_name QString [required]
    * @param[in]  domain_name2 QString [required]
    * @param[in]  oai_edit_name_servers OAIEditNameServers [optional]
    */
    virtual void editNameServers(const QString &domain_name, const QString &domain_name2, const ::OpenAPI::OptionalParam<OAIEditNameServers> &oai_edit_name_servers = ::OpenAPI::OptionalParam<OAIEditNameServers>());

    /**
    * @param[in]  domain_name QString [required]
    * @param[in]  domain_name2 QString [required]
    */
    virtual void getDomain(const QString &domain_name, const QString &domain_name2);

    /**
    * @param[in]  skip qint32 [optional]
    * @param[in]  take qint32 [optional]
    */
    virtual void getDomains(const ::OpenAPI::OptionalParam<qint32> &skip = ::OpenAPI::OptionalParam<qint32>(), const ::OpenAPI::OptionalParam<qint32> &take = ::OpenAPI::OptionalParam<qint32>());

    /**
    * @param[in]  oai_register_domain OAIRegisterDomain [optional]
    */
    virtual void r_register(const ::OpenAPI::OptionalParam<OAIRegisterDomain> &oai_register_domain = ::OpenAPI::OptionalParam<OAIRegisterDomain>());

    /**
    * @param[in]  oai_transfer_domain OAITransferDomain [optional]
    */
    virtual void transfer(const ::OpenAPI::OptionalParam<OAITransferDomain> &oai_transfer_domain = ::OpenAPI::OptionalParam<OAITransferDomain>());
...
private:
    ...
    void configureDomainCallback(OAIHttpRequestWorker *worker);
    void editNameServersCallback(OAIHttpRequestWorker *worker);
...
Q_SIGNALS:
    ...
    void configureDomainSignal();
    void editNameServersSignal();
    void getDomainSignal(OAIDomainDetail summary);
    void getDomainsSignal(QList<OAIDomain> summary);
    void r_registerSignal();
    void transferSignal();


    void configureDomainSignalFull(OAIHttpRequestWorker *worker);
    void editNameServersSignalFull(OAIHttpRequestWorker *worker);
    void getDomainSignalFull(OAIHttpRequestWorker *worker, OAIDomainDetail summary);
    ...
    void transferSignalFull(OAIHttpRequestWorker *worker);

    Q_DECL_DEPRECATED_X("Use configureDomainSignalError() instead")
    void configureDomainSignalE(QNetworkReply::NetworkError error_type, QString error_str);
    void configureDomainSignalError(QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use editNameServersSignalError() instead")
    void editNameServersSignalE(QNetworkReply::NetworkError error_type, QString error_str);
    void editNameServersSignalError(QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use getDomainSignalError() instead")
    void getDomainSignalE(OAIDomainDetail summary, QNetworkReply::NetworkError error_type, QString error_str);
    void getDomainSignalError(OAIDomainDetail summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    void transferSignalE(QNetworkReply::NetworkError error_type, QString error_str);
    void transferSignalError(QNetworkReply::NetworkError error_type, const QString &error_str);

    Q_DECL_DEPRECATED_X("Use configureDomainSignalErrorFull() instead")
    void configureDomainSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void configureDomainSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use editNameServersSignalErrorFull() instead")
    void editNameServersSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void editNameServersSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
