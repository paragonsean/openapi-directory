...
OAICreateSmtpDomainRequest::OAICreateSmtpDomainRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateSmtpDomainRequest::OAICreateSmtpDomainRequest() {
    this->initializeModel();
}

OAICreateSmtpDomainRequest::~OAICreateSmtpDomainRequest() {}

void OAICreateSmtpDomainRequest::initializeModel() {

    m_hostname_isSet = false;
    m_hostname_isValid = false;
}

void OAICreateSmtpDomainRequest::fromJson(QString jsonString) {
...
void OAICreateSmtpDomainRequest::fromJsonObject(QJsonObject json) {
...
QString OAICreateSmtpDomainRequest::asJson() const {
...
QJsonObject OAICreateSmtpDomainRequest::asJsonObject() const {
    QJsonObject obj;
    if (m_hostname_isSet) {
...
QString OAICreateSmtpDomainRequest::getHostname() const {
    return m_hostname;
}
void OAICreateSmtpDomainRequest::setHostname(const QString &hostname) {
    m_hostname = hostname;
    m_hostname_isSet = true;
}

bool OAICreateSmtpDomainRequest::is_hostname_Set() const{
    return m_hostname_isSet;
}

bool OAICreateSmtpDomainRequest::is_hostname_Valid() const{
    return m_hostname_isValid;
}

bool OAICreateSmtpDomainRequest::isSet() const {
...
bool OAICreateSmtpDomainRequest::isValid() const {
