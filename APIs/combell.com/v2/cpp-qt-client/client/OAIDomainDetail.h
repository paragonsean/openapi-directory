...
public:
    ...
    bool isCanToggleRenew() const;
    void setCanToggleRenew(const bool &can_toggle_renew);
    bool is_can_toggle_renew_Set() const;
    bool is_can_toggle_renew_Valid() const;
    ...
    QList<OAINameServer> getNameServers() const;
    void setNameServers(const QList<OAINameServer> &name_servers);
    bool is_name_servers_Set() const;
    bool is_name_servers_Valid() const;

    OAIRegistrant getRegistrant() const;
    void setRegistrant(const OAIRegistrant &registrant);
    bool is_registrant_Set() const;
    bool is_registrant_Valid() const;

    bool isWillRenew() const;
    void setWillRenew(const bool &will_renew);
    bool is_will_renew_Set() const;
    bool is_will_renew_Valid() const;
...
private:
    ...
    bool m_can_toggle_renew;
    bool m_can_toggle_renew_isSet;
    bool m_can_toggle_renew_isValid;
    ...
    QList<OAINameServer> m_name_servers;
    bool m_name_servers_isSet;
    bool m_name_servers_isValid;

    OAIRegistrant m_registrant;
    bool m_registrant_isSet;
    bool m_registrant_isValid;

    bool m_will_renew;
    bool m_will_renew_isSet;
    bool m_will_renew_isValid;
};
