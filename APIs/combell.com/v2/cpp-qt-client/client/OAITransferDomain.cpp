...
OAITransferDomain::OAITransferDomain(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAITransferDomain::OAITransferDomain() {
    this->initializeModel();
}

OAITransferDomain::~OAITransferDomain() {}

void OAITransferDomain::initializeModel() {
...
void OAITransferDomain::fromJson(QString jsonString) {
...
void OAITransferDomain::fromJsonObject(QJsonObject json) {
...
QString OAITransferDomain::asJson() const {
...
QJsonObject OAITransferDomain::asJsonObject() const {
    QJsonObject obj;
...
QString OAITransferDomain::getAuthCode() const {
    return m_auth_code;
}
void OAITransferDomain::setAuthCode(const QString &auth_code) {
    m_auth_code = auth_code;
    m_auth_code_isSet = true;
}

bool OAITransferDomain::is_auth_code_Set() const{
    return m_auth_code_isSet;
}

bool OAITransferDomain::is_auth_code_Valid() const{
    return m_auth_code_isValid;
}

QString OAITransferDomain::getDomainName() const {
    return m_domain_name;
}
void OAITransferDomain::setDomainName(const QString &domain_name) {
    m_domain_name = domain_name;
    m_domain_name_isSet = true;
}

bool OAITransferDomain::is_domain_name_Set() const{
    return m_domain_name_isSet;
}

bool OAITransferDomain::is_domain_name_Valid() const{
    return m_domain_name_isValid;
}

QList<QString> OAITransferDomain::getNameServers() const {
    return m_name_servers;
}
void OAITransferDomain::setNameServers(const QList<QString> &name_servers) {
    m_name_servers = name_servers;
    m_name_servers_isSet = true;
}

bool OAITransferDomain::is_name_servers_Set() const{
    return m_name_servers_isSet;
}

bool OAITransferDomain::is_name_servers_Valid() const{
    return m_name_servers_isValid;
}

OAIRegistrantInput OAITransferDomain::getRegistrant() const {
    return m_registrant;
}
void OAITransferDomain::setRegistrant(const OAIRegistrantInput &registrant) {
    m_registrant = registrant;
    m_registrant_isSet = true;
}

bool OAITransferDomain::is_registrant_Set() const{
    return m_registrant_isSet;
}

bool OAITransferDomain::is_registrant_Valid() const{
    return m_registrant_isValid;
}

bool OAITransferDomain::isSet() const {
...
bool OAITransferDomain::isValid() const {
