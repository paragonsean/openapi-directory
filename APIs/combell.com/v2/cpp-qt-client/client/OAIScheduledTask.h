...
#ifndef OAIScheduledTask_H
#define OAIScheduledTask_H
...
class OAIScheduledTask : public OAIObject {
public:
    OAIScheduledTask();
    OAIScheduledTask(QString json);
    ~OAIScheduledTask() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIScheduledTask)

#endif // OAIScheduledTask_H
