...
#include "OAISslSubjectAltName.h"
...
OAISslSubjectAltName::OAISslSubjectAltName(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISslSubjectAltName::OAISslSubjectAltName() {
    this->initializeModel();
}

OAISslSubjectAltName::~OAISslSubjectAltName() {}

void OAISslSubjectAltName::initializeModel() {
...
void OAISslSubjectAltName::fromJson(QString jsonString) {
...
void OAISslSubjectAltName::fromJsonObject(QJsonObject json) {
...
QString OAISslSubjectAltName::asJson() const {
...
QJsonObject OAISslSubjectAltName::asJsonObject() const {
    QJsonObject obj;
    if (m_type.isSet()) {
...
OAISslSubjectAltNameType OAISslSubjectAltName::getType() const {
    return m_type;
}
void OAISslSubjectAltName::setType(const OAISslSubjectAltNameType &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAISslSubjectAltName::is_type_Set() const{
    return m_type_isSet;
}

bool OAISslSubjectAltName::is_type_Valid() const{
    return m_type_isValid;
}

QString OAISslSubjectAltName::getValue() const {
    return m_value;
}
void OAISslSubjectAltName::setValue(const QString &value) {
    m_value = value;
    m_value_isSet = true;
}

bool OAISslSubjectAltName::is_value_Set() const{
    return m_value_isSet;
}

bool OAISslSubjectAltName::is_value_Valid() const{
    return m_value_isValid;
}

bool OAISslSubjectAltName::isSet() const {
...
bool OAISslSubjectAltName::isValid() const {
