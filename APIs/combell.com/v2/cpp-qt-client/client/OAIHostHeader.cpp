...
OAIHostHeader::OAIHostHeader(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIHostHeader::OAIHostHeader() {
    this->initializeModel();
}

OAIHostHeader::~OAIHostHeader() {}

void OAIHostHeader::initializeModel() {
...
void OAIHostHeader::fromJson(QString jsonString) {
...
void OAIHostHeader::fromJsonObject(QJsonObject json) {
...
QString OAIHostHeader::asJson() const {
...
QJsonObject OAIHostHeader::asJsonObject() const {
    QJsonObject obj;
    if (m_enabled_isSet) {
...
bool OAIHostHeader::isEnabled() const {
    return m_enabled;
}
void OAIHostHeader::setEnabled(const bool &enabled) {
    m_enabled = enabled;
    m_enabled_isSet = true;
}

bool OAIHostHeader::is_enabled_Set() const{
    return m_enabled_isSet;
}

bool OAIHostHeader::is_enabled_Valid() const{
    return m_enabled_isValid;
}

QString OAIHostHeader::getName() const {
    return m_name;
}
void OAIHostHeader::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIHostHeader::is_name_Set() const{
    return m_name_isSet;
}

bool OAIHostHeader::is_name_Valid() const{
    return m_name_isValid;
}

bool OAIHostHeader::isSet() const {
...
bool OAIHostHeader::isValid() const {
