...
OAIAntiSpam::OAIAntiSpam(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAntiSpam::OAIAntiSpam() {
    this->initializeModel();
}

OAIAntiSpam::~OAIAntiSpam() {}

void OAIAntiSpam::initializeModel() {
...
void OAIAntiSpam::fromJson(QString jsonString) {
...
void OAIAntiSpam::fromJsonObject(QJsonObject json) {
...
QString OAIAntiSpam::asJson() const {
...
QJsonObject OAIAntiSpam::asJsonObject() const {
    QJsonObject obj;
    if (m_allowed_types.size() > 0) {
...
QList<OAIAntiSpamTypes> OAIAntiSpam::getAllowedTypes() const {
    return m_allowed_types;
}
void OAIAntiSpam::setAllowedTypes(const QList<OAIAntiSpamTypes> &allowed_types) {
    m_allowed_types = allowed_types;
    m_allowed_types_isSet = true;
}

bool OAIAntiSpam::is_allowed_types_Set() const{
    return m_allowed_types_isSet;
}

bool OAIAntiSpam::is_allowed_types_Valid() const{
    return m_allowed_types_isValid;
}

OAIAntiSpamTypes OAIAntiSpam::getType() const {
    return m_type;
}
void OAIAntiSpam::setType(const OAIAntiSpamTypes &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAIAntiSpam::is_type_Set() const{
    return m_type_isSet;
}

bool OAIAntiSpam::is_type_Valid() const{
    return m_type_isValid;
}

bool OAIAntiSpam::isSet() const {
...
bool OAIAntiSpam::isValid() const {
