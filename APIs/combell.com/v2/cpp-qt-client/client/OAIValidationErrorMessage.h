...
/*
 * OAIValidationErrorMessage.h
 *
 * 
 */

#ifndef OAIValidationErrorMessage_H
#define OAIValidationErrorMessage_H
...
class OAIValidationErrorMessage : public OAIObject {
public:
    OAIValidationErrorMessage();
    OAIValidationErrorMessage(QString json);
    ~OAIValidationErrorMessage() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIValidationErrorMessage)

#endif // OAIValidationErrorMessage_H
