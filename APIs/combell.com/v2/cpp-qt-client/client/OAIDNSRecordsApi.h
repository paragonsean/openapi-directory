...
public:
    ...
    * @param[in]  record_name QString [optional]
    * @param[in]  service QString [optional]
    */
    virtual void dnsDomainNameRecordsGet(const QString &domain_name, const QString &domain_name2, const ::OpenAPI::OptionalParam<qint32> &skip = ::OpenAPI::OptionalParam<qint32>(), const ::OpenAPI::OptionalParam<qint32> &take = ::OpenAPI::OptionalParam<qint32>(), const ::OpenAPI::OptionalParam<QString> &type = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &record_name = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &service = ::OpenAPI::OptionalParam<QString>());

    /**
    * @param[in]  domain_name QString [required]
    * @param[in]  domain_name2 QString [required]
    * @param[in]  oai_dns_record OAIDnsRecord [optional]
    */
    virtual void dnsDomainNameRecordsPost(const QString &domain_name, const QString &domain_name2, const ::OpenAPI::OptionalParam<OAIDnsRecord> &oai_dns_record = ::OpenAPI::OptionalParam<OAIDnsRecord>());

    /**
    * @param[in]  domain_name QString [required]
    * @param[in]  record_id QString [required]
    * @param[in]  domain_name2 QString [required]
    * @param[in]  record_id2 QString [required]
    */
    virtual void dnsDomainNameRecordsRecordIdDelete(const QString &domain_name, const QString &record_id, const QString &domain_name2, const QString &record_id2);
    ...
    * @param[in]  record_id2 QString [required]
    */
    virtual void dnsDomainNameRecordsRecordIdGet(const QString &domain_name, const QString &record_id, const QString &domain_name2, const QString &record_id2);
    ...
    * @param[in]  oai_dns_record OAIDnsRecord [optional]
    */
    virtual void dnsDomainNameRecordsRecordIdPut(const QString &domain_name, const QString &record_id, const QString &domain_name2, const QString &record_id2, const ::OpenAPI::OptionalParam<OAIDnsRecord> &oai_dns_record = ::OpenAPI::OptionalParam<OAIDnsRecord>());
...
private:
    ...
    void dnsDomainNameRecordsGetCallback(OAIHttpRequestWorker *worker);
    void dnsDomainNameRecordsPostCallback(OAIHttpRequestWorker *worker);
    void dnsDomainNameRecordsRecordIdDeleteCallback(OAIHttpRequestWorker *worker);
    void dnsDomainNameRecordsRecordIdGetCallback(OAIHttpRequestWorker *worker);
    void dnsDomainNameRecordsRecordIdPutCallback(OAIHttpRequestWorker *worker);

Q_SIGNALS:

    void dnsDomainNameRecordsGetSignal(QList<OAIDnsRecord> summary);
    void dnsDomainNameRecordsPostSignal();
    void dnsDomainNameRecordsRecordIdDeleteSignal();
    void dnsDomainNameRecordsRecordIdGetSignal(OAIDnsRecord summary);
    void dnsDomainNameRecordsRecordIdPutSignal();


    void dnsDomainNameRecordsGetSignalFull(OAIHttpRequestWorker *worker, QList<OAIDnsRecord> summary);
    void dnsDomainNameRecordsPostSignalFull(OAIHttpRequestWorker *worker);
    void dnsDomainNameRecordsRecordIdDeleteSignalFull(OAIHttpRequestWorker *worker);
    void dnsDomainNameRecordsRecordIdGetSignalFull(OAIHttpRequestWorker *worker, OAIDnsRecord summary);
    void dnsDomainNameRecordsRecordIdPutSignalFull(OAIHttpRequestWorker *worker);

    Q_DECL_DEPRECATED_X("Use dnsDomainNameRecordsGetSignalError() instead")
    void dnsDomainNameRecordsGetSignalE(QList<OAIDnsRecord> summary, QNetworkReply::NetworkError error_type, QString error_str);
    void dnsDomainNameRecordsGetSignalError(QList<OAIDnsRecord> summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use dnsDomainNameRecordsPostSignalError() instead")
    void dnsDomainNameRecordsPostSignalE(QNetworkReply::NetworkError error_type, QString error_str);
    void dnsDomainNameRecordsPostSignalError(QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use dnsDomainNameRecordsRecordIdDeleteSignalError() instead")
    void dnsDomainNameRecordsRecordIdDeleteSignalE(QNetworkReply::NetworkError error_type, QString error_str);
    void dnsDomainNameRecordsRecordIdDeleteSignalError(QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use dnsDomainNameRecordsRecordIdGetSignalError() instead")
    void dnsDomainNameRecordsRecordIdGetSignalE(OAIDnsRecord summary, QNetworkReply::NetworkError error_type, QString error_str);
    void dnsDomainNameRecordsRecordIdGetSignalError(OAIDnsRecord summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use dnsDomainNameRecordsRecordIdPutSignalError() instead")
    void dnsDomainNameRecordsRecordIdPutSignalE(QNetworkReply::NetworkError error_type, QString error_str);
    void dnsDomainNameRecordsRecordIdPutSignalError(QNetworkReply::NetworkError error_type, const QString &error_str);

    Q_DECL_DEPRECATED_X("Use dnsDomainNameRecordsGetSignalErrorFull() instead")
    void dnsDomainNameRecordsGetSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void dnsDomainNameRecordsGetSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use dnsDomainNameRecordsPostSignalErrorFull() instead")
    void dnsDomainNameRecordsPostSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void dnsDomainNameRecordsPostSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use dnsDomainNameRecordsRecordIdDeleteSignalErrorFull() instead")
    void dnsDomainNameRecordsRecordIdDeleteSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void dnsDomainNameRecordsRecordIdDeleteSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use dnsDomainNameRecordsRecordIdGetSignalErrorFull() instead")
    void dnsDomainNameRecordsRecordIdGetSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void dnsDomainNameRecordsRecordIdGetSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use dnsDomainNameRecordsRecordIdPutSignalErrorFull() instead")
    void dnsDomainNameRecordsRecordIdPutSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void dnsDomainNameRecordsRecordIdPutSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
