...
bool OAISshConfiguration::isEnabled() const {
    return m_enabled;
}
void OAISshConfiguration::setEnabled(const bool &enabled) {
    m_enabled = enabled;
    m_enabled_isSet = true;
}

bool OAISshConfiguration::is_enabled_Set() const{
    return m_enabled_isSet;
}

bool OAISshConfiguration::is_enabled_Valid() const{
