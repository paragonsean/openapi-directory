...
qint32 OAIMySqlDatabase::getAccountId() const {
    return m_account_id;
}
void OAIMySqlDatabase::setAccountId(const qint32 &account_id) {
    m_account_id = account_id;
    m_account_id_isSet = true;
}

bool OAIMySqlDatabase::is_account_id_Set() const{
    return m_account_id_isSet;
}

bool OAIMySqlDatabase::is_account_id_Valid() const{
    return m_account_id_isValid;
}

qint32 OAIMySqlDatabase::getActualSize() const {
    return m_actual_size;
}
void OAIMySqlDatabase::setActualSize(const qint32 &actual_size) {
    m_actual_size = actual_size;
    m_actual_size_isSet = true;
}

bool OAIMySqlDatabase::is_actual_size_Set() const{
    return m_actual_size_isSet;
}

bool OAIMySqlDatabase::is_actual_size_Valid() const{
    return m_actual_size_isValid;
}

QString OAIMySqlDatabase::getHostname() const {
    return m_hostname;
}
void OAIMySqlDatabase::setHostname(const QString &hostname) {
    m_hostname = hostname;
    m_hostname_isSet = true;
}

bool OAIMySqlDatabase::is_hostname_Set() const{
    return m_hostname_isSet;
}

bool OAIMySqlDatabase::is_hostname_Valid() const{
    return m_hostname_isValid;
}

qint32 OAIMySqlDatabase::getMaxSize() const {
    return m_max_size;
}
void OAIMySqlDatabase::setMaxSize(const qint32 &max_size) {
    m_max_size = max_size;
    m_max_size_isSet = true;
}

bool OAIMySqlDatabase::is_max_size_Set() const{
    return m_max_size_isSet;
}

bool OAIMySqlDatabase::is_max_size_Valid() const{
    return m_max_size_isValid;
}

QString OAIMySqlDatabase::getName() const {
    return m_name;
}
void OAIMySqlDatabase::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIMySqlDatabase::is_name_Set() const{
    return m_name_isSet;
}

bool OAIMySqlDatabase::is_name_Valid() const{
    return m_name_isValid;
}

qint32 OAIMySqlDatabase::getUserCount() const {
    return m_user_count;
}
void OAIMySqlDatabase::setUserCount(const qint32 &user_count) {
    m_user_count = user_count;
    m_user_count_isSet = true;
}

bool OAIMySqlDatabase::is_user_count_Set() const{
    return m_user_count_isSet;
}

bool OAIMySqlDatabase::is_user_count_Valid() const{
