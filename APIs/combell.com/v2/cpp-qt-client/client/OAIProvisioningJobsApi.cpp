...
#include "OAIProvisioningJobsApi.h"
...
OAIProvisioningJobsApi::OAIProvisioningJobsApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAIProvisioningJobsApi::~OAIProvisioningJobsApi() {
}

void OAIProvisioningJobsApi::initializeServerConfigs() {
    //Default server
    ...
    _serverConfigs.insert("provisioningjobsJobIdGet", defaultConf);
    _serverIndices.insert("provisioningjobsJobIdGet", 0);
}
...
*/
int OAIProvisioningJobsApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAIProvisioningJobsApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAIProvisioningJobsApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAIProvisioningJobsApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAIProvisioningJobsApi::setUsername(const QString &username) {
    _username = username;
}

void OAIProvisioningJobsApi::setPassword(const QString &password) {
    _password = password;
}


void OAIProvisioningJobsApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAIProvisioningJobsApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAIProvisioningJobsApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAIProvisioningJobsApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAIProvisioningJobsApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAIProvisioningJobsApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAIProvisioningJobsApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAIProvisioningJobsApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAIProvisioningJobsApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAIProvisioningJobsApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAIProvisioningJobsApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAIProvisioningJobsApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAIProvisioningJobsApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAIProvisioningJobsApi::provisioningjobsJobIdGet(const QString &job_id, const QString &job_id2) {
    QString fullPath = QString(_serverConfigs["provisioningjobsJobIdGet"][_serverIndices.value("provisioningjobsJobIdGet")].URL()+"/provisioningjobs/{jobId}");
    
    
    {
        QString job_id2PathParam("{");
        job_id2PathParam.append("jobId").append("}");
        ...
        fullPath.replace(job_id2PathParam, paramString+QUrl::toPercentEncoding(::OpenAPI::toStringValue(job_id2)));
    }
    ...
    
    {
        ...
        queryDelimiter = getParamStyleDelimiter(queryStyle, "job_id", true);
        if (fullPath.indexOf("?") > 0)
            fullPath.append(queryPrefix);
        else
            fullPath.append("?");

        fullPath.append(QUrl::toPercentEncoding("job_id")).append(querySuffix).append(QUrl::toPercentEncoding(job_id));
    }
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIProvisioningJobsApi::provisioningjobsJobIdGetCallback);
    connect(this, &OAIProvisioningJobsApi::abortRequestsSignal, worker, &QObject::deleteLater);
...
void OAIProvisioningJobsApi::provisioningjobsJobIdGetCallback(OAIHttpRequestWorker *worker) {
    ...
    OAIProvisioningJobInfo output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT provisioningjobsJobIdGetSignal(output);
        Q_EMIT provisioningjobsJobIdGetSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT provisioningjobsJobIdGetSignalE(output, error_type, error_str);
        Q_EMIT provisioningjobsJobIdGetSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT provisioningjobsJobIdGetSignalError(output, error_type, error_str);
        Q_EMIT provisioningjobsJobIdGetSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIProvisioningJobsApi::tokenAvailable(){
