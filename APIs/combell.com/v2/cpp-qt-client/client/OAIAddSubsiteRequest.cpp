...
OAIAddSubsiteRequest::OAIAddSubsiteRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAddSubsiteRequest::OAIAddSubsiteRequest() {
    this->initializeModel();
}

OAIAddSubsiteRequest::~OAIAddSubsiteRequest() {}

void OAIAddSubsiteRequest::initializeModel() {
...
void OAIAddSubsiteRequest::fromJson(QString jsonString) {
...
void OAIAddSubsiteRequest::fromJsonObject(QJsonObject json) {
...
QString OAIAddSubsiteRequest::asJson() const {
...
QJsonObject OAIAddSubsiteRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIAddSubsiteRequest::getDomainName() const {
    return m_domain_name;
}
void OAIAddSubsiteRequest::setDomainName(const QString &domain_name) {
    m_domain_name = domain_name;
    m_domain_name_isSet = true;
}

bool OAIAddSubsiteRequest::is_domain_name_Set() const{
    return m_domain_name_isSet;
}

bool OAIAddSubsiteRequest::is_domain_name_Valid() const{
    return m_domain_name_isValid;
}

QString OAIAddSubsiteRequest::getPath() const {
    return m_path;
}
void OAIAddSubsiteRequest::setPath(const QString &path) {
    m_path = path;
    m_path_isSet = true;
}

bool OAIAddSubsiteRequest::is_path_Set() const{
    return m_path_isSet;
}

bool OAIAddSubsiteRequest::is_path_Valid() const{
    return m_path_isValid;
}

bool OAIAddSubsiteRequest::isSet() const {
...
bool OAIAddSubsiteRequest::isValid() const {
