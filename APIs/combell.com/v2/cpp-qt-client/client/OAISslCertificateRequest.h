...
/*
 * OAISslCertificateRequest.h
 *
 * 
 */

#ifndef OAISslCertificateRequest_H
#define OAISslCertificateRequest_H

#include <QJsonObject>

#include "OAISslCertificateType.h"
#include "OAISslCertificateValidationLevel.h"
#include "OAISslCertificateVendor.h"
#include <QString>
...
class OAISslCertificateRequest : public OAIObject {
public:
    OAISslCertificateRequest();
    OAISslCertificateRequest(QString json);
    ~OAISslCertificateRequest() override;
    ...
    OAISslCertificateType getCertificateType() const;
    void setCertificateType(const OAISslCertificateType &certificate_type);
    ...
    void setOrderCode(const QString &order_code);
    bool is_order_code_Set() const;
    bool is_order_code_Valid() const;

    OAISslCertificateValidationLevel getValidationLevel() const;
    void setValidationLevel(const OAISslCertificateValidationLevel &validation_level);
    bool is_validation_level_Set() const;
    bool is_validation_level_Valid() const;

    OAISslCertificateVendor getVendor() const;
    void setVendor(const OAISslCertificateVendor &vendor);
...
private:
    ...
    OAISslCertificateType m_certificate_type;
    ...
    QString m_order_code;
    bool m_order_code_isSet;
    bool m_order_code_isValid;

    OAISslCertificateValidationLevel m_validation_level;
    bool m_validation_level_isSet;
    bool m_validation_level_isValid;

    OAISslCertificateVendor m_vendor;
    bool m_vendor_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAISslCertificateRequest)

#endif // OAISslCertificateRequest_H
