...
OAIWindowsIpType::OAIWindowsIpType(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIWindowsIpType::OAIWindowsIpType() {
    this->initializeModel();
}

OAIWindowsIpType::~OAIWindowsIpType() {}

void OAIWindowsIpType::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIWindowsIpType::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIWindowsIpType::fromJson(QString jsonString) {
    
    if ( jsonString.compare("dedicated", Qt::CaseInsensitive) == 0) {
        m_value = eOAIWindowsIpType::DEDICATED;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("shared", Qt::CaseInsensitive) == 0) {
        m_value = eOAIWindowsIpType::SHARED;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIWindowsIpType::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIWindowsIpType::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIWindowsIpType::DEDICATED:
            val = "dedicated";
            break;
        case eOAIWindowsIpType::SHARED:
            val = "shared";
            break;
        default:
            break;
...
QJsonValue OAIWindowsIpType::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIWindowsIpType::eOAIWindowsIpType OAIWindowsIpType::getValue() const {
    return m_value;
}

void OAIWindowsIpType::setValue(const OAIWindowsIpType::eOAIWindowsIpType& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIWindowsIpType::isSet() const {
    
    return m_value_isSet;
}

bool OAIWindowsIpType::isValid() const {
