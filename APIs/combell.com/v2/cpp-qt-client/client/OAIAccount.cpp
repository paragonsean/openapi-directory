...
QString OAIAccount::getIdentifier() const {
    return m_identifier;
}
void OAIAccount::setIdentifier(const QString &identifier) {
    m_identifier = identifier;
    m_identifier_isSet = true;
}

bool OAIAccount::is_identifier_Set() const{
    return m_identifier_isSet;
}

bool OAIAccount::is_identifier_Valid() const{
    return m_identifier_isValid;
}

qint32 OAIAccount::getServicepackId() const {
    return m_servicepack_id;
}
void OAIAccount::setServicepackId(const qint32 &servicepack_id) {
    m_servicepack_id = servicepack_id;
    m_servicepack_id_isSet = true;
}

bool OAIAccount::is_servicepack_id_Set() const{
    return m_servicepack_id_isSet;
}

bool OAIAccount::is_servicepack_id_Valid() const{
