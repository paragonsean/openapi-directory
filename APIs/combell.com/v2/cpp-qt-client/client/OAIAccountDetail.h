...
public:
    ...
    QList<OAIAddon> getAddons() const;
    void setAddons(const QList<OAIAddon> &addons);
    ...
    OAIServicepack getServicepack() const;
    void setServicepack(const OAIServicepack &servicepack);
    bool is_servicepack_Set() const;
    bool is_servicepack_Valid() const;
...
private:
    ...
    OAIServicepack m_servicepack;
    bool m_servicepack_isSet;
    bool m_servicepack_isValid;
};
