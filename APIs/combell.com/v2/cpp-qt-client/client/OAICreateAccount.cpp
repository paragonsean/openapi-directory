...
OAICreateAccount::OAICreateAccount(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateAccount::OAICreateAccount() {
    this->initializeModel();
}

OAICreateAccount::~OAICreateAccount() {}

void OAICreateAccount::initializeModel() {
    ...
    m_servicepack_id_isSet = false;
    m_servicepack_id_isValid = false;
}

void OAICreateAccount::fromJson(QString jsonString) {
...
void OAICreateAccount::fromJsonObject(QJsonObject json) {
    ...
    m_servicepack_id_isValid = ::OpenAPI::fromJsonValue(m_servicepack_id, json[QString("servicepack_id")]);
    m_servicepack_id_isSet = !json[QString("servicepack_id")].isNull() && m_servicepack_id_isValid;
}

QString OAICreateAccount::asJson() const {
...
QJsonObject OAICreateAccount::asJsonObject() const {
    QJsonObject obj;
    ...
    if (m_servicepack_id_isSet) {
        obj.insert(QString("servicepack_id"), ::OpenAPI::toJsonValue(m_servicepack_id));
    }
    return obj;
}

QString OAICreateAccount::getFtpPassword() const {
    return m_ftp_password;
}
void OAICreateAccount::setFtpPassword(const QString &ftp_password) {
    m_ftp_password = ftp_password;
    m_ftp_password_isSet = true;
}

bool OAICreateAccount::is_ftp_password_Set() const{
    return m_ftp_password_isSet;
}

bool OAICreateAccount::is_ftp_password_Valid() const{
    return m_ftp_password_isValid;
}

QString OAICreateAccount::getIdentifier() const {
    return m_identifier;
}
void OAICreateAccount::setIdentifier(const QString &identifier) {
    m_identifier = identifier;
    m_identifier_isSet = true;
}

bool OAICreateAccount::is_identifier_Set() const{
    return m_identifier_isSet;
}

bool OAICreateAccount::is_identifier_Valid() const{
    return m_identifier_isValid;
}

qint32 OAICreateAccount::getServicepackId() const {
    return m_servicepack_id;
}
void OAICreateAccount::setServicepackId(const qint32 &servicepack_id) {
    m_servicepack_id = servicepack_id;
    m_servicepack_id_isSet = true;
}

bool OAICreateAccount::is_servicepack_id_Set() const{
    return m_servicepack_id_isSet;
}

bool OAICreateAccount::is_servicepack_id_Valid() const{
    return m_servicepack_id_isValid;
}

bool OAICreateAccount::isSet() const {
...
bool OAICreateAccount::isValid() const {
