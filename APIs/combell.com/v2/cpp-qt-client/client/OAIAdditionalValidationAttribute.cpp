...
OAIAdditionalValidationAttribute::OAIAdditionalValidationAttribute(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAdditionalValidationAttribute::OAIAdditionalValidationAttribute() {
    this->initializeModel();
}

OAIAdditionalValidationAttribute::~OAIAdditionalValidationAttribute() {}

void OAIAdditionalValidationAttribute::initializeModel() {
...
void OAIAdditionalValidationAttribute::fromJson(QString jsonString) {
...
void OAIAdditionalValidationAttribute::fromJsonObject(QJsonObject json) {
...
QString OAIAdditionalValidationAttribute::asJson() const {
...
QJsonObject OAIAdditionalValidationAttribute::asJsonObject() const {
    QJsonObject obj;
    if (m_name_isSet) {
...
QString OAIAdditionalValidationAttribute::getName() const {
    return m_name;
}
void OAIAdditionalValidationAttribute::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIAdditionalValidationAttribute::is_name_Set() const{
    return m_name_isSet;
}

bool OAIAdditionalValidationAttribute::is_name_Valid() const{
    return m_name_isValid;
}

QString OAIAdditionalValidationAttribute::getValue() const {
    return m_value;
}
void OAIAdditionalValidationAttribute::setValue(const QString &value) {
    m_value = value;
    m_value_isSet = true;
}

bool OAIAdditionalValidationAttribute::is_value_Set() const{
    return m_value_isSet;
}

bool OAIAdditionalValidationAttribute::is_value_Valid() const{
    return m_value_isValid;
}

bool OAIAdditionalValidationAttribute::isSet() const {
...
bool OAIAdditionalValidationAttribute::isValid() const {
