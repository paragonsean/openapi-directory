...
#include "OAISslCertificate.h"
#include "OAISslCertificateDetail.h"
#include "OAISslCertificateFileFormat.h"
#include <QString>
...
public:
    ...
    * @param[in]  file_format OAISslCertificateFileFormat [required]
    * @param[in]  password QString [required]
    * @param[in]  sha1_fingerprint2 QString [required]
    */
    virtual void downloadCertificate(const QString &sha1_fingerprint, const OAISslCertificateFileFormat &file_format, const QString &password, const QString &sha1_fingerprint2);

    /**
    * @param[in]  sha1_fingerprint QString [required]
    * @param[in]  sha1_fingerprint2 QString [required]
    */
    virtual void getSslCertificate(const QString &sha1_fingerprint, const QString &sha1_fingerprint2);

    /**
    * @param[in]  skip qint32 [optional]
    * @param[in]  take qint32 [optional]
    */
    virtual void getSslCertificates(const ::OpenAPI::OptionalParam<qint32> &skip = ::OpenAPI::OptionalParam<qint32>(), const ::OpenAPI::OptionalParam<qint32> &take = ::OpenAPI::OptionalParam<qint32>());
...
private:
    ...
    void downloadCertificateCallback(OAIHttpRequestWorker *worker);
    void getSslCertificateCallback(OAIHttpRequestWorker *worker);
    void getSslCertificatesCallback(OAIHttpRequestWorker *worker);

Q_SIGNALS:

    void downloadCertificateSignal(OAIHttpFileElement summary);
    void getSslCertificateSignal(OAISslCertificateDetail summary);
    void getSslCertificatesSignal(QList<OAISslCertificate> summary);


    void downloadCertificateSignalFull(OAIHttpRequestWorker *worker, OAIHttpFileElement summary);
    void getSslCertificateSignalFull(OAIHttpRequestWorker *worker, OAISslCertificateDetail summary);
    void getSslCertificatesSignalFull(OAIHttpRequestWorker *worker, QList<OAISslCertificate> summary);

    Q_DECL_DEPRECATED_X("Use downloadCertificateSignalError() instead")
    void downloadCertificateSignalE(OAIHttpFileElement summary, QNetworkReply::NetworkError error_type, QString error_str);
    void downloadCertificateSignalError(OAIHttpFileElement summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use getSslCertificateSignalError() instead")
    void getSslCertificateSignalE(OAISslCertificateDetail summary, QNetworkReply::NetworkError error_type, QString error_str);
    void getSslCertificateSignalError(OAISslCertificateDetail summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use getSslCertificatesSignalError() instead")
    void getSslCertificatesSignalE(QList<OAISslCertificate> summary, QNetworkReply::NetworkError error_type, QString error_str);
    void getSslCertificatesSignalError(QList<OAISslCertificate> summary, QNetworkReply::NetworkError error_type, const QString &error_str);

    Q_DECL_DEPRECATED_X("Use downloadCertificateSignalErrorFull() instead")
    void downloadCertificateSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void downloadCertificateSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use getSslCertificateSignalErrorFull() instead")
    void getSslCertificateSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void getSslCertificateSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use getSslCertificatesSignalErrorFull() instead")
    void getSslCertificatesSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void getSslCertificatesSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
