...
#ifndef OAI_OAIServicepacksApi_H
#define OAI_OAIServicepacksApi_H
...
class OAIServicepacksApi : public QObject {
    Q_OBJECT

public:
    OAIServicepacksApi(const int timeOut = 0);
    ~OAIServicepacksApi();
...
private:
    ...
    void servicepacksCallback(OAIHttpRequestWorker *worker);

Q_SIGNALS:

    void servicepacksSignal(QList<OAIServicepack> summary);


    void servicepacksSignalFull(OAIHttpRequestWorker *worker, QList<OAIServicepack> summary);

    Q_DECL_DEPRECATED_X("Use servicepacksSignalError() instead")
    void servicepacksSignalE(QList<OAIServicepack> summary, QNetworkReply::NetworkError error_type, QString error_str);
    void servicepacksSignalError(QList<OAIServicepack> summary, QNetworkReply::NetworkError error_type, const QString &error_str);

    Q_DECL_DEPRECATED_X("Use servicepacksSignalErrorFull() instead")
    void servicepacksSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void servicepacksSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
