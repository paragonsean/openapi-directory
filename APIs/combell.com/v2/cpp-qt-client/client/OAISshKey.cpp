...
QString OAISshKey::getFingerprint() const {
    return m_fingerprint;
}
void OAISshKey::setFingerprint(const QString &fingerprint) {
    m_fingerprint = fingerprint;
    m_fingerprint_isSet = true;
}

bool OAISshKey::is_fingerprint_Set() const{
    return m_fingerprint_isSet;
}

bool OAISshKey::is_fingerprint_Valid() const{
