...
#ifndef OAILinuxHosting_H
#define OAILinuxHosting_H
...
class OAILinuxHosting : public OAIObject {
public:
    OAILinuxHosting();
    OAILinuxHosting(QString json);
    ~OAILinuxHosting() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILinuxHosting)

#endif // OAILinuxHosting_H
