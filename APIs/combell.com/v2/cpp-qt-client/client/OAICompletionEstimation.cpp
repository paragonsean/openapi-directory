...
OAICompletionEstimation::OAICompletionEstimation(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICompletionEstimation::OAICompletionEstimation() {
    this->initializeModel();
}

OAICompletionEstimation::~OAICompletionEstimation() {}

void OAICompletionEstimation::initializeModel() {

    m_estimate_isSet = false;
    m_estimate_isValid = false;
}

void OAICompletionEstimation::fromJson(QString jsonString) {
...
void OAICompletionEstimation::fromJsonObject(QJsonObject json) {
...
QString OAICompletionEstimation::asJson() const {
...
QJsonObject OAICompletionEstimation::asJsonObject() const {
    QJsonObject obj;
    if (m_estimate_isSet) {
...
QDateTime OAICompletionEstimation::getEstimate() const {
    return m_estimate;
}
void OAICompletionEstimation::setEstimate(const QDateTime &estimate) {
    m_estimate = estimate;
    m_estimate_isSet = true;
}

bool OAICompletionEstimation::is_estimate_Set() const{
    return m_estimate_isSet;
}

bool OAICompletionEstimation::is_estimate_Valid() const{
    return m_estimate_isValid;
}

bool OAICompletionEstimation::isSet() const {
...
bool OAICompletionEstimation::isValid() const {
