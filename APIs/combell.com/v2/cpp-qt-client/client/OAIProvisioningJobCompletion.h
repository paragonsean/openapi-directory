...
/*
 * OAIProvisioningJobCompletion.h
 *
 * 
 */

#ifndef OAIProvisioningJobCompletion_H
#define OAIProvisioningJobCompletion_H
...
class OAIProvisioningJobCompletion : public OAIObject {
public:
    OAIProvisioningJobCompletion();
    OAIProvisioningJobCompletion(QString json);
    ~OAIProvisioningJobCompletion() override;
    ...
    QList<QString> getResourceLinks() const;
    void setResourceLinks(const QList<QString> &resource_links);
...
private:
    ...
    QList<QString> m_resource_links;
...
Q_DECLARE_METATYPE(OpenAPI::OAIProvisioningJobCompletion)

#endif // OAIProvisioningJobCompletion_H
