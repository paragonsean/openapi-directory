...
/*
 * OAICreateMySqlUser.h
 *
 * 
 */

#ifndef OAICreateMySqlUser_H
#define OAICreateMySqlUser_H
...
class OAICreateMySqlUser : public OAIObject {
public:
    OAICreateMySqlUser();
    OAICreateMySqlUser(QString json);
    ~OAICreateMySqlUser() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateMySqlUser)

#endif // OAICreateMySqlUser_H
