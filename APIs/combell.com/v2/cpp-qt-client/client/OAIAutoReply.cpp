...
OAIAutoReply::OAIAutoReply(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAutoReply::OAIAutoReply() {
    this->initializeModel();
}

OAIAutoReply::~OAIAutoReply() {}

void OAIAutoReply::initializeModel() {
...
void OAIAutoReply::fromJson(QString jsonString) {
...
void OAIAutoReply::fromJsonObject(QJsonObject json) {
...
QString OAIAutoReply::asJson() const {
...
QJsonObject OAIAutoReply::asJsonObject() const {
    QJsonObject obj;
    if (m_enabled_isSet) {
...
bool OAIAutoReply::isEnabled() const {
    return m_enabled;
}
void OAIAutoReply::setEnabled(const bool &enabled) {
    m_enabled = enabled;
    m_enabled_isSet = true;
}

bool OAIAutoReply::is_enabled_Set() const{
    return m_enabled_isSet;
}

bool OAIAutoReply::is_enabled_Valid() const{
    return m_enabled_isValid;
}

QString OAIAutoReply::getMessage() const {
    return m_message;
}
void OAIAutoReply::setMessage(const QString &message) {
    m_message = message;
    m_message_isSet = true;
}

bool OAIAutoReply::is_message_Set() const{
    return m_message_isSet;
}

bool OAIAutoReply::is_message_Valid() const{
    return m_message_isValid;
}

QString OAIAutoReply::getSubject() const {
    return m_subject;
}
void OAIAutoReply::setSubject(const QString &subject) {
    m_subject = subject;
    m_subject_isSet = true;
}

bool OAIAutoReply::is_subject_Set() const{
    return m_subject_isSet;
}

bool OAIAutoReply::is_subject_Valid() const{
    return m_subject_isValid;
}

bool OAIAutoReply::isSet() const {
...
bool OAIAutoReply::isValid() const {
