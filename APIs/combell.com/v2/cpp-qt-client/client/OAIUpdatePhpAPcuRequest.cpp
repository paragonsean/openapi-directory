...
#include "OAIUpdatePhpAPcuRequest.h"
...
OAIUpdatePhpAPcuRequest::OAIUpdatePhpAPcuRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdatePhpAPcuRequest::OAIUpdatePhpAPcuRequest() {
    this->initializeModel();
}

OAIUpdatePhpAPcuRequest::~OAIUpdatePhpAPcuRequest() {}

void OAIUpdatePhpAPcuRequest::initializeModel() {

    m_apcu_size_isSet = false;
    m_apcu_size_isValid = false;

    m_enabled_isSet = false;
    m_enabled_isValid = false;
}

void OAIUpdatePhpAPcuRequest::fromJson(QString jsonString) {
...
void OAIUpdatePhpAPcuRequest::fromJsonObject(QJsonObject json) {

    m_apcu_size_isValid = ::OpenAPI::fromJsonValue(m_apcu_size, json[QString("apcu_size")]);
    m_apcu_size_isSet = !json[QString("apcu_size")].isNull() && m_apcu_size_isValid;

    m_enabled_isValid = ::OpenAPI::fromJsonValue(m_enabled, json[QString("enabled")]);
    m_enabled_isSet = !json[QString("enabled")].isNull() && m_enabled_isValid;
}

QString OAIUpdatePhpAPcuRequest::asJson() const {
...
QJsonObject OAIUpdatePhpAPcuRequest::asJsonObject() const {
    QJsonObject obj;
    if (m_apcu_size_isSet) {
        obj.insert(QString("apcu_size"), ::OpenAPI::toJsonValue(m_apcu_size));
    }
    if (m_enabled_isSet) {
...
qint32 OAIUpdatePhpAPcuRequest::getApcuSize() const {
    return m_apcu_size;
}
void OAIUpdatePhpAPcuRequest::setApcuSize(const qint32 &apcu_size) {
    m_apcu_size = apcu_size;
    m_apcu_size_isSet = true;
}

bool OAIUpdatePhpAPcuRequest::is_apcu_size_Set() const{
    return m_apcu_size_isSet;
}

bool OAIUpdatePhpAPcuRequest::is_apcu_size_Valid() const{
    return m_apcu_size_isValid;
}

bool OAIUpdatePhpAPcuRequest::isEnabled() const {
    return m_enabled;
}
void OAIUpdatePhpAPcuRequest::setEnabled(const bool &enabled) {
    m_enabled = enabled;
    m_enabled_isSet = true;
}

bool OAIUpdatePhpAPcuRequest::is_enabled_Set() const{
    return m_enabled_isSet;
}

bool OAIUpdatePhpAPcuRequest::is_enabled_Valid() const{
    return m_enabled_isValid;
}

bool OAIUpdatePhpAPcuRequest::isSet() const {
...
bool OAIUpdatePhpAPcuRequest::isValid() const {
