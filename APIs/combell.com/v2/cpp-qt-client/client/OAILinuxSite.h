...
#ifndef OAILinuxSite_H
#define OAILinuxSite_H
...
class OAILinuxSite : public OAIObject {
public:
    OAILinuxSite();
    OAILinuxSite(QString json);
    ~OAILinuxSite() override;
    ...
    QList<OAIHostHeader> getHostHeaders() const;
    void setHostHeaders(const QList<OAIHostHeader> &host_headers);
    bool is_host_headers_Set() const;
    bool is_host_headers_Valid() const;

    bool isHttp2Enabled() const;
    void setHttp2Enabled(const bool &http2_enabled);
    bool is_http2_enabled_Set() const;
    bool is_http2_enabled_Valid() const;

    bool isHttpsRedirectEnabled() const;
    void setHttpsRedirectEnabled(const bool &https_redirect_enabled);
    bool is_https_redirect_enabled_Set() const;
    bool is_https_redirect_enabled_Valid() const;
...
private:
    ...
    QList<OAIHostHeader> m_host_headers;
    bool m_host_headers_isSet;
    bool m_host_headers_isValid;

    bool m_http2_enabled;
    bool m_http2_enabled_isSet;
    bool m_http2_enabled_isValid;

    bool m_https_redirect_enabled;
    bool m_https_redirect_enabled_isSet;
    bool m_https_redirect_enabled_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAILinuxSite)

#endif // OAILinuxSite_H
