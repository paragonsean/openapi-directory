...
#ifndef OAIServicepack_H
#define OAIServicepack_H
...
class OAIServicepack : public OAIObject {
public:
    OAIServicepack();
    OAIServicepack(QString json);
    ~OAIServicepack() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIServicepack)

#endif // OAIServicepack_H
