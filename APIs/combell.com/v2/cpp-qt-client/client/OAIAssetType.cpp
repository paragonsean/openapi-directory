...
void OAIAssetType::fromJson(QString jsonString) {
    ...
    if ( jsonString.compare("domain", Qt::CaseInsensitive) == 0) {
        m_value = eOAIAssetType::DOMAIN;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("linux_hosting", Qt::CaseInsensitive) == 0) {
        m_value = eOAIAssetType::LINUX_HOSTING;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("mysql", Qt::CaseInsensitive) == 0) {
        m_value = eOAIAssetType::MYSQL;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("dns", Qt::CaseInsensitive) == 0) {
        m_value = eOAIAssetType::DNS;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("mailbox", Qt::CaseInsensitive) == 0) {
        m_value = eOAIAssetType::MAILBOX;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("windows_hosting", Qt::CaseInsensitive) == 0) {
        m_value = eOAIAssetType::WINDOWS_HOSTING;
        m_value_isSet = m_value_isValid = true;
    }
}
...
QString OAIAssetType::asJson() const {
    ...
    QString val;
    switch (m_value){
        case eOAIAssetType::DOMAIN:
            val = "domain";
            break;
        case eOAIAssetType::LINUX_HOSTING:
            val = "linux_hosting";
            break;
        case eOAIAssetType::MYSQL:
            val = "mysql";
            break;
        case eOAIAssetType::DNS:
            val = "dns";
            break;
        case eOAIAssetType::MAILBOX:
            val = "mailbox";
            break;
        case eOAIAssetType::WINDOWS_HOSTING:
            val = "windows_hosting";
            break;
        default:
            break;
