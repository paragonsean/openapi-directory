...
OAIMailboxesApi::OAIMailboxesApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAIMailboxesApi::~OAIMailboxesApi() {
}

void OAIMailboxesApi::initializeServerConfigs() {
    //Default server
    ...
    _serverConfigs.insert("changeMailboxPassword", defaultConf);
    _serverIndices.insert("changeMailboxPassword", 0);
    _serverConfigs.insert("configureMailboxAutoForward", defaultConf);
    _serverIndices.insert("configureMailboxAutoForward", 0);
    _serverConfigs.insert("configureMailboxAutoReply", defaultConf);
    _serverIndices.insert("configureMailboxAutoReply", 0);
    _serverConfigs.insert("createMailbox", defaultConf);
    _serverIndices.insert("createMailbox", 0);
    _serverConfigs.insert("deleteMailbox", defaultConf);
    _serverIndices.insert("deleteMailbox", 0);
    _serverConfigs.insert("getMailbox", defaultConf);
    _serverIndices.insert("getMailbox", 0);
    _serverConfigs.insert("getMailboxes", defaultConf);
    _serverIndices.insert("getMailboxes", 0);
}
...
*/
int OAIMailboxesApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAIMailboxesApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAIMailboxesApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAIMailboxesApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAIMailboxesApi::setUsername(const QString &username) {
    _username = username;
}

void OAIMailboxesApi::setPassword(const QString &password) {
    _password = password;
}


void OAIMailboxesApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAIMailboxesApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAIMailboxesApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAIMailboxesApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAIMailboxesApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAIMailboxesApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAIMailboxesApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAIMailboxesApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAIMailboxesApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAIMailboxesApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAIMailboxesApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAIMailboxesApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAIMailboxesApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAIMailboxesApi::changeMailboxPassword(const QString &mailbox_name, const QString &mailbox_name2, const ::OpenAPI::OptionalParam<OAIUpdateMailboxPasswordRequest> &oai_update_mailbox_password_request) {
    QString fullPath = QString(_serverConfigs["changeMailboxPassword"][_serverIndices.value("changeMailboxPassword")].URL()+"/mailboxes/{mailboxName}/password");
    
    
    {
        QString mailbox_name2PathParam("{");
        mailbox_name2PathParam.append("mailboxName").append("}");
        ...
        pathDelimiter = getParamStyleDelimiter(pathStyle, "mailboxName", false);
        QString paramString = (pathStyle == "matrix") ? pathPrefix+"mailboxName"+pathSuffix : pathPrefix;
        fullPath.replace(mailbox_name2PathParam, paramString+QUrl::toPercentEncoding(::OpenAPI::toStringValue(mailbox_name2)));
    }
    ...
    
    {
        ...
        queryDelimiter = getParamStyleDelimiter(queryStyle, "mailbox_name", true);
        if (fullPath.indexOf("?") > 0)
            fullPath.append(queryPrefix);
        else
            fullPath.append("?");

        fullPath.append(QUrl::toPercentEncoding("mailbox_name")).append(querySuffix).append(QUrl::toPercentEncoding(mailbox_name));
    }
    ...
    if (oai_update_mailbox_password_request.hasValue()){

        
        QByteArray output = oai_update_mailbox_password_request.value().asJson().toUtf8();
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIMailboxesApi::changeMailboxPasswordCallback);
    connect(this, &OAIMailboxesApi::abortRequestsSignal, worker, &QObject::deleteLater);
...
void OAIMailboxesApi::changeMailboxPasswordCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT changeMailboxPasswordSignal();
        Q_EMIT changeMailboxPasswordSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT changeMailboxPasswordSignalE(error_type, error_str);
        Q_EMIT changeMailboxPasswordSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT changeMailboxPasswordSignalError(error_type, error_str);
        Q_EMIT changeMailboxPasswordSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIMailboxesApi::configureMailboxAutoForward(const QString &mailbox_name, const QString &mailbox_name2, const ::OpenAPI::OptionalParam<OAIAutoForward> &oai_auto_forward) {
    QString fullPath = QString(_serverConfigs["configureMailboxAutoForward"][_serverIndices.value("configureMailboxAutoForward")].URL()+"/mailboxes/{mailboxName}/autoforward");
    ...
    if (oai_auto_forward.hasValue()){

        
        QByteArray output = oai_auto_forward.value().asJson().toUtf8();
        input.request_body.append(output);
    }
    for (auto keyValueIt = _defaultHeaders.keyValueBegin(); keyValueIt != _defaultHeaders.keyValueEnd(); keyValueIt++) {
        input.headers.insert(keyValueIt->first, keyValueIt->second);
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIMailboxesApi::configureMailboxAutoForwardCallback);
    connect(this, &OAIMailboxesApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIMailboxesApi::configureMailboxAutoForwardCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT configureMailboxAutoForwardSignal();
        Q_EMIT configureMailboxAutoForwardSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT configureMailboxAutoForwardSignalE(error_type, error_str);
        Q_EMIT configureMailboxAutoForwardSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT configureMailboxAutoForwardSignalError(error_type, error_str);
        Q_EMIT configureMailboxAutoForwardSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIMailboxesApi::configureMailboxAutoReply(const QString &mailbox_name, const QString &mailbox_name2, const ::OpenAPI::OptionalParam<OAIAutoReply> &oai_auto_reply) {
    QString fullPath = QString(_serverConfigs["configureMailboxAutoReply"][_serverIndices.value("configureMailboxAutoReply")].URL()+"/mailboxes/{mailboxName}/autoreply");
    ...
    if (oai_auto_reply.hasValue()){

        
        QByteArray output = oai_auto_reply.value().asJson().toUtf8();
        input.request_body.append(output);
    }
    for (auto keyValueIt = _defaultHeaders.keyValueBegin(); keyValueIt != _defaultHeaders.keyValueEnd(); keyValueIt++) {
        input.headers.insert(keyValueIt->first, keyValueIt->second);
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIMailboxesApi::configureMailboxAutoReplyCallback);
    connect(this, &OAIMailboxesApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIMailboxesApi::configureMailboxAutoReplyCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT configureMailboxAutoReplySignal();
        Q_EMIT configureMailboxAutoReplySignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT configureMailboxAutoReplySignalE(error_type, error_str);
        Q_EMIT configureMailboxAutoReplySignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT configureMailboxAutoReplySignalError(error_type, error_str);
        Q_EMIT configureMailboxAutoReplySignalErrorFull(worker, error_type, error_str);
    }
}

void OAIMailboxesApi::createMailbox(const ::OpenAPI::OptionalParam<OAICreateMailboxRequest> &oai_create_mailbox_request) {
    QString fullPath = QString(_serverConfigs["createMailbox"][_serverIndices.value("createMailbox")].URL()+"/mailboxes");
    ...
    if (oai_create_mailbox_request.hasValue()){

        
        QByteArray output = oai_create_mailbox_request.value().asJson().toUtf8();
        input.request_body.append(output);
    }
    for (auto keyValueIt = _defaultHeaders.keyValueBegin(); keyValueIt != _defaultHeaders.keyValueEnd(); keyValueIt++) {
        input.headers.insert(keyValueIt->first, keyValueIt->second);
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIMailboxesApi::createMailboxCallback);
    connect(this, &OAIMailboxesApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIMailboxesApi::createMailboxCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT createMailboxSignal();
        Q_EMIT createMailboxSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT createMailboxSignalE(error_type, error_str);
        Q_EMIT createMailboxSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT createMailboxSignalError(error_type, error_str);
        Q_EMIT createMailboxSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIMailboxesApi::deleteMailbox(const QString &mailbox_name, const QString &mailbox_name2) {
    QString fullPath = QString(_serverConfigs["deleteMailbox"][_serverIndices.value("deleteMailbox")].URL()+"/mailboxes/{mailboxName}");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIMailboxesApi::deleteMailboxCallback);
    connect(this, &OAIMailboxesApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIMailboxesApi::deleteMailboxCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT deleteMailboxSignal();
        Q_EMIT deleteMailboxSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT deleteMailboxSignalE(error_type, error_str);
        Q_EMIT deleteMailboxSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT deleteMailboxSignalError(error_type, error_str);
        Q_EMIT deleteMailboxSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIMailboxesApi::getMailbox(const QString &mailbox_name, const QString &mailbox_name2) {
    QString fullPath = QString(_serverConfigs["getMailbox"][_serverIndices.value("getMailbox")].URL()+"/mailboxes/{mailboxName}");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIMailboxesApi::getMailboxCallback);
    connect(this, &OAIMailboxesApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIMailboxesApi::getMailboxCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    OAIMailboxDetail output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT getMailboxSignal(output);
        Q_EMIT getMailboxSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT getMailboxSignalE(output, error_type, error_str);
        Q_EMIT getMailboxSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT getMailboxSignalError(output, error_type, error_str);
        Q_EMIT getMailboxSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIMailboxesApi::getMailboxes(const ::OpenAPI::OptionalParam<QString> &domain_name) {
    QString fullPath = QString(_serverConfigs["getMailboxes"][_serverIndices.value("getMailboxes")].URL()+"/mailboxes");
    ...
    if (domain_name.hasValue())
    {
        ...
        fullPath.append(QUrl::toPercentEncoding("domain_name")).append(querySuffix).append(QUrl::toPercentEncoding(domain_name.stringValue()));
    }
    OAIHttpRequestWorker *worker = new OAIHttpRequestWorker(this, _manager);
    worker->setTimeOut(_timeOut);
    worker->setWorkingDirectory(_workingDirectory);
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIMailboxesApi::getMailboxesCallback);
    connect(this, &OAIMailboxesApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIMailboxesApi::getMailboxesCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT getMailboxesSignal(output);
        Q_EMIT getMailboxesSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT getMailboxesSignalE(output, error_type, error_str);
        Q_EMIT getMailboxesSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT getMailboxesSignalError(output, error_type, error_str);
        Q_EMIT getMailboxesSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIMailboxesApi::tokenAvailable(){
