...
#ifndef OAIAutoReply_H
#define OAIAutoReply_H
...
class OAIAutoReply : public OAIObject {
public:
    OAIAutoReply();
    OAIAutoReply(QString json);
    ~OAIAutoReply() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAutoReply)

#endif // OAIAutoReply_H
