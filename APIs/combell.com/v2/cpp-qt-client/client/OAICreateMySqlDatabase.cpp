...
OAICreateMySqlDatabase::OAICreateMySqlDatabase(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateMySqlDatabase::OAICreateMySqlDatabase() {
    this->initializeModel();
}

OAICreateMySqlDatabase::~OAICreateMySqlDatabase() {}

void OAICreateMySqlDatabase::initializeModel() {
...
void OAICreateMySqlDatabase::fromJson(QString jsonString) {
...
void OAICreateMySqlDatabase::fromJsonObject(QJsonObject json) {
...
QString OAICreateMySqlDatabase::asJson() const {
...
QJsonObject OAICreateMySqlDatabase::asJsonObject() const {
    QJsonObject obj;
...
qint32 OAICreateMySqlDatabase::getAccountId() const {
    return m_account_id;
}
void OAICreateMySqlDatabase::setAccountId(const qint32 &account_id) {
    m_account_id = account_id;
    m_account_id_isSet = true;
}

bool OAICreateMySqlDatabase::is_account_id_Set() const{
    return m_account_id_isSet;
}

bool OAICreateMySqlDatabase::is_account_id_Valid() const{
    return m_account_id_isValid;
}

QString OAICreateMySqlDatabase::getDatabaseName() const {
    return m_database_name;
}
void OAICreateMySqlDatabase::setDatabaseName(const QString &database_name) {
    m_database_name = database_name;
    m_database_name_isSet = true;
}

bool OAICreateMySqlDatabase::is_database_name_Set() const{
    return m_database_name_isSet;
}

bool OAICreateMySqlDatabase::is_database_name_Valid() const{
    return m_database_name_isValid;
}

QString OAICreateMySqlDatabase::getPassword() const {
    return m_password;
}
void OAICreateMySqlDatabase::setPassword(const QString &password) {
    m_password = password;
    m_password_isSet = true;
}

bool OAICreateMySqlDatabase::is_password_Set() const{
    return m_password_isSet;
}

bool OAICreateMySqlDatabase::is_password_Valid() const{
    return m_password_isValid;
}

bool OAICreateMySqlDatabase::isSet() const {
...
bool OAICreateMySqlDatabase::isValid() const {
