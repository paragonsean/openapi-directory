...
OAIMailZone::OAIMailZone(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIMailZone::OAIMailZone() {
    this->initializeModel();
}

OAIMailZone::~OAIMailZone() {}

void OAIMailZone::initializeModel() {

    m_aliases_isSet = false;
    m_aliases_isValid = false;

    m_anti_spam_isSet = false;
    m_anti_spam_isValid = false;
    ...
    m_smtp_domains_isSet = false;
    m_smtp_domains_isValid = false;
}

void OAIMailZone::fromJson(QString jsonString) {
...
void OAIMailZone::fromJsonObject(QJsonObject json) {
    ...
    m_anti_spam_isValid = ::OpenAPI::fromJsonValue(m_anti_spam, json[QString("anti_spam")]);
    m_anti_spam_isSet = !json[QString("anti_spam")].isNull() && m_anti_spam_isValid;
    ...
    m_smtp_domains_isValid = ::OpenAPI::fromJsonValue(m_smtp_domains, json[QString("smtp_domains")]);
    m_smtp_domains_isSet = !json[QString("smtp_domains")].isNull() && m_smtp_domains_isValid;
}

QString OAIMailZone::asJson() const {
...
QJsonObject OAIMailZone::asJsonObject() const {
    ...
    if (m_smtp_domains.size() > 0) {
        obj.insert(QString("smtp_domains"), ::OpenAPI::toJsonValue(m_smtp_domains));
    }
    return obj;
}

QList<OAIAlias> OAIMailZone::getAliases() const {
    return m_aliases;
}
void OAIMailZone::setAliases(const QList<OAIAlias> &aliases) {
    m_aliases = aliases;
    m_aliases_isSet = true;
}

bool OAIMailZone::is_aliases_Set() const{
    return m_aliases_isSet;
}

bool OAIMailZone::is_aliases_Valid() const{
    return m_aliases_isValid;
}

OAIAntiSpam OAIMailZone::getAntiSpam() const {
    return m_anti_spam;
}
void OAIMailZone::setAntiSpam(const OAIAntiSpam &anti_spam) {
    m_anti_spam = anti_spam;
    m_anti_spam_isSet = true;
}

bool OAIMailZone::is_anti_spam_Set() const{
    return m_anti_spam_isSet;
}

bool OAIMailZone::is_anti_spam_Valid() const{
    return m_anti_spam_isValid;
}

QList<OAIMailZoneAccount> OAIMailZone::getAvailableAccounts() const {
    return m_available_accounts;
}
void OAIMailZone::setAvailableAccounts(const QList<OAIMailZoneAccount> &available_accounts) {
    m_available_accounts = available_accounts;
    m_available_accounts_isSet = true;
}

bool OAIMailZone::is_available_accounts_Set() const{
    return m_available_accounts_isSet;
}

bool OAIMailZone::is_available_accounts_Valid() const{
    return m_available_accounts_isValid;
}

OAICatchAll OAIMailZone::getCatchAll() const {
    return m_catch_all;
}
void OAIMailZone::setCatchAll(const OAICatchAll &catch_all) {
    m_catch_all = catch_all;
    m_catch_all_isSet = true;
}

bool OAIMailZone::is_catch_all_Set() const{
    return m_catch_all_isSet;
}

bool OAIMailZone::is_catch_all_Valid() const{
    return m_catch_all_isValid;
}

bool OAIMailZone::isEnabled() const {
    return m_enabled;
}
void OAIMailZone::setEnabled(const bool &enabled) {
    m_enabled = enabled;
    m_enabled_isSet = true;
}

bool OAIMailZone::is_enabled_Set() const{
    return m_enabled_isSet;
}

bool OAIMailZone::is_enabled_Valid() const{
    return m_enabled_isValid;
}

QString OAIMailZone::getName() const {
    return m_name;
}
void OAIMailZone::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIMailZone::is_name_Set() const{
    return m_name_isSet;
}

bool OAIMailZone::is_name_Valid() const{
    return m_name_isValid;
}

QList<OAISmtpDomain> OAIMailZone::getSmtpDomains() const {
    return m_smtp_domains;
}
void OAIMailZone::setSmtpDomains(const QList<OAISmtpDomain> &smtp_domains) {
    m_smtp_domains = smtp_domains;
    m_smtp_domains_isSet = true;
}

bool OAIMailZone::is_smtp_domains_Set() const{
    return m_smtp_domains_isSet;
}

bool OAIMailZone::is_smtp_domains_Valid() const{
    return m_smtp_domains_isValid;
}

bool OAIMailZone::isSet() const {
...
bool OAIMailZone::isValid() const {
