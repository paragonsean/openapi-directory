...
OAIUpdateMailboxPasswordRequest::OAIUpdateMailboxPasswordRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateMailboxPasswordRequest::OAIUpdateMailboxPasswordRequest() {
    this->initializeModel();
}

OAIUpdateMailboxPasswordRequest::~OAIUpdateMailboxPasswordRequest() {}

void OAIUpdateMailboxPasswordRequest::initializeModel() {

    m_password_isSet = false;
    m_password_isValid = false;
}

void OAIUpdateMailboxPasswordRequest::fromJson(QString jsonString) {
...
void OAIUpdateMailboxPasswordRequest::fromJsonObject(QJsonObject json) {

    m_password_isValid = ::OpenAPI::fromJsonValue(m_password, json[QString("password")]);
    m_password_isSet = !json[QString("password")].isNull() && m_password_isValid;
}

QString OAIUpdateMailboxPasswordRequest::asJson() const {
...
QJsonObject OAIUpdateMailboxPasswordRequest::asJsonObject() const {
    QJsonObject obj;
    if (m_password_isSet) {
...
QString OAIUpdateMailboxPasswordRequest::getPassword() const {
    return m_password;
}
void OAIUpdateMailboxPasswordRequest::setPassword(const QString &password) {
    m_password = password;
    m_password_isSet = true;
}

bool OAIUpdateMailboxPasswordRequest::is_password_Set() const{
    return m_password_isSet;
}

bool OAIUpdateMailboxPasswordRequest::is_password_Valid() const{
    return m_password_isValid;
}

bool OAIUpdateMailboxPasswordRequest::isSet() const {
...
bool OAIUpdateMailboxPasswordRequest::isValid() const {
