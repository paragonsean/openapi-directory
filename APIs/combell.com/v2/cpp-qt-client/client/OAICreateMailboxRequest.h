...
/*
 * OAICreateMailboxRequest.h
 *
 * 
 */

#ifndef OAICreateMailboxRequest_H
#define OAICreateMailboxRequest_H
...
class OAICreateMailboxRequest : public OAIObject {
public:
    OAICreateMailboxRequest();
    OAICreateMailboxRequest(QString json);
    ~OAICreateMailboxRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateMailboxRequest)

#endif // OAICreateMailboxRequest_H
