...
/*
 * OAISslCertificateRequestDetail.h
 *
 * 
 */

#ifndef OAISslCertificateRequestDetail_H
#define OAISslCertificateRequestDetail_H
...
namespace OpenAPI {
class OAISslSubjectAltName;
class OAISslCertificateRequestValidation;

class OAISslCertificateRequestDetail : public OAIObject {
public:
    OAISslCertificateRequestDetail();
    OAISslCertificateRequestDetail(QString json);
    ~OAISslCertificateRequestDetail() override;
    ...
    QList<OAISslSubjectAltName> getSubjectAltNames() const;
    void setSubjectAltNames(const QList<OAISslSubjectAltName> &subject_alt_names);
    bool is_subject_alt_names_Set() const;
    bool is_subject_alt_names_Valid() const;
    ...
    QList<OAISslCertificateRequestValidation> getValidations() const;
    void setValidations(const QList<OAISslCertificateRequestValidation> &validations);
...
private:
    ...
    QList<OAISslSubjectAltName> m_subject_alt_names;
    bool m_subject_alt_names_isSet;
    bool m_subject_alt_names_isValid;

    OAISslCertificateValidationLevel m_validation_level;
    bool m_validation_level_isSet;
    bool m_validation_level_isValid;

    QList<OAISslCertificateRequestValidation> m_validations;
...
Q_DECLARE_METATYPE(OpenAPI::OAISslCertificateRequestDetail)

#endif // OAISslCertificateRequestDetail_H
