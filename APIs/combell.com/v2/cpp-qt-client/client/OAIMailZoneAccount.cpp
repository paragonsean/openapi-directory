...
OAIMailZoneAccount::OAIMailZoneAccount(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIMailZoneAccount::OAIMailZoneAccount() {
    this->initializeModel();
}

OAIMailZoneAccount::~OAIMailZoneAccount() {}

void OAIMailZoneAccount::initializeModel() {
...
void OAIMailZoneAccount::fromJson(QString jsonString) {
...
void OAIMailZoneAccount::fromJsonObject(QJsonObject json) {
...
QString OAIMailZoneAccount::asJson() const {
...
QJsonObject OAIMailZoneAccount::asJsonObject() const {
    QJsonObject obj;
...
qint32 OAIMailZoneAccount::getAccountId() const {
    return m_account_id;
}
void OAIMailZoneAccount::setAccountId(const qint32 &account_id) {
    m_account_id = account_id;
    m_account_id_isSet = true;
}

bool OAIMailZoneAccount::is_account_id_Set() const{
    return m_account_id_isSet;
}

bool OAIMailZoneAccount::is_account_id_Valid() const{
    return m_account_id_isValid;
}

qint32 OAIMailZoneAccount::getSize() const {
    return m_size;
}
void OAIMailZoneAccount::setSize(const qint32 &size) {
    m_size = size;
    m_size_isSet = true;
}

bool OAIMailZoneAccount::is_size_Set() const{
    return m_size_isSet;
}

bool OAIMailZoneAccount::is_size_Valid() const{
    return m_size_isValid;
}

bool OAIMailZoneAccount::isSet() const {
...
bool OAIMailZoneAccount::isValid() const {
