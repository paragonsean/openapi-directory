...
/*
 * OAIAddSubsiteRequest.h
 *
 * 
 */

#ifndef OAIAddSubsiteRequest_H
#define OAIAddSubsiteRequest_H
...
class OAIAddSubsiteRequest : public OAIObject {
public:
    OAIAddSubsiteRequest();
    OAIAddSubsiteRequest(QString json);
    ~OAIAddSubsiteRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAddSubsiteRequest)

#endif // OAIAddSubsiteRequest_H
