...
#ifndef OAI_OAIMailboxesApi_H
#define OAI_OAIMailboxesApi_H
...
#include "OAICreateMailboxRequest.h"
#include "OAIMailbox.h"
#include "OAIMailboxDetail.h"
#include "OAIUpdateMailboxPasswordRequest.h"
#include <QString>
...
class OAIMailboxesApi : public QObject {
    Q_OBJECT

public:
    OAIMailboxesApi(const int timeOut = 0);
    ~OAIMailboxesApi();
    ...
    /**
    * @param[in]  mailbox_name QString [required]
    * @param[in]  mailbox_name2 QString [required]
    * @param[in]  oai_update_mailbox_password_request OAIUpdateMailboxPasswordRequest [optional]
    */
    virtual void changeMailboxPassword(const QString &mailbox_name, const QString &mailbox_name2, const ::OpenAPI::OptionalParam<OAIUpdateMailboxPasswordRequest> &oai_update_mailbox_password_request = ::OpenAPI::OptionalParam<OAIUpdateMailboxPasswordRequest>());

    /**
    * @param[in]  mailbox_name QString [required]
    * @param[in]  mailbox_name2 QString [required]
    * @param[in]  oai_auto_forward OAIAutoForward [optional]
    */
    virtual void configureMailboxAutoForward(const QString &mailbox_name, const QString &mailbox_name2, const ::OpenAPI::OptionalParam<OAIAutoForward> &oai_auto_forward = ::OpenAPI::OptionalParam<OAIAutoForward>());

    /**
    * @param[in]  mailbox_name QString [required]
    * @param[in]  mailbox_name2 QString [required]
    * @param[in]  oai_auto_reply OAIAutoReply [optional]
    */
    virtual void configureMailboxAutoReply(const QString &mailbox_name, const QString &mailbox_name2, const ::OpenAPI::OptionalParam<OAIAutoReply> &oai_auto_reply = ::OpenAPI::OptionalParam<OAIAutoReply>());

    /**
    * @param[in]  oai_create_mailbox_request OAICreateMailboxRequest [optional]
    */
    virtual void createMailbox(const ::OpenAPI::OptionalParam<OAICreateMailboxRequest> &oai_create_mailbox_request = ::OpenAPI::OptionalParam<OAICreateMailboxRequest>());

    /**
    * @param[in]  mailbox_name QString [required]
    * @param[in]  mailbox_name2 QString [required]
    */
    virtual void deleteMailbox(const QString &mailbox_name, const QString &mailbox_name2);

    /**
    * @param[in]  mailbox_name QString [required]
    * @param[in]  mailbox_name2 QString [required]
    */
    virtual void getMailbox(const QString &mailbox_name, const QString &mailbox_name2);

    /**
    * @param[in]  domain_name QString [optional]
    */
    virtual void getMailboxes(const ::OpenAPI::OptionalParam<QString> &domain_name = ::OpenAPI::OptionalParam<QString>());
...
private:
    ...
    void changeMailboxPasswordCallback(OAIHttpRequestWorker *worker);
    void configureMailboxAutoForwardCallback(OAIHttpRequestWorker *worker);
    void configureMailboxAutoReplyCallback(OAIHttpRequestWorker *worker);
    void createMailboxCallback(OAIHttpRequestWorker *worker);
    void deleteMailboxCallback(OAIHttpRequestWorker *worker);
    void getMailboxCallback(OAIHttpRequestWorker *worker);
    void getMailboxesCallback(OAIHttpRequestWorker *worker);

Q_SIGNALS:

    void changeMailboxPasswordSignal();
    void configureMailboxAutoForwardSignal();
    void configureMailboxAutoReplySignal();
    void createMailboxSignal();
    void deleteMailboxSignal();
    void getMailboxSignal(OAIMailboxDetail summary);
    void getMailboxesSignal(QList<OAIMailbox> summary);


    void changeMailboxPasswordSignalFull(OAIHttpRequestWorker *worker);
    void configureMailboxAutoForwardSignalFull(OAIHttpRequestWorker *worker);
    void configureMailboxAutoReplySignalFull(OAIHttpRequestWorker *worker);
    void createMailboxSignalFull(OAIHttpRequestWorker *worker);
    void deleteMailboxSignalFull(OAIHttpRequestWorker *worker);
    void getMailboxSignalFull(OAIHttpRequestWorker *worker, OAIMailboxDetail summary);
    void getMailboxesSignalFull(OAIHttpRequestWorker *worker, QList<OAIMailbox> summary);

    Q_DECL_DEPRECATED_X("Use changeMailboxPasswordSignalError() instead")
    void changeMailboxPasswordSignalE(QNetworkReply::NetworkError error_type, QString error_str);
    void changeMailboxPasswordSignalError(QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use configureMailboxAutoForwardSignalError() instead")
    void configureMailboxAutoForwardSignalE(QNetworkReply::NetworkError error_type, QString error_str);
    void configureMailboxAutoForwardSignalError(QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use configureMailboxAutoReplySignalError() instead")
    void configureMailboxAutoReplySignalE(QNetworkReply::NetworkError error_type, QString error_str);
    void configureMailboxAutoReplySignalError(QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use createMailboxSignalError() instead")
    void createMailboxSignalE(QNetworkReply::NetworkError error_type, QString error_str);
    void createMailboxSignalError(QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use deleteMailboxSignalError() instead")
    void deleteMailboxSignalE(QNetworkReply::NetworkError error_type, QString error_str);
    void deleteMailboxSignalError(QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use getMailboxSignalError() instead")
    void getMailboxSignalE(OAIMailboxDetail summary, QNetworkReply::NetworkError error_type, QString error_str);
    void getMailboxSignalError(OAIMailboxDetail summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use getMailboxesSignalError() instead")
    void getMailboxesSignalE(QList<OAIMailbox> summary, QNetworkReply::NetworkError error_type, QString error_str);
    void getMailboxesSignalError(QList<OAIMailbox> summary, QNetworkReply::NetworkError error_type, const QString &error_str);

    Q_DECL_DEPRECATED_X("Use changeMailboxPasswordSignalErrorFull() instead")
    void changeMailboxPasswordSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void changeMailboxPasswordSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use configureMailboxAutoForwardSignalErrorFull() instead")
    void configureMailboxAutoForwardSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void configureMailboxAutoForwardSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use configureMailboxAutoReplySignalErrorFull() instead")
    void configureMailboxAutoReplySignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void configureMailboxAutoReplySignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use createMailboxSignalErrorFull() instead")
    void createMailboxSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void createMailboxSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use deleteMailboxSignalErrorFull() instead")
    void deleteMailboxSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void deleteMailboxSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use getMailboxSignalErrorFull() instead")
    void getMailboxSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void getMailboxSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use getMailboxesSignalErrorFull() instead")
    void getMailboxesSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void getMailboxesSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
