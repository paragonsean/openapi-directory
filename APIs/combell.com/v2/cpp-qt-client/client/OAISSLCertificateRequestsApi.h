...
#ifndef OAI_OAISSLCertificateRequestsApi_H
#define OAI_OAISSLCertificateRequestsApi_H
...
class OAISSLCertificateRequestsApi : public QObject {
    Q_OBJECT

public:
    OAISSLCertificateRequestsApi(const int timeOut = 0);
    ~OAISSLCertificateRequestsApi();
    ...
    /**
    * @param[in]  oai_create_ssl_certificate_request OAICreateSslCertificateRequest [optional]
    */
    virtual void addSslCertificateRequest(const ::OpenAPI::OptionalParam<OAICreateSslCertificateRequest> &oai_create_ssl_certificate_request = ::OpenAPI::OptionalParam<OAICreateSslCertificateRequest>());

    /**
    * @param[in]  id qint32 [required]
    */
    virtual void getSslCertificateRequest(const qint32 &id);

    /**
    * @param[in]  skip qint32 [optional]
    * @param[in]  take qint32 [optional]
    */
    virtual void getSslCertificateRequests(const ::OpenAPI::OptionalParam<qint32> &skip = ::OpenAPI::OptionalParam<qint32>(), const ::OpenAPI::OptionalParam<qint32> &take = ::OpenAPI::OptionalParam<qint32>());

    /**
    * @param[in]  id qint32 [required]
    */
    virtual void verifySslCertificateRequestDomainValidations(const qint32 &id);
...
private:
    ...
    void addSslCertificateRequestCallback(OAIHttpRequestWorker *worker);
    void getSslCertificateRequestCallback(OAIHttpRequestWorker *worker);
    void getSslCertificateRequestsCallback(OAIHttpRequestWorker *worker);
    void verifySslCertificateRequestDomainValidationsCallback(OAIHttpRequestWorker *worker);

Q_SIGNALS:

    void addSslCertificateRequestSignal();
    void getSslCertificateRequestSignal(OAISslCertificateRequestDetail summary);
    void getSslCertificateRequestsSignal(QList<OAISslCertificateRequest> summary);
    void verifySslCertificateRequestDomainValidationsSignal();


    void addSslCertificateRequestSignalFull(OAIHttpRequestWorker *worker);
    void getSslCertificateRequestSignalFull(OAIHttpRequestWorker *worker, OAISslCertificateRequestDetail summary);
    void getSslCertificateRequestsSignalFull(OAIHttpRequestWorker *worker, QList<OAISslCertificateRequest> summary);
    void verifySslCertificateRequestDomainValidationsSignalFull(OAIHttpRequestWorker *worker);

    Q_DECL_DEPRECATED_X("Use addSslCertificateRequestSignalError() instead")
    void addSslCertificateRequestSignalE(QNetworkReply::NetworkError error_type, QString error_str);
    void addSslCertificateRequestSignalError(QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use getSslCertificateRequestSignalError() instead")
    void getSslCertificateRequestSignalE(OAISslCertificateRequestDetail summary, QNetworkReply::NetworkError error_type, QString error_str);
    void getSslCertificateRequestSignalError(OAISslCertificateRequestDetail summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use getSslCertificateRequestsSignalError() instead")
    void getSslCertificateRequestsSignalE(QList<OAISslCertificateRequest> summary, QNetworkReply::NetworkError error_type, QString error_str);
    void getSslCertificateRequestsSignalError(QList<OAISslCertificateRequest> summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use verifySslCertificateRequestDomainValidationsSignalError() instead")
    void verifySslCertificateRequestDomainValidationsSignalE(QNetworkReply::NetworkError error_type, QString error_str);
    void verifySslCertificateRequestDomainValidationsSignalError(QNetworkReply::NetworkError error_type, const QString &error_str);

    Q_DECL_DEPRECATED_X("Use addSslCertificateRequestSignalErrorFull() instead")
    void addSslCertificateRequestSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void addSslCertificateRequestSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use getSslCertificateRequestSignalErrorFull() instead")
    void getSslCertificateRequestSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void getSslCertificateRequestSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use getSslCertificateRequestsSignalErrorFull() instead")
    void getSslCertificateRequestsSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void getSslCertificateRequestsSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use verifySslCertificateRequestDomainValidationsSignalErrorFull() instead")
    void verifySslCertificateRequestDomainValidationsSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void verifySslCertificateRequestDomainValidationsSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
