...
#include "OAIAddHostHeaderRequest.h"
...
OAIAddHostHeaderRequest::OAIAddHostHeaderRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAddHostHeaderRequest::OAIAddHostHeaderRequest() {
    this->initializeModel();
}

OAIAddHostHeaderRequest::~OAIAddHostHeaderRequest() {}

void OAIAddHostHeaderRequest::initializeModel() {

    m_domain_name_isSet = false;
    m_domain_name_isValid = false;
}

void OAIAddHostHeaderRequest::fromJson(QString jsonString) {
...
void OAIAddHostHeaderRequest::fromJsonObject(QJsonObject json) {
...
QString OAIAddHostHeaderRequest::asJson() const {
...
QJsonObject OAIAddHostHeaderRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIAddHostHeaderRequest::getDomainName() const {
    return m_domain_name;
}
void OAIAddHostHeaderRequest::setDomainName(const QString &domain_name) {
    m_domain_name = domain_name;
    m_domain_name_isSet = true;
}

bool OAIAddHostHeaderRequest::is_domain_name_Set() const{
    return m_domain_name_isSet;
}

bool OAIAddHostHeaderRequest::is_domain_name_Valid() const{
    return m_domain_name_isValid;
}

bool OAIAddHostHeaderRequest::isSet() const {
...
bool OAIAddHostHeaderRequest::isValid() const {
