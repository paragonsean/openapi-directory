...
OAIProvisioningJobStatus::OAIProvisioningJobStatus(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIProvisioningJobStatus::OAIProvisioningJobStatus() {
    this->initializeModel();
}

OAIProvisioningJobStatus::~OAIProvisioningJobStatus() {}

void OAIProvisioningJobStatus::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIProvisioningJobStatus::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIProvisioningJobStatus::fromJson(QString jsonString) {
    
    if ( jsonString.compare("ongoing", Qt::CaseInsensitive) == 0) {
        m_value = eOAIProvisioningJobStatus::ONGOING;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("cancelled", Qt::CaseInsensitive) == 0) {
        m_value = eOAIProvisioningJobStatus::CANCELLED;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("failed", Qt::CaseInsensitive) == 0) {
        m_value = eOAIProvisioningJobStatus::FAILED;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("finished", Qt::CaseInsensitive) == 0) {
        m_value = eOAIProvisioningJobStatus::FINISHED;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIProvisioningJobStatus::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIProvisioningJobStatus::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIProvisioningJobStatus::ONGOING:
            val = "ongoing";
            break;
        case eOAIProvisioningJobStatus::CANCELLED:
            val = "cancelled";
            break;
        case eOAIProvisioningJobStatus::FAILED:
            val = "failed";
            break;
        case eOAIProvisioningJobStatus::FINISHED:
            val = "finished";
            break;
        default:
            break;
...
QJsonValue OAIProvisioningJobStatus::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIProvisioningJobStatus::eOAIProvisioningJobStatus OAIProvisioningJobStatus::getValue() const {
    return m_value;
}

void OAIProvisioningJobStatus::setValue(const OAIProvisioningJobStatus::eOAIProvisioningJobStatus& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIProvisioningJobStatus::isSet() const {
    
    return m_value_isSet;
}

bool OAIProvisioningJobStatus::isValid() const {
