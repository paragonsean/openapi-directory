...
OAILinuxHosting::OAILinuxHosting(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAILinuxHosting::OAILinuxHosting() {
    this->initializeModel();
}

OAILinuxHosting::~OAILinuxHosting() {}

void OAILinuxHosting::initializeModel() {
...
void OAILinuxHosting::fromJson(QString jsonString) {
...
void OAILinuxHosting::fromJsonObject(QJsonObject json) {
...
QString OAILinuxHosting::asJson() const {
...
QJsonObject OAILinuxHosting::asJsonObject() const {
    QJsonObject obj;
...
QString OAILinuxHosting::getDomainName() const {
    return m_domain_name;
}
void OAILinuxHosting::setDomainName(const QString &domain_name) {
    m_domain_name = domain_name;
    m_domain_name_isSet = true;
}

bool OAILinuxHosting::is_domain_name_Set() const{
    return m_domain_name_isSet;
}

bool OAILinuxHosting::is_domain_name_Valid() const{
    return m_domain_name_isValid;
}

qint32 OAILinuxHosting::getServicepackId() const {
    return m_servicepack_id;
}
void OAILinuxHosting::setServicepackId(const qint32 &servicepack_id) {
    m_servicepack_id = servicepack_id;
    m_servicepack_id_isSet = true;
}

bool OAILinuxHosting::is_servicepack_id_Set() const{
    return m_servicepack_id_isSet;
}

bool OAILinuxHosting::is_servicepack_id_Valid() const{
    return m_servicepack_id_isValid;
}

bool OAILinuxHosting::isSet() const {
...
bool OAILinuxHosting::isValid() const {
