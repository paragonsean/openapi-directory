...
QString OAIRegistrant::getAddress() const {
    return m_address;
}
void OAIRegistrant::setAddress(const QString &address) {
    m_address = address;
    m_address_isSet = true;
}

bool OAIRegistrant::is_address_Set() const{
    return m_address_isSet;
}

bool OAIRegistrant::is_address_Valid() const{
    return m_address_isValid;
}

QString OAIRegistrant::getCity() const {
    return m_city;
}
void OAIRegistrant::setCity(const QString &city) {
    m_city = city;
    m_city_isSet = true;
}

bool OAIRegistrant::is_city_Set() const{
    return m_city_isSet;
}

bool OAIRegistrant::is_city_Valid() const{
    return m_city_isValid;
}

QString OAIRegistrant::getCompanyName() const {
    return m_company_name;
}
void OAIRegistrant::setCompanyName(const QString &company_name) {
    m_company_name = company_name;
    m_company_name_isSet = true;
}

bool OAIRegistrant::is_company_name_Set() const{
    return m_company_name_isSet;
}

bool OAIRegistrant::is_company_name_Valid() const{
    return m_company_name_isValid;
}

QString OAIRegistrant::getCountryCode() const {
    return m_country_code;
}
void OAIRegistrant::setCountryCode(const QString &country_code) {
    m_country_code = country_code;
    m_country_code_isSet = true;
}

bool OAIRegistrant::is_country_code_Set() const{
    return m_country_code_isSet;
}

bool OAIRegistrant::is_country_code_Valid() const{
...
QString OAIRegistrant::getEnterpriseNumber() const {
    return m_enterprise_number;
}
void OAIRegistrant::setEnterpriseNumber(const QString &enterprise_number) {
    m_enterprise_number = enterprise_number;
    m_enterprise_number_isSet = true;
}

bool OAIRegistrant::is_enterprise_number_Set() const{
    return m_enterprise_number_isSet;
}

bool OAIRegistrant::is_enterprise_number_Valid() const{
    return m_enterprise_number_isValid;
}

QString OAIRegistrant::getFax() const {
    return m_fax;
}
void OAIRegistrant::setFax(const QString &fax) {
    m_fax = fax;
    m_fax_isSet = true;
}

bool OAIRegistrant::is_fax_Set() const{
    return m_fax_isSet;
}

bool OAIRegistrant::is_fax_Valid() const{
...
QString OAIRegistrant::getLanguageCode() const {
    return m_language_code;
}
void OAIRegistrant::setLanguageCode(const QString &language_code) {
    m_language_code = language_code;
    m_language_code_isSet = true;
}

bool OAIRegistrant::is_language_code_Set() const{
    return m_language_code_isSet;
}

bool OAIRegistrant::is_language_code_Valid() const{
...
QString OAIRegistrant::getPhone() const {
    return m_phone;
}
void OAIRegistrant::setPhone(const QString &phone) {
    m_phone = phone;
    m_phone_isSet = true;
}

bool OAIRegistrant::is_phone_Set() const{
    return m_phone_isSet;
}

bool OAIRegistrant::is_phone_Valid() const{
    return m_phone_isValid;
}

QString OAIRegistrant::getPostalCode() const {
    return m_postal_code;
}
void OAIRegistrant::setPostalCode(const QString &postal_code) {
    m_postal_code = postal_code;
    m_postal_code_isSet = true;
}

bool OAIRegistrant::is_postal_code_Set() const{
    return m_postal_code_isSet;
}

bool OAIRegistrant::is_postal_code_Valid() const{
