...
OAIUpdateAliasRequest::OAIUpdateAliasRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateAliasRequest::OAIUpdateAliasRequest() {
    this->initializeModel();
}

OAIUpdateAliasRequest::~OAIUpdateAliasRequest() {}

void OAIUpdateAliasRequest::initializeModel() {

    m_destinations_isSet = false;
    m_destinations_isValid = false;
}

void OAIUpdateAliasRequest::fromJson(QString jsonString) {
...
void OAIUpdateAliasRequest::fromJsonObject(QJsonObject json) {
...
QString OAIUpdateAliasRequest::asJson() const {
...
QJsonObject OAIUpdateAliasRequest::asJsonObject() const {
    QJsonObject obj;
...
QList<QString> OAIUpdateAliasRequest::getDestinations() const {
    return m_destinations;
}
void OAIUpdateAliasRequest::setDestinations(const QList<QString> &destinations) {
    m_destinations = destinations;
    m_destinations_isSet = true;
}

bool OAIUpdateAliasRequest::is_destinations_Set() const{
    return m_destinations_isSet;
}

bool OAIUpdateAliasRequest::is_destinations_Valid() const{
    return m_destinations_isValid;
}

bool OAIUpdateAliasRequest::isSet() const {
...
bool OAIUpdateAliasRequest::isValid() const {
