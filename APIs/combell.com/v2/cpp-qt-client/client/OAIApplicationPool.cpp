...
OAIApplicationPool::OAIApplicationPool(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIApplicationPool::OAIApplicationPool() {
    this->initializeModel();
}

OAIApplicationPool::~OAIApplicationPool() {}

void OAIApplicationPool::initializeModel() {

    m_installed_net_core_runtimes_isSet = false;
    m_installed_net_core_runtimes_isValid = false;

    m_pipeline_mode_isSet = false;
    m_pipeline_mode_isValid = false;

    m_runtime_isSet = false;
    m_runtime_isValid = false;
}

void OAIApplicationPool::fromJson(QString jsonString) {
...
void OAIApplicationPool::fromJsonObject(QJsonObject json) {

    m_installed_net_core_runtimes_isValid = ::OpenAPI::fromJsonValue(m_installed_net_core_runtimes, json[QString("installed_net_core_runtimes")]);
    m_installed_net_core_runtimes_isSet = !json[QString("installed_net_core_runtimes")].isNull() && m_installed_net_core_runtimes_isValid;

    m_pipeline_mode_isValid = ::OpenAPI::fromJsonValue(m_pipeline_mode, json[QString("pipeline_mode")]);
    m_pipeline_mode_isSet = !json[QString("pipeline_mode")].isNull() && m_pipeline_mode_isValid;
...
QString OAIApplicationPool::asJson() const {
...
QJsonObject OAIApplicationPool::asJsonObject() const {
    QJsonObject obj;
    if (m_installed_net_core_runtimes.size() > 0) {
        obj.insert(QString("installed_net_core_runtimes"), ::OpenAPI::toJsonValue(m_installed_net_core_runtimes));
    }
    if (m_pipeline_mode_isSet) {
        obj.insert(QString("pipeline_mode"), ::OpenAPI::toJsonValue(m_pipeline_mode));
    }
    if (m_runtime_isSet) {
...
QList<QString> OAIApplicationPool::getInstalledNetCoreRuntimes() const {
    return m_installed_net_core_runtimes;
}
void OAIApplicationPool::setInstalledNetCoreRuntimes(const QList<QString> &installed_net_core_runtimes) {
    m_installed_net_core_runtimes = installed_net_core_runtimes;
    m_installed_net_core_runtimes_isSet = true;
}

bool OAIApplicationPool::is_installed_net_core_runtimes_Set() const{
    return m_installed_net_core_runtimes_isSet;
}

bool OAIApplicationPool::is_installed_net_core_runtimes_Valid() const{
    return m_installed_net_core_runtimes_isValid;
}

QString OAIApplicationPool::getPipelineMode() const {
    return m_pipeline_mode;
}
void OAIApplicationPool::setPipelineMode(const QString &pipeline_mode) {
    m_pipeline_mode = pipeline_mode;
    m_pipeline_mode_isSet = true;
}

bool OAIApplicationPool::is_pipeline_mode_Set() const{
    return m_pipeline_mode_isSet;
}

bool OAIApplicationPool::is_pipeline_mode_Valid() const{
    return m_pipeline_mode_isValid;
}

QString OAIApplicationPool::getRuntime() const {
    return m_runtime;
}
void OAIApplicationPool::setRuntime(const QString &runtime) {
    m_runtime = runtime;
    m_runtime_isSet = true;
}

bool OAIApplicationPool::is_runtime_Set() const{
    return m_runtime_isSet;
}

bool OAIApplicationPool::is_runtime_Valid() const{
    return m_runtime_isValid;
}

bool OAIApplicationPool::isSet() const {
...
bool OAIApplicationPool::isValid() const {
