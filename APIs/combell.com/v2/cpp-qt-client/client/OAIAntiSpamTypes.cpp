...
OAIAntiSpamTypes::OAIAntiSpamTypes(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAntiSpamTypes::OAIAntiSpamTypes() {
    this->initializeModel();
}

OAIAntiSpamTypes::~OAIAntiSpamTypes() {}

void OAIAntiSpamTypes::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIAntiSpamTypes::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIAntiSpamTypes::fromJson(QString jsonString) {
    
    if ( jsonString.compare("none", Qt::CaseInsensitive) == 0) {
        m_value = eOAIAntiSpamTypes::NONE;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("advanced", Qt::CaseInsensitive) == 0) {
        m_value = eOAIAntiSpamTypes::ADVANCED;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("basic", Qt::CaseInsensitive) == 0) {
        m_value = eOAIAntiSpamTypes::BASIC;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIAntiSpamTypes::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIAntiSpamTypes::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIAntiSpamTypes::NONE:
            val = "none";
            break;
        case eOAIAntiSpamTypes::ADVANCED:
            val = "advanced";
            break;
        case eOAIAntiSpamTypes::BASIC:
            val = "basic";
            break;
        default:
            break;
...
QJsonValue OAIAntiSpamTypes::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIAntiSpamTypes::eOAIAntiSpamTypes OAIAntiSpamTypes::getValue() const {
    return m_value;
}

void OAIAntiSpamTypes::setValue(const OAIAntiSpamTypes::eOAIAntiSpamTypes& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIAntiSpamTypes::isSet() const {
    
    return m_value_isSet;
}

bool OAIAntiSpamTypes::isValid() const {
