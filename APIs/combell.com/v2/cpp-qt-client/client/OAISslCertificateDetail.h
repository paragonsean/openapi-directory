...
/*
 * OAISslCertificateDetail.h
 *
 * 
 */

#ifndef OAISslCertificateDetail_H
#define OAISslCertificateDetail_H
...
class OAISslCertificateDetail : public OAIObject {
public:
    OAISslCertificateDetail();
    OAISslCertificateDetail(QString json);
    ~OAISslCertificateDetail() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISslCertificateDetail)

#endif // OAISslCertificateDetail_H
