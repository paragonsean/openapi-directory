...
OAILinuxSite::OAILinuxSite(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAILinuxSite::OAILinuxSite() {
    this->initializeModel();
}

OAILinuxSite::~OAILinuxSite() {}

void OAILinuxSite::initializeModel() {

    m_host_headers_isSet = false;
    m_host_headers_isValid = false;

    m_http2_enabled_isSet = false;
    m_http2_enabled_isValid = false;

    m_https_redirect_enabled_isSet = false;
    m_https_redirect_enabled_isValid = false;
...
void OAILinuxSite::fromJson(QString jsonString) {
...
void OAILinuxSite::fromJsonObject(QJsonObject json) {

    m_host_headers_isValid = ::OpenAPI::fromJsonValue(m_host_headers, json[QString("host_headers")]);
    m_host_headers_isSet = !json[QString("host_headers")].isNull() && m_host_headers_isValid;

    m_http2_enabled_isValid = ::OpenAPI::fromJsonValue(m_http2_enabled, json[QString("http2_enabled")]);
    m_http2_enabled_isSet = !json[QString("http2_enabled")].isNull() && m_http2_enabled_isValid;

    m_https_redirect_enabled_isValid = ::OpenAPI::fromJsonValue(m_https_redirect_enabled, json[QString("https_redirect_enabled")]);
    m_https_redirect_enabled_isSet = !json[QString("https_redirect_enabled")].isNull() && m_https_redirect_enabled_isValid;
    ...
    m_ssl_enabled_isValid = ::OpenAPI::fromJsonValue(m_ssl_enabled, json[QString("ssl_enabled")]);
    m_ssl_enabled_isSet = !json[QString("ssl_enabled")].isNull() && m_ssl_enabled_isValid;
}

QString OAILinuxSite::asJson() const {
...
QJsonObject OAILinuxSite::asJsonObject() const {
    QJsonObject obj;
    if (m_host_headers.size() > 0) {
        obj.insert(QString("host_headers"), ::OpenAPI::toJsonValue(m_host_headers));
    }
    if (m_http2_enabled_isSet) {
        obj.insert(QString("http2_enabled"), ::OpenAPI::toJsonValue(m_http2_enabled));
    }
    if (m_https_redirect_enabled_isSet) {
        obj.insert(QString("https_redirect_enabled"), ::OpenAPI::toJsonValue(m_https_redirect_enabled));
    }
    if (m_name_isSet) {
    ...
    if (m_ssl_enabled_isSet) {
        obj.insert(QString("ssl_enabled"), ::OpenAPI::toJsonValue(m_ssl_enabled));
    }
    return obj;
}

QList<OAIHostHeader> OAILinuxSite::getHostHeaders() const {
    return m_host_headers;
}
void OAILinuxSite::setHostHeaders(const QList<OAIHostHeader> &host_headers) {
    m_host_headers = host_headers;
    m_host_headers_isSet = true;
}

bool OAILinuxSite::is_host_headers_Set() const{
    return m_host_headers_isSet;
}

bool OAILinuxSite::is_host_headers_Valid() const{
    return m_host_headers_isValid;
}

bool OAILinuxSite::isHttp2Enabled() const {
    return m_http2_enabled;
}
void OAILinuxSite::setHttp2Enabled(const bool &http2_enabled) {
    m_http2_enabled = http2_enabled;
    m_http2_enabled_isSet = true;
}

bool OAILinuxSite::is_http2_enabled_Set() const{
    return m_http2_enabled_isSet;
}

bool OAILinuxSite::is_http2_enabled_Valid() const{
    return m_http2_enabled_isValid;
}

bool OAILinuxSite::isHttpsRedirectEnabled() const {
    return m_https_redirect_enabled;
}
void OAILinuxSite::setHttpsRedirectEnabled(const bool &https_redirect_enabled) {
    m_https_redirect_enabled = https_redirect_enabled;
    m_https_redirect_enabled_isSet = true;
}

bool OAILinuxSite::is_https_redirect_enabled_Set() const{
    return m_https_redirect_enabled_isSet;
}

bool OAILinuxSite::is_https_redirect_enabled_Valid() const{
    return m_https_redirect_enabled_isValid;
}

QString OAILinuxSite::getName() const {
    return m_name;
}
void OAILinuxSite::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAILinuxSite::is_name_Set() const{
    return m_name_isSet;
}

bool OAILinuxSite::is_name_Valid() const{
    return m_name_isValid;
}

QString OAILinuxSite::getPath() const {
    return m_path;
}
void OAILinuxSite::setPath(const QString &path) {
    m_path = path;
    m_path_isSet = true;
}

bool OAILinuxSite::is_path_Set() const{
    return m_path_isSet;
}

bool OAILinuxSite::is_path_Valid() const{
    return m_path_isValid;
}

bool OAILinuxSite::isSslEnabled() const {
    return m_ssl_enabled;
}
void OAILinuxSite::setSslEnabled(const bool &ssl_enabled) {
    m_ssl_enabled = ssl_enabled;
    m_ssl_enabled_isSet = true;
}

bool OAILinuxSite::is_ssl_enabled_Set() const{
    return m_ssl_enabled_isSet;
}

bool OAILinuxSite::is_ssl_enabled_Valid() const{
    return m_ssl_enabled_isValid;
}

bool OAILinuxSite::isSet() const {
...
bool OAILinuxSite::isValid() const {
