...
OAISmtpDomain::OAISmtpDomain(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISmtpDomain::OAISmtpDomain() {
    this->initializeModel();
}

OAISmtpDomain::~OAISmtpDomain() {}

void OAISmtpDomain::initializeModel() {
...
void OAISmtpDomain::fromJson(QString jsonString) {
...
void OAISmtpDomain::fromJsonObject(QJsonObject json) {
...
QString OAISmtpDomain::asJson() const {
...
QJsonObject OAISmtpDomain::asJsonObject() const {
    QJsonObject obj;
    if (m_enabled_isSet) {
...
bool OAISmtpDomain::isEnabled() const {
    return m_enabled;
}
void OAISmtpDomain::setEnabled(const bool &enabled) {
    m_enabled = enabled;
    m_enabled_isSet = true;
}

bool OAISmtpDomain::is_enabled_Set() const{
    return m_enabled_isSet;
}

bool OAISmtpDomain::is_enabled_Valid() const{
    return m_enabled_isValid;
}

QString OAISmtpDomain::getHostname() const {
    return m_hostname;
}
void OAISmtpDomain::setHostname(const QString &hostname) {
    m_hostname = hostname;
    m_hostname_isSet = true;
}

bool OAISmtpDomain::is_hostname_Set() const{
    return m_hostname_isSet;
}

bool OAISmtpDomain::is_hostname_Valid() const{
    return m_hostname_isValid;
}

bool OAISmtpDomain::isSet() const {
...
bool OAISmtpDomain::isValid() const {
