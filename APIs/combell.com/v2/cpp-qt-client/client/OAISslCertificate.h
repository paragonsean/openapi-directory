...
#ifndef OAISslCertificate_H
#define OAISslCertificate_H
...
class OAISslCertificate : public OAIObject {
public:
    OAISslCertificate();
    OAISslCertificate(QString json);
    ~OAISslCertificate() override;
    ...
    OAISslCertificateType getType() const;
    void setType(const OAISslCertificateType &type);
...
Q_DECLARE_METATYPE(OpenAPI::OAISslCertificate)

#endif // OAISslCertificate_H
