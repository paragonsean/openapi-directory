...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PublicApi.ProvisioningJobCompletion();
  });
  ...
  describe('ProvisioningJobCompletion', function() {
    it('should create an instance of ProvisioningJobCompletion', function() {
      // uncomment below and update the code to test ProvisioningJobCompletion
      //var instance = new PublicApi.ProvisioningJobCompletion();
      //expect(instance).to.be.a(PublicApi.ProvisioningJobCompletion);
    });
