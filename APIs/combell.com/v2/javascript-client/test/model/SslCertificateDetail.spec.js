...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PublicApi.SslCertificateDetail();
  });
  ...
  describe('SslCertificateDetail', function() {
    it('should create an instance of SslCertificateDetail', function() {
      // uncomment below and update the code to test SslCertificateDetail
      //var instance = new PublicApi.SslCertificateDetail();
      //expect(instance).to.be.a(PublicApi.SslCertificateDetail);
    });
