...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PublicApi.SslCertificate();
  });
  ...
  describe('SslCertificate', function() {
    it('should create an instance of SslCertificate', function() {
      // uncomment below and update the code to test SslCertificate
      //var instance = new PublicApi.SslCertificate();
      //expect(instance).to.be.a(PublicApi.SslCertificate);
    });
    ...
    it('should have the property sha1Fingerprint (base name: "sha1_fingerprint")', function() {
