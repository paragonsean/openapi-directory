...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PublicApi.WindowsHostingDetail();
  });
  ...
  describe('WindowsHostingDetail', function() {
    it('should create an instance of WindowsHostingDetail', function() {
      // uncomment below and update the code to test WindowsHostingDetail
      //var instance = new PublicApi.WindowsHostingDetail();
      //expect(instance).to.be.a(PublicApi.WindowsHostingDetail);
    });
    ...
    it('should have the property applicationPool (base name: "application_pool")', function() {
      // uncomment below and update the code to test the property applicationPool
      //var instance = new PublicApi.WindowsHostingDetail();
      //expect(instance).to.be();
    });
    ...
    it('should have the property mssqlDatabaseNames (base name: "mssql_database_names")', function() {
      // uncomment below and update the code to test the property mssqlDatabaseNames
      //var instance = new PublicApi.WindowsHostingDetail();
      //expect(instance).to.be();
    });
