...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PublicApi.AddSubsiteRequest();
  });
  ...
  describe('AddSubsiteRequest', function() {
    it('should create an instance of AddSubsiteRequest', function() {
      // uncomment below and update the code to test AddSubsiteRequest
      //var instance = new PublicApi.AddSubsiteRequest();
      //expect(instance).to.be.a(PublicApi.AddSubsiteRequest);
    });
