...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    factory(root.expect, root.PublicApi);
  }
}(this, function(expect, PublicApi) {
  'use strict';

  var instance;

  beforeEach(function() {
    instance = new PublicApi.SslCertificateRequestValidation();
  });
  ...
  describe('SslCertificateRequestValidation', function() {
    it('should create an instance of SslCertificateRequestValidation', function() {
      // uncomment below and update the code to test SslCertificateRequestValidation
      //var instance = new PublicApi.SslCertificateRequestValidation();
      //expect(instance).to.be.a(PublicApi.SslCertificateRequestValidation);
    });

    it('should have the property autoValidated (base name: "auto_validated")', function() {
      // uncomment below and update the code to test the property autoValidated
      //var instance = new PublicApi.SslCertificateRequestValidation();
      //expect(instance).to.be();
    });

    it('should have the property cnameValidationContent (base name: "cname_validation_content")', function() {
      // uncomment below and update the code to test the property cnameValidationContent
      //var instance = new PublicApi.SslCertificateRequestValidation();
      //expect(instance).to.be();
    });

    it('should have the property cnameValidationName (base name: "cname_validation_name")', function() {
      // uncomment below and update the code to test the property cnameValidationName
      //var instance = new PublicApi.SslCertificateRequestValidation();
      //expect(instance).to.be();
    });

    it('should have the property dnsName (base name: "dns_name")', function() {
    ...
    it('should have the property fileValidationContent (base name: "file_validation_content")', function() {
      // uncomment below and update the code to test the property fileValidationContent
      //var instance = new PublicApi.SslCertificateRequestValidation();
      //expect(instance).to.be();
    });

    it('should have the property fileValidationUrlHttp (base name: "file_validation_url_http")', function() {
      // uncomment below and update the code to test the property fileValidationUrlHttp
      //var instance = new PublicApi.SslCertificateRequestValidation();
      //expect(instance).to.be();
    });

    it('should have the property fileValidationUrlHttps (base name: "file_validation_url_https")', function() {
      // uncomment below and update the code to test the property fileValidationUrlHttps
      //var instance = new PublicApi.SslCertificateRequestValidation();
      //expect(instance).to.be();
    });
