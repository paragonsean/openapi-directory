...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PublicApi.ApplicationPool();
  });
  ...
  describe('ApplicationPool', function() {
    it('should create an instance of ApplicationPool', function() {
      // uncomment below and update the code to test ApplicationPool
      //var instance = new PublicApi.ApplicationPool();
      //expect(instance).to.be.a(PublicApi.ApplicationPool);
    });

    it('should have the property installedNetCoreRuntimes (base name: "installed_net_core_runtimes")', function() {
      // uncomment below and update the code to test the property installedNetCoreRuntimes
      //var instance = new PublicApi.ApplicationPool();
      //expect(instance).to.be();
    });

    it('should have the property pipelineMode (base name: "pipeline_mode")', function() {
      // uncomment below and update the code to test the property pipelineMode
      //var instance = new PublicApi.ApplicationPool();
      //expect(instance).to.be();
    });
