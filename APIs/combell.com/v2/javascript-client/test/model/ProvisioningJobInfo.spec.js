...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PublicApi.ProvisioningJobInfo();
  });
  ...
  describe('ProvisioningJobInfo', function() {
    it('should create an instance of ProvisioningJobInfo', function() {
      // uncomment below and update the code to test ProvisioningJobInfo
      //var instance = new PublicApi.ProvisioningJobInfo();
      //expect(instance).to.be.a(PublicApi.ProvisioningJobInfo);
    });
