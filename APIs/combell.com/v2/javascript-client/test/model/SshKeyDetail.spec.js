...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PublicApi.SshKeyDetail();
  });
  ...
  describe('SshKeyDetail', function() {
    it('should create an instance of SshKeyDetail', function() {
      // uncomment below and update the code to test SshKeyDetail
      //var instance = new PublicApi.SshKeyDetail();
      //expect(instance).to.be.a(PublicApi.SshKeyDetail);
    });
    ...
    it('should have the property linuxHostings (base name: "linux_hostings")', function() {
      // uncomment below and update the code to test the property linuxHostings
      //var instance = new PublicApi.SshKeyDetail();
      //expect(instance).to.be();
    });
