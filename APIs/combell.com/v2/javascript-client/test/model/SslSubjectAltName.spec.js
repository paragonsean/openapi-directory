...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PublicApi.SslSubjectAltName();
  });
  ...
  describe('SslSubjectAltName', function() {
    it('should create an instance of SslSubjectAltName', function() {
      // uncomment below and update the code to test SslSubjectAltName
      //var instance = new PublicApi.SslSubjectAltName();
      //expect(instance).to.be.a(PublicApi.SslSubjectAltName);
    });
