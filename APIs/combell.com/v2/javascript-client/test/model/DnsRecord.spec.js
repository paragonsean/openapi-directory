...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PublicApi.DnsRecord();
  });
  ...
  describe('DnsRecord', function() {
    it('should create an instance of DnsRecord', function() {
      ...
      //var instance = new PublicApi.DnsRecord();
      //expect(instance).to.be.a(PublicApi.DnsRecord);
    });
    ...
    it('should have the property recordName (base name: "record_name")', function() {
