...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PublicApi.LinuxHosting();
  });
  ...
  describe('LinuxHosting', function() {
    it('should create an instance of LinuxHosting', function() {
      // uncomment below and update the code to test LinuxHosting
      //var instance = new PublicApi.LinuxHosting();
      //expect(instance).to.be.a(PublicApi.LinuxHosting);
    });
