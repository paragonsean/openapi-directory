...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PublicApi.AutoReply();
  });
  ...
  describe('AutoReply', function() {
    it('should create an instance of AutoReply', function() {
      // uncomment below and update the code to test AutoReply
      //var instance = new PublicApi.AutoReply();
      //expect(instance).to.be.a(PublicApi.AutoReply);
    });
