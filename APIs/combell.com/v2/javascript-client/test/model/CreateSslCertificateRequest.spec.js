...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PublicApi.CreateSslCertificateRequest();
  });
  ...
  describe('CreateSslCertificateRequest', function() {
    it('should create an instance of CreateSslCertificateRequest', function() {
      // uncomment below and update the code to test CreateSslCertificateRequest
      //var instance = new PublicApi.CreateSslCertificateRequest();
      //expect(instance).to.be.a(PublicApi.CreateSslCertificateRequest);
    });

    it('should have the property additionalValidationAttributes (base name: "additional_validation_attributes")', function() {
      // uncomment below and update the code to test the property additionalValidationAttributes
      //var instance = new PublicApi.CreateSslCertificateRequest();
