...
(function(root, factory) {
  ...
  describe('Domain', function() {
    it('should create an instance of Domain', function() {
      ...
      //var instance = new PublicApi.Domain();
      //expect(instance).to.be.a(PublicApi.Domain);
    });
    ...
    it('should have the property willRenew (base name: "will_renew")', function() {
      // uncomment below and update the code to test the property willRenew
      //var instance = new PublicApi.Domain();
      //expect(instance).to.be();
    });
