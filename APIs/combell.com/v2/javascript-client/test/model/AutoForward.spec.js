...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PublicApi.AutoForward();
  });
  ...
  describe('AutoForward', function() {
    it('should create an instance of AutoForward', function() {
      // uncomment below and update the code to test AutoForward
      //var instance = new PublicApi.AutoForward();
      //expect(instance).to.be.a(PublicApi.AutoForward);
    });

    it('should have the property copyToMyself (base name: "copy_to_myself")', function() {
      // uncomment below and update the code to test the property copyToMyself
      //var instance = new PublicApi.AutoForward();
