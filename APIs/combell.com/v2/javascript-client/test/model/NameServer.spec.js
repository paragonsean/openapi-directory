...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PublicApi.NameServer();
  });
  ...
  describe('NameServer', function() {
    it('should create an instance of NameServer', function() {
      // uncomment below and update the code to test NameServer
      //var instance = new PublicApi.NameServer();
      //expect(instance).to.be.a(PublicApi.NameServer);
    });
