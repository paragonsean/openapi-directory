...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PublicApi.SmtpDomain();
  });
  ...
  describe('SmtpDomain', function() {
    it('should create an instance of SmtpDomain', function() {
      // uncomment below and update the code to test SmtpDomain
      //var instance = new PublicApi.SmtpDomain();
      //expect(instance).to.be.a(PublicApi.SmtpDomain);
    });
