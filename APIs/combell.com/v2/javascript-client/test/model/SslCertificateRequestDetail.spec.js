...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PublicApi.SslCertificateRequestDetail();
  });
  ...
  describe('SslCertificateRequestDetail', function() {
    it('should create an instance of SslCertificateRequestDetail', function() {
      // uncomment below and update the code to test SslCertificateRequestDetail
      //var instance = new PublicApi.SslCertificateRequestDetail();
      //expect(instance).to.be.a(PublicApi.SslCertificateRequestDetail);
    });
    ...
    it('should have the property orderCode (base name: "order_code")', function() {
      // uncomment below and update the code to test the property orderCode
      //var instance = new PublicApi.SslCertificateRequestDetail();
      //expect(instance).to.be();
    });

    it('should have the property subjectAltNames (base name: "subject_alt_names")', function() {
      // uncomment below and update the code to test the property subjectAltNames
      //var instance = new PublicApi.SslCertificateRequestDetail();
      //expect(instance).to.be();
    });
