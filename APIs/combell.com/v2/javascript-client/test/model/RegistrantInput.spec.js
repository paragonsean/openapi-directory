...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PublicApi.RegistrantInput();
  });
  ...
  describe('RegistrantInput', function() {
    it('should create an instance of RegistrantInput', function() {
      // uncomment below and update the code to test RegistrantInput
      //var instance = new PublicApi.RegistrantInput();
      //expect(instance).to.be.a(PublicApi.RegistrantInput);
    });
    ...
    it('should have the property enterpriseNumber (base name: "enterprise_number")', function() {
      // uncomment below and update the code to test the property enterpriseNumber
      //var instance = new PublicApi.RegistrantInput();
      //expect(instance).to.be();
    });

    it('should have the property extraFields (base name: "extra_fields")', function() {
