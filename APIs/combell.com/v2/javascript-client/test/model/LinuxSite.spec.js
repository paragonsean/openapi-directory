...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PublicApi.LinuxSite();
  });
  ...
  describe('LinuxSite', function() {
    it('should create an instance of LinuxSite', function() {
      // uncomment below and update the code to test LinuxSite
      //var instance = new PublicApi.LinuxSite();
      //expect(instance).to.be.a(PublicApi.LinuxSite);
    });

    it('should have the property hostHeaders (base name: "host_headers")', function() {
      // uncomment below and update the code to test the property hostHeaders
      //var instance = new PublicApi.LinuxSite();
      //expect(instance).to.be();
    });

    it('should have the property http2Enabled (base name: "http2_enabled")', function() {
      // uncomment below and update the code to test the property http2Enabled
      //var instance = new PublicApi.LinuxSite();
      //expect(instance).to.be();
    });

    it('should have the property httpsRedirectEnabled (base name: "https_redirect_enabled")', function() {
      // uncomment below and update the code to test the property httpsRedirectEnabled
      //var instance = new PublicApi.LinuxSite();
      //expect(instance).to.be();
    });
    ...
    it('should have the property sslEnabled (base name: "ssl_enabled")', function() {
