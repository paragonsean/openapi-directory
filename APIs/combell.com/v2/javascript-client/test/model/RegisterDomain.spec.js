...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PublicApi.RegisterDomain();
  });
  ...
  describe('RegisterDomain', function() {
    it('should create an instance of RegisterDomain', function() {
      // uncomment below and update the code to test RegisterDomain
      //var instance = new PublicApi.RegisterDomain();
      //expect(instance).to.be.a(PublicApi.RegisterDomain);
    });
