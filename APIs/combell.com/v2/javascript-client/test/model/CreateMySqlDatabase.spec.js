...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PublicApi.CreateMySqlDatabase();
  });
  ...
  describe('CreateMySqlDatabase', function() {
    it('should create an instance of CreateMySqlDatabase', function() {
      // uncomment below and update the code to test CreateMySqlDatabase
      //var instance = new PublicApi.CreateMySqlDatabase();
      //expect(instance).to.be.a(PublicApi.CreateMySqlDatabase);
    });
