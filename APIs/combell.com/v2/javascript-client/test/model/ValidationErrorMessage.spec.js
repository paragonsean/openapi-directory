...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PublicApi.ValidationErrorMessage();
  });
  ...
  describe('ValidationErrorMessage', function() {
    it('should create an instance of ValidationErrorMessage', function() {
      // uncomment below and update the code to test ValidationErrorMessage
      //var instance = new PublicApi.ValidationErrorMessage();
      //expect(instance).to.be.a(PublicApi.ValidationErrorMessage);
    });
