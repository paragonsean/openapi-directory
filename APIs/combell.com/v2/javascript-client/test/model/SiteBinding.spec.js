...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PublicApi.SiteBinding();
  });
  ...
  describe('SiteBinding', function() {
    it('should create an instance of SiteBinding', function() {
      // uncomment below and update the code to test SiteBinding
      //var instance = new PublicApi.SiteBinding();
      //expect(instance).to.be.a(PublicApi.SiteBinding);
    });

    it('should have the property certThumbprint (base name: "cert_thumbprint")', function() {
