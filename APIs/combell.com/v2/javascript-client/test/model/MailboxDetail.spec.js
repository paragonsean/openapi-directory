...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PublicApi.MailboxDetail();
  });
  ...
  describe('MailboxDetail', function() {
    it('should create an instance of MailboxDetail', function() {
      // uncomment below and update the code to test MailboxDetail
      //var instance = new PublicApi.MailboxDetail();
      //expect(instance).to.be.a(PublicApi.MailboxDetail);
    });

    it('should have the property actualSize (base name: "actual_size")', function() {
      // uncomment below and update the code to test the property actualSize
      //var instance = new PublicApi.MailboxDetail();
      //expect(instance).to.be();
    });

    it('should have the property autoForward (base name: "auto_forward")', function() {
      // uncomment below and update the code to test the property autoForward
      //var instance = new PublicApi.MailboxDetail();
      //expect(instance).to.be();
    });
