...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PublicApi.CreateMySqlUser();
  });
  ...
  describe('CreateMySqlUser', function() {
    it('should create an instance of CreateMySqlUser', function() {
      // uncomment below and update the code to test CreateMySqlUser
      //var instance = new PublicApi.CreateMySqlUser();
      //expect(instance).to.be.a(PublicApi.CreateMySqlUser);
    });
