...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PublicApi.AntiSpam();
  });
  ...
  describe('AntiSpam', function() {
    it('should create an instance of AntiSpam', function() {
      // uncomment below and update the code to test AntiSpam
      //var instance = new PublicApi.AntiSpam();
      //expect(instance).to.be.a(PublicApi.AntiSpam);
    });

    it('should have the property allowedTypes (base name: "allowed_types")', function() {
      // uncomment below and update the code to test the property allowedTypes
      //var instance = new PublicApi.AntiSpam();
