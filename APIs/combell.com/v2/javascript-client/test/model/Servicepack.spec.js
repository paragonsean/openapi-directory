...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PublicApi.Servicepack();
  });
  ...
  describe('Servicepack', function() {
    it('should create an instance of Servicepack', function() {
      // uncomment below and update the code to test Servicepack
      //var instance = new PublicApi.Servicepack();
      //expect(instance).to.be.a(PublicApi.Servicepack);
    });
