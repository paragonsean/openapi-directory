...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PublicApi.MySqlUser();
  });
  ...
  describe('MySqlUser', function() {
    it('should create an instance of MySqlUser', function() {
      // uncomment below and update the code to test MySqlUser
      //var instance = new PublicApi.MySqlUser();
      //expect(instance).to.be.a(PublicApi.MySqlUser);
    });
