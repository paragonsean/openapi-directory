...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PublicApi.HostHeader();
  });
  ...
  describe('HostHeader', function() {
    it('should create an instance of HostHeader', function() {
      // uncomment below and update the code to test HostHeader
      //var instance = new PublicApi.HostHeader();
      //expect(instance).to.be.a(PublicApi.HostHeader);
    });
