...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PublicApi.MailZoneAccount();
  });
  ...
  describe('MailZoneAccount', function() {
    it('should create an instance of MailZoneAccount', function() {
      // uncomment below and update the code to test MailZoneAccount
      //var instance = new PublicApi.MailZoneAccount();
      //expect(instance).to.be.a(PublicApi.MailZoneAccount);
    });
