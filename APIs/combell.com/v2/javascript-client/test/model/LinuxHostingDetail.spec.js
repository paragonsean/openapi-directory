...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PublicApi.LinuxHostingDetail();
  });
  ...
  describe('LinuxHostingDetail', function() {
    it('should create an instance of LinuxHostingDetail', function() {
      // uncomment below and update the code to test LinuxHostingDetail
      //var instance = new PublicApi.LinuxHostingDetail();
      //expect(instance).to.be.a(PublicApi.LinuxHostingDetail);
    });
    ...
    it('should have the property maxWebspaceSize (base name: "max_webspace_size")', function() {
      // uncomment below and update the code to test the property maxWebspaceSize
      //var instance = new PublicApi.LinuxHostingDetail();
      //expect(instance).to.be();
    });

    it('should have the property mysqlDatabaseNames (base name: "mysql_database_names")', function() {
      // uncomment below and update the code to test the property mysqlDatabaseNames
      //var instance = new PublicApi.LinuxHostingDetail();
      //expect(instance).to.be();
    });

    it('should have the property phpVersion (base name: "php_version")', function() {
    ...
    it('should have the property sshHost (base name: "ssh_host")', function() {
      // uncomment below and update the code to test the property sshHost
      //var instance = new PublicApi.LinuxHostingDetail();
      //expect(instance).to.be();
    });

    it('should have the property sshUsername (base name: "ssh_username")', function() {
      // uncomment below and update the code to test the property sshUsername
      //var instance = new PublicApi.LinuxHostingDetail();
      //expect(instance).to.be();
    });

    it('should have the property webspaceUsage (base name: "webspace_usage")', function() {
      // uncomment below and update the code to test the property webspaceUsage
      //var instance = new PublicApi.LinuxHostingDetail();
      //expect(instance).to.be();
    });
