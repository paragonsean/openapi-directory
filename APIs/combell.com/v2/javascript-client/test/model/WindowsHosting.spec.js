...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PublicApi.WindowsHosting();
  });
  ...
  describe('WindowsHosting', function() {
    it('should create an instance of WindowsHosting', function() {
      // uncomment below and update the code to test WindowsHosting
      //var instance = new PublicApi.WindowsHosting();
      //expect(instance).to.be.a(PublicApi.WindowsHosting);
    });
    ...
    it('should have the property servicepackId (base name: "servicepack_id")', function() {
      // uncomment below and update the code to test the property servicepackId
      //var instance = new PublicApi.WindowsHosting();
      //expect(instance).to.be();
    });
