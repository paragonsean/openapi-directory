...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PublicApi.SslCertificateRequest();
  });
  ...
  describe('SslCertificateRequest', function() {
    it('should create an instance of SslCertificateRequest', function() {
      // uncomment below and update the code to test SslCertificateRequest
      //var instance = new PublicApi.SslCertificateRequest();
      //expect(instance).to.be.a(PublicApi.SslCertificateRequest);
    });
