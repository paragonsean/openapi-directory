...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PublicApi.UpdatePhpAPcuRequest();
  });
  ...
  describe('UpdatePhpAPcuRequest', function() {
    it('should create an instance of UpdatePhpAPcuRequest', function() {
      // uncomment below and update the code to test UpdatePhpAPcuRequest
      //var instance = new PublicApi.UpdatePhpAPcuRequest();
      //expect(instance).to.be.a(PublicApi.UpdatePhpAPcuRequest);
    });

    it('should have the property apcuSize (base name: "apcu_size")', function() {
      // uncomment below and update the code to test the property apcuSize
      //var instance = new PublicApi.UpdatePhpAPcuRequest();
