...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PublicApi.AdditionalValidationAttribute();
  });
  ...
  describe('AdditionalValidationAttribute', function() {
    it('should create an instance of AdditionalValidationAttribute', function() {
      // uncomment below and update the code to test AdditionalValidationAttribute
      //var instance = new PublicApi.AdditionalValidationAttribute();
      //expect(instance).to.be.a(PublicApi.AdditionalValidationAttribute);
    });
