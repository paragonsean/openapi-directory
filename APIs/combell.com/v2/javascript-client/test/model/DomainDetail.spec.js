...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PublicApi.DomainDetail();
  });
  ...
  describe('DomainDetail', function() {
    it('should create an instance of DomainDetail', function() {
      ...
      //var instance = new PublicApi.DomainDetail();
      //expect(instance).to.be.a(PublicApi.DomainDetail);
    });

    it('should have the property canToggleRenew (base name: "can_toggle_renew")', function() {
      // uncomment below and update the code to test the property canToggleRenew
      //var instance = new PublicApi.DomainDetail();
