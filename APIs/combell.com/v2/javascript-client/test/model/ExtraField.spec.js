...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PublicApi.ExtraField();
  });
  ...
  describe('ExtraField', function() {
    it('should create an instance of ExtraField', function() {
      // uncomment below and update the code to test ExtraField
      //var instance = new PublicApi.ExtraField();
      //expect(instance).to.be.a(PublicApi.ExtraField);
    });
