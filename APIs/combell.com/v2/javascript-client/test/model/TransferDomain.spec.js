...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PublicApi.TransferDomain();
  });
  ...
  describe('TransferDomain', function() {
    it('should create an instance of TransferDomain', function() {
      // uncomment below and update the code to test TransferDomain
      //var instance = new PublicApi.TransferDomain();
      //expect(instance).to.be.a(PublicApi.TransferDomain);
    });
