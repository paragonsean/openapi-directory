...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PublicApi.WindowsSite();
  });
  ...
  describe('WindowsSite', function() {
    it('should create an instance of WindowsSite', function() {
      // uncomment below and update the code to test WindowsSite
      //var instance = new PublicApi.WindowsSite();
      //expect(instance).to.be.a(PublicApi.WindowsSite);
    });
