...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PublicApi.MailZone();
  });
  ...
  describe('MailZone', function() {
    it('should create an instance of MailZone', function() {
      // uncomment below and update the code to test MailZone
      //var instance = new PublicApi.MailZone();
      //expect(instance).to.be.a(PublicApi.MailZone);
    });
    ...
    it('should have the property antiSpam (base name: "anti_spam")', function() {
      // uncomment below and update the code to test the property antiSpam
      //var instance = new PublicApi.MailZone();
      //expect(instance).to.be();
    });
    ...
    it('should have the property smtpDomains (base name: "smtp_domains")', function() {
      // uncomment below and update the code to test the property smtpDomains
      //var instance = new PublicApi.MailZone();
      //expect(instance).to.be();
    });
