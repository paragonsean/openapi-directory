...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PublicApi.EditNameServers();
  });
  ...
  describe('EditNameServers', function() {
    it('should create an instance of EditNameServers', function() {
      // uncomment below and update the code to test EditNameServers
      //var instance = new PublicApi.EditNameServers();
      //expect(instance).to.be.a(PublicApi.EditNameServers);
    });
