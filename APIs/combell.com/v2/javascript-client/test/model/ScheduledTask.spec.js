...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PublicApi.ScheduledTask();
  });
  ...
  describe('ScheduledTask', function() {
    it('should create an instance of ScheduledTask', function() {
      // uncomment below and update the code to test ScheduledTask
      //var instance = new PublicApi.ScheduledTask();
      //expect(instance).to.be.a(PublicApi.ScheduledTask);
    });
    ...
    it('should have the property scriptLocation (base name: "script_location")', function() {
      // uncomment below and update the code to test the property scriptLocation
      //var instance = new PublicApi.ScheduledTask();
      //expect(instance).to.be();
    });
