...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PublicApi.MySqlDatabasesApi();
  });
  ...
  describe('MySqlDatabasesApi', function() {
    describe('changeDatabaseUserPassword', function() {
      it('should call changeDatabaseUserPassword successfully', function(done) {
        //uncomment below and update the code to test changeDatabaseUserPassword
        //instance.changeDatabaseUserPassword(function(error) {
    ...
    describe('changeDatabaseUserStatus', function() {
      it('should call changeDatabaseUserStatus successfully', function(done) {
        //uncomment below and update the code to test changeDatabaseUserStatus
        //instance.changeDatabaseUserStatus(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('createMySqlDatabase', function() {
      it('should call createMySqlDatabase successfully', function(done) {
        //uncomment below and update the code to test createMySqlDatabase
        //instance.createMySqlDatabase(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('createMySqlUser', function() {
      it('should call createMySqlUser successfully', function(done) {
        //uncomment below and update the code to test createMySqlUser
        //instance.createMySqlUser(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('getMySqlDatabase', function() {
      it('should call getMySqlDatabase successfully', function(done) {
        //uncomment below and update the code to test getMySqlDatabase
        //instance.getMySqlDatabase(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('getMySqlDatabases', function() {
      it('should call getMySqlDatabases successfully', function(done) {
        //uncomment below and update the code to test getMySqlDatabases
        //instance.getMySqlDatabases(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
