...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PublicApi.DomainsApi();
  });
  ...
  describe('DomainsApi', function() {
    describe('configureDomain', function() {
      it('should call configureDomain successfully', function(done) {
        //uncomment below and update the code to test configureDomain
        //instance.configureDomain(function(error) {
    ...
    describe('editNameServers', function() {
      it('should call editNameServers successfully', function(done) {
        //uncomment below and update the code to test editNameServers
        //instance.editNameServers(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
