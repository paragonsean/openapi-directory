...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PublicApi.MailboxesApi();
  });
  ...
  describe('MailboxesApi', function() {
    describe('changeMailboxPassword', function() {
      it('should call changeMailboxPassword successfully', function(done) {
        //uncomment below and update the code to test changeMailboxPassword
        //instance.changeMailboxPassword(function(error) {
    ...
    describe('configureMailboxAutoForward', function() {
      it('should call configureMailboxAutoForward successfully', function(done) {
        //uncomment below and update the code to test configureMailboxAutoForward
        //instance.configureMailboxAutoForward(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('configureMailboxAutoReply', function() {
      it('should call configureMailboxAutoReply successfully', function(done) {
        //uncomment below and update the code to test configureMailboxAutoReply
        //instance.configureMailboxAutoReply(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
