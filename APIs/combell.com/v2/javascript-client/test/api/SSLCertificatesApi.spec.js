...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PublicApi.SSLCertificatesApi();
  });
  ...
  describe('SSLCertificatesApi', function() {
    describe('downloadCertificate', function() {
      it('should call downloadCertificate successfully', function(done) {
        //uncomment below and update the code to test downloadCertificate
        //instance.downloadCertificate(function(error) {
    ...
    describe('getSslCertificate', function() {
      it('should call getSslCertificate successfully', function(done) {
        //uncomment below and update the code to test getSslCertificate
        //instance.getSslCertificate(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('getSslCertificates', function() {
      it('should call getSslCertificates successfully', function(done) {
        //uncomment below and update the code to test getSslCertificates
        //instance.getSslCertificates(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
