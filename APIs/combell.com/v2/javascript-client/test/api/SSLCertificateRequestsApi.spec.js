...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PublicApi.SSLCertificateRequestsApi();
  });
  ...
  describe('SSLCertificateRequestsApi', function() {
    describe('addSslCertificateRequest', function() {
      it('should call addSslCertificateRequest successfully', function(done) {
        //uncomment below and update the code to test addSslCertificateRequest
        //instance.addSslCertificateRequest(function(error) {
    ...
    describe('getSslCertificateRequest', function() {
      it('should call getSslCertificateRequest successfully', function(done) {
        //uncomment below and update the code to test getSslCertificateRequest
        //instance.getSslCertificateRequest(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('getSslCertificateRequests', function() {
      it('should call getSslCertificateRequests successfully', function(done) {
        //uncomment below and update the code to test getSslCertificateRequests
        //instance.getSslCertificateRequests(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('verifySslCertificateRequestDomainValidations', function() {
      it('should call verifySslCertificateRequestDomainValidations successfully', function(done) {
        //uncomment below and update the code to test verifySslCertificateRequestDomainValidations
        //instance.verifySslCertificateRequestDomainValidations(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
