...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PublicApi.MailZonesApi();
  });
  ...
  describe('MailZonesApi', function() {
    describe('configureAlias', function() {
      it('should call configureAlias successfully', function(done) {
        //uncomment below and update the code to test configureAlias
        //instance.configureAlias(function(error) {
    ...
    describe('configureAntiSpam', function() {
      it('should call configureAntiSpam successfully', function(done) {
        //uncomment below and update the code to test configureAntiSpam
        //instance.configureAntiSpam(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('configureSmtpDomain', function() {
      it('should call configureSmtpDomain successfully', function(done) {
        //uncomment below and update the code to test configureSmtpDomain
        //instance.configureSmtpDomain(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('createCatchAll', function() {
      it('should call createCatchAll successfully', function(done) {
        //uncomment below and update the code to test createCatchAll
        //instance.createCatchAll(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('createSmtpDomain', function() {
      it('should call createSmtpDomain successfully', function(done) {
        //uncomment below and update the code to test createSmtpDomain
        //instance.createSmtpDomain(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('deleteCatchAll', function() {
      it('should call deleteCatchAll successfully', function(done) {
        //uncomment below and update the code to test deleteCatchAll
        //instance.deleteCatchAll(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('deleteSmtpDomain', function() {
      it('should call deleteSmtpDomain successfully', function(done) {
        //uncomment below and update the code to test deleteSmtpDomain
        //instance.deleteSmtpDomain(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('getMailZone', function() {
      it('should call getMailZone successfully', function(done) {
        //uncomment below and update the code to test getMailZone
        //instance.getMailZone(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
