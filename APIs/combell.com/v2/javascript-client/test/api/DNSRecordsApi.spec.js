...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PublicApi.DNSRecordsApi();
  });
  ...
  describe('DNSRecordsApi', function() {
    describe('dnsDomainNameRecordsGet', function() {
      it('should call dnsDomainNameRecordsGet successfully', function(done) {
        //uncomment below and update the code to test dnsDomainNameRecordsGet
        //instance.dnsDomainNameRecordsGet(function(error) {
    ...
    describe('dnsDomainNameRecordsPost', function() {
      it('should call dnsDomainNameRecordsPost successfully', function(done) {
        //uncomment below and update the code to test dnsDomainNameRecordsPost
        //instance.dnsDomainNameRecordsPost(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('dnsDomainNameRecordsRecordIdDelete', function() {
      it('should call dnsDomainNameRecordsRecordIdDelete successfully', function(done) {
        //uncomment below and update the code to test dnsDomainNameRecordsRecordIdDelete
        //instance.dnsDomainNameRecordsRecordIdDelete(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('dnsDomainNameRecordsRecordIdGet', function() {
      it('should call dnsDomainNameRecordsRecordIdGet successfully', function(done) {
        //uncomment below and update the code to test dnsDomainNameRecordsRecordIdGet
        //instance.dnsDomainNameRecordsRecordIdGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('dnsDomainNameRecordsRecordIdPut', function() {
      it('should call dnsDomainNameRecordsRecordIdPut successfully', function(done) {
        //uncomment below and update the code to test dnsDomainNameRecordsRecordIdPut
        //instance.dnsDomainNameRecordsRecordIdPut(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
