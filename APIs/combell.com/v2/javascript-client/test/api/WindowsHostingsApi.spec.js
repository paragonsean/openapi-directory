...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PublicApi.WindowsHostingsApi();
  });
  ...
  describe('WindowsHostingsApi', function() {
    describe('getWindowsHosting', function() {
      it('should call getWindowsHosting successfully', function(done) {
        //uncomment below and update the code to test getWindowsHosting
        //instance.getWindowsHosting(function(error) {
    ...
    describe('getWindowsHostings', function() {
      it('should call getWindowsHostings successfully', function(done) {
        //uncomment below and update the code to test getWindowsHostings
        //instance.getWindowsHostings(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
