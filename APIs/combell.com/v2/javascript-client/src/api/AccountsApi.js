...
export default class AccountsApi {
    ...
    */
     ...
     * @param {module:model/CreateAccount} [createAccount] 
    ...
    createAccount(opts, callback) {
      opts = opts || {};
      let postBody = opts['createAccount'];
     ...
     * @param {String} error Error message, if any.
     * @param {module:model/AccountDetail} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} accountId2 Automatically added
     ...
     * data is of type: {@link module:model/AccountDetail}
     */
    getAccount(accountId, accountId2, callback) {
      let postBody = null;
      ...
      if (accountId2 === undefined || accountId2 === null) {
        throw new Error("Missing the required parameter 'accountId2' when calling getAccount");
      }
     ...
     * @param {module:model/AssetType} [assetType] Filters the list, returning only accounts containing the specified asset type.
