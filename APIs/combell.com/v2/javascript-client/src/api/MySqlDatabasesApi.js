...
/**
* MySqlDatabases service.
* @module api/MySqlDatabasesApi
* @version v2
*/
export default class MySqlDatabasesApi {

    /**
    * Constructs a new MySqlDatabasesApi. 
    * @alias module:api/MySqlDatabasesApi
    * @class
    ...
    */
    ...
    /**
     * Callback function to receive the result of the changeDatabaseUserPassword operation.
     * @callback module:api/MySqlDatabasesApi~changeDatabaseUserPasswordCallback
     ...
     * @param {String} databaseName2 Automatically added
     * @param {String} userName2 Automatically added
     * @param {Object} opts Optional parameters
     * @param {module:model/UpdateUserPasswordRequest} [updateUserPasswordRequest] Contains the new password.
     * @param {module:api/MySqlDatabasesApi~changeDatabaseUserPasswordCallback} callback The callback function, accepting three arguments: error, data, response
     */
    changeDatabaseUserPassword(databaseName, userName, databaseName2, userName2, opts, callback) {
      opts = opts || {};
      let postBody = opts['updateUserPasswordRequest'];
      // verify the required parameter 'databaseName' is set
      if (databaseName === undefined || databaseName === null) {
        throw new Error("Missing the required parameter 'databaseName' when calling changeDatabaseUserPassword");
      }
      // verify the required parameter 'userName' is set
      if (userName === undefined || userName === null) {
        throw new Error("Missing the required parameter 'userName' when calling changeDatabaseUserPassword");
      }
      // verify the required parameter 'databaseName2' is set
      if (databaseName2 === undefined || databaseName2 === null) {
        throw new Error("Missing the required parameter 'databaseName2' when calling changeDatabaseUserPassword");
      }
      // verify the required parameter 'userName2' is set
      if (userName2 === undefined || userName2 === null) {
        throw new Error("Missing the required parameter 'userName2' when calling changeDatabaseUserPassword");
      }
      ...
      return this.apiClient.callApi(
        '/mysqldatabases/{databaseName}/users/{userName}/password', 'PUT',
    ...
    /**
     * Callback function to receive the result of the changeDatabaseUserStatus operation.
     * @callback module:api/MySqlDatabasesApi~changeDatabaseUserStatusCallback
     * @param {String} error Error message, if any.
     * @param data This operation does not return a value.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} userName2 Automatically added
     * @param {Object} opts Optional parameters
     * @param {module:model/UpdateUserStatusRequest} [updateUserStatusRequest] Whether the user is enabled or not.
     * @param {module:api/MySqlDatabasesApi~changeDatabaseUserStatusCallback} callback The callback function, accepting three arguments: error, data, response
     */
    changeDatabaseUserStatus(databaseName, userName, databaseName2, userName2, opts, callback) {
      opts = opts || {};
      let postBody = opts['updateUserStatusRequest'];
      // verify the required parameter 'databaseName' is set
      if (databaseName === undefined || databaseName === null) {
        throw new Error("Missing the required parameter 'databaseName' when calling changeDatabaseUserStatus");
      }
      // verify the required parameter 'userName' is set
      if (userName === undefined || userName === null) {
        throw new Error("Missing the required parameter 'userName' when calling changeDatabaseUserStatus");
      }
      // verify the required parameter 'databaseName2' is set
      if (databaseName2 === undefined || databaseName2 === null) {
        throw new Error("Missing the required parameter 'databaseName2' when calling changeDatabaseUserStatus");
      }
      // verify the required parameter 'userName2' is set
      if (userName2 === undefined || userName2 === null) {
        throw new Error("Missing the required parameter 'userName2' when calling changeDatabaseUserStatus");
      }
      ...
      let returnType = null;
      return this.apiClient.callApi(
        '/mysqldatabases/{databaseName}/users/{userName}/status', 'PUT',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
    ...
    /**
     * Callback function to receive the result of the createMySqlDatabase operation.
     * @callback module:api/MySqlDatabasesApi~createMySqlDatabaseCallback
     * @param {String} error Error message, if any.
     * @param data This operation does not return a value.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Object} opts Optional parameters
     * @param {module:model/CreateMySqlDatabase} [createMySqlDatabase] 
     * @param {module:api/MySqlDatabasesApi~createMySqlDatabaseCallback} callback The callback function, accepting three arguments: error, data, response
     */
    createMySqlDatabase(opts, callback) {
      opts = opts || {};
      let postBody = opts['createMySqlDatabase'];
    ...
    /**
     * Callback function to receive the result of the createMySqlUser operation.
     * @callback module:api/MySqlDatabasesApi~createMySqlUserCallback
     * @param {String} error Error message, if any.
     * @param data This operation does not return a value.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} databaseName2 Automatically added
     * @param {Object} opts Optional parameters
     * @param {module:model/CreateMySqlUser} [createMySqlUser] 
     * @param {module:api/MySqlDatabasesApi~createMySqlUserCallback} callback The callback function, accepting three arguments: error, data, response
     */
    createMySqlUser(databaseName, databaseName2, opts, callback) {
      opts = opts || {};
      let postBody = opts['createMySqlUser'];
      // verify the required parameter 'databaseName' is set
      if (databaseName === undefined || databaseName === null) {
        throw new Error("Missing the required parameter 'databaseName' when calling createMySqlUser");
      }
      // verify the required parameter 'databaseName2' is set
      if (databaseName2 === undefined || databaseName2 === null) {
        throw new Error("Missing the required parameter 'databaseName2' when calling createMySqlUser");
      }
      ...
      let returnType = null;
      return this.apiClient.callApi(
        '/mysqldatabases/{databaseName}/users', 'POST',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
     ...
     * @callback module:api/MySqlDatabasesApi~deleteDatabaseCallback
     * @param {String} error Error message, if any.
     * @param data This operation does not return a value.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} databaseName Name of the database.
     * @param {String} databaseName2 Automatically added
     * @param {module:api/MySqlDatabasesApi~deleteDatabaseCallback} callback The callback function, accepting three arguments: error, data, response
     */
    deleteDatabase(databaseName, databaseName2, callback) {
      let postBody = null;
      // verify the required parameter 'databaseName' is set
      if (databaseName === undefined || databaseName === null) {
      ...
      // verify the required parameter 'databaseName2' is set
      if (databaseName2 === undefined || databaseName2 === null) {
        throw new Error("Missing the required parameter 'databaseName2' when calling deleteDatabase");
      }
      ...
      let returnType = null;
      return this.apiClient.callApi(
        '/mysqldatabases/{databaseName}', 'DELETE',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
     ...
     * @callback module:api/MySqlDatabasesApi~deleteDatabaseUserCallback
     * @param {String} error Error message, if any.
     * @param data This operation does not return a value.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} databaseName2 Automatically added
     * @param {String} userName2 Automatically added
     * @param {module:api/MySqlDatabasesApi~deleteDatabaseUserCallback} callback The callback function, accepting three arguments: error, data, response
     */
    deleteDatabaseUser(databaseName, userName, databaseName2, userName2, callback) {
      let postBody = null;
      // verify the required parameter 'databaseName' is set
      if (databaseName === undefined || databaseName === null) {
        throw new Error("Missing the required parameter 'databaseName' when calling deleteDatabaseUser");
      }
      // verify the required parameter 'userName' is set
      if (userName === undefined || userName === null) {
        throw new Error("Missing the required parameter 'userName' when calling deleteDatabaseUser");
      }
      // verify the required parameter 'databaseName2' is set
      if (databaseName2 === undefined || databaseName2 === null) {
        throw new Error("Missing the required parameter 'databaseName2' when calling deleteDatabaseUser");
      }
      // verify the required parameter 'userName2' is set
      if (userName2 === undefined || userName2 === null) {
        throw new Error("Missing the required parameter 'userName2' when calling deleteDatabaseUser");
      }
      ...
      let returnType = null;
      return this.apiClient.callApi(
        '/mysqldatabases/{databaseName}/users/{userName}', 'DELETE',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
     ...
     * @callback module:api/MySqlDatabasesApi~getDatabaseUsersCallback
     * @param {String} error Error message, if any.
     * @param {Array.<module:model/MySqlUser>} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} databaseName Name of the database.
     * @param {String} databaseName2 Automatically added
     * @param {module:api/MySqlDatabasesApi~getDatabaseUsersCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Array.<module:model/MySqlUser>}
     */
    getDatabaseUsers(databaseName, databaseName2, callback) {
      let postBody = null;
      // verify the required parameter 'databaseName' is set
      if (databaseName === undefined || databaseName === null) {
        throw new Error("Missing the required parameter 'databaseName' when calling getDatabaseUsers");
      }
      // verify the required parameter 'databaseName2' is set
      if (databaseName2 === undefined || databaseName2 === null) {
        throw new Error("Missing the required parameter 'databaseName2' when calling getDatabaseUsers");
      }
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = [MySqlUser];
      return this.apiClient.callApi(
        '/mysqldatabases/{databaseName}/users', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
    ...
    /**
     * Callback function to receive the result of the getMySqlDatabase operation.
     * @callback module:api/MySqlDatabasesApi~getMySqlDatabaseCallback
     * @param {String} error Error message, if any.
     * @param {module:model/MySqlDatabase} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} databaseName2 Automatically added
     * @param {module:api/MySqlDatabasesApi~getMySqlDatabaseCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/MySqlDatabase}
     */
    getMySqlDatabase(databaseName, databaseName2, callback) {
      let postBody = null;
      // verify the required parameter 'databaseName' is set
      if (databaseName === undefined || databaseName === null) {
        throw new Error("Missing the required parameter 'databaseName' when calling getMySqlDatabase");
      }
      // verify the required parameter 'databaseName2' is set
      if (databaseName2 === undefined || databaseName2 === null) {
        throw new Error("Missing the required parameter 'databaseName2' when calling getMySqlDatabase");
      }
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = MySqlDatabase;
      return this.apiClient.callApi(
        '/mysqldatabases/{databaseName}', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
    ...
    /**
     * Callback function to receive the result of the getMySqlDatabases operation.
     * @callback module:api/MySqlDatabasesApi~getMySqlDatabasesCallback
     * @param {String} error Error message, if any.
     * @param {Array.<module:model/MySqlDatabase>} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:api/MySqlDatabasesApi~getMySqlDatabasesCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Array.<module:model/MySqlDatabase>}
     */
    getMySqlDatabases(opts, callback) {
      opts = opts || {};
      let postBody = null;
