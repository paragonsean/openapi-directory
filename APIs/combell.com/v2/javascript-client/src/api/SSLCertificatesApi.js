...
export default class SSLCertificatesApi {
    ...
    */
     ...
     * @callback module:api/SSLCertificatesApi~downloadCertificateCallback
     ...
     * @param {module:model/SslCertificateFileFormat} fileFormat The file format of the returned file stream:  <ul><li>PFX: Also known as PKCS #12, is a single, password protected certificate archive that contains the entire certificate chain plus the matching private key.</li></ul>
     * @param {String} password The password used to protect the certificate file.<br />
     * @param {String} sha1Fingerprint2 Automatically added
     * @param {module:api/SSLCertificatesApi~downloadCertificateCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link File}
     */
    downloadCertificate(sha1Fingerprint, fileFormat, password, sha1Fingerprint2, callback) {
      let postBody = null;
      // verify the required parameter 'sha1Fingerprint' is set
      if (sha1Fingerprint === undefined || sha1Fingerprint === null) {
        throw new Error("Missing the required parameter 'sha1Fingerprint' when calling downloadCertificate");
      }
      // verify the required parameter 'fileFormat' is set
      if (fileFormat === undefined || fileFormat === null) {
        throw new Error("Missing the required parameter 'fileFormat' when calling downloadCertificate");
      }
      // verify the required parameter 'password' is set
      if (password === undefined || password === null) {
        throw new Error("Missing the required parameter 'password' when calling downloadCertificate");
      }
      // verify the required parameter 'sha1Fingerprint2' is set
      if (sha1Fingerprint2 === undefined || sha1Fingerprint2 === null) {
        throw new Error("Missing the required parameter 'sha1Fingerprint2' when calling downloadCertificate");
      }

      let pathParams = {
        'sha1Fingerprint': sha1Fingerprint2
      };
      let queryParams = {
      ...
      return this.apiClient.callApi(
        '/sslcertificates/{sha1Fingerprint}/download', 'GET',
    ...
    /**
     * Callback function to receive the result of the getSslCertificate operation.
     * @callback module:api/SSLCertificatesApi~getSslCertificateCallback
     * @param {String} error Error message, if any.
     * @param {module:model/SslCertificateDetail} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} sha1Fingerprint The SHA-1 fingerprint of the certificate.
     * @param {String} sha1Fingerprint2 Automatically added
     * @param {module:api/SSLCertificatesApi~getSslCertificateCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/SslCertificateDetail}
     */
    getSslCertificate(sha1Fingerprint, sha1Fingerprint2, callback) {
      let postBody = null;
      // verify the required parameter 'sha1Fingerprint' is set
      if (sha1Fingerprint === undefined || sha1Fingerprint === null) {
        throw new Error("Missing the required parameter 'sha1Fingerprint' when calling getSslCertificate");
      }
      // verify the required parameter 'sha1Fingerprint2' is set
      if (sha1Fingerprint2 === undefined || sha1Fingerprint2 === null) {
        throw new Error("Missing the required parameter 'sha1Fingerprint2' when calling getSslCertificate");
      }
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = SslCertificateDetail;
      return this.apiClient.callApi(
        '/sslcertificates/{sha1Fingerprint}', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
    ...
    /**
     * Callback function to receive the result of the getSslCertificates operation.
     * @callback module:api/SSLCertificatesApi~getSslCertificatesCallback
     * @param {String} error Error message, if any.
     * @param {Array.<module:model/SslCertificate>} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:api/SSLCertificatesApi~getSslCertificatesCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Array.<module:model/SslCertificate>}
     */
    getSslCertificates(opts, callback) {
      opts = opts || {};
      let postBody = null;
