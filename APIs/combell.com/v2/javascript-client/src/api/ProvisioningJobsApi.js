...
* @module api/ProvisioningJobsApi
* @version v2
*/
export default class ProvisioningJobsApi {

    /**
    * Constructs a new ProvisioningJobsApi. 
    * @alias module:api/ProvisioningJobsApi
    * @class
    ...
    */
    ...
    /**
     * Callback function to receive the result of the provisioningjobsJobIdGet operation.
     * @callback module:api/ProvisioningJobsApi~provisioningjobsJobIdGetCallback
     * @param {String} error Error message, if any.
     * @param {module:model/ProvisioningJobInfo} data The data returned by the service call.
     ...
     * @param {String} jobId 
     * @param {String} jobId2 Automatically added
     * @param {module:api/ProvisioningJobsApi~provisioningjobsJobIdGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/ProvisioningJobInfo}
     */
    provisioningjobsJobIdGet(jobId, jobId2, callback) {
      let postBody = null;
      // verify the required parameter 'jobId' is set
      if (jobId === undefined || jobId === null) {
        throw new Error("Missing the required parameter 'jobId' when calling provisioningjobsJobIdGet");
      }
      // verify the required parameter 'jobId2' is set
      if (jobId2 === undefined || jobId2 === null) {
        throw new Error("Missing the required parameter 'jobId2' when calling provisioningjobsJobIdGet");
      }
      ...
      let returnType = ProvisioningJobInfo;
      return this.apiClient.callApi(
        '/provisioningjobs/{jobId}', 'GET',
