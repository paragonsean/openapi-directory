...
/**
* Servicepacks service.
* @module api/ServicepacksApi
* @version v2
*/
export default class ServicepacksApi {

    /**
    * Constructs a new ServicepacksApi. 
    * @alias module:api/ServicepacksApi
    * @class
    ...
    */
    ...
    /**
     * Callback function to receive the result of the servicepacks operation.
     * @callback module:api/ServicepacksApi~servicepacksCallback
     * @param {String} error Error message, if any.
     * @param {Array.<module:model/Servicepack>} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */

    /**
     * Overview of service packs
     * @param {module:api/ServicepacksApi~servicepacksCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Array.<module:model/Servicepack>}
     */
    servicepacks(callback) {
      let postBody = null;
