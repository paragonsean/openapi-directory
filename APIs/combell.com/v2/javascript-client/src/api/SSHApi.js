...
export default class SSHApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the getAllSshKeys operation.
     * @callback module:api/SSHApi~getAllSshKeysCallback
     * @param {String} error Error message, if any.
     * @param {Array.<module:model/SshKeyDetail>} data The data returned by the service call.
     ...
     * @param {module:api/SSHApi~getAllSshKeysCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Array.<module:model/SshKeyDetail>}
     */
    getAllSshKeys(opts, callback) {
      opts = opts || {};
      let postBody = null;
