...
export default class DomainsApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the configureDomain operation.
     * @callback module:api/DomainsApi~configureDomainCallback
     ...
     * @param {module:model/EditDomainWillRenewRequest} [editDomainWillRenewRequest] Contains the domain renew information
     * @param {module:api/DomainsApi~configureDomainCallback} callback The callback function, accepting three arguments: error, data, response
     */
    configureDomain(domainName, domainName2, opts, callback) {
      opts = opts || {};
      let postBody = opts['editDomainWillRenewRequest'];
      // verify the required parameter 'domainName' is set
      if (domainName === undefined || domainName === null) {
        throw new Error("Missing the required parameter 'domainName' when calling configureDomain");
      }
      // verify the required parameter 'domainName2' is set
      if (domainName2 === undefined || domainName2 === null) {
        throw new Error("Missing the required parameter 'domainName2' when calling configureDomain");
      }
    ...
    /**
     * Callback function to receive the result of the editNameServers operation.
     * @callback module:api/DomainsApi~editNameServersCallback
     * @param {String} error Error message, if any.
     * @param data This operation does not return a value.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} domainName2 Automatically added
     * @param {Object} opts Optional parameters
     * @param {module:model/EditNameServers} [editNameServers] 
     * @param {module:api/DomainsApi~editNameServersCallback} callback The callback function, accepting three arguments: error, data, response
     */
    editNameServers(domainName, domainName2, opts, callback) {
      opts = opts || {};
      let postBody = opts['editNameServers'];
      // verify the required parameter 'domainName' is set
      if (domainName === undefined || domainName === null) {
        throw new Error("Missing the required parameter 'domainName' when calling editNameServers");
      }
      // verify the required parameter 'domainName2' is set
      if (domainName2 === undefined || domainName2 === null) {
        throw new Error("Missing the required parameter 'domainName2' when calling editNameServers");
      }
     ...
     */
    getDomain(domainName, domainName2, callback) {
      let postBody = null;
      // verify the required parameter 'domainName' is set
      if (domainName === undefined || domainName === null) {
      ...
      // verify the required parameter 'domainName2' is set
      if (domainName2 === undefined || domainName2 === null) {
        throw new Error("Missing the required parameter 'domainName2' when calling getDomain");
      }
     ...
     * @callback module:api/DomainsApi~registerCallback
     * @param {String} error Error message, if any.
     * @param data This operation does not return a value.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Object} opts Optional parameters
     * @param {module:model/RegisterDomain} [registerDomain] 
     * @param {module:api/DomainsApi~registerCallback} callback The callback function, accepting three arguments: error, data, response
     */
    register(opts, callback) {
      opts = opts || {};
      let postBody = opts['registerDomain'];
     ...
     * @callback module:api/DomainsApi~transferCallback
     * @param {String} error Error message, if any.
     * @param data This operation does not return a value.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Object} opts Optional parameters
     * @param {module:model/TransferDomain} [transferDomain] 
     * @param {module:api/DomainsApi~transferCallback} callback The callback function, accepting three arguments: error, data, response
     */
    transfer(opts, callback) {
      opts = opts || {};
      let postBody = opts['transferDomain'];
