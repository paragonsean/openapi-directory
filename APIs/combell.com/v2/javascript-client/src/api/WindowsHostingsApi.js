...
/**
* WindowsHostings service.
* @module api/WindowsHostingsApi
* @version v2
*/
export default class WindowsHostingsApi {

    /**
    * Constructs a new WindowsHostingsApi. 
    * @alias module:api/WindowsHostingsApi
    * @class
    ...
    */
    ...
    /**
     * Callback function to receive the result of the getWindowsHosting operation.
     * @callback module:api/WindowsHostingsApi~getWindowsHostingCallback
     * @param {String} error Error message, if any.
     * @param {module:model/WindowsHostingDetail} data The data returned by the service call.
     ...
     * @param {module:api/WindowsHostingsApi~getWindowsHostingCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/WindowsHostingDetail}
     */
    getWindowsHosting(domainName, domainName2, callback) {
      let postBody = null;
      // verify the required parameter 'domainName' is set
      if (domainName === undefined || domainName === null) {
        throw new Error("Missing the required parameter 'domainName' when calling getWindowsHosting");
      }
      // verify the required parameter 'domainName2' is set
      if (domainName2 === undefined || domainName2 === null) {
        throw new Error("Missing the required parameter 'domainName2' when calling getWindowsHosting");
      }
      ...
      let returnType = WindowsHostingDetail;
      return this.apiClient.callApi(
        '/windowshostings/{domainName}', 'GET',
    ...
    /**
     * Callback function to receive the result of the getWindowsHostings operation.
     * @callback module:api/WindowsHostingsApi~getWindowsHostingsCallback
     * @param {String} error Error message, if any.
     * @param {Array.<module:model/WindowsHosting>} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:api/WindowsHostingsApi~getWindowsHostingsCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Array.<module:model/WindowsHosting>}
     */
    getWindowsHostings(opts, callback) {
      opts = opts || {};
      let postBody = null;
