...
/**
* SSLCertificateRequests service.
* @module api/SSLCertificateRequestsApi
* @version v2
*/
export default class SSLCertificateRequestsApi {

    /**
    * Constructs a new SSLCertificateRequestsApi. 
    * @alias module:api/SSLCertificateRequestsApi
    * @class
    ...
    */
    ...
    /**
     * Callback function to receive the result of the addSslCertificateRequest operation.
     * @callback module:api/SSLCertificateRequestsApi~addSslCertificateRequestCallback
     ...
     * @param {module:model/CreateSslCertificateRequest} [createSslCertificateRequest] 
     * @param {module:api/SSLCertificateRequestsApi~addSslCertificateRequestCallback} callback The callback function, accepting three arguments: error, data, response
     */
    addSslCertificateRequest(opts, callback) {
      opts = opts || {};
      let postBody = opts['createSslCertificateRequest'];
    ...
    /**
     * Callback function to receive the result of the getSslCertificateRequest operation.
     * @callback module:api/SSLCertificateRequestsApi~getSslCertificateRequestCallback
     * @param {String} error Error message, if any.
     * @param {module:model/SslCertificateRequestDetail} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:api/SSLCertificateRequestsApi~getSslCertificateRequestCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/SslCertificateRequestDetail}
     */
    getSslCertificateRequest(id, callback) {
      let postBody = null;
      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling getSslCertificateRequest");
      }
      ...
      let returnType = SslCertificateRequestDetail;
      return this.apiClient.callApi(
        '/sslcertificaterequests/{id}', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
    ...
    /**
     * Callback function to receive the result of the getSslCertificateRequests operation.
     * @callback module:api/SSLCertificateRequestsApi~getSslCertificateRequestsCallback
     * @param {String} error Error message, if any.
     * @param {Array.<module:model/SslCertificateRequest>} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:api/SSLCertificateRequestsApi~getSslCertificateRequestsCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Array.<module:model/SslCertificateRequest>}
     */
    getSslCertificateRequests(opts, callback) {
      opts = opts || {};
      let postBody = null;
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = [SslCertificateRequest];
      return this.apiClient.callApi(
        '/sslcertificaterequests', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
    ...
    /**
     * Callback function to receive the result of the verifySslCertificateRequestDomainValidations operation.
     * @callback module:api/SSLCertificateRequestsApi~verifySslCertificateRequestDomainValidationsCallback
     * @param {String} error Error message, if any.
     * @param data This operation does not return a value.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Number} id The id of the certificate request.
     * @param {module:api/SSLCertificateRequestsApi~verifySslCertificateRequestDomainValidationsCallback} callback The callback function, accepting three arguments: error, data, response
     */
    verifySslCertificateRequestDomainValidations(id, callback) {
      let postBody = null;
      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling verifySslCertificateRequestDomainValidations");
      }
