...
/**
 * The ExtraField model module.
 * @module model/ExtraField
 * @version v2
 */
class ExtraField {
    /**
     * Constructs a new <code>ExtraField</code>.
     * @alias module:model/ExtraField
     */
    constructor() { 
        
        ExtraField.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ExtraField</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ExtraField} obj Optional instance to populate.
     * @return {module:model/ExtraField} The populated <code>ExtraField</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ExtraField();
    ...
    /**
     * Validates the JSON data with respect to <code>ExtraField</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ExtraField</code>.
     */
 ...
 * @member {String} name
 */
ExtraField.prototype['name'] = undefined;

/**
 * Registrant extra field value.
 * @member {String} value
 */
ExtraField.prototype['value'] = undefined;
