...
/**
 * The AutoReply model module.
 * @module model/AutoReply
 * @version v2
 */
class AutoReply {
    /**
     * Constructs a new <code>AutoReply</code>.
     * @alias module:model/AutoReply
     */
    constructor() { 
        
        AutoReply.initialize(this);
    }
    ...
    /**
     * Constructs a <code>AutoReply</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AutoReply} obj Optional instance to populate.
     * @return {module:model/AutoReply} The populated <code>AutoReply</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AutoReply();
    ...
    /**
     * Validates the JSON data with respect to <code>AutoReply</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AutoReply</code>.
     */
 ...
 */
AutoReply.prototype['enabled'] = undefined;

/**
 * Message
 * @member {String} message
 */
AutoReply.prototype['message'] = undefined;

/**
 * Subject
 * @member {String} subject
 */
AutoReply.prototype['subject'] = undefined;
