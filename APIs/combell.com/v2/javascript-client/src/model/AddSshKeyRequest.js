...
/**
 * The AddSshKeyRequest model module.
 * @module model/AddSshKeyRequest
 * @version v2
 */
class AddSshKeyRequest {
    /**
     * Constructs a new <code>AddSshKeyRequest</code>.
     * @alias module:model/AddSshKeyRequest
     */
    constructor() { 
        
        AddSshKeyRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>AddSshKeyRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AddSshKeyRequest} obj Optional instance to populate.
     * @return {module:model/AddSshKeyRequest} The populated <code>AddSshKeyRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AddSshKeyRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>AddSshKeyRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AddSshKeyRequest</code>.
     */
 ...
 */
AddSshKeyRequest.prototype['public_key'] = undefined;
...
export default AddSshKeyRequest;
