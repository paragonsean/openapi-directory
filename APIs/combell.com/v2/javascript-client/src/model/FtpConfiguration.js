...
/**
 * The FtpConfiguration model module.
 * @module model/FtpConfiguration
 * @version v2
 */
class FtpConfiguration {
    /**
     * Constructs a new <code>FtpConfiguration</code>.
     * @alias module:model/FtpConfiguration
     */
    constructor() { 
        
        FtpConfiguration.initialize(this);
    }
    ...
    /**
     * Constructs a <code>FtpConfiguration</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/FtpConfiguration} obj Optional instance to populate.
     * @return {module:model/FtpConfiguration} The populated <code>FtpConfiguration</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new FtpConfiguration();
    ...
    /**
     * Validates the JSON data with respect to <code>FtpConfiguration</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>FtpConfiguration</code>.
     */
 ...
 */
FtpConfiguration.prototype['enabled'] = undefined;
